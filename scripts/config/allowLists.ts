...
export const IGNORE_TITLE_MISMATCHES: string[] = [
  ...
  "docs/guides/cloud-setup-invited.mdx",
  "docs/guides/cloud-setup-rest-api.mdx",
  ...
  "docs/guides/debugging-tools.mdx",
  ...
  "docs/guides/job-limits.mdx",
  "docs/guides/kipu-optimization.ipynb",
  "docs/guides/latest-updates.mdx",
  ...
  "docs/guides/qiskit-addons-cutting.mdx",
  ...
  "docs/guides/runtime-options-overview.mdx",
  ...
  "docs/security/context-based-restrictions.mdx",
  "docs/security/ha-dr.mdx",
  "docs/security/index.mdx",
  "docs/security/observability.mdx",
  "docs/security/responsibilities.mdx",
  "docs/security/secure-data.mdx",
  "docs/security/virtual-private-endpoints.mdx",
