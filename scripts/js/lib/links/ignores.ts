...
function _apisToQiskitOldLinks(): string[] {
  ...
  return [
    ...
    // Current APIs (objects.inv, release-notes, etc)
    "/api/qiskit/qiskit.transpiler.passes.RemoveResetInZeroState",
    "/api/qiskit/qiskit.circuit.library.CHGate",
    "/api/qiskit/qiskit.circuit.library.CYGate",
    "/api/qiskit/qiskit.circuit.library.CSGate",
    "/api/qiskit/qiskit.circuit.library.CSXGate",
    "/api/qiskit/qiskit.circuit.library.CSdgGate",
    "/api/qiskit/qiskit.circuit.library.CPhaseGate",
    "/api/qiskit/qiskit.circuit.library.ECRGate",
    "/api/qiskit/qiskit.circuit.library.SwapGate",
    "/api/qiskit/qiskit.circuit.library.iSwapGate",
    "/api/qiskit/qiskit.circuit.library.DCXGate",
    "/api/qiskit/qiskit.circuit.library.RXXGate",
    "/api/qiskit/qiskit.circuit.library.RYYGate",
    "/api/qiskit/qiskit.circuit.library.RZZGate",
    "/api/qiskit/qiskit.circuit.library.CRXGate",
    "/api/qiskit/qiskit.circuit.library.CRYGate",
    "/api/qiskit/qiskit.circuit.library.CRZGate",
    "/api/qiskit/qiskit.primitives.BaseSampler",
    "/api/qiskit/qiskit.primitives.BaseSamplerV1",
    "/api/qiskit/qiskit.synthesis.EvolutionSynthesis",
    "/api/qiskit/qiskit.transpiler.passes.CollectAndCollapse",
    "/api/qiskit/qiskit.primitives.BackendSamplerV2",
    "/api/qiskit-ibm-runtime/qiskit_ibm_runtime.QiskitRuntimeService#.*",
    "/api/qiskit/qiskit.providers.convert_to_target",
    "/api/qiskit-ibm-runtime/qiskit_ibm_runtime.IBMBackend#.*",
    "/api/qiskit-ibm-runtime/qiskit_ibm_runtime.Session#.*",
    "/api/qiskit-ibm-runtime/qiskit_ibm_runtime.RuntimeJobV2#in_final_state",
    "/api/qiskit-ibm-runtime/qiskit_ibm_runtime.transpiler.passes.scheduling.PadDynamicalDecoupling",
    "/api/qiskit-ibm-runtime/qiskit_ibm_runtime.Session",
    "/api/qiskit-ibm-runtime/qiskit_ibm_runtime.IBMBackend#open_session",
    "/api/qiskit-ibm-runtime/qiskit_ibm_runtime.QiskitRuntimeService#backends",
    "/api/qiskit-ibm-runtime/qiskit_ibm_runtime.RuntimeJob.*",
    "/api/qiskit-ibm-runtime/qiskit_ibm_runtime.Estimator",
    "/api/qiskit-ibm-runtime/qiskit_ibm_runtime.Sampler",
    "/api/qiskit-ibm-runtime/qiskit_ibm_runtime.Session#.*",
    "/api/qiskit-ibm-runtime/qiskit_ibm_runtime.QiskitRuntimeService.*",
    "/api/qiskit-ibm-runtime/qiskit_ibm_runtime.RuntimeJob#.*",
    "/api/qiskit-ibm-runtime/qiskit_ibm_runtime.options.SimulatorOptions",
    "/api/qiskit-ibm-runtime/qiskit_ibm_runtime.IBMBackend",
    "/api/qiskit-ibm-runtime/qiskit_ibm_runtime.options.EnvironmentOptions",
    "/api/qiskit-ibm-runtime/qiskit_ibm_runtime.RuntimeEncoder",
    "/api/qiskit-ibm-runtime/qiskit_ibm_runtime.RuntimeDecoder",
    "/api/qiskit/circuit-library-efficient-su-2#.*",
    "/api/qiskit/circuit-library-evolved-operator-ansatz#.*",
    "/api/qiskit/circuit-library-excitation-preserving#.*",
    "/api/qiskit/circuit-library-fourier-checking#.*",
    "/api/qiskit/circuit-library-grover-operator#.*",
    "/api/qiskit/circuit-library-hidden-linear-function#.*",
    "/api/qiskit/circuit-library-n-local#.*",
    "/api/qiskit/circuit-library-pauli-feature-map#.*",
    "/api/qiskit/circuit-library-pauli-two-design#.*",
    "/api/qiskit/circuit-library-phase-estimation#.*",
    "/api/qiskit/circuit-library-qaoa-ansatz#.*",
    "/api/qiskit/circuit-library-quantum-volume#.*",
    "/api/qiskit/circuit-library-real-amplitudes#.*",
    "/api/qiskit/circuit-library-unitary-overlap#.*",
    "/api/qiskit/circuit-library-z-feature-map#.*",
    "/api/qiskit/circuit-library-zz-feature-map#.*",
  ];
}
