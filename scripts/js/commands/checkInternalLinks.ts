...
const SYNTHETIC_FILES: string[] = [
  ...
  "profile.mdx",
  "signin.mdx",
  "functions?id=colibritd-quick-pde.mdx",
  "functions?id=global-data-quantum-quantum-portfolio-optimizer.mdx",
  "instances.mdx",
  "api/docs/index.mdx",
  "access-groups.mdx",
  "functions?id=algorithmiq-tem.mdx",
  "computers.mdx",
  "login.mdx",
  "composer.mdx",
  "workloads.mdx",
  "functions?id=multiverse-singularity.mdx",
  "functions?id=q-ctrl-performance-management.mdx",
