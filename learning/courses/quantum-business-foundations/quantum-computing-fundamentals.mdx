...
True. A quantum circuit is an abstract representation of a set of instructions that make up a quantum algorithm. We can use a visual tool like the IBM [Composer](https://quantum.cloud.ibm.com/composer) or an SDK like [Qiskit](/docs/guides) to construct quantum circuits.
