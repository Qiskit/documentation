...
Before beginning, please complete this short [pre-course survey](https://your.feedback.ibm.com/jfe/form/SV_07bsNr1LgHJPgjQ), which is important to help improve our content offerings and user experience.
...
<Admonition title="Note" type="note">
  "Agile" refers to a set of principles and practices used in software development and project management.
  It emphasizes flexibility, collaboration, iterative development, and customer involvement throughout the project lifecycle.
  The goal of the agile approach is to respond quickly to changing requirements, deliver incremental improvements, and achieve better alignment with customer needs.
</Admonition>
...
- IBM&reg; product offerings that can help
