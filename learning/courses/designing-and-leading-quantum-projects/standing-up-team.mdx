...
* Develop incrementally utiliziing agile methodology to scale up a technical approach and project
...
* Use software features such as [Qiskit Addons](/docs/en/guides/addons), [Qiskit Functions](docs/en/guides/functions) to fast-track technical development, learning and discovery
