...
Maintaining up to date documentation is a huge challenge for any software project, especially in a field like quantum computing where the pace at which new research and technological capabilities get released is incredibly fast. As a result, we greatly appreciate any who take the time to support us in keeping this content accurate and up to the highest quality standard possible to benefit the broadest range of users.
...
### 3. Validate exisiting issues

You can help the maintainer team prioritise already open issues by doing the following:
...
## Pre-requisites to building the docs locally
