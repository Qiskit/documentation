...
description: The default settings and configuration options for quantum circuit transpilation in Qiskit SDK.
...
![Original circuit](/images/transpile/defaults-and-configuration-options/original-circuit-qiskit-1.0.png "Original circuit")
...
![Transpiled circuit](/images/transpile/defaults-and-configuration-options/transpiled-circuit-qiskit-1.0.png "Transpiled circuit")
