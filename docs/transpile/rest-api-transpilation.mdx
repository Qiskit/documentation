...
resp = requests.post(
    ...
    <TabItem value="Qiskit Transpiler Service with AI" label="Qiskit Transpiler Service with AI">
        ```python
backend='ibm_brisbane' #choose your IBM Backend
...
<Admonition type="tip" title="Recommendations">
    - Review detailed [Sampler and Estimator](/run/rest-api-primitives) primitives examples using REST API.
