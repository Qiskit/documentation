---
title: Transpilation using REST APIs
description: How to transpile quantum circuits using REST APIs.
---

# Transpilation using REST APIs
...
<Admonition type="tip" title="Recommendations">
    - Review detailed [Sampler and Estimator](/run/rest-api-primitives) primitives examples using REST APIs.
