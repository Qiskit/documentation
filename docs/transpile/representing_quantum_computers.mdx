...
This shows that our virtual qubits 0-11 were trivially mapped to the line of physical qubits 0-11.
...
Now there are no SWAP gates inserted and the physical qubits selected are the same when using the Target class *(TODO: actually they should probably be different).*
