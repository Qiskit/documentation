...
```python
qc_t3_exact = transpile(qc, backend, optimization_level=1, coupling_map=[[0, 1], [1, 0]], seed_transpiler=12345)
...
```python
qc_t3_approx = transpile(qc, backend, optimization_level=1, approximation_degree=0.99, coupling_map=[[0, 1], [1, 0]], seed_transpiler=12345)
