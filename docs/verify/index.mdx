...
1. Run your program on a quantum simulator, using [Qiskit reference primitives](simulate-with-qiskit-primitives) or [IBM Quantum cloud-based simulators](simulators).
