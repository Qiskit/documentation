...
- For simulating circuits when using Qiskit Runtime, use its [local testing mode.](../run/primitives-get-started#test-locally) 
...
- For higher-performance simulation that can handle larger circuits, or to incorporate noise models into your simulation, use [Qiskit Aer](https://qiskit.org/ecosystem/aer/), a project that is part of the [Qiskit Ecosystem](https://qiskit.github.io/ecosystem/). See [Exact and noisy simulation with Qiskit Aer primitives](simulate-with-qiskit-aer) (V1 primitive support only). For V2 primitive support, use the [Qiskit Runtime local testing mode](../run/primitives-get-started#test-locally) with the Qiskit Aer primitives.
