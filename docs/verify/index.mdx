...
Stabilizer circuits are a useful tool for accomplishing this latter goal. See [Efficient simulation of stabilizer circuits with Qiskit Aer primitives](stabilizer-circuit-simulation) for an overview of stabilizer circuits and how to simulate them efficiently.

The following tools are available for you to verify your quantum programs:
...
- As mentioned before, Qiskit Aer can be used to efficiently simulate stabilizer circuits, a special restricted class of quantum circuits. For example, using Qiskit Aer, you can simulate stabilizer circuits with thousands of qubits. See [Efficient simulation of stabilizer circuits with Qiskit Aer primitives](stabilizer-circuit-simulation).