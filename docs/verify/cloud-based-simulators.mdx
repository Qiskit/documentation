...
This page gives details about the IBM Quantum&reg; cloud-based simulators. For information about the Qiskit&reg; built-in simulator, see the [Python&reg;-based simulators page in the API reference.](../api/qiskit/providers_basicaer) You can also use the [Qiskit reference primitives](simulate-with-qiskit-primitives) for local statevector simulation.
</Admonition>
