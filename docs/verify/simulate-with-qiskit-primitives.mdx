...
For a full example, see the [Primitives examples](/run/primitives-examples#estimator-examples) page.
...
For a full example, see the [Primitives examples](/run/primitives-examples#sampler-examples) page.
## Next steps
...
<Admonition type="tip" title="Recommendations">
  ...
  - Learn how to run on a QPU in the [Run](../run) section.
</Admonition>