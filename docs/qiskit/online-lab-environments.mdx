...
1. [Create an IBM Cloud account](/docs/guides/cloud-setup).
...
2. [Create a Watson Studio Project](https://www.ibm.com/docs/db2-event-store/2.0.0?topic=data-projects#d275537e106).
