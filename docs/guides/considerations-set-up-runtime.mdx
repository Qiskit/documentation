...
This guide describes the decisions and tradeoffs involved in setting up access for an organization with multiple service instances. For example, having one instance per team or workload.
