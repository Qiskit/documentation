...
When you create an instance in IBM Quantum Platform, an access group is automatically generated (unless you opt out) for collaborators to use that instance. If you want to customize an access group or create other access groups, use the IBM&reg; Cloud console for [Access groups.](https://cloud.ibm.com/iam/groups)
...
finally, invite users to the access group.  You can do this from the access group's **Users** page, or by using the IBM Quantum Platform [Access management](https://quantum.cloud.ibm.com/admin/access-groups) page.
