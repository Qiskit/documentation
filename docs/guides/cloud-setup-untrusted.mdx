...
To initialize the service in this situation, use code like the following:
    ...
    # Saved accounts are not used when a token is passed in. 
    # The service is initialized with credentials that are not saved.
    service = QiskitRuntimeService(
      ...
      # the IBM Quantum Platform Home dashboard
