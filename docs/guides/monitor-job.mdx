...
You can cancel a job from the IBM Quantum Platform dashboard either on the Workloads page or the details page for a specific job. Click the menu with three vertical dots (at the end of the row on the Jobs page, or the top of the page on the Job details page), and select Cancel.
