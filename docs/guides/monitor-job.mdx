...
# Decide whether the 0th shot of parameter set (1, 2) occured in this span.
...
Excution spans can be filtered to include information pertaining to specific PUBs, selected by their indices:
