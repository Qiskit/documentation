...
*   IBM Quantum&trade; channel: In IBM Quantum Platform, open the [Workloads page](https://quantum.ibm.com/workloads).
...
The results of [`SamplerV2`](/api/qiskit-ibm-runtime/sampler-v-2) jobs executed in Qiskit Runtime contain execution timing information in their metadata.
