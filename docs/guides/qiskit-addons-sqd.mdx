...
![SQD diagram depicting configuration recovery, collecting subsamples, and obtaining eigenstates from those subsamples](/images/guides/qiskit-addons/sqd_diagram.avif)
...
<Admonition type="tip" title="Recommendations">
    - Read through the [SQD getting started](/guides/qiskit-addons-sqd-get-started) page.
