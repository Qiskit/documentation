...
description: Description of feature changes introduced in Qiskit v1.0 and how to update your code to work with them.
---

{/* cspell:ignore nbqa, ipynb, tqdm */}

# Qiskit v1.0 feature changes

This guide describes migration paths for the most important feature changes in Qiskit v1.0, organized by module.
Use the table of contents on the right side to navigate to the module you are interested in.

## Qiskit v1.0 migration tool
...
The `qiskit.Aer` object is not available in Qiskit v1.0. Instead, use the
...
The `qiskit.BasicAer` object is not available in Qiskit v1.0. See the
...
The `qiskit.execute` function is not available in Qiskit v1.0. This
function served as a high-level wrapper around the
[`transpile`](/docs/api/qiskit/compiler#transpile) and
[`run`](/docs/api/qiskit/qiskit.providers.BackendV2#run) functions in Qiskit.
Instead of `qiskit.execute`, use the
[`transpile`](/docs/api/qiskit/compiler#transpile) function followed by
[`backend.run()`](/docs/api/qiskit/qiskit.providers.BackendV2#run).
...
Alternatively, the [Sampler](/docs/api/qiskit/1.4/qiskit.primitives.Sampler)
primitive is semantically equivalent to the removed `qiskit.execute`
function. The class
[`BackendSampler`](/docs/api/qiskit/1.4/qiskit.primitives.BackendSampler) is a
...
[`qasm2.dump`](/docs/api/qiskit/qasm2#dump) or
[`qasm2.dumps`](/docs/api/qiskit/qasm2#dumps).
...
| Removed                      | Alternative |
|------------------------------|----------------------|
| `QuantumCircuit.cnot`        | [`QuantumCircuit.cx`](/docs/api/qiskit/qiskit.circuit.QuantumCircuit#cx)       |
| `QuantumCircuit.toffoli`     | [`QuantumCircuit.ccx`](/docs/api/qiskit/qiskit.circuit.QuantumCircuit#ccx)     |
| `QuantumCircuit.fredkin`     | [`QuantumCircuit.cswap`](/docs/api/qiskit/qiskit.circuit.QuantumCircuit#cswap) |
| `QuantumCircuit.mct`         | [`QuantumCircuit.mcx`](/docs/api/qiskit/qiskit.circuit.QuantumCircuit#mcx)     |
| `QuantumCircuit.i`           | [`QuantumCircuit.id`](/docs/api/qiskit/qiskit.circuit.QuantumCircuit#id)       |
| `QuantumCircuit.squ`         | [`QuantumCircuit.unitary`](/docs/api/qiskit/qiskit.circuit.QuantumCircuit#unitary) |
...
|------------------------------|----------------------|
| `QuantumCircuit.diagonal`    | [`DiagonalGate`](/docs/api/qiskit/qiskit.circuit.library.DiagonalGate)          |
| `QuantumCircuit.hamiltonian` | [`HamiltonianGate`](/docs/api/qiskit/qiskit.circuit.library.HamiltonianGate)    |
| `QuantumCircuit.isometry`    | [`Isometry`](/docs/api/qiskit/qiskit.circuit.library.Isometry)           |
| `QuantumCircuit.iso`         | [`Isometry`](/docs/api/qiskit/qiskit.circuit.library.Isometry)           |
| `QuantumCircuit.uc`          | [`UCGate`](/docs/api/qiskit/qiskit.circuit.library.UCGate)               |
| `QuantumCircuit.ucrx`        | [`UCRXGate`](/docs/api/qiskit/qiskit.circuit.library.UCRXGate)           |
| `QuantumCircuit.ucry`        | [`UCRYGate`](/docs/api/qiskit/qiskit.circuit.library.UCRYGate)           |
| `QuantumCircuit.ucrz`        | [`UCRZGate`](/docs/api/qiskit/qiskit.circuit.library.UCRZGate)           |

For example, for a [`DiagonalGate`](/docs/api/qiskit/qiskit.circuit.library.DiagonalGate):
...
| Removed                          | Alternative |
|----------------------------------|-------------|
| `QuantumCircuit.bind_parameters` | [`QuantumCircuit.assign_parameters`](/docs/api/qiskit/qiskit.circuit.QuantumCircuit#assign_parameters) |
...
[`DAGCircuit`](/docs/api/qiskit/qiskit.dagcircuit.DAGCircuit). As the legacy
...
[`QuantumCircuit.from_qasm_file`](/docs/api/qiskit/qiskit.circuit.QuantumCircuit#from_qasm_file)
or
[`QuantumCircuit.from_qasm_str`](/docs/api/qiskit/qiskit.circuit.QuantumCircuit#from_qasm_str)
constructor methods (or the [`qiskit.qasm2`](/docs/api/qiskit/qasm2) module), then
convert that `QuantumCircuit` into a
[`DAGCircuit`](/docs/api/qiskit/qiskit.dagcircuit.DAGCircuit) with
[`circuit_to_dag`](/docs/api/qiskit/converters#circuit_to_dag).
...
([`qiskit.circuit.library`](/docs/api/qiskit/circuit_library)). To migrate to the
...
The classes moved to [`qiskit.circuit.library`](/docs/api/qiskit/circuit_library) are:

* [`DiagonalGate`](/docs/api/qiskit/qiskit.circuit.library.DiagonalGate)
* [`HamiltonianGate`](/docs/api/qiskit/qiskit.circuit.library.HamiltonianGate)
* [`Initialize`](/docs/api/qiskit/qiskit.circuit.library.Initialize)
* [`Isometry`](/docs/api/qiskit/qiskit.circuit.library.Isometry)
* `qiskit.circuit.library.generalized_gates.mcg_up_diag.MCGupDiag`
* [`UCGate`](/docs/api/qiskit/qiskit.circuit.library.UCGate)
* [`UCPauliRotGate`](/docs/api/qiskit/qiskit.circuit.library.UCPauliRotGate)
* [`UCRXGate`](/docs/api/qiskit/qiskit.circuit.library.UCRXGate)
* [`UCRYGate`](/docs/api/qiskit/qiskit.circuit.library.UCRYGate)
* [`UCRZGate`](/docs/api/qiskit/qiskit.circuit.library.UCRZGate)
* [`UnitaryGate`](/docs/api/qiskit/qiskit.circuit.library.UnitaryGate)
...
Removed                          |   Alternative
---------------------------------|--------------------------------------------
`SingleQubitUnitary`    |  [`qiskit.circuit.library.UnitaryGate`](/docs/api/qiskit/qiskit.circuit.library.UnitaryGate)
...
The most notable change in the [`qiskit.primitives`](/docs/api/qiskit/primitives) module is the
...
Starting with the v1.0 release, we will refer to the pre-1.0 primitives interface as "primitives V1".
</Admonition>
...
---------------------------------|--------------------------------------------
`BaseEstimator`         |  [`BaseEstimatorV2`](/docs/api/qiskit/qiskit.primitives.BaseEstimatorV2)
`BaseSampler`             |  [`BaseSamplerV2`](/docs/api/qiskit/qiskit.primitives.BaseSamplerV2)
...
Migrate from                     |   Replace with
---------------------------------|--------------------------------------------
`qiskit.primitives.Estimator`         |  [`qiskit.primitives.StatevectorEstimator`](/docs/api/qiskit/qiskit.primitives.StatevectorEstimator)
`qiskit.primitives.Sampler`             |  [`qiskit.primitives.StatevectorSampler`](/docs/api/qiskit/qiskit.primitives.StatevectorSampler)
...
2. [Sampler](/docs/api/qiskit/qiskit.primitives.BaseSamplerV2): The V2 sampler now
...
3. `Sampler and Estimator`: The sampling overhead, commonly exposed by V1 implementations
  ...
  The V2 base classes expose the arguments in formats different from the V1 API:
    ...
    * [`BaseSamplerV2.run`](/docs/api/qiskit/qiskit.primitives.BaseSamplerV2#run)
    ...
    * [`EstimatorV2.run`](/docs/api/qiskit/qiskit.primitives.BaseEstimatorV2#run)
...
* Implicit conversion from a dense `BaseOperator` to a
  [`SparsePauliOp`](/docs/api/qiskit/qiskit.quantum_info.SparsePauliOp) in
  [`Estimator`](/docs/api/qiskit/1.4/qiskit.primitives.Estimator) observable arguments
  is no longer allowed. You should explicitly convert to a `SparsePauliOp`
by using
  [`SparsePauliOp.from_operator(operator)`](/docs/api/qiskit/qiskit.quantum_info.SparsePauliOp#from_operator)
  instead.

* Using a [`PauliList`](/docs/api/qiskit/qiskit.quantum_info.PauliList) in
  Estimator observable arguments is no longer allowed. Instead you should
  explicitly convert the argument by using
  [`SparsePauliOp(pauli_list)`](/docs/api/qiskit/qiskit.quantum_info.SparsePauliOp)
  first.
...
[`qiskit.providers.basic_provider`](/docs/api/qiskit/providers_basic_provider)
...
the [`quantum_info`](/docs/api/qiskit/quantum_info) module.
...
Removed                          | Alternative
---------------------------------|--------------------------------------------
`qiskit.providers.basicaer`                            |  [`qiskit.providers.basic_provider`](/docs/api/qiskit/providers_basic_provider)
`BasicAerProvider`             |  [`BasicProvider`](/docs/api/qiskit/qiskit.providers.basic_provider.BasicProvider)
`BasicAerJob`                       |  [`BasicProviderJob`](/docs/api/qiskit/qiskit.providers.basic_provider.BasicProviderJob)
`QasmSimulatorPy`               |  [`BasicSimulator`](/docs/api/qiskit/qiskit.providers.basic_provider.BasicSimulator)
...
different [`quantum_info`](/docs/api/qiskit/quantum_info) classes. This is not a
drop-in replacement, but the changes are minimal. See the following migration
examples:

Removed                          |   Alternative
---------------------------------|--------------------------------------------
`UnitarySimulatorPy`         |  [`quantum_info.Operator`](/docs/api/qiskit/qiskit.quantum_info.Operator)
`StatevectorSimulatorPy` |  [`quantum_info.Statevector`](/docs/api/qiskit/qiskit.quantum_info.Statevector)
...
<Admonition type="note">
    ...
    * [`qiskit.providers.fake_provider.Fake5QV1`](/docs/api/qiskit/1.4/qiskit.providers.fake_provider.Fake5QV1)
    * [`qiskit.providers.fake_provider.Fake20QV1`](/docs/api/qiskit/1.4/qiskit.providers.fake_provider.Fake20QV1)
    * [`qiskit.providers.fake_provider.Fake7QPulseV1`](/docs/api/qiskit/1.4/qiskit.providers.fake_provider.Fake7QPulseV1)
    * [`qiskit.providers.fake_provider.Fake27QPulseV1`](/docs/api/qiskit/1.4/qiskit.providers.fake_provider.Fake27QPulseV1)
    * [`qiskit.providers.fake_provider.Fake127QPulseV1`](/docs/api/qiskit/1.4/qiskit.providers.fake_provider.Fake127QPulseV1)

    This is a configurable class that returns `BackendV2` instances:

    * [`qiskit.providers.fake_provider.GenericBackendV2`](/docs/api/qiskit/qiskit.providers.fake_provider.GenericBackendV2)
</Admonition>
...
[`GenericBackendV2`](/docs/api/qiskit/qiskit.providers.fake_provider.GenericBackendV2)
class to configure a backend with similar properties or to build a custom
target.

Removed                          |   Alternative
---------------------------------|--------------------------------------------
`fake_provider.FakeBackendV2` | [`fake_provider.GenericBackendV2`](/docs/api/qiskit/qiskit.providers.fake_provider.GenericBackendV2)
`fake_provider.FakeBackend5QV2` | [`fake_provider.GenericBackendV2`](/docs/api/qiskit/qiskit.providers.fake_provider.GenericBackendV2)
`fake_provider.FakeBackendV2LegacyQubitProps` | [`fake_provider.GenericBackendV2`](/docs/api/qiskit/qiskit.providers.fake_provider.GenericBackendV2)
`fake_provider.FakeBackendSimple` | [`fake_provider.GenericBackendV2`](/docs/api/qiskit/qiskit.providers.fake_provider.GenericBackendV2)
`fake_provider.ConfigurableFakeBackend` | [`fake_provider.GenericBackendV2`](/docs/api/qiskit/qiskit.providers.fake_provider.GenericBackendV2)
...
* Support for running pulse jobs on backends from
  [`qiskit.providers.fake_provider`](/docs/api/qiskit/providers_fake_provider) has
  been removed in Qiskit v1.0.  This is because Qiskit Aer removed its
...
[`qiskit.pulse.SymbolicPulse`](/docs/api/qiskit/1.4/qiskit.pulse.library.SymbolicPulse)
and the corresponding pulse library. `SymbolicPulse` supports
[QPY](/docs/api/qiskit/qpy) serialization:
...
Removed                          |   Alternative
---------------------------------|--------------------------------------------
`pulse.library.parametric_pulses.ParametricPulse` | [`qiskit.pulse.SymbolicPulse`](/docs/api/qiskit/1.4/qiskit.pulse.library.SymbolicPulse)
`pulse.library.parametric_pulses.Constant` |  [`pulse.library.symbolic_pulses.Constant`](/docs/api/qiskit/1.4/qiskit.pulse.library.Constant)
`pulse.library.parametric_pulses.Drag` |  [`pulse.library.symbolic_pulses.Drag`](/docs/api/qiskit/1.4/qiskit.pulse.library.Drag)
`pulse.library.parametric_pulses.Gaussian` |  [`pulse.library.symbolic_pulses.Gaussian`](/docs/api/qiskit/1.4/qiskit.pulse.library.Gaussian)
`qiskit.pulse.library.parametric_pulses.GaussianSquare` |  [`pulse.library.symbolic_pulses.GaussianSquare`](/docs/api/qiskit/1.4/qiskit.pulse.library.GaussianSquare)
...
[`qiskit.pulse.builder.call`](/docs/api/qiskit/1.4/pulse#call) is no longer possible.
...
Similarly, a [`QuantumCircuit`](/docs/api/qiskit/qiskit.circuit.QuantumCircuit) can
...
[`QuantumCircuit.add_calibration`](/docs/api/qiskit/1.4/qiskit.circuit.QuantumCircuit#add_calibration)
...
[`qiskit.pulse.SymbolicPulse`](/docs/api/qiskit/1.4/qiskit.pulse.library.SymbolicPulse),
with
[`SymbolicPulse.get_waveform()`](/docs/api/qiskit/1.4/qiskit.pulse.library.SymbolicPulse#get_waveform).
For example, instead of `pulse.gaussian(100,0.5,10)`, use
`pulse.Gaussian(100,0.5,10).get_waveform()`. Note that the phase of both
[`Sawtooth`](/docs/api/qiskit/1.4/qiskit.pulse.library.Sawtooth) and
[`Square`](/docs/api/qiskit/1.4/qiskit.pulse.library.Square) is defined such
...
* [`qiskit.pulse.Constant`](/docs/api/qiskit/1.4/qiskit.pulse.library.Constant)
* [`qiskit.pulse.Drag`](/docs/api/qiskit/1.4/qiskit.pulse.library.Drag)
* [`qiskit.pulse.Gaussian`](/docs/api/qiskit/1.4/qiskit.pulse.library.Gaussian)
* [`qiskit.pulse.GaussianSquare`](/docs/api/qiskit/1.4/qiskit.pulse.library.GaussianSquare)
...
been superseded by the [`qiskit.qasm2`](/docs/api/qiskit/qasm2) module, which
provides a faster and more accurate parser for OpenQASM 2. The high level
`QuantumCircuit` methods
[`from_qasm_file()`](/docs/api/qiskit/qiskit.circuit.QuantumCircuit#from_qasm_file)
and
[`from_qasm_str()`](/docs/api/qiskit/qiskit.circuit.QuantumCircuit#from_qasm_str)
...
outputs a [`QuantumCircuit`](/docs/api/qiskit/qiskit.circuit.QuantumCircuit) object.
...
locations in the codebase, mostly [`qiskit.synthesis`](/docs/api/qiskit/synthesis).

Removed    | Alternative
-----------|------------
`OneQubitEulerDecomposer` | [`qiskit.synthesis.one_qubit.OneQubitEulerDecomposer`](/docs/api/qiskit/qiskit.synthesis.OneQubitEulerDecomposer)
`TwoQubitBasisDecomposer` | [`qiskit.synthesis.two_qubits.TwoQubitBasisDecomposer`](/docs/api/qiskit/qiskit.synthesis.TwoQubitBasisDecomposer)
`XXDecomposer` | [`qiskit.synthesis.two_qubits.XXDecomposer`](/docs/api/qiskit/qiskit.synthesis.XXDecomposer)
`two_qubit_cnot_decompose` | [`qiskit.synthesis.two_qubits.two_qubit_cnot_decompose`](/docs/api/qiskit/synthesis#qiskit.synthesis.two_qubit_cnot_decompose)
`Quaternion` | [`qiskit.quantum_info.Quaternion`](/docs/api/qiskit/qiskit.quantum_info.Quaternion)
...
The `qiskit.tools` module was removed in Qiskit v1.0. Most of this functionality was
...
the [`qiskit.utils`](/docs/api/qiskit/utils#parallel_map) module. It can be used
...
[`BackendV2`](/docs/api/qiskit/qiskit.providers.BackendV2) interface.
...
[`BackendV2`](/docs/api/qiskit/qiskit.providers.BackendV2) interface). There is
...
was moved to [`qiskit.visualization`](/docs/api/qiskit/visualization) in Qiskit
...
Removed    | Alternative
-----------|------------
`qiskit.transpiler.synthesis.aqc` (except for [`AQCSynthesisPlugin`](/docs/api/qiskit/qiskit.transpiler.passes.synthesis.aqc_plugin.AQCSynthesisPlugin)) | [`qiskit.synthesis.unitary.aqc`](/docs/api/qiskit/qiskit.synthesis.unitary.aqc)
`qiskit.transpiler.synthesis.graysynth` | [`qiskit.synthesis.synth_cnot_phase_aam`](/docs/api/qiskit/synthesis#synth_cnot_phase_aam)
`qiskit.transpiler.synthesis.cnot_synth` | [`qiskit.synthesis.synth_cnot_count_full_pmh`](/docs/api/qiskit/synthesis#synth_cnot_count_full_pmh)

<span id="transpiler.passes"></span>
### passes

The `NoiseAdaptiveLayout` transpiler pass has been superseded by
[`VF2Layout`](/docs/api/qiskit/qiskit.transpiler.passes.VF2Layout) and
[`VF2PostLayout`](/docs/api/qiskit/qiskit.transpiler.passes.VF2PostLayout),
...
[`ConditionalController`](/docs/api/qiskit/qiskit.passmanager.ConditionalController),
[`FlowControllerLinear`](/docs/api/qiskit/qiskit.passmanager.FlowControllerLinear), and
[`DoWhileController`](/docs/api/qiskit/qiskit.passmanager.DoWhileController) classes
