...
* Coherence times for [$T_1$](/docs/guides/qpu-information#median-t1-relaxation-time) and [$T_2$](/docs/guides/qpu-information#median-t2-dephasing-time)
...
* [CZ and RZZ fractional gate EPG (Heron), ECR (Eagle)](/docs/guides/qpu-information#median-2q-error-heron-cz-eagle-ecr
) as measured by RB on those gates 
