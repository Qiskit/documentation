...
This calibration degrades results when the circuits involved have bitstrings that can be classically distilled. That is, peaked circuits (circuits engineered to concentrate probability weight on a single bitstring), and [SQD or SKQD](/courses/integrating-quantum-and-high-performance-computing/sqd-skqd) workflows.
