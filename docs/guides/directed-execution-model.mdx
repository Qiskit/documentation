...
```
The inputs and output of the Executor primitive is very different from those of Sampler and Estimator. Refer to its [API reference](https://qiskit.github.io/qiskit-ibm-runtime/stubs/qiskit_ibm_runtime.Executor.html) for more information.
