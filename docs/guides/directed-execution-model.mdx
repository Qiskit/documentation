...
The inputs and output of the Executor primitive are very different from those of Sampler and Estimator. Refer to the [Executor input and output topic](/docs/guides/executor-input-output) for more information. In addition, the [Executor quickstart guide](https://qiskit.github.io/qiskit-ibm-runtime/guides/executor_basic.html) provides an overview and code examples.
