...
f.close()
```
For more information, see the [Exporting to OpenQASM 3](/api/qiskit/qasm-3#exporting-to-openqasm-3) section of the API reference.
...
<Admonition type="tip" title="Recommendations">
    ...
    - Review the [OpenQASM 3 Qiskit API](/api/qiskit/qasm-3) reference.
