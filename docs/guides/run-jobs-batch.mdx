...
Batch mode can shorten processing time if all jobs can be provided at the outset. If you want to submit iterative jobs, use [sessions](/guides/execution-modes) instead.  Using batch mode has these benefits:
