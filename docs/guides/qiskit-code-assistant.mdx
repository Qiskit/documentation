...
<Admonition type="tip" title="Recommendations">
  ...
  - See examples to use the Qiskit Code Assistant for [circuits](/guides/circuit-library), [configuring error suppression](/guides/configure-error-suppression), and [transpiling with pass managers.](/guides/transpile-with-pass-managers)
</Admonition>
