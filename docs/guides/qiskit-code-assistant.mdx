...
Qiskit Code Assistant aims to make quantum computing more accessible to new Qiskit adopters and to improve the coding experience for current users. It is trained using millions of text tokens from Qiskit SDK, years of Qiskit code examples, and IBM Quantum&reg; features. Qiskit Code Assistant can help your quantum development workflow by offering LLM-generated suggestions based on [IBM Granite models](https://www.ibm.com/products/watsonx-ai/foundation-models), which incorporate the latest features and functionalities from IBM&reg;.

To skip to installation instructions, go to the [Install Qiskit Code Assistant](#install) section.
