...
* Extensions available for [Visual Studio Code](https://code.visualstudio.com/) (VS Code) and [JupyterLab.](https://jupyterlab.readthedocs.io/en/latest/)
* Includes guardrails to avoid answering questions that represent a potential risk, such as hateful speech.

## Install the extensions

Use  the official extensions for JupyterLab and VSCode to integrate Qiskit Code Assistant directly into your  development environment.
...
## Get started using the Qiskit Code Assistant
