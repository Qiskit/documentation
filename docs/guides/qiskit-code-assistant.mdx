...
<Admonition type="note" title="Notes">
    - **Want to skip to the installation instructions? Go to the [Install Qiskit Code Assistant](#install) section.**
...
1. Install the [Hugging Face CLI](https://huggingface.co/docs/huggingface_hub/main/guides/cli)
...
#### [Jupyter AI](https://jupyter-ai.readthedocs.io/v3/index.html) (JupyterLab)
