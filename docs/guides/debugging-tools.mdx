---
title: Introduction
description: Introduction to using simulators for testing and debugging quantum circuits in Qiskit.
---
# Introduction 
...
Stabilizer circuits, also known as Clifford circuits, are a useful tool for accomplishing this latter goal. These are a restricted class of quantum circuits that can be efficiently simulated classically. Specialized simulators can easily simulate stabilizer circuits with thousands of qubits. See [Efficient simulation of stabilizer circuits with Qiskit Aer primitives](/docs/guides/simulate-stabilizer-circuits) for more information.

For general quantum circuits, the following tools are available to test and debug your quantum programs:

- For exact simulation of small quantum circuits, you can use the reference primitives included with Qiskit. See [Exact simulation with Qiskit SDK primitives](/docs/guides/simulate-with-qiskit-sdk-primitives).
...
- To build custom noise models, use the [`noise`](https://qiskit.org/ecosystem/aer/apidocs/aer_noise.html) module of Qiskit Aer. See [Building noise models](/docs/guides/build-noise-models).
...
- The only requirement to run Qiskit is a functioning Python environment.  For details, see the [Operating system support](/docs/guides/install-qiskit#operating-system-support) section.
...
- To get the most benefit out of your hardware, use local stabilizer (Clifford) circuit simulation when possible.  See [Clifford simulation with Qiskit Runtime local testing mode](local-testing-mode#clifford-simulation) or [Efficient simulation of stabilizer circuits with Qiskit Aer primitives](/docs/guides/simulate-stabilizer-circuits) for examples.
...
<Admonition type="tip" title="Recommendations">
    ...
    - Review the [circuit visualization](/docs/guides/visualize-circuits) documentation.
    - Review the [circuit timing visualization](/docs/guides/visualize-circuit-timing) documentation.
    - [Debug Qiskit Runtime jobs](/docs/guides/debug-qiskit-runtime-jobs).
</Admonition>