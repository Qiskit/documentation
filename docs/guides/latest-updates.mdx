...
Jump to [IBM Quantum Platform](#latest-platform) | [Qiskit SDK](#latest-qiskit-sdk) | [Qiskit IBM Runtime client](#latest-qiskit-runtime-client) | [Qiskit IBM Runtime](#latest-qiskit-runtime) | [Qiskit Transpiler Service](#latest-qiskit-transpiler-service) | [Qiskit addons](#latest-qiskit-addons) | [Qiskit Functions](#latest-qiskit-functions) | [Qiskit Code Assistant](#latest-qca)
...
- **Qiskit Runtime service is now IBM Quantum Compute Service** &mdash; Qiskit Runtime previously referred to both an internal runtime mechanism and IBM's managed execution service. The new naming clearly separates Qiskit, the open-source SDK for building portable quantum applications, from IBM Quantum Compute, the managed service for executing on IBM Quantum hardware. This provides a clearer architecture without changing workflows, APIs, access plans, or the user experience.
...
## Qiskit IBM Runtime client 0.46.0
...
This summary of the latest changes to the Qiskit IBM Runtime applies to anyone executing on IBM Quantum hardware, regardless of how you communicate with the service (by using `qiskit-ibm-runtime` or otherwise), or which version of the client SDK you use.
