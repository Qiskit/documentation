...
[Developers can set detailed statuses and track what's happening across a workflow](https://docs.quantum.ibm.com/guides/serverless-manage-resources#set-detailed-statuses)
