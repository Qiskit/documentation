...
- **Qiskit Code Assistant service discontinued** - The preview service has been discontinued and the Visual Studio Code and JupyterLab extensions have been archived.
  ...
  Qiskit Code Assistant models remain available for local use. See [Use Qiskit Code Assistant in local mode](/docs/guides/qiskit-code-assistant#use-qiskit-code-assistant-in-local-mode).
