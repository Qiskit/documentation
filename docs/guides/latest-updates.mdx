...
Explore the [v1.3 release notes](/api/qiskit/release-notes), and read about this release on the [IBM Quantum blog](https://www.ibm.com/quantum/blog/qiskit-1-3-release-summary).
