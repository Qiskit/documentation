...
- **Compute resources page now displays QPU scheduled maintenance.** The [Compute resources page](https://quantum.cloud.ibm.com/computers) now includes a link to upcoming or active planned maintenance for QPUs in your selected region. This feature gives you the transparency you need to plan your workloads around expected downtimes.
