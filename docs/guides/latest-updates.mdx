...
- **Cost limits for Standard (Pay-As-You-Go) Plan** - Standard Plan users with sufficient access can now view and edit [maximum cost limits](/docs/guides/manage-cost#cost-limit) for their instances.
