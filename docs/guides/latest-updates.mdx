...
- Copyediting and typo fixes across the docs, including bugs reported by open-source contributors - thank you!
...
- We improved the design and color of the warning banner for when you access outdated API pages to make it easier to realize that newer docs are available. The banner persists as you scroll down the page.
