...
- **Cost limits for Standard Plan** - Standard Plan users with sufficient access can now view and edit [maximum cost limits](/guides/upgrade-from-open#set-the-maximum-cost-limit) for their instances.
