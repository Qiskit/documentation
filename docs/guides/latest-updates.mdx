...
Jump to [IBM Quantum Platform](#latest-platform) | [Qiskit SDK](#latest-qiskit-sdk) | [IBM Qiskit Runtime client](#latest-qiskit-runtime-client) | [IBM Qiskit Runtime](#latest-qiskit-runtime) | [Qiskit Transpiler Service](#latest-qiskit-transpiler-service) | [Qiskit addons](#latest-qiskit-addons) | [Qiskit Functions](#latest-qiskit-functions) | [Qiskit Code Assistant](#latest-qca)
...
<span id="latest-quantum-compute-service"></span>
...
This summary of the latest changes to the IBM Qiskit Runtime execution environment to anyone executing Qiskit Primitives on IBM Quantum hardware, regardless of how you communicate with it (by using `qiskit-ibm-runtime` or otherwise), or which version of the client SDK you use.
