...
- We're excited to roll out two new functions for finance and optimization:
  ...
  - [Quantum Portfolio Optimizer](https://quantum.cloud.ibm.com/functions?id=global-data-quantum-dynamic-portfolio-optimization) by Global Quantum Data enables quantitative finance researchers to backtest portfolio optimization strategies. Running on over 100 qubits, this function calculates a portfolio’s Sharpe ratio versus return across a specified time period. Early users are exploring the optimizer’s ability to evaluate historical performance of an investment strategy and to enable comparisons of different portfolios under similar conditions.
