...
### Major upgrades coming for IBM Quantum Platform, plus Heron access for Open Plan users
...
We are upgrading the Platform as part of our effort to deliver an enterprise-grade cloud experience that leverages new backend infrastructure for enhanced features, increased performance, and the latest data privacy and security measures. These changes lay a foundation to support the scaling of our services alongside the IBM Quantum Roadmap, and to enable the increasingly complex workloads that are required to achieve quantum advantage. 
...
<CloudContent>
- Guidance on how to [securely manage your API token](/guides/cloud-setup)
</CloudContent>
