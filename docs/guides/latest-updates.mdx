...
- We fixed several broken links in historical API docs.
- We improved the design and color of the warning banner for when you access outdated API pages to make it easier to realize that newer docs are available. The banner also now persists as you scroll down the page.
