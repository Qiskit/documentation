...
- Released Flex Plan offering - a new resource consumption offering.
- [Tutorials](https://quantum.cloud.ibm.com/docs/tutorials) are now available on the new platform to help users with use-case exploration.
- Updated Session OpenAPI schema: `backend_name` field is now nullable.
- Launched the [Qiskit Functions Catalog](https://quantum.cloud.ibm.com/functions) on the new platform.
