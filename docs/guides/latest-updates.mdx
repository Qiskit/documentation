...
- Learning: New learning resources, including courses and modules, are now available to help you improve your skills and knowledge. Access these resources without logging in on [IBM Quantum Learning.](https://quantum.cloud.ibm.com/learning)
- Announcements: Announcements have been migrated to the new platform. Click the bell icon in the top navigation bar or visit the [Announcements](https://quantum.cloud.ibm.com/announcements) page.
