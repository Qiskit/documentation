...
<Admonition type="tip" title="Recommendations">
    ...
    - Practice with primitives by working through the [Cost function lesson](/learning/en/courses/variational-algorithm-design/cost-functions) in IBM Quantum Learning.
