...
- [Directed execution model](/docs/guides/tool-index#directed-execution-model) - Generate and execute circuit variants based on directives defined with Samplomatic