...
* `ai_layout_mode` - Specifies how the AI routing part of the PassManager handles the layout. Refer to the #AI-routing-pass section to review the configuration options for this `ai_layout_mode` parameter.
