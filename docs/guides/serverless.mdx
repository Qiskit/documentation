...
The following compute resources are included by default in the Qiskit Serverless environment. Users can contact (((Who?))) to increase any of these.

- 16 vCPU cores
- 64GB RAM
- Maximum two active jobs per user at any one time
