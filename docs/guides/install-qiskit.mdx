...
This documentation is relevant to IBM Quantum&reg; Platform Classic. If you need the newer version, go to the new [IBM Quantum Platform documentation.](https://quantum.cloud.ibm.com/docs/guides/install-qiskit)
</Admonition>
</LegacyContent>
<CloudContent>
<Admonition type="note">
This documentation is relevant to the new IBM Quantum&reg; Platform. If you need the previous version, return to the [IBM Quantum Platform Classic documentation.](https://docs.quantum.ibm.com/guides/install-qiskit)
</Admonition>
</CloudContent>
...
<ImageLink
  ...
  src="/images/guides/install-qiskit/youtube-thumbnail.avif"
/>
...
<CloudContent>
  - Set up your [IBM Cloud account.](/guides/cloud-setup)
</CloudContent>
