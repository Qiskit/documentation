...
<Admonition type="tip" title="Recommendations">
  ...
  -  [Install Qiskit Runtime from source.](/docs/guides/install-qiskit-runtime-source.mdx)
  -  Follow the steps in the [Quickstart](/docs/guides/quick-start) guide to write and run a simple quantum program.
