...
Provides access to IBM Quantum cloud services through the IBM Quantum Compute Service. This enables AI assistants to interact with quantum backends, submit jobs, and retrieve results.
...
For IBM Quantum Compute Service, or Qiskit IBM Transpiler MCP Servers:
