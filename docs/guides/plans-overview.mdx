...
description: Overview of the available plans, including Pay-As-You-Go, Premium, and Open
...
Run your quantum circuits on the world's best QPUs for free (up to 10 minutes per 28-day rolling window). You can track your usage on the [Platform dashboard](https://quantum.cloud.ibm.com/) and the [Workloads](https://quantum.cloud.ibm.com/workloads) pages.  Open Plan instances can only be created in the us-east region (you can switch regions from the drop-down menu at the top of the Platform dashboard). [Click to go the sign-up page](https://quantum.cloud.ibm.com/registration).

This plan is recommended for those who are learning quantum computing and exploring IBM quantum technology.

<Admonition type="note" title="Limited time promotion">
As of 16 March 2026, active Open Plan users can opt in to an additional 180 minutes over the next 12 months.
Read the [Doubling down on open-access quantum computing](https://www.ibm.com/quantum/blog/open-plan-updates) blog for full details.
</Admonition>
...
Run quantum circuits on the world's best QPUs and pay only for the QPU consumption you use.
...
Run quantum circuits on the world's best QPUs using an enterprise subscription. Additionally, some functionality, such as [Qiskit Functions](/docs/guides/functions), is available to Premium Plan users.
...
<Admonition type="tip" title="Recommendations">
  -  [Compare available plans](https://www.ibm.com/quantum/products).
  -  Understand what counts as [usage](/docs/guides/estimate-job-run-time).
  -  Learn about the [fair-share scheduler](/docs/guides/fair-share-scheduler)
  -  Access plans by creating [instances](/docs/guides/instances).
  -  [Upgrade from the Open Plan](/docs/guides/upgrade-from-open).
</Admonition>
