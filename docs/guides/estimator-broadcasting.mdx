...
![This image illustrates several visual representations of array broadcasting](/docs/images/guides/pubs-broadcasting/broadcasting.avif "Visual representation of broadcasting")
...
<Admonition type="tip" title="Recommendations">
    - See the [broadcasting guide](/docs/guides/pubs-broadcasting#broadcasting) for an overview of broadcasting.
    - Learn about [PUBs](/docs/guides/pubs-broadcasting#pubs).
