---
title: Broadcasting
description: How Estimator handles array inputs and outputs using broadcasting semantics

---

# Estimator broadcasting semantics

When invoking an Estimator primitive's [`run()`](/docs/api/qiskit-ibm-runtime/estimator-v2#run) method, the main argument that is required is a tuple called a [PUB](/docs/guides/primitive-input-output#pubs). The data provided to these tuples can be arranged in a variety of shapes to provide flexibility in a workload through [broadcasting](/docs/guides/primitive-input-output#broadcasting). This guide explains how Estimator handles array inputs and outputs using broadcasting semantics.
...
<Admonition type="tip" title="Recommendations">
    - See the [broadcasting guide](/docs/guides/primitive-input-output#broadcasting) for an overview of broadcasting.
    - Learn about [PUBs](/docs/guides/primitive-input-output#pubs).
