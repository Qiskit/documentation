...
![A two-qubit quantum circuit containing a Hadamard and two CNOT gates.](/images/guides/pre-transpiled.png "Quantum circuit")
...
![The same two-qubit quantum circuit after transpilation.  It contains RZ, X, SX, and ECR gates.](/images/guides/transpiled.png "Quantum circuit after transpilation")
