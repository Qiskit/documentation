...
This documentation is relevant to IBM Quantum&reg; Platform Classic. If you need the newer version, go to the new [IBM Quantum Platform documentation.](https://quantum.cloud.ibm.com/docs/guides/native-gates)
</Admonition>
</LegacyContent>
<CloudContent>
<Admonition type="note">
This documentation is relevant to the new IBM Quantum&reg; Platform. If you need the previous version, return to the [IBM Quantum Platform Classic documentation.](https://docs.quantum.ibm.com/guides/native-gates)
</Admonition>
</CloudContent>
...
You can view the native gates and operations for a QPU either [with Qiskit](#native-gates-with-qiskit) or on the IBM Quantum&reg; Platform [Compute resources page](#native-gates-on-platform).
...
<CloudContent>
Select any QPU on the [Compute resources](https://quantum.cloud.ibm.com/computers) page. The default gates for that QPU are listed under Details. Note that the non-unitary operations are not listed here; use the method in Qiskit described above to see all native gates and operations for a QPU.
</CloudContent>
...
| [for_loop](/docs/api/qiskit/qiskit.circuit.ForLoopOp) | control flow for classical feedforward |
| [switch_case](/docs/api/qiskit/qiskit.circuit.SwitchCaseOp) | control flow for classical feedforward |
...
| Name |  Notes |
| :--- | :--- |
| [CX](/docs/api/qiskit/qiskit.circuit.library.CXGate)  | two-qubit gate |
| [RZ](/docs/api/qiskit/qiskit.circuit.library.RZGate) | single-qubit gate |
| [ID](/docs/api/qiskit/qiskit.circuit.library.IGate) | single-qubit gate wait cycle |
| [reset](/docs/api/qiskit/circuit#qiskit.circuit.Reset)  | single-qubit gate, non-unitary; not the same as the initialization done at the start of a circuit to prepare the all 0's state |
| [if_else](/docs/api/qiskit/qiskit.circuit.IfElseOp) | control flow for classical feedforward |
