...
<Admonition type="note" title="Responsible quantum computing">
IBM is committed to the responsible development of quantum computing. Please familiarize yourself with the [terms and conditions](https://quantum.ibm.com/terms), which forbid uses of our services relating to weaponry, defeating encryption, and processing regulated data. Learn more about responsible quantum at IBM, review our responsible quantum principles, and flag responsible quantum computing issues in the [Responsible quantum computing and inclusive tech](/responsible-quantum-computing) topic.
</Admonition>
