...
|                      | [layer_noise_model](/api/qiskit-ibm-runtime/qiskit_ibm_runtime.options.ResilienceOptionsV2#layer_noise_model)       |        | `UnsetType`/`NoiseLearnerResult`/`Sequence[LayerError]`                      | `Unset`                      |                      |
