...
description: Available options for building with qiskit-ibm-runtime primitives
...
# Introduction to options
 ...
 You can use options to customize `qiskit-ibm-runtime` primitives to meet your needs.
