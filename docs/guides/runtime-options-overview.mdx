...
description: Available options for building with IBM Quantum primitives
...
# Introduction to options
 ...
 You can use options to customize IBM Quantum primitives to meet your needs.
...
See [`SamplerOptions`](/docs/api/qiskit-ibm-runtime/options-models-sampler-options) or [`EstimatorOptions`](/docs/api/qiskit-ibm-runtime/options-models-estimator-options) for full details about the class.
...
The primitive's options class ([`EstimatorOptions`](/docs/api/qiskit-ibm-runtime/options-models-estimator-options) or [`SamplerOptions`](/docs/api/qiskit-ibm-runtime/options-models-sampler-options)) does not need to be instantiated if you are setting options after initializing the primitive.
