...
This guide walks you through migrating from IBM Quantum&reg; `NoiseLearner` to `NoiseLearnerV3`. Both
...
Most [`NoiseLearnerOptions`](/docs/api/qiskit-ibm-runtime/options-models-noise-learner-options) fields map directly to [`NoiseLearnerV3Options`](/docs/api/qiskit-ibm-runtime/options-models-noise-learner-v3-options), except the following:
