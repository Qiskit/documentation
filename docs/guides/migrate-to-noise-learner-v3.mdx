...
The [`NoiseLearner`](https://quantum.cloud.ibm.com/docs/api/qiskit-ibm-runtime/noise-learner-noise-learner)
...
[`NoiseLearnerV3`](https://quantum.cloud.ibm.com/docs/api/qiskit-ibm-runtime/noise-learner-v3-noise-learner-v3)
...
lets you control how to stratify your circuits, and the class simply takes a list of boxed circuit instructions
...
The `NoiseLearner` `run()` method takes a list of circuits or PUBs, whereas the `NoiseLearnerV3` `run()` method takes a list of instructions, each of which must be a twirling-annotated [BoxOp](https://quantum.cloud.ibm.com/docs/api/qiskit/qiskit.circuit.BoxOp) containing ISA operations.
...
Most [`NoiseLearnerOptions`](https://quantum.cloud.ibm.com/docs/api/qiskit-ibm-runtime/options-noise-learner-options) fields map directly to [`NoiseLearnerV3Options`](https://quantum.cloud.ibm.com/docs/api/qiskit-ibm-runtime/options-models-noise-learner-v3-options), except the following:
...
| --- | --- | --- |
| Result type | [NoiseLearnerResult](https://quantum.cloud.ibm.com/docs/api/qiskit-ibm-runtime/results-noise-learner-result#noiselearnerresult) | [NoiseLearnerV3Results](https://quantum.cloud.ibm.com/docs/api/qiskit-ibm-runtime/results-noise-learner-v3-results), a sequence-like container of [NoiseLearnerV3Result](https://quantum.cloud.ibm.com/docs/api/qiskit-ibm-runtime/results-noise-learner-v3-result) |
...
| Result type of each layer | [LayerError](https://quantum.cloud.ibm.com/docs/api/qiskit-ibm-runtime/results-layer-error) (`type(layer_error)`) | [PauliLindbladMap](https://quantum.cloud.ibm.com/docs/api/qiskit/qiskit.quantum_info.PauliLindbladMap) (`type(noise_map)`) |
