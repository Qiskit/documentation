...
![IBM Quantum Composer window.](https://learning-api.quantum.ibm.com/assets/52af25d0-aafe-4a4d-b92b-91cd3a3c54a1)
...
![A set of selected operations.](https://learning-api.quantum.ibm.com/assets/3c5c063d-b15f-43cb-bb65-9728187454d8)

Select Copy from the contextual menu to copy the group.

![Right-click menu options.](https://learning-api.quantum.ibm.com/assets/611ee5a8-cd08-401c-ba8c-6b40a7a55c21)
...
![Create a custom operation by grouping.](https://learning-api.quantum.ibm.com/assets/6ebf7cf5-dc36-49d4-ba78-f1af9ea55972)
...
![control modifier.](https://learning-api.quantum.ibm.com/assets/c5bb3c7b-3b9b-480b-8b17-e8c5fdf54543)
...
![cust-icon-explod](https://learning-api.quantum.ibm.com/assets/763d3b42-4b6e-4409-817f-7d15abae2d76)

b) The code for the new operation:

![cust-qasm](https://learning-api.quantum.ibm.com/assets/db5856ca-751c-4f12-9f25-6060b9003687)

c) The new operation in the graphical editor:

![cust-icon](https://learning-api.quantum.ibm.com/assets/d7fb8ec5-5eae-4ad4-9972-1e3665b39b7f)
...
![Circuit Inspector.](https://learning-api.quantum.ibm.com/assets/138134c2-cdfb-4a8b-918d-98df70fb8e3c)
...
![Controls to step forward and backward, and to jump to a circuit's beginning or end.](https://learning-api.quantum.ibm.com/assets/5f2dfb7c-a244-405c-8950-f422a4408fcf)
...
![Window displaying job options.](https://learning-api.quantum.ibm.com/assets/21dd1126-b0e7-4d35-b86a-6ec0ef2c7385)
...
![probability the qubit is in the 1 state](https://learning-api.quantum.ibm.com/assets/3e4140c6-9da0-46b0-85e4-a1509078d3e9)
...
![phase of the local qubit state](https://learning-api.quantum.ibm.com/assets/7f047fde-c19e-46db-b596-be5da55e697e)

**Example: phase disks for two different qubits**

![phase disk examples](https://learning-api.quantum.ibm.com/assets/0207fba8-8b4b-4611-9638-6cbe169e10c4)
...
![purity of the qubit state](https://learning-api.quantum.ibm.com/assets/425d4355-6a67-45ec-989c-afc2aa800448)
...
![a quantum circuit](https://learning-api.quantum.ibm.com/assets/58f83286-9707-4e43-893e-2bd161c744cd)
...
![measurement probabilities view](https://learning-api.quantum.ibm.com/assets/4d79349d-dadd-4e9c-8571-4617601d22f3)
...
![q-sphere view](https://learning-api.quantum.ibm.com/assets/55d58744-c95c-44b3-ba29-3c7e24ec4dcc)
...
![statevector view](https://learning-api.quantum.ibm.com/assets/1f828b26-e332-4ef2-b8f0-649030fabab4)
...
| ------------------------------------------------- | ------------------ | ---------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| ![x\_gate](https://learning-api.quantum.ibm.com/assets/1d52e1a3-ca53-4caa-9700-259e35f0dbaf) | `x q[0];`          | ![image19](https://learning-api.quantum.ibm.com/assets/1392cb96-3d66-4a9e-9ed1-687a937bc3cc)                              | The q-sphere representation shows the state after the gate operates on the initial equal superposition state $\frac{1}{\sqrt{2^{n}}}\sum_{i=0}^{2^{n}-1}\vert i\rangle, $ where $n$ is the number of qubits needed to support the gate. |
...
| Composer reference                                | OpenQASM reference | Q-Sphere | Note about q-sphere representations                                                                                                                                                                                                     |
| ------------------------------------------------- | ------------------ | ---------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| ![CX-Gate](https://learning-api.quantum.ibm.com/assets/e74dca0d-3f6b-42c9-9471-b65fd03ef5b5) | `cx q[0], q[1];`          | ![image19](https://learning-api.quantum.ibm.com/assets/40abd3fa-ab1e-4ea2-ade7-49a06073b37f)                              | The q-sphere representation shows the state after the gate operates on the initial equal superposition state $\frac{1}{\sqrt{2^{n}}}\sum_{i=0}^{2^{n}-1}\vert i\rangle, $ where $n$ is the number of qubits needed to support the gate. |
...
| Composer reference                                    | OpenQASM reference      | Q-Sphere | Note about q-sphere representations                                                                                                                                                                                                     |
| ----------------------------------------------------- | ----------------------- | ---------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| ![ccx-gate](https://learning-api.quantum.ibm.com/assets/16a28c9a-fd2c-4e1b-a0d7-27059adc0aa0) | `ccx q[0], q[1], q[2];` | ![ccx\_qsph](https://learning-api.quantum.ibm.com/assets/dc2fb919-f576-4a76-acbe-69dec221145a)                          | The q-sphere representation shows the state after the gate operates on the initial equal superposition state $\frac{1}{\sqrt{2^{n}}}\sum_{i=0}^{2^{n}-1}\vert i\rangle, $ where $n$ is the number of qubits needed to support the gate. |
...
| Composer reference                                  | OpenQASM reference | Q-Sphere | Note about q-sphere representations                                                                                                                                                                                                     |
| --------------------------------------------------- | ------------------ | ---------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| ![swapgate](https://learning-api.quantum.ibm.com/assets/61f641e0-fb8f-4a67-af60-9b1bf792f2c6) | `swap q[0], q[1];` | ![swap\_qsph](https://learning-api.quantum.ibm.com/assets/e2090577-7a13-484a-a642-2c56f42119cb)                        | The q-sphere representation shows the state after the gate operates on the initial equal superposition state $\frac{1}{\sqrt{2^{n}}}\sum_{i=0}^{2^{n}-1}\vert i\rangle, $ where $n$ is the number of qubits needed to support the gate. |
...
| -------------------------------------------------- | -------------- |
| ![idgate](https://learning-api.quantum.ibm.com/assets/f3c1f16a-d5b4-4f1c-9f18-2d9b6dcfd2fe) | `id q[0];`     |
...
| Composer reference                                | OpenQASM reference | Q-Sphere | Note about q-sphere representations                                                                                                                                                                                                     |
| ------------------------------------------------- | ------------------ | ---------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| ![t\_gate](https://learning-api.quantum.ibm.com/assets/b5f1b90c-d3b7-4f60-82f9-259dc40cef5b) | `t q[0];`          | ![image29](https://learning-api.quantum.ibm.com/assets/c43496bb-89ff-4518-9afb-d276e400b032)                              | The q-sphere representation shows the state after the gate operates on the initial equal superposition state $\frac{1}{\sqrt{2^{n}}}\sum_{i=0}^{2^{n}-1}\vert i\rangle, $ where $n$ is the number of qubits needed to support the gate. |
...
| Composer reference                                | OpenQASM reference | Q-Sphere | Note about q-sphere representations                                                                                                                                                                                                     |
| ------------------------------------------------- | ------------------ | ---------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| ![z\_gate](https://learning-api.quantum.ibm.com/assets/941c8820-65bc-444c-890b-b445b9958085) | `z q[0];`          | ![image23](https://learning-api.quantum.ibm.com/assets/84b92ecb-3b62-4cb3-9c01-549866681816)                              | The q-sphere representation shows the state after the gate operates on the initial equal superposition state $\frac{1}{\sqrt{2^{n}}}\sum_{i=0}^{2^{n}-1}\vert i\rangle, $ where $n$ is the number of qubits needed to support the gate. |
...
| Composer reference                                | OpenQASM reference | Q-Sphere | Note about q-sphere representations                                                                                                                                                                                                     |
| ------------------------------------------------- | ------------------ | ---------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| ![tdggate](https://learning-api.quantum.ibm.com/assets/8e348308-7e1f-4e61-a002-ff84d04d89b1) | `tdg q[0];`        | ![image31](https://learning-api.quantum.ibm.com/assets/b79890e8-e6f1-4c22-8546-6322bc6ed57b)                            | The q-sphere representation shows the state after the gate operates on the initial equal superposition state $\frac{1}{\sqrt{2^{n}}}\sum_{i=0}^{2^{n}-1}\vert i\rangle, $ where $n$ is the number of qubits needed to support the gate. |
...
| Composer reference                                | OpenQASM reference | Q-Sphere | Note about q-sphere representations                                                                                                                                                                                                     |
| ------------------------------------------------- | ------------------ | ---------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| ![sdggate](https://learning-api.quantum.ibm.com/assets/ae59613c-0c65-447c-869d-81c7ffb8b2ad) | `sdg q[0];`        | ![image27](https://learning-api.quantum.ibm.com/assets/1de10ec2-2026-40f6-8f96-cd332f79780d)                            | The q-sphere representation shows the state after the gate operates on the initial equal superposition state $\frac{1}{\sqrt{2^{n}}}\sum_{i=0}^{2^{n}-1}\vert i\rangle, $ where $n$ is the number of qubits needed to support the gate. |
...
| Composer reference                              | OpenQASM reference | Q-Sphere | Note about q-sphere representations                                                                                                                                                                                                     |
| ----------------------------------------------- | ------------------ | ---------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| ![p\_gate](https://learning-api.quantum.ibm.com/assets/2b9eec00-ecbf-45ce-ae09-8e3015dc6c98) | `p(theta) q[0];`   | ![p\_qsph](https://learning-api.quantum.ibm.com/assets/a02007e1-4c68-42af-b10c-49cbbaaed8ef)                             | The q-sphere representation shows the state after the gate operates on the initial equal superposition state $\frac{1}{\sqrt{2^{n}}}\sum_{i=0}^{2^{n}-1}\vert i\rangle, $ where $n$ is the number of qubits needed to support the gate. |
...
| Composer reference                                | OpenQASM reference | Q-Sphere | Note about q-sphere representations                                                                                                                                                                                                     |
| ------------------------------------------------- | ------------------ | ---------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| ![rz\_gate](https://learning-api.quantum.ibm.com/assets/112f2dec-4fa2-42f5-b51c-2bd2205ebd30) | `rz(angle) q[0];`  | ![image17](https://learning-api.quantum.ibm.com/assets/8d60318b-72f9-4188-a07a-ad4d3e82b4e8)                             | The q-sphere representation shows the state after the gate operates on the initial equal superposition state $\frac{1}{\sqrt{2^{n}}}\sum_{i=0}^{2^{n}-1}\vert i\rangle, $ where $n$ is the number of qubits needed to support the gate. |
...
| ------------------------------------------- | ------------------ |
| ![0-opera](https://learning-api.quantum.ibm.com/assets/6a1605ff-fb88-4bf7-ac81-43b0cce918c9) | `reset q[0];`      |
...
| Composer reference                                       | OpenQASM reference |
| -------------------------------------------------------- | ------------------ |
| ![z-measu](https://learning-api.quantum.ibm.com/assets/9fca7f1e-ba46-400d-a3d1-312ee011d705) | `measure q[0];`    |
...
| Composer reference                                          | OpenQASM reference |
| ----------------------------------------------------------- | ------------------ |
| ![cntrl-mod](https://learning-api.quantum.ibm.com/assets/243c0fad-8236-4b03-a71a-bacaed4055c8) | `c`                |
...
| Composer reference                               | OpenQASM reference |
| ------------------------------------------------ | ------------------ |
| ![barrier](https://learning-api.quantum.ibm.com/assets/96cd10ae-e3cf-40ea-9ca7-49a2d68a8c07) | `barrier q;`       |
...
| Composer reference                                    | OpenQASM reference | Q-Sphere | Note about q-sphere representations                                                                                                                                                                                                     |
| ----------------------------------------------------- | ------------------ | ---------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| ![h-gate](https://learning-api.quantum.ibm.com/assets/fd58c6d3-f0af-4566-bf2b-105ed850c946) | `h q[0];`          | ![image1](https://learning-api.quantum.ibm.com/assets/e797de24-e6de-44cb-9137-bb8931d763df)                               | The q-sphere representation shows the state after the gate operates on the initial equal superposition state $\frac{1}{\sqrt{2^{n}}}\sum_{i=0}^{2^{n}-1}\vert i\rangle, $ where $n$ is the number of qubits needed to support the gate. |
...
| Composer reference                                | OpenQASM reference | Q-Sphere | Note about q-sphere representations                                                                                                                                                                                                     |
| ------------------------------------------------- | ------------------ | ---------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| ![sx\_gate](https://learning-api.quantum.ibm.com/assets/67933b13-85f0-45e9-bc31-dcea4684dd6f) | `sx q[0];`         | ![sx\_qsph](https://learning-api.quantum.ibm.com/assets/fd300da1-512c-4193-8e77-b15e5e378d34)                         | The q-sphere representation shows the state after the gate operates on the initial equal superposition state $\frac{1}{\sqrt{2^{n}}}\sum_{i=0}^{2^{n}-1}\vert i\rangle, $ where $n$ is the number of qubits needed to support the gate. |
...
| Composer reference                                    | OpenQASM reference | Q-Sphere | Note about q-sphere representations                                                                                                                                                                                                     |
| ----------------------------------------------------- | ------------------ | ---------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| ![sxdg\_gate](https://learning-api.quantum.ibm.com/assets/4d5d9638-30af-48c3-a8c9-d506a0041f24) | `sxdg q[0];`       | ![sxdg\_qsph](https://learning-api.quantum.ibm.com/assets/3e258992-baa9-42bb-92b1-6e082eb674c9)                     | The q-sphere representation shows the state after the gate operates on the initial equal superposition state $\frac{1}{\sqrt{2^{n}}}\sum_{i=0}^{2^{n}-1}\vert i\rangle, $ where $n$ is the number of qubits needed to support the gate. |
...
| Composer reference                                | OpenQASM reference | Q-Sphere | Note about q-sphere representations                                                                                                                                                                                                     |
| ------------------------------------------------- | ------------------ | ---------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| ![y\_gate](https://learning-api.quantum.ibm.com/assets/14cb9cf2-9460-47ae-98b7-dbd06239522a) | `y q[0];`          | ![image21](https://learning-api.quantum.ibm.com/assets/7bdac8ad-6004-4853-afda-d2cabe66c214)                              | The q-sphere representation shows the state after the gate operates on the initial equal superposition state $\frac{1}{\sqrt{2^{n}}}\sum_{i=0}^{2^{n}-1}\vert i\rangle, $ where $n$ is the number of qubits needed to support the gate. |
...
| Composer reference                                | OpenQASM reference | Q-Sphere | Note about q-sphere representations                                                                                                                                                                                                     |
| ------------------------------------------------- | ------------------ | ---------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| ![rx\_gate](https://learning-api.quantum.ibm.com/assets/f943edee-7a79-43a1-9e18-87eba141f787) | `rx(angle) q[0];`  | ![image13](https://learning-api.quantum.ibm.com/assets/7640c11d-253a-42b7-a3cd-63a8fa98e446)                             | The q-sphere representation shows the state after the gate operates on the initial equal superposition state $\frac{1}{\sqrt{2^{n}}}\sum_{i=0}^{2^{n}-1}\vert i\rangle, $ where $n$ is the number of qubits needed to support the gate. |
...
| Composer reference                                | OpenQASM reference | Q-Sphere | Note about q-sphere representations                                                                                                                                                                                                     |
| ------------------------------------------------- | ------------------ | ---------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| ![ry\_gate](https://learning-api.quantum.ibm.com/assets/77c50d8c-b2d1-4de8-9657-572ede30e02f) | `ry(angle) q[0];`  | ![image15](https://learning-api.quantum.ibm.com/assets/3c1efa46-e05f-486d-8e6a-df5fd0add674)                             | The q-sphere representation shows the state after the gate operates on the initial equal superposition state $\frac{1}{\sqrt{2^{n}}}\sum_{i=0}^{2^{n}-1}\vert i\rangle, $ where $n$ is the number of qubits needed to support the gate. |
...
| Composer reference                                 | OpenQASM reference       | Q-Sphere | Note about q-sphere representations                                                                                                                                                                                                     |
| -------------------------------------------------- | ------------------------ | ---------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| ![rxx-gate](https://learning-api.quantum.ibm.com/assets/d4328ec9-dc63-4c5c-b7ac-8ecc7cbcd5b6) | `rxx(angle) q[0], q[1];` | ![rxx\_qsph](https://learning-api.quantum.ibm.com/assets/206828a8-0392-498e-98c2-1c89ece527bb)                          | The q-sphere representation shows the state after the gate operates on the initial equal superposition state $\frac{1}{\sqrt{2^{n}}}\sum_{i=0}^{2^{n}-1}\vert i\rangle, $ where $n$ is the number of qubits needed to support the gate. |
...
| Composer reference                                  | OpenQASM reference       | Q-Sphere | Note about q-sphere representations                                                                                                                                                                                                     |
| --------------------------------------------------- | ------------------------ | ---------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| ![rzz\_gate](https://learning-api.quantum.ibm.com/assets/50bddfba-198c-4d70-b978-d044da32c36e) | `rzz(angle) q[0], q[1];` | ![rzz\_qsph](https://learning-api.quantum.ibm.com/assets/013918f1-8973-499b-8b2b-ee150d628852)                          | The q-sphere representation shows the state after the gate operates on the initial equal superposition state $\frac{1}{\sqrt{2^{n}}}\sum_{i=0}^{2^{n}-1}\vert i\rangle, $ where $n$ is the number of qubits needed to support the gate. |
...
| Composer reference                                   | OpenQASM reference         | Q-Sphere | Note about q-sphere representations                                                                                                                                                                                                     |
| ---------------------------------------------------- | -------------------------- | ---------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| ![u\_gate](https://learning-api.quantum.ibm.com/assets/628ae112-fcf8-4be7-a04b-568c390f7c4d) | `u(theta, phi, lam) q[0];` | ![u3\_qsph](https://learning-api.quantum.ibm.com/assets/3e5212aa-a78c-48d8-b49a-4af362e5b899)                            | The q-sphere representation shows the state after the gate operates on the initial equal superposition state $\frac{1}{\sqrt{2^{n}}}\sum_{i=0}^{2^{n}-1}\vert i\rangle, $ where $n$ is the number of qubits needed to support the gate. |
...
| Composer reference                        | OpenQASM reference | Q-Sphere | Note about q-sphere representations                                                                                                                                                                                                     |
| ----------------------------------------- | ------------------ | ---------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| ![rccx-gate](https://learning-api.quantum.ibm.com/assets/6cdded97-f988-42c6-81c2-f901fd22f692) | `rccx a, b, c;`    | ![rccx\_qsph](https://learning-api.quantum.ibm.com/assets/e4efe9af-7bfb-4753-93f7-6f3b2933ef78)                        | The q-sphere representation shows the state after the gate operates on the initial equal superposition state $\frac{1}{\sqrt{2^{n}}}\sum_{i=0}^{2^{n}-1}\vert i\rangle, $ where $n$ is the number of qubits needed to support the gate. |
...
| Composer reference                        | OpenQASM reference | Q-Sphere | Note about q-sphere representations                                                                                                                                                                                                     |
| ----------------------------------------- | ------------------ | ---------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| ![rc3x-gate](https://learning-api.quantum.ibm.com/assets/5cebe71b-7864-4ff6-b669-ae2ec7049901) | `rc3x a, b, c, d;` | ![rc3x\_qsph](https://learning-api.quantum.ibm.com/assets/86b6a4bc-36cd-483c-a225-bc1d0b3207b3)                        | The q-sphere representation shows the state after the gate operates on the initial equal superposition state $\frac{1}{\sqrt{2^{n}}}\sum_{i=0}^{2^{n}-1}\vert i\rangle, $ where $n$ is the number of qubits needed to support the gate. |
