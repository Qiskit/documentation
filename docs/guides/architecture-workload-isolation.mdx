---
title: Learning about Qiskit Runtime architecture and workload isolation
description: Understand workload visibility between users and how to restrict access to service instances.
