...
|     Mode     |                                                                                                        Benefits                                                                                                        |
|:------------:|:---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------:|
| Batch mode   | The entire batch of jobs is scheduled together and there is no additional queuing time for each. Jobs in a batch are usually run close together.                                                                     |
| Session mode | Dedicated and exclusive access to the QPU during the session active window, and no other users’ or QPU jobs can run. This is particularly useful for workloads that don’t have all inputs ready at the outset.  |
| Job mode     | Easiest to use when running a small experiment. Might run sooner than batch mode.                                                                                                                                     |
...
| title                                       | heading |   |   |   |
|---------------------------------------------|---------|---|---|---|
| one thing<br></br>second thing<br></br><br></br>two spaces |         |   |   |   |
|                                             |         |   |   |   |
|                                             |         |   |   |   |
