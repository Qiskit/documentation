...
![Qiskit Code Assistant is shown on the bottom of the VS Code window.](/images/guides/qiskit-code-assistant/vscode-selected-model.avif)
...
![The window that opens upon first use contains restrictions that must be accepted.](/images/guides/qiskit-code-assistant/eula.avif)
