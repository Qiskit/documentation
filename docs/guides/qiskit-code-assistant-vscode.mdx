...
![Qiskit Code Assistant is shown on the bottom of the VS Code window.](/images/run/qiskit-code-assistant/vscode-selected-model.png)
...
![The bottom status bar is shown, with `granite-8b-qiskit` listed.](/images/run/qiskit-code-assistant/vscode-selected-model.png)
...
- You can hover the cursor over the suggestion to use the pop-up toolbar to cycle through the suggestions, as shown:
  ![The toolbar that pops up if you hover over suggested code is shown.](/images/run/qiskit-code-assistant/vscode-inline-suggestion-toolbar.png)
</Admonition>
