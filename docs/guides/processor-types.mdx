...
![Illustration of segment H on a Falcon processor.](/docs/images/guides/processor-types/seg-h.avif "Illustration of segment H on a Falcon processor")
...
* [Native gates and operations](/docs/guides/qpu-information#native-gates): `cx, id, delay, measure, reset, rz, sx, x, if_else, for_loop, switch_case`
