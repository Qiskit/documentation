...
* [Native gates and operations](/docs/guides/qpu-information#native-gates): `cz, id, delay, measure, reset, rz, sx, x, if_else, for_loop, switch_case`
...
* [Native gates and operations](/docs/guides/qpu-information#native-gates): `ecr, id, delay, measure, reset, rz, sx, x, if_else, for_loop, switch_case`
