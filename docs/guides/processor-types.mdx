...
To find the native gates and operations of a backend, use [this code](/docs/guides/get-qpu-information#native-gates-with-qiskit). You can see all native gates and operations in [this table](/docs/guides/get-qpu-information#native-gates).
</Admonition>
...
![Osprey processor icon](/docs/images/guides/processor-types/osprey.svg)
...
* [Native gates and operations](/docs/guides/qpu-information#native-gates): `ecr, id, delay, measure, reset, rz, sx, x`
...
![Hummingbird processor icon](/docs/images/guides/processor-types/hummingbird.svg)
...
<Admonition type="info" title="Revisions">
  ...
  `r2` (August 2020) This revision contains 65 qubits. Improvements previously demonstrated on Falcons, like readout multiplexing, space-efficient qubit-qubit couplers, and flip-chip technology enhanced the capabilities of the Hummingbird family and led to a scalable 65Q design.
...
![Egret processor icon](/docs/images/guides/processor-types/egret.svg)
...
![Falcon processor icon](/docs/images/guides/processor-types/falcon.svg)
...
* [Native gates and operations](/docs/guides/qpu-information#native-gates): `cx, id, delay, measure, reset, rz, sx, x`
...
![Canary processor icon](/docs/images/guides/processor-types/canary.svg)
