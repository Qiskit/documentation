...
To find the supported instruction set for a backend, use [this code](/docs/guides/qpu-information#native-gates-with-qiskit). You can see all supported instructions in [this table](/docs/guides/qpu-information#native-gates).
</Admonition>
