...
To find the native gates and operations of a backend, use [this code](/docs/guides/qpu-information#native-gates-with-qiskit). You can see all native gates and operations in [this table](/docs/guides/qpu-information#native-gates).
</Admonition>
