...
At 120 qubits and a grid topology, Nighthawk leverages our technology stack from Heron (couplers, signal delivery, coherence) with increased connectivity for enhanced application workloads.
...
<Admonition type="info" title="Revisions">
  ...
  `r1` (December 2025) The first version of Nighthawk.
