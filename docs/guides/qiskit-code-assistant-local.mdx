...
GGUF format models are optimized for local use and require less computational resources:
...
<table
  style={{
    ...
    boxShadow: '0 6px 18px rgba(12, 20, 29, 0.06)',
    borderRadius: '12px',
    overflow: 'hidden',
    tableLayout: 'auto',
...
>
  <thead>
    <tr>
      <th style={{textAlign: 'left', padding: '10px 14px', background: '#e8f0f8', color: '#475569', fontWeight: 600, fontSize: '13px', borderBottom: '1px solid rgba(15,23,42,0.08)'}}>
        Model
      </th>
      <th style={{textAlign: 'center', padding: '10px 14px', background: '#e8f0f8', color: '#475569', fontWeight: 600, fontSize: '13px', borderBottom: '1px solid rgba(15,23,42,0.08)'}}>
        Trained on Qiskit Version
      </th>
      <th style={{textAlign: 'center', padding: '10px 14px', background: '#e8f0f8', color: '#475569', fontWeight: 600, fontSize: '13px', borderBottom: '1px solid rgba(15,23,42,0.08)'}}>
        Release date
      </th>
  ...
  <tbody>
    ...
    <tr style={{background: '#ffffff'}}>
      <td style={{padding: '10px 14px', fontWeight: 700, color: '#0f172a', fontSize: '14px'}}>mistral-small-3.2-24b-qiskit</td>
      <td style={{padding: '10px 14px', fontWeight: 700, textAlign: 'center', fontFamily: 'ui-monospace, SFMono-Regular, Menlo, Monaco, monospace', fontSize: '14px'}}>2.1</td>
      <td style={{padding: '10px 14px', textAlign: 'center', fontFamily: 'ui-monospace, SFMono-Regular, Menlo, Monaco, monospace', fontSize: '14px'}}>October 2025</td>
    </tr>
    <tr style={{background: '#fbfdff'}}>
      <td style={{padding: '10px 14px', color: '#07102a', fontSize: '14px'}}>qwen2.5-coder-14b-qiskit</td>
      <td style={{padding: '10px 14px', textAlign: 'center', fontFamily: 'ui-monospace, SFMono-Regular, Menlo, Monaco, monospace', fontSize: '14px'}}>2.0</td>
      <td style={{padding: '10px 14px', textAlign: 'center', fontFamily: 'ui-monospace, SFMono-Regular, Menlo, Monaco, monospace', fontSize: '14px'}}>June 2025</td>
    </tr>
    <tr style={{background: '#fbfdff'}}>
      <td style={{padding: '10px 14px', color: '#0f172a', fontSize: '14px'}}>granite-3.3-8b-qiskit</td>
      <td style={{padding: '10px 14px', textAlign: 'center', fontFamily: 'ui-monospace, SFMono-Regular, Menlo, Monaco, monospace', fontSize: '14px'}}>2.0</td>
      <td style={{padding: '10px 14px', textAlign: 'center', fontFamily: 'ui-monospace, SFMono-Regular, Menlo, Monaco, monospace', fontSize: '14px'}}>June 2025</td>
    </tr>
    <tr style={{background: '#ffffff'}}>
      <td style={{padding: '10px 14px', color: '#0f172a', fontSize: '14px'}}>granite-3.2-8b-qiskit</td>
      <td style={{padding: '10px 14px', textAlign: 'center', fontFamily: 'ui-monospace, SFMono-Regular, Menlo, Monaco, monospace', fontSize: '14px'}}>2.0</td>
      <td style={{padding: '10px 14px', textAlign: 'center', fontFamily: 'ui-monospace, SFMono-Regular, Menlo, Monaco, monospace', fontSize: '14px'}}>June 2025</td>
    </tr>
    <tr style={{background: '#ffffff'}}>
      <td style={{padding: '10px 14px', color: '#0f172a', fontSize: '14px'}}>granite-8b-qiskit-rc-0.10</td>
      <td style={{padding: '10px 14px', textAlign: 'center', fontFamily: 'ui-monospace, SFMono-Regular, Menlo, Monaco, monospace', fontSize: '14px'}}>1.3</td>
      <td style={{padding: '10px 14px', textAlign: 'center', fontFamily: 'ui-monospace, SFMono-Regular, Menlo, Monaco, monospace', fontSize: '14px'}}>February 2025</td>
    </tr>
    <tr style={{background: '#ffffff'}}>
      <td style={{padding: '10px 14px', color: '#0f172a', fontSize: '14px'}}>granite-8b-qiskit</td>
      <td style={{padding: '10px 14px', textAlign: 'center', fontFamily: 'ui-monospace, SFMono-Regular, Menlo, Monaco, monospace', fontSize: '14px'}}>1.2</td>
      <td style={{padding: '10px 14px', textAlign: 'center', fontFamily: 'ui-monospace, SFMono-Regular, Menlo, Monaco, monospace', fontSize: '14px'}}>November 2024</td>
    </tr>
  </tbody>
</table>
