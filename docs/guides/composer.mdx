...
![Gates in the custom operation](/docs/images/guides/composer/763d3b42-4b6e-4409-817f-7d15abae2d76.avif)

b) The code for the new operation:

![Customized new operation](/docs/images/guides/composer/db5856ca-751c-4f12-9f25-6060b9003687.avif)

c) The new operation in the graphical editor:

![New operation](/docs/images/guides/composer/d7fb8ec5-5eae-4ad4-9972-1e3665b39b7f.avif)
...
![Controls to step forward and backward, and to jump to a circuit's beginning or end.](/docs/images/guides/composer/5f2dfb7c-a244-405c-8950-f422a4408fcf.avif)

Inspect mode controls, in order: jump to the beginning of a circuit, step backward, play from one break point to the next, step forward, jump to the end of a circuit.
...
![measurement probabilities view](/docs/images/guides/composer/4d79349d-dadd-4e9c-8571-4617601d22f3.avif)
...
![statevector view](/docs/images/guides/composer/1f828b26-e332-4ef2-b8f0-649030fabab4.avif)
