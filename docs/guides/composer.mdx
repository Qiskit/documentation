...
![a quantum circuit](/docs/images/guides/composer/2H-circuit.svg "A circuit consisting of a column of Hadamards that creates an equal superposition of the computational basis states, followed by a two-qubit controlled-Z (CZ) gate.")

![Probabilities view of the previous circuit](/docs/images/guides/composer/probabilities.svg "Probabilities view of the previous circuit.")
...
![a quantum circuit](/docs/images/guides/composer/2H-circuit.svg)

![q-sphere view](/docs/images/guides/composer/q-sphere.avif)
