...
3. **Run settings** - Change the run settings and then run your circuit on a quantum system or simulator.
...
7. **Code editor** - Use the View menu to open or close the code editor, which allows you to view the OpenQASM or Qiskit code for the circuit. You can edit the OpenQASM code; the Qiskit code is read-only.
