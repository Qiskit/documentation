...
![a quantum circuit](/docs/images/guides/composer/probabilities-view.avif "A circuit consisting of a column of Hadamards that creates an equal superposition of the computational basis states, followed by a two-qubit controlled-Z (CZ) gate.")
