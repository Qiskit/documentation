...
![statevector view](/docs/images/guides/composer/state-vector.svg "The statevector at the terminus of the above circuit. The color wheel maps phase angle to color. The output state is expressed as a list of complex numbers.")
