...
description: IBM Quantum Composer is a graphical quantum programming tool that lets you drag and drop operations to build quantum circuits and run them on real quantum hardware or simulators.
platform: cloud
---
...
![cust-icon-explod](/docs/images/tutorials/explore-composer/763d3b42-4b6e-4409-817f-7d15abae2d76.avif)

b) The code for the new operation:

![cust-qasm](/docs/images/tutorials/explore-composer/db5856ca-751c-4f12-9f25-6060b9003687.avif)

c) The new operation in the graphical editor:

![cust-icon](/docs/images/tutorials/explore-composer/d7fb8ec5-5eae-4ad4-9972-1e3665b39b7f.avif)
...
| -------------------------------------------------- | -------------- |
| ![idgate](/docs/images/tutorials/explore-composer/f3c1f16a-d5b4-4f1c-9f18-2d9b6dcfd2fe.avif) | `id q[0];`     |
...
| Composer reference                                | OpenQASM reference | Q-Sphere | Note about q-sphere representations                                                                                                                                                                                                     |
| ------------------------------------------------- | ------------------ | ---------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| ![tdggate](/docs/images/tutorials/explore-composer/8e348308-7e1f-4e61-a002-ff84d04d89b1.avif) | `tdg q[0];`        | ![image31](/docs/images/tutorials/explore-composer/b79890e8-e6f1-4c22-8546-6322bc6ed57b.avif)                            | The q-sphere representation shows the state after the gate operates on the initial equal superposition state $\frac{1}{\sqrt{2^{n}}}\sum_{i=0}^{2^{n}-1}\vert i\rangle, $ where $n$ is the number of qubits needed to support the gate. |
...
| Composer reference                                       | OpenQASM reference |
| -------------------------------------------------------- | ------------------ |
| ![z-measu](/docs/images/tutorials/explore-composer/9fca7f1e-ba46-400d-a3d1-312ee011d705.avif) | `measure q[0];`    |
...
| Composer reference                                          | OpenQASM reference |
| ----------------------------------------------------------- | ------------------ |
| ![cntrl-mod](/docs/images/tutorials/explore-composer/243c0fad-8236-4b03-a71a-bacaed4055c8.avif) | `c`                |
