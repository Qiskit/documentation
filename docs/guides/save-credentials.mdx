...
Save your credentials by running the appropriate code once per account you want to save. After saving your credentials, load them by following the steps in [Initialize the IBM Quantum Compute Service](/docs/guides/initialize-account).
...
* If you don't save your credentials, you must specify them every time you start a new session (instantiate the IBM Quantum Compute Service).
* If you manually specify your credentials, a saved account will not be used.

# Next steps

<Admonition type="tip" title="Recommendations">
  -  [Initialize the IBM Quantum Compute Service](/docs/guides/initialize-account) in a trusted Python environment.
  -  [Initialize the IBM Quantum Compute Service in an **untrusted environment**](/docs/guides/cloud-setup-untrusted).
