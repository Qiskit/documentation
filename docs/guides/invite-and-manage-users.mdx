...
Create your account's instances before you invite users. For every instance you create through IBM Quantum Platform, an associated [access group](/docs/guides/access-groups) is automatically generated. When you invite users to an instance, you can assign them to a specific instance's access group as part of the invitation process.
</Admonition>
...
If a user has a previously existing IBM Cloud account, follow the instructions in the [Manage IBM Cloud users](/docs/guides/manage-cloud-users) section.
</Admonition>
...
<Admonition type="tip" title="Recommendations">
   - Create [instances.](/docs/guides/instances#add-instance)
   ...
   - [Create and manage access groups.](/docs/guides/access-groups)
</Admonition>
