...
Create your account's instances before you invite users. For every instance you create through IBM Quantum Platform, an associated [access group](/guides/access-groups) is automatically generated (unless you decline the automatically generated access group when you create the instance). When you invite users to an instance, you can assign them to a specific instance's access group as part of the invitation process.
</Admonition>
...
1. Enter the users' email adddresses and optionally assign the invited users to access groups. To create an access group, see the [Create and manage access groups](/guides/access-groups) guide.
...
<Admonition type="tip" title="Recommendations">
   - Create [instances.](/guides/instances#add-instances)
   - Understand the [IBM Cloud account structure,](/guides/cloud-account-structure) including access policies, groups, and roles.
   - Learn how to [set up access groups.](https://cloud.ibm.com/docs/account?topic=account-groups&interface=ui)
</Admonition>
