...
### 1. Create an instance
    ...
    1. Make sure that you have the correct account and region are selected from the account and region switchers in the header. If you want to create an Open instance, you must choose the us-east region.
