...
1. **Premium Plan users only, who have been invited by their organization to join an account:** Be sure you have accepted the invitation you received by email, and have created your user ID on IBM Cloud. (If you already have an IBM Cloud account associated with the invited email address, there is no need to create a new user ID.) You have already been added to an instance in your organization's account, so you can skip the "Create an instance" step and go straight to [Find your access credentials](#access-credentials).
