...
<Admonition type="caution" title="The backends field may be outdated">
  ...
  Instead, the current workaround is to use the [Qiskit Runtime REST API](/docs/api/qiskit-runtime-rest) with the [`GET /v1/instance`](/docs/api/qiskit-runtime-rest/tags/instances#tags__instances__operations__get_instance) endpoint.
</Admonition>
