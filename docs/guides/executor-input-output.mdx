...
Circuit items are executed without any sort of randomization. On the contrary, samplex items allows users to specify how to randomize their content. In the next cell, we show how to generate a samplex item for the GHZ circuit above that adds twirling to all the gates and measurements in it.
