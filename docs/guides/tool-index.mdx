...
<span id="tool-index-primitives"></span>
...
<details>
<summary>Generate and execute circuit variants based on directives defined with Samplomatic</summary>
...
- [API reference for post-selection utilities](/docs/api/qiskit-addon-utils/noise-management)
...
<details>
<summary> Qiskit Function for error mitigation based on tensor-network methods </summary>
