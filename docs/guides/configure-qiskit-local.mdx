...
<Admonition type="note">
    * Circuit drawer settings apply to [qiskit.circuit.QuantumCircuit.draw](../api/qiskit/qiskit.circuit.QuantumCircuit) and [qiskit.visualization.circuit_drawer](/docs/api/qiskit/qiskit.visualization.circuit_drawer#qiskitvisualizationcircuit_drawer).
    * State visualization draw methods are [qiskit.quantum_info.Statevector.draw](/docs/api/qiskit/qiskit.quantum_info.Statevector#statevector) and [qiskit.quantum_info.DensityMatrix.draw](/docs/api/qiskit/qiskit.quantum_info.Statevector#statevector).
</Admonition>
