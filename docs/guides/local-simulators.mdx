...
Local testing mode does not have built-in error suppression or mitigation.  Instead, you must specify those options explicitly. See [Configure error mitigation for Qiskit Runtime](/docs/guides/error-mitigation-and-suppression-techniques) for details.
</Admonition>
