...
If you aren't using any advanced error-mitigation techiques, you can use `2+0.00035*<num executions>` as a quick formula. (Note that this does not include overhead from control electronics operations, such as loading the payload.)
</CloudContent>
