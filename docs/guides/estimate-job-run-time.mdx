...
<CloudContent>
For Standard Plan users, usage determines how much the workload costs. See [Manage cost](/guides/manage-cost#manage-cost) for details.
</CloudContent>

<LegacyContent>
Your usage has different impacts, depending on which channel you're using:

- For Qiskit Runtime on IBM Cloud&reg; users, the usage determines how much the job costs.  See [Manage cost](/guides/manage-cost#manage-cost) for details.
