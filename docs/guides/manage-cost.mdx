...
To determine how much has been billed to an instance during the current billing cycle, from the [Instances](https://quantum.cloud.ibm.com/instances) page, click the instance to open its details page. The **Total usage** field displays the total amount of this instance's QPU usage since it was created.
...
The **Usage** field displays the amount of service capacity consumed by the job, measured using the QPU charge time metric.
