...
This guide describes how to set a cost limit or instance limit.  You can also manage cost by [minimizing a workload's quantum time.](/docs/guides/minimize-time)
...
* **API**: [`GET /v1/instances/configuration`](/docs/api/qiskit-runtime-rest/tags/instances).
