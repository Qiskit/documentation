...
<Admonition type="tip" title="Recommendations">
  ...
  - Read the [Qiskit Estimator API](/api/qiskit/1.4/qiskit.primitives.Estimator) reference.
  - Read the [Qiskit Sampler API](/api/qiskit/1.4/qiskit.primitives.Sampler) reference.
