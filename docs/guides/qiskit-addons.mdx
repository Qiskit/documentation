...
Sample-based quantum diagonalization (SQD) classically postprocesses noisy quantum samples to yield more accurate energy estimations of quantum system Hamiltonians, for example in chemistry applications.
