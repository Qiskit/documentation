...
![Diagram of gate cutting by taking one larger circuit and cutting it into two smaller ones labeled "A" and "B"](/images/guides/qiskit-addons/circuit-cutting-diagram.avif)
...
<Admonition type="tip" title="Recommendations"> 
    - [Get started with circuit cutting using gate cuts.](/guides/qiskit-addons-cutting-gates)
    - [Get started with circuit cutting using wire cuts.](/guides/qiskit-addons-cutting-wires)
</Admonition>
