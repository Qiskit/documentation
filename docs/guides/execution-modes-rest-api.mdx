...
In job mode, a single primitive request of the estimator or the sampler made without a context manager. See how to run a quatum circuit using [Estimator](run-primitives-rest-api#estimator-primitive-with-rest-api) and [Sampler](run-primitives-rest-api#sampler-primitive-with-rest-api) for some examples. 
...
<Admonition type="tip" title="Recommendations">
    ...
    - Learn how to [transpile circuits using REST API](./transpile-rest-api.mdx).
