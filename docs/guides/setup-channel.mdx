...
1. **If you are not on a trusted machine** (such as a shared computer), do the following to authenticate, while being careful not to save your API token in a notebook file or any other file on the local machine. 
