...
4. Let's view your available backends
    ...
    You can then [transpile circuits using REST API](./transpile-rest-api) and run them using either the [Sampler or the Estimator Primitives](./run-primitives-rest-api).   
