...
```python
token = "<your-API_KEY>" # Use the 44-characters API_KEY you created and saved from the IBM Quantum Platform Home dashboard
```
...
service = QiskitRuntimeService(channel="ibm_quantum_platform",
         ...
         instance="<MY_INSTANCE_CRN or name>")
```
...
* If you currently use the Lite Plan (deprecated), you can switch to [using simulators locally](https://quantum.cloud.ibm.com/docs/guides/local-simulators). Optionally, you can [create instances in the Open Plan,](#onboard) which lets you run jobs on quantum hardware.
