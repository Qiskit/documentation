...
If you have already saved your credentials, use the following code to use your default credentials. For instructions to save credentials, see [Save your access credentials.](/docs/guides/save-credentials)
