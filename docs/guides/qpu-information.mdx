...
## View your resources
<LegacyContent>
To find your available QPUs, open the [Compute resources](https://cloud.ibm.com/quantum/resources) page.  Click a QPU to view its details.
</LegacyContent>
<CloudContent>
...
You can also view your available QPUs by using the [backends API.](/api/qiskit-ibm-runtime/qiskit_ibm_runtime.QiskitRuntimeService#backends)
</CloudContent>
