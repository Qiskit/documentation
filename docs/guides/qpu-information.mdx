...
The following is a subset of QPU configuration values available in IBM Quantum Platform and from [Qiskit](/docs/en/api/qiskit/2.1/qiskit.providers.BackendV2).
