...
The following is a subset of QPU configuration values available in IBM Quantum Platform and from [Qiskit](/docs/en/api/qiskit/qiskit.providers.BackendV2).
...
*   **Processor type** - Reflects the [topology](/docs/en/guides/qpu-information) and indicates the approximate qubit count.
