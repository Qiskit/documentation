...
Find details about a specific QPU on the [Compute resources](https://quantum.cloud.ibm.com/computers) page by selecting the QPU. The card that opens up displays the following details: 
...
The calibration data is located below the Details section of the QPU's card (display a card by selecting a QPU on the [Compute resources](https://quantum.cloud.ibm.com/computers) page). Click the arrow to display the view options: map, graph, or table view. 
