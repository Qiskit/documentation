...
[Name](#name) | [Qubits](#qubits) | [2Q error (best)](#2q-error-best) | [2Q error (layered)](#2q-error-layered) | [CLOPS (or CLOPS_h)](#clops-or-clops_h) | [Status](#status) | [Region](#region) | [QPU version](#qpu-version) | [Processor type](#processor-type) | [Basis gates](#basis-gates) | [Total pending jobs](#total-pending-jobs) | [Median 2Q error](#median-2q-error-heron-cz-eagle-ecr) |
...
Reflects the [topology](/docs/guides/qpu-information) and indicates the approximate qubit count.

### Basis gates<span id="native-gates-on-platform"></span>
...
[Topology diagram or coupling map](#topology-diagram-or-coupling-map) | [Readout assignment error](#readout-assignment-error) | [Prob meas0 prep1](#prob-meas0-prep1) | [Prob meas1 prep0](#prob-meas1-prep0) | [Readout length (ns)](#readout-length-ns) | [ID error / √x (sx) error / [Pauli-X error]](#id-error--x-sx-error--pauli-x-error) | [Single-qubit gate length (ns)](#single-qubit-gate-length-ns) | [RX error](#rx-error) | [Z-axis rotation (RZ) error](#z-axis-rotation-rz-error) | [Operational](#operational-yesno) | [Gate length (ns)](#gate-length-ns) | [2Q error (best)](#2q-error-best-heron-cz-eagle-ecr) | [RZZ error](#rzz-error-heron)
...
### 2Q error (best) (Heron: CZ, Eagle: ECR)
