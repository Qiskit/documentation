...
The following is a subset of QPU configuration values available in IBM Quantum Platform and from [Qiskit](/docs/api/qiskit/qiskit.providers.BackendV2).
...
*   **Region** - Location of the data center where your data and experiments are hosted and processed.
*   **Total pending jobs** - The total number of jobs that you have submitted to this QPU.
*   **Processor type** - Reflects the [topology](/docs/guides/processor-types) and indicates the approximate qubit count.
