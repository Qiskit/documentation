...
The "map the problem to quantum circuits and operators" step of a Qiskit pattern
describes how a user starts with a classical problem and figures out how to map it to a quantum computer.
...
* [MPF Qiskit Addon](/guides/qiskit-addons-mpf)
  * [Get started with MPF](/guides/qiskit-addons-mpf-get-started)