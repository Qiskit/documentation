...
print(f"print(gate twirling is turned on: {estimator.options.twirling.enable_gates}")
print(f"print(measurement error mitigation is turned on: {estimator.options.resilience.measure_mitigation}")
```
  </TabItem>
...
print(f"print(dynamical decoupling is turned on: {sampler.options.dynamical_decoupling.enable}")
print(f"print(gate twirling is turned on: {sampler.options.twirling.enable_gates}")
