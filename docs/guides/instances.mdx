...
For Qiskit Runtime v0.42 or later, free plans are prioritized by default when [automatic instanc selection](/docs/guides/initialize-account#auto-select) is used.
</Admonition>
