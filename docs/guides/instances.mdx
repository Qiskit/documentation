...
You can specify an instance when initializing the service or provider, or when choosing a QPU.  You can copy the service-level code by clicking the three dots by the instance name on the Instances section of the [Account overview page](https://quantum.ibm.com/account).
