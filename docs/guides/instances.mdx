...
Administrators can archive any instance within their account. 
- Archiving an instance ensures that collaborators retain access to results and QPU metrics, properties, and calibrations from past workloads.
...
- All archived instances are organized under a dedicated "Archived" tab.
