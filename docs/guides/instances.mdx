...
<CloudContent>
<Admonition type="note">
 Administrators can filter analytics data by instance (as well as by other options) by choosing specific parameters in the Filters card on the [Analytics](https://quantum.cloud.ibm.com/admin/analytics) page.
 </Admonition>
 </CloudContent>
 <LegacyContent>
