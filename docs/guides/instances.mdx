...
3. In all other cases, the code selects the first instance other than the Open Plan instance that has access to the quantum computer. If this instance is not associated with a free plan, a cost will be incurred, except under special circumstances, such as if you have credits that give you free usage.
</Admonition>
