...
<Admonition type="tip" title="Recommendations">
    ...
    - [Initialize the Quantum Compute Service](/docs/guides/initialize-account) in a trusted Python environment.
    - [Initialize the Quantum Compute Service in an **untrusted environment**](/docs/guides/cloud-setup-untrusted).
</Admonition>