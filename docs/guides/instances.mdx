...
![Collaborator's dashboard view, reflecting an instance that has exceeded its specified limit](/images/guides/instances/exceeded-limit-instance.png)
_Collaborator's dashboard view, reflecting an instance that has exceeded its specified limit_

![Collaborator's dashboard view, reflecting an instance (with no limit specified) that has exceeded its allocation](/images/guides/instances/exceeded-allocation-instance.png)
