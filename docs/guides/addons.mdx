...
<CardGroup>
    ...
    <Card
      ...
      description="Work with fermionic quantum systems using data structures for fermionic operators, fermion-to-qubit encodings, fermionic circuit synthesis, and integration with the Qiskit transpiler."
