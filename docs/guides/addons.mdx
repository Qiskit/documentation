...
<CardGroup>
    ...
    <Card
      ...
      description="Work with fermionic systems using data structures for fermionic operators and circuits, as well as frameworks for fermion-to-qubit encodings and circuit synthesis through the Qiskit transpiler integration."
      href="/docs/addons/qiskit-fermions"
      analyticsName="Documentation page: Qiskit Fermions"
      linkText="Browse documentation"
    />
...
## Learn noise models
Use the following tools for learning and refining noise models as part of your error mitigation strategy

<CardGroup>
  <Card
      title="Noise learning"
      description="Build randomization-based quantum noise characterization experiments and model-fitting analysis pipelines"
      href="/docs/addons/qiskit-noise-learning"
      analyticsName="Documentation page: NL"
      linkText="Browse documentation"
    />
    <Card
...
<CardGroup>
  ...
  <Card
      ...
      description="Build custom error mitigation pipelines with techniques such as PEC, ZNE, and TREX directly with Samplomatic."
      href="/docs/addons/qiskit-mitigation"
      analyticsName="Documentation page: Qiskit Mitigation"
      linkText="Browse documentation"
    />
...
<CardGroup>
    ...
    <Card
      ...
      href="/docs/addons/qiskit-addon-paulice"
