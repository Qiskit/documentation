...
<CardGroup>
  <Card
    ...
    <Card
      ...
      description="Reduce the sampling overhead of probabilistic error cancellation (PEC) by removing noise model terms that have low impact on the observable estimation."
