...
3. Launch qBraid Lab, click the **ENVS** icon on the right, click **+ ADD** at the top of the new sidebar, seach for Qiskit.  Click the version you want to use, then click **Install**.
...
2. Go to the [Google Google Colab landing page](https://colab.research.google.com/) and sign in with your Google account.
