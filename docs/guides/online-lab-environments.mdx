...
For platforms without Qiskit preconfigured, the setup instructions are similar: create an account, start a new project (or notebook or workspace, depending on the platform), and pip install Qiskit.
