...
## 4. Create access groups for instances
...
Next, [create an access group](/docs/guides/access-groups) for each instance and give that group the minimum set of permissions that are required to work with the instance's resources.
