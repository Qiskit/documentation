...
The [EstimatorV1](/api/qiskit-ibm-runtime/qiskit_ibm_runtime.EstimatorV1) has been deprecated in `qiskit-ibm-runtime` 0.23.
Its support will be removed no earlier than 15 August 2024.
...
<Admonition type="warning">
The [SamplerV1](/api/qiskit-ibm-runtime/qiskit_ibm_runtime.SamplerV1) has been deprecated in `qiskit-ibm-runtime` 0.23.
Its support will be removed no earlier than 15 August 2024.
