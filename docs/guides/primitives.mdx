...
- The Qiskit Runtime primitives ([`EstimatorV2`](/api/qiskit-ibm-runtime/estimator-v2) and [`SamplerV2`](/api/qiskit-ibm-runtime/sampler-v2)) provide a more sophisticated implementation (for example, by including error mitigation) as a cloud-based service. This implementation of the base primitives is used to access IBM Quantum&reg; hardware.  They are accessed through IBM Qiskit Runtime.
