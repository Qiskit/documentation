...
For a more detailed introduction to installing the Qiskit SDK, check out the [installation guide](/docs/guides/install-qiskit). If you're ready to install it now, simply run:
