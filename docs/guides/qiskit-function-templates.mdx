...
The source files for these two templates can be accessed at the links below:

- [Template for Hamiltonian simulation](https://github.com/qiskit-community/qiskit-function-templates/tree/main/physics/hamiltonian_simulation)
- [Template for electronic structure simulation with implicit solvent model](https://github.com/qiskit-community/qiskit-function-templates/tree/main/chemistry/sqd_pcm)
