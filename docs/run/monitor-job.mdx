...
*   IBM Quantum&reg; channel: In IBM Quantum Platform, open the [Jobs page](https://quantum.ibm.com/jobs).
...
<Admonition type="note">
  service.jobs() returns only Qiskit&reg; Runtime jobs. To retrieve other jobs, use [qiskit-ibm-provider](../api/qiskit-ibm-provider/qiskit_ibm_provider.IBMBackend#ibmbackend) instead.
</Admonition>
