...
The following systems have been retired. For the full list of available systems, see the [Compute resources page.](../services/resources?services=systems) By default, the information is shown in the card view, but you can use the view switchers (![view-switcher](/images/migration/view-switcher1.png)) at the top right to change to a sortable table view.
