...
Each processor family has a particular set of native gates. 
...
X - 1Q
ID no-op
Reset - 1Q (special; not unitary)
qubit_init flag?


describing for 2Q, then 1Q, what each is, what the unitaries are, etc. Then explanation of reset

service.backends.... code to loop through all the backends

Basis gate is more abstract...
Native gate is concrete...
point to Representing quantum computers in transpile
