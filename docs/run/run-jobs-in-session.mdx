...
Before starting a session, you must [set up Qiskit&reg; Runtime](../start/install) and initialize it as a service:
...
```
 ...
 You can also view session details on the [Quantum Platform Jobs page](https://quantum.ibm.com/jobs) or on the IBM Cloud&reg; Jobs page, which you access from your [Instances page](https://cloud.ibm.com/quantum/instances). 
