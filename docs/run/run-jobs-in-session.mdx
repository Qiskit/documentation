...
Before starting a session, you must [set up Qiskit Runtime](https://quantum-computing.ibm.com/start/install) and initialize it as a service:
...
For the full list, see the [Sessions API documentation](https://quantum-computing.ibm.com/api/qiskit-ibm-runtime/qiskit_ibm_runtime.Session#session).
