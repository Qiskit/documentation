---
title: Advanced Qiskit Runtime options 2
description: Specify options when building with Qiskit Runtime primitives

---

# Advanced Qiskit Runtime options 2
...
<Tabs>
  <TabItem value="EstimatorV2" label="Estimator V2">
| Sub-options              | Sub-sub-options         | Choices                                                                                   | Default                   |
|--------------------------|-------------------------|-------------------------------------------------------------------------------------------|---------------------------|
...
### option = resilience_level

### option = dynamical_decoupling
