...
After submitting a job to the IBM Quantum&reg; channel, you can see an estimation for how much _quantum time_ the job will take to run by using `job.usage_estimation`.  Alternatively, you can [view this information on the IBM Quantum Platform user interface](#view-usage).
...
<Admonition type="note" title="Notes">
    ...
    - This is not yet available on the Qiskit&reg; Runtime on IBM Cloud&reg; channel. 
</Admonition>
