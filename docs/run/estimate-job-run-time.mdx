...
- On the job's details page. From the [home page](https://quantum-computing.ibm.com/) or [Jobs table](https://quantum-computing.ibm.com/jobs), click the job ID to open the job details page.  The estimated usage is shown in the Status Timeline. 