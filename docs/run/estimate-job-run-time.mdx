...
- On the [Jobs table](../jobs) in the Usage column.  From the Home page, click *View all* on the Recent jobs table.  The Usage column shows the estimated usage for pending jobs, or actual usage for completed jobs. 
- On the job's details page. From the [Dashboard](../) or [Jobs table](../jobs), click the job ID to open the job details page.  The estimated usage is shown in the Status Timeline. 