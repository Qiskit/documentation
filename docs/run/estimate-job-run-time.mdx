...
After submitting a job to the IBM Quantum channel, you can see an estimation for how much _quantum time_ the job will take to run. You can use `job.usage_estimation`.  Alternatively, you can view this information on the IBM Quantum Platform user interface.

Quantum time is the duration a quantum system is committed to fulfilling a user request.
...
You can view the estimated usage (in seconds) in two places on IBM Quantum Platform:
