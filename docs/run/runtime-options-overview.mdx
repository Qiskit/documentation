...
- ![Limitations](/images/run/runtime-options-overview/warning.svg) - - These features can be used together but with limitations.
...
| Gate-folding ZNE         | ✅                | 🚫                                                               |                                    | 🚫   | ![Incompatible](/images/run/runtime-options-overview/error.svg) | ![Compatible](/images/run/runtime-options-overview/checkmark.svg) | ![Limitations](/images/run/runtime-options-overview/warning.svg) - Might not work with custom gates | ![Compatible](/images/run/runtime-options-overview/checkmark.svg)    |
| PEA                      | 🚫                | 🚫                                                               | 🚫                                  |     | 🚫                                                               | ✅                                                                 | 🚫                                                                                                   | ✅                                                                    |
| PEC                      | 🚫                | 🚫                                                               | 🚫                                  | 🚫   |                                                                 | ✅                                                                 | 🚫                                                                                                   | ✅                                                                    |
...
You can set optitons in an options class, when initializing the primitive, when calling the `run()` method, or any combination of those.
