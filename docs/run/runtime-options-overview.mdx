...
client default (Unset) and where to find server defaults
...
Specify options as follows:  `primitive.options.option.sub-option.sub-sub-option = choice`

Example: `estimator.options.dynamical_decoupling.enable = True`
