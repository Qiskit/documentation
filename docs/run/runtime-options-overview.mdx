...
| default_precision    |                          |                         |                                                                                           | `0.015625 (1 / sqrt(4096))`     |
...
|                      |                          | max_layers_to_learn     |  `None`/ integer                                                                            | `4`                    |
|                      |                          | shots_per_randomization |  integer                                                                         |  `128`                    |
|                      |                          | num_randomizations      |   integer                                                                                |  `32`                    |
|                      |                          | layer_pair_depths       |  list[int] of 2-10 values in the range [0, 200]                                              | `(0, 1, 2, 4, 16, 32)`              |
|                      | measure_mitigation       |                         | `True`/`False`                                                                                | `True`                      |
|                      | measure_noise_learning   | num_randomizations      |  integer                                                                             | `32`                      |
|                      |                          | shots_per_randomization |  integer                                                                                 | 'auto'                    |
|                      | pec                      | max_overhead            |  `None`/ integer                                                                          | `100`                      |
...
|                      | num_randomizations       |                         |  `auto`/ integer                                                                             | `'auto'`                    |
|                      | shots_per_randomization  |                         |   `auto`/ integer                                                                           | `'auto'`                    |
