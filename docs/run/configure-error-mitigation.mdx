...
You can use resilience levels to specify error mitigation techniques, or you can set custom techniques individually as described in [Custom error settings with Estimator V2.](#advanced-options) You cannot specify resiliance levels in Sampler V2. However, you can set custom techniques individually.
