...
<Admonition type="note">
  If using an IBM Cloud&reg; Qiskit&reg; Runtime service instance with Q-CTRL performance management enabled, there is no need to specify runtime optimization or resilience levels, as the strategy includes an automatic preset.
...
| twirling   | gates                    | Whether to apply two-qubit gate twirling.                                                                                                                                                                                                 | False          | Estimator only |
| twirling   | measure                  | Whether to apply measurement twirling.                                                                                                                                                                                                  | True           | Estimator only |
| twirling   | strategy                 | Specify the strategy of twirling qubits in identified layers of  two-qubit twirled gates.                                                                                                                                                 | `active-accum` | Estimator only |
