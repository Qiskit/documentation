...
-  You don't get exclusive access to the quantum system.  Therefore, if another user's job is already using the system, your jobs have to wait.  Additionally, system calibration jobs could run between the batched jobs. 
