...
![An expanded card for a sample system.](/images/migration/exp-card.png 'Expanded card for a sample system')
...
![The graph view tab shows the calibration data as a graph.](/images/migration/graph-view1.png 'Graph view tab')
