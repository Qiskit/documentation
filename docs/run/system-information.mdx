...
The following is a subset of system configuration values available in IBM Quantum and from [Qiskit&reg;](/api/qiskit/qiskit.providers.models.BackendConfiguration).
