...
<Admonition type="tip" title="Recommendations">
    ...
    - Find details about [runtime compilation](../run/configure-error-suppression) and [error mitigation](../run/configure-error-mitigation). 
</Admonition>
