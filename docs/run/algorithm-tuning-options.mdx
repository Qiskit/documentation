---
title: Algorithm tuning options
description: Common settings to use when tuning primitive options

---

<span id="tuning-opt"></span>
...
[Submitting user-transpiled circuits using primitives tutorial](https://learning.quantum-computing.ibm.com/tutorial/submitting-user-transpiled-circuits-using-primitives).
