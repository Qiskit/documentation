...
Here is an example of computing the quasi-probability distribution of a quantum circuit using the Qiskit Runtime Estimator primitive. This Python script should be saved in your working directory. (Warning! All contents of the working directory will be shipped to the cluster for execution.)
...
After creating a workflow, authenticate to the `IBMServerlessProvider` with your [IBM Quantum token](account-management), and upload the script.
