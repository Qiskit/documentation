...
* To reduce the total execution time, v2 primitives only support *lightweight transpilation*. If you need more advanced transpilation, you can use the Qiskit transpiler or the AI transpilation service, as described in the [Runtime compilation section.](advanced-runtime-options#runtime-compilation)
