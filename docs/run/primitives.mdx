...
The need to sample and estimate data is fundamental to quantum computation. With this in mind, Qiskit has introduced its first two primitives: Estimator and Sampler.
