...
| Estimator V1                                                                                                                                                                                             | Estimator V2                                                                                                                                                                                |
|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| * Takes three parameters: circuits, observables, and parameter_values. * Each parameter can be a single value or a list. * The length of the parameters must match. * Elements from each are aggregated. | * Takes one parameter - PUBs * Each PUB is a tuple containing the following:     - 1 circuit    - 1 or more observables for the circuit    - 0 or more parameter value sets for the circuit |
| `estimator.run(    [circuit1, circuit2, ...],    [observable1, observable2, ...],    [param_values1, param_values2, ...] )`                                                                              | `estimator.run([    (circuit1, observable1, param_values1),    (circuit2, observable2, param_values2) ])`                                                                                   |
