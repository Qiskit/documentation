...
A      (3d array):  11 x 2 x 7
B      (3d array):  11 x 1 x 7
...
A      (2d array):      2 x 1
B      (3d array):  6 x 5 x 4 # This would work except for the middle dimensions (2 compared to 5).
```
...
observables = observable = SparsePauliOp("Z" * 5)
