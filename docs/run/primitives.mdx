...
* Takes one parameter: PUBs.
* Each PUB is a tuple containing one circuit, one or more observable for the circuit, and one or more parameter value sets for the circuit.
* Elements from each are aggregated.
