---
title: Primitives using REST API
description: How to use the Sampler and Estimator primitives with Qiskit Runtime REST API.
---

# Primitives using REST API

The steps in this topic describe how to run primitives workloads with REST API, explore the options you can use to configure them, and invoke them in any program of your choice.

<Admonition type="note">
    This documentation utilizes the `requests` module of python to demonstrate the Qiskit Runtime REST API. However, this workflow can be executed using any language/framework that supports working with REST APIs. The official documentation for the API Reference can be found [here](https://docs.quantum.ibm.com/api/runtime/tags/jobs).
</Admonition>
...
Because Qiskit Runtime `Estimator` is a managed service, you first need to initialize your account. You can then select the simulator or real system you want to use to calculate the expectation value. You can then select the IBM Quantum Compute resource of your choice to run your calculations on. 

Details on how to initialize your account, view available backends and invalidate tokens can be found in this [topic](/start/setup-channel#access-ibm-quantum-systems-using-rest-api).
...
The code snippets given below assume that the `qasm_string` has been transpiled to a new string `resulting_qasm`. Detailed instructions on how to use the Cloud Transpiler API can be found in this [topic](/transpile/rest-api-transpilation).
...
You will see examples of three such error mitigation / suppression techniques when used with the Estimator Primitive. The examples given below demonstrate the default options for Dynamical decoupling, Twirling and TREX + ZNE. More options and further details can be found [here](https://docs.quantum.ibm.com/run/error-mitigation-explanation).
...
You will see examples of two such error mitigation / suppression techniques when used with the Sampler Primitive. The examples given below demonstrate the default options for Dynamical decoupling and Twirling. More options and further details can be found [here](https://docs.quantum.ibm.com/run/error-mitigation-explanation).   
...
<Admonition type="tip" title="Recommendations">
    ...
    - Learn how to [initialize your account](/start/setup-channel#access-ibm-quantum-systems-using-rest-api) with REST API.
