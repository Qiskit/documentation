...
Details on how to initialize your account, view available backends and invalidate tokens can be found in this [topic](setup-channel#set-up-account-using-rest-apis).
...
The code snippets given below assume that the `qasm_string` has been transpiled to a new string `resulting_qasm`. Detailed instructions on how to use the Cloud Transpiler API can be found in this [topic](rest-api-transpilation).
