---
title: Primitives with REST APIs
description: How to use the Sampler and Estimator primitives with Qiskit Runtime REST APIs.
---

# Primitives with REST APIs
...
Details on how to initialize your account, view available backends and invalidate tokens can be found in this [topic](/start/setup-channel#set-up-account-using-rest-apis).
...
<Admonition type="tip" title="Recommendations">
    ...
    - Learn how to [initialize your account](/start/setup-channel#set-up-account-using-rest-apis) with REST APIs.
    - Learn how to [transpile circuits using REST APIs](/transpile/rest-api-transpilation).
