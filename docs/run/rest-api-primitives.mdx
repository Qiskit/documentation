...
Because Qiskit Runtime `Estimator` is a managed service, you first need to initialize your account. You can then select the device you want to use to calculate the expectation value. You can then select the IBM Quantum Compute resource of your choice to run your calculations on. 

Details on how to initialize your account, view available backends and invalidate tokens can be found in this [topic](/start/setup-channel#set-up-to-use-ibm-quantum-platform-with-rest-api).
...
Because Qiskit Runtime `Sampler` is a managed service, you first need to initialize your account. You can then select the device you want to use to calculate the expectation value. You can then select the IBM Quantum Compute resource of your choice to run your calculations on. 
...
<Admonition type="tip" title="Recommendations">
    ...
    - Learn how to [initialize your account](/start/setup-channel#set-up-to-use-ibm-quantum-platform-with-rest-api) with REST API.
