...
Details on how to initialize your account, view available backends and invalidate tokens can be found in this [topic](/start/setup-channel#set-up-account-using-rest-api).
...
<Admonition type="tip" title="Recommendations">
    ...
    - Learn how to [initialize your account](/start/setup-channel#set-up-account-using-rest-api) with REST API.
