...
### V2 primitives optmization level behavior

Estimator V2 does not accept levels higher than 1 and Sampler V2 does not accept `optimization_level`.
...
### V1 primitives optimization level behavior
