...
Future versions of the Primitives will offer options to tune runtime compilation. At present, the only option with any effect is `skip_transpilation` to turn off all optimziations done with the Primitives.
