...
sampler.options.dynamical_decoupling.scheduling_method = "XpXm"

print(f">>> dynamical decoupling sequence to use: {sampler.options.dynamical_decoupling.scheduling_method}")
``` 
  </TabItem>
