...
<Tabs>
  <TabItem value="PrimV2" label="V2 primitives">
    In the V2 primitives, you can explicitly enable and disable individual error mitigation/suppression methods, such as dynamical decoupling. See [Custom error settings](configure-error-mitigation#advanced-options) for details and examples. 
  </TabItem>
