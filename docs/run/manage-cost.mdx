...
<Admonition type="note">
  The information in this topic only applies to those who are using the Standard plan for Qiskit&reg; Runtime on IBM Cloud.  There are no costs associated with IBM Quantum&reg; Platform Open plan.
</Admonition>
