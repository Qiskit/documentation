...
The [`qiskit_addon_sqd.fermion.solve_fermion()`](fermion#qiskit_addon_sqd.fermion.solve_fermion "qiskit_addon_sqd.fermion.solve_fermion") function is multithreaded and capable of handling systems with \~25 spacial orbitals and \~10 electrons with subspace dimensions of \~\$10^7\$, using \~10-30 cores.
