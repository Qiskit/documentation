---
title: "Electronic Integrals"
description: "Electronic Integrals for the latest version of Qiskit Fermions"
---
...
<Function id="c.qf_ferm_op_from_1body_tril_spin_sym" signature="QfFermionOperator *qf_ferm_op_from_1body_tril_spin_sym(double *one_body_a, uint32_t norb)">
...
<Function id="c.qf_ferm_op_from_1body_tril_spin" signature="QfFermionOperator *qf_ferm_op_from_1body_tril_spin(double *one_body_a, double *one_body_b, uint32_t norb)">
...
<Function id="c.qf_ferm_op_from_2body_tril_spin_sym" signature="QfFermionOperator *qf_ferm_op_from_2body_tril_spin_sym(double *two_body_aa, uint32_t norb)">
...
<Function id="c.qf_ferm_op_from_2body_tril_spin" signature="QfFermionOperator *qf_ferm_op_from_2body_tril_spin(double *two_body_aa, double *two_body_ab, double *two_body_bb, uint32_t norb)">
