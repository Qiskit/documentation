...
description: "Filtering Functions for the latest version of Qiskit Fermions"
---
...
<Function id="c.qf_ferm_op_filter_diagonal_terms" signature="void qf_ferm_op_filter_diagonal_terms(QfFermionOperator *op)">
