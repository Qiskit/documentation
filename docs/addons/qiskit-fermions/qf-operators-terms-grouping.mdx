...
description: "Grouping Functions for the latest version of Qiskit Fermions"
---
...
<Function id="c.qf_ferm_op_group_terms_by_electronic_structure" signature="QfExitCode qf_ferm_op_group_terms_by_electronic_structure(QfFermionOperator *op, uint32_t num_modes, bool two_body_physicist_order)">
