---
title: "Installation Instructions - Qiskit addon utilities 0.3.1"
description: "Installation Instructions for Qiskit addon utilities"
---
...
The next step is to install `qiskit-addon-utils` to the virtual environment. If you plan on running the notebooks, install the notebook dependencies in order to run all the visualizations in the notebooks. If you plan on developing in the repository, you may want to install the `dev` dependencies.
