...
The next step is to install `pauli-prop` to the virtual environment. Install the notebook dependencies if you want to run all the visualizations in the notebooks. If you plan on developing in the repository, you can install the `dev` dependencies.
