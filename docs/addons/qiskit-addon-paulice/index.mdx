...
This technique has been used to improve the fidelity of samples from Clifford-dominated circuits up to 50 qubits and 2450 entangling gates <span id="id2" />[\[1\]](#id4).
