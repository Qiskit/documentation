...
This technique has been used to improve the fidelity of samples from Clifford-dominated circuits up to 50 qubits and 2450 entangling gates [\[1\]](#references).

## Technical discussion

### Finding good sets of spacetime Pauli checks

![Quantum circuit cartoon](/docs/images/addons/qiskit-addon-paulice/paulice.avif)
...
\[[1](#id1)] Simon Martiel, Ali Javadi-Abhari, [Low-overhead error detection with spacetime codes](https://arxiv.org/abs/2504.15725), arXiv:2504.15725 \[quant-ph].
