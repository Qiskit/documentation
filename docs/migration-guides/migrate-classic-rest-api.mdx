...
As part of the move to the new IBM Quantum&reg; Platform, the Qiskit Runtime REST API on the classic IBM Quantum Platform and the Qiskit Runtime REST API on IBM Cloud&reg; have been combined into one REST API: the *Qiskit Runtime REST API*.
