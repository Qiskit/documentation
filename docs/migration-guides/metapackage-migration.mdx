---
title: Understand the breaking packaging changes
description: Understand the packaging changes that occurred with the release of Qiskit 1.0
---

# Understand the breaking Qiskit 1.0 package changes
...
To better explain how the old Qiskit metapackage was structured and how that has changed with the release of Qiskit 1.0, below is a glossary of commonly used Python-packaging jargon. The following words have specific meanings that we'll use in this document.
<details>
