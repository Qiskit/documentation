...
<Admonition type="note">
For most users, `AerSimulator` is a good choice, due to its flexibility and performance. However, if your work targets a specific QPU, refer to the above table to determine which simulator to use.
</Admonition>
