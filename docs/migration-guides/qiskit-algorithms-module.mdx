...
* For running on quantum hardware choose from these options:
   ...
   - Access services with native primitive implementations, such as the Qiskit Runtime service by using [`qiskit_ibm_runtime.Sampler`](/api/qiskit-ibm-runtime/0.27/qiskit_ibm_runtime.SamplerV1) and [`qiskit_ibm_runtime.Estimator`.](/api/qiskit-ibm-runtime/0.27/qiskit_ibm_runtime.EstimatorV1)
...
```python
from qiskit_ibm_runtime import SamplerV1 as Sampler, EstimatorV1 as Estimator, QiskitRuntimeService, Session
