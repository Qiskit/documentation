...
<Admonition type="caution">
  ...
  setup. Most [`qiskit.opflow`](/api/qiskit/0.46/opflow) dependencies have a direct [`qiskit.quantum_info`](/api/qiskit/quantum-info)
  ...
  (for example, to plug into VQE), which can be replaced by [`qiskit.quantum_info.SparsePauliOp`](/api/qiskit/quantum-info-sparse-pauli-op).
...
* For quick prototyping, use the reference implementations of primitives included in Qiskit: [`qiskit.primitives.Sampler`](/api/qiskit/primitives-sampler) and [`qiskit.primitives.Estimator`](/api/qiskit/primitives-estimator).
...
* For running on quantum hardware choose from these options:
   ...
   - Wrap any QPU (quantum processing unti) with `Backend` primitives ([`qiskit.primitives.BackendSampler`](/api/qiskit/primitives-backend-sampler) and [`qiskit.primitives.BackendEstimator`](/api/qiskit/primitives-backend-estimator)). These wrappers implement a primitive interface on top of a backend that only supports `backend.run()`.
...
by using an instance of the [`qiskit.primitives.Sampler`](/api/qiskit/primitives-sampler) or [`qiskit.primitives.Estimator`](/api/qiskit/primitives-estimator) primitive, depending
...
<Admonition type="note">
  In addition to taking in an [`qiskit.primitives.Estimator`](/api/qiskit/primitives-estimator) instance instead of a [`qiskit.utils.QuantumInstance`](/api/qiskit/0.46/qiskit.utils.QuantumInstance),
...
<Admonition type="note">
  In addition to taking in a [`qiskit.primitives.Sampler`](/api/qiskit/primitives-sampler) instance instead of a [`qiskit.utils.QuantumInstance`](/api/qiskit/0.46/qiskit.utils.QuantumInstance),
...
<Admonition type="note">
  If you want to run QAOA on a non-diagonal operator, use the [`qiskit.circuit.library.QAOAAnsatz`](/api/qiskit/circuit-library-qaoa-ansatz) with
...
using an instance of the [`qiskit.primitives.Sampler`](/api/qiskit/primitives-sampler) or [`qiskit.primitives.Estimator`](/api/qiskit/primitives-estimator) primitive, or
...
[`qiskit.primitives.Estimator`](/api/qiskit/primitives-estimator) primitive instead of a [`qiskit.utils.QuantumInstance`](/api/qiskit/0.46/qiskit.utils.QuantumInstance).
It also takes an instance of a state fidelity class from mod:`qiskit.algorithms.state_fidelities`,
such as the [`qiskit.primitives.Sampler`](/api/qiskit/primitives-sampler)-based [`qiskit.algorithms.state_fidelities.ComputeUncompute`](/api/qiskit/0.46/qiskit.algorithms.state_fidelities.ComputeUncompute).

<Admonition type="note">
  In addition to taking in a [`qiskit.primitives.Estimator`](/api/qiskit/primitives-estimator) instance instead of a [`qiskit.utils.QuantumInstance`](/api/qiskit/0.46/qiskit.utils.QuantumInstance),
...
using a [`qiskit.primitives.Estimator`](/api/qiskit/primitives-estimator) primitive instance. The legacy classes can still be found
...
using an instance of any Sampler primitive.  That is, [`qiskit.primitives.Sampler`](/api/qiskit/primitives-sampler).
