...
The evolution of [user access patterns for QPUs](/docs/guides/primitives#qpu-access-patterns)
...
Qiskit defines base interfaces ([BaseEstimatorV2](/docs/api/qiskit/qiskit.primitives.BaseEstimatorV2)
and [BaseSamplerV2](/docs/api/qiskit/qiskit.primitives.BaseSamplerV2)) that set the standards for input and output handling
...
querying job status, and returning the job results. See the `qiskit.primitives` [API documentation](/docs/api/qiskit/primitives)
for more information.

The primitive unified bloc (PUB) data model defines the primitive input format, as described in
[Overview of PUBs](/docs/guides/primitive-input-output#pubs).
...
The [PrimitiveResult](/docs/api/qiskit/qiskit.primitives.PrimitiveResult)
defines the output of a primitive job. It is comprised of additional data models such as
[PubResult](/docs/api/qiskit/qiskit.primitives.PubResult) and
[DataBin](/docs/api/qiskit/qiskit.primitives.DataBin).
See [Overview of primitive results](/docs/guides/primitive-input-output#overview-of-primitive-outputs)
for more information.
...
This implementation is based on the [`StatevectorSampler` source code](/docs/api/qiskit/qiskit.primitives.StatevectorSampler),
...
Similar to the `Sampler` example, this implementation is based on the [`StatevectorEstimator` source code](/docs/api/qiskit/qiskit.primitives.StatevectorEstimator),
