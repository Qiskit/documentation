...
If you have been invited by your organization to join a **Premium Plan account:** 
...
- You have already been added to an instance in your organization's account, so your next step is to [find your access credentials](#access-credentials), as detailed in the "Set up your IBM Cloud account" guide.
