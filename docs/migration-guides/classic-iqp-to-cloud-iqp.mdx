...
Early access mode means that while you are able to log in, create instances, run jobs, and so on, some functions are not yet available and will be added in the coming months. Find the recent changes in the new platform on the [Latest updates page,](/guides/latest-updates), which is updated every two weeks.

You can also continue to use [IBM Quantum Platform Classic](https://quantum.ibm.com/) until it is sunset on 1 July, 2025.
...
Instead of accessing [IBM Quantum Platform Classic](https://quantum.ibm.com/), you will now access the [upgraded version of IBM Quantum Platform](https://quantum.cloud.ibm.com/), which is integrated with IBM Cloud.  Because of this integration, all users need to follow the onboarding instructions before using the new platform.

### Save results from IBM Quantum Platform Classic

<Admonition type="important">
Jobs that were run on IBM Quantum Platform Classic will not be available after that version of platform is sunset on 1 July, 2025. Open users should therefore save any workloads data from the classic platform prior to that date by following the steps in the [Save and retrieve jobs](/guides/save-jobs) guide. Premium Plan, Dedicated Service, and Startup Program users should wait to receive  guidance from their administrators regarding whether and when to download historical data.
</Admonition>
