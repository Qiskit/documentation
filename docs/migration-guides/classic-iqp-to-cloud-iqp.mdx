...
Premium Plan, On-Prem, and Startup Program users should not create a new account yet and should wait to receive migration guidance from their administrators in the coming weeks.
...
* Premium Plan, On-Prem, and Startup Program users should wait to receive  guidance from their administrators regarding whether to download historical data.
