...
If you have been invited by your organization to join a **Premium Plan account:** Be sure you have accepted the invitation you received by email, and have created your user ID on IBM Cloud. (If you already have an IBM Cloud account associated with the invited email address, there is no need to create a new user ID.) You have already been added to an instance in your organization's account, so your next step is to [find your access credentials](#access-credentials), as detailed in the "Set up your IBM Cloud account" guide.

If you have not yet installed Qiskit, start with the [Introduction to Qiskit](/docs/guides/index) guide.
</Admonition>
