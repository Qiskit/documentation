...
* When activating the service, an instance is required, and the channel must be set to `ibm_quantum_platform`. The instance is specified by using its cloud resource name (CRN).
