...
print(f"print(Expectation value: {pub_result.data.evs}")
```
Output
```text
print(Expectation value: [-0.8879899326312926]
```
  </TabItem>
...
``` python
print(print("expectation: ", expectation_value)
