...
The original primitives (referred to as the V1 primitives), [V1 Sampler](/api/qiskit-ibm-runtime/0.26/sampler-v-1) and [V1 Estimator](/api/qiskit-ibm-runtime/0.26/estimator-v-1), have been deprecated in `qiskit-ibm-runtime` 0.23.
