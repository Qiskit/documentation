...
information about retrieving account credentials, see [Select and set up an IBM Quantum channel](/guides/setup-channel).
...
<CloudContent>
For information about retrieving account credentials, see [Set up your IBM Cloud account](/guides/cloud-setup).
```python
