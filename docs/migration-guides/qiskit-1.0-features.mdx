...
[`run`](/api/qiskit/providers-backend-v-2#run) functions in Qiskit.
Instead of `qiskit.execute`, use the
[`transpile`](/api/qiskit/compiler#transpile) function followed by
[`backend.run()`](/api/qiskit/providers-backend-v-2#run).
...
Alternatively, the [Sampler](/api/qiskit/primitives-sampler)
primitive is semantically equivalent to the removed `qiskit.execute`
function. The class
[`BackendSampler`](/api/qiskit/primitives-backend-sampler) is a
...
[`qasm2.dump`](/api/qiskit/qasm-2#dump) or
[`qasm2.dumps`](/api/qiskit/qasm-2#dumps).
...
| Removed                      | Alternative |
|------------------------------|----------------------|
| `QuantumCircuit.cnot`        | [`QuantumCircuit.cx`](/api/qiskit/circuit-quantum-circuit#cx)       |
| `QuantumCircuit.toffoli`     | [`QuantumCircuit.ccx`](/api/qiskit/circuit-quantum-circuit#ccx)     |
| `QuantumCircuit.fredkin`     | [`QuantumCircuit.cswap`](/api/qiskit/circuit-quantum-circuit#cswap) |
| `QuantumCircuit.mct`         | [`QuantumCircuit.mcx`](/api/qiskit/circuit-quantum-circuit#mcx)     |
| `QuantumCircuit.i`           | [`QuantumCircuit.id`](/api/qiskit/circuit-quantum-circuit#id)       |
| `QuantumCircuit.squ`         | [`QuantumCircuit.unitary`](/api/qiskit/circuit-quantum-circuit#unitary) |
...
|------------------------------|----------------------|
| `QuantumCircuit.diagonal`    | [`DiagonalGate`](/api/qiskit/circuit-library-diagonal-gate)          |
| `QuantumCircuit.hamiltonian` | [`HamiltonianGate`](/api/qiskit/circuit-library-hamiltonian-gate)    |
| `QuantumCircuit.isometry`    | [`Isometry`](/api/qiskit/circuit-library-isometry)           |
| `QuantumCircuit.iso`         | [`Isometry`](/api/qiskit/circuit-library-isometry)           |
| `QuantumCircuit.uc`          | [`UCGate`](/api/qiskit/circuit-library-uc-gate)               |
| `QuantumCircuit.ucrx`        | [`UCRXGate`](/api/qiskit/circuit-library-ucrx-gate)           |
| `QuantumCircuit.ucry`        | [`UCRYGate`](/api/qiskit/circuit-library-ucry-gate)           |
| `QuantumCircuit.ucrz`        | [`UCRZGate`](/api/qiskit/circuit-library-ucrz-gate)           |

For example, for a [`DiagonalGate`](/api/qiskit/circuit-library-diagonal-gate):
...
| Removed                          | Alternative |
|----------------------------------|-------------|
| `QuantumCircuit.bind_parameters` | [`QuantumCircuit.assign_parameters`](/api/qiskit/circuit-quantum-circuit#assign_parameters) |
...
[`DAGCircuit`](/api/qiskit/dagcircuit-dag-circuit). As the legacy
...
[`QuantumCircuit.from_qasm_file`](/api/qiskit/circuit-quantum-circuit#from_qasm_file)
or
[`QuantumCircuit.from_qasm_str`](/api/qiskit/circuit-quantum-circuit#from_qasm_str)
constructor methods (or the [`qiskit.qasm2`](/api/qiskit/qasm-2) module), then
convert that `QuantumCircuit` into a
[`DAGCircuit`](/api/qiskit/dagcircuit-dag-circuit) with
...
([`qiskit.circuit.library`](/api/qiskit/circuit-library)). To migrate to the
...
The classes moved to [`qiskit.circuit.library`](/api/qiskit/circuit-library) are:

* [`DiagonalGate`](/api/qiskit/circuit-library-diagonal-gate)
* [`HamiltonianGate`](/api/qiskit/circuit-library-hamiltonian-gate)
* [`Initialize`](/api/qiskit/circuit-library-initialize)
* [`Isometry`](/api/qiskit/circuit-library-isometry)
* `qiskit.circuit.library.generalized_gates.mcg_up_diag.MCGupDiag`
* [`UCGate`](/api/qiskit/circuit-library-uc-gate)
* [`UCPauliRotGate`](/api/qiskit/circuit-library-uc-pauli-rot-gate)
* [`UCRXGate`](/api/qiskit/circuit-library-ucrx-gate)
* [`UCRYGate`](/api/qiskit/circuit-library-ucry-gate)
* [`UCRZGate`](/api/qiskit/circuit-library-ucrz-gate)
* [`UnitaryGate`](/api/qiskit/circuit-library-unitary-gate)
...
Removed                          |   Alternative
---------------------------------|--------------------------------------------
`SingleQubitUnitary`    |  [`qiskit.circuit.library.UnitaryGate`](/api/qiskit/circuit-library-unitary-gate)
...
---------------------------------|--------------------------------------------
`BaseEstimator`         |  [`BaseEstimatorV2`](/api/qiskit/primitives-base-estimator-v-2)
`BaseSampler`             |  [`BaseSamplerV2`](/api/qiskit/primitives-base-sampler-v-2)
...
Migrate from                     |   Replace with
---------------------------------|--------------------------------------------
`qiskit.primitives.Estimator`         |  [`qiskit.primitives.StatevectorEstimator`](/api/qiskit/primitives-statevector-estimator)
`qiskit.primitives.Sampler`             |  [`qiskit.primitives.StatevectorSampler`](/api/qiskit/primitives-statevector-sampler)
...
2. [Sampler](/api/qiskit/primitives-base-sampler-v-2): The V2 sampler now
...
3. `Sampler and Estimator`: The sampling overhead, commonly exposed by V1 implementations
  ...
  The V2 base classes expose the arguments in formats different from the V1 API:
    ...
    * [`BaseSamplerV2.run`](/api/qiskit/primitives-base-sampler-v-2#run)
    ...
    * [`EstimatorV2.run`](/api/qiskit/primitives-base-estimator-v-2#run)
...
* Implicit conversion from a dense `BaseOperator` to a
  [`SparsePauliOp`](/api/qiskit/quantum-info-sparse-pauli-op) in
  [`Estimator`](/api/qiskit/primitives-estimator) observable arguments
  is no longer allowed. You should explicitly convert to a `SparsePauliOp`
by using
  [`SparsePauliOp.from_operator(operator)`](/api/qiskit/quantum-info-sparse-pauli-op#from_operator)
  instead.

* Using a [`PauliList`](/api/qiskit/quantum-info-pauli-list) in
  Estimator observable arguments is no longer allowed. Instead you should
  explicitly convert the argument by using
  [`SparsePauliOp(pauli_list)`](/api/qiskit/quantum-info-sparse-pauli-op)
  first.
...
[`qiskit.providers.basic_provider`](/api/qiskit/providers-basic-provider)
...
the [`quantum_info`](/api/qiskit/quantum-info) module.
...
Removed                          | Alternative
---------------------------------|--------------------------------------------
`qiskit.providers.basicaer`                            |  [`qiskit.providers.basic_provider`](/api/qiskit/providers-basic-provider)
`BasicAerProvider`             |  [`BasicProvider`](/api/qiskit/providers-basic-provider-basic-provider)
`BasicAerJob`                       |  [`BasicProviderJob`](/api/qiskit/providers-basic-provider-basic-provider-job)
`QasmSimulatorPy`               |  [`BasicSimulator`](/api/qiskit/providers-basic-provider-basic-simulator)
...
different [`quantum_info`](/api/qiskit/quantum-info) classes. This is not a
drop-in replacement, but the changes are minimal. See the following migration
examples:

Removed                          |   Alternative
---------------------------------|--------------------------------------------
`UnitarySimulatorPy`         |  [`quantum_info.Operator`](/api/qiskit/quantum-info-operator)
`StatevectorSimulatorPy` |  [`quantum_info.Statevector`](/api/qiskit/quantum-info-statevector)
...
<Admonition type="note">
    ...
    * [`qiskit.providers.fake_provider.Fake5QV1`](/api/qiskit/providers-fake-provider-fake-5-qv-1)
    * [`qiskit.providers.fake_provider.Fake20QV1`](/api/qiskit/providers-fake-provider-fake-20-qv-1)
    * [`qiskit.providers.fake_provider.Fake7QPulseV1`](/api/qiskit/providers-fake-provider-fake-7-q-pulse-v-1)
    * [`qiskit.providers.fake_provider.Fake27QPulseV1`](/api/qiskit/providers-fake-provider-fake-27-q-pulse-v-1)
    * [`qiskit.providers.fake_provider.Fake127QPulseV1`](/api/qiskit/providers-fake-provider-fake-127-q-pulse-v-1)

    This is a configurable class that returns `BackendV2` instances:

    * [`qiskit.providers.fake_provider.GenericBackendV2`](/api/qiskit/providers-fake-provider-generic-backend-v-2)
</Admonition>
...
[`GenericBackendV2`](/api/qiskit/providers-fake-provider-generic-backend-v-2)
class to configure a backend with similar properties or to build a custom
target.

Removed                          |   Alternative
---------------------------------|--------------------------------------------
`fake_provider.FakeBackendV2` | [`fake_provider.GenericBackendV2`](/api/qiskit/providers-fake-provider-generic-backend-v-2)
`fake_provider.FakeBackend5QV2` | [`fake_provider.GenericBackendV2`](/api/qiskit/providers-fake-provider-generic-backend-v-2)
`fake_provider.FakeBackendV2LegacyQubitProps` | [`fake_provider.GenericBackendV2`](/api/qiskit/providers-fake-provider-generic-backend-v-2)
`fake_provider.FakeBackendSimple` | [`fake_provider.GenericBackendV2`](/api/qiskit/providers-fake-provider-generic-backend-v-2)
`fake_provider.ConfigurableFakeBackend` | [`fake_provider.GenericBackendV2`](/api/qiskit/providers-fake-provider-generic-backend-v-2)
...
* Support for running pulse jobs on backends from
  [`qiskit.providers.fake_provider`](/api/qiskit/providers-fake-provider) has
...
[`qiskit.pulse.SymbolicPulse`](/api/qiskit/pulse-library-symbolic-pulse)
...
Removed                          |   Alternative
---------------------------------|--------------------------------------------
`pulse.library.parametric_pulses.ParametricPulse` | [`qiskit.pulse.SymbolicPulse`](/api/qiskit/pulse-library-symbolic-pulse)
`pulse.library.parametric_pulses.Constant` |  [`pulse.library.symbolic_pulses.Constant`](/api/qiskit/pulse-library-constant)
`pulse.library.parametric_pulses.Drag` |  [`pulse.library.symbolic_pulses.Drag`](/api/qiskit/pulse-library-drag)
`pulse.library.parametric_pulses.Gaussian` |  [`pulse.library.symbolic_pulses.Gaussian`](/api/qiskit/pulse-library-gaussian)
`qiskit.pulse.library.parametric_pulses.GaussianSquare` |  [`pulse.library.symbolic_pulses.GaussianSquare`](/api/qiskit/pulse-library-gaussian-square)
...
Similarly, a [`QuantumCircuit`](/api/qiskit/circuit-quantum-circuit) can
...
[`QuantumCircuit.add_calibration`](/api/qiskit/circuit-quantum-circuit#add_calibration)
...
[`qiskit.pulse.SymbolicPulse`](/api/qiskit/pulse-library-symbolic-pulse),
with
[`SymbolicPulse.get_waveform()`](/api/qiskit/pulse-library-symbolic-pulse#get_waveform).
For example, instead of `pulse.gaussian(100,0.5,10)`, use
`pulse.Gaussian(100,0.5,10).get_waveform()`. Note that the phase of both
[`Sawtooth`](/api/qiskit/pulse-library-sawtooth) and
[`Square`](/api/qiskit/pulse-library-square) is defined such
...
* [`qiskit.pulse.Constant`](/api/qiskit/pulse-library-constant)
* [`qiskit.pulse.Drag`](/api/qiskit/pulse-library-drag)
* [`qiskit.pulse.Gaussian`](/api/qiskit/pulse-library-gaussian)
* [`qiskit.pulse.GaussianSquare`](/api/qiskit/pulse-library-gaussian-square)
...
been superseded by the [`qiskit.qasm2`](/api/qiskit/qasm-2) module, which
provides a faster and more accurate parser for OpenQASM 2. The high level
`QuantumCircuit` methods
[`from_qasm_file()`](/api/qiskit/circuit-quantum-circuit#from_qasm_file)
and
[`from_qasm_str()`](/api/qiskit/circuit-quantum-circuit#from_qasm_str)
...
outputs a [`QuantumCircuit`](/api/qiskit/circuit-quantum-circuit) object.
...
Removed    | Alternative
-----------|------------
`OneQubitEulerDecomposer` | [`qiskit.synthesis.one_qubit.OneQubitEulerDecomposer`](/api/qiskit/synthesis-one-qubit-euler-decomposer)
`TwoQubitBasisDecomposer` | [`qiskit.synthesis.two_qubits.TwoQubitBasisDecomposer`](/api/qiskit/synthesis-two-qubit-basis-decomposer)
`XXDecomposer` | [`qiskit.synthesis.two_qubits.XXDecomposer`](/api/qiskit/synthesis-xx-decomposer)
...
`Quaternion` | [`qiskit.quantum_info.Quaternion`](/api/qiskit/quantum-info-quaternion)
...
[`BackendV2`](/api/qiskit/providers-backend-v-2) interface.
...
[`BackendV2`](/api/qiskit/providers-backend-v-2) interface). There is
...
Removed    | Alternative
-----------|------------
`qiskit.transpiler.synthesis.aqc` (except for [`AQCSynthesisPlugin`](/api/qiskit/transpiler-passes-synthesis-aqc-plugin-aqc-synthesis-plugin)) | [`qiskit.synthesis.unitary.aqc`](/api/qiskit/synthesis-unitary-aqc)
...
[`VF2Layout`](/api/qiskit/transpiler-passes-vf-2-layout) and
[`VF2PostLayout`](/api/qiskit/transpiler-passes-vf-2-post-layout),
...
[`ConditionalController`](/api/qiskit/passmanager-conditional-controller),
[`FlowControllerLinear`](/api/qiskit/passmanager-flow-controller-linear), and 
[`DoWhileController`](/api/qiskit/passmanager-do-while-controller) classes
