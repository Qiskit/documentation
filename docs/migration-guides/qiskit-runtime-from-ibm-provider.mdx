...
information about retrieving account credentials, see [Install and set up](/guides/setup-channel).
</LegacyContent>
<CloudContent>
For information about retrieving account credentials, see [Install and set up](/guides/cloud-setup).
</CloudContent>
<LegacyContent>
```python
