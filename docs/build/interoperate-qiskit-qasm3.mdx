---
title: OpenQASM 3 and Qiskit SDK
description: How to convert code between OpenQASM 3 and Qiskit SDK.

---

# OpenQASM 3 and Qiskit SDK

Qiskit SDK provides some tools for converting between OpenQASM representations of quantum programs, and the QuantumCircuit class. Note these tools are still in an exploratory phase of development and will continue to evolve as Qiskit’s support for dynamic circuit capabilities expressed by OpenQASM 3 increases.
...
<Admonition type="tip" title="Recommendations">
    ...
    - Visit the [Verify your program](../verify/) topic.
