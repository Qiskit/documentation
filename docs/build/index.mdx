...
Qiskit enables working with circuits (and, to a lesser extent, operators) at various abstraction levels: abstract, virtual, physical, scheduled, and pulse programs.
