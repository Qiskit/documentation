---
title: Introduction
description: Build quantum programs using Qiskit SDK quantum circuits, operators, waveform pulses, or OpenQASM.

---

# Introduction

In the build phase, you create quantum programs that represent the problem you are solving. The foundation of quantum programs are quantum circuits, which consist of operations - including gates, measurement, and reset - that manipulate qubits in the quantum computer.  Depending on your needs, you can use Qiskit SDK or OpenQASM to create your circuits. 
