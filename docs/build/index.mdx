...
All tasks require building one or more [quantum circuits](circuit-construction). Some tasks additionally require constructing [quantum operators](operators_overview) to define properties of quantum states that you want to estimate or measure.
