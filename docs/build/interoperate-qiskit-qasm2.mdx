---
title: OpenQASM 2 and Qiskit SDK
description: How to convert code between OpenQASM 2 and Qiskit SDK.

---

# OpenQASM 2 and Qiskit SDK

Qiskit SDK provides some tools for converting between OpenQASM representations of quantum programs, and the [QuantumCircuit](../api/qiskit/qiskit.circuit.QuantumCircuit) class.
