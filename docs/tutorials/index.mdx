...
* [Sample-based quantum diagonalization of a fermionic lattice model](/docs/tutorials/sample-based-krylov-quantum-diagonalization)
...
- Experiment domain-specific problems with Application functions -- with familiar inputs and outputs to classical solvers.
