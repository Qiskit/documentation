...
- Design new algorithms with **Circuit functions** -- with pre-built transpilation, error suppression, and error mitigation pipelines.
  ...
  * [Transverse-Field Ising Model Simulation: Demonstrating better performance with Q-CTRL's Qiskit Functions](/docs/tutorials/transverse-field-ising-model)

  * [Quantum Phase Estimation: Improve Hardware Performance with Q-CTRL's Qiskit Functions](/docs/tutorials/quantum-phase-estimation-qctrl)
