...
* [SqDRIFT algorithm for ground state estimation](/docs/tutorials/sqdrift)

* [Pooled sample-based quantum diagonalization of a nuclear Hamiltonian](/docs/tutorials/nuclear-sqd-pooled)
...
* [Quantum approximate multi-objective optimization](/docs/tutorials/quantum-approximate-multi-objective-optimization)
...
* [Run quantum workloads with QRMI](/docs/tutorials/run-quantum-workloads-with-qrmi)
...
- Experiment with domain-specific problems with **Application functions** &mdash; with familiar inputs and outputs to classical solvers.
  ...
  * [Find the Maximum Independent Set with the Aqarios Constrained Quantum Optimizer](/docs/tutorials/find-the-maximum-independent-set-with-aqarios-constrained-quantum-optimizer)

  * [Solve the market split problem with the ParityQC Parity Twine Optimizer](/docs/tutorials/parity-twine-optimizer-ms)

  * [Solve the Sherrington-Kirkpatrick model with the ParityQC Parity Twine Optimizer](/docs/tutorials/parity-twine-optimizer-sk)
...
* [Probabilistic error cancellation with logical noise models](/docs/tutorials/probabilistic-error-cancellation-with-logical-noise-models)
