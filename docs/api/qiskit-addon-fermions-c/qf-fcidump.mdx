...
description: API reference for FCIDump in the latest version of qiskit-addon-fermions-c
...
<Function id="qf_fcidump_from_file" signature="QfFCIDump *qf_fcidump_from_file(char *file_path)">
