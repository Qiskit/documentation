...
- Use **sessions** mode for iterative workloads, or if you need dedicated access to the system
...
* Session usage is the wall clock time of the entire session active window.
