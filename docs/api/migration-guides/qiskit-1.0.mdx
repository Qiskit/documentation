...
3. Install all the packages you want to install.
   ...
   If you encounter issues, consult [the troubleshooting section](#troubleshooting) below, ask on [the Qiskit Slack](https://qisk.it/join-slack/), or if you think there is a Qiskit bug you can [file an issue against Qiskit](https://github.com/Qiskit/qiskit/issues/new).
...
<span id="why-did-this-happen"></id>
...
1. Please [file an issue on Qiskit](https://github.com/Qiskit/qiskit/issues/new) explaining how this happened and why you are sure the environment is correct so we can fix it.
