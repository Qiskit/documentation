...
This guide is organized by Qiskit&reg; module. Use the navigation bar on the
...
<Tabs>
  ...
  <TabItem value="e-1-4-2" label="Estimator, 1 circuit, 4 observables, 3 parameter sets" default>
      ```python
...
it exposed have been deprecated and will be removed in the Qiskit 1.0.0
