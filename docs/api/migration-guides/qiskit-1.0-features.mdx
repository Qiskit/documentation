...
counterpart. Also note that complex amplitude support is no longer supported in
...
Removed    | Alternative
-----------|------------
`qiskit.transpiler.synthesis.aqc` (except for [`AQCSynthesisPlugin`](/api/qiskit/qiskit.transpiler.passes.AQCSynthesisPlugin) | [`qiskit.synthesis.unitary.aqc`](/api/qiskit/synthesis_aqc))
