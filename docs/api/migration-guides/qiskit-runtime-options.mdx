...
| memory              | Use result.data.classical_register_name.get_counts() to get counts and result.data.classical_register_name.get_bitstrings() to get per-shot measurements    |                                                                                          |
...
| meas_level          | options.execution.meas_type: <br></br>avg_kerneled replaces meas_level=1 and meas_return="avg" <br></br>kerneled replaces meas_level=1 and meas_return="single" <br></br>classified replaces meas_level=2 <br></br>meas_level=0 is no longer supported by IBM backends.                                                                                           |   |
