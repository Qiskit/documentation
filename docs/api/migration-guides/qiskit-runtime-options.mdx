...
| meas_level          | options.execution.meas_type                                                                                           | (meas_level, meas_return) → meas_type <br></br>0, * → not implemented <br></br>1, “avg” → “avg_kerneled” 1, “single” → “kerneled” <br></br>2, * → “classified”  |
