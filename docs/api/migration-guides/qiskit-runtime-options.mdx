...
All `backend.run` options are now available through the Qiskit Runtime primitives.

| backend.run options | SamplerV2 options                                                                                                     | notes                                                                                                                                |
|---------------------|-----------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------|
...
| shots               | run([(…, shots)]) or run(…, shots=) or options.default_shots                                                          |                                                                                                                                      |
