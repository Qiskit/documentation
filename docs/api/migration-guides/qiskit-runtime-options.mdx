...
| job_share_level     | N/A: This was deprecated long ago and no longer supported.                                                            | ibmq-provider only                                                                                                                   |
...
| shots               | run([(…, shots)]) or <br> run(…, shots=) or <br> options.default_shots                                                | default_shots is available with SamplerV2 only                                                                                       |
