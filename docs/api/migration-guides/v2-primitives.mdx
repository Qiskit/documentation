...
After the V1 primitves are deprecated, import *primitive* will import the V2 version of the specified primitive.
</Admonition>
...
<Tabs>
  <TabItem value="EstimatorV2" label="EstimatorV2 single circuit">
    ```python 
circuit = IQP(mat)
...
```
  ...
  <TabItem value="EstimatorV1" label="Estimator (V1) single circuit">
    ```python 
circuit = IQP(mat)
observable = SparsePauliOp("Z" * n_qubits)
...
```
  ...
  <TabItem value="EstimatorV2m" label="EstimatorV2 multi circuit">
    ```python 
theta = Parameter("θ")
...
```
  ...
  <TabItem value="EstimatorV1m" label="Estimator (V1) multi circuit">
    ```python 
theta = Parameter("θ")
