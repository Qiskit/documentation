...
The first versions of primitives, i.e., [SamplerV1](api/qiskit-ibm-runtime/qiskit_ibm_runtime.SamplerV1) and [EstimatorV1](api/qiskit-ibm-runtime/qiskit_ibm_runtime.EstimatorV1), have been deprecated in `qiskit-ibm-runtime 0.23`.
Their support will be removed no earlier than July 15, 2024.
</Admonition>
