...
The first version of primitives, i.e. [SamplerV1](api/qiskit-ibm-runtime/qiskit_ibm_runtime.SamplerV1) and [EstimatorV1](api/qiskit-ibm-runtime/qiskit_ibm_runtime.EstimatorV1), have been deprecated in ``qiskit-ibm-runtime 0.23``.
Their support is going to be removed not earlier than July 15th, 2024. 
</Admonition>
