...
Additional advanced options are available in V2 primitives. See the [API reference](../api/qiskit-ibm-runtime/options) for the list of available options.
...
* V2 Sampler does not support `resilience_level`. 
* V2 Estimator supports `resilience_level` 0-2, as described in the following table. You can also explicitly turn on / off individual error mitigation / suppression methods.
