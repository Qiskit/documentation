...
# Algorithms migration guide
  ...
  available on [GitHub&reg;](https://github.com/qiskit-community/qiskit-algorithms) and 
  [PyPi&reg;](https://pypi.org/project/qiskit-algorithms). The `qiskit.algorithms` module  was migrated to a
