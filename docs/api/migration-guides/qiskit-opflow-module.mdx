...
<Admonition type="note">
  ...
  Specific QPUs can be wrapped with ([`qiskit.primitives.BackendSampler`](../qiskit/qiskit.primitives.BackendSampler), [`qiskit.primitives.BackendEstimator`](../qiskit/qiskit.primitives.BackendEstimator)) to also present primitive-compatible interfaces.
...
The release of the [`qiskit.primitives`](../qiskit/primitives) introduced a new paradigm for interacting with QPUs. Instead of
...
approximations of its state functions using a QPU.
