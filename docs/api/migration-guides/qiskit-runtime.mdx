...
### Save and load accounts tests

<table>
<tr>
<th> Legacy: Save accounts </th>
<th> Updated: Save accounts </th>
</tr>
<tr VALIGN="TOP">
<td ALIGN="LEFT">
...
<td ALIGN="LEFT" style="word-wrap: normal">
...
You can also name your saved credentials and load the credentials by name.
