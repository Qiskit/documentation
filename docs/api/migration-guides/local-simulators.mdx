...
In quantum computing, the choice between using simulators and quantum hardware is crucial for making progress in the field. While simulators are useful for testing and debugging, in this era of quantum utility, quantum development and industry advancement requires actual hardware. As part of the move to quantum utility, IBM Quantum&trade; will retire its cloud simulators on 15 May 2024. This guide explains in more detail why this is happening, and how (and when) to change from cloud to local simulators. 
...
Interacting with quantum hardware grows skills and experience unatainable by only using simulators: 
...
Quantum simulators should be used to help develop and test programs before fine-tuning them and sending them to quantum hardware. This can be done with good performance and efficiency on local simulators. 
