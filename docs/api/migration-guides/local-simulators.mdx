...
<Admonition>
Qiskit Aer primitives do not support the V2 primitive interface.  To use V2 primitives with Aer simulators, use local testing mode in Qiskit Runtime to specify `AerSimulator()`.
</Admonition>