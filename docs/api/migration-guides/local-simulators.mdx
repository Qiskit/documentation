...
To simulate with noise, you specify a system (quantum hardware), Aer builds a noise model based on the calibration data from that system, then instantiates an Aer backend with that model.  If you prefer, you can [build a noise model](../verify/build-noise-models).
