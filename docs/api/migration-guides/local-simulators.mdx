...
Local testing mode does not have built-in error suppression or mitigation.  Instead, you must specify those options explictly. See [Configure error mitigation for Qiskit Runtime](/run/configure-error-mitigation) for details. 
</Admonition>
