...
<Function id="qiskit_addon_utils.coloring.auto_color_edges" github="https://github.com/Qiskit/qiskit-addon-utils/tree/stable/0.4/qiskit_addon_utils/coloring/automatic_coloring.py#L22-L42" signature="auto_color_edges(edges)">
...
<Function id="qiskit_addon_utils.coloring.is_valid_edge_coloring" github="https://github.com/Qiskit/qiskit-addon-utils/tree/stable/0.4/qiskit_addon_utils/coloring/validation.py#L20-L38" signature="is_valid_edge_coloring(coloring)">
