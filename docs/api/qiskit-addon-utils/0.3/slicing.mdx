...
For more information, check out the [how-to guide](/docs/addons/qiskit-addon-utils/how_tos/create_circuit_slices) which discusses this submodule.

### combine\_slices

<Function id="qiskit_addon_utils.slicing.combine_slices" github="https://github.com/Qiskit/qiskit-addon-utils/tree/stable/0.3/qiskit_addon_utils/slicing/combine_slices.py#L22-L54" signature="combine_slices(slices, include_barriers=False)">
...
<Function id="qiskit_addon_utils.slicing.slice_by_barriers" github="https://github.com/Qiskit/qiskit-addon-utils/tree/stable/0.3/qiskit_addon_utils/slicing/slice_by_barriers.py#L21-L52" signature="slice_by_barriers(circuit)">
...
<Function id="qiskit_addon_utils.slicing.slice_by_coloring" github="https://github.com/Qiskit/qiskit-addon-utils/tree/stable/0.3/qiskit_addon_utils/slicing/slice_by_coloring.py#L28-L120" signature="slice_by_coloring(circuit, coloring)">
...
<Function id="qiskit_addon_utils.slicing.slice_by_depth" github="https://github.com/Qiskit/qiskit-addon-utils/tree/stable/0.3/qiskit_addon_utils/slicing/slice_by_depth.py#L21-L57" signature="slice_by_depth(circuit, max_slice_depth)">
...
<Function id="qiskit_addon_utils.slicing.slice_by_gate_types" github="https://github.com/Qiskit/qiskit-addon-utils/tree/stable/0.3/qiskit_addon_utils/slicing/slice_by_gate_types.py#L24-L57" signature="slice_by_gate_types(circuit)">
