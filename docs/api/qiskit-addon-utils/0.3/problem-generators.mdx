...
<Function id="qiskit_addon_utils.problem_generators.generate_xyz_hamiltonian" github="https://github.com/Qiskit/qiskit-addon-utils/tree/stable/0.3/qiskit_addon_utils/problem_generators/generate_xyz_hamiltonian.py#L56-L188" signature="generate_xyz_hamiltonian(coupling, *, coupling_constants=(1.0, 1.0, 1.0), ext_magnetic_field=(0.0, 0.0, 0.0), pauli_order_strategy=PauliOrderStrategy.ColorThenInteraction, coloring=None)">
...
<Function id="qiskit_addon_utils.problem_generators.generate_time_evolution_circuit" github="https://github.com/Qiskit/qiskit-addon-utils/tree/stable/0.3/qiskit_addon_utils/problem_generators/generate_time_evolution_circuit.py#L23-L77" signature="generate_time_evolution_circuit(operator, *, synthesis=None, time=1.0)">
  ...
  ![Output from the previous code.](/docs/images/api/qiskit-addon-utils/0.3/qiskit_addon_utils-problem_generators-1.avif)
...
<Class id="qiskit_addon_utils.problem_generators.PauliOrderStrategy" github="https://github.com/Qiskit/qiskit-addon-utils/tree/stable/0.3/qiskit_addon_utils/problem_generators/generate_xyz_hamiltonian.py#L29-L53" signature="PauliOrderStrategy(value)" modifiers="class">
