...
description: API reference for qiskit_addon_utils.noise_management.post_selection.transpiler.passes.XSlowGate in the latest version of qiskit-addon-utils
...
<Class id="qiskit_addon_utils.noise_management.post_selection.transpiler.passes.XSlowGate" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit-addon-utils/tree/stable/0.3/qiskit_addon_utils/noise_management/post_selection/transpiler/passes/xslow_gate.py#L19-L28" signature="XSlowGate(label='xslow', xslow_gate_name='xslow')" modifiers="class">
  ...
  *   **xslow\_gate\_name** ([*str*](https://docs.python.org/3/library/stdtypes.html#str "(in Python v3.14)"))
  ...
  <Attribute id="qiskit_addon_utils.noise_management.post_selection.transpiler.passes.XSlowGate.base_class">
  ...
  <Attribute id="qiskit_addon_utils.noise_management.post_selection.transpiler.passes.XSlowGate.label">
    Return instruction label
  </Attribute>

  ### mutable

  <Attribute id="qiskit_addon_utils.noise_management.post_selection.transpiler.passes.XSlowGate.mutable">
