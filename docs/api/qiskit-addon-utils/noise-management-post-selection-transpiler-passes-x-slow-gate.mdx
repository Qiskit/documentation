...
<Class id="qiskit_addon_utils.noise_management.post_selection.transpiler.passes.XSlowGate" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit-addon-utils/tree/stable/0.4/qiskit_addon_utils/noise_management/post_selection/transpiler/passes/xslow_gate.py#L19-L28" signature="XSlowGate(label='xslow', xslow_gate_name='xslow')" modifiers="class">
