...
$$
  ...
  *   **coupling** ([*CouplingMap*](/docs/api/qiskit/qiskit.transpiler.CouplingMap "(in Qiskit v2.2)")  *|*[*PyGraph*](https://www.rustworkx.org/apiref/rustworkx.PyGraph.html#rustworkx.PyGraph "(in rustworkx v0.17)")  *|*[*PyDiGraph*](https://www.rustworkx.org/apiref/rustworkx.PyDiGraph.html#rustworkx.PyDiGraph "(in rustworkx v0.17)")) – The qubit subgraph on which to map the Hamiltonian. Directionality of graph edges will be ignored, and parallel edges will be treated as a single edge during generation of the operator.
  *   **coupling\_constants** ([*Sequence*](https://docs.python.org/3/library/collections.abc.html#collections.abc.Sequence "(in Python v3.14)")*\[*[*float*](https://docs.python.org/3/library/functions.html#float "(in Python v3.14)")*]*) – The real-valued coupling constants, $J_i$, in each Cartesian axis.
  *   **ext\_magnetic\_field** ([*Sequence*](https://docs.python.org/3/library/collections.abc.html#collections.abc.Sequence "(in Python v3.14)")*\[*[*float*](https://docs.python.org/3/library/functions.html#float "(in Python v3.14)")*]*) – The coefficients, $h_i$, representing a magnetic field along each Cartesian axis.
  ...
  *   [**ValueError**](https://docs.python.org/3/library/exceptions.html#ValueError "(in Python v3.14)") – The coupling constants must be specified by a length-3 sequence of floating point values.
  *   [**ValueError**](https://docs.python.org/3/library/exceptions.html#ValueError "(in Python v3.14)") – The external magnetic field must be specified by a length-3 sequence of floating point values.

  **Return type**

  [*SparsePauliOp*](/docs/api/qiskit/qiskit.quantum_info.SparsePauliOp "(in Qiskit v2.2)")
</Function>
...
<Function id="qiskit_addon_utils.problem_generators.generate_time_evolution_circuit" github="https://github.com/Qiskit/qiskit-addon-utils/tree/stable/0.2/qiskit_addon_utils/problem_generators/generate_time_evolution_circuit.py#L23-L77" signature="generate_time_evolution_circuit(operator, *, synthesis=None, time=1.0)">
  ...
  *   **operator** ([*SparsePauliOp*](/docs/api/qiskit/qiskit.quantum_info.SparsePauliOp "(in Qiskit v2.2)")) – The operator for which to model the time evolution.
  *   **synthesis** ([*EvolutionSynthesis*](/docs/api/qiskit/qiskit.synthesis.EvolutionSynthesis "(in Qiskit v2.2)") *| None*) – A synthesis strategy. If `None`, the default synthesis is the Lie-Trotter product formula with a single repetition.
  *   **time** ([*float*](https://docs.python.org/3/library/functions.html#float "(in Python v3.14)")) – The evolution time.

  **Returns**

  A [`QuantumCircuit`](/docs/api/qiskit/qiskit.circuit.QuantumCircuit "(in Qiskit v2.2)") implementing a time-evolved operator.

  **Return type**

  [*QuantumCircuit*](/docs/api/qiskit/qiskit.circuit.QuantumCircuit "(in Qiskit v2.2)")
</Function>
