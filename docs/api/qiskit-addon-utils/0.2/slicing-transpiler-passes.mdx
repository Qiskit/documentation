---
title: passes (v0.2)
description: API reference for qiskit_addon_utils.slicing.transpiler.passes in qiskit-addon-utils v0.2
...
<span id="slicing-transpiler-passes-qiskit-addon-utils-slicing-transpiler-passes" />
