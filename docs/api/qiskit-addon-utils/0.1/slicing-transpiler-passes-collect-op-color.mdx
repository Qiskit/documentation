---
title: CollectOpColor (v0.1)
description: API reference for qiskit_addon_utils.slicing.transpiler.passes.CollectOpColor in qiskit-addon-utils v0.1
...
<Class id="qiskit_addon_utils.slicing.transpiler.passes.CollectOpColor" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit-addon-utils/tree/stable/0.1/qiskit_addon_utils/slicing/transpiler/passes/collect_op_color.py#L28-L65" signature="CollectOpColor(*args, **kwargs)" modifiers="class">
  Bases: [`CollectAndCollapse`](/docs/api/qiskit/qiskit.transpiler.passes.CollectAndCollapse "(in Qiskit v1.4)")
  ...
  *   **do\_commutative\_analysis** – If `True`, exploits commutativity relations between nodes. Note also the warning above.
  ...
  <Attribute id="qiskit_addon_utils.slicing.transpiler.passes.CollectOpColor.is_analysis_pass">
  ...
  <Attribute id="qiskit_addon_utils.slicing.transpiler.passes.CollectOpColor.is_transformation_pass">
  ...
  <Function id="qiskit_addon_utils.slicing.transpiler.passes.CollectOpColor.execute" signature="execute(passmanager_ir, state, callback=None)">
  ...
  <Function id="qiskit_addon_utils.slicing.transpiler.passes.CollectOpColor.name" signature="name()">
    Name of the pass.
  ...
  <Function id="qiskit_addon_utils.slicing.transpiler.passes.CollectOpColor.run" signature="run(dag)">
  ...
  <Function id="qiskit_addon_utils.slicing.transpiler.passes.CollectOpColor.update_status" signature="update_status(state, run_state)">
