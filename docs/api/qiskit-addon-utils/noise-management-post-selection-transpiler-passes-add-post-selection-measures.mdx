...
<Class id="qiskit_addon_utils.noise_management.post_selection.transpiler.passes.AddPostSelectionMeasures" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit-addon-utils/tree/stable/0.4/qiskit_addon_utils/noise_management/post_selection/transpiler/passes/add_post_selection_measures.py#L43-L171" signature="AddPostSelectionMeasures(*args, **kwargs)" modifiers="class">
  ...
  *   **post\_selection\_suffix** – A fixed suffix to append to the names of the classical registers when copying them.
  ...
  <Function id="qiskit_addon_utils.noise_management.post_selection.transpiler.passes.AddPostSelectionMeasures.run" github="https://github.com/Qiskit/qiskit-addon-utils/tree/stable/0.4/qiskit_addon_utils/noise_management/post_selection/transpiler/passes/add_post_selection_measures.py#L82-L108" signature="run(dag)">
