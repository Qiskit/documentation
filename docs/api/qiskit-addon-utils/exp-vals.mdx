...
<Function id="qiskit_addon_utils.exp_vals.get_measurement_bases" github="https://github.com/Qiskit/qiskit-addon-utils/tree/stable/0.4/qiskit_addon_utils/exp_vals/measurement_bases.py#L21-L71" signature="get_measurement_bases(observables, bases_in_int_format=True)">
...
<Function id="qiskit_addon_utils.exp_vals.map_observable_isa_to_canonical" github="https://github.com/Qiskit/qiskit-addon-utils/tree/stable/0.4/qiskit_addon_utils/exp_vals/observable_mappings.py#L22-L69" signature="map_observable_isa_to_canonical(isa_observable, canonical_qubits)">
...
<Function id="qiskit_addon_utils.exp_vals.map_observable_virtual_to_canonical" github="https://github.com/Qiskit/qiskit-addon-utils/tree/stable/0.4/qiskit_addon_utils/exp_vals/observable_mappings.py#L72-L125" signature="map_observable_virtual_to_canonical(virt_observable, layout, canonical_qubits)">
...
<Function id="qiskit_addon_utils.exp_vals.map_observable_isa_to_virtual" github="https://github.com/Qiskit/qiskit-addon-utils/tree/stable/0.4/qiskit_addon_utils/exp_vals/observable_mappings.py#L128-L174" signature="map_observable_isa_to_virtual(isa_observable, layout)">
