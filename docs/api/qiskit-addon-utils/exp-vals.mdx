...
<Function id="qiskit_addon_utils.exp_vals.get_measurement_bases" github="https://github.com/Qiskit/qiskit-addon-utils/tree/stable/0.3/qiskit_addon_utils/exp_vals/measurement_bases.py#L21-L61" signature="get_measurement_bases(observables)">
  ...
  **observables** ([*SparsePauliOp*](/docs/api/qiskit/qiskit.quantum_info.SparsePauliOp "(in Qiskit v2.2)")  *|*[*list*](https://docs.python.org/3/library/stdtypes.html#list "(in Python v3.14)")*\[*[*SparsePauliOp*](/docs/api/qiskit/qiskit.quantum_info.SparsePauliOp "(in Qiskit v2.2)")*]*) – The observables to calculate using the quantum computer.
  ...
  **Return type**
  ...
  [tuple](https://docs.python.org/3/library/stdtypes.html#tuple "(in Python v3.14)")\[[list](https://docs.python.org/3/library/stdtypes.html#list "(in Python v3.14)")\[[*ndarray*](https://numpy.org/doc/stable/reference/generated/numpy.ndarray.html#numpy.ndarray "(in NumPy v2.3)")\[[tuple](https://docs.python.org/3/library/stdtypes.html#tuple "(in Python v3.14)")\[[int](https://docs.python.org/3/library/functions.html#int "(in Python v3.14)"), …], [*dtype*](https://numpy.org/doc/stable/reference/generated/numpy.dtype.html#numpy.dtype "(in NumPy v2.3)")\[*uint8*]]], [dict](https://docs.python.org/3/library/stdtypes.html#dict "(in Python v3.14)")\[[*Pauli*](/docs/api/qiskit/qiskit.quantum_info.Pauli "(in Qiskit v2.2)"), [list](https://docs.python.org/3/library/stdtypes.html#list "(in Python v3.14)")\[[*SparsePauliOp*](/docs/api/qiskit/qiskit.quantum_info.SparsePauliOp "(in Qiskit v2.2)")]]]
</Function>
...
<Function id="qiskit_addon_utils.exp_vals.map_observable_isa_to_canonical" github="https://github.com/Qiskit/qiskit-addon-utils/tree/stable/0.3/qiskit_addon_utils/exp_vals/observable_mappings.py#L22-L69" signature="map_observable_isa_to_canonical(isa_observable, canonical_qubits)">
  ...
  *   **isa\_observable** ([*Pauli*](/docs/api/qiskit/qiskit.quantum_info.Pauli "(in Qiskit v2.2)")  *|*[*SparsePauliOp*](/docs/api/qiskit/qiskit.quantum_info.SparsePauliOp "(in Qiskit v2.2)")  *|*[*SparseObservable*](/docs/api/qiskit/qiskit.quantum_info.SparseObservable "(in Qiskit v2.2)")) – A Pauli, SparsePauliOp, or SparseObservable object.
  *   **canonical\_qubits** ([*Sequence*](https://docs.python.org/3/library/collections.abc.html#collections.abc.Sequence "(in Python v3.14)")*\[*[*int*](https://docs.python.org/3/library/functions.html#int "(in Python v3.14)")*]*) – A sequence specifying the physical qubit for each canonical qubit.
  ...
  **Return type**
  ...
  [*Pauli*](/docs/api/qiskit/qiskit.quantum_info.Pauli "(in Qiskit v2.2)") | [*SparsePauliOp*](/docs/api/qiskit/qiskit.quantum_info.SparsePauliOp "(in Qiskit v2.2)") | [*SparseObservable*](/docs/api/qiskit/qiskit.quantum_info.SparseObservable "(in Qiskit v2.2)")
</Function>
...
<Function id="qiskit_addon_utils.exp_vals.map_observable_virtual_to_canonical" github="https://github.com/Qiskit/qiskit-addon-utils/tree/stable/0.3/qiskit_addon_utils/exp_vals/observable_mappings.py#L72-L125" signature="map_observable_virtual_to_canonical(virt_observable, layout, canonical_qubits)">
  ...
  *   **virt\_observable** ([*Pauli*](/docs/api/qiskit/qiskit.quantum_info.Pauli "(in Qiskit v2.2)")  *|*[*SparsePauliOp*](/docs/api/qiskit/qiskit.quantum_info.SparsePauliOp "(in Qiskit v2.2)")  *|*[*SparseObservable*](/docs/api/qiskit/qiskit.quantum_info.SparseObservable "(in Qiskit v2.2)")) – A Pauli, SparsePauliOp, or SparseObservable object.
  *   **layout** ([*Sequence*](https://docs.python.org/3/library/collections.abc.html#collections.abc.Sequence "(in Python v3.14)")*\[*[*int*](https://docs.python.org/3/library/functions.html#int "(in Python v3.14)")*]*) – The list of physical qubits used for the isa circuit.
  *   **canonical\_qubits** ([*Sequence*](https://docs.python.org/3/library/collections.abc.html#collections.abc.Sequence "(in Python v3.14)")*\[*[*int*](https://docs.python.org/3/library/functions.html#int "(in Python v3.14)")*]*) – A dictionary mapping canonical qubits within a box to physical qubits within the layout.
