...
*   The keyword argument `include_slice_barriers` of [`combine_slices()`](qiskit_addon_utils.slicing.combine_slices "qiskit_addon_utils.slicing.combine_slices") has been renamed to `include_barriers`.
