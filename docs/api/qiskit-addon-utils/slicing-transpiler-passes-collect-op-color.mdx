---
title: CollectOpColor (latest version)
description: API reference for qiskit_addon_utils.slicing.transpiler.passes.CollectOpColor in the latest version of qiskit-addon-utils
...
<Class id="qiskit_addon_utils.slicing.transpiler.passes.CollectOpColor" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit-addon-utils/tree/stable/0.3/qiskit_addon_utils/slicing/transpiler/passes/collect_op_color.py#L28-L65" signature="CollectOpColor(*args, **kwargs)" modifiers="class">
