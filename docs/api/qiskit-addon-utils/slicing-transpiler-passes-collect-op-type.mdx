...
<Class id="qiskit_addon_utils.slicing.transpiler.passes.CollectOpType" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit-addon-utils/tree/stable/0.4/qiskit_addon_utils/slicing/transpiler/passes/collect_op_type.py#L28-L58" signature="CollectOpType(*args, **kwargs)" modifiers="class">
