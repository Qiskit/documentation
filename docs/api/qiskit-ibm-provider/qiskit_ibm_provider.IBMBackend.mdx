...
<Class id="qiskit_ibm_provider.IBMBackend" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit-ibm-provider/tree/stable/0.11/qiskit_ibm_provider/ibm_backend.py#L79-L895" signature="IBMBackend(configuration, provider, api_client, instance=None)">
  ...
  *   **api\_client** (`AccountClient`) – IBM Quantum client used to communicate with the server.
  ...
  <Function id="qiskit_ibm_provider.IBMBackend.get_translation_stage_plugin" github="https://github.com/Qiskit/qiskit-ibm-provider/tree/stable/0.11/qiskit_ibm_provider/ibm_backend.py#L802-L805" signature="classmethod get_translation_stage_plugin()">
