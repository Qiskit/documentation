...
<Class id="qiskit_ibm_provider.Session" github="https://github.com/qiskit/qiskit-ibm-provider/tree/stable/0.7/qiskit_ibm_provider/session.py" signature="Session(max_time=None)">
  ...
  **ValueError** – If an input value is invalid.
  ...
  |                                                                                                         |                                   |
  | ------------------------------------------------------------------------------------------------------- | --------------------------------- |
  | [`Session.active`](qiskit_ibm_provider.Session#active "qiskit_ibm_provider.Session.active")             | Return the status of the session. |
  | [`Session.session_id`](qiskit_ibm_provider.Session#session_id "qiskit_ibm_provider.Session.session_id") | Return the session ID.            |

  ## Methods

  |                                                                                               |                                          |
  | --------------------------------------------------------------------------------------------- | ---------------------------------------- |
  | [`Session.cancel`](qiskit_ibm_provider.Session#cancel "qiskit_ibm_provider.Session.cancel")() | Set the session.\_active status to False |
</Class>
