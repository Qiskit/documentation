...
<Class id="qiskit_ibm_provider.Session" github="https://github.com/qiskit/qiskit-ibm-provider/tree/stable/0.7/qiskit_ibm_provider/session.py" signature="Session(max_time=None)">
  ...
  **ValueError** – If an input value is invalid.
  ...
  <Attribute id="qiskit_ibm_provider.Session.active" name="active" signature="bool">
  ...
  <Attribute id="qiskit_ibm_provider.Session.session_id" name="session_id" signature="str">
  ...
  <Function id="qiskit_ibm_provider.Session.cancel" name="cancel" signature="Session.cancel()">
