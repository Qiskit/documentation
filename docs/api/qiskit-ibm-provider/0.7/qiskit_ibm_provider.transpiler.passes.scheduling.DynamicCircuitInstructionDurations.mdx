...
<Class id="qiskit_ibm_provider.transpiler.passes.scheduling.DynamicCircuitInstructionDurations" github="https://github.com/qiskit/qiskit-ibm-provider/tree/stable/0.7/qiskit_ibm_provider/transpiler/passes/scheduling/utils.py" signature="DynamicCircuitInstructionDurations(instruction_durations=None, dt=None, enable_patching=True)">
  ...
  <Function id="qiskit_ibm_provider.transpiler.passes.scheduling.DynamicCircuitInstructionDurations.from_backend" name="from_backend" signature="classmethod DynamicCircuitInstructionDurations.from_backend(backend)">
  ...
  <Function id="qiskit_ibm_provider.transpiler.passes.scheduling.DynamicCircuitInstructionDurations.get" name="get" signature="DynamicCircuitInstructionDurations.get(inst, qubits, unit='dt', parameters=None)">
  ...
  <Function id="qiskit_ibm_provider.transpiler.passes.scheduling.DynamicCircuitInstructionDurations.units_used" name="units_used" signature="DynamicCircuitInstructionDurations.units_used()">
  ...
  <Function id="qiskit_ibm_provider.transpiler.passes.scheduling.DynamicCircuitInstructionDurations.update" name="update" signature="DynamicCircuitInstructionDurations.update(inst_durations, dt=None)">
