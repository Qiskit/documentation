...
<Class id="qiskit_ibm_provider.transpiler.passes.scheduling.PadDelay" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-ibm-provider/tree/stable/0.7/qiskit_ibm_provider/transpiler/passes/scheduling/pad_delay.py" signature="PadDelay(fill_very_end=True, schedule_idle_qubits=False)">
  ...
  *   **schedule\_idle\_qubits** (`bool`) – Set to true if you’d like a delay inserted on idle qubits. This is useful for timeline visualizations, but may cause issues for execution on large backends.
  ...
  <Function id="qiskit_ibm_provider.transpiler.passes.scheduling.PadDelay.__call__" name="__call__" signature="PadDelay.__call__(circuit, property_set=None)">
  ...
  <Function id="qiskit_ibm_provider.transpiler.passes.scheduling.PadDelay.execute" name="execute" signature="PadDelay.execute(passmanager_ir, state, callback=None)">
  ...
  <Function id="qiskit_ibm_provider.transpiler.passes.scheduling.PadDelay.name" name="name" signature="PadDelay.name()">
    Name of the pass.
  ...
  <Function id="qiskit_ibm_provider.transpiler.passes.scheduling.PadDelay.run" name="run" signature="PadDelay.run(dag)">
  ...
  <Function id="qiskit_ibm_provider.transpiler.passes.scheduling.PadDelay.update_status" name="update_status" signature="PadDelay.update_status(state, run_state)">
