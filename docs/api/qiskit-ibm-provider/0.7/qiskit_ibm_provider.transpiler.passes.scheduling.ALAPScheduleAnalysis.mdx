...
<Class id="qiskit_ibm_provider.transpiler.passes.scheduling.ALAPScheduleAnalysis" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-ibm-provider/tree/stable/0.7/qiskit_ibm_provider/transpiler/passes/scheduling/scheduler.py" signature="ALAPScheduleAnalysis(durations)">
  ...
  **durations** ([`InstructionDurations`](/api/qiskit/qiskit.transpiler.InstructionDurations "(in Qiskit v0.45)")) – Durations of instructions to be used in scheduling.
  ...
  <Function id="qiskit_ibm_provider.transpiler.passes.scheduling.ALAPScheduleAnalysis.__call__" name="__call__" signature="ALAPScheduleAnalysis.__call__(circuit, property_set=None)">
  ...
  <Function id="qiskit_ibm_provider.transpiler.passes.scheduling.ALAPScheduleAnalysis.execute" name="execute" signature="ALAPScheduleAnalysis.execute(passmanager_ir, state, callback=None)">
  ...
  <Function id="qiskit_ibm_provider.transpiler.passes.scheduling.ALAPScheduleAnalysis.name" name="name" signature="ALAPScheduleAnalysis.name()">
    Name of the pass.
  ...
  <Function id="qiskit_ibm_provider.transpiler.passes.scheduling.ALAPScheduleAnalysis.run" name="run" signature="ALAPScheduleAnalysis.run(dag)">
  ...
  <Function id="qiskit_ibm_provider.transpiler.passes.scheduling.ALAPScheduleAnalysis.update_status" name="update_status" signature="ALAPScheduleAnalysis.update_status(state, run_state)">
