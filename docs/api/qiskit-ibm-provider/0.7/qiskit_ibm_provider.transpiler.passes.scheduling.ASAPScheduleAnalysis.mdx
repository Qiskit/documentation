...
<Class id="qiskit_ibm_provider.transpiler.passes.scheduling.ASAPScheduleAnalysis" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-ibm-provider/tree/stable/0.7/qiskit_ibm_provider/transpiler/passes/scheduling/scheduler.py" signature="ASAPScheduleAnalysis(durations)">
  ...
  **durations** ([`InstructionDurations`](/api/qiskit/qiskit.transpiler.InstructionDurations "(in Qiskit v0.45)")) – Durations of instructions to be used in scheduling.
  ...
  <Function id="qiskit_ibm_provider.transpiler.passes.scheduling.ASAPScheduleAnalysis.__call__" name="__call__" signature="ASAPScheduleAnalysis.__call__(circuit, property_set=None)">
  ...
  <Function id="qiskit_ibm_provider.transpiler.passes.scheduling.ASAPScheduleAnalysis.execute" name="execute" signature="ASAPScheduleAnalysis.execute(passmanager_ir, state, callback=None)">
  ...
  <Function id="qiskit_ibm_provider.transpiler.passes.scheduling.ASAPScheduleAnalysis.name" name="name" signature="ASAPScheduleAnalysis.name()">
    Name of the pass.
  ...
  <Function id="qiskit_ibm_provider.transpiler.passes.scheduling.ASAPScheduleAnalysis.run" name="run" signature="ASAPScheduleAnalysis.run(dag)">
  ...
  <Function id="qiskit_ibm_provider.transpiler.passes.scheduling.ASAPScheduleAnalysis.update_status" name="update_status" signature="ASAPScheduleAnalysis.update_status(state, run_state)">
