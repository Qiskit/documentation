...
<Class id="qiskit_ibm_provider.job.IBMCompositeJob" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-ibm-provider/tree/stable/0.7/qiskit_ibm_provider/job/ibm_composite_job.py" signature="IBMCompositeJob(backend, api_client, job_id=None, creation_date=None, jobs=None, circuits_list=None, run_config=None, name=None, tags=None, client_version=None)" modifiers="class">
  ...
  **Raises**
  ...
  <Function id="qiskit_ibm_provider.job.IBMCompositeJob.backend" signature="IBMCompositeJob.backend()">
  ...
  <Function id="qiskit_ibm_provider.job.IBMCompositeJob.backend_options" signature="IBMCompositeJob.backend_options()">
  ...
  <Function id="qiskit_ibm_provider.job.IBMCompositeJob.block_for_submit" signature="IBMCompositeJob.block_for_submit()">
  ...
  <Function id="qiskit_ibm_provider.job.IBMCompositeJob.cancel" signature="IBMCompositeJob.cancel()">
  ...
  <Function id="qiskit_ibm_provider.job.IBMCompositeJob.cancelled" signature="IBMCompositeJob.cancelled()">
  ...
  <Function id="qiskit_ibm_provider.job.IBMCompositeJob.circuits" signature="IBMCompositeJob.circuits()">
  ...
  <Function id="qiskit_ibm_provider.job.IBMCompositeJob.creation_date" signature="IBMCompositeJob.creation_date()">
  ...
  <Function id="qiskit_ibm_provider.job.IBMCompositeJob.done" signature="IBMCompositeJob.done()">
  ...
  <Function id="qiskit_ibm_provider.job.IBMCompositeJob.error_message" signature="IBMCompositeJob.error_message()">
  ...
  <Function id="qiskit_ibm_provider.job.IBMCompositeJob.from_jobs" signature="IBMCompositeJob.from_jobs(job_id, jobs, api_client)" modifiers="classmethod">
  ...
  <Function id="qiskit_ibm_provider.job.IBMCompositeJob.header" signature="IBMCompositeJob.header()">
  ...
  <Function id="qiskit_ibm_provider.job.IBMCompositeJob.in_final_state" signature="IBMCompositeJob.in_final_state()">
  ...
  <Function id="qiskit_ibm_provider.job.IBMCompositeJob.job_id" signature="IBMCompositeJob.job_id()">
  ...
  <Function id="qiskit_ibm_provider.job.IBMCompositeJob.name" signature="IBMCompositeJob.name()">
  ...
  <Function id="qiskit_ibm_provider.job.IBMCompositeJob.properties" signature="IBMCompositeJob.properties(refresh=False)">
  ...
  <Function id="qiskit_ibm_provider.job.IBMCompositeJob.queue_info" signature="IBMCompositeJob.queue_info()">
  ...
  <Function id="qiskit_ibm_provider.job.IBMCompositeJob.queue_position" signature="IBMCompositeJob.queue_position(refresh=False)">
  ...
  <Function id="qiskit_ibm_provider.job.IBMCompositeJob.refresh" signature="IBMCompositeJob.refresh()">
  ...
  <Function id="qiskit_ibm_provider.job.IBMCompositeJob.report" signature="IBMCompositeJob.report(detailed=True)">
  ...
  <Function id="qiskit_ibm_provider.job.IBMCompositeJob.rerun_failed" signature="IBMCompositeJob.rerun_failed()">
  ...
  <Function id="qiskit_ibm_provider.job.IBMCompositeJob.result" signature="IBMCompositeJob.result(timeout=None, wait=5, partial=False, refresh=False)">
  ...
  <Function id="qiskit_ibm_provider.job.IBMCompositeJob.running" signature="IBMCompositeJob.running()">
  ...
  <Function id="qiskit_ibm_provider.job.IBMCompositeJob.scheduling_mode" signature="IBMCompositeJob.scheduling_mode()">
  ...
  <Function id="qiskit_ibm_provider.job.IBMCompositeJob.status" signature="IBMCompositeJob.status()">
  ...
  <Function id="qiskit_ibm_provider.job.IBMCompositeJob.sub_job" signature="IBMCompositeJob.sub_job(circuit_index)">
  ...
  <Function id="qiskit_ibm_provider.job.IBMCompositeJob.sub_jobs" signature="IBMCompositeJob.sub_jobs(block_for_submit=True)">
  ...
  <Function id="qiskit_ibm_provider.job.IBMCompositeJob.submit" signature="IBMCompositeJob.submit()">
    Unsupported method.
  ...
  <Function id="qiskit_ibm_provider.job.IBMCompositeJob.tags" signature="IBMCompositeJob.tags()">
  ...
  <Function id="qiskit_ibm_provider.job.IBMCompositeJob.time_per_step" signature="IBMCompositeJob.time_per_step()">
  ...
  <Function id="qiskit_ibm_provider.job.IBMCompositeJob.update_name" signature="IBMCompositeJob.update_name(name)">
  ...
  <Function id="qiskit_ibm_provider.job.IBMCompositeJob.update_tags" signature="IBMCompositeJob.update_tags(new_tags)">
  ...
  <Function id="qiskit_ibm_provider.job.IBMCompositeJob.wait_for_final_state" signature="IBMCompositeJob.wait_for_final_state(timeout=None, wait=None, callback=None)">
