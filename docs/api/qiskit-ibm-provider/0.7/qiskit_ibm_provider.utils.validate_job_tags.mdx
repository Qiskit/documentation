...
<Function id="qiskit_ibm_provider.utils.validate_job_tags" name="validate_job_tags" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-ibm-provider/tree/stable/0.7/qiskit_ibm_provider/utils/utils.py" signature="validate_job_tags(job_tags, exception)">
