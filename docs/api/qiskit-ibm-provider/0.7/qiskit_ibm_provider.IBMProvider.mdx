...
<Class id="qiskit_ibm_provider.IBMProvider" github="https://github.com/qiskit/qiskit-ibm-provider/tree/stable/0.7/qiskit_ibm_provider/ibm_provider.py" signature="IBMProvider(token=None, url=None, name=None, instance=None, proxies=None, verify=None)">
  ...
  **IBMInputValueError** – If an input is invalid.
  ...
  <Attribute id="qiskit_ibm_provider.IBMProvider.backend" name="backend" signature="IBMBackendService">
  ...
  <Function id="qiskit_ibm_provider.IBMProvider.active_account" name="active_account" signature="IBMProvider.active_account()">
  ...
  <Function id="qiskit_ibm_provider.IBMProvider.backends" name="backends" signature="IBMProvider.backends(name=None, filters=None, min_num_qubits=None, instance=None, **kwargs)">
  ...
  <Function id="qiskit_ibm_provider.IBMProvider.delete_account" name="delete_account" signature="static IBMProvider.delete_account(name=None)">
  ...
  <Function id="qiskit_ibm_provider.IBMProvider.get_backend" name="get_backend" signature="IBMProvider.get_backend(name=None, instance=None, **kwargs)">
  ...
  <Function id="qiskit_ibm_provider.IBMProvider.instances" name="instances" signature="IBMProvider.instances()">
  ...
  <Function id="qiskit_ibm_provider.IBMProvider.jobs" name="jobs" signature="IBMProvider.jobs(limit=10, skip=0, backend_name=None, status=None, start_datetime=None, end_datetime=None, job_tags=None, descending=True, instance=None, legacy=False)">
  ...
  <Function id="qiskit_ibm_provider.IBMProvider.retrieve_job" name="retrieve_job" signature="IBMProvider.retrieve_job(job_id)">
    Return a single job.
  ...
  <Function id="qiskit_ibm_provider.IBMProvider.save_account" name="save_account" signature="static IBMProvider.save_account(token=None, url=None, instance=None, name=None, proxies=None, verify=None, overwrite=False)">
  ...
  <Function id="qiskit_ibm_provider.IBMProvider.saved_accounts" name="saved_accounts" signature="static IBMProvider.saved_accounts(default=None, name=None)">
