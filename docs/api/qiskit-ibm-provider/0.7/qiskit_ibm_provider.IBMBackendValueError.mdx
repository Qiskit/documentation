...
<Class id="qiskit_ibm_provider.IBMBackendValueError" github="https://github.com/qiskit/qiskit-ibm-provider/tree/stable/0.7/qiskit_ibm_provider/exceptions.py" signature="IBMBackendValueError(*message)">
