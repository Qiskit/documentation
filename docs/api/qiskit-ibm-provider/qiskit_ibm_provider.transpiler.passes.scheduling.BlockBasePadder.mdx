...
<Class id="qiskit_ibm_provider.transpiler.passes.scheduling.BlockBasePadder" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit-ibm-provider/tree/stable/0.11/qiskit_ibm_provider/transpiler/passes/scheduling/block_base_padder.py#L38-L642" signature="BlockBasePadder(schedule_idle_qubits=False)">
  ...
  <Function id="qiskit_ibm_provider.transpiler.passes.scheduling.BlockBasePadder.run" name="run" github="https://github.com/Qiskit/qiskit-ibm-provider/tree/stable/0.11/qiskit_ibm_provider/transpiler/passes/scheduling/block_base_padder.py#L91-L117" signature="run(dag)">
