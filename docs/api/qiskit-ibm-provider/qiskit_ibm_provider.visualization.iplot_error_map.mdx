...
<Function id="qiskit_ibm_provider.visualization.iplot_error_map" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit-ibm-provider/tree/stable/0.11/qiskit_ibm_provider/visualization/interactive/error_map.py#L31-L554" signature="iplot_error_map(backend, figsize=(800, 500), show_title=True, remove_badcal_edges=True, background_color='white', as_widget=False)">
