...
<Class id="qiskit_ibm_provider.IBMProviderValueError" github="https://github.com/qiskit/qiskit-ibm-provider/tree/stable/0.8/qiskit_ibm_provider/exceptions.py" signature="IBMProviderValueError(*message)">
