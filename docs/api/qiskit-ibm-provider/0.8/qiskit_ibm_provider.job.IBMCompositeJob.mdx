...
<Class id="qiskit_ibm_provider.job.IBMCompositeJob" github="https://github.com/qiskit/qiskit-ibm-provider/tree/stable/0.8/qiskit_ibm_provider/job/ibm_composite_job.py" signature="IBMCompositeJob(backend, api_client, job_id=None, creation_date=None, jobs=None, circuits_list=None, run_config=None, name=None, tags=None, client_version=None)">
  ...
  **Raises**
  ...
  <Function id="qiskit_ibm_provider.job.IBMCompositeJob.backend_options" name="backend_options" signature="backend_options()">
  ...
  <Function id="qiskit_ibm_provider.job.IBMCompositeJob.block_for_submit" name="block_for_submit" signature="block_for_submit()">
  ...
  <Function id="qiskit_ibm_provider.job.IBMCompositeJob.cancel" name="cancel" signature="cancel()">
  ...
  <Function id="qiskit_ibm_provider.job.IBMCompositeJob.circuits" name="circuits" signature="circuits()">
  ...
  <Function id="qiskit_ibm_provider.job.IBMCompositeJob.creation_date" name="creation_date" signature="creation_date()">
  ...
  <Function id="qiskit_ibm_provider.job.IBMCompositeJob.error_message" name="error_message" signature="error_message()">
  ...
  <Function id="qiskit_ibm_provider.job.IBMCompositeJob.from_jobs" name="from_jobs" signature="classmethod from_jobs(job_id, jobs, api_client)">
  ...
  <Function id="qiskit_ibm_provider.job.IBMCompositeJob.header" name="header" signature="header()">
  ...
  <Function id="qiskit_ibm_provider.job.IBMCompositeJob.name" name="name" signature="name()">
  ...
  <Function id="qiskit_ibm_provider.job.IBMCompositeJob.properties" name="properties" signature="properties(refresh=False)">
  ...
  <Function id="qiskit_ibm_provider.job.IBMCompositeJob.queue_info" name="queue_info" signature="queue_info()">
  ...
  <Function id="qiskit_ibm_provider.job.IBMCompositeJob.queue_position" name="queue_position" signature="queue_position(refresh=False)">
  ...
  <Function id="qiskit_ibm_provider.job.IBMCompositeJob.refresh" name="refresh" signature="refresh()">
  ...
  <Function id="qiskit_ibm_provider.job.IBMCompositeJob.report" name="report" signature="report(detailed=True)">
  ...
  <Function id="qiskit_ibm_provider.job.IBMCompositeJob.rerun_failed" name="rerun_failed" signature="rerun_failed()">
  ...
  <Function id="qiskit_ibm_provider.job.IBMCompositeJob.result" name="result" signature="result(timeout=None, wait=5, partial=False, refresh=False)">
  ...
  <Function id="qiskit_ibm_provider.job.IBMCompositeJob.scheduling_mode" name="scheduling_mode" signature="scheduling_mode()">
  ...
  <Function id="qiskit_ibm_provider.job.IBMCompositeJob.status" name="status" signature="status()">
  ...
  <Function id="qiskit_ibm_provider.job.IBMCompositeJob.sub_job" name="sub_job" signature="sub_job(circuit_index)">
  ...
  <Function id="qiskit_ibm_provider.job.IBMCompositeJob.sub_jobs" name="sub_jobs" signature="sub_jobs(block_for_submit=True)">
  ...
  <Function id="qiskit_ibm_provider.job.IBMCompositeJob.submit" name="submit" signature="submit()">
    Unsupported method.
  ...
  <Function id="qiskit_ibm_provider.job.IBMCompositeJob.tags" name="tags" signature="tags()">
  ...
  <Function id="qiskit_ibm_provider.job.IBMCompositeJob.time_per_step" name="time_per_step" signature="time_per_step()">
  ...
  <Function id="qiskit_ibm_provider.job.IBMCompositeJob.update_name" name="update_name" signature="update_name(name)">
  ...
  <Function id="qiskit_ibm_provider.job.IBMCompositeJob.update_tags" name="update_tags" signature="update_tags(new_tags)">
  ...
  <Function id="qiskit_ibm_provider.job.IBMCompositeJob.wait_for_final_state" name="wait_for_final_state" signature="wait_for_final_state(timeout=None, wait=None, callback=None)">
