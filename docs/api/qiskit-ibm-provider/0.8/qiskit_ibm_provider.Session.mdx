...
<Class id="qiskit_ibm_provider.Session" github="https://github.com/qiskit/qiskit-ibm-provider/tree/stable/0.8/qiskit_ibm_provider/session.py" signature="Session(max_time=None)">
