...
<Class id="qiskit_ibm_provider.IBMBackendError" github="https://github.com/qiskit/qiskit-ibm-provider/tree/stable/0.8/qiskit_ibm_provider/exceptions.py" signature="IBMBackendError(*message)">
