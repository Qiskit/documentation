...
<Function id="qiskit_ibm_provider.utils.seconds_to_duration" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-ibm-provider/tree/stable/0.8/qiskit_ibm_provider/utils/converters.py" signature="seconds_to_duration(seconds)">
