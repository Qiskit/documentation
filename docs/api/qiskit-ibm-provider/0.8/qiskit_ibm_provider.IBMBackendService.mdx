...
<Class id="qiskit_ibm_provider.IBMBackendService" github="https://github.com/qiskit/qiskit-ibm-provider/tree/stable/0.8/qiskit_ibm_provider/ibm_backend_service.py" signature="IBMBackendService(provider, hgp)">
