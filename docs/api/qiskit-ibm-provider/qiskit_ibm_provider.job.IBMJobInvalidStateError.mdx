...
<Class id="qiskit_ibm_provider.job.IBMJobInvalidStateError" github="https://github.com/Qiskit/qiskit-ibm-provider/tree/stable/0.10/qiskit_ibm_provider/job/exceptions.py#L38-L41" signature="IBMJobInvalidStateError(*message)">
