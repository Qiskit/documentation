...
<Class id="qiskit_ibm_provider.job.IBMJobInvalidStateError" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit-ibm-provider/tree/stable/0.11/qiskit_ibm_provider/job/exceptions.py#L38-L41" signature="IBMJobInvalidStateError(*message)">
