...
<Class id="qiskit_ibm_provider.transpiler.passes.scheduling.DynamicCircuitInstructionDurations" github="https://github.com/Qiskit/qiskit-ibm-provider/tree/stable/0.11/qiskit_ibm_provider/transpiler/passes/scheduling/utils.py#L133-L367" signature="DynamicCircuitInstructionDurations(instruction_durations=None, dt=None, enable_patching=True)">
  ...
  <Function id="qiskit_ibm_provider.transpiler.passes.scheduling.DynamicCircuitInstructionDurations.from_backend" name="from_backend" github="https://github.com/Qiskit/qiskit-ibm-provider/tree/stable/0.11/qiskit_ibm_provider/transpiler/passes/scheduling/utils.py#L155-L209" signature="classmethod from_backend(backend)">
  ...
  <Function id="qiskit_ibm_provider.transpiler.passes.scheduling.DynamicCircuitInstructionDurations.from_target" name="from_target" github="https://github.com/Qiskit/qiskit-ibm-provider/tree/stable/0.11/qiskit_ibm_provider/transpiler/passes/scheduling/utils.py#L211-L230" signature="classmethod from_target(target)">
  ...
  <Function id="qiskit_ibm_provider.transpiler.passes.scheduling.DynamicCircuitInstructionDurations.update" name="update" github="https://github.com/Qiskit/qiskit-ibm-provider/tree/stable/0.11/qiskit_ibm_provider/transpiler/passes/scheduling/utils.py#L232-L278" signature="update(inst_durations, dt=None)">
