...
<Function id="qiskit_ibm_provider.utils.validate_job_tags" github="https://github.com/Qiskit/qiskit-ibm-provider/tree/stable/0.10/qiskit_ibm_provider/utils/utils.py#L92-L108" signature="validate_job_tags(job_tags, exception)">
