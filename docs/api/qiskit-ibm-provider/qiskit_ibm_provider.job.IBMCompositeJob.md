...
*   **circuits\_list** (`Optional`\[`List`\[`Union`\[`List`\[[`QuantumCircuit`](/api/qiskit/qiskit.circuit.QuantumCircuit.html#qiskit.circuit.QuantumCircuit "(in Qiskit v0.44)")], `List`\[[`Schedule`](/api/qiskit/qiskit.pulse.Schedule.html#qiskit.pulse.Schedule "(in Qiskit v0.44)")]]]]) – Circuits for this job.
...
`List`\[`Union`\[[`QuantumCircuit`](/api/qiskit/qiskit.circuit.QuantumCircuit.html#qiskit.circuit.QuantumCircuit "(in Qiskit v0.44)"), [`Schedule`](/api/qiskit/qiskit.pulse.Schedule.html#qiskit.pulse.Schedule "(in Qiskit v0.44)")]]
