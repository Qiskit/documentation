...
<Class id="qiskit_ibm_provider.IBMBackendError" github="https://github.com/Qiskit/qiskit-ibm-provider/tree/stable/0.10/qiskit_ibm_provider/exceptions.py#L72-L75" signature="IBMBackendError(*message)">
