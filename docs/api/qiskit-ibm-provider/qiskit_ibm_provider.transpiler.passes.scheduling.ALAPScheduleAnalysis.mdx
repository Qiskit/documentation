...
<Class id="qiskit_ibm_provider.transpiler.passes.scheduling.ALAPScheduleAnalysis" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit-ibm-provider/tree/stable/0.11/qiskit_ibm_provider/transpiler/passes/scheduling/scheduler.py#L437-L665" signature="ALAPScheduleAnalysis(durations)">
  ...
  **durations** ([`InstructionDurations`](/api/qiskit/qiskit.transpiler.InstructionDurations "(in Qiskit v1.0)")) – Durations of instructions to be used in scheduling.
  ...
  <Attribute id="qiskit_ibm_provider.transpiler.passes.scheduling.ALAPScheduleAnalysis.is_analysis_pass" name="is_analysis_pass">
  ...
  <Attribute id="qiskit_ibm_provider.transpiler.passes.scheduling.ALAPScheduleAnalysis.is_transformation_pass" name="is_transformation_pass">
  ...
  <Function id="qiskit_ibm_provider.transpiler.passes.scheduling.ALAPScheduleAnalysis.__call__" name="__call__" signature="__call__(circuit, property_set=None)">
  ...
  <Function id="qiskit_ibm_provider.transpiler.passes.scheduling.ALAPScheduleAnalysis.execute" name="execute" signature="execute(passmanager_ir, state, callback=None)">
  ...
  <Function id="qiskit_ibm_provider.transpiler.passes.scheduling.ALAPScheduleAnalysis.name" name="name" signature="name()">
    Name of the pass.
  ...
  <Function id="qiskit_ibm_provider.transpiler.passes.scheduling.ALAPScheduleAnalysis.run" name="run" github="https://github.com/Qiskit/qiskit-ibm-provider/tree/stable/0.11/qiskit_ibm_provider/transpiler/passes/scheduling/scheduler.py#L458-L477" signature="run(dag)">
  ...
  <Function id="qiskit_ibm_provider.transpiler.passes.scheduling.ALAPScheduleAnalysis.update_status" name="update_status" signature="update_status(state, run_state)">
