...
<Class id="qiskit_ibm_provider.Session" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit-ibm-provider/tree/stable/0.11/qiskit_ibm_provider/session.py#L22-L123" signature="Session(max_time=None, session_id=None)">
