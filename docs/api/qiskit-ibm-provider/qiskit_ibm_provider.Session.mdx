...
<Class id="qiskit_ibm_provider.Session" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit-ibm-provider/tree/stable/0.11/qiskit_ibm_provider/session.py#L22-L123" signature="Session(max_time=None, session_id=None)" modifiers="class">
  ...
  **ValueError** – If an input value is invalid.
  ...
  <Function id="qiskit_ibm_provider.Session.cancel" github="https://github.com/Qiskit/qiskit-ibm-provider/tree/stable/0.11/qiskit_ibm_provider/session.py#L109-L111" signature="cancel()">
