...
<Class id="qiskit_ibm_provider.job.IBMJobInvalidStateError" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-ibm-provider/tree/stable/0.9/qiskit_ibm_provider/job/exceptions.py" signature="IBMJobInvalidStateError(*message)" modifiers="exception">
