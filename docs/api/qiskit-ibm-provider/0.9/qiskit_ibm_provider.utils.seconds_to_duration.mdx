...
<Function id="qiskit_ibm_provider.utils.seconds_to_duration" github="https://github.com/qiskit/qiskit-ibm-provider/tree/stable/0.9/qiskit_ibm_provider/utils/converters.py" signature="seconds_to_duration(seconds)">
