...
<Class id="qiskit_ibm_provider.IBMBackendApiProtocolError" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-ibm-provider/tree/stable/0.9/qiskit_ibm_provider/exceptions.py" signature="IBMBackendApiProtocolError(*message)">
