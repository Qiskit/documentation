...
<Class id="qiskit_ibm_provider.IBMBackend" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-ibm-provider/tree/stable/0.9/qiskit_ibm_provider/ibm_backend.py" signature="IBMBackend(configuration, provider, api_client, instance=None)" modifiers="class">
  ...
  *   **api\_client** (`AccountClient`) – IBM Quantum client used to communicate with the server.
  ...
  <Function id="qiskit_ibm_provider.IBMBackend.acquire_channel" signature="acquire_channel(qubit)">
  ...
  <Function id="qiskit_ibm_provider.IBMBackend.cancel_session" signature="cancel_session()">
  ...
  <Function id="qiskit_ibm_provider.IBMBackend.close_session" signature="close_session()">
  ...
  <Function id="qiskit_ibm_provider.IBMBackend.configuration" signature="configuration()">
  ...
  <Function id="qiskit_ibm_provider.IBMBackend.control_channel" signature="control_channel(qubits)">
  ...
  <Function id="qiskit_ibm_provider.IBMBackend.defaults" signature="defaults(refresh=False)">
  ...
  <Function id="qiskit_ibm_provider.IBMBackend.drive_channel" signature="drive_channel(qubit)">
  ...
  <Function id="qiskit_ibm_provider.IBMBackend.get_translation_stage_plugin" signature="get_translation_stage_plugin()" modifiers="classmethod">
  ...
  <Function id="qiskit_ibm_provider.IBMBackend.measure_channel" signature="measure_channel(qubit)">
  ...
  <Function id="qiskit_ibm_provider.IBMBackend.open_session" signature="open_session(max_time=None)">
    Open session
  ...
  <Function id="qiskit_ibm_provider.IBMBackend.properties" signature="properties(refresh=False, datetime=None)">
  ...
  <Function id="qiskit_ibm_provider.IBMBackend.status" signature="status()">
  ...
  <Function id="qiskit_ibm_provider.IBMBackend.target_history" signature="target_history(datetime=None)">
