...
<Class id="qiskit_ibm_provider.transpiler.passes.scheduling.DynamicCircuitInstructionDurations" github="https://github.com/qiskit/qiskit-ibm-provider/tree/stable/0.9/qiskit_ibm_provider/transpiler/passes/scheduling/utils.py" signature="DynamicCircuitInstructionDurations(instruction_durations=None, dt=None, enable_patching=True)">
  ...
  <Attribute id="qiskit_ibm_provider.transpiler.passes.scheduling.DynamicCircuitInstructionDurations.MEASURE_PATCH_CYCLES" name="MEASURE_PATCH_CYCLES" attributeValue="= 160" />

  ### MEASURE\_PATCH\_ODD\_OFFSET

  <Attribute id="qiskit_ibm_provider.transpiler.passes.scheduling.DynamicCircuitInstructionDurations.MEASURE_PATCH_ODD_OFFSET" name="MEASURE_PATCH_ODD_OFFSET" attributeValue="= 64" />

  ## Methods

  ### from\_backend

  <Function id="qiskit_ibm_provider.transpiler.passes.scheduling.DynamicCircuitInstructionDurations.from_backend" name="from_backend" signature="classmethod from_backend(backend)">
  ...
  <Function id="qiskit_ibm_provider.transpiler.passes.scheduling.DynamicCircuitInstructionDurations.from_target" name="from_target" signature="classmethod from_target(target)">
  ...
  <Function id="qiskit_ibm_provider.transpiler.passes.scheduling.DynamicCircuitInstructionDurations.get" name="get" signature="get(inst, qubits, unit='dt', parameters=None)">
  ...
  <Function id="qiskit_ibm_provider.transpiler.passes.scheduling.DynamicCircuitInstructionDurations.units_used" name="units_used" signature="units_used()">
  ...
  <Function id="qiskit_ibm_provider.transpiler.passes.scheduling.DynamicCircuitInstructionDurations.update" name="update" signature="update(inst_durations, dt=None)">
