...
<Class id="qiskit_ibm_provider.Session" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-ibm-provider/tree/stable/0.9/qiskit_ibm_provider/session.py" signature="Session(max_time=None)">
  ...
  **ValueError** – If an input value is invalid.
  ...
  <Function id="qiskit_ibm_provider.Session.cancel" name="cancel" signature="cancel()">
