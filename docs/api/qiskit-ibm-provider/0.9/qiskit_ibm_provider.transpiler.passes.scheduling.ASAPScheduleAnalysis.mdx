...
<Class id="qiskit_ibm_provider.transpiler.passes.scheduling.ASAPScheduleAnalysis" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-ibm-provider/tree/stable/0.9/qiskit_ibm_provider/transpiler/passes/scheduling/scheduler.py" signature="ASAPScheduleAnalysis(durations)" modifiers="class">
  ...
  **durations** ([`InstructionDurations`](/api/qiskit/qiskit.transpiler.InstructionDurations "(in Qiskit v0.46)")) – Durations of instructions to be used in scheduling.
  ...
  <Function id="qiskit_ibm_provider.transpiler.passes.scheduling.ASAPScheduleAnalysis.run" signature="run(dag)">
