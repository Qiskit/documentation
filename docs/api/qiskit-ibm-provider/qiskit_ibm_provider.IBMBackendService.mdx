...
<Class id="qiskit_ibm_provider.IBMBackendService" github="https://github.com/Qiskit/qiskit-ibm-provider/tree/stable/0.11/qiskit_ibm_provider/ibm_backend_service.py#L61-L741" signature="IBMBackendService(provider, hgp)">
