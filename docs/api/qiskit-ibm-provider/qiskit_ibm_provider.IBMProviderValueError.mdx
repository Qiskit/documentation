...
<Class id="qiskit_ibm_provider.IBMProviderValueError" github="https://github.com/Qiskit/qiskit-ibm-provider/tree/stable/0.10/qiskit_ibm_provider/exceptions.py#L36-L39" signature="IBMProviderValueError(*message)">
