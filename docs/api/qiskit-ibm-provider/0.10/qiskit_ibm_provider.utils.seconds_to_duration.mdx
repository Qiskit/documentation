...
<Function id="qiskit_ibm_provider.utils.seconds_to_duration" name="seconds_to_duration" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit-ibm-provider/tree/stable/0.10/qiskit_ibm_provider/utils/converters.py#L140-L160" signature="seconds_to_duration(seconds)">
