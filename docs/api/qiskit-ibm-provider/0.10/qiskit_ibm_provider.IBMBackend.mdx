...
<Class id="qiskit_ibm_provider.IBMBackend" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit-ibm-provider/tree/stable/0.10/qiskit_ibm_provider/ibm_backend.py#L79-L895" signature="IBMBackend(configuration, provider, api_client, instance=None)" modifiers="class">
  ...
  *   **api\_client** (`AccountClient`) – IBM Quantum client used to communicate with the server.
  ...
  <Function id="qiskit_ibm_provider.IBMBackend.acquire_channel" github="https://github.com/Qiskit/qiskit-ibm-provider/tree/stable/0.10/qiskit_ibm_provider/ibm_backend.py#L710-L716" signature="acquire_channel(qubit)">
  ...
  <Function id="qiskit_ibm_provider.IBMBackend.cancel_session" github="https://github.com/Qiskit/qiskit-ibm-provider/tree/stable/0.10/qiskit_ibm_provider/ibm_backend.py#L879-L885" signature="cancel_session()">
  ...
  <Function id="qiskit_ibm_provider.IBMBackend.close_session" github="https://github.com/Qiskit/qiskit-ibm-provider/tree/stable/0.10/qiskit_ibm_provider/ibm_backend.py#L887-L895" signature="close_session()">
  ...
  <Function id="qiskit_ibm_provider.IBMBackend.configuration" github="https://github.com/Qiskit/qiskit-ibm-provider/tree/stable/0.10/qiskit_ibm_provider/ibm_backend.py#L677-L692" signature="configuration()">
  ...
  <Function id="qiskit_ibm_provider.IBMBackend.control_channel" github="https://github.com/Qiskit/qiskit-ibm-provider/tree/stable/0.10/qiskit_ibm_provider/ibm_backend.py#L718-L731" signature="control_channel(qubits)">
  ...
  <Function id="qiskit_ibm_provider.IBMBackend.defaults" github="https://github.com/Qiskit/qiskit-ibm-provider/tree/stable/0.10/qiskit_ibm_provider/ibm_backend.py#L652-L675" signature="defaults(refresh=False)">
  ...
  <Function id="qiskit_ibm_provider.IBMBackend.drive_channel" github="https://github.com/Qiskit/qiskit-ibm-provider/tree/stable/0.10/qiskit_ibm_provider/ibm_backend.py#L694-L700" signature="drive_channel(qubit)">
  ...
  <Function id="qiskit_ibm_provider.IBMBackend.measure_channel" github="https://github.com/Qiskit/qiskit-ibm-provider/tree/stable/0.10/qiskit_ibm_provider/ibm_backend.py#L702-L708" signature="measure_channel(qubit)">
  ...
  <Function id="qiskit_ibm_provider.IBMBackend.open_session" github="https://github.com/Qiskit/qiskit-ibm-provider/tree/stable/0.10/qiskit_ibm_provider/ibm_backend.py#L863-L872" signature="open_session(max_time=None)">
    Open session
  ...
  <Function id="qiskit_ibm_provider.IBMBackend.properties" github="https://github.com/Qiskit/qiskit-ibm-provider/tree/stable/0.10/qiskit_ibm_provider/ibm_backend.py#L574-L626" signature="properties(refresh=False, datetime=None)">
  ...
  <Function id="qiskit_ibm_provider.IBMBackend.status" github="https://github.com/Qiskit/qiskit-ibm-provider/tree/stable/0.10/qiskit_ibm_provider/ibm_backend.py#L628-L650" signature="status()">
  ...
  <Function id="qiskit_ibm_provider.IBMBackend.target_history" github="https://github.com/Qiskit/qiskit-ibm-provider/tree/stable/0.10/qiskit_ibm_provider/ibm_backend.py#L324-L329" signature="target_history(datetime=None)">
