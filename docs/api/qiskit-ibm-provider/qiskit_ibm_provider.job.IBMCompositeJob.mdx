...
<Class id="qiskit_ibm_provider.job.IBMCompositeJob" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit-ibm-provider/tree/stable/0.11/qiskit_ibm_provider/job/ibm_composite_job.py#L72-L1317" signature="IBMCompositeJob(backend, api_client, job_id=None, creation_date=None, jobs=None, circuits_list=None, run_config=None, name=None, tags=None, client_version=None)">
  ...
  **Raises**
  ...
  <Function id="qiskit_ibm_provider.job.IBMCompositeJob.from_jobs" github="https://github.com/Qiskit/qiskit-ibm-provider/tree/stable/0.11/qiskit_ibm_provider/job/ibm_composite_job.py#L224-L255" signature="classmethod from_jobs(job_id, jobs, api_client)">
