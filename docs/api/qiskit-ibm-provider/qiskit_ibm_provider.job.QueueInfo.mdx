...
<Class id="qiskit_ibm_provider.job.QueueInfo" github="https://github.com/Qiskit/qiskit-ibm-provider/tree/stable/0.11/qiskit_ibm_provider/job/queueinfo.py#L25-L183" signature="QueueInfo(position_in_queue=None, status=None, estimated_start_time=None, estimated_completion_time=None, hub_priority=None, group_priority=None, project_priority=None, job_id=None, **kwargs)">
  ...
  *   **kwargs** (`Any`) – Additional attributes.
  ...
  <Attribute id="qiskit_ibm_provider.job.QueueInfo.estimated_complete_time" name="estimated_complete_time">
  ...
  <Attribute id="qiskit_ibm_provider.job.QueueInfo.estimated_start_time" name="estimated_start_time">
  ...
  <Function id="qiskit_ibm_provider.job.QueueInfo.format" name="format" github="https://github.com/Qiskit/qiskit-ibm-provider/tree/stable/0.11/qiskit_ibm_provider/job/queueinfo.py#L123-L159" signature="format()">
