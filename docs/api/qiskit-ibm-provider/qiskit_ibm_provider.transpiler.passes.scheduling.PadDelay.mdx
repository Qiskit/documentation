...
<Class id="qiskit_ibm_provider.transpiler.passes.scheduling.PadDelay" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit-ibm-provider/tree/stable/0.11/qiskit_ibm_provider/transpiler/passes/scheduling/pad_delay.py#L22-L78" signature="PadDelay(fill_very_end=True, schedule_idle_qubits=False)">
  ...
  *   **schedule\_idle\_qubits** (`bool`) – Set to true if you’d like a delay inserted on idle qubits. This is useful for timeline visualizations, but may cause issues for execution on large backends.
  ...
  <Attribute id="qiskit_ibm_provider.transpiler.passes.scheduling.PadDelay.is_analysis_pass" name="is_analysis_pass">
  ...
  <Attribute id="qiskit_ibm_provider.transpiler.passes.scheduling.PadDelay.is_transformation_pass" name="is_transformation_pass">
  ...
  <Function id="qiskit_ibm_provider.transpiler.passes.scheduling.PadDelay.__call__" name="__call__" signature="__call__(circuit, property_set=None)">
  ...
  <Function id="qiskit_ibm_provider.transpiler.passes.scheduling.PadDelay.execute" name="execute" signature="execute(passmanager_ir, state, callback=None)">
  ...
  <Function id="qiskit_ibm_provider.transpiler.passes.scheduling.PadDelay.name" name="name" signature="name()">
    Name of the pass.
  ...
  <Function id="qiskit_ibm_provider.transpiler.passes.scheduling.PadDelay.run" name="run" github="https://github.com/Qiskit/qiskit-ibm-provider/tree/stable/0.11/qiskit_ibm_provider/transpiler/passes/scheduling/block_base_padder.py#L91-L117" signature="run(dag)">
  ...
  <Function id="qiskit_ibm_provider.transpiler.passes.scheduling.PadDelay.update_status" name="update_status" signature="update_status(state, run_state)">
