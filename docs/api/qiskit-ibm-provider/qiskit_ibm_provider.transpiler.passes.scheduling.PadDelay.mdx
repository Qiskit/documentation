...
<Class id="qiskit_ibm_provider.transpiler.passes.scheduling.PadDelay" github="https://github.com/Qiskit/qiskit-ibm-provider/tree/stable/0.10/qiskit_ibm_provider/transpiler/passes/scheduling/pad_delay.py#L22-L78" signature="PadDelay(fill_very_end=True, schedule_idle_qubits=False)">
  ...
  *   **schedule\_idle\_qubits** (`bool`) – Set to true if you’d like a delay inserted on idle qubits. This is useful for timeline visualizations, but may cause issues for execution on large backends.
  ...
  <Function id="qiskit_ibm_provider.transpiler.passes.scheduling.PadDelay.run" name="run" github="https://github.com/Qiskit/qiskit-ibm-provider/tree/stable/0.10/qiskit_ibm_provider/transpiler/passes/scheduling/block_base_padder.py#L91-L117" signature="run(dag)">
