...
<Class id="qiskit_ibm_provider.IBMBackendApiProtocolError" github="https://github.com/Qiskit/qiskit-ibm-provider/tree/stable/0.10/qiskit_ibm_provider/exceptions.py#L84-L87" signature="IBMBackendApiProtocolError(*message)">
