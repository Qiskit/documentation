...
- In Batch mode, Orbit attempts one snapshot for every child Runtime job and reports them in `backendInfo.snapshots`.
...
<LeftColoredBar color="blue">
    `metadata["quantum_elements_orbit"]`
        ...
        <LeftColoredBar color="purple">
            ...
            `executionMode`
                <Attribute attributeTypeHint="str">
                Present with value `"batch"` when Orbit used server-side Runtime Batch execution.
                </Attribute>
