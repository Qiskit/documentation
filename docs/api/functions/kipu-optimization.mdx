...
Options to handle the hardware submission, such as number of shots. Options for this function are specified as a nested dictionary. See the full [list of options](#kipu-options) and their default values.
- Required: No
