...
<CardGroup>
    <Card
      ...
      analyticsName="Functions API: q-ctrl-performance-management"
...
Input options; see [Options list](#est-options) for more details
- Required: No
...
Input options; see [Options list](#sam-options) section for more details
...
- Example: `PrimitiveResult([PubResult(data=DataBin(c=BitArray(<shape=(), num_shots=2048, num_bits=35>)), metadata={'shots': 2048})], metadata={`provider_job_ids`: 1234678})`
</Attribute>