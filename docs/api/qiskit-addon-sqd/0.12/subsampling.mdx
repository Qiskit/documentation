...
<Function id="qiskit_addon_sqd.subsampling.subsample" github="https://github.com/Qiskit/qiskit-addon-sqd/tree/main/qiskit_addon_sqd/subsampling.py#L147-L211" signature="subsample(bitstring_matrix, probabilities, samples_per_batch, num_batches, rand_seed=None)">
...
<Function id="qiskit_addon_sqd.subsampling.postselect_by_hamming_right_and_left" github="https://github.com/Qiskit/qiskit-addon-sqd/tree/main/qiskit_addon_sqd/subsampling.py#L96-L144" signature="postselect_by_hamming_right_and_left(bitstring_matrix, probabilities, *, hamming_right, hamming_left)">
