...
<Function id="qiskit_addon_sqd.qubit.solve_qubit" github="https://github.com/Qiskit/qiskit-addon-sqd/tree/stable/0.13/qiskit_addon_sqd/qubit.py#L29-L75" signature="solve_qubit(bitstring_matrix, hamiltonian, *, verbose=False, **scipy_kwargs)">
...
<Function id="qiskit_addon_sqd.qubit.project_operator_to_subspace" github="https://github.com/Qiskit/qiskit-addon-sqd/tree/stable/0.13/qiskit_addon_sqd/qubit.py#L78-L144" signature="project_operator_to_subspace(bitstring_matrix, hamiltonian, *, verbose=False)">
...
<Function id="qiskit_addon_sqd.qubit.sort_and_remove_duplicates" github="https://github.com/Qiskit/qiskit-addon-sqd/tree/stable/0.13/qiskit_addon_sqd/qubit.py#L147-L164" signature="sort_and_remove_duplicates(bitstring_matrix)">
...
<Function id="qiskit_addon_sqd.qubit.matrix_elements_from_pauli" github="https://github.com/Qiskit/qiskit-addon-sqd/tree/stable/0.13/qiskit_addon_sqd/qubit.py#L167-L240" signature="matrix_elements_from_pauli(bitstring_matrix, pauli)">
