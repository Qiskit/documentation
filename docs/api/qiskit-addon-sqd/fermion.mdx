...
<Class id="qiskit_addon_sqd.fermion.SCIState" github="https://github.com/Qiskit/qiskit-addon-sqd/tree/stable/0.13/qiskit_addon_sqd/fermion.py#L57-L139" signature="SCIState(amplitudes, ci_strs_a, ci_strs_b, norb, nelec)" modifiers="class">
  ...
  *   **nelec** ([*tuple*](https://docs.python.org/3/library/stdtypes.html#tuple)*\[*[*int*](https://docs.python.org/3/library/functions.html#int)*,* [*int*](https://docs.python.org/3/library/functions.html#int)*]*)
  ...
  <Attribute id="qiskit_addon_sqd.fermion.SCIState.amplitudes" attributeTypeHint="ndarray" attributeTypeHintHref="https://numpy.org/doc/stable/reference/generated/numpy.ndarray.html">
  ...
  <Attribute id="qiskit_addon_sqd.fermion.SCIState.ci_strs_a" attributeTypeHint="ndarray" attributeTypeHintHref="https://numpy.org/doc/stable/reference/generated/numpy.ndarray.html">
    The alpha determinants.
  </Attribute>

  #### ci\_strs\_b

  <Attribute id="qiskit_addon_sqd.fermion.SCIState.ci_strs_b" attributeTypeHint="ndarray" attributeTypeHintHref="https://numpy.org/doc/stable/reference/generated/numpy.ndarray.html">
    The beta determinants.
  </Attribute>

  #### load

  <Function id="qiskit_addon_sqd.fermion.SCIState.load" github="https://github.com/Qiskit/qiskit-addon-sqd/tree/stable/0.13/qiskit_addon_sqd/fermion.py#L101-L111" signature="load(filename)" modifiers="classmethod">
    Load an SCIState object from an .npz file.
  </Function>

  #### nelec

  <Attribute id="qiskit_addon_sqd.fermion.SCIState.nelec" attributeTypeHint="tuple[int, int]" attributeTypeHintHref="https://docs.python.org/3/library/stdtypes.html">
    The numbers of alpha and beta electrons.
  </Attribute>

  #### norb

  <Attribute id="qiskit_addon_sqd.fermion.SCIState.norb" attributeTypeHint="int" attributeTypeHintHref="https://docs.python.org/3/library/functions.html">
    The number of spatial orbitals.
  </Attribute>

  #### orbital\_occupancies

  <Function id="qiskit_addon_sqd.fermion.SCIState.orbital_occupancies" github="https://github.com/Qiskit/qiskit-addon-sqd/tree/stable/0.13/qiskit_addon_sqd/fermion.py#L136-L139" signature="orbital_occupancies()">
  ...
  <Function id="qiskit_addon_sqd.fermion.SCIState.rdm" github="https://github.com/Qiskit/qiskit-addon-sqd/tree/stable/0.13/qiskit_addon_sqd/fermion.py#L113-L128" signature="rdm(rank=1, spin_summed=False)">
  ...
  <Function id="qiskit_addon_sqd.fermion.SCIState.save" github="https://github.com/Qiskit/qiskit-addon-sqd/tree/stable/0.13/qiskit_addon_sqd/fermion.py#L90-L99" signature="save(filename)">
    Save the SCIState object to an .npz file.
  </Function>

  #### spin\_square

  <Function id="qiskit_addon_sqd.fermion.SCIState.spin_square" github="https://github.com/Qiskit/qiskit-addon-sqd/tree/stable/0.13/qiskit_addon_sqd/fermion.py#L130-L134" signature="spin_square()">
    Return spin squared.
...
<Function id="qiskit_addon_sqd.fermion.bitstring_matrix_to_ci_strs" github="https://github.com/Qiskit/qiskit-addon-sqd/tree/stable/0.13/qiskit_addon_sqd/fermion.py#L1004-L1035" signature="bitstring_matrix_to_ci_strs(bitstring_matrix, open_shell=False)">
...
<Function id="qiskit_addon_sqd.fermion.enlarge_batch_from_transitions" github="https://github.com/Qiskit/qiskit-addon-sqd/tree/stable/0.13/qiskit_addon_sqd/fermion.py#L1038-L1061" signature="enlarge_batch_from_transitions(bitstring_matrix, transition_operators)">
...
<Function id="qiskit_addon_sqd.fermion.solve_fermion" github="https://github.com/Qiskit/qiskit-addon-sqd/tree/stable/0.13/qiskit_addon_sqd/fermion.py#L745-L845" signature="solve_fermion(bitstring_matrix, /, hcore, eri, *, open_shell=False, spin_sq=None, shift=0.1, **kwargs)">
...
<Function id="qiskit_addon_sqd.fermion.solve_sci" github="https://github.com/Qiskit/qiskit-addon-sqd/tree/stable/0.13/qiskit_addon_sqd/fermion.py#L684-L742" signature="solve_sci(ci_strings, one_body_tensor, two_body_tensor, norb, nelec, *, spin_sq=None, **kwargs)">
...
<Function id="qiskit_addon_sqd.fermion.solve_sci_batch" github="https://github.com/Qiskit/qiskit-addon-sqd/tree/stable/0.13/qiskit_addon_sqd/fermion.py#L643-L681" signature="solve_sci_batch(ci_strings, one_body_tensor, two_body_tensor, norb, nelec, *, spin_sq=None, **kwargs)">
...
<Function id="qiskit_addon_sqd.fermion.optimize_orbitals" github="https://github.com/Qiskit/qiskit-addon-sqd/tree/stable/0.13/qiskit_addon_sqd/fermion.py#L848-L960" signature="optimize_orbitals(bitstring_matrix, /, hcore, eri, k_flat, *, open_shell=False, spin_sq=0.0, num_iters=10, num_steps_grad=10000, learning_rate=0.01, **kwargs)">
...
<Function id="qiskit_addon_sqd.fermion.rotate_integrals" github="https://github.com/Qiskit/qiskit-addon-sqd/tree/stable/0.13/qiskit_addon_sqd/fermion.py#L963-L1001" signature="rotate_integrals(hcore, eri, k_flat)">
