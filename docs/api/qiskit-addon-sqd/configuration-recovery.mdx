...
<Function id="qiskit_addon_sqd.configuration_recovery.post_select_by_hamming_weight" github="https://github.com/Qiskit/qiskit-addon-sqd/tree/stable/0.13/qiskit_addon_sqd/configuration_recovery.py#L26-L56" signature="post_select_by_hamming_weight(bitstring_matrix, *, hamming_right, hamming_left)">
