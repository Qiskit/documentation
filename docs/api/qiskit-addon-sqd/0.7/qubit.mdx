---
title: qubit (v0.7)
description: API reference for qiskit_addon_sqd.qubit in qiskit-addon-sqd v0.7
...
<Function id="qiskit_addon_sqd.qubit.solve_qubit" github="https://github.com/Qiskit/qiskit-addon-sqd/tree/stable/0.7/qiskit_addon_sqd/qubit.py#L29-L74" signature="solve_qubit(bitstring_matrix, hamiltonian, *, verbose=False, **scipy_kwargs)">
...
<Function id="qiskit_addon_sqd.qubit.project_operator_to_subspace" github="https://github.com/Qiskit/qiskit-addon-sqd/tree/stable/0.7/qiskit_addon_sqd/qubit.py#L77-L143" signature="project_operator_to_subspace(bitstring_matrix, hamiltonian, *, verbose=False)">
...
<Function id="qiskit_addon_sqd.qubit.sort_and_remove_duplicates" github="https://github.com/Qiskit/qiskit-addon-sqd/tree/stable/0.7/qiskit_addon_sqd/qubit.py#L146-L163" signature="sort_and_remove_duplicates(bitstring_matrix)">
...
<Function id="qiskit_addon_sqd.qubit.matrix_elements_from_pauli" github="https://github.com/Qiskit/qiskit-addon-sqd/tree/stable/0.7/qiskit_addon_sqd/qubit.py#L166-L239" signature="matrix_elements_from_pauli(bitstring_matrix, pauli)">
