...
<Function id="qiskit_addon_sqd.counts.generate_counts_uniform" github="https://github.com/Qiskit/qiskit-addon-sqd/tree/stable/0.12/qiskit_addon_sqd/counts.py#L64-L97" signature="generate_counts_uniform(num_samples, num_bits, rand_seed=None)">
  ...
  *   **rand\_seed** ([*Generator*](https://numpy.org/doc/stable/reference/random/generator.html#numpy.random.Generator "(in NumPy v2.3)")  *|*[*int*](https://docs.python.org/3/library/functions.html#int "(in Python v3.13)") *| None*) – A seed for controlling randomness
...
<Function id="qiskit_addon_sqd.counts.bit_array_to_arrays" github="https://github.com/Qiskit/qiskit-addon-sqd/tree/stable/0.12/qiskit_addon_sqd/counts.py#L45-L61" signature="bit_array_to_arrays(bit_array)">
  ...
  **bit\_array** ([*BitArray*](/docs/api/qiskit/qiskit.primitives.BitArray "(in Qiskit v2.1)")) – The bit array to convert
...
<Function id="qiskit_addon_sqd.counts.generate_bit_array_uniform" github="https://github.com/Qiskit/qiskit-addon-sqd/tree/stable/0.12/qiskit_addon_sqd/counts.py#L100-L117" signature="generate_bit_array_uniform(num_samples, num_bits, rand_seed=None)">
  ...
  **Return type**
  ...
  [*BitArray*](/docs/api/qiskit/qiskit.primitives.BitArray "(in Qiskit v2.1)")
</Function>
