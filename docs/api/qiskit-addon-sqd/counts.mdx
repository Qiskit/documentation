---
title: counts
description: API reference for qiskit_addon_sqd.counts
...
<Function id="qiskit_addon_sqd.counts.counts_to_arrays" github="https://github.com/Qiskit/qiskit-addon-sqd/tree/main/qiskit_addon_sqd/counts.py#L21-L40" signature="counts_to_arrays(counts)">
...
<Function id="qiskit_addon_sqd.counts.generate_counts_uniform" github="https://github.com/Qiskit/qiskit-addon-sqd/tree/main/qiskit_addon_sqd/counts.py#L43-L75" signature="generate_counts_uniform(num_samples, num_bits, rand_seed=None)">
...
<Function id="qiskit_addon_sqd.counts.generate_counts_bipartite_hamming" github="https://github.com/Qiskit/qiskit-addon-sqd/tree/main/qiskit_addon_sqd/counts.py#L78-L137" signature="generate_counts_bipartite_hamming(num_samples, num_bits, *, hamming_right, hamming_left, rand_seed=None)">
...
<Function id="qiskit_addon_sqd.counts.normalize_counts_dict" github="https://github.com/Qiskit/qiskit-addon-sqd/tree/main/qiskit_addon_sqd/counts.py#L140-L147" signature="normalize_counts_dict(counts)">
