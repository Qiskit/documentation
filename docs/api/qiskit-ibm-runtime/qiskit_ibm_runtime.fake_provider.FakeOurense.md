...
`FakeOurense` [GitHub](https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.21/qiskit_ibm_runtime/fake_provider/backends/ourense/fake_ourense.py#L37-L50 "view source code")
