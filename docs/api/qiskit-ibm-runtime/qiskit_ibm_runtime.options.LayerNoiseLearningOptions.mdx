...
<Class id="qiskit_ibm_runtime.options.LayerNoiseLearningOptions" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.23/qiskit_ibm_runtime/options/layer_noise_learning_options.py#L28-L75" signature="LayerNoiseLearningOptions(*args, **kwargs)">
