...
`LayerNoiseLearningOptions(*args, **kwargs)` [GitHub](https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.22/qiskit_ibm_runtime/options/layer_noise_learning_options.py#L28-L75 "view source code")
