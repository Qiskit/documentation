...
<Class id="qiskit_ibm_runtime.fake_provider.FakeBrisbane" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.37/qiskit_ibm_runtime/fake_provider/backends/brisbane/fake_brisbane.py#L21-L28" signature="FakeBrisbane" modifiers="class">
  Bases: `FakeBackendV2`
  ...
  <Function id="qiskit_ibm_runtime.fake_provider.FakeBrisbane.acquire_channel" signature="acquire_channel(qubit)">
  ...
  <Function id="qiskit_ibm_runtime.fake_provider.FakeBrisbane.check_faulty" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.37/qiskit_ibm_runtime/fake_provider/fake_backend.py#L198-L230" signature="check_faulty(circuit)">
  ...
  <Function id="qiskit_ibm_runtime.fake_provider.FakeBrisbane.configuration" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.37/qiskit_ibm_runtime/fake_provider/fake_backend.py#L194-L196" signature="configuration()">
  ...
  <Function id="qiskit_ibm_runtime.fake_provider.FakeBrisbane.control_channel" signature="control_channel(qubits)">
  ...
  <Function id="qiskit_ibm_runtime.fake_provider.FakeBrisbane.defaults" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.37/qiskit_ibm_runtime/fake_provider/fake_backend.py#L179-L192" signature="defaults(refresh=False)">
  ...
  <Function id="qiskit_ibm_runtime.fake_provider.FakeBrisbane.drive_channel" signature="drive_channel(qubit)">
  ...
  <Function id="qiskit_ibm_runtime.fake_provider.FakeBrisbane.measure_channel" signature="measure_channel(qubit)">
  ...
  <Function id="qiskit_ibm_runtime.fake_provider.FakeBrisbane.properties" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.37/qiskit_ibm_runtime/fake_provider/fake_backend.py#L166-L177" signature="properties(refresh=False)">
  ...
  <Function id="qiskit_ibm_runtime.fake_provider.FakeBrisbane.refresh" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.37/qiskit_ibm_runtime/fake_provider/fake_backend.py#L426-L502" signature="refresh(service)">
  ...
  <Function id="qiskit_ibm_runtime.fake_provider.FakeBrisbane.run" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.37/qiskit_ibm_runtime/fake_provider/fake_backend.py#L310-L341" signature="run(run_input, **options)">
  ...
  <Function id="qiskit_ibm_runtime.fake_provider.FakeBrisbane.status" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.37/qiskit_ibm_runtime/fake_provider/fake_backend.py#L148-L164" signature="status()">
