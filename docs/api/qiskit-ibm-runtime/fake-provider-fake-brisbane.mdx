...
<Class id="qiskit_ibm_runtime.fake_provider.FakeBrisbane" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.49/qiskit_ibm_runtime/fake_provider/backends/brisbane/fake_brisbane.py#L20-L26" signature="FakeBrisbane" modifiers="class">
  ...
  **AttributeError** – If a field is specified that’s outside the backend’s options
  ...
  <Attribute id="qiskit_ibm_runtime.fake_provider.FakeBrisbane.backend_name" attributeTypeHint="str" attributeValue="'fake_brisbane'">
    Name of the backend.
  </Attribute>

  ### conf\_filename

  <Attribute id="qiskit_ibm_runtime.fake_provider.FakeBrisbane.conf_filename" attributeTypeHint="str" attributeValue="'conf_brisbane.json'">
  ...
  <Attribute id="qiskit_ibm_runtime.fake_provider.FakeBrisbane.dirname" attributeTypeHint="str" attributeValue="'/home/runner/work/qiskit-ibm-runtime/qiskit-ibm-runtime/qiskit_ibm_runtime/fake_provider/backends/brisbane'">
  ...
  <Attribute id="qiskit_ibm_runtime.fake_provider.FakeBrisbane.props_filename" attributeTypeHint="str" attributeValue="'props_brisbane.json'">
