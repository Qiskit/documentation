---
title: QiskitRuntimeService (v0.23)
description: API reference for qiskit_ibm_runtime.QiskitRuntimeService in qiskit-ibm-runtime v0.23
...
<Class id="qiskit_ibm_runtime.QiskitRuntimeService" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.23/qiskit_ibm_runtime/qiskit_runtime_service.py#L64-L1163" signature="QiskitRuntimeService(channel=None, token=None, url=None, filename=None, name=None, instance=None, proxies=None, verify=None, channel_strategy=None)" modifiers="class">
  ...
  **IBMInputValueError** – If an input is invalid.
  ...
  <Function id="qiskit_ibm_runtime.QiskitRuntimeService.active_account" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.23/qiskit_ibm_runtime/qiskit_runtime_service.py#L648-L654" signature="active_account()">
  ...
  <Function id="qiskit_ibm_runtime.QiskitRuntimeService.backend" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.23/qiskit_ibm_runtime/qiskit_runtime_service.py#L757-L787" signature="backend(name=None, instance=None)">
  ...
  <Function id="qiskit_ibm_runtime.QiskitRuntimeService.backends" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.23/qiskit_ibm_runtime/qiskit_runtime_service.py#L485-L592" signature="backends(name=None, min_num_qubits=None, instance=None, dynamic_circuits=None, filters=None, **kwargs)">
  ...
  <Function id="qiskit_ibm_runtime.QiskitRuntimeService.delete_account" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.23/qiskit_ibm_runtime/qiskit_runtime_service.py#L656-L674" signature="delete_account(filename=None, name=None, channel=None)" modifiers="static">
  ...
  <Function id="qiskit_ibm_runtime.QiskitRuntimeService.delete_job" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.23/qiskit_ibm_runtime/qiskit_runtime_service.py#L1036-L1053" signature="delete_job(job_id)">
  ...
  <Function id="qiskit_ibm_runtime.QiskitRuntimeService.get_backend" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.23/qiskit_ibm_runtime/qiskit_runtime_service.py#L789-L790" signature="get_backend(name=None, **kwargs)">
    Return a single backend matching the specified filtering.
  ...
  <Function id="qiskit_ibm_runtime.QiskitRuntimeService.instances" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.23/qiskit_ibm_runtime/qiskit_runtime_service.py#L1143-L1151" signature="instances()">
  ...
  <Function id="qiskit_ibm_runtime.QiskitRuntimeService.job" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.23/qiskit_ibm_runtime/qiskit_runtime_service.py#L919-L938" signature="job(job_id)">
    ...
    **Return type**
    ...
    `Union`\[[`RuntimeJob`](runtime-job "qiskit_ibm_runtime.runtime_job.RuntimeJob"), [`RuntimeJobV2`](runtime-job-v-2 "qiskit_ibm_runtime.runtime_job_v2.RuntimeJobV2")]
  ...
  <Function id="qiskit_ibm_runtime.QiskitRuntimeService.jobs" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.23/qiskit_ibm_runtime/qiskit_runtime_service.py#L940-L1034" signature="jobs(limit=10, skip=0, backend_name=None, pending=None, program_id=None, instance=None, job_tags=None, session_id=None, created_after=None, created_before=None, descending=True)">
    ...
    **Return type**
    ...
    `List`\[`Union`\[[`RuntimeJob`](runtime-job "qiskit_ibm_runtime.runtime_job.RuntimeJob"), [`RuntimeJobV2`](runtime-job-v-2 "qiskit_ibm_runtime.runtime_job_v2.RuntimeJobV2")]]
  ...
  <Function id="qiskit_ibm_runtime.QiskitRuntimeService.least_busy" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.23/qiskit_ibm_runtime/qiskit_runtime_service.py#L1106-L1141" signature="least_busy(min_num_qubits=None, instance=None, filters=None, **kwargs)">
  ...
  <Function id="qiskit_ibm_runtime.QiskitRuntimeService.run" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.23/qiskit_ibm_runtime/qiskit_runtime_service.py#L792-L917" signature="run(program_id, inputs, options=None, callback=None, result_decoder=None, session_id=None, start_session=False)">
  ...
  <Function id="qiskit_ibm_runtime.QiskitRuntimeService.saved_accounts" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.23/qiskit_ibm_runtime/qiskit_runtime_service.py#L727-L755" signature="saved_accounts(default=None, channel=None, filename=None, name=None)" modifiers="static">
