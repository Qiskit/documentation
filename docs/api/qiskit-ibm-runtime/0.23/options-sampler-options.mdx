---
title: SamplerOptions (v0.23)
description: API reference for qiskit_ibm_runtime.options.SamplerOptions in qiskit-ibm-runtime v0.23
...
<Class id="qiskit_ibm_runtime.options.SamplerOptions" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.23/qiskit_ibm_runtime/options/sampler_options.py#L27-L54" signature="SamplerOptions(*args, **kwargs)" modifiers="class">
  ...
  *   **experimental** – Experimental options.
  ...
  <Function id="qiskit_ibm_runtime.options.SamplerOptions.update" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.23/qiskit_ibm_runtime/options/options.py#L151-L156" signature="update(**kwargs)">
    Update the options.
