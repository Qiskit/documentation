...
| [`EstimatorV2`](estimator-v2 "qiskit_ibm_runtime.EstimatorV2")(\[backend, session, options])                            | Class for interacting with Qiskit Runtime Estimator primitive service.            |
...
| [`SamplerV2`](sampler-v2 "qiskit_ibm_runtime.SamplerV2")(\[backend, session, options])                                  | Class for interacting with Qiskit Runtime Sampler primitive service.              |
