---
title: FakePoughkeepsie (v0.23)
description: API reference for qiskit_ibm_runtime.fake_provider.FakePoughkeepsie in qiskit-ibm-runtime v0.23
...
<Class id="qiskit_ibm_runtime.fake_provider.FakePoughkeepsie" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.23/qiskit_ibm_runtime/fake_provider/backends/poughkeepsie/fake_poughkeepsie.py#L39-L128" signature="FakePoughkeepsie" modifiers="class">
  ...
  <Function id="qiskit_ibm_runtime.fake_provider.FakePoughkeepsie.properties" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.23/qiskit_ibm_runtime/fake_provider/backends/poughkeepsie/fake_poughkeepsie.py#L122-L128" signature="properties()">
