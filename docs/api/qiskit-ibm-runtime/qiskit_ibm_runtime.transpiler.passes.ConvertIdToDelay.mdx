...
<Class id="qiskit_ibm_runtime.transpiler.passes.ConvertIdToDelay" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.33/qiskit_ibm_runtime/transpiler/passes/basis/convert_id_to_delay.py#L27-L87" signature="ConvertIdToDelay(durations, gate='sx')" modifiers="class">
