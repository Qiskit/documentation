...
<Class id="qiskit_ibm_runtime.options.ResilienceOptions" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.20/qiskit_ibm_runtime/options/resilience_options.py#L34-L91" signature="ResilienceOptions(noise_amplifier=None, noise_factors=None, extrapolator=None)">
  Resilience options.
