...
<Class id="qiskit_ibm_runtime.options.ExecutionOptions" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.20/qiskit_ibm_runtime/options/execution_options.py#L25-L47" signature="ExecutionOptions(shots=4000, init_qubits=True)">
  ...
  *   **init\_qubits** (`bool`) – Whether to reset the qubits to the ground state for each shot. Default: `True`.
  ...
  <Function id="qiskit_ibm_runtime.options.ExecutionOptions.validate_execution_options" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.20/qiskit_ibm_runtime/options/execution_options.py#L39-L47" signature="static validate_execution_options(execution_options)">
