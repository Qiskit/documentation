...
<Class id="qiskit_ibm_runtime.Session" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.20/qiskit_ibm_runtime/session.py#L40-L336" signature="Session(service=None, backend=None, max_time=None)">
