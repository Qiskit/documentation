...
<span id="qiskit_ibm_runtime.fake_provider.FakeSydney.backend_name" />

### backend\_name

`= 'fake_sydney'`

<span id="qiskit_ibm_runtime.fake_provider.FakeSydney.conf_filename" />

### conf\_filename

`= 'conf_sydney.json'`

<span id="qiskit_ibm_runtime.fake_provider.FakeSydney.defs_filename" />

### defs\_filename

`= 'defs_sydney.json'`

<span id="qiskit_ibm_runtime.fake_provider.FakeSydney.dirname" />

### dirname

`= '/home/runner/work/qiskit-ibm-runtime/qiskit-ibm-runtime/qiskit_ibm_runtime/fake_provider/backends/sydney'`

<span id="qiskit_ibm_runtime.fake_provider.FakeSydney.options" />
...
<span id="qiskit_ibm_runtime.fake_provider.FakeSydney.props_filename" />

### props\_filename

`= 'props_sydney.json'`

<span id="qiskit_ibm_runtime.fake_provider.FakeSydney.version" />
...
<span id="qiskit_ibm_runtime.fake_provider.FakeSydney.configuration" />
...
<span id="qiskit_ibm_runtime.fake_provider.FakeSydney.defaults" />
...
<span id="qiskit_ibm_runtime.fake_provider.FakeSydney.name" />
...
<span id="qiskit_ibm_runtime.fake_provider.FakeSydney.properties" />
...
<span id="qiskit_ibm_runtime.fake_provider.FakeSydney.provider" />
...
<span id="qiskit_ibm_runtime.fake_provider.FakeSydney.run" />
...
<span id="qiskit_ibm_runtime.fake_provider.FakeSydney.set_options" />
...
<span id="qiskit_ibm_runtime.fake_provider.FakeSydney.status" />
