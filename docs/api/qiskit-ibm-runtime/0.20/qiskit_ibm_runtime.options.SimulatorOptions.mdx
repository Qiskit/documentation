...
<Class id="qiskit_ibm_runtime.options.SimulatorOptions" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.20/qiskit_ibm_runtime/options/simulator_options.py#L35-L95" signature="SimulatorOptions(noise_model=None, seed_simulator=None, coupling_map=None, basis_gates=None)">
  ...
  *   **basis\_gates** (`Optional`\[`List`\[`str`]]) – List of basis gate names to unroll to. For example, `['u1', 'u2', 'u3', 'cx']`. If `None`, do not unroll.
  ...
  <Function id="qiskit_ibm_runtime.options.SimulatorOptions.validate_simulator_options" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.20/qiskit_ibm_runtime/options/simulator_options.py#L61-L69" signature="static validate_simulator_options(simulator_options)">
