...
`FakePerth` [GitHub](https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.20/qiskit_ibm_runtime/fake_provider/backends/perth/fake_perth.py#L22-L29 "view source code")
...
<span id="qiskit_ibm_runtime.fake_provider.FakePerth.backend_name" />

### backend\_name

`= 'fake_perth'`

<span id="qiskit_ibm_runtime.fake_provider.FakePerth.conf_filename" />

### conf\_filename

`= 'conf_perth.json'`

<span id="qiskit_ibm_runtime.fake_provider.FakePerth.coupling_map" />

### coupling\_map

Return the `CouplingMap` object

<span id="qiskit_ibm_runtime.fake_provider.FakePerth.defs_filename" />

### defs\_filename

`= 'defs_perth.json'`

<span id="qiskit_ibm_runtime.fake_provider.FakePerth.dirname" />

### dirname

`= '/home/runner/work/qiskit-ibm-runtime/qiskit-ibm-runtime/qiskit_ibm_runtime/fake_provider/backends/perth'`

<span id="qiskit_ibm_runtime.fake_provider.FakePerth.dt" />
...
<span id="qiskit_ibm_runtime.fake_provider.FakePerth.dtm" />
...
<span id="qiskit_ibm_runtime.fake_provider.FakePerth.instruction_durations" />

### instruction\_durations

Return the `InstructionDurations` object.

<span id="qiskit_ibm_runtime.fake_provider.FakePerth.instruction_schedule_map" />

### instruction\_schedule\_map

Return the `InstructionScheduleMap` for the instructions defined in this backend’s target.

<span id="qiskit_ibm_runtime.fake_provider.FakePerth.instructions" />
...
<span id="qiskit_ibm_runtime.fake_provider.FakePerth.max_circuits" />
...
<span id="qiskit_ibm_runtime.fake_provider.FakePerth.meas_map" />
...
<span id="qiskit_ibm_runtime.fake_provider.FakePerth.num_qubits" />
...
<span id="qiskit_ibm_runtime.fake_provider.FakePerth.operation_names" />
...
<span id="qiskit_ibm_runtime.fake_provider.FakePerth.operations" />
...
<span id="qiskit_ibm_runtime.fake_provider.FakePerth.options" />
...
<span id="qiskit_ibm_runtime.fake_provider.FakePerth.props_filename" />

### props\_filename

`= 'props_perth.json'`

<span id="qiskit_ibm_runtime.fake_provider.FakePerth.provider" />
...
<span id="qiskit_ibm_runtime.fake_provider.FakePerth.target" />
...
<span id="qiskit_ibm_runtime.fake_provider.FakePerth.version" />

### version

`= 2`

<span id="qiskit_ibm_runtime.fake_provider.FakePerth.name" />

### name

Name of the backend.

<span id="qiskit_ibm_runtime.fake_provider.FakePerth.description" />

### description

Optional human-readable description.

<span id="qiskit_ibm_runtime.fake_provider.FakePerth.online_date" />

### online\_date

Date that the backend came online.

<span id="qiskit_ibm_runtime.fake_provider.FakePerth.backend_version" />
...
<span id="qiskit_ibm_runtime.fake_provider.FakePerth.acquire_channel" />
...
<span id="qiskit_ibm_runtime.fake_provider.FakePerth.control_channel" />
...
<span id="qiskit_ibm_runtime.fake_provider.FakePerth.drive_channel" />
...
<span id="qiskit_ibm_runtime.fake_provider.FakePerth.measure_channel" />
...
<span id="qiskit_ibm_runtime.fake_provider.FakePerth.qubit_properties" />
...
<span id="qiskit_ibm_runtime.fake_provider.FakePerth.run" />
...
<span id="qiskit_ibm_runtime.fake_provider.FakePerth.set_options" />
