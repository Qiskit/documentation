...
<Class id="qiskit_ibm_runtime.IBMBackend" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.20/qiskit_ibm_runtime/ibm_backend.py#L75-L856" signature="IBMBackend(configuration, service, api_client, instance=None)">
