...
<Class id="qiskit_ibm_runtime.transpiler.passes.scheduling.BlockBasePadder" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.20/qiskit_ibm_runtime/transpiler/passes/scheduling/block_base_padder.py#L38-L633" signature="BlockBasePadder(schedule_idle_qubits=False)">
