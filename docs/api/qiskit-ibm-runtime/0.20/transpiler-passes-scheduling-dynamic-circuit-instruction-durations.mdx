---
title: DynamicCircuitInstructionDurations (v0.20)
description: API reference for qiskit_ibm_runtime.transpiler.passes.scheduling.DynamicCircuitInstructionDurations in qiskit-ibm-runtime v0.20
