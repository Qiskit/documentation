...
<Class id="qiskit_ibm_runtime.IBMBackend" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.22/qiskit_ibm_runtime/ibm_backend.py#L75-L863" signature="IBMBackend(configuration, service, api_client, instance=None)">
