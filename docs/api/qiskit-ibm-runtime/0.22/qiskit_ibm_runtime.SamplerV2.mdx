...
<Class id="qiskit_ibm_runtime.SamplerV2" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.22/qiskit_ibm_runtime/sampler.py#L46-L136" signature="SamplerV2(backend=None, session=None, options=None)">
  ...
  **NotImplementedError** – If “q-ctrl” channel strategy is used.
  ...
  <Function id="qiskit_ibm_runtime.SamplerV2.run" name="run" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.22/qiskit_ibm_runtime/sampler.py#L96-L123" signature="run(pubs, *, shots=None)">
