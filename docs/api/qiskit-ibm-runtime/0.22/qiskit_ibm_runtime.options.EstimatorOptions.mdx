---
title: EstimatorOptions (v0.22)
description: API reference for qiskit_ibm_runtime.options.EstimatorOptions in qiskit-ibm-runtime v0.22
...
<Class id="qiskit_ibm_runtime.options.EstimatorOptions" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.22/qiskit_ibm_runtime/options/estimator_options.py#L35-L125" signature="EstimatorOptions(*args, **kwargs)" modifiers="class">
  ...
  *   **experimental** – Experimental options.
  ...
  <Function id="qiskit_ibm_runtime.options.EstimatorOptions.update" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.22/qiskit_ibm_runtime/options/options.py#L106-L111" signature="update(**kwargs)">
    Update the options.
