...
<Class id="qiskit_ibm_runtime.SamplerV1" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.22/qiskit_ibm_runtime/sampler.py#L139-L291" signature="SamplerV1(backend=None, session=None, options=None)">
