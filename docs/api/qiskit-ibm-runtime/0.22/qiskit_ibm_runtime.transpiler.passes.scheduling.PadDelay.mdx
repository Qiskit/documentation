...
<Class id="qiskit_ibm_runtime.transpiler.passes.scheduling.PadDelay" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.22/qiskit_ibm_runtime/transpiler/passes/scheduling/pad_delay.py#L23-L87" signature="PadDelay(durations, fill_very_end=True, schedule_idle_qubits=False)">
