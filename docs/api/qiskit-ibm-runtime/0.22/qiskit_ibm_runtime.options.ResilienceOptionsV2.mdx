...
<Class id="qiskit_ibm_runtime.options.ResilienceOptionsV2" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.22/qiskit_ibm_runtime/options/resilience_options.py#L38-L101" signature="ResilienceOptionsV2(*args, **kwargs)">
