...
`FakeBogota` [GitHub](https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.21/qiskit_ibm_runtime/fake_provider/backends/bogota/fake_bogota.py#L31-L38 "view source code")
