...
<Class id="qiskit_ibm_runtime.utils.noise_learner_result.LayerError" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.42/qiskit_ibm_runtime/utils/noise_learner_result.py#L136-L349" signature="LayerError(circuit, qubits, error=None)" modifiers="class">
  Bases: `object`
  ...
  **ValueError** – If `circuit`, `qubits`, and `error` have mismatching number of qubits.
  ...
  <Function id="qiskit_ibm_runtime.utils.noise_learner_result.LayerError.draw_swarm" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.42/qiskit_ibm_runtime/utils/noise_learner_result.py#L277-L341" signature="draw_swarm(num_bodies=None, max_rate=None, min_rate=None, connected=None, colors=None, num_bins=None, opacities=0.4, names=None, x_coo=None, marker_size=None, height=500, width=800)">
