...
<Class id="qiskit_ibm_runtime.results.StretchValues" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.49/qiskit_ibm_runtime/results/quantum_program.py#L81-L103" signature="StretchValues(name, value, remainder, expanded_values)" modifiers="class">
  Bases: `object`
