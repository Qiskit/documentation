---
title: draw_zne_extrapolators (v0.42)
description: API reference for qiskit_ibm_runtime.visualization.draw_zne_extrapolators in qiskit-ibm-runtime v0.42
...
<Function id="qiskit_ibm_runtime.visualization.draw_zne_extrapolators" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.42/qiskit_ibm_runtime/visualization/draw_zne.py#L155-L271" signature="draw_zne_extrapolators(result, indices=None, names=None, num_stds=1, max_mag=10, max_std=0.2, height=500, width=1000, colorscale='Aggrnyl')">
