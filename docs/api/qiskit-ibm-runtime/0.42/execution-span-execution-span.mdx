---
title: ExecutionSpan (v0.42)
description: API reference for qiskit_ibm_runtime.execution_span.ExecutionSpan in qiskit-ibm-runtime v0.42
...
<Class id="qiskit_ibm_runtime.execution_span.ExecutionSpan" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.42/qiskit_ibm_runtime/execution_span/execution_span.py#L31-L140" signature="ExecutionSpan(start, stop)" modifiers="class">
  Bases: `ABC`
  ...
  *   **stop** (*datetime*) – The stop time of the span, in UTC.
  ...
  <Function id="qiskit_ibm_runtime.execution_span.ExecutionSpan.contains_pub" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.42/qiskit_ibm_runtime/execution_span/execution_span.py#L115-L125" signature="contains_pub(pub_idx)">
  ...
  <Function id="qiskit_ibm_runtime.execution_span.ExecutionSpan.filter_by_pub" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.42/qiskit_ibm_runtime/execution_span/execution_span.py#L127-L140" signature="filter_by_pub(pub_idx)" modifiers="abstract">
  ...
  <Function id="qiskit_ibm_runtime.execution_span.ExecutionSpan.mask" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.42/qiskit_ibm_runtime/execution_span/execution_span.py#L101-L113" signature="mask(pub_idx)" modifiers="abstract">
