---
title: draw_layer_errors_swarm (v0.42)
description: API reference for qiskit_ibm_runtime.visualization.draw_layer_errors_swarm in qiskit-ibm-runtime v0.42
