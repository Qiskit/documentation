---
title: SamplerOptions (v0.42)
description: API reference for qiskit_ibm_runtime.options.SamplerOptions in qiskit-ibm-runtime v0.42
...
<Class id="qiskit_ibm_runtime.options.SamplerOptions" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.42/qiskit_ibm_runtime/options/sampler_options.py#L27-L57" signature="SamplerOptions(_VERSION=2, max_execution_time=Unset, environment=<factory>, simulator=<factory>, default_shots=Unset, dynamical_decoupling=<factory>, execution=<factory>, twirling=<factory>, experimental=Unset)" modifiers="class">
  ...
  *   **experimental** (*UnsetType | dict*)
  ...
  <Function id="qiskit_ibm_runtime.options.SamplerOptions.update" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.42/qiskit_ibm_runtime/options/options.py#L146-L155" signature="update(**kwargs)">
    Update the options.
