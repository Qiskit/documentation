---
title: LayerNoiseLearningOptions (v0.42)
description: API reference for qiskit_ibm_runtime.options.LayerNoiseLearningOptions in qiskit-ibm-runtime v0.42
