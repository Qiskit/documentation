...
<Class id="qiskit_ibm_runtime.transpiler.passes.scheduling.ALAPScheduleAnalysis" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.33/qiskit_ibm_runtime/transpiler/passes/scheduling/scheduler.py#L438-L655" signature="ALAPScheduleAnalysis(*args, **kwargs)" modifiers="class">
  ...
  *   **block\_ordering\_callable** – A callable used to produce an ordering of the nodes to minimize the number of blocks needed. If not provided, `block_order_op_nodes()` will be used.
  ...
  <Function id="qiskit_ibm_runtime.transpiler.passes.scheduling.ALAPScheduleAnalysis.__call__" signature="__call__(circuit, property_set=None)">
    ...
    *   **circuit** ([*QuantumCircuit*](/api/qiskit/qiskit.circuit.QuantumCircuit "(in Qiskit v1.2)")) – The dag on which the pass is run.
    *   **property\_set** ([*PropertySet*](/api/qiskit/qiskit.passmanager.PropertySet "(in Qiskit v1.2)") *| dict | None*) – Input/output property set. An analysis pass might change the property set in-place.
  ...
  <Function id="qiskit_ibm_runtime.transpiler.passes.scheduling.ALAPScheduleAnalysis.run" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.33/qiskit_ibm_runtime/transpiler/passes/scheduling/scheduler.py#L459-L478" signature="run(dag)">
    ...
    **dag** ([*DAGCircuit*](/api/qiskit/qiskit.dagcircuit.DAGCircuit "(in Qiskit v1.2)"))
