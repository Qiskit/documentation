...
<Class id="qiskit_ibm_runtime.fake_provider.FakeQuebec" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.49/qiskit_ibm_runtime/fake_provider/backends/quebec/fake_quebec.py#L20-L26" signature="FakeQuebec" modifiers="class">
  ...
  **AttributeError** – If a field is specified that’s outside the backend’s options
  ...
  <Attribute id="qiskit_ibm_runtime.fake_provider.FakeQuebec.backend_name">
    Type: `str`

    Default value: `'fake_quebec'`
  ...
  <Attribute id="qiskit_ibm_runtime.fake_provider.FakeQuebec.conf_filename">
    Type: `str`

    Default value: `'conf_quebec.json'`
  ...
  <Attribute id="qiskit_ibm_runtime.fake_provider.FakeQuebec.dirname">
    Type: `str`

    Default value: `'/home/runner/work/qiskit-ibm-runtime/qiskit-ibm-runtime/qiskit_ibm_runtime/fake_provider/backends/quebec'`
  ...
  <Attribute id="qiskit_ibm_runtime.fake_provider.FakeQuebec.props_filename">
    Type: `str`

    Default value: `'props_quebec.json'`
  ...
  <Attribute id="qiskit_ibm_runtime.fake_provider.FakeQuebec.version">
    Default value: `2`
  </Attribute>
