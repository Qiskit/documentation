...
<Class id="qiskit_ibm_runtime.fake_provider.FakeRueschlikon" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.30/qiskit_ibm_runtime/fake_provider/backends/rueschlikon/fake_rueschlikon.py#L22-L75" signature="FakeRueschlikon" modifiers="class">
