...
`SamplerV1(backend=None, session=None, options=None)` [GitHub](https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.21/qiskit_ibm_runtime/sampler.py#L140-L290 "view source code")
...
<span id="qiskit_ibm_runtime.SamplerV1.options" />

### options

Return options values for the sampler. :rtype: `Options` :returns: options

<span id="qiskit_ibm_runtime.SamplerV1.session" />
...
<span id="qiskit_ibm_runtime.SamplerV1.version" />
...
`run(circuits, parameter_values=None, **kwargs)` [GitHub](https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.21/qiskit_ibm_runtime/sampler.py#L210-L238 "view source code")
