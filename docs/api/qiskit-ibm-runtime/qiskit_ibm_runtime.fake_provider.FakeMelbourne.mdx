...
<Class id="qiskit_ibm_runtime.fake_provider.FakeMelbourne" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.24/qiskit_ibm_runtime/fake_provider/backends/melbourne/fake_melbourne.py#L38-L95" signature="FakeMelbourne" modifiers="class">
  ...
  <Function id="qiskit_ibm_runtime.fake_provider.FakeMelbourne.properties" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.24/qiskit_ibm_runtime/fake_provider/backends/melbourne/fake_melbourne.py#L89-L95" signature="properties()">
