...
<Class id="qiskit_ibm_runtime.execution_span.ExecutionSpan" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.50/qiskit_ibm_runtime/execution_span/execution_span.py#L33-L142" signature="ExecutionSpan(start, stop)" modifiers="class">
  Bases: `ABC`
  ...
  *   **stop** (*datetime*) – The stop time of the span, in UTC.
  ...
  <Function id="qiskit_ibm_runtime.execution_span.ExecutionSpan.contains_pub" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.50/qiskit_ibm_runtime/execution_span/execution_span.py#L117-L127" signature="contains_pub(pub_idx)">
  ...
  <Function id="qiskit_ibm_runtime.execution_span.ExecutionSpan.filter_by_pub" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.50/qiskit_ibm_runtime/execution_span/execution_span.py#L129-L142" signature="filter_by_pub(pub_idx)" modifiers="abstract">
  ...
  <Function id="qiskit_ibm_runtime.execution_span.ExecutionSpan.mask" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.50/qiskit_ibm_runtime/execution_span/execution_span.py#L103-L115" signature="mask(pub_idx)" modifiers="abstract">
