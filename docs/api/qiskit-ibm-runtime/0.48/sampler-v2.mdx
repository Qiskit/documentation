---
title: SamplerV2 (v0.48)
description: API reference for qiskit_ibm_runtime.SamplerV2 in qiskit-ibm-runtime v0.48
...
<Class id="qiskit_ibm_runtime.SamplerV2" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.48/qiskit_ibm_runtime/sampler.py#L48-L135" signature="SamplerV2(mode=None, options=None)" modifiers="class">
  ...
  *   **options** (*dict |* [*SamplerOptions*](options-sampler-options "qiskit_ibm_runtime.options.SamplerOptions") *| None*) – Sampler options, see [`qiskit_ibm_runtime.options.SamplerOptions`](options-sampler-options "qiskit_ibm_runtime.options.SamplerOptions") for detailed description.
  ...
  <Attribute id="qiskit_ibm_runtime.SamplerV2.options" attributeTypeHint="SamplerOptions" attributeTypeHintHref="options-sampler-options">
    Return options.
  </Attribute>
  ...
  <Function id="qiskit_ibm_runtime.SamplerV2.backend" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.48/qiskit_ibm_runtime/base_primitive.py#L213-L215" signature="backend()">
  ...
  <Function id="qiskit_ibm_runtime.SamplerV2.run" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.48/qiskit_ibm_runtime/sampler.py#L91-L122" signature="run(pubs, *, shots=None)">
