---
title: FakePrague (v0.48)
description: API reference for qiskit_ibm_runtime.fake_provider.FakePrague in qiskit-ibm-runtime v0.48
...
<Class id="qiskit_ibm_runtime.fake_provider.FakePrague" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.48/qiskit_ibm_runtime/fake_provider/backends/prague/fake_prague.py#L21-L27" signature="FakePrague" modifiers="class">
  Bases: `FakeBackendV2`
  ...
  **AttributeError** – If a field is specified that’s outside the backend’s options
  ...
  <Attribute id="qiskit_ibm_runtime.fake_provider.FakePrague.backend_name" attributeTypeHint="str | None" attributeValue="'fake_prague'" />

  ### conf\_filename

  <Attribute id="qiskit_ibm_runtime.fake_provider.FakePrague.conf_filename" attributeTypeHint="str | None" attributeValue="'conf_prague.json'" />
  ...
  <Attribute id="qiskit_ibm_runtime.fake_provider.FakePrague.dirname" attributeTypeHint="str | None" attributeValue="'/home/runner/work/qiskit-ibm-runtime/qiskit-ibm-runtime/qiskit_ibm_runtime/fake_provider/backends/prague'" />
  ...
  <Attribute id="qiskit_ibm_runtime.fake_provider.FakePrague.props_filename" attributeTypeHint="str | None" attributeValue="'props_prague.json'" />
  ...
  <Function id="qiskit_ibm_runtime.fake_provider.FakePrague.check_faulty" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.48/qiskit_ibm_runtime/fake_provider/fake_backend.py#L158-L190" signature="check_faulty(circuit)">
  ...
  <Function id="qiskit_ibm_runtime.fake_provider.FakePrague.configuration" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.48/qiskit_ibm_runtime/fake_provider/fake_backend.py#L154-L156" signature="configuration()">
  ...
  <Function id="qiskit_ibm_runtime.fake_provider.FakePrague.properties" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.48/qiskit_ibm_runtime/fake_provider/fake_backend.py#L141-L152" signature="properties(refresh=False)">
  ...
  <Function id="qiskit_ibm_runtime.fake_provider.FakePrague.refresh" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.48/qiskit_ibm_runtime/fake_provider/fake_backend.py#L372-L447" signature="refresh(service, use_fractional_gates=False)">
  ...
  <Function id="qiskit_ibm_runtime.fake_provider.FakePrague.run" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.48/qiskit_ibm_runtime/fake_provider/fake_backend.py#L261-L290" signature="run(run_input, **options)">
  ...
  <Function id="qiskit_ibm_runtime.fake_provider.FakePrague.status" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.48/qiskit_ibm_runtime/fake_provider/fake_backend.py#L124-L139" signature="status()">
