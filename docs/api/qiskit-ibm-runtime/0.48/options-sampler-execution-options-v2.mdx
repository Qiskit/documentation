---
title: SamplerExecutionOptionsV2 (v0.48)
description: API reference for qiskit_ibm_runtime.options.SamplerExecutionOptionsV2 in qiskit-ibm-runtime v0.48
