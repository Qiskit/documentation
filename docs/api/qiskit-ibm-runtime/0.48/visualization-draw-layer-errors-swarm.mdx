---
title: draw_layer_errors_swarm (v0.48)
description: API reference for qiskit_ibm_runtime.visualization.draw_layer_errors_swarm in qiskit-ibm-runtime v0.48
...
<Function id="qiskit_ibm_runtime.visualization.draw_layer_errors_swarm" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.48/qiskit_ibm_runtime/visualization/draw_layer_error.py#L269-L422" signature="draw_layer_errors_swarm(layer_errors, num_bodies=None, max_rate=None, min_rate=None, connected=None, colors=None, num_bins=None, opacities=0.4, names=None, x_coo=None, marker_size=None, height=500, width=800)">
  ...
  *   **layer\_errors** (*list\[*[*LayerError*](results-layer-error "qiskit_ibm_runtime.results.LayerError")*]*) – The layer errors to draw.
