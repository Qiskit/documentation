---
title: ConvertToMidCircuitMeasure (v0.48)
description: API reference for qiskit_ibm_runtime.transpiler.passes.ConvertToMidCircuitMeasure in qiskit-ibm-runtime v0.48
...
<Class id="qiskit_ibm_runtime.transpiler.passes.ConvertToMidCircuitMeasure" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.48/qiskit_ibm_runtime/transpiler/passes/basis/convert_mid_circ_meas.py#L28-L78" signature="ConvertToMidCircuitMeasure(*args, **kwargs)" modifiers="class">
  ...
  **ValueError** – If the specifcied `mcm_name` does not conform to the `measure_` pattern or is not contained in the provided target.
  ...
  <Function id="qiskit_ibm_runtime.transpiler.passes.ConvertToMidCircuitMeasure.run" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.48/qiskit_ibm_runtime/transpiler/passes/basis/convert_mid_circ_meas.py#L66-L78" signature="run(dag)">
