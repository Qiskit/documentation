---
title: draw_circuit_schedule_timing (v0.48)
description: API reference for qiskit_ibm_runtime.visualization.draw_circuit_schedule_timing in qiskit-ibm-runtime v0.48
...
<Function id="qiskit_ibm_runtime.visualization.draw_circuit_schedule_timing" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.48/qiskit_ibm_runtime/visualization/draw_circuit_schedule_timings.py#L27-L160" signature="draw_circuit_schedule_timing(circuit_schedule, included_channels=None, filter_readout_channels=False, filter_barriers=False, merge_common_instructions=False, width=1400)">
