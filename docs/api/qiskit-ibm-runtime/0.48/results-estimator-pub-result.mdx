---
title: EstimatorPubResult (v0.48)
description: API reference for qiskit_ibm_runtime.results.EstimatorPubResult in qiskit-ibm-runtime v0.48
...
<Class id="qiskit_ibm_runtime.results.EstimatorPubResult" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.48/qiskit_ibm_runtime/results/estimator_pub.py#L27-L129" signature="EstimatorPubResult(data, metadata=None)" modifiers="class">
