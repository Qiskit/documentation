---
title: QuantumProgram (v0.48)
description: API reference for qiskit_ibm_runtime.quantum_program.QuantumProgram in qiskit-ibm-runtime v0.48
...
<Class id="qiskit_ibm_runtime.quantum_program.QuantumProgram" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.48/qiskit_ibm_runtime/quantum_program/quantum_program.py#L211-L338" signature="QuantumProgram(shots, items=None, noise_maps=None, meas_level='classified', passthrough_data=None)" modifiers="class">
  Bases: `object`
  ...
  *   **passthrough\_data** (*DataTree | None*)
  ...
  <Function id="qiskit_ibm_runtime.quantum_program.QuantumProgram.append_circuit_item" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.48/qiskit_ibm_runtime/quantum_program/quantum_program.py#L259-L283" signature="append_circuit_item(circuit, *, circuit_arguments=None, chunk_size=None)">
    Append a new [`CircuitItem`](quantum-program-circuit-item "qiskit_ibm_runtime.quantum_program.CircuitItem") to this program.
  ...
  <Function id="qiskit_ibm_runtime.quantum_program.QuantumProgram.append_samplex_item" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.48/qiskit_ibm_runtime/quantum_program/quantum_program.py#L285-L329" signature="append_samplex_item(circuit, *, samplex, samplex_arguments=None, shape=None, chunk_size=None)">
    Append a new [`SamplexItem`](quantum-program-samplex-item "qiskit_ibm_runtime.quantum_program.SamplexItem") to this program.
