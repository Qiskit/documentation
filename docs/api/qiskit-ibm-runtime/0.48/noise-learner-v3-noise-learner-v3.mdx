---
title: NoiseLearnerV3 (v0.48)
description: API reference for qiskit_ibm_runtime.noise_learner_v3.NoiseLearnerV3 in qiskit-ibm-runtime v0.48
...
<Class id="qiskit_ibm_runtime.noise_learner_v3.NoiseLearnerV3" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.48/qiskit_ibm_runtime/noise_learner_v3/noise_learner_v3.py#L41-L180" signature="NoiseLearnerV3(mode=None, options=None)" modifiers="class">
  Bases: `object`
  ...
  **References**
  ...
  <Attribute id="qiskit_ibm_runtime.noise_learner_v3.NoiseLearnerV3.options" attributeTypeHint="NoiseLearnerV3Options" attributeTypeHintHref="options-models-noise-learner-v3-options">
  ...
  <Function id="qiskit_ibm_runtime.noise_learner_v3.NoiseLearnerV3.backend" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.48/qiskit_ibm_runtime/noise_learner_v3/noise_learner_v3.py#L178-L180" signature="backend()">
  ...
  <Function id="qiskit_ibm_runtime.noise_learner_v3.NoiseLearnerV3.run" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.48/qiskit_ibm_runtime/noise_learner_v3/noise_learner_v3.py#L103-L176" signature="run(instructions)">
