---
title: SimulatorOptions (v0.48)
description: API reference for qiskit_ibm_runtime.options.SimulatorOptions in qiskit-ibm-runtime v0.48
...
<Class id="qiskit_ibm_runtime.options.SimulatorOptions" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.48/qiskit_ibm_runtime/options/simulator_options.py#L30-L110" signature="SimulatorOptions(noise_model=Unset, seed_simulator=Unset, coupling_map=Unset, basis_gates=Unset)" modifiers="class">
  ...
  *   **basis\_gates** (*UnsetType | list\[str]*)
  ...
  <Attribute id="qiskit_ibm_runtime.options.SimulatorOptions.coupling_map" attributeTypeHint="UnsetType | list[list[int]] | CouplingMap" attributeTypeHintHref="https://quantum.cloud.ibm.com/docs/api/qiskit/qiskit.transpiler.CouplingMap" attributeValue="Unset">
  ...
  <Function id="qiskit_ibm_runtime.options.SimulatorOptions.set_backend" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.48/qiskit_ibm_runtime/options/simulator_options.py#L88-L110" signature="set_backend(backend)">
