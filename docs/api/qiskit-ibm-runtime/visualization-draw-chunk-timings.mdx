...
<Function id="qiskit_ibm_runtime.visualization.draw_chunk_timings" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.48/qiskit_ibm_runtime/visualization/draw_chunk_timings.py#L82-L194" signature="draw_chunk_timings(*timings, names=None, common_start=False, normalize_y=False, line_width=4, show_legend=None, tz=None)">
  ...
  *   **timings** ([*ChunkTiming*](results-chunk-timing "qiskit_ibm_runtime.results.ChunkTiming")) – One or more [`ChunkTiming`](results-chunk-timing "qiskit_ibm_runtime.results.ChunkTiming") collections.
