...
<Function id="qiskit_ibm_runtime.visualization.draw_chunk_timings" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.47/qiskit_ibm_runtime/visualization/draw_chunk_timings.py#L80-L192" signature="draw_chunk_timings(*timings, names=None, common_start=False, normalize_y=False, line_width=4, show_legend=None, tz=None)">
