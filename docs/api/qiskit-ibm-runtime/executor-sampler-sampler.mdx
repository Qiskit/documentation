...
<Class id="qiskit_ibm_runtime.executor_sampler.Sampler" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.50/qiskit_ibm_runtime/executor_sampler/sampler.py#L47-L235" signature="Sampler(mode=None, options=None)" modifiers="class">
  ...
  *   **options** ([*SamplerOptions*](options-models-sampler-options "qiskit_ibm_runtime.options_models.sampler.SamplerOptions")) – Sampler options. See [`SamplerOptions`](options-models-sampler-options "qiskit_ibm_runtime.options_models.SamplerOptions") for all available options.
  ...
  <Function id="qiskit_ibm_runtime.executor_sampler.Sampler.backend" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.50/qiskit_ibm_runtime/executor_sampler/sampler.py#L129-L131" signature="backend()">
  ...
  <Function id="qiskit_ibm_runtime.executor_sampler.Sampler.finalize_options" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.50/qiskit_ibm_runtime/executor_sampler/sampler.py#L171-L182" signature="finalize_options()">
  ...
  <Function id="qiskit_ibm_runtime.executor_sampler.Sampler.find_unique_layers" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.50/qiskit_ibm_runtime/executor_sampler/sampler.py#L142-L169" signature="find_unique_layers(pubs, types='gates')">
  ...
  <Function id="qiskit_ibm_runtime.executor_sampler.Sampler.run" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.50/qiskit_ibm_runtime/executor_sampler/sampler.py#L184-L235" signature="run(pubs, *, shots=None, dry_run=False)">
