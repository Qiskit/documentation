...
<Class id="qiskit_ibm_runtime.fake_provider.FakeKyoto" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.49/qiskit_ibm_runtime/fake_provider/backends/kyoto/fake_kyoto.py#L20-L26" signature="FakeKyoto" modifiers="class">
  ...
  **AttributeError** – If a field is specified that’s outside the backend’s options
  ...
  <Attribute id="qiskit_ibm_runtime.fake_provider.FakeKyoto.backend_name">
    Type: `str`

    Default value: `'fake_kyoto'`
  ...
  <Attribute id="qiskit_ibm_runtime.fake_provider.FakeKyoto.conf_filename">
    Type: `str`

    Default value: `'conf_kyoto.json'`
  ...
  <Attribute id="qiskit_ibm_runtime.fake_provider.FakeKyoto.dirname">
    Type: `str`

    Default value: `'/home/runner/work/qiskit-ibm-runtime/qiskit-ibm-runtime/qiskit_ibm_runtime/fake_provider/backends/kyoto'`
  ...
  <Attribute id="qiskit_ibm_runtime.fake_provider.FakeKyoto.props_filename">
    Type: `str`

    Default value: `'props_kyoto.json'`
  ...
  <Attribute id="qiskit_ibm_runtime.fake_provider.FakeKyoto.version">
    Default value: `2`
  </Attribute>
