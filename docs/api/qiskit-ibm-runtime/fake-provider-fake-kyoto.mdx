...
<Class id="qiskit_ibm_runtime.fake_provider.FakeKyoto" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.48/qiskit_ibm_runtime/fake_provider/backends/kyoto/fake_kyoto.py#L20-L26" signature="FakeKyoto" modifiers="class">
  Bases: `FakeBackendV2`
  ...
  **AttributeError** – If a field is specified that’s outside the backend’s options
  ...
  <Attribute id="qiskit_ibm_runtime.fake_provider.FakeKyoto.backend_name" attributeTypeHint="str | None" attributeValue="'fake_kyoto'" />

  ### conf\_filename

  <Attribute id="qiskit_ibm_runtime.fake_provider.FakeKyoto.conf_filename" attributeTypeHint="str | None" attributeValue="'conf_kyoto.json'" />
  ...
  <Attribute id="qiskit_ibm_runtime.fake_provider.FakeKyoto.dirname" attributeTypeHint="str | None" attributeValue="'/home/runner/work/qiskit-ibm-runtime/qiskit-ibm-runtime/qiskit_ibm_runtime/fake_provider/backends/kyoto'" />
  ...
  <Attribute id="qiskit_ibm_runtime.fake_provider.FakeKyoto.props_filename" attributeTypeHint="str | None" attributeValue="'props_kyoto.json'" />
  ...
  <Function id="qiskit_ibm_runtime.fake_provider.FakeKyoto.check_faulty" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.48/qiskit_ibm_runtime/fake_provider/fake_backend.py#L158-L190" signature="check_faulty(circuit)">
  ...
  <Function id="qiskit_ibm_runtime.fake_provider.FakeKyoto.configuration" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.48/qiskit_ibm_runtime/fake_provider/fake_backend.py#L154-L156" signature="configuration()">
  ...
  <Function id="qiskit_ibm_runtime.fake_provider.FakeKyoto.properties" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.48/qiskit_ibm_runtime/fake_provider/fake_backend.py#L141-L152" signature="properties(refresh=False)">
  ...
  <Function id="qiskit_ibm_runtime.fake_provider.FakeKyoto.refresh" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.48/qiskit_ibm_runtime/fake_provider/fake_backend.py#L372-L447" signature="refresh(service, use_fractional_gates=False)">
  ...
  <Function id="qiskit_ibm_runtime.fake_provider.FakeKyoto.run" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.48/qiskit_ibm_runtime/fake_provider/fake_backend.py#L261-L290" signature="run(run_input, **options)">
  ...
  <Function id="qiskit_ibm_runtime.fake_provider.FakeKyoto.status" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.48/qiskit_ibm_runtime/fake_provider/fake_backend.py#L124-L139" signature="status()">
