...
<Class id="qiskit_ibm_runtime.options_models.NoiseLearnerV3Options" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.50/qiskit_ibm_runtime/options_models/noise_learner_v3.py#L28-L82" signature="NoiseLearnerV3Options" modifiers="pydantic model">
  ...
  *   **extra**: *str = forbid*
  ...
  <Attribute id="qiskit_ibm_runtime.options_models.NoiseLearnerV3Options.max_execution_time" modifiers="field">
    Type: `int` | `None`
  ...
  <Function id="qiskit_ibm_runtime.options_models.NoiseLearnerV3Options.update" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.50/qiskit_ibm_runtime/options_models/base.py#L46-L54" signature="update(**kwargs)">
    Update the options.
