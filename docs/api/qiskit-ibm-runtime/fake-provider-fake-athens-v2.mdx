...
<Class id="qiskit_ibm_runtime.fake_provider.FakeAthensV2" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.49/qiskit_ibm_runtime/fake_provider/backends/athens/fake_athens.py#L20-L26" signature="FakeAthensV2" modifiers="class">
  ...
  **AttributeError** – If a field is specified that’s outside the backend’s options
  ...
  <Attribute id="qiskit_ibm_runtime.fake_provider.FakeAthensV2.backend_name">
    Type: `str`

    Default value: `'fake_athens'`
  ...
  <Attribute id="qiskit_ibm_runtime.fake_provider.FakeAthensV2.conf_filename">
    Type: `str`

    Default value: `'conf_athens.json'`
  ...
  <Attribute id="qiskit_ibm_runtime.fake_provider.FakeAthensV2.dirname">
    Type: `str`

    Default value: `'/home/runner/work/qiskit-ibm-runtime/qiskit-ibm-runtime/qiskit_ibm_runtime/fake_provider/backends/athens'`
  ...
  <Attribute id="qiskit_ibm_runtime.fake_provider.FakeAthensV2.props_filename">
    Type: `str`

    Default value: `'props_athens.json'`
  ...
  <Attribute id="qiskit_ibm_runtime.fake_provider.FakeAthensV2.version">
    Default value: `2`
  </Attribute>
