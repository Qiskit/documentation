---
title: Session (v0.15)
description: API reference for qiskit_ibm_runtime.Session in qiskit-ibm-runtime v0.15
...
<Class id="qiskit_ibm_runtime.Session" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-ibm-runtime/tree/stable/0.15/qiskit_ibm_runtime/session.py" signature="Session(service=None, backend=None, max_time=None)" modifiers="class">
