...
<Class id="qiskit_ibm_runtime.ParameterNamespace" github="https://github.com/qiskit/qiskit-ibm-runtime/tree/stable/0.15/qiskit_ibm_runtime/runtime_program.py" signature="ParameterNamespace(parameters)">
