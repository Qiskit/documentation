...
<Class id="qiskit_ibm_runtime.ParameterNamespace" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-ibm-runtime/tree/stable/0.15/qiskit_ibm_runtime/runtime_program.py" signature="ParameterNamespace(parameters)">
