...
<Class id="qiskit_ibm_runtime.options.TwirlingOptions" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.49/qiskit_ibm_runtime/options/twirling_options.py#L27-L121" signature="TwirlingOptions(enable_gates=Unset, enable_measure=Unset, num_randomizations=Unset, shots_per_randomization=Unset, strategy=Unset)" modifiers="class">
  Bases: `object`
  ...
  *   **strategy** (*UnsetType | Literal\['active', 'active-accum', 'active-circuit', 'all']*)
  ...
  <Attribute id="qiskit_ibm_runtime.options.TwirlingOptions.enable_gates">
    Type: `UnsetType` | `bool`
  ...
  <Attribute id="qiskit_ibm_runtime.options.TwirlingOptions.enable_measure">
    Type: `UnsetType` | `bool`
  ...
  <Attribute id="qiskit_ibm_runtime.options.TwirlingOptions.num_randomizations">
    ...
    <Admonition title="Note" type="note">
      The `shots` value specified in a PUB or in the `run()` method is considered part of the primitive execution interface and therefore is always obeyed. `default_shots`, on the other hand, is considered a IBM Quantum Compute (formerly Qiskit Runtime) specific option. Therefore, the product of `num_randomizations` and `shots_per_randomization` takes precedence over `default_shots`.
    </Admonition>
  </Attribute>

  ### shots\_per\_randomization

  <Attribute id="qiskit_ibm_runtime.options.TwirlingOptions.shots_per_randomization">
    Type: `UnsetType` | `int` | `Literal`\[`'auto'`]
  ...
  <Attribute id="qiskit_ibm_runtime.options.TwirlingOptions.strategy">
