---
title: PecOptions (v0.28)
description: API reference for qiskit_ibm_runtime.options.PecOptions in qiskit-ibm-runtime v0.28
...
<Class id="qiskit_ibm_runtime.options.PecOptions" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.28/qiskit_ibm_runtime/options/pec_options.py#L20-L44" signature="PecOptions(*args, **kwargs)" modifiers="class">
