---
title: ConvertIdToDelay (v0.28)
description: API reference for qiskit_ibm_runtime.transpiler.passes.ConvertIdToDelay in qiskit-ibm-runtime v0.28
...
<Class id="qiskit_ibm_runtime.transpiler.passes.ConvertIdToDelay" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.28/qiskit_ibm_runtime/transpiler/passes/basis/convert_id_to_delay.py#L27-L87" signature="ConvertIdToDelay(durations, gate='sx')" modifiers="class">
  Convert `qiskit.circuit.library.standard_gates.IGate` to a delay of the corresponding length.

  Convert [`qiskit.circuit.library.IGate`](/docs/api/qiskit/qiskit.circuit.library.IGate "(in Qiskit v1.2)") to a Convert [`qiskit.circuit.Delay`](/docs/api/qiskit/circuit#qiskit.circuit.Delay "(in Qiskit v1.2)").
  ...
  *   **gate** (`str`) – Single qubit gate to extract duration from.
  ...
  <Function id="qiskit_ibm_runtime.transpiler.passes.ConvertIdToDelay.run" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.28/qiskit_ibm_runtime/transpiler/passes/basis/convert_id_to_delay.py#L46-L48" signature="run(dag)">
