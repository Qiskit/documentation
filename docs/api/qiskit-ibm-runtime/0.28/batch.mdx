...
<Class id="qiskit_ibm_runtime.Batch" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.28/qiskit_ibm_runtime/batch.py#L24-L139" signature="Batch(service=None, backend=None, max_time=None)" modifiers="class">
  ...
  *   **backend** (`Union`\[`str`, [BackendV1](/docs/api/qiskit/1.4/qiskit.providers.BackendV1), [`BackendV2`](/docs/api/qiskit/qiskit.providers.BackendV2), `None`]) – Instance of `Backend` class or backend string name. Note that passing a backend name is deprecated.
