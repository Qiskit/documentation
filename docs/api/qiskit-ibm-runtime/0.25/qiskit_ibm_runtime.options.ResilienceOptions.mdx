...
<Class id="qiskit_ibm_runtime.options.ResilienceOptions" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.25/qiskit_ibm_runtime/options/resilience_options.py#L104-L141" signature="ResilienceOptions(*args, **kwargs)" modifiers="class">
