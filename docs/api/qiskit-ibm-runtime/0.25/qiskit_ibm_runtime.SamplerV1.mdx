---
title: SamplerV1 (v0.25)
description: API reference for qiskit_ibm_runtime.SamplerV1 in qiskit-ibm-runtime v0.25
...
<Class id="qiskit_ibm_runtime.SamplerV1" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.25/qiskit_ibm_runtime/sampler.py#L170-L322" signature="SamplerV1(backend=None, session=None, options=None)" modifiers="class">
  ...
  *   **options** (`Union`\[`Dict`, [`Options`](qiskit_ibm_runtime.options.Options "qiskit_ibm_runtime.options.options.Options"), `None`]) – Primitive options, see `Options` for detailed description. The `backend` keyword is still supported but is deprecated.
  ...
  <Function id="qiskit_ibm_runtime.SamplerV1.run" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.25/qiskit_ibm_runtime/sampler.py#L242-L270" signature="run(circuits, parameter_values=None, **kwargs)">
  ...
  <Function id="qiskit_ibm_runtime.SamplerV1.set_options" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.25/qiskit_ibm_runtime/base_primitive.py#L426-L434" signature="set_options(**fields)">
