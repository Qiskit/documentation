---
title: FakeRueschlikon (v0.25)
description: API reference for qiskit_ibm_runtime.fake_provider.FakeRueschlikon in qiskit-ibm-runtime v0.25
...
<Class id="qiskit_ibm_runtime.fake_provider.FakeRueschlikon" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.25/qiskit_ibm_runtime/fake_provider/backends/rueschlikon/fake_rueschlikon.py#L21-L74" signature="FakeRueschlikon" modifiers="class">
