---
title: EstimatorV1 (v0.25)
description: API reference for qiskit_ibm_runtime.EstimatorV1 in qiskit-ibm-runtime v0.25
...
<Class id="qiskit_ibm_runtime.EstimatorV1" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.25/qiskit_ibm_runtime/estimator.py#L228-L412" signature="EstimatorV1(backend=None, session=None, options=None)" modifiers="class">
  ...
  *   **options** (`Union`\[`Dict`, [`Options`](options-options "qiskit_ibm_runtime.options.options.Options"), `None`]) – Primitive options, see `Options` for detailed description. The `backend` keyword is still supported but is deprecated.
  ...
  <Function id="qiskit_ibm_runtime.EstimatorV1.run" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.25/qiskit_ibm_runtime/estimator.py#L307-L341" signature="run(circuits, observables, parameter_values=None, **kwargs)">
  ...
  <Function id="qiskit_ibm_runtime.EstimatorV1.set_options" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.25/qiskit_ibm_runtime/base_primitive.py#L426-L434" signature="set_options(**fields)">
