...
<Class id="qiskit_ibm_runtime.fake_provider.FakeArmonkV2" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.49/qiskit_ibm_runtime/fake_provider/backends/armonk/fake_armonk.py#L20-L31" signature="FakeArmonkV2" modifiers="class">
  ...
  **AttributeError** – If a field is specified that’s outside the backend’s options
  ...
  <Attribute id="qiskit_ibm_runtime.fake_provider.FakeArmonkV2.backend_name" attributeTypeHint="str" attributeValue="'fake_armonk'">
    Name of the backend.
  </Attribute>

  ### conf\_filename

  <Attribute id="qiskit_ibm_runtime.fake_provider.FakeArmonkV2.conf_filename" attributeTypeHint="str" attributeValue="'conf_armonk.json'">
  ...
  <Attribute id="qiskit_ibm_runtime.fake_provider.FakeArmonkV2.dirname" attributeTypeHint="str" attributeValue="'/home/runner/work/qiskit-ibm-runtime/qiskit-ibm-runtime/qiskit_ibm_runtime/fake_provider/backends/armonk'">
  ...
  <Attribute id="qiskit_ibm_runtime.fake_provider.FakeArmonkV2.props_filename" attributeTypeHint="str" attributeValue="'props_armonk.json'">
