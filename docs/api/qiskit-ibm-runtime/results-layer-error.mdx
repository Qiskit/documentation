...
<Class id="qiskit_ibm_runtime.results.LayerError" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.50/qiskit_ibm_runtime/results/noise_learner.py#L122-L322" signature="LayerError(circuit, qubits, error=None)" modifiers="class">
  Bases: `object`
