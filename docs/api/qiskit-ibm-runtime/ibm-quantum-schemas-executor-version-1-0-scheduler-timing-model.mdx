...
<Class id="ibm_quantum_schemas.executor.version_1_0.SchedulerTimingModel" isDedicatedPage={true} github="https://github.com/Qiskit/ibm-quantum-schemas/tree/0.12.20260921/ibm_quantum_schemas/executor/version_1_0/models.py#L225-L236" signature="SchedulerTimingModel" modifiers="pydantic model">
  Bases: `BaseModel`
