...
<Class id="ibm_quantum_schemas.executor.version_1_0.SchedulerTimingModel" isDedicatedPage={true} github="https://github.com/Qiskit/ibm-quantum-schemas/tree/0.10.20260723/ibm_quantum_schemas/executor/version_1_0/models.py#L225-L236" signature="SchedulerTimingModel" modifiers="pydantic model">
  ...
  <Attribute id="ibm_quantum_schemas.executor.version_1_0.SchedulerTimingModel.circuit_duration" modifiers="field">
    Type: `int`
  ...
  <Attribute id="ibm_quantum_schemas.executor.version_1_0.SchedulerTimingModel.timing" modifiers="field">
    Type: `str`
