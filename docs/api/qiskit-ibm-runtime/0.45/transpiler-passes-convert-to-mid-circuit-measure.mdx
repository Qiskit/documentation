---
title: ConvertToMidCircuitMeasure (v0.45)
description: API reference for qiskit_ibm_runtime.transpiler.passes.ConvertToMidCircuitMeasure in qiskit-ibm-runtime v0.45
