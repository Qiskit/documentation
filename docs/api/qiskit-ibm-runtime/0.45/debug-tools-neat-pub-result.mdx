---
title: NeatPubResult (v0.45)
description: API reference for qiskit_ibm_runtime.debug_tools.NeatPubResult in qiskit-ibm-runtime v0.45
...
<Class id="qiskit_ibm_runtime.debug_tools.NeatPubResult" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.45/qiskit_ibm_runtime/debug_tools/neat_results.py#L29-L116" signature="NeatPubResult(vals)" modifiers="class">
  Bases: `object`
  ...
  **vals** (*ArrayLike*) – The values in this `NeatPubResult`.
  ...
  <Function id="qiskit_ibm_runtime.debug_tools.NeatPubResult.__mul__" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.45/qiskit_ibm_runtime/debug_tools/neat_results.py#L91-L92" signature="__mul__(other)">
    **Parameters**
