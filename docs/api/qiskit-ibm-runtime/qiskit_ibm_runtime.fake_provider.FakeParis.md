...
`FakeParis` [GitHub](https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.21/qiskit_ibm_runtime/fake_provider/backends/paris/fake_paris.py#L44-L64 "view source code")
