---
title: IBM Quantum Schemas (latest version)
description: API reference for IBM Quantum Schemas in the latest version of qiskit-ibm-runtime
...
<Admonition title="Note" type="note">
  This package is a [separate dependency](https://pypi.org/project/ibm-quantum-schemas/). This documentations refers to version `0.10.20260723`.
</Admonition>
...
*   [Executor v1.1 (`ibm_quantum_schemas.executor.version_1_1`)](executor-1-1)
*   [Executor v2.0 (`ibm_quantum_schemas.executor.version_2_0`)](executor-2-0)
...
*   [NoiseLearnerV3 v0.3 (`ibm_quantum_schemas.noise_learner_v3.version_0_3`)](noise-learner-v3-0-3)
