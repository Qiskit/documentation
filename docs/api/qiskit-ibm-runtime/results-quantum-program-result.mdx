...
<Class id="qiskit_ibm_runtime.results.QuantumProgramResult" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.47/qiskit_ibm_runtime/results/quantum_program.py#L221-L293" signature="QuantumProgramResult(data, metadata=None, passthrough_data=None)" modifiers="class">
  Bases: `object`
  ...
  *   **passthrough\_data** (*DataTree | None*) – Arbitrary nested data passed through execution without modification.
  ...
  <Function id="qiskit_ibm_runtime.results.QuantumProgramResult.__getitem__" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.47/qiskit_ibm_runtime/results/quantum_program.py#L253-L254" signature="__getitem__(idx)">
    **Parameters**
  ...
  <Function id="qiskit_ibm_runtime.results.QuantumProgramResult.__len__" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.47/qiskit_ibm_runtime/results/quantum_program.py#L256-L257" signature="__len__()">
    **Return type**
