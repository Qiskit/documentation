...
`FakeVigo` [GitHub](https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.22/qiskit_ibm_runtime/fake_provider/backends/vigo/fake_vigo.py#L37-L50 "view source code")
