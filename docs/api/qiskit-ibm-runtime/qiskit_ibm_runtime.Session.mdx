...
<Class id="qiskit_ibm_runtime.Session" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.22/qiskit_ibm_runtime/session.py#L47-L365" signature="Session(service=None, backend=None, max_time=None)">
  ...
  **ValueError** – If an input value is invalid.
  ...
  <Function id="qiskit_ibm_runtime.Session.backend" name="backend" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.22/qiskit_ibm_runtime/session.py#L235-L243" signature="backend()">
  ...
  <Function id="qiskit_ibm_runtime.Session.cancel" name="cancel" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.22/qiskit_ibm_runtime/session.py#L221-L225" signature="cancel()">
  ...
  <Function id="qiskit_ibm_runtime.Session.close" name="close" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.22/qiskit_ibm_runtime/session.py#L227-L233" signature="close()">
  ...
  <Function id="qiskit_ibm_runtime.Session.details" name="details" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.22/qiskit_ibm_runtime/session.py#L271-L307" signature="details()">
  ...
  <Function id="qiskit_ibm_runtime.Session.from_id" name="from_id" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.22/qiskit_ibm_runtime/session.py#L327-L352" signature="classmethod from_id(session_id, service=None, backend=None)">
  ...
  <Function id="qiskit_ibm_runtime.Session.run" name="run" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.22/qiskit_ibm_runtime/session.py#L169-L219" signature="run(program_id, inputs, options=None, callback=None, result_decoder=None)">
  ...
  <Function id="qiskit_ibm_runtime.Session.status" name="status" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.22/qiskit_ibm_runtime/session.py#L245-L269" signature="status()">
