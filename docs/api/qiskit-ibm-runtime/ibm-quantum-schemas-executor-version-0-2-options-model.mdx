...
<Class id="ibm_quantum_schemas.executor.version_0_2.OptionsModel" isDedicatedPage={true} github="https://github.com/Qiskit/ibm-quantum-schemas/tree/0.12.20260921/ibm_quantum_schemas/executor/version_0_2/models.py#L56-L89" signature="OptionsModel" modifiers="pydantic model">
  Bases: `BaseModel`
