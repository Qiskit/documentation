...
|                                                                                                                                                                                            |                                                 |
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ----------------------------------------------- |
| [`NoiseLearner`](/docs/api/qiskit-ibm-runtime/noise-learner-noise-learner#qiskit_ibm_runtime.noise_learner.NoiseLearner "qiskit_ibm_runtime.noise_learner.NoiseLearner")(\[mode, options]) | Class for executing noise learning experiments. |
