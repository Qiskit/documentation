...
description: API reference for qiskit_ibm_runtime.RuntimeDecoder in qiskit-ibm-runtime v0.39
...
<Class id="qiskit_ibm_runtime.RuntimeDecoder" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.39/qiskit_ibm_runtime/utils/json.py#L393-L509" signature="RuntimeDecoder(*args, **kwargs)" modifiers="class">
  Bases: `JSONDecoder`
  ...
  *   **kwargs** (*Any*)
  ...
  <Function id="qiskit_ibm_runtime.RuntimeDecoder.object_hook" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.39/qiskit_ibm_runtime/utils/json.py#L401-L509" signature="object_hook(obj)">
