---
title: NoiseLearner (v0.39)
description: API reference for qiskit_ibm_runtime.noise_learner.NoiseLearner in qiskit-ibm-runtime v0.39
...
<Class id="qiskit_ibm_runtime.noise_learner.NoiseLearner" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.39/qiskit_ibm_runtime/noise_learner/noise_learner.py#L48-L268" signature="NoiseLearner(mode=None, options=None)" modifiers="class">
  Bases: `object`
  ...
  **References**
  ...
  <Function id="qiskit_ibm_runtime.noise_learner.NoiseLearner.backend" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.39/qiskit_ibm_runtime/noise_learner/noise_learner.py#L219-L221" signature="backend()">
  ...
  <Function id="qiskit_ibm_runtime.noise_learner.NoiseLearner.run" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.39/qiskit_ibm_runtime/noise_learner/noise_learner.py#L140-L212" signature="run(circuits)">
