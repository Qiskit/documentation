...
| [`EstimatorV2`](estimator-v2 "qiskit_ibm_runtime.EstimatorV2")(\[mode, options])                                        | Class for interacting with Qiskit Runtime Estimator primitive service.            |
| [`Sampler`](sampler "qiskit_ibm_runtime.Sampler")                                                                       | alias of [`SamplerV2`](sampler-v2 "qiskit_ibm_runtime.sampler.SamplerV2")         |
| [`SamplerV2`](sampler-v2 "qiskit_ibm_runtime.SamplerV2")(\[mode, options])                                              | Class for interacting with Qiskit Runtime Sampler primitive service.              |
