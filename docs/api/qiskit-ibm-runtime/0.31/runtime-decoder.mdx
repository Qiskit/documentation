---
title: RuntimeDecoder (v0.31)
description: API reference for qiskit_ibm_runtime.RuntimeDecoder in qiskit-ibm-runtime v0.31
...
<Class id="qiskit_ibm_runtime.RuntimeDecoder" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.31/qiskit_ibm_runtime/utils/json.py#L368-L469" signature="RuntimeDecoder(*args, **kwargs)" modifiers="class">
  ...
  <Function id="qiskit_ibm_runtime.RuntimeDecoder.object_hook" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.31/qiskit_ibm_runtime/utils/json.py#L376-L469" signature="object_hook(obj)">
