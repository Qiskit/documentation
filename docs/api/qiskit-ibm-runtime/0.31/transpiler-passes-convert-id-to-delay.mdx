---
title: ConvertIdToDelay (v0.31)
description: API reference for qiskit_ibm_runtime.transpiler.passes.ConvertIdToDelay in qiskit-ibm-runtime v0.31
...
<Class id="qiskit_ibm_runtime.transpiler.passes.ConvertIdToDelay" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.31/qiskit_ibm_runtime/transpiler/passes/basis/convert_id_to_delay.py#L27-L87" signature="ConvertIdToDelay(durations, gate='sx')" modifiers="class">
  ...
  *   **gate** (`str`) – Single qubit gate to extract duration from.
  ...
  <Function id="qiskit_ibm_runtime.transpiler.passes.ConvertIdToDelay.run" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.31/qiskit_ibm_runtime/transpiler/passes/basis/convert_id_to_delay.py#L46-L48" signature="run(dag)">
