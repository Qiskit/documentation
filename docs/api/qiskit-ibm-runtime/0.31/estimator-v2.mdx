---
title: EstimatorV2 (v0.31)
description: API reference for qiskit_ibm_runtime.EstimatorV2 in qiskit-ibm-runtime v0.31
...
<Class id="qiskit_ibm_runtime.EstimatorV2" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.31/qiskit_ibm_runtime/estimator.py#L46-L197" signature="EstimatorV2(mode=None, options=None)" modifiers="class">
  ...
  **NotImplementedError** – If “q-ctrl” channel strategy is used.
  ...
  <Function id="qiskit_ibm_runtime.EstimatorV2.run" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.31/qiskit_ibm_runtime/estimator.py#L137-L160" signature="run(pubs, *, precision=None)">
