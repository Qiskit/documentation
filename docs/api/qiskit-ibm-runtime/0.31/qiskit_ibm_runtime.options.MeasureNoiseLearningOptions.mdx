---
title: MeasureNoiseLearningOptions (v0.31)
description: API reference for qiskit_ibm_runtime.options.MeasureNoiseLearningOptions in qiskit-ibm-runtime v0.31
...
<Class id="qiskit_ibm_runtime.options.MeasureNoiseLearningOptions" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.31/qiskit_ibm_runtime/options/measure_noise_learning_options.py#L20-L44" signature="MeasureNoiseLearningOptions(*args, **kwargs)" modifiers="class">
