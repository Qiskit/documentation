---
title: LayerNoiseLearningOptions (v0.31)
description: API reference for qiskit_ibm_runtime.options.LayerNoiseLearningOptions in qiskit-ibm-runtime v0.31
...
<Class id="qiskit_ibm_runtime.options.LayerNoiseLearningOptions" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.31/qiskit_ibm_runtime/options/layer_noise_learning_options.py#L28-L82" signature="LayerNoiseLearningOptions(*args, **kwargs)" modifiers="class">
