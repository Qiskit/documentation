---
title: draw_execution_spans (v0.47)
description: API reference for qiskit_ibm_runtime.visualization.draw_execution_spans in qiskit-ibm-runtime v0.47
