---
title: LayerNoiseLearningOptions (v0.47)
description: API reference for qiskit_ibm_runtime.options.LayerNoiseLearningOptions in qiskit-ibm-runtime v0.47
