---
title: QuantumProgram (v0.47)
description: API reference for qiskit_ibm_runtime.quantum_program.QuantumProgram in qiskit-ibm-runtime v0.47
...
<Class id="qiskit_ibm_runtime.quantum_program.QuantumProgram" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.47/qiskit_ibm_runtime/quantum_program/quantum_program.py#L208-L321" signature="QuantumProgram(shots, items=None, noise_maps=None, meas_level='classified', passthrough_data=None)" modifiers="class">
  Bases: `object`
  ...
  *   **meas\_level** (*Literal\['classified', 'kerneled', 'avg\_kerneled']*)
  ...
  <Function id="qiskit_ibm_runtime.quantum_program.QuantumProgram.append_circuit_item" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.47/qiskit_ibm_runtime/quantum_program/quantum_program.py#L242-L266" signature="append_circuit_item(circuit, *, circuit_arguments=None, chunk_size=None)">
