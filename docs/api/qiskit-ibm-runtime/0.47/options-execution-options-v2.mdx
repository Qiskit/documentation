---
title: ExecutionOptionsV2 (v0.47)
description: API reference for qiskit_ibm_runtime.options.ExecutionOptionsV2 in qiskit-ibm-runtime v0.47
...
<Class id="qiskit_ibm_runtime.options.ExecutionOptionsV2" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.47/qiskit_ibm_runtime/options/execution_options.py#L18-L33" signature="ExecutionOptionsV2(init_qubits=Unset, rep_delay=Unset)" modifiers="class">
  Bases: `object`
