---
title: noise_learner (v0.47)
description: API reference for qiskit_ibm_runtime.noise_learner in qiskit-ibm-runtime v0.47
...
|                                                                                                                                                   |                                                 |
| ------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------- |
| [`NoiseLearner`](/docs/api/qiskit-ibm-runtime/0.47/noise-learner-noise-learner "qiskit_ibm_runtime.noise_learner.NoiseLearner")(\[mode, options]) | Class for executing noise learning experiments. |
