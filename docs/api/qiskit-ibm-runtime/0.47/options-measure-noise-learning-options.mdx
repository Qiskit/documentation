---
title: MeasureNoiseLearningOptions (v0.47)
description: API reference for qiskit_ibm_runtime.options.MeasureNoiseLearningOptions in qiskit-ibm-runtime v0.47
...
<Class id="qiskit_ibm_runtime.options.MeasureNoiseLearningOptions" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.47/qiskit_ibm_runtime/options/measure_noise_learning_options.py#L20-L48" signature="MeasureNoiseLearningOptions(num_randomizations=Unset, shots_per_randomization=Unset)" modifiers="class">
  Bases: `object`
