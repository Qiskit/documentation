---
title: EstimatorV2 (v0.47)
description: API reference for qiskit_ibm_runtime.EstimatorV2 in qiskit-ibm-runtime v0.47
...
<Class id="qiskit_ibm_runtime.EstimatorV2" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.47/qiskit_ibm_runtime/estimator.py#L41-L168" signature="EstimatorV2(mode=None, options=None)" modifiers="class">
  ...
  *   **options** (*dict |* [*EstimatorOptions*](options-estimator-options "qiskit_ibm_runtime.options.estimator_options.EstimatorOptions") *| None*) – Estimator options, see `EstimatorOptions` for detailed description.
  ...
  <Function id="qiskit_ibm_runtime.EstimatorV2.backend" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.47/qiskit_ibm_runtime/base_primitive.py#L208-L210" signature="backend()">
  ...
  <Function id="qiskit_ibm_runtime.EstimatorV2.run" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.47/qiskit_ibm_runtime/estimator.py#L122-L145" signature="run(pubs, *, precision=None)">
