---
title: ALAPScheduleAnalysis (v0.47)
description: API reference for qiskit_ibm_runtime.transpiler.passes.scheduling.ALAPScheduleAnalysis in qiskit-ibm-runtime v0.47
...
<Class id="qiskit_ibm_runtime.transpiler.passes.scheduling.ALAPScheduleAnalysis" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.47/qiskit_ibm_runtime/transpiler/passes/scheduling/scheduler.py#L439-L649" signature="ALAPScheduleAnalysis(*args, **kwargs)" modifiers="class">
  ...
  *   **Measurements and resets on disjoint qubits happen simultaneously and are part of the same**
  ...
  <Function id="qiskit_ibm_runtime.transpiler.passes.scheduling.ALAPScheduleAnalysis.run" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.47/qiskit_ibm_runtime/transpiler/passes/scheduling/scheduler.py#L461-L483" signature="run(dag)">
