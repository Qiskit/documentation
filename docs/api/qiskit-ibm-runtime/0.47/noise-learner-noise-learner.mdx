---
title: NoiseLearner (v0.47)
description: API reference for qiskit_ibm_runtime.noise_learner.NoiseLearner in qiskit-ibm-runtime v0.47
...
<Class id="qiskit_ibm_runtime.noise_learner.NoiseLearner" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.47/qiskit_ibm_runtime/noise_learner/noise_learner.py#L46-L275" signature="NoiseLearner(mode=None, options=None)" modifiers="class">
  Bases: `object`
  ...
  **References**
  ...
  <Function id="qiskit_ibm_runtime.noise_learner.NoiseLearner.backend" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.47/qiskit_ibm_runtime/noise_learner/noise_learner.py#L225-L227" signature="backend()">
  ...
  <Function id="qiskit_ibm_runtime.noise_learner.NoiseLearner.run" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.47/qiskit_ibm_runtime/noise_learner/noise_learner.py#L138-L218" signature="run(circuits)">
