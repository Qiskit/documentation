...
<Class id="qiskit_ibm_runtime.models.GateProperties" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.46/qiskit_ibm_runtime/models/backend_properties.py#L92-L161" signature="GateProperties(qubits, gate, parameters, **kwargs)" modifiers="class">
  Bases: `object`
  ...
  *   **kwargs** (*Any*) – Optional additional fields
  ...
  <Function id="qiskit_ibm_runtime.models.GateProperties.from_dict" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.46/qiskit_ibm_runtime/models/backend_properties.py#L124-L141" signature="from_dict(data)" modifiers="classmethod">
  ...
  <Function id="qiskit_ibm_runtime.models.GateProperties.to_dict" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.46/qiskit_ibm_runtime/models/backend_properties.py#L143-L155" signature="to_dict()">
