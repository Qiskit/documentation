...
<Class id="qiskit_ibm_runtime.Batch" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.33/qiskit_ibm_runtime/batch.py#L24-L141" signature="Batch(service=None, backend=None, max_time=None)" modifiers="class">
  ...
  *   **backend** (*str |* [*BackendV1*](/api/qiskit/qiskit.providers.BackendV1 "(in Qiskit v1.2)")  *|*[*BackendV2*](/api/qiskit/qiskit.providers.BackendV2 "(in Qiskit v1.2)") *| None*) – Instance of `Backend` class or backend string name. Note that passing a backend name is deprecated.
