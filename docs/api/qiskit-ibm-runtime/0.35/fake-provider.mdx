...
![Circuit diagram output by the previous code.](/images/api/qiskit-ibm-runtime/0.35/fake_provider-1.avif)
...
![Circuit diagram output by the previous code.](/images/api/qiskit-ibm-runtime/0.35/fake_provider-2.avif)
...
![Histogram output by the previous code.](/images/api/qiskit-ibm-runtime/0.35/fake_provider-3.avif)
