...
<Class id="qiskit_ibm_runtime.transpiler.passes.scheduling.PadDynamicalDecoupling" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.35/qiskit_ibm_runtime/transpiler/passes/scheduling/dynamical_decoupling.py#L40-L589" signature="PadDynamicalDecoupling(*args, **kwargs)" modifiers="class">
  ...
  ![Circuit diagram output by the previous code.](/images/api/qiskit-ibm-runtime/0.35/qiskit_ibm_runtime-transpiler-passes-scheduling-PadDynamicalDecoupling-1.avif)
  ...
  ![Circuit diagram output by the previous code.](/images/api/qiskit-ibm-runtime/0.35/qiskit_ibm_runtime-transpiler-passes-scheduling-PadDynamicalDecoupling-2.avif)
