---
title: Batch (v0.35)
description: API reference for qiskit_ibm_runtime.Batch in qiskit-ibm-runtime v0.35
...
<Class id="qiskit_ibm_runtime.Batch" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.35/qiskit_ibm_runtime/batch.py#L23-L117" signature="Batch(backend=None, max_time=None)" modifiers="class">
  ...
  *   **backend** ([BackendV1](/docs/api/qiskit/1.4/qiskit.providers.BackendV1 "(in Qiskit v1.3)")  *|*[*BackendV2*](/docs/api/qiskit/qiskit.providers.BackendV2 "(in Qiskit v1.3)") *| None*) – Instance of `Backend` class.
  ...
  **ValueError** – If an input value is invalid.
  ...
  <Function id="qiskit_ibm_runtime.Batch.backend" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.35/qiskit_ibm_runtime/session.py#L204-L212" signature="backend()">
  ...
  <Function id="qiskit_ibm_runtime.Batch.cancel" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.35/qiskit_ibm_runtime/session.py#L190-L194" signature="cancel()">
  ...
  <Function id="qiskit_ibm_runtime.Batch.close" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.35/qiskit_ibm_runtime/session.py#L196-L202" signature="close()">
  ...
  <Function id="qiskit_ibm_runtime.Batch.details" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.35/qiskit_ibm_runtime/session.py#L255-L297" signature="details()">
  ...
  <Function id="qiskit_ibm_runtime.Batch.from_id" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.35/qiskit_ibm_runtime/session.py#L317-L350" signature="from_id(session_id, service)" modifiers="classmethod">
  ...
  <Function id="qiskit_ibm_runtime.Batch.status" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.35/qiskit_ibm_runtime/session.py#L214-L239" signature="status()">
  ...
  <Function id="qiskit_ibm_runtime.Batch.usage" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.35/qiskit_ibm_runtime/session.py#L241-L253" signature="usage()">
