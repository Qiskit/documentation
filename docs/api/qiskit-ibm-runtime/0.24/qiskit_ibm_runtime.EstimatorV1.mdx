---
title: EstimatorV1 (v0.24)
description: API reference for qiskit_ibm_runtime.EstimatorV1 in qiskit-ibm-runtime v0.24
...
<Class id="qiskit_ibm_runtime.EstimatorV1" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.24/qiskit_ibm_runtime/estimator.py#L218-L402" signature="EstimatorV1(backend=None, session=None, options=None)" modifiers="class">
  ...
  *   **options** (`Union`\[`Dict`, [`Options`](qiskit_ibm_runtime.options.Options "qiskit_ibm_runtime.options.options.Options"), `None`]) – Primitive options, see `Options` for detailed description. The `backend` keyword is still supported but is deprecated.
  ...
  <Function id="qiskit_ibm_runtime.EstimatorV1.run" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.24/qiskit_ibm_runtime/estimator.py#L297-L331" signature="run(circuits, observables, parameter_values=None, **kwargs)">
  ...
  <Function id="qiskit_ibm_runtime.EstimatorV1.set_options" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.24/qiskit_ibm_runtime/base_primitive.py#L452-L460" signature="set_options(**fields)">
