---
title: ZneOptions (v0.24)
description: API reference for qiskit_ibm_runtime.options.ZneOptions in qiskit-ibm-runtime v0.24
...
<Class id="qiskit_ibm_runtime.options.ZneOptions" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.24/qiskit_ibm_runtime/options/zne_options.py#L35-L116" signature="ZneOptions(*args, **kwargs)" modifiers="class">
