---
title: EstimatorOptions (v0.24)
description: API reference for qiskit_ibm_runtime.options.EstimatorOptions in qiskit-ibm-runtime v0.24
...
<Class id="qiskit_ibm_runtime.options.EstimatorOptions" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.24/qiskit_ibm_runtime/options/estimator_options.py#L35-L139" signature="EstimatorOptions(*args, **kwargs)" modifiers="class">
  ...
  *   **optimization\_level** –
      ...
      *   1: light optimization
      ...
      Refer to the [Configure runtime compilation for Qiskit Runtime](/docs/run/configure-runtime-compilation). for more information about the optimization levels.
  ...
  *   **resilience\_level** –
      ...
      *   2: Medium mitigation costs. Typically reduces bias in estimators but is not guaranteed to be zero bias.
      ...
      Refer to the [Configure error mitigation for Qiskit Runtime](/docs/run/configure-error-mitigation). for more information about the error mitigation methods used at each level.
