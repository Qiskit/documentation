...
`MeasureNoiseLearningOptions(*args, **kwargs)` [GitHub](https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.22/qiskit_ibm_runtime/options/measure_noise_learning_options.py#L20-L40 "view source code")
