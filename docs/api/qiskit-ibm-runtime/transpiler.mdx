...
|                                                                                                                                                                     |                                                                                               |
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------- |
| [`ConvertIdToDelay`](qiskit_ibm_runtime.transpiler.passes.ConvertIdToDelay "qiskit_ibm_runtime.transpiler.passes.ConvertIdToDelay")(\*args, \*\*kwargs)             | Convert `qiskit.circuit.library.standard_gates.IGate` to a delay of the corresponding length. |
