---
title: FakeRueschlikon (v0.29)
description: API reference for qiskit_ibm_runtime.fake_provider.FakeRueschlikon in qiskit-ibm-runtime v0.29
...
<Class id="qiskit_ibm_runtime.fake_provider.FakeRueschlikon" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.29/qiskit_ibm_runtime/fake_provider/backends/rueschlikon/fake_rueschlikon.py#L22-L75" signature="FakeRueschlikon" modifiers="class">
