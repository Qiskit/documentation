---
title: FakeProviderForBackendV2 (v0.29)
description: API reference for qiskit_ibm_runtime.fake_provider.FakeProviderForBackendV2 in qiskit-ibm-runtime v0.29
