---
title: ExecutionOptions (v0.26)
description: API reference for qiskit_ibm_runtime.options.ExecutionOptions in qiskit-ibm-runtime v0.26
...
<Class id="qiskit_ibm_runtime.options.ExecutionOptions" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.26/qiskit_ibm_runtime/options/execution_options.py#L37-L49" signature="ExecutionOptions(*args, **kwargs)" modifiers="class">
