...
<Class id="qiskit_ibm_runtime.EstimatorV1" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.26/qiskit_ibm_runtime/estimator.py#L234-L422" signature="EstimatorV1(backend=None, session=None, options=None)" modifiers="class">
  ...
  <Admonition title="Deprecated since version 0.23" type="danger">
    The `EstimatorV1` primitives have been deprecated in 0.23, released on April 15, 2024. See the [V2 migration guide](/docs/api/migration-guides/v2-primitives). for more details. The `EstimatorV1` support will be removed no earlier than July 15, 2024.
  </Admonition>
