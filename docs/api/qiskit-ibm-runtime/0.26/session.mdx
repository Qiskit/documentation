...
<Class id="qiskit_ibm_runtime.Session" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.26/qiskit_ibm_runtime/session.py#L48-L412" signature="Session(service=None, backend=None, max_time=None)" modifiers="class">
  ...
  *   **backend** (`Union`\[`str`, [BackendV1](/docs/api/qiskit/1.4/qiskit.providers.BackendV1 "(in Qiskit v1.1)"), [`BackendV2`](/docs/api/qiskit/qiskit.providers.BackendV2 "(in Qiskit v1.1)"), `None`]) – Instance of `Backend` class or string name of backend. Note that passing a backend name is deprecated.
