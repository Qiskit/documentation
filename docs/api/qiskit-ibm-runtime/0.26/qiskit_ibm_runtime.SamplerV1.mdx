---
title: SamplerV1 (v0.26)
description: API reference for qiskit_ibm_runtime.SamplerV1 in qiskit-ibm-runtime v0.26
...
<Class id="qiskit_ibm_runtime.SamplerV1" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.26/qiskit_ibm_runtime/sampler.py#L178-L334" signature="SamplerV1(backend=None, session=None, options=None)" modifiers="class">
  Class for interacting with Qiskit Runtime Sampler primitive service.

  <Admonition title="Deprecated since version 0.23" type="danger">
    The `SamplerV1` primitives have been deprecated in 0.23, released on April 15, 2024. See the [V2 migration guide](/api/migration-guides/v2-primitives). for more details. The `SamplerV1` support will be removed no earlier than July 15, 2024.
  </Admonition>
  ...
  *   **options** (`Union`\[`Dict`, [`Options`](qiskit_ibm_runtime.options.Options "qiskit_ibm_runtime.options.options.Options"), `None`]) – Primitive options, see `Options` for detailed description. The `backend` keyword is still supported but is deprecated.
  ...
  <Function id="qiskit_ibm_runtime.SamplerV1.run" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.26/qiskit_ibm_runtime/sampler.py#L256-L283" signature="run(circuits, parameter_values=None, **kwargs)">
    ...
    **Returns**
    ...
    Submitted job. The result of the job is an instance of [`qiskit.primitives.SamplerResult`](/api/qiskit/qiskit.primitives.SamplerResult "(in Qiskit v1.1)").
  ...
  <Function id="qiskit_ibm_runtime.SamplerV1.set_options" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.26/qiskit_ibm_runtime/base_primitive.py#L465-L473" signature="set_options(**fields)">
