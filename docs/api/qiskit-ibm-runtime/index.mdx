---
title: IBM Quantum Compute client API documentation (latest version)
...
*   [Client-side Sampler (`qiskit_ibm_runtime.executor_sampler`)](executor-sampler)
*   [Client-side Estimator (`qiskit_ibm_runtime.executor_estimator`)](executor-estimator)
...
*   [Vendor-specific circuit instructions (`qiskit_ibm_runtime.circuit.library`)](circuit-library)
