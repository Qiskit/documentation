---
title: FakeArmonkV2 (v0.19)
description: API reference for qiskit_ibm_runtime.fake_provider.FakeArmonkV2 in qiskit-ibm-runtime v0.19
...
<Class id="qiskit_ibm_runtime.fake_provider.FakeArmonkV2" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-ibm-runtime/tree/stable/0.19/qiskit_ibm_runtime/fake_provider/backends/armonk/fake_armonk.py" signature="FakeArmonkV2" modifiers="class">
  ...
  <Function id="qiskit_ibm_runtime.fake_provider.FakeArmonkV2.acquire_channel" signature="acquire_channel(qubit)">
  ...
  <Function id="qiskit_ibm_runtime.fake_provider.FakeArmonkV2.control_channel" signature="control_channel(qubits)">
  ...
  <Function id="qiskit_ibm_runtime.fake_provider.FakeArmonkV2.drive_channel" signature="drive_channel(qubit)">
  ...
  <Function id="qiskit_ibm_runtime.fake_provider.FakeArmonkV2.measure_channel" signature="measure_channel(qubit)">
  ...
  <Function id="qiskit_ibm_runtime.fake_provider.FakeArmonkV2.run" signature="run(run_input, **options)">
