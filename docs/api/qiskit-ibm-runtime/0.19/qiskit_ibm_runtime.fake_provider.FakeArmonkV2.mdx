...
<span id="qiskit_ibm_runtime.fake_provider.FakeArmonkV2.backend_name" />

### backend\_name

`= 'fake_armonk'`

<span id="qiskit_ibm_runtime.fake_provider.FakeArmonkV2.conf_filename" />

### conf\_filename

`= 'conf_armonk.json'`

<span id="qiskit_ibm_runtime.fake_provider.FakeArmonkV2.coupling_map" />

### coupling\_map

Return the `CouplingMap` object

<span id="qiskit_ibm_runtime.fake_provider.FakeArmonkV2.defs_filename" />

### defs\_filename

`= 'defs_armonk.json'`

<span id="qiskit_ibm_runtime.fake_provider.FakeArmonkV2.dirname" />

### dirname

`= '/home/runner/work/qiskit-ibm-runtime/qiskit-ibm-runtime/qiskit_ibm_runtime/fake_provider/backends/armonk'`

<span id="qiskit_ibm_runtime.fake_provider.FakeArmonkV2.dt" />
...
<span id="qiskit_ibm_runtime.fake_provider.FakeArmonkV2.dtm" />
...
<span id="qiskit_ibm_runtime.fake_provider.FakeArmonkV2.instruction_durations" />

### instruction\_durations

Return the `InstructionDurations` object.

<span id="qiskit_ibm_runtime.fake_provider.FakeArmonkV2.instruction_schedule_map" />

### instruction\_schedule\_map

Return the `InstructionScheduleMap` for the instructions defined in this backend’s target.

<span id="qiskit_ibm_runtime.fake_provider.FakeArmonkV2.instructions" />
...
<span id="qiskit_ibm_runtime.fake_provider.FakeArmonkV2.max_circuits" />
...
<span id="qiskit_ibm_runtime.fake_provider.FakeArmonkV2.meas_map" />
...
<span id="qiskit_ibm_runtime.fake_provider.FakeArmonkV2.num_qubits" />
...
<span id="qiskit_ibm_runtime.fake_provider.FakeArmonkV2.operation_names" />
...
<span id="qiskit_ibm_runtime.fake_provider.FakeArmonkV2.operations" />
...
<span id="qiskit_ibm_runtime.fake_provider.FakeArmonkV2.options" />
...
<span id="qiskit_ibm_runtime.fake_provider.FakeArmonkV2.props_filename" />

### props\_filename

`= 'props_armonk.json'`

<span id="qiskit_ibm_runtime.fake_provider.FakeArmonkV2.provider" />
...
<span id="qiskit_ibm_runtime.fake_provider.FakeArmonkV2.target" />
...
<span id="qiskit_ibm_runtime.fake_provider.FakeArmonkV2.version" />

### version

`= 2`

<span id="qiskit_ibm_runtime.fake_provider.FakeArmonkV2.name" />

### name

Name of the backend.

<span id="qiskit_ibm_runtime.fake_provider.FakeArmonkV2.description" />

### description

Optional human-readable description.

<span id="qiskit_ibm_runtime.fake_provider.FakeArmonkV2.online_date" />

### online\_date

Date that the backend came online.

<span id="qiskit_ibm_runtime.fake_provider.FakeArmonkV2.backend_version" />
...
<span id="qiskit_ibm_runtime.fake_provider.FakeArmonkV2.acquire_channel" />
...
<span id="qiskit_ibm_runtime.fake_provider.FakeArmonkV2.qubit_properties" />
...
<span id="qiskit_ibm_runtime.fake_provider.FakeArmonkV2.set_options" />
