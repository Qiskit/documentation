...
<Class id="qiskit_ibm_runtime.fake_provider.FakeSantiagoV2" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-ibm-runtime/tree/stable/0.19/qiskit_ibm_runtime/fake_provider/backends/santiago/fake_santiago.py" signature="FakeSantiagoV2" modifiers="class">
  ...
  <Function id="qiskit_ibm_runtime.fake_provider.FakeSantiagoV2.run" signature="run(run_input, **options)">
