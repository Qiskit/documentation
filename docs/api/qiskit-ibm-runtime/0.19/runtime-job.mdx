---
title: RuntimeJob (v0.19)
description: API reference for qiskit_ibm_runtime.RuntimeJob in qiskit-ibm-runtime v0.19
...
<Class id="qiskit_ibm_runtime.RuntimeJob" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-ibm-runtime/tree/stable/0.19/qiskit_ibm_runtime/runtime_job.py" signature="RuntimeJob(backend, api_client, client_params, job_id, program_id, service, params=None, creation_date=None, user_callback=None, result_decoder=None, image='', session_id=None, tags=None)" modifiers="class">
  ...
  *   **tags** (`Optional`\[`List`]) – Tags assigned to the job.
  ...
  <Function id="qiskit_ibm_runtime.RuntimeJob.properties" signature="properties(refresh=False)">
  ...
  <Function id="qiskit_ibm_runtime.RuntimeJob.queue_info" signature="queue_info()">
  ...
  <Function id="qiskit_ibm_runtime.RuntimeJob.queue_position" signature="queue_position(refresh=False)">
