---
title: FakeCairo (v0.19)
description: API reference for qiskit_ibm_runtime.fake_provider.FakeCairo in qiskit-ibm-runtime v0.19
...
<Class id="qiskit_ibm_runtime.fake_provider.FakeCairo" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-ibm-runtime/tree/stable/0.19/qiskit_ibm_runtime/fake_provider/backends/cairo/fake_cairo.py" signature="FakeCairo" modifiers="class">
  ...
  *   **time\_alive** (*int*) – time to wait before returning result
  ...
  <Function id="qiskit_ibm_runtime.fake_provider.FakeCairo.defaults" signature="defaults()">
  ...
  <Function id="qiskit_ibm_runtime.fake_provider.FakeCairo.properties" signature="properties()">
  ...
  <Function id="qiskit_ibm_runtime.fake_provider.FakeCairo.run" signature="run(run_input, **kwargs)">
