...
<Class id="qiskit_ibm_runtime.fake_provider.FakeManhattanV2" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-ibm-runtime/tree/stable/0.19/qiskit_ibm_runtime/fake_provider/backends/manhattan/fake_manhattan.py" signature="FakeManhattanV2" modifiers="class">
  ...
  <Function id="qiskit_ibm_runtime.fake_provider.FakeManhattanV2.run" signature="run(run_input, **options)">
