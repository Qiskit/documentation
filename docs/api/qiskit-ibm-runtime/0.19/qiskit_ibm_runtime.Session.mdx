...
<Class id="qiskit_ibm_runtime.Session" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-ibm-runtime/tree/stable/0.19/qiskit_ibm_runtime/session.py" signature="Session(service=None, backend=None, max_time=None)">
  ...
  **ValueError** – If an input value is invalid.
  ...
  <Function id="qiskit_ibm_runtime.Session.backend" name="backend" signature="backend()">
  ...
  <Function id="qiskit_ibm_runtime.Session.cancel" name="cancel" signature="cancel()">
  ...
  <Function id="qiskit_ibm_runtime.Session.close" name="close" signature="close()">
  ...
  <Function id="qiskit_ibm_runtime.Session.details" name="details" signature="details()">
  ...
  <Function id="qiskit_ibm_runtime.Session.from_id" name="from_id" signature="classmethod from_id(session_id, service=None, backend=None)">
  ...
  <Function id="qiskit_ibm_runtime.Session.run" name="run" signature="run(program_id, inputs, options=None, callback=None, result_decoder=None)">
  ...
  <Function id="qiskit_ibm_runtime.Session.status" name="status" signature="status()">
