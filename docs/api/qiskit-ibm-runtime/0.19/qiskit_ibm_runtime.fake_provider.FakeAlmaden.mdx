---
title: FakeAlmaden (v0.19)
description: API reference for qiskit_ibm_runtime.fake_provider.FakeAlmaden in qiskit-ibm-runtime v0.19
...
<Class id="qiskit_ibm_runtime.fake_provider.FakeAlmaden" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-ibm-runtime/tree/stable/0.19/qiskit_ibm_runtime/fake_provider/backends/almaden/fake_almaden.py" signature="FakeAlmaden" modifiers="class">
  ...
  *   **time\_alive** (*int*) – time to wait before returning result
  ...
  <Function id="qiskit_ibm_runtime.fake_provider.FakeAlmaden.properties" signature="properties()">
  ...
  <Function id="qiskit_ibm_runtime.fake_provider.FakeAlmaden.run" signature="run(run_input, **kwargs)">
