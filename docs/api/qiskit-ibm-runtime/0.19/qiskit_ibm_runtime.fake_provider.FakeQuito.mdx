...
<Class id="qiskit_ibm_runtime.fake_provider.FakeQuito" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-ibm-runtime/tree/stable/0.19/qiskit_ibm_runtime/fake_provider/backends/quito/fake_quito.py" signature="FakeQuito" modifiers="class">
  ...
  *   **time\_alive** (*int*) – time to wait before returning result
  ...
  <Function id="qiskit_ibm_runtime.fake_provider.FakeQuito.defaults" signature="defaults()">
  ...
  <Function id="qiskit_ibm_runtime.fake_provider.FakeQuito.properties" signature="properties()">
  ...
  <Function id="qiskit_ibm_runtime.fake_provider.FakeQuito.run" signature="run(run_input, **kwargs)">
