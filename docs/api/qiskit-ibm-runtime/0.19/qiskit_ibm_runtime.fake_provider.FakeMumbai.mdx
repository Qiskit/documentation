---
title: FakeMumbai (v0.19)
description: API reference for qiskit_ibm_runtime.fake_provider.FakeMumbai in qiskit-ibm-runtime v0.19
...
<Class id="qiskit_ibm_runtime.fake_provider.FakeMumbai" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-ibm-runtime/tree/stable/0.19/qiskit_ibm_runtime/fake_provider/backends/mumbai/fake_mumbai.py" signature="FakeMumbai" modifiers="class">
