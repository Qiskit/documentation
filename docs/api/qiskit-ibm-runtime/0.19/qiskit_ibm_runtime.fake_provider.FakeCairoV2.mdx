...
<Class id="qiskit_ibm_runtime.fake_provider.FakeCairoV2" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-ibm-runtime/tree/stable/0.19/qiskit_ibm_runtime/fake_provider/backends/cairo/fake_cairo.py" signature="FakeCairoV2" modifiers="class">
  ...
  <Function id="qiskit_ibm_runtime.fake_provider.FakeCairoV2.run" signature="run(run_input, **options)">
