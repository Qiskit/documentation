...
<Class id="qiskit_ibm_runtime.fake_provider.FakeBogota" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-ibm-runtime/tree/stable/0.19/qiskit_ibm_runtime/fake_provider/backends/bogota/fake_bogota.py" signature="FakeBogota">
