---
title: FakeMelbourne (v0.19)
description: API reference for qiskit_ibm_runtime.fake_provider.FakeMelbourne in qiskit-ibm-runtime v0.19
...
<Class id="qiskit_ibm_runtime.fake_provider.FakeMelbourne" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-ibm-runtime/tree/stable/0.19/qiskit_ibm_runtime/fake_provider/backends/melbourne/fake_melbourne.py" signature="FakeMelbourne" modifiers="class">
