...
<Class id="qiskit_ibm_runtime.fake_provider.FakeGuadalupeV2" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-ibm-runtime/tree/stable/0.19/qiskit_ibm_runtime/fake_provider/backends/guadalupe/fake_guadalupe.py" signature="FakeGuadalupeV2" modifiers="class">
  ...
  <Function id="qiskit_ibm_runtime.fake_provider.FakeGuadalupeV2.run" signature="run(run_input, **options)">
