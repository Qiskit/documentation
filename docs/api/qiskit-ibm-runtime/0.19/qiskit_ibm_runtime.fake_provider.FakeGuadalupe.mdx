...
<Class id="qiskit_ibm_runtime.fake_provider.FakeGuadalupe" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-ibm-runtime/tree/stable/0.19/qiskit_ibm_runtime/fake_provider/backends/guadalupe/fake_guadalupe.py" signature="FakeGuadalupe" modifiers="class">
