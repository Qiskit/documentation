---
title: FakeBoeblingen (v0.19)
description: API reference for qiskit_ibm_runtime.fake_provider.FakeBoeblingen in qiskit-ibm-runtime v0.19
...
<Class id="qiskit_ibm_runtime.fake_provider.FakeBoeblingen" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-ibm-runtime/tree/stable/0.19/qiskit_ibm_runtime/fake_provider/backends/boeblingen/fake_boeblingen.py" signature="FakeBoeblingen" modifiers="class">
  ...
  *   **time\_alive** (*int*) – time to wait before returning result
  ...
  <Function id="qiskit_ibm_runtime.fake_provider.FakeBoeblingen.defaults" signature="defaults()">
  ...
  <Function id="qiskit_ibm_runtime.fake_provider.FakeBoeblingen.properties" signature="properties()">
  ...
  <Function id="qiskit_ibm_runtime.fake_provider.FakeBoeblingen.run" signature="run(run_input, **kwargs)">
