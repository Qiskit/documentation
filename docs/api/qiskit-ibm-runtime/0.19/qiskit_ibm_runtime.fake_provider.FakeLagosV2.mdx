---
title: FakeLagosV2 (v0.19)
description: API reference for qiskit_ibm_runtime.fake_provider.FakeLagosV2 in qiskit-ibm-runtime v0.19
...
<Class id="qiskit_ibm_runtime.fake_provider.FakeLagosV2" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-ibm-runtime/tree/stable/0.19/qiskit_ibm_runtime/fake_provider/backends/lagos/fake_lagos.py" signature="FakeLagosV2" modifiers="class">
  ...
  <Function id="qiskit_ibm_runtime.fake_provider.FakeLagosV2.run" signature="run(run_input, **options)">
