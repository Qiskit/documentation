---
title: FakePoughkeepsieV2 (v0.19)
description: API reference for qiskit_ibm_runtime.fake_provider.FakePoughkeepsieV2 in qiskit-ibm-runtime v0.19
...
<Class id="qiskit_ibm_runtime.fake_provider.FakePoughkeepsieV2" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-ibm-runtime/tree/stable/0.19/qiskit_ibm_runtime/fake_provider/backends/poughkeepsie/fake_poughkeepsie.py" signature="FakePoughkeepsieV2" modifiers="class">
  ...
  <Function id="qiskit_ibm_runtime.fake_provider.FakePoughkeepsieV2.run" signature="run(run_input, **options)">
