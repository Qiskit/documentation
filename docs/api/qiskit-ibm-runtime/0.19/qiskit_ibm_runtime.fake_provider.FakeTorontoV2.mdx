...
<Class id="qiskit_ibm_runtime.fake_provider.FakeTorontoV2" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-ibm-runtime/tree/stable/0.19/qiskit_ibm_runtime/fake_provider/backends/toronto/fake_toronto.py" signature="FakeTorontoV2" modifiers="class">
  ...
  <Function id="qiskit_ibm_runtime.fake_provider.FakeTorontoV2.run" signature="run(run_input, **options)">
