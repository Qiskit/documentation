---
title: FakeOurense (v0.19)
description: API reference for qiskit_ibm_runtime.fake_provider.FakeOurense in qiskit-ibm-runtime v0.19
...
<Class id="qiskit_ibm_runtime.fake_provider.FakeOurense" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-ibm-runtime/tree/stable/0.19/qiskit_ibm_runtime/fake_provider/backends/ourense/fake_ourense.py" signature="FakeOurense" modifiers="class">
