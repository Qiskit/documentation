---
title: FakeLondon (v0.19)
description: API reference for qiskit_ibm_runtime.fake_provider.FakeLondon in qiskit-ibm-runtime v0.19
...
<Class id="qiskit_ibm_runtime.fake_provider.FakeLondon" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-ibm-runtime/tree/stable/0.19/qiskit_ibm_runtime/fake_provider/backends/london/fake_london.py" signature="FakeLondon" modifiers="class">
  ...
  *   **time\_alive** (*int*) – time to wait before returning result
  ...
  <Function id="qiskit_ibm_runtime.fake_provider.FakeLondon.properties" signature="properties()">
  ...
  <Function id="qiskit_ibm_runtime.fake_provider.FakeLondon.run" signature="run(run_input, **kwargs)">
