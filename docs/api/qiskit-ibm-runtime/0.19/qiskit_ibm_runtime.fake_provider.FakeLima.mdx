---
title: FakeLima (v0.19)
description: API reference for qiskit_ibm_runtime.fake_provider.FakeLima in qiskit-ibm-runtime v0.19
...
<Class id="qiskit_ibm_runtime.fake_provider.FakeLima" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-ibm-runtime/tree/stable/0.19/qiskit_ibm_runtime/fake_provider/backends/lima/fake_lima.py" signature="FakeLima" modifiers="class">
  ...
  *   **time\_alive** (*int*) – time to wait before returning result
  ...
  <Function id="qiskit_ibm_runtime.fake_provider.FakeLima.defaults" signature="defaults()">
  ...
  <Function id="qiskit_ibm_runtime.fake_provider.FakeLima.properties" signature="properties()">
  ...
  <Function id="qiskit_ibm_runtime.fake_provider.FakeLima.run" signature="run(run_input, **kwargs)">
