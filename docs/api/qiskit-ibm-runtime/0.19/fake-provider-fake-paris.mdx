---
title: FakeParis (v0.19)
description: API reference for qiskit_ibm_runtime.fake_provider.FakeParis in qiskit-ibm-runtime v0.19
...
<Class id="qiskit_ibm_runtime.fake_provider.FakeParis" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-ibm-runtime/tree/stable/0.19/qiskit_ibm_runtime/fake_provider/backends/paris/fake_paris.py" signature="FakeParis" modifiers="class">
