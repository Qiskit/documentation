...
<Class id="qiskit_ibm_runtime.Executor" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.50/qiskit_ibm_runtime/executor/executor.py#L40-L181" signature="Executor(mode=None, options=None)" modifiers="class">
  Bases: `object`
  ...
  **TypeError** – If `options` is not a valid type.
  ...
  <Function id="qiskit_ibm_runtime.Executor.backend" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.50/qiskit_ibm_runtime/executor/executor.py#L110-L112" signature="backend()">
  ...
  <Function id="qiskit_ibm_runtime.Executor.run" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.50/qiskit_ibm_runtime/executor/executor.py#L123-L181" signature="run(program, dry_run=False)">
