---
title: IBMBackend (v0.16)
description: API reference for qiskit_ibm_runtime.IBMBackend in qiskit-ibm-runtime v0.16
...
<Class id="qiskit_ibm_runtime.IBMBackend" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-ibm-runtime/tree/stable/0.16/qiskit_ibm_runtime/ibm_backend.py" signature="IBMBackend(configuration, service, api_client, instance=None)" modifiers="class">
