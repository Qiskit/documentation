...
<Class id="qiskit_ibm_runtime.Sampler" github="https://github.com/qiskit/qiskit-ibm-runtime/tree/stable/0.16/qiskit_ibm_runtime/sampler.py" signature="Sampler(backend=None, session=None, options=None)">
