...
<Class id="qiskit_ibm_runtime.fake_provider.FakeGeneva" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.49/qiskit_ibm_runtime/fake_provider/backends/geneva/fake_geneva.py#L21-L27" signature="FakeGeneva" modifiers="class">
  ...
  **AttributeError** – If a field is specified that’s outside the backend’s options
  ...
  <Attribute id="qiskit_ibm_runtime.fake_provider.FakeGeneva.backend_name">
    Type: `str`

    Default value: `'fake_geneva'`
  ...
  <Attribute id="qiskit_ibm_runtime.fake_provider.FakeGeneva.conf_filename">
    Type: `str`

    Default value: `'conf_geneva.json'`
  ...
  <Attribute id="qiskit_ibm_runtime.fake_provider.FakeGeneva.dirname">
    Type: `str`

    Default value: `'/home/runner/work/qiskit-ibm-runtime/qiskit-ibm-runtime/qiskit_ibm_runtime/fake_provider/backends/geneva'`
  ...
  <Attribute id="qiskit_ibm_runtime.fake_provider.FakeGeneva.props_filename">
    Type: `str`

    Default value: `'props_geneva.json'`
  ...
  <Attribute id="qiskit_ibm_runtime.fake_provider.FakeGeneva.version">
    Default value: `2`
  </Attribute>
