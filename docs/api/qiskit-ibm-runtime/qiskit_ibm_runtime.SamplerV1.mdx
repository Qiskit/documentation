...
<Class id="qiskit_ibm_runtime.SamplerV1" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.23/qiskit_ibm_runtime/sampler.py#L140-L292" signature="SamplerV1(backend=None, session=None, options=None)">
  ...
  *   **options** (`Union`\[`Dict`, [`Options`](qiskit_ibm_runtime.options.Options "qiskit_ibm_runtime.options.options.Options"), `None`]) – Primitive options, see `Options` for detailed description. The `backend` keyword is still supported but is deprecated.
  ...
  <Attribute id="qiskit_ibm_runtime.SamplerV1.options" name="options">
    Return options values for the sampler. :rtype: `Options` :returns: options
  </Attribute>

  ### session

  <Attribute id="qiskit_ibm_runtime.SamplerV1.session" name="session">
  ...
  <Attribute id="qiskit_ibm_runtime.SamplerV1.version" name="version" attributeValue="= 1" />

  ## Methods

  ### run

  <Function id="qiskit_ibm_runtime.SamplerV1.run" name="run" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.23/qiskit_ibm_runtime/sampler.py#L212-L240" signature="run(circuits, parameter_values=None, **kwargs)">
  ...
  <Function id="qiskit_ibm_runtime.SamplerV1.set_options" name="set_options" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.23/qiskit_ibm_runtime/base_primitive.py#L437-L445" signature="set_options(**fields)">
