...
<Class id="qiskit_ibm_runtime.execution_span.ExecutionSpans" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.48/qiskit_ibm_runtime/execution_span/execution_spans.py#L28-L145" signature="ExecutionSpans(spans)" modifiers="class">
  Bases: `object`
  ...
  **spans** (*Iterable\[*[*ExecutionSpan*](execution-span-execution-span "qiskit_ibm_runtime.execution_span.ExecutionSpan")*]*)
  ...
  <Function id="qiskit_ibm_runtime.execution_span.ExecutionSpans.__getitem__" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.48/qiskit_ibm_runtime/execution_span/execution_spans.py#L61-L66" signature="__getitem__(idxs: int) → ExecutionSpan" extraSignatures={["__getitem__(idxs: slice | list[int]) → ExecutionSpans"]} />

  ### \_\_len\_\_

  <Function id="qiskit_ibm_runtime.execution_span.ExecutionSpans.__len__" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.48/qiskit_ibm_runtime/execution_span/execution_spans.py#L52-L53" signature="__len__()">
    **Return type**
  ...
  <Function id="qiskit_ibm_runtime.execution_span.ExecutionSpans.draw" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.48/qiskit_ibm_runtime/execution_span/execution_spans.py#L122-L145" signature="draw(name=None, normalize_y=False, line_width=4)">
  ...
  <Function id="qiskit_ibm_runtime.execution_span.ExecutionSpans.filter_by_pub" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.48/qiskit_ibm_runtime/execution_span/execution_spans.py#L97-L105" signature="filter_by_pub(pub_idx)">
  ...
  <Function id="qiskit_ibm_runtime.execution_span.ExecutionSpans.sort" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.48/qiskit_ibm_runtime/execution_span/execution_spans.py#L107-L120" signature="sort(inplace=True)">
