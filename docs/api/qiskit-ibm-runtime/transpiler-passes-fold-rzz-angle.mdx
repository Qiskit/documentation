...
<Class id="qiskit_ibm_runtime.transpiler.passes.FoldRzzAngle" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.48/qiskit_ibm_runtime/transpiler/passes/basis/fold_rzz_angle.py#L47-L274" signature="FoldRzzAngle(*args, **kwargs)" modifiers="class">
  ...
  <Function id="qiskit_ibm_runtime.transpiler.passes.FoldRzzAngle.run" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.48/qiskit_ibm_runtime/transpiler/passes/basis/fold_rzz_angle.py#L72-L75" signature="run(dag)">
