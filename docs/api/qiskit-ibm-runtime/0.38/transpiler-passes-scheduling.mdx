---
title: scheduling (v0.38)
description: API reference for qiskit_ibm_runtime.transpiler.passes.scheduling in qiskit-ibm-runtime v0.38
...
![Circuit diagram output by the previous code.](/docs/images/api/qiskit-ibm-runtime/0.38/qiskit_ibm_runtime-transpiler-passes-scheduling-1.avif)
...
![Circuit diagram output by the previous code.](/docs/images/api/qiskit-ibm-runtime/0.38/qiskit_ibm_runtime-transpiler-passes-scheduling-2.avif)
...
![Circuit diagram output by the previous code.](/docs/images/api/qiskit-ibm-runtime/0.38/qiskit_ibm_runtime-transpiler-passes-scheduling-3.avif)
...
![Circuit diagram output by the previous code.](/docs/images/api/qiskit-ibm-runtime/0.38/qiskit_ibm_runtime-transpiler-passes-scheduling-4.avif)
...
![Circuit diagram output by the previous code.](/docs/images/api/qiskit-ibm-runtime/0.38/qiskit_ibm_runtime-transpiler-passes-scheduling-5.avif)
...
![Circuit diagram output by the previous code.](/docs/images/api/qiskit-ibm-runtime/0.38/qiskit_ibm_runtime-transpiler-passes-scheduling-6.avif)
...
![Circuit diagram output by the previous code.](/docs/images/api/qiskit-ibm-runtime/0.38/qiskit_ibm_runtime-transpiler-passes-scheduling-7.avif)
...
![Circuit diagram output by the previous code.](/docs/images/api/qiskit-ibm-runtime/0.38/qiskit_ibm_runtime-transpiler-passes-scheduling-8.avif)
...
![Circuit diagram output by the previous code.](/docs/images/api/qiskit-ibm-runtime/0.38/qiskit_ibm_runtime-transpiler-passes-scheduling-9.avif)
...
![Circuit diagram output by the previous code.](/docs/images/api/qiskit-ibm-runtime/0.38/qiskit_ibm_runtime-transpiler-passes-scheduling-10.avif)
...
![Circuit diagram output by the previous code.](/docs/images/api/qiskit-ibm-runtime/0.38/qiskit_ibm_runtime-transpiler-passes-scheduling-11.avif)
...
![Circuit diagram output by the previous code.](/docs/images/api/qiskit-ibm-runtime/0.38/qiskit_ibm_runtime-transpiler-passes-scheduling-12.avif)
...
![Circuit diagram output by the previous code.](/docs/images/api/qiskit-ibm-runtime/0.38/qiskit_ibm_runtime-transpiler-passes-scheduling-13.avif)
...
<Admonition title="Note" type="note">
  ...
  ![Circuit diagram output by the previous code.](/docs/images/api/qiskit-ibm-runtime/0.38/qiskit_ibm_runtime-transpiler-passes-scheduling-14.avif)
</Admonition>
