...
![Circuit diagram output by the previous code.](/docs/images/api/qiskit-ibm-runtime/qiskit_ibm_runtime-transpiler-passes-scheduling-1.avif)
...
![Circuit diagram output by the previous code.](/docs/images/api/qiskit-ibm-runtime/qiskit_ibm_runtime-transpiler-passes-scheduling-2.avif)

When compiling a circuit with Qiskit, it is more efficient and more robust to perform all the transformations in a single transpilation. This has been done above by extending Qiskit’s preset pass managers. For example, Qiskit’s [`transpile()`](/docs/api/qiskit/compiler#qiskit.compiler.transpile "(in Qiskit v1.4)") function internally builds its pass set by using `generate_preset_pass_manager()`. This returns instances of [`StagedPassManager`](/docs/api/qiskit/qiskit.transpiler.StagedPassManager "(in Qiskit v1.4)"), which can be extended.
...
![Circuit diagram output by the previous code.](/docs/images/api/qiskit-ibm-runtime/qiskit_ibm_runtime-transpiler-passes-scheduling-3.avif)

The [`IBMBackend`](ibm-backend "qiskit_ibm_runtime.IBMBackend") configures a translation plugin `IBMTranslationPlugin` to automatically apply transformations and optimizations for IBM hardware backends when invoking [`transpile()`](/docs/api/qiskit/compiler#qiskit.compiler.transpile "(in Qiskit v1.4)"). This will automatically convert all old style `c_if` conditioned gates to new-style control-flow. We may then schedule the transpiled circuit without further modification.
...
![Circuit diagram output by the previous code.](/docs/images/api/qiskit-ibm-runtime/qiskit_ibm_runtime-transpiler-passes-scheduling-4.avif)

If you are not using the transpiler plugin stages to work around this please manually run the pass [qiskit.transpiler.passes.ConvertConditionsToIfOps](/docs/api/qiskit/1.4/qiskit.transpiler.passes.ConvertConditionsToIfOps "(in Qiskit v1.4)") prior to your scheduling pass. This is only necessary in Qiskit 1.x.
...
![Circuit diagram output by the previous code.](/docs/images/api/qiskit-ibm-runtime/qiskit_ibm_runtime-transpiler-passes-scheduling-5.avif)
...
![Circuit diagram output by the previous code.](/docs/images/api/qiskit-ibm-runtime/qiskit_ibm_runtime-transpiler-passes-scheduling-6.avif)
...
![Circuit diagram output by the previous code.](/docs/images/api/qiskit-ibm-runtime/qiskit_ibm_runtime-transpiler-passes-scheduling-7.avif)
...
![Circuit diagram output by the previous code.](/docs/images/api/qiskit-ibm-runtime/qiskit_ibm_runtime-transpiler-passes-scheduling-8.avif)
...
![Circuit diagram output by the previous code.](/docs/images/api/qiskit-ibm-runtime/qiskit_ibm_runtime-transpiler-passes-scheduling-9.avif)
...
![Circuit diagram output by the previous code.](/docs/images/api/qiskit-ibm-runtime/qiskit_ibm_runtime-transpiler-passes-scheduling-10.avif)
...
![Circuit diagram output by the previous code.](/docs/images/api/qiskit-ibm-runtime/qiskit_ibm_runtime-transpiler-passes-scheduling-11.avif)
...
![Circuit diagram output by the previous code.](/docs/images/api/qiskit-ibm-runtime/qiskit_ibm_runtime-transpiler-passes-scheduling-12.avif)
...
![Circuit diagram output by the previous code.](/docs/images/api/qiskit-ibm-runtime/qiskit_ibm_runtime-transpiler-passes-scheduling-13.avif)
...
![Circuit diagram output by the previous code.](/docs/images/api/qiskit-ibm-runtime/qiskit_ibm_runtime-transpiler-passes-scheduling-14.avif)
...
![Circuit diagram output by the previous code.](/docs/images/api/qiskit-ibm-runtime/qiskit_ibm_runtime-transpiler-passes-scheduling-15.avif)
...
![Circuit diagram output by the previous code.](/docs/images/api/qiskit-ibm-runtime/qiskit_ibm_runtime-transpiler-passes-scheduling-16.avif)
...
<Admonition title="Note" type="note">
  ...
  ![Circuit diagram output by the previous code.](/docs/images/api/qiskit-ibm-runtime/qiskit_ibm_runtime-transpiler-passes-scheduling-17.avif)
</Admonition>
