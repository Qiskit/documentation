...
<Class id="qiskit_ibm_runtime.EstimatorV2" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.45/qiskit_ibm_runtime/estimator.py#L44-L174" signature="EstimatorV2(mode=None, options=None)" modifiers="class">
  ...
  *   **options** (*dict |* [*EstimatorOptions*](options-estimator-options "qiskit_ibm_runtime.options.EstimatorOptions") *| None*) – Estimator options, see `EstimatorOptions` for detailed description.
  ...
  <Function id="qiskit_ibm_runtime.EstimatorV2.backend" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.45/qiskit_ibm_runtime/base_primitive.py#L210-L212" signature="backend()">
  ...
  <Function id="qiskit_ibm_runtime.EstimatorV2.run" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.45/qiskit_ibm_runtime/estimator.py#L127-L150" signature="run(pubs, *, precision=None)">
