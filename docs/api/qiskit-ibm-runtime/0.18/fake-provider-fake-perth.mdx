---
title: FakePerth (v0.18)
description: API reference for qiskit_ibm_runtime.fake_provider.FakePerth in qiskit-ibm-runtime v0.18
...
<Class id="qiskit_ibm_runtime.fake_provider.FakePerth" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-ibm-runtime/tree/stable/0.18/qiskit_ibm_runtime/fake_provider/backends/perth/fake_perth.py" signature="FakePerth" modifiers="class">
  ...
  <Function id="qiskit_ibm_runtime.fake_provider.FakePerth.run" signature="run(run_input, **options)">
