---
title: FakeMelbourneV2 (v0.18)
description: API reference for qiskit_ibm_runtime.fake_provider.FakeMelbourneV2 in qiskit-ibm-runtime v0.18
...
<Class id="qiskit_ibm_runtime.fake_provider.FakeMelbourneV2" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-ibm-runtime/tree/stable/0.18/qiskit_ibm_runtime/fake_provider/backends/melbourne/fake_melbourne.py" signature="FakeMelbourneV2" modifiers="class">
  ...
  <Function id="qiskit_ibm_runtime.fake_provider.FakeMelbourneV2.run" signature="run(run_input, **options)">
