...
`FakeManhattan` [GitHub](https://github.com/qiskit/qiskit-ibm-runtime/tree/stable/0.18/qiskit_ibm_runtime/fake_provider/backends/manhattan/fake_manhattan.py "view source code")
