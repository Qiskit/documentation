---
title: FakeMontreal (v0.18)
description: API reference for qiskit_ibm_runtime.fake_provider.FakeMontreal in qiskit-ibm-runtime v0.18
...
<Class id="qiskit_ibm_runtime.fake_provider.FakeMontreal" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-ibm-runtime/tree/stable/0.18/qiskit_ibm_runtime/fake_provider/backends/montreal/fake_montreal.py" signature="FakeMontreal" modifiers="class">
  ...
  *   **time\_alive** (*int*) – time to wait before returning result
  ...
  <Function id="qiskit_ibm_runtime.fake_provider.FakeMontreal.defaults" signature="defaults()">
  ...
  <Function id="qiskit_ibm_runtime.fake_provider.FakeMontreal.properties" signature="properties()">
  ...
  <Function id="qiskit_ibm_runtime.fake_provider.FakeMontreal.run" signature="run(run_input, **kwargs)">
