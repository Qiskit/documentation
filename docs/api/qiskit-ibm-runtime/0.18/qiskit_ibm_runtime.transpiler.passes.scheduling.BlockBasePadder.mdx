...
<Class id="qiskit_ibm_runtime.transpiler.passes.scheduling.BlockBasePadder" github="https://github.com/qiskit/qiskit-ibm-runtime/tree/stable/0.18/qiskit_ibm_runtime/transpiler/passes/scheduling/block_base_padder.py" signature="BlockBasePadder(schedule_idle_qubits=False)">
