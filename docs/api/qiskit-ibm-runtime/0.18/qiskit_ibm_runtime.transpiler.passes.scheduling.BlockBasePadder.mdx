---
title: BlockBasePadder (v0.18)
description: API reference for qiskit_ibm_runtime.transpiler.passes.scheduling.BlockBasePadder in qiskit-ibm-runtime v0.18
...
<Class id="qiskit_ibm_runtime.transpiler.passes.scheduling.BlockBasePadder" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-ibm-runtime/tree/stable/0.18/qiskit_ibm_runtime/transpiler/passes/scheduling/block_base_padder.py" signature="BlockBasePadder(schedule_idle_qubits=False)" modifiers="class">
  ...
  <Function id="qiskit_ibm_runtime.transpiler.passes.scheduling.BlockBasePadder.run" signature="run(dag)">
