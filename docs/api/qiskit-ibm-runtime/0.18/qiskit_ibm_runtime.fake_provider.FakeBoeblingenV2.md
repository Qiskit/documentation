...
`FakeBoeblingenV2` [GitHub](https://github.com/qiskit/qiskit-ibm-runtime/tree/stable/0.18/qiskit_ibm_runtime/fake_provider/backends/boeblingen/fake_boeblingen.py "view source code")
