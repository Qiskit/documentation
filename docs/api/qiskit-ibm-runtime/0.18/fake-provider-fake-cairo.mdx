---
title: FakeCairo (v0.18)
description: API reference for qiskit_ibm_runtime.fake_provider.FakeCairo in qiskit-ibm-runtime v0.18
...
<Class id="qiskit_ibm_runtime.fake_provider.FakeCairo" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-ibm-runtime/tree/stable/0.18/qiskit_ibm_runtime/fake_provider/backends/cairo/fake_cairo.py" signature="FakeCairo" modifiers="class">
