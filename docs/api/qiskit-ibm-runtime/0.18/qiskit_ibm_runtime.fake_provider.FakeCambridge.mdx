---
title: FakeCambridge (v0.18)
description: API reference for qiskit_ibm_runtime.fake_provider.FakeCambridge in qiskit-ibm-runtime v0.18
...
<Class id="qiskit_ibm_runtime.fake_provider.FakeCambridge" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-ibm-runtime/tree/stable/0.18/qiskit_ibm_runtime/fake_provider/backends/cambridge/fake_cambridge.py" signature="FakeCambridge" modifiers="class">
  ...
  *   **time\_alive** (*int*) – time to wait before returning result
  ...
  <Function id="qiskit_ibm_runtime.fake_provider.FakeCambridge.properties" signature="properties()">
  ...
  <Function id="qiskit_ibm_runtime.fake_provider.FakeCambridge.run" signature="run(run_input, **kwargs)">
