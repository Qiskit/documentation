...
<Class id="qiskit_ibm_runtime.fake_provider.FakeMontrealV2" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-ibm-runtime/tree/stable/0.18/qiskit_ibm_runtime/fake_provider/backends/montreal/fake_montreal.py" signature="FakeMontrealV2" modifiers="class">
  ...
  <Function id="qiskit_ibm_runtime.fake_provider.FakeMontrealV2.run" signature="run(run_input, **options)">
