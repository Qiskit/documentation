---
title: FakeManila (v0.18)
description: API reference for qiskit_ibm_runtime.fake_provider.FakeManila in qiskit-ibm-runtime v0.18
...
<Class id="qiskit_ibm_runtime.fake_provider.FakeManila" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-ibm-runtime/tree/stable/0.18/qiskit_ibm_runtime/fake_provider/backends/manila/fake_manila.py" signature="FakeManila" modifiers="class">
  ...
  *   **time\_alive** (*int*) – time to wait before returning result
  ...
  <Function id="qiskit_ibm_runtime.fake_provider.FakeManila.defaults" signature="defaults()">
  ...
  <Function id="qiskit_ibm_runtime.fake_provider.FakeManila.properties" signature="properties()">
  ...
  <Function id="qiskit_ibm_runtime.fake_provider.FakeManila.run" signature="run(run_input, **kwargs)">
