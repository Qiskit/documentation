---
title: FakeManhattan (v0.18)
description: API reference for qiskit_ibm_runtime.fake_provider.FakeManhattan in qiskit-ibm-runtime v0.18
...
<Class id="qiskit_ibm_runtime.fake_provider.FakeManhattan" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-ibm-runtime/tree/stable/0.18/qiskit_ibm_runtime/fake_provider/backends/manhattan/fake_manhattan.py" signature="FakeManhattan" modifiers="class">
