...
<Class id="qiskit_ibm_runtime.fake_provider.FakeLimaV2" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-ibm-runtime/tree/stable/0.18/qiskit_ibm_runtime/fake_provider/backends/lima/fake_lima.py" signature="FakeLimaV2" modifiers="class">
  ...
  <Function id="qiskit_ibm_runtime.fake_provider.FakeLimaV2.run" signature="run(run_input, **options)">
