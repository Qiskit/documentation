...
`FakeRueschlikon` [GitHub](https://github.com/qiskit/qiskit-ibm-runtime/tree/stable/0.18/qiskit_ibm_runtime/fake_provider/backends/rueschlikon/fake_rueschlikon.py "view source code")
