---
title: FakeParisV2 (v0.18)
description: API reference for qiskit_ibm_runtime.fake_provider.FakeParisV2 in qiskit-ibm-runtime v0.18
...
<Class id="qiskit_ibm_runtime.fake_provider.FakeParisV2" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-ibm-runtime/tree/stable/0.18/qiskit_ibm_runtime/fake_provider/backends/paris/fake_paris.py" signature="FakeParisV2" modifiers="class">
  ...
  <Function id="qiskit_ibm_runtime.fake_provider.FakeParisV2.run" signature="run(run_input, **options)">
