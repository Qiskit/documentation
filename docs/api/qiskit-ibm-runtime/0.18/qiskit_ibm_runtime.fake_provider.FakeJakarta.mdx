...
<Class id="qiskit_ibm_runtime.fake_provider.FakeJakarta" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-ibm-runtime/tree/stable/0.18/qiskit_ibm_runtime/fake_provider/backends/jakarta/fake_jakarta.py" signature="FakeJakarta">
