---
title: FakeParis (v0.18)
description: API reference for qiskit_ibm_runtime.fake_provider.FakeParis in qiskit-ibm-runtime v0.18
...
<Class id="qiskit_ibm_runtime.fake_provider.FakeParis" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-ibm-runtime/tree/stable/0.18/qiskit_ibm_runtime/fake_provider/backends/paris/fake_paris.py" signature="FakeParis" modifiers="class">
  ...
  *   **time\_alive** (*int*) – time to wait before returning result
  ...
  <Function id="qiskit_ibm_runtime.fake_provider.FakeParis.defaults" signature="defaults()">
  ...
  <Function id="qiskit_ibm_runtime.fake_provider.FakeParis.properties" signature="properties()">
  ...
  <Function id="qiskit_ibm_runtime.fake_provider.FakeParis.run" signature="run(run_input, **kwargs)">
