---
title: FakeOslo (v0.18)
description: API reference for qiskit_ibm_runtime.fake_provider.FakeOslo in qiskit-ibm-runtime v0.18
...
<Class id="qiskit_ibm_runtime.fake_provider.FakeOslo" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-ibm-runtime/tree/stable/0.18/qiskit_ibm_runtime/fake_provider/backends/oslo/fake_oslo.py" signature="FakeOslo" modifiers="class">
  ...
  <Function id="qiskit_ibm_runtime.fake_provider.FakeOslo.run" signature="run(run_input, **options)">
