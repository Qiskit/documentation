---
title: FakeLondonV2 (v0.18)
description: API reference for qiskit_ibm_runtime.fake_provider.FakeLondonV2 in qiskit-ibm-runtime v0.18
...
<Class id="qiskit_ibm_runtime.fake_provider.FakeLondonV2" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-ibm-runtime/tree/stable/0.18/qiskit_ibm_runtime/fake_provider/backends/london/fake_london.py" signature="FakeLondonV2" modifiers="class">
  ...
  <Function id="qiskit_ibm_runtime.fake_provider.FakeLondonV2.run" signature="run(run_input, **options)">
