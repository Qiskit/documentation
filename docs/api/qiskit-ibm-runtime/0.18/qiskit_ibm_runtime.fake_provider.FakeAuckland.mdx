---
title: FakeAuckland (v0.18)
description: API reference for qiskit_ibm_runtime.fake_provider.FakeAuckland in qiskit-ibm-runtime v0.18
...
<Class id="qiskit_ibm_runtime.fake_provider.FakeAuckland" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-ibm-runtime/tree/stable/0.18/qiskit_ibm_runtime/fake_provider/backends/auckland/fake_auckland.py" signature="FakeAuckland" modifiers="class">
  ...
  <Function id="qiskit_ibm_runtime.fake_provider.FakeAuckland.run" signature="run(run_input, **options)">
