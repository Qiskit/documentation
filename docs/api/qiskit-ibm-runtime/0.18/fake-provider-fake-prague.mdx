---
title: FakePrague (v0.18)
description: API reference for qiskit_ibm_runtime.fake_provider.FakePrague in qiskit-ibm-runtime v0.18
...
<Class id="qiskit_ibm_runtime.fake_provider.FakePrague" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-ibm-runtime/tree/stable/0.18/qiskit_ibm_runtime/fake_provider/backends/prague/fake_prague.py" signature="FakePrague" modifiers="class">
  ...
  <Function id="qiskit_ibm_runtime.fake_provider.FakePrague.run" signature="run(run_input, **options)">
