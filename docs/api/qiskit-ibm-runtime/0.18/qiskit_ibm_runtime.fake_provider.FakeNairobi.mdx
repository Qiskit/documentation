...
<Class id="qiskit_ibm_runtime.fake_provider.FakeNairobi" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-ibm-runtime/tree/stable/0.18/qiskit_ibm_runtime/fake_provider/backends/nairobi/fake_nairobi.py" signature="FakeNairobi" modifiers="class">
  ...
  *   **time\_alive** (*int*) – time to wait before returning result
  ...
  <Function id="qiskit_ibm_runtime.fake_provider.FakeNairobi.defaults" signature="defaults()">
  ...
  <Function id="qiskit_ibm_runtime.fake_provider.FakeNairobi.properties" signature="properties()">
  ...
  <Function id="qiskit_ibm_runtime.fake_provider.FakeNairobi.run" signature="run(run_input, **kwargs)">
