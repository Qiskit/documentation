...
<Class id="qiskit_ibm_runtime.QiskitRuntimeService" github="https://github.com/qiskit/qiskit-ibm-runtime/tree/stable/0.18/qiskit_ibm_runtime/qiskit_runtime_service.py" signature="QiskitRuntimeService(channel=None, token=None, url=None, filename=None, name=None, instance=None, proxies=None, verify=None, channel_strategy=None)">
  ...
  **IBMInputValueError** – If an input is invalid.
  ...
  <Function id="qiskit_ibm_runtime.QiskitRuntimeService.backends" name="backends" signature="backends(name=None, min_num_qubits=None, instance=None, dynamic_circuits=None, filters=None, **kwargs)">
