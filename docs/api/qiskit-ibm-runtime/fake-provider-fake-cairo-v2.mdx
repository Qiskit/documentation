...
<Class id="qiskit_ibm_runtime.fake_provider.FakeCairoV2" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.49/qiskit_ibm_runtime/fake_provider/backends/cairo/fake_cairo.py#L20-L26" signature="FakeCairoV2" modifiers="class">
  ...
  **AttributeError** – If a field is specified that’s outside the backend’s options
  ...
  <Attribute id="qiskit_ibm_runtime.fake_provider.FakeCairoV2.backend_name">
    Type: `str`

    Default value: `'fake_cairo'`
  ...
  <Attribute id="qiskit_ibm_runtime.fake_provider.FakeCairoV2.conf_filename">
    Type: `str`

    Default value: `'conf_cairo.json'`
  ...
  <Attribute id="qiskit_ibm_runtime.fake_provider.FakeCairoV2.dirname">
    Type: `str`

    Default value: `'/home/runner/work/qiskit-ibm-runtime/qiskit-ibm-runtime/qiskit_ibm_runtime/fake_provider/backends/cairo'`
  ...
  <Attribute id="qiskit_ibm_runtime.fake_provider.FakeCairoV2.props_filename">
    Type: `str`

    Default value: `'props_cairo.json'`
  ...
  <Attribute id="qiskit_ibm_runtime.fake_provider.FakeCairoV2.version">
    Default value: `2`
  </Attribute>
