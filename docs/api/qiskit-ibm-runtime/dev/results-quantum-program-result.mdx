...
<Class id="qiskit_ibm_runtime.results.QuantumProgramResult" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/main/qiskit_ibm_runtime/results/quantum_program.py#L136-L215" signature="QuantumProgramResult(data, metadata=None, passthrough_data=None)" modifiers="class">
  Bases: `QuantumProgramResult`
  ...
  *   **passthrough\_data** (*DataTree | None*) – Arbitrary nested data passed through execution without modification.
  ...
  <Function id="qiskit_ibm_runtime.results.QuantumProgramResult.__getitem__" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/main/qiskit_ibm_runtime/results/quantum_program.py#L206-L212" signature="__getitem__(idx: int) → QuantumProgramItemResult" extraSignatures={["__getitem__(idx: slice) → list[QuantumProgramItemResult]"]} />

  ### \_\_len\_\_

  <Function id="qiskit_ibm_runtime.results.QuantumProgramResult.__len__" signature="__len__()">
    **Return type**
