...
<Class id="qiskit_ibm_runtime.results.QuantumProgramResult" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/main/qiskit_ibm_runtime/results/quantum_program.py#L137-L219" signature="QuantumProgramResult(data, metadata=None, passthrough_data=None)" modifiers="class">
