...
<Class id="qiskit_ibm_runtime.fake_provider.FakeSingaporeV2" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/main/qiskit_ibm_runtime/fake_provider/backends/singapore/fake_singapore.py#L20-L37" signature="FakeSingaporeV2" modifiers="class">
  ...
  **AttributeError** – If a field is specified that’s outside the backend’s options
  ...
  <Attribute id="qiskit_ibm_runtime.fake_provider.FakeSingaporeV2.backend_name">
    Type: `str`

    Default value: `'fake_singapore'`
  ...
  <Attribute id="qiskit_ibm_runtime.fake_provider.FakeSingaporeV2.conf_filename">
    Type: `str`

    Default value: `'conf_singapore.json'`
  ...
  <Attribute id="qiskit_ibm_runtime.fake_provider.FakeSingaporeV2.dirname">
    Type: `str`

    Default value: `'/home/runner/work/qiskit-ibm-runtime/qiskit-ibm-runtime/qiskit_ibm_runtime/fake_provider/backends/singapore'`
  ...
  <Attribute id="qiskit_ibm_runtime.fake_provider.FakeSingaporeV2.props_filename">
    Type: `str`

    Default value: `'props_singapore.json'`
  ...
  <Attribute id="qiskit_ibm_runtime.fake_provider.FakeSingaporeV2.version">
    Default value: `2`
  </Attribute>
