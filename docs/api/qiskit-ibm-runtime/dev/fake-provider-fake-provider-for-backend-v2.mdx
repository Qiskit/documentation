...
<Class id="qiskit_ibm_runtime.fake_provider.FakeProviderForBackendV2" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/main/qiskit_ibm_runtime/fake_provider/fake_provider.py#L26-L115" signature="FakeProviderForBackendV2" modifiers="class">
  Bases: `object`
