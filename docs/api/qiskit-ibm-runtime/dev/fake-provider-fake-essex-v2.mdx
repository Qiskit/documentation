...
<Class id="qiskit_ibm_runtime.fake_provider.FakeEssexV2" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/main/qiskit_ibm_runtime/fake_provider/backends/essex/fake_essex.py#L20-L35" signature="FakeEssexV2" modifiers="class">
  Bases: `FakeBackendV2`
  ...
  **AttributeError** – If a field is specified that’s outside the backend’s options
  ...
  <Attribute id="qiskit_ibm_runtime.fake_provider.FakeEssexV2.backend_name" attributeTypeHint="str" attributeValue="'fake_essex'">
    Name of the backend.
  </Attribute>

  ### conf\_filename

  <Attribute id="qiskit_ibm_runtime.fake_provider.FakeEssexV2.conf_filename" attributeTypeHint="str" attributeValue="'conf_essex.json'">
  ...
  <Attribute id="qiskit_ibm_runtime.fake_provider.FakeEssexV2.dirname" attributeTypeHint="str" attributeValue="'/home/runner/work/qiskit-ibm-runtime/qiskit-ibm-runtime/qiskit_ibm_runtime/fake_provider/backends/essex'">
  ...
  <Attribute id="qiskit_ibm_runtime.fake_provider.FakeEssexV2.props_filename" attributeTypeHint="str" attributeValue="'props_essex.json'">
  ...
  <Function id="qiskit_ibm_runtime.fake_provider.FakeEssexV2.check_faulty" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/main/qiskit_ibm_runtime/fake_provider/fake_backend.py#L174-L206" signature="check_faulty(circuit)">
  ...
  <Function id="qiskit_ibm_runtime.fake_provider.FakeEssexV2.configuration" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/main/qiskit_ibm_runtime/fake_provider/fake_backend.py#L170-L172" signature="configuration()">
  ...
  <Function id="qiskit_ibm_runtime.fake_provider.FakeEssexV2.properties" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/main/qiskit_ibm_runtime/fake_provider/fake_backend.py#L157-L168" signature="properties(refresh=False)">
  ...
  <Function id="qiskit_ibm_runtime.fake_provider.FakeEssexV2.refresh" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/main/qiskit_ibm_runtime/fake_provider/fake_backend.py#L388-L493" signature="refresh(service, use_fractional_gates=False, persist=True)">
  ...
  <Function id="qiskit_ibm_runtime.fake_provider.FakeEssexV2.run" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/main/qiskit_ibm_runtime/fake_provider/fake_backend.py#L277-L306" signature="run(run_input, **options)">
  ...
  <Function id="qiskit_ibm_runtime.fake_provider.FakeEssexV2.status" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/main/qiskit_ibm_runtime/fake_provider/fake_backend.py#L140-L155" signature="status()">
