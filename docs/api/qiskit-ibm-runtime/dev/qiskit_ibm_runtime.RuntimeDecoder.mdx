...
<Class id="qiskit_ibm_runtime.RuntimeDecoder" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/main/qiskit_ibm_runtime/utils/json.py#L327-L421" signature="RuntimeDecoder(*args, **kwargs)">
