---
title: LayerError (dev version)
description: API reference for qiskit_ibm_runtime.results.LayerError in the dev version of qiskit-ibm-runtime
in_page_toc_min_heading_level: 1
python_api_type: class
python_api_name: qiskit_ibm_runtime.results.LayerError
---

# LayerError

<Class id="qiskit_ibm_runtime.results.LayerError" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/main/qiskit_ibm_runtime/results/noise_learner.py#L122-L322" signature="LayerError(circuit, qubits, error=None)" modifiers="class">
  Bases: `object`
  ...
  *   **error** ([*PauliLindbladError*](results-pauli-lindblad-error "qiskit_ibm_runtime.results.PauliLindbladError") *| None*) – The Pauli Lindblad error channel affecting the `circuit`, or `None` if the error channel is either unknown or explicitly disabled.
  ...
  **ValueError** – If `circuit`, `qubits`, and `error` have mismatching number of qubits.
  ...
  <Attribute id="qiskit_ibm_runtime.results.LayerError.circuit">
    The circuit in this `LayerError`.
  </Attribute>

  ### error

  <Attribute id="qiskit_ibm_runtime.results.LayerError.error">
  ...
  <Attribute id="qiskit_ibm_runtime.results.LayerError.num_qubits">
    The number of qubits in this [`LayerError`](#qiskit_ibm_runtime.results.LayerError "qiskit_ibm_runtime.results.LayerError").
  </Attribute>

  ### qubits

  <Attribute id="qiskit_ibm_runtime.results.LayerError.qubits">
  ...
  <Function id="qiskit_ibm_runtime.results.LayerError.draw_map" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/main/qiskit_ibm_runtime/results/noise_learner.py#L174-L251" signature="draw_map(embedding, colorscale='Bluered', color_no_data='lightgray', color_out_of_scale='lightgreen', num_edge_segments=16, edge_width=4, height=500, highest_rate=None, background_color='white', radius=0.25, width=800)">
  ...
  <Function id="qiskit_ibm_runtime.results.LayerError.draw_swarm" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/main/qiskit_ibm_runtime/results/noise_learner.py#L253-L314" signature="draw_swarm(num_bodies=None, max_rate=None, min_rate=None, connected=None, colors=None, num_bins=None, opacities=0.4, names=None, x_coo=None, marker_size=None, height=500, width=800)">
