...
|                                                                                                                                                    |                                                                                 |
| -------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------- |
| [`ConvertIdToDelay`](transpiler-passes-convert-id-to-delay "qiskit_ibm_runtime.transpiler.passes.ConvertIdToDelay")                                | Convert `qiskit.circuit.library.standard_gates.IGate` to a corresponding delay. |
...
| [`ConvertToMidCircuitMeasure`](transpiler-passes-convert-to-mid-circuit-measure "qiskit_ibm_runtime.transpiler.passes.ConvertToMidCircuitMeasure") | Transpiler pass replacing mid-circuit terminal measure instructions.            |
