...
<Class id="qiskit_ibm_runtime.noise_learner.NoiseLearner" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/main/qiskit_ibm_runtime/noise_learner/noise_learner.py#L47-L270" signature="NoiseLearner(mode=None, options=None)" modifiers="class">
  Bases: `object`
  ...
  *   **mode** ([*BackendV2*](/docs/api/qiskit/qiskit.providers.BackendV2 "(in Qiskit v2.3)")  *|*[*Session*](session "qiskit_ibm_runtime.session.Session")  *|*[*Batch*](batch "qiskit_ibm_runtime.batch.Batch") *| None*) –
  ...
  **References**
  ...
  <Function id="qiskit_ibm_runtime.noise_learner.NoiseLearner.backend" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/main/qiskit_ibm_runtime/noise_learner/noise_learner.py#L221-L223" signature="backend()">
    Return the backend the primitive query will be run on.

    **Return type**

    [*BackendV2*](/docs/api/qiskit/qiskit.providers.BackendV2 "(in Qiskit v2.3)")
  </Function>

  ### run

  <Function id="qiskit_ibm_runtime.noise_learner.NoiseLearner.run" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/main/qiskit_ibm_runtime/noise_learner/noise_learner.py#L139-L214" signature="run(circuits)">
    ...
    **circuits** (*Iterable\[*[*QuantumCircuit*](/docs/api/qiskit/qiskit.circuit.QuantumCircuit "(in Qiskit v2.3)") *| EstimatorPub | Tuple\[*[*QuantumCircuit*](/docs/api/qiskit/qiskit.circuit.QuantumCircuit "(in Qiskit v2.3)")*, str |* [*Pauli*](/docs/api/qiskit/qiskit.quantum_info.Pauli "(in Qiskit v2.3)")  *|*[*SparsePauliOp*](/docs/api/qiskit/qiskit.quantum_info.SparsePauliOp "(in Qiskit v2.3)")  *|*[*SparseObservable*](/docs/api/qiskit/qiskit.quantum_info.SparseObservable "(in Qiskit v2.3)")  *| Mapping\[str |*[*Pauli*](/docs/api/qiskit/qiskit.quantum_info.Pauli "(in Qiskit v2.3)")*, float] | \_Buffer | \_SupportsArray\[*[*dtype*](https://numpy.org/doc/stable/reference/generated/numpy.dtype.html#numpy.dtype "(in NumPy v2.4)")*\[Any]] | \_NestedSequence\[\_SupportsArray\[*[*dtype*](https://numpy.org/doc/stable/reference/generated/numpy.dtype.html#numpy.dtype "(in NumPy v2.4)")*\[Any]]] | bool | int | float | complex | bytes | \_NestedSequence\[bool | int | float | complex | str | bytes]] | Tuple\[*[*QuantumCircuit*](/docs/api/qiskit/qiskit.circuit.QuantumCircuit "(in Qiskit v2.3)")*, str |* [*Pauli*](/docs/api/qiskit/qiskit.quantum_info.Pauli "(in Qiskit v2.3)")  *|*[*SparsePauliOp*](/docs/api/qiskit/qiskit.quantum_info.SparsePauliOp "(in Qiskit v2.3)")  *|*[*SparseObservable*](/docs/api/qiskit/qiskit.quantum_info.SparseObservable "(in Qiskit v2.3)")  *| Mapping\[str |*[*Pauli*](/docs/api/qiskit/qiskit.quantum_info.Pauli "(in Qiskit v2.3)")*, float] | \_Buffer | \_SupportsArray\[*[*dtype*](https://numpy.org/doc/stable/reference/generated/numpy.dtype.html#numpy.dtype "(in NumPy v2.4)")*\[Any]] | \_NestedSequence\[\_SupportsArray\[*[*dtype*](https://numpy.org/doc/stable/reference/generated/numpy.dtype.html#numpy.dtype "(in NumPy v2.4)")*\[Any]]] | bool | int | float | complex | bytes | \_NestedSequence\[bool | int | float | complex | str | bytes], Mapping\[*[*Parameter*](/docs/api/qiskit/qiskit.circuit.Parameter "(in Qiskit v2.3)") *| str | Tuple\[*[*Parameter*](/docs/api/qiskit/qiskit.circuit.Parameter "(in Qiskit v2.3)") *| str, ...], \_Buffer | \_SupportsArray\[*[*dtype*](https://numpy.org/doc/stable/reference/generated/numpy.dtype.html#numpy.dtype "(in NumPy v2.4)")*\[Any]] | \_NestedSequence\[\_SupportsArray\[*[*dtype*](https://numpy.org/doc/stable/reference/generated/numpy.dtype.html#numpy.dtype "(in NumPy v2.4)")*\[Any]]] | bool | int | float | complex | str | bytes | \_NestedSequence\[bool | int | float | complex | str | bytes]]] | Tuple\[*[*QuantumCircuit*](/docs/api/qiskit/qiskit.circuit.QuantumCircuit "(in Qiskit v2.3)")*, str |* [*Pauli*](/docs/api/qiskit/qiskit.quantum_info.Pauli "(in Qiskit v2.3)")  *|*[*SparsePauliOp*](/docs/api/qiskit/qiskit.quantum_info.SparsePauliOp "(in Qiskit v2.3)")  *|*[*SparseObservable*](/docs/api/qiskit/qiskit.quantum_info.SparseObservable "(in Qiskit v2.3)")  *| Mapping\[str |*[*Pauli*](/docs/api/qiskit/qiskit.quantum_info.Pauli "(in Qiskit v2.3)")*, float] | \_Buffer | \_SupportsArray\[*[*dtype*](https://numpy.org/doc/stable/reference/generated/numpy.dtype.html#numpy.dtype "(in NumPy v2.4)")*\[Any]] | \_NestedSequence\[\_SupportsArray\[*[*dtype*](https://numpy.org/doc/stable/reference/generated/numpy.dtype.html#numpy.dtype "(in NumPy v2.4)")*\[Any]]] | bool | int | float | complex | bytes | \_NestedSequence\[bool | int | float | complex | str | bytes], Mapping\[*[*Parameter*](/docs/api/qiskit/qiskit.circuit.Parameter "(in Qiskit v2.3)") *| str | Tuple\[*[*Parameter*](/docs/api/qiskit/qiskit.circuit.Parameter "(in Qiskit v2.3)") *| str, ...], \_Buffer | \_SupportsArray\[*[*dtype*](https://numpy.org/doc/stable/reference/generated/numpy.dtype.html#numpy.dtype "(in NumPy v2.4)")*\[Any]] | \_NestedSequence\[\_SupportsArray\[*[*dtype*](https://numpy.org/doc/stable/reference/generated/numpy.dtype.html#numpy.dtype "(in NumPy v2.4)")*\[Any]]] | bool | int | float | complex | str | bytes | \_NestedSequence\[bool | int | float | complex | str | bytes]], Real]]*) – An iterable of circuits to run the noise learner program for. Alternatively, estimator pub-like (primitive unified bloc) objects can be specified, such as tuples `(circuit, observables)` or `(circuit, observables, parameter_values)`. In this case, the pub-like objects are converted to a list of circuits, and all the other fields (such as `observables` and `parameter_values`) are ignored.
