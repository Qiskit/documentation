...
<Class id="qiskit_ibm_runtime.noise_learner.NoiseLearner" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/main/qiskit_ibm_runtime/noise_learner/noise_learner.py#L49-L272" signature="NoiseLearner(mode=None, options=None)" modifiers="class">
  Bases: `object`
  ...
  **References**
  ...
  <Function id="qiskit_ibm_runtime.noise_learner.NoiseLearner.backend" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/main/qiskit_ibm_runtime/noise_learner/noise_learner.py#L223-L225" signature="backend()">
  ...
  <Function id="qiskit_ibm_runtime.noise_learner.NoiseLearner.run" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/main/qiskit_ibm_runtime/noise_learner/noise_learner.py#L141-L216" signature="run(circuits)">
