...
<Class id="qiskit_ibm_runtime.transpiler.passes.FoldRzzAngle" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/main/qiskit_ibm_runtime/transpiler/passes/basis/fold_rzz_angle.py#L33-L253" signature="FoldRzzAngle(*args, **kwargs)" modifiers="class">
  ...
  <Function id="qiskit_ibm_runtime.transpiler.passes.FoldRzzAngle.run" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/main/qiskit_ibm_runtime/transpiler/passes/basis/fold_rzz_angle.py#L58-L61" signature="run(dag)">
