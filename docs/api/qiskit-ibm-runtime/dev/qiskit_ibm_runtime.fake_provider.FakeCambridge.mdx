...
<span id="qiskit_ibm_runtime.fake_provider.FakeCambridge.backend_name" />

### backend\_name

`= 'fake_cambridge'`

<span id="qiskit_ibm_runtime.fake_provider.FakeCambridge.conf_filename" />

### conf\_filename

`= 'conf_cambridge.json'`

<span id="qiskit_ibm_runtime.fake_provider.FakeCambridge.dirname" />

### dirname

`= '/home/runner/work/qiskit-ibm-runtime/qiskit-ibm-runtime/qiskit_ibm_runtime/fake_provider/backends/cambridge'`

<span id="qiskit_ibm_runtime.fake_provider.FakeCambridge.options" />
...
<span id="qiskit_ibm_runtime.fake_provider.FakeCambridge.props_filename" />

### props\_filename

`= 'props_cambridge.json'`

<span id="qiskit_ibm_runtime.fake_provider.FakeCambridge.version" />
...
<span id="qiskit_ibm_runtime.fake_provider.FakeCambridge.configuration" />
...
<span id="qiskit_ibm_runtime.fake_provider.FakeCambridge.name" />
...
<span id="qiskit_ibm_runtime.fake_provider.FakeCambridge.provider" />
...
<span id="qiskit_ibm_runtime.fake_provider.FakeCambridge.set_options" />
...
<span id="qiskit_ibm_runtime.fake_provider.FakeCambridge.status" />
