...
<Class id="qiskit_ibm_runtime.Session" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/main/qiskit_ibm_runtime/session.py#L48-L389" signature="Session(service=None, backend=None, max_time=None)">
