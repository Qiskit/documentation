...
<Class id="qiskit_ibm_runtime.fake_provider.FakeBurlingtonV2" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/main/qiskit_ibm_runtime/fake_provider/backends/burlington/fake_burlington.py#L20-L33" signature="FakeBurlingtonV2" modifiers="class">
  ...
  **AttributeError** – If a field is specified that’s outside the backend’s options
  ...
  <Attribute id="qiskit_ibm_runtime.fake_provider.FakeBurlingtonV2.backend_name">
    Type: `str`

    Default value: `'fake_burlington'`
  ...
  <Attribute id="qiskit_ibm_runtime.fake_provider.FakeBurlingtonV2.conf_filename">
    Type: `str`

    Default value: `'conf_burlington.json'`
  ...
  <Attribute id="qiskit_ibm_runtime.fake_provider.FakeBurlingtonV2.dirname">
    Type: `str`

    Default value: `'/home/runner/work/qiskit-ibm-runtime/qiskit-ibm-runtime/qiskit_ibm_runtime/fake_provider/backends/burlington'`
  ...
  <Attribute id="qiskit_ibm_runtime.fake_provider.FakeBurlingtonV2.props_filename">
    Type: `str`

    Default value: `'props_burlington.json'`
  ...
  <Attribute id="qiskit_ibm_runtime.fake_provider.FakeBurlingtonV2.version">
    Default value: `2`
  </Attribute>
