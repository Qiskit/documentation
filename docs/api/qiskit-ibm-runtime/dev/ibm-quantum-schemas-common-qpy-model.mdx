...
<Class id="ibm_quantum_schemas.common.QpyModel" isDedicatedPage={true} github="https://github.com/Qiskit/ibm-quantum-schemas/tree/0.10rc1/ibm_quantum_schemas/common/qpy.py#L244-L311" signature="QpyModel" modifiers="pydantic model">
  Bases: `BaseModel`
  ...
  <Function id="ibm_quantum_schemas.common.QpyModel.cross_validate_qpy_version" github="https://github.com/Qiskit/ibm-quantum-schemas/tree/0.10rc1/ibm_quantum_schemas/common/qpy.py#L255-L268" signature="cross_validate_qpy_version" modifiers="validator">
    Check that the reported version matches the encoded version.
  </Function>

  ### from\_quantum\_circuit

  <Function id="ibm_quantum_schemas.common.QpyModel.from_quantum_circuit" github="https://github.com/Qiskit/ibm-quantum-schemas/tree/0.10rc1/ibm_quantum_schemas/common/qpy.py#L289-L311" signature="from_quantum_circuit(circuit, qpy_version=17)" modifiers="classmethod">
  ...
  <Function id="ibm_quantum_schemas.common.QpyModel.to_quantum_circuit" github="https://github.com/Qiskit/ibm-quantum-schemas/tree/0.10rc1/ibm_quantum_schemas/common/qpy.py#L270-L287" signature="to_quantum_circuit(use_cached=False)">
