---
title: draw_execution_spans (dev version)
description: API reference for qiskit_ibm_runtime.visualization.draw_execution_spans in the dev version of qiskit-ibm-runtime
