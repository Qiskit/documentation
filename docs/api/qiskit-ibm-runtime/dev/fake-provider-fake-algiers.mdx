...
<Class id="qiskit_ibm_runtime.fake_provider.FakeAlgiers" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/main/qiskit_ibm_runtime/fake_provider/backends/algiers/fake_algiers.py#L19-L25" signature="FakeAlgiers" modifiers="class">
  Bases: `FakeBackendV2`
