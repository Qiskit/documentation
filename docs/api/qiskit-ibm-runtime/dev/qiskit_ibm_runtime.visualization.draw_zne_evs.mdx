---
title: draw_zne_evs (dev version)
description: API reference for qiskit_ibm_runtime.visualization.draw_zne_evs in the dev version of qiskit-ibm-runtime
...
<Function id="qiskit_ibm_runtime.visualization.draw_zne_evs" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/main/qiskit_ibm_runtime/visualization/draw_zne.py#L29-L152" signature="draw_zne_evs(result, indices=None, names=None, num_stds=1, max_mag=10, max_std=0.2, height=500, width=1000, num_cols=4, colorscale='Aggrnyl')">
  ...
  *   **indices** (*Sequence\[tuple\[int, ...]] | None*) – The indices of the expectation values to include in the plot. If `None`, includes all values. See [`ZneOptions`](qiskit_ibm_runtime.options.ZneOptions "qiskit_ibm_runtime.options.ZneOptions") for information on the indexing scheme.
