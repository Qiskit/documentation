...
<Class id="qiskit_ibm_runtime.fake_provider.FakeMarrakesh" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/main/qiskit_ibm_runtime/fake_provider/backends/marrakesh/fake_marrakesh.py#L20-L27" signature="FakeMarrakesh" modifiers="class">
  ...
  **AttributeError** – If a field is specified that’s outside the backend’s options
  ...
  <Attribute id="qiskit_ibm_runtime.fake_provider.FakeMarrakesh.backend_name">
    Type: `str`

    Default value: `'fake_marrakesh'`
  ...
  <Attribute id="qiskit_ibm_runtime.fake_provider.FakeMarrakesh.conf_filename">
    Type: `str`

    Default value: `'conf_marrakesh.json'`
  ...
  <Attribute id="qiskit_ibm_runtime.fake_provider.FakeMarrakesh.dirname">
    Type: `str`

    Default value: `'/home/runner/work/qiskit-ibm-runtime/qiskit-ibm-runtime/qiskit_ibm_runtime/fake_provider/backends/marrakesh'`
  ...
  <Attribute id="qiskit_ibm_runtime.fake_provider.FakeMarrakesh.props_filename">
    Type: `str`

    Default value: `'props_marrakesh.json'`
  ...
  <Attribute id="qiskit_ibm_runtime.fake_provider.FakeMarrakesh.version">
    Default value: `2`
  </Attribute>
