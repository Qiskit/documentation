...
<Class id="qiskit_ibm_runtime.fake_provider.FakePrague" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/main/qiskit_ibm_runtime/fake_provider/backends/prague/fake_prague.py#L21-L27" signature="FakePrague" modifiers="class">
  ...
  **AttributeError** – If a field is specified that’s outside the backend’s options
  ...
  <Attribute id="qiskit_ibm_runtime.fake_provider.FakePrague.backend_name">
    Type: `str`

    Default value: `'fake_prague'`
  ...
  <Attribute id="qiskit_ibm_runtime.fake_provider.FakePrague.conf_filename">
    Type: `str`

    Default value: `'conf_prague.json'`
  ...
  <Attribute id="qiskit_ibm_runtime.fake_provider.FakePrague.dirname">
    Type: `str`

    Default value: `'/home/runner/work/qiskit-ibm-runtime/qiskit-ibm-runtime/qiskit_ibm_runtime/fake_provider/backends/prague'`
  ...
  <Attribute id="qiskit_ibm_runtime.fake_provider.FakePrague.props_filename">
    Type: `str`

    Default value: `'props_prague.json'`
  ...
  <Attribute id="qiskit_ibm_runtime.fake_provider.FakePrague.version">
    Default value: `2`
  </Attribute>
