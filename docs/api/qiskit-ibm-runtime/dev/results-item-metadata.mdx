...
<Class id="qiskit_ibm_runtime.results.ItemMetadata" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/main/qiskit_ibm_runtime/results/quantum_program.py#L66-L68" signature="ItemMetadata" modifiers="class">
  Bases: `object`
