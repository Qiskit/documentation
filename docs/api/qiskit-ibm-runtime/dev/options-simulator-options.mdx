...
<Class id="qiskit_ibm_runtime.options.SimulatorOptions" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/main/qiskit_ibm_runtime/options/simulator_options.py#L33-L111" signature="SimulatorOptions(noise_model=Unset, seed_simulator=Unset, coupling_map=Unset, basis_gates=Unset)" modifiers="class">
  ...
  *   **coupling\_map** (*UnsetType | List\[List\[int]] |* [*CouplingMap*](https://quantum.cloud.ibm.com/docs/api/qiskit/qiskit.transpiler.CouplingMap "(in Qiskit v2.0)"))
  *   **basis\_gates** (*UnsetType | List\[str]*)
  ...
  <Function id="qiskit_ibm_runtime.options.SimulatorOptions.set_backend" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/main/qiskit_ibm_runtime/options/simulator_options.py#L88-L111" signature="set_backend(backend)">
    ...
    **backend** ([*BackendV2*](https://quantum.cloud.ibm.com/docs/api/qiskit/qiskit.providers.BackendV2 "(in Qiskit v2.0)")) – backend to be set.
