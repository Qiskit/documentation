...
<Class id="qiskit_ibm_runtime.SamplerV1" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/main/qiskit_ibm_runtime/sampler.py#L140-L292" signature="SamplerV1(backend=None, session=None, options=None)">
