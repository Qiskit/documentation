---
title: XSlowGate (dev version)
description: API reference for qiskit_ibm_runtime.circuit.library.XSlowGate in the dev version of qiskit-ibm-runtime
...
<Class id="qiskit_ibm_runtime.circuit.library.XSlowGate" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/main/qiskit_ibm_runtime/circuit/library/xslow.py#L18-L22" signature="XSlowGate" modifiers="class">
