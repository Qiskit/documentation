...
<Class id="qiskit_ibm_runtime.results.NoiseLearnerV3Results" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/main/qiskit_ibm_runtime/results/noise_learner_v3.py#L129-L201" signature="NoiseLearnerV3Results(data, metadata=None)" modifiers="class">
  Bases: `object`
  ...
  *   **metadata** ([*Metadata*](results-metadata "qiskit_ibm_runtime.results.Metadata") *| None*) – A dictionary of metadata.
  ...
  <Function id="qiskit_ibm_runtime.results.NoiseLearnerV3Results.__getitem__" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/main/qiskit_ibm_runtime/results/noise_learner_v3.py#L191-L192" signature="__getitem__(idx)">
    **Parameters**
  ...
  <Function id="qiskit_ibm_runtime.results.NoiseLearnerV3Results.__len__" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/main/qiskit_ibm_runtime/results/noise_learner_v3.py#L197-L198" signature="__len__()">
    **Return type**
  ...
  <Function id="qiskit_ibm_runtime.results.NoiseLearnerV3Results.to_dict" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/main/qiskit_ibm_runtime/results/noise_learner_v3.py#L141-L189" signature="to_dict(instructions, require_refs=True)">
