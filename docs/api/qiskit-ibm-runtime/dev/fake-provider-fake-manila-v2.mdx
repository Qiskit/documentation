...
<Class id="qiskit_ibm_runtime.fake_provider.FakeManilaV2" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/main/qiskit_ibm_runtime/fake_provider/backends/manila/fake_manila.py#L19-L25" signature="FakeManilaV2" modifiers="class">
  Bases: `FakeBackendV2`
