...
<Class id="qiskit_ibm_runtime.fake_provider.FakeLimaV2" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/main/qiskit_ibm_runtime/fake_provider/backends/lima/fake_lima.py#L20-L26" signature="FakeLimaV2" modifiers="class">
  ...
  **AttributeError** – If a field is specified that’s outside the backend’s options
  ...
  <Attribute id="qiskit_ibm_runtime.fake_provider.FakeLimaV2.backend_name">
    Type: `str`

    Default value: `'fake_lima'`
  ...
  <Attribute id="qiskit_ibm_runtime.fake_provider.FakeLimaV2.conf_filename">
    Type: `str`

    Default value: `'conf_lima.json'`
  ...
  <Attribute id="qiskit_ibm_runtime.fake_provider.FakeLimaV2.dirname">
    Type: `str`

    Default value: `'/home/runner/work/qiskit-ibm-runtime/qiskit-ibm-runtime/qiskit_ibm_runtime/fake_provider/backends/lima'`
  ...
  <Attribute id="qiskit_ibm_runtime.fake_provider.FakeLimaV2.props_filename">
    Type: `str`

    Default value: `'props_lima.json'`
  ...
  <Attribute id="qiskit_ibm_runtime.fake_provider.FakeLimaV2.version">
    Default value: `2`
  </Attribute>
