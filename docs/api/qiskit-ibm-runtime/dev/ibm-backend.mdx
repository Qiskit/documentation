...
<Class id="qiskit_ibm_runtime.IBMBackend" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/main/qiskit_ibm_runtime/ibm_backend.py#L64-L579" signature="IBMBackend(configuration, service, api_client, instance=None)" modifiers="class">
  Bases: [`BackendV2`](https://quantum.cloud.ibm.com/docs/api/qiskit/qiskit.providers.BackendV2 "(in Qiskit v2.0)")
  ...
  >
  > *   target: A [`qiskit.transpiler.Target`](https://quantum.cloud.ibm.com/docs/api/qiskit/qiskit.transpiler.Target "(in Qiskit v2.0)") object for the backend.
  >
  ...
  *   **instance** (*str | None*)
  ...
  <Function id="qiskit_ibm_runtime.IBMBackend.target_history" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/main/qiskit_ibm_runtime/ibm_backend.py#L324-L334" signature="target_history(datetime=None)">
    ...
    **Return type**
    ...
    [*Target*](https://quantum.cloud.ibm.com/docs/api/qiskit/qiskit.transpiler.Target "(in Qiskit v2.0)")
  </Function>
</Class>
