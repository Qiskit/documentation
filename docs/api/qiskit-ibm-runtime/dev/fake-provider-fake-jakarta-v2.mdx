...
<Class id="qiskit_ibm_runtime.fake_provider.FakeJakartaV2" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/main/qiskit_ibm_runtime/fake_provider/backends/jakarta/fake_jakarta.py#L20-L26" signature="FakeJakartaV2" modifiers="class">
  ...
  **AttributeError** – If a field is specified that’s outside the backend’s options
  ...
  <Attribute id="qiskit_ibm_runtime.fake_provider.FakeJakartaV2.backend_name">
    Type: `str`

    Default value: `'fake_jakarta'`
  ...
  <Attribute id="qiskit_ibm_runtime.fake_provider.FakeJakartaV2.conf_filename">
    Type: `str`

    Default value: `'conf_jakarta.json'`
  ...
  <Attribute id="qiskit_ibm_runtime.fake_provider.FakeJakartaV2.dirname">
    Type: `str`

    Default value: `'/home/runner/work/qiskit-ibm-runtime/qiskit-ibm-runtime/qiskit_ibm_runtime/fake_provider/backends/jakarta'`
  ...
  <Attribute id="qiskit_ibm_runtime.fake_provider.FakeJakartaV2.props_filename">
    Type: `str`

    Default value: `'props_jakarta.json'`
  ...
  <Attribute id="qiskit_ibm_runtime.fake_provider.FakeJakartaV2.version">
    Default value: `2`
  </Attribute>
