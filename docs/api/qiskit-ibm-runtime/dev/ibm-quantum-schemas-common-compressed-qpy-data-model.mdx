...
<Class id="ibm_quantum_schemas.common.CompressedQpyDataModel" isDedicatedPage={true} github="https://github.com/Qiskit/ibm-quantum-schemas/tree/0.12.20260921/ibm_quantum_schemas/common/qpy.py#L152-L239" signature="CompressedQpyDataModel" modifiers="pydantic model">
  ...
  <Function id="ibm_quantum_schemas.common.CompressedQpyDataModel.cross_validate_qpy_info" github="https://github.com/Qiskit/ibm-quantum-schemas/tree/0.12.20260921/ibm_quantum_schemas/common/qpy.py#L155-L169" signature="cross_validate_qpy_info" modifiers="validator">
    Check that the encoded qpy information matches expectations.
  </Function>

  ### from\_python

  <Function id="ibm_quantum_schemas.common.CompressedQpyDataModel.from_python" github="https://github.com/Qiskit/ibm-quantum-schemas/tree/0.12.20260921/ibm_quantum_schemas/common/qpy.py#L201-L239" signature="from_python(data, qpy_version=17, metadata_serializer=None)" modifiers="classmethod">
  ...
  <Function id="ibm_quantum_schemas.common.CompressedQpyDataModel.to_python" github="https://github.com/Qiskit/ibm-quantum-schemas/tree/0.12.20260921/ibm_quantum_schemas/common/qpy.py#L171-L199" signature="to_python(use_cached=False, metadata_deserializer=None)">
