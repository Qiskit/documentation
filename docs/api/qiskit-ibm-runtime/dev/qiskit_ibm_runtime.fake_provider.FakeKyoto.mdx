...
<span id="qiskit_ibm_runtime.fake_provider.FakeKyoto" />
...
<span id="qiskit_ibm_runtime.fake_provider.FakeKyoto.backend_name" />

### backend\_name

`= 'fake_kyoto'`

<span id="qiskit_ibm_runtime.fake_provider.FakeKyoto.conf_filename" />

### conf\_filename

`= 'conf_kyoto.json'`

<span id="qiskit_ibm_runtime.fake_provider.FakeKyoto.coupling_map" />

### coupling\_map

Return the `CouplingMap` object

<span id="qiskit_ibm_runtime.fake_provider.FakeKyoto.defs_filename" />

### defs\_filename

`= 'defs_kyoto.json'`

<span id="qiskit_ibm_runtime.fake_provider.FakeKyoto.dirname" />

### dirname

`= '/home/runner/work/qiskit-ibm-runtime/qiskit-ibm-runtime/qiskit_ibm_runtime/fake_provider/backends/kyoto'`

<span id="qiskit_ibm_runtime.fake_provider.FakeKyoto.dt" />
...
<span id="qiskit_ibm_runtime.fake_provider.FakeKyoto.dtm" />
...
<span id="qiskit_ibm_runtime.fake_provider.FakeKyoto.instruction_durations" />

### instruction\_durations

Return the `InstructionDurations` object.

<span id="qiskit_ibm_runtime.fake_provider.FakeKyoto.instruction_schedule_map" />

### instruction\_schedule\_map

Return the `InstructionScheduleMap` for the instructions defined in this backend’s target.

<span id="qiskit_ibm_runtime.fake_provider.FakeKyoto.instructions" />
...
<span id="qiskit_ibm_runtime.fake_provider.FakeKyoto.max_circuits" />
...
<span id="qiskit_ibm_runtime.fake_provider.FakeKyoto.meas_map" />
...
<span id="qiskit_ibm_runtime.fake_provider.FakeKyoto.num_qubits" />
...
<span id="qiskit_ibm_runtime.fake_provider.FakeKyoto.operation_names" />
...
<span id="qiskit_ibm_runtime.fake_provider.FakeKyoto.operations" />
...
<span id="qiskit_ibm_runtime.fake_provider.FakeKyoto.options" />
...
<span id="qiskit_ibm_runtime.fake_provider.FakeKyoto.props_filename" />

### props\_filename

`= 'props_kyoto.json'`

<span id="qiskit_ibm_runtime.fake_provider.FakeKyoto.provider" />
...
<span id="qiskit_ibm_runtime.fake_provider.FakeKyoto.target" />
...
<span id="qiskit_ibm_runtime.fake_provider.FakeKyoto.version" />

### version

`= 2`

<span id="qiskit_ibm_runtime.fake_provider.FakeKyoto.name" />

### name

Name of the backend.

<span id="qiskit_ibm_runtime.fake_provider.FakeKyoto.description" />

### description

Optional human-readable description.

<span id="qiskit_ibm_runtime.fake_provider.FakeKyoto.online_date" />

### online\_date

Date that the backend came online.

<span id="qiskit_ibm_runtime.fake_provider.FakeKyoto.backend_version" />
...
<span id="qiskit_ibm_runtime.fake_provider.FakeKyoto.acquire_channel" />
...
<span id="qiskit_ibm_runtime.fake_provider.FakeKyoto.control_channel" />
...
<span id="qiskit_ibm_runtime.fake_provider.FakeKyoto.drive_channel" />
...
<span id="qiskit_ibm_runtime.fake_provider.FakeKyoto.measure_channel" />
...
<span id="qiskit_ibm_runtime.fake_provider.FakeKyoto.qubit_properties" />
...
<span id="qiskit_ibm_runtime.fake_provider.FakeKyoto.run" />
...
<span id="qiskit_ibm_runtime.fake_provider.FakeKyoto.set_options" />
