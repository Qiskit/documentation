...
|                                                                                                                                                                                        |                                                                       |
| -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------- |
| [`ParamsModel`](ibm-quantum-schemas-executor-version-0-1-params-model "ibm_quantum_schemas.executor.version_0_1.ParamsModel")                                                          | A model describing the Executor program inputs.                       |
