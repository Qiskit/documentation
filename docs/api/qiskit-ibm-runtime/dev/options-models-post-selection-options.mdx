...
<Class id="qiskit_ibm_runtime.options_models.PostSelectionOptions" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/main/qiskit_ibm_runtime/options_models/post_selection.py#L25-L60" signature="PostSelectionOptions(enable=False, x_pulse_type='xslow', strategy='node')" modifiers="class">
  Bases: `object`
