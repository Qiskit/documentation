...
<Class id="qiskit_ibm_runtime.options_models.PostSelectionOptions" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/main/qiskit_ibm_runtime/options_models/post_selection_options.py#L25-L62" signature="PostSelectionOptions(enable=False, x_pulse_type='xslow', strategy='node')" modifiers="class">
  Bases: `object`
