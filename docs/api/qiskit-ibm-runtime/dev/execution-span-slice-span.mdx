...
<Class id="qiskit_ibm_runtime.execution_span.SliceSpan" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/main/qiskit_ibm_runtime/execution_span/slice_span.py#L33-L87" signature="SliceSpan(start, stop, data_slices)" modifiers="class">
  ...
  *   **data\_slices** (*dict\[int, tuple\[ShapeType, slice]]*) – A map from pub indices to pairs `(shape_tuple, slice)`.
  ...
  <Function id="qiskit_ibm_runtime.execution_span.SliceSpan.contains_pub" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/main/qiskit_ibm_runtime/execution_span/execution_span.py#L117-L127" signature="contains_pub(pub_idx)">
  ...
  <Function id="qiskit_ibm_runtime.execution_span.SliceSpan.filter_by_pub" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/main/qiskit_ibm_runtime/execution_span/slice_span.py#L83-L87" signature="filter_by_pub(pub_idx)">
  ...
  <Function id="qiskit_ibm_runtime.execution_span.SliceSpan.mask" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/main/qiskit_ibm_runtime/execution_span/slice_span.py#L73-L81" signature="mask(pub_idx)">
