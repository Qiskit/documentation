...
<Class id="qiskit_ibm_runtime.SamplerV2" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/main/qiskit_ibm_runtime/sampler.py#L50-L176" signature="SamplerV2(mode=None, backend=None, session=None, options=None)" modifiers="class">
  ...
  **NotImplementedError** – If “q-ctrl” channel strategy is used.
  ...
  <Function id="qiskit_ibm_runtime.SamplerV2.run" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/main/qiskit_ibm_runtime/sampler.py#L138-L160" signature="run(pubs, *, shots=None)">
