...
<Class id="qiskit_ibm_runtime.SamplerV2" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/main/qiskit_ibm_runtime/sampler.py#L50-L172" signature="SamplerV2(mode=None, backend=None, session=None, options=None)">
  ...
  **NotImplementedError** – If “q-ctrl” channel strategy is used.
  ...
  <Attribute id="qiskit_ibm_runtime.SamplerV2.mode" name="mode">
  ...
  <Function id="qiskit_ibm_runtime.SamplerV2.run" name="run" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/main/qiskit_ibm_runtime/sampler.py#L129-L156" signature="run(pubs, *, shots=None)">
