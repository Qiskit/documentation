...
|                                                                                                                                                                                                                                             |                                                                                     |
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------- |
| [`ParamsModel`](ibm-quantum-schemas-noise-learner-v3-version-0-2-params-model "ibm_quantum_schemas.noise_learner_v3.version_0_2.ParamsModel")                                                                                               | A model describing the Noise Learner V3 program inputs.                             |
