...
<Class id="ibm_quantum_schemas.executor.version_1_0.CircuitItemModel" isDedicatedPage={true} github="https://github.com/Qiskit/ibm-quantum-schemas/tree/0.11.20260824/ibm_quantum_schemas/executor/version_1_0/models.py#L93-L123" signature="CircuitItemModel" modifiers="pydantic model">
  Bases: `BaseModel`
