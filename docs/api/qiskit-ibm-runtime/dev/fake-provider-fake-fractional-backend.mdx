...
<Class id="qiskit_ibm_runtime.fake_provider.FakeFractionalBackend" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/main/qiskit_ibm_runtime/fake_provider/backends/fractional/fake_fractional.py#L19-L33" signature="FakeFractionalBackend" modifiers="class">
  Bases: `FakeBackendV2`
