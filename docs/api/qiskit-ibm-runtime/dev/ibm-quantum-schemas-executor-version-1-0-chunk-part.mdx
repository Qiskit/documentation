...
<Class id="ibm_quantum_schemas.executor.version_1_0.ChunkPart" isDedicatedPage={true} github="https://github.com/Qiskit/ibm-quantum-schemas/tree/0.12.20260921/ibm_quantum_schemas/executor/version_1_0/models.py#L283-L341" signature="ChunkPart" modifiers="pydantic model">
  Bases: `BaseModel`
  ...
  <Function id="ibm_quantum_schemas.executor.version_1_0.ChunkPart.cross_validate" github="https://github.com/Qiskit/ibm-quantum-schemas/tree/0.12.20260921/ibm_quantum_schemas/executor/version_1_0/models.py#L332-L341" signature="cross_validate" modifiers="validator">
  ...
  <Function id="ibm_quantum_schemas.executor.version_1_0.ChunkPart.must_be_a_valid_range" github="https://github.com/Qiskit/ibm-quantum-schemas/tree/0.12.20260921/ibm_quantum_schemas/executor/version_1_0/models.py#L323-L330" signature="must_be_a_valid_range" modifiers="validator">
    Check that we have a valid range tuple.
  </Function>

  ### must\_be\_permutation\_of\_range

  <Function id="ibm_quantum_schemas.executor.version_1_0.ChunkPart.must_be_permutation_of_range" github="https://github.com/Qiskit/ibm-quantum-schemas/tree/0.12.20260921/ibm_quantum_schemas/executor/version_1_0/models.py#L315-L321" signature="must_be_permutation_of_range" modifiers="validator">
