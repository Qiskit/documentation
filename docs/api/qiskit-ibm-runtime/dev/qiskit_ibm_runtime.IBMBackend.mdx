...
<Class id="qiskit_ibm_runtime.IBMBackend" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/main/qiskit_ibm_runtime/ibm_backend.py#L76-L900" signature="IBMBackend(configuration, service, api_client, instance=None)">
