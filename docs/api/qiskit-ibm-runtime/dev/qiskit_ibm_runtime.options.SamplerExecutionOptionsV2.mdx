---
title: SamplerExecutionOptionsV2 (dev version)
description: API reference for qiskit_ibm_runtime.options.SamplerExecutionOptionsV2 in the dev version of qiskit-ibm-runtime
