...
<Class id="ibm_quantum_schemas.executor.version_1_0.StretchValueModel" isDedicatedPage={true} github="https://github.com/Qiskit/ibm-quantum-schemas/tree/0.11.20260824/ibm_quantum_schemas/executor/version_1_0/models.py#L239-L260" signature="StretchValueModel" modifiers="pydantic model">
  Bases: `BaseModel`
