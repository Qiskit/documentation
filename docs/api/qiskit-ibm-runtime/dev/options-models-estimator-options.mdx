...
description: API reference for qiskit_ibm_runtime.options_models.EstimatorOptions in the dev version of qiskit-ibm-runtime
...
<Class id="qiskit_ibm_runtime.options_models.EstimatorOptions" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/main/qiskit_ibm_runtime/options_models/estimator.py#L30-L102" signature="EstimatorOptions" modifiers="pydantic model">
  ...
  *   **extra**: *str = forbid*
  ...
  <Function id="qiskit_ibm_runtime.options_models.EstimatorOptions.update" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/main/qiskit_ibm_runtime/options_models/base.py#L46-L54" signature="update(**kwargs)">
    Update the options.
