...
<Class id="qiskit_ibm_runtime.Executor" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/main/qiskit_ibm_runtime/executor/executor.py#L41-L161" signature="Executor(mode=None, options=None)" modifiers="class">
  Bases: `object`
  ...
  *   **ValueError** – If local mode is used.
  ...
  <Function id="qiskit_ibm_runtime.Executor.backend" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/main/qiskit_ibm_runtime/executor/executor.py#L159-L161" signature="backend()">
  ...
  <Function id="qiskit_ibm_runtime.Executor.run" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/main/qiskit_ibm_runtime/executor/executor.py#L115-L157" signature="run(program)">
