...
<Class id="qiskit_ibm_runtime.Executor" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/main/qiskit_ibm_runtime/executor/executor.py#L40-L158" signature="Executor(mode=None, options=None)" modifiers="class">
  Bases: `object`
  ...
  *   **ValueError** – If local mode is used.
  ...
  <Function id="qiskit_ibm_runtime.Executor.backend" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/main/qiskit_ibm_runtime/executor/executor.py#L156-L158" signature="backend()">
  ...
  <Function id="qiskit_ibm_runtime.Executor.run" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/main/qiskit_ibm_runtime/executor/executor.py#L113-L154" signature="run(program)">
