...
<Class id="qiskit_ibm_runtime.Executor" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/main/qiskit_ibm_runtime/executor/executor.py#L40-L155" signature="Executor(mode=None, options=None)" modifiers="class">
  Bases: `object`
  ...
  **TypeError** – If `options` is not a valid type.
  ...
  <Function id="qiskit_ibm_runtime.Executor.backend" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/main/qiskit_ibm_runtime/executor/executor.py#L153-L155" signature="backend()">
  ...
  <Function id="qiskit_ibm_runtime.Executor.run" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/main/qiskit_ibm_runtime/executor/executor.py#L110-L151" signature="run(program)">
