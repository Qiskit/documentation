...
<Class id="qiskit_ibm_runtime.Executor" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/main/qiskit_ibm_runtime/executor.py#L44-L171" signature="Executor(mode, *, options=None)" modifiers="class">
  Bases: `object`
  ...
  *   **ValueError** – If local mode is used.
  ...
  <Function id="qiskit_ibm_runtime.Executor.run" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/main/qiskit_ibm_runtime/executor.py#L157-L171" signature="run(program)">
