---
title: ResilienceOptionsV2 (dev version)
description: API reference for qiskit_ibm_runtime.options.ResilienceOptionsV2 in the dev version of qiskit-ibm-runtime
