---
title: LayerNoiseLearningOptions (dev version)
description: API reference for qiskit_ibm_runtime.options.LayerNoiseLearningOptions in the dev version of qiskit-ibm-runtime
