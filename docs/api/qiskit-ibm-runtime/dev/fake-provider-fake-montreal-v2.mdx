---
title: FakeMontrealV2 (dev version)
description: API reference for qiskit_ibm_runtime.fake_provider.FakeMontrealV2 in the dev version of qiskit-ibm-runtime
...
<Class id="qiskit_ibm_runtime.fake_provider.FakeMontrealV2" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/main/qiskit_ibm_runtime/fake_provider/backends/montreal/fake_montreal.py#L20-L26" signature="FakeMontrealV2" modifiers="class">
  Bases: `FakeBackendV2`
  ...
  **AttributeError** – If a field is specified that’s outside the backend’s options
  ...
  <Attribute id="qiskit_ibm_runtime.fake_provider.FakeMontrealV2.backend_name" attributeTypeHint="str" attributeValue="'fake_montreal'">
    Name of the backend.
  </Attribute>

  ### conf\_filename

  <Attribute id="qiskit_ibm_runtime.fake_provider.FakeMontrealV2.conf_filename" attributeTypeHint="str" attributeValue="'conf_montreal.json'">
  ...
  <Attribute id="qiskit_ibm_runtime.fake_provider.FakeMontrealV2.dirname" attributeTypeHint="str" attributeValue="'/home/runner/work/qiskit-ibm-runtime/qiskit-ibm-runtime/qiskit_ibm_runtime/fake_provider/backends/montreal'">
  ...
  <Attribute id="qiskit_ibm_runtime.fake_provider.FakeMontrealV2.physical_qubits">
  ...
  <Attribute id="qiskit_ibm_runtime.fake_provider.FakeMontrealV2.props_filename" attributeTypeHint="str" attributeValue="'props_montreal.json'">
  ...
  <Function id="qiskit_ibm_runtime.fake_provider.FakeMontrealV2.check_faulty" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/main/qiskit_ibm_runtime/fake_provider/fake_backend.py#L177-L209" signature="check_faulty(circuit)">
  ...
  <Function id="qiskit_ibm_runtime.fake_provider.FakeMontrealV2.configuration" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/main/qiskit_ibm_runtime/fake_provider/fake_backend.py#L173-L175" signature="configuration()">
  ...
  <Function id="qiskit_ibm_runtime.fake_provider.FakeMontrealV2.properties" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/main/qiskit_ibm_runtime/fake_provider/fake_backend.py#L160-L171" signature="properties(refresh=False)">
  ...
  <Function id="qiskit_ibm_runtime.fake_provider.FakeMontrealV2.refresh" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/main/qiskit_ibm_runtime/fake_provider/fake_backend.py#L400-L505" signature="refresh(service, use_fractional_gates=False, persist=True)">
    ...
    *   **persist** (*bool*) – If `True` (default), the refreshed data files overwrite the copies bundled with the installed package so the update persists across sessions. If `False`, the data is written to a temporary directory instead, which allows [`refresh()`](#qiskit_ibm_runtime.fake_provider.FakeMontrealV2.refresh "qiskit_ibm_runtime.fake_provider.FakeMontrealV2.refresh") to succeed even when the package is installed in a read-only location, at the cost of the update not persisting between sessions.
  ...
  <Function id="qiskit_ibm_runtime.fake_provider.FakeMontrealV2.run" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/main/qiskit_ibm_runtime/fake_provider/fake_backend.py#L289-L318" signature="run(run_input, **options)">
  ...
  <Function id="qiskit_ibm_runtime.fake_provider.FakeMontrealV2.status" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/main/qiskit_ibm_runtime/fake_provider/fake_backend.py#L143-L158" signature="status()">
