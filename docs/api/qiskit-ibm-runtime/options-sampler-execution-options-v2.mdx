...
<Class id="qiskit_ibm_runtime.options.SamplerExecutionOptionsV2" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.47/qiskit_ibm_runtime/options/sampler_execution_options.py#L20-L50" signature="SamplerExecutionOptionsV2(init_qubits=Unset, rep_delay=Unset, meas_type=Unset)" modifiers="class">
