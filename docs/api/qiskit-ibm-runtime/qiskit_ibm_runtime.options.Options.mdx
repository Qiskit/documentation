...
<Class id="qiskit_ibm_runtime.options.Options" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.22/qiskit_ibm_runtime/options/options.py#L172-L404" signature="Options(optimization_level=None, resilience_level=None, max_execution_time=None, transpilation=<factory>, resilience=<factory>, execution=<factory>, environment=<factory>, simulator=<factory>)">
  ...
  *   **simulator** (`Union`\[[`SimulatorOptions`](qiskit_ibm_runtime.options.SimulatorOptions "qiskit_ibm_runtime.options.simulator_options.SimulatorOptions"), `Dict`]) – Simulator options. See [`SimulatorOptions`](qiskit_ibm_runtime.options.SimulatorOptions "qiskit_ibm_runtime.options.SimulatorOptions") for all available options.
  ...
  <Attribute id="qiskit_ibm_runtime.options.Options.max_execution_time" name="max_execution_time" attributeTypeHint="int | None" attributeValue="= None" />

  ### optimization\_level

  <Attribute id="qiskit_ibm_runtime.options.Options.optimization_level" name="optimization_level" attributeTypeHint="int | None" attributeValue="= None" />

  ### resilience\_level

  <Attribute id="qiskit_ibm_runtime.options.Options.resilience_level" name="resilience_level" attributeTypeHint="int | None" attributeValue="= None" />

  ### transpilation

  <Attribute id="qiskit_ibm_runtime.options.Options.transpilation" name="transpilation" attributeTypeHint="TranspilationOptions | Dict" />

  ### resilience

  <Attribute id="qiskit_ibm_runtime.options.Options.resilience" name="resilience" attributeTypeHint="ResilienceOptions | Dict" />

  ### execution

  <Attribute id="qiskit_ibm_runtime.options.Options.execution" name="execution" attributeTypeHint="ExecutionOptions | Dict" />

  ### environment

  <Attribute id="qiskit_ibm_runtime.options.Options.environment" name="environment" attributeTypeHint="EnvironmentOptions | Dict" />

  ### simulator

  <Attribute id="qiskit_ibm_runtime.options.Options.simulator" name="simulator" attributeTypeHint="SimulatorOptions | Dict" />

  ## Methods

  ### validate\_options

  <Function id="qiskit_ibm_runtime.options.Options.validate_options" name="validate_options" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.22/qiskit_ibm_runtime/options/options.py#L306-L334" signature="static validate_options(options)">
