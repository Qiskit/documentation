...
<Class id="qiskit_ibm_runtime.fake_provider.FakeLagosV2" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.49/qiskit_ibm_runtime/fake_provider/backends/lagos/fake_lagos.py#L20-L26" signature="FakeLagosV2" modifiers="class">
  ...
  **AttributeError** – If a field is specified that’s outside the backend’s options
  ...
  <Attribute id="qiskit_ibm_runtime.fake_provider.FakeLagosV2.backend_name" attributeTypeHint="str" attributeValue="'fake_lagos'">
    Name of the backend.
  </Attribute>

  ### conf\_filename

  <Attribute id="qiskit_ibm_runtime.fake_provider.FakeLagosV2.conf_filename" attributeTypeHint="str" attributeValue="'conf_lagos.json'">
  ...
  <Attribute id="qiskit_ibm_runtime.fake_provider.FakeLagosV2.dirname" attributeTypeHint="str" attributeValue="'/home/runner/work/qiskit-ibm-runtime/qiskit-ibm-runtime/qiskit_ibm_runtime/fake_provider/backends/lagos'">
  ...
  <Attribute id="qiskit_ibm_runtime.fake_provider.FakeLagosV2.props_filename" attributeTypeHint="str" attributeValue="'props_lagos.json'">
