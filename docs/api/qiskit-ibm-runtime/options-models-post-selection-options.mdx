...
<Class id="qiskit_ibm_runtime.options_models.PostSelectionOptions" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.50/qiskit_ibm_runtime/options_models/post_selection.py#L46-L80" signature="PostSelectionOptions" modifiers="pydantic model">
  ...
  *   **extra**: *str = forbid*
  ...
  <Attribute id="qiskit_ibm_runtime.options_models.PostSelectionOptions.enable" modifiers="field">
    Type: `Annotated`\[`bool`, `AfterValidator`(`warn_post_selection`)]
    ...
    *   **func** = \<function warn\_post\_selection at 0x7f500e771480>
  </Attribute>

  ### strategy

  <Attribute id="qiskit_ibm_runtime.options_models.PostSelectionOptions.strategy" modifiers="field">
  ...
  <Attribute id="qiskit_ibm_runtime.options_models.PostSelectionOptions.x_pulse_type" modifiers="field">
  ...
  <Function id="qiskit_ibm_runtime.options_models.PostSelectionOptions.update" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.50/qiskit_ibm_runtime/options_models/base.py#L46-L54" signature="update(**kwargs)">
    Update the options.
