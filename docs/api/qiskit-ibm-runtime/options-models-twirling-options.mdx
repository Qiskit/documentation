...
<Class id="qiskit_ibm_runtime.options_models.TwirlingOptions" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.50/qiskit_ibm_runtime/options_models/twirling.py#L24-L85" signature="TwirlingOptions" modifiers="pydantic model">
  ...
  *   **extra**: *str = forbid*
  ...
  <Function id="qiskit_ibm_runtime.options_models.TwirlingOptions.update" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.50/qiskit_ibm_runtime/options_models/base.py#L46-L54" signature="update(**kwargs)">
    Update the options.
