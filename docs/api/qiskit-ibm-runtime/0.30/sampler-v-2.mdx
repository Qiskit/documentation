---
title: SamplerV2 (v0.30)
description: API reference for qiskit_ibm_runtime.SamplerV2 in qiskit-ibm-runtime v0.30
...
<Class id="qiskit_ibm_runtime.SamplerV2" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.30/qiskit_ibm_runtime/sampler.py#L46-L139" signature="SamplerV2(mode=None, options=None)" modifiers="class">
  ...
  **NotImplementedError** – If “q-ctrl” channel strategy is used.
  ...
  <Function id="qiskit_ibm_runtime.SamplerV2.run" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.30/qiskit_ibm_runtime/sampler.py#L101-L123" signature="run(pubs, *, shots=None)">
