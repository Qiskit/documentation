...
<Class id="qiskit_ibm_runtime.options.SamplerOptions" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.34/qiskit_ibm_runtime/options/sampler_options.py#L27-L57" signature="SamplerOptions(_VERSION=2, max_execution_time=Unset, environment=<factory>, simulator=<factory>, default_shots=Unset, dynamical_decoupling=<factory>, execution=<factory>, twirling=<factory>, experimental=Unset)" modifiers="class">
  ...
  *   **execution** ([*SamplerExecutionOptionsV2*](options-sampler-execution-options-v-2 "qiskit_ibm_runtime.options.sampler_execution_options.SamplerExecutionOptionsV2") *| Dict*)
  ...
  *   **experimental** (*UnsetType | dict*)
  ...
  <Attribute id="qiskit_ibm_runtime.options.SamplerOptions.execution" attributeTypeHint="SamplerExecutionOptionsV2 | Dict" attributeValue="FieldInfo(annotation=Union[SamplerExecutionOptionsV2, Dict], required=False, default_factory=SamplerExecutionOptionsV2)">
    Execution time options. See [`SamplerExecutionOptionsV2`](options-sampler-execution-options-v-2 "qiskit_ibm_runtime.options.SamplerExecutionOptionsV2") for all available options.
  </Attribute>
  ...
  <Function id="qiskit_ibm_runtime.options.SamplerOptions.update" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.34/qiskit_ibm_runtime/options/options.py#L146-L155" signature="update(**kwargs)">
    Update the options.
