...
<Class id="qiskit_ibm_runtime.transpiler.passes.ConvertToMidCircuitMeasure" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.46/qiskit_ibm_runtime/transpiler/passes/basis/convert_mid_circ_meas.py#L22-L74" signature="ConvertToMidCircuitMeasure(*args, **kwargs)" modifiers="class">
  ...
  **ValueError** – If the specifcied `mcm_name` does not conform to the `measure_` pattern or is not contained in the provided target.
  ...
  <Function id="qiskit_ibm_runtime.transpiler.passes.ConvertToMidCircuitMeasure.run" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.46/qiskit_ibm_runtime/transpiler/passes/basis/convert_mid_circ_meas.py#L62-L74" signature="run(dag)">
