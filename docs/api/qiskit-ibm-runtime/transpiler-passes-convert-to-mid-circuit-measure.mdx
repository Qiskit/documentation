...
<Class id="qiskit_ibm_runtime.transpiler.passes.ConvertToMidCircuitMeasure" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.47/qiskit_ibm_runtime/transpiler/passes/basis/convert_mid_circ_meas.py#L21-L71" signature="ConvertToMidCircuitMeasure(*args, **kwargs)" modifiers="class">
  ...
  **ValueError** – If the specifcied `mcm_name` does not conform to the `measure_` pattern or is not contained in the provided target.
  ...
  <Function id="qiskit_ibm_runtime.transpiler.passes.ConvertToMidCircuitMeasure.run" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.47/qiskit_ibm_runtime/transpiler/passes/basis/convert_mid_circ_meas.py#L59-L71" signature="run(dag)">
