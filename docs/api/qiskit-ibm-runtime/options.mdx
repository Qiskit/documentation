...
| [`ResilienceOptionsV2`](options-resilience-options-v-2 "qiskit_ibm_runtime.options.ResilienceOptionsV2")                         | Resilience options for V2 Estimator.                                                                                                          |
...
| [`ExecutionOptionsV2`](options-execution-options-v-2 "qiskit_ibm_runtime.options.ExecutionOptionsV2")                            | Execution options for V2 primitives.                                                                                                          |
| [`SamplerExecutionOptionsV2`](options-sampler-execution-options-v-2 "qiskit_ibm_runtime.options.SamplerExecutionOptionsV2")      | Extension of [`ExecutionOptionsV2`](options-execution-options-v-2 "qiskit_ibm_runtime.options.ExecutionOptionsV2") for the sampler primitive. |
