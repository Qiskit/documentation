...
<Class id="qiskit_ibm_runtime.fake_provider.FakeOurenseV2" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.49/qiskit_ibm_runtime/fake_provider/backends/ourense/fake_ourense.py#L20-L33" signature="FakeOurenseV2" modifiers="class">
  ...
  **AttributeError** – If a field is specified that’s outside the backend’s options
  ...
  <Attribute id="qiskit_ibm_runtime.fake_provider.FakeOurenseV2.backend_name" attributeTypeHint="str" attributeValue="'fake_ourense'">
    Name of the backend.
  </Attribute>

  ### conf\_filename

  <Attribute id="qiskit_ibm_runtime.fake_provider.FakeOurenseV2.conf_filename" attributeTypeHint="str" attributeValue="'conf_ourense.json'">
  ...
  <Attribute id="qiskit_ibm_runtime.fake_provider.FakeOurenseV2.dirname" attributeTypeHint="str" attributeValue="'/home/runner/work/qiskit-ibm-runtime/qiskit-ibm-runtime/qiskit_ibm_runtime/fake_provider/backends/ourense'">
  ...
  <Attribute id="qiskit_ibm_runtime.fake_provider.FakeOurenseV2.props_filename" attributeTypeHint="str" attributeValue="'props_ourense.json'">
