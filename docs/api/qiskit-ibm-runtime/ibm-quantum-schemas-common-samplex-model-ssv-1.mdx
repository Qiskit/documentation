...
<Class id="ibm_quantum_schemas.common.SamplexModelSSV1" isDedicatedPage={true} github="https://github.com/Qiskit/ibm-quantum-schemas/tree/0.5.20260320/ibm_quantum_schemas/common/samplex.py#L93-L96" signature="SamplexModelSSV1" modifiers="pydantic model">
  ...
  <Function id="ibm_quantum_schemas.common.SamplexModelSSV1.cross_validate_ssv_version" github="https://github.com/Qiskit/ibm-quantum-schemas/tree/0.5.20260320/ibm_quantum_schemas/common/samplex.py#L32-L49" signature="cross_validate_ssv_version" modifiers="validator">
    Check that the reported version matches the encoded version.
  </Function>

  ### from\_samplex

  <Function id="ibm_quantum_schemas.common.SamplexModelSSV1.from_samplex" github="https://github.com/Qiskit/ibm-quantum-schemas/tree/0.5.20260320/ibm_quantum_schemas/common/samplex.py#L71-L90" signature="from_samplex(samplex, ssv=None)" modifiers="classmethod">
  ...
  <Function id="ibm_quantum_schemas.common.SamplexModelSSV1.to_samplex" github="https://github.com/Qiskit/ibm-quantum-schemas/tree/0.5.20260320/ibm_quantum_schemas/common/samplex.py#L53-L69" signature="to_samplex(use_cached=False)">
