...
<Class id="qiskit_ibm_runtime.SamplerV2" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.23/qiskit_ibm_runtime/sampler.py#L47-L137" signature="SamplerV2(backend=None, session=None, options=None)">
  ...
  **NotImplementedError** – If “q-ctrl” channel strategy is used.
  ...
  <Attribute id="qiskit_ibm_runtime.SamplerV2.options" name="options" attributeTypeHint="SamplerOptions">
    Return options
  ...
  <Attribute id="qiskit_ibm_runtime.SamplerV2.session" name="session">
  ...
  <Attribute id="qiskit_ibm_runtime.SamplerV2.version" name="version" attributeValue="= 2" />

  ## Methods

  ### run

  <Function id="qiskit_ibm_runtime.SamplerV2.run" name="run" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.23/qiskit_ibm_runtime/sampler.py#L94-L121" signature="run(pubs, *, shots=None)">
