...
<Class id="qiskit_ibm_runtime.noise_learner.NoiseLearner" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.32/qiskit_ibm_runtime/noise_learner/noise_learner.py#L48-L273" signature="NoiseLearner(mode=None, options=None)" modifiers="class">
  ...
  *   **mode** (`Union`\[[`BackendV2`](/docs/api/qiskit/qiskit.providers.BackendV2 "(in Qiskit v1.2)"), [`Session`](session "qiskit_ibm_runtime.session.Session"), [`Batch`](batch "qiskit_ibm_runtime.batch.Batch"), `None`]) –
  ...
  **References**
  ...
  <Attribute id="qiskit_ibm_runtime.noise_learner.NoiseLearner.options">
    ...
    **Return type**
    ...
    [`NoiseLearnerOptions`](options-noise-learner-options "qiskit_ibm_runtime.options.noise_learner_options.NoiseLearnerOptions")
  </Attribute>
  ...
  <Function id="qiskit_ibm_runtime.noise_learner.NoiseLearner.backend" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.32/qiskit_ibm_runtime/noise_learner/noise_learner.py#L224-L226" signature="backend()">
  ...
  <Function id="qiskit_ibm_runtime.noise_learner.NoiseLearner.run" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.32/qiskit_ibm_runtime/noise_learner/noise_learner.py#L145-L217" signature="run(circuits)">
