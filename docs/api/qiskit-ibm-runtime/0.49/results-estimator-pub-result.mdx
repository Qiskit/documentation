---
title: EstimatorPubResult (v0.49)
description: API reference for qiskit_ibm_runtime.results.EstimatorPubResult in qiskit-ibm-runtime v0.49
...
<Class id="qiskit_ibm_runtime.results.EstimatorPubResult" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.49/qiskit_ibm_runtime/results/estimator_pub.py#L27-L129" signature="EstimatorPubResult(data, metadata=None)" modifiers="class">
