---
title: QiskitRuntimeService (v0.49)
description: API reference for qiskit_ibm_runtime.QiskitRuntimeService in qiskit-ibm-runtime v0.49
...
<Class id="qiskit_ibm_runtime.QiskitRuntimeService" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.49/qiskit_ibm_runtime/qiskit_runtime_service.py#L57-L1436" signature="QiskitRuntimeService(*args, **kwargs)" modifiers="class">
  Bases: `object`
  ...
  *   **url\_resolver** – Function used to resolve the IBM Quantum Compute URL. If not provided, a default resolver will be used to access different service endpoints.
  ...
  **IBMInputValueError** – If an input is invalid.
  ...
  <Function id="qiskit_ibm_runtime.QiskitRuntimeService.active_account" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.49/qiskit_ibm_runtime/qiskit_runtime_service.py#L807-L813" signature="active_account()">
  ...
  <Function id="qiskit_ibm_runtime.QiskitRuntimeService.active_instance" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.49/qiskit_ibm_runtime/qiskit_runtime_service.py#L1415-L1417" signature="active_instance()">
  ...
  <Function id="qiskit_ibm_runtime.QiskitRuntimeService.backend" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.49/qiskit_ibm_runtime/qiskit_runtime_service.py#L933-L997" signature="backend(name, instance=None, use_fractional_gates=False, calibration_id=None)">
  ...
  <Function id="qiskit_ibm_runtime.QiskitRuntimeService.backends" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.49/qiskit_ibm_runtime/qiskit_runtime_service.py#L544-L667" signature="backends(name=None, min_num_qubits=None, instance=None, dynamic_circuits=None, filters=None, *, use_fractional_gates=False, calibration_id=None, **kwargs)">
    ...
    *   **filters** (*Callable\[\[*[*IBMBackend*](ibm-backend "qiskit_ibm_runtime.IBMBackend")*], bool] | None*) –
    ...
    **Return type**
    ...
    list\[[IBMBackend](ibm-backend "qiskit_ibm_runtime.IBMBackend")]
  </Function>

  ### delete\_account

  <Function id="qiskit_ibm_runtime.QiskitRuntimeService.delete_account" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.49/qiskit_ibm_runtime/qiskit_runtime_service.py#L815-L833" signature="delete_account(filename=None, name=None, channel=None)" modifiers="static">
  ...
  <Function id="qiskit_ibm_runtime.QiskitRuntimeService.delete_job" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.49/qiskit_ibm_runtime/qiskit_runtime_service.py#L1228-L1245" signature="delete_job(job_id)">
  ...
  <Function id="qiskit_ibm_runtime.QiskitRuntimeService.instances" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.49/qiskit_ibm_runtime/qiskit_runtime_service.py#L1402-L1413" signature="instances()">
  ...
  <Function id="qiskit_ibm_runtime.QiskitRuntimeService.job" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.49/qiskit_ibm_runtime/qiskit_runtime_service.py#L1102-L1133" signature="job(job_id)">
  ...
  <Function id="qiskit_ibm_runtime.QiskitRuntimeService.jobs" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.49/qiskit_ibm_runtime/qiskit_runtime_service.py#L1135-L1226" signature="jobs(limit=10, skip=0, backend_name=None, pending=None, program_id=None, instance=None, job_tags=None, session_id=None, created_after=None, created_before=None, descending=True)">
    ...
    **Return type**
    ...
    list\[[RuntimeJobV2](runtime-job-v2 "qiskit_ibm_runtime.RuntimeJobV2")]
  </Function>

  ### least\_busy

  <Function id="qiskit_ibm_runtime.QiskitRuntimeService.least_busy" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.49/qiskit_ibm_runtime/qiskit_runtime_service.py#L1322-L1400" signature="least_busy(min_num_qubits=None, instance=None, filters=None, use_fractional_gates=False, **kwargs)">
  ...
  <Function id="qiskit_ibm_runtime.QiskitRuntimeService.saved_accounts" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.49/qiskit_ibm_runtime/qiskit_runtime_service.py#L905-L931" signature="saved_accounts(default=None, channel=None, filename=None, name=None)" modifiers="static">
  ...
  <Function id="qiskit_ibm_runtime.QiskitRuntimeService.usage" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.49/qiskit_ibm_runtime/qiskit_runtime_service.py#L1247-L1261" signature="usage()">
