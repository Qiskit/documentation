---
title: NoiseLearnerV3 (v0.49)
description: API reference for qiskit_ibm_runtime.noise_learner_v3.NoiseLearnerV3 in qiskit-ibm-runtime v0.49
...
<Class id="qiskit_ibm_runtime.noise_learner_v3.NoiseLearnerV3" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.49/qiskit_ibm_runtime/noise_learner_v3/noise_learner_v3.py#L41-L177" signature="NoiseLearnerV3(mode=None, options=None)" modifiers="class">
  Bases: `object`
  ...
  **References**
  ...
  <Attribute id="qiskit_ibm_runtime.noise_learner_v3.NoiseLearnerV3.options">
    Type: [`NoiseLearnerV3Options`](options-models-noise-learner-v3-options "qiskit_ibm_runtime.options_models.noise_learner_v3.NoiseLearnerV3Options")
  ...
  <Function id="qiskit_ibm_runtime.noise_learner_v3.NoiseLearnerV3.backend" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.49/qiskit_ibm_runtime/noise_learner_v3/noise_learner_v3.py#L175-L177" signature="backend()">
  ...
  <Function id="qiskit_ibm_runtime.noise_learner_v3.NoiseLearnerV3.run" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.49/qiskit_ibm_runtime/noise_learner_v3/noise_learner_v3.py#L104-L173" signature="run(instructions)">
