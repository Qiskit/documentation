---
title: FakePerth (v0.49)
description: API reference for qiskit_ibm_runtime.fake_provider.FakePerth in qiskit-ibm-runtime v0.49
...
<Class id="qiskit_ibm_runtime.fake_provider.FakePerth" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.49/qiskit_ibm_runtime/fake_provider/backends/perth/fake_perth.py#L21-L27" signature="FakePerth" modifiers="class">
  ...
  **AttributeError** – If a field is specified that’s outside the backend’s options
  ...
  <Attribute id="qiskit_ibm_runtime.fake_provider.FakePerth.backend_name">
    Type: `str`
  ...
  <Attribute id="qiskit_ibm_runtime.fake_provider.FakePerth.conf_filename">
    Type: `str`
  ...
  <Attribute id="qiskit_ibm_runtime.fake_provider.FakePerth.dirname">
    Type: `str`
  ...
  <Attribute id="qiskit_ibm_runtime.fake_provider.FakePerth.props_filename">
    Type: `str`
  ...
  <Attribute id="qiskit_ibm_runtime.fake_provider.FakePerth.version">
    Default value: `2`
  </Attribute>
