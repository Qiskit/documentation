---
title: IBM Quantum Compute client API documentation (v0.49)
description: Index of all the modules in qiskit-ibm-runtime v0.49.
---
...
*   [IBM Quantum Compute (formerly Qiskit Runtime) Client (`qiskit_ibm_runtime`)](runtime-service)
