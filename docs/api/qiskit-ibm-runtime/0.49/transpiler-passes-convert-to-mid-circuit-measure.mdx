---
title: ConvertToMidCircuitMeasure (v0.49)
description: API reference for qiskit_ibm_runtime.transpiler.passes.ConvertToMidCircuitMeasure in qiskit-ibm-runtime v0.49
...
<Class id="qiskit_ibm_runtime.transpiler.passes.ConvertToMidCircuitMeasure" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.49/qiskit_ibm_runtime/transpiler/passes/basis/convert_mid_circ_meas.py#L123-L159" signature="ConvertToMidCircuitMeasure(*args, **kwargs)" modifiers="class">
  ...
  **ValueError** – If the specified `mcm_name` does not start with `measure` or is not contained in the provided target.
  ...
  <Function id="qiskit_ibm_runtime.transpiler.passes.ConvertToMidCircuitMeasure.run" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.49/qiskit_ibm_runtime/transpiler/passes/basis/convert_mid_circ_meas.py#L157-L159" signature="run(dag)">
