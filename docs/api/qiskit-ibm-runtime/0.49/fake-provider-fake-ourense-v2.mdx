---
title: FakeOurenseV2 (v0.49)
description: API reference for qiskit_ibm_runtime.fake_provider.FakeOurenseV2 in qiskit-ibm-runtime v0.49
...
<Class id="qiskit_ibm_runtime.fake_provider.FakeOurenseV2" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.49/qiskit_ibm_runtime/fake_provider/backends/ourense/fake_ourense.py#L20-L33" signature="FakeOurenseV2" modifiers="class">
  Bases: `FakeBackendV2`
  ...
  **AttributeError** – If a field is specified that’s outside the backend’s options
  ...
  <Attribute id="qiskit_ibm_runtime.fake_provider.FakeOurenseV2.backend_name">
    Type: `str`

    Default value: `'fake_ourense'`
  ...
  <Attribute id="qiskit_ibm_runtime.fake_provider.FakeOurenseV2.conf_filename">
    Type: `str`

    Default value: `'conf_ourense.json'`
  ...
  <Attribute id="qiskit_ibm_runtime.fake_provider.FakeOurenseV2.dirname">
    Type: `str`

    Default value: `'/home/runner/work/qiskit-ibm-runtime/qiskit-ibm-runtime/qiskit_ibm_runtime/fake_provider/backends/ourense'`
  ...
  <Attribute id="qiskit_ibm_runtime.fake_provider.FakeOurenseV2.physical_qubits">
  ...
  <Attribute id="qiskit_ibm_runtime.fake_provider.FakeOurenseV2.props_filename">
    Type: `str`

    Default value: `'props_ourense.json'`
  ...
  <Attribute id="qiskit_ibm_runtime.fake_provider.FakeOurenseV2.version">
    Default value: `2`
  </Attribute>
  ...
  <Function id="qiskit_ibm_runtime.fake_provider.FakeOurenseV2.check_faulty" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.49/qiskit_ibm_runtime/fake_provider/fake_backend.py#L177-L209" signature="check_faulty(circuit)">
  ...
  <Function id="qiskit_ibm_runtime.fake_provider.FakeOurenseV2.configuration" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.49/qiskit_ibm_runtime/fake_provider/fake_backend.py#L173-L175" signature="configuration()">
  ...
  <Function id="qiskit_ibm_runtime.fake_provider.FakeOurenseV2.properties" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.49/qiskit_ibm_runtime/fake_provider/fake_backend.py#L160-L171" signature="properties(refresh=False)">
  ...
  <Function id="qiskit_ibm_runtime.fake_provider.FakeOurenseV2.refresh" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.49/qiskit_ibm_runtime/fake_provider/fake_backend.py#L400-L505" signature="refresh(service, use_fractional_gates=False, persist=True)">
    ...
    *   **persist** (*bool*) – If `True` (default), the refreshed data files overwrite the copies bundled with the installed package so the update persists across sessions. If `False`, the data is written to a temporary directory instead, which allows [`refresh()`](#qiskit_ibm_runtime.fake_provider.FakeOurenseV2.refresh "qiskit_ibm_runtime.fake_provider.FakeOurenseV2.refresh") to succeed even when the package is installed in a read-only location, at the cost of the update not persisting between sessions.
  ...
  <Function id="qiskit_ibm_runtime.fake_provider.FakeOurenseV2.run" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.49/qiskit_ibm_runtime/fake_provider/fake_backend.py#L289-L318" signature="run(run_input, **options)">
  ...
  <Function id="qiskit_ibm_runtime.fake_provider.FakeOurenseV2.status" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.49/qiskit_ibm_runtime/fake_provider/fake_backend.py#L143-L158" signature="status()">
