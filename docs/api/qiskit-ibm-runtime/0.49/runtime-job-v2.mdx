---
title: RuntimeJobV2 (v0.49)
description: API reference for qiskit_ibm_runtime.RuntimeJobV2 in qiskit-ibm-runtime v0.49
...
<Class id="qiskit_ibm_runtime.RuntimeJobV2" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.49/qiskit_ibm_runtime/runtime_job_v2.py#L57-L301" signature="RuntimeJobV2(backend, api_client, job_id, program_id, service, creation_date=None, result_decoder=None, image='', session_id=None, tags=None, version=None, private=False)" modifiers="class">
  ...
  *   **private** (*bool | None*)
  ...
  <Attribute id="qiskit_ibm_runtime.RuntimeJobV2.ERROR">
  ...
  <Attribute id="qiskit_ibm_runtime.RuntimeJobV2.JOB_FINAL_STATES">
  ...
  <Function id="qiskit_ibm_runtime.RuntimeJobV2.backend" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.49/qiskit_ibm_runtime/runtime_job_v2.py#L287-L301" signature="backend(timeout=None)">
  ...
  <Function id="qiskit_ibm_runtime.RuntimeJobV2.cancel" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.49/qiskit_ibm_runtime/runtime_job_v2.py#L161-L174" signature="cancel()">
    Cancel the job.
  ...
  <Function id="qiskit_ibm_runtime.RuntimeJobV2.cancelled" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.49/qiskit_ibm_runtime/runtime_job_v2.py#L202-L204" signature="cancelled()">
  ...
  <Function id="qiskit_ibm_runtime.RuntimeJobV2.done" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.49/qiskit_ibm_runtime/runtime_job_v2.py#L206-L208" signature="done()">
  ...
  <Function id="qiskit_ibm_runtime.RuntimeJobV2.error_message" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.49/qiskit_ibm_runtime/base_runtime_job.py#L217-L224" signature="error_message()">
  ...
  <Function id="qiskit_ibm_runtime.RuntimeJobV2.errored" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.49/qiskit_ibm_runtime/runtime_job_v2.py#L210-L212" signature="errored()">
  ...
  <Function id="qiskit_ibm_runtime.RuntimeJobV2.in_final_state" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.49/qiskit_ibm_runtime/runtime_job_v2.py#L214-L216" signature="in_final_state()">
  ...
  <Function id="qiskit_ibm_runtime.RuntimeJobV2.logs" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.49/qiskit_ibm_runtime/runtime_job_v2.py#L222-L241" signature="logs()">
    Return job logs.
  ...
  <Function id="qiskit_ibm_runtime.RuntimeJobV2.metrics" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.49/qiskit_ibm_runtime/base_runtime_job.py#L153-L169" signature="metrics()">
    Return job metrics.
  ...
  <Function id="qiskit_ibm_runtime.RuntimeJobV2.properties" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.49/qiskit_ibm_runtime/base_runtime_job.py#L200-L215" signature="properties(refresh=False)">
  ...
  <Function id="qiskit_ibm_runtime.RuntimeJobV2.result" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.49/qiskit_ibm_runtime/runtime_job_v2.py#L114-L159" signature="result(timeout=None, decoder=None, poll_interval=None)">
  ...
  <Function id="qiskit_ibm_runtime.RuntimeJobV2.running" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.49/qiskit_ibm_runtime/runtime_job_v2.py#L218-L220" signature="running()">
  ...
  <Function id="qiskit_ibm_runtime.RuntimeJobV2.status" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.49/qiskit_ibm_runtime/runtime_job_v2.py#L176-L183" signature="status()">
  ...
  <Function id="qiskit_ibm_runtime.RuntimeJobV2.update_tags" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.49/qiskit_ibm_runtime/base_runtime_job.py#L171-L198" signature="update_tags(new_tags)">
  ...
  <Function id="qiskit_ibm_runtime.RuntimeJobV2.usage" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.49/qiskit_ibm_runtime/base_runtime_job.py#L125-L151" signature="usage(partial=False)">
  ...
  <Function id="qiskit_ibm_runtime.RuntimeJobV2.wait_for_final_state" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.49/qiskit_ibm_runtime/runtime_job_v2.py#L243-L285" signature="wait_for_final_state(timeout=None, poll_interval=None)">
