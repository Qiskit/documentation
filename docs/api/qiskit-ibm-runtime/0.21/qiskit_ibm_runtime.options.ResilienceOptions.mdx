...
<Class id="qiskit_ibm_runtime.options.ResilienceOptions" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.21/qiskit_ibm_runtime/options/resilience_options.py#L104-L141" signature="ResilienceOptions(*args, **kwargs)">
  ...
  *   **extrapolator** – An extrapolation strategy. One of `"LinearExtrapolator"`, `"QuadraticExtrapolator"`, `"CubicExtrapolator"`, `"QuarticExtrapolator"`. Note that `"CubicExtrapolator"` and `"QuarticExtrapolator"` require more noise factors than the default. Only applicable for `resilience_level=2`. Default: `None`, and `LinearExtrapolator` if resilience level is 2.
  ...
  <Attribute id="qiskit_ibm_runtime.options.ResilienceOptions.extrapolator" name="extrapolator" attributeTypeHint="Literal['LinearExtrapolator', 'QuadraticExtrapolator', 'CubicExtrapolator', 'QuarticExtrapolator'] | None" attributeValue="= None" />

  ### noise\_amplifier

  <Attribute id="qiskit_ibm_runtime.options.ResilienceOptions.noise_amplifier" name="noise_amplifier" attributeTypeHint="Literal['LocalFoldingAmplifier'] | None" attributeValue="= None" />

  ### noise\_factors

  <Attribute id="qiskit_ibm_runtime.options.ResilienceOptions.noise_factors" name="noise_factors" attributeTypeHint="Sequence[float] | None" attributeValue="= None" />
