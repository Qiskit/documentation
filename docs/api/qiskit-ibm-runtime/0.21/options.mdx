...
<Admonition title="Note" type="note">
  If an option is not specified, the server default value is used. The default values are subject to change. See the [API Reference](/api/qiskit-ibm-runtime/0.21/options) for the most up-to-date default values.
</Admonition>
