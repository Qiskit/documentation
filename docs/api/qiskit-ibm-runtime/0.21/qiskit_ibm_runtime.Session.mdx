...
<Class id="qiskit_ibm_runtime.Session" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.21/qiskit_ibm_runtime/session.py#L41-L346" signature="Session(service=None, backend=None, max_time=None)">
  ...
  **ValueError** – If an input value is invalid.
  ...
  <Attribute id="qiskit_ibm_runtime.Session.service" name="service">
  ...
  <Attribute id="qiskit_ibm_runtime.Session.session_id" name="session_id">
  ...
  <Function id="qiskit_ibm_runtime.Session.backend" name="backend" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.21/qiskit_ibm_runtime/session.py#L218-L224" signature="backend()">
  ...
  <Function id="qiskit_ibm_runtime.Session.cancel" name="cancel" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.21/qiskit_ibm_runtime/session.py#L204-L208" signature="cancel()">
  ...
  <Function id="qiskit_ibm_runtime.Session.close" name="close" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.21/qiskit_ibm_runtime/session.py#L210-L216" signature="close()">
  ...
  <Function id="qiskit_ibm_runtime.Session.details" name="details" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.21/qiskit_ibm_runtime/session.py#L252-L288" signature="details()">
  ...
  <Function id="qiskit_ibm_runtime.Session.from_id" name="from_id" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.21/qiskit_ibm_runtime/session.py#L308-L333" signature="classmethod from_id(session_id, service=None, backend=None)">
  ...
  <Function id="qiskit_ibm_runtime.Session.run" name="run" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.21/qiskit_ibm_runtime/session.py#L159-L202" signature="run(program_id, inputs, options=None, callback=None, result_decoder=None)">
  ...
  <Function id="qiskit_ibm_runtime.Session.status" name="status" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.21/qiskit_ibm_runtime/session.py#L226-L250" signature="status()">
