---
title: IBMBackend (v0.21)
description: API reference for qiskit_ibm_runtime.IBMBackend in qiskit-ibm-runtime v0.21
...
<Class id="qiskit_ibm_runtime.IBMBackend" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.21/qiskit_ibm_runtime/ibm_backend.py#L75-L856" signature="IBMBackend(configuration, service, api_client, instance=None)" modifiers="class">
  ...
  *   **api\_client** (`RuntimeClient`) – IBM client used to communicate with the server.
  ...
  <Function id="qiskit_ibm_runtime.IBMBackend.__call__" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.21/qiskit_ibm_runtime/ibm_backend.py#L506-L508" signature="__call__()">
  ...
  <Function id="qiskit_ibm_runtime.IBMBackend.acquire_channel" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.21/qiskit_ibm_runtime/ibm_backend.py#L480-L486" signature="acquire_channel(qubit)">
  ...
  <Function id="qiskit_ibm_runtime.IBMBackend.cancel_session" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.21/qiskit_ibm_runtime/ibm_backend.py#L839-L846" signature="cancel_session()">
  ...
  <Function id="qiskit_ibm_runtime.IBMBackend.check_faulty" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.21/qiskit_ibm_runtime/ibm_backend.py#L530-L562" signature="check_faulty(circuit)">
  ...
  <Function id="qiskit_ibm_runtime.IBMBackend.close_session" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.21/qiskit_ibm_runtime/ibm_backend.py#L848-L856" signature="close_session()">
  ...
  <Function id="qiskit_ibm_runtime.IBMBackend.configuration" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.21/qiskit_ibm_runtime/ibm_backend.py#L447-L462" signature="configuration()">
  ...
  <Function id="qiskit_ibm_runtime.IBMBackend.control_channel" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.21/qiskit_ibm_runtime/ibm_backend.py#L488-L501" signature="control_channel(qubits)">
  ...
  <Function id="qiskit_ibm_runtime.IBMBackend.defaults" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.21/qiskit_ibm_runtime/ibm_backend.py#L424-L445" signature="defaults(refresh=False)">
  ...
  <Function id="qiskit_ibm_runtime.IBMBackend.drive_channel" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.21/qiskit_ibm_runtime/ibm_backend.py#L464-L470" signature="drive_channel(qubit)">
  ...
  <Function id="qiskit_ibm_runtime.IBMBackend.measure_channel" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.21/qiskit_ibm_runtime/ibm_backend.py#L472-L478" signature="measure_channel(qubit)">
  ...
  <Function id="qiskit_ibm_runtime.IBMBackend.open_session" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.21/qiskit_ibm_runtime/ibm_backend.py#L823-L832" signature="open_session(max_time=None)">
    Open session
  ...
  <Function id="qiskit_ibm_runtime.IBMBackend.properties" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.21/qiskit_ibm_runtime/ibm_backend.py#L348-L398" signature="properties(refresh=False, datetime=None)">
  ...
  <Function id="qiskit_ibm_runtime.IBMBackend.status" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.21/qiskit_ibm_runtime/ibm_backend.py#L400-L422" signature="status()">
  ...
  <Function id="qiskit_ibm_runtime.IBMBackend.target_history" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.21/qiskit_ibm_runtime/ibm_backend.py#L338-L346" signature="target_history(datetime=None)">
