---
title: qiskit_ibm_runtime (v0.21)
description: API reference for qiskit_ibm_runtime in qiskit-ibm-runtime v0.21
...
| [`EstimatorV2`](estimator-v-2 "qiskit_ibm_runtime.EstimatorV2")(\[backend, session, options])                           | Class for interacting with Qiskit Runtime Estimator primitive service.             |
...
| [`SamplerV2`](sampler-v-2 "qiskit_ibm_runtime.SamplerV2")(\[backend, session, options])                                 | Class for interacting with Qiskit Runtime Sampler primitive service.               |
