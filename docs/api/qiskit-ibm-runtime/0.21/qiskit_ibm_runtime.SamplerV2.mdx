---
title: SamplerV2 (v0.21)
description: API reference for qiskit_ibm_runtime.SamplerV2 in qiskit-ibm-runtime v0.21
...
<Class id="qiskit_ibm_runtime.SamplerV2" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.21/qiskit_ibm_runtime/sampler.py#L46-L137" signature="SamplerV2(backend=None, session=None, options=None)" modifiers="class">
  ...
  **NotImplementedError** – If “q-ctrl” channel strategy is used.
  ...
  <Function id="qiskit_ibm_runtime.SamplerV2.run" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.21/qiskit_ibm_runtime/sampler.py#L97-L124" signature="run(pubs, *, shots=None)">
