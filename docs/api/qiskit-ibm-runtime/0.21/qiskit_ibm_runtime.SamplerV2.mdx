...
<Class id="qiskit_ibm_runtime.SamplerV2" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.21/qiskit_ibm_runtime/sampler.py#L46-L137" signature="SamplerV2(backend=None, session=None, options=None)">
