...
<Class id="qiskit_ibm_runtime.SamplerV1" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.21/qiskit_ibm_runtime/sampler.py#L140-L290" signature="SamplerV1(backend=None, session=None, options=None)">
