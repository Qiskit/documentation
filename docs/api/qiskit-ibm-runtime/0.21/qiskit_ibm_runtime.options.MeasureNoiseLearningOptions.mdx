---
title: MeasureNoiseLearningOptions (v0.21)
description: API reference for qiskit_ibm_runtime.options.MeasureNoiseLearningOptions in qiskit-ibm-runtime v0.21
