...
<Class id="qiskit_ibm_runtime.EstimatorV2" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.21/qiskit_ibm_runtime/estimator.py#L48-L177" signature="EstimatorV2(backend=None, session=None, options=None)">
  ...
  **NotImplementedError** – If “q-ctrl” channel strategy is used.
  ...
  <Attribute id="qiskit_ibm_runtime.EstimatorV2.session" name="session">
  ...
  <Attribute id="qiskit_ibm_runtime.EstimatorV2.version" name="version" attributeValue="= 2" />

  ## Methods

  ### run

  <Function id="qiskit_ibm_runtime.EstimatorV2.run" name="run" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.21/qiskit_ibm_runtime/estimator.py#L137-L154" signature="run(pubs, *, precision=None)">
