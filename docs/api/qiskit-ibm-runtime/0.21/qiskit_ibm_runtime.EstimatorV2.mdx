...
<Class id="qiskit_ibm_runtime.EstimatorV2" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.21/qiskit_ibm_runtime/estimator.py#L48-L177" signature="EstimatorV2(backend=None, session=None, options=None)">
