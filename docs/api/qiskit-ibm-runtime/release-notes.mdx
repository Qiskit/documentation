...
*   Virtual private endpoints for IBM Quantum Platform are now supported. Learn more in our [virtual private endpoints guide](/docs/security/virtual-private-endpoints). ([2367](https://github.com/Qiskit/qiskit-ibm-runtime/pull/2367))
