...
*   The `post_selection` option [`NoiseLearnerV3`](/docs/api/qiskit-ibm-runtime/noise-learner-v3-noise-learner-v3 "qiskit_ibm_runtime.noise_learner_v3.NoiseLearnerV3") is now deprecated and will be removed in a future release. ([3160](https://github.com/Qiskit/qiskit-ibm-runtime/pull/3160))

### New Features

*   Added `MidCircuitReset` instruction and `ConvertToMidCircuitResetAndMeasure` transpiler pass. The new pass extends the existing [`ConvertToMidCircuitMeasure`](/docs/api/qiskit-ibm-runtime/transpiler-passes-convert-to-mid-circuit-measure "qiskit_ibm_runtime.transpiler.passes.ConvertToMidCircuitMeasure") functionality by also replacing non-terminal `reset` instructions with hardware-specific mid-circuit reset implementations. ([2903](https://github.com/Qiskit/qiskit-ibm-runtime/pull/2903))
...
*   [`IBMBackend`](/docs/api/qiskit-ibm-runtime/ibm-backend "qiskit_ibm_runtime.IBMBackend") now has a `physical_qubits` attribute, which returns the number of physical qubits for the backend (programmable qubits, reset qubits, and couplers combined). The attribute is also available in `FakeBackendV2` for backends that are not retired. ([3080](https://github.com/Qiskit/qiskit-ibm-runtime/pull/3080))
...
*   [`FakeProviderForBackendV2.backends()`](/docs/api/qiskit-ibm-runtime/fake-provider-fake-provider-for-backend-v2#backends "qiskit_ibm_runtime.fake_provider.FakeProviderForBackendV2.backends") now also returns eight fake backends that were importable from [`qiskit_ibm_runtime.fake_provider`](/docs/api/qiskit-ibm-runtime/fake-provider#module-qiskit_ibm_runtime.fake_provider "qiskit_ibm_runtime.fake_provider") but missing from the provider’s backend list, in addition to the ones it already returned: [`FakeAachen`](/docs/api/qiskit-ibm-runtime/fake-provider-fake-aachen "qiskit_ibm_runtime.fake_provider.FakeAachen"), [`FakeBerlin`](/docs/api/qiskit-ibm-runtime/fake-provider-fake-berlin "qiskit_ibm_runtime.fake_provider.FakeBerlin"), [`FakeBoston`](/docs/api/qiskit-ibm-runtime/fake-provider-fake-boston "qiskit_ibm_runtime.fake_provider.FakeBoston"), [`FakeBrussels`](/docs/api/qiskit-ibm-runtime/fake-provider-fake-brussels "qiskit_ibm_runtime.fake_provider.FakeBrussels"), [`FakeKingston`](/docs/api/qiskit-ibm-runtime/fake-provider-fake-kingston "qiskit_ibm_runtime.fake_provider.FakeKingston"), [`FakeMiami`](/docs/api/qiskit-ibm-runtime/fake-provider-fake-miami "qiskit_ibm_runtime.fake_provider.FakeMiami"), [`FakePittsburgh`](/docs/api/qiskit-ibm-runtime/fake-provider-fake-pittsburgh "qiskit_ibm_runtime.fake_provider.FakePittsburgh"), and [`FakeStrasbourg`](/docs/api/qiskit-ibm-runtime/fake-provider-fake-strasbourg "qiskit_ibm_runtime.fake_provider.FakeStrasbourg"). Previously, calling `FakeProviderForBackendV2().backend(name="fake_kingston")` (and the other seven) raised a `QiskitBackendNotFoundError` even though the backend classes existed. ([3164](https://github.com/Qiskit/qiskit-ibm-runtime/pull/3164))
...
*   Running a [`SamplerV2`](/docs/api/qiskit-ibm-runtime/sampler-v2 "qiskit_ibm_runtime.SamplerV2") job with different `pub.shots` values across PUBs is deprecated. Similarly, running an [`EstimatorV2`](/docs/api/qiskit-ibm-runtime/estimator-v2 "qiskit_ibm_runtime.EstimatorV2") job with different `pub.precision` values across PUBs is deprecated. ([2992](https://github.com/Qiskit/qiskit-ibm-runtime/pull/2992))

*   Setting [`MeasureNoiseLearningOptions.shots_per_randomization`](/docs/api/qiskit-ibm-runtime/options-measure-noise-learning-options#shots_per_randomization "qiskit_ibm_runtime.options.MeasureNoiseLearningOptions.shots_per_randomization") to an `int` value is deprecated and will be removed in future releases. Please use `"auto"` instead. ([3004](https://github.com/Qiskit/qiskit-ibm-runtime/pull/3004))

<span id="id5" />

### New Features

*   The [`RuntimeJobV2.usage()`](/docs/api/qiskit-ibm-runtime/runtime-job-v2#usage "qiskit_ibm_runtime.RuntimeJobV2.usage") method now supports an optional `partial` parameter ([2884](https://github.com/Qiskit/qiskit-ibm-runtime/pull/2884)):
...
*   Fixed a bug in the [`FoldRzzAngle`](/docs/api/qiskit-ibm-runtime/transpiler-passes-fold-rzz-angle "qiskit_ibm_runtime.transpiler.passes.FoldRzzAngle") transpiler pass where `Rzz` gates whose angle wraps exactly onto the `+-pi` boundary (for example `3*pi`, `-3*pi`, `7*pi`) were folded into a circuit that differed from the original by a global phase of `pi`. The pass now derives the dropped `2*pi` winding parity directly from the wrapped angle, so the folded circuit preserves the full unitary (including global phase) for all angles. ([2856](https://github.com/Qiskit/qiskit-ibm-runtime/pull/2856))
*   When using backends from different instances, the service used by [`SamplerV2.run()`](/docs/api/qiskit-ibm-runtime/sampler-v2#run "qiskit_ibm_runtime.SamplerV2.run"), [`EstimatorV2.run()`](/docs/api/qiskit-ibm-runtime/estimator-v2#run "qiskit_ibm_runtime.EstimatorV2.run"), and other primitives’ `.run()` methods now ensures that the API client used for submitting the job is the one belonging to the backend, instead of always using the active API client. ([2931](https://github.com/Qiskit/qiskit-ibm-runtime/pull/2931))
*   Fixed the folding of out-of-bounds `rzz` angles during transpilation. With the previous setting there was a bug, where translation passes that ran after the FoldRzzAngle pass could modify angles and make them negative or greater than `pi/2`. The bug is fixed by setting the `angle_bounds` in the backend’s target to `(0, pi/2)` for the `rzz` gate, and registering an `rzz` wrapper with the transpiler’s `WrapAngles` pass. This mechanism replaces the usage of the `IBMDynamicFractionalTranslationPlugin` plugin and the [`FoldRzzAngle`](/docs/api/qiskit-ibm-runtime/transpiler-passes-fold-rzz-angle "qiskit_ibm_runtime.transpiler.passes.FoldRzzAngle") transpiler pass. ([2960](https://github.com/Qiskit/qiskit-ibm-runtime/pull/2960))
...
*   Added [`draw_chunk_timings()`](/docs/api/qiskit-ibm-runtime/visualization-draw-chunk-timings "qiskit_ibm_runtime.visualization.draw_chunk_timings") to [`qiskit_ibm_runtime.visualization`](/docs/api/qiskit-ibm-runtime/visualization#module-qiskit_ibm_runtime.visualization "qiskit_ibm_runtime.visualization") for plotting the execution timing of one or more instances of the new chunk timings container class, [`ChunkTiming`](/docs/api/qiskit-ibm-runtime/results-chunk-timing "qiskit_ibm_runtime.results.ChunkTiming"), on an interactive barchart. A convenience [`ChunkTiming.draw()`](/docs/api/qiskit-ibm-runtime/results-chunk-timing#draw "qiskit_ibm_runtime.results.ChunkTiming.draw") method is also available for the single-result case via `job.result().timing.draw()`. ([2727](https://github.com/Qiskit/qiskit-ibm-runtime/pull/2727))
...
*   If a backend that does not support fractional gates is requested by setting the flag `use_fractional_gates=True` in [`QiskitRuntimeService.backend()`](/docs/api/qiskit-ibm-runtime/qiskit-runtime-service#backend "qiskit_ibm_runtime.QiskitRuntimeService.backend"), `IBMInputValueError` will be raised. ([2405](https://github.com/Qiskit/qiskit-ibm-runtime/pull/2405))
...
*   It is now possible to retrieve the job tags of a job without having to actually fetch the job with [`QiskitRuntimeService.job()`](/docs/api/qiskit-ibm-runtime/qiskit-runtime-service#job "qiskit_ibm_runtime.QiskitRuntimeService.job"). ([2420](https://github.com/Qiskit/qiskit-ibm-runtime/pull/2420))
...
*   [`RuntimeJobV2.properties()`](/docs/api/qiskit-ibm-runtime/runtime-job-v2#properties "qiskit_ibm_runtime.RuntimeJobV2.properties") will now fetch the backend properties from when the job started running instead of when the job was created. ([2369](https://github.com/Qiskit/qiskit-ibm-runtime/pull/2369))

*   Fixed an inconsistency in the unit conversion of `rep_times` in [`QasmBackendConfiguration`](/docs/api/qiskit-ibm-runtime/models-qasm-backend-configuration "qiskit_ibm_runtime.models.QasmBackendConfiguration") to maintain consistency between initialization and serialization. The parameter is now properly converted from microseconds to seconds during initialization and back to microseconds when serialized through `to_dict()`, matching the behavior of other timing parameters: `rep_delay_range` and `default_rep_delay`. ([2386](https://github.com/Qiskit/qiskit-ibm-runtime/pull/2386))

*   A consistent error will now be raised during service initialization if an invalid API token is given to [`QiskitRuntimeService`](/docs/api/qiskit-ibm-runtime/qiskit-runtime-service "qiskit_ibm_runtime.QiskitRuntimeService").
...
*   Fixed multiple bugs where having a default saved instance or passing in the instance name would result in an an `IBMInputValueError` when creating a [`Session`](/docs/api/qiskit-ibm-runtime/session "qiskit_ibm_runtime.Session") / [`Batch`](/docs/api/qiskit-ibm-runtime/batch "qiskit_ibm_runtime.Batch")
...
> *   [`QiskitRuntimeService.least_busy()`](/docs/api/qiskit-ibm-runtime/qiskit-runtime-service#least_busy "qiskit_ibm_runtime.QiskitRuntimeService.least_busy") is significantly faster.
> *   [`QiskitRuntimeService.usage()`](/docs/api/qiskit-ibm-runtime/qiskit-runtime-service#usage "qiskit_ibm_runtime.QiskitRuntimeService.usage") has been updated to return information regarding the current instance usage limit, consumption, and time remaining.
...
*   With the migration to the new IBM Quantum Platform, there were a few inconsistencies with IBM Quantum Platform Classic that needed to be addressed:
    ...
    > *   [`QiskitRuntimeService.usage()`](/docs/api/qiskit-ibm-runtime/qiskit-runtime-service#usage "qiskit_ibm_runtime.QiskitRuntimeService.usage") now returns usage information for the current active IBM Cloud instance.
    > *   [`QiskitRuntimeService.delete_job()`](/docs/api/qiskit-ibm-runtime/qiskit-runtime-service#delete_job "qiskit_ibm_runtime.QiskitRuntimeService.delete_job") is not supported on the new platform, so it has been deprecated.
...
*   There is a new method, [`QiskitRuntimeService.active_instance()`](/docs/api/qiskit-ibm-runtime/qiskit-runtime-service#active_instance "qiskit_ibm_runtime.QiskitRuntimeService.active_instance") which returns the IBM Cloud CRN of the current active instance.

    The [`QiskitRuntimeService.jobs()`](/docs/api/qiskit-ibm-runtime/qiskit-runtime-service#jobs "qiskit_ibm_runtime.QiskitRuntimeService.jobs") method has been updated to properly accept the `instance` parameter, which can be used to filter jobs. ([2325](https://github.com/Qiskit/qiskit-ibm-runtime/pull/2325))

*   [`QiskitRuntimeService.usage()`](/docs/api/qiskit-ibm-runtime/qiskit-runtime-service#usage "qiskit_ibm_runtime.QiskitRuntimeService.usage") has been updated to include a `usage_remaining_seconds` field. This field includes the difference between the reported `usage_limit_seconds` or `usage_allocation_seconds` (depending on how the instance is configured) and `usage_consumed_seconds`. Learn more about instance allocation limits [here](/docs/guides/allocation-limits). ([2329](https://github.com/Qiskit/qiskit-ibm-runtime/pull/2329))
...
*   Fixed a bug in `BasePrimitive` where primitives instantiated inside a [`Session`](/docs/api/qiskit-ibm-runtime/session "qiskit_ibm_runtime.Session") or [`Batch`](/docs/api/qiskit-ibm-runtime/batch "qiskit_ibm_runtime.Batch") context manager without the `mode` parameter would fetch the backend from the service (by name) instead of using the backend passed to the [`Session`](/docs/api/qiskit-ibm-runtime/session "qiskit_ibm_runtime.Session") or [`Batch`](/docs/api/qiskit-ibm-runtime/batch "qiskit_ibm_runtime.Batch"). This could cause issues when the [`Session`](/docs/api/qiskit-ibm-runtime/session "qiskit_ibm_runtime.Session") or [`Batch`](/docs/api/qiskit-ibm-runtime/batch "qiskit_ibm_runtime.Batch") backend was modified by users (for example, by removing a gate), because the primitives would instead fetch the unmodified backend object from the service. After the fix, the [`Session`](/docs/api/qiskit-ibm-runtime/session "qiskit_ibm_runtime.Session") or [`Batch`](/docs/api/qiskit-ibm-runtime/batch "qiskit_ibm_runtime.Batch") backend object is used directly. ([2282](https://github.com/Qiskit/qiskit-ibm-runtime/pull/2282))
*   Fixed an issue in [`IBMBackend`](/docs/api/qiskit-ibm-runtime/ibm-backend "qiskit_ibm_runtime.IBMBackend") where property changes, such as modifications to `basis_gates`, persisted even after the backend object was renewed. ([2283](https://github.com/Qiskit/qiskit-ibm-runtime/pull/2283))
*   Fixed the serialization of execution spans, to ensure that executions of old versions of qiskit-ibm-runtime will not crash when trying to decode newly encoded execution spans. However the deserialization with old versions will now return the execution spans in the format of a dictionary, and not in the form of an [`ExecutionSpans`](/docs/api/qiskit-ibm-runtime/execution-span-execution-spans "qiskit_ibm_runtime.execution_span.ExecutionSpans") object. As part of this work, we also removed the `data_slice_version` field from [`TwirledSliceSpan`](/docs/api/qiskit-ibm-runtime/execution-span-twirled-slice-span "qiskit_ibm_runtime.execution_span.TwirledSliceSpan"); twirled slice spans that are aware of the pub shots are now managed by a new class `TwirledSliceSpanV2`. ([2347](https://github.com/Qiskit/qiskit-ibm-runtime/pull/2347))

<span id="id45" />

### Other Notes

*   The deprecated [`IBMBackend`](/docs/api/qiskit-ibm-runtime/ibm-backend "qiskit_ibm_runtime.IBMBackend") attributes, `max_shots` and `max_experiments`, have been removed and the `IBMBackend.max_circuits()` method now returns `None`. See the [job limits guide](/docs/guides/job-limits#job-limits) for details. ([2235](https://github.com/Qiskit/qiskit-ibm-runtime/pull/2235))
*   The deprecated [`IBMBackend`](/docs/api/qiskit-ibm-runtime/ibm-backend "qiskit_ibm_runtime.IBMBackend") and `FakeBackendV2` `defaults()` methods have been removed. They were deprecated in the v0.38.0 release. Pulse defaults have also been removed from all fake backends. ([2238](https://github.com/Qiskit/qiskit-ibm-runtime/pull/2238))
*   Improved the error message returned when [`ExecutionSpan.mask()`](/docs/api/qiskit-ibm-runtime/execution-span-execution-span#mask "qiskit_ibm_runtime.execution_span.ExecutionSpan.mask") is called for a PUB that’s not contained in the span. ([2311](https://github.com/Qiskit/qiskit-ibm-runtime/pull/2311))
...
*   Fixed an issue where if there was no instance saved nor passed in at initialization, the service could not make any API calls until [`QiskitRuntimeService.backend()`](/docs/api/qiskit-ibm-runtime/qiskit-runtime-service#backend "qiskit_ibm_runtime.QiskitRuntimeService.backend") or [`QiskitRuntimeService.backends()`](/docs/api/qiskit-ibm-runtime/qiskit-runtime-service#backends "qiskit_ibm_runtime.QiskitRuntimeService.backends") is called first.
...
*   Pub inputs to [`EstimatorV2`](/docs/api/qiskit-ibm-runtime/estimator-v2 "qiskit_ibm_runtime.EstimatorV2") are now subject to a new validation step that checks that observables consist of Pauli operations that only contain \{I, X, Y, Z}. ([2254](https://github.com/Qiskit/qiskit-ibm-runtime/pull/2254))

<span id="id54" />

### Bug Fixes

*   A new parameter `create_new` has been added to the [`Batch`](/docs/api/qiskit-ibm-runtime/batch "qiskit_ibm_runtime.Batch") and [`Session`](/docs/api/qiskit-ibm-runtime/session "qiskit_ibm_runtime.Session") classes. This parameter allows users to control whether the POST session API endpoint should be called when initializing the class. It defaults to `True` as this is the case for most user-facing workflows. However, methods such as [`Session.from_id()`](/docs/api/qiskit-ibm-runtime/session#from_id "qiskit_ibm_runtime.Session.from_id") set it to `False` to avoid generating a new session when the original session is still active. This fixed issues where multiple sessions were generated simultaneously when calling `.from_id()`. ([2195](https://github.com/Qiskit/qiskit-ibm-runtime/pull/2195))
*   Removed the incorrect `Optional` type hint for the `backend` parameter in [`Session`](/docs/api/qiskit-ibm-runtime/session "qiskit_ibm_runtime.Session") and [`Batch`](/docs/api/qiskit-ibm-runtime/batch "qiskit_ibm_runtime.Batch"). ([2222](https://github.com/Qiskit/qiskit-ibm-runtime/pull/2222))
*   [`Session.from_id()`](/docs/api/qiskit-ibm-runtime/session#from_id "qiskit_ibm_runtime.Session.from_id") now raises an error if the session does not have a known backend. This is usually the case if there haven’t been any jobs run in the session yet. ([2226](https://github.com/Qiskit/qiskit-ibm-runtime/pull/2226))
...
*   Added a new transpiler translation plugin `IBMFractionalTranslationPlugin` and a pass [`FoldRzzAngle`](/docs/api/qiskit-ibm-runtime/transpiler-passes-fold-rzz-angle "qiskit_ibm_runtime.transpiler.passes.FoldRzzAngle"). This plugin is automatically applied for backends retrieved with the `use_fractional_gates` opt-in, and the folding pass is added when the backend target includes the `RZZ` gate.
...
*   Added [`draw_execution_spans()`](/docs/api/qiskit-ibm-runtime/visualization-draw-execution-spans "qiskit_ibm_runtime.visualization.draw_execution_spans"), a function for creating a Plotly figure that visualizes one or more [`ExecutionSpans`](/docs/api/qiskit-ibm-runtime/execution-span-execution-spans "qiskit_ibm_runtime.execution_span.ExecutionSpans") objects. Also added the convenience method [`draw()`](/docs/api/qiskit-ibm-runtime/execution-span-execution-spans#draw "qiskit_ibm_runtime.execution_span.ExecutionSpans.draw") to invoke the drawing function on a particular instance. ([1923](https://github.com/Qiskit/qiskit-ibm-runtime/pull/1923))
...
*   Added [`DoubleSliceSpan`](/docs/api/qiskit-ibm-runtime/execution-span-double-slice-span "qiskit_ibm_runtime.execution_span.DoubleSliceSpan"), an `ExecutionSpan` for batching with two slices. ([1982](https://github.com/Qiskit/qiskit-ibm-runtime/pull/1982))

*   Each of [`SamplerV2`](/docs/api/qiskit-ibm-runtime/sampler-v2 "qiskit_ibm_runtime.SamplerV2"), [`EstimatorV2`](/docs/api/qiskit-ibm-runtime/estimator-v2 "qiskit_ibm_runtime.EstimatorV2"), and [`noise_learner.NoiseLearner`](/docs/api/qiskit-ibm-runtime/noise-learner-noise-learner "qiskit_ibm_runtime.noise_learner.NoiseLearner") now has a `backend()` method that returns the backend that the class is configured with. ([1995](https://github.com/Qiskit/qiskit-ibm-runtime/pull/1995))
...
*   We added new classes, [`ExecutionSpan`](/docs/api/qiskit-ibm-runtime/execution-span-execution-span "qiskit_ibm_runtime.execution_span.ExecutionSpan") and `ExecutionSpanSet`. These classes are used in the primitive result metadata, to convey information about start and stop times of batch jobs. ([1833](https://github.com/Qiskit/qiskit-ibm-runtime/pull/1833))
...
*   New opt-in feature to support fractional gates is added to [`IBMBackend`](/docs/api/qiskit-ibm-runtime/ibm-backend "qiskit_ibm_runtime.IBMBackend"). IBM backends currently support dynamic circuits and fractional gates exclusively and the two features cannot be used in the same primitive job. In addition, some error mitigation protocols you can use with the estimator primitive, such as PEC or PEA, may not support gate twirling with the fractional gates. Since Qiskit Target model doesn’t represent such constraint, we adopted the opt-in approach, where your backend target includes only fractional gates (control flow instructions) when the backend is (not) opted. This feature is controlled when you retrieve the target backend from the [`QiskitRuntimeService`](/docs/api/qiskit-ibm-runtime/qiskit-runtime-service "qiskit_ibm_runtime.QiskitRuntimeService").
...
*   You can now use the experimental option in [`qiskit_ibm_runtime.options.EstimatorOptions`](/docs/api/qiskit-ibm-runtime/options-estimator-options "qiskit_ibm_runtime.options.EstimatorOptions") to enable Probabilistic Error Amplification (PEA) error mitigation method for your estimator jobs. ([1728](https://github.com/Qiskit/qiskit-ibm-runtime/pull/1728))
...
*   Fixed the combination of `insert_multiple_cycles` and `coupling_map` options in [`PadDynamicalDecoupling`](/docs/api/qiskit-ibm-runtime/transpiler-passes-scheduling-pad-dynamical-decoupling "qiskit_ibm_runtime.transpiler.passes.scheduling.PadDynamicalDecoupling"). This combination allows to select staggered dynamical decoupling with multiple sequence cycles in each delay that crosses the threshold set by `sequence_min_length_ratios`. ([1630](https://github.com/Qiskit/qiskit-ibm-runtime/pull/1630))
...
*   Add `block_ordering_callable` argument to [`BlockBasePadder`](/docs/api/qiskit-ibm-runtime/transpiler-passes-scheduling-block-base-padder "qiskit_ibm_runtime.transpiler.passes.scheduling.BlockBasePadder"), [`PadDynamicalDecoupling`](/docs/api/qiskit-ibm-runtime/transpiler-passes-scheduling-pad-dynamical-decoupling "qiskit_ibm_runtime.transpiler.passes.scheduling.PadDynamicalDecoupling"), [`PadDelay`](/docs/api/qiskit-ibm-runtime/transpiler-passes-scheduling-pad-delay "qiskit_ibm_runtime.transpiler.passes.scheduling.PadDelay"), and `BaseDynamicCircuitAnalysis`. This allows the user to construct blocks using an algorithm of their choosing. No assumptions or checks are made on the validity of the output that the `block_ordering_callable` produces. The motivation for this argument is that for some families of circuits, the existing function `block_order_op_nodes` can be very slow. ([1531](https://github.com/Qiskit/qiskit-ibm-runtime/pull/1531))
...
*   [`SamplerV2`](/docs/api/qiskit-ibm-runtime/sampler-v2 "qiskit_ibm_runtime.SamplerV2") now supports twirling. Twirling will only be applied to those measurement registers not involved within a conditional logic. ([1557](https://github.com/Qiskit/qiskit-ibm-runtime/pull/1557))
...
*   [`RuntimeJobV2`](/docs/api/qiskit-ibm-runtime/runtime-job-v2 "qiskit_ibm_runtime.RuntimeJobV2") will no longer error when the API returns an unknown status. Instead, the status from the API will directly be returned. ([1476](https://github.com/Qiskit/qiskit-ibm-runtime/pull/1476))
...
*   Fixed an issue where the [in\_final\_state()](/docs/api/qiskit-ibm-runtime/runtime-job-v2#in_final_state) method in [`RuntimeJobV2`](/docs/api/qiskit-ibm-runtime/runtime-job-v2 "qiskit_ibm_runtime.RuntimeJobV2") would not update the status when called. ([1547](https://github.com/Qiskit/qiskit-ibm-runtime/pull/1547))
