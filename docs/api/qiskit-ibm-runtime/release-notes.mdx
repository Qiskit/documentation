...
*   The V1 Primitives `SamplerV1` and `EstimatorV1` have been completely removed. Please use the [migration guide](/migration-guides/v2-primitives) and use theV2 Primitives instead. ([1857](https://github.com/Qiskit/qiskit-ibm-runtime/pull/1857))
