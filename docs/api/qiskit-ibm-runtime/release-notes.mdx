...
*   Added serialization for [`qiskit.quantum_info.PauliLindbladMap`](/docs/api/qiskit/qiskit.quantum_info.PauliLindbladMap "(in Qiskit v2.1)"). ([2297](https://github.com/Qiskit/qiskit-ibm-runtime/pull/2297))
