...
<Class id="qiskit_ibm_runtime.RuntimeDecoder" github="https://github.com/qiskit/qiskit-ibm-runtime/tree/stable/0.17/qiskit_ibm_runtime/utils/json.py" signature="RuntimeDecoder(*args, **kwargs)">
