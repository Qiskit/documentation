...
<Class id="qiskit_ibm_runtime.Sampler" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-ibm-runtime/tree/stable/0.17/qiskit_ibm_runtime/sampler.py" signature="Sampler(backend=None, session=None, options=None)">
  ...
  *   **options** (`Union`\[`Dict`, [`Options`](qiskit_ibm_runtime.options.Options "qiskit_ibm_runtime.options.options.Options"), `None`]) – Primitive options, see `Options` for detailed description. The `backend` keyword is still supported but is deprecated.
  ...
  <Attribute id="qiskit_ibm_runtime.Sampler.circuits" name="circuits">
  ...
  <Attribute id="qiskit_ibm_runtime.Sampler.parameters" name="parameters">
  ...
  <Function id="qiskit_ibm_runtime.Sampler.run" name="run" signature="run(circuits, parameter_values=None, **kwargs)">
  ...
  <Function id="qiskit_ibm_runtime.Sampler.set_options" name="set_options" signature="set_options(**fields)">
