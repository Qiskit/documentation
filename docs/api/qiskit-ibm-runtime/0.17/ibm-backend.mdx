---
title: IBMBackend (v0.17)
description: API reference for qiskit_ibm_runtime.IBMBackend in qiskit-ibm-runtime v0.17
...
<Class id="qiskit_ibm_runtime.IBMBackend" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-ibm-runtime/tree/stable/0.17/qiskit_ibm_runtime/ibm_backend.py" signature="IBMBackend(configuration, service, api_client, instance=None)" modifiers="class">
  ...
  *   **api\_client** (`BaseBackendClient`) – IBM client used to communicate with the server.
  ...
  <Function id="qiskit_ibm_runtime.IBMBackend.open_session" signature="open_session()">
    Open session
