---
title: ResilienceOptions (v0.17)
description: API reference for qiskit_ibm_runtime.options.ResilienceOptions in qiskit-ibm-runtime v0.17
...
<Class id="qiskit_ibm_runtime.options.ResilienceOptions" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-ibm-runtime/tree/stable/0.17/qiskit_ibm_runtime/options/resilience_options.py" signature="ResilienceOptions(noise_amplifier=None, noise_factors=None, extrapolator=None)" modifiers="class">
  Resilience options.
