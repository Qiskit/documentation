---
title: Estimator (v0.17)
description: API reference for qiskit_ibm_runtime.Estimator in qiskit-ibm-runtime v0.17
...
<Class id="qiskit_ibm_runtime.Estimator" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-ibm-runtime/tree/stable/0.17/qiskit_ibm_runtime/estimator.py" signature="Estimator(backend=None, session=None, options=None)" modifiers="class">
