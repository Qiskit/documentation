...
<Class id="qiskit_ibm_runtime.RuntimeEncoder" github="https://github.com/qiskit/qiskit-ibm-runtime/tree/stable/0.17/qiskit_ibm_runtime/utils/json.py" signature="RuntimeEncoder(*, skipkeys=False, ensure_ascii=True, check_circular=True, allow_nan=True, sort_keys=False, indent=None, separators=None, default=None)">
  ...
  <Attribute id="qiskit_ibm_runtime.RuntimeEncoder.item_separator" name="item_separator" attributeValue="= ', '" />

  ### key\_separator

  <Attribute id="qiskit_ibm_runtime.RuntimeEncoder.key_separator" name="key_separator" attributeValue="= ': '" />

  ## Methods

  ### default

  <Function id="qiskit_ibm_runtime.RuntimeEncoder.default" name="default" signature="default(obj)">
  ...
  <Function id="qiskit_ibm_runtime.RuntimeEncoder.encode" name="encode" signature="encode(o)">
  ...
  <Function id="qiskit_ibm_runtime.RuntimeEncoder.iterencode" name="iterencode" signature="iterencode(o, _one_shot=False)">
