...
<Class id="qiskit_ibm_runtime.models.UchannelLO" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.50/qiskit_ibm_runtime/models/backend_configuration.py#L129-L182" signature="UchannelLO(q, scale)" modifiers="class">
  Bases: `object`
  ...
  **QiskitError** – If q is \< 0
  ...
  <Function id="qiskit_ibm_runtime.models.UchannelLO.from_dict" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.50/qiskit_ibm_runtime/models/backend_configuration.py#L150-L161" signature="from_dict(data)" modifiers="classmethod">
  ...
  <Function id="qiskit_ibm_runtime.models.UchannelLO.to_dict" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.50/qiskit_ibm_runtime/models/backend_configuration.py#L163-L173" signature="to_dict()">
