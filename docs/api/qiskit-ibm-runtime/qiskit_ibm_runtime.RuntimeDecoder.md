...
`RuntimeDecoder(*args, **kwargs)` [GitHub](https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.21/qiskit_ibm_runtime/utils/json.py#L332-L424 "view source code")
...
`object_hook(obj)` [GitHub](https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.21/qiskit_ibm_runtime/utils/json.py#L347-L424 "view source code")
