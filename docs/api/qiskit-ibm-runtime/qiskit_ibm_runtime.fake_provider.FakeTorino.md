...
<span id="qiskit_ibm_runtime.fake_provider.FakeTorino" />

`FakeTorino` [GitHub](https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.21/qiskit_ibm_runtime/fake_provider/backends/torino/fake_torino.py#L21-L28 "view source code")
...
<span id="qiskit_ibm_runtime.fake_provider.FakeTorino.backend_name" />

### backend\_name

`= 'fake_torino'`

<span id="qiskit_ibm_runtime.fake_provider.FakeTorino.conf_filename" />

### conf\_filename

`= 'conf_torino.json'`

<span id="qiskit_ibm_runtime.fake_provider.FakeTorino.coupling_map" />

### coupling\_map

Return the `CouplingMap` object

<span id="qiskit_ibm_runtime.fake_provider.FakeTorino.defs_filename" />

### defs\_filename

`= 'defs_torino.json'`

<span id="qiskit_ibm_runtime.fake_provider.FakeTorino.dirname" />

### dirname

`= '/home/runner/work/qiskit-ibm-runtime/qiskit-ibm-runtime/qiskit_ibm_runtime/fake_provider/backends/torino'`

<span id="qiskit_ibm_runtime.fake_provider.FakeTorino.dt" />
...
<span id="qiskit_ibm_runtime.fake_provider.FakeTorino.dtm" />
...
<span id="qiskit_ibm_runtime.fake_provider.FakeTorino.instruction_durations" />

### instruction\_durations

Return the `InstructionDurations` object.

<span id="qiskit_ibm_runtime.fake_provider.FakeTorino.instruction_schedule_map" />

### instruction\_schedule\_map

Return the `InstructionScheduleMap` for the instructions defined in this backend’s target.

<span id="qiskit_ibm_runtime.fake_provider.FakeTorino.instructions" />
...
<span id="qiskit_ibm_runtime.fake_provider.FakeTorino.max_circuits" />
...
<span id="qiskit_ibm_runtime.fake_provider.FakeTorino.meas_map" />
...
<span id="qiskit_ibm_runtime.fake_provider.FakeTorino.num_qubits" />
...
<span id="qiskit_ibm_runtime.fake_provider.FakeTorino.operation_names" />
...
<span id="qiskit_ibm_runtime.fake_provider.FakeTorino.operations" />
...
<span id="qiskit_ibm_runtime.fake_provider.FakeTorino.options" />
...
<span id="qiskit_ibm_runtime.fake_provider.FakeTorino.props_filename" />

### props\_filename

`= 'props_torino.json'`

<span id="qiskit_ibm_runtime.fake_provider.FakeTorino.provider" />
...
<span id="qiskit_ibm_runtime.fake_provider.FakeTorino.target" />
...
<span id="qiskit_ibm_runtime.fake_provider.FakeTorino.version" />

### version

`= 2`

<span id="qiskit_ibm_runtime.fake_provider.FakeTorino.name" />

### name

Name of the backend.

<span id="qiskit_ibm_runtime.fake_provider.FakeTorino.description" />

### description

Optional human-readable description.

<span id="qiskit_ibm_runtime.fake_provider.FakeTorino.online_date" />

### online\_date

Date that the backend came online.

<span id="qiskit_ibm_runtime.fake_provider.FakeTorino.backend_version" />
...
<span id="qiskit_ibm_runtime.fake_provider.FakeTorino.acquire_channel" />
...
<span id="qiskit_ibm_runtime.fake_provider.FakeTorino.control_channel" />
...
<span id="qiskit_ibm_runtime.fake_provider.FakeTorino.drive_channel" />
...
<span id="qiskit_ibm_runtime.fake_provider.FakeTorino.measure_channel" />
...
<span id="qiskit_ibm_runtime.fake_provider.FakeTorino.qubit_properties" />
...
<span id="qiskit_ibm_runtime.fake_provider.FakeTorino.run" />
...
<span id="qiskit_ibm_runtime.fake_provider.FakeTorino.set_options" />
