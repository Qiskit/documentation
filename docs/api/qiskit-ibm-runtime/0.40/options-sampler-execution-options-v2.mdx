---
title: SamplerExecutionOptionsV2 (v0.40)
description: API reference for qiskit_ibm_runtime.options.SamplerExecutionOptionsV2 in qiskit-ibm-runtime v0.40
