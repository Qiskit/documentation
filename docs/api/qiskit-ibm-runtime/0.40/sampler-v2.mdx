---
title: SamplerV2 (v0.40)
description: API reference for qiskit_ibm_runtime.SamplerV2 in qiskit-ibm-runtime v0.40
...
<Class id="qiskit_ibm_runtime.SamplerV2" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.40/qiskit_ibm_runtime/sampler.py#L44-L125" signature="SamplerV2(mode=None, options=None)" modifiers="class">
  Bases: `BasePrimitiveV2`\[[`SamplerOptions`](options-sampler-options "qiskit_ibm_runtime.options.sampler_options.SamplerOptions")], `Sampler`, [`BaseSamplerV2`](/docs/api/qiskit/qiskit.primitives.BaseSamplerV2 "(in Qiskit v2.0)")
  ...
  *   **options** (*Optional\[Union\[Dict,* [*SamplerOptions*](options-sampler-options "qiskit_ibm_runtime.options.SamplerOptions")*]]*) – Sampler options, see `SamplerOptions` for detailed description.
  ...
  <Function id="qiskit_ibm_runtime.SamplerV2.backend" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.40/qiskit_ibm_runtime/base_primitive.py#L226-L228" signature="backend()">
  ...
  <Function id="qiskit_ibm_runtime.SamplerV2.run" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.40/qiskit_ibm_runtime/sampler.py#L89-L111" signature="run(pubs, *, shots=None)">
