---
title: SimulatorOptions (v0.40)
description: API reference for qiskit_ibm_runtime.options.SimulatorOptions in qiskit-ibm-runtime v0.40
...
<Class id="qiskit_ibm_runtime.options.SimulatorOptions" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.40/qiskit_ibm_runtime/options/simulator_options.py#L33-L111" signature="SimulatorOptions(noise_model=Unset, seed_simulator=Unset, coupling_map=Unset, basis_gates=Unset)" modifiers="class">
  ...
  *   **coupling\_map** (*UnsetType | List\[List\[int]] |* [*CouplingMap*](/docs/api/qiskit/qiskit.transpiler.CouplingMap "(in Qiskit v2.0)"))
  *   **basis\_gates** (*UnsetType | List\[str]*)
  ...
  <Function id="qiskit_ibm_runtime.options.SimulatorOptions.set_backend" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.40/qiskit_ibm_runtime/options/simulator_options.py#L88-L111" signature="set_backend(backend)">
    Set backend for simulation. This method changes noise\_model, coupling\_map, basis\_gates according to given backend.

    **Parameters**

    **backend** ([*BackendV2*](/docs/api/qiskit/qiskit.providers.BackendV2 "(in Qiskit v2.0)")) – backend to be set.
