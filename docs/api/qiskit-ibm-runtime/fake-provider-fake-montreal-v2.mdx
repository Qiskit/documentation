...
<Class id="qiskit_ibm_runtime.fake_provider.FakeMontrealV2" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.37/qiskit_ibm_runtime/fake_provider/backends/montreal/fake_montreal.py#L21-L28" signature="FakeMontrealV2" modifiers="class">
  Bases: `FakeBackendV2`
  ...
  <Function id="qiskit_ibm_runtime.fake_provider.FakeMontrealV2.acquire_channel" signature="acquire_channel(qubit)">
  ...
  <Function id="qiskit_ibm_runtime.fake_provider.FakeMontrealV2.check_faulty" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.37/qiskit_ibm_runtime/fake_provider/fake_backend.py#L198-L230" signature="check_faulty(circuit)">
  ...
  <Function id="qiskit_ibm_runtime.fake_provider.FakeMontrealV2.configuration" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.37/qiskit_ibm_runtime/fake_provider/fake_backend.py#L194-L196" signature="configuration()">
  ...
  <Function id="qiskit_ibm_runtime.fake_provider.FakeMontrealV2.control_channel" signature="control_channel(qubits)">
  ...
  <Function id="qiskit_ibm_runtime.fake_provider.FakeMontrealV2.defaults" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.37/qiskit_ibm_runtime/fake_provider/fake_backend.py#L179-L192" signature="defaults(refresh=False)">
  ...
  <Function id="qiskit_ibm_runtime.fake_provider.FakeMontrealV2.drive_channel" signature="drive_channel(qubit)">
  ...
  <Function id="qiskit_ibm_runtime.fake_provider.FakeMontrealV2.measure_channel" signature="measure_channel(qubit)">
  ...
  <Function id="qiskit_ibm_runtime.fake_provider.FakeMontrealV2.properties" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.37/qiskit_ibm_runtime/fake_provider/fake_backend.py#L166-L177" signature="properties(refresh=False)">
  ...
  <Function id="qiskit_ibm_runtime.fake_provider.FakeMontrealV2.refresh" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.37/qiskit_ibm_runtime/fake_provider/fake_backend.py#L426-L502" signature="refresh(service)">
  ...
  <Function id="qiskit_ibm_runtime.fake_provider.FakeMontrealV2.run" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.37/qiskit_ibm_runtime/fake_provider/fake_backend.py#L310-L341" signature="run(run_input, **options)">
  ...
  <Function id="qiskit_ibm_runtime.fake_provider.FakeMontrealV2.status" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.37/qiskit_ibm_runtime/fake_provider/fake_backend.py#L148-L164" signature="status()">
