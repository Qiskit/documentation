---
title: NoiseLearner (v0.34)
description: API reference for qiskit_ibm_runtime.noise_learner.NoiseLearner in qiskit-ibm-runtime v0.34
...
<Class id="qiskit_ibm_runtime.noise_learner.NoiseLearner" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.34/qiskit_ibm_runtime/noise_learner/noise_learner.py#L48-L273" signature="NoiseLearner(mode=None, options=None)" modifiers="class">
  Bases: `object`
  ...
  **References**
  ...
  <Function id="qiskit_ibm_runtime.noise_learner.NoiseLearner.backend" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.34/qiskit_ibm_runtime/noise_learner/noise_learner.py#L224-L226" signature="backend()">
    Return the backend the primitive query will be run on.

    **Return type**

    [*BackendV2*](/docs/api/qiskit/qiskit.providers.BackendV2 "(in Qiskit v1.3)")
  </Function>

  ### run

  <Function id="qiskit_ibm_runtime.noise_learner.NoiseLearner.run" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.34/qiskit_ibm_runtime/noise_learner/noise_learner.py#L145-L217" signature="run(circuits)">
