...
![\[Circuit diagram output by the previous code.\]](/images/api/qiskit-ibm-runtime/0.34/fake_provider-1.avif)
...
![\[Circuit diagram output by the previous code.\]](/images/api/qiskit-ibm-runtime/0.34/fake_provider-2.avif)
...
![\[Histogram output by the previous code.\]](/images/api/qiskit-ibm-runtime/0.34/fake_provider-3.avif)
