---
title: scheduling (v0.34)
description: API reference for qiskit_ibm_runtime.transpiler.passes.scheduling in qiskit-ibm-runtime v0.34
...
<Admonition title="Warning" type="caution">
  You should not mix these scheduling passes with Qiskit’s built in scheduling passes as they will negatively interact with the scheduling routines for dynamic circuits. This includes setting `scheduling_method` in [`transpile()`](/docs/api/qiskit/compiler#qiskit.compiler.transpile "(in Qiskit v1.3)") or [generate\_preset\_pass\_manager()](/docs/api/qiskit/qiskit.transpiler.generate_preset_pass_manager#qiskit.transpiler.generate_preset_pass_manager "(in Qiskit v1.3)").
</Admonition>
...
![\[Circuit diagram output by the previous code.\]](/docs/images/api/qiskit-ibm-runtime/0.34/qiskit_ibm_runtime-transpiler-passes-scheduling-1.avif)
...
![\[Circuit diagram output by the previous code.\]](/docs/images/api/qiskit-ibm-runtime/0.34/qiskit_ibm_runtime-transpiler-passes-scheduling-2.avif)

When compiling a circuit with Qiskit, it is more efficient and more robust to perform all the transformations in a single transpilation. This has been done above by extending Qiskit’s preset pass managers. For example, Qiskit’s [`transpile()`](/docs/api/qiskit/compiler#qiskit.compiler.transpile "(in Qiskit v1.3)") function internally builds its pass set by using [generate\_preset\_pass\_manager()](/docs/api/qiskit/qiskit.transpiler.generate_preset_pass_manager#qiskit.transpiler.generate_preset_pass_manager "(in Qiskit v1.3)"). This returns instances of [`StagedPassManager`](/docs/api/qiskit/qiskit.transpiler.StagedPassManager "(in Qiskit v1.3)"), which can be extended.
...
![\[Circuit diagram output by the previous code.\]](/docs/images/api/qiskit-ibm-runtime/0.34/qiskit_ibm_runtime-transpiler-passes-scheduling-3.avif)

The [`IBMBackend`](ibm-backend "qiskit_ibm_runtime.IBMBackend") configures a translation plugin `IBMTranslationPlugin` to automatically apply transformations and optimizations for IBM hardware backends when invoking [`transpile()`](/docs/api/qiskit/compiler#qiskit.compiler.transpile "(in Qiskit v1.3)"). This will automatically convert all old style `c_if` conditioned gates to new-style control-flow. We may then schedule the transpiled circuit without further modification.
...
![\[Circuit diagram output by the previous code.\]](/docs/images/api/qiskit-ibm-runtime/0.34/qiskit_ibm_runtime-transpiler-passes-scheduling-4.avif)

If you are not using the transpiler plugin stages to work around this please manually run the pass [qiskit.transpiler.passes.ConvertConditionsToIfOps](/docs/api/qiskit/1.4/qiskit.transpiler.passes.ConvertConditionsToIfOps "(in Qiskit v1.3)") prior to your scheduling pass.
...
![\[Circuit diagram output by the previous code.\]](/docs/images/api/qiskit-ibm-runtime/0.34/qiskit_ibm_runtime-transpiler-passes-scheduling-5.avif)
...
![\[Circuit diagram output by the previous code.\]](/docs/images/api/qiskit-ibm-runtime/0.34/qiskit_ibm_runtime-transpiler-passes-scheduling-6.avif)
...
![\[Circuit diagram output by the previous code.\]](/docs/images/api/qiskit-ibm-runtime/0.34/qiskit_ibm_runtime-transpiler-passes-scheduling-7.avif)
...
![\[Circuit diagram output by the previous code.\]](/docs/images/api/qiskit-ibm-runtime/0.34/qiskit_ibm_runtime-transpiler-passes-scheduling-8.avif)
...
![\[Circuit diagram output by the previous code.\]](/docs/images/api/qiskit-ibm-runtime/0.34/qiskit_ibm_runtime-transpiler-passes-scheduling-9.avif)
...
![\[Circuit diagram output by the previous code.\]](/docs/images/api/qiskit-ibm-runtime/0.34/qiskit_ibm_runtime-transpiler-passes-scheduling-10.avif)
...
![\[Circuit diagram output by the previous code.\]](/docs/images/api/qiskit-ibm-runtime/0.34/qiskit_ibm_runtime-transpiler-passes-scheduling-11.avif)
...
![\[Circuit diagram output by the previous code.\]](/docs/images/api/qiskit-ibm-runtime/0.34/qiskit_ibm_runtime-transpiler-passes-scheduling-12.avif)
...
![\[Circuit diagram output by the previous code.\]](/docs/images/api/qiskit-ibm-runtime/0.34/qiskit_ibm_runtime-transpiler-passes-scheduling-13.avif)
...
![\[Circuit diagram output by the previous code.\]](/docs/images/api/qiskit-ibm-runtime/0.34/qiskit_ibm_runtime-transpiler-passes-scheduling-14.avif)
...
![\[Circuit diagram output by the previous code.\]](/docs/images/api/qiskit-ibm-runtime/0.34/qiskit_ibm_runtime-transpiler-passes-scheduling-15.avif)
...
![\[Circuit diagram output by the previous code.\]](/docs/images/api/qiskit-ibm-runtime/0.34/qiskit_ibm_runtime-transpiler-passes-scheduling-16.avif)
...
<Admonition title="Note" type="note">
  ...
  ![\[Circuit diagram output by the previous code.\]](/docs/images/api/qiskit-ibm-runtime/0.34/qiskit_ibm_runtime-transpiler-passes-scheduling-17.avif)
</Admonition>
