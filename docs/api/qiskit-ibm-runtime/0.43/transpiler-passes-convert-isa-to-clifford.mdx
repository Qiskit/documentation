---
title: ConvertISAToClifford (v0.43)
description: API reference for qiskit_ibm_runtime.transpiler.passes.ConvertISAToClifford in qiskit-ibm-runtime v0.43
...
<Class id="qiskit_ibm_runtime.transpiler.passes.ConvertISAToClifford" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.43/qiskit_ibm_runtime/transpiler/passes/cliffordization/convert_isa_to_clifford.py#L51-L110" signature="ConvertISAToClifford(*args, **kwargs)" modifiers="class">
  ...
  **ValueError** – If the given circuit contains unsupported operations, such as non-ISA gates.
  ...
  <Function id="qiskit_ibm_runtime.transpiler.passes.ConvertISAToClifford.run" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.43/qiskit_ibm_runtime/transpiler/passes/cliffordization/convert_isa_to_clifford.py#L89-L110" signature="run(dag)">
