---
title: draw_execution_spans (v0.43)
description: API reference for qiskit_ibm_runtime.visualization.draw_execution_spans in qiskit-ibm-runtime v0.43
