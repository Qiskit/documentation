---
title: RuntimeJobV2 (v0.43)
description: API reference for qiskit_ibm_runtime.RuntimeJobV2 in qiskit-ibm-runtime v0.43
...
<Class id="qiskit_ibm_runtime.RuntimeJobV2" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.43/qiskit_ibm_runtime/runtime_job_v2.py#L51-L265" signature="RuntimeJobV2(backend, api_client, job_id, program_id, service, creation_date=None, result_decoder=None, image='', session_id=None, tags=None, version=None, private=False)" modifiers="class">
  ...
  *   **private** (*bool | None*) – Marks job as private.
  ...
  <Function id="qiskit_ibm_runtime.RuntimeJobV2.backend" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.43/qiskit_ibm_runtime/runtime_job_v2.py#L251-L265" signature="backend(timeout=None)">
  ...
  <Function id="qiskit_ibm_runtime.RuntimeJobV2.cancel" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.43/qiskit_ibm_runtime/runtime_job_v2.py#L141-L154" signature="cancel()">
    Cancel the job.
  ...
  <Function id="qiskit_ibm_runtime.RuntimeJobV2.cancelled" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.43/qiskit_ibm_runtime/runtime_job_v2.py#L182-L184" signature="cancelled()">
  ...
  <Function id="qiskit_ibm_runtime.RuntimeJobV2.done" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.43/qiskit_ibm_runtime/runtime_job_v2.py#L186-L188" signature="done()">
  ...
  <Function id="qiskit_ibm_runtime.RuntimeJobV2.error_message" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.43/qiskit_ibm_runtime/base_runtime_job.py#L190-L197" signature="error_message()">
  ...
  <Function id="qiskit_ibm_runtime.RuntimeJobV2.errored" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.43/qiskit_ibm_runtime/runtime_job_v2.py#L190-L192" signature="errored()">
  ...
  <Function id="qiskit_ibm_runtime.RuntimeJobV2.in_final_state" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.43/qiskit_ibm_runtime/runtime_job_v2.py#L194-L196" signature="in_final_state()">
  ...
  <Function id="qiskit_ibm_runtime.RuntimeJobV2.logs" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.43/qiskit_ibm_runtime/runtime_job_v2.py#L202-L221" signature="logs()">
    Return job logs.
  ...
  <Function id="qiskit_ibm_runtime.RuntimeJobV2.metrics" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.43/qiskit_ibm_runtime/base_runtime_job.py#L126-L142" signature="metrics()">
    Return job metrics.
  ...
  <Function id="qiskit_ibm_runtime.RuntimeJobV2.properties" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.43/qiskit_ibm_runtime/base_runtime_job.py#L173-L188" signature="properties(refresh=False)">
  ...
  <Function id="qiskit_ibm_runtime.RuntimeJobV2.result" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.43/qiskit_ibm_runtime/runtime_job_v2.py#L106-L139" signature="result(timeout=None, decoder=None)">
  ...
  <Function id="qiskit_ibm_runtime.RuntimeJobV2.running" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.43/qiskit_ibm_runtime/runtime_job_v2.py#L198-L200" signature="running()">
  ...
  <Function id="qiskit_ibm_runtime.RuntimeJobV2.status" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.43/qiskit_ibm_runtime/runtime_job_v2.py#L156-L163" signature="status()">
  ...
  <Function id="qiskit_ibm_runtime.RuntimeJobV2.update_tags" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.43/qiskit_ibm_runtime/base_runtime_job.py#L144-L171" signature="update_tags(new_tags)">
  ...
  <Function id="qiskit_ibm_runtime.RuntimeJobV2.usage" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.43/qiskit_ibm_runtime/base_runtime_job.py#L118-L124" signature="usage()">
  ...
  <Function id="qiskit_ibm_runtime.RuntimeJobV2.wait_for_final_state" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.43/qiskit_ibm_runtime/runtime_job_v2.py#L223-L249" signature="wait_for_final_state(timeout=None)">
