---
title: SamplerExecutionOptionsV2 (v0.43)
description: API reference for qiskit_ibm_runtime.options.SamplerExecutionOptionsV2 in qiskit-ibm-runtime v0.43
