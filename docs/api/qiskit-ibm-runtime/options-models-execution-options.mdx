...
<Class id="qiskit_ibm_runtime.options_models.ExecutionOptions" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.50/qiskit_ibm_runtime/options_models/execution.py#L20-L54" signature="ExecutionOptions" modifiers="pydantic model">
  ...
  *   **extra**: *str = forbid*
  ...
  <Function id="qiskit_ibm_runtime.options_models.ExecutionOptions.update" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.50/qiskit_ibm_runtime/options_models/base.py#L46-L54" signature="update(**kwargs)">
    Update the options.
