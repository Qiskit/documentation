---
title: SamplerV1 (v0.27)
description: API reference for qiskit_ibm_runtime.SamplerV1 in qiskit-ibm-runtime v0.27
...
<Class id="qiskit_ibm_runtime.SamplerV1" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.27/qiskit_ibm_runtime/sampler.py#L179-L335" signature="SamplerV1(backend=None, session=None, options=None)" modifiers="class">
  Class for interacting with Qiskit Runtime Sampler primitive service.

  <Admonition title="Deprecated since version 0.23" type="danger">
    The `SamplerV1` primitives have been deprecated in 0.23, released on April 15, 2024. See the [V2 migration guide](/docs/guides/v2-primitives). for more details. The `SamplerV1` support will be removed no earlier than July 15, 2024.
  </Admonition>
  ...
  *   **options** (`Union`\[`Dict`, [`Options`](options-options "qiskit_ibm_runtime.options.options.Options"), `None`]) – Primitive options, see `Options` for detailed description. The `backend` keyword is still supported but is deprecated.
  ...
  <Attribute id="qiskit_ibm_runtime.SamplerV1.options">
    Return options values for the sampler. :rtype: [`Options`](/docs/api/qiskit/qiskit.providers.Options) :returns: options
  </Attribute>
  ...
  <Function id="qiskit_ibm_runtime.SamplerV1.run" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.27/qiskit_ibm_runtime/sampler.py#L257-L284" signature="run(circuits, parameter_values=None, **kwargs)">
    Submit a request to the sampler primitive.

    **Parameters**

    *   **circuits** (*QuantumCircuit | Sequence\[QuantumCircuit]*) – A (parameterized) [`QuantumCircuit`](/docs/api/qiskit/qiskit.circuit.QuantumCircuit) or a list of (parameterized) [`QuantumCircuit`](/docs/api/qiskit/qiskit.circuit.QuantumCircuit).
    ...
    **Returns**
    ...
    Submitted job. The result of the job is an instance of [`qiskit.primitives.SamplerResult`](/docs/api/qiskit/qiskit.primitives.SamplerResult).
  ...
  <Function id="qiskit_ibm_runtime.SamplerV1.set_options" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.27/qiskit_ibm_runtime/base_primitive.py#L465-L473" signature="set_options(**fields)">
