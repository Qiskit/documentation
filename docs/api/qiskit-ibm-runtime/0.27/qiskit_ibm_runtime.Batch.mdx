---
title: Batch (v0.27)
description: API reference for qiskit_ibm_runtime.Batch in qiskit-ibm-runtime v0.27
...
<Class id="qiskit_ibm_runtime.Batch" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.27/qiskit_ibm_runtime/batch.py#L24-L130" signature="Batch(service=None, backend=None, max_time=None)" modifiers="class">
  ...
  *   **backend** (`Union`\[`str`, [`BackendV1`](/api/qiskit/qiskit.providers.BackendV1 "(in Qiskit v1.1)"), [`BackendV2`](/api/qiskit/qiskit.providers.BackendV2 "(in Qiskit v1.1)"), `None`]) – Instance of `Backend` class or backend string name. Note that passing a backend name is deprecated.
  ...
  **ValueError** – If an input value is invalid.
  ...
  <Function id="qiskit_ibm_runtime.Batch.backend" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.27/qiskit_ibm_runtime/session.py#L254-L262" signature="backend()">
  ...
  <Function id="qiskit_ibm_runtime.Batch.cancel" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.27/qiskit_ibm_runtime/session.py#L240-L244" signature="cancel()">
  ...
  <Function id="qiskit_ibm_runtime.Batch.close" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.27/qiskit_ibm_runtime/session.py#L246-L252" signature="close()">
  ...
  <Function id="qiskit_ibm_runtime.Batch.details" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.27/qiskit_ibm_runtime/session.py#L291-L333" signature="details()">
  ...
  <Function id="qiskit_ibm_runtime.Batch.from_id" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.27/qiskit_ibm_runtime/session.py#L353-L399" signature="from_id(session_id, service=None)" modifiers="classmethod">
  ...
  <Function id="qiskit_ibm_runtime.Batch.run" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.27/qiskit_ibm_runtime/session.py#L176-L233" signature="run(program_id, inputs, options=None, callback=None, result_decoder=None)">
  ...
  <Function id="qiskit_ibm_runtime.Batch.status" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.27/qiskit_ibm_runtime/session.py#L264-L289" signature="status()">
