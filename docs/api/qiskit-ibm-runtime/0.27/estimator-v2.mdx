---
title: EstimatorV2 (v0.27)
description: API reference for qiskit_ibm_runtime.EstimatorV2 in qiskit-ibm-runtime v0.27
...
<Class id="qiskit_ibm_runtime.EstimatorV2" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.27/qiskit_ibm_runtime/estimator.py#L53-L232" signature="EstimatorV2(mode=None, backend=None, session=None, options=None)" modifiers="class">
  ...
  *   a single [`QuantumCircuit`](/api/qiskit/qiskit.circuit.QuantumCircuit "(in Qiskit v1.1)"), possibly parametrized, whose final state we define as $\psi(\theta)$,
  ...
  **NotImplementedError** – If “q-ctrl” channel strategy is used.
  ...
  <Function id="qiskit_ibm_runtime.EstimatorV2.run" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.27/qiskit_ibm_runtime/estimator.py#L177-L195" signature="run(pubs, *, precision=None)">
