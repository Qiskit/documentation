---
title: EnvironmentOptions (v0.27)
description: API reference for qiskit_ibm_runtime.options.EnvironmentOptions in qiskit-ibm-runtime v0.27
...
<Class id="qiskit_ibm_runtime.options.EnvironmentOptions" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.27/qiskit_ibm_runtime/options/environment_options.py#L28-L52" signature="EnvironmentOptions(*args, **kwargs)" modifiers="class">
