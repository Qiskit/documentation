---
title: MeasureNoiseLearningOptions (v0.27)
description: API reference for qiskit_ibm_runtime.options.MeasureNoiseLearningOptions in qiskit-ibm-runtime v0.27
