...
<Class id="qiskit_ibm_runtime.RuntimeEncoder" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.23/qiskit_ibm_runtime/utils/json.py#L206-L324" signature="RuntimeEncoder(*, skipkeys=False, ensure_ascii=True, check_circular=True, allow_nan=True, sort_keys=False, indent=None, separators=None, default=None)">
  ...
  <Function id="qiskit_ibm_runtime.RuntimeEncoder.default" name="default" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.23/qiskit_ibm_runtime/utils/json.py#L209-L324" signature="default(obj)">
