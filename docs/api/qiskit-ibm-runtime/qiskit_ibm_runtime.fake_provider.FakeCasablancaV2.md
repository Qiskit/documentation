...
`FakeCasablancaV2` [GitHub](https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.20/qiskit_ibm_runtime/fake_provider/backends/casablanca/fake_casablanca.py#L21-L28 "view source code")
...
<span id="qiskit_ibm_runtime.fake_provider.FakeCasablancaV2.backend_name" />

### backend\_name

`= 'fake_casablanca'`

<span id="qiskit_ibm_runtime.fake_provider.FakeCasablancaV2.conf_filename" />

### conf\_filename

`= 'conf_casablanca.json'`

<span id="qiskit_ibm_runtime.fake_provider.FakeCasablancaV2.coupling_map" />

### coupling\_map

Return the `CouplingMap` object

<span id="qiskit_ibm_runtime.fake_provider.FakeCasablancaV2.defs_filename" />

### defs\_filename

`= 'defs_casablanca.json'`

<span id="qiskit_ibm_runtime.fake_provider.FakeCasablancaV2.dirname" />

### dirname

`= '/home/runner/work/qiskit-ibm-runtime/qiskit-ibm-runtime/qiskit_ibm_runtime/fake_provider/backends/casablanca'`

<span id="qiskit_ibm_runtime.fake_provider.FakeCasablancaV2.dt" />
...
<span id="qiskit_ibm_runtime.fake_provider.FakeCasablancaV2.dtm" />
...
<span id="qiskit_ibm_runtime.fake_provider.FakeCasablancaV2.instruction_durations" />

### instruction\_durations

Return the `InstructionDurations` object.

<span id="qiskit_ibm_runtime.fake_provider.FakeCasablancaV2.instruction_schedule_map" />

### instruction\_schedule\_map

Return the `InstructionScheduleMap` for the instructions defined in this backend’s target.

<span id="qiskit_ibm_runtime.fake_provider.FakeCasablancaV2.instructions" />
...
<span id="qiskit_ibm_runtime.fake_provider.FakeCasablancaV2.max_circuits" />
...
<span id="qiskit_ibm_runtime.fake_provider.FakeCasablancaV2.meas_map" />
...
<span id="qiskit_ibm_runtime.fake_provider.FakeCasablancaV2.num_qubits" />
...
<span id="qiskit_ibm_runtime.fake_provider.FakeCasablancaV2.operation_names" />
...
<span id="qiskit_ibm_runtime.fake_provider.FakeCasablancaV2.operations" />
...
<span id="qiskit_ibm_runtime.fake_provider.FakeCasablancaV2.options" />
...
<span id="qiskit_ibm_runtime.fake_provider.FakeCasablancaV2.props_filename" />

### props\_filename

`= 'props_casablanca.json'`

<span id="qiskit_ibm_runtime.fake_provider.FakeCasablancaV2.provider" />
...
<span id="qiskit_ibm_runtime.fake_provider.FakeCasablancaV2.target" />
...
<span id="qiskit_ibm_runtime.fake_provider.FakeCasablancaV2.version" />

### version

`= 2`

<span id="qiskit_ibm_runtime.fake_provider.FakeCasablancaV2.name" />

### name

Name of the backend.

<span id="qiskit_ibm_runtime.fake_provider.FakeCasablancaV2.description" />

### description

Optional human-readable description.

<span id="qiskit_ibm_runtime.fake_provider.FakeCasablancaV2.online_date" />

### online\_date

Date that the backend came online.

<span id="qiskit_ibm_runtime.fake_provider.FakeCasablancaV2.backend_version" />
...
<span id="qiskit_ibm_runtime.fake_provider.FakeCasablancaV2.acquire_channel" />
...
<span id="qiskit_ibm_runtime.fake_provider.FakeCasablancaV2.control_channel" />
...
<span id="qiskit_ibm_runtime.fake_provider.FakeCasablancaV2.drive_channel" />
...
<span id="qiskit_ibm_runtime.fake_provider.FakeCasablancaV2.measure_channel" />
...
<span id="qiskit_ibm_runtime.fake_provider.FakeCasablancaV2.qubit_properties" />
...
<span id="qiskit_ibm_runtime.fake_provider.FakeCasablancaV2.run" />
...
<span id="qiskit_ibm_runtime.fake_provider.FakeCasablancaV2.set_options" />
