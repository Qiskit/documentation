---
title: fake_provider (v0.36)
description: API reference for qiskit_ibm_runtime.fake_provider in qiskit-ibm-runtime v0.36
...
![Circuit diagram output by the previous code.](/docs/images/api/qiskit-ibm-runtime/0.36/fake_provider-1.avif)
...
![Circuit diagram output by the previous code.](/docs/images/api/qiskit-ibm-runtime/0.36/fake_provider-2.avif)
...
![Histogram output by the previous code.](/docs/images/api/qiskit-ibm-runtime/0.36/fake_provider-3.avif)
