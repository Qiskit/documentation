...
<Class id="qiskit_ibm_runtime.options.ResilienceOptions" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-ibm-runtime/tree/stable/0.14/qiskit_ibm_runtime/options/resilience_options.py" signature="ResilienceOptions(noise_amplifier=None, noise_factors=None, extrapolator=None)" modifiers="class">
  Resilience options.
