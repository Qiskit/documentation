...
<Class id="qiskit_ibm_runtime.Estimator" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-ibm-runtime/tree/stable/0.14/qiskit_ibm_runtime/estimator.py" signature="Estimator(backend=None, session=None, options=None)">
