...
<Class id="qiskit_ibm_runtime.options.SimulatorOptions" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-ibm-runtime/tree/stable/0.14/qiskit_ibm_runtime/options/simulator_options.py" signature="SimulatorOptions(noise_model=None, seed_simulator=None, coupling_map=None, basis_gates=None)">
  Simulator options.
