---
title: Session (v0.14)
description: API reference for qiskit_ibm_runtime.Session in qiskit-ibm-runtime v0.14
...
<Class id="qiskit_ibm_runtime.Session" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-ibm-runtime/tree/stable/0.14/qiskit_ibm_runtime/session.py" signature="Session(service=None, backend=None, max_time=None)" modifiers="class">
  ...
  **ValueError** – If an input value is invalid.
  ...
  <Function id="qiskit_ibm_runtime.Session.run" signature="run(program_id, inputs, options=None, callback=None, result_decoder=None)">
    ...
    *   **inputs** (`Union`\[`Dict`, [`ParameterNamespace`](parameter-namespace "qiskit_ibm_runtime.runtime_program.ParameterNamespace")]) – Program input parameters. These input values are passed to the runtime program.
