...
<Class id="qiskit_ibm_runtime.RuntimeDecoder" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-ibm-runtime/tree/stable/0.14/qiskit_ibm_runtime/utils/json.py" signature="RuntimeDecoder(*args, **kwargs)">
  ...
  <Function id="qiskit_ibm_runtime.RuntimeDecoder.object_hook" name="object_hook" signature="object_hook(obj)">
