...
<Class id="qiskit_ibm_runtime.fake_provider.FakeLima" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.23/qiskit_ibm_runtime/fake_provider/backends/lima/fake_lima.py#L31-L38" signature="FakeLima">
