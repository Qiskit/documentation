...
<Class id="qiskit_ibm_runtime.debug_tools.NeatPubResult" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.50/qiskit_ibm_runtime/debug_tools/neat_results.py#L32-L117" signature="NeatPubResult(vals)" modifiers="class">
  Bases: `object`
  ...
  **vals** (*ArrayLike*) – The values in this `NeatPubResult`.
  ...
  <Function id="qiskit_ibm_runtime.debug_tools.NeatPubResult.__mul__" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.50/qiskit_ibm_runtime/debug_tools/neat_results.py#L92-L93" signature="__mul__(other)">
    **Parameters**
