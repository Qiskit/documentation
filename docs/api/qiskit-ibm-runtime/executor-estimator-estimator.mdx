...
<Class id="qiskit_ibm_runtime.executor_estimator.Estimator" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.50/qiskit_ibm_runtime/executor_estimator/estimator.py#L46-L273" signature="Estimator(mode=None, options=None)" modifiers="class">
  ...
  *   **options** ([*EstimatorOptions*](options-models-estimator-options "qiskit_ibm_runtime.options_models.estimator.EstimatorOptions")) – Estimator options. See [`EstimatorOptions`](options-models-estimator-options "qiskit_ibm_runtime.options_models.EstimatorOptions") for all available options.
  ...
  <Function id="qiskit_ibm_runtime.executor_estimator.Estimator.backend" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.50/qiskit_ibm_runtime/executor_estimator/estimator.py#L126-L128" signature="backend()">
  ...
  <Function id="qiskit_ibm_runtime.executor_estimator.Estimator.finalize_options" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.50/qiskit_ibm_runtime/executor_estimator/estimator.py#L188-L211" signature="finalize_options()">
  ...
  <Function id="qiskit_ibm_runtime.executor_estimator.Estimator.find_unique_layers" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.50/qiskit_ibm_runtime/executor_estimator/estimator.py#L139-L186" signature="find_unique_layers(pubs, types='gates')">
  ...
  <Function id="qiskit_ibm_runtime.executor_estimator.Estimator.run" github="https://github.com/Qiskit/qiskit-ibm-runtime/tree/stable/0.50/qiskit_ibm_runtime/executor_estimator/estimator.py#L213-L273" signature="run(pubs, *, precision=None, dry_run=False)">
