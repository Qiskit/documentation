...
<Class id="qiskit_addon_aqc_tensor.ansatz_generation.KAK" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit-addon-aqc-tensor/tree/stable/0.3/qiskit_addon_aqc_tensor/ansatz_generation/from_connectivity.py#L108-L146" signature="KAK(params)" modifiers="class">
  ...
  **params** ([`Sequence`](https://docs.python.org/3/library/typing.html#typing.Sequence)\[[`Parameter`](/docs/api/qiskit/qiskit.circuit.Parameter)]) – Sequence of parameters.
  ...
  <Attribute id="qiskit_addon_aqc_tensor.ansatz_generation.KAK.ansatz_name">
    Default value: `'KAK'`
  </Attribute>

  ### ansatz\_num\_params

  <Attribute id="qiskit_addon_aqc_tensor.ansatz_generation.KAK.ansatz_num_params">
    Default value: `3`
  </Attribute>

  ### ansatz\_num\_qubits

  <Attribute id="qiskit_addon_aqc_tensor.ansatz_generation.KAK.ansatz_num_qubits">
    Default value: `2`
  </Attribute>
