...
<Class id="qiskit_addon_aqc_tensor.ansatz_generation.KAK" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit-addon-aqc-tensor/tree/stable/0.2/qiskit_addon_aqc_tensor/ansatz_generation/from_connectivity.py#L101-L139" signature="KAK(params)" modifiers="class">
  Bases: [`TwoQubitAnsatzBlock`](ansatz-generation-two-qubit-ansatz-block "qiskit_addon_aqc_tensor.ansatz_generation.from_connectivity.TwoQubitAnsatzBlock")

  Two-qubit ansatz block based on the KAK decomposition.

  ![Circuit diagram output by the previous code.](/images/api/qiskit-addon-aqc-tensor/qiskit_addon_aqc_tensor-ansatz_generation-KAK-1.svg)

  The above KAK block is equivalent to the following circuit:

  ![Circuit diagram output by the previous code.](/images/api/qiskit-addon-aqc-tensor/qiskit_addon_aqc_tensor-ansatz_generation-KAK-2.svg)
