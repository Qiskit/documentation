...
<Class id="qiskit_addon_aqc_tensor.ansatz_generation.KAK" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit-addon-aqc-tensor/tree/stable/0.1/qiskit_addon_aqc_tensor/ansatz_generation.py#L81-L99" signature="KAK(params)[[source]](https://github.com/Qiskit/qiskit-addon-aqc-tensor/tree/stable/0.1/qiskit_addon_aqc_tensor/ansatz_generation.py)" modifiers="class">
