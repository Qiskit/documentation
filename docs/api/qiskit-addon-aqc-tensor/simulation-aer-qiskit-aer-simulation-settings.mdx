...
<Class id="qiskit_addon_aqc_tensor.simulation.aer.QiskitAerSimulationSettings" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit-addon-aqc-tensor/tree/stable/0.1/qiskit_addon_aqc_tensor/simulation/aer/simulation.py#L59-L92" signature="QiskitAerSimulationSettings(simulator, callback=None)[[source]](https://github.com/Qiskit/qiskit-addon-aqc-tensor/tree/stable/0.1/qiskit_addon_aqc_tensor/simulation/aer/simulation.py)" modifiers="class">
