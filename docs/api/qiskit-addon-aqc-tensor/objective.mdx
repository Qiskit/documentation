...
<Class id="qiskit_addon_aqc_tensor.objective.MaximizeStateFidelity" github="https://github.com/Qiskit/qiskit-addon-aqc-tensor/tree/stable/0.3/qiskit_addon_aqc_tensor/objective.py#L33-L103" signature="MaximizeStateFidelity(target, ansatz, settings)" modifiers="class">
...
$$
  ...
  *   **settings** ([`TensorNetworkSimulationSettings`](simulation#qiskit_addon_aqc_tensor.simulation.TensorNetworkSimulationSettings "qiskit_addon_aqc_tensor.simulation.abstract.TensorNetworkSimulationSettings")) – Tensor network simulation settings.
  ...
  <Function id="qiskit_addon_aqc_tensor.objective.MaximizeStateFidelity.loss_function" github="https://github.com/Qiskit/qiskit-addon-aqc-tensor/tree/stable/0.3/qiskit_addon_aqc_tensor/objective.py#L92-L98" signature="loss_function(x)">
  ...
  <Attribute id="qiskit_addon_aqc_tensor.objective.MaximizeStateFidelity.target">
    Type: [`TensorNetworkState`](simulation#qiskit_addon_aqc_tensor.simulation.TensorNetworkState "qiskit_addon_aqc_tensor.simulation.abstract.TensorNetworkState")
...
<Class id="qiskit_addon_aqc_tensor.objective.OneMinusFidelity" github="https://github.com/Qiskit/qiskit-addon-aqc-tensor/tree/stable/0.3/qiskit_addon_aqc_tensor/objective.py#L106-L131" signature="OneMinusFidelity(target, ansatz, settings)" modifiers="class">
  ...
  *   **settings** ([`TensorNetworkSimulationSettings`](simulation#qiskit_addon_aqc_tensor.simulation.TensorNetworkSimulationSettings "qiskit_addon_aqc_tensor.simulation.abstract.TensorNetworkSimulationSettings")) – Tensor network simulation settings.
  ...
  <Function id="qiskit_addon_aqc_tensor.objective.OneMinusFidelity.__call__" github="https://github.com/Qiskit/qiskit-addon-aqc-tensor/tree/stable/0.3/qiskit_addon_aqc_tensor/objective.py#L75-L90" signature="__call__(x)">
    Evaluate `(objective_value, gradient)` of function at point `x`.
  ...
  <Function id="qiskit_addon_aqc_tensor.objective.OneMinusFidelity.loss_function" github="https://github.com/Qiskit/qiskit-addon-aqc-tensor/tree/stable/0.3/qiskit_addon_aqc_tensor/objective.py#L92-L98" signature="loss_function(x)">
    Evaluate `(objective_value, gradient)` of function at point `x`.
  ...
  <Attribute id="qiskit_addon_aqc_tensor.objective.OneMinusFidelity.target">
    Type: [`TensorNetworkState`](simulation#qiskit_addon_aqc_tensor.simulation.TensorNetworkState "qiskit_addon_aqc_tensor.simulation.abstract.TensorNetworkState")
