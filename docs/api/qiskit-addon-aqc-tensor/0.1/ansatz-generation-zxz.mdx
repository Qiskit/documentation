---
title: ZXZ (v0.1)
description: API reference for qiskit_addon_aqc_tensor.ansatz_generation.ZXZ in qiskit-addon-aqc-tensor v0.1
...
<Class id="qiskit_addon_aqc_tensor.ansatz_generation.ZXZ" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit-addon-aqc-tensor/tree/stable/0.1/qiskit_addon_aqc_tensor/ansatz_generation.py#L67-L78" signature="ZXZ(params)" modifiers="class">
