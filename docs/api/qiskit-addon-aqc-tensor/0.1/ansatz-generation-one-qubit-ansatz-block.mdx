---
title: OneQubitAnsatzBlock (v0.1)
description: API reference for qiskit_addon_aqc_tensor.ansatz_generation.OneQubitAnsatzBlock in qiskit-addon-aqc-tensor v0.1
...
<Class id="qiskit_addon_aqc_tensor.ansatz_generation.OneQubitAnsatzBlock" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit-addon-aqc-tensor/tree/stable/0.1/qiskit_addon_aqc_tensor/ansatz_generation.py#L55-L58" signature="OneQubitAnsatzBlock(params)" modifiers="class">
  ...
  **params** ([`Sequence`](https://docs.python.org/3/library/typing.html#typing.Sequence "(in Python v3.13)")\[[`Parameter`](/api/qiskit/qiskit.circuit.Parameter "(in Qiskit v1.2)")]) – Sequence of parameters.
  ...
  <Attribute id="qiskit_addon_aqc_tensor.ansatz_generation.OneQubitAnsatzBlock.ansatz_num_qubits" attributeValue="1" />

  ### base\_class

  <Attribute id="qiskit_addon_aqc_tensor.ansatz_generation.OneQubitAnsatzBlock.base_class">
  ...
  <Attribute id="qiskit_addon_aqc_tensor.ansatz_generation.OneQubitAnsatzBlock.condition">
    The classical condition on the instruction.
  </Attribute>

  ### condition\_bits

  <Attribute id="qiskit_addon_aqc_tensor.ansatz_generation.OneQubitAnsatzBlock.condition_bits">
    Get Clbits in condition.
  </Attribute>

  ### decompositions

  <Attribute id="qiskit_addon_aqc_tensor.ansatz_generation.OneQubitAnsatzBlock.decompositions">
    Get the decompositions of the instruction from the SessionEquivalenceLibrary.
  </Attribute>

  ### definition

  <Attribute id="qiskit_addon_aqc_tensor.ansatz_generation.OneQubitAnsatzBlock.definition">
    Return definition in terms of other basic gates.
  </Attribute>

  ### duration

  <Attribute id="qiskit_addon_aqc_tensor.ansatz_generation.OneQubitAnsatzBlock.duration">
    Get the duration.
  </Attribute>

  ### label

  <Attribute id="qiskit_addon_aqc_tensor.ansatz_generation.OneQubitAnsatzBlock.label">
    Return instruction label
  </Attribute>

  ### mutable

  <Attribute id="qiskit_addon_aqc_tensor.ansatz_generation.OneQubitAnsatzBlock.mutable">
  ...
  <Attribute id="qiskit_addon_aqc_tensor.ansatz_generation.OneQubitAnsatzBlock.name">
    Return the name.
  </Attribute>

  ### num\_clbits

  <Attribute id="qiskit_addon_aqc_tensor.ansatz_generation.OneQubitAnsatzBlock.num_clbits">
    Return the number of clbits.
  </Attribute>

  ### num\_qubits

  <Attribute id="qiskit_addon_aqc_tensor.ansatz_generation.OneQubitAnsatzBlock.num_qubits">
    Return the number of qubits.
  </Attribute>

  ### params

  <Attribute id="qiskit_addon_aqc_tensor.ansatz_generation.OneQubitAnsatzBlock.params">
    The parameters of this `Instruction`. Ideally these will be gate angles.
  </Attribute>

  ### unit

  <Attribute id="qiskit_addon_aqc_tensor.ansatz_generation.OneQubitAnsatzBlock.unit">
  ...
  <Function id="qiskit_addon_aqc_tensor.ansatz_generation.OneQubitAnsatzBlock.add_decomposition" signature="add_decomposition(decomposition)">
    Add a decomposition of the instruction to the SessionEquivalenceLibrary.
  </Function>

  ### assemble

  <Function id="qiskit_addon_aqc_tensor.ansatz_generation.OneQubitAnsatzBlock.assemble" signature="assemble()">
  ...
  <Function id="qiskit_addon_aqc_tensor.ansatz_generation.OneQubitAnsatzBlock.broadcast_arguments" signature="broadcast_arguments(qargs, cargs)">
  ...
  <Function id="qiskit_addon_aqc_tensor.ansatz_generation.OneQubitAnsatzBlock.c_if" signature="c_if(classical, val)">
  ...
  <Function id="qiskit_addon_aqc_tensor.ansatz_generation.OneQubitAnsatzBlock.copy" signature="copy(name=None)">
  ...
  <Function id="qiskit_addon_aqc_tensor.ansatz_generation.OneQubitAnsatzBlock.inverse" signature="inverse(annotated=False)">
  ...
  <Function id="qiskit_addon_aqc_tensor.ansatz_generation.OneQubitAnsatzBlock.is_parameterized" signature="is_parameterized()">
  ...
  <Function id="qiskit_addon_aqc_tensor.ansatz_generation.OneQubitAnsatzBlock.power" signature="power(exponent, annotated=False)">
  ...
  <Function id="qiskit_addon_aqc_tensor.ansatz_generation.OneQubitAnsatzBlock.reverse_ops" signature="reverse_ops()">
  ...
  <Function id="qiskit_addon_aqc_tensor.ansatz_generation.OneQubitAnsatzBlock.soft_compare" signature="soft_compare(other)">
  ...
  <Function id="qiskit_addon_aqc_tensor.ansatz_generation.OneQubitAnsatzBlock.to_matrix" signature="to_matrix()">
  ...
  <Function id="qiskit_addon_aqc_tensor.ansatz_generation.OneQubitAnsatzBlock.to_mutable" signature="to_mutable()">
  ...
  <Function id="qiskit_addon_aqc_tensor.ansatz_generation.OneQubitAnsatzBlock.validate_parameter" signature="validate_parameter(parameter)">
