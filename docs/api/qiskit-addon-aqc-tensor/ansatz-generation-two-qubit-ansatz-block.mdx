...
<Class id="qiskit_addon_aqc_tensor.ansatz_generation.TwoQubitAnsatzBlock" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit-addon-aqc-tensor/tree/stable/0.1/qiskit_addon_aqc_tensor/ansatz_generation.py#L61-L64" signature="TwoQubitAnsatzBlock(params)[[source]](https://github.com/Qiskit/qiskit-addon-aqc-tensor/tree/stable/0.1/qiskit_addon_aqc_tensor/ansatz_generation.py)" modifiers="class">
