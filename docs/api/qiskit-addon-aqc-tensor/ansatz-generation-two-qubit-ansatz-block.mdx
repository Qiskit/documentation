...
<Class id="qiskit_addon_aqc_tensor.ansatz_generation.TwoQubitAnsatzBlock" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit-addon-aqc-tensor/tree/stable/0.2/qiskit_addon_aqc_tensor/ansatz_generation/from_connectivity.py#L61-L64" signature="TwoQubitAnsatzBlock(params)" modifiers="class">
