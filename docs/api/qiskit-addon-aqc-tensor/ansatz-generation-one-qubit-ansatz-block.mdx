...
<Class id="qiskit_addon_aqc_tensor.ansatz_generation.OneQubitAnsatzBlock" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit-addon-aqc-tensor/tree/stable/0.1/qiskit_addon_aqc_tensor/ansatz_generation.py#L55-L58" signature="OneQubitAnsatzBlock(params)[source]" modifiers="class">
