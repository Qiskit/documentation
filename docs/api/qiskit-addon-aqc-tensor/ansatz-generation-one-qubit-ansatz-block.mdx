...
<Class id="qiskit_addon_aqc_tensor.ansatz_generation.OneQubitAnsatzBlock" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit-addon-aqc-tensor/tree/stable/0.2/qiskit_addon_aqc_tensor/ansatz_generation/from_connectivity.py#L55-L58" signature="OneQubitAnsatzBlock(params)" modifiers="class">
