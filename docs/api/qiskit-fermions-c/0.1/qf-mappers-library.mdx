---
title: Mapper Library (v0.1)
description: API reference for Mapper Library in qiskit-fermions-c v0.1
...
<Function id="qf_ferm_op_jordan_wigner" signature="QfExitCode qf_ferm_op_jordan_wigner(const QfFermionOperator *op, uint32_t num_qubits, QkObs **out)">
  ...
  Map a [`QfFermionOperator`](qf-ferm-op#qffermionoperator "QfFermionOperator") to a [QkObs](/docs/api/qiskit-c/qk-obs) under the Jordan-Wigner transformation.   <span id="id1" />[\[1\]](#id2)
