...
description: API reference for qiskit_fermions.circuit.FermionicGate in the latest version of qiskit-addon-fermions
...
<Class id="qiskit_fermions.circuit.FermionicGate" isDedicatedPage={true} signature="FermionicGate(name, num_modes, /, params=None, *, label=None)" modifiers="class">
  ...
  To ensure consistency only subclasses of this gate class can be added to instances of [`FermionicCircuit`](qiskit-fermions-circuit-fermionic-circuit "qiskit_fermions.circuit.FermionicCircuit"). As such, this class (mostly) serves as a type (for the time being).
  ...
  *   **params** ([*list*](https://docs.python.org/3/library/stdtypes.html#list) *| None*) – A list of parameters.
  *   **label** ([*str*](https://docs.python.org/3/library/stdtypes.html#str) *| None*) – An optional label for the gate.
  *   **num\_modes** ([*int*](https://docs.python.org/3/library/functions.html#int))
  ...
  **Protocol Methods**
  ...
  <Function id="qiskit_fermions.circuit.FermionicGate._apply_unitary_" signature="_apply_unitary_(vec, norb, nelec, copy)">
    ...
    This is the identity-placement entry point of ffsim’s [`ffsim.SupportsApplyUnitary`](https://qiskit-community.github.io/ffsim/api/stubs/ffsim.SupportsApplyUnitary.html#ffsim.SupportsApplyUnitary "(in ffsim)") protocol (mirrored locally as [`SupportsApplyUnitary`](qiskit-fermions-protocols-supports-apply-unitary "qiskit_fermions.protocols.SupportsApplyUnitary")): it assumes the gate acts on the modes `0..num_modes` of the state vector and delegates to the placement-aware `_apply_unitary_placed_()` (see [`SupportsApplyUnitaryPlaced`](qiskit-fermions-protocols-supports-apply-unitary-placed "qiskit_fermions.protocols.SupportsApplyUnitaryPlaced")), which every concrete fermionic gate implements. See that method for the semantics of `vec` (including whether a `None` vector is accepted), `norb`, `nelec`, and `copy`.

    **Raises**

    [**NotImplementedError**](https://docs.python.org/3/library/exceptions.html#NotImplementedError) – if this gate does not implement `_apply_unitary_placed_` (a bare [`FermionicGate`](#qiskit_fermions.circuit.FermionicGate "qiskit_fermions.circuit.FermionicGate") used only as a type marker), and therefore cannot be applied to a state vector.
