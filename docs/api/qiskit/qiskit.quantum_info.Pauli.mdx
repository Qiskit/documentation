...
$$
  ...
  **Raises**
  ...
  <Function id="qiskit.quantum_info.Pauli.set_truncation" github="https://github.com/Qiskit/qiskit/tree/stable/1.0/qiskit/quantum_info/operators/symplectic/pauli.py#L229-L240" signature="classmethod set_truncation(val)">
