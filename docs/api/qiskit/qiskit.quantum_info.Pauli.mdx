...
<Class id="qiskit.quantum_info.Pauli" github="https://github.com/Qiskit/qiskit/tree/stable/1.0/qiskit/quantum_info/operators/symplectic/pauli.py#L38-L698" signature="qiskit.quantum_info.Pauli(data=None)">
  Bases: `BasePauli`
