...
<Class id="qiskit.quantum_info.Pauli" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/2.1/qiskit/quantum_info/operators/symplectic/pauli.py#L39-L751" signature="qiskit.quantum_info.Pauli(data=None)" modifiers="class">
  Bases: `BasePauli`
...
$$
  ...
  **Raises**
  ...
  <Function id="qiskit.quantum_info.Pauli.adjoint" github="https://github.com/Qiskit/qiskit/tree/stable/2.1/qiskit/quantum_info/operators/symplectic/pauli.py#L526-L527" signature="adjoint()">
    Return the adjoint of the Operator.
  </Function>

  ### anticommutes

  <Function id="qiskit.quantum_info.Pauli.anticommutes" github="https://github.com/Qiskit/qiskit/tree/stable/2.1/qiskit/quantum_info/operators/symplectic/pauli.py#L556-L566" signature="anticommutes(other, qargs=None)">
  ...
  <Function id="qiskit.quantum_info.Pauli.apply_layout" github="https://github.com/Qiskit/qiskit/tree/stable/2.1/qiskit/quantum_info/operators/symplectic/pauli.py#L708-L751" signature="apply_layout(layout, num_qubits=None)">
  ...
  <Function id="qiskit.quantum_info.Pauli.commutes" github="https://github.com/Qiskit/qiskit/tree/stable/2.1/qiskit/quantum_info/operators/symplectic/pauli.py#L537-L554" signature="commutes(other, qargs=None)">
  ...
  <Function id="qiskit.quantum_info.Pauli.compose" github="https://github.com/Qiskit/qiskit/tree/stable/2.1/qiskit/quantum_info/operators/symplectic/pauli.py#L457-L491" signature="compose(other, qargs=None, front=False, inplace=False)">
  ...
  <Function id="qiskit.quantum_info.Pauli.conjugate" github="https://github.com/Qiskit/qiskit/tree/stable/2.1/qiskit/quantum_info/operators/symplectic/pauli.py#L520-L521" signature="conjugate()">
    Return the complex conjugate of the Pauli with respect to the Z basis.
  </Function>

  ### copy

  <Function id="qiskit.quantum_info.Pauli.copy" github="https://github.com/Qiskit/qiskit/tree/stable/2.1/qiskit/quantum_info/operators/symplectic/base_pauli.py#L63-L72" signature="copy()">
    Make a deep copy of current operator.
  </Function>

  ### delete

  <Function id="qiskit.quantum_info.Pauli.delete" github="https://github.com/Qiskit/qiskit/tree/stable/2.1/qiskit/quantum_info/operators/symplectic/pauli.py#L333-L359" signature="delete(qubits)">
  ...
  <Function id="qiskit.quantum_info.Pauli.dot" github="https://github.com/Qiskit/qiskit/tree/stable/2.1/qiskit/quantum_info/operators/symplectic/pauli.py#L493-L505" signature="dot(other, qargs=None, inplace=False)">
  ...
  <Function id="qiskit.quantum_info.Pauli.equiv" github="https://github.com/Qiskit/qiskit/tree/stable/2.1/qiskit/quantum_info/operators/symplectic/pauli.py#L256-L270" signature="equiv(other)">
  ...
  <Function id="qiskit.quantum_info.Pauli.evolve" github="https://github.com/Qiskit/qiskit/tree/stable/2.1/qiskit/quantum_info/operators/symplectic/pauli.py#L568-L607" signature="evolve(other, qargs=None, frame='h')">
  ...
  <Function id="qiskit.quantum_info.Pauli.expand" github="https://github.com/Qiskit/qiskit/tree/stable/2.1/qiskit/quantum_info/operators/symplectic/pauli.py#L512-L515" signature="expand(other)">
  ...
  <Function id="qiskit.quantum_info.Pauli.input_dims" github="https://github.com/Qiskit/qiskit/tree/stable/2.1/qiskit/quantum_info/operators/base_operator.py#L135-L137" signature="input_dims(qargs=None)">
    Return tuple of input dimension for specified subsystems.
  </Function>

  ### insert

  <Function id="qiskit.quantum_info.Pauli.insert" github="https://github.com/Qiskit/qiskit/tree/stable/2.1/qiskit/quantum_info/operators/symplectic/pauli.py#L361-L399" signature="insert(qubits, value)">
  ...
  <Function id="qiskit.quantum_info.Pauli.inverse" github="https://github.com/Qiskit/qiskit/tree/stable/2.1/qiskit/quantum_info/operators/symplectic/pauli.py#L529-L531" signature="inverse()">
    Return the inverse of the Pauli.
  </Function>

  ### output\_dims

  <Function id="qiskit.quantum_info.Pauli.output_dims" github="https://github.com/Qiskit/qiskit/tree/stable/2.1/qiskit/quantum_info/operators/base_operator.py#L139-L141" signature="output_dims(qargs=None)">
    Return tuple of output dimension for specified subsystems.
  </Function>

  ### power

  <Function id="qiskit.quantum_info.Pauli.power" github="https://github.com/Qiskit/qiskit/tree/stable/2.1/qiskit/quantum_info/operators/mixins/group.py#L151-L171" signature="power(n)">
  ...
  <Function id="qiskit.quantum_info.Pauli.reshape" github="https://github.com/Qiskit/qiskit/tree/stable/2.1/qiskit/quantum_info/operators/base_operator.py#L106-L133" signature="reshape(input_dims=None, output_dims=None, num_qubits=None)">
  ...
  <Function id="qiskit.quantum_info.Pauli.set_truncation" github="https://github.com/Qiskit/qiskit/tree/stable/2.1/qiskit/quantum_info/operators/symplectic/pauli.py#L237-L248" signature="set_truncation(val)" modifiers="classmethod">
  ...
  <Function id="qiskit.quantum_info.Pauli.tensor" github="https://github.com/Qiskit/qiskit/tree/stable/2.1/qiskit/quantum_info/operators/symplectic/pauli.py#L507-L510" signature="tensor(other)">
  ...
  <Function id="qiskit.quantum_info.Pauli.to_instruction" github="https://github.com/Qiskit/qiskit/tree/stable/2.1/qiskit/quantum_info/operators/symplectic/pauli.py#L434-L451" signature="to_instruction()">
    Convert to Pauli circuit instruction.
  </Function>

  ### to\_label

  <Function id="qiskit.quantum_info.Pauli.to_label" github="https://github.com/Qiskit/qiskit/tree/stable/2.1/qiskit/quantum_info/operators/symplectic/pauli.py#L409-L420" signature="to_label()">
  ...
  <Function id="qiskit.quantum_info.Pauli.to_matrix" github="https://github.com/Qiskit/qiskit/tree/stable/2.1/qiskit/quantum_info/operators/symplectic/pauli.py#L422-L432" signature="to_matrix(sparse=False)">
  ...
  <Function id="qiskit.quantum_info.Pauli.transpose" github="https://github.com/Qiskit/qiskit/tree/stable/2.1/qiskit/quantum_info/operators/symplectic/pauli.py#L523-L524" signature="transpose()">
