...
`qiskit.transpiler.passes.CXCancellation(*args, **kwargs)` [GitHub](https://github.com/qiskit/qiskit/tree/stable/1.0/qiskit/transpiler/passes/optimization/cx_cancellation.py "view source code")
...
<span id="qiskit.transpiler.passes.CXCancellation.execute" />
...
<span id="qiskit.transpiler.passes.CXCancellation.update_status" />
