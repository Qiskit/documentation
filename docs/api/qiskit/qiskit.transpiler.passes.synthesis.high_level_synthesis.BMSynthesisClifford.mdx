...
<Class id="qiskit.transpiler.passes.synthesis.high_level_synthesis.BMSynthesisClifford" github="https://github.com/Qiskit/qiskit/tree/stable/1.0/qiskit/transpiler/passes/synthesis/high_level_synthesis.py#L643-L659" signature="qiskit.transpiler.passes.synthesis.high_level_synthesis.BMSynthesisClifford">
  ...
  <Function id="qiskit.transpiler.passes.synthesis.high_level_synthesis.BMSynthesisClifford.run" name="run" github="https://github.com/Qiskit/qiskit/tree/stable/1.0/qiskit/transpiler/passes/synthesis/high_level_synthesis.py#L653-L659" signature="run(high_level_object, coupling_map=None, target=None, qubits=None, **options)">
