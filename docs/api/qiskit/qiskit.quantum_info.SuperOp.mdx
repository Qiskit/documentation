...
<Class id="qiskit.quantum_info.SuperOp" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.0/qiskit/quantum_info/operators/channel/superop.py#L38-L372" signature="qiskit.quantum_info.SuperOp(data, input_dims=None, output_dims=None)">
...
$$
  ...
  **Additional Information:**
  ...
  <Attribute id="qiskit.quantum_info.SuperOp.atol" name="atol" attributeValue="= 1e-08" />

  ### data

  <Attribute id="qiskit.quantum_info.SuperOp.data" name="data">
    Return data.
  </Attribute>

  ### dim

  <Attribute id="qiskit.quantum_info.SuperOp.dim" name="dim">
    Return tuple (input\_shape, output\_shape).
  </Attribute>

  ### num\_qubits

  <Attribute id="qiskit.quantum_info.SuperOp.num_qubits" name="num_qubits">
    Return the number of qubits if a N-qubit operator or None otherwise.
  </Attribute>

  ### qargs

  <Attribute id="qiskit.quantum_info.SuperOp.qargs" name="qargs">
    Return the qargs for the operator.
  </Attribute>

  ### rtol

  <Attribute id="qiskit.quantum_info.SuperOp.rtol" name="rtol" attributeValue="= 1e-05" />

  ### settings

  <Attribute id="qiskit.quantum_info.SuperOp.settings" name="settings">
    Return settings.
  </Attribute>
  ...
  <Function id="qiskit.quantum_info.SuperOp.adjoint" name="adjoint" github="https://github.com/Qiskit/qiskit/tree/stable/1.0/qiskit/quantum_info/operators/channel/superop.py#L161-L165" signature="adjoint()">
  ...
  <Function id="qiskit.quantum_info.SuperOp.compose" name="compose" github="https://github.com/Qiskit/qiskit/tree/stable/1.0/qiskit/quantum_info/operators/channel/superop.py#L186-L234" signature="compose(other, qargs=None, front=False)">
  ...
  <Function id="qiskit.quantum_info.SuperOp.conjugate" name="conjugate" github="https://github.com/Qiskit/qiskit/tree/stable/1.0/qiskit/quantum_info/operators/channel/superop.py#L150-L153" signature="conjugate()">
  ...
  <Function id="qiskit.quantum_info.SuperOp.copy" name="copy" github="https://github.com/Qiskit/qiskit/tree/stable/1.0/qiskit/quantum_info/operators/base_operator.py#L143-L145" signature="copy()">
    Make a deep copy of current operator.
  </Function>

  ### dot

  <Function id="qiskit.quantum_info.SuperOp.dot" name="dot" github="https://github.com/Qiskit/qiskit/tree/stable/1.0/qiskit/quantum_info/operators/mixins/group.py#L133-L149" signature="dot(other, qargs=None)">
  ...
  <Function id="qiskit.quantum_info.SuperOp.expand" name="expand" github="https://github.com/Qiskit/qiskit/tree/stable/1.0/qiskit/quantum_info/operators/channel/superop.py#L172-L175" signature="expand(other)">
  ...
  <Function id="qiskit.quantum_info.SuperOp.input_dims" name="input_dims" github="https://github.com/Qiskit/qiskit/tree/stable/1.0/qiskit/quantum_info/operators/base_operator.py#L135-L137" signature="input_dims(qargs=None)">
    Return tuple of input dimension for specified subsystems.
  </Function>

  ### is\_cp

  <Function id="qiskit.quantum_info.SuperOp.is_cp" name="is_cp" github="https://github.com/Qiskit/qiskit/tree/stable/1.0/qiskit/quantum_info/operators/channel/quantum_channel.py#L220-L223" signature="is_cp(atol=None, rtol=None)">
  ...
  <Function id="qiskit.quantum_info.SuperOp.is_cptp" name="is_cptp" github="https://github.com/Qiskit/qiskit/tree/stable/1.0/qiskit/quantum_info/operators/channel/quantum_channel.py#L210-L213" signature="is_cptp(atol=None, rtol=None)">
  ...
  <Function id="qiskit.quantum_info.SuperOp.is_tp" name="is_tp" github="https://github.com/Qiskit/qiskit/tree/stable/1.0/qiskit/quantum_info/operators/channel/quantum_channel.py#L215-L218" signature="is_tp(atol=None, rtol=None)">
  ...
  <Function id="qiskit.quantum_info.SuperOp.is_unitary" name="is_unitary" github="https://github.com/Qiskit/qiskit/tree/stable/1.0/qiskit/quantum_info/operators/channel/quantum_channel.py#L225-L231" signature="is_unitary(atol=None, rtol=None)">
  ...
  <Function id="qiskit.quantum_info.SuperOp.output_dims" name="output_dims" github="https://github.com/Qiskit/qiskit/tree/stable/1.0/qiskit/quantum_info/operators/base_operator.py#L139-L141" signature="output_dims(qargs=None)">
    Return tuple of output dimension for specified subsystems.
  </Function>

  ### power

  <Function id="qiskit.quantum_info.SuperOp.power" name="power" github="https://github.com/Qiskit/qiskit/tree/stable/1.0/qiskit/quantum_info/operators/channel/quantum_channel.py#L141-L176" signature="power(n)">
  ...
  <Function id="qiskit.quantum_info.SuperOp.reshape" name="reshape" github="https://github.com/Qiskit/qiskit/tree/stable/1.0/qiskit/quantum_info/operators/base_operator.py#L106-L133" signature="reshape(input_dims=None, output_dims=None, num_qubits=None)">
  ...
  <Function id="qiskit.quantum_info.SuperOp.tensor" name="tensor" github="https://github.com/Qiskit/qiskit/tree/stable/1.0/qiskit/quantum_info/operators/channel/superop.py#L167-L170" signature="tensor(other)">
  ...
  <Function id="qiskit.quantum_info.SuperOp.to_instruction" name="to_instruction" github="https://github.com/Qiskit/qiskit/tree/stable/1.0/qiskit/quantum_info/operators/channel/quantum_channel.py#L238-L267" signature="to_instruction()">
  ...
  <Function id="qiskit.quantum_info.SuperOp.to_operator" name="to_operator" github="https://github.com/Qiskit/qiskit/tree/stable/1.0/qiskit/quantum_info/operators/channel/quantum_channel.py#L233-L236" signature="to_operator()">
  ...
  <Function id="qiskit.quantum_info.SuperOp.transpose" name="transpose" github="https://github.com/Qiskit/qiskit/tree/stable/1.0/qiskit/quantum_info/operators/channel/superop.py#L155-L159" signature="transpose()">
