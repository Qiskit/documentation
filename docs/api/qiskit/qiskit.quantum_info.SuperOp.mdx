...
<Class id="qiskit.quantum_info.SuperOp" github="https://github.com/qiskit/qiskit/tree/stable/1.0/qiskit/quantum_info/operators/channel/superop.py" signature="qiskit.quantum_info.SuperOp(data, input_dims=None, output_dims=None)">
