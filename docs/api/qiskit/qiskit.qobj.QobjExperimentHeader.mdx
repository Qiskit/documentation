...
<Class id="qiskit.qobj.QobjExperimentHeader" github="https://github.com/Qiskit/qiskit/tree/stable/1.0/qiskit/qobj/common.py#L68-L71" signature="qiskit.qobj.QobjExperimentHeader(**kwargs)">
