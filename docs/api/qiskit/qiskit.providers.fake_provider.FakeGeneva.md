...
`qiskit.providers.fake_provider.FakeGeneva`
...
`= '/home/runner/work/qiskit/qiskit/.tox/docs/lib/python3.9/site-packages/qiskit/providers/fake_provider/backends/geneva'`
...
<span id="qiskit.providers.fake_provider.FakeGeneva.name" />

### name

Name of the backend.

<span id="qiskit.providers.fake_provider.FakeGeneva.description" />

### description

Optional human-readable description.

<span id="qiskit.providers.fake_provider.FakeGeneva.online_date" />

### online\_date

Date that the backend came online.

<span id="qiskit.providers.fake_provider.FakeGeneva.backend_version" />
