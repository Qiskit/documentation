...
<Class id="qiskit.circuit.ParameterExpression" isDedicatedPage={true} signature="qiskit.circuit.ParameterExpression(name_map, expr)" modifiers="class">
  ...
  <Attribute id="qiskit.circuit.ParameterExpression.num_parameters" name="num_parameters" headingLevel={3}>
  ...
  <Attribute id="qiskit.circuit.ParameterExpression.parameters" name="parameters" headingLevel={3}>
