...
<Class id="qiskit.circuit.library.U1Gate" github="https://github.com/qiskit/qiskit/tree/stable/1.0/qiskit/circuit/library/standard_gates/u1.py" signature="qiskit.circuit.library.U1Gate(theta, label=None, *, duration=None, unit='dt')">
...
$$
  ...
  **Examples:**
  ...
  <Function id="qiskit.circuit.library.U1Gate.control" name="control" signature="control(num_ctrl_qubits=1, label=None, ctrl_state=None, annotated=False)">
  ...
  <Function id="qiskit.circuit.library.U1Gate.inverse" name="inverse" signature="inverse(annotated=False)">
