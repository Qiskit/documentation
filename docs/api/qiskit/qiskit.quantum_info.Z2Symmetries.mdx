...
<Class id="qiskit.quantum_info.Z2Symmetries" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.0/qiskit/quantum_info/analysis/z2_symmetries.py#L28-L415" signature="qiskit.quantum_info.Z2Symmetries(symmetries, sq_paulis, sq_list, tapering_values=None, *, tol=1e-14)">
  ...
  <Attribute id="qiskit.quantum_info.Z2Symmetries.tapering_values" name="tapering_values">
  ...
  <Attribute id="qiskit.quantum_info.Z2Symmetries.tol" name="tol">
  ...
  **Raises**
  ...
  <Attribute id="qiskit.quantum_info.Z2Symmetries.cliffords" name="cliffords">
  ...
  <Attribute id="qiskit.quantum_info.Z2Symmetries.settings" name="settings">
    Return operator settings.
  </Attribute>

  ### sq\_list

  <Attribute id="qiskit.quantum_info.Z2Symmetries.sq_list" name="sq_list">
    Return sq list.
  </Attribute>

  ### sq\_paulis

  <Attribute id="qiskit.quantum_info.Z2Symmetries.sq_paulis" name="sq_paulis">
    Return sq paulis.
  </Attribute>

  ### symmetries

  <Attribute id="qiskit.quantum_info.Z2Symmetries.symmetries" name="symmetries">
    Return symmetries.
  </Attribute>
  ...
  <Function id="qiskit.quantum_info.Z2Symmetries.convert_clifford" name="convert_clifford" github="https://github.com/Qiskit/qiskit/tree/stable/1.0/qiskit/quantum_info/analysis/z2_symmetries.py#L302-L321" signature="convert_clifford(operator)">
  ...
  <Function id="qiskit.quantum_info.Z2Symmetries.find_z2_symmetries" name="find_z2_symmetries" github="https://github.com/Qiskit/qiskit/tree/stable/1.0/qiskit/quantum_info/analysis/z2_symmetries.py#L179-L300" signature="classmethod find_z2_symmetries(operator)">
  ...
  <Function id="qiskit.quantum_info.Z2Symmetries.is_empty" name="is_empty" github="https://github.com/Qiskit/qiskit/tree/stable/1.0/qiskit/quantum_info/analysis/z2_symmetries.py#L170-L177" signature="is_empty()">
  ...
  <Function id="qiskit.quantum_info.Z2Symmetries.taper" name="taper" github="https://github.com/Qiskit/qiskit/tree/stable/1.0/qiskit/quantum_info/analysis/z2_symmetries.py#L354-L380" signature="taper(operator)">
  ...
  <Function id="qiskit.quantum_info.Z2Symmetries.taper_clifford" name="taper_clifford" github="https://github.com/Qiskit/qiskit/tree/stable/1.0/qiskit/quantum_info/analysis/z2_symmetries.py#L323-L352" signature="taper_clifford(operator)">
