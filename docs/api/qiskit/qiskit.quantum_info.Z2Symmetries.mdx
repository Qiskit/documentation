...
<Class id="qiskit.quantum_info.Z2Symmetries" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/quantum_info/analysis/z2_symmetries.py#L29-L415" signature="qiskit.quantum_info.Z2Symmetries(symmetries, sq_paulis, sq_list, tapering_values=None, *, tol=1e-14)" modifiers="class">
  ...
  <Attribute id="qiskit.quantum_info.Z2Symmetries.tapering_values" name="tapering_values" headingLevel={3}>
    Values determining the sector.

    **Type**

    [list](https://docs.python.org/3/library/stdtypes.html#list)\[[int](https://docs.python.org/3/library/functions.html#int)] or None
  </Attribute>

  <Attribute id="qiskit.quantum_info.Z2Symmetries.tol" name="tol" headingLevel={3}>
  ...
  *   **sq\_list** (*Iterable\[*[*int*](https://docs.python.org/3/library/functions.html#int)*]*) – The list of indices \$q(i)\$ of the single-qubit Pauli operators used to build the Clifford operators.
  *   **tapering\_values** (*Iterable\[*[*int*](https://docs.python.org/3/library/functions.html#int)*] | None*) – List of eigenvalues determining the symmetry sector for each symmetry.
  ...
  **Raises**
  ...
  <Attribute id="qiskit.quantum_info.Z2Symmetries.settings" name="settings" headingLevel={3}>
    Return operator settings.
  </Attribute>

  <Attribute id="qiskit.quantum_info.Z2Symmetries.sq_list" name="sq_list" headingLevel={3}>
    Return sq list.
  </Attribute>

  <Attribute id="qiskit.quantum_info.Z2Symmetries.sq_paulis" name="sq_paulis" headingLevel={3}>
    Return sq paulis.
  </Attribute>

  <Attribute id="qiskit.quantum_info.Z2Symmetries.symmetries" name="symmetries" headingLevel={3}>
    Return symmetries.
  </Attribute>
  ...
  <Function id="qiskit.quantum_info.Z2Symmetries.convert_clifford" github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/quantum_info/analysis/z2_symmetries.py#L303-L322" signature="convert_clifford(operator)">
  ...
  <Function id="qiskit.quantum_info.Z2Symmetries.find_z2_symmetries" github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/quantum_info/analysis/z2_symmetries.py#L180-L301" signature="find_z2_symmetries(operator)" modifiers="classmethod">
  ...
  <Function id="qiskit.quantum_info.Z2Symmetries.is_empty" github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/quantum_info/analysis/z2_symmetries.py#L171-L178" signature="is_empty()">
  ...
  <Function id="qiskit.quantum_info.Z2Symmetries.taper" github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/quantum_info/analysis/z2_symmetries.py#L354-L380" signature="taper(operator)">
  ...
  <Function id="qiskit.quantum_info.Z2Symmetries.taper_clifford" github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/quantum_info/analysis/z2_symmetries.py#L324-L352" signature="taper_clifford(operator)">
