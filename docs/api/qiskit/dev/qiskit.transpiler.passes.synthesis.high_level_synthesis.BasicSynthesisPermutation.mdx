...
<Class id="qiskit.transpiler.passes.synthesis.high_level_synthesis.BasicSynthesisPermutation" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/main/qiskit/transpiler/passes/synthesis/high_level_synthesis.py#L895-L905" signature="qiskit.transpiler.passes.synthesis.high_level_synthesis.BasicSynthesisPermutation" modifiers="class">
  ...
  <Function id="qiskit.transpiler.passes.synthesis.high_level_synthesis.BasicSynthesisPermutation.run" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/transpiler/passes/synthesis/high_level_synthesis.py#L902-L905" signature="run(high_level_object, coupling_map=None, target=None, qubits=None, **options)">
