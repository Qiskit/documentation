...
<Class id="qiskit.circuit.library.LinearAmplitudeFunctionGate" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/main/qiskit/circuit/library/arithmetic/linear_amplitude_function.py#L186-L347" signature="qiskit.circuit.library.LinearAmplitudeFunctionGate(num_state_qubits, slope, offset, domain, image, rescaling_factor=1, breakpoints=None, label='F')" modifiers="class">
...
$$
  ...
  *   **label** ([*str*](https://docs.python.org/3/library/stdtypes.html#str "(in Python v3.13)")) – A label for the gate.
  ...
  <Function id="qiskit.circuit.library.LinearAmplitudeFunctionGate.post_processing" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/circuit/library/arithmetic/linear_amplitude_function.py#L328-L347" signature="post_processing(scaled_value)">
