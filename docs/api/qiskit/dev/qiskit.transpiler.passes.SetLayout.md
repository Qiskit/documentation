...
`qiskit.transpiler.passes.SetLayout(*args, **kwargs)` [GitHub](https://github.com/qiskit/qiskit/tree/main/qiskit/transpiler/passes/layout/set_layout.py "view source code")
