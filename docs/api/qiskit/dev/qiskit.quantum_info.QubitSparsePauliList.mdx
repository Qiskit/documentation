---
title: QubitSparsePauliList (dev version)
description: API reference for qiskit.quantum_info.QubitSparsePauliList in the dev version of qiskit
...
<Class id="qiskit.quantum_info.QubitSparsePauliList" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/main/qiskit/quantum_info/__init__.py" signature="qiskit.quantum_info.QubitSparsePauliList(data, /, num_qubits=None)" modifiers="class">
  ...
  <Function id="qiskit.quantum_info.QubitSparsePauliList.commutes" signature="commutes(other)">
    Check if the elements of self\` commute with another qubit sparse Pauli list.

    **Parameters**

    **other** ([*QubitSparsePauliList*](#qiskit.quantum_info.QubitSparsePauliList "qiskit.quantum_info.QubitSparsePauliList")) – the qubit sparse Pauli list to check for commutation with.
  </Function>
