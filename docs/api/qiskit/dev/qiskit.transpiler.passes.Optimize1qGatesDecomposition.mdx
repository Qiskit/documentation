...
<Class id="qiskit.transpiler.passes.Optimize1qGatesDecomposition" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/main/qiskit/transpiler/passes/optimization/optimize_1q_decomposition.py#L61-L240" signature="qiskit.transpiler.passes.Optimize1qGatesDecomposition(*args, **kwargs)" modifiers="class">
  ...
  *   **basis** ([*list*](https://docs.python.org/3/builtins/stdtypes.html#list)*\[*[*str*](https://docs.python.org/3/builtins/stdtypes.html#str)*]*) – Basis gates to consider, e.g. \[‘u3’, ‘cx’]. For the effects of this pass, the basis is the set intersection between the basis parameter and the Euler basis. Ignored if `target` is also specified.
