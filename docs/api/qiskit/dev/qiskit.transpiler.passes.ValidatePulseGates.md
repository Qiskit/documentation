...
`qiskit.transpiler.passes.ValidatePulseGates(*args, **kwargs)` [GitHub](https://github.com/qiskit/qiskit/tree/main/qiskit/transpiler/passes/scheduling/alignments/pulse_gate_validation.py "view source code")
