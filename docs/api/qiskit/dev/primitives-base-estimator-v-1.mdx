...
<Class id="qiskit.primitives.BaseEstimatorV1" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/main/qiskit/primitives/base/base_estimator.py#L42-L190" signature="qiskit.primitives.BaseEstimatorV1(*, options=None)" modifiers="class">
...
$$
  ...
  **options** ([*dict*](https://docs.python.org/3/library/stdtypes.html#dict "(in Python v3.13)") *| None*) – Default options.
  ...
  <Function id="qiskit.primitives.BaseEstimatorV1.run" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/primitives/base/base_estimator.py#L123-L180" signature="run(circuits, observables, parameter_values=None, **run_options)">
