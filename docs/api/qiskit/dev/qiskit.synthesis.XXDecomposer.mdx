...
<Class id="qiskit.synthesis.XXDecomposer" github="https://github.com/qiskit/qiskit/tree/main/qiskit/synthesis/two_qubit/xx_decompose/decomposer.py" signature="qiskit.synthesis.XXDecomposer(basis_fidelity=1.0, euler_basis='U', embodiments=None, backup_optimizer=None)">
