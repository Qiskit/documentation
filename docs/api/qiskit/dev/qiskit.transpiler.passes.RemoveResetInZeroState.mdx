...
<Class id="qiskit.transpiler.passes.RemoveResetInZeroState" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.1/qiskit/transpiler/passes/optimization/remove_reset_in_zero_state.py#L20-L37" signature="qiskit.transpiler.passes.RemoveResetInZeroState(*args, **kwargs)">
