...
<Class id="qiskit.circuit.Operation" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/2.2/qiskit/circuit/operation.py#L18-L68" signature="qiskit.circuit.Operation" modifiers="class">
