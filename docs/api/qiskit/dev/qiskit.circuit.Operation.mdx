...
<Class id="qiskit.circuit.Operation" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.3/qiskit/circuit/operation.py#L18-L67" signature="qiskit.circuit.Operation" modifiers="class">
