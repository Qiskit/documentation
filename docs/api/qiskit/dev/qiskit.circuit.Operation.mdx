...
<Class id="qiskit.circuit.Operation" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/circuit/operation.py#L18-L67" signature="qiskit.circuit.Operation">
