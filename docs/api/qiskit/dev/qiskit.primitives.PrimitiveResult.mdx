...
<Class id="qiskit.primitives.PrimitiveResult" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/primitives/containers/primitive_result.py#L25-L53" signature="qiskit.primitives.PrimitiveResult(pub_results, metadata=None)">
