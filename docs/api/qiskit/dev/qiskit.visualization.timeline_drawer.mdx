...
<Function id="qiskit.visualization.timeline_drawer" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.3/qiskit/visualization/timeline/interface.py#L33-L436" signature="qiskit.visualization.timeline_drawer(program, style=None, time_range=None, disable_bits=None, show_clbits=None, idle_wires=None, plot_barriers=None, show_delays=None, show_labels=True, plotter='mpl', axis=None, filename=None, target=None, *, show_idle=None, show_barriers=None)">
  ...
  **Examples**
  ...
  ![../\_images/qiskit-visualization-timeline\_drawer-1.png](/images/api/qiskit/dev/qiskit-visualization-timeline_drawer-1.png)
  ...
  ![../\_images/qiskit-visualization-timeline\_drawer-2.png](/images/api/qiskit/dev/qiskit-visualization-timeline_drawer-2.png)
  ...
  ![../\_images/qiskit-visualization-timeline\_drawer-3.png](/images/api/qiskit/dev/qiskit-visualization-timeline_drawer-3.png)
