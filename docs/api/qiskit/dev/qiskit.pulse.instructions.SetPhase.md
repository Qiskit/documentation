...
`qiskit.pulse.instructions.SetPhase(phase, channel, name=None)` [GitHub](https://github.com/qiskit/qiskit/tree/main/qiskit/pulse/instructions/phase.py "view source code")
