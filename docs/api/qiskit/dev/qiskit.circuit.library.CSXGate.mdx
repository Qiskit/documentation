...
<Class id="qiskit.circuit.library.CSXGate" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/circuit/library/standard_gates/sx.py#L207-L305" signature="qiskit.circuit.library.CSXGate(*args, _force_mutable=False, **kwargs)">
