...
<Class id="qiskit.circuit.library.RXXGate" github="https://github.com/qiskit/qiskit/tree/main/qiskit/circuit/library/standard_gates/rxx.py" signature="qiskit.circuit.library.RXXGate(theta, label=None, *, duration=None, unit='dt')">
...
$$
  ...
  **Examples:**
  ...
  <Function id="qiskit.circuit.library.RXXGate.inverse" name="inverse" signature="inverse(annotated=False)">
