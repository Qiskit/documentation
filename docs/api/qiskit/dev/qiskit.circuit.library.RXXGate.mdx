...
<Class id="qiskit.circuit.library.RXXGate" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/main/qiskit/circuit/library/standard_gates/rxx.py#L22-L143" signature="qiskit.circuit.library.RXXGate(theta, label=None, *, duration=None, unit='dt')">
...
$$
  ...
  **Examples:**
  ...
  <Attribute id="qiskit.circuit.library.RXXGate.base_class" name="base_class">
  ...
  <Attribute id="qiskit.circuit.library.RXXGate.condition" name="condition">
    The classical condition on the instruction.
  </Attribute>

  ### condition\_bits

  <Attribute id="qiskit.circuit.library.RXXGate.condition_bits" name="condition_bits">
  ...
  <Attribute id="qiskit.circuit.library.RXXGate.duration" name="duration">
    Get the duration.
  </Attribute>

  ### label

  <Attribute id="qiskit.circuit.library.RXXGate.label" name="label">
    Return instruction label
  </Attribute>

  ### mutable

  <Attribute id="qiskit.circuit.library.RXXGate.mutable" name="mutable">
  ...
  <Attribute id="qiskit.circuit.library.RXXGate.name" name="name">
    Return the name.
  </Attribute>

  ### num\_clbits

  <Attribute id="qiskit.circuit.library.RXXGate.num_clbits" name="num_clbits">
    Return the number of clbits.
  </Attribute>

  ### num\_qubits

  <Attribute id="qiskit.circuit.library.RXXGate.num_qubits" name="num_qubits">
  ...
  <Attribute id="qiskit.circuit.library.RXXGate.unit" name="unit">
  ...
  <Function id="qiskit.circuit.library.RXXGate.inverse" name="inverse" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/circuit/library/standard_gates/rxx.py#L111-L123" signature="inverse(annotated=False)">
  ...
  <Function id="qiskit.circuit.library.RXXGate.power" name="power" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/circuit/library/standard_gates/rxx.py#L135-L138" signature="power(exponent)">
