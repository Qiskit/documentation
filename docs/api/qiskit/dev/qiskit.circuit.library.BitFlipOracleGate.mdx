...
<Class id="qiskit.circuit.library.BitFlipOracleGate" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/main/qiskit/circuit/library/bit_flip_oracle.py#L25-L141" signature="qiskit.circuit.library.BitFlipOracleGate(expression, var_order=None, label=None)" modifiers="class">
...
$$
  ...
  *   **label** ([*str*](https://docs.python.org/3/library/stdtypes.html#str) *| None*) – A label for the gate to display in visualizations. Per default, the label is set to display the textual representation of the boolean expression (truncated if needed)
  ...
  <Function id="qiskit.circuit.library.BitFlipOracleGate.from_dimacs_file" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/circuit/library/bit_flip_oracle.py#L93-L141" signature="from_dimacs_file(filename)" modifiers="classmethod">
