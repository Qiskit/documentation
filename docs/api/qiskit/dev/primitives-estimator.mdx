...
<Class id="qiskit.primitives.Estimator" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/main/qiskit/primitives/estimator.py#L38-L172" signature="qiskit.primitives.Estimator(*, options=None)" modifiers="class">
  ...
  Reference implementation of [`BaseEstimator`](primitives-base-estimator "qiskit.primitives.BaseEstimator") (V1).
  ...
  **Raises**
  ...
  <Function id="qiskit.primitives.Estimator.run" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/primitives/base/base_estimator.py#L123-L180" signature="run(circuits, observables, parameter_values=None, **run_options)">
