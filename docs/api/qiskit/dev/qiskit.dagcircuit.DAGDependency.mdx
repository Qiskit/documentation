...
<Class id="qiskit.dagcircuit.DAGDependency" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/dagcircuit/dagdependency.py#L57-L617" signature="qiskit.dagcircuit.DAGDependency">
