...
<Class id="qiskit.dagcircuit.DAGDependency" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.1/qiskit/dagcircuit/dagdependency.py#L57-L617" signature="qiskit.dagcircuit.DAGDependency">
