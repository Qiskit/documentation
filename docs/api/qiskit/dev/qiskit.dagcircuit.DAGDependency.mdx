...
<Class id="qiskit.dagcircuit.DAGDependency" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/2.0/qiskit/dagcircuit/dagdependency.py#L56-L596" signature="qiskit.dagcircuit.DAGDependency" modifiers="class">
  ...
  **Reference:**
  ...
  <Function id="qiskit.dagcircuit.DAGDependency.add_clbits" github="https://github.com/Qiskit/qiskit/tree/stable/2.0/qiskit/dagcircuit/dagdependency.py#L173-L182" signature="add_clbits(clbits)">
    Add individual clbit wires.
  </Function>

  ### add\_creg

  <Function id="qiskit.dagcircuit.DAGDependency.add_creg" github="https://github.com/Qiskit/qiskit/tree/stable/2.0/qiskit/dagcircuit/dagdependency.py#L196-L206" signature="add_creg(creg)">
    Add clbits in a classical register.
  </Function>

  ### add\_op\_node

  <Function id="qiskit.dagcircuit.DAGDependency.add_op_node" github="https://github.com/Qiskit/qiskit/tree/stable/2.0/qiskit/dagcircuit/dagdependency.py#L405-L415" signature="add_op_node(operation, qargs, cargs)">
  ...
  <Function id="qiskit.dagcircuit.DAGDependency.add_qreg" github="https://github.com/Qiskit/qiskit/tree/stable/2.0/qiskit/dagcircuit/dagdependency.py#L184-L194" signature="add_qreg(qreg)">
    Add qubits in a quantum register.
  </Function>

  ### add\_qubits

  <Function id="qiskit.dagcircuit.DAGDependency.add_qubits" github="https://github.com/Qiskit/qiskit/tree/stable/2.0/qiskit/dagcircuit/dagdependency.py#L162-L171" signature="add_qubits(qubits)">
    Add individual qubit wires.
  </Function>

  ### copy

  <Function id="qiskit.dagcircuit.DAGDependency.copy" github="https://github.com/Qiskit/qiskit/tree/stable/2.0/qiskit/dagcircuit/dagdependency.py#L487-L503" signature="copy()">
    Function to copy a DAGDependency object. :returns: a copy of a DAGDependency object. :rtype: DAGDependency
  </Function>

  ### depth

  <Function id="qiskit.dagcircuit.DAGDependency.depth" github="https://github.com/Qiskit/qiskit/tree/stable/2.0/qiskit/dagcircuit/dagdependency.py#L154-L160" signature="depth()">
    Return the circuit depth. :returns: the circuit depth :rtype: int
  </Function>

  ### direct\_predecessors

  <Function id="qiskit.dagcircuit.DAGDependency.direct_predecessors" github="https://github.com/Qiskit/qiskit/tree/stable/2.0/qiskit/dagcircuit/dagdependency.py#L312-L322" signature="direct_predecessors(node_id)">
  ...
  <Function id="qiskit.dagcircuit.DAGDependency.direct_successors" github="https://github.com/Qiskit/qiskit/tree/stable/2.0/qiskit/dagcircuit/dagdependency.py#L300-L310" signature="direct_successors(node_id)">
  ...
  <Function id="qiskit.dagcircuit.DAGDependency.draw" github="https://github.com/Qiskit/qiskit/tree/stable/2.0/qiskit/dagcircuit/dagdependency.py#L505-L523" signature="draw(scale=0.7, filename=None, style='color')">
  ...
  <Function id="qiskit.dagcircuit.DAGDependency.get_all_edges" github="https://github.com/Qiskit/qiskit/tree/stable/2.0/qiskit/dagcircuit/dagdependency.py#L262-L274" signature="get_all_edges()">
  ...
  <Function id="qiskit.dagcircuit.DAGDependency.get_edges" github="https://github.com/Qiskit/qiskit/tree/stable/2.0/qiskit/dagcircuit/dagdependency.py#L249-L260" signature="get_edges(src_id, dest_id)">
  ...
  <Function id="qiskit.dagcircuit.DAGDependency.get_in_edges" github="https://github.com/Qiskit/qiskit/tree/stable/2.0/qiskit/dagcircuit/dagdependency.py#L276-L286" signature="get_in_edges(node_id)">
  ...
  <Function id="qiskit.dagcircuit.DAGDependency.get_node" github="https://github.com/Qiskit/qiskit/tree/stable/2.0/qiskit/dagcircuit/dagdependency.py#L227-L235" signature="get_node(node_id)">
    **Parameters**
  ...
  <Function id="qiskit.dagcircuit.DAGDependency.get_nodes" github="https://github.com/Qiskit/qiskit/tree/stable/2.0/qiskit/dagcircuit/dagdependency.py#L220-L225" signature="get_nodes()">
    **Returns**
  ...
  <Function id="qiskit.dagcircuit.DAGDependency.get_out_edges" github="https://github.com/Qiskit/qiskit/tree/stable/2.0/qiskit/dagcircuit/dagdependency.py#L288-L298" signature="get_out_edges(node_id)">
  ...
  <Function id="qiskit.dagcircuit.DAGDependency.predecessors" github="https://github.com/Qiskit/qiskit/tree/stable/2.0/qiskit/dagcircuit/dagdependency.py#L336-L346" signature="predecessors(node_id)">
  ...
  <Function id="qiskit.dagcircuit.DAGDependency.replace_block_with_op" github="https://github.com/Qiskit/qiskit/tree/stable/2.0/qiskit/dagcircuit/dagdependency.py#L525-L596" signature="replace_block_with_op(node_block, op, wire_pos_map, cycle_check=True)">
  ...
  <Function id="qiskit.dagcircuit.DAGDependency.size" github="https://github.com/Qiskit/qiskit/tree/stable/2.0/qiskit/dagcircuit/dagdependency.py#L150-L152" signature="size()">
    Returns the number of gates in the circuit
  </Function>

  ### successors

  <Function id="qiskit.dagcircuit.DAGDependency.successors" github="https://github.com/Qiskit/qiskit/tree/stable/2.0/qiskit/dagcircuit/dagdependency.py#L324-L334" signature="successors(node_id)">
  ...
  <Function id="qiskit.dagcircuit.DAGDependency.to_retworkx" github="https://github.com/Qiskit/qiskit/tree/stable/2.0/qiskit/dagcircuit/dagdependency.py#L146-L148" signature="to_retworkx()">
    Returns the DAGDependency in retworkx format.
  </Function>

  ### topological\_nodes

  <Function id="qiskit.dagcircuit.DAGDependency.topological_nodes" github="https://github.com/Qiskit/qiskit/tree/stable/2.0/qiskit/dagcircuit/dagdependency.py#L348-L359" signature="topological_nodes()">
