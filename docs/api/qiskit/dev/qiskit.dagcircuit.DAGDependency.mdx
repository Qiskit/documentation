...
<Class id="qiskit.dagcircuit.DAGDependency" github="https://github.com/qiskit/qiskit/tree/main/qiskit/dagcircuit/dagdependency.py" signature="qiskit.dagcircuit.DAGDependency">
