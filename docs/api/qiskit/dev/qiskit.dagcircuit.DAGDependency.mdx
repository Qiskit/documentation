...
<Class id="qiskit.dagcircuit.DAGDependency" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/main/qiskit/dagcircuit/dagdependency.py#L58-L630" signature="qiskit.dagcircuit.DAGDependency" modifiers="class">
  ...
  **Reference:**
  ...
  <Function id="qiskit.dagcircuit.DAGDependency.add_clbits" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/dagcircuit/dagdependency.py#L207-L216" signature="add_clbits(clbits)">
    Add individual clbit wires.
  </Function>

  ### add\_creg

  <Function id="qiskit.dagcircuit.DAGDependency.add_creg" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/dagcircuit/dagdependency.py#L230-L240" signature="add_creg(creg)">
    Add clbits in a classical register.
  </Function>

  ### add\_op\_node

  <Function id="qiskit.dagcircuit.DAGDependency.add_op_node" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/dagcircuit/dagdependency.py#L439-L449" signature="add_op_node(operation, qargs, cargs)">
  ...
  <Function id="qiskit.dagcircuit.DAGDependency.add_qreg" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/dagcircuit/dagdependency.py#L218-L228" signature="add_qreg(qreg)">
    Add qubits in a quantum register.
  </Function>

  ### add\_qubits

  <Function id="qiskit.dagcircuit.DAGDependency.add_qubits" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/dagcircuit/dagdependency.py#L196-L205" signature="add_qubits(qubits)">
    Add individual qubit wires.
  </Function>

  ### copy

  <Function id="qiskit.dagcircuit.DAGDependency.copy" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/dagcircuit/dagdependency.py#L521-L537" signature="copy()">
    Function to copy a DAGDependency object. :returns: a copy of a DAGDependency object. :rtype: DAGDependency
  </Function>

  ### depth

  <Function id="qiskit.dagcircuit.DAGDependency.depth" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/dagcircuit/dagdependency.py#L188-L194" signature="depth()">
    Return the circuit depth. :returns: the circuit depth :rtype: int
  </Function>

  ### direct\_predecessors

  <Function id="qiskit.dagcircuit.DAGDependency.direct_predecessors" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/dagcircuit/dagdependency.py#L346-L356" signature="direct_predecessors(node_id)">
  ...
  <Function id="qiskit.dagcircuit.DAGDependency.direct_successors" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/dagcircuit/dagdependency.py#L334-L344" signature="direct_successors(node_id)">
  ...
  <Function id="qiskit.dagcircuit.DAGDependency.draw" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/dagcircuit/dagdependency.py#L539-L557" signature="draw(scale=0.7, filename=None, style='color')">
  ...
  <Function id="qiskit.dagcircuit.DAGDependency.get_all_edges" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/dagcircuit/dagdependency.py#L296-L308" signature="get_all_edges()">
  ...
  <Function id="qiskit.dagcircuit.DAGDependency.get_edges" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/dagcircuit/dagdependency.py#L283-L294" signature="get_edges(src_id, dest_id)">
  ...
  <Function id="qiskit.dagcircuit.DAGDependency.get_in_edges" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/dagcircuit/dagdependency.py#L310-L320" signature="get_in_edges(node_id)">
  ...
  <Function id="qiskit.dagcircuit.DAGDependency.get_node" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/dagcircuit/dagdependency.py#L261-L269" signature="get_node(node_id)">
    **Parameters**
  ...
  <Function id="qiskit.dagcircuit.DAGDependency.get_nodes" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/dagcircuit/dagdependency.py#L254-L259" signature="get_nodes()">
    **Returns**
  ...
  <Function id="qiskit.dagcircuit.DAGDependency.get_out_edges" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/dagcircuit/dagdependency.py#L322-L332" signature="get_out_edges(node_id)">
  ...
  <Function id="qiskit.dagcircuit.DAGDependency.predecessors" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/dagcircuit/dagdependency.py#L370-L380" signature="predecessors(node_id)">
  ...
  <Function id="qiskit.dagcircuit.DAGDependency.replace_block_with_op" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/dagcircuit/dagdependency.py#L559-L630" signature="replace_block_with_op(node_block, op, wire_pos_map, cycle_check=True)">
  ...
  <Function id="qiskit.dagcircuit.DAGDependency.size" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/dagcircuit/dagdependency.py#L184-L186" signature="size()">
    Returns the number of gates in the circuit
  </Function>

  ### successors

  <Function id="qiskit.dagcircuit.DAGDependency.successors" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/dagcircuit/dagdependency.py#L358-L368" signature="successors(node_id)">
  ...
  <Function id="qiskit.dagcircuit.DAGDependency.to_retworkx" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/dagcircuit/dagdependency.py#L180-L182" signature="to_retworkx()">
    Returns the DAGDependency in retworkx format.
  </Function>

  ### topological\_nodes

  <Function id="qiskit.dagcircuit.DAGDependency.topological_nodes" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/dagcircuit/dagdependency.py#L382-L393" signature="topological_nodes()">
