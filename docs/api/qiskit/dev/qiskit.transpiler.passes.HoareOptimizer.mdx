...
<Class id="qiskit.transpiler.passes.HoareOptimizer" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/main/qiskit/transpiler/passes/optimization/hoare_opt.py#L25-L416" signature="qiskit.transpiler.passes.HoareOptimizer(*args, **kwargs)" modifiers="class">
