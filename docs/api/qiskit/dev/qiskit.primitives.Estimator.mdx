...
<Class id="qiskit.primitives.Estimator" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.1/qiskit/primitives/estimator.py#L38-L158" signature="qiskit.primitives.Estimator(*, options=None)">
