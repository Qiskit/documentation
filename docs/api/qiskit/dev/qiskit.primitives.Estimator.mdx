...
<Class id="qiskit.primitives.Estimator" github="https://github.com/qiskit/qiskit/tree/main/qiskit/primitives/estimator.py" signature="qiskit.primitives.Estimator(*, options=None)">
