...
$$
  ...
  *   **slopes** ([*list*](https://docs.python.org/3/builtins/stdtypes.html#list)*\[*[*float*](https://docs.python.org/3/builtins/functions.html#float)*] | np.ndarray | None*) – The slopes for different segments of the piecewise-linear function. Defaults to `[1]`.
  *   **offsets** ([*list*](https://docs.python.org/3/builtins/stdtypes.html#list)*\[*[*float*](https://docs.python.org/3/builtins/functions.html#float)*] | np.ndarray | None*) – The offsets for different segments of the piecewise-linear function. Defaults to `[0]`.
  ...
  *   **name** ([*str*](https://docs.python.org/3/builtins/stdtypes.html#str)) – The name of the circuit.
  ...
  <Attribute id="qiskit.circuit.library.PiecewiseLinearPauliRotations.name">
