...
<Class id="qiskit.transpiler.passes.RZXCalibrationBuilder" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/transpiler/passes/calibration/rzx_builder.py#L55-L242" signature="qiskit.transpiler.passes.RZXCalibrationBuilder(*args, **kwargs)">
