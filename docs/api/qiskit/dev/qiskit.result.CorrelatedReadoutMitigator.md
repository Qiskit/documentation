...
`qiskit.result.CorrelatedReadoutMitigator(assignment_matrix, qubits=None)` [GitHub](https://github.com/qiskit/qiskit/tree/main/qiskit/result/mitigation/correlated_readout_mitigator.py "view source code")
