...
<Function id="qiskit.quantum_info.random_cnotdihedral" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/quantum_info/operators/dihedral/random.py#L22-L61" signature="qiskit.quantum_info.random_cnotdihedral(num_qubits, seed=None)">
