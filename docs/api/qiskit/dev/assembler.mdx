---
title: assembler (dev version)
description: API reference for qiskit.assembler in the dev version of qiskit
...
<Function id="qiskit.assembler.assemble_circuits" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/assembler/assemble_circuits.py#L408-L453" signature="qiskit.assembler.assemble_circuits(circuits, run_config, qobj_id, qobj_header)">
  ...
  *   **circuits** ([*List*](https://docs.python.org/3/library/typing.html#typing.List "(in Python v3.13)")*\[*[*QuantumCircuit*](circuit-quantum-circuit "qiskit.circuit.quantumcircuit.QuantumCircuit")*]*) – circuit(s) to assemble
  *   **run\_config** ([*RunConfig*](assembler-run-config "qiskit.assembler.run_config.RunConfig")) – configuration of the runtime environment
  *   **qobj\_id** ([*int*](https://docs.python.org/3/library/functions.html#int "(in Python v3.13)")) – identifier for the generated qobj
  *   **qobj\_header** ([*QobjHeader*](qobj-qobj-header "qiskit.qobj.common.QobjHeader")) – header to pass to the results
  ...
  **Return type**
  ...
  [*QasmQobj*](qobj-qasm-qobj "qiskit.qobj.qasm_qobj.QasmQobj")
...
<Function id="qiskit.assembler.assemble_schedules" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/assembler/assemble_schedules.py#L28-L107" signature="qiskit.assembler.assemble_schedules(schedules, qobj_id, qobj_header, run_config)">
  ...
  **Return type**
  ...
  [*PulseQobj*](qobj-pulse-qobj "qiskit.qobj.pulse_qobj.PulseQobj")
...
<Function id="qiskit.assembler.disassemble" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/assembler/disassemble.py#L41-L94" signature="qiskit.assembler.disassemble(qobj)">
  Disassemble a qobj and return the circuits or pulse schedules, run\_config, and user header.

  <Admonition title="Note" type="note">
    `disassemble(assemble(qc))` is not guaranteed to produce an exactly equal circuit to the input, due to limitations in the [`QasmQobj`](qobj-qasm-qobj "qiskit.qobj.QasmQobj") format that need to be maintained for backend system compatibility. This is most likely to be the case when using newer features of [`QuantumCircuit`](circuit-quantum-circuit "qiskit.circuit.QuantumCircuit"). In most cases, the output should be equivalent, if not quite equal.
  </Admonition>
...
|                                                                                                          |                              |
| -------------------------------------------------------------------------------------------------------- | ---------------------------- |
| [`RunConfig`](assembler-run-config "qiskit.assembler.RunConfig")(\[shots, seed\_simulator, memory, ...]) | Class for Run Configuration. |
