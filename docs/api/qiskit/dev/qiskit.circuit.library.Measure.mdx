...
<Class id="qiskit.circuit.library.Measure" github="https://github.com/qiskit/qiskit/tree/main/qiskit/circuit/measure.py" signature="qiskit.circuit.library.Measure(*args, _force_mutable=False, **kwargs)">
