...
<Class id="qiskit.circuit.library.GraphState" github="https://github.com/qiskit/qiskit/tree/main/qiskit/circuit/library/graph_state.py" signature="qiskit.circuit.library.GraphState(adjacency_matrix)">
...
$$
  ...
  **Raises**
  ...
  <Attribute id="qiskit.circuit.library.GraphState.instances" name="instances" attributeValue="= 168" />
