...
<Class id="qiskit.pulse.instructions.Play" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.1/qiskit/pulse/instructions/play.py#L26-L97" signature="qiskit.pulse.instructions.Play(pulse, channel, name=None)">
