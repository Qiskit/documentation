...
<Class id="qiskit.circuit.library.RZXGate" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/main/qiskit/circuit/library/standard_gates/rzx.py#L24-L215" signature="qiskit.circuit.library.RZXGate(theta, label=None)" modifiers="class">
...
$$
  ...
  *   **label** (*Optional\[*[*str*](https://docs.python.org/3/library/stdtypes.html#str "(in Python v3.13)")*]*) – An optional label for the gate.
  ...
  <Function id="qiskit.circuit.library.RZXGate.broadcast_arguments" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/circuit/gate.py#L187-L244" signature="broadcast_arguments(qargs, cargs)">
  ...
  <Function id="qiskit.circuit.library.RZXGate.control" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/circuit/library/standard_gates/rzx.py#L147-L178" signature="control(num_ctrl_qubits=1, label=None, ctrl_state=None, annotated=None)">
  ...
  <Function id="qiskit.circuit.library.RZXGate.inverse" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/circuit/library/standard_gates/rzx.py#L180-L192" signature="inverse(annotated=False)">
  ...
  <Function id="qiskit.circuit.library.RZXGate.power" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/circuit/library/standard_gates/rzx.py#L208-L210" signature="power(exponent, annotated=False)">
  ...
  <Function id="qiskit.circuit.library.RZXGate.validate_parameter" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/circuit/gate.py#L246-L260" signature="validate_parameter(parameter)">
