...
<Class id="qiskit.qobj.QobjHeader" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/main/qiskit/qobj/common.py#L62-L65" signature="qiskit.qobj.QobjHeader(**kwargs)">
  ...
  **kwargs** – arbitrary keyword arguments that can be accessed as attributes of the object.
  ...
  <Function id="qiskit.qobj.QobjHeader.from_dict" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/qobj/common.py#L41-L53" signature="classmethod from_dict(data)">
