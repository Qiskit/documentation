...
<Class id="qiskit.transpiler.passes.ContextAwareDynamicalDecoupling" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/main/qiskit/transpiler/passes/scheduling/padding/context_aware_dynamical_decoupling.py#L42-L640" signature="qiskit.transpiler.passes.ContextAwareDynamicalDecoupling(*args, **kwargs)" modifiers="class">
  ...
  **\[2] A. Kosowski, and K. Manuszewski, Classical Coloring of Graphs, Graph Colorings,**
  ...
  <Function id="qiskit.transpiler.passes.ContextAwareDynamicalDecoupling.execute" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/transpiler/basepasses.py#L161-L180" signature="execute(passmanager_ir, state, callback=None)">
  ...
  <Function id="qiskit.transpiler.passes.ContextAwareDynamicalDecoupling.get_orthogonal_sequence" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/transpiler/passes/scheduling/padding/context_aware_dynamical_decoupling.py#L231-L234" signature="get_orthogonal_sequence(order)">
  ...
  <Function id="qiskit.transpiler.passes.ContextAwareDynamicalDecoupling.name" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/passmanager/base_tasks.py#L68-L70" signature="name()">
    Name of the pass.
  ...
  <Function id="qiskit.transpiler.passes.ContextAwareDynamicalDecoupling.run" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/transpiler/passes/scheduling/padding/context_aware_dynamical_decoupling.py#L164-L229" signature="run(dag)">
  ...
  <Function id="qiskit.transpiler.passes.ContextAwareDynamicalDecoupling.update_status" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/transpiler/basepasses.py#L182-L190" signature="update_status(state, run_state)">
