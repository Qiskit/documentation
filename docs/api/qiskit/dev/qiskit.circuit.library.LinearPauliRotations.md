...
`qiskit.circuit.library.LinearPauliRotations(num_state_qubits=None, slope=1, offset=0, basis='Y', name='LinRot')` [GitHub](https://github.com/qiskit/qiskit/tree/main/qiskit/circuit/library/arithmetic/linear_pauli_rotations.py "view source code")
...
<span id="qiskit.circuit.library.LinearPauliRotations.num_captured_vars" />
...
<span id="qiskit.circuit.library.LinearPauliRotations.num_declared_vars" />
...
<span id="qiskit.circuit.library.LinearPauliRotations.num_input_vars" />
...
<span id="qiskit.circuit.library.LinearPauliRotations.num_vars" />
