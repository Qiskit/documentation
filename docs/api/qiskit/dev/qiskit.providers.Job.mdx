...
<Class id="qiskit.providers.Job" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/main/qiskit/providers/job.py#L30-L39" signature="qiskit.providers.Job">
  ...
  <Attribute id="qiskit.providers.Job.version" name="version" attributeValue="= 0" />
</Class>
