...
<Class id="qiskit.primitives.Sampler" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/main/qiskit/primitives/sampler.py#L39-L162" signature="qiskit.primitives.Sampler(*, options=None)" modifiers="class">
  ...
  **Raises**
  ...
  <Function id="qiskit.primitives.Sampler.run" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/primitives/base/base_sampler.py#L111-L142" signature="run(circuits, parameter_values=None, **run_options)">
