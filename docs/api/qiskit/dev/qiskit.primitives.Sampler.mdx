...
<Class id="qiskit.primitives.Sampler" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/main/qiskit/primitives/sampler.py#L38-L155" signature="qiskit.primitives.Sampler(*, options=None)">
  ...
  **Raises**
  ...
  <Function id="qiskit.primitives.Sampler.run" name="run" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/primitives/base/base_sampler.py#L110-L141" signature="run(circuits, parameter_values=None, **run_options)">
  ...
  <Function id="qiskit.primitives.Sampler.set_options" name="set_options" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/primitives/base/base_primitive.py#L39-L45" signature="set_options(**fields)">
