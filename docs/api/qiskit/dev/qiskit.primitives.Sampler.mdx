...
<Class id="qiskit.primitives.Sampler" github="https://github.com/qiskit/qiskit/tree/main/qiskit/primitives/sampler.py" signature="qiskit.primitives.Sampler(*, options=None)">
