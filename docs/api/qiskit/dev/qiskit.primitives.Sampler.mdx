...
<Class id="qiskit.primitives.Sampler" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.1/qiskit/primitives/sampler.py#L38-L155" signature="qiskit.primitives.Sampler(*, options=None)">
