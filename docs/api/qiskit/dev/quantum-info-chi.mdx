...
<Class id="qiskit.quantum_info.Chi" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/main/qiskit/quantum_info/operators/channel/chi.py#L40-L187" signature="qiskit.quantum_info.Chi(data, input_dims=None, output_dims=None)" modifiers="class">
