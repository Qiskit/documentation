...
`qiskit.passmanager.BasePassManager(tasks=(), max_iteration=1000)` [GitHub](https://github.com/qiskit/qiskit/tree/main/qiskit/passmanager/passmanager.py "view source code")
