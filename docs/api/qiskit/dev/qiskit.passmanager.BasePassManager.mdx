...
<Class id="qiskit.passmanager.BasePassManager" github="https://github.com/qiskit/qiskit/tree/main/qiskit/passmanager/passmanager.py" signature="qiskit.passmanager.BasePassManager(tasks=(), max_iteration=1000)">
  ...
  *   **max\_iteration** ([*int*](https://docs.python.org/3/library/functions.html#int "(in Python v3.12)")) – The maximum number of iterations the schedule will be looped if the condition is not met.
  ...
  <Function id="qiskit.passmanager.BasePassManager.run" name="run" signature="run(in_programs, callback=None, num_processes=None, **kwargs)">
