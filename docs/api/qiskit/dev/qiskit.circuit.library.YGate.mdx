...
<Class id="qiskit.circuit.library.YGate" github="https://github.com/qiskit/qiskit/tree/main/qiskit/circuit/library/standard_gates/y.py" signature="qiskit.circuit.library.YGate(*args, _force_mutable=False, **kwargs)">
