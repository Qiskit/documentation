...
<Class id="qiskit.dagcircuit.DAGDepNode" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/main/qiskit/dagcircuit/dagdepnode.py#L25-L175" signature="qiskit.dagcircuit.DAGDepNode(type=None, op=None, name=None, qargs=(), cargs=(), successors=None, predecessors=None, reachable=None, matchedwith=None, successorstovisit=None, isblocked=None, qindices=None, cindices=None, nid=-1)" modifiers="class">
  ...
  *   **nid** ([*int*](https://docs.python.org/3/library/functions.html#int))
  ...
  <Attribute id="qiskit.dagcircuit.DAGDepNode.cargs">
    Type: [`tuple`](https://docs.python.org/3/library/stdtypes.html#tuple)\[[`Clbit`](/docs/api/qiskit/dev/circuit#qiskit.circuit.Clbit "qiskit.circuit.Clbit"), ...]
  </Attribute>
  ...
  <Attribute id="qiskit.dagcircuit.DAGDepNode.qargs">
    Type: [`tuple`](https://docs.python.org/3/library/stdtypes.html#tuple)\[[`Qubit`](/docs/api/qiskit/dev/circuit#qiskit.circuit.Qubit "qiskit.circuit.Qubit"), ...]
