...
<Class id="qiskit.circuit.library.CSGate" github="https://github.com/qiskit/qiskit/tree/main/qiskit/circuit/library/standard_gates/s.py" signature="qiskit.circuit.library.CSGate(*args, _force_mutable=False, **kwargs)">
