...
<Class id="qiskit.providers.fake_provider.Fake1Q" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.1/qiskit/providers/fake_provider/fake_1q.py#L23-L91" signature="qiskit.providers.fake_provider.Fake1Q">
