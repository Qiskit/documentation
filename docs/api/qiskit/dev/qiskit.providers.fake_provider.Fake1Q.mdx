...
<Class id="qiskit.providers.fake_provider.Fake1Q" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/main/qiskit/providers/fake_provider/fake_1q.py#L23-L91" signature="qiskit.providers.fake_provider.Fake1Q">
  ...
  <Function id="qiskit.providers.fake_provider.Fake1Q.properties" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/providers/fake_provider/fake_backend.py#L474-L524" signature="properties()">
  ...
  <Function id="qiskit.providers.fake_provider.Fake1Q.run" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/providers/fake_provider/fake_backend.py#L535-L563" signature="run(run_input, **kwargs)">
