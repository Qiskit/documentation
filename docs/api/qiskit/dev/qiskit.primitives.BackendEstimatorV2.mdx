...
<Class id="qiskit.primitives.BackendEstimatorV2" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.1/qiskit/primitives/backend_estimator_v2.py#L74-L390" signature="qiskit.primitives.BackendEstimatorV2(*, backend, options=None)">
