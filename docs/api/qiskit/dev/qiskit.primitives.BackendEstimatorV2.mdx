...
<Class id="qiskit.primitives.BackendEstimatorV2" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/main/qiskit/primitives/backend_estimator_v2.py#L59-L271" signature="qiskit.primitives.BackendEstimatorV2(*, backend, options=None)">
  ...
  *   **options** ([*dict*](https://docs.python.org/3/library/stdtypes.html#dict "(in Python v3.12)") *| None*) – The options to control the default precision (`default_precision`), the operator grouping (`abelian_grouping`), and the random seed for the simulator (`seed_simulator`).
  ...
  <Attribute id="qiskit.primitives.BackendEstimatorV2.backend" name="backend">
    Returns the backend which this sampler object based on.
  </Attribute>

  ### options

  <Attribute id="qiskit.primitives.BackendEstimatorV2.options" name="options">
    Return the options
  </Attribute>
  ...
  <Function id="qiskit.primitives.BackendEstimatorV2.run" name="run" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/primitives/backend_estimator_v2.py#L127-L136" signature="run(pubs, *, precision=None)">
