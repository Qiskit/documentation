...
<Class id="qiskit.circuit.library.random_iqp" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.3/qiskit/circuit/library/iqp.py#L146-L175" signature="qiskit.circuit.library.random_iqp(num_qubits, seed=None)" modifiers="class">
  Bases:
  ...
  ![../\_images/qiskit-circuit-library-random\_iqp-1.png](/images/api/qiskit/dev/qiskit-circuit-library-random_iqp-1.png)
