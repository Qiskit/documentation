...
<Class id="qiskit.circuit.library.random_iqp" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/2.0/qiskit/circuit/library/iqp.py#L150-L180" signature="qiskit.circuit.library.random_iqp(num_qubits, seed=None)" modifiers="class">
  Bases:
