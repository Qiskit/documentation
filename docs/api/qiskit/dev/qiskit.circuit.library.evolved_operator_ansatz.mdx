...
<Class id="qiskit.circuit.library.evolved_operator_ansatz" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.3/qiskit/circuit/library/n_local/evolved_operator_ansatz.py#L39-L183" signature="qiskit.circuit.library.evolved_operator_ansatz(operators, reps=1, evolution=None, insert_barriers=False, name='EvolvedOps', parameter_prefix='t', remove_identities=True, flatten=None)" modifiers="class">
  Bases:
...
$$
  ...
  **Examples**
  ...
  ![../\_images/qiskit-circuit-library-evolved\_operator\_ansatz-1.png](/images/api/qiskit/dev/qiskit-circuit-library-evolved_operator_ansatz-1.png)
