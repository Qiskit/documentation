...
`qiskit.transpiler.passes.BasisTranslator(*args, **kwargs)`[GitHub](https://github.com/qiskit/qiskit/tree/main/qiskit/transpiler/passes/basis/basis_translator.py "view source code")
...
<span id="qiskit.transpiler.passes.BasisTranslator.execute" />
...
<span id="qiskit.transpiler.passes.BasisTranslator.update_status" />
