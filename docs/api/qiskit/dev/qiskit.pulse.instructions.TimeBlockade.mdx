...
<Class id="qiskit.pulse.instructions.TimeBlockade" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/main/qiskit/pulse/instructions/directives.py#L61-L151" signature="qiskit.pulse.instructions.TimeBlockade(duration, channel, name=None)" modifiers="class">
  Bases: `Directive`
