...
<Class id="qiskit.circuit.library.GMS" github="https://github.com/qiskit/qiskit/tree/main/qiskit/circuit/library/generalized_gates/gms.py" signature="qiskit.circuit.library.GMS(num_qubits, theta)">
