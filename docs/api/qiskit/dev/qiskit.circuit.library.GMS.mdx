...
<Class id="qiskit.circuit.library.GMS" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/circuit/library/generalized_gates/gms.py#L27-L93" signature="qiskit.circuit.library.GMS(num_qubits, theta)">
