...
<Class id="qiskit.circuit.library.GMS" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/main/qiskit/circuit/library/generalized_gates/gms.py#L27-L93" signature="qiskit.circuit.library.GMS(num_qubits, theta)">
...
$$
  ...
  *   **theta** ([*List*](https://docs.python.org/3/library/typing.html#typing.List "(in Python v3.12)")*\[*[*List*](https://docs.python.org/3/library/typing.html#typing.List "(in Python v3.12)")*\[*[*float*](https://docs.python.org/3/library/functions.html#float "(in Python v3.12)")*]] |* [*ndarray*](https://numpy.org/doc/stable/reference/generated/numpy.ndarray.html#numpy.ndarray "(in NumPy v1.26)")) – a num\_qubits x num\_qubits symmetric matrix of interaction angles for each qubit pair. The upper triangle is considered.
  ...
  <Attribute id="qiskit.circuit.library.GMS.instances" name="instances" attributeValue="169" />
  ...
  <Attribute id="qiskit.circuit.library.GMS.num_captured_vars" name="num_captured_vars">
  ...
  <Attribute id="qiskit.circuit.library.GMS.num_declared_vars" name="num_declared_vars">
  ...
  <Attribute id="qiskit.circuit.library.GMS.num_input_vars" name="num_input_vars">
  ...
  <Attribute id="qiskit.circuit.library.GMS.num_vars" name="num_vars">
