...
`qiskit.synthesis.unitary.aqc.ApproximatingObjective` [GitHub](https://github.com/qiskit/qiskit/tree/main/qiskit/synthesis/unitary/aqc/approximate.py "view source code")
