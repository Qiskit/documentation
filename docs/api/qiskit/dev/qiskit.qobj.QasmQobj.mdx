...
<Class id="qiskit.qobj.QasmQobj" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/qobj/qasm_qobj.py#L543-L656" signature="qiskit.qobj.QasmQobj(qobj_id=None, config=None, experiments=None, header=None)">
