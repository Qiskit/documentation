...
<Class id="qiskit.circuit.Instruction" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/main/qiskit/circuit/instruction.py#L55-L666" signature="qiskit.circuit.Instruction(name, num_qubits, num_clbits, params, duration=None, unit='dt', label=None)" modifiers="class">
  ...
  *   [**TypeError**](https://docs.python.org/3/library/exceptions.html#TypeError "(in Python v3.13)") – when the optional label is provided, but it is not a string.
  ...
  <Function id="qiskit.circuit.Instruction.add_decomposition" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/circuit/instruction.py#L358-L363" signature="add_decomposition(decomposition)">
    Add a decomposition of the instruction to the SessionEquivalenceLibrary.
  </Function>

  ### broadcast\_arguments

  <Function id="qiskit.circuit.Instruction.broadcast_arguments" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/circuit/instruction.py#L535-L564" signature="broadcast_arguments(qargs, cargs)">
  ...
  <Function id="qiskit.circuit.Instruction.c_if" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/circuit/instruction.py#L490-L509" signature="c_if(classical, val)">
  ...
  <Function id="qiskit.circuit.Instruction.copy" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/circuit/instruction.py#L511-L526" signature="copy(name=None)">
  ...
  <Function id="qiskit.circuit.Instruction.inverse" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/circuit/instruction.py#L433-L488" signature="inverse(annotated=False)">
  ...
  <Function id="qiskit.circuit.Instruction.is_parameterized" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/circuit/instruction.py#L323-L328" signature="is_parameterized()">
  ...
  <Function id="qiskit.circuit.Instruction.repeat" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/circuit/instruction.py#L574-L616" signature="repeat(n)">
  ...
  <Function id="qiskit.circuit.Instruction.reverse_ops" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/circuit/instruction.py#L407-L431" signature="reverse_ops()">
  ...
  <Function id="qiskit.circuit.Instruction.soft_compare" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/circuit/instruction.py#L254-L294" signature="soft_compare(other)">
  ...
  <Function id="qiskit.circuit.Instruction.to_mutable" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/circuit/instruction.py#L173-L181" signature="to_mutable()">
  ...
  <Function id="qiskit.circuit.Instruction.validate_parameter" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/circuit/instruction.py#L319-L321" signature="validate_parameter(parameter)">
