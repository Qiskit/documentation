...
<Class id="qiskit.transpiler.passes.synthesis.hls_plugins.HalfAdderSynthesisC04" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/main/qiskit/transpiler/passes/synthesis/hls_plugins.py#L1751-L1773" signature="qiskit.transpiler.passes.synthesis.hls_plugins.HalfAdderSynthesisC04" modifiers="class">
  ...
  *   `num_clean_ancillas`: The number of clean auxiliary qubits available.
  ...
  <Function id="qiskit.transpiler.passes.synthesis.hls_plugins.HalfAdderSynthesisC04.run" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/transpiler/passes/synthesis/hls_plugins.py#L1765-L1773" signature="run(high_level_object, coupling_map=None, target=None, qubits=None, **options)">
