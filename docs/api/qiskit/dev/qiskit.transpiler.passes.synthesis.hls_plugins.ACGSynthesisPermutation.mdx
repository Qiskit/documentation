...
description: API reference for qiskit.transpiler.passes.synthesis.hls_plugins.ACGSynthesisPermutation
...
<Class id="qiskit.transpiler.passes.synthesis.hls_plugins.ACGSynthesisPermutation" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/main/qiskit/transpiler/passes/synthesis/hls_plugins.py#L489-L499" signature="qiskit.transpiler.passes.synthesis.hls_plugins.ACGSynthesisPermutation" modifiers="class">
  ...
  <Function id="qiskit.transpiler.passes.synthesis.hls_plugins.ACGSynthesisPermutation.run" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/transpiler/passes/synthesis/hls_plugins.py#L496-L499" signature="run(high_level_object, coupling_map=None, target=None, qubits=None, **options)">
