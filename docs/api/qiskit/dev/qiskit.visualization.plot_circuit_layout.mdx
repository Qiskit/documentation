...
<Function id="qiskit.visualization.plot_circuit_layout" name="plot_circuit_layout" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/main/qiskit/visualization/gate_map.py" signature="qiskit.visualization.plot_circuit_layout(circuit, backend, view='virtual', qubit_coordinates=None)">
