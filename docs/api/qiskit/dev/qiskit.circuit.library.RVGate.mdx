...
<Class id="qiskit.circuit.library.RVGate" github="https://github.com/qiskit/qiskit/tree/main/qiskit/circuit/library/generalized_gates/rv.py" signature="qiskit.circuit.library.RVGate(v_x, v_y, v_z, basis='U')">
...
$$
  ...
  *   **basis** ([*str*](https://docs.python.org/3/library/stdtypes.html#str "(in Python v3.12)")*, optional*) – basis (see [`OneQubitEulerDecomposer`](qiskit.synthesis.OneQubitEulerDecomposer "qiskit.synthesis.one_qubit.one_qubit_decompose.OneQubitEulerDecomposer"))
  ...
  <Function id="qiskit.circuit.library.RVGate.inverse" name="inverse" signature="inverse(annotated=False)">
    Invert this gate.
  </Function>
