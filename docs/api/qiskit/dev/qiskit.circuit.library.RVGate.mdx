...
<Class id="qiskit.circuit.library.RVGate" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/circuit/library/generalized_gates/rv.py#L21-L97" signature="qiskit.circuit.library.RVGate(v_x, v_y, v_z, basis='U')">
