...
<Class id="qiskit.circuit.library.RVGate" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.1/qiskit/circuit/library/generalized_gates/rv.py#L21-L97" signature="qiskit.circuit.library.RVGate(v_x, v_y, v_z, basis='U')">
