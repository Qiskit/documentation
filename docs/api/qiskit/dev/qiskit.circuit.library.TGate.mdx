...
<Class id="qiskit.circuit.library.TGate" github="https://github.com/qiskit/qiskit/tree/main/qiskit/circuit/library/standard_gates/t.py" signature="qiskit.circuit.library.TGate(*args, _force_mutable=False, **kwargs)">
...
$$
  ...
  **Circuit symbol:**
  ...
  <Function id="qiskit.circuit.library.TGate.inverse" name="inverse" signature="inverse(annotated=False)">
