...
<Class id="qiskit.circuit.library.TGate" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/main/qiskit/circuit/library/standard_gates/t.py#L26-L100" signature="qiskit.circuit.library.TGate(*args, _force_mutable=False, **kwargs)">
...
$$
  ...
  **Circuit symbol:**
  ...
  <Attribute id="qiskit.circuit.library.TGate.base_class" name="base_class">
  ...
  <Attribute id="qiskit.circuit.library.TGate.condition" name="condition">
    The classical condition on the instruction.
  </Attribute>

  ### condition\_bits

  <Attribute id="qiskit.circuit.library.TGate.condition_bits" name="condition_bits">
  ...
  <Attribute id="qiskit.circuit.library.TGate.mutable" name="mutable">
  ...
  <Attribute id="qiskit.circuit.library.TGate.name" name="name">
    Return the name.
  </Attribute>

  ### num\_clbits

  <Attribute id="qiskit.circuit.library.TGate.num_clbits" name="num_clbits">
    Return the number of clbits.
  </Attribute>

  ### num\_qubits

  <Attribute id="qiskit.circuit.library.TGate.num_qubits" name="num_qubits">
  ...
  <Function id="qiskit.circuit.library.TGate.inverse" name="inverse" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/circuit/library/standard_gates/t.py#L81-L93" signature="inverse(annotated=False)">
  ...
  <Function id="qiskit.circuit.library.TGate.power" name="power" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/circuit/library/standard_gates/t.py#L95-L97" signature="power(exponent)">
