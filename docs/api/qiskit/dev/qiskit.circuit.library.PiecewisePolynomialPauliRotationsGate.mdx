...
$$
  ...
  *   **label** ([*str*](https://docs.python.org/3/library/stdtypes.html#str "(in Python v3.13)") *| None*) – An optional label for the gate.
  ...
  <Function id="qiskit.circuit.library.PiecewisePolynomialPauliRotationsGate.evaluate" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/circuit/library/arithmetic/piecewise_polynomial_pauli_rotations.py#L427-L442" signature="evaluate(x)">
