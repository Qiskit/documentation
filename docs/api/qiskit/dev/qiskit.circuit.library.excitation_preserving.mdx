...
$$
  ...
  *   **mode** ([*str*](https://docs.python.org/3/builtins/stdtypes.html#str)) – Choose the entangler mode, can be “iswap” or “fsim”.
  ...
  *   **parameter\_prefix** ([*str*](https://docs.python.org/3/builtins/stdtypes.html#str)) – The name of the free parameters.
