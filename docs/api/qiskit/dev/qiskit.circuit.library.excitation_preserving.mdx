...
$$
  ...
  **Examples**
  ...
  ![Circuit diagram output by the previous code.](/images/api/qiskit/dev/qiskit-circuit-library-excitation_preserving-1.png)
  ...
  ![Circuit diagram output by the previous code.](/images/api/qiskit/dev/qiskit-circuit-library-excitation_preserving-2_00.png)

  ![Circuit diagram output by the previous code.](/images/api/qiskit/dev/qiskit-circuit-library-excitation_preserving-2_01.png)
