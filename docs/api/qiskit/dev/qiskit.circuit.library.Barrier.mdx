...
<Class id="qiskit.circuit.library.Barrier" github="https://github.com/qiskit/qiskit/tree/main/qiskit/circuit/barrier.py" signature="qiskit.circuit.library.Barrier(num_qubits, label=None)">
