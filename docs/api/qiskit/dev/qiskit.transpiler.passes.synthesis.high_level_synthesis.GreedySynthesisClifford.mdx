...
<Class id="qiskit.transpiler.passes.synthesis.high_level_synthesis.GreedySynthesisClifford" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/main/qiskit/transpiler/passes/synthesis/high_level_synthesis.py#L662-L673" signature="qiskit.transpiler.passes.synthesis.high_level_synthesis.GreedySynthesisClifford">
  ...
  <Function id="qiskit.transpiler.passes.synthesis.high_level_synthesis.GreedySynthesisClifford.run" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/transpiler/passes/synthesis/high_level_synthesis.py#L670-L673" signature="run(high_level_object, coupling_map=None, target=None, qubits=None, **options)">
