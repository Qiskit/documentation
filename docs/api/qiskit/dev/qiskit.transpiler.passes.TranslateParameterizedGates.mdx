...
<Class id="qiskit.transpiler.passes.TranslateParameterizedGates" github="https://github.com/qiskit/qiskit/tree/main/qiskit/transpiler/passes/basis/translate_parameterized.py" signature="qiskit.transpiler.passes.TranslateParameterizedGates(*args, **kwargs)">
