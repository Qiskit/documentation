...
<Class id="qiskit.transpiler.passes.TranslateParameterizedGates" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/transpiler/passes/basis/translate_parameterized.py#L29-L151" signature="qiskit.transpiler.passes.TranslateParameterizedGates(*args, **kwargs)">
