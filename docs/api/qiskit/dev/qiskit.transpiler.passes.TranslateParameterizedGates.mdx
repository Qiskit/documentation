...
<Class id="qiskit.transpiler.passes.TranslateParameterizedGates" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/main/qiskit/transpiler/passes/basis/translate_parameterized.py#L29-L151" signature="qiskit.transpiler.passes.TranslateParameterizedGates(*args, **kwargs)">
  ...
  **Raises**
  ...
  <Attribute id="qiskit.transpiler.passes.TranslateParameterizedGates.is_analysis_pass" name="is_analysis_pass">
  ...
  <Attribute id="qiskit.transpiler.passes.TranslateParameterizedGates.is_transformation_pass" name="is_transformation_pass">
  ...
  <Function id="qiskit.transpiler.passes.TranslateParameterizedGates.execute" name="execute" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/transpiler/basepasses.py#L189-L211" signature="execute(passmanager_ir, state, callback=None)">
  ...
  <Function id="qiskit.transpiler.passes.TranslateParameterizedGates.name" name="name" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/passmanager/base_tasks.py#L68-L70" signature="name()">
    Name of the pass.
  ...
  <Function id="qiskit.transpiler.passes.TranslateParameterizedGates.run" name="run" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/transpiler/passes/basis/translate_parameterized.py#L119-L151" signature="run(dag)">
  ...
  <Function id="qiskit.transpiler.passes.TranslateParameterizedGates.update_status" name="update_status" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/transpiler/basepasses.py#L213-L221" signature="update_status(state, run_state)">
