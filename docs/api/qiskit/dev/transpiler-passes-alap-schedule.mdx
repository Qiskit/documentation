...
<Class id="qiskit.transpiler.passes.ALAPSchedule" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/main/qiskit/transpiler/passes/scheduling/alap.py#L22-L153" signature="qiskit.transpiler.passes.ALAPSchedule(*args, **kwargs)" modifiers="class">
  ...
  <Function id="qiskit.transpiler.passes.ALAPSchedule.run" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/transpiler/passes/scheduling/alap.py#L39-L153" signature="run(dag)">
