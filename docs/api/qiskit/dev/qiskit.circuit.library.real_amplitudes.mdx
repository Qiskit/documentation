---
title: real_amplitudes (dev version)
description: API reference for qiskit.circuit.library.real_amplitudes in the dev version of qiskit
...
<Class id="qiskit.circuit.library.real_amplitudes" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/main/qiskit/circuit/library/n_local/real_amplitudes.py#L27-L130" signature="qiskit.circuit.library.real_amplitudes(num_qubits, entanglement='reverse_linear', reps=3, skip_unentangled_qubits=False, skip_final_rotation_layer=False, parameter_prefix='θ', insert_barriers=False, name='RealAmplitudes')" modifiers="class">
  ...
  **Examples**
  ...
  ![../\_images/qiskit-circuit-library-real\_amplitudes-1.png](/images/api/qiskit/dev/qiskit-circuit-library-real_amplitudes-1.png)
  ...
  ![../\_images/qiskit-circuit-library-real\_amplitudes-2\_00.png](/images/api/qiskit/dev/qiskit-circuit-library-real_amplitudes-2_00.png)

  ![../\_images/qiskit-circuit-library-real\_amplitudes-2\_01.png](/images/api/qiskit/dev/qiskit-circuit-library-real_amplitudes-2_01.png)
  ...
  ![../\_images/qiskit-circuit-library-real\_amplitudes-3\_00.png](/images/api/qiskit/dev/qiskit-circuit-library-real_amplitudes-3_00.png)

  ![../\_images/qiskit-circuit-library-real\_amplitudes-3\_01.png](/images/api/qiskit/dev/qiskit-circuit-library-real_amplitudes-3_01.png)

  ![../\_images/qiskit-circuit-library-real\_amplitudes-3\_02.png](/images/api/qiskit/dev/qiskit-circuit-library-real_amplitudes-3_02.png)
  ...
  ![../\_images/qiskit-circuit-library-real\_amplitudes-4\_00.png](/images/api/qiskit/dev/qiskit-circuit-library-real_amplitudes-4_00.png)

  ![../\_images/qiskit-circuit-library-real\_amplitudes-4\_01.png](/images/api/qiskit/dev/qiskit-circuit-library-real_amplitudes-4_01.png)

  ![../\_images/qiskit-circuit-library-real\_amplitudes-4\_02.png](/images/api/qiskit/dev/qiskit-circuit-library-real_amplitudes-4_02.png)

  ![../\_images/qiskit-circuit-library-real\_amplitudes-4\_03.png](/images/api/qiskit/dev/qiskit-circuit-library-real_amplitudes-4_03.png)
