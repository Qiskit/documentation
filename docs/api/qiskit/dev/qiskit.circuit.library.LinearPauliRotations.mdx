...
<Class id="qiskit.circuit.library.LinearPauliRotations" github="https://github.com/qiskit/qiskit/tree/main/qiskit/circuit/library/arithmetic/linear_pauli_rotations.py" signature="qiskit.circuit.library.LinearPauliRotations(num_state_qubits=None, slope=1, offset=0, basis='Y', name='LinRot')">
...
$$
  ...
  *   **name** ([*str*](https://docs.python.org/3/library/stdtypes.html#str "(in Python v3.12)")) – The name of the circuit object.
  ...
  <Attribute id="qiskit.circuit.library.LinearPauliRotations.instances" name="instances" attributeValue="= 192" />
