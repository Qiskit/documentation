...
`qiskit.quantum_info.DensityMatrix(data, dims=None)` [GitHub](https://github.com/qiskit/qiskit/tree/main/qiskit/quantum_info/states/densitymatrix.py "view source code")
