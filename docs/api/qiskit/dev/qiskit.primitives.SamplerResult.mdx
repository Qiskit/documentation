...
<Class id="qiskit.primitives.SamplerResult" github="https://github.com/qiskit/qiskit/tree/main/qiskit/primitives/base/sampler_result.py" signature="qiskit.primitives.SamplerResult(quasi_dists, metadata)">
