...
<Class id="qiskit.primitives.SamplerResult" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/primitives/base/sampler_result.py#L26-L45" signature="qiskit.primitives.SamplerResult(quasi_dists, metadata)">
