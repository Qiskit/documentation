...
`qiskit.transpiler.passes.GatesInBasis(*args, **kwargs)` [GitHub](https://github.com/qiskit/qiskit/tree/main/qiskit/transpiler/passes/utils/gates_basis.py "view source code")
