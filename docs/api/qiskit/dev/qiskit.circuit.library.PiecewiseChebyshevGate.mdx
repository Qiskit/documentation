...
<Class id="qiskit.circuit.library.PiecewiseChebyshevGate" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/main/qiskit/circuit/library/arithmetic/piecewise_chebyshev.py#L356-L502" signature="qiskit.circuit.library.PiecewiseChebyshevGate(f_x, num_state_qubits, degree=None, breakpoints=None, label=None)" modifiers="class">
  ...
  *   **label** ([*str*](https://docs.python.org/3/library/stdtypes.html#str "(in Python v3.13)") *| None*) – A label for the gate.
  ...
  <Function id="qiskit.circuit.library.PiecewiseChebyshevGate.add_decomposition" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/circuit/instruction.py#L321-L326" signature="add_decomposition(decomposition)">
    Add a decomposition of the instruction to the SessionEquivalenceLibrary.
  </Function>

  ### broadcast\_arguments

  <Function id="qiskit.circuit.library.PiecewiseChebyshevGate.broadcast_arguments" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/circuit/gate.py#L188-L245" signature="broadcast_arguments(qargs, cargs)">
  ...
  <Function id="qiskit.circuit.library.PiecewiseChebyshevGate.control" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/circuit/gate.py#L105-L145" signature="control(num_ctrl_qubits=1, label=None, ctrl_state=None, annotated=None)">
  ...
  <Function id="qiskit.circuit.library.PiecewiseChebyshevGate.copy" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/circuit/instruction.py#L431-L446" signature="copy(name=None)">
  ...
  <Function id="qiskit.circuit.library.PiecewiseChebyshevGate.inverse" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/circuit/instruction.py#L374-L429" signature="inverse(annotated=False)">
  ...
  <Function id="qiskit.circuit.library.PiecewiseChebyshevGate.is_parameterized" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/circuit/instruction.py#L286-L291" signature="is_parameterized()">
  ...
  <Function id="qiskit.circuit.library.PiecewiseChebyshevGate.repeat" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/circuit/instruction.py#L494-L524" signature="repeat(n)">
  ...
  <Function id="qiskit.circuit.library.PiecewiseChebyshevGate.reverse_ops" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/circuit/instruction.py#L348-L372" signature="reverse_ops()">
  ...
  <Function id="qiskit.circuit.library.PiecewiseChebyshevGate.soft_compare" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/circuit/instruction.py#L217-L257" signature="soft_compare(other)">
  ...
  <Function id="qiskit.circuit.library.PiecewiseChebyshevGate.to_mutable" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/circuit/instruction.py#L146-L154" signature="to_mutable()">
  ...
  <Function id="qiskit.circuit.library.PiecewiseChebyshevGate.validate_parameter" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/circuit/gate.py#L247-L261" signature="validate_parameter(parameter)">
