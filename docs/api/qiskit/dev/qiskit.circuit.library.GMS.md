...
`qiskit.circuit.library.GMS(num_qubits, theta)` [GitHub](https://github.com/qiskit/qiskit/tree/main/qiskit/circuit/library/generalized_gates/gms.py "view source code")
...
![../\_images/qiskit-circuit-library-GMS-1.png](/images/api/qiskit/dev/qiskit-circuit-library-GMS-1.png)
...
<span id="qiskit.circuit.library.GMS.num_captured_vars" />
...
<span id="qiskit.circuit.library.GMS.num_declared_vars" />
...
<span id="qiskit.circuit.library.GMS.num_input_vars" />
...
<span id="qiskit.circuit.library.GMS.num_vars" />
