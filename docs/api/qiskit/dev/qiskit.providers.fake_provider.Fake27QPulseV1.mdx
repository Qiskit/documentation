...
<Class id="qiskit.providers.fake_provider.Fake27QPulseV1" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/main/qiskit/providers/fake_provider/backends_v1/fake_27q_pulse/fake_27q_pulse_v1.py#L21-L50" signature="qiskit.providers.fake_provider.Fake27QPulseV1">
  ...
  *   **time\_alive** ([*int*](https://docs.python.org/3/library/functions.html#int "(in Python v3.12)")) – time to wait before returning result
  ...
  <Function id="qiskit.providers.fake_provider.Fake27QPulseV1.run" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/providers/fake_provider/fake_backend.py#L535-L563" signature="run(run_input, **kwargs)">
