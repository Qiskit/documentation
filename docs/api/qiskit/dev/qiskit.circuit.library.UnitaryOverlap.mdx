...
<Class id="qiskit.circuit.library.UnitaryOverlap" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/circuit/library/overlap.py#L21-L98" signature="qiskit.circuit.library.UnitaryOverlap(unitary1, unitary2, prefix1='p1', prefix2='p2')">
