...
<Class id="qiskit.circuit.library.UnitaryOverlap" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/main/qiskit/circuit/library/overlap.py#L21-L98" signature="qiskit.circuit.library.UnitaryOverlap(unitary1, unitary2, prefix1='p1', prefix2='p2')">
  ...
  *   [**CircuitError**](circuit#qiskit.circuit.CircuitError "qiskit.circuit.CircuitError") – Inputs contain measurements and/or resets.
  ...
  <Attribute id="qiskit.circuit.library.UnitaryOverlap.ancillas" name="ancillas">
    Returns a list of ancilla bits in the order that the registers were added.
  </Attribute>

  ### calibrations

  <Attribute id="qiskit.circuit.library.UnitaryOverlap.calibrations" name="calibrations">
  ...
  <Attribute id="qiskit.circuit.library.UnitaryOverlap.clbits" name="clbits">
    Returns a list of classical bits in the order that the registers were added.
  </Attribute>

  ### data

  <Attribute id="qiskit.circuit.library.UnitaryOverlap.data" name="data">
  ...
  <Attribute id="qiskit.circuit.library.UnitaryOverlap.global_phase" name="global_phase">
    Return the global phase of the current circuit scope in radians.
  </Attribute>

  ### instances

  <Attribute id="qiskit.circuit.library.UnitaryOverlap.instances" name="instances" attributeValue="158" />

  ### layout

  <Attribute id="qiskit.circuit.library.UnitaryOverlap.layout" name="layout">
  ...
  <Attribute id="qiskit.circuit.library.UnitaryOverlap.metadata" name="metadata">
  ...
  <Attribute id="qiskit.circuit.library.UnitaryOverlap.num_ancillas" name="num_ancillas">
    Return the number of ancilla qubits.
  </Attribute>

  ### num\_captured\_vars

  <Attribute id="qiskit.circuit.library.UnitaryOverlap.num_captured_vars" name="num_captured_vars">
  ...
  <Attribute id="qiskit.circuit.library.UnitaryOverlap.num_clbits" name="num_clbits">
    Return number of classical bits.
  </Attribute>

  ### num\_declared\_vars

  <Attribute id="qiskit.circuit.library.UnitaryOverlap.num_declared_vars" name="num_declared_vars">
  ...
  <Attribute id="qiskit.circuit.library.UnitaryOverlap.num_input_vars" name="num_input_vars">
  ...
  <Attribute id="qiskit.circuit.library.UnitaryOverlap.num_parameters" name="num_parameters">
    The number of parameter objects in the circuit.
  </Attribute>

  ### num\_qubits

  <Attribute id="qiskit.circuit.library.UnitaryOverlap.num_qubits" name="num_qubits">
    Return number of qubits.
  </Attribute>

  ### num\_vars

  <Attribute id="qiskit.circuit.library.UnitaryOverlap.num_vars" name="num_vars">
  ...
  <Attribute id="qiskit.circuit.library.UnitaryOverlap.op_start_times" name="op_start_times">
  ...
  <Attribute id="qiskit.circuit.library.UnitaryOverlap.parameters" name="parameters">
  ...
  <Attribute id="qiskit.circuit.library.UnitaryOverlap.prefix" name="prefix" attributeValue="'circuit'" />

  ### qubits

  <Attribute id="qiskit.circuit.library.UnitaryOverlap.qubits" name="qubits">
