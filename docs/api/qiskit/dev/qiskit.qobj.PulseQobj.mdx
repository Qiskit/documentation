...
<Class id="qiskit.qobj.PulseQobj" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/qobj/pulse_qobj.py#L542-L655" signature="qiskit.qobj.PulseQobj(qobj_id, config, experiments, header=None)">
