...
<Class id="qiskit.transpiler.passes.synthesis.high_level_synthesis.TokenSwapperSynthesisPermutation" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/main/qiskit/transpiler/passes/synthesis/high_level_synthesis.py#L1183-L1256" signature="qiskit.transpiler.passes.synthesis.high_level_synthesis.TokenSwapperSynthesisPermutation" modifiers="class">
