...
You should not rely on [`type`](https://docs.python.org/3/library/functions.html#type) having an exact value; use [`isinstance()`](https://docs.python.org/3/library/functions.html#isinstance) instead for type checking. If you need to reliably retrieve the base class from an [`Instruction`](/docs/api/qiskit/dev/qiskit.circuit.Instruction "qiskit.circuit.Instruction"), see the [`Instruction.base_class`](/docs/api/qiskit/dev/qiskit.circuit.Instruction#base_class "qiskit.circuit.Instruction.base_class") attribute; singleton instances set this correctly. For most cases in using Qiskit, [`Instruction.name`](/docs/api/qiskit/dev/qiskit.circuit.Instruction#name "qiskit.circuit.Instruction.name") is a more suitable determiner of what an instruction “means” in a circuit.
