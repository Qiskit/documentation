...
<Class id="qiskit.synthesis.unitary.aqc.ApproximatingObjective" github="https://github.com/qiskit/qiskit/tree/main/qiskit/synthesis/unitary/aqc/approximate.py" signature="qiskit.synthesis.unitary.aqc.ApproximatingObjective">
