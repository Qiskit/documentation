...
<Function id="qiskit.synthesis.synth_cnot_count_full_pmh" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/synthesis/linear/cnot_synth.py#L26-L71" signature="qiskit.synthesis.synth_cnot_count_full_pmh(state, section_size=2)">
