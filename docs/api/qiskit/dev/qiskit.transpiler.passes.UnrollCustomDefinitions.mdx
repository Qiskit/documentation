...
<Class id="qiskit.transpiler.passes.UnrollCustomDefinitions" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/main/qiskit/transpiler/passes/basis/unroll_custom_definitions.py#L22-L109" signature="qiskit.transpiler.passes.UnrollCustomDefinitions(*args, **kwargs)" modifiers="class">
  ...
  *   **target** (*Optional\[*[*Target*](qiskit.transpiler.Target "qiskit.transpiler.Target")*]*) –
  ...
  <Function id="qiskit.transpiler.passes.UnrollCustomDefinitions.run" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/transpiler/passes/basis/unroll_custom_definitions.py#L46-L109" signature="run(dag)">
