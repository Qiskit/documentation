...
<Class id="qiskit.pulse.transforms.AlignRight" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.1/qiskit/pulse/transforms/alignments.py#L157-L222" signature="qiskit.pulse.transforms.AlignRight">
