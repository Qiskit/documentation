...
<Class id="qiskit.transpiler.passes.Layout2qDistance" github="https://github.com/qiskit/qiskit/tree/main/qiskit/transpiler/passes/layout/layout_2q_distance.py" signature="qiskit.transpiler.passes.Layout2qDistance(*args, **kwargs)">
