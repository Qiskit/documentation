...
<Class id="qiskit.transpiler.passes.Layout2qDistance" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/main/qiskit/transpiler/passes/layout/layout_2q_distance.py#L25-L77" signature="qiskit.transpiler.passes.Layout2qDistance(*args, **kwargs)" modifiers="class">
  ...
  *   **property\_name** ([*str*](https://docs.python.org/3/library/stdtypes.html#str)) – The property name to save the score. Default: layout\_score
  ...
  <Function id="qiskit.transpiler.passes.Layout2qDistance.execute" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/passmanager/base_tasks.py#L76-L122" signature="execute(passmanager_ir, state, callback=None)">
  ...
  <Function id="qiskit.transpiler.passes.Layout2qDistance.name" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/passmanager/base_tasks.py#L72-L74" signature="name()">
    Name of the pass.
  ...
  <Function id="qiskit.transpiler.passes.Layout2qDistance.update_status" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/passmanager/base_tasks.py#L124-L142" signature="update_status(state, run_state)">
