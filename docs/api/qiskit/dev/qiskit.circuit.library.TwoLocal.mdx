...
<Class id="qiskit.circuit.library.TwoLocal" github="https://github.com/qiskit/qiskit/tree/main/qiskit/circuit/library/n_local/two_local.py" signature="qiskit.circuit.library.TwoLocal(num_qubits=None, rotation_blocks=None, entanglement_blocks=None, entanglement='full', reps=3, skip_unentangled_qubits=False, skip_final_rotation_layer=False, parameter_prefix='θ', insert_barriers=False, initial_state=None, name='TwoLocal', flatten=None)">
