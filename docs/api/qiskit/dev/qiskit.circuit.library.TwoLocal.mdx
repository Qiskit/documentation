...
<Class id="qiskit.circuit.library.TwoLocal" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/circuit/library/n_local/two_local.py#L54-L338" signature="qiskit.circuit.library.TwoLocal(num_qubits=None, rotation_blocks=None, entanglement_blocks=None, entanglement='full', reps=3, skip_unentangled_qubits=False, skip_final_rotation_layer=False, parameter_prefix='θ', insert_barriers=False, initial_state=None, name='TwoLocal', flatten=None)">
  ...
  *   **flatten** ([*bool*](https://docs.python.org/3/library/functions.html#bool "(in Python v3.12)") *| None*) – Set this to `True` to output a flat circuit instead of nesting it inside multiple layers of gate objects. By default currently the contents of the output circuit will be wrapped in nested objects for cleaner visualization. However, if you’re using this circuit for anything besides visualization its **strongly** recommended to set this flag to `True` to avoid a large performance overhead for parameter binding.
  ...
  <Attribute id="qiskit.circuit.library.TwoLocal.instances" name="instances" attributeValue="= 158" />
  ...
  <Attribute id="qiskit.circuit.library.TwoLocal.num_captured_vars" name="num_captured_vars">
  ...
  <Attribute id="qiskit.circuit.library.TwoLocal.num_declared_vars" name="num_declared_vars">
  ...
  <Attribute id="qiskit.circuit.library.TwoLocal.num_input_vars" name="num_input_vars">
  ...
  <Attribute id="qiskit.circuit.library.TwoLocal.num_vars" name="num_vars">
  ...
  <Function id="qiskit.circuit.library.TwoLocal.get_entangler_map" name="get_entangler_map" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/circuit/library/n_local/two_local.py#L332-L338" signature="get_entangler_map(rep_num, block_num, num_block_qubits)">
