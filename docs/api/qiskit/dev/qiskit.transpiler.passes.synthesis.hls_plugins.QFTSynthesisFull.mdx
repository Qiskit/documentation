...
<Class id="qiskit.transpiler.passes.synthesis.hls_plugins.QFTSynthesisFull" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/main/qiskit/transpiler/passes/synthesis/hls_plugins.py#L863-L920" signature="qiskit.transpiler.passes.synthesis.hls_plugins.QFTSynthesisFull" modifiers="class">
  ...
  **References**
  ...
  <Function id="qiskit.transpiler.passes.synthesis.hls_plugins.QFTSynthesisFull.run" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/transpiler/passes/synthesis/hls_plugins.py#L898-L920" signature="run(high_level_object, coupling_map=None, target=None, qubits=None, **options)">
