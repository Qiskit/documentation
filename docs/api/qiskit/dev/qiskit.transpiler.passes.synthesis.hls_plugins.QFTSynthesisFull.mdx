...
<Class id="qiskit.transpiler.passes.synthesis.hls_plugins.QFTSynthesisFull" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/main/qiskit/transpiler/passes/synthesis/hls_plugins.py#L869-L926" signature="qiskit.transpiler.passes.synthesis.hls_plugins.QFTSynthesisFull" modifiers="class">
  ...
  **References**
  ...
  <Function id="qiskit.transpiler.passes.synthesis.hls_plugins.QFTSynthesisFull.run" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/transpiler/passes/synthesis/hls_plugins.py#L904-L926" signature="run(high_level_object, coupling_map=None, target=None, qubits=None, **options)">
