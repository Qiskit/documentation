...
<Class id="qiskit.pulse.transforms.AlignSequential" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/main/qiskit/pulse/transforms/alignments.py#L225-L256" signature="qiskit.pulse.transforms.AlignSequential">
  ...
  <Attribute id="qiskit.pulse.transforms.AlignSequential.is_sequential" name="is_sequential" />

  ## Methods

  ### align

  <Function id="qiskit.pulse.transforms.AlignSequential.align" name="align" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/pulse/transforms/alignments.py#L240-L256" signature="align(schedule)">
