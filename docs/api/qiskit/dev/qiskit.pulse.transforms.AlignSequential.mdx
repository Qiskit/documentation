...
<Class id="qiskit.pulse.transforms.AlignSequential" github="https://github.com/qiskit/qiskit/tree/main/qiskit/pulse/transforms/alignments.py" signature="qiskit.pulse.transforms.AlignSequential">
