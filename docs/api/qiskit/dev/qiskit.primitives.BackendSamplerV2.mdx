...
<Class id="qiskit.primitives.BackendSamplerV2" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/main/qiskit/primitives/backend_sampler_v2.py#L64-L180" signature="qiskit.primitives.BackendSamplerV2(*, backend, options=None)">
  ...
  *   **options** ([*dict*](https://docs.python.org/3/library/stdtypes.html#dict "(in Python v3.12)") *| None*) – The options to control the default shots (`default_shots`) and the random seed for the simulator (`seed_simulator`).
  ...
  <Attribute id="qiskit.primitives.BackendSamplerV2.backend" name="backend">
    Returns the backend which this sampler object based on.
  </Attribute>

  ### options

  <Attribute id="qiskit.primitives.BackendSamplerV2.options" name="options">
    Return the options
  </Attribute>
  ...
  <Function id="qiskit.primitives.BackendSamplerV2.run" name="run" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/primitives/backend_sampler_v2.py#L124-L133" signature="run(pubs, *, shots=None)">
