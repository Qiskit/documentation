...
<Class id="qiskit.primitives.BackendSamplerV2" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.1/qiskit/primitives/backend_sampler_v2.py#L65-L216" signature="qiskit.primitives.BackendSamplerV2(*, backend, options=None)">
