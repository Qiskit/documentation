...
`qiskit.circuit.library.PhaseOracle(expression, synthesizer=None, var_order=None)` [GitHub](https://github.com/qiskit/qiskit/tree/main/qiskit/circuit/library/phase_oracle.py "view source code")
...
<span id="qiskit.circuit.library.PhaseOracle.num_captured_vars" />
...
<span id="qiskit.circuit.library.PhaseOracle.num_declared_vars" />
...
<span id="qiskit.circuit.library.PhaseOracle.num_input_vars" />
...
<span id="qiskit.circuit.library.PhaseOracle.num_vars" />
