...
<Class id="qiskit.primitives.PrimitiveJob" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.1/qiskit/primitives/primitive_job.py#L25-L81" signature="qiskit.primitives.PrimitiveJob(function, *args, **kwargs)">
