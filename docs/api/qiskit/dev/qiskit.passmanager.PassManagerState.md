...
`qiskit.passmanager.PassManagerState(workflow_status, property_set)` [GitHub](https://github.com/qiskit/qiskit/tree/main/qiskit/passmanager/compilation_status.py "view source code")
