...
<Class id="qiskit.primitives.StatevectorSampler" github="https://github.com/qiskit/qiskit/tree/main/qiskit/primitives/statevector_sampler.py" signature="qiskit.primitives.StatevectorSampler(*, default_shots=1024, seed=None)">
  ...
  *   **seed** (*np.random.Generator |* [*int*](https://docs.python.org/3/library/functions.html#int "(in Python v3.12)") *| None*) – The seed or Generator object for random number generation. If None, a random seeded default RNG will be used.
  ...
  <Function id="qiskit.primitives.StatevectorSampler.run" name="run" signature="run(pubs, *, shots=None)">
