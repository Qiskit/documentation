...
<Class id="qiskit.pulse.channels.SnapshotChannel" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.1/qiskit/pulse/channels.py#L204-L211" signature="qiskit.pulse.channels.SnapshotChannel(*args, **kwargs)">
