...
`qiskit.quantum_info.Pauli(data=None)` [GitHub](https://github.com/qiskit/qiskit/tree/main/qiskit/quantum_info/operators/symplectic/pauli.py "view source code")
