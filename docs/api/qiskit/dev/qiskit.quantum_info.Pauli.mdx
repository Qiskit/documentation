...
$$
  ...
  **Raises**
  ...
  <Function id="qiskit.quantum_info.Pauli.copy" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/quantum_info/operators/symplectic/base_pauli.py#L63-L72" signature="copy()">
