...
<Class id="qiskit.quantum_info.Pauli" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.1/qiskit/quantum_info/operators/symplectic/pauli.py#L39-L742" signature="qiskit.quantum_info.Pauli(data=None)">
  Bases: `BasePauli`
...
$$
  ...
  **Raises**
  ...
  <Function id="qiskit.quantum_info.Pauli.set_truncation" github="https://github.com/Qiskit/qiskit/tree/stable/1.1/qiskit/quantum_info/operators/symplectic/pauli.py#L231-L242" signature="classmethod set_truncation(val)">
