...
<Class id="qiskit.quantum_info.Pauli" github="https://github.com/qiskit/qiskit/tree/main/qiskit/quantum_info/operators/symplectic/pauli.py" signature="qiskit.quantum_info.Pauli(data=None)">
  Bases: `BasePauli`
