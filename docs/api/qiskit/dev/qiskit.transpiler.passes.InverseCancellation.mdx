...
<Class id="qiskit.transpiler.passes.InverseCancellation" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/main/qiskit/transpiler/passes/optimization/inverse_cancellation.py#L26-L93" signature="qiskit.transpiler.passes.InverseCancellation(*args, **kwargs)" modifiers="class">
  ...
  **Raises**
  ...
  <Function id="qiskit.transpiler.passes.InverseCancellation.run" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/transpiler/passes/optimization/inverse_cancellation.py#L77-L93" signature="run(dag)">
