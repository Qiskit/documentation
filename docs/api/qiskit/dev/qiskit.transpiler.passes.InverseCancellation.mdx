...
<Class id="qiskit.transpiler.passes.InverseCancellation" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.1/qiskit/transpiler/passes/optimization/inverse_cancellation.py#L24-L176" signature="qiskit.transpiler.passes.InverseCancellation(*args, **kwargs)">
