...
<Class id="qiskit.circuit.library.MSGate" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/main/qiskit/circuit/library/generalized_gates/gms.py#L100-L174" signature="qiskit.circuit.library.MSGate(num_qubits, theta, label=None)" modifiers="class">
...
$$
  ...
  *   **label** ([*str*](https://docs.python.org/3/library/stdtypes.html#str "(in Python v3.13)") *| None*) – A gate label.
  ...
  <Function id="qiskit.circuit.library.MSGate.validate_parameter" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/circuit/library/generalized_gates/gms.py#L166-L174" signature="validate_parameter(parameter)">
