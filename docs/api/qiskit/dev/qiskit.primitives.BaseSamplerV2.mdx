...
<Class id="qiskit.primitives.BaseSamplerV2" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/main/qiskit/primitives/base/base_sampler.py#L182-L206" signature="qiskit.primitives.BaseSamplerV2" modifiers="class">
  ...
  <Function id="qiskit.primitives.BaseSamplerV2.run" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/primitives/base/base_sampler.py#L191-L206" signature="run(pubs, *, shots=None)" modifiers="abstract">
