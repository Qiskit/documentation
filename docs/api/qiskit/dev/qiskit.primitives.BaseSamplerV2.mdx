...
<Class id="qiskit.primitives.BaseSamplerV2" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/main/qiskit/primitives/base/base_sampler.py#L156-L180" signature="qiskit.primitives.BaseSamplerV2">
  ...
  <Function id="qiskit.primitives.BaseSamplerV2.run" name="run" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/primitives/base/base_sampler.py#L165-L180" signature="abstract run(pubs, *, shots=None)">
