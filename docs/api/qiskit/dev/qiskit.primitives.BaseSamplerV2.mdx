...
<Class id="qiskit.primitives.BaseSamplerV2" github="https://github.com/qiskit/qiskit/tree/main/qiskit/primitives/base/base_sampler.py" signature="qiskit.primitives.BaseSamplerV2">
