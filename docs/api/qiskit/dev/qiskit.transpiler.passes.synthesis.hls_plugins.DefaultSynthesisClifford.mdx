---
title: DefaultSynthesisClifford (dev version)
description: API reference for qiskit.transpiler.passes.synthesis.hls_plugins.DefaultSynthesisClifford in the dev version of qiskit
...
<Class id="qiskit.transpiler.passes.synthesis.hls_plugins.DefaultSynthesisClifford" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/2.2/qiskit/transpiler/passes/synthesis/hls_plugins.py#L609-L626" signature="qiskit.transpiler.passes.synthesis.hls_plugins.DefaultSynthesisClifford" modifiers="class">
  ...
  <Function id="qiskit.transpiler.passes.synthesis.hls_plugins.DefaultSynthesisClifford.run" github="https://github.com/Qiskit/qiskit/tree/stable/2.2/qiskit/transpiler/passes/synthesis/hls_plugins.py#L620-L626" signature="run(high_level_object, coupling_map=None, target=None, qubits=None, **options)">
