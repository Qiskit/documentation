...
<span id="qiskit.circuit.ForLoopOp.base_class" />
...
<span id="qiskit.circuit.ForLoopOp.condition" />
...
<span id="qiskit.circuit.ForLoopOp.mutable" />
...
<span id="qiskit.circuit.ForLoopOp.to_mutable" />
