---
title: CorrelatedReadoutMitigator (dev version)
description: API reference for qiskit.result.CorrelatedReadoutMitigator in the dev version of qiskit
...
<Class id="qiskit.result.CorrelatedReadoutMitigator" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/main/qiskit/result/mitigation/correlated_readout_mitigator.py#L28-L277" signature="qiskit.result.CorrelatedReadoutMitigator(assignment_matrix, qubits=None)" modifiers="class">
  ...
  **Raises**
  ...
  <Function id="qiskit.result.CorrelatedReadoutMitigator.assignment_matrix" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/result/mitigation/correlated_readout_mitigator.py#L214-L248" signature="assignment_matrix(qubits=None)">
  ...
  <Function id="qiskit.result.CorrelatedReadoutMitigator.expectation_value" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/result/mitigation/correlated_readout_mitigator.py#L79-L138" signature="expectation_value(data, diagonal=None, qubits=None, clbits=None, shots=None)">
  ...
  <Function id="qiskit.result.CorrelatedReadoutMitigator.mitigation_matrix" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/result/mitigation/correlated_readout_mitigator.py#L185-L212" signature="mitigation_matrix(qubits=None)">
  ...
  <Function id="qiskit.result.CorrelatedReadoutMitigator.quasi_probabilities" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/result/mitigation/correlated_readout_mitigator.py#L140-L183" signature="quasi_probabilities(data, qubits=None, clbits=None, shots=None)">
  ...
  <Function id="qiskit.result.CorrelatedReadoutMitigator.stddev_upper_bound" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/result/mitigation/correlated_readout_mitigator.py#L262-L272" signature="stddev_upper_bound(shots)">
