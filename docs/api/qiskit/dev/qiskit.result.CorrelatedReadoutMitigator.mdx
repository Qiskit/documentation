...
<Class id="qiskit.result.CorrelatedReadoutMitigator" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.3/qiskit/result/mitigation/correlated_readout_mitigator.py#L28-L277" signature="qiskit.result.CorrelatedReadoutMitigator(assignment_matrix, qubits=None)" modifiers="class">
  ...
  **Raises**
  ...
  <Function id="qiskit.result.CorrelatedReadoutMitigator.assignment_matrix" github="https://github.com/Qiskit/qiskit/tree/stable/1.3/qiskit/result/mitigation/correlated_readout_mitigator.py#L214-L248" signature="assignment_matrix(qubits=None)">
    ...
    **qubits** ([*List*](https://docs.python.org/3/library/typing.html#typing.List "(in Python v3.13)")*\[*[*int*](https://docs.python.org/3/library/functions.html#int "(in Python v3.13)")*]*) – Optional, qubits being measured.
