...
<Class id="qiskit.transpiler.passes.TemplateOptimization" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.1/qiskit/transpiler/passes/optimization/template_optimization.py#L42-L158" signature="qiskit.transpiler.passes.TemplateOptimization(*args, **kwargs)">
