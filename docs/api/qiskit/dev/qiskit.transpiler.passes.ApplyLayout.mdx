...
<Class id="qiskit.transpiler.passes.ApplyLayout" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/main/qiskit/transpiler/passes/layout/apply_layout.py#L22-L128" signature="qiskit.transpiler.passes.ApplyLayout(*args, **kwargs)" modifiers="class">
  ...
  <Function id="qiskit.transpiler.passes.ApplyLayout.run" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/transpiler/passes/layout/apply_layout.py#L38-L128" signature="run(dag)">
