...
`qiskit.circuit.library.QuantumVolume(num_qubits, depth=None, seed=None, classical_permutation=True)` [GitHub](https://github.com/qiskit/qiskit/tree/main/qiskit/circuit/library/quantum_volume.py "view source code")
...
![../\_images/qiskit-circuit-library-QuantumVolume-1.png](/images/api/qiskit/dev/qiskit-circuit-library-QuantumVolume-1.png)

**Expanded Circuit:**

![../\_images/qiskit-circuit-library-QuantumVolume-2.png](/images/api/qiskit/dev/qiskit-circuit-library-QuantumVolume-2.png)
...
<span id="qiskit.circuit.library.QuantumVolume.num_captured_vars" />
...
<span id="qiskit.circuit.library.QuantumVolume.num_declared_vars" />
...
<span id="qiskit.circuit.library.QuantumVolume.num_input_vars" />
...
<span id="qiskit.circuit.library.QuantumVolume.num_vars" />
