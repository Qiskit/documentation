...
<Class id="qiskit.circuit.library.RZZGate" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/main/qiskit/circuit/library/standard_gates/rzz.py#L22-L160" signature="qiskit.circuit.library.RZZGate(theta, label=None, *, duration=None, unit='dt')" modifiers="class">
...
$$
  ...
  **Examples:**
  ...
  <Function id="qiskit.circuit.library.RZZGate.inverse" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/circuit/library/standard_gates/rzz.py#L122-L134" signature="inverse(annotated=False)">
  ...
  <Function id="qiskit.circuit.library.RZZGate.power" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/circuit/library/standard_gates/rzz.py#L153-L155" signature="power(exponent, annotated=False)">
