...
<Class id="qiskit.circuit.library.RZZGate" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/main/qiskit/circuit/library/standard_gates/rzz.py#L21-L156" signature="qiskit.circuit.library.RZZGate(theta, label=None, *, duration=None, unit='dt')">
...
$$
  ...
  **Examples:**
  ...
  <Attribute id="qiskit.circuit.library.RZZGate.base_class" name="base_class">
  ...
  <Attribute id="qiskit.circuit.library.RZZGate.condition" name="condition">
    The classical condition on the instruction.
  </Attribute>

  ### condition\_bits

  <Attribute id="qiskit.circuit.library.RZZGate.condition_bits" name="condition_bits">
  ...
  <Attribute id="qiskit.circuit.library.RZZGate.duration" name="duration">
    Get the duration.
  </Attribute>

  ### label

  <Attribute id="qiskit.circuit.library.RZZGate.label" name="label">
    Return instruction label
  </Attribute>

  ### mutable

  <Attribute id="qiskit.circuit.library.RZZGate.mutable" name="mutable">
  ...
  <Attribute id="qiskit.circuit.library.RZZGate.name" name="name">
    Return the name.
  </Attribute>

  ### num\_clbits

  <Attribute id="qiskit.circuit.library.RZZGate.num_clbits" name="num_clbits">
    Return the number of clbits.
  </Attribute>

  ### num\_qubits

  <Attribute id="qiskit.circuit.library.RZZGate.num_qubits" name="num_qubits">
  ...
  <Attribute id="qiskit.circuit.library.RZZGate.unit" name="unit">
  ...
  <Function id="qiskit.circuit.library.RZZGate.inverse" name="inverse" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/circuit/library/standard_gates/rzz.py#L119-L131" signature="inverse(annotated=False)">
  ...
  <Function id="qiskit.circuit.library.RZZGate.power" name="power" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/circuit/library/standard_gates/rzz.py#L148-L151" signature="power(exponent)">
