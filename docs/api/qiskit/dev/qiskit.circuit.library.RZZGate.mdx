...
$$
  ...
  **Examples:**
  ...
  <Function id="qiskit.circuit.library.RZZGate.power" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/circuit/library/standard_gates/rzz.py#L148-L151" signature="power(exponent)">
