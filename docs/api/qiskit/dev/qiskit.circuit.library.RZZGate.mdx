...
<Class id="qiskit.circuit.library.RZZGate" github="https://github.com/qiskit/qiskit/tree/main/qiskit/circuit/library/standard_gates/rzz.py" signature="qiskit.circuit.library.RZZGate(theta, label=None, *, duration=None, unit='dt')">
...
$$
  ...
  **Examples:**
  ...
  <Function id="qiskit.circuit.library.RZZGate.inverse" name="inverse" signature="inverse(annotated=False)">
