...
<Class id="qiskit.pulse.instructions.RelativeBarrier" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.1/qiskit/pulse/instructions/directives.py#L35-L58" signature="qiskit.pulse.instructions.RelativeBarrier(*channels, name=None)">
  Bases: `Directive`
