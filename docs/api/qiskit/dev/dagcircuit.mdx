...
<Class id="qiskit.dagcircuit.DAGCircuitError" name="DAGCircuitError" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/dagcircuit/exceptions.py#L19-L29" signature="qiskit.dagcircuit.DAGCircuitError(*msg)">
...
<Class id="qiskit.dagcircuit.DAGDependencyError" name="DAGDependencyError" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/dagcircuit/exceptions.py#L32-L42" signature="qiskit.dagcircuit.DAGDependencyError(*msg)">
