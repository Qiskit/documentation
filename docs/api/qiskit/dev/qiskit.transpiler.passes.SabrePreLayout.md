...
`qiskit.transpiler.passes.SabrePreLayout(*args, **kwargs)` [GitHub](https://github.com/qiskit/qiskit/tree/main/qiskit/transpiler/passes/layout/sabre_pre_layout.py "view source code")
