...
<Class id="qiskit.circuit.library.PhaseEstimation" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/main/qiskit/circuit/library/phase_estimation.py#L22-L99" signature="qiskit.circuit.library.PhaseEstimation(num_evaluation_qubits, unitary, iqft=None, name='QPE')">
...
$$
  ...
  **Reference Circuit:**
  ...
  <Attribute id="qiskit.circuit.library.PhaseEstimation.ancillas" name="ancillas">
    Returns a list of ancilla bits in the order that the registers were added.
  </Attribute>

  ### calibrations

  <Attribute id="qiskit.circuit.library.PhaseEstimation.calibrations" name="calibrations">
  ...
  <Attribute id="qiskit.circuit.library.PhaseEstimation.clbits" name="clbits">
    Returns a list of classical bits in the order that the registers were added.
  </Attribute>

  ### data

  <Attribute id="qiskit.circuit.library.PhaseEstimation.data" name="data">
  ...
  <Attribute id="qiskit.circuit.library.PhaseEstimation.global_phase" name="global_phase">
    Return the global phase of the current circuit scope in radians.
  </Attribute>

  ### instances

  <Attribute id="qiskit.circuit.library.PhaseEstimation.instances" name="instances" attributeValue="= 259" />

  ### layout

  <Attribute id="qiskit.circuit.library.PhaseEstimation.layout" name="layout">
  ...
  <Attribute id="qiskit.circuit.library.PhaseEstimation.metadata" name="metadata">
  ...
  <Attribute id="qiskit.circuit.library.PhaseEstimation.num_ancillas" name="num_ancillas">
    Return the number of ancilla qubits.
  </Attribute>

  ### num\_captured\_vars

  <Attribute id="qiskit.circuit.library.PhaseEstimation.num_captured_vars" name="num_captured_vars">
  ...
  <Attribute id="qiskit.circuit.library.PhaseEstimation.num_clbits" name="num_clbits">
    Return number of classical bits.
  </Attribute>

  ### num\_declared\_vars

  <Attribute id="qiskit.circuit.library.PhaseEstimation.num_declared_vars" name="num_declared_vars">
  ...
  <Attribute id="qiskit.circuit.library.PhaseEstimation.num_input_vars" name="num_input_vars">
  ...
  <Attribute id="qiskit.circuit.library.PhaseEstimation.num_parameters" name="num_parameters">
    The number of parameter objects in the circuit.
  </Attribute>

  ### num\_qubits

  <Attribute id="qiskit.circuit.library.PhaseEstimation.num_qubits" name="num_qubits">
    Return number of qubits.
  </Attribute>

  ### num\_vars

  <Attribute id="qiskit.circuit.library.PhaseEstimation.num_vars" name="num_vars">
  ...
  <Attribute id="qiskit.circuit.library.PhaseEstimation.op_start_times" name="op_start_times">
  ...
  <Attribute id="qiskit.circuit.library.PhaseEstimation.parameters" name="parameters">
  ...
  <Attribute id="qiskit.circuit.library.PhaseEstimation.prefix" name="prefix" attributeValue="= 'circuit'" />

  ### qubits

  <Attribute id="qiskit.circuit.library.PhaseEstimation.qubits" name="qubits">
