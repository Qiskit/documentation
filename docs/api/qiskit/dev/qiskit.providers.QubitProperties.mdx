...
<Class id="qiskit.providers.QubitProperties" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/main/qiskit/providers/backend.py#L239-L264" signature="qiskit.providers.QubitProperties(t1=None, t2=None, frequency=None)" modifiers="class">
