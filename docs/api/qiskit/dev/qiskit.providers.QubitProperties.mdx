...
<Class id="qiskit.providers.QubitProperties" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.3/qiskit/providers/backend.py#L249-L274" signature="qiskit.providers.QubitProperties(t1=None, t2=None, frequency=None)" modifiers="class">
