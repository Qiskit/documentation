...
`qiskit.providers.QubitProperties(t1=None, t2=None, frequency=None)` [GitHub](https://github.com/qiskit/qiskit/tree/main/qiskit/providers/backend.py "view source code")
