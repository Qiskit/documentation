...
<Class id="qiskit.providers.QubitProperties" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/main/qiskit/providers/backend.py#L245-L270" signature="qiskit.providers.QubitProperties(t1=None, t2=None, frequency=None)">
  ...
  *   **frequency** – The frequency of a qubit in Hz
  ...
  <Attribute id="qiskit.providers.QubitProperties.t1" name="t1" />

  ### t2

  <Attribute id="qiskit.providers.QubitProperties.t2" name="t2" />

  ### frequency

  <Attribute id="qiskit.providers.QubitProperties.frequency" name="frequency" />
</Class>
