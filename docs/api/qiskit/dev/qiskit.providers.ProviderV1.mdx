...
<Class id="qiskit.providers.ProviderV1" github="https://github.com/qiskit/qiskit/tree/main/qiskit/providers/provider.py" signature="qiskit.providers.ProviderV1">
