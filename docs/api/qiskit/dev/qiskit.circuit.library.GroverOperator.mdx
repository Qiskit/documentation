...
$$
  ...
  *   **name** ([*str*](https://docs.python.org/3/library/stdtypes.html#str "(in Python v3.12)")) – The name of the circuit.
  ...
  <Attribute id="qiskit.circuit.library.GroverOperator.instances" name="instances" attributeValue="= 170" />
  ...
  <Attribute id="qiskit.circuit.library.GroverOperator.num_captured_vars" name="num_captured_vars">
  ...
  <Attribute id="qiskit.circuit.library.GroverOperator.num_declared_vars" name="num_declared_vars">
  ...
  <Attribute id="qiskit.circuit.library.GroverOperator.num_input_vars" name="num_input_vars">
  ...
  <Attribute id="qiskit.circuit.library.GroverOperator.num_vars" name="num_vars">
