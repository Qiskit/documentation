...
<Class id="qiskit.circuit.library.HiddenLinearFunction" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/circuit/library/hidden_linear_function.py#L22-L98" signature="qiskit.circuit.library.HiddenLinearFunction(adjacency_matrix)">
