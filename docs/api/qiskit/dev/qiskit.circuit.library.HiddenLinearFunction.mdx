---
title: HiddenLinearFunction (dev version)
description: API reference for qiskit.circuit.library.HiddenLinearFunction in the dev version of qiskit
...
<Class id="qiskit.circuit.library.HiddenLinearFunction" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/main/qiskit/circuit/library/hidden_linear_function.py#L23-L89" signature="qiskit.circuit.library.HiddenLinearFunction(adjacency_matrix)" modifiers="class">
...
$$
  ...
  ![Diagram illustrating the previously described circuit.](/docs/images/api/qiskit/dev/qiskit-circuit-library-HiddenLinearFunction-1.avif)
  ...
  **adjacency\_matrix** ([*list*](https://docs.python.org/3/builtins/stdtypes.html#list) *| np.ndarray*) – a symmetric n-by-n list of 0-1 lists. n will be the number of qubits.
