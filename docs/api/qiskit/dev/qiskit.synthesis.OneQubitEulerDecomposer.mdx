...
<Class id="qiskit.synthesis.OneQubitEulerDecomposer" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.2/qiskit/synthesis/one_qubit/one_qubit_decompose.py#L76-L287" signature="qiskit.synthesis.OneQubitEulerDecomposer(basis='U3', use_dag=False)" modifiers="class">
  ...
  **Raises**
  ...
  <Function id="qiskit.synthesis.OneQubitEulerDecomposer.angles" github="https://github.com/Qiskit/qiskit/tree/stable/1.2/qiskit/synthesis/one_qubit/one_qubit_decompose.py#L257-L268" signature="angles(unitary)">
  ...
  <Function id="qiskit.synthesis.OneQubitEulerDecomposer.angles_and_phase" github="https://github.com/Qiskit/qiskit/tree/stable/1.2/qiskit/synthesis/one_qubit/one_qubit_decompose.py#L270-L280" signature="angles_and_phase(unitary)">
