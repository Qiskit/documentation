...
<Class id="qiskit.circuit.library.Diagonal" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.1/qiskit/circuit/library/generalized_gates/diagonal.py#L32-L126" signature="qiskit.circuit.library.Diagonal(diag)">
