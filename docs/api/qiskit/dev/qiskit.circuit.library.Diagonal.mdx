...
<Class id="qiskit.circuit.library.Diagonal" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/main/qiskit/circuit/library/generalized_gates/diagonal.py#L32-L126" signature="qiskit.circuit.library.Diagonal(diag)">
...
$$
  ...
  **Raises**
  ...
  <Attribute id="qiskit.circuit.library.Diagonal.instances" name="instances" attributeValue="158" />
  ...
  <Attribute id="qiskit.circuit.library.Diagonal.num_captured_vars" name="num_captured_vars">
  ...
  <Attribute id="qiskit.circuit.library.Diagonal.num_declared_vars" name="num_declared_vars">
  ...
  <Attribute id="qiskit.circuit.library.Diagonal.num_input_vars" name="num_input_vars">
  ...
  <Attribute id="qiskit.circuit.library.Diagonal.num_vars" name="num_vars">
