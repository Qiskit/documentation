...
<Class id="qiskit.circuit.library.Diagonal" github="https://github.com/qiskit/qiskit/tree/main/qiskit/circuit/library/generalized_gates/diagonal.py" signature="qiskit.circuit.library.Diagonal(diag)">
