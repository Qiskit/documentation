...
`qiskit.circuit.library.InnerProduct(num_qubits)` [GitHub](https://github.com/qiskit/qiskit/tree/main/qiskit/circuit/library/boolean_logic/inner_product.py "view source code")
...
<span id="qiskit.circuit.library.InnerProduct.num_captured_vars" />
...
<span id="qiskit.circuit.library.InnerProduct.num_declared_vars" />
...
<span id="qiskit.circuit.library.InnerProduct.num_input_vars" />
...
<span id="qiskit.circuit.library.InnerProduct.num_vars" />
