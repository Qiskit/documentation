...
`qiskit.transpiler.passes.HoareOptimizer(*args, **kwargs)` [GitHub](https://github.com/qiskit/qiskit/tree/main/qiskit/transpiler/passes/optimization/hoare_opt.py "view source code")
