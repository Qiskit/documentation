...
<Class id="qiskit.circuit.library.RGQFTMultiplier" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/circuit/library/arithmetic/multipliers/rg_qft_multiplier.py#L25-L101" signature="qiskit.circuit.library.RGQFTMultiplier(num_state_qubits, num_result_qubits=None, name='RGQFTMultiplier')">
  Bases: `Multiplier`
  ...
  *   **name** ([*str*](https://docs.python.org/3/library/stdtypes.html#str "(in Python v3.12)")) – The name of the circuit object.
  ...
  <Attribute id="qiskit.circuit.library.RGQFTMultiplier.ancillas" name="ancillas">
    Returns a list of ancilla bits in the order that the registers were added.
  </Attribute>

  ### calibrations

  <Attribute id="qiskit.circuit.library.RGQFTMultiplier.calibrations" name="calibrations">
  ...
  <Attribute id="qiskit.circuit.library.RGQFTMultiplier.clbits" name="clbits">
    Returns a list of classical bits in the order that the registers were added.
  </Attribute>

  ### data

  <Attribute id="qiskit.circuit.library.RGQFTMultiplier.data" name="data">
  ...
  <Attribute id="qiskit.circuit.library.RGQFTMultiplier.global_phase" name="global_phase">
    Return the global phase of the current circuit scope in radians.
  </Attribute>

  ### instances

  <Attribute id="qiskit.circuit.library.RGQFTMultiplier.instances" name="instances" attributeValue="= 158" />

  ### layout

  <Attribute id="qiskit.circuit.library.RGQFTMultiplier.layout" name="layout">
  ...
  <Attribute id="qiskit.circuit.library.RGQFTMultiplier.metadata" name="metadata">
  ...
  <Attribute id="qiskit.circuit.library.RGQFTMultiplier.num_ancillas" name="num_ancillas">
    Return the number of ancilla qubits.
  </Attribute>

  ### num\_captured\_vars

  <Attribute id="qiskit.circuit.library.RGQFTMultiplier.num_captured_vars" name="num_captured_vars">
  ...
  <Attribute id="qiskit.circuit.library.RGQFTMultiplier.num_clbits" name="num_clbits">
    Return number of classical bits.
  </Attribute>

  ### num\_declared\_vars

  <Attribute id="qiskit.circuit.library.RGQFTMultiplier.num_declared_vars" name="num_declared_vars">
  ...
  <Attribute id="qiskit.circuit.library.RGQFTMultiplier.num_input_vars" name="num_input_vars">
  ...
  <Attribute id="qiskit.circuit.library.RGQFTMultiplier.num_parameters" name="num_parameters">
    The number of parameter objects in the circuit.
  </Attribute>

  ### num\_qubits

  <Attribute id="qiskit.circuit.library.RGQFTMultiplier.num_qubits" name="num_qubits">
    Return number of qubits.
  </Attribute>

  ### num\_result\_qubits

  <Attribute id="qiskit.circuit.library.RGQFTMultiplier.num_result_qubits" name="num_result_qubits">
  ...
  <Attribute id="qiskit.circuit.library.RGQFTMultiplier.num_state_qubits" name="num_state_qubits">
  ...
  <Attribute id="qiskit.circuit.library.RGQFTMultiplier.num_vars" name="num_vars">
  ...
  <Attribute id="qiskit.circuit.library.RGQFTMultiplier.op_start_times" name="op_start_times">
  ...
  <Attribute id="qiskit.circuit.library.RGQFTMultiplier.parameters" name="parameters">
  ...
  <Attribute id="qiskit.circuit.library.RGQFTMultiplier.prefix" name="prefix" attributeValue="= 'circuit'" />

  ### qubits

  <Attribute id="qiskit.circuit.library.RGQFTMultiplier.qubits" name="qubits">
