...
<Function id="qiskit.transpiler.preset_passmanagers.clifford_t_pass_manager" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/transpiler/preset_passmanagers/clifford_t.py#L33-L133" signature="qiskit.transpiler.preset_passmanagers.clifford_t_pass_manager(pass_manager_config, optimization_level)">
  ...
  *   **pass\_manager\_config** ([*PassManagerCliffordTConfig*](qiskit.transpiler.PassManagerCliffordTConfig "qiskit.transpiler.passmanager_config.PassManagerCliffordTConfig")) – Configuration of the pass manager.
