...
<Class id="qiskit.providers.models.GateProperties" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/main/qiskit/providers/models/backendproperties.py#L88-L158" signature="qiskit.providers.models.GateProperties(qubits, gate, parameters, **kwargs)">
  ...
  <Attribute id="qiskit.providers.models.GateProperties.qubits" name="qubits">
    qubits.
  </Attribute>

  ### gate

  <Attribute id="qiskit.providers.models.GateProperties.gate" name="gate">
    gate.
  </Attribute>

  ### parameters

  <Attribute id="qiskit.providers.models.GateProperties.parameters" name="parameters">
    parameters.
  </Attribute>
  ...
  *   **kwargs** – Optional additional fields
  ...
  <Function id="qiskit.providers.models.GateProperties.from_dict" name="from_dict" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/providers/models/backendproperties.py#L121-L139" signature="classmethod from_dict(data)">
  ...
  <Function id="qiskit.providers.models.GateProperties.to_dict" name="to_dict" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/providers/models/backendproperties.py#L141-L152" signature="to_dict()">
