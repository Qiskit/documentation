...
description: API reference for qiskit.providers.models.BackendProperties in the dev version of qiskit
...
<Class id="qiskit.providers.models.BackendProperties" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.3/qiskit/providers/models/backendproperties.py#L166-L517" signature="qiskit.providers.models.BackendProperties(backend_name, backend_version, last_update_date, qubits, gates, general, **kwargs)" modifiers="class">
  ...
  *   **kwargs** – optional additional fields
  ...
  <Function id="qiskit.providers.models.BackendProperties.gate_property" github="https://github.com/Qiskit/qiskit/tree/stable/1.3/qiskit/providers/models/backendproperties.py#L294-L331" signature="gate_property(gate, qubits=None, name=None)">
    ...
    *   **qubits** ([*int*](https://docs.python.org/3/library/functions.html#int "(in Python v3.13)")  *|*[*Iterable*](https://docs.python.org/3/library/typing.html#typing.Iterable "(in Python v3.13)")*\[*[*int*](https://docs.python.org/3/library/functions.html#int "(in Python v3.13)")*]*) – The qubit to find the property for.
    *   **name** ([*str*](https://docs.python.org/3/library/stdtypes.html#str "(in Python v3.13)")) – Optionally used to specify which gate property to return.
  ...
  <Function id="qiskit.providers.models.BackendProperties.is_gate_operational" github="https://github.com/Qiskit/qiskit/tree/stable/1.3/qiskit/providers/models/backendproperties.py#L349-L364" signature="is_gate_operational(gate, qubits=None)">
    ...
    *   **gate** ([*str*](https://docs.python.org/3/library/stdtypes.html#str "(in Python v3.13)")) – Name of the gate.
    *   **qubits** ([*int*](https://docs.python.org/3/library/functions.html#int "(in Python v3.13)")  *|*[*Iterable*](https://docs.python.org/3/library/typing.html#typing.Iterable "(in Python v3.13)")*\[*[*int*](https://docs.python.org/3/library/functions.html#int "(in Python v3.13)")*]*) – The qubit to find the operational status for.
  ...
  <Function id="qiskit.providers.models.BackendProperties.qubit_property" github="https://github.com/Qiskit/qiskit/tree/stable/1.3/qiskit/providers/models/backendproperties.py#L392-L422" signature="qubit_property(qubit, name=None)">
    ...
    *   **name** ([*str*](https://docs.python.org/3/library/stdtypes.html#str "(in Python v3.13)")) – Optionally used to specify within the hierarchy which property to return.
