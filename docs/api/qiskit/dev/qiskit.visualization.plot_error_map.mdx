...
<Function id="qiskit.visualization.plot_error_map" github="https://github.com/qiskit/qiskit/tree/main/qiskit/visualization/gate_map.py" signature="qiskit.visualization.plot_error_map(backend, figsize=(15, 12), show_title=True, qubit_coordinates=None)">
