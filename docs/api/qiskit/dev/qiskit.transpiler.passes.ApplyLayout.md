...
`qiskit.transpiler.passes.ApplyLayout(*args, **kwargs)` [GitHub](https://github.com/qiskit/qiskit/tree/main/qiskit/transpiler/passes/layout/apply_layout.py "view source code")
...
<span id="qiskit.transpiler.passes.ApplyLayout.execute" />
...
<span id="qiskit.transpiler.passes.ApplyLayout.update_status" />
