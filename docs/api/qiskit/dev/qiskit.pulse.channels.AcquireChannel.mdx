...
<Class id="qiskit.pulse.channels.AcquireChannel" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.1/qiskit/pulse/channels.py#L198-L201" signature="qiskit.pulse.channels.AcquireChannel(*args, **kwargs)">
