---
title: AcquireChannel (dev version)
description: API reference for qiskit.pulse.channels.AcquireChannel in the dev version of qiskit
...
<Class id="qiskit.pulse.channels.AcquireChannel" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.3/qiskit/pulse/channels.py#L200-L203" signature="qiskit.pulse.channels.AcquireChannel(*args, **kwargs)" modifiers="class">
  ...
  **index** – Index of channel.
  ...
  <Function id="qiskit.pulse.channels.AcquireChannel.is_parameterized" github="https://github.com/Qiskit/qiskit/tree/stable/1.3/qiskit/pulse/channels.py#L137-L139" signature="is_parameterized()">
