...
<Class id="qiskit.qobj.QasmExperimentCalibrations" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/qobj/qasm_qobj.py#L446-L484" signature="qiskit.qobj.QasmExperimentCalibrations(gates)">
