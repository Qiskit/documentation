...
<Function id="qiskit.circuit.random.random_circuit" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/circuit/random/utils.py#L458-L682" signature="qiskit.circuit.random.random_circuit(num_qubits, depth, max_operands=4, measure=False, conditional=False, reset=False, seed=None, num_operand_distribution=None)">
  ...
  *   **num\_qubits** ([*int*](https://docs.python.org/3/builtins/functions.html#int)) – number of quantum wires
  *   **depth** ([*int*](https://docs.python.org/3/builtins/functions.html#int)) – layers of operations (i.e. critical path length)
  *   **max\_operands** ([*int*](https://docs.python.org/3/builtins/functions.html#int)) – maximum qubit operands of each gate (between 1 and 4)
  *   **measure** ([*bool*](https://docs.python.org/3/builtins/functions.html#bool)) – if True, measure all qubits at the end
  *   **conditional** ([*bool*](https://docs.python.org/3/builtins/functions.html#bool)) – if True, insert middle measurements and conditionals
  *   **reset** ([*bool*](https://docs.python.org/3/builtins/functions.html#bool)) – if True, insert middle resets
  *   **seed** ([*int*](https://docs.python.org/3/builtins/functions.html#int)) – sets random seed (optional)
  *   **num\_operand\_distribution** ([*dict*](https://docs.python.org/3/builtins/stdtypes.html#dict)) – a distribution of gates that specifies the ratio of 1-qubit, 2-qubit, 3-qubit, …, n-qubit gates in the random circuit. Expect a deviation from the specified ratios that depends on the size of the requested random circuit. (optional)
...
<Function id="qiskit.circuit.random.random_circuit_from_graph" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/circuit/random/utils.py#L79-L455" signature="qiskit.circuit.random.random_circuit_from_graph(interaction_graph, min_2q_gate_per_edge=1, max_operands=2, measure=False, conditional=False, reset=False, seed=None, insert_1q_oper=True, prob_conditional=0.1, prob_reset=0.1)">
  ...
  *   **interaction\_graph** (*PyGraph | PyDiGraph | List\[Tuple\[*[*int*](https://docs.python.org/3/builtins/functions.html#int)*,* [*int*](https://docs.python.org/3/builtins/functions.html#int)*,* [*float*](https://docs.python.org/3/builtins/functions.html#float)*]]*) – Interaction Graph
  *   **min\_2q\_gate\_per\_edge** ([*int*](https://docs.python.org/3/builtins/functions.html#int)) – Minimum number of times every qubit-pair must be used in the random circuit. (optional, default:1)
  *   **max\_operands** ([*int*](https://docs.python.org/3/builtins/functions.html#int)) – maximum qubit operands of each gate(should be 1 or 2) (optional, default:2)
  *   **measure** ([*bool*](https://docs.python.org/3/builtins/functions.html#bool)) – if True, measure all qubits at the end. (optional, default: False)
  *   **conditional** ([*bool*](https://docs.python.org/3/builtins/functions.html#bool)) – if True, insert middle measurements and conditionals. (optional, default: False)
  *   **reset** ([*bool*](https://docs.python.org/3/builtins/functions.html#bool)) – if True, insert middle resets. (optional, default: False)
  *   **seed** ([*int*](https://docs.python.org/3/builtins/functions.html#int)) – sets random seed. (If None, a random seed is chosen) (optional)
  *   **insert\_1q\_oper** ([*bool*](https://docs.python.org/3/builtins/functions.html#bool)) – Insert 1Q operations to the circuit. (optional, default: True)
  *   **prob\_conditional** ([*float*](https://docs.python.org/3/builtins/functions.html#float)) – Probability less than 1.0, this is used to control the occurrence of conditionals in the circuit. (optional, default: 0.1)
  *   **prob\_reset** ([*float*](https://docs.python.org/3/builtins/functions.html#float)) – Probability less than 1.0, this is used to control the occurrence of reset in the circuit. (optional, default: 0.1)
  ...
  *   [**ValueError**](https://docs.python.org/3/builtins/exceptions.html#ValueError) – Given max\_operands=2, when any edge have probability None but not all, or any of the probabilities are negative.
</Function>
...
<Function id="qiskit.circuit.random.random_clifford_circuit" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/circuit/random/utils.py#L685-L753" signature="qiskit.circuit.random.random_clifford_circuit(num_qubits, num_gates, gates='all', seed=None)">
  ...
  *   **num\_qubits** ([*int*](https://docs.python.org/3/builtins/functions.html#int)) – number of quantum wires.
  *   **num\_gates** ([*int*](https://docs.python.org/3/builtins/functions.html#int)) – number of gates in the circuit.
  *   **gates** ([*list*](https://docs.python.org/3/builtins/stdtypes.html#list)*\[*[*str*](https://docs.python.org/3/builtins/stdtypes.html#str)*]*) – optional list of Clifford gate names to randomly sample from. If `"all"` (default), use all Clifford gates in the standard library.
  *   **seed** ([*int*](https://docs.python.org/3/builtins/functions.html#int) *| np.random.Generator*) – sets random seed/generator (optional).
