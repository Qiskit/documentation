---
title: PulseQobjInstruction (dev version)
description: API reference for qiskit.qobj.PulseQobjInstruction in the dev version of qiskit
...
<Class id="qiskit.qobj.PulseQobjInstruction" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/main/qiskit/qobj/pulse_qobj.py#L82-L279" signature="qiskit.qobj.PulseQobjInstruction(name, t0, ch=None, conditional=None, val=None, phase=None, duration=None, qubits=None, memory_slot=None, register_slot=None, kernels=None, discriminators=None, label=None, type=None, pulse_shape=None, parameters=None, frequency=None)" modifiers="class">
  ...
  *   **parameters** ([*dict*](https://docs.python.org/3/library/stdtypes.html#dict "(in Python v3.13)")) – The parameters for a parametric pulse
  ...
  <Function id="qiskit.qobj.PulseQobjInstruction.from_dict" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/qobj/pulse_qobj.py#L236-L273" signature="from_dict(data)" modifiers="classmethod">
  ...
  <Function id="qiskit.qobj.PulseQobjInstruction.to_dict" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/qobj/pulse_qobj.py#L200-L214" signature="to_dict()">
