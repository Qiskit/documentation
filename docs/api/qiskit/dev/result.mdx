...
<Function id="qiskit.result.sampled_expectation_value" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/result/sampled_expval.py#L26-L74" signature="qiskit.result.sampled_expectation_value(dist, oper)">
