---
title: BackendV2Converter (dev version)
description: API reference for qiskit.providers.BackendV2Converter in the dev version of qiskit
...
<Class id="qiskit.providers.BackendV2Converter" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/main/qiskit/providers/backend_compat.py#L283-L374" signature="qiskit.providers.BackendV2Converter(backend, name_mapping=None, add_delay=True, filter_faulty=True)" modifiers="class">
  ...
  *   **filter\_faulty** ([*bool*](https://docs.python.org/3/library/functions.html#bool "(in Python v3.13)")) – If the [`BackendProperties`](qiskit.providers.models.BackendProperties "qiskit.providers.models.BackendProperties") object (if present) for `backend` has any qubits or gates flagged as non-operational filter those from the output target.
  ...
  <Function id="qiskit.providers.BackendV2Converter.acquire_channel" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/providers/backend.py#L564-L578" signature="acquire_channel(qubit)">
  ...
  <Function id="qiskit.providers.BackendV2Converter.control_channel" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/providers/backend.py#L580-L601" signature="control_channel(qubits)">
  ...
  <Function id="qiskit.providers.BackendV2Converter.drive_channel" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/providers/backend.py#L532-L546" signature="drive_channel(qubit)">
  ...
  <Function id="qiskit.providers.BackendV2Converter.measure_channel" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/providers/backend.py#L548-L562" signature="measure_channel(qubit)">
  ...
  <Function id="qiskit.providers.BackendV2Converter.qubit_properties" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/providers/backend.py#L498-L530" signature="qubit_properties(qubit)">
  ...
  <Function id="qiskit.providers.BackendV2Converter.run" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/providers/backend_compat.py#L373-L374" signature="run(run_input, **options)">
    Run on the backend.
  ...
  <Function id="qiskit.providers.BackendV2Converter.set_options" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/providers/backend.py#L603-L620" signature="set_options(**fields)">
