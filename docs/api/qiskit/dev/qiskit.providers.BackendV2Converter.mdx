...
<Class id="qiskit.providers.BackendV2Converter" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/providers/backend_compat.py#L332-L451" signature="qiskit.providers.BackendV2Converter(backend, name_mapping=None, add_delay=True, filter_faulty=True)">
