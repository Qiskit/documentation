...
<Class id="qiskit.providers.BackendV2Converter" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/main/qiskit/providers/backend_compat.py#L346-L472" signature="qiskit.providers.BackendV2Converter(backend, name_mapping=None, add_delay=True, filter_faulty=True)" modifiers="class">
  ...
  *   **filter\_faulty** ([*bool*](https://docs.python.org/3/library/functions.html#bool "(in Python v3.13)")) – If the [`BackendProperties`](qiskit.providers.models.BackendProperties "qiskit.providers.models.BackendProperties") object (if present) for `backend` has any qubits or gates flagged as non-operational filter those from the output target.
  ...
  <Function id="qiskit.providers.BackendV2Converter.acquire_channel" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/providers/backend_compat.py#L463-L465" signature="acquire_channel(qubit)">
    <Admonition title="Deprecated since version 1.3" type="danger">
  ...
  <Function id="qiskit.providers.BackendV2Converter.control_channel" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/providers/backend_compat.py#L467-L469" signature="control_channel(qubits)">
    <Admonition title="Deprecated since version 1.3" type="danger">
  ...
  <Function id="qiskit.providers.BackendV2Converter.drive_channel" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/providers/backend_compat.py#L455-L457" signature="drive_channel(qubit)">
    <Admonition title="Deprecated since version 1.3" type="danger">
  ...
  <Function id="qiskit.providers.BackendV2Converter.measure_channel" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/providers/backend_compat.py#L459-L461" signature="measure_channel(qubit)">
    <Admonition title="Deprecated since version 1.3" type="danger">
  ...
  <Function id="qiskit.providers.BackendV2Converter.qubit_properties" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/providers/backend.py#L500-L532" signature="qubit_properties(qubit)">
  ...
  <Function id="qiskit.providers.BackendV2Converter.run" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/providers/backend_compat.py#L471-L472" signature="run(run_input, **options)">
    Run on the backend.
  ...
  <Function id="qiskit.providers.BackendV2Converter.set_options" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/providers/backend.py#L605-L622" signature="set_options(**fields)">
