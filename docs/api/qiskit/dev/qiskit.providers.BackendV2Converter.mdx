...
`qiskit.providers.BackendV2Converter(backend, name_mapping=None, add_delay=True, filter_faulty=True)` [GitHub](https://github.com/qiskit/qiskit/tree/main/qiskit/providers/backend_compat.py "view source code")
