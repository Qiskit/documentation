...
<Class id="qiskit.transpiler.passes.GatesInBasis" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.1/qiskit/transpiler/passes/utils/gates_basis.py#L20-L75" signature="qiskit.transpiler.passes.GatesInBasis(*args, **kwargs)">
