...
<Function id="qiskit.pulse.library.Sech" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/main/qiskit/pulse/library/symbolic_pulses.py#L1824-L1897" signature="qiskit.pulse.library.Sech(duration, amp, sigma, angle=0.0, name=None, zero_ends=True, limit_amplitude=None)">
