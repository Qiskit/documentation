...
<Class id="qiskit.circuit.library.random_bitwise_xor" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/2.0/qiskit/circuit/library/boolean_logic/quantum_xor.py#L156-L167" signature="qiskit.circuit.library.random_bitwise_xor(num_qubits, seed)" modifiers="class">
  Bases:
