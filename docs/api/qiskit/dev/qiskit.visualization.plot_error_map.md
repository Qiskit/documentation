...
`qiskit.visualization.plot_error_map(backend, figsize=(15, 12), show_title=True, qubit_coordinates=None)` [GitHub](https://github.com/qiskit/qiskit/tree/main/qiskit/visualization/gate_map.py "view source code")
...
![../\_images/qiskit-visualization-plot\_error\_map-1.png](/images/api/qiskit/dev/qiskit-visualization-plot_error_map-1.png)
