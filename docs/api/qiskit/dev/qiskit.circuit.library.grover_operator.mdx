...
$$
  ...
  ![Circuit diagram output by the previous code.](/docs/images/api/qiskit/dev/qiskit-circuit-library-grover_operator-1.avif)
  ...
  ![Circuit diagram output by the previous code.](/docs/images/api/qiskit/dev/qiskit-circuit-library-grover_operator-2.avif)
  ...
  ![Circuit diagram output by the previous code.](/docs/images/api/qiskit/dev/qiskit-circuit-library-grover_operator-3.avif)

  The oracle and the zero reflection can also be passed as [`qiskit.quantum_info`](/docs/api/qiskit/dev/quantum_info#module-qiskit.quantum_info "qiskit.quantum_info") objects:
  ...
  ![Circuit diagram output by the previous code.](/docs/images/api/qiskit/dev/qiskit-circuit-library-grover_operator-4.avif)
  ...
  *   **oracle** ([*QuantumCircuit*](/docs/api/qiskit/dev/qiskit.circuit.QuantumCircuit "qiskit.circuit.quantumcircuit.QuantumCircuit")  *|*[*Statevector*](qiskit.quantum_info.Statevector "qiskit.quantum_info.states.statevector.Statevector")) – The phase oracle implementing a reflection about the bad state. Note that this is not a bitflip oracle, see the docstring for more information.
  *   **state\_preparation** ([*QuantumCircuit*](/docs/api/qiskit/dev/qiskit.circuit.QuantumCircuit "qiskit.circuit.quantumcircuit.QuantumCircuit") *| None*) – The operator preparing the good and bad state. For Grover’s algorithm, this is a n-qubit Hadamard gate and for amplitude amplification or estimation the operator $\mathcal{A}$.
  *   **zero\_reflection** ([*QuantumCircuit*](/docs/api/qiskit/dev/qiskit.circuit.QuantumCircuit "qiskit.circuit.quantumcircuit.QuantumCircuit")  *|*[*DensityMatrix*](qiskit.quantum_info.DensityMatrix "qiskit.quantum_info.states.densitymatrix.DensityMatrix")  *|*[*Operator*](qiskit.quantum_info.Operator "qiskit.quantum_info.operators.operator.Operator") *| None*) – The reflection about the zero state, $\mathcal{S}_0$.
  *   **reflection\_qubits** ([*list*](https://docs.python.org/3/builtins/stdtypes.html#list)*\[*[*int*](https://docs.python.org/3/builtins/functions.html#int)*] | None*) – Qubits on which the zero reflection acts on.
  *   **insert\_barriers** ([*bool*](https://docs.python.org/3/builtins/functions.html#bool)) – Whether barriers should be inserted between the reflections and A.
  *   **name** ([*str*](https://docs.python.org/3/builtins/stdtypes.html#str)) – The name of the circuit.
  ...
  \[3] Brassard, G., Hoyer, P., Mosca, M., & Tapp, A. (2000). Quantum Amplitude Amplification and Estimation. [arXiv:quant-ph/0005055](https://arxiv.org/abs/quant-ph/0005055).
</Function>
