...
`qiskit.transpiler.passes.CollectMultiQBlocks(*args, **kwargs)` [GitHub](https://github.com/qiskit/qiskit/tree/main/qiskit/transpiler/passes/optimization/collect_multiqubit_blocks.py "view source code")
