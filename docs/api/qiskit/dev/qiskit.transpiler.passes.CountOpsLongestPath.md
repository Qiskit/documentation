...
`qiskit.transpiler.passes.CountOpsLongestPath(*args, **kwargs)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/1.0/qiskit/transpiler/passes/analysis/count_ops_longest_path.py "view source code")
...
<span id="qiskit.transpiler.passes.CountOpsLongestPath.execute" />
...
<span id="qiskit.transpiler.passes.CountOpsLongestPath.update_status" />
