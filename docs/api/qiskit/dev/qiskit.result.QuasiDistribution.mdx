...
<Class id="qiskit.result.QuasiDistribution" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/result/distributions/quasi.py#L26-L154" signature="qiskit.result.QuasiDistribution(data, shots=None, stddev_upper_bound=None)">
