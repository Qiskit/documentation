...
<Class id="qiskit.passmanager.PassManagerError" name="PassManagerError" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/passmanager/exceptions.py#L18-L19" signature="qiskit.passmanager.PassManagerError(*message)">
  Pass manager error.
