---
title: InstructionDurationCheck (dev version)
description: API reference for qiskit.transpiler.passes.InstructionDurationCheck in the dev version of qiskit
