...
`qiskit.dagcircuit.DAGCircuitError(*msg)` [GitHub](https://github.com/qiskit/qiskit/tree/main/qiskit/dagcircuit/exceptions.py "view source code")
...
`qiskit.dagcircuit.DAGDependencyError(*msg)` [GitHub](https://github.com/qiskit/qiskit/tree/main/qiskit/dagcircuit/exceptions.py "view source code")
