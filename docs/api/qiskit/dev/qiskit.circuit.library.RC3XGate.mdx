...
<Class id="qiskit.circuit.library.RC3XGate" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/main/qiskit/circuit/library/standard_gates/x.py#L644-L696" signature="qiskit.circuit.library.RC3XGate(*args, _force_mutable=False, **kwargs)" modifiers="class">
  ...
  <Function id="qiskit.circuit.library.RC3XGate.broadcast_arguments" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/circuit/gate.py#L187-L244" signature="broadcast_arguments(qargs, cargs)">
  ...
  <Function id="qiskit.circuit.library.RC3XGate.control" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/circuit/gate.py#L104-L144" signature="control(num_ctrl_qubits=1, label=None, ctrl_state=None, annotated=None)">
  ...
  <Function id="qiskit.circuit.library.RC3XGate.validate_parameter" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/circuit/gate.py#L246-L260" signature="validate_parameter(parameter)">
