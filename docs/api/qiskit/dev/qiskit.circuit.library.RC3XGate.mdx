...
<Class id="qiskit.circuit.library.RC3XGate" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/main/qiskit/circuit/library/standard_gates/x.py#L838-L934" signature="qiskit.circuit.library.RC3XGate(*args, _force_mutable=False, **kwargs)" modifiers="class">
