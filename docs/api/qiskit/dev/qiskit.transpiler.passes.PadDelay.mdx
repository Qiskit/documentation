...
<Class id="qiskit.transpiler.passes.PadDelay" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/transpiler/passes/scheduling/padding/pad_delay.py#L23-L79" signature="qiskit.transpiler.passes.PadDelay(*args, **kwargs)">
  Bases: `BasePadding`
