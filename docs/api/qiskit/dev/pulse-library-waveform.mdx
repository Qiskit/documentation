---
title: Waveform (dev version)
description: API reference for qiskit.pulse.library.Waveform in the dev version of qiskit
...
<Class id="qiskit.pulse.library.Waveform" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/main/qiskit/pulse/library/waveform.py#L24-L136" signature="qiskit.pulse.library.Waveform(samples, name=None, epsilon=1e-07, limit_amplitude=None)" modifiers="class">
  Bases: `Pulse`
  ...
  *   **limit\_amplitude** ([*bool*](https://docs.python.org/3/library/functions.html#bool "(in Python v3.13)") *| None*) – Passed to parent Pulse
  ...
  <Function id="qiskit.pulse.library.Waveform.draw" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/pulse/library/pulse.py#L79-L134" signature="draw(style=None, backend=None, time_range=None, time_unit='dt', show_waveform_info=True, plotter='mpl2d', axis=None)">
  ...
  <Function id="qiskit.pulse.library.Waveform.is_parameterized" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/pulse/library/waveform.py#L110-L112" signature="is_parameterized()">
