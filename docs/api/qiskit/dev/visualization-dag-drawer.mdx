...
<Function id="qiskit.visualization.dag_drawer" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/main/qiskit/visualization/dag_visualization.py#L74-L317" signature="qiskit.visualization.dag_drawer(dag, scale=0.7, filename=None, style='color')">
  ...
  *   **dag** ([*DAGCircuit*](dagcircuit-dag-circuit "qiskit.dagcircuit.DAGCircuit")  *or*[*DAGDependency*](dagcircuit-dag-dependency "qiskit.dagcircuit.DAGDependency")) – The dag to draw.
