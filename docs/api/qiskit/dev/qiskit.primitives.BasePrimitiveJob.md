...
`qiskit.primitives.BasePrimitiveJob(job_id, **kwargs)` [GitHub](https://github.com/qiskit/qiskit/tree/main/qiskit/primitives/base/base_primitive_job.py "view source code")
...
*   **job\_id** – A unique id in the context of the primitive used to run the job.
