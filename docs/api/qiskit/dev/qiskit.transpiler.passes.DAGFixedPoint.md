...
`qiskit.transpiler.passes.DAGFixedPoint(*args, **kwargs)` [GitHub](https://github.com/qiskit/qiskit/tree/main/qiskit/transpiler/passes/utils/dag_fixed_point.py "view source code")
