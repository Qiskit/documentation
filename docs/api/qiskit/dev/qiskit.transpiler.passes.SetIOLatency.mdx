...
<Class id="qiskit.transpiler.passes.SetIOLatency" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/transpiler/passes/scheduling/scheduling/set_io_latency.py#L18-L64" signature="qiskit.transpiler.passes.SetIOLatency(*args, **kwargs)">
