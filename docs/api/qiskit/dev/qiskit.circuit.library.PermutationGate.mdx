...
<Class id="qiskit.circuit.library.PermutationGate" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/main/qiskit/circuit/library/generalized_gates/permutation.py#L103-L201" signature="qiskit.circuit.library.PermutationGate(pattern)" modifiers="class">
  ...
  **Expanded Circuit:**
  ...
  <Function id="qiskit.circuit.library.PermutationGate.add_decomposition" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/circuit/instruction.py#L318-L323" signature="add_decomposition(decomposition)">
  ...
  <Function id="qiskit.circuit.library.PermutationGate.copy" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/circuit/instruction.py#L428-L443" signature="copy(name=None)">
  ...
  <Function id="qiskit.circuit.library.PermutationGate.inverse" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/circuit/library/generalized_gates/permutation.py#L185-L190" signature="inverse(annotated=False)">
  ...
  <Function id="qiskit.circuit.library.PermutationGate.is_parameterized" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/circuit/instruction.py#L283-L288" signature="is_parameterized()">
  ...
  <Function id="qiskit.circuit.library.PermutationGate.repeat" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/circuit/instruction.py#L491-L521" signature="repeat(n)">
  ...
  <Function id="qiskit.circuit.library.PermutationGate.reverse_ops" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/circuit/instruction.py#L345-L369" signature="reverse_ops()">
  ...
  <Function id="qiskit.circuit.library.PermutationGate.soft_compare" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/circuit/instruction.py#L214-L254" signature="soft_compare(other)">
  ...
  <Function id="qiskit.circuit.library.PermutationGate.to_mutable" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/circuit/instruction.py#L144-L152" signature="to_mutable()">
  ...
  <Function id="qiskit.circuit.library.PermutationGate.validate_parameter" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/circuit/library/generalized_gates/permutation.py#L176-L178" signature="validate_parameter(parameter)">
