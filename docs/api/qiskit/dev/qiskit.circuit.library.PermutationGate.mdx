...
<Class id="qiskit.circuit.library.PermutationGate" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.1/qiskit/circuit/library/generalized_gates/permutation.py#L97-L193" signature="qiskit.circuit.library.PermutationGate(pattern)">
