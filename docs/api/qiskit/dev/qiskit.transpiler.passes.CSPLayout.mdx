...
`qiskit.transpiler.passes.CSPLayout(*args, **kwargs)` [GitHub](https://github.com/qiskit/qiskit/tree/main/qiskit/transpiler/passes/layout/csp_layout.py "view source code")
