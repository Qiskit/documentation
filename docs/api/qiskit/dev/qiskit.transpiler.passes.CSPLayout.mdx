...
<Class id="qiskit.transpiler.passes.CSPLayout" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/main/qiskit/transpiler/passes/layout/csp_layout.py#L28-L132" signature="qiskit.transpiler.passes.CSPLayout(*args, **kwargs)" modifiers="class">
