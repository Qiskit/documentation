...
`qiskit.transpiler.TransformationPass(*args, **kwargs)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/1.0/qiskit/transpiler/basepasses.py "view source code")
...
<span id="qiskit.transpiler.TransformationPass.execute" />
...
<span id="qiskit.transpiler.TransformationPass.update_status" />
