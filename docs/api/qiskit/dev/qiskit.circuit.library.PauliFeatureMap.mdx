...
$$
  ...
  *   **insert\_barriers** ([*bool*](https://docs.python.org/3/library/functions.html#bool "(in Python v3.12)")) – If True, barriers are inserted in between the evolution instructions and hadamard layers.
  ...
  <Attribute id="qiskit.circuit.library.PauliFeatureMap.alpha" name="alpha">
  ...
  <Attribute id="qiskit.circuit.library.PauliFeatureMap.ancillas" name="ancillas">
    Returns a list of ancilla bits in the order that the registers were added.
  </Attribute>

  ### calibrations

  <Attribute id="qiskit.circuit.library.PauliFeatureMap.calibrations" name="calibrations">
  ...
  <Attribute id="qiskit.circuit.library.PauliFeatureMap.entanglement" name="entanglement">
  ...
  <Attribute id="qiskit.circuit.library.PauliFeatureMap.feature_dimension" name="feature_dimension">
  ...
  <Attribute id="qiskit.circuit.library.PauliFeatureMap.flatten" name="flatten">
    Returns whether the circuit is wrapped in nested gates/instructions or flattened.
  </Attribute>

  ### global\_phase

  <Attribute id="qiskit.circuit.library.PauliFeatureMap.global_phase" name="global_phase">
    Return the global phase of the current circuit scope in radians.
  </Attribute>

  ### initial\_state

  <Attribute id="qiskit.circuit.library.PauliFeatureMap.initial_state" name="initial_state">
  ...
  <Attribute id="qiskit.circuit.library.PauliFeatureMap.insert_barriers" name="insert_barriers">
  ...
  <Attribute id="qiskit.circuit.library.PauliFeatureMap.instances" name="instances" attributeValue="= 186" />

  ### layout

  <Attribute id="qiskit.circuit.library.PauliFeatureMap.layout" name="layout">
  ...
  <Attribute id="qiskit.circuit.library.PauliFeatureMap.metadata" name="metadata">
  ...
  <Attribute id="qiskit.circuit.library.PauliFeatureMap.num_ancillas" name="num_ancillas">
    Return the number of ancilla qubits.
  </Attribute>

  ### num\_captured\_vars

  <Attribute id="qiskit.circuit.library.PauliFeatureMap.num_captured_vars" name="num_captured_vars">
  ...
  <Attribute id="qiskit.circuit.library.PauliFeatureMap.num_declared_vars" name="num_declared_vars">
  ...
  <Attribute id="qiskit.circuit.library.PauliFeatureMap.num_input_vars" name="num_input_vars">
  ...
  <Attribute id="qiskit.circuit.library.PauliFeatureMap.num_layers" name="num_layers">
  ...
  <Attribute id="qiskit.circuit.library.PauliFeatureMap.num_qubits" name="num_qubits">
  ...
  <Attribute id="qiskit.circuit.library.PauliFeatureMap.num_vars" name="num_vars">
  ...
  <Attribute id="qiskit.circuit.library.PauliFeatureMap.op_start_times" name="op_start_times">
  ...
  <Attribute id="qiskit.circuit.library.PauliFeatureMap.ordered_parameters" name="ordered_parameters">
  ...
  <Attribute id="qiskit.circuit.library.PauliFeatureMap.parameter_bounds" name="parameter_bounds">
  ...
  <Attribute id="qiskit.circuit.library.PauliFeatureMap.parameters" name="parameters" />

  ### paulis

  <Attribute id="qiskit.circuit.library.PauliFeatureMap.paulis" name="paulis">
  ...
  <Attribute id="qiskit.circuit.library.PauliFeatureMap.preferred_init_points" name="preferred_init_points">
  ...
  <Attribute id="qiskit.circuit.library.PauliFeatureMap.prefix" name="prefix" attributeValue="= 'circuit'" />

  ### qregs

  <Attribute id="qiskit.circuit.library.PauliFeatureMap.qregs" name="qregs" attributeTypeHint="list[QuantumRegister]">
  ...
  <Attribute id="qiskit.circuit.library.PauliFeatureMap.reps" name="reps">
  ...
  <Attribute id="qiskit.circuit.library.PauliFeatureMap.rotation_blocks" name="rotation_blocks">
  ...
  <Function id="qiskit.circuit.library.PauliFeatureMap.pauli_block" name="pauli_block" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/circuit/library/data_preparation/pauli_feature_map.py#L241-L245" signature="pauli_block(pauli_string)">
    Get the Pauli block for the feature map circuit.
  </Function>

  ### pauli\_evolution

  <Function id="qiskit.circuit.library.PauliFeatureMap.pauli_evolution" name="pauli_evolution" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/circuit/library/data_preparation/pauli_feature_map.py#L247-L282" signature="pauli_evolution(pauli_string, time)">
