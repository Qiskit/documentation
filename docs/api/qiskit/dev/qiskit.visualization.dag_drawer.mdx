...
<Function id="qiskit.visualization.dag_drawer" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/main/qiskit/visualization/dag_visualization.py#L76-L393" signature="qiskit.visualization.dag_drawer(dag, scale=0.7, filename=None, style='color')">
  ...
  *   **style** ([*dict*](https://docs.python.org/3/builtins/stdtypes.html#dict)  *or*[*str*](https://docs.python.org/3/builtins/stdtypes.html#str)) –
  ...
  *   [**VisualizationError**](/docs/api/qiskit/dev/visualization#qiskit.visualization.VisualizationError "qiskit.visualization.VisualizationError") – when style is not recognized.
  *   [**InvalidFileError**](/docs/api/qiskit/dev/exceptions#qiskit.exceptions.InvalidFileError "qiskit.exceptions.InvalidFileError") – when filename provided is not valid
  *   [**ValueError**](https://docs.python.org/3/builtins/exceptions.html#ValueError) – If the file extension for `filename` is not an image type supported by Graphviz.
