...
<Function id="qiskit.visualization.dag_drawer" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/main/qiskit/visualization/dag_visualization.py#L77-L389" signature="qiskit.visualization.dag_drawer(dag, scale=0.7, filename=None, style='color')">
