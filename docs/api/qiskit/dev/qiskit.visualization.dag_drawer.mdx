...
<Function id="qiskit.visualization.dag_drawer" name="dag_drawer" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/main/qiskit/visualization/dag_visualization.py" signature="qiskit.visualization.dag_drawer(dag, scale=0.7, filename=None, style='color')">
