...
<Class id="qiskit.transpiler.passes.synthesis.hls_plugins.MCXSynthesisNCleanM15" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/main/qiskit/transpiler/passes/synthesis/hls_plugins.py#L792-L832" signature="qiskit.transpiler.passes.synthesis.hls_plugins.MCXSynthesisNCleanM15" modifiers="class">
  ...
  **References**
  ...
  <Function id="qiskit.transpiler.passes.synthesis.hls_plugins.MCXSynthesisNCleanM15.run" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/transpiler/passes/synthesis/hls_plugins.py#L814-L832" signature="run(high_level_object, coupling_map=None, target=None, qubits=None, **options)">
