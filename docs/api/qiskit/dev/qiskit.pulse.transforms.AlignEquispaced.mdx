...
<Class id="qiskit.pulse.transforms.AlignEquispaced" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/pulse/transforms/alignments.py#L259-L325" signature="qiskit.pulse.transforms.AlignEquispaced(duration)">
