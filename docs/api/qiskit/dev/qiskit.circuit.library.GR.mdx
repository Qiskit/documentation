...
`qiskit.circuit.library.GR(num_qubits, theta, phi)` [GitHub](https://github.com/qiskit/qiskit/tree/main/qiskit/circuit/library/generalized_gates/gr.py "view source code")
...
![../\_images/qiskit-circuit-library-GR-1.png](/images/api/qiskit/dev/qiskit-circuit-library-GR-1.png)
...
<span id="qiskit.circuit.library.GR.num_captured_vars" />
...
<span id="qiskit.circuit.library.GR.num_declared_vars" />
...
<span id="qiskit.circuit.library.GR.num_input_vars" />
...
<span id="qiskit.circuit.library.GR.num_vars" />
