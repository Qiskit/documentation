...
$$
  ...
  *   **theta** ([*float*](https://docs.python.org/3/builtins/functions.html#float)) – rotation angle about axis determined by phi
  *   **phi** ([*float*](https://docs.python.org/3/builtins/functions.html#float)) – angle of rotation axis in xy-plane
