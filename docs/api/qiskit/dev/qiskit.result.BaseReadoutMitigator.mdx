...
<Class id="qiskit.result.BaseReadoutMitigator" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/main/qiskit/result/mitigation/base_readout_mitigator.py#L23-L79" signature="qiskit.result.BaseReadoutMitigator">
  ...
  <Function id="qiskit.result.BaseReadoutMitigator.expectation_value" name="expectation_value" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/result/mitigation/base_readout_mitigator.py#L52-L79" signature="abstract expectation_value(data, diagonal, qubits=None, clbits=None, shots=None)">
  ...
  <Function id="qiskit.result.BaseReadoutMitigator.quasi_probabilities" name="quasi_probabilities" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/result/mitigation/base_readout_mitigator.py#L26-L50" signature="abstract quasi_probabilities(data, qubits=None, clbits=None, shots=None)">
