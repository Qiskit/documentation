...
`qiskit.transpiler.passes.CountOps(*args, **kwargs)` [GitHub](https://github.com/qiskit/qiskit/tree/main/qiskit/transpiler/passes/analysis/count_ops.py "view source code")
