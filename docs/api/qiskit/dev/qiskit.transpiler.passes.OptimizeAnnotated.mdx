...
<Class id="qiskit.transpiler.passes.OptimizeAnnotated" github="https://github.com/qiskit/qiskit/tree/main/qiskit/transpiler/passes/optimization/optimize_annotated.py" signature="qiskit.transpiler.passes.OptimizeAnnotated(*args, **kwargs)">
