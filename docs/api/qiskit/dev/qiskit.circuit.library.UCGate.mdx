...
$$
  ...
  **Raises**
  ...
  <Function id="qiskit.circuit.library.UCGate.inverse" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/circuit/library/generalized_gates/uc.py#L112-L134" signature="inverse(annotated=False)">
    Return the inverse.
  ...
  <Function id="qiskit.circuit.library.UCGate.validate_parameter" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/circuit/library/generalized_gates/uc.py#L304-L309" signature="validate_parameter(parameter)">
