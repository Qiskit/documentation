---
title: UnitarySynthesisPluginManager (dev version)
description: API reference for qiskit.transpiler.passes.synthesis.plugin.UnitarySynthesisPluginManager in the dev version of qiskit
