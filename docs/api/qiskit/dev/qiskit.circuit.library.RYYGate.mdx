...
<Class id="qiskit.circuit.library.RYYGate" github="https://github.com/qiskit/qiskit/tree/main/qiskit/circuit/library/standard_gates/ryy.py" signature="qiskit.circuit.library.RYYGate(theta, label=None, *, duration=None, unit='dt')">
...
$$
  ...
  **Examples:**
  ...
  <Function id="qiskit.circuit.library.RYYGate.inverse" name="inverse" signature="inverse(annotated=False)">
