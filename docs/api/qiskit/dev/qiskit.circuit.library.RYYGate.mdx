...
$$
  ...
  **Examples:**
  ...
  <Function id="qiskit.circuit.library.RYYGate.power" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/circuit/library/standard_gates/ryy.py#L135-L138" signature="power(exponent)">
