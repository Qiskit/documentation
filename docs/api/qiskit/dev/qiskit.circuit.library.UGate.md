...
`qiskit.circuit.library.UGate(theta, phi, lam, label=None, *, duration=None, unit='dt')` [GitHub](https://github.com/qiskit/qiskit/tree/main/qiskit/circuit/library/standard_gates/u.py "view source code")
...
<span id="qiskit.circuit.library.UGate.base_class" />
...
<span id="qiskit.circuit.library.UGate.condition" />
...
<span id="qiskit.circuit.library.UGate.mutable" />
