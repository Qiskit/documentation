...
$$
  ...
  <Function id="qiskit.circuit.library.ZGate.power" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/circuit/library/standard_gates/z.py#L143-L145" signature="power(exponent)">
