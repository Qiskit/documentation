...
<Class id="qiskit.qobj.GateCalibration" github="https://github.com/qiskit/qiskit/tree/main/qiskit/qobj/qasm_qobj.py" signature="qiskit.qobj.GateCalibration(name, qubits, params, instructions)">
