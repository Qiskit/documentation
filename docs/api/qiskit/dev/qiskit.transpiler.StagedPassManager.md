...
`qiskit.transpiler.StagedPassManager(stages=None, **kwargs)` [GitHub](https://github.com/qiskit/qiskit/tree/main/qiskit/transpiler/passmanager.py "view source code")
