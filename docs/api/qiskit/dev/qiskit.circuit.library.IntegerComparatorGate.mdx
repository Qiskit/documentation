...
<Class id="qiskit.circuit.library.IntegerComparatorGate" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/main/qiskit/circuit/library/arithmetic/integer_comparator.py#L169-L199" signature="qiskit.circuit.library.IntegerComparatorGate(num_state_qubits, value, geq=True, label=None)" modifiers="class">
