---
title: PhasedQubitSparsePauli (dev version)
description: API reference for qiskit.quantum_info.PhasedQubitSparsePauli in the dev version of qiskit
...
<Class id="qiskit.quantum_info.PhasedQubitSparsePauli" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/main/qiskit/quantum_info/__init__.py" signature="qiskit.quantum_info.PhasedQubitSparsePauli(data, /, num_qubits=None)" modifiers="class">
  ...
  <Function id="qiskit.quantum_info.PhasedQubitSparsePauli.__new__" signature="__new__(data, /, num_qubits=None)">
    ...
    *   **num\_qubits** ([*int*](https://docs.python.org/3/builtins/functions.html#int)*|None*) – Optional number of qubits for the operator. For most data inputs, this can be inferred and need not be passed. It is only necessary for the sparse-label format. If given unnecessarily, it must match the data input.
  </Function>
  ...
  <Function id="qiskit.quantum_info.PhasedQubitSparsePauli.from_sparse_label" signature="from_sparse_label(sparse_label, num_qubits)" modifiers="static">
    ...
    *   **sparse\_label** ([*tuple*](https://docs.python.org/3/builtins/stdtypes.html#tuple)*\[*[*int*](https://docs.python.org/3/builtins/functions.html#int)*,* [*str*](https://docs.python.org/3/builtins/stdtypes.html#str)*, Sequence\[*[*int*](https://docs.python.org/3/builtins/functions.html#int)*]]*) – labels and the qubits each single-qubit term applies to.
    *   **num\_qubits** ([*int*](https://docs.python.org/3/builtins/functions.html#int)) – the number of qubits the operator acts on.
