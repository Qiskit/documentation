...
<Class id="qiskit.quantum_info.PhasedQubitSparsePauli" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/main/qiskit/quantum_info/__init__.py" signature="qiskit.quantum_info.PhasedQubitSparsePauli(data, /, num_qubits=None)" modifiers="class">
  ...
  <Function id="qiskit.quantum_info.PhasedQubitSparsePauli.from_raw_parts" signature="from_raw_parts(num_qubits, paulis, indices, phase=0)" modifiers="static">
    ...
    *   **paulis** – list of the single-qubit terms. This should be a Numpy array with dtype [`uint8`](https://numpy.org/doc/stable/reference/arrays.scalars.html#numpy.uint8 "(in NumPy v2.4)") (which is compatible with [`Pauli`](qiskit.quantum_info.Pauli "qiskit.quantum_info.Pauli")).
