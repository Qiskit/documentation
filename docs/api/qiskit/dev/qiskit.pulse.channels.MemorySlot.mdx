---
title: MemorySlot (dev version)
description: API reference for qiskit.pulse.channels.MemorySlot in the dev version of qiskit
...
<Class id="qiskit.pulse.channels.MemorySlot" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/main/qiskit/pulse/channels.py#L216-L219" signature="qiskit.pulse.channels.MemorySlot(*args, **kwargs)" modifiers="class">
  ...
  **index** – Index of channel.
  ...
  <Function id="qiskit.pulse.channels.MemorySlot.is_parameterized" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/pulse/channels.py#L137-L139" signature="is_parameterized()">
