...
<Class id="qiskit.qobj.QobjExperimentHeader" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/qobj/common.py#L68-L71" signature="qiskit.qobj.QobjExperimentHeader(**kwargs)">
