...
<Class id="qiskit.qobj.QobjExperimentHeader" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.2/qiskit/qobj/common.py#L78-L81" signature="qiskit.qobj.QobjExperimentHeader(**kwargs)" modifiers="class">
  ...
  **kwargs** – arbitrary keyword arguments that can be accessed as attributes of the object.
  ...
  <Function id="qiskit.qobj.QobjExperimentHeader.from_dict" github="https://github.com/Qiskit/qiskit/tree/stable/1.2/qiskit/qobj/common.py#L51-L63" signature="from_dict(data)" modifiers="classmethod">
  ...
  <Function id="qiskit.qobj.QobjExperimentHeader.to_dict" github="https://github.com/Qiskit/qiskit/tree/stable/1.2/qiskit/qobj/common.py#L43-L49" signature="to_dict()">
