...
<Class id="qiskit.circuit.ControlFlowOp" github="https://github.com/qiskit/qiskit/tree/main/qiskit/circuit/controlflow/control_flow.py" signature="qiskit.circuit.ControlFlowOp(*args, **kwargs)">
