...
<Class id="qiskit.providers.basic_provider.BasicProviderError" name="BasicProviderError" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/main/qiskit/providers/basic_provider/exceptions.py" signature="qiskit.providers.basic_provider.BasicProviderError(*message)">
