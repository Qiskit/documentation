...
<Class id="qiskit.providers.basic_provider.BasicProviderError" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.2/qiskit/providers/basic_provider/exceptions.py#L20-L30" signature="qiskit.providers.basic_provider.BasicProviderError(*message)" modifiers="exception">
