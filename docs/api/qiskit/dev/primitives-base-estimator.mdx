---
title: BaseEstimator (dev version)
description: API reference for qiskit.primitives.BaseEstimator in the dev version of qiskit
...
<Class id="qiskit.primitives.BaseEstimator" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/main/qiskit/primitives/base/base_estimator.py#L193-L219" signature="qiskit.primitives.BaseEstimator(*, options=None)" modifiers="class">
  Bases: [`BaseEstimatorV1`](primitives-base-estimator-v-1 "qiskit.primitives.base.base_estimator.BaseEstimatorV1")\[`T`]

  DEPRECATED. Type alias for Estimator V1 base class.

  See [`BaseEstimatorV1`](primitives-base-estimator-v-1 "qiskit.primitives.BaseEstimatorV1") for details.
  ...
  **options** ([*dict*](https://docs.python.org/3/library/stdtypes.html#dict "(in Python v3.13)") *| None*) – Default options.
  ...
  <Function id="qiskit.primitives.BaseEstimator.run" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/primitives/base/base_estimator.py#L123-L180" signature="run(circuits, observables, parameter_values=None, **run_options)">
  ...
  <Function id="qiskit.primitives.BaseEstimator.set_options" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/primitives/base/base_primitive.py#L39-L45" signature="set_options(**fields)">
