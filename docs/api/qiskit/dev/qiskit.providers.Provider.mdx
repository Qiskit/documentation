...
<Class id="qiskit.providers.Provider" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/main/qiskit/providers/provider.py#L20-L29" signature="qiskit.providers.Provider">
