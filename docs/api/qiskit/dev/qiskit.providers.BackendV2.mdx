...
<Class id="qiskit.providers.BackendV2" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/main/qiskit/providers/backend.py#L38-L330" signature="qiskit.providers.BackendV2(provider=None, name=None, description=None, online_date=None, backend_version=None, **fields)" modifiers="class">
  ...
  <Function id="qiskit.providers.BackendV2._default_options" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/providers/backend.py#L181-L194" signature="_default_options()" modifiers="abstractmethod classmethod">
  ...
  *   **name** ([*str*](https://docs.python.org/3/builtins/stdtypes.html#str) *| None*) – An optional name for the backend
  *   **description** ([*str*](https://docs.python.org/3/builtins/stdtypes.html#str) *| None*) – An optional description of the backend
  ...
  *   **backend\_version** ([*str*](https://docs.python.org/3/builtins/stdtypes.html#str) *| None*) – An optional backend version string. This differs from the [`version`](#qiskit.providers.BackendV2.version "qiskit.providers.BackendV2.version") attribute as [`version`](#qiskit.providers.BackendV2.version "qiskit.providers.BackendV2.version") is for the abstract [`Backend`](qiskit.providers.Backend "qiskit.providers.Backend") abstract interface version of the object while `backend_version` is for versioning the backend itself.
  *   **fields** – kwargs for the values to use to override the default options.

  **Raises**

  [**AttributeError**](https://docs.python.org/3/builtins/exceptions.html#AttributeError) – If a field is specified that’s outside the backend’s options
  ...
  <Attribute id="qiskit.providers.BackendV2.dtm">
    ...
    **Raises**
    ...
    [**NotImplementedError**](https://docs.python.org/3/builtins/exceptions.html#NotImplementedError) – if the backend doesn’t support querying the output signal timestep
  </Attribute>
  ...
  <Attribute id="qiskit.providers.BackendV2.meas_map">
    ...
    **Raises**
    ...
    [**NotImplementedError**](https://docs.python.org/3/builtins/exceptions.html#NotImplementedError) – if the backend doesn’t support querying the measurement mapping
  </Attribute>
  ...
  <Function id="qiskit.providers.BackendV2.qubit_properties" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/providers/backend.py#L238-L268" signature="qubit_properties(qubit)">
    ...
    **qubit** ([*int*](https://docs.python.org/3/builtins/functions.html#int)  *|*[*list*](https://docs.python.org/3/builtins/stdtypes.html#list)*\[*[*int*](https://docs.python.org/3/builtins/functions.html#int)*]*) – The qubit to get the [`QubitProperties`](qiskit.providers.QubitProperties "qiskit.providers.QubitProperties") object for. This can be a single integer for 1 qubit or a list of qubits and a list of [`QubitProperties`](qiskit.providers.QubitProperties "qiskit.providers.QubitProperties") objects will be returned in the same order
    ...
    **Raises**
    ...
    [**NotImplementedError**](https://docs.python.org/3/builtins/exceptions.html#NotImplementedError) – if the backend doesn’t support querying the qubit properties

    **Return type**

    [*QubitProperties*](qiskit.providers.QubitProperties "qiskit._accelerate.target.QubitProperties") | [list](https://docs.python.org/3/builtins/stdtypes.html#list)\[[*QubitProperties*](qiskit.providers.QubitProperties "qiskit._accelerate.target.QubitProperties")]
  </Function>

  ### run

  <Function id="qiskit.providers.BackendV2.run" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/providers/backend.py#L308-L330" signature="run(run_input, **options)" modifiers="abstractmethod">
    Run on the backend.
    ...
    *   **run\_input** ([*QuantumCircuit*](/docs/api/qiskit/dev/qiskit.circuit.QuantumCircuit "qiskit.circuit.QuantumCircuit")  *or*[*list*](https://docs.python.org/3/builtins/stdtypes.html#list)) – An individual or a list of [`QuantumCircuit`](/docs/api/qiskit/dev/qiskit.circuit.QuantumCircuit "qiskit.circuit.QuantumCircuit") objects to run on the backend.
  ...
  <Function id="qiskit.providers.BackendV2.set_options" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/providers/backend.py#L270-L287" signature="set_options(**fields)">
    ...
    **Raises**
    ...
    [**AttributeError**](https://docs.python.org/3/builtins/exceptions.html#AttributeError) – If the field passed in is not part of the options
  </Function>
</Class>
