...
<Class id="qiskit.providers.BackendV2" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/main/qiskit/providers/backend.py#L38-L330" signature="qiskit.providers.BackendV2(provider=None, name=None, description=None, online_date=None, backend_version=None, **fields)" modifiers="class">
  ...
  <Function id="qiskit.providers.BackendV2._default_options" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/providers/backend.py#L181-L194" signature="_default_options()" modifiers="abstract classmethod">
  ...
  **Raises**
  ...
  <Function id="qiskit.providers.BackendV2.qubit_properties" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/providers/backend.py#L238-L268" signature="qubit_properties(qubit)">
    ...
    **Return type**
    ...
    [*QubitProperties*](qiskit.providers.QubitProperties "qiskit._accelerate.target.QubitProperties") | [list](https://docs.python.org/3/library/stdtypes.html#list)\[[qiskit.\_accelerate.target.QubitProperties](qiskit.providers.QubitProperties "qiskit._accelerate.target.QubitProperties")]
  </Function>

  ### run

  <Function id="qiskit.providers.BackendV2.run" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/providers/backend.py#L308-L330" signature="run(run_input, **options)" modifiers="abstract">
    Run on the backend.
