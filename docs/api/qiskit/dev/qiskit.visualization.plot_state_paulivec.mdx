...
$$
  ...
  **Examples**
  ...
  ![Output from the previous code.](/images/api/qiskit/dev/qiskit-visualization-plot_state_paulivec-1.png)
  ...
  ![Output from the previous code.](/images/api/qiskit/dev/qiskit-visualization-plot_state_paulivec-2.png)
</Function>
