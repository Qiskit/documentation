...
<Function id="qiskit.visualization.plot_state_paulivec" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/main/qiskit/visualization/state_visualization.py#L611-L722" signature="qiskit.visualization.plot_state_paulivec(state, title='', figsize=None, color=None, ax=None, *, filename=None)">
...
$$
  ...
  **Examples**
  ...
  ![../\_images/qiskit-visualization-plot\_state\_paulivec-1.png](/images/api/qiskit/dev/qiskit-visualization-plot_state_paulivec-1.png)
  ...
  ![../\_images/qiskit-visualization-plot\_state\_paulivec-2.png](/images/api/qiskit/dev/qiskit-visualization-plot_state_paulivec-2.png)
</Function>
