...
<Class id="qiskit.primitives.BindingsArray" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/main/qiskit/primitives/containers/bindings_array.py#L54-L319" signature="qiskit.primitives.BindingsArray(data=None, shape=None)" modifiers="class">
  ...
  *   [**TypeError**](https://docs.python.org/3/library/exceptions.html#TypeError) – If some of the values can’t be cast to a float type.
  ...
  <Function id="qiskit.primitives.BindingsArray.bind" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/primitives/containers/bindings_array.py#L217-L238" signature="bind(circuit, loc)">
    ...
    *   **loc** ([*tuple*](https://docs.python.org/3/library/stdtypes.html#tuple)*\[*[*int*](https://docs.python.org/3/library/functions.html#int)*, ...]*) – A tuple of indices, on for each dimension of this array.
