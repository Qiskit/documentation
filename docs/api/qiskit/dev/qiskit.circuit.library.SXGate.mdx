...
<Class id="qiskit.circuit.library.SXGate" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/main/qiskit/circuit/library/standard_gates/sx.py#L27-L135" signature="qiskit.circuit.library.SXGate(*args, _force_mutable=False, **kwargs)" modifiers="class">
