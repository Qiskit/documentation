...
<Class id="qiskit.primitives.PubResult" github="https://github.com/qiskit/qiskit/tree/main/qiskit/primitives/containers/pub_result.py" signature="qiskit.primitives.PubResult(data, metadata=None)">
