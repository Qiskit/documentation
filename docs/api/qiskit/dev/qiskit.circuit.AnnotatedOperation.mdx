...
<Class id="qiskit.circuit.AnnotatedOperation" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/main/qiskit/circuit/annotated_operation.py#L59-L202" signature="qiskit.circuit.AnnotatedOperation(base_op, modifiers)">
  ...
  *   **modifiers** (*Union\[Modifier, List\[Modifier]]*) – ordered list of modifiers. Supported modifiers include `InverseModifier`, `ControlModifier` and `PowerModifier`.
  ...
  <Attribute id="qiskit.circuit.AnnotatedOperation.base_op" name="base_op">
    The base operation that the modifiers in this annotated operation applies to.
  </Attribute>

  ### modifiers

  <Attribute id="qiskit.circuit.AnnotatedOperation.modifiers" name="modifiers">
  ...
  <Function id="qiskit.circuit.AnnotatedOperation.control" name="control" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/circuit/annotated_operation.py#L158-L185" signature="control(num_ctrl_qubits=1, label=None, ctrl_state=None, annotated=True)">
  ...
  <Function id="qiskit.circuit.AnnotatedOperation.copy" name="copy" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/circuit/annotated_operation.py#L133-L135" signature="copy()">
  ...
  <Function id="qiskit.circuit.AnnotatedOperation.inverse" name="inverse" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/circuit/annotated_operation.py#L187-L202" signature="inverse(annotated=True)">
  ...
  <Function id="qiskit.circuit.AnnotatedOperation.to_matrix" name="to_matrix" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/circuit/annotated_operation.py#L137-L156" signature="to_matrix()">
