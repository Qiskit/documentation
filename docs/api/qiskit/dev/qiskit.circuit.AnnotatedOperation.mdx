...
<Class id="qiskit.circuit.AnnotatedOperation" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/main/qiskit/circuit/annotated_operation.py#L63-L245" signature="qiskit.circuit.AnnotatedOperation(base_op, modifiers)" modifiers="class">
  ...
  *   **modifiers** (*Union\[Modifier, List\[Modifier]]*) – ordered list of modifiers. Supported modifiers include `InverseModifier`, `ControlModifier` and `PowerModifier`.
  ...
  <Function id="qiskit.circuit.AnnotatedOperation.control" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/circuit/annotated_operation.py#L162-L189" signature="control(num_ctrl_qubits=1, label=None, ctrl_state=None, annotated=None)">
  ...
  <Function id="qiskit.circuit.AnnotatedOperation.copy" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/circuit/annotated_operation.py#L137-L139" signature="copy()">
  ...
  <Function id="qiskit.circuit.AnnotatedOperation.inverse" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/circuit/annotated_operation.py#L191-L206" signature="inverse(annotated=True)">
  ...
  <Function id="qiskit.circuit.AnnotatedOperation.power" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/circuit/annotated_operation.py#L208-L224" signature="power(exponent, annotated=False)">
  ...
  <Function id="qiskit.circuit.AnnotatedOperation.to_matrix" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/circuit/annotated_operation.py#L141-L160" signature="to_matrix()">
    Return a matrix representation (allowing to construct Operator).
  </Function>

  ### validate\_parameter

  <Function id="qiskit.circuit.AnnotatedOperation.validate_parameter" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/circuit/annotated_operation.py#L240-L245" signature="validate_parameter(parameter)">
