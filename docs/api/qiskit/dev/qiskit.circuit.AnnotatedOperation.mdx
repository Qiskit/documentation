...
<Class id="qiskit.circuit.AnnotatedOperation" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.1/qiskit/circuit/annotated_operation.py#L59-L220" signature="qiskit.circuit.AnnotatedOperation(base_op, modifiers)">
