...
<Class id="qiskit.circuit.AnnotatedOperation" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/circuit/annotated_operation.py#L59-L202" signature="qiskit.circuit.AnnotatedOperation(base_op, modifiers)">
