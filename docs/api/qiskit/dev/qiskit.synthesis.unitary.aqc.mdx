...
<Function id="qiskit.synthesis.unitary.aqc.make_cnot_network" name="make_cnot_network" github="https://github.com/qiskit/qiskit/tree/main/qiskit/synthesis/unitary/aqc/cnot_structures.py" signature="qiskit.synthesis.unitary.aqc.make_cnot_network(num_qubits, network_layout='spin', connectivity_type='full', depth=0)">
