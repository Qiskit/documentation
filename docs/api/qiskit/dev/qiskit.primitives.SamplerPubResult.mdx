  ...
  *   **metadata** ([*dict*](https://docs.python.org/3/library/stdtypes.html#dict "(in Python v3.13)")*\[*[*str*](https://docs.python.org/3/library/stdtypes.html#str "(in Python v3.13)")*, Any] | None*) – Metadata specific to this pub. Keys are expected to be strings.
  ...
  <Function id="qiskit.primitives.SamplerPubResult.join_data" github="https://github.com/Qiskit/qiskit/tree/stable/1.3/qiskit/primitives/containers/sampler_pub_result.py#L30-L74" signature="join_data(names=None)">
    ...
    **Return type**
    ...
    [*BitArray*](qiskit.primitives.BitArray "qiskit.primitives.containers.bit_array.BitArray") | [*ndarray*](https://numpy.org/doc/stable/reference/generated/numpy.ndarray.html#numpy.ndarray "(in NumPy v2.1)")
  </Function>
</Class>
