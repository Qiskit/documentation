...
<Class id="qiskit.circuit.InstructionSet" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/circuit/instructionset.py#L28-L180" signature="qiskit.circuit.InstructionSet(*, resource_requester=None)">
