...
<Class id="qiskit.circuit.InstructionSet" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/main/qiskit/circuit/instructionset.py#L28-L130" signature="qiskit.circuit.InstructionSet(*, resource_requester=None)" modifiers="class">
