...
<Class id="qiskit.circuit.InstructionSet" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.1/qiskit/circuit/instructionset.py#L28-L180" signature="qiskit.circuit.InstructionSet(*, resource_requester=None)">
