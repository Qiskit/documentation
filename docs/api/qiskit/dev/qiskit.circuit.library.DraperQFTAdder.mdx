...
<Class id="qiskit.circuit.library.DraperQFTAdder" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/main/qiskit/circuit/library/arithmetic/adders/draper_qft_adder.py#L24-L116" signature="qiskit.circuit.library.DraperQFTAdder(num_state_qubits, kind='fixed', name='DraperQFTAdder')">
  Bases: `Adder`
  ...
  **Raises**
  ...
  <Attribute id="qiskit.circuit.library.DraperQFTAdder.ancillas" name="ancillas">
    Returns a list of ancilla bits in the order that the registers were added.
  </Attribute>

  ### calibrations

  <Attribute id="qiskit.circuit.library.DraperQFTAdder.calibrations" name="calibrations">
  ...
  <Attribute id="qiskit.circuit.library.DraperQFTAdder.clbits" name="clbits">
    Returns a list of classical bits in the order that the registers were added.
  </Attribute>

  ### data

  <Attribute id="qiskit.circuit.library.DraperQFTAdder.data" name="data">
  ...
  <Attribute id="qiskit.circuit.library.DraperQFTAdder.global_phase" name="global_phase">
    Return the global phase of the current circuit scope in radians.
  </Attribute>

  ### instances

  <Attribute id="qiskit.circuit.library.DraperQFTAdder.instances" name="instances" attributeValue="158" />

  ### layout

  <Attribute id="qiskit.circuit.library.DraperQFTAdder.layout" name="layout">
  ...
  <Attribute id="qiskit.circuit.library.DraperQFTAdder.metadata" name="metadata">
  ...
  <Attribute id="qiskit.circuit.library.DraperQFTAdder.num_ancillas" name="num_ancillas">
    Return the number of ancilla qubits.
  </Attribute>

  ### num\_captured\_vars

  <Attribute id="qiskit.circuit.library.DraperQFTAdder.num_captured_vars" name="num_captured_vars">
  ...
  <Attribute id="qiskit.circuit.library.DraperQFTAdder.num_clbits" name="num_clbits">
    Return number of classical bits.
  </Attribute>

  ### num\_declared\_vars

  <Attribute id="qiskit.circuit.library.DraperQFTAdder.num_declared_vars" name="num_declared_vars">
  ...
  <Attribute id="qiskit.circuit.library.DraperQFTAdder.num_input_vars" name="num_input_vars">
  ...
  <Attribute id="qiskit.circuit.library.DraperQFTAdder.num_parameters" name="num_parameters">
    The number of parameter objects in the circuit.
  </Attribute>

  ### num\_qubits

  <Attribute id="qiskit.circuit.library.DraperQFTAdder.num_qubits" name="num_qubits">
    Return number of qubits.
  </Attribute>

  ### num\_state\_qubits

  <Attribute id="qiskit.circuit.library.DraperQFTAdder.num_state_qubits" name="num_state_qubits">
  ...
  <Attribute id="qiskit.circuit.library.DraperQFTAdder.num_vars" name="num_vars">
  ...
  <Attribute id="qiskit.circuit.library.DraperQFTAdder.op_start_times" name="op_start_times">
  ...
  <Attribute id="qiskit.circuit.library.DraperQFTAdder.parameters" name="parameters">
  ...
  <Attribute id="qiskit.circuit.library.DraperQFTAdder.prefix" name="prefix" attributeValue="'circuit'" />

  ### qubits

  <Attribute id="qiskit.circuit.library.DraperQFTAdder.qubits" name="qubits">
