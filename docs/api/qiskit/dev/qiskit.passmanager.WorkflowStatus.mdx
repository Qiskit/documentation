---
title: WorkflowStatus (dev version)
description: API reference for qiskit.passmanager.WorkflowStatus in the dev version of qiskit
...
<Class id="qiskit.passmanager.WorkflowStatus" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/main/qiskit/passmanager/compilation_status.py#L35-L52" signature="qiskit.passmanager.WorkflowStatus(count=0, completed_passes=<factory>, previous_run=RunState.FAIL)" modifiers="class">
  ...
  *   **count** ([*int*](https://docs.python.org/3/builtins/functions.html#int))
  *   **completed\_passes** ([*set*](https://docs.python.org/3/builtins/stdtypes.html#set))
  *   **previous\_run** (*RunState*)

  ### count

  <Attribute id="qiskit.passmanager.WorkflowStatus.count">
  ...
  <Attribute id="qiskit.passmanager.WorkflowStatus.previous_run">
    Type: `RunState`
  ...
  <Attribute id="qiskit.passmanager.WorkflowStatus.completed_passes">
    Type: [`set`](https://docs.python.org/3/builtins/stdtypes.html#set)
