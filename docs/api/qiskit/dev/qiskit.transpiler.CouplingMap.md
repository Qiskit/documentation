...
`qiskit.transpiler.CouplingMap(couplinglist=None, description=None)` [GitHub](https://github.com/qiskit/qiskit/tree/main/qiskit/transpiler/coupling.py "view source code")
