...
<Class id="qiskit.transpiler.passes.FullAncillaAllocation" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/main/qiskit/transpiler/passes/layout/full_ancilla_allocation.py#L21-L116" signature="qiskit.transpiler.passes.FullAncillaAllocation(*args, **kwargs)" modifiers="class">
  ...
  **coupling\_map** (*Union\[*[*CouplingMap*](qiskit.transpiler.CouplingMap "qiskit.transpiler.CouplingMap")*,* [*Target*](qiskit.transpiler.Target "qiskit.transpiler.Target")*]*) – directed graph representing a coupling map.
  ...
  <Function id="qiskit.transpiler.passes.FullAncillaAllocation.execute" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/passmanager/base_tasks.py#L76-L122" signature="execute(passmanager_ir, state, callback=None)">
  ...
  <Function id="qiskit.transpiler.passes.FullAncillaAllocation.name" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/passmanager/base_tasks.py#L72-L74" signature="name()">
    Name of the pass.
  ...
  <Function id="qiskit.transpiler.passes.FullAncillaAllocation.run" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/transpiler/passes/layout/full_ancilla_allocation.py#L50-L104" signature="run(dag)">
    ...
    **Raises**
    ...
    [**TranspilerError**](/docs/api/qiskit/dev/transpiler#qiskit.transpiler.TranspilerError "qiskit.transpiler.TranspilerError") – If there is no layout in the property set or not set at init time.
  </Function>

  ### update\_status

  <Function id="qiskit.transpiler.passes.FullAncillaAllocation.update_status" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/passmanager/base_tasks.py#L124-L142" signature="update_status(state, run_state)">
