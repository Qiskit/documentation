...
<Class id="qiskit.circuit.Gate" github="https://github.com/qiskit/qiskit/tree/main/qiskit/circuit/gate.py" signature="qiskit.circuit.Gate(name, num_qubits, params, label=None, duration=None, unit='dt')">
