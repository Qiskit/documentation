...
<Class id="qiskit.circuit.Gate" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/main/qiskit/circuit/gate.py#L25-L242" signature="qiskit.circuit.Gate(name, num_qubits, params, label=None, duration=None, unit='dt')">
  ...
  *   **label** ([*str*](https://docs.python.org/3/library/stdtypes.html#str "(in Python v3.12)") *| None*) – An optional label for the gate.
  ...
  <Function id="qiskit.circuit.Gate.broadcast_arguments" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/circuit/gate.py#L169-L226" signature="broadcast_arguments(qargs, cargs)">
  ...
  <Function id="qiskit.circuit.Gate.control" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/circuit/gate.py#L89-L126" signature="control(num_ctrl_qubits=1, label=None, ctrl_state=None, annotated=False)">
  ...
  <Function id="qiskit.circuit.Gate.power" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/circuit/gate.py#L65-L81" signature="power(exponent)">
  ...
  <Function id="qiskit.circuit.Gate.validate_parameter" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/circuit/gate.py#L228-L242" signature="validate_parameter(parameter)">
