...
<Class id="qiskit.circuit.Gate" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/circuit/gate.py#L25-L242" signature="qiskit.circuit.Gate(name, num_qubits, params, label=None, duration=None, unit='dt')">
