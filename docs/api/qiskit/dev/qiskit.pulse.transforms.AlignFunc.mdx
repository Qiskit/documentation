...
<Class id="qiskit.pulse.transforms.AlignFunc" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.2/qiskit/pulse/transforms/alignments.py#L328-L404" signature="qiskit.pulse.transforms.AlignFunc(duration, func)" modifiers="class">
  ...
  *   **func** (*Callable*) – A function that takes an index of sub-schedule and returns the fractional coordinate of of that sub-schedule. The returned value should be defined within \[0, 1]. The pulse index starts from 1.
  ...
  <Function id="qiskit.pulse.transforms.AlignFunc.align" github="https://github.com/Qiskit/qiskit/tree/stable/1.2/qiskit/pulse/transforms/alignments.py#L379-L404" signature="align(schedule)">
