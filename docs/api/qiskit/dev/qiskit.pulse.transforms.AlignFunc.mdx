...
<Class id="qiskit.pulse.transforms.AlignFunc" github="https://github.com/qiskit/qiskit/tree/main/qiskit/pulse/transforms/alignments.py" signature="qiskit.pulse.transforms.AlignFunc(duration, func)">
