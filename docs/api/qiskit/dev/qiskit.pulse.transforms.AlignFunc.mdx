...
<Class id="qiskit.pulse.transforms.AlignFunc" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.1/qiskit/pulse/transforms/alignments.py#L328-L406" signature="qiskit.pulse.transforms.AlignFunc(duration, func)">
