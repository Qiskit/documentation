---
title: DriveChannel (dev version)
description: API reference for qiskit.pulse.channels.DriveChannel in the dev version of qiskit
...
<Class id="qiskit.pulse.channels.DriveChannel" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/main/qiskit/pulse/channels.py#L179-L182" signature="qiskit.pulse.channels.DriveChannel(*args, **kwargs)" modifiers="class">
  Bases: `PulseChannel`
  ...
  **index** – Index of channel.
  ...
  <Function id="qiskit.pulse.channels.DriveChannel.is_parameterized" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/pulse/channels.py#L137-L139" signature="is_parameterized()">
