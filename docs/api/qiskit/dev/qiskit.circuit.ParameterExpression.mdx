...
<Class id="qiskit.circuit.ParameterExpression" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/main/qiskit/circuit/parameterexpression.py#L105-L732" signature="qiskit.circuit.ParameterExpression(symbol_map, expr, *, _qpy_replay=None)" modifiers="class">
  ...
  *   **expr** (*SymbolExpr or* [*str*](https://docs.python.org/3/library/stdtypes.html#str "(in Python v3.13)")) – Expression with Rust’s SymbolExprPy or string
  ...
  <Function id="qiskit.circuit.ParameterExpression.sympify" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/circuit/parameterexpression.py#L668-L732" signature="sympify()">
