...
<Class id="qiskit.circuit.library.AndGate" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/main/qiskit/circuit/library/boolean_logic/quantum_and.py#L107-L200" signature="qiskit.circuit.library.AndGate(num_variable_qubits, flags=None)" modifiers="class">
  ...
  *   **flags** ([*list*](https://docs.python.org/3/library/stdtypes.html#list "(in Python v3.13)")*\[*[*int*](https://docs.python.org/3/library/functions.html#int "(in Python v3.13)")*] | None*) – A list of +1/0/-1 marking negations or omissions of qubits.
  ...
  <Function id="qiskit.circuit.library.AndGate.inverse" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/circuit/library/boolean_logic/quantum_and.py#L181-L193" signature="inverse(annotated=False)">
