...
<Class id="qiskit.circuit.SwitchCaseOp" github="https://github.com/qiskit/qiskit/tree/main/qiskit/circuit/controlflow/switch_case.py" signature="qiskit.circuit.SwitchCaseOp(target, cases, *, label=None)">
