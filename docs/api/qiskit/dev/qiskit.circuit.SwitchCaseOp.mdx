...
<Class id="qiskit.circuit.SwitchCaseOp" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/main/qiskit/circuit/controlflow/switch_case.py#L52-L187" signature="qiskit.circuit.SwitchCaseOp(target, cases, *, label=None)" modifiers="class">
  ...
  *   **label** ([*str*](https://docs.python.org/3/library/stdtypes.html#str) *| None*) –
  ...
  <Function id="qiskit.circuit.SwitchCaseOp.cases" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/circuit/controlflow/switch_case.py#L167-L177" signature="cases()">
  ...
  <Function id="qiskit.circuit.SwitchCaseOp.cases_specifier" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/circuit/controlflow/switch_case.py#L153-L165" signature="cases_specifier()">
  ...
  <Function id="qiskit.circuit.SwitchCaseOp.iter_captured_stretches" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/circuit/controlflow/control_flow.py#L86-L94" signature="iter_captured_stretches()">
  ...
  <Function id="qiskit.circuit.SwitchCaseOp.replace_blocks" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/circuit/controlflow/switch_case.py#L183-L187" signature="replace_blocks(blocks)">
