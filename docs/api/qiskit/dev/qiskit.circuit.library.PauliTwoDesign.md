...
`qiskit.circuit.library.PauliTwoDesign(num_qubits=None, reps=3, seed=None, insert_barriers=False, name='PauliTwoDesign')` [GitHub](https://github.com/qiskit/qiskit/tree/main/qiskit/circuit/library/n_local/pauli_two_design.py "view source code")
...
![../\_images/qiskit-circuit-library-PauliTwoDesign-1.png](/images/api/qiskit/dev/qiskit-circuit-library-PauliTwoDesign-1.png)
...
<span id="qiskit.circuit.library.PauliTwoDesign.num_captured_vars" />
...
<span id="qiskit.circuit.library.PauliTwoDesign.num_declared_vars" />
...
<span id="qiskit.circuit.library.PauliTwoDesign.num_input_vars" />
...
<span id="qiskit.circuit.library.PauliTwoDesign.num_vars" />
