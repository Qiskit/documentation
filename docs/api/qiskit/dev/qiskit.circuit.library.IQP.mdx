...
<Class id="qiskit.circuit.library.IQP" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/main/qiskit/circuit/library/iqp.py#L24-L81" signature="qiskit.circuit.library.IQP(interactions)" modifiers="class">
  ...
  **Raises**
  ...
  <Attribute id="qiskit.circuit.library.IQP.instances" attributeValue="202" />
