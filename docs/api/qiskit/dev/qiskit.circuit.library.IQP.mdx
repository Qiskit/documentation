...
<Class id="qiskit.circuit.library.IQP" github="https://github.com/qiskit/qiskit/tree/main/qiskit/circuit/library/iqp.py" signature="qiskit.circuit.library.IQP(interactions)">
  ...
  **Raises**
  ...
  <Attribute id="qiskit.circuit.library.IQP.instances" name="instances" attributeValue="= 177" />
