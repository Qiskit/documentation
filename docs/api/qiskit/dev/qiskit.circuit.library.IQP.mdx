...
<Class id="qiskit.circuit.library.IQP" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/main/qiskit/circuit/library/iqp.py#L22-L96" signature="qiskit.circuit.library.IQP(interactions)">
  ...
  **Raises**
  ...
  <Attribute id="qiskit.circuit.library.IQP.instances" name="instances" attributeValue="161" />

  ### layout

  <Attribute id="qiskit.circuit.library.IQP.layout" name="layout">
  ...
  <Attribute id="qiskit.circuit.library.IQP.num_captured_vars" name="num_captured_vars">
  ...
  <Attribute id="qiskit.circuit.library.IQP.num_declared_vars" name="num_declared_vars">
  ...
  <Attribute id="qiskit.circuit.library.IQP.num_input_vars" name="num_input_vars">
  ...
  <Attribute id="qiskit.circuit.library.IQP.num_vars" name="num_vars">
