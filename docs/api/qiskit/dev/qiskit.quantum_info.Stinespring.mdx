...
<Class id="qiskit.quantum_info.Stinespring" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.1/qiskit/quantum_info/operators/channel/stinespring.py#L36-L292" signature="qiskit.quantum_info.Stinespring(data, input_dims=None, output_dims=None)">
