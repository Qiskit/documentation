...
<Class id="qiskit.transpiler.passes.SabreLayout" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/main/qiskit/transpiler/passes/layout/sabre_layout.py#L47-L463" signature="qiskit.transpiler.passes.SabreLayout(*args, **kwargs)" modifiers="class">
  ...
  **raises both `routing_pass` and `layout_trials` are specified**
  ...
  <Function id="qiskit.transpiler.passes.SabreLayout.run" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/transpiler/passes/layout/sabre_layout.py#L192-L360" signature="run(dag)">
