---
title: IntegerComparator (dev version)
description: API reference for qiskit.circuit.library.IntegerComparator in the dev version of qiskit
...
$$
  ...
  *   **name** ([*str*](https://docs.python.org/3/library/stdtypes.html#str "(in Python v3.13)")) – Name of the circuit.
  ...
  <Attribute id="qiskit.circuit.library.IntegerComparator.instances" attributeValue="184" />
