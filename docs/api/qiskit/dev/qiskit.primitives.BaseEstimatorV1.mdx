...
<Class id="qiskit.primitives.BaseEstimatorV1" github="https://github.com/qiskit/qiskit/tree/main/qiskit/primitives/base/base_estimator.py" signature="qiskit.primitives.BaseEstimatorV1(*, options=None)">
