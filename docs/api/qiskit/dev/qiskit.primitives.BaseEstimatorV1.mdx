...
<Class id="qiskit.primitives.BaseEstimatorV1" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.1/qiskit/primitives/base/base_estimator.py#L41-L187" signature="qiskit.primitives.BaseEstimatorV1(*, options=None)">
