...
<Class id="qiskit.primitives.BaseEstimatorV1" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/primitives/base/base_estimator.py#L44-L190" signature="qiskit.primitives.BaseEstimatorV1(*, options=None)">
