...
$$
  ...
  **options** ([*dict*](https://docs.python.org/3/builtins/stdtypes.html#dict) *| None*) – Default options.
  ...
  <Function id="qiskit.primitives.BaseEstimatorV1.run" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/primitives/base/base_estimator.py#L180-L237" signature="run(circuits, observables, parameter_values=None, **run_options)">
    ...
    *   **circuits** ([*Sequence*](https://docs.python.org/3/library/collections.abc.html#collections.abc.Sequence)*\[*[*QuantumCircuit*](/docs/api/qiskit/dev/qiskit.circuit.QuantumCircuit "qiskit.circuit.quantumcircuit.QuantumCircuit")*] |* [*QuantumCircuit*](/docs/api/qiskit/dev/qiskit.circuit.QuantumCircuit "qiskit.circuit.quantumcircuit.QuantumCircuit")) – one or more circuit objects.
    *   **observables** ([*Sequence*](https://docs.python.org/3/library/collections.abc.html#collections.abc.Sequence)*\[BaseOperator |* [*str*](https://docs.python.org/3/builtins/stdtypes.html#str)*] | BaseOperator |* [*str*](https://docs.python.org/3/builtins/stdtypes.html#str)) – one or more observable objects. Several formats are allowed; importantly, `str` should follow the string representation format for [`Pauli`](qiskit.quantum_info.Pauli "qiskit.quantum_info.Pauli") objects.
    *   **parameter\_values** ([*Sequence*](https://docs.python.org/3/library/collections.abc.html#collections.abc.Sequence)*\[*[*Sequence*](https://docs.python.org/3/library/collections.abc.html#collections.abc.Sequence)*\[*[*float*](https://docs.python.org/3/builtins/functions.html#float)*]] |* [*Sequence*](https://docs.python.org/3/library/collections.abc.html#collections.abc.Sequence)*\[*[*float*](https://docs.python.org/3/builtins/functions.html#float)*] |* [*float*](https://docs.python.org/3/builtins/functions.html#float) *| None*) – concrete parameters to be bound.
    ...
    *   [**TypeError**](https://docs.python.org/3/builtins/exceptions.html#TypeError) – Invalid argument type given.
    *   [**ValueError**](https://docs.python.org/3/builtins/exceptions.html#ValueError) – Invalid argument values given.
