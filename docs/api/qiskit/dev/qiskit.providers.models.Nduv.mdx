...
<Class id="qiskit.providers.models.Nduv" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/main/qiskit/providers/models/backendproperties.py#L27-L86" signature="qiskit.providers.models.Nduv(date, name, unit, value)" modifiers="class">
  ...
  *   **value** ([*float*](https://docs.python.org/3/library/functions.html#float "(in Python v3.13)")) – The value of the Nduv
  ...
  <Function id="qiskit.providers.models.Nduv.from_dict" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/providers/models/backendproperties.py#L51-L63" signature="from_dict(data)" modifiers="classmethod">
  ...
  <Function id="qiskit.providers.models.Nduv.to_dict" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/providers/models/backendproperties.py#L65-L77" signature="to_dict()">
