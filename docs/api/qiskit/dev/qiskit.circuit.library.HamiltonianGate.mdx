...
<Class id="qiskit.circuit.library.HamiltonianGate" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.1/qiskit/circuit/library/hamiltonian_gate.py#L39-L143" signature="qiskit.circuit.library.HamiltonianGate(data, time, label=None)">
