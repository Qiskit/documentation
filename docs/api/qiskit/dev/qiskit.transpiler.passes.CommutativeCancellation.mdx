...
<Class id="qiskit.transpiler.passes.CommutativeCancellation" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.1/qiskit/transpiler/passes/optimization/commutative_cancellation.py#L34-L207" signature="qiskit.transpiler.passes.CommutativeCancellation(*args, **kwargs)">
