...
<Class id="qiskit.transpiler.passes.Size" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/2.2/qiskit/transpiler/passes/analysis/size.py#L18-L36" signature="qiskit.transpiler.passes.Size(*args, **kwargs)" modifiers="class">
  ...
  **recurse** – whether to allow recursion into control flow. If this is `False` (default), the pass will throw an error when control flow is present, to avoid returning a number with little meaning.
  ...
  <Function id="qiskit.transpiler.passes.Size.execute" github="https://github.com/Qiskit/qiskit/tree/stable/2.2/qiskit/passmanager/base_tasks.py#L72-L118" signature="execute(passmanager_ir, state, callback=None)">
  ...
  <Function id="qiskit.transpiler.passes.Size.name" github="https://github.com/Qiskit/qiskit/tree/stable/2.2/qiskit/passmanager/base_tasks.py#L68-L70" signature="name()">
    Name of the pass.
  ...
  <Function id="qiskit.transpiler.passes.Size.run" github="https://github.com/Qiskit/qiskit/tree/stable/2.2/qiskit/transpiler/passes/analysis/size.py#L34-L36" signature="run(dag)">
    Run the Size pass on dag.
  </Function>

  ### update\_status

  <Function id="qiskit.transpiler.passes.Size.update_status" github="https://github.com/Qiskit/qiskit/tree/stable/2.2/qiskit/passmanager/base_tasks.py#L120-L138" signature="update_status(state, run_state)">
