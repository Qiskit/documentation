...
<Class id="qiskit.transpiler.passes.Size" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.1/qiskit/transpiler/passes/analysis/size.py#L18-L36" signature="qiskit.transpiler.passes.Size(*args, **kwargs)">
