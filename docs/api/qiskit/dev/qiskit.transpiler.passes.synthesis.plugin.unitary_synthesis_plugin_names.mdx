...
<Function id="qiskit.transpiler.passes.synthesis.plugin.unitary_synthesis_plugin_names" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/main/qiskit/transpiler/passes/synthesis/plugin.py#L657-L667" signature="qiskit.transpiler.passes.synthesis.plugin.unitary_synthesis_plugin_names()">
