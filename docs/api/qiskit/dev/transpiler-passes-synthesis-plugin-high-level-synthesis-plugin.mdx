---
title: HighLevelSynthesisPlugin (dev version)
description: API reference for qiskit.transpiler.passes.synthesis.plugin.HighLevelSynthesisPlugin in the dev version of qiskit
