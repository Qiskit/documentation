...
<Class id="qiskit.circuit.library.MCMT" github="https://github.com/qiskit/qiskit/tree/main/qiskit/circuit/library/generalized_gates/mcmt.py" signature="qiskit.circuit.library.MCMT(gate, num_ctrl_qubits, num_target_qubits)">
  ...
  *   [**AttributeError**](https://docs.python.org/3/library/exceptions.html#AttributeError "(in Python v3.12)") – If the number of controls or targets is 0.
  ...
  <Attribute id="qiskit.circuit.library.MCMT.instances" name="instances" attributeValue="= 192" />
  ...
  <Function id="qiskit.circuit.library.MCMT.control" name="control" signature="control(num_ctrl_qubits=1, label=None, ctrl_state=None, annotated=False)">
    Return the controlled version of the MCMT circuit.
  </Function>

  ### inverse

  <Function id="qiskit.circuit.library.MCMT.inverse" name="inverse" signature="inverse(annotated=False)">
