...
<Class id="qiskit.quantum_info.StabilizerState" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/main/qiskit/quantum_info/states/stabilizerstate.py#L36-L778" signature="qiskit.quantum_info.StabilizerState(data, validate=True)" modifiers="class">
  Bases: `QuantumState`
  ...
  *   **validate** ([*bool*](https://docs.python.org/3/library/functions.html#bool "(in Python v3.13)")) – validate that the stabilizer state data is a valid Clifford.
  ...
  <Function id="qiskit.quantum_info.StabilizerState.equiv" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/quantum_info/states/stabilizerstate.py#L327-L366" signature="equiv(other)">
  ...
  <Function id="qiskit.quantum_info.StabilizerState.expectation_value" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/quantum_info/states/stabilizerstate.py#L262-L325" signature="expectation_value(oper, qargs=None)">
  ...
  <Function id="qiskit.quantum_info.StabilizerState.measure" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/quantum_info/states/stabilizerstate.py#L491-L519" signature="measure(qargs=None)">
  ...
  <Function id="qiskit.quantum_info.StabilizerState.probabilities" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/quantum_info/states/stabilizerstate.py#L368-L392" signature="probabilities(qargs=None, decimals=None)">
  ...
  <Function id="qiskit.quantum_info.StabilizerState.probabilities_dict" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/quantum_info/states/stabilizerstate.py#L430-L452" signature="probabilities_dict(qargs=None, decimals=None)">
  ...
  <Function id="qiskit.quantum_info.StabilizerState.probabilities_dict_from_bitstring" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/quantum_info/states/stabilizerstate.py#L394-L428" signature="probabilities_dict_from_bitstring(outcome_bitstring, qargs=None, decimals=None)">
  ...
  <Function id="qiskit.quantum_info.StabilizerState.reset" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/quantum_info/states/stabilizerstate.py#L454-L489" signature="reset(qargs=None)">
  ...
  <Function id="qiskit.quantum_info.StabilizerState.sample_memory" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/quantum_info/states/stabilizerstate.py#L521-L545" signature="sample_memory(shots, qargs=None)">
