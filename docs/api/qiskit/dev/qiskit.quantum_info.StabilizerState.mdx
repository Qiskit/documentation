...
<Class id="qiskit.quantum_info.StabilizerState" github="https://github.com/qiskit/qiskit/tree/main/qiskit/quantum_info/states/stabilizerstate.py" signature="qiskit.quantum_info.StabilizerState(data, validate=True)">
  Bases: `QuantumState`
