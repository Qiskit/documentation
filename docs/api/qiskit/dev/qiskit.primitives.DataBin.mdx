...
<Class id="qiskit.primitives.DataBin" github="https://github.com/qiskit/qiskit/tree/main/qiskit/primitives/containers/data_bin.py" signature="qiskit.primitives.DataBin">
