...
<Class id="qiskit.primitives.DataBin" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.2/qiskit/primitives/containers/data_bin.py#L32-L143" signature="qiskit.primitives.DataBin(*, shape=(), **data)" modifiers="class">
  Bases: `ShapedMixin`
  ...
  *   [**ValueError**](https://docs.python.org/3/library/exceptions.html#ValueError "(in Python v3.12)") – If some value is inconsistent with the provided shape.
  ...
  <Function id="qiskit.primitives.DataBin.items" github="https://github.com/Qiskit/qiskit/tree/stable/1.2/qiskit/primitives/containers/data_bin.py#L125-L127" signature="items()">
  ...
  <Function id="qiskit.primitives.DataBin.keys" github="https://github.com/Qiskit/qiskit/tree/stable/1.2/qiskit/primitives/containers/data_bin.py#L117-L119" signature="keys()">
  ...
  <Function id="qiskit.primitives.DataBin.values" github="https://github.com/Qiskit/qiskit/tree/stable/1.2/qiskit/primitives/containers/data_bin.py#L121-L123" signature="values()">
