...
<Class id="qiskit.primitives.DataBin" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/primitives/containers/data_bin.py#L36-L55" signature="qiskit.primitives.DataBin">
