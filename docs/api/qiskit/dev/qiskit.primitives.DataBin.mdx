...
<Class id="qiskit.primitives.DataBin" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/main/qiskit/primitives/containers/data_bin.py#L32-L151" signature="qiskit.primitives.DataBin(*, shape=(), **data)" modifiers="class">
  Bases: `ShapedMixin`
  ...
  *   [**ValueError**](https://docs.python.org/3/library/exceptions.html#ValueError "(in Python v3.13)") – If some value is inconsistent with the provided shape.
  ...
  <Function id="qiskit.primitives.DataBin.items" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/primitives/containers/data_bin.py#L133-L135" signature="items()">
  ...
  <Function id="qiskit.primitives.DataBin.keys" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/primitives/containers/data_bin.py#L125-L127" signature="keys()">
  ...
  <Function id="qiskit.primitives.DataBin.values" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/primitives/containers/data_bin.py#L129-L131" signature="values()">
