...
`qiskit.providers.models.UchannelLO(q, scale)` [GitHub](https://github.com/qiskit/qiskit/tree/main/qiskit/providers/models/backendconfiguration.py "view source code")
