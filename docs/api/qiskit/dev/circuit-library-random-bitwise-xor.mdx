...
<Class id="qiskit.circuit.library.random_bitwise_xor" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/main/qiskit/circuit/library/boolean_logic/quantum_xor.py#L156-L167" signature="qiskit.circuit.library.random_bitwise_xor(num_qubits, seed)" modifiers="class">
  Bases:
  ...
  **Return type**
  ...
  [*BitwiseXorGate*](circuit-library-bitwise-xor-gate "qiskit.circuit.library.boolean_logic.quantum_xor.BitwiseXorGate")
</Class>
