...
<Class id="qiskit.circuit.library.MCXGrayCode" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/main/qiskit/circuit/library/standard_gates/x.py#L1227-L1300" signature="qiskit.circuit.library.MCXGrayCode(num_ctrl_qubits=None, label=None, ctrl_state=None, *, duration=None, unit='dt', _base_label=None)">
  ...
  <Attribute id="qiskit.circuit.library.MCXGrayCode.base_class" name="base_class">
  ...
  <Attribute id="qiskit.circuit.library.MCXGrayCode.condition" name="condition">
  ...
  <Attribute id="qiskit.circuit.library.MCXGrayCode.mutable" name="mutable">
  ...
  <Function id="qiskit.circuit.library.MCXGrayCode.inverse" name="inverse" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/circuit/library/standard_gates/x.py#L1274-L1286" signature="inverse(annotated=False)">
