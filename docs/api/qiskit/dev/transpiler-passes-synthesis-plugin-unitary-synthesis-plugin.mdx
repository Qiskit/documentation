---
title: UnitarySynthesisPlugin (dev version)
description: API reference for qiskit.transpiler.passes.synthesis.plugin.UnitarySynthesisPlugin in the dev version of qiskit
