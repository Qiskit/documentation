...
<Class id="qiskit.circuit.library.UCPauliRotGate" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/main/qiskit/circuit/library/generalized_gates/uc_pauli_rot.py#L32-L164" signature="qiskit.circuit.library.UCPauliRotGate(angle_list, rot_axis)" modifiers="class">
  ...
  *   **rot\_axis** ([*str*](https://docs.python.org/3/library/stdtypes.html#str "(in Python v3.13)")) – Rotation axis. Must be either of `"X"`, `"Y"` or `"Z"`.
  ...
  <Function id="qiskit.circuit.library.UCPauliRotGate.broadcast_arguments" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/circuit/gate.py#L187-L244" signature="broadcast_arguments(qargs, cargs)">
  ...
  <Function id="qiskit.circuit.library.UCPauliRotGate.control" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/circuit/gate.py#L104-L144" signature="control(num_ctrl_qubits=1, label=None, ctrl_state=None, annotated=None)">
  ...
  <Function id="qiskit.circuit.library.UCPauliRotGate.validate_parameter" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/circuit/gate.py#L246-L260" signature="validate_parameter(parameter)">
