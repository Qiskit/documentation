...
<Class id="qiskit.passmanager.FlowControllerLinear" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.1/qiskit/passmanager/flow_controllers.py#L27-L49" signature="qiskit.passmanager.FlowControllerLinear(tasks=(), *, options=None)">
