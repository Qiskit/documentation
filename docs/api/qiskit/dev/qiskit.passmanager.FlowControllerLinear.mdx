...
<Class id="qiskit.passmanager.FlowControllerLinear" github="https://github.com/qiskit/qiskit/tree/main/qiskit/passmanager/flow_controllers.py" signature="qiskit.passmanager.FlowControllerLinear(tasks=(), *, options=None)">
