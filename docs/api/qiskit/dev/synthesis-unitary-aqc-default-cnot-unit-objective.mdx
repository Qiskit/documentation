---
title: DefaultCNOTUnitObjective (dev version)
description: API reference for qiskit.synthesis.unitary.aqc.DefaultCNOTUnitObjective in the dev version of qiskit
