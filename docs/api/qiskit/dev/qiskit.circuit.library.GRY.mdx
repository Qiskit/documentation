...
<Class id="qiskit.circuit.library.GRY" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/2.2/qiskit/circuit/library/generalized_gates/gr.py#L122-L168" signature="qiskit.circuit.library.GRY(num_qubits, theta)" modifiers="class">
