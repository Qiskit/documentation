...
`qiskit.circuit.library.GRY(num_qubits, theta)` [GitHub](https://github.com/qiskit/qiskit/tree/main/qiskit/circuit/library/generalized_gates/gr.py "view source code")
...
![../\_images/qiskit-circuit-library-GRY-1.png](/images/api/qiskit/dev/qiskit-circuit-library-GRY-1.png)
...
<span id="qiskit.circuit.library.GRY.num_captured_vars" />
...
<span id="qiskit.circuit.library.GRY.num_declared_vars" />
...
<span id="qiskit.circuit.library.GRY.num_input_vars" />
...
<span id="qiskit.circuit.library.GRY.num_vars" />
