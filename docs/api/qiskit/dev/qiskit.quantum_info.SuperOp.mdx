...
<Class id="qiskit.quantum_info.SuperOp" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.1/qiskit/quantum_info/operators/channel/superop.py#L40-L373" signature="qiskit.quantum_info.SuperOp(data, input_dims=None, output_dims=None)">
