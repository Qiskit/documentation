...
<Class id="qiskit.quantum_info.SuperOp" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/quantum_info/operators/channel/superop.py#L39-L373" signature="qiskit.quantum_info.SuperOp(data, input_dims=None, output_dims=None)">
