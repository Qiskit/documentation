...
`qiskit.transpiler.passes.HighLevelSynthesis(*args, **kwargs)` [GitHub](https://github.com/qiskit/qiskit/tree/main/qiskit/transpiler/passes/synthesis/high_level_synthesis.py "view source code")
...
<span id="qiskit.transpiler.passes.HighLevelSynthesis.execute" />
...
<span id="qiskit.transpiler.passes.HighLevelSynthesis.update_status" />
