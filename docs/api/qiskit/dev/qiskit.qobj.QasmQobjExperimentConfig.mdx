...
<Class id="qiskit.qobj.QasmQobjExperimentConfig" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/main/qiskit/qobj/qasm_qobj.py#L412-L443" signature="qiskit.qobj.QasmQobjExperimentConfig(calibrations=None, qubit_lo_freq=None, meas_lo_freq=None, **kwargs)">
  Bases: `QobjDictField`
  ...
  *   **kwargs** – Additional free form key value fields to add to the configuration
  ...
  <Function id="qiskit.qobj.QasmQobjExperimentConfig.from_dict" name="from_dict" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/qobj/qasm_qobj.py#L438-L443" signature="classmethod from_dict(data)">
  ...
  <Function id="qiskit.qobj.QasmQobjExperimentConfig.to_dict" name="to_dict" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/qobj/qasm_qobj.py#L432-L436" signature="to_dict()">
