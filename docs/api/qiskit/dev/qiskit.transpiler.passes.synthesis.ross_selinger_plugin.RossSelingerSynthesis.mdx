...
<Class id="qiskit.transpiler.passes.synthesis.ross_selinger_plugin.RossSelingerSynthesis" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/main/qiskit/transpiler/passes/synthesis/ross_selinger_plugin.py#L32-L111" signature="qiskit.transpiler.passes.synthesis.ross_selinger_plugin.RossSelingerSynthesis" modifiers="class">
  ...
  **\[1] Neil J. Ross, Peter Selinger, Optimal ancilla-free Clifford+T approximation of z-rotations,**
  ...
  <Function id="qiskit.transpiler.passes.synthesis.ross_selinger_plugin.RossSelingerSynthesis.run" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/transpiler/passes/synthesis/ross_selinger_plugin.py#L104-L111" signature="run(unitary, **options)">
