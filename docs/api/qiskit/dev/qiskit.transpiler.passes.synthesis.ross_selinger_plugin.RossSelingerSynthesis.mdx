---
title: RossSelingerSynthesis (dev version)
description: API reference for qiskit.transpiler.passes.synthesis.ross_selinger_plugin.RossSelingerSynthesis in the dev version of qiskit
...
<Class id="qiskit.transpiler.passes.synthesis.ross_selinger_plugin.RossSelingerSynthesis" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/main/qiskit/transpiler/passes/synthesis/ross_selinger_plugin.py#L32-L114" signature="qiskit.transpiler.passes.synthesis.ross_selinger_plugin.RossSelingerSynthesis" modifiers="class">
  ...
  This plugin is invoked by [`transpile()`](/docs/api/qiskit/dev/compiler#qiskit.compiler.transpile "qiskit.compiler.transpile") when the `unitary_synthesis_method` parameter is set to `"gridsynth"`.
  ...
  **\[1] Neil J. Ross, Peter Selinger, Optimal ancilla-free Clifford+T approximation of z-rotations,**
  ...
  <Function id="qiskit.transpiler.passes.synthesis.ross_selinger_plugin.RossSelingerSynthesis.run" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/transpiler/passes/synthesis/ross_selinger_plugin.py#L104-L114" signature="run(unitary, **options)">
