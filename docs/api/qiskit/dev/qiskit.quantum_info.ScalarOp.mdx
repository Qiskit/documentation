...
<Class id="qiskit.quantum_info.ScalarOp" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/quantum_info/operators/scalar_op.py#L29-L249" signature="qiskit.quantum_info.ScalarOp(dims=None, coeff=1)">
  Bases: `LinearOp`
