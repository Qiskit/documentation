...
<Class id="qiskit.circuit.library.UCRZGate" github="https://github.com/qiskit/qiskit/tree/main/qiskit/circuit/library/generalized_gates/ucrz.py" signature="qiskit.circuit.library.UCRZGate(angle_list)">
