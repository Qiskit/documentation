...
<Class id="qiskit.transpiler.passes.synthesis.hls_plugins.PMHSynthesisLinearFunction" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/main/qiskit/transpiler/passes/synthesis/hls_plugins.py#L823-L869" signature="qiskit.transpiler.passes.synthesis.hls_plugins.PMHSynthesisLinearFunction" modifiers="class">
  ...
  **References**
  ...
  <Function id="qiskit.transpiler.passes.synthesis.hls_plugins.PMHSynthesisLinearFunction.run" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/transpiler/passes/synthesis/hls_plugins.py#L846-L869" signature="run(high_level_object, coupling_map=None, target=None, qubits=None, **options)">
