...
`qiskit.transpiler.passes.StochasticSwap(*args, **kwargs)` [GitHub](https://github.com/qiskit/qiskit/tree/main/qiskit/transpiler/passes/routing/stochastic_swap.py "view source code")
...
<span id="qiskit.transpiler.passes.StochasticSwap.execute" />
...
<span id="qiskit.transpiler.passes.StochasticSwap.update_status" />
