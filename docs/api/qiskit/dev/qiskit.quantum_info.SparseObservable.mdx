...
$$
  ...
  *   negate all the coefficients in an observable with unary `-`
  ...
  <Function id="qiskit.quantum_info.SparseObservable.to_matrix" signature="to_matrix()">
    ...
    *   [**ValueError**](https://docs.python.org/3/library/exceptions.html#ValueError) – If the number of qubits exceeds system limits.
    *   [**ValueError**](https://docs.python.org/3/library/exceptions.html#ValueError) – If the number of qubits is 0.
  </Function>
