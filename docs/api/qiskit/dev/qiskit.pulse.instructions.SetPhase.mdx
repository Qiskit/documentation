...
<Class id="qiskit.pulse.instructions.SetPhase" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.1/qiskit/pulse/instructions/phase.py#L91-L149" signature="qiskit.pulse.instructions.SetPhase(phase, channel, name=None)">
