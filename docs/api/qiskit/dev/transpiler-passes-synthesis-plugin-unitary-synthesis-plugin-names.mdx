---
title: unitary_synthesis_plugin_names (dev version)
description: API reference for qiskit.transpiler.passes.synthesis.plugin.unitary_synthesis_plugin_names in the dev version of qiskit
