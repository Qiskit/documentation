...
<Class id="qiskit.transpiler.passes.RZXCalibrationBuilderNoEcho" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.2/qiskit/transpiler/passes/calibration/rzx_builder.py#L245-L307" signature="qiskit.transpiler.passes.RZXCalibrationBuilderNoEcho(*args, **kwargs)" modifiers="class">
  ...
  **Raises**
  ...
  <Function id="qiskit.transpiler.passes.RZXCalibrationBuilderNoEcho.rescale_cr_inst" github="https://github.com/Qiskit/qiskit/tree/stable/1.2/qiskit/pulse/builder.py#L110-L163" signature="rescale_cr_inst(instruction, theta, sample_mult=16)" modifiers="static">
