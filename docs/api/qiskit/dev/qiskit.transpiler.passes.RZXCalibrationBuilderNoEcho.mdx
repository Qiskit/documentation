---
title: RZXCalibrationBuilderNoEcho (dev version)
description: API reference for qiskit.transpiler.passes.RZXCalibrationBuilderNoEcho in the dev version of qiskit
