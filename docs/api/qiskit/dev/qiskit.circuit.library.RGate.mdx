...
<Class id="qiskit.circuit.library.RGate" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.1/qiskit/circuit/library/standard_gates/r.py#L25-L114" signature="qiskit.circuit.library.RGate(theta, phi, label=None, *, duration=None, unit='dt')">
