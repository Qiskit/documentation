...
<Class id="qiskit.circuit.library.RGate" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/main/qiskit/circuit/library/standard_gates/r.py#L25-L114" signature="qiskit.circuit.library.RGate(theta, phi, label=None)" modifiers="class">
