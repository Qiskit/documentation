...
<Class id="qiskit.dagcircuit.DAGCircuit" isDedicatedPage={true} signature="qiskit.dagcircuit.DAGCircuit" modifiers="class">
  ...
  <Function id="qiskit.dagcircuit.DAGCircuit.apply_operation_back" signature="apply_operation_back(op, qargs=None, cargs=None, *, check=True)">
    ...
    *   **op** ([*qiskit.circuit.Operation*](circuit-operation "qiskit.circuit.Operation")) – the operation associated with the DAG node
    ...
    **Return type**
    ...
    [DAGOpNode](dagcircuit-dag-op-node "qiskit.dagcircuit.DAGOpNode")
  ...
  <Function id="qiskit.dagcircuit.DAGCircuit.control_flow_op_nodes" signature="control_flow_op_nodes()">
    ...
    **The list of dag nodes containing control flow ops. If there**

    are no control flow nodes None is returned

    **Return type**

    [list](https://docs.python.org/3/library/stdtypes.html#list "(in Python v3.13)")\[[DAGOpNode](dagcircuit-dag-op-node "qiskit.dagcircuit.DAGOpNode")] | None
  </Function>
  ...
  <Function id="qiskit.dagcircuit.DAGCircuit.edges" signature="edges(nodes=None)">
    ...
    **nodes** ([*DAGOpNode*](dagcircuit-dag-op-node "qiskit.dagcircuit.DAGOpNode")*,* [*DAGInNode*](dagcircuit-dag-in-node "qiskit.dagcircuit.DAGInNode")*, or* [*DAGOutNode*](dagcircuit-dag-out-node "qiskit.dagcircuit.DAGOutNode")*|*[*list*](https://docs.python.org/3/library/stdtypes.html#list "(in Python v3.13)")*(*[*DAGOpNode*](dagcircuit-dag-op-node "qiskit.dagcircuit.DAGOpNode")*,* [*DAGInNode*](dagcircuit-dag-in-node "qiskit.dagcircuit.DAGInNode")*, or* [*DAGOutNode*](dagcircuit-dag-out-node "qiskit.dagcircuit.DAGOutNode")) – Either a list of nodes or a single input node. If none is specified, all edges are returned from the graph.
  ...
  <Function id="qiskit.dagcircuit.DAGCircuit.gate_nodes" signature="gate_nodes()">
    ...
    **Return type**
    ...
    [list](https://docs.python.org/3/library/stdtypes.html#list "(in Python v3.13)")\[[DAGOpNode](dagcircuit-dag-op-node "qiskit.dagcircuit.DAGOpNode")]
  </Function>
  ...
  <Function id="qiskit.dagcircuit.DAGCircuit.op_nodes" signature="op_nodes(op=None, include_directives=True)">
    ...
    *   **op** ([*Type*](circuit-classical#qiskit.circuit.classical.types.Type "qiskit.circuit.classical.types.Type")) – [`qiskit.circuit.Operation`](circuit-operation "qiskit.circuit.Operation") subclass op nodes to return. If None, return all op nodes.
  ...
  <Function id="qiskit.dagcircuit.DAGCircuit.replace_block_with_op" signature="replace_block_with_op(node_block, op, wire_pos_map, cycle_check=True)">
    ...
    *   **node\_block** (*List\[*[*DAGNode*](dagcircuit-dag-node "qiskit.dagcircuit.DAGNode")*]*) – A list of dag nodes that represents the node block to be replaced
    *   **op** ([*qiskit.circuit.Operation*](circuit-operation "qiskit.circuit.Operation")) – The operation to replace the block with
  ...
  <Function id="qiskit.dagcircuit.DAGCircuit.size" signature="size(*, recurse=False)">
    ...
    **Raises**
    ...
    [**DAGCircuitError**](dagcircuit#qiskit.dagcircuit.DAGCircuitError "qiskit.dagcircuit.DAGCircuitError") – if an unknown [`ControlFlowOp`](circuit-control-flow-op "qiskit.circuit.ControlFlowOp") is present in a call with `recurse=True`, or any control flow is present in a non-recursive call.
  </Function>
  ...
  <Function id="qiskit.dagcircuit.DAGCircuit.substitute_node" signature="substitute_node(node, op, inplace=False, propagate_condition=True)">
    ...
    *   **node** ([*DAGOpNode*](dagcircuit-dag-op-node "qiskit.dagcircuit.DAGOpNode")) – Node to be replaced
    *   **op** ([*qiskit.circuit.Operation*](circuit-operation "qiskit.circuit.Operation")) – The [`qiskit.circuit.Operation`](circuit-operation "qiskit.circuit.Operation") instance to be added to the DAG
  ...
  <Function id="qiskit.dagcircuit.DAGCircuit.substitute_node_with_dag" signature="substitute_node_with_dag(node, input_dag, wires=None, propagate_condition=True)">
    ...
    *   **node** ([*DAGOpNode*](dagcircuit-dag-op-node "qiskit.dagcircuit.DAGOpNode")) – node to substitute
    ...
    *   **propagate\_condition** ([*bool*](https://docs.python.org/3/library/functions.html#bool "(in Python v3.13)")) – If `True` (default), then any `condition` attribute on the operation within `node` is propagated to each node in the `input_dag`. If `False`, then the `input_dag` is assumed to faithfully implement suitable conditional logic already. This is ignored for [`ControlFlowOp`](circuit-control-flow-op "qiskit.circuit.ControlFlowOp")\ s (i.e. treated as if it is `False`); replacements of those must already fulfill the same conditional logic or this function would be close to useless for them.
  ...
  <Function id="qiskit.dagcircuit.DAGCircuit.topological_nodes" signature="topological_nodes(key=None)">
    ...
    **Return type**
    ...
    generator([DAGOpNode](dagcircuit-dag-op-node "qiskit.dagcircuit.DAGOpNode"), [DAGInNode](dagcircuit-dag-in-node "qiskit.dagcircuit.DAGInNode"), or [DAGOutNode](dagcircuit-dag-out-node "qiskit.dagcircuit.DAGOutNode"))
  </Function>
  ...
  <Function id="qiskit.dagcircuit.DAGCircuit.topological_op_nodes" signature="topological_op_nodes(key=None)">
    ...
    **Return type**
    ...
    generator([DAGOpNode](dagcircuit-dag-op-node "qiskit.dagcircuit.DAGOpNode"))
  </Function>
