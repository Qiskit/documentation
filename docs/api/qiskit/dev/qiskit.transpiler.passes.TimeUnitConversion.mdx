...
<Class id="qiskit.transpiler.passes.TimeUnitConversion" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.1/qiskit/transpiler/passes/scheduling/time_unit_conversion.py#L24-L159" signature="qiskit.transpiler.passes.TimeUnitConversion(*args, **kwargs)">
