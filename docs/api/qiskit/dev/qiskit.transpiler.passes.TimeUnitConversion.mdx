---
title: TimeUnitConversion (dev version)
description: API reference for qiskit.transpiler.passes.TimeUnitConversion in the dev version of qiskit
...
<Class id="qiskit.transpiler.passes.TimeUnitConversion" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/main/qiskit/transpiler/passes/scheduling/time_unit_conversion.py#L26-L173" signature="qiskit.transpiler.passes.TimeUnitConversion(*args, **kwargs)" modifiers="class">
  ...
  *   **target** – The [`Target`](qiskit.transpiler.Target "qiskit.transpiler.Target") representing the target backend, if both `inst_durations` and `target` are specified then this argument will take precedence and `inst_durations` will be ignored.
  ...
  <Function id="qiskit.transpiler.passes.TimeUnitConversion.execute" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/transpiler/basepasses.py#L162-L181" signature="execute(passmanager_ir, state, callback=None)">
  ...
  <Function id="qiskit.transpiler.passes.TimeUnitConversion.name" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/passmanager/base_tasks.py#L72-L74" signature="name()">
    Name of the pass.
  ...
  <Function id="qiskit.transpiler.passes.TimeUnitConversion.run" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/transpiler/passes/scheduling/time_unit_conversion.py#L59-L154" signature="run(dag)">
    ...
    **Raises**
    ...
    [**TranspilerError**](/docs/api/qiskit/dev/transpiler#qiskit.transpiler.TranspilerError "qiskit.transpiler.TranspilerError") – if the units are not unifiable
  </Function>

  ### update\_status

  <Function id="qiskit.transpiler.passes.TimeUnitConversion.update_status" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/transpiler/basepasses.py#L183-L191" signature="update_status(state, run_state)">
