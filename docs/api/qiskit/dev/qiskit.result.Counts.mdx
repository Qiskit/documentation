...
<Class id="qiskit.result.Counts" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/main/qiskit/result/counts.py#L27-L196" signature="qiskit.result.Counts(data, time_taken=None, creg_sizes=None, memory_slots=None)" modifiers="class">
  ...
  *   [**TypeError**](https://docs.python.org/3/library/exceptions.html#TypeError "(in Python v3.14)") – If the input key type is not an `int` or `str`, or if the input keys are not all of the same type.
  *   [**QiskitError**](exceptions#qiskit.exceptions.QiskitError "qiskit.exceptions.QiskitError") – If a dit string key is input with `creg_sizes` and/or `memory_slots`.
  ...
  <Function id="qiskit.result.Counts.hex_outcomes" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/result/counts.py#L144-L165" signature="hex_outcomes()">
  ...
  <Function id="qiskit.result.Counts.int_outcomes" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/result/counts.py#L167-L187" signature="int_outcomes()">
  ...
  <Function id="qiskit.result.Counts.most_frequent" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/result/counts.py#L125-L142" signature="most_frequent()">
  ...
  <Function id="qiskit.result.Counts.shots" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/result/counts.py#L194-L196" signature="shots()">
