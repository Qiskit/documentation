...
<Class id="qiskit.result.Counts" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/result/counts.py#L27-L189" signature="qiskit.result.Counts(data, time_taken=None, creg_sizes=None, memory_slots=None)">
