...
<Class id="qiskit.circuit.library.RYGate" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.1/qiskit/circuit/library/standard_gates/ry.py#L25-L137" signature="qiskit.circuit.library.RYGate(theta, label=None, *, duration=None, unit='dt')">
