...
$$
  ...
  <Function id="qiskit.circuit.library.RYGate.power" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/circuit/library/standard_gates/ry.py#L128-L131" signature="power(exponent)">
