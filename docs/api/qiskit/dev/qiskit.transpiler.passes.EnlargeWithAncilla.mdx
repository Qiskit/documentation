...
<Class id="qiskit.transpiler.passes.EnlargeWithAncilla" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.1/qiskit/transpiler/passes/layout/enlarge_with_ancilla.py#L19-L49" signature="qiskit.transpiler.passes.EnlargeWithAncilla(*args, **kwargs)">
