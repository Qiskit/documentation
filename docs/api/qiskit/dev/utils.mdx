...
<Function id="qiskit.utils.add_deprecation_to_docstring" github="https://github.com/Qiskit/qiskit/tree/stable/1.3/qiskit/utils/deprecation.py#L418-L490" signature="qiskit.utils.add_deprecation_to_docstring(func, msg, *, since, pending)">
  ...
  *   **func** ([*Callable*](https://docs.python.org/3/library/collections.abc.html#collections.abc.Callable "(in Python v3.13)")) – The function to modify.
...
<Function id="qiskit.utils.deprecate_arguments" github="https://github.com/Qiskit/qiskit/tree/stable/1.3/qiskit/utils/deprecation.py#L208-L277" signature="qiskit.utils.deprecate_arguments(kwarg_map, category=<class 'DeprecationWarning'>, *, since=None)">
  ...
  *   **category** ([*Type*](https://docs.python.org/3/library/typing.html#typing.Type "(in Python v3.13)")*\[*[*Warning*](https://docs.python.org/3/library/exceptions.html#Warning "(in Python v3.13)")*]*) – Usually either DeprecationWarning or PendingDeprecationWarning.
...
<Function id="qiskit.utils.apply_prefix" github="https://github.com/Qiskit/qiskit/tree/stable/1.3/qiskit/utils/units.py#L21-L68" signature="qiskit.utils.apply_prefix(value, unit)">
  ...
  *   **value** ([*float*](https://docs.python.org/3/library/functions.html#float "(in Python v3.13)")  *|*[*ParameterExpression*](qiskit.circuit.ParameterExpression "qiskit.circuit.parameterexpression.ParameterExpression")) – The number to apply prefix to.
  ...
  *   **value** ([*float*](https://docs.python.org/3/library/functions.html#float "(in Python v3.13)")  *|*[*ParameterExpression*](qiskit.circuit.ParameterExpression "qiskit.circuit.parameterexpression.ParameterExpression")) –
...
<Function id="qiskit.utils.wrap_method" github="https://github.com/Qiskit/qiskit/tree/stable/1.3/qiskit/utils/classtools.py#L120-L146" signature="qiskit.utils.wrap_method(cls, name, *, before=None, after=None)">
  ...
  *   **before** ([*Callable*](https://docs.python.org/3/library/typing.html#typing.Callable "(in Python v3.13)")) – a callable that should be called before the method that is being wrapped.
  *   **after** ([*Callable*](https://docs.python.org/3/library/typing.html#typing.Callable "(in Python v3.13)")) – a callable that should be called after the method that is being wrapped.
...
<Function id="qiskit.utils.parallel_map" github="https://github.com/Qiskit/qiskit/tree/stable/1.3/qiskit/utils/parallel.py#L121-L191" signature="qiskit.utils.parallel_map(task, values, task_args=(), task_kwargs={}, num_processes=5)">
