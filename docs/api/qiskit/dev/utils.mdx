...
<Function id="qiskit.utils.apply_prefix" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/utils/units.py#L24-L71" signature="qiskit.utils.apply_prefix(value, unit)">
  ...
  *   **value** ([*float*](https://docs.python.org/3/library/functions.html#float)  *|*[*ParameterExpression*](/docs/api/qiskit/dev/qiskit.circuit.ParameterExpression "qiskit.circuit.ParameterExpression")) – The number to apply prefix to.
  ...
  **Return type**
  ...
  [float](https://docs.python.org/3/library/functions.html#float) | [ParameterExpression](/docs/api/qiskit/dev/qiskit.circuit.ParameterExpression "qiskit.circuit.ParameterExpression")
  ...
  *   **value** ([*float*](https://docs.python.org/3/library/functions.html#float)  *|*[*ParameterExpression*](/docs/api/qiskit/dev/qiskit.circuit.ParameterExpression "qiskit.circuit.ParameterExpression"))
