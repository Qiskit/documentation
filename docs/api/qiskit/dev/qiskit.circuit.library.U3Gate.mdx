...
<Class id="qiskit.circuit.library.U3Gate" github="https://github.com/qiskit/qiskit/tree/main/qiskit/circuit/library/standard_gates/u3.py" signature="qiskit.circuit.library.U3Gate(theta, phi, lam, label=None, *, duration=None, unit='dt')">
...
$$
  ...
  <Function id="qiskit.circuit.library.U3Gate.control" name="control" signature="control(num_ctrl_qubits=1, label=None, ctrl_state=None, annotated=False)">
  ...
  <Function id="qiskit.circuit.library.U3Gate.inverse" name="inverse" signature="inverse(annotated=False)">
