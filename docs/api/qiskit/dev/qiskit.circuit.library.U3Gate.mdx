...
<Class id="qiskit.circuit.library.U3Gate" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/main/qiskit/circuit/library/standard_gates/u3.py#L25-L169" signature="qiskit.circuit.library.U3Gate(theta, phi, lam, label=None, *, duration=None, unit='dt')" modifiers="class">
...
$$
  ...
  <Function id="qiskit.circuit.library.U3Gate.control" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/circuit/library/standard_gates/u3.py#L115-L145" signature="control(num_ctrl_qubits=1, label=None, ctrl_state=None, annotated=False)">
