...
<Class id="qiskit.transpiler.passes.StochasticSwap" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.1/qiskit/transpiler/passes/routing/stochastic_swap.py#L47-L476" signature="qiskit.transpiler.passes.StochasticSwap(*args, **kwargs)">
