...
<Class id="qiskit.transpiler.passes.StochasticSwap" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/main/qiskit/transpiler/passes/routing/stochastic_swap.py#L48-L480" signature="qiskit.transpiler.passes.StochasticSwap(*args, **kwargs)" modifiers="class">
  ...
  *   **initial\_layout** ([*Layout*](qiskit.transpiler.Layout "qiskit.transpiler.Layout")) – starting layout at beginning of pass.
  ...
  <Function id="qiskit.transpiler.passes.StochasticSwap.run" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/transpiler/passes/routing/stochastic_swap.py#L101-L140" signature="run(dag)">
