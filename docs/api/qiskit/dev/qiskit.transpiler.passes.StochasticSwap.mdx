...
<Class id="qiskit.transpiler.passes.StochasticSwap" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/transpiler/passes/routing/stochastic_swap.py#L48-L473" signature="qiskit.transpiler.passes.StochasticSwap(*args, **kwargs)">
