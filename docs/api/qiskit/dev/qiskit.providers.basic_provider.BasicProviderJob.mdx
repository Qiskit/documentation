...
<Class id="qiskit.providers.basic_provider.BasicProviderJob" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.1/qiskit/providers/basic_provider/basic_provider_job.py#L22-L65" signature="qiskit.providers.basic_provider.BasicProviderJob(backend, job_id, result)">
