...
<Class id="qiskit.circuit.library.QFT" github="https://github.com/qiskit/qiskit/tree/main/qiskit/circuit/library/basis_change/qft.py" signature="qiskit.circuit.library.QFT(num_qubits=None, approximation_degree=0, do_swaps=True, inverse=False, insert_barriers=False, name=None)">
...
$$
  ...
  *   **name** ([*str*](https://docs.python.org/3/library/stdtypes.html#str "(in Python v3.12)") *| None*) – The name of the circuit.
  ...
  <Attribute id="qiskit.circuit.library.QFT.instances" name="instances" attributeValue="= 164" />
  ...
  <Function id="qiskit.circuit.library.QFT.inverse" name="inverse" signature="inverse(annotated=False)">
    Invert this circuit.
