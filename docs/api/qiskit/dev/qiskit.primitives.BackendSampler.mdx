...
<Class id="qiskit.primitives.BackendSampler" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/main/qiskit/primitives/backend_sampler.py#L34-L222" signature="qiskit.primitives.BackendSampler(backend, options=None, bound_pass_manager=None, skip_transpilation=False)" modifiers="class">
  ...
  **Raises**
  ...
  <Function id="qiskit.primitives.BackendSampler.run" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/primitives/base/base_sampler.py#L113-L144" signature="run(circuits, parameter_values=None, **run_options)">
  ...
  <Function id="qiskit.primitives.BackendSampler.set_transpile_options" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/primitives/backend_sampler.py#L130-L139" signature="set_transpile_options(**fields)">
