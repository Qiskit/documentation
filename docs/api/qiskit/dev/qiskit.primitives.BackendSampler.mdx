...
<Class id="qiskit.primitives.BackendSampler" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/main/qiskit/primitives/backend_sampler.py#L33-L213" signature="qiskit.primitives.BackendSampler(backend, options=None, bound_pass_manager=None, skip_transpilation=False)">
  ...
  **Raises**
  ...
  <Function id="qiskit.primitives.BackendSampler.run" name="run" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/primitives/base/base_sampler.py#L110-L141" signature="run(circuits, parameter_values=None, **run_options)">
  ...
  <Function id="qiskit.primitives.BackendSampler.set_options" name="set_options" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/primitives/base/base_primitive.py#L39-L45" signature="set_options(**fields)">
  ...
  <Function id="qiskit.primitives.BackendSampler.set_transpile_options" name="set_transpile_options" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/primitives/backend_sampler.py#L121-L130" signature="set_transpile_options(**fields)">
