...
<Function id="qiskit.visualization.plot_state_hinton" name="plot_state_hinton" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/main/qiskit/utils/lazy_tester.py#L39-L184" signature="qiskit.visualization.plot_state_hinton(state, title='', figsize=None, ax_real=None, ax_imag=None, *, filename=None)">
