...
`qiskit.result.ProbDistribution(data, shots=None)`[GitHub](https://github.com/qiskit/qiskit/tree/main/qiskit/result/distributions/probability.py "view source code")
