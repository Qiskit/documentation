...
<Class id="qiskit.circuit.library.GlobalPhaseGate" github="https://github.com/qiskit/qiskit/tree/main/qiskit/circuit/library/standard_gates/global_phase.py" signature="qiskit.circuit.library.GlobalPhaseGate(phase, label=None, *, duration=None, unit='dt')">
