...
<Class id="qiskit.circuit.library.GlobalPhaseGate" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/main/qiskit/circuit/library/standard_gates/global_phase.py#L26-L83" signature="qiskit.circuit.library.GlobalPhaseGate(phase, label=None)" modifiers="class">
