...
<Class id="qiskit.circuit.library.GlobalPhaseGate" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/main/qiskit/circuit/library/standard_gates/global_phase.py#L24-L83" signature="qiskit.circuit.library.GlobalPhaseGate(phase, label=None)" modifiers="class">
...
$$
  ...
  *   **label** ([*str*](https://docs.python.org/3/library/stdtypes.html#str) *| None*) – An optional label for the gate.
  ...
  <Function id="qiskit.circuit.library.GlobalPhaseGate.add_decomposition" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/circuit/instruction.py#L320-L325" signature="add_decomposition(decomposition)">
  ...
  <Function id="qiskit.circuit.library.GlobalPhaseGate.copy" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/circuit/instruction.py#L430-L445" signature="copy(name=None)">
  ...
  <Function id="qiskit.circuit.library.GlobalPhaseGate.inverse" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/circuit/library/standard_gates/global_phase.py#L56-L71" signature="inverse(annotated=False)">
  ...
  <Function id="qiskit.circuit.library.GlobalPhaseGate.is_parameterized" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/circuit/instruction.py#L285-L290" signature="is_parameterized()">
  ...
  <Function id="qiskit.circuit.library.GlobalPhaseGate.repeat" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/circuit/instruction.py#L493-L523" signature="repeat(n)">
  ...
  <Function id="qiskit.circuit.library.GlobalPhaseGate.reverse_ops" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/circuit/instruction.py#L347-L371" signature="reverse_ops()">
  ...
  <Function id="qiskit.circuit.library.GlobalPhaseGate.soft_compare" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/circuit/instruction.py#L216-L256" signature="soft_compare(other)">
  ...
  <Function id="qiskit.circuit.library.GlobalPhaseGate.to_mutable" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/circuit/instruction.py#L145-L153" signature="to_mutable()">
