...
<Class id="qiskit.passmanager.DoWhileController" github="https://github.com/qiskit/qiskit/tree/main/qiskit/passmanager/flow_controllers.py" signature="qiskit.passmanager.DoWhileController(tasks=(), do_while=None, *, options=None)">
  ...
  **options** ([*dict*](https://docs.python.org/3/library/stdtypes.html#dict "(in Python v3.12)")*\[*[*str*](https://docs.python.org/3/library/stdtypes.html#str "(in Python v3.12)")*, Any] | None*) – Option for this flow controller.
  ...
  <Function id="qiskit.passmanager.DoWhileController.execute" name="execute" signature="execute(passmanager_ir, state, callback=None)">
  ...
  <Function id="qiskit.passmanager.DoWhileController.iter_tasks" name="iter_tasks" signature="iter_tasks(state)">
