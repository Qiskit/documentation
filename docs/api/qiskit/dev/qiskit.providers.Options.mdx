...
<Class id="qiskit.providers.Options" github="https://github.com/qiskit/qiskit/tree/main/qiskit/providers/options.py" signature="qiskit.providers.Options(**kwargs)">
