...
<Class id="qiskit.providers.models.BackendStatus" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/providers/models/backendstatus.py#L19-L94" signature="qiskit.providers.models.BackendStatus(backend_name, backend_version, operational, pending_jobs, status_msg)">
