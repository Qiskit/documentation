...
<Class id="qiskit.primitives.BaseSamplerV1" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/primitives/base/base_sampler.py#L35-L150" signature="qiskit.primitives.BaseSamplerV1(*, options=None)">
