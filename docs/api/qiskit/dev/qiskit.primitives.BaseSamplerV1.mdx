...
<Class id="qiskit.primitives.BaseSamplerV1" github="https://github.com/qiskit/qiskit/tree/main/qiskit/primitives/base/base_sampler.py" signature="qiskit.primitives.BaseSamplerV1(*, options=None)">
  ...
  **options** ([*dict*](https://docs.python.org/3/library/stdtypes.html#dict "(in Python v3.12)") *| None*) – Default options.
  ...
  <Function id="qiskit.primitives.BaseSamplerV1.run" name="run" signature="run(circuits, parameter_values=None, **run_options)">
  ...
  <Function id="qiskit.primitives.BaseSamplerV1.set_options" name="set_options" signature="set_options(**fields)">
