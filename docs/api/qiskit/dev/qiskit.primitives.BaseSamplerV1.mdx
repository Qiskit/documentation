...
<Class id="qiskit.primitives.BaseSamplerV1" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/main/qiskit/primitives/base/base_sampler.py#L36-L151" signature="qiskit.primitives.BaseSamplerV1(*, options=None)" modifiers="class">
  ...
  **options** ([*dict*](https://docs.python.org/3/library/stdtypes.html#dict "(in Python v3.13)") *| None*) – Default options.
  ...
  <Function id="qiskit.primitives.BaseSamplerV1.run" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/primitives/base/base_sampler.py#L111-L142" signature="run(circuits, parameter_values=None, **run_options)">
