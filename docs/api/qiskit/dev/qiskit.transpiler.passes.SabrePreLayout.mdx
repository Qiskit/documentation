...
<Class id="qiskit.transpiler.passes.SabrePreLayout" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/main/qiskit/transpiler/passes/layout/sabre_pre_layout.py#L22-L217" signature="qiskit.transpiler.passes.SabrePreLayout(*args, **kwargs)">
  ...
  **raises TranspilerError**
  ...
  <Function id="qiskit.transpiler.passes.SabrePreLayout.execute" name="execute" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/passmanager/base_tasks.py#L72-L118" signature="execute(passmanager_ir, state, callback=None)">
  ...
  <Function id="qiskit.transpiler.passes.SabrePreLayout.name" name="name" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/passmanager/base_tasks.py#L68-L70" signature="name()">
    Name of the pass.
  ...
  <Function id="qiskit.transpiler.passes.SabrePreLayout.run" name="run" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/transpiler/passes/layout/sabre_pre_layout.py#L89-L132" signature="run(dag)">
  ...
  <Function id="qiskit.transpiler.passes.SabrePreLayout.update_status" name="update_status" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/passmanager/base_tasks.py#L120-L138" signature="update_status(state, run_state)">
