---
title: plot_error_map (dev version)
description: API reference for qiskit.visualization.plot_error_map in the dev version of qiskit
...
<Function id="qiskit.visualization.plot_error_map" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/main/qiskit/visualization/gate_map.py#L1252-L1489" signature="qiskit.visualization.plot_error_map(backend, figsize=(15, 12), show_title=True, qubit_coordinates=None)">
  Plots the error map of a given backend.

  **Parameters**

  *   **backend** ([*Backend*](providers-backend "qiskit.providers.Backend")) – Given backend.
  ...
  **Example**
  ...
  ![Output from the previous code.](/images/api/qiskit/dev/qiskit-visualization-plot_error_map-1.avif)
</Function>
