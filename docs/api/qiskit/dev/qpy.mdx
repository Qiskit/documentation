...
<Function id="qiskit.qpy.load" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/qpy/interface.py#L277-L444" signature="qiskit.qpy.load(file_obj, metadata_deserializer=None, annotation_factories=None)">
...
<Function id="qiskit.qpy.dump" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/qpy/interface.py#L89-L274" signature="qiskit.qpy.dump(programs, file_obj, metadata_serializer=None, use_symengine=False, version=17, annotation_factories=None)">
  ...
  *   **metadata\_serializer** ([*type*](https://docs.python.org/3/library/functions.html#type)*\[JSONEncoder] | None*) – An optional JSONEncoder class that will be passed the `.metadata` attribute for each program in `programs` and will be used as the `cls` kwarg on the json.dump()\` call to JSON serialize that dictionary.
...
<Function id="qiskit.qpy.get_qpy_version" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/qpy/interface.py#L447-L474" signature="qiskit.qpy.get_qpy_version(file_obj)">
