...
<Function id="qiskit.qpy.load" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/qpy/interface.py#L209-L342" signature="qiskit.qpy.load(file_obj, metadata_deserializer=None)">
  ...
  *   [**TypeError**](https://docs.python.org/3/library/exceptions.html#TypeError "(in Python v3.13)") – if invalid data type is loaded.
...
<Function id="qiskit.qpy.dump" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/qpy/interface.py#L75-L206" signature="qiskit.qpy.dump(programs, file_obj, metadata_serializer=None, use_symengine=True, version=14)">
...
Version 14 adds a new core DURATION type, as well as support for additional [`Type`](circuit_classical#qiskit.circuit.classical.types.Type "qiskit.circuit.classical.types.Type") classes.
