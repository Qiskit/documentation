...
> *   The bit term elements are of type “!H” and represents the u8 value of the [`SparseObservable.BitTerm`](/docs/api/qiskit/dev/qiskit.quantum_info.SparseObservable#bitterm "qiskit.quantum_info.SparseObservable.BitTerm")
