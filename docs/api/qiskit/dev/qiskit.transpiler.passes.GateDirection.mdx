...
<Class id="qiskit.transpiler.passes.GateDirection" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/transpiler/passes/utils/gate_direction.py#L43-L347" signature="qiskit.transpiler.passes.GateDirection(*args, **kwargs)">
