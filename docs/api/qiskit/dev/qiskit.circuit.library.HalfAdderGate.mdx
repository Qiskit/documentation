...
<Class id="qiskit.circuit.library.HalfAdderGate" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/main/qiskit/circuit/library/arithmetic/adders/adder.py#L74-L127" signature="qiskit.circuit.library.HalfAdderGate(num_state_qubits, label=None)" modifiers="class">
