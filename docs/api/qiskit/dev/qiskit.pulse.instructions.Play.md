...
`qiskit.pulse.instructions.Play(pulse, channel, name=None)` [GitHub](https://github.com/qiskit/qiskit/tree/main/qiskit/pulse/instructions/play.py "view source code")
