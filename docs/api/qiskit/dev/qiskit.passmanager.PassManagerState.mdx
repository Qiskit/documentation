...
<Class id="qiskit.passmanager.PassManagerState" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/main/qiskit/passmanager/compilation_status.py#L55-L74" signature="qiskit.passmanager.PassManagerState(workflow_status, property_set)">
  ...
  <Attribute id="qiskit.passmanager.PassManagerState.workflow_status" name="workflow_status" attributeTypeHint="WorkflowStatus">
    Status of the current compilation workflow.
  </Attribute>

  ### property\_set

  <Attribute id="qiskit.passmanager.PassManagerState.property_set" name="property_set" attributeTypeHint="PropertySet">
