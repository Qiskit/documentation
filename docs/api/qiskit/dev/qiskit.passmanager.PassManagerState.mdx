...
<Class id="qiskit.passmanager.PassManagerState" github="https://github.com/qiskit/qiskit/tree/main/qiskit/passmanager/compilation_status.py" signature="qiskit.passmanager.PassManagerState(workflow_status, property_set)">
