...
<Class id="qiskit.transpiler.passes.CollectCliffords" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/main/qiskit/transpiler/passes/optimization/collect_cliffords.py#L29-L74" signature="qiskit.transpiler.passes.CollectCliffords(*args, **kwargs)" modifiers="class">
  ...
  *   **matrix\_based** ([*bool*](https://docs.python.org/3/library/functions.html#bool "(in Python v3.12)")) – specifies whether to collect unitary gates which are Clifford gates only for certain parameters (based on their unitary matrix).
