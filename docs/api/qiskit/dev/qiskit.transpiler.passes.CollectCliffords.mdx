...
<Class id="qiskit.transpiler.passes.CollectCliffords" github="https://github.com/qiskit/qiskit/tree/main/qiskit/transpiler/passes/optimization/collect_cliffords.py" signature="qiskit.transpiler.passes.CollectCliffords(*args, **kwargs)">
