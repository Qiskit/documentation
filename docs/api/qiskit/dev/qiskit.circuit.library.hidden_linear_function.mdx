...
$$
  ...
  ![Circuit diagram output by the previous code.](/docs/images/api/qiskit/dev/qiskit-circuit-library-hidden_linear_function-1.avif)

  **Parameters**

  **adjacency\_matrix** ([*list*](https://docs.python.org/3/builtins/stdtypes.html#list)  *|*[*ndarray*](https://numpy.org/doc/stable/reference/generated/numpy.ndarray.html#numpy.ndarray)) – a symmetric n-by-n list of 0-1 lists. n will be the number of qubits.

  **Raises**

  [**CircuitError**](/docs/api/qiskit/dev/circuit#qiskit.circuit.CircuitError "qiskit.circuit.CircuitError") – If A is not symmetric.
