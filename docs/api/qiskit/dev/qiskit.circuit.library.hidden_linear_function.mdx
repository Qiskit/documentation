...
<Class id="qiskit.circuit.library.hidden_linear_function" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/main/qiskit/circuit/library/hidden_linear_function.py#L91-L161" signature="qiskit.circuit.library.hidden_linear_function(adjacency_matrix)" modifiers="class">
  Bases:
