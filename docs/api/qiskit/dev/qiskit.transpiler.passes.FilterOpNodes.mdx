...
<Class id="qiskit.transpiler.passes.FilterOpNodes" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.1/qiskit/transpiler/passes/utils/filter_op_nodes.py#L22-L65" signature="qiskit.transpiler.passes.FilterOpNodes(*args, **kwargs)">
