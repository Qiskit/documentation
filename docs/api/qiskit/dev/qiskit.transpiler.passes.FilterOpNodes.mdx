...
<Class id="qiskit.transpiler.passes.FilterOpNodes" github="https://github.com/qiskit/qiskit/tree/main/qiskit/transpiler/passes/utils/filter_op_nodes.py" signature="qiskit.transpiler.passes.FilterOpNodes(*args, **kwargs)">
