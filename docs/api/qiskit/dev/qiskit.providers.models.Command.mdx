...
<Class id="qiskit.providers.models.Command" github="https://github.com/qiskit/qiskit/tree/main/qiskit/providers/models/pulsedefaults.py" signature="qiskit.providers.models.Command(name, qubits=None, sequence=None, **kwargs)">
