...
<Class id="qiskit.circuit.library.U2Gate" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/main/qiskit/circuit/library/standard_gates/u2.py#L24-L146" signature="qiskit.circuit.library.U2Gate(phi, lam, label=None, *, duration=None, unit='dt')" modifiers="class">
