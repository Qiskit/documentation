...
<Class id="qiskit.circuit.library.U2Gate" github="https://github.com/qiskit/qiskit/tree/main/qiskit/circuit/library/standard_gates/u2.py" signature="qiskit.circuit.library.U2Gate(phi, lam, label=None, *, duration=None, unit='dt')">
