...
<Class id="qiskit.circuit.library.U1Gate" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.1/qiskit/circuit/library/standard_gates/u1.py#L24-L168" signature="qiskit.circuit.library.U1Gate(theta, label=None, *, duration=None, unit='dt')">
