...
<Class id="qiskit.circuit.library.U1Gate" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/circuit/library/standard_gates/u1.py#L24-L166" signature="qiskit.circuit.library.U1Gate(theta, label=None, *, duration=None, unit='dt')">
