...
<Class id="qiskit.transpiler.passes.SabrePreLayout" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/main/qiskit/transpiler/passes/layout/sabre_pre_layout.py#L25-L225" signature="qiskit.transpiler.passes.SabrePreLayout(*args, **kwargs)" modifiers="class">
  ...
  **`sabre_starting_layouts` (`list[Layout]`)**
  ...
  An optional list of [`Layout`](transpiler-layout "qiskit.transpiler.Layout") objects to use for additional Sabre layout trials.
  ...
  **raises TranspilerError**
  ...
  <Function id="qiskit.transpiler.passes.SabrePreLayout.run" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/transpiler/passes/layout/sabre_pre_layout.py#L97-L140" signature="run(dag)">
    ...
    **dag** ([*DAGCircuit*](dagcircuit-dag-circuit "qiskit.dagcircuit.DAGCircuit")) – DAG to create starting layout for.
  </Function>
