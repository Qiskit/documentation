...
<Class id="qiskit.synthesis.SuzukiTrotter" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/main/qiskit/synthesis/evolution/suzuki_trotter.py#L26-L145" signature="qiskit.synthesis.SuzukiTrotter(order=2, reps=1, insert_barriers=False, cx_structure='chain', atomic_evolution=None)">
...
$$
  ...
  **Raises**
  ...
  <Function id="qiskit.synthesis.SuzukiTrotter.synthesize" name="synthesize" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/synthesis/evolution/suzuki_trotter.py#L86-L125" signature="synthesize(evolution)">
