...
<Class id="qiskit.transpiler.passes.InstructionDurationCheck" github="https://github.com/qiskit/qiskit/tree/main/qiskit/transpiler/passes/scheduling/alignments/check_durations.py" signature="qiskit.transpiler.passes.InstructionDurationCheck(*args, **kwargs)">
