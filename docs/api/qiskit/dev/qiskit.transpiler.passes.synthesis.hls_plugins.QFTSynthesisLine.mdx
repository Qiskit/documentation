...
<Class id="qiskit.transpiler.passes.synthesis.hls_plugins.QFTSynthesisLine" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/main/qiskit/transpiler/passes/synthesis/hls_plugins.py#L760-L808" signature="qiskit.transpiler.passes.synthesis.hls_plugins.QFTSynthesisLine" modifiers="class">
  ...
  **References**
  ...
  <Function id="qiskit.transpiler.passes.synthesis.hls_plugins.QFTSynthesisLine.run" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/transpiler/passes/synthesis/hls_plugins.py#L792-L808" signature="run(high_level_object, coupling_map=None, target=None, qubits=None, **options)">
