...
<Class id="qiskit.synthesis.unitary.aqc.AQC" github="https://github.com/qiskit/qiskit/tree/main/qiskit/synthesis/unitary/aqc/aqc.py" signature="qiskit.synthesis.unitary.aqc.AQC(optimizer=None, seed=None)">
