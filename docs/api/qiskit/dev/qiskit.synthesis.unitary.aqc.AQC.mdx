...
<Class id="qiskit.synthesis.unitary.aqc.AQC" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/main/qiskit/synthesis/unitary/aqc/aqc.py#L77-L175" signature="qiskit.synthesis.unitary.aqc.AQC(optimizer=None, seed=None)">
  ...
  *   **seed** ([*int*](https://docs.python.org/3/library/functions.html#int "(in Python v3.12)") *| None*) – a seed value to be used by a random number generator.
  ...
  <Function id="qiskit.synthesis.unitary.aqc.AQC.compile_unitary" name="compile_unitary" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/synthesis/unitary/aqc/aqc.py#L127-L175" signature="compile_unitary(target_matrix, approximate_circuit, approximating_objective, initial_point=None)">
