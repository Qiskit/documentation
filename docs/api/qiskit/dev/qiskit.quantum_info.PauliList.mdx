...
<Class id="qiskit.quantum_info.PauliList" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/quantum_info/operators/symplectic/pauli_list.py#L33-L1230" signature="qiskit.quantum_info.PauliList(data)">
