...
<Class id="qiskit.transpiler.TranspilerError" name="TranspilerError" github="https://github.com/qiskit/qiskit/tree/main/qiskit/transpiler/exceptions.py" signature="qiskit.transpiler.TranspilerError(*message)">
...
<Class id="qiskit.transpiler.TranspilerAccessError" name="TranspilerAccessError" github="https://github.com/qiskit/qiskit/tree/main/qiskit/transpiler/exceptions.py" signature="qiskit.transpiler.TranspilerAccessError(*message)">
...
<Class id="qiskit.transpiler.CouplingError" name="CouplingError" github="https://github.com/qiskit/qiskit/tree/main/qiskit/transpiler/exceptions.py" signature="qiskit.transpiler.CouplingError(*msg)">
...
<Class id="qiskit.transpiler.LayoutError" name="LayoutError" github="https://github.com/qiskit/qiskit/tree/main/qiskit/transpiler/exceptions.py" signature="qiskit.transpiler.LayoutError(*msg)">
...
<Class id="qiskit.transpiler.CircuitTooWideForTarget" name="CircuitTooWideForTarget" github="https://github.com/qiskit/qiskit/tree/main/qiskit/transpiler/exceptions.py" signature="qiskit.transpiler.CircuitTooWideForTarget(*message)">
...
<Class id="qiskit.transpiler.InvalidLayoutError" name="InvalidLayoutError" github="https://github.com/qiskit/qiskit/tree/main/qiskit/transpiler/exceptions.py" signature="qiskit.transpiler.InvalidLayoutError(*message)">
