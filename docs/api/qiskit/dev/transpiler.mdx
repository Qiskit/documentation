...
![The transpilation process takes the input circuit, applies the transpilation       passes, then produces the output circuit.](/images/api/qiskit/dev/transpiling_core_steps.png)
...
![Circuit diagram output by the previous code.](/images/api/qiskit/dev/transpiler-8.png)
...
![Circuit diagram output by the previous code.](/images/api/qiskit/dev/transpiler-9.png)
...
2.  A Toffoli, or controlled-controlled-not gate (`ccx`), is a three-qubit gate. Given that our basis gate set includes only single- and two-qubit gates, it is obvious that this gate must be decomposed. This decomposition is quite costly:
    ...
    ![Circuit diagram output by the previous code.](/images/api/qiskit/dev/transpiler-12.png)
...
![Diagram illustrating how virtual qubits are mapped to physical qubits.](/images/api/qiskit/dev/mapping.png)
...
![Circuit diagram output by the previous code.](/images/api/qiskit/dev/transpiler-13.png)
...
*   **Layout Using Optimization Level 0**
    ...
    > ```
    >
    > ![Output from the previous code.](/images/api/qiskit/dev/transpiler-14.png)
...
*   **Layout Using Optimization Level 3**
    ...
    > ```
    >
    > ![Output from the previous code.](/images/api/qiskit/dev/transpiler-15.png)
...
![Output from the previous code.](/images/api/qiskit/dev/transpiler-16.png)
...
![Diagram illustrating the previously described circuit.](/images/api/qiskit/dev/transpiler-17.png)
...
![Output from the previous code.](/images/api/qiskit/dev/transpiler-18.png)
...
![Diagram illustrating the previously described circuit.](/images/api/qiskit/dev/transpiler-19.png)
...
![Output from the previous code.](/images/api/qiskit/dev/transpiler-20.png)
...
![Diagram illustrating the previously described circuit.](/images/api/qiskit/dev/transpiler-21.png)
...
![Circuit diagram output by the previous code.](/images/api/qiskit/dev/transpiler-22.png)
...
![Output from circuit timeline drawer.](/images/api/qiskit/dev/transpiler-23.png)
