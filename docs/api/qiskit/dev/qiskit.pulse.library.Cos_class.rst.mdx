...
<Function id="qiskit.pulse.library.Cos" name="Cos" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/main/qiskit/pulse/library/symbolic_pulses.py" signature="qiskit.pulse.library.Cos(duration, amp, phase, freq=None, angle=0.0, name=None, limit_amplitude=None)">
  A cosine pulse.
