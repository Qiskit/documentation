...
<Class id="qiskit.circuit.library.SXdgGate" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/main/qiskit/circuit/library/standard_gates/sx.py#L139-L204" signature="qiskit.circuit.library.SXdgGate(*args, _force_mutable=False, **kwargs)" modifiers="class">
