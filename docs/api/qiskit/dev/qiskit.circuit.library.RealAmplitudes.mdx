...
<Class id="qiskit.circuit.library.RealAmplitudes" github="https://github.com/qiskit/qiskit/tree/main/qiskit/circuit/library/n_local/real_amplitudes.py" signature="qiskit.circuit.library.RealAmplitudes(num_qubits=None, entanglement='reverse_linear', reps=3, skip_unentangled_qubits=False, skip_final_rotation_layer=False, parameter_prefix='θ', insert_barriers=False, initial_state=None, name='RealAmplitudes', flatten=None)">
  ...
  *   **flatten** ([*bool*](https://docs.python.org/3/library/functions.html#bool "(in Python v3.12)") *| None*) – Set this to `True` to output a flat circuit instead of nesting it inside multiple layers of gate objects. By default currently the contents of the output circuit will be wrapped in nested objects for cleaner visualization. However, if you’re using this circuit for anything besides visualization its **strongly** recommended to set this flag to `True` to avoid a large performance overhead for parameter binding.
  ...
  <Attribute id="qiskit.circuit.library.RealAmplitudes.ancillas" name="ancillas">
    Returns a list of ancilla bits in the order that the registers were added.
  </Attribute>

  ### calibrations

  <Attribute id="qiskit.circuit.library.RealAmplitudes.calibrations" name="calibrations">
  ...
  <Attribute id="qiskit.circuit.library.RealAmplitudes.clbits" name="clbits">
    Returns a list of classical bits in the order that the registers were added.
  </Attribute>

  ### data

  <Attribute id="qiskit.circuit.library.RealAmplitudes.data" name="data" />

  ### entanglement

  <Attribute id="qiskit.circuit.library.RealAmplitudes.entanglement" name="entanglement">
  ...
  <Attribute id="qiskit.circuit.library.RealAmplitudes.entanglement_blocks" name="entanglement_blocks">
  ...
  <Attribute id="qiskit.circuit.library.RealAmplitudes.flatten" name="flatten">
    Returns whether the circuit is wrapped in nested gates/instructions or flattened.
  </Attribute>

  ### global\_phase

  <Attribute id="qiskit.circuit.library.RealAmplitudes.global_phase" name="global_phase">
    Return the global phase of the current circuit scope in radians.
  </Attribute>

  ### initial\_state

  <Attribute id="qiskit.circuit.library.RealAmplitudes.initial_state" name="initial_state">
  ...
  <Attribute id="qiskit.circuit.library.RealAmplitudes.insert_barriers" name="insert_barriers">
  ...
  <Attribute id="qiskit.circuit.library.RealAmplitudes.instances" name="instances" attributeValue="= 412" />

  ### layout

  <Attribute id="qiskit.circuit.library.RealAmplitudes.layout" name="layout">
  ...
  <Attribute id="qiskit.circuit.library.RealAmplitudes.metadata" name="metadata">
  ...
  <Attribute id="qiskit.circuit.library.RealAmplitudes.num_ancillas" name="num_ancillas">
    Return the number of ancilla qubits.
  </Attribute>

  ### num\_captured\_vars

  <Attribute id="qiskit.circuit.library.RealAmplitudes.num_captured_vars" name="num_captured_vars">
  ...
  <Attribute id="qiskit.circuit.library.RealAmplitudes.num_clbits" name="num_clbits">
    Return number of classical bits.
  </Attribute>

  ### num\_declared\_vars

  <Attribute id="qiskit.circuit.library.RealAmplitudes.num_declared_vars" name="num_declared_vars">
  ...
  <Attribute id="qiskit.circuit.library.RealAmplitudes.num_input_vars" name="num_input_vars">
  ...
  <Attribute id="qiskit.circuit.library.RealAmplitudes.num_layers" name="num_layers">
  ...
  <Attribute id="qiskit.circuit.library.RealAmplitudes.num_parameters" name="num_parameters" />

  ### num\_parameters\_settable

  <Attribute id="qiskit.circuit.library.RealAmplitudes.num_parameters_settable" name="num_parameters_settable">
  ...
  <Attribute id="qiskit.circuit.library.RealAmplitudes.num_qubits" name="num_qubits">
  ...
  <Attribute id="qiskit.circuit.library.RealAmplitudes.num_vars" name="num_vars">
  ...
  <Attribute id="qiskit.circuit.library.RealAmplitudes.op_start_times" name="op_start_times">
  ...
  <Attribute id="qiskit.circuit.library.RealAmplitudes.ordered_parameters" name="ordered_parameters">
  ...
  <Attribute id="qiskit.circuit.library.RealAmplitudes.parameter_bounds" name="parameter_bounds">
  ...
  <Attribute id="qiskit.circuit.library.RealAmplitudes.parameters" name="parameters" />

  ### preferred\_init\_points

  <Attribute id="qiskit.circuit.library.RealAmplitudes.preferred_init_points" name="preferred_init_points">
  ...
  <Attribute id="qiskit.circuit.library.RealAmplitudes.prefix" name="prefix" attributeValue="= 'circuit'" />

  ### qregs

  <Attribute id="qiskit.circuit.library.RealAmplitudes.qregs" name="qregs" attributeTypeHint="list[QuantumRegister]">
    A list of the quantum registers associated with the circuit.
  </Attribute>

  ### qubits

  <Attribute id="qiskit.circuit.library.RealAmplitudes.qubits" name="qubits">
    Returns a list of quantum bits in the order that the registers were added.
  </Attribute>

  ### reps

  <Attribute id="qiskit.circuit.library.RealAmplitudes.reps" name="reps">
  ...
  <Attribute id="qiskit.circuit.library.RealAmplitudes.rotation_blocks" name="rotation_blocks">
