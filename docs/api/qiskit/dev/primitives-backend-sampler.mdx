...
<Class id="qiskit.primitives.BackendSampler" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/main/qiskit/primitives/backend_sampler.py#L34-L222" signature="qiskit.primitives.BackendSampler(backend, options=None, bound_pass_manager=None, skip_transpilation=False)" modifiers="class">
  ...
  A [`BaseSampler`](primitives-base-sampler "qiskit.primitives.BaseSampler") (V1) implementation that provides a wrapper for leveraging the Sampler V1 interface from any backend.

  This class provides a sampler interface from any backend and doesn’t do any measurement mitigation, it just computes the probability distribution from the counts. It facilitates using backends that do not provide a native [`BaseSampler`](primitives-base-sampler "qiskit.primitives.BaseSampler") V1 implementation in places that work with [`BaseSampler`](primitives-base-sampler "qiskit.primitives.BaseSampler") V1. However, if you’re using a provider that has a native implementation of [`BaseSamplerV1`](primitives-base-sampler-v-1 "qiskit.primitives.BaseSamplerV1") ( [`BaseSampler`](primitives-base-sampler "qiskit.primitives.BaseSampler")) or `BaseESamplerV2`, it is a better choice to leverage that native implementation as it will likely include additional optimizations and be a more efficient implementation. The generic nature of this class precludes doing any provider- or backend-specific optimizations.
  ...
  *   **backend** ([*BackendV1*](providers-backend-v-1 "qiskit.providers.BackendV1")  *|*[*BackendV2*](providers-backend-v-2 "qiskit.providers.BackendV2")) – (required) the backend to run the sampler primitive on
