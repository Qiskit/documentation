...
<Class id="qiskit.providers.Backend" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/2.2/qiskit/providers/backend.py#L27-L36" signature="qiskit.providers.Backend" modifiers="class">
