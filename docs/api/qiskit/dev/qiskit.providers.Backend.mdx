...
<Class id="qiskit.providers.Backend" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/2.0/qiskit/providers/backend.py#L26-L35" signature="qiskit.providers.Backend" modifiers="class">
