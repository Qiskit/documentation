...
<Class id="qiskit.providers.Backend" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/main/qiskit/providers/backend.py#L30-L39" signature="qiskit.providers.Backend" modifiers="class">
