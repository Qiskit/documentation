...
![Output from the previous code.](/images/api/qiskit/dev/visualization-1.png)
...
![Output from the previous code.](/images/api/qiskit/dev/visualization-2.png)
...
![Output from the previous code.](/images/api/qiskit/dev/visualization-3.png)
...
![Output from the previous code.](/images/api/qiskit/dev/visualization-4.png)
...
![Output from the previous code.](/images/api/qiskit/dev/visualization-5.png)
...
![Output from the previous code.](/images/api/qiskit/dev/visualization-6.png)
