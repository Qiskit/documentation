...
<Class id="qiskit.visualization.VisualizationError" name="VisualizationError" github="https://github.com/qiskit/qiskit/tree/main/qiskit/visualization/exceptions.py" signature="qiskit.visualization.VisualizationError(*message)">
