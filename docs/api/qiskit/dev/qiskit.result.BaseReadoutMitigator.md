...
`qiskit.result.BaseReadoutMitigator` [GitHub](https://github.com/qiskit/qiskit/tree/main/qiskit/result/mitigation/base_readout_mitigator.py "view source code")
