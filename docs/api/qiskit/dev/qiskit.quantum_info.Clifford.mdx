...
<Class id="qiskit.quantum_info.Clifford" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/quantum_info/operators/symplectic/clifford.py#L39-L1000" signature="qiskit.quantum_info.Clifford(data, validate=True, copy=True)">
