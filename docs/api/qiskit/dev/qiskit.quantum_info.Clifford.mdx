...
<Class id="qiskit.quantum_info.Clifford" github="https://github.com/qiskit/qiskit/tree/main/qiskit/quantum_info/operators/symplectic/clifford.py" signature="qiskit.quantum_info.Clifford(data, validate=True, copy=True)">
