...
<Class id="qiskit.pulse.instructions.Delay" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.1/qiskit/pulse/instructions/delay.py#L21-L69" signature="qiskit.pulse.instructions.Delay(duration, channel, name=None)">
