---
title: CircuitInstruction (dev version)
description: API reference for qiskit.circuit.CircuitInstruction in the dev version of qiskit
...
<Class id="qiskit.circuit.CircuitInstruction" isDedicatedPage={true} signature="qiskit.circuit.CircuitInstruction(operation, qubits=None, clbits=None)" modifiers="class">
  ...
  A single instruction in a [`QuantumCircuit`](/docs/api/qiskit/dev/qiskit.circuit.QuantumCircuit "qiskit.circuit.QuantumCircuit"), comprised of the [`operation`](#qiskit.circuit.CircuitInstruction.operation "qiskit.circuit.CircuitInstruction.operation") and various operands.
