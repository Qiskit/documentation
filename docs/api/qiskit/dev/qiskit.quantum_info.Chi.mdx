...
<Class id="qiskit.quantum_info.Chi" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.1/qiskit/quantum_info/operators/channel/chi.py#L35-L187" signature="qiskit.quantum_info.Chi(data, input_dims=None, output_dims=None)">
