...
<Class id="qiskit.quantum_info.Chi" github="https://github.com/qiskit/qiskit/tree/main/qiskit/quantum_info/operators/channel/chi.py" signature="qiskit.quantum_info.Chi(data, input_dims=None, output_dims=None)">
