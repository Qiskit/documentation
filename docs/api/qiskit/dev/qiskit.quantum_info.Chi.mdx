...
<Class id="qiskit.quantum_info.Chi" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/quantum_info/operators/channel/chi.py#L34-L187" signature="qiskit.quantum_info.Chi(data, input_dims=None, output_dims=None)">
