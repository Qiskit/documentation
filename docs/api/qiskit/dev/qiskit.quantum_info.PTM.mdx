...
<Class id="qiskit.quantum_info.PTM" github="https://github.com/qiskit/qiskit/tree/main/qiskit/quantum_info/operators/channel/ptm.py" signature="qiskit.quantum_info.PTM(data, input_dims=None, output_dims=None)">
