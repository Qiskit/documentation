...
<Class id="qiskit.transpiler.passes.RemoveFinalMeasurements" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.1/qiskit/transpiler/passes/utils/remove_final_measurements.py#L19-L114" signature="qiskit.transpiler.passes.RemoveFinalMeasurements(*args, **kwargs)">
