...
<Class id="qiskit.transpiler.passes.RemoveFinalMeasurements" github="https://github.com/qiskit/qiskit/tree/main/qiskit/transpiler/passes/utils/remove_final_measurements.py" signature="qiskit.transpiler.passes.RemoveFinalMeasurements(*args, **kwargs)">
