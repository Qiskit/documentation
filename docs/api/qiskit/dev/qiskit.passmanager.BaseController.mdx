...
<Class id="qiskit.passmanager.BaseController" github="https://github.com/qiskit/qiskit/tree/main/qiskit/passmanager/base_tasks.py" signature="qiskit.passmanager.BaseController(options=None)">
