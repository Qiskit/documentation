...
<Class id="qiskit.circuit.Parameter" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/circuit/parameter.py#L27-L175" signature="qiskit.circuit.Parameter(name, *, uuid=None)">
