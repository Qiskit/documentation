...
<Class id="qiskit.circuit.Parameter" github="https://github.com/qiskit/qiskit/tree/main/qiskit/circuit/parameter.py" signature="qiskit.circuit.Parameter(name, *, uuid=None)">
