...
<Class id="qiskit.circuit.Parameter" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.1/qiskit/circuit/parameter.py#L27-L175" signature="qiskit.circuit.Parameter(name, *, uuid=None)">
