...
`qiskit.quantum_info.ScalarOp(dims=None, coeff=1)` [GitHub](https://github.com/qiskit/qiskit/tree/main/qiskit/quantum_info/operators/scalar_op.py "view source code")
