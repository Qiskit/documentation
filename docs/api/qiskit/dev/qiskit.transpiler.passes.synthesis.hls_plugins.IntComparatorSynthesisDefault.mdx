---
title: IntComparatorSynthesisDefault (dev version)
description: API reference for qiskit.transpiler.passes.synthesis.hls_plugins.IntComparatorSynthesisDefault in the dev version of qiskit
