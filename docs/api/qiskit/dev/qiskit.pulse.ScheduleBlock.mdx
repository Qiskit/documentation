...
<Class id="qiskit.pulse.ScheduleBlock" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/pulse/schedule.py#L825-L1621" signature="qiskit.pulse.ScheduleBlock(name=None, metadata=None, alignment_context=None)">
