...
<Class id="qiskit.pulse.ScheduleBlock" github="https://github.com/qiskit/qiskit/tree/main/qiskit/pulse/schedule.py" signature="qiskit.pulse.ScheduleBlock(name=None, metadata=None, alignment_context=None)">
