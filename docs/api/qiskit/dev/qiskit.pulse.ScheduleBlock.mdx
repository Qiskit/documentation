...
<Class id="qiskit.pulse.ScheduleBlock" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.1/qiskit/pulse/schedule.py#L827-L1624" signature="qiskit.pulse.ScheduleBlock(name=None, metadata=None, alignment_context=None)">
  ...
  **Raises**
  ...
  <Function id="qiskit.pulse.ScheduleBlock.initialize_from" github="https://github.com/Qiskit/qiskit/tree/stable/1.1/qiskit/pulse/schedule.py#L1044-L1076" signature="classmethod initialize_from(other_program, name=None)">
