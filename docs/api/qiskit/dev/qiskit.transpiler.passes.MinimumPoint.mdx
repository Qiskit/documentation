...
`qiskit.transpiler.passes.MinimumPoint(*args, **kwargs)` [GitHub](https://github.com/qiskit/qiskit/tree/main/qiskit/transpiler/passes/utils/minimum_point.py "view source code")
