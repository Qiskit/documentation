...
<Class id="qiskit.primitives.BaseEstimatorV2" github="https://github.com/qiskit/qiskit/tree/main/qiskit/primitives/base/base_estimator.py" signature="qiskit.primitives.BaseEstimatorV2">
