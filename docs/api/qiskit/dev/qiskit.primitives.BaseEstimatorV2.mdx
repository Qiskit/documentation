...
<Class id="qiskit.primitives.BaseEstimatorV2" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/primitives/base/base_estimator.py#L196-L230" signature="qiskit.primitives.BaseEstimatorV2">
