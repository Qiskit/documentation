...
<Class id="qiskit.primitives.BaseEstimatorV2" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/main/qiskit/primitives/base/base_estimator.py#L220-L252" signature="qiskit.primitives.BaseEstimatorV2" modifiers="class">
  ...
  <Function id="qiskit.primitives.BaseEstimatorV2.run" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/primitives/base/base_estimator.py#L237-L252" signature="run(pubs, *, precision=None)" modifiers="abstract">
