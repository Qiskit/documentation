...
<Class id="qiskit.circuit.Delay" github="https://github.com/qiskit/qiskit/tree/main/qiskit/circuit/delay.py" signature="qiskit.circuit.Delay(duration, unit='dt')">
  ...
  <Attribute id="qiskit.circuit.Delay.base_class" name="base_class">
  ...
  <Attribute id="qiskit.circuit.Delay.condition" name="condition">
  ...
  <Attribute id="qiskit.circuit.Delay.mutable" name="mutable">
