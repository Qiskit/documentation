...
`qiskit.circuit.library.HRSCumulativeMultiplier(num_state_qubits, num_result_qubits=None, adder=None, name='HRSCumulativeMultiplier')` [GitHub](https://github.com/qiskit/qiskit/tree/main/qiskit/circuit/library/arithmetic/multipliers/hrs_cumulative_multiplier.py "view source code")
...
<span id="qiskit.circuit.library.HRSCumulativeMultiplier.num_captured_vars" />
...
<span id="qiskit.circuit.library.HRSCumulativeMultiplier.num_declared_vars" />
...
<span id="qiskit.circuit.library.HRSCumulativeMultiplier.num_input_vars" />
...
<span id="qiskit.circuit.library.HRSCumulativeMultiplier.num_vars" />
