...
<Class id="qiskit.transpiler.passes.synthesis.hls_plugins.MCMTSynthesisXGate" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/main/qiskit/transpiler/passes/synthesis/hls_plugins.py#L1536-L1549" signature="qiskit.transpiler.passes.synthesis.hls_plugins.MCMTSynthesisXGate" modifiers="class">
  ...
  <Function id="qiskit.transpiler.passes.synthesis.hls_plugins.MCMTSynthesisXGate.run" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/transpiler/passes/synthesis/hls_plugins.py#L1539-L1549" signature="run(high_level_object, coupling_map=None, target=None, qubits=None, **options)">
