...
<Class id="qiskit.circuit.library.fourier_checking" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.3/qiskit/circuit/library/fourier_checking.py#L103-L158" signature="qiskit.circuit.library.fourier_checking(f, g)" modifiers="class">
  Bases:
