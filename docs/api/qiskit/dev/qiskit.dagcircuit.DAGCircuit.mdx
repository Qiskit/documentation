...
<Class id="qiskit.dagcircuit.DAGCircuit" isDedicatedPage={true} signature="qiskit.dagcircuit.DAGCircuit" modifiers="class">
  ...
  <Function id="qiskit.dagcircuit.DAGCircuit.apply_operation_back" signature="apply_operation_back(op, qargs=None, cargs=None, *, check=True)">
    ...
    *   **qargs** ([*tuple*](https://docs.python.org/3/library/stdtypes.html#tuple)*\[*[*Qubit*](/docs/api/qiskit/dev/circuit#qiskit.circuit.Qubit "qiskit.circuit.Qubit")*]*) – qubits that op will be applied to
    *   **cargs** ([*tuple*](https://docs.python.org/3/library/stdtypes.html#tuple)*\[*[*Clbit*](/docs/api/qiskit/dev/circuit#qiskit.circuit.Clbit "qiskit.circuit.Clbit")*]*) – cbits that op will be applied to
  ...
  <Function id="qiskit.dagcircuit.DAGCircuit.compose" signature="compose(other, qubits=None, clbits=None, front=False, inplace=True, *, inline_captures=False)">
    ...
    *   **qubits** ([*list*](https://docs.python.org/3/library/stdtypes.html#list)*\[*[*Qubit*](/docs/api/qiskit/dev/circuit#qiskit.circuit.Qubit "qiskit.circuit.Qubit")*|*[*int*](https://docs.python.org/3/library/functions.html#int)*]*) – qubits of self to compose onto.
    *   **clbits** ([*list*](https://docs.python.org/3/library/stdtypes.html#list)*\[*[*Clbit*](/docs/api/qiskit/dev/circuit#qiskit.circuit.Clbit "qiskit.circuit.Clbit")*|*[*int*](https://docs.python.org/3/library/functions.html#int)*]*) – clbits of self to compose onto.
  ...
  <Function id="qiskit.dagcircuit.DAGCircuit.control_flow_op_nodes" signature="control_flow_op_nodes()">
    ...
    **Return type**
    ...
    [list](https://docs.python.org/3/library/stdtypes.html#list)\[[DAGOpNode](qiskit.dagcircuit.DAGOpNode "qiskit.dagcircuit.DAGOpNode")]
  </Function>
