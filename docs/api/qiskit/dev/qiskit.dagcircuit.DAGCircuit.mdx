...
description: API reference for qiskit.dagcircuit.DAGCircuit in the dev version of qiskit
...
<Class id="qiskit.dagcircuit.DAGCircuit" isDedicatedPage={true} signature="qiskit.dagcircuit.DAGCircuit" modifiers="class">
  ...
  <Attribute id="qiskit.dagcircuit.DAGCircuit.clbits">
    Returns the current sequence of registered [`Clbit`](/docs/api/qiskit/dev/circuit#qiskit.circuit.Clbit "qiskit.circuit.Clbit") instances as a list.
    ...
    **Return type**
    ...
    list([`Clbit`](/docs/api/qiskit/dev/circuit#qiskit.circuit.Clbit "qiskit.circuit.Clbit"))
  </Attribute>
  ...
  <Attribute id="qiskit.dagcircuit.DAGCircuit.num_captured_stretches">
  ...
  <Attribute id="qiskit.dagcircuit.DAGCircuit.num_declared_stretches">
  ...
  <Attribute id="qiskit.dagcircuit.DAGCircuit.num_stretches">
  ...
  <Attribute id="qiskit.dagcircuit.DAGCircuit.qubits">
    Returns the current sequence of registered [`Qubit`](/docs/api/qiskit/dev/circuit#qiskit.circuit.Qubit "qiskit.circuit.Qubit") instances as a list.
    ...
    **Return type**
    ...
    list([`Qubit`](/docs/api/qiskit/dev/circuit#qiskit.circuit.Qubit "qiskit.circuit.Qubit"))
  </Attribute>
  ...
  <Function id="qiskit.dagcircuit.DAGCircuit.add_captured_stretch" signature="add_captured_stretch(stretch)">
  ...
  <Function id="qiskit.dagcircuit.DAGCircuit.add_declared_stretch" signature="add_declared_stretch(stretch)">
  ...
  <Function id="qiskit.dagcircuit.DAGCircuit.ancestors" signature="ancestors(node)">
    Returns set of the ancestors of a node as [`DAGOpNode`](qiskit.dagcircuit.DAGOpNode "qiskit.dagcircuit.DAGOpNode")s and [`DAGInNode`](qiskit.dagcircuit.DAGInNode "qiskit.dagcircuit.DAGInNode")s.
  ...
  <Function id="qiskit.dagcircuit.DAGCircuit.apply_operation_back" signature="apply_operation_back(op, qargs=None, cargs=None, *, check=True)">
    ...
    *   **qargs** ([*tuple*](https://docs.python.org/3/builtins/stdtypes.html#tuple)*\[*[*Qubit*](/docs/api/qiskit/dev/circuit#qiskit.circuit.Qubit "qiskit.circuit.Qubit")*]*) – qubits that op will be applied to
    *   **cargs** ([*tuple*](https://docs.python.org/3/builtins/stdtypes.html#tuple)*\[*[*Clbit*](/docs/api/qiskit/dev/circuit#qiskit.circuit.Clbit "qiskit.circuit.Clbit")*]*) – cbits that op will be applied to
    *   **check** ([*bool*](https://docs.python.org/3/builtins/functions.html#bool)) – If `True` (default), this function will enforce that the [`DAGCircuit`](#qiskit.dagcircuit.DAGCircuit "qiskit.dagcircuit.DAGCircuit") data-structure invariants are maintained (all `qargs` are [`Qubit`](/docs/api/qiskit/dev/circuit#qiskit.circuit.Qubit "qiskit.circuit.Qubit")\ s, all are in the DAG, etc). If `False`, the caller *must* uphold these invariants itself, but the cost of several checks will be skipped. This is most useful when building a new DAG from a source of known-good nodes.
    ...
    **Raises**
    ...
    [**DAGCircuitError**](/docs/api/qiskit/dev/dagcircuit#qiskit.dagcircuit.DAGCircuitError "qiskit.dagcircuit.DAGCircuitError") – if a leaf node is connected to multiple outputs
  </Function>
  ...
  <Function id="qiskit.dagcircuit.DAGCircuit.apply_operation_front" signature="apply_operation_front(op, qargs=None, cargs=None, *, check=True)">
    ...
    **Raises**
    ...
    [**DAGCircuitError**](/docs/api/qiskit/dev/dagcircuit#qiskit.dagcircuit.DAGCircuitError "qiskit.dagcircuit.DAGCircuitError") – if initial nodes connected to multiple out edges
  </Function>
  ...
  <Function id="qiskit.dagcircuit.DAGCircuit.compose" signature="compose(other, qubits=None, clbits=None, front=False, inplace=True, *, inline_captures=False)">
    ...
    *   **qubits** ([*list*](https://docs.python.org/3/builtins/stdtypes.html#list)*\[*[*Qubit*](/docs/api/qiskit/dev/circuit#qiskit.circuit.Qubit "qiskit.circuit.Qubit")*|*[*int*](https://docs.python.org/3/builtins/functions.html#int)*]*) – qubits of self to compose onto.
    *   **clbits** ([*list*](https://docs.python.org/3/builtins/stdtypes.html#list)*\[*[*Clbit*](/docs/api/qiskit/dev/circuit#qiskit.circuit.Clbit "qiskit.circuit.Clbit")*|*[*int*](https://docs.python.org/3/builtins/functions.html#int)*]*) – clbits of self to compose onto.
    *   **front** ([*bool*](https://docs.python.org/3/builtins/functions.html#bool)) – If True, front composition will be performed (not implemented yet)
    ...
    *   **inline\_captures** ([*bool*](https://docs.python.org/3/builtins/functions.html#bool)) – If `True`, variables marked as “captures” in the `other` DAG will be inlined onto existing uses of those same variables in `self`. If `False`, all variables in `other` are required to be distinct from `self`, and they will be added to `self`.
    ...
    **Raises**
    ...
    [**DAGCircuitError**](/docs/api/qiskit/dev/dagcircuit#qiskit.dagcircuit.DAGCircuitError "qiskit.dagcircuit.DAGCircuitError") – if `other` is wider or there are duplicate edge mappings.
  </Function>
  ...
  <Function id="qiskit.dagcircuit.DAGCircuit.control_flow_op_nodes" signature="control_flow_op_nodes()">
    ...
    **Return type**
    ...
    [list](https://docs.python.org/3/builtins/stdtypes.html#list)\[[DAGOpNode](qiskit.dagcircuit.DAGOpNode "qiskit.dagcircuit.DAGOpNode")]
  </Function>

  ### copy\_empty\_like

  <Function id="qiskit.dagcircuit.DAGCircuit.copy_empty_like" signature="copy_empty_like(*, vars_mode=Ellipsis)">
  ...
  <Function id="qiskit.dagcircuit.DAGCircuit.count_ops" signature="count_ops(*, recurse=True)">
    ...
    **Return type**
    ...
    Mapping\[[str](https://docs.python.org/3/builtins/stdtypes.html#str), [int](https://docs.python.org/3/builtins/functions.html#int)]
  </Function>
  ...
  <Function id="qiskit.dagcircuit.DAGCircuit.depth" signature="depth(*, recurse=False)">
    ...
    *   [**DAGCircuitError**](/docs/api/qiskit/dev/dagcircuit#qiskit.dagcircuit.DAGCircuitError "qiskit.dagcircuit.DAGCircuitError") – if not a directed acyclic graph
    *   [**DAGCircuitError**](/docs/api/qiskit/dev/dagcircuit#qiskit.dagcircuit.DAGCircuitError "qiskit.dagcircuit.DAGCircuitError") – if unknown control flow is present in a recursive call, or any control flow is present in a non-recursive call.
  </Function>

  ### descendants

  <Function id="qiskit.dagcircuit.DAGCircuit.descendants" signature="descendants(node)">
    Returns set of the descendants of a node as [`DAGOpNode`](qiskit.dagcircuit.DAGOpNode "qiskit.dagcircuit.DAGOpNode")s and [`DAGOutNode`](qiskit.dagcircuit.DAGOutNode "qiskit.dagcircuit.DAGOutNode")s.
  ...
  <Function id="qiskit.dagcircuit.DAGCircuit.draw" signature="draw(scale=0.7, filename=None, style='color')">
    ...
    *   **scale** ([*float*](https://docs.python.org/3/builtins/functions.html#float)) – scaling factor
    *   **filename** ([*str*](https://docs.python.org/3/builtins/stdtypes.html#str)) – file path to save image to (format inferred from name)
    *   **style** ([*str*](https://docs.python.org/3/builtins/stdtypes.html#str)) – ‘plain’: B\&W graph; ‘color’ (default): color input/output/op nodes
  ...
  <Function id="qiskit.dagcircuit.DAGCircuit.find_bit" signature="find_bit(bit)">
    ...
    **bit** ([*Bit*](/docs/api/qiskit/dev/circuit#qiskit.circuit.Bit "qiskit.circuit.Bit")) – The bit to locate.
  ...
  <Function id="qiskit.dagcircuit.DAGCircuit.has_stretch" signature="has_stretch(stretch)">
  ...
  <Function id="qiskit.dagcircuit.DAGCircuit.idle_wires" signature="idle_wires(ignore=None)">
    ...
    **ignore** ([*list*](https://docs.python.org/3/builtins/stdtypes.html#list)*(*[*str*](https://docs.python.org/3/builtins/stdtypes.html#str)*)*) – List of node names to ignore. Default: \[]
    ...
    **Raises**
    ...
    [**DAGCircuitError**](/docs/api/qiskit/dev/dagcircuit#qiskit.dagcircuit.DAGCircuitError "qiskit.dagcircuit.DAGCircuitError") – If the DAG is invalid
  </Function>

  ### is\_empty

  <Function id="qiskit.dagcircuit.DAGCircuit.is_empty" signature="is_empty()">
  ...
  <Function id="qiskit.dagcircuit.DAGCircuit.layers" signature="layers(*, vars_mode=Ellipsis)">
  ...
  <Function id="qiskit.dagcircuit.DAGCircuit.make_physical" signature="make_physical(num_qubits=None)">
  ...
  <Function id="qiskit.dagcircuit.DAGCircuit.node" signature="node(node_id)">
    ...
    **node\_id** ([*int*](https://docs.python.org/3/builtins/functions.html#int)) – Node identifier.
  ...
  <Function id="qiskit.dagcircuit.DAGCircuit.nodes_on_wire" signature="nodes_on_wire(wire, only_ops=False)">
    ...
    *   **wire** ([*Bit*](/docs/api/qiskit/dev/circuit#qiskit.circuit.Bit "qiskit.circuit.Bit")) – the wire to be looked at.
    *   **only\_ops** ([*bool*](https://docs.python.org/3/builtins/functions.html#bool)) – True if only the ops nodes are wanted; otherwise, all nodes are returned.
    ...
    **Raises**
    ...
    [**DAGCircuitError**](/docs/api/qiskit/dev/dagcircuit#qiskit.dagcircuit.DAGCircuitError "qiskit.dagcircuit.DAGCircuitError") – if the given wire doesn’t exist in the DAG
  </Function>

  ### num\_blocks

  <Function id="qiskit.dagcircuit.DAGCircuit.num_blocks" signature="num_blocks()">
  ...
  <Function id="qiskit.dagcircuit.DAGCircuit.num_ops" signature="num_ops()">
  ...
  <Function id="qiskit.dagcircuit.DAGCircuit.op_nodes" signature="op_nodes(op=None, include_directives=True)">
    ...
    *   **op** ([*Type*](/docs/api/qiskit/dev/circuit_classical#qiskit.circuit.classical.types.Type "qiskit.circuit.classical.types.Type") *| Iterable\[*[*Type*](/docs/api/qiskit/dev/circuit_classical#qiskit.circuit.classical.types.Type "qiskit.circuit.classical.types.Type")*]*) – [`qiskit.circuit.Operation`](qiskit.circuit.Operation "qiskit.circuit.Operation") subclass (or iterable of subclasses) of op nodes to return. If None, return all op nodes.
    *   **include\_directives** ([*bool*](https://docs.python.org/3/builtins/functions.html#bool)) – include barrier, snapshot etc.
  ...
  <Function id="qiskit.dagcircuit.DAGCircuit.predecessors" signature="predecessors(node)">
    Returns iterator of the predecessors of a node as [`DAGOpNode`](qiskit.dagcircuit.DAGOpNode "qiskit.dagcircuit.DAGOpNode")s and [`DAGInNode`](qiskit.dagcircuit.DAGInNode "qiskit.dagcircuit.DAGInNode")s.
  </Function>
  ...
  <Function id="qiskit.dagcircuit.DAGCircuit.quantum_causal_cone" signature="quantum_causal_cone(qubit)">
    ...
    **qubit** ([*Qubit*](/docs/api/qiskit/dev/circuit#qiskit.circuit.Qubit "qiskit.circuit.Qubit")) – The output qubit for which we want to find the causal cone.
    ...
    **Return type**
    ...
    Set\[[*Qubit*](/docs/api/qiskit/dev/circuit#qiskit.circuit.Qubit "qiskit.circuit.Qubit")]
  </Function>
  ...
  <Function id="qiskit.dagcircuit.DAGCircuit.remove_clbits" signature="remove_clbits(*clbits)">
    ...
    **clbits** (*List\[*[*Clbit*](/docs/api/qiskit/dev/circuit#qiskit.circuit.Clbit "qiskit.circuit.Clbit")*]*) – The bits to remove.

    **Raises**

    [**DAGCircuitError**](/docs/api/qiskit/dev/dagcircuit#qiskit.dagcircuit.DAGCircuitError "qiskit.dagcircuit.DAGCircuitError") – a clbit is not a [`Clbit`](/docs/api/qiskit/dev/circuit#qiskit.circuit.Clbit "qiskit.circuit.Clbit"), is not in the circuit, or is not idle.
  </Function>
  ...
  <Function id="qiskit.dagcircuit.DAGCircuit.remove_cregs" signature="remove_cregs(*cregs)">
    ...
    *   [**DAGCircuitError**](/docs/api/qiskit/dev/dagcircuit#qiskit.dagcircuit.DAGCircuitError "qiskit.dagcircuit.DAGCircuitError") – a creg is not a ClassicalRegister, or is not in
    *   **the circuit.** –
  </Function>
  ...
  <Function id="qiskit.dagcircuit.DAGCircuit.remove_qregs" signature="remove_qregs(*qregs)">
    ...
    *   [**DAGCircuitError**](/docs/api/qiskit/dev/dagcircuit#qiskit.dagcircuit.DAGCircuitError "qiskit.dagcircuit.DAGCircuitError") – a qreg is not a QuantumRegister, or is not in
    *   **the circuit.** –
  </Function>
  ...
  <Function id="qiskit.dagcircuit.DAGCircuit.remove_qubits" signature="remove_qubits(*qubits)">
    ...
    **qubits** (*List\[*[*Qubit*](/docs/api/qiskit/dev/circuit#qiskit.circuit.Qubit "qiskit.circuit.Qubit")*]*) – The bits to remove.

    **Raises**

    [**DAGCircuitError**](/docs/api/qiskit/dev/dagcircuit#qiskit.dagcircuit.DAGCircuitError "qiskit.dagcircuit.DAGCircuitError") – a qubit is not a [`Qubit`](/docs/api/qiskit/dev/circuit#qiskit.circuit.Qubit "qiskit.circuit.Qubit"), is not in the circuit, or is not idle.
  </Function>
  ...
  <Function id="qiskit.dagcircuit.DAGCircuit.separable_circuits" signature="separable_circuits(remove_idle_qubits=False, *, vars_mode=Ellipsis)">
    Decompose the circuit into sets of qubits with no gates connecting them.

    **Parameters**

    **remove\_idle\_qubits** ([*bool*](https://docs.python.org/3/builtins/functions.html#bool)) – Flag denoting whether to remove idle qubits from the separated circuits. If `False`, each output circuit will contain the same number of qubits as `self`.
  ...
  <Function id="qiskit.dagcircuit.DAGCircuit.serial_layers" signature="serial_layers(*, vars_mode=Ellipsis)">
  ...
  <Function id="qiskit.dagcircuit.DAGCircuit.size" signature="size(*, recurse=False)">
    ...
    **Raises**
    ...
    [**DAGCircuitError**](/docs/api/qiskit/dev/dagcircuit#qiskit.dagcircuit.DAGCircuitError "qiskit.dagcircuit.DAGCircuitError") – if an unknown [`ControlFlowOp`](qiskit.circuit.ControlFlowOp "qiskit.circuit.ControlFlowOp") is present in a call with `recurse=True`, or any control flow is present in a non-recursive call.
  </Function>

  ### structurally\_equal

  <Function id="qiskit.dagcircuit.DAGCircuit.structurally_equal" signature="structurally_equal(other)">
  ...
  <Function id="qiskit.dagcircuit.DAGCircuit.substitute_node" signature="substitute_node(node, op, inplace=False, propagate_condition=None)">
    ...
    *   **inplace** ([*bool*](https://docs.python.org/3/builtins/functions.html#bool)) – Optional, default False. If True, existing DAG node will be modified to include op. Otherwise, a new DAG node will be used.
    *   **propagate\_condition** ([*bool*](https://docs.python.org/3/builtins/functions.html#bool)) – DEPRECATED a legacy option that used to control the behavior of handling control flow. It has no effect anymore, left it for backwards compatibility. Will be removed in Qiskit 3.0.
    ...
    *   [**DAGCircuitError**](/docs/api/qiskit/dev/dagcircuit#qiskit.dagcircuit.DAGCircuitError "qiskit.dagcircuit.DAGCircuitError") – If replacement operation was incompatible with
  ...
  <Function id="qiskit.dagcircuit.DAGCircuit.substitute_node_with_dag" signature="substitute_node_with_dag(node, input_dag, wires=None, propagate_condition=None)">
    ...
    **Raises**
    ...
    [**DAGCircuitError**](/docs/api/qiskit/dev/dagcircuit#qiskit.dagcircuit.DAGCircuitError "qiskit.dagcircuit.DAGCircuitError") – if met with unexpected predecessor/successors
  </Function>

  ### successors

  <Function id="qiskit.dagcircuit.DAGCircuit.successors" signature="successors(node)">
    Returns iterator of the successors of a node as [`DAGOpNode`](qiskit.dagcircuit.DAGOpNode "qiskit.dagcircuit.DAGOpNode")s and [`DAGOutNode`](qiskit.dagcircuit.DAGOutNode "qiskit.dagcircuit.DAGOutNode")s.
  </Function>
  ...
  <Function id="qiskit.dagcircuit.DAGCircuit.swap_nodes" signature="swap_nodes(node1, node2)">
    ...
    **Raises**
    ...
    [**DAGCircuitError**](/docs/api/qiskit/dev/dagcircuit#qiskit.dagcircuit.DAGCircuitError "qiskit.dagcircuit.DAGCircuitError") – if either node is not an OpNode or nodes are not connected
  </Function>

  ### to\_circuit

  <Function id="qiskit.dagcircuit.DAGCircuit.to_circuit" signature="to_circuit(*, copy_operations=True)">
    Convert this DAG to a [`QuantumCircuit`](/docs/api/qiskit/dev/qiskit.circuit.QuantumCircuit "qiskit.circuit.QuantumCircuit").

    This is a simple wrapper around [`dag_to_circuit()`](/docs/api/qiskit/dev/converters#qiskit.converters.dag_to_circuit "qiskit.converters.dag_to_circuit").
    ...
    **Returns**
    ...
    a [`QuantumCircuit`](/docs/api/qiskit/dev/qiskit.circuit.QuantumCircuit "qiskit.circuit.QuantumCircuit") representing this same DAG.
  </Function>

  ### topological\_nodes

  <Function id="qiskit.dagcircuit.DAGCircuit.topological_nodes" signature="topological_nodes(key=None, reverse=False)">
    ...
    *   **reverse** ([*bool*](https://docs.python.org/3/builtins/functions.html#bool)) – If True, yield nodes in reverse topological order.
  ...
  <Function id="qiskit.dagcircuit.DAGCircuit.topological_op_nodes" signature="topological_op_nodes(key=None, reverse=False)">
    ...
    *   **reverse** ([*bool*](https://docs.python.org/3/builtins/functions.html#bool)) – If True, yield op nodes in reverse topological order.
