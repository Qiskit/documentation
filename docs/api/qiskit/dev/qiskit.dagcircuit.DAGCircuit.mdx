...
<Class id="qiskit.dagcircuit.DAGCircuit" github="https://github.com/qiskit/qiskit/tree/main/qiskit/dagcircuit/dagcircuit.py" signature="qiskit.dagcircuit.DAGCircuit">
  ...
  <Function id="qiskit.dagcircuit.DAGCircuit.apply_operation_back" name="apply_operation_back" signature="apply_operation_back(op, qargs=(), cargs=(), *, check=True)">
  ...
  <Function id="qiskit.dagcircuit.DAGCircuit.apply_operation_front" name="apply_operation_front" signature="apply_operation_front(op, qargs=(), cargs=(), *, check=True)">
