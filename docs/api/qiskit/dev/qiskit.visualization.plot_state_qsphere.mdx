...
<Function id="qiskit.visualization.plot_state_qsphere" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/main/qiskit/visualization/state_visualization.py#L791-L1078" signature="qiskit.visualization.plot_state_qsphere(state, figsize=None, ax=None, show_state_labels=True, show_state_phases=False, use_degrees=False, *, filename=None)">
  ...
  **Examples**
  ...
  ![Output from the previous code.](/images/api/qiskit/dev/qiskit-visualization-plot_state_qsphere-1.png)
  ...
  ![Output from the previous code.](/images/api/qiskit/dev/qiskit-visualization-plot_state_qsphere-2.png)
</Function>
