...
<Class id="qiskit.transpiler.InstructionDurations" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/transpiler/instruction_durations.py#L26-L268" signature="qiskit.transpiler.InstructionDurations(instruction_durations=None, dt=None)">
