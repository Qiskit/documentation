...
<span id="qiskit.circuit.library.Initialize.base_class" />
...
<span id="qiskit.circuit.library.Initialize.condition" />

### condition

The classical condition on the instruction.

<span id="qiskit.circuit.library.Initialize.condition_bits" />

### condition\_bits

Get Clbits in condition.

<span id="qiskit.circuit.library.Initialize.decompositions" />

### decompositions

Get the decompositions of the instruction from the SessionEquivalenceLibrary.

<span id="qiskit.circuit.library.Initialize.definition" />

### definition

Return definition in terms of other basic gates.

<span id="qiskit.circuit.library.Initialize.duration" />

### duration

Get the duration.

<span id="qiskit.circuit.library.Initialize.label" />

### label

Return instruction label

<span id="qiskit.circuit.library.Initialize.mutable" />
...
<span id="qiskit.circuit.library.Initialize.name" />

### name

Return the name.

<span id="qiskit.circuit.library.Initialize.num_clbits" />

### num\_clbits

Return the number of clbits.

<span id="qiskit.circuit.library.Initialize.num_qubits" />

### num\_qubits

Return the number of qubits.

<span id="qiskit.circuit.library.Initialize.params" />

### params

Return initialize params.

<span id="qiskit.circuit.library.Initialize.unit" />
...
<span id="qiskit.circuit.library.Initialize.broadcast_arguments" />
...
<span id="qiskit.circuit.library.Initialize.gates_to_uncompute" />
