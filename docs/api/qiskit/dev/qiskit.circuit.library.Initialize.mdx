...
<Class id="qiskit.circuit.library.Initialize" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/main/qiskit/circuit/library/data_preparation/initializer.py#L32-L96" signature="qiskit.circuit.library.Initialize(params, num_qubits=None, normalize=False)">
  ...
  *   **normalize** ([*bool*](https://docs.python.org/3/library/functions.html#bool "(in Python v3.12)")) – Whether to normalize an input array to a unit vector.
  ...
  <Attribute id="qiskit.circuit.library.Initialize.base_class" name="base_class">
  ...
  <Attribute id="qiskit.circuit.library.Initialize.condition" name="condition">
    The classical condition on the instruction.
  </Attribute>

  ### condition\_bits

  <Attribute id="qiskit.circuit.library.Initialize.condition_bits" name="condition_bits">
    Get Clbits in condition.
  </Attribute>

  ### decompositions

  <Attribute id="qiskit.circuit.library.Initialize.decompositions" name="decompositions">
    Get the decompositions of the instruction from the SessionEquivalenceLibrary.
  </Attribute>

  ### definition

  <Attribute id="qiskit.circuit.library.Initialize.definition" name="definition">
    Return definition in terms of other basic gates.
  </Attribute>

  ### duration

  <Attribute id="qiskit.circuit.library.Initialize.duration" name="duration">
    Get the duration.
  </Attribute>

  ### label

  <Attribute id="qiskit.circuit.library.Initialize.label" name="label">
    Return instruction label
  </Attribute>

  ### mutable

  <Attribute id="qiskit.circuit.library.Initialize.mutable" name="mutable">
  ...
  <Attribute id="qiskit.circuit.library.Initialize.name" name="name">
    Return the name.
  </Attribute>

  ### num\_clbits

  <Attribute id="qiskit.circuit.library.Initialize.num_clbits" name="num_clbits">
    Return the number of clbits.
  </Attribute>

  ### num\_qubits

  <Attribute id="qiskit.circuit.library.Initialize.num_qubits" name="num_qubits">
    Return the number of qubits.
  </Attribute>

  ### params

  <Attribute id="qiskit.circuit.library.Initialize.params" name="params">
    Return initialize params.
  </Attribute>

  ### unit

  <Attribute id="qiskit.circuit.library.Initialize.unit" name="unit">
  ...
  <Function id="qiskit.circuit.library.Initialize.broadcast_arguments" name="broadcast_arguments" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/circuit/library/data_preparation/initializer.py#L95-L96" signature="broadcast_arguments(qargs, cargs)">
  ...
  <Function id="qiskit.circuit.library.Initialize.gates_to_uncompute" name="gates_to_uncompute" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/circuit/library/data_preparation/initializer.py#L77-L83" signature="gates_to_uncompute()">
