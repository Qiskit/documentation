...
<Class id="qiskit.transpiler.passes.CollectAndCollapse" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/main/qiskit/transpiler/passes/optimization/collect_and_collapse.py#L23-L88" signature="qiskit.transpiler.passes.CollectAndCollapse(*args, **kwargs)" modifiers="class">
  ...
  *   **do\_commutative\_analysis** ([*bool*](https://docs.python.org/3/library/functions.html#bool "(in Python v3.13)")) – if True, exploits commutativity relations between nodes.
  ...
  <Function id="qiskit.transpiler.passes.CollectAndCollapse.execute" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/transpiler/basepasses.py#L189-L211" signature="execute(passmanager_ir, state, callback=None)">
  ...
  <Function id="qiskit.transpiler.passes.CollectAndCollapse.update_status" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/transpiler/basepasses.py#L213-L221" signature="update_status(state, run_state)">
