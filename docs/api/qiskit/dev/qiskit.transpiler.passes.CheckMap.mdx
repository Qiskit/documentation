...
<Class id="qiskit.transpiler.passes.CheckMap" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/main/qiskit/transpiler/passes/utils/check_map.py#L21-L92" signature="qiskit.transpiler.passes.CheckMap(*args, **kwargs)" modifiers="class">
