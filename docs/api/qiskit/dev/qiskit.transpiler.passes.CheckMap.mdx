...
<Class id="qiskit.transpiler.passes.CheckMap" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.1/qiskit/transpiler/passes/utils/check_map.py#L21-L94" signature="qiskit.transpiler.passes.CheckMap(*args, **kwargs)">
