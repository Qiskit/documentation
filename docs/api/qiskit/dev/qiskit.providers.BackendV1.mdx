...
<Class id="qiskit.providers.BackendV1" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/main/qiskit/providers/backend.py#L40-L242" signature="qiskit.providers.BackendV1(configuration, provider=None, **fields)">
  ...
  <Function id="qiskit.providers.BackendV1._default_options" name="_default_options" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/providers/backend.py#L107-L120" signature="abstract classmethod _default_options()">
  ...
  **Raises**
  ...
  <Function github="https://github.com/Qiskit/qiskit/tree/main/qiskit/providers/backend.py#L107-L120" signature="abstract classmethod _default_options()">
    Return the default options
  ...
  <Attribute id="qiskit.providers.BackendV1.options" name="options">
  ...
  <Attribute id="qiskit.providers.BackendV1.version" name="version" attributeValue="1" />

  ## Methods

  ### configuration

  <Function id="qiskit.providers.BackendV1.configuration" name="configuration" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/providers/backend.py#L141-L147" signature="configuration()">
  ...
  <Function id="qiskit.providers.BackendV1.name" name="name" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/providers/backend.py#L180-L186" signature="name()">
  ...
  <Function id="qiskit.providers.BackendV1.properties" name="properties" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/providers/backend.py#L149-L156" signature="properties()">
  ...
  <Function id="qiskit.providers.BackendV1.provider" name="provider" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/providers/backend.py#L158-L164" signature="provider()">
  ...
  <Function id="qiskit.providers.BackendV1.run" name="run" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/providers/backend.py#L212-L242" signature="abstract run(run_input, **options)">
    Run on the backend.
  ...
  <Function id="qiskit.providers.BackendV1.set_options" name="set_options" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/providers/backend.py#L122-L139" signature="set_options(**fields)">
  ...
  <Function id="qiskit.providers.BackendV1.status" name="status" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/providers/backend.py#L166-L178" signature="status()">
