...
`qiskit.providers.BackendV1(configuration, provider=None, **fields)` [GitHub](https://github.com/qiskit/qiskit/tree/main/qiskit/providers/backend.py "view source code")
