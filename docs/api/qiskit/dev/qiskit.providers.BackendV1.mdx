...
<Class id="qiskit.providers.BackendV1" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.3/qiskit/providers/backend.py#L42-L246" signature="qiskit.providers.BackendV1(configuration, provider=None, **fields)" modifiers="class">
  ...
  <Function id="qiskit.providers.BackendV1._default_options" github="https://github.com/Qiskit/qiskit/tree/stable/1.3/qiskit/providers/backend.py#L111-L124" signature="_default_options()" modifiers="abstract classmethod">
  ...
  **Raises**
  ...
  <Function id="qiskit.providers.BackendV1.configuration" github="https://github.com/Qiskit/qiskit/tree/stable/1.3/qiskit/providers/backend.py#L145-L151" signature="configuration()">
  ...
  <Function id="qiskit.providers.BackendV1.name" github="https://github.com/Qiskit/qiskit/tree/stable/1.3/qiskit/providers/backend.py#L184-L190" signature="name()">
  ...
  <Function id="qiskit.providers.BackendV1.properties" github="https://github.com/Qiskit/qiskit/tree/stable/1.3/qiskit/providers/backend.py#L153-L160" signature="properties()">
  ...
  <Function id="qiskit.providers.BackendV1.provider" github="https://github.com/Qiskit/qiskit/tree/stable/1.3/qiskit/providers/backend.py#L162-L168" signature="provider()">
  ...
  <Function id="qiskit.providers.BackendV1.run" github="https://github.com/Qiskit/qiskit/tree/stable/1.3/qiskit/providers/backend.py#L216-L246" signature="run(run_input, **options)" modifiers="abstract">
    Run on the backend.
  ...
  <Function id="qiskit.providers.BackendV1.set_options" github="https://github.com/Qiskit/qiskit/tree/stable/1.3/qiskit/providers/backend.py#L126-L143" signature="set_options(**fields)">
  ...
  <Function id="qiskit.providers.BackendV1.status" github="https://github.com/Qiskit/qiskit/tree/stable/1.3/qiskit/providers/backend.py#L170-L182" signature="status()">
