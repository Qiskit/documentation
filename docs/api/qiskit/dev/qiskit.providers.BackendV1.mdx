...
<Class id="qiskit.providers.BackendV1" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/providers/backend.py#L40-L242" signature="qiskit.providers.BackendV1(configuration, provider=None, **fields)">
