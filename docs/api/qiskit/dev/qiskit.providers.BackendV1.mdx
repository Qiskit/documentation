---
title: BackendV1 (dev version)
description: API reference for qiskit.providers.BackendV1 in the dev version of qiskit
...
<Class id="qiskit.providers.BackendV1" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/main/qiskit/providers/backend.py#L41-L245" signature="qiskit.providers.BackendV1(configuration, provider=None, **fields)" modifiers="class">
  ...
  <Function id="qiskit.providers.BackendV1._default_options" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/providers/backend.py#L110-L123" signature="_default_options()" modifiers="abstract classmethod">
  ...
  *   **provider** – Optionally, the provider object that this Backend comes from.
  ...
  **Raises**
  ...
  <Function id="qiskit.providers.BackendV1.configuration" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/providers/backend.py#L144-L150" signature="configuration()">
  ...
  <Function id="qiskit.providers.BackendV1.name" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/providers/backend.py#L183-L189" signature="name()">
  ...
  <Function id="qiskit.providers.BackendV1.properties" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/providers/backend.py#L152-L159" signature="properties()">
  ...
  <Function id="qiskit.providers.BackendV1.provider" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/providers/backend.py#L161-L167" signature="provider()">
  ...
  <Function id="qiskit.providers.BackendV1.run" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/providers/backend.py#L215-L245" signature="run(run_input, **options)" modifiers="abstract">
    Run on the backend.
  ...
  <Function id="qiskit.providers.BackendV1.set_options" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/providers/backend.py#L125-L142" signature="set_options(**fields)">
  ...
  <Function id="qiskit.providers.BackendV1.status" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/providers/backend.py#L169-L181" signature="status()">
