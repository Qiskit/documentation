...
<Class id="qiskit.circuit.library.QuadraticForm" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/circuit/library/arithmetic/quadratic_form.py#L24-L198" signature="qiskit.circuit.library.QuadraticForm(num_result_qubits=None, quadratic=None, linear=None, offset=None, little_endian=True)">
...
$$
  ...
  *   [**ValueError**](https://docs.python.org/3/library/exceptions.html#ValueError "(in Python v3.12)") – If `num_result_qubits` is unspecified but cannot be determined because some values of the quadratic form are parameterized.
  ...
  <Attribute id="qiskit.circuit.library.QuadraticForm.instances" name="instances" attributeValue="= 335" />
  ...
  <Attribute id="qiskit.circuit.library.QuadraticForm.num_captured_vars" name="num_captured_vars">
  ...
  <Attribute id="qiskit.circuit.library.QuadraticForm.num_declared_vars" name="num_declared_vars">
  ...
  <Attribute id="qiskit.circuit.library.QuadraticForm.num_input_vars" name="num_input_vars">
  ...
  <Attribute id="qiskit.circuit.library.QuadraticForm.num_vars" name="num_vars">
  ...
  <Function id="qiskit.circuit.library.QuadraticForm.required_result_qubits" name="required_result_qubits" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/circuit/library/arithmetic/quadratic_form.py#L166-L198" signature="static required_result_qubits(quadratic, linear, offset)">
