...
`qiskit.circuit.library.QuadraticForm(num_result_qubits=None, quadratic=None, linear=None, offset=None, little_endian=True)` [GitHub](https://github.com/qiskit/qiskit/tree/main/qiskit/circuit/library/arithmetic/quadratic_form.py "view source code")
...
<span id="qiskit.circuit.library.QuadraticForm.num_captured_vars" />
...
<span id="qiskit.circuit.library.QuadraticForm.num_declared_vars" />
...
<span id="qiskit.circuit.library.QuadraticForm.num_input_vars" />
...
<span id="qiskit.circuit.library.QuadraticForm.num_vars" />
