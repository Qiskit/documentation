...
<Function id="qiskit.qasm3.dump" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/qasm3/__init__.py#L292-L302" signature="qiskit.qasm3.dump(circuit, stream, **kwargs)">
  Serialize a [`QuantumCircuit`](circuit-quantum-circuit "qiskit.circuit.QuantumCircuit") object as an OpenQASM 3 stream to file-like object.

  **Parameters**

  *   **circuit** ([*QuantumCircuit*](circuit-quantum-circuit "qiskit.circuit.QuantumCircuit")) – Circuit to serialize.
...
<Function id="qiskit.qasm3.dumps" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/qasm3/__init__.py#L279-L289" signature="qiskit.qasm3.dumps(circuit, **kwargs)">
  Serialize a [`QuantumCircuit`](circuit-quantum-circuit "qiskit.circuit.QuantumCircuit") object in an OpenQASM 3 string.
...
<Function id="qiskit.qasm3.load" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/qasm3/__init__.py#L305-L327" signature="qiskit.qasm3.load(filename)">
  ...
  **Raises**
  ...
  [**QASM3ImporterError**](#qiskit.qasm3.QASM3ImporterError "qiskit.qasm3.QASM3ImporterError") – if the OpenQASM 3 file is invalid, or cannot be represented by a [`QuantumCircuit`](circuit-quantum-circuit "qiskit.circuit.QuantumCircuit").
</Function>
...
For example, we can define a quantum program using OpenQASM 3, and use [`loads()`](#qiskit.qasm3.loads "qiskit.qasm3.loads") to directly convert it into a [`QuantumCircuit`](circuit-quantum-circuit "qiskit.circuit.QuantumCircuit"):
...
<Function id="qiskit.qasm3.load_experimental" signature="qiskit.qasm3.load_experimental(pathlike_or_filelike, /, *, custom_gates=None, include_path=None)">
  Load an OpenQASM 3 program from a source file into a [`QuantumCircuit`](circuit-quantum-circuit "qiskit.circuit.QuantumCircuit").
...
<Function id="qiskit.qasm3.loads_experimental" signature="qiskit.qasm3.loads_experimental(source, /, *, custom_gates=None, include_path=None)">
  Load an OpenQASM 3 program from a string into a [`QuantumCircuit`](circuit-quantum-circuit "qiskit.circuit.QuantumCircuit").
...
<Class id="qiskit.qasm3.CustomGate" signature="qiskit.qasm3.CustomGate" modifiers="class">
  ...
  <Attribute id="qiskit.qasm3.CustomGate.constructor">
    A callable Python object that takes `num_params` angles as positional arguments, and returns a [`Gate`](circuit-gate "qiskit.circuit.Gate") object representing the gate.
  </Attribute>
