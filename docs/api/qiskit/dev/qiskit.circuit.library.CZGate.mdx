...
<Class id="qiskit.circuit.library.CZGate" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/main/qiskit/circuit/library/standard_gates/z.py#L151-L242" signature="qiskit.circuit.library.CZGate(*args, _force_mutable=False, **kwargs)">
...
$$
  ...
  <Attribute id="qiskit.circuit.library.CZGate.base_class" name="base_class">
  ...
  <Attribute id="qiskit.circuit.library.CZGate.condition" name="condition">
  ...
  <Attribute id="qiskit.circuit.library.CZGate.mutable" name="mutable">
  ...
  <Attribute id="qiskit.circuit.library.CZGate.num_clbits" name="num_clbits">
  ...
  <Attribute id="qiskit.circuit.library.CZGate.num_qubits" name="num_qubits">
  ...
  <Function id="qiskit.circuit.library.CZGate.inverse" name="inverse" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/circuit/library/standard_gates/z.py#L227-L239" signature="inverse(annotated=False)">
