...
<Class id="qiskit.circuit.library.CZGate" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/circuit/library/standard_gates/z.py#L151-L242" signature="qiskit.circuit.library.CZGate(*args, _force_mutable=False, **kwargs)">
