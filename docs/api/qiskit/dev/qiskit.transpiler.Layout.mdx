...
<Class id="qiskit.transpiler.Layout" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/main/qiskit/transpiler/layout.py#L35-L444" signature="qiskit.transpiler.Layout(input_dict=None)" modifiers="class">
  ...
  <Function id="qiskit.transpiler.Layout.inverse" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/transpiler/layout.py#L396-L421" signature="inverse(source_qubits, target_qubits)">
    ...
    *   **source\_qubits** ([*list*](https://docs.python.org/3/library/stdtypes.html#list)*\[*[*qiskit.circuit.Qubit*](circuit#qiskit.circuit.Qubit "qiskit.circuit.Qubit")*]*) – A list of [`Qubit`](circuit#qiskit.circuit.Qubit "qiskit.circuit.Qubit") objects representing the domain of the layout.
    *   **target\_qubits** ([*list*](https://docs.python.org/3/library/stdtypes.html#list)*\[*[*qiskit.circuit.Qubit*](circuit#qiskit.circuit.Qubit "qiskit.circuit.Qubit")*]*) – A list of [`Qubit`](circuit#qiskit.circuit.Qubit "qiskit.circuit.Qubit") objects representing the image of the layout.
  ...
  <Function id="qiskit.transpiler.Layout.to_permutation" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/transpiler/layout.py#L423-L444" signature="to_permutation(qubits)">
    ...
    **qubits** ([*list*](https://docs.python.org/3/library/stdtypes.html#list)*\[*[*qiskit.circuit.Qubit*](circuit#qiskit.circuit.Qubit "qiskit.circuit.Qubit")*]*) –
  </Function>
</Class>
