...
<Class id="qiskit.dagcircuit.DAGOpNode" github="https://github.com/qiskit/qiskit/tree/main/qiskit/dagcircuit/dagnode.py" signature="qiskit.dagcircuit.DAGOpNode(op, qargs=(), cargs=(), dag=None)">
