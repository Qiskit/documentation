...
<Class id="qiskit.dagcircuit.DAGOpNode" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/dagcircuit/dagnode.py#L258-L296" signature="qiskit.dagcircuit.DAGOpNode(op, qargs=(), cargs=(), dag=None)">
