...
$$
  ...
  **Reference Circuit:**
  ...
  ![Diagram illustrating the previously described circuit.](/docs/images/api/qiskit/dev/qiskit-circuit-library-InnerProduct-1.avif)
  ...
  **num\_qubits** ([*int*](https://docs.python.org/3/library/functions.html#int "(in Python v3.13)")) – width of top and bottom registers (half total circuit width)
  ...
  <Attribute id="qiskit.circuit.library.InnerProduct.instances" attributeValue="244" />
