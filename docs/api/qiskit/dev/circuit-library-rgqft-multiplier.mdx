...
<Class id="qiskit.circuit.library.RGQFTMultiplier" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/main/qiskit/circuit/library/arithmetic/multipliers/rg_qft_multiplier.py#L25-L108" signature="qiskit.circuit.library.RGQFTMultiplier(num_state_qubits, num_result_qubits=None, name='RGQFTMultiplier')" modifiers="class">
  ...
  <Admonition title="See also" type="note">
    The [`MultiplierGate`](circuit-library-multiplier-gate "qiskit.circuit.library.MultiplierGate") objects represents a multiplication, like this circuit class, but allows the compiler to select the optimal decomposition based on the context. Specific implementations can be set via the [`HLSConfig`](transpiler-passes-hls-config "qiskit.transpiler.passes.HLSConfig"), e.g. this circuit can be chosen via `Multiplier=["qft_r17"]`.
  </Admonition>
