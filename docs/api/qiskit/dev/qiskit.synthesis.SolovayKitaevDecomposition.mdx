...
<Class id="qiskit.synthesis.SolovayKitaevDecomposition" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/main/qiskit/synthesis/discrete_basis/solovay_kitaev.py#L33-L274" signature="qiskit.synthesis.SolovayKitaevDecomposition(basic_approximations=None, *, basis_gates=None, depth=12, check_input=False)" modifiers="class">
  ...
  *   **check\_input** ([*bool*](https://docs.python.org/3/library/functions.html#bool "(in Python v3.14)")) – If `True`, perform intermediate steps checking whether the matrices are of expected form.
  ...
  <Function id="qiskit.synthesis.SolovayKitaevDecomposition.find_basic_approximation" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/synthesis/discrete_basis/solovay_kitaev.py#L260-L274" signature="find_basic_approximation(sequence)">
  ...
  <Function id="qiskit.synthesis.SolovayKitaevDecomposition.load_basic_approximations" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/synthesis/discrete_basis/solovay_kitaev.py#L118-L177" signature="load_basic_approximations(data)" modifiers="static">
  ...
  <Function id="qiskit.synthesis.SolovayKitaevDecomposition.query_basic_approximation" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/synthesis/discrete_basis/solovay_kitaev.py#L250-L258" signature="query_basic_approximation(gate)">
    Query a basic approximation of a matrix.

    **Parameters**

    **gate** ([*ndarray*](https://numpy.org/doc/stable/reference/generated/numpy.ndarray.html#numpy.ndarray "(in NumPy v2.4)")  *|*[*Gate*](qiskit.circuit.Gate "qiskit.circuit.gate.Gate")) –
  ...
  <Function id="qiskit.synthesis.SolovayKitaevDecomposition.run" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/synthesis/discrete_basis/solovay_kitaev.py#L207-L248" signature="run(gate_matrix, recursion_degree, return_dag=False, check_input=True)">
    Run the algorithm.
  ...
  <Function id="qiskit.synthesis.SolovayKitaevDecomposition.save_basic_approximations" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/synthesis/discrete_basis/solovay_kitaev.py#L179-L205" signature="save_basic_approximations(filename)">
