...
<Class id="qiskit.synthesis.SolovayKitaevDecomposition" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/main/qiskit/synthesis/discrete_basis/solovay_kitaev.py#L33-L273" signature="qiskit.synthesis.SolovayKitaevDecomposition(basic_approximations=None, *, basis_gates=None, depth=12, check_input=False)" modifiers="class">
  ...
  *   **check\_input** ([*bool*](https://docs.python.org/3/library/functions.html#bool)) – If `True`, perform intermediate steps checking whether the matrices are of expected form.
  ...
  <Function id="qiskit.synthesis.SolovayKitaevDecomposition.find_basic_approximation" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/synthesis/discrete_basis/solovay_kitaev.py#L259-L273" signature="find_basic_approximation(sequence)">
  ...
  <Function id="qiskit.synthesis.SolovayKitaevDecomposition.query_basic_approximation" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/synthesis/discrete_basis/solovay_kitaev.py#L249-L257" signature="query_basic_approximation(gate)">
  ...
  <Function id="qiskit.synthesis.SolovayKitaevDecomposition.run" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/synthesis/discrete_basis/solovay_kitaev.py#L206-L247" signature="run(gate_matrix, recursion_degree, return_dag=False, check_input=True)">
    Run the algorithm.
