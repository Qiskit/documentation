...
<Class id="qiskit.circuit.library.CYGate" github="https://github.com/qiskit/qiskit/tree/main/qiskit/circuit/library/standard_gates/y.py" signature="qiskit.circuit.library.CYGate(*args, _force_mutable=False, **kwargs)">
