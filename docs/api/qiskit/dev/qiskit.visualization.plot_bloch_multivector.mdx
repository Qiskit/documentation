...
<Function id="qiskit.visualization.plot_bloch_multivector" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/main/qiskit/visualization/state_visualization.py#L257-L362" signature="qiskit.visualization.plot_bloch_multivector(state, title='', figsize=None, *, reverse_bits=False, filename=None, font_size=None, title_font_size=None, title_pad=1)">
  ...
  **Examples**
  ...
  ![Output from the previous code.](/images/api/qiskit/dev/qiskit-visualization-plot_bloch_multivector-1.png)
  ...
  ![Output from the previous code.](/images/api/qiskit/dev/qiskit-visualization-plot_bloch_multivector-2.png)
</Function>
