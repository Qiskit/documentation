...
<Class id="qiskit.result.ResultError" github="https://github.com/qiskit/qiskit/tree/main/qiskit/result/exceptions.py" signature="qiskit.result.ResultError(error)">
