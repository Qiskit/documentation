---
title: BasePrimitiveJob (dev version)
description: API reference for qiskit.primitives.BasePrimitiveJob in the dev version of qiskit
...
<Class id="qiskit.primitives.BasePrimitiveJob" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/main/qiskit/primitives/base/base_primitive_job.py#L26-L116" signature="qiskit.primitives.BasePrimitiveJob(job_id, **kwargs)" modifiers="class">
  ...
  **param kwargs**
  ...
  <Function id="qiskit.primitives.BasePrimitiveJob.cancel" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/primitives/base/base_primitive_job.py#L113-L116" signature="cancel()" modifiers="abstractmethod">
    Attempt to cancel the job.
  </Function>

  ### cancelled

  <Function id="qiskit.primitives.BasePrimitiveJob.cancelled" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/primitives/base/base_primitive_job.py#L101-L104" signature="cancelled()" modifiers="abstractmethod">
  ...
  <Function id="qiskit.primitives.BasePrimitiveJob.done" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/primitives/base/base_primitive_job.py#L91-L94" signature="done()" modifiers="abstractmethod">
  ...
  <Function id="qiskit.primitives.BasePrimitiveJob.in_final_state" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/primitives/base/base_primitive_job.py#L106-L111" signature="in_final_state()" modifiers="abstractmethod">
  ...
  <Function id="qiskit.primitives.BasePrimitiveJob.job_id" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/primitives/base/base_primitive_job.py#L77-L79" signature="job_id()">
  ...
  <Function id="qiskit.primitives.BasePrimitiveJob.result" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/primitives/base/base_primitive_job.py#L81-L84" signature="result()" modifiers="abstractmethod">
  ...
  <Function id="qiskit.primitives.BasePrimitiveJob.running" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/primitives/base/base_primitive_job.py#L96-L99" signature="running()" modifiers="abstractmethod">
  ...
  <Function id="qiskit.primitives.BasePrimitiveJob.status" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/primitives/base/base_primitive_job.py#L86-L89" signature="status()" modifiers="abstractmethod">
  ...
  **job\_id** ([*str*](https://docs.python.org/3/builtins/stdtypes.html#str))
</Class>
