...
<Class id="qiskit.scheduler.ScheduleConfig" github="https://github.com/Qiskit/qiskit/tree/stable/1.1/qiskit/scheduler/config.py#L21-L35" signature="qiskit.scheduler.ScheduleConfig(inst_map, meas_map, dt)">
