---
title: scheduler (dev version)
description: API reference for qiskit.scheduler in the dev version of qiskit
...
<Class id="qiskit.scheduler.ScheduleConfig" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/scheduler/config.py#L22-L37" signature="qiskit.scheduler.ScheduleConfig(inst_map, meas_map, dt)" modifiers="class">
  ...
  *   **inst\_map** ([*InstructionScheduleMap*](pulse-instruction-schedule-map "qiskit.pulse.instruction_schedule_map.InstructionScheduleMap")) – The schedule definition of all gates supported on a backend.
...
<Function id="qiskit.scheduler.schedule_circuit.schedule_circuit" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/scheduler/schedule_circuit.py#L26-L69" signature="qiskit.scheduler.schedule_circuit.schedule_circuit(circuit, schedule_config, method=None, backend=None)">
  ...
  *   **circuit** ([*QuantumCircuit*](circuit-quantum-circuit "qiskit.circuit.quantumcircuit.QuantumCircuit")) – The quantum circuit to translate.
  ...
  *   **backend** ([*BackendV1*](providers-backend-v-1 "qiskit.providers.backend.BackendV1")  *|*[*BackendV2*](providers-backend-v-2 "qiskit.providers.backend.BackendV2") *| None*) – A backend used to build the Schedule, the backend could be BackendV1 or BackendV2.
...
<Function id="qiskit.scheduler.methods.as_soon_as_possible" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/scheduler/methods/basic.py#L29-L80" signature="qiskit.scheduler.methods.as_soon_as_possible(circuit, schedule_config, backend=None)">
...
<Function id="qiskit.scheduler.methods.as_late_as_possible" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/scheduler/methods/basic.py#L83-L140" signature="qiskit.scheduler.methods.as_late_as_possible(circuit, schedule_config, backend=None)">
