...
<Class id="qiskit.quantum_info.Choi" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/quantum_info/operators/channel/choi.py#L35-L214" signature="qiskit.quantum_info.Choi(data, input_dims=None, output_dims=None)">
