...
<Class id="qiskit.synthesis.OneQubitEulerDecomposer" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/main/qiskit/synthesis/one_qubit/one_qubit_decompose.py#L76-L288" signature="qiskit.synthesis.OneQubitEulerDecomposer(basis='U3', use_dag=False)" modifiers="class">
  ...
  <Function id="qiskit.synthesis.OneQubitEulerDecomposer.__call__" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/synthesis/one_qubit/one_qubit_decompose.py#L178-L215" signature="__call__(unitary, simplify=True, atol=1e-12)">
    ...
    *   **unitary** ([*Operator*](quantum-info-operator "qiskit.quantum_info.Operator")  *|*[*Gate*](circuit-gate "qiskit.circuit.Gate") *| np.ndarray*) – 1-qubit unitary matrix
  ...
  *   **use\_dag** ([*bool*](https://docs.python.org/3/library/functions.html#bool "(in Python v3.13)")) – If true the output from calls to the decomposer will be a [`DAGCircuit`](dagcircuit-dag-circuit "qiskit.dagcircuit.DAGCircuit") object instead of [`QuantumCircuit`](circuit-quantum-circuit "qiskit.circuit.QuantumCircuit").
  ...
  **Raises**
  ...
  <Function id="qiskit.synthesis.OneQubitEulerDecomposer.build_circuit" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/synthesis/one_qubit/one_qubit_decompose.py#L157-L176" signature="build_circuit(gates, global_phase)">
    ...
    **Return type**
    ...
    [QuantumCircuit](circuit-quantum-circuit "qiskit.circuit.QuantumCircuit") | [DAGCircuit](dagcircuit-dag-circuit "qiskit.dagcircuit.DAGCircuit")
  </Function>
</Class>
