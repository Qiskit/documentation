...
$$
  ...
  **Circuit symbol:**
  ...
  <Function id="qiskit.circuit.library.SGate.power" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/circuit/library/standard_gates/s.py#L97-L101" signature="power(exponent)">
