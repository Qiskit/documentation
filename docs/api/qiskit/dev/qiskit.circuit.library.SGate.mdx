...
<Class id="qiskit.circuit.library.SGate" github="https://github.com/qiskit/qiskit/tree/main/qiskit/circuit/library/standard_gates/s.py" signature="qiskit.circuit.library.SGate(*args, _force_mutable=False, **kwargs)">
