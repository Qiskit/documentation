...
<Class id="qiskit.circuit.library.PiecewiseLinearPauliRotationsGate" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/2.0/qiskit/circuit/library/arithmetic/piecewise_linear_pauli_rotations.py#L281-L387" signature="qiskit.circuit.library.PiecewiseLinearPauliRotationsGate(num_state_qubits=None, breakpoints=None, slopes=None, offsets=None, basis='Y', label=None)" modifiers="class">
