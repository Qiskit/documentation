...
`qiskit.quantum_info.Statevector(data, dims=None)` [GitHub](https://github.com/qiskit/qiskit/tree/main/qiskit/quantum_info/states/statevector.py "view source code")
...
![../\_images/qiskit-quantum\_info-Statevector-1.png](/images/api/qiskit/dev/qiskit-quantum_info-Statevector-1.png)
