...
<Class id="qiskit.synthesis.QDrift" github="https://github.com/qiskit/qiskit/tree/main/qiskit/synthesis/evolution/qdrift.py" signature="qiskit.synthesis.QDrift(reps=1, insert_barriers=False, cx_structure='chain', atomic_evolution=None, seed=None)">
