...
<Class id="qiskit.synthesis.QDrift" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/main/qiskit/synthesis/evolution/qdrift.py#L34-L128" signature="qiskit.synthesis.QDrift(reps=1, insert_barriers=False, cx_structure='chain', atomic_evolution=None, seed=None, wrap=False)" modifiers="class">
  ...
  *   **wrap** ([*bool*](https://docs.python.org/3/library/functions.html#bool "(in Python v3.13)")) – Whether to wrap the atomic evolutions into custom gate objects. This only takes effect when `atomic_evolution is None`.
  ...
  <Function id="qiskit.synthesis.QDrift.expand" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/synthesis/evolution/qdrift.py#L96-L128" signature="expand(evolution)">
  ...
  <Function id="qiskit.synthesis.QDrift.synthesize" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/synthesis/evolution/product_formula.py#L135-L157" signature="synthesize(evolution)">
