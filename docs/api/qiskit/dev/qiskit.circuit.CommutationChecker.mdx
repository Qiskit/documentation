...
<Class id="qiskit.circuit.CommutationChecker" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/main/qiskit/circuit/commutation_checker.py#L24-L142" signature="qiskit.circuit.CommutationChecker(standard_gate_commutations=None, cache_max_entries=1000000, *, gates=None)" modifiers="class">
...
$$
  ...
  *   **gates** (*Optional\[Set\[*[*str*](https://docs.python.org/3/library/stdtypes.html#str "(in Python v3.13)")*]]*) –
  ...
  <Function id="qiskit.circuit.CommutationChecker.check_commutation_entries" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/circuit/commutation_checker.py#L122-L142" signature="check_commutation_entries(first_op, first_qargs, second_op, second_qargs)">
  ...
  <Function id="qiskit.circuit.CommutationChecker.clear_cached_commutations" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/circuit/commutation_checker.py#L118-L120" signature="clear_cached_commutations()">
    Clears the dictionary holding cached commutations
  </Function>

  ### commute

  <Function id="qiskit.circuit.CommutationChecker.commute" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/circuit/commutation_checker.py#L71-L112" signature="commute(op1, qargs1, cargs1, op2, qargs2, cargs2, max_num_qubits=3, approximation_degree=1.0)">
  ...
  <Function id="qiskit.circuit.CommutationChecker.num_cached_entries" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/circuit/commutation_checker.py#L114-L116" signature="num_cached_entries()">
