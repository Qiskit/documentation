...
<Class id="qiskit.circuit.library.PauliGate" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/main/qiskit/circuit/library/generalized_gates/pauli.py#L25-L84" signature="qiskit.circuit.library.PauliGate(label)" modifiers="class">
  ...
  *   **label** – An optional label for the gate.
  ...
  <Function id="qiskit.circuit.library.PauliGate.inverse" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/circuit/library/generalized_gates/pauli.py#L61-L63" signature="inverse(annotated=False)">
  ...
  <Function id="qiskit.circuit.library.PauliGate.validate_parameter" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/circuit/library/generalized_gates/pauli.py#L73-L84" signature="validate_parameter(parameter)">
