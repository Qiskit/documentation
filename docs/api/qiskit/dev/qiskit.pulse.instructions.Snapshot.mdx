...
<Class id="qiskit.pulse.instructions.Snapshot" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.1/qiskit/pulse/instructions/snapshot.py#L23-L80" signature="qiskit.pulse.instructions.Snapshot(label, snapshot_type='statevector', name=None)">
