...
<Class id="qiskit.circuit.library.TdgGate" github="https://github.com/qiskit/qiskit/tree/main/qiskit/circuit/library/standard_gates/t.py" signature="qiskit.circuit.library.TdgGate(*args, _force_mutable=False, **kwargs)">
