...
<Class id="qiskit.transpiler.passes.synthesis.hls_plugins.IntComparatorSynthesisNoAux" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/main/qiskit/transpiler/passes/synthesis/hls_plugins.py#L1327-L1333" signature="qiskit.transpiler.passes.synthesis.hls_plugins.IntComparatorSynthesisNoAux" modifiers="class">
  ...
  <Function id="qiskit.transpiler.passes.synthesis.hls_plugins.IntComparatorSynthesisNoAux.run" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/transpiler/passes/synthesis/hls_plugins.py#L1330-L1333" signature="run(high_level_object, coupling_map=None, target=None, qubits=None, **options)">
