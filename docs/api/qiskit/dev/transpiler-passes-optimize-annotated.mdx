...
<Class id="qiskit.transpiler.passes.OptimizeAnnotated" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/main/qiskit/transpiler/passes/optimization/optimize_annotated.py#L35-L448" signature="qiskit.transpiler.passes.OptimizeAnnotated(*args, **kwargs)" modifiers="class">
