...
$$
  ...
  **Additional Information:**
  ...
  <Function id="qiskit.quantum_info.Operator.draw" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/quantum_info/operators/operator.py#L181-L234" signature="draw(output=None, **drawer_args)">
