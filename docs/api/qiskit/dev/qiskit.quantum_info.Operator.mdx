...
<Class id="qiskit.quantum_info.Operator" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/2.2/qiskit/quantum_info/operators/operator.py#L42-L865" signature="qiskit.quantum_info.Operator(data, input_dims=None, output_dims=None)" modifiers="class">
  Bases: `LinearOp`
...
$$
  ...
  **Additional Information:**
  ...
  <Function id="qiskit.quantum_info.Operator.adjoint" github="https://github.com/Qiskit/qiskit/tree/stable/2.2/qiskit/quantum_info/operators/mixins/adjoint.py#L42-L44" signature="adjoint()">
  ...
  <Function id="qiskit.quantum_info.Operator.apply_permutation" github="https://github.com/Qiskit/qiskit/tree/stable/2.2/qiskit/quantum_info/operators/operator.py#L306-L383" signature="apply_permutation(perm, front=False)">
  ...
  <Function id="qiskit.quantum_info.Operator.compose" github="https://github.com/Qiskit/qiskit/tree/stable/2.2/qiskit/quantum_info/operators/operator.py#L498-L546" signature="compose(other, qargs=None, front=False)">
  ...
  <Function id="qiskit.quantum_info.Operator.conjugate" github="https://github.com/Qiskit/qiskit/tree/stable/2.2/qiskit/quantum_info/operators/operator.py#L485-L489" signature="conjugate()">
    Return the conjugate of the Operator.
  </Function>

  ### copy

  <Function id="qiskit.quantum_info.Operator.copy" github="https://github.com/Qiskit/qiskit/tree/stable/2.2/qiskit/quantum_info/operators/base_operator.py#L143-L145" signature="copy()">
    Make a deep copy of current operator.
  </Function>

  ### dot

  <Function id="qiskit.quantum_info.Operator.dot" github="https://github.com/Qiskit/qiskit/tree/stable/2.2/qiskit/quantum_info/operators/mixins/group.py#L133-L149" signature="dot(other, qargs=None)">
  ...
  <Function id="qiskit.quantum_info.Operator.draw" github="https://github.com/Qiskit/qiskit/tree/stable/2.2/qiskit/quantum_info/operators/operator.py#L183-L238" signature="draw(output=None, **drawer_args)">
  ...
  <Function id="qiskit.quantum_info.Operator.equiv" github="https://github.com/Qiskit/qiskit/tree/stable/2.2/qiskit/quantum_info/operators/operator.py#L692-L714" signature="equiv(other, rtol=None, atol=None)">
  ...
  <Function id="qiskit.quantum_info.Operator.expand" github="https://github.com/Qiskit/qiskit/tree/stable/2.2/qiskit/quantum_info/operators/operator.py#L628-L631" signature="expand(other)">
  ...
  <Function id="qiskit.quantum_info.Operator.from_circuit" github="https://github.com/Qiskit/qiskit/tree/stable/2.2/qiskit/quantum_info/operators/operator.py#L385-L464" signature="from_circuit(circuit, ignore_set_layout=False, layout=None, final_layout=None)" modifiers="classmethod">
  ...
  <Function id="qiskit.quantum_info.Operator.from_label" github="https://github.com/Qiskit/qiskit/tree/stable/2.2/qiskit/quantum_info/operators/operator.py#L249-L304" signature="from_label(label)" modifiers="classmethod">
  ...
  <Function id="qiskit.quantum_info.Operator.input_dims" github="https://github.com/Qiskit/qiskit/tree/stable/2.2/qiskit/quantum_info/operators/base_operator.py#L135-L137" signature="input_dims(qargs=None)">
    Return tuple of input dimension for specified subsystems.
  </Function>

  ### is\_unitary

  <Function id="qiskit.quantum_info.Operator.is_unitary" github="https://github.com/Qiskit/qiskit/tree/stable/2.2/qiskit/quantum_info/operators/operator.py#L466-L472" signature="is_unitary(atol=None, rtol=None)">
    Return True if operator is a unitary matrix.
  </Function>

  ### output\_dims

  <Function id="qiskit.quantum_info.Operator.output_dims" github="https://github.com/Qiskit/qiskit/tree/stable/2.2/qiskit/quantum_info/operators/base_operator.py#L139-L141" signature="output_dims(qargs=None)">
    Return tuple of output dimension for specified subsystems.
  </Function>

  ### power

  <Function id="qiskit.quantum_info.Operator.power" github="https://github.com/Qiskit/qiskit/tree/stable/2.2/qiskit/quantum_info/operators/operator.py#L548-L621" signature="power(n, branch_cut_rotation=3.141592653589793e-12, assume_unitary=False)">
  ...
  <Function id="qiskit.quantum_info.Operator.reshape" github="https://github.com/Qiskit/qiskit/tree/stable/2.2/qiskit/quantum_info/operators/base_operator.py#L106-L133" signature="reshape(input_dims=None, output_dims=None, num_qubits=None)">
  ...
  <Function id="qiskit.quantum_info.Operator.reverse_qargs" github="https://github.com/Qiskit/qiskit/tree/stable/2.2/qiskit/quantum_info/operators/operator.py#L716-L736" signature="reverse_qargs()">
  ...
  <Function id="qiskit.quantum_info.Operator.tensor" github="https://github.com/Qiskit/qiskit/tree/stable/2.2/qiskit/quantum_info/operators/operator.py#L623-L626" signature="tensor(other)">
  ...
  <Function id="qiskit.quantum_info.Operator.to_instruction" github="https://github.com/Qiskit/qiskit/tree/stable/2.2/qiskit/quantum_info/operators/operator.py#L478-L483" signature="to_instruction()">
    Convert to a UnitaryGate instruction.
  </Function>

  ### to\_matrix

  <Function id="qiskit.quantum_info.Operator.to_matrix" github="https://github.com/Qiskit/qiskit/tree/stable/2.2/qiskit/quantum_info/operators/operator.py#L738-L740" signature="to_matrix()">
    Convert operator to NumPy matrix.
  </Function>

  ### to\_operator

  <Function id="qiskit.quantum_info.Operator.to_operator" github="https://github.com/Qiskit/qiskit/tree/stable/2.2/qiskit/quantum_info/operators/operator.py#L474-L476" signature="to_operator()">
  ...
  <Function id="qiskit.quantum_info.Operator.transpose" github="https://github.com/Qiskit/qiskit/tree/stable/2.2/qiskit/quantum_info/operators/operator.py#L491-L496" signature="transpose()">
