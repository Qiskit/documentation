...
<Class id="qiskit.transpiler.passes.synthesis.plugin.HighLevelSynthesisPlugin" github="https://github.com/qiskit/qiskit/tree/main/qiskit/transpiler/passes/synthesis/plugin.py" signature="qiskit.transpiler.passes.synthesis.plugin.HighLevelSynthesisPlugin">
