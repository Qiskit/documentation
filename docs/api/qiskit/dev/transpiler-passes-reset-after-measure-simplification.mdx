---
title: ResetAfterMeasureSimplification (dev version)
description: API reference for qiskit.transpiler.passes.ResetAfterMeasureSimplification in the dev version of qiskit
...
<Class id="qiskit.transpiler.passes.ResetAfterMeasureSimplification" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/main/qiskit/transpiler/passes/optimization/reset_after_measure_simplification.py#L24-L47" signature="qiskit.transpiler.passes.ResetAfterMeasureSimplification(*args, **kwargs)" modifiers="class">
  ...
  <Function id="qiskit.transpiler.passes.ResetAfterMeasureSimplification.run" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/transpiler/passes/optimization/reset_after_measure_simplification.py#L33-L47" signature="run(dag)">
