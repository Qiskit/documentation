...
<Class id="qiskit.quantum_info.SparsePauliOp" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.1/qiskit/quantum_info/operators/symplectic/sparse_pauli_op.py#L50-L1167" signature="qiskit.quantum_info.SparsePauliOp(data, coeffs=None, *, ignore_pauli_phase=False, copy=True)">
  Bases: `LinearOp`
  ...
  **Raises**
  ...
  <Function id="qiskit.quantum_info.SparsePauliOp.from_list" github="https://github.com/Qiskit/qiskit/tree/stable/1.1/qiskit/quantum_info/operators/symplectic/sparse_pauli_op.py#L781-L837" signature="static from_list(obj, dtype=<class 'complex'>, *, num_qubits=None)">
...
$$
  ...
  <Function id="qiskit.quantum_info.SparsePauliOp.from_operator" github="https://github.com/Qiskit/qiskit/tree/stable/1.1/qiskit/quantum_info/operators/symplectic/sparse_pauli_op.py#L734-L779" signature="static from_operator(obj, atol=None, rtol=None)">
  ...
  <Function id="qiskit.quantum_info.SparsePauliOp.from_sparse_list" github="https://github.com/Qiskit/qiskit/tree/stable/1.1/qiskit/quantum_info/operators/symplectic/sparse_pauli_op.py#L839-L907" signature="static from_sparse_list(obj, num_qubits, do_checks=True, dtype=<class 'complex'>)">
...
$$
  ...
  <Function id="qiskit.quantum_info.SparsePauliOp.sum" github="https://github.com/Qiskit/qiskit/tree/stable/1.1/qiskit/quantum_info/operators/symplectic/sparse_pauli_op.py#L698-L728" signature="static sum(ops)">
