...
<Class id="qiskit.quantum_info.SparsePauliOp" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/quantum_info/operators/symplectic/sparse_pauli_op.py#L44-L1140" signature="qiskit.quantum_info.SparsePauliOp(data, coeffs=None, *, ignore_pauli_phase=False, copy=True)">
  Bases: `LinearOp`
