...
<Class id="qiskit.quantum_info.SparsePauliOp" github="https://github.com/qiskit/qiskit/tree/main/qiskit/quantum_info/operators/symplectic/sparse_pauli_op.py" signature="qiskit.quantum_info.SparsePauliOp(data, coeffs=None, *, ignore_pauli_phase=False, copy=True)">
  Bases: `LinearOp`
...
$$
  ...
  <Function id="qiskit.quantum_info.SparsePauliOp.noncommutation_graph" name="noncommutation_graph" signature="noncommutation_graph(qubit_wise)">
