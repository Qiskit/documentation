...
<Class id="qiskit.transpiler.passes.synthesis.high_level_synthesis.KMSSynthesisLinearFunction" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/transpiler/passes/synthesis/high_level_synthesis.py#L718-L728" signature="qiskit.transpiler.passes.synthesis.high_level_synthesis.KMSSynthesisLinearFunction">
  ...
  <Function id="qiskit.transpiler.passes.synthesis.high_level_synthesis.KMSSynthesisLinearFunction.run" name="run" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/transpiler/passes/synthesis/high_level_synthesis.py#L725-L728" signature="run(high_level_object, coupling_map=None, target=None, qubits=None, **options)">
