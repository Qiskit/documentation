...
<Class id="qiskit.passmanager.ConditionalController" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/main/qiskit/passmanager/flow_controllers.py#L90-L116" signature="qiskit.passmanager.ConditionalController(tasks=(), condition=None, *, options=None)" modifiers="class">
  ...
  *   **condition** (*Callable\[\[*[*PropertySet*](qiskit.passmanager.PropertySet "qiskit.passmanager.PropertySet")*],* [*bool*](https://docs.python.org/3/library/functions.html#bool)*] | None*)
  ...
  <Function id="qiskit.passmanager.ConditionalController.execute" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/passmanager/base_tasks.py#L199-L227" signature="execute(passmanager_ir, state, callback=None)">
