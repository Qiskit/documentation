...
<Class id="qiskit.passmanager.ConditionalController" github="https://github.com/qiskit/qiskit/tree/main/qiskit/passmanager/flow_controllers.py" signature="qiskit.passmanager.ConditionalController(tasks=(), condition=None, *, options=None)">
