...
$$
  ...
  *   **num\_state\_qubits** ([*int*](https://docs.python.org/3/builtins/functions.html#int) *| None*) – Number of state qubits. If this is set it will determine the number of qubits required for the circuit.
  *   **value** ([*int*](https://docs.python.org/3/builtins/functions.html#int) *| None*) – The fixed value to compare with.
  *   **geq** ([*bool*](https://docs.python.org/3/builtins/functions.html#bool)) – If True, evaluate a `>=` condition, else `<`.
