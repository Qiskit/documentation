...
<Class id="qiskit.pulse.instructions.SetFrequency" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.1/qiskit/pulse/instructions/frequency.py#L24-L82" signature="qiskit.pulse.instructions.SetFrequency(frequency, channel, name=None)">
