...
<Class id="qiskit.circuit.library.FourierChecking" github="https://github.com/qiskit/qiskit/tree/main/qiskit/circuit/library/fourier_checking.py" signature="qiskit.circuit.library.FourierChecking(f, g)">
