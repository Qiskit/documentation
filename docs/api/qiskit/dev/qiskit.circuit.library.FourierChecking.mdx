...
<Class id="qiskit.circuit.library.FourierChecking" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/main/qiskit/circuit/library/fourier_checking.py#L24-L97" signature="qiskit.circuit.library.FourierChecking(f, g)">
  ...
  **Reference Circuit:**
  ...
  <Attribute id="qiskit.circuit.library.FourierChecking.instances" name="instances" attributeValue="166" />
  ...
  <Attribute id="qiskit.circuit.library.FourierChecking.num_captured_vars" name="num_captured_vars">
  ...
  <Attribute id="qiskit.circuit.library.FourierChecking.num_declared_vars" name="num_declared_vars">
  ...
  <Attribute id="qiskit.circuit.library.FourierChecking.num_input_vars" name="num_input_vars">
  ...
  <Attribute id="qiskit.circuit.library.FourierChecking.num_vars" name="num_vars">
