...
<Class id="qiskit.circuit.library.HGate" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/circuit/library/standard_gates/h.py#L24-L124" signature="qiskit.circuit.library.HGate(*args, _force_mutable=False, **kwargs)">
