...
<Class id="qiskit.quantum_info.DensityMatrix" github="https://github.com/qiskit/qiskit/tree/main/qiskit/quantum_info/states/densitymatrix.py" signature="qiskit.quantum_info.DensityMatrix(data, dims=None)">
