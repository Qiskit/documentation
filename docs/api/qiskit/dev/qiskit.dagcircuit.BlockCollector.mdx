...
<Class id="qiskit.dagcircuit.BlockCollector" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/main/qiskit/dagcircuit/collect_blocks.py#L29-L260" signature="qiskit.dagcircuit.BlockCollector(dag)" modifiers="class">
  ...
  **Raises**
  ...
  <Function id="qiskit.dagcircuit.BlockCollector.collect_matching_block" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/dagcircuit/collect_blocks.py#L143-L188" signature="collect_matching_block(filter_fn, max_block_width)">
