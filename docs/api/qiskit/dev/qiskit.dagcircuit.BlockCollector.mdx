---
title: BlockCollector (dev version)
description: API reference for qiskit.dagcircuit.BlockCollector in the dev version of qiskit
...
<Class id="qiskit.dagcircuit.BlockCollector" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/main/qiskit/dagcircuit/collect_blocks.py#L29-L254" signature="qiskit.dagcircuit.BlockCollector(dag)" modifiers="class">
  ...
  **Raises**
  ...
  [**DAGCircuitError**](/docs/api/qiskit/dev/dagcircuit#qiskit.dagcircuit.DAGCircuitError "qiskit.dagcircuit.DAGCircuitError") – the input object is not a DAG.

  ## Methods

  ### collect\_all\_matching\_blocks

  <Function id="qiskit.dagcircuit.BlockCollector.collect_all_matching_blocks" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/dagcircuit/collect_blocks.py#L184-L254" signature="collect_all_matching_blocks(filter_fn, split_blocks=True, min_block_size=2, split_layers=False, collect_from_back=False, max_block_width=None)">
  ...
  <Function id="qiskit.dagcircuit.BlockCollector.collect_matching_block" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/dagcircuit/collect_blocks.py#L137-L182" signature="collect_matching_block(filter_fn, max_block_width)">
    ...
    *   **max\_block\_width** ([*int*](https://docs.python.org/3/builtins/functions.html#int) *| None*)

    **Return type**

    [list](https://docs.python.org/3/builtins/stdtypes.html#list)\[[*DAGOpNode*](qiskit.dagcircuit.DAGOpNode "qiskit._accelerate.circuit.DAGOpNode") | [*DAGDepNode*](qiskit.dagcircuit.DAGDepNode "qiskit.dagcircuit.dagdepnode.DAGDepNode")]
  </Function>
</Class>
