  ...
  **Raises**
  ...
  <Function id="qiskit.dagcircuit.BlockCollector.collect_matching_block" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/dagcircuit/collect_blocks.py#L137-L182" signature="collect_matching_block(filter_fn, max_block_width)">
    ...
    **Return type**
    ...
    [list](https://docs.python.org/3/library/stdtypes.html#list)\[[qiskit.\_accelerate.circuit.DAGOpNode](qiskit.dagcircuit.DAGOpNode "qiskit._accelerate.circuit.DAGOpNode") | [qiskit.dagcircuit.dagdepnode.DAGDepNode](qiskit.dagcircuit.DAGDepNode "qiskit.dagcircuit.dagdepnode.DAGDepNode")]
  </Function>
</Class>
