...
<Class id="qiskit.transpiler.passes.VF2Layout" github="https://github.com/qiskit/qiskit/tree/main/qiskit/transpiler/passes/layout/vf2_layout.py" signature="qiskit.transpiler.passes.VF2Layout(*args, **kwargs)">
