...
`qiskit.transpiler.passes.LinearFunctionsToPermutations(*args, **kwargs)` [GitHub](https://github.com/qiskit/qiskit/tree/main/qiskit/transpiler/passes/synthesis/linear_functions_synthesis.py "view source code")
...
<span id="qiskit.transpiler.passes.LinearFunctionsToPermutations.execute" />
...
<span id="qiskit.transpiler.passes.LinearFunctionsToPermutations.update_status" />
