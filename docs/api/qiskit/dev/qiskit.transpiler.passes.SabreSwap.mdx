...
<Class id="qiskit.transpiler.passes.SabreSwap" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/transpiler/passes/routing/sabre_swap.py#L45-L270" signature="qiskit.transpiler.passes.SabreSwap(*args, **kwargs)">
