...
`qiskit.transpiler.passes.ConvertConditionsToIfOps(*args, **kwargs)` [GitHub](https://github.com/qiskit/qiskit/tree/main/qiskit/transpiler/passes/utils/convert_conditions_to_if_ops.py "view source code")
...
<span id="qiskit.transpiler.passes.ConvertConditionsToIfOps.execute" />
...
<span id="qiskit.transpiler.passes.ConvertConditionsToIfOps.update_status" />
