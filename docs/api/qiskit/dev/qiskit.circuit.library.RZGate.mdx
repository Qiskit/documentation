...
<Class id="qiskit.circuit.library.RZGate" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.1/qiskit/circuit/library/standard_gates/rz.py#L22-L149" signature="qiskit.circuit.library.RZGate(phi, label=None, *, duration=None, unit='dt')">
