...
<Class id="qiskit.transpiler.InstructionProperties" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/transpiler/target.py#L58-L136" signature="qiskit.transpiler.InstructionProperties(duration=None, error=None, calibration=None)">
