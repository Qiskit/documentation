...
<Class id="qiskit.transpiler.StagedPassManager" github="https://github.com/qiskit/qiskit/tree/main/qiskit/transpiler/passmanager.py" signature="qiskit.transpiler.StagedPassManager(stages=None, **kwargs)">
