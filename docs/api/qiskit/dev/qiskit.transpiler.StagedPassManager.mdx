...
<Class id="qiskit.transpiler.StagedPassManager" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.3/qiskit/transpiler/passmanager.py#L260-L451" signature="qiskit.transpiler.StagedPassManager(stages=None, **kwargs)" modifiers="class">
  ...
  *   [**ValueError**](https://docs.python.org/3/library/exceptions.html#ValueError "(in Python v3.13)") – If an invalid stage name is specified.
  ...
  <Function id="qiskit.transpiler.StagedPassManager.append" github="https://github.com/Qiskit/qiskit/tree/stable/1.3/qiskit/transpiler/passmanager.py#L397-L401" signature="append(passes)">
    ...
    **passes** (*Task |* [*list*](https://docs.python.org/3/library/stdtypes.html#list "(in Python v3.13)")*\[qiskit.passmanager.base\_tasks.Task]*) – A set of transpiler passes to be added to schedule.
  ...
  <Function id="qiskit.transpiler.StagedPassManager.replace" github="https://github.com/Qiskit/qiskit/tree/stable/1.3/qiskit/transpiler/passmanager.py#L403-L408" signature="replace(index, passes)">
    ...
    *   **passes** (*BasePass |* [*list*](https://docs.python.org/3/library/stdtypes.html#list "(in Python v3.13)")*\[qiskit.transpiler.basepasses.BasePass]*) – A pass set to be added to the pass manager schedule.
  ...
  <Function id="qiskit.transpiler.StagedPassManager.run" github="https://github.com/Qiskit/qiskit/tree/stable/1.3/qiskit/transpiler/passmanager.py#L433-L441" signature="run(circuits, output_name=None, callback=None, num_processes=None)">
    ...
    *   **callback** ([*Callable*](https://docs.python.org/3/library/collections.abc.html#collections.abc.Callable "(in Python v3.13)") *| None*) –
