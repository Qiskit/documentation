...
<Class id="qiskit.transpiler.passes.AlignMeasures" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.1/qiskit/transpiler/passes/scheduling/alignments/align_measures.py#L32-L207" signature="qiskit.transpiler.passes.AlignMeasures(*args, **kwargs)">
