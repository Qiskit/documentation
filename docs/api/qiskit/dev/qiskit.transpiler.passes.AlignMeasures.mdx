...
<Class id="qiskit.transpiler.passes.AlignMeasures" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/transpiler/passes/scheduling/alignments/align_measures.py#L32-L207" signature="qiskit.transpiler.passes.AlignMeasures(*args, **kwargs)">
