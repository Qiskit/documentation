...
<Class id="qiskit.transpiler.passes.AlignMeasures" github="https://github.com/qiskit/qiskit/tree/main/qiskit/transpiler/passes/scheduling/alignments/align_measures.py" signature="qiskit.transpiler.passes.AlignMeasures(*args, **kwargs)">
