...
<Function id="qiskit.pulse.library.Triangle" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/main/qiskit/pulse/library/symbolic_pulses.py#L1685-L1750" signature="qiskit.pulse.library.Triangle(duration, amp, phase, freq=None, angle=0.0, name=None, limit_amplitude=None)">
