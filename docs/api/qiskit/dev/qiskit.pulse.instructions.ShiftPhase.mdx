...
<Class id="qiskit.pulse.instructions.ShiftPhase" github="https://github.com/qiskit/qiskit/tree/main/qiskit/pulse/instructions/phase.py" signature="qiskit.pulse.instructions.ShiftPhase(phase, channel, name=None)">
