...
<Class id="qiskit.circuit.library.WeightedAdder" github="https://github.com/qiskit/qiskit/tree/main/qiskit/circuit/library/arithmetic/weighted_adder.py" signature="qiskit.circuit.library.WeightedAdder(num_state_qubits=None, weights=None, name='adder')">
