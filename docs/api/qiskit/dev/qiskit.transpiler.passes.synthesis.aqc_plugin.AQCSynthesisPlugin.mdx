...
<Class id="qiskit.transpiler.passes.synthesis.aqc_plugin.AQCSynthesisPlugin" github="https://github.com/qiskit/qiskit/tree/main/qiskit/transpiler/passes/synthesis/aqc_plugin.py" signature="qiskit.transpiler.passes.synthesis.aqc_plugin.AQCSynthesisPlugin">
