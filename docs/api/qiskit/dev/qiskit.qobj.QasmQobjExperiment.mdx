---
title: QasmQobjExperiment (dev version)
description: API reference for qiskit.qobj.QasmQobjExperiment in the dev version of qiskit
...
<Class id="qiskit.qobj.QasmQobjExperiment" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.3/qiskit/qobj/qasm_qobj.py#L205-L290" signature="qiskit.qobj.QasmQobjExperiment(config=None, header=None, instructions=None)" modifiers="class">
  ...
  *   **instructions** ([*list*](https://docs.python.org/3/library/stdtypes.html#list "(in Python v3.13)")) – A list of [`QasmQobjInstruction`](qiskit.qobj.QasmQobjInstruction "qiskit.qobj.QasmQobjInstruction") objects
  ...
  <Function id="qiskit.qobj.QasmQobjExperiment.from_dict" github="https://github.com/Qiskit/qiskit/tree/stable/1.3/qiskit/qobj/qasm_qobj.py#L263-L284" signature="from_dict(data)" modifiers="classmethod">
  ...
  <Function id="qiskit.qobj.QasmQobjExperiment.to_dict" github="https://github.com/Qiskit/qiskit/tree/stable/1.3/qiskit/qobj/qasm_qobj.py#L250-L261" signature="to_dict()">
