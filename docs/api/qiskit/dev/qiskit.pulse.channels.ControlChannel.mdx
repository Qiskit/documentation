...
<Class id="qiskit.pulse.channels.ControlChannel" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.1/qiskit/pulse/channels.py#L189-L195" signature="qiskit.pulse.channels.ControlChannel(*args, **kwargs)">
  Bases: `PulseChannel`
