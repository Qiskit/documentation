...
<Class id="qiskit.primitives.StatevectorEstimator" github="https://github.com/qiskit/qiskit/tree/main/qiskit/primitives/statevector_estimator.py" signature="qiskit.primitives.StatevectorEstimator(*, default_precision=0.0, seed=None)">
