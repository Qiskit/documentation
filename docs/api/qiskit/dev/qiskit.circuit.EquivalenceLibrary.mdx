...
<Class id="qiskit.circuit.EquivalenceLibrary" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/circuit/equivalence.py#L32-L267" signature="qiskit.circuit.EquivalenceLibrary(*, base=None)">
