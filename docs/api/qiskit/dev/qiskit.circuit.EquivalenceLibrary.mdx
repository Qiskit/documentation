...
<Class id="qiskit.circuit.EquivalenceLibrary" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/main/qiskit/circuit/equivalence.py#L29-L98" signature="qiskit.circuit.EquivalenceLibrary(base=None)" modifiers="class">
  ...
  <Function id="qiskit.circuit.EquivalenceLibrary.draw" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/circuit/equivalence.py#L33-L62" signature="draw(filename=None)">
