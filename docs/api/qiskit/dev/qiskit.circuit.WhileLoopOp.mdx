...
<Class id="qiskit.circuit.WhileLoopOp" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/circuit/controlflow/while_loop.py#L29-L97" signature="qiskit.circuit.WhileLoopOp(condition, body, label=None)">
