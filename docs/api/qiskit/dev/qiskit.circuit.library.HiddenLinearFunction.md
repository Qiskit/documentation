...
`qiskit.circuit.library.HiddenLinearFunction(adjacency_matrix)` [GitHub](https://github.com/qiskit/qiskit/tree/main/qiskit/circuit/library/hidden_linear_function.py "view source code")
...
> ![../\_images/qiskit-circuit-library-HiddenLinearFunction-1.png](/images/api/qiskit/dev/qiskit-circuit-library-HiddenLinearFunction-1.png)
...
<span id="qiskit.circuit.library.HiddenLinearFunction.num_captured_vars" />
...
<span id="qiskit.circuit.library.HiddenLinearFunction.num_declared_vars" />
...
<span id="qiskit.circuit.library.HiddenLinearFunction.num_input_vars" />
...
<span id="qiskit.circuit.library.HiddenLinearFunction.num_vars" />
