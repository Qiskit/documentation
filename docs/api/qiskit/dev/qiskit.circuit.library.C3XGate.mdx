...
<Class id="qiskit.circuit.library.C3XGate" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/main/qiskit/circuit/library/standard_gates/x.py#L556-L642" signature="qiskit.circuit.library.C3XGate(*args, _force_mutable=False, **kwargs)" modifiers="class">
  ...
  <Function id="qiskit.circuit.library.C3XGate.broadcast_arguments" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/circuit/gate.py#L199-L256" signature="broadcast_arguments(qargs, cargs)">
  ...
  <Function id="qiskit.circuit.library.C3XGate.validate_parameter" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/circuit/gate.py#L258-L272" signature="validate_parameter(parameter)">
