...
<Class id="qiskit.circuit.library.C3XGate" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/main/qiskit/circuit/library/standard_gates/x.py#L671-L828" signature="qiskit.circuit.library.C3XGate(*args, _force_mutable=False, **kwargs)">
  ...
  <Attribute id="qiskit.circuit.library.C3XGate.base_class" name="base_class">
  ...
  <Attribute id="qiskit.circuit.library.C3XGate.condition" name="condition">
  ...
  <Attribute id="qiskit.circuit.library.C3XGate.mutable" name="mutable">
  ...
  <Function id="qiskit.circuit.library.C3XGate.control" name="control" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/circuit/library/standard_gates/x.py#L775-L811" signature="control(num_ctrl_qubits=1, label=None, ctrl_state=None, annotated=False)">
  ...
  <Function id="qiskit.circuit.library.C3XGate.inverse" name="inverse" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/circuit/library/standard_gates/x.py#L813-L825" signature="inverse(annotated=False)">
