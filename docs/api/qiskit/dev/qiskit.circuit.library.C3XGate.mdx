...
<Class id="qiskit.circuit.library.C3XGate" github="https://github.com/qiskit/qiskit/tree/main/qiskit/circuit/library/standard_gates/x.py" signature="qiskit.circuit.library.C3XGate(*args, _force_mutable=False, **kwargs)">
