...
<Class id="qiskit.circuit.library.LinearFunction" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/circuit/library/generalized_gates/linear_function.py#L26-L311" signature="qiskit.circuit.library.LinearFunction(linear, validate_input=False)">
