...
<Function id="qiskit.visualization.plot_state_city" name="plot_state_city" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/main/qiskit/visualization/state_visualization.py" signature="qiskit.visualization.plot_state_city(state, title='', figsize=None, color=None, alpha=1, ax_real=None, ax_imag=None, *, filename=None)">
