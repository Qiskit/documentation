...
<Class id="qiskit.circuit.library.FullAdderGate" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/main/qiskit/circuit/library/arithmetic/adders/adder.py#L186-L238" signature="qiskit.circuit.library.FullAdderGate(num_state_qubits, label=None)" modifiers="class">
