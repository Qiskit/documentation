...
<Class id="qiskit.transpiler.passes.RemoveFinalReset" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/main/qiskit/transpiler/passes/optimization/remove_final_reset.py#L20-L37" signature="qiskit.transpiler.passes.RemoveFinalReset(*args, **kwargs)" modifiers="class">
  ...
  <Function id="qiskit.transpiler.passes.RemoveFinalReset.execute" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/transpiler/basepasses.py#L189-L208" signature="execute(passmanager_ir, state, callback=None)">
  ...
  <Function id="qiskit.transpiler.passes.RemoveFinalReset.update_status" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/transpiler/basepasses.py#L210-L218" signature="update_status(state, run_state)">
