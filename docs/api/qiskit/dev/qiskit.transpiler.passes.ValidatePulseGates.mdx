...
<Class id="qiskit.transpiler.passes.ValidatePulseGates" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/transpiler/passes/scheduling/alignments/pulse_gate_validation.py#L22-L105" signature="qiskit.transpiler.passes.ValidatePulseGates(*args, **kwargs)">
