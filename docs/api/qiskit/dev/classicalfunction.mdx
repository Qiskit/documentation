...
description: API reference for qiskit.circuit.classicalfunction in the dev version of qiskit
...
<Function id="qiskit.circuit.classicalfunction.classical_function" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/circuit/classicalfunction/__init__.py#L126-L142" signature="qiskit.circuit.classicalfunction.classical_function(func)">
