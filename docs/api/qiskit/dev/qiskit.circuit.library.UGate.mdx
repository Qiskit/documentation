...
<Class id="qiskit.circuit.library.UGate" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.1/qiskit/circuit/library/standard_gates/u.py#L26-L157" signature="qiskit.circuit.library.UGate(theta, phi, lam, label=None, *, duration=None, unit='dt')">
