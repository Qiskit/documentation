...
<Class id="qiskit.circuit.library.UGate" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/circuit/library/standard_gates/u.py#L26-L155" signature="qiskit.circuit.library.UGate(theta, phi, lam, label=None, *, duration=None, unit='dt')">
