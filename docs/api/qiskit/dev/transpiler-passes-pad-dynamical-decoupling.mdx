...
description: API reference for qiskit.transpiler.passes.PadDynamicalDecoupling in the dev version of qiskit
...
<Class id="qiskit.transpiler.passes.PadDynamicalDecoupling" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/main/qiskit/transpiler/passes/scheduling/padding/dynamical_decoupling.py#L37-L446" signature="qiskit.transpiler.passes.PadDynamicalDecoupling(*args, **kwargs)" modifiers="class">
  Bases: `BasePadding`
  ...
  ![Output from the previous code.](/images/api/qiskit/dev/qiskit-transpiler-passes-PadDynamicalDecoupling-1_00.avif)

  ![Output from the previous code.](/images/api/qiskit/dev/qiskit-transpiler-passes-PadDynamicalDecoupling-1_01.avif)
