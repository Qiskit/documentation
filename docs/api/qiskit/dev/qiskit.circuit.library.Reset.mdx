...
<Class id="qiskit.circuit.library.Reset" github="https://github.com/qiskit/qiskit/tree/main/qiskit/circuit/reset.py" signature="qiskit.circuit.library.Reset(*args, _force_mutable=False, **kwargs)">
  ...
  <Function id="qiskit.circuit.library.Reset.inverse" name="inverse" signature="inverse(annotated=False)">
