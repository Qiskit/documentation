...
<Class id="qiskit.quantum_info.Z2Symmetries" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/main/qiskit/quantum_info/analysis/z2_symmetries.py#L29-L416" signature="qiskit.quantum_info.Z2Symmetries(symmetries, sq_paulis, sq_list, tapering_values=None, *, tol=1e-14)">
  ...
  **Raises**
  ...
  <Function id="qiskit.quantum_info.Z2Symmetries.find_z2_symmetries" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/quantum_info/analysis/z2_symmetries.py#L180-L301" signature="classmethod find_z2_symmetries(operator)">
