...
<Function id="qiskit.converters.dag_to_circuit" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/converters/dag_to_circuit.py#L19-L73" signature="qiskit.converters.dag_to_circuit(dag, copy_operations=True)">
