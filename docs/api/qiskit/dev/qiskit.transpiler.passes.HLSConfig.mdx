...
<Class id="qiskit.transpiler.passes.HLSConfig" github="https://github.com/qiskit/qiskit/tree/main/qiskit/transpiler/passes/synthesis/high_level_synthesis.py" signature="qiskit.transpiler.passes.HLSConfig(use_default_on_unspecified=True, **kwargs)">
