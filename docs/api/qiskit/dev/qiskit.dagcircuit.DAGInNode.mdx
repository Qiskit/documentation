...
<Class id="qiskit.dagcircuit.DAGInNode" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/dagcircuit/dagnode.py#L299-L314" signature="qiskit.dagcircuit.DAGInNode(wire)">
