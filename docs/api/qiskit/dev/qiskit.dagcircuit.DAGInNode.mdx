...
<Class id="qiskit.dagcircuit.DAGInNode" github="https://github.com/qiskit/qiskit/tree/main/qiskit/dagcircuit/dagnode.py" signature="qiskit.dagcircuit.DAGInNode(wire)">
