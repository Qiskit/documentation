---
title: QobjMeasurementOption (dev version)
description: API reference for qiskit.qobj.QobjMeasurementOption in the dev version of qiskit
...
<Class id="qiskit.qobj.QobjMeasurementOption" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/main/qiskit/qobj/pulse_qobj.py#L29-L79" signature="qiskit.qobj.QobjMeasurementOption(name, params=None)" modifiers="class">
  ...
  *   **params** ([*list*](https://docs.python.org/3/library/stdtypes.html#list "(in Python v3.13)")) – The parameters of the measurement option.
  ...
  <Function id="qiskit.qobj.QobjMeasurementOption.from_dict" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/qobj/pulse_qobj.py#L62-L73" signature="from_dict(data)" modifiers="classmethod">
  ...
  <Function id="qiskit.qobj.QobjMeasurementOption.to_dict" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/qobj/pulse_qobj.py#L51-L60" signature="to_dict()">
