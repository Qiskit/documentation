...
<Class id="qiskit.circuit.library.XXPlusYYGate" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/2.0/qiskit/circuit/library/standard_gates/xx_plus_yy.py#L30-L236" signature="qiskit.circuit.library.XXPlusYYGate(theta, beta=0, label='(XX+YY)')" modifiers="class">
...
$$
  ...
  *   **label** (*Optional\[*[*str*](https://docs.python.org/3/library/stdtypes.html#str "(in Python v3.13)")*]*) – The label of the gate.
  ...
  <Function id="qiskit.circuit.library.XXPlusYYGate.control" github="https://github.com/Qiskit/qiskit/tree/stable/2.0/qiskit/circuit/library/standard_gates/xx_plus_yy.py#L163-L194" signature="control(num_ctrl_qubits=1, label=None, ctrl_state=None, annotated=None)">
  ...
  <Function id="qiskit.circuit.library.XXPlusYYGate.inverse" github="https://github.com/Qiskit/qiskit/tree/stable/2.0/qiskit/circuit/library/standard_gates/xx_plus_yy.py#L196-L209" signature="inverse(annotated=False)">
  ...
  <Function id="qiskit.circuit.library.XXPlusYYGate.power" github="https://github.com/Qiskit/qiskit/tree/stable/2.0/qiskit/circuit/library/standard_gates/xx_plus_yy.py#L229-L231" signature="power(exponent, annotated=False)">
