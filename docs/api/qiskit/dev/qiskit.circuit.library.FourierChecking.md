...
`qiskit.circuit.library.FourierChecking(f, g)` [GitHub](https://github.com/qiskit/qiskit/tree/main/qiskit/circuit/library/fourier_checking.py "view source code")
...
![../\_images/qiskit-circuit-library-FourierChecking-1.png](/images/api/qiskit/dev/qiskit-circuit-library-FourierChecking-1.png)
...
<span id="qiskit.circuit.library.FourierChecking.num_captured_vars" />
...
<span id="qiskit.circuit.library.FourierChecking.num_declared_vars" />
...
<span id="qiskit.circuit.library.FourierChecking.num_input_vars" />
...
<span id="qiskit.circuit.library.FourierChecking.num_vars" />
