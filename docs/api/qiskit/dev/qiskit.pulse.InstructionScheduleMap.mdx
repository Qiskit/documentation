...
<Class id="qiskit.pulse.InstructionScheduleMap" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/main/qiskit/pulse/instruction_schedule_map.py#L52-L387" signature="qiskit.pulse.InstructionScheduleMap" modifiers="class">
  ...
  <Function id="qiskit.pulse.InstructionScheduleMap.assert_has" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/pulse/instruction_schedule_map.py#L158-L177" signature="assert_has(instruction, qubits)">
  ...
  <Function id="qiskit.pulse.InstructionScheduleMap.get_parameters" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/pulse/instruction_schedule_map.py#L344-L363" signature="get_parameters(instruction, qubits)">
