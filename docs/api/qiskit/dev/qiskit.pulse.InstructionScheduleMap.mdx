...
<Class id="qiskit.pulse.InstructionScheduleMap" github="https://github.com/qiskit/qiskit/tree/main/qiskit/pulse/instruction_schedule_map.py" signature="qiskit.pulse.InstructionScheduleMap">
