...
<Class id="qiskit.pulse.InstructionScheduleMap" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.1/qiskit/pulse/instruction_schedule_map.py#L51-L384" signature="qiskit.pulse.InstructionScheduleMap">
