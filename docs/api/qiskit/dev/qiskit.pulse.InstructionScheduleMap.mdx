...
<Class id="qiskit.pulse.InstructionScheduleMap" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/pulse/instruction_schedule_map.py#L51-L384" signature="qiskit.pulse.InstructionScheduleMap">
