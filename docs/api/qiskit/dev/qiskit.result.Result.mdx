...
<Class id="qiskit.result.Result" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/main/qiskit/result/result.py#L26-L385" signature="qiskit.result.Result(*, backend_name=None, backend_version=None, job_id=None, success=None, results=None, date=None, status=None, header=None, **kwargs)" modifiers="class">
  ...
  <Function id="qiskit.result.Result.get_counts" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/result/result.py#L232-L282" signature="get_counts(experiment=None)">
    ...
    **experiment** ([*str*](https://docs.python.org/3/library/stdtypes.html#str)  *or*[*QuantumCircuit*](/docs/api/qiskit/dev/qiskit.circuit.QuantumCircuit "qiskit.circuit.QuantumCircuit")  *or*[*int*](https://docs.python.org/3/library/functions.html#int) *or None*) – the index of the experiment, as specified by `data([experiment])`.
  ...
  <Function id="qiskit.result.Result.get_memory" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/result/result.py#L178-L230" signature="get_memory(experiment=None)">
    ...
    **experiment** ([*str*](https://docs.python.org/3/library/stdtypes.html#str)  *or*[*QuantumCircuit*](/docs/api/qiskit/dev/qiskit.circuit.QuantumCircuit "qiskit.circuit.QuantumCircuit")  *or*[*int*](https://docs.python.org/3/library/functions.html#int) *or None*) – the index of the experiment, as specified by `data()`.
