...
`qiskit.circuit.library.GRZ(num_qubits, phi)` [GitHub](https://github.com/qiskit/qiskit/tree/main/qiskit/circuit/library/generalized_gates/gr.py "view source code")
...
![../\_images/qiskit-circuit-library-GRZ-1.png](/images/api/qiskit/dev/qiskit-circuit-library-GRZ-1.png)
...
<span id="qiskit.circuit.library.GRZ.num_captured_vars" />
...
<span id="qiskit.circuit.library.GRZ.num_declared_vars" />
...
<span id="qiskit.circuit.library.GRZ.num_input_vars" />
...
<span id="qiskit.circuit.library.GRZ.num_vars" />
