...
<Class id="qiskit.providers.fake_provider.FakeOpenPulse2Q" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.1/qiskit/providers/fake_provider/fake_openpulse_2q.py#L31-L383" signature="qiskit.providers.fake_provider.FakeOpenPulse2Q">
