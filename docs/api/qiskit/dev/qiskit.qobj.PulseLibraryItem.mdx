...
<Class id="qiskit.qobj.PulseLibraryItem" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/qobj/pulse_qobj.py#L492-L539" signature="qiskit.qobj.PulseLibraryItem(name, samples)">
