...
<Class id="qiskit.dagcircuit.DAGNode" github="https://github.com/qiskit/qiskit/tree/main/qiskit/dagcircuit/dagnode.py" signature="qiskit.dagcircuit.DAGNode(nid=-1)">
