...
<Class id="qiskit.dagcircuit.DAGNode" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/main/qiskit/dagcircuit/dagnode.py#L178-L255" signature="qiskit.dagcircuit.DAGNode(nid=-1)">
  ...
  <Function id="qiskit.dagcircuit.DAGNode.semantic_eq" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/dagcircuit/dagnode.py#L198-L255" signature="static semantic_eq(node1, node2, bit_indices1, bit_indices2)">
