...
<Class id="qiskit.dagcircuit.DAGOutNode" github="https://github.com/qiskit/qiskit/tree/main/qiskit/dagcircuit/dagnode.py" signature="qiskit.dagcircuit.DAGOutNode(wire)">
