...
<Class id="qiskit.dagcircuit.DAGOutNode" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/main/qiskit/dagcircuit/dagnode.py#L317-L332" signature="qiskit.dagcircuit.DAGOutNode(wire)">
  ...
  <Function id="qiskit.dagcircuit.DAGOutNode.semantic_eq" name="semantic_eq" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/dagcircuit/dagnode.py#L198-L255" signature="static semantic_eq(node1, node2, bit_indices1, bit_indices2)">
