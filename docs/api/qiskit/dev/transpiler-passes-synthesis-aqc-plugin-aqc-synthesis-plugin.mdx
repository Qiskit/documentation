---
title: AQCSynthesisPlugin (dev version)
description: API reference for qiskit.transpiler.passes.synthesis.aqc_plugin.AQCSynthesisPlugin in the dev version of qiskit
