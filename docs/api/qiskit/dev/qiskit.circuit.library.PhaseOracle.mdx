...
<Class id="qiskit.circuit.library.PhaseOracle" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/main/qiskit/circuit/library/phase_oracle.py#L28-L153" signature="qiskit.circuit.library.PhaseOracle(expression, synthesizer=None, var_order=None)">
  ...
  *   **var\_order** ([*list*](https://docs.python.org/3/library/stdtypes.html#list "(in Python v3.12)")) – A list with the order in which variables will be created. (default: by appearance)
  ...
  <Attribute id="qiskit.circuit.library.PhaseOracle.ancillas" name="ancillas">
    Returns a list of ancilla bits in the order that the registers were added.
  </Attribute>

  ### calibrations

  <Attribute id="qiskit.circuit.library.PhaseOracle.calibrations" name="calibrations">
  ...
  <Attribute id="qiskit.circuit.library.PhaseOracle.clbits" name="clbits">
    Returns a list of classical bits in the order that the registers were added.
  </Attribute>

  ### data

  <Attribute id="qiskit.circuit.library.PhaseOracle.data" name="data">
  ...
  <Attribute id="qiskit.circuit.library.PhaseOracle.global_phase" name="global_phase">
    Return the global phase of the current circuit scope in radians.
  </Attribute>

  ### instances

  <Attribute id="qiskit.circuit.library.PhaseOracle.instances" name="instances" attributeValue="= 261" />

  ### layout

  <Attribute id="qiskit.circuit.library.PhaseOracle.layout" name="layout">
  ...
  <Attribute id="qiskit.circuit.library.PhaseOracle.metadata" name="metadata">
  ...
  <Attribute id="qiskit.circuit.library.PhaseOracle.num_ancillas" name="num_ancillas">
    Return the number of ancilla qubits.
  </Attribute>

  ### num\_captured\_vars

  <Attribute id="qiskit.circuit.library.PhaseOracle.num_captured_vars" name="num_captured_vars">
  ...
  <Attribute id="qiskit.circuit.library.PhaseOracle.num_clbits" name="num_clbits">
    Return number of classical bits.
  </Attribute>

  ### num\_declared\_vars

  <Attribute id="qiskit.circuit.library.PhaseOracle.num_declared_vars" name="num_declared_vars">
  ...
  <Attribute id="qiskit.circuit.library.PhaseOracle.num_input_vars" name="num_input_vars">
  ...
  <Attribute id="qiskit.circuit.library.PhaseOracle.num_parameters" name="num_parameters">
    The number of parameter objects in the circuit.
  </Attribute>

  ### num\_qubits

  <Attribute id="qiskit.circuit.library.PhaseOracle.num_qubits" name="num_qubits">
    Return number of qubits.
  </Attribute>

  ### num\_vars

  <Attribute id="qiskit.circuit.library.PhaseOracle.num_vars" name="num_vars">
  ...
  <Attribute id="qiskit.circuit.library.PhaseOracle.op_start_times" name="op_start_times">
  ...
  <Attribute id="qiskit.circuit.library.PhaseOracle.parameters" name="parameters">
  ...
  <Attribute id="qiskit.circuit.library.PhaseOracle.prefix" name="prefix" attributeValue="= 'circuit'" />

  ### qubits

  <Attribute id="qiskit.circuit.library.PhaseOracle.qubits" name="qubits">
  ...
  <Function id="qiskit.circuit.library.PhaseOracle.evaluate_bitstring" name="evaluate_bitstring" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/circuit/library/phase_oracle.py#L92-L103" signature="evaluate_bitstring(bitstring)">
  ...
  <Function id="qiskit.circuit.library.PhaseOracle.from_dimacs_file" name="from_dimacs_file" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/circuit/library/phase_oracle.py#L105-L153" signature="classmethod from_dimacs_file(filename)">
