...
<Class id="qiskit.circuit.library.PhaseOracle" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/circuit/library/phase_oracle.py#L28-L153" signature="qiskit.circuit.library.PhaseOracle(expression, synthesizer=None, var_order=None)">
