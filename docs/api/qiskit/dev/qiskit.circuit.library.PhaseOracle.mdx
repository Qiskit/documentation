...
<Class id="qiskit.circuit.library.PhaseOracle" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/main/qiskit/circuit/library/phase_oracle.py#L26-L144" signature="qiskit.circuit.library.PhaseOracle(expression, var_order=None)" modifiers="class">
...
$$
  ...
  *   **expression** ([*str*](https://docs.python.org/3/builtins/stdtypes.html#str) *| BooleanExpression*) – A Python-like boolean expression string or a BooleanExpression object.
  *   **var\_order** ([*list*](https://docs.python.org/3/builtins/stdtypes.html#list)*\[*[*str*](https://docs.python.org/3/builtins/stdtypes.html#str)*] | None*) – A list with the order in which variables will be created. (default: by appearance)

  ## Attributes

  ### name

  <Attribute id="qiskit.circuit.library.PhaseOracle.name">
  ...
  <Function id="qiskit.circuit.library.PhaseOracle.evaluate_bitstring" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/circuit/library/phase_oracle.py#L83-L94" signature="evaluate_bitstring(bitstring)">
    Evaluate the oracle on a bitstring. This evaluation is done classically without any quantum circuit.

    **Parameters**

    **bitstring** ([*str*](https://docs.python.org/3/builtins/stdtypes.html#str)) – The bitstring for which to evaluate. The input bitstring is expected to be in little-endian order.
  ...
  <Function id="qiskit.circuit.library.PhaseOracle.from_dimacs_file" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/circuit/library/phase_oracle.py#L96-L144" signature="from_dimacs_file(filename)" modifiers="classmethod">
    ...
    **filename** ([*str*](https://docs.python.org/3/builtins/stdtypes.html#str)) – A file in DIMACS format.
