...
<Class id="qiskit.primitives.BitArray" github="https://github.com/qiskit/qiskit/tree/main/qiskit/primitives/containers/bit_array.py" signature="qiskit.primitives.BitArray(array, num_bits)">
  Bases: `ShapedMixin`
