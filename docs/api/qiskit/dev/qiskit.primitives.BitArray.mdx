...
<Class id="qiskit.primitives.BitArray" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.3/qiskit/primitives/containers/bit_array.py#L59-L741" signature="qiskit.primitives.BitArray(array, num_bits)" modifiers="class">
  ...
  *   [**ValueError**](https://docs.python.org/3/library/exceptions.html#ValueError "(in Python v3.13)") – If the input array has fewer than two axes, or the size of the last axis is not the smallest number of bytes that can contain `num_bits`.
  ...
  <Function id="qiskit.primitives.BitArray.slice_bits" github="https://github.com/Qiskit/qiskit/tree/stable/1.3/qiskit/primitives/containers/bit_array.py#L418-L453" signature="slice_bits(indices)">
    ...
    **indices** ([*int*](https://docs.python.org/3/library/functions.html#int "(in Python v3.13)")  *|*[*Sequence*](https://docs.python.org/3/library/typing.html#typing.Sequence "(in Python v3.13)")*\[*[*int*](https://docs.python.org/3/library/functions.html#int "(in Python v3.13)")*]*) – The bit positions of interest to slice along.
  ...
  <Function id="qiskit.primitives.BitArray.slice_shots" github="https://github.com/Qiskit/qiskit/tree/stable/1.3/qiskit/primitives/containers/bit_array.py#L455-L476" signature="slice_shots(indices)">
    ...
    **indices** ([*int*](https://docs.python.org/3/library/functions.html#int "(in Python v3.13)")  *|*[*Sequence*](https://docs.python.org/3/library/typing.html#typing.Sequence "(in Python v3.13)")*\[*[*int*](https://docs.python.org/3/library/functions.html#int "(in Python v3.13)")*]*) – The shots positions of interest to slice along.
