...
<Class id="qiskit.primitives.BitArray" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/main/qiskit/primitives/containers/bit_array.py#L40-L349" signature="qiskit.primitives.BitArray(array, num_bits)">
  Bases: `ShapedMixin`
  ...
  *   [**ValueError**](https://docs.python.org/3/library/exceptions.html#ValueError "(in Python v3.12)") – If the input array has fewer than two axes, or the size of the last axis is not the smallest number of bytes that can contain `num_bits`.
  ...
  <Function id="qiskit.primitives.BitArray.bitcount" name="bitcount" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/primitives/containers/bit_array.py#L153-L159" signature="bitcount()">
  ...
  <Function id="qiskit.primitives.BitArray.from_bool_array" name="from_bool_array" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/primitives/containers/bit_array.py#L161-L192" signature="static from_bool_array(array, order='big')">
  ...
  <Function id="qiskit.primitives.BitArray.from_counts" name="from_counts" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/primitives/containers/bit_array.py#L194-L235" signature="static from_counts(counts, num_bits=None)">
  ...
  <Function id="qiskit.primitives.BitArray.from_samples" name="from_samples" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/primitives/containers/bit_array.py#L237-L278" signature="static from_samples(samples, num_bits=None)">
  ...
  <Function id="qiskit.primitives.BitArray.get_bitstrings" name="get_bitstrings" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/primitives/containers/bit_array.py#L308-L321" signature="get_bitstrings(loc=None)">
  ...
  <Function id="qiskit.primitives.BitArray.get_counts" name="get_counts" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/primitives/containers/bit_array.py#L280-L292" signature="get_counts(loc=None)">
  ...
  <Function id="qiskit.primitives.BitArray.get_int_counts" name="get_int_counts" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/primitives/containers/bit_array.py#L294-L306" signature="get_int_counts(loc=None)">
  ...
  <Function id="qiskit.primitives.BitArray.reshape" name="reshape" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/primitives/containers/bit_array.py#L323-L349" signature="reshape(*shape)">
