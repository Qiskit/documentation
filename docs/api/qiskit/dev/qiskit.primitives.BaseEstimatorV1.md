...
`qiskit.primitives.BaseEstimatorV1(*, options=None)` [GitHub](https://github.com/qiskit/qiskit/tree/main/qiskit/primitives/base/base_estimator.py "view source code")
...
<span id="qiskit.primitives.BaseEstimatorV1.options" />
...
<span id="qiskit.primitives.BaseEstimatorV1.run" />
...
<span id="qiskit.primitives.BaseEstimatorV1.set_options" />
