...
<Class id="qiskit.circuit.library.IGate" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/circuit/library/standard_gates/i.py#L20-L73" signature="qiskit.circuit.library.IGate(*args, _force_mutable=False, **kwargs)">
