...
<Class id="qiskit.circuit.library.IGate" github="https://github.com/qiskit/qiskit/tree/main/qiskit/circuit/library/standard_gates/i.py" signature="qiskit.circuit.library.IGate(*args, _force_mutable=False, **kwargs)">
