...
<Class id="qiskit.circuit.ContinueLoopOp" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/circuit/controlflow/continue_loop.py#L21-L33" signature="qiskit.circuit.ContinueLoopOp(num_qubits, num_clbits, label=None)">
