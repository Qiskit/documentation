...
<Class id="qiskit.transpiler.passes.VF2PostLayout" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/main/qiskit/transpiler/passes/layout/vf2_post_layout.py#L52-L383" signature="qiskit.transpiler.passes.VF2PostLayout(*args, **kwargs)" modifiers="class">
  ...
  **Raises**
  ...
  <Function id="qiskit.transpiler.passes.VF2PostLayout.run" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/transpiler/passes/layout/vf2_post_layout.py#L142-L361" signature="run(dag)">
