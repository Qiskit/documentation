...
<Class id="qiskit.transpiler.PassManager" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/main/qiskit/transpiler/passmanager.py#L37-L277" signature="qiskit.transpiler.PassManager(passes=(), max_iteration=1000)" modifiers="class">
  ...
  *   **max\_iteration** ([*int*](https://docs.python.org/3/library/functions.html#int "(in Python v3.13)")) – The maximum number of iterations the schedule will be looped if the condition is not met.
  ...
  <Function id="qiskit.transpiler.PassManager.append" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/transpiler/passmanager.py#L147-L159" signature="append(passes)">
  ...
  <Function id="qiskit.transpiler.PassManager.draw" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/transpiler/passmanager.py#L253-L277" signature="draw(filename=None, style=None, raw=False)">
  ...
  <Function id="qiskit.transpiler.PassManager.replace" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/transpiler/passmanager.py#L161-L172" signature="replace(index, passes)">
  ...
  <Function id="qiskit.transpiler.PassManager.run" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/transpiler/passmanager.py#L175-L251" signature="run(circuits, output_name=None, callback=None, num_processes=None, *, property_set=None)">
  ...
  <Function id="qiskit.transpiler.PassManager.to_flow_controller" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/passmanager/passmanager.py#L266-L274" signature="to_flow_controller()">
