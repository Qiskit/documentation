...
<Class id="qiskit.circuit.library.FunctionalPauliRotations" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/main/qiskit/circuit/library/arithmetic/functional_pauli_rotations.py#L21-L112" signature="qiskit.circuit.library.FunctionalPauliRotations(num_state_qubits=None, basis='Y', name='F')" modifiers="class">
  ...
  *   **num\_state\_qubits** ([*int*](https://docs.python.org/3/builtins/functions.html#int) *| None*) – The number of qubits representing the state $|x\rangle$.
  *   **basis** ([*str*](https://docs.python.org/3/builtins/stdtypes.html#str)) – The kind of Pauli rotation to use. Must be ‘X’, ‘Y’ or ‘Z’.
