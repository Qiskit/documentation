...
<Class id="qiskit.transpiler.passes.synthesis.hls_plugins.HalfAdderSynthesisR25" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/main/qiskit/transpiler/passes/synthesis/hls_plugins.py#L1867-L1880" signature="qiskit.transpiler.passes.synthesis.hls_plugins.HalfAdderSynthesisR25" modifiers="class">
  ...
  <Function id="qiskit.transpiler.passes.synthesis.hls_plugins.HalfAdderSynthesisR25.run" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/transpiler/passes/synthesis/hls_plugins.py#L1875-L1880" signature="run(high_level_object, coupling_map=None, target=None, qubits=None, **options)">
