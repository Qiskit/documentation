...
<Class id="qiskit.circuit.library.RXGate" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/main/qiskit/circuit/library/standard_gates/rx.py#L26-L137" signature="qiskit.circuit.library.RXGate(theta, label=None, *, duration=None, unit='dt')">
...
$$
  ...
  <Function id="qiskit.circuit.library.RXGate.control" name="control" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/circuit/library/standard_gates/rx.py#L75-L105" signature="control(num_ctrl_qubits=1, label=None, ctrl_state=None, annotated=False)">
  ...
  <Function id="qiskit.circuit.library.RXGate.inverse" name="inverse" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/circuit/library/standard_gates/rx.py#L107-L121" signature="inverse(annotated=False)">
  ...
  <Function id="qiskit.circuit.library.RXGate.power" name="power" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/circuit/library/standard_gates/rx.py#L129-L132" signature="power(exponent)">
