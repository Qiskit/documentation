...
<Class id="qiskit.circuit.library.RXGate" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/main/qiskit/circuit/library/standard_gates/rx.py#L29-L144" signature="qiskit.circuit.library.RXGate(theta, label=None)" modifiers="class">
...
$$
  ...
  *   **label** (*Optional\[*[*str*](https://docs.python.org/3/library/stdtypes.html#str "(in Python v3.13)")*]*) –
  ...
  <Function id="qiskit.circuit.library.RXGate.control" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/circuit/library/standard_gates/rx.py#L78-L111" signature="control(num_ctrl_qubits=1, label=None, ctrl_state=None, annotated=None)">
  ...
  <Function id="qiskit.circuit.library.RXGate.inverse" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/circuit/library/standard_gates/rx.py#L113-L127" signature="inverse(annotated=False)">
  ...
  <Function id="qiskit.circuit.library.RXGate.power" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/circuit/library/standard_gates/rx.py#L137-L139" signature="power(exponent, annotated=False)">
