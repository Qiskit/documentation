...
$$
  ...
  *   **label** (*Optional\[*[*str*](https://docs.python.org/3/library/stdtypes.html#str)*]*) – An optional label for the gate.
  ...
  <Function id="qiskit.circuit.library.RXGate.broadcast_arguments" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/circuit/gate.py#L199-L256" signature="broadcast_arguments(qargs, cargs)">
  ...
  <Function id="qiskit.circuit.library.RXGate.validate_parameter" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/circuit/gate.py#L258-L272" signature="validate_parameter(parameter)">
