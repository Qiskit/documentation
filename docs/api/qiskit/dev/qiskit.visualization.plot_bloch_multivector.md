...
`qiskit.visualization.plot_bloch_multivector(state, title='', figsize=None, *, reverse_bits=False, filename=None, font_size=None, title_font_size=None, title_pad=1)` [GitHub](https://github.com/qiskit/qiskit/tree/main/qiskit/visualization/state_visualization.py "view source code")
...
![../\_images/qiskit-visualization-plot\_bloch\_multivector-1.png](/images/api/qiskit/dev/qiskit-visualization-plot_bloch_multivector-1.png)
...
![../\_images/qiskit-visualization-plot\_bloch\_multivector-2.png](/images/api/qiskit/dev/qiskit-visualization-plot_bloch_multivector-2.png)
