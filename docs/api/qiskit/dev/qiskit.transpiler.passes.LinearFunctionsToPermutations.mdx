---
title: LinearFunctionsToPermutations (dev version)
description: API reference for qiskit.transpiler.passes.LinearFunctionsToPermutations in the dev version of qiskit
