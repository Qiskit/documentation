...
<Class id="qiskit.circuit.QuantumRegister" github="https://github.com/qiskit/qiskit/tree/main/qiskit/circuit/quantumregister.py" signature="qiskit.circuit.QuantumRegister(size=None, name=None, bits=None)">
  ...
  *   [**CircuitError**](circuit#qiskit.circuit.CircuitError "qiskit.circuit.CircuitError") – if `bits` contained bits of an incorrect type.
  ...
  <Attribute id="qiskit.circuit.QuantumRegister.instances_counter" name="instances_counter" attributeValue="= count(5)" />
