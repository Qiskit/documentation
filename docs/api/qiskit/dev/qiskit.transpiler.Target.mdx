...
<Class id="qiskit.transpiler.Target" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/2.2/qiskit/transpiler/target.py#L93-L945" signature="qiskit.transpiler.Target(description=None, num_qubits=0, dt=None, granularity=1, min_length=1, pulse_alignment=1, acquire_alignment=1, qubit_properties=None, concurrent_measurements=None)" modifiers="class">
  Bases: `BaseTarget`
  ...
  **Raises**
  ...
  <Function id="qiskit.transpiler.Target.add_instruction" github="https://github.com/Qiskit/qiskit/tree/stable/2.2/qiskit/transpiler/target.py#L356-L456" signature="add_instruction(instruction, properties=None, name=None, *, angle_bounds=None)">
  ...
  <Function id="qiskit.transpiler.Target.build_coupling_map" github="https://github.com/Qiskit/qiskit/tree/stable/2.2/qiskit/transpiler/target.py#L610-L676" signature="build_coupling_map(two_q_gate=None, filter_idle_qubits=False)">
  ...
  <Function id="qiskit.transpiler.Target.durations" github="https://github.com/Qiskit/qiskit/tree/stable/2.2/qiskit/transpiler/target.py#L491-L506" signature="durations()">
  ...
  <Function id="qiskit.transpiler.Target.from_configuration" github="https://github.com/Qiskit/qiskit/tree/stable/2.2/qiskit/transpiler/target.py#L778-L945" signature="from_configuration(basis_gates, num_qubits=None, coupling_map=None, instruction_durations=None, concurrent_measurements=None, dt=None, timing_constraints=None, custom_name_mapping=None)" modifiers="classmethod">
  ...
  <Function id="qiskit.transpiler.Target.get" github="https://github.com/Qiskit/qiskit/tree/stable/2.2/qiskit/transpiler/target.py#L692-L697" signature="get(key, default=None)">
    Gets an item from the Target. If not found return a provided default or None.
  </Function>

  ### get\_non\_global\_operation\_names

  <Function id="qiskit.transpiler.Target.get_non_global_operation_names" github="https://github.com/Qiskit/qiskit/tree/stable/2.2/qiskit/transpiler/target.py#L316-L343" signature="get_non_global_operation_names(strict_direction=False)">
  ...
  <Function id="qiskit.transpiler.Target.instruction_properties" github="https://github.com/Qiskit/qiskit/tree/stable/2.2/qiskit/transpiler/target.py#L538-L576" signature="instruction_properties(index)">
  ...
  <Function id="qiskit.transpiler.Target.items" github="https://github.com/Qiskit/qiskit/tree/stable/2.2/qiskit/transpiler/target.py#L713-L715" signature="items()">
    Returns pairs of Gate names and its property map (str, dict\[tuple, InstructionProperties])
  </Function>

  ### keys

  <Function id="qiskit.transpiler.Target.keys" github="https://github.com/Qiskit/qiskit/tree/stable/2.2/qiskit/transpiler/target.py#L705-L707" signature="keys()">
  ...
  <Function id="qiskit.transpiler.Target.qargs_for_operation_name" github="https://github.com/Qiskit/qiskit/tree/stable/2.2/qiskit/transpiler/target.py#L479-L489" signature="qargs_for_operation_name(operation)">
  ...
  <Function id="qiskit.transpiler.Target.seconds_to_dt" github="https://github.com/Qiskit/qiskit/tree/stable/2.2/qiskit/transpiler/target.py#L766-L776" signature="seconds_to_dt(duration)">
  ...
  <Function id="qiskit.transpiler.Target.timing_constraints" github="https://github.com/Qiskit/qiskit/tree/stable/2.2/qiskit/transpiler/target.py#L508-L516" signature="timing_constraints()">
  ...
  <Function id="qiskit.transpiler.Target.update_instruction_properties" github="https://github.com/Qiskit/qiskit/tree/stable/2.2/qiskit/transpiler/target.py#L458-L477" signature="update_instruction_properties(instruction, qargs, properties)">
  ...
  <Function id="qiskit.transpiler.Target.values" github="https://github.com/Qiskit/qiskit/tree/stable/2.2/qiskit/transpiler/target.py#L709-L711" signature="values()">
