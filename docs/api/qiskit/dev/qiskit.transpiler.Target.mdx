...
<Class id="qiskit.transpiler.Target" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/main/qiskit/transpiler/target.py#L139-L1442" signature="qiskit.transpiler.Target(description=None, num_qubits=0, dt=None, granularity=1, min_length=1, pulse_alignment=1, acquire_alignment=1, qubit_properties=None, concurrent_measurements=None)" modifiers="class">
  ...
  **Raises**
  ...
  <Function id="qiskit.transpiler.Target.add_instruction" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/transpiler/target.py#L330-L439" signature="add_instruction(instruction, properties=None, name=None)">
  ...
  <Function id="qiskit.transpiler.Target.build_coupling_map" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/transpiler/target.py#L1017-L1083" signature="build_coupling_map(two_q_gate=None, filter_idle_qubits=False)">
  ...
  <Function id="qiskit.transpiler.Target.durations" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/transpiler/target.py#L597-L612" signature="durations()">
  ...
  <Function id="qiskit.transpiler.Target.from_configuration" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/transpiler/target.py#L1208-L1442" signature="from_configuration(basis_gates, num_qubits=None, coupling_map=None, inst_map=None, backend_properties=None, instruction_durations=None, concurrent_measurements=None, dt=None, timing_constraints=None, custom_name_mapping=None)" modifiers="classmethod">
  ...
  <Function id="qiskit.transpiler.Target.get_calibration" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/transpiler/target.py#L897-L923" signature="get_calibration(operation_name, qargs, *args, **kwargs)">
  ...
  <Function id="qiskit.transpiler.Target.get_non_global_operation_names" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/transpiler/target.py#L1098-L1149" signature="get_non_global_operation_names(strict_direction=False)">
  ...
  <Function id="qiskit.transpiler.Target.has_calibration" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/transpiler/target.py#L876-L895" signature="has_calibration(operation_name, qargs)">
  ...
  <Function id="qiskit.transpiler.Target.instruction_properties" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/transpiler/target.py#L950-L988" signature="instruction_properties(index)">
  ...
  <Function id="qiskit.transpiler.Target.instruction_schedule_map" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/transpiler/target.py#L624-L644" signature="instruction_schedule_map()">
  ...
  <Function id="qiskit.transpiler.Target.instruction_supported" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/transpiler/target.py#L716-L874" signature="instruction_supported(operation_name=None, qargs=None, operation_class=None, parameters=None)">
  ...
  <Function id="qiskit.transpiler.Target.items" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/transpiler/target.py#L1169-L1170" signature="items() → a set-like object providing a view on D's items" />

  ### keys

  <Function id="qiskit.transpiler.Target.keys" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/transpiler/target.py#L1163-L1164" signature="keys() → a set-like object providing a view on D's keys" />

  ### operation\_from\_name

  <Function id="qiskit.transpiler.Target.operation_from_name" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/transpiler/target.py#L646-L657" signature="operation_from_name(instruction)">
  ...
  <Function id="qiskit.transpiler.Target.operation_names_for_qargs" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/transpiler/target.py#L687-L714" signature="operation_names_for_qargs(qargs)">
  ...
  <Function id="qiskit.transpiler.Target.operations_for_qargs" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/transpiler/target.py#L659-L685" signature="operations_for_qargs(qargs)">
  ...
  <Function id="qiskit.transpiler.Target.qargs_for_operation_name" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/transpiler/target.py#L585-L595" signature="qargs_for_operation_name(operation)">
  ...
  <Function id="qiskit.transpiler.Target.timing_constraints" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/transpiler/target.py#L614-L622" signature="timing_constraints()">
  ...
  <Function id="qiskit.transpiler.Target.update_from_instruction_schedule_map" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/transpiler/target.py#L459-L575" signature="update_from_instruction_schedule_map(inst_map, inst_name_map=None, error_dict=None)">
  ...
  <Function id="qiskit.transpiler.Target.update_instruction_properties" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/transpiler/target.py#L441-L457" signature="update_instruction_properties(instruction, qargs, properties)">
  ...
  <Function id="qiskit.transpiler.Target.values" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/transpiler/target.py#L1166-L1167" signature="values() → an object providing a view on D's values" />
</Class>
