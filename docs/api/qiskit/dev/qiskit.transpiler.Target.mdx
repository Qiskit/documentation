...
<Class id="qiskit.transpiler.Target" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/main/qiskit/transpiler/target.py#L87-L950" signature="qiskit.transpiler.Target(description=None, num_qubits=0, dt=None, granularity=1, min_length=1, pulse_alignment=1, acquire_alignment=1, qubit_properties=None, concurrent_measurements=None, **_subclass_kwargs)" modifiers="class">
  Bases: `BaseTarget`
  ...
  **raises ValueError**
  ...
  <Function id="qiskit.transpiler.Target.add_instruction" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/transpiler/target.py#L363-L463" signature="add_instruction(instruction, properties=None, name=None, *, angle_bounds=None)">
  ...
  <Function id="qiskit.transpiler.Target.build_coupling_map" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/transpiler/target.py#L615-L681" signature="build_coupling_map(two_q_gate=None, filter_idle_qubits=False)">
    ...
    *   [**ValueError**](https://docs.python.org/3/builtins/exceptions.html#ValueError) – If a non-two qubit gate is passed in for `two_q_gate`.
    *   [**IndexError**](https://docs.python.org/3/builtins/exceptions.html#IndexError) – If an Instruction not in the `Target` is passed in for `two_q_gate`.
  </Function>

  ### durations

  <Function id="qiskit.transpiler.Target.durations" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/transpiler/target.py#L498-L513" signature="durations()">
  ...
  <Function id="qiskit.transpiler.Target.from_configuration" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/transpiler/target.py#L783-L950" signature="from_configuration(basis_gates, num_qubits=None, coupling_map=None, instruction_durations=None, concurrent_measurements=None, dt=None, timing_constraints=None, custom_name_mapping=None)" modifiers="classmethod">
    ...
    *   **basis\_gates** ([*list*](https://docs.python.org/3/builtins/stdtypes.html#list)*\[*[*str*](https://docs.python.org/3/builtins/stdtypes.html#str)*]*) – The list of basis gate names for the backend. For the target to be created these names must either be in the output from [`get_standard_gate_name_mapping()`](/docs/api/qiskit/dev/circuit_library#qiskit.circuit.library.get_standard_gate_name_mapping "qiskit.circuit.library.get_standard_gate_name_mapping") or present in the specified `custom_name_mapping` argument.
    *   **num\_qubits** ([*int*](https://docs.python.org/3/builtins/functions.html#int) *| None*) – The number of qubits supported on the backend.
    ...
    *   **concurrent\_measurements** ([*list*](https://docs.python.org/3/builtins/stdtypes.html#list)) – A list of sets of qubits that must be measured together. This must be provided as a nested list like `[[0, 1], [2, 3, 4]]`.
    *   **dt** ([*float*](https://docs.python.org/3/builtins/functions.html#float) *| None*) – The system time resolution of input signals in seconds
    ...
    *   [**TranspilerError**](/docs/api/qiskit/dev/transpiler#qiskit.transpiler.TranspilerError "qiskit.transpiler.TranspilerError") – If the input basis gates contain > 2 qubits and `coupling_map` is
    *   **specified.** –
    *   [**KeyError**](https://docs.python.org/3/builtins/exceptions.html#KeyError) – If no mapping is available for a specified `basis_gate`.
  </Function>
  ...
  <Function id="qiskit.transpiler.Target.gate_has_angle_bounds" signature="gate_has_angle_bounds(name)">
    ...
    **name** ([*str*](https://docs.python.org/3/builtins/stdtypes.html#str)) – The instruction name to check if it has an angle bound set
  ...
  <Function id="qiskit.transpiler.Target.get" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/transpiler/target.py#L697-L702" signature="get(key, default=None)">
    Gets an item from the Target. If not found return a provided default or None.
  </Function>

  ### get\_non\_global\_operation\_names

  <Function id="qiskit.transpiler.Target.get_non_global_operation_names" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/transpiler/target.py#L323-L350" signature="get_non_global_operation_names(strict_direction=False)">
    ...
    **Return type**
    ...
    List\[[str](https://docs.python.org/3/builtins/stdtypes.html#str)]
  </Function>
  ...
  <Function id="qiskit.transpiler.Target.instruction_properties" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/transpiler/target.py#L545-L583" signature="instruction_properties(index)">
    ...
    **index** ([*int*](https://docs.python.org/3/builtins/functions.html#int)) – The index of the instruction tuple from the [`instructions`](#qiskit.transpiler.Target.instructions "qiskit.transpiler.Target.instructions") attribute. For, example if you want the properties from the third element in [`instructions`](#qiskit.transpiler.Target.instructions "qiskit.transpiler.Target.instructions") you would set this to be `2`.
  ...
  <Function id="qiskit.transpiler.Target.instruction_supported" signature="instruction_supported(operation_name=None, qargs=Ellipsis, operation_class=None, parameters=None, check_angle_bounds=True)">
    ...
    *   **operation\_name** ([*str*](https://docs.python.org/3/builtins/stdtypes.html#str)) – The name of the operation for the instruction. Either this or `operation_class` must be specified, if both are specified `operation_class` will take priority and this argument will be ignored.

    *   **qargs** ([*tuple*](https://docs.python.org/3/builtins/stdtypes.html#tuple)) – The tuple of qubit indices for the instruction. If this is not specified then this method will return `True` if the specified operation is supported on any qubits. The typical application will always have this set (otherwise it’s the same as just checking if the target contains the operation). Normally you would not set this argument if you wanted to check more generally that the target supports an operation with the `parameters` on any qubits.

    *   **operation\_class** ([*Type*](/docs/api/qiskit/dev/circuit_classical#qiskit.circuit.classical.types.Type "qiskit.circuit.classical.types.Type")*\[*[*qiskit.circuit.Instruction*](qiskit.circuit.Instruction "qiskit.circuit.Instruction")*]*) – The operation class to check whether the target supports a particular operation by class rather than by name. This lookup is more expensive as it needs to iterate over all operations in the target instead of just a single lookup. If this is specified it will supersede the `operation_name` argument. The typical use case for this operation is to check whether a specific variant of an operation is supported on the backend. For example, if you wanted to check whether a [`RXGate`](qiskit.circuit.library.RXGate "qiskit.circuit.library.RXGate") was supported on a specific qubit with a fixed angle. That fixed angle variant will typically have a name different from the object’s [`name`](qiskit.circuit.Instruction#name "qiskit.circuit.Instruction.name") attribute (`"rx"`) in the target. This can be used to check if any instances of the class are available in such a case.

    *   **parameters** ([*list*](https://docs.python.org/3/builtins/stdtypes.html#list)) –
  ...
  <Function id="qiskit.transpiler.Target.items" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/transpiler/target.py#L718-L720" signature="items()">
    Returns pairs of Gate names and its property map (str, dict\[tuple, InstructionProperties])
  </Function>

  ### keys

  <Function id="qiskit.transpiler.Target.keys" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/transpiler/target.py#L710-L712" signature="keys()">
  ...
  <Function id="qiskit.transpiler.Target.operation_from_name" signature="operation_from_name(instruction)">
    ...
    **instruction** ([*str*](https://docs.python.org/3/builtins/stdtypes.html#str)) – The instruction name to get the [`Instruction`](qiskit.circuit.Instruction "qiskit.circuit.Instruction") instance for
  ...
  <Function id="qiskit.transpiler.Target.operation_names_for_qargs" signature="operation_names_for_qargs(qargs, /)">
    ...
    **qargs** ([*tuple*](https://docs.python.org/3/builtins/stdtypes.html#tuple)) – A `qargs` tuple of the qubits to get the gates that apply to it. For example, `(0,)` will return the set of all instructions that apply to qubit 0. If set to `None` this will return the names for any globally defined operations in the target.
    ...
    **Raises**
    ...
    [**KeyError**](https://docs.python.org/3/builtins/exceptions.html#KeyError) – If `qargs` is not in target
  </Function>
  ...
  <Function id="qiskit.transpiler.Target.operations_for_qargs" signature="operations_for_qargs(qargs, /)">
    ...
    **qargs** ([*tuple*](https://docs.python.org/3/builtins/stdtypes.html#tuple)) – A qargs tuple of the qubits to get the gates that apply to it. For example, `(0,)` will return the set of all instructions that apply to qubit 0. If set to `None` this will return any globally defined operations in the target.
  ...
  <Function id="qiskit.transpiler.Target.qargs_for_operation_name" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/transpiler/target.py#L486-L496" signature="qargs_for_operation_name(operation)">
    Get the qargs for a given operation name

    **Parameters**

    **operation** ([*str*](https://docs.python.org/3/builtins/stdtypes.html#str)) – The operation name to get qargs for
  ...
  <Function id="qiskit.transpiler.Target.seconds_to_dt" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/transpiler/target.py#L771-L781" signature="seconds_to_dt(duration)">
    Convert a given duration in seconds to units of dt

    **Parameters**

    **duration** ([*float*](https://docs.python.org/3/builtins/functions.html#float)) – The duration in seconds, such as in an [`InstructionProperties`](qiskit.transpiler.InstructionProperties "qiskit.transpiler.InstructionProperties") field for an instruction in the target.
  ...
  <Function id="qiskit.transpiler.Target.supported_angle_bound" signature="supported_angle_bound(name, angles)">
    ...
    *   **name** ([*str*](https://docs.python.org/3/builtins/stdtypes.html#str)) – The instruction name to check the angle bounds of
    *   **angles** ([*list*](https://docs.python.org/3/builtins/stdtypes.html#list)) – A list of float parameter values for `name` to see if they conform to the defined angle bounds.
    ...
    *   [**TranspilerError**](/docs/api/qiskit/dev/transpiler#qiskit.transpiler.TranspilerError "qiskit.transpiler.TranspilerError") – If `name` is not in the target or does not
    *   **have angle bounds defined.** –
  </Function>

  ### timing\_constraints

  <Function id="qiskit.transpiler.Target.timing_constraints" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/transpiler/target.py#L515-L523" signature="timing_constraints()">
  ...
  <Function id="qiskit.transpiler.Target.update_instruction_properties" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/transpiler/target.py#L465-L484" signature="update_instruction_properties(instruction, qargs, properties)">
    ...
    *   **instruction** ([*str*](https://docs.python.org/3/builtins/stdtypes.html#str)) – The instruction name to update
    *   **qargs** ([*tuple*](https://docs.python.org/3/builtins/stdtypes.html#tuple)) – The qargs to update the properties of
    ...
    **Raises**
    ...
    [**KeyError**](https://docs.python.org/3/builtins/exceptions.html#KeyError) – If `instruction` or `qarg` are not in the target
  </Function>

  ### values

  <Function id="qiskit.transpiler.Target.values" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/transpiler/target.py#L714-L716" signature="values()">
    Return the Property Map (qargs -> InstructionProperties) of every instruction in the Target
  </Function>

  **Parameters**

  *   **description** ([*str*](https://docs.python.org/3/builtins/stdtypes.html#str) *| None*)
  *   **num\_qubits** ([*int*](https://docs.python.org/3/builtins/functions.html#int) *| None*)
  *   **dt** ([*float*](https://docs.python.org/3/builtins/functions.html#float) *| None*)
  *   **granularity** ([*int*](https://docs.python.org/3/builtins/functions.html#int))
  *   **min\_length** ([*int*](https://docs.python.org/3/builtins/functions.html#int))
  *   **pulse\_alignment** ([*int*](https://docs.python.org/3/builtins/functions.html#int))
  *   **acquire\_alignment** ([*int*](https://docs.python.org/3/builtins/functions.html#int))
  *   **qubit\_properties** ([*list*](https://docs.python.org/3/builtins/stdtypes.html#list) *| None*)
  *   **concurrent\_measurements** ([*list*](https://docs.python.org/3/builtins/stdtypes.html#list) *| None*)
</Class>
