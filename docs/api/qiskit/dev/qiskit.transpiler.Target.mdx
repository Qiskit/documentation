...
<Class id="qiskit.transpiler.Target" github="https://github.com/qiskit/qiskit/tree/main/qiskit/transpiler/target.py" signature="qiskit.transpiler.Target(description=None, num_qubits=0, dt=None, granularity=1, min_length=1, pulse_alignment=1, acquire_alignment=1, qubit_properties=None, concurrent_measurements=None)">
