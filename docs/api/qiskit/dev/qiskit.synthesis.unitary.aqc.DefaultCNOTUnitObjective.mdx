...
<Class id="qiskit.synthesis.unitary.aqc.DefaultCNOTUnitObjective" github="https://github.com/qiskit/qiskit/tree/main/qiskit/synthesis/unitary/aqc/cnot_unit_objective.py" signature="qiskit.synthesis.unitary.aqc.DefaultCNOTUnitObjective(num_qubits, cnots)">
