...
`qiskit.circuit.library.UCRXGate(angle_list)` [GitHub](https://github.com/qiskit/qiskit/tree/main/qiskit/circuit/library/generalized_gates/ucrx.py "view source code")
