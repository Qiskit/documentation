...
<Class id="qiskit.circuit.library.Isometry" github="https://github.com/qiskit/qiskit/tree/main/qiskit/circuit/library/generalized_gates/isometry.py" signature="qiskit.circuit.library.Isometry(isometry, num_ancillas_zero, num_ancillas_dirty, epsilon=1e-10)">
  ...
  *   **epsilon** ([*float*](https://docs.python.org/3/library/functions.html#float "(in Python v3.12)")) – Error tolerance of calculations.
  ...
  <Function id="qiskit.circuit.library.Isometry.inv_gate" name="inv_gate" signature="inv_gate()">
    Return the adjoint of the unitary.
  </Function>

  ### inverse

  <Function id="qiskit.circuit.library.Isometry.inverse" name="inverse" signature="inverse(annotated=False)">
  ...
  <Function id="qiskit.circuit.library.Isometry.validate_parameter" name="validate_parameter" signature="validate_parameter(parameter)">
