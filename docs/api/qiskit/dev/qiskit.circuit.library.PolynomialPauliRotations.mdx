...
<Class id="qiskit.circuit.library.PolynomialPauliRotations" github="https://github.com/qiskit/qiskit/tree/main/qiskit/circuit/library/arithmetic/polynomial_pauli_rotations.py" signature="qiskit.circuit.library.PolynomialPauliRotations(num_state_qubits=None, coeffs=None, basis='Y', name='poly')">
...
$$
  ...
  <Attribute id="qiskit.circuit.library.PolynomialPauliRotations.instances" name="instances" attributeValue="= 209" />
