...
<Class id="qiskit.circuit.library.PhaseGate" github="https://github.com/qiskit/qiskit/tree/main/qiskit/circuit/library/standard_gates/p.py" signature="qiskit.circuit.library.PhaseGate(theta, label=None, *, duration=None, unit='dt')">
