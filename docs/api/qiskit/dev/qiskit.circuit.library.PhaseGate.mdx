...
$$
  ...
  **Examples:**
  ...
  <Function id="qiskit.circuit.library.PhaseGate.power" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/circuit/library/standard_gates/p.py#L148-L151" signature="power(exponent)">
