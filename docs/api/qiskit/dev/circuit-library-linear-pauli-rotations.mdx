---
title: LinearPauliRotations (dev version)
description: API reference for qiskit.circuit.library.LinearPauliRotations in the dev version of qiskit
...
$$
  ...
  *   **name** ([*str*](https://docs.python.org/3/library/stdtypes.html#str "(in Python v3.13)")) – The name of the circuit object.
  ...
  <Attribute id="qiskit.circuit.library.LinearPauliRotations.instances" attributeValue="187" />
