...
<Class id="qiskit.primitives.BackendEstimator" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/primitives/backend_estimator.py#L89-L405" signature="qiskit.primitives.BackendEstimator(backend, options=None, abelian_grouping=True, bound_pass_manager=None, skip_transpilation=False)">
