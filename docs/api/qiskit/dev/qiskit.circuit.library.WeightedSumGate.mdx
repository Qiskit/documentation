...
<Class id="qiskit.circuit.library.WeightedSumGate" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/main/qiskit/circuit/library/arithmetic/weighted_adder.py#L361-L428" signature="qiskit.circuit.library.WeightedSumGate(num_state_qubits, weights=None, label=None)" modifiers="class">
