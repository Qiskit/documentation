...
<Class id="qiskit.circuit.library.CRXGate" github="https://github.com/qiskit/qiskit/tree/main/qiskit/circuit/library/standard_gates/rx.py" signature="qiskit.circuit.library.CRXGate(theta, label=None, ctrl_state=None, *, duration=None, unit='dt', _base_label=None)">
