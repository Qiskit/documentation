...
<Class id="qiskit.circuit.library.PiecewisePolynomialPauliRotations" github="https://github.com/qiskit/qiskit/tree/main/qiskit/circuit/library/arithmetic/piecewise_polynomial_pauli_rotations.py" signature="qiskit.circuit.library.PiecewisePolynomialPauliRotations(num_state_qubits=None, breakpoints=None, coeffs=None, basis='Y', name='pw_poly')">
...
$$
  ...
  *   **name** ([*str*](https://docs.python.org/3/library/stdtypes.html#str "(in Python v3.12)")) – The name of the circuit.
  ...
  <Attribute id="qiskit.circuit.library.PiecewisePolynomialPauliRotations.ancillas" name="ancillas">
    Returns a list of ancilla bits in the order that the registers were added.
  </Attribute>

  ### basis

  <Attribute id="qiskit.circuit.library.PiecewisePolynomialPauliRotations.basis" name="basis">
  ...
  <Attribute id="qiskit.circuit.library.PiecewisePolynomialPauliRotations.breakpoints" name="breakpoints">
  ...
  <Attribute id="qiskit.circuit.library.PiecewisePolynomialPauliRotations.calibrations" name="calibrations">
  ...
  <Attribute id="qiskit.circuit.library.PiecewisePolynomialPauliRotations.clbits" name="clbits">
    Returns a list of classical bits in the order that the registers were added.
  </Attribute>

  ### coeffs

  <Attribute id="qiskit.circuit.library.PiecewisePolynomialPauliRotations.coeffs" name="coeffs">
  ...
  <Attribute id="qiskit.circuit.library.PiecewisePolynomialPauliRotations.contains_zero_breakpoint" name="contains_zero_breakpoint">
  ...
  <Attribute id="qiskit.circuit.library.PiecewisePolynomialPauliRotations.data" name="data" />

  ### global\_phase

  <Attribute id="qiskit.circuit.library.PiecewisePolynomialPauliRotations.global_phase" name="global_phase">
    Return the global phase of the current circuit scope in radians.
  </Attribute>

  ### instances

  <Attribute id="qiskit.circuit.library.PiecewisePolynomialPauliRotations.instances" name="instances" attributeValue="= 206" />

  ### layout

  <Attribute id="qiskit.circuit.library.PiecewisePolynomialPauliRotations.layout" name="layout">
  ...
  <Attribute id="qiskit.circuit.library.PiecewisePolynomialPauliRotations.mapped_coeffs" name="mapped_coeffs">
  ...
  <Attribute id="qiskit.circuit.library.PiecewisePolynomialPauliRotations.metadata" name="metadata">
  ...
  <Attribute id="qiskit.circuit.library.PiecewisePolynomialPauliRotations.num_ancilla_qubits" name="num_ancilla_qubits">
  ...
  <Attribute id="qiskit.circuit.library.PiecewisePolynomialPauliRotations.num_ancillas" name="num_ancillas">
    Return the number of ancilla qubits.
  </Attribute>

  ### num\_captured\_vars

  <Attribute id="qiskit.circuit.library.PiecewisePolynomialPauliRotations.num_captured_vars" name="num_captured_vars">
  ...
  <Attribute id="qiskit.circuit.library.PiecewisePolynomialPauliRotations.num_clbits" name="num_clbits">
    Return number of classical bits.
  </Attribute>

  ### num\_declared\_vars

  <Attribute id="qiskit.circuit.library.PiecewisePolynomialPauliRotations.num_declared_vars" name="num_declared_vars">
  ...
  <Attribute id="qiskit.circuit.library.PiecewisePolynomialPauliRotations.num_input_vars" name="num_input_vars">
  ...
  <Attribute id="qiskit.circuit.library.PiecewisePolynomialPauliRotations.num_parameters" name="num_parameters" />

  ### num\_qubits

  <Attribute id="qiskit.circuit.library.PiecewisePolynomialPauliRotations.num_qubits" name="num_qubits">
    Return number of qubits.
  </Attribute>

  ### num\_state\_qubits

  <Attribute id="qiskit.circuit.library.PiecewisePolynomialPauliRotations.num_state_qubits" name="num_state_qubits">
  ...
  <Attribute id="qiskit.circuit.library.PiecewisePolynomialPauliRotations.num_vars" name="num_vars">
  ...
  <Attribute id="qiskit.circuit.library.PiecewisePolynomialPauliRotations.op_start_times" name="op_start_times">
  ...
  <Attribute id="qiskit.circuit.library.PiecewisePolynomialPauliRotations.parameters" name="parameters" />

  ### prefix

  <Attribute id="qiskit.circuit.library.PiecewisePolynomialPauliRotations.prefix" name="prefix" attributeValue="= 'circuit'" />

  ### qregs

  <Attribute id="qiskit.circuit.library.PiecewisePolynomialPauliRotations.qregs" name="qregs" attributeTypeHint="list[QuantumRegister]">
    A list of the quantum registers associated with the circuit.
  </Attribute>

  ### qubits

  <Attribute id="qiskit.circuit.library.PiecewisePolynomialPauliRotations.qubits" name="qubits">
