...
|                                                                                                      |                                                                    |
| ---------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------ |
| [`ParameterLike`](qiskit.primitives.ParameterLike "qiskit.primitives.ParameterLike")                 | Represent a PEP 604 union type                                     |
...
| [`ObservableLike`](qiskit.primitives.ObservableLike "qiskit.primitives.ObservableLike")                                                   | Represent a PEP 604 union type                                                                                                                         |
