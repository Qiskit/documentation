...
|                                                                                                      |                                                                                                                                                                                                                                                                       |
| ---------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [`ParameterLike`](qiskit.primitives.ParameterLike "qiskit.primitives.ParameterLike")                 | alias of [`Union`](https://docs.python.org/3/library/typing.html#typing.Union "(in Python v3.14)")\[[`Parameter`](qiskit.circuit.Parameter "qiskit._accelerate.circuit.Parameter"), [`str`](https://docs.python.org/3/library/stdtypes.html#str "(in Python v3.14)")] |
