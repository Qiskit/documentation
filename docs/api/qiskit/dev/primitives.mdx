...
|                                                                                                      |                                                                    |
| ---------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------ |
| [`ParameterLike`](qiskit.primitives.ParameterLike "qiskit.primitives.ParameterLike")                 |                                                                    |
...
| [`ObservableLike`](qiskit.primitives.ObservableLike "qiskit.primitives.ObservableLike")                                                   |                                                                                                                                                        |
