...
<Class id="qiskit.quantum_info.QubitSparsePauli" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/main/qiskit/quantum_info/__init__.py" signature="qiskit.quantum_info.QubitSparsePauli(data, /, num_qubits=None)" modifiers="class">
  ...
  <Function id="qiskit.quantum_info.QubitSparsePauli.from_sparse_label" signature="from_sparse_label(sparse_label, num_qubits)" modifiers="static">
    ...
    *   **sparse\_label** ([*tuple*](https://docs.python.org/3/builtins/stdtypes.html#tuple)*\[*[*str*](https://docs.python.org/3/builtins/stdtypes.html#str)*, Sequence\[*[*int*](https://docs.python.org/3/builtins/functions.html#int)*]]*) – labels and the qubits each single-qubit term applies to.
