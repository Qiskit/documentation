...
<Class id="qiskit.synthesis.MatrixExponential" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/synthesis/evolution/matrix_synthesis.py#L20-L47" signature="qiskit.synthesis.MatrixExponential">
