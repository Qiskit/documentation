...
<Class id="qiskit.synthesis.MatrixExponential" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.1/qiskit/synthesis/evolution/matrix_synthesis.py#L20-L47" signature="qiskit.synthesis.MatrixExponential">
