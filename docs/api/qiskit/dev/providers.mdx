...
<Class id="qiskit.providers.QiskitBackendNotFoundError" name="QiskitBackendNotFoundError" github="https://github.com/qiskit/qiskit/tree/main/qiskit/providers/exceptions.py" signature="qiskit.providers.QiskitBackendNotFoundError(*message)">
...
<Class id="qiskit.providers.BackendPropertyError" name="BackendPropertyError" github="https://github.com/qiskit/qiskit/tree/main/qiskit/providers/exceptions.py" signature="qiskit.providers.BackendPropertyError(*message)">
...
<Class id="qiskit.providers.JobError" name="JobError" github="https://github.com/qiskit/qiskit/tree/main/qiskit/providers/exceptions.py" signature="qiskit.providers.JobError(*message)">
...
<Class id="qiskit.providers.JobTimeoutError" name="JobTimeoutError" github="https://github.com/qiskit/qiskit/tree/main/qiskit/providers/exceptions.py" signature="qiskit.providers.JobTimeoutError(*message)">
...
<Class id="qiskit.providers.BackendConfigurationError" name="BackendConfigurationError" github="https://github.com/qiskit/qiskit/tree/main/qiskit/providers/exceptions.py" signature="qiskit.providers.BackendConfigurationError(*message)">
