...
<Function id="qiskit.visualization.visualize_transition" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/2.0/qiskit/visualization/transition_visualization.py#L125-L369" signature="qiskit.visualization.visualize_transition(circuit, trace=False, saveas=None, fpg=100, spg=2)">
