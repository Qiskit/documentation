---
title: RegisterSlot (dev version)
description: API reference for qiskit.pulse.channels.RegisterSlot in the dev version of qiskit
...
<Class id="qiskit.pulse.channels.RegisterSlot" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/main/qiskit/pulse/channels.py#L222-L227" signature="qiskit.pulse.channels.RegisterSlot(*args, **kwargs)" modifiers="class">
  ...
  **index** – Index of channel.
  ...
  <Function id="qiskit.pulse.channels.RegisterSlot.is_parameterized" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/pulse/channels.py#L137-L139" signature="is_parameterized()">
