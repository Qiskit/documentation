...
<Class id="qiskit.pulse.channels.RegisterSlot" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.1/qiskit/pulse/channels.py#L220-L225" signature="qiskit.pulse.channels.RegisterSlot(*args, **kwargs)">
