...
<Class id="qiskit.pulse.transforms.AlignLeft" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/pulse/transforms/alignments.py#L90-L154" signature="qiskit.pulse.transforms.AlignLeft">
