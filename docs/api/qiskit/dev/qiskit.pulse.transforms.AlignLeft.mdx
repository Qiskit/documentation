...
<Class id="qiskit.pulse.transforms.AlignLeft" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.1/qiskit/pulse/transforms/alignments.py#L90-L154" signature="qiskit.pulse.transforms.AlignLeft">
