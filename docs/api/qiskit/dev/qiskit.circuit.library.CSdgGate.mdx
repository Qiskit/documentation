...
<Class id="qiskit.circuit.library.CSdgGate" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/main/qiskit/circuit/library/standard_gates/s.py#L272-L355" signature="qiskit.circuit.library.CSdgGate(*args, _force_mutable=False, **kwargs)">
...
$$
  ...
  <Function id="qiskit.circuit.library.CSdgGate.inverse" name="inverse" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/circuit/library/standard_gates/s.py#L334-L346" signature="inverse(annotated=False)">
  ...
  <Function id="qiskit.circuit.library.CSdgGate.power" name="power" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/circuit/library/standard_gates/s.py#L348-L352" signature="power(exponent)">
