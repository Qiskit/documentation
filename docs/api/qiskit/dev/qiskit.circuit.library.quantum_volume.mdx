...
<Class id="qiskit.circuit.library.quantum_volume" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/main/qiskit/circuit/library/quantum_volume.py#L131-L167" signature="qiskit.circuit.library.quantum_volume(num_qubits, depth=None, seed=None)" modifiers="class">
  Bases:
