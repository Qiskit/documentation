...
<Class id="qiskit.circuit.library.quantum_volume" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.3/qiskit/circuit/library/quantum_volume.py#L131-L167" signature="qiskit.circuit.library.quantum_volume(num_qubits, depth=None, seed=None)" modifiers="class">
  Bases:
  ...
  **Reference Circuit:**
  ...
  ![../\_images/qiskit-circuit-library-quantum\_volume-1.png](/images/api/qiskit/dev/qiskit-circuit-library-quantum_volume-1.png)
  ...
  *   **seed** ([*int*](https://docs.python.org/3/library/functions.html#int "(in Python v3.13)")  *|*[*Generator*](https://numpy.org/doc/stable/reference/random/generator.html#numpy.random.Generator "(in NumPy v2.1)") *| None*) –
