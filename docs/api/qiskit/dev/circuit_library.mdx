...
<Function id="qiskit.circuit.library.get_standard_gate_name_mapping" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/circuit/library/standard_gates/__init__.py#L49-L142" signature="qiskit.circuit.library.get_standard_gate_name_mapping()">
