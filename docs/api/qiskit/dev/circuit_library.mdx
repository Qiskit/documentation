...
<Function id="qiskit.circuit.library.random_bitwise_xor" github="https://github.com/Qiskit/qiskit/tree/stable/1.3/qiskit/circuit/library/boolean_logic/quantum_xor.py#L154-L165" signature="qiskit.circuit.library.random_bitwise_xor(num_qubits, seed)">
...
| [`iqp`](qiskit.circuit.library.iqp "qiskit.circuit.library.iqp")(interactions)                                                               | Instantaneous quantum polynomial time (IQP) circuit.                     |
