...
$$
  ...
  <Function id="qiskit.quantum_info.PauliLindbladMap.apply_layout" signature="apply_layout(layout, num_qubits=None)">
    ...
    *   **layout** ([*TranspileLayout*](qiskit.transpiler.TranspileLayout "qiskit.transpiler.TranspileLayout")  *|*[*list*](https://docs.python.org/3/library/stdtypes.html#list)*\[*[*int*](https://docs.python.org/3/library/functions.html#int)*] | None*) – The layout to apply. Most uses of this function should pass the [`QuantumCircuit.layout`](/docs/api/qiskit/dev/qiskit.circuit.QuantumCircuit#layout "qiskit.circuit.QuantumCircuit.layout") field from a circuit that was transpiled for hardware. In addition, you can pass a list of new qubit indices. If given as explicitly `None`, no remapping is applied (but you can still use `num_qubits` to expand the map).
  ...
  <Function id="qiskit.quantum_info.PauliLindbladMap.parity_sample" signature="parity_sample(num_samples, seed=None, scale=None, local_scale=None)">
    ...
    *   **scale** ([*float*](https://docs.python.org/3/library/functions.html#float)) – Scale to apply to all rates.
    *   **local\_scale** ([*list*](https://docs.python.org/3/library/stdtypes.html#list)*\[*[*float*](https://docs.python.org/3/library/functions.html#float)*]*) – Local scale to apply on a term-by-term basis.
