...
<Class id="qiskit.quantum_info.PauliLindbladMap" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/main/qiskit/quantum_info/__init__.py" signature="qiskit.quantum_info.PauliLindbladMap(data, /, num_qubits=None)" modifiers="class">
...
$$
  ...
  Internally, [`PauliLindbladMap`](#qiskit.quantum_info.PauliLindbladMap "qiskit.quantum_info.PauliLindbladMap") stores an array of rates and a [`QubitSparsePauliList`](qiskit.quantum_info.QubitSparsePauliList "qiskit.quantum_info.QubitSparsePauliList") containing the corresponding sparse Pauli operators. Additionally, [`PauliLindbladMap`](#qiskit.quantum_info.PauliLindbladMap "qiskit.quantum_info.PauliLindbladMap") can compute the overall channel $\gamma$ in the [`gamma()`](#qiskit.quantum_info.PauliLindbladMap.gamma "qiskit.quantum_info.PauliLindbladMap.gamma") method, as well as the corresponding probabilities $p_P$ via the [`probabilities()`](#qiskit.quantum_info.PauliLindbladMap.probabilities "qiskit.quantum_info.PauliLindbladMap.probabilities") method.
  ...
  <Class id="qiskit.quantum_info.PauliLindbladMap.GeneratorTerm" github="https://github.com/Qiskit/qiskit/tree/main/qiskit/quantum_info/__init__.py" signature="GeneratorTerm(rate, qubit_sparse_pauli)" modifiers="class">
    Bases: [`object`](https://docs.python.org/3/builtins/functions.html#object)
  ...
  <Function id="qiskit.quantum_info.PauliLindbladMap.__new__" signature="__new__(data, /, num_qubits=None)">
    ...
    *   **num\_qubits** ([*int*](https://docs.python.org/3/builtins/functions.html#int)*|None*) – Optional number of qubits for the map. For most data inputs, this can be inferred and need not be passed. It is only necessary for empty lists or the sparse-list format. If given unnecessarily, it must match the data input.
  </Function>
  ...
  <Function id="qiskit.quantum_info.PauliLindbladMap.apply_layout" signature="apply_layout(layout, num_qubits=None)">
    ...
    *   **layout** ([*TranspileLayout*](qiskit.transpiler.TranspileLayout "qiskit.transpiler.TranspileLayout")  *|*[*list*](https://docs.python.org/3/builtins/stdtypes.html#list)*\[*[*int*](https://docs.python.org/3/builtins/functions.html#int)*] | None*) – The layout to apply. Most uses of this function should pass the [`QuantumCircuit.layout`](/docs/api/qiskit/dev/qiskit.circuit.QuantumCircuit#layout "qiskit.circuit.QuantumCircuit.layout") field from a circuit that was transpiled for hardware. In addition, you can pass a list of new qubit indices. If given as explicitly `None`, no remapping is applied (but you can still use `num_qubits` to expand the map).
    *   **num\_qubits** ([*int*](https://docs.python.org/3/builtins/functions.html#int) *| None*) – The number of qubits to expand the map to. If not supplied, the output will be as wide as the given [`TranspileLayout`](qiskit.transpiler.TranspileLayout "qiskit.transpiler.TranspileLayout"), or the same width as the input if the `layout` is given in another form.
  ...
  <Function id="qiskit.quantum_info.PauliLindbladMap.drop_paulis" signature="drop_paulis(indices)">
    ...
    **indices** (*Sequence\[*[*int*](https://docs.python.org/3/builtins/functions.html#int)*]*) – The indices for which Paulis must be dropped.
  ...
  <Function id="qiskit.quantum_info.PauliLindbladMap.drop_qubits" signature="drop_qubits(indices)">
    ...
    **indices** (*Sequence\[*[*int*](https://docs.python.org/3/builtins/functions.html#int)*]*) – The indices of the qubits to trace out.
  ...
  <Function id="qiskit.quantum_info.PauliLindbladMap.from_list" signature="from_list(iter, /, *, num_qubits=None)" modifiers="static">
    ...
    *   **iter** ([*list*](https://docs.python.org/3/builtins/stdtypes.html#list)*\[*[*tuple*](https://docs.python.org/3/builtins/stdtypes.html#tuple)*\[*[*str*](https://docs.python.org/3/builtins/stdtypes.html#str)*,* [*float*](https://docs.python.org/3/builtins/functions.html#float)*]]*) – Pairs of labels and their associated rates in the generator sum.
    *   **num\_qubits** ([*int*](https://docs.python.org/3/builtins/functions.html#int) *| None*) – It is not necessary to specify this if you are sure that `iter` is not an empty sequence, since it can be inferred from the label lengths. If `iter` may be empty, you must specify this argument to disambiguate how many qubits the map acts on. If this is given and `iter` is not empty, the value must match the label lengths.
  ...
  <Function id="qiskit.quantum_info.PauliLindbladMap.from_sparse_list" signature="from_sparse_list(iter, /, num_qubits)" modifiers="static">
    ...
    *   **iter** ([*list*](https://docs.python.org/3/builtins/stdtypes.html#list)*\[*[*tuple*](https://docs.python.org/3/builtins/stdtypes.html#tuple)*\[*[*str*](https://docs.python.org/3/builtins/stdtypes.html#str)*, Sequence\[*[*int*](https://docs.python.org/3/builtins/functions.html#int)*],* [*float*](https://docs.python.org/3/builtins/functions.html#float)*]]*) – triples of labels, the qubits each single-qubit term applies to, and the rate of the entire term.
    *   **num\_qubits** ([*int*](https://docs.python.org/3/builtins/functions.html#int)) – the number of qubits the map acts on.
  ...
  <Function id="qiskit.quantum_info.PauliLindbladMap.from_terms" signature="from_terms(obj, /, num_qubits=None)" modifiers="static">
    ...
    *   **num\_qubits** ([*int*](https://docs.python.org/3/builtins/functions.html#int) *| None*) – The number of qubits the map should act on. This is usually inferred from the input, but can be explicitly given to handle the case of an empty iterable.
  ...
  <Function id="qiskit.quantum_info.PauliLindbladMap.keep_paulis" signature="keep_paulis(indices)">
    ...
    **indices** (*Sequence\[*[*int*](https://docs.python.org/3/builtins/functions.html#int)*]*) – The indices for which Paulis must be kept.
  ...
  <Function id="qiskit.quantum_info.PauliLindbladMap.keep_qubits" signature="keep_qubits(indices)">
    ...
    **indices** (*Sequence\[*[*int*](https://docs.python.org/3/builtins/functions.html#int)*]*) – The indices for which qubits must be kept.
  ...
  <Function id="qiskit.quantum_info.PauliLindbladMap.parity_sample" signature="parity_sample(num_samples, seed=None, scale=None, local_scale=None)">
    ...
    *   If the operator is applied, update the :class\`QubitSparsePauli\` by multiplying it with the Pauli. If the rate associated with the Pauli is negative, flip the sign boolean.
    ...
    The arguments `scale` and `local_scale` can be used to change the underlying rates used in the sampling process without modifying current instance or requiring creating a new one. The `scale` argument scales all rates by a fixed float, and `local_scale` scales rates on a term-by-term basis.

    **Parameters**

    *   **num\_samples** ([*int*](https://docs.python.org/3/builtins/functions.html#int)) – Number of samples to draw.
    *   **seed** ([*int*](https://docs.python.org/3/builtins/functions.html#int)) – Random seed.
    *   **scale** ([*float*](https://docs.python.org/3/builtins/functions.html#float)) – Scale to apply to all rates.
    *   **local\_scale** ([*list*](https://docs.python.org/3/builtins/stdtypes.html#list)*\[*[*float*](https://docs.python.org/3/builtins/functions.html#float)*]*) – Local scale to apply on a term-by-term basis.
  ...
  ### parity\_sample\_with\_history

  <Function id="qiskit.quantum_info.PauliLindbladMap.parity_sample_with_history" signature="parity_sample_with_history(num_samples, seed=None, scale=None, local_scale=None)">
    Sample sign and Pauli operator pairs from the map, preserving the sampled generators.

    This method is identical to [`parity_sample()`](#qiskit.quantum_info.PauliLindbladMap.parity_sample "qiskit.quantum_info.PauliLindbladMap.parity_sample") except for also returning the information which [`generators()`](#qiskit.quantum_info.PauliLindbladMap.generators "qiskit.quantum_info.PauliLindbladMap.generators") were actually sampled to yield the final Pauli operator and sign.
    ...
    **The boolean array of**

    signs, the list of qubit sparse paulis, the two dimensional boolean array indicating which [`generators()`](#qiskit.quantum_info.PauliLindbladMap.generators "qiskit.quantum_info.PauliLindbladMap.generators") were sampled and the two dimensional boolean array indicating their signs.

    **Return type**

    signs, qubit\_sparse\_pauli\_list, pauli\_history, signs\_history
  </Function>
...
$$
  ...
  <Function id="qiskit.quantum_info.PauliLindbladMap.sample" signature="sample(num_samples, seed=None)">
    ...
    *   **num\_samples** ([*int*](https://docs.python.org/3/builtins/functions.html#int)) – Number of samples to draw.
    *   **seed** ([*int*](https://docs.python.org/3/builtins/functions.html#int)) – Random seed. Defaults to `None`.
    ...
    **Raises**
    ...
    [**ValueError**](https://docs.python.org/3/builtins/exceptions.html#ValueError) – If any of the rates in the map are negative.
  </Function>
  ...
  <Function id="qiskit.quantum_info.PauliLindbladMap.simplify" signature="simplify(tol=1e-08)">
    Sum any like terms in the generator, removing them if the resulting rate has an absolute value within tolerance of zero. This also removes terms whose Pauli operator is proportional to the identity, as the corresponding generator is actually the zero map.

    As a side effect, this sorts the generators into a fixed canonical order.

    <Admonition title="Note" type="note">
      When using this for equality comparisons, note that floating-point rounding and the non-associativity of floating-point addition may cause non-zero coefficients of summed terms to compare unequal. To compare two observables up to a tolerance, it is safest to compare the canonicalized difference of the two observables to zero.
    </Admonition>

    **Parameters**

    **tol** ([*float*](https://docs.python.org/3/builtins/functions.html#float)) – after summing like terms, any rates whose absolute value is less than the given absolute tolerance will be suppressed from the output.
