...
$$
  ...
  <Function id="qiskit.quantum_info.PauliLindbladMap.parity_sample" signature="parity_sample(num_samples, seed=None, scale=None, local_scale=None)">
    ...
    *   **scale** ([*float*](https://docs.python.org/3/library/functions.html#float "(in Python v3.14)")) – Scale to apply to all rates.
    *   **local\_scale** ([*list*](https://docs.python.org/3/library/stdtypes.html#list "(in Python v3.14)")*\[*[*float*](https://docs.python.org/3/library/functions.html#float "(in Python v3.14)")*]*) – Local scale to apply on a term-by-term basis.
