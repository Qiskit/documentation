...
<Class id="qiskit.transpiler.passes.SolovayKitaev" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/2.1/qiskit/transpiler/passes/synthesis/solovay_kitaev_synthesis.py#L38-L201" signature="qiskit.transpiler.passes.SolovayKitaev(*args, **kwargs)" modifiers="class">
  ...
  *   **depth** – The maximal gate depth used in basic approximations. This argument cannot be set if `basic_approximations` is provided.
  ...
  <Function id="qiskit.transpiler.passes.SolovayKitaev.execute" github="https://github.com/Qiskit/qiskit/tree/stable/2.1/qiskit/transpiler/basepasses.py#L161-L180" signature="execute(passmanager_ir, state, callback=None)">
  ...
  <Function id="qiskit.transpiler.passes.SolovayKitaev.name" github="https://github.com/Qiskit/qiskit/tree/stable/2.1/qiskit/passmanager/base_tasks.py#L68-L70" signature="name()">
    Name of the pass.
  ...
  <Function id="qiskit.transpiler.passes.SolovayKitaev.run" github="https://github.com/Qiskit/qiskit/tree/stable/2.1/qiskit/transpiler/passes/synthesis/solovay_kitaev_synthesis.py#L167-L201" signature="run(dag)">
  ...
  <Function id="qiskit.transpiler.passes.SolovayKitaev.update_status" github="https://github.com/Qiskit/qiskit/tree/stable/2.1/qiskit/transpiler/basepasses.py#L182-L190" signature="update_status(state, run_state)">
