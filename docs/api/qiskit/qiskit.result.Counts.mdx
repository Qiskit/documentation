...
<Class id="qiskit.result.Counts" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.0/qiskit/result/counts.py#L27-L189" signature="qiskit.result.Counts(data, time_taken=None, creg_sizes=None, memory_slots=None)">
  ...
  *   [**QiskitError**](exceptions#qiskit.exceptions.QiskitError "qiskit.exceptions.QiskitError") – If a dit string key is input with `creg_sizes` and/or `memory_slots`.
  ...
  <Attribute id="qiskit.result.Counts.bitstring_regex" name="bitstring_regex" attributeValue="re.compile('^[01\\s]+$')" />

  ## Methods

  ### clear

  <Function id="qiskit.result.Counts.clear" name="clear" signature="clear() → None.  Remove all items from D." />

  ### copy

  <Function id="qiskit.result.Counts.copy" name="copy" signature="copy() → a shallow copy of D" />

  ### fromkeys

  <Function id="qiskit.result.Counts.fromkeys" name="fromkeys" signature="fromkeys(value=None, /)">
    Create a new dictionary with keys from iterable and values set to value.
  </Function>

  ### get

  <Function id="qiskit.result.Counts.get" name="get" signature="get(key, default=None, /)">
    Return the value for key if key is in the dictionary, else default.
  </Function>

  ### hex\_outcomes

  <Function id="qiskit.result.Counts.hex_outcomes" name="hex_outcomes" github="https://github.com/Qiskit/qiskit/tree/stable/1.0/qiskit/result/counts.py#L137-L158" signature="hex_outcomes()">
  ...
  <Function id="qiskit.result.Counts.int_outcomes" name="int_outcomes" github="https://github.com/Qiskit/qiskit/tree/stable/1.0/qiskit/result/counts.py#L160-L180" signature="int_outcomes()">
  ...
  <Function id="qiskit.result.Counts.items" name="items" signature="items() → a set-like object providing a view on D's items" />

  ### keys

  <Function id="qiskit.result.Counts.keys" name="keys" signature="keys() → a set-like object providing a view on D's keys" />

  ### most\_frequent

  <Function id="qiskit.result.Counts.most_frequent" name="most_frequent" github="https://github.com/Qiskit/qiskit/tree/stable/1.0/qiskit/result/counts.py#L118-L135" signature="most_frequent()">
  ...
  <Function id="qiskit.result.Counts.pop" name="pop" signature="pop(k[, d]) → v, remove specified key and return the corresponding value.">
    If key is not found, default is returned if given, otherwise KeyError is raised
  </Function>

  ### popitem

  <Function id="qiskit.result.Counts.popitem" name="popitem" signature="popitem()">
  ...
  <Function id="qiskit.result.Counts.setdefault" name="setdefault" signature="setdefault(key, default=None, /)">
  ...
  <Function id="qiskit.result.Counts.shots" name="shots" github="https://github.com/Qiskit/qiskit/tree/stable/1.0/qiskit/result/counts.py#L187-L189" signature="shots()">
    Return the number of shots
  </Function>

  ### update

  <Function id="qiskit.result.Counts.update" name="update" signature="update([E, ]**F) → None.  Update D from dict/iterable E and F.">
    If E is present and has a .keys() method, then does: for k in E: D\[k] = E\[k] If E is present and lacks a .keys() method, then does: for k, v in E: D\[k] = v In either case, this is followed by: for k in F: D\[k] = F\[k]
  </Function>

  ### values

  <Function id="qiskit.result.Counts.values" name="values" signature="values() → an object providing a view on D's values" />
</Class>
