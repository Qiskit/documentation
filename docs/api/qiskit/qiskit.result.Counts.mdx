...
<Class id="qiskit.result.Counts" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/result/counts.py#L27-L194" signature="qiskit.result.Counts(data, time_taken=None, creg_sizes=None, memory_slots=None)" modifiers="class">
  ...
  *   [**QiskitError**](/docs/api/qiskit/exceptions#qiskit.exceptions.QiskitError "qiskit.exceptions.QiskitError") – If a dit string key is input with `creg_sizes` and/or `memory_slots`.
  ...
  <Attribute id="qiskit.result.Counts.bitstring_regex" name="bitstring_regex" headingLevel={3}>
    <AttributeTypeHint>= re.compile('^\[01\\\s]+\$')</AttributeTypeHint>
  </Attribute>
  ...
  <Function id="qiskit.result.Counts.hex_outcomes" github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/result/counts.py#L142-L163" signature="hex_outcomes()">
  ...
  <Function id="qiskit.result.Counts.int_outcomes" github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/result/counts.py#L165-L185" signature="int_outcomes()">
  ...
  <Function id="qiskit.result.Counts.most_frequent" github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/result/counts.py#L123-L140" signature="most_frequent()">
  ...
  <Function id="qiskit.result.Counts.shots" github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/result/counts.py#L192-L194" signature="shots()">
