...
<Class id="qiskit.circuit.library.Diagonal" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/2.0/qiskit/circuit/library/generalized_gates/diagonal.py#L34-L52" signature="qiskit.circuit.library.Diagonal(diag)" modifiers="class">
  ...
  **Raises**
  ...
  <Attribute id="qiskit.circuit.library.Diagonal.cregs">
    A list of `Clbit`s in the order that they were added. You should not mutate this.
  </Attribute>
  ...
  <Attribute id="qiskit.circuit.library.Diagonal.num_captured_stretches">
    The number of stretches in the circuit marked as captured from an enclosing scope.

    This is the length of the `iter_captured_stretches()` iterable. If this is non-zero, [`num_input_vars`](#qiskit.circuit.library.Diagonal.num_input_vars "qiskit.circuit.library.Diagonal.num_input_vars") must be zero.
  </Attribute>
  ...
  <Attribute id="qiskit.circuit.library.Diagonal.num_declared_stretches">
  ...
  <Attribute id="qiskit.circuit.library.Diagonal.num_identifiers">
    The number of real-time classical variables and stretches in the circuit.

    This is equal to [`num_vars()`](#qiskit.circuit.library.Diagonal.num_vars "qiskit.circuit.library.Diagonal.num_vars") + [`num_stretches()`](#qiskit.circuit.library.Diagonal.num_stretches "qiskit.circuit.library.Diagonal.num_stretches").
  </Attribute>
  ...
  <Attribute id="qiskit.circuit.library.Diagonal.num_stretches">
  ...
  <Attribute id="qiskit.circuit.library.Diagonal.qregs">
