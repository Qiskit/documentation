...
<Class id="qiskit.circuit.library.Diagonal" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/2.1/qiskit/circuit/library/generalized_gates/diagonal.py#L34-L56" signature="qiskit.circuit.library.Diagonal(diag)" modifiers="class">
  ...
  **Raises**
  ...
  <Attribute id="qiskit.circuit.library.Diagonal.instances" attributeValue="188" />
