...
<Class id="qiskit.circuit.ParameterVector" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/2.0/qiskit/circuit/parametervector.py#L55-L140" signature="qiskit.circuit.ParameterVector(name, length=0)" modifiers="class">
  ...
  <Function id="qiskit.circuit.ParameterVector.index" github="https://github.com/Qiskit/qiskit/tree/stable/2.0/qiskit/circuit/parametervector.py#L91-L95" signature="index(value)">
  ...
  <Function id="qiskit.circuit.ParameterVector.resize" github="https://github.com/Qiskit/qiskit/tree/stable/2.0/qiskit/circuit/parametervector.py#L112-L140" signature="resize(length)">
