...
<Class id="qiskit.circuit.ParameterVector" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/2.4/qiskit/circuit/parametervector.py#L20-L116" signature="qiskit.circuit.ParameterVector(name, length=0)" modifiers="class">
  ...
  <Function id="qiskit.circuit.ParameterVector.index" github="https://github.com/Qiskit/qiskit/tree/stable/2.4/qiskit/circuit/parametervector.py#L56-L60" signature="index(value)">
  ...
  <Function id="qiskit.circuit.ParameterVector.resize" github="https://github.com/Qiskit/qiskit/tree/stable/2.4/qiskit/circuit/parametervector.py#L88-L116" signature="resize(length)">
