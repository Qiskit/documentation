...
<Class id="qiskit.result.CorrelatedReadoutMitigator" github="https://github.com/Qiskit/qiskit/tree/stable/1.0/qiskit/result/mitigation/correlated_readout_mitigator.py#L26-L268" signature="qiskit.result.CorrelatedReadoutMitigator(assignment_matrix, qubits=None)">
