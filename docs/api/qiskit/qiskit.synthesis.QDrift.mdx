...
<Class id="qiskit.synthesis.QDrift" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.0/qiskit/synthesis/evolution/qdrift.py#L24-L102" signature="qiskit.synthesis.QDrift(reps=1, insert_barriers=False, cx_structure='chain', atomic_evolution=None, seed=None)">
  ...
  *   **seed** ([*int*](https://docs.python.org/3/library/functions.html#int "(in Python v3.12)") *| None*) – An optional seed for reproducibility of the random sampling process.
  ...
  <Attribute id="qiskit.synthesis.QDrift.settings" name="settings">
  ...
  <Function id="qiskit.synthesis.QDrift.synthesize" name="synthesize" github="https://github.com/Qiskit/qiskit/tree/stable/1.0/qiskit/synthesis/evolution/qdrift.py#L60-L102" signature="synthesize(evolution)">
