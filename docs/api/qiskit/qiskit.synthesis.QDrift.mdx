...
<Class id="qiskit.synthesis.QDrift" github="https://github.com/qiskit/qiskit/tree/stable/1.0/qiskit/synthesis/evolution/qdrift.py" signature="qiskit.synthesis.QDrift(reps=1, insert_barriers=False, cx_structure='chain', atomic_evolution=None, seed=None)">
  ...
  *   **seed** ([*int*](https://docs.python.org/3/library/functions.html#int "(in Python v3.12)") *| None*) – An optional seed for reproducibility of the random sampling process.
  ...
  <Function id="qiskit.synthesis.QDrift.synthesize" name="synthesize" signature="synthesize(evolution)">
