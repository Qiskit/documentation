...
`qiskit.circuit.Clbit(register=None, index=None)` [GitHub](https://github.com/qiskit/qiskit/tree/stable/1.0/qiskit/circuit/classicalregister.py "view source code")
