...
<Class id="qiskit.transpiler.passes.CSPLayout" github="https://github.com/Qiskit/qiskit/tree/stable/1.0/qiskit/transpiler/passes/layout/csp_layout.py#L27-L132" signature="qiskit.transpiler.passes.CSPLayout(*args, **kwargs)">
