...
<Class id="qiskit.providers.Backend" github="https://github.com/Qiskit/qiskit/tree/stable/1.0/qiskit/providers/backend.py#L28-L37" signature="qiskit.providers.Backend">
