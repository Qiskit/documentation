...
<Class id="qiskit.providers.Backend" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/providers/backend.py#L26-L35" signature="qiskit.providers.Backend" modifiers="class">
  ...
  <Attribute id="qiskit.providers.Backend.version" name="version" headingLevel={3}>
    <AttributeTypeHint>= 0</AttributeTypeHint>
  </Attribute>
</Class>
