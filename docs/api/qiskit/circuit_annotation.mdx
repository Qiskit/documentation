...
The main user-facing class is the base class [`qiskit.circuit.Annotation`](/docs/api/qiskit/qiskit.circuit.Annotation "qiskit.circuit.Annotation"), which is also re-exported from this module.

<span id="circuit-annotation-subclassing" />

## Custom annotation subclasses

The [`Annotation`](/docs/api/qiskit/qiskit.circuit.Annotation "qiskit.circuit.Annotation") class is intended to be subclassed. Subclasses must set their [`namespace`](/docs/api/qiskit/qiskit.circuit.Annotation#namespace "qiskit.circuit.Annotation.namespace") field. This can be specific to an instance, or static for an entire subclass. The namespace is used as part of the dispatch mechanism, as described in [Namespacing](#circuit-annotation-namespacing).
...
<Function id="qiskit.circuit.annotation.iter_namespaces" github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/circuit/annotation.py#L207-L225" signature="qiskit.circuit.annotation.iter_namespaces(namespace)">
...
<Class id="qiskit.circuit.annotation.QPYSerializer" github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/circuit/annotation.py#L228-L366" signature="qiskit.circuit.annotation.QPYSerializer" modifiers="class">
  Bases: [`ABC`](https://docs.python.org/3/library/abc.html#abc.ABC)

  The interface for serializers and deserializers of [`Annotation`](/docs/api/qiskit/qiskit.circuit.Annotation "qiskit.circuit.Annotation") objects to QPY.
  ...
  1.  many calls to `dump_annotation()`, which will all share the same `namespace` argument, which will always be a (non-strict) prefix of all the [`Annotation`](/docs/api/qiskit/qiskit.circuit.Annotation "qiskit.circuit.Annotation") objects given.
...
<Class id="qiskit.circuit.annotation.QPYFromOpenQASM3Serializer" github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/circuit/annotation.py#L427-L504" signature="qiskit.circuit.annotation.QPYFromOpenQASM3Serializer(inner)" modifiers="class">
...
<Class id="qiskit.circuit.annotation.OpenQASM3Serializer" github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/circuit/annotation.py#L369-L424" signature="qiskit.circuit.annotation.OpenQASM3Serializer" modifiers="class">
  Bases: [`ABC`](https://docs.python.org/3/library/abc.html#abc.ABC)

  The interface for serializers and deserializers of [`Annotation`](/docs/api/qiskit/qiskit.circuit.Annotation "qiskit.circuit.Annotation") objects to OpenQASM 3.
...
For example, we can write a simple transpiler pass that collects runs of single-qubit operations, and puts each run into a [`BoxOp`](/docs/api/qiskit/qiskit.circuit.BoxOp "qiskit.circuit.BoxOp"), then calculates the total unitary action and attaches it as a custom annotation, so the same analysis does not need to be repeated later, even if the internals of each block are optimized.
