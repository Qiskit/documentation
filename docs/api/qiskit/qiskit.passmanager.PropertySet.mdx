...
<Class id="qiskit.passmanager.PropertySet" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/2.3/qiskit/passmanager/compilation_status.py#L20-L24" signature="qiskit.passmanager.PropertySet" modifiers="class">
