...
<Class id="qiskit.primitives.BackendEstimator" github="https://github.com/qiskit/qiskit/tree/stable/1.0/qiskit/primitives/backend_estimator.py" signature="qiskit.primitives.BackendEstimator(backend, options=None, abelian_grouping=True, bound_pass_manager=None, skip_transpilation=False)">
