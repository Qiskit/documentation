...
<Class id="qiskit.circuit.library.RGate" github="https://github.com/Qiskit/qiskit/tree/stable/1.0/qiskit/circuit/library/standard_gates/r.py#L25-L113" signature="qiskit.circuit.library.RGate(theta, phi, label=None, *, duration=None, unit='dt')">
