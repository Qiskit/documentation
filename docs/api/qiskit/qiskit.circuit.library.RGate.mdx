...
<Class id="qiskit.circuit.library.RGate" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/2.4/qiskit/circuit/library/standard_gates/r.py#L24-L113" signature="qiskit.circuit.library.RGate(theta, phi, label=None)" modifiers="class">
...
$$
  ...
  *   **label** ([*str*](https://docs.python.org/3/library/stdtypes.html#str) *| None*) – An optional label for the gate.
  ...
  <Function id="qiskit.circuit.library.RGate.add_decomposition" github="https://github.com/Qiskit/qiskit/tree/stable/2.4/qiskit/circuit/instruction.py#L318-L323" signature="add_decomposition(decomposition)">
    Add a decomposition of the instruction to the SessionEquivalenceLibrary.
  </Function>

  ### broadcast\_arguments

  <Function id="qiskit.circuit.library.RGate.broadcast_arguments" github="https://github.com/Qiskit/qiskit/tree/stable/2.4/qiskit/circuit/gate.py#L206-L263" signature="broadcast_arguments(qargs, cargs)">
  ...
  <Function id="qiskit.circuit.library.RGate.control" github="https://github.com/Qiskit/qiskit/tree/stable/2.4/qiskit/circuit/gate.py#L105-L163" signature="control(num_ctrl_qubits=1, label=None, ctrl_state=None, annotated=None)">
  ...
  <Function id="qiskit.circuit.library.RGate.copy" github="https://github.com/Qiskit/qiskit/tree/stable/2.4/qiskit/circuit/instruction.py#L428-L443" signature="copy(name=None)">
  ...
  <Function id="qiskit.circuit.library.RGate.inverse" github="https://github.com/Qiskit/qiskit/tree/stable/2.4/qiskit/circuit/library/standard_gates/r.py#L81-L93" signature="inverse(annotated=False)">
  ...
  <Function id="qiskit.circuit.library.RGate.is_parameterized" github="https://github.com/Qiskit/qiskit/tree/stable/2.4/qiskit/circuit/instruction.py#L283-L288" signature="is_parameterized()">
    Return whether the `Instruction` contains [compile-time parameters](circuit#circuit-compile-time-parameters).
  </Function>

  ### power

  <Function id="qiskit.circuit.library.RGate.power" github="https://github.com/Qiskit/qiskit/tree/stable/2.4/qiskit/circuit/library/standard_gates/r.py#L106-L108" signature="power(exponent, annotated=False)">
  ...
  <Function id="qiskit.circuit.library.RGate.repeat" github="https://github.com/Qiskit/qiskit/tree/stable/2.4/qiskit/circuit/instruction.py#L491-L521" signature="repeat(n)">
  ...
  <Function id="qiskit.circuit.library.RGate.reverse_ops" github="https://github.com/Qiskit/qiskit/tree/stable/2.4/qiskit/circuit/instruction.py#L345-L369" signature="reverse_ops()">
  ...
  <Function id="qiskit.circuit.library.RGate.soft_compare" github="https://github.com/Qiskit/qiskit/tree/stable/2.4/qiskit/circuit/instruction.py#L214-L254" signature="soft_compare(other)">
  ...
  <Function id="qiskit.circuit.library.RGate.to_matrix" github="https://github.com/Qiskit/qiskit/tree/stable/2.4/qiskit/circuit/gate.py#L49-L61" signature="to_matrix()">
  ...
  <Function id="qiskit.circuit.library.RGate.to_mutable" github="https://github.com/Qiskit/qiskit/tree/stable/2.4/qiskit/circuit/instruction.py#L144-L152" signature="to_mutable()">
  ...
  <Function id="qiskit.circuit.library.RGate.validate_parameter" github="https://github.com/Qiskit/qiskit/tree/stable/2.4/qiskit/circuit/gate.py#L265-L279" signature="validate_parameter(parameter)">
