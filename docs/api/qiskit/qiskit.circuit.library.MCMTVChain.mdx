...
<Class id="qiskit.circuit.library.MCMTVChain" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/2.0/qiskit/circuit/library/generalized_gates/mcmt.py#L123-L185" signature="qiskit.circuit.library.MCMTVChain(gate, num_ctrl_qubits, num_target_qubits)" modifiers="class">
  ...
  **Expanded Circuit:**
  ...
  ![Diagram illustrating the previously described circuit.](/docs/images/api/qiskit/qiskit-circuit-library-MCMTVChain-1.avif)
  ...
  *   **num\_target\_qubits** ([*int*](https://docs.python.org/3/library/functions.html#int "(in Python v3.13)")) –
  ...
  <Attribute id="qiskit.circuit.library.MCMTVChain.cregs">
    A list of `Clbit`s in the order that they were added. You should not mutate this.
  </Attribute>
  ...
  <Attribute id="qiskit.circuit.library.MCMTVChain.instances" attributeValue="207" />
  ...
  <Attribute id="qiskit.circuit.library.MCMTVChain.num_captured_stretches">
    The number of stretches in the circuit marked as captured from an enclosing scope.

    This is the length of the `iter_captured_stretches()` iterable. If this is non-zero, [`num_input_vars`](#qiskit.circuit.library.MCMTVChain.num_input_vars "qiskit.circuit.library.MCMTVChain.num_input_vars") must be zero.
  </Attribute>
  ...
  <Attribute id="qiskit.circuit.library.MCMTVChain.num_declared_stretches">
  ...
  <Attribute id="qiskit.circuit.library.MCMTVChain.num_identifiers">
    The number of real-time classical variables and stretches in the circuit.

    This is equal to [`num_vars()`](#qiskit.circuit.library.MCMTVChain.num_vars "qiskit.circuit.library.MCMTVChain.num_vars") + [`num_stretches()`](#qiskit.circuit.library.MCMTVChain.num_stretches "qiskit.circuit.library.MCMTVChain.num_stretches").
  </Attribute>
  ...
  <Attribute id="qiskit.circuit.library.MCMTVChain.num_stretches">
  ...
  <Attribute id="qiskit.circuit.library.MCMTVChain.qregs">
  ...
  <Function id="qiskit.circuit.library.MCMTVChain.inverse" github="https://github.com/Qiskit/qiskit/tree/stable/2.0/qiskit/circuit/library/generalized_gates/mcmt.py#L184-L185" signature="inverse(annotated=False)">
