...
<Class id="qiskit.quantum_info.Kraus" github="https://github.com/Qiskit/qiskit/tree/stable/1.0/qiskit/quantum_info/operators/channel/kraus.py#L36-L324" signature="qiskit.quantum_info.Kraus(data, input_dims=None, output_dims=None)">
