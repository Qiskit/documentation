...
<Class id="qiskit.quantum_info.PauliList" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/2.3/qiskit/quantum_info/operators/symplectic/pauli_list.py#L33-L1242" signature="qiskit.quantum_info.PauliList(data)" modifiers="class">
  ...
  **Additional Information:**
  ...
  <Function id="qiskit.quantum_info.PauliList.adjoint" github="https://github.com/Qiskit/qiskit/tree/stable/2.3/qiskit/quantum_info/operators/symplectic/pauli_list.py#L828-L830" signature="adjoint()">
    Return the adjoint of each Pauli in the list.
  </Function>

  ### anticommutes

  <Function id="qiskit.quantum_info.PauliList.anticommutes" github="https://github.com/Qiskit/qiskit/tree/stable/2.3/qiskit/quantum_info/operators/symplectic/pauli_list.py#L856-L866" signature="anticommutes(other, qargs=None)">
  ...
  <Function id="qiskit.quantum_info.PauliList.anticommutes_with_all" github="https://github.com/Qiskit/qiskit/tree/stable/2.3/qiskit/quantum_info/operators/symplectic/pauli_list.py#L883-L896" signature="anticommutes_with_all(other)">
  ...
  <Function id="qiskit.quantum_info.PauliList.argsort" github="https://github.com/Qiskit/qiskit/tree/stable/2.3/qiskit/quantum_info/operators/symplectic/pauli_list.py#L476-L537" signature="argsort(weight=False, phase=False)">
  ...
  <Function id="qiskit.quantum_info.PauliList.commutes" github="https://github.com/Qiskit/qiskit/tree/stable/2.3/qiskit/quantum_info/operators/symplectic/pauli_list.py#L840-L854" signature="commutes(other, qargs=None)">
  ...
  <Function id="qiskit.quantum_info.PauliList.commutes_with_all" github="https://github.com/Qiskit/qiskit/tree/stable/2.3/qiskit/quantum_info/operators/symplectic/pauli_list.py#L868-L881" signature="commutes_with_all(other)">
    Return indexes of rows that commute `other`.
  ...
  <Function id="qiskit.quantum_info.PauliList.compose" github="https://github.com/Qiskit/qiskit/tree/stable/2.3/qiskit/quantum_info/operators/symplectic/pauli_list.py#L712-L745" signature="compose(other, qargs=None, front=False, inplace=False)">
  ...
  <Function id="qiskit.quantum_info.PauliList.conjugate" github="https://github.com/Qiskit/qiskit/tree/stable/2.3/qiskit/quantum_info/operators/symplectic/pauli_list.py#L820-L822" signature="conjugate()">
    Return the conjugate of each Pauli in the list.
  </Function>

  ### copy

  <Function id="qiskit.quantum_info.PauliList.copy" github="https://github.com/Qiskit/qiskit/tree/stable/2.3/qiskit/quantum_info/operators/symplectic/base_pauli.py#L64-L73" signature="copy()">
    Make a deep copy of current operator.
  </Function>

  ### delete

  <Function id="qiskit.quantum_info.PauliList.delete" github="https://github.com/Qiskit/qiskit/tree/stable/2.3/qiskit/quantum_info/operators/symplectic/pauli_list.py#L365-L410" signature="delete(ind, qubit=False)">
  ...
  <Function id="qiskit.quantum_info.PauliList.dot" github="https://github.com/Qiskit/qiskit/tree/stable/2.3/qiskit/quantum_info/operators/symplectic/pauli_list.py#L747-L764" signature="dot(other, qargs=None, inplace=False)">
  ...
  <Function id="qiskit.quantum_info.PauliList.equiv" github="https://github.com/Qiskit/qiskit/tree/stable/2.3/qiskit/quantum_info/operators/symplectic/pauli_list.py#L241-L253" signature="equiv(other)">
  ...
  <Function id="qiskit.quantum_info.PauliList.evolve" github="https://github.com/Qiskit/qiskit/tree/stable/2.3/qiskit/quantum_info/operators/symplectic/pauli_list.py#L922-L959" signature="evolve(other, qargs=None, frame='h')">
  ...
  <Function id="qiskit.quantum_info.PauliList.expand" github="https://github.com/Qiskit/qiskit/tree/stable/2.3/qiskit/quantum_info/operators/symplectic/pauli_list.py#L689-L710" signature="expand(other)">
  ...
  <Function id="qiskit.quantum_info.PauliList.from_symplectic" github="https://github.com/Qiskit/qiskit/tree/stable/2.3/qiskit/quantum_info/operators/symplectic/pauli_list.py#L1118-L1135" signature="from_symplectic(z, x, phase=0)" modifiers="classmethod">
  ...
  <Function id="qiskit.quantum_info.PauliList.group_commuting" github="https://github.com/Qiskit/qiskit/tree/stable/2.3/qiskit/quantum_info/operators/symplectic/pauli_list.py#L1220-L1242" signature="group_commuting(qubit_wise=False)">
  ...
  <Function id="qiskit.quantum_info.PauliList.group_qubit_wise_commuting" github="https://github.com/Qiskit/qiskit/tree/stable/2.3/qiskit/quantum_info/operators/symplectic/pauli_list.py#L1212-L1218" signature="group_qubit_wise_commuting()">
  ...
  <Function id="qiskit.quantum_info.PauliList.input_dims" github="https://github.com/Qiskit/qiskit/tree/stable/2.3/qiskit/quantum_info/operators/base_operator.py#L135-L137" signature="input_dims(qargs=None)">
    Return tuple of input dimension for specified subsystems.
  </Function>

  ### insert

  <Function id="qiskit.quantum_info.PauliList.insert" github="https://github.com/Qiskit/qiskit/tree/stable/2.3/qiskit/quantum_info/operators/symplectic/pauli_list.py#L412-L474" signature="insert(ind, value, qubit=False)">
  ...
  <Function id="qiskit.quantum_info.PauliList.inverse" github="https://github.com/Qiskit/qiskit/tree/stable/2.3/qiskit/quantum_info/operators/symplectic/pauli_list.py#L832-L834" signature="inverse()">
    Return the inverse of each Pauli in the list.
  </Function>

  ### label\_iter

  <Function id="qiskit.quantum_info.PauliList.label_iter" github="https://github.com/Qiskit/qiskit/tree/stable/2.3/qiskit/quantum_info/operators/symplectic/pauli_list.py#L1063-L1083" signature="label_iter()">
  ...
  <Function id="qiskit.quantum_info.PauliList.matrix_iter" github="https://github.com/Qiskit/qiskit/tree/stable/2.3/qiskit/quantum_info/operators/symplectic/pauli_list.py#L1085-L1112" signature="matrix_iter(sparse=False)">
  ...
  <Function id="qiskit.quantum_info.PauliList.noncommutation_graph" github="https://github.com/Qiskit/qiskit/tree/stable/2.3/qiskit/quantum_info/operators/symplectic/pauli_list.py#L1168-L1188" signature="noncommutation_graph(qubit_wise)">
  ...
  <Function id="qiskit.quantum_info.PauliList.output_dims" github="https://github.com/Qiskit/qiskit/tree/stable/2.3/qiskit/quantum_info/operators/base_operator.py#L139-L141" signature="output_dims(qargs=None)">
    Return tuple of output dimension for specified subsystems.
  </Function>

  ### power

  <Function id="qiskit.quantum_info.PauliList.power" github="https://github.com/Qiskit/qiskit/tree/stable/2.3/qiskit/quantum_info/operators/mixins/group.py#L154-L174" signature="power(n)">
  ...
  <Function id="qiskit.quantum_info.PauliList.reshape" github="https://github.com/Qiskit/qiskit/tree/stable/2.3/qiskit/quantum_info/operators/base_operator.py#L106-L133" signature="reshape(input_dims=None, output_dims=None, num_qubits=None)">
  ...
  <Function id="qiskit.quantum_info.PauliList.sort" github="https://github.com/Qiskit/qiskit/tree/stable/2.3/qiskit/quantum_info/operators/symplectic/pauli_list.py#L539-L597" signature="sort(weight=False, phase=False)">
  ...
  <Function id="qiskit.quantum_info.PauliList.tensor" github="https://github.com/Qiskit/qiskit/tree/stable/2.3/qiskit/quantum_info/operators/symplectic/pauli_list.py#L671-L687" signature="tensor(other)">
  ...
  <Function id="qiskit.quantum_info.PauliList.to_labels" github="https://github.com/Qiskit/qiskit/tree/stable/2.3/qiskit/quantum_info/operators/symplectic/pauli_list.py#L961-L1007" signature="to_labels(array=False)">
  ...
  <Function id="qiskit.quantum_info.PauliList.to_matrix" github="https://github.com/Qiskit/qiskit/tree/stable/2.3/qiskit/quantum_info/operators/symplectic/pauli_list.py#L1009-L1057" signature="to_matrix(sparse=False, array=False)">
  ...
  <Function id="qiskit.quantum_info.PauliList.transpose" github="https://github.com/Qiskit/qiskit/tree/stable/2.3/qiskit/quantum_info/operators/symplectic/pauli_list.py#L824-L826" signature="transpose()">
    Return the transpose of each Pauli in the list.
  </Function>

  ### unique

  <Function id="qiskit.quantum_info.PauliList.unique" github="https://github.com/Qiskit/qiskit/tree/stable/2.3/qiskit/quantum_info/operators/symplectic/pauli_list.py#L599-L665" signature="unique(return_index=False, return_counts=False)">
