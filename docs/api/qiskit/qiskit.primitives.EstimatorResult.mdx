...
<Class id="qiskit.primitives.EstimatorResult" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/primitives/base/estimator_result_v1.py#L27-L46" signature="qiskit.primitives.EstimatorResult(values, metadata)" modifiers="class">
  ...
  *   **metadata** ([*list*](https://docs.python.org/3/library/stdtypes.html#list)*\[*[*dict*](https://docs.python.org/3/library/stdtypes.html#dict)*]*) – List of the metadata.
  ...
  <Attribute id="qiskit.primitives.EstimatorResult.metadata" attributeTypeHint="list[dict[str, Any]]" attributeTypeHintHref="https://docs.python.org/3/library/stdtypes.html" />
</Class>
