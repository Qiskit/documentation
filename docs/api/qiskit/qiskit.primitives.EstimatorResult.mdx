...
<Class id="qiskit.primitives.EstimatorResult" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.4/qiskit/primitives/base/estimator_result.py#L27-L46" signature="qiskit.primitives.EstimatorResult(values, metadata)" modifiers="class">
