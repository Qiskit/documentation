...
<Class id="qiskit.providers.models.Nduv" github="https://github.com/Qiskit/qiskit/tree/stable/1.0/qiskit/providers/models/backendproperties.py#L26-L85" signature="qiskit.providers.models.Nduv(date, name, unit, value)">
