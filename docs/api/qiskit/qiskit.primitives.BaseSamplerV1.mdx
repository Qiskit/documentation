---
title: BaseSamplerV1 (latest version)
description: API reference for qiskit.primitives.BaseSamplerV1 in the latest version of qiskit
...
<Class id="qiskit.primitives.BaseSamplerV1" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/primitives/base/base_sampler.py#L77-L196" signature="qiskit.primitives.BaseSamplerV1(*, options=None)" modifiers="class">
  ...
  **options** ([*dict*](https://docs.python.org/3/library/stdtypes.html#dict) *| None*) – Default options.
  ...
  <Attribute id="qiskit.primitives.BaseSamplerV1.options" name="options" headingLevel={3}>
  ...
  <Function id="qiskit.primitives.BaseSamplerV1.run" github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/primitives/base/base_sampler.py#L156-L187" signature="run(circuits, parameter_values=None, **run_options)">
    Run the job of the sampling of bitstrings.

    **Parameters**

    *   **circuits** ([*QuantumCircuit*](/docs/api/qiskit/qiskit.circuit.QuantumCircuit "qiskit.circuit.quantumcircuit.QuantumCircuit")  *|*[*Sequence*](https://docs.python.org/3/library/collections.abc.html#collections.abc.Sequence)*\[*[*QuantumCircuit*](/docs/api/qiskit/qiskit.circuit.QuantumCircuit "qiskit.circuit.quantumcircuit.QuantumCircuit")*]*) – One or more circuit objects.
  ...
  <Function id="qiskit.primitives.BaseSamplerV1.set_options" github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/primitives/base/base_primitive_v1.py#L39-L45" signature="set_options(**fields)">
