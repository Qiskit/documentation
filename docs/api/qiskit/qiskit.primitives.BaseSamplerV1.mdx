...
<Class id="qiskit.primitives.BaseSamplerV1" github="https://github.com/qiskit/qiskit/tree/stable/1.0/qiskit/primitives/base/base_sampler.py" signature="qiskit.primitives.BaseSamplerV1(*, options=None)">
