...
<Class id="qiskit.circuit.library.TGate" github="https://github.com/Qiskit/qiskit/tree/stable/1.0/qiskit/circuit/library/standard_gates/t.py#L26-L100" signature="qiskit.circuit.library.TGate(*args, _force_mutable=False, **kwargs)">
