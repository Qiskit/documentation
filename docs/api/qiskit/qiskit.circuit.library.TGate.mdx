...
<Class id="qiskit.circuit.library.TGate" github="https://github.com/qiskit/qiskit/tree/stable/1.0/qiskit/circuit/library/standard_gates/t.py" signature="qiskit.circuit.library.TGate(*args, _force_mutable=False, **kwargs)">
