...
`qiskit.transpiler.passes.SetLayout(*args, **kwargs)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/1.0/qiskit/transpiler/passes/layout/set_layout.py "view source code")
...
<span id="qiskit.transpiler.passes.SetLayout.execute" />
...
<span id="qiskit.transpiler.passes.SetLayout.update_status" />
