...
![../\_images/qiskit-circuit-library-IQP-1.png](/images/api/qiskit/qiskit-circuit-library-IQP-1.png)

**Expanded Circuit:**

> ![../\_images/qiskit-circuit-library-IQP-2.png](/images/api/qiskit/qiskit-circuit-library-IQP-2.png)
...
**interactions** ([*list*](https://docs.python.org/3/library/stdtypes.html#list "(in Python v3.11)") *| np.ndarray*) – input n-by-n symmetric matrix.
