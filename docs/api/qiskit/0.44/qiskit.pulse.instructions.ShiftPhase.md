...
`qiskit.pulse.instructions.ShiftPhase(phase, channel, name=None)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.44/qiskit/pulse/instructions/phase.py "view source code")
