...
`qiskit.providers.fake_provider.FakePerth` [GitHub](https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/providers/fake_provider/backends/perth/fake_perth.py "view source code")
...
`= '/home/runner/work/qiskit/qiskit/.tox/docs/lib/python3.9/site-packages/qiskit/providers/fake_provider/backends/perth'`

<span id="qiskit.providers.fake_provider.FakePerth.dt" />
