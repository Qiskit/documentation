...
<Class id="qiskit.providers.fake_provider.ConfigurableFakeBackend" github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/providers/fake_provider/utils/configurable_backend.py" signature="qiskit.providers.fake_provider.ConfigurableFakeBackend(name, n_qubits, version=None, coupling_map=None, basis_gates=None, qubit_t1=None, qubit_t2=None, qubit_frequency=None, qubit_readout_error=None, single_qubit_gates=None, dt=None, std=None, seed=None)">
  ...
  *   **seed** ([*int*](https://docs.python.org/3/library/functions.html#int "(in Python v3.12)") *| None*) – Random seed.
  ...
  <Attribute id="qiskit.providers.fake_provider.ConfigurableFakeBackend.options" name="options">
  ...
  <Attribute id="qiskit.providers.fake_provider.ConfigurableFakeBackend.version" name="version" attributeValue="= 1" />

  ## Methods

  ### configuration

  <Function id="qiskit.providers.fake_provider.ConfigurableFakeBackend.configuration" name="configuration" signature="configuration()">
  ...
  <Function id="qiskit.providers.fake_provider.ConfigurableFakeBackend.defaults" name="defaults" signature="defaults()">
    Return backend defaults.
  </Function>

  ### name

  <Function id="qiskit.providers.fake_provider.ConfigurableFakeBackend.name" name="name" signature="name()">
  ...
  <Function id="qiskit.providers.fake_provider.ConfigurableFakeBackend.properties" name="properties" signature="properties()">
    Return backend properties
  </Function>

  ### provider

  <Function id="qiskit.providers.fake_provider.ConfigurableFakeBackend.provider" name="provider" signature="provider()">
  ...
  <Function id="qiskit.providers.fake_provider.ConfigurableFakeBackend.run" name="run" signature="run(run_input, **kwargs)">
    Main job in simulator
  </Function>

  ### set\_options

  <Function id="qiskit.providers.fake_provider.ConfigurableFakeBackend.set_options" name="set_options" signature="set_options(**fields)">
  ...
  <Function id="qiskit.providers.fake_provider.ConfigurableFakeBackend.status" name="status" signature="status()">
