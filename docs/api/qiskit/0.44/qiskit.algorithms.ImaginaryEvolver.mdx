...
<Class id="qiskit.algorithms.ImaginaryEvolver" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/algorithms/evolvers/imaginary_evolver.py" signature="qiskit.algorithms.ImaginaryEvolver">
  ...
  <Function id="qiskit.algorithms.ImaginaryEvolver.evolve" name="evolve" signature="abstract evolve(evolution_problem)">
