...
<Class id="qiskit.transpiler.passes.ResetAfterMeasureSimplification" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/transpiler/passes/optimization/reset_after_measure_simplification.py" signature="qiskit.transpiler.passes.ResetAfterMeasureSimplification(*args, **kwargs)">
