...
`qiskit.transpiler.FencedPropertySet(property_set_instance)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/transpiler/fencedobjs.py "view source code")
