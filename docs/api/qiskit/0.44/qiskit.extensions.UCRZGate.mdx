...
<Class id="qiskit.extensions.UCRZGate" github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/extensions/quantum_initializer/ucrz.py" signature="qiskit.extensions.UCRZGate(angle_list)">
