---
title: CDKMRippleCarryAdder (v0.44)
description: API reference for qiskit.circuit.library.CDKMRippleCarryAdder in qiskit v0.44
...
<Class id="qiskit.circuit.library.CDKMRippleCarryAdder" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/circuit/library/arithmetic/adders/cdkm_ripple_carry_adder.py" signature="qiskit.circuit.library.CDKMRippleCarryAdder(num_state_qubits, kind='full', name='CDKMRippleCarryAdder')" modifiers="class">
  ...
  **Raises**
  ...
  <Attribute id="qiskit.circuit.library.CDKMRippleCarryAdder.instances" attributeValue="168" />
