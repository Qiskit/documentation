...
<Class id="qiskit.dagcircuit.BlockCollector" github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/dagcircuit/collect_blocks.py" signature="qiskit.dagcircuit.BlockCollector(dag)">
