...
`qiskit.providers.fake_provider.FakeVigoV2` [GitHub](https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/providers/fake_provider/backends/vigo/fake_vigo.py "view source code")
