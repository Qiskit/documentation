---
title: plot_bloch_vector (v0.44)
description: API reference for qiskit.visualization.plot_bloch_vector in qiskit v0.44
...
<Function id="qiskit.visualization.plot_bloch_vector" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/visualization/state_visualization.py" signature="qiskit.visualization.plot_bloch_vector(bloch, title='', ax=None, figsize=None, coord_type='cartesian', font_size=None)">
  ...
  **Examples**
  ...
  ![../\_images/qiskit-visualization-plot\_bloch\_vector-1.png](/docs/images/api/qiskit/0.44/qiskit-visualization-plot_bloch_vector-1.avif)
  ...
  ![../\_images/qiskit-visualization-plot\_bloch\_vector-2.png](/docs/images/api/qiskit/0.44/qiskit-visualization-plot_bloch_vector-2.avif)
</Function>
