---
title: MatrixExponential (v0.44)
description: API reference for qiskit.synthesis.MatrixExponential in qiskit v0.44
...
<Class id="qiskit.synthesis.MatrixExponential" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/synthesis/evolution/matrix_synthesis.py" signature="qiskit.synthesis.MatrixExponential" modifiers="class">
  ...
  <Function id="qiskit.synthesis.MatrixExponential.synthesize" signature="synthesize(evolution)">
