...
<Class id="qiskit.synthesis.MatrixExponential" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/synthesis/evolution/matrix_synthesis.py" signature="qiskit.synthesis.MatrixExponential">
  ...
  <Function id="qiskit.synthesis.MatrixExponential.synthesize" name="synthesize" signature="synthesize(evolution)">
