...
`qiskit.providers.fake_provider.FakeArmonkV2` [GitHub](https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/providers/fake_provider/backends/armonk/fake_armonk.py "view source code")
