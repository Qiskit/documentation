...
<Class id="qiskit.algorithms.AlgorithmError" github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/algorithms/exceptions.py" signature="qiskit.algorithms.AlgorithmError(*message)">
