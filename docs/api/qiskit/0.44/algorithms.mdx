---
title: algorithms (v0.44)
description: API reference for qiskit.algorithms in qiskit v0.44
...
<Class id="qiskit.algorithms.AlgorithmError" github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/algorithms/exceptions.py" signature="qiskit.algorithms.AlgorithmError(*message)" modifiers="exception">
...
<Function id="qiskit.algorithms.eval_observables" github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/algorithms/aux_ops_evaluator.py" signature="qiskit.algorithms.eval_observables(quantum_instance, quantum_state, observables, expectation, threshold=1e-12)">
...
<Function id="qiskit.algorithms.estimate_observables" github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/algorithms/observables_evaluator.py" signature="qiskit.algorithms.estimate_observables(estimator, quantum_state, observables, parameter_values=None, threshold=1e-12)">
