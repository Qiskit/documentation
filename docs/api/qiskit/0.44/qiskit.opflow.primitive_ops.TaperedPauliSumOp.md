...
`qiskit.opflow.primitive_ops.TaperedPauliSumOp(*args, **kwargs)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.44/qiskit/opflow/primitive_ops/tapered_pauli_sum_op.py "view source code")
