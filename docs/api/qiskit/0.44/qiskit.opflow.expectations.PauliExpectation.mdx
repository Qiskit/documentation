---
title: PauliExpectation (v0.44)
description: API reference for qiskit.opflow.expectations.PauliExpectation in qiskit v0.44
...
<Class id="qiskit.opflow.expectations.PauliExpectation" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/opflow/expectations/pauli_expectation.py" signature="qiskit.opflow.expectations.PauliExpectation(group_paulis=True)" modifiers="class">
