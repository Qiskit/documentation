...
`qiskit.quantum_info.Pauli(data=None, x=None, *, z=None, label=None)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.44/qiskit/quantum_info/operators/symplectic/pauli.py "view source code")
