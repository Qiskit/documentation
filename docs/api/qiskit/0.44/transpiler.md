...
![../\_images/transpiler-11.png](/images/api/qiskit/0.44/transpiler-11.png)
...
![../\_images/transpiler-14.png](/images/api/qiskit/0.44/transpiler-14.png)
...
`qiskit.transpiler.TranspilerError(*message)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.44/qiskit/transpiler/exceptions.py "view source code")
...
`qiskit.transpiler.TranspilerAccessError(*message)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.44/qiskit/transpiler/exceptions.py "view source code")
...
`qiskit.transpiler.CouplingError(*msg)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.44/qiskit/transpiler/exceptions.py "view source code")
...
`qiskit.transpiler.LayoutError(*msg)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.44/qiskit/transpiler/exceptions.py "view source code")
