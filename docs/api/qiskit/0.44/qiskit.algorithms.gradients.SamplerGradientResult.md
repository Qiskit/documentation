...
`qiskit.algorithms.gradients.SamplerGradientResult(gradients, metadata, options)` [GitHub](https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/algorithms/gradients/base/sampler_gradient_result.py "view source code")
