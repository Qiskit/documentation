---
title: QobjExperimentHeader (v0.44)
description: API reference for qiskit.qobj.QobjExperimentHeader in qiskit v0.44
...
<Class id="qiskit.qobj.QobjExperimentHeader" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/qobj/common.py" signature="qiskit.qobj.QobjExperimentHeader(**kwargs)" modifiers="class">
