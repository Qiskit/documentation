...
`qiskit.extensions.Initialize(params, num_qubits=None, normalize=False)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.44/qiskit/extensions/quantum_initializer/initializer.py "view source code")
