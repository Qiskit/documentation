...
`qiskit.qobj.PulseQobj(qobj_id, config, experiments, header=None)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.44/qiskit/qobj/pulse_qobj.py "view source code")
