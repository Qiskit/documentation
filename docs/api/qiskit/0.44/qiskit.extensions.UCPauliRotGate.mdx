...
<Class id="qiskit.extensions.UCPauliRotGate" github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/extensions/quantum_initializer/uc_pauli_rot.py" signature="qiskit.extensions.UCPauliRotGate(angle_list, rot_axis)">
