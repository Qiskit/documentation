---
title: Call (v0.44)
description: API reference for qiskit.pulse.instructions.Call in qiskit v0.44
...
<Class id="qiskit.pulse.instructions.Call" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/pulse/instructions/call.py" signature="qiskit.pulse.instructions.Call(subroutine, value_dict=None, name=None)" modifiers="class">
