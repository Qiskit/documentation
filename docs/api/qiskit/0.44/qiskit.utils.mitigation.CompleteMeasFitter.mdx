...
<Class id="qiskit.utils.mitigation.CompleteMeasFitter" github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/utils/mitigation/fitters.py" signature="qiskit.utils.mitigation.CompleteMeasFitter(results, state_labels, qubit_list=None, circlabel='')">
