---
title: FakeGuadalupeV2 (v0.44)
description: API reference for qiskit.providers.fake_provider.FakeGuadalupeV2 in qiskit v0.44
...
<Class id="qiskit.providers.fake_provider.FakeGuadalupeV2" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/providers/fake_provider/backends/guadalupe/fake_guadalupe.py" signature="qiskit.providers.fake_provider.FakeGuadalupeV2" modifiers="class">
  Bases: `FakeBackendV2`
  ...
  <Attribute id="qiskit.providers.fake_provider.FakeGuadalupeV2.dirname" attributeValue="'/home/runner/work/qiskit/qiskit/.tox/docs/lib/python3.9/site-packages/qiskit/providers/fake_provider/backends/guadalupe'" />
