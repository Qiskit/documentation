...
`qiskit.algorithms.gradients.BaseEstimatorGradient(estimator, options=None, derivative_type=DerivativeType.REAL)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.44/qiskit/algorithms/gradients/base/base_estimator_gradient.py "view source code")
