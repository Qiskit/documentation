...
<Class id="qiskit.algorithms.PhaseEstimation" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/algorithms/phase_estimators/phase_estimation.py" signature="qiskit.algorithms.PhaseEstimation(num_evaluation_qubits, quantum_instance=None, sampler=None)">
...
$$
  ...
  **Raises**
  ...
  <Function id="qiskit.algorithms.PhaseEstimation.estimate" name="estimate" signature="estimate(unitary, state_preparation=None)">
