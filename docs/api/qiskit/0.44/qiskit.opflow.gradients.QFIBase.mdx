...
<Class id="qiskit.opflow.gradients.QFIBase" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/opflow/gradients/qfi_base.py" signature="qiskit.opflow.gradients.QFIBase(qfi_method='lin_comb_full')">
  ...
  **Raises**
  ...
  <Attribute id="qiskit.opflow.gradients.QFIBase.qfi_method" name="qfi_method">
    Returns `CircuitQFI`.
