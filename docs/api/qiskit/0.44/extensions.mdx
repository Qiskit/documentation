...
<Class id="qiskit.extensions.ExtensionError" name="ExtensionError" github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/extensions/exceptions.py" signature="qiskit.extensions.ExtensionError(*message)">
