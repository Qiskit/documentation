---
title: RealVariationalPrinciple (v0.44)
description: API reference for qiskit.algorithms.time_evolvers.variational.RealVariationalPrinciple in qiskit v0.44
