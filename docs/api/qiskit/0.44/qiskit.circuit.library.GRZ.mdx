---
title: GRZ (v0.44)
description: API reference for qiskit.circuit.library.GRZ in qiskit v0.44
...
<Class id="qiskit.circuit.library.GRZ" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/circuit/library/generalized_gates/gr.py" signature="qiskit.circuit.library.GRZ(num_qubits, phi)" modifiers="class">
...
$$
  ...
  **Expanded Circuit:**
  ...
  ![../\_images/qiskit-circuit-library-GRZ-1.png](/docs/images/api/qiskit/0.44/qiskit-circuit-library-GRZ-1.avif)
  ...
  *   **phi** ([*float*](https://docs.python.org/3/library/functions.html#float "(in Python v3.12)")) – rotation angle about z-axis
  ...
  <Attribute id="qiskit.circuit.library.GRZ.instances" attributeValue="152" />
