---
title: CRYGate (v0.44)
description: API reference for qiskit.circuit.library.CRYGate in qiskit v0.44
...
<Class id="qiskit.circuit.library.CRYGate" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/circuit/library/standard_gates/ry.py" signature="qiskit.circuit.library.CRYGate(theta, label=None, ctrl_state=None)" modifiers="class">
