...
`qiskit.quantum_info.Clifford(data, validate=True, copy=True)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.44/qiskit/quantum_info/operators/symplectic/clifford.py "view source code")
