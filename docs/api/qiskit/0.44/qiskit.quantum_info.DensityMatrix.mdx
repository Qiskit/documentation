...
<Class id="qiskit.quantum_info.DensityMatrix" github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/quantum_info/states/densitymatrix.py" signature="qiskit.quantum_info.DensityMatrix(data, dims=None)">
