---
title: Permutation (v0.44)
description: API reference for qiskit.circuit.library.Permutation in qiskit v0.44
...
<Class id="qiskit.circuit.library.Permutation" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/circuit/library/generalized_gates/permutation.py" signature="qiskit.circuit.library.Permutation(num_qubits, pattern=None, seed=None)" modifiers="class">
  ...
  **Reference Circuit:**
  ...
  ![../\_images/qiskit-circuit-library-Permutation-1.png](/docs/images/api/qiskit/0.44/qiskit-circuit-library-Permutation-1.avif)

  **Expanded Circuit:**

  ![../\_images/qiskit-circuit-library-Permutation-2.png](/docs/images/api/qiskit/0.44/qiskit-circuit-library-Permutation-2.avif)
  ...
  <Attribute id="qiskit.circuit.library.Permutation.instances" attributeValue="242" />
