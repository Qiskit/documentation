...
<Class id="qiskit.quantum_info.XXDecomposer" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/quantum_info/synthesis/xx_decompose/decomposer.py" signature="qiskit.quantum_info.XXDecomposer(basis_fidelity=1.0, euler_basis='U', embodiments=None, backup_optimizer=None)">
