---
title: AbelianGrouper (v0.44)
description: API reference for qiskit.opflow.converters.AbelianGrouper in qiskit v0.44
...
<Class id="qiskit.opflow.converters.AbelianGrouper" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/opflow/converters/abelian_grouper.py" signature="qiskit.opflow.converters.AbelianGrouper(traverse=True)" modifiers="class">
