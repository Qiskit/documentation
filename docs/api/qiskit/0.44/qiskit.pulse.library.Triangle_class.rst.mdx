---
title: Triangle (v0.44)
description: API reference for qiskit.pulse.library.Triangle in qiskit v0.44
...
<Function id="qiskit.pulse.library.Triangle" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/pulse/library/symbolic_pulses.py" signature="qiskit.pulse.library.Triangle(duration, amp, phase, freq=None, angle=0.0, name=None, limit_amplitude=None)">
