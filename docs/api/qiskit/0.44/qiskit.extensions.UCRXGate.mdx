...
<Class id="qiskit.extensions.UCRXGate" github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/extensions/quantum_initializer/ucrx.py" signature="qiskit.extensions.UCRXGate(angle_list)">
