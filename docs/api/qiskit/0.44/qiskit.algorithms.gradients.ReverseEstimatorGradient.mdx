...
<Class id="qiskit.algorithms.gradients.ReverseEstimatorGradient" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/algorithms/gradients/reverse/reverse_gradient.py" signature="qiskit.algorithms.gradients.ReverseEstimatorGradient(derivative_type=DerivativeType.REAL)">
