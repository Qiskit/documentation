---
title: NumPyMinimumEigensolverResult (v0.44)
description: API reference for qiskit.algorithms.minimum_eigensolvers.NumPyMinimumEigensolverResult in qiskit v0.44
