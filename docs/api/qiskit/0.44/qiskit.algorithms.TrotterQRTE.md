...
`qiskit.algorithms.TrotterQRTE(product_formula=None, expectation=None, quantum_instance=None)` [GitHub](https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/algorithms/evolvers/trotterization/trotter_qrte.py "view source code")
