---
title: MatrixEvolution (v0.44)
description: API reference for qiskit.opflow.evolutions.MatrixEvolution in qiskit v0.44
...
<Class id="qiskit.opflow.evolutions.MatrixEvolution" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/opflow/evolutions/matrix_evolution.py" signature="qiskit.opflow.evolutions.MatrixEvolution" modifiers="class">
