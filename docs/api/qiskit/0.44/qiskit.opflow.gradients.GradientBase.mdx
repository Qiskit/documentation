...
<Class id="qiskit.opflow.gradients.GradientBase" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/opflow/gradients/gradient_base.py" signature="qiskit.opflow.gradients.GradientBase(grad_method='param_shift', **kwargs)">
