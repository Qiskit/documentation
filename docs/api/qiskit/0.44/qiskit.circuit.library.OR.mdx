---
title: OR (v0.44)
description: API reference for qiskit.circuit.library.OR in qiskit v0.44
...
<Class id="qiskit.circuit.library.OR" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/circuit/library/boolean_logic/quantum_or.py" signature="qiskit.circuit.library.OR(num_variable_qubits, flags=None, mcx_mode='noancilla')" modifiers="class">
  ...
  ![../\_images/qiskit-circuit-library-OR-1.png](/docs/images/api/qiskit/0.44/qiskit-circuit-library-OR-1.avif)
  ...
  ![../\_images/qiskit-circuit-library-OR-2.png](/docs/images/api/qiskit/0.44/qiskit-circuit-library-OR-2.avif)
