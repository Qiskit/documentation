---
title: JobStatus (v0.44)
description: API reference for qiskit.providers.JobStatus in qiskit v0.44
...
<Class id="qiskit.providers.JobStatus" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/providers/jobstatus.py" signature="qiskit.providers.JobStatus(value)" modifiers="class">
