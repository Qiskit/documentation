---
title: RC3XGate (v0.44)
description: API reference for qiskit.circuit.library.RC3XGate in qiskit v0.44
...
<Class id="qiskit.circuit.library.RC3XGate" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/circuit/library/standard_gates/x.py" signature="qiskit.circuit.library.RC3XGate(label=None)" modifiers="class">
