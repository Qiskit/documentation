---
title: MatrixExpectation (v0.44)
description: API reference for qiskit.opflow.expectations.MatrixExpectation in qiskit v0.44
...
<Class id="qiskit.opflow.expectations.MatrixExpectation" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/opflow/expectations/matrix_expectation.py" signature="qiskit.opflow.expectations.MatrixExpectation" modifiers="class">
