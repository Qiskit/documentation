---
title: QobjHeader (v0.44)
description: API reference for qiskit.qobj.QobjHeader in qiskit v0.44
...
<Class id="qiskit.qobj.QobjHeader" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/qobj/common.py" signature="qiskit.qobj.QobjHeader(**kwargs)" modifiers="class">
  Bases: `QobjDictField`
