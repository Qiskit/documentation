...
<Class id="qiskit.providers.fake_provider.FakeLima" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/providers/fake_provider/backends/lima/fake_lima.py" signature="qiskit.providers.fake_provider.FakeLima">
