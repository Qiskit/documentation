...
<Class id="qiskit.transpiler.passes.CollectLinearFunctions" github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/transpiler/passes/optimization/collect_linear_functions.py" signature="qiskit.transpiler.passes.CollectLinearFunctions(*args, **kwargs)">
