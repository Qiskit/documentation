...
<Class id="qiskit.transpiler.passes.Unroller" github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/transpiler/passes/basis/unroller.py" signature="qiskit.transpiler.passes.Unroller(*args, **kwargs)">
