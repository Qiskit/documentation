...
<Class id="qiskit.transpiler.passes.NumTensorFactors" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/transpiler/passes/analysis/num_tensor_factors.py" signature="qiskit.transpiler.passes.NumTensorFactors(*args, **kwargs)">
