---
title: BasicAerJob (v0.44)
description: API reference for qiskit.providers.basicaer.BasicAerJob in qiskit v0.44
...
<Class id="qiskit.providers.basicaer.BasicAerJob" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/providers/basicaer/basicaerjob.py" signature="qiskit.providers.basicaer.BasicAerJob(backend, job_id, result)" modifiers="class">
