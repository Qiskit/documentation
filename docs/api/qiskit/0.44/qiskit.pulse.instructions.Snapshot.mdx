...
description: API reference for qiskit.pulse.instructions.Snapshot in qiskit v0.44
...
<Class id="qiskit.pulse.instructions.Snapshot" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/pulse/instructions/snapshot.py" signature="qiskit.pulse.instructions.Snapshot(label, snapshot_type='statevector', name=None)" modifiers="class">
