...
`qiskit.opflow.converters.AbelianGrouper(traverse=True)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.44/qiskit/opflow/converters/abelian_grouper.py "view source code")
