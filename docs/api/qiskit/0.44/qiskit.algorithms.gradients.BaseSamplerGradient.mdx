...
<Class id="qiskit.algorithms.gradients.BaseSamplerGradient" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/algorithms/gradients/base/base_sampler_gradient.py" signature="qiskit.algorithms.gradients.BaseSamplerGradient(sampler, options=None)">
