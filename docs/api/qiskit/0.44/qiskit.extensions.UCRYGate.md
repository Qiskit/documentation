...
`qiskit.extensions.UCRYGate(angle_list)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.44/qiskit/extensions/quantum_initializer/ucry.py "view source code")
