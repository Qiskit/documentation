...
<Class id="qiskit.transpiler.passes.UnrollCustomDefinitions" github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/transpiler/passes/basis/unroll_custom_definitions.py" signature="qiskit.transpiler.passes.UnrollCustomDefinitions(*args, **kwargs)">
