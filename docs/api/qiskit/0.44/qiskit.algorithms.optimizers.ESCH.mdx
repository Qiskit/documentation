---
title: ESCH (v0.44)
description: API reference for qiskit.algorithms.optimizers.ESCH in qiskit v0.44
...
<Class id="qiskit.algorithms.optimizers.ESCH" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/algorithms/optimizers/nlopts/esch.py" signature="qiskit.algorithms.optimizers.ESCH(max_evals=1000)" modifiers="class">
