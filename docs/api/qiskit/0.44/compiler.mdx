---
title: compiler (v0.44)
description: API reference for qiskit.compiler in qiskit v0.44
...
<Function id="qiskit.compiler.schedule" github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/compiler/scheduler.py" signature="qiskit.compiler.schedule(circuits, backend=None, inst_map=None, meas_map=None, dt=None, method=None)">
...
<Function id="qiskit.compiler.sequence" github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/compiler/sequencer.py" signature="qiskit.compiler.sequence(scheduled_circuits, backend=None, inst_map=None, meas_map=None, dt=None)">
