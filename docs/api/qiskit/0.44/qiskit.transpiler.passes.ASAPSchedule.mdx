---
title: ASAPSchedule (v0.44)
description: API reference for qiskit.transpiler.passes.ASAPSchedule in qiskit v0.44
...
<Class id="qiskit.transpiler.passes.ASAPSchedule" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/transpiler/passes/scheduling/asap.py" signature="qiskit.transpiler.passes.ASAPSchedule(*args, **kwargs)" modifiers="class">
