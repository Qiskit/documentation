...
<Function id="qiskit.opflow.commutator" name="commutator" github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/opflow/utils.py" signature="qiskit.opflow.commutator(op_a, op_b)">
...
<Function id="qiskit.opflow.anti_commutator" name="anti_commutator" github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/opflow/utils.py" signature="qiskit.opflow.anti_commutator(op_a, op_b)">
...
<Function id="qiskit.opflow.double_commutator" name="double_commutator" github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/opflow/utils.py" signature="qiskit.opflow.double_commutator(op_a, op_b, op_c, sign=False)">
...
<Class id="qiskit.opflow.OpflowError" name="OpflowError" github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/opflow/exceptions.py" signature="qiskit.opflow.OpflowError(*message)">
