---
title: MaximumLikelihoodAmplitudeEstimationResult (v0.44)
description: API reference for qiskit.algorithms.MaximumLikelihoodAmplitudeEstimationResult in qiskit v0.44
...
<Class id="qiskit.algorithms.MaximumLikelihoodAmplitudeEstimationResult" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/algorithms/amplitude_estimators/mlae.py" signature="qiskit.algorithms.MaximumLikelihoodAmplitudeEstimationResult" modifiers="class">
