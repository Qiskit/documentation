---
title: unitary_synthesis_plugin_names (v0.44)
description: API reference for qiskit.transpiler.passes.synthesis.plugin.unitary_synthesis_plugin_names in qiskit v0.44
...
<Function id="qiskit.transpiler.passes.synthesis.plugin.unitary_synthesis_plugin_names" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/transpiler/passes/synthesis/plugin.py" signature="qiskit.transpiler.passes.synthesis.plugin.unitary_synthesis_plugin_names()">
