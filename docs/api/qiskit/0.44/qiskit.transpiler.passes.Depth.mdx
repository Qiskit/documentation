...
<Class id="qiskit.transpiler.passes.Depth" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/transpiler/passes/analysis/depth.py" signature="qiskit.transpiler.passes.Depth(*args, **kwargs)">
