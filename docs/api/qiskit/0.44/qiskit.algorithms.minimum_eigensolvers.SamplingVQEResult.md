...
`qiskit.algorithms.minimum_eigensolvers.SamplingVQEResult` [GitHub](https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/algorithms/minimum_eigensolvers/sampling_vqe.py "view source code")
