...
`qiskit.providers.fake_provider.FakeWashington` [GitHub](https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/providers/fake_provider/backends/washington/fake_washington.py "view source code")
