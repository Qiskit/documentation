---
title: plot_error_map (v0.44)
description: API reference for qiskit.visualization.plot_error_map in qiskit v0.44
...
<Function id="qiskit.visualization.plot_error_map" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/visualization/gate_map.py" signature="qiskit.visualization.plot_error_map(backend, figsize=(12, 9), show_title=True, qubit_coordinates=None)">
  ...
  **Example**
  ...
  ![../\_images/qiskit-visualization-plot\_error\_map-1.png](/docs/images/api/qiskit/0.44/qiskit-visualization-plot_error_map-1.avif)
</Function>
