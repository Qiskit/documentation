...
<Class id="qiskit.transpiler.passes.CollectCliffords" github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/transpiler/passes/optimization/collect_cliffords.py" signature="qiskit.transpiler.passes.CollectCliffords(*args, **kwargs)">
