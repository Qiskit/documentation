...
`qiskit.visualization.qcstyle.DefaultStyle`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.44/qiskit/visualization/circuit/qcstyle.py "view source code")
