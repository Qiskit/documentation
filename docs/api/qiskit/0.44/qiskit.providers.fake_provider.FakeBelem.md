...
`qiskit.providers.fake_provider.FakeBelem` [GitHub](https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/providers/fake_provider/backends/belem/fake_belem.py "view source code")
