...
`qiskit.opflow.converters.TwoQubitReduction(num_particles)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.44/qiskit/opflow/converters/two_qubit_reduction.py "view source code")
