...
<Class id="qiskit.transpiler.passes.AlignMeasures" github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/transpiler/passes/scheduling/alignments/align_measures.py" signature="qiskit.transpiler.passes.AlignMeasures(*args, **kwargs)">
