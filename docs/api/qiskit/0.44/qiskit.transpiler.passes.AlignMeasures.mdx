---
title: AlignMeasures (v0.44)
description: API reference for qiskit.transpiler.passes.AlignMeasures in qiskit v0.44
...
<Class id="qiskit.transpiler.passes.AlignMeasures" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/transpiler/passes/scheduling/alignments/align_measures.py" signature="qiskit.transpiler.passes.AlignMeasures(*args, **kwargs)" modifiers="class">
