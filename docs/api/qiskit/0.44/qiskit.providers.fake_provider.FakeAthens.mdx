...
`qiskit.providers.fake_provider.FakeAthens` [GitHub](https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/providers/fake_provider/backends/athens/fake_athens.py "view source code")
