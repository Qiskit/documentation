...
<Class id="qiskit.transpiler.DoWhileController" github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/transpiler/runningpassmanager.py" signature="qiskit.transpiler.DoWhileController(passes, options=None, do_while=None, **partial_controller)">
