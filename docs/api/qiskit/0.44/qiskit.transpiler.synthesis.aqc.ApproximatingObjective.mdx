...
<Class id="qiskit.transpiler.synthesis.aqc.ApproximatingObjective" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/transpiler/synthesis/aqc/approximate.py" signature="qiskit.transpiler.synthesis.aqc.ApproximatingObjective">
  ...
  <Function id="qiskit.transpiler.synthesis.aqc.ApproximatingObjective.gradient" name="gradient" signature="abstract gradient(param_values)">
  ...
  <Function id="qiskit.transpiler.synthesis.aqc.ApproximatingObjective.objective" name="objective" signature="abstract objective(param_values)">
