---
title: Gradient (v0.44)
description: API reference for qiskit.opflow.gradients.Gradient in qiskit v0.44
...
<Class id="qiskit.opflow.gradients.Gradient" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/opflow/gradients/gradient.py" signature="qiskit.opflow.gradients.Gradient(grad_method='param_shift', **kwargs)" modifiers="class">
