...
<Class id="qiskit.quantum_info.StabilizerTable" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/quantum_info/operators/symplectic/stabilizer_table.py" signature="qiskit.quantum_info.StabilizerTable(data, phase=None)">
...
$$
  ...
  **Additional Information:**
  ...
  <Attribute id="qiskit.quantum_info.StabilizerTable.settings" name="settings">
    Return settings.
  </Attribute>
  ...
  <Function id="qiskit.quantum_info.StabilizerTable.reshape" name="reshape" signature="reshape(input_dims=None, output_dims=None, num_qubits=None)">
