...
<Class id="qiskit.quantum_info.StabilizerTable" github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/quantum_info/operators/symplectic/stabilizer_table.py" signature="qiskit.quantum_info.StabilizerTable(data, phase=None)">
