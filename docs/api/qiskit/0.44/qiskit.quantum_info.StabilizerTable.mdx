---
title: StabilizerTable (v0.44)
description: API reference for qiskit.quantum_info.StabilizerTable in qiskit v0.44
...
<Class id="qiskit.quantum_info.StabilizerTable" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/quantum_info/operators/symplectic/stabilizer_table.py" signature="qiskit.quantum_info.StabilizerTable(data, phase=None)" modifiers="class">
