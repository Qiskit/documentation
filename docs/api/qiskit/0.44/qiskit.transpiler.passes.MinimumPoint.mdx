...
<Class id="qiskit.transpiler.passes.MinimumPoint" github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/transpiler/passes/utils/minimum_point.py" signature="qiskit.transpiler.passes.MinimumPoint(*args, **kwargs)">
