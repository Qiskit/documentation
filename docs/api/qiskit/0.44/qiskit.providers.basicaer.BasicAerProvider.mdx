---
title: BasicAerProvider (v0.44)
description: API reference for qiskit.providers.basicaer.BasicAerProvider in qiskit v0.44
...
<Class id="qiskit.providers.basicaer.BasicAerProvider" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/providers/basicaer/basicaerprovider.py" signature="qiskit.providers.basicaer.BasicAerProvider" modifiers="class">
