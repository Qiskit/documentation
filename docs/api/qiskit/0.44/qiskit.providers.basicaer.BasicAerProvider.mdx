...
<Class id="qiskit.providers.basicaer.BasicAerProvider" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/providers/basicaer/basicaerprovider.py" signature="qiskit.providers.basicaer.BasicAerProvider">
  ...
  <Function id="qiskit.providers.basicaer.BasicAerProvider.backends" name="backends" signature="backends(name=None, filters=None, **kwargs)">
  ...
  <Function id="qiskit.providers.basicaer.BasicAerProvider.get_backend" name="get_backend" signature="get_backend(name=None, **kwargs)">
