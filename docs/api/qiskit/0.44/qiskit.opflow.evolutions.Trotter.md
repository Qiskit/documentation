...
`qiskit.opflow.evolutions.Trotter(reps=1)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.44/qiskit/opflow/evolutions/trotterizations/trotter.py "view source code")
