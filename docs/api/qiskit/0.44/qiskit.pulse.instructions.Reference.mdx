...
<Class id="qiskit.pulse.instructions.Reference" github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/pulse/instructions/reference.py" signature="qiskit.pulse.instructions.Reference(name, *extra_keys)">
