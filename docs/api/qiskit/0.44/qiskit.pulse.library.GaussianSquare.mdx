...
<Class id="qiskit.pulse.library.GaussianSquare" github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/pulse/library/symbolic_pulses.py" signature="qiskit.pulse.library.GaussianSquare(duration, amp, sigma, width=None, angle=None, risefall_sigma_ratio=None, name=None, limit_amplitude=None)">
...
$$
  ...
  **Raises**
  ...
  <Attribute id="qiskit.pulse.library.GaussianSquare.alias" name="alias" attributeValue="= 'GaussianSquare'" />
</Class>
