...
`qiskit.opflow.evolutions.Suzuki(reps=1, order=2)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.44/qiskit/opflow/evolutions/trotterizations/suzuki.py "view source code")
