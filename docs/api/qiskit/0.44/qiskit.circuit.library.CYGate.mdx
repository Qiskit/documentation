...
<Class id="qiskit.circuit.library.CYGate" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/circuit/library/standard_gates/y.py" signature="qiskit.circuit.library.CYGate(label=None, ctrl_state=None)">
