---
title: CYGate (v0.44)
description: API reference for qiskit.circuit.library.CYGate in qiskit v0.44
...
<Class id="qiskit.circuit.library.CYGate" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/circuit/library/standard_gates/y.py" signature="qiskit.circuit.library.CYGate(label=None, ctrl_state=None)" modifiers="class">
