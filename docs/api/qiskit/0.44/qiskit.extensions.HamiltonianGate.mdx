...
<Class id="qiskit.extensions.HamiltonianGate" github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/extensions/hamiltonian_gate.py" signature="qiskit.extensions.HamiltonianGate(data, time, label=None)">
