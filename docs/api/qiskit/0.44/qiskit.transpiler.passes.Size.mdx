...
<Class id="qiskit.transpiler.passes.Size" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/transpiler/passes/analysis/size.py" signature="qiskit.transpiler.passes.Size(*args, **kwargs)">
