...
`qiskit.quantum_info.PauliTable(data)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.44/qiskit/quantum_info/operators/symplectic/pauli_table.py "view source code")
