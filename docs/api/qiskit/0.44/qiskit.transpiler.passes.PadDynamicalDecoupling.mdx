...
<Class id="qiskit.transpiler.passes.PadDynamicalDecoupling" github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/transpiler/passes/scheduling/padding/dynamical_decoupling.py" signature="qiskit.transpiler.passes.PadDynamicalDecoupling(*args, **kwargs)">
  Bases: `BasePadding`
