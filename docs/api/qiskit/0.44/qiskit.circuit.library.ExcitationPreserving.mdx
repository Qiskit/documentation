---
title: ExcitationPreserving (v0.44)
description: API reference for qiskit.circuit.library.ExcitationPreserving in qiskit v0.44
...
$$
  ...
  **Raises**
  ...
  <Attribute id="qiskit.circuit.library.ExcitationPreserving.instances" attributeValue="127" />
