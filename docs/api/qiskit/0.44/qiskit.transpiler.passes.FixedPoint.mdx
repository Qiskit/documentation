...
<Class id="qiskit.transpiler.passes.FixedPoint" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/transpiler/passes/utils/fixed_point.py" signature="qiskit.transpiler.passes.FixedPoint(*args, **kwargs)">
