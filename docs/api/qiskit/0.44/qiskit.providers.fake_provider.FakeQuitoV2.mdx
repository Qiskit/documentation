...
<Class id="qiskit.providers.fake_provider.FakeQuitoV2" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/providers/fake_provider/backends/quito/fake_quito.py" signature="qiskit.providers.fake_provider.FakeQuitoV2">
  Bases: `FakeBackendV2`
  ...
  <Attribute id="qiskit.providers.fake_provider.FakeQuitoV2.backend_name" name="backend_name" attributeValue="'fake_quito'" />
  ...
  <Attribute id="qiskit.providers.fake_provider.FakeQuitoV2.dirname" name="dirname" attributeValue="'/home/runner/work/qiskit/qiskit/.tox/docs/lib/python3.9/site-packages/qiskit/providers/fake_provider/backends/quito'" />
  ...
  <Function id="qiskit.providers.fake_provider.FakeQuitoV2.acquire_channel" name="acquire_channel" signature="acquire_channel(qubit)">
  ...
  <Function id="qiskit.providers.fake_provider.FakeQuitoV2.control_channel" name="control_channel" signature="control_channel(qubits)">
  ...
  <Function id="qiskit.providers.fake_provider.FakeQuitoV2.drive_channel" name="drive_channel" signature="drive_channel(qubit)">
  ...
  <Function id="qiskit.providers.fake_provider.FakeQuitoV2.measure_channel" name="measure_channel" signature="measure_channel(qubit)">
  ...
  <Function id="qiskit.providers.fake_provider.FakeQuitoV2.qubit_properties" name="qubit_properties" signature="qubit_properties(qubit)">
  ...
  <Function id="qiskit.providers.fake_provider.FakeQuitoV2.run" name="run" signature="run(run_input, **options)">
  ...
  <Function id="qiskit.providers.fake_provider.FakeQuitoV2.set_options" name="set_options" signature="set_options(**fields)">
