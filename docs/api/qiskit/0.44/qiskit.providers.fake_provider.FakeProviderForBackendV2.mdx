...
<Class id="qiskit.providers.fake_provider.FakeProviderForBackendV2" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/providers/fake_provider/fake_provider.py" signature="qiskit.providers.fake_provider.FakeProviderForBackendV2">
  ...
  <Function id="qiskit.providers.fake_provider.FakeProviderForBackendV2.backends" name="backends" signature="backends(name=None, **kwargs)">
  ...
  <Function id="qiskit.providers.fake_provider.FakeProviderForBackendV2.get_backend" name="get_backend" signature="get_backend(name=None, **kwargs)">
