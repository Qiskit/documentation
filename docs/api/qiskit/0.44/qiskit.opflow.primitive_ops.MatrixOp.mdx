---
title: MatrixOp (v0.44)
description: API reference for qiskit.opflow.primitive_ops.MatrixOp in qiskit v0.44
...
<Class id="qiskit.opflow.primitive_ops.MatrixOp" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/opflow/primitive_ops/matrix_op.py" signature="qiskit.opflow.primitive_ops.MatrixOp(*args, **kwargs)" modifiers="class">
