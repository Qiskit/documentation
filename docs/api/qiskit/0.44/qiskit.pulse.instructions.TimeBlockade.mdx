...
<Class id="qiskit.pulse.instructions.TimeBlockade" github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/pulse/instructions/directives.py" signature="qiskit.pulse.instructions.TimeBlockade(duration, channel, name=None)">
  Bases: `Directive`
