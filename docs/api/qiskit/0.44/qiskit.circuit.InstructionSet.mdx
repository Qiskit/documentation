---
title: InstructionSet (v0.44)
description: API reference for qiskit.circuit.InstructionSet in qiskit v0.44
...
<Class id="qiskit.circuit.InstructionSet" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/circuit/instructionset.py" signature="qiskit.circuit.InstructionSet(*, resource_requester=None)" modifiers="class">
  ...
  **resource\_requester** (*Callable\[...,* [*ClassicalRegister*](qiskit.circuit.ClassicalRegister "qiskit.circuit.ClassicalRegister")  *|*[*Clbit*](qiskit.circuit.Clbit "qiskit.circuit.Clbit")*] | None*) –
  ...
  <Function id="qiskit.circuit.InstructionSet.c_if" signature="c_if(classical, val)">
    ...
    **Example**
    ...
    ![../\_images/qiskit-circuit-InstructionSet-1.png](/docs/images/api/qiskit/0.44/qiskit-circuit-InstructionSet-1.avif)
  </Function>
