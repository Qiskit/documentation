...
`qiskit.providers.fake_provider.FakePrague`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.44/qiskit/providers/fake_provider/backends/prague/fake_prague.py "view source code")
