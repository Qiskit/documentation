---
title: CNOTUnitCircuit (v0.44)
description: API reference for qiskit.transpiler.synthesis.aqc.CNOTUnitCircuit in qiskit v0.44
...
<Class id="qiskit.transpiler.synthesis.aqc.CNOTUnitCircuit" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/transpiler/synthesis/aqc/cnot_unit_circuit.py" signature="qiskit.transpiler.synthesis.aqc.CNOTUnitCircuit(num_qubits, cnots, tol=0.0, name=None)" modifiers="class">
  ...
  **Raises**
  ...
  <Attribute id="qiskit.transpiler.synthesis.aqc.CNOTUnitCircuit.instances" attributeValue="127" />
