---
title: DAGOutNode (v0.44)
description: API reference for qiskit.dagcircuit.DAGOutNode in qiskit v0.44
...
<Class id="qiskit.dagcircuit.DAGOutNode" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/dagcircuit/dagnode.py" signature="qiskit.dagcircuit.DAGOutNode(wire)" modifiers="class">
