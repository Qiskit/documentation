...
<Class id="qiskit.transpiler.passes.Unroll3qOrMore" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/transpiler/passes/basis/unroll_3q_or_more.py" signature="qiskit.transpiler.passes.Unroll3qOrMore(*args, **kwargs)">
