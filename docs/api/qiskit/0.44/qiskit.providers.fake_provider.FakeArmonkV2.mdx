...
description: API reference for qiskit.providers.fake_provider.FakeArmonkV2 in qiskit v0.44
...
<Class id="qiskit.providers.fake_provider.FakeArmonkV2" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/providers/fake_provider/backends/armonk/fake_armonk.py" signature="qiskit.providers.fake_provider.FakeArmonkV2" modifiers="class">
  Bases: `FakeBackendV2`
  ...
  <Attribute id="qiskit.providers.fake_provider.FakeArmonkV2.dirname" attributeValue="'/home/runner/work/qiskit/qiskit/.tox/docs/lib/python3.9/site-packages/qiskit/providers/fake_provider/backends/armonk'" />
  ...
  <Function id="qiskit.providers.fake_provider.FakeArmonkV2.acquire_channel" signature="acquire_channel(qubit)">
  ...
  <Function id="qiskit.providers.fake_provider.FakeArmonkV2.control_channel" signature="control_channel(qubits)">
  ...
  <Function id="qiskit.providers.fake_provider.FakeArmonkV2.drive_channel" signature="drive_channel(qubit)">
  ...
  <Function id="qiskit.providers.fake_provider.FakeArmonkV2.measure_channel" signature="measure_channel(qubit)">
  ...
  <Function id="qiskit.providers.fake_provider.FakeArmonkV2.qubit_properties" signature="qubit_properties(qubit)">
  ...
  <Function id="qiskit.providers.fake_provider.FakeArmonkV2.run" signature="run(run_input, **options)">
  ...
  <Function id="qiskit.providers.fake_provider.FakeArmonkV2.set_options" signature="set_options(**fields)">
