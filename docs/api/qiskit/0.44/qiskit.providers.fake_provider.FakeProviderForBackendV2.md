...
`qiskit.providers.fake_provider.FakeProviderForBackendV2` [GitHub](https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/providers/fake_provider/fake_provider.py "view source code")
