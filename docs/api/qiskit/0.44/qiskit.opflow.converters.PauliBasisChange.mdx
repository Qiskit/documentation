...
<Class id="qiskit.opflow.converters.PauliBasisChange" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/opflow/converters/pauli_basis_change.py" signature="qiskit.opflow.converters.PauliBasisChange(destination_basis=None, traverse=True, replacement_fn=None)">
  ...
  *   **replacement\_fn** ([*Callable*](https://docs.python.org/3/library/typing.html#typing.Callable "(in Python v3.12)") *| None*) –
  ...
  <Function id="qiskit.opflow.converters.PauliBasisChange.measurement_replacement_fn" signature="static measurement_replacement_fn(cob_instr_op, dest_pauli_op)">
  ...
  <Function id="qiskit.opflow.converters.PauliBasisChange.operator_replacement_fn" signature="static operator_replacement_fn(cob_instr_op, dest_pauli_op)">
  ...
  <Function id="qiskit.opflow.converters.PauliBasisChange.statefn_replacement_fn" signature="static statefn_replacement_fn(cob_instr_op, dest_pauli_op)">
