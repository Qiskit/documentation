...
`qiskit.opflow.converters.PauliBasisChange(destination_basis=None, traverse=True, replacement_fn=None)` [GitHub](https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/opflow/converters/pauli_basis_change.py "view source code")
