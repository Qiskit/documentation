---
title: BaseReadoutMitigator (v0.44)
description: API reference for qiskit.result.BaseReadoutMitigator in qiskit v0.44
...
<Class id="qiskit.result.BaseReadoutMitigator" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/result/mitigation/base_readout_mitigator.py" signature="qiskit.result.BaseReadoutMitigator" modifiers="class">
