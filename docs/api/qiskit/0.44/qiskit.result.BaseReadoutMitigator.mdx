...
`qiskit.result.BaseReadoutMitigator` [GitHub](https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/result/mitigation/base_readout_mitigator.py "view source code")
