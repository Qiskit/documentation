---
title: FakeSydneyV2 (v0.44)
description: API reference for qiskit.providers.fake_provider.FakeSydneyV2 in qiskit v0.44
...
<Class id="qiskit.providers.fake_provider.FakeSydneyV2" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/providers/fake_provider/backends/sydney/fake_sydney.py" signature="qiskit.providers.fake_provider.FakeSydneyV2" modifiers="class">
  Bases: `FakeBackendV2`
  ...
  <Attribute id="qiskit.providers.fake_provider.FakeSydneyV2.backend_name" attributeValue="'fake_sydney'" />
  ...
  <Attribute id="qiskit.providers.fake_provider.FakeSydneyV2.dirname" attributeValue="'/home/runner/work/qiskit/qiskit/.tox/docs/lib/python3.9/site-packages/qiskit/providers/fake_provider/backends/sydney'" />
  ...
  <Function id="qiskit.providers.fake_provider.FakeSydneyV2.acquire_channel" signature="acquire_channel(qubit)">
  ...
  <Function id="qiskit.providers.fake_provider.FakeSydneyV2.control_channel" signature="control_channel(qubits)">
  ...
  <Function id="qiskit.providers.fake_provider.FakeSydneyV2.drive_channel" signature="drive_channel(qubit)">
  ...
  <Function id="qiskit.providers.fake_provider.FakeSydneyV2.measure_channel" signature="measure_channel(qubit)">
  ...
  <Function id="qiskit.providers.fake_provider.FakeSydneyV2.qubit_properties" signature="qubit_properties(qubit)">
  ...
  <Function id="qiskit.providers.fake_provider.FakeSydneyV2.run" signature="run(run_input, **options)">
  ...
  <Function id="qiskit.providers.fake_provider.FakeSydneyV2.set_options" signature="set_options(**fields)">
