...
`qiskit.providers.fake_provider.FakeSydneyV2` [GitHub](https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/providers/fake_provider/backends/sydney/fake_sydney.py "view source code")
...
`= '/home/runner/work/qiskit/qiskit/.tox/docs/lib/python3.9/site-packages/qiskit/providers/fake_provider/backends/sydney'`
