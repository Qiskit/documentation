---
title: PauliTable (v0.44)
description: API reference for qiskit.quantum_info.PauliTable in qiskit v0.44
...
<Class id="qiskit.quantum_info.PauliTable" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/quantum_info/operators/symplectic/pauli_table.py" signature="qiskit.quantum_info.PauliTable(data)" modifiers="class">
