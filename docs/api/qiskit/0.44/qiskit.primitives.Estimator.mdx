...
<Class id="qiskit.primitives.Estimator" github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/primitives/estimator.py" signature="qiskit.primitives.Estimator(*, options=None)">
