---
title: OptimizerState (v0.44)
description: API reference for qiskit.algorithms.optimizers.OptimizerState in qiskit v0.44
...
<Class id="qiskit.algorithms.optimizers.OptimizerState" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/algorithms/optimizers/steppable_optimizer.py" signature="qiskit.algorithms.optimizers.OptimizerState(x, fun, jac, nfev, njev, nit)" modifiers="class">
