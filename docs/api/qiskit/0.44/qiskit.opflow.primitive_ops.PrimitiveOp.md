...
`qiskit.opflow.primitive_ops.PrimitiveOp(primitive, coeff=1.0)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.44/qiskit/opflow/primitive_ops/primitive_op.py "view source code")
