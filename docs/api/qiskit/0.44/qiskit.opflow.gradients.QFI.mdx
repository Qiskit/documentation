---
title: QFI (v0.44)
description: API reference for qiskit.opflow.gradients.QFI in qiskit v0.44
...
<Class id="qiskit.opflow.gradients.QFI" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/opflow/gradients/qfi.py" signature="qiskit.opflow.gradients.QFI(qfi_method='lin_comb_full')" modifiers="class">
