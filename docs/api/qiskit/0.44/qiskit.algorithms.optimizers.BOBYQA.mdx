---
title: BOBYQA (v0.44)
description: API reference for qiskit.algorithms.optimizers.BOBYQA in qiskit v0.44
...
<Class id="qiskit.algorithms.optimizers.BOBYQA" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/algorithms/optimizers/bobyqa.py" signature="qiskit.algorithms.optimizers.BOBYQA(maxiter=1000)" modifiers="class">
