...
`qiskit.extensions.UCRZGate(angle_list)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.44/qiskit/extensions/quantum_initializer/ucrz.py "view source code")
