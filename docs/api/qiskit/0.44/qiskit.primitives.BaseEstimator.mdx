...
<Class id="qiskit.primitives.BaseEstimator" github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/primitives/base/base_estimator.py" signature="qiskit.primitives.BaseEstimator(*, options=None)">
