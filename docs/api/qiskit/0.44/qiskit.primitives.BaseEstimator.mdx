---
title: BaseEstimator (v0.44)
description: API reference for qiskit.primitives.BaseEstimator in qiskit v0.44
...
<Class id="qiskit.primitives.BaseEstimator" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/primitives/base/base_estimator.py" signature="qiskit.primitives.BaseEstimator(*, options=None)" modifiers="class">
