...
`qiskit.transpiler.FencedDAGCircuit(dag_circuit_instance)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.44/qiskit/transpiler/fencedobjs.py "view source code")
