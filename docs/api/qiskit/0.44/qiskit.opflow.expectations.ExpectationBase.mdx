...
<Class id="qiskit.opflow.expectations.ExpectationBase" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/opflow/expectations/expectation_base.py" signature="qiskit.opflow.expectations.ExpectationBase">
