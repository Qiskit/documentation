---
title: ISRES (v0.44)
description: API reference for qiskit.algorithms.optimizers.ISRES in qiskit v0.44
...
<Class id="qiskit.algorithms.optimizers.ISRES" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/algorithms/optimizers/nlopts/isres.py" signature="qiskit.algorithms.optimizers.ISRES(max_evals=1000)" modifiers="class">
