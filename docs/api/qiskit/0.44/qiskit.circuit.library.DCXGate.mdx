---
title: DCXGate (v0.44)
description: API reference for qiskit.circuit.library.DCXGate in qiskit v0.44
...
<Class id="qiskit.circuit.library.DCXGate" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/circuit/library/standard_gates/dcx.py" signature="qiskit.circuit.library.DCXGate" modifiers="class">
