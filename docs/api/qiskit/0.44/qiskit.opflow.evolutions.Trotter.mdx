...
<Class id="qiskit.opflow.evolutions.Trotter" github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/opflow/evolutions/trotterizations/trotter.py" signature="qiskit.opflow.evolutions.Trotter(reps=1)">
