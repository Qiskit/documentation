---
title: IGate (v0.44)
description: API reference for qiskit.circuit.library.IGate in qiskit v0.44
...
<Class id="qiskit.circuit.library.IGate" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/circuit/library/standard_gates/i.py" signature="qiskit.circuit.library.IGate(label=None)" modifiers="class">
