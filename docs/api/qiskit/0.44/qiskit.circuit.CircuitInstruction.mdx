...
<Class id="qiskit.circuit.CircuitInstruction" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/circuit/quantumcircuitdata.py" signature="qiskit.circuit.CircuitInstruction(operation, qubits=(), clbits=())">
  ...
  <Attribute id="qiskit.circuit.CircuitInstruction.operation" name="operation" attributeTypeHint="Operation">
    The logical operation that this instruction represents an execution of.
  </Attribute>

  ### qubits

  <Attribute id="qiskit.circuit.CircuitInstruction.qubits" name="qubits" attributeTypeHint="Tuple[Qubit, ...]">
    A sequence of the qubits that the operation is applied to.
  </Attribute>

  ### clbits

  <Attribute id="qiskit.circuit.CircuitInstruction.clbits" name="clbits" attributeTypeHint="Tuple[Clbit, ...]">
  ...
  <Function id="qiskit.circuit.CircuitInstruction.copy" name="copy" signature="copy()">
  ...
  <Function id="qiskit.circuit.CircuitInstruction.replace" name="replace" signature="replace(operation=None, qubits=None, clbits=None)">
