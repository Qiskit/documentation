...
<Class id="qiskit.circuit.CircuitInstruction" github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/circuit/quantumcircuitdata.py" signature="qiskit.circuit.CircuitInstruction(operation, qubits=(), clbits=())">
