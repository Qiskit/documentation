...
`qiskit.circuit.CircuitInstruction(operation, qubits=(), clbits=())` [GitHub](https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/circuit/quantumcircuitdata.py "view source code")
