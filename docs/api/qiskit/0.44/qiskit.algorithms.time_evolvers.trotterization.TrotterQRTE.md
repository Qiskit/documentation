...
`qiskit.algorithms.time_evolvers.trotterization.TrotterQRTE(product_formula=None, estimator=None, num_timesteps=1)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.44/qiskit/algorithms/time_evolvers/trotterization/trotter_qrte.py "view source code")
