...
<Class id="qiskit.transpiler.ConditionalController" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/transpiler/runningpassmanager.py" signature="qiskit.transpiler.ConditionalController(passes, options=None, condition=None, **partial_controller)">
  ...
  <Function id="qiskit.transpiler.ConditionalController.add_flow_controller" name="add_flow_controller" signature="classmethod add_flow_controller(name, controller)">
  ...
  <Function id="qiskit.transpiler.ConditionalController.controller_factory" name="controller_factory" signature="classmethod controller_factory(passes, options, **partial_controller)">
  ...
  <Function id="qiskit.transpiler.ConditionalController.dump_passes" name="dump_passes" signature="dump_passes()">
  ...
  <Function id="qiskit.transpiler.ConditionalController.remove_flow_controller" name="remove_flow_controller" signature="classmethod remove_flow_controller(name)">
