...
<Class id="qiskit.transpiler.ConditionalController" github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/transpiler/runningpassmanager.py" signature="qiskit.transpiler.ConditionalController(passes, options=None, condition=None, **partial_controller)">
