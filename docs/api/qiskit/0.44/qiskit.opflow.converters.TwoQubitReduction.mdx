...
<Class id="qiskit.opflow.converters.TwoQubitReduction" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/opflow/converters/two_qubit_reduction.py" signature="qiskit.opflow.converters.TwoQubitReduction(num_particles)">
