...
`qiskit.algorithms.optimizers.Optimizer` [GitHub](https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/algorithms/optimizers/optimizer.py "view source code")
