...
<Class id="qiskit.transpiler.passes.SetIOLatency" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/transpiler/passes/scheduling/scheduling/set_io_latency.py" signature="qiskit.transpiler.passes.SetIOLatency(*args, **kwargs)">
