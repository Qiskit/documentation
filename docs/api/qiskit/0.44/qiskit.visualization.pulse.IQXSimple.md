...
`qiskit.visualization.pulse.IQXSimple(**kwargs)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.44/qiskit/visualization/pulse_v2/stylesheet.py "view source code")
