---
title: EvolutionFactory (v0.44)
description: API reference for qiskit.opflow.evolutions.EvolutionFactory in qiskit v0.44
...
<Class id="qiskit.opflow.evolutions.EvolutionFactory" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/opflow/evolutions/evolution_factory.py" signature="qiskit.opflow.evolutions.EvolutionFactory" modifiers="class">
