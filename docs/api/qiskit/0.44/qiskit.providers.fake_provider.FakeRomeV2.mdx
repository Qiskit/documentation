---
title: FakeRomeV2 (v0.44)
description: API reference for qiskit.providers.fake_provider.FakeRomeV2 in qiskit v0.44
...
<Class id="qiskit.providers.fake_provider.FakeRomeV2" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/providers/fake_provider/backends/rome/fake_rome.py" signature="qiskit.providers.fake_provider.FakeRomeV2" modifiers="class">
  Bases: `FakeBackendV2`
  ...
  <Attribute id="qiskit.providers.fake_provider.FakeRomeV2.backend_name" attributeValue="'fake_rome'" />
  ...
  <Attribute id="qiskit.providers.fake_provider.FakeRomeV2.dirname" attributeValue="'/home/runner/work/qiskit/qiskit/.tox/docs/lib/python3.9/site-packages/qiskit/providers/fake_provider/backends/rome'" />
  ...
  <Function id="qiskit.providers.fake_provider.FakeRomeV2.acquire_channel" signature="acquire_channel(qubit)">
  ...
  <Function id="qiskit.providers.fake_provider.FakeRomeV2.control_channel" signature="control_channel(qubits)">
  ...
  <Function id="qiskit.providers.fake_provider.FakeRomeV2.drive_channel" signature="drive_channel(qubit)">
  ...
  <Function id="qiskit.providers.fake_provider.FakeRomeV2.measure_channel" signature="measure_channel(qubit)">
  ...
  <Function id="qiskit.providers.fake_provider.FakeRomeV2.qubit_properties" signature="qubit_properties(qubit)">
  ...
  <Function id="qiskit.providers.fake_provider.FakeRomeV2.run" signature="run(run_input, **options)">
  ...
  <Function id="qiskit.providers.fake_provider.FakeRomeV2.set_options" signature="set_options(**fields)">
