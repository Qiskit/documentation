---
title: FakeAuckland (v0.44)
description: API reference for qiskit.providers.fake_provider.FakeAuckland in qiskit v0.44
...
<Class id="qiskit.providers.fake_provider.FakeAuckland" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/providers/fake_provider/backends/auckland/fake_auckland.py" signature="qiskit.providers.fake_provider.FakeAuckland" modifiers="class">
  Bases: `FakeBackendV2`
  ...
  <Attribute id="qiskit.providers.fake_provider.FakeAuckland.dirname" attributeValue="'/home/runner/work/qiskit/qiskit/.tox/docs/lib/python3.9/site-packages/qiskit/providers/fake_provider/backends/auckland'" />
