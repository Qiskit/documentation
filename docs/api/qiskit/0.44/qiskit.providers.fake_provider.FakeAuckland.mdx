...
<Class id="qiskit.providers.fake_provider.FakeAuckland" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/providers/fake_provider/backends/auckland/fake_auckland.py" signature="qiskit.providers.fake_provider.FakeAuckland">
  Bases: `FakeBackendV2`
  ...
  <Attribute id="qiskit.providers.fake_provider.FakeAuckland.dirname" name="dirname" attributeValue="= '/home/runner/work/qiskit/qiskit/.tox/docs/lib/python3.9/site-packages/qiskit/providers/fake_provider/backends/auckland'" />
