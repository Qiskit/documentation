...
`qiskit.algorithms.MinimumEigensolver`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.44/qiskit/algorithms/minimum_eigen_solvers/minimum_eigen_solver.py "view source code")
