...
<Class id="qiskit.quantum_info.OneQubitEulerDecomposer" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/quantum_info/synthesis/one_qubit_decompose.py" signature="qiskit.quantum_info.OneQubitEulerDecomposer(basis='U3', use_dag=False)">
  ...
  **Raises**
  ...
  <Function id="qiskit.quantum_info.OneQubitEulerDecomposer.angles" name="angles" signature="angles(unitary)">
  ...
  <Function id="qiskit.quantum_info.OneQubitEulerDecomposer.angles_and_phase" name="angles_and_phase" signature="angles_and_phase(unitary)">
  ...
  <Function id="qiskit.quantum_info.OneQubitEulerDecomposer.build_circuit" name="build_circuit" signature="build_circuit(gates, global_phase)">
