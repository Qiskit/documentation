...
<Class id="qiskit.quantum_info.OneQubitEulerDecomposer" github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/quantum_info/synthesis/one_qubit_decompose.py" signature="qiskit.quantum_info.OneQubitEulerDecomposer(basis='U3', use_dag=False)">
