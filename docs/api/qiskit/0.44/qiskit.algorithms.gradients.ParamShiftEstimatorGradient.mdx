---
title: ParamShiftEstimatorGradient (v0.44)
description: API reference for qiskit.algorithms.gradients.ParamShiftEstimatorGradient in qiskit v0.44
...
<Class id="qiskit.algorithms.gradients.ParamShiftEstimatorGradient" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/algorithms/gradients/param_shift/param_shift_estimator_gradient.py" signature="qiskit.algorithms.gradients.ParamShiftEstimatorGradient(estimator, options=None, derivative_type=DerivativeType.REAL)" modifiers="class">
