...
`qiskit.transpiler.passes.CXCancellation(*args, **kwargs)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.44/qiskit/transpiler/passes/optimization/cx_cancellation.py "view source code")
