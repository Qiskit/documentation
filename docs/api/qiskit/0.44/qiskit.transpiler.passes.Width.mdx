...
<Class id="qiskit.transpiler.passes.Width" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/transpiler/passes/analysis/width.py" signature="qiskit.transpiler.passes.Width(*args, **kwargs)">
