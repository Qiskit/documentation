...
<Class id="qiskit.transpiler.passes.synthesis.plugin.UnitarySynthesisPlugin" github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/transpiler/passes/synthesis/plugin.py" signature="qiskit.transpiler.passes.synthesis.plugin.UnitarySynthesisPlugin">
