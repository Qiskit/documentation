...
<Class id="qiskit.transpiler.synthesis.aqc.DefaultCNOTUnitObjective" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/transpiler/synthesis/aqc/cnot_unit_objective.py" signature="qiskit.transpiler.synthesis.aqc.DefaultCNOTUnitObjective(num_qubits, cnots)">
  ...
  *   **cnots** (*np.ndarray*) – a CNOT structure to be used in the optimization procedure.
  ...
  <Function id="qiskit.transpiler.synthesis.aqc.DefaultCNOTUnitObjective.gradient" name="gradient" signature="gradient(param_values)">
  ...
  <Function id="qiskit.transpiler.synthesis.aqc.DefaultCNOTUnitObjective.objective" name="objective" signature="objective(param_values)">
