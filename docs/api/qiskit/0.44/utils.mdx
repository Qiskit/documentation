...
<Function id="qiskit.utils.add_deprecation_to_docstring" name="add_deprecation_to_docstring" github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/utils/deprecation.py" signature="qiskit.utils.add_deprecation_to_docstring(func, msg, *, since, pending)">
...
<Function id="qiskit.utils.deprecate_arguments" name="deprecate_arguments" github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/utils/deprecation.py" signature="qiskit.utils.deprecate_arguments(kwarg_map, category=<class 'DeprecationWarning'>, *, since=None)">
...
<Function id="qiskit.utils.deprecate_func" name="deprecate_func" github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/utils/deprecation.py" signature="qiskit.utils.deprecate_func(*, since, additional_msg=None, pending=False, package_name='qiskit-terra', removal_timeline='no earlier than 3 months after the release date', is_property=False)">
...
<Function id="qiskit.utils.deprecate_function" name="deprecate_function" github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/utils/deprecation.py" signature="qiskit.utils.deprecate_function(msg, stacklevel=2, category=<class 'DeprecationWarning'>, *, since=None)">
...
<Function id="qiskit.utils.local_hardware_info" name="local_hardware_info" github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/utils/multiprocessing.py" signature="qiskit.utils.local_hardware_info()">
...
<Function id="qiskit.utils.is_main_process" name="is_main_process" github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/utils/multiprocessing.py" signature="qiskit.utils.is_main_process()">
  Checks whether the current process is the main one
</Function>

### apply\_prefix

<Function id="qiskit.utils.apply_prefix" name="apply_prefix" github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/utils/units.py" signature="qiskit.utils.apply_prefix(value, unit)">
...
<Function id="qiskit.utils.detach_prefix" name="detach_prefix" github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/utils/units.py" signature="qiskit.utils.detach_prefix(value, decimal=None)">
...
<Function id="qiskit.utils.wrap_method" name="wrap_method" github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/utils/classtools.py" signature="qiskit.utils.wrap_method(cls, name, *, before=None, after=None)">
...
<Function id="qiskit.utils.summarize_circuits" name="summarize_circuits" github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/utils/circuit_utils.py" signature="qiskit.utils.summarize_circuits(circuits)">
...
<Function id="qiskit.utils.get_entangler_map" name="get_entangler_map" github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/utils/entangler_map.py" signature="qiskit.utils.get_entangler_map(map_type, num_qubits, offset=0)">
...
<Function id="qiskit.utils.validate_entangler_map" name="validate_entangler_map" github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/utils/entangler_map.py" signature="qiskit.utils.validate_entangler_map(entangler_map, num_qubits, allow_double_entanglement=False)">
...
<Function id="qiskit.utils.has_ibmq" name="has_ibmq" github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/utils/backend_utils.py" signature="qiskit.utils.has_ibmq()">
...
<Function id="qiskit.utils.has_aer" name="has_aer" github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/utils/backend_utils.py" signature="qiskit.utils.has_aer()">
...
<Function id="qiskit.utils.name_args" name="name_args" github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/utils/name_unnamed_args.py" signature="qiskit.utils.name_args(mapping, skip=0)">
...
<Class id="qiskit.utils.LazyDependencyManager" github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/utils/lazy_tester.py" signature="qiskit.utils.LazyDependencyManager(*, name=None, callback=None, install=None, msg=None)">
  ...
  *   **msg** – an extra message to include in the error raised if this is required.
  ...
  <Function id="qiskit.utils.LazyDependencyManager._is_available" name="_is_available" signature="abstract _is_available()">
  ...
  <Function id="qiskit.utils.LazyDependencyManager.disable_locally" name="disable_locally" signature="disable_locally()">
  ...
  <Function id="qiskit.utils.LazyDependencyManager.require_in_call" name="require_in_call" signature="require_in_call(feature_or_callable: Callable) → Callable" extraSignatures={["require_in_call(feature_or_callable: str) → Callable[[Callable], Callable]"]}>
  ...
  <Function id="qiskit.utils.LazyDependencyManager.require_in_instance" name="require_in_instance" signature="require_in_instance(feature_or_class: Type) → Type" extraSignatures={["require_in_instance(feature_or_class: str) → Callable[[Type], Type]"]}>
  ...
  <Function id="qiskit.utils.LazyDependencyManager.require_now" name="require_now" signature="require_now(feature)">
...
<Class id="qiskit.utils.LazyImportTester" github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/utils/lazy_tester.py" signature="qiskit.utils.LazyImportTester(name_map_or_modules, *, name=None, callback=None, install=None, msg=None)">
...
<Class id="qiskit.utils.LazySubprocessTester" github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/utils/lazy_tester.py" signature="qiskit.utils.LazySubprocessTester(command, *, name=None, callback=None, install=None, msg=None)">
