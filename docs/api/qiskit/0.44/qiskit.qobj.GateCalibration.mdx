---
title: GateCalibration (v0.44)
description: API reference for qiskit.qobj.GateCalibration in qiskit v0.44
...
<Class id="qiskit.qobj.GateCalibration" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/qobj/qasm_qobj.py" signature="qiskit.qobj.GateCalibration(name, qubits, params, instructions)" modifiers="class">
