...
<Class id="qiskit.qobj.GateCalibration" github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/qobj/qasm_qobj.py" signature="qiskit.qobj.GateCalibration(name, qubits, params, instructions)">
