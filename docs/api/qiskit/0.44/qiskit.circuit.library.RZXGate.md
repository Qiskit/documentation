...
`qiskit.circuit.library.RZXGate(theta, label=None)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/circuit/library/standard_gates/rzx.py "view source code")
