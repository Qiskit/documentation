---
title: ZGate (v0.44)
description: API reference for qiskit.circuit.library.ZGate in qiskit v0.44
...
<Class id="qiskit.circuit.library.ZGate" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/circuit/library/standard_gates/z.py" signature="qiskit.circuit.library.ZGate(label=None)" modifiers="class">
