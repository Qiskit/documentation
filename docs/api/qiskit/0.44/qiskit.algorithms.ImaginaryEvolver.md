...
`qiskit.algorithms.ImaginaryEvolver`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.44/qiskit/algorithms/evolvers/imaginary_evolver.py "view source code")
