---
title: Optimize1qGatesSimpleCommutation (v0.44)
description: API reference for qiskit.transpiler.passes.Optimize1qGatesSimpleCommutation in qiskit v0.44
...
<Class id="qiskit.transpiler.passes.Optimize1qGatesSimpleCommutation" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/transpiler/passes/optimization/optimize_1q_commutation.py" signature="qiskit.transpiler.passes.Optimize1qGatesSimpleCommutation(*args, **kwargs)" modifiers="class">
