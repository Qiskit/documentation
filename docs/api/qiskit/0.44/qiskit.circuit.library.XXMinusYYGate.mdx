...
<Class id="qiskit.circuit.library.XXMinusYYGate" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/circuit/library/standard_gates/xx_minus_yy.py" signature="qiskit.circuit.library.XXMinusYYGate(theta, beta=0, label='(XX-YY)')">
