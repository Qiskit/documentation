---
title: VQEResult (v0.44)
description: API reference for qiskit.algorithms.minimum_eigensolvers.VQEResult in qiskit v0.44
...
<Class id="qiskit.algorithms.minimum_eigensolvers.VQEResult" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/algorithms/minimum_eigensolvers/vqe.py" signature="qiskit.algorithms.minimum_eigensolvers.VQEResult" modifiers="class">
