...
`qiskit.providers.fake_provider.FakeToronto`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.44/qiskit/providers/fake_provider/backends/toronto/fake_toronto.py "view source code")
