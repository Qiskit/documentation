...
<Class id="qiskit.algorithms.AmplitudeEstimator" github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/algorithms/amplitude_estimators/amplitude_estimator.py" signature="qiskit.algorithms.AmplitudeEstimator">
