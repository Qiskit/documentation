---
title: GatesInBasis (v0.44)
description: API reference for qiskit.transpiler.passes.GatesInBasis in qiskit v0.44
...
<Class id="qiskit.transpiler.passes.GatesInBasis" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/transpiler/passes/utils/gates_basis.py" signature="qiskit.transpiler.passes.GatesInBasis(*args, **kwargs)" modifiers="class">
