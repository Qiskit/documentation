...
<Class id="qiskit.opflow.evolutions.TrotterizationBase" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/opflow/evolutions/trotterizations/trotterization_base.py" signature="qiskit.opflow.evolutions.TrotterizationBase(reps=1)">
