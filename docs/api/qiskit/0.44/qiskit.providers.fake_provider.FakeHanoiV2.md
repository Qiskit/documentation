...
`qiskit.providers.fake_provider.FakeHanoiV2` [GitHub](https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/providers/fake_provider/backends/hanoi/fake_hanoi.py "view source code")
