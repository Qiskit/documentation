...
<Class id="qiskit.circuit.Gate" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/circuit/gate.py" signature="qiskit.circuit.Gate(name, num_qubits, params, label=None)">
