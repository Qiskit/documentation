...
<Class id="qiskit.algorithms.optimizers.L_BFGS_B" github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/algorithms/optimizers/l_bfgs_b.py" signature="qiskit.algorithms.optimizers.L_BFGS_B(maxfun=15000, maxiter=15000, ftol=2.220446049250313e-15, iprint=-1, eps=1e-08, options=None, max_evals_grouped=1, **kwargs)">
  ...
  *   **kwargs** – additional kwargs for `scipy.optimize.minimize`.
  ...
  <Function id="qiskit.algorithms.optimizers.L_BFGS_B.get_support_level" name="get_support_level" signature="get_support_level()">
    Return support level dictionary
  </Function>

  ### gradient\_num\_diff

  <Function id="qiskit.algorithms.optimizers.L_BFGS_B.gradient_num_diff" name="gradient_num_diff" signature="static gradient_num_diff(x_center, f, epsilon, max_evals_grouped=None)">
  ...
  <Function id="qiskit.algorithms.optimizers.L_BFGS_B.minimize" name="minimize" signature="minimize(fun, x0, jac=None, bounds=None)">
  ...
  <Function id="qiskit.algorithms.optimizers.L_BFGS_B.print_options" name="print_options" signature="print_options()">
    Print algorithm-specific options.
  </Function>

  ### set\_max\_evals\_grouped

  <Function id="qiskit.algorithms.optimizers.L_BFGS_B.set_max_evals_grouped" name="set_max_evals_grouped" signature="set_max_evals_grouped(limit)">
    Set max evals grouped
  </Function>

  ### set\_options

  <Function id="qiskit.algorithms.optimizers.L_BFGS_B.set_options" name="set_options" signature="set_options(**kwargs)">
  ...
  <Function id="qiskit.algorithms.optimizers.L_BFGS_B.wrap_function" name="wrap_function" signature="static wrap_function(function, args)">
