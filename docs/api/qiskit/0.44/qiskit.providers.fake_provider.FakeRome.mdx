...
`qiskit.providers.fake_provider.FakeRome` [GitHub](https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/providers/fake_provider/backends/rome/fake_rome.py "view source code")
