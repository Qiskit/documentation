...
`qiskit.synthesis.MatrixExponential` [GitHub](https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/synthesis/evolution/matrix_synthesis.py "view source code")
