---
title: Backend (v0.44)
description: API reference for qiskit.providers.Backend in qiskit v0.44
...
<Class id="qiskit.providers.Backend" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/providers/backend.py" signature="qiskit.providers.Backend" modifiers="class">
