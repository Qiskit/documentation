...
<Class id="qiskit.algorithms.optimizers.NELDER_MEAD" github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/algorithms/optimizers/nelder_mead.py" signature="qiskit.algorithms.optimizers.NELDER_MEAD(maxiter=None, maxfev=1000, disp=False, xatol=0.0001, tol=None, adaptive=False, options=None, **kwargs)">
  ...
  *   **kwargs** – additional kwargs for scipy.optimize.minimize.
  ...
  <Function id="qiskit.algorithms.optimizers.NELDER_MEAD.gradient_num_diff" name="gradient_num_diff" signature="static gradient_num_diff(x_center, f, epsilon, max_evals_grouped=None)">
  ...
  <Function id="qiskit.algorithms.optimizers.NELDER_MEAD.minimize" name="minimize" signature="minimize(fun, x0, jac=None, bounds=None)">
