...
`qiskit.providers.fake_provider.FakeBogota` [GitHub](https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/providers/fake_provider/backends/bogota/fake_bogota.py "view source code")
