...
<Class id="qiskit.circuit.Register" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/circuit/register.py" signature="qiskit.circuit.Register(size=None, name=None, bits=None)">
