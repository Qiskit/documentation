...
`qiskit.providers.fake_provider.FakeBelemV2`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.44/qiskit/providers/fake_provider/backends/belem/fake_belem.py "view source code")
