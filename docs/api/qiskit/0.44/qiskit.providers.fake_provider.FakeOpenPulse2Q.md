...
`qiskit.providers.fake_provider.FakeOpenPulse2Q` [GitHub](https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/providers/fake_provider/fake_openpulse_2q.py "view source code")
