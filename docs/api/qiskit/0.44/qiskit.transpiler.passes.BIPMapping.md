...
`qiskit.transpiler.passes.BIPMapping(*args, **kwargs)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.44/qiskit/transpiler/passes/routing/bip_mapping.py "view source code")
