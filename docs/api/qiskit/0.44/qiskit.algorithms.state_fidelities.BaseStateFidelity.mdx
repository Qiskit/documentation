...
`qiskit.algorithms.state_fidelities.BaseStateFidelity` [GitHub](https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/algorithms/state_fidelities/base_state_fidelity.py "view source code")
