---
title: BaseStateFidelity (v0.44)
description: API reference for qiskit.algorithms.state_fidelities.BaseStateFidelity in qiskit v0.44
...
<Class id="qiskit.algorithms.state_fidelities.BaseStateFidelity" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/algorithms/state_fidelities/base_state_fidelity.py" signature="qiskit.algorithms.state_fidelities.BaseStateFidelity" modifiers="class">
