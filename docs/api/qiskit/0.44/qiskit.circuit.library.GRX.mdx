---
title: GRX (v0.44)
description: API reference for qiskit.circuit.library.GRX in qiskit v0.44
...
<Class id="qiskit.circuit.library.GRX" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/circuit/library/generalized_gates/gr.py" signature="qiskit.circuit.library.GRX(num_qubits, theta)" modifiers="class">
...
$$
  ...
  **Expanded Circuit:**
  ...
  ![../\_images/qiskit-circuit-library-GRX-1.png](/docs/images/api/qiskit/0.44/qiskit-circuit-library-GRX-1.avif)
  ...
  *   **theta** ([*float*](https://docs.python.org/3/library/functions.html#float "(in Python v3.12)")) – rotation angle about x-axis
  ...
  <Attribute id="qiskit.circuit.library.GRX.instances" attributeValue="142" />
