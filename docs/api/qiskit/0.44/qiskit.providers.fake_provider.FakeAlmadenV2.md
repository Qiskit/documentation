...
`qiskit.providers.fake_provider.FakeAlmadenV2` [GitHub](https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/providers/fake_provider/backends/almaden/fake_almaden.py "view source code")
