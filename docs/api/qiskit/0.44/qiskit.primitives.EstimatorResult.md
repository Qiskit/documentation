...
`qiskit.primitives.EstimatorResult(values, metadata)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.44/qiskit/primitives/base/estimator_result.py "view source code")
