---
title: SolovayKitaevSynthesis (v0.44)
description: API reference for qiskit.transpiler.passes.SolovayKitaevSynthesis in qiskit v0.44
...
<Class id="qiskit.transpiler.passes.SolovayKitaevSynthesis" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/transpiler/passes/synthesis/solovay_kitaev_synthesis.py" signature="qiskit.transpiler.passes.SolovayKitaevSynthesis" modifiers="class">
