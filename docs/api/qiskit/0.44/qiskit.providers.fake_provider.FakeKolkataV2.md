...
`qiskit.providers.fake_provider.FakeKolkataV2` [GitHub](https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/providers/fake_provider/backends/kolkata/fake_kolkata.py "view source code")
