...
`qiskit.opflow.state_fns.DictStateFn(*args, **kwargs)` [GitHub](https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/opflow/state_fns/dict_state_fn.py "view source code")
