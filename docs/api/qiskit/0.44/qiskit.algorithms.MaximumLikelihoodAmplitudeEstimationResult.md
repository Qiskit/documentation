...
`qiskit.algorithms.MaximumLikelihoodAmplitudeEstimationResult`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.44/qiskit/algorithms/amplitude_estimators/mlae.py "view source code")
