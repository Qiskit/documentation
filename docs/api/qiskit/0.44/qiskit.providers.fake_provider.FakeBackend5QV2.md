...
`qiskit.providers.fake_provider.FakeBackend5QV2(bidirectional=True)` [GitHub](https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/providers/fake_provider/fake_backend_v2.py "view source code")
