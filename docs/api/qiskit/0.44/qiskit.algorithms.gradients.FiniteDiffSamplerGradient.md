...
`qiskit.algorithms.gradients.FiniteDiffSamplerGradient(sampler, epsilon, options=None, *, method='central')`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.44/qiskit/algorithms/gradients/finite_diff/finite_diff_sampler_gradient.py "view source code")
