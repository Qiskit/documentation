---
title: SabreSwap (v0.44)
description: API reference for qiskit.transpiler.passes.SabreSwap in qiskit v0.44
...
<Class id="qiskit.transpiler.passes.SabreSwap" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/transpiler/passes/routing/sabre_swap.py" signature="qiskit.transpiler.passes.SabreSwap(*args, **kwargs)" modifiers="class">
