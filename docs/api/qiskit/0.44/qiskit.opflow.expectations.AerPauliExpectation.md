...
`qiskit.opflow.expectations.AerPauliExpectation`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.44/qiskit/opflow/expectations/aer_pauli_expectation.py "view source code")
