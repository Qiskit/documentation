---
title: DriveChannel (v0.44)
description: API reference for qiskit.pulse.channels.DriveChannel in qiskit v0.44
...
<Class id="qiskit.pulse.channels.DriveChannel" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/pulse/channels.py" signature="qiskit.pulse.channels.DriveChannel(*args, **kwargs)" modifiers="class">
  Bases: `PulseChannel`
