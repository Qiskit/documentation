---
title: CircuitGradient (v0.44)
description: API reference for qiskit.opflow.gradients.CircuitGradient in qiskit v0.44
...
<Class id="qiskit.opflow.gradients.CircuitGradient" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/opflow/gradients/circuit_gradients/circuit_gradient.py" signature="qiskit.opflow.gradients.CircuitGradient" modifiers="class">
