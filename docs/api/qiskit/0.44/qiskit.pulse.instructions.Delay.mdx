...
<Class id="qiskit.pulse.instructions.Delay" github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/pulse/instructions/delay.py" signature="qiskit.pulse.instructions.Delay(duration, channel, name=None)">
