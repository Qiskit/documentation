...
<Class id="qiskit.providers.basicaer.BasicAerError" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/providers/basicaer/exceptions.py" signature="qiskit.providers.basicaer.BasicAerError(*message)">
