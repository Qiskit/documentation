---
title: RYYGate (v0.44)
description: API reference for qiskit.circuit.library.RYYGate in qiskit v0.44
...
<Class id="qiskit.circuit.library.RYYGate" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/circuit/library/standard_gates/ryy.py" signature="qiskit.circuit.library.RYYGate(theta, label=None)" modifiers="class">
