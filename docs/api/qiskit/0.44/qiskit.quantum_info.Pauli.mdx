---
title: Pauli (v0.44)
description: API reference for qiskit.quantum_info.Pauli in qiskit v0.44
...
<Class id="qiskit.quantum_info.Pauli" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/quantum_info/operators/symplectic/pauli.py" signature="qiskit.quantum_info.Pauli(data=None, x=None, *, z=None, label=None)" modifiers="class">
  Bases: `BasePauli`
