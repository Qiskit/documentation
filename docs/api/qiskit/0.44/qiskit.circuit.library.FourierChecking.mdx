---
title: FourierChecking (v0.44)
description: API reference for qiskit.circuit.library.FourierChecking in qiskit v0.44
...
<Class id="qiskit.circuit.library.FourierChecking" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/circuit/library/fourier_checking.py" signature="qiskit.circuit.library.FourierChecking(f, g)" modifiers="class">
  ...
  **Reference Circuit:**
  ...
  ![../\_images/qiskit-circuit-library-FourierChecking-1.png](/docs/images/api/qiskit/0.44/qiskit-circuit-library-FourierChecking-1.avif)
  ...
  <Attribute id="qiskit.circuit.library.FourierChecking.instances" attributeValue="129" />
