---
title: CommutativeInverseCancellation (v0.44)
description: API reference for qiskit.transpiler.passes.CommutativeInverseCancellation in qiskit v0.44
...
<Class id="qiskit.transpiler.passes.CommutativeInverseCancellation" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/transpiler/passes/optimization/commutative_inverse_cancellation.py" signature="qiskit.transpiler.passes.CommutativeInverseCancellation(*args, **kwargs)" modifiers="class">
