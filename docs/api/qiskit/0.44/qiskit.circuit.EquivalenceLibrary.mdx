---
title: EquivalenceLibrary (v0.44)
description: API reference for qiskit.circuit.EquivalenceLibrary in qiskit v0.44
...
<Class id="qiskit.circuit.EquivalenceLibrary" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/circuit/equivalence.py" signature="qiskit.circuit.EquivalenceLibrary(*, base=None)" modifiers="class">
