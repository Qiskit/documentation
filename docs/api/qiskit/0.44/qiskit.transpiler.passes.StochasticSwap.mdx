---
title: StochasticSwap (v0.44)
description: API reference for qiskit.transpiler.passes.StochasticSwap in qiskit v0.44
...
<Class id="qiskit.transpiler.passes.StochasticSwap" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/transpiler/passes/routing/stochastic_swap.py" signature="qiskit.transpiler.passes.StochasticSwap(*args, **kwargs)" modifiers="class">
