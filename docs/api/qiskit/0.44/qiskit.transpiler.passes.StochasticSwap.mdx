...
<Class id="qiskit.transpiler.passes.StochasticSwap" github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/transpiler/passes/routing/stochastic_swap.py" signature="qiskit.transpiler.passes.StochasticSwap(*args, **kwargs)">
