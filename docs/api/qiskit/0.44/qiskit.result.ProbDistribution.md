...
`qiskit.result.ProbDistribution(data, shots=None)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.44/qiskit/result/distributions/probability.py "view source code")
