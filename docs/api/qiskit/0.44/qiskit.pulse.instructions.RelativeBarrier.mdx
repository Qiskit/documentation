...
<Class id="qiskit.pulse.instructions.RelativeBarrier" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/pulse/instructions/directives.py" signature="qiskit.pulse.instructions.RelativeBarrier(*channels, name=None)">
  Bases: `Directive`
