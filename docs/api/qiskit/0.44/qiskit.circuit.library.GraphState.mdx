---
title: GraphState (v0.44)
description: API reference for qiskit.circuit.library.GraphState in qiskit v0.44
...
<Class id="qiskit.circuit.library.GraphState" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/circuit/library/graph_state.py" signature="qiskit.circuit.library.GraphState(adjacency_matrix)" modifiers="class">
...
$$
  ...
  **Reference Circuit:**
  ...
  ![../\_images/qiskit-circuit-library-GraphState-1.png](/docs/images/api/qiskit/0.44/qiskit-circuit-library-GraphState-1.avif)
  ...
  **Raises**
  ...
  <Attribute id="qiskit.circuit.library.GraphState.instances" attributeValue="157" />
