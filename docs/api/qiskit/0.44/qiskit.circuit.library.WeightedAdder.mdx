---
title: WeightedAdder (v0.44)
description: API reference for qiskit.circuit.library.WeightedAdder in qiskit v0.44
...
<Class id="qiskit.circuit.library.WeightedAdder" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/circuit/library/arithmetic/weighted_adder.py" signature="qiskit.circuit.library.WeightedAdder(num_state_qubits=None, weights=None, name='adder')" modifiers="class">
...
$$
  ...
  *   **name** ([*str*](https://docs.python.org/3/library/stdtypes.html#str "(in Python v3.12)")) – The name of the circuit.
  ...
  <Attribute id="qiskit.circuit.library.WeightedAdder.instances" attributeValue="127" />
