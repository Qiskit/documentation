...
<Class id="qiskit.algorithms.eigensolvers.VQD" github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/algorithms/eigensolvers/vqd.py" signature="qiskit.algorithms.eigensolvers.VQD(estimator, fidelity, ansatz, optimizer, *, k=2, betas=None, initial_point=None, callback=None)">
  ...
  <Attribute id="qiskit.algorithms.eigensolvers.VQD.estimator" name="estimator">
  ...
  <Attribute id="qiskit.algorithms.eigensolvers.VQD.fidelity" name="fidelity">
  ...
  <Attribute id="qiskit.algorithms.eigensolvers.VQD.ansatz" name="ansatz">
  ...
  <Attribute id="" name="one for every k-th eigenvalue. Can either be a Qiskit optimizer or a callable">
  ...
  <Attribute id="qiskit.algorithms.eigensolvers.VQD.betas" name="betas">
  ...
  <Attribute id="" name="initial point">
  ...
  *   **callback** (*Callable\[\[*[*int*](https://docs.python.org/3/library/functions.html#int "(in Python v3.12)")*, np.ndarray,* [*float*](https://docs.python.org/3/library/functions.html#float "(in Python v3.12)")*,* [*dict*](https://docs.python.org/3/library/stdtypes.html#dict "(in Python v3.12)")*\[*[*str*](https://docs.python.org/3/library/stdtypes.html#str "(in Python v3.12)")*, Any]], None] | None*) – A callback that can access the intermediate data during the optimization. Four parameter values are passed to the callback as follows during each evaluation by the optimizer: the evaluation count, the optimizer parameters for the ansatz, the estimated value, the estimation metadata, and the current step.
  ...
  <Attribute id="qiskit.algorithms.eigensolvers.VQD.initial_point" name="initial_point">
  ...
  <Function id="qiskit.algorithms.eigensolvers.VQD.compute_eigenvalues" name="compute_eigenvalues" signature="compute_eigenvalues(operator, aux_operators=None)">
  ...
  <Function id="qiskit.algorithms.eigensolvers.VQD.supports_aux_operators" name="supports_aux_operators" signature="classmethod supports_aux_operators()">
