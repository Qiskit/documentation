...
<Class id="qiskit.transpiler.passes.HoareOptimizer" github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/transpiler/passes/optimization/hoare_opt.py" signature="qiskit.transpiler.passes.HoareOptimizer(*args, **kwargs)">
