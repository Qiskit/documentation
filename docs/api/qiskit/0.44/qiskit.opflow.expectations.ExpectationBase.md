...
`qiskit.opflow.expectations.ExpectationBase`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.44/qiskit/opflow/expectations/expectation_base.py "view source code")
