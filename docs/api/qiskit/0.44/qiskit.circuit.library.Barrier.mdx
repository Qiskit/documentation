...
<Class id="qiskit.circuit.library.Barrier" github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/circuit/barrier.py" signature="qiskit.circuit.library.Barrier(num_qubits, label=None)">
