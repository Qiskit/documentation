...
<Class id="qiskit.algorithms.AmplitudeAmplifier" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/algorithms/amplitude_amplifiers/amplitude_amplifier.py" signature="qiskit.algorithms.AmplitudeAmplifier">
