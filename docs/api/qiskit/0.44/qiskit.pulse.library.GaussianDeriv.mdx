---
title: GaussianDeriv (v0.44)
description: API reference for qiskit.pulse.library.GaussianDeriv in qiskit v0.44
...
<Function id="qiskit.pulse.library.GaussianDeriv" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/pulse/library/symbolic_pulses.py" signature="qiskit.pulse.library.GaussianDeriv(duration, amp, sigma, angle=0.0, name=None, limit_amplitude=None)">
