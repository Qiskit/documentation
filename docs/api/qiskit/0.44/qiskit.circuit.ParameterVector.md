...
`qiskit.circuit.ParameterVector(name, length=0)` [GitHub](https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/circuit/parametervector.py "view source code")
