...
`qiskit.visualization.pulse.IQXStandard(**kwargs)` [GitHub](https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/visualization/pulse_v2/stylesheet.py "view source code")
