---
title: SetLayout (v0.44)
description: API reference for qiskit.transpiler.passes.SetLayout in qiskit v0.44
...
<Class id="qiskit.transpiler.passes.SetLayout" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/transpiler/passes/layout/set_layout.py" signature="qiskit.transpiler.passes.SetLayout(*args, **kwargs)" modifiers="class">
