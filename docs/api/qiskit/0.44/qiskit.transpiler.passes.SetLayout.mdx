...
<Class id="qiskit.transpiler.passes.SetLayout" github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/transpiler/passes/layout/set_layout.py" signature="qiskit.transpiler.passes.SetLayout(*args, **kwargs)">
