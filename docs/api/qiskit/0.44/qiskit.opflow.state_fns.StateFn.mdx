...
<Class id="qiskit.opflow.state_fns.StateFn" github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/opflow/state_fns/state_fn.py" signature="qiskit.opflow.state_fns.StateFn(primitive=None, coeff=1.0, is_measurement=False)">
