...
<Class id="qiskit.transpiler.passes.ConvertConditionsToIfOps" github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/transpiler/passes/utils/convert_conditions_to_if_ops.py" signature="qiskit.transpiler.passes.ConvertConditionsToIfOps(*args, **kwargs)">
