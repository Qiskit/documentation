...
<Class id="qiskit.extensions.UCRYGate" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/extensions/quantum_initializer/ucry.py" signature="qiskit.extensions.UCRYGate(angle_list)">
  ...
  *   **label** – An optional label for the gate.
  ...
  <Function id="qiskit.extensions.UCRYGate.add_decomposition" name="add_decomposition" signature="add_decomposition(decomposition)">
    Add a decomposition of the instruction to the SessionEquivalenceLibrary.
  </Function>

  ### assemble

  <Function id="qiskit.extensions.UCRYGate.assemble" name="assemble" signature="assemble()">
    Assemble a QasmQobjInstruction
  </Function>

  ### broadcast\_arguments

  <Function id="qiskit.extensions.UCRYGate.broadcast_arguments" name="broadcast_arguments" signature="broadcast_arguments(qargs, cargs)">
  ...
  <Function id="qiskit.extensions.UCRYGate.c_if" name="c_if" signature="c_if(classical, val)">
  ...
  <Function id="qiskit.extensions.UCRYGate.control" name="control" signature="control(num_ctrl_qubits=1, label=None, ctrl_state=None)">
  ...
  <Function id="qiskit.extensions.UCRYGate.copy" name="copy" signature="copy(name=None)">
  ...
  <Function id="qiskit.extensions.UCRYGate.inverse" name="inverse" signature="inverse()">
  ...
  <Function id="qiskit.extensions.UCRYGate.is_parameterized" name="is_parameterized" signature="is_parameterized()">
    Return True .IFF. instruction is parameterized else False
  </Function>

  ### power

  <Function id="qiskit.extensions.UCRYGate.power" name="power" signature="power(exponent)">
  ...
  <Function id="qiskit.extensions.UCRYGate.qasm" name="qasm" signature="qasm()">
  ...
  <Function id="qiskit.extensions.UCRYGate.repeat" name="repeat" signature="repeat(n)">
  ...
  <Function id="qiskit.extensions.UCRYGate.reverse_ops" name="reverse_ops" signature="reverse_ops()">
  ...
  <Function id="qiskit.extensions.UCRYGate.soft_compare" name="soft_compare" signature="soft_compare(other)">
  ...
  <Function id="qiskit.extensions.UCRYGate.to_matrix" name="to_matrix" signature="to_matrix()">
  ...
  <Function id="qiskit.extensions.UCRYGate.validate_parameter" name="validate_parameter" signature="validate_parameter(parameter)">
