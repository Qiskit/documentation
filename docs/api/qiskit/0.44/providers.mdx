...
<Class id="qiskit.providers.QiskitBackendNotFoundError" github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/providers/exceptions.py" signature="qiskit.providers.QiskitBackendNotFoundError(*message)">
...
<Class id="qiskit.providers.BackendPropertyError" github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/providers/exceptions.py" signature="qiskit.providers.BackendPropertyError(*message)">
...
<Class id="qiskit.providers.JobError" github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/providers/exceptions.py" signature="qiskit.providers.JobError(*message)">
...
<Class id="qiskit.providers.JobTimeoutError" github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/providers/exceptions.py" signature="qiskit.providers.JobTimeoutError(*message)">
...
<Class id="qiskit.providers.BackendConfigurationError" github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/providers/exceptions.py" signature="qiskit.providers.BackendConfigurationError(*message)">
