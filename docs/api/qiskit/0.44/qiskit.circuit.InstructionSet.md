...
`qiskit.circuit.InstructionSet(*, resource_requester=None)` [GitHub](https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/circuit/instructionset.py "view source code")
...
![../\_images/qiskit-circuit-InstructionSet-1.png](/images/api/qiskit/0.44/qiskit-circuit-InstructionSet-1.png)
