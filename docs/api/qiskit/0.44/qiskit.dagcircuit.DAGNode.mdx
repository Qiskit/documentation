---
title: DAGNode (v0.44)
description: API reference for qiskit.dagcircuit.DAGNode in qiskit v0.44
...
<Class id="qiskit.dagcircuit.DAGNode" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/dagcircuit/dagnode.py" signature="qiskit.dagcircuit.DAGNode(nid=-1)" modifiers="class">
