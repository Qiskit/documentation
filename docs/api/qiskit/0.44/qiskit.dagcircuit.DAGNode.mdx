...
<Class id="qiskit.dagcircuit.DAGNode" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/dagcircuit/dagnode.py" signature="qiskit.dagcircuit.DAGNode(nid=-1)">
  ...
  <Function id="qiskit.dagcircuit.DAGNode.semantic_eq" name="semantic_eq" signature="static semantic_eq(node1, node2, bit_indices1, bit_indices2)">
