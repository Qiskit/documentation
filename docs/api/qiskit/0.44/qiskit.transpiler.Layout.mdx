---
title: Layout (v0.44)
description: API reference for qiskit.transpiler.Layout in qiskit v0.44
...
<Class id="qiskit.transpiler.Layout" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/transpiler/layout.py" signature="qiskit.transpiler.Layout(input_dict=None)" modifiers="class">
