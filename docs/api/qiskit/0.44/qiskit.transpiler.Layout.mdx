...
<Class id="qiskit.transpiler.Layout" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/transpiler/layout.py" signature="qiskit.transpiler.Layout(input_dict=None)">
