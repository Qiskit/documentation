...
<Class id="qiskit.dagcircuit.DAGCircuitError" name="DAGCircuitError" github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/dagcircuit/exceptions.py" signature="qiskit.dagcircuit.DAGCircuitError(*msg)">
...
<Class id="qiskit.dagcircuit.DAGDependencyError" name="DAGDependencyError" github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/dagcircuit/exceptions.py" signature="qiskit.dagcircuit.DAGDependencyError(*msg)">
