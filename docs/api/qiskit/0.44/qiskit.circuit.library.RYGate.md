...
`qiskit.circuit.library.RYGate(theta, label=None)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/circuit/library/standard_gates/ry.py "view source code")
