...
`qiskit.opflow.list_ops.ComposedOp(oplist, coeff=1.0, abelian=False)` [GitHub](https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/opflow/list_ops/composed_op.py "view source code")
