...
<Class id="qiskit.algorithms.optimizers.TNC" github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/algorithms/optimizers/tnc.py" signature="qiskit.algorithms.optimizers.TNC(maxiter=100, disp=False, accuracy=0, ftol=-1, xtol=-1, gtol=-1, tol=None, eps=1e-08, options=None, max_evals_grouped=1, **kwargs)">
  ...
  *   **kwargs** – additional kwargs for scipy.optimize.minimize.
  ...
  <Function id="qiskit.algorithms.optimizers.TNC.gradient_num_diff" name="gradient_num_diff" signature="static gradient_num_diff(x_center, f, epsilon, max_evals_grouped=None)">
  ...
  <Function id="qiskit.algorithms.optimizers.TNC.minimize" name="minimize" signature="minimize(fun, x0, jac=None, bounds=None)">
