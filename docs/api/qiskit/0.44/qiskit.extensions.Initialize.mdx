...
<Class id="qiskit.extensions.Initialize" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/extensions/quantum_initializer/initializer.py" signature="qiskit.extensions.Initialize(params, num_qubits=None, normalize=False)">
  ...
  *   **normalize** ([*bool*](https://docs.python.org/3/library/functions.html#bool "(in Python v3.12)")) – Whether to normalize an input array to a unit vector.
  ...
  <Function id="qiskit.extensions.Initialize.add_decomposition" name="add_decomposition" signature="add_decomposition(decomposition)">
    Add a decomposition of the instruction to the SessionEquivalenceLibrary.
  </Function>

  ### assemble

  <Function id="qiskit.extensions.Initialize.assemble" name="assemble" signature="assemble()">
    Assemble a QasmQobjInstruction
  </Function>

  ### broadcast\_arguments

  <Function id="qiskit.extensions.Initialize.broadcast_arguments" name="broadcast_arguments" signature="broadcast_arguments(qargs, cargs)">
  ...
  <Function id="qiskit.extensions.Initialize.c_if" name="c_if" signature="c_if(classical, val)">
  ...
  <Function id="qiskit.extensions.Initialize.copy" name="copy" signature="copy(name=None)">
  ...
  <Function id="qiskit.extensions.Initialize.gates_to_uncompute" name="gates_to_uncompute" signature="gates_to_uncompute()">
  ...
  <Function id="qiskit.extensions.Initialize.inverse" name="inverse" signature="inverse()">
  ...
  <Function id="qiskit.extensions.Initialize.is_parameterized" name="is_parameterized" signature="is_parameterized()">
    Return True .IFF. instruction is parameterized else False
  </Function>

  ### qasm

  <Function id="qiskit.extensions.Initialize.qasm" name="qasm" signature="qasm()">
  ...
  <Function id="qiskit.extensions.Initialize.repeat" name="repeat" signature="repeat(n)">
  ...
  <Function id="qiskit.extensions.Initialize.reverse_ops" name="reverse_ops" signature="reverse_ops()">
  ...
  <Function id="qiskit.extensions.Initialize.soft_compare" name="soft_compare" signature="soft_compare(other)">
  ...
  <Function id="qiskit.extensions.Initialize.validate_parameter" name="validate_parameter" signature="validate_parameter(parameter)">
