...
description: API reference for qiskit.algorithms.VQDResult in qiskit v0.44
...
<Class id="qiskit.algorithms.VQDResult" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/algorithms/eigen_solvers/vqd.py" signature="qiskit.algorithms.VQDResult" modifiers="class">
