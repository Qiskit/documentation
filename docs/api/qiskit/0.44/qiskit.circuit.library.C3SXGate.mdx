...
<Class id="qiskit.circuit.library.C3SXGate" github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/circuit/library/standard_gates/x.py" signature="qiskit.circuit.library.C3SXGate(label=None, ctrl_state=None)">
