...
`qiskit.extensions.HamiltonianGate(data, time, label=None)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.44/qiskit/extensions/hamiltonian_gate.py "view source code")
