...
<Class id="qiskit.algorithms.GroverResult" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/algorithms/amplitude_amplifiers/grover.py" signature="qiskit.algorithms.GroverResult">
  ...
  <Attribute id="qiskit.algorithms.GroverResult.assignment" name="assignment">
  ...
  <Attribute id="qiskit.algorithms.GroverResult.circuit_results" name="circuit_results">
    Return the circuit results. Can be a statevector or counts dictionary.
  </Attribute>

  ### iterations

  <Attribute id="qiskit.algorithms.GroverResult.iterations" name="iterations">
  ...
  <Attribute id="qiskit.algorithms.GroverResult.max_probability" name="max_probability">
    Return the maximum sampling probability.
  </Attribute>

  ### oracle\_evaluation

  <Attribute id="qiskit.algorithms.GroverResult.oracle_evaluation" name="oracle_evaluation">
  ...
  <Attribute id="qiskit.algorithms.GroverResult.top_measurement" name="top_measurement">
