...
<Class id="qiskit.transpiler.CouplingMap" github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/transpiler/coupling.py" signature="qiskit.transpiler.CouplingMap(couplinglist=None, description=None)">
