...
`qiskit.opflow.expectations.PauliExpectation(group_paulis=True)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.44/qiskit/opflow/expectations/pauli_expectation.py "view source code")
