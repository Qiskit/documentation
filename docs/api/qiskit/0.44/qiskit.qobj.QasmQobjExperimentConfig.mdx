...
<Class id="qiskit.qobj.QasmQobjExperimentConfig" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/qobj/qasm_qobj.py" signature="qiskit.qobj.QasmQobjExperimentConfig(calibrations=None, qubit_lo_freq=None, meas_lo_freq=None, **kwargs)">
  Bases: `QobjDictField`
