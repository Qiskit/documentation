...
<Class id="qiskit.transpiler.passes.BarrierBeforeFinalMeasurements" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/transpiler/passes/utils/barrier_before_final_measurements.py" signature="qiskit.transpiler.passes.BarrierBeforeFinalMeasurements(*args, **kwargs)">
