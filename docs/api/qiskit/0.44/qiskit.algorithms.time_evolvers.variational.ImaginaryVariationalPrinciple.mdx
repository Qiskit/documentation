---
title: ImaginaryVariationalPrinciple (v0.44)
description: API reference for qiskit.algorithms.time_evolvers.variational.ImaginaryVariationalPrinciple in qiskit v0.44
