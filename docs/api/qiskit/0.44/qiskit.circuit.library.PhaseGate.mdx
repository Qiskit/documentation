---
title: PhaseGate (v0.44)
description: API reference for qiskit.circuit.library.PhaseGate in qiskit v0.44
...
<Class id="qiskit.circuit.library.PhaseGate" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/circuit/library/standard_gates/p.py" signature="qiskit.circuit.library.PhaseGate(theta, label=None)" modifiers="class">
