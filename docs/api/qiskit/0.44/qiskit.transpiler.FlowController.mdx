...
<Class id="qiskit.transpiler.FlowController" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/transpiler/runningpassmanager.py" signature="qiskit.transpiler.FlowController(passes, options, **partial_controller)">
  ...
  <Function id="qiskit.transpiler.FlowController.add_flow_controller" signature="classmethod add_flow_controller(name, controller)">
  ...
  <Function id="qiskit.transpiler.FlowController.controller_factory" signature="classmethod controller_factory(passes, options, **partial_controller)">
  ...
  <Function id="qiskit.transpiler.FlowController.remove_flow_controller" signature="classmethod remove_flow_controller(name)">
