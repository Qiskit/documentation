...
<Class id="qiskit.transpiler.FlowController" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/transpiler/runningpassmanager.py" signature="qiskit.transpiler.FlowController(passes, options, **partial_controller)">
