...
`qiskit.algorithms.AmplitudeAmplifier`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.44/qiskit/algorithms/amplitude_amplifiers/amplitude_amplifier.py "view source code")
