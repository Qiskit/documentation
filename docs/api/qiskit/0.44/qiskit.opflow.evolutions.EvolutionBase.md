...
`qiskit.opflow.evolutions.EvolutionBase`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.44/qiskit/opflow/evolutions/evolution_base.py "view source code")
