---
title: ResultError (v0.44)
description: API reference for qiskit.result.ResultError in qiskit v0.44
...
<Class id="qiskit.result.ResultError" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/result/exceptions.py" signature="qiskit.result.ResultError(error)" modifiers="exception">
