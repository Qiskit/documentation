...
<Class id="qiskit.providers.JobV1" github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/providers/job.py" signature="qiskit.providers.JobV1(backend, job_id, **kwargs)">
