...
`qiskit.algorithms.gradients.QGTResult(qgts, derivative_type, metadata, options)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.44/qiskit/algorithms/gradients/base/qgt_result.py "view source code")
