...
description: API reference for qiskit.quantum_info.Z2Symmetries in qiskit v0.44
...
<Class id="qiskit.quantum_info.Z2Symmetries" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/quantum_info/analysis/z2_symmetries.py" signature="qiskit.quantum_info.Z2Symmetries(symmetries, sq_paulis, sq_list, tapering_values=None, *, tol=1e-14)" modifiers="class">
