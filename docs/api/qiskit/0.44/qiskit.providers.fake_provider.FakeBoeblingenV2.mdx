...
<Class id="qiskit.providers.fake_provider.FakeBoeblingenV2" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/providers/fake_provider/backends/boeblingen/fake_boeblingen.py" signature="qiskit.providers.fake_provider.FakeBoeblingenV2">
  ...
  <Attribute id="qiskit.providers.fake_provider.FakeBoeblingenV2.dirname" name="dirname" attributeValue="= '/home/runner/work/qiskit/qiskit/.tox/docs/lib/python3.9/site-packages/qiskit/providers/fake_provider/backends/boeblingen'" />
