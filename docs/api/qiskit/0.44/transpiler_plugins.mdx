...
<Function id="qiskit.transpiler.preset_passmanagers.plugin.list_stage_plugins" name="list_stage_plugins" github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/transpiler/preset_passmanagers/plugin.py" signature="qiskit.transpiler.preset_passmanagers.plugin.list_stage_plugins(stage_name)">
