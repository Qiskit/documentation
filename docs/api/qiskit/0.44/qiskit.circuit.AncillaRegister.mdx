...
<Class id="qiskit.circuit.AncillaRegister" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/circuit/quantumregister.py" signature="qiskit.circuit.AncillaRegister(size=None, name=None, bits=None)">
  ...
  *   [**CircuitError**](circuit#qiskit.circuit.CircuitError "qiskit.circuit.CircuitError") – if `bits` contained bits of an incorrect type.
  ...
  <Function id="qiskit.circuit.AncillaRegister.qasm" name="qasm" signature="qasm()">
