---
title: Options (v0.44)
description: API reference for qiskit.providers.Options in qiskit v0.44
...
<Class id="qiskit.providers.Options" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/providers/options.py" signature="qiskit.providers.Options(**kwargs)" modifiers="class">
