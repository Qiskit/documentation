...
`qiskit.opflow.evolutions.TrotterizationBase(reps=1)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.44/qiskit/opflow/evolutions/trotterizations/trotterization_base.py "view source code")
