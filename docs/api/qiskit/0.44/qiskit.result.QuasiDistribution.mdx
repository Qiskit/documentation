---
title: QuasiDistribution (v0.44)
description: API reference for qiskit.result.QuasiDistribution in qiskit v0.44
...
<Class id="qiskit.result.QuasiDistribution" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/result/distributions/quasi.py" signature="qiskit.result.QuasiDistribution(data, shots=None, stddev_upper_bound=None)" modifiers="class">
