---
title: AnalysisPass (v0.44)
description: API reference for qiskit.transpiler.AnalysisPass in qiskit v0.44
...
<Class id="qiskit.transpiler.AnalysisPass" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/transpiler/basepasses.py" signature="qiskit.transpiler.AnalysisPass(*args, **kwargs)" modifiers="class">
  Bases: `BasePass`
