...
<Class id="qiskit.algorithms.AmplitudeEstimationResult" github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/algorithms/amplitude_estimators/ae.py" signature="qiskit.algorithms.AmplitudeEstimationResult">
