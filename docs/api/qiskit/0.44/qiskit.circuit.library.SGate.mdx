---
title: SGate (v0.44)
description: API reference for qiskit.circuit.library.SGate in qiskit v0.44
...
<Class id="qiskit.circuit.library.SGate" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/circuit/library/standard_gates/s.py" signature="qiskit.circuit.library.SGate(label=None)" modifiers="class">
