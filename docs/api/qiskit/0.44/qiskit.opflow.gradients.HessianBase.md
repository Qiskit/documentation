...
`qiskit.opflow.gradients.HessianBase(hess_method='param_shift', **kwargs)` [GitHub](https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/opflow/gradients/hessian_base.py "view source code")
