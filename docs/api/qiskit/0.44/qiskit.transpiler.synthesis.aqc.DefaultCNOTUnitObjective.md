...
`qiskit.transpiler.synthesis.aqc.DefaultCNOTUnitObjective(num_qubits, cnots)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.44/qiskit/transpiler/synthesis/aqc/cnot_unit_objective.py "view source code")
