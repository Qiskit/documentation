---
title: BackendEstimator (v0.44)
description: API reference for qiskit.primitives.BackendEstimator in qiskit v0.44
...
<Class id="qiskit.primitives.BackendEstimator" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/primitives/backend_estimator.py" signature="qiskit.primitives.BackendEstimator(backend, options=None, abelian_grouping=True, bound_pass_manager=None, skip_transpilation=False)" modifiers="class">
