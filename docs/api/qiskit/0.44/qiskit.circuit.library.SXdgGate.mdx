---
title: SXdgGate (v0.44)
description: API reference for qiskit.circuit.library.SXdgGate in qiskit v0.44
...
<Class id="qiskit.circuit.library.SXdgGate" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/circuit/library/standard_gates/sx.py" signature="qiskit.circuit.library.SXdgGate(label=None)" modifiers="class">
