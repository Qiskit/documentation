...
`qiskit.opflow.gradients.DerivativeBase` [GitHub](https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/opflow/gradients/derivative_base.py "view source code")
