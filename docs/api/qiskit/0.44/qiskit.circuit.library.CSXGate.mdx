---
title: CSXGate (v0.44)
description: API reference for qiskit.circuit.library.CSXGate in qiskit v0.44
...
<Class id="qiskit.circuit.library.CSXGate" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/circuit/library/standard_gates/sx.py" signature="qiskit.circuit.library.CSXGate(label=None, ctrl_state=None)" modifiers="class">
