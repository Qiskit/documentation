...
`qiskit.providers.fake_provider.FakeSydney`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.44/qiskit/providers/fake_provider/backends/sydney/fake_sydney.py "view source code")
