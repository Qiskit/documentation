...
<Class id="qiskit.pulse.instructions.Acquire" github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/pulse/instructions/acquire.py" signature="qiskit.pulse.instructions.Acquire(duration, channel, mem_slot=None, reg_slot=None, kernel=None, discriminator=None, name=None)">
