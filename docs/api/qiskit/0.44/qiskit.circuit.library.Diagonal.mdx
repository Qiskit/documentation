---
title: Diagonal (v0.44)
description: API reference for qiskit.circuit.library.Diagonal in qiskit v0.44
...
<Class id="qiskit.circuit.library.Diagonal" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/circuit/library/generalized_gates/diagonal.py" signature="qiskit.circuit.library.Diagonal(diag)" modifiers="class">
...
$$
  ...
  **Raises**
  ...
  <Attribute id="qiskit.circuit.library.Diagonal.instances" attributeValue="168" />
