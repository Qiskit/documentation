...
<Class id="qiskit.circuit.Qubit" github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/circuit/quantumregister.py" signature="qiskit.circuit.Qubit(register=None, index=None)">
