---
title: Qubit (v0.44)
description: API reference for qiskit.circuit.Qubit in qiskit v0.44
...
<Class id="qiskit.circuit.Qubit" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/circuit/quantumregister.py" signature="qiskit.circuit.Qubit(register=None, index=None)" modifiers="class">
