...
`qiskit.algorithms.optimizers.optimizer_utils.LearningRate(learning_rate)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.44/qiskit/algorithms/optimizers/optimizer_utils/learning_rate.py "view source code")
