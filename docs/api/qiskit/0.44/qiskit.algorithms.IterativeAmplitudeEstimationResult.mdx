---
title: IterativeAmplitudeEstimationResult (v0.44)
description: API reference for qiskit.algorithms.IterativeAmplitudeEstimationResult in qiskit v0.44
...
<Class id="qiskit.algorithms.IterativeAmplitudeEstimationResult" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/algorithms/amplitude_estimators/iae.py" signature="qiskit.algorithms.IterativeAmplitudeEstimationResult" modifiers="class">
