...
`qiskit.transpiler.passes.UnitarySynthesis(*args, **kwargs)` [GitHub](https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/transpiler/passes/synthesis/unitary_synthesis.py "view source code")
