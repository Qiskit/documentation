...
<Class id="qiskit.providers.fake_provider.FakePoughkeepsieV2" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/providers/fake_provider/backends/poughkeepsie/fake_poughkeepsie.py" signature="qiskit.providers.fake_provider.FakePoughkeepsieV2">
  Bases: `FakeBackendV2`
  ...
  <Attribute id="qiskit.providers.fake_provider.FakePoughkeepsieV2.backend_name" name="backend_name" attributeValue="= 'fake_poughkeepsie'" />
  ...
  <Attribute id="qiskit.providers.fake_provider.FakePoughkeepsieV2.dirname" name="dirname" attributeValue="= '/home/runner/work/qiskit/qiskit/.tox/docs/lib/python3.9/site-packages/qiskit/providers/fake_provider/backends/poughkeepsie'" />
  ...
  <Function id="qiskit.providers.fake_provider.FakePoughkeepsieV2.acquire_channel" name="acquire_channel" signature="acquire_channel(qubit)">
  ...
  <Function id="qiskit.providers.fake_provider.FakePoughkeepsieV2.control_channel" name="control_channel" signature="control_channel(qubits)">
  ...
  <Function id="qiskit.providers.fake_provider.FakePoughkeepsieV2.drive_channel" name="drive_channel" signature="drive_channel(qubit)">
  ...
  <Function id="qiskit.providers.fake_provider.FakePoughkeepsieV2.measure_channel" name="measure_channel" signature="measure_channel(qubit)">
  ...
  <Function id="qiskit.providers.fake_provider.FakePoughkeepsieV2.qubit_properties" name="qubit_properties" signature="qubit_properties(qubit)">
  ...
  <Function id="qiskit.providers.fake_provider.FakePoughkeepsieV2.run" name="run" signature="run(run_input, **options)">
  ...
  <Function id="qiskit.providers.fake_provider.FakePoughkeepsieV2.set_options" name="set_options" signature="set_options(**fields)">
