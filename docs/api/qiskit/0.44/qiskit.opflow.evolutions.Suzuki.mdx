---
title: Suzuki (v0.44)
description: API reference for qiskit.opflow.evolutions.Suzuki in qiskit v0.44
...
<Class id="qiskit.opflow.evolutions.Suzuki" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/opflow/evolutions/trotterizations/suzuki.py" signature="qiskit.opflow.evolutions.Suzuki(reps=1, order=2)" modifiers="class">
