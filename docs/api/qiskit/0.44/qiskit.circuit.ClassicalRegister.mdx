---
title: ClassicalRegister (v0.44)
description: API reference for qiskit.circuit.ClassicalRegister in qiskit v0.44
...
<Class id="qiskit.circuit.ClassicalRegister" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/circuit/classicalregister.py" signature="qiskit.circuit.ClassicalRegister(size=None, name=None, bits=None)" modifiers="class">
