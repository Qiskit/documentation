...
<Class id="qiskit.transpiler.passes.CSPLayout" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/transpiler/passes/layout/csp_layout.py" signature="qiskit.transpiler.passes.CSPLayout(*args, **kwargs)">
