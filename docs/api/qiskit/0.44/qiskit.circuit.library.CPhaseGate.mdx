...
<Class id="qiskit.circuit.library.CPhaseGate" github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/circuit/library/standard_gates/p.py" signature="qiskit.circuit.library.CPhaseGate(theta, label=None, ctrl_state=None)">
