...
<Class id="qiskit.opflow.primitive_ops.TaperedPauliSumOp" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/opflow/primitive_ops/tapered_pauli_sum_op.py" signature="qiskit.opflow.primitive_ops.TaperedPauliSumOp(*args, **kwargs)">
