...
<Class id="qiskit.transpiler.passes.CXDirection" github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/transpiler/passes/utils/cx_direction.py" signature="qiskit.transpiler.passes.CXDirection(*args, **kwargs)">
