---
title: CXDirection (v0.44)
description: API reference for qiskit.transpiler.passes.CXDirection in qiskit v0.44
...
<Class id="qiskit.transpiler.passes.CXDirection" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/transpiler/passes/utils/cx_direction.py" signature="qiskit.transpiler.passes.CXDirection(*args, **kwargs)" modifiers="class">
