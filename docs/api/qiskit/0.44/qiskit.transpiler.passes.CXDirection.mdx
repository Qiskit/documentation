...
<Class id="qiskit.transpiler.passes.CXDirection" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/transpiler/passes/utils/cx_direction.py" signature="qiskit.transpiler.passes.CXDirection(*args, **kwargs)">
  ...
  <Attribute id="qiskit.transpiler.passes.CXDirection.is_analysis_pass" name="is_analysis_pass">
  ...
  <Attribute id="qiskit.transpiler.passes.CXDirection.is_transformation_pass" name="is_transformation_pass">
