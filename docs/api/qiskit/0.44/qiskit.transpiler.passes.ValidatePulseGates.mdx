...
<Class id="qiskit.transpiler.passes.ValidatePulseGates" github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/transpiler/passes/scheduling/alignments/pulse_gate_validation.py" signature="qiskit.transpiler.passes.ValidatePulseGates(*args, **kwargs)">
