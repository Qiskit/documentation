...
<Class id="qiskit.opflow.gradients.HessianBase" github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/opflow/gradients/hessian_base.py" signature="qiskit.opflow.gradients.HessianBase(hess_method='param_shift', **kwargs)">
