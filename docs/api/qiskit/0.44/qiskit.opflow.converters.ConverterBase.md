...
`qiskit.opflow.converters.ConverterBase`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.44/qiskit/opflow/converters/converter_base.py "view source code")
