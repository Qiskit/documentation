...
`qiskit.circuit.library.SXGate(label=None)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.44/qiskit/circuit/library/standard_gates/sx.py "view source code")
