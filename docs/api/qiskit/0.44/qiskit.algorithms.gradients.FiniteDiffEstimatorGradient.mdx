---
title: FiniteDiffEstimatorGradient (v0.44)
description: API reference for qiskit.algorithms.gradients.FiniteDiffEstimatorGradient in qiskit v0.44
...
<Class id="qiskit.algorithms.gradients.FiniteDiffEstimatorGradient" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/algorithms/gradients/finite_diff/finite_diff_estimator_gradient.py" signature="qiskit.algorithms.gradients.FiniteDiffEstimatorGradient(estimator, epsilon, options=None, *, method='central')" modifiers="class">
  ...
  *   [**TypeError**](https://docs.python.org/3/library/exceptions.html#TypeError "(in Python v3.12)") – If `method` is invalid.
  ...
  <Function id="qiskit.algorithms.gradients.FiniteDiffEstimatorGradient.run" signature="run(circuits, observables, parameter_values, parameters=None, **options)">
  ...
  <Function id="qiskit.algorithms.gradients.FiniteDiffEstimatorGradient.update_default_options" signature="update_default_options(**options)">
