...
<Class id="qiskit.algorithms.gradients.ReverseQGT" github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/algorithms/gradients/reverse/reverse_qgt.py" signature="qiskit.algorithms.gradients.ReverseQGT(phase_fix=True, derivative_type=DerivativeType.COMPLEX)">
