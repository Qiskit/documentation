---
title: CRS (v0.44)
description: API reference for qiskit.algorithms.optimizers.CRS in qiskit v0.44
...
<Class id="qiskit.algorithms.optimizers.CRS" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/algorithms/optimizers/nlopts/crs.py" signature="qiskit.algorithms.optimizers.CRS(max_evals=1000)" modifiers="class">
  ...
  **Raises**
  ...
  <Function id="qiskit.algorithms.optimizers.CRS.gradient_num_diff" signature="gradient_num_diff(x_center, f, epsilon, max_evals_grouped=None)" modifiers="static">
  ...
  <Function id="qiskit.algorithms.optimizers.CRS.minimize" signature="minimize(fun, x0, jac=None, bounds=None)">
