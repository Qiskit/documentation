...
`qiskit.circuit.library.RXGate(theta, label=None)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.44/qiskit/circuit/library/standard_gates/rx.py "view source code")
