...
<Class id="qiskit.visualization.qcstyle.DefaultStyle" github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/visualization/circuit/qcstyle.py" signature="qiskit.visualization.qcstyle.DefaultStyle">
