...
<Class id="qiskit.transpiler.passes.SolovayKitaev" github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/transpiler/passes/synthesis/solovay_kitaev_synthesis.py" signature="qiskit.transpiler.passes.SolovayKitaev(*args, **kwargs)">
