...
<Class id="qiskit.quantum_info.StabilizerState" github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/quantum_info/states/stabilizerstate.py" signature="qiskit.quantum_info.StabilizerState(data, validate=True)">
  Bases: `QuantumState`
