---
title: PropertySet (v0.44)
description: API reference for qiskit.transpiler.PropertySet in qiskit v0.44
...
<Class id="qiskit.transpiler.PropertySet" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/transpiler/propertyset.py" signature="qiskit.transpiler.PropertySet" modifiers="class">
  ...
  <Function id="qiskit.transpiler.PropertySet.popitem" signature="popitem()">
