---
title: SabreLayout (v0.44)
description: API reference for qiskit.transpiler.passes.SabreLayout in qiskit v0.44
...
<Class id="qiskit.transpiler.passes.SabreLayout" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/transpiler/passes/layout/sabre_layout.py" signature="qiskit.transpiler.passes.SabreLayout(*args, **kwargs)" modifiers="class">
