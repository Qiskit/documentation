---
title: CRXGate (v0.44)
description: API reference for qiskit.circuit.library.CRXGate in qiskit v0.44
...
<Class id="qiskit.circuit.library.CRXGate" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/circuit/library/standard_gates/rx.py" signature="qiskit.circuit.library.CRXGate(theta, label=None, ctrl_state=None)" modifiers="class">
