...
<Class id="qiskit.transpiler.synthesis.aqc.CNOTUnitObjective" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/transpiler/synthesis/aqc/cnot_unit_objective.py" signature="qiskit.transpiler.synthesis.aqc.CNOTUnitObjective(num_qubits, cnots)">
