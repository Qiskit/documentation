---
title: DAGInNode (v0.44)
description: API reference for qiskit.dagcircuit.DAGInNode in qiskit v0.44
...
<Class id="qiskit.dagcircuit.DAGInNode" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/dagcircuit/dagnode.py" signature="qiskit.dagcircuit.DAGInNode(wire)" modifiers="class">
