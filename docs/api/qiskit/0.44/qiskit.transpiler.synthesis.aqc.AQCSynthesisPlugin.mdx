---
title: AQCSynthesisPlugin (v0.44)
description: API reference for qiskit.transpiler.synthesis.aqc.AQCSynthesisPlugin in qiskit v0.44
...
<Class id="qiskit.transpiler.synthesis.aqc.AQCSynthesisPlugin" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/transpiler/synthesis/aqc/aqc_plugin.py" signature="qiskit.transpiler.synthesis.aqc.AQCSynthesisPlugin" modifiers="class">
