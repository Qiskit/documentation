---
title: ControlFlowOp (v0.44)
description: API reference for qiskit.circuit.ControlFlowOp in qiskit v0.44
...
<Class id="qiskit.circuit.ControlFlowOp" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/circuit/controlflow/control_flow.py" signature="qiskit.circuit.ControlFlowOp(name, num_qubits, num_clbits, params, duration=None, unit='dt', label=None)" modifiers="class">
