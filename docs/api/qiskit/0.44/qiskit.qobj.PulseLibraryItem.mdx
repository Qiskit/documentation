...
<Class id="qiskit.qobj.PulseLibraryItem" github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/qobj/pulse_qobj.py" signature="qiskit.qobj.PulseLibraryItem(name, samples)">
