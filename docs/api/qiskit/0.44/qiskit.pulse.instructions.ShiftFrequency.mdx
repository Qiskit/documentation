---
title: ShiftFrequency (v0.44)
description: API reference for qiskit.pulse.instructions.ShiftFrequency in qiskit v0.44
...
<Class id="qiskit.pulse.instructions.ShiftFrequency" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/pulse/instructions/frequency.py" signature="qiskit.pulse.instructions.ShiftFrequency(frequency, channel, name=None)" modifiers="class">
