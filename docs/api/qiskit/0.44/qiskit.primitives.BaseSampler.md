...
`qiskit.primitives.BaseSampler(*, options=None)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.44/qiskit/primitives/base/base_sampler.py "view source code")
