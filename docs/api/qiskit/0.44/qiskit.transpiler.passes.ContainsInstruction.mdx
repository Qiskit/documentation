---
title: ContainsInstruction (v0.44)
description: API reference for qiskit.transpiler.passes.ContainsInstruction in qiskit v0.44
...
<Class id="qiskit.transpiler.passes.ContainsInstruction" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/transpiler/passes/utils/contains_instruction.py" signature="qiskit.transpiler.passes.ContainsInstruction(*args, **kwargs)" modifiers="class">
  ...
  *   **recurse** ([*bool*](https://docs.python.org/3/library/functions.html#bool "(in Python v3.12)")) – if `True` (default), then recurse into control-flow operations.
  ...
  <Function id="qiskit.transpiler.passes.ContainsInstruction.name" signature="name()">
    Return the name of the pass.
  </Function>

  ### run

  <Function id="qiskit.transpiler.passes.ContainsInstruction.run" signature="run(dag)">
