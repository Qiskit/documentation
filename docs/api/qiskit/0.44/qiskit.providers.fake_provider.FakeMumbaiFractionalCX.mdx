...
<Class id="qiskit.providers.fake_provider.FakeMumbaiFractionalCX" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/providers/fake_provider/fake_mumbai_v2.py" signature="qiskit.providers.fake_provider.FakeMumbaiFractionalCX">
