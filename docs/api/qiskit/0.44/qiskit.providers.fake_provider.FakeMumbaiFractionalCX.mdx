---
title: FakeMumbaiFractionalCX (v0.44)
description: API reference for qiskit.providers.fake_provider.FakeMumbaiFractionalCX in qiskit v0.44
...
<Class id="qiskit.providers.fake_provider.FakeMumbaiFractionalCX" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/providers/fake_provider/fake_mumbai_v2.py" signature="qiskit.providers.fake_provider.FakeMumbaiFractionalCX" modifiers="class">
