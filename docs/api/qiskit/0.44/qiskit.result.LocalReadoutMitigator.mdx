...
<Class id="qiskit.result.LocalReadoutMitigator" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/result/mitigation/local_readout_mitigator.py" signature="qiskit.result.LocalReadoutMitigator(assignment_matrices=None, qubits=None, backend=None)">
  ...
  **Raises**
  ...
  <Function id="qiskit.result.LocalReadoutMitigator.assignment_matrix" name="assignment_matrix" signature="assignment_matrix(qubits=None)">
  ...
  <Function id="qiskit.result.LocalReadoutMitigator.expectation_value" name="expectation_value" signature="expectation_value(data, diagonal=None, qubits=None, clbits=None, shots=None)">
  ...
  <Function id="qiskit.result.LocalReadoutMitigator.mitigation_matrix" name="mitigation_matrix" signature="mitigation_matrix(qubits=None)">
  ...
  <Function id="qiskit.result.LocalReadoutMitigator.quasi_probabilities" name="quasi_probabilities" signature="quasi_probabilities(data, qubits=None, clbits=None, shots=None)">
  ...
  <Function id="qiskit.result.LocalReadoutMitigator.stddev_upper_bound" name="stddev_upper_bound" signature="stddev_upper_bound(shots, qubits=None)">
