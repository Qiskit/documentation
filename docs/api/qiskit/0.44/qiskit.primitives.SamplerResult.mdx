...
<Class id="qiskit.primitives.SamplerResult" github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/primitives/base/sampler_result.py" signature="qiskit.primitives.SamplerResult(quasi_dists, metadata)">
