---
title: SamplerResult (v0.44)
description: API reference for qiskit.primitives.SamplerResult in qiskit v0.44
...
<Class id="qiskit.primitives.SamplerResult" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/primitives/base/sampler_result.py" signature="qiskit.primitives.SamplerResult(quasi_dists, metadata)" modifiers="class">
