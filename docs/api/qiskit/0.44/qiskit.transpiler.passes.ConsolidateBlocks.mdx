---
title: ConsolidateBlocks (v0.44)
description: API reference for qiskit.transpiler.passes.ConsolidateBlocks in qiskit v0.44
...
<Class id="qiskit.transpiler.passes.ConsolidateBlocks" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/transpiler/passes/optimization/consolidate_blocks.py" signature="qiskit.transpiler.passes.ConsolidateBlocks(*args, **kwargs)" modifiers="class">
