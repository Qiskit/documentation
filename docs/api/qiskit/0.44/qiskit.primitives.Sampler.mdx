...
<Class id="qiskit.primitives.Sampler" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/primitives/sampler.py" signature="qiskit.primitives.Sampler(*, options=None)">
  ...
  **Raises**
  ...
  <Function id="qiskit.primitives.Sampler.run" name="run" signature="run(circuits, parameter_values=None, **run_options)">
  ...
  <Function id="qiskit.primitives.Sampler.set_options" name="set_options" signature="set_options(**fields)">
