---
title: EnlargeWithAncilla (v0.44)
description: API reference for qiskit.transpiler.passes.EnlargeWithAncilla in qiskit v0.44
...
<Class id="qiskit.transpiler.passes.EnlargeWithAncilla" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/transpiler/passes/layout/enlarge_with_ancilla.py" signature="qiskit.transpiler.passes.EnlargeWithAncilla(*args, **kwargs)" modifiers="class">
