---
title: Bit (v0.44)
description: API reference for qiskit.circuit.Bit in qiskit v0.44
...
<Class id="qiskit.circuit.Bit" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/circuit/bit.py" signature="qiskit.circuit.Bit(register=None, index=None)" modifiers="class">
