...
<Class id="qiskit.circuit.Bit" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/circuit/bit.py" signature="qiskit.circuit.Bit(register=None, index=None)">
  ...
  <Attribute id="qiskit.circuit.Bit.index" name="index">
  ...
  <Attribute id="qiskit.circuit.Bit.register" name="register">
