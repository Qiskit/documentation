...
<Class id="qiskit.quantum_info.Operator" github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/quantum_info/operators/operator.py" signature="qiskit.quantum_info.Operator(data, input_dims=None, output_dims=None)">
  Bases: `LinearOp`
