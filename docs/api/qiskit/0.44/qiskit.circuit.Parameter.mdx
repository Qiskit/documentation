...
<Class id="qiskit.circuit.Parameter" github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/circuit/parameter.py" signature="qiskit.circuit.Parameter(name, uuid=None)">
