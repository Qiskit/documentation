---
title: BIPMapping (v0.44)
description: API reference for qiskit.transpiler.passes.BIPMapping in qiskit v0.44
...
<Class id="qiskit.transpiler.passes.BIPMapping" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/transpiler/passes/routing/bip_mapping.py" signature="qiskit.transpiler.passes.BIPMapping(*args, **kwargs)" modifiers="class">
  ...
  *   [**TranspilerError**](transpiler#qiskit.transpiler.TranspilerError "qiskit.transpiler.TranspilerError") – if invalid options are specified.
  ...
  <Function id="qiskit.transpiler.passes.BIPMapping.name" signature="name()">
    Return the name of the pass.
  </Function>

  ### run

  <Function id="qiskit.transpiler.passes.BIPMapping.run" signature="run(dag)">
