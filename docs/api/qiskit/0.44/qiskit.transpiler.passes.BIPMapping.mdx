...
<Class id="qiskit.transpiler.passes.BIPMapping" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/transpiler/passes/routing/bip_mapping.py" signature="qiskit.transpiler.passes.BIPMapping(*args, **kwargs)">
  ...
  *   [**TranspilerError**](transpiler#qiskit.transpiler.TranspilerError "qiskit.transpiler.TranspilerError") – if invalid options are specified.
  ...
  <Attribute id="qiskit.transpiler.passes.BIPMapping.is_analysis_pass" name="is_analysis_pass">
  ...
  <Attribute id="qiskit.transpiler.passes.BIPMapping.is_transformation_pass" name="is_transformation_pass">
  ...
  <Function id="qiskit.transpiler.passes.BIPMapping.name" name="name" signature="name()">
    Return the name of the pass.
  </Function>

  ### run

  <Function id="qiskit.transpiler.passes.BIPMapping.run" name="run" signature="run(dag)">
