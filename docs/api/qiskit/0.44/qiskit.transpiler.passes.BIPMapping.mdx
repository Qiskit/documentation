...
<Class id="qiskit.transpiler.passes.BIPMapping" github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/transpiler/passes/routing/bip_mapping.py" signature="qiskit.transpiler.passes.BIPMapping(*args, **kwargs)">
