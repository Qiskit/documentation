...
<Class id="qiskit.algorithms.optimizers.Minimizer" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/algorithms/optimizers/optimizer.py" signature="qiskit.algorithms.optimizers.Minimizer(*args, **kwargs)">
