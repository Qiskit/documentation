...
`qiskit.providers.fake_provider.FakeLondon` [GitHub](https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/providers/fake_provider/backends/london/fake_london.py "view source code")
