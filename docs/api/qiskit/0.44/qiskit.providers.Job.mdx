---
title: Job (v0.44)
description: API reference for qiskit.providers.Job in qiskit v0.44
...
<Class id="qiskit.providers.Job" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/providers/job.py" signature="qiskit.providers.Job" modifiers="class">
