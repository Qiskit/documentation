...
<Class id="qiskit.algorithms.time_evolvers.trotterization.TrotterQRTE" github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/algorithms/time_evolvers/trotterization/trotter_qrte.py" signature="qiskit.algorithms.time_evolvers.trotterization.TrotterQRTE(product_formula=None, estimator=None, num_timesteps=1)">
  ...
  *   **estimator** ([*BaseEstimator*](qiskit.primitives.BaseEstimator "qiskit.primitives.BaseEstimator") *| None*) – An estimator primitive used for calculating expectation values of `TimeEvolutionProblem.aux_operators`.
  ...
  <Attribute id="qiskit.algorithms.time_evolvers.trotterization.TrotterQRTE.estimator" name="estimator">
    Returns an estimator.
  </Attribute>

  ### num\_timesteps

  <Attribute id="qiskit.algorithms.time_evolvers.trotterization.TrotterQRTE.num_timesteps" name="num_timesteps">
    Returns the number of timesteps.
  </Attribute>

  ### product\_formula

  <Attribute id="qiskit.algorithms.time_evolvers.trotterization.TrotterQRTE.product_formula" name="product_formula">
  ...
  <Function id="qiskit.algorithms.time_evolvers.trotterization.TrotterQRTE.evolve" name="evolve" signature="evolve(evolution_problem)">
  ...
  <Function id="qiskit.algorithms.time_evolvers.trotterization.TrotterQRTE.supports_aux_operators" name="supports_aux_operators" signature="classmethod supports_aux_operators()">
