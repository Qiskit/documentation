---
title: Provider (v0.44)
description: API reference for qiskit.providers.Provider in qiskit v0.44
...
<Class id="qiskit.providers.Provider" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/providers/provider.py" signature="qiskit.providers.Provider" modifiers="class">
