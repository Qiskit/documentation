...
`qiskit.quantum_info.Statevector(data, dims=None)` [GitHub](https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/quantum_info/states/statevector.py "view source code")
...
![../\_images/qiskit-quantum\_info-Statevector-1.png](/images/api/qiskit/0.44/qiskit-quantum_info-Statevector-1.png)
