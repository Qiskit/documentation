...
`qiskit.quantum_info.Statevector(data, dims=None)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.44/qiskit/quantum_info/states/statevector.py "view source code")
