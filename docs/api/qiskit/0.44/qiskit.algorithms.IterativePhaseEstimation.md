...
`qiskit.algorithms.IterativePhaseEstimation(num_iterations, quantum_instance=None, sampler=None)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.44/qiskit/algorithms/phase_estimators/ipe.py "view source code")
