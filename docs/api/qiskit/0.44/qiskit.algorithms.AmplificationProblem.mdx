---
title: AmplificationProblem (v0.44)
description: API reference for qiskit.algorithms.AmplificationProblem in qiskit v0.44
...
<Class id="qiskit.algorithms.AmplificationProblem" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/algorithms/amplitude_amplifiers/amplification_problem.py" signature="qiskit.algorithms.AmplificationProblem(oracle, state_preparation=None, grover_operator=None, post_processing=None, objective_qubits=None, is_good_state=None)" modifiers="class">
