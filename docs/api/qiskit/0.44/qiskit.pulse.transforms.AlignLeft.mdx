...
<Class id="qiskit.pulse.transforms.AlignLeft" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/pulse/transforms/alignments.py" signature="qiskit.pulse.transforms.AlignLeft">
  ...
  <Function id="qiskit.pulse.transforms.AlignLeft.align" name="align" signature="align(schedule)">
  ...
  <Function id="qiskit.pulse.transforms.AlignLeft.to_dict" name="to_dict" signature="to_dict()">
