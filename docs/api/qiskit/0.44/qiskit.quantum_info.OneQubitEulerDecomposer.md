...
`qiskit.quantum_info.OneQubitEulerDecomposer(basis='U3', use_dag=False)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.44/qiskit/quantum_info/synthesis/one_qubit_decompose.py "view source code")
