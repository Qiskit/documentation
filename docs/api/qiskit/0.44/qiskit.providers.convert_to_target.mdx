---
title: convert_to_target (v0.44)
description: API reference for qiskit.providers.convert_to_target in qiskit v0.44
...
<Function id="qiskit.providers.convert_to_target" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/providers/backend_compat.py" signature="qiskit.providers.convert_to_target(configuration, properties=None, defaults=None, custom_name_mapping=None, add_delay=False, filter_faulty=False)">
