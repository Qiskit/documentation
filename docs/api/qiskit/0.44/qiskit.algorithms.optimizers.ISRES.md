...
`qiskit.algorithms.optimizers.ISRES(max_evals=1000)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.44/qiskit/algorithms/optimizers/nlopts/isres.py "view source code")
