---
title: RZXGate (v0.44)
description: API reference for qiskit.circuit.library.RZXGate in qiskit v0.44
...
<Class id="qiskit.circuit.library.RZXGate" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/circuit/library/standard_gates/rzx.py" signature="qiskit.circuit.library.RZXGate(theta, label=None)" modifiers="class">
