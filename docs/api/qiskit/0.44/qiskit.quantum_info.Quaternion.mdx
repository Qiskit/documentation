---
title: Quaternion (v0.44)
description: API reference for qiskit.quantum_info.Quaternion in qiskit v0.44
...
<Class id="qiskit.quantum_info.Quaternion" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/quantum_info/synthesis/quaternion.py" signature="qiskit.quantum_info.Quaternion(data)" modifiers="class">
