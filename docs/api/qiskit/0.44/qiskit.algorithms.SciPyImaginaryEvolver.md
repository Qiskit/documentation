...
`qiskit.algorithms.SciPyImaginaryEvolver(num_timesteps)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.44/qiskit/algorithms/time_evolvers/classical_methods/scipy_imaginary_evolver.py "view source code")
