---
title: RZGate (v0.44)
description: API reference for qiskit.circuit.library.RZGate in qiskit v0.44
...
<Class id="qiskit.circuit.library.RZGate" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/circuit/library/standard_gates/rz.py" signature="qiskit.circuit.library.RZGate(phi, label=None)" modifiers="class">
