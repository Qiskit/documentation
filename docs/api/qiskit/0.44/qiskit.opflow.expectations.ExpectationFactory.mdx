---
title: ExpectationFactory (v0.44)
description: API reference for qiskit.opflow.expectations.ExpectationFactory in qiskit v0.44
...
<Class id="qiskit.opflow.expectations.ExpectationFactory" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/opflow/expectations/expectation_factory.py" signature="qiskit.opflow.expectations.ExpectationFactory" modifiers="class">
