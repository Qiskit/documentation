---
title: SparsePauliOp (v0.44)
description: API reference for qiskit.quantum_info.SparsePauliOp in qiskit v0.44
...
<Class id="qiskit.quantum_info.SparsePauliOp" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/quantum_info/operators/symplectic/sparse_pauli_op.py" signature="qiskit.quantum_info.SparsePauliOp(data, coeffs=None, *, ignore_pauli_phase=False, copy=True)" modifiers="class">
  Bases: `LinearOp`
  ...
  **Raises**
  ...
  <Function id="qiskit.quantum_info.SparsePauliOp.from_list" signature="from_list(obj, dtype=<class 'complex'>)" modifiers="static">
