...
`qiskit.transpiler.passes.CheckGateDirection(*args, **kwargs)` [GitHub](https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/transpiler/passes/utils/check_gate_direction.py "view source code")
