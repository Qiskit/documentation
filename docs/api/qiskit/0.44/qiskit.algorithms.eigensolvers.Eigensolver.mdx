...
<Class id="qiskit.algorithms.eigensolvers.Eigensolver" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/algorithms/eigensolvers/eigensolver.py" signature="qiskit.algorithms.eigensolvers.Eigensolver">
  ...
  <Function id="qiskit.algorithms.eigensolvers.Eigensolver.compute_eigenvalues" name="compute_eigenvalues" signature="abstract compute_eigenvalues(operator, aux_operators=None)">
  ...
  <Function id="qiskit.algorithms.eigensolvers.Eigensolver.supports_aux_operators" name="supports_aux_operators" signature="classmethod supports_aux_operators()">
