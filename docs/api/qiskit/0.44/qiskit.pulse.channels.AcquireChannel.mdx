---
title: AcquireChannel (v0.44)
description: API reference for qiskit.pulse.channels.AcquireChannel in qiskit v0.44
...
<Class id="qiskit.pulse.channels.AcquireChannel" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/pulse/channels.py" signature="qiskit.pulse.channels.AcquireChannel(*args, **kwargs)" modifiers="class">
