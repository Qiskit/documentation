---
title: MSGate (v0.44)
description: API reference for qiskit.circuit.library.MSGate in qiskit v0.44
...
<Class id="qiskit.circuit.library.MSGate" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/circuit/library/generalized_gates/gms.py" signature="qiskit.circuit.library.MSGate(num_qubits, theta, label=None)" modifiers="class">
