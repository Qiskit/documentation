...
<Class id="qiskit.transpiler.PassManager" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/transpiler/passmanager.py" signature="qiskit.transpiler.PassManager(passes=None, max_iteration=1000)">
  ...
  *   **max\_iteration** ([*int*](https://docs.python.org/3/library/functions.html#int "(in Python v3.12)")) – The maximum number of iterations the schedule will be looped if the condition is not met.
  ...
  <Function id="qiskit.transpiler.PassManager.append" name="append" signature="append(passes, max_iteration=None, **flow_controller_conditions)">
  ...
  <Function id="qiskit.transpiler.PassManager.draw" name="draw" signature="draw(filename=None, style=None, raw=False)">
  ...
  <Function id="qiskit.transpiler.PassManager.passes" name="passes" signature="passes()">
  ...
  <Function id="qiskit.transpiler.PassManager.remove" name="remove" signature="remove(index)">
  ...
  <Function id="qiskit.transpiler.PassManager.replace" name="replace" signature="replace(index, passes, max_iteration=None, **flow_controller_conditions)">
  ...
  <Function id="qiskit.transpiler.PassManager.run" name="run" signature="run(circuits, output_name=None, callback=None)">
  ...
  <Function id="qiskit.transpiler.PassManager.to_flow_controller" name="to_flow_controller" signature="to_flow_controller()">
