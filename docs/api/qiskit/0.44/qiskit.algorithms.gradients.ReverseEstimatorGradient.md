...
`qiskit.algorithms.gradients.ReverseEstimatorGradient(derivative_type=DerivativeType.REAL)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.44/qiskit/algorithms/gradients/reverse/reverse_gradient.py "view source code")
