---
title: plot_circuit_layout (v0.44)
description: API reference for qiskit.visualization.plot_circuit_layout in qiskit v0.44
...
<Function id="qiskit.visualization.plot_circuit_layout" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/visualization/gate_map.py" signature="qiskit.visualization.plot_circuit_layout(circuit, backend, view='virtual', qubit_coordinates=None)">
  ...
  **Example**
  ...
  ![../\_images/qiskit-visualization-plot\_circuit\_layout-1.png](/docs/images/api/qiskit/0.44/qiskit-visualization-plot_circuit_layout-1.avif)
</Function>
