...
<Class id="qiskit.transpiler.passes.LinearFunctionsSynthesis" github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/transpiler/passes/synthesis/linear_functions_synthesis.py" signature="qiskit.transpiler.passes.LinearFunctionsSynthesis(*args, **kwargs)">
