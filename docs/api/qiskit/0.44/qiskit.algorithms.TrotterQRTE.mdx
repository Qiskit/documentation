...
description: API reference for qiskit.algorithms.TrotterQRTE in qiskit v0.44
...
<Class id="qiskit.algorithms.TrotterQRTE" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/algorithms/evolvers/trotterization/trotter_qrte.py" signature="qiskit.algorithms.TrotterQRTE(product_formula=None, expectation=None, quantum_instance=None)" modifiers="class">
