...
`qiskit.algorithms.ImaginaryTimeEvolver`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.44/qiskit/algorithms/time_evolvers/imaginary_time_evolver.py "view source code")
