---
title: PauliGate (v0.44)
description: API reference for qiskit.circuit.library.PauliGate in qiskit v0.44
...
<Class id="qiskit.circuit.library.PauliGate" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/circuit/library/generalized_gates/pauli.py" signature="qiskit.circuit.library.PauliGate(label)" modifiers="class">
