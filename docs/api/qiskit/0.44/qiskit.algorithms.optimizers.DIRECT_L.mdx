---
title: DIRECT_L (v0.44)
description: API reference for qiskit.algorithms.optimizers.DIRECT_L in qiskit v0.44
...
<Class id="qiskit.algorithms.optimizers.DIRECT_L" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/algorithms/optimizers/nlopts/direct_l.py" signature="qiskit.algorithms.optimizers.DIRECT_L(max_evals=1000)" modifiers="class">
  ...
  **Raises**
  ...
  <Function id="qiskit.algorithms.optimizers.DIRECT_L.gradient_num_diff" signature="gradient_num_diff(x_center, f, epsilon, max_evals_grouped=None)" modifiers="static">
  ...
  <Function id="qiskit.algorithms.optimizers.DIRECT_L.minimize" signature="minimize(fun, x0, jac=None, bounds=None)">
