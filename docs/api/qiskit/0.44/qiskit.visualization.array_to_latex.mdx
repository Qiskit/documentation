---
title: array_to_latex (v0.44)
description: API reference for qiskit.visualization.array_to_latex in qiskit v0.44
...
<Function id="qiskit.visualization.array_to_latex" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/visualization/array.py" signature="qiskit.visualization.array_to_latex(array, precision=10, prefix='', source=False, max_size=8)">
