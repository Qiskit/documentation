---
title: Hessian (v0.44)
description: API reference for qiskit.opflow.gradients.Hessian in qiskit v0.44
...
<Class id="qiskit.opflow.gradients.Hessian" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/opflow/gradients/hessian.py" signature="qiskit.opflow.gradients.Hessian(hess_method='param_shift', **kwargs)" modifiers="class">
