---
title: CommutationAnalysis (v0.44)
description: API reference for qiskit.transpiler.passes.CommutationAnalysis in qiskit v0.44
...
<Class id="qiskit.transpiler.passes.CommutationAnalysis" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/transpiler/passes/optimization/commutation_analysis.py" signature="qiskit.transpiler.passes.CommutationAnalysis(*args, **kwargs)" modifiers="class">
