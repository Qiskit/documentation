...
<Class id="qiskit.transpiler.passes.CommutationAnalysis" github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/transpiler/passes/optimization/commutation_analysis.py" signature="qiskit.transpiler.passes.CommutationAnalysis(*args, **kwargs)">
