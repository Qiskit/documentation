...
<Class id="qiskit.transpiler.InstructionProperties" github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/transpiler/target.py" signature="qiskit.transpiler.InstructionProperties(duration=None, error=None, calibration=None)">
