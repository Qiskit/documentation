...
<Class id="qiskit.result.Counts" github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/result/counts.py" signature="qiskit.result.Counts(data, time_taken=None, creg_sizes=None, memory_slots=None)">
