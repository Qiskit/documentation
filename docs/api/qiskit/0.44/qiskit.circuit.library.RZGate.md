...
`qiskit.circuit.library.RZGate(phi, label=None)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.44/qiskit/circuit/library/standard_gates/rz.py "view source code")
