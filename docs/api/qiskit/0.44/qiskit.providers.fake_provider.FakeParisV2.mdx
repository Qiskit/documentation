...
`qiskit.providers.fake_provider.FakeParisV2` [GitHub](https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/providers/fake_provider/backends/paris/fake_paris.py "view source code")
