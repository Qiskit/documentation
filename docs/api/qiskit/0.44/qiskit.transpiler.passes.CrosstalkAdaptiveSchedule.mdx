...
<Class id="qiskit.transpiler.passes.CrosstalkAdaptiveSchedule" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/transpiler/passes/optimization/crosstalk_adaptive_schedule.py" signature="qiskit.transpiler.passes.CrosstalkAdaptiveSchedule(*args, **kwargs)">
