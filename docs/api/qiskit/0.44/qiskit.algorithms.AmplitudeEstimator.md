...
`qiskit.algorithms.AmplitudeEstimator`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.44/qiskit/algorithms/amplitude_estimators/amplitude_estimator.py "view source code")
