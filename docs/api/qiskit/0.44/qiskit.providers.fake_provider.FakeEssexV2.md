...
`qiskit.providers.fake_provider.FakeEssexV2` [GitHub](https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/providers/fake_provider/backends/essex/fake_essex.py "view source code")
