...
`qiskit.quantum_info.DensityMatrix(data, dims=None)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.44/qiskit/quantum_info/states/densitymatrix.py "view source code")
