---
title: FakeProvider (v0.44)
description: API reference for qiskit.providers.fake_provider.FakeProvider in qiskit v0.44
...
<Class id="qiskit.providers.fake_provider.FakeProvider" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/providers/fake_provider/fake_provider.py" signature="qiskit.providers.fake_provider.FakeProvider" modifiers="class">
