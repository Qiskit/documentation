...
<Class id="qiskit.providers.fake_provider.FakeProvider" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/providers/fake_provider/fake_provider.py" signature="qiskit.providers.fake_provider.FakeProvider">
  ...
  <Attribute id="qiskit.providers.fake_provider.FakeProvider.version" name="version" attributeValue="= 1" />

  ## Methods

  ### backends

  <Function id="qiskit.providers.fake_provider.FakeProvider.backends" name="backends" signature="backends(name=None, **kwargs)">
  ...
  <Function id="qiskit.providers.fake_provider.FakeProvider.get_backend" name="get_backend" signature="get_backend(name=None, **kwargs)">
