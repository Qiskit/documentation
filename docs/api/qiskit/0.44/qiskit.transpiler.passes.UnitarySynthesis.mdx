...
<Class id="qiskit.transpiler.passes.UnitarySynthesis" github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/transpiler/passes/synthesis/unitary_synthesis.py" signature="qiskit.transpiler.passes.UnitarySynthesis(*args, **kwargs)">
