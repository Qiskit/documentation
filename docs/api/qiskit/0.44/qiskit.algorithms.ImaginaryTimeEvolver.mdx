---
title: ImaginaryTimeEvolver (v0.44)
description: API reference for qiskit.algorithms.ImaginaryTimeEvolver in qiskit v0.44
...
<Class id="qiskit.algorithms.ImaginaryTimeEvolver" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/algorithms/time_evolvers/imaginary_time_evolver.py" signature="qiskit.algorithms.ImaginaryTimeEvolver" modifiers="class">
