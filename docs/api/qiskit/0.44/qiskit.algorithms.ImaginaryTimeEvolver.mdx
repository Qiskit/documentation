...
<Class id="qiskit.algorithms.ImaginaryTimeEvolver" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/algorithms/time_evolvers/imaginary_time_evolver.py" signature="qiskit.algorithms.ImaginaryTimeEvolver">
