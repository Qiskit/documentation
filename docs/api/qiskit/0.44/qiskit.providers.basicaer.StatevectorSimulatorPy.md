...
`qiskit.providers.basicaer.StatevectorSimulatorPy(configuration=None, provider=None, **fields)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.44/qiskit/providers/basicaer/statevector_simulator.py "view source code")
