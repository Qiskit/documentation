...
<Class id="qiskit.providers.fake_provider.FakeSherbrooke" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/providers/fake_provider/backends/sherbrooke/fake_sherbrooke.py" signature="qiskit.providers.fake_provider.FakeSherbrooke">
  Bases: `FakeBackendV2`
  ...
  <Attribute id="qiskit.providers.fake_provider.FakeSherbrooke.dirname" name="dirname" attributeValue="'/home/runner/work/qiskit/qiskit/.tox/docs/lib/python3.9/site-packages/qiskit/providers/fake_provider/backends/sherbrooke'" />
