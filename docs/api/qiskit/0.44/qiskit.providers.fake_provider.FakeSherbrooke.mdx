...
description: API reference for qiskit.providers.fake_provider.FakeSherbrooke in qiskit v0.44
...
<Class id="qiskit.providers.fake_provider.FakeSherbrooke" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/providers/fake_provider/backends/sherbrooke/fake_sherbrooke.py" signature="qiskit.providers.fake_provider.FakeSherbrooke" modifiers="class">
  Bases: `FakeBackendV2`
  ...
  <Attribute id="qiskit.providers.fake_provider.FakeSherbrooke.dirname" attributeValue="'/home/runner/work/qiskit/qiskit/.tox/docs/lib/python3.9/site-packages/qiskit/providers/fake_provider/backends/sherbrooke'" />
