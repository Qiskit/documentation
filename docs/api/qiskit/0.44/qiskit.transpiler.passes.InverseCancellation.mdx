...
<Class id="qiskit.transpiler.passes.InverseCancellation" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/transpiler/passes/optimization/inverse_cancellation.py" signature="qiskit.transpiler.passes.InverseCancellation(*args, **kwargs)">
