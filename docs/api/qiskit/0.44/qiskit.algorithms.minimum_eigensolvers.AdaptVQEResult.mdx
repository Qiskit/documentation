...
`qiskit.algorithms.minimum_eigensolvers.AdaptVQEResult` [GitHub](https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/algorithms/minimum_eigensolvers/adapt_vqe.py "view source code")
