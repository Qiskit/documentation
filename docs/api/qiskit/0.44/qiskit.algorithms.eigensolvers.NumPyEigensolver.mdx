...
<Class id="qiskit.algorithms.eigensolvers.NumPyEigensolver" github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/algorithms/eigensolvers/numpy_eigensolver.py" signature="qiskit.algorithms.eigensolvers.NumPyEigensolver(k=1, filter_criterion=None)">
