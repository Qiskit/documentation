---
title: TwoQubitBasisDecomposer (v0.44)
description: API reference for qiskit.quantum_info.TwoQubitBasisDecomposer in qiskit v0.44
...
<Class id="qiskit.quantum_info.TwoQubitBasisDecomposer" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/quantum_info/synthesis/two_qubit_decompose.py" signature="qiskit.quantum_info.TwoQubitBasisDecomposer(gate, basis_fidelity=1.0, euler_basis='U', pulse_optimize=None)" modifiers="class">
