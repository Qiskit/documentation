---
title: U3Gate (v0.44)
description: API reference for qiskit.circuit.library.U3Gate in qiskit v0.44
...
<Class id="qiskit.circuit.library.U3Gate" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/circuit/library/standard_gates/u3.py" signature="qiskit.circuit.library.U3Gate(theta, phi, lam, label=None)" modifiers="class">
