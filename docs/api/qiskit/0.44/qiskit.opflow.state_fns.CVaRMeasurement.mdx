---
title: CVaRMeasurement (v0.44)
description: API reference for qiskit.opflow.state_fns.CVaRMeasurement in qiskit v0.44
...
<Class id="qiskit.opflow.state_fns.CVaRMeasurement" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/opflow/state_fns/cvar_measurement.py" signature="qiskit.opflow.state_fns.CVaRMeasurement(*args, **kwargs)" modifiers="class">
