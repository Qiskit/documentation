---
title: RemoveDiagonalGatesBeforeMeasure (v0.44)
description: API reference for qiskit.transpiler.passes.RemoveDiagonalGatesBeforeMeasure in qiskit v0.44
