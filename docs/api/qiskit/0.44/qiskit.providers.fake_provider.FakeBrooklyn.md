...
`qiskit.providers.fake_provider.FakeBrooklyn` [GitHub](https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/providers/fake_provider/backends/brooklyn/fake_brooklyn.py "view source code")
