---
title: CorrelatedReadoutMitigator (v0.44)
description: API reference for qiskit.result.CorrelatedReadoutMitigator in qiskit v0.44
...
<Class id="qiskit.result.CorrelatedReadoutMitigator" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/result/mitigation/correlated_readout_mitigator.py" signature="qiskit.result.CorrelatedReadoutMitigator(assignment_matrix, qubits=None)" modifiers="class">
