...
<Class id="qiskit.result.CorrelatedReadoutMitigator" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/result/mitigation/correlated_readout_mitigator.py" signature="qiskit.result.CorrelatedReadoutMitigator(assignment_matrix, qubits=None)">
  ...
  **Raises**
  ...
  <Function id="qiskit.result.CorrelatedReadoutMitigator.assignment_matrix" name="assignment_matrix" signature="assignment_matrix(qubits=None)">
  ...
  <Function id="qiskit.result.CorrelatedReadoutMitigator.expectation_value" name="expectation_value" signature="expectation_value(data, diagonal=None, qubits=None, clbits=None, shots=None)">
  ...
  <Function id="qiskit.result.CorrelatedReadoutMitigator.mitigation_matrix" name="mitigation_matrix" signature="mitigation_matrix(qubits=None)">
  ...
  <Function id="qiskit.result.CorrelatedReadoutMitigator.quasi_probabilities" name="quasi_probabilities" signature="quasi_probabilities(data, qubits=None, clbits=None, shots=None)">
  ...
  <Function id="qiskit.result.CorrelatedReadoutMitigator.stddev_upper_bound" name="stddev_upper_bound" signature="stddev_upper_bound(shots)">
