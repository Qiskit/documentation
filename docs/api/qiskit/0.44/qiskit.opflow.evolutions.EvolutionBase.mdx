...
<Class id="qiskit.opflow.evolutions.EvolutionBase" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/opflow/evolutions/evolution_base.py" signature="qiskit.opflow.evolutions.EvolutionBase">
