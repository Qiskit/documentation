...
`qiskit.algorithms.PhaseEstimationScale(bound)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.44/qiskit/algorithms/phase_estimators/phase_estimation_scale.py "view source code")
