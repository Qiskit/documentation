...
`qiskit.providers.fake_provider.FakeBurlingtonV2` [GitHub](https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/providers/fake_provider/backends/burlington/fake_burlington.py "view source code")
