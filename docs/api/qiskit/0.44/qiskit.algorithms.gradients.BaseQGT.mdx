...
<Class id="qiskit.algorithms.gradients.BaseQGT" github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/algorithms/gradients/base/base_qgt.py" signature="qiskit.algorithms.gradients.BaseQGT(estimator, phase_fix=True, derivative_type=DerivativeType.COMPLEX, options=None)">
