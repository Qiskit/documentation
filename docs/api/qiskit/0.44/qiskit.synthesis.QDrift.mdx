...
<Class id="qiskit.synthesis.QDrift" github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/synthesis/evolution/qdrift.py" signature="qiskit.synthesis.QDrift(reps=1, insert_barriers=False, cx_structure='chain', atomic_evolution=None)">
