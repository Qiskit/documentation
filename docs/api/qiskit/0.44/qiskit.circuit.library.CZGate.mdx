---
title: CZGate (v0.44)
description: API reference for qiskit.circuit.library.CZGate in qiskit v0.44
...
<Class id="qiskit.circuit.library.CZGate" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/circuit/library/standard_gates/z.py" signature="qiskit.circuit.library.CZGate(label=None, ctrl_state=None)" modifiers="class">
