---
title: ForLoopOp (v0.44)
description: API reference for qiskit.circuit.ForLoopOp in qiskit v0.44
...
<Class id="qiskit.circuit.ForLoopOp" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/circuit/controlflow/for_loop.py" signature="qiskit.circuit.ForLoopOp(indexset, loop_parameter, body, label=None)" modifiers="class">
  ...
  *   [**TypeError**](https://docs.python.org/3/library/exceptions.html#TypeError "(in Python v3.12)") – when the optional label is provided, but it is not a string.
  ...
  <Function id="qiskit.circuit.ForLoopOp.add_decomposition" signature="add_decomposition(decomposition)">
    Add a decomposition of the instruction to the SessionEquivalenceLibrary.
  </Function>

  ### assemble

  <Function id="qiskit.circuit.ForLoopOp.assemble" signature="assemble()">
    Assemble a QasmQobjInstruction
  </Function>

  ### broadcast\_arguments

  <Function id="qiskit.circuit.ForLoopOp.broadcast_arguments" signature="broadcast_arguments(qargs, cargs)">
  ...
  <Function id="qiskit.circuit.ForLoopOp.c_if" signature="c_if(classical, val)">
  ...
  <Function id="qiskit.circuit.ForLoopOp.copy" signature="copy(name=None)">
  ...
  <Function id="qiskit.circuit.ForLoopOp.inverse" signature="inverse()">
  ...
  <Function id="qiskit.circuit.ForLoopOp.is_parameterized" signature="is_parameterized()">
    Return True .IFF. instruction is parameterized else False
  </Function>

  ### qasm

  <Function id="qiskit.circuit.ForLoopOp.qasm" signature="qasm()">
  ...
  <Function id="qiskit.circuit.ForLoopOp.repeat" signature="repeat(n)">
  ...
  <Function id="qiskit.circuit.ForLoopOp.replace_blocks" signature="replace_blocks(blocks)">
  ...
  <Function id="qiskit.circuit.ForLoopOp.reverse_ops" signature="reverse_ops()">
  ...
  <Function id="qiskit.circuit.ForLoopOp.soft_compare" signature="soft_compare(other)">
  ...
  <Function id="qiskit.circuit.ForLoopOp.validate_parameter" signature="validate_parameter(parameter)">
