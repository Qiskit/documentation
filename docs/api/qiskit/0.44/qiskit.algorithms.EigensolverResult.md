...
`qiskit.algorithms.EigensolverResult` [GitHub](https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/algorithms/eigen_solvers/eigen_solver.py "view source code")
