...
`qiskit.circuit.library.FourierChecking(f, g)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.44/qiskit/circuit/library/fourier_checking.py "view source code")
...
![../\_images/qiskit-circuit-library-FourierChecking-1.png](/images/api/qiskit/0.44/qiskit-circuit-library-FourierChecking-1.png)
