...
<Class id="qiskit.opflow.primitive_ops.Z2Symmetries" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/opflow/primitive_ops/tapered_pauli_sum_op.py" signature="qiskit.opflow.primitive_ops.Z2Symmetries(symmetries, sq_paulis, sq_list, tapering_values=None, tol=1e-14)">
  ...
  **Raises**
  ...
  <Function id="qiskit.opflow.primitive_ops.Z2Symmetries.convert_clifford" name="convert_clifford" signature="convert_clifford(operator)">
  ...
  <Function id="qiskit.opflow.primitive_ops.Z2Symmetries.taper_clifford" name="taper_clifford" signature="taper_clifford(operator)">
