...
`qiskit.assembler.assemble_circuits(circuits, run_config, qobj_id, qobj_header)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.44/qiskit/assembler/assemble_circuits.py "view source code")
...
`qiskit.assembler.assemble_schedules(schedules, qobj_id, qobj_header, run_config)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.44/qiskit/assembler/assemble_schedules.py "view source code")
...
`qiskit.assembler.disassemble(qobj)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.44/qiskit/assembler/disassemble.py "view source code")
