---
title: ProviderV1 (v0.44)
description: API reference for qiskit.providers.ProviderV1 in qiskit v0.44
...
<Class id="qiskit.providers.ProviderV1" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/providers/provider.py" signature="qiskit.providers.ProviderV1" modifiers="class">
