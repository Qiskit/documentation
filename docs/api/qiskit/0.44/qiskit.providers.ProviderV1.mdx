...
<Class id="qiskit.providers.ProviderV1" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/providers/provider.py" signature="qiskit.providers.ProviderV1">
  ...
  <Function id="qiskit.providers.ProviderV1.backends" name="backends" signature="abstract backends(name=None, **kwargs)">
  ...
  <Function id="qiskit.providers.ProviderV1.get_backend" name="get_backend" signature="get_backend(name=None, **kwargs)">
