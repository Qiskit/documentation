...
<Class id="qiskit.circuit.Clbit" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/circuit/classicalregister.py" signature="qiskit.circuit.Clbit(register=None, index=None)">
