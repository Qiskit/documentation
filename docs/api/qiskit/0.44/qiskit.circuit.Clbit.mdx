---
title: Clbit (v0.44)
description: API reference for qiskit.circuit.Clbit in qiskit v0.44
...
<Class id="qiskit.circuit.Clbit" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/circuit/classicalregister.py" signature="qiskit.circuit.Clbit(register=None, index=None)" modifiers="class">
