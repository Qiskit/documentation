...
`qiskit.primitives.BaseEstimator(*, options=None)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.44/qiskit/primitives/base/base_estimator.py "view source code")
