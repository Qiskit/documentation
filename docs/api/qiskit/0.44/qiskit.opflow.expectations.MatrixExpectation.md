...
`qiskit.opflow.expectations.MatrixExpectation`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.44/qiskit/opflow/expectations/matrix_expectation.py "view source code")
