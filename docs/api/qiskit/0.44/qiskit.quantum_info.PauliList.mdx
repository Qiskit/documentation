...
<Class id="qiskit.quantum_info.PauliList" github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/quantum_info/operators/symplectic/pauli_list.py" signature="qiskit.quantum_info.PauliList(data)">
