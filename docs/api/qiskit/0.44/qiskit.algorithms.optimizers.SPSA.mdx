...
<Class id="qiskit.algorithms.optimizers.SPSA" github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/algorithms/optimizers/spsa.py" signature="qiskit.algorithms.optimizers.SPSA(maxiter=100, blocking=False, allowed_increase=None, trust_region=False, learning_rate=None, perturbation=None, last_avg=1, resamplings=1, perturbation_dims=None, second_order=False, regularization=None, hessian_delay=0, lse_solver=None, initial_hessian=None, callback=None, termination_checker=None)">
