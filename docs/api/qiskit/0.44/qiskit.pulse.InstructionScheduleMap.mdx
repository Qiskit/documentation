...
<Class id="qiskit.pulse.InstructionScheduleMap" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/pulse/instruction_schedule_map.py" signature="qiskit.pulse.InstructionScheduleMap">
  ...
  <Function id="qiskit.pulse.InstructionScheduleMap.add" name="add" signature="add(instruction, qubits, schedule, arguments=None)">
  ...
  <Function id="qiskit.pulse.InstructionScheduleMap.assert_has" name="assert_has" signature="assert_has(instruction, qubits)">
  ...
  <Function id="qiskit.pulse.InstructionScheduleMap.get" name="get" signature="get(instruction, qubits, *params, **kwparams)">
  ...
  <Function id="qiskit.pulse.InstructionScheduleMap.get_parameters" name="get_parameters" signature="get_parameters(instruction, qubits)">
  ...
  <Function id="qiskit.pulse.InstructionScheduleMap.has" name="has" signature="has(instruction, qubits)">
  ...
  <Function id="qiskit.pulse.InstructionScheduleMap.has_custom_gate" name="has_custom_gate" signature="has_custom_gate()">
  ...
  <Function id="qiskit.pulse.InstructionScheduleMap.pop" name="pop" signature="pop(instruction, qubits, *params, **kwparams)">
  ...
  <Function id="qiskit.pulse.InstructionScheduleMap.qubit_instructions" name="qubit_instructions" signature="qubit_instructions(qubits)">
  ...
  <Function id="qiskit.pulse.InstructionScheduleMap.qubits_with_instruction" name="qubits_with_instruction" signature="qubits_with_instruction(instruction)">
  ...
  <Function id="qiskit.pulse.InstructionScheduleMap.remove" name="remove" signature="remove(instruction, qubits)">
