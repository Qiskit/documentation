---
title: LookaheadSwap (v0.44)
description: API reference for qiskit.transpiler.passes.LookaheadSwap in qiskit v0.44
...
<Class id="qiskit.transpiler.passes.LookaheadSwap" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/transpiler/passes/routing/lookahead_swap.py" signature="qiskit.transpiler.passes.LookaheadSwap(*args, **kwargs)" modifiers="class">
