---
title: FastCNOTUnitObjective (v0.44)
description: API reference for qiskit.transpiler.synthesis.aqc.FastCNOTUnitObjective in qiskit v0.44
...
<Class id="qiskit.transpiler.synthesis.aqc.FastCNOTUnitObjective" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/transpiler/synthesis/aqc/fast_gradient/fast_gradient.py" signature="qiskit.transpiler.synthesis.aqc.FastCNOTUnitObjective(num_qubits, cnots)" modifiers="class">
