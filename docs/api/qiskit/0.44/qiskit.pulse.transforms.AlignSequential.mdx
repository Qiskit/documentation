...
<Class id="qiskit.pulse.transforms.AlignSequential" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/pulse/transforms/alignments.py" signature="qiskit.pulse.transforms.AlignSequential">
  ...
  <Function id="qiskit.pulse.transforms.AlignSequential.align" name="align" signature="align(schedule)">
  ...
  <Function id="qiskit.pulse.transforms.AlignSequential.to_dict" name="to_dict" signature="to_dict()">
