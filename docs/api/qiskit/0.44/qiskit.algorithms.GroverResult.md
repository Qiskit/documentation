...
`qiskit.algorithms.GroverResult`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.44/qiskit/algorithms/amplitude_amplifiers/grover.py "view source code")
