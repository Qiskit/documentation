...
<Class id="qiskit.primitives.BackendSampler" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.25/qiskit/primitives/backend_sampler.py" signature="qiskit.primitives.BackendSampler(backend, options=None, bound_pass_manager=None, skip_transpilation=False)">
  ...
  **Raises**
  ...
  <Function id="qiskit.primitives.BackendSampler.run" name="run" signature="run(circuits, parameter_values=None, **run_options)">
  ...
  <Function id="qiskit.primitives.BackendSampler.set_options" name="set_options" signature="set_options(**fields)">
  ...
  <Function id="qiskit.primitives.BackendSampler.set_transpile_options" name="set_transpile_options" signature="set_transpile_options(**fields)">
