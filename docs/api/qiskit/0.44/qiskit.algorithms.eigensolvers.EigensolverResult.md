...
`qiskit.algorithms.eigensolvers.EigensolverResult`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.44/qiskit/algorithms/eigensolvers/eigensolver.py "view source code")
