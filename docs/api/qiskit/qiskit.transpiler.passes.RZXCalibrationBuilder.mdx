...
<Class id="qiskit.transpiler.passes.RZXCalibrationBuilder" github="https://github.com/Qiskit/qiskit/tree/stable/1.0/qiskit/transpiler/passes/calibration/rzx_builder.py#L54-L241" signature="qiskit.transpiler.passes.RZXCalibrationBuilder(*args, **kwargs)">
