...
python_api_name: qiskit.transpiler.passes.synthesis.ross_selinger_plugin.RossSelingerSynthesis
---
...
<Class id="qiskit.transpiler.passes.synthesis.ross_selinger_plugin.RossSelingerSynthesis" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/transpiler/passes/synthesis/ross_selinger_plugin.py#L32-L114" signature="qiskit.transpiler.passes.synthesis.ross_selinger_plugin.RossSelingerSynthesis" modifiers="class">
  ...
  **\[1] Neil J. Ross, Peter Selinger, Optimal ancilla-free Clifford+T approximation of z-rotations,**
  ...
  <Attribute id="qiskit.transpiler.passes.synthesis.ross_selinger_plugin.RossSelingerSynthesis.max_qubits" name="max_qubits" headingLevel={3}>
    Maximum number of supported qubits is `1`.
  </Attribute>

  <Attribute id="qiskit.transpiler.passes.synthesis.ross_selinger_plugin.RossSelingerSynthesis.min_qubits" name="min_qubits" headingLevel={3}>
    Minimum number of supported qubits is `1`.
  </Attribute>

  <Attribute id="qiskit.transpiler.passes.synthesis.ross_selinger_plugin.RossSelingerSynthesis.supported_bases" name="supported_bases" headingLevel={3}>
    The plugin does not support bases for synthesis.
  </Attribute>

  <Attribute id="qiskit.transpiler.passes.synthesis.ross_selinger_plugin.RossSelingerSynthesis.supports_basis_gates" name="supports_basis_gates" headingLevel={3}>
    The plugin does not support basis gates. By default it synthesizes to the `["h", "s", "t", "x"]` gate basis.
  </Attribute>

  <Attribute id="qiskit.transpiler.passes.synthesis.ross_selinger_plugin.RossSelingerSynthesis.supports_coupling_map" name="supports_coupling_map" headingLevel={3}>
    The plugin does not support coupling maps.
  </Attribute>

  <Attribute id="qiskit.transpiler.passes.synthesis.ross_selinger_plugin.RossSelingerSynthesis.supports_gate_errors" name="supports_gate_errors" headingLevel={3}>
    The plugin does not support gate errors.
  </Attribute>

  <Attribute id="qiskit.transpiler.passes.synthesis.ross_selinger_plugin.RossSelingerSynthesis.supports_gate_errors_by_qubit" name="supports_gate_errors_by_qubit" headingLevel={3}>
  ...
  <Attribute id="qiskit.transpiler.passes.synthesis.ross_selinger_plugin.RossSelingerSynthesis.supports_gate_lengths" name="supports_gate_lengths" headingLevel={3}>
    The plugin does not support gate lengths.
  </Attribute>

  <Attribute id="qiskit.transpiler.passes.synthesis.ross_selinger_plugin.RossSelingerSynthesis.supports_gate_lengths_by_qubit" name="supports_gate_lengths_by_qubit" headingLevel={3}>
  ...
  <Attribute id="qiskit.transpiler.passes.synthesis.ross_selinger_plugin.RossSelingerSynthesis.supports_natural_direction" name="supports_natural_direction" headingLevel={3}>
    The plugin does not support natural direction, it does not assume bidirectional two qubit gates.
  </Attribute>

  <Attribute id="qiskit.transpiler.passes.synthesis.ross_selinger_plugin.RossSelingerSynthesis.supports_pulse_optimize" name="supports_pulse_optimize" headingLevel={3}>
    The plugin does not support optimization of pulses.
  </Attribute>

  <Attribute id="qiskit.transpiler.passes.synthesis.ross_selinger_plugin.RossSelingerSynthesis.supports_target" name="supports_target" headingLevel={3}>
