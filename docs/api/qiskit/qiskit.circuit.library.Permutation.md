...
`qiskit.circuit.library.Permutation(num_qubits, pattern=None, seed=None)`
...
![../\_images/qiskit-circuit-library-Permutation-1.png](/images/api/qiskit/qiskit-circuit-library-Permutation-1.png)

**Expanded Circuit:**

![../\_images/qiskit-circuit-library-Permutation-2.png](/images/api/qiskit/qiskit-circuit-library-Permutation-2.png)
