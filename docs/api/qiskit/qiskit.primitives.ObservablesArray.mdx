...
<Class id="qiskit.primitives.ObservablesArray" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/primitives/containers/observables_array.py#L50-L382" signature="qiskit.primitives.ObservablesArray(observables, num_qubits=None, copy=True, validate=True)" modifiers="class">
  Bases: `ShapedMixin`
  ...
  **Raises**
  ...
  <Attribute id="qiskit.primitives.ObservablesArray.ndim" name="ndim" headingLevel={3} />

  <Attribute id="qiskit.primitives.ObservablesArray.num_qubits" name="num_qubits" headingLevel={3}>
    The number of qubits each observable acts on.
  </Attribute>

  <Attribute id="qiskit.primitives.ObservablesArray.shape" name="shape" headingLevel={3} />

  <Attribute id="qiskit.primitives.ObservablesArray.size" name="size" headingLevel={3} />

  ## Methods

  ### apply\_layout

  <Function id="qiskit.primitives.ObservablesArray.apply_layout" github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/primitives/containers/observables_array.py#L344-L373" signature="apply_layout(layout, num_qubits=None)">
  ...
  <Function id="qiskit.primitives.ObservablesArray.coerce" github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/primitives/containers/observables_array.py#L305-L317" signature="coerce(observables)" modifiers="classmethod">
  ...
  <Function id="qiskit.primitives.ObservablesArray.coerce_observable" github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/primitives/containers/observables_array.py#L246-L303" signature="coerce_observable(observable)" modifiers="classmethod">
  ...
  <Function id="qiskit.primitives.ObservablesArray.copy" github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/primitives/containers/observables_array.py#L340-L342" signature="copy()">
    Return a deep copy of the array.
  </Function>

  ### equivalent

  <Function id="qiskit.primitives.ObservablesArray.equivalent" github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/primitives/containers/observables_array.py#L319-L338" signature="equivalent(other, tol=1e-08)">
  ...
  <Function id="qiskit.primitives.ObservablesArray.ravel" github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/primitives/containers/observables_array.py#L230-L239" signature="ravel()">
  ...
  <Function id="qiskit.primitives.ObservablesArray.reshape" github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/primitives/containers/observables_array.py#L216-L228" signature="reshape(*shape)">
  ...
  <Function id="qiskit.primitives.ObservablesArray.slice" github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/primitives/containers/observables_array.py#L199-L214" signature="slice(args: int | tuple[int, ...]) → SparseObservable" extraSignatures={["slice(args: int | slice | None | tuple[int | slice | None, ...]) → ObservablesArray"]}>
  ...
  <Function id="qiskit.primitives.ObservablesArray.sparse_observables_array" github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/primitives/containers/observables_array.py#L168-L178" signature="sparse_observables_array(copy=False)">
  ...
  <Function id="qiskit.primitives.ObservablesArray.tolist" github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/primitives/containers/observables_array.py#L133-L152" signature="tolist()">
  ...
  <Function id="qiskit.primitives.ObservablesArray.validate" github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/primitives/containers/observables_array.py#L375-L382" signature="validate()">
