---
title: PhaseEstimation (v0.37)
description: API reference for qiskit.algorithms.PhaseEstimation in qiskit v0.37
...
<Class id="qiskit.algorithms.PhaseEstimation" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.21/qiskit/algorithms/phase_estimators/phase_estimation.py" signature="PhaseEstimation(num_evaluation_qubits, quantum_instance=None)" modifiers="class">
