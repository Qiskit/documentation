...
<Class id="qiskit.opflow.expectations.AerPauliExpectation" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.21/qiskit/opflow/expectations/aer_pauli_expectation.py" signature="AerPauliExpectation">
  ...
  <Function id="qiskit.opflow.expectations.AerPauliExpectation.compute_variance" name="compute_variance" signature="AerPauliExpectation.compute_variance(exp_op)">
  ...
  <Function id="qiskit.opflow.expectations.AerPauliExpectation.convert" name="convert" signature="AerPauliExpectation.convert(operator)">
