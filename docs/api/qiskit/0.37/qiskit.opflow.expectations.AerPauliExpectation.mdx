---
title: AerPauliExpectation (v0.37)
description: API reference for qiskit.opflow.expectations.AerPauliExpectation in qiskit v0.37
...
<Class id="qiskit.opflow.expectations.AerPauliExpectation" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.21/qiskit/opflow/expectations/aer_pauli_expectation.py" signature="AerPauliExpectation" modifiers="class">
