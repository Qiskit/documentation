---
title: Unroll3qOrMore (v0.37)
description: API reference for qiskit.transpiler.passes.Unroll3qOrMore in qiskit v0.37
...
<Class id="qiskit.transpiler.passes.Unroll3qOrMore" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.21/qiskit/transpiler/passes/basis/unroll_3q_or_more.py" signature="Unroll3qOrMore(*args, **kwargs)" modifiers="class">
