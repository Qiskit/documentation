---
title: NumPyEigensolver (v0.37)
description: API reference for qiskit.algorithms.NumPyEigensolver in qiskit v0.37
...
<Class id="qiskit.algorithms.NumPyEigensolver" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.21/qiskit/algorithms/eigen_solvers/numpy_eigen_solver.py" signature="NumPyEigensolver(k=1, filter_criterion=None)" modifiers="class">
