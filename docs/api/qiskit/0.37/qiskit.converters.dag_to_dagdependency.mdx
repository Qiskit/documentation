...
<Function id="qiskit.converters.dag_to_dagdependency" github="https://github.com/qiskit/qiskit/tree/stable/0.21/qiskit/converters/dag_to_dagdependency.py" signature="dag_to_dagdependency(dag)">
