---
title: load (v0.37)
description: API reference for qiskit.qpy.load in qiskit v0.37
...
<Function id="qiskit.qpy.load" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.21/qiskit/qpy/interface.py" signature="load(file_obj, metadata_deserializer=None)">
