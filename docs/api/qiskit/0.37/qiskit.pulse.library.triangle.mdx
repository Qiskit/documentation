---
title: triangle (v0.37)
description: API reference for qiskit.pulse.library.triangle in qiskit v0.37
...
$$
  ...
  **Example**
  ...
  ![../\_images/qiskit.pulse.library.triangle\_0\_1.png](/docs/images/api/qiskit/0.37/qiskit.pulse.library.triangle_0_1.avif)
