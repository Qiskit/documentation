---
title: AbelianGrouper (v0.37)
description: API reference for qiskit.opflow.converters.AbelianGrouper in qiskit v0.37
...
<Class id="qiskit.opflow.converters.AbelianGrouper" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.21/qiskit/opflow/converters/abelian_grouper.py" signature="AbelianGrouper(traverse=True)" modifiers="class">
