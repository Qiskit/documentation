...
<Class id="qiskit.opflow.converters.AbelianGrouper" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.21/qiskit/opflow/converters/abelian_grouper.py" signature="AbelianGrouper(traverse=True)">
  ...
  **traverse** (`bool`) – Whether to convert only the Operator passed to `convert`, or traverse down that Operator.
  ...
  <Function id="qiskit.opflow.converters.AbelianGrouper.convert" name="convert" signature="AbelianGrouper.convert(operator)">
  ...
  <Function id="qiskit.opflow.converters.AbelianGrouper.group_subops" name="group_subops" signature="classmethod AbelianGrouper.group_subops(list_op)">
