...
<Function id="qiskit.pulse.transforms.flatten" github="https://github.com/qiskit/qiskit/tree/stable/0.21/qiskit/pulse/transforms/canonicalization.py" signature="flatten(program)">
