---
title: FakeLima (v0.37)
description: API reference for qiskit.providers.fake_provider.FakeLima in qiskit v0.37
...
<Class id="qiskit.providers.fake_provider.FakeLima" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.21/qiskit/providers/fake_provider/backends/lima/fake_lima.py" signature="FakeLima" modifiers="class">
