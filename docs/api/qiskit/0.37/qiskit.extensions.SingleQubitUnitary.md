...
`SingleQubitUnitary.inverse()` [GitHub](https://github.com/qiskit/qiskit/tree/stable/0.21/qiskit/extensions/quantum_initializer/squ.py "view source code")
...
`SingleQubitUnitary.validate_parameter(parameter)` [GitHub](https://github.com/qiskit/qiskit/tree/stable/0.21/qiskit/extensions/quantum_initializer/squ.py "view source code")
