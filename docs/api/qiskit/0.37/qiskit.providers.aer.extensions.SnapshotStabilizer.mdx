...
<Class id="qiskit.providers.aer.extensions.SnapshotStabilizer" github="https://github.com/qiskit/qiskit-aer/tree/stable/0.10/qiskit/providers/aer/extensions/snapshot_stabilizer.py" signature="SnapshotStabilizer(label, num_qubits=0)">
  ...
  **Additional Information:**
  ...
  <Function id="qiskit.providers.aer.extensions.SnapshotStabilizer.define_snapshot_register" signature="static SnapshotStabilizer.define_snapshot_register(circuit, label=None, qubits=None)">
