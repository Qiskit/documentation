---
title: SnapshotStabilizer (v0.37)
description: API reference for qiskit.providers.aer.extensions.SnapshotStabilizer in qiskit v0.37
...
<Class id="qiskit.providers.aer.extensions.SnapshotStabilizer" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-aer/tree/stable/0.10/qiskit/providers/aer/extensions/snapshot_stabilizer.py" signature="SnapshotStabilizer(label, num_qubits=0)" modifiers="class">
