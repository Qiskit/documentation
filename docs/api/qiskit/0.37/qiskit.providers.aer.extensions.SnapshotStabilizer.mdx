...
<Class id="qiskit.providers.aer.extensions.SnapshotStabilizer" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-aer/tree/stable/0.10/qiskit/providers/aer/extensions/snapshot_stabilizer.py" signature="SnapshotStabilizer(label, num_qubits=0)">
  ...
  **Additional Information:**
  ...
  <Attribute id="qiskit.providers.aer.extensions.SnapshotStabilizer.name">
    Return the name.
  </Attribute>

  ### num\_clbits

  <Attribute id="qiskit.providers.aer.extensions.SnapshotStabilizer.num_clbits">
    Return the number of clbits.
  </Attribute>

  ### num\_qubits

  <Attribute id="qiskit.providers.aer.extensions.SnapshotStabilizer.num_qubits">
