...
<Class id="qiskit.transpiler.passes.SetIOLatency" github="https://github.com/qiskit/qiskit/tree/stable/0.21/qiskit/transpiler/passes/scheduling/scheduling/set_io_latency.py" signature="SetIOLatency(clbit_write_latency=0, conditional_latency=0)">
