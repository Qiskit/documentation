...
<Class id="qiskit.pulse.library.Constant" github="https://github.com/qiskit/qiskit/tree/stable/0.21/qiskit/pulse/library/symbolic_pulses.py" signature="Constant(duration, amp, name=None, limit_amplitude=None)">
  ...
  *   **limit\_amplitude** (`Optional`\[`bool`]) – If `True`, then limit the amplitude of the waveform to 1. The default is `True` and the amplitude is constrained to 1.
  ...
  <Attribute id="qiskit.pulse.library.Constant.constraints" name="constraints">
  ...
  <Attribute id="qiskit.pulse.library.Constant.duration" name="duration" />

  ### envelope

  <Attribute id="qiskit.pulse.library.Constant.envelope" name="envelope">
  ...
  <Attribute id="qiskit.pulse.library.Constant.name" name="name" />
  ...
  <Attribute id="qiskit.pulse.library.Constant.pulse_type" name="pulse_type">
  ...
  <Attribute id="qiskit.pulse.library.Constant.valid_amp_conditions" name="valid_amp_conditions">
