...
<Function id="qiskit.compiler.sequence" github="https://github.com/qiskit/qiskit/tree/stable/0.21/qiskit/compiler/sequencer.py" signature="sequence(scheduled_circuits, backend=None, inst_map=None, meas_map=None, dt=None)">
