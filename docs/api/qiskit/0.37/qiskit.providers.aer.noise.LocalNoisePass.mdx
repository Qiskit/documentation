...
<Class id="qiskit.providers.aer.noise.LocalNoisePass" github="https://github.com/qiskit/qiskit-aer/tree/stable/0.10/qiskit/providers/aer/noise/passes/local_noise_pass.py" signature="LocalNoisePass(func, op_types=None, method='append')">
