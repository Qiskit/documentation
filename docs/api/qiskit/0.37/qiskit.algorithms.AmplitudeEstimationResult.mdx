---
title: AmplitudeEstimationResult (v0.37)
description: API reference for qiskit.algorithms.AmplitudeEstimationResult in qiskit v0.37
...
<Class id="qiskit.algorithms.AmplitudeEstimationResult" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.21/qiskit/algorithms/amplitude_estimators/ae.py" signature="AmplitudeEstimationResult" modifiers="class">
