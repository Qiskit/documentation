...
<Class id="qiskit.transpiler.passes.CollectMultiQBlocks" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.21/qiskit/transpiler/passes/optimization/collect_multiqubit_blocks.py" signature="CollectMultiQBlocks(*args, **kwargs)">
