---
title: ConverterBase (v0.37)
description: API reference for qiskit.opflow.converters.ConverterBase in qiskit v0.37
...
<Class id="qiskit.opflow.converters.ConverterBase" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.21/qiskit/opflow/converters/converter_base.py" signature="ConverterBase" modifiers="class">
  Bases: `abc.ABC`
