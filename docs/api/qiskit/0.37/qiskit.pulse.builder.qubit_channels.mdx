...
<Function id="qiskit.pulse.builder.qubit_channels" github="https://github.com/qiskit/qiskit/tree/stable/0.21/qiskit/pulse/builder.py" signature="qubit_channels(qubit)">
