---
title: AccountProvider (v0.37)
description: API reference for qiskit.providers.ibmq.AccountProvider in qiskit v0.37
...
<Class id="qiskit.providers.ibmq.AccountProvider" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-ibmq-provider/tree/stable/0.19/qiskit/providers/ibmq/accountprovider.py" signature="AccountProvider(credentials, factory)" modifiers="class">
