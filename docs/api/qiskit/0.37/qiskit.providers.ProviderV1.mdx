---
title: ProviderV1 (v0.37)
description: API reference for qiskit.providers.ProviderV1 in qiskit v0.37
...
<Class id="qiskit.providers.ProviderV1" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.21/qiskit/providers/provider.py" signature="ProviderV1" modifiers="class">
