---
title: frequency_offset (v0.37)
description: API reference for qiskit.pulse.builder.frequency_offset in qiskit v0.37
...
<Function id="qiskit.pulse.builder.frequency_offset" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.21/qiskit/pulse/builder.py" signature="frequency_offset(frequency, *channels, compensate_phase=False)">
