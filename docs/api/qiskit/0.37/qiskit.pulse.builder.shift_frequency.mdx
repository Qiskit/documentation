...
<Function id="qiskit.pulse.builder.shift_frequency" github="https://github.com/qiskit/qiskit/tree/stable/0.21/qiskit/pulse/builder.py" signature="shift_frequency(frequency, channel, name=None)">
