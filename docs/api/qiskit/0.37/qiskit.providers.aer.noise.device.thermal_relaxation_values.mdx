...
<Function id="qiskit.providers.aer.noise.device.thermal_relaxation_values" github="https://github.com/qiskit/qiskit-aer/tree/stable/0.10/qiskit/providers/aer/noise/device/parameters.py" signature="thermal_relaxation_values(properties)">
