---
title: Credentials (v0.37)
description: API reference for qiskit.providers.ibmq.credentials.Credentials in qiskit v0.37
...
<Class id="qiskit.providers.ibmq.credentials.Credentials" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-ibmq-provider/tree/stable/0.19/qiskit/providers/ibmq/credentials/credentials.py" signature="Credentials(token, url, websockets_url=None, hub=None, group=None, project=None, proxies=None, verify=True, services=None, access_token=None, preferences=None, default_provider=None)" modifiers="class">
  ...
  *   **default\_provider** (`Optional`\[`HubGroupProject`]) – Default provider to use.
  ...
  <span id="qiskit-providers-ibmq-credentials-credentials-connection-parameters" />
  ...
  <span id="qiskit-providers-ibmq-credentials-credentials-is-ibmq" />
  ...
  <span id="qiskit-providers-ibmq-credentials-credentials-unique-id" />
