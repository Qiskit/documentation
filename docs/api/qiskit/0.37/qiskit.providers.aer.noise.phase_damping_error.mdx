...
<Function id="qiskit.providers.aer.noise.phase_damping_error" name="phase_damping_error" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-aer/tree/stable/0.10/qiskit/providers/aer/noise/errors/standard_errors.py" signature="phase_damping_error(param_phase, canonical_kraus=True)">
