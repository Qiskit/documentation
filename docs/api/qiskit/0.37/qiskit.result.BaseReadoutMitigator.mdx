---
title: BaseReadoutMitigator (v0.37)
description: API reference for qiskit.result.BaseReadoutMitigator in qiskit v0.37
...
<Class id="qiskit.result.BaseReadoutMitigator" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.21/qiskit/result/mitigation/base_readout_mitigator.py" signature="BaseReadoutMitigator" modifiers="class">
  Bases: `abc.ABC`
