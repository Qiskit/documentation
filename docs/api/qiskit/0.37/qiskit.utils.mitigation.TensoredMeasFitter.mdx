---
title: TensoredMeasFitter (v0.37)
description: API reference for qiskit.utils.mitigation.TensoredMeasFitter in qiskit v0.37
...
<Class id="qiskit.utils.mitigation.TensoredMeasFitter" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.21/qiskit/utils/mitigation/fitters.py" signature="TensoredMeasFitter(results, mit_pattern, substate_labels_list=None, circlabel='')" modifiers="class">
  Bases: `object`
