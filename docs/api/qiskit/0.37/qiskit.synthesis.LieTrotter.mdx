...
<Class id="qiskit.synthesis.LieTrotter" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.21/qiskit/synthesis/evolution/lie_trotter.py" signature="LieTrotter(reps=1, insert_barriers=False, cx_structure='chain', atomic_evolution=None)">
