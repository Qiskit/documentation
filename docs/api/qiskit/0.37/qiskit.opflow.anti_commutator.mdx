...
<Function id="qiskit.opflow.anti_commutator" github="https://github.com/qiskit/qiskit/tree/stable/0.21/qiskit/opflow/utils.py" signature="anti_commutator(op_a, op_b)">
