---
title: UCRZGate (v0.37)
description: API reference for qiskit.extensions.UCRZGate in qiskit v0.37
...
<Class id="qiskit.extensions.UCRZGate" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.21/qiskit/extensions/quantum_initializer/ucrz.py" signature="UCRZGate(angle_list)" modifiers="class">
