---
title: Parameter (v0.37)
description: API reference for qiskit.circuit.Parameter in qiskit v0.37
...
<Class id="qiskit.circuit.Parameter" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.21/qiskit/circuit/parameter.py" signature="Parameter(name)" modifiers="class">
