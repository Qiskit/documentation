...
<Class id="qiskit.qobj.QasmQobj" github="https://github.com/qiskit/qiskit/tree/stable/0.21/qiskit/qobj/qasm_qobj.py" signature="QasmQobj(qobj_id=None, config=None, experiments=None, header=None)">
  Bases: `object`
