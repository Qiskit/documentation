---
title: ContainsInstruction (v0.37)
description: API reference for qiskit.transpiler.passes.ContainsInstruction in qiskit v0.37
...
<Class id="qiskit.transpiler.passes.ContainsInstruction" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.21/qiskit/transpiler/passes/utils/contains_instruction.py" signature="ContainsInstruction(*args, **kwargs)" modifiers="class">
