---
title: PauliOp (v0.37)
description: API reference for qiskit.opflow.primitive_ops.PauliOp in qiskit v0.37
...
<Class id="qiskit.opflow.primitive_ops.PauliOp" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.21/qiskit/opflow/primitive_ops/pauli_op.py" signature="PauliOp(primitive, coeff=1.0)" modifiers="class">
