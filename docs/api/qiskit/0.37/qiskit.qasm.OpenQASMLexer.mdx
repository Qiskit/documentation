---
title: OpenQASMLexer (v0.37)
description: API reference for qiskit.qasm.OpenQASMLexer in qiskit v0.37
...
<Class id="qiskit.qasm.OpenQASMLexer" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.21/qiskit/qasm/pygments/lexer.py" signature="OpenQASMLexer(*args, **kwds)" modifiers="class">
