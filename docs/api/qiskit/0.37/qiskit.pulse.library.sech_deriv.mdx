...
<Function id="qiskit.pulse.library.sech_deriv" name="sech_deriv" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.21/qiskit/pulse/library/discrete.py" signature="sech_deriv(duration, amp, sigma, name=None)">
