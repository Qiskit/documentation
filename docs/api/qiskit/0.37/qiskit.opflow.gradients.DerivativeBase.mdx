...
<Class id="qiskit.opflow.gradients.DerivativeBase" github="https://github.com/qiskit/qiskit/tree/stable/0.21/qiskit/opflow/gradients/derivative_base.py" signature="DerivativeBase">
