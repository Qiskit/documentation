---
title: UMDA (v0.37)
description: API reference for qiskit.algorithms.optimizers.UMDA in qiskit v0.37
...
<Class id="qiskit.algorithms.optimizers.UMDA" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.21/qiskit/algorithms/optimizers/umda.py" signature="UMDA(maxiter=100, size_gen=20, alpha=0.5)" modifiers="class">
  ...
  *   **alpha** (`float`) – Percentage (0, 1] of the population to be selected as elite selection.
  ...
  <Function id="qiskit.algorithms.optimizers.UMDA.gradient_num_diff" signature="UMDA.gradient_num_diff(x_center, f, epsilon, max_evals_grouped=1)" modifiers="static">
