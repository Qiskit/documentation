...
<Function id="qiskit.providers.aer.utils.transform_noise_model" name="transform_noise_model" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-aer/tree/stable/0.10/qiskit/providers/aer/utils/noise_transformation.py" signature="transform_noise_model(noise_model, func)">
