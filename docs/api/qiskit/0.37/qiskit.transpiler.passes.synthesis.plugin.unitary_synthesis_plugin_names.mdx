...
<Function id="qiskit.transpiler.passes.synthesis.plugin.unitary_synthesis_plugin_names" name="unitary_synthesis_plugin_names" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.21/qiskit/transpiler/passes/synthesis/plugin.py" signature="unitary_synthesis_plugin_names()">
