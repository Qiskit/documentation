---
title: library (v0.37)
description: API reference for qiskit.circuit.library in qiskit v0.37
...
![../\_images/circuit\_library\_0\_0.png](/docs/images/api/qiskit/0.37/circuit_library_0_0.avif)
