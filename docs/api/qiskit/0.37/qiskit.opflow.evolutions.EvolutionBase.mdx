---
title: EvolutionBase (v0.37)
description: API reference for qiskit.opflow.evolutions.EvolutionBase in qiskit v0.37
...
<Class id="qiskit.opflow.evolutions.EvolutionBase" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.21/qiskit/opflow/evolutions/evolution_base.py" signature="EvolutionBase" modifiers="class">
