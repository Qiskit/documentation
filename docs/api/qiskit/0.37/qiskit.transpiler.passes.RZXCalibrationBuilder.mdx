...
<Class id="qiskit.transpiler.passes.RZXCalibrationBuilder" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.21/qiskit/transpiler/passes/calibration/builders.py" signature="RZXCalibrationBuilder(instruction_schedule_map=None, qubit_channel_mapping=None)">
