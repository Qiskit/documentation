---
title: Provider (v0.37)
description: API reference for qiskit.providers.Provider in qiskit v0.37
...
<Class id="qiskit.providers.Provider" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.21/qiskit/providers/provider.py" signature="Provider" modifiers="class">
  Bases: `object`
