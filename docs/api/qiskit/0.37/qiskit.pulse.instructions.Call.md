...
`Call.assigned_subroutine()`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.21/qiskit/pulse/instructions/call.py "view source code")
...
`Call.is_parameterized()`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.21/qiskit/pulse/instructions/call.py "view source code")
