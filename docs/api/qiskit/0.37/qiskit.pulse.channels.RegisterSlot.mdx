---
title: RegisterSlot (v0.37)
description: API reference for qiskit.pulse.channels.RegisterSlot in qiskit v0.37
...
<Class id="qiskit.pulse.channels.RegisterSlot" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.21/qiskit/pulse/channels.py" signature="RegisterSlot(index)" modifiers="class">
