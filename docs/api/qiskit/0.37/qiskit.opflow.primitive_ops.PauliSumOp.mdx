---
title: PauliSumOp (v0.37)
description: API reference for qiskit.opflow.primitive_ops.PauliSumOp in qiskit v0.37
...
<Class id="qiskit.opflow.primitive_ops.PauliSumOp" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.21/qiskit/opflow/primitive_ops/pauli_sum_op.py" signature="PauliSumOp(primitive, coeff=1.0, grouping_type='None')" modifiers="class">
  ...
  **TypeError** – invalid parameters.
  ...
  <Function id="qiskit.opflow.primitive_ops.PauliSumOp.from_list" signature="PauliSumOp.from_list(pauli_list, coeff=1.0)" modifiers="classmethod">
