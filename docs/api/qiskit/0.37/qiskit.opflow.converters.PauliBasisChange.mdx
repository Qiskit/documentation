...
<Class id="qiskit.opflow.converters.PauliBasisChange" github="https://github.com/qiskit/qiskit/tree/stable/0.21/qiskit/opflow/converters/pauli_basis_change.py" signature="PauliBasisChange(destination_basis=None, traverse=True, replacement_fn=None)">
  ...
  *   **replacement\_fn** (`Optional`\[`Callable`]) –
  ...
  <Function id="qiskit.opflow.converters.PauliBasisChange.measurement_replacement_fn" signature="static PauliBasisChange.measurement_replacement_fn(cob_instr_op, dest_pauli_op)">
  ...
  <Function id="qiskit.opflow.converters.PauliBasisChange.operator_replacement_fn" signature="static PauliBasisChange.operator_replacement_fn(cob_instr_op, dest_pauli_op)">
  ...
  <Function id="qiskit.opflow.converters.PauliBasisChange.statefn_replacement_fn" signature="static PauliBasisChange.statefn_replacement_fn(cob_instr_op, dest_pauli_op)">
