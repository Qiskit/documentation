...
`classmethod RunConfig.from_dict(data)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.21/qiskit/assembler/run_config.py "view source code")
...
`RunConfig.to_dict()`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.21/qiskit/assembler/run_config.py "view source code")
