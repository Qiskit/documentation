...
<Class id="qiskit.transpiler.synthesis.aqc.ApproximatingObjective" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.21/qiskit/transpiler/synthesis/aqc/approximate.py" signature="ApproximatingObjective">
  Bases: `abc.ABC`
  ...
  <Function id="qiskit.transpiler.synthesis.aqc.ApproximatingObjective.gradient" name="gradient" signature="abstract ApproximatingObjective.gradient(param_values)">
  ...
  <Function id="qiskit.transpiler.synthesis.aqc.ApproximatingObjective.objective" name="objective" signature="abstract ApproximatingObjective.objective(param_values)">
  ...
  <Attribute id="qiskit.transpiler.synthesis.aqc.ApproximatingObjective.num_thetas" name="num_thetas">
  ...
  <Attribute id="qiskit.transpiler.synthesis.aqc.ApproximatingObjective.target_matrix" name="target_matrix">
