...
<Class id="qiskit.opflow.primitive_ops.MatrixOp" github="https://github.com/qiskit/qiskit/tree/stable/0.21/qiskit/opflow/primitive_ops/matrix_op.py" signature="MatrixOp(primitive, coeff=1.0)">
  ...
  *   **ValueError** – invalid parameters.
  ...
  <Function id="qiskit.opflow.primitive_ops.MatrixOp.add" name="add" signature="MatrixOp.add(other)">
  ...
  <Function id="qiskit.opflow.primitive_ops.MatrixOp.adjoint" name="adjoint" signature="MatrixOp.adjoint()">
  ...
  <Function id="qiskit.opflow.primitive_ops.MatrixOp.compose" name="compose" signature="MatrixOp.compose(other, permutation=None, front=False)">
  ...
  <Function id="qiskit.opflow.primitive_ops.MatrixOp.equals" name="equals" signature="MatrixOp.equals(other)">
  ...
  <Function id="qiskit.opflow.primitive_ops.MatrixOp.eval" name="eval" signature="MatrixOp.eval(front=None)">
  ...
  <Function id="qiskit.opflow.primitive_ops.MatrixOp.exp_i" name="exp_i" signature="MatrixOp.exp_i()">
  ...
  <Function id="qiskit.opflow.primitive_ops.MatrixOp.permute" name="permute" signature="MatrixOp.permute(permutation=None)">
  ...
  <Function id="qiskit.opflow.primitive_ops.MatrixOp.primitive_strings" name="primitive_strings" signature="MatrixOp.primitive_strings()">
  ...
  <Function id="qiskit.opflow.primitive_ops.MatrixOp.tensor" name="tensor" signature="MatrixOp.tensor(other)">
  ...
  <Function id="qiskit.opflow.primitive_ops.MatrixOp.to_instruction" name="to_instruction" signature="MatrixOp.to_instruction()">
  ...
  <Function id="qiskit.opflow.primitive_ops.MatrixOp.to_matrix" name="to_matrix" signature="MatrixOp.to_matrix(massive=False)">
  ...
  <Function id="qiskit.opflow.primitive_ops.MatrixOp.to_matrix_op" name="to_matrix_op" signature="MatrixOp.to_matrix_op(massive=False)">
  ...
  <Attribute id="qiskit.opflow.primitive_ops.MatrixOp.INDENTATION" name="INDENTATION" attributeValue="= '  '" />

  ### coeff

  <Attribute id="qiskit.opflow.primitive_ops.MatrixOp.coeff" name="coeff">
  ...
  <Attribute id="qiskit.opflow.primitive_ops.MatrixOp.instance_id" name="instance_id">
  ...
  <Attribute id="qiskit.opflow.primitive_ops.MatrixOp.num_qubits" name="num_qubits">
    **Return type**
  ...
  <Attribute id="qiskit.opflow.primitive_ops.MatrixOp.parameters" name="parameters" />

  ### primitive

  <Attribute id="qiskit.opflow.primitive_ops.MatrixOp.primitive" name="primitive" attributeTypeHint="qiskit.quantum_info.operators.operator.Operator">
  ...
  <Attribute id="qiskit.opflow.primitive_ops.MatrixOp.settings" name="settings">
