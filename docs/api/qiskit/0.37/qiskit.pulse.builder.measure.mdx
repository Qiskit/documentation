---
title: measure (v0.37)
description: API reference for qiskit.pulse.builder.measure in qiskit v0.37
...
<Function id="qiskit.pulse.builder.measure" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.21/qiskit/pulse/builder.py" signature="measure(qubits, registers=None)">
