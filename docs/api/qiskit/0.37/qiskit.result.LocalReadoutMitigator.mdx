...
<Class id="qiskit.result.LocalReadoutMitigator" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.21/qiskit/result/mitigation/local_readout_mitigator.py" signature="LocalReadoutMitigator(assignment_matrices=None, qubits=None, backend=None)">
  ...
  **QiskitError** – matrices sizes do not agree with number of qubits
  ...
  <Function id="qiskit.result.LocalReadoutMitigator.assignment_matrix" name="assignment_matrix" signature="LocalReadoutMitigator.assignment_matrix(qubits=None)">
  ...
  <Function id="qiskit.result.LocalReadoutMitigator.expectation_value" name="expectation_value" signature="LocalReadoutMitigator.expectation_value(data, diagonal=None, qubits=None, clbits=None, shots=None)">
  ...
  <Function id="qiskit.result.LocalReadoutMitigator.mitigation_matrix" name="mitigation_matrix" signature="LocalReadoutMitigator.mitigation_matrix(qubits=None)">
  ...
  <Function id="qiskit.result.LocalReadoutMitigator.quasi_probabilities" name="quasi_probabilities" signature="LocalReadoutMitigator.quasi_probabilities(data, qubits=None, clbits=None, shots=False)">
  ...
  <Function id="qiskit.result.LocalReadoutMitigator.stddev_upper_bound" name="stddev_upper_bound" signature="LocalReadoutMitigator.stddev_upper_bound(shots, qubits=None)">
  ...
  <Attribute id="qiskit.result.LocalReadoutMitigator.qubits" name="qubits">
  ...
  <Attribute id="qiskit.result.LocalReadoutMitigator.settings" name="settings">
    Return settings.
