...
`align_func(duration, func)` [GitHub](https://github.com/qiskit/qiskit/tree/stable/0.21/qiskit/pulse/builder.py "view source code")
...
![../\_images/qiskit.pulse.builder.align\_func\_0\_0.png](/images/api/qiskit/0.37/qiskit.pulse.builder.align_func_0_0.png)
