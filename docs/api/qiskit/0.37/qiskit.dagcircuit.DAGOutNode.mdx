---
title: DAGOutNode (v0.37)
description: API reference for qiskit.dagcircuit.DAGOutNode in qiskit v0.37
...
<Class id="qiskit.dagcircuit.DAGOutNode" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.21/qiskit/dagcircuit/dagnode.py" signature="DAGOutNode(wire)" modifiers="class">
  ...
  <span id="qiskit-dagcircuit-dagoutnode-semantic-eq" />
