---
title: RYGate (v0.37)
description: API reference for qiskit.circuit.library.RYGate in qiskit v0.37
...
<Class id="qiskit.circuit.library.RYGate" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.21/qiskit/circuit/library/standard_gates/ry.py" signature="RYGate(theta, label=None)" modifiers="class">
