...
<Function id="qiskit.providers.aer.noise.device.gate_error_values" github="https://github.com/qiskit/qiskit-aer/tree/stable/0.10/qiskit/providers/aer/noise/device/parameters.py" signature="gate_error_values(properties)">
