...
<Class id="qiskit.synthesis.EvolutionSynthesis" github="https://github.com/qiskit/qiskit/tree/stable/0.21/qiskit/synthesis/evolution/evolution_synthesis.py" signature="EvolutionSynthesis">
  Bases: `abc.ABC`
