...
description: API reference for qiskit.providers.fake_provider.FakeBrooklynV2 in qiskit v0.37
...
<Class id="qiskit.providers.fake_provider.FakeBrooklynV2" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.21/qiskit/providers/fake_provider/backends/brooklyn/fake_brooklyn.py" signature="FakeBrooklynV2" modifiers="class">
  ...
  <Attribute id="qiskit.providers.fake_provider.FakeBrooklynV2.backend_name" attributeValue="'fake_brooklyn_v2'" />
  ...
  <Attribute id="qiskit.providers.fake_provider.FakeBrooklynV2.dirname" attributeValue="'/home/runner/work/qiskit/qiskit/.tox/docs/lib/python3.8/site-packages/qiskit/providers/fake_provider/backends/brooklyn'" />
