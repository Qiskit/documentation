---
title: disassemble (v0.37)
description: API reference for qiskit.assembler.disassemble in qiskit v0.37
...
<Function id="qiskit.assembler.disassemble" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.21/qiskit/assembler/disassemble.py" signature="disassemble(qobj)">
