...
<Class id="qiskit.transpiler.synthesis.aqc.DefaultCNOTUnitObjective" github="https://github.com/qiskit/qiskit/tree/stable/0.21/qiskit/transpiler/synthesis/aqc/cnot_unit_objective.py" signature="DefaultCNOTUnitObjective(num_qubits, cnots)">
