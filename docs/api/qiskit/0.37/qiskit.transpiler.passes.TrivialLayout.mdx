---
title: TrivialLayout (v0.37)
description: API reference for qiskit.transpiler.passes.TrivialLayout in qiskit v0.37
...
<Class id="qiskit.transpiler.passes.TrivialLayout" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.21/qiskit/transpiler/passes/layout/trivial_layout.py" signature="TrivialLayout(*args, **kwargs)" modifiers="class">
