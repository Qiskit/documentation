---
title: FakeMelbourneV2 (v0.37)
description: API reference for qiskit.providers.fake_provider.FakeMelbourneV2 in qiskit v0.37
...
<Class id="qiskit.providers.fake_provider.FakeMelbourneV2" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.21/qiskit/providers/fake_provider/backends/melbourne/fake_melbourne.py" signature="FakeMelbourneV2" modifiers="class">
