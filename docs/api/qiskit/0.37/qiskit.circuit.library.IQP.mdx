---
title: IQP (v0.37)
description: API reference for qiskit.circuit.library.IQP in qiskit v0.37
...
<Class id="qiskit.circuit.library.IQP" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.21/qiskit/circuit/library/iqp.py" signature="IQP(interactions)" modifiers="class">
  ...
  **Reference Circuit:**
  ...
  ![../\_images/qiskit.circuit.library.IQP\_0\_0.png](/docs/images/api/qiskit/0.37/qiskit.circuit.library.IQP_0_0.avif)
  ...
  **CircuitError** – if the inputs is not as symmetric matrix.
  ...
  <Attribute id="qiskit.circuit.library.IQP.instances" attributeValue="87" />
