...
`FakeBrooklyn`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.21/qiskit/providers/fake_provider/backends/brooklyn/fake_brooklyn.py "view source code")
