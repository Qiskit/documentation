---
title: IfElseOp (v0.37)
description: API reference for qiskit.circuit.IfElseOp in qiskit v0.37
...
<Class id="qiskit.circuit.IfElseOp" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.21/qiskit/circuit/controlflow/if_else.py" signature="IfElseOp(condition, true_body, false_body=None, label=None)" modifiers="class">
