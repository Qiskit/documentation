...
`plot_error_map(backend, figsize=(12, 9), show_title=True, qubit_coordinates=None)` [GitHub](https://github.com/qiskit/qiskit/tree/stable/0.21/qiskit/visualization/gate_map.py "view source code")
...
![../\_images/qiskit.visualization.plot\_error\_map\_1\_0.png](/images/api/qiskit/0.37/qiskit.visualization.plot_error_map_1_0.png)
