...
<Class id="qiskit.transpiler.passes.Commuting2qGateRouter" github="https://github.com/qiskit/qiskit/tree/stable/0.21/qiskit/transpiler/passes/routing/commuting_2q_gate_routing/commuting_2q_gate_router.py" signature="Commuting2qGateRouter(swap_strategy=None)">
