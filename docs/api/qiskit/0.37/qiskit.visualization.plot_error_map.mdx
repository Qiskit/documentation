---
title: plot_error_map (v0.37)
description: API reference for qiskit.visualization.plot_error_map in qiskit v0.37
...
<Function id="qiskit.visualization.plot_error_map" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.21/qiskit/visualization/gate_map.py" signature="plot_error_map(backend, figsize=(12, 9), show_title=True, qubit_coordinates=None)">
  ...
  **Example**
  ...
  ![../\_images/qiskit.visualization.plot\_error\_map\_1\_0.png](/docs/images/api/qiskit/0.37/qiskit.visualization.plot_error_map_1_0.avif)
</Function>
