...
<Function id="qiskit.pulse.builder.shift_phase" name="shift_phase" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.21/qiskit/pulse/builder.py" signature="shift_phase(phase, channel, name=None)">
