---
title: save_amplitudes (v0.37)
description: API reference for qiskit.providers.aer.library.save_amplitudes in qiskit v0.37
in_page_toc_min_heading_level: 1
python_api_type: function
python_api_name: qiskit.providers.aer.library.save_amplitudes
---

<span id="qiskit-providers-aer-library-save-amplitudes" />

# qiskit.providers.aer.library.save\_amplitudes

<Function id="qiskit.providers.aer.library.save_amplitudes" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-aer/tree/stable/0.10/qiskit/providers/aer/library/save_instructions/save_amplitudes.py" signature="save_amplitudes(self, params, label='amplitudes', pershot=False, conditional=False)">
