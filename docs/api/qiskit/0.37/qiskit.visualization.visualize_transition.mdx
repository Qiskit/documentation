---
title: visualize_transition (v0.37)
description: API reference for qiskit.visualization.visualize_transition in qiskit v0.37
...
<Function id="qiskit.visualization.visualize_transition" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.21/qiskit/visualization/transition_visualization.py" signature="visualize_transition(circuit, trace=False, saveas=None, fpg=100, spg=2)">
