...
<Function id="qiskit.quantum_info.random_clifford" github="https://github.com/qiskit/qiskit/tree/stable/0.21/qiskit/quantum_info/operators/symplectic/random.py" signature="random_clifford(num_qubits, seed=None)">
