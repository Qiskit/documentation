---
title: MCPhaseGate (v0.37)
description: API reference for qiskit.circuit.library.MCPhaseGate in qiskit v0.37
...
<Class id="qiskit.circuit.library.MCPhaseGate" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.21/qiskit/circuit/library/standard_gates/p.py" signature="MCPhaseGate(lam, num_ctrl_qubits, label=None)" modifiers="class">
