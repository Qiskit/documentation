---
title: summarize_circuits (v0.37)
description: API reference for qiskit.utils.summarize_circuits in qiskit v0.37
...
<Function id="qiskit.utils.summarize_circuits" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.21/qiskit/utils/circuit_utils.py" signature="summarize_circuits(circuits)">
