---
title: GRX (v0.37)
description: API reference for qiskit.circuit.library.GRX in qiskit v0.37
...
<Class id="qiskit.circuit.library.GRX" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.21/qiskit/circuit/library/generalized_gates/gr.py" signature="GRX(num_qubits, theta)" modifiers="class">
...
$$
  ...
  *   **theta** (`float`) – rotation angle about x-axis
  ...
  <Attribute id="qiskit.circuit.library.GRX.instances" attributeValue="87" />
