---
title: Stinespring (v0.37)
description: API reference for qiskit.quantum_info.Stinespring in qiskit v0.37
...
<Class id="qiskit.quantum_info.Stinespring" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.21/qiskit/quantum_info/operators/channel/stinespring.py" signature="Stinespring(data, input_dims=None, output_dims=None)" modifiers="class">
