...
<Class id="qiskit.algorithms.Eigensolver" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.21/qiskit/algorithms/eigen_solvers/eigen_solver.py" signature="Eigensolver">
  Bases: `abc.ABC`
