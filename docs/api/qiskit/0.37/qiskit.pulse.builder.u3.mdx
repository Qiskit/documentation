---
title: u3 (v0.37)
description: API reference for qiskit.pulse.builder.u3 in qiskit v0.37
...
<Function id="qiskit.pulse.builder.u3" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.21/qiskit/pulse/builder.py" signature="u3(theta, phi, lam, qubit)">
