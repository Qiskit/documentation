---
title: SGate (v0.37)
description: API reference for qiskit.circuit.library.SGate in qiskit v0.37
...
<Class id="qiskit.circuit.library.SGate" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.21/qiskit/circuit/library/standard_gates/s.py" signature="SGate(label=None)" modifiers="class">
