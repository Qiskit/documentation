...
<Class id="qiskit.transpiler.passes.DenseLayout" github="https://github.com/qiskit/qiskit/tree/stable/0.21/qiskit/transpiler/passes/layout/dense_layout.py" signature="DenseLayout(*args, **kwargs)">
