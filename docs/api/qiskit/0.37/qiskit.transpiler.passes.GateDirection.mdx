...
<Class id="qiskit.transpiler.passes.GateDirection" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.21/qiskit/transpiler/passes/utils/gate_direction.py" signature="GateDirection(*args, **kwargs)">
