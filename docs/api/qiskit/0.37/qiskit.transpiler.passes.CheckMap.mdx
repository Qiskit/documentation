...
<Class id="qiskit.transpiler.passes.CheckMap" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.21/qiskit/transpiler/passes/utils/check_map.py" signature="CheckMap(*args, **kwargs)">
  ...
  **coupling\_map** ([*CouplingMap*](qiskit.transpiler.CouplingMap "qiskit.transpiler.CouplingMap")) – Directed graph representing a coupling map.
  ...
  <Function id="qiskit.transpiler.passes.CheckMap.name" name="name" signature="CheckMap.name()">
    Return the name of the pass.
  </Function>

  ### run

  <Function id="qiskit.transpiler.passes.CheckMap.run" name="run" signature="CheckMap.run(dag)">
  ...
  <Attribute id="qiskit.transpiler.passes.CheckMap.is_analysis_pass" name="is_analysis_pass">
  ...
  <Attribute id="qiskit.transpiler.passes.CheckMap.is_transformation_pass" name="is_transformation_pass">
