...
`FakeYorktownV2` [GitHub](https://github.com/qiskit/qiskit/tree/stable/0.21/qiskit/providers/fake_provider/backends/yorktown/fake_yorktown.py "view source code")
...
<span id="qiskit.providers.fake_provider.FakeYorktownV2.acquire_channel" />

`FakeYorktownV2.acquire_channel(qubit)`
...
<span id="qiskit.providers.fake_provider.FakeYorktownV2.control_channel" />

`FakeYorktownV2.control_channel(qubits)`
...
<span id="qiskit.providers.fake_provider.FakeYorktownV2.drive_channel" />

`FakeYorktownV2.drive_channel(qubit)`
...
<span id="qiskit.providers.fake_provider.FakeYorktownV2.measure_channel" />

`FakeYorktownV2.measure_channel(qubit)`
...
<span id="qiskit.providers.fake_provider.FakeYorktownV2.qubit_properties" />

`FakeYorktownV2.qubit_properties(qubit)`
...
<span id="qiskit.providers.fake_provider.FakeYorktownV2.run" />

`FakeYorktownV2.run(run_input, **options)`
...
<span id="qiskit.providers.fake_provider.FakeYorktownV2.set_options" />

`FakeYorktownV2.set_options(**fields)`
...
<span id="qiskit.providers.fake_provider.FakeYorktownV2.backend_name" />

### backend\_name

`= 'fake_yorktown_v2'`

<span id="qiskit.providers.fake_provider.FakeYorktownV2.conf_filename" />

### conf\_filename

`= 'conf_yorktown.json'`

<span id="qiskit.providers.fake_provider.FakeYorktownV2.coupling_map" />

### coupling\_map

Return the [`CouplingMap`](qiskit.transpiler.CouplingMap "qiskit.transpiler.CouplingMap") object

<span id="qiskit.providers.fake_provider.FakeYorktownV2.defs_filename" />

### defs\_filename

`= None`

<span id="qiskit.providers.fake_provider.FakeYorktownV2.dirname" />
...
<span id="qiskit.providers.fake_provider.FakeYorktownV2.dtm" />
...
<span id="qiskit.providers.fake_provider.FakeYorktownV2.instruction_durations" />

### instruction\_durations

Return the [`InstructionDurations`](qiskit.transpiler.InstructionDurations "qiskit.transpiler.InstructionDurations") object.

<span id="qiskit.providers.fake_provider.FakeYorktownV2.instruction_schedule_map" />
...
<span id="qiskit.providers.fake_provider.FakeYorktownV2.instructions" />
...
<span id="qiskit.providers.fake_provider.FakeYorktownV2.max_circuits" />

### max\_circuits

<span id="qiskit.providers.fake_provider.FakeYorktownV2.meas_map" />
...
<span id="qiskit.providers.fake_provider.FakeYorktownV2.num_qubits" />
...
<span id="qiskit.providers.fake_provider.FakeYorktownV2.operation_names" />
...
<span id="qiskit.providers.fake_provider.FakeYorktownV2.operations" />
...
<span id="qiskit.providers.fake_provider.FakeYorktownV2.options" />
...
<span id="qiskit.providers.fake_provider.FakeYorktownV2.props_filename" />

### props\_filename

`= 'props_yorktown.json'`

<span id="qiskit.providers.fake_provider.FakeYorktownV2.provider" />
...
<span id="qiskit.providers.fake_provider.FakeYorktownV2.target" />
...
<span id="qiskit.providers.fake_provider.FakeYorktownV2.version" />
