...
description: API reference for qiskit.providers.fake_provider.FakeAlmadenV2 in qiskit v0.37
...
<Class id="qiskit.providers.fake_provider.FakeAlmadenV2" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.21/qiskit/providers/fake_provider/backends/almaden/fake_almaden.py" signature="FakeAlmadenV2" modifiers="class">
  ...
  <Attribute id="qiskit.providers.fake_provider.FakeAlmadenV2.backend_name" attributeValue="'fake_almaden_v2'" />
  ...
  <Attribute id="qiskit.providers.fake_provider.FakeAlmadenV2.defs_filename" attributeValue="'defs_almaden.json'" />

  ### dirname

  <Attribute id="qiskit.providers.fake_provider.FakeAlmadenV2.dirname" attributeValue="'/home/runner/work/qiskit/qiskit/.tox/docs/lib/python3.8/site-packages/qiskit/providers/fake_provider/backends/almaden'" />
