...
<Class id="qiskit.providers.aer.QasmSimulator" github="https://github.com/qiskit/qiskit-aer/tree/stable/0.10/qiskit/providers/aer/backends/qasm_simulator.py" signature="QasmSimulator(configuration=None, properties=None, provider=None, **backend_options)">
