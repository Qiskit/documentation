---
title: phase_offset (v0.37)
description: API reference for qiskit.pulse.builder.phase_offset in qiskit v0.37
...
<Function id="qiskit.pulse.builder.phase_offset" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.21/qiskit/pulse/builder.py" signature="phase_offset(phase, *channels)">
