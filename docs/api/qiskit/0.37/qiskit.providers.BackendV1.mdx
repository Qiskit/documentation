---
title: BackendV1 (v0.37)
description: API reference for qiskit.providers.BackendV1 in qiskit v0.37
...
<Class id="qiskit.providers.BackendV1" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.21/qiskit/providers/backend.py" signature="BackendV1(configuration, provider=None, **fields)" modifiers="class">
  ...
  **AttributeError** – if input field not a valid options
  ...
  <Function id="qiskit.providers.BackendV1._default_options" signature="_default_options()" modifiers="abstract classmethod">
  ...
  <Function id="qiskit.providers.BackendV1.configuration" signature="BackendV1.configuration()">
  ...
  <Function id="qiskit.providers.BackendV1.name" signature="BackendV1.name()">
  ...
  <Function id="qiskit.providers.BackendV1.properties" signature="BackendV1.properties()">
  ...
  <Function id="qiskit.providers.BackendV1.provider" signature="BackendV1.provider()">
  ...
  <Function id="qiskit.providers.BackendV1.run" signature="BackendV1.run(run_input, **options)" modifiers="abstract">
    Run on the backend.
  ...
  <span id="qiskit-providers-backendv1-set-options" />

  ### set\_options

  <Function id="qiskit.providers.BackendV1.set_options" signature="BackendV1.set_options(**fields)">
  ...
  <Function id="qiskit.providers.BackendV1.status" signature="BackendV1.status()">
