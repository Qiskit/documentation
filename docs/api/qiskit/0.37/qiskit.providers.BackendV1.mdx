...
<Class id="qiskit.providers.BackendV1" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.21/qiskit/providers/backend.py" signature="BackendV1(configuration, provider=None, **fields)">
  ...
  **AttributeError** – if input field not a valid options
  ...
  <Function id="qiskit.providers.BackendV1.configuration" name="configuration" signature="BackendV1.configuration()">
  ...
  <Function id="qiskit.providers.BackendV1.name" name="name" signature="BackendV1.name()">
  ...
  <Function id="qiskit.providers.BackendV1.properties" name="properties" signature="BackendV1.properties()">
  ...
  <Function id="qiskit.providers.BackendV1.provider" name="provider" signature="BackendV1.provider()">
  ...
  <Function id="qiskit.providers.BackendV1.run" name="run" signature="abstract BackendV1.run(run_input, **options)">
    Run on the backend.
  ...
  <Function id="qiskit.providers.BackendV1.set_options" name="set_options" signature="BackendV1.set_options(**fields)">
  ...
  <Function id="qiskit.providers.BackendV1.status" name="status" signature="BackendV1.status()">
