---
title: ShorResult (v0.37)
description: API reference for qiskit.algorithms.ShorResult in qiskit v0.37
...
<Class id="qiskit.algorithms.ShorResult" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.21/qiskit/algorithms/factorizers/shor.py" signature="ShorResult" modifiers="class">
