...
<Function id="qiskit.pulse.builder.align_func" github="https://github.com/qiskit/qiskit/tree/stable/0.21/qiskit/pulse/builder.py" signature="align_func(duration, func)">
