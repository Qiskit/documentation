---
title: DAGCircuit (v0.37)
description: API reference for qiskit.dagcircuit.DAGCircuit in qiskit v0.37
...
<Class id="qiskit.dagcircuit.DAGCircuit" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.21/qiskit/dagcircuit/dagcircuit.py" signature="DAGCircuit" modifiers="class">
  Bases: `object`
