...
<Class id="qiskit.dagcircuit.DAGCircuit" github="https://github.com/qiskit/qiskit/tree/stable/0.21/qiskit/dagcircuit/dagcircuit.py" signature="DAGCircuit">
  Bases: `object`
  ...
  <Function id="qiskit.dagcircuit.DAGCircuit.apply_operation_back" name="apply_operation_back" signature="DAGCircuit.apply_operation_back(op, qargs=(), cargs=())">
