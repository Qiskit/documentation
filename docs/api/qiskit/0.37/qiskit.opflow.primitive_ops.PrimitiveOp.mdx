---
title: PrimitiveOp (v0.37)
description: API reference for qiskit.opflow.primitive_ops.PrimitiveOp in qiskit v0.37
...
<Class id="qiskit.opflow.primitive_ops.PrimitiveOp" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.21/qiskit/opflow/primitive_ops/primitive_op.py" signature="PrimitiveOp(primitive, coeff=1.0)" modifiers="class">
