...
<Class id="qiskit.result.Result" github="https://github.com/qiskit/qiskit/tree/stable/0.21/qiskit/result/result.py" signature="Result(backend_name, backend_version, qobj_id, job_id, success, results, date=None, status=None, header=None, **kwargs)">
  Bases: `object`
  ...
  <Function id="qiskit.result.Result.from_dict" signature="classmethod Result.from_dict(data)">
