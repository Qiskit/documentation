---
title: Result (v0.37)
description: API reference for qiskit.result.Result in qiskit v0.37
...
<Class id="qiskit.result.Result" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.21/qiskit/result/result.py" signature="Result(backend_name, backend_version, qobj_id, job_id, success, results, date=None, status=None, header=None, **kwargs)" modifiers="class">
  Bases: `object`
  ...
  <Function id="qiskit.result.Result.from_dict" signature="Result.from_dict(data)" modifiers="classmethod">
