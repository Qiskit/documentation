---
title: Fake1Q (v0.37)
description: API reference for qiskit.providers.fake_provider.Fake1Q in qiskit v0.37
...
<Class id="qiskit.providers.fake_provider.Fake1Q" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.21/qiskit/providers/fake_provider/fake_1q.py" signature="Fake1Q" modifiers="class">
