...
description: API reference for qiskit.circuit.library.PhaseEstimation in qiskit v0.37
...
<Class id="qiskit.circuit.library.PhaseEstimation" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.21/qiskit/circuit/library/phase_estimation.py" signature="PhaseEstimation(num_evaluation_qubits, unitary, iqft=None, name='QPE')" modifiers="class">
...
$$
  ...
  **Reference Circuit:**
  ...
  <Attribute id="qiskit.circuit.library.PhaseEstimation.instances" attributeValue="87" />
