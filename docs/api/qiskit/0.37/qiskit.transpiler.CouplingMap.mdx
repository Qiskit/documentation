...
<Class id="qiskit.transpiler.CouplingMap" github="https://github.com/qiskit/qiskit/tree/stable/0.21/qiskit/transpiler/coupling.py" signature="CouplingMap(couplinglist=None, description=None)">
  Bases: `object`
