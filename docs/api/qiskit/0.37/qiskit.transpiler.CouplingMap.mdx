---
title: CouplingMap (v0.37)
description: API reference for qiskit.transpiler.CouplingMap in qiskit v0.37
...
<Class id="qiskit.transpiler.CouplingMap" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.21/qiskit/transpiler/coupling.py" signature="CouplingMap(couplinglist=None, description=None)" modifiers="class">
  Bases: `object`
