...
<Class id="qiskit.pulse.library.Drag" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.21/qiskit/pulse/library/symbolic_pulses.py" signature="Drag(duration, amp, sigma, beta, name=None, limit_amplitude=None)">
...
$$
  ...
  *   **limit\_amplitude** (`Optional`\[`bool`]) – If `True`, then limit the amplitude of the waveform to 1. The default is `True` and the amplitude is constrained to 1.
  ...
  <Function id="qiskit.pulse.library.Drag.draw" name="draw" signature="Drag.draw(style=None, backend=None, time_range=None, time_unit='dt', show_waveform_info=True, plotter='mpl2d', axis=None)">
  ...
  <Function id="qiskit.pulse.library.Drag.get_waveform" name="get_waveform" signature="Drag.get_waveform()">
...
$$
  ...
  <Function id="qiskit.pulse.library.Drag.is_parameterized" name="is_parameterized" signature="Drag.is_parameterized()">
  ...
  <Function id="qiskit.pulse.library.Drag.validate_parameters" name="validate_parameters" signature="Drag.validate_parameters()">
    Validate parameters.
  ...
  <Attribute id="qiskit.pulse.library.Drag.constraints" name="constraints">
  ...
  <Attribute id="qiskit.pulse.library.Drag.duration" name="duration" />

  ### envelope

  <Attribute id="qiskit.pulse.library.Drag.envelope" name="envelope">
  ...
  <Attribute id="qiskit.pulse.library.Drag.id" name="id">
  ...
  <Attribute id="qiskit.pulse.library.Drag.limit_amplitude" name="limit_amplitude" attributeValue="True" />

  ### name

  <Attribute id="qiskit.pulse.library.Drag.name" name="name" />

  ### parameters

  <Attribute id="qiskit.pulse.library.Drag.parameters" name="parameters">
    **Return type**
  ...
  <Attribute id="qiskit.pulse.library.Drag.pulse_type" name="pulse_type">
  ...
  <Attribute id="qiskit.pulse.library.Drag.valid_amp_conditions" name="valid_amp_conditions">
