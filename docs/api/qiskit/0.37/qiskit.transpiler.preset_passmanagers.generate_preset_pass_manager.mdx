---
title: generate_preset_pass_manager (v0.37)
description: API reference for qiskit.transpiler.preset_passmanagers.generate_preset_pass_manager in qiskit v0.37
