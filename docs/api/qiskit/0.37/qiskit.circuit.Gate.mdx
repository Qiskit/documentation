---
title: Gate (v0.37)
description: API reference for qiskit.circuit.Gate in qiskit v0.37
...
<Class id="qiskit.circuit.Gate" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.21/qiskit/circuit/gate.py" signature="Gate(name, num_qubits, params, label=None)" modifiers="class">
