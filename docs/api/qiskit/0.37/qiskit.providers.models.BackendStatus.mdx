...
<Class id="qiskit.providers.models.BackendStatus" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.21/qiskit/providers/models/backendstatus.py" signature="BackendStatus(backend_name, backend_version, operational, pending_jobs, status_msg)">
  Bases: `object`
  ...
  **QiskitError** – If the backend version is in an invalid format
  ...
  <Function id="qiskit.providers.models.BackendStatus.from_dict" name="from_dict" signature="classmethod BackendStatus.from_dict(data)">
  ...
  <Function id="qiskit.providers.models.BackendStatus.to_dict" name="to_dict" signature="BackendStatus.to_dict()">
