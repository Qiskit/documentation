---
title: Options (v0.37)
description: API reference for qiskit.providers.Options in qiskit v0.37
...
<Class id="qiskit.providers.Options" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.21/qiskit/providers/options.py" signature="Options(**kwargs)" modifiers="class">
  Bases: `object`
