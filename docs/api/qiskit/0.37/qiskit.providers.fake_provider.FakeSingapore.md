...
`FakeSingapore` [GitHub](https://github.com/qiskit/qiskit/tree/stable/0.21/qiskit/providers/fake_provider/backends/singapore/fake_singapore.py "view source code")
