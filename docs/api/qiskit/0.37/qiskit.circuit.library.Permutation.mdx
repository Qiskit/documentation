---
title: Permutation (v0.37)
description: API reference for qiskit.circuit.library.Permutation in qiskit v0.37
...
<Class id="qiskit.circuit.library.Permutation" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.21/qiskit/circuit/library/generalized_gates/permutation.py" signature="Permutation(num_qubits, pattern=None, seed=None)" modifiers="class">
  ...
  **Reference Circuit:**
  ...
  ![../\_images/qiskit.circuit.library.Permutation\_0\_0.png](/docs/images/api/qiskit/0.37/qiskit.circuit.library.Permutation_0_0.avif)
  ...
  **Expanded Circuit:**
  ...
  <Attribute id="qiskit.circuit.library.Permutation.instances" attributeValue="87" />
