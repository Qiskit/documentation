---
title: dumps (v0.37)
description: API reference for qiskit.qasm3.dumps in qiskit v0.37
...
<Function id="qiskit.qasm3.dumps" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.21/qiskit/qasm3/__init__.py" signature="dumps(circuit, **kwargs)">
