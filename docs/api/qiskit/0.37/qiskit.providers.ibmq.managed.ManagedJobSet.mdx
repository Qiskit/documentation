---
title: ManagedJobSet (v0.37)
description: API reference for qiskit.providers.ibmq.managed.ManagedJobSet in qiskit v0.37
...
<Class id="qiskit.providers.ibmq.managed.ManagedJobSet" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-ibmq-provider/tree/stable/0.19/qiskit/providers/ibmq/managed/managedjobset.py" signature="ManagedJobSet(name=None, short_id=None)" modifiers="class">
  ...
  *   **short\_id** (`Optional`\[`str`]) – Short ID for this set of jobs.
  ...
  <span id="qiskit-providers-ibmq-managed-managedjobset-error-messages" />
  ...
  <span id="qiskit-providers-ibmq-managed-managedjobset-job-set-id" />
  ...
  <span id="qiskit-providers-ibmq-managed-managedjobset-managed-jobs" />
  ...
  <span id="qiskit-providers-ibmq-managed-managedjobset-retrieve-jobs" />
  ...
  <span id="qiskit-providers-ibmq-managed-managedjobset-update-name" />
  ...
  <span id="qiskit-providers-ibmq-managed-managedjobset-update-tags" />
