...
<Class id="qiskit.transpiler.passes.NoiseAdaptiveLayout" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.21/qiskit/transpiler/passes/layout/noise_adaptive_layout.py" signature="NoiseAdaptiveLayout(*args, **kwargs)">
  ...
  **Raises**
  ...
  <Function id="qiskit.transpiler.passes.NoiseAdaptiveLayout.name" name="name" signature="NoiseAdaptiveLayout.name()">
    Return the name of the pass.
  </Function>

  ### run

  <Function id="qiskit.transpiler.passes.NoiseAdaptiveLayout.run" name="run" signature="NoiseAdaptiveLayout.run(dag)">
