---
title: NoiseAdaptiveLayout (v0.37)
description: API reference for qiskit.transpiler.passes.NoiseAdaptiveLayout in qiskit v0.37
...
<Class id="qiskit.transpiler.passes.NoiseAdaptiveLayout" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.21/qiskit/transpiler/passes/layout/noise_adaptive_layout.py" signature="NoiseAdaptiveLayout(*args, **kwargs)" modifiers="class">
