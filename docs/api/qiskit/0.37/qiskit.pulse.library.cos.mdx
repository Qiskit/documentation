...
<Function id="qiskit.pulse.library.cos" github="https://github.com/qiskit/qiskit/tree/stable/0.21/qiskit/pulse/library/discrete.py" signature="cos(duration, amp, freq=None, phase=0, name=None)">
