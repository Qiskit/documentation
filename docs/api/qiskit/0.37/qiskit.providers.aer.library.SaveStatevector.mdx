...
<span id="qiskit.providers.aer.library.SaveStatevector.condition_bits" />
...
<span id="qiskit.providers.aer.library.SaveStatevector.name" />

### name

Return the name.

<span id="qiskit.providers.aer.library.SaveStatevector.num_clbits" />

### num\_clbits

Return the number of clbits.

<span id="qiskit.providers.aer.library.SaveStatevector.num_qubits" />
