...
`Optimize1qGatesSimpleCommutation(*args, **kwargs)` [GitHub](https://github.com/qiskit/qiskit/tree/stable/0.21/qiskit/transpiler/passes/optimization/optimize_1q_commutation.py "view source code")
...
`Optimize1qGatesSimpleCommutation.run(dag)` [GitHub](https://github.com/qiskit/qiskit/tree/stable/0.21/qiskit/transpiler/passes/optimization/optimize_1q_commutation.py "view source code")
