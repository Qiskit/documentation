---
title: eval_observables (v0.37)
description: API reference for qiskit.algorithms.eval_observables in qiskit v0.37
...
<Function id="qiskit.algorithms.eval_observables" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.21/qiskit/algorithms/aux_ops_evaluator.py" signature="eval_observables(quantum_instance, quantum_state, observables, expectation, threshold=1e-12)">
