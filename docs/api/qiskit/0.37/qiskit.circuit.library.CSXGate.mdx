---
title: CSXGate (v0.37)
description: API reference for qiskit.circuit.library.CSXGate in qiskit v0.37
...
<Class id="qiskit.circuit.library.CSXGate" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.21/qiskit/circuit/library/standard_gates/sx.py" signature="CSXGate(label=None, ctrl_state=None)" modifiers="class">
