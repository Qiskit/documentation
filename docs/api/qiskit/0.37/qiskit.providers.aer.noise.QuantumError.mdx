...
<Class id="qiskit.providers.aer.noise.QuantumError" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-aer/tree/stable/0.10/qiskit/providers/aer/noise/errors/quantum_error.py" signature="QuantumError(noise_ops, number_of_qubits=None, standard_gates=None, atol=None)">
  ...
  **NoiseError** – If input noise\_ops is invalid, e.g. it’s not a CPTP map.
  ...
  <Function id="qiskit.providers.aer.noise.QuantumError.compose" name="compose" signature="QuantumError.compose(other, qargs=None, front=False)">
  ...
  <Function id="qiskit.providers.aer.noise.QuantumError.copy" name="copy" signature="QuantumError.copy()">
    Make a copy of current QuantumError.
  </Function>

  ### dot

  <Function id="qiskit.providers.aer.noise.QuantumError.dot" name="dot" signature="QuantumError.dot(other, qargs=None)">
  ...
  <Function id="qiskit.providers.aer.noise.QuantumError.error_term" name="error_term" signature="QuantumError.error_term(position)">
  ...
  <Function id="qiskit.providers.aer.noise.QuantumError.expand" name="expand" signature="QuantumError.expand(other)">
  ...
  <Function id="qiskit.providers.aer.noise.QuantumError.ideal" name="ideal" signature="QuantumError.ideal()">
  ...
  <Function id="qiskit.providers.aer.noise.QuantumError.input_dims" name="input_dims" signature="QuantumError.input_dims(qargs=None)">
    Return tuple of input dimension for specified subsystems.
  </Function>

  ### output\_dims

  <Function id="qiskit.providers.aer.noise.QuantumError.output_dims" name="output_dims" signature="QuantumError.output_dims(qargs=None)">
    Return tuple of output dimension for specified subsystems.
  </Function>

  ### power

  <Function id="qiskit.providers.aer.noise.QuantumError.power" name="power" signature="QuantumError.power(n)">
  ...
  <Function id="qiskit.providers.aer.noise.QuantumError.reshape" name="reshape" signature="QuantumError.reshape(input_dims=None, output_dims=None, num_qubits=None)">
  ...
  <Function id="qiskit.providers.aer.noise.QuantumError.set_atol" name="set_atol" signature="classmethod QuantumError.set_atol(value)">
    Set the class default absolute tolerance parameter for float comparisons.
  </Function>

  ### set\_rtol

  <Function id="qiskit.providers.aer.noise.QuantumError.set_rtol" name="set_rtol" signature="classmethod QuantumError.set_rtol(value)">
    Set the class default relative tolerance parameter for float comparisons.
  </Function>

  ### tensor

  <Function id="qiskit.providers.aer.noise.QuantumError.tensor" name="tensor" signature="QuantumError.tensor(other)">
  ...
  <Function id="qiskit.providers.aer.noise.QuantumError.to_dict" name="to_dict" signature="QuantumError.to_dict()">
    Return the current error as a dictionary.
  </Function>

  ### to\_instruction

  <Function id="qiskit.providers.aer.noise.QuantumError.to_instruction" name="to_instruction" signature="QuantumError.to_instruction()">
    Convert the QuantumError to a circuit Instruction.
  </Function>

  ### to\_quantumchannel

  <Function id="qiskit.providers.aer.noise.QuantumError.to_quantumchannel" name="to_quantumchannel" signature="QuantumError.to_quantumchannel()">
  ...
  <Attribute id="qiskit.providers.aer.noise.QuantumError.atol" name="atol" attributeValue="1e-08" />

  ### circuits

  <Attribute id="qiskit.providers.aer.noise.QuantumError.circuits" name="circuits">
    Return the list of error circuits.
  </Attribute>

  ### dim

  <Attribute id="qiskit.providers.aer.noise.QuantumError.dim" name="dim">
    Return tuple (input\_shape, output\_shape).
  </Attribute>

  ### id

  <Attribute id="qiskit.providers.aer.noise.QuantumError.id" name="id">
    Return unique ID string for error
  </Attribute>

  ### num\_qubits

  <Attribute id="qiskit.providers.aer.noise.QuantumError.num_qubits" name="num_qubits">
    Return the number of qubits if a N-qubit operator or None otherwise.
  </Attribute>

  ### number\_of\_qubits

  <Attribute id="qiskit.providers.aer.noise.QuantumError.number_of_qubits" name="number_of_qubits">
    Return the number of qubits for the error.
  </Attribute>

  ### probabilities

  <Attribute id="qiskit.providers.aer.noise.QuantumError.probabilities" name="probabilities">
    Return the list of error probabilities.
  </Attribute>

  ### qargs

  <Attribute id="qiskit.providers.aer.noise.QuantumError.qargs" name="qargs">
    Return the qargs for the operator.
  </Attribute>

  ### rtol

  <Attribute id="qiskit.providers.aer.noise.QuantumError.rtol" name="rtol" attributeValue="1e-05" />

  ### size

  <Attribute id="qiskit.providers.aer.noise.QuantumError.size" name="size">
