...
<Class id="qiskit.quantum_info.ScalarOp" github="https://github.com/qiskit/qiskit/tree/stable/0.21/qiskit/quantum_info/operators/scalar_op.py" signature="ScalarOp(dims=None, coeff=1)">
