---
title: block_to_schedule (v0.37)
description: API reference for qiskit.pulse.transforms.block_to_schedule in qiskit v0.37
...
<Function id="qiskit.pulse.transforms.block_to_schedule" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.21/qiskit/pulse/transforms/canonicalization.py" signature="block_to_schedule(block)">
