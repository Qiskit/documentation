...
`qiskit.transpiler.passes.HoareOptimizer(*args, **kwargs)` [GitHub](https://github.com/qiskit/qiskit/tree/stable/1.0/qiskit/transpiler/passes/optimization/hoare_opt.py "view source code")
...
<span id="qiskit.transpiler.passes.HoareOptimizer.execute" />
...
<span id="qiskit.transpiler.passes.HoareOptimizer.update_status" />
