...
<Class id="qiskit.primitives.StatevectorEstimator" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/primitives/statevector_estimator.py#L31-L176" signature="qiskit.primitives.StatevectorEstimator(*, default_precision=0.0, seed=None)" modifiers="class">
  ...
  *   **seed** (*np.random.Generator |* [*int*](https://docs.python.org/3/library/functions.html#int) *| None*) – The seed or Generator object for random number generation. If None, a random seeded default RNG will be used.
  ...
  <Attribute id="qiskit.primitives.StatevectorEstimator.default_precision" name="default_precision" headingLevel={3}>
    Return the default precision
  </Attribute>

  <Attribute id="qiskit.primitives.StatevectorEstimator.seed" name="seed" headingLevel={3}>
  ...
  <Function id="qiskit.primitives.StatevectorEstimator.run" github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/primitives/statevector_estimator.py#L136-L145" signature="run(pubs, *, precision=None)">
