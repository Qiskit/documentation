...
<Class id="qiskit.circuit.Parameter" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.14/qiskit/circuit/parameter.py" signature="Parameter(_, uuid=None)">
  ...
  *   **expr** (*sympy.Expr*) – Expression of sympy.Symbols.
  ...
  <Function id="qiskit.circuit.Parameter.__mul__" name="__mul__" signature="Parameter.__mul__(other)" />
