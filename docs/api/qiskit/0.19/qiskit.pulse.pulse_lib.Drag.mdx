...
<Class id="qiskit.pulse.pulse_lib.Drag" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.14/qiskit/pulse/pulse_lib/parametric_pulses.py" signature="Drag(duration, amp, sigma, beta, name=None)">
...
$$
  ...
  *   **name** (`Optional`\[`str`]) – Display name for this pulse envelope.
  ...
  <Attribute id="qiskit.pulse.pulse_lib.Drag.amp" name="amp" signature="complex">
  ...
  <Attribute id="qiskit.pulse.pulse_lib.Drag.beta" name="beta" signature="float">
  ...
  <Attribute id="qiskit.pulse.pulse_lib.Drag.id" name="id" signature="int">
  ...
  <Attribute id="qiskit.pulse.pulse_lib.Drag.parameters" name="parameters" signature="Dict[str, Any]">
  ...
  <Attribute id="qiskit.pulse.pulse_lib.Drag.sigma" name="sigma" signature="float">
  ...
  <Function id="qiskit.pulse.pulse_lib.Drag.__call__" name="__call__" signature="Drag.__call__(channel)">
    Call self as a function.
  </Function>

  ### draw

  <Function id="qiskit.pulse.pulse_lib.Drag.draw" name="draw" signature="Drag.draw(dt=1, style=None, filename=None, interp_method=None, scale=1, interactive=False, scaling=None)">
    Plot the pulse.
  ...
  <Function id="qiskit.pulse.pulse_lib.Drag.get_sample_pulse" name="get_sample_pulse" signature="Drag.get_sample_pulse()">
  ...
  <Function id="qiskit.pulse.pulse_lib.Drag.validate_parameters" name="validate_parameters" signature="Drag.validate_parameters()">
    Validate parameters.
