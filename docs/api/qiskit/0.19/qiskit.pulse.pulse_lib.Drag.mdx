...
$$
  ...
  *   **name** (`Optional`\[`str`]) – Display name for this pulse envelope.
  ...
  <Attribute id="qiskit.pulse.pulse_lib.Drag.amp" signature="complex">
  ...
  <Attribute id="qiskit.pulse.pulse_lib.Drag.beta" signature="float">
  ...
  <Attribute id="qiskit.pulse.pulse_lib.Drag.id" signature="int">
  ...
  <Attribute id="qiskit.pulse.pulse_lib.Drag.parameters" signature="Dict[str, Any]">
  ...
  <Attribute id="qiskit.pulse.pulse_lib.Drag.sigma" signature="float">
