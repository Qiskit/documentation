---
title: Drag (v0.19)
description: API reference for qiskit.pulse.pulse_lib.Drag in qiskit v0.19
...
$$
  ...
  *   **name** (`Optional`\[`str`]) – Display name for this pulse envelope.
  ...
  <span id="drag-validate-parameters" />
