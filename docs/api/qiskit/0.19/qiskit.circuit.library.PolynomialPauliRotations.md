...
<span id="qiskit.circuit.library.PolynomialPauliRotations.AND" />

`PolynomialPauliRotations.AND(qr_variables, qb_target, qr_ancillae, flags=None, mct_mode='no-ancilla')`
...
<span id="qiskit.circuit.library.PolynomialPauliRotations.OR" />

`PolynomialPauliRotations.OR(qr_variables, qb_target, qr_ancillae, flags=None, mct_mode='basic')`
...
`PolynomialPauliRotations.add_register(*regs)`
...
`PolynomialPauliRotations.append(instruction, qargs=None, cargs=None)`
...
`PolynomialPauliRotations.assign_parameters(param_dict, inplace=False)`
...
`PolynomialPauliRotations.barrier(*qargs)`
...
`PolynomialPauliRotations.bind_parameters(value_dict)`
...
`static PolynomialPauliRotations.cast(value, _type)`
...
`PolynomialPauliRotations.cbit_argument_conversion(clbit_representation)`
...
`PolynomialPauliRotations.ccx(control_qubit1, control_qubit2, target_qubit, *, ctl1=None, ctl2=None, tgt=None)`
...
`PolynomialPauliRotations.ch(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)`
...
`classmethod PolynomialPauliRotations.cls_instances()`
...
`classmethod PolynomialPauliRotations.cls_prefix()`
...
`PolynomialPauliRotations.cnot(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)`
...
`PolynomialPauliRotations.combine(rhs)`
...
`PolynomialPauliRotations.compose(other, qubits=None, clbits=None, front=False, inplace=False)`
...
`PolynomialPauliRotations.copy(name=None)`
...
`PolynomialPauliRotations.crx(theta, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)`
...
`PolynomialPauliRotations.cry(theta, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)`
...
`PolynomialPauliRotations.crz(theta, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)`
...
`PolynomialPauliRotations.cswap(control_qubit, target_qubit1, target_qubit2, *, label=None, ctrl_state=None, ctl=None, tgt1=None, tgt2=None)`
...
`PolynomialPauliRotations.cu1(theta, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)`
...
`PolynomialPauliRotations.cu3(theta, phi, lam, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)`
...
`PolynomialPauliRotations.cx(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)`
...
`PolynomialPauliRotations.cy(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)`
...
`PolynomialPauliRotations.cz(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)`
...
`PolynomialPauliRotations.dcx(qubit1, qubit2)`
...
`PolynomialPauliRotations.diag_gate(diag, qubit)`
...
`PolynomialPauliRotations.diagonal(diag, qubit)`
...
`PolynomialPauliRotations.draw(output=None, scale=0.7, filename=None, style=None, interactive=False, line_length=None, plot_barriers=True, reverse_bits=False, justify=None, vertical_compression='medium', idle_wires=True, with_layout=True, fold=None, ax=None, initial_state=False, cregbundle=False)`
...
`PolynomialPauliRotations.extend(rhs)`
...
`PolynomialPauliRotations.fredkin(control_qubit, target_qubit1, target_qubit2, *, ctl=None, tgt1=None, tgt2=None)`
...
`static PolynomialPauliRotations.from_qasm_file(path)`
...
`static PolynomialPauliRotations.from_qasm_str(qasm_str)`
...
`PolynomialPauliRotations.h(qubit, *, q=None)`
...
`PolynomialPauliRotations.hamiltonian(operator, time, qubits, label=None)`
...
`PolynomialPauliRotations.has_register(register)`
...
`PolynomialPauliRotations.id(qubit, *, q=None)`

Apply [`IGate`](qiskit.circuit.library.IGate "qiskit.circuit.library.IGate").

### iden

<span id="qiskit.circuit.library.PolynomialPauliRotations.iden" />

`PolynomialPauliRotations.iden(qubit, *, q=None)`
...
`PolynomialPauliRotations.initialize(params, qubits)`
...
`PolynomialPauliRotations.iso(isometry, q_input, q_ancillas_for_output, q_ancillas_zero=None, q_ancillas_dirty=None)`
...
`PolynomialPauliRotations.isometry(isometry, q_input, q_ancillas_for_output, q_ancillas_zero=None, q_ancillas_dirty=None)`
...
`PolynomialPauliRotations.iswap(qubit1, qubit2)`
...
`PolynomialPauliRotations.mcmt(gate, control_qubits, target_qubits, ancilla_qubits=None, mode='no-ancilla', *, single_control_gate_fun=None, q_controls=None, q_ancillae=None, q_targets=None)`
...
`PolynomialPauliRotations.mcrx(theta, q_controls, q_target, use_basis_gates=False)`
...
`PolynomialPauliRotations.mcry(theta, q_controls, q_target, q_ancillae, mode='basic', use_basis_gates=False)`
...
`PolynomialPauliRotations.mcrz(lam, q_controls, q_target, use_basis_gates=False)`
...
`PolynomialPauliRotations.mct(control_qubits, target_qubit, ancilla_qubits=None, mode='noancilla')`
...
`PolynomialPauliRotations.mcu1(lam, control_qubits, target_qubit)`
...
`PolynomialPauliRotations.mcx(control_qubits, target_qubit, ancilla_qubits=None, mode='noancilla')`
...
`PolynomialPauliRotations.measure_active(inplace=True)`
...
`PolynomialPauliRotations.num_connected_components(unitary_only=False)`
...
`PolynomialPauliRotations.qasm(formatted=False, filename=None)`
...
`PolynomialPauliRotations.qbit_argument_conversion(qubit_representation)`
...
`PolynomialPauliRotations.r(theta, phi, qubit, *, q=None)`
...
`PolynomialPauliRotations.rcccx(control_qubit1, control_qubit2, control_qubit3, target_qubit)`
...
`PolynomialPauliRotations.rccx(control_qubit1, control_qubit2, target_qubit)`
...
`PolynomialPauliRotations.remove_final_measurements(inplace=True)`
...
`PolynomialPauliRotations.reset(qubit)`
...
`PolynomialPauliRotations.rx(theta, qubit, *, label=None, q=None)`
...
`PolynomialPauliRotations.rxx(theta, qubit1, qubit2)`
...
`PolynomialPauliRotations.ry(theta, qubit, *, label=None, q=None)`
...
`PolynomialPauliRotations.ryy(theta, qubit1, qubit2)`
...
`PolynomialPauliRotations.rz(phi, qubit, *, q=None)`
...
`PolynomialPauliRotations.rzx(theta, qubit1, qubit2)`
...
`PolynomialPauliRotations.rzz(theta, qubit1, qubit2)`
...
`PolynomialPauliRotations.s(qubit, *, q=None)`
...
`PolynomialPauliRotations.sdg(qubit, *, q=None)`
...
`PolynomialPauliRotations.snapshot(label, snapshot_type='statevector', qubits=None, params=None)`
...
`PolynomialPauliRotations.snapshot_density_matrix(label, qubits=None)`
...
`PolynomialPauliRotations.snapshot_expectation_value(label, op, qubits, single_shot=False, variance=False)`
...
`PolynomialPauliRotations.snapshot_probabilities(label, qubits, variance=False)`
...
`PolynomialPauliRotations.snapshot_stabilizer(label)`
...
`PolynomialPauliRotations.snapshot_statevector(label)`
...
`PolynomialPauliRotations.swap(qubit1, qubit2)`
...
`PolynomialPauliRotations.t(qubit, *, q=None)`
...
`PolynomialPauliRotations.tdg(qubit, *, q=None)`
...
`PolynomialPauliRotations.to_gate(parameter_map=None)`
...
`PolynomialPauliRotations.to_instruction(parameter_map=None)`
...
`PolynomialPauliRotations.toffoli(control_qubit1, control_qubit2, target_qubit, *, ctl1=None, ctl2=None, tgt=None)`
...
`PolynomialPauliRotations.u1(theta, qubit, *, q=None)`
...
`PolynomialPauliRotations.u2(phi, lam, qubit, *, q=None)`
...
`PolynomialPauliRotations.u3(theta, phi, lam, qubit, *, q=None)`
...
`PolynomialPauliRotations.uc(gate_list, q_controls, q_target, up_to_diagonal=False)`
...
<span id="qiskit.circuit.library.PolynomialPauliRotations.ucg" />

`PolynomialPauliRotations.ucg(angle_list, q_controls, q_target, up_to_diagonal=False)`
...
`PolynomialPauliRotations.ucrx(angle_list, q_controls, q_target)`
...
`PolynomialPauliRotations.ucry(angle_list, q_controls, q_target)`
...
`PolynomialPauliRotations.ucrz(angle_list, q_controls, q_target)`
...
<span id="qiskit.circuit.library.PolynomialPauliRotations.ucx" />

`PolynomialPauliRotations.ucx(angle_list, q_controls, q_target)`

Deprecated version of ucrx.

### ucy

<span id="qiskit.circuit.library.PolynomialPauliRotations.ucy" />

`PolynomialPauliRotations.ucy(angle_list, q_controls, q_target)`

Deprecated version of ucry.

### ucz

<span id="qiskit.circuit.library.PolynomialPauliRotations.ucz" />

`PolynomialPauliRotations.ucz(angle_list, q_controls, q_target)`
...
`PolynomialPauliRotations.unitary(obj, qubits, label=None)`
...
`PolynomialPauliRotations.x(qubit, *, label=None, ctrl_state=None, q=None)`
...
`PolynomialPauliRotations.y(qubit, *, q=None)`
...
`PolynomialPauliRotations.z(qubit, *, q=None)`
