...
<Class id="qiskit.aqua.algorithms.DeutschJozsa" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.7/qiskit/aqua/algorithms/education/deutsch_jozsa.py" signature="DeutschJozsa(oracle, quantum_instance=None)">
  ...
  *   **quantum\_instance** (`Union`\[[`QuantumInstance`](qiskit.aqua.QuantumInstance "qiskit.aqua.quantum_instance.QuantumInstance"), [`BaseBackend`](qiskit.providers.BaseBackend "qiskit.providers.basebackend.BaseBackend"), `None`]) – Quantum Instance or Backend
  ...
  <Attribute id="qiskit.aqua.algorithms.DeutschJozsa.backend" name="backend" signature="qiskit.providers.basebackend.BaseBackend">
    Returns backend.
  ...
  <Attribute id="qiskit.aqua.algorithms.DeutschJozsa.quantum_instance" name="quantum_instance" signature="Union[None, qiskit.aqua.quantum_instance.QuantumInstance]">
  ...
  <Attribute id="qiskit.aqua.algorithms.DeutschJozsa.random" name="random">
  ...
  <Function id="qiskit.aqua.algorithms.DeutschJozsa.construct_circuit" name="construct_circuit" signature="DeutschJozsa.construct_circuit(measurement=False)">
  ...
  <Function id="qiskit.aqua.algorithms.DeutschJozsa.run" name="run" signature="DeutschJozsa.run(quantum_instance=None, **kwargs)">
  ...
  <Function id="qiskit.aqua.algorithms.DeutschJozsa.set_backend" name="set_backend" signature="DeutschJozsa.set_backend(backend, **kwargs)">
