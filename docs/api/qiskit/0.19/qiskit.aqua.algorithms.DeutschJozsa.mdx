---
title: DeutschJozsa (v0.19)
description: API reference for qiskit.aqua.algorithms.DeutschJozsa in qiskit v0.19
...
<Class id="qiskit.aqua.algorithms.DeutschJozsa" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.7/qiskit/aqua/algorithms/education/deutsch_jozsa.py" signature="DeutschJozsa(oracle, quantum_instance=None)" modifiers="class">
  ...
  *   **quantum\_instance** (`Union`\[[`QuantumInstance`](qiskit.aqua.QuantumInstance "qiskit.aqua.quantum_instance.QuantumInstance"), [`BaseBackend`](qiskit.providers.BaseBackend "qiskit.providers.basebackend.BaseBackend"), `None`]) – Quantum Instance or Backend
  ...
  <span id="deutschjozsa-quantum-instance" />
  ...
  <span id="deutschjozsa-construct-circuit" />
  ...
  <span id="deutschjozsa-set-backend" />
