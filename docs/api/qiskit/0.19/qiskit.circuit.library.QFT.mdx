...
<Class id="qiskit.circuit.library.QFT" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.14/qiskit/circuit/library/basis_change/qft.py" signature="QFT(num_qubits=None, approximation_degree=0, do_swaps=True, inverse=False, insert_barriers=False, name='qft')">
...
$$
  ...
  *   **name** (`str`) – The name of the circuit.
  ...
  <Attribute id="qiskit.circuit.library.QFT.approximation_degree" name="approximation_degree" signature="int">
  ...
  <Attribute id="qiskit.circuit.library.QFT.do_swaps" name="do_swaps" signature="bool">
  ...
  <Attribute id="qiskit.circuit.library.QFT.extension_lib" signature="= 'include \&#x22;qelib1.inc\&#x22;;'" />

  ### header

  <Attribute id="qiskit.circuit.library.QFT.header" signature="= 'OPENQASM 2.0;'" />

  ### insert\_barriers

  <Attribute id="qiskit.circuit.library.QFT.insert_barriers" name="insert_barriers" signature="bool">
  ...
  <Attribute id="qiskit.circuit.library.QFT.instances" signature="= 8" />

  ### n\_qubits

  <Attribute id="qiskit.circuit.library.QFT.n_qubits" name="n_qubits">
  ...
  <Attribute id="qiskit.circuit.library.QFT.num_qubits" name="num_qubits" signature="int">
  ...
  <Attribute id="qiskit.circuit.library.QFT.prefix" signature="= 'circuit'" />
  ...
  <Function id="qiskit.circuit.library.QFT.AND" name="AND" signature="QFT.AND(qr_variables, qb_target, qr_ancillae, flags=None, mct_mode='no-ancilla')">
  ...
  <Function id="qiskit.circuit.library.QFT.OR" name="OR" signature="QFT.OR(qr_variables, qb_target, qr_ancillae, flags=None, mct_mode='basic')">
  ...
  <Function id="qiskit.circuit.library.QFT.__getitem__" name="__getitem__" signature="QFT.__getitem__(item)">
    Return indexed operation.
  </Function>

  ### \_\_len\_\_

  <Function id="qiskit.circuit.library.QFT.__len__" name="__len__" signature="QFT.__len__()">
    Return number of operations in circuit.
  </Function>

  ### add\_register

  <Function id="qiskit.circuit.library.QFT.add_register" name="add_register" signature="QFT.add_register(*regs)">
    Add registers.
  </Function>

  ### append

  <Function id="qiskit.circuit.library.QFT.append" name="append" signature="QFT.append(instruction, qargs=None, cargs=None)">
  ...
  <Function id="qiskit.circuit.library.QFT.assign_parameters" name="assign_parameters" signature="QFT.assign_parameters(param_dict, inplace=False)">
  ...
  <Function id="qiskit.circuit.library.QFT.barrier" name="barrier" signature="QFT.barrier(*qargs)">
    Apply `Barrier`. If qargs is None, applies to all.
  </Function>

  ### bind\_parameters

  <Function id="qiskit.circuit.library.QFT.bind_parameters" name="bind_parameters" signature="QFT.bind_parameters(value_dict)">
  ...
  <Function id="qiskit.circuit.library.QFT.cast" name="cast" signature="static QFT.cast(value, _type)">
    Best effort to cast value to type. Otherwise, returns the value.
  </Function>

  ### cbit\_argument\_conversion

  <Function id="qiskit.circuit.library.QFT.cbit_argument_conversion" name="cbit_argument_conversion" signature="QFT.cbit_argument_conversion(clbit_representation)">
  ...
  <Function id="qiskit.circuit.library.QFT.ccx" name="ccx" signature="QFT.ccx(control_qubit1, control_qubit2, target_qubit, *, ctl1=None, ctl2=None, tgt=None)">
    Apply [`CCXGate`](qiskit.circuit.library.CCXGate "qiskit.circuit.library.CCXGate").
  </Function>

  ### ch

  <Function id="qiskit.circuit.library.QFT.ch" name="ch" signature="QFT.ch(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CHGate`](qiskit.circuit.library.CHGate "qiskit.circuit.library.CHGate").
  </Function>

  ### cls\_instances

  <Function id="qiskit.circuit.library.QFT.cls_instances" name="cls_instances" signature="classmethod QFT.cls_instances()">
    Return the current number of instances of this class, useful for auto naming.
  </Function>

  ### cls\_prefix

  <Function id="qiskit.circuit.library.QFT.cls_prefix" name="cls_prefix" signature="classmethod QFT.cls_prefix()">
    Return the prefix to use for auto naming.
  </Function>

  ### cnot

  <Function id="qiskit.circuit.library.QFT.cnot" name="cnot" signature="QFT.cnot(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CXGate`](qiskit.circuit.library.CXGate "qiskit.circuit.library.CXGate").
  </Function>

  ### combine

  <Function id="qiskit.circuit.library.QFT.combine" name="combine" signature="QFT.combine(rhs)">
  ...
  <Function id="qiskit.circuit.library.QFT.compose" name="compose" signature="QFT.compose(other, qubits=None, clbits=None, front=False, inplace=False)">
  ...
  <Function id="qiskit.circuit.library.QFT.copy" name="copy" signature="QFT.copy(name=None)">
    Copy the circuit.
  ...
  <Function id="qiskit.circuit.library.QFT.count_ops" name="count_ops" signature="QFT.count_ops()">
  ...
  <Function id="qiskit.circuit.library.QFT.crx" name="crx" signature="QFT.crx(theta, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CRXGate`](qiskit.circuit.library.CRXGate "qiskit.circuit.library.CRXGate").
  </Function>

  ### cry

  <Function id="qiskit.circuit.library.QFT.cry" name="cry" signature="QFT.cry(theta, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CRYGate`](qiskit.circuit.library.CRYGate "qiskit.circuit.library.CRYGate").
  </Function>

  ### crz

  <Function id="qiskit.circuit.library.QFT.crz" name="crz" signature="QFT.crz(theta, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CRZGate`](qiskit.circuit.library.CRZGate "qiskit.circuit.library.CRZGate").
  </Function>

  ### cswap

  <Function id="qiskit.circuit.library.QFT.cswap" name="cswap" signature="QFT.cswap(control_qubit, target_qubit1, target_qubit2, *, label=None, ctrl_state=None, ctl=None, tgt1=None, tgt2=None)">
    Apply [`CSwapGate`](qiskit.circuit.library.CSwapGate "qiskit.circuit.library.CSwapGate").
  </Function>

  ### cu1

  <Function id="qiskit.circuit.library.QFT.cu1" name="cu1" signature="QFT.cu1(theta, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CU1Gate`](qiskit.circuit.library.CU1Gate "qiskit.circuit.library.CU1Gate").
  </Function>

  ### cu3

  <Function id="qiskit.circuit.library.QFT.cu3" name="cu3" signature="QFT.cu3(theta, phi, lam, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CU3Gate`](qiskit.circuit.library.CU3Gate "qiskit.circuit.library.CU3Gate").
  </Function>

  ### cx

  <Function id="qiskit.circuit.library.QFT.cx" name="cx" signature="QFT.cx(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CXGate`](qiskit.circuit.library.CXGate "qiskit.circuit.library.CXGate").
  </Function>

  ### cy

  <Function id="qiskit.circuit.library.QFT.cy" name="cy" signature="QFT.cy(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CYGate`](qiskit.circuit.library.CYGate "qiskit.circuit.library.CYGate").
  </Function>

  ### cz

  <Function id="qiskit.circuit.library.QFT.cz" name="cz" signature="QFT.cz(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CZGate`](qiskit.circuit.library.CZGate "qiskit.circuit.library.CZGate").
  </Function>

  ### dcx

  <Function id="qiskit.circuit.library.QFT.dcx" name="dcx" signature="QFT.dcx(qubit1, qubit2)">
    Apply [`DCXGate`](qiskit.circuit.library.DCXGate "qiskit.circuit.library.DCXGate").
  </Function>

  ### decompose

  <Function id="qiskit.circuit.library.QFT.decompose" name="decompose" signature="QFT.decompose()">
  ...
  <Function id="qiskit.circuit.library.QFT.depth" name="depth" signature="QFT.depth()">
  ...
  <Function id="qiskit.circuit.library.QFT.diag_gate" name="diag_gate" signature="QFT.diag_gate(diag, qubit)">
    Deprecated version of QuantumCircuit.diagonal.
  </Function>

  ### diagonal

  <Function id="qiskit.circuit.library.QFT.diagonal" name="diagonal" signature="QFT.diagonal(diag, qubit)">
  ...
  <Function id="qiskit.circuit.library.QFT.extend" name="extend" signature="QFT.extend(rhs)">
  ...
  <Function id="qiskit.circuit.library.QFT.fredkin" name="fredkin" signature="QFT.fredkin(control_qubit, target_qubit1, target_qubit2, *, ctl=None, tgt1=None, tgt2=None)">
    Apply [`CSwapGate`](qiskit.circuit.library.CSwapGate "qiskit.circuit.library.CSwapGate").
  </Function>

  ### from\_qasm\_file

  <Function id="qiskit.circuit.library.QFT.from_qasm_file" name="from_qasm_file" signature="static QFT.from_qasm_file(path)">
  ...
  <Function id="qiskit.circuit.library.QFT.from_qasm_str" name="from_qasm_str" signature="static QFT.from_qasm_str(qasm_str)">
  ...
  <Function id="qiskit.circuit.library.QFT.h" name="h" signature="QFT.h(qubit, *, q=None)">
    Apply [`HGate`](qiskit.circuit.library.HGate "qiskit.circuit.library.HGate").
  </Function>

  ### hamiltonian

  <Function id="qiskit.circuit.library.QFT.hamiltonian" name="hamiltonian" signature="QFT.hamiltonian(operator, time, qubits, label=None)">
    Apply hamiltonian evolution to to qubits.
  </Function>

  ### has\_register

  <Function id="qiskit.circuit.library.QFT.has_register" name="has_register" signature="QFT.has_register(register)">
  ...
  <Function id="qiskit.circuit.library.QFT.i" name="i" signature="QFT.i(qubit, *, q=None)">
    Apply [`IGate`](qiskit.circuit.library.IGate "qiskit.circuit.library.IGate").
  </Function>

  ### id

  <Function id="qiskit.circuit.library.QFT.id" name="id" signature="QFT.id(qubit, *, q=None)">
    Apply [`IGate`](qiskit.circuit.library.IGate "qiskit.circuit.library.IGate").
  </Function>

  ### iden

  <Function id="qiskit.circuit.library.QFT.iden" name="iden" signature="QFT.iden(qubit, *, q=None)">
    Deprecated identity gate.
  </Function>

  ### initialize

  <Function id="qiskit.circuit.library.QFT.initialize" name="initialize" signature="QFT.initialize(params, qubits)">
  ...
  <Function id="qiskit.circuit.library.QFT.iso" name="iso" signature="QFT.iso(isometry, q_input, q_ancillas_for_output, q_ancillas_zero=None, q_ancillas_dirty=None)">
  ...
  <Function id="qiskit.circuit.library.QFT.isometry" name="isometry" signature="QFT.isometry(isometry, q_input, q_ancillas_for_output, q_ancillas_zero=None, q_ancillas_dirty=None)">
    Attach an arbitrary isometry from m to n qubits to a circuit. In particular, this allows to attach arbitrary unitaries on n qubits (m=n) or to prepare any state on n qubits (m=0). The decomposition used here was introduced by Iten et al. in [https://arxiv.org/abs/1501.06911](https://arxiv.org/abs/1501.06911).
  ...
  <Function id="qiskit.circuit.library.QFT.iswap" name="iswap" signature="QFT.iswap(qubit1, qubit2)">
    Apply [`iSwapGate`](qiskit.circuit.library.iSwapGate "qiskit.circuit.library.iSwapGate").
  </Function>

  ### mcmt

  <Function id="qiskit.circuit.library.QFT.mcmt" name="mcmt" signature="QFT.mcmt(gate, control_qubits, target_qubits, ancilla_qubits=None, mode='no-ancilla', *, single_control_gate_fun=None, q_controls=None, q_ancillae=None, q_targets=None)">
  ...
  <Function id="qiskit.circuit.library.QFT.mcrx" name="mcrx" signature="QFT.mcrx(theta, q_controls, q_target, use_basis_gates=False)">
  ...
  <Function id="qiskit.circuit.library.QFT.mcry" name="mcry" signature="QFT.mcry(theta, q_controls, q_target, q_ancillae, mode='basic', use_basis_gates=False)">
  ...
  <Function id="qiskit.circuit.library.QFT.mcrz" name="mcrz" signature="QFT.mcrz(lam, q_controls, q_target, use_basis_gates=False)">
  ...
  <Function id="qiskit.circuit.library.QFT.mct" name="mct" signature="QFT.mct(control_qubits, target_qubit, ancilla_qubits=None, mode='noancilla')">
    Apply `MCXGate`.
  </Function>

  ### mcu1

  <Function id="qiskit.circuit.library.QFT.mcu1" name="mcu1" signature="QFT.mcu1(lam, control_qubits, target_qubit)">
    Apply `MCU1Gate`.
  </Function>

  ### mcx

  <Function id="qiskit.circuit.library.QFT.mcx" name="mcx" signature="QFT.mcx(control_qubits, target_qubit, ancilla_qubits=None, mode='noancilla')">
    Apply `MCXGate`.
  ...
  <Function id="qiskit.circuit.library.QFT.measure" name="measure" signature="QFT.measure(qubit, cbit)">
  ...
  <Function id="qiskit.circuit.library.QFT.measure_active" name="measure_active" signature="QFT.measure_active(inplace=True)">
  ...
  <Function id="qiskit.circuit.library.QFT.measure_all" name="measure_all" signature="QFT.measure_all(inplace=True)">
  ...
  <Function id="qiskit.circuit.library.QFT.mirror" name="mirror" signature="QFT.mirror()">
  ...
  <Function id="qiskit.circuit.library.QFT.ms" name="ms" signature="QFT.ms(theta, qubits)">
    Apply [`MSGate`](qiskit.circuit.library.MSGate "qiskit.circuit.library.MSGate").
  </Function>

  ### num\_connected\_components

  <Function id="qiskit.circuit.library.QFT.num_connected_components" name="num_connected_components" signature="QFT.num_connected_components(unitary_only=False)">
  ...
  <Function id="qiskit.circuit.library.QFT.num_nonlocal_gates" name="num_nonlocal_gates" signature="QFT.num_nonlocal_gates()">
  ...
  <Function id="qiskit.circuit.library.QFT.num_tensor_factors" name="num_tensor_factors" signature="QFT.num_tensor_factors()">
  ...
  <Function id="qiskit.circuit.library.QFT.num_unitary_factors" name="num_unitary_factors" signature="QFT.num_unitary_factors()">
    Computes the number of tensor factors in the unitary (quantum) part of the circuit only.
  </Function>

  ### qasm

  <Function id="qiskit.circuit.library.QFT.qasm" name="qasm" signature="QFT.qasm(formatted=False, filename=None)">
  ...
  <Function id="qiskit.circuit.library.QFT.qbit_argument_conversion" name="qbit_argument_conversion" signature="QFT.qbit_argument_conversion(qubit_representation)">
  ...
  <Function id="qiskit.circuit.library.QFT.r" name="r" signature="QFT.r(theta, phi, qubit, *, q=None)">
    Apply `RGate`.
  </Function>

  ### rcccx

  <Function id="qiskit.circuit.library.QFT.rcccx" name="rcccx" signature="QFT.rcccx(control_qubit1, control_qubit2, control_qubit3, target_qubit)">
    Apply [`RC3XGate`](qiskit.circuit.library.RC3XGate "qiskit.circuit.library.RC3XGate").
  </Function>

  ### rccx

  <Function id="qiskit.circuit.library.QFT.rccx" name="rccx" signature="QFT.rccx(control_qubit1, control_qubit2, target_qubit)">
    Apply [`RCCXGate`](qiskit.circuit.library.RCCXGate "qiskit.circuit.library.RCCXGate").
  </Function>

  ### remove\_final\_measurements

  <Function id="qiskit.circuit.library.QFT.remove_final_measurements" name="remove_final_measurements" signature="QFT.remove_final_measurements(inplace=True)">
  ...
  <Function id="qiskit.circuit.library.QFT.reset" name="reset" signature="QFT.reset(qubit)">
    Reset q.
  </Function>

  ### rx

  <Function id="qiskit.circuit.library.QFT.rx" name="rx" signature="QFT.rx(theta, qubit, *, label=None, q=None)">
    Apply [`RXGate`](qiskit.circuit.library.RXGate "qiskit.circuit.library.RXGate").
  </Function>

  ### rxx

  <Function id="qiskit.circuit.library.QFT.rxx" name="rxx" signature="QFT.rxx(theta, qubit1, qubit2)">
    Apply [`RXXGate`](qiskit.circuit.library.RXXGate "qiskit.circuit.library.RXXGate").
  </Function>

  ### ry

  <Function id="qiskit.circuit.library.QFT.ry" name="ry" signature="QFT.ry(theta, qubit, *, label=None, q=None)">
    Apply [`RYGate`](qiskit.circuit.library.RYGate "qiskit.circuit.library.RYGate").
  </Function>

  ### ryy

  <Function id="qiskit.circuit.library.QFT.ryy" name="ryy" signature="QFT.ryy(theta, qubit1, qubit2)">
    Apply [`RYYGate`](qiskit.circuit.library.RYYGate "qiskit.circuit.library.RYYGate").
  </Function>

  ### rz

  <Function id="qiskit.circuit.library.QFT.rz" name="rz" signature="QFT.rz(phi, qubit, *, q=None)">
    Apply [`RZGate`](qiskit.circuit.library.RZGate "qiskit.circuit.library.RZGate").
  </Function>

  ### rzx

  <Function id="qiskit.circuit.library.QFT.rzx" name="rzx" signature="QFT.rzx(theta, qubit1, qubit2)">
    Apply [`RZXGate`](qiskit.circuit.library.RZXGate "qiskit.circuit.library.RZXGate").
  </Function>

  ### rzz

  <Function id="qiskit.circuit.library.QFT.rzz" name="rzz" signature="QFT.rzz(theta, qubit1, qubit2)">
    Apply [`RZZGate`](qiskit.circuit.library.RZZGate "qiskit.circuit.library.RZZGate").
  </Function>

  ### s

  <Function id="qiskit.circuit.library.QFT.s" name="s" signature="QFT.s(qubit, *, q=None)">
    Apply [`SGate`](qiskit.circuit.library.SGate "qiskit.circuit.library.SGate").
  </Function>

  ### sdg

  <Function id="qiskit.circuit.library.QFT.sdg" name="sdg" signature="QFT.sdg(qubit, *, q=None)">
    Apply [`SdgGate`](qiskit.circuit.library.SdgGate "qiskit.circuit.library.SdgGate").
  </Function>

  ### size

  <Function id="qiskit.circuit.library.QFT.size" name="size" signature="QFT.size()">
  ...
  <Function id="qiskit.circuit.library.QFT.snapshot" name="snapshot" signature="QFT.snapshot(label, snapshot_type='statevector', qubits=None, params=None)">
  ...
  <Function id="qiskit.circuit.library.QFT.snapshot_density_matrix" name="snapshot_density_matrix" signature="QFT.snapshot_density_matrix(label, qubits=None)">
  ...
  <Function id="qiskit.circuit.library.QFT.snapshot_expectation_value" name="snapshot_expectation_value" signature="QFT.snapshot_expectation_value(label, op, qubits, single_shot=False, variance=False)">
  ...
  <Function id="qiskit.circuit.library.QFT.snapshot_probabilities" name="snapshot_probabilities" signature="QFT.snapshot_probabilities(label, qubits, variance=False)">
  ...
  <Function id="qiskit.circuit.library.QFT.snapshot_stabilizer" name="snapshot_stabilizer" signature="QFT.snapshot_stabilizer(label)">
  ...
  <Function id="qiskit.circuit.library.QFT.snapshot_statevector" name="snapshot_statevector" signature="QFT.snapshot_statevector(label)">
  ...
  <Function id="qiskit.circuit.library.QFT.squ" name="squ" signature="QFT.squ(unitary_matrix, qubit, mode='ZYZ', up_to_diagonal=False, *, u=None)">
  ...
  <Function id="qiskit.circuit.library.QFT.swap" name="swap" signature="QFT.swap(qubit1, qubit2)">
    Apply [`SwapGate`](qiskit.circuit.library.SwapGate "qiskit.circuit.library.SwapGate").
  </Function>

  ### t

  <Function id="qiskit.circuit.library.QFT.t" name="t" signature="QFT.t(qubit, *, q=None)">
    Apply [`TGate`](qiskit.circuit.library.TGate "qiskit.circuit.library.TGate").
  </Function>

  ### tdg

  <Function id="qiskit.circuit.library.QFT.tdg" name="tdg" signature="QFT.tdg(qubit, *, q=None)">
    Apply [`TdgGate`](qiskit.circuit.library.TdgGate "qiskit.circuit.library.TdgGate").
  </Function>

  ### to\_gate

  <Function id="qiskit.circuit.library.QFT.to_gate" name="to_gate" signature="QFT.to_gate(parameter_map=None)">
  ...
  <Function id="qiskit.circuit.library.QFT.to_instruction" name="to_instruction" signature="QFT.to_instruction(parameter_map=None)">
  ...
  <Function id="qiskit.circuit.library.QFT.toffoli" name="toffoli" signature="QFT.toffoli(control_qubit1, control_qubit2, target_qubit, *, ctl1=None, ctl2=None, tgt=None)">
    Apply [`CCXGate`](qiskit.circuit.library.CCXGate "qiskit.circuit.library.CCXGate").
  </Function>

  ### u1

  <Function id="qiskit.circuit.library.QFT.u1" name="u1" signature="QFT.u1(theta, qubit, *, q=None)">
    Apply [`U1Gate`](qiskit.circuit.library.U1Gate "qiskit.circuit.library.U1Gate").
  </Function>

  ### u2

  <Function id="qiskit.circuit.library.QFT.u2" name="u2" signature="QFT.u2(phi, lam, qubit, *, q=None)">
    Apply [`U2Gate`](qiskit.circuit.library.U2Gate "qiskit.circuit.library.U2Gate").
  </Function>

  ### u3

  <Function id="qiskit.circuit.library.QFT.u3" name="u3" signature="QFT.u3(theta, phi, lam, qubit, *, q=None)">
    Apply [`U3Gate`](qiskit.circuit.library.U3Gate "qiskit.circuit.library.U3Gate").
  </Function>

  ### uc

  <Function id="qiskit.circuit.library.QFT.uc" name="uc" signature="QFT.uc(gate_list, q_controls, q_target, up_to_diagonal=False)">
  ...
  <Function id="qiskit.circuit.library.QFT.ucg" name="ucg" signature="QFT.ucg(angle_list, q_controls, q_target, up_to_diagonal=False)">
    Deprecated version of uc.
  </Function>

  ### ucrx

  <Function id="qiskit.circuit.library.QFT.ucrx" name="ucrx" signature="QFT.ucrx(angle_list, q_controls, q_target)">
  ...
  <Function id="qiskit.circuit.library.QFT.ucry" name="ucry" signature="QFT.ucry(angle_list, q_controls, q_target)">
  ...
  <Function id="qiskit.circuit.library.QFT.ucrz" name="ucrz" signature="QFT.ucrz(angle_list, q_controls, q_target)">
  ...
  <Function id="qiskit.circuit.library.QFT.ucx" name="ucx" signature="QFT.ucx(angle_list, q_controls, q_target)">
    Deprecated version of ucrx.
  </Function>

  ### ucy

  <Function id="qiskit.circuit.library.QFT.ucy" name="ucy" signature="QFT.ucy(angle_list, q_controls, q_target)">
    Deprecated version of ucry.
  </Function>

  ### ucz

  <Function id="qiskit.circuit.library.QFT.ucz" name="ucz" signature="QFT.ucz(angle_list, q_controls, q_target)">
    Deprecated version of ucrz.
  </Function>

  ### unitary

  <Function id="qiskit.circuit.library.QFT.unitary" name="unitary" signature="QFT.unitary(obj, qubits, label=None)">
    Apply unitary gate to q.
  </Function>

  ### width

  <Function id="qiskit.circuit.library.QFT.width" name="width" signature="QFT.width()">
  ...
  <Function id="qiskit.circuit.library.QFT.x" name="x" signature="QFT.x(qubit, *, label=None, ctrl_state=None, q=None)">
    Apply [`XGate`](qiskit.circuit.library.XGate "qiskit.circuit.library.XGate").
  </Function>

  ### y

  <Function id="qiskit.circuit.library.QFT.y" name="y" signature="QFT.y(qubit, *, q=None)">
    Apply [`YGate`](qiskit.circuit.library.YGate "qiskit.circuit.library.YGate").
  </Function>

  ### z

  <Function id="qiskit.circuit.library.QFT.z" name="z" signature="QFT.z(qubit, *, q=None)">
