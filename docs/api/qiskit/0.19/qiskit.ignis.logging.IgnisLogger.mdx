---
title: IgnisLogger (v0.19)
description: API reference for qiskit.ignis.logging.IgnisLogger in qiskit v0.19
...
<Class id="qiskit.ignis.logging.IgnisLogger" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-ignis/tree/stable/0.3/qiskit/ignis/logging/ignis_logging.py" signature="IgnisLogger(name, level=0)" modifiers="class">
  ...
  *   **level** (*logging.NOTSET*) – Verbosity level (use logging package enums)
  ...
  <span id="ignislogger-addhandler" />
  ...
  <span id="ignislogger-callhandlers" />
  ...
  <span id="ignislogger-disable-file-logging" />
  ...
  <span id="ignislogger-enable-file-logging" />
  ...
  <span id="ignislogger-findcaller" />
  ...
  <span id="ignislogger-geteffectivelevel" />
  ...
  <span id="ignislogger-hashandlers" />
  ...
  <span id="ignislogger-isenabledfor" />
  ...
  <span id="ignislogger-log-to-file" />
  ...
  <span id="ignislogger-makerecord" />
  ...
  <span id="ignislogger-removefilter" />
  ...
  <span id="ignislogger-removehandler" />
