---
title: FullAncillaAllocation (v0.19)
description: API reference for qiskit.transpiler.passes.FullAncillaAllocation in qiskit v0.19
...
<Class id="qiskit.transpiler.passes.FullAncillaAllocation" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.14/qiskit/transpiler/passes/layout/full_ancilla_allocation.py" signature="FullAncillaAllocation(*args, **kwargs)" modifiers="class">
  ...
  **coupling\_map** (*Coupling*) – directed graph representing a coupling map.
  ...
  <span id="fullancillaallocation-is-analysis-pass" />
  ...
  <span id="fullancillaallocation-is-transformation-pass" />
  ...
  <span id="fullancillaallocation-name" />
  ...
  <span id="fullancillaallocation-run" />
