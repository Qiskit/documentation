...
<Class id="qiskit.optimization.converters.InequalityToEquality" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.7/qiskit/optimization/converters/inequality_to_equality.py" signature="InequalityToEquality">
  ...
  **Examples**
  ...
  <Function id="qiskit.optimization.converters.InequalityToEquality.decode" name="decode" signature="InequalityToEquality.decode(result)">
  ...
  <Function id="qiskit.optimization.converters.InequalityToEquality.encode" name="encode" signature="InequalityToEquality.encode(op, name=None, mode='auto')">
