---
title: InequalityToEquality (v0.19)
description: API reference for qiskit.optimization.converters.InequalityToEquality in qiskit v0.19
...
<Class id="qiskit.optimization.converters.InequalityToEquality" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.7/qiskit/optimization/converters/inequality_to_equality.py" signature="InequalityToEquality" modifiers="class">
  ...
  **Examples**
  ...
  <span id="inequalitytoequality-decode" />
  ...
  <span id="inequalitytoequality-encode" />
