...
$$
  ...
  *   **name** (`Optional`\[`str`]) – Display name for this pulse envelope.
  ...
  <Attribute id="qiskit.pulse.Drag.amp" signature="complex">
  ...
  <Attribute id="qiskit.pulse.Drag.beta" signature="float">
  ...
  <Attribute id="qiskit.pulse.Drag.id" signature="int">
  ...
  <Attribute id="qiskit.pulse.Drag.parameters" signature="Dict[str, Any]">
  ...
  <Attribute id="qiskit.pulse.Drag.sigma" signature="float">
