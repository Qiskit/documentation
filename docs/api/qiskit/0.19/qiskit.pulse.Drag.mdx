---
title: Drag (v0.19)
description: API reference for qiskit.pulse.Drag in qiskit v0.19
...
<Class id="qiskit.pulse.Drag" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.14/qiskit/pulse/pulse_lib/parametric_pulses.py" signature="Drag(duration, amp, sigma, beta, name=None)" modifiers="class">
...
$$
  ...
  *   **name** (`Optional`\[`str`]) – Display name for this pulse envelope.
  ...
  <Attribute id="qiskit.pulse.Drag.amp" attributeTypeHint="complex">
  ...
  <Attribute id="qiskit.pulse.Drag.beta" attributeTypeHint="float">
  ...
  <Attribute id="qiskit.pulse.Drag.id" attributeTypeHint="int">
  ...
  <Attribute id="qiskit.pulse.Drag.parameters" attributeTypeHint="Dict[str, Any]">
  ...
  <Attribute id="qiskit.pulse.Drag.sigma" attributeTypeHint="float">
  ...
  <Function id="qiskit.pulse.Drag.__call__" signature="Drag.__call__(channel)">
  ...
  <Function id="qiskit.pulse.Drag.draw" signature="Drag.draw(dt=1, style=None, filename=None, interp_method=None, scale=1, interactive=False, scaling=None)">
    Plot the pulse.
  ...
  <Function id="qiskit.pulse.Drag.get_sample_pulse" signature="Drag.get_sample_pulse()">
