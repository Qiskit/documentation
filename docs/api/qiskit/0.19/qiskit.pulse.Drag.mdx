...
<Class id="qiskit.pulse.Drag" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.14/qiskit/pulse/pulse_lib/parametric_pulses.py" signature="Drag(duration, amp, sigma, beta, name=None)">
...
$$
  ...
  *   **name** (`Optional`\[`str`]) – Display name for this pulse envelope.
  ...
  <Attribute id="qiskit.pulse.Drag.amp" name="amp" signature="complex">
  ...
  <Attribute id="qiskit.pulse.Drag.beta" name="beta" signature="float">
  ...
  <Attribute id="qiskit.pulse.Drag.id" name="id" signature="int">
  ...
  <Attribute id="qiskit.pulse.Drag.parameters" name="parameters" signature="Dict[str, Any]">
  ...
  <Attribute id="qiskit.pulse.Drag.sigma" name="sigma" signature="float">
  ...
  <Function id="qiskit.pulse.Drag.__call__" name="__call__" signature="Drag.__call__(channel)">
    Call self as a function.
  </Function>

  ### draw

  <Function id="qiskit.pulse.Drag.draw" name="draw" signature="Drag.draw(dt=1, style=None, filename=None, interp_method=None, scale=1, interactive=False, scaling=None)">
    Plot the pulse.
  ...
  <Function id="qiskit.pulse.Drag.get_sample_pulse" name="get_sample_pulse" signature="Drag.get_sample_pulse()">
