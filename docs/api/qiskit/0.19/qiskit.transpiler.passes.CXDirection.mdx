---
title: CXDirection (v0.19)
description: API reference for qiskit.transpiler.passes.CXDirection in qiskit v0.19
...
<Class id="qiskit.transpiler.passes.CXDirection" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.14/qiskit/transpiler/passes/utils/cx_direction.py" signature="CXDirection(*args, **kwargs)" modifiers="class">
  ...
  **coupling\_map** ([*CouplingMap*](qiskit.transpiler.CouplingMap "qiskit.transpiler.CouplingMap")) – Directed graph represented a coupling map.
  ...
  <span id="cxdirection-is-analysis-pass" />
  ...
  <span id="cxdirection-is-transformation-pass" />
