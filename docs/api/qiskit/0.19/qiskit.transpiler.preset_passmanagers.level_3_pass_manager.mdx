...
`level_3_pass_manager(pass_manager_config)` [GitHub](https://github.com/qiskit/qiskit/tree/stable/0.14/qiskit/transpiler/preset_passmanagers/level3.py "view source code")
