---
title: circuit_to_instruction (v0.19)
description: API reference for qiskit.converters.circuit_to_instruction in qiskit v0.19
in_page_toc_min_heading_level: 1
python_api_type: function
python_api_name: qiskit.converters.circuit_to_instruction
---

<span id="circuit-to-instruction" />

# circuit\_to\_instruction

<Function id="qiskit.converters.circuit_to_instruction" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.14/qiskit/converters/circuit_to_instruction.py" signature="circuit_to_instruction(circuit, parameter_map=None, equivalence_library=None)">
