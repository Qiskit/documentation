...
<Class id="qiskit.aqua.operators.expectations.ExpectationFactory" github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.7/qiskit/aqua/operators/expectations/expectation_factory.py" signature="ExpectationFactory">
