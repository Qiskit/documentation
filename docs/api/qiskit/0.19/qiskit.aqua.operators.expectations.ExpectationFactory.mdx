---
title: ExpectationFactory (v0.19)
description: API reference for qiskit.aqua.operators.expectations.ExpectationFactory in qiskit v0.19
...
<Class id="qiskit.aqua.operators.expectations.ExpectationFactory" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.7/qiskit/aqua/operators/expectations/expectation_factory.py" signature="ExpectationFactory" modifiers="class">
  ...
  <span id="expectationfactory-build" />
