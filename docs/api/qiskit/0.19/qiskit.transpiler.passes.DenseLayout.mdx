---
title: DenseLayout (v0.19)
description: API reference for qiskit.transpiler.passes.DenseLayout in qiskit v0.19
...
<Class id="qiskit.transpiler.passes.DenseLayout" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.14/qiskit/transpiler/passes/layout/dense_layout.py" signature="DenseLayout(*args, **kwargs)" modifiers="class">
  ...
  *   **backend\_prop** ([*BackendProperties*](qiskit.providers.models.BackendProperties "qiskit.providers.models.BackendProperties")) – backend properties object
  ...
  <span id="denselayout-is-analysis-pass" />
  ...
  <span id="denselayout-is-transformation-pass" />
