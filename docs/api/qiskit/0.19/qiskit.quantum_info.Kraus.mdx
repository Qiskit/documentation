...
$$
  ...
  **Additional Information:**
  ...
  <Function id="qiskit.quantum_info.Kraus.set_atol" signature="classmethod Kraus.set_atol(value)">
    Set the class default absolute tolerance parameter for float comparisons.
  </Function>

  ### set\_rtol

  <Function id="qiskit.quantum_info.Kraus.set_rtol" signature="classmethod Kraus.set_rtol(value)">
