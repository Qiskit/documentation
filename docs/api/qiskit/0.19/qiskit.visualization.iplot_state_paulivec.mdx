...
<Function id="qiskit.visualization.iplot_state_paulivec" github="https://github.com/qiskit/qiskit/tree/stable/0.14/qiskit/visualization/interactive/iplot_paulivec.py" signature="iplot_state_paulivec(rho, figsize=None, slider=False, show_legend=False)">
