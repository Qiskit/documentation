...
<Class id="qiskit.transpiler.Layout" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.14/qiskit/transpiler/layout.py" signature="Layout(input_dict=None)">
  ...
  <Function id="qiskit.transpiler.Layout.__getitem__" name="__getitem__" signature="Layout.__getitem__(item)" />

  ### \_\_len\_\_

  <Function id="qiskit.transpiler.Layout.__len__" name="__len__" signature="Layout.__len__()" />

  ### add

  <Function id="qiskit.transpiler.Layout.add" name="add" signature="Layout.add(virtual_bit, physical_bit=None)">
  ...
  <Function id="qiskit.transpiler.Layout.add_register" name="add_register" signature="Layout.add_register(reg)">
  ...
  <Function id="qiskit.transpiler.Layout.combine_into_edge_map" name="combine_into_edge_map" signature="Layout.combine_into_edge_map(another_layout)">
  ...
  <Function id="qiskit.transpiler.Layout.copy" name="copy" signature="Layout.copy()">
    Returns a copy of a Layout instance.
  </Function>

  ### from\_dict

  <Function id="qiskit.transpiler.Layout.from_dict" name="from_dict" signature="Layout.from_dict(input_dict)">
  ...
  <Function id="qiskit.transpiler.Layout.from_intlist" name="from_intlist" signature="static Layout.from_intlist(int_list, *qregs)">
  ...
  <Function id="qiskit.transpiler.Layout.from_qubit_list" name="from_qubit_list" signature="static Layout.from_qubit_list(qubit_list)">
  ...
  <Function id="qiskit.transpiler.Layout.generate_trivial_layout" name="generate_trivial_layout" signature="static Layout.generate_trivial_layout(*regs)">
  ...
  <Function id="qiskit.transpiler.Layout.get_physical_bits" name="get_physical_bits" signature="Layout.get_physical_bits()">
    Returns the dictionary where the keys are physical (qu)bits and the values are virtual (qu)bits.
  </Function>

  ### get\_registers

  <Function id="qiskit.transpiler.Layout.get_registers" name="get_registers" signature="Layout.get_registers()">
  ...
  <Function id="qiskit.transpiler.Layout.get_virtual_bits" name="get_virtual_bits" signature="Layout.get_virtual_bits()">
    Returns the dictionary where the keys are virtual (qu)bits and the values are physical (qu)bits.
  </Function>

  ### order\_based\_on\_type

  <Function id="qiskit.transpiler.Layout.order_based_on_type" name="order_based_on_type" signature="static Layout.order_based_on_type(value1, value2)">
    decides which one is physical/virtual based on the type. Returns (virtual, physical)
  </Function>

  ### reorder\_bits

  <Function id="qiskit.transpiler.Layout.reorder_bits" name="reorder_bits" signature="Layout.reorder_bits(bits)">
  ...
  <Function id="qiskit.transpiler.Layout.swap" name="swap" signature="Layout.swap(left, right)">
