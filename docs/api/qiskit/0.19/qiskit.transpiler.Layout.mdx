---
title: Layout (v0.19)
description: API reference for qiskit.transpiler.Layout in qiskit v0.19
...
<Class id="qiskit.transpiler.Layout" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.14/qiskit/transpiler/layout.py" signature="Layout(input_dict=None)" modifiers="class">
  ...
  <span id="layout-getitem" />

  ### \_\_getitem\_\_

  <Function id="qiskit.transpiler.Layout.__getitem__" signature="Layout.__getitem__(item)" />

  <span id="layout-len" />

  ### \_\_len\_\_

  <Function id="qiskit.transpiler.Layout.__len__" signature="Layout.__len__()" />
  ...
  <span id="layout-combine-into-edge-map" />
  ...
  <span id="layout-from-qubit-list" />

  ### from\_qubit\_list

  <Function id="qiskit.transpiler.Layout.from_qubit_list" signature="Layout.from_qubit_list(qubit_list)" modifiers="static">
  ...
  <span id="layout-generate-trivial-layout" />
  ...
  <span id="layout-get-physical-bits" />
  ...
  <span id="layout-get-virtual-bits" />
  ...
  <span id="layout-order-based-on-type" />
