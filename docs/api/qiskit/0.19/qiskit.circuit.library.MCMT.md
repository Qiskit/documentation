...
<span id="qiskit.circuit.library.MCMT.AND" />

`MCMT.AND(qr_variables, qb_target, qr_ancillae, flags=None, mct_mode='no-ancilla')`
...
`MCMT.ccx(control_qubit1, control_qubit2, target_qubit, *, ctl1=None, ctl2=None, tgt=None)`
...
`MCMT.ch(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)`
...
`MCMT.crz(theta, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)`
...
`MCMT.cu1(theta, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)`
...
`MCMT.cx(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)`
...
`MCMT.cy(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)`
...
`MCMT.fredkin(control_qubit, target_qubit1, target_qubit2, *, ctl=None, tgt1=None, tgt2=None)`
...
`static MCMT.from_qasm_str(qasm_str)`
...
`MCMT.iso(isometry, q_input, q_ancillas_for_output, q_ancillas_zero=None, q_ancillas_dirty=None)`
...
`MCMT.mcrx(theta, q_controls, q_target, use_basis_gates=False)`
...
`MCMT.mcry(theta, q_controls, q_target, q_ancillae, mode='basic', use_basis_gates=False)`
...
`MCMT.mcrz(lam, q_controls, q_target, use_basis_gates=False)`
...
`MCMT.mcx(control_qubits, target_qubit, ancilla_qubits=None, mode='noancilla')`
...
`MCMT.measure_active(inplace=True)`
...
`MCMT.qasm(formatted=False, filename=None)`
...
`MCMT.qbit_argument_conversion(qubit_representation)`
...
`MCMT.rccx(control_qubit1, control_qubit2, target_qubit)`
...
`MCMT.rx(theta, qubit, *, label=None, q=None)`
...
`MCMT.snapshot_density_matrix(label, qubits=None)`
...
`MCMT.snapshot_probabilities(label, qubits, variance=False)`
...
`MCMT.squ(unitary_matrix, qubit, mode='ZYZ', up_to_diagonal=False, *, u=None)`
...
`MCMT.to_instruction(parameter_map=None)`
...
`MCMT.uc(gate_list, q_controls, q_target, up_to_diagonal=False)`
...
`MCMT.x(qubit, *, label=None, ctrl_state=None, q=None)`
