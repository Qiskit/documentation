...
<Class id="qiskit.chemistry.core.ChemistryOperator" github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.7/qiskit/chemistry/core/chemistry_operator.py" signature="ChemistryOperator">
