...
<Class id="qiskit.chemistry.core.ChemistryOperator" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.7/qiskit/chemistry/core/chemistry_operator.py" signature="ChemistryOperator">
  ...
  <Attribute id="qiskit.chemistry.core.ChemistryOperator.INFO_NUM_ORBITALS" signature="= 'num_orbitals'" />

  ### INFO\_NUM\_PARTICLES

  <Attribute id="qiskit.chemistry.core.ChemistryOperator.INFO_NUM_PARTICLES" signature="= 'num_particles'" />

  ### INFO\_TWO\_QUBIT\_REDUCTION

  <Attribute id="qiskit.chemistry.core.ChemistryOperator.INFO_TWO_QUBIT_REDUCTION" signature="= 'two_qubit_reduction'" />

  ### INFO\_Z2SYMMETRIES

  <Attribute id="qiskit.chemistry.core.ChemistryOperator.INFO_Z2SYMMETRIES" signature="= 'z2symmetries'" />
