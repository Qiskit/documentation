...
<Function id="qiskit.ignis.characterization.ampcal_cx_circuits" name="ampcal_cx_circuits" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-ignis/tree/stable/0.3/qiskit/ignis/characterization/gates/circuits.py" signature="ampcal_cx_circuits(max_reps, qubits, control_qubits)">
