---
title: ampcal_cx_circuits (v0.19)
description: API reference for qiskit.ignis.characterization.ampcal_cx_circuits in qiskit v0.19
in_page_toc_min_heading_level: 1
python_api_type: function
python_api_name: qiskit.ignis.characterization.ampcal_cx_circuits
---

<span id="ampcal-cx-circuits" />
