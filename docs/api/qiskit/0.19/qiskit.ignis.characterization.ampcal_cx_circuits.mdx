...
`ampcal_cx_circuits(max_reps, qubits, control_qubits)` [GitHub](https://github.com/qiskit-community/qiskit-ignis/tree/stable/0.3/qiskit/ignis/characterization/gates/circuits.py "view source code")
