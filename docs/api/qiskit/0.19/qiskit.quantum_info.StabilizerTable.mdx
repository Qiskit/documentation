---
title: StabilizerTable (v0.19)
description: API reference for qiskit.quantum_info.StabilizerTable in qiskit v0.19
...
<Class id="qiskit.quantum_info.StabilizerTable" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.14/qiskit/quantum_info/operators/symplectic/stabilizer_table.py" signature="StabilizerTable(data, phase=None)" modifiers="class">
...
$$
  ...
  **Additional Information:**
  ...
  <span id="stabilizertable-atol" />

  ### atol

  <Attribute id="qiskit.quantum_info.StabilizerTable.atol">
    The default absolute tolerance parameter for float comparisons.
  </Attribute>

  <span id="stabilizertable-dim" />
  ...
  <span id="stabilizertable-num-qubits" />
  ...
  <span id="stabilizertable-rtol" />

  ### rtol

  <Attribute id="qiskit.quantum_info.StabilizerTable.rtol">
    The relative tolerance parameter for float comparisons.
  </Attribute>

  <span id="stabilizertable-shape" />
  ...
  <span id="stabilizertable-call" />

  ### \_\_call\_\_

  <Function id="qiskit.quantum_info.StabilizerTable.__call__" signature="StabilizerTable.__call__(qargs)">
    Return a clone with qargs set
  </Function>

  <span id="stabilizertable-getitem" />

  ### \_\_getitem\_\_

  <Function id="qiskit.quantum_info.StabilizerTable.__getitem__" signature="StabilizerTable.__getitem__(key)">
    Return a view of StabilizerTable
  </Function>

  <span id="stabilizertable-len" />

  ### \_\_len\_\_

  <Function id="qiskit.quantum_info.StabilizerTable.__len__" signature="StabilizerTable.__len__()">
    Return the number of Pauli rows in the table.
  </Function>

  <span id="stabilizertable-mul" />

  ### \_\_mul\_\_

  <Function id="qiskit.quantum_info.StabilizerTable.__mul__" signature="StabilizerTable.__mul__(other)" />

  <span id="stabilizertable-add" />

  ### add

  <Function id="qiskit.quantum_info.StabilizerTable.add" signature="StabilizerTable.add(other)">
  ...
  <span id="stabilizertable-adjoint" />
  ...
  <span id="stabilizertable-anticommutes-with-all" />
  ...
  <span id="stabilizertable-argsort" />
  ...
  <span id="stabilizertable-commutes" />
  ...
  <span id="stabilizertable-commutes-with-all" />
  ...
  <span id="stabilizertable-compose" />
  ...
  <span id="stabilizertable-conjugate" />
  ...
  <span id="stabilizertable-delete" />
  ...
  <span id="stabilizertable-expand" />
  ...
  <span id="stabilizertable-from-labels" />
  ...
  <span id="stabilizertable-input-dims" />
  ...
  <span id="stabilizertable-insert" />
  ...
  <span id="stabilizertable-label-iter" />
  ...
  <span id="stabilizertable-matrix-iter" />
  ...
  <span id="stabilizertable-multiply" />

  ### multiply

  <Function id="qiskit.quantum_info.StabilizerTable.multiply" signature="StabilizerTable.multiply(other)">
  ...
  <span id="stabilizertable-output-dims" />
  ...
  <span id="stabilizertable-reshape" />

  ### reshape

  <Function id="qiskit.quantum_info.StabilizerTable.reshape" signature="StabilizerTable.reshape(input_dims=None, output_dims=None)">
  ...
  <span id="stabilizertable-set-atol" />

  ### set\_atol

  <Function id="qiskit.quantum_info.StabilizerTable.set_atol" signature="StabilizerTable.set_atol(value)" modifiers="classmethod">
    Set the class default absolute tolerance parameter for float comparisons.
  </Function>

  <span id="stabilizertable-set-rtol" />

  ### set\_rtol

  <Function id="qiskit.quantum_info.StabilizerTable.set_rtol" signature="StabilizerTable.set_rtol(value)" modifiers="classmethod">
    Set the class default relative tolerance parameter for float comparisons.
  </Function>

  <span id="stabilizertable-sort" />
  ...
  <span id="stabilizertable-subtract" />

  ### subtract

  <Function id="qiskit.quantum_info.StabilizerTable.subtract" signature="StabilizerTable.subtract(other)">
    Return the linear operator self - other.
  ...
  <span id="stabilizertable-tensor" />
  ...
  <span id="stabilizertable-to-labels" />
  ...
  <span id="stabilizertable-to-matrix" />
  ...
  <span id="stabilizertable-transpose" />
  ...
  <span id="stabilizertable-unique" />
