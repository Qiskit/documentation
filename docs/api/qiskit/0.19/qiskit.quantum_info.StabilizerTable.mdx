...
<Class id="qiskit.quantum_info.StabilizerTable" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.14/qiskit/quantum_info/operators/symplectic/stabilizer_table.py" signature="StabilizerTable(data, phase=None)">
...
$$
  ...
  **Additional Information:**
  ...
  <Attribute id="qiskit.quantum_info.StabilizerTable.X" name="X">
    The X block of the [`array`](qiskit.quantum_info.StabilizerTable#array "qiskit.quantum_info.StabilizerTable.array").
  </Attribute>

  ### Z

  <Attribute id="qiskit.quantum_info.StabilizerTable.Z" name="Z">
    The Z block of the [`array`](qiskit.quantum_info.StabilizerTable#array "qiskit.quantum_info.StabilizerTable.array").
  </Attribute>

  ### array

  <Attribute id="qiskit.quantum_info.StabilizerTable.array" name="array">
    The underlying boolean array.
  </Attribute>

  ### atol

  <Attribute id="qiskit.quantum_info.StabilizerTable.atol" name="atol">
    The default absolute tolerance parameter for float comparisons.
  </Attribute>

  ### dim

  <Attribute id="qiskit.quantum_info.StabilizerTable.dim" name="dim">
    Return tuple (input\_shape, output\_shape).
  </Attribute>

  ### num\_qubits

  <Attribute id="qiskit.quantum_info.StabilizerTable.num_qubits" name="num_qubits">
    Return the number of qubits if a N-qubit operator or None otherwise.
  </Attribute>

  ### pauli

  <Attribute id="qiskit.quantum_info.StabilizerTable.pauli" name="pauli">
    Return PauliTable
  </Attribute>

  ### phase

  <Attribute id="qiskit.quantum_info.StabilizerTable.phase" name="phase">
    Return phase vector
  </Attribute>

  ### qargs

  <Attribute id="qiskit.quantum_info.StabilizerTable.qargs" name="qargs">
    Return the qargs for the operator.
  </Attribute>

  ### rtol

  <Attribute id="qiskit.quantum_info.StabilizerTable.rtol" name="rtol">
    The relative tolerance parameter for float comparisons.
  </Attribute>

  ### shape

  <Attribute id="qiskit.quantum_info.StabilizerTable.shape" name="shape">
    The full shape of the [`array()`](qiskit.quantum_info.StabilizerTable#array "qiskit.quantum_info.StabilizerTable.array")
  </Attribute>

  ### size

  <Attribute id="qiskit.quantum_info.StabilizerTable.size" name="size">
  ...
  <Function id="qiskit.quantum_info.StabilizerTable.__call__" name="__call__" signature="StabilizerTable.__call__(qargs)">
    Return a clone with qargs set
  </Function>

  ### \_\_getitem\_\_

  <Function id="qiskit.quantum_info.StabilizerTable.__getitem__" name="__getitem__" signature="StabilizerTable.__getitem__(key)">
    Return a view of StabilizerTable
  </Function>

  ### \_\_len\_\_

  <Function id="qiskit.quantum_info.StabilizerTable.__len__" name="__len__" signature="StabilizerTable.__len__()">
    Return the number of Pauli rows in the table.
  </Function>

  ### \_\_mul\_\_

  <Function id="qiskit.quantum_info.StabilizerTable.__mul__" name="__mul__" signature="StabilizerTable.__mul__(other)" />

  ### add

  <Function id="qiskit.quantum_info.StabilizerTable.add" name="add" signature="StabilizerTable.add(other)">
  ...
  <Function id="qiskit.quantum_info.StabilizerTable.adjoint" name="adjoint" signature="StabilizerTable.adjoint()">
    Return the adjoint of the operator.
  </Function>

  ### anticommutes\_with\_all

  <Function id="qiskit.quantum_info.StabilizerTable.anticommutes_with_all" name="anticommutes_with_all" signature="StabilizerTable.anticommutes_with_all(other)">
  ...
  <Function id="qiskit.quantum_info.StabilizerTable.argsort" name="argsort" signature="StabilizerTable.argsort(weight=False)">
  ...
  <Function id="qiskit.quantum_info.StabilizerTable.commutes" name="commutes" signature="StabilizerTable.commutes(pauli)">
  ...
  <Function id="qiskit.quantum_info.StabilizerTable.commutes_with_all" name="commutes_with_all" signature="StabilizerTable.commutes_with_all(other)">
    Return indexes of rows that commute other.
  ...
  <Function id="qiskit.quantum_info.StabilizerTable.compose" name="compose" signature="StabilizerTable.compose(other, qargs=None, front=False)">
  ...
  <Function id="qiskit.quantum_info.StabilizerTable.conjugate" name="conjugate" signature="StabilizerTable.conjugate()">
    Not implemented.
  </Function>

  ### copy

  <Function id="qiskit.quantum_info.StabilizerTable.copy" name="copy" signature="StabilizerTable.copy()">
    Return a copy of the StabilizerTable.
  </Function>

  ### delete

  <Function id="qiskit.quantum_info.StabilizerTable.delete" name="delete" signature="StabilizerTable.delete(ind, qubit=False)">
  ...
  <Function id="qiskit.quantum_info.StabilizerTable.dot" name="dot" signature="StabilizerTable.dot(other, qargs=None)">
  ...
  <Function id="qiskit.quantum_info.StabilizerTable.expand" name="expand" signature="StabilizerTable.expand(other)">
  ...
  <Function id="qiskit.quantum_info.StabilizerTable.from_labels" name="from_labels" signature="classmethod StabilizerTable.from_labels(labels)">
  ...
  <Function id="qiskit.quantum_info.StabilizerTable.input_dims" name="input_dims" signature="StabilizerTable.input_dims(qargs=None)">
    Return tuple of input dimension for specified subsystems.
  </Function>

  ### insert

  <Function id="qiskit.quantum_info.StabilizerTable.insert" name="insert" signature="StabilizerTable.insert(ind, value, qubit=False)">
  ...
  <Function id="qiskit.quantum_info.StabilizerTable.label_iter" name="label_iter" signature="StabilizerTable.label_iter()">
  ...
  <Function id="qiskit.quantum_info.StabilizerTable.matrix_iter" name="matrix_iter" signature="StabilizerTable.matrix_iter(sparse=False)">
  ...
  <Function id="qiskit.quantum_info.StabilizerTable.multiply" name="multiply" signature="StabilizerTable.multiply(other)">
  ...
  <Function id="qiskit.quantum_info.StabilizerTable.output_dims" name="output_dims" signature="StabilizerTable.output_dims(qargs=None)">
    Return tuple of output dimension for specified subsystems.
  </Function>

  ### power

  <Function id="qiskit.quantum_info.StabilizerTable.power" name="power" signature="StabilizerTable.power(n)">
  ...
  <Function id="qiskit.quantum_info.StabilizerTable.reshape" name="reshape" signature="StabilizerTable.reshape(input_dims=None, output_dims=None)">
  ...
  <Function id="qiskit.quantum_info.StabilizerTable.set_atol" name="set_atol" signature="classmethod StabilizerTable.set_atol(value)">
    Set the class default absolute tolerance parameter for float comparisons.
  </Function>

  ### set\_rtol

  <Function id="qiskit.quantum_info.StabilizerTable.set_rtol" name="set_rtol" signature="classmethod StabilizerTable.set_rtol(value)">
    Set the class default relative tolerance parameter for float comparisons.
  </Function>

  ### sort

  <Function id="qiskit.quantum_info.StabilizerTable.sort" name="sort" signature="StabilizerTable.sort(weight=False)">
  ...
  <Function id="qiskit.quantum_info.StabilizerTable.subtract" name="subtract" signature="StabilizerTable.subtract(other)">
    Return the linear operator self - other.
  ...
  <Function id="qiskit.quantum_info.StabilizerTable.tensor" name="tensor" signature="StabilizerTable.tensor(other)">
  ...
  <Function id="qiskit.quantum_info.StabilizerTable.to_labels" name="to_labels" signature="StabilizerTable.to_labels(array=False)">
  ...
  <Function id="qiskit.quantum_info.StabilizerTable.to_matrix" name="to_matrix" signature="StabilizerTable.to_matrix(sparse=False, array=False)">
  ...
  <Function id="qiskit.quantum_info.StabilizerTable.transpose" name="transpose" signature="StabilizerTable.transpose()">
    Not implemented.
  </Function>

  ### unique

  <Function id="qiskit.quantum_info.StabilizerTable.unique" name="unique" signature="StabilizerTable.unique(return_index=False, return_counts=False)">
