---
title: CouplingMap (v0.19)
description: API reference for qiskit.transpiler.CouplingMap in qiskit v0.19
...
<Class id="qiskit.transpiler.CouplingMap" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.14/qiskit/transpiler/coupling.py" signature="CouplingMap(couplinglist=None, description=None)" modifiers="class">
  ...
  *   **description** (*str*) – A string to describe the coupling map.
  ...
  <span id="couplingmap-is-symmetric" />
  ...
  <span id="couplingmap-physical-qubits" />
  ...
  <span id="couplingmap-add-physical-qubit" />
  ...
  <span id="couplingmap-is-connected" />
  ...
  <span id="couplingmap-shortest-undirected-path" />
