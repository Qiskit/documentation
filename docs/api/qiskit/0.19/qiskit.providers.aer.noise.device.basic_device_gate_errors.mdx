---
title: basic_device_gate_errors (v0.19)
description: API reference for qiskit.providers.aer.noise.device.basic_device_gate_errors in qiskit v0.19
in_page_toc_min_heading_level: 1
python_api_type: function
python_api_name: qiskit.providers.aer.noise.device.basic_device_gate_errors
---

<span id="basic-device-gate-errors" />

# basic\_device\_gate\_errors

<Function id="qiskit.providers.aer.noise.device.basic_device_gate_errors" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-aer/tree/stable/0.5/qiskit/providers/aer/noise/device/models.py" signature="basic_device_gate_errors(properties, gate_error=True, thermal_relaxation=True, gate_lengths=None, gate_length_units='ns', temperature=0, standard_gates=True)">
