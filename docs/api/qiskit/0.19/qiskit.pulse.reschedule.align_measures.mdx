...
<Function id="qiskit.pulse.reschedule.align_measures" github="https://github.com/qiskit/qiskit/tree/stable/0.14/qiskit/pulse/reschedule.py" signature="align_measures(schedules, inst_map=None, cal_gate='u3', max_calibration_duration=None, align_time=None)">
