---
title: PassManager (v0.19)
description: API reference for qiskit.transpiler.PassManager in qiskit v0.19
...
<Class id="qiskit.transpiler.PassManager" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.14/qiskit/transpiler/passmanager.py" signature="PassManager(passes=None, max_iteration=1000, callback=None)" modifiers="class">
  ...
  *   **callback** (`Optional`\[`Callable`]) – DEPRECATED - A callback function that will be called after each pass execution.
  ...
  <span id="passmanager-getitem" />

  ### \_\_getitem\_\_

  <Function id="qiskit.transpiler.PassManager.__getitem__" signature="PassManager.__getitem__(index)" />

  <span id="passmanager-len" />

  ### \_\_len\_\_

  <Function id="qiskit.transpiler.PassManager.__len__" signature="PassManager.__len__()" />

  <span id="passmanager-append" />
