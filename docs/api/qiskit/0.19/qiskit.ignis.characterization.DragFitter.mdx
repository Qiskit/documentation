...
<Class id="qiskit.ignis.characterization.DragFitter" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-ignis/tree/stable/0.3/qiskit/ignis/characterization/calibrations/fitters.py" signature="DragFitter(backend_result, xdata, qubits, fit_p0, fit_bounds=None)">
  ...
  <Attribute id="qiskit.ignis.characterization.DragFitter.backend_result" signature="Union[qiskit.result.result.Result, List[qiskit.result.result.Result]]">
  ...
  <Attribute id="qiskit.ignis.characterization.DragFitter.description" signature="str">
  ...
  <Attribute id="qiskit.ignis.characterization.DragFitter.fit_fun" signature="Callable">
  ...
  <Attribute id="qiskit.ignis.characterization.DragFitter.measured_qubits" signature="List[int]">
  ...
  <Attribute id="qiskit.ignis.characterization.DragFitter.params" signature="List[float]">
  ...
  <Attribute id="qiskit.ignis.characterization.DragFitter.params_err" signature="List[float]">
  ...
  <Attribute id="qiskit.ignis.characterization.DragFitter.series" signature="Optional[List[str]]">
  ...
  <Attribute id="qiskit.ignis.characterization.DragFitter.xdata" signature="Union[List[float], numpy.array]">
  ...
  <Attribute id="qiskit.ignis.characterization.DragFitter.ydata" signature="List[Dict]">
