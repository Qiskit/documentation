---
title: evolution_instruction (v0.19)
description: API reference for qiskit.aqua.operators.legacy.evolution_instruction in qiskit v0.19
in_page_toc_min_heading_level: 1
python_api_type: function
python_api_name: qiskit.aqua.operators.legacy.evolution_instruction
---

<span id="evolution-instruction" />
