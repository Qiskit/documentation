---
title: InitialState (v0.19)
description: API reference for qiskit.aqua.components.initial_states.InitialState in qiskit v0.19
...
<Class id="qiskit.aqua.components.initial_states.InitialState" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.7/qiskit/aqua/components/initial_states/initial_state.py" signature="InitialState" modifiers="class">
  ...
  <span id="initialstate-construct-circuit" />
