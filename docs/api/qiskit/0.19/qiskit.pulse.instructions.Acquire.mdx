...
<Class id="qiskit.pulse.instructions.Acquire" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.14/qiskit/pulse/instructions/acquire.py" signature="Acquire(duration, channel=None, mem_slot=None, reg_slots=None, mem_slots=None, reg_slot=None, kernel=None, discriminator=None, name=None)">
  ...
  **Raises**
  ...
  <Attribute id="qiskit.pulse.instructions.Acquire.acquire" name="acquire" signature="qiskit.pulse.channels.AcquireChannel">
  ...
  <Attribute id="qiskit.pulse.instructions.Acquire.acquires" name="acquires" signature="List[qiskit.pulse.channels.AcquireChannel]">
  ...
  <Attribute id="qiskit.pulse.instructions.Acquire.channel" name="channel" signature="qiskit.pulse.channels.AcquireChannel">
  ...
  <Attribute id="qiskit.pulse.instructions.Acquire.channels" name="channels" signature="Tuple[qiskit.pulse.channels.Channel]">
  ...
  <Attribute id="qiskit.pulse.instructions.Acquire.command" name="command" signature="qiskit.pulse.commands.command.Command">
  ...
  <Attribute id="qiskit.pulse.instructions.Acquire.discriminator" name="discriminator" signature="qiskit.pulse.configuration.Discriminator">
  ...
  <Attribute id="qiskit.pulse.instructions.Acquire.duration" name="duration" signature="int">
  ...
  <Attribute id="qiskit.pulse.instructions.Acquire.id" name="id" signature="int">
  ...
  <Attribute id="qiskit.pulse.instructions.Acquire.instructions" name="instructions" signature="Tuple[Tuple[int, qiskit.pulse.instructions.instruction.Instruction]]">
  ...
  <Attribute id="qiskit.pulse.instructions.Acquire.kernel" name="kernel" signature="qiskit.pulse.configuration.Kernel">
  ...
  <Attribute id="qiskit.pulse.instructions.Acquire.mem_slot" name="mem_slot" signature="qiskit.pulse.channels.MemorySlot">
  ...
  <Attribute id="qiskit.pulse.instructions.Acquire.mem_slots" name="mem_slots" signature="List[qiskit.pulse.channels.MemorySlot]">
    MemorySlots.
  ...
  <Attribute id="qiskit.pulse.instructions.Acquire.name" name="name" signature="str">
  ...
  <Attribute id="qiskit.pulse.instructions.Acquire.operands" name="operands" signature="Tuple">
  ...
  <Attribute id="qiskit.pulse.instructions.Acquire.reg_slot" name="reg_slot" signature="qiskit.pulse.channels.RegisterSlot">
  ...
  <Attribute id="qiskit.pulse.instructions.Acquire.reg_slots" name="reg_slots" signature="List[qiskit.pulse.channels.RegisterSlot]">
    RegisterSlots.
  ...
  <Attribute id="qiskit.pulse.instructions.Acquire.start_time" name="start_time" signature="int">
  ...
  <Attribute id="qiskit.pulse.instructions.Acquire.stop_time" name="stop_time" signature="int">
  ...
  <Attribute id="qiskit.pulse.instructions.Acquire.timeslots" name="timeslots" signature="Dict[qiskit.pulse.channels.Channel, List[Tuple[int, int]]]">
  ...
  <Function id="qiskit.pulse.instructions.Acquire.__call__" name="__call__" signature="Acquire.__call__(channel=None, mem_slot=None, reg_slots=None, mem_slots=None, reg_slot=None, kernel=None, discriminator=None, name=None)">
  ...
  <Function id="qiskit.pulse.instructions.Acquire.append" name="append" signature="Acquire.append(schedule, name=None)">
  ...
  <Function id="qiskit.pulse.instructions.Acquire.ch_duration" name="ch_duration" signature="Acquire.ch_duration(*channels)">
  ...
  <Function id="qiskit.pulse.instructions.Acquire.ch_start_time" name="ch_start_time" signature="Acquire.ch_start_time(*channels)">
  ...
  <Function id="qiskit.pulse.instructions.Acquire.ch_stop_time" name="ch_stop_time" signature="Acquire.ch_stop_time(*channels)">
  ...
  <Function id="qiskit.pulse.instructions.Acquire.draw" name="draw" signature="Acquire.draw(dt=1, style=None, filename=None, interp_method=None, scale=1, channels_to_plot=None, plot_all=False, plot_range=None, interactive=False, table=True, label=False, framechange=True, scaling=None, channels=None)">
  ...
  <Function id="qiskit.pulse.instructions.Acquire.flatten" name="flatten" signature="Acquire.flatten()">
  ...
  <Function id="qiskit.pulse.instructions.Acquire.insert" name="insert" signature="Acquire.insert(start_time, schedule, name=None)">
  ...
  <Function id="qiskit.pulse.instructions.Acquire.shift" name="shift" signature="Acquire.shift(time, name=None)">
  ...
  <Function id="qiskit.pulse.instructions.Acquire.union" name="union" signature="Acquire.union(*schedules, name=None)">
