---
title: Acquire (v0.19)
description: API reference for qiskit.pulse.instructions.Acquire in qiskit v0.19
...
<Class id="qiskit.pulse.instructions.Acquire" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.14/qiskit/pulse/instructions/acquire.py" signature="Acquire(duration, channel=None, mem_slot=None, reg_slots=None, mem_slots=None, reg_slot=None, kernel=None, discriminator=None, name=None)" modifiers="class">
  ...
  **Raises**
  ...
  <Attribute id="qiskit.pulse.instructions.Acquire.acquire" attributeTypeHint="qiskit.pulse.channels.AcquireChannel">
  ...
  <Attribute id="qiskit.pulse.instructions.Acquire.acquires" attributeTypeHint="List[qiskit.pulse.channels.AcquireChannel]">
  ...
  <Attribute id="qiskit.pulse.instructions.Acquire.channel" attributeTypeHint="qiskit.pulse.channels.AcquireChannel">
  ...
  <Attribute id="qiskit.pulse.instructions.Acquire.channels" attributeTypeHint="Tuple[qiskit.pulse.channels.Channel]">
  ...
  <Attribute id="qiskit.pulse.instructions.Acquire.command" attributeTypeHint="qiskit.pulse.commands.command.Command">
  ...
  <Attribute id="qiskit.pulse.instructions.Acquire.discriminator" attributeTypeHint="qiskit.pulse.configuration.Discriminator">
  ...
  <Attribute id="qiskit.pulse.instructions.Acquire.duration" attributeTypeHint="int">
  ...
  <Attribute id="qiskit.pulse.instructions.Acquire.id" attributeTypeHint="int">
  ...
  <Attribute id="qiskit.pulse.instructions.Acquire.instructions" attributeTypeHint="Tuple[Tuple[int, qiskit.pulse.instructions.instruction.Instruction]]">
  ...
  <Attribute id="qiskit.pulse.instructions.Acquire.kernel" attributeTypeHint="qiskit.pulse.configuration.Kernel">
  ...
  <Attribute id="qiskit.pulse.instructions.Acquire.mem_slot" attributeTypeHint="qiskit.pulse.channels.MemorySlot">
  ...
  <Attribute id="qiskit.pulse.instructions.Acquire.mem_slots" attributeTypeHint="List[qiskit.pulse.channels.MemorySlot]">
    MemorySlots.
  ...
  <Attribute id="qiskit.pulse.instructions.Acquire.name" attributeTypeHint="str">
  ...
  <Attribute id="qiskit.pulse.instructions.Acquire.operands" attributeTypeHint="Tuple">
  ...
  <Attribute id="qiskit.pulse.instructions.Acquire.reg_slot" attributeTypeHint="qiskit.pulse.channels.RegisterSlot">
  ...
  <Attribute id="qiskit.pulse.instructions.Acquire.reg_slots" attributeTypeHint="List[qiskit.pulse.channels.RegisterSlot]">
    RegisterSlots.
  ...
  <Attribute id="qiskit.pulse.instructions.Acquire.start_time" attributeTypeHint="int">
  ...
  <Attribute id="qiskit.pulse.instructions.Acquire.stop_time" attributeTypeHint="int">
  ...
  <Attribute id="qiskit.pulse.instructions.Acquire.timeslots" attributeTypeHint="Dict[qiskit.pulse.channels.Channel, List[Tuple[int, int]]]">
  ...
  <Function id="qiskit.pulse.instructions.Acquire.__call__" signature="Acquire.__call__(channel=None, mem_slot=None, reg_slots=None, mem_slots=None, reg_slot=None, kernel=None, discriminator=None, name=None)">
  ...
  <Function id="qiskit.pulse.instructions.Acquire.draw" signature="Acquire.draw(dt=1, style=None, filename=None, interp_method=None, scale=1, channels_to_plot=None, plot_all=False, plot_range=None, interactive=False, table=True, label=False, framechange=True, scaling=None, channels=None)">
  ...
  <Function id="qiskit.pulse.instructions.Acquire.union" signature="Acquire.union(*schedules, name=None)">
