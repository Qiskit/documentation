...
# state\_fidelity[¶](#state-fidelity "Permalink to this headline")
...
If one of the states is a pure state this simplies to $F(\rho_1, \rho_2) = \langle\psi_1|\rho_2|\psi_1\rangle$, where $\rho_1 = |\psi_1\rangle\!\langle\psi_1|$.
