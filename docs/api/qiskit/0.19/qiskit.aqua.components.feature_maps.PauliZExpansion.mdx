---
title: PauliZExpansion (v0.19)
description: API reference for qiskit.aqua.components.feature_maps.PauliZExpansion in qiskit v0.19
...
<Class id="qiskit.aqua.components.feature_maps.PauliZExpansion" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.7/qiskit/aqua/components/feature_maps/pauli_z_expansion.py" signature="PauliZExpansion(feature_dimension, depth=2, entangler_map=None, entanglement='full', z_order=2, data_map_func=<function self_product>)" modifiers="class">
  ...
  *   **data\_map\_func** (`Callable`\[\[`ndarray`], `float`]) – A mapping function for data x which can be supplied to override the default mapping from [`self_product()`](qiskit.aqua.components.feature_maps.self_product "qiskit.aqua.components.feature_maps.self_product").
  ...
  <span id="paulizexpansion-feature-dimension" />
  ...
  <span id="paulizexpansion-num-qubits" />
  ...
  <span id="paulizexpansion-support-parameterized-circuit" />
  ...
  <span id="paulizexpansion-construct-circuit" />
  ...
  <span id="paulizexpansion-get-entangler-map" />
  ...
  <span id="paulizexpansion-validate-entangler-map" />
