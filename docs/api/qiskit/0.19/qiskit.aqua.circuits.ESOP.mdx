---
title: ESOP (v0.19)
description: API reference for qiskit.aqua.circuits.ESOP in qiskit v0.19
...
<Class id="qiskit.aqua.circuits.ESOP" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.7/qiskit/aqua/circuits/boolean_logical_circuits.py" signature="ESOP(ast, num_vars=None)" modifiers="class">
  ...
  **Raises**
  ...
  <span id="esop-ancillary-register" />
  ...
  <span id="esop-variable-register" />
  ...
  <span id="esop-construct-circuit" />
