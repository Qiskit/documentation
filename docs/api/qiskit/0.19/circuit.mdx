---
title: circuit (v0.19)
description: API reference for qiskit.circuit in qiskit v0.19
...
![../\_images/depth.gif](/docs/images/api/qiskit/0.19/depth.gif)
...
|                                                                                                           |                                 |
| --------------------------------------------------------------------------------------------------------- | ------------------------------- |
| [`QuantumCircuit`](qiskit.circuit.QuantumCircuit "qiskit.circuit.QuantumCircuit")(\*regs\[, name])        | Create a new circuit.           |
...
|                                                                                                                     |                                                                         |
| ------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------- |
| [`Parameter`](qiskit.circuit.Parameter "qiskit.circuit.Parameter")(\_\[, uuid])                                     | Parameter Class for variable parameters.                                |
