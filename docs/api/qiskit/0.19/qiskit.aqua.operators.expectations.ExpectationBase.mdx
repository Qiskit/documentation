...
<Class id="qiskit.aqua.operators.expectations.ExpectationBase" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.7/qiskit/aqua/operators/expectations/expectation_base.py" signature="ExpectationBase">
  ...
  <Function id="qiskit.aqua.operators.expectations.ExpectationBase.compute_variance" signature="abstract ExpectationBase.compute_variance(exp_op)">
  ...
  <Function id="qiskit.aqua.operators.expectations.ExpectationBase.convert" signature="abstract ExpectationBase.convert(operator)">
