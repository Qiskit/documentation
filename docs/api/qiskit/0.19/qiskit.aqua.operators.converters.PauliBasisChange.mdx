---
title: PauliBasisChange (v0.19)
description: API reference for qiskit.aqua.operators.converters.PauliBasisChange in qiskit v0.19
...
<Class id="qiskit.aqua.operators.converters.PauliBasisChange" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.7/qiskit/aqua/operators/converters/pauli_basis_change.py" signature="PauliBasisChange(destination_basis=None, traverse=True, replacement_fn=None)" modifiers="class">
  ...
  *   **replacement\_fn** (`Optional`\[`Callable`]) –
  ...
  <span id="paulibasischange-destination" />

  ### destination

  <Attribute id="qiskit.aqua.operators.converters.PauliBasisChange.destination" attributeTypeHint="Optional[qiskit.aqua.operators.primitive_ops.pauli_op.PauliOp]">
  ...
  <span id="paulibasischange-construct-cnot-chain" />

  ### construct\_cnot\_chain

  <Function id="qiskit.aqua.operators.converters.PauliBasisChange.construct_cnot_chain" signature="PauliBasisChange.construct_cnot_chain(diag_pauli_op1, diag_pauli_op2)">
  ...
  <span id="paulibasischange-convert" />

  ### convert

  <Function id="qiskit.aqua.operators.converters.PauliBasisChange.convert" signature="PauliBasisChange.convert(operator)">
  ...
  <span id="paulibasischange-get-cob-circuit" />

  ### get\_cob\_circuit

  <Function id="qiskit.aqua.operators.converters.PauliBasisChange.get_cob_circuit" signature="PauliBasisChange.get_cob_circuit(origin)">
  ...
  <span id="paulibasischange-get-diagonal-pauli-op" />

  ### get\_diagonal\_pauli\_op

  <Function id="qiskit.aqua.operators.converters.PauliBasisChange.get_diagonal_pauli_op" signature="PauliBasisChange.get_diagonal_pauli_op(pauli_op)">
  ...
  <span id="paulibasischange-get-diagonalizing-clifford" />

  ### get\_diagonalizing\_clifford

  <Function id="qiskit.aqua.operators.converters.PauliBasisChange.get_diagonalizing_clifford" signature="PauliBasisChange.get_diagonalizing_clifford(pauli)">
  ...
  <span id="paulibasischange-get-tpb-pauli" />

  ### get\_tpb\_pauli

  <Function id="qiskit.aqua.operators.converters.PauliBasisChange.get_tpb_pauli" signature="PauliBasisChange.get_tpb_pauli(list_op)">
  ...
  <span id="paulibasischange-measurement-replacement-fn" />

  ### measurement\_replacement\_fn

  <Function id="qiskit.aqua.operators.converters.PauliBasisChange.measurement_replacement_fn" signature="PauliBasisChange.measurement_replacement_fn(cob_instr_op, dest_pauli_op)" modifiers="static">
  ...
  <span id="paulibasischange-operator-replacement-fn" />

  ### operator\_replacement\_fn

  <Function id="qiskit.aqua.operators.converters.PauliBasisChange.operator_replacement_fn" signature="PauliBasisChange.operator_replacement_fn(cob_instr_op, dest_pauli_op)" modifiers="static">
  ...
  <span id="paulibasischange-pad-paulis-to-equal-length" />

  ### pad\_paulis\_to\_equal\_length

  <Function id="qiskit.aqua.operators.converters.PauliBasisChange.pad_paulis_to_equal_length" signature="PauliBasisChange.pad_paulis_to_equal_length(pauli_op1, pauli_op2)">
  ...
  <span id="paulibasischange-statefn-replacement-fn" />

  ### statefn\_replacement\_fn

  <Function id="qiskit.aqua.operators.converters.PauliBasisChange.statefn_replacement_fn" signature="PauliBasisChange.statefn_replacement_fn(cob_instr_op, dest_pauli_op)" modifiers="static">
