---
title: uc
description: API reference for qiskit.circuit.library.XOR.uc
in_page_toc_min_heading_level: 1
python_api_type: method
python_api_name: qiskit.circuit.library.XOR.uc
---
...
`XOR.uc(gate_list, q_controls, q_target, up_to_diagonal=False)`
