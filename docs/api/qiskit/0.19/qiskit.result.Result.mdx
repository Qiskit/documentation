...
<Class id="qiskit.result.Result" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.14/qiskit/result/result.py" signature="Result(backend_name, backend_version, qobj_id, job_id, success, results, **kwargs)">
  Model for Results.
  ...
  <Attribute id="qiskit.result.Result.schema" signature="=" />

  ### shallow\_schema

  <Attribute id="qiskit.result.Result.shallow_schema" signature="=" />
  ...
  <Function id="qiskit.result.Result.from_dict" name="from_dict" signature="classmethod Result.from_dict(dict_)">
