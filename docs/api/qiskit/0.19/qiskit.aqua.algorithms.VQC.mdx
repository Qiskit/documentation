...
<Class id="qiskit.aqua.algorithms.VQC" github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.7/qiskit/aqua/algorithms/classifiers/vqc.py" signature="VQC(optimizer, feature_map, var_form, training_dataset, test_dataset=None, datapoints=None, max_evals_grouped=1, minibatch_size=- 1, callback=None, quantum_instance=None)">
  ...
  **Raises**
  ...
  <Attribute id="qiskit.aqua.algorithms.VQC.backend" name="backend" signature="qiskit.providers.basebackend.BaseBackend">
    Returns backend.
  ...
  <Attribute id="qiskit.aqua.algorithms.VQC.class_to_label" name="class_to_label">
    returns class to label
  </Attribute>

  ### datapoints

  <Attribute id="qiskit.aqua.algorithms.VQC.datapoints" name="datapoints">
    return data points
  </Attribute>

  ### feature\_map

  <Attribute id="qiskit.aqua.algorithms.VQC.feature_map" name="feature_map" signature="Optional[Union[qiskit.aqua.components.feature_maps.feature_map.FeatureMap, qiskit.circuit.quantumcircuit.QuantumCircuit]]">
  ...
  <Attribute id="qiskit.aqua.algorithms.VQC.initial_point" name="initial_point" signature="Optional[numpy.ndarray]">
  ...
  <Attribute id="qiskit.aqua.algorithms.VQC.label_to_class" name="label_to_class">
    returns label to class
  </Attribute>

  ### optimal\_params

  <Attribute id="qiskit.aqua.algorithms.VQC.optimal_params" name="optimal_params">
    returns optimal parameters
  </Attribute>

  ### optimizer

  <Attribute id="qiskit.aqua.algorithms.VQC.optimizer" name="optimizer" signature="Optional[qiskit.aqua.components.optimizers.optimizer.Optimizer]">
    Returns optimizer
  ...
  <Attribute id="qiskit.aqua.algorithms.VQC.quantum_instance" name="quantum_instance" signature="Union[None, qiskit.aqua.quantum_instance.QuantumInstance]">
  ...
  <Attribute id="qiskit.aqua.algorithms.VQC.random" name="random">
    Return a numpy random.
  </Attribute>

  ### ret

  <Attribute id="qiskit.aqua.algorithms.VQC.ret" name="ret">
    returns result
  </Attribute>

  ### test\_dataset

  <Attribute id="qiskit.aqua.algorithms.VQC.test_dataset" name="test_dataset">
    returns test dataset
  </Attribute>

  ### training\_dataset

  <Attribute id="qiskit.aqua.algorithms.VQC.training_dataset" name="training_dataset">
    returns training dataset
  </Attribute>

  ### var\_form

  <Attribute id="qiskit.aqua.algorithms.VQC.var_form" name="var_form" signature="Optional[Union[qiskit.circuit.quantumcircuit.QuantumCircuit, qiskit.aqua.components.variational_forms.variational_form.VariationalForm]]">
  ...
  <Function id="qiskit.aqua.algorithms.VQC.batch_data" name="batch_data" signature="VQC.batch_data(data, labels=None, minibatch_size=- 1)">
    batch data
  </Function>

  ### cleanup\_parameterized\_circuits

  <Function id="qiskit.aqua.algorithms.VQC.cleanup_parameterized_circuits" name="cleanup_parameterized_circuits" signature="VQC.cleanup_parameterized_circuits()">
    set parameterized circuits to None
  </Function>

  ### construct\_circuit

  <Function id="qiskit.aqua.algorithms.VQC.construct_circuit" name="construct_circuit" signature="VQC.construct_circuit(x, theta, measurement=False)">
  ...
  <Function id="qiskit.aqua.algorithms.VQC.find_minimum" name="find_minimum" signature="VQC.find_minimum(initial_point=None, var_form=None, cost_fn=None, optimizer=None, gradient_fn=None)">
  ...
  <Function id="qiskit.aqua.algorithms.VQC.get_optimal_circuit" name="get_optimal_circuit" signature="VQC.get_optimal_circuit()">
    get optimal circuit
  </Function>

  ### get\_optimal\_cost

  <Function id="qiskit.aqua.algorithms.VQC.get_optimal_cost" name="get_optimal_cost" signature="VQC.get_optimal_cost()">
    get optimal cost
  </Function>

  ### get\_optimal\_vector

  <Function id="qiskit.aqua.algorithms.VQC.get_optimal_vector" name="get_optimal_vector" signature="VQC.get_optimal_vector()">
    get optimal vector
  </Function>

  ### get\_prob\_vector\_for\_params

  <Function id="qiskit.aqua.algorithms.VQC.get_prob_vector_for_params" name="get_prob_vector_for_params" signature="VQC.get_prob_vector_for_params(construct_circuit_fn, params_s, quantum_instance, construct_circuit_args=None)">
    Helper function to get probability vectors for a set of params
  </Function>

  ### get\_probabilities\_for\_counts

  <Function id="qiskit.aqua.algorithms.VQC.get_probabilities_for_counts" name="get_probabilities_for_counts" signature="VQC.get_probabilities_for_counts(counts)">
    get probabilities for counts
  </Function>

  ### is\_gradient\_really\_supported

  <Function id="qiskit.aqua.algorithms.VQC.is_gradient_really_supported" name="is_gradient_really_supported" signature="VQC.is_gradient_really_supported()">
    returns is gradient really supported
  </Function>

  ### load\_model

  <Function id="qiskit.aqua.algorithms.VQC.load_model" name="load_model" signature="VQC.load_model(file_path)">
    load model
  </Function>

  ### predict

  <Function id="qiskit.aqua.algorithms.VQC.predict" name="predict" signature="VQC.predict(data, quantum_instance=None, minibatch_size=- 1, params=None)">
  ...
  <Function id="qiskit.aqua.algorithms.VQC.run" name="run" signature="VQC.run(quantum_instance=None, **kwargs)">
  ...
  <Function id="qiskit.aqua.algorithms.VQC.save_model" name="save_model" signature="VQC.save_model(file_path)">
    save model
  </Function>

  ### set\_backend

  <Function id="qiskit.aqua.algorithms.VQC.set_backend" name="set_backend" signature="VQC.set_backend(backend, **kwargs)">
  ...
  <Function id="qiskit.aqua.algorithms.VQC.test" name="test" signature="VQC.test(data, labels, quantum_instance=None, minibatch_size=- 1, params=None)">
  ...
  <Function id="qiskit.aqua.algorithms.VQC.train" name="train" signature="VQC.train(data, labels, quantum_instance=None, minibatch_size=- 1)">
