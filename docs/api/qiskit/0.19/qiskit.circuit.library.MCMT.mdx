...
<Class id="qiskit.circuit.library.MCMT" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.14/qiskit/circuit/library/generalized_gates/mcmt.py" signature="MCMT(gate, num_ctrl_qubits, num_target_qubits)">
  ...
  *   **AttributeError** – If the number of controls or targets is 0.
  ...
  <Attribute id="qiskit.circuit.library.MCMT.clbits" name="clbits">
    Returns a list of classical bits in the order that the registers were added.
  </Attribute>

  ### data

  <Attribute id="qiskit.circuit.library.MCMT.data" name="data">
  ...
  <Attribute id="qiskit.circuit.library.MCMT.extension_lib" signature="= 'include \&#x22;qelib1.inc\&#x22;;'" />

  ### header

  <Attribute id="qiskit.circuit.library.MCMT.header" signature="= 'OPENQASM 2.0;'" />

  ### instances

  <Attribute id="qiskit.circuit.library.MCMT.instances" signature="= 8" />

  ### n\_qubits

  <Attribute id="qiskit.circuit.library.MCMT.n_qubits" name="n_qubits">
    Deprecated, use `num_qubits` instead. Return number of qubits.
  </Attribute>

  ### num\_ancilla\_qubits

  <Attribute id="qiskit.circuit.library.MCMT.num_ancilla_qubits" name="num_ancilla_qubits">
    Return the number of ancillas.
  </Attribute>

  ### num\_clbits

  <Attribute id="qiskit.circuit.library.MCMT.num_clbits" name="num_clbits">
    Return number of classical bits.
  </Attribute>

  ### num\_parameters

  <Attribute id="qiskit.circuit.library.MCMT.num_parameters" name="num_parameters">
    Convenience function to get the number of parameter objects in the circuit.
  </Attribute>

  ### num\_qubits

  <Attribute id="qiskit.circuit.library.MCMT.num_qubits" name="num_qubits">
    Return number of qubits.
  </Attribute>

  ### parameters

  <Attribute id="qiskit.circuit.library.MCMT.parameters" name="parameters">
    Convenience function to get the parameters defined in the parameter table.
  </Attribute>

  ### prefix

  <Attribute id="qiskit.circuit.library.MCMT.prefix" signature="= 'circuit'" />

  ### qubits

  <Attribute id="qiskit.circuit.library.MCMT.qubits" name="qubits">
  ...
  <Function id="qiskit.circuit.library.MCMT.AND" name="AND" signature="MCMT.AND(qr_variables, qb_target, qr_ancillae, flags=None, mct_mode='no-ancilla')">
  ...
  <Function id="qiskit.circuit.library.MCMT.OR" name="OR" signature="MCMT.OR(qr_variables, qb_target, qr_ancillae, flags=None, mct_mode='basic')">
  ...
  <Function id="qiskit.circuit.library.MCMT.__getitem__" name="__getitem__" signature="MCMT.__getitem__(item)">
    Return indexed operation.
  </Function>

  ### \_\_len\_\_

  <Function id="qiskit.circuit.library.MCMT.__len__" name="__len__" signature="MCMT.__len__()">
    Return number of operations in circuit.
  </Function>

  ### add\_register

  <Function id="qiskit.circuit.library.MCMT.add_register" name="add_register" signature="MCMT.add_register(*regs)">
    Add registers.
  </Function>

  ### append

  <Function id="qiskit.circuit.library.MCMT.append" name="append" signature="MCMT.append(instruction, qargs=None, cargs=None)">
  ...
  <Function id="qiskit.circuit.library.MCMT.assign_parameters" name="assign_parameters" signature="MCMT.assign_parameters(param_dict, inplace=False)">
  ...
  <Function id="qiskit.circuit.library.MCMT.barrier" name="barrier" signature="MCMT.barrier(*qargs)">
    Apply `Barrier`. If qargs is None, applies to all.
  </Function>

  ### bind\_parameters

  <Function id="qiskit.circuit.library.MCMT.bind_parameters" name="bind_parameters" signature="MCMT.bind_parameters(value_dict)">
  ...
  <Function id="qiskit.circuit.library.MCMT.cast" name="cast" signature="static MCMT.cast(value, _type)">
    Best effort to cast value to type. Otherwise, returns the value.
  </Function>

  ### cbit\_argument\_conversion

  <Function id="qiskit.circuit.library.MCMT.cbit_argument_conversion" name="cbit_argument_conversion" signature="MCMT.cbit_argument_conversion(clbit_representation)">
  ...
  <Function id="qiskit.circuit.library.MCMT.ccx" name="ccx" signature="MCMT.ccx(control_qubit1, control_qubit2, target_qubit, *, ctl1=None, ctl2=None, tgt=None)">
    Apply [`CCXGate`](qiskit.circuit.library.CCXGate "qiskit.circuit.library.CCXGate").
  </Function>

  ### ch

  <Function id="qiskit.circuit.library.MCMT.ch" name="ch" signature="MCMT.ch(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CHGate`](qiskit.circuit.library.CHGate "qiskit.circuit.library.CHGate").
  </Function>

  ### cls\_instances

  <Function id="qiskit.circuit.library.MCMT.cls_instances" name="cls_instances" signature="classmethod MCMT.cls_instances()">
    Return the current number of instances of this class, useful for auto naming.
  </Function>

  ### cls\_prefix

  <Function id="qiskit.circuit.library.MCMT.cls_prefix" name="cls_prefix" signature="classmethod MCMT.cls_prefix()">
    Return the prefix to use for auto naming.
  </Function>

  ### cnot

  <Function id="qiskit.circuit.library.MCMT.cnot" name="cnot" signature="MCMT.cnot(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CXGate`](qiskit.circuit.library.CXGate "qiskit.circuit.library.CXGate").
  </Function>

  ### combine

  <Function id="qiskit.circuit.library.MCMT.combine" name="combine" signature="MCMT.combine(rhs)">
  ...
  <Function id="qiskit.circuit.library.MCMT.compose" name="compose" signature="MCMT.compose(other, qubits=None, clbits=None, front=False, inplace=False)">
  ...
  <Function id="qiskit.circuit.library.MCMT.control" name="control" signature="MCMT.control(num_ctrl_qubits=1)">
    Return the controlled version of the MCMT circuit.
  </Function>

  ### copy

  <Function id="qiskit.circuit.library.MCMT.copy" name="copy" signature="MCMT.copy(name=None)">
    Copy the circuit.
  ...
  <Function id="qiskit.circuit.library.MCMT.count_ops" name="count_ops" signature="MCMT.count_ops()">
  ...
  <Function id="qiskit.circuit.library.MCMT.crx" name="crx" signature="MCMT.crx(theta, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CRXGate`](qiskit.circuit.library.CRXGate "qiskit.circuit.library.CRXGate").
  </Function>

  ### cry

  <Function id="qiskit.circuit.library.MCMT.cry" name="cry" signature="MCMT.cry(theta, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CRYGate`](qiskit.circuit.library.CRYGate "qiskit.circuit.library.CRYGate").
  </Function>

  ### crz

  <Function id="qiskit.circuit.library.MCMT.crz" name="crz" signature="MCMT.crz(theta, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CRZGate`](qiskit.circuit.library.CRZGate "qiskit.circuit.library.CRZGate").
  </Function>

  ### cswap

  <Function id="qiskit.circuit.library.MCMT.cswap" name="cswap" signature="MCMT.cswap(control_qubit, target_qubit1, target_qubit2, *, label=None, ctrl_state=None, ctl=None, tgt1=None, tgt2=None)">
    Apply [`CSwapGate`](qiskit.circuit.library.CSwapGate "qiskit.circuit.library.CSwapGate").
  </Function>

  ### cu1

  <Function id="qiskit.circuit.library.MCMT.cu1" name="cu1" signature="MCMT.cu1(theta, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CU1Gate`](qiskit.circuit.library.CU1Gate "qiskit.circuit.library.CU1Gate").
  </Function>

  ### cu3

  <Function id="qiskit.circuit.library.MCMT.cu3" name="cu3" signature="MCMT.cu3(theta, phi, lam, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CU3Gate`](qiskit.circuit.library.CU3Gate "qiskit.circuit.library.CU3Gate").
  </Function>

  ### cx

  <Function id="qiskit.circuit.library.MCMT.cx" name="cx" signature="MCMT.cx(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CXGate`](qiskit.circuit.library.CXGate "qiskit.circuit.library.CXGate").
  </Function>

  ### cy

  <Function id="qiskit.circuit.library.MCMT.cy" name="cy" signature="MCMT.cy(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CYGate`](qiskit.circuit.library.CYGate "qiskit.circuit.library.CYGate").
  </Function>

  ### cz

  <Function id="qiskit.circuit.library.MCMT.cz" name="cz" signature="MCMT.cz(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CZGate`](qiskit.circuit.library.CZGate "qiskit.circuit.library.CZGate").
  </Function>

  ### dcx

  <Function id="qiskit.circuit.library.MCMT.dcx" name="dcx" signature="MCMT.dcx(qubit1, qubit2)">
    Apply [`DCXGate`](qiskit.circuit.library.DCXGate "qiskit.circuit.library.DCXGate").
  </Function>

  ### decompose

  <Function id="qiskit.circuit.library.MCMT.decompose" name="decompose" signature="MCMT.decompose()">
  ...
  <Function id="qiskit.circuit.library.MCMT.depth" name="depth" signature="MCMT.depth()">
  ...
  <Function id="qiskit.circuit.library.MCMT.diag_gate" name="diag_gate" signature="MCMT.diag_gate(diag, qubit)">
    Deprecated version of QuantumCircuit.diagonal.
  </Function>

  ### diagonal

  <Function id="qiskit.circuit.library.MCMT.diagonal" name="diagonal" signature="MCMT.diagonal(diag, qubit)">
  ...
  <Function id="qiskit.circuit.library.MCMT.extend" name="extend" signature="MCMT.extend(rhs)">
  ...
  <Function id="qiskit.circuit.library.MCMT.fredkin" name="fredkin" signature="MCMT.fredkin(control_qubit, target_qubit1, target_qubit2, *, ctl=None, tgt1=None, tgt2=None)">
    Apply [`CSwapGate`](qiskit.circuit.library.CSwapGate "qiskit.circuit.library.CSwapGate").
  </Function>

  ### from\_qasm\_file

  <Function id="qiskit.circuit.library.MCMT.from_qasm_file" name="from_qasm_file" signature="static MCMT.from_qasm_file(path)">
  ...
  <Function id="qiskit.circuit.library.MCMT.from_qasm_str" name="from_qasm_str" signature="static MCMT.from_qasm_str(qasm_str)">
  ...
  <Function id="qiskit.circuit.library.MCMT.h" name="h" signature="MCMT.h(qubit, *, q=None)">
    Apply [`HGate`](qiskit.circuit.library.HGate "qiskit.circuit.library.HGate").
  </Function>

  ### hamiltonian

  <Function id="qiskit.circuit.library.MCMT.hamiltonian" name="hamiltonian" signature="MCMT.hamiltonian(operator, time, qubits, label=None)">
    Apply hamiltonian evolution to to qubits.
  </Function>

  ### has\_register

  <Function id="qiskit.circuit.library.MCMT.has_register" name="has_register" signature="MCMT.has_register(register)">
  ...
  <Function id="qiskit.circuit.library.MCMT.i" name="i" signature="MCMT.i(qubit, *, q=None)">
    Apply [`IGate`](qiskit.circuit.library.IGate "qiskit.circuit.library.IGate").
  </Function>

  ### id

  <Function id="qiskit.circuit.library.MCMT.id" name="id" signature="MCMT.id(qubit, *, q=None)">
    Apply [`IGate`](qiskit.circuit.library.IGate "qiskit.circuit.library.IGate").
  </Function>

  ### iden

  <Function id="qiskit.circuit.library.MCMT.iden" name="iden" signature="MCMT.iden(qubit, *, q=None)">
    Deprecated identity gate.
  </Function>

  ### initialize

  <Function id="qiskit.circuit.library.MCMT.initialize" name="initialize" signature="MCMT.initialize(params, qubits)">
    Apply initialize to circuit.
  </Function>

  ### inverse

  <Function id="qiskit.circuit.library.MCMT.inverse" name="inverse" signature="MCMT.inverse()">
    Return the inverse MCMT circuit, which is itself.
  </Function>

  ### iso

  <Function id="qiskit.circuit.library.MCMT.iso" name="iso" signature="MCMT.iso(isometry, q_input, q_ancillas_for_output, q_ancillas_zero=None, q_ancillas_dirty=None)">
  ...
  <Function id="qiskit.circuit.library.MCMT.isometry" name="isometry" signature="MCMT.isometry(isometry, q_input, q_ancillas_for_output, q_ancillas_zero=None, q_ancillas_dirty=None)">
    Attach an arbitrary isometry from m to n qubits to a circuit. In particular, this allows to attach arbitrary unitaries on n qubits (m=n) or to prepare any state on n qubits (m=0). The decomposition used here was introduced by Iten et al. in [https://arxiv.org/abs/1501.06911](https://arxiv.org/abs/1501.06911).
  ...
  <Function id="qiskit.circuit.library.MCMT.iswap" name="iswap" signature="MCMT.iswap(qubit1, qubit2)">
    Apply [`iSwapGate`](qiskit.circuit.library.iSwapGate "qiskit.circuit.library.iSwapGate").
  </Function>

  ### mcmt

  <Function id="qiskit.circuit.library.MCMT.mcmt" name="mcmt" signature="MCMT.mcmt(gate, control_qubits, target_qubits, ancilla_qubits=None, mode='no-ancilla', *, single_control_gate_fun=None, q_controls=None, q_ancillae=None, q_targets=None)">
  ...
  <Function id="qiskit.circuit.library.MCMT.mcrx" name="mcrx" signature="MCMT.mcrx(theta, q_controls, q_target, use_basis_gates=False)">
  ...
  <Function id="qiskit.circuit.library.MCMT.mcry" name="mcry" signature="MCMT.mcry(theta, q_controls, q_target, q_ancillae, mode='basic', use_basis_gates=False)">
  ...
  <Function id="qiskit.circuit.library.MCMT.mcrz" name="mcrz" signature="MCMT.mcrz(lam, q_controls, q_target, use_basis_gates=False)">
  ...
  <Function id="qiskit.circuit.library.MCMT.mct" name="mct" signature="MCMT.mct(control_qubits, target_qubit, ancilla_qubits=None, mode='noancilla')">
    Apply `MCXGate`.
  </Function>

  ### mcu1

  <Function id="qiskit.circuit.library.MCMT.mcu1" name="mcu1" signature="MCMT.mcu1(lam, control_qubits, target_qubit)">
    Apply `MCU1Gate`.
  </Function>

  ### mcx

  <Function id="qiskit.circuit.library.MCMT.mcx" name="mcx" signature="MCMT.mcx(control_qubits, target_qubit, ancilla_qubits=None, mode='noancilla')">
    Apply `MCXGate`.
  ...
  <Function id="qiskit.circuit.library.MCMT.measure" name="measure" signature="MCMT.measure(qubit, cbit)">
  ...
  <Function id="qiskit.circuit.library.MCMT.measure_active" name="measure_active" signature="MCMT.measure_active(inplace=True)">
  ...
  <Function id="qiskit.circuit.library.MCMT.measure_all" name="measure_all" signature="MCMT.measure_all(inplace=True)">
  ...
  <Function id="qiskit.circuit.library.MCMT.mirror" name="mirror" signature="MCMT.mirror()">
  ...
  <Function id="qiskit.circuit.library.MCMT.ms" name="ms" signature="MCMT.ms(theta, qubits)">
    Apply [`MSGate`](qiskit.circuit.library.MSGate "qiskit.circuit.library.MSGate").
  </Function>

  ### num\_connected\_components

  <Function id="qiskit.circuit.library.MCMT.num_connected_components" name="num_connected_components" signature="MCMT.num_connected_components(unitary_only=False)">
  ...
  <Function id="qiskit.circuit.library.MCMT.num_nonlocal_gates" name="num_nonlocal_gates" signature="MCMT.num_nonlocal_gates()">
  ...
  <Function id="qiskit.circuit.library.MCMT.num_tensor_factors" name="num_tensor_factors" signature="MCMT.num_tensor_factors()">
  ...
  <Function id="qiskit.circuit.library.MCMT.num_unitary_factors" name="num_unitary_factors" signature="MCMT.num_unitary_factors()">
    Computes the number of tensor factors in the unitary (quantum) part of the circuit only.
  </Function>

  ### qasm

  <Function id="qiskit.circuit.library.MCMT.qasm" name="qasm" signature="MCMT.qasm(formatted=False, filename=None)">
  ...
  <Function id="qiskit.circuit.library.MCMT.qbit_argument_conversion" name="qbit_argument_conversion" signature="MCMT.qbit_argument_conversion(qubit_representation)">
  ...
  <Function id="qiskit.circuit.library.MCMT.r" name="r" signature="MCMT.r(theta, phi, qubit, *, q=None)">
    Apply `RGate`.
  </Function>

  ### rcccx

  <Function id="qiskit.circuit.library.MCMT.rcccx" name="rcccx" signature="MCMT.rcccx(control_qubit1, control_qubit2, control_qubit3, target_qubit)">
    Apply [`RC3XGate`](qiskit.circuit.library.RC3XGate "qiskit.circuit.library.RC3XGate").
  </Function>

  ### rccx

  <Function id="qiskit.circuit.library.MCMT.rccx" name="rccx" signature="MCMT.rccx(control_qubit1, control_qubit2, target_qubit)">
    Apply [`RCCXGate`](qiskit.circuit.library.RCCXGate "qiskit.circuit.library.RCCXGate").
  </Function>

  ### remove\_final\_measurements

  <Function id="qiskit.circuit.library.MCMT.remove_final_measurements" name="remove_final_measurements" signature="MCMT.remove_final_measurements(inplace=True)">
  ...
  <Function id="qiskit.circuit.library.MCMT.reset" name="reset" signature="MCMT.reset(qubit)">
    Reset q.
  </Function>

  ### rx

  <Function id="qiskit.circuit.library.MCMT.rx" name="rx" signature="MCMT.rx(theta, qubit, *, label=None, q=None)">
    Apply [`RXGate`](qiskit.circuit.library.RXGate "qiskit.circuit.library.RXGate").
  </Function>

  ### rxx

  <Function id="qiskit.circuit.library.MCMT.rxx" name="rxx" signature="MCMT.rxx(theta, qubit1, qubit2)">
    Apply [`RXXGate`](qiskit.circuit.library.RXXGate "qiskit.circuit.library.RXXGate").
  </Function>

  ### ry

  <Function id="qiskit.circuit.library.MCMT.ry" name="ry" signature="MCMT.ry(theta, qubit, *, label=None, q=None)">
    Apply [`RYGate`](qiskit.circuit.library.RYGate "qiskit.circuit.library.RYGate").
  </Function>

  ### ryy

  <Function id="qiskit.circuit.library.MCMT.ryy" name="ryy" signature="MCMT.ryy(theta, qubit1, qubit2)">
    Apply [`RYYGate`](qiskit.circuit.library.RYYGate "qiskit.circuit.library.RYYGate").
  </Function>

  ### rz

  <Function id="qiskit.circuit.library.MCMT.rz" name="rz" signature="MCMT.rz(phi, qubit, *, q=None)">
    Apply [`RZGate`](qiskit.circuit.library.RZGate "qiskit.circuit.library.RZGate").
  </Function>

  ### rzx

  <Function id="qiskit.circuit.library.MCMT.rzx" name="rzx" signature="MCMT.rzx(theta, qubit1, qubit2)">
    Apply [`RZXGate`](qiskit.circuit.library.RZXGate "qiskit.circuit.library.RZXGate").
  </Function>

  ### rzz

  <Function id="qiskit.circuit.library.MCMT.rzz" name="rzz" signature="MCMT.rzz(theta, qubit1, qubit2)">
    Apply [`RZZGate`](qiskit.circuit.library.RZZGate "qiskit.circuit.library.RZZGate").
  </Function>

  ### s

  <Function id="qiskit.circuit.library.MCMT.s" name="s" signature="MCMT.s(qubit, *, q=None)">
    Apply [`SGate`](qiskit.circuit.library.SGate "qiskit.circuit.library.SGate").
  </Function>

  ### sdg

  <Function id="qiskit.circuit.library.MCMT.sdg" name="sdg" signature="MCMT.sdg(qubit, *, q=None)">
    Apply [`SdgGate`](qiskit.circuit.library.SdgGate "qiskit.circuit.library.SdgGate").
  </Function>

  ### size

  <Function id="qiskit.circuit.library.MCMT.size" name="size" signature="MCMT.size()">
  ...
  <Function id="qiskit.circuit.library.MCMT.snapshot" name="snapshot" signature="MCMT.snapshot(label, snapshot_type='statevector', qubits=None, params=None)">
  ...
  <Function id="qiskit.circuit.library.MCMT.snapshot_density_matrix" name="snapshot_density_matrix" signature="MCMT.snapshot_density_matrix(label, qubits=None)">
  ...
  <Function id="qiskit.circuit.library.MCMT.snapshot_expectation_value" name="snapshot_expectation_value" signature="MCMT.snapshot_expectation_value(label, op, qubits, single_shot=False, variance=False)">
  ...
  <Function id="qiskit.circuit.library.MCMT.snapshot_probabilities" name="snapshot_probabilities" signature="MCMT.snapshot_probabilities(label, qubits, variance=False)">
  ...
  <Function id="qiskit.circuit.library.MCMT.snapshot_stabilizer" name="snapshot_stabilizer" signature="MCMT.snapshot_stabilizer(label)">
  ...
  <Function id="qiskit.circuit.library.MCMT.snapshot_statevector" name="snapshot_statevector" signature="MCMT.snapshot_statevector(label)">
  ...
  <Function id="qiskit.circuit.library.MCMT.squ" name="squ" signature="MCMT.squ(unitary_matrix, qubit, mode='ZYZ', up_to_diagonal=False, *, u=None)">
  ...
  <Function id="qiskit.circuit.library.MCMT.swap" name="swap" signature="MCMT.swap(qubit1, qubit2)">
    Apply [`SwapGate`](qiskit.circuit.library.SwapGate "qiskit.circuit.library.SwapGate").
  </Function>

  ### t

  <Function id="qiskit.circuit.library.MCMT.t" name="t" signature="MCMT.t(qubit, *, q=None)">
    Apply [`TGate`](qiskit.circuit.library.TGate "qiskit.circuit.library.TGate").
  </Function>

  ### tdg

  <Function id="qiskit.circuit.library.MCMT.tdg" name="tdg" signature="MCMT.tdg(qubit, *, q=None)">
    Apply [`TdgGate`](qiskit.circuit.library.TdgGate "qiskit.circuit.library.TdgGate").
  </Function>

  ### to\_gate

  <Function id="qiskit.circuit.library.MCMT.to_gate" name="to_gate" signature="MCMT.to_gate(parameter_map=None)">
  ...
  <Function id="qiskit.circuit.library.MCMT.to_instruction" name="to_instruction" signature="MCMT.to_instruction(parameter_map=None)">
  ...
  <Function id="qiskit.circuit.library.MCMT.toffoli" name="toffoli" signature="MCMT.toffoli(control_qubit1, control_qubit2, target_qubit, *, ctl1=None, ctl2=None, tgt=None)">
    Apply [`CCXGate`](qiskit.circuit.library.CCXGate "qiskit.circuit.library.CCXGate").
  </Function>

  ### u1

  <Function id="qiskit.circuit.library.MCMT.u1" name="u1" signature="MCMT.u1(theta, qubit, *, q=None)">
    Apply [`U1Gate`](qiskit.circuit.library.U1Gate "qiskit.circuit.library.U1Gate").
  </Function>

  ### u2

  <Function id="qiskit.circuit.library.MCMT.u2" name="u2" signature="MCMT.u2(phi, lam, qubit, *, q=None)">
    Apply [`U2Gate`](qiskit.circuit.library.U2Gate "qiskit.circuit.library.U2Gate").
  </Function>

  ### u3

  <Function id="qiskit.circuit.library.MCMT.u3" name="u3" signature="MCMT.u3(theta, phi, lam, qubit, *, q=None)">
    Apply [`U3Gate`](qiskit.circuit.library.U3Gate "qiskit.circuit.library.U3Gate").
  </Function>

  ### uc

  <Function id="qiskit.circuit.library.MCMT.uc" name="uc" signature="MCMT.uc(gate_list, q_controls, q_target, up_to_diagonal=False)">
  ...
  <Function id="qiskit.circuit.library.MCMT.ucg" name="ucg" signature="MCMT.ucg(angle_list, q_controls, q_target, up_to_diagonal=False)">
    Deprecated version of uc.
  </Function>

  ### ucrx

  <Function id="qiskit.circuit.library.MCMT.ucrx" name="ucrx" signature="MCMT.ucrx(angle_list, q_controls, q_target)">
  ...
  <Function id="qiskit.circuit.library.MCMT.ucry" name="ucry" signature="MCMT.ucry(angle_list, q_controls, q_target)">
  ...
  <Function id="qiskit.circuit.library.MCMT.ucrz" name="ucrz" signature="MCMT.ucrz(angle_list, q_controls, q_target)">
  ...
  <Function id="qiskit.circuit.library.MCMT.ucx" name="ucx" signature="MCMT.ucx(angle_list, q_controls, q_target)">
    Deprecated version of ucrx.
  </Function>

  ### ucy

  <Function id="qiskit.circuit.library.MCMT.ucy" name="ucy" signature="MCMT.ucy(angle_list, q_controls, q_target)">
    Deprecated version of ucry.
  </Function>

  ### ucz

  <Function id="qiskit.circuit.library.MCMT.ucz" name="ucz" signature="MCMT.ucz(angle_list, q_controls, q_target)">
    Deprecated version of ucrz.
  </Function>

  ### unitary

  <Function id="qiskit.circuit.library.MCMT.unitary" name="unitary" signature="MCMT.unitary(obj, qubits, label=None)">
    Apply unitary gate to q.
  </Function>

  ### width

  <Function id="qiskit.circuit.library.MCMT.width" name="width" signature="MCMT.width()">
  ...
  <Function id="qiskit.circuit.library.MCMT.x" name="x" signature="MCMT.x(qubit, *, label=None, ctrl_state=None, q=None)">
    Apply [`XGate`](qiskit.circuit.library.XGate "qiskit.circuit.library.XGate").
  </Function>

  ### y

  <Function id="qiskit.circuit.library.MCMT.y" name="y" signature="MCMT.y(qubit, *, q=None)">
    Apply [`YGate`](qiskit.circuit.library.YGate "qiskit.circuit.library.YGate").
  </Function>

  ### z

  <Function id="qiskit.circuit.library.MCMT.z" name="z" signature="MCMT.z(qubit, *, q=None)">
