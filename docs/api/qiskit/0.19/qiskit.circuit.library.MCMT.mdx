...
<Class id="qiskit.circuit.library.MCMT" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.14/qiskit/circuit/library/generalized_gates/mcmt.py" signature="MCMT(gate, num_ctrl_qubits, num_target_qubits)">
  ...
  *   **AttributeError** – If the number of controls or targets is 0.
  ...
  <Function id="qiskit.circuit.library.MCMT.cast" signature="static MCMT.cast(value, _type)">
  ...
  <Function id="qiskit.circuit.library.MCMT.cls_instances" signature="classmethod MCMT.cls_instances()">
    Return the current number of instances of this class, useful for auto naming.
  </Function>

  ### cls\_prefix

  <Function id="qiskit.circuit.library.MCMT.cls_prefix" signature="classmethod MCMT.cls_prefix()">
  ...
  <Function id="qiskit.circuit.library.MCMT.from_qasm_file" signature="static MCMT.from_qasm_file(path)">
  ...
  <Function id="qiskit.circuit.library.MCMT.from_qasm_str" signature="static MCMT.from_qasm_str(qasm_str)">
