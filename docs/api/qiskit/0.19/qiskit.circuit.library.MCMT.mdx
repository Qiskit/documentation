---
title: MCMT (v0.19)
description: API reference for qiskit.circuit.library.MCMT in qiskit v0.19
...
<Class id="qiskit.circuit.library.MCMT" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.14/qiskit/circuit/library/generalized_gates/mcmt.py" signature="MCMT(gate, num_ctrl_qubits, num_target_qubits)" modifiers="class">
  ...
  *   **AttributeError** – If the number of controls or targets is 0.
  ...
  <span id="mcmt-instances" />

  ### instances

  <Attribute id="qiskit.circuit.library.MCMT.instances" attributeValue="8" />

  <span id="mcmt-n-qubits" />

  ### n\_qubits

  <Attribute id="qiskit.circuit.library.MCMT.n_qubits">
    Deprecated, use `num_qubits` instead. Return number of qubits.
  </Attribute>

  <span id="mcmt-num-ancilla-qubits" />
  ...
  <Function id="qiskit.circuit.library.MCMT.AND" signature="MCMT.AND(qr_variables, qb_target, qr_ancillae, flags=None, mct_mode='no-ancilla')">
  ...
  <Function id="qiskit.circuit.library.MCMT.OR" signature="MCMT.OR(qr_variables, qb_target, qr_ancillae, flags=None, mct_mode='basic')">
  ...
  <span id="mcmt-getitem" />

  ### \_\_getitem\_\_

  <Function id="qiskit.circuit.library.MCMT.__getitem__" signature="MCMT.__getitem__(item)">
  ...
  <Function id="qiskit.circuit.library.MCMT.__len__" signature="MCMT.__len__()">
    Return number of operations in circuit.
  </Function>

  <span id="mcmt-add-register" />

  ### add\_register

  <Function id="qiskit.circuit.library.MCMT.add_register" signature="MCMT.add_register(*regs)">
    Add registers.
  </Function>
  ...
  <Function id="qiskit.circuit.library.MCMT.append" signature="MCMT.append(instruction, qargs=None, cargs=None)">
  ...
  <span id="mcmt-assign-parameters" />

  ### assign\_parameters

  <Function id="qiskit.circuit.library.MCMT.assign_parameters" signature="MCMT.assign_parameters(param_dict, inplace=False)">
  ...
  <span id="mcmt-barrier" />

  ### barrier

  <Function id="qiskit.circuit.library.MCMT.barrier" signature="MCMT.barrier(*qargs)">
    Apply `Barrier`. If qargs is None, applies to all.
  </Function>

  <span id="mcmt-bind-parameters" />

  ### bind\_parameters

  <Function id="qiskit.circuit.library.MCMT.bind_parameters" signature="MCMT.bind_parameters(value_dict)">
  ...
  <Function id="qiskit.circuit.library.MCMT.cast" signature="MCMT.cast(value, _type)" modifiers="static">
    Best effort to cast value to type. Otherwise, returns the value.
  </Function>

  <span id="mcmt-cbit-argument-conversion" />

  ### cbit\_argument\_conversion

  <Function id="qiskit.circuit.library.MCMT.cbit_argument_conversion" signature="MCMT.cbit_argument_conversion(clbit_representation)">
  ...
  <Function id="qiskit.circuit.library.MCMT.ccx" signature="MCMT.ccx(control_qubit1, control_qubit2, target_qubit, *, ctl1=None, ctl2=None, tgt=None)">
  ...
  <Function id="qiskit.circuit.library.MCMT.ch" signature="MCMT.ch(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CHGate`](qiskit.circuit.library.CHGate "qiskit.circuit.library.CHGate").
  </Function>

  <span id="mcmt-cls-instances" />

  ### cls\_instances

  <Function id="qiskit.circuit.library.MCMT.cls_instances" signature="MCMT.cls_instances()" modifiers="classmethod">
    Return the current number of instances of this class, useful for auto naming.
  </Function>

  <span id="mcmt-cls-prefix" />

  ### cls\_prefix

  <Function id="qiskit.circuit.library.MCMT.cls_prefix" signature="MCMT.cls_prefix()" modifiers="classmethod">
  ...
  <Function id="qiskit.circuit.library.MCMT.cnot" signature="MCMT.cnot(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CXGate`](qiskit.circuit.library.CXGate "qiskit.circuit.library.CXGate").
  </Function>

  <span id="mcmt-combine" />

  ### combine

  <Function id="qiskit.circuit.library.MCMT.combine" signature="MCMT.combine(rhs)">
  ...
  <span id="mcmt-compose" />

  ### compose

  <Function id="qiskit.circuit.library.MCMT.compose" signature="MCMT.compose(other, qubits=None, clbits=None, front=False, inplace=False)">
  ...
  <span id="mcmt-control" />

  ### control

  <Function id="qiskit.circuit.library.MCMT.control" signature="MCMT.control(num_ctrl_qubits=1)">
  ...
  <Function id="qiskit.circuit.library.MCMT.copy" signature="MCMT.copy(name=None)">
    Copy the circuit.
  ...
  <span id="mcmt-count-ops" />

  ### count\_ops

  <Function id="qiskit.circuit.library.MCMT.count_ops" signature="MCMT.count_ops()">
  ...
  <Function id="qiskit.circuit.library.MCMT.crx" signature="MCMT.crx(theta, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
  ...
  <Function id="qiskit.circuit.library.MCMT.cry" signature="MCMT.cry(theta, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
  ...
  <Function id="qiskit.circuit.library.MCMT.crz" signature="MCMT.crz(theta, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
  ...
  <Function id="qiskit.circuit.library.MCMT.cswap" signature="MCMT.cswap(control_qubit, target_qubit1, target_qubit2, *, label=None, ctrl_state=None, ctl=None, tgt1=None, tgt2=None)">
  ...
  <Function id="qiskit.circuit.library.MCMT.cu1" signature="MCMT.cu1(theta, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
  ...
  <Function id="qiskit.circuit.library.MCMT.cu3" signature="MCMT.cu3(theta, phi, lam, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
  ...
  <Function id="qiskit.circuit.library.MCMT.cx" signature="MCMT.cx(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CXGate`](qiskit.circuit.library.CXGate "qiskit.circuit.library.CXGate").
  </Function>
  ...
  <Function id="qiskit.circuit.library.MCMT.cy" signature="MCMT.cy(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
  ...
  <Function id="qiskit.circuit.library.MCMT.cz" signature="MCMT.cz(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
  ...
  <Function id="qiskit.circuit.library.MCMT.dcx" signature="MCMT.dcx(qubit1, qubit2)">
    Apply [`DCXGate`](qiskit.circuit.library.DCXGate "qiskit.circuit.library.DCXGate").
  </Function>

  <span id="mcmt-decompose" />

  ### decompose

  <Function id="qiskit.circuit.library.MCMT.decompose" signature="MCMT.decompose()">
  ...
  <Function id="qiskit.circuit.library.MCMT.depth" signature="MCMT.depth()">
  ...
  <span id="mcmt-diag-gate" />

  ### diag\_gate

  <Function id="qiskit.circuit.library.MCMT.diag_gate" signature="MCMT.diag_gate(diag, qubit)">
    Deprecated version of QuantumCircuit.diagonal.
  </Function>

  <span id="mcmt-diagonal" />

  ### diagonal

  <Function id="qiskit.circuit.library.MCMT.diagonal" signature="MCMT.diagonal(diag, qubit)">
  ...
  <Function id="qiskit.circuit.library.MCMT.extend" signature="MCMT.extend(rhs)">
  ...
  <span id="mcmt-fredkin" />

  ### fredkin

  <Function id="qiskit.circuit.library.MCMT.fredkin" signature="MCMT.fredkin(control_qubit, target_qubit1, target_qubit2, *, ctl=None, tgt1=None, tgt2=None)">
    Apply [`CSwapGate`](qiskit.circuit.library.CSwapGate "qiskit.circuit.library.CSwapGate").
  </Function>

  <span id="mcmt-from-qasm-file" />

  ### from\_qasm\_file

  <Function id="qiskit.circuit.library.MCMT.from_qasm_file" signature="MCMT.from_qasm_file(path)" modifiers="static">
  ...
  <span id="mcmt-from-qasm-str" />

  ### from\_qasm\_str

  <Function id="qiskit.circuit.library.MCMT.from_qasm_str" signature="MCMT.from_qasm_str(qasm_str)" modifiers="static">
  ...
  <Function id="qiskit.circuit.library.MCMT.h" signature="MCMT.h(qubit, *, q=None)">
    Apply [`HGate`](qiskit.circuit.library.HGate "qiskit.circuit.library.HGate").
  </Function>

  <span id="mcmt-hamiltonian" />

  ### hamiltonian

  <Function id="qiskit.circuit.library.MCMT.hamiltonian" signature="MCMT.hamiltonian(operator, time, qubits, label=None)">
    Apply hamiltonian evolution to to qubits.
  </Function>

  <span id="mcmt-has-register" />

  ### has\_register

  <Function id="qiskit.circuit.library.MCMT.has_register" signature="MCMT.has_register(register)">
  ...
  <Function id="qiskit.circuit.library.MCMT.i" signature="MCMT.i(qubit, *, q=None)">
  ...
  <Function id="qiskit.circuit.library.MCMT.id" signature="MCMT.id(qubit, *, q=None)">
    Apply [`IGate`](qiskit.circuit.library.IGate "qiskit.circuit.library.IGate").
  </Function>
  ...
  <Function id="qiskit.circuit.library.MCMT.iden" signature="MCMT.iden(qubit, *, q=None)">
    Deprecated identity gate.
  </Function>

  <span id="mcmt-initialize" />

  ### initialize

  <Function id="qiskit.circuit.library.MCMT.initialize" signature="MCMT.initialize(params, qubits)">
    Apply initialize to circuit.
  </Function>

  <span id="mcmt-inverse" />
  ...
  <Function id="qiskit.circuit.library.MCMT.iso" signature="MCMT.iso(isometry, q_input, q_ancillas_for_output, q_ancillas_zero=None, q_ancillas_dirty=None)">
  ...
  <span id="mcmt-isometry" />

  ### isometry

  <Function id="qiskit.circuit.library.MCMT.isometry" signature="MCMT.isometry(isometry, q_input, q_ancillas_for_output, q_ancillas_zero=None, q_ancillas_dirty=None)">
    Attach an arbitrary isometry from m to n qubits to a circuit. In particular, this allows to attach arbitrary unitaries on n qubits (m=n) or to prepare any state on n qubits (m=0). The decomposition used here was introduced by Iten et al. in [https://arxiv.org/abs/1501.06911](https://arxiv.org/abs/1501.06911).
  ...
  <Function id="qiskit.circuit.library.MCMT.iswap" signature="MCMT.iswap(qubit1, qubit2)">
  ...
  <Function id="qiskit.circuit.library.MCMT.mcmt" signature="MCMT.mcmt(gate, control_qubits, target_qubits, ancilla_qubits=None, mode='no-ancilla', *, single_control_gate_fun=None, q_controls=None, q_ancillae=None, q_targets=None)">
  ...
  <Function id="qiskit.circuit.library.MCMT.mcrx" signature="MCMT.mcrx(theta, q_controls, q_target, use_basis_gates=False)">
  ...
  <Function id="qiskit.circuit.library.MCMT.mcry" signature="MCMT.mcry(theta, q_controls, q_target, q_ancillae, mode='basic', use_basis_gates=False)">
  ...
  <Function id="qiskit.circuit.library.MCMT.mcrz" signature="MCMT.mcrz(lam, q_controls, q_target, use_basis_gates=False)">
  ...
  <Function id="qiskit.circuit.library.MCMT.mct" signature="MCMT.mct(control_qubits, target_qubit, ancilla_qubits=None, mode='noancilla')">
    Apply `MCXGate`.
  </Function>
  ...
  <Function id="qiskit.circuit.library.MCMT.mcu1" signature="MCMT.mcu1(lam, control_qubits, target_qubit)">
    Apply `MCU1Gate`.
  </Function>
  ...
  <Function id="qiskit.circuit.library.MCMT.mcx" signature="MCMT.mcx(control_qubits, target_qubit, ancilla_qubits=None, mode='noancilla')">
    Apply `MCXGate`.
  ...
  <span id="mcmt-measure" />

  ### measure

  <Function id="qiskit.circuit.library.MCMT.measure" signature="MCMT.measure(qubit, cbit)">
  ...
  <span id="mcmt-measure-active" />

  ### measure\_active

  <Function id="qiskit.circuit.library.MCMT.measure_active" signature="MCMT.measure_active(inplace=True)">
  ...
  <span id="mcmt-measure-all" />

  ### measure\_all

  <Function id="qiskit.circuit.library.MCMT.measure_all" signature="MCMT.measure_all(inplace=True)">
  ...
  <Function id="qiskit.circuit.library.MCMT.mirror" signature="MCMT.mirror()">
  ...
  <Function id="qiskit.circuit.library.MCMT.ms" signature="MCMT.ms(theta, qubits)">
    Apply [`MSGate`](qiskit.circuit.library.MSGate "qiskit.circuit.library.MSGate").
  </Function>

  <span id="mcmt-num-connected-components" />

  ### num\_connected\_components

  <Function id="qiskit.circuit.library.MCMT.num_connected_components" signature="MCMT.num_connected_components(unitary_only=False)">
  ...
  <span id="mcmt-num-nonlocal-gates" />

  ### num\_nonlocal\_gates

  <Function id="qiskit.circuit.library.MCMT.num_nonlocal_gates" signature="MCMT.num_nonlocal_gates()">
    Return number of non-local gates (i.e. involving 2+ qubits).

    Conditional nonlocal gates are also included.
  </Function>

  <span id="mcmt-num-tensor-factors" />

  ### num\_tensor\_factors

  <Function id="qiskit.circuit.library.MCMT.num_tensor_factors" signature="MCMT.num_tensor_factors()">
  ...
  <span id="mcmt-num-unitary-factors" />

  ### num\_unitary\_factors

  <Function id="qiskit.circuit.library.MCMT.num_unitary_factors" signature="MCMT.num_unitary_factors()">
    Computes the number of tensor factors in the unitary (quantum) part of the circuit only.
  </Function>
  ...
  <Function id="qiskit.circuit.library.MCMT.qasm" signature="MCMT.qasm(formatted=False, filename=None)">
  ...
  <span id="mcmt-qbit-argument-conversion" />

  ### qbit\_argument\_conversion

  <Function id="qiskit.circuit.library.MCMT.qbit_argument_conversion" signature="MCMT.qbit_argument_conversion(qubit_representation)">
  ...
  <Function id="qiskit.circuit.library.MCMT.r" signature="MCMT.r(theta, phi, qubit, *, q=None)">
    Apply `RGate`.
  </Function>
  ...
  <Function id="qiskit.circuit.library.MCMT.rcccx" signature="MCMT.rcccx(control_qubit1, control_qubit2, control_qubit3, target_qubit)">
  ...
  <Function id="qiskit.circuit.library.MCMT.rccx" signature="MCMT.rccx(control_qubit1, control_qubit2, target_qubit)">
    Apply [`RCCXGate`](qiskit.circuit.library.RCCXGate "qiskit.circuit.library.RCCXGate").
  </Function>

  <span id="mcmt-remove-final-measurements" />

  ### remove\_final\_measurements

  <Function id="qiskit.circuit.library.MCMT.remove_final_measurements" signature="MCMT.remove_final_measurements(inplace=True)">
  ...
  <Function id="qiskit.circuit.library.MCMT.reset" signature="MCMT.reset(qubit)">
    Reset q.
  </Function>
  ...
  <Function id="qiskit.circuit.library.MCMT.rx" signature="MCMT.rx(theta, qubit, *, label=None, q=None)">
  ...
  <Function id="qiskit.circuit.library.MCMT.rxx" signature="MCMT.rxx(theta, qubit1, qubit2)">
  ...
  <Function id="qiskit.circuit.library.MCMT.ry" signature="MCMT.ry(theta, qubit, *, label=None, q=None)">
  ...
  <Function id="qiskit.circuit.library.MCMT.ryy" signature="MCMT.ryy(theta, qubit1, qubit2)">
  ...
  <Function id="qiskit.circuit.library.MCMT.rz" signature="MCMT.rz(phi, qubit, *, q=None)">
  ...
  <Function id="qiskit.circuit.library.MCMT.rzx" signature="MCMT.rzx(theta, qubit1, qubit2)">
  ...
  <Function id="qiskit.circuit.library.MCMT.rzz" signature="MCMT.rzz(theta, qubit1, qubit2)">
  ...
  <Function id="qiskit.circuit.library.MCMT.s" signature="MCMT.s(qubit, *, q=None)">
  ...
  <Function id="qiskit.circuit.library.MCMT.sdg" signature="MCMT.sdg(qubit, *, q=None)">
  ...
  <Function id="qiskit.circuit.library.MCMT.size" signature="MCMT.size()">
  ...
  <span id="mcmt-snapshot" />

  ### snapshot

  <Function id="qiskit.circuit.library.MCMT.snapshot" signature="MCMT.snapshot(label, snapshot_type='statevector', qubits=None, params=None)">
  ...
  <span id="mcmt-snapshot-density-matrix" />

  ### snapshot\_density\_matrix

  <Function id="qiskit.circuit.library.MCMT.snapshot_density_matrix" signature="MCMT.snapshot_density_matrix(label, qubits=None)">
  ...
  <span id="mcmt-snapshot-expectation-value" />

  ### snapshot\_expectation\_value

  <Function id="qiskit.circuit.library.MCMT.snapshot_expectation_value" signature="MCMT.snapshot_expectation_value(label, op, qubits, single_shot=False, variance=False)">
  ...
  <span id="mcmt-snapshot-probabilities" />

  ### snapshot\_probabilities

  <Function id="qiskit.circuit.library.MCMT.snapshot_probabilities" signature="MCMT.snapshot_probabilities(label, qubits, variance=False)">
  ...
  <span id="mcmt-snapshot-stabilizer" />

  ### snapshot\_stabilizer

  <Function id="qiskit.circuit.library.MCMT.snapshot_stabilizer" signature="MCMT.snapshot_stabilizer(label)">
  ...
  <span id="mcmt-snapshot-statevector" />

  ### snapshot\_statevector

  <Function id="qiskit.circuit.library.MCMT.snapshot_statevector" signature="MCMT.snapshot_statevector(label)">
  ...
  <Function id="qiskit.circuit.library.MCMT.squ" signature="MCMT.squ(unitary_matrix, qubit, mode='ZYZ', up_to_diagonal=False, *, u=None)">
  ...
  <Function id="qiskit.circuit.library.MCMT.swap" signature="MCMT.swap(qubit1, qubit2)">
  ...
  <Function id="qiskit.circuit.library.MCMT.t" signature="MCMT.t(qubit, *, q=None)">
  ...
  <Function id="qiskit.circuit.library.MCMT.tdg" signature="MCMT.tdg(qubit, *, q=None)">
    Apply [`TdgGate`](qiskit.circuit.library.TdgGate "qiskit.circuit.library.TdgGate").
  </Function>

  <span id="mcmt-to-gate" />

  ### to\_gate

  <Function id="qiskit.circuit.library.MCMT.to_gate" signature="MCMT.to_gate(parameter_map=None)">
  ...
  <span id="mcmt-to-instruction" />

  ### to\_instruction

  <Function id="qiskit.circuit.library.MCMT.to_instruction" signature="MCMT.to_instruction(parameter_map=None)">
  ...
  <span id="mcmt-toffoli" />

  ### toffoli

  <Function id="qiskit.circuit.library.MCMT.toffoli" signature="MCMT.toffoli(control_qubit1, control_qubit2, target_qubit, *, ctl1=None, ctl2=None, tgt=None)">
    Apply [`CCXGate`](qiskit.circuit.library.CCXGate "qiskit.circuit.library.CCXGate").
  </Function>
  ...
  <Function id="qiskit.circuit.library.MCMT.u1" signature="MCMT.u1(theta, qubit, *, q=None)">
  ...
  <Function id="qiskit.circuit.library.MCMT.u2" signature="MCMT.u2(phi, lam, qubit, *, q=None)">
  ...
  <Function id="qiskit.circuit.library.MCMT.u3" signature="MCMT.u3(theta, phi, lam, qubit, *, q=None)">
  ...
  <Function id="qiskit.circuit.library.MCMT.uc" signature="MCMT.uc(gate_list, q_controls, q_target, up_to_diagonal=False)">
  ...
  <Function id="qiskit.circuit.library.MCMT.ucg" signature="MCMT.ucg(angle_list, q_controls, q_target, up_to_diagonal=False)">
  ...
  <Function id="qiskit.circuit.library.MCMT.ucrx" signature="MCMT.ucrx(angle_list, q_controls, q_target)">
  ...
  <Function id="qiskit.circuit.library.MCMT.ucry" signature="MCMT.ucry(angle_list, q_controls, q_target)">
  ...
  <Function id="qiskit.circuit.library.MCMT.ucrz" signature="MCMT.ucrz(angle_list, q_controls, q_target)">
  ...
  <Function id="qiskit.circuit.library.MCMT.ucx" signature="MCMT.ucx(angle_list, q_controls, q_target)">
  ...
  <Function id="qiskit.circuit.library.MCMT.ucy" signature="MCMT.ucy(angle_list, q_controls, q_target)">
  ...
  <Function id="qiskit.circuit.library.MCMT.ucz" signature="MCMT.ucz(angle_list, q_controls, q_target)">
    Deprecated version of ucrz.
  </Function>

  <span id="mcmt-unitary" />

  ### unitary

  <Function id="qiskit.circuit.library.MCMT.unitary" signature="MCMT.unitary(obj, qubits, label=None)">
  ...
  <Function id="qiskit.circuit.library.MCMT.width" signature="MCMT.width()">
  ...
  <Function id="qiskit.circuit.library.MCMT.x" signature="MCMT.x(qubit, *, label=None, ctrl_state=None, q=None)">
  ...
  <Function id="qiskit.circuit.library.MCMT.y" signature="MCMT.y(qubit, *, q=None)">
  ...
  <Function id="qiskit.circuit.library.MCMT.z" signature="MCMT.z(qubit, *, q=None)">
