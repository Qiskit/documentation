---
title: BackendConfiguration (v0.19)
description: API reference for qiskit.providers.models.BackendConfiguration in qiskit v0.19
...
<Class id="qiskit.providers.models.BackendConfiguration" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.14/qiskit/providers/models/backendconfiguration.py" signature="BackendConfiguration(backend_name, backend_version, n_qubits, basis_gates, gates, local, simulator, conditional, open_pulse, memory, max_shots, coupling_map, max_experiments=None, sample_name=None, n_registers=None, register_map=None, configurable=None, credits_required=None, online_date=None, display_name=None, description=None, tags=None, **kwargs)" modifiers="class">
  ...
  *   **\*\*kwargs** – optional fields
  ...
  <span id="backendconfiguration-num-qubits" />
  ...
  <span id="backendconfiguration-from-dict" />
  ...
  <span id="backendconfiguration-to-dict" />
