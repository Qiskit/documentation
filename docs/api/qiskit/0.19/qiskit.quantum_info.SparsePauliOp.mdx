...
<Class id="qiskit.quantum_info.SparsePauliOp" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.14/qiskit/quantum_info/operators/symplectic/sparse_pauli_op.py" signature="SparsePauliOp(data, coeffs=None)">
  ...
  **QiskitError** – If the input data or coeffs are invalid.
  ...
  <Function id="qiskit.quantum_info.SparsePauliOp.from_list" signature="static SparsePauliOp.from_list(obj)">
  ...
  <Function id="qiskit.quantum_info.SparsePauliOp.set_atol" signature="classmethod SparsePauliOp.set_atol(value)">
    Set the class default absolute tolerance parameter for float comparisons.
  </Function>

  ### set\_rtol

  <Function id="qiskit.quantum_info.SparsePauliOp.set_rtol" signature="classmethod SparsePauliOp.set_rtol(value)">
