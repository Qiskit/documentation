...
<Class id="qiskit.aqua.operators.primitive_ops.MatrixOp" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.7/qiskit/aqua/operators/primitive_ops/matrix_op.py" signature="MatrixOp(primitive=None, coeff=1.0)">
  ...
  *   **ValueError** – invalid parameters.
  ...
  <Attribute id="qiskit.aqua.operators.primitive_ops.MatrixOp.coeff" name="coeff" signature="Union[int, float, complex, qiskit.circuit.parameterexpression.ParameterExpression]">
  ...
  <Attribute id="qiskit.aqua.operators.primitive_ops.MatrixOp.num_qubits" name="num_qubits" signature="int">
  ...
  <Attribute id="qiskit.aqua.operators.primitive_ops.MatrixOp.primitive" name="primitive" signature="Union[qiskit.circuit.instruction.Instruction, qiskit.circuit.quantumcircuit.QuantumCircuit, list, numpy.ndarray, scipy.sparse.base.spmatrix, qiskit.quantum_info.operators.operator.Operator, qiskit.quantum_info.operators.pauli.Pauli]">
  ...
  <Function id="qiskit.aqua.operators.primitive_ops.MatrixOp.__mul__" name="__mul__" signature="MatrixOp.__mul__(other)">
  ...
  <Function id="qiskit.aqua.operators.primitive_ops.MatrixOp.add" name="add" signature="MatrixOp.add(other)">
  ...
  <Function id="qiskit.aqua.operators.primitive_ops.MatrixOp.adjoint" name="adjoint" signature="MatrixOp.adjoint()">
  ...
  <Function id="qiskit.aqua.operators.primitive_ops.MatrixOp.assign_parameters" name="assign_parameters" signature="MatrixOp.assign_parameters(param_dict)">
  ...
  <Function id="qiskit.aqua.operators.primitive_ops.MatrixOp.bind_parameters" name="bind_parameters" signature="MatrixOp.bind_parameters(param_dict)">
  ...
  <Function id="qiskit.aqua.operators.primitive_ops.MatrixOp.compose" name="compose" signature="MatrixOp.compose(other)">
  ...
  <Function id="qiskit.aqua.operators.primitive_ops.MatrixOp.equals" name="equals" signature="MatrixOp.equals(other)">
  ...
  <Function id="qiskit.aqua.operators.primitive_ops.MatrixOp.eval" name="eval" signature="MatrixOp.eval(front=None)">
  ...
  <Function id="qiskit.aqua.operators.primitive_ops.MatrixOp.exp_i" name="exp_i" signature="MatrixOp.exp_i()">
  ...
  <Function id="qiskit.aqua.operators.primitive_ops.MatrixOp.log_i" name="log_i" signature="MatrixOp.log_i(massive=False)">
  ...
  <Function id="qiskit.aqua.operators.primitive_ops.MatrixOp.mul" name="mul" signature="MatrixOp.mul(scalar)">
  ...
  <Function id="qiskit.aqua.operators.primitive_ops.MatrixOp.neg" name="neg" signature="MatrixOp.neg()">
  ...
  <Function id="qiskit.aqua.operators.primitive_ops.MatrixOp.power" name="power" signature="MatrixOp.power(exponent)">
  ...
  <Function id="qiskit.aqua.operators.primitive_ops.MatrixOp.primitive_strings" name="primitive_strings" signature="MatrixOp.primitive_strings()">
  ...
  <Function id="qiskit.aqua.operators.primitive_ops.MatrixOp.reduce" name="reduce" signature="MatrixOp.reduce()">
  ...
  <Function id="qiskit.aqua.operators.primitive_ops.MatrixOp.tensor" name="tensor" signature="MatrixOp.tensor(other)">
  ...
  <Function id="qiskit.aqua.operators.primitive_ops.MatrixOp.tensorpower" name="tensorpower" signature="MatrixOp.tensorpower(other)">
  ...
  <Function id="qiskit.aqua.operators.primitive_ops.MatrixOp.to_circuit" name="to_circuit" signature="MatrixOp.to_circuit()">
  ...
  <Function id="qiskit.aqua.operators.primitive_ops.MatrixOp.to_circuit_op" name="to_circuit_op" signature="MatrixOp.to_circuit_op()">
  ...
  <Function id="qiskit.aqua.operators.primitive_ops.MatrixOp.to_instruction" name="to_instruction" signature="MatrixOp.to_instruction()">
  ...
  <Function id="qiskit.aqua.operators.primitive_ops.MatrixOp.to_legacy_op" name="to_legacy_op" signature="MatrixOp.to_legacy_op(massive=False)">
  ...
  <Function id="qiskit.aqua.operators.primitive_ops.MatrixOp.to_matrix" name="to_matrix" signature="MatrixOp.to_matrix(massive=False)">
  ...
  <Function id="qiskit.aqua.operators.primitive_ops.MatrixOp.to_matrix_op" name="to_matrix_op" signature="MatrixOp.to_matrix_op(massive=False)">
  ...
  <Function id="qiskit.aqua.operators.primitive_ops.MatrixOp.to_pauli_op" name="to_pauli_op" signature="MatrixOp.to_pauli_op(massive=False)">
