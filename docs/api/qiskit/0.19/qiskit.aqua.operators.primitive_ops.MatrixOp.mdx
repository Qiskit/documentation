---
title: MatrixOp (v0.19)
description: API reference for qiskit.aqua.operators.primitive_ops.MatrixOp in qiskit v0.19
...
<Class id="qiskit.aqua.operators.primitive_ops.MatrixOp" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.7/qiskit/aqua/operators/primitive_ops/matrix_op.py" signature="MatrixOp(primitive=None, coeff=1.0)" modifiers="class">
  ...
  *   **ValueError** – invalid parameters.
  ...
  <span id="matrixop-assign-parameters" />
  ...
  <span id="matrixop-bind-parameters" />
  ...
  <span id="matrixop-primitive-strings" />
  ...
  <span id="matrixop-to-circuit-op" />
  ...
  <span id="matrixop-to-instruction" />
