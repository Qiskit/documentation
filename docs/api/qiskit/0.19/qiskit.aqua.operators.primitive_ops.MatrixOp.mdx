...
<Class id="qiskit.aqua.operators.primitive_ops.MatrixOp" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.7/qiskit/aqua/operators/primitive_ops/matrix_op.py" signature="MatrixOp(primitive=None, coeff=1.0)">
  ...
  *   **ValueError** – invalid parameters.
  ...
  <Attribute id="qiskit.aqua.operators.primitive_ops.MatrixOp.coeff" signature="Union[int, float, complex, qiskit.circuit.parameterexpression.ParameterExpression]">
  ...
  <Attribute id="qiskit.aqua.operators.primitive_ops.MatrixOp.num_qubits" signature="int">
  ...
  <Attribute id="qiskit.aqua.operators.primitive_ops.MatrixOp.primitive" signature="Union[qiskit.circuit.instruction.Instruction, qiskit.circuit.quantumcircuit.QuantumCircuit, list, numpy.ndarray, scipy.sparse.base.spmatrix, qiskit.quantum_info.operators.operator.Operator, qiskit.quantum_info.operators.pauli.Pauli]">
