...
`Permutation(num_qubits, pattern=None, seed=None)` [GitHub](https://github.com/qiskit/qiskit/tree/stable/0.14/qiskit/circuit/library/generalized_gates/permutation.py "view source code")
...
<span id="qiskit.circuit.library.Permutation.AND" />

`Permutation.AND(qr_variables, qb_target, qr_ancillae, flags=None, mct_mode='no-ancilla')`
...
<span id="qiskit.circuit.library.Permutation.OR" />

`Permutation.OR(qr_variables, qb_target, qr_ancillae, flags=None, mct_mode='basic')`
...
`Permutation.append(instruction, qargs=None, cargs=None)`
...
`Permutation.cbit_argument_conversion(clbit_representation)`
...
`Permutation.ccx(control_qubit1, control_qubit2, target_qubit, *, ctl1=None, ctl2=None, tgt=None)`
...
`Permutation.ch(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)`
...
`Permutation.cnot(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)`
...
`Permutation.compose(other, qubits=None, clbits=None, front=False, inplace=False)`
...
`Permutation.crx(theta, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)`
...
`Permutation.cry(theta, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)`
...
`Permutation.crz(theta, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)`
...
`Permutation.cswap(control_qubit, target_qubit1, target_qubit2, *, label=None, ctrl_state=None, ctl=None, tgt1=None, tgt2=None)`
...
`Permutation.cu1(theta, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)`
...
`Permutation.cu3(theta, phi, lam, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)`
...
`Permutation.cx(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)`
...
`Permutation.cy(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)`
...
`Permutation.cz(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)`
...
`Permutation.draw(output=None, scale=0.7, filename=None, style=None, interactive=False, line_length=None, plot_barriers=True, reverse_bits=False, justify=None, vertical_compression='medium', idle_wires=True, with_layout=True, fold=None, ax=None, initial_state=False, cregbundle=False)`
...
`Permutation.fredkin(control_qubit, target_qubit1, target_qubit2, *, ctl=None, tgt1=None, tgt2=None)`
...
`static Permutation.from_qasm_file(path)`
...
`static Permutation.from_qasm_str(qasm_str)`
...
`Permutation.hamiltonian(operator, time, qubits, label=None)`
...
`Permutation.iso(isometry, q_input, q_ancillas_for_output, q_ancillas_zero=None, q_ancillas_dirty=None)`
...
`Permutation.isometry(isometry, q_input, q_ancillas_for_output, q_ancillas_zero=None, q_ancillas_dirty=None)`
...
`Permutation.mcmt(gate, control_qubits, target_qubits, ancilla_qubits=None, mode='no-ancilla', *, single_control_gate_fun=None, q_controls=None, q_ancillae=None, q_targets=None)`
...
`Permutation.mcrx(theta, q_controls, q_target, use_basis_gates=False)`
...
`Permutation.mcry(theta, q_controls, q_target, q_ancillae, mode='basic', use_basis_gates=False)`
...
`Permutation.mcrz(lam, q_controls, q_target, use_basis_gates=False)`
...
`Permutation.mcu1(lam, control_qubits, target_qubit)`
...
`Permutation.mcx(control_qubits, target_qubit, ancilla_qubits=None, mode='noancilla')`
...
`Permutation.measure_active(inplace=True)`
...
`Permutation.measure_all(inplace=True)`
...
`Permutation.num_connected_components(unitary_only=False)`
...
`Permutation.qasm(formatted=False, filename=None)`
...
`Permutation.qbit_argument_conversion(qubit_representation)`
...
`Permutation.r(theta, phi, qubit, *, q=None)`
...
`Permutation.rcccx(control_qubit1, control_qubit2, control_qubit3, target_qubit)`
...
`Permutation.rccx(control_qubit1, control_qubit2, target_qubit)`
...
`Permutation.remove_final_measurements(inplace=True)`
...
`Permutation.rx(theta, qubit, *, label=None, q=None)`
...
`Permutation.ry(theta, qubit, *, label=None, q=None)`
...
`Permutation.rz(phi, qubit, *, q=None)`
...
`Permutation.snapshot(label, snapshot_type='statevector', qubits=None, params=None)`
...
`Permutation.snapshot_density_matrix(label, qubits=None)`
...
`Permutation.snapshot_expectation_value(label, op, qubits, single_shot=False, variance=False)`
...
`Permutation.snapshot_probabilities(label, qubits, variance=False)`
...
`Permutation.squ(unitary_matrix, qubit, mode='ZYZ', up_to_diagonal=False, *, u=None)`
...
`Permutation.to_gate(parameter_map=None)`
...
`Permutation.toffoli(control_qubit1, control_qubit2, target_qubit, *, ctl1=None, ctl2=None, tgt=None)`
...
`Permutation.u2(phi, lam, qubit, *, q=None)`
...
`Permutation.u3(theta, phi, lam, qubit, *, q=None)`
...
`Permutation.uc(gate_list, q_controls, q_target, up_to_diagonal=False)`
...
<span id="qiskit.circuit.library.Permutation.ucg" />

`Permutation.ucg(angle_list, q_controls, q_target, up_to_diagonal=False)`
...
`Permutation.ucrx(angle_list, q_controls, q_target)`
...
`Permutation.ucry(angle_list, q_controls, q_target)`
...
<span id="qiskit.circuit.library.Permutation.ucz" />
...
`Permutation.x(qubit, *, label=None, ctrl_state=None, q=None)`
