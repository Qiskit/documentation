...
$$
  ...
  *   **name** (`Optional`\[`str`]) – Display name for this pulse envelope.
  ...
  <Attribute id="qiskit.pulse.pulse_lib.Gaussian.amp" signature="complex">
  ...
  <Attribute id="qiskit.pulse.pulse_lib.Gaussian.id" signature="int">
  ...
  <Attribute id="qiskit.pulse.pulse_lib.Gaussian.parameters" signature="Dict[str, Any]">
  ...
  <Attribute id="qiskit.pulse.pulse_lib.Gaussian.sigma" signature="float">
