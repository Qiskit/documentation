...
<Class id="qiskit.pulse.pulse_lib.Gaussian" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.14/qiskit/pulse/pulse_lib/parametric_pulses.py" signature="Gaussian(duration, amp, sigma, name=None)">
...
$$
  ...
  *   **name** (`Optional`\[`str`]) – Display name for this pulse envelope.
  ...
  <Attribute id="qiskit.pulse.pulse_lib.Gaussian.amp" name="amp" signature="complex">
  ...
  <Attribute id="qiskit.pulse.pulse_lib.Gaussian.id" name="id" signature="int">
  ...
  <Attribute id="qiskit.pulse.pulse_lib.Gaussian.parameters" name="parameters" signature="Dict[str, Any]">
  ...
  <Attribute id="qiskit.pulse.pulse_lib.Gaussian.sigma" name="sigma" signature="float">
  ...
  <Function id="qiskit.pulse.pulse_lib.Gaussian.__call__" name="__call__" signature="Gaussian.__call__(channel)">
    Call self as a function.
  </Function>

  ### draw

  <Function id="qiskit.pulse.pulse_lib.Gaussian.draw" name="draw" signature="Gaussian.draw(dt=1, style=None, filename=None, interp_method=None, scale=1, interactive=False, scaling=None)">
    Plot the pulse.
  ...
  <Function id="qiskit.pulse.pulse_lib.Gaussian.get_sample_pulse" name="get_sample_pulse" signature="Gaussian.get_sample_pulse()">
  ...
  <Function id="qiskit.pulse.pulse_lib.Gaussian.validate_parameters" name="validate_parameters" signature="Gaussian.validate_parameters()">
    Validate parameters.
