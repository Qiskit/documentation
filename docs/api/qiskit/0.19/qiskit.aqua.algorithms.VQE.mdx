...
<Class id="qiskit.aqua.algorithms.VQE" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.7/qiskit/aqua/algorithms/minimum_eigen_solvers/vqe.py" signature="VQE(operator=None, var_form=None, optimizer=None, initial_point=None, expectation=None, include_custom=False, max_evals_grouped=1, aux_operators=None, callback=None, quantum_instance=None)">
  ...
  *   **quantum\_instance** (`Union`\[[`QuantumInstance`](qiskit.aqua.QuantumInstance "qiskit.aqua.quantum_instance.QuantumInstance"), [`BaseBackend`](qiskit.providers.BaseBackend "qiskit.providers.basebackend.BaseBackend"), `None`]) – Quantum Instance or Backend
  ...
  <Attribute id="qiskit.aqua.algorithms.VQE.aux_operators" signature="Optional[List[Optional[qiskit.aqua.operators.operator_base.OperatorBase]]]">
  ...
  <Attribute id="qiskit.aqua.algorithms.VQE.backend" signature="qiskit.providers.basebackend.BaseBackend">
    Returns backend.
  ...
  <Attribute id="qiskit.aqua.algorithms.VQE.expectation" signature="qiskit.aqua.operators.expectations.expectation_base.ExpectationBase">
  ...
  <Attribute id="qiskit.aqua.algorithms.VQE.initial_point" signature="Optional[numpy.ndarray]">
  ...
  <Attribute id="qiskit.aqua.algorithms.VQE.operator" signature="Optional[qiskit.aqua.operators.operator_base.OperatorBase]">
    Returns operator
  ...
  <Attribute id="qiskit.aqua.algorithms.VQE.optimal_params" signature="List[float]">
  ...
  <Attribute id="qiskit.aqua.algorithms.VQE.optimizer" signature="Optional[qiskit.aqua.components.optimizers.optimizer.Optimizer]">
    Returns optimizer
  ...
  <Attribute id="qiskit.aqua.algorithms.VQE.quantum_instance" signature="Union[None, qiskit.aqua.quantum_instance.QuantumInstance]">
  ...
  <Attribute id="qiskit.aqua.algorithms.VQE.var_form" signature="Optional[Union[qiskit.circuit.quantumcircuit.QuantumCircuit, qiskit.aqua.components.variational_forms.variational_form.VariationalForm]]">
