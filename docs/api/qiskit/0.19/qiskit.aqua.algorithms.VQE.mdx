---
title: VQE (v0.19)
description: API reference for qiskit.aqua.algorithms.VQE in qiskit v0.19
...
<Class id="qiskit.aqua.algorithms.VQE" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.7/qiskit/aqua/algorithms/minimum_eigen_solvers/vqe.py" signature="VQE(operator=None, var_form=None, optimizer=None, initial_point=None, expectation=None, include_custom=False, max_evals_grouped=1, aux_operators=None, callback=None, quantum_instance=None)" modifiers="class">
  ...
  *   **quantum\_instance** (`Union`\[[`QuantumInstance`](qiskit.aqua.QuantumInstance "qiskit.aqua.quantum_instance.QuantumInstance"), [`BaseBackend`](qiskit.providers.BaseBackend "qiskit.providers.basebackend.BaseBackend"), `None`]) – Quantum Instance or Backend
  ...
  <span id="vqe-aux-operators" />

  ### aux\_operators

  <Attribute id="qiskit.aqua.algorithms.VQE.aux_operators" attributeTypeHint="Optional[List[Optional[qiskit.aqua.operators.operator_base.OperatorBase]]]">
  ...
  <Attribute id="qiskit.aqua.algorithms.VQE.backend" attributeTypeHint="qiskit.providers.basebackend.BaseBackend">
    Returns backend.
  ...
  <span id="vqe-expectation" />

  ### expectation

  <Attribute id="qiskit.aqua.algorithms.VQE.expectation" attributeTypeHint="qiskit.aqua.operators.expectations.expectation_base.ExpectationBase">
  ...
  <span id="vqe-initial-point" />

  ### initial\_point

  <Attribute id="qiskit.aqua.algorithms.VQE.initial_point" attributeTypeHint="Optional[numpy.ndarray]">
  ...
  <span id="vqe-operator" />

  ### operator

  <Attribute id="qiskit.aqua.algorithms.VQE.operator" attributeTypeHint="Optional[qiskit.aqua.operators.operator_base.OperatorBase]">
    Returns operator
  ...
  <span id="vqe-optimal-params" />

  ### optimal\_params

  <Attribute id="qiskit.aqua.algorithms.VQE.optimal_params" attributeTypeHint="List[float]">
  ...
  <span id="vqe-optimizer" />

  ### optimizer

  <Attribute id="qiskit.aqua.algorithms.VQE.optimizer" attributeTypeHint="Optional[qiskit.aqua.components.optimizers.optimizer.Optimizer]">
    Returns optimizer
  ...
  <span id="vqe-quantum-instance" />

  ### quantum\_instance

  <Attribute id="qiskit.aqua.algorithms.VQE.quantum_instance" attributeTypeHint="Union[None, qiskit.aqua.quantum_instance.QuantumInstance]">
  ...
  <span id="vqe-var-form" />

  ### var\_form

  <Attribute id="qiskit.aqua.algorithms.VQE.var_form" attributeTypeHint="Optional[Union[qiskit.circuit.quantumcircuit.QuantumCircuit, qiskit.aqua.components.variational_forms.variational_form.VariationalForm]]">
  ...
  <span id="vqe-cleanup-parameterized-circuits" />
  ...
  <span id="vqe-compute-minimum-eigenvalue" />
  ...
  <span id="vqe-get-optimal-circuit" />
  ...
  <span id="vqe-get-optimal-vector" />
  ...
  <span id="vqe-get-prob-vector-for-params" />
  ...
  <span id="vqe-get-probabilities-for-counts" />
  ...
  <span id="vqe-supports-aux-operators" />

  ### supports\_aux\_operators

  <Function id="qiskit.aqua.algorithms.VQE.supports_aux_operators" signature="VQE.supports_aux_operators()">
