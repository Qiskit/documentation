...
<Class id="qiskit.validation.BaseSchema" github="https://github.com/qiskit/qiskit/tree/stable/0.14/qiskit/validation/base.py" signature="BaseSchema(*, only=None, exclude=(), many=False, context=None, load_only=(), dump_only=(), partial=False, unknown=None)">
  ...
  *   handling of unknown attributes not defined in the schema.
  ...
  <Attribute id="" name="constructor is passed all named parameters from deserialization." />
  ...
  <Attribute id="qiskit.validation.BaseSchema.dict_class" signature="type">
    **Return type**
  ...
  <Attribute id="qiskit.validation.BaseSchema.set_class" signature="type">
    **Return type**
