---
title: BaseSchema (v0.19)
description: API reference for qiskit.validation.BaseSchema in qiskit v0.19
...
<Class id="qiskit.validation.BaseSchema" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.14/qiskit/validation/base.py" signature="BaseSchema(*, only=None, exclude=(), many=False, context=None, load_only=(), dump_only=(), partial=False, unknown=None)" modifiers="class">
  ...
  *   handling of unknown attributes not defined in the schema.
  ...
  <span id="baseschema-type-mapping" />
  ...
  <span id="baseschema-error-messages" />
  ...
  <span id="baseschema-dump-additional-data" />
  ...
  <span id="baseschema-get-attribute" />
  ...
  <span id="baseschema-handle-error" />
  ...
  <span id="baseschema-on-bind-field" />
