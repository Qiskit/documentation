---
title: StateVectorCircuit (v0.19)
description: API reference for qiskit.aqua.circuits.StateVectorCircuit in qiskit v0.19
...
<Class id="qiskit.aqua.circuits.StateVectorCircuit" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.7/qiskit/aqua/circuits/statevector_circuit.py" signature="StateVectorCircuit(state_vector)" modifiers="class">
  ...
  **Raises**
  ...
  <span id="statevectorcircuit-construct-circuit" />
