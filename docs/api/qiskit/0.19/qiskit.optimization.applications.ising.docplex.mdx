---
title: docplex (v0.19)
description: API reference for qiskit.optimization.applications.ising.docplex in qiskit v0.19
...
<Function id="qiskit.optimization.applications.ising.docplex.get_operator" github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.7/qiskit/optimization/applications/ising/docplex.py" signature="get_operator(mdl, auto_penalty=True, default_penalty=100000.0)">
