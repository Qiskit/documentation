---
title: Layout2qDistance (v0.19)
description: API reference for qiskit.transpiler.passes.Layout2qDistance in qiskit v0.19
...
<Class id="qiskit.transpiler.passes.Layout2qDistance" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.14/qiskit/transpiler/passes/layout/layout_2q_distance.py" signature="Layout2qDistance(*args, **kwargs)" modifiers="class">
  ...
  *   **property\_name** (*str*) – The property name to save the score. Default: layout\_score
  ...
  <span id="layout2qdistance-is-analysis-pass" />
  ...
  <span id="layout2qdistance-is-transformation-pass" />
