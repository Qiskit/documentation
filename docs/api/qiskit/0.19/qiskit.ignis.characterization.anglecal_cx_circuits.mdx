...
<Function id="qiskit.ignis.characterization.anglecal_cx_circuits" name="anglecal_cx_circuits" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-ignis/tree/stable/0.3/qiskit/ignis/characterization/gates/circuits.py" signature="anglecal_cx_circuits(max_reps, qubits, control_qubits, angleerr=0.0)">
