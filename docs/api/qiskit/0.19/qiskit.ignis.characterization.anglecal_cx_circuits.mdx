---
title: anglecal_cx_circuits (v0.19)
description: API reference for qiskit.ignis.characterization.anglecal_cx_circuits in qiskit v0.19
in_page_toc_min_heading_level: 1
python_api_type: function
python_api_name: qiskit.ignis.characterization.anglecal_cx_circuits
---

<span id="anglecal-cx-circuits" />

# anglecal\_cx\_circuits

<Function id="qiskit.ignis.characterization.anglecal_cx_circuits" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-ignis/tree/stable/0.3/qiskit/ignis/characterization/gates/circuits.py" signature="anglecal_cx_circuits(max_reps, qubits, control_qubits, angleerr=0.0)">
