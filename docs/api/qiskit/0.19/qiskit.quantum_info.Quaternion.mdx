---
title: Quaternion (v0.19)
description: API reference for qiskit.quantum_info.Quaternion in qiskit v0.19
...
<Class id="qiskit.quantum_info.Quaternion" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.14/qiskit/quantum_info/operators/quaternion.py" signature="Quaternion(data)" modifiers="class">
  ...
  <span id="quaternion-from-axis-rotation" />
