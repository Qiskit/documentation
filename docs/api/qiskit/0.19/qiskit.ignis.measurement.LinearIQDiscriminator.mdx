---
title: LinearIQDiscriminator (v0.19)
description: API reference for qiskit.ignis.measurement.LinearIQDiscriminator in qiskit v0.19
...
<Class id="qiskit.ignis.measurement.LinearIQDiscriminator" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-ignis/tree/stable/0.3/qiskit/ignis/measurement/discriminator/iq_discriminators.py" signature="LinearIQDiscriminator(cal_results, qubit_mask, expected_states=None, standardize=False, schedules=None, discriminator_parameters=None)" modifiers="class">
  ...
  *   **discriminator\_parameters** (*dict*) – parameters for Sklearn’s LDA.
  ...
  <span id="lineariqdiscriminator-expected-states" />
  ...
  <span id="lineariqdiscriminator-fitted" />
  ...
  <span id="lineariqdiscriminator-schedules" />
  ...
  <span id="lineariqdiscriminator-add-data" />
  ...
  <span id="lineariqdiscriminator-discriminate" />
  ...
  <span id="lineariqdiscriminator-fit" />
  ...
  <span id="lineariqdiscriminator-format-iq-data" />
  ...
  <span id="lineariqdiscriminator-get-xdata" />
  ...
  <span id="lineariqdiscriminator-get-ydata" />
  ...
  <span id="lineariqdiscriminator-is-calibration" />
  ...
  <span id="lineariqdiscriminator-plot" />
  ...
  <span id="lineariqdiscriminator-plot-xdata" />
