---
title: IgnisLogReader (v0.19)
description: API reference for qiskit.ignis.logging.IgnisLogReader in qiskit v0.19
...
<Class id="qiskit.ignis.logging.IgnisLogReader" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-ignis/tree/stable/0.3/qiskit/ignis/logging/ignis_logging.py" signature="IgnisLogReader" modifiers="class">
  ...
  <span id="ignislogreader-get-log-files" />
  ...
  <span id="ignislogreader-read-values" />
