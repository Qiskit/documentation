...
<Class id="qiskit.optimization.converters.QuadraticProgramToNegativeValueOracle" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/0.7.3/qiskit/optimization/converters/quadratic_program_to_negative_value_oracle.py" signature="QuadraticProgramToNegativeValueOracle(num_value_qubits, measurement=False)">
  ...
  *   **measurement** (`bool`) – Whether the A operator contains measurements.
  ...
  <Function id="qiskit.optimization.converters.QuadraticProgramToNegativeValueOracle.encode" name="encode" signature="QuadraticProgramToNegativeValueOracle.encode(problem)">
