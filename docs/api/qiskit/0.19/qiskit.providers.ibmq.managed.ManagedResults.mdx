---
title: ManagedResults (v0.19)
description: API reference for qiskit.providers.ibmq.managed.ManagedResults in qiskit v0.19
...
<Class id="qiskit.providers.ibmq.managed.ManagedResults" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-ibmq-provider/tree/stable/0.7/qiskit/providers/ibmq/managed/managedresults.py" signature="ManagedResults(job_set, backend_name, success)" modifiers="class">
  ...
  *   **success** (`bool`) – `True` if all experiments were successful and results available. `False` otherwise.
  ...
  <span id="managedresults-get-counts" />
  ...
  <span id="managedresults-get-memory" />
  ...
  <span id="managedresults-get-statevector" />
  ...
  <span id="managedresults-get-unitary" />
