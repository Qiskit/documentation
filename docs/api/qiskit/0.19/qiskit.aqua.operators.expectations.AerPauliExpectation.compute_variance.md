...
description: API reference for qiskit.aqua.operators.expectations.AerPauliExpectation.compute_variance
in_page_toc_min_heading_level: 1
python_api_type: method
python_api_name: qiskit.aqua.operators.expectations.AerPauliExpectation.compute_variance
---
