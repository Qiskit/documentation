...
<Function id="qiskit.providers.aer.noise.coherent_unitary_error" name="coherent_unitary_error" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-aer/tree/stable/0.5/qiskit/providers/aer/noise/errors/standard_errors.py" signature="coherent_unitary_error(unitary)">
