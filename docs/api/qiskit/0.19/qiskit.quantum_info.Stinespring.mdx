---
title: Stinespring (v0.19)
description: API reference for qiskit.quantum_info.Stinespring in qiskit v0.19
...
$$
  ...
  **Additional Information:**
  ...
  <span id="stinespring-num-qubits" />
  ...
  <span id="stinespring-input-dims" />
  ...
  <span id="stinespring-is-unitary" />
  ...
  <span id="stinespring-output-dims" />
  ...
  <span id="stinespring-to-instruction" />
  ...
  <span id="stinespring-to-operator" />
