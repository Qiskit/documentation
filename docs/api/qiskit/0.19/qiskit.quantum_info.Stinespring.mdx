...
$$
  ...
  **Additional Information:**
  ...
  <Function id="qiskit.quantum_info.Stinespring.set_atol" signature="classmethod Stinespring.set_atol(value)">
    Set the class default absolute tolerance parameter for float comparisons.
  </Function>

  ### set\_rtol

  <Function id="qiskit.quantum_info.Stinespring.set_rtol" signature="classmethod Stinespring.set_rtol(value)">
