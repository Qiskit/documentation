...
<Class id="qiskit.pulse.instructions.Delay" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.14/qiskit/pulse/instructions/delay.py" signature="Delay(duration, channel=None, name=None)">
  ...
  *   **name** (`Optional`\[`str`]) – Name of the delay for display purposes.
  ...
  <Attribute id="qiskit.pulse.instructions.Delay.channel" signature="qiskit.pulse.channels.Channel">
  ...
  <Attribute id="qiskit.pulse.instructions.Delay.channels" signature="Tuple[qiskit.pulse.channels.Channel]">
  ...
  <Attribute id="qiskit.pulse.instructions.Delay.command" signature="qiskit.pulse.commands.command.Command">
  ...
  <Attribute id="qiskit.pulse.instructions.Delay.duration" signature="int">
  ...
  <Attribute id="qiskit.pulse.instructions.Delay.id" signature="int">
  ...
  <Attribute id="qiskit.pulse.instructions.Delay.instructions" signature="Tuple[Tuple[int, qiskit.pulse.instructions.instruction.Instruction]]">
  ...
  <Attribute id="qiskit.pulse.instructions.Delay.name" signature="str">
  ...
  <Attribute id="qiskit.pulse.instructions.Delay.operands" signature="Tuple">
  ...
  <Attribute id="qiskit.pulse.instructions.Delay.start_time" signature="int">
  ...
  <Attribute id="qiskit.pulse.instructions.Delay.stop_time" signature="int">
  ...
  <Attribute id="qiskit.pulse.instructions.Delay.timeslots" signature="Dict[qiskit.pulse.channels.Channel, List[Tuple[int, int]]]">
