...
<Class id="qiskit.circuit.library.ZFeatureMap" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.14/qiskit/circuit/library/data_preparation/z_feature_map.py" signature="ZFeatureMap(feature_dimension, reps=2, data_map_func=None, insert_barriers=False)">
  ...
  *   **insert\_barriers** (`bool`) – If True, barriers are inserted in between the evolution instructions and hadamard layers.
  ...
  <Attribute id="qiskit.circuit.library.ZFeatureMap.clbits" name="clbits">
    Returns a list of classical bits in the order that the registers were added.
  </Attribute>

  ### data

  <Attribute id="qiskit.circuit.library.ZFeatureMap.data" name="data">
  ...
  <Attribute id="qiskit.circuit.library.ZFeatureMap.entanglement" name="entanglement" signature="Union[str, List[str], List[List[str]], List[int], List[List[int]], List[List[List[int]]], List[List[List[List[int]]]], Callable[[int], str], Callable[[int], List[List[int]]]]">
  ...
  <Attribute id="qiskit.circuit.library.ZFeatureMap.entanglement_blocks" name="entanglement_blocks">
  ...
  <Attribute id="qiskit.circuit.library.ZFeatureMap.extension_lib" signature="= 'include \&#x22;qelib1.inc\&#x22;;'" />

  ### feature\_dimension

  <Attribute id="qiskit.circuit.library.ZFeatureMap.feature_dimension" name="feature_dimension" signature="int">
  ...
  <Attribute id="qiskit.circuit.library.ZFeatureMap.header" signature="= 'OPENQASM 2.0;'" />

  ### initial\_state

  <Attribute id="qiskit.circuit.library.ZFeatureMap.initial_state" name="initial_state" signature="Any">
  ...
  <Attribute id="qiskit.circuit.library.ZFeatureMap.insert_barriers" name="insert_barriers" signature="bool">
  ...
  <Attribute id="qiskit.circuit.library.ZFeatureMap.instances" signature="= 8" />

  ### n\_qubits

  <Attribute id="qiskit.circuit.library.ZFeatureMap.n_qubits" name="n_qubits">
    Deprecated, use `num_qubits` instead. Return number of qubits.
  </Attribute>

  ### num\_clbits

  <Attribute id="qiskit.circuit.library.ZFeatureMap.num_clbits" name="num_clbits">
    Return number of classical bits.
  </Attribute>

  ### num\_layers

  <Attribute id="qiskit.circuit.library.ZFeatureMap.num_layers" name="num_layers" signature="int">
  ...
  <Attribute id="qiskit.circuit.library.ZFeatureMap.num_parameters" name="num_parameters">
    Convenience function to get the number of parameter objects in the circuit.
  </Attribute>

  ### num\_parameters\_settable

  <Attribute id="qiskit.circuit.library.ZFeatureMap.num_parameters_settable" name="num_parameters_settable">
    The number of distinct parameters.
  </Attribute>

  ### num\_qubits

  <Attribute id="qiskit.circuit.library.ZFeatureMap.num_qubits" name="num_qubits" signature="int">
  ...
  <Attribute id="qiskit.circuit.library.ZFeatureMap.ordered_parameters" name="ordered_parameters" signature="List[qiskit.circuit.parameter.Parameter]">
  ...
  <Attribute id="qiskit.circuit.library.ZFeatureMap.parameter_bounds" name="parameter_bounds" signature="Optional[List[Tuple[float, float]]]">
  ...
  <Attribute id="qiskit.circuit.library.ZFeatureMap.parameters" name="parameters" signature="Set[qiskit.circuit.parameter.Parameter]">
  ...
  <Attribute id="qiskit.circuit.library.ZFeatureMap.paulis" name="paulis" signature="List[str]">
  ...
  <Attribute id="qiskit.circuit.library.ZFeatureMap.preferred_init_points" name="preferred_init_points" signature="Optional[List[float]]">
  ...
  <Attribute id="qiskit.circuit.library.ZFeatureMap.prefix" signature="= 'circuit'" />

  ### qregs

  <Attribute id="qiskit.circuit.library.ZFeatureMap.qregs" name="qregs">
    A list of the quantum registers associated with the circuit.
  </Attribute>

  ### qubits

  <Attribute id="qiskit.circuit.library.ZFeatureMap.qubits" name="qubits">
    Returns a list of quantum bits in the order that the registers were added.
  </Attribute>

  ### reps

  <Attribute id="qiskit.circuit.library.ZFeatureMap.reps" name="reps" signature="int">
  ...
  <Attribute id="qiskit.circuit.library.ZFeatureMap.rotation_blocks" name="rotation_blocks" signature="List[qiskit.circuit.instruction.Instruction]">
  ...
  <Function id="qiskit.circuit.library.ZFeatureMap.AND" name="AND" signature="ZFeatureMap.AND(qr_variables, qb_target, qr_ancillae, flags=None, mct_mode='no-ancilla')">
  ...
  <Function id="qiskit.circuit.library.ZFeatureMap.OR" name="OR" signature="ZFeatureMap.OR(qr_variables, qb_target, qr_ancillae, flags=None, mct_mode='basic')">
  ...
  <Function id="qiskit.circuit.library.ZFeatureMap.__getitem__" name="__getitem__" signature="ZFeatureMap.__getitem__(item)">
    Return indexed operation.
  </Function>

  ### \_\_len\_\_

  <Function id="qiskit.circuit.library.ZFeatureMap.__len__" name="__len__" signature="ZFeatureMap.__len__()">
    Return number of operations in circuit.
  </Function>

  ### add\_layer

  <Function id="qiskit.circuit.library.ZFeatureMap.add_layer" name="add_layer" signature="ZFeatureMap.add_layer(other, entanglement=None, front=False)">
  ...
  <Function id="qiskit.circuit.library.ZFeatureMap.add_register" name="add_register" signature="ZFeatureMap.add_register(*regs)">
    Add registers.
  </Function>

  ### append

  <Function id="qiskit.circuit.library.ZFeatureMap.append" name="append" signature="ZFeatureMap.append(instruction, qargs=None, cargs=None)">
  ...
  <Function id="qiskit.circuit.library.ZFeatureMap.assign_parameters" name="assign_parameters" signature="ZFeatureMap.assign_parameters(param_dict, inplace=False)">
  ...
  <Function id="qiskit.circuit.library.ZFeatureMap.barrier" name="barrier" signature="ZFeatureMap.barrier(*qargs)">
    Apply `Barrier`. If qargs is None, applies to all.
  </Function>

  ### bind\_parameters

  <Function id="qiskit.circuit.library.ZFeatureMap.bind_parameters" name="bind_parameters" signature="ZFeatureMap.bind_parameters(value_dict)">
  ...
  <Function id="qiskit.circuit.library.ZFeatureMap.cast" name="cast" signature="static ZFeatureMap.cast(value, _type)">
    Best effort to cast value to type. Otherwise, returns the value.
  </Function>

  ### cbit\_argument\_conversion

  <Function id="qiskit.circuit.library.ZFeatureMap.cbit_argument_conversion" name="cbit_argument_conversion" signature="ZFeatureMap.cbit_argument_conversion(clbit_representation)">
  ...
  <Function id="qiskit.circuit.library.ZFeatureMap.ccx" name="ccx" signature="ZFeatureMap.ccx(control_qubit1, control_qubit2, target_qubit, *, ctl1=None, ctl2=None, tgt=None)">
    Apply [`CCXGate`](qiskit.circuit.library.CCXGate "qiskit.circuit.library.CCXGate").
  </Function>

  ### ch

  <Function id="qiskit.circuit.library.ZFeatureMap.ch" name="ch" signature="ZFeatureMap.ch(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CHGate`](qiskit.circuit.library.CHGate "qiskit.circuit.library.CHGate").
  </Function>

  ### cls\_instances

  <Function id="qiskit.circuit.library.ZFeatureMap.cls_instances" name="cls_instances" signature="classmethod ZFeatureMap.cls_instances()">
    Return the current number of instances of this class, useful for auto naming.
  </Function>

  ### cls\_prefix

  <Function id="qiskit.circuit.library.ZFeatureMap.cls_prefix" name="cls_prefix" signature="classmethod ZFeatureMap.cls_prefix()">
    Return the prefix to use for auto naming.
  </Function>

  ### cnot

  <Function id="qiskit.circuit.library.ZFeatureMap.cnot" name="cnot" signature="ZFeatureMap.cnot(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CXGate`](qiskit.circuit.library.CXGate "qiskit.circuit.library.CXGate").
  </Function>

  ### combine

  <Function id="qiskit.circuit.library.ZFeatureMap.combine" name="combine" signature="ZFeatureMap.combine(rhs)">
  ...
  <Function id="qiskit.circuit.library.ZFeatureMap.compose" name="compose" signature="ZFeatureMap.compose(other, qubits=None, clbits=None, front=False, inplace=False)">
  ...
  <Function id="qiskit.circuit.library.ZFeatureMap.copy" name="copy" signature="ZFeatureMap.copy(name=None)">
    Copy the circuit.
  ...
  <Function id="qiskit.circuit.library.ZFeatureMap.count_ops" name="count_ops" signature="ZFeatureMap.count_ops()">
  ...
  <Function id="qiskit.circuit.library.ZFeatureMap.crx" name="crx" signature="ZFeatureMap.crx(theta, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CRXGate`](qiskit.circuit.library.CRXGate "qiskit.circuit.library.CRXGate").
  </Function>

  ### cry

  <Function id="qiskit.circuit.library.ZFeatureMap.cry" name="cry" signature="ZFeatureMap.cry(theta, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CRYGate`](qiskit.circuit.library.CRYGate "qiskit.circuit.library.CRYGate").
  </Function>

  ### crz

  <Function id="qiskit.circuit.library.ZFeatureMap.crz" name="crz" signature="ZFeatureMap.crz(theta, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CRZGate`](qiskit.circuit.library.CRZGate "qiskit.circuit.library.CRZGate").
  </Function>

  ### cswap

  <Function id="qiskit.circuit.library.ZFeatureMap.cswap" name="cswap" signature="ZFeatureMap.cswap(control_qubit, target_qubit1, target_qubit2, *, label=None, ctrl_state=None, ctl=None, tgt1=None, tgt2=None)">
    Apply [`CSwapGate`](qiskit.circuit.library.CSwapGate "qiskit.circuit.library.CSwapGate").
  </Function>

  ### cu1

  <Function id="qiskit.circuit.library.ZFeatureMap.cu1" name="cu1" signature="ZFeatureMap.cu1(theta, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CU1Gate`](qiskit.circuit.library.CU1Gate "qiskit.circuit.library.CU1Gate").
  </Function>

  ### cu3

  <Function id="qiskit.circuit.library.ZFeatureMap.cu3" name="cu3" signature="ZFeatureMap.cu3(theta, phi, lam, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CU3Gate`](qiskit.circuit.library.CU3Gate "qiskit.circuit.library.CU3Gate").
  </Function>

  ### cx

  <Function id="qiskit.circuit.library.ZFeatureMap.cx" name="cx" signature="ZFeatureMap.cx(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CXGate`](qiskit.circuit.library.CXGate "qiskit.circuit.library.CXGate").
  </Function>

  ### cy

  <Function id="qiskit.circuit.library.ZFeatureMap.cy" name="cy" signature="ZFeatureMap.cy(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CYGate`](qiskit.circuit.library.CYGate "qiskit.circuit.library.CYGate").
  </Function>

  ### cz

  <Function id="qiskit.circuit.library.ZFeatureMap.cz" name="cz" signature="ZFeatureMap.cz(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CZGate`](qiskit.circuit.library.CZGate "qiskit.circuit.library.CZGate").
  </Function>

  ### dcx

  <Function id="qiskit.circuit.library.ZFeatureMap.dcx" name="dcx" signature="ZFeatureMap.dcx(qubit1, qubit2)">
    Apply [`DCXGate`](qiskit.circuit.library.DCXGate "qiskit.circuit.library.DCXGate").
  </Function>

  ### decompose

  <Function id="qiskit.circuit.library.ZFeatureMap.decompose" name="decompose" signature="ZFeatureMap.decompose()">
  ...
  <Function id="qiskit.circuit.library.ZFeatureMap.depth" name="depth" signature="ZFeatureMap.depth()">
  ...
  <Function id="qiskit.circuit.library.ZFeatureMap.diag_gate" name="diag_gate" signature="ZFeatureMap.diag_gate(diag, qubit)">
    Deprecated version of QuantumCircuit.diagonal.
  </Function>

  ### diagonal

  <Function id="qiskit.circuit.library.ZFeatureMap.diagonal" name="diagonal" signature="ZFeatureMap.diagonal(diag, qubit)">
  ...
  <Function id="qiskit.circuit.library.ZFeatureMap.extend" name="extend" signature="ZFeatureMap.extend(rhs)">
  ...
  <Function id="qiskit.circuit.library.ZFeatureMap.fredkin" name="fredkin" signature="ZFeatureMap.fredkin(control_qubit, target_qubit1, target_qubit2, *, ctl=None, tgt1=None, tgt2=None)">
    Apply [`CSwapGate`](qiskit.circuit.library.CSwapGate "qiskit.circuit.library.CSwapGate").
  </Function>

  ### from\_qasm\_file

  <Function id="qiskit.circuit.library.ZFeatureMap.from_qasm_file" name="from_qasm_file" signature="static ZFeatureMap.from_qasm_file(path)">
  ...
  <Function id="qiskit.circuit.library.ZFeatureMap.from_qasm_str" name="from_qasm_str" signature="static ZFeatureMap.from_qasm_str(qasm_str)">
  ...
  <Function id="qiskit.circuit.library.ZFeatureMap.get_entangler_map" name="get_entangler_map" signature="ZFeatureMap.get_entangler_map(rep_num, block_num, num_block_qubits)">
  ...
  <Function id="qiskit.circuit.library.ZFeatureMap.get_unentangled_qubits" name="get_unentangled_qubits" signature="ZFeatureMap.get_unentangled_qubits()">
  ...
  <Function id="qiskit.circuit.library.ZFeatureMap.h" name="h" signature="ZFeatureMap.h(qubit, *, q=None)">
    Apply [`HGate`](qiskit.circuit.library.HGate "qiskit.circuit.library.HGate").
  </Function>

  ### hamiltonian

  <Function id="qiskit.circuit.library.ZFeatureMap.hamiltonian" name="hamiltonian" signature="ZFeatureMap.hamiltonian(operator, time, qubits, label=None)">
    Apply hamiltonian evolution to to qubits.
  </Function>

  ### has\_register

  <Function id="qiskit.circuit.library.ZFeatureMap.has_register" name="has_register" signature="ZFeatureMap.has_register(register)">
  ...
  <Function id="qiskit.circuit.library.ZFeatureMap.i" name="i" signature="ZFeatureMap.i(qubit, *, q=None)">
    Apply [`IGate`](qiskit.circuit.library.IGate "qiskit.circuit.library.IGate").
  </Function>

  ### id

  <Function id="qiskit.circuit.library.ZFeatureMap.id" name="id" signature="ZFeatureMap.id(qubit, *, q=None)">
    Apply [`IGate`](qiskit.circuit.library.IGate "qiskit.circuit.library.IGate").
  </Function>

  ### iden

  <Function id="qiskit.circuit.library.ZFeatureMap.iden" name="iden" signature="ZFeatureMap.iden(qubit, *, q=None)">
    Deprecated identity gate.
  </Function>

  ### initialize

  <Function id="qiskit.circuit.library.ZFeatureMap.initialize" name="initialize" signature="ZFeatureMap.initialize(params, qubits)">
    Apply initialize to circuit.
  </Function>

  ### inverse

  <Function id="qiskit.circuit.library.ZFeatureMap.inverse" name="inverse" signature="ZFeatureMap.inverse()">
    Invert this circuit.
  ...
  <Function id="qiskit.circuit.library.ZFeatureMap.iso" name="iso" signature="ZFeatureMap.iso(isometry, q_input, q_ancillas_for_output, q_ancillas_zero=None, q_ancillas_dirty=None)">
  ...
  <Function id="qiskit.circuit.library.ZFeatureMap.isometry" name="isometry" signature="ZFeatureMap.isometry(isometry, q_input, q_ancillas_for_output, q_ancillas_zero=None, q_ancillas_dirty=None)">
    Attach an arbitrary isometry from m to n qubits to a circuit. In particular, this allows to attach arbitrary unitaries on n qubits (m=n) or to prepare any state on n qubits (m=0). The decomposition used here was introduced by Iten et al. in [https://arxiv.org/abs/1501.06911](https://arxiv.org/abs/1501.06911).
  ...
  <Function id="qiskit.circuit.library.ZFeatureMap.iswap" name="iswap" signature="ZFeatureMap.iswap(qubit1, qubit2)">
    Apply [`iSwapGate`](qiskit.circuit.library.iSwapGate "qiskit.circuit.library.iSwapGate").
  </Function>

  ### mcmt

  <Function id="qiskit.circuit.library.ZFeatureMap.mcmt" name="mcmt" signature="ZFeatureMap.mcmt(gate, control_qubits, target_qubits, ancilla_qubits=None, mode='no-ancilla', *, single_control_gate_fun=None, q_controls=None, q_ancillae=None, q_targets=None)">
  ...
  <Function id="qiskit.circuit.library.ZFeatureMap.mcrx" name="mcrx" signature="ZFeatureMap.mcrx(theta, q_controls, q_target, use_basis_gates=False)">
  ...
  <Function id="qiskit.circuit.library.ZFeatureMap.mcry" name="mcry" signature="ZFeatureMap.mcry(theta, q_controls, q_target, q_ancillae, mode='basic', use_basis_gates=False)">
  ...
  <Function id="qiskit.circuit.library.ZFeatureMap.mcrz" name="mcrz" signature="ZFeatureMap.mcrz(lam, q_controls, q_target, use_basis_gates=False)">
  ...
  <Function id="qiskit.circuit.library.ZFeatureMap.mct" name="mct" signature="ZFeatureMap.mct(control_qubits, target_qubit, ancilla_qubits=None, mode='noancilla')">
    Apply `MCXGate`.
  </Function>

  ### mcu1

  <Function id="qiskit.circuit.library.ZFeatureMap.mcu1" name="mcu1" signature="ZFeatureMap.mcu1(lam, control_qubits, target_qubit)">
    Apply `MCU1Gate`.
  </Function>

  ### mcx

  <Function id="qiskit.circuit.library.ZFeatureMap.mcx" name="mcx" signature="ZFeatureMap.mcx(control_qubits, target_qubit, ancilla_qubits=None, mode='noancilla')">
    Apply `MCXGate`.
  ...
  <Function id="qiskit.circuit.library.ZFeatureMap.measure" name="measure" signature="ZFeatureMap.measure(qubit, cbit)">
  ...
  <Function id="qiskit.circuit.library.ZFeatureMap.measure_active" name="measure_active" signature="ZFeatureMap.measure_active(inplace=True)">
  ...
  <Function id="qiskit.circuit.library.ZFeatureMap.measure_all" name="measure_all" signature="ZFeatureMap.measure_all(inplace=True)">
  ...
  <Function id="qiskit.circuit.library.ZFeatureMap.mirror" name="mirror" signature="ZFeatureMap.mirror()">
  ...
  <Function id="qiskit.circuit.library.ZFeatureMap.ms" name="ms" signature="ZFeatureMap.ms(theta, qubits)">
    Apply [`MSGate`](qiskit.circuit.library.MSGate "qiskit.circuit.library.MSGate").
  </Function>

  ### num\_connected\_components

  <Function id="qiskit.circuit.library.ZFeatureMap.num_connected_components" name="num_connected_components" signature="ZFeatureMap.num_connected_components(unitary_only=False)">
  ...
  <Function id="qiskit.circuit.library.ZFeatureMap.num_nonlocal_gates" name="num_nonlocal_gates" signature="ZFeatureMap.num_nonlocal_gates()">
  ...
  <Function id="qiskit.circuit.library.ZFeatureMap.num_tensor_factors" name="num_tensor_factors" signature="ZFeatureMap.num_tensor_factors()">
  ...
  <Function id="qiskit.circuit.library.ZFeatureMap.num_unitary_factors" name="num_unitary_factors" signature="ZFeatureMap.num_unitary_factors()">
    Computes the number of tensor factors in the unitary (quantum) part of the circuit only.
  </Function>

  ### pauli\_block

  <Function id="qiskit.circuit.library.ZFeatureMap.pauli_block" name="pauli_block" signature="ZFeatureMap.pauli_block(pauli_string)">
    Get the Pauli block for the feature map circuit.
  </Function>

  ### pauli\_evolution

  <Function id="qiskit.circuit.library.ZFeatureMap.pauli_evolution" name="pauli_evolution" signature="ZFeatureMap.pauli_evolution(pauli_string, time)">
    Get the evolution block for the given pauli string.
  </Function>

  ### print\_settings

  <Function id="qiskit.circuit.library.ZFeatureMap.print_settings" name="print_settings" signature="ZFeatureMap.print_settings()">
  ...
  <Function id="qiskit.circuit.library.ZFeatureMap.qasm" name="qasm" signature="ZFeatureMap.qasm(formatted=False, filename=None)">
  ...
  <Function id="qiskit.circuit.library.ZFeatureMap.qbit_argument_conversion" name="qbit_argument_conversion" signature="ZFeatureMap.qbit_argument_conversion(qubit_representation)">
  ...
  <Function id="qiskit.circuit.library.ZFeatureMap.r" name="r" signature="ZFeatureMap.r(theta, phi, qubit, *, q=None)">
    Apply `RGate`.
  </Function>

  ### rcccx

  <Function id="qiskit.circuit.library.ZFeatureMap.rcccx" name="rcccx" signature="ZFeatureMap.rcccx(control_qubit1, control_qubit2, control_qubit3, target_qubit)">
    Apply [`RC3XGate`](qiskit.circuit.library.RC3XGate "qiskit.circuit.library.RC3XGate").
  </Function>

  ### rccx

  <Function id="qiskit.circuit.library.ZFeatureMap.rccx" name="rccx" signature="ZFeatureMap.rccx(control_qubit1, control_qubit2, target_qubit)">
    Apply [`RCCXGate`](qiskit.circuit.library.RCCXGate "qiskit.circuit.library.RCCXGate").
  </Function>

  ### remove\_final\_measurements

  <Function id="qiskit.circuit.library.ZFeatureMap.remove_final_measurements" name="remove_final_measurements" signature="ZFeatureMap.remove_final_measurements(inplace=True)">
  ...
  <Function id="qiskit.circuit.library.ZFeatureMap.reset" name="reset" signature="ZFeatureMap.reset(qubit)">
    Reset q.
  </Function>

  ### rx

  <Function id="qiskit.circuit.library.ZFeatureMap.rx" name="rx" signature="ZFeatureMap.rx(theta, qubit, *, label=None, q=None)">
    Apply [`RXGate`](qiskit.circuit.library.RXGate "qiskit.circuit.library.RXGate").
  </Function>

  ### rxx

  <Function id="qiskit.circuit.library.ZFeatureMap.rxx" name="rxx" signature="ZFeatureMap.rxx(theta, qubit1, qubit2)">
    Apply [`RXXGate`](qiskit.circuit.library.RXXGate "qiskit.circuit.library.RXXGate").
  </Function>

  ### ry

  <Function id="qiskit.circuit.library.ZFeatureMap.ry" name="ry" signature="ZFeatureMap.ry(theta, qubit, *, label=None, q=None)">
    Apply [`RYGate`](qiskit.circuit.library.RYGate "qiskit.circuit.library.RYGate").
  </Function>

  ### ryy

  <Function id="qiskit.circuit.library.ZFeatureMap.ryy" name="ryy" signature="ZFeatureMap.ryy(theta, qubit1, qubit2)">
    Apply [`RYYGate`](qiskit.circuit.library.RYYGate "qiskit.circuit.library.RYYGate").
  </Function>

  ### rz

  <Function id="qiskit.circuit.library.ZFeatureMap.rz" name="rz" signature="ZFeatureMap.rz(phi, qubit, *, q=None)">
    Apply [`RZGate`](qiskit.circuit.library.RZGate "qiskit.circuit.library.RZGate").
  </Function>

  ### rzx

  <Function id="qiskit.circuit.library.ZFeatureMap.rzx" name="rzx" signature="ZFeatureMap.rzx(theta, qubit1, qubit2)">
    Apply [`RZXGate`](qiskit.circuit.library.RZXGate "qiskit.circuit.library.RZXGate").
  </Function>

  ### rzz

  <Function id="qiskit.circuit.library.ZFeatureMap.rzz" name="rzz" signature="ZFeatureMap.rzz(theta, qubit1, qubit2)">
    Apply [`RZZGate`](qiskit.circuit.library.RZZGate "qiskit.circuit.library.RZZGate").
  </Function>

  ### s

  <Function id="qiskit.circuit.library.ZFeatureMap.s" name="s" signature="ZFeatureMap.s(qubit, *, q=None)">
    Apply [`SGate`](qiskit.circuit.library.SGate "qiskit.circuit.library.SGate").
  </Function>

  ### sdg

  <Function id="qiskit.circuit.library.ZFeatureMap.sdg" name="sdg" signature="ZFeatureMap.sdg(qubit, *, q=None)">
    Apply [`SdgGate`](qiskit.circuit.library.SdgGate "qiskit.circuit.library.SdgGate").
  </Function>

  ### size

  <Function id="qiskit.circuit.library.ZFeatureMap.size" name="size" signature="ZFeatureMap.size()">
  ...
  <Function id="qiskit.circuit.library.ZFeatureMap.snapshot" name="snapshot" signature="ZFeatureMap.snapshot(label, snapshot_type='statevector', qubits=None, params=None)">
  ...
  <Function id="qiskit.circuit.library.ZFeatureMap.snapshot_density_matrix" name="snapshot_density_matrix" signature="ZFeatureMap.snapshot_density_matrix(label, qubits=None)">
  ...
  <Function id="qiskit.circuit.library.ZFeatureMap.snapshot_expectation_value" name="snapshot_expectation_value" signature="ZFeatureMap.snapshot_expectation_value(label, op, qubits, single_shot=False, variance=False)">
  ...
  <Function id="qiskit.circuit.library.ZFeatureMap.snapshot_probabilities" name="snapshot_probabilities" signature="ZFeatureMap.snapshot_probabilities(label, qubits, variance=False)">
  ...
  <Function id="qiskit.circuit.library.ZFeatureMap.snapshot_stabilizer" name="snapshot_stabilizer" signature="ZFeatureMap.snapshot_stabilizer(label)">
  ...
  <Function id="qiskit.circuit.library.ZFeatureMap.snapshot_statevector" name="snapshot_statevector" signature="ZFeatureMap.snapshot_statevector(label)">
  ...
  <Function id="qiskit.circuit.library.ZFeatureMap.squ" name="squ" signature="ZFeatureMap.squ(unitary_matrix, qubit, mode='ZYZ', up_to_diagonal=False, *, u=None)">
  ...
  <Function id="qiskit.circuit.library.ZFeatureMap.swap" name="swap" signature="ZFeatureMap.swap(qubit1, qubit2)">
    Apply [`SwapGate`](qiskit.circuit.library.SwapGate "qiskit.circuit.library.SwapGate").
  </Function>

  ### t

  <Function id="qiskit.circuit.library.ZFeatureMap.t" name="t" signature="ZFeatureMap.t(qubit, *, q=None)">
    Apply [`TGate`](qiskit.circuit.library.TGate "qiskit.circuit.library.TGate").
  </Function>

  ### tdg

  <Function id="qiskit.circuit.library.ZFeatureMap.tdg" name="tdg" signature="ZFeatureMap.tdg(qubit, *, q=None)">
    Apply [`TdgGate`](qiskit.circuit.library.TdgGate "qiskit.circuit.library.TdgGate").
  </Function>

  ### to\_gate

  <Function id="qiskit.circuit.library.ZFeatureMap.to_gate" name="to_gate" signature="ZFeatureMap.to_gate(parameter_map=None)">
  ...
  <Function id="qiskit.circuit.library.ZFeatureMap.to_instruction" name="to_instruction" signature="ZFeatureMap.to_instruction(parameter_map=None)">
  ...
  <Function id="qiskit.circuit.library.ZFeatureMap.toffoli" name="toffoli" signature="ZFeatureMap.toffoli(control_qubit1, control_qubit2, target_qubit, *, ctl1=None, ctl2=None, tgt=None)">
    Apply [`CCXGate`](qiskit.circuit.library.CCXGate "qiskit.circuit.library.CCXGate").
  </Function>

  ### u1

  <Function id="qiskit.circuit.library.ZFeatureMap.u1" name="u1" signature="ZFeatureMap.u1(theta, qubit, *, q=None)">
    Apply [`U1Gate`](qiskit.circuit.library.U1Gate "qiskit.circuit.library.U1Gate").
  </Function>

  ### u2

  <Function id="qiskit.circuit.library.ZFeatureMap.u2" name="u2" signature="ZFeatureMap.u2(phi, lam, qubit, *, q=None)">
    Apply [`U2Gate`](qiskit.circuit.library.U2Gate "qiskit.circuit.library.U2Gate").
  </Function>

  ### u3

  <Function id="qiskit.circuit.library.ZFeatureMap.u3" name="u3" signature="ZFeatureMap.u3(theta, phi, lam, qubit, *, q=None)">
    Apply [`U3Gate`](qiskit.circuit.library.U3Gate "qiskit.circuit.library.U3Gate").
  </Function>

  ### uc

  <Function id="qiskit.circuit.library.ZFeatureMap.uc" name="uc" signature="ZFeatureMap.uc(gate_list, q_controls, q_target, up_to_diagonal=False)">
  ...
  <Function id="qiskit.circuit.library.ZFeatureMap.ucg" name="ucg" signature="ZFeatureMap.ucg(angle_list, q_controls, q_target, up_to_diagonal=False)">
    Deprecated version of uc.
  </Function>

  ### ucrx

  <Function id="qiskit.circuit.library.ZFeatureMap.ucrx" name="ucrx" signature="ZFeatureMap.ucrx(angle_list, q_controls, q_target)">
  ...
  <Function id="qiskit.circuit.library.ZFeatureMap.ucry" name="ucry" signature="ZFeatureMap.ucry(angle_list, q_controls, q_target)">
  ...
  <Function id="qiskit.circuit.library.ZFeatureMap.ucrz" name="ucrz" signature="ZFeatureMap.ucrz(angle_list, q_controls, q_target)">
  ...
  <Function id="qiskit.circuit.library.ZFeatureMap.ucx" name="ucx" signature="ZFeatureMap.ucx(angle_list, q_controls, q_target)">
    Deprecated version of ucrx.
  </Function>

  ### ucy

  <Function id="qiskit.circuit.library.ZFeatureMap.ucy" name="ucy" signature="ZFeatureMap.ucy(angle_list, q_controls, q_target)">
    Deprecated version of ucry.
  </Function>

  ### ucz

  <Function id="qiskit.circuit.library.ZFeatureMap.ucz" name="ucz" signature="ZFeatureMap.ucz(angle_list, q_controls, q_target)">
    Deprecated version of ucrz.
  </Function>

  ### unitary

  <Function id="qiskit.circuit.library.ZFeatureMap.unitary" name="unitary" signature="ZFeatureMap.unitary(obj, qubits, label=None)">
    Apply unitary gate to q.
  </Function>

  ### width

  <Function id="qiskit.circuit.library.ZFeatureMap.width" name="width" signature="ZFeatureMap.width()">
  ...
  <Function id="qiskit.circuit.library.ZFeatureMap.x" name="x" signature="ZFeatureMap.x(qubit, *, label=None, ctrl_state=None, q=None)">
    Apply [`XGate`](qiskit.circuit.library.XGate "qiskit.circuit.library.XGate").
  </Function>

  ### y

  <Function id="qiskit.circuit.library.ZFeatureMap.y" name="y" signature="ZFeatureMap.y(qubit, *, q=None)">
    Apply [`YGate`](qiskit.circuit.library.YGate "qiskit.circuit.library.YGate").
  </Function>

  ### z

  <Function id="qiskit.circuit.library.ZFeatureMap.z" name="z" signature="ZFeatureMap.z(qubit, *, q=None)">
