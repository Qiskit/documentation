---
title: ZFeatureMap (v0.19)
description: API reference for qiskit.circuit.library.ZFeatureMap in qiskit v0.19
...
<Class id="qiskit.circuit.library.ZFeatureMap" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.14/qiskit/circuit/library/data_preparation/z_feature_map.py" signature="ZFeatureMap(feature_dimension, reps=2, data_map_func=None, insert_barriers=False)" modifiers="class">
  ...
  *   **insert\_barriers** (`bool`) – If True, barriers are inserted in between the evolution instructions and hadamard layers.
  ...
  <span id="zfeaturemap-entanglement" />

  ### entanglement

  <Attribute id="qiskit.circuit.library.ZFeatureMap.entanglement" attributeTypeHint="Union[str, List[str], List[List[str]], List[int], List[List[int]], List[List[List[int]]], List[List[List[List[int]]]], Callable[[int], str], Callable[[int], List[List[int]]]]">
  ...
  <span id="zfeaturemap-entanglement-blocks" />
  ...
  <span id="zfeaturemap-extension-lib" />

  ### extension\_lib

  <Attribute id="qiskit.circuit.library.ZFeatureMap.extension_lib" attributeValue="'include &#x22;qelib1.inc&#x22;;'" />

  <span id="zfeaturemap-feature-dimension" />

  ### feature\_dimension

  <Attribute id="qiskit.circuit.library.ZFeatureMap.feature_dimension" attributeTypeHint="int">
  ...
  <span id="zfeaturemap-header" />

  ### header

  <Attribute id="qiskit.circuit.library.ZFeatureMap.header" attributeValue="'OPENQASM 2.0;'" />

  <span id="zfeaturemap-initial-state" />

  ### initial\_state

  <Attribute id="qiskit.circuit.library.ZFeatureMap.initial_state" attributeTypeHint="Any">
  ...
  <span id="zfeaturemap-insert-barriers" />

  ### insert\_barriers

  <Attribute id="qiskit.circuit.library.ZFeatureMap.insert_barriers" attributeTypeHint="bool">
  ...
  <span id="zfeaturemap-instances" />

  ### instances

  <Attribute id="qiskit.circuit.library.ZFeatureMap.instances" attributeValue="8" />

  <span id="zfeaturemap-n-qubits" />

  ### n\_qubits

  <Attribute id="qiskit.circuit.library.ZFeatureMap.n_qubits">
    Deprecated, use `num_qubits` instead. Return number of qubits.
  </Attribute>

  <span id="zfeaturemap-num-clbits" />
  ...
  <span id="zfeaturemap-num-layers" />

  ### num\_layers

  <Attribute id="qiskit.circuit.library.ZFeatureMap.num_layers" attributeTypeHint="int">
  ...
  <span id="zfeaturemap-num-parameters" />
  ...
  <span id="zfeaturemap-num-parameters-settable" />
  ...
  <span id="zfeaturemap-num-qubits" />

  ### num\_qubits

  <Attribute id="qiskit.circuit.library.ZFeatureMap.num_qubits" attributeTypeHint="int">
  ...
  <span id="zfeaturemap-ordered-parameters" />

  ### ordered\_parameters

  <Attribute id="qiskit.circuit.library.ZFeatureMap.ordered_parameters" attributeTypeHint="List[qiskit.circuit.parameter.Parameter]">
  ...
  <span id="zfeaturemap-parameter-bounds" />

  ### parameter\_bounds

  <Attribute id="qiskit.circuit.library.ZFeatureMap.parameter_bounds" attributeTypeHint="Optional[List[Tuple[float, float]]]">
  ...
  <span id="zfeaturemap-parameters" />

  ### parameters

  <Attribute id="qiskit.circuit.library.ZFeatureMap.parameters" attributeTypeHint="Set[qiskit.circuit.parameter.Parameter]">
  ...
  <span id="zfeaturemap-paulis" />

  ### paulis

  <Attribute id="qiskit.circuit.library.ZFeatureMap.paulis" attributeTypeHint="List[str]">
  ...
  <span id="zfeaturemap-preferred-init-points" />

  ### preferred\_init\_points

  <Attribute id="qiskit.circuit.library.ZFeatureMap.preferred_init_points" attributeTypeHint="Optional[List[float]]">
  ...
  <span id="zfeaturemap-reps" />

  ### reps

  <Attribute id="qiskit.circuit.library.ZFeatureMap.reps" attributeTypeHint="int">
  ...
  <span id="zfeaturemap-rotation-blocks" />

  ### rotation\_blocks

  <Attribute id="qiskit.circuit.library.ZFeatureMap.rotation_blocks" attributeTypeHint="List[qiskit.circuit.instruction.Instruction]">
  ...
  <span id="zfeaturemap-and" />

  ### AND

  <Function id="qiskit.circuit.library.ZFeatureMap.AND" signature="ZFeatureMap.AND(qr_variables, qb_target, qr_ancillae, flags=None, mct_mode='no-ancilla')">
  ...
  <span id="zfeaturemap-or" />

  ### OR

  <Function id="qiskit.circuit.library.ZFeatureMap.OR" signature="ZFeatureMap.OR(qr_variables, qb_target, qr_ancillae, flags=None, mct_mode='basic')">
  ...
  <span id="zfeaturemap-getitem" />

  ### \_\_getitem\_\_

  <Function id="qiskit.circuit.library.ZFeatureMap.__getitem__" signature="ZFeatureMap.__getitem__(item)">
    Return indexed operation.
  </Function>

  <span id="zfeaturemap-len" />

  ### \_\_len\_\_

  <Function id="qiskit.circuit.library.ZFeatureMap.__len__" signature="ZFeatureMap.__len__()">
    Return number of operations in circuit.
  </Function>

  <span id="zfeaturemap-add-layer" />

  ### add\_layer

  <Function id="qiskit.circuit.library.ZFeatureMap.add_layer" signature="ZFeatureMap.add_layer(other, entanglement=None, front=False)">
  ...
  <span id="zfeaturemap-add-register" />

  ### add\_register

  <Function id="qiskit.circuit.library.ZFeatureMap.add_register" signature="ZFeatureMap.add_register(*regs)">
    Add registers.
  </Function>

  <span id="zfeaturemap-append" />

  ### append

  <Function id="qiskit.circuit.library.ZFeatureMap.append" signature="ZFeatureMap.append(instruction, qargs=None, cargs=None)">
  ...
  <span id="zfeaturemap-assign-parameters" />

  ### assign\_parameters

  <Function id="qiskit.circuit.library.ZFeatureMap.assign_parameters" signature="ZFeatureMap.assign_parameters(param_dict, inplace=False)">
  ...
  <span id="zfeaturemap-barrier" />

  ### barrier

  <Function id="qiskit.circuit.library.ZFeatureMap.barrier" signature="ZFeatureMap.barrier(*qargs)">
    Apply `Barrier`. If qargs is None, applies to all.
  </Function>

  <span id="zfeaturemap-bind-parameters" />

  ### bind\_parameters

  <Function id="qiskit.circuit.library.ZFeatureMap.bind_parameters" signature="ZFeatureMap.bind_parameters(value_dict)">
  ...
  <span id="zfeaturemap-cast" />

  ### cast

  <Function id="qiskit.circuit.library.ZFeatureMap.cast" signature="ZFeatureMap.cast(value, _type)" modifiers="static">
    Best effort to cast value to type. Otherwise, returns the value.
  </Function>

  <span id="zfeaturemap-cbit-argument-conversion" />

  ### cbit\_argument\_conversion

  <Function id="qiskit.circuit.library.ZFeatureMap.cbit_argument_conversion" signature="ZFeatureMap.cbit_argument_conversion(clbit_representation)">
  ...
  <span id="zfeaturemap-ccx" />

  ### ccx

  <Function id="qiskit.circuit.library.ZFeatureMap.ccx" signature="ZFeatureMap.ccx(control_qubit1, control_qubit2, target_qubit, *, ctl1=None, ctl2=None, tgt=None)">
    Apply [`CCXGate`](qiskit.circuit.library.CCXGate "qiskit.circuit.library.CCXGate").
  </Function>

  <span id="zfeaturemap-ch" />

  ### ch

  <Function id="qiskit.circuit.library.ZFeatureMap.ch" signature="ZFeatureMap.ch(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CHGate`](qiskit.circuit.library.CHGate "qiskit.circuit.library.CHGate").
  </Function>

  <span id="zfeaturemap-cls-instances" />

  ### cls\_instances

  <Function id="qiskit.circuit.library.ZFeatureMap.cls_instances" signature="ZFeatureMap.cls_instances()" modifiers="classmethod">
    Return the current number of instances of this class, useful for auto naming.
  </Function>

  <span id="zfeaturemap-cls-prefix" />

  ### cls\_prefix

  <Function id="qiskit.circuit.library.ZFeatureMap.cls_prefix" signature="ZFeatureMap.cls_prefix()" modifiers="classmethod">
    Return the prefix to use for auto naming.
  </Function>

  <span id="zfeaturemap-cnot" />

  ### cnot

  <Function id="qiskit.circuit.library.ZFeatureMap.cnot" signature="ZFeatureMap.cnot(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CXGate`](qiskit.circuit.library.CXGate "qiskit.circuit.library.CXGate").
  </Function>

  <span id="zfeaturemap-combine" />

  ### combine

  <Function id="qiskit.circuit.library.ZFeatureMap.combine" signature="ZFeatureMap.combine(rhs)">
  ...
  <span id="zfeaturemap-compose" />

  ### compose

  <Function id="qiskit.circuit.library.ZFeatureMap.compose" signature="ZFeatureMap.compose(other, qubits=None, clbits=None, front=False, inplace=False)">
  ...
  <span id="zfeaturemap-copy" />

  ### copy

  <Function id="qiskit.circuit.library.ZFeatureMap.copy" signature="ZFeatureMap.copy(name=None)">
    Copy the circuit.
  ...
  <span id="zfeaturemap-count-ops" />

  ### count\_ops

  <Function id="qiskit.circuit.library.ZFeatureMap.count_ops" signature="ZFeatureMap.count_ops()">
  ...
  <span id="zfeaturemap-crx" />

  ### crx

  <Function id="qiskit.circuit.library.ZFeatureMap.crx" signature="ZFeatureMap.crx(theta, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CRXGate`](qiskit.circuit.library.CRXGate "qiskit.circuit.library.CRXGate").
  </Function>

  <span id="zfeaturemap-cry" />

  ### cry

  <Function id="qiskit.circuit.library.ZFeatureMap.cry" signature="ZFeatureMap.cry(theta, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CRYGate`](qiskit.circuit.library.CRYGate "qiskit.circuit.library.CRYGate").
  </Function>

  <span id="zfeaturemap-crz" />

  ### crz

  <Function id="qiskit.circuit.library.ZFeatureMap.crz" signature="ZFeatureMap.crz(theta, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CRZGate`](qiskit.circuit.library.CRZGate "qiskit.circuit.library.CRZGate").
  </Function>

  <span id="zfeaturemap-cswap" />

  ### cswap

  <Function id="qiskit.circuit.library.ZFeatureMap.cswap" signature="ZFeatureMap.cswap(control_qubit, target_qubit1, target_qubit2, *, label=None, ctrl_state=None, ctl=None, tgt1=None, tgt2=None)">
    Apply [`CSwapGate`](qiskit.circuit.library.CSwapGate "qiskit.circuit.library.CSwapGate").
  </Function>

  <span id="zfeaturemap-cu1" />

  ### cu1

  <Function id="qiskit.circuit.library.ZFeatureMap.cu1" signature="ZFeatureMap.cu1(theta, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CU1Gate`](qiskit.circuit.library.CU1Gate "qiskit.circuit.library.CU1Gate").
  </Function>

  <span id="zfeaturemap-cu3" />

  ### cu3

  <Function id="qiskit.circuit.library.ZFeatureMap.cu3" signature="ZFeatureMap.cu3(theta, phi, lam, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CU3Gate`](qiskit.circuit.library.CU3Gate "qiskit.circuit.library.CU3Gate").
  </Function>

  <span id="zfeaturemap-cx" />

  ### cx

  <Function id="qiskit.circuit.library.ZFeatureMap.cx" signature="ZFeatureMap.cx(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CXGate`](qiskit.circuit.library.CXGate "qiskit.circuit.library.CXGate").
  </Function>

  <span id="zfeaturemap-cy" />

  ### cy

  <Function id="qiskit.circuit.library.ZFeatureMap.cy" signature="ZFeatureMap.cy(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CYGate`](qiskit.circuit.library.CYGate "qiskit.circuit.library.CYGate").
  </Function>

  <span id="zfeaturemap-cz" />

  ### cz

  <Function id="qiskit.circuit.library.ZFeatureMap.cz" signature="ZFeatureMap.cz(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CZGate`](qiskit.circuit.library.CZGate "qiskit.circuit.library.CZGate").
  </Function>

  <span id="zfeaturemap-dcx" />

  ### dcx

  <Function id="qiskit.circuit.library.ZFeatureMap.dcx" signature="ZFeatureMap.dcx(qubit1, qubit2)">
    Apply [`DCXGate`](qiskit.circuit.library.DCXGate "qiskit.circuit.library.DCXGate").
  </Function>

  <span id="zfeaturemap-decompose" />

  ### decompose

  <Function id="qiskit.circuit.library.ZFeatureMap.decompose" signature="ZFeatureMap.decompose()">
  ...
  <span id="zfeaturemap-depth" />

  ### depth

  <Function id="qiskit.circuit.library.ZFeatureMap.depth" signature="ZFeatureMap.depth()">
  ...
  <span id="zfeaturemap-diag-gate" />

  ### diag\_gate

  <Function id="qiskit.circuit.library.ZFeatureMap.diag_gate" signature="ZFeatureMap.diag_gate(diag, qubit)">
    Deprecated version of QuantumCircuit.diagonal.
  </Function>

  <span id="zfeaturemap-diagonal" />

  ### diagonal

  <Function id="qiskit.circuit.library.ZFeatureMap.diagonal" signature="ZFeatureMap.diagonal(diag, qubit)">
  ...
  <span id="zfeaturemap-extend" />

  ### extend

  <Function id="qiskit.circuit.library.ZFeatureMap.extend" signature="ZFeatureMap.extend(rhs)">
  ...
  <span id="zfeaturemap-fredkin" />

  ### fredkin

  <Function id="qiskit.circuit.library.ZFeatureMap.fredkin" signature="ZFeatureMap.fredkin(control_qubit, target_qubit1, target_qubit2, *, ctl=None, tgt1=None, tgt2=None)">
    Apply [`CSwapGate`](qiskit.circuit.library.CSwapGate "qiskit.circuit.library.CSwapGate").
  </Function>

  <span id="zfeaturemap-from-qasm-file" />

  ### from\_qasm\_file

  <Function id="qiskit.circuit.library.ZFeatureMap.from_qasm_file" signature="ZFeatureMap.from_qasm_file(path)" modifiers="static">
  ...
  <span id="zfeaturemap-from-qasm-str" />

  ### from\_qasm\_str

  <Function id="qiskit.circuit.library.ZFeatureMap.from_qasm_str" signature="ZFeatureMap.from_qasm_str(qasm_str)" modifiers="static">
  ...
  <span id="zfeaturemap-get-entangler-map" />

  ### get\_entangler\_map

  <Function id="qiskit.circuit.library.ZFeatureMap.get_entangler_map" signature="ZFeatureMap.get_entangler_map(rep_num, block_num, num_block_qubits)">
  ...
  <span id="zfeaturemap-get-unentangled-qubits" />

  ### get\_unentangled\_qubits

  <Function id="qiskit.circuit.library.ZFeatureMap.get_unentangled_qubits" signature="ZFeatureMap.get_unentangled_qubits()">
  ...
  <span id="zfeaturemap-h" />

  ### h

  <Function id="qiskit.circuit.library.ZFeatureMap.h" signature="ZFeatureMap.h(qubit, *, q=None)">
    Apply [`HGate`](qiskit.circuit.library.HGate "qiskit.circuit.library.HGate").
  </Function>

  <span id="zfeaturemap-hamiltonian" />

  ### hamiltonian

  <Function id="qiskit.circuit.library.ZFeatureMap.hamiltonian" signature="ZFeatureMap.hamiltonian(operator, time, qubits, label=None)">
    Apply hamiltonian evolution to to qubits.
  </Function>

  <span id="zfeaturemap-has-register" />

  ### has\_register

  <Function id="qiskit.circuit.library.ZFeatureMap.has_register" signature="ZFeatureMap.has_register(register)">
  ...
  <span id="zfeaturemap-i" />

  ### i

  <Function id="qiskit.circuit.library.ZFeatureMap.i" signature="ZFeatureMap.i(qubit, *, q=None)">
    Apply [`IGate`](qiskit.circuit.library.IGate "qiskit.circuit.library.IGate").
  </Function>

  <span id="zfeaturemap-id" />

  ### id

  <Function id="qiskit.circuit.library.ZFeatureMap.id" signature="ZFeatureMap.id(qubit, *, q=None)">
    Apply [`IGate`](qiskit.circuit.library.IGate "qiskit.circuit.library.IGate").
  </Function>

  <span id="zfeaturemap-iden" />

  ### iden

  <Function id="qiskit.circuit.library.ZFeatureMap.iden" signature="ZFeatureMap.iden(qubit, *, q=None)">
    Deprecated identity gate.
  </Function>

  <span id="zfeaturemap-initialize" />

  ### initialize

  <Function id="qiskit.circuit.library.ZFeatureMap.initialize" signature="ZFeatureMap.initialize(params, qubits)">
    Apply initialize to circuit.
  </Function>

  <span id="zfeaturemap-inverse" />

  ### inverse

  <Function id="qiskit.circuit.library.ZFeatureMap.inverse" signature="ZFeatureMap.inverse()">
    Invert this circuit.
  ...
  <span id="zfeaturemap-iso" />

  ### iso

  <Function id="qiskit.circuit.library.ZFeatureMap.iso" signature="ZFeatureMap.iso(isometry, q_input, q_ancillas_for_output, q_ancillas_zero=None, q_ancillas_dirty=None)">
  ...
  <span id="zfeaturemap-isometry" />

  ### isometry

  <Function id="qiskit.circuit.library.ZFeatureMap.isometry" signature="ZFeatureMap.isometry(isometry, q_input, q_ancillas_for_output, q_ancillas_zero=None, q_ancillas_dirty=None)">
    Attach an arbitrary isometry from m to n qubits to a circuit. In particular, this allows to attach arbitrary unitaries on n qubits (m=n) or to prepare any state on n qubits (m=0). The decomposition used here was introduced by Iten et al. in [https://arxiv.org/abs/1501.06911](https://arxiv.org/abs/1501.06911).
  ...
  <span id="zfeaturemap-iswap" />

  ### iswap

  <Function id="qiskit.circuit.library.ZFeatureMap.iswap" signature="ZFeatureMap.iswap(qubit1, qubit2)">
    Apply [`iSwapGate`](qiskit.circuit.library.iSwapGate "qiskit.circuit.library.iSwapGate").
  </Function>

  <span id="zfeaturemap-mcmt" />

  ### mcmt

  <Function id="qiskit.circuit.library.ZFeatureMap.mcmt" signature="ZFeatureMap.mcmt(gate, control_qubits, target_qubits, ancilla_qubits=None, mode='no-ancilla', *, single_control_gate_fun=None, q_controls=None, q_ancillae=None, q_targets=None)">
    Apply a multi-control, multi-target using a generic gate.

    This can also be used to implement a generic multi-control gate, as the target could also be of length 1.
  </Function>

  <span id="zfeaturemap-mcrx" />

  ### mcrx

  <Function id="qiskit.circuit.library.ZFeatureMap.mcrx" signature="ZFeatureMap.mcrx(theta, q_controls, q_target, use_basis_gates=False)">
  ...
  <span id="zfeaturemap-mcry" />

  ### mcry

  <Function id="qiskit.circuit.library.ZFeatureMap.mcry" signature="ZFeatureMap.mcry(theta, q_controls, q_target, q_ancillae, mode='basic', use_basis_gates=False)">
  ...
  <span id="zfeaturemap-mcrz" />

  ### mcrz

  <Function id="qiskit.circuit.library.ZFeatureMap.mcrz" signature="ZFeatureMap.mcrz(lam, q_controls, q_target, use_basis_gates=False)">
  ...
  <span id="zfeaturemap-mct" />

  ### mct

  <Function id="qiskit.circuit.library.ZFeatureMap.mct" signature="ZFeatureMap.mct(control_qubits, target_qubit, ancilla_qubits=None, mode='noancilla')">
    Apply `MCXGate`.
  </Function>

  <span id="zfeaturemap-mcu1" />

  ### mcu1

  <Function id="qiskit.circuit.library.ZFeatureMap.mcu1" signature="ZFeatureMap.mcu1(lam, control_qubits, target_qubit)">
    Apply `MCU1Gate`.
  </Function>

  <span id="zfeaturemap-mcx" />

  ### mcx

  <Function id="qiskit.circuit.library.ZFeatureMap.mcx" signature="ZFeatureMap.mcx(control_qubits, target_qubit, ancilla_qubits=None, mode='noancilla')">
    Apply `MCXGate`.
  ...
  <span id="zfeaturemap-measure" />

  ### measure

  <Function id="qiskit.circuit.library.ZFeatureMap.measure" signature="ZFeatureMap.measure(qubit, cbit)">
  ...
  <span id="zfeaturemap-measure-active" />

  ### measure\_active

  <Function id="qiskit.circuit.library.ZFeatureMap.measure_active" signature="ZFeatureMap.measure_active(inplace=True)">
  ...
  <span id="zfeaturemap-measure-all" />

  ### measure\_all

  <Function id="qiskit.circuit.library.ZFeatureMap.measure_all" signature="ZFeatureMap.measure_all(inplace=True)">
  ...
  <span id="zfeaturemap-mirror" />

  ### mirror

  <Function id="qiskit.circuit.library.ZFeatureMap.mirror" signature="ZFeatureMap.mirror()">
  ...
  <span id="zfeaturemap-ms" />

  ### ms

  <Function id="qiskit.circuit.library.ZFeatureMap.ms" signature="ZFeatureMap.ms(theta, qubits)">
    Apply [`MSGate`](qiskit.circuit.library.MSGate "qiskit.circuit.library.MSGate").
  </Function>

  <span id="zfeaturemap-num-connected-components" />

  ### num\_connected\_components

  <Function id="qiskit.circuit.library.ZFeatureMap.num_connected_components" signature="ZFeatureMap.num_connected_components(unitary_only=False)">
  ...
  <span id="zfeaturemap-num-nonlocal-gates" />

  ### num\_nonlocal\_gates

  <Function id="qiskit.circuit.library.ZFeatureMap.num_nonlocal_gates" signature="ZFeatureMap.num_nonlocal_gates()">
    Return number of non-local gates (i.e. involving 2+ qubits).

    Conditional nonlocal gates are also included.
  </Function>

  <span id="zfeaturemap-num-tensor-factors" />

  ### num\_tensor\_factors

  <Function id="qiskit.circuit.library.ZFeatureMap.num_tensor_factors" signature="ZFeatureMap.num_tensor_factors()">
  ...
  <span id="zfeaturemap-num-unitary-factors" />

  ### num\_unitary\_factors

  <Function id="qiskit.circuit.library.ZFeatureMap.num_unitary_factors" signature="ZFeatureMap.num_unitary_factors()">
    Computes the number of tensor factors in the unitary (quantum) part of the circuit only.
  </Function>

  <span id="zfeaturemap-pauli-block" />

  ### pauli\_block

  <Function id="qiskit.circuit.library.ZFeatureMap.pauli_block" signature="ZFeatureMap.pauli_block(pauli_string)">
    Get the Pauli block for the feature map circuit.
  </Function>

  <span id="zfeaturemap-pauli-evolution" />

  ### pauli\_evolution

  <Function id="qiskit.circuit.library.ZFeatureMap.pauli_evolution" signature="ZFeatureMap.pauli_evolution(pauli_string, time)">
    Get the evolution block for the given pauli string.
  </Function>

  <span id="zfeaturemap-print-settings" />

  ### print\_settings

  <Function id="qiskit.circuit.library.ZFeatureMap.print_settings" signature="ZFeatureMap.print_settings()">
  ...
  <span id="zfeaturemap-qasm" />

  ### qasm

  <Function id="qiskit.circuit.library.ZFeatureMap.qasm" signature="ZFeatureMap.qasm(formatted=False, filename=None)">
  ...
  <span id="zfeaturemap-qbit-argument-conversion" />

  ### qbit\_argument\_conversion

  <Function id="qiskit.circuit.library.ZFeatureMap.qbit_argument_conversion" signature="ZFeatureMap.qbit_argument_conversion(qubit_representation)">
  ...
  <span id="zfeaturemap-r" />

  ### r

  <Function id="qiskit.circuit.library.ZFeatureMap.r" signature="ZFeatureMap.r(theta, phi, qubit, *, q=None)">
    Apply `RGate`.
  </Function>

  <span id="zfeaturemap-rcccx" />

  ### rcccx

  <Function id="qiskit.circuit.library.ZFeatureMap.rcccx" signature="ZFeatureMap.rcccx(control_qubit1, control_qubit2, control_qubit3, target_qubit)">
    Apply [`RC3XGate`](qiskit.circuit.library.RC3XGate "qiskit.circuit.library.RC3XGate").
  </Function>

  <span id="zfeaturemap-rccx" />

  ### rccx

  <Function id="qiskit.circuit.library.ZFeatureMap.rccx" signature="ZFeatureMap.rccx(control_qubit1, control_qubit2, target_qubit)">
    Apply [`RCCXGate`](qiskit.circuit.library.RCCXGate "qiskit.circuit.library.RCCXGate").
  </Function>

  <span id="zfeaturemap-remove-final-measurements" />

  ### remove\_final\_measurements

  <Function id="qiskit.circuit.library.ZFeatureMap.remove_final_measurements" signature="ZFeatureMap.remove_final_measurements(inplace=True)">
  ...
  <span id="zfeaturemap-reset" />

  ### reset

  <Function id="qiskit.circuit.library.ZFeatureMap.reset" signature="ZFeatureMap.reset(qubit)">
    Reset q.
  </Function>

  <span id="zfeaturemap-rx" />

  ### rx

  <Function id="qiskit.circuit.library.ZFeatureMap.rx" signature="ZFeatureMap.rx(theta, qubit, *, label=None, q=None)">
    Apply [`RXGate`](qiskit.circuit.library.RXGate "qiskit.circuit.library.RXGate").
  </Function>

  <span id="zfeaturemap-rxx" />

  ### rxx

  <Function id="qiskit.circuit.library.ZFeatureMap.rxx" signature="ZFeatureMap.rxx(theta, qubit1, qubit2)">
    Apply [`RXXGate`](qiskit.circuit.library.RXXGate "qiskit.circuit.library.RXXGate").
  </Function>

  <span id="zfeaturemap-ry" />

  ### ry

  <Function id="qiskit.circuit.library.ZFeatureMap.ry" signature="ZFeatureMap.ry(theta, qubit, *, label=None, q=None)">
    Apply [`RYGate`](qiskit.circuit.library.RYGate "qiskit.circuit.library.RYGate").
  </Function>

  <span id="zfeaturemap-ryy" />

  ### ryy

  <Function id="qiskit.circuit.library.ZFeatureMap.ryy" signature="ZFeatureMap.ryy(theta, qubit1, qubit2)">
    Apply [`RYYGate`](qiskit.circuit.library.RYYGate "qiskit.circuit.library.RYYGate").
  </Function>

  <span id="zfeaturemap-rz" />

  ### rz

  <Function id="qiskit.circuit.library.ZFeatureMap.rz" signature="ZFeatureMap.rz(phi, qubit, *, q=None)">
    Apply [`RZGate`](qiskit.circuit.library.RZGate "qiskit.circuit.library.RZGate").
  </Function>

  <span id="zfeaturemap-rzx" />

  ### rzx

  <Function id="qiskit.circuit.library.ZFeatureMap.rzx" signature="ZFeatureMap.rzx(theta, qubit1, qubit2)">
    Apply [`RZXGate`](qiskit.circuit.library.RZXGate "qiskit.circuit.library.RZXGate").
  </Function>

  <span id="zfeaturemap-rzz" />

  ### rzz

  <Function id="qiskit.circuit.library.ZFeatureMap.rzz" signature="ZFeatureMap.rzz(theta, qubit1, qubit2)">
    Apply [`RZZGate`](qiskit.circuit.library.RZZGate "qiskit.circuit.library.RZZGate").
  </Function>

  <span id="zfeaturemap-s" />

  ### s

  <Function id="qiskit.circuit.library.ZFeatureMap.s" signature="ZFeatureMap.s(qubit, *, q=None)">
    Apply [`SGate`](qiskit.circuit.library.SGate "qiskit.circuit.library.SGate").
  </Function>

  <span id="zfeaturemap-sdg" />

  ### sdg

  <Function id="qiskit.circuit.library.ZFeatureMap.sdg" signature="ZFeatureMap.sdg(qubit, *, q=None)">
    Apply [`SdgGate`](qiskit.circuit.library.SdgGate "qiskit.circuit.library.SdgGate").
  </Function>

  <span id="zfeaturemap-size" />

  ### size

  <Function id="qiskit.circuit.library.ZFeatureMap.size" signature="ZFeatureMap.size()">
  ...
  <span id="zfeaturemap-snapshot" />

  ### snapshot

  <Function id="qiskit.circuit.library.ZFeatureMap.snapshot" signature="ZFeatureMap.snapshot(label, snapshot_type='statevector', qubits=None, params=None)">
  ...
  <span id="zfeaturemap-snapshot-density-matrix" />

  ### snapshot\_density\_matrix

  <Function id="qiskit.circuit.library.ZFeatureMap.snapshot_density_matrix" signature="ZFeatureMap.snapshot_density_matrix(label, qubits=None)">
  ...
  <span id="zfeaturemap-snapshot-expectation-value" />

  ### snapshot\_expectation\_value

  <Function id="qiskit.circuit.library.ZFeatureMap.snapshot_expectation_value" signature="ZFeatureMap.snapshot_expectation_value(label, op, qubits, single_shot=False, variance=False)">
  ...
  <span id="zfeaturemap-snapshot-probabilities" />

  ### snapshot\_probabilities

  <Function id="qiskit.circuit.library.ZFeatureMap.snapshot_probabilities" signature="ZFeatureMap.snapshot_probabilities(label, qubits, variance=False)">
  ...
  <span id="zfeaturemap-snapshot-stabilizer" />

  ### snapshot\_stabilizer

  <Function id="qiskit.circuit.library.ZFeatureMap.snapshot_stabilizer" signature="ZFeatureMap.snapshot_stabilizer(label)">
  ...
  <span id="zfeaturemap-snapshot-statevector" />

  ### snapshot\_statevector

  <Function id="qiskit.circuit.library.ZFeatureMap.snapshot_statevector" signature="ZFeatureMap.snapshot_statevector(label)">
  ...
  <span id="zfeaturemap-squ" />

  ### squ

  <Function id="qiskit.circuit.library.ZFeatureMap.squ" signature="ZFeatureMap.squ(unitary_matrix, qubit, mode='ZYZ', up_to_diagonal=False, *, u=None)">
  ...
  <span id="zfeaturemap-swap" />

  ### swap

  <Function id="qiskit.circuit.library.ZFeatureMap.swap" signature="ZFeatureMap.swap(qubit1, qubit2)">
    Apply [`SwapGate`](qiskit.circuit.library.SwapGate "qiskit.circuit.library.SwapGate").
  </Function>

  <span id="zfeaturemap-t" />

  ### t

  <Function id="qiskit.circuit.library.ZFeatureMap.t" signature="ZFeatureMap.t(qubit, *, q=None)">
    Apply [`TGate`](qiskit.circuit.library.TGate "qiskit.circuit.library.TGate").
  </Function>

  <span id="zfeaturemap-tdg" />

  ### tdg

  <Function id="qiskit.circuit.library.ZFeatureMap.tdg" signature="ZFeatureMap.tdg(qubit, *, q=None)">
    Apply [`TdgGate`](qiskit.circuit.library.TdgGate "qiskit.circuit.library.TdgGate").
  </Function>

  <span id="zfeaturemap-to-gate" />

  ### to\_gate

  <Function id="qiskit.circuit.library.ZFeatureMap.to_gate" signature="ZFeatureMap.to_gate(parameter_map=None)">
  ...
  <span id="zfeaturemap-to-instruction" />

  ### to\_instruction

  <Function id="qiskit.circuit.library.ZFeatureMap.to_instruction" signature="ZFeatureMap.to_instruction(parameter_map=None)">
  ...
  <span id="zfeaturemap-toffoli" />

  ### toffoli

  <Function id="qiskit.circuit.library.ZFeatureMap.toffoli" signature="ZFeatureMap.toffoli(control_qubit1, control_qubit2, target_qubit, *, ctl1=None, ctl2=None, tgt=None)">
    Apply [`CCXGate`](qiskit.circuit.library.CCXGate "qiskit.circuit.library.CCXGate").
  </Function>

  <span id="zfeaturemap-u1" />

  ### u1

  <Function id="qiskit.circuit.library.ZFeatureMap.u1" signature="ZFeatureMap.u1(theta, qubit, *, q=None)">
    Apply [`U1Gate`](qiskit.circuit.library.U1Gate "qiskit.circuit.library.U1Gate").
  </Function>

  <span id="zfeaturemap-u2" />

  ### u2

  <Function id="qiskit.circuit.library.ZFeatureMap.u2" signature="ZFeatureMap.u2(phi, lam, qubit, *, q=None)">
    Apply [`U2Gate`](qiskit.circuit.library.U2Gate "qiskit.circuit.library.U2Gate").
  </Function>

  <span id="zfeaturemap-u3" />

  ### u3

  <Function id="qiskit.circuit.library.ZFeatureMap.u3" signature="ZFeatureMap.u3(theta, phi, lam, qubit, *, q=None)">
    Apply [`U3Gate`](qiskit.circuit.library.U3Gate "qiskit.circuit.library.U3Gate").
  </Function>

  <span id="zfeaturemap-uc" />

  ### uc

  <Function id="qiskit.circuit.library.ZFeatureMap.uc" signature="ZFeatureMap.uc(gate_list, q_controls, q_target, up_to_diagonal=False)">
  ...
  <span id="zfeaturemap-ucg" />

  ### ucg

  <Function id="qiskit.circuit.library.ZFeatureMap.ucg" signature="ZFeatureMap.ucg(angle_list, q_controls, q_target, up_to_diagonal=False)">
    Deprecated version of uc.
  </Function>

  <span id="zfeaturemap-ucrx" />

  ### ucrx

  <Function id="qiskit.circuit.library.ZFeatureMap.ucrx" signature="ZFeatureMap.ucrx(angle_list, q_controls, q_target)">
  ...
  <span id="zfeaturemap-ucry" />

  ### ucry

  <Function id="qiskit.circuit.library.ZFeatureMap.ucry" signature="ZFeatureMap.ucry(angle_list, q_controls, q_target)">
  ...
  <span id="zfeaturemap-ucrz" />

  ### ucrz

  <Function id="qiskit.circuit.library.ZFeatureMap.ucrz" signature="ZFeatureMap.ucrz(angle_list, q_controls, q_target)">
  ...
  <span id="zfeaturemap-ucx" />

  ### ucx

  <Function id="qiskit.circuit.library.ZFeatureMap.ucx" signature="ZFeatureMap.ucx(angle_list, q_controls, q_target)">
    Deprecated version of ucrx.
  </Function>

  <span id="zfeaturemap-ucy" />

  ### ucy

  <Function id="qiskit.circuit.library.ZFeatureMap.ucy" signature="ZFeatureMap.ucy(angle_list, q_controls, q_target)">
    Deprecated version of ucry.
  </Function>

  <span id="zfeaturemap-ucz" />

  ### ucz

  <Function id="qiskit.circuit.library.ZFeatureMap.ucz" signature="ZFeatureMap.ucz(angle_list, q_controls, q_target)">
    Deprecated version of ucrz.
  </Function>

  <span id="zfeaturemap-unitary" />

  ### unitary

  <Function id="qiskit.circuit.library.ZFeatureMap.unitary" signature="ZFeatureMap.unitary(obj, qubits, label=None)">
    Apply unitary gate to q.
  </Function>

  <span id="zfeaturemap-width" />

  ### width

  <Function id="qiskit.circuit.library.ZFeatureMap.width" signature="ZFeatureMap.width()">
  ...
  <span id="zfeaturemap-x" />

  ### x

  <Function id="qiskit.circuit.library.ZFeatureMap.x" signature="ZFeatureMap.x(qubit, *, label=None, ctrl_state=None, q=None)">
    Apply [`XGate`](qiskit.circuit.library.XGate "qiskit.circuit.library.XGate").
  </Function>

  <span id="zfeaturemap-y" />

  ### y

  <Function id="qiskit.circuit.library.ZFeatureMap.y" signature="ZFeatureMap.y(qubit, *, q=None)">
    Apply [`YGate`](qiskit.circuit.library.YGate "qiskit.circuit.library.YGate").
  </Function>

  <span id="zfeaturemap-z" />

  ### z

  <Function id="qiskit.circuit.library.ZFeatureMap.z" signature="ZFeatureMap.z(qubit, *, q=None)">
