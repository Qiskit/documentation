...
<Class id="qiskit.circuit.library.ZFeatureMap" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.14/qiskit/circuit/library/data_preparation/z_feature_map.py" signature="ZFeatureMap(feature_dimension, reps=2, data_map_func=None, insert_barriers=False)">
  ...
  *   **insert\_barriers** (`bool`) – If True, barriers are inserted in between the evolution instructions and hadamard layers.
  ...
  <Attribute id="qiskit.circuit.library.ZFeatureMap.entanglement" signature="Union[str, List[str], List[List[str]], List[int], List[List[int]], List[List[List[int]]], List[List[List[List[int]]]], Callable[[int], str], Callable[[int], List[List[int]]]]">
  ...
  <Attribute id="qiskit.circuit.library.ZFeatureMap.feature_dimension" signature="int">
  ...
  <Attribute id="qiskit.circuit.library.ZFeatureMap.initial_state" signature="Any">
  ...
  <Attribute id="qiskit.circuit.library.ZFeatureMap.insert_barriers" signature="bool">
  ...
  <Attribute id="qiskit.circuit.library.ZFeatureMap.num_layers" signature="int">
  ...
  <Attribute id="qiskit.circuit.library.ZFeatureMap.num_qubits" signature="int">
  ...
  <Attribute id="qiskit.circuit.library.ZFeatureMap.ordered_parameters" signature="List[qiskit.circuit.parameter.Parameter]">
  ...
  <Attribute id="qiskit.circuit.library.ZFeatureMap.parameter_bounds" signature="Optional[List[Tuple[float, float]]]">
  ...
  <Attribute id="qiskit.circuit.library.ZFeatureMap.parameters" signature="Set[qiskit.circuit.parameter.Parameter]">
  ...
  <Attribute id="qiskit.circuit.library.ZFeatureMap.paulis" signature="List[str]">
  ...
  <Attribute id="qiskit.circuit.library.ZFeatureMap.preferred_init_points" signature="Optional[List[float]]">
  ...
  <Attribute id="qiskit.circuit.library.ZFeatureMap.reps" signature="int">
  ...
  <Attribute id="qiskit.circuit.library.ZFeatureMap.rotation_blocks" signature="List[qiskit.circuit.instruction.Instruction]">
  ...
  <Function id="qiskit.circuit.library.ZFeatureMap.cast" signature="static ZFeatureMap.cast(value, _type)">
  ...
  <Function id="qiskit.circuit.library.ZFeatureMap.cls_instances" signature="classmethod ZFeatureMap.cls_instances()">
    Return the current number of instances of this class, useful for auto naming.
  </Function>

  ### cls\_prefix

  <Function id="qiskit.circuit.library.ZFeatureMap.cls_prefix" signature="classmethod ZFeatureMap.cls_prefix()">
  ...
  <Function id="qiskit.circuit.library.ZFeatureMap.from_qasm_file" signature="static ZFeatureMap.from_qasm_file(path)">
  ...
  <Function id="qiskit.circuit.library.ZFeatureMap.from_qasm_str" signature="static ZFeatureMap.from_qasm_str(qasm_str)">
