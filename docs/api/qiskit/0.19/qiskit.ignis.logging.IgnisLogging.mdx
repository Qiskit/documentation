---
title: IgnisLogging (v0.19)
description: API reference for qiskit.ignis.logging.IgnisLogging in qiskit v0.19
...
<Class id="qiskit.ignis.logging.IgnisLogging" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-ignis/tree/stable/0.3/qiskit/ignis/logging/ignis_logging.py" signature="IgnisLogging" modifiers="class">
  ...
  **Config file fields:**
  ...
  <span id="ignislogging-default-datetime-fmt" />
  ...
  <span id="ignislogging-get-file-handler" />
  ...
  <span id="ignislogging-get-log-file" />
  ...
  <span id="ignislogging-get-logger" />
