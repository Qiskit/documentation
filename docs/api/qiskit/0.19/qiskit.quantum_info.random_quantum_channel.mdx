---
title: random_quantum_channel (v0.19)
description: API reference for qiskit.quantum_info.random_quantum_channel in qiskit v0.19
in_page_toc_min_heading_level: 1
python_api_type: function
python_api_name: qiskit.quantum_info.random_quantum_channel
---

<span id="random-quantum-channel" />

# random\_quantum\_channel

<Function id="qiskit.quantum_info.random_quantum_channel" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.14/qiskit/quantum_info/operators/random.py" signature="random_quantum_channel(input_dims=None, output_dims=None, rank=None, seed=None)">
