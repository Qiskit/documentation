...
<Class id="qiskit.circuit.library.EfficientSU2" github="https://github.com/qiskit/qiskit/tree/stable/0.14/qiskit/circuit/library/n_local/efficient_su2.py" signature="EfficientSU2(num_qubits=None, su2_gates=None, entanglement='full', reps=3, skip_unentangled_qubits=False, skip_final_rotation_layer=False, parameter_prefix='θ', insert_barriers=False, initial_state=None)">
  ...
  *   **insert\_barriers** (`bool`) – If True, barriers are inserted in between each layer. If False, no barriers are inserted.
  ...
  <Attribute id="qiskit.circuit.library.EfficientSU2.entanglement" name="entanglement" signature="Union[str, List[str], List[List[str]], List[int], List[List[int]], List[List[List[int]]], List[List[List[List[int]]]], Callable[[int], str], Callable[[int], List[List[int]]]]">
  ...
  <Attribute id="qiskit.circuit.library.EfficientSU2.entanglement_blocks" name="entanglement_blocks" signature="List[qiskit.circuit.instruction.Instruction]">
  ...
  <Attribute id="qiskit.circuit.library.EfficientSU2.extension_lib" signature="= 'include \&#x22;qelib1.inc\&#x22;;'" />

  ### header

  <Attribute id="qiskit.circuit.library.EfficientSU2.header" signature="= 'OPENQASM 2.0;'" />

  ### initial\_state

  <Attribute id="qiskit.circuit.library.EfficientSU2.initial_state" name="initial_state" signature="Any">
  ...
  <Attribute id="qiskit.circuit.library.EfficientSU2.insert_barriers" name="insert_barriers" signature="bool">
  ...
  <Attribute id="qiskit.circuit.library.EfficientSU2.instances" signature="= 8" />

  ### n\_qubits

  <Attribute id="qiskit.circuit.library.EfficientSU2.n_qubits" name="n_qubits">
  ...
  <Attribute id="qiskit.circuit.library.EfficientSU2.num_layers" name="num_layers" signature="int">
  ...
  <Attribute id="qiskit.circuit.library.EfficientSU2.num_parameters_settable" name="num_parameters_settable" signature="int">
  ...
  <Attribute id="qiskit.circuit.library.EfficientSU2.num_qubits" name="num_qubits" signature="int">
  ...
  <Attribute id="qiskit.circuit.library.EfficientSU2.ordered_parameters" name="ordered_parameters" signature="List[qiskit.circuit.parameter.Parameter]">
  ...
  <Attribute id="qiskit.circuit.library.EfficientSU2.parameter_bounds" name="parameter_bounds" signature="List[Tuple[float, float]]">
  ...
  <Attribute id="qiskit.circuit.library.EfficientSU2.parameters" name="parameters" signature="Set[qiskit.circuit.parameter.Parameter]">
  ...
  <Attribute id="qiskit.circuit.library.EfficientSU2.preferred_init_points" name="preferred_init_points" signature="Optional[List[float]]">
  ...
  <Attribute id="qiskit.circuit.library.EfficientSU2.prefix" signature="= 'circuit'" />
  ...
  <Attribute id="qiskit.circuit.library.EfficientSU2.reps" name="reps" signature="int">
  ...
  <Attribute id="qiskit.circuit.library.EfficientSU2.rotation_blocks" name="rotation_blocks" signature="List[qiskit.circuit.instruction.Instruction]">
  ...
  <Function id="qiskit.circuit.library.EfficientSU2.AND" name="AND" signature="EfficientSU2.AND(qr_variables, qb_target, qr_ancillae, flags=None, mct_mode='no-ancilla')">
  ...
  <Function id="qiskit.circuit.library.EfficientSU2.OR" name="OR" signature="EfficientSU2.OR(qr_variables, qb_target, qr_ancillae, flags=None, mct_mode='basic')">
  ...
  <Function id="qiskit.circuit.library.EfficientSU2.__getitem__" name="__getitem__" signature="EfficientSU2.__getitem__(item)">
    Return indexed operation.
  </Function>

  ### \_\_len\_\_

  <Function id="qiskit.circuit.library.EfficientSU2.__len__" name="__len__" signature="EfficientSU2.__len__()">
    Return number of operations in circuit.
  </Function>

  ### add\_layer

  <Function id="qiskit.circuit.library.EfficientSU2.add_layer" name="add_layer" signature="EfficientSU2.add_layer(other, entanglement=None, front=False)">
  ...
  <Function id="qiskit.circuit.library.EfficientSU2.add_register" name="add_register" signature="EfficientSU2.add_register(*regs)">
    Add registers.
  </Function>

  ### append

  <Function id="qiskit.circuit.library.EfficientSU2.append" name="append" signature="EfficientSU2.append(instruction, qargs=None, cargs=None)">
  ...
  <Function id="qiskit.circuit.library.EfficientSU2.assign_parameters" name="assign_parameters" signature="EfficientSU2.assign_parameters(param_dict, inplace=False)">
  ...
  <Function id="qiskit.circuit.library.EfficientSU2.barrier" name="barrier" signature="EfficientSU2.barrier(*qargs)">
    Apply `Barrier`. If qargs is None, applies to all.
  </Function>

  ### bind\_parameters

  <Function id="qiskit.circuit.library.EfficientSU2.bind_parameters" name="bind_parameters" signature="EfficientSU2.bind_parameters(value_dict)">
  ...
  <Function id="qiskit.circuit.library.EfficientSU2.cast" name="cast" signature="static EfficientSU2.cast(value, _type)">
    Best effort to cast value to type. Otherwise, returns the value.
  </Function>

  ### cbit\_argument\_conversion

  <Function id="qiskit.circuit.library.EfficientSU2.cbit_argument_conversion" name="cbit_argument_conversion" signature="EfficientSU2.cbit_argument_conversion(clbit_representation)">
  ...
  <Function id="qiskit.circuit.library.EfficientSU2.ccx" name="ccx" signature="EfficientSU2.ccx(control_qubit1, control_qubit2, target_qubit, *, ctl1=None, ctl2=None, tgt=None)">
    Apply [`CCXGate`](qiskit.circuit.library.CCXGate "qiskit.circuit.library.CCXGate").
  </Function>

  ### ch

  <Function id="qiskit.circuit.library.EfficientSU2.ch" name="ch" signature="EfficientSU2.ch(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CHGate`](qiskit.circuit.library.CHGate "qiskit.circuit.library.CHGate").
  </Function>

  ### cls\_instances

  <Function id="qiskit.circuit.library.EfficientSU2.cls_instances" name="cls_instances" signature="classmethod EfficientSU2.cls_instances()">
    Return the current number of instances of this class, useful for auto naming.
  </Function>

  ### cls\_prefix

  <Function id="qiskit.circuit.library.EfficientSU2.cls_prefix" name="cls_prefix" signature="classmethod EfficientSU2.cls_prefix()">
    Return the prefix to use for auto naming.
  </Function>

  ### cnot

  <Function id="qiskit.circuit.library.EfficientSU2.cnot" name="cnot" signature="EfficientSU2.cnot(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CXGate`](qiskit.circuit.library.CXGate "qiskit.circuit.library.CXGate").
  </Function>

  ### combine

  <Function id="qiskit.circuit.library.EfficientSU2.combine" name="combine" signature="EfficientSU2.combine(rhs)">
  ...
  <Function id="qiskit.circuit.library.EfficientSU2.compose" name="compose" signature="EfficientSU2.compose(other, qubits=None, clbits=None, front=False, inplace=False)">
  ...
  <Function id="qiskit.circuit.library.EfficientSU2.copy" name="copy" signature="EfficientSU2.copy(name=None)">
    Copy the circuit.
  ...
  <Function id="qiskit.circuit.library.EfficientSU2.count_ops" name="count_ops" signature="EfficientSU2.count_ops()">
  ...
  <Function id="qiskit.circuit.library.EfficientSU2.crx" name="crx" signature="EfficientSU2.crx(theta, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CRXGate`](qiskit.circuit.library.CRXGate "qiskit.circuit.library.CRXGate").
  </Function>

  ### cry

  <Function id="qiskit.circuit.library.EfficientSU2.cry" name="cry" signature="EfficientSU2.cry(theta, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CRYGate`](qiskit.circuit.library.CRYGate "qiskit.circuit.library.CRYGate").
  </Function>

  ### crz

  <Function id="qiskit.circuit.library.EfficientSU2.crz" name="crz" signature="EfficientSU2.crz(theta, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CRZGate`](qiskit.circuit.library.CRZGate "qiskit.circuit.library.CRZGate").
  </Function>

  ### cswap

  <Function id="qiskit.circuit.library.EfficientSU2.cswap" name="cswap" signature="EfficientSU2.cswap(control_qubit, target_qubit1, target_qubit2, *, label=None, ctrl_state=None, ctl=None, tgt1=None, tgt2=None)">
    Apply [`CSwapGate`](qiskit.circuit.library.CSwapGate "qiskit.circuit.library.CSwapGate").
  </Function>

  ### cu1

  <Function id="qiskit.circuit.library.EfficientSU2.cu1" name="cu1" signature="EfficientSU2.cu1(theta, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CU1Gate`](qiskit.circuit.library.CU1Gate "qiskit.circuit.library.CU1Gate").
  </Function>

  ### cu3

  <Function id="qiskit.circuit.library.EfficientSU2.cu3" name="cu3" signature="EfficientSU2.cu3(theta, phi, lam, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CU3Gate`](qiskit.circuit.library.CU3Gate "qiskit.circuit.library.CU3Gate").
  </Function>

  ### cx

  <Function id="qiskit.circuit.library.EfficientSU2.cx" name="cx" signature="EfficientSU2.cx(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CXGate`](qiskit.circuit.library.CXGate "qiskit.circuit.library.CXGate").
  </Function>

  ### cy

  <Function id="qiskit.circuit.library.EfficientSU2.cy" name="cy" signature="EfficientSU2.cy(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CYGate`](qiskit.circuit.library.CYGate "qiskit.circuit.library.CYGate").
  </Function>

  ### cz

  <Function id="qiskit.circuit.library.EfficientSU2.cz" name="cz" signature="EfficientSU2.cz(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CZGate`](qiskit.circuit.library.CZGate "qiskit.circuit.library.CZGate").
  </Function>

  ### dcx

  <Function id="qiskit.circuit.library.EfficientSU2.dcx" name="dcx" signature="EfficientSU2.dcx(qubit1, qubit2)">
    Apply [`DCXGate`](qiskit.circuit.library.DCXGate "qiskit.circuit.library.DCXGate").
  </Function>

  ### decompose

  <Function id="qiskit.circuit.library.EfficientSU2.decompose" name="decompose" signature="EfficientSU2.decompose()">
  ...
  <Function id="qiskit.circuit.library.EfficientSU2.depth" name="depth" signature="EfficientSU2.depth()">
  ...
  <Function id="qiskit.circuit.library.EfficientSU2.diag_gate" name="diag_gate" signature="EfficientSU2.diag_gate(diag, qubit)">
    Deprecated version of QuantumCircuit.diagonal.
  </Function>

  ### diagonal

  <Function id="qiskit.circuit.library.EfficientSU2.diagonal" name="diagonal" signature="EfficientSU2.diagonal(diag, qubit)">
  ...
  <Function id="qiskit.circuit.library.EfficientSU2.extend" name="extend" signature="EfficientSU2.extend(rhs)">
  ...
  <Function id="qiskit.circuit.library.EfficientSU2.fredkin" name="fredkin" signature="EfficientSU2.fredkin(control_qubit, target_qubit1, target_qubit2, *, ctl=None, tgt1=None, tgt2=None)">
    Apply [`CSwapGate`](qiskit.circuit.library.CSwapGate "qiskit.circuit.library.CSwapGate").
  </Function>

  ### from\_qasm\_file

  <Function id="qiskit.circuit.library.EfficientSU2.from_qasm_file" name="from_qasm_file" signature="static EfficientSU2.from_qasm_file(path)">
  ...
  <Function id="qiskit.circuit.library.EfficientSU2.from_qasm_str" name="from_qasm_str" signature="static EfficientSU2.from_qasm_str(qasm_str)">
  ...
  <Function id="qiskit.circuit.library.EfficientSU2.get_entangler_map" name="get_entangler_map" signature="EfficientSU2.get_entangler_map(rep_num, block_num, num_block_qubits)">
  ...
  <Function id="qiskit.circuit.library.EfficientSU2.get_unentangled_qubits" name="get_unentangled_qubits" signature="EfficientSU2.get_unentangled_qubits()">
  ...
  <Function id="qiskit.circuit.library.EfficientSU2.h" name="h" signature="EfficientSU2.h(qubit, *, q=None)">
    Apply [`HGate`](qiskit.circuit.library.HGate "qiskit.circuit.library.HGate").
  </Function>

  ### hamiltonian

  <Function id="qiskit.circuit.library.EfficientSU2.hamiltonian" name="hamiltonian" signature="EfficientSU2.hamiltonian(operator, time, qubits, label=None)">
    Apply hamiltonian evolution to to qubits.
  </Function>

  ### has\_register

  <Function id="qiskit.circuit.library.EfficientSU2.has_register" name="has_register" signature="EfficientSU2.has_register(register)">
  ...
  <Function id="qiskit.circuit.library.EfficientSU2.i" name="i" signature="EfficientSU2.i(qubit, *, q=None)">
    Apply [`IGate`](qiskit.circuit.library.IGate "qiskit.circuit.library.IGate").
  </Function>

  ### id

  <Function id="qiskit.circuit.library.EfficientSU2.id" name="id" signature="EfficientSU2.id(qubit, *, q=None)">
    Apply [`IGate`](qiskit.circuit.library.IGate "qiskit.circuit.library.IGate").
  </Function>

  ### iden

  <Function id="qiskit.circuit.library.EfficientSU2.iden" name="iden" signature="EfficientSU2.iden(qubit, *, q=None)">
    Deprecated identity gate.
  </Function>

  ### initialize

  <Function id="qiskit.circuit.library.EfficientSU2.initialize" name="initialize" signature="EfficientSU2.initialize(params, qubits)">
    Apply initialize to circuit.
  </Function>

  ### inverse

  <Function id="qiskit.circuit.library.EfficientSU2.inverse" name="inverse" signature="EfficientSU2.inverse()">
    Invert this circuit.
  ...
  <Function id="qiskit.circuit.library.EfficientSU2.iso" name="iso" signature="EfficientSU2.iso(isometry, q_input, q_ancillas_for_output, q_ancillas_zero=None, q_ancillas_dirty=None)">
  ...
  <Function id="qiskit.circuit.library.EfficientSU2.isometry" name="isometry" signature="EfficientSU2.isometry(isometry, q_input, q_ancillas_for_output, q_ancillas_zero=None, q_ancillas_dirty=None)">
    Attach an arbitrary isometry from m to n qubits to a circuit. In particular, this allows to attach arbitrary unitaries on n qubits (m=n) or to prepare any state on n qubits (m=0). The decomposition used here was introduced by Iten et al. in [https://arxiv.org/abs/1501.06911](https://arxiv.org/abs/1501.06911).
  ...
  <Function id="qiskit.circuit.library.EfficientSU2.iswap" name="iswap" signature="EfficientSU2.iswap(qubit1, qubit2)">
    Apply [`iSwapGate`](qiskit.circuit.library.iSwapGate "qiskit.circuit.library.iSwapGate").
  </Function>

  ### mcmt

  <Function id="qiskit.circuit.library.EfficientSU2.mcmt" name="mcmt" signature="EfficientSU2.mcmt(gate, control_qubits, target_qubits, ancilla_qubits=None, mode='no-ancilla', *, single_control_gate_fun=None, q_controls=None, q_ancillae=None, q_targets=None)">
  ...
  <Function id="qiskit.circuit.library.EfficientSU2.mcrx" name="mcrx" signature="EfficientSU2.mcrx(theta, q_controls, q_target, use_basis_gates=False)">
  ...
  <Function id="qiskit.circuit.library.EfficientSU2.mcry" name="mcry" signature="EfficientSU2.mcry(theta, q_controls, q_target, q_ancillae, mode='basic', use_basis_gates=False)">
  ...
  <Function id="qiskit.circuit.library.EfficientSU2.mcrz" name="mcrz" signature="EfficientSU2.mcrz(lam, q_controls, q_target, use_basis_gates=False)">
  ...
  <Function id="qiskit.circuit.library.EfficientSU2.mct" name="mct" signature="EfficientSU2.mct(control_qubits, target_qubit, ancilla_qubits=None, mode='noancilla')">
    Apply `MCXGate`.
  </Function>

  ### mcu1

  <Function id="qiskit.circuit.library.EfficientSU2.mcu1" name="mcu1" signature="EfficientSU2.mcu1(lam, control_qubits, target_qubit)">
    Apply `MCU1Gate`.
  </Function>

  ### mcx

  <Function id="qiskit.circuit.library.EfficientSU2.mcx" name="mcx" signature="EfficientSU2.mcx(control_qubits, target_qubit, ancilla_qubits=None, mode='noancilla')">
    Apply `MCXGate`.
  ...
  <Function id="qiskit.circuit.library.EfficientSU2.measure" name="measure" signature="EfficientSU2.measure(qubit, cbit)">
  ...
  <Function id="qiskit.circuit.library.EfficientSU2.measure_active" name="measure_active" signature="EfficientSU2.measure_active(inplace=True)">
  ...
  <Function id="qiskit.circuit.library.EfficientSU2.measure_all" name="measure_all" signature="EfficientSU2.measure_all(inplace=True)">
  ...
  <Function id="qiskit.circuit.library.EfficientSU2.mirror" name="mirror" signature="EfficientSU2.mirror()">
  ...
  <Function id="qiskit.circuit.library.EfficientSU2.ms" name="ms" signature="EfficientSU2.ms(theta, qubits)">
    Apply [`MSGate`](qiskit.circuit.library.MSGate "qiskit.circuit.library.MSGate").
  </Function>

  ### num\_connected\_components

  <Function id="qiskit.circuit.library.EfficientSU2.num_connected_components" name="num_connected_components" signature="EfficientSU2.num_connected_components(unitary_only=False)">
  ...
  <Function id="qiskit.circuit.library.EfficientSU2.num_nonlocal_gates" name="num_nonlocal_gates" signature="EfficientSU2.num_nonlocal_gates()">
  ...
  <Function id="qiskit.circuit.library.EfficientSU2.num_tensor_factors" name="num_tensor_factors" signature="EfficientSU2.num_tensor_factors()">
  ...
  <Function id="qiskit.circuit.library.EfficientSU2.num_unitary_factors" name="num_unitary_factors" signature="EfficientSU2.num_unitary_factors()">
    Computes the number of tensor factors in the unitary (quantum) part of the circuit only.
  </Function>

  ### print\_settings

  <Function id="qiskit.circuit.library.EfficientSU2.print_settings" name="print_settings" signature="EfficientSU2.print_settings()">
  ...
  <Function id="qiskit.circuit.library.EfficientSU2.qasm" name="qasm" signature="EfficientSU2.qasm(formatted=False, filename=None)">
  ...
  <Function id="qiskit.circuit.library.EfficientSU2.qbit_argument_conversion" name="qbit_argument_conversion" signature="EfficientSU2.qbit_argument_conversion(qubit_representation)">
  ...
  <Function id="qiskit.circuit.library.EfficientSU2.r" name="r" signature="EfficientSU2.r(theta, phi, qubit, *, q=None)">
    Apply `RGate`.
  </Function>

  ### rcccx

  <Function id="qiskit.circuit.library.EfficientSU2.rcccx" name="rcccx" signature="EfficientSU2.rcccx(control_qubit1, control_qubit2, control_qubit3, target_qubit)">
    Apply [`RC3XGate`](qiskit.circuit.library.RC3XGate "qiskit.circuit.library.RC3XGate").
  </Function>

  ### rccx

  <Function id="qiskit.circuit.library.EfficientSU2.rccx" name="rccx" signature="EfficientSU2.rccx(control_qubit1, control_qubit2, target_qubit)">
    Apply [`RCCXGate`](qiskit.circuit.library.RCCXGate "qiskit.circuit.library.RCCXGate").
  </Function>

  ### remove\_final\_measurements

  <Function id="qiskit.circuit.library.EfficientSU2.remove_final_measurements" name="remove_final_measurements" signature="EfficientSU2.remove_final_measurements(inplace=True)">
  ...
  <Function id="qiskit.circuit.library.EfficientSU2.reset" name="reset" signature="EfficientSU2.reset(qubit)">
    Reset q.
  </Function>

  ### rx

  <Function id="qiskit.circuit.library.EfficientSU2.rx" name="rx" signature="EfficientSU2.rx(theta, qubit, *, label=None, q=None)">
    Apply [`RXGate`](qiskit.circuit.library.RXGate "qiskit.circuit.library.RXGate").
  </Function>

  ### rxx

  <Function id="qiskit.circuit.library.EfficientSU2.rxx" name="rxx" signature="EfficientSU2.rxx(theta, qubit1, qubit2)">
    Apply [`RXXGate`](qiskit.circuit.library.RXXGate "qiskit.circuit.library.RXXGate").
  </Function>

  ### ry

  <Function id="qiskit.circuit.library.EfficientSU2.ry" name="ry" signature="EfficientSU2.ry(theta, qubit, *, label=None, q=None)">
    Apply [`RYGate`](qiskit.circuit.library.RYGate "qiskit.circuit.library.RYGate").
  </Function>

  ### ryy

  <Function id="qiskit.circuit.library.EfficientSU2.ryy" name="ryy" signature="EfficientSU2.ryy(theta, qubit1, qubit2)">
    Apply [`RYYGate`](qiskit.circuit.library.RYYGate "qiskit.circuit.library.RYYGate").
  </Function>

  ### rz

  <Function id="qiskit.circuit.library.EfficientSU2.rz" name="rz" signature="EfficientSU2.rz(phi, qubit, *, q=None)">
    Apply [`RZGate`](qiskit.circuit.library.RZGate "qiskit.circuit.library.RZGate").
  </Function>

  ### rzx

  <Function id="qiskit.circuit.library.EfficientSU2.rzx" name="rzx" signature="EfficientSU2.rzx(theta, qubit1, qubit2)">
    Apply [`RZXGate`](qiskit.circuit.library.RZXGate "qiskit.circuit.library.RZXGate").
  </Function>

  ### rzz

  <Function id="qiskit.circuit.library.EfficientSU2.rzz" name="rzz" signature="EfficientSU2.rzz(theta, qubit1, qubit2)">
    Apply [`RZZGate`](qiskit.circuit.library.RZZGate "qiskit.circuit.library.RZZGate").
  </Function>

  ### s

  <Function id="qiskit.circuit.library.EfficientSU2.s" name="s" signature="EfficientSU2.s(qubit, *, q=None)">
    Apply [`SGate`](qiskit.circuit.library.SGate "qiskit.circuit.library.SGate").
  </Function>

  ### sdg

  <Function id="qiskit.circuit.library.EfficientSU2.sdg" name="sdg" signature="EfficientSU2.sdg(qubit, *, q=None)">
    Apply [`SdgGate`](qiskit.circuit.library.SdgGate "qiskit.circuit.library.SdgGate").
  </Function>

  ### size

  <Function id="qiskit.circuit.library.EfficientSU2.size" name="size" signature="EfficientSU2.size()">
  ...
  <Function id="qiskit.circuit.library.EfficientSU2.snapshot" name="snapshot" signature="EfficientSU2.snapshot(label, snapshot_type='statevector', qubits=None, params=None)">
  ...
  <Function id="qiskit.circuit.library.EfficientSU2.snapshot_density_matrix" name="snapshot_density_matrix" signature="EfficientSU2.snapshot_density_matrix(label, qubits=None)">
  ...
  <Function id="qiskit.circuit.library.EfficientSU2.snapshot_expectation_value" name="snapshot_expectation_value" signature="EfficientSU2.snapshot_expectation_value(label, op, qubits, single_shot=False, variance=False)">
  ...
  <Function id="qiskit.circuit.library.EfficientSU2.snapshot_probabilities" name="snapshot_probabilities" signature="EfficientSU2.snapshot_probabilities(label, qubits, variance=False)">
  ...
  <Function id="qiskit.circuit.library.EfficientSU2.snapshot_stabilizer" name="snapshot_stabilizer" signature="EfficientSU2.snapshot_stabilizer(label)">
  ...
  <Function id="qiskit.circuit.library.EfficientSU2.snapshot_statevector" name="snapshot_statevector" signature="EfficientSU2.snapshot_statevector(label)">
  ...
  <Function id="qiskit.circuit.library.EfficientSU2.squ" name="squ" signature="EfficientSU2.squ(unitary_matrix, qubit, mode='ZYZ', up_to_diagonal=False, *, u=None)">
  ...
  <Function id="qiskit.circuit.library.EfficientSU2.swap" name="swap" signature="EfficientSU2.swap(qubit1, qubit2)">
    Apply [`SwapGate`](qiskit.circuit.library.SwapGate "qiskit.circuit.library.SwapGate").
  </Function>

  ### t

  <Function id="qiskit.circuit.library.EfficientSU2.t" name="t" signature="EfficientSU2.t(qubit, *, q=None)">
    Apply [`TGate`](qiskit.circuit.library.TGate "qiskit.circuit.library.TGate").
  </Function>

  ### tdg

  <Function id="qiskit.circuit.library.EfficientSU2.tdg" name="tdg" signature="EfficientSU2.tdg(qubit, *, q=None)">
    Apply [`TdgGate`](qiskit.circuit.library.TdgGate "qiskit.circuit.library.TdgGate").
  </Function>

  ### to\_gate

  <Function id="qiskit.circuit.library.EfficientSU2.to_gate" name="to_gate" signature="EfficientSU2.to_gate(parameter_map=None)">
  ...
  <Function id="qiskit.circuit.library.EfficientSU2.to_instruction" name="to_instruction" signature="EfficientSU2.to_instruction(parameter_map=None)">
  ...
  <Function id="qiskit.circuit.library.EfficientSU2.toffoli" name="toffoli" signature="EfficientSU2.toffoli(control_qubit1, control_qubit2, target_qubit, *, ctl1=None, ctl2=None, tgt=None)">
    Apply [`CCXGate`](qiskit.circuit.library.CCXGate "qiskit.circuit.library.CCXGate").
  </Function>

  ### u1

  <Function id="qiskit.circuit.library.EfficientSU2.u1" name="u1" signature="EfficientSU2.u1(theta, qubit, *, q=None)">
    Apply [`U1Gate`](qiskit.circuit.library.U1Gate "qiskit.circuit.library.U1Gate").
  </Function>

  ### u2

  <Function id="qiskit.circuit.library.EfficientSU2.u2" name="u2" signature="EfficientSU2.u2(phi, lam, qubit, *, q=None)">
    Apply [`U2Gate`](qiskit.circuit.library.U2Gate "qiskit.circuit.library.U2Gate").
  </Function>

  ### u3

  <Function id="qiskit.circuit.library.EfficientSU2.u3" name="u3" signature="EfficientSU2.u3(theta, phi, lam, qubit, *, q=None)">
    Apply [`U3Gate`](qiskit.circuit.library.U3Gate "qiskit.circuit.library.U3Gate").
  </Function>

  ### uc

  <Function id="qiskit.circuit.library.EfficientSU2.uc" name="uc" signature="EfficientSU2.uc(gate_list, q_controls, q_target, up_to_diagonal=False)">
  ...
  <Function id="qiskit.circuit.library.EfficientSU2.ucg" name="ucg" signature="EfficientSU2.ucg(angle_list, q_controls, q_target, up_to_diagonal=False)">
    Deprecated version of uc.
  </Function>

  ### ucrx

  <Function id="qiskit.circuit.library.EfficientSU2.ucrx" name="ucrx" signature="EfficientSU2.ucrx(angle_list, q_controls, q_target)">
  ...
  <Function id="qiskit.circuit.library.EfficientSU2.ucry" name="ucry" signature="EfficientSU2.ucry(angle_list, q_controls, q_target)">
  ...
  <Function id="qiskit.circuit.library.EfficientSU2.ucrz" name="ucrz" signature="EfficientSU2.ucrz(angle_list, q_controls, q_target)">
  ...
  <Function id="qiskit.circuit.library.EfficientSU2.ucx" name="ucx" signature="EfficientSU2.ucx(angle_list, q_controls, q_target)">
    Deprecated version of ucrx.
  </Function>

  ### ucy

  <Function id="qiskit.circuit.library.EfficientSU2.ucy" name="ucy" signature="EfficientSU2.ucy(angle_list, q_controls, q_target)">
    Deprecated version of ucry.
  </Function>

  ### ucz

  <Function id="qiskit.circuit.library.EfficientSU2.ucz" name="ucz" signature="EfficientSU2.ucz(angle_list, q_controls, q_target)">
    Deprecated version of ucrz.
  </Function>

  ### unitary

  <Function id="qiskit.circuit.library.EfficientSU2.unitary" name="unitary" signature="EfficientSU2.unitary(obj, qubits, label=None)">
    Apply unitary gate to q.
  </Function>

  ### width

  <Function id="qiskit.circuit.library.EfficientSU2.width" name="width" signature="EfficientSU2.width()">
  ...
  <Function id="qiskit.circuit.library.EfficientSU2.x" name="x" signature="EfficientSU2.x(qubit, *, label=None, ctrl_state=None, q=None)">
    Apply [`XGate`](qiskit.circuit.library.XGate "qiskit.circuit.library.XGate").
  </Function>

  ### y

  <Function id="qiskit.circuit.library.EfficientSU2.y" name="y" signature="EfficientSU2.y(qubit, *, q=None)">
    Apply [`YGate`](qiskit.circuit.library.YGate "qiskit.circuit.library.YGate").
  </Function>

  ### z

  <Function id="qiskit.circuit.library.EfficientSU2.z" name="z" signature="EfficientSU2.z(qubit, *, q=None)">
