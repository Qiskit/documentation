...
<Class id="qiskit.circuit.library.HiddenLinearFunction" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.14/qiskit/circuit/library/hidden_linear_function.py" signature="HiddenLinearFunction(adjacency_matrix)">
...
$$
  ...
  **adjacency\_matrix** (`Union`\[`List`\[`List`\[`int`]], `ndarray`]) – a symmetric n-by-n list of 0-1 lists. n will be the number of qubits.
  ...
  <Attribute id="qiskit.circuit.library.HiddenLinearFunction.extension_lib" signature="= 'include \&#x22;qelib1.inc\&#x22;;'" />

  ### header

  <Attribute id="qiskit.circuit.library.HiddenLinearFunction.header" signature="= 'OPENQASM 2.0;'" />

  ### instances

  <Attribute id="qiskit.circuit.library.HiddenLinearFunction.instances" signature="= 8" />

  ### n\_qubits

  <Attribute id="qiskit.circuit.library.HiddenLinearFunction.n_qubits" name="n_qubits">
  ...
  <Attribute id="qiskit.circuit.library.HiddenLinearFunction.prefix" signature="= 'circuit'" />
  ...
  <Function id="qiskit.circuit.library.HiddenLinearFunction.AND" name="AND" signature="HiddenLinearFunction.AND(qr_variables, qb_target, qr_ancillae, flags=None, mct_mode='no-ancilla')">
  ...
  <Function id="qiskit.circuit.library.HiddenLinearFunction.OR" name="OR" signature="HiddenLinearFunction.OR(qr_variables, qb_target, qr_ancillae, flags=None, mct_mode='basic')">
  ...
  <Function id="qiskit.circuit.library.HiddenLinearFunction.__getitem__" name="__getitem__" signature="HiddenLinearFunction.__getitem__(item)">
    Return indexed operation.
  </Function>

  ### \_\_len\_\_

  <Function id="qiskit.circuit.library.HiddenLinearFunction.__len__" name="__len__" signature="HiddenLinearFunction.__len__()">
    Return number of operations in circuit.
  </Function>

  ### add\_register

  <Function id="qiskit.circuit.library.HiddenLinearFunction.add_register" name="add_register" signature="HiddenLinearFunction.add_register(*regs)">
    Add registers.
  </Function>

  ### append

  <Function id="qiskit.circuit.library.HiddenLinearFunction.append" name="append" signature="HiddenLinearFunction.append(instruction, qargs=None, cargs=None)">
  ...
  <Function id="qiskit.circuit.library.HiddenLinearFunction.assign_parameters" name="assign_parameters" signature="HiddenLinearFunction.assign_parameters(param_dict, inplace=False)">
  ...
  <Function id="qiskit.circuit.library.HiddenLinearFunction.barrier" name="barrier" signature="HiddenLinearFunction.barrier(*qargs)">
    Apply `Barrier`. If qargs is None, applies to all.
  </Function>

  ### bind\_parameters

  <Function id="qiskit.circuit.library.HiddenLinearFunction.bind_parameters" name="bind_parameters" signature="HiddenLinearFunction.bind_parameters(value_dict)">
  ...
  <Function id="qiskit.circuit.library.HiddenLinearFunction.cast" name="cast" signature="static HiddenLinearFunction.cast(value, _type)">
    Best effort to cast value to type. Otherwise, returns the value.
  </Function>

  ### cbit\_argument\_conversion

  <Function id="qiskit.circuit.library.HiddenLinearFunction.cbit_argument_conversion" name="cbit_argument_conversion" signature="HiddenLinearFunction.cbit_argument_conversion(clbit_representation)">
  ...
  <Function id="qiskit.circuit.library.HiddenLinearFunction.ccx" name="ccx" signature="HiddenLinearFunction.ccx(control_qubit1, control_qubit2, target_qubit, *, ctl1=None, ctl2=None, tgt=None)">
    Apply [`CCXGate`](qiskit.circuit.library.CCXGate "qiskit.circuit.library.CCXGate").
  </Function>

  ### ch

  <Function id="qiskit.circuit.library.HiddenLinearFunction.ch" name="ch" signature="HiddenLinearFunction.ch(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CHGate`](qiskit.circuit.library.CHGate "qiskit.circuit.library.CHGate").
  </Function>

  ### cls\_instances

  <Function id="qiskit.circuit.library.HiddenLinearFunction.cls_instances" name="cls_instances" signature="classmethod HiddenLinearFunction.cls_instances()">
    Return the current number of instances of this class, useful for auto naming.
  </Function>

  ### cls\_prefix

  <Function id="qiskit.circuit.library.HiddenLinearFunction.cls_prefix" name="cls_prefix" signature="classmethod HiddenLinearFunction.cls_prefix()">
    Return the prefix to use for auto naming.
  </Function>

  ### cnot

  <Function id="qiskit.circuit.library.HiddenLinearFunction.cnot" name="cnot" signature="HiddenLinearFunction.cnot(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CXGate`](qiskit.circuit.library.CXGate "qiskit.circuit.library.CXGate").
  </Function>

  ### combine

  <Function id="qiskit.circuit.library.HiddenLinearFunction.combine" name="combine" signature="HiddenLinearFunction.combine(rhs)">
  ...
  <Function id="qiskit.circuit.library.HiddenLinearFunction.compose" name="compose" signature="HiddenLinearFunction.compose(other, qubits=None, clbits=None, front=False, inplace=False)">
  ...
  <Function id="qiskit.circuit.library.HiddenLinearFunction.copy" name="copy" signature="HiddenLinearFunction.copy(name=None)">
    Copy the circuit.
  ...
  <Function id="qiskit.circuit.library.HiddenLinearFunction.count_ops" name="count_ops" signature="HiddenLinearFunction.count_ops()">
  ...
  <Function id="qiskit.circuit.library.HiddenLinearFunction.crx" name="crx" signature="HiddenLinearFunction.crx(theta, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CRXGate`](qiskit.circuit.library.CRXGate "qiskit.circuit.library.CRXGate").
  </Function>

  ### cry

  <Function id="qiskit.circuit.library.HiddenLinearFunction.cry" name="cry" signature="HiddenLinearFunction.cry(theta, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CRYGate`](qiskit.circuit.library.CRYGate "qiskit.circuit.library.CRYGate").
  </Function>

  ### crz

  <Function id="qiskit.circuit.library.HiddenLinearFunction.crz" name="crz" signature="HiddenLinearFunction.crz(theta, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CRZGate`](qiskit.circuit.library.CRZGate "qiskit.circuit.library.CRZGate").
  </Function>

  ### cswap

  <Function id="qiskit.circuit.library.HiddenLinearFunction.cswap" name="cswap" signature="HiddenLinearFunction.cswap(control_qubit, target_qubit1, target_qubit2, *, label=None, ctrl_state=None, ctl=None, tgt1=None, tgt2=None)">
    Apply [`CSwapGate`](qiskit.circuit.library.CSwapGate "qiskit.circuit.library.CSwapGate").
  </Function>

  ### cu1

  <Function id="qiskit.circuit.library.HiddenLinearFunction.cu1" name="cu1" signature="HiddenLinearFunction.cu1(theta, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CU1Gate`](qiskit.circuit.library.CU1Gate "qiskit.circuit.library.CU1Gate").
  </Function>

  ### cu3

  <Function id="qiskit.circuit.library.HiddenLinearFunction.cu3" name="cu3" signature="HiddenLinearFunction.cu3(theta, phi, lam, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CU3Gate`](qiskit.circuit.library.CU3Gate "qiskit.circuit.library.CU3Gate").
  </Function>

  ### cx

  <Function id="qiskit.circuit.library.HiddenLinearFunction.cx" name="cx" signature="HiddenLinearFunction.cx(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CXGate`](qiskit.circuit.library.CXGate "qiskit.circuit.library.CXGate").
  </Function>

  ### cy

  <Function id="qiskit.circuit.library.HiddenLinearFunction.cy" name="cy" signature="HiddenLinearFunction.cy(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CYGate`](qiskit.circuit.library.CYGate "qiskit.circuit.library.CYGate").
  </Function>

  ### cz

  <Function id="qiskit.circuit.library.HiddenLinearFunction.cz" name="cz" signature="HiddenLinearFunction.cz(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CZGate`](qiskit.circuit.library.CZGate "qiskit.circuit.library.CZGate").
  </Function>

  ### dcx

  <Function id="qiskit.circuit.library.HiddenLinearFunction.dcx" name="dcx" signature="HiddenLinearFunction.dcx(qubit1, qubit2)">
    Apply [`DCXGate`](qiskit.circuit.library.DCXGate "qiskit.circuit.library.DCXGate").
  </Function>

  ### decompose

  <Function id="qiskit.circuit.library.HiddenLinearFunction.decompose" name="decompose" signature="HiddenLinearFunction.decompose()">
  ...
  <Function id="qiskit.circuit.library.HiddenLinearFunction.depth" name="depth" signature="HiddenLinearFunction.depth()">
  ...
  <Function id="qiskit.circuit.library.HiddenLinearFunction.diag_gate" name="diag_gate" signature="HiddenLinearFunction.diag_gate(diag, qubit)">
    Deprecated version of QuantumCircuit.diagonal.
  </Function>

  ### diagonal

  <Function id="qiskit.circuit.library.HiddenLinearFunction.diagonal" name="diagonal" signature="HiddenLinearFunction.diagonal(diag, qubit)">
  ...
  <Function id="qiskit.circuit.library.HiddenLinearFunction.extend" name="extend" signature="HiddenLinearFunction.extend(rhs)">
  ...
  <Function id="qiskit.circuit.library.HiddenLinearFunction.fredkin" name="fredkin" signature="HiddenLinearFunction.fredkin(control_qubit, target_qubit1, target_qubit2, *, ctl=None, tgt1=None, tgt2=None)">
    Apply [`CSwapGate`](qiskit.circuit.library.CSwapGate "qiskit.circuit.library.CSwapGate").
  </Function>

  ### from\_qasm\_file

  <Function id="qiskit.circuit.library.HiddenLinearFunction.from_qasm_file" name="from_qasm_file" signature="static HiddenLinearFunction.from_qasm_file(path)">
  ...
  <Function id="qiskit.circuit.library.HiddenLinearFunction.from_qasm_str" name="from_qasm_str" signature="static HiddenLinearFunction.from_qasm_str(qasm_str)">
  ...
  <Function id="qiskit.circuit.library.HiddenLinearFunction.h" name="h" signature="HiddenLinearFunction.h(qubit, *, q=None)">
    Apply [`HGate`](qiskit.circuit.library.HGate "qiskit.circuit.library.HGate").
  </Function>

  ### hamiltonian

  <Function id="qiskit.circuit.library.HiddenLinearFunction.hamiltonian" name="hamiltonian" signature="HiddenLinearFunction.hamiltonian(operator, time, qubits, label=None)">
    Apply hamiltonian evolution to to qubits.
  </Function>

  ### has\_register

  <Function id="qiskit.circuit.library.HiddenLinearFunction.has_register" name="has_register" signature="HiddenLinearFunction.has_register(register)">
  ...
  <Function id="qiskit.circuit.library.HiddenLinearFunction.i" name="i" signature="HiddenLinearFunction.i(qubit, *, q=None)">
    Apply [`IGate`](qiskit.circuit.library.IGate "qiskit.circuit.library.IGate").
  </Function>

  ### id

  <Function id="qiskit.circuit.library.HiddenLinearFunction.id" name="id" signature="HiddenLinearFunction.id(qubit, *, q=None)">
    Apply [`IGate`](qiskit.circuit.library.IGate "qiskit.circuit.library.IGate").
  </Function>

  ### iden

  <Function id="qiskit.circuit.library.HiddenLinearFunction.iden" name="iden" signature="HiddenLinearFunction.iden(qubit, *, q=None)">
    Deprecated identity gate.
  </Function>

  ### initialize

  <Function id="qiskit.circuit.library.HiddenLinearFunction.initialize" name="initialize" signature="HiddenLinearFunction.initialize(params, qubits)">
    Apply initialize to circuit.
  </Function>

  ### inverse

  <Function id="qiskit.circuit.library.HiddenLinearFunction.inverse" name="inverse" signature="HiddenLinearFunction.inverse()">
    Invert this circuit.
  ...
  <Function id="qiskit.circuit.library.HiddenLinearFunction.iso" name="iso" signature="HiddenLinearFunction.iso(isometry, q_input, q_ancillas_for_output, q_ancillas_zero=None, q_ancillas_dirty=None)">
  ...
  <Function id="qiskit.circuit.library.HiddenLinearFunction.isometry" name="isometry" signature="HiddenLinearFunction.isometry(isometry, q_input, q_ancillas_for_output, q_ancillas_zero=None, q_ancillas_dirty=None)">
    Attach an arbitrary isometry from m to n qubits to a circuit. In particular, this allows to attach arbitrary unitaries on n qubits (m=n) or to prepare any state on n qubits (m=0). The decomposition used here was introduced by Iten et al. in [https://arxiv.org/abs/1501.06911](https://arxiv.org/abs/1501.06911).
  ...
  <Function id="qiskit.circuit.library.HiddenLinearFunction.iswap" name="iswap" signature="HiddenLinearFunction.iswap(qubit1, qubit2)">
    Apply [`iSwapGate`](qiskit.circuit.library.iSwapGate "qiskit.circuit.library.iSwapGate").
  </Function>

  ### mcmt

  <Function id="qiskit.circuit.library.HiddenLinearFunction.mcmt" name="mcmt" signature="HiddenLinearFunction.mcmt(gate, control_qubits, target_qubits, ancilla_qubits=None, mode='no-ancilla', *, single_control_gate_fun=None, q_controls=None, q_ancillae=None, q_targets=None)">
  ...
  <Function id="qiskit.circuit.library.HiddenLinearFunction.mcrx" name="mcrx" signature="HiddenLinearFunction.mcrx(theta, q_controls, q_target, use_basis_gates=False)">
  ...
  <Function id="qiskit.circuit.library.HiddenLinearFunction.mcry" name="mcry" signature="HiddenLinearFunction.mcry(theta, q_controls, q_target, q_ancillae, mode='basic', use_basis_gates=False)">
  ...
  <Function id="qiskit.circuit.library.HiddenLinearFunction.mcrz" name="mcrz" signature="HiddenLinearFunction.mcrz(lam, q_controls, q_target, use_basis_gates=False)">
  ...
  <Function id="qiskit.circuit.library.HiddenLinearFunction.mct" name="mct" signature="HiddenLinearFunction.mct(control_qubits, target_qubit, ancilla_qubits=None, mode='noancilla')">
    Apply `MCXGate`.
  </Function>

  ### mcu1

  <Function id="qiskit.circuit.library.HiddenLinearFunction.mcu1" name="mcu1" signature="HiddenLinearFunction.mcu1(lam, control_qubits, target_qubit)">
    Apply `MCU1Gate`.
  </Function>

  ### mcx

  <Function id="qiskit.circuit.library.HiddenLinearFunction.mcx" name="mcx" signature="HiddenLinearFunction.mcx(control_qubits, target_qubit, ancilla_qubits=None, mode='noancilla')">
    Apply `MCXGate`.
  ...
  <Function id="qiskit.circuit.library.HiddenLinearFunction.measure" name="measure" signature="HiddenLinearFunction.measure(qubit, cbit)">
  ...
  <Function id="qiskit.circuit.library.HiddenLinearFunction.measure_active" name="measure_active" signature="HiddenLinearFunction.measure_active(inplace=True)">
  ...
  <Function id="qiskit.circuit.library.HiddenLinearFunction.measure_all" name="measure_all" signature="HiddenLinearFunction.measure_all(inplace=True)">
  ...
  <Function id="qiskit.circuit.library.HiddenLinearFunction.mirror" name="mirror" signature="HiddenLinearFunction.mirror()">
  ...
  <Function id="qiskit.circuit.library.HiddenLinearFunction.ms" name="ms" signature="HiddenLinearFunction.ms(theta, qubits)">
    Apply [`MSGate`](qiskit.circuit.library.MSGate "qiskit.circuit.library.MSGate").
  </Function>

  ### num\_connected\_components

  <Function id="qiskit.circuit.library.HiddenLinearFunction.num_connected_components" name="num_connected_components" signature="HiddenLinearFunction.num_connected_components(unitary_only=False)">
  ...
  <Function id="qiskit.circuit.library.HiddenLinearFunction.num_nonlocal_gates" name="num_nonlocal_gates" signature="HiddenLinearFunction.num_nonlocal_gates()">
  ...
  <Function id="qiskit.circuit.library.HiddenLinearFunction.num_tensor_factors" name="num_tensor_factors" signature="HiddenLinearFunction.num_tensor_factors()">
  ...
  <Function id="qiskit.circuit.library.HiddenLinearFunction.num_unitary_factors" name="num_unitary_factors" signature="HiddenLinearFunction.num_unitary_factors()">
    Computes the number of tensor factors in the unitary (quantum) part of the circuit only.
  </Function>

  ### qasm

  <Function id="qiskit.circuit.library.HiddenLinearFunction.qasm" name="qasm" signature="HiddenLinearFunction.qasm(formatted=False, filename=None)">
  ...
  <Function id="qiskit.circuit.library.HiddenLinearFunction.qbit_argument_conversion" name="qbit_argument_conversion" signature="HiddenLinearFunction.qbit_argument_conversion(qubit_representation)">
  ...
  <Function id="qiskit.circuit.library.HiddenLinearFunction.r" name="r" signature="HiddenLinearFunction.r(theta, phi, qubit, *, q=None)">
    Apply `RGate`.
  </Function>

  ### rcccx

  <Function id="qiskit.circuit.library.HiddenLinearFunction.rcccx" name="rcccx" signature="HiddenLinearFunction.rcccx(control_qubit1, control_qubit2, control_qubit3, target_qubit)">
    Apply [`RC3XGate`](qiskit.circuit.library.RC3XGate "qiskit.circuit.library.RC3XGate").
  </Function>

  ### rccx

  <Function id="qiskit.circuit.library.HiddenLinearFunction.rccx" name="rccx" signature="HiddenLinearFunction.rccx(control_qubit1, control_qubit2, target_qubit)">
    Apply [`RCCXGate`](qiskit.circuit.library.RCCXGate "qiskit.circuit.library.RCCXGate").
  </Function>

  ### remove\_final\_measurements

  <Function id="qiskit.circuit.library.HiddenLinearFunction.remove_final_measurements" name="remove_final_measurements" signature="HiddenLinearFunction.remove_final_measurements(inplace=True)">
  ...
  <Function id="qiskit.circuit.library.HiddenLinearFunction.reset" name="reset" signature="HiddenLinearFunction.reset(qubit)">
    Reset q.
  </Function>

  ### rx

  <Function id="qiskit.circuit.library.HiddenLinearFunction.rx" name="rx" signature="HiddenLinearFunction.rx(theta, qubit, *, label=None, q=None)">
    Apply [`RXGate`](qiskit.circuit.library.RXGate "qiskit.circuit.library.RXGate").
  </Function>

  ### rxx

  <Function id="qiskit.circuit.library.HiddenLinearFunction.rxx" name="rxx" signature="HiddenLinearFunction.rxx(theta, qubit1, qubit2)">
    Apply [`RXXGate`](qiskit.circuit.library.RXXGate "qiskit.circuit.library.RXXGate").
  </Function>

  ### ry

  <Function id="qiskit.circuit.library.HiddenLinearFunction.ry" name="ry" signature="HiddenLinearFunction.ry(theta, qubit, *, label=None, q=None)">
    Apply [`RYGate`](qiskit.circuit.library.RYGate "qiskit.circuit.library.RYGate").
  </Function>

  ### ryy

  <Function id="qiskit.circuit.library.HiddenLinearFunction.ryy" name="ryy" signature="HiddenLinearFunction.ryy(theta, qubit1, qubit2)">
    Apply [`RYYGate`](qiskit.circuit.library.RYYGate "qiskit.circuit.library.RYYGate").
  </Function>

  ### rz

  <Function id="qiskit.circuit.library.HiddenLinearFunction.rz" name="rz" signature="HiddenLinearFunction.rz(phi, qubit, *, q=None)">
    Apply [`RZGate`](qiskit.circuit.library.RZGate "qiskit.circuit.library.RZGate").
  </Function>

  ### rzx

  <Function id="qiskit.circuit.library.HiddenLinearFunction.rzx" name="rzx" signature="HiddenLinearFunction.rzx(theta, qubit1, qubit2)">
    Apply [`RZXGate`](qiskit.circuit.library.RZXGate "qiskit.circuit.library.RZXGate").
  </Function>

  ### rzz

  <Function id="qiskit.circuit.library.HiddenLinearFunction.rzz" name="rzz" signature="HiddenLinearFunction.rzz(theta, qubit1, qubit2)">
    Apply [`RZZGate`](qiskit.circuit.library.RZZGate "qiskit.circuit.library.RZZGate").
  </Function>

  ### s

  <Function id="qiskit.circuit.library.HiddenLinearFunction.s" name="s" signature="HiddenLinearFunction.s(qubit, *, q=None)">
    Apply [`SGate`](qiskit.circuit.library.SGate "qiskit.circuit.library.SGate").
  </Function>

  ### sdg

  <Function id="qiskit.circuit.library.HiddenLinearFunction.sdg" name="sdg" signature="HiddenLinearFunction.sdg(qubit, *, q=None)">
    Apply [`SdgGate`](qiskit.circuit.library.SdgGate "qiskit.circuit.library.SdgGate").
  </Function>

  ### size

  <Function id="qiskit.circuit.library.HiddenLinearFunction.size" name="size" signature="HiddenLinearFunction.size()">
  ...
  <Function id="qiskit.circuit.library.HiddenLinearFunction.snapshot" name="snapshot" signature="HiddenLinearFunction.snapshot(label, snapshot_type='statevector', qubits=None, params=None)">
  ...
  <Function id="qiskit.circuit.library.HiddenLinearFunction.snapshot_density_matrix" name="snapshot_density_matrix" signature="HiddenLinearFunction.snapshot_density_matrix(label, qubits=None)">
  ...
  <Function id="qiskit.circuit.library.HiddenLinearFunction.snapshot_expectation_value" name="snapshot_expectation_value" signature="HiddenLinearFunction.snapshot_expectation_value(label, op, qubits, single_shot=False, variance=False)">
  ...
  <Function id="qiskit.circuit.library.HiddenLinearFunction.snapshot_probabilities" name="snapshot_probabilities" signature="HiddenLinearFunction.snapshot_probabilities(label, qubits, variance=False)">
  ...
  <Function id="qiskit.circuit.library.HiddenLinearFunction.snapshot_stabilizer" name="snapshot_stabilizer" signature="HiddenLinearFunction.snapshot_stabilizer(label)">
  ...
  <Function id="qiskit.circuit.library.HiddenLinearFunction.snapshot_statevector" name="snapshot_statevector" signature="HiddenLinearFunction.snapshot_statevector(label)">
  ...
  <Function id="qiskit.circuit.library.HiddenLinearFunction.squ" name="squ" signature="HiddenLinearFunction.squ(unitary_matrix, qubit, mode='ZYZ', up_to_diagonal=False, *, u=None)">
  ...
  <Function id="qiskit.circuit.library.HiddenLinearFunction.swap" name="swap" signature="HiddenLinearFunction.swap(qubit1, qubit2)">
    Apply [`SwapGate`](qiskit.circuit.library.SwapGate "qiskit.circuit.library.SwapGate").
  </Function>

  ### t

  <Function id="qiskit.circuit.library.HiddenLinearFunction.t" name="t" signature="HiddenLinearFunction.t(qubit, *, q=None)">
    Apply [`TGate`](qiskit.circuit.library.TGate "qiskit.circuit.library.TGate").
  </Function>

  ### tdg

  <Function id="qiskit.circuit.library.HiddenLinearFunction.tdg" name="tdg" signature="HiddenLinearFunction.tdg(qubit, *, q=None)">
    Apply [`TdgGate`](qiskit.circuit.library.TdgGate "qiskit.circuit.library.TdgGate").
  </Function>

  ### to\_gate

  <Function id="qiskit.circuit.library.HiddenLinearFunction.to_gate" name="to_gate" signature="HiddenLinearFunction.to_gate(parameter_map=None)">
  ...
  <Function id="qiskit.circuit.library.HiddenLinearFunction.to_instruction" name="to_instruction" signature="HiddenLinearFunction.to_instruction(parameter_map=None)">
  ...
  <Function id="qiskit.circuit.library.HiddenLinearFunction.toffoli" name="toffoli" signature="HiddenLinearFunction.toffoli(control_qubit1, control_qubit2, target_qubit, *, ctl1=None, ctl2=None, tgt=None)">
    Apply [`CCXGate`](qiskit.circuit.library.CCXGate "qiskit.circuit.library.CCXGate").
  </Function>

  ### u1

  <Function id="qiskit.circuit.library.HiddenLinearFunction.u1" name="u1" signature="HiddenLinearFunction.u1(theta, qubit, *, q=None)">
    Apply [`U1Gate`](qiskit.circuit.library.U1Gate "qiskit.circuit.library.U1Gate").
  </Function>

  ### u2

  <Function id="qiskit.circuit.library.HiddenLinearFunction.u2" name="u2" signature="HiddenLinearFunction.u2(phi, lam, qubit, *, q=None)">
    Apply [`U2Gate`](qiskit.circuit.library.U2Gate "qiskit.circuit.library.U2Gate").
  </Function>

  ### u3

  <Function id="qiskit.circuit.library.HiddenLinearFunction.u3" name="u3" signature="HiddenLinearFunction.u3(theta, phi, lam, qubit, *, q=None)">
    Apply [`U3Gate`](qiskit.circuit.library.U3Gate "qiskit.circuit.library.U3Gate").
  </Function>

  ### uc

  <Function id="qiskit.circuit.library.HiddenLinearFunction.uc" name="uc" signature="HiddenLinearFunction.uc(gate_list, q_controls, q_target, up_to_diagonal=False)">
  ...
  <Function id="qiskit.circuit.library.HiddenLinearFunction.ucg" name="ucg" signature="HiddenLinearFunction.ucg(angle_list, q_controls, q_target, up_to_diagonal=False)">
    Deprecated version of uc.
  </Function>

  ### ucrx

  <Function id="qiskit.circuit.library.HiddenLinearFunction.ucrx" name="ucrx" signature="HiddenLinearFunction.ucrx(angle_list, q_controls, q_target)">
  ...
  <Function id="qiskit.circuit.library.HiddenLinearFunction.ucry" name="ucry" signature="HiddenLinearFunction.ucry(angle_list, q_controls, q_target)">
  ...
  <Function id="qiskit.circuit.library.HiddenLinearFunction.ucrz" name="ucrz" signature="HiddenLinearFunction.ucrz(angle_list, q_controls, q_target)">
  ...
  <Function id="qiskit.circuit.library.HiddenLinearFunction.ucx" name="ucx" signature="HiddenLinearFunction.ucx(angle_list, q_controls, q_target)">
    Deprecated version of ucrx.
  </Function>

  ### ucy

  <Function id="qiskit.circuit.library.HiddenLinearFunction.ucy" name="ucy" signature="HiddenLinearFunction.ucy(angle_list, q_controls, q_target)">
    Deprecated version of ucry.
  </Function>

  ### ucz

  <Function id="qiskit.circuit.library.HiddenLinearFunction.ucz" name="ucz" signature="HiddenLinearFunction.ucz(angle_list, q_controls, q_target)">
    Deprecated version of ucrz.
  </Function>

  ### unitary

  <Function id="qiskit.circuit.library.HiddenLinearFunction.unitary" name="unitary" signature="HiddenLinearFunction.unitary(obj, qubits, label=None)">
    Apply unitary gate to q.
  </Function>

  ### width

  <Function id="qiskit.circuit.library.HiddenLinearFunction.width" name="width" signature="HiddenLinearFunction.width()">
  ...
  <Function id="qiskit.circuit.library.HiddenLinearFunction.x" name="x" signature="HiddenLinearFunction.x(qubit, *, label=None, ctrl_state=None, q=None)">
    Apply [`XGate`](qiskit.circuit.library.XGate "qiskit.circuit.library.XGate").
  </Function>

  ### y

  <Function id="qiskit.circuit.library.HiddenLinearFunction.y" name="y" signature="HiddenLinearFunction.y(qubit, *, q=None)">
    Apply [`YGate`](qiskit.circuit.library.YGate "qiskit.circuit.library.YGate").
  </Function>

  ### z

  <Function id="qiskit.circuit.library.HiddenLinearFunction.z" name="z" signature="HiddenLinearFunction.z(qubit, *, q=None)">
