---
title: HiddenLinearFunction (v0.19)
description: API reference for qiskit.circuit.library.HiddenLinearFunction in qiskit v0.19
...
<Class id="qiskit.circuit.library.HiddenLinearFunction" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.14/qiskit/circuit/library/hidden_linear_function.py" signature="HiddenLinearFunction(adjacency_matrix)" modifiers="class">
...
$$
  ...
  **adjacency\_matrix** (`Union`\[`List`\[`List`\[`int`]], `ndarray`]) – a symmetric n-by-n list of 0-1 lists. n will be the number of qubits.
  ...
  <span id="hiddenlinearfunction-clbits" />
  ...
  <span id="hiddenlinearfunction-data" />
  ...
  <span id="hiddenlinearfunction-extension-lib" />

  ### extension\_lib

  <Attribute id="qiskit.circuit.library.HiddenLinearFunction.extension_lib" attributeValue="'include &#x22;qelib1.inc&#x22;;'" />

  <span id="hiddenlinearfunction-header" />

  ### header

  <Attribute id="qiskit.circuit.library.HiddenLinearFunction.header" attributeValue="'OPENQASM 2.0;'" />

  <span id="hiddenlinearfunction-instances" />

  ### instances

  <Attribute id="qiskit.circuit.library.HiddenLinearFunction.instances" attributeValue="8" />

  <span id="hiddenlinearfunction-n-qubits" />

  ### n\_qubits

  <Attribute id="qiskit.circuit.library.HiddenLinearFunction.n_qubits">
    Deprecated, use `num_qubits` instead. Return number of qubits.
  </Attribute>

  <span id="hiddenlinearfunction-num-clbits" />
  ...
  <span id="hiddenlinearfunction-num-parameters" />
  ...
  <span id="hiddenlinearfunction-num-qubits" />
  ...
  <span id="hiddenlinearfunction-parameters" />
  ...
  <span id="hiddenlinearfunction-and" />

  ### AND

  <Function id="qiskit.circuit.library.HiddenLinearFunction.AND" signature="HiddenLinearFunction.AND(qr_variables, qb_target, qr_ancillae, flags=None, mct_mode='no-ancilla')">
  ...
  <span id="hiddenlinearfunction-or" />

  ### OR

  <Function id="qiskit.circuit.library.HiddenLinearFunction.OR" signature="HiddenLinearFunction.OR(qr_variables, qb_target, qr_ancillae, flags=None, mct_mode='basic')">
  ...
  <span id="hiddenlinearfunction-getitem" />

  ### \_\_getitem\_\_

  <Function id="qiskit.circuit.library.HiddenLinearFunction.__getitem__" signature="HiddenLinearFunction.__getitem__(item)">
    Return indexed operation.
  </Function>

  <span id="hiddenlinearfunction-len" />

  ### \_\_len\_\_

  <Function id="qiskit.circuit.library.HiddenLinearFunction.__len__" signature="HiddenLinearFunction.__len__()">
    Return number of operations in circuit.
  </Function>

  <span id="hiddenlinearfunction-add-register" />

  ### add\_register

  <Function id="qiskit.circuit.library.HiddenLinearFunction.add_register" signature="HiddenLinearFunction.add_register(*regs)">
    Add registers.
  </Function>

  <span id="hiddenlinearfunction-append" />

  ### append

  <Function id="qiskit.circuit.library.HiddenLinearFunction.append" signature="HiddenLinearFunction.append(instruction, qargs=None, cargs=None)">
  ...
  <span id="hiddenlinearfunction-assign-parameters" />

  ### assign\_parameters

  <Function id="qiskit.circuit.library.HiddenLinearFunction.assign_parameters" signature="HiddenLinearFunction.assign_parameters(param_dict, inplace=False)">
  ...
  <span id="hiddenlinearfunction-barrier" />

  ### barrier

  <Function id="qiskit.circuit.library.HiddenLinearFunction.barrier" signature="HiddenLinearFunction.barrier(*qargs)">
    Apply `Barrier`. If qargs is None, applies to all.
  </Function>

  <span id="hiddenlinearfunction-bind-parameters" />

  ### bind\_parameters

  <Function id="qiskit.circuit.library.HiddenLinearFunction.bind_parameters" signature="HiddenLinearFunction.bind_parameters(value_dict)">
  ...
  <span id="hiddenlinearfunction-cast" />

  ### cast

  <Function id="qiskit.circuit.library.HiddenLinearFunction.cast" signature="HiddenLinearFunction.cast(value, _type)" modifiers="static">
    Best effort to cast value to type. Otherwise, returns the value.
  </Function>

  <span id="hiddenlinearfunction-cbit-argument-conversion" />

  ### cbit\_argument\_conversion

  <Function id="qiskit.circuit.library.HiddenLinearFunction.cbit_argument_conversion" signature="HiddenLinearFunction.cbit_argument_conversion(clbit_representation)">
  ...
  <span id="hiddenlinearfunction-ccx" />

  ### ccx

  <Function id="qiskit.circuit.library.HiddenLinearFunction.ccx" signature="HiddenLinearFunction.ccx(control_qubit1, control_qubit2, target_qubit, *, ctl1=None, ctl2=None, tgt=None)">
    Apply [`CCXGate`](qiskit.circuit.library.CCXGate "qiskit.circuit.library.CCXGate").
  </Function>

  <span id="hiddenlinearfunction-ch" />

  ### ch

  <Function id="qiskit.circuit.library.HiddenLinearFunction.ch" signature="HiddenLinearFunction.ch(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CHGate`](qiskit.circuit.library.CHGate "qiskit.circuit.library.CHGate").
  </Function>

  <span id="hiddenlinearfunction-cls-instances" />

  ### cls\_instances

  <Function id="qiskit.circuit.library.HiddenLinearFunction.cls_instances" signature="HiddenLinearFunction.cls_instances()" modifiers="classmethod">
    Return the current number of instances of this class, useful for auto naming.
  </Function>

  <span id="hiddenlinearfunction-cls-prefix" />

  ### cls\_prefix

  <Function id="qiskit.circuit.library.HiddenLinearFunction.cls_prefix" signature="HiddenLinearFunction.cls_prefix()" modifiers="classmethod">
    Return the prefix to use for auto naming.
  </Function>

  <span id="hiddenlinearfunction-cnot" />

  ### cnot

  <Function id="qiskit.circuit.library.HiddenLinearFunction.cnot" signature="HiddenLinearFunction.cnot(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CXGate`](qiskit.circuit.library.CXGate "qiskit.circuit.library.CXGate").
  </Function>

  <span id="hiddenlinearfunction-combine" />

  ### combine

  <Function id="qiskit.circuit.library.HiddenLinearFunction.combine" signature="HiddenLinearFunction.combine(rhs)">
  ...
  <span id="hiddenlinearfunction-compose" />

  ### compose

  <Function id="qiskit.circuit.library.HiddenLinearFunction.compose" signature="HiddenLinearFunction.compose(other, qubits=None, clbits=None, front=False, inplace=False)">
  ...
  <span id="hiddenlinearfunction-copy" />

  ### copy

  <Function id="qiskit.circuit.library.HiddenLinearFunction.copy" signature="HiddenLinearFunction.copy(name=None)">
    Copy the circuit.
  ...
  <span id="hiddenlinearfunction-count-ops" />

  ### count\_ops

  <Function id="qiskit.circuit.library.HiddenLinearFunction.count_ops" signature="HiddenLinearFunction.count_ops()">
  ...
  <span id="hiddenlinearfunction-crx" />

  ### crx

  <Function id="qiskit.circuit.library.HiddenLinearFunction.crx" signature="HiddenLinearFunction.crx(theta, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CRXGate`](qiskit.circuit.library.CRXGate "qiskit.circuit.library.CRXGate").
  </Function>

  <span id="hiddenlinearfunction-cry" />

  ### cry

  <Function id="qiskit.circuit.library.HiddenLinearFunction.cry" signature="HiddenLinearFunction.cry(theta, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CRYGate`](qiskit.circuit.library.CRYGate "qiskit.circuit.library.CRYGate").
  </Function>

  <span id="hiddenlinearfunction-crz" />

  ### crz

  <Function id="qiskit.circuit.library.HiddenLinearFunction.crz" signature="HiddenLinearFunction.crz(theta, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CRZGate`](qiskit.circuit.library.CRZGate "qiskit.circuit.library.CRZGate").
  </Function>

  <span id="hiddenlinearfunction-cswap" />

  ### cswap

  <Function id="qiskit.circuit.library.HiddenLinearFunction.cswap" signature="HiddenLinearFunction.cswap(control_qubit, target_qubit1, target_qubit2, *, label=None, ctrl_state=None, ctl=None, tgt1=None, tgt2=None)">
    Apply [`CSwapGate`](qiskit.circuit.library.CSwapGate "qiskit.circuit.library.CSwapGate").
  </Function>

  <span id="hiddenlinearfunction-cu1" />

  ### cu1

  <Function id="qiskit.circuit.library.HiddenLinearFunction.cu1" signature="HiddenLinearFunction.cu1(theta, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CU1Gate`](qiskit.circuit.library.CU1Gate "qiskit.circuit.library.CU1Gate").
  </Function>

  <span id="hiddenlinearfunction-cu3" />

  ### cu3

  <Function id="qiskit.circuit.library.HiddenLinearFunction.cu3" signature="HiddenLinearFunction.cu3(theta, phi, lam, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CU3Gate`](qiskit.circuit.library.CU3Gate "qiskit.circuit.library.CU3Gate").
  </Function>

  <span id="hiddenlinearfunction-cx" />

  ### cx

  <Function id="qiskit.circuit.library.HiddenLinearFunction.cx" signature="HiddenLinearFunction.cx(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CXGate`](qiskit.circuit.library.CXGate "qiskit.circuit.library.CXGate").
  </Function>

  <span id="hiddenlinearfunction-cy" />

  ### cy

  <Function id="qiskit.circuit.library.HiddenLinearFunction.cy" signature="HiddenLinearFunction.cy(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CYGate`](qiskit.circuit.library.CYGate "qiskit.circuit.library.CYGate").
  </Function>

  <span id="hiddenlinearfunction-cz" />

  ### cz

  <Function id="qiskit.circuit.library.HiddenLinearFunction.cz" signature="HiddenLinearFunction.cz(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CZGate`](qiskit.circuit.library.CZGate "qiskit.circuit.library.CZGate").
  </Function>

  <span id="hiddenlinearfunction-dcx" />

  ### dcx

  <Function id="qiskit.circuit.library.HiddenLinearFunction.dcx" signature="HiddenLinearFunction.dcx(qubit1, qubit2)">
    Apply [`DCXGate`](qiskit.circuit.library.DCXGate "qiskit.circuit.library.DCXGate").
  </Function>

  <span id="hiddenlinearfunction-decompose" />

  ### decompose

  <Function id="qiskit.circuit.library.HiddenLinearFunction.decompose" signature="HiddenLinearFunction.decompose()">
  ...
  <span id="hiddenlinearfunction-depth" />

  ### depth

  <Function id="qiskit.circuit.library.HiddenLinearFunction.depth" signature="HiddenLinearFunction.depth()">
  ...
  <span id="hiddenlinearfunction-diag-gate" />

  ### diag\_gate

  <Function id="qiskit.circuit.library.HiddenLinearFunction.diag_gate" signature="HiddenLinearFunction.diag_gate(diag, qubit)">
    Deprecated version of QuantumCircuit.diagonal.
  </Function>

  <span id="hiddenlinearfunction-diagonal" />

  ### diagonal

  <Function id="qiskit.circuit.library.HiddenLinearFunction.diagonal" signature="HiddenLinearFunction.diagonal(diag, qubit)">
  ...
  <span id="hiddenlinearfunction-extend" />

  ### extend

  <Function id="qiskit.circuit.library.HiddenLinearFunction.extend" signature="HiddenLinearFunction.extend(rhs)">
  ...
  <span id="hiddenlinearfunction-fredkin" />

  ### fredkin

  <Function id="qiskit.circuit.library.HiddenLinearFunction.fredkin" signature="HiddenLinearFunction.fredkin(control_qubit, target_qubit1, target_qubit2, *, ctl=None, tgt1=None, tgt2=None)">
    Apply [`CSwapGate`](qiskit.circuit.library.CSwapGate "qiskit.circuit.library.CSwapGate").
  </Function>

  <span id="hiddenlinearfunction-from-qasm-file" />

  ### from\_qasm\_file

  <Function id="qiskit.circuit.library.HiddenLinearFunction.from_qasm_file" signature="HiddenLinearFunction.from_qasm_file(path)" modifiers="static">
  ...
  <span id="hiddenlinearfunction-from-qasm-str" />

  ### from\_qasm\_str

  <Function id="qiskit.circuit.library.HiddenLinearFunction.from_qasm_str" signature="HiddenLinearFunction.from_qasm_str(qasm_str)" modifiers="static">
  ...
  <span id="hiddenlinearfunction-h" />

  ### h

  <Function id="qiskit.circuit.library.HiddenLinearFunction.h" signature="HiddenLinearFunction.h(qubit, *, q=None)">
    Apply [`HGate`](qiskit.circuit.library.HGate "qiskit.circuit.library.HGate").
  </Function>

  <span id="hiddenlinearfunction-hamiltonian" />

  ### hamiltonian

  <Function id="qiskit.circuit.library.HiddenLinearFunction.hamiltonian" signature="HiddenLinearFunction.hamiltonian(operator, time, qubits, label=None)">
    Apply hamiltonian evolution to to qubits.
  </Function>

  <span id="hiddenlinearfunction-has-register" />

  ### has\_register

  <Function id="qiskit.circuit.library.HiddenLinearFunction.has_register" signature="HiddenLinearFunction.has_register(register)">
  ...
  <span id="hiddenlinearfunction-i" />

  ### i

  <Function id="qiskit.circuit.library.HiddenLinearFunction.i" signature="HiddenLinearFunction.i(qubit, *, q=None)">
    Apply [`IGate`](qiskit.circuit.library.IGate "qiskit.circuit.library.IGate").
  </Function>

  <span id="hiddenlinearfunction-id" />

  ### id

  <Function id="qiskit.circuit.library.HiddenLinearFunction.id" signature="HiddenLinearFunction.id(qubit, *, q=None)">
    Apply [`IGate`](qiskit.circuit.library.IGate "qiskit.circuit.library.IGate").
  </Function>

  <span id="hiddenlinearfunction-iden" />

  ### iden

  <Function id="qiskit.circuit.library.HiddenLinearFunction.iden" signature="HiddenLinearFunction.iden(qubit, *, q=None)">
    Deprecated identity gate.
  </Function>

  <span id="hiddenlinearfunction-initialize" />

  ### initialize

  <Function id="qiskit.circuit.library.HiddenLinearFunction.initialize" signature="HiddenLinearFunction.initialize(params, qubits)">
    Apply initialize to circuit.
  </Function>

  <span id="hiddenlinearfunction-inverse" />

  ### inverse

  <Function id="qiskit.circuit.library.HiddenLinearFunction.inverse" signature="HiddenLinearFunction.inverse()">
    Invert this circuit.
  ...
  <span id="hiddenlinearfunction-iso" />

  ### iso

  <Function id="qiskit.circuit.library.HiddenLinearFunction.iso" signature="HiddenLinearFunction.iso(isometry, q_input, q_ancillas_for_output, q_ancillas_zero=None, q_ancillas_dirty=None)">
  ...
  <span id="hiddenlinearfunction-isometry" />

  ### isometry

  <Function id="qiskit.circuit.library.HiddenLinearFunction.isometry" signature="HiddenLinearFunction.isometry(isometry, q_input, q_ancillas_for_output, q_ancillas_zero=None, q_ancillas_dirty=None)">
    Attach an arbitrary isometry from m to n qubits to a circuit. In particular, this allows to attach arbitrary unitaries on n qubits (m=n) or to prepare any state on n qubits (m=0). The decomposition used here was introduced by Iten et al. in [https://arxiv.org/abs/1501.06911](https://arxiv.org/abs/1501.06911).
  ...
  <span id="hiddenlinearfunction-iswap" />

  ### iswap

  <Function id="qiskit.circuit.library.HiddenLinearFunction.iswap" signature="HiddenLinearFunction.iswap(qubit1, qubit2)">
    Apply [`iSwapGate`](qiskit.circuit.library.iSwapGate "qiskit.circuit.library.iSwapGate").
  </Function>

  <span id="hiddenlinearfunction-mcmt" />

  ### mcmt

  <Function id="qiskit.circuit.library.HiddenLinearFunction.mcmt" signature="HiddenLinearFunction.mcmt(gate, control_qubits, target_qubits, ancilla_qubits=None, mode='no-ancilla', *, single_control_gate_fun=None, q_controls=None, q_ancillae=None, q_targets=None)">
    Apply a multi-control, multi-target using a generic gate.

    This can also be used to implement a generic multi-control gate, as the target could also be of length 1.
  </Function>

  <span id="hiddenlinearfunction-mcrx" />

  ### mcrx

  <Function id="qiskit.circuit.library.HiddenLinearFunction.mcrx" signature="HiddenLinearFunction.mcrx(theta, q_controls, q_target, use_basis_gates=False)">
  ...
  <span id="hiddenlinearfunction-mcry" />

  ### mcry

  <Function id="qiskit.circuit.library.HiddenLinearFunction.mcry" signature="HiddenLinearFunction.mcry(theta, q_controls, q_target, q_ancillae, mode='basic', use_basis_gates=False)">
  ...
  <span id="hiddenlinearfunction-mcrz" />

  ### mcrz

  <Function id="qiskit.circuit.library.HiddenLinearFunction.mcrz" signature="HiddenLinearFunction.mcrz(lam, q_controls, q_target, use_basis_gates=False)">
  ...
  <span id="hiddenlinearfunction-mct" />

  ### mct

  <Function id="qiskit.circuit.library.HiddenLinearFunction.mct" signature="HiddenLinearFunction.mct(control_qubits, target_qubit, ancilla_qubits=None, mode='noancilla')">
    Apply `MCXGate`.
  </Function>

  <span id="hiddenlinearfunction-mcu1" />

  ### mcu1

  <Function id="qiskit.circuit.library.HiddenLinearFunction.mcu1" signature="HiddenLinearFunction.mcu1(lam, control_qubits, target_qubit)">
    Apply `MCU1Gate`.
  </Function>

  <span id="hiddenlinearfunction-mcx" />

  ### mcx

  <Function id="qiskit.circuit.library.HiddenLinearFunction.mcx" signature="HiddenLinearFunction.mcx(control_qubits, target_qubit, ancilla_qubits=None, mode='noancilla')">
    Apply `MCXGate`.
  ...
  <span id="hiddenlinearfunction-measure" />

  ### measure

  <Function id="qiskit.circuit.library.HiddenLinearFunction.measure" signature="HiddenLinearFunction.measure(qubit, cbit)">
  ...
  <span id="hiddenlinearfunction-measure-active" />

  ### measure\_active

  <Function id="qiskit.circuit.library.HiddenLinearFunction.measure_active" signature="HiddenLinearFunction.measure_active(inplace=True)">
  ...
  <span id="hiddenlinearfunction-measure-all" />

  ### measure\_all

  <Function id="qiskit.circuit.library.HiddenLinearFunction.measure_all" signature="HiddenLinearFunction.measure_all(inplace=True)">
  ...
  <span id="hiddenlinearfunction-mirror" />

  ### mirror

  <Function id="qiskit.circuit.library.HiddenLinearFunction.mirror" signature="HiddenLinearFunction.mirror()">
  ...
  <span id="hiddenlinearfunction-ms" />

  ### ms

  <Function id="qiskit.circuit.library.HiddenLinearFunction.ms" signature="HiddenLinearFunction.ms(theta, qubits)">
    Apply [`MSGate`](qiskit.circuit.library.MSGate "qiskit.circuit.library.MSGate").
  </Function>

  <span id="hiddenlinearfunction-num-connected-components" />

  ### num\_connected\_components

  <Function id="qiskit.circuit.library.HiddenLinearFunction.num_connected_components" signature="HiddenLinearFunction.num_connected_components(unitary_only=False)">
  ...
  <span id="hiddenlinearfunction-num-nonlocal-gates" />

  ### num\_nonlocal\_gates

  <Function id="qiskit.circuit.library.HiddenLinearFunction.num_nonlocal_gates" signature="HiddenLinearFunction.num_nonlocal_gates()">
    Return number of non-local gates (i.e. involving 2+ qubits).

    Conditional nonlocal gates are also included.
  </Function>

  <span id="hiddenlinearfunction-num-tensor-factors" />

  ### num\_tensor\_factors

  <Function id="qiskit.circuit.library.HiddenLinearFunction.num_tensor_factors" signature="HiddenLinearFunction.num_tensor_factors()">
  ...
  <span id="hiddenlinearfunction-num-unitary-factors" />

  ### num\_unitary\_factors

  <Function id="qiskit.circuit.library.HiddenLinearFunction.num_unitary_factors" signature="HiddenLinearFunction.num_unitary_factors()">
    Computes the number of tensor factors in the unitary (quantum) part of the circuit only.
  </Function>

  <span id="hiddenlinearfunction-qasm" />

  ### qasm

  <Function id="qiskit.circuit.library.HiddenLinearFunction.qasm" signature="HiddenLinearFunction.qasm(formatted=False, filename=None)">
  ...
  <span id="hiddenlinearfunction-qbit-argument-conversion" />

  ### qbit\_argument\_conversion

  <Function id="qiskit.circuit.library.HiddenLinearFunction.qbit_argument_conversion" signature="HiddenLinearFunction.qbit_argument_conversion(qubit_representation)">
  ...
  <span id="hiddenlinearfunction-r" />

  ### r

  <Function id="qiskit.circuit.library.HiddenLinearFunction.r" signature="HiddenLinearFunction.r(theta, phi, qubit, *, q=None)">
    Apply `RGate`.
  </Function>

  <span id="hiddenlinearfunction-rcccx" />

  ### rcccx

  <Function id="qiskit.circuit.library.HiddenLinearFunction.rcccx" signature="HiddenLinearFunction.rcccx(control_qubit1, control_qubit2, control_qubit3, target_qubit)">
    Apply [`RC3XGate`](qiskit.circuit.library.RC3XGate "qiskit.circuit.library.RC3XGate").
  </Function>

  <span id="hiddenlinearfunction-rccx" />

  ### rccx

  <Function id="qiskit.circuit.library.HiddenLinearFunction.rccx" signature="HiddenLinearFunction.rccx(control_qubit1, control_qubit2, target_qubit)">
    Apply [`RCCXGate`](qiskit.circuit.library.RCCXGate "qiskit.circuit.library.RCCXGate").
  </Function>

  <span id="hiddenlinearfunction-remove-final-measurements" />

  ### remove\_final\_measurements

  <Function id="qiskit.circuit.library.HiddenLinearFunction.remove_final_measurements" signature="HiddenLinearFunction.remove_final_measurements(inplace=True)">
  ...
  <span id="hiddenlinearfunction-reset" />

  ### reset

  <Function id="qiskit.circuit.library.HiddenLinearFunction.reset" signature="HiddenLinearFunction.reset(qubit)">
    Reset q.
  </Function>

  <span id="hiddenlinearfunction-rx" />

  ### rx

  <Function id="qiskit.circuit.library.HiddenLinearFunction.rx" signature="HiddenLinearFunction.rx(theta, qubit, *, label=None, q=None)">
    Apply [`RXGate`](qiskit.circuit.library.RXGate "qiskit.circuit.library.RXGate").
  </Function>

  <span id="hiddenlinearfunction-rxx" />

  ### rxx

  <Function id="qiskit.circuit.library.HiddenLinearFunction.rxx" signature="HiddenLinearFunction.rxx(theta, qubit1, qubit2)">
    Apply [`RXXGate`](qiskit.circuit.library.RXXGate "qiskit.circuit.library.RXXGate").
  </Function>

  <span id="hiddenlinearfunction-ry" />

  ### ry

  <Function id="qiskit.circuit.library.HiddenLinearFunction.ry" signature="HiddenLinearFunction.ry(theta, qubit, *, label=None, q=None)">
    Apply [`RYGate`](qiskit.circuit.library.RYGate "qiskit.circuit.library.RYGate").
  </Function>

  <span id="hiddenlinearfunction-ryy" />

  ### ryy

  <Function id="qiskit.circuit.library.HiddenLinearFunction.ryy" signature="HiddenLinearFunction.ryy(theta, qubit1, qubit2)">
    Apply [`RYYGate`](qiskit.circuit.library.RYYGate "qiskit.circuit.library.RYYGate").
  </Function>

  <span id="hiddenlinearfunction-rz" />

  ### rz

  <Function id="qiskit.circuit.library.HiddenLinearFunction.rz" signature="HiddenLinearFunction.rz(phi, qubit, *, q=None)">
    Apply [`RZGate`](qiskit.circuit.library.RZGate "qiskit.circuit.library.RZGate").
  </Function>

  <span id="hiddenlinearfunction-rzx" />

  ### rzx

  <Function id="qiskit.circuit.library.HiddenLinearFunction.rzx" signature="HiddenLinearFunction.rzx(theta, qubit1, qubit2)">
    Apply [`RZXGate`](qiskit.circuit.library.RZXGate "qiskit.circuit.library.RZXGate").
  </Function>

  <span id="hiddenlinearfunction-rzz" />

  ### rzz

  <Function id="qiskit.circuit.library.HiddenLinearFunction.rzz" signature="HiddenLinearFunction.rzz(theta, qubit1, qubit2)">
    Apply [`RZZGate`](qiskit.circuit.library.RZZGate "qiskit.circuit.library.RZZGate").
  </Function>

  <span id="hiddenlinearfunction-s" />

  ### s

  <Function id="qiskit.circuit.library.HiddenLinearFunction.s" signature="HiddenLinearFunction.s(qubit, *, q=None)">
    Apply [`SGate`](qiskit.circuit.library.SGate "qiskit.circuit.library.SGate").
  </Function>

  <span id="hiddenlinearfunction-sdg" />

  ### sdg

  <Function id="qiskit.circuit.library.HiddenLinearFunction.sdg" signature="HiddenLinearFunction.sdg(qubit, *, q=None)">
    Apply [`SdgGate`](qiskit.circuit.library.SdgGate "qiskit.circuit.library.SdgGate").
  </Function>

  <span id="hiddenlinearfunction-size" />

  ### size

  <Function id="qiskit.circuit.library.HiddenLinearFunction.size" signature="HiddenLinearFunction.size()">
  ...
  <span id="hiddenlinearfunction-snapshot" />

  ### snapshot

  <Function id="qiskit.circuit.library.HiddenLinearFunction.snapshot" signature="HiddenLinearFunction.snapshot(label, snapshot_type='statevector', qubits=None, params=None)">
  ...
  <span id="hiddenlinearfunction-snapshot-density-matrix" />

  ### snapshot\_density\_matrix

  <Function id="qiskit.circuit.library.HiddenLinearFunction.snapshot_density_matrix" signature="HiddenLinearFunction.snapshot_density_matrix(label, qubits=None)">
  ...
  <span id="hiddenlinearfunction-snapshot-expectation-value" />

  ### snapshot\_expectation\_value

  <Function id="qiskit.circuit.library.HiddenLinearFunction.snapshot_expectation_value" signature="HiddenLinearFunction.snapshot_expectation_value(label, op, qubits, single_shot=False, variance=False)">
  ...
  <span id="hiddenlinearfunction-snapshot-probabilities" />

  ### snapshot\_probabilities

  <Function id="qiskit.circuit.library.HiddenLinearFunction.snapshot_probabilities" signature="HiddenLinearFunction.snapshot_probabilities(label, qubits, variance=False)">
  ...
  <span id="hiddenlinearfunction-snapshot-stabilizer" />

  ### snapshot\_stabilizer

  <Function id="qiskit.circuit.library.HiddenLinearFunction.snapshot_stabilizer" signature="HiddenLinearFunction.snapshot_stabilizer(label)">
  ...
  <span id="hiddenlinearfunction-snapshot-statevector" />

  ### snapshot\_statevector

  <Function id="qiskit.circuit.library.HiddenLinearFunction.snapshot_statevector" signature="HiddenLinearFunction.snapshot_statevector(label)">
  ...
  <span id="hiddenlinearfunction-squ" />

  ### squ

  <Function id="qiskit.circuit.library.HiddenLinearFunction.squ" signature="HiddenLinearFunction.squ(unitary_matrix, qubit, mode='ZYZ', up_to_diagonal=False, *, u=None)">
  ...
  <span id="hiddenlinearfunction-swap" />

  ### swap

  <Function id="qiskit.circuit.library.HiddenLinearFunction.swap" signature="HiddenLinearFunction.swap(qubit1, qubit2)">
    Apply [`SwapGate`](qiskit.circuit.library.SwapGate "qiskit.circuit.library.SwapGate").
  </Function>

  <span id="hiddenlinearfunction-t" />

  ### t

  <Function id="qiskit.circuit.library.HiddenLinearFunction.t" signature="HiddenLinearFunction.t(qubit, *, q=None)">
    Apply [`TGate`](qiskit.circuit.library.TGate "qiskit.circuit.library.TGate").
  </Function>

  <span id="hiddenlinearfunction-tdg" />

  ### tdg

  <Function id="qiskit.circuit.library.HiddenLinearFunction.tdg" signature="HiddenLinearFunction.tdg(qubit, *, q=None)">
    Apply [`TdgGate`](qiskit.circuit.library.TdgGate "qiskit.circuit.library.TdgGate").
  </Function>

  <span id="hiddenlinearfunction-to-gate" />

  ### to\_gate

  <Function id="qiskit.circuit.library.HiddenLinearFunction.to_gate" signature="HiddenLinearFunction.to_gate(parameter_map=None)">
  ...
  <span id="hiddenlinearfunction-to-instruction" />

  ### to\_instruction

  <Function id="qiskit.circuit.library.HiddenLinearFunction.to_instruction" signature="HiddenLinearFunction.to_instruction(parameter_map=None)">
  ...
  <span id="hiddenlinearfunction-toffoli" />

  ### toffoli

  <Function id="qiskit.circuit.library.HiddenLinearFunction.toffoli" signature="HiddenLinearFunction.toffoli(control_qubit1, control_qubit2, target_qubit, *, ctl1=None, ctl2=None, tgt=None)">
    Apply [`CCXGate`](qiskit.circuit.library.CCXGate "qiskit.circuit.library.CCXGate").
  </Function>

  <span id="hiddenlinearfunction-u1" />

  ### u1

  <Function id="qiskit.circuit.library.HiddenLinearFunction.u1" signature="HiddenLinearFunction.u1(theta, qubit, *, q=None)">
    Apply [`U1Gate`](qiskit.circuit.library.U1Gate "qiskit.circuit.library.U1Gate").
  </Function>

  <span id="hiddenlinearfunction-u2" />

  ### u2

  <Function id="qiskit.circuit.library.HiddenLinearFunction.u2" signature="HiddenLinearFunction.u2(phi, lam, qubit, *, q=None)">
    Apply [`U2Gate`](qiskit.circuit.library.U2Gate "qiskit.circuit.library.U2Gate").
  </Function>

  <span id="hiddenlinearfunction-u3" />

  ### u3

  <Function id="qiskit.circuit.library.HiddenLinearFunction.u3" signature="HiddenLinearFunction.u3(theta, phi, lam, qubit, *, q=None)">
    Apply [`U3Gate`](qiskit.circuit.library.U3Gate "qiskit.circuit.library.U3Gate").
  </Function>

  <span id="hiddenlinearfunction-uc" />

  ### uc

  <Function id="qiskit.circuit.library.HiddenLinearFunction.uc" signature="HiddenLinearFunction.uc(gate_list, q_controls, q_target, up_to_diagonal=False)">
  ...
  <span id="hiddenlinearfunction-ucg" />

  ### ucg

  <Function id="qiskit.circuit.library.HiddenLinearFunction.ucg" signature="HiddenLinearFunction.ucg(angle_list, q_controls, q_target, up_to_diagonal=False)">
    Deprecated version of uc.
  </Function>

  <span id="hiddenlinearfunction-ucrx" />

  ### ucrx

  <Function id="qiskit.circuit.library.HiddenLinearFunction.ucrx" signature="HiddenLinearFunction.ucrx(angle_list, q_controls, q_target)">
  ...
  <span id="hiddenlinearfunction-ucry" />

  ### ucry

  <Function id="qiskit.circuit.library.HiddenLinearFunction.ucry" signature="HiddenLinearFunction.ucry(angle_list, q_controls, q_target)">
  ...
  <span id="hiddenlinearfunction-ucrz" />

  ### ucrz

  <Function id="qiskit.circuit.library.HiddenLinearFunction.ucrz" signature="HiddenLinearFunction.ucrz(angle_list, q_controls, q_target)">
  ...
  <span id="hiddenlinearfunction-ucx" />

  ### ucx

  <Function id="qiskit.circuit.library.HiddenLinearFunction.ucx" signature="HiddenLinearFunction.ucx(angle_list, q_controls, q_target)">
    Deprecated version of ucrx.
  </Function>

  <span id="hiddenlinearfunction-ucy" />

  ### ucy

  <Function id="qiskit.circuit.library.HiddenLinearFunction.ucy" signature="HiddenLinearFunction.ucy(angle_list, q_controls, q_target)">
    Deprecated version of ucry.
  </Function>

  <span id="hiddenlinearfunction-ucz" />

  ### ucz

  <Function id="qiskit.circuit.library.HiddenLinearFunction.ucz" signature="HiddenLinearFunction.ucz(angle_list, q_controls, q_target)">
    Deprecated version of ucrz.
  </Function>

  <span id="hiddenlinearfunction-unitary" />

  ### unitary

  <Function id="qiskit.circuit.library.HiddenLinearFunction.unitary" signature="HiddenLinearFunction.unitary(obj, qubits, label=None)">
    Apply unitary gate to q.
  </Function>

  <span id="hiddenlinearfunction-width" />

  ### width

  <Function id="qiskit.circuit.library.HiddenLinearFunction.width" signature="HiddenLinearFunction.width()">
  ...
  <span id="hiddenlinearfunction-x" />

  ### x

  <Function id="qiskit.circuit.library.HiddenLinearFunction.x" signature="HiddenLinearFunction.x(qubit, *, label=None, ctrl_state=None, q=None)">
    Apply [`XGate`](qiskit.circuit.library.XGate "qiskit.circuit.library.XGate").
  </Function>

  <span id="hiddenlinearfunction-y" />

  ### y

  <Function id="qiskit.circuit.library.HiddenLinearFunction.y" signature="HiddenLinearFunction.y(qubit, *, q=None)">
    Apply [`YGate`](qiskit.circuit.library.YGate "qiskit.circuit.library.YGate").
  </Function>

  <span id="hiddenlinearfunction-z" />

  ### z

  <Function id="qiskit.circuit.library.HiddenLinearFunction.z" signature="HiddenLinearFunction.z(qubit, *, q=None)">
