...
$$
  ...
  **adjacency\_matrix** (`Union`\[`List`\[`List`\[`int`]], `ndarray`]) – a symmetric n-by-n list of 0-1 lists. n will be the number of qubits.
  ...
  <Function id="qiskit.circuit.library.HiddenLinearFunction.cast" signature="static HiddenLinearFunction.cast(value, _type)">
  ...
  <Function id="qiskit.circuit.library.HiddenLinearFunction.cls_instances" signature="classmethod HiddenLinearFunction.cls_instances()">
    Return the current number of instances of this class, useful for auto naming.
  </Function>

  ### cls\_prefix

  <Function id="qiskit.circuit.library.HiddenLinearFunction.cls_prefix" signature="classmethod HiddenLinearFunction.cls_prefix()">
  ...
  <Function id="qiskit.circuit.library.HiddenLinearFunction.from_qasm_file" signature="static HiddenLinearFunction.from_qasm_file(path)">
  ...
  <Function id="qiskit.circuit.library.HiddenLinearFunction.from_qasm_str" signature="static HiddenLinearFunction.from_qasm_str(qasm_str)">
