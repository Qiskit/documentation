---
title: UniformDistribution (v0.19)
description: API reference for qiskit.aqua.components.uncertainty_models.UniformDistribution in qiskit v0.19
...
<Class id="qiskit.aqua.components.uncertainty_models.UniformDistribution" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.7/qiskit/aqua/components/uncertainty_models/uniform_distribution.py" signature="UniformDistribution(num_target_qubits, low=0, high=1)" modifiers="class">
  ...
  *   **high** (`float`) – Upper bound, i.e., the value corresponding to |1…1> (assuming an equidistant grid)
  ...
  <span id="uniformdistribution-high" />
  ...
  <span id="uniformdistribution-low" />
  ...
  <span id="uniformdistribution-num-target-qubits" />
  ...
  <span id="uniformdistribution-num-values" />
  ...
  <span id="uniformdistribution-probabilities" />
  ...
  <span id="uniformdistribution-values" />
  ...
  <span id="uniformdistribution-build" />
  ...
  <span id="uniformdistribution-build-controlled" />
  ...
  <span id="uniformdistribution-build-controlled-inverse" />
  ...
  <span id="uniformdistribution-build-controlled-inverse-power" />
  ...
  <span id="uniformdistribution-build-controlled-power" />
  ...
  <span id="uniformdistribution-build-inverse" />
  ...
  <span id="uniformdistribution-build-inverse-power" />
  ...
  <span id="uniformdistribution-build-power" />
  ...
  <span id="uniformdistribution-get-num-qubits" />
  ...
  <span id="uniformdistribution-get-num-qubits-controlled" />
  ...
  <span id="uniformdistribution-pdf-to-probabilities" />
  ...
  <span id="uniformdistribution-required-ancillas" />
  ...
  <span id="uniformdistribution-required-ancillas-controlled" />
