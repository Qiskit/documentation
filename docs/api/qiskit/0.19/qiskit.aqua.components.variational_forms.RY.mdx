...
<Class id="qiskit.aqua.components.variational_forms.RY" github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.7/qiskit/aqua/components/variational_forms/ry.py" signature="RY(num_qubits, depth=3, entangler_map=None, entanglement='full', initial_state=None, entanglement_gate='cz', skip_unentangled_qubits=False, skip_final_ry=False)">
  ...
  *   **skip\_final\_ry** (`bool`) – Skip the final layer of Y rotations
  ...
  <Function id="qiskit.aqua.components.variational_forms.RY.get_entangler_map" signature="static RY.get_entangler_map(map_type, num_qubits, offset=0)">
    returns entangler map
  </Function>

  ### validate\_entangler\_map

  <Function id="qiskit.aqua.components.variational_forms.RY.validate_entangler_map" signature="static RY.validate_entangler_map(entangler_map, num_qubits)">
