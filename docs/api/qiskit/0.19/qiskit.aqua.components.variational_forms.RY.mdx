...
<Class id="qiskit.aqua.components.variational_forms.RY" github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.7/qiskit/aqua/components/variational_forms/ry.py" signature="RY(num_qubits, depth=3, entangler_map=None, entanglement='full', initial_state=None, entanglement_gate='cz', skip_unentangled_qubits=False, skip_final_ry=False)">
  ...
  *   **skip\_final\_ry** (`bool`) – Skip the final layer of Y rotations
  ...
  <Attribute id="qiskit.aqua.components.variational_forms.RY.num_parameters" name="num_parameters">
  ...
  <Attribute id="qiskit.aqua.components.variational_forms.RY.num_qubits" name="num_qubits">
  ...
  <Attribute id="qiskit.aqua.components.variational_forms.RY.parameter_bounds" name="parameter_bounds">
    Parameter bounds.
  ...
  <Attribute id="qiskit.aqua.components.variational_forms.RY.preferred_init_points" name="preferred_init_points">
  ...
  <Attribute id="qiskit.aqua.components.variational_forms.RY.setting" name="setting" />

  ### support\_parameterized\_circuit

  <Attribute id="qiskit.aqua.components.variational_forms.RY.support_parameterized_circuit" name="support_parameterized_circuit">
  ...
  <Function id="qiskit.aqua.components.variational_forms.RY.construct_circuit" name="construct_circuit" signature="RY.construct_circuit(parameters, q=None)">
  ...
  <Function id="qiskit.aqua.components.variational_forms.RY.get_entangler_map" name="get_entangler_map" signature="static RY.get_entangler_map(map_type, num_qubits, offset=0)">
    returns entangler map
  </Function>

  ### validate\_entangler\_map

  <Function id="qiskit.aqua.components.variational_forms.RY.validate_entangler_map" name="validate_entangler_map" signature="static RY.validate_entangler_map(entangler_map, num_qubits)">
