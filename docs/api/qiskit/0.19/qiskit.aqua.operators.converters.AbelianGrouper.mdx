...
<Class id="qiskit.aqua.operators.converters.AbelianGrouper" github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.7/qiskit/aqua/operators/converters/abelian_grouper.py" signature="AbelianGrouper(traverse=True)">
