...
`GraphState(adjacency_matrix)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.14/qiskit/circuit/library/graph_state.py "view source code")
...
<span id="qiskit.circuit.library.GraphState.AND" />

`GraphState.AND(qr_variables, qb_target, qr_ancillae, flags=None, mct_mode='no-ancilla')`
...
<span id="qiskit.circuit.library.GraphState.OR" />

`GraphState.OR(qr_variables, qb_target, qr_ancillae, flags=None, mct_mode='basic')`
...
`GraphState.append(instruction, qargs=None, cargs=None)`
...
`GraphState.assign_parameters(param_dict, inplace=False)`
...
`GraphState.cbit_argument_conversion(clbit_representation)`
...
`GraphState.ccx(control_qubit1, control_qubit2, target_qubit, *, ctl1=None, ctl2=None, tgt=None)`
...
`GraphState.ch(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)`
...
`GraphState.cnot(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)`
...
`GraphState.compose(other, qubits=None, clbits=None, front=False, inplace=False)`
...
`GraphState.crx(theta, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)`
...
`GraphState.cry(theta, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)`
...
`GraphState.crz(theta, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)`
...
`GraphState.cswap(control_qubit, target_qubit1, target_qubit2, *, label=None, ctrl_state=None, ctl=None, tgt1=None, tgt2=None)`
...
`GraphState.cu1(theta, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)`
...
`GraphState.cu3(theta, phi, lam, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)`
...
`GraphState.cx(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)`
...
`GraphState.cy(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)`
...
`GraphState.cz(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)`
...
`GraphState.draw(output=None, scale=0.7, filename=None, style=None, interactive=False, line_length=None, plot_barriers=True, reverse_bits=False, justify=None, vertical_compression='medium', idle_wires=True, with_layout=True, fold=None, ax=None, initial_state=False, cregbundle=False)`
...
`GraphState.fredkin(control_qubit, target_qubit1, target_qubit2, *, ctl=None, tgt1=None, tgt2=None)`
...
`static GraphState.from_qasm_file(path)`
...
`static GraphState.from_qasm_str(qasm_str)`
...
`GraphState.hamiltonian(operator, time, qubits, label=None)`
...
`GraphState.iso(isometry, q_input, q_ancillas_for_output, q_ancillas_zero=None, q_ancillas_dirty=None)`
...
`GraphState.isometry(isometry, q_input, q_ancillas_for_output, q_ancillas_zero=None, q_ancillas_dirty=None)`
...
`GraphState.mcmt(gate, control_qubits, target_qubits, ancilla_qubits=None, mode='no-ancilla', *, single_control_gate_fun=None, q_controls=None, q_ancillae=None, q_targets=None)`
...
`GraphState.mcry(theta, q_controls, q_target, q_ancillae, mode='basic', use_basis_gates=False)`
...
`GraphState.mcrz(lam, q_controls, q_target, use_basis_gates=False)`
...
`GraphState.mcx(control_qubits, target_qubit, ancilla_qubits=None, mode='noancilla')`
...
`GraphState.measure_active(inplace=True)`
...
`GraphState.measure_all(inplace=True)`
...
`GraphState.num_connected_components(unitary_only=False)`
...
`GraphState.qasm(formatted=False, filename=None)`
...
`GraphState.qbit_argument_conversion(qubit_representation)`
...
`GraphState.rcccx(control_qubit1, control_qubit2, control_qubit3, target_qubit)`
...
`GraphState.rccx(control_qubit1, control_qubit2, target_qubit)`
...
`GraphState.remove_final_measurements(inplace=True)`
...
`GraphState.rx(theta, qubit, *, label=None, q=None)`
...
`GraphState.rz(phi, qubit, *, q=None)`
...
`GraphState.snapshot(label, snapshot_type='statevector', qubits=None, params=None)`
...
`GraphState.snapshot_density_matrix(label, qubits=None)`
...
`GraphState.snapshot_expectation_value(label, op, qubits, single_shot=False, variance=False)`
...
`GraphState.snapshot_probabilities(label, qubits, variance=False)`
...
`GraphState.squ(unitary_matrix, qubit, mode='ZYZ', up_to_diagonal=False, *, u=None)`
...
`GraphState.to_gate(parameter_map=None)`
...
`GraphState.to_instruction(parameter_map=None)`
...
`GraphState.toffoli(control_qubit1, control_qubit2, target_qubit, *, ctl1=None, ctl2=None, tgt=None)`
...
`GraphState.u2(phi, lam, qubit, *, q=None)`
...
`GraphState.u3(theta, phi, lam, qubit, *, q=None)`
...
`GraphState.uc(gate_list, q_controls, q_target, up_to_diagonal=False)`
...
<span id="qiskit.circuit.library.GraphState.ucz" />
...
`GraphState.x(qubit, *, label=None, ctrl_state=None, q=None)`
