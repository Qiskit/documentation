...
<Class id="qiskit.circuit.library.OR" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.14/qiskit/circuit/library/boolean_logic/quantum_or.py" signature="OR(num_variable_qubits, flags=None, mcx_mode='noancilla')">
  ...
  *   **mcx\_mode** (`str`) – The mode to be used to implement the multi-controlled X gate.
  ...
  <Function id="qiskit.circuit.library.OR.cast" signature="static OR.cast(value, _type)">
  ...
  <Function id="qiskit.circuit.library.OR.cls_instances" signature="classmethod OR.cls_instances()">
    Return the current number of instances of this class, useful for auto naming.
  </Function>

  ### cls\_prefix

  <Function id="qiskit.circuit.library.OR.cls_prefix" signature="classmethod OR.cls_prefix()">
  ...
  <Function id="qiskit.circuit.library.OR.from_qasm_file" signature="static OR.from_qasm_file(path)">
  ...
  <Function id="qiskit.circuit.library.OR.from_qasm_str" signature="static OR.from_qasm_str(qasm_str)">
