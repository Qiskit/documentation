...
<Class id="qiskit.circuit.library.OR" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.14/qiskit/circuit/library/boolean_logic/quantum_or.py" signature="OR(num_variable_qubits, flags=None, mcx_mode='noancilla')">
  ...
  *   **mcx\_mode** (`str`) – The mode to be used to implement the multi-controlled X gate.
  ...
  <Attribute id="qiskit.circuit.library.OR.clbits" name="clbits">
    Returns a list of classical bits in the order that the registers were added.
  </Attribute>

  ### data

  <Attribute id="qiskit.circuit.library.OR.data" name="data">
  ...
  <Attribute id="qiskit.circuit.library.OR.extension_lib" signature="= 'include \&#x22;qelib1.inc\&#x22;;'" />

  ### header

  <Attribute id="qiskit.circuit.library.OR.header" signature="= 'OPENQASM 2.0;'" />

  ### instances

  <Attribute id="qiskit.circuit.library.OR.instances" signature="= 8" />

  ### n\_qubits

  <Attribute id="qiskit.circuit.library.OR.n_qubits" name="n_qubits">
    Deprecated, use `num_qubits` instead. Return number of qubits.
  </Attribute>

  ### num\_clbits

  <Attribute id="qiskit.circuit.library.OR.num_clbits" name="num_clbits">
    Return number of classical bits.
  </Attribute>

  ### num\_parameters

  <Attribute id="qiskit.circuit.library.OR.num_parameters" name="num_parameters">
    Convenience function to get the number of parameter objects in the circuit.
  </Attribute>

  ### num\_qubits

  <Attribute id="qiskit.circuit.library.OR.num_qubits" name="num_qubits">
    Return number of qubits.
  </Attribute>

  ### parameters

  <Attribute id="qiskit.circuit.library.OR.parameters" name="parameters">
    Convenience function to get the parameters defined in the parameter table.
  </Attribute>

  ### prefix

  <Attribute id="qiskit.circuit.library.OR.prefix" signature="= 'circuit'" />

  ### qubits

  <Attribute id="qiskit.circuit.library.OR.qubits" name="qubits">
  ...
  <Function id="qiskit.circuit.library.OR.AND" name="AND" signature="OR.AND(qr_variables, qb_target, qr_ancillae, flags=None, mct_mode='no-ancilla')">
  ...
  <Function id="qiskit.circuit.library.OR.OR" name="OR" signature="OR.OR(qr_variables, qb_target, qr_ancillae, flags=None, mct_mode='basic')">
  ...
  <Function id="qiskit.circuit.library.OR.__getitem__" name="__getitem__" signature="OR.__getitem__(item)">
    Return indexed operation.
  </Function>

  ### \_\_len\_\_

  <Function id="qiskit.circuit.library.OR.__len__" name="__len__" signature="OR.__len__()">
    Return number of operations in circuit.
  </Function>

  ### add\_register

  <Function id="qiskit.circuit.library.OR.add_register" name="add_register" signature="OR.add_register(*regs)">
    Add registers.
  </Function>

  ### append

  <Function id="qiskit.circuit.library.OR.append" name="append" signature="OR.append(instruction, qargs=None, cargs=None)">
  ...
  <Function id="qiskit.circuit.library.OR.assign_parameters" name="assign_parameters" signature="OR.assign_parameters(param_dict, inplace=False)">
  ...
  <Function id="qiskit.circuit.library.OR.barrier" name="barrier" signature="OR.barrier(*qargs)">
    Apply `Barrier`. If qargs is None, applies to all.
  </Function>

  ### bind\_parameters

  <Function id="qiskit.circuit.library.OR.bind_parameters" name="bind_parameters" signature="OR.bind_parameters(value_dict)">
  ...
  <Function id="qiskit.circuit.library.OR.cast" name="cast" signature="static OR.cast(value, _type)">
    Best effort to cast value to type. Otherwise, returns the value.
  </Function>

  ### cbit\_argument\_conversion

  <Function id="qiskit.circuit.library.OR.cbit_argument_conversion" name="cbit_argument_conversion" signature="OR.cbit_argument_conversion(clbit_representation)">
  ...
  <Function id="qiskit.circuit.library.OR.ccx" name="ccx" signature="OR.ccx(control_qubit1, control_qubit2, target_qubit, *, ctl1=None, ctl2=None, tgt=None)">
    Apply [`CCXGate`](qiskit.circuit.library.CCXGate "qiskit.circuit.library.CCXGate").
  </Function>

  ### ch

  <Function id="qiskit.circuit.library.OR.ch" name="ch" signature="OR.ch(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CHGate`](qiskit.circuit.library.CHGate "qiskit.circuit.library.CHGate").
  </Function>

  ### cls\_instances

  <Function id="qiskit.circuit.library.OR.cls_instances" name="cls_instances" signature="classmethod OR.cls_instances()">
    Return the current number of instances of this class, useful for auto naming.
  </Function>

  ### cls\_prefix

  <Function id="qiskit.circuit.library.OR.cls_prefix" name="cls_prefix" signature="classmethod OR.cls_prefix()">
    Return the prefix to use for auto naming.
  </Function>

  ### cnot

  <Function id="qiskit.circuit.library.OR.cnot" name="cnot" signature="OR.cnot(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CXGate`](qiskit.circuit.library.CXGate "qiskit.circuit.library.CXGate").
  </Function>

  ### combine

  <Function id="qiskit.circuit.library.OR.combine" name="combine" signature="OR.combine(rhs)">
  ...
  <Function id="qiskit.circuit.library.OR.compose" name="compose" signature="OR.compose(other, qubits=None, clbits=None, front=False, inplace=False)">
  ...
  <Function id="qiskit.circuit.library.OR.copy" name="copy" signature="OR.copy(name=None)">
    Copy the circuit.
  ...
  <Function id="qiskit.circuit.library.OR.count_ops" name="count_ops" signature="OR.count_ops()">
  ...
  <Function id="qiskit.circuit.library.OR.crx" name="crx" signature="OR.crx(theta, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CRXGate`](qiskit.circuit.library.CRXGate "qiskit.circuit.library.CRXGate").
  </Function>

  ### cry

  <Function id="qiskit.circuit.library.OR.cry" name="cry" signature="OR.cry(theta, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CRYGate`](qiskit.circuit.library.CRYGate "qiskit.circuit.library.CRYGate").
  </Function>

  ### crz

  <Function id="qiskit.circuit.library.OR.crz" name="crz" signature="OR.crz(theta, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CRZGate`](qiskit.circuit.library.CRZGate "qiskit.circuit.library.CRZGate").
  </Function>

  ### cswap

  <Function id="qiskit.circuit.library.OR.cswap" name="cswap" signature="OR.cswap(control_qubit, target_qubit1, target_qubit2, *, label=None, ctrl_state=None, ctl=None, tgt1=None, tgt2=None)">
    Apply [`CSwapGate`](qiskit.circuit.library.CSwapGate "qiskit.circuit.library.CSwapGate").
  </Function>

  ### cu1

  <Function id="qiskit.circuit.library.OR.cu1" name="cu1" signature="OR.cu1(theta, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CU1Gate`](qiskit.circuit.library.CU1Gate "qiskit.circuit.library.CU1Gate").
  </Function>

  ### cu3

  <Function id="qiskit.circuit.library.OR.cu3" name="cu3" signature="OR.cu3(theta, phi, lam, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CU3Gate`](qiskit.circuit.library.CU3Gate "qiskit.circuit.library.CU3Gate").
  </Function>

  ### cx

  <Function id="qiskit.circuit.library.OR.cx" name="cx" signature="OR.cx(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CXGate`](qiskit.circuit.library.CXGate "qiskit.circuit.library.CXGate").
  </Function>

  ### cy

  <Function id="qiskit.circuit.library.OR.cy" name="cy" signature="OR.cy(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CYGate`](qiskit.circuit.library.CYGate "qiskit.circuit.library.CYGate").
  </Function>

  ### cz

  <Function id="qiskit.circuit.library.OR.cz" name="cz" signature="OR.cz(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CZGate`](qiskit.circuit.library.CZGate "qiskit.circuit.library.CZGate").
  </Function>

  ### dcx

  <Function id="qiskit.circuit.library.OR.dcx" name="dcx" signature="OR.dcx(qubit1, qubit2)">
    Apply [`DCXGate`](qiskit.circuit.library.DCXGate "qiskit.circuit.library.DCXGate").
  </Function>

  ### decompose

  <Function id="qiskit.circuit.library.OR.decompose" name="decompose" signature="OR.decompose()">
  ...
  <Function id="qiskit.circuit.library.OR.depth" name="depth" signature="OR.depth()">
  ...
  <Function id="qiskit.circuit.library.OR.diag_gate" name="diag_gate" signature="OR.diag_gate(diag, qubit)">
    Deprecated version of QuantumCircuit.diagonal.
  </Function>

  ### diagonal

  <Function id="qiskit.circuit.library.OR.diagonal" name="diagonal" signature="OR.diagonal(diag, qubit)">
  ...
  <Function id="qiskit.circuit.library.OR.extend" name="extend" signature="OR.extend(rhs)">
  ...
  <Function id="qiskit.circuit.library.OR.fredkin" name="fredkin" signature="OR.fredkin(control_qubit, target_qubit1, target_qubit2, *, ctl=None, tgt1=None, tgt2=None)">
    Apply [`CSwapGate`](qiskit.circuit.library.CSwapGate "qiskit.circuit.library.CSwapGate").
  </Function>

  ### from\_qasm\_file

  <Function id="qiskit.circuit.library.OR.from_qasm_file" name="from_qasm_file" signature="static OR.from_qasm_file(path)">
  ...
  <Function id="qiskit.circuit.library.OR.from_qasm_str" name="from_qasm_str" signature="static OR.from_qasm_str(qasm_str)">
  ...
  <Function id="qiskit.circuit.library.OR.h" name="h" signature="OR.h(qubit, *, q=None)">
    Apply [`HGate`](qiskit.circuit.library.HGate "qiskit.circuit.library.HGate").
  </Function>

  ### hamiltonian

  <Function id="qiskit.circuit.library.OR.hamiltonian" name="hamiltonian" signature="OR.hamiltonian(operator, time, qubits, label=None)">
    Apply hamiltonian evolution to to qubits.
  </Function>

  ### has\_register

  <Function id="qiskit.circuit.library.OR.has_register" name="has_register" signature="OR.has_register(register)">
  ...
  <Function id="qiskit.circuit.library.OR.i" name="i" signature="OR.i(qubit, *, q=None)">
    Apply [`IGate`](qiskit.circuit.library.IGate "qiskit.circuit.library.IGate").
  </Function>

  ### id

  <Function id="qiskit.circuit.library.OR.id" name="id" signature="OR.id(qubit, *, q=None)">
    Apply [`IGate`](qiskit.circuit.library.IGate "qiskit.circuit.library.IGate").
  </Function>

  ### iden

  <Function id="qiskit.circuit.library.OR.iden" name="iden" signature="OR.iden(qubit, *, q=None)">
    Deprecated identity gate.
  </Function>

  ### initialize

  <Function id="qiskit.circuit.library.OR.initialize" name="initialize" signature="OR.initialize(params, qubits)">
    Apply initialize to circuit.
  </Function>

  ### inverse

  <Function id="qiskit.circuit.library.OR.inverse" name="inverse" signature="OR.inverse()">
    Invert this circuit.
  ...
  <Function id="qiskit.circuit.library.OR.iso" name="iso" signature="OR.iso(isometry, q_input, q_ancillas_for_output, q_ancillas_zero=None, q_ancillas_dirty=None)">
  ...
  <Function id="qiskit.circuit.library.OR.isometry" name="isometry" signature="OR.isometry(isometry, q_input, q_ancillas_for_output, q_ancillas_zero=None, q_ancillas_dirty=None)">
    Attach an arbitrary isometry from m to n qubits to a circuit. In particular, this allows to attach arbitrary unitaries on n qubits (m=n) or to prepare any state on n qubits (m=0). The decomposition used here was introduced by Iten et al. in [https://arxiv.org/abs/1501.06911](https://arxiv.org/abs/1501.06911).
  ...
  <Function id="qiskit.circuit.library.OR.iswap" name="iswap" signature="OR.iswap(qubit1, qubit2)">
    Apply [`iSwapGate`](qiskit.circuit.library.iSwapGate "qiskit.circuit.library.iSwapGate").
  </Function>

  ### mcmt

  <Function id="qiskit.circuit.library.OR.mcmt" name="mcmt" signature="OR.mcmt(gate, control_qubits, target_qubits, ancilla_qubits=None, mode='no-ancilla', *, single_control_gate_fun=None, q_controls=None, q_ancillae=None, q_targets=None)">
  ...
  <Function id="qiskit.circuit.library.OR.mcrx" name="mcrx" signature="OR.mcrx(theta, q_controls, q_target, use_basis_gates=False)">
  ...
  <Function id="qiskit.circuit.library.OR.mcry" name="mcry" signature="OR.mcry(theta, q_controls, q_target, q_ancillae, mode='basic', use_basis_gates=False)">
  ...
  <Function id="qiskit.circuit.library.OR.mcrz" name="mcrz" signature="OR.mcrz(lam, q_controls, q_target, use_basis_gates=False)">
  ...
  <Function id="qiskit.circuit.library.OR.mct" name="mct" signature="OR.mct(control_qubits, target_qubit, ancilla_qubits=None, mode='noancilla')">
    Apply `MCXGate`.
  </Function>

  ### mcu1

  <Function id="qiskit.circuit.library.OR.mcu1" name="mcu1" signature="OR.mcu1(lam, control_qubits, target_qubit)">
    Apply `MCU1Gate`.
  </Function>

  ### mcx

  <Function id="qiskit.circuit.library.OR.mcx" name="mcx" signature="OR.mcx(control_qubits, target_qubit, ancilla_qubits=None, mode='noancilla')">
    Apply `MCXGate`.
  ...
  <Function id="qiskit.circuit.library.OR.measure" name="measure" signature="OR.measure(qubit, cbit)">
  ...
  <Function id="qiskit.circuit.library.OR.measure_active" name="measure_active" signature="OR.measure_active(inplace=True)">
  ...
  <Function id="qiskit.circuit.library.OR.measure_all" name="measure_all" signature="OR.measure_all(inplace=True)">
  ...
  <Function id="qiskit.circuit.library.OR.mirror" name="mirror" signature="OR.mirror()">
  ...
  <Function id="qiskit.circuit.library.OR.ms" name="ms" signature="OR.ms(theta, qubits)">
    Apply [`MSGate`](qiskit.circuit.library.MSGate "qiskit.circuit.library.MSGate").
  </Function>

  ### num\_connected\_components

  <Function id="qiskit.circuit.library.OR.num_connected_components" name="num_connected_components" signature="OR.num_connected_components(unitary_only=False)">
  ...
  <Function id="qiskit.circuit.library.OR.num_nonlocal_gates" name="num_nonlocal_gates" signature="OR.num_nonlocal_gates()">
  ...
  <Function id="qiskit.circuit.library.OR.num_tensor_factors" name="num_tensor_factors" signature="OR.num_tensor_factors()">
  ...
  <Function id="qiskit.circuit.library.OR.num_unitary_factors" name="num_unitary_factors" signature="OR.num_unitary_factors()">
    Computes the number of tensor factors in the unitary (quantum) part of the circuit only.
  </Function>

  ### qasm

  <Function id="qiskit.circuit.library.OR.qasm" name="qasm" signature="OR.qasm(formatted=False, filename=None)">
  ...
  <Function id="qiskit.circuit.library.OR.qbit_argument_conversion" name="qbit_argument_conversion" signature="OR.qbit_argument_conversion(qubit_representation)">
  ...
  <Function id="qiskit.circuit.library.OR.r" name="r" signature="OR.r(theta, phi, qubit, *, q=None)">
    Apply `RGate`.
  </Function>

  ### rcccx

  <Function id="qiskit.circuit.library.OR.rcccx" name="rcccx" signature="OR.rcccx(control_qubit1, control_qubit2, control_qubit3, target_qubit)">
    Apply [`RC3XGate`](qiskit.circuit.library.RC3XGate "qiskit.circuit.library.RC3XGate").
  </Function>

  ### rccx

  <Function id="qiskit.circuit.library.OR.rccx" name="rccx" signature="OR.rccx(control_qubit1, control_qubit2, target_qubit)">
    Apply [`RCCXGate`](qiskit.circuit.library.RCCXGate "qiskit.circuit.library.RCCXGate").
  </Function>

  ### remove\_final\_measurements

  <Function id="qiskit.circuit.library.OR.remove_final_measurements" name="remove_final_measurements" signature="OR.remove_final_measurements(inplace=True)">
  ...
  <Function id="qiskit.circuit.library.OR.reset" name="reset" signature="OR.reset(qubit)">
    Reset q.
  </Function>

  ### rx

  <Function id="qiskit.circuit.library.OR.rx" name="rx" signature="OR.rx(theta, qubit, *, label=None, q=None)">
    Apply [`RXGate`](qiskit.circuit.library.RXGate "qiskit.circuit.library.RXGate").
  </Function>

  ### rxx

  <Function id="qiskit.circuit.library.OR.rxx" name="rxx" signature="OR.rxx(theta, qubit1, qubit2)">
    Apply [`RXXGate`](qiskit.circuit.library.RXXGate "qiskit.circuit.library.RXXGate").
  </Function>

  ### ry

  <Function id="qiskit.circuit.library.OR.ry" name="ry" signature="OR.ry(theta, qubit, *, label=None, q=None)">
    Apply [`RYGate`](qiskit.circuit.library.RYGate "qiskit.circuit.library.RYGate").
  </Function>

  ### ryy

  <Function id="qiskit.circuit.library.OR.ryy" name="ryy" signature="OR.ryy(theta, qubit1, qubit2)">
    Apply [`RYYGate`](qiskit.circuit.library.RYYGate "qiskit.circuit.library.RYYGate").
  </Function>

  ### rz

  <Function id="qiskit.circuit.library.OR.rz" name="rz" signature="OR.rz(phi, qubit, *, q=None)">
    Apply [`RZGate`](qiskit.circuit.library.RZGate "qiskit.circuit.library.RZGate").
  </Function>

  ### rzx

  <Function id="qiskit.circuit.library.OR.rzx" name="rzx" signature="OR.rzx(theta, qubit1, qubit2)">
    Apply [`RZXGate`](qiskit.circuit.library.RZXGate "qiskit.circuit.library.RZXGate").
  </Function>

  ### rzz

  <Function id="qiskit.circuit.library.OR.rzz" name="rzz" signature="OR.rzz(theta, qubit1, qubit2)">
    Apply [`RZZGate`](qiskit.circuit.library.RZZGate "qiskit.circuit.library.RZZGate").
  </Function>

  ### s

  <Function id="qiskit.circuit.library.OR.s" name="s" signature="OR.s(qubit, *, q=None)">
    Apply [`SGate`](qiskit.circuit.library.SGate "qiskit.circuit.library.SGate").
  </Function>

  ### sdg

  <Function id="qiskit.circuit.library.OR.sdg" name="sdg" signature="OR.sdg(qubit, *, q=None)">
    Apply [`SdgGate`](qiskit.circuit.library.SdgGate "qiskit.circuit.library.SdgGate").
  </Function>

  ### size

  <Function id="qiskit.circuit.library.OR.size" name="size" signature="OR.size()">
  ...
  <Function id="qiskit.circuit.library.OR.snapshot" name="snapshot" signature="OR.snapshot(label, snapshot_type='statevector', qubits=None, params=None)">
  ...
  <Function id="qiskit.circuit.library.OR.snapshot_density_matrix" name="snapshot_density_matrix" signature="OR.snapshot_density_matrix(label, qubits=None)">
  ...
  <Function id="qiskit.circuit.library.OR.snapshot_expectation_value" name="snapshot_expectation_value" signature="OR.snapshot_expectation_value(label, op, qubits, single_shot=False, variance=False)">
  ...
  <Function id="qiskit.circuit.library.OR.snapshot_probabilities" name="snapshot_probabilities" signature="OR.snapshot_probabilities(label, qubits, variance=False)">
  ...
  <Function id="qiskit.circuit.library.OR.snapshot_stabilizer" name="snapshot_stabilizer" signature="OR.snapshot_stabilizer(label)">
  ...
  <Function id="qiskit.circuit.library.OR.snapshot_statevector" name="snapshot_statevector" signature="OR.snapshot_statevector(label)">
  ...
  <Function id="qiskit.circuit.library.OR.squ" name="squ" signature="OR.squ(unitary_matrix, qubit, mode='ZYZ', up_to_diagonal=False, *, u=None)">
  ...
  <Function id="qiskit.circuit.library.OR.swap" name="swap" signature="OR.swap(qubit1, qubit2)">
    Apply [`SwapGate`](qiskit.circuit.library.SwapGate "qiskit.circuit.library.SwapGate").
  </Function>

  ### t

  <Function id="qiskit.circuit.library.OR.t" name="t" signature="OR.t(qubit, *, q=None)">
    Apply [`TGate`](qiskit.circuit.library.TGate "qiskit.circuit.library.TGate").
  </Function>

  ### tdg

  <Function id="qiskit.circuit.library.OR.tdg" name="tdg" signature="OR.tdg(qubit, *, q=None)">
    Apply [`TdgGate`](qiskit.circuit.library.TdgGate "qiskit.circuit.library.TdgGate").
  </Function>

  ### to\_gate

  <Function id="qiskit.circuit.library.OR.to_gate" name="to_gate" signature="OR.to_gate(parameter_map=None)">
  ...
  <Function id="qiskit.circuit.library.OR.to_instruction" name="to_instruction" signature="OR.to_instruction(parameter_map=None)">
  ...
  <Function id="qiskit.circuit.library.OR.toffoli" name="toffoli" signature="OR.toffoli(control_qubit1, control_qubit2, target_qubit, *, ctl1=None, ctl2=None, tgt=None)">
    Apply [`CCXGate`](qiskit.circuit.library.CCXGate "qiskit.circuit.library.CCXGate").
  </Function>

  ### u1

  <Function id="qiskit.circuit.library.OR.u1" name="u1" signature="OR.u1(theta, qubit, *, q=None)">
    Apply [`U1Gate`](qiskit.circuit.library.U1Gate "qiskit.circuit.library.U1Gate").
  </Function>

  ### u2

  <Function id="qiskit.circuit.library.OR.u2" name="u2" signature="OR.u2(phi, lam, qubit, *, q=None)">
    Apply [`U2Gate`](qiskit.circuit.library.U2Gate "qiskit.circuit.library.U2Gate").
  </Function>

  ### u3

  <Function id="qiskit.circuit.library.OR.u3" name="u3" signature="OR.u3(theta, phi, lam, qubit, *, q=None)">
    Apply [`U3Gate`](qiskit.circuit.library.U3Gate "qiskit.circuit.library.U3Gate").
  </Function>

  ### uc

  <Function id="qiskit.circuit.library.OR.uc" name="uc" signature="OR.uc(gate_list, q_controls, q_target, up_to_diagonal=False)">
  ...
  <Function id="qiskit.circuit.library.OR.ucg" name="ucg" signature="OR.ucg(angle_list, q_controls, q_target, up_to_diagonal=False)">
    Deprecated version of uc.
  </Function>

  ### ucrx

  <Function id="qiskit.circuit.library.OR.ucrx" name="ucrx" signature="OR.ucrx(angle_list, q_controls, q_target)">
  ...
  <Function id="qiskit.circuit.library.OR.ucry" name="ucry" signature="OR.ucry(angle_list, q_controls, q_target)">
  ...
  <Function id="qiskit.circuit.library.OR.ucrz" name="ucrz" signature="OR.ucrz(angle_list, q_controls, q_target)">
  ...
  <Function id="qiskit.circuit.library.OR.ucx" name="ucx" signature="OR.ucx(angle_list, q_controls, q_target)">
    Deprecated version of ucrx.
  </Function>

  ### ucy

  <Function id="qiskit.circuit.library.OR.ucy" name="ucy" signature="OR.ucy(angle_list, q_controls, q_target)">
    Deprecated version of ucry.
  </Function>

  ### ucz

  <Function id="qiskit.circuit.library.OR.ucz" name="ucz" signature="OR.ucz(angle_list, q_controls, q_target)">
    Deprecated version of ucrz.
  </Function>

  ### unitary

  <Function id="qiskit.circuit.library.OR.unitary" name="unitary" signature="OR.unitary(obj, qubits, label=None)">
    Apply unitary gate to q.
  </Function>

  ### width

  <Function id="qiskit.circuit.library.OR.width" name="width" signature="OR.width()">
  ...
  <Function id="qiskit.circuit.library.OR.x" name="x" signature="OR.x(qubit, *, label=None, ctrl_state=None, q=None)">
    Apply [`XGate`](qiskit.circuit.library.XGate "qiskit.circuit.library.XGate").
  </Function>

  ### y

  <Function id="qiskit.circuit.library.OR.y" name="y" signature="OR.y(qubit, *, q=None)">
    Apply [`YGate`](qiskit.circuit.library.YGate "qiskit.circuit.library.YGate").
  </Function>

  ### z

  <Function id="qiskit.circuit.library.OR.z" name="z" signature="OR.z(qubit, *, q=None)">
