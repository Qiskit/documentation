...
`OR(num_variable_qubits, flags=None, mcx_mode='noancilla')` [GitHub](https://github.com/qiskit/qiskit/tree/stable/0.14/qiskit/circuit/library/boolean_logic/quantum_or.py "view source code")
...
<span id="qiskit.circuit.library.OR.AND" />

`OR.AND(qr_variables, qb_target, qr_ancillae, flags=None, mct_mode='no-ancilla')`
...
<span id="qiskit.circuit.library.OR.OR" />

`OR.OR(qr_variables, qb_target, qr_ancillae, flags=None, mct_mode='basic')`
...
`OR.append(instruction, qargs=None, cargs=None)`
...
`OR.assign_parameters(param_dict, inplace=False)`
...
`OR.ccx(control_qubit1, control_qubit2, target_qubit, *, ctl1=None, ctl2=None, tgt=None)`
...
`OR.ch(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)`
...
`OR.cnot(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)`
...
`OR.compose(other, qubits=None, clbits=None, front=False, inplace=False)`
...
`OR.crx(theta, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)`
...
`OR.cry(theta, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)`
...
`OR.crz(theta, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)`
...
`OR.cswap(control_qubit, target_qubit1, target_qubit2, *, label=None, ctrl_state=None, ctl=None, tgt1=None, tgt2=None)`
...
`OR.cu1(theta, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)`
...
`OR.cu3(theta, phi, lam, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)`
...
`OR.cx(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)`
...
`OR.cy(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)`
...
`OR.cz(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)`
...
`OR.draw(output=None, scale=0.7, filename=None, style=None, interactive=False, line_length=None, plot_barriers=True, reverse_bits=False, justify=None, vertical_compression='medium', idle_wires=True, with_layout=True, fold=None, ax=None, initial_state=False, cregbundle=False)`
...
`OR.fredkin(control_qubit, target_qubit1, target_qubit2, *, ctl=None, tgt1=None, tgt2=None)`
...
`static OR.from_qasm_str(qasm_str)`
...
`OR.hamiltonian(operator, time, qubits, label=None)`
...
`OR.iso(isometry, q_input, q_ancillas_for_output, q_ancillas_zero=None, q_ancillas_dirty=None)`
...
`OR.isometry(isometry, q_input, q_ancillas_for_output, q_ancillas_zero=None, q_ancillas_dirty=None)`
...
`OR.mcmt(gate, control_qubits, target_qubits, ancilla_qubits=None, mode='no-ancilla', *, single_control_gate_fun=None, q_controls=None, q_ancillae=None, q_targets=None)`
...
`OR.mcrx(theta, q_controls, q_target, use_basis_gates=False)`
...
`OR.mcry(theta, q_controls, q_target, q_ancillae, mode='basic', use_basis_gates=False)`
...
`OR.mcrz(lam, q_controls, q_target, use_basis_gates=False)`
...
`OR.mcx(control_qubits, target_qubit, ancilla_qubits=None, mode='noancilla')`
...
`OR.measure_active(inplace=True)`
...
`OR.num_connected_components(unitary_only=False)`
...
`OR.qasm(formatted=False, filename=None)`
...
`OR.rcccx(control_qubit1, control_qubit2, control_qubit3, target_qubit)`
...
`OR.rccx(control_qubit1, control_qubit2, target_qubit)`
...
`OR.remove_final_measurements(inplace=True)`
...
`OR.rx(theta, qubit, *, label=None, q=None)`
...
`OR.ry(theta, qubit, *, label=None, q=None)`
...
`OR.snapshot(label, snapshot_type='statevector', qubits=None, params=None)`
...
`OR.snapshot_expectation_value(label, op, qubits, single_shot=False, variance=False)`
...
`OR.squ(unitary_matrix, qubit, mode='ZYZ', up_to_diagonal=False, *, u=None)`
...
`OR.to_instruction(parameter_map=None)`
...
`OR.toffoli(control_qubit1, control_qubit2, target_qubit, *, ctl1=None, ctl2=None, tgt=None)`
...
`OR.u3(theta, phi, lam, qubit, *, q=None)`
...
`OR.uc(gate_list, q_controls, q_target, up_to_diagonal=False)`
...
`OR.x(qubit, *, label=None, ctrl_state=None, q=None)`
