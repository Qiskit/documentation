---
title: OR (v0.19)
description: API reference for qiskit.circuit.library.OR in qiskit v0.19
...
<Class id="qiskit.circuit.library.OR" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.14/qiskit/circuit/library/boolean_logic/quantum_or.py" signature="OR(num_variable_qubits, flags=None, mcx_mode='noancilla')" modifiers="class">
  ...
  *   **mcx\_mode** (`str`) – The mode to be used to implement the multi-controlled X gate.
  ...
  <span id="or-instances" />

  ### instances

  <Attribute id="qiskit.circuit.library.OR.instances" attributeValue="8" />

  <span id="or-n-qubits" />

  ### n\_qubits

  <Attribute id="qiskit.circuit.library.OR.n_qubits">
    Deprecated, use `num_qubits` instead. Return number of qubits.
  </Attribute>

  <span id="or-num-clbits" />
  ...
  <Function id="qiskit.circuit.library.OR.AND" signature="OR.AND(qr_variables, qb_target, qr_ancillae, flags=None, mct_mode='no-ancilla')">
  ...
  <Function id="qiskit.circuit.library.OR.OR" signature="OR.OR(qr_variables, qb_target, qr_ancillae, flags=None, mct_mode='basic')">
  ...
  <Function id="qiskit.circuit.library.OR.__getitem__" signature="OR.__getitem__(item)">
  ...
  <Function id="qiskit.circuit.library.OR.__len__" signature="OR.__len__()">
    Return number of operations in circuit.
  </Function>

  <span id="or-add-register" />

  ### add\_register

  <Function id="qiskit.circuit.library.OR.add_register" signature="OR.add_register(*regs)">
    Add registers.
  </Function>
  ...
  <Function id="qiskit.circuit.library.OR.append" signature="OR.append(instruction, qargs=None, cargs=None)">
  ...
  <span id="or-assign-parameters" />

  ### assign\_parameters

  <Function id="qiskit.circuit.library.OR.assign_parameters" signature="OR.assign_parameters(param_dict, inplace=False)">
  ...
  <Function id="qiskit.circuit.library.OR.barrier" signature="OR.barrier(*qargs)">
    Apply `Barrier`. If qargs is None, applies to all.
  </Function>

  <span id="or-bind-parameters" />

  ### bind\_parameters

  <Function id="qiskit.circuit.library.OR.bind_parameters" signature="OR.bind_parameters(value_dict)">
  ...
  <Function id="qiskit.circuit.library.OR.cast" signature="OR.cast(value, _type)" modifiers="static">
    Best effort to cast value to type. Otherwise, returns the value.
  </Function>

  <span id="or-cbit-argument-conversion" />

  ### cbit\_argument\_conversion

  <Function id="qiskit.circuit.library.OR.cbit_argument_conversion" signature="OR.cbit_argument_conversion(clbit_representation)">
  ...
  <Function id="qiskit.circuit.library.OR.ccx" signature="OR.ccx(control_qubit1, control_qubit2, target_qubit, *, ctl1=None, ctl2=None, tgt=None)">
  ...
  <Function id="qiskit.circuit.library.OR.ch" signature="OR.ch(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CHGate`](qiskit.circuit.library.CHGate "qiskit.circuit.library.CHGate").
  </Function>

  <span id="or-cls-instances" />

  ### cls\_instances

  <Function id="qiskit.circuit.library.OR.cls_instances" signature="OR.cls_instances()" modifiers="classmethod">
    Return the current number of instances of this class, useful for auto naming.
  </Function>

  <span id="or-cls-prefix" />

  ### cls\_prefix

  <Function id="qiskit.circuit.library.OR.cls_prefix" signature="OR.cls_prefix()" modifiers="classmethod">
  ...
  <Function id="qiskit.circuit.library.OR.cnot" signature="OR.cnot(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
  ...
  <Function id="qiskit.circuit.library.OR.combine" signature="OR.combine(rhs)">
  ...
  <Function id="qiskit.circuit.library.OR.compose" signature="OR.compose(other, qubits=None, clbits=None, front=False, inplace=False)">
  ...
  <Function id="qiskit.circuit.library.OR.copy" signature="OR.copy(name=None)">
    Copy the circuit.
  ...
  <span id="or-count-ops" />

  ### count\_ops

  <Function id="qiskit.circuit.library.OR.count_ops" signature="OR.count_ops()">
  ...
  <Function id="qiskit.circuit.library.OR.crx" signature="OR.crx(theta, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
  ...
  <Function id="qiskit.circuit.library.OR.cry" signature="OR.cry(theta, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
  ...
  <Function id="qiskit.circuit.library.OR.crz" signature="OR.crz(theta, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
  ...
  <Function id="qiskit.circuit.library.OR.cswap" signature="OR.cswap(control_qubit, target_qubit1, target_qubit2, *, label=None, ctrl_state=None, ctl=None, tgt1=None, tgt2=None)">
  ...
  <Function id="qiskit.circuit.library.OR.cu1" signature="OR.cu1(theta, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
  ...
  <Function id="qiskit.circuit.library.OR.cu3" signature="OR.cu3(theta, phi, lam, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
  ...
  <Function id="qiskit.circuit.library.OR.cx" signature="OR.cx(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CXGate`](qiskit.circuit.library.CXGate "qiskit.circuit.library.CXGate").
  </Function>
  ...
  <Function id="qiskit.circuit.library.OR.cy" signature="OR.cy(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
  ...
  <Function id="qiskit.circuit.library.OR.cz" signature="OR.cz(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
  ...
  <Function id="qiskit.circuit.library.OR.dcx" signature="OR.dcx(qubit1, qubit2)">
    Apply [`DCXGate`](qiskit.circuit.library.DCXGate "qiskit.circuit.library.DCXGate").
  </Function>

  <span id="or-decompose" />

  ### decompose

  <Function id="qiskit.circuit.library.OR.decompose" signature="OR.decompose()">
  ...
  <Function id="qiskit.circuit.library.OR.depth" signature="OR.depth()">
  ...
  <span id="or-diag-gate" />

  ### diag\_gate

  <Function id="qiskit.circuit.library.OR.diag_gate" signature="OR.diag_gate(diag, qubit)">
  ...
  <Function id="qiskit.circuit.library.OR.diagonal" signature="OR.diagonal(diag, qubit)">
  ...
  <Function id="qiskit.circuit.library.OR.extend" signature="OR.extend(rhs)">
  ...
  <Function id="qiskit.circuit.library.OR.fredkin" signature="OR.fredkin(control_qubit, target_qubit1, target_qubit2, *, ctl=None, tgt1=None, tgt2=None)">
    Apply [`CSwapGate`](qiskit.circuit.library.CSwapGate "qiskit.circuit.library.CSwapGate").
  </Function>

  <span id="or-from-qasm-file" />

  ### from\_qasm\_file

  <Function id="qiskit.circuit.library.OR.from_qasm_file" signature="OR.from_qasm_file(path)" modifiers="static">
  ...
  <span id="or-from-qasm-str" />

  ### from\_qasm\_str

  <Function id="qiskit.circuit.library.OR.from_qasm_str" signature="OR.from_qasm_str(qasm_str)" modifiers="static">
  ...
  <Function id="qiskit.circuit.library.OR.h" signature="OR.h(qubit, *, q=None)">
    Apply [`HGate`](qiskit.circuit.library.HGate "qiskit.circuit.library.HGate").
  </Function>

  <span id="or-hamiltonian" />

  ### hamiltonian

  <Function id="qiskit.circuit.library.OR.hamiltonian" signature="OR.hamiltonian(operator, time, qubits, label=None)">
    Apply hamiltonian evolution to to qubits.
  </Function>

  <span id="or-has-register" />

  ### has\_register

  <Function id="qiskit.circuit.library.OR.has_register" signature="OR.has_register(register)">
  ...
  <Function id="qiskit.circuit.library.OR.i" signature="OR.i(qubit, *, q=None)">
  ...
  <Function id="qiskit.circuit.library.OR.id" signature="OR.id(qubit, *, q=None)">
    Apply [`IGate`](qiskit.circuit.library.IGate "qiskit.circuit.library.IGate").
  </Function>
  ...
  <Function id="qiskit.circuit.library.OR.iden" signature="OR.iden(qubit, *, q=None)">
    Deprecated identity gate.
  </Function>

  <span id="or-initialize" />

  ### initialize

  <Function id="qiskit.circuit.library.OR.initialize" signature="OR.initialize(params, qubits)">
  ...
  <Function id="qiskit.circuit.library.OR.inverse" signature="OR.inverse()">
    Invert this circuit.
  ...
  <Function id="qiskit.circuit.library.OR.iso" signature="OR.iso(isometry, q_input, q_ancillas_for_output, q_ancillas_zero=None, q_ancillas_dirty=None)">
  ...
  <Function id="qiskit.circuit.library.OR.isometry" signature="OR.isometry(isometry, q_input, q_ancillas_for_output, q_ancillas_zero=None, q_ancillas_dirty=None)">
    Attach an arbitrary isometry from m to n qubits to a circuit. In particular, this allows to attach arbitrary unitaries on n qubits (m=n) or to prepare any state on n qubits (m=0). The decomposition used here was introduced by Iten et al. in [https://arxiv.org/abs/1501.06911](https://arxiv.org/abs/1501.06911).
  ...
  <Function id="qiskit.circuit.library.OR.iswap" signature="OR.iswap(qubit1, qubit2)">
  ...
  <Function id="qiskit.circuit.library.OR.mcmt" signature="OR.mcmt(gate, control_qubits, target_qubits, ancilla_qubits=None, mode='no-ancilla', *, single_control_gate_fun=None, q_controls=None, q_ancillae=None, q_targets=None)">
  ...
  <Function id="qiskit.circuit.library.OR.mcrx" signature="OR.mcrx(theta, q_controls, q_target, use_basis_gates=False)">
  ...
  <Function id="qiskit.circuit.library.OR.mcry" signature="OR.mcry(theta, q_controls, q_target, q_ancillae, mode='basic', use_basis_gates=False)">
  ...
  <Function id="qiskit.circuit.library.OR.mcrz" signature="OR.mcrz(lam, q_controls, q_target, use_basis_gates=False)">
  ...
  <Function id="qiskit.circuit.library.OR.mct" signature="OR.mct(control_qubits, target_qubit, ancilla_qubits=None, mode='noancilla')">
    Apply `MCXGate`.
  </Function>
  ...
  <Function id="qiskit.circuit.library.OR.mcu1" signature="OR.mcu1(lam, control_qubits, target_qubit)">
    Apply `MCU1Gate`.
  </Function>
  ...
  <Function id="qiskit.circuit.library.OR.mcx" signature="OR.mcx(control_qubits, target_qubit, ancilla_qubits=None, mode='noancilla')">
    Apply `MCXGate`.
  ...
  <Function id="qiskit.circuit.library.OR.measure" signature="OR.measure(qubit, cbit)">
  ...
  <span id="or-measure-active" />

  ### measure\_active

  <Function id="qiskit.circuit.library.OR.measure_active" signature="OR.measure_active(inplace=True)">
  ...
  <span id="or-measure-all" />

  ### measure\_all

  <Function id="qiskit.circuit.library.OR.measure_all" signature="OR.measure_all(inplace=True)">
  ...
  <Function id="qiskit.circuit.library.OR.mirror" signature="OR.mirror()">
  ...
  <Function id="qiskit.circuit.library.OR.ms" signature="OR.ms(theta, qubits)">
    Apply [`MSGate`](qiskit.circuit.library.MSGate "qiskit.circuit.library.MSGate").
  </Function>

  <span id="or-num-connected-components" />

  ### num\_connected\_components

  <Function id="qiskit.circuit.library.OR.num_connected_components" signature="OR.num_connected_components(unitary_only=False)">
  ...
  <span id="or-num-nonlocal-gates" />

  ### num\_nonlocal\_gates

  <Function id="qiskit.circuit.library.OR.num_nonlocal_gates" signature="OR.num_nonlocal_gates()">
    Return number of non-local gates (i.e. involving 2+ qubits).

    Conditional nonlocal gates are also included.
  </Function>

  <span id="or-num-tensor-factors" />

  ### num\_tensor\_factors

  <Function id="qiskit.circuit.library.OR.num_tensor_factors" signature="OR.num_tensor_factors()">
  ...
  <span id="or-num-unitary-factors" />

  ### num\_unitary\_factors

  <Function id="qiskit.circuit.library.OR.num_unitary_factors" signature="OR.num_unitary_factors()">
    Computes the number of tensor factors in the unitary (quantum) part of the circuit only.
  </Function>
  ...
  <Function id="qiskit.circuit.library.OR.qasm" signature="OR.qasm(formatted=False, filename=None)">
  ...
  <span id="or-qbit-argument-conversion" />

  ### qbit\_argument\_conversion

  <Function id="qiskit.circuit.library.OR.qbit_argument_conversion" signature="OR.qbit_argument_conversion(qubit_representation)">
  ...
  <Function id="qiskit.circuit.library.OR.r" signature="OR.r(theta, phi, qubit, *, q=None)">
    Apply `RGate`.
  </Function>
  ...
  <Function id="qiskit.circuit.library.OR.rcccx" signature="OR.rcccx(control_qubit1, control_qubit2, control_qubit3, target_qubit)">
  ...
  <Function id="qiskit.circuit.library.OR.rccx" signature="OR.rccx(control_qubit1, control_qubit2, target_qubit)">
    Apply [`RCCXGate`](qiskit.circuit.library.RCCXGate "qiskit.circuit.library.RCCXGate").
  </Function>

  <span id="or-remove-final-measurements" />

  ### remove\_final\_measurements

  <Function id="qiskit.circuit.library.OR.remove_final_measurements" signature="OR.remove_final_measurements(inplace=True)">
  ...
  <Function id="qiskit.circuit.library.OR.reset" signature="OR.reset(qubit)">
    Reset q.
  </Function>
  ...
  <Function id="qiskit.circuit.library.OR.rx" signature="OR.rx(theta, qubit, *, label=None, q=None)">
  ...
  <Function id="qiskit.circuit.library.OR.rxx" signature="OR.rxx(theta, qubit1, qubit2)">
  ...
  <Function id="qiskit.circuit.library.OR.ry" signature="OR.ry(theta, qubit, *, label=None, q=None)">
  ...
  <Function id="qiskit.circuit.library.OR.ryy" signature="OR.ryy(theta, qubit1, qubit2)">
  ...
  <Function id="qiskit.circuit.library.OR.rz" signature="OR.rz(phi, qubit, *, q=None)">
  ...
  <Function id="qiskit.circuit.library.OR.rzx" signature="OR.rzx(theta, qubit1, qubit2)">
  ...
  <Function id="qiskit.circuit.library.OR.rzz" signature="OR.rzz(theta, qubit1, qubit2)">
  ...
  <Function id="qiskit.circuit.library.OR.s" signature="OR.s(qubit, *, q=None)">
  ...
  <Function id="qiskit.circuit.library.OR.sdg" signature="OR.sdg(qubit, *, q=None)">
  ...
  <Function id="qiskit.circuit.library.OR.size" signature="OR.size()">
  ...
  <Function id="qiskit.circuit.library.OR.snapshot" signature="OR.snapshot(label, snapshot_type='statevector', qubits=None, params=None)">
  ...
  <span id="or-snapshot-density-matrix" />

  ### snapshot\_density\_matrix

  <Function id="qiskit.circuit.library.OR.snapshot_density_matrix" signature="OR.snapshot_density_matrix(label, qubits=None)">
  ...
  <span id="or-snapshot-expectation-value" />

  ### snapshot\_expectation\_value

  <Function id="qiskit.circuit.library.OR.snapshot_expectation_value" signature="OR.snapshot_expectation_value(label, op, qubits, single_shot=False, variance=False)">
  ...
  <span id="or-snapshot-probabilities" />

  ### snapshot\_probabilities

  <Function id="qiskit.circuit.library.OR.snapshot_probabilities" signature="OR.snapshot_probabilities(label, qubits, variance=False)">
  ...
  <span id="or-snapshot-stabilizer" />

  ### snapshot\_stabilizer

  <Function id="qiskit.circuit.library.OR.snapshot_stabilizer" signature="OR.snapshot_stabilizer(label)">
  ...
  <span id="or-snapshot-statevector" />

  ### snapshot\_statevector

  <Function id="qiskit.circuit.library.OR.snapshot_statevector" signature="OR.snapshot_statevector(label)">
  ...
  <Function id="qiskit.circuit.library.OR.squ" signature="OR.squ(unitary_matrix, qubit, mode='ZYZ', up_to_diagonal=False, *, u=None)">
  ...
  <Function id="qiskit.circuit.library.OR.swap" signature="OR.swap(qubit1, qubit2)">
  ...
  <Function id="qiskit.circuit.library.OR.t" signature="OR.t(qubit, *, q=None)">
  ...
  <Function id="qiskit.circuit.library.OR.tdg" signature="OR.tdg(qubit, *, q=None)">
  ...
  <Function id="qiskit.circuit.library.OR.to_gate" signature="OR.to_gate(parameter_map=None)">
  ...
  <span id="or-to-instruction" />

  ### to\_instruction

  <Function id="qiskit.circuit.library.OR.to_instruction" signature="OR.to_instruction(parameter_map=None)">
  ...
  <Function id="qiskit.circuit.library.OR.toffoli" signature="OR.toffoli(control_qubit1, control_qubit2, target_qubit, *, ctl1=None, ctl2=None, tgt=None)">
    Apply [`CCXGate`](qiskit.circuit.library.CCXGate "qiskit.circuit.library.CCXGate").
  </Function>
  ...
  <Function id="qiskit.circuit.library.OR.u1" signature="OR.u1(theta, qubit, *, q=None)">
  ...
  <Function id="qiskit.circuit.library.OR.u2" signature="OR.u2(phi, lam, qubit, *, q=None)">
  ...
  <Function id="qiskit.circuit.library.OR.u3" signature="OR.u3(theta, phi, lam, qubit, *, q=None)">
  ...
  <Function id="qiskit.circuit.library.OR.uc" signature="OR.uc(gate_list, q_controls, q_target, up_to_diagonal=False)">
  ...
  <Function id="qiskit.circuit.library.OR.ucg" signature="OR.ucg(angle_list, q_controls, q_target, up_to_diagonal=False)">
  ...
  <Function id="qiskit.circuit.library.OR.ucrx" signature="OR.ucrx(angle_list, q_controls, q_target)">
  ...
  <Function id="qiskit.circuit.library.OR.ucry" signature="OR.ucry(angle_list, q_controls, q_target)">
  ...
  <Function id="qiskit.circuit.library.OR.ucrz" signature="OR.ucrz(angle_list, q_controls, q_target)">
  ...
  <Function id="qiskit.circuit.library.OR.ucx" signature="OR.ucx(angle_list, q_controls, q_target)">
  ...
  <Function id="qiskit.circuit.library.OR.ucy" signature="OR.ucy(angle_list, q_controls, q_target)">
  ...
  <Function id="qiskit.circuit.library.OR.ucz" signature="OR.ucz(angle_list, q_controls, q_target)">
  ...
  <Function id="qiskit.circuit.library.OR.unitary" signature="OR.unitary(obj, qubits, label=None)">
  ...
  <Function id="qiskit.circuit.library.OR.width" signature="OR.width()">
  ...
  <Function id="qiskit.circuit.library.OR.x" signature="OR.x(qubit, *, label=None, ctrl_state=None, q=None)">
  ...
  <Function id="qiskit.circuit.library.OR.y" signature="OR.y(qubit, *, q=None)">
  ...
  <Function id="qiskit.circuit.library.OR.z" signature="OR.z(qubit, *, q=None)">
