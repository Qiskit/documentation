---
title: CSPLayout (v0.19)
description: API reference for qiskit.transpiler.passes.CSPLayout in qiskit v0.19
...
<Class id="qiskit.transpiler.passes.CSPLayout" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.14/qiskit/transpiler/passes/layout/csp_layout.py" signature="CSPLayout(*args, **kwargs)" modifiers="class">
  ...
  *   **time\_limit** (*int*) – Amount of seconds that the pass will try to find a solution. None means no time limit. Default: 10 seconds.
  ...
  <span id="csplayout-is-analysis-pass" />
  ...
  <span id="csplayout-is-transformation-pass" />
