...
# basic\_device\_gate\_errors[¶](#basic-device-gate-errors "Permalink to this headline")

<span id="qiskit.providers.aer.noise.device.basic_device_gate_errors" />

`basic_device_gate_errors(properties, gate_error=True, thermal_relaxation=True, gate_lengths=None, gate_length_units='ns', temperature=0, standard_gates=True)`
