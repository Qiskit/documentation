---
title: ZZFeatureMap (v0.19)
description: API reference for qiskit.circuit.library.ZZFeatureMap in qiskit v0.19
...
<Class id="qiskit.circuit.library.ZZFeatureMap" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.14/qiskit/circuit/library/data_preparation/zz_feature_map.py" signature="ZZFeatureMap(feature_dimension, reps=2, entanglement='full', data_map_func=None, insert_barriers=False)" modifiers="class">
  ...
  *   **insert\_barriers** (`bool`) – If True, barriers are inserted in between the evolution instructions and hadamard layers.
  ...
  <span id="zzfeaturemap-entanglement" />

  ### entanglement

  <Attribute id="qiskit.circuit.library.ZZFeatureMap.entanglement" attributeTypeHint="Union[str, List[str], List[List[str]], List[int], List[List[int]], List[List[List[int]]], List[List[List[List[int]]]], Callable[[int], str], Callable[[int], List[List[int]]]]">
  ...
  <span id="zzfeaturemap-entanglement-blocks" />
  ...
  <span id="zzfeaturemap-extension-lib" />

  ### extension\_lib

  <Attribute id="qiskit.circuit.library.ZZFeatureMap.extension_lib" attributeValue="'include &#x22;qelib1.inc&#x22;;'" />

  <span id="zzfeaturemap-feature-dimension" />

  ### feature\_dimension

  <Attribute id="qiskit.circuit.library.ZZFeatureMap.feature_dimension" attributeTypeHint="int">
  ...
  <span id="zzfeaturemap-header" />

  ### header

  <Attribute id="qiskit.circuit.library.ZZFeatureMap.header" attributeValue="'OPENQASM 2.0;'" />

  <span id="zzfeaturemap-initial-state" />

  ### initial\_state

  <Attribute id="qiskit.circuit.library.ZZFeatureMap.initial_state" attributeTypeHint="Any">
  ...
  <span id="zzfeaturemap-insert-barriers" />

  ### insert\_barriers

  <Attribute id="qiskit.circuit.library.ZZFeatureMap.insert_barriers" attributeTypeHint="bool">
  ...
  <span id="zzfeaturemap-instances" />

  ### instances

  <Attribute id="qiskit.circuit.library.ZZFeatureMap.instances" attributeValue="8" />

  <span id="zzfeaturemap-n-qubits" />

  ### n\_qubits

  <Attribute id="qiskit.circuit.library.ZZFeatureMap.n_qubits">
    Deprecated, use `num_qubits` instead. Return number of qubits.
  </Attribute>

  <span id="zzfeaturemap-num-clbits" />
  ...
  <span id="zzfeaturemap-num-layers" />

  ### num\_layers

  <Attribute id="qiskit.circuit.library.ZZFeatureMap.num_layers" attributeTypeHint="int">
  ...
  <span id="zzfeaturemap-num-parameters" />
  ...
  <span id="zzfeaturemap-num-parameters-settable" />
  ...
  <span id="zzfeaturemap-num-qubits" />

  ### num\_qubits

  <Attribute id="qiskit.circuit.library.ZZFeatureMap.num_qubits" attributeTypeHint="int">
  ...
  <span id="zzfeaturemap-ordered-parameters" />

  ### ordered\_parameters

  <Attribute id="qiskit.circuit.library.ZZFeatureMap.ordered_parameters" attributeTypeHint="List[qiskit.circuit.parameter.Parameter]">
  ...
  <span id="zzfeaturemap-parameter-bounds" />

  ### parameter\_bounds

  <Attribute id="qiskit.circuit.library.ZZFeatureMap.parameter_bounds" attributeTypeHint="Optional[List[Tuple[float, float]]]">
  ...
  <span id="zzfeaturemap-parameters" />

  ### parameters

  <Attribute id="qiskit.circuit.library.ZZFeatureMap.parameters" attributeTypeHint="Set[qiskit.circuit.parameter.Parameter]">
  ...
  <span id="zzfeaturemap-paulis" />

  ### paulis

  <Attribute id="qiskit.circuit.library.ZZFeatureMap.paulis" attributeTypeHint="List[str]">
  ...
  <span id="zzfeaturemap-preferred-init-points" />

  ### preferred\_init\_points

  <Attribute id="qiskit.circuit.library.ZZFeatureMap.preferred_init_points" attributeTypeHint="Optional[List[float]]">
  ...
  <span id="zzfeaturemap-reps" />

  ### reps

  <Attribute id="qiskit.circuit.library.ZZFeatureMap.reps" attributeTypeHint="int">
  ...
  <span id="zzfeaturemap-rotation-blocks" />

  ### rotation\_blocks

  <Attribute id="qiskit.circuit.library.ZZFeatureMap.rotation_blocks" attributeTypeHint="List[qiskit.circuit.instruction.Instruction]">
  ...
  <span id="zzfeaturemap-and" />

  ### AND

  <Function id="qiskit.circuit.library.ZZFeatureMap.AND" signature="ZZFeatureMap.AND(qr_variables, qb_target, qr_ancillae, flags=None, mct_mode='no-ancilla')">
  ...
  <span id="zzfeaturemap-or" />

  ### OR

  <Function id="qiskit.circuit.library.ZZFeatureMap.OR" signature="ZZFeatureMap.OR(qr_variables, qb_target, qr_ancillae, flags=None, mct_mode='basic')">
  ...
  <span id="zzfeaturemap-getitem" />

  ### \_\_getitem\_\_

  <Function id="qiskit.circuit.library.ZZFeatureMap.__getitem__" signature="ZZFeatureMap.__getitem__(item)">
    Return indexed operation.
  </Function>

  <span id="zzfeaturemap-len" />

  ### \_\_len\_\_

  <Function id="qiskit.circuit.library.ZZFeatureMap.__len__" signature="ZZFeatureMap.__len__()">
    Return number of operations in circuit.
  </Function>

  <span id="zzfeaturemap-add-layer" />

  ### add\_layer

  <Function id="qiskit.circuit.library.ZZFeatureMap.add_layer" signature="ZZFeatureMap.add_layer(other, entanglement=None, front=False)">
  ...
  <span id="zzfeaturemap-add-register" />

  ### add\_register

  <Function id="qiskit.circuit.library.ZZFeatureMap.add_register" signature="ZZFeatureMap.add_register(*regs)">
    Add registers.
  </Function>

  <span id="zzfeaturemap-append" />

  ### append

  <Function id="qiskit.circuit.library.ZZFeatureMap.append" signature="ZZFeatureMap.append(instruction, qargs=None, cargs=None)">
  ...
  <span id="zzfeaturemap-assign-parameters" />

  ### assign\_parameters

  <Function id="qiskit.circuit.library.ZZFeatureMap.assign_parameters" signature="ZZFeatureMap.assign_parameters(param_dict, inplace=False)">
  ...
  <span id="zzfeaturemap-barrier" />

  ### barrier

  <Function id="qiskit.circuit.library.ZZFeatureMap.barrier" signature="ZZFeatureMap.barrier(*qargs)">
    Apply `Barrier`. If qargs is None, applies to all.
  </Function>

  <span id="zzfeaturemap-bind-parameters" />

  ### bind\_parameters

  <Function id="qiskit.circuit.library.ZZFeatureMap.bind_parameters" signature="ZZFeatureMap.bind_parameters(value_dict)">
  ...
  <span id="zzfeaturemap-cast" />

  ### cast

  <Function id="qiskit.circuit.library.ZZFeatureMap.cast" signature="ZZFeatureMap.cast(value, _type)" modifiers="static">
    Best effort to cast value to type. Otherwise, returns the value.
  </Function>

  <span id="zzfeaturemap-cbit-argument-conversion" />

  ### cbit\_argument\_conversion

  <Function id="qiskit.circuit.library.ZZFeatureMap.cbit_argument_conversion" signature="ZZFeatureMap.cbit_argument_conversion(clbit_representation)">
  ...
  <span id="zzfeaturemap-ccx" />

  ### ccx

  <Function id="qiskit.circuit.library.ZZFeatureMap.ccx" signature="ZZFeatureMap.ccx(control_qubit1, control_qubit2, target_qubit, *, ctl1=None, ctl2=None, tgt=None)">
    Apply [`CCXGate`](qiskit.circuit.library.CCXGate "qiskit.circuit.library.CCXGate").
  </Function>

  <span id="zzfeaturemap-ch" />

  ### ch

  <Function id="qiskit.circuit.library.ZZFeatureMap.ch" signature="ZZFeatureMap.ch(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CHGate`](qiskit.circuit.library.CHGate "qiskit.circuit.library.CHGate").
  </Function>

  <span id="zzfeaturemap-cls-instances" />

  ### cls\_instances

  <Function id="qiskit.circuit.library.ZZFeatureMap.cls_instances" signature="ZZFeatureMap.cls_instances()" modifiers="classmethod">
    Return the current number of instances of this class, useful for auto naming.
  </Function>

  <span id="zzfeaturemap-cls-prefix" />

  ### cls\_prefix

  <Function id="qiskit.circuit.library.ZZFeatureMap.cls_prefix" signature="ZZFeatureMap.cls_prefix()" modifiers="classmethod">
    Return the prefix to use for auto naming.
  </Function>

  <span id="zzfeaturemap-cnot" />

  ### cnot

  <Function id="qiskit.circuit.library.ZZFeatureMap.cnot" signature="ZZFeatureMap.cnot(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CXGate`](qiskit.circuit.library.CXGate "qiskit.circuit.library.CXGate").
  </Function>

  <span id="zzfeaturemap-combine" />

  ### combine

  <Function id="qiskit.circuit.library.ZZFeatureMap.combine" signature="ZZFeatureMap.combine(rhs)">
  ...
  <span id="zzfeaturemap-compose" />

  ### compose

  <Function id="qiskit.circuit.library.ZZFeatureMap.compose" signature="ZZFeatureMap.compose(other, qubits=None, clbits=None, front=False, inplace=False)">
  ...
  <span id="zzfeaturemap-copy" />

  ### copy

  <Function id="qiskit.circuit.library.ZZFeatureMap.copy" signature="ZZFeatureMap.copy(name=None)">
    Copy the circuit.
  ...
  <span id="zzfeaturemap-count-ops" />

  ### count\_ops

  <Function id="qiskit.circuit.library.ZZFeatureMap.count_ops" signature="ZZFeatureMap.count_ops()">
  ...
  <span id="zzfeaturemap-crx" />

  ### crx

  <Function id="qiskit.circuit.library.ZZFeatureMap.crx" signature="ZZFeatureMap.crx(theta, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CRXGate`](qiskit.circuit.library.CRXGate "qiskit.circuit.library.CRXGate").
  </Function>

  <span id="zzfeaturemap-cry" />

  ### cry

  <Function id="qiskit.circuit.library.ZZFeatureMap.cry" signature="ZZFeatureMap.cry(theta, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CRYGate`](qiskit.circuit.library.CRYGate "qiskit.circuit.library.CRYGate").
  </Function>

  <span id="zzfeaturemap-crz" />

  ### crz

  <Function id="qiskit.circuit.library.ZZFeatureMap.crz" signature="ZZFeatureMap.crz(theta, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CRZGate`](qiskit.circuit.library.CRZGate "qiskit.circuit.library.CRZGate").
  </Function>

  <span id="zzfeaturemap-cswap" />

  ### cswap

  <Function id="qiskit.circuit.library.ZZFeatureMap.cswap" signature="ZZFeatureMap.cswap(control_qubit, target_qubit1, target_qubit2, *, label=None, ctrl_state=None, ctl=None, tgt1=None, tgt2=None)">
    Apply [`CSwapGate`](qiskit.circuit.library.CSwapGate "qiskit.circuit.library.CSwapGate").
  </Function>

  <span id="zzfeaturemap-cu1" />

  ### cu1

  <Function id="qiskit.circuit.library.ZZFeatureMap.cu1" signature="ZZFeatureMap.cu1(theta, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CU1Gate`](qiskit.circuit.library.CU1Gate "qiskit.circuit.library.CU1Gate").
  </Function>

  <span id="zzfeaturemap-cu3" />

  ### cu3

  <Function id="qiskit.circuit.library.ZZFeatureMap.cu3" signature="ZZFeatureMap.cu3(theta, phi, lam, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CU3Gate`](qiskit.circuit.library.CU3Gate "qiskit.circuit.library.CU3Gate").
  </Function>

  <span id="zzfeaturemap-cx" />

  ### cx

  <Function id="qiskit.circuit.library.ZZFeatureMap.cx" signature="ZZFeatureMap.cx(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CXGate`](qiskit.circuit.library.CXGate "qiskit.circuit.library.CXGate").
  </Function>

  <span id="zzfeaturemap-cy" />

  ### cy

  <Function id="qiskit.circuit.library.ZZFeatureMap.cy" signature="ZZFeatureMap.cy(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CYGate`](qiskit.circuit.library.CYGate "qiskit.circuit.library.CYGate").
  </Function>

  <span id="zzfeaturemap-cz" />

  ### cz

  <Function id="qiskit.circuit.library.ZZFeatureMap.cz" signature="ZZFeatureMap.cz(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CZGate`](qiskit.circuit.library.CZGate "qiskit.circuit.library.CZGate").
  </Function>

  <span id="zzfeaturemap-dcx" />

  ### dcx

  <Function id="qiskit.circuit.library.ZZFeatureMap.dcx" signature="ZZFeatureMap.dcx(qubit1, qubit2)">
    Apply [`DCXGate`](qiskit.circuit.library.DCXGate "qiskit.circuit.library.DCXGate").
  </Function>

  <span id="zzfeaturemap-decompose" />

  ### decompose

  <Function id="qiskit.circuit.library.ZZFeatureMap.decompose" signature="ZZFeatureMap.decompose()">
  ...
  <span id="zzfeaturemap-depth" />

  ### depth

  <Function id="qiskit.circuit.library.ZZFeatureMap.depth" signature="ZZFeatureMap.depth()">
  ...
  <span id="zzfeaturemap-diag-gate" />

  ### diag\_gate

  <Function id="qiskit.circuit.library.ZZFeatureMap.diag_gate" signature="ZZFeatureMap.diag_gate(diag, qubit)">
    Deprecated version of QuantumCircuit.diagonal.
  </Function>

  <span id="zzfeaturemap-diagonal" />

  ### diagonal

  <Function id="qiskit.circuit.library.ZZFeatureMap.diagonal" signature="ZZFeatureMap.diagonal(diag, qubit)">
  ...
  <span id="zzfeaturemap-extend" />

  ### extend

  <Function id="qiskit.circuit.library.ZZFeatureMap.extend" signature="ZZFeatureMap.extend(rhs)">
  ...
  <span id="zzfeaturemap-fredkin" />

  ### fredkin

  <Function id="qiskit.circuit.library.ZZFeatureMap.fredkin" signature="ZZFeatureMap.fredkin(control_qubit, target_qubit1, target_qubit2, *, ctl=None, tgt1=None, tgt2=None)">
    Apply [`CSwapGate`](qiskit.circuit.library.CSwapGate "qiskit.circuit.library.CSwapGate").
  </Function>

  <span id="zzfeaturemap-from-qasm-file" />

  ### from\_qasm\_file

  <Function id="qiskit.circuit.library.ZZFeatureMap.from_qasm_file" signature="ZZFeatureMap.from_qasm_file(path)" modifiers="static">
  ...
  <span id="zzfeaturemap-from-qasm-str" />

  ### from\_qasm\_str

  <Function id="qiskit.circuit.library.ZZFeatureMap.from_qasm_str" signature="ZZFeatureMap.from_qasm_str(qasm_str)" modifiers="static">
  ...
  <span id="zzfeaturemap-get-entangler-map" />

  ### get\_entangler\_map

  <Function id="qiskit.circuit.library.ZZFeatureMap.get_entangler_map" signature="ZZFeatureMap.get_entangler_map(rep_num, block_num, num_block_qubits)">
  ...
  <span id="zzfeaturemap-get-unentangled-qubits" />

  ### get\_unentangled\_qubits

  <Function id="qiskit.circuit.library.ZZFeatureMap.get_unentangled_qubits" signature="ZZFeatureMap.get_unentangled_qubits()">
  ...
  <span id="zzfeaturemap-h" />

  ### h

  <Function id="qiskit.circuit.library.ZZFeatureMap.h" signature="ZZFeatureMap.h(qubit, *, q=None)">
    Apply [`HGate`](qiskit.circuit.library.HGate "qiskit.circuit.library.HGate").
  </Function>

  <span id="zzfeaturemap-hamiltonian" />

  ### hamiltonian

  <Function id="qiskit.circuit.library.ZZFeatureMap.hamiltonian" signature="ZZFeatureMap.hamiltonian(operator, time, qubits, label=None)">
    Apply hamiltonian evolution to to qubits.
  </Function>

  <span id="zzfeaturemap-has-register" />

  ### has\_register

  <Function id="qiskit.circuit.library.ZZFeatureMap.has_register" signature="ZZFeatureMap.has_register(register)">
  ...
  <span id="zzfeaturemap-i" />

  ### i

  <Function id="qiskit.circuit.library.ZZFeatureMap.i" signature="ZZFeatureMap.i(qubit, *, q=None)">
    Apply [`IGate`](qiskit.circuit.library.IGate "qiskit.circuit.library.IGate").
  </Function>

  <span id="zzfeaturemap-id" />

  ### id

  <Function id="qiskit.circuit.library.ZZFeatureMap.id" signature="ZZFeatureMap.id(qubit, *, q=None)">
    Apply [`IGate`](qiskit.circuit.library.IGate "qiskit.circuit.library.IGate").
  </Function>

  <span id="zzfeaturemap-iden" />

  ### iden

  <Function id="qiskit.circuit.library.ZZFeatureMap.iden" signature="ZZFeatureMap.iden(qubit, *, q=None)">
    Deprecated identity gate.
  </Function>

  <span id="zzfeaturemap-initialize" />

  ### initialize

  <Function id="qiskit.circuit.library.ZZFeatureMap.initialize" signature="ZZFeatureMap.initialize(params, qubits)">
    Apply initialize to circuit.
  </Function>

  <span id="zzfeaturemap-inverse" />

  ### inverse

  <Function id="qiskit.circuit.library.ZZFeatureMap.inverse" signature="ZZFeatureMap.inverse()">
    Invert this circuit.
  ...
  <span id="zzfeaturemap-iso" />

  ### iso

  <Function id="qiskit.circuit.library.ZZFeatureMap.iso" signature="ZZFeatureMap.iso(isometry, q_input, q_ancillas_for_output, q_ancillas_zero=None, q_ancillas_dirty=None)">
  ...
  <span id="zzfeaturemap-isometry" />

  ### isometry

  <Function id="qiskit.circuit.library.ZZFeatureMap.isometry" signature="ZZFeatureMap.isometry(isometry, q_input, q_ancillas_for_output, q_ancillas_zero=None, q_ancillas_dirty=None)">
    Attach an arbitrary isometry from m to n qubits to a circuit. In particular, this allows to attach arbitrary unitaries on n qubits (m=n) or to prepare any state on n qubits (m=0). The decomposition used here was introduced by Iten et al. in [https://arxiv.org/abs/1501.06911](https://arxiv.org/abs/1501.06911).
  ...
  <span id="zzfeaturemap-iswap" />

  ### iswap

  <Function id="qiskit.circuit.library.ZZFeatureMap.iswap" signature="ZZFeatureMap.iswap(qubit1, qubit2)">
    Apply [`iSwapGate`](qiskit.circuit.library.iSwapGate "qiskit.circuit.library.iSwapGate").
  </Function>

  <span id="zzfeaturemap-mcmt" />

  ### mcmt

  <Function id="qiskit.circuit.library.ZZFeatureMap.mcmt" signature="ZZFeatureMap.mcmt(gate, control_qubits, target_qubits, ancilla_qubits=None, mode='no-ancilla', *, single_control_gate_fun=None, q_controls=None, q_ancillae=None, q_targets=None)">
    Apply a multi-control, multi-target using a generic gate.

    This can also be used to implement a generic multi-control gate, as the target could also be of length 1.
  </Function>

  <span id="zzfeaturemap-mcrx" />

  ### mcrx

  <Function id="qiskit.circuit.library.ZZFeatureMap.mcrx" signature="ZZFeatureMap.mcrx(theta, q_controls, q_target, use_basis_gates=False)">
  ...
  <span id="zzfeaturemap-mcry" />

  ### mcry

  <Function id="qiskit.circuit.library.ZZFeatureMap.mcry" signature="ZZFeatureMap.mcry(theta, q_controls, q_target, q_ancillae, mode='basic', use_basis_gates=False)">
  ...
  <span id="zzfeaturemap-mcrz" />

  ### mcrz

  <Function id="qiskit.circuit.library.ZZFeatureMap.mcrz" signature="ZZFeatureMap.mcrz(lam, q_controls, q_target, use_basis_gates=False)">
  ...
  <span id="zzfeaturemap-mct" />

  ### mct

  <Function id="qiskit.circuit.library.ZZFeatureMap.mct" signature="ZZFeatureMap.mct(control_qubits, target_qubit, ancilla_qubits=None, mode='noancilla')">
    Apply `MCXGate`.
  </Function>

  <span id="zzfeaturemap-mcu1" />

  ### mcu1

  <Function id="qiskit.circuit.library.ZZFeatureMap.mcu1" signature="ZZFeatureMap.mcu1(lam, control_qubits, target_qubit)">
    Apply `MCU1Gate`.
  </Function>

  <span id="zzfeaturemap-mcx" />

  ### mcx

  <Function id="qiskit.circuit.library.ZZFeatureMap.mcx" signature="ZZFeatureMap.mcx(control_qubits, target_qubit, ancilla_qubits=None, mode='noancilla')">
    Apply `MCXGate`.
  ...
  <span id="zzfeaturemap-measure" />

  ### measure

  <Function id="qiskit.circuit.library.ZZFeatureMap.measure" signature="ZZFeatureMap.measure(qubit, cbit)">
  ...
  <span id="zzfeaturemap-measure-active" />

  ### measure\_active

  <Function id="qiskit.circuit.library.ZZFeatureMap.measure_active" signature="ZZFeatureMap.measure_active(inplace=True)">
  ...
  <span id="zzfeaturemap-measure-all" />

  ### measure\_all

  <Function id="qiskit.circuit.library.ZZFeatureMap.measure_all" signature="ZZFeatureMap.measure_all(inplace=True)">
  ...
  <span id="zzfeaturemap-mirror" />

  ### mirror

  <Function id="qiskit.circuit.library.ZZFeatureMap.mirror" signature="ZZFeatureMap.mirror()">
  ...
  <span id="zzfeaturemap-ms" />

  ### ms

  <Function id="qiskit.circuit.library.ZZFeatureMap.ms" signature="ZZFeatureMap.ms(theta, qubits)">
    Apply [`MSGate`](qiskit.circuit.library.MSGate "qiskit.circuit.library.MSGate").
  </Function>

  <span id="zzfeaturemap-num-connected-components" />

  ### num\_connected\_components

  <Function id="qiskit.circuit.library.ZZFeatureMap.num_connected_components" signature="ZZFeatureMap.num_connected_components(unitary_only=False)">
  ...
  <span id="zzfeaturemap-num-nonlocal-gates" />

  ### num\_nonlocal\_gates

  <Function id="qiskit.circuit.library.ZZFeatureMap.num_nonlocal_gates" signature="ZZFeatureMap.num_nonlocal_gates()">
    Return number of non-local gates (i.e. involving 2+ qubits).

    Conditional nonlocal gates are also included.
  </Function>

  <span id="zzfeaturemap-num-tensor-factors" />

  ### num\_tensor\_factors

  <Function id="qiskit.circuit.library.ZZFeatureMap.num_tensor_factors" signature="ZZFeatureMap.num_tensor_factors()">
  ...
  <span id="zzfeaturemap-num-unitary-factors" />

  ### num\_unitary\_factors

  <Function id="qiskit.circuit.library.ZZFeatureMap.num_unitary_factors" signature="ZZFeatureMap.num_unitary_factors()">
    Computes the number of tensor factors in the unitary (quantum) part of the circuit only.
  </Function>

  <span id="zzfeaturemap-pauli-block" />

  ### pauli\_block

  <Function id="qiskit.circuit.library.ZZFeatureMap.pauli_block" signature="ZZFeatureMap.pauli_block(pauli_string)">
    Get the Pauli block for the feature map circuit.
  </Function>

  <span id="zzfeaturemap-pauli-evolution" />

  ### pauli\_evolution

  <Function id="qiskit.circuit.library.ZZFeatureMap.pauli_evolution" signature="ZZFeatureMap.pauli_evolution(pauli_string, time)">
    Get the evolution block for the given pauli string.
  </Function>

  <span id="zzfeaturemap-print-settings" />

  ### print\_settings

  <Function id="qiskit.circuit.library.ZZFeatureMap.print_settings" signature="ZZFeatureMap.print_settings()">
  ...
  <span id="zzfeaturemap-qasm" />

  ### qasm

  <Function id="qiskit.circuit.library.ZZFeatureMap.qasm" signature="ZZFeatureMap.qasm(formatted=False, filename=None)">
  ...
  <span id="zzfeaturemap-qbit-argument-conversion" />

  ### qbit\_argument\_conversion

  <Function id="qiskit.circuit.library.ZZFeatureMap.qbit_argument_conversion" signature="ZZFeatureMap.qbit_argument_conversion(qubit_representation)">
  ...
  <span id="zzfeaturemap-r" />

  ### r

  <Function id="qiskit.circuit.library.ZZFeatureMap.r" signature="ZZFeatureMap.r(theta, phi, qubit, *, q=None)">
    Apply `RGate`.
  </Function>

  <span id="zzfeaturemap-rcccx" />

  ### rcccx

  <Function id="qiskit.circuit.library.ZZFeatureMap.rcccx" signature="ZZFeatureMap.rcccx(control_qubit1, control_qubit2, control_qubit3, target_qubit)">
    Apply [`RC3XGate`](qiskit.circuit.library.RC3XGate "qiskit.circuit.library.RC3XGate").
  </Function>

  <span id="zzfeaturemap-rccx" />

  ### rccx

  <Function id="qiskit.circuit.library.ZZFeatureMap.rccx" signature="ZZFeatureMap.rccx(control_qubit1, control_qubit2, target_qubit)">
    Apply [`RCCXGate`](qiskit.circuit.library.RCCXGate "qiskit.circuit.library.RCCXGate").
  </Function>

  <span id="zzfeaturemap-remove-final-measurements" />

  ### remove\_final\_measurements

  <Function id="qiskit.circuit.library.ZZFeatureMap.remove_final_measurements" signature="ZZFeatureMap.remove_final_measurements(inplace=True)">
  ...
  <span id="zzfeaturemap-reset" />

  ### reset

  <Function id="qiskit.circuit.library.ZZFeatureMap.reset" signature="ZZFeatureMap.reset(qubit)">
    Reset q.
  </Function>

  <span id="zzfeaturemap-rx" />

  ### rx

  <Function id="qiskit.circuit.library.ZZFeatureMap.rx" signature="ZZFeatureMap.rx(theta, qubit, *, label=None, q=None)">
    Apply [`RXGate`](qiskit.circuit.library.RXGate "qiskit.circuit.library.RXGate").
  </Function>

  <span id="zzfeaturemap-rxx" />

  ### rxx

  <Function id="qiskit.circuit.library.ZZFeatureMap.rxx" signature="ZZFeatureMap.rxx(theta, qubit1, qubit2)">
    Apply [`RXXGate`](qiskit.circuit.library.RXXGate "qiskit.circuit.library.RXXGate").
  </Function>

  <span id="zzfeaturemap-ry" />

  ### ry

  <Function id="qiskit.circuit.library.ZZFeatureMap.ry" signature="ZZFeatureMap.ry(theta, qubit, *, label=None, q=None)">
    Apply [`RYGate`](qiskit.circuit.library.RYGate "qiskit.circuit.library.RYGate").
  </Function>

  <span id="zzfeaturemap-ryy" />

  ### ryy

  <Function id="qiskit.circuit.library.ZZFeatureMap.ryy" signature="ZZFeatureMap.ryy(theta, qubit1, qubit2)">
    Apply [`RYYGate`](qiskit.circuit.library.RYYGate "qiskit.circuit.library.RYYGate").
  </Function>

  <span id="zzfeaturemap-rz" />

  ### rz

  <Function id="qiskit.circuit.library.ZZFeatureMap.rz" signature="ZZFeatureMap.rz(phi, qubit, *, q=None)">
    Apply [`RZGate`](qiskit.circuit.library.RZGate "qiskit.circuit.library.RZGate").
  </Function>

  <span id="zzfeaturemap-rzx" />

  ### rzx

  <Function id="qiskit.circuit.library.ZZFeatureMap.rzx" signature="ZZFeatureMap.rzx(theta, qubit1, qubit2)">
    Apply [`RZXGate`](qiskit.circuit.library.RZXGate "qiskit.circuit.library.RZXGate").
  </Function>

  <span id="zzfeaturemap-rzz" />

  ### rzz

  <Function id="qiskit.circuit.library.ZZFeatureMap.rzz" signature="ZZFeatureMap.rzz(theta, qubit1, qubit2)">
    Apply [`RZZGate`](qiskit.circuit.library.RZZGate "qiskit.circuit.library.RZZGate").
  </Function>

  <span id="zzfeaturemap-s" />

  ### s

  <Function id="qiskit.circuit.library.ZZFeatureMap.s" signature="ZZFeatureMap.s(qubit, *, q=None)">
    Apply [`SGate`](qiskit.circuit.library.SGate "qiskit.circuit.library.SGate").
  </Function>

  <span id="zzfeaturemap-sdg" />

  ### sdg

  <Function id="qiskit.circuit.library.ZZFeatureMap.sdg" signature="ZZFeatureMap.sdg(qubit, *, q=None)">
    Apply [`SdgGate`](qiskit.circuit.library.SdgGate "qiskit.circuit.library.SdgGate").
  </Function>

  <span id="zzfeaturemap-size" />

  ### size

  <Function id="qiskit.circuit.library.ZZFeatureMap.size" signature="ZZFeatureMap.size()">
  ...
  <span id="zzfeaturemap-snapshot" />

  ### snapshot

  <Function id="qiskit.circuit.library.ZZFeatureMap.snapshot" signature="ZZFeatureMap.snapshot(label, snapshot_type='statevector', qubits=None, params=None)">
  ...
  <span id="zzfeaturemap-snapshot-density-matrix" />

  ### snapshot\_density\_matrix

  <Function id="qiskit.circuit.library.ZZFeatureMap.snapshot_density_matrix" signature="ZZFeatureMap.snapshot_density_matrix(label, qubits=None)">
  ...
  <span id="zzfeaturemap-snapshot-expectation-value" />

  ### snapshot\_expectation\_value

  <Function id="qiskit.circuit.library.ZZFeatureMap.snapshot_expectation_value" signature="ZZFeatureMap.snapshot_expectation_value(label, op, qubits, single_shot=False, variance=False)">
  ...
  <span id="zzfeaturemap-snapshot-probabilities" />

  ### snapshot\_probabilities

  <Function id="qiskit.circuit.library.ZZFeatureMap.snapshot_probabilities" signature="ZZFeatureMap.snapshot_probabilities(label, qubits, variance=False)">
  ...
  <span id="zzfeaturemap-snapshot-stabilizer" />

  ### snapshot\_stabilizer

  <Function id="qiskit.circuit.library.ZZFeatureMap.snapshot_stabilizer" signature="ZZFeatureMap.snapshot_stabilizer(label)">
  ...
  <span id="zzfeaturemap-snapshot-statevector" />

  ### snapshot\_statevector

  <Function id="qiskit.circuit.library.ZZFeatureMap.snapshot_statevector" signature="ZZFeatureMap.snapshot_statevector(label)">
  ...
  <span id="zzfeaturemap-squ" />

  ### squ

  <Function id="qiskit.circuit.library.ZZFeatureMap.squ" signature="ZZFeatureMap.squ(unitary_matrix, qubit, mode='ZYZ', up_to_diagonal=False, *, u=None)">
  ...
  <span id="zzfeaturemap-swap" />

  ### swap

  <Function id="qiskit.circuit.library.ZZFeatureMap.swap" signature="ZZFeatureMap.swap(qubit1, qubit2)">
    Apply [`SwapGate`](qiskit.circuit.library.SwapGate "qiskit.circuit.library.SwapGate").
  </Function>

  <span id="zzfeaturemap-t" />

  ### t

  <Function id="qiskit.circuit.library.ZZFeatureMap.t" signature="ZZFeatureMap.t(qubit, *, q=None)">
    Apply [`TGate`](qiskit.circuit.library.TGate "qiskit.circuit.library.TGate").
  </Function>

  <span id="zzfeaturemap-tdg" />

  ### tdg

  <Function id="qiskit.circuit.library.ZZFeatureMap.tdg" signature="ZZFeatureMap.tdg(qubit, *, q=None)">
    Apply [`TdgGate`](qiskit.circuit.library.TdgGate "qiskit.circuit.library.TdgGate").
  </Function>

  <span id="zzfeaturemap-to-gate" />

  ### to\_gate

  <Function id="qiskit.circuit.library.ZZFeatureMap.to_gate" signature="ZZFeatureMap.to_gate(parameter_map=None)">
  ...
  <span id="zzfeaturemap-to-instruction" />

  ### to\_instruction

  <Function id="qiskit.circuit.library.ZZFeatureMap.to_instruction" signature="ZZFeatureMap.to_instruction(parameter_map=None)">
  ...
  <span id="zzfeaturemap-toffoli" />

  ### toffoli

  <Function id="qiskit.circuit.library.ZZFeatureMap.toffoli" signature="ZZFeatureMap.toffoli(control_qubit1, control_qubit2, target_qubit, *, ctl1=None, ctl2=None, tgt=None)">
    Apply [`CCXGate`](qiskit.circuit.library.CCXGate "qiskit.circuit.library.CCXGate").
  </Function>

  <span id="zzfeaturemap-u1" />

  ### u1

  <Function id="qiskit.circuit.library.ZZFeatureMap.u1" signature="ZZFeatureMap.u1(theta, qubit, *, q=None)">
    Apply [`U1Gate`](qiskit.circuit.library.U1Gate "qiskit.circuit.library.U1Gate").
  </Function>

  <span id="zzfeaturemap-u2" />

  ### u2

  <Function id="qiskit.circuit.library.ZZFeatureMap.u2" signature="ZZFeatureMap.u2(phi, lam, qubit, *, q=None)">
    Apply [`U2Gate`](qiskit.circuit.library.U2Gate "qiskit.circuit.library.U2Gate").
  </Function>

  <span id="zzfeaturemap-u3" />

  ### u3

  <Function id="qiskit.circuit.library.ZZFeatureMap.u3" signature="ZZFeatureMap.u3(theta, phi, lam, qubit, *, q=None)">
    Apply [`U3Gate`](qiskit.circuit.library.U3Gate "qiskit.circuit.library.U3Gate").
  </Function>

  <span id="zzfeaturemap-uc" />

  ### uc

  <Function id="qiskit.circuit.library.ZZFeatureMap.uc" signature="ZZFeatureMap.uc(gate_list, q_controls, q_target, up_to_diagonal=False)">
  ...
  <span id="zzfeaturemap-ucg" />

  ### ucg

  <Function id="qiskit.circuit.library.ZZFeatureMap.ucg" signature="ZZFeatureMap.ucg(angle_list, q_controls, q_target, up_to_diagonal=False)">
    Deprecated version of uc.
  </Function>

  <span id="zzfeaturemap-ucrx" />

  ### ucrx

  <Function id="qiskit.circuit.library.ZZFeatureMap.ucrx" signature="ZZFeatureMap.ucrx(angle_list, q_controls, q_target)">
  ...
  <span id="zzfeaturemap-ucry" />

  ### ucry

  <Function id="qiskit.circuit.library.ZZFeatureMap.ucry" signature="ZZFeatureMap.ucry(angle_list, q_controls, q_target)">
  ...
  <span id="zzfeaturemap-ucrz" />

  ### ucrz

  <Function id="qiskit.circuit.library.ZZFeatureMap.ucrz" signature="ZZFeatureMap.ucrz(angle_list, q_controls, q_target)">
  ...
  <span id="zzfeaturemap-ucx" />

  ### ucx

  <Function id="qiskit.circuit.library.ZZFeatureMap.ucx" signature="ZZFeatureMap.ucx(angle_list, q_controls, q_target)">
    Deprecated version of ucrx.
  </Function>

  <span id="zzfeaturemap-ucy" />

  ### ucy

  <Function id="qiskit.circuit.library.ZZFeatureMap.ucy" signature="ZZFeatureMap.ucy(angle_list, q_controls, q_target)">
    Deprecated version of ucry.
  </Function>

  <span id="zzfeaturemap-ucz" />

  ### ucz

  <Function id="qiskit.circuit.library.ZZFeatureMap.ucz" signature="ZZFeatureMap.ucz(angle_list, q_controls, q_target)">
    Deprecated version of ucrz.
  </Function>

  <span id="zzfeaturemap-unitary" />

  ### unitary

  <Function id="qiskit.circuit.library.ZZFeatureMap.unitary" signature="ZZFeatureMap.unitary(obj, qubits, label=None)">
    Apply unitary gate to q.
  </Function>

  <span id="zzfeaturemap-width" />

  ### width

  <Function id="qiskit.circuit.library.ZZFeatureMap.width" signature="ZZFeatureMap.width()">
  ...
  <span id="zzfeaturemap-x" />

  ### x

  <Function id="qiskit.circuit.library.ZZFeatureMap.x" signature="ZZFeatureMap.x(qubit, *, label=None, ctrl_state=None, q=None)">
    Apply [`XGate`](qiskit.circuit.library.XGate "qiskit.circuit.library.XGate").
  </Function>

  <span id="zzfeaturemap-y" />

  ### y

  <Function id="qiskit.circuit.library.ZZFeatureMap.y" signature="ZZFeatureMap.y(qubit, *, q=None)">
    Apply [`YGate`](qiskit.circuit.library.YGate "qiskit.circuit.library.YGate").
  </Function>

  <span id="zzfeaturemap-z" />

  ### z

  <Function id="qiskit.circuit.library.ZZFeatureMap.z" signature="ZZFeatureMap.z(qubit, *, q=None)">
