...
<Class id="qiskit.circuit.library.ZZFeatureMap" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.14/qiskit/circuit/library/data_preparation/zz_feature_map.py" signature="ZZFeatureMap(feature_dimension, reps=2, entanglement='full', data_map_func=None, insert_barriers=False)">
  ...
  *   **insert\_barriers** (`bool`) – If True, barriers are inserted in between the evolution instructions and hadamard layers.
  ...
  <Attribute id="qiskit.circuit.library.ZZFeatureMap.entanglement" signature="Union[str, List[str], List[List[str]], List[int], List[List[int]], List[List[List[int]]], List[List[List[List[int]]]], Callable[[int], str], Callable[[int], List[List[int]]]]">
  ...
  <Attribute id="qiskit.circuit.library.ZZFeatureMap.feature_dimension" signature="int">
  ...
  <Attribute id="qiskit.circuit.library.ZZFeatureMap.initial_state" signature="Any">
  ...
  <Attribute id="qiskit.circuit.library.ZZFeatureMap.insert_barriers" signature="bool">
  ...
  <Attribute id="qiskit.circuit.library.ZZFeatureMap.num_layers" signature="int">
  ...
  <Attribute id="qiskit.circuit.library.ZZFeatureMap.num_qubits" signature="int">
  ...
  <Attribute id="qiskit.circuit.library.ZZFeatureMap.ordered_parameters" signature="List[qiskit.circuit.parameter.Parameter]">
  ...
  <Attribute id="qiskit.circuit.library.ZZFeatureMap.parameter_bounds" signature="Optional[List[Tuple[float, float]]]">
  ...
  <Attribute id="qiskit.circuit.library.ZZFeatureMap.parameters" signature="Set[qiskit.circuit.parameter.Parameter]">
  ...
  <Attribute id="qiskit.circuit.library.ZZFeatureMap.paulis" signature="List[str]">
  ...
  <Attribute id="qiskit.circuit.library.ZZFeatureMap.preferred_init_points" signature="Optional[List[float]]">
  ...
  <Attribute id="qiskit.circuit.library.ZZFeatureMap.reps" signature="int">
  ...
  <Attribute id="qiskit.circuit.library.ZZFeatureMap.rotation_blocks" signature="List[qiskit.circuit.instruction.Instruction]">
  ...
  <Function id="qiskit.circuit.library.ZZFeatureMap.cast" signature="static ZZFeatureMap.cast(value, _type)">
  ...
  <Function id="qiskit.circuit.library.ZZFeatureMap.cls_instances" signature="classmethod ZZFeatureMap.cls_instances()">
    Return the current number of instances of this class, useful for auto naming.
  </Function>

  ### cls\_prefix

  <Function id="qiskit.circuit.library.ZZFeatureMap.cls_prefix" signature="classmethod ZZFeatureMap.cls_prefix()">
  ...
  <Function id="qiskit.circuit.library.ZZFeatureMap.from_qasm_file" signature="static ZZFeatureMap.from_qasm_file(path)">
  ...
  <Function id="qiskit.circuit.library.ZZFeatureMap.from_qasm_str" signature="static ZZFeatureMap.from_qasm_str(qasm_str)">
