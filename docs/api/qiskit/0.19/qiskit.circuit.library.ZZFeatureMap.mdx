...
<Class id="qiskit.circuit.library.ZZFeatureMap" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.14/qiskit/circuit/library/data_preparation/zz_feature_map.py" signature="ZZFeatureMap(feature_dimension, reps=2, entanglement='full', data_map_func=None, insert_barriers=False)">
  ...
  *   **insert\_barriers** (`bool`) – If True, barriers are inserted in between the evolution instructions and hadamard layers.
  ...
  <Attribute id="qiskit.circuit.library.ZZFeatureMap.entanglement" name="entanglement" signature="Union[str, List[str], List[List[str]], List[int], List[List[int]], List[List[List[int]]], List[List[List[List[int]]]], Callable[[int], str], Callable[[int], List[List[int]]]]">
  ...
  <Attribute id="qiskit.circuit.library.ZZFeatureMap.extension_lib" signature="= 'include \&#x22;qelib1.inc\&#x22;;'" />

  ### feature\_dimension

  <Attribute id="qiskit.circuit.library.ZZFeatureMap.feature_dimension" name="feature_dimension" signature="int">
  ...
  <Attribute id="qiskit.circuit.library.ZZFeatureMap.header" signature="= 'OPENQASM 2.0;'" />

  ### initial\_state

  <Attribute id="qiskit.circuit.library.ZZFeatureMap.initial_state" name="initial_state" signature="Any">
  ...
  <Attribute id="qiskit.circuit.library.ZZFeatureMap.insert_barriers" name="insert_barriers" signature="bool">
  ...
  <Attribute id="qiskit.circuit.library.ZZFeatureMap.instances" signature="= 8" />

  ### n\_qubits

  <Attribute id="qiskit.circuit.library.ZZFeatureMap.n_qubits" name="n_qubits">
  ...
  <Attribute id="qiskit.circuit.library.ZZFeatureMap.num_layers" name="num_layers" signature="int">
  ...
  <Attribute id="qiskit.circuit.library.ZZFeatureMap.num_qubits" name="num_qubits" signature="int">
  ...
  <Attribute id="qiskit.circuit.library.ZZFeatureMap.ordered_parameters" name="ordered_parameters" signature="List[qiskit.circuit.parameter.Parameter]">
  ...
  <Attribute id="qiskit.circuit.library.ZZFeatureMap.parameter_bounds" name="parameter_bounds" signature="Optional[List[Tuple[float, float]]]">
  ...
  <Attribute id="qiskit.circuit.library.ZZFeatureMap.parameters" name="parameters" signature="Set[qiskit.circuit.parameter.Parameter]">
  ...
  <Attribute id="qiskit.circuit.library.ZZFeatureMap.paulis" name="paulis" signature="List[str]">
  ...
  <Attribute id="qiskit.circuit.library.ZZFeatureMap.preferred_init_points" name="preferred_init_points" signature="Optional[List[float]]">
  ...
  <Attribute id="qiskit.circuit.library.ZZFeatureMap.prefix" signature="= 'circuit'" />
  ...
  <Attribute id="qiskit.circuit.library.ZZFeatureMap.reps" name="reps" signature="int">
  ...
  <Attribute id="qiskit.circuit.library.ZZFeatureMap.rotation_blocks" name="rotation_blocks" signature="List[qiskit.circuit.instruction.Instruction]">
  ...
  <Function id="qiskit.circuit.library.ZZFeatureMap.AND" name="AND" signature="ZZFeatureMap.AND(qr_variables, qb_target, qr_ancillae, flags=None, mct_mode='no-ancilla')">
  ...
  <Function id="qiskit.circuit.library.ZZFeatureMap.OR" name="OR" signature="ZZFeatureMap.OR(qr_variables, qb_target, qr_ancillae, flags=None, mct_mode='basic')">
  ...
  <Function id="qiskit.circuit.library.ZZFeatureMap.__getitem__" name="__getitem__" signature="ZZFeatureMap.__getitem__(item)">
    Return indexed operation.
  </Function>

  ### \_\_len\_\_

  <Function id="qiskit.circuit.library.ZZFeatureMap.__len__" name="__len__" signature="ZZFeatureMap.__len__()">
    Return number of operations in circuit.
  </Function>

  ### add\_layer

  <Function id="qiskit.circuit.library.ZZFeatureMap.add_layer" name="add_layer" signature="ZZFeatureMap.add_layer(other, entanglement=None, front=False)">
  ...
  <Function id="qiskit.circuit.library.ZZFeatureMap.add_register" name="add_register" signature="ZZFeatureMap.add_register(*regs)">
    Add registers.
  </Function>

  ### append

  <Function id="qiskit.circuit.library.ZZFeatureMap.append" name="append" signature="ZZFeatureMap.append(instruction, qargs=None, cargs=None)">
  ...
  <Function id="qiskit.circuit.library.ZZFeatureMap.assign_parameters" name="assign_parameters" signature="ZZFeatureMap.assign_parameters(param_dict, inplace=False)">
  ...
  <Function id="qiskit.circuit.library.ZZFeatureMap.barrier" name="barrier" signature="ZZFeatureMap.barrier(*qargs)">
    Apply `Barrier`. If qargs is None, applies to all.
  </Function>

  ### bind\_parameters

  <Function id="qiskit.circuit.library.ZZFeatureMap.bind_parameters" name="bind_parameters" signature="ZZFeatureMap.bind_parameters(value_dict)">
  ...
  <Function id="qiskit.circuit.library.ZZFeatureMap.cast" name="cast" signature="static ZZFeatureMap.cast(value, _type)">
    Best effort to cast value to type. Otherwise, returns the value.
  </Function>

  ### cbit\_argument\_conversion

  <Function id="qiskit.circuit.library.ZZFeatureMap.cbit_argument_conversion" name="cbit_argument_conversion" signature="ZZFeatureMap.cbit_argument_conversion(clbit_representation)">
  ...
  <Function id="qiskit.circuit.library.ZZFeatureMap.ccx" name="ccx" signature="ZZFeatureMap.ccx(control_qubit1, control_qubit2, target_qubit, *, ctl1=None, ctl2=None, tgt=None)">
    Apply [`CCXGate`](qiskit.circuit.library.CCXGate "qiskit.circuit.library.CCXGate").
  </Function>

  ### ch

  <Function id="qiskit.circuit.library.ZZFeatureMap.ch" name="ch" signature="ZZFeatureMap.ch(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CHGate`](qiskit.circuit.library.CHGate "qiskit.circuit.library.CHGate").
  </Function>

  ### cls\_instances

  <Function id="qiskit.circuit.library.ZZFeatureMap.cls_instances" name="cls_instances" signature="classmethod ZZFeatureMap.cls_instances()">
    Return the current number of instances of this class, useful for auto naming.
  </Function>

  ### cls\_prefix

  <Function id="qiskit.circuit.library.ZZFeatureMap.cls_prefix" name="cls_prefix" signature="classmethod ZZFeatureMap.cls_prefix()">
    Return the prefix to use for auto naming.
  </Function>

  ### cnot

  <Function id="qiskit.circuit.library.ZZFeatureMap.cnot" name="cnot" signature="ZZFeatureMap.cnot(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CXGate`](qiskit.circuit.library.CXGate "qiskit.circuit.library.CXGate").
  </Function>

  ### combine

  <Function id="qiskit.circuit.library.ZZFeatureMap.combine" name="combine" signature="ZZFeatureMap.combine(rhs)">
  ...
  <Function id="qiskit.circuit.library.ZZFeatureMap.compose" name="compose" signature="ZZFeatureMap.compose(other, qubits=None, clbits=None, front=False, inplace=False)">
  ...
  <Function id="qiskit.circuit.library.ZZFeatureMap.copy" name="copy" signature="ZZFeatureMap.copy(name=None)">
    Copy the circuit.
  ...
  <Function id="qiskit.circuit.library.ZZFeatureMap.count_ops" name="count_ops" signature="ZZFeatureMap.count_ops()">
  ...
  <Function id="qiskit.circuit.library.ZZFeatureMap.crx" name="crx" signature="ZZFeatureMap.crx(theta, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CRXGate`](qiskit.circuit.library.CRXGate "qiskit.circuit.library.CRXGate").
  </Function>

  ### cry

  <Function id="qiskit.circuit.library.ZZFeatureMap.cry" name="cry" signature="ZZFeatureMap.cry(theta, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CRYGate`](qiskit.circuit.library.CRYGate "qiskit.circuit.library.CRYGate").
  </Function>

  ### crz

  <Function id="qiskit.circuit.library.ZZFeatureMap.crz" name="crz" signature="ZZFeatureMap.crz(theta, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CRZGate`](qiskit.circuit.library.CRZGate "qiskit.circuit.library.CRZGate").
  </Function>

  ### cswap

  <Function id="qiskit.circuit.library.ZZFeatureMap.cswap" name="cswap" signature="ZZFeatureMap.cswap(control_qubit, target_qubit1, target_qubit2, *, label=None, ctrl_state=None, ctl=None, tgt1=None, tgt2=None)">
    Apply [`CSwapGate`](qiskit.circuit.library.CSwapGate "qiskit.circuit.library.CSwapGate").
  </Function>

  ### cu1

  <Function id="qiskit.circuit.library.ZZFeatureMap.cu1" name="cu1" signature="ZZFeatureMap.cu1(theta, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CU1Gate`](qiskit.circuit.library.CU1Gate "qiskit.circuit.library.CU1Gate").
  </Function>

  ### cu3

  <Function id="qiskit.circuit.library.ZZFeatureMap.cu3" name="cu3" signature="ZZFeatureMap.cu3(theta, phi, lam, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CU3Gate`](qiskit.circuit.library.CU3Gate "qiskit.circuit.library.CU3Gate").
  </Function>

  ### cx

  <Function id="qiskit.circuit.library.ZZFeatureMap.cx" name="cx" signature="ZZFeatureMap.cx(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CXGate`](qiskit.circuit.library.CXGate "qiskit.circuit.library.CXGate").
  </Function>

  ### cy

  <Function id="qiskit.circuit.library.ZZFeatureMap.cy" name="cy" signature="ZZFeatureMap.cy(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CYGate`](qiskit.circuit.library.CYGate "qiskit.circuit.library.CYGate").
  </Function>

  ### cz

  <Function id="qiskit.circuit.library.ZZFeatureMap.cz" name="cz" signature="ZZFeatureMap.cz(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CZGate`](qiskit.circuit.library.CZGate "qiskit.circuit.library.CZGate").
  </Function>

  ### dcx

  <Function id="qiskit.circuit.library.ZZFeatureMap.dcx" name="dcx" signature="ZZFeatureMap.dcx(qubit1, qubit2)">
    Apply [`DCXGate`](qiskit.circuit.library.DCXGate "qiskit.circuit.library.DCXGate").
  </Function>

  ### decompose

  <Function id="qiskit.circuit.library.ZZFeatureMap.decompose" name="decompose" signature="ZZFeatureMap.decompose()">
  ...
  <Function id="qiskit.circuit.library.ZZFeatureMap.depth" name="depth" signature="ZZFeatureMap.depth()">
  ...
  <Function id="qiskit.circuit.library.ZZFeatureMap.diag_gate" name="diag_gate" signature="ZZFeatureMap.diag_gate(diag, qubit)">
    Deprecated version of QuantumCircuit.diagonal.
  </Function>

  ### diagonal

  <Function id="qiskit.circuit.library.ZZFeatureMap.diagonal" name="diagonal" signature="ZZFeatureMap.diagonal(diag, qubit)">
  ...
  <Function id="qiskit.circuit.library.ZZFeatureMap.extend" name="extend" signature="ZZFeatureMap.extend(rhs)">
  ...
  <Function id="qiskit.circuit.library.ZZFeatureMap.fredkin" name="fredkin" signature="ZZFeatureMap.fredkin(control_qubit, target_qubit1, target_qubit2, *, ctl=None, tgt1=None, tgt2=None)">
    Apply [`CSwapGate`](qiskit.circuit.library.CSwapGate "qiskit.circuit.library.CSwapGate").
  </Function>

  ### from\_qasm\_file

  <Function id="qiskit.circuit.library.ZZFeatureMap.from_qasm_file" name="from_qasm_file" signature="static ZZFeatureMap.from_qasm_file(path)">
  ...
  <Function id="qiskit.circuit.library.ZZFeatureMap.from_qasm_str" name="from_qasm_str" signature="static ZZFeatureMap.from_qasm_str(qasm_str)">
  ...
  <Function id="qiskit.circuit.library.ZZFeatureMap.get_entangler_map" name="get_entangler_map" signature="ZZFeatureMap.get_entangler_map(rep_num, block_num, num_block_qubits)">
  ...
  <Function id="qiskit.circuit.library.ZZFeatureMap.get_unentangled_qubits" name="get_unentangled_qubits" signature="ZZFeatureMap.get_unentangled_qubits()">
  ...
  <Function id="qiskit.circuit.library.ZZFeatureMap.h" name="h" signature="ZZFeatureMap.h(qubit, *, q=None)">
    Apply [`HGate`](qiskit.circuit.library.HGate "qiskit.circuit.library.HGate").
  </Function>

  ### hamiltonian

  <Function id="qiskit.circuit.library.ZZFeatureMap.hamiltonian" name="hamiltonian" signature="ZZFeatureMap.hamiltonian(operator, time, qubits, label=None)">
    Apply hamiltonian evolution to to qubits.
  </Function>

  ### has\_register

  <Function id="qiskit.circuit.library.ZZFeatureMap.has_register" name="has_register" signature="ZZFeatureMap.has_register(register)">
  ...
  <Function id="qiskit.circuit.library.ZZFeatureMap.i" name="i" signature="ZZFeatureMap.i(qubit, *, q=None)">
    Apply [`IGate`](qiskit.circuit.library.IGate "qiskit.circuit.library.IGate").
  </Function>

  ### id

  <Function id="qiskit.circuit.library.ZZFeatureMap.id" name="id" signature="ZZFeatureMap.id(qubit, *, q=None)">
    Apply [`IGate`](qiskit.circuit.library.IGate "qiskit.circuit.library.IGate").
  </Function>

  ### iden

  <Function id="qiskit.circuit.library.ZZFeatureMap.iden" name="iden" signature="ZZFeatureMap.iden(qubit, *, q=None)">
    Deprecated identity gate.
  </Function>

  ### initialize

  <Function id="qiskit.circuit.library.ZZFeatureMap.initialize" name="initialize" signature="ZZFeatureMap.initialize(params, qubits)">
    Apply initialize to circuit.
  </Function>

  ### inverse

  <Function id="qiskit.circuit.library.ZZFeatureMap.inverse" name="inverse" signature="ZZFeatureMap.inverse()">
    Invert this circuit.
  ...
  <Function id="qiskit.circuit.library.ZZFeatureMap.iso" name="iso" signature="ZZFeatureMap.iso(isometry, q_input, q_ancillas_for_output, q_ancillas_zero=None, q_ancillas_dirty=None)">
  ...
  <Function id="qiskit.circuit.library.ZZFeatureMap.isometry" name="isometry" signature="ZZFeatureMap.isometry(isometry, q_input, q_ancillas_for_output, q_ancillas_zero=None, q_ancillas_dirty=None)">
    Attach an arbitrary isometry from m to n qubits to a circuit. In particular, this allows to attach arbitrary unitaries on n qubits (m=n) or to prepare any state on n qubits (m=0). The decomposition used here was introduced by Iten et al. in [https://arxiv.org/abs/1501.06911](https://arxiv.org/abs/1501.06911).
  ...
  <Function id="qiskit.circuit.library.ZZFeatureMap.iswap" name="iswap" signature="ZZFeatureMap.iswap(qubit1, qubit2)">
    Apply [`iSwapGate`](qiskit.circuit.library.iSwapGate "qiskit.circuit.library.iSwapGate").
  </Function>

  ### mcmt

  <Function id="qiskit.circuit.library.ZZFeatureMap.mcmt" name="mcmt" signature="ZZFeatureMap.mcmt(gate, control_qubits, target_qubits, ancilla_qubits=None, mode='no-ancilla', *, single_control_gate_fun=None, q_controls=None, q_ancillae=None, q_targets=None)">
  ...
  <Function id="qiskit.circuit.library.ZZFeatureMap.mcrx" name="mcrx" signature="ZZFeatureMap.mcrx(theta, q_controls, q_target, use_basis_gates=False)">
  ...
  <Function id="qiskit.circuit.library.ZZFeatureMap.mcry" name="mcry" signature="ZZFeatureMap.mcry(theta, q_controls, q_target, q_ancillae, mode='basic', use_basis_gates=False)">
  ...
  <Function id="qiskit.circuit.library.ZZFeatureMap.mcrz" name="mcrz" signature="ZZFeatureMap.mcrz(lam, q_controls, q_target, use_basis_gates=False)">
  ...
  <Function id="qiskit.circuit.library.ZZFeatureMap.mct" name="mct" signature="ZZFeatureMap.mct(control_qubits, target_qubit, ancilla_qubits=None, mode='noancilla')">
    Apply `MCXGate`.
  </Function>

  ### mcu1

  <Function id="qiskit.circuit.library.ZZFeatureMap.mcu1" name="mcu1" signature="ZZFeatureMap.mcu1(lam, control_qubits, target_qubit)">
    Apply `MCU1Gate`.
  </Function>

  ### mcx

  <Function id="qiskit.circuit.library.ZZFeatureMap.mcx" name="mcx" signature="ZZFeatureMap.mcx(control_qubits, target_qubit, ancilla_qubits=None, mode='noancilla')">
    Apply `MCXGate`.
  ...
  <Function id="qiskit.circuit.library.ZZFeatureMap.measure" name="measure" signature="ZZFeatureMap.measure(qubit, cbit)">
  ...
  <Function id="qiskit.circuit.library.ZZFeatureMap.measure_active" name="measure_active" signature="ZZFeatureMap.measure_active(inplace=True)">
  ...
  <Function id="qiskit.circuit.library.ZZFeatureMap.measure_all" name="measure_all" signature="ZZFeatureMap.measure_all(inplace=True)">
  ...
  <Function id="qiskit.circuit.library.ZZFeatureMap.mirror" name="mirror" signature="ZZFeatureMap.mirror()">
  ...
  <Function id="qiskit.circuit.library.ZZFeatureMap.ms" name="ms" signature="ZZFeatureMap.ms(theta, qubits)">
    Apply [`MSGate`](qiskit.circuit.library.MSGate "qiskit.circuit.library.MSGate").
  </Function>

  ### num\_connected\_components

  <Function id="qiskit.circuit.library.ZZFeatureMap.num_connected_components" name="num_connected_components" signature="ZZFeatureMap.num_connected_components(unitary_only=False)">
  ...
  <Function id="qiskit.circuit.library.ZZFeatureMap.num_nonlocal_gates" name="num_nonlocal_gates" signature="ZZFeatureMap.num_nonlocal_gates()">
  ...
  <Function id="qiskit.circuit.library.ZZFeatureMap.num_tensor_factors" name="num_tensor_factors" signature="ZZFeatureMap.num_tensor_factors()">
  ...
  <Function id="qiskit.circuit.library.ZZFeatureMap.num_unitary_factors" name="num_unitary_factors" signature="ZZFeatureMap.num_unitary_factors()">
    Computes the number of tensor factors in the unitary (quantum) part of the circuit only.
  </Function>

  ### pauli\_block

  <Function id="qiskit.circuit.library.ZZFeatureMap.pauli_block" name="pauli_block" signature="ZZFeatureMap.pauli_block(pauli_string)">
    Get the Pauli block for the feature map circuit.
  </Function>

  ### pauli\_evolution

  <Function id="qiskit.circuit.library.ZZFeatureMap.pauli_evolution" name="pauli_evolution" signature="ZZFeatureMap.pauli_evolution(pauli_string, time)">
    Get the evolution block for the given pauli string.
  </Function>

  ### print\_settings

  <Function id="qiskit.circuit.library.ZZFeatureMap.print_settings" name="print_settings" signature="ZZFeatureMap.print_settings()">
  ...
  <Function id="qiskit.circuit.library.ZZFeatureMap.qasm" name="qasm" signature="ZZFeatureMap.qasm(formatted=False, filename=None)">
  ...
  <Function id="qiskit.circuit.library.ZZFeatureMap.qbit_argument_conversion" name="qbit_argument_conversion" signature="ZZFeatureMap.qbit_argument_conversion(qubit_representation)">
  ...
  <Function id="qiskit.circuit.library.ZZFeatureMap.r" name="r" signature="ZZFeatureMap.r(theta, phi, qubit, *, q=None)">
    Apply `RGate`.
  </Function>

  ### rcccx

  <Function id="qiskit.circuit.library.ZZFeatureMap.rcccx" name="rcccx" signature="ZZFeatureMap.rcccx(control_qubit1, control_qubit2, control_qubit3, target_qubit)">
    Apply [`RC3XGate`](qiskit.circuit.library.RC3XGate "qiskit.circuit.library.RC3XGate").
  </Function>

  ### rccx

  <Function id="qiskit.circuit.library.ZZFeatureMap.rccx" name="rccx" signature="ZZFeatureMap.rccx(control_qubit1, control_qubit2, target_qubit)">
    Apply [`RCCXGate`](qiskit.circuit.library.RCCXGate "qiskit.circuit.library.RCCXGate").
  </Function>

  ### remove\_final\_measurements

  <Function id="qiskit.circuit.library.ZZFeatureMap.remove_final_measurements" name="remove_final_measurements" signature="ZZFeatureMap.remove_final_measurements(inplace=True)">
  ...
  <Function id="qiskit.circuit.library.ZZFeatureMap.reset" name="reset" signature="ZZFeatureMap.reset(qubit)">
    Reset q.
  </Function>

  ### rx

  <Function id="qiskit.circuit.library.ZZFeatureMap.rx" name="rx" signature="ZZFeatureMap.rx(theta, qubit, *, label=None, q=None)">
    Apply [`RXGate`](qiskit.circuit.library.RXGate "qiskit.circuit.library.RXGate").
  </Function>

  ### rxx

  <Function id="qiskit.circuit.library.ZZFeatureMap.rxx" name="rxx" signature="ZZFeatureMap.rxx(theta, qubit1, qubit2)">
    Apply [`RXXGate`](qiskit.circuit.library.RXXGate "qiskit.circuit.library.RXXGate").
  </Function>

  ### ry

  <Function id="qiskit.circuit.library.ZZFeatureMap.ry" name="ry" signature="ZZFeatureMap.ry(theta, qubit, *, label=None, q=None)">
    Apply [`RYGate`](qiskit.circuit.library.RYGate "qiskit.circuit.library.RYGate").
  </Function>

  ### ryy

  <Function id="qiskit.circuit.library.ZZFeatureMap.ryy" name="ryy" signature="ZZFeatureMap.ryy(theta, qubit1, qubit2)">
    Apply [`RYYGate`](qiskit.circuit.library.RYYGate "qiskit.circuit.library.RYYGate").
  </Function>

  ### rz

  <Function id="qiskit.circuit.library.ZZFeatureMap.rz" name="rz" signature="ZZFeatureMap.rz(phi, qubit, *, q=None)">
    Apply [`RZGate`](qiskit.circuit.library.RZGate "qiskit.circuit.library.RZGate").
  </Function>

  ### rzx

  <Function id="qiskit.circuit.library.ZZFeatureMap.rzx" name="rzx" signature="ZZFeatureMap.rzx(theta, qubit1, qubit2)">
    Apply [`RZXGate`](qiskit.circuit.library.RZXGate "qiskit.circuit.library.RZXGate").
  </Function>

  ### rzz

  <Function id="qiskit.circuit.library.ZZFeatureMap.rzz" name="rzz" signature="ZZFeatureMap.rzz(theta, qubit1, qubit2)">
    Apply [`RZZGate`](qiskit.circuit.library.RZZGate "qiskit.circuit.library.RZZGate").
  </Function>

  ### s

  <Function id="qiskit.circuit.library.ZZFeatureMap.s" name="s" signature="ZZFeatureMap.s(qubit, *, q=None)">
    Apply [`SGate`](qiskit.circuit.library.SGate "qiskit.circuit.library.SGate").
  </Function>

  ### sdg

  <Function id="qiskit.circuit.library.ZZFeatureMap.sdg" name="sdg" signature="ZZFeatureMap.sdg(qubit, *, q=None)">
    Apply [`SdgGate`](qiskit.circuit.library.SdgGate "qiskit.circuit.library.SdgGate").
  </Function>

  ### size

  <Function id="qiskit.circuit.library.ZZFeatureMap.size" name="size" signature="ZZFeatureMap.size()">
  ...
  <Function id="qiskit.circuit.library.ZZFeatureMap.snapshot" name="snapshot" signature="ZZFeatureMap.snapshot(label, snapshot_type='statevector', qubits=None, params=None)">
  ...
  <Function id="qiskit.circuit.library.ZZFeatureMap.snapshot_density_matrix" name="snapshot_density_matrix" signature="ZZFeatureMap.snapshot_density_matrix(label, qubits=None)">
  ...
  <Function id="qiskit.circuit.library.ZZFeatureMap.snapshot_expectation_value" name="snapshot_expectation_value" signature="ZZFeatureMap.snapshot_expectation_value(label, op, qubits, single_shot=False, variance=False)">
  ...
  <Function id="qiskit.circuit.library.ZZFeatureMap.snapshot_probabilities" name="snapshot_probabilities" signature="ZZFeatureMap.snapshot_probabilities(label, qubits, variance=False)">
  ...
  <Function id="qiskit.circuit.library.ZZFeatureMap.snapshot_stabilizer" name="snapshot_stabilizer" signature="ZZFeatureMap.snapshot_stabilizer(label)">
  ...
  <Function id="qiskit.circuit.library.ZZFeatureMap.snapshot_statevector" name="snapshot_statevector" signature="ZZFeatureMap.snapshot_statevector(label)">
  ...
  <Function id="qiskit.circuit.library.ZZFeatureMap.squ" name="squ" signature="ZZFeatureMap.squ(unitary_matrix, qubit, mode='ZYZ', up_to_diagonal=False, *, u=None)">
  ...
  <Function id="qiskit.circuit.library.ZZFeatureMap.swap" name="swap" signature="ZZFeatureMap.swap(qubit1, qubit2)">
    Apply [`SwapGate`](qiskit.circuit.library.SwapGate "qiskit.circuit.library.SwapGate").
  </Function>

  ### t

  <Function id="qiskit.circuit.library.ZZFeatureMap.t" name="t" signature="ZZFeatureMap.t(qubit, *, q=None)">
    Apply [`TGate`](qiskit.circuit.library.TGate "qiskit.circuit.library.TGate").
  </Function>

  ### tdg

  <Function id="qiskit.circuit.library.ZZFeatureMap.tdg" name="tdg" signature="ZZFeatureMap.tdg(qubit, *, q=None)">
    Apply [`TdgGate`](qiskit.circuit.library.TdgGate "qiskit.circuit.library.TdgGate").
  </Function>

  ### to\_gate

  <Function id="qiskit.circuit.library.ZZFeatureMap.to_gate" name="to_gate" signature="ZZFeatureMap.to_gate(parameter_map=None)">
  ...
  <Function id="qiskit.circuit.library.ZZFeatureMap.to_instruction" name="to_instruction" signature="ZZFeatureMap.to_instruction(parameter_map=None)">
  ...
  <Function id="qiskit.circuit.library.ZZFeatureMap.toffoli" name="toffoli" signature="ZZFeatureMap.toffoli(control_qubit1, control_qubit2, target_qubit, *, ctl1=None, ctl2=None, tgt=None)">
    Apply [`CCXGate`](qiskit.circuit.library.CCXGate "qiskit.circuit.library.CCXGate").
  </Function>

  ### u1

  <Function id="qiskit.circuit.library.ZZFeatureMap.u1" name="u1" signature="ZZFeatureMap.u1(theta, qubit, *, q=None)">
    Apply [`U1Gate`](qiskit.circuit.library.U1Gate "qiskit.circuit.library.U1Gate").
  </Function>

  ### u2

  <Function id="qiskit.circuit.library.ZZFeatureMap.u2" name="u2" signature="ZZFeatureMap.u2(phi, lam, qubit, *, q=None)">
    Apply [`U2Gate`](qiskit.circuit.library.U2Gate "qiskit.circuit.library.U2Gate").
  </Function>

  ### u3

  <Function id="qiskit.circuit.library.ZZFeatureMap.u3" name="u3" signature="ZZFeatureMap.u3(theta, phi, lam, qubit, *, q=None)">
    Apply [`U3Gate`](qiskit.circuit.library.U3Gate "qiskit.circuit.library.U3Gate").
  </Function>

  ### uc

  <Function id="qiskit.circuit.library.ZZFeatureMap.uc" name="uc" signature="ZZFeatureMap.uc(gate_list, q_controls, q_target, up_to_diagonal=False)">
  ...
  <Function id="qiskit.circuit.library.ZZFeatureMap.ucg" name="ucg" signature="ZZFeatureMap.ucg(angle_list, q_controls, q_target, up_to_diagonal=False)">
    Deprecated version of uc.
  </Function>

  ### ucrx

  <Function id="qiskit.circuit.library.ZZFeatureMap.ucrx" name="ucrx" signature="ZZFeatureMap.ucrx(angle_list, q_controls, q_target)">
  ...
  <Function id="qiskit.circuit.library.ZZFeatureMap.ucry" name="ucry" signature="ZZFeatureMap.ucry(angle_list, q_controls, q_target)">
  ...
  <Function id="qiskit.circuit.library.ZZFeatureMap.ucrz" name="ucrz" signature="ZZFeatureMap.ucrz(angle_list, q_controls, q_target)">
  ...
  <Function id="qiskit.circuit.library.ZZFeatureMap.ucx" name="ucx" signature="ZZFeatureMap.ucx(angle_list, q_controls, q_target)">
    Deprecated version of ucrx.
  </Function>

  ### ucy

  <Function id="qiskit.circuit.library.ZZFeatureMap.ucy" name="ucy" signature="ZZFeatureMap.ucy(angle_list, q_controls, q_target)">
    Deprecated version of ucry.
  </Function>

  ### ucz

  <Function id="qiskit.circuit.library.ZZFeatureMap.ucz" name="ucz" signature="ZZFeatureMap.ucz(angle_list, q_controls, q_target)">
    Deprecated version of ucrz.
  </Function>

  ### unitary

  <Function id="qiskit.circuit.library.ZZFeatureMap.unitary" name="unitary" signature="ZZFeatureMap.unitary(obj, qubits, label=None)">
    Apply unitary gate to q.
  </Function>

  ### width

  <Function id="qiskit.circuit.library.ZZFeatureMap.width" name="width" signature="ZZFeatureMap.width()">
  ...
  <Function id="qiskit.circuit.library.ZZFeatureMap.x" name="x" signature="ZZFeatureMap.x(qubit, *, label=None, ctrl_state=None, q=None)">
    Apply [`XGate`](qiskit.circuit.library.XGate "qiskit.circuit.library.XGate").
  </Function>

  ### y

  <Function id="qiskit.circuit.library.ZZFeatureMap.y" name="y" signature="ZZFeatureMap.y(qubit, *, q=None)">
    Apply [`YGate`](qiskit.circuit.library.YGate "qiskit.circuit.library.YGate").
  </Function>

  ### z

  <Function id="qiskit.circuit.library.ZZFeatureMap.z" name="z" signature="ZZFeatureMap.z(qubit, *, q=None)">
