---
title: RYRZ (v0.19)
description: API reference for qiskit.aqua.components.variational_forms.RYRZ in qiskit v0.19
...
<Class id="qiskit.aqua.components.variational_forms.RYRZ" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.7/qiskit/aqua/components/variational_forms/ryrz.py" signature="RYRZ(num_qubits, depth=3, entangler_map=None, entanglement='full', initial_state=None, entanglement_gate='cz', skip_unentangled_qubits=False)" modifiers="class">
  ...
  *   **skip\_unentangled\_qubits** (`bool`) – Skip the qubits not in the entangler\_map
  ...
  <span id="ryrz-preferred-init-points" />
  ...
  <span id="ryrz-construct-circuit" />
  ...
  <span id="ryrz-get-entangler-map" />
  ...
  <span id="ryrz-validate-entangler-map" />
