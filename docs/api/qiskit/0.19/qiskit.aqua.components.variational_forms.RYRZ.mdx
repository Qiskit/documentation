...
<Class id="qiskit.aqua.components.variational_forms.RYRZ" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.7/qiskit/aqua/components/variational_forms/ryrz.py" signature="RYRZ(num_qubits, depth=3, entangler_map=None, entanglement='full', initial_state=None, entanglement_gate='cz', skip_unentangled_qubits=False)">
  ...
  *   **skip\_unentangled\_qubits** (`bool`) – Skip the qubits not in the entangler\_map
  ...
  <Function id="qiskit.aqua.components.variational_forms.RYRZ.get_entangler_map" signature="static RYRZ.get_entangler_map(map_type, num_qubits, offset=0)">
    returns entangler map
  </Function>

  ### validate\_entangler\_map

  <Function id="qiskit.aqua.components.variational_forms.RYRZ.validate_entangler_map" signature="static RYRZ.validate_entangler_map(entangler_map, num_qubits)">
