---
title: squ
description: API reference for qiskit.circuit.library.QuantumVolume.squ
in_page_toc_min_heading_level: 1
python_api_type: method
python_api_name: qiskit.circuit.library.QuantumVolume.squ
---
...
`QuantumVolume.squ(unitary_matrix, qubit, mode='ZYZ', up_to_diagonal=False, *, u=None)`
