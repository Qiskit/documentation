...
<Function id="qiskit.aqua.utils.split_dataset_to_data_and_labels" name="split_dataset_to_data_and_labels" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.7/qiskit/aqua/utils/dataset_helper.py" signature="split_dataset_to_data_and_labels(dataset, class_names=None)">
