---
title: split_dataset_to_data_and_labels (v0.19)
description: API reference for qiskit.aqua.utils.split_dataset_to_data_and_labels in qiskit v0.19
in_page_toc_min_heading_level: 1
python_api_type: function
python_api_name: qiskit.aqua.utils.split_dataset_to_data_and_labels
---

<span id="split-dataset-to-data-and-labels" />
