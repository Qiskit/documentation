...
<Class id="qiskit.circuit.Clbit" github="https://github.com/qiskit/qiskit/tree/stable/0.14/qiskit/circuit/classicalregister.py" signature="Clbit(register, index)">
