...
<Function id="qiskit.tools.chop" name="chop" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.14/qiskit/tools/qi/qi.py" signature="chop(array, epsilon=1e-10)">
