---
title: pauli_measurement (v0.19)
description: API reference for qiskit.aqua.operators.legacy.pauli_measurement in qiskit v0.19
in_page_toc_min_heading_level: 1
python_api_type: function
python_api_name: qiskit.aqua.operators.legacy.pauli_measurement
---

<span id="pauli-measurement" />

# pauli\_measurement

<Function id="qiskit.aqua.operators.legacy.pauli_measurement" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.7/qiskit/aqua/operators/legacy/common.py" signature="pauli_measurement(circuit, pauli, qr, cr, barrier=False)">
