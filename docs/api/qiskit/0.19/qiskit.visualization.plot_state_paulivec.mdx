...
<Function id="qiskit.visualization.plot_state_paulivec" github="https://github.com/qiskit/qiskit/tree/stable/0.14/qiskit/visualization/state_visualization.py" signature="plot_state_paulivec(rho, title='', figsize=None, color=None, ax=None)">
