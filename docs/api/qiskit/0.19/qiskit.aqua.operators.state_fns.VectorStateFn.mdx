---
title: VectorStateFn (v0.19)
description: API reference for qiskit.aqua.operators.state_fns.VectorStateFn in qiskit v0.19
...
<Class id="qiskit.aqua.operators.state_fns.VectorStateFn" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.7/qiskit/aqua/operators/state_fns/vector_state_fn.py" signature="VectorStateFn(primitive=None, coeff=1.0, is_measurement=False)" modifiers="class">
  ...
  *   **is\_measurement** (`bool`) – Whether the StateFn is a measurement operator
  ...
  <span id="vectorstatefn-coeff" />

  ### coeff

  <Attribute id="qiskit.aqua.operators.state_fns.VectorStateFn.coeff" attributeTypeHint="Union[int, float, complex, qiskit.circuit.parameterexpression.ParameterExpression]">
  ...
  <span id="vectorstatefn-is-measurement" />

  ### is\_measurement

  <Attribute id="qiskit.aqua.operators.state_fns.VectorStateFn.is_measurement" attributeTypeHint="bool">
  ...
  <span id="vectorstatefn-num-qubits" />

  ### num\_qubits

  <Attribute id="qiskit.aqua.operators.state_fns.VectorStateFn.num_qubits" attributeTypeHint="int">
  ...
  <span id="vectorstatefn-primitive" />
  ...
  <span id="vectorstatefn-mul" />

  ### \_\_mul\_\_

  <Function id="qiskit.aqua.operators.state_fns.VectorStateFn.__mul__" signature="VectorStateFn.__mul__(other)">
  ...
  <span id="vectorstatefn-assign-parameters" />
  ...
  <span id="vectorstatefn-bind-parameters" />
  ...
  <span id="vectorstatefn-compose" />

  ### compose

  <Function id="qiskit.aqua.operators.state_fns.VectorStateFn.compose" signature="VectorStateFn.compose(other)">
  ...
  <span id="vectorstatefn-primitive-strings" />
  ...
  <span id="vectorstatefn-tensorpower" />
  ...
  <span id="vectorstatefn-to-circuit-op" />
  ...
  <span id="vectorstatefn-to-density-matrix" />
  ...
  <span id="vectorstatefn-to-legacy-op" />
  ...
  <span id="vectorstatefn-to-matrix" />
  ...
  <span id="vectorstatefn-to-matrix-op" />
  ...
  <span id="vectorstatefn-traverse" />
