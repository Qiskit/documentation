...
<Class id="qiskit.aqua.operators.state_fns.VectorStateFn" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.7/qiskit/aqua/operators/state_fns/vector_state_fn.py" signature="VectorStateFn(primitive=None, coeff=1.0, is_measurement=False)">
  ...
  *   **is\_measurement** (`bool`) – Whether the StateFn is a measurement operator
  ...
  <Attribute id="qiskit.aqua.operators.state_fns.VectorStateFn.coeff" signature="Union[int, float, complex, qiskit.circuit.parameterexpression.ParameterExpression]">
  ...
  <Attribute id="qiskit.aqua.operators.state_fns.VectorStateFn.is_measurement" signature="bool">
  ...
  <Attribute id="qiskit.aqua.operators.state_fns.VectorStateFn.num_qubits" signature="int">
