---
title: SPSA (v0.19)
description: API reference for qiskit.aqua.components.optimizers.SPSA in qiskit v0.19
...
<Class id="qiskit.aqua.components.optimizers.SPSA" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.7/qiskit/aqua/components/optimizers/spsa.py" signature="SPSA(max_trials=1000, save_steps=1, last_avg=1, c0=0.6283185307179586, c1=0.1, c2=0.602, c3=0.101, c4=0, skip_calibration=False)" modifiers="class">
  ...
  *   **skip\_calibration** (`float`) – Skip calibration and use provided c(s) as is.
  ...
  <span id="spsa-bounds-support-level" />
  ...
  <span id="spsa-gradient-support-level" />
  ...
  <span id="spsa-initial-point-support-level" />
  ...
  <span id="spsa-is-bounds-ignored" />
  ...
  <span id="spsa-is-bounds-required" />
  ...
  <span id="spsa-is-bounds-supported" />
  ...
  <span id="spsa-is-gradient-ignored" />
  ...
  <span id="spsa-is-gradient-required" />
  ...
  <span id="spsa-is-gradient-supported" />
  ...
  <span id="spsa-is-initial-point-ignored" />
  ...
  <span id="spsa-is-initial-point-required" />
  ...
  <span id="spsa-is-initial-point-supported" />
  ...
  <span id="spsa-get-support-level" />

  ### get\_support\_level

  <Function id="qiskit.aqua.components.optimizers.SPSA.get_support_level" signature="SPSA.get_support_level()">
    return support level dictionary
  </Function>

  <span id="spsa-gradient-num-diff" />

  ### gradient\_num\_diff

  <Function id="qiskit.aqua.components.optimizers.SPSA.gradient_num_diff" signature="SPSA.gradient_num_diff(x_center, f, epsilon, max_evals_grouped=1)" modifiers="static">
  ...
  <span id="spsa-optimize" />

  ### optimize

  <Function id="qiskit.aqua.components.optimizers.SPSA.optimize" signature="SPSA.optimize(num_vars, objective_function, gradient_function=None, variable_bounds=None, initial_point=None)">
  ...
  <span id="spsa-print-options" />

  ### print\_options

  <Function id="qiskit.aqua.components.optimizers.SPSA.print_options" signature="SPSA.print_options()">
    Print algorithm-specific options.
  </Function>

  <span id="spsa-set-max-evals-grouped" />

  ### set\_max\_evals\_grouped

  <Function id="qiskit.aqua.components.optimizers.SPSA.set_max_evals_grouped" signature="SPSA.set_max_evals_grouped(limit)">
    Set max evals grouped
  </Function>

  <span id="spsa-set-options" />

  ### set\_options

  <Function id="qiskit.aqua.components.optimizers.SPSA.set_options" signature="SPSA.set_options(**kwargs)">
  ...
  <span id="spsa-wrap-function" />

  ### wrap\_function

  <Function id="qiskit.aqua.components.optimizers.SPSA.wrap_function" signature="SPSA.wrap_function(function, args)" modifiers="static">
