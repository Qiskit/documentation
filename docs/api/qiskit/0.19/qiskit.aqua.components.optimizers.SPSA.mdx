...
<Class id="qiskit.aqua.components.optimizers.SPSA" github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.7/qiskit/aqua/components/optimizers/spsa.py" signature="SPSA(max_trials=1000, save_steps=1, last_avg=1, c0=0.6283185307179586, c1=0.1, c2=0.602, c3=0.101, c4=0, skip_calibration=False)">
  ...
  *   **skip\_calibration** (`float`) – Skip calibration and use provided c(s) as is.
  ...
  <Function id="qiskit.aqua.components.optimizers.SPSA.gradient_num_diff" signature="static SPSA.gradient_num_diff(x_center, f, epsilon, max_evals_grouped=1)">
  ...
  <Function id="qiskit.aqua.components.optimizers.SPSA.wrap_function" signature="static SPSA.wrap_function(function, args)">
