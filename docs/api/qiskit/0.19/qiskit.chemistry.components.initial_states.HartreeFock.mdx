...
<Class id="qiskit.chemistry.components.initial_states.HartreeFock" github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.7/qiskit/chemistry/components/initial_states/hartree_fock.py" signature="HartreeFock(num_orbitals, num_particles, qubit_mapping='parity', two_qubit_reduction=True, sq_list=None)">
  ...
  *   **ValueError** – wrong setting for computed num\_qubits and supplied num\_qubits.
  ...
  <Attribute id="qiskit.chemistry.components.initial_states.HartreeFock.bitstr" name="bitstr">
  ...
  <Function id="qiskit.chemistry.components.initial_states.HartreeFock.construct_circuit" name="construct_circuit" signature="HartreeFock.construct_circuit(mode='circuit', register=None)">
