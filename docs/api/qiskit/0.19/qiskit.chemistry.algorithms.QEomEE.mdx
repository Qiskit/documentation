...
<Class id="qiskit.chemistry.algorithms.QEomEE" github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.7/qiskit/chemistry/algorithms/eigen_solvers/q_eom_ee.py" signature="QEomEE(operator, num_orbitals, num_particles, qubit_mapping='parity', two_qubit_reduction=True, active_occupied=None, active_unoccupied=None, is_eom_matrix_symmetric=True, se_list=None, de_list=None, z2_symmetries=None, untapered_op=None, aux_operators=None)">
  ...
  **ValueError** – invalid parameter
  ...
  <Attribute id="qiskit.chemistry.algorithms.QEomEE.aux_operators" name="aux_operators" signature="Optional[List[Optional[qiskit.aqua.operators.operator_base.OperatorBase]]]">
  ...
  <Attribute id="qiskit.chemistry.algorithms.QEomEE.operator" name="operator" signature="Optional[qiskit.aqua.operators.operator_base.OperatorBase]">
    Return the operator.
  ...
  <Attribute id="qiskit.chemistry.algorithms.QEomEE.random" name="random">
  ...
  <Function id="qiskit.chemistry.algorithms.QEomEE.compute_minimum_eigenvalue" name="compute_minimum_eigenvalue" signature="QEomEE.compute_minimum_eigenvalue(operator=None, aux_operators=None)">
  ...
  <Function id="qiskit.chemistry.algorithms.QEomEE.run" name="run" signature="QEomEE.run()">
  ...
  <Function id="qiskit.chemistry.algorithms.QEomEE.supports_aux_operators" name="supports_aux_operators" signature="QEomEE.supports_aux_operators()">
