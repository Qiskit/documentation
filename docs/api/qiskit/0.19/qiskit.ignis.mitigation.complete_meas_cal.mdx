---
title: complete_meas_cal (v0.19)
description: API reference for qiskit.ignis.mitigation.complete_meas_cal in qiskit v0.19
in_page_toc_min_heading_level: 1
python_api_type: function
python_api_name: qiskit.ignis.mitigation.complete_meas_cal
---

<span id="complete-meas-cal" />

# complete\_meas\_cal

<Function id="qiskit.ignis.mitigation.complete_meas_cal" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-ignis/tree/stable/0.3/qiskit/ignis/mitigation/measurement/circuits.py" signature="complete_meas_cal(qubit_list=None, qr=None, cr=None, circlabel='')">
