...
<Class id="qiskit.aqua.operators.converters.CircuitSampler" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.7/qiskit/aqua/operators/converters/circuit_sampler.py" signature="CircuitSampler(backend=None, statevector=None, param_qobj=False, attach_results=False)">
  ...
  **ValueError** – Set statevector or param\_qobj True when not supported by backend.
  ...
  <Attribute id="qiskit.aqua.operators.converters.CircuitSampler.backend" name="backend" signature="qiskit.providers.basebackend.BaseBackend">
    Returns the backend.
  ...
  <Attribute id="qiskit.aqua.operators.converters.CircuitSampler.quantum_instance" name="quantum_instance" signature="qiskit.aqua.quantum_instance.QuantumInstance">
  ...
  <Function id="qiskit.aqua.operators.converters.CircuitSampler.convert" name="convert" signature="CircuitSampler.convert(operator, params=None)">
  ...
  <Function id="qiskit.aqua.operators.converters.CircuitSampler.sample_circuits" name="sample_circuits" signature="CircuitSampler.sample_circuits(circuit_sfns=None, param_bindings=None)">
  ...
  <Function id="qiskit.aqua.operators.converters.CircuitSampler.set_backend" name="set_backend" signature="CircuitSampler.set_backend(backend, **kwargs)">
