...
<Class id="qiskit.aqua.operators.converters.CircuitSampler" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.7/qiskit/aqua/operators/converters/circuit_sampler.py" signature="CircuitSampler(backend=None, statevector=None, param_qobj=False, attach_results=False)">
  ...
  **ValueError** – Set statevector or param\_qobj True when not supported by backend.
  ...
  <Attribute id="qiskit.aqua.operators.converters.CircuitSampler.backend" signature="qiskit.providers.basebackend.BaseBackend">
    Returns the backend.
  ...
  <Attribute id="qiskit.aqua.operators.converters.CircuitSampler.quantum_instance" signature="qiskit.aqua.quantum_instance.QuantumInstance">
