---
title: PulseQobjInstruction (v0.19)
description: API reference for qiskit.qobj.PulseQobjInstruction in qiskit v0.19
...
<Class id="qiskit.qobj.PulseQobjInstruction" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.14/qiskit/qobj/pulse_qobj.py" signature="PulseQobjInstruction(name, t0, ch=None, conditional=None, val=None, phase=None, duration=None, qubits=None, memory_slot=None, register_slot=None, kernels=None, discriminators=None, label=None, type=None, pulse_shape=None, parameters=None, frequency=None)" modifiers="class">
  ...
  *   **parameters** (*dict*) – The parameters for a parametric pulse
  ...
  <span id="pulseqobjinstruction-from-dict" />
  ...
  <span id="pulseqobjinstruction-to-dict" />
