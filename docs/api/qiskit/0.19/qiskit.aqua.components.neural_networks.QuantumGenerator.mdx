...
<Class id="qiskit.aqua.components.neural_networks.QuantumGenerator" github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.7/qiskit/aqua/components/neural_networks/quantum_generator.py" signature="QuantumGenerator(bounds, num_qubits, generator_circuit=None, init_params=None, snapshot_dir=None)">
  Quantum Generator.
  ...
  **Raises**
  ...
  <Function id="qiskit.aqua.components.neural_networks.QuantumGenerator.get_output" name="get_output" signature="QuantumGenerator.get_output(quantum_instance, qc_state_in=None, params=None, shots=None)">
