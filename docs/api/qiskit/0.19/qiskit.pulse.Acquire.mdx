...
<Class id="qiskit.pulse.Acquire" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.14/qiskit/pulse/instructions/acquire.py" signature="Acquire(duration, channel=None, mem_slot=None, reg_slots=None, mem_slots=None, reg_slot=None, kernel=None, discriminator=None, name=None)">
  ...
  **Raises**
  ...
  <Attribute id="qiskit.pulse.Acquire.acquire" signature="qiskit.pulse.channels.AcquireChannel">
  ...
  <Attribute id="qiskit.pulse.Acquire.acquires" signature="List[qiskit.pulse.channels.AcquireChannel]">
  ...
  <Attribute id="qiskit.pulse.Acquire.channel" signature="qiskit.pulse.channels.AcquireChannel">
  ...
  <Attribute id="qiskit.pulse.Acquire.channels" signature="Tuple[qiskit.pulse.channels.Channel]">
  ...
  <Attribute id="qiskit.pulse.Acquire.command" signature="qiskit.pulse.commands.command.Command">
  ...
  <Attribute id="qiskit.pulse.Acquire.discriminator" signature="qiskit.pulse.configuration.Discriminator">
  ...
  <Attribute id="qiskit.pulse.Acquire.duration" signature="int">
  ...
  <Attribute id="qiskit.pulse.Acquire.id" signature="int">
  ...
  <Attribute id="qiskit.pulse.Acquire.instructions" signature="Tuple[Tuple[int, qiskit.pulse.instructions.instruction.Instruction]]">
  ...
  <Attribute id="qiskit.pulse.Acquire.kernel" signature="qiskit.pulse.configuration.Kernel">
  ...
  <Attribute id="qiskit.pulse.Acquire.mem_slot" signature="qiskit.pulse.channels.MemorySlot">
  ...
  <Attribute id="qiskit.pulse.Acquire.mem_slots" signature="List[qiskit.pulse.channels.MemorySlot]">
    MemorySlots.
  ...
  <Attribute id="qiskit.pulse.Acquire.name" signature="str">
  ...
  <Attribute id="qiskit.pulse.Acquire.operands" signature="Tuple">
  ...
  <Attribute id="qiskit.pulse.Acquire.reg_slot" signature="qiskit.pulse.channels.RegisterSlot">
  ...
  <Attribute id="qiskit.pulse.Acquire.reg_slots" signature="List[qiskit.pulse.channels.RegisterSlot]">
    RegisterSlots.
  ...
  <Attribute id="qiskit.pulse.Acquire.start_time" signature="int">
  ...
  <Attribute id="qiskit.pulse.Acquire.stop_time" signature="int">
  ...
  <Attribute id="qiskit.pulse.Acquire.timeslots" signature="Dict[qiskit.pulse.channels.Channel, List[Tuple[int, int]]]">
