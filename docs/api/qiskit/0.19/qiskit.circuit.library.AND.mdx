---
title: AND (v0.19)
description: API reference for qiskit.circuit.library.AND in qiskit v0.19
...
<Class id="qiskit.circuit.library.AND" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.14/qiskit/circuit/library/boolean_logic/quantum_and.py" signature="AND(num_variable_qubits, flags=None, mcx_mode='noancilla')" modifiers="class">
  ...
  *   **mcx\_mode** (`str`) – The mode to be used to implement the multi-controlled X gate.
  ...
  <span id="and-instances" />

  ### instances

  <Attribute id="qiskit.circuit.library.AND.instances" attributeValue="8" />

  <span id="and-n-qubits" />

  ### n\_qubits

  <Attribute id="qiskit.circuit.library.AND.n_qubits">
    Deprecated, use `num_qubits` instead. Return number of qubits.
  </Attribute>

  <span id="and-num-clbits" />
  ...
  <Function id="qiskit.circuit.library.AND.AND" signature="AND.AND(qr_variables, qb_target, qr_ancillae, flags=None, mct_mode='no-ancilla')">
  ...
  <Function id="qiskit.circuit.library.AND.OR" signature="AND.OR(qr_variables, qb_target, qr_ancillae, flags=None, mct_mode='basic')">
  ...
  <Function id="qiskit.circuit.library.AND.__getitem__" signature="AND.__getitem__(item)">
  ...
  <Function id="qiskit.circuit.library.AND.__len__" signature="AND.__len__()">
    Return number of operations in circuit.
  </Function>

  <span id="and-add-register" />

  ### add\_register

  <Function id="qiskit.circuit.library.AND.add_register" signature="AND.add_register(*regs)">
    Add registers.
  </Function>
  ...
  <Function id="qiskit.circuit.library.AND.append" signature="AND.append(instruction, qargs=None, cargs=None)">
  ...
  <span id="and-assign-parameters" />

  ### assign\_parameters

  <Function id="qiskit.circuit.library.AND.assign_parameters" signature="AND.assign_parameters(param_dict, inplace=False)">
  ...
  <Function id="qiskit.circuit.library.AND.barrier" signature="AND.barrier(*qargs)">
    Apply `Barrier`. If qargs is None, applies to all.
  </Function>

  <span id="and-bind-parameters" />

  ### bind\_parameters

  <Function id="qiskit.circuit.library.AND.bind_parameters" signature="AND.bind_parameters(value_dict)">
  ...
  <Function id="qiskit.circuit.library.AND.cast" signature="AND.cast(value, _type)" modifiers="static">
    Best effort to cast value to type. Otherwise, returns the value.
  </Function>

  <span id="and-cbit-argument-conversion" />

  ### cbit\_argument\_conversion

  <Function id="qiskit.circuit.library.AND.cbit_argument_conversion" signature="AND.cbit_argument_conversion(clbit_representation)">
  ...
  <Function id="qiskit.circuit.library.AND.ccx" signature="AND.ccx(control_qubit1, control_qubit2, target_qubit, *, ctl1=None, ctl2=None, tgt=None)">
  ...
  <Function id="qiskit.circuit.library.AND.ch" signature="AND.ch(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CHGate`](qiskit.circuit.library.CHGate "qiskit.circuit.library.CHGate").
  </Function>

  <span id="and-cls-instances" />

  ### cls\_instances

  <Function id="qiskit.circuit.library.AND.cls_instances" signature="AND.cls_instances()" modifiers="classmethod">
    Return the current number of instances of this class, useful for auto naming.
  </Function>

  <span id="and-cls-prefix" />

  ### cls\_prefix

  <Function id="qiskit.circuit.library.AND.cls_prefix" signature="AND.cls_prefix()" modifiers="classmethod">
  ...
  <Function id="qiskit.circuit.library.AND.cnot" signature="AND.cnot(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
  ...
  <Function id="qiskit.circuit.library.AND.combine" signature="AND.combine(rhs)">
  ...
  <Function id="qiskit.circuit.library.AND.compose" signature="AND.compose(other, qubits=None, clbits=None, front=False, inplace=False)">
  ...
  <Function id="qiskit.circuit.library.AND.copy" signature="AND.copy(name=None)">
    Copy the circuit.
  ...
  <span id="and-count-ops" />

  ### count\_ops

  <Function id="qiskit.circuit.library.AND.count_ops" signature="AND.count_ops()">
  ...
  <Function id="qiskit.circuit.library.AND.crx" signature="AND.crx(theta, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
  ...
  <Function id="qiskit.circuit.library.AND.cry" signature="AND.cry(theta, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
  ...
  <Function id="qiskit.circuit.library.AND.crz" signature="AND.crz(theta, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
  ...
  <Function id="qiskit.circuit.library.AND.cswap" signature="AND.cswap(control_qubit, target_qubit1, target_qubit2, *, label=None, ctrl_state=None, ctl=None, tgt1=None, tgt2=None)">
  ...
  <Function id="qiskit.circuit.library.AND.cu1" signature="AND.cu1(theta, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
  ...
  <Function id="qiskit.circuit.library.AND.cu3" signature="AND.cu3(theta, phi, lam, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
  ...
  <Function id="qiskit.circuit.library.AND.cx" signature="AND.cx(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CXGate`](qiskit.circuit.library.CXGate "qiskit.circuit.library.CXGate").
  </Function>
  ...
  <Function id="qiskit.circuit.library.AND.cy" signature="AND.cy(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
  ...
  <Function id="qiskit.circuit.library.AND.cz" signature="AND.cz(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
  ...
  <Function id="qiskit.circuit.library.AND.dcx" signature="AND.dcx(qubit1, qubit2)">
    Apply [`DCXGate`](qiskit.circuit.library.DCXGate "qiskit.circuit.library.DCXGate").
  </Function>

  <span id="and-decompose" />

  ### decompose

  <Function id="qiskit.circuit.library.AND.decompose" signature="AND.decompose()">
  ...
  <Function id="qiskit.circuit.library.AND.depth" signature="AND.depth()">
  ...
  <span id="and-diag-gate" />

  ### diag\_gate

  <Function id="qiskit.circuit.library.AND.diag_gate" signature="AND.diag_gate(diag, qubit)">
    Deprecated version of QuantumCircuit.diagonal.
  </Function>

  <span id="and-diagonal" />

  ### diagonal

  <Function id="qiskit.circuit.library.AND.diagonal" signature="AND.diagonal(diag, qubit)">
  ...
  <Function id="qiskit.circuit.library.AND.extend" signature="AND.extend(rhs)">
  ...
  <Function id="qiskit.circuit.library.AND.fredkin" signature="AND.fredkin(control_qubit, target_qubit1, target_qubit2, *, ctl=None, tgt1=None, tgt2=None)">
    Apply [`CSwapGate`](qiskit.circuit.library.CSwapGate "qiskit.circuit.library.CSwapGate").
  </Function>

  <span id="and-from-qasm-file" />

  ### from\_qasm\_file

  <Function id="qiskit.circuit.library.AND.from_qasm_file" signature="AND.from_qasm_file(path)" modifiers="static">
  ...
  <span id="and-from-qasm-str" />

  ### from\_qasm\_str

  <Function id="qiskit.circuit.library.AND.from_qasm_str" signature="AND.from_qasm_str(qasm_str)" modifiers="static">
  ...
  <Function id="qiskit.circuit.library.AND.h" signature="AND.h(qubit, *, q=None)">
    Apply [`HGate`](qiskit.circuit.library.HGate "qiskit.circuit.library.HGate").
  </Function>

  <span id="and-hamiltonian" />

  ### hamiltonian

  <Function id="qiskit.circuit.library.AND.hamiltonian" signature="AND.hamiltonian(operator, time, qubits, label=None)">
    Apply hamiltonian evolution to to qubits.
  </Function>

  <span id="and-has-register" />

  ### has\_register

  <Function id="qiskit.circuit.library.AND.has_register" signature="AND.has_register(register)">
  ...
  <Function id="qiskit.circuit.library.AND.i" signature="AND.i(qubit, *, q=None)">
  ...
  <Function id="qiskit.circuit.library.AND.id" signature="AND.id(qubit, *, q=None)">
    Apply [`IGate`](qiskit.circuit.library.IGate "qiskit.circuit.library.IGate").
  </Function>
  ...
  <Function id="qiskit.circuit.library.AND.iden" signature="AND.iden(qubit, *, q=None)">
    Deprecated identity gate.
  </Function>

  <span id="and-initialize" />

  ### initialize

  <Function id="qiskit.circuit.library.AND.initialize" signature="AND.initialize(params, qubits)">
  ...
  <Function id="qiskit.circuit.library.AND.inverse" signature="AND.inverse()">
    Invert this circuit.
  ...
  <Function id="qiskit.circuit.library.AND.iso" signature="AND.iso(isometry, q_input, q_ancillas_for_output, q_ancillas_zero=None, q_ancillas_dirty=None)">
  ...
  <span id="and-isometry" />

  ### isometry

  <Function id="qiskit.circuit.library.AND.isometry" signature="AND.isometry(isometry, q_input, q_ancillas_for_output, q_ancillas_zero=None, q_ancillas_dirty=None)">
    Attach an arbitrary isometry from m to n qubits to a circuit. In particular, this allows to attach arbitrary unitaries on n qubits (m=n) or to prepare any state on n qubits (m=0). The decomposition used here was introduced by Iten et al. in [https://arxiv.org/abs/1501.06911](https://arxiv.org/abs/1501.06911).
  ...
  <Function id="qiskit.circuit.library.AND.iswap" signature="AND.iswap(qubit1, qubit2)">
  ...
  <Function id="qiskit.circuit.library.AND.mcmt" signature="AND.mcmt(gate, control_qubits, target_qubits, ancilla_qubits=None, mode='no-ancilla', *, single_control_gate_fun=None, q_controls=None, q_ancillae=None, q_targets=None)">
  ...
  <Function id="qiskit.circuit.library.AND.mcrx" signature="AND.mcrx(theta, q_controls, q_target, use_basis_gates=False)">
  ...
  <Function id="qiskit.circuit.library.AND.mcry" signature="AND.mcry(theta, q_controls, q_target, q_ancillae, mode='basic', use_basis_gates=False)">
  ...
  <Function id="qiskit.circuit.library.AND.mcrz" signature="AND.mcrz(lam, q_controls, q_target, use_basis_gates=False)">
  ...
  <Function id="qiskit.circuit.library.AND.mct" signature="AND.mct(control_qubits, target_qubit, ancilla_qubits=None, mode='noancilla')">
    Apply `MCXGate`.
  </Function>
  ...
  <Function id="qiskit.circuit.library.AND.mcu1" signature="AND.mcu1(lam, control_qubits, target_qubit)">
    Apply `MCU1Gate`.
  </Function>
  ...
  <Function id="qiskit.circuit.library.AND.mcx" signature="AND.mcx(control_qubits, target_qubit, ancilla_qubits=None, mode='noancilla')">
    Apply `MCXGate`.
  ...
  <Function id="qiskit.circuit.library.AND.measure" signature="AND.measure(qubit, cbit)">
  ...
  <span id="and-measure-active" />

  ### measure\_active

  <Function id="qiskit.circuit.library.AND.measure_active" signature="AND.measure_active(inplace=True)">
  ...
  <span id="and-measure-all" />

  ### measure\_all

  <Function id="qiskit.circuit.library.AND.measure_all" signature="AND.measure_all(inplace=True)">
  ...
  <Function id="qiskit.circuit.library.AND.mirror" signature="AND.mirror()">
  ...
  <Function id="qiskit.circuit.library.AND.ms" signature="AND.ms(theta, qubits)">
    Apply [`MSGate`](qiskit.circuit.library.MSGate "qiskit.circuit.library.MSGate").
  </Function>

  <span id="and-num-connected-components" />

  ### num\_connected\_components

  <Function id="qiskit.circuit.library.AND.num_connected_components" signature="AND.num_connected_components(unitary_only=False)">
  ...
  <span id="and-num-nonlocal-gates" />

  ### num\_nonlocal\_gates

  <Function id="qiskit.circuit.library.AND.num_nonlocal_gates" signature="AND.num_nonlocal_gates()">
    Return number of non-local gates (i.e. involving 2+ qubits).

    Conditional nonlocal gates are also included.
  </Function>

  <span id="and-num-tensor-factors" />

  ### num\_tensor\_factors

  <Function id="qiskit.circuit.library.AND.num_tensor_factors" signature="AND.num_tensor_factors()">
  ...
  <span id="and-num-unitary-factors" />

  ### num\_unitary\_factors

  <Function id="qiskit.circuit.library.AND.num_unitary_factors" signature="AND.num_unitary_factors()">
    Computes the number of tensor factors in the unitary (quantum) part of the circuit only.
  </Function>
  ...
  <Function id="qiskit.circuit.library.AND.qasm" signature="AND.qasm(formatted=False, filename=None)">
  ...
  <span id="and-qbit-argument-conversion" />

  ### qbit\_argument\_conversion

  <Function id="qiskit.circuit.library.AND.qbit_argument_conversion" signature="AND.qbit_argument_conversion(qubit_representation)">
  ...
  <Function id="qiskit.circuit.library.AND.r" signature="AND.r(theta, phi, qubit, *, q=None)">
    Apply `RGate`.
  </Function>
  ...
  <Function id="qiskit.circuit.library.AND.rcccx" signature="AND.rcccx(control_qubit1, control_qubit2, control_qubit3, target_qubit)">
  ...
  <Function id="qiskit.circuit.library.AND.rccx" signature="AND.rccx(control_qubit1, control_qubit2, target_qubit)">
    Apply [`RCCXGate`](qiskit.circuit.library.RCCXGate "qiskit.circuit.library.RCCXGate").
  </Function>

  <span id="and-remove-final-measurements" />

  ### remove\_final\_measurements

  <Function id="qiskit.circuit.library.AND.remove_final_measurements" signature="AND.remove_final_measurements(inplace=True)">
  ...
  <Function id="qiskit.circuit.library.AND.reset" signature="AND.reset(qubit)">
    Reset q.
  </Function>
  ...
  <Function id="qiskit.circuit.library.AND.rx" signature="AND.rx(theta, qubit, *, label=None, q=None)">
  ...
  <Function id="qiskit.circuit.library.AND.rxx" signature="AND.rxx(theta, qubit1, qubit2)">
  ...
  <Function id="qiskit.circuit.library.AND.ry" signature="AND.ry(theta, qubit, *, label=None, q=None)">
  ...
  <Function id="qiskit.circuit.library.AND.ryy" signature="AND.ryy(theta, qubit1, qubit2)">
  ...
  <Function id="qiskit.circuit.library.AND.rz" signature="AND.rz(phi, qubit, *, q=None)">
  ...
  <Function id="qiskit.circuit.library.AND.rzx" signature="AND.rzx(theta, qubit1, qubit2)">
  ...
  <Function id="qiskit.circuit.library.AND.rzz" signature="AND.rzz(theta, qubit1, qubit2)">
  ...
  <Function id="qiskit.circuit.library.AND.s" signature="AND.s(qubit, *, q=None)">
  ...
  <Function id="qiskit.circuit.library.AND.sdg" signature="AND.sdg(qubit, *, q=None)">
  ...
  <Function id="qiskit.circuit.library.AND.size" signature="AND.size()">
  ...
  <span id="and-snapshot" />

  ### snapshot

  <Function id="qiskit.circuit.library.AND.snapshot" signature="AND.snapshot(label, snapshot_type='statevector', qubits=None, params=None)">
  ...
  <span id="and-snapshot-density-matrix" />

  ### snapshot\_density\_matrix

  <Function id="qiskit.circuit.library.AND.snapshot_density_matrix" signature="AND.snapshot_density_matrix(label, qubits=None)">
  ...
  <span id="and-snapshot-expectation-value" />

  ### snapshot\_expectation\_value

  <Function id="qiskit.circuit.library.AND.snapshot_expectation_value" signature="AND.snapshot_expectation_value(label, op, qubits, single_shot=False, variance=False)">
  ...
  <span id="and-snapshot-probabilities" />

  ### snapshot\_probabilities

  <Function id="qiskit.circuit.library.AND.snapshot_probabilities" signature="AND.snapshot_probabilities(label, qubits, variance=False)">
  ...
  <span id="and-snapshot-stabilizer" />

  ### snapshot\_stabilizer

  <Function id="qiskit.circuit.library.AND.snapshot_stabilizer" signature="AND.snapshot_stabilizer(label)">
  ...
  <span id="and-snapshot-statevector" />

  ### snapshot\_statevector

  <Function id="qiskit.circuit.library.AND.snapshot_statevector" signature="AND.snapshot_statevector(label)">
  ...
  <Function id="qiskit.circuit.library.AND.squ" signature="AND.squ(unitary_matrix, qubit, mode='ZYZ', up_to_diagonal=False, *, u=None)">
  ...
  <Function id="qiskit.circuit.library.AND.swap" signature="AND.swap(qubit1, qubit2)">
  ...
  <Function id="qiskit.circuit.library.AND.t" signature="AND.t(qubit, *, q=None)">
  ...
  <Function id="qiskit.circuit.library.AND.tdg" signature="AND.tdg(qubit, *, q=None)">
  ...
  <Function id="qiskit.circuit.library.AND.to_gate" signature="AND.to_gate(parameter_map=None)">
  ...
  <span id="and-to-instruction" />

  ### to\_instruction

  <Function id="qiskit.circuit.library.AND.to_instruction" signature="AND.to_instruction(parameter_map=None)">
  ...
  <Function id="qiskit.circuit.library.AND.toffoli" signature="AND.toffoli(control_qubit1, control_qubit2, target_qubit, *, ctl1=None, ctl2=None, tgt=None)">
    Apply [`CCXGate`](qiskit.circuit.library.CCXGate "qiskit.circuit.library.CCXGate").
  </Function>
  ...
  <Function id="qiskit.circuit.library.AND.u1" signature="AND.u1(theta, qubit, *, q=None)">
  ...
  <Function id="qiskit.circuit.library.AND.u2" signature="AND.u2(phi, lam, qubit, *, q=None)">
  ...
  <Function id="qiskit.circuit.library.AND.u3" signature="AND.u3(theta, phi, lam, qubit, *, q=None)">
  ...
  <Function id="qiskit.circuit.library.AND.uc" signature="AND.uc(gate_list, q_controls, q_target, up_to_diagonal=False)">
  ...
  <Function id="qiskit.circuit.library.AND.ucg" signature="AND.ucg(angle_list, q_controls, q_target, up_to_diagonal=False)">
  ...
  <Function id="qiskit.circuit.library.AND.ucrx" signature="AND.ucrx(angle_list, q_controls, q_target)">
  ...
  <Function id="qiskit.circuit.library.AND.ucry" signature="AND.ucry(angle_list, q_controls, q_target)">
  ...
  <Function id="qiskit.circuit.library.AND.ucrz" signature="AND.ucrz(angle_list, q_controls, q_target)">
  ...
  <Function id="qiskit.circuit.library.AND.ucx" signature="AND.ucx(angle_list, q_controls, q_target)">
  ...
  <Function id="qiskit.circuit.library.AND.ucy" signature="AND.ucy(angle_list, q_controls, q_target)">
  ...
  <Function id="qiskit.circuit.library.AND.ucz" signature="AND.ucz(angle_list, q_controls, q_target)">
  ...
  <Function id="qiskit.circuit.library.AND.unitary" signature="AND.unitary(obj, qubits, label=None)">
  ...
  <Function id="qiskit.circuit.library.AND.width" signature="AND.width()">
  ...
  <Function id="qiskit.circuit.library.AND.x" signature="AND.x(qubit, *, label=None, ctrl_state=None, q=None)">
  ...
  <Function id="qiskit.circuit.library.AND.y" signature="AND.y(qubit, *, q=None)">
  ...
  <Function id="qiskit.circuit.library.AND.z" signature="AND.z(qubit, *, q=None)">
