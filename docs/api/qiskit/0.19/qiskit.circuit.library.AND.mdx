...
<Class id="qiskit.circuit.library.AND" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.14/qiskit/circuit/library/boolean_logic/quantum_and.py" signature="AND(num_variable_qubits, flags=None, mcx_mode='noancilla')">
  ...
  *   **mcx\_mode** (`str`) – The mode to be used to implement the multi-controlled X gate.
  ...
  <Function id="qiskit.circuit.library.AND.cast" signature="static AND.cast(value, _type)">
  ...
  <Function id="qiskit.circuit.library.AND.cls_instances" signature="classmethod AND.cls_instances()">
    Return the current number of instances of this class, useful for auto naming.
  </Function>

  ### cls\_prefix

  <Function id="qiskit.circuit.library.AND.cls_prefix" signature="classmethod AND.cls_prefix()">
  ...
  <Function id="qiskit.circuit.library.AND.from_qasm_file" signature="static AND.from_qasm_file(path)">
  ...
  <Function id="qiskit.circuit.library.AND.from_qasm_str" signature="static AND.from_qasm_str(qasm_str)">
