...
<Class id="qiskit.circuit.library.AND" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.14/qiskit/circuit/library/boolean_logic/quantum_and.py" signature="AND(num_variable_qubits, flags=None, mcx_mode='noancilla')">
  ...
  *   **mcx\_mode** (`str`) – The mode to be used to implement the multi-controlled X gate.
  ...
  <Attribute id="qiskit.circuit.library.AND.extension_lib" signature="= 'include \&#x22;qelib1.inc\&#x22;;'" />

  ### header

  <Attribute id="qiskit.circuit.library.AND.header" signature="= 'OPENQASM 2.0;'" />

  ### instances

  <Attribute id="qiskit.circuit.library.AND.instances" signature="= 8" />

  ### n\_qubits

  <Attribute id="qiskit.circuit.library.AND.n_qubits" name="n_qubits">
  ...
  <Attribute id="qiskit.circuit.library.AND.prefix" signature="= 'circuit'" />
  ...
  <Function id="qiskit.circuit.library.AND.AND" name="AND" signature="AND.AND(qr_variables, qb_target, qr_ancillae, flags=None, mct_mode='no-ancilla')">
  ...
  <Function id="qiskit.circuit.library.AND.OR" name="OR" signature="AND.OR(qr_variables, qb_target, qr_ancillae, flags=None, mct_mode='basic')">
  ...
  <Function id="qiskit.circuit.library.AND.__getitem__" name="__getitem__" signature="AND.__getitem__(item)">
    Return indexed operation.
  </Function>

  ### \_\_len\_\_

  <Function id="qiskit.circuit.library.AND.__len__" name="__len__" signature="AND.__len__()">
    Return number of operations in circuit.
  </Function>

  ### add\_register

  <Function id="qiskit.circuit.library.AND.add_register" name="add_register" signature="AND.add_register(*regs)">
    Add registers.
  </Function>

  ### append

  <Function id="qiskit.circuit.library.AND.append" name="append" signature="AND.append(instruction, qargs=None, cargs=None)">
  ...
  <Function id="qiskit.circuit.library.AND.assign_parameters" name="assign_parameters" signature="AND.assign_parameters(param_dict, inplace=False)">
  ...
  <Function id="qiskit.circuit.library.AND.barrier" name="barrier" signature="AND.barrier(*qargs)">
    Apply `Barrier`. If qargs is None, applies to all.
  </Function>

  ### bind\_parameters

  <Function id="qiskit.circuit.library.AND.bind_parameters" name="bind_parameters" signature="AND.bind_parameters(value_dict)">
  ...
  <Function id="qiskit.circuit.library.AND.cast" name="cast" signature="static AND.cast(value, _type)">
    Best effort to cast value to type. Otherwise, returns the value.
  </Function>

  ### cbit\_argument\_conversion

  <Function id="qiskit.circuit.library.AND.cbit_argument_conversion" name="cbit_argument_conversion" signature="AND.cbit_argument_conversion(clbit_representation)">
  ...
  <Function id="qiskit.circuit.library.AND.ccx" name="ccx" signature="AND.ccx(control_qubit1, control_qubit2, target_qubit, *, ctl1=None, ctl2=None, tgt=None)">
    Apply [`CCXGate`](qiskit.circuit.library.CCXGate "qiskit.circuit.library.CCXGate").
  </Function>

  ### ch

  <Function id="qiskit.circuit.library.AND.ch" name="ch" signature="AND.ch(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CHGate`](qiskit.circuit.library.CHGate "qiskit.circuit.library.CHGate").
  </Function>

  ### cls\_instances

  <Function id="qiskit.circuit.library.AND.cls_instances" name="cls_instances" signature="classmethod AND.cls_instances()">
    Return the current number of instances of this class, useful for auto naming.
  </Function>

  ### cls\_prefix

  <Function id="qiskit.circuit.library.AND.cls_prefix" name="cls_prefix" signature="classmethod AND.cls_prefix()">
    Return the prefix to use for auto naming.
  </Function>

  ### cnot

  <Function id="qiskit.circuit.library.AND.cnot" name="cnot" signature="AND.cnot(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CXGate`](qiskit.circuit.library.CXGate "qiskit.circuit.library.CXGate").
  </Function>

  ### combine

  <Function id="qiskit.circuit.library.AND.combine" name="combine" signature="AND.combine(rhs)">
  ...
  <Function id="qiskit.circuit.library.AND.compose" name="compose" signature="AND.compose(other, qubits=None, clbits=None, front=False, inplace=False)">
  ...
  <Function id="qiskit.circuit.library.AND.copy" name="copy" signature="AND.copy(name=None)">
    Copy the circuit.
  ...
  <Function id="qiskit.circuit.library.AND.count_ops" name="count_ops" signature="AND.count_ops()">
  ...
  <Function id="qiskit.circuit.library.AND.crx" name="crx" signature="AND.crx(theta, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CRXGate`](qiskit.circuit.library.CRXGate "qiskit.circuit.library.CRXGate").
  </Function>

  ### cry

  <Function id="qiskit.circuit.library.AND.cry" name="cry" signature="AND.cry(theta, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CRYGate`](qiskit.circuit.library.CRYGate "qiskit.circuit.library.CRYGate").
  </Function>

  ### crz

  <Function id="qiskit.circuit.library.AND.crz" name="crz" signature="AND.crz(theta, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CRZGate`](qiskit.circuit.library.CRZGate "qiskit.circuit.library.CRZGate").
  </Function>

  ### cswap

  <Function id="qiskit.circuit.library.AND.cswap" name="cswap" signature="AND.cswap(control_qubit, target_qubit1, target_qubit2, *, label=None, ctrl_state=None, ctl=None, tgt1=None, tgt2=None)">
    Apply [`CSwapGate`](qiskit.circuit.library.CSwapGate "qiskit.circuit.library.CSwapGate").
  </Function>

  ### cu1

  <Function id="qiskit.circuit.library.AND.cu1" name="cu1" signature="AND.cu1(theta, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CU1Gate`](qiskit.circuit.library.CU1Gate "qiskit.circuit.library.CU1Gate").
  </Function>

  ### cu3

  <Function id="qiskit.circuit.library.AND.cu3" name="cu3" signature="AND.cu3(theta, phi, lam, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CU3Gate`](qiskit.circuit.library.CU3Gate "qiskit.circuit.library.CU3Gate").
  </Function>

  ### cx

  <Function id="qiskit.circuit.library.AND.cx" name="cx" signature="AND.cx(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CXGate`](qiskit.circuit.library.CXGate "qiskit.circuit.library.CXGate").
  </Function>

  ### cy

  <Function id="qiskit.circuit.library.AND.cy" name="cy" signature="AND.cy(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CYGate`](qiskit.circuit.library.CYGate "qiskit.circuit.library.CYGate").
  </Function>

  ### cz

  <Function id="qiskit.circuit.library.AND.cz" name="cz" signature="AND.cz(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CZGate`](qiskit.circuit.library.CZGate "qiskit.circuit.library.CZGate").
  </Function>

  ### dcx

  <Function id="qiskit.circuit.library.AND.dcx" name="dcx" signature="AND.dcx(qubit1, qubit2)">
    Apply [`DCXGate`](qiskit.circuit.library.DCXGate "qiskit.circuit.library.DCXGate").
  </Function>

  ### decompose

  <Function id="qiskit.circuit.library.AND.decompose" name="decompose" signature="AND.decompose()">
  ...
  <Function id="qiskit.circuit.library.AND.depth" name="depth" signature="AND.depth()">
  ...
  <Function id="qiskit.circuit.library.AND.diag_gate" name="diag_gate" signature="AND.diag_gate(diag, qubit)">
    Deprecated version of QuantumCircuit.diagonal.
  </Function>

  ### diagonal

  <Function id="qiskit.circuit.library.AND.diagonal" name="diagonal" signature="AND.diagonal(diag, qubit)">
  ...
  <Function id="qiskit.circuit.library.AND.extend" name="extend" signature="AND.extend(rhs)">
  ...
  <Function id="qiskit.circuit.library.AND.fredkin" name="fredkin" signature="AND.fredkin(control_qubit, target_qubit1, target_qubit2, *, ctl=None, tgt1=None, tgt2=None)">
    Apply [`CSwapGate`](qiskit.circuit.library.CSwapGate "qiskit.circuit.library.CSwapGate").
  </Function>

  ### from\_qasm\_file

  <Function id="qiskit.circuit.library.AND.from_qasm_file" name="from_qasm_file" signature="static AND.from_qasm_file(path)">
  ...
  <Function id="qiskit.circuit.library.AND.from_qasm_str" name="from_qasm_str" signature="static AND.from_qasm_str(qasm_str)">
  ...
  <Function id="qiskit.circuit.library.AND.h" name="h" signature="AND.h(qubit, *, q=None)">
    Apply [`HGate`](qiskit.circuit.library.HGate "qiskit.circuit.library.HGate").
  </Function>

  ### hamiltonian

  <Function id="qiskit.circuit.library.AND.hamiltonian" name="hamiltonian" signature="AND.hamiltonian(operator, time, qubits, label=None)">
    Apply hamiltonian evolution to to qubits.
  </Function>

  ### has\_register

  <Function id="qiskit.circuit.library.AND.has_register" name="has_register" signature="AND.has_register(register)">
  ...
  <Function id="qiskit.circuit.library.AND.i" name="i" signature="AND.i(qubit, *, q=None)">
    Apply [`IGate`](qiskit.circuit.library.IGate "qiskit.circuit.library.IGate").
  </Function>

  ### id

  <Function id="qiskit.circuit.library.AND.id" name="id" signature="AND.id(qubit, *, q=None)">
    Apply [`IGate`](qiskit.circuit.library.IGate "qiskit.circuit.library.IGate").
  </Function>

  ### iden

  <Function id="qiskit.circuit.library.AND.iden" name="iden" signature="AND.iden(qubit, *, q=None)">
    Deprecated identity gate.
  </Function>

  ### initialize

  <Function id="qiskit.circuit.library.AND.initialize" name="initialize" signature="AND.initialize(params, qubits)">
    Apply initialize to circuit.
  </Function>

  ### inverse

  <Function id="qiskit.circuit.library.AND.inverse" name="inverse" signature="AND.inverse()">
    Invert this circuit.
  ...
  <Function id="qiskit.circuit.library.AND.iso" name="iso" signature="AND.iso(isometry, q_input, q_ancillas_for_output, q_ancillas_zero=None, q_ancillas_dirty=None)">
  ...
  <Function id="qiskit.circuit.library.AND.isometry" name="isometry" signature="AND.isometry(isometry, q_input, q_ancillas_for_output, q_ancillas_zero=None, q_ancillas_dirty=None)">
    Attach an arbitrary isometry from m to n qubits to a circuit. In particular, this allows to attach arbitrary unitaries on n qubits (m=n) or to prepare any state on n qubits (m=0). The decomposition used here was introduced by Iten et al. in [https://arxiv.org/abs/1501.06911](https://arxiv.org/abs/1501.06911).
  ...
  <Function id="qiskit.circuit.library.AND.iswap" name="iswap" signature="AND.iswap(qubit1, qubit2)">
    Apply [`iSwapGate`](qiskit.circuit.library.iSwapGate "qiskit.circuit.library.iSwapGate").
  </Function>

  ### mcmt

  <Function id="qiskit.circuit.library.AND.mcmt" name="mcmt" signature="AND.mcmt(gate, control_qubits, target_qubits, ancilla_qubits=None, mode='no-ancilla', *, single_control_gate_fun=None, q_controls=None, q_ancillae=None, q_targets=None)">
  ...
  <Function id="qiskit.circuit.library.AND.mcrx" name="mcrx" signature="AND.mcrx(theta, q_controls, q_target, use_basis_gates=False)">
  ...
  <Function id="qiskit.circuit.library.AND.mcry" name="mcry" signature="AND.mcry(theta, q_controls, q_target, q_ancillae, mode='basic', use_basis_gates=False)">
  ...
  <Function id="qiskit.circuit.library.AND.mcrz" name="mcrz" signature="AND.mcrz(lam, q_controls, q_target, use_basis_gates=False)">
  ...
  <Function id="qiskit.circuit.library.AND.mct" name="mct" signature="AND.mct(control_qubits, target_qubit, ancilla_qubits=None, mode='noancilla')">
    Apply `MCXGate`.
  </Function>

  ### mcu1

  <Function id="qiskit.circuit.library.AND.mcu1" name="mcu1" signature="AND.mcu1(lam, control_qubits, target_qubit)">
    Apply `MCU1Gate`.
  </Function>

  ### mcx

  <Function id="qiskit.circuit.library.AND.mcx" name="mcx" signature="AND.mcx(control_qubits, target_qubit, ancilla_qubits=None, mode='noancilla')">
    Apply `MCXGate`.
  ...
  <Function id="qiskit.circuit.library.AND.measure" name="measure" signature="AND.measure(qubit, cbit)">
  ...
  <Function id="qiskit.circuit.library.AND.measure_active" name="measure_active" signature="AND.measure_active(inplace=True)">
  ...
  <Function id="qiskit.circuit.library.AND.measure_all" name="measure_all" signature="AND.measure_all(inplace=True)">
  ...
  <Function id="qiskit.circuit.library.AND.mirror" name="mirror" signature="AND.mirror()">
  ...
  <Function id="qiskit.circuit.library.AND.ms" name="ms" signature="AND.ms(theta, qubits)">
    Apply [`MSGate`](qiskit.circuit.library.MSGate "qiskit.circuit.library.MSGate").
  </Function>

  ### num\_connected\_components

  <Function id="qiskit.circuit.library.AND.num_connected_components" name="num_connected_components" signature="AND.num_connected_components(unitary_only=False)">
  ...
  <Function id="qiskit.circuit.library.AND.num_nonlocal_gates" name="num_nonlocal_gates" signature="AND.num_nonlocal_gates()">
  ...
  <Function id="qiskit.circuit.library.AND.num_tensor_factors" name="num_tensor_factors" signature="AND.num_tensor_factors()">
  ...
  <Function id="qiskit.circuit.library.AND.num_unitary_factors" name="num_unitary_factors" signature="AND.num_unitary_factors()">
    Computes the number of tensor factors in the unitary (quantum) part of the circuit only.
  </Function>

  ### qasm

  <Function id="qiskit.circuit.library.AND.qasm" name="qasm" signature="AND.qasm(formatted=False, filename=None)">
  ...
  <Function id="qiskit.circuit.library.AND.qbit_argument_conversion" name="qbit_argument_conversion" signature="AND.qbit_argument_conversion(qubit_representation)">
  ...
  <Function id="qiskit.circuit.library.AND.r" name="r" signature="AND.r(theta, phi, qubit, *, q=None)">
    Apply `RGate`.
  </Function>

  ### rcccx

  <Function id="qiskit.circuit.library.AND.rcccx" name="rcccx" signature="AND.rcccx(control_qubit1, control_qubit2, control_qubit3, target_qubit)">
    Apply [`RC3XGate`](qiskit.circuit.library.RC3XGate "qiskit.circuit.library.RC3XGate").
  </Function>

  ### rccx

  <Function id="qiskit.circuit.library.AND.rccx" name="rccx" signature="AND.rccx(control_qubit1, control_qubit2, target_qubit)">
    Apply [`RCCXGate`](qiskit.circuit.library.RCCXGate "qiskit.circuit.library.RCCXGate").
  </Function>

  ### remove\_final\_measurements

  <Function id="qiskit.circuit.library.AND.remove_final_measurements" name="remove_final_measurements" signature="AND.remove_final_measurements(inplace=True)">
  ...
  <Function id="qiskit.circuit.library.AND.reset" name="reset" signature="AND.reset(qubit)">
    Reset q.
  </Function>

  ### rx

  <Function id="qiskit.circuit.library.AND.rx" name="rx" signature="AND.rx(theta, qubit, *, label=None, q=None)">
    Apply [`RXGate`](qiskit.circuit.library.RXGate "qiskit.circuit.library.RXGate").
  </Function>

  ### rxx

  <Function id="qiskit.circuit.library.AND.rxx" name="rxx" signature="AND.rxx(theta, qubit1, qubit2)">
    Apply [`RXXGate`](qiskit.circuit.library.RXXGate "qiskit.circuit.library.RXXGate").
  </Function>

  ### ry

  <Function id="qiskit.circuit.library.AND.ry" name="ry" signature="AND.ry(theta, qubit, *, label=None, q=None)">
    Apply [`RYGate`](qiskit.circuit.library.RYGate "qiskit.circuit.library.RYGate").
  </Function>

  ### ryy

  <Function id="qiskit.circuit.library.AND.ryy" name="ryy" signature="AND.ryy(theta, qubit1, qubit2)">
    Apply [`RYYGate`](qiskit.circuit.library.RYYGate "qiskit.circuit.library.RYYGate").
  </Function>

  ### rz

  <Function id="qiskit.circuit.library.AND.rz" name="rz" signature="AND.rz(phi, qubit, *, q=None)">
    Apply [`RZGate`](qiskit.circuit.library.RZGate "qiskit.circuit.library.RZGate").
  </Function>

  ### rzx

  <Function id="qiskit.circuit.library.AND.rzx" name="rzx" signature="AND.rzx(theta, qubit1, qubit2)">
    Apply [`RZXGate`](qiskit.circuit.library.RZXGate "qiskit.circuit.library.RZXGate").
  </Function>

  ### rzz

  <Function id="qiskit.circuit.library.AND.rzz" name="rzz" signature="AND.rzz(theta, qubit1, qubit2)">
    Apply [`RZZGate`](qiskit.circuit.library.RZZGate "qiskit.circuit.library.RZZGate").
  </Function>

  ### s

  <Function id="qiskit.circuit.library.AND.s" name="s" signature="AND.s(qubit, *, q=None)">
    Apply [`SGate`](qiskit.circuit.library.SGate "qiskit.circuit.library.SGate").
  </Function>

  ### sdg

  <Function id="qiskit.circuit.library.AND.sdg" name="sdg" signature="AND.sdg(qubit, *, q=None)">
    Apply [`SdgGate`](qiskit.circuit.library.SdgGate "qiskit.circuit.library.SdgGate").
  </Function>

  ### size

  <Function id="qiskit.circuit.library.AND.size" name="size" signature="AND.size()">
  ...
  <Function id="qiskit.circuit.library.AND.snapshot" name="snapshot" signature="AND.snapshot(label, snapshot_type='statevector', qubits=None, params=None)">
  ...
  <Function id="qiskit.circuit.library.AND.snapshot_density_matrix" name="snapshot_density_matrix" signature="AND.snapshot_density_matrix(label, qubits=None)">
  ...
  <Function id="qiskit.circuit.library.AND.snapshot_expectation_value" name="snapshot_expectation_value" signature="AND.snapshot_expectation_value(label, op, qubits, single_shot=False, variance=False)">
  ...
  <Function id="qiskit.circuit.library.AND.snapshot_probabilities" name="snapshot_probabilities" signature="AND.snapshot_probabilities(label, qubits, variance=False)">
  ...
  <Function id="qiskit.circuit.library.AND.snapshot_stabilizer" name="snapshot_stabilizer" signature="AND.snapshot_stabilizer(label)">
  ...
  <Function id="qiskit.circuit.library.AND.snapshot_statevector" name="snapshot_statevector" signature="AND.snapshot_statevector(label)">
  ...
  <Function id="qiskit.circuit.library.AND.squ" name="squ" signature="AND.squ(unitary_matrix, qubit, mode='ZYZ', up_to_diagonal=False, *, u=None)">
  ...
  <Function id="qiskit.circuit.library.AND.swap" name="swap" signature="AND.swap(qubit1, qubit2)">
    Apply [`SwapGate`](qiskit.circuit.library.SwapGate "qiskit.circuit.library.SwapGate").
  </Function>

  ### t

  <Function id="qiskit.circuit.library.AND.t" name="t" signature="AND.t(qubit, *, q=None)">
    Apply [`TGate`](qiskit.circuit.library.TGate "qiskit.circuit.library.TGate").
  </Function>

  ### tdg

  <Function id="qiskit.circuit.library.AND.tdg" name="tdg" signature="AND.tdg(qubit, *, q=None)">
    Apply [`TdgGate`](qiskit.circuit.library.TdgGate "qiskit.circuit.library.TdgGate").
  </Function>

  ### to\_gate

  <Function id="qiskit.circuit.library.AND.to_gate" name="to_gate" signature="AND.to_gate(parameter_map=None)">
  ...
  <Function id="qiskit.circuit.library.AND.to_instruction" name="to_instruction" signature="AND.to_instruction(parameter_map=None)">
  ...
  <Function id="qiskit.circuit.library.AND.toffoli" name="toffoli" signature="AND.toffoli(control_qubit1, control_qubit2, target_qubit, *, ctl1=None, ctl2=None, tgt=None)">
    Apply [`CCXGate`](qiskit.circuit.library.CCXGate "qiskit.circuit.library.CCXGate").
  </Function>

  ### u1

  <Function id="qiskit.circuit.library.AND.u1" name="u1" signature="AND.u1(theta, qubit, *, q=None)">
    Apply [`U1Gate`](qiskit.circuit.library.U1Gate "qiskit.circuit.library.U1Gate").
  </Function>

  ### u2

  <Function id="qiskit.circuit.library.AND.u2" name="u2" signature="AND.u2(phi, lam, qubit, *, q=None)">
    Apply [`U2Gate`](qiskit.circuit.library.U2Gate "qiskit.circuit.library.U2Gate").
  </Function>

  ### u3

  <Function id="qiskit.circuit.library.AND.u3" name="u3" signature="AND.u3(theta, phi, lam, qubit, *, q=None)">
    Apply [`U3Gate`](qiskit.circuit.library.U3Gate "qiskit.circuit.library.U3Gate").
  </Function>

  ### uc

  <Function id="qiskit.circuit.library.AND.uc" name="uc" signature="AND.uc(gate_list, q_controls, q_target, up_to_diagonal=False)">
  ...
  <Function id="qiskit.circuit.library.AND.ucg" name="ucg" signature="AND.ucg(angle_list, q_controls, q_target, up_to_diagonal=False)">
    Deprecated version of uc.
  </Function>

  ### ucrx

  <Function id="qiskit.circuit.library.AND.ucrx" name="ucrx" signature="AND.ucrx(angle_list, q_controls, q_target)">
  ...
  <Function id="qiskit.circuit.library.AND.ucry" name="ucry" signature="AND.ucry(angle_list, q_controls, q_target)">
  ...
  <Function id="qiskit.circuit.library.AND.ucrz" name="ucrz" signature="AND.ucrz(angle_list, q_controls, q_target)">
  ...
  <Function id="qiskit.circuit.library.AND.ucx" name="ucx" signature="AND.ucx(angle_list, q_controls, q_target)">
    Deprecated version of ucrx.
  </Function>

  ### ucy

  <Function id="qiskit.circuit.library.AND.ucy" name="ucy" signature="AND.ucy(angle_list, q_controls, q_target)">
    Deprecated version of ucry.
  </Function>

  ### ucz

  <Function id="qiskit.circuit.library.AND.ucz" name="ucz" signature="AND.ucz(angle_list, q_controls, q_target)">
    Deprecated version of ucrz.
  </Function>

  ### unitary

  <Function id="qiskit.circuit.library.AND.unitary" name="unitary" signature="AND.unitary(obj, qubits, label=None)">
    Apply unitary gate to q.
  </Function>

  ### width

  <Function id="qiskit.circuit.library.AND.width" name="width" signature="AND.width()">
  ...
  <Function id="qiskit.circuit.library.AND.x" name="x" signature="AND.x(qubit, *, label=None, ctrl_state=None, q=None)">
    Apply [`XGate`](qiskit.circuit.library.XGate "qiskit.circuit.library.XGate").
  </Function>

  ### y

  <Function id="qiskit.circuit.library.AND.y" name="y" signature="AND.y(qubit, *, q=None)">
    Apply [`YGate`](qiskit.circuit.library.YGate "qiskit.circuit.library.YGate").
  </Function>

  ### z

  <Function id="qiskit.circuit.library.AND.z" name="z" signature="AND.z(qubit, *, q=None)">
