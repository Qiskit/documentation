---
title: SummedOp (v0.19)
description: API reference for qiskit.aqua.operators.list_ops.SummedOp in qiskit v0.19
...
<Class id="qiskit.aqua.operators.list_ops.SummedOp" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.7/qiskit/aqua/operators/list_ops/summed_op.py" signature="SummedOp(oplist, coeff=1.0, abelian=False)" modifiers="class">
  ...
  *   **abelian** (`bool`) – Indicates whether the Operators in `oplist` are known to mutually commute.
  ...
  <span id="summedop-abelian" />

  ### abelian

  <Attribute id="qiskit.aqua.operators.list_ops.SummedOp.abelian" attributeTypeHint="bool">
  ...
  <span id="summedop-coeff" />

  ### coeff

  <Attribute id="qiskit.aqua.operators.list_ops.SummedOp.coeff" attributeTypeHint="Union[int, float, complex, qiskit.circuit.parameterexpression.ParameterExpression]">
  ...
  <span id="summedop-combo-fn" />

  ### combo\_fn

  <Attribute id="qiskit.aqua.operators.list_ops.SummedOp.combo_fn" attributeTypeHint="Callable">
  ...
  <span id="summedop-distributive" />

  ### distributive

  <Attribute id="qiskit.aqua.operators.list_ops.SummedOp.distributive" attributeTypeHint="bool">
  ...
  <span id="summedop-num-qubits" />

  ### num\_qubits

  <Attribute id="qiskit.aqua.operators.list_ops.SummedOp.num_qubits" attributeTypeHint="int">
  ...
  <span id="summedop-oplist" />

  ### oplist

  <Attribute id="qiskit.aqua.operators.list_ops.SummedOp.oplist" attributeTypeHint="List[qiskit.aqua.operators.operator_base.OperatorBase]">
  ...
  <span id="summedop-getitem" />

  ### \_\_getitem\_\_

  <Function id="qiskit.aqua.operators.list_ops.SummedOp.__getitem__" signature="SummedOp.__getitem__(offset)">
  ...
  <span id="summedop-len" />

  ### \_\_len\_\_

  <Function id="qiskit.aqua.operators.list_ops.SummedOp.__len__" signature="SummedOp.__len__()">
    Length of `oplist`.
  ...
  <span id="summedop-mul" />

  ### \_\_mul\_\_

  <Function id="qiskit.aqua.operators.list_ops.SummedOp.__mul__" signature="SummedOp.__mul__(other)">
  ...
  <span id="summedop-assign-parameters" />
  ...
  <span id="summedop-bind-parameters" />
  ...
  <span id="summedop-compose" />

  ### compose

  <Function id="qiskit.aqua.operators.list_ops.SummedOp.compose" signature="SummedOp.compose(other)">
  ...
  <span id="summedop-primitive-strings" />
  ...
  <span id="summedop-to-circuit-op" />
