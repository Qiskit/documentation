...
<Class id="qiskit.aqua.operators.list_ops.SummedOp" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.7/qiskit/aqua/operators/list_ops/summed_op.py" signature="SummedOp(oplist, coeff=1.0, abelian=False)">
  ...
  *   **abelian** (`bool`) – Indicates whether the Operators in `oplist` are known to mutually commute.
  ...
  <Attribute id="qiskit.aqua.operators.list_ops.SummedOp.abelian" name="abelian" signature="bool">
  ...
  <Attribute id="qiskit.aqua.operators.list_ops.SummedOp.coeff" name="coeff" signature="Union[int, float, complex, qiskit.circuit.parameterexpression.ParameterExpression]">
  ...
  <Attribute id="qiskit.aqua.operators.list_ops.SummedOp.combo_fn" name="combo_fn" signature="Callable">
  ...
  <Attribute id="qiskit.aqua.operators.list_ops.SummedOp.distributive" name="distributive" signature="bool">
  ...
  <Attribute id="qiskit.aqua.operators.list_ops.SummedOp.num_qubits" name="num_qubits" signature="int">
  ...
  <Attribute id="qiskit.aqua.operators.list_ops.SummedOp.oplist" name="oplist" signature="List[qiskit.aqua.operators.operator_base.OperatorBase]">
  ...
  <Function id="qiskit.aqua.operators.list_ops.SummedOp.__getitem__" name="__getitem__" signature="SummedOp.__getitem__(offset)">
  ...
  <Function id="qiskit.aqua.operators.list_ops.SummedOp.__len__" name="__len__" signature="SummedOp.__len__()">
    Length of `oplist`.
  ...
  <Function id="qiskit.aqua.operators.list_ops.SummedOp.__mul__" name="__mul__" signature="SummedOp.__mul__(other)">
  ...
  <Function id="qiskit.aqua.operators.list_ops.SummedOp.compose" name="compose" signature="SummedOp.compose(other)">
