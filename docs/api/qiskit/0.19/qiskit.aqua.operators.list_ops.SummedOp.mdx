...
<Class id="qiskit.aqua.operators.list_ops.SummedOp" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.7/qiskit/aqua/operators/list_ops/summed_op.py" signature="SummedOp(oplist, coeff=1.0, abelian=False)">
  ...
  *   **abelian** (`bool`) – Indicates whether the Operators in `oplist` are known to mutually commute.
  ...
  <Attribute id="qiskit.aqua.operators.list_ops.SummedOp.abelian" signature="bool">
  ...
  <Attribute id="qiskit.aqua.operators.list_ops.SummedOp.coeff" signature="Union[int, float, complex, qiskit.circuit.parameterexpression.ParameterExpression]">
  ...
  <Attribute id="qiskit.aqua.operators.list_ops.SummedOp.combo_fn" signature="Callable">
  ...
  <Attribute id="qiskit.aqua.operators.list_ops.SummedOp.distributive" signature="bool">
  ...
  <Attribute id="qiskit.aqua.operators.list_ops.SummedOp.num_qubits" signature="int">
  ...
  <Attribute id="qiskit.aqua.operators.list_ops.SummedOp.oplist" signature="List[qiskit.aqua.operators.operator_base.OperatorBase]">
