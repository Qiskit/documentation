---
title: Operator (v0.19)
description: API reference for qiskit.quantum_info.Operator in qiskit v0.19
...
<Class id="qiskit.quantum_info.Operator" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.14/qiskit/quantum_info/operators/operator.py" signature="Operator(data, input_dims=None, output_dims=None)" modifiers="class">
...
$$
  ...
  **Additional Information:**
  ...
  <span id="operator-call" />

  ### \_\_call\_\_

  <Function id="qiskit.quantum_info.Operator.__call__" signature="Operator.__call__(qargs)">
    Return a clone with qargs set
  </Function>

  <span id="operator-mul" />

  ### \_\_mul\_\_

  <Function id="qiskit.quantum_info.Operator.__mul__" signature="Operator.__mul__(other)" />

  <span id="operator-add" />

  ### add

  <Function id="qiskit.quantum_info.Operator.add" signature="Operator.add(other)">
  ...
  <span id="operator-multiply" />

  ### multiply

  <Function id="qiskit.quantum_info.Operator.multiply" signature="Operator.multiply(other)">
  ...
  <span id="operator-reshape" />

  ### reshape

  <Function id="qiskit.quantum_info.Operator.reshape" signature="Operator.reshape(input_dims=None, output_dims=None)">
  ...
  <span id="operator-set-atol" />

  ### set\_atol

  <Function id="qiskit.quantum_info.Operator.set_atol" signature="Operator.set_atol(value)" modifiers="classmethod">
    Set the class default absolute tolerance parameter for float comparisons.
  </Function>

  <span id="operator-set-rtol" />

  ### set\_rtol

  <Function id="qiskit.quantum_info.Operator.set_rtol" signature="Operator.set_rtol(value)" modifiers="classmethod">
    Set the class default relative tolerance parameter for float comparisons.
  </Function>

  <span id="operator-subtract" />

  ### subtract

  <Function id="qiskit.quantum_info.Operator.subtract" signature="Operator.subtract(other)">
    Return the linear operator self - other.
  ...
  <span id="operator-to-instruction" />
