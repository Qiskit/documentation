...
$$
  ...
  **Additional Information:**
  ...
  <Function id="qiskit.quantum_info.Operator.set_atol" signature="classmethod Operator.set_atol(value)">
    Set the class default absolute tolerance parameter for float comparisons.
  </Function>

  ### set\_rtol

  <Function id="qiskit.quantum_info.Operator.set_rtol" signature="classmethod Operator.set_rtol(value)">
