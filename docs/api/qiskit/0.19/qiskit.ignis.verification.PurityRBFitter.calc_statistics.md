...
description: API reference for qiskit.ignis.verification.PurityRBFitter.calc_statistics
in_page_toc_min_heading_level: 1
python_api_type: method
python_api_name: qiskit.ignis.verification.PurityRBFitter.calc_statistics
---
