...
<Class id="qiskit.pulse.Snapshot" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.14/qiskit/pulse/instructions/snapshot.py" signature="Snapshot(label, snapshot_type='statevector', name=None)">
  ...
  *   **name** (`Optional`\[`str`]) – Snapshot name which defaults to `label`. This parameter is only for display purposes and is not taken into account during comparison.
  ...
  <Attribute id="qiskit.pulse.Snapshot.channel" signature="qiskit.pulse.channels.SnapshotChannel">
  ...
  <Attribute id="qiskit.pulse.Snapshot.channels" signature="Tuple[qiskit.pulse.channels.Channel]">
  ...
  <Attribute id="qiskit.pulse.Snapshot.command" signature="qiskit.pulse.commands.command.Command">
  ...
  <Attribute id="qiskit.pulse.Snapshot.duration" signature="int">
  ...
  <Attribute id="qiskit.pulse.Snapshot.id" signature="int">
  ...
  <Attribute id="qiskit.pulse.Snapshot.instructions" signature="Tuple[Tuple[int, qiskit.pulse.instructions.instruction.Instruction]]">
  ...
  <Attribute id="qiskit.pulse.Snapshot.label" signature="str">
    Label of snapshot.
  ...
  <Attribute id="qiskit.pulse.Snapshot.name" signature="str">
  ...
  <Attribute id="qiskit.pulse.Snapshot.operands" signature="Tuple">
  ...
  <Attribute id="qiskit.pulse.Snapshot.start_time" signature="int">
  ...
  <Attribute id="qiskit.pulse.Snapshot.stop_time" signature="int">
  ...
  <Attribute id="qiskit.pulse.Snapshot.timeslots" signature="Dict[qiskit.pulse.channels.Channel, List[Tuple[int, int]]]">
  ...
  <Attribute id="qiskit.pulse.Snapshot.type" signature="str">
    Type of snapshot.
