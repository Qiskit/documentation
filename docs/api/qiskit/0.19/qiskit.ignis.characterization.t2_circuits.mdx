...
<Function id="qiskit.ignis.characterization.t2_circuits" name="t2_circuits" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-ignis/tree/stable/0.3/qiskit/ignis/characterization/coherence/circuits.py" signature="t2_circuits(num_of_gates, gate_time, qubits, n_echos=1, phase_alt_echo=False)">
