...
<Class id="qiskit.aqua.algorithms.HHL" github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.7/qiskit/aqua/algorithms/linear_solvers/hhl.py" signature="HHL(matrix, vector, truncate_powerdim=False, truncate_hermitian=False, eigs=None, init_state=None, reciprocal=None, num_q=0, num_a=0, orig_size=None, quantum_instance=None)">
  ...
  **ValueError** – Invalid input
  ...
  <Function id="qiskit.aqua.algorithms.HHL.expand_to_hermitian" signature="static HHL.expand_to_hermitian(matrix, vector)">
  ...
  <Function id="qiskit.aqua.algorithms.HHL.expand_to_powerdim" signature="static HHL.expand_to_powerdim(matrix, vector)">
  ...
  <Function id="qiskit.aqua.algorithms.HHL.matrix_resize" signature="static HHL.matrix_resize(matrix, vector)">
