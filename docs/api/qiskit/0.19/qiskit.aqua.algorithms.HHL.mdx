...
$$
  ...
  **ValueError** – Invalid input
  ...
  <Attribute id="qiskit.aqua.algorithms.HHL.backend" name="backend" signature="qiskit.providers.basebackend.BaseBackend">
    Returns backend.
  ...
  <Attribute id="qiskit.aqua.algorithms.HHL.quantum_instance" name="quantum_instance" signature="Union[None, qiskit.aqua.quantum_instance.QuantumInstance]">
  ...
  <Attribute id="qiskit.aqua.algorithms.HHL.random" name="random">
  ...
  <Function id="qiskit.aqua.algorithms.HHL.construct_circuit" name="construct_circuit" signature="HHL.construct_circuit(measurement=False)">
  ...
  <Function id="qiskit.aqua.algorithms.HHL.expand_to_hermitian" name="expand_to_hermitian" signature="static HHL.expand_to_hermitian(matrix, vector)">
  ...
  <Function id="qiskit.aqua.algorithms.HHL.expand_to_powerdim" name="expand_to_powerdim" signature="static HHL.expand_to_powerdim(matrix, vector)">
  ...
  <Function id="qiskit.aqua.algorithms.HHL.matrix_resize" name="matrix_resize" signature="static HHL.matrix_resize(matrix, vector)">
  ...
  <Function id="qiskit.aqua.algorithms.HHL.run" name="run" signature="HHL.run(quantum_instance=None, **kwargs)">
  ...
  <Function id="qiskit.aqua.algorithms.HHL.set_backend" name="set_backend" signature="HHL.set_backend(backend, **kwargs)">
