...
<Class id="qiskit.ignis.verification.CliffordUtils" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-ignis/tree/stable/0.3/qiskit/ignis/verification/randomized_benchmarking/clifford_utils.py" signature="CliffordUtils(num_qubits=2, group_tables=None, elmnt=None, gatelist=None, elmnt_key=None)">
  ...
  *   **gatelist** (*list*) – a list of gates corresponding to a Clifford object.
  ...
  <Function id="qiskit.ignis.verification.CliffordUtils.clifford1_gates" name="clifford1_gates" signature="CliffordUtils.clifford1_gates(idx)">
  ...
  <Function id="qiskit.ignis.verification.CliffordUtils.clifford1_gates_table" name="clifford1_gates_table" signature="CliffordUtils.clifford1_gates_table()">
  ...
  <Function id="qiskit.ignis.verification.CliffordUtils.clifford2_gates" name="clifford2_gates" signature="CliffordUtils.clifford2_gates(idx)">
  ...
  <Function id="qiskit.ignis.verification.CliffordUtils.clifford2_gates_table" name="clifford2_gates_table" signature="CliffordUtils.clifford2_gates_table()">
  ...
  <Function id="qiskit.ignis.verification.CliffordUtils.clifford_from_gates" name="clifford_from_gates" signature="CliffordUtils.clifford_from_gates(num_qubits, gatelist)">
  ...
  <Function id="qiskit.ignis.verification.CliffordUtils.compose_gates" name="compose_gates" signature="CliffordUtils.compose_gates(cliff, gatelist)">
  ...
  <Function id="qiskit.ignis.verification.CliffordUtils.cx_gates" name="cx_gates" signature="CliffordUtils.cx_gates(gatelist, ctrl, tgt)">
  ...
  <Function id="qiskit.ignis.verification.CliffordUtils.elmnt" name="elmnt" signature="CliffordUtils.elmnt()">
    Return a Clifford object.
  </Function>

  ### elmnt\_key

  <Function id="qiskit.ignis.verification.CliffordUtils.elmnt_key" name="elmnt_key" signature="CliffordUtils.elmnt_key()">
    Return a unique index of a Clifford object.
  </Function>

  ### find\_inverse\_gates

  <Function id="qiskit.ignis.verification.CliffordUtils.find_inverse_gates" name="find_inverse_gates" signature="CliffordUtils.find_inverse_gates(num_qubits, gatelist)">
  ...
  <Function id="qiskit.ignis.verification.CliffordUtils.find_key" name="find_key" signature="CliffordUtils.find_key(cliff, num_qubits)">
  ...
  <Function id="qiskit.ignis.verification.CliffordUtils.gatelist" name="gatelist" signature="CliffordUtils.gatelist()">
    Return a list of gates corresponding to a Clifford object.
  </Function>

  ### group\_tables

  <Function id="qiskit.ignis.verification.CliffordUtils.group_tables" name="group_tables" signature="CliffordUtils.group_tables()">
    Return the Clifford group tables.
  </Function>

  ### h\_gates

  <Function id="qiskit.ignis.verification.CliffordUtils.h_gates" name="h_gates" signature="CliffordUtils.h_gates(gatelist, q, h)">
  ...
  <Function id="qiskit.ignis.verification.CliffordUtils.load_clifford_table" name="load_clifford_table" signature="CliffordUtils.load_clifford_table(picklefile='cliffords2.pickle')">
  ...
  <Function id="qiskit.ignis.verification.CliffordUtils.load_tables" name="load_tables" signature="CliffordUtils.load_tables(num_qubits)">
    Return the Clifford group tables.
  ...
  <Function id="qiskit.ignis.verification.CliffordUtils.num_qubits" name="num_qubits" signature="CliffordUtils.num_qubits()">
    Return the number of qubits of the Clifford object.
  </Function>

  ### pauli\_gates

  <Function id="qiskit.ignis.verification.CliffordUtils.pauli_gates" name="pauli_gates" signature="CliffordUtils.pauli_gates(gatelist, q, pauli)">
  ...
  <Function id="qiskit.ignis.verification.CliffordUtils.pickle_clifford_table" name="pickle_clifford_table" signature="CliffordUtils.pickle_clifford_table(picklefile='cliffords2.pickle', num_qubits=2)">
  ...
  <Function id="qiskit.ignis.verification.CliffordUtils.random_gates" name="random_gates" signature="CliffordUtils.random_gates(num_qubits, rand_seed=None)">
  ...
  <Function id="qiskit.ignis.verification.CliffordUtils.v_gates" name="v_gates" signature="CliffordUtils.v_gates(gatelist, q, v)">
