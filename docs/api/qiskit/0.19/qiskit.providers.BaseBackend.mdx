---
title: BaseBackend (v0.19)
description: API reference for qiskit.providers.BaseBackend in qiskit v0.19
...
<Class id="qiskit.providers.BaseBackend" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.14/qiskit/providers/basebackend.py" signature="BaseBackend(configuration, provider=None)" modifiers="class">
  ...
  **QiskitError** – if an error occurred when instantiating the backend.
  ...
  <span id="basebackend-configuration" />
  ...
  <span id="basebackend-properties" />
