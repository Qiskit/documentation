---
title: ampcal_1Q_circuits (v0.19)
description: API reference for qiskit.ignis.characterization.ampcal_1Q_circuits in qiskit v0.19
in_page_toc_min_heading_level: 1
python_api_type: function
python_api_name: qiskit.ignis.characterization.ampcal_1Q_circuits
---

<span id="ampcal-1q-circuits" />

# ampcal\_1Q\_circuits

<Function id="qiskit.ignis.characterization.ampcal_1Q_circuits" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-ignis/tree/stable/0.3/qiskit/ignis/characterization/gates/circuits.py" signature="ampcal_1Q_circuits(max_reps, qubits)">
