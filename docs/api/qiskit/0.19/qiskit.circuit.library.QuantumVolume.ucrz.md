---
title: ucrz
description: API reference for qiskit.circuit.library.QuantumVolume.ucrz
in_page_toc_min_heading_level: 1
python_api_type: method
python_api_name: qiskit.circuit.library.QuantumVolume.ucrz
---
...
`QuantumVolume.ucrz(angle_list, q_controls, q_target)`
