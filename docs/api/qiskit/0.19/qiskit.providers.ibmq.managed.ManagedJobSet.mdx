---
title: ManagedJobSet (v0.19)
description: API reference for qiskit.providers.ibmq.managed.ManagedJobSet in qiskit v0.19
...
<Class id="qiskit.providers.ibmq.managed.ManagedJobSet" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-ibmq-provider/tree/stable/0.7/qiskit/providers/ibmq/managed/managedjobset.py" signature="ManagedJobSet(name=None, short_id=None)" modifiers="class">
  ...
  *   **short\_id** (`Optional`\[`str`]) – Short ID for this set of jobs.
  ...
  <span id="managedjobset-error-messages" />
  ...
  <span id="managedjobset-job-set-id" />
  ...
  <span id="managedjobset-managed-jobs" />
  ...
  <span id="managedjobset-results" />

  ### results

  <Function id="qiskit.providers.ibmq.managed.ManagedJobSet.results" signature="ManagedJobSet.results(timeout=None, partial=False)">
  ...
  <span id="managedjobset-retrieve-jobs" />
  ...
  <span id="managedjobset-run" />

  ### run

  <Function id="qiskit.providers.ibmq.managed.ManagedJobSet.run" signature="ManagedJobSet.run(experiment_list, backend, executor, job_share_level, job_tags=None, **assemble_config)">
  ...
  <span id="managedjobset-statuses" />
  ...
  <span id="managedjobset-update-name" />
  ...
  <span id="managedjobset-update-tags" />
