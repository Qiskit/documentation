...
<Function id="qiskit.quantum_info.gate_error" name="gate_error" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.14/qiskit/quantum_info/operators/measures.py" signature="gate_error(channel, target=None, require_cp=True, require_tp=False)">
