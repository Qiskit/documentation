...
<Class id="qiskit.providers.aer.QasmSimulator" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-aer/tree/stable/0.5/qiskit/providers/aer/backends/qasm_simulator.py" signature="QasmSimulator(configuration=None, provider=None)">
  ...
  *   [**AerError**](qiskit.providers.aer.AerError "qiskit.providers.aer.AerError") – if there is no name in the configuration
  ...
  <Function id="qiskit.providers.aer.QasmSimulator.run" name="run" signature="QasmSimulator.run(qobj, backend_options=None, noise_model=None, validate=False)">
  ...
  <Function id="qiskit.providers.aer.QasmSimulator.version" name="version" signature="QasmSimulator.version()">
