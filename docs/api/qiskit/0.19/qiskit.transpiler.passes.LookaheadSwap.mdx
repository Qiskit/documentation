---
title: LookaheadSwap (v0.19)
description: API reference for qiskit.transpiler.passes.LookaheadSwap in qiskit v0.19
...
<Class id="qiskit.transpiler.passes.LookaheadSwap" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.14/qiskit/transpiler/passes/routing/lookahead_swap.py" signature="LookaheadSwap(*args, **kwargs)" modifiers="class">
  ...
  *   **search\_width** (*int*) – lookahead tree width when ranking best SWAP options.
  ...
  <span id="lookaheadswap-is-analysis-pass" />
  ...
  <span id="lookaheadswap-is-transformation-pass" />
