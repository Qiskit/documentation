---
title: Z2Symmetries (v0.19)
description: API reference for qiskit.aqua.operators.legacy.Z2Symmetries in qiskit v0.19
...
<Class id="qiskit.aqua.operators.legacy.Z2Symmetries" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.7/qiskit/aqua/operators/legacy/weighted_pauli_operator.py" signature="Z2Symmetries(symmetries, sq_paulis, sq_list, tapering_values=None)" modifiers="class">
  Z2 Symmetries
  ...
  **Raises**
  ...
  <span id="z2symmetries-cliffords" />
  ...
  <span id="z2symmetries-sq-paulis" />
  ...
  <span id="z2symmetries-symmetries" />
  ...
  <span id="z2symmetries-tapering-values" />
  ...
  <span id="z2symmetries-consistent-tapering" />
  ...
  <span id="z2symmetries-find-z2-symmetries" />
  ...
  <span id="z2symmetries-two-qubit-reduction" />
