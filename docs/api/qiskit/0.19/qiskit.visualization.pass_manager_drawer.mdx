---
title: pass_manager_drawer (v0.19)
description: API reference for qiskit.visualization.pass_manager_drawer in qiskit v0.19
in_page_toc_min_heading_level: 1
python_api_type: function
python_api_name: qiskit.visualization.pass_manager_drawer
---

<span id="pass-manager-drawer" />

# pass\_manager\_drawer

<Function id="qiskit.visualization.pass_manager_drawer" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.14/qiskit/visualization/pass_manager_visualization.py" signature="pass_manager_drawer(pass_manager, filename=None, style=None, raw=False)">
