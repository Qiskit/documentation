---
title: SLSQP (v0.19)
description: API reference for qiskit.aqua.components.optimizers.SLSQP in qiskit v0.19
...
<Class id="qiskit.aqua.components.optimizers.SLSQP" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.7/qiskit/aqua/components/optimizers/slsqp.py" signature="SLSQP(maxiter=100, disp=False, ftol=1e-06, tol=None, eps=1.4901161193847656e-08)" modifiers="class">
  ...
  *   **eps** (`float`) – Step size used for numerical approximation of the Jacobian.
  ...
  <span id="slsqp-bounds-support-level" />
  ...
  <span id="slsqp-gradient-support-level" />
  ...
  <span id="slsqp-initial-point-support-level" />
  ...
  <span id="slsqp-is-bounds-ignored" />
  ...
  <span id="slsqp-is-bounds-required" />
  ...
  <span id="slsqp-is-bounds-supported" />
  ...
  <span id="slsqp-is-gradient-ignored" />
  ...
  <span id="slsqp-is-gradient-required" />
  ...
  <span id="slsqp-is-gradient-supported" />
  ...
  <span id="slsqp-is-initial-point-ignored" />
  ...
  <span id="slsqp-is-initial-point-required" />
  ...
  <span id="slsqp-is-initial-point-supported" />
  ...
  <span id="slsqp-get-support-level" />
  ...
  <span id="slsqp-gradient-num-diff" />
  ...
  <span id="slsqp-set-max-evals-grouped" />
