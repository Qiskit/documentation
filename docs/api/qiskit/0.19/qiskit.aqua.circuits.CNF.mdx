...
<Class id="qiskit.aqua.circuits.CNF" github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.7/qiskit/aqua/circuits/boolean_logical_circuits.py" signature="CNF(ast, num_vars=None)">
