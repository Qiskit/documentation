---
title: MeasurementFilter (v0.19)
description: API reference for qiskit.ignis.mitigation.MeasurementFilter in qiskit v0.19
...
<Class id="qiskit.ignis.mitigation.MeasurementFilter" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-ignis/tree/stable/0.3/qiskit/ignis/mitigation/measurement/filters.py" signature="MeasurementFilter(cal_matrix, state_labels)" modifiers="class">
  ...
  *   **state\_labels** (`list`) – the states for the ordering of the cal matrix
  ...
  <span id="measurementfilter-cal-matrix" />
  ...
  <span id="measurementfilter-state-labels" />
  ...
  <span id="measurementfilter-apply" />
