...
$$
  ...
  *   **name** (`Optional`\[`str`]) – Display name for this pulse envelope.
  ...
  <Attribute id="qiskit.pulse.pulse_lib.GaussianSquare.amp" signature="complex">
  ...
  <Attribute id="qiskit.pulse.pulse_lib.GaussianSquare.id" signature="int">
  ...
  <Attribute id="qiskit.pulse.pulse_lib.GaussianSquare.parameters" signature="Dict[str, Any]">
  ...
  <Attribute id="qiskit.pulse.pulse_lib.GaussianSquare.sigma" signature="float">
  ...
  <Attribute id="qiskit.pulse.pulse_lib.GaussianSquare.width" signature="float">
