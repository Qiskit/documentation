...
<Class id="qiskit.pulse.ControlChannel" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.14/qiskit/pulse/channels.py" signature="ControlChannel(index)">
  ...
  **Raises**
  ...
  <Attribute id="qiskit.pulse.ControlChannel.index" name="index" signature="int">
  ...
  <Attribute id="qiskit.pulse.ControlChannel.name" name="name" signature="str">
  ...
  <Attribute id="qiskit.pulse.ControlChannel.prefix" signature="= 'u'">
