...
<Class id="qiskit.aqua.algorithms.QAOA" github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.7/qiskit/aqua/algorithms/minimum_eigen_solvers/qaoa/qaoa.py" signature="QAOA(operator=None, optimizer=None, p=1, initial_state=None, mixer=None, initial_point=None, expectation=None, include_custom=False, max_evals_grouped=1, aux_operators=None, callback=None, quantum_instance=None)">
  ...
  *   **quantum\_instance** (`Union`\[[`QuantumInstance`](qiskit.aqua.QuantumInstance "qiskit.aqua.quantum_instance.QuantumInstance"), [`BaseBackend`](qiskit.providers.BaseBackend "qiskit.providers.basebackend.BaseBackend"), `None`]) – Quantum Instance or Backend
  ...
  <Attribute id="qiskit.aqua.algorithms.QAOA.aux_operators" name="aux_operators" signature="Optional[List[Optional[qiskit.aqua.operators.operator_base.OperatorBase]]]">
  ...
  <Attribute id="qiskit.aqua.algorithms.QAOA.backend" name="backend" signature="qiskit.providers.basebackend.BaseBackend">
    Returns backend.
  ...
  <Attribute id="qiskit.aqua.algorithms.QAOA.expectation" name="expectation" signature="qiskit.aqua.operators.expectations.expectation_base.ExpectationBase">
  ...
  <Attribute id="qiskit.aqua.algorithms.QAOA.initial_point" name="initial_point" signature="Optional[numpy.ndarray]">
  ...
  <Attribute id="qiskit.aqua.algorithms.QAOA.operator" name="operator" signature="Optional[qiskit.aqua.operators.operator_base.OperatorBase]">
    Returns operator
  ...
  <Attribute id="qiskit.aqua.algorithms.QAOA.optimal_params" name="optimal_params" signature="List[float]">
  ...
  <Attribute id="qiskit.aqua.algorithms.QAOA.optimizer" name="optimizer" signature="Optional[qiskit.aqua.components.optimizers.optimizer.Optimizer]">
    Returns optimizer
  ...
  <Attribute id="qiskit.aqua.algorithms.QAOA.quantum_instance" name="quantum_instance" signature="Union[None, qiskit.aqua.quantum_instance.QuantumInstance]">
  ...
  <Attribute id="qiskit.aqua.algorithms.QAOA.random" name="random">
    Return a numpy random.
  </Attribute>

  ### setting

  <Attribute id="qiskit.aqua.algorithms.QAOA.setting" name="setting">
    Prepare the setting of VQE as a string.
  </Attribute>

  ### var\_form

  <Attribute id="qiskit.aqua.algorithms.QAOA.var_form" name="var_form" signature="Optional[Union[qiskit.circuit.quantumcircuit.QuantumCircuit, qiskit.aqua.components.variational_forms.variational_form.VariationalForm]]">
  ...
  <Function id="qiskit.aqua.algorithms.QAOA.cleanup_parameterized_circuits" name="cleanup_parameterized_circuits" signature="QAOA.cleanup_parameterized_circuits()">
    set parameterized circuits to None
  </Function>

  ### compute\_minimum\_eigenvalue

  <Function id="qiskit.aqua.algorithms.QAOA.compute_minimum_eigenvalue" name="compute_minimum_eigenvalue" signature="QAOA.compute_minimum_eigenvalue(operator=None, aux_operators=None)">
  ...
  <Function id="qiskit.aqua.algorithms.QAOA.construct_circuit" name="construct_circuit" signature="QAOA.construct_circuit(parameter)">
  ...
  <Function id="qiskit.aqua.algorithms.QAOA.find_minimum" name="find_minimum" signature="QAOA.find_minimum(initial_point=None, var_form=None, cost_fn=None, optimizer=None, gradient_fn=None)">
  ...
  <Function id="qiskit.aqua.algorithms.QAOA.get_optimal_circuit" name="get_optimal_circuit" signature="QAOA.get_optimal_circuit()">
  ...
  <Function id="qiskit.aqua.algorithms.QAOA.get_optimal_cost" name="get_optimal_cost" signature="QAOA.get_optimal_cost()">
  ...
  <Function id="qiskit.aqua.algorithms.QAOA.get_optimal_vector" name="get_optimal_vector" signature="QAOA.get_optimal_vector()">
  ...
  <Function id="qiskit.aqua.algorithms.QAOA.get_prob_vector_for_params" name="get_prob_vector_for_params" signature="QAOA.get_prob_vector_for_params(construct_circuit_fn, params_s, quantum_instance, construct_circuit_args=None)">
    Helper function to get probability vectors for a set of params
  </Function>

  ### get\_probabilities\_for\_counts

  <Function id="qiskit.aqua.algorithms.QAOA.get_probabilities_for_counts" name="get_probabilities_for_counts" signature="QAOA.get_probabilities_for_counts(counts)">
    get probabilities for counts
  </Function>

  ### print\_settings

  <Function id="qiskit.aqua.algorithms.QAOA.print_settings" name="print_settings" signature="QAOA.print_settings()">
  ...
  <Function id="qiskit.aqua.algorithms.QAOA.run" name="run" signature="QAOA.run(quantum_instance=None, **kwargs)">
  ...
  <Function id="qiskit.aqua.algorithms.QAOA.set_backend" name="set_backend" signature="QAOA.set_backend(backend, **kwargs)">
  ...
  <Function id="qiskit.aqua.algorithms.QAOA.supports_aux_operators" name="supports_aux_operators" signature="QAOA.supports_aux_operators()">
