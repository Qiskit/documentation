...
<Class id="qiskit.circuit.library.TwoLocal" github="https://github.com/qiskit/qiskit/tree/stable/0.14/qiskit/circuit/library/n_local/two_local.py" signature="TwoLocal(num_qubits=None, rotation_blocks=None, entanglement_blocks=None, entanglement='full', reps=3, skip_unentangled_qubits=False, skip_final_rotation_layer=False, parameter_prefix='θ', insert_barriers=False, initial_state=None)">
  ...
  **Examples**
  ...
  <Attribute id="qiskit.circuit.library.TwoLocal.clbits" name="clbits">
    Returns a list of classical bits in the order that the registers were added.
  </Attribute>

  ### data

  <Attribute id="qiskit.circuit.library.TwoLocal.data" name="data">
  ...
  <Attribute id="qiskit.circuit.library.TwoLocal.entanglement" name="entanglement" signature="Union[str, List[str], List[List[str]], List[int], List[List[int]], List[List[List[int]]], List[List[List[List[int]]]], Callable[[int], str], Callable[[int], List[List[int]]]]">
  ...
  <Attribute id="qiskit.circuit.library.TwoLocal.entanglement_blocks" name="entanglement_blocks" signature="List[qiskit.circuit.instruction.Instruction]">
  ...
  <Attribute id="qiskit.circuit.library.TwoLocal.extension_lib" signature="= 'include \&#x22;qelib1.inc\&#x22;;'" />

  ### header

  <Attribute id="qiskit.circuit.library.TwoLocal.header" signature="= 'OPENQASM 2.0;'" />

  ### initial\_state

  <Attribute id="qiskit.circuit.library.TwoLocal.initial_state" name="initial_state" signature="Any">
  ...
  <Attribute id="qiskit.circuit.library.TwoLocal.insert_barriers" name="insert_barriers" signature="bool">
  ...
  <Attribute id="qiskit.circuit.library.TwoLocal.instances" signature="= 8" />

  ### n\_qubits

  <Attribute id="qiskit.circuit.library.TwoLocal.n_qubits" name="n_qubits">
    Deprecated, use `num_qubits` instead. Return number of qubits.
  </Attribute>

  ### num\_clbits

  <Attribute id="qiskit.circuit.library.TwoLocal.num_clbits" name="num_clbits">
    Return number of classical bits.
  </Attribute>

  ### num\_layers

  <Attribute id="qiskit.circuit.library.TwoLocal.num_layers" name="num_layers" signature="int">
  ...
  <Attribute id="qiskit.circuit.library.TwoLocal.num_parameters" name="num_parameters">
    Convenience function to get the number of parameter objects in the circuit.
  </Attribute>

  ### num\_parameters\_settable

  <Attribute id="qiskit.circuit.library.TwoLocal.num_parameters_settable" name="num_parameters_settable" signature="int">
  ...
  <Attribute id="qiskit.circuit.library.TwoLocal.num_qubits" name="num_qubits" signature="int">
  ...
  <Attribute id="qiskit.circuit.library.TwoLocal.ordered_parameters" name="ordered_parameters" signature="List[qiskit.circuit.parameter.Parameter]">
  ...
  <Attribute id="qiskit.circuit.library.TwoLocal.parameter_bounds" name="parameter_bounds" signature="Optional[List[Tuple[float, float]]]">
  ...
  <Attribute id="qiskit.circuit.library.TwoLocal.parameters" name="parameters" signature="Set[qiskit.circuit.parameter.Parameter]">
  ...
  <Attribute id="qiskit.circuit.library.TwoLocal.preferred_init_points" name="preferred_init_points" signature="Optional[List[float]]">
  ...
  <Attribute id="qiskit.circuit.library.TwoLocal.prefix" signature="= 'circuit'" />

  ### qregs

  <Attribute id="qiskit.circuit.library.TwoLocal.qregs" name="qregs">
    A list of the quantum registers associated with the circuit.
  </Attribute>

  ### qubits

  <Attribute id="qiskit.circuit.library.TwoLocal.qubits" name="qubits">
    Returns a list of quantum bits in the order that the registers were added.
  </Attribute>

  ### reps

  <Attribute id="qiskit.circuit.library.TwoLocal.reps" name="reps" signature="int">
  ...
  <Attribute id="qiskit.circuit.library.TwoLocal.rotation_blocks" name="rotation_blocks" signature="List[qiskit.circuit.instruction.Instruction]">
  ...
  <Function id="qiskit.circuit.library.TwoLocal.AND" name="AND" signature="TwoLocal.AND(qr_variables, qb_target, qr_ancillae, flags=None, mct_mode='no-ancilla')">
  ...
  <Function id="qiskit.circuit.library.TwoLocal.OR" name="OR" signature="TwoLocal.OR(qr_variables, qb_target, qr_ancillae, flags=None, mct_mode='basic')">
  ...
  <Function id="qiskit.circuit.library.TwoLocal.__getitem__" name="__getitem__" signature="TwoLocal.__getitem__(item)">
    Return indexed operation.
  </Function>

  ### \_\_len\_\_

  <Function id="qiskit.circuit.library.TwoLocal.__len__" name="__len__" signature="TwoLocal.__len__()">
    Return number of operations in circuit.
  </Function>

  ### add\_layer

  <Function id="qiskit.circuit.library.TwoLocal.add_layer" name="add_layer" signature="TwoLocal.add_layer(other, entanglement=None, front=False)">
  ...
  <Function id="qiskit.circuit.library.TwoLocal.add_register" name="add_register" signature="TwoLocal.add_register(*regs)">
    Add registers.
  </Function>

  ### append

  <Function id="qiskit.circuit.library.TwoLocal.append" name="append" signature="TwoLocal.append(instruction, qargs=None, cargs=None)">
  ...
  <Function id="qiskit.circuit.library.TwoLocal.assign_parameters" name="assign_parameters" signature="TwoLocal.assign_parameters(param_dict, inplace=False)">
  ...
  <Function id="qiskit.circuit.library.TwoLocal.barrier" name="barrier" signature="TwoLocal.barrier(*qargs)">
    Apply `Barrier`. If qargs is None, applies to all.
  </Function>

  ### bind\_parameters

  <Function id="qiskit.circuit.library.TwoLocal.bind_parameters" name="bind_parameters" signature="TwoLocal.bind_parameters(value_dict)">
  ...
  <Function id="qiskit.circuit.library.TwoLocal.cast" name="cast" signature="static TwoLocal.cast(value, _type)">
    Best effort to cast value to type. Otherwise, returns the value.
  </Function>

  ### cbit\_argument\_conversion

  <Function id="qiskit.circuit.library.TwoLocal.cbit_argument_conversion" name="cbit_argument_conversion" signature="TwoLocal.cbit_argument_conversion(clbit_representation)">
  ...
  <Function id="qiskit.circuit.library.TwoLocal.ccx" name="ccx" signature="TwoLocal.ccx(control_qubit1, control_qubit2, target_qubit, *, ctl1=None, ctl2=None, tgt=None)">
    Apply [`CCXGate`](qiskit.circuit.library.CCXGate "qiskit.circuit.library.CCXGate").
  </Function>

  ### ch

  <Function id="qiskit.circuit.library.TwoLocal.ch" name="ch" signature="TwoLocal.ch(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CHGate`](qiskit.circuit.library.CHGate "qiskit.circuit.library.CHGate").
  </Function>

  ### cls\_instances

  <Function id="qiskit.circuit.library.TwoLocal.cls_instances" name="cls_instances" signature="classmethod TwoLocal.cls_instances()">
    Return the current number of instances of this class, useful for auto naming.
  </Function>

  ### cls\_prefix

  <Function id="qiskit.circuit.library.TwoLocal.cls_prefix" name="cls_prefix" signature="classmethod TwoLocal.cls_prefix()">
    Return the prefix to use for auto naming.
  </Function>

  ### cnot

  <Function id="qiskit.circuit.library.TwoLocal.cnot" name="cnot" signature="TwoLocal.cnot(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CXGate`](qiskit.circuit.library.CXGate "qiskit.circuit.library.CXGate").
  </Function>

  ### combine

  <Function id="qiskit.circuit.library.TwoLocal.combine" name="combine" signature="TwoLocal.combine(rhs)">
  ...
  <Function id="qiskit.circuit.library.TwoLocal.compose" name="compose" signature="TwoLocal.compose(other, qubits=None, clbits=None, front=False, inplace=False)">
  ...
  <Function id="qiskit.circuit.library.TwoLocal.copy" name="copy" signature="TwoLocal.copy(name=None)">
    Copy the circuit.
  ...
  <Function id="qiskit.circuit.library.TwoLocal.count_ops" name="count_ops" signature="TwoLocal.count_ops()">
  ...
  <Function id="qiskit.circuit.library.TwoLocal.crx" name="crx" signature="TwoLocal.crx(theta, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CRXGate`](qiskit.circuit.library.CRXGate "qiskit.circuit.library.CRXGate").
  </Function>

  ### cry

  <Function id="qiskit.circuit.library.TwoLocal.cry" name="cry" signature="TwoLocal.cry(theta, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CRYGate`](qiskit.circuit.library.CRYGate "qiskit.circuit.library.CRYGate").
  </Function>

  ### crz

  <Function id="qiskit.circuit.library.TwoLocal.crz" name="crz" signature="TwoLocal.crz(theta, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CRZGate`](qiskit.circuit.library.CRZGate "qiskit.circuit.library.CRZGate").
  </Function>

  ### cswap

  <Function id="qiskit.circuit.library.TwoLocal.cswap" name="cswap" signature="TwoLocal.cswap(control_qubit, target_qubit1, target_qubit2, *, label=None, ctrl_state=None, ctl=None, tgt1=None, tgt2=None)">
    Apply [`CSwapGate`](qiskit.circuit.library.CSwapGate "qiskit.circuit.library.CSwapGate").
  </Function>

  ### cu1

  <Function id="qiskit.circuit.library.TwoLocal.cu1" name="cu1" signature="TwoLocal.cu1(theta, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CU1Gate`](qiskit.circuit.library.CU1Gate "qiskit.circuit.library.CU1Gate").
  </Function>

  ### cu3

  <Function id="qiskit.circuit.library.TwoLocal.cu3" name="cu3" signature="TwoLocal.cu3(theta, phi, lam, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CU3Gate`](qiskit.circuit.library.CU3Gate "qiskit.circuit.library.CU3Gate").
  </Function>

  ### cx

  <Function id="qiskit.circuit.library.TwoLocal.cx" name="cx" signature="TwoLocal.cx(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CXGate`](qiskit.circuit.library.CXGate "qiskit.circuit.library.CXGate").
  </Function>

  ### cy

  <Function id="qiskit.circuit.library.TwoLocal.cy" name="cy" signature="TwoLocal.cy(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CYGate`](qiskit.circuit.library.CYGate "qiskit.circuit.library.CYGate").
  </Function>

  ### cz

  <Function id="qiskit.circuit.library.TwoLocal.cz" name="cz" signature="TwoLocal.cz(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CZGate`](qiskit.circuit.library.CZGate "qiskit.circuit.library.CZGate").
  </Function>

  ### dcx

  <Function id="qiskit.circuit.library.TwoLocal.dcx" name="dcx" signature="TwoLocal.dcx(qubit1, qubit2)">
    Apply [`DCXGate`](qiskit.circuit.library.DCXGate "qiskit.circuit.library.DCXGate").
  </Function>

  ### decompose

  <Function id="qiskit.circuit.library.TwoLocal.decompose" name="decompose" signature="TwoLocal.decompose()">
  ...
  <Function id="qiskit.circuit.library.TwoLocal.depth" name="depth" signature="TwoLocal.depth()">
  ...
  <Function id="qiskit.circuit.library.TwoLocal.diag_gate" name="diag_gate" signature="TwoLocal.diag_gate(diag, qubit)">
    Deprecated version of QuantumCircuit.diagonal.
  </Function>

  ### diagonal

  <Function id="qiskit.circuit.library.TwoLocal.diagonal" name="diagonal" signature="TwoLocal.diagonal(diag, qubit)">
  ...
  <Function id="qiskit.circuit.library.TwoLocal.extend" name="extend" signature="TwoLocal.extend(rhs)">
  ...
  <Function id="qiskit.circuit.library.TwoLocal.fredkin" name="fredkin" signature="TwoLocal.fredkin(control_qubit, target_qubit1, target_qubit2, *, ctl=None, tgt1=None, tgt2=None)">
    Apply [`CSwapGate`](qiskit.circuit.library.CSwapGate "qiskit.circuit.library.CSwapGate").
  </Function>

  ### from\_qasm\_file

  <Function id="qiskit.circuit.library.TwoLocal.from_qasm_file" name="from_qasm_file" signature="static TwoLocal.from_qasm_file(path)">
  ...
  <Function id="qiskit.circuit.library.TwoLocal.from_qasm_str" name="from_qasm_str" signature="static TwoLocal.from_qasm_str(qasm_str)">
  ...
  <Function id="qiskit.circuit.library.TwoLocal.get_entangler_map" name="get_entangler_map" signature="TwoLocal.get_entangler_map(rep_num, block_num, num_block_qubits)">
  ...
  <Function id="qiskit.circuit.library.TwoLocal.get_unentangled_qubits" name="get_unentangled_qubits" signature="TwoLocal.get_unentangled_qubits()">
  ...
  <Function id="qiskit.circuit.library.TwoLocal.h" name="h" signature="TwoLocal.h(qubit, *, q=None)">
    Apply [`HGate`](qiskit.circuit.library.HGate "qiskit.circuit.library.HGate").
  </Function>

  ### hamiltonian

  <Function id="qiskit.circuit.library.TwoLocal.hamiltonian" name="hamiltonian" signature="TwoLocal.hamiltonian(operator, time, qubits, label=None)">
    Apply hamiltonian evolution to to qubits.
  </Function>

  ### has\_register

  <Function id="qiskit.circuit.library.TwoLocal.has_register" name="has_register" signature="TwoLocal.has_register(register)">
  ...
  <Function id="qiskit.circuit.library.TwoLocal.i" name="i" signature="TwoLocal.i(qubit, *, q=None)">
    Apply [`IGate`](qiskit.circuit.library.IGate "qiskit.circuit.library.IGate").
  </Function>

  ### id

  <Function id="qiskit.circuit.library.TwoLocal.id" name="id" signature="TwoLocal.id(qubit, *, q=None)">
    Apply [`IGate`](qiskit.circuit.library.IGate "qiskit.circuit.library.IGate").
  </Function>

  ### iden

  <Function id="qiskit.circuit.library.TwoLocal.iden" name="iden" signature="TwoLocal.iden(qubit, *, q=None)">
    Deprecated identity gate.
  </Function>

  ### initialize

  <Function id="qiskit.circuit.library.TwoLocal.initialize" name="initialize" signature="TwoLocal.initialize(params, qubits)">
    Apply initialize to circuit.
  </Function>

  ### inverse

  <Function id="qiskit.circuit.library.TwoLocal.inverse" name="inverse" signature="TwoLocal.inverse()">
    Invert this circuit.
  ...
  <Function id="qiskit.circuit.library.TwoLocal.iso" name="iso" signature="TwoLocal.iso(isometry, q_input, q_ancillas_for_output, q_ancillas_zero=None, q_ancillas_dirty=None)">
  ...
  <Function id="qiskit.circuit.library.TwoLocal.isometry" name="isometry" signature="TwoLocal.isometry(isometry, q_input, q_ancillas_for_output, q_ancillas_zero=None, q_ancillas_dirty=None)">
    Attach an arbitrary isometry from m to n qubits to a circuit. In particular, this allows to attach arbitrary unitaries on n qubits (m=n) or to prepare any state on n qubits (m=0). The decomposition used here was introduced by Iten et al. in [https://arxiv.org/abs/1501.06911](https://arxiv.org/abs/1501.06911).
  ...
  <Function id="qiskit.circuit.library.TwoLocal.iswap" name="iswap" signature="TwoLocal.iswap(qubit1, qubit2)">
    Apply [`iSwapGate`](qiskit.circuit.library.iSwapGate "qiskit.circuit.library.iSwapGate").
  </Function>

  ### mcmt

  <Function id="qiskit.circuit.library.TwoLocal.mcmt" name="mcmt" signature="TwoLocal.mcmt(gate, control_qubits, target_qubits, ancilla_qubits=None, mode='no-ancilla', *, single_control_gate_fun=None, q_controls=None, q_ancillae=None, q_targets=None)">
  ...
  <Function id="qiskit.circuit.library.TwoLocal.mcrx" name="mcrx" signature="TwoLocal.mcrx(theta, q_controls, q_target, use_basis_gates=False)">
  ...
  <Function id="qiskit.circuit.library.TwoLocal.mcry" name="mcry" signature="TwoLocal.mcry(theta, q_controls, q_target, q_ancillae, mode='basic', use_basis_gates=False)">
  ...
  <Function id="qiskit.circuit.library.TwoLocal.mcrz" name="mcrz" signature="TwoLocal.mcrz(lam, q_controls, q_target, use_basis_gates=False)">
  ...
  <Function id="qiskit.circuit.library.TwoLocal.mct" name="mct" signature="TwoLocal.mct(control_qubits, target_qubit, ancilla_qubits=None, mode='noancilla')">
    Apply `MCXGate`.
  </Function>

  ### mcu1

  <Function id="qiskit.circuit.library.TwoLocal.mcu1" name="mcu1" signature="TwoLocal.mcu1(lam, control_qubits, target_qubit)">
    Apply `MCU1Gate`.
  </Function>

  ### mcx

  <Function id="qiskit.circuit.library.TwoLocal.mcx" name="mcx" signature="TwoLocal.mcx(control_qubits, target_qubit, ancilla_qubits=None, mode='noancilla')">
    Apply `MCXGate`.
  ...
  <Function id="qiskit.circuit.library.TwoLocal.measure" name="measure" signature="TwoLocal.measure(qubit, cbit)">
  ...
  <Function id="qiskit.circuit.library.TwoLocal.measure_active" name="measure_active" signature="TwoLocal.measure_active(inplace=True)">
  ...
  <Function id="qiskit.circuit.library.TwoLocal.measure_all" name="measure_all" signature="TwoLocal.measure_all(inplace=True)">
  ...
  <Function id="qiskit.circuit.library.TwoLocal.mirror" name="mirror" signature="TwoLocal.mirror()">
  ...
  <Function id="qiskit.circuit.library.TwoLocal.ms" name="ms" signature="TwoLocal.ms(theta, qubits)">
    Apply [`MSGate`](qiskit.circuit.library.MSGate "qiskit.circuit.library.MSGate").
  </Function>

  ### num\_connected\_components

  <Function id="qiskit.circuit.library.TwoLocal.num_connected_components" name="num_connected_components" signature="TwoLocal.num_connected_components(unitary_only=False)">
  ...
  <Function id="qiskit.circuit.library.TwoLocal.num_nonlocal_gates" name="num_nonlocal_gates" signature="TwoLocal.num_nonlocal_gates()">
  ...
  <Function id="qiskit.circuit.library.TwoLocal.num_tensor_factors" name="num_tensor_factors" signature="TwoLocal.num_tensor_factors()">
  ...
  <Function id="qiskit.circuit.library.TwoLocal.num_unitary_factors" name="num_unitary_factors" signature="TwoLocal.num_unitary_factors()">
    Computes the number of tensor factors in the unitary (quantum) part of the circuit only.
  </Function>

  ### print\_settings

  <Function id="qiskit.circuit.library.TwoLocal.print_settings" name="print_settings" signature="TwoLocal.print_settings()">
  ...
  <Function id="qiskit.circuit.library.TwoLocal.qasm" name="qasm" signature="TwoLocal.qasm(formatted=False, filename=None)">
  ...
  <Function id="qiskit.circuit.library.TwoLocal.qbit_argument_conversion" name="qbit_argument_conversion" signature="TwoLocal.qbit_argument_conversion(qubit_representation)">
  ...
  <Function id="qiskit.circuit.library.TwoLocal.r" name="r" signature="TwoLocal.r(theta, phi, qubit, *, q=None)">
    Apply `RGate`.
  </Function>

  ### rcccx

  <Function id="qiskit.circuit.library.TwoLocal.rcccx" name="rcccx" signature="TwoLocal.rcccx(control_qubit1, control_qubit2, control_qubit3, target_qubit)">
    Apply [`RC3XGate`](qiskit.circuit.library.RC3XGate "qiskit.circuit.library.RC3XGate").
  </Function>

  ### rccx

  <Function id="qiskit.circuit.library.TwoLocal.rccx" name="rccx" signature="TwoLocal.rccx(control_qubit1, control_qubit2, target_qubit)">
    Apply [`RCCXGate`](qiskit.circuit.library.RCCXGate "qiskit.circuit.library.RCCXGate").
  </Function>

  ### remove\_final\_measurements

  <Function id="qiskit.circuit.library.TwoLocal.remove_final_measurements" name="remove_final_measurements" signature="TwoLocal.remove_final_measurements(inplace=True)">
  ...
  <Function id="qiskit.circuit.library.TwoLocal.reset" name="reset" signature="TwoLocal.reset(qubit)">
    Reset q.
  </Function>

  ### rx

  <Function id="qiskit.circuit.library.TwoLocal.rx" name="rx" signature="TwoLocal.rx(theta, qubit, *, label=None, q=None)">
    Apply [`RXGate`](qiskit.circuit.library.RXGate "qiskit.circuit.library.RXGate").
  </Function>

  ### rxx

  <Function id="qiskit.circuit.library.TwoLocal.rxx" name="rxx" signature="TwoLocal.rxx(theta, qubit1, qubit2)">
    Apply [`RXXGate`](qiskit.circuit.library.RXXGate "qiskit.circuit.library.RXXGate").
  </Function>

  ### ry

  <Function id="qiskit.circuit.library.TwoLocal.ry" name="ry" signature="TwoLocal.ry(theta, qubit, *, label=None, q=None)">
    Apply [`RYGate`](qiskit.circuit.library.RYGate "qiskit.circuit.library.RYGate").
  </Function>

  ### ryy

  <Function id="qiskit.circuit.library.TwoLocal.ryy" name="ryy" signature="TwoLocal.ryy(theta, qubit1, qubit2)">
    Apply [`RYYGate`](qiskit.circuit.library.RYYGate "qiskit.circuit.library.RYYGate").
  </Function>

  ### rz

  <Function id="qiskit.circuit.library.TwoLocal.rz" name="rz" signature="TwoLocal.rz(phi, qubit, *, q=None)">
    Apply [`RZGate`](qiskit.circuit.library.RZGate "qiskit.circuit.library.RZGate").
  </Function>

  ### rzx

  <Function id="qiskit.circuit.library.TwoLocal.rzx" name="rzx" signature="TwoLocal.rzx(theta, qubit1, qubit2)">
    Apply [`RZXGate`](qiskit.circuit.library.RZXGate "qiskit.circuit.library.RZXGate").
  </Function>

  ### rzz

  <Function id="qiskit.circuit.library.TwoLocal.rzz" name="rzz" signature="TwoLocal.rzz(theta, qubit1, qubit2)">
    Apply [`RZZGate`](qiskit.circuit.library.RZZGate "qiskit.circuit.library.RZZGate").
  </Function>

  ### s

  <Function id="qiskit.circuit.library.TwoLocal.s" name="s" signature="TwoLocal.s(qubit, *, q=None)">
    Apply [`SGate`](qiskit.circuit.library.SGate "qiskit.circuit.library.SGate").
  </Function>

  ### sdg

  <Function id="qiskit.circuit.library.TwoLocal.sdg" name="sdg" signature="TwoLocal.sdg(qubit, *, q=None)">
    Apply [`SdgGate`](qiskit.circuit.library.SdgGate "qiskit.circuit.library.SdgGate").
  </Function>

  ### size

  <Function id="qiskit.circuit.library.TwoLocal.size" name="size" signature="TwoLocal.size()">
  ...
  <Function id="qiskit.circuit.library.TwoLocal.snapshot" name="snapshot" signature="TwoLocal.snapshot(label, snapshot_type='statevector', qubits=None, params=None)">
  ...
  <Function id="qiskit.circuit.library.TwoLocal.snapshot_density_matrix" name="snapshot_density_matrix" signature="TwoLocal.snapshot_density_matrix(label, qubits=None)">
  ...
  <Function id="qiskit.circuit.library.TwoLocal.snapshot_expectation_value" name="snapshot_expectation_value" signature="TwoLocal.snapshot_expectation_value(label, op, qubits, single_shot=False, variance=False)">
  ...
  <Function id="qiskit.circuit.library.TwoLocal.snapshot_probabilities" name="snapshot_probabilities" signature="TwoLocal.snapshot_probabilities(label, qubits, variance=False)">
  ...
  <Function id="qiskit.circuit.library.TwoLocal.snapshot_stabilizer" name="snapshot_stabilizer" signature="TwoLocal.snapshot_stabilizer(label)">
  ...
  <Function id="qiskit.circuit.library.TwoLocal.snapshot_statevector" name="snapshot_statevector" signature="TwoLocal.snapshot_statevector(label)">
  ...
  <Function id="qiskit.circuit.library.TwoLocal.squ" name="squ" signature="TwoLocal.squ(unitary_matrix, qubit, mode='ZYZ', up_to_diagonal=False, *, u=None)">
  ...
  <Function id="qiskit.circuit.library.TwoLocal.swap" name="swap" signature="TwoLocal.swap(qubit1, qubit2)">
    Apply [`SwapGate`](qiskit.circuit.library.SwapGate "qiskit.circuit.library.SwapGate").
  </Function>

  ### t

  <Function id="qiskit.circuit.library.TwoLocal.t" name="t" signature="TwoLocal.t(qubit, *, q=None)">
    Apply [`TGate`](qiskit.circuit.library.TGate "qiskit.circuit.library.TGate").
  </Function>

  ### tdg

  <Function id="qiskit.circuit.library.TwoLocal.tdg" name="tdg" signature="TwoLocal.tdg(qubit, *, q=None)">
    Apply [`TdgGate`](qiskit.circuit.library.TdgGate "qiskit.circuit.library.TdgGate").
  </Function>

  ### to\_gate

  <Function id="qiskit.circuit.library.TwoLocal.to_gate" name="to_gate" signature="TwoLocal.to_gate(parameter_map=None)">
  ...
  <Function id="qiskit.circuit.library.TwoLocal.to_instruction" name="to_instruction" signature="TwoLocal.to_instruction(parameter_map=None)">
  ...
  <Function id="qiskit.circuit.library.TwoLocal.toffoli" name="toffoli" signature="TwoLocal.toffoli(control_qubit1, control_qubit2, target_qubit, *, ctl1=None, ctl2=None, tgt=None)">
    Apply [`CCXGate`](qiskit.circuit.library.CCXGate "qiskit.circuit.library.CCXGate").
  </Function>

  ### u1

  <Function id="qiskit.circuit.library.TwoLocal.u1" name="u1" signature="TwoLocal.u1(theta, qubit, *, q=None)">
    Apply [`U1Gate`](qiskit.circuit.library.U1Gate "qiskit.circuit.library.U1Gate").
  </Function>

  ### u2

  <Function id="qiskit.circuit.library.TwoLocal.u2" name="u2" signature="TwoLocal.u2(phi, lam, qubit, *, q=None)">
    Apply [`U2Gate`](qiskit.circuit.library.U2Gate "qiskit.circuit.library.U2Gate").
  </Function>

  ### u3

  <Function id="qiskit.circuit.library.TwoLocal.u3" name="u3" signature="TwoLocal.u3(theta, phi, lam, qubit, *, q=None)">
    Apply [`U3Gate`](qiskit.circuit.library.U3Gate "qiskit.circuit.library.U3Gate").
  </Function>

  ### uc

  <Function id="qiskit.circuit.library.TwoLocal.uc" name="uc" signature="TwoLocal.uc(gate_list, q_controls, q_target, up_to_diagonal=False)">
  ...
  <Function id="qiskit.circuit.library.TwoLocal.ucg" name="ucg" signature="TwoLocal.ucg(angle_list, q_controls, q_target, up_to_diagonal=False)">
    Deprecated version of uc.
  </Function>

  ### ucrx

  <Function id="qiskit.circuit.library.TwoLocal.ucrx" name="ucrx" signature="TwoLocal.ucrx(angle_list, q_controls, q_target)">
  ...
  <Function id="qiskit.circuit.library.TwoLocal.ucry" name="ucry" signature="TwoLocal.ucry(angle_list, q_controls, q_target)">
  ...
  <Function id="qiskit.circuit.library.TwoLocal.ucrz" name="ucrz" signature="TwoLocal.ucrz(angle_list, q_controls, q_target)">
  ...
  <Function id="qiskit.circuit.library.TwoLocal.ucx" name="ucx" signature="TwoLocal.ucx(angle_list, q_controls, q_target)">
    Deprecated version of ucrx.
  </Function>

  ### ucy

  <Function id="qiskit.circuit.library.TwoLocal.ucy" name="ucy" signature="TwoLocal.ucy(angle_list, q_controls, q_target)">
    Deprecated version of ucry.
  </Function>

  ### ucz

  <Function id="qiskit.circuit.library.TwoLocal.ucz" name="ucz" signature="TwoLocal.ucz(angle_list, q_controls, q_target)">
    Deprecated version of ucrz.
  </Function>

  ### unitary

  <Function id="qiskit.circuit.library.TwoLocal.unitary" name="unitary" signature="TwoLocal.unitary(obj, qubits, label=None)">
    Apply unitary gate to q.
  </Function>

  ### width

  <Function id="qiskit.circuit.library.TwoLocal.width" name="width" signature="TwoLocal.width()">
  ...
  <Function id="qiskit.circuit.library.TwoLocal.x" name="x" signature="TwoLocal.x(qubit, *, label=None, ctrl_state=None, q=None)">
    Apply [`XGate`](qiskit.circuit.library.XGate "qiskit.circuit.library.XGate").
  </Function>

  ### y

  <Function id="qiskit.circuit.library.TwoLocal.y" name="y" signature="TwoLocal.y(qubit, *, q=None)">
    Apply [`YGate`](qiskit.circuit.library.YGate "qiskit.circuit.library.YGate").
  </Function>

  ### z

  <Function id="qiskit.circuit.library.TwoLocal.z" name="z" signature="TwoLocal.z(qubit, *, q=None)">
