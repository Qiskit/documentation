...
<Class id="qiskit.circuit.library.TwoLocal" github="https://github.com/qiskit/qiskit/tree/stable/0.14/qiskit/circuit/library/n_local/two_local.py" signature="TwoLocal(num_qubits=None, rotation_blocks=None, entanglement_blocks=None, entanglement='full', reps=3, skip_unentangled_qubits=False, skip_final_rotation_layer=False, parameter_prefix='θ', insert_barriers=False, initial_state=None)">
  ...
  **Examples**
  ...
  <Attribute id="qiskit.circuit.library.TwoLocal.entanglement" signature="Union[str, List[str], List[List[str]], List[int], List[List[int]], List[List[List[int]]], List[List[List[List[int]]]], Callable[[int], str], Callable[[int], List[List[int]]]]">
  ...
  <Attribute id="qiskit.circuit.library.TwoLocal.entanglement_blocks" signature="List[qiskit.circuit.instruction.Instruction]">
  ...
  <Attribute id="qiskit.circuit.library.TwoLocal.initial_state" signature="Any">
  ...
  <Attribute id="qiskit.circuit.library.TwoLocal.insert_barriers" signature="bool">
  ...
  <Attribute id="qiskit.circuit.library.TwoLocal.num_layers" signature="int">
  ...
  <Attribute id="qiskit.circuit.library.TwoLocal.num_parameters_settable" signature="int">
  ...
  <Attribute id="qiskit.circuit.library.TwoLocal.num_qubits" signature="int">
  ...
  <Attribute id="qiskit.circuit.library.TwoLocal.ordered_parameters" signature="List[qiskit.circuit.parameter.Parameter]">
  ...
  <Attribute id="qiskit.circuit.library.TwoLocal.parameter_bounds" signature="Optional[List[Tuple[float, float]]]">
  ...
  <Attribute id="qiskit.circuit.library.TwoLocal.parameters" signature="Set[qiskit.circuit.parameter.Parameter]">
  ...
  <Attribute id="qiskit.circuit.library.TwoLocal.preferred_init_points" signature="Optional[List[float]]">
  ...
  <Attribute id="qiskit.circuit.library.TwoLocal.reps" signature="int">
  ...
  <Attribute id="qiskit.circuit.library.TwoLocal.rotation_blocks" signature="List[qiskit.circuit.instruction.Instruction]">
  ...
  <Function id="qiskit.circuit.library.TwoLocal.cast" signature="static TwoLocal.cast(value, _type)">
  ...
  <Function id="qiskit.circuit.library.TwoLocal.cls_instances" signature="classmethod TwoLocal.cls_instances()">
    Return the current number of instances of this class, useful for auto naming.
  </Function>

  ### cls\_prefix

  <Function id="qiskit.circuit.library.TwoLocal.cls_prefix" signature="classmethod TwoLocal.cls_prefix()">
  ...
  <Function id="qiskit.circuit.library.TwoLocal.from_qasm_file" signature="static TwoLocal.from_qasm_file(path)">
  ...
  <Function id="qiskit.circuit.library.TwoLocal.from_qasm_str" signature="static TwoLocal.from_qasm_str(qasm_str)">
