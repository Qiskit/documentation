---
title: ParameterExpression (v0.19)
description: API reference for qiskit.circuit.ParameterExpression in qiskit v0.19
...
<Class id="qiskit.circuit.ParameterExpression" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.14/qiskit/circuit/parameterexpression.py" signature="ParameterExpression(symbol_map, expr)" modifiers="class">
  ...
  *   **expr** (*sympy.Expr*) – Expression of sympy.Symbols.
  ...
  <span id="parameterexpression-parameters" />
  ...
  <span id="parameterexpression-subs" />
