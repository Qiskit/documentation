---
title: QuantumVolume (v0.19)
description: API reference for qiskit.circuit.library.QuantumVolume in qiskit v0.19
...
<Class id="qiskit.circuit.library.QuantumVolume" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.14/qiskit/circuit/library/quantum_volume.py" signature="QuantumVolume(num_qubits, depth=None, seed=None, classical_permutation=True)" modifiers="class">
  ...
  **Reference Circuit:**
  ...
  ![../\_images/qiskit.circuit.library.QuantumVolume\_0\_2.png](/docs/images/api/qiskit/0.19/qiskit.circuit.library.QuantumVolume_0_2.avif)
  ...
  *   **classical\_permutation** (`bool`) – use classical permutations at every layer, rather than quantum.
  ...
  <span id="quantumvolume-extension-lib" />

  ### extension\_lib

  <Attribute id="qiskit.circuit.library.QuantumVolume.extension_lib" attributeValue="'include &#x22;qelib1.inc&#x22;;'" />

  <span id="quantumvolume-header" />

  ### header

  <Attribute id="qiskit.circuit.library.QuantumVolume.header" attributeValue="'OPENQASM 2.0;'" />

  <span id="quantumvolume-instances" />

  ### instances

  <Attribute id="qiskit.circuit.library.QuantumVolume.instances" attributeValue="8" />

  <span id="quantumvolume-n-qubits" />

  ### n\_qubits

  <Attribute id="qiskit.circuit.library.QuantumVolume.n_qubits">
    Deprecated, use `num_qubits` instead. Return number of qubits.
  </Attribute>

  <span id="quantumvolume-num-clbits" />
  ...
  <span id="quantumvolume-num-parameters" />
  ...
  <span id="quantumvolume-num-qubits" />
  ...
  <span id="quantumvolume-parameters" />
  ...
  <span id="quantumvolume-and" />

  ### AND

  <Function id="qiskit.circuit.library.QuantumVolume.AND" signature="QuantumVolume.AND(qr_variables, qb_target, qr_ancillae, flags=None, mct_mode='no-ancilla')">
  ...
  <span id="quantumvolume-or" />

  ### OR

  <Function id="qiskit.circuit.library.QuantumVolume.OR" signature="QuantumVolume.OR(qr_variables, qb_target, qr_ancillae, flags=None, mct_mode='basic')">
  ...
  <span id="quantumvolume-getitem" />

  ### \_\_getitem\_\_

  <Function id="qiskit.circuit.library.QuantumVolume.__getitem__" signature="QuantumVolume.__getitem__(item)">
    Return indexed operation.
  </Function>

  <span id="quantumvolume-len" />

  ### \_\_len\_\_

  <Function id="qiskit.circuit.library.QuantumVolume.__len__" signature="QuantumVolume.__len__()">
    Return number of operations in circuit.
  </Function>

  <span id="quantumvolume-add-register" />

  ### add\_register

  <Function id="qiskit.circuit.library.QuantumVolume.add_register" signature="QuantumVolume.add_register(*regs)">
    Add registers.
  </Function>

  <span id="quantumvolume-append" />

  ### append

  <Function id="qiskit.circuit.library.QuantumVolume.append" signature="QuantumVolume.append(instruction, qargs=None, cargs=None)">
  ...
  <span id="quantumvolume-assign-parameters" />

  ### assign\_parameters

  <Function id="qiskit.circuit.library.QuantumVolume.assign_parameters" signature="QuantumVolume.assign_parameters(param_dict, inplace=False)">
  ...
  <span id="quantumvolume-barrier" />

  ### barrier

  <Function id="qiskit.circuit.library.QuantumVolume.barrier" signature="QuantumVolume.barrier(*qargs)">
    Apply `Barrier`. If qargs is None, applies to all.
  </Function>

  <span id="quantumvolume-bind-parameters" />

  ### bind\_parameters

  <Function id="qiskit.circuit.library.QuantumVolume.bind_parameters" signature="QuantumVolume.bind_parameters(value_dict)">
  ...
  <span id="quantumvolume-cast" />

  ### cast

  <Function id="qiskit.circuit.library.QuantumVolume.cast" signature="QuantumVolume.cast(value, _type)" modifiers="static">
    Best effort to cast value to type. Otherwise, returns the value.
  </Function>

  <span id="quantumvolume-cbit-argument-conversion" />

  ### cbit\_argument\_conversion

  <Function id="qiskit.circuit.library.QuantumVolume.cbit_argument_conversion" signature="QuantumVolume.cbit_argument_conversion(clbit_representation)">
  ...
  <span id="quantumvolume-ccx" />

  ### ccx

  <Function id="qiskit.circuit.library.QuantumVolume.ccx" signature="QuantumVolume.ccx(control_qubit1, control_qubit2, target_qubit, *, ctl1=None, ctl2=None, tgt=None)">
    Apply [`CCXGate`](qiskit.circuit.library.CCXGate "qiskit.circuit.library.CCXGate").
  </Function>

  <span id="quantumvolume-ch" />

  ### ch

  <Function id="qiskit.circuit.library.QuantumVolume.ch" signature="QuantumVolume.ch(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CHGate`](qiskit.circuit.library.CHGate "qiskit.circuit.library.CHGate").
  </Function>

  <span id="quantumvolume-cls-instances" />

  ### cls\_instances

  <Function id="qiskit.circuit.library.QuantumVolume.cls_instances" signature="QuantumVolume.cls_instances()" modifiers="classmethod">
    Return the current number of instances of this class, useful for auto naming.
  </Function>

  <span id="quantumvolume-cls-prefix" />

  ### cls\_prefix

  <Function id="qiskit.circuit.library.QuantumVolume.cls_prefix" signature="QuantumVolume.cls_prefix()" modifiers="classmethod">
    Return the prefix to use for auto naming.
  </Function>

  <span id="quantumvolume-cnot" />

  ### cnot

  <Function id="qiskit.circuit.library.QuantumVolume.cnot" signature="QuantumVolume.cnot(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CXGate`](qiskit.circuit.library.CXGate "qiskit.circuit.library.CXGate").
  </Function>

  <span id="quantumvolume-combine" />

  ### combine

  <Function id="qiskit.circuit.library.QuantumVolume.combine" signature="QuantumVolume.combine(rhs)">
  ...
  <span id="quantumvolume-compose" />

  ### compose

  <Function id="qiskit.circuit.library.QuantumVolume.compose" signature="QuantumVolume.compose(other, qubits=None, clbits=None, front=False, inplace=False)">
  ...
  <span id="quantumvolume-copy" />

  ### copy

  <Function id="qiskit.circuit.library.QuantumVolume.copy" signature="QuantumVolume.copy(name=None)">
    Copy the circuit.
  ...
  <span id="quantumvolume-count-ops" />

  ### count\_ops

  <Function id="qiskit.circuit.library.QuantumVolume.count_ops" signature="QuantumVolume.count_ops()">
  ...
  <span id="quantumvolume-crx" />

  ### crx

  <Function id="qiskit.circuit.library.QuantumVolume.crx" signature="QuantumVolume.crx(theta, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CRXGate`](qiskit.circuit.library.CRXGate "qiskit.circuit.library.CRXGate").
  </Function>

  <span id="quantumvolume-cry" />

  ### cry

  <Function id="qiskit.circuit.library.QuantumVolume.cry" signature="QuantumVolume.cry(theta, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CRYGate`](qiskit.circuit.library.CRYGate "qiskit.circuit.library.CRYGate").
  </Function>

  <span id="quantumvolume-crz" />

  ### crz

  <Function id="qiskit.circuit.library.QuantumVolume.crz" signature="QuantumVolume.crz(theta, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CRZGate`](qiskit.circuit.library.CRZGate "qiskit.circuit.library.CRZGate").
  </Function>

  <span id="quantumvolume-cswap" />

  ### cswap

  <Function id="qiskit.circuit.library.QuantumVolume.cswap" signature="QuantumVolume.cswap(control_qubit, target_qubit1, target_qubit2, *, label=None, ctrl_state=None, ctl=None, tgt1=None, tgt2=None)">
    Apply [`CSwapGate`](qiskit.circuit.library.CSwapGate "qiskit.circuit.library.CSwapGate").
  </Function>

  <span id="quantumvolume-cu1" />

  ### cu1

  <Function id="qiskit.circuit.library.QuantumVolume.cu1" signature="QuantumVolume.cu1(theta, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CU1Gate`](qiskit.circuit.library.CU1Gate "qiskit.circuit.library.CU1Gate").
  </Function>

  <span id="quantumvolume-cu3" />

  ### cu3

  <Function id="qiskit.circuit.library.QuantumVolume.cu3" signature="QuantumVolume.cu3(theta, phi, lam, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CU3Gate`](qiskit.circuit.library.CU3Gate "qiskit.circuit.library.CU3Gate").
  </Function>

  <span id="quantumvolume-cx" />

  ### cx

  <Function id="qiskit.circuit.library.QuantumVolume.cx" signature="QuantumVolume.cx(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CXGate`](qiskit.circuit.library.CXGate "qiskit.circuit.library.CXGate").
  </Function>

  <span id="quantumvolume-cy" />

  ### cy

  <Function id="qiskit.circuit.library.QuantumVolume.cy" signature="QuantumVolume.cy(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CYGate`](qiskit.circuit.library.CYGate "qiskit.circuit.library.CYGate").
  </Function>

  <span id="quantumvolume-cz" />

  ### cz

  <Function id="qiskit.circuit.library.QuantumVolume.cz" signature="QuantumVolume.cz(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CZGate`](qiskit.circuit.library.CZGate "qiskit.circuit.library.CZGate").
  </Function>

  <span id="quantumvolume-dcx" />

  ### dcx

  <Function id="qiskit.circuit.library.QuantumVolume.dcx" signature="QuantumVolume.dcx(qubit1, qubit2)">
    Apply [`DCXGate`](qiskit.circuit.library.DCXGate "qiskit.circuit.library.DCXGate").
  </Function>

  <span id="quantumvolume-decompose" />

  ### decompose

  <Function id="qiskit.circuit.library.QuantumVolume.decompose" signature="QuantumVolume.decompose()">
  ...
  <span id="quantumvolume-depth" />

  ### depth

  <Function id="qiskit.circuit.library.QuantumVolume.depth" signature="QuantumVolume.depth()">
  ...
  <span id="quantumvolume-diag-gate" />

  ### diag\_gate

  <Function id="qiskit.circuit.library.QuantumVolume.diag_gate" signature="QuantumVolume.diag_gate(diag, qubit)">
    Deprecated version of QuantumCircuit.diagonal.
  </Function>

  <span id="quantumvolume-diagonal" />

  ### diagonal

  <Function id="qiskit.circuit.library.QuantumVolume.diagonal" signature="QuantumVolume.diagonal(diag, qubit)">
  ...
  <span id="quantumvolume-extend" />

  ### extend

  <Function id="qiskit.circuit.library.QuantumVolume.extend" signature="QuantumVolume.extend(rhs)">
  ...
  <span id="quantumvolume-fredkin" />

  ### fredkin

  <Function id="qiskit.circuit.library.QuantumVolume.fredkin" signature="QuantumVolume.fredkin(control_qubit, target_qubit1, target_qubit2, *, ctl=None, tgt1=None, tgt2=None)">
    Apply [`CSwapGate`](qiskit.circuit.library.CSwapGate "qiskit.circuit.library.CSwapGate").
  </Function>

  <span id="quantumvolume-from-qasm-file" />

  ### from\_qasm\_file

  <Function id="qiskit.circuit.library.QuantumVolume.from_qasm_file" signature="QuantumVolume.from_qasm_file(path)" modifiers="static">
  ...
  <span id="quantumvolume-from-qasm-str" />

  ### from\_qasm\_str

  <Function id="qiskit.circuit.library.QuantumVolume.from_qasm_str" signature="QuantumVolume.from_qasm_str(qasm_str)" modifiers="static">
  ...
  <span id="quantumvolume-h" />

  ### h

  <Function id="qiskit.circuit.library.QuantumVolume.h" signature="QuantumVolume.h(qubit, *, q=None)">
    Apply [`HGate`](qiskit.circuit.library.HGate "qiskit.circuit.library.HGate").
  </Function>

  <span id="quantumvolume-hamiltonian" />

  ### hamiltonian

  <Function id="qiskit.circuit.library.QuantumVolume.hamiltonian" signature="QuantumVolume.hamiltonian(operator, time, qubits, label=None)">
    Apply hamiltonian evolution to to qubits.
  </Function>

  <span id="quantumvolume-has-register" />

  ### has\_register

  <Function id="qiskit.circuit.library.QuantumVolume.has_register" signature="QuantumVolume.has_register(register)">
  ...
  <span id="quantumvolume-i" />

  ### i

  <Function id="qiskit.circuit.library.QuantumVolume.i" signature="QuantumVolume.i(qubit, *, q=None)">
    Apply [`IGate`](qiskit.circuit.library.IGate "qiskit.circuit.library.IGate").
  </Function>

  <span id="quantumvolume-id" />

  ### id

  <Function id="qiskit.circuit.library.QuantumVolume.id" signature="QuantumVolume.id(qubit, *, q=None)">
    Apply [`IGate`](qiskit.circuit.library.IGate "qiskit.circuit.library.IGate").
  </Function>

  <span id="quantumvolume-iden" />

  ### iden

  <Function id="qiskit.circuit.library.QuantumVolume.iden" signature="QuantumVolume.iden(qubit, *, q=None)">
    Deprecated identity gate.
  </Function>

  <span id="quantumvolume-initialize" />

  ### initialize

  <Function id="qiskit.circuit.library.QuantumVolume.initialize" signature="QuantumVolume.initialize(params, qubits)">
    Apply initialize to circuit.
  </Function>

  <span id="quantumvolume-inverse" />

  ### inverse

  <Function id="qiskit.circuit.library.QuantumVolume.inverse" signature="QuantumVolume.inverse()">
    Invert this circuit.
  ...
  <span id="quantumvolume-iso" />

  ### iso

  <Function id="qiskit.circuit.library.QuantumVolume.iso" signature="QuantumVolume.iso(isometry, q_input, q_ancillas_for_output, q_ancillas_zero=None, q_ancillas_dirty=None)">
  ...
  <span id="quantumvolume-isometry" />

  ### isometry

  <Function id="qiskit.circuit.library.QuantumVolume.isometry" signature="QuantumVolume.isometry(isometry, q_input, q_ancillas_for_output, q_ancillas_zero=None, q_ancillas_dirty=None)">
    Attach an arbitrary isometry from m to n qubits to a circuit. In particular, this allows to attach arbitrary unitaries on n qubits (m=n) or to prepare any state on n qubits (m=0). The decomposition used here was introduced by Iten et al. in [https://arxiv.org/abs/1501.06911](https://arxiv.org/abs/1501.06911).
  ...
  <span id="quantumvolume-iswap" />

  ### iswap

  <Function id="qiskit.circuit.library.QuantumVolume.iswap" signature="QuantumVolume.iswap(qubit1, qubit2)">
    Apply [`iSwapGate`](qiskit.circuit.library.iSwapGate "qiskit.circuit.library.iSwapGate").
  </Function>

  <span id="quantumvolume-mcmt" />

  ### mcmt

  <Function id="qiskit.circuit.library.QuantumVolume.mcmt" signature="QuantumVolume.mcmt(gate, control_qubits, target_qubits, ancilla_qubits=None, mode='no-ancilla', *, single_control_gate_fun=None, q_controls=None, q_ancillae=None, q_targets=None)">
    Apply a multi-control, multi-target using a generic gate.

    This can also be used to implement a generic multi-control gate, as the target could also be of length 1.
  </Function>

  <span id="quantumvolume-mcrx" />

  ### mcrx

  <Function id="qiskit.circuit.library.QuantumVolume.mcrx" signature="QuantumVolume.mcrx(theta, q_controls, q_target, use_basis_gates=False)">
  ...
  <span id="quantumvolume-mcry" />

  ### mcry

  <Function id="qiskit.circuit.library.QuantumVolume.mcry" signature="QuantumVolume.mcry(theta, q_controls, q_target, q_ancillae, mode='basic', use_basis_gates=False)">
  ...
  <span id="quantumvolume-mcrz" />

  ### mcrz

  <Function id="qiskit.circuit.library.QuantumVolume.mcrz" signature="QuantumVolume.mcrz(lam, q_controls, q_target, use_basis_gates=False)">
  ...
  <span id="quantumvolume-mct" />

  ### mct

  <Function id="qiskit.circuit.library.QuantumVolume.mct" signature="QuantumVolume.mct(control_qubits, target_qubit, ancilla_qubits=None, mode='noancilla')">
    Apply `MCXGate`.
  </Function>

  <span id="quantumvolume-mcu1" />

  ### mcu1

  <Function id="qiskit.circuit.library.QuantumVolume.mcu1" signature="QuantumVolume.mcu1(lam, control_qubits, target_qubit)">
    Apply `MCU1Gate`.
  </Function>

  <span id="quantumvolume-mcx" />

  ### mcx

  <Function id="qiskit.circuit.library.QuantumVolume.mcx" signature="QuantumVolume.mcx(control_qubits, target_qubit, ancilla_qubits=None, mode='noancilla')">
    Apply `MCXGate`.
  ...
  <span id="quantumvolume-measure" />

  ### measure

  <Function id="qiskit.circuit.library.QuantumVolume.measure" signature="QuantumVolume.measure(qubit, cbit)">
  ...
  <span id="quantumvolume-measure-active" />

  ### measure\_active

  <Function id="qiskit.circuit.library.QuantumVolume.measure_active" signature="QuantumVolume.measure_active(inplace=True)">
  ...
  <span id="quantumvolume-measure-all" />

  ### measure\_all

  <Function id="qiskit.circuit.library.QuantumVolume.measure_all" signature="QuantumVolume.measure_all(inplace=True)">
  ...
  <span id="quantumvolume-mirror" />

  ### mirror

  <Function id="qiskit.circuit.library.QuantumVolume.mirror" signature="QuantumVolume.mirror()">
  ...
  <span id="quantumvolume-ms" />

  ### ms

  <Function id="qiskit.circuit.library.QuantumVolume.ms" signature="QuantumVolume.ms(theta, qubits)">
    Apply [`MSGate`](qiskit.circuit.library.MSGate "qiskit.circuit.library.MSGate").
  </Function>

  <span id="quantumvolume-num-connected-components" />

  ### num\_connected\_components

  <Function id="qiskit.circuit.library.QuantumVolume.num_connected_components" signature="QuantumVolume.num_connected_components(unitary_only=False)">
  ...
  <span id="quantumvolume-num-nonlocal-gates" />

  ### num\_nonlocal\_gates

  <Function id="qiskit.circuit.library.QuantumVolume.num_nonlocal_gates" signature="QuantumVolume.num_nonlocal_gates()">
    Return number of non-local gates (i.e. involving 2+ qubits).

    Conditional nonlocal gates are also included.
  </Function>

  <span id="quantumvolume-num-tensor-factors" />

  ### num\_tensor\_factors

  <Function id="qiskit.circuit.library.QuantumVolume.num_tensor_factors" signature="QuantumVolume.num_tensor_factors()">
  ...
  <span id="quantumvolume-num-unitary-factors" />

  ### num\_unitary\_factors

  <Function id="qiskit.circuit.library.QuantumVolume.num_unitary_factors" signature="QuantumVolume.num_unitary_factors()">
    Computes the number of tensor factors in the unitary (quantum) part of the circuit only.
  </Function>

  <span id="quantumvolume-qasm" />

  ### qasm

  <Function id="qiskit.circuit.library.QuantumVolume.qasm" signature="QuantumVolume.qasm(formatted=False, filename=None)">
  ...
  <span id="quantumvolume-qbit-argument-conversion" />

  ### qbit\_argument\_conversion

  <Function id="qiskit.circuit.library.QuantumVolume.qbit_argument_conversion" signature="QuantumVolume.qbit_argument_conversion(qubit_representation)">
  ...
  <span id="quantumvolume-r" />

  ### r

  <Function id="qiskit.circuit.library.QuantumVolume.r" signature="QuantumVolume.r(theta, phi, qubit, *, q=None)">
    Apply `RGate`.
  </Function>

  <span id="quantumvolume-rcccx" />

  ### rcccx

  <Function id="qiskit.circuit.library.QuantumVolume.rcccx" signature="QuantumVolume.rcccx(control_qubit1, control_qubit2, control_qubit3, target_qubit)">
    Apply [`RC3XGate`](qiskit.circuit.library.RC3XGate "qiskit.circuit.library.RC3XGate").
  </Function>

  <span id="quantumvolume-rccx" />

  ### rccx

  <Function id="qiskit.circuit.library.QuantumVolume.rccx" signature="QuantumVolume.rccx(control_qubit1, control_qubit2, target_qubit)">
    Apply [`RCCXGate`](qiskit.circuit.library.RCCXGate "qiskit.circuit.library.RCCXGate").
  </Function>

  <span id="quantumvolume-remove-final-measurements" />

  ### remove\_final\_measurements

  <Function id="qiskit.circuit.library.QuantumVolume.remove_final_measurements" signature="QuantumVolume.remove_final_measurements(inplace=True)">
  ...
  <span id="quantumvolume-reset" />

  ### reset

  <Function id="qiskit.circuit.library.QuantumVolume.reset" signature="QuantumVolume.reset(qubit)">
    Reset q.
  </Function>

  <span id="quantumvolume-rx" />

  ### rx

  <Function id="qiskit.circuit.library.QuantumVolume.rx" signature="QuantumVolume.rx(theta, qubit, *, label=None, q=None)">
    Apply [`RXGate`](qiskit.circuit.library.RXGate "qiskit.circuit.library.RXGate").
  </Function>

  <span id="quantumvolume-rxx" />

  ### rxx

  <Function id="qiskit.circuit.library.QuantumVolume.rxx" signature="QuantumVolume.rxx(theta, qubit1, qubit2)">
    Apply [`RXXGate`](qiskit.circuit.library.RXXGate "qiskit.circuit.library.RXXGate").
  </Function>

  <span id="quantumvolume-ry" />

  ### ry

  <Function id="qiskit.circuit.library.QuantumVolume.ry" signature="QuantumVolume.ry(theta, qubit, *, label=None, q=None)">
    Apply [`RYGate`](qiskit.circuit.library.RYGate "qiskit.circuit.library.RYGate").
  </Function>

  <span id="quantumvolume-ryy" />

  ### ryy

  <Function id="qiskit.circuit.library.QuantumVolume.ryy" signature="QuantumVolume.ryy(theta, qubit1, qubit2)">
    Apply [`RYYGate`](qiskit.circuit.library.RYYGate "qiskit.circuit.library.RYYGate").
  </Function>

  <span id="quantumvolume-rz" />

  ### rz

  <Function id="qiskit.circuit.library.QuantumVolume.rz" signature="QuantumVolume.rz(phi, qubit, *, q=None)">
    Apply [`RZGate`](qiskit.circuit.library.RZGate "qiskit.circuit.library.RZGate").
  </Function>

  <span id="quantumvolume-rzx" />

  ### rzx

  <Function id="qiskit.circuit.library.QuantumVolume.rzx" signature="QuantumVolume.rzx(theta, qubit1, qubit2)">
    Apply [`RZXGate`](qiskit.circuit.library.RZXGate "qiskit.circuit.library.RZXGate").
  </Function>

  <span id="quantumvolume-rzz" />

  ### rzz

  <Function id="qiskit.circuit.library.QuantumVolume.rzz" signature="QuantumVolume.rzz(theta, qubit1, qubit2)">
    Apply [`RZZGate`](qiskit.circuit.library.RZZGate "qiskit.circuit.library.RZZGate").
  </Function>

  <span id="quantumvolume-s" />

  ### s

  <Function id="qiskit.circuit.library.QuantumVolume.s" signature="QuantumVolume.s(qubit, *, q=None)">
    Apply [`SGate`](qiskit.circuit.library.SGate "qiskit.circuit.library.SGate").
  </Function>

  <span id="quantumvolume-sdg" />

  ### sdg

  <Function id="qiskit.circuit.library.QuantumVolume.sdg" signature="QuantumVolume.sdg(qubit, *, q=None)">
    Apply [`SdgGate`](qiskit.circuit.library.SdgGate "qiskit.circuit.library.SdgGate").
  </Function>

  <span id="quantumvolume-size" />

  ### size

  <Function id="qiskit.circuit.library.QuantumVolume.size" signature="QuantumVolume.size()">
  ...
  <span id="quantumvolume-snapshot" />

  ### snapshot

  <Function id="qiskit.circuit.library.QuantumVolume.snapshot" signature="QuantumVolume.snapshot(label, snapshot_type='statevector', qubits=None, params=None)">
  ...
  <span id="quantumvolume-snapshot-density-matrix" />

  ### snapshot\_density\_matrix

  <Function id="qiskit.circuit.library.QuantumVolume.snapshot_density_matrix" signature="QuantumVolume.snapshot_density_matrix(label, qubits=None)">
  ...
  <span id="quantumvolume-snapshot-expectation-value" />

  ### snapshot\_expectation\_value

  <Function id="qiskit.circuit.library.QuantumVolume.snapshot_expectation_value" signature="QuantumVolume.snapshot_expectation_value(label, op, qubits, single_shot=False, variance=False)">
  ...
  <span id="quantumvolume-snapshot-probabilities" />

  ### snapshot\_probabilities

  <Function id="qiskit.circuit.library.QuantumVolume.snapshot_probabilities" signature="QuantumVolume.snapshot_probabilities(label, qubits, variance=False)">
  ...
  <span id="quantumvolume-snapshot-stabilizer" />

  ### snapshot\_stabilizer

  <Function id="qiskit.circuit.library.QuantumVolume.snapshot_stabilizer" signature="QuantumVolume.snapshot_stabilizer(label)">
  ...
  <span id="quantumvolume-snapshot-statevector" />

  ### snapshot\_statevector

  <Function id="qiskit.circuit.library.QuantumVolume.snapshot_statevector" signature="QuantumVolume.snapshot_statevector(label)">
  ...
  <span id="quantumvolume-squ" />

  ### squ

  <Function id="qiskit.circuit.library.QuantumVolume.squ" signature="QuantumVolume.squ(unitary_matrix, qubit, mode='ZYZ', up_to_diagonal=False, *, u=None)">
  ...
  <span id="quantumvolume-swap" />

  ### swap

  <Function id="qiskit.circuit.library.QuantumVolume.swap" signature="QuantumVolume.swap(qubit1, qubit2)">
    Apply [`SwapGate`](qiskit.circuit.library.SwapGate "qiskit.circuit.library.SwapGate").
  </Function>

  <span id="quantumvolume-t" />

  ### t

  <Function id="qiskit.circuit.library.QuantumVolume.t" signature="QuantumVolume.t(qubit, *, q=None)">
    Apply [`TGate`](qiskit.circuit.library.TGate "qiskit.circuit.library.TGate").
  </Function>

  <span id="quantumvolume-tdg" />

  ### tdg

  <Function id="qiskit.circuit.library.QuantumVolume.tdg" signature="QuantumVolume.tdg(qubit, *, q=None)">
    Apply [`TdgGate`](qiskit.circuit.library.TdgGate "qiskit.circuit.library.TdgGate").
  </Function>

  <span id="quantumvolume-to-gate" />

  ### to\_gate

  <Function id="qiskit.circuit.library.QuantumVolume.to_gate" signature="QuantumVolume.to_gate(parameter_map=None)">
  ...
  <span id="quantumvolume-to-instruction" />

  ### to\_instruction

  <Function id="qiskit.circuit.library.QuantumVolume.to_instruction" signature="QuantumVolume.to_instruction(parameter_map=None)">
  ...
  <span id="quantumvolume-toffoli" />

  ### toffoli

  <Function id="qiskit.circuit.library.QuantumVolume.toffoli" signature="QuantumVolume.toffoli(control_qubit1, control_qubit2, target_qubit, *, ctl1=None, ctl2=None, tgt=None)">
    Apply [`CCXGate`](qiskit.circuit.library.CCXGate "qiskit.circuit.library.CCXGate").
  </Function>

  <span id="quantumvolume-u1" />

  ### u1

  <Function id="qiskit.circuit.library.QuantumVolume.u1" signature="QuantumVolume.u1(theta, qubit, *, q=None)">
    Apply [`U1Gate`](qiskit.circuit.library.U1Gate "qiskit.circuit.library.U1Gate").
  </Function>

  <span id="quantumvolume-u2" />

  ### u2

  <Function id="qiskit.circuit.library.QuantumVolume.u2" signature="QuantumVolume.u2(phi, lam, qubit, *, q=None)">
    Apply [`U2Gate`](qiskit.circuit.library.U2Gate "qiskit.circuit.library.U2Gate").
  </Function>

  <span id="quantumvolume-u3" />

  ### u3

  <Function id="qiskit.circuit.library.QuantumVolume.u3" signature="QuantumVolume.u3(theta, phi, lam, qubit, *, q=None)">
    Apply [`U3Gate`](qiskit.circuit.library.U3Gate "qiskit.circuit.library.U3Gate").
  </Function>

  <span id="quantumvolume-uc" />

  ### uc

  <Function id="qiskit.circuit.library.QuantumVolume.uc" signature="QuantumVolume.uc(gate_list, q_controls, q_target, up_to_diagonal=False)">
  ...
  <span id="quantumvolume-ucg" />

  ### ucg

  <Function id="qiskit.circuit.library.QuantumVolume.ucg" signature="QuantumVolume.ucg(angle_list, q_controls, q_target, up_to_diagonal=False)">
    Deprecated version of uc.
  </Function>

  <span id="quantumvolume-ucrx" />

  ### ucrx

  <Function id="qiskit.circuit.library.QuantumVolume.ucrx" signature="QuantumVolume.ucrx(angle_list, q_controls, q_target)">
  ...
  <span id="quantumvolume-ucry" />

  ### ucry

  <Function id="qiskit.circuit.library.QuantumVolume.ucry" signature="QuantumVolume.ucry(angle_list, q_controls, q_target)">
  ...
  <span id="quantumvolume-ucrz" />

  ### ucrz

  <Function id="qiskit.circuit.library.QuantumVolume.ucrz" signature="QuantumVolume.ucrz(angle_list, q_controls, q_target)">
  ...
  <span id="quantumvolume-ucx" />

  ### ucx

  <Function id="qiskit.circuit.library.QuantumVolume.ucx" signature="QuantumVolume.ucx(angle_list, q_controls, q_target)">
    Deprecated version of ucrx.
  </Function>

  <span id="quantumvolume-ucy" />

  ### ucy

  <Function id="qiskit.circuit.library.QuantumVolume.ucy" signature="QuantumVolume.ucy(angle_list, q_controls, q_target)">
    Deprecated version of ucry.
  </Function>

  <span id="quantumvolume-ucz" />

  ### ucz

  <Function id="qiskit.circuit.library.QuantumVolume.ucz" signature="QuantumVolume.ucz(angle_list, q_controls, q_target)">
    Deprecated version of ucrz.
  </Function>

  <span id="quantumvolume-unitary" />

  ### unitary

  <Function id="qiskit.circuit.library.QuantumVolume.unitary" signature="QuantumVolume.unitary(obj, qubits, label=None)">
    Apply unitary gate to q.
  </Function>

  <span id="quantumvolume-width" />

  ### width

  <Function id="qiskit.circuit.library.QuantumVolume.width" signature="QuantumVolume.width()">
  ...
  <span id="quantumvolume-x" />

  ### x

  <Function id="qiskit.circuit.library.QuantumVolume.x" signature="QuantumVolume.x(qubit, *, label=None, ctrl_state=None, q=None)">
    Apply [`XGate`](qiskit.circuit.library.XGate "qiskit.circuit.library.XGate").
  </Function>

  <span id="quantumvolume-y" />

  ### y

  <Function id="qiskit.circuit.library.QuantumVolume.y" signature="QuantumVolume.y(qubit, *, q=None)">
    Apply [`YGate`](qiskit.circuit.library.YGate "qiskit.circuit.library.YGate").
  </Function>

  <span id="quantumvolume-z" />

  ### z

  <Function id="qiskit.circuit.library.QuantumVolume.z" signature="QuantumVolume.z(qubit, *, q=None)">
