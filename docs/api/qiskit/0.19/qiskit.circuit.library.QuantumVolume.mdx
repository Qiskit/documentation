...
<Class id="qiskit.circuit.library.QuantumVolume" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.14/qiskit/circuit/library/quantum_volume.py" signature="QuantumVolume(num_qubits, depth=None, seed=None, classical_permutation=True)">
  ...
  *   **classical\_permutation** (`bool`) – use classical permutations at every layer, rather than quantum.
  ...
  <Function id="qiskit.circuit.library.QuantumVolume.cast" signature="static QuantumVolume.cast(value, _type)">
  ...
  <Function id="qiskit.circuit.library.QuantumVolume.cls_instances" signature="classmethod QuantumVolume.cls_instances()">
    Return the current number of instances of this class, useful for auto naming.
  </Function>

  ### cls\_prefix

  <Function id="qiskit.circuit.library.QuantumVolume.cls_prefix" signature="classmethod QuantumVolume.cls_prefix()">
  ...
  <Function id="qiskit.circuit.library.QuantumVolume.from_qasm_file" signature="static QuantumVolume.from_qasm_file(path)">
  ...
  <Function id="qiskit.circuit.library.QuantumVolume.from_qasm_str" signature="static QuantumVolume.from_qasm_str(qasm_str)">
