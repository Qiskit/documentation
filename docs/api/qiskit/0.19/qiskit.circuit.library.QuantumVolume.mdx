...
<Class id="qiskit.circuit.library.QuantumVolume" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.14/qiskit/circuit/library/quantum_volume.py" signature="QuantumVolume(num_qubits, depth=None, seed=None, classical_permutation=True)">
  ...
  *   **classical\_permutation** (`bool`) – use classical permutations at every layer, rather than quantum.
  ...
  <Attribute id="qiskit.circuit.library.QuantumVolume.extension_lib" signature="= 'include \&#x22;qelib1.inc\&#x22;;'" />

  ### header

  <Attribute id="qiskit.circuit.library.QuantumVolume.header" signature="= 'OPENQASM 2.0;'" />

  ### instances

  <Attribute id="qiskit.circuit.library.QuantumVolume.instances" signature="= 8" />

  ### n\_qubits

  <Attribute id="qiskit.circuit.library.QuantumVolume.n_qubits" name="n_qubits">
  ...
  <Attribute id="qiskit.circuit.library.QuantumVolume.prefix" signature="= 'circuit'" />
  ...
  <Function id="qiskit.circuit.library.QuantumVolume.AND" name="AND" signature="QuantumVolume.AND(qr_variables, qb_target, qr_ancillae, flags=None, mct_mode='no-ancilla')">
  ...
  <Function id="qiskit.circuit.library.QuantumVolume.OR" name="OR" signature="QuantumVolume.OR(qr_variables, qb_target, qr_ancillae, flags=None, mct_mode='basic')">
  ...
  <Function id="qiskit.circuit.library.QuantumVolume.__getitem__" name="__getitem__" signature="QuantumVolume.__getitem__(item)">
    Return indexed operation.
  </Function>

  ### \_\_len\_\_

  <Function id="qiskit.circuit.library.QuantumVolume.__len__" name="__len__" signature="QuantumVolume.__len__()">
    Return number of operations in circuit.
  </Function>

  ### add\_register

  <Function id="qiskit.circuit.library.QuantumVolume.add_register" name="add_register" signature="QuantumVolume.add_register(*regs)">
    Add registers.
  </Function>

  ### append

  <Function id="qiskit.circuit.library.QuantumVolume.append" name="append" signature="QuantumVolume.append(instruction, qargs=None, cargs=None)">
  ...
  <Function id="qiskit.circuit.library.QuantumVolume.assign_parameters" name="assign_parameters" signature="QuantumVolume.assign_parameters(param_dict, inplace=False)">
  ...
  <Function id="qiskit.circuit.library.QuantumVolume.barrier" name="barrier" signature="QuantumVolume.barrier(*qargs)">
    Apply `Barrier`. If qargs is None, applies to all.
  </Function>

  ### bind\_parameters

  <Function id="qiskit.circuit.library.QuantumVolume.bind_parameters" name="bind_parameters" signature="QuantumVolume.bind_parameters(value_dict)">
  ...
  <Function id="qiskit.circuit.library.QuantumVolume.cast" name="cast" signature="static QuantumVolume.cast(value, _type)">
    Best effort to cast value to type. Otherwise, returns the value.
  </Function>

  ### cbit\_argument\_conversion

  <Function id="qiskit.circuit.library.QuantumVolume.cbit_argument_conversion" name="cbit_argument_conversion" signature="QuantumVolume.cbit_argument_conversion(clbit_representation)">
  ...
  <Function id="qiskit.circuit.library.QuantumVolume.ccx" name="ccx" signature="QuantumVolume.ccx(control_qubit1, control_qubit2, target_qubit, *, ctl1=None, ctl2=None, tgt=None)">
    Apply [`CCXGate`](qiskit.circuit.library.CCXGate "qiskit.circuit.library.CCXGate").
  </Function>

  ### ch

  <Function id="qiskit.circuit.library.QuantumVolume.ch" name="ch" signature="QuantumVolume.ch(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CHGate`](qiskit.circuit.library.CHGate "qiskit.circuit.library.CHGate").
  </Function>

  ### cls\_instances

  <Function id="qiskit.circuit.library.QuantumVolume.cls_instances" name="cls_instances" signature="classmethod QuantumVolume.cls_instances()">
    Return the current number of instances of this class, useful for auto naming.
  </Function>

  ### cls\_prefix

  <Function id="qiskit.circuit.library.QuantumVolume.cls_prefix" name="cls_prefix" signature="classmethod QuantumVolume.cls_prefix()">
    Return the prefix to use for auto naming.
  </Function>

  ### cnot

  <Function id="qiskit.circuit.library.QuantumVolume.cnot" name="cnot" signature="QuantumVolume.cnot(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CXGate`](qiskit.circuit.library.CXGate "qiskit.circuit.library.CXGate").
  </Function>

  ### combine

  <Function id="qiskit.circuit.library.QuantumVolume.combine" name="combine" signature="QuantumVolume.combine(rhs)">
  ...
  <Function id="qiskit.circuit.library.QuantumVolume.compose" name="compose" signature="QuantumVolume.compose(other, qubits=None, clbits=None, front=False, inplace=False)">
  ...
  <Function id="qiskit.circuit.library.QuantumVolume.copy" name="copy" signature="QuantumVolume.copy(name=None)">
    Copy the circuit.
  ...
  <Function id="qiskit.circuit.library.QuantumVolume.count_ops" name="count_ops" signature="QuantumVolume.count_ops()">
  ...
  <Function id="qiskit.circuit.library.QuantumVolume.crx" name="crx" signature="QuantumVolume.crx(theta, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CRXGate`](qiskit.circuit.library.CRXGate "qiskit.circuit.library.CRXGate").
  </Function>

  ### cry

  <Function id="qiskit.circuit.library.QuantumVolume.cry" name="cry" signature="QuantumVolume.cry(theta, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CRYGate`](qiskit.circuit.library.CRYGate "qiskit.circuit.library.CRYGate").
  </Function>

  ### crz

  <Function id="qiskit.circuit.library.QuantumVolume.crz" name="crz" signature="QuantumVolume.crz(theta, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CRZGate`](qiskit.circuit.library.CRZGate "qiskit.circuit.library.CRZGate").
  </Function>

  ### cswap

  <Function id="qiskit.circuit.library.QuantumVolume.cswap" name="cswap" signature="QuantumVolume.cswap(control_qubit, target_qubit1, target_qubit2, *, label=None, ctrl_state=None, ctl=None, tgt1=None, tgt2=None)">
    Apply [`CSwapGate`](qiskit.circuit.library.CSwapGate "qiskit.circuit.library.CSwapGate").
  </Function>

  ### cu1

  <Function id="qiskit.circuit.library.QuantumVolume.cu1" name="cu1" signature="QuantumVolume.cu1(theta, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CU1Gate`](qiskit.circuit.library.CU1Gate "qiskit.circuit.library.CU1Gate").
  </Function>

  ### cu3

  <Function id="qiskit.circuit.library.QuantumVolume.cu3" name="cu3" signature="QuantumVolume.cu3(theta, phi, lam, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CU3Gate`](qiskit.circuit.library.CU3Gate "qiskit.circuit.library.CU3Gate").
  </Function>

  ### cx

  <Function id="qiskit.circuit.library.QuantumVolume.cx" name="cx" signature="QuantumVolume.cx(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CXGate`](qiskit.circuit.library.CXGate "qiskit.circuit.library.CXGate").
  </Function>

  ### cy

  <Function id="qiskit.circuit.library.QuantumVolume.cy" name="cy" signature="QuantumVolume.cy(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CYGate`](qiskit.circuit.library.CYGate "qiskit.circuit.library.CYGate").
  </Function>

  ### cz

  <Function id="qiskit.circuit.library.QuantumVolume.cz" name="cz" signature="QuantumVolume.cz(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CZGate`](qiskit.circuit.library.CZGate "qiskit.circuit.library.CZGate").
  </Function>

  ### dcx

  <Function id="qiskit.circuit.library.QuantumVolume.dcx" name="dcx" signature="QuantumVolume.dcx(qubit1, qubit2)">
    Apply [`DCXGate`](qiskit.circuit.library.DCXGate "qiskit.circuit.library.DCXGate").
  </Function>

  ### decompose

  <Function id="qiskit.circuit.library.QuantumVolume.decompose" name="decompose" signature="QuantumVolume.decompose()">
  ...
  <Function id="qiskit.circuit.library.QuantumVolume.depth" name="depth" signature="QuantumVolume.depth()">
  ...
  <Function id="qiskit.circuit.library.QuantumVolume.diag_gate" name="diag_gate" signature="QuantumVolume.diag_gate(diag, qubit)">
    Deprecated version of QuantumCircuit.diagonal.
  </Function>

  ### diagonal

  <Function id="qiskit.circuit.library.QuantumVolume.diagonal" name="diagonal" signature="QuantumVolume.diagonal(diag, qubit)">
  ...
  <Function id="qiskit.circuit.library.QuantumVolume.extend" name="extend" signature="QuantumVolume.extend(rhs)">
  ...
  <Function id="qiskit.circuit.library.QuantumVolume.fredkin" name="fredkin" signature="QuantumVolume.fredkin(control_qubit, target_qubit1, target_qubit2, *, ctl=None, tgt1=None, tgt2=None)">
    Apply [`CSwapGate`](qiskit.circuit.library.CSwapGate "qiskit.circuit.library.CSwapGate").
  </Function>

  ### from\_qasm\_file

  <Function id="qiskit.circuit.library.QuantumVolume.from_qasm_file" name="from_qasm_file" signature="static QuantumVolume.from_qasm_file(path)">
  ...
  <Function id="qiskit.circuit.library.QuantumVolume.from_qasm_str" name="from_qasm_str" signature="static QuantumVolume.from_qasm_str(qasm_str)">
  ...
  <Function id="qiskit.circuit.library.QuantumVolume.h" name="h" signature="QuantumVolume.h(qubit, *, q=None)">
    Apply [`HGate`](qiskit.circuit.library.HGate "qiskit.circuit.library.HGate").
  </Function>

  ### hamiltonian

  <Function id="qiskit.circuit.library.QuantumVolume.hamiltonian" name="hamiltonian" signature="QuantumVolume.hamiltonian(operator, time, qubits, label=None)">
    Apply hamiltonian evolution to to qubits.
  </Function>

  ### has\_register

  <Function id="qiskit.circuit.library.QuantumVolume.has_register" name="has_register" signature="QuantumVolume.has_register(register)">
  ...
  <Function id="qiskit.circuit.library.QuantumVolume.i" name="i" signature="QuantumVolume.i(qubit, *, q=None)">
    Apply [`IGate`](qiskit.circuit.library.IGate "qiskit.circuit.library.IGate").
  </Function>

  ### id

  <Function id="qiskit.circuit.library.QuantumVolume.id" name="id" signature="QuantumVolume.id(qubit, *, q=None)">
    Apply [`IGate`](qiskit.circuit.library.IGate "qiskit.circuit.library.IGate").
  </Function>

  ### iden

  <Function id="qiskit.circuit.library.QuantumVolume.iden" name="iden" signature="QuantumVolume.iden(qubit, *, q=None)">
    Deprecated identity gate.
  </Function>

  ### initialize

  <Function id="qiskit.circuit.library.QuantumVolume.initialize" name="initialize" signature="QuantumVolume.initialize(params, qubits)">
    Apply initialize to circuit.
  </Function>

  ### inverse

  <Function id="qiskit.circuit.library.QuantumVolume.inverse" name="inverse" signature="QuantumVolume.inverse()">
    Invert this circuit.
  ...
  <Function id="qiskit.circuit.library.QuantumVolume.iso" name="iso" signature="QuantumVolume.iso(isometry, q_input, q_ancillas_for_output, q_ancillas_zero=None, q_ancillas_dirty=None)">
  ...
  <Function id="qiskit.circuit.library.QuantumVolume.isometry" name="isometry" signature="QuantumVolume.isometry(isometry, q_input, q_ancillas_for_output, q_ancillas_zero=None, q_ancillas_dirty=None)">
    Attach an arbitrary isometry from m to n qubits to a circuit. In particular, this allows to attach arbitrary unitaries on n qubits (m=n) or to prepare any state on n qubits (m=0). The decomposition used here was introduced by Iten et al. in [https://arxiv.org/abs/1501.06911](https://arxiv.org/abs/1501.06911).
  ...
  <Function id="qiskit.circuit.library.QuantumVolume.iswap" name="iswap" signature="QuantumVolume.iswap(qubit1, qubit2)">
    Apply [`iSwapGate`](qiskit.circuit.library.iSwapGate "qiskit.circuit.library.iSwapGate").
  </Function>

  ### mcmt

  <Function id="qiskit.circuit.library.QuantumVolume.mcmt" name="mcmt" signature="QuantumVolume.mcmt(gate, control_qubits, target_qubits, ancilla_qubits=None, mode='no-ancilla', *, single_control_gate_fun=None, q_controls=None, q_ancillae=None, q_targets=None)">
  ...
  <Function id="qiskit.circuit.library.QuantumVolume.mcrx" name="mcrx" signature="QuantumVolume.mcrx(theta, q_controls, q_target, use_basis_gates=False)">
  ...
  <Function id="qiskit.circuit.library.QuantumVolume.mcry" name="mcry" signature="QuantumVolume.mcry(theta, q_controls, q_target, q_ancillae, mode='basic', use_basis_gates=False)">
  ...
  <Function id="qiskit.circuit.library.QuantumVolume.mcrz" name="mcrz" signature="QuantumVolume.mcrz(lam, q_controls, q_target, use_basis_gates=False)">
  ...
  <Function id="qiskit.circuit.library.QuantumVolume.mct" name="mct" signature="QuantumVolume.mct(control_qubits, target_qubit, ancilla_qubits=None, mode='noancilla')">
    Apply `MCXGate`.
  </Function>

  ### mcu1

  <Function id="qiskit.circuit.library.QuantumVolume.mcu1" name="mcu1" signature="QuantumVolume.mcu1(lam, control_qubits, target_qubit)">
    Apply `MCU1Gate`.
  </Function>

  ### mcx

  <Function id="qiskit.circuit.library.QuantumVolume.mcx" name="mcx" signature="QuantumVolume.mcx(control_qubits, target_qubit, ancilla_qubits=None, mode='noancilla')">
    Apply `MCXGate`.
  ...
  <Function id="qiskit.circuit.library.QuantumVolume.measure" name="measure" signature="QuantumVolume.measure(qubit, cbit)">
  ...
  <Function id="qiskit.circuit.library.QuantumVolume.measure_active" name="measure_active" signature="QuantumVolume.measure_active(inplace=True)">
  ...
  <Function id="qiskit.circuit.library.QuantumVolume.measure_all" name="measure_all" signature="QuantumVolume.measure_all(inplace=True)">
  ...
  <Function id="qiskit.circuit.library.QuantumVolume.mirror" name="mirror" signature="QuantumVolume.mirror()">
  ...
  <Function id="qiskit.circuit.library.QuantumVolume.ms" name="ms" signature="QuantumVolume.ms(theta, qubits)">
    Apply [`MSGate`](qiskit.circuit.library.MSGate "qiskit.circuit.library.MSGate").
  </Function>

  ### num\_connected\_components

  <Function id="qiskit.circuit.library.QuantumVolume.num_connected_components" name="num_connected_components" signature="QuantumVolume.num_connected_components(unitary_only=False)">
  ...
  <Function id="qiskit.circuit.library.QuantumVolume.num_nonlocal_gates" name="num_nonlocal_gates" signature="QuantumVolume.num_nonlocal_gates()">
  ...
  <Function id="qiskit.circuit.library.QuantumVolume.num_tensor_factors" name="num_tensor_factors" signature="QuantumVolume.num_tensor_factors()">
  ...
  <Function id="qiskit.circuit.library.QuantumVolume.num_unitary_factors" name="num_unitary_factors" signature="QuantumVolume.num_unitary_factors()">
    Computes the number of tensor factors in the unitary (quantum) part of the circuit only.
  </Function>

  ### qasm

  <Function id="qiskit.circuit.library.QuantumVolume.qasm" name="qasm" signature="QuantumVolume.qasm(formatted=False, filename=None)">
  ...
  <Function id="qiskit.circuit.library.QuantumVolume.qbit_argument_conversion" name="qbit_argument_conversion" signature="QuantumVolume.qbit_argument_conversion(qubit_representation)">
  ...
  <Function id="qiskit.circuit.library.QuantumVolume.r" name="r" signature="QuantumVolume.r(theta, phi, qubit, *, q=None)">
    Apply `RGate`.
  </Function>

  ### rcccx

  <Function id="qiskit.circuit.library.QuantumVolume.rcccx" name="rcccx" signature="QuantumVolume.rcccx(control_qubit1, control_qubit2, control_qubit3, target_qubit)">
    Apply [`RC3XGate`](qiskit.circuit.library.RC3XGate "qiskit.circuit.library.RC3XGate").
  </Function>

  ### rccx

  <Function id="qiskit.circuit.library.QuantumVolume.rccx" name="rccx" signature="QuantumVolume.rccx(control_qubit1, control_qubit2, target_qubit)">
    Apply [`RCCXGate`](qiskit.circuit.library.RCCXGate "qiskit.circuit.library.RCCXGate").
  </Function>

  ### remove\_final\_measurements

  <Function id="qiskit.circuit.library.QuantumVolume.remove_final_measurements" name="remove_final_measurements" signature="QuantumVolume.remove_final_measurements(inplace=True)">
  ...
  <Function id="qiskit.circuit.library.QuantumVolume.reset" name="reset" signature="QuantumVolume.reset(qubit)">
    Reset q.
  </Function>

  ### rx

  <Function id="qiskit.circuit.library.QuantumVolume.rx" name="rx" signature="QuantumVolume.rx(theta, qubit, *, label=None, q=None)">
    Apply [`RXGate`](qiskit.circuit.library.RXGate "qiskit.circuit.library.RXGate").
  </Function>

  ### rxx

  <Function id="qiskit.circuit.library.QuantumVolume.rxx" name="rxx" signature="QuantumVolume.rxx(theta, qubit1, qubit2)">
    Apply [`RXXGate`](qiskit.circuit.library.RXXGate "qiskit.circuit.library.RXXGate").
  </Function>

  ### ry

  <Function id="qiskit.circuit.library.QuantumVolume.ry" name="ry" signature="QuantumVolume.ry(theta, qubit, *, label=None, q=None)">
    Apply [`RYGate`](qiskit.circuit.library.RYGate "qiskit.circuit.library.RYGate").
  </Function>

  ### ryy

  <Function id="qiskit.circuit.library.QuantumVolume.ryy" name="ryy" signature="QuantumVolume.ryy(theta, qubit1, qubit2)">
    Apply [`RYYGate`](qiskit.circuit.library.RYYGate "qiskit.circuit.library.RYYGate").
  </Function>

  ### rz

  <Function id="qiskit.circuit.library.QuantumVolume.rz" name="rz" signature="QuantumVolume.rz(phi, qubit, *, q=None)">
    Apply [`RZGate`](qiskit.circuit.library.RZGate "qiskit.circuit.library.RZGate").
  </Function>

  ### rzx

  <Function id="qiskit.circuit.library.QuantumVolume.rzx" name="rzx" signature="QuantumVolume.rzx(theta, qubit1, qubit2)">
    Apply [`RZXGate`](qiskit.circuit.library.RZXGate "qiskit.circuit.library.RZXGate").
  </Function>

  ### rzz

  <Function id="qiskit.circuit.library.QuantumVolume.rzz" name="rzz" signature="QuantumVolume.rzz(theta, qubit1, qubit2)">
    Apply [`RZZGate`](qiskit.circuit.library.RZZGate "qiskit.circuit.library.RZZGate").
  </Function>

  ### s

  <Function id="qiskit.circuit.library.QuantumVolume.s" name="s" signature="QuantumVolume.s(qubit, *, q=None)">
    Apply [`SGate`](qiskit.circuit.library.SGate "qiskit.circuit.library.SGate").
  </Function>

  ### sdg

  <Function id="qiskit.circuit.library.QuantumVolume.sdg" name="sdg" signature="QuantumVolume.sdg(qubit, *, q=None)">
    Apply [`SdgGate`](qiskit.circuit.library.SdgGate "qiskit.circuit.library.SdgGate").
  </Function>

  ### size

  <Function id="qiskit.circuit.library.QuantumVolume.size" name="size" signature="QuantumVolume.size()">
  ...
  <Function id="qiskit.circuit.library.QuantumVolume.snapshot" name="snapshot" signature="QuantumVolume.snapshot(label, snapshot_type='statevector', qubits=None, params=None)">
  ...
  <Function id="qiskit.circuit.library.QuantumVolume.snapshot_density_matrix" name="snapshot_density_matrix" signature="QuantumVolume.snapshot_density_matrix(label, qubits=None)">
  ...
  <Function id="qiskit.circuit.library.QuantumVolume.snapshot_expectation_value" name="snapshot_expectation_value" signature="QuantumVolume.snapshot_expectation_value(label, op, qubits, single_shot=False, variance=False)">
  ...
  <Function id="qiskit.circuit.library.QuantumVolume.snapshot_probabilities" name="snapshot_probabilities" signature="QuantumVolume.snapshot_probabilities(label, qubits, variance=False)">
  ...
  <Function id="qiskit.circuit.library.QuantumVolume.snapshot_stabilizer" name="snapshot_stabilizer" signature="QuantumVolume.snapshot_stabilizer(label)">
  ...
  <Function id="qiskit.circuit.library.QuantumVolume.snapshot_statevector" name="snapshot_statevector" signature="QuantumVolume.snapshot_statevector(label)">
  ...
  <Function id="qiskit.circuit.library.QuantumVolume.squ" name="squ" signature="QuantumVolume.squ(unitary_matrix, qubit, mode='ZYZ', up_to_diagonal=False, *, u=None)">
  ...
  <Function id="qiskit.circuit.library.QuantumVolume.swap" name="swap" signature="QuantumVolume.swap(qubit1, qubit2)">
    Apply [`SwapGate`](qiskit.circuit.library.SwapGate "qiskit.circuit.library.SwapGate").
  </Function>

  ### t

  <Function id="qiskit.circuit.library.QuantumVolume.t" name="t" signature="QuantumVolume.t(qubit, *, q=None)">
    Apply [`TGate`](qiskit.circuit.library.TGate "qiskit.circuit.library.TGate").
  </Function>

  ### tdg

  <Function id="qiskit.circuit.library.QuantumVolume.tdg" name="tdg" signature="QuantumVolume.tdg(qubit, *, q=None)">
    Apply [`TdgGate`](qiskit.circuit.library.TdgGate "qiskit.circuit.library.TdgGate").
  </Function>

  ### to\_gate

  <Function id="qiskit.circuit.library.QuantumVolume.to_gate" name="to_gate" signature="QuantumVolume.to_gate(parameter_map=None)">
  ...
  <Function id="qiskit.circuit.library.QuantumVolume.to_instruction" name="to_instruction" signature="QuantumVolume.to_instruction(parameter_map=None)">
  ...
  <Function id="qiskit.circuit.library.QuantumVolume.toffoli" name="toffoli" signature="QuantumVolume.toffoli(control_qubit1, control_qubit2, target_qubit, *, ctl1=None, ctl2=None, tgt=None)">
    Apply [`CCXGate`](qiskit.circuit.library.CCXGate "qiskit.circuit.library.CCXGate").
  </Function>

  ### u1

  <Function id="qiskit.circuit.library.QuantumVolume.u1" name="u1" signature="QuantumVolume.u1(theta, qubit, *, q=None)">
    Apply [`U1Gate`](qiskit.circuit.library.U1Gate "qiskit.circuit.library.U1Gate").
  </Function>

  ### u2

  <Function id="qiskit.circuit.library.QuantumVolume.u2" name="u2" signature="QuantumVolume.u2(phi, lam, qubit, *, q=None)">
    Apply [`U2Gate`](qiskit.circuit.library.U2Gate "qiskit.circuit.library.U2Gate").
  </Function>

  ### u3

  <Function id="qiskit.circuit.library.QuantumVolume.u3" name="u3" signature="QuantumVolume.u3(theta, phi, lam, qubit, *, q=None)">
    Apply [`U3Gate`](qiskit.circuit.library.U3Gate "qiskit.circuit.library.U3Gate").
  </Function>

  ### uc

  <Function id="qiskit.circuit.library.QuantumVolume.uc" name="uc" signature="QuantumVolume.uc(gate_list, q_controls, q_target, up_to_diagonal=False)">
  ...
  <Function id="qiskit.circuit.library.QuantumVolume.ucg" name="ucg" signature="QuantumVolume.ucg(angle_list, q_controls, q_target, up_to_diagonal=False)">
    Deprecated version of uc.
  </Function>

  ### ucrx

  <Function id="qiskit.circuit.library.QuantumVolume.ucrx" name="ucrx" signature="QuantumVolume.ucrx(angle_list, q_controls, q_target)">
  ...
  <Function id="qiskit.circuit.library.QuantumVolume.ucry" name="ucry" signature="QuantumVolume.ucry(angle_list, q_controls, q_target)">
  ...
  <Function id="qiskit.circuit.library.QuantumVolume.ucrz" name="ucrz" signature="QuantumVolume.ucrz(angle_list, q_controls, q_target)">
  ...
  <Function id="qiskit.circuit.library.QuantumVolume.ucx" name="ucx" signature="QuantumVolume.ucx(angle_list, q_controls, q_target)">
    Deprecated version of ucrx.
  </Function>

  ### ucy

  <Function id="qiskit.circuit.library.QuantumVolume.ucy" name="ucy" signature="QuantumVolume.ucy(angle_list, q_controls, q_target)">
    Deprecated version of ucry.
  </Function>

  ### ucz

  <Function id="qiskit.circuit.library.QuantumVolume.ucz" name="ucz" signature="QuantumVolume.ucz(angle_list, q_controls, q_target)">
    Deprecated version of ucrz.
  </Function>

  ### unitary

  <Function id="qiskit.circuit.library.QuantumVolume.unitary" name="unitary" signature="QuantumVolume.unitary(obj, qubits, label=None)">
    Apply unitary gate to q.
  </Function>

  ### width

  <Function id="qiskit.circuit.library.QuantumVolume.width" name="width" signature="QuantumVolume.width()">
  ...
  <Function id="qiskit.circuit.library.QuantumVolume.x" name="x" signature="QuantumVolume.x(qubit, *, label=None, ctrl_state=None, q=None)">
    Apply [`XGate`](qiskit.circuit.library.XGate "qiskit.circuit.library.XGate").
  </Function>

  ### y

  <Function id="qiskit.circuit.library.QuantumVolume.y" name="y" signature="QuantumVolume.y(qubit, *, q=None)">
    Apply [`YGate`](qiskit.circuit.library.YGate "qiskit.circuit.library.YGate").
  </Function>

  ### z

  <Function id="qiskit.circuit.library.QuantumVolume.z" name="z" signature="QuantumVolume.z(qubit, *, q=None)">
