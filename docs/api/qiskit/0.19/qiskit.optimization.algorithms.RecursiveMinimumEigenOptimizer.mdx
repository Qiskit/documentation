...
<Class id="qiskit.optimization.algorithms.RecursiveMinimumEigenOptimizer" github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.7/qiskit/optimization/algorithms/recursive_minimum_eigen_optimizer.py" signature="RecursiveMinimumEigenOptimizer(min_eigen_optimizer, min_num_vars=1, min_num_vars_optimizer=None, penalty=None)">
  ...
  **Raises**
  ...
  <Function id="qiskit.optimization.algorithms.RecursiveMinimumEigenOptimizer.get_compatibility_msg" name="get_compatibility_msg" signature="RecursiveMinimumEigenOptimizer.get_compatibility_msg(problem)">
  ...
  <Function id="qiskit.optimization.algorithms.RecursiveMinimumEigenOptimizer.is_compatible" name="is_compatible" signature="RecursiveMinimumEigenOptimizer.is_compatible(problem)">
  ...
  <Function id="qiskit.optimization.algorithms.RecursiveMinimumEigenOptimizer.solve" name="solve" signature="RecursiveMinimumEigenOptimizer.solve(problem)">
