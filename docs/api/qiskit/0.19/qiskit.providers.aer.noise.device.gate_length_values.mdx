---
title: gate_length_values (v0.19)
description: API reference for qiskit.providers.aer.noise.device.gate_length_values in qiskit v0.19
in_page_toc_min_heading_level: 1
python_api_type: function
python_api_name: qiskit.providers.aer.noise.device.gate_length_values
---

<span id="gate-length-values" />

# gate\_length\_values

<Function id="qiskit.providers.aer.noise.device.gate_length_values" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-aer/tree/stable/0.5/qiskit/providers/aer/noise/device/parameters.py" signature="gate_length_values(properties)">
