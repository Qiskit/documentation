...
<Function id="qiskit.tools.choi_to_pauli" github="https://github.com/qiskit/qiskit/tree/stable/0.14/qiskit/tools/qi/qi.py" signature="choi_to_pauli(choi, order=1)">
