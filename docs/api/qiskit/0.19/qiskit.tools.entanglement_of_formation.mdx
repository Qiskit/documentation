...
<Function id="qiskit.tools.entanglement_of_formation" github="https://github.com/qiskit/qiskit/tree/stable/0.14/qiskit/tools/qi/qi.py" signature="entanglement_of_formation(state, d0, d1=None)">
