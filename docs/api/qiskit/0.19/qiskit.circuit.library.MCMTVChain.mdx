...
<Class id="qiskit.circuit.library.MCMTVChain" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.14/qiskit/circuit/library/generalized_gates/mcmt.py" signature="MCMTVChain(gate, num_ctrl_qubits, num_target_qubits)">
  ...
  *   **AttributeError** – If the number of controls or targets is 0.
  ...
  <Attribute id="qiskit.circuit.library.MCMTVChain.clbits" name="clbits">
    Returns a list of classical bits in the order that the registers were added.
  </Attribute>

  ### data

  <Attribute id="qiskit.circuit.library.MCMTVChain.data" name="data">
  ...
  <Attribute id="qiskit.circuit.library.MCMTVChain.extension_lib" signature="= 'include \&#x22;qelib1.inc\&#x22;;'" />

  ### header

  <Attribute id="qiskit.circuit.library.MCMTVChain.header" signature="= 'OPENQASM 2.0;'" />

  ### instances

  <Attribute id="qiskit.circuit.library.MCMTVChain.instances" signature="= 8" />

  ### n\_qubits

  <Attribute id="qiskit.circuit.library.MCMTVChain.n_qubits" name="n_qubits">
    Deprecated, use `num_qubits` instead. Return number of qubits.
  </Attribute>

  ### num\_ancilla\_qubits

  <Attribute id="qiskit.circuit.library.MCMTVChain.num_ancilla_qubits" name="num_ancilla_qubits">
    Return the number of ancilla qubits required.
  </Attribute>

  ### num\_clbits

  <Attribute id="qiskit.circuit.library.MCMTVChain.num_clbits" name="num_clbits">
    Return number of classical bits.
  </Attribute>

  ### num\_parameters

  <Attribute id="qiskit.circuit.library.MCMTVChain.num_parameters" name="num_parameters">
    Convenience function to get the number of parameter objects in the circuit.
  </Attribute>

  ### num\_qubits

  <Attribute id="qiskit.circuit.library.MCMTVChain.num_qubits" name="num_qubits">
    Return number of qubits.
  </Attribute>

  ### parameters

  <Attribute id="qiskit.circuit.library.MCMTVChain.parameters" name="parameters">
    Convenience function to get the parameters defined in the parameter table.
  </Attribute>

  ### prefix

  <Attribute id="qiskit.circuit.library.MCMTVChain.prefix" signature="= 'circuit'" />

  ### qubits

  <Attribute id="qiskit.circuit.library.MCMTVChain.qubits" name="qubits">
  ...
  <Function id="qiskit.circuit.library.MCMTVChain.AND" name="AND" signature="MCMTVChain.AND(qr_variables, qb_target, qr_ancillae, flags=None, mct_mode='no-ancilla')">
  ...
  <Function id="qiskit.circuit.library.MCMTVChain.OR" name="OR" signature="MCMTVChain.OR(qr_variables, qb_target, qr_ancillae, flags=None, mct_mode='basic')">
  ...
  <Function id="qiskit.circuit.library.MCMTVChain.__getitem__" name="__getitem__" signature="MCMTVChain.__getitem__(item)">
    Return indexed operation.
  </Function>

  ### \_\_len\_\_

  <Function id="qiskit.circuit.library.MCMTVChain.__len__" name="__len__" signature="MCMTVChain.__len__()">
    Return number of operations in circuit.
  </Function>

  ### add\_register

  <Function id="qiskit.circuit.library.MCMTVChain.add_register" name="add_register" signature="MCMTVChain.add_register(*regs)">
    Add registers.
  </Function>

  ### append

  <Function id="qiskit.circuit.library.MCMTVChain.append" name="append" signature="MCMTVChain.append(instruction, qargs=None, cargs=None)">
  ...
  <Function id="qiskit.circuit.library.MCMTVChain.assign_parameters" name="assign_parameters" signature="MCMTVChain.assign_parameters(param_dict, inplace=False)">
  ...
  <Function id="qiskit.circuit.library.MCMTVChain.barrier" name="barrier" signature="MCMTVChain.barrier(*qargs)">
    Apply `Barrier`. If qargs is None, applies to all.
  </Function>

  ### bind\_parameters

  <Function id="qiskit.circuit.library.MCMTVChain.bind_parameters" name="bind_parameters" signature="MCMTVChain.bind_parameters(value_dict)">
  ...
  <Function id="qiskit.circuit.library.MCMTVChain.cast" name="cast" signature="static MCMTVChain.cast(value, _type)">
    Best effort to cast value to type. Otherwise, returns the value.
  </Function>

  ### cbit\_argument\_conversion

  <Function id="qiskit.circuit.library.MCMTVChain.cbit_argument_conversion" name="cbit_argument_conversion" signature="MCMTVChain.cbit_argument_conversion(clbit_representation)">
  ...
  <Function id="qiskit.circuit.library.MCMTVChain.ccx" name="ccx" signature="MCMTVChain.ccx(control_qubit1, control_qubit2, target_qubit, *, ctl1=None, ctl2=None, tgt=None)">
    Apply [`CCXGate`](qiskit.circuit.library.CCXGate "qiskit.circuit.library.CCXGate").
  </Function>

  ### ch

  <Function id="qiskit.circuit.library.MCMTVChain.ch" name="ch" signature="MCMTVChain.ch(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CHGate`](qiskit.circuit.library.CHGate "qiskit.circuit.library.CHGate").
  </Function>

  ### cls\_instances

  <Function id="qiskit.circuit.library.MCMTVChain.cls_instances" name="cls_instances" signature="classmethod MCMTVChain.cls_instances()">
    Return the current number of instances of this class, useful for auto naming.
  </Function>

  ### cls\_prefix

  <Function id="qiskit.circuit.library.MCMTVChain.cls_prefix" name="cls_prefix" signature="classmethod MCMTVChain.cls_prefix()">
    Return the prefix to use for auto naming.
  </Function>

  ### cnot

  <Function id="qiskit.circuit.library.MCMTVChain.cnot" name="cnot" signature="MCMTVChain.cnot(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CXGate`](qiskit.circuit.library.CXGate "qiskit.circuit.library.CXGate").
  </Function>

  ### combine

  <Function id="qiskit.circuit.library.MCMTVChain.combine" name="combine" signature="MCMTVChain.combine(rhs)">
  ...
  <Function id="qiskit.circuit.library.MCMTVChain.compose" name="compose" signature="MCMTVChain.compose(other, qubits=None, clbits=None, front=False, inplace=False)">
  ...
  <Function id="qiskit.circuit.library.MCMTVChain.control" name="control" signature="MCMTVChain.control(num_ctrl_qubits=1)">
    Return the controlled version of the MCMT circuit.
  </Function>

  ### copy

  <Function id="qiskit.circuit.library.MCMTVChain.copy" name="copy" signature="MCMTVChain.copy(name=None)">
    Copy the circuit.
  ...
  <Function id="qiskit.circuit.library.MCMTVChain.count_ops" name="count_ops" signature="MCMTVChain.count_ops()">
  ...
  <Function id="qiskit.circuit.library.MCMTVChain.crx" name="crx" signature="MCMTVChain.crx(theta, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CRXGate`](qiskit.circuit.library.CRXGate "qiskit.circuit.library.CRXGate").
  </Function>

  ### cry

  <Function id="qiskit.circuit.library.MCMTVChain.cry" name="cry" signature="MCMTVChain.cry(theta, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CRYGate`](qiskit.circuit.library.CRYGate "qiskit.circuit.library.CRYGate").
  </Function>

  ### crz

  <Function id="qiskit.circuit.library.MCMTVChain.crz" name="crz" signature="MCMTVChain.crz(theta, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CRZGate`](qiskit.circuit.library.CRZGate "qiskit.circuit.library.CRZGate").
  </Function>

  ### cswap

  <Function id="qiskit.circuit.library.MCMTVChain.cswap" name="cswap" signature="MCMTVChain.cswap(control_qubit, target_qubit1, target_qubit2, *, label=None, ctrl_state=None, ctl=None, tgt1=None, tgt2=None)">
    Apply [`CSwapGate`](qiskit.circuit.library.CSwapGate "qiskit.circuit.library.CSwapGate").
  </Function>

  ### cu1

  <Function id="qiskit.circuit.library.MCMTVChain.cu1" name="cu1" signature="MCMTVChain.cu1(theta, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CU1Gate`](qiskit.circuit.library.CU1Gate "qiskit.circuit.library.CU1Gate").
  </Function>

  ### cu3

  <Function id="qiskit.circuit.library.MCMTVChain.cu3" name="cu3" signature="MCMTVChain.cu3(theta, phi, lam, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CU3Gate`](qiskit.circuit.library.CU3Gate "qiskit.circuit.library.CU3Gate").
  </Function>

  ### cx

  <Function id="qiskit.circuit.library.MCMTVChain.cx" name="cx" signature="MCMTVChain.cx(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CXGate`](qiskit.circuit.library.CXGate "qiskit.circuit.library.CXGate").
  </Function>

  ### cy

  <Function id="qiskit.circuit.library.MCMTVChain.cy" name="cy" signature="MCMTVChain.cy(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CYGate`](qiskit.circuit.library.CYGate "qiskit.circuit.library.CYGate").
  </Function>

  ### cz

  <Function id="qiskit.circuit.library.MCMTVChain.cz" name="cz" signature="MCMTVChain.cz(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CZGate`](qiskit.circuit.library.CZGate "qiskit.circuit.library.CZGate").
  </Function>

  ### dcx

  <Function id="qiskit.circuit.library.MCMTVChain.dcx" name="dcx" signature="MCMTVChain.dcx(qubit1, qubit2)">
    Apply [`DCXGate`](qiskit.circuit.library.DCXGate "qiskit.circuit.library.DCXGate").
  </Function>

  ### decompose

  <Function id="qiskit.circuit.library.MCMTVChain.decompose" name="decompose" signature="MCMTVChain.decompose()">
  ...
  <Function id="qiskit.circuit.library.MCMTVChain.depth" name="depth" signature="MCMTVChain.depth()">
  ...
  <Function id="qiskit.circuit.library.MCMTVChain.diag_gate" name="diag_gate" signature="MCMTVChain.diag_gate(diag, qubit)">
    Deprecated version of QuantumCircuit.diagonal.
  </Function>

  ### diagonal

  <Function id="qiskit.circuit.library.MCMTVChain.diagonal" name="diagonal" signature="MCMTVChain.diagonal(diag, qubit)">
  ...
  <Function id="qiskit.circuit.library.MCMTVChain.extend" name="extend" signature="MCMTVChain.extend(rhs)">
  ...
  <Function id="qiskit.circuit.library.MCMTVChain.fredkin" name="fredkin" signature="MCMTVChain.fredkin(control_qubit, target_qubit1, target_qubit2, *, ctl=None, tgt1=None, tgt2=None)">
    Apply [`CSwapGate`](qiskit.circuit.library.CSwapGate "qiskit.circuit.library.CSwapGate").
  </Function>

  ### from\_qasm\_file

  <Function id="qiskit.circuit.library.MCMTVChain.from_qasm_file" name="from_qasm_file" signature="static MCMTVChain.from_qasm_file(path)">
  ...
  <Function id="qiskit.circuit.library.MCMTVChain.from_qasm_str" name="from_qasm_str" signature="static MCMTVChain.from_qasm_str(qasm_str)">
  ...
  <Function id="qiskit.circuit.library.MCMTVChain.h" name="h" signature="MCMTVChain.h(qubit, *, q=None)">
    Apply [`HGate`](qiskit.circuit.library.HGate "qiskit.circuit.library.HGate").
  </Function>

  ### hamiltonian

  <Function id="qiskit.circuit.library.MCMTVChain.hamiltonian" name="hamiltonian" signature="MCMTVChain.hamiltonian(operator, time, qubits, label=None)">
    Apply hamiltonian evolution to to qubits.
  </Function>

  ### has\_register

  <Function id="qiskit.circuit.library.MCMTVChain.has_register" name="has_register" signature="MCMTVChain.has_register(register)">
  ...
  <Function id="qiskit.circuit.library.MCMTVChain.i" name="i" signature="MCMTVChain.i(qubit, *, q=None)">
    Apply [`IGate`](qiskit.circuit.library.IGate "qiskit.circuit.library.IGate").
  </Function>

  ### id

  <Function id="qiskit.circuit.library.MCMTVChain.id" name="id" signature="MCMTVChain.id(qubit, *, q=None)">
    Apply [`IGate`](qiskit.circuit.library.IGate "qiskit.circuit.library.IGate").
  </Function>

  ### iden

  <Function id="qiskit.circuit.library.MCMTVChain.iden" name="iden" signature="MCMTVChain.iden(qubit, *, q=None)">
    Deprecated identity gate.
  </Function>

  ### initialize

  <Function id="qiskit.circuit.library.MCMTVChain.initialize" name="initialize" signature="MCMTVChain.initialize(params, qubits)">
    Apply initialize to circuit.
  </Function>

  ### inverse

  <Function id="qiskit.circuit.library.MCMTVChain.inverse" name="inverse" signature="MCMTVChain.inverse()">
    Return the inverse MCMT circuit, which is itself.
  </Function>

  ### iso

  <Function id="qiskit.circuit.library.MCMTVChain.iso" name="iso" signature="MCMTVChain.iso(isometry, q_input, q_ancillas_for_output, q_ancillas_zero=None, q_ancillas_dirty=None)">
  ...
  <Function id="qiskit.circuit.library.MCMTVChain.isometry" name="isometry" signature="MCMTVChain.isometry(isometry, q_input, q_ancillas_for_output, q_ancillas_zero=None, q_ancillas_dirty=None)">
    Attach an arbitrary isometry from m to n qubits to a circuit. In particular, this allows to attach arbitrary unitaries on n qubits (m=n) or to prepare any state on n qubits (m=0). The decomposition used here was introduced by Iten et al. in [https://arxiv.org/abs/1501.06911](https://arxiv.org/abs/1501.06911).
  ...
  <Function id="qiskit.circuit.library.MCMTVChain.iswap" name="iswap" signature="MCMTVChain.iswap(qubit1, qubit2)">
    Apply [`iSwapGate`](qiskit.circuit.library.iSwapGate "qiskit.circuit.library.iSwapGate").
  </Function>

  ### mcmt

  <Function id="qiskit.circuit.library.MCMTVChain.mcmt" name="mcmt" signature="MCMTVChain.mcmt(gate, control_qubits, target_qubits, ancilla_qubits=None, mode='no-ancilla', *, single_control_gate_fun=None, q_controls=None, q_ancillae=None, q_targets=None)">
  ...
  <Function id="qiskit.circuit.library.MCMTVChain.mcrx" name="mcrx" signature="MCMTVChain.mcrx(theta, q_controls, q_target, use_basis_gates=False)">
  ...
  <Function id="qiskit.circuit.library.MCMTVChain.mcry" name="mcry" signature="MCMTVChain.mcry(theta, q_controls, q_target, q_ancillae, mode='basic', use_basis_gates=False)">
  ...
  <Function id="qiskit.circuit.library.MCMTVChain.mcrz" name="mcrz" signature="MCMTVChain.mcrz(lam, q_controls, q_target, use_basis_gates=False)">
  ...
  <Function id="qiskit.circuit.library.MCMTVChain.mct" name="mct" signature="MCMTVChain.mct(control_qubits, target_qubit, ancilla_qubits=None, mode='noancilla')">
    Apply `MCXGate`.
  </Function>

  ### mcu1

  <Function id="qiskit.circuit.library.MCMTVChain.mcu1" name="mcu1" signature="MCMTVChain.mcu1(lam, control_qubits, target_qubit)">
    Apply `MCU1Gate`.
  </Function>

  ### mcx

  <Function id="qiskit.circuit.library.MCMTVChain.mcx" name="mcx" signature="MCMTVChain.mcx(control_qubits, target_qubit, ancilla_qubits=None, mode='noancilla')">
    Apply `MCXGate`.
  ...
  <Function id="qiskit.circuit.library.MCMTVChain.measure" name="measure" signature="MCMTVChain.measure(qubit, cbit)">
  ...
  <Function id="qiskit.circuit.library.MCMTVChain.measure_active" name="measure_active" signature="MCMTVChain.measure_active(inplace=True)">
  ...
  <Function id="qiskit.circuit.library.MCMTVChain.measure_all" name="measure_all" signature="MCMTVChain.measure_all(inplace=True)">
  ...
  <Function id="qiskit.circuit.library.MCMTVChain.mirror" name="mirror" signature="MCMTVChain.mirror()">
  ...
  <Function id="qiskit.circuit.library.MCMTVChain.ms" name="ms" signature="MCMTVChain.ms(theta, qubits)">
    Apply [`MSGate`](qiskit.circuit.library.MSGate "qiskit.circuit.library.MSGate").
  </Function>

  ### num\_connected\_components

  <Function id="qiskit.circuit.library.MCMTVChain.num_connected_components" name="num_connected_components" signature="MCMTVChain.num_connected_components(unitary_only=False)">
  ...
  <Function id="qiskit.circuit.library.MCMTVChain.num_nonlocal_gates" name="num_nonlocal_gates" signature="MCMTVChain.num_nonlocal_gates()">
  ...
  <Function id="qiskit.circuit.library.MCMTVChain.num_tensor_factors" name="num_tensor_factors" signature="MCMTVChain.num_tensor_factors()">
  ...
  <Function id="qiskit.circuit.library.MCMTVChain.num_unitary_factors" name="num_unitary_factors" signature="MCMTVChain.num_unitary_factors()">
    Computes the number of tensor factors in the unitary (quantum) part of the circuit only.
  </Function>

  ### qasm

  <Function id="qiskit.circuit.library.MCMTVChain.qasm" name="qasm" signature="MCMTVChain.qasm(formatted=False, filename=None)">
  ...
  <Function id="qiskit.circuit.library.MCMTVChain.qbit_argument_conversion" name="qbit_argument_conversion" signature="MCMTVChain.qbit_argument_conversion(qubit_representation)">
  ...
  <Function id="qiskit.circuit.library.MCMTVChain.r" name="r" signature="MCMTVChain.r(theta, phi, qubit, *, q=None)">
    Apply `RGate`.
  </Function>

  ### rcccx

  <Function id="qiskit.circuit.library.MCMTVChain.rcccx" name="rcccx" signature="MCMTVChain.rcccx(control_qubit1, control_qubit2, control_qubit3, target_qubit)">
    Apply [`RC3XGate`](qiskit.circuit.library.RC3XGate "qiskit.circuit.library.RC3XGate").
  </Function>

  ### rccx

  <Function id="qiskit.circuit.library.MCMTVChain.rccx" name="rccx" signature="MCMTVChain.rccx(control_qubit1, control_qubit2, target_qubit)">
    Apply [`RCCXGate`](qiskit.circuit.library.RCCXGate "qiskit.circuit.library.RCCXGate").
  </Function>

  ### remove\_final\_measurements

  <Function id="qiskit.circuit.library.MCMTVChain.remove_final_measurements" name="remove_final_measurements" signature="MCMTVChain.remove_final_measurements(inplace=True)">
  ...
  <Function id="qiskit.circuit.library.MCMTVChain.reset" name="reset" signature="MCMTVChain.reset(qubit)">
    Reset q.
  </Function>

  ### rx

  <Function id="qiskit.circuit.library.MCMTVChain.rx" name="rx" signature="MCMTVChain.rx(theta, qubit, *, label=None, q=None)">
    Apply [`RXGate`](qiskit.circuit.library.RXGate "qiskit.circuit.library.RXGate").
  </Function>

  ### rxx

  <Function id="qiskit.circuit.library.MCMTVChain.rxx" name="rxx" signature="MCMTVChain.rxx(theta, qubit1, qubit2)">
    Apply [`RXXGate`](qiskit.circuit.library.RXXGate "qiskit.circuit.library.RXXGate").
  </Function>

  ### ry

  <Function id="qiskit.circuit.library.MCMTVChain.ry" name="ry" signature="MCMTVChain.ry(theta, qubit, *, label=None, q=None)">
    Apply [`RYGate`](qiskit.circuit.library.RYGate "qiskit.circuit.library.RYGate").
  </Function>

  ### ryy

  <Function id="qiskit.circuit.library.MCMTVChain.ryy" name="ryy" signature="MCMTVChain.ryy(theta, qubit1, qubit2)">
    Apply [`RYYGate`](qiskit.circuit.library.RYYGate "qiskit.circuit.library.RYYGate").
  </Function>

  ### rz

  <Function id="qiskit.circuit.library.MCMTVChain.rz" name="rz" signature="MCMTVChain.rz(phi, qubit, *, q=None)">
    Apply [`RZGate`](qiskit.circuit.library.RZGate "qiskit.circuit.library.RZGate").
  </Function>

  ### rzx

  <Function id="qiskit.circuit.library.MCMTVChain.rzx" name="rzx" signature="MCMTVChain.rzx(theta, qubit1, qubit2)">
    Apply [`RZXGate`](qiskit.circuit.library.RZXGate "qiskit.circuit.library.RZXGate").
  </Function>

  ### rzz

  <Function id="qiskit.circuit.library.MCMTVChain.rzz" name="rzz" signature="MCMTVChain.rzz(theta, qubit1, qubit2)">
    Apply [`RZZGate`](qiskit.circuit.library.RZZGate "qiskit.circuit.library.RZZGate").
  </Function>

  ### s

  <Function id="qiskit.circuit.library.MCMTVChain.s" name="s" signature="MCMTVChain.s(qubit, *, q=None)">
    Apply [`SGate`](qiskit.circuit.library.SGate "qiskit.circuit.library.SGate").
  </Function>

  ### sdg

  <Function id="qiskit.circuit.library.MCMTVChain.sdg" name="sdg" signature="MCMTVChain.sdg(qubit, *, q=None)">
    Apply [`SdgGate`](qiskit.circuit.library.SdgGate "qiskit.circuit.library.SdgGate").
  </Function>

  ### size

  <Function id="qiskit.circuit.library.MCMTVChain.size" name="size" signature="MCMTVChain.size()">
  ...
  <Function id="qiskit.circuit.library.MCMTVChain.snapshot" name="snapshot" signature="MCMTVChain.snapshot(label, snapshot_type='statevector', qubits=None, params=None)">
  ...
  <Function id="qiskit.circuit.library.MCMTVChain.snapshot_density_matrix" name="snapshot_density_matrix" signature="MCMTVChain.snapshot_density_matrix(label, qubits=None)">
  ...
  <Function id="qiskit.circuit.library.MCMTVChain.snapshot_expectation_value" name="snapshot_expectation_value" signature="MCMTVChain.snapshot_expectation_value(label, op, qubits, single_shot=False, variance=False)">
  ...
  <Function id="qiskit.circuit.library.MCMTVChain.snapshot_probabilities" name="snapshot_probabilities" signature="MCMTVChain.snapshot_probabilities(label, qubits, variance=False)">
  ...
  <Function id="qiskit.circuit.library.MCMTVChain.snapshot_stabilizer" name="snapshot_stabilizer" signature="MCMTVChain.snapshot_stabilizer(label)">
  ...
  <Function id="qiskit.circuit.library.MCMTVChain.snapshot_statevector" name="snapshot_statevector" signature="MCMTVChain.snapshot_statevector(label)">
  ...
  <Function id="qiskit.circuit.library.MCMTVChain.squ" name="squ" signature="MCMTVChain.squ(unitary_matrix, qubit, mode='ZYZ', up_to_diagonal=False, *, u=None)">
  ...
  <Function id="qiskit.circuit.library.MCMTVChain.swap" name="swap" signature="MCMTVChain.swap(qubit1, qubit2)">
    Apply [`SwapGate`](qiskit.circuit.library.SwapGate "qiskit.circuit.library.SwapGate").
  </Function>

  ### t

  <Function id="qiskit.circuit.library.MCMTVChain.t" name="t" signature="MCMTVChain.t(qubit, *, q=None)">
    Apply [`TGate`](qiskit.circuit.library.TGate "qiskit.circuit.library.TGate").
  </Function>

  ### tdg

  <Function id="qiskit.circuit.library.MCMTVChain.tdg" name="tdg" signature="MCMTVChain.tdg(qubit, *, q=None)">
    Apply [`TdgGate`](qiskit.circuit.library.TdgGate "qiskit.circuit.library.TdgGate").
  </Function>

  ### to\_gate

  <Function id="qiskit.circuit.library.MCMTVChain.to_gate" name="to_gate" signature="MCMTVChain.to_gate(parameter_map=None)">
  ...
  <Function id="qiskit.circuit.library.MCMTVChain.to_instruction" name="to_instruction" signature="MCMTVChain.to_instruction(parameter_map=None)">
  ...
  <Function id="qiskit.circuit.library.MCMTVChain.toffoli" name="toffoli" signature="MCMTVChain.toffoli(control_qubit1, control_qubit2, target_qubit, *, ctl1=None, ctl2=None, tgt=None)">
    Apply [`CCXGate`](qiskit.circuit.library.CCXGate "qiskit.circuit.library.CCXGate").
  </Function>

  ### u1

  <Function id="qiskit.circuit.library.MCMTVChain.u1" name="u1" signature="MCMTVChain.u1(theta, qubit, *, q=None)">
    Apply [`U1Gate`](qiskit.circuit.library.U1Gate "qiskit.circuit.library.U1Gate").
  </Function>

  ### u2

  <Function id="qiskit.circuit.library.MCMTVChain.u2" name="u2" signature="MCMTVChain.u2(phi, lam, qubit, *, q=None)">
    Apply [`U2Gate`](qiskit.circuit.library.U2Gate "qiskit.circuit.library.U2Gate").
  </Function>

  ### u3

  <Function id="qiskit.circuit.library.MCMTVChain.u3" name="u3" signature="MCMTVChain.u3(theta, phi, lam, qubit, *, q=None)">
    Apply [`U3Gate`](qiskit.circuit.library.U3Gate "qiskit.circuit.library.U3Gate").
  </Function>

  ### uc

  <Function id="qiskit.circuit.library.MCMTVChain.uc" name="uc" signature="MCMTVChain.uc(gate_list, q_controls, q_target, up_to_diagonal=False)">
  ...
  <Function id="qiskit.circuit.library.MCMTVChain.ucg" name="ucg" signature="MCMTVChain.ucg(angle_list, q_controls, q_target, up_to_diagonal=False)">
    Deprecated version of uc.
  </Function>

  ### ucrx

  <Function id="qiskit.circuit.library.MCMTVChain.ucrx" name="ucrx" signature="MCMTVChain.ucrx(angle_list, q_controls, q_target)">
  ...
  <Function id="qiskit.circuit.library.MCMTVChain.ucry" name="ucry" signature="MCMTVChain.ucry(angle_list, q_controls, q_target)">
  ...
  <Function id="qiskit.circuit.library.MCMTVChain.ucrz" name="ucrz" signature="MCMTVChain.ucrz(angle_list, q_controls, q_target)">
  ...
  <Function id="qiskit.circuit.library.MCMTVChain.ucx" name="ucx" signature="MCMTVChain.ucx(angle_list, q_controls, q_target)">
    Deprecated version of ucrx.
  </Function>

  ### ucy

  <Function id="qiskit.circuit.library.MCMTVChain.ucy" name="ucy" signature="MCMTVChain.ucy(angle_list, q_controls, q_target)">
    Deprecated version of ucry.
  </Function>

  ### ucz

  <Function id="qiskit.circuit.library.MCMTVChain.ucz" name="ucz" signature="MCMTVChain.ucz(angle_list, q_controls, q_target)">
    Deprecated version of ucrz.
  </Function>

  ### unitary

  <Function id="qiskit.circuit.library.MCMTVChain.unitary" name="unitary" signature="MCMTVChain.unitary(obj, qubits, label=None)">
    Apply unitary gate to q.
  </Function>

  ### width

  <Function id="qiskit.circuit.library.MCMTVChain.width" name="width" signature="MCMTVChain.width()">
  ...
  <Function id="qiskit.circuit.library.MCMTVChain.x" name="x" signature="MCMTVChain.x(qubit, *, label=None, ctrl_state=None, q=None)">
    Apply [`XGate`](qiskit.circuit.library.XGate "qiskit.circuit.library.XGate").
  </Function>

  ### y

  <Function id="qiskit.circuit.library.MCMTVChain.y" name="y" signature="MCMTVChain.y(qubit, *, q=None)">
    Apply [`YGate`](qiskit.circuit.library.YGate "qiskit.circuit.library.YGate").
  </Function>

  ### z

  <Function id="qiskit.circuit.library.MCMTVChain.z" name="z" signature="MCMTVChain.z(qubit, *, q=None)">
