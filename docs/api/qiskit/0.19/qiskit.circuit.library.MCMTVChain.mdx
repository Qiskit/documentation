---
title: MCMTVChain (v0.19)
description: API reference for qiskit.circuit.library.MCMTVChain in qiskit v0.19
...
<Class id="qiskit.circuit.library.MCMTVChain" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.14/qiskit/circuit/library/generalized_gates/mcmt.py" signature="MCMTVChain(gate, num_ctrl_qubits, num_target_qubits)" modifiers="class">
  ...
  *   **AttributeError** – If the number of controls or targets is 0.
  ...
  <span id="mcmtvchain-extension-lib" />

  ### extension\_lib

  <Attribute id="qiskit.circuit.library.MCMTVChain.extension_lib" attributeValue="'include &#x22;qelib1.inc&#x22;;'" />

  <span id="mcmtvchain-header" />

  ### header

  <Attribute id="qiskit.circuit.library.MCMTVChain.header" attributeValue="'OPENQASM 2.0;'" />

  <span id="mcmtvchain-instances" />

  ### instances

  <Attribute id="qiskit.circuit.library.MCMTVChain.instances" attributeValue="8" />

  <span id="mcmtvchain-n-qubits" />

  ### n\_qubits

  <Attribute id="qiskit.circuit.library.MCMTVChain.n_qubits">
    Deprecated, use `num_qubits` instead. Return number of qubits.
  </Attribute>

  <span id="mcmtvchain-num-ancilla-qubits" />
  ...
  <span id="mcmtvchain-num-parameters" />
  ...
  <span id="mcmtvchain-and" />

  ### AND

  <Function id="qiskit.circuit.library.MCMTVChain.AND" signature="MCMTVChain.AND(qr_variables, qb_target, qr_ancillae, flags=None, mct_mode='no-ancilla')">
  ...
  <span id="mcmtvchain-or" />

  ### OR

  <Function id="qiskit.circuit.library.MCMTVChain.OR" signature="MCMTVChain.OR(qr_variables, qb_target, qr_ancillae, flags=None, mct_mode='basic')">
  ...
  <span id="mcmtvchain-getitem" />

  ### \_\_getitem\_\_

  <Function id="qiskit.circuit.library.MCMTVChain.__getitem__" signature="MCMTVChain.__getitem__(item)">
    Return indexed operation.
  </Function>

  <span id="mcmtvchain-len" />

  ### \_\_len\_\_

  <Function id="qiskit.circuit.library.MCMTVChain.__len__" signature="MCMTVChain.__len__()">
    Return number of operations in circuit.
  </Function>

  <span id="mcmtvchain-add-register" />

  ### add\_register

  <Function id="qiskit.circuit.library.MCMTVChain.add_register" signature="MCMTVChain.add_register(*regs)">
    Add registers.
  </Function>

  <span id="mcmtvchain-append" />

  ### append

  <Function id="qiskit.circuit.library.MCMTVChain.append" signature="MCMTVChain.append(instruction, qargs=None, cargs=None)">
  ...
  <span id="mcmtvchain-assign-parameters" />

  ### assign\_parameters

  <Function id="qiskit.circuit.library.MCMTVChain.assign_parameters" signature="MCMTVChain.assign_parameters(param_dict, inplace=False)">
  ...
  <span id="mcmtvchain-barrier" />

  ### barrier

  <Function id="qiskit.circuit.library.MCMTVChain.barrier" signature="MCMTVChain.barrier(*qargs)">
    Apply `Barrier`. If qargs is None, applies to all.
  </Function>

  <span id="mcmtvchain-bind-parameters" />

  ### bind\_parameters

  <Function id="qiskit.circuit.library.MCMTVChain.bind_parameters" signature="MCMTVChain.bind_parameters(value_dict)">
  ...
  <span id="mcmtvchain-cast" />

  ### cast

  <Function id="qiskit.circuit.library.MCMTVChain.cast" signature="MCMTVChain.cast(value, _type)" modifiers="static">
    Best effort to cast value to type. Otherwise, returns the value.
  </Function>

  <span id="mcmtvchain-cbit-argument-conversion" />

  ### cbit\_argument\_conversion

  <Function id="qiskit.circuit.library.MCMTVChain.cbit_argument_conversion" signature="MCMTVChain.cbit_argument_conversion(clbit_representation)">
  ...
  <span id="mcmtvchain-ccx" />

  ### ccx

  <Function id="qiskit.circuit.library.MCMTVChain.ccx" signature="MCMTVChain.ccx(control_qubit1, control_qubit2, target_qubit, *, ctl1=None, ctl2=None, tgt=None)">
    Apply [`CCXGate`](qiskit.circuit.library.CCXGate "qiskit.circuit.library.CCXGate").
  </Function>

  <span id="mcmtvchain-ch" />

  ### ch

  <Function id="qiskit.circuit.library.MCMTVChain.ch" signature="MCMTVChain.ch(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CHGate`](qiskit.circuit.library.CHGate "qiskit.circuit.library.CHGate").
  </Function>

  <span id="mcmtvchain-cls-instances" />

  ### cls\_instances

  <Function id="qiskit.circuit.library.MCMTVChain.cls_instances" signature="MCMTVChain.cls_instances()" modifiers="classmethod">
    Return the current number of instances of this class, useful for auto naming.
  </Function>

  <span id="mcmtvchain-cls-prefix" />

  ### cls\_prefix

  <Function id="qiskit.circuit.library.MCMTVChain.cls_prefix" signature="MCMTVChain.cls_prefix()" modifiers="classmethod">
    Return the prefix to use for auto naming.
  </Function>

  <span id="mcmtvchain-cnot" />

  ### cnot

  <Function id="qiskit.circuit.library.MCMTVChain.cnot" signature="MCMTVChain.cnot(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CXGate`](qiskit.circuit.library.CXGate "qiskit.circuit.library.CXGate").
  </Function>

  <span id="mcmtvchain-combine" />

  ### combine

  <Function id="qiskit.circuit.library.MCMTVChain.combine" signature="MCMTVChain.combine(rhs)">
  ...
  <span id="mcmtvchain-compose" />

  ### compose

  <Function id="qiskit.circuit.library.MCMTVChain.compose" signature="MCMTVChain.compose(other, qubits=None, clbits=None, front=False, inplace=False)">
  ...
  <span id="mcmtvchain-control" />

  ### control

  <Function id="qiskit.circuit.library.MCMTVChain.control" signature="MCMTVChain.control(num_ctrl_qubits=1)">
    Return the controlled version of the MCMT circuit.
  </Function>

  <span id="mcmtvchain-copy" />

  ### copy

  <Function id="qiskit.circuit.library.MCMTVChain.copy" signature="MCMTVChain.copy(name=None)">
    Copy the circuit.
  ...
  <span id="mcmtvchain-count-ops" />

  ### count\_ops

  <Function id="qiskit.circuit.library.MCMTVChain.count_ops" signature="MCMTVChain.count_ops()">
  ...
  <span id="mcmtvchain-crx" />

  ### crx

  <Function id="qiskit.circuit.library.MCMTVChain.crx" signature="MCMTVChain.crx(theta, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CRXGate`](qiskit.circuit.library.CRXGate "qiskit.circuit.library.CRXGate").
  </Function>

  <span id="mcmtvchain-cry" />

  ### cry

  <Function id="qiskit.circuit.library.MCMTVChain.cry" signature="MCMTVChain.cry(theta, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CRYGate`](qiskit.circuit.library.CRYGate "qiskit.circuit.library.CRYGate").
  </Function>

  <span id="mcmtvchain-crz" />

  ### crz

  <Function id="qiskit.circuit.library.MCMTVChain.crz" signature="MCMTVChain.crz(theta, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CRZGate`](qiskit.circuit.library.CRZGate "qiskit.circuit.library.CRZGate").
  </Function>

  <span id="mcmtvchain-cswap" />

  ### cswap

  <Function id="qiskit.circuit.library.MCMTVChain.cswap" signature="MCMTVChain.cswap(control_qubit, target_qubit1, target_qubit2, *, label=None, ctrl_state=None, ctl=None, tgt1=None, tgt2=None)">
    Apply [`CSwapGate`](qiskit.circuit.library.CSwapGate "qiskit.circuit.library.CSwapGate").
  </Function>

  <span id="mcmtvchain-cu1" />

  ### cu1

  <Function id="qiskit.circuit.library.MCMTVChain.cu1" signature="MCMTVChain.cu1(theta, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CU1Gate`](qiskit.circuit.library.CU1Gate "qiskit.circuit.library.CU1Gate").
  </Function>

  <span id="mcmtvchain-cu3" />

  ### cu3

  <Function id="qiskit.circuit.library.MCMTVChain.cu3" signature="MCMTVChain.cu3(theta, phi, lam, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CU3Gate`](qiskit.circuit.library.CU3Gate "qiskit.circuit.library.CU3Gate").
  </Function>

  <span id="mcmtvchain-cx" />

  ### cx

  <Function id="qiskit.circuit.library.MCMTVChain.cx" signature="MCMTVChain.cx(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CXGate`](qiskit.circuit.library.CXGate "qiskit.circuit.library.CXGate").
  </Function>

  <span id="mcmtvchain-cy" />

  ### cy

  <Function id="qiskit.circuit.library.MCMTVChain.cy" signature="MCMTVChain.cy(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CYGate`](qiskit.circuit.library.CYGate "qiskit.circuit.library.CYGate").
  </Function>

  <span id="mcmtvchain-cz" />

  ### cz

  <Function id="qiskit.circuit.library.MCMTVChain.cz" signature="MCMTVChain.cz(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CZGate`](qiskit.circuit.library.CZGate "qiskit.circuit.library.CZGate").
  </Function>

  <span id="mcmtvchain-dcx" />

  ### dcx

  <Function id="qiskit.circuit.library.MCMTVChain.dcx" signature="MCMTVChain.dcx(qubit1, qubit2)">
    Apply [`DCXGate`](qiskit.circuit.library.DCXGate "qiskit.circuit.library.DCXGate").
  </Function>

  <span id="mcmtvchain-decompose" />

  ### decompose

  <Function id="qiskit.circuit.library.MCMTVChain.decompose" signature="MCMTVChain.decompose()">
  ...
  <span id="mcmtvchain-depth" />

  ### depth

  <Function id="qiskit.circuit.library.MCMTVChain.depth" signature="MCMTVChain.depth()">
  ...
  <span id="mcmtvchain-diag-gate" />

  ### diag\_gate

  <Function id="qiskit.circuit.library.MCMTVChain.diag_gate" signature="MCMTVChain.diag_gate(diag, qubit)">
    Deprecated version of QuantumCircuit.diagonal.
  </Function>

  <span id="mcmtvchain-diagonal" />

  ### diagonal

  <Function id="qiskit.circuit.library.MCMTVChain.diagonal" signature="MCMTVChain.diagonal(diag, qubit)">
  ...
  <span id="mcmtvchain-extend" />

  ### extend

  <Function id="qiskit.circuit.library.MCMTVChain.extend" signature="MCMTVChain.extend(rhs)">
  ...
  <span id="mcmtvchain-fredkin" />

  ### fredkin

  <Function id="qiskit.circuit.library.MCMTVChain.fredkin" signature="MCMTVChain.fredkin(control_qubit, target_qubit1, target_qubit2, *, ctl=None, tgt1=None, tgt2=None)">
    Apply [`CSwapGate`](qiskit.circuit.library.CSwapGate "qiskit.circuit.library.CSwapGate").
  </Function>

  <span id="mcmtvchain-from-qasm-file" />

  ### from\_qasm\_file

  <Function id="qiskit.circuit.library.MCMTVChain.from_qasm_file" signature="MCMTVChain.from_qasm_file(path)" modifiers="static">
  ...
  <span id="mcmtvchain-from-qasm-str" />

  ### from\_qasm\_str

  <Function id="qiskit.circuit.library.MCMTVChain.from_qasm_str" signature="MCMTVChain.from_qasm_str(qasm_str)" modifiers="static">
  ...
  <span id="mcmtvchain-h" />

  ### h

  <Function id="qiskit.circuit.library.MCMTVChain.h" signature="MCMTVChain.h(qubit, *, q=None)">
    Apply [`HGate`](qiskit.circuit.library.HGate "qiskit.circuit.library.HGate").
  </Function>

  <span id="mcmtvchain-hamiltonian" />

  ### hamiltonian

  <Function id="qiskit.circuit.library.MCMTVChain.hamiltonian" signature="MCMTVChain.hamiltonian(operator, time, qubits, label=None)">
    Apply hamiltonian evolution to to qubits.
  </Function>

  <span id="mcmtvchain-has-register" />

  ### has\_register

  <Function id="qiskit.circuit.library.MCMTVChain.has_register" signature="MCMTVChain.has_register(register)">
  ...
  <span id="mcmtvchain-i" />

  ### i

  <Function id="qiskit.circuit.library.MCMTVChain.i" signature="MCMTVChain.i(qubit, *, q=None)">
    Apply [`IGate`](qiskit.circuit.library.IGate "qiskit.circuit.library.IGate").
  </Function>

  <span id="mcmtvchain-id" />

  ### id

  <Function id="qiskit.circuit.library.MCMTVChain.id" signature="MCMTVChain.id(qubit, *, q=None)">
    Apply [`IGate`](qiskit.circuit.library.IGate "qiskit.circuit.library.IGate").
  </Function>

  <span id="mcmtvchain-iden" />

  ### iden

  <Function id="qiskit.circuit.library.MCMTVChain.iden" signature="MCMTVChain.iden(qubit, *, q=None)">
    Deprecated identity gate.
  </Function>

  <span id="mcmtvchain-initialize" />

  ### initialize

  <Function id="qiskit.circuit.library.MCMTVChain.initialize" signature="MCMTVChain.initialize(params, qubits)">
    Apply initialize to circuit.
  </Function>

  <span id="mcmtvchain-inverse" />
  ...
  <span id="mcmtvchain-iso" />

  ### iso

  <Function id="qiskit.circuit.library.MCMTVChain.iso" signature="MCMTVChain.iso(isometry, q_input, q_ancillas_for_output, q_ancillas_zero=None, q_ancillas_dirty=None)">
  ...
  <span id="mcmtvchain-isometry" />

  ### isometry

  <Function id="qiskit.circuit.library.MCMTVChain.isometry" signature="MCMTVChain.isometry(isometry, q_input, q_ancillas_for_output, q_ancillas_zero=None, q_ancillas_dirty=None)">
    Attach an arbitrary isometry from m to n qubits to a circuit. In particular, this allows to attach arbitrary unitaries on n qubits (m=n) or to prepare any state on n qubits (m=0). The decomposition used here was introduced by Iten et al. in [https://arxiv.org/abs/1501.06911](https://arxiv.org/abs/1501.06911).
  ...
  <span id="mcmtvchain-iswap" />

  ### iswap

  <Function id="qiskit.circuit.library.MCMTVChain.iswap" signature="MCMTVChain.iswap(qubit1, qubit2)">
    Apply [`iSwapGate`](qiskit.circuit.library.iSwapGate "qiskit.circuit.library.iSwapGate").
  </Function>

  <span id="mcmtvchain-mcmt" />

  ### mcmt

  <Function id="qiskit.circuit.library.MCMTVChain.mcmt" signature="MCMTVChain.mcmt(gate, control_qubits, target_qubits, ancilla_qubits=None, mode='no-ancilla', *, single_control_gate_fun=None, q_controls=None, q_ancillae=None, q_targets=None)">
    Apply a multi-control, multi-target using a generic gate.

    This can also be used to implement a generic multi-control gate, as the target could also be of length 1.
  </Function>

  <span id="mcmtvchain-mcrx" />

  ### mcrx

  <Function id="qiskit.circuit.library.MCMTVChain.mcrx" signature="MCMTVChain.mcrx(theta, q_controls, q_target, use_basis_gates=False)">
  ...
  <span id="mcmtvchain-mcry" />

  ### mcry

  <Function id="qiskit.circuit.library.MCMTVChain.mcry" signature="MCMTVChain.mcry(theta, q_controls, q_target, q_ancillae, mode='basic', use_basis_gates=False)">
  ...
  <span id="mcmtvchain-mcrz" />

  ### mcrz

  <Function id="qiskit.circuit.library.MCMTVChain.mcrz" signature="MCMTVChain.mcrz(lam, q_controls, q_target, use_basis_gates=False)">
  ...
  <span id="mcmtvchain-mct" />

  ### mct

  <Function id="qiskit.circuit.library.MCMTVChain.mct" signature="MCMTVChain.mct(control_qubits, target_qubit, ancilla_qubits=None, mode='noancilla')">
    Apply `MCXGate`.
  </Function>

  <span id="mcmtvchain-mcu1" />

  ### mcu1

  <Function id="qiskit.circuit.library.MCMTVChain.mcu1" signature="MCMTVChain.mcu1(lam, control_qubits, target_qubit)">
    Apply `MCU1Gate`.
  </Function>

  <span id="mcmtvchain-mcx" />

  ### mcx

  <Function id="qiskit.circuit.library.MCMTVChain.mcx" signature="MCMTVChain.mcx(control_qubits, target_qubit, ancilla_qubits=None, mode='noancilla')">
    Apply `MCXGate`.
  ...
  <span id="mcmtvchain-measure" />

  ### measure

  <Function id="qiskit.circuit.library.MCMTVChain.measure" signature="MCMTVChain.measure(qubit, cbit)">
  ...
  <span id="mcmtvchain-measure-active" />

  ### measure\_active

  <Function id="qiskit.circuit.library.MCMTVChain.measure_active" signature="MCMTVChain.measure_active(inplace=True)">
  ...
  <span id="mcmtvchain-measure-all" />

  ### measure\_all

  <Function id="qiskit.circuit.library.MCMTVChain.measure_all" signature="MCMTVChain.measure_all(inplace=True)">
  ...
  <span id="mcmtvchain-mirror" />

  ### mirror

  <Function id="qiskit.circuit.library.MCMTVChain.mirror" signature="MCMTVChain.mirror()">
  ...
  <span id="mcmtvchain-ms" />

  ### ms

  <Function id="qiskit.circuit.library.MCMTVChain.ms" signature="MCMTVChain.ms(theta, qubits)">
    Apply [`MSGate`](qiskit.circuit.library.MSGate "qiskit.circuit.library.MSGate").
  </Function>

  <span id="mcmtvchain-num-connected-components" />

  ### num\_connected\_components

  <Function id="qiskit.circuit.library.MCMTVChain.num_connected_components" signature="MCMTVChain.num_connected_components(unitary_only=False)">
  ...
  <span id="mcmtvchain-num-nonlocal-gates" />

  ### num\_nonlocal\_gates

  <Function id="qiskit.circuit.library.MCMTVChain.num_nonlocal_gates" signature="MCMTVChain.num_nonlocal_gates()">
    Return number of non-local gates (i.e. involving 2+ qubits).

    Conditional nonlocal gates are also included.
  </Function>

  <span id="mcmtvchain-num-tensor-factors" />

  ### num\_tensor\_factors

  <Function id="qiskit.circuit.library.MCMTVChain.num_tensor_factors" signature="MCMTVChain.num_tensor_factors()">
  ...
  <span id="mcmtvchain-num-unitary-factors" />

  ### num\_unitary\_factors

  <Function id="qiskit.circuit.library.MCMTVChain.num_unitary_factors" signature="MCMTVChain.num_unitary_factors()">
    Computes the number of tensor factors in the unitary (quantum) part of the circuit only.
  </Function>

  <span id="mcmtvchain-qasm" />

  ### qasm

  <Function id="qiskit.circuit.library.MCMTVChain.qasm" signature="MCMTVChain.qasm(formatted=False, filename=None)">
  ...
  <span id="mcmtvchain-qbit-argument-conversion" />

  ### qbit\_argument\_conversion

  <Function id="qiskit.circuit.library.MCMTVChain.qbit_argument_conversion" signature="MCMTVChain.qbit_argument_conversion(qubit_representation)">
  ...
  <span id="mcmtvchain-r" />

  ### r

  <Function id="qiskit.circuit.library.MCMTVChain.r" signature="MCMTVChain.r(theta, phi, qubit, *, q=None)">
    Apply `RGate`.
  </Function>

  <span id="mcmtvchain-rcccx" />

  ### rcccx

  <Function id="qiskit.circuit.library.MCMTVChain.rcccx" signature="MCMTVChain.rcccx(control_qubit1, control_qubit2, control_qubit3, target_qubit)">
    Apply [`RC3XGate`](qiskit.circuit.library.RC3XGate "qiskit.circuit.library.RC3XGate").
  </Function>

  <span id="mcmtvchain-rccx" />

  ### rccx

  <Function id="qiskit.circuit.library.MCMTVChain.rccx" signature="MCMTVChain.rccx(control_qubit1, control_qubit2, target_qubit)">
    Apply [`RCCXGate`](qiskit.circuit.library.RCCXGate "qiskit.circuit.library.RCCXGate").
  </Function>

  <span id="mcmtvchain-remove-final-measurements" />

  ### remove\_final\_measurements

  <Function id="qiskit.circuit.library.MCMTVChain.remove_final_measurements" signature="MCMTVChain.remove_final_measurements(inplace=True)">
  ...
  <span id="mcmtvchain-reset" />

  ### reset

  <Function id="qiskit.circuit.library.MCMTVChain.reset" signature="MCMTVChain.reset(qubit)">
    Reset q.
  </Function>

  <span id="mcmtvchain-rx" />

  ### rx

  <Function id="qiskit.circuit.library.MCMTVChain.rx" signature="MCMTVChain.rx(theta, qubit, *, label=None, q=None)">
    Apply [`RXGate`](qiskit.circuit.library.RXGate "qiskit.circuit.library.RXGate").
  </Function>

  <span id="mcmtvchain-rxx" />

  ### rxx

  <Function id="qiskit.circuit.library.MCMTVChain.rxx" signature="MCMTVChain.rxx(theta, qubit1, qubit2)">
    Apply [`RXXGate`](qiskit.circuit.library.RXXGate "qiskit.circuit.library.RXXGate").
  </Function>

  <span id="mcmtvchain-ry" />

  ### ry

  <Function id="qiskit.circuit.library.MCMTVChain.ry" signature="MCMTVChain.ry(theta, qubit, *, label=None, q=None)">
    Apply [`RYGate`](qiskit.circuit.library.RYGate "qiskit.circuit.library.RYGate").
  </Function>

  <span id="mcmtvchain-ryy" />

  ### ryy

  <Function id="qiskit.circuit.library.MCMTVChain.ryy" signature="MCMTVChain.ryy(theta, qubit1, qubit2)">
    Apply [`RYYGate`](qiskit.circuit.library.RYYGate "qiskit.circuit.library.RYYGate").
  </Function>

  <span id="mcmtvchain-rz" />

  ### rz

  <Function id="qiskit.circuit.library.MCMTVChain.rz" signature="MCMTVChain.rz(phi, qubit, *, q=None)">
    Apply [`RZGate`](qiskit.circuit.library.RZGate "qiskit.circuit.library.RZGate").
  </Function>

  <span id="mcmtvchain-rzx" />

  ### rzx

  <Function id="qiskit.circuit.library.MCMTVChain.rzx" signature="MCMTVChain.rzx(theta, qubit1, qubit2)">
    Apply [`RZXGate`](qiskit.circuit.library.RZXGate "qiskit.circuit.library.RZXGate").
  </Function>

  <span id="mcmtvchain-rzz" />

  ### rzz

  <Function id="qiskit.circuit.library.MCMTVChain.rzz" signature="MCMTVChain.rzz(theta, qubit1, qubit2)">
    Apply [`RZZGate`](qiskit.circuit.library.RZZGate "qiskit.circuit.library.RZZGate").
  </Function>

  <span id="mcmtvchain-s" />

  ### s

  <Function id="qiskit.circuit.library.MCMTVChain.s" signature="MCMTVChain.s(qubit, *, q=None)">
    Apply [`SGate`](qiskit.circuit.library.SGate "qiskit.circuit.library.SGate").
  </Function>

  <span id="mcmtvchain-sdg" />

  ### sdg

  <Function id="qiskit.circuit.library.MCMTVChain.sdg" signature="MCMTVChain.sdg(qubit, *, q=None)">
    Apply [`SdgGate`](qiskit.circuit.library.SdgGate "qiskit.circuit.library.SdgGate").
  </Function>

  <span id="mcmtvchain-size" />

  ### size

  <Function id="qiskit.circuit.library.MCMTVChain.size" signature="MCMTVChain.size()">
  ...
  <span id="mcmtvchain-snapshot" />

  ### snapshot

  <Function id="qiskit.circuit.library.MCMTVChain.snapshot" signature="MCMTVChain.snapshot(label, snapshot_type='statevector', qubits=None, params=None)">
  ...
  <span id="mcmtvchain-snapshot-density-matrix" />

  ### snapshot\_density\_matrix

  <Function id="qiskit.circuit.library.MCMTVChain.snapshot_density_matrix" signature="MCMTVChain.snapshot_density_matrix(label, qubits=None)">
  ...
  <span id="mcmtvchain-snapshot-expectation-value" />

  ### snapshot\_expectation\_value

  <Function id="qiskit.circuit.library.MCMTVChain.snapshot_expectation_value" signature="MCMTVChain.snapshot_expectation_value(label, op, qubits, single_shot=False, variance=False)">
  ...
  <span id="mcmtvchain-snapshot-probabilities" />

  ### snapshot\_probabilities

  <Function id="qiskit.circuit.library.MCMTVChain.snapshot_probabilities" signature="MCMTVChain.snapshot_probabilities(label, qubits, variance=False)">
  ...
  <span id="mcmtvchain-snapshot-stabilizer" />

  ### snapshot\_stabilizer

  <Function id="qiskit.circuit.library.MCMTVChain.snapshot_stabilizer" signature="MCMTVChain.snapshot_stabilizer(label)">
  ...
  <span id="mcmtvchain-snapshot-statevector" />

  ### snapshot\_statevector

  <Function id="qiskit.circuit.library.MCMTVChain.snapshot_statevector" signature="MCMTVChain.snapshot_statevector(label)">
  ...
  <span id="mcmtvchain-squ" />

  ### squ

  <Function id="qiskit.circuit.library.MCMTVChain.squ" signature="MCMTVChain.squ(unitary_matrix, qubit, mode='ZYZ', up_to_diagonal=False, *, u=None)">
  ...
  <span id="mcmtvchain-swap" />

  ### swap

  <Function id="qiskit.circuit.library.MCMTVChain.swap" signature="MCMTVChain.swap(qubit1, qubit2)">
    Apply [`SwapGate`](qiskit.circuit.library.SwapGate "qiskit.circuit.library.SwapGate").
  </Function>

  <span id="mcmtvchain-t" />

  ### t

  <Function id="qiskit.circuit.library.MCMTVChain.t" signature="MCMTVChain.t(qubit, *, q=None)">
    Apply [`TGate`](qiskit.circuit.library.TGate "qiskit.circuit.library.TGate").
  </Function>

  <span id="mcmtvchain-tdg" />

  ### tdg

  <Function id="qiskit.circuit.library.MCMTVChain.tdg" signature="MCMTVChain.tdg(qubit, *, q=None)">
    Apply [`TdgGate`](qiskit.circuit.library.TdgGate "qiskit.circuit.library.TdgGate").
  </Function>

  <span id="mcmtvchain-to-gate" />

  ### to\_gate

  <Function id="qiskit.circuit.library.MCMTVChain.to_gate" signature="MCMTVChain.to_gate(parameter_map=None)">
  ...
  <span id="mcmtvchain-to-instruction" />

  ### to\_instruction

  <Function id="qiskit.circuit.library.MCMTVChain.to_instruction" signature="MCMTVChain.to_instruction(parameter_map=None)">
  ...
  <span id="mcmtvchain-toffoli" />

  ### toffoli

  <Function id="qiskit.circuit.library.MCMTVChain.toffoli" signature="MCMTVChain.toffoli(control_qubit1, control_qubit2, target_qubit, *, ctl1=None, ctl2=None, tgt=None)">
    Apply [`CCXGate`](qiskit.circuit.library.CCXGate "qiskit.circuit.library.CCXGate").
  </Function>

  <span id="mcmtvchain-u1" />

  ### u1

  <Function id="qiskit.circuit.library.MCMTVChain.u1" signature="MCMTVChain.u1(theta, qubit, *, q=None)">
    Apply [`U1Gate`](qiskit.circuit.library.U1Gate "qiskit.circuit.library.U1Gate").
  </Function>

  <span id="mcmtvchain-u2" />

  ### u2

  <Function id="qiskit.circuit.library.MCMTVChain.u2" signature="MCMTVChain.u2(phi, lam, qubit, *, q=None)">
    Apply [`U2Gate`](qiskit.circuit.library.U2Gate "qiskit.circuit.library.U2Gate").
  </Function>

  <span id="mcmtvchain-u3" />

  ### u3

  <Function id="qiskit.circuit.library.MCMTVChain.u3" signature="MCMTVChain.u3(theta, phi, lam, qubit, *, q=None)">
    Apply [`U3Gate`](qiskit.circuit.library.U3Gate "qiskit.circuit.library.U3Gate").
  </Function>

  <span id="mcmtvchain-uc" />

  ### uc

  <Function id="qiskit.circuit.library.MCMTVChain.uc" signature="MCMTVChain.uc(gate_list, q_controls, q_target, up_to_diagonal=False)">
  ...
  <span id="mcmtvchain-ucg" />

  ### ucg

  <Function id="qiskit.circuit.library.MCMTVChain.ucg" signature="MCMTVChain.ucg(angle_list, q_controls, q_target, up_to_diagonal=False)">
    Deprecated version of uc.
  </Function>

  <span id="mcmtvchain-ucrx" />

  ### ucrx

  <Function id="qiskit.circuit.library.MCMTVChain.ucrx" signature="MCMTVChain.ucrx(angle_list, q_controls, q_target)">
  ...
  <span id="mcmtvchain-ucry" />

  ### ucry

  <Function id="qiskit.circuit.library.MCMTVChain.ucry" signature="MCMTVChain.ucry(angle_list, q_controls, q_target)">
  ...
  <span id="mcmtvchain-ucrz" />

  ### ucrz

  <Function id="qiskit.circuit.library.MCMTVChain.ucrz" signature="MCMTVChain.ucrz(angle_list, q_controls, q_target)">
  ...
  <span id="mcmtvchain-ucx" />

  ### ucx

  <Function id="qiskit.circuit.library.MCMTVChain.ucx" signature="MCMTVChain.ucx(angle_list, q_controls, q_target)">
    Deprecated version of ucrx.
  </Function>

  <span id="mcmtvchain-ucy" />

  ### ucy

  <Function id="qiskit.circuit.library.MCMTVChain.ucy" signature="MCMTVChain.ucy(angle_list, q_controls, q_target)">
    Deprecated version of ucry.
  </Function>

  <span id="mcmtvchain-ucz" />

  ### ucz

  <Function id="qiskit.circuit.library.MCMTVChain.ucz" signature="MCMTVChain.ucz(angle_list, q_controls, q_target)">
    Deprecated version of ucrz.
  </Function>

  <span id="mcmtvchain-unitary" />

  ### unitary

  <Function id="qiskit.circuit.library.MCMTVChain.unitary" signature="MCMTVChain.unitary(obj, qubits, label=None)">
    Apply unitary gate to q.
  </Function>

  <span id="mcmtvchain-width" />

  ### width

  <Function id="qiskit.circuit.library.MCMTVChain.width" signature="MCMTVChain.width()">
  ...
  <span id="mcmtvchain-x" />

  ### x

  <Function id="qiskit.circuit.library.MCMTVChain.x" signature="MCMTVChain.x(qubit, *, label=None, ctrl_state=None, q=None)">
    Apply [`XGate`](qiskit.circuit.library.XGate "qiskit.circuit.library.XGate").
  </Function>

  <span id="mcmtvchain-y" />

  ### y

  <Function id="qiskit.circuit.library.MCMTVChain.y" signature="MCMTVChain.y(qubit, *, q=None)">
    Apply [`YGate`](qiskit.circuit.library.YGate "qiskit.circuit.library.YGate").
  </Function>

  <span id="mcmtvchain-z" />

  ### z

  <Function id="qiskit.circuit.library.MCMTVChain.z" signature="MCMTVChain.z(qubit, *, q=None)">
