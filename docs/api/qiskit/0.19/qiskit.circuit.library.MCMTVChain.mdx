...
<Class id="qiskit.circuit.library.MCMTVChain" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.14/qiskit/circuit/library/generalized_gates/mcmt.py" signature="MCMTVChain(gate, num_ctrl_qubits, num_target_qubits)">
  ...
  *   **AttributeError** – If the number of controls or targets is 0.
  ...
  <Function id="qiskit.circuit.library.MCMTVChain.cast" signature="static MCMTVChain.cast(value, _type)">
  ...
  <Function id="qiskit.circuit.library.MCMTVChain.cls_instances" signature="classmethod MCMTVChain.cls_instances()">
    Return the current number of instances of this class, useful for auto naming.
  </Function>

  ### cls\_prefix

  <Function id="qiskit.circuit.library.MCMTVChain.cls_prefix" signature="classmethod MCMTVChain.cls_prefix()">
  ...
  <Function id="qiskit.circuit.library.MCMTVChain.from_qasm_file" signature="static MCMTVChain.from_qasm_file(path)">
  ...
  <Function id="qiskit.circuit.library.MCMTVChain.from_qasm_str" signature="static MCMTVChain.from_qasm_str(qasm_str)">
