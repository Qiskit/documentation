...
<Class id="qiskit.circuit.library.RealAmplitudes" github="https://github.com/qiskit/qiskit/tree/stable/0.14/qiskit/circuit/library/n_local/real_amplitudes.py" signature="RealAmplitudes(num_qubits=None, entanglement='full', reps=3, skip_unentangled_qubits=False, skip_final_rotation_layer=False, parameter_prefix='θ', insert_barriers=False, initial_state=None)">
  ...
  *   **insert\_barriers** (`bool`) – If True, barriers are inserted in between each layer. If False, no barriers are inserted.
  ...
  <Attribute id="qiskit.circuit.library.RealAmplitudes.entanglement" name="entanglement" signature="Union[str, List[str], List[List[str]], List[int], List[List[int]], List[List[List[int]]], List[List[List[List[int]]]], Callable[[int], str], Callable[[int], List[List[int]]]]">
  ...
  <Attribute id="qiskit.circuit.library.RealAmplitudes.entanglement_blocks" name="entanglement_blocks" signature="List[qiskit.circuit.instruction.Instruction]">
  ...
  <Attribute id="qiskit.circuit.library.RealAmplitudes.extension_lib" signature="= 'include \&#x22;qelib1.inc\&#x22;;'" />

  ### header

  <Attribute id="qiskit.circuit.library.RealAmplitudes.header" signature="= 'OPENQASM 2.0;'" />

  ### initial\_state

  <Attribute id="qiskit.circuit.library.RealAmplitudes.initial_state" name="initial_state" signature="Any">
  ...
  <Attribute id="qiskit.circuit.library.RealAmplitudes.insert_barriers" name="insert_barriers" signature="bool">
  ...
  <Attribute id="qiskit.circuit.library.RealAmplitudes.instances" signature="= 8" />

  ### n\_qubits

  <Attribute id="qiskit.circuit.library.RealAmplitudes.n_qubits" name="n_qubits">
  ...
  <Attribute id="qiskit.circuit.library.RealAmplitudes.num_layers" name="num_layers" signature="int">
  ...
  <Attribute id="qiskit.circuit.library.RealAmplitudes.num_parameters_settable" name="num_parameters_settable" signature="int">
  ...
  <Attribute id="qiskit.circuit.library.RealAmplitudes.num_qubits" name="num_qubits" signature="int">
  ...
  <Attribute id="qiskit.circuit.library.RealAmplitudes.ordered_parameters" name="ordered_parameters" signature="List[qiskit.circuit.parameter.Parameter]">
  ...
  <Attribute id="qiskit.circuit.library.RealAmplitudes.parameter_bounds" name="parameter_bounds" signature="List[Tuple[float, float]]">
  ...
  <Attribute id="qiskit.circuit.library.RealAmplitudes.parameters" name="parameters" signature="Set[qiskit.circuit.parameter.Parameter]">
  ...
  <Attribute id="qiskit.circuit.library.RealAmplitudes.preferred_init_points" name="preferred_init_points" signature="Optional[List[float]]">
  ...
  <Attribute id="qiskit.circuit.library.RealAmplitudes.prefix" signature="= 'circuit'" />
  ...
  <Attribute id="qiskit.circuit.library.RealAmplitudes.reps" name="reps" signature="int">
  ...
  <Attribute id="qiskit.circuit.library.RealAmplitudes.rotation_blocks" name="rotation_blocks" signature="List[qiskit.circuit.instruction.Instruction]">
  ...
  <Function id="qiskit.circuit.library.RealAmplitudes.AND" name="AND" signature="RealAmplitudes.AND(qr_variables, qb_target, qr_ancillae, flags=None, mct_mode='no-ancilla')">
  ...
  <Function id="qiskit.circuit.library.RealAmplitudes.OR" name="OR" signature="RealAmplitudes.OR(qr_variables, qb_target, qr_ancillae, flags=None, mct_mode='basic')">
  ...
  <Function id="qiskit.circuit.library.RealAmplitudes.__getitem__" name="__getitem__" signature="RealAmplitudes.__getitem__(item)">
    Return indexed operation.
  </Function>

  ### \_\_len\_\_

  <Function id="qiskit.circuit.library.RealAmplitudes.__len__" name="__len__" signature="RealAmplitudes.__len__()">
    Return number of operations in circuit.
  </Function>

  ### add\_layer

  <Function id="qiskit.circuit.library.RealAmplitudes.add_layer" name="add_layer" signature="RealAmplitudes.add_layer(other, entanglement=None, front=False)">
  ...
  <Function id="qiskit.circuit.library.RealAmplitudes.add_register" name="add_register" signature="RealAmplitudes.add_register(*regs)">
    Add registers.
  </Function>

  ### append

  <Function id="qiskit.circuit.library.RealAmplitudes.append" name="append" signature="RealAmplitudes.append(instruction, qargs=None, cargs=None)">
  ...
  <Function id="qiskit.circuit.library.RealAmplitudes.assign_parameters" name="assign_parameters" signature="RealAmplitudes.assign_parameters(param_dict, inplace=False)">
  ...
  <Function id="qiskit.circuit.library.RealAmplitudes.barrier" name="barrier" signature="RealAmplitudes.barrier(*qargs)">
    Apply `Barrier`. If qargs is None, applies to all.
  </Function>

  ### bind\_parameters

  <Function id="qiskit.circuit.library.RealAmplitudes.bind_parameters" name="bind_parameters" signature="RealAmplitudes.bind_parameters(value_dict)">
  ...
  <Function id="qiskit.circuit.library.RealAmplitudes.cast" name="cast" signature="static RealAmplitudes.cast(value, _type)">
    Best effort to cast value to type. Otherwise, returns the value.
  </Function>

  ### cbit\_argument\_conversion

  <Function id="qiskit.circuit.library.RealAmplitudes.cbit_argument_conversion" name="cbit_argument_conversion" signature="RealAmplitudes.cbit_argument_conversion(clbit_representation)">
  ...
  <Function id="qiskit.circuit.library.RealAmplitudes.ccx" name="ccx" signature="RealAmplitudes.ccx(control_qubit1, control_qubit2, target_qubit, *, ctl1=None, ctl2=None, tgt=None)">
    Apply [`CCXGate`](qiskit.circuit.library.CCXGate "qiskit.circuit.library.CCXGate").
  </Function>

  ### ch

  <Function id="qiskit.circuit.library.RealAmplitudes.ch" name="ch" signature="RealAmplitudes.ch(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CHGate`](qiskit.circuit.library.CHGate "qiskit.circuit.library.CHGate").
  </Function>

  ### cls\_instances

  <Function id="qiskit.circuit.library.RealAmplitudes.cls_instances" name="cls_instances" signature="classmethod RealAmplitudes.cls_instances()">
    Return the current number of instances of this class, useful for auto naming.
  </Function>

  ### cls\_prefix

  <Function id="qiskit.circuit.library.RealAmplitudes.cls_prefix" name="cls_prefix" signature="classmethod RealAmplitudes.cls_prefix()">
    Return the prefix to use for auto naming.
  </Function>

  ### cnot

  <Function id="qiskit.circuit.library.RealAmplitudes.cnot" name="cnot" signature="RealAmplitudes.cnot(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CXGate`](qiskit.circuit.library.CXGate "qiskit.circuit.library.CXGate").
  </Function>

  ### combine

  <Function id="qiskit.circuit.library.RealAmplitudes.combine" name="combine" signature="RealAmplitudes.combine(rhs)">
  ...
  <Function id="qiskit.circuit.library.RealAmplitudes.compose" name="compose" signature="RealAmplitudes.compose(other, qubits=None, clbits=None, front=False, inplace=False)">
  ...
  <Function id="qiskit.circuit.library.RealAmplitudes.copy" name="copy" signature="RealAmplitudes.copy(name=None)">
    Copy the circuit.
  ...
  <Function id="qiskit.circuit.library.RealAmplitudes.count_ops" name="count_ops" signature="RealAmplitudes.count_ops()">
  ...
  <Function id="qiskit.circuit.library.RealAmplitudes.crx" name="crx" signature="RealAmplitudes.crx(theta, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CRXGate`](qiskit.circuit.library.CRXGate "qiskit.circuit.library.CRXGate").
  </Function>

  ### cry

  <Function id="qiskit.circuit.library.RealAmplitudes.cry" name="cry" signature="RealAmplitudes.cry(theta, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CRYGate`](qiskit.circuit.library.CRYGate "qiskit.circuit.library.CRYGate").
  </Function>

  ### crz

  <Function id="qiskit.circuit.library.RealAmplitudes.crz" name="crz" signature="RealAmplitudes.crz(theta, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CRZGate`](qiskit.circuit.library.CRZGate "qiskit.circuit.library.CRZGate").
  </Function>

  ### cswap

  <Function id="qiskit.circuit.library.RealAmplitudes.cswap" name="cswap" signature="RealAmplitudes.cswap(control_qubit, target_qubit1, target_qubit2, *, label=None, ctrl_state=None, ctl=None, tgt1=None, tgt2=None)">
    Apply [`CSwapGate`](qiskit.circuit.library.CSwapGate "qiskit.circuit.library.CSwapGate").
  </Function>

  ### cu1

  <Function id="qiskit.circuit.library.RealAmplitudes.cu1" name="cu1" signature="RealAmplitudes.cu1(theta, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CU1Gate`](qiskit.circuit.library.CU1Gate "qiskit.circuit.library.CU1Gate").
  </Function>

  ### cu3

  <Function id="qiskit.circuit.library.RealAmplitudes.cu3" name="cu3" signature="RealAmplitudes.cu3(theta, phi, lam, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CU3Gate`](qiskit.circuit.library.CU3Gate "qiskit.circuit.library.CU3Gate").
  </Function>

  ### cx

  <Function id="qiskit.circuit.library.RealAmplitudes.cx" name="cx" signature="RealAmplitudes.cx(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CXGate`](qiskit.circuit.library.CXGate "qiskit.circuit.library.CXGate").
  </Function>

  ### cy

  <Function id="qiskit.circuit.library.RealAmplitudes.cy" name="cy" signature="RealAmplitudes.cy(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CYGate`](qiskit.circuit.library.CYGate "qiskit.circuit.library.CYGate").
  </Function>

  ### cz

  <Function id="qiskit.circuit.library.RealAmplitudes.cz" name="cz" signature="RealAmplitudes.cz(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CZGate`](qiskit.circuit.library.CZGate "qiskit.circuit.library.CZGate").
  </Function>

  ### dcx

  <Function id="qiskit.circuit.library.RealAmplitudes.dcx" name="dcx" signature="RealAmplitudes.dcx(qubit1, qubit2)">
    Apply [`DCXGate`](qiskit.circuit.library.DCXGate "qiskit.circuit.library.DCXGate").
  </Function>

  ### decompose

  <Function id="qiskit.circuit.library.RealAmplitudes.decompose" name="decompose" signature="RealAmplitudes.decompose()">
  ...
  <Function id="qiskit.circuit.library.RealAmplitudes.depth" name="depth" signature="RealAmplitudes.depth()">
  ...
  <Function id="qiskit.circuit.library.RealAmplitudes.diag_gate" name="diag_gate" signature="RealAmplitudes.diag_gate(diag, qubit)">
    Deprecated version of QuantumCircuit.diagonal.
  </Function>

  ### diagonal

  <Function id="qiskit.circuit.library.RealAmplitudes.diagonal" name="diagonal" signature="RealAmplitudes.diagonal(diag, qubit)">
  ...
  <Function id="qiskit.circuit.library.RealAmplitudes.extend" name="extend" signature="RealAmplitudes.extend(rhs)">
  ...
  <Function id="qiskit.circuit.library.RealAmplitudes.fredkin" name="fredkin" signature="RealAmplitudes.fredkin(control_qubit, target_qubit1, target_qubit2, *, ctl=None, tgt1=None, tgt2=None)">
    Apply [`CSwapGate`](qiskit.circuit.library.CSwapGate "qiskit.circuit.library.CSwapGate").
  </Function>

  ### from\_qasm\_file

  <Function id="qiskit.circuit.library.RealAmplitudes.from_qasm_file" name="from_qasm_file" signature="static RealAmplitudes.from_qasm_file(path)">
  ...
  <Function id="qiskit.circuit.library.RealAmplitudes.from_qasm_str" name="from_qasm_str" signature="static RealAmplitudes.from_qasm_str(qasm_str)">
  ...
  <Function id="qiskit.circuit.library.RealAmplitudes.get_entangler_map" name="get_entangler_map" signature="RealAmplitudes.get_entangler_map(rep_num, block_num, num_block_qubits)">
  ...
  <Function id="qiskit.circuit.library.RealAmplitudes.get_unentangled_qubits" name="get_unentangled_qubits" signature="RealAmplitudes.get_unentangled_qubits()">
  ...
  <Function id="qiskit.circuit.library.RealAmplitudes.h" name="h" signature="RealAmplitudes.h(qubit, *, q=None)">
    Apply [`HGate`](qiskit.circuit.library.HGate "qiskit.circuit.library.HGate").
  </Function>

  ### hamiltonian

  <Function id="qiskit.circuit.library.RealAmplitudes.hamiltonian" name="hamiltonian" signature="RealAmplitudes.hamiltonian(operator, time, qubits, label=None)">
    Apply hamiltonian evolution to to qubits.
  </Function>

  ### has\_register

  <Function id="qiskit.circuit.library.RealAmplitudes.has_register" name="has_register" signature="RealAmplitudes.has_register(register)">
  ...
  <Function id="qiskit.circuit.library.RealAmplitudes.i" name="i" signature="RealAmplitudes.i(qubit, *, q=None)">
    Apply [`IGate`](qiskit.circuit.library.IGate "qiskit.circuit.library.IGate").
  </Function>

  ### id

  <Function id="qiskit.circuit.library.RealAmplitudes.id" name="id" signature="RealAmplitudes.id(qubit, *, q=None)">
    Apply [`IGate`](qiskit.circuit.library.IGate "qiskit.circuit.library.IGate").
  </Function>

  ### iden

  <Function id="qiskit.circuit.library.RealAmplitudes.iden" name="iden" signature="RealAmplitudes.iden(qubit, *, q=None)">
    Deprecated identity gate.
  </Function>

  ### initialize

  <Function id="qiskit.circuit.library.RealAmplitudes.initialize" name="initialize" signature="RealAmplitudes.initialize(params, qubits)">
    Apply initialize to circuit.
  </Function>

  ### inverse

  <Function id="qiskit.circuit.library.RealAmplitudes.inverse" name="inverse" signature="RealAmplitudes.inverse()">
    Invert this circuit.
  ...
  <Function id="qiskit.circuit.library.RealAmplitudes.iso" name="iso" signature="RealAmplitudes.iso(isometry, q_input, q_ancillas_for_output, q_ancillas_zero=None, q_ancillas_dirty=None)">
  ...
  <Function id="qiskit.circuit.library.RealAmplitudes.isometry" name="isometry" signature="RealAmplitudes.isometry(isometry, q_input, q_ancillas_for_output, q_ancillas_zero=None, q_ancillas_dirty=None)">
    Attach an arbitrary isometry from m to n qubits to a circuit. In particular, this allows to attach arbitrary unitaries on n qubits (m=n) or to prepare any state on n qubits (m=0). The decomposition used here was introduced by Iten et al. in [https://arxiv.org/abs/1501.06911](https://arxiv.org/abs/1501.06911).
  ...
  <Function id="qiskit.circuit.library.RealAmplitudes.iswap" name="iswap" signature="RealAmplitudes.iswap(qubit1, qubit2)">
    Apply [`iSwapGate`](qiskit.circuit.library.iSwapGate "qiskit.circuit.library.iSwapGate").
  </Function>

  ### mcmt

  <Function id="qiskit.circuit.library.RealAmplitudes.mcmt" name="mcmt" signature="RealAmplitudes.mcmt(gate, control_qubits, target_qubits, ancilla_qubits=None, mode='no-ancilla', *, single_control_gate_fun=None, q_controls=None, q_ancillae=None, q_targets=None)">
  ...
  <Function id="qiskit.circuit.library.RealAmplitudes.mcrx" name="mcrx" signature="RealAmplitudes.mcrx(theta, q_controls, q_target, use_basis_gates=False)">
  ...
  <Function id="qiskit.circuit.library.RealAmplitudes.mcry" name="mcry" signature="RealAmplitudes.mcry(theta, q_controls, q_target, q_ancillae, mode='basic', use_basis_gates=False)">
  ...
  <Function id="qiskit.circuit.library.RealAmplitudes.mcrz" name="mcrz" signature="RealAmplitudes.mcrz(lam, q_controls, q_target, use_basis_gates=False)">
  ...
  <Function id="qiskit.circuit.library.RealAmplitudes.mct" name="mct" signature="RealAmplitudes.mct(control_qubits, target_qubit, ancilla_qubits=None, mode='noancilla')">
    Apply `MCXGate`.
  </Function>

  ### mcu1

  <Function id="qiskit.circuit.library.RealAmplitudes.mcu1" name="mcu1" signature="RealAmplitudes.mcu1(lam, control_qubits, target_qubit)">
    Apply `MCU1Gate`.
  </Function>

  ### mcx

  <Function id="qiskit.circuit.library.RealAmplitudes.mcx" name="mcx" signature="RealAmplitudes.mcx(control_qubits, target_qubit, ancilla_qubits=None, mode='noancilla')">
    Apply `MCXGate`.
  ...
  <Function id="qiskit.circuit.library.RealAmplitudes.measure" name="measure" signature="RealAmplitudes.measure(qubit, cbit)">
  ...
  <Function id="qiskit.circuit.library.RealAmplitudes.measure_active" name="measure_active" signature="RealAmplitudes.measure_active(inplace=True)">
  ...
  <Function id="qiskit.circuit.library.RealAmplitudes.measure_all" name="measure_all" signature="RealAmplitudes.measure_all(inplace=True)">
  ...
  <Function id="qiskit.circuit.library.RealAmplitudes.mirror" name="mirror" signature="RealAmplitudes.mirror()">
  ...
  <Function id="qiskit.circuit.library.RealAmplitudes.ms" name="ms" signature="RealAmplitudes.ms(theta, qubits)">
    Apply [`MSGate`](qiskit.circuit.library.MSGate "qiskit.circuit.library.MSGate").
  </Function>

  ### num\_connected\_components

  <Function id="qiskit.circuit.library.RealAmplitudes.num_connected_components" name="num_connected_components" signature="RealAmplitudes.num_connected_components(unitary_only=False)">
  ...
  <Function id="qiskit.circuit.library.RealAmplitudes.num_nonlocal_gates" name="num_nonlocal_gates" signature="RealAmplitudes.num_nonlocal_gates()">
  ...
  <Function id="qiskit.circuit.library.RealAmplitudes.num_tensor_factors" name="num_tensor_factors" signature="RealAmplitudes.num_tensor_factors()">
  ...
  <Function id="qiskit.circuit.library.RealAmplitudes.num_unitary_factors" name="num_unitary_factors" signature="RealAmplitudes.num_unitary_factors()">
    Computes the number of tensor factors in the unitary (quantum) part of the circuit only.
  </Function>

  ### print\_settings

  <Function id="qiskit.circuit.library.RealAmplitudes.print_settings" name="print_settings" signature="RealAmplitudes.print_settings()">
  ...
  <Function id="qiskit.circuit.library.RealAmplitudes.qasm" name="qasm" signature="RealAmplitudes.qasm(formatted=False, filename=None)">
  ...
  <Function id="qiskit.circuit.library.RealAmplitudes.qbit_argument_conversion" name="qbit_argument_conversion" signature="RealAmplitudes.qbit_argument_conversion(qubit_representation)">
  ...
  <Function id="qiskit.circuit.library.RealAmplitudes.r" name="r" signature="RealAmplitudes.r(theta, phi, qubit, *, q=None)">
    Apply `RGate`.
  </Function>

  ### rcccx

  <Function id="qiskit.circuit.library.RealAmplitudes.rcccx" name="rcccx" signature="RealAmplitudes.rcccx(control_qubit1, control_qubit2, control_qubit3, target_qubit)">
    Apply [`RC3XGate`](qiskit.circuit.library.RC3XGate "qiskit.circuit.library.RC3XGate").
  </Function>

  ### rccx

  <Function id="qiskit.circuit.library.RealAmplitudes.rccx" name="rccx" signature="RealAmplitudes.rccx(control_qubit1, control_qubit2, target_qubit)">
    Apply [`RCCXGate`](qiskit.circuit.library.RCCXGate "qiskit.circuit.library.RCCXGate").
  </Function>

  ### remove\_final\_measurements

  <Function id="qiskit.circuit.library.RealAmplitudes.remove_final_measurements" name="remove_final_measurements" signature="RealAmplitudes.remove_final_measurements(inplace=True)">
  ...
  <Function id="qiskit.circuit.library.RealAmplitudes.reset" name="reset" signature="RealAmplitudes.reset(qubit)">
    Reset q.
  </Function>

  ### rx

  <Function id="qiskit.circuit.library.RealAmplitudes.rx" name="rx" signature="RealAmplitudes.rx(theta, qubit, *, label=None, q=None)">
    Apply [`RXGate`](qiskit.circuit.library.RXGate "qiskit.circuit.library.RXGate").
  </Function>

  ### rxx

  <Function id="qiskit.circuit.library.RealAmplitudes.rxx" name="rxx" signature="RealAmplitudes.rxx(theta, qubit1, qubit2)">
    Apply [`RXXGate`](qiskit.circuit.library.RXXGate "qiskit.circuit.library.RXXGate").
  </Function>

  ### ry

  <Function id="qiskit.circuit.library.RealAmplitudes.ry" name="ry" signature="RealAmplitudes.ry(theta, qubit, *, label=None, q=None)">
    Apply [`RYGate`](qiskit.circuit.library.RYGate "qiskit.circuit.library.RYGate").
  </Function>

  ### ryy

  <Function id="qiskit.circuit.library.RealAmplitudes.ryy" name="ryy" signature="RealAmplitudes.ryy(theta, qubit1, qubit2)">
    Apply [`RYYGate`](qiskit.circuit.library.RYYGate "qiskit.circuit.library.RYYGate").
  </Function>

  ### rz

  <Function id="qiskit.circuit.library.RealAmplitudes.rz" name="rz" signature="RealAmplitudes.rz(phi, qubit, *, q=None)">
    Apply [`RZGate`](qiskit.circuit.library.RZGate "qiskit.circuit.library.RZGate").
  </Function>

  ### rzx

  <Function id="qiskit.circuit.library.RealAmplitudes.rzx" name="rzx" signature="RealAmplitudes.rzx(theta, qubit1, qubit2)">
    Apply [`RZXGate`](qiskit.circuit.library.RZXGate "qiskit.circuit.library.RZXGate").
  </Function>

  ### rzz

  <Function id="qiskit.circuit.library.RealAmplitudes.rzz" name="rzz" signature="RealAmplitudes.rzz(theta, qubit1, qubit2)">
    Apply [`RZZGate`](qiskit.circuit.library.RZZGate "qiskit.circuit.library.RZZGate").
  </Function>

  ### s

  <Function id="qiskit.circuit.library.RealAmplitudes.s" name="s" signature="RealAmplitudes.s(qubit, *, q=None)">
    Apply [`SGate`](qiskit.circuit.library.SGate "qiskit.circuit.library.SGate").
  </Function>

  ### sdg

  <Function id="qiskit.circuit.library.RealAmplitudes.sdg" name="sdg" signature="RealAmplitudes.sdg(qubit, *, q=None)">
    Apply [`SdgGate`](qiskit.circuit.library.SdgGate "qiskit.circuit.library.SdgGate").
  </Function>

  ### size

  <Function id="qiskit.circuit.library.RealAmplitudes.size" name="size" signature="RealAmplitudes.size()">
  ...
  <Function id="qiskit.circuit.library.RealAmplitudes.snapshot" name="snapshot" signature="RealAmplitudes.snapshot(label, snapshot_type='statevector', qubits=None, params=None)">
  ...
  <Function id="qiskit.circuit.library.RealAmplitudes.snapshot_density_matrix" name="snapshot_density_matrix" signature="RealAmplitudes.snapshot_density_matrix(label, qubits=None)">
  ...
  <Function id="qiskit.circuit.library.RealAmplitudes.snapshot_expectation_value" name="snapshot_expectation_value" signature="RealAmplitudes.snapshot_expectation_value(label, op, qubits, single_shot=False, variance=False)">
  ...
  <Function id="qiskit.circuit.library.RealAmplitudes.snapshot_probabilities" name="snapshot_probabilities" signature="RealAmplitudes.snapshot_probabilities(label, qubits, variance=False)">
  ...
  <Function id="qiskit.circuit.library.RealAmplitudes.snapshot_stabilizer" name="snapshot_stabilizer" signature="RealAmplitudes.snapshot_stabilizer(label)">
  ...
  <Function id="qiskit.circuit.library.RealAmplitudes.snapshot_statevector" name="snapshot_statevector" signature="RealAmplitudes.snapshot_statevector(label)">
  ...
  <Function id="qiskit.circuit.library.RealAmplitudes.squ" name="squ" signature="RealAmplitudes.squ(unitary_matrix, qubit, mode='ZYZ', up_to_diagonal=False, *, u=None)">
  ...
  <Function id="qiskit.circuit.library.RealAmplitudes.swap" name="swap" signature="RealAmplitudes.swap(qubit1, qubit2)">
    Apply [`SwapGate`](qiskit.circuit.library.SwapGate "qiskit.circuit.library.SwapGate").
  </Function>

  ### t

  <Function id="qiskit.circuit.library.RealAmplitudes.t" name="t" signature="RealAmplitudes.t(qubit, *, q=None)">
    Apply [`TGate`](qiskit.circuit.library.TGate "qiskit.circuit.library.TGate").
  </Function>

  ### tdg

  <Function id="qiskit.circuit.library.RealAmplitudes.tdg" name="tdg" signature="RealAmplitudes.tdg(qubit, *, q=None)">
    Apply [`TdgGate`](qiskit.circuit.library.TdgGate "qiskit.circuit.library.TdgGate").
  </Function>

  ### to\_gate

  <Function id="qiskit.circuit.library.RealAmplitudes.to_gate" name="to_gate" signature="RealAmplitudes.to_gate(parameter_map=None)">
  ...
  <Function id="qiskit.circuit.library.RealAmplitudes.to_instruction" name="to_instruction" signature="RealAmplitudes.to_instruction(parameter_map=None)">
  ...
  <Function id="qiskit.circuit.library.RealAmplitudes.toffoli" name="toffoli" signature="RealAmplitudes.toffoli(control_qubit1, control_qubit2, target_qubit, *, ctl1=None, ctl2=None, tgt=None)">
    Apply [`CCXGate`](qiskit.circuit.library.CCXGate "qiskit.circuit.library.CCXGate").
  </Function>

  ### u1

  <Function id="qiskit.circuit.library.RealAmplitudes.u1" name="u1" signature="RealAmplitudes.u1(theta, qubit, *, q=None)">
    Apply [`U1Gate`](qiskit.circuit.library.U1Gate "qiskit.circuit.library.U1Gate").
  </Function>

  ### u2

  <Function id="qiskit.circuit.library.RealAmplitudes.u2" name="u2" signature="RealAmplitudes.u2(phi, lam, qubit, *, q=None)">
    Apply [`U2Gate`](qiskit.circuit.library.U2Gate "qiskit.circuit.library.U2Gate").
  </Function>

  ### u3

  <Function id="qiskit.circuit.library.RealAmplitudes.u3" name="u3" signature="RealAmplitudes.u3(theta, phi, lam, qubit, *, q=None)">
    Apply [`U3Gate`](qiskit.circuit.library.U3Gate "qiskit.circuit.library.U3Gate").
  </Function>

  ### uc

  <Function id="qiskit.circuit.library.RealAmplitudes.uc" name="uc" signature="RealAmplitudes.uc(gate_list, q_controls, q_target, up_to_diagonal=False)">
  ...
  <Function id="qiskit.circuit.library.RealAmplitudes.ucg" name="ucg" signature="RealAmplitudes.ucg(angle_list, q_controls, q_target, up_to_diagonal=False)">
    Deprecated version of uc.
  </Function>

  ### ucrx

  <Function id="qiskit.circuit.library.RealAmplitudes.ucrx" name="ucrx" signature="RealAmplitudes.ucrx(angle_list, q_controls, q_target)">
  ...
  <Function id="qiskit.circuit.library.RealAmplitudes.ucry" name="ucry" signature="RealAmplitudes.ucry(angle_list, q_controls, q_target)">
  ...
  <Function id="qiskit.circuit.library.RealAmplitudes.ucrz" name="ucrz" signature="RealAmplitudes.ucrz(angle_list, q_controls, q_target)">
  ...
  <Function id="qiskit.circuit.library.RealAmplitudes.ucx" name="ucx" signature="RealAmplitudes.ucx(angle_list, q_controls, q_target)">
    Deprecated version of ucrx.
  </Function>

  ### ucy

  <Function id="qiskit.circuit.library.RealAmplitudes.ucy" name="ucy" signature="RealAmplitudes.ucy(angle_list, q_controls, q_target)">
    Deprecated version of ucry.
  </Function>

  ### ucz

  <Function id="qiskit.circuit.library.RealAmplitudes.ucz" name="ucz" signature="RealAmplitudes.ucz(angle_list, q_controls, q_target)">
    Deprecated version of ucrz.
  </Function>

  ### unitary

  <Function id="qiskit.circuit.library.RealAmplitudes.unitary" name="unitary" signature="RealAmplitudes.unitary(obj, qubits, label=None)">
    Apply unitary gate to q.
  </Function>

  ### width

  <Function id="qiskit.circuit.library.RealAmplitudes.width" name="width" signature="RealAmplitudes.width()">
  ...
  <Function id="qiskit.circuit.library.RealAmplitudes.x" name="x" signature="RealAmplitudes.x(qubit, *, label=None, ctrl_state=None, q=None)">
    Apply [`XGate`](qiskit.circuit.library.XGate "qiskit.circuit.library.XGate").
  </Function>

  ### y

  <Function id="qiskit.circuit.library.RealAmplitudes.y" name="y" signature="RealAmplitudes.y(qubit, *, q=None)">
    Apply [`YGate`](qiskit.circuit.library.YGate "qiskit.circuit.library.YGate").
  </Function>

  ### z

  <Function id="qiskit.circuit.library.RealAmplitudes.z" name="z" signature="RealAmplitudes.z(qubit, *, q=None)">
