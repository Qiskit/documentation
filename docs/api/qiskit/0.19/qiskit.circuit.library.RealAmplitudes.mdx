---
title: RealAmplitudes (v0.19)
description: API reference for qiskit.circuit.library.RealAmplitudes in qiskit v0.19
...
<Class id="qiskit.circuit.library.RealAmplitudes" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.14/qiskit/circuit/library/n_local/real_amplitudes.py" signature="RealAmplitudes(num_qubits=None, entanglement='full', reps=3, skip_unentangled_qubits=False, skip_final_rotation_layer=False, parameter_prefix='θ', insert_barriers=False, initial_state=None)" modifiers="class">
  ...
  *   **insert\_barriers** (`bool`) – If True, barriers are inserted in between each layer. If False, no barriers are inserted.
  ...
  <span id="realamplitudes-entanglement" />

  ### entanglement

  <Attribute id="qiskit.circuit.library.RealAmplitudes.entanglement" attributeTypeHint="Union[str, List[str], List[List[str]], List[int], List[List[int]], List[List[List[int]]], List[List[List[List[int]]]], Callable[[int], str], Callable[[int], List[List[int]]]]">
  ...
  <span id="realamplitudes-entanglement-blocks" />

  ### entanglement\_blocks

  <Attribute id="qiskit.circuit.library.RealAmplitudes.entanglement_blocks" attributeTypeHint="List[qiskit.circuit.instruction.Instruction]">
  ...
  <span id="realamplitudes-extension-lib" />

  ### extension\_lib

  <Attribute id="qiskit.circuit.library.RealAmplitudes.extension_lib" attributeValue="'include &#x22;qelib1.inc&#x22;;'" />

  <span id="realamplitudes-header" />

  ### header

  <Attribute id="qiskit.circuit.library.RealAmplitudes.header" attributeValue="'OPENQASM 2.0;'" />

  <span id="realamplitudes-initial-state" />

  ### initial\_state

  <Attribute id="qiskit.circuit.library.RealAmplitudes.initial_state" attributeTypeHint="Any">
  ...
  <span id="realamplitudes-insert-barriers" />

  ### insert\_barriers

  <Attribute id="qiskit.circuit.library.RealAmplitudes.insert_barriers" attributeTypeHint="bool">
  ...
  <span id="realamplitudes-instances" />

  ### instances

  <Attribute id="qiskit.circuit.library.RealAmplitudes.instances" attributeValue="8" />

  <span id="realamplitudes-n-qubits" />

  ### n\_qubits

  <Attribute id="qiskit.circuit.library.RealAmplitudes.n_qubits">
    Deprecated, use `num_qubits` instead. Return number of qubits.
  </Attribute>

  <span id="realamplitudes-num-clbits" />
  ...
  <span id="realamplitudes-num-layers" />

  ### num\_layers

  <Attribute id="qiskit.circuit.library.RealAmplitudes.num_layers" attributeTypeHint="int">
  ...
  <span id="realamplitudes-num-parameters" />
  ...
  <span id="realamplitudes-num-parameters-settable" />

  ### num\_parameters\_settable

  <Attribute id="qiskit.circuit.library.RealAmplitudes.num_parameters_settable" attributeTypeHint="int">
  ...
  <span id="realamplitudes-num-qubits" />

  ### num\_qubits

  <Attribute id="qiskit.circuit.library.RealAmplitudes.num_qubits" attributeTypeHint="int">
  ...
  <span id="realamplitudes-ordered-parameters" />

  ### ordered\_parameters

  <Attribute id="qiskit.circuit.library.RealAmplitudes.ordered_parameters" attributeTypeHint="List[qiskit.circuit.parameter.Parameter]">
  ...
  <span id="realamplitudes-parameter-bounds" />

  ### parameter\_bounds

  <Attribute id="qiskit.circuit.library.RealAmplitudes.parameter_bounds" attributeTypeHint="List[Tuple[float, float]]">
  ...
  <span id="realamplitudes-parameters" />

  ### parameters

  <Attribute id="qiskit.circuit.library.RealAmplitudes.parameters" attributeTypeHint="Set[qiskit.circuit.parameter.Parameter]">
  ...
  <span id="realamplitudes-preferred-init-points" />

  ### preferred\_init\_points

  <Attribute id="qiskit.circuit.library.RealAmplitudes.preferred_init_points" attributeTypeHint="Optional[List[float]]">
  ...
  <span id="realamplitudes-reps" />

  ### reps

  <Attribute id="qiskit.circuit.library.RealAmplitudes.reps" attributeTypeHint="int">
  ...
  <span id="realamplitudes-rotation-blocks" />

  ### rotation\_blocks

  <Attribute id="qiskit.circuit.library.RealAmplitudes.rotation_blocks" attributeTypeHint="List[qiskit.circuit.instruction.Instruction]">
  ...
  <span id="realamplitudes-and" />

  ### AND

  <Function id="qiskit.circuit.library.RealAmplitudes.AND" signature="RealAmplitudes.AND(qr_variables, qb_target, qr_ancillae, flags=None, mct_mode='no-ancilla')">
  ...
  <span id="realamplitudes-or" />

  ### OR

  <Function id="qiskit.circuit.library.RealAmplitudes.OR" signature="RealAmplitudes.OR(qr_variables, qb_target, qr_ancillae, flags=None, mct_mode='basic')">
  ...
  <span id="realamplitudes-getitem" />

  ### \_\_getitem\_\_

  <Function id="qiskit.circuit.library.RealAmplitudes.__getitem__" signature="RealAmplitudes.__getitem__(item)">
    Return indexed operation.
  </Function>

  <span id="realamplitudes-len" />

  ### \_\_len\_\_

  <Function id="qiskit.circuit.library.RealAmplitudes.__len__" signature="RealAmplitudes.__len__()">
    Return number of operations in circuit.
  </Function>

  <span id="realamplitudes-add-layer" />

  ### add\_layer

  <Function id="qiskit.circuit.library.RealAmplitudes.add_layer" signature="RealAmplitudes.add_layer(other, entanglement=None, front=False)">
  ...
  <span id="realamplitudes-add-register" />

  ### add\_register

  <Function id="qiskit.circuit.library.RealAmplitudes.add_register" signature="RealAmplitudes.add_register(*regs)">
    Add registers.
  </Function>

  <span id="realamplitudes-append" />

  ### append

  <Function id="qiskit.circuit.library.RealAmplitudes.append" signature="RealAmplitudes.append(instruction, qargs=None, cargs=None)">
  ...
  <span id="realamplitudes-assign-parameters" />

  ### assign\_parameters

  <Function id="qiskit.circuit.library.RealAmplitudes.assign_parameters" signature="RealAmplitudes.assign_parameters(param_dict, inplace=False)">
  ...
  <span id="realamplitudes-barrier" />

  ### barrier

  <Function id="qiskit.circuit.library.RealAmplitudes.barrier" signature="RealAmplitudes.barrier(*qargs)">
    Apply `Barrier`. If qargs is None, applies to all.
  </Function>

  <span id="realamplitudes-bind-parameters" />

  ### bind\_parameters

  <Function id="qiskit.circuit.library.RealAmplitudes.bind_parameters" signature="RealAmplitudes.bind_parameters(value_dict)">
  ...
  <span id="realamplitudes-cast" />

  ### cast

  <Function id="qiskit.circuit.library.RealAmplitudes.cast" signature="RealAmplitudes.cast(value, _type)" modifiers="static">
    Best effort to cast value to type. Otherwise, returns the value.
  </Function>

  <span id="realamplitudes-cbit-argument-conversion" />

  ### cbit\_argument\_conversion

  <Function id="qiskit.circuit.library.RealAmplitudes.cbit_argument_conversion" signature="RealAmplitudes.cbit_argument_conversion(clbit_representation)">
  ...
  <span id="realamplitudes-ccx" />

  ### ccx

  <Function id="qiskit.circuit.library.RealAmplitudes.ccx" signature="RealAmplitudes.ccx(control_qubit1, control_qubit2, target_qubit, *, ctl1=None, ctl2=None, tgt=None)">
    Apply [`CCXGate`](qiskit.circuit.library.CCXGate "qiskit.circuit.library.CCXGate").
  </Function>

  <span id="realamplitudes-ch" />

  ### ch

  <Function id="qiskit.circuit.library.RealAmplitudes.ch" signature="RealAmplitudes.ch(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CHGate`](qiskit.circuit.library.CHGate "qiskit.circuit.library.CHGate").
  </Function>

  <span id="realamplitudes-cls-instances" />

  ### cls\_instances

  <Function id="qiskit.circuit.library.RealAmplitudes.cls_instances" signature="RealAmplitudes.cls_instances()" modifiers="classmethod">
    Return the current number of instances of this class, useful for auto naming.
  </Function>

  <span id="realamplitudes-cls-prefix" />

  ### cls\_prefix

  <Function id="qiskit.circuit.library.RealAmplitudes.cls_prefix" signature="RealAmplitudes.cls_prefix()" modifiers="classmethod">
    Return the prefix to use for auto naming.
  </Function>

  <span id="realamplitudes-cnot" />

  ### cnot

  <Function id="qiskit.circuit.library.RealAmplitudes.cnot" signature="RealAmplitudes.cnot(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CXGate`](qiskit.circuit.library.CXGate "qiskit.circuit.library.CXGate").
  </Function>

  <span id="realamplitudes-combine" />

  ### combine

  <Function id="qiskit.circuit.library.RealAmplitudes.combine" signature="RealAmplitudes.combine(rhs)">
  ...
  <span id="realamplitudes-compose" />

  ### compose

  <Function id="qiskit.circuit.library.RealAmplitudes.compose" signature="RealAmplitudes.compose(other, qubits=None, clbits=None, front=False, inplace=False)">
  ...
  <span id="realamplitudes-copy" />

  ### copy

  <Function id="qiskit.circuit.library.RealAmplitudes.copy" signature="RealAmplitudes.copy(name=None)">
    Copy the circuit.
  ...
  <span id="realamplitudes-count-ops" />

  ### count\_ops

  <Function id="qiskit.circuit.library.RealAmplitudes.count_ops" signature="RealAmplitudes.count_ops()">
  ...
  <span id="realamplitudes-crx" />

  ### crx

  <Function id="qiskit.circuit.library.RealAmplitudes.crx" signature="RealAmplitudes.crx(theta, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CRXGate`](qiskit.circuit.library.CRXGate "qiskit.circuit.library.CRXGate").
  </Function>

  <span id="realamplitudes-cry" />

  ### cry

  <Function id="qiskit.circuit.library.RealAmplitudes.cry" signature="RealAmplitudes.cry(theta, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CRYGate`](qiskit.circuit.library.CRYGate "qiskit.circuit.library.CRYGate").
  </Function>

  <span id="realamplitudes-crz" />

  ### crz

  <Function id="qiskit.circuit.library.RealAmplitudes.crz" signature="RealAmplitudes.crz(theta, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CRZGate`](qiskit.circuit.library.CRZGate "qiskit.circuit.library.CRZGate").
  </Function>

  <span id="realamplitudes-cswap" />

  ### cswap

  <Function id="qiskit.circuit.library.RealAmplitudes.cswap" signature="RealAmplitudes.cswap(control_qubit, target_qubit1, target_qubit2, *, label=None, ctrl_state=None, ctl=None, tgt1=None, tgt2=None)">
    Apply [`CSwapGate`](qiskit.circuit.library.CSwapGate "qiskit.circuit.library.CSwapGate").
  </Function>

  <span id="realamplitudes-cu1" />

  ### cu1

  <Function id="qiskit.circuit.library.RealAmplitudes.cu1" signature="RealAmplitudes.cu1(theta, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CU1Gate`](qiskit.circuit.library.CU1Gate "qiskit.circuit.library.CU1Gate").
  </Function>

  <span id="realamplitudes-cu3" />

  ### cu3

  <Function id="qiskit.circuit.library.RealAmplitudes.cu3" signature="RealAmplitudes.cu3(theta, phi, lam, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CU3Gate`](qiskit.circuit.library.CU3Gate "qiskit.circuit.library.CU3Gate").
  </Function>

  <span id="realamplitudes-cx" />

  ### cx

  <Function id="qiskit.circuit.library.RealAmplitudes.cx" signature="RealAmplitudes.cx(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CXGate`](qiskit.circuit.library.CXGate "qiskit.circuit.library.CXGate").
  </Function>

  <span id="realamplitudes-cy" />

  ### cy

  <Function id="qiskit.circuit.library.RealAmplitudes.cy" signature="RealAmplitudes.cy(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CYGate`](qiskit.circuit.library.CYGate "qiskit.circuit.library.CYGate").
  </Function>

  <span id="realamplitudes-cz" />

  ### cz

  <Function id="qiskit.circuit.library.RealAmplitudes.cz" signature="RealAmplitudes.cz(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CZGate`](qiskit.circuit.library.CZGate "qiskit.circuit.library.CZGate").
  </Function>

  <span id="realamplitudes-dcx" />

  ### dcx

  <Function id="qiskit.circuit.library.RealAmplitudes.dcx" signature="RealAmplitudes.dcx(qubit1, qubit2)">
    Apply [`DCXGate`](qiskit.circuit.library.DCXGate "qiskit.circuit.library.DCXGate").
  </Function>

  <span id="realamplitudes-decompose" />

  ### decompose

  <Function id="qiskit.circuit.library.RealAmplitudes.decompose" signature="RealAmplitudes.decompose()">
  ...
  <span id="realamplitudes-depth" />

  ### depth

  <Function id="qiskit.circuit.library.RealAmplitudes.depth" signature="RealAmplitudes.depth()">
  ...
  <span id="realamplitudes-diag-gate" />

  ### diag\_gate

  <Function id="qiskit.circuit.library.RealAmplitudes.diag_gate" signature="RealAmplitudes.diag_gate(diag, qubit)">
    Deprecated version of QuantumCircuit.diagonal.
  </Function>

  <span id="realamplitudes-diagonal" />

  ### diagonal

  <Function id="qiskit.circuit.library.RealAmplitudes.diagonal" signature="RealAmplitudes.diagonal(diag, qubit)">
  ...
  <span id="realamplitudes-extend" />

  ### extend

  <Function id="qiskit.circuit.library.RealAmplitudes.extend" signature="RealAmplitudes.extend(rhs)">
  ...
  <span id="realamplitudes-fredkin" />

  ### fredkin

  <Function id="qiskit.circuit.library.RealAmplitudes.fredkin" signature="RealAmplitudes.fredkin(control_qubit, target_qubit1, target_qubit2, *, ctl=None, tgt1=None, tgt2=None)">
    Apply [`CSwapGate`](qiskit.circuit.library.CSwapGate "qiskit.circuit.library.CSwapGate").
  </Function>

  <span id="realamplitudes-from-qasm-file" />

  ### from\_qasm\_file

  <Function id="qiskit.circuit.library.RealAmplitudes.from_qasm_file" signature="RealAmplitudes.from_qasm_file(path)" modifiers="static">
  ...
  <span id="realamplitudes-from-qasm-str" />

  ### from\_qasm\_str

  <Function id="qiskit.circuit.library.RealAmplitudes.from_qasm_str" signature="RealAmplitudes.from_qasm_str(qasm_str)" modifiers="static">
  ...
  <span id="realamplitudes-get-entangler-map" />

  ### get\_entangler\_map

  <Function id="qiskit.circuit.library.RealAmplitudes.get_entangler_map" signature="RealAmplitudes.get_entangler_map(rep_num, block_num, num_block_qubits)">
  ...
  <span id="realamplitudes-get-unentangled-qubits" />

  ### get\_unentangled\_qubits

  <Function id="qiskit.circuit.library.RealAmplitudes.get_unentangled_qubits" signature="RealAmplitudes.get_unentangled_qubits()">
  ...
  <span id="realamplitudes-h" />

  ### h

  <Function id="qiskit.circuit.library.RealAmplitudes.h" signature="RealAmplitudes.h(qubit, *, q=None)">
    Apply [`HGate`](qiskit.circuit.library.HGate "qiskit.circuit.library.HGate").
  </Function>

  <span id="realamplitudes-hamiltonian" />

  ### hamiltonian

  <Function id="qiskit.circuit.library.RealAmplitudes.hamiltonian" signature="RealAmplitudes.hamiltonian(operator, time, qubits, label=None)">
    Apply hamiltonian evolution to to qubits.
  </Function>

  <span id="realamplitudes-has-register" />

  ### has\_register

  <Function id="qiskit.circuit.library.RealAmplitudes.has_register" signature="RealAmplitudes.has_register(register)">
  ...
  <span id="realamplitudes-i" />

  ### i

  <Function id="qiskit.circuit.library.RealAmplitudes.i" signature="RealAmplitudes.i(qubit, *, q=None)">
    Apply [`IGate`](qiskit.circuit.library.IGate "qiskit.circuit.library.IGate").
  </Function>

  <span id="realamplitudes-id" />

  ### id

  <Function id="qiskit.circuit.library.RealAmplitudes.id" signature="RealAmplitudes.id(qubit, *, q=None)">
    Apply [`IGate`](qiskit.circuit.library.IGate "qiskit.circuit.library.IGate").
  </Function>

  <span id="realamplitudes-iden" />

  ### iden

  <Function id="qiskit.circuit.library.RealAmplitudes.iden" signature="RealAmplitudes.iden(qubit, *, q=None)">
    Deprecated identity gate.
  </Function>

  <span id="realamplitudes-initialize" />

  ### initialize

  <Function id="qiskit.circuit.library.RealAmplitudes.initialize" signature="RealAmplitudes.initialize(params, qubits)">
    Apply initialize to circuit.
  </Function>

  <span id="realamplitudes-inverse" />

  ### inverse

  <Function id="qiskit.circuit.library.RealAmplitudes.inverse" signature="RealAmplitudes.inverse()">
    Invert this circuit.
  ...
  <span id="realamplitudes-iso" />

  ### iso

  <Function id="qiskit.circuit.library.RealAmplitudes.iso" signature="RealAmplitudes.iso(isometry, q_input, q_ancillas_for_output, q_ancillas_zero=None, q_ancillas_dirty=None)">
  ...
  <span id="realamplitudes-isometry" />

  ### isometry

  <Function id="qiskit.circuit.library.RealAmplitudes.isometry" signature="RealAmplitudes.isometry(isometry, q_input, q_ancillas_for_output, q_ancillas_zero=None, q_ancillas_dirty=None)">
    Attach an arbitrary isometry from m to n qubits to a circuit. In particular, this allows to attach arbitrary unitaries on n qubits (m=n) or to prepare any state on n qubits (m=0). The decomposition used here was introduced by Iten et al. in [https://arxiv.org/abs/1501.06911](https://arxiv.org/abs/1501.06911).
  ...
  <span id="realamplitudes-iswap" />

  ### iswap

  <Function id="qiskit.circuit.library.RealAmplitudes.iswap" signature="RealAmplitudes.iswap(qubit1, qubit2)">
    Apply [`iSwapGate`](qiskit.circuit.library.iSwapGate "qiskit.circuit.library.iSwapGate").
  </Function>

  <span id="realamplitudes-mcmt" />

  ### mcmt

  <Function id="qiskit.circuit.library.RealAmplitudes.mcmt" signature="RealAmplitudes.mcmt(gate, control_qubits, target_qubits, ancilla_qubits=None, mode='no-ancilla', *, single_control_gate_fun=None, q_controls=None, q_ancillae=None, q_targets=None)">
    Apply a multi-control, multi-target using a generic gate.

    This can also be used to implement a generic multi-control gate, as the target could also be of length 1.
  </Function>

  <span id="realamplitudes-mcrx" />

  ### mcrx

  <Function id="qiskit.circuit.library.RealAmplitudes.mcrx" signature="RealAmplitudes.mcrx(theta, q_controls, q_target, use_basis_gates=False)">
  ...
  <span id="realamplitudes-mcry" />

  ### mcry

  <Function id="qiskit.circuit.library.RealAmplitudes.mcry" signature="RealAmplitudes.mcry(theta, q_controls, q_target, q_ancillae, mode='basic', use_basis_gates=False)">
  ...
  <span id="realamplitudes-mcrz" />

  ### mcrz

  <Function id="qiskit.circuit.library.RealAmplitudes.mcrz" signature="RealAmplitudes.mcrz(lam, q_controls, q_target, use_basis_gates=False)">
  ...
  <span id="realamplitudes-mct" />

  ### mct

  <Function id="qiskit.circuit.library.RealAmplitudes.mct" signature="RealAmplitudes.mct(control_qubits, target_qubit, ancilla_qubits=None, mode='noancilla')">
    Apply `MCXGate`.
  </Function>

  <span id="realamplitudes-mcu1" />

  ### mcu1

  <Function id="qiskit.circuit.library.RealAmplitudes.mcu1" signature="RealAmplitudes.mcu1(lam, control_qubits, target_qubit)">
    Apply `MCU1Gate`.
  </Function>

  <span id="realamplitudes-mcx" />

  ### mcx

  <Function id="qiskit.circuit.library.RealAmplitudes.mcx" signature="RealAmplitudes.mcx(control_qubits, target_qubit, ancilla_qubits=None, mode='noancilla')">
    Apply `MCXGate`.
  ...
  <span id="realamplitudes-measure" />

  ### measure

  <Function id="qiskit.circuit.library.RealAmplitudes.measure" signature="RealAmplitudes.measure(qubit, cbit)">
  ...
  <span id="realamplitudes-measure-active" />

  ### measure\_active

  <Function id="qiskit.circuit.library.RealAmplitudes.measure_active" signature="RealAmplitudes.measure_active(inplace=True)">
  ...
  <span id="realamplitudes-measure-all" />

  ### measure\_all

  <Function id="qiskit.circuit.library.RealAmplitudes.measure_all" signature="RealAmplitudes.measure_all(inplace=True)">
  ...
  <span id="realamplitudes-mirror" />

  ### mirror

  <Function id="qiskit.circuit.library.RealAmplitudes.mirror" signature="RealAmplitudes.mirror()">
  ...
  <span id="realamplitudes-ms" />

  ### ms

  <Function id="qiskit.circuit.library.RealAmplitudes.ms" signature="RealAmplitudes.ms(theta, qubits)">
    Apply [`MSGate`](qiskit.circuit.library.MSGate "qiskit.circuit.library.MSGate").
  </Function>

  <span id="realamplitudes-num-connected-components" />

  ### num\_connected\_components

  <Function id="qiskit.circuit.library.RealAmplitudes.num_connected_components" signature="RealAmplitudes.num_connected_components(unitary_only=False)">
  ...
  <span id="realamplitudes-num-nonlocal-gates" />

  ### num\_nonlocal\_gates

  <Function id="qiskit.circuit.library.RealAmplitudes.num_nonlocal_gates" signature="RealAmplitudes.num_nonlocal_gates()">
    Return number of non-local gates (i.e. involving 2+ qubits).

    Conditional nonlocal gates are also included.
  </Function>

  <span id="realamplitudes-num-tensor-factors" />

  ### num\_tensor\_factors

  <Function id="qiskit.circuit.library.RealAmplitudes.num_tensor_factors" signature="RealAmplitudes.num_tensor_factors()">
  ...
  <span id="realamplitudes-num-unitary-factors" />

  ### num\_unitary\_factors

  <Function id="qiskit.circuit.library.RealAmplitudes.num_unitary_factors" signature="RealAmplitudes.num_unitary_factors()">
    Computes the number of tensor factors in the unitary (quantum) part of the circuit only.
  </Function>

  <span id="realamplitudes-print-settings" />

  ### print\_settings

  <Function id="qiskit.circuit.library.RealAmplitudes.print_settings" signature="RealAmplitudes.print_settings()">
  ...
  <span id="realamplitudes-qasm" />

  ### qasm

  <Function id="qiskit.circuit.library.RealAmplitudes.qasm" signature="RealAmplitudes.qasm(formatted=False, filename=None)">
  ...
  <span id="realamplitudes-qbit-argument-conversion" />

  ### qbit\_argument\_conversion

  <Function id="qiskit.circuit.library.RealAmplitudes.qbit_argument_conversion" signature="RealAmplitudes.qbit_argument_conversion(qubit_representation)">
  ...
  <span id="realamplitudes-r" />

  ### r

  <Function id="qiskit.circuit.library.RealAmplitudes.r" signature="RealAmplitudes.r(theta, phi, qubit, *, q=None)">
    Apply `RGate`.
  </Function>

  <span id="realamplitudes-rcccx" />

  ### rcccx

  <Function id="qiskit.circuit.library.RealAmplitudes.rcccx" signature="RealAmplitudes.rcccx(control_qubit1, control_qubit2, control_qubit3, target_qubit)">
    Apply [`RC3XGate`](qiskit.circuit.library.RC3XGate "qiskit.circuit.library.RC3XGate").
  </Function>

  <span id="realamplitudes-rccx" />

  ### rccx

  <Function id="qiskit.circuit.library.RealAmplitudes.rccx" signature="RealAmplitudes.rccx(control_qubit1, control_qubit2, target_qubit)">
    Apply [`RCCXGate`](qiskit.circuit.library.RCCXGate "qiskit.circuit.library.RCCXGate").
  </Function>

  <span id="realamplitudes-remove-final-measurements" />

  ### remove\_final\_measurements

  <Function id="qiskit.circuit.library.RealAmplitudes.remove_final_measurements" signature="RealAmplitudes.remove_final_measurements(inplace=True)">
  ...
  <span id="realamplitudes-reset" />

  ### reset

  <Function id="qiskit.circuit.library.RealAmplitudes.reset" signature="RealAmplitudes.reset(qubit)">
    Reset q.
  </Function>

  <span id="realamplitudes-rx" />

  ### rx

  <Function id="qiskit.circuit.library.RealAmplitudes.rx" signature="RealAmplitudes.rx(theta, qubit, *, label=None, q=None)">
    Apply [`RXGate`](qiskit.circuit.library.RXGate "qiskit.circuit.library.RXGate").
  </Function>

  <span id="realamplitudes-rxx" />

  ### rxx

  <Function id="qiskit.circuit.library.RealAmplitudes.rxx" signature="RealAmplitudes.rxx(theta, qubit1, qubit2)">
    Apply [`RXXGate`](qiskit.circuit.library.RXXGate "qiskit.circuit.library.RXXGate").
  </Function>

  <span id="realamplitudes-ry" />

  ### ry

  <Function id="qiskit.circuit.library.RealAmplitudes.ry" signature="RealAmplitudes.ry(theta, qubit, *, label=None, q=None)">
    Apply [`RYGate`](qiskit.circuit.library.RYGate "qiskit.circuit.library.RYGate").
  </Function>

  <span id="realamplitudes-ryy" />

  ### ryy

  <Function id="qiskit.circuit.library.RealAmplitudes.ryy" signature="RealAmplitudes.ryy(theta, qubit1, qubit2)">
    Apply [`RYYGate`](qiskit.circuit.library.RYYGate "qiskit.circuit.library.RYYGate").
  </Function>

  <span id="realamplitudes-rz" />

  ### rz

  <Function id="qiskit.circuit.library.RealAmplitudes.rz" signature="RealAmplitudes.rz(phi, qubit, *, q=None)">
    Apply [`RZGate`](qiskit.circuit.library.RZGate "qiskit.circuit.library.RZGate").
  </Function>

  <span id="realamplitudes-rzx" />

  ### rzx

  <Function id="qiskit.circuit.library.RealAmplitudes.rzx" signature="RealAmplitudes.rzx(theta, qubit1, qubit2)">
    Apply [`RZXGate`](qiskit.circuit.library.RZXGate "qiskit.circuit.library.RZXGate").
  </Function>

  <span id="realamplitudes-rzz" />

  ### rzz

  <Function id="qiskit.circuit.library.RealAmplitudes.rzz" signature="RealAmplitudes.rzz(theta, qubit1, qubit2)">
    Apply [`RZZGate`](qiskit.circuit.library.RZZGate "qiskit.circuit.library.RZZGate").
  </Function>

  <span id="realamplitudes-s" />

  ### s

  <Function id="qiskit.circuit.library.RealAmplitudes.s" signature="RealAmplitudes.s(qubit, *, q=None)">
    Apply [`SGate`](qiskit.circuit.library.SGate "qiskit.circuit.library.SGate").
  </Function>

  <span id="realamplitudes-sdg" />

  ### sdg

  <Function id="qiskit.circuit.library.RealAmplitudes.sdg" signature="RealAmplitudes.sdg(qubit, *, q=None)">
    Apply [`SdgGate`](qiskit.circuit.library.SdgGate "qiskit.circuit.library.SdgGate").
  </Function>

  <span id="realamplitudes-size" />

  ### size

  <Function id="qiskit.circuit.library.RealAmplitudes.size" signature="RealAmplitudes.size()">
  ...
  <span id="realamplitudes-snapshot" />

  ### snapshot

  <Function id="qiskit.circuit.library.RealAmplitudes.snapshot" signature="RealAmplitudes.snapshot(label, snapshot_type='statevector', qubits=None, params=None)">
  ...
  <span id="realamplitudes-snapshot-density-matrix" />

  ### snapshot\_density\_matrix

  <Function id="qiskit.circuit.library.RealAmplitudes.snapshot_density_matrix" signature="RealAmplitudes.snapshot_density_matrix(label, qubits=None)">
  ...
  <span id="realamplitudes-snapshot-expectation-value" />

  ### snapshot\_expectation\_value

  <Function id="qiskit.circuit.library.RealAmplitudes.snapshot_expectation_value" signature="RealAmplitudes.snapshot_expectation_value(label, op, qubits, single_shot=False, variance=False)">
  ...
  <span id="realamplitudes-snapshot-probabilities" />

  ### snapshot\_probabilities

  <Function id="qiskit.circuit.library.RealAmplitudes.snapshot_probabilities" signature="RealAmplitudes.snapshot_probabilities(label, qubits, variance=False)">
  ...
  <span id="realamplitudes-snapshot-stabilizer" />

  ### snapshot\_stabilizer

  <Function id="qiskit.circuit.library.RealAmplitudes.snapshot_stabilizer" signature="RealAmplitudes.snapshot_stabilizer(label)">
  ...
  <span id="realamplitudes-snapshot-statevector" />

  ### snapshot\_statevector

  <Function id="qiskit.circuit.library.RealAmplitudes.snapshot_statevector" signature="RealAmplitudes.snapshot_statevector(label)">
  ...
  <span id="realamplitudes-squ" />

  ### squ

  <Function id="qiskit.circuit.library.RealAmplitudes.squ" signature="RealAmplitudes.squ(unitary_matrix, qubit, mode='ZYZ', up_to_diagonal=False, *, u=None)">
  ...
  <span id="realamplitudes-swap" />

  ### swap

  <Function id="qiskit.circuit.library.RealAmplitudes.swap" signature="RealAmplitudes.swap(qubit1, qubit2)">
    Apply [`SwapGate`](qiskit.circuit.library.SwapGate "qiskit.circuit.library.SwapGate").
  </Function>

  <span id="realamplitudes-t" />

  ### t

  <Function id="qiskit.circuit.library.RealAmplitudes.t" signature="RealAmplitudes.t(qubit, *, q=None)">
    Apply [`TGate`](qiskit.circuit.library.TGate "qiskit.circuit.library.TGate").
  </Function>

  <span id="realamplitudes-tdg" />

  ### tdg

  <Function id="qiskit.circuit.library.RealAmplitudes.tdg" signature="RealAmplitudes.tdg(qubit, *, q=None)">
    Apply [`TdgGate`](qiskit.circuit.library.TdgGate "qiskit.circuit.library.TdgGate").
  </Function>

  <span id="realamplitudes-to-gate" />

  ### to\_gate

  <Function id="qiskit.circuit.library.RealAmplitudes.to_gate" signature="RealAmplitudes.to_gate(parameter_map=None)">
  ...
  <span id="realamplitudes-to-instruction" />

  ### to\_instruction

  <Function id="qiskit.circuit.library.RealAmplitudes.to_instruction" signature="RealAmplitudes.to_instruction(parameter_map=None)">
  ...
  <span id="realamplitudes-toffoli" />

  ### toffoli

  <Function id="qiskit.circuit.library.RealAmplitudes.toffoli" signature="RealAmplitudes.toffoli(control_qubit1, control_qubit2, target_qubit, *, ctl1=None, ctl2=None, tgt=None)">
    Apply [`CCXGate`](qiskit.circuit.library.CCXGate "qiskit.circuit.library.CCXGate").
  </Function>

  <span id="realamplitudes-u1" />

  ### u1

  <Function id="qiskit.circuit.library.RealAmplitudes.u1" signature="RealAmplitudes.u1(theta, qubit, *, q=None)">
    Apply [`U1Gate`](qiskit.circuit.library.U1Gate "qiskit.circuit.library.U1Gate").
  </Function>

  <span id="realamplitudes-u2" />

  ### u2

  <Function id="qiskit.circuit.library.RealAmplitudes.u2" signature="RealAmplitudes.u2(phi, lam, qubit, *, q=None)">
    Apply [`U2Gate`](qiskit.circuit.library.U2Gate "qiskit.circuit.library.U2Gate").
  </Function>

  <span id="realamplitudes-u3" />

  ### u3

  <Function id="qiskit.circuit.library.RealAmplitudes.u3" signature="RealAmplitudes.u3(theta, phi, lam, qubit, *, q=None)">
    Apply [`U3Gate`](qiskit.circuit.library.U3Gate "qiskit.circuit.library.U3Gate").
  </Function>

  <span id="realamplitudes-uc" />

  ### uc

  <Function id="qiskit.circuit.library.RealAmplitudes.uc" signature="RealAmplitudes.uc(gate_list, q_controls, q_target, up_to_diagonal=False)">
  ...
  <span id="realamplitudes-ucg" />

  ### ucg

  <Function id="qiskit.circuit.library.RealAmplitudes.ucg" signature="RealAmplitudes.ucg(angle_list, q_controls, q_target, up_to_diagonal=False)">
    Deprecated version of uc.
  </Function>

  <span id="realamplitudes-ucrx" />

  ### ucrx

  <Function id="qiskit.circuit.library.RealAmplitudes.ucrx" signature="RealAmplitudes.ucrx(angle_list, q_controls, q_target)">
  ...
  <span id="realamplitudes-ucry" />

  ### ucry

  <Function id="qiskit.circuit.library.RealAmplitudes.ucry" signature="RealAmplitudes.ucry(angle_list, q_controls, q_target)">
  ...
  <span id="realamplitudes-ucrz" />

  ### ucrz

  <Function id="qiskit.circuit.library.RealAmplitudes.ucrz" signature="RealAmplitudes.ucrz(angle_list, q_controls, q_target)">
  ...
  <span id="realamplitudes-ucx" />

  ### ucx

  <Function id="qiskit.circuit.library.RealAmplitudes.ucx" signature="RealAmplitudes.ucx(angle_list, q_controls, q_target)">
    Deprecated version of ucrx.
  </Function>

  <span id="realamplitudes-ucy" />

  ### ucy

  <Function id="qiskit.circuit.library.RealAmplitudes.ucy" signature="RealAmplitudes.ucy(angle_list, q_controls, q_target)">
    Deprecated version of ucry.
  </Function>

  <span id="realamplitudes-ucz" />

  ### ucz

  <Function id="qiskit.circuit.library.RealAmplitudes.ucz" signature="RealAmplitudes.ucz(angle_list, q_controls, q_target)">
    Deprecated version of ucrz.
  </Function>

  <span id="realamplitudes-unitary" />

  ### unitary

  <Function id="qiskit.circuit.library.RealAmplitudes.unitary" signature="RealAmplitudes.unitary(obj, qubits, label=None)">
    Apply unitary gate to q.
  </Function>

  <span id="realamplitudes-width" />

  ### width

  <Function id="qiskit.circuit.library.RealAmplitudes.width" signature="RealAmplitudes.width()">
  ...
  <span id="realamplitudes-x" />

  ### x

  <Function id="qiskit.circuit.library.RealAmplitudes.x" signature="RealAmplitudes.x(qubit, *, label=None, ctrl_state=None, q=None)">
    Apply [`XGate`](qiskit.circuit.library.XGate "qiskit.circuit.library.XGate").
  </Function>

  <span id="realamplitudes-y" />

  ### y

  <Function id="qiskit.circuit.library.RealAmplitudes.y" signature="RealAmplitudes.y(qubit, *, q=None)">
    Apply [`YGate`](qiskit.circuit.library.YGate "qiskit.circuit.library.YGate").
  </Function>

  <span id="realamplitudes-z" />

  ### z

  <Function id="qiskit.circuit.library.RealAmplitudes.z" signature="RealAmplitudes.z(qubit, *, q=None)">
