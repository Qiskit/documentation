...
<Class id="qiskit.circuit.library.RealAmplitudes" github="https://github.com/qiskit/qiskit/tree/stable/0.14/qiskit/circuit/library/n_local/real_amplitudes.py" signature="RealAmplitudes(num_qubits=None, entanglement='full', reps=3, skip_unentangled_qubits=False, skip_final_rotation_layer=False, parameter_prefix='θ', insert_barriers=False, initial_state=None)">
  ...
  *   **insert\_barriers** (`bool`) – If True, barriers are inserted in between each layer. If False, no barriers are inserted.
  ...
  <Attribute id="qiskit.circuit.library.RealAmplitudes.entanglement" signature="Union[str, List[str], List[List[str]], List[int], List[List[int]], List[List[List[int]]], List[List[List[List[int]]]], Callable[[int], str], Callable[[int], List[List[int]]]]">
  ...
  <Attribute id="qiskit.circuit.library.RealAmplitudes.entanglement_blocks" signature="List[qiskit.circuit.instruction.Instruction]">
  ...
  <Attribute id="qiskit.circuit.library.RealAmplitudes.initial_state" signature="Any">
  ...
  <Attribute id="qiskit.circuit.library.RealAmplitudes.insert_barriers" signature="bool">
  ...
  <Attribute id="qiskit.circuit.library.RealAmplitudes.num_layers" signature="int">
  ...
  <Attribute id="qiskit.circuit.library.RealAmplitudes.num_parameters_settable" signature="int">
  ...
  <Attribute id="qiskit.circuit.library.RealAmplitudes.num_qubits" signature="int">
  ...
  <Attribute id="qiskit.circuit.library.RealAmplitudes.ordered_parameters" signature="List[qiskit.circuit.parameter.Parameter]">
  ...
  <Attribute id="qiskit.circuit.library.RealAmplitudes.parameter_bounds" signature="List[Tuple[float, float]]">
  ...
  <Attribute id="qiskit.circuit.library.RealAmplitudes.parameters" signature="Set[qiskit.circuit.parameter.Parameter]">
  ...
  <Attribute id="qiskit.circuit.library.RealAmplitudes.preferred_init_points" signature="Optional[List[float]]">
  ...
  <Attribute id="qiskit.circuit.library.RealAmplitudes.reps" signature="int">
  ...
  <Attribute id="qiskit.circuit.library.RealAmplitudes.rotation_blocks" signature="List[qiskit.circuit.instruction.Instruction]">
  ...
  <Function id="qiskit.circuit.library.RealAmplitudes.cast" signature="static RealAmplitudes.cast(value, _type)">
  ...
  <Function id="qiskit.circuit.library.RealAmplitudes.cls_instances" signature="classmethod RealAmplitudes.cls_instances()">
    Return the current number of instances of this class, useful for auto naming.
  </Function>

  ### cls\_prefix

  <Function id="qiskit.circuit.library.RealAmplitudes.cls_prefix" signature="classmethod RealAmplitudes.cls_prefix()">
  ...
  <Function id="qiskit.circuit.library.RealAmplitudes.from_qasm_file" signature="static RealAmplitudes.from_qasm_file(path)">
  ...
  <Function id="qiskit.circuit.library.RealAmplitudes.from_qasm_str" signature="static RealAmplitudes.from_qasm_str(qasm_str)">
