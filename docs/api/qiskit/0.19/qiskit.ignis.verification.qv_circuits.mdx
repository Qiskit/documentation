---
title: qv_circuits (v0.19)
description: API reference for qiskit.ignis.verification.qv_circuits in qiskit v0.19
...
<Function id="qiskit.ignis.verification.qv_circuits" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-ignis/tree/stable/0.3/qiskit/ignis/verification/quantum_volume/circuits.py" signature="qv_circuits(qubit_lists=None, ntrials=1, qr=None, cr=None)">
