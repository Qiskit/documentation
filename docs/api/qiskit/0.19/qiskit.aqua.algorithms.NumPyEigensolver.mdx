...
<Class id="qiskit.aqua.algorithms.NumPyEigensolver" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.7/qiskit/aqua/algorithms/eigen_solvers/numpy_eigen_solver.py" signature="NumPyEigensolver(operator=None, k=1, aux_operators=None)">
  ...
  *   **aux\_operators** (`Optional`\[`List`\[`Union`\[[`OperatorBase`](qiskit.aqua.operators.OperatorBase "qiskit.aqua.operators.operator_base.OperatorBase"), [`LegacyBaseOperator`](qiskit.aqua.operators.legacy.LegacyBaseOperator "qiskit.aqua.operators.legacy.base_operator.LegacyBaseOperator"), `None`]]]) – Auxiliary operators to be evaluated at each eigenvalue
  ...
  <Attribute id="qiskit.aqua.algorithms.NumPyEigensolver.aux_operators" name="aux_operators" signature="Optional[List[Optional[qiskit.aqua.operators.operator_base.OperatorBase]]]">
  ...
  <Attribute id="qiskit.aqua.algorithms.NumPyEigensolver.k" name="k" signature="int">
  ...
  <Attribute id="qiskit.aqua.algorithms.NumPyEigensolver.operator" name="operator" signature="Optional[qiskit.aqua.operators.operator_base.OperatorBase]">
    returns operator
  ...
  <Function id="qiskit.aqua.algorithms.NumPyEigensolver.supports_aux_operators" name="supports_aux_operators" signature="NumPyEigensolver.supports_aux_operators()">
