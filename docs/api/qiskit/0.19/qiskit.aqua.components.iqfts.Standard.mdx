...
<Class id="qiskit.aqua.components.iqfts.Standard" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.7/qiskit/aqua/components/iqfts/standard.py" signature="Standard(num_qubits)">
  The Standard IQFT.
  ...
  **num\_qubits** (`int`) – The number of qubits
  ...
  <Function id="qiskit.aqua.components.iqfts.Standard.construct_circuit" name="construct_circuit" signature="Standard.construct_circuit(mode='circuit', qubits=None, circuit=None, do_swaps=True)">
