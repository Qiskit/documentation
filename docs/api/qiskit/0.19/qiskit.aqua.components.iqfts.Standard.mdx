...
<Class id="qiskit.aqua.components.iqfts.Standard" github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.7/qiskit/aqua/components/iqfts/standard.py" signature="Standard(num_qubits)">
  The Standard IQFT.
