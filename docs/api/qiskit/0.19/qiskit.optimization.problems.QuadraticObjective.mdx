...
<Class id="qiskit.optimization.problems.QuadraticObjective" github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.7/qiskit/optimization/problems/quadratic_objective.py" signature="QuadraticObjective(quadratic_program, constant=0.0, linear=None, quadratic=None, sense=ObjSense.MINIMIZE)">
  ...
  *   **sense** (`ObjSense`) – The optimization sense of the objective.
  ...
  <Attribute id="qiskit.optimization.problems.QuadraticObjective.constant" signature="float">
  ...
  <Attribute id="qiskit.optimization.problems.QuadraticObjective.linear" signature="qiskit.optimization.problems.linear_expression.LinearExpression">
  ...
  <Attribute id="qiskit.optimization.problems.QuadraticObjective.quadratic" signature="qiskit.optimization.problems.quadratic_expression.QuadraticExpression">
  ...
  <Attribute id="qiskit.optimization.problems.QuadraticObjective.quadratic_program" signature="Any">
  ...
  <Attribute id="qiskit.optimization.problems.QuadraticObjective.sense" signature="qiskit.optimization.problems.quadratic_objective.ObjSense">
