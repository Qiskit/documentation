...
<Function id="qiskit.aqua.utils.optimize_svm" name="optimize_svm" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.7/qiskit/aqua/utils/qp_solver.py" signature="optimize_svm(kernel_matrix, y, scaling=None, max_iters=500, show_progress=False)">
