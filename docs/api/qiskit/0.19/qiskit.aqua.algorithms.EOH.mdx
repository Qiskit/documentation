...
<Class id="qiskit.aqua.algorithms.EOH" github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.7/qiskit/aqua/algorithms/education/eoh.py" signature="EOH(operator, initial_state, evo_operator, evo_time=1, num_time_slices=1, expansion_mode='trotter', expansion_order=1, quantum_instance=None)">
  ...
  *   **quantum\_instance** (`Union`\[[`QuantumInstance`](qiskit.aqua.QuantumInstance "qiskit.aqua.quantum_instance.QuantumInstance"), [`BaseBackend`](qiskit.providers.BaseBackend "qiskit.providers.basebackend.BaseBackend"), `None`]) – Quantum Instance or Backend
  ...
  <Attribute id="qiskit.aqua.algorithms.EOH.backend" name="backend" signature="qiskit.providers.basebackend.BaseBackend">
    Returns backend.
  ...
  <Attribute id="qiskit.aqua.algorithms.EOH.quantum_instance" name="quantum_instance" signature="Union[None, qiskit.aqua.quantum_instance.QuantumInstance]">
  ...
  <Attribute id="qiskit.aqua.algorithms.EOH.random" name="random">
  ...
  <Function id="qiskit.aqua.algorithms.EOH.construct_circuit" name="construct_circuit" signature="EOH.construct_circuit()">
  ...
  <Function id="qiskit.aqua.algorithms.EOH.run" name="run" signature="EOH.run(quantum_instance=None, **kwargs)">
  ...
  <Function id="qiskit.aqua.algorithms.EOH.set_backend" name="set_backend" signature="EOH.set_backend(backend, **kwargs)">
