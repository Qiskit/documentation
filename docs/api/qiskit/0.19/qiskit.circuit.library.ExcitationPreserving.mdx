...
<Class id="qiskit.circuit.library.ExcitationPreserving" github="https://github.com/qiskit/qiskit/tree/stable/0.14/qiskit/circuit/library/n_local/excitation_preserving.py" signature="ExcitationPreserving(num_qubits=None, mode='iswap', entanglement='full', reps=3, skip_unentangled_qubits=False, skip_final_rotation_layer=False, parameter_prefix='θ', insert_barriers=False, initial_state=None)">
  ...
  **ValueError** – If the selected mode is not supported.
  ...
  <Attribute id="qiskit.circuit.library.ExcitationPreserving.entanglement" signature="Union[str, List[str], List[List[str]], List[int], List[List[int]], List[List[List[int]]], List[List[List[List[int]]]], Callable[[int], str], Callable[[int], List[List[int]]]]">
  ...
  <Attribute id="qiskit.circuit.library.ExcitationPreserving.entanglement_blocks" signature="List[qiskit.circuit.instruction.Instruction]">
  ...
  <Attribute id="qiskit.circuit.library.ExcitationPreserving.initial_state" signature="Any">
  ...
  <Attribute id="qiskit.circuit.library.ExcitationPreserving.insert_barriers" signature="bool">
  ...
  <Attribute id="qiskit.circuit.library.ExcitationPreserving.num_layers" signature="int">
  ...
  <Attribute id="qiskit.circuit.library.ExcitationPreserving.num_parameters_settable" signature="int">
  ...
  <Attribute id="qiskit.circuit.library.ExcitationPreserving.num_qubits" signature="int">
  ...
  <Attribute id="qiskit.circuit.library.ExcitationPreserving.ordered_parameters" signature="List[qiskit.circuit.parameter.Parameter]">
  ...
  <Attribute id="qiskit.circuit.library.ExcitationPreserving.parameter_bounds" signature="List[Tuple[float, float]]">
  ...
  <Attribute id="qiskit.circuit.library.ExcitationPreserving.parameters" signature="Set[qiskit.circuit.parameter.Parameter]">
  ...
  <Attribute id="qiskit.circuit.library.ExcitationPreserving.preferred_init_points" signature="Optional[List[float]]">
  ...
  <Attribute id="qiskit.circuit.library.ExcitationPreserving.reps" signature="int">
  ...
  <Attribute id="qiskit.circuit.library.ExcitationPreserving.rotation_blocks" signature="List[qiskit.circuit.instruction.Instruction]">
  ...
  <Function id="qiskit.circuit.library.ExcitationPreserving.cast" signature="static ExcitationPreserving.cast(value, _type)">
  ...
  <Function id="qiskit.circuit.library.ExcitationPreserving.cls_instances" signature="classmethod ExcitationPreserving.cls_instances()">
    Return the current number of instances of this class, useful for auto naming.
  </Function>

  ### cls\_prefix

  <Function id="qiskit.circuit.library.ExcitationPreserving.cls_prefix" signature="classmethod ExcitationPreserving.cls_prefix()">
  ...
  <Function id="qiskit.circuit.library.ExcitationPreserving.from_qasm_file" signature="static ExcitationPreserving.from_qasm_file(path)">
  ...
  <Function id="qiskit.circuit.library.ExcitationPreserving.from_qasm_str" signature="static ExcitationPreserving.from_qasm_str(qasm_str)">
