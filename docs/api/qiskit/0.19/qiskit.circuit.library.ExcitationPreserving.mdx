...
$$
  ...
  **ValueError** – If the selected mode is not supported.
  ...
  <Attribute id="qiskit.circuit.library.ExcitationPreserving.entanglement" name="entanglement" signature="Union[str, List[str], List[List[str]], List[int], List[List[int]], List[List[List[int]]], List[List[List[List[int]]]], Callable[[int], str], Callable[[int], List[List[int]]]]">
  ...
  <Attribute id="qiskit.circuit.library.ExcitationPreserving.entanglement_blocks" name="entanglement_blocks" signature="List[qiskit.circuit.instruction.Instruction]">
  ...
  <Attribute id="qiskit.circuit.library.ExcitationPreserving.extension_lib" signature="= 'include \&#x22;qelib1.inc\&#x22;;'" />

  ### header

  <Attribute id="qiskit.circuit.library.ExcitationPreserving.header" signature="= 'OPENQASM 2.0;'" />

  ### initial\_state

  <Attribute id="qiskit.circuit.library.ExcitationPreserving.initial_state" name="initial_state" signature="Any">
  ...
  <Attribute id="qiskit.circuit.library.ExcitationPreserving.insert_barriers" name="insert_barriers" signature="bool">
  ...
  <Attribute id="qiskit.circuit.library.ExcitationPreserving.instances" signature="= 8" />

  ### n\_qubits

  <Attribute id="qiskit.circuit.library.ExcitationPreserving.n_qubits" name="n_qubits">
  ...
  <Attribute id="qiskit.circuit.library.ExcitationPreserving.num_layers" name="num_layers" signature="int">
  ...
  <Attribute id="qiskit.circuit.library.ExcitationPreserving.num_parameters_settable" name="num_parameters_settable" signature="int">
  ...
  <Attribute id="qiskit.circuit.library.ExcitationPreserving.num_qubits" name="num_qubits" signature="int">
  ...
  <Attribute id="qiskit.circuit.library.ExcitationPreserving.ordered_parameters" name="ordered_parameters" signature="List[qiskit.circuit.parameter.Parameter]">
  ...
  <Attribute id="qiskit.circuit.library.ExcitationPreserving.parameter_bounds" name="parameter_bounds" signature="List[Tuple[float, float]]">
  ...
  <Attribute id="qiskit.circuit.library.ExcitationPreserving.parameters" name="parameters" signature="Set[qiskit.circuit.parameter.Parameter]">
  ...
  <Attribute id="qiskit.circuit.library.ExcitationPreserving.preferred_init_points" name="preferred_init_points" signature="Optional[List[float]]">
  ...
  <Attribute id="qiskit.circuit.library.ExcitationPreserving.prefix" signature="= 'circuit'" />
  ...
  <Attribute id="qiskit.circuit.library.ExcitationPreserving.reps" name="reps" signature="int">
  ...
  <Attribute id="qiskit.circuit.library.ExcitationPreserving.rotation_blocks" name="rotation_blocks" signature="List[qiskit.circuit.instruction.Instruction]">
  ...
  <Function id="qiskit.circuit.library.ExcitationPreserving.AND" name="AND" signature="ExcitationPreserving.AND(qr_variables, qb_target, qr_ancillae, flags=None, mct_mode='no-ancilla')">
  ...
  <Function id="qiskit.circuit.library.ExcitationPreserving.OR" name="OR" signature="ExcitationPreserving.OR(qr_variables, qb_target, qr_ancillae, flags=None, mct_mode='basic')">
  ...
  <Function id="qiskit.circuit.library.ExcitationPreserving.__getitem__" name="__getitem__" signature="ExcitationPreserving.__getitem__(item)">
    Return indexed operation.
  </Function>

  ### \_\_len\_\_

  <Function id="qiskit.circuit.library.ExcitationPreserving.__len__" name="__len__" signature="ExcitationPreserving.__len__()">
    Return number of operations in circuit.
  </Function>

  ### add\_layer

  <Function id="qiskit.circuit.library.ExcitationPreserving.add_layer" name="add_layer" signature="ExcitationPreserving.add_layer(other, entanglement=None, front=False)">
  ...
  <Function id="qiskit.circuit.library.ExcitationPreserving.add_register" name="add_register" signature="ExcitationPreserving.add_register(*regs)">
    Add registers.
  </Function>

  ### append

  <Function id="qiskit.circuit.library.ExcitationPreserving.append" name="append" signature="ExcitationPreserving.append(instruction, qargs=None, cargs=None)">
  ...
  <Function id="qiskit.circuit.library.ExcitationPreserving.assign_parameters" name="assign_parameters" signature="ExcitationPreserving.assign_parameters(param_dict, inplace=False)">
  ...
  <Function id="qiskit.circuit.library.ExcitationPreserving.barrier" name="barrier" signature="ExcitationPreserving.barrier(*qargs)">
    Apply `Barrier`. If qargs is None, applies to all.
  </Function>

  ### bind\_parameters

  <Function id="qiskit.circuit.library.ExcitationPreserving.bind_parameters" name="bind_parameters" signature="ExcitationPreserving.bind_parameters(value_dict)">
  ...
  <Function id="qiskit.circuit.library.ExcitationPreserving.cast" name="cast" signature="static ExcitationPreserving.cast(value, _type)">
    Best effort to cast value to type. Otherwise, returns the value.
  </Function>

  ### cbit\_argument\_conversion

  <Function id="qiskit.circuit.library.ExcitationPreserving.cbit_argument_conversion" name="cbit_argument_conversion" signature="ExcitationPreserving.cbit_argument_conversion(clbit_representation)">
  ...
  <Function id="qiskit.circuit.library.ExcitationPreserving.ccx" name="ccx" signature="ExcitationPreserving.ccx(control_qubit1, control_qubit2, target_qubit, *, ctl1=None, ctl2=None, tgt=None)">
    Apply [`CCXGate`](qiskit.circuit.library.CCXGate "qiskit.circuit.library.CCXGate").
  </Function>

  ### ch

  <Function id="qiskit.circuit.library.ExcitationPreserving.ch" name="ch" signature="ExcitationPreserving.ch(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CHGate`](qiskit.circuit.library.CHGate "qiskit.circuit.library.CHGate").
  </Function>

  ### cls\_instances

  <Function id="qiskit.circuit.library.ExcitationPreserving.cls_instances" name="cls_instances" signature="classmethod ExcitationPreserving.cls_instances()">
    Return the current number of instances of this class, useful for auto naming.
  </Function>

  ### cls\_prefix

  <Function id="qiskit.circuit.library.ExcitationPreserving.cls_prefix" name="cls_prefix" signature="classmethod ExcitationPreserving.cls_prefix()">
    Return the prefix to use for auto naming.
  </Function>

  ### cnot

  <Function id="qiskit.circuit.library.ExcitationPreserving.cnot" name="cnot" signature="ExcitationPreserving.cnot(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CXGate`](qiskit.circuit.library.CXGate "qiskit.circuit.library.CXGate").
  </Function>

  ### combine

  <Function id="qiskit.circuit.library.ExcitationPreserving.combine" name="combine" signature="ExcitationPreserving.combine(rhs)">
  ...
  <Function id="qiskit.circuit.library.ExcitationPreserving.compose" name="compose" signature="ExcitationPreserving.compose(other, qubits=None, clbits=None, front=False, inplace=False)">
  ...
  <Function id="qiskit.circuit.library.ExcitationPreserving.copy" name="copy" signature="ExcitationPreserving.copy(name=None)">
    Copy the circuit.
  ...
  <Function id="qiskit.circuit.library.ExcitationPreserving.count_ops" name="count_ops" signature="ExcitationPreserving.count_ops()">
  ...
  <Function id="qiskit.circuit.library.ExcitationPreserving.crx" name="crx" signature="ExcitationPreserving.crx(theta, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CRXGate`](qiskit.circuit.library.CRXGate "qiskit.circuit.library.CRXGate").
  </Function>

  ### cry

  <Function id="qiskit.circuit.library.ExcitationPreserving.cry" name="cry" signature="ExcitationPreserving.cry(theta, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CRYGate`](qiskit.circuit.library.CRYGate "qiskit.circuit.library.CRYGate").
  </Function>

  ### crz

  <Function id="qiskit.circuit.library.ExcitationPreserving.crz" name="crz" signature="ExcitationPreserving.crz(theta, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CRZGate`](qiskit.circuit.library.CRZGate "qiskit.circuit.library.CRZGate").
  </Function>

  ### cswap

  <Function id="qiskit.circuit.library.ExcitationPreserving.cswap" name="cswap" signature="ExcitationPreserving.cswap(control_qubit, target_qubit1, target_qubit2, *, label=None, ctrl_state=None, ctl=None, tgt1=None, tgt2=None)">
    Apply [`CSwapGate`](qiskit.circuit.library.CSwapGate "qiskit.circuit.library.CSwapGate").
  </Function>

  ### cu1

  <Function id="qiskit.circuit.library.ExcitationPreserving.cu1" name="cu1" signature="ExcitationPreserving.cu1(theta, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CU1Gate`](qiskit.circuit.library.CU1Gate "qiskit.circuit.library.CU1Gate").
  </Function>

  ### cu3

  <Function id="qiskit.circuit.library.ExcitationPreserving.cu3" name="cu3" signature="ExcitationPreserving.cu3(theta, phi, lam, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CU3Gate`](qiskit.circuit.library.CU3Gate "qiskit.circuit.library.CU3Gate").
  </Function>

  ### cx

  <Function id="qiskit.circuit.library.ExcitationPreserving.cx" name="cx" signature="ExcitationPreserving.cx(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CXGate`](qiskit.circuit.library.CXGate "qiskit.circuit.library.CXGate").
  </Function>

  ### cy

  <Function id="qiskit.circuit.library.ExcitationPreserving.cy" name="cy" signature="ExcitationPreserving.cy(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CYGate`](qiskit.circuit.library.CYGate "qiskit.circuit.library.CYGate").
  </Function>

  ### cz

  <Function id="qiskit.circuit.library.ExcitationPreserving.cz" name="cz" signature="ExcitationPreserving.cz(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CZGate`](qiskit.circuit.library.CZGate "qiskit.circuit.library.CZGate").
  </Function>

  ### dcx

  <Function id="qiskit.circuit.library.ExcitationPreserving.dcx" name="dcx" signature="ExcitationPreserving.dcx(qubit1, qubit2)">
    Apply [`DCXGate`](qiskit.circuit.library.DCXGate "qiskit.circuit.library.DCXGate").
  </Function>

  ### decompose

  <Function id="qiskit.circuit.library.ExcitationPreserving.decompose" name="decompose" signature="ExcitationPreserving.decompose()">
  ...
  <Function id="qiskit.circuit.library.ExcitationPreserving.depth" name="depth" signature="ExcitationPreserving.depth()">
  ...
  <Function id="qiskit.circuit.library.ExcitationPreserving.diag_gate" name="diag_gate" signature="ExcitationPreserving.diag_gate(diag, qubit)">
    Deprecated version of QuantumCircuit.diagonal.
  </Function>

  ### diagonal

  <Function id="qiskit.circuit.library.ExcitationPreserving.diagonal" name="diagonal" signature="ExcitationPreserving.diagonal(diag, qubit)">
  ...
  <Function id="qiskit.circuit.library.ExcitationPreserving.extend" name="extend" signature="ExcitationPreserving.extend(rhs)">
  ...
  <Function id="qiskit.circuit.library.ExcitationPreserving.fredkin" name="fredkin" signature="ExcitationPreserving.fredkin(control_qubit, target_qubit1, target_qubit2, *, ctl=None, tgt1=None, tgt2=None)">
    Apply [`CSwapGate`](qiskit.circuit.library.CSwapGate "qiskit.circuit.library.CSwapGate").
  </Function>

  ### from\_qasm\_file

  <Function id="qiskit.circuit.library.ExcitationPreserving.from_qasm_file" name="from_qasm_file" signature="static ExcitationPreserving.from_qasm_file(path)">
  ...
  <Function id="qiskit.circuit.library.ExcitationPreserving.from_qasm_str" name="from_qasm_str" signature="static ExcitationPreserving.from_qasm_str(qasm_str)">
  ...
  <Function id="qiskit.circuit.library.ExcitationPreserving.get_entangler_map" name="get_entangler_map" signature="ExcitationPreserving.get_entangler_map(rep_num, block_num, num_block_qubits)">
  ...
  <Function id="qiskit.circuit.library.ExcitationPreserving.get_unentangled_qubits" name="get_unentangled_qubits" signature="ExcitationPreserving.get_unentangled_qubits()">
  ...
  <Function id="qiskit.circuit.library.ExcitationPreserving.h" name="h" signature="ExcitationPreserving.h(qubit, *, q=None)">
    Apply [`HGate`](qiskit.circuit.library.HGate "qiskit.circuit.library.HGate").
  </Function>

  ### hamiltonian

  <Function id="qiskit.circuit.library.ExcitationPreserving.hamiltonian" name="hamiltonian" signature="ExcitationPreserving.hamiltonian(operator, time, qubits, label=None)">
    Apply hamiltonian evolution to to qubits.
  </Function>

  ### has\_register

  <Function id="qiskit.circuit.library.ExcitationPreserving.has_register" name="has_register" signature="ExcitationPreserving.has_register(register)">
  ...
  <Function id="qiskit.circuit.library.ExcitationPreserving.i" name="i" signature="ExcitationPreserving.i(qubit, *, q=None)">
    Apply [`IGate`](qiskit.circuit.library.IGate "qiskit.circuit.library.IGate").
  </Function>

  ### id

  <Function id="qiskit.circuit.library.ExcitationPreserving.id" name="id" signature="ExcitationPreserving.id(qubit, *, q=None)">
    Apply [`IGate`](qiskit.circuit.library.IGate "qiskit.circuit.library.IGate").
  </Function>

  ### iden

  <Function id="qiskit.circuit.library.ExcitationPreserving.iden" name="iden" signature="ExcitationPreserving.iden(qubit, *, q=None)">
    Deprecated identity gate.
  </Function>

  ### initialize

  <Function id="qiskit.circuit.library.ExcitationPreserving.initialize" name="initialize" signature="ExcitationPreserving.initialize(params, qubits)">
    Apply initialize to circuit.
  </Function>

  ### inverse

  <Function id="qiskit.circuit.library.ExcitationPreserving.inverse" name="inverse" signature="ExcitationPreserving.inverse()">
    Invert this circuit.
  ...
  <Function id="qiskit.circuit.library.ExcitationPreserving.iso" name="iso" signature="ExcitationPreserving.iso(isometry, q_input, q_ancillas_for_output, q_ancillas_zero=None, q_ancillas_dirty=None)">
  ...
  <Function id="qiskit.circuit.library.ExcitationPreserving.isometry" name="isometry" signature="ExcitationPreserving.isometry(isometry, q_input, q_ancillas_for_output, q_ancillas_zero=None, q_ancillas_dirty=None)">
    Attach an arbitrary isometry from m to n qubits to a circuit. In particular, this allows to attach arbitrary unitaries on n qubits (m=n) or to prepare any state on n qubits (m=0). The decomposition used here was introduced by Iten et al. in [https://arxiv.org/abs/1501.06911](https://arxiv.org/abs/1501.06911).
  ...
  <Function id="qiskit.circuit.library.ExcitationPreserving.iswap" name="iswap" signature="ExcitationPreserving.iswap(qubit1, qubit2)">
    Apply [`iSwapGate`](qiskit.circuit.library.iSwapGate "qiskit.circuit.library.iSwapGate").
  </Function>

  ### mcmt

  <Function id="qiskit.circuit.library.ExcitationPreserving.mcmt" name="mcmt" signature="ExcitationPreserving.mcmt(gate, control_qubits, target_qubits, ancilla_qubits=None, mode='no-ancilla', *, single_control_gate_fun=None, q_controls=None, q_ancillae=None, q_targets=None)">
  ...
  <Function id="qiskit.circuit.library.ExcitationPreserving.mcrx" name="mcrx" signature="ExcitationPreserving.mcrx(theta, q_controls, q_target, use_basis_gates=False)">
  ...
  <Function id="qiskit.circuit.library.ExcitationPreserving.mcry" name="mcry" signature="ExcitationPreserving.mcry(theta, q_controls, q_target, q_ancillae, mode='basic', use_basis_gates=False)">
  ...
  <Function id="qiskit.circuit.library.ExcitationPreserving.mcrz" name="mcrz" signature="ExcitationPreserving.mcrz(lam, q_controls, q_target, use_basis_gates=False)">
  ...
  <Function id="qiskit.circuit.library.ExcitationPreserving.mct" name="mct" signature="ExcitationPreserving.mct(control_qubits, target_qubit, ancilla_qubits=None, mode='noancilla')">
    Apply `MCXGate`.
  </Function>

  ### mcu1

  <Function id="qiskit.circuit.library.ExcitationPreserving.mcu1" name="mcu1" signature="ExcitationPreserving.mcu1(lam, control_qubits, target_qubit)">
    Apply `MCU1Gate`.
  </Function>

  ### mcx

  <Function id="qiskit.circuit.library.ExcitationPreserving.mcx" name="mcx" signature="ExcitationPreserving.mcx(control_qubits, target_qubit, ancilla_qubits=None, mode='noancilla')">
    Apply `MCXGate`.
  ...
  <Function id="qiskit.circuit.library.ExcitationPreserving.measure" name="measure" signature="ExcitationPreserving.measure(qubit, cbit)">
  ...
  <Function id="qiskit.circuit.library.ExcitationPreserving.measure_active" name="measure_active" signature="ExcitationPreserving.measure_active(inplace=True)">
  ...
  <Function id="qiskit.circuit.library.ExcitationPreserving.measure_all" name="measure_all" signature="ExcitationPreserving.measure_all(inplace=True)">
  ...
  <Function id="qiskit.circuit.library.ExcitationPreserving.mirror" name="mirror" signature="ExcitationPreserving.mirror()">
  ...
  <Function id="qiskit.circuit.library.ExcitationPreserving.ms" name="ms" signature="ExcitationPreserving.ms(theta, qubits)">
    Apply [`MSGate`](qiskit.circuit.library.MSGate "qiskit.circuit.library.MSGate").
  </Function>

  ### num\_connected\_components

  <Function id="qiskit.circuit.library.ExcitationPreserving.num_connected_components" name="num_connected_components" signature="ExcitationPreserving.num_connected_components(unitary_only=False)">
  ...
  <Function id="qiskit.circuit.library.ExcitationPreserving.num_nonlocal_gates" name="num_nonlocal_gates" signature="ExcitationPreserving.num_nonlocal_gates()">
  ...
  <Function id="qiskit.circuit.library.ExcitationPreserving.num_tensor_factors" name="num_tensor_factors" signature="ExcitationPreserving.num_tensor_factors()">
  ...
  <Function id="qiskit.circuit.library.ExcitationPreserving.num_unitary_factors" name="num_unitary_factors" signature="ExcitationPreserving.num_unitary_factors()">
    Computes the number of tensor factors in the unitary (quantum) part of the circuit only.
  </Function>

  ### print\_settings

  <Function id="qiskit.circuit.library.ExcitationPreserving.print_settings" name="print_settings" signature="ExcitationPreserving.print_settings()">
  ...
  <Function id="qiskit.circuit.library.ExcitationPreserving.qasm" name="qasm" signature="ExcitationPreserving.qasm(formatted=False, filename=None)">
  ...
  <Function id="qiskit.circuit.library.ExcitationPreserving.qbit_argument_conversion" name="qbit_argument_conversion" signature="ExcitationPreserving.qbit_argument_conversion(qubit_representation)">
  ...
  <Function id="qiskit.circuit.library.ExcitationPreserving.r" name="r" signature="ExcitationPreserving.r(theta, phi, qubit, *, q=None)">
    Apply `RGate`.
  </Function>

  ### rcccx

  <Function id="qiskit.circuit.library.ExcitationPreserving.rcccx" name="rcccx" signature="ExcitationPreserving.rcccx(control_qubit1, control_qubit2, control_qubit3, target_qubit)">
    Apply [`RC3XGate`](qiskit.circuit.library.RC3XGate "qiskit.circuit.library.RC3XGate").
  </Function>

  ### rccx

  <Function id="qiskit.circuit.library.ExcitationPreserving.rccx" name="rccx" signature="ExcitationPreserving.rccx(control_qubit1, control_qubit2, target_qubit)">
    Apply [`RCCXGate`](qiskit.circuit.library.RCCXGate "qiskit.circuit.library.RCCXGate").
  </Function>

  ### remove\_final\_measurements

  <Function id="qiskit.circuit.library.ExcitationPreserving.remove_final_measurements" name="remove_final_measurements" signature="ExcitationPreserving.remove_final_measurements(inplace=True)">
  ...
  <Function id="qiskit.circuit.library.ExcitationPreserving.reset" name="reset" signature="ExcitationPreserving.reset(qubit)">
    Reset q.
  </Function>

  ### rx

  <Function id="qiskit.circuit.library.ExcitationPreserving.rx" name="rx" signature="ExcitationPreserving.rx(theta, qubit, *, label=None, q=None)">
    Apply [`RXGate`](qiskit.circuit.library.RXGate "qiskit.circuit.library.RXGate").
  </Function>

  ### rxx

  <Function id="qiskit.circuit.library.ExcitationPreserving.rxx" name="rxx" signature="ExcitationPreserving.rxx(theta, qubit1, qubit2)">
    Apply [`RXXGate`](qiskit.circuit.library.RXXGate "qiskit.circuit.library.RXXGate").
  </Function>

  ### ry

  <Function id="qiskit.circuit.library.ExcitationPreserving.ry" name="ry" signature="ExcitationPreserving.ry(theta, qubit, *, label=None, q=None)">
    Apply [`RYGate`](qiskit.circuit.library.RYGate "qiskit.circuit.library.RYGate").
  </Function>

  ### ryy

  <Function id="qiskit.circuit.library.ExcitationPreserving.ryy" name="ryy" signature="ExcitationPreserving.ryy(theta, qubit1, qubit2)">
    Apply [`RYYGate`](qiskit.circuit.library.RYYGate "qiskit.circuit.library.RYYGate").
  </Function>

  ### rz

  <Function id="qiskit.circuit.library.ExcitationPreserving.rz" name="rz" signature="ExcitationPreserving.rz(phi, qubit, *, q=None)">
    Apply [`RZGate`](qiskit.circuit.library.RZGate "qiskit.circuit.library.RZGate").
  </Function>

  ### rzx

  <Function id="qiskit.circuit.library.ExcitationPreserving.rzx" name="rzx" signature="ExcitationPreserving.rzx(theta, qubit1, qubit2)">
    Apply [`RZXGate`](qiskit.circuit.library.RZXGate "qiskit.circuit.library.RZXGate").
  </Function>

  ### rzz

  <Function id="qiskit.circuit.library.ExcitationPreserving.rzz" name="rzz" signature="ExcitationPreserving.rzz(theta, qubit1, qubit2)">
    Apply [`RZZGate`](qiskit.circuit.library.RZZGate "qiskit.circuit.library.RZZGate").
  </Function>

  ### s

  <Function id="qiskit.circuit.library.ExcitationPreserving.s" name="s" signature="ExcitationPreserving.s(qubit, *, q=None)">
    Apply [`SGate`](qiskit.circuit.library.SGate "qiskit.circuit.library.SGate").
  </Function>

  ### sdg

  <Function id="qiskit.circuit.library.ExcitationPreserving.sdg" name="sdg" signature="ExcitationPreserving.sdg(qubit, *, q=None)">
    Apply [`SdgGate`](qiskit.circuit.library.SdgGate "qiskit.circuit.library.SdgGate").
  </Function>

  ### size

  <Function id="qiskit.circuit.library.ExcitationPreserving.size" name="size" signature="ExcitationPreserving.size()">
  ...
  <Function id="qiskit.circuit.library.ExcitationPreserving.snapshot" name="snapshot" signature="ExcitationPreserving.snapshot(label, snapshot_type='statevector', qubits=None, params=None)">
  ...
  <Function id="qiskit.circuit.library.ExcitationPreserving.snapshot_density_matrix" name="snapshot_density_matrix" signature="ExcitationPreserving.snapshot_density_matrix(label, qubits=None)">
  ...
  <Function id="qiskit.circuit.library.ExcitationPreserving.snapshot_expectation_value" name="snapshot_expectation_value" signature="ExcitationPreserving.snapshot_expectation_value(label, op, qubits, single_shot=False, variance=False)">
  ...
  <Function id="qiskit.circuit.library.ExcitationPreserving.snapshot_probabilities" name="snapshot_probabilities" signature="ExcitationPreserving.snapshot_probabilities(label, qubits, variance=False)">
  ...
  <Function id="qiskit.circuit.library.ExcitationPreserving.snapshot_stabilizer" name="snapshot_stabilizer" signature="ExcitationPreserving.snapshot_stabilizer(label)">
  ...
  <Function id="qiskit.circuit.library.ExcitationPreserving.snapshot_statevector" name="snapshot_statevector" signature="ExcitationPreserving.snapshot_statevector(label)">
  ...
  <Function id="qiskit.circuit.library.ExcitationPreserving.squ" name="squ" signature="ExcitationPreserving.squ(unitary_matrix, qubit, mode='ZYZ', up_to_diagonal=False, *, u=None)">
  ...
  <Function id="qiskit.circuit.library.ExcitationPreserving.swap" name="swap" signature="ExcitationPreserving.swap(qubit1, qubit2)">
    Apply [`SwapGate`](qiskit.circuit.library.SwapGate "qiskit.circuit.library.SwapGate").
  </Function>

  ### t

  <Function id="qiskit.circuit.library.ExcitationPreserving.t" name="t" signature="ExcitationPreserving.t(qubit, *, q=None)">
    Apply [`TGate`](qiskit.circuit.library.TGate "qiskit.circuit.library.TGate").
  </Function>

  ### tdg

  <Function id="qiskit.circuit.library.ExcitationPreserving.tdg" name="tdg" signature="ExcitationPreserving.tdg(qubit, *, q=None)">
    Apply [`TdgGate`](qiskit.circuit.library.TdgGate "qiskit.circuit.library.TdgGate").
  </Function>

  ### to\_gate

  <Function id="qiskit.circuit.library.ExcitationPreserving.to_gate" name="to_gate" signature="ExcitationPreserving.to_gate(parameter_map=None)">
  ...
  <Function id="qiskit.circuit.library.ExcitationPreserving.to_instruction" name="to_instruction" signature="ExcitationPreserving.to_instruction(parameter_map=None)">
  ...
  <Function id="qiskit.circuit.library.ExcitationPreserving.toffoli" name="toffoli" signature="ExcitationPreserving.toffoli(control_qubit1, control_qubit2, target_qubit, *, ctl1=None, ctl2=None, tgt=None)">
    Apply [`CCXGate`](qiskit.circuit.library.CCXGate "qiskit.circuit.library.CCXGate").
  </Function>

  ### u1

  <Function id="qiskit.circuit.library.ExcitationPreserving.u1" name="u1" signature="ExcitationPreserving.u1(theta, qubit, *, q=None)">
    Apply [`U1Gate`](qiskit.circuit.library.U1Gate "qiskit.circuit.library.U1Gate").
  </Function>

  ### u2

  <Function id="qiskit.circuit.library.ExcitationPreserving.u2" name="u2" signature="ExcitationPreserving.u2(phi, lam, qubit, *, q=None)">
    Apply [`U2Gate`](qiskit.circuit.library.U2Gate "qiskit.circuit.library.U2Gate").
  </Function>

  ### u3

  <Function id="qiskit.circuit.library.ExcitationPreserving.u3" name="u3" signature="ExcitationPreserving.u3(theta, phi, lam, qubit, *, q=None)">
    Apply [`U3Gate`](qiskit.circuit.library.U3Gate "qiskit.circuit.library.U3Gate").
  </Function>

  ### uc

  <Function id="qiskit.circuit.library.ExcitationPreserving.uc" name="uc" signature="ExcitationPreserving.uc(gate_list, q_controls, q_target, up_to_diagonal=False)">
  ...
  <Function id="qiskit.circuit.library.ExcitationPreserving.ucg" name="ucg" signature="ExcitationPreserving.ucg(angle_list, q_controls, q_target, up_to_diagonal=False)">
    Deprecated version of uc.
  </Function>

  ### ucrx

  <Function id="qiskit.circuit.library.ExcitationPreserving.ucrx" name="ucrx" signature="ExcitationPreserving.ucrx(angle_list, q_controls, q_target)">
  ...
  <Function id="qiskit.circuit.library.ExcitationPreserving.ucry" name="ucry" signature="ExcitationPreserving.ucry(angle_list, q_controls, q_target)">
  ...
  <Function id="qiskit.circuit.library.ExcitationPreserving.ucrz" name="ucrz" signature="ExcitationPreserving.ucrz(angle_list, q_controls, q_target)">
  ...
  <Function id="qiskit.circuit.library.ExcitationPreserving.ucx" name="ucx" signature="ExcitationPreserving.ucx(angle_list, q_controls, q_target)">
    Deprecated version of ucrx.
  </Function>

  ### ucy

  <Function id="qiskit.circuit.library.ExcitationPreserving.ucy" name="ucy" signature="ExcitationPreserving.ucy(angle_list, q_controls, q_target)">
    Deprecated version of ucry.
  </Function>

  ### ucz

  <Function id="qiskit.circuit.library.ExcitationPreserving.ucz" name="ucz" signature="ExcitationPreserving.ucz(angle_list, q_controls, q_target)">
    Deprecated version of ucrz.
  </Function>

  ### unitary

  <Function id="qiskit.circuit.library.ExcitationPreserving.unitary" name="unitary" signature="ExcitationPreserving.unitary(obj, qubits, label=None)">
    Apply unitary gate to q.
  </Function>

  ### width

  <Function id="qiskit.circuit.library.ExcitationPreserving.width" name="width" signature="ExcitationPreserving.width()">
  ...
  <Function id="qiskit.circuit.library.ExcitationPreserving.x" name="x" signature="ExcitationPreserving.x(qubit, *, label=None, ctrl_state=None, q=None)">
    Apply [`XGate`](qiskit.circuit.library.XGate "qiskit.circuit.library.XGate").
  </Function>

  ### y

  <Function id="qiskit.circuit.library.ExcitationPreserving.y" name="y" signature="ExcitationPreserving.y(qubit, *, q=None)">
    Apply [`YGate`](qiskit.circuit.library.YGate "qiskit.circuit.library.YGate").
  </Function>

  ### z

  <Function id="qiskit.circuit.library.ExcitationPreserving.z" name="z" signature="ExcitationPreserving.z(qubit, *, q=None)">
