---
title: ShiftPhase (v0.19)
description: API reference for qiskit.pulse.instructions.ShiftPhase in qiskit v0.19
...
$$
  ...
  *   **name** (`Optional`\[`str`]) – Display name for this instruction.
  ...
  <span id="shiftphase-instructions" />
  ...
  <span id="shiftphase-ch-duration" />
  ...
  <span id="shiftphase-ch-start-time" />
  ...
  <span id="shiftphase-ch-stop-time" />
