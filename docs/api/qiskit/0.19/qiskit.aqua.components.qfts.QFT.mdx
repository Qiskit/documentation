...
<Class id="qiskit.aqua.components.qfts.QFT" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.7/qiskit/aqua/components/qfts/qft.py" signature="QFT">
  ...
  <Function id="qiskit.aqua.components.qfts.QFT.construct_circuit" name="construct_circuit" signature="QFT.construct_circuit(mode='circuit', qubits=None, circuit=None, do_swaps=True)">
