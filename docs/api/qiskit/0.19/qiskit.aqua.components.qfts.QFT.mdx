...
<Class id="qiskit.aqua.components.qfts.QFT" github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.7/qiskit/aqua/components/qfts/qft.py" signature="QFT">
