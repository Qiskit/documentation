...
$$
  ...
  **CircuitError** – if the list of the diagonal entries or the qubit list is in bad format; if the number of diagonal entries is not 2^k, where k denotes the number of qubits
  ...
  <Function id="qiskit.circuit.library.Diagonal.cast" signature="static Diagonal.cast(value, _type)">
  ...
  <Function id="qiskit.circuit.library.Diagonal.cls_instances" signature="classmethod Diagonal.cls_instances()">
    Return the current number of instances of this class, useful for auto naming.
  </Function>

  ### cls\_prefix

  <Function id="qiskit.circuit.library.Diagonal.cls_prefix" signature="classmethod Diagonal.cls_prefix()">
  ...
  <Function id="qiskit.circuit.library.Diagonal.from_qasm_file" signature="static Diagonal.from_qasm_file(path)">
  ...
  <Function id="qiskit.circuit.library.Diagonal.from_qasm_str" signature="static Diagonal.from_qasm_str(qasm_str)">
