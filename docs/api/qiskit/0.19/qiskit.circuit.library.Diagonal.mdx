---
title: Diagonal (v0.19)
description: API reference for qiskit.circuit.library.Diagonal in qiskit v0.19
...
$$
  ...
  **CircuitError** – if the list of the diagonal entries or the qubit list is in bad format; if the number of diagonal entries is not 2^k, where k denotes the number of qubits
  ...
  <span id="diagonal-num-parameters" />
  ...
  <span id="diagonal-assign-parameters" />
  ...
  <span id="diagonal-bind-parameters" />
  ...
  <span id="diagonal-cbit-argument-conversion" />
  ...
  <span id="diagonal-cls-instances" />
  ...
  <span id="diagonal-from-qasm-file" />
  ...
  <span id="diagonal-from-qasm-str" />
  ...
  <span id="diagonal-measure-active" />
  ...
  <span id="diagonal-num-connected-components" />
  ...
  <span id="diagonal-num-nonlocal-gates" />
  ...
  <span id="diagonal-num-tensor-factors" />
  ...
  <span id="diagonal-num-unitary-factors" />
  ...
  <span id="diagonal-qbit-argument-conversion" />
  ...
  <span id="diagonal-remove-final-measurements" />
  ...
  <span id="diagonal-snapshot-density-matrix" />
  ...
  <span id="diagonal-snapshot-expectation-value" />
  ...
  <span id="diagonal-snapshot-probabilities" />
  ...
  <span id="diagonal-snapshot-stabilizer" />
  ...
  <span id="diagonal-snapshot-statevector" />
  ...
  <span id="diagonal-to-instruction" />
