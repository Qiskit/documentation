...
`Diagonal(diag)` [GitHub](https://github.com/qiskit/qiskit/tree/stable/0.14/qiskit/circuit/library/generalized_gates/diagonal.py "view source code")
...
<span id="qiskit.circuit.library.Diagonal.AND" />

`Diagonal.AND(qr_variables, qb_target, qr_ancillae, flags=None, mct_mode='no-ancilla')`
...
<span id="qiskit.circuit.library.Diagonal.OR" />

`Diagonal.OR(qr_variables, qb_target, qr_ancillae, flags=None, mct_mode='basic')`
...
`Diagonal.append(instruction, qargs=None, cargs=None)`
...
`Diagonal.assign_parameters(param_dict, inplace=False)`
...
`Diagonal.cbit_argument_conversion(clbit_representation)`
...
`Diagonal.ccx(control_qubit1, control_qubit2, target_qubit, *, ctl1=None, ctl2=None, tgt=None)`
...
`Diagonal.ch(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)`
...
`Diagonal.cnot(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)`
...
`Diagonal.compose(other, qubits=None, clbits=None, front=False, inplace=False)`
...
`Diagonal.crx(theta, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)`
...
`Diagonal.cry(theta, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)`
...
`Diagonal.crz(theta, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)`
...
`Diagonal.cswap(control_qubit, target_qubit1, target_qubit2, *, label=None, ctrl_state=None, ctl=None, tgt1=None, tgt2=None)`
...
`Diagonal.cu1(theta, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)`
...
`Diagonal.cu3(theta, phi, lam, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)`
...
`Diagonal.cx(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)`
...
`Diagonal.cy(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)`
...
`Diagonal.cz(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)`
...
`Diagonal.draw(output=None, scale=0.7, filename=None, style=None, interactive=False, line_length=None, plot_barriers=True, reverse_bits=False, justify=None, vertical_compression='medium', idle_wires=True, with_layout=True, fold=None, ax=None, initial_state=False, cregbundle=False)`
...
`Diagonal.fredkin(control_qubit, target_qubit1, target_qubit2, *, ctl=None, tgt1=None, tgt2=None)`
...
`static Diagonal.from_qasm_file(path)`
...
`static Diagonal.from_qasm_str(qasm_str)`
...
`Diagonal.iso(isometry, q_input, q_ancillas_for_output, q_ancillas_zero=None, q_ancillas_dirty=None)`
...
`Diagonal.isometry(isometry, q_input, q_ancillas_for_output, q_ancillas_zero=None, q_ancillas_dirty=None)`
...
`Diagonal.mcmt(gate, control_qubits, target_qubits, ancilla_qubits=None, mode='no-ancilla', *, single_control_gate_fun=None, q_controls=None, q_ancillae=None, q_targets=None)`
...
`Diagonal.mcrx(theta, q_controls, q_target, use_basis_gates=False)`
...
`Diagonal.mcry(theta, q_controls, q_target, q_ancillae, mode='basic', use_basis_gates=False)`
...
`Diagonal.mcrz(lam, q_controls, q_target, use_basis_gates=False)`
...
`Diagonal.mcx(control_qubits, target_qubit, ancilla_qubits=None, mode='noancilla')`
...
`Diagonal.measure_active(inplace=True)`
...
`Diagonal.measure_all(inplace=True)`
...
`Diagonal.num_connected_components(unitary_only=False)`
...
`Diagonal.qbit_argument_conversion(qubit_representation)`
...
`Diagonal.rcccx(control_qubit1, control_qubit2, control_qubit3, target_qubit)`
...
`Diagonal.rccx(control_qubit1, control_qubit2, target_qubit)`
...
`Diagonal.remove_final_measurements(inplace=True)`
...
`Diagonal.rx(theta, qubit, *, label=None, q=None)`
...
`Diagonal.ry(theta, qubit, *, label=None, q=None)`
...
`Diagonal.snapshot(label, snapshot_type='statevector', qubits=None, params=None)`
...
`Diagonal.snapshot_expectation_value(label, op, qubits, single_shot=False, variance=False)`
...
`Diagonal.squ(unitary_matrix, qubit, mode='ZYZ', up_to_diagonal=False, *, u=None)`
...
`Diagonal.to_gate(parameter_map=None)`
...
`Diagonal.to_instruction(parameter_map=None)`
...
`Diagonal.toffoli(control_qubit1, control_qubit2, target_qubit, *, ctl1=None, ctl2=None, tgt=None)`
...
`Diagonal.u2(phi, lam, qubit, *, q=None)`
...
`Diagonal.u3(theta, phi, lam, qubit, *, q=None)`
...
`Diagonal.uc(gate_list, q_controls, q_target, up_to_diagonal=False)`
...
`Diagonal.x(qubit, *, label=None, ctrl_state=None, q=None)`
