...
<Class id="qiskit.circuit.library.Diagonal" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.14/qiskit/circuit/library/generalized_gates/diagonal.py" signature="Diagonal(diag)">
  Diagonal circuit.
...
$$
  ...
  **CircuitError** – if the list of the diagonal entries or the qubit list is in bad format; if the number of diagonal entries is not 2^k, where k denotes the number of qubits
  ...
  <Attribute id="qiskit.circuit.library.Diagonal.clbits" name="clbits">
    Returns a list of classical bits in the order that the registers were added.
  </Attribute>

  ### data

  <Attribute id="qiskit.circuit.library.Diagonal.data" name="data">
  ...
  <Attribute id="qiskit.circuit.library.Diagonal.extension_lib" signature="= 'include \&#x22;qelib1.inc\&#x22;;'" />

  ### header

  <Attribute id="qiskit.circuit.library.Diagonal.header" signature="= 'OPENQASM 2.0;'" />

  ### instances

  <Attribute id="qiskit.circuit.library.Diagonal.instances" signature="= 8" />

  ### n\_qubits

  <Attribute id="qiskit.circuit.library.Diagonal.n_qubits" name="n_qubits">
    Deprecated, use `num_qubits` instead. Return number of qubits.
  </Attribute>

  ### num\_clbits

  <Attribute id="qiskit.circuit.library.Diagonal.num_clbits" name="num_clbits">
    Return number of classical bits.
  </Attribute>

  ### num\_parameters

  <Attribute id="qiskit.circuit.library.Diagonal.num_parameters" name="num_parameters">
    Convenience function to get the number of parameter objects in the circuit.
  </Attribute>

  ### num\_qubits

  <Attribute id="qiskit.circuit.library.Diagonal.num_qubits" name="num_qubits">
    Return number of qubits.
  </Attribute>

  ### parameters

  <Attribute id="qiskit.circuit.library.Diagonal.parameters" name="parameters">
    Convenience function to get the parameters defined in the parameter table.
  </Attribute>

  ### prefix

  <Attribute id="qiskit.circuit.library.Diagonal.prefix" signature="= 'circuit'" />

  ### qubits

  <Attribute id="qiskit.circuit.library.Diagonal.qubits" name="qubits">
  ...
  <Function id="qiskit.circuit.library.Diagonal.AND" name="AND" signature="Diagonal.AND(qr_variables, qb_target, qr_ancillae, flags=None, mct_mode='no-ancilla')">
  ...
  <Function id="qiskit.circuit.library.Diagonal.OR" name="OR" signature="Diagonal.OR(qr_variables, qb_target, qr_ancillae, flags=None, mct_mode='basic')">
  ...
  <Function id="qiskit.circuit.library.Diagonal.__getitem__" name="__getitem__" signature="Diagonal.__getitem__(item)">
    Return indexed operation.
  </Function>

  ### \_\_len\_\_

  <Function id="qiskit.circuit.library.Diagonal.__len__" name="__len__" signature="Diagonal.__len__()">
    Return number of operations in circuit.
  </Function>

  ### add\_register

  <Function id="qiskit.circuit.library.Diagonal.add_register" name="add_register" signature="Diagonal.add_register(*regs)">
    Add registers.
  </Function>

  ### append

  <Function id="qiskit.circuit.library.Diagonal.append" name="append" signature="Diagonal.append(instruction, qargs=None, cargs=None)">
  ...
  <Function id="qiskit.circuit.library.Diagonal.assign_parameters" name="assign_parameters" signature="Diagonal.assign_parameters(param_dict, inplace=False)">
  ...
  <Function id="qiskit.circuit.library.Diagonal.barrier" name="barrier" signature="Diagonal.barrier(*qargs)">
    Apply `Barrier`. If qargs is None, applies to all.
  </Function>

  ### bind\_parameters

  <Function id="qiskit.circuit.library.Diagonal.bind_parameters" name="bind_parameters" signature="Diagonal.bind_parameters(value_dict)">
  ...
  <Function id="qiskit.circuit.library.Diagonal.cast" name="cast" signature="static Diagonal.cast(value, _type)">
    Best effort to cast value to type. Otherwise, returns the value.
  </Function>

  ### cbit\_argument\_conversion

  <Function id="qiskit.circuit.library.Diagonal.cbit_argument_conversion" name="cbit_argument_conversion" signature="Diagonal.cbit_argument_conversion(clbit_representation)">
  ...
  <Function id="qiskit.circuit.library.Diagonal.ccx" name="ccx" signature="Diagonal.ccx(control_qubit1, control_qubit2, target_qubit, *, ctl1=None, ctl2=None, tgt=None)">
    Apply [`CCXGate`](qiskit.circuit.library.CCXGate "qiskit.circuit.library.CCXGate").
  </Function>

  ### ch

  <Function id="qiskit.circuit.library.Diagonal.ch" name="ch" signature="Diagonal.ch(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CHGate`](qiskit.circuit.library.CHGate "qiskit.circuit.library.CHGate").
  </Function>

  ### cls\_instances

  <Function id="qiskit.circuit.library.Diagonal.cls_instances" name="cls_instances" signature="classmethod Diagonal.cls_instances()">
    Return the current number of instances of this class, useful for auto naming.
  </Function>

  ### cls\_prefix

  <Function id="qiskit.circuit.library.Diagonal.cls_prefix" name="cls_prefix" signature="classmethod Diagonal.cls_prefix()">
    Return the prefix to use for auto naming.
  </Function>

  ### cnot

  <Function id="qiskit.circuit.library.Diagonal.cnot" name="cnot" signature="Diagonal.cnot(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CXGate`](qiskit.circuit.library.CXGate "qiskit.circuit.library.CXGate").
  </Function>

  ### combine

  <Function id="qiskit.circuit.library.Diagonal.combine" name="combine" signature="Diagonal.combine(rhs)">
  ...
  <Function id="qiskit.circuit.library.Diagonal.compose" name="compose" signature="Diagonal.compose(other, qubits=None, clbits=None, front=False, inplace=False)">
  ...
  <Function id="qiskit.circuit.library.Diagonal.copy" name="copy" signature="Diagonal.copy(name=None)">
    Copy the circuit.
  ...
  <Function id="qiskit.circuit.library.Diagonal.count_ops" name="count_ops" signature="Diagonal.count_ops()">
  ...
  <Function id="qiskit.circuit.library.Diagonal.crx" name="crx" signature="Diagonal.crx(theta, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CRXGate`](qiskit.circuit.library.CRXGate "qiskit.circuit.library.CRXGate").
  </Function>

  ### cry

  <Function id="qiskit.circuit.library.Diagonal.cry" name="cry" signature="Diagonal.cry(theta, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CRYGate`](qiskit.circuit.library.CRYGate "qiskit.circuit.library.CRYGate").
  </Function>

  ### crz

  <Function id="qiskit.circuit.library.Diagonal.crz" name="crz" signature="Diagonal.crz(theta, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CRZGate`](qiskit.circuit.library.CRZGate "qiskit.circuit.library.CRZGate").
  </Function>

  ### cswap

  <Function id="qiskit.circuit.library.Diagonal.cswap" name="cswap" signature="Diagonal.cswap(control_qubit, target_qubit1, target_qubit2, *, label=None, ctrl_state=None, ctl=None, tgt1=None, tgt2=None)">
    Apply [`CSwapGate`](qiskit.circuit.library.CSwapGate "qiskit.circuit.library.CSwapGate").
  </Function>

  ### cu1

  <Function id="qiskit.circuit.library.Diagonal.cu1" name="cu1" signature="Diagonal.cu1(theta, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CU1Gate`](qiskit.circuit.library.CU1Gate "qiskit.circuit.library.CU1Gate").
  </Function>

  ### cu3

  <Function id="qiskit.circuit.library.Diagonal.cu3" name="cu3" signature="Diagonal.cu3(theta, phi, lam, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CU3Gate`](qiskit.circuit.library.CU3Gate "qiskit.circuit.library.CU3Gate").
  </Function>

  ### cx

  <Function id="qiskit.circuit.library.Diagonal.cx" name="cx" signature="Diagonal.cx(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CXGate`](qiskit.circuit.library.CXGate "qiskit.circuit.library.CXGate").
  </Function>

  ### cy

  <Function id="qiskit.circuit.library.Diagonal.cy" name="cy" signature="Diagonal.cy(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CYGate`](qiskit.circuit.library.CYGate "qiskit.circuit.library.CYGate").
  </Function>

  ### cz

  <Function id="qiskit.circuit.library.Diagonal.cz" name="cz" signature="Diagonal.cz(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CZGate`](qiskit.circuit.library.CZGate "qiskit.circuit.library.CZGate").
  </Function>

  ### dcx

  <Function id="qiskit.circuit.library.Diagonal.dcx" name="dcx" signature="Diagonal.dcx(qubit1, qubit2)">
    Apply [`DCXGate`](qiskit.circuit.library.DCXGate "qiskit.circuit.library.DCXGate").
  </Function>

  ### decompose

  <Function id="qiskit.circuit.library.Diagonal.decompose" name="decompose" signature="Diagonal.decompose()">
  ...
  <Function id="qiskit.circuit.library.Diagonal.depth" name="depth" signature="Diagonal.depth()">
  ...
  <Function id="qiskit.circuit.library.Diagonal.diag_gate" name="diag_gate" signature="Diagonal.diag_gate(diag, qubit)">
    Deprecated version of QuantumCircuit.diagonal.
  </Function>

  ### diagonal

  <Function id="qiskit.circuit.library.Diagonal.diagonal" name="diagonal" signature="Diagonal.diagonal(diag, qubit)">
  ...
  <Function id="qiskit.circuit.library.Diagonal.extend" name="extend" signature="Diagonal.extend(rhs)">
  ...
  <Function id="qiskit.circuit.library.Diagonal.fredkin" name="fredkin" signature="Diagonal.fredkin(control_qubit, target_qubit1, target_qubit2, *, ctl=None, tgt1=None, tgt2=None)">
    Apply [`CSwapGate`](qiskit.circuit.library.CSwapGate "qiskit.circuit.library.CSwapGate").
  </Function>

  ### from\_qasm\_file

  <Function id="qiskit.circuit.library.Diagonal.from_qasm_file" name="from_qasm_file" signature="static Diagonal.from_qasm_file(path)">
  ...
  <Function id="qiskit.circuit.library.Diagonal.from_qasm_str" name="from_qasm_str" signature="static Diagonal.from_qasm_str(qasm_str)">
  ...
  <Function id="qiskit.circuit.library.Diagonal.h" name="h" signature="Diagonal.h(qubit, *, q=None)">
    Apply [`HGate`](qiskit.circuit.library.HGate "qiskit.circuit.library.HGate").
  </Function>

  ### hamiltonian

  <Function id="qiskit.circuit.library.Diagonal.hamiltonian" name="hamiltonian" signature="Diagonal.hamiltonian(operator, time, qubits, label=None)">
    Apply hamiltonian evolution to to qubits.
  </Function>

  ### has\_register

  <Function id="qiskit.circuit.library.Diagonal.has_register" name="has_register" signature="Diagonal.has_register(register)">
  ...
  <Function id="qiskit.circuit.library.Diagonal.i" name="i" signature="Diagonal.i(qubit, *, q=None)">
    Apply [`IGate`](qiskit.circuit.library.IGate "qiskit.circuit.library.IGate").
  </Function>

  ### id

  <Function id="qiskit.circuit.library.Diagonal.id" name="id" signature="Diagonal.id(qubit, *, q=None)">
    Apply [`IGate`](qiskit.circuit.library.IGate "qiskit.circuit.library.IGate").
  </Function>

  ### iden

  <Function id="qiskit.circuit.library.Diagonal.iden" name="iden" signature="Diagonal.iden(qubit, *, q=None)">
    Deprecated identity gate.
  </Function>

  ### initialize

  <Function id="qiskit.circuit.library.Diagonal.initialize" name="initialize" signature="Diagonal.initialize(params, qubits)">
    Apply initialize to circuit.
  </Function>

  ### inverse

  <Function id="qiskit.circuit.library.Diagonal.inverse" name="inverse" signature="Diagonal.inverse()">
    Invert this circuit.
  ...
  <Function id="qiskit.circuit.library.Diagonal.iso" name="iso" signature="Diagonal.iso(isometry, q_input, q_ancillas_for_output, q_ancillas_zero=None, q_ancillas_dirty=None)">
  ...
  <Function id="qiskit.circuit.library.Diagonal.isometry" name="isometry" signature="Diagonal.isometry(isometry, q_input, q_ancillas_for_output, q_ancillas_zero=None, q_ancillas_dirty=None)">
    Attach an arbitrary isometry from m to n qubits to a circuit. In particular, this allows to attach arbitrary unitaries on n qubits (m=n) or to prepare any state on n qubits (m=0). The decomposition used here was introduced by Iten et al. in [https://arxiv.org/abs/1501.06911](https://arxiv.org/abs/1501.06911).
  ...
  <Function id="qiskit.circuit.library.Diagonal.iswap" name="iswap" signature="Diagonal.iswap(qubit1, qubit2)">
    Apply [`iSwapGate`](qiskit.circuit.library.iSwapGate "qiskit.circuit.library.iSwapGate").
  </Function>

  ### mcmt

  <Function id="qiskit.circuit.library.Diagonal.mcmt" name="mcmt" signature="Diagonal.mcmt(gate, control_qubits, target_qubits, ancilla_qubits=None, mode='no-ancilla', *, single_control_gate_fun=None, q_controls=None, q_ancillae=None, q_targets=None)">
  ...
  <Function id="qiskit.circuit.library.Diagonal.mcrx" name="mcrx" signature="Diagonal.mcrx(theta, q_controls, q_target, use_basis_gates=False)">
  ...
  <Function id="qiskit.circuit.library.Diagonal.mcry" name="mcry" signature="Diagonal.mcry(theta, q_controls, q_target, q_ancillae, mode='basic', use_basis_gates=False)">
  ...
  <Function id="qiskit.circuit.library.Diagonal.mcrz" name="mcrz" signature="Diagonal.mcrz(lam, q_controls, q_target, use_basis_gates=False)">
  ...
  <Function id="qiskit.circuit.library.Diagonal.mct" name="mct" signature="Diagonal.mct(control_qubits, target_qubit, ancilla_qubits=None, mode='noancilla')">
    Apply `MCXGate`.
  </Function>

  ### mcu1

  <Function id="qiskit.circuit.library.Diagonal.mcu1" name="mcu1" signature="Diagonal.mcu1(lam, control_qubits, target_qubit)">
    Apply `MCU1Gate`.
  </Function>

  ### mcx

  <Function id="qiskit.circuit.library.Diagonal.mcx" name="mcx" signature="Diagonal.mcx(control_qubits, target_qubit, ancilla_qubits=None, mode='noancilla')">
    Apply `MCXGate`.
  ...
  <Function id="qiskit.circuit.library.Diagonal.measure" name="measure" signature="Diagonal.measure(qubit, cbit)">
  ...
  <Function id="qiskit.circuit.library.Diagonal.measure_active" name="measure_active" signature="Diagonal.measure_active(inplace=True)">
  ...
  <Function id="qiskit.circuit.library.Diagonal.measure_all" name="measure_all" signature="Diagonal.measure_all(inplace=True)">
  ...
  <Function id="qiskit.circuit.library.Diagonal.mirror" name="mirror" signature="Diagonal.mirror()">
  ...
  <Function id="qiskit.circuit.library.Diagonal.ms" name="ms" signature="Diagonal.ms(theta, qubits)">
    Apply [`MSGate`](qiskit.circuit.library.MSGate "qiskit.circuit.library.MSGate").
  </Function>

  ### num\_connected\_components

  <Function id="qiskit.circuit.library.Diagonal.num_connected_components" name="num_connected_components" signature="Diagonal.num_connected_components(unitary_only=False)">
  ...
  <Function id="qiskit.circuit.library.Diagonal.num_nonlocal_gates" name="num_nonlocal_gates" signature="Diagonal.num_nonlocal_gates()">
  ...
  <Function id="qiskit.circuit.library.Diagonal.num_tensor_factors" name="num_tensor_factors" signature="Diagonal.num_tensor_factors()">
  ...
  <Function id="qiskit.circuit.library.Diagonal.num_unitary_factors" name="num_unitary_factors" signature="Diagonal.num_unitary_factors()">
    Computes the number of tensor factors in the unitary (quantum) part of the circuit only.
  </Function>

  ### qasm

  <Function id="qiskit.circuit.library.Diagonal.qasm" name="qasm" signature="Diagonal.qasm(formatted=False, filename=None)">
  ...
  <Function id="qiskit.circuit.library.Diagonal.qbit_argument_conversion" name="qbit_argument_conversion" signature="Diagonal.qbit_argument_conversion(qubit_representation)">
  ...
  <Function id="qiskit.circuit.library.Diagonal.r" name="r" signature="Diagonal.r(theta, phi, qubit, *, q=None)">
    Apply `RGate`.
  </Function>

  ### rcccx

  <Function id="qiskit.circuit.library.Diagonal.rcccx" name="rcccx" signature="Diagonal.rcccx(control_qubit1, control_qubit2, control_qubit3, target_qubit)">
    Apply [`RC3XGate`](qiskit.circuit.library.RC3XGate "qiskit.circuit.library.RC3XGate").
  </Function>

  ### rccx

  <Function id="qiskit.circuit.library.Diagonal.rccx" name="rccx" signature="Diagonal.rccx(control_qubit1, control_qubit2, target_qubit)">
    Apply [`RCCXGate`](qiskit.circuit.library.RCCXGate "qiskit.circuit.library.RCCXGate").
  </Function>

  ### remove\_final\_measurements

  <Function id="qiskit.circuit.library.Diagonal.remove_final_measurements" name="remove_final_measurements" signature="Diagonal.remove_final_measurements(inplace=True)">
  ...
  <Function id="qiskit.circuit.library.Diagonal.reset" name="reset" signature="Diagonal.reset(qubit)">
    Reset q.
  </Function>

  ### rx

  <Function id="qiskit.circuit.library.Diagonal.rx" name="rx" signature="Diagonal.rx(theta, qubit, *, label=None, q=None)">
    Apply [`RXGate`](qiskit.circuit.library.RXGate "qiskit.circuit.library.RXGate").
  </Function>

  ### rxx

  <Function id="qiskit.circuit.library.Diagonal.rxx" name="rxx" signature="Diagonal.rxx(theta, qubit1, qubit2)">
    Apply [`RXXGate`](qiskit.circuit.library.RXXGate "qiskit.circuit.library.RXXGate").
  </Function>

  ### ry

  <Function id="qiskit.circuit.library.Diagonal.ry" name="ry" signature="Diagonal.ry(theta, qubit, *, label=None, q=None)">
    Apply [`RYGate`](qiskit.circuit.library.RYGate "qiskit.circuit.library.RYGate").
  </Function>

  ### ryy

  <Function id="qiskit.circuit.library.Diagonal.ryy" name="ryy" signature="Diagonal.ryy(theta, qubit1, qubit2)">
    Apply [`RYYGate`](qiskit.circuit.library.RYYGate "qiskit.circuit.library.RYYGate").
  </Function>

  ### rz

  <Function id="qiskit.circuit.library.Diagonal.rz" name="rz" signature="Diagonal.rz(phi, qubit, *, q=None)">
    Apply [`RZGate`](qiskit.circuit.library.RZGate "qiskit.circuit.library.RZGate").
  </Function>

  ### rzx

  <Function id="qiskit.circuit.library.Diagonal.rzx" name="rzx" signature="Diagonal.rzx(theta, qubit1, qubit2)">
    Apply [`RZXGate`](qiskit.circuit.library.RZXGate "qiskit.circuit.library.RZXGate").
  </Function>

  ### rzz

  <Function id="qiskit.circuit.library.Diagonal.rzz" name="rzz" signature="Diagonal.rzz(theta, qubit1, qubit2)">
    Apply [`RZZGate`](qiskit.circuit.library.RZZGate "qiskit.circuit.library.RZZGate").
  </Function>

  ### s

  <Function id="qiskit.circuit.library.Diagonal.s" name="s" signature="Diagonal.s(qubit, *, q=None)">
    Apply [`SGate`](qiskit.circuit.library.SGate "qiskit.circuit.library.SGate").
  </Function>

  ### sdg

  <Function id="qiskit.circuit.library.Diagonal.sdg" name="sdg" signature="Diagonal.sdg(qubit, *, q=None)">
    Apply [`SdgGate`](qiskit.circuit.library.SdgGate "qiskit.circuit.library.SdgGate").
  </Function>

  ### size

  <Function id="qiskit.circuit.library.Diagonal.size" name="size" signature="Diagonal.size()">
  ...
  <Function id="qiskit.circuit.library.Diagonal.snapshot" name="snapshot" signature="Diagonal.snapshot(label, snapshot_type='statevector', qubits=None, params=None)">
  ...
  <Function id="qiskit.circuit.library.Diagonal.snapshot_density_matrix" name="snapshot_density_matrix" signature="Diagonal.snapshot_density_matrix(label, qubits=None)">
  ...
  <Function id="qiskit.circuit.library.Diagonal.snapshot_expectation_value" name="snapshot_expectation_value" signature="Diagonal.snapshot_expectation_value(label, op, qubits, single_shot=False, variance=False)">
  ...
  <Function id="qiskit.circuit.library.Diagonal.snapshot_probabilities" name="snapshot_probabilities" signature="Diagonal.snapshot_probabilities(label, qubits, variance=False)">
  ...
  <Function id="qiskit.circuit.library.Diagonal.snapshot_stabilizer" name="snapshot_stabilizer" signature="Diagonal.snapshot_stabilizer(label)">
  ...
  <Function id="qiskit.circuit.library.Diagonal.snapshot_statevector" name="snapshot_statevector" signature="Diagonal.snapshot_statevector(label)">
  ...
  <Function id="qiskit.circuit.library.Diagonal.squ" name="squ" signature="Diagonal.squ(unitary_matrix, qubit, mode='ZYZ', up_to_diagonal=False, *, u=None)">
  ...
  <Function id="qiskit.circuit.library.Diagonal.swap" name="swap" signature="Diagonal.swap(qubit1, qubit2)">
    Apply [`SwapGate`](qiskit.circuit.library.SwapGate "qiskit.circuit.library.SwapGate").
  </Function>

  ### t

  <Function id="qiskit.circuit.library.Diagonal.t" name="t" signature="Diagonal.t(qubit, *, q=None)">
    Apply [`TGate`](qiskit.circuit.library.TGate "qiskit.circuit.library.TGate").
  </Function>

  ### tdg

  <Function id="qiskit.circuit.library.Diagonal.tdg" name="tdg" signature="Diagonal.tdg(qubit, *, q=None)">
    Apply [`TdgGate`](qiskit.circuit.library.TdgGate "qiskit.circuit.library.TdgGate").
  </Function>

  ### to\_gate

  <Function id="qiskit.circuit.library.Diagonal.to_gate" name="to_gate" signature="Diagonal.to_gate(parameter_map=None)">
  ...
  <Function id="qiskit.circuit.library.Diagonal.to_instruction" name="to_instruction" signature="Diagonal.to_instruction(parameter_map=None)">
  ...
  <Function id="qiskit.circuit.library.Diagonal.toffoli" name="toffoli" signature="Diagonal.toffoli(control_qubit1, control_qubit2, target_qubit, *, ctl1=None, ctl2=None, tgt=None)">
    Apply [`CCXGate`](qiskit.circuit.library.CCXGate "qiskit.circuit.library.CCXGate").
  </Function>

  ### u1

  <Function id="qiskit.circuit.library.Diagonal.u1" name="u1" signature="Diagonal.u1(theta, qubit, *, q=None)">
    Apply [`U1Gate`](qiskit.circuit.library.U1Gate "qiskit.circuit.library.U1Gate").
  </Function>

  ### u2

  <Function id="qiskit.circuit.library.Diagonal.u2" name="u2" signature="Diagonal.u2(phi, lam, qubit, *, q=None)">
    Apply [`U2Gate`](qiskit.circuit.library.U2Gate "qiskit.circuit.library.U2Gate").
  </Function>

  ### u3

  <Function id="qiskit.circuit.library.Diagonal.u3" name="u3" signature="Diagonal.u3(theta, phi, lam, qubit, *, q=None)">
    Apply [`U3Gate`](qiskit.circuit.library.U3Gate "qiskit.circuit.library.U3Gate").
  </Function>

  ### uc

  <Function id="qiskit.circuit.library.Diagonal.uc" name="uc" signature="Diagonal.uc(gate_list, q_controls, q_target, up_to_diagonal=False)">
  ...
  <Function id="qiskit.circuit.library.Diagonal.ucg" name="ucg" signature="Diagonal.ucg(angle_list, q_controls, q_target, up_to_diagonal=False)">
    Deprecated version of uc.
  </Function>

  ### ucrx

  <Function id="qiskit.circuit.library.Diagonal.ucrx" name="ucrx" signature="Diagonal.ucrx(angle_list, q_controls, q_target)">
  ...
  <Function id="qiskit.circuit.library.Diagonal.ucry" name="ucry" signature="Diagonal.ucry(angle_list, q_controls, q_target)">
  ...
  <Function id="qiskit.circuit.library.Diagonal.ucrz" name="ucrz" signature="Diagonal.ucrz(angle_list, q_controls, q_target)">
  ...
  <Function id="qiskit.circuit.library.Diagonal.ucx" name="ucx" signature="Diagonal.ucx(angle_list, q_controls, q_target)">
    Deprecated version of ucrx.
  </Function>

  ### ucy

  <Function id="qiskit.circuit.library.Diagonal.ucy" name="ucy" signature="Diagonal.ucy(angle_list, q_controls, q_target)">
    Deprecated version of ucry.
  </Function>

  ### ucz

  <Function id="qiskit.circuit.library.Diagonal.ucz" name="ucz" signature="Diagonal.ucz(angle_list, q_controls, q_target)">
    Deprecated version of ucrz.
  </Function>

  ### unitary

  <Function id="qiskit.circuit.library.Diagonal.unitary" name="unitary" signature="Diagonal.unitary(obj, qubits, label=None)">
    Apply unitary gate to q.
  </Function>

  ### width

  <Function id="qiskit.circuit.library.Diagonal.width" name="width" signature="Diagonal.width()">
  ...
  <Function id="qiskit.circuit.library.Diagonal.x" name="x" signature="Diagonal.x(qubit, *, label=None, ctrl_state=None, q=None)">
    Apply [`XGate`](qiskit.circuit.library.XGate "qiskit.circuit.library.XGate").
  </Function>

  ### y

  <Function id="qiskit.circuit.library.Diagonal.y" name="y" signature="Diagonal.y(qubit, *, q=None)">
    Apply [`YGate`](qiskit.circuit.library.YGate "qiskit.circuit.library.YGate").
  </Function>

  ### z

  <Function id="qiskit.circuit.library.Diagonal.z" name="z" signature="Diagonal.z(qubit, *, q=None)">
