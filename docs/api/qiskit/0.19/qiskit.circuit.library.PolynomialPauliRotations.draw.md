---
title: draw
description: API reference for qiskit.circuit.library.PolynomialPauliRotations.draw
in_page_toc_min_heading_level: 1
python_api_type: method
python_api_name: qiskit.circuit.library.PolynomialPauliRotations.draw
---
