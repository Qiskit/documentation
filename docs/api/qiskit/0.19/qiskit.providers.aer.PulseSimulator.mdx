---
title: PulseSimulator (v0.19)
description: API reference for qiskit.providers.aer.PulseSimulator in qiskit v0.19
...
<Class id="qiskit.providers.aer.PulseSimulator" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-aer/tree/stable/0.5/qiskit/providers/aer/backends/pulse_simulator.py" signature="PulseSimulator(configuration=None, provider=None)" modifiers="class">
  ...
  *   [**AerError**](qiskit.providers.aer.AerError "qiskit.providers.aer.AerError") – if there is no name in the configuration
  ...
  <span id="pulsesimulator-default-configuration" />
  ...
  <span id="pulsesimulator-configuration" />
  ...
  <span id="pulsesimulator-defaults" />
  ...
  <span id="pulsesimulator-properties" />
  ...
  <span id="pulsesimulator-provider" />
  ...
  <span id="pulsesimulator-version" />
