...
<Class id="qiskit.providers.aer.PulseSimulator" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-aer/tree/stable/0.5/qiskit/providers/aer/backends/pulse_simulator.py" signature="PulseSimulator(configuration=None, provider=None)">
  ...
  *   [**AerError**](qiskit.providers.aer.AerError "qiskit.providers.aer.AerError") – if there is no name in the configuration
  ...
  <Function id="qiskit.providers.aer.PulseSimulator.run" name="run" signature="PulseSimulator.run(qobj, system_model, backend_options=None, validate=False)">
  ...
  <Function id="qiskit.providers.aer.PulseSimulator.version" name="version" signature="PulseSimulator.version()">
