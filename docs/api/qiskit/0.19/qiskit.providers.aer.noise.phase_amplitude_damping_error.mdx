...
<Function id="qiskit.providers.aer.noise.phase_amplitude_damping_error" github="https://github.com/qiskit/qiskit-aer/tree/stable/0.5/qiskit/providers/aer/noise/errors/standard_errors.py" signature="phase_amplitude_damping_error(param_amp, param_phase, excited_state_population=0, canonical_kraus=True)">
