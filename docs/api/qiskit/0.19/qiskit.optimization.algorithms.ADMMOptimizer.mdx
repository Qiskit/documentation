---
title: ADMMOptimizer (v0.19)
description: API reference for qiskit.optimization.algorithms.ADMMOptimizer in qiskit v0.19
...
<Class id="qiskit.optimization.algorithms.ADMMOptimizer" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.7/qiskit/optimization/algorithms/admm_optimizer.py" signature="ADMMOptimizer(qubo_optimizer=None, continuous_optimizer=None, params=None)" modifiers="class">
  ...
  **NameError** – CPLEX is not installed.
  ...
  <span id="admmoptimizer-get-compatibility-msg" />
  ...
  <span id="admmoptimizer-is-compatible" />
