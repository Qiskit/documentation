...
<span id="qiskit.circuit.library.FunctionalPauliRotations.AND" />

`FunctionalPauliRotations.AND(qr_variables, qb_target, qr_ancillae, flags=None, mct_mode='no-ancilla')`
...
<span id="qiskit.circuit.library.FunctionalPauliRotations.OR" />

`FunctionalPauliRotations.OR(qr_variables, qb_target, qr_ancillae, flags=None, mct_mode='basic')`
...
<span id="qiskit.circuit.library.FunctionalPauliRotations.__len__" />
...
`FunctionalPauliRotations.append(instruction, qargs=None, cargs=None)`
...
`FunctionalPauliRotations.assign_parameters(param_dict, inplace=False)`
...
`FunctionalPauliRotations.bind_parameters(value_dict)`
...
`FunctionalPauliRotations.cbit_argument_conversion(clbit_representation)`
...
`FunctionalPauliRotations.ccx(control_qubit1, control_qubit2, target_qubit, *, ctl1=None, ctl2=None, tgt=None)`
...
`FunctionalPauliRotations.ch(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)`
...
`classmethod FunctionalPauliRotations.cls_instances()`
...
`FunctionalPauliRotations.cnot(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)`
...
`FunctionalPauliRotations.compose(other, qubits=None, clbits=None, front=False, inplace=False)`
...
`FunctionalPauliRotations.copy(name=None)`
...
`FunctionalPauliRotations.crx(theta, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)`
...
`FunctionalPauliRotations.cry(theta, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)`
...
`FunctionalPauliRotations.crz(theta, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)`
...
`FunctionalPauliRotations.cswap(control_qubit, target_qubit1, target_qubit2, *, label=None, ctrl_state=None, ctl=None, tgt1=None, tgt2=None)`
...
`FunctionalPauliRotations.cu1(theta, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)`
...
`FunctionalPauliRotations.cu3(theta, phi, lam, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)`
...
`FunctionalPauliRotations.cx(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)`
...
`FunctionalPauliRotations.cy(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)`
...
`FunctionalPauliRotations.cz(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)`
...
`FunctionalPauliRotations.draw(output=None, scale=0.7, filename=None, style=None, interactive=False, line_length=None, plot_barriers=True, reverse_bits=False, justify=None, vertical_compression='medium', idle_wires=True, with_layout=True, fold=None, ax=None, initial_state=False, cregbundle=False)`
...
`FunctionalPauliRotations.fredkin(control_qubit, target_qubit1, target_qubit2, *, ctl=None, tgt1=None, tgt2=None)`
...
`static FunctionalPauliRotations.from_qasm_file(path)`
...
`static FunctionalPauliRotations.from_qasm_str(qasm_str)`
...
`FunctionalPauliRotations.h(qubit, *, q=None)`
...
`FunctionalPauliRotations.hamiltonian(operator, time, qubits, label=None)`
...
`FunctionalPauliRotations.i(qubit, *, q=None)`
...
`FunctionalPauliRotations.iso(isometry, q_input, q_ancillas_for_output, q_ancillas_zero=None, q_ancillas_dirty=None)`
...
`FunctionalPauliRotations.isometry(isometry, q_input, q_ancillas_for_output, q_ancillas_zero=None, q_ancillas_dirty=None)`
...
`FunctionalPauliRotations.mcmt(gate, control_qubits, target_qubits, ancilla_qubits=None, mode='no-ancilla', *, single_control_gate_fun=None, q_controls=None, q_ancillae=None, q_targets=None)`
...
`FunctionalPauliRotations.mcrx(theta, q_controls, q_target, use_basis_gates=False)`
...
`FunctionalPauliRotations.mcry(theta, q_controls, q_target, q_ancillae, mode='basic', use_basis_gates=False)`
...
`FunctionalPauliRotations.mct(control_qubits, target_qubit, ancilla_qubits=None, mode='noancilla')`
...
`FunctionalPauliRotations.mcx(control_qubits, target_qubit, ancilla_qubits=None, mode='noancilla')`
...
`FunctionalPauliRotations.measure_active(inplace=True)`
...
`FunctionalPauliRotations.measure_all(inplace=True)`
...
`FunctionalPauliRotations.num_connected_components(unitary_only=False)`
...
`FunctionalPauliRotations.qasm(formatted=False, filename=None)`
...
`FunctionalPauliRotations.qbit_argument_conversion(qubit_representation)`
...
`FunctionalPauliRotations.r(theta, phi, qubit, *, q=None)`
...
`FunctionalPauliRotations.rcccx(control_qubit1, control_qubit2, control_qubit3, target_qubit)`
...
`FunctionalPauliRotations.rccx(control_qubit1, control_qubit2, target_qubit)`
...
`FunctionalPauliRotations.remove_final_measurements(inplace=True)`
...
`FunctionalPauliRotations.rx(theta, qubit, *, label=None, q=None)`
...
`FunctionalPauliRotations.rxx(theta, qubit1, qubit2)`
...
`FunctionalPauliRotations.ry(theta, qubit, *, label=None, q=None)`
...
`FunctionalPauliRotations.ryy(theta, qubit1, qubit2)`
...
`FunctionalPauliRotations.rz(phi, qubit, *, q=None)`
...
`FunctionalPauliRotations.rzx(theta, qubit1, qubit2)`
...
`FunctionalPauliRotations.rzz(theta, qubit1, qubit2)`
...
`FunctionalPauliRotations.sdg(qubit, *, q=None)`
...
`FunctionalPauliRotations.snapshot(label, snapshot_type='statevector', qubits=None, params=None)`
...
`FunctionalPauliRotations.snapshot_density_matrix(label, qubits=None)`
...
`FunctionalPauliRotations.snapshot_probabilities(label, qubits, variance=False)`
...
`FunctionalPauliRotations.squ(unitary_matrix, qubit, mode='ZYZ', up_to_diagonal=False, *, u=None)`
...
`FunctionalPauliRotations.t(qubit, *, q=None)`
...
`FunctionalPauliRotations.tdg(qubit, *, q=None)`
...
`FunctionalPauliRotations.to_gate(parameter_map=None)`
...
`FunctionalPauliRotations.to_instruction(parameter_map=None)`
...
`FunctionalPauliRotations.toffoli(control_qubit1, control_qubit2, target_qubit, *, ctl1=None, ctl2=None, tgt=None)`
...
`FunctionalPauliRotations.u1(theta, qubit, *, q=None)`
...
`FunctionalPauliRotations.u2(phi, lam, qubit, *, q=None)`
...
`FunctionalPauliRotations.u3(theta, phi, lam, qubit, *, q=None)`
...
`FunctionalPauliRotations.uc(gate_list, q_controls, q_target, up_to_diagonal=False)`
...
`FunctionalPauliRotations.ucrx(angle_list, q_controls, q_target)`
...
`FunctionalPauliRotations.ucry(angle_list, q_controls, q_target)`
...
`FunctionalPauliRotations.ucrz(angle_list, q_controls, q_target)`
...
<span id="qiskit.circuit.library.FunctionalPauliRotations.ucz" />

`FunctionalPauliRotations.ucz(angle_list, q_controls, q_target)`
...
`FunctionalPauliRotations.x(qubit, *, label=None, ctrl_state=None, q=None)`
...
`FunctionalPauliRotations.y(qubit, *, q=None)`
...
`FunctionalPauliRotations.z(qubit, *, q=None)`
