...
<Class id="qiskit.aqua.operators.list_ops.TensoredOp" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.7/qiskit/aqua/operators/list_ops/tensored_op.py" signature="TensoredOp(oplist, coeff=1.0, abelian=False)">
  ...
  *   **abelian** (`bool`) – Indicates whether the Operators in `oplist` are known to mutually commute.
  ...
  <Attribute id="qiskit.aqua.operators.list_ops.TensoredOp.abelian" signature="bool">
  ...
  <Attribute id="qiskit.aqua.operators.list_ops.TensoredOp.coeff" signature="Union[int, float, complex, qiskit.circuit.parameterexpression.ParameterExpression]">
  ...
  <Attribute id="qiskit.aqua.operators.list_ops.TensoredOp.combo_fn" signature="Callable">
  ...
  <Attribute id="qiskit.aqua.operators.list_ops.TensoredOp.distributive" signature="bool">
  ...
  <Attribute id="qiskit.aqua.operators.list_ops.TensoredOp.num_qubits" signature="int">
  ...
  <Attribute id="qiskit.aqua.operators.list_ops.TensoredOp.oplist" signature="List[qiskit.aqua.operators.operator_base.OperatorBase]">
