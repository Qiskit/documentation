...
<Class id="qiskit.aqua.operators.list_ops.TensoredOp" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.7/qiskit/aqua/operators/list_ops/tensored_op.py" signature="TensoredOp(oplist, coeff=1.0, abelian=False)">
  ...
  *   **abelian** (`bool`) – Indicates whether the Operators in `oplist` are known to mutually commute.
  ...
  <Attribute id="qiskit.aqua.operators.list_ops.TensoredOp.abelian" name="abelian" signature="bool">
  ...
  <Attribute id="qiskit.aqua.operators.list_ops.TensoredOp.coeff" name="coeff" signature="Union[int, float, complex, qiskit.circuit.parameterexpression.ParameterExpression]">
  ...
  <Attribute id="qiskit.aqua.operators.list_ops.TensoredOp.combo_fn" name="combo_fn" signature="Callable">
  ...
  <Attribute id="qiskit.aqua.operators.list_ops.TensoredOp.distributive" name="distributive" signature="bool">
  ...
  <Attribute id="qiskit.aqua.operators.list_ops.TensoredOp.num_qubits" name="num_qubits" signature="int">
  ...
  <Attribute id="qiskit.aqua.operators.list_ops.TensoredOp.oplist" name="oplist" signature="List[qiskit.aqua.operators.operator_base.OperatorBase]">
  ...
  <Function id="qiskit.aqua.operators.list_ops.TensoredOp.__getitem__" name="__getitem__" signature="TensoredOp.__getitem__(offset)">
  ...
  <Function id="qiskit.aqua.operators.list_ops.TensoredOp.__len__" name="__len__" signature="TensoredOp.__len__()">
    Length of `oplist`.
  ...
  <Function id="qiskit.aqua.operators.list_ops.TensoredOp.__mul__" name="__mul__" signature="TensoredOp.__mul__(other)">
  ...
  <Function id="qiskit.aqua.operators.list_ops.TensoredOp.compose" name="compose" signature="TensoredOp.compose(other)">
