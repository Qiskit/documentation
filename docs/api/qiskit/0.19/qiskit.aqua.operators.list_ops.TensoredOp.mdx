---
title: TensoredOp (v0.19)
description: API reference for qiskit.aqua.operators.list_ops.TensoredOp in qiskit v0.19
...
<Class id="qiskit.aqua.operators.list_ops.TensoredOp" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.7/qiskit/aqua/operators/list_ops/tensored_op.py" signature="TensoredOp(oplist, coeff=1.0, abelian=False)" modifiers="class">
  ...
  *   **abelian** (`bool`) – Indicates whether the Operators in `oplist` are known to mutually commute.
  ...
  <span id="tensoredop-abelian" />

  ### abelian

  <Attribute id="qiskit.aqua.operators.list_ops.TensoredOp.abelian" attributeTypeHint="bool">
  ...
  <span id="tensoredop-coeff" />

  ### coeff

  <Attribute id="qiskit.aqua.operators.list_ops.TensoredOp.coeff" attributeTypeHint="Union[int, float, complex, qiskit.circuit.parameterexpression.ParameterExpression]">
  ...
  <span id="tensoredop-combo-fn" />

  ### combo\_fn

  <Attribute id="qiskit.aqua.operators.list_ops.TensoredOp.combo_fn" attributeTypeHint="Callable">
  ...
  <span id="tensoredop-distributive" />

  ### distributive

  <Attribute id="qiskit.aqua.operators.list_ops.TensoredOp.distributive" attributeTypeHint="bool">
  ...
  <span id="tensoredop-num-qubits" />

  ### num\_qubits

  <Attribute id="qiskit.aqua.operators.list_ops.TensoredOp.num_qubits" attributeTypeHint="int">
  ...
  <span id="tensoredop-oplist" />

  ### oplist

  <Attribute id="qiskit.aqua.operators.list_ops.TensoredOp.oplist" attributeTypeHint="List[qiskit.aqua.operators.operator_base.OperatorBase]">
  ...
  <span id="tensoredop-getitem" />

  ### \_\_getitem\_\_

  <Function id="qiskit.aqua.operators.list_ops.TensoredOp.__getitem__" signature="TensoredOp.__getitem__(offset)">
  ...
  <span id="tensoredop-len" />

  ### \_\_len\_\_

  <Function id="qiskit.aqua.operators.list_ops.TensoredOp.__len__" signature="TensoredOp.__len__()">
    Length of `oplist`.
  ...
  <span id="tensoredop-mul" />

  ### \_\_mul\_\_

  <Function id="qiskit.aqua.operators.list_ops.TensoredOp.__mul__" signature="TensoredOp.__mul__(other)">
  ...
  <span id="tensoredop-assign-parameters" />
  ...
  <span id="tensoredop-bind-parameters" />
  ...
  <span id="tensoredop-compose" />

  ### compose

  <Function id="qiskit.aqua.operators.list_ops.TensoredOp.compose" signature="TensoredOp.compose(other)">
  ...
  <span id="tensoredop-primitive-strings" />
  ...
  <span id="tensoredop-tensorpower" />
  ...
  <span id="tensoredop-to-circuit-op" />
  ...
  <span id="tensoredop-to-legacy-op" />
  ...
  <span id="tensoredop-to-matrix-op" />
  ...
  <span id="tensoredop-to-pauli-op" />
  ...
  <span id="tensoredop-to-spmatrix" />
