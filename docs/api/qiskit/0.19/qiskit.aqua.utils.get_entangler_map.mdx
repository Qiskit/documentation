...
<Function id="qiskit.aqua.utils.get_entangler_map" name="get_entangler_map" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.7/qiskit/aqua/utils/entangler_map.py" signature="get_entangler_map(map_type, num_qubits, offset=0)">
