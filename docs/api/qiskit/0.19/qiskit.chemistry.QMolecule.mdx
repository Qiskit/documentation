---
title: QMolecule (v0.19)
description: API reference for qiskit.chemistry.QMolecule in qiskit v0.19
...
<Class id="qiskit.chemistry.QMolecule" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.7/qiskit/chemistry/qmolecule.py" signature="QMolecule(filename=None)" modifiers="class">
  ...
  <span id="qmolecule-one-body-integrals" />
  ...
  <span id="qmolecule-two-body-integrals" />
  ...
  <span id="qmolecule-x-dipole-integrals" />
  ...
  <span id="qmolecule-y-dipole-integrals" />
  ...
  <span id="qmolecule-z-dipole-integrals" />
  ...
  <span id="qmolecule-has-dipole-integrals" />
  ...
  <span id="qmolecule-onee-to-spin" />
  ...
  <span id="qmolecule-twoe-to-spin" />
  ...
  <span id="qmolecule-twoeints2mo-general" />
