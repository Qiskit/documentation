...
<Class id="qiskit.aqua.components.iqfts.Approximate" github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.7/qiskit/aqua/components/iqfts/approximate.py" signature="Approximate(num_qubits, degree=0)">
