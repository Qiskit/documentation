...
description: API reference for qiskit.circuit.library.LinearPauliRotations.remove_final_measurements
in_page_toc_min_heading_level: 1
python_api_type: method
python_api_name: qiskit.circuit.library.LinearPauliRotations.remove_final_measurements
---
...
`LinearPauliRotations.remove_final_measurements(inplace=True)`
