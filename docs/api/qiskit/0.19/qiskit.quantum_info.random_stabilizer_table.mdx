...
<Function id="qiskit.quantum_info.random_stabilizer_table" github="https://github.com/qiskit/qiskit/tree/stable/0.14/qiskit/quantum_info/operators/symplectic/random.py" signature="random_stabilizer_table(num_qubits, size=1, seed=None)">
