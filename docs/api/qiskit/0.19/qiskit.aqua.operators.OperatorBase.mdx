---
title: OperatorBase (v0.19)
description: API reference for qiskit.aqua.operators.OperatorBase in qiskit v0.19
...
<Class id="qiskit.aqua.operators.OperatorBase" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.7/qiskit/aqua/operators/operator_base.py" signature="OperatorBase" modifiers="class">
  ...
  <span id="operatorbase-num-qubits" />
  ...
  <span id="operatorbase-assign-parameters" />
  ...
  <span id="operatorbase-bind-parameters" />
  ...
  <span id="operatorbase-primitive-strings" />
  ...
  <span id="operatorbase-tensorpower" />
  ...
  <span id="operatorbase-to-legacy-op" />
  ...
  <span id="operatorbase-to-matrix" />
