...
<Class id="qiskit.aqua.operators.OperatorBase" github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.7/qiskit/aqua/operators/operator_base.py" signature="OperatorBase">
