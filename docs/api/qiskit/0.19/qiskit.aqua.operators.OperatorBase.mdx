...
<Class id="qiskit.aqua.operators.OperatorBase" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.7/qiskit/aqua/operators/operator_base.py" signature="OperatorBase">
  ...
  <Attribute id="qiskit.aqua.operators.OperatorBase.num_qubits" name="num_qubits" signature="abstract property : int">
  ...
  <Function id="qiskit.aqua.operators.OperatorBase.__mul__" name="__mul__" signature="OperatorBase.__mul__(other)">
  ...
  <Function id="qiskit.aqua.operators.OperatorBase.compose" name="compose" signature="abstract OperatorBase.compose(other)">
