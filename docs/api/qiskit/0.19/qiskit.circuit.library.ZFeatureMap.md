...
`ZFeatureMap(feature_dimension, reps=2, data_map_func=None, insert_barriers=False)` [GitHub](https://github.com/qiskit/qiskit/tree/stable/0.14/qiskit/circuit/library/data_preparation/z_feature_map.py "view source code")
...
<span id="qiskit.circuit.library.ZFeatureMap.AND" />

`ZFeatureMap.AND(qr_variables, qb_target, qr_ancillae, flags=None, mct_mode='no-ancilla')`
...
<span id="qiskit.circuit.library.ZFeatureMap.OR" />

`ZFeatureMap.OR(qr_variables, qb_target, qr_ancillae, flags=None, mct_mode='basic')`
...
`ZFeatureMap.append(instruction, qargs=None, cargs=None)`
...
`ZFeatureMap.assign_parameters(param_dict, inplace=False)`
...
`ZFeatureMap.bind_parameters(value_dict)`
...
`ZFeatureMap.cbit_argument_conversion(clbit_representation)`
...
`ZFeatureMap.ccx(control_qubit1, control_qubit2, target_qubit, *, ctl1=None, ctl2=None, tgt=None)`
...
`ZFeatureMap.ch(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)`
...
`ZFeatureMap.cnot(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)`
...
`ZFeatureMap.compose(other, qubits=None, clbits=None, front=False, inplace=False)`
...
`ZFeatureMap.crx(theta, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)`
...
`ZFeatureMap.cry(theta, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)`
...
`ZFeatureMap.crz(theta, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)`
...
`ZFeatureMap.cswap(control_qubit, target_qubit1, target_qubit2, *, label=None, ctrl_state=None, ctl=None, tgt1=None, tgt2=None)`
...
`ZFeatureMap.cu1(theta, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)`
...
`ZFeatureMap.cu3(theta, phi, lam, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)`
...
`ZFeatureMap.cx(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)`
...
`ZFeatureMap.cy(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)`
...
`ZFeatureMap.cz(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)`
...
`ZFeatureMap.diagonal(diag, qubit)`
...
`ZFeatureMap.draw(output=None, scale=0.7, filename=None, style=None, interactive=False, line_length=None, plot_barriers=True, reverse_bits=False, justify=None, vertical_compression='medium', idle_wires=True, with_layout=True, fold=None, ax=None, initial_state=False, cregbundle=False)`
...
`ZFeatureMap.fredkin(control_qubit, target_qubit1, target_qubit2, *, ctl=None, tgt1=None, tgt2=None)`
...
`static ZFeatureMap.from_qasm_file(path)`
...
`static ZFeatureMap.from_qasm_str(qasm_str)`
...
`ZFeatureMap.get_entangler_map(rep_num, block_num, num_block_qubits)`
...
`ZFeatureMap.has_register(register)`
...
`ZFeatureMap.iso(isometry, q_input, q_ancillas_for_output, q_ancillas_zero=None, q_ancillas_dirty=None)`
...
`ZFeatureMap.isometry(isometry, q_input, q_ancillas_for_output, q_ancillas_zero=None, q_ancillas_dirty=None)`
...
`ZFeatureMap.iswap(qubit1, qubit2)`
...
`ZFeatureMap.mcmt(gate, control_qubits, target_qubits, ancilla_qubits=None, mode='no-ancilla', *, single_control_gate_fun=None, q_controls=None, q_ancillae=None, q_targets=None)`
...
`ZFeatureMap.mcrx(theta, q_controls, q_target, use_basis_gates=False)`
...
`ZFeatureMap.mcry(theta, q_controls, q_target, q_ancillae, mode='basic', use_basis_gates=False)`
...
`ZFeatureMap.mcrz(lam, q_controls, q_target, use_basis_gates=False)`
...
`ZFeatureMap.mcx(control_qubits, target_qubit, ancilla_qubits=None, mode='noancilla')`
...
`ZFeatureMap.measure(qubit, cbit)`
...
`ZFeatureMap.measure_active(inplace=True)`
...
`ZFeatureMap.measure_all(inplace=True)`
...
`ZFeatureMap.num_connected_components(unitary_only=False)`
...
`ZFeatureMap.qasm(formatted=False, filename=None)`
...
`ZFeatureMap.qbit_argument_conversion(qubit_representation)`
...
`ZFeatureMap.rcccx(control_qubit1, control_qubit2, control_qubit3, target_qubit)`
...
`ZFeatureMap.rccx(control_qubit1, control_qubit2, target_qubit)`
...
`ZFeatureMap.remove_final_measurements(inplace=True)`
...
`ZFeatureMap.rx(theta, qubit, *, label=None, q=None)`
...
`ZFeatureMap.rxx(theta, qubit1, qubit2)`
...
`ZFeatureMap.ry(theta, qubit, *, label=None, q=None)`
...
`ZFeatureMap.ryy(theta, qubit1, qubit2)`
...
`ZFeatureMap.rz(phi, qubit, *, q=None)`
...
`ZFeatureMap.rzx(theta, qubit1, qubit2)`
...
`ZFeatureMap.rzz(theta, qubit1, qubit2)`
...
`ZFeatureMap.snapshot(label, snapshot_type='statevector', qubits=None, params=None)`
...
`ZFeatureMap.snapshot_density_matrix(label, qubits=None)`
...
`ZFeatureMap.snapshot_expectation_value(label, op, qubits, single_shot=False, variance=False)`
...
`ZFeatureMap.snapshot_probabilities(label, qubits, variance=False)`
...
`ZFeatureMap.snapshot_stabilizer(label)`
...
`ZFeatureMap.snapshot_statevector(label)`
...
`ZFeatureMap.squ(unitary_matrix, qubit, mode='ZYZ', up_to_diagonal=False, *, u=None)`
...
`ZFeatureMap.swap(qubit1, qubit2)`
...
`ZFeatureMap.to_gate(parameter_map=None)`
...
`ZFeatureMap.to_instruction(parameter_map=None)`
...
`ZFeatureMap.toffoli(control_qubit1, control_qubit2, target_qubit, *, ctl1=None, ctl2=None, tgt=None)`
...
`ZFeatureMap.u1(theta, qubit, *, q=None)`
...
`ZFeatureMap.u2(phi, lam, qubit, *, q=None)`
...
`ZFeatureMap.u3(theta, phi, lam, qubit, *, q=None)`
...
`ZFeatureMap.uc(gate_list, q_controls, q_target, up_to_diagonal=False)`
...
`ZFeatureMap.ucrx(angle_list, q_controls, q_target)`
...
`ZFeatureMap.ucry(angle_list, q_controls, q_target)`
...
`ZFeatureMap.ucrz(angle_list, q_controls, q_target)`
...
`ZFeatureMap.x(qubit, *, label=None, ctrl_state=None, q=None)`
