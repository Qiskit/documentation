---
title: UnitaryGate (v0.19)
description: API reference for qiskit.extensions.UnitaryGate in qiskit v0.19
...
<Class id="qiskit.extensions.UnitaryGate" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.14/qiskit/extensions/unitary.py" signature="UnitaryGate(data, label=None)" modifiers="class">
  ...
  **ExtensionError** – if input data is not an N-qubit unitary operator.
  ...
  <span id="unitarygate-decompositions" />
  ...
  <span id="unitarygate-definition" />
  ...
  <span id="unitarygate-label" />

  ### label

  <Attribute id="qiskit.extensions.UnitaryGate.label" attributeTypeHint="str">
    Return gate label
  ...
  <span id="unitarygate-add-decomposition" />
  ...
  <span id="unitarygate-broadcast-arguments" />
  ...
  <span id="unitarygate-is-parameterized" />
