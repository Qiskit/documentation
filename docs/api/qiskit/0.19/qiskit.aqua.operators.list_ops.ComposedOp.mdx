---
title: ComposedOp (v0.19)
description: API reference for qiskit.aqua.operators.list_ops.ComposedOp in qiskit v0.19
...
<Class id="qiskit.aqua.operators.list_ops.ComposedOp" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.7/qiskit/aqua/operators/list_ops/composed_op.py" signature="ComposedOp(oplist, coeff=1.0, abelian=False)" modifiers="class">
  ...
  *   **abelian** (`bool`) – Indicates whether the Operators in `oplist` are known to mutually commute.
  ...
  <span id="composedop-distributive" />
  ...
  <span id="composedop-assign-parameters" />
  ...
  <span id="composedop-bind-parameters" />
  ...
  <span id="composedop-non-distributive-reduce" />
  ...
  <span id="composedop-primitive-strings" />
  ...
  <span id="composedop-tensorpower" />
  ...
  <span id="composedop-to-circuit-op" />
  ...
  <span id="composedop-to-legacy-op" />
  ...
  <span id="composedop-to-matrix-op" />
  ...
  <span id="composedop-to-pauli-op" />
  ...
  <span id="composedop-to-spmatrix" />
