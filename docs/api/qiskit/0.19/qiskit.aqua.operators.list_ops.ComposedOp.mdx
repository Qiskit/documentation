...
<Class id="qiskit.aqua.operators.list_ops.ComposedOp" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.7/qiskit/aqua/operators/list_ops/composed_op.py" signature="ComposedOp(oplist, coeff=1.0, abelian=False)">
  ...
  *   **abelian** (`bool`) – Indicates whether the Operators in `oplist` are known to mutually commute.
  ...
  <Attribute id="qiskit.aqua.operators.list_ops.ComposedOp.abelian" signature="bool">
  ...
  <Attribute id="qiskit.aqua.operators.list_ops.ComposedOp.coeff" signature="Union[int, float, complex, qiskit.circuit.parameterexpression.ParameterExpression]">
  ...
  <Attribute id="qiskit.aqua.operators.list_ops.ComposedOp.combo_fn" signature="Callable">
  ...
  <Attribute id="qiskit.aqua.operators.list_ops.ComposedOp.distributive" signature="bool">
  ...
  <Attribute id="qiskit.aqua.operators.list_ops.ComposedOp.num_qubits" signature="int">
  ...
  <Attribute id="qiskit.aqua.operators.list_ops.ComposedOp.oplist" signature="List[qiskit.aqua.operators.operator_base.OperatorBase]">
