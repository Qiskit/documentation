...
<Class id="qiskit.aqua.operators.list_ops.ComposedOp" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.7/qiskit/aqua/operators/list_ops/composed_op.py" signature="ComposedOp(oplist, coeff=1.0, abelian=False)">
  ...
  *   **abelian** (`bool`) – Indicates whether the Operators in `oplist` are known to mutually commute.
  ...
  <Attribute id="qiskit.aqua.operators.list_ops.ComposedOp.abelian" name="abelian" signature="bool">
  ...
  <Attribute id="qiskit.aqua.operators.list_ops.ComposedOp.coeff" name="coeff" signature="Union[int, float, complex, qiskit.circuit.parameterexpression.ParameterExpression]">
  ...
  <Attribute id="qiskit.aqua.operators.list_ops.ComposedOp.combo_fn" name="combo_fn" signature="Callable">
  ...
  <Attribute id="qiskit.aqua.operators.list_ops.ComposedOp.distributive" name="distributive" signature="bool">
  ...
  <Attribute id="qiskit.aqua.operators.list_ops.ComposedOp.num_qubits" name="num_qubits" signature="int">
  ...
  <Attribute id="qiskit.aqua.operators.list_ops.ComposedOp.oplist" name="oplist" signature="List[qiskit.aqua.operators.operator_base.OperatorBase]">
  ...
  <Function id="qiskit.aqua.operators.list_ops.ComposedOp.__getitem__" name="__getitem__" signature="ComposedOp.__getitem__(offset)">
  ...
  <Function id="qiskit.aqua.operators.list_ops.ComposedOp.__len__" name="__len__" signature="ComposedOp.__len__()">
    Length of `oplist`.
  ...
  <Function id="qiskit.aqua.operators.list_ops.ComposedOp.__mul__" name="__mul__" signature="ComposedOp.__mul__(other)">
  ...
  <Function id="qiskit.aqua.operators.list_ops.ComposedOp.compose" name="compose" signature="ComposedOp.compose(other)">
