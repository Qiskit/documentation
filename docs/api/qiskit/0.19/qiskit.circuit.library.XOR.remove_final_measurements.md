...
description: API reference for qiskit.circuit.library.XOR.remove_final_measurements
in_page_toc_min_heading_level: 1
python_api_type: method
python_api_name: qiskit.circuit.library.XOR.remove_final_measurements
---
...
`XOR.remove_final_measurements(inplace=True)`
