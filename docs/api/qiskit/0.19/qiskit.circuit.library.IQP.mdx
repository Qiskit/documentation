---
title: IQP (v0.19)
description: API reference for qiskit.circuit.library.IQP in qiskit v0.19
...
<Class id="qiskit.circuit.library.IQP" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.14/qiskit/circuit/library/iqp.py" signature="IQP(interactions)" modifiers="class">
  ...
  **Reference Circuit:**
  ...
  ![../\_images/qiskit.circuit.library.IQP\_0\_2.png](/docs/images/api/qiskit/0.19/qiskit.circuit.library.IQP_0_2.avif)
  ...
  **CircuitError** – if the inputs is not as symmetric matrix.
  ...
  <span id="iqp-instances" />

  ### instances

  <Attribute id="qiskit.circuit.library.IQP.instances" attributeValue="8" />

  <span id="iqp-n-qubits" />

  ### n\_qubits

  <Attribute id="qiskit.circuit.library.IQP.n_qubits">
    Deprecated, use `num_qubits` instead. Return number of qubits.
  </Attribute>

  <span id="iqp-num-clbits" />
  ...
  <Function id="qiskit.circuit.library.IQP.AND" signature="IQP.AND(qr_variables, qb_target, qr_ancillae, flags=None, mct_mode='no-ancilla')">
  ...
  <Function id="qiskit.circuit.library.IQP.OR" signature="IQP.OR(qr_variables, qb_target, qr_ancillae, flags=None, mct_mode='basic')">
  ...
  <Function id="qiskit.circuit.library.IQP.__getitem__" signature="IQP.__getitem__(item)">
  ...
  <Function id="qiskit.circuit.library.IQP.__len__" signature="IQP.__len__()">
    Return number of operations in circuit.
  </Function>

  <span id="iqp-add-register" />

  ### add\_register

  <Function id="qiskit.circuit.library.IQP.add_register" signature="IQP.add_register(*regs)">
    Add registers.
  </Function>
  ...
  <Function id="qiskit.circuit.library.IQP.append" signature="IQP.append(instruction, qargs=None, cargs=None)">
  ...
  <span id="iqp-assign-parameters" />

  ### assign\_parameters

  <Function id="qiskit.circuit.library.IQP.assign_parameters" signature="IQP.assign_parameters(param_dict, inplace=False)">
  ...
  <Function id="qiskit.circuit.library.IQP.barrier" signature="IQP.barrier(*qargs)">
    Apply `Barrier`. If qargs is None, applies to all.
  </Function>

  <span id="iqp-bind-parameters" />

  ### bind\_parameters

  <Function id="qiskit.circuit.library.IQP.bind_parameters" signature="IQP.bind_parameters(value_dict)">
  ...
  <Function id="qiskit.circuit.library.IQP.cast" signature="IQP.cast(value, _type)" modifiers="static">
    Best effort to cast value to type. Otherwise, returns the value.
  </Function>

  <span id="iqp-cbit-argument-conversion" />

  ### cbit\_argument\_conversion

  <Function id="qiskit.circuit.library.IQP.cbit_argument_conversion" signature="IQP.cbit_argument_conversion(clbit_representation)">
  ...
  <Function id="qiskit.circuit.library.IQP.ccx" signature="IQP.ccx(control_qubit1, control_qubit2, target_qubit, *, ctl1=None, ctl2=None, tgt=None)">
  ...
  <Function id="qiskit.circuit.library.IQP.ch" signature="IQP.ch(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CHGate`](qiskit.circuit.library.CHGate "qiskit.circuit.library.CHGate").
  </Function>

  <span id="iqp-cls-instances" />

  ### cls\_instances

  <Function id="qiskit.circuit.library.IQP.cls_instances" signature="IQP.cls_instances()" modifiers="classmethod">
    Return the current number of instances of this class, useful for auto naming.
  </Function>

  <span id="iqp-cls-prefix" />

  ### cls\_prefix

  <Function id="qiskit.circuit.library.IQP.cls_prefix" signature="IQP.cls_prefix()" modifiers="classmethod">
  ...
  <Function id="qiskit.circuit.library.IQP.cnot" signature="IQP.cnot(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
  ...
  <Function id="qiskit.circuit.library.IQP.combine" signature="IQP.combine(rhs)">
  ...
  <Function id="qiskit.circuit.library.IQP.compose" signature="IQP.compose(other, qubits=None, clbits=None, front=False, inplace=False)">
  ...
  <Function id="qiskit.circuit.library.IQP.copy" signature="IQP.copy(name=None)">
    Copy the circuit.
  ...
  <span id="iqp-count-ops" />

  ### count\_ops

  <Function id="qiskit.circuit.library.IQP.count_ops" signature="IQP.count_ops()">
  ...
  <Function id="qiskit.circuit.library.IQP.crx" signature="IQP.crx(theta, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
  ...
  <Function id="qiskit.circuit.library.IQP.cry" signature="IQP.cry(theta, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
  ...
  <Function id="qiskit.circuit.library.IQP.crz" signature="IQP.crz(theta, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
  ...
  <Function id="qiskit.circuit.library.IQP.cswap" signature="IQP.cswap(control_qubit, target_qubit1, target_qubit2, *, label=None, ctrl_state=None, ctl=None, tgt1=None, tgt2=None)">
  ...
  <Function id="qiskit.circuit.library.IQP.cu1" signature="IQP.cu1(theta, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
  ...
  <Function id="qiskit.circuit.library.IQP.cu3" signature="IQP.cu3(theta, phi, lam, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
  ...
  <Function id="qiskit.circuit.library.IQP.cx" signature="IQP.cx(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CXGate`](qiskit.circuit.library.CXGate "qiskit.circuit.library.CXGate").
  </Function>
  ...
  <Function id="qiskit.circuit.library.IQP.cy" signature="IQP.cy(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
  ...
  <Function id="qiskit.circuit.library.IQP.cz" signature="IQP.cz(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
  ...
  <Function id="qiskit.circuit.library.IQP.dcx" signature="IQP.dcx(qubit1, qubit2)">
    Apply [`DCXGate`](qiskit.circuit.library.DCXGate "qiskit.circuit.library.DCXGate").
  </Function>

  <span id="iqp-decompose" />

  ### decompose

  <Function id="qiskit.circuit.library.IQP.decompose" signature="IQP.decompose()">
  ...
  <Function id="qiskit.circuit.library.IQP.depth" signature="IQP.depth()">
  ...
  <span id="iqp-diag-gate" />

  ### diag\_gate

  <Function id="qiskit.circuit.library.IQP.diag_gate" signature="IQP.diag_gate(diag, qubit)">
    Deprecated version of QuantumCircuit.diagonal.
  </Function>

  <span id="iqp-diagonal" />

  ### diagonal

  <Function id="qiskit.circuit.library.IQP.diagonal" signature="IQP.diagonal(diag, qubit)">
  ...
  <Function id="qiskit.circuit.library.IQP.extend" signature="IQP.extend(rhs)">
  ...
  <Function id="qiskit.circuit.library.IQP.fredkin" signature="IQP.fredkin(control_qubit, target_qubit1, target_qubit2, *, ctl=None, tgt1=None, tgt2=None)">
    Apply [`CSwapGate`](qiskit.circuit.library.CSwapGate "qiskit.circuit.library.CSwapGate").
  </Function>

  <span id="iqp-from-qasm-file" />

  ### from\_qasm\_file

  <Function id="qiskit.circuit.library.IQP.from_qasm_file" signature="IQP.from_qasm_file(path)" modifiers="static">
  ...
  <span id="iqp-from-qasm-str" />

  ### from\_qasm\_str

  <Function id="qiskit.circuit.library.IQP.from_qasm_str" signature="IQP.from_qasm_str(qasm_str)" modifiers="static">
  ...
  <Function id="qiskit.circuit.library.IQP.h" signature="IQP.h(qubit, *, q=None)">
    Apply [`HGate`](qiskit.circuit.library.HGate "qiskit.circuit.library.HGate").
  </Function>

  <span id="iqp-hamiltonian" />

  ### hamiltonian

  <Function id="qiskit.circuit.library.IQP.hamiltonian" signature="IQP.hamiltonian(operator, time, qubits, label=None)">
    Apply hamiltonian evolution to to qubits.
  </Function>

  <span id="iqp-has-register" />

  ### has\_register

  <Function id="qiskit.circuit.library.IQP.has_register" signature="IQP.has_register(register)">
  ...
  <Function id="qiskit.circuit.library.IQP.i" signature="IQP.i(qubit, *, q=None)">
  ...
  <Function id="qiskit.circuit.library.IQP.id" signature="IQP.id(qubit, *, q=None)">
    Apply [`IGate`](qiskit.circuit.library.IGate "qiskit.circuit.library.IGate").
  </Function>
  ...
  <Function id="qiskit.circuit.library.IQP.iden" signature="IQP.iden(qubit, *, q=None)">
    Deprecated identity gate.
  </Function>

  <span id="iqp-initialize" />

  ### initialize

  <Function id="qiskit.circuit.library.IQP.initialize" signature="IQP.initialize(params, qubits)">
  ...
  <Function id="qiskit.circuit.library.IQP.inverse" signature="IQP.inverse()">
    Invert this circuit.
  ...
  <Function id="qiskit.circuit.library.IQP.iso" signature="IQP.iso(isometry, q_input, q_ancillas_for_output, q_ancillas_zero=None, q_ancillas_dirty=None)">
  ...
  <span id="iqp-isometry" />

  ### isometry

  <Function id="qiskit.circuit.library.IQP.isometry" signature="IQP.isometry(isometry, q_input, q_ancillas_for_output, q_ancillas_zero=None, q_ancillas_dirty=None)">
    Attach an arbitrary isometry from m to n qubits to a circuit. In particular, this allows to attach arbitrary unitaries on n qubits (m=n) or to prepare any state on n qubits (m=0). The decomposition used here was introduced by Iten et al. in [https://arxiv.org/abs/1501.06911](https://arxiv.org/abs/1501.06911).
  ...
  <Function id="qiskit.circuit.library.IQP.iswap" signature="IQP.iswap(qubit1, qubit2)">
  ...
  <Function id="qiskit.circuit.library.IQP.mcmt" signature="IQP.mcmt(gate, control_qubits, target_qubits, ancilla_qubits=None, mode='no-ancilla', *, single_control_gate_fun=None, q_controls=None, q_ancillae=None, q_targets=None)">
  ...
  <Function id="qiskit.circuit.library.IQP.mcrx" signature="IQP.mcrx(theta, q_controls, q_target, use_basis_gates=False)">
  ...
  <Function id="qiskit.circuit.library.IQP.mcry" signature="IQP.mcry(theta, q_controls, q_target, q_ancillae, mode='basic', use_basis_gates=False)">
  ...
  <Function id="qiskit.circuit.library.IQP.mcrz" signature="IQP.mcrz(lam, q_controls, q_target, use_basis_gates=False)">
  ...
  <Function id="qiskit.circuit.library.IQP.mct" signature="IQP.mct(control_qubits, target_qubit, ancilla_qubits=None, mode='noancilla')">
    Apply `MCXGate`.
  </Function>
  ...
  <Function id="qiskit.circuit.library.IQP.mcu1" signature="IQP.mcu1(lam, control_qubits, target_qubit)">
    Apply `MCU1Gate`.
  </Function>
  ...
  <Function id="qiskit.circuit.library.IQP.mcx" signature="IQP.mcx(control_qubits, target_qubit, ancilla_qubits=None, mode='noancilla')">
    Apply `MCXGate`.
  ...
  <Function id="qiskit.circuit.library.IQP.measure" signature="IQP.measure(qubit, cbit)">
  ...
  <span id="iqp-measure-active" />

  ### measure\_active

  <Function id="qiskit.circuit.library.IQP.measure_active" signature="IQP.measure_active(inplace=True)">
  ...
  <span id="iqp-measure-all" />

  ### measure\_all

  <Function id="qiskit.circuit.library.IQP.measure_all" signature="IQP.measure_all(inplace=True)">
  ...
  <Function id="qiskit.circuit.library.IQP.mirror" signature="IQP.mirror()">
  ...
  <Function id="qiskit.circuit.library.IQP.ms" signature="IQP.ms(theta, qubits)">
    Apply [`MSGate`](qiskit.circuit.library.MSGate "qiskit.circuit.library.MSGate").
  </Function>

  <span id="iqp-num-connected-components" />

  ### num\_connected\_components

  <Function id="qiskit.circuit.library.IQP.num_connected_components" signature="IQP.num_connected_components(unitary_only=False)">
  ...
  <span id="iqp-num-nonlocal-gates" />

  ### num\_nonlocal\_gates

  <Function id="qiskit.circuit.library.IQP.num_nonlocal_gates" signature="IQP.num_nonlocal_gates()">
    Return number of non-local gates (i.e. involving 2+ qubits).

    Conditional nonlocal gates are also included.
  </Function>

  <span id="iqp-num-tensor-factors" />

  ### num\_tensor\_factors

  <Function id="qiskit.circuit.library.IQP.num_tensor_factors" signature="IQP.num_tensor_factors()">
  ...
  <span id="iqp-num-unitary-factors" />

  ### num\_unitary\_factors

  <Function id="qiskit.circuit.library.IQP.num_unitary_factors" signature="IQP.num_unitary_factors()">
    Computes the number of tensor factors in the unitary (quantum) part of the circuit only.
  </Function>
  ...
  <Function id="qiskit.circuit.library.IQP.qasm" signature="IQP.qasm(formatted=False, filename=None)">
  ...
  <span id="iqp-qbit-argument-conversion" />

  ### qbit\_argument\_conversion

  <Function id="qiskit.circuit.library.IQP.qbit_argument_conversion" signature="IQP.qbit_argument_conversion(qubit_representation)">
  ...
  <Function id="qiskit.circuit.library.IQP.r" signature="IQP.r(theta, phi, qubit, *, q=None)">
    Apply `RGate`.
  </Function>
  ...
  <Function id="qiskit.circuit.library.IQP.rcccx" signature="IQP.rcccx(control_qubit1, control_qubit2, control_qubit3, target_qubit)">
  ...
  <Function id="qiskit.circuit.library.IQP.rccx" signature="IQP.rccx(control_qubit1, control_qubit2, target_qubit)">
    Apply [`RCCXGate`](qiskit.circuit.library.RCCXGate "qiskit.circuit.library.RCCXGate").
  </Function>

  <span id="iqp-remove-final-measurements" />

  ### remove\_final\_measurements

  <Function id="qiskit.circuit.library.IQP.remove_final_measurements" signature="IQP.remove_final_measurements(inplace=True)">
  ...
  <Function id="qiskit.circuit.library.IQP.reset" signature="IQP.reset(qubit)">
    Reset q.
  </Function>
  ...
  <Function id="qiskit.circuit.library.IQP.rx" signature="IQP.rx(theta, qubit, *, label=None, q=None)">
  ...
  <Function id="qiskit.circuit.library.IQP.rxx" signature="IQP.rxx(theta, qubit1, qubit2)">
  ...
  <Function id="qiskit.circuit.library.IQP.ry" signature="IQP.ry(theta, qubit, *, label=None, q=None)">
  ...
  <Function id="qiskit.circuit.library.IQP.ryy" signature="IQP.ryy(theta, qubit1, qubit2)">
  ...
  <Function id="qiskit.circuit.library.IQP.rz" signature="IQP.rz(phi, qubit, *, q=None)">
  ...
  <Function id="qiskit.circuit.library.IQP.rzx" signature="IQP.rzx(theta, qubit1, qubit2)">
  ...
  <Function id="qiskit.circuit.library.IQP.rzz" signature="IQP.rzz(theta, qubit1, qubit2)">
  ...
  <Function id="qiskit.circuit.library.IQP.s" signature="IQP.s(qubit, *, q=None)">
  ...
  <Function id="qiskit.circuit.library.IQP.sdg" signature="IQP.sdg(qubit, *, q=None)">
  ...
  <Function id="qiskit.circuit.library.IQP.size" signature="IQP.size()">
  ...
  <span id="iqp-snapshot" />

  ### snapshot

  <Function id="qiskit.circuit.library.IQP.snapshot" signature="IQP.snapshot(label, snapshot_type='statevector', qubits=None, params=None)">
  ...
  <span id="iqp-snapshot-density-matrix" />

  ### snapshot\_density\_matrix

  <Function id="qiskit.circuit.library.IQP.snapshot_density_matrix" signature="IQP.snapshot_density_matrix(label, qubits=None)">
  ...
  <span id="iqp-snapshot-expectation-value" />

  ### snapshot\_expectation\_value

  <Function id="qiskit.circuit.library.IQP.snapshot_expectation_value" signature="IQP.snapshot_expectation_value(label, op, qubits, single_shot=False, variance=False)">
  ...
  <span id="iqp-snapshot-probabilities" />

  ### snapshot\_probabilities

  <Function id="qiskit.circuit.library.IQP.snapshot_probabilities" signature="IQP.snapshot_probabilities(label, qubits, variance=False)">
  ...
  <span id="iqp-snapshot-stabilizer" />

  ### snapshot\_stabilizer

  <Function id="qiskit.circuit.library.IQP.snapshot_stabilizer" signature="IQP.snapshot_stabilizer(label)">
  ...
  <span id="iqp-snapshot-statevector" />

  ### snapshot\_statevector

  <Function id="qiskit.circuit.library.IQP.snapshot_statevector" signature="IQP.snapshot_statevector(label)">
  ...
  <Function id="qiskit.circuit.library.IQP.squ" signature="IQP.squ(unitary_matrix, qubit, mode='ZYZ', up_to_diagonal=False, *, u=None)">
  ...
  <Function id="qiskit.circuit.library.IQP.swap" signature="IQP.swap(qubit1, qubit2)">
  ...
  <Function id="qiskit.circuit.library.IQP.t" signature="IQP.t(qubit, *, q=None)">
  ...
  <Function id="qiskit.circuit.library.IQP.tdg" signature="IQP.tdg(qubit, *, q=None)">
  ...
  <Function id="qiskit.circuit.library.IQP.to_gate" signature="IQP.to_gate(parameter_map=None)">
  ...
  <span id="iqp-to-instruction" />

  ### to\_instruction

  <Function id="qiskit.circuit.library.IQP.to_instruction" signature="IQP.to_instruction(parameter_map=None)">
  ...
  <Function id="qiskit.circuit.library.IQP.toffoli" signature="IQP.toffoli(control_qubit1, control_qubit2, target_qubit, *, ctl1=None, ctl2=None, tgt=None)">
    Apply [`CCXGate`](qiskit.circuit.library.CCXGate "qiskit.circuit.library.CCXGate").
  </Function>
  ...
  <Function id="qiskit.circuit.library.IQP.u1" signature="IQP.u1(theta, qubit, *, q=None)">
  ...
  <Function id="qiskit.circuit.library.IQP.u2" signature="IQP.u2(phi, lam, qubit, *, q=None)">
  ...
  <Function id="qiskit.circuit.library.IQP.u3" signature="IQP.u3(theta, phi, lam, qubit, *, q=None)">
  ...
  <Function id="qiskit.circuit.library.IQP.uc" signature="IQP.uc(gate_list, q_controls, q_target, up_to_diagonal=False)">
  ...
  <Function id="qiskit.circuit.library.IQP.ucg" signature="IQP.ucg(angle_list, q_controls, q_target, up_to_diagonal=False)">
  ...
  <Function id="qiskit.circuit.library.IQP.ucrx" signature="IQP.ucrx(angle_list, q_controls, q_target)">
  ...
  <Function id="qiskit.circuit.library.IQP.ucry" signature="IQP.ucry(angle_list, q_controls, q_target)">
  ...
  <Function id="qiskit.circuit.library.IQP.ucrz" signature="IQP.ucrz(angle_list, q_controls, q_target)">
  ...
  <Function id="qiskit.circuit.library.IQP.ucx" signature="IQP.ucx(angle_list, q_controls, q_target)">
  ...
  <Function id="qiskit.circuit.library.IQP.ucy" signature="IQP.ucy(angle_list, q_controls, q_target)">
  ...
  <Function id="qiskit.circuit.library.IQP.ucz" signature="IQP.ucz(angle_list, q_controls, q_target)">
  ...
  <Function id="qiskit.circuit.library.IQP.unitary" signature="IQP.unitary(obj, qubits, label=None)">
  ...
  <Function id="qiskit.circuit.library.IQP.width" signature="IQP.width()">
  ...
  <Function id="qiskit.circuit.library.IQP.x" signature="IQP.x(qubit, *, label=None, ctrl_state=None, q=None)">
  ...
  <Function id="qiskit.circuit.library.IQP.y" signature="IQP.y(qubit, *, q=None)">
  ...
  <Function id="qiskit.circuit.library.IQP.z" signature="IQP.z(qubit, *, q=None)">
