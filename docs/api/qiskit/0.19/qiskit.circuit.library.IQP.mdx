...
`IQP(interactions)` [GitHub](https://github.com/qiskit/qiskit/tree/stable/0.14/qiskit/circuit/library/iqp.py "view source code")
...
<span id="qiskit.circuit.library.IQP.AND" />

`IQP.AND(qr_variables, qb_target, qr_ancillae, flags=None, mct_mode='no-ancilla')`
...
<span id="qiskit.circuit.library.IQP.OR" />

`IQP.OR(qr_variables, qb_target, qr_ancillae, flags=None, mct_mode='basic')`
...
`IQP.append(instruction, qargs=None, cargs=None)`
...
`IQP.assign_parameters(param_dict, inplace=False)`
...
`IQP.cbit_argument_conversion(clbit_representation)`
...
`IQP.ccx(control_qubit1, control_qubit2, target_qubit, *, ctl1=None, ctl2=None, tgt=None)`
...
`IQP.cnot(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)`
...
`IQP.compose(other, qubits=None, clbits=None, front=False, inplace=False)`
...
`IQP.crx(theta, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)`
...
`IQP.cry(theta, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)`
...
`IQP.crz(theta, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)`
...
`IQP.cswap(control_qubit, target_qubit1, target_qubit2, *, label=None, ctrl_state=None, ctl=None, tgt1=None, tgt2=None)`
...
`IQP.cu1(theta, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)`
...
`IQP.cu3(theta, phi, lam, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)`
...
`IQP.cx(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)`
...
`IQP.cy(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)`
...
`IQP.cz(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)`
...
`IQP.draw(output=None, scale=0.7, filename=None, style=None, interactive=False, line_length=None, plot_barriers=True, reverse_bits=False, justify=None, vertical_compression='medium', idle_wires=True, with_layout=True, fold=None, ax=None, initial_state=False, cregbundle=False)`
...
`IQP.fredkin(control_qubit, target_qubit1, target_qubit2, *, ctl=None, tgt1=None, tgt2=None)`
...
`static IQP.from_qasm_file(path)`
...
`static IQP.from_qasm_str(qasm_str)`
...
`IQP.iso(isometry, q_input, q_ancillas_for_output, q_ancillas_zero=None, q_ancillas_dirty=None)`
...
`IQP.isometry(isometry, q_input, q_ancillas_for_output, q_ancillas_zero=None, q_ancillas_dirty=None)`
...
`IQP.mcmt(gate, control_qubits, target_qubits, ancilla_qubits=None, mode='no-ancilla', *, single_control_gate_fun=None, q_controls=None, q_ancillae=None, q_targets=None)`
...
`IQP.mcrx(theta, q_controls, q_target, use_basis_gates=False)`
...
`IQP.mcry(theta, q_controls, q_target, q_ancillae, mode='basic', use_basis_gates=False)`
...
`IQP.mcrz(lam, q_controls, q_target, use_basis_gates=False)`
...
`IQP.mcx(control_qubits, target_qubit, ancilla_qubits=None, mode='noancilla')`
...
`IQP.measure_active(inplace=True)`
...
`IQP.num_connected_components(unitary_only=False)`
...
`IQP.qasm(formatted=False, filename=None)`
...
`IQP.qbit_argument_conversion(qubit_representation)`
...
`IQP.rcccx(control_qubit1, control_qubit2, control_qubit3, target_qubit)`
...
`IQP.rccx(control_qubit1, control_qubit2, target_qubit)`
...
`IQP.remove_final_measurements(inplace=True)`
...
`IQP.rx(theta, qubit, *, label=None, q=None)`
...
`IQP.ry(theta, qubit, *, label=None, q=None)`
...
`IQP.snapshot(label, snapshot_type='statevector', qubits=None, params=None)`
...
`IQP.snapshot_density_matrix(label, qubits=None)`
...
`IQP.snapshot_expectation_value(label, op, qubits, single_shot=False, variance=False)`
...
`IQP.snapshot_probabilities(label, qubits, variance=False)`
...
`IQP.squ(unitary_matrix, qubit, mode='ZYZ', up_to_diagonal=False, *, u=None)`
...
`IQP.to_gate(parameter_map=None)`
...
`IQP.to_instruction(parameter_map=None)`
...
`IQP.toffoli(control_qubit1, control_qubit2, target_qubit, *, ctl1=None, ctl2=None, tgt=None)`
...
`IQP.uc(gate_list, q_controls, q_target, up_to_diagonal=False)`
...
`IQP.x(qubit, *, label=None, ctrl_state=None, q=None)`
