...
<Class id="qiskit.circuit.library.IQP" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.14/qiskit/circuit/library/iqp.py" signature="IQP(interactions)">
  ...
  **CircuitError** – if the inputs is not as symmetric matrix.
  ...
  <Function id="qiskit.circuit.library.IQP.cast" signature="static IQP.cast(value, _type)">
  ...
  <Function id="qiskit.circuit.library.IQP.cls_instances" signature="classmethod IQP.cls_instances()">
    Return the current number of instances of this class, useful for auto naming.
  </Function>

  ### cls\_prefix

  <Function id="qiskit.circuit.library.IQP.cls_prefix" signature="classmethod IQP.cls_prefix()">
  ...
  <Function id="qiskit.circuit.library.IQP.from_qasm_file" signature="static IQP.from_qasm_file(path)">
  ...
  <Function id="qiskit.circuit.library.IQP.from_qasm_str" signature="static IQP.from_qasm_str(qasm_str)">
