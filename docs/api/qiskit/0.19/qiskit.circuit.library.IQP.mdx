...
<Class id="qiskit.circuit.library.IQP" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.14/qiskit/circuit/library/iqp.py" signature="IQP(interactions)">
  ...
  **CircuitError** – if the inputs is not as symmetric matrix.
  ...
  <Attribute id="qiskit.circuit.library.IQP.clbits" name="clbits">
    Returns a list of classical bits in the order that the registers were added.
  </Attribute>

  ### data

  <Attribute id="qiskit.circuit.library.IQP.data" name="data">
  ...
  <Attribute id="qiskit.circuit.library.IQP.extension_lib" signature="= 'include \&#x22;qelib1.inc\&#x22;;'" />

  ### header

  <Attribute id="qiskit.circuit.library.IQP.header" signature="= 'OPENQASM 2.0;'" />

  ### instances

  <Attribute id="qiskit.circuit.library.IQP.instances" signature="= 8" />

  ### n\_qubits

  <Attribute id="qiskit.circuit.library.IQP.n_qubits" name="n_qubits">
    Deprecated, use `num_qubits` instead. Return number of qubits.
  </Attribute>

  ### num\_clbits

  <Attribute id="qiskit.circuit.library.IQP.num_clbits" name="num_clbits">
    Return number of classical bits.
  </Attribute>

  ### num\_parameters

  <Attribute id="qiskit.circuit.library.IQP.num_parameters" name="num_parameters">
    Convenience function to get the number of parameter objects in the circuit.
  </Attribute>

  ### num\_qubits

  <Attribute id="qiskit.circuit.library.IQP.num_qubits" name="num_qubits">
    Return number of qubits.
  </Attribute>

  ### parameters

  <Attribute id="qiskit.circuit.library.IQP.parameters" name="parameters">
    Convenience function to get the parameters defined in the parameter table.
  </Attribute>

  ### prefix

  <Attribute id="qiskit.circuit.library.IQP.prefix" signature="= 'circuit'" />

  ### qubits

  <Attribute id="qiskit.circuit.library.IQP.qubits" name="qubits">
  ...
  <Function id="qiskit.circuit.library.IQP.AND" name="AND" signature="IQP.AND(qr_variables, qb_target, qr_ancillae, flags=None, mct_mode='no-ancilla')">
  ...
  <Function id="qiskit.circuit.library.IQP.OR" name="OR" signature="IQP.OR(qr_variables, qb_target, qr_ancillae, flags=None, mct_mode='basic')">
  ...
  <Function id="qiskit.circuit.library.IQP.__getitem__" name="__getitem__" signature="IQP.__getitem__(item)">
    Return indexed operation.
  </Function>

  ### \_\_len\_\_

  <Function id="qiskit.circuit.library.IQP.__len__" name="__len__" signature="IQP.__len__()">
    Return number of operations in circuit.
  </Function>

  ### add\_register

  <Function id="qiskit.circuit.library.IQP.add_register" name="add_register" signature="IQP.add_register(*regs)">
    Add registers.
  </Function>

  ### append

  <Function id="qiskit.circuit.library.IQP.append" name="append" signature="IQP.append(instruction, qargs=None, cargs=None)">
  ...
  <Function id="qiskit.circuit.library.IQP.assign_parameters" name="assign_parameters" signature="IQP.assign_parameters(param_dict, inplace=False)">
  ...
  <Function id="qiskit.circuit.library.IQP.barrier" name="barrier" signature="IQP.barrier(*qargs)">
    Apply `Barrier`. If qargs is None, applies to all.
  </Function>

  ### bind\_parameters

  <Function id="qiskit.circuit.library.IQP.bind_parameters" name="bind_parameters" signature="IQP.bind_parameters(value_dict)">
  ...
  <Function id="qiskit.circuit.library.IQP.cast" name="cast" signature="static IQP.cast(value, _type)">
    Best effort to cast value to type. Otherwise, returns the value.
  </Function>

  ### cbit\_argument\_conversion

  <Function id="qiskit.circuit.library.IQP.cbit_argument_conversion" name="cbit_argument_conversion" signature="IQP.cbit_argument_conversion(clbit_representation)">
  ...
  <Function id="qiskit.circuit.library.IQP.ccx" name="ccx" signature="IQP.ccx(control_qubit1, control_qubit2, target_qubit, *, ctl1=None, ctl2=None, tgt=None)">
    Apply [`CCXGate`](qiskit.circuit.library.CCXGate "qiskit.circuit.library.CCXGate").
  </Function>

  ### ch

  <Function id="qiskit.circuit.library.IQP.ch" name="ch" signature="IQP.ch(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CHGate`](qiskit.circuit.library.CHGate "qiskit.circuit.library.CHGate").
  </Function>

  ### cls\_instances

  <Function id="qiskit.circuit.library.IQP.cls_instances" name="cls_instances" signature="classmethod IQP.cls_instances()">
    Return the current number of instances of this class, useful for auto naming.
  </Function>

  ### cls\_prefix

  <Function id="qiskit.circuit.library.IQP.cls_prefix" name="cls_prefix" signature="classmethod IQP.cls_prefix()">
    Return the prefix to use for auto naming.
  </Function>

  ### cnot

  <Function id="qiskit.circuit.library.IQP.cnot" name="cnot" signature="IQP.cnot(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CXGate`](qiskit.circuit.library.CXGate "qiskit.circuit.library.CXGate").
  </Function>

  ### combine

  <Function id="qiskit.circuit.library.IQP.combine" name="combine" signature="IQP.combine(rhs)">
  ...
  <Function id="qiskit.circuit.library.IQP.compose" name="compose" signature="IQP.compose(other, qubits=None, clbits=None, front=False, inplace=False)">
  ...
  <Function id="qiskit.circuit.library.IQP.copy" name="copy" signature="IQP.copy(name=None)">
    Copy the circuit.
  ...
  <Function id="qiskit.circuit.library.IQP.count_ops" name="count_ops" signature="IQP.count_ops()">
  ...
  <Function id="qiskit.circuit.library.IQP.crx" name="crx" signature="IQP.crx(theta, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CRXGate`](qiskit.circuit.library.CRXGate "qiskit.circuit.library.CRXGate").
  </Function>

  ### cry

  <Function id="qiskit.circuit.library.IQP.cry" name="cry" signature="IQP.cry(theta, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CRYGate`](qiskit.circuit.library.CRYGate "qiskit.circuit.library.CRYGate").
  </Function>

  ### crz

  <Function id="qiskit.circuit.library.IQP.crz" name="crz" signature="IQP.crz(theta, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CRZGate`](qiskit.circuit.library.CRZGate "qiskit.circuit.library.CRZGate").
  </Function>

  ### cswap

  <Function id="qiskit.circuit.library.IQP.cswap" name="cswap" signature="IQP.cswap(control_qubit, target_qubit1, target_qubit2, *, label=None, ctrl_state=None, ctl=None, tgt1=None, tgt2=None)">
    Apply [`CSwapGate`](qiskit.circuit.library.CSwapGate "qiskit.circuit.library.CSwapGate").
  </Function>

  ### cu1

  <Function id="qiskit.circuit.library.IQP.cu1" name="cu1" signature="IQP.cu1(theta, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CU1Gate`](qiskit.circuit.library.CU1Gate "qiskit.circuit.library.CU1Gate").
  </Function>

  ### cu3

  <Function id="qiskit.circuit.library.IQP.cu3" name="cu3" signature="IQP.cu3(theta, phi, lam, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CU3Gate`](qiskit.circuit.library.CU3Gate "qiskit.circuit.library.CU3Gate").
  </Function>

  ### cx

  <Function id="qiskit.circuit.library.IQP.cx" name="cx" signature="IQP.cx(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CXGate`](qiskit.circuit.library.CXGate "qiskit.circuit.library.CXGate").
  </Function>

  ### cy

  <Function id="qiskit.circuit.library.IQP.cy" name="cy" signature="IQP.cy(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CYGate`](qiskit.circuit.library.CYGate "qiskit.circuit.library.CYGate").
  </Function>

  ### cz

  <Function id="qiskit.circuit.library.IQP.cz" name="cz" signature="IQP.cz(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CZGate`](qiskit.circuit.library.CZGate "qiskit.circuit.library.CZGate").
  </Function>

  ### dcx

  <Function id="qiskit.circuit.library.IQP.dcx" name="dcx" signature="IQP.dcx(qubit1, qubit2)">
    Apply [`DCXGate`](qiskit.circuit.library.DCXGate "qiskit.circuit.library.DCXGate").
  </Function>

  ### decompose

  <Function id="qiskit.circuit.library.IQP.decompose" name="decompose" signature="IQP.decompose()">
  ...
  <Function id="qiskit.circuit.library.IQP.depth" name="depth" signature="IQP.depth()">
  ...
  <Function id="qiskit.circuit.library.IQP.diag_gate" name="diag_gate" signature="IQP.diag_gate(diag, qubit)">
    Deprecated version of QuantumCircuit.diagonal.
  </Function>

  ### diagonal

  <Function id="qiskit.circuit.library.IQP.diagonal" name="diagonal" signature="IQP.diagonal(diag, qubit)">
  ...
  <Function id="qiskit.circuit.library.IQP.extend" name="extend" signature="IQP.extend(rhs)">
  ...
  <Function id="qiskit.circuit.library.IQP.fredkin" name="fredkin" signature="IQP.fredkin(control_qubit, target_qubit1, target_qubit2, *, ctl=None, tgt1=None, tgt2=None)">
    Apply [`CSwapGate`](qiskit.circuit.library.CSwapGate "qiskit.circuit.library.CSwapGate").
  </Function>

  ### from\_qasm\_file

  <Function id="qiskit.circuit.library.IQP.from_qasm_file" name="from_qasm_file" signature="static IQP.from_qasm_file(path)">
  ...
  <Function id="qiskit.circuit.library.IQP.from_qasm_str" name="from_qasm_str" signature="static IQP.from_qasm_str(qasm_str)">
  ...
  <Function id="qiskit.circuit.library.IQP.h" name="h" signature="IQP.h(qubit, *, q=None)">
    Apply [`HGate`](qiskit.circuit.library.HGate "qiskit.circuit.library.HGate").
  </Function>

  ### hamiltonian

  <Function id="qiskit.circuit.library.IQP.hamiltonian" name="hamiltonian" signature="IQP.hamiltonian(operator, time, qubits, label=None)">
    Apply hamiltonian evolution to to qubits.
  </Function>

  ### has\_register

  <Function id="qiskit.circuit.library.IQP.has_register" name="has_register" signature="IQP.has_register(register)">
  ...
  <Function id="qiskit.circuit.library.IQP.i" name="i" signature="IQP.i(qubit, *, q=None)">
    Apply [`IGate`](qiskit.circuit.library.IGate "qiskit.circuit.library.IGate").
  </Function>

  ### id

  <Function id="qiskit.circuit.library.IQP.id" name="id" signature="IQP.id(qubit, *, q=None)">
    Apply [`IGate`](qiskit.circuit.library.IGate "qiskit.circuit.library.IGate").
  </Function>

  ### iden

  <Function id="qiskit.circuit.library.IQP.iden" name="iden" signature="IQP.iden(qubit, *, q=None)">
    Deprecated identity gate.
  </Function>

  ### initialize

  <Function id="qiskit.circuit.library.IQP.initialize" name="initialize" signature="IQP.initialize(params, qubits)">
    Apply initialize to circuit.
  </Function>

  ### inverse

  <Function id="qiskit.circuit.library.IQP.inverse" name="inverse" signature="IQP.inverse()">
    Invert this circuit.
  ...
  <Function id="qiskit.circuit.library.IQP.iso" name="iso" signature="IQP.iso(isometry, q_input, q_ancillas_for_output, q_ancillas_zero=None, q_ancillas_dirty=None)">
  ...
  <Function id="qiskit.circuit.library.IQP.isometry" name="isometry" signature="IQP.isometry(isometry, q_input, q_ancillas_for_output, q_ancillas_zero=None, q_ancillas_dirty=None)">
    Attach an arbitrary isometry from m to n qubits to a circuit. In particular, this allows to attach arbitrary unitaries on n qubits (m=n) or to prepare any state on n qubits (m=0). The decomposition used here was introduced by Iten et al. in [https://arxiv.org/abs/1501.06911](https://arxiv.org/abs/1501.06911).
  ...
  <Function id="qiskit.circuit.library.IQP.iswap" name="iswap" signature="IQP.iswap(qubit1, qubit2)">
    Apply [`iSwapGate`](qiskit.circuit.library.iSwapGate "qiskit.circuit.library.iSwapGate").
  </Function>

  ### mcmt

  <Function id="qiskit.circuit.library.IQP.mcmt" name="mcmt" signature="IQP.mcmt(gate, control_qubits, target_qubits, ancilla_qubits=None, mode='no-ancilla', *, single_control_gate_fun=None, q_controls=None, q_ancillae=None, q_targets=None)">
  ...
  <Function id="qiskit.circuit.library.IQP.mcrx" name="mcrx" signature="IQP.mcrx(theta, q_controls, q_target, use_basis_gates=False)">
  ...
  <Function id="qiskit.circuit.library.IQP.mcry" name="mcry" signature="IQP.mcry(theta, q_controls, q_target, q_ancillae, mode='basic', use_basis_gates=False)">
  ...
  <Function id="qiskit.circuit.library.IQP.mcrz" name="mcrz" signature="IQP.mcrz(lam, q_controls, q_target, use_basis_gates=False)">
  ...
  <Function id="qiskit.circuit.library.IQP.mct" name="mct" signature="IQP.mct(control_qubits, target_qubit, ancilla_qubits=None, mode='noancilla')">
    Apply `MCXGate`.
  </Function>

  ### mcu1

  <Function id="qiskit.circuit.library.IQP.mcu1" name="mcu1" signature="IQP.mcu1(lam, control_qubits, target_qubit)">
    Apply `MCU1Gate`.
  </Function>

  ### mcx

  <Function id="qiskit.circuit.library.IQP.mcx" name="mcx" signature="IQP.mcx(control_qubits, target_qubit, ancilla_qubits=None, mode='noancilla')">
    Apply `MCXGate`.
  ...
  <Function id="qiskit.circuit.library.IQP.measure" name="measure" signature="IQP.measure(qubit, cbit)">
  ...
  <Function id="qiskit.circuit.library.IQP.measure_active" name="measure_active" signature="IQP.measure_active(inplace=True)">
  ...
  <Function id="qiskit.circuit.library.IQP.measure_all" name="measure_all" signature="IQP.measure_all(inplace=True)">
  ...
  <Function id="qiskit.circuit.library.IQP.mirror" name="mirror" signature="IQP.mirror()">
  ...
  <Function id="qiskit.circuit.library.IQP.ms" name="ms" signature="IQP.ms(theta, qubits)">
    Apply [`MSGate`](qiskit.circuit.library.MSGate "qiskit.circuit.library.MSGate").
  </Function>

  ### num\_connected\_components

  <Function id="qiskit.circuit.library.IQP.num_connected_components" name="num_connected_components" signature="IQP.num_connected_components(unitary_only=False)">
  ...
  <Function id="qiskit.circuit.library.IQP.num_nonlocal_gates" name="num_nonlocal_gates" signature="IQP.num_nonlocal_gates()">
  ...
  <Function id="qiskit.circuit.library.IQP.num_tensor_factors" name="num_tensor_factors" signature="IQP.num_tensor_factors()">
  ...
  <Function id="qiskit.circuit.library.IQP.num_unitary_factors" name="num_unitary_factors" signature="IQP.num_unitary_factors()">
    Computes the number of tensor factors in the unitary (quantum) part of the circuit only.
  </Function>

  ### qasm

  <Function id="qiskit.circuit.library.IQP.qasm" name="qasm" signature="IQP.qasm(formatted=False, filename=None)">
  ...
  <Function id="qiskit.circuit.library.IQP.qbit_argument_conversion" name="qbit_argument_conversion" signature="IQP.qbit_argument_conversion(qubit_representation)">
  ...
  <Function id="qiskit.circuit.library.IQP.r" name="r" signature="IQP.r(theta, phi, qubit, *, q=None)">
    Apply `RGate`.
  </Function>

  ### rcccx

  <Function id="qiskit.circuit.library.IQP.rcccx" name="rcccx" signature="IQP.rcccx(control_qubit1, control_qubit2, control_qubit3, target_qubit)">
    Apply [`RC3XGate`](qiskit.circuit.library.RC3XGate "qiskit.circuit.library.RC3XGate").
  </Function>

  ### rccx

  <Function id="qiskit.circuit.library.IQP.rccx" name="rccx" signature="IQP.rccx(control_qubit1, control_qubit2, target_qubit)">
    Apply [`RCCXGate`](qiskit.circuit.library.RCCXGate "qiskit.circuit.library.RCCXGate").
  </Function>

  ### remove\_final\_measurements

  <Function id="qiskit.circuit.library.IQP.remove_final_measurements" name="remove_final_measurements" signature="IQP.remove_final_measurements(inplace=True)">
  ...
  <Function id="qiskit.circuit.library.IQP.reset" name="reset" signature="IQP.reset(qubit)">
    Reset q.
  </Function>

  ### rx

  <Function id="qiskit.circuit.library.IQP.rx" name="rx" signature="IQP.rx(theta, qubit, *, label=None, q=None)">
    Apply [`RXGate`](qiskit.circuit.library.RXGate "qiskit.circuit.library.RXGate").
  </Function>

  ### rxx

  <Function id="qiskit.circuit.library.IQP.rxx" name="rxx" signature="IQP.rxx(theta, qubit1, qubit2)">
    Apply [`RXXGate`](qiskit.circuit.library.RXXGate "qiskit.circuit.library.RXXGate").
  </Function>

  ### ry

  <Function id="qiskit.circuit.library.IQP.ry" name="ry" signature="IQP.ry(theta, qubit, *, label=None, q=None)">
    Apply [`RYGate`](qiskit.circuit.library.RYGate "qiskit.circuit.library.RYGate").
  </Function>

  ### ryy

  <Function id="qiskit.circuit.library.IQP.ryy" name="ryy" signature="IQP.ryy(theta, qubit1, qubit2)">
    Apply [`RYYGate`](qiskit.circuit.library.RYYGate "qiskit.circuit.library.RYYGate").
  </Function>

  ### rz

  <Function id="qiskit.circuit.library.IQP.rz" name="rz" signature="IQP.rz(phi, qubit, *, q=None)">
    Apply [`RZGate`](qiskit.circuit.library.RZGate "qiskit.circuit.library.RZGate").
  </Function>

  ### rzx

  <Function id="qiskit.circuit.library.IQP.rzx" name="rzx" signature="IQP.rzx(theta, qubit1, qubit2)">
    Apply [`RZXGate`](qiskit.circuit.library.RZXGate "qiskit.circuit.library.RZXGate").
  </Function>

  ### rzz

  <Function id="qiskit.circuit.library.IQP.rzz" name="rzz" signature="IQP.rzz(theta, qubit1, qubit2)">
    Apply [`RZZGate`](qiskit.circuit.library.RZZGate "qiskit.circuit.library.RZZGate").
  </Function>

  ### s

  <Function id="qiskit.circuit.library.IQP.s" name="s" signature="IQP.s(qubit, *, q=None)">
    Apply [`SGate`](qiskit.circuit.library.SGate "qiskit.circuit.library.SGate").
  </Function>

  ### sdg

  <Function id="qiskit.circuit.library.IQP.sdg" name="sdg" signature="IQP.sdg(qubit, *, q=None)">
    Apply [`SdgGate`](qiskit.circuit.library.SdgGate "qiskit.circuit.library.SdgGate").
  </Function>

  ### size

  <Function id="qiskit.circuit.library.IQP.size" name="size" signature="IQP.size()">
  ...
  <Function id="qiskit.circuit.library.IQP.snapshot" name="snapshot" signature="IQP.snapshot(label, snapshot_type='statevector', qubits=None, params=None)">
  ...
  <Function id="qiskit.circuit.library.IQP.snapshot_density_matrix" name="snapshot_density_matrix" signature="IQP.snapshot_density_matrix(label, qubits=None)">
  ...
  <Function id="qiskit.circuit.library.IQP.snapshot_expectation_value" name="snapshot_expectation_value" signature="IQP.snapshot_expectation_value(label, op, qubits, single_shot=False, variance=False)">
  ...
  <Function id="qiskit.circuit.library.IQP.snapshot_probabilities" name="snapshot_probabilities" signature="IQP.snapshot_probabilities(label, qubits, variance=False)">
  ...
  <Function id="qiskit.circuit.library.IQP.snapshot_stabilizer" name="snapshot_stabilizer" signature="IQP.snapshot_stabilizer(label)">
  ...
  <Function id="qiskit.circuit.library.IQP.snapshot_statevector" name="snapshot_statevector" signature="IQP.snapshot_statevector(label)">
  ...
  <Function id="qiskit.circuit.library.IQP.squ" name="squ" signature="IQP.squ(unitary_matrix, qubit, mode='ZYZ', up_to_diagonal=False, *, u=None)">
  ...
  <Function id="qiskit.circuit.library.IQP.swap" name="swap" signature="IQP.swap(qubit1, qubit2)">
    Apply [`SwapGate`](qiskit.circuit.library.SwapGate "qiskit.circuit.library.SwapGate").
  </Function>

  ### t

  <Function id="qiskit.circuit.library.IQP.t" name="t" signature="IQP.t(qubit, *, q=None)">
    Apply [`TGate`](qiskit.circuit.library.TGate "qiskit.circuit.library.TGate").
  </Function>

  ### tdg

  <Function id="qiskit.circuit.library.IQP.tdg" name="tdg" signature="IQP.tdg(qubit, *, q=None)">
    Apply [`TdgGate`](qiskit.circuit.library.TdgGate "qiskit.circuit.library.TdgGate").
  </Function>

  ### to\_gate

  <Function id="qiskit.circuit.library.IQP.to_gate" name="to_gate" signature="IQP.to_gate(parameter_map=None)">
  ...
  <Function id="qiskit.circuit.library.IQP.to_instruction" name="to_instruction" signature="IQP.to_instruction(parameter_map=None)">
  ...
  <Function id="qiskit.circuit.library.IQP.toffoli" name="toffoli" signature="IQP.toffoli(control_qubit1, control_qubit2, target_qubit, *, ctl1=None, ctl2=None, tgt=None)">
    Apply [`CCXGate`](qiskit.circuit.library.CCXGate "qiskit.circuit.library.CCXGate").
  </Function>

  ### u1

  <Function id="qiskit.circuit.library.IQP.u1" name="u1" signature="IQP.u1(theta, qubit, *, q=None)">
    Apply [`U1Gate`](qiskit.circuit.library.U1Gate "qiskit.circuit.library.U1Gate").
  </Function>

  ### u2

  <Function id="qiskit.circuit.library.IQP.u2" name="u2" signature="IQP.u2(phi, lam, qubit, *, q=None)">
    Apply [`U2Gate`](qiskit.circuit.library.U2Gate "qiskit.circuit.library.U2Gate").
  </Function>

  ### u3

  <Function id="qiskit.circuit.library.IQP.u3" name="u3" signature="IQP.u3(theta, phi, lam, qubit, *, q=None)">
    Apply [`U3Gate`](qiskit.circuit.library.U3Gate "qiskit.circuit.library.U3Gate").
  </Function>

  ### uc

  <Function id="qiskit.circuit.library.IQP.uc" name="uc" signature="IQP.uc(gate_list, q_controls, q_target, up_to_diagonal=False)">
  ...
  <Function id="qiskit.circuit.library.IQP.ucg" name="ucg" signature="IQP.ucg(angle_list, q_controls, q_target, up_to_diagonal=False)">
    Deprecated version of uc.
  </Function>

  ### ucrx

  <Function id="qiskit.circuit.library.IQP.ucrx" name="ucrx" signature="IQP.ucrx(angle_list, q_controls, q_target)">
  ...
  <Function id="qiskit.circuit.library.IQP.ucry" name="ucry" signature="IQP.ucry(angle_list, q_controls, q_target)">
  ...
  <Function id="qiskit.circuit.library.IQP.ucrz" name="ucrz" signature="IQP.ucrz(angle_list, q_controls, q_target)">
  ...
  <Function id="qiskit.circuit.library.IQP.ucx" name="ucx" signature="IQP.ucx(angle_list, q_controls, q_target)">
    Deprecated version of ucrx.
  </Function>

  ### ucy

  <Function id="qiskit.circuit.library.IQP.ucy" name="ucy" signature="IQP.ucy(angle_list, q_controls, q_target)">
    Deprecated version of ucry.
  </Function>

  ### ucz

  <Function id="qiskit.circuit.library.IQP.ucz" name="ucz" signature="IQP.ucz(angle_list, q_controls, q_target)">
    Deprecated version of ucrz.
  </Function>

  ### unitary

  <Function id="qiskit.circuit.library.IQP.unitary" name="unitary" signature="IQP.unitary(obj, qubits, label=None)">
    Apply unitary gate to q.
  </Function>

  ### width

  <Function id="qiskit.circuit.library.IQP.width" name="width" signature="IQP.width()">
  ...
  <Function id="qiskit.circuit.library.IQP.x" name="x" signature="IQP.x(qubit, *, label=None, ctrl_state=None, q=None)">
    Apply [`XGate`](qiskit.circuit.library.XGate "qiskit.circuit.library.XGate").
  </Function>

  ### y

  <Function id="qiskit.circuit.library.IQP.y" name="y" signature="IQP.y(qubit, *, q=None)">
    Apply [`YGate`](qiskit.circuit.library.YGate "qiskit.circuit.library.YGate").
  </Function>

  ### z

  <Function id="qiskit.circuit.library.IQP.z" name="z" signature="IQP.z(qubit, *, q=None)">
