...
<Class id="qiskit.aqua.components.initial_states.Custom" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.7/qiskit/aqua/components/initial_states/custom.py" signature="Custom(num_qubits, state='zero', state_vector=None, circuit=None)">
  ...
  **Raises**
  ...
  <Attribute id="qiskit.aqua.components.initial_states.Custom.bitstr" name="bitstr" />

  ## Methods

  ### construct\_circuit

  <Function id="qiskit.aqua.components.initial_states.Custom.construct_circuit" name="construct_circuit" signature="Custom.construct_circuit(mode='circuit', register=None)">
