...
$$
  ...
  *   **time\_unit** (`str`) – unit of delay times in xdata.
  ...
  <Attribute id="qiskit.ignis.characterization.T1Fitter.backend_result" signature="Union[qiskit.result.result.Result, List[qiskit.result.result.Result]]">
  ...
  <Attribute id="qiskit.ignis.characterization.T1Fitter.description" signature="str">
  ...
  <Attribute id="qiskit.ignis.characterization.T1Fitter.fit_fun" signature="Callable">
  ...
  <Attribute id="qiskit.ignis.characterization.T1Fitter.measured_qubits" signature="List[int]">
  ...
  <Attribute id="qiskit.ignis.characterization.T1Fitter.params" signature="List[float]">
  ...
  <Attribute id="qiskit.ignis.characterization.T1Fitter.params_err" signature="List[float]">
  ...
  <Attribute id="qiskit.ignis.characterization.T1Fitter.series" signature="Optional[List[str]]">
  ...
  <Attribute id="qiskit.ignis.characterization.T1Fitter.xdata" signature="Union[List[float], numpy.array]">
  ...
  <Attribute id="qiskit.ignis.characterization.T1Fitter.ydata" signature="List[Dict]">
