---
title: T1Fitter (v0.19)
description: API reference for qiskit.ignis.characterization.T1Fitter in qiskit v0.19
...
<Class id="qiskit.ignis.characterization.T1Fitter" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-ignis/tree/stable/0.3/qiskit/ignis/characterization/coherence/fitters.py" signature="T1Fitter(backend_result, xdata, qubits, fit_p0, fit_bounds, time_unit='micro-seconds')" modifiers="class">
...
$$
  ...
  *   **time\_unit** (`str`) – unit of delay times in xdata.
  ...
  <span id="t1fitter-backend-result" />

  ### backend\_result

  <Attribute id="qiskit.ignis.characterization.T1Fitter.backend_result" attributeTypeHint="Union[qiskit.result.result.Result, List[qiskit.result.result.Result]]">
  ...
  <span id="t1fitter-description" />

  ### description

  <Attribute id="qiskit.ignis.characterization.T1Fitter.description" attributeTypeHint="str">
  ...
  <span id="t1fitter-fit-fun" />

  ### fit\_fun

  <Attribute id="qiskit.ignis.characterization.T1Fitter.fit_fun" attributeTypeHint="Callable">
  ...
  <span id="t1fitter-measured-qubits" />

  ### measured\_qubits

  <Attribute id="qiskit.ignis.characterization.T1Fitter.measured_qubits" attributeTypeHint="List[int]">
  ...
  <span id="t1fitter-params" />

  ### params

  <Attribute id="qiskit.ignis.characterization.T1Fitter.params" attributeTypeHint="List[float]">
  ...
  <span id="t1fitter-params-err" />

  ### params\_err

  <Attribute id="qiskit.ignis.characterization.T1Fitter.params_err" attributeTypeHint="List[float]">
  ...
  <span id="t1fitter-series" />

  ### series

  <Attribute id="qiskit.ignis.characterization.T1Fitter.series" attributeTypeHint="Optional[List[str]]">
  ...
  <span id="t1fitter-xdata" />

  ### xdata

  <Attribute id="qiskit.ignis.characterization.T1Fitter.xdata" attributeTypeHint="Union[List[float], numpy.array]">
  ...
  <span id="t1fitter-ydata" />

  ### ydata

  <Attribute id="qiskit.ignis.characterization.T1Fitter.ydata" attributeTypeHint="List[Dict]">
