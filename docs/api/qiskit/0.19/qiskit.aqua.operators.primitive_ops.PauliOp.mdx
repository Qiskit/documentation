...
<Class id="qiskit.aqua.operators.primitive_ops.PauliOp" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.7/qiskit/aqua/operators/primitive_ops/pauli_op.py" signature="PauliOp(primitive=None, coeff=1.0)">
  ...
  **TypeError** – invalid parameters.
  ...
  <Attribute id="qiskit.aqua.operators.primitive_ops.PauliOp.coeff" name="coeff" signature="Union[int, float, complex, qiskit.circuit.parameterexpression.ParameterExpression]">
  ...
  <Attribute id="qiskit.aqua.operators.primitive_ops.PauliOp.num_qubits" name="num_qubits" signature="int">
  ...
  <Function id="qiskit.aqua.operators.primitive_ops.PauliOp.__mul__" name="__mul__" signature="PauliOp.__mul__(other)">
  ...
  <Function id="qiskit.aqua.operators.primitive_ops.PauliOp.compose" name="compose" signature="PauliOp.compose(other)">
