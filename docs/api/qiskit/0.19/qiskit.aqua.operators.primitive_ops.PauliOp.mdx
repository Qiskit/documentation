...
<Class id="qiskit.aqua.operators.primitive_ops.PauliOp" github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.7/qiskit/aqua/operators/primitive_ops/pauli_op.py" signature="PauliOp(primitive=None, coeff=1.0)">
