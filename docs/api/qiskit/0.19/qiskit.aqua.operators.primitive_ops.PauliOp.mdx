---
title: PauliOp (v0.19)
description: API reference for qiskit.aqua.operators.primitive_ops.PauliOp in qiskit v0.19
...
<Class id="qiskit.aqua.operators.primitive_ops.PauliOp" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.7/qiskit/aqua/operators/primitive_ops/pauli_op.py" signature="PauliOp(primitive=None, coeff=1.0)" modifiers="class">
  ...
  **TypeError** – invalid parameters.
  ...
  <span id="pauliop-coeff" />

  ### coeff

  <Attribute id="qiskit.aqua.operators.primitive_ops.PauliOp.coeff" attributeTypeHint="Union[int, float, complex, qiskit.circuit.parameterexpression.ParameterExpression]">
  ...
  <span id="pauliop-num-qubits" />

  ### num\_qubits

  <Attribute id="qiskit.aqua.operators.primitive_ops.PauliOp.num_qubits" attributeTypeHint="int">
  ...
  <span id="pauliop-primitive" />

  ### primitive

  <Attribute id="qiskit.aqua.operators.primitive_ops.PauliOp.primitive" attributeTypeHint="Union[qiskit.circuit.instruction.Instruction, qiskit.circuit.quantumcircuit.QuantumCircuit, list, numpy.ndarray, scipy.sparse.base.spmatrix, qiskit.quantum_info.operators.operator.Operator, qiskit.quantum_info.operators.pauli.Pauli]">
  ...
  <Function id="qiskit.aqua.operators.primitive_ops.PauliOp.__mul__" signature="PauliOp.__mul__(other)">
  ...
  <span id="pauliop-assign-parameters" />
  ...
  <span id="pauliop-bind-parameters" />
  ...
  <span id="pauliop-compose" />

  ### compose

  <Function id="qiskit.aqua.operators.primitive_ops.PauliOp.compose" signature="PauliOp.compose(other)">
  ...
  <span id="pauliop-primitive-strings" />
  ...
  <span id="pauliop-to-instruction" />
