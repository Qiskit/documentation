---
title: NoiseModel (v0.19)
description: API reference for qiskit.providers.aer.noise.NoiseModel in qiskit v0.19
...
<Class id="qiskit.providers.aer.noise.NoiseModel" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-aer/tree/stable/0.5/qiskit/providers/aer/noise/noise_model.py" signature="NoiseModel(basis_gates=None)" modifiers="class">
  ...
  **basis\_gates** (*list\[str] or None*) – Specify an initial basis\_gates for the noise model. If None a default value of \[‘id’, ‘u3’, ‘cx’] is used (Default: None).
  ...
  <span id="noisemodel-basis-gates" />
  ...
  <span id="noisemodel-noise-instructions" />
  ...
  <span id="noisemodel-noise-qubits" />
  ...
  <span id="noisemodel-add-all-qubit-quantum-error" />
  ...
  <span id="noisemodel-add-all-qubit-readout-error" />
  ...
  <span id="noisemodel-add-basis-gates" />
  ...
  <span id="noisemodel-add-nonlocal-quantum-error" />
  ...
  <span id="noisemodel-add-quantum-error" />
  ...
  <span id="noisemodel-add-readout-error" />
  ...
  <span id="noisemodel-from-backend" />

  ### from\_backend

  <Function id="qiskit.providers.aer.noise.NoiseModel.from_backend" signature="NoiseModel.from_backend(backend, gate_error=True, readout_error=True, thermal_relaxation=True, temperature=0, gate_lengths=None, gate_length_units='ns', standard_gates=True)" modifiers="classmethod">
  ...
  <span id="noisemodel-set-x90-single-qubit-gates" />

  ### set\_x90\_single\_qubit\_gates

  <Function id="qiskit.providers.aer.noise.NoiseModel.set_x90_single_qubit_gates" signature="NoiseModel.set_x90_single_qubit_gates(instructions)">
