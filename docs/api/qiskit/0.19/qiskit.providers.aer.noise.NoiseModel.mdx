...
<Class id="qiskit.providers.aer.noise.NoiseModel" github="https://github.com/qiskit/qiskit-aer/tree/stable/0.5/qiskit/providers/aer/noise/noise_model.py" signature="NoiseModel(basis_gates=None)">
