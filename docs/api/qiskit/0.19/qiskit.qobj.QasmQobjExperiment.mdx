---
title: QasmQobjExperiment (v0.19)
description: API reference for qiskit.qobj.QasmQobjExperiment in qiskit v0.19
...
<Class id="qiskit.qobj.QasmQobjExperiment" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.14/qiskit/qobj/qasm_qobj.py" signature="QasmQobjExperiment(config=None, header=None, instructions=None)" modifiers="class">
  ...
  *   **instructions** (*list*) – A list of [`QasmQobjInstruction`](qiskit.qobj.QasmQobjInstruction "qiskit.qobj.QasmQobjInstruction") objects
  ...
  <span id="qasmqobjexperiment-from-dict" />
  ...
  <span id="qasmqobjexperiment-to-dict" />
