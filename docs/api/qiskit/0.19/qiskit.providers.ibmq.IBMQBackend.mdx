...
<Class id="qiskit.providers.ibmq.IBMQBackend" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-ibmq-provider/tree/stable/0.7/qiskit/providers/ibmq/ibmqbackend.py" signature="IBMQBackend(configuration, provider, credentials, api)">
  ...
  *   **api** (`AccountClient`) – IBM Quantum Experience client used to communicate with the server.
  ...
  <Function id="qiskit.providers.ibmq.IBMQBackend.jobs" name="jobs" signature="IBMQBackend.jobs(limit=10, skip=0, status=None, job_name=None, start_datetime=None, end_datetime=None, job_tags=None, job_tags_operator='OR', descending=True, db_filter=None)">
  ...
  <Function id="qiskit.providers.ibmq.IBMQBackend.run" name="run" signature="IBMQBackend.run(qobj, job_name=None, job_share_level=None, job_tags=None, validate_qobj=False)">
  ...
  <Function id="qiskit.providers.ibmq.IBMQBackend.version" name="version" signature="IBMQBackend.version()">
