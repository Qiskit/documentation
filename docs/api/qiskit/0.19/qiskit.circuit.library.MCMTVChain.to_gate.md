---
title: to_gate
description: API reference for qiskit.circuit.library.MCMTVChain.to_gate
in_page_toc_min_heading_level: 1
python_api_type: method
python_api_name: qiskit.circuit.library.MCMTVChain.to_gate
---
...
`MCMTVChain.to_gate(parameter_map=None)`
