...
<Class id="qiskit.providers.BaseJob" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.14/qiskit/providers/basejob.py" signature="BaseJob(backend, job_id)">
  ...
  *   **job\_id** (`str`) – a unique id in the context of the backend used to run the job.
  ...
  <Function id="qiskit.providers.BaseJob.cancel" signature="abstract BaseJob.cancel()">
  ...
  <Function id="qiskit.providers.BaseJob.result" signature="abstract BaseJob.result()">
  ...
  <Function id="qiskit.providers.BaseJob.status" signature="abstract BaseJob.status()">
    Return the status of the job, among the values of `JobStatus`.
  </Function>

  ### submit

  <Function id="qiskit.providers.BaseJob.submit" signature="abstract BaseJob.submit()">
