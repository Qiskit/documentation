---
title: BaseJob (v0.19)
description: API reference for qiskit.providers.BaseJob in qiskit v0.19
...
<Class id="qiskit.providers.BaseJob" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.14/qiskit/providers/basejob.py" signature="BaseJob(backend, job_id)" modifiers="class">
  ...
  *   **job\_id** (`str`) – a unique id in the context of the backend used to run the job.
  ...
  <span id="basejob-in-final-state" />
  ...
  <span id="basejob-wait-for-final-state" />
