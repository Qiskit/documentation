...
<Class id="qiskit.circuit.ControlledGate" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.14/qiskit/circuit/controlledgate.py" signature="ControlledGate(name, num_qubits, params, label=None, num_ctrl_qubits=1, definition=None, ctrl_state=None)">
  ...
  *   **CircuitError** – ctrl\_state \< 0 or ctrl\_state > 2\*\*num\_ctrl\_qubits.
  ...
  <Attribute id="qiskit.circuit.ControlledGate.ctrl_state" signature="int">
  ...
  <Attribute id="qiskit.circuit.ControlledGate.definition" signature="List">
  ...
  <Attribute id="qiskit.circuit.ControlledGate.label" signature="str">
    Return gate label
