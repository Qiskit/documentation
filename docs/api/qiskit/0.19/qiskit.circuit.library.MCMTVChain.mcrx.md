---
title: mcrx
description: API reference for qiskit.circuit.library.MCMTVChain.mcrx
in_page_toc_min_heading_level: 1
python_api_type: method
python_api_name: qiskit.circuit.library.MCMTVChain.mcrx
---
...
`MCMTVChain.mcrx(theta, q_controls, q_target, use_basis_gates=False)`
