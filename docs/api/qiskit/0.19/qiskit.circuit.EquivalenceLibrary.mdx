---
title: EquivalenceLibrary (v0.19)
description: API reference for qiskit.circuit.EquivalenceLibrary in qiskit v0.19
...
<Class id="qiskit.circuit.EquivalenceLibrary" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.14/qiskit/circuit/equivalence.py" signature="EquivalenceLibrary(*, base=None)" modifiers="class">
  ...
  **base** (*Optional\[*[*EquivalenceLibrary*](#qiskit.circuit.EquivalenceLibrary "qiskit.circuit.EquivalenceLibrary")*]*) – Base equivalence library to will be referenced if an entry is not found in this library.
  ...
  <span id="equivalencelibrary-add-equivalence" />
  ...
  <span id="equivalencelibrary-get-entry" />
  ...
  <span id="equivalencelibrary-has-entry" />
  ...
  <span id="equivalencelibrary-set-entry" />
