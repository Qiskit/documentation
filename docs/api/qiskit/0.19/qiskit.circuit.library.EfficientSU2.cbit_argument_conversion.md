...
description: API reference for qiskit.circuit.library.EfficientSU2.cbit_argument_conversion
in_page_toc_min_heading_level: 1
python_api_type: method
python_api_name: qiskit.circuit.library.EfficientSU2.cbit_argument_conversion
---
