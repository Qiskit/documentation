...
<Class id="qiskit.aqua.operators.expectations.AerPauliExpectation" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.7/qiskit/aqua/operators/expectations/aer_pauli_expectation.py" signature="AerPauliExpectation">
  ...
  <Function id="qiskit.aqua.operators.expectations.AerPauliExpectation.compute_variance" name="compute_variance" signature="AerPauliExpectation.compute_variance(exp_op)">
  ...
  <Function id="qiskit.aqua.operators.expectations.AerPauliExpectation.convert" name="convert" signature="AerPauliExpectation.convert(operator)">
