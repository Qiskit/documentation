---
title: AerPauliExpectation (v0.19)
description: API reference for qiskit.aqua.operators.expectations.AerPauliExpectation in qiskit v0.19
...
<Class id="qiskit.aqua.operators.expectations.AerPauliExpectation" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.7/qiskit/aqua/operators/expectations/aer_pauli_expectation.py" signature="AerPauliExpectation" modifiers="class">
  ...
  <span id="aerpauliexpectation-compute-variance" />
  ...
  <span id="aerpauliexpectation-convert" />
