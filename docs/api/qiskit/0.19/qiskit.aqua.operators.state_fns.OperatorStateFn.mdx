...
<Class id="qiskit.aqua.operators.state_fns.OperatorStateFn" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.7/qiskit/aqua/operators/state_fns/operator_state_fn.py" signature="OperatorStateFn(primitive=None, coeff=1.0, is_measurement=False)">
  ...
  *   **is\_measurement** (`bool`) – Whether the StateFn is a measurement operator
  ...
  <Attribute id="qiskit.aqua.operators.state_fns.OperatorStateFn.coeff" name="coeff" signature="Union[int, float, complex, qiskit.circuit.parameterexpression.ParameterExpression]">
  ...
  <Attribute id="qiskit.aqua.operators.state_fns.OperatorStateFn.is_measurement" name="is_measurement" signature="bool">
  ...
  <Attribute id="qiskit.aqua.operators.state_fns.OperatorStateFn.num_qubits" name="num_qubits" signature="int">
  ...
  <Function id="qiskit.aqua.operators.state_fns.OperatorStateFn.__mul__" name="__mul__" signature="OperatorStateFn.__mul__(other)">
  ...
  <Function id="qiskit.aqua.operators.state_fns.OperatorStateFn.compose" name="compose" signature="OperatorStateFn.compose(other)">
