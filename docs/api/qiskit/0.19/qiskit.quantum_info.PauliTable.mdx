---
title: PauliTable (v0.19)
description: API reference for qiskit.quantum_info.PauliTable in qiskit v0.19
...
<Class id="qiskit.quantum_info.PauliTable" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.14/qiskit/quantum_info/operators/symplectic/pauli_table.py" signature="PauliTable(data)" modifiers="class">
...
$$
  ...
  **Additional Information:**
  ...
  <span id="paulitable-atol" />

  ### atol

  <Attribute id="qiskit.quantum_info.PauliTable.atol">
    The default absolute tolerance parameter for float comparisons.
  </Attribute>

  <span id="paulitable-dim" />
  ...
  <span id="paulitable-rtol" />

  ### rtol

  <Attribute id="qiskit.quantum_info.PauliTable.rtol">
    The relative tolerance parameter for float comparisons.
  </Attribute>

  <span id="paulitable-shape" />
  ...
  <span id="paulitable-call" />

  ### \_\_call\_\_

  <Function id="qiskit.quantum_info.PauliTable.__call__" signature="PauliTable.__call__(qargs)">
    Return a clone with qargs set
  </Function>

  <span id="paulitable-getitem" />

  ### \_\_getitem\_\_

  <Function id="qiskit.quantum_info.PauliTable.__getitem__" signature="PauliTable.__getitem__(key)">
    Return a view of the PauliTable.
  </Function>

  <span id="paulitable-len" />

  ### \_\_len\_\_

  <Function id="qiskit.quantum_info.PauliTable.__len__" signature="PauliTable.__len__()">
    Return the number of Pauli rows in the table.
  </Function>

  <span id="paulitable-mul" />

  ### \_\_mul\_\_

  <Function id="qiskit.quantum_info.PauliTable.__mul__" signature="PauliTable.__mul__(other)" />

  <span id="paulitable-add" />

  ### add

  <Function id="qiskit.quantum_info.PauliTable.add" signature="PauliTable.add(other)">
  ...
  <span id="paulitable-anticommutes-with-all" />
  ...
  <span id="paulitable-commutes-with-all" />
  ...
  <span id="paulitable-from-labels" />
  ...
  <span id="paulitable-matrix-iter" />
  ...
  <span id="paulitable-multiply" />

  ### multiply

  <Function id="qiskit.quantum_info.PauliTable.multiply" signature="PauliTable.multiply(other)">
  ...
  <span id="paulitable-output-dims" />
  ...
  <span id="paulitable-reshape" />

  ### reshape

  <Function id="qiskit.quantum_info.PauliTable.reshape" signature="PauliTable.reshape(input_dims=None, output_dims=None)">
  ...
  <span id="paulitable-set-atol" />

  ### set\_atol

  <Function id="qiskit.quantum_info.PauliTable.set_atol" signature="PauliTable.set_atol(value)" modifiers="classmethod">
    Set the class default absolute tolerance parameter for float comparisons.
  </Function>

  <span id="paulitable-set-rtol" />

  ### set\_rtol

  <Function id="qiskit.quantum_info.PauliTable.set_rtol" signature="PauliTable.set_rtol(value)" modifiers="classmethod">
    Set the class default relative tolerance parameter for float comparisons.
  </Function>

  <span id="paulitable-sort" />
  ...
  <span id="paulitable-subtract" />

  ### subtract

  <Function id="qiskit.quantum_info.PauliTable.subtract" signature="PauliTable.subtract(other)">
    Return the linear operator self - other.
