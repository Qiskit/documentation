...
$$
  ...
  **Additional Information:**
  ...
  <Function id="qiskit.quantum_info.PauliTable.from_labels" signature="classmethod PauliTable.from_labels(labels)">
  ...
  <Function id="qiskit.quantum_info.PauliTable.set_atol" signature="classmethod PauliTable.set_atol(value)">
    Set the class default absolute tolerance parameter for float comparisons.
  </Function>

  ### set\_rtol

  <Function id="qiskit.quantum_info.PauliTable.set_rtol" signature="classmethod PauliTable.set_rtol(value)">
