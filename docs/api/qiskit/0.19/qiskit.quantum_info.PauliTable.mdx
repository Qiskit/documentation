...
<Class id="qiskit.quantum_info.PauliTable" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.14/qiskit/quantum_info/operators/symplectic/pauli_table.py" signature="PauliTable(data)">
...
$$
  ...
  **Additional Information:**
  ...
  <Attribute id="qiskit.quantum_info.PauliTable.X" name="X">
    The X block of the [`array`](qiskit.quantum_info.PauliTable#array "qiskit.quantum_info.PauliTable.array").
  </Attribute>

  ### Z

  <Attribute id="qiskit.quantum_info.PauliTable.Z" name="Z">
    The Z block of the [`array`](qiskit.quantum_info.PauliTable#array "qiskit.quantum_info.PauliTable.array").
  </Attribute>

  ### array

  <Attribute id="qiskit.quantum_info.PauliTable.array" name="array">
    The underlying boolean array.
  </Attribute>

  ### atol

  <Attribute id="qiskit.quantum_info.PauliTable.atol" name="atol">
    The default absolute tolerance parameter for float comparisons.
  </Attribute>

  ### dim

  <Attribute id="qiskit.quantum_info.PauliTable.dim" name="dim">
    Return tuple (input\_shape, output\_shape).
  </Attribute>

  ### num\_qubits

  <Attribute id="qiskit.quantum_info.PauliTable.num_qubits" name="num_qubits">
    Return the number of qubits if a N-qubit operator or None otherwise.
  </Attribute>

  ### qargs

  <Attribute id="qiskit.quantum_info.PauliTable.qargs" name="qargs">
    Return the qargs for the operator.
  </Attribute>

  ### rtol

  <Attribute id="qiskit.quantum_info.PauliTable.rtol" name="rtol">
    The relative tolerance parameter for float comparisons.
  </Attribute>

  ### shape

  <Attribute id="qiskit.quantum_info.PauliTable.shape" name="shape">
    The full shape of the [`array()`](qiskit.quantum_info.PauliTable#array "qiskit.quantum_info.PauliTable.array")
  </Attribute>

  ### size

  <Attribute id="qiskit.quantum_info.PauliTable.size" name="size">
  ...
  <Function id="qiskit.quantum_info.PauliTable.__call__" name="__call__" signature="PauliTable.__call__(qargs)">
    Return a clone with qargs set
  </Function>

  ### \_\_getitem\_\_

  <Function id="qiskit.quantum_info.PauliTable.__getitem__" name="__getitem__" signature="PauliTable.__getitem__(key)">
    Return a view of the PauliTable.
  </Function>

  ### \_\_len\_\_

  <Function id="qiskit.quantum_info.PauliTable.__len__" name="__len__" signature="PauliTable.__len__()">
    Return the number of Pauli rows in the table.
  </Function>

  ### \_\_mul\_\_

  <Function id="qiskit.quantum_info.PauliTable.__mul__" name="__mul__" signature="PauliTable.__mul__(other)" />

  ### add

  <Function id="qiskit.quantum_info.PauliTable.add" name="add" signature="PauliTable.add(other)">
  ...
  <Function id="qiskit.quantum_info.PauliTable.adjoint" name="adjoint" signature="PauliTable.adjoint()">
    Return the adjoint of the operator.
  </Function>

  ### anticommutes\_with\_all

  <Function id="qiskit.quantum_info.PauliTable.anticommutes_with_all" name="anticommutes_with_all" signature="PauliTable.anticommutes_with_all(other)">
  ...
  <Function id="qiskit.quantum_info.PauliTable.argsort" name="argsort" signature="PauliTable.argsort(weight=False)">
  ...
  <Function id="qiskit.quantum_info.PauliTable.commutes" name="commutes" signature="PauliTable.commutes(pauli)">
  ...
  <Function id="qiskit.quantum_info.PauliTable.commutes_with_all" name="commutes_with_all" signature="PauliTable.commutes_with_all(other)">
    Return indexes of rows that commute other.
  ...
  <Function id="qiskit.quantum_info.PauliTable.compose" name="compose" signature="PauliTable.compose(other, qargs=None, front=True)">
  ...
  <Function id="qiskit.quantum_info.PauliTable.conjugate" name="conjugate" signature="PauliTable.conjugate()">
    Not implemented.
  </Function>

  ### copy

  <Function id="qiskit.quantum_info.PauliTable.copy" name="copy" signature="PauliTable.copy()">
    Make a deep copy of current operator.
  </Function>

  ### delete

  <Function id="qiskit.quantum_info.PauliTable.delete" name="delete" signature="PauliTable.delete(ind, qubit=False)">
  ...
  <Function id="qiskit.quantum_info.PauliTable.dot" name="dot" signature="PauliTable.dot(other, qargs=None)">
  ...
  <Function id="qiskit.quantum_info.PauliTable.expand" name="expand" signature="PauliTable.expand(other)">
  ...
  <Function id="qiskit.quantum_info.PauliTable.from_labels" name="from_labels" signature="classmethod PauliTable.from_labels(labels)">
  ...
  <Function id="qiskit.quantum_info.PauliTable.input_dims" name="input_dims" signature="PauliTable.input_dims(qargs=None)">
    Return tuple of input dimension for specified subsystems.
  </Function>

  ### insert

  <Function id="qiskit.quantum_info.PauliTable.insert" name="insert" signature="PauliTable.insert(ind, value, qubit=False)">
  ...
  <Function id="qiskit.quantum_info.PauliTable.label_iter" name="label_iter" signature="PauliTable.label_iter()">
  ...
  <Function id="qiskit.quantum_info.PauliTable.matrix_iter" name="matrix_iter" signature="PauliTable.matrix_iter(sparse=False)">
  ...
  <Function id="qiskit.quantum_info.PauliTable.multiply" name="multiply" signature="PauliTable.multiply(other)">
  ...
  <Function id="qiskit.quantum_info.PauliTable.output_dims" name="output_dims" signature="PauliTable.output_dims(qargs=None)">
    Return tuple of output dimension for specified subsystems.
  </Function>

  ### power

  <Function id="qiskit.quantum_info.PauliTable.power" name="power" signature="PauliTable.power(n)">
  ...
  <Function id="qiskit.quantum_info.PauliTable.reshape" name="reshape" signature="PauliTable.reshape(input_dims=None, output_dims=None)">
  ...
  <Function id="qiskit.quantum_info.PauliTable.set_atol" name="set_atol" signature="classmethod PauliTable.set_atol(value)">
    Set the class default absolute tolerance parameter for float comparisons.
  </Function>

  ### set\_rtol

  <Function id="qiskit.quantum_info.PauliTable.set_rtol" name="set_rtol" signature="classmethod PauliTable.set_rtol(value)">
    Set the class default relative tolerance parameter for float comparisons.
  </Function>

  ### sort

  <Function id="qiskit.quantum_info.PauliTable.sort" name="sort" signature="PauliTable.sort(weight=False)">
  ...
  <Function id="qiskit.quantum_info.PauliTable.subtract" name="subtract" signature="PauliTable.subtract(other)">
    Return the linear operator self - other.
  ...
  <Function id="qiskit.quantum_info.PauliTable.tensor" name="tensor" signature="PauliTable.tensor(other)">
  ...
  <Function id="qiskit.quantum_info.PauliTable.to_labels" name="to_labels" signature="PauliTable.to_labels(array=False)">
  ...
  <Function id="qiskit.quantum_info.PauliTable.to_matrix" name="to_matrix" signature="PauliTable.to_matrix(sparse=False, array=False)">
  ...
  <Function id="qiskit.quantum_info.PauliTable.transpose" name="transpose" signature="PauliTable.transpose()">
    Not implemented.
  </Function>

  ### unique

  <Function id="qiskit.quantum_info.PauliTable.unique" name="unique" signature="PauliTable.unique(return_index=False, return_counts=False)">
