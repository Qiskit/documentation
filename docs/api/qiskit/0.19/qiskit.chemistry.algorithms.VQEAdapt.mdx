---
title: VQEAdapt (v0.19)
description: API reference for qiskit.chemistry.algorithms.VQEAdapt in qiskit v0.19
...
<Class id="qiskit.chemistry.algorithms.VQEAdapt" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.7/qiskit/chemistry/algorithms/minimum_eigen_solvers/vqe_adapt.py" signature="VQEAdapt(operator, var_form_base, optimizer, initial_point=None, excitation_pool=None, threshold=1e-05, delta=1, max_evals_grouped=1, aux_operators=None, quantum_instance=None)" modifiers="class">
  ...
  *   **See also** – qiskit/chemistry/components/variational\_forms/uccsd\_adapt.py
  ...
  <span id="vqeadapt-initial-point" />
  ...
  <span id="vqeadapt-optimal-params" />
  ...
  <span id="vqeadapt-quantum-instance" />
  ...
  <span id="vqeadapt-cleanup-parameterized-circuits" />
  ...
  <span id="vqeadapt-get-optimal-circuit" />
  ...
  <span id="vqeadapt-get-optimal-cost" />
  ...
  <span id="vqeadapt-get-optimal-vector" />
  ...
  <span id="vqeadapt-get-prob-vector-for-params" />
  ...
  <span id="vqeadapt-get-probabilities-for-counts" />
