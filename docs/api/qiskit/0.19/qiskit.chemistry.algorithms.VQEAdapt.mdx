...
<Class id="qiskit.chemistry.algorithms.VQEAdapt" github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.7/qiskit/chemistry/algorithms/minimum_eigen_solvers/vqe_adapt.py" signature="VQEAdapt(operator, var_form_base, optimizer, initial_point=None, excitation_pool=None, threshold=1e-05, delta=1, max_evals_grouped=1, aux_operators=None, quantum_instance=None)">
  ...
  *   **See also** – qiskit/chemistry/components/variational\_forms/uccsd\_adapt.py
  ...
  <Attribute id="qiskit.chemistry.algorithms.VQEAdapt.backend" signature="qiskit.providers.basebackend.BaseBackend">
    Returns backend.
  ...
  <Attribute id="qiskit.chemistry.algorithms.VQEAdapt.initial_point" signature="Optional[numpy.ndarray]">
  ...
  <Attribute id="qiskit.chemistry.algorithms.VQEAdapt.optimizer" signature="Optional[qiskit.aqua.components.optimizers.optimizer.Optimizer]">
    Returns optimizer
  ...
  <Attribute id="qiskit.chemistry.algorithms.VQEAdapt.quantum_instance" signature="Union[None, qiskit.aqua.quantum_instance.QuantumInstance]">
  ...
  <Attribute id="qiskit.chemistry.algorithms.VQEAdapt.var_form" signature="Optional[Union[qiskit.circuit.quantumcircuit.QuantumCircuit, qiskit.aqua.components.variational_forms.variational_form.VariationalForm]]">
