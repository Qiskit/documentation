...
<Class id="qiskit.aqua.components.variational_forms.SwapRZ" github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.7/qiskit/aqua/components/variational_forms/swaprz.py" signature="SwapRZ(num_qubits, depth=3, entangler_map=None, entanglement='full', initial_state=None, skip_unentangled_qubits=False)">
  ...
  *   **skip\_unentangled\_qubits** (`bool`) – Skip the qubits not in the entangler\_map
  ...
  <Attribute id="qiskit.aqua.components.variational_forms.SwapRZ.num_parameters" name="num_parameters">
  ...
  <Attribute id="qiskit.aqua.components.variational_forms.SwapRZ.num_qubits" name="num_qubits">
  ...
  <Attribute id="qiskit.aqua.components.variational_forms.SwapRZ.parameter_bounds" name="parameter_bounds">
    Parameter bounds.
  ...
  <Attribute id="qiskit.aqua.components.variational_forms.SwapRZ.preferred_init_points" name="preferred_init_points">
  ...
  <Attribute id="qiskit.aqua.components.variational_forms.SwapRZ.setting" name="setting" />

  ### support\_parameterized\_circuit

  <Attribute id="qiskit.aqua.components.variational_forms.SwapRZ.support_parameterized_circuit" name="support_parameterized_circuit">
  ...
  <Function id="qiskit.aqua.components.variational_forms.SwapRZ.construct_circuit" name="construct_circuit" signature="SwapRZ.construct_circuit(parameters, q=None)">
  ...
  <Function id="qiskit.aqua.components.variational_forms.SwapRZ.get_entangler_map" name="get_entangler_map" signature="static SwapRZ.get_entangler_map(map_type, num_qubits, offset=0)">
    returns entangler map
  </Function>

  ### validate\_entangler\_map

  <Function id="qiskit.aqua.components.variational_forms.SwapRZ.validate_entangler_map" name="validate_entangler_map" signature="static SwapRZ.validate_entangler_map(entangler_map, num_qubits)">
