---
title: check_commutativity (v0.19)
description: API reference for qiskit.aqua.operators.legacy.check_commutativity in qiskit v0.19
in_page_toc_min_heading_level: 1
python_api_type: function
python_api_name: qiskit.aqua.operators.legacy.check_commutativity
---

<span id="check-commutativity" />

# check\_commutativity

<Function id="qiskit.aqua.operators.legacy.check_commutativity" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.7/qiskit/aqua/operators/legacy/common.py" signature="check_commutativity(op_1, op_2, anti=False)">
