...
description: API reference for qiskit.ignis.characterization.DragFitter.backend_result
in_page_toc_min_heading_level: 1
python_api_type: property
python_api_name: qiskit.ignis.characterization.DragFitter.backend_result
---
