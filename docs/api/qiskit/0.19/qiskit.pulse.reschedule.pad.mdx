...
<Function id="qiskit.pulse.reschedule.pad" name="pad" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.14/qiskit/pulse/reschedule.py" signature="pad(schedule, channels=None, until=None)">
