---
title: SuperOp (v0.19)
description: API reference for qiskit.quantum_info.SuperOp in qiskit v0.19
...
$$
  ...
  **Additional Information:**
  ...
  <span id="superop-to-instruction" />
