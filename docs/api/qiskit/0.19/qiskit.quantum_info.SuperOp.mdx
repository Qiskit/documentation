...
$$
  ...
  **Additional Information:**
  ...
  <Function id="qiskit.quantum_info.SuperOp.set_atol" signature="classmethod SuperOp.set_atol(value)">
    Set the class default absolute tolerance parameter for float comparisons.
  </Function>

  ### set\_rtol

  <Function id="qiskit.quantum_info.SuperOp.set_rtol" signature="classmethod SuperOp.set_rtol(value)">
