---
title: isometry
description: API reference for qiskit.circuit.library.MCMT.isometry
in_page_toc_min_heading_level: 1
python_api_type: method
python_api_name: qiskit.circuit.library.MCMT.isometry
---
...
`MCMT.isometry(isometry, q_input, q_ancillas_for_output, q_ancillas_zero=None, q_ancillas_dirty=None)`
