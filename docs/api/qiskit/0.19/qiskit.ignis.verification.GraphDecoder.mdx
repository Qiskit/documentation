---
title: GraphDecoder (v0.19)
description: API reference for qiskit.ignis.verification.GraphDecoder in qiskit v0.19
...
<Class id="qiskit.ignis.verification.GraphDecoder" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-ignis/tree/stable/0.3/qiskit/ignis/verification/topological_codes/fitters.py" signature="GraphDecoder(code, S=None)" modifiers="class">
  ...
  **Additional information:**
  ...
  <span id="graphdecoder-get-logical-prob" />
  ...
  <span id="graphdecoder-make-error-graph" />
  ...
  <span id="graphdecoder-weight-syndrome-graph" />
