...
<Class id="qiskit.aqua.components.initial_states.VarFormBased" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.7/qiskit/aqua/components/initial_states/var_form_based.py" signature="VarFormBased(var_form, params)">
  ...
  **ValueError** – Invalid input
  ...
  <Function id="qiskit.aqua.components.initial_states.VarFormBased.construct_circuit" name="construct_circuit" signature="VarFormBased.construct_circuit(mode='circuit', register=None)">
