---
title: VarFormBased (v0.19)
description: API reference for qiskit.aqua.components.initial_states.VarFormBased in qiskit v0.19
...
<Class id="qiskit.aqua.components.initial_states.VarFormBased" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.7/qiskit/aqua/components/initial_states/var_form_based.py" signature="VarFormBased(var_form, params)" modifiers="class">
  ...
  **ValueError** – Invalid input
  ...
  <span id="varformbased-construct-circuit" />
