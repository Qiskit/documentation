---
title: assemble_schedules (v0.19)
description: API reference for qiskit.assembler.assemble_schedules in qiskit v0.19
in_page_toc_min_heading_level: 1
python_api_type: function
python_api_name: qiskit.assembler.assemble_schedules
---

<span id="assemble-schedules" />

# assemble\_schedules

<Function id="qiskit.assembler.assemble_schedules" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.14/qiskit/assembler/assemble_schedules.py" signature="assemble_schedules(schedules, qobj_id, qobj_header, run_config)">
