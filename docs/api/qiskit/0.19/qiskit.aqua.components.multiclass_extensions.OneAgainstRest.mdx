...
<Class id="qiskit.aqua.components.multiclass_extensions.OneAgainstRest" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.7/qiskit/aqua/components/multiclass_extensions/one_against_rest.py" signature="OneAgainstRest">
  ...
  <Function id="qiskit.aqua.components.multiclass_extensions.OneAgainstRest.predict" name="predict" signature="OneAgainstRest.predict(x)">
  ...
  <Function id="qiskit.aqua.components.multiclass_extensions.OneAgainstRest.set_estimator" name="set_estimator" signature="OneAgainstRest.set_estimator(estimator_cls, params=None)">
  ...
  <Function id="qiskit.aqua.components.multiclass_extensions.OneAgainstRest.test" name="test" signature="OneAgainstRest.test(x, y)">
  ...
  <Function id="qiskit.aqua.components.multiclass_extensions.OneAgainstRest.train" name="train" signature="OneAgainstRest.train(x, y)">
