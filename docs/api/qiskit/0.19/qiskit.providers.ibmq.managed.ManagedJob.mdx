...
<Class id="qiskit.providers.ibmq.managed.ManagedJob" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-ibmq-provider/tree/stable/0.7/qiskit/providers/ibmq/managed/managedjob.py" signature="ManagedJob(start_index, experiments_count, job=None)">
  ...
  *   **job** (`Optional`\[[`IBMQJob`](qiskit.providers.ibmq.job.IBMQJob "qiskit.providers.ibmq.job.ibmqjob.IBMQJob")]) – Job to be managed, or `None` if not already known.
  ...
  <Function id="qiskit.providers.ibmq.managed.ManagedJob.result" name="result" signature="ManagedJob.result(timeout=None, partial=False)">
  ...
  <Function id="qiskit.providers.ibmq.managed.ManagedJob.submit" name="submit" signature="ManagedJob.submit(qobj, job_name, backend, executor, submit_lock, job_share_level, job_tags=None)">
    Submit the job.
