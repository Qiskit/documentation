---
title: snapshot
description: API reference for qiskit.circuit.library.MCMT.snapshot
in_page_toc_min_heading_level: 1
python_api_type: method
python_api_name: qiskit.circuit.library.MCMT.snapshot
---
...
`MCMT.snapshot(label, snapshot_type='statevector', qubits=None, params=None)`
