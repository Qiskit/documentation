---
title: TensoredMeasFitter (v0.19)
description: API reference for qiskit.ignis.mitigation.TensoredMeasFitter in qiskit v0.19
...
<Class id="qiskit.ignis.mitigation.TensoredMeasFitter" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-ignis/tree/stable/0.3/qiskit/ignis/mitigation/measurement/fitters.py" signature="TensoredMeasFitter(results, mit_pattern, substate_labels_list=None, circlabel='')" modifiers="class">
  ...
  **ValueError** – if the mit\_pattern doesn’t match the substate\_labels\_list
  ...
  <span id="tensoredmeasfitter-cal-matrices" />
  ...
  <span id="tensoredmeasfitter-filter" />
  ...
  <span id="tensoredmeasfitter-nqubits" />
  ...
  <span id="tensoredmeasfitter-substate-labels-list" />
  ...
  <span id="tensoredmeasfitter-add-data" />
  ...
  <span id="tensoredmeasfitter-plot-calibration" />
  ...
  <span id="tensoredmeasfitter-readout-fidelity" />
