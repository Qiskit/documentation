...
<Function id="qiskit.ignis.verification.state_tomography_circuits" github="https://github.com/qiskit-community/qiskit-ignis/tree/stable/0.3/qiskit/ignis/verification/tomography/basis/circuits.py" signature="state_tomography_circuits(circuit, measured_qubits, meas_labels='Pauli', meas_basis='Pauli')">
