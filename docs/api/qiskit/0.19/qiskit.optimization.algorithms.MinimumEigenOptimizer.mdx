---
title: MinimumEigenOptimizer (v0.19)
description: API reference for qiskit.optimization.algorithms.MinimumEigenOptimizer in qiskit v0.19
...
<Class id="qiskit.optimization.algorithms.MinimumEigenOptimizer" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.7/qiskit/optimization/algorithms/minimum_eigen_optimizer.py" signature="MinimumEigenOptimizer(min_eigen_solver, penalty=None)" modifiers="class">
  ...
  *   **penalty** (`Optional`\[`float`]) – The penalty factor to be used, or `None` for applying a default logic.
  ...
  <span id="minimumeigenoptimizer-get-compatibility-msg" />

  ### get\_compatibility\_msg

  <Function id="qiskit.optimization.algorithms.MinimumEigenOptimizer.get_compatibility_msg" signature="MinimumEigenOptimizer.get_compatibility_msg(problem)">
  ...
  <span id="minimumeigenoptimizer-is-compatible" />

  ### is\_compatible

  <Function id="qiskit.optimization.algorithms.MinimumEigenOptimizer.is_compatible" signature="MinimumEigenOptimizer.is_compatible(problem)">
  ...
  <span id="minimumeigenoptimizer-solve" />

  ### solve

  <Function id="qiskit.optimization.algorithms.MinimumEigenOptimizer.solve" signature="MinimumEigenOptimizer.solve(problem)">
