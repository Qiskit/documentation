...
<Class id="qiskit.circuit.library.WeightedAdder" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.14/qiskit/circuit/library/arithmetic/weighted_adder.py" signature="WeightedAdder(num_state_qubits=None, weights=None, name='adder')">
...
$$
  ...
  *   **name** (`str`) – The name of the circuit.
  ...
  <Attribute id="qiskit.circuit.library.WeightedAdder.extension_lib" signature="= 'include \&#x22;qelib1.inc\&#x22;;'" />

  ### header

  <Attribute id="qiskit.circuit.library.WeightedAdder.header" signature="= 'OPENQASM 2.0;'" />

  ### instances

  <Attribute id="qiskit.circuit.library.WeightedAdder.instances" signature="= 8" />

  ### n\_qubits

  <Attribute id="qiskit.circuit.library.WeightedAdder.n_qubits" name="n_qubits">
    Deprecated, use `num_qubits` instead. Return number of qubits.
  </Attribute>

  ### num\_ancilla\_qubits

  <Attribute id="qiskit.circuit.library.WeightedAdder.num_ancilla_qubits" name="num_ancilla_qubits" signature="int">
  ...
  <Attribute id="qiskit.circuit.library.WeightedAdder.num_carry_qubits" name="num_carry_qubits" signature="int">
  ...
  <Attribute id="qiskit.circuit.library.WeightedAdder.num_control_qubits" name="num_control_qubits" signature="int">
  ...
  <Attribute id="qiskit.circuit.library.WeightedAdder.num_state_qubits" name="num_state_qubits" signature="int">
  ...
  <Attribute id="qiskit.circuit.library.WeightedAdder.num_sum_qubits" name="num_sum_qubits" signature="int">
  ...
  <Attribute id="qiskit.circuit.library.WeightedAdder.prefix" signature="= 'circuit'" />
  ...
  <Attribute id="qiskit.circuit.library.WeightedAdder.weights" name="weights" signature="List[int]">
  ...
  <Function id="qiskit.circuit.library.WeightedAdder.AND" name="AND" signature="WeightedAdder.AND(qr_variables, qb_target, qr_ancillae, flags=None, mct_mode='no-ancilla')">
  ...
  <Function id="qiskit.circuit.library.WeightedAdder.OR" name="OR" signature="WeightedAdder.OR(qr_variables, qb_target, qr_ancillae, flags=None, mct_mode='basic')">
  ...
  <Function id="qiskit.circuit.library.WeightedAdder.__getitem__" name="__getitem__" signature="WeightedAdder.__getitem__(item)">
    Return indexed operation.
  </Function>

  ### \_\_len\_\_

  <Function id="qiskit.circuit.library.WeightedAdder.__len__" name="__len__" signature="WeightedAdder.__len__()">
    Return number of operations in circuit.
  </Function>

  ### add\_register

  <Function id="qiskit.circuit.library.WeightedAdder.add_register" name="add_register" signature="WeightedAdder.add_register(*regs)">
    Add registers.
  </Function>

  ### append

  <Function id="qiskit.circuit.library.WeightedAdder.append" name="append" signature="WeightedAdder.append(instruction, qargs=None, cargs=None)">
  ...
  <Function id="qiskit.circuit.library.WeightedAdder.assign_parameters" name="assign_parameters" signature="WeightedAdder.assign_parameters(param_dict, inplace=False)">
  ...
  <Function id="qiskit.circuit.library.WeightedAdder.barrier" name="barrier" signature="WeightedAdder.barrier(*qargs)">
    Apply `Barrier`. If qargs is None, applies to all.
  </Function>

  ### bind\_parameters

  <Function id="qiskit.circuit.library.WeightedAdder.bind_parameters" name="bind_parameters" signature="WeightedAdder.bind_parameters(value_dict)">
  ...
  <Function id="qiskit.circuit.library.WeightedAdder.cast" name="cast" signature="static WeightedAdder.cast(value, _type)">
    Best effort to cast value to type. Otherwise, returns the value.
  </Function>

  ### cbit\_argument\_conversion

  <Function id="qiskit.circuit.library.WeightedAdder.cbit_argument_conversion" name="cbit_argument_conversion" signature="WeightedAdder.cbit_argument_conversion(clbit_representation)">
  ...
  <Function id="qiskit.circuit.library.WeightedAdder.ccx" name="ccx" signature="WeightedAdder.ccx(control_qubit1, control_qubit2, target_qubit, *, ctl1=None, ctl2=None, tgt=None)">
    Apply [`CCXGate`](qiskit.circuit.library.CCXGate "qiskit.circuit.library.CCXGate").
  </Function>

  ### ch

  <Function id="qiskit.circuit.library.WeightedAdder.ch" name="ch" signature="WeightedAdder.ch(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CHGate`](qiskit.circuit.library.CHGate "qiskit.circuit.library.CHGate").
  </Function>

  ### cls\_instances

  <Function id="qiskit.circuit.library.WeightedAdder.cls_instances" name="cls_instances" signature="classmethod WeightedAdder.cls_instances()">
    Return the current number of instances of this class, useful for auto naming.
  </Function>

  ### cls\_prefix

  <Function id="qiskit.circuit.library.WeightedAdder.cls_prefix" name="cls_prefix" signature="classmethod WeightedAdder.cls_prefix()">
    Return the prefix to use for auto naming.
  </Function>

  ### cnot

  <Function id="qiskit.circuit.library.WeightedAdder.cnot" name="cnot" signature="WeightedAdder.cnot(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CXGate`](qiskit.circuit.library.CXGate "qiskit.circuit.library.CXGate").
  </Function>

  ### combine

  <Function id="qiskit.circuit.library.WeightedAdder.combine" name="combine" signature="WeightedAdder.combine(rhs)">
  ...
  <Function id="qiskit.circuit.library.WeightedAdder.compose" name="compose" signature="WeightedAdder.compose(other, qubits=None, clbits=None, front=False, inplace=False)">
  ...
  <Function id="qiskit.circuit.library.WeightedAdder.copy" name="copy" signature="WeightedAdder.copy(name=None)">
    Copy the circuit.
  ...
  <Function id="qiskit.circuit.library.WeightedAdder.count_ops" name="count_ops" signature="WeightedAdder.count_ops()">
  ...
  <Function id="qiskit.circuit.library.WeightedAdder.crx" name="crx" signature="WeightedAdder.crx(theta, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CRXGate`](qiskit.circuit.library.CRXGate "qiskit.circuit.library.CRXGate").
  </Function>

  ### cry

  <Function id="qiskit.circuit.library.WeightedAdder.cry" name="cry" signature="WeightedAdder.cry(theta, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CRYGate`](qiskit.circuit.library.CRYGate "qiskit.circuit.library.CRYGate").
  </Function>

  ### crz

  <Function id="qiskit.circuit.library.WeightedAdder.crz" name="crz" signature="WeightedAdder.crz(theta, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CRZGate`](qiskit.circuit.library.CRZGate "qiskit.circuit.library.CRZGate").
  </Function>

  ### cswap

  <Function id="qiskit.circuit.library.WeightedAdder.cswap" name="cswap" signature="WeightedAdder.cswap(control_qubit, target_qubit1, target_qubit2, *, label=None, ctrl_state=None, ctl=None, tgt1=None, tgt2=None)">
    Apply [`CSwapGate`](qiskit.circuit.library.CSwapGate "qiskit.circuit.library.CSwapGate").
  </Function>

  ### cu1

  <Function id="qiskit.circuit.library.WeightedAdder.cu1" name="cu1" signature="WeightedAdder.cu1(theta, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CU1Gate`](qiskit.circuit.library.CU1Gate "qiskit.circuit.library.CU1Gate").
  </Function>

  ### cu3

  <Function id="qiskit.circuit.library.WeightedAdder.cu3" name="cu3" signature="WeightedAdder.cu3(theta, phi, lam, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CU3Gate`](qiskit.circuit.library.CU3Gate "qiskit.circuit.library.CU3Gate").
  </Function>

  ### cx

  <Function id="qiskit.circuit.library.WeightedAdder.cx" name="cx" signature="WeightedAdder.cx(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CXGate`](qiskit.circuit.library.CXGate "qiskit.circuit.library.CXGate").
  </Function>

  ### cy

  <Function id="qiskit.circuit.library.WeightedAdder.cy" name="cy" signature="WeightedAdder.cy(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CYGate`](qiskit.circuit.library.CYGate "qiskit.circuit.library.CYGate").
  </Function>

  ### cz

  <Function id="qiskit.circuit.library.WeightedAdder.cz" name="cz" signature="WeightedAdder.cz(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CZGate`](qiskit.circuit.library.CZGate "qiskit.circuit.library.CZGate").
  </Function>

  ### dcx

  <Function id="qiskit.circuit.library.WeightedAdder.dcx" name="dcx" signature="WeightedAdder.dcx(qubit1, qubit2)">
    Apply [`DCXGate`](qiskit.circuit.library.DCXGate "qiskit.circuit.library.DCXGate").
  </Function>

  ### decompose

  <Function id="qiskit.circuit.library.WeightedAdder.decompose" name="decompose" signature="WeightedAdder.decompose()">
  ...
  <Function id="qiskit.circuit.library.WeightedAdder.depth" name="depth" signature="WeightedAdder.depth()">
  ...
  <Function id="qiskit.circuit.library.WeightedAdder.diag_gate" name="diag_gate" signature="WeightedAdder.diag_gate(diag, qubit)">
    Deprecated version of QuantumCircuit.diagonal.
  </Function>

  ### diagonal

  <Function id="qiskit.circuit.library.WeightedAdder.diagonal" name="diagonal" signature="WeightedAdder.diagonal(diag, qubit)">
  ...
  <Function id="qiskit.circuit.library.WeightedAdder.extend" name="extend" signature="WeightedAdder.extend(rhs)">
  ...
  <Function id="qiskit.circuit.library.WeightedAdder.fredkin" name="fredkin" signature="WeightedAdder.fredkin(control_qubit, target_qubit1, target_qubit2, *, ctl=None, tgt1=None, tgt2=None)">
    Apply [`CSwapGate`](qiskit.circuit.library.CSwapGate "qiskit.circuit.library.CSwapGate").
  </Function>

  ### from\_qasm\_file

  <Function id="qiskit.circuit.library.WeightedAdder.from_qasm_file" name="from_qasm_file" signature="static WeightedAdder.from_qasm_file(path)">
  ...
  <Function id="qiskit.circuit.library.WeightedAdder.from_qasm_str" name="from_qasm_str" signature="static WeightedAdder.from_qasm_str(qasm_str)">
  ...
  <Function id="qiskit.circuit.library.WeightedAdder.h" name="h" signature="WeightedAdder.h(qubit, *, q=None)">
    Apply [`HGate`](qiskit.circuit.library.HGate "qiskit.circuit.library.HGate").
  </Function>

  ### hamiltonian

  <Function id="qiskit.circuit.library.WeightedAdder.hamiltonian" name="hamiltonian" signature="WeightedAdder.hamiltonian(operator, time, qubits, label=None)">
    Apply hamiltonian evolution to to qubits.
  </Function>

  ### has\_register

  <Function id="qiskit.circuit.library.WeightedAdder.has_register" name="has_register" signature="WeightedAdder.has_register(register)">
  ...
  <Function id="qiskit.circuit.library.WeightedAdder.i" name="i" signature="WeightedAdder.i(qubit, *, q=None)">
    Apply [`IGate`](qiskit.circuit.library.IGate "qiskit.circuit.library.IGate").
  </Function>

  ### id

  <Function id="qiskit.circuit.library.WeightedAdder.id" name="id" signature="WeightedAdder.id(qubit, *, q=None)">
    Apply [`IGate`](qiskit.circuit.library.IGate "qiskit.circuit.library.IGate").
  </Function>

  ### iden

  <Function id="qiskit.circuit.library.WeightedAdder.iden" name="iden" signature="WeightedAdder.iden(qubit, *, q=None)">
    Deprecated identity gate.
  </Function>

  ### initialize

  <Function id="qiskit.circuit.library.WeightedAdder.initialize" name="initialize" signature="WeightedAdder.initialize(params, qubits)">
    Apply initialize to circuit.
  </Function>

  ### inverse

  <Function id="qiskit.circuit.library.WeightedAdder.inverse" name="inverse" signature="WeightedAdder.inverse()">
    Invert this circuit.
  ...
  <Function id="qiskit.circuit.library.WeightedAdder.iso" name="iso" signature="WeightedAdder.iso(isometry, q_input, q_ancillas_for_output, q_ancillas_zero=None, q_ancillas_dirty=None)">
  ...
  <Function id="qiskit.circuit.library.WeightedAdder.isometry" name="isometry" signature="WeightedAdder.isometry(isometry, q_input, q_ancillas_for_output, q_ancillas_zero=None, q_ancillas_dirty=None)">
    Attach an arbitrary isometry from m to n qubits to a circuit. In particular, this allows to attach arbitrary unitaries on n qubits (m=n) or to prepare any state on n qubits (m=0). The decomposition used here was introduced by Iten et al. in [https://arxiv.org/abs/1501.06911](https://arxiv.org/abs/1501.06911).
  ...
  <Function id="qiskit.circuit.library.WeightedAdder.iswap" name="iswap" signature="WeightedAdder.iswap(qubit1, qubit2)">
    Apply [`iSwapGate`](qiskit.circuit.library.iSwapGate "qiskit.circuit.library.iSwapGate").
  </Function>

  ### mcmt

  <Function id="qiskit.circuit.library.WeightedAdder.mcmt" name="mcmt" signature="WeightedAdder.mcmt(gate, control_qubits, target_qubits, ancilla_qubits=None, mode='no-ancilla', *, single_control_gate_fun=None, q_controls=None, q_ancillae=None, q_targets=None)">
  ...
  <Function id="qiskit.circuit.library.WeightedAdder.mcrx" name="mcrx" signature="WeightedAdder.mcrx(theta, q_controls, q_target, use_basis_gates=False)">
  ...
  <Function id="qiskit.circuit.library.WeightedAdder.mcry" name="mcry" signature="WeightedAdder.mcry(theta, q_controls, q_target, q_ancillae, mode='basic', use_basis_gates=False)">
  ...
  <Function id="qiskit.circuit.library.WeightedAdder.mcrz" name="mcrz" signature="WeightedAdder.mcrz(lam, q_controls, q_target, use_basis_gates=False)">
  ...
  <Function id="qiskit.circuit.library.WeightedAdder.mct" name="mct" signature="WeightedAdder.mct(control_qubits, target_qubit, ancilla_qubits=None, mode='noancilla')">
    Apply `MCXGate`.
  </Function>

  ### mcu1

  <Function id="qiskit.circuit.library.WeightedAdder.mcu1" name="mcu1" signature="WeightedAdder.mcu1(lam, control_qubits, target_qubit)">
    Apply `MCU1Gate`.
  </Function>

  ### mcx

  <Function id="qiskit.circuit.library.WeightedAdder.mcx" name="mcx" signature="WeightedAdder.mcx(control_qubits, target_qubit, ancilla_qubits=None, mode='noancilla')">
    Apply `MCXGate`.
  ...
  <Function id="qiskit.circuit.library.WeightedAdder.measure" name="measure" signature="WeightedAdder.measure(qubit, cbit)">
  ...
  <Function id="qiskit.circuit.library.WeightedAdder.measure_active" name="measure_active" signature="WeightedAdder.measure_active(inplace=True)">
  ...
  <Function id="qiskit.circuit.library.WeightedAdder.measure_all" name="measure_all" signature="WeightedAdder.measure_all(inplace=True)">
  ...
  <Function id="qiskit.circuit.library.WeightedAdder.mirror" name="mirror" signature="WeightedAdder.mirror()">
  ...
  <Function id="qiskit.circuit.library.WeightedAdder.ms" name="ms" signature="WeightedAdder.ms(theta, qubits)">
    Apply [`MSGate`](qiskit.circuit.library.MSGate "qiskit.circuit.library.MSGate").
  </Function>

  ### num\_connected\_components

  <Function id="qiskit.circuit.library.WeightedAdder.num_connected_components" name="num_connected_components" signature="WeightedAdder.num_connected_components(unitary_only=False)">
  ...
  <Function id="qiskit.circuit.library.WeightedAdder.num_nonlocal_gates" name="num_nonlocal_gates" signature="WeightedAdder.num_nonlocal_gates()">
  ...
  <Function id="qiskit.circuit.library.WeightedAdder.num_tensor_factors" name="num_tensor_factors" signature="WeightedAdder.num_tensor_factors()">
  ...
  <Function id="qiskit.circuit.library.WeightedAdder.num_unitary_factors" name="num_unitary_factors" signature="WeightedAdder.num_unitary_factors()">
    Computes the number of tensor factors in the unitary (quantum) part of the circuit only.
  </Function>

  ### qasm

  <Function id="qiskit.circuit.library.WeightedAdder.qasm" name="qasm" signature="WeightedAdder.qasm(formatted=False, filename=None)">
  ...
  <Function id="qiskit.circuit.library.WeightedAdder.qbit_argument_conversion" name="qbit_argument_conversion" signature="WeightedAdder.qbit_argument_conversion(qubit_representation)">
  ...
  <Function id="qiskit.circuit.library.WeightedAdder.r" name="r" signature="WeightedAdder.r(theta, phi, qubit, *, q=None)">
    Apply `RGate`.
  </Function>

  ### rcccx

  <Function id="qiskit.circuit.library.WeightedAdder.rcccx" name="rcccx" signature="WeightedAdder.rcccx(control_qubit1, control_qubit2, control_qubit3, target_qubit)">
    Apply [`RC3XGate`](qiskit.circuit.library.RC3XGate "qiskit.circuit.library.RC3XGate").
  </Function>

  ### rccx

  <Function id="qiskit.circuit.library.WeightedAdder.rccx" name="rccx" signature="WeightedAdder.rccx(control_qubit1, control_qubit2, target_qubit)">
    Apply [`RCCXGate`](qiskit.circuit.library.RCCXGate "qiskit.circuit.library.RCCXGate").
  </Function>

  ### remove\_final\_measurements

  <Function id="qiskit.circuit.library.WeightedAdder.remove_final_measurements" name="remove_final_measurements" signature="WeightedAdder.remove_final_measurements(inplace=True)">
  ...
  <Function id="qiskit.circuit.library.WeightedAdder.reset" name="reset" signature="WeightedAdder.reset(qubit)">
    Reset q.
  </Function>

  ### rx

  <Function id="qiskit.circuit.library.WeightedAdder.rx" name="rx" signature="WeightedAdder.rx(theta, qubit, *, label=None, q=None)">
    Apply [`RXGate`](qiskit.circuit.library.RXGate "qiskit.circuit.library.RXGate").
  </Function>

  ### rxx

  <Function id="qiskit.circuit.library.WeightedAdder.rxx" name="rxx" signature="WeightedAdder.rxx(theta, qubit1, qubit2)">
    Apply [`RXXGate`](qiskit.circuit.library.RXXGate "qiskit.circuit.library.RXXGate").
  </Function>

  ### ry

  <Function id="qiskit.circuit.library.WeightedAdder.ry" name="ry" signature="WeightedAdder.ry(theta, qubit, *, label=None, q=None)">
    Apply [`RYGate`](qiskit.circuit.library.RYGate "qiskit.circuit.library.RYGate").
  </Function>

  ### ryy

  <Function id="qiskit.circuit.library.WeightedAdder.ryy" name="ryy" signature="WeightedAdder.ryy(theta, qubit1, qubit2)">
    Apply [`RYYGate`](qiskit.circuit.library.RYYGate "qiskit.circuit.library.RYYGate").
  </Function>

  ### rz

  <Function id="qiskit.circuit.library.WeightedAdder.rz" name="rz" signature="WeightedAdder.rz(phi, qubit, *, q=None)">
    Apply [`RZGate`](qiskit.circuit.library.RZGate "qiskit.circuit.library.RZGate").
  </Function>

  ### rzx

  <Function id="qiskit.circuit.library.WeightedAdder.rzx" name="rzx" signature="WeightedAdder.rzx(theta, qubit1, qubit2)">
    Apply [`RZXGate`](qiskit.circuit.library.RZXGate "qiskit.circuit.library.RZXGate").
  </Function>

  ### rzz

  <Function id="qiskit.circuit.library.WeightedAdder.rzz" name="rzz" signature="WeightedAdder.rzz(theta, qubit1, qubit2)">
    Apply [`RZZGate`](qiskit.circuit.library.RZZGate "qiskit.circuit.library.RZZGate").
  </Function>

  ### s

  <Function id="qiskit.circuit.library.WeightedAdder.s" name="s" signature="WeightedAdder.s(qubit, *, q=None)">
    Apply [`SGate`](qiskit.circuit.library.SGate "qiskit.circuit.library.SGate").
  </Function>

  ### sdg

  <Function id="qiskit.circuit.library.WeightedAdder.sdg" name="sdg" signature="WeightedAdder.sdg(qubit, *, q=None)">
    Apply [`SdgGate`](qiskit.circuit.library.SdgGate "qiskit.circuit.library.SdgGate").
  </Function>

  ### size

  <Function id="qiskit.circuit.library.WeightedAdder.size" name="size" signature="WeightedAdder.size()">
  ...
  <Function id="qiskit.circuit.library.WeightedAdder.snapshot" name="snapshot" signature="WeightedAdder.snapshot(label, snapshot_type='statevector', qubits=None, params=None)">
  ...
  <Function id="qiskit.circuit.library.WeightedAdder.snapshot_density_matrix" name="snapshot_density_matrix" signature="WeightedAdder.snapshot_density_matrix(label, qubits=None)">
  ...
  <Function id="qiskit.circuit.library.WeightedAdder.snapshot_expectation_value" name="snapshot_expectation_value" signature="WeightedAdder.snapshot_expectation_value(label, op, qubits, single_shot=False, variance=False)">
  ...
  <Function id="qiskit.circuit.library.WeightedAdder.snapshot_probabilities" name="snapshot_probabilities" signature="WeightedAdder.snapshot_probabilities(label, qubits, variance=False)">
  ...
  <Function id="qiskit.circuit.library.WeightedAdder.snapshot_stabilizer" name="snapshot_stabilizer" signature="WeightedAdder.snapshot_stabilizer(label)">
  ...
  <Function id="qiskit.circuit.library.WeightedAdder.snapshot_statevector" name="snapshot_statevector" signature="WeightedAdder.snapshot_statevector(label)">
  ...
  <Function id="qiskit.circuit.library.WeightedAdder.squ" name="squ" signature="WeightedAdder.squ(unitary_matrix, qubit, mode='ZYZ', up_to_diagonal=False, *, u=None)">
  ...
  <Function id="qiskit.circuit.library.WeightedAdder.swap" name="swap" signature="WeightedAdder.swap(qubit1, qubit2)">
    Apply [`SwapGate`](qiskit.circuit.library.SwapGate "qiskit.circuit.library.SwapGate").
  </Function>

  ### t

  <Function id="qiskit.circuit.library.WeightedAdder.t" name="t" signature="WeightedAdder.t(qubit, *, q=None)">
    Apply [`TGate`](qiskit.circuit.library.TGate "qiskit.circuit.library.TGate").
  </Function>

  ### tdg

  <Function id="qiskit.circuit.library.WeightedAdder.tdg" name="tdg" signature="WeightedAdder.tdg(qubit, *, q=None)">
    Apply [`TdgGate`](qiskit.circuit.library.TdgGate "qiskit.circuit.library.TdgGate").
  </Function>

  ### to\_gate

  <Function id="qiskit.circuit.library.WeightedAdder.to_gate" name="to_gate" signature="WeightedAdder.to_gate(parameter_map=None)">
  ...
  <Function id="qiskit.circuit.library.WeightedAdder.to_instruction" name="to_instruction" signature="WeightedAdder.to_instruction(parameter_map=None)">
  ...
  <Function id="qiskit.circuit.library.WeightedAdder.toffoli" name="toffoli" signature="WeightedAdder.toffoli(control_qubit1, control_qubit2, target_qubit, *, ctl1=None, ctl2=None, tgt=None)">
    Apply [`CCXGate`](qiskit.circuit.library.CCXGate "qiskit.circuit.library.CCXGate").
  </Function>

  ### u1

  <Function id="qiskit.circuit.library.WeightedAdder.u1" name="u1" signature="WeightedAdder.u1(theta, qubit, *, q=None)">
    Apply [`U1Gate`](qiskit.circuit.library.U1Gate "qiskit.circuit.library.U1Gate").
  </Function>

  ### u2

  <Function id="qiskit.circuit.library.WeightedAdder.u2" name="u2" signature="WeightedAdder.u2(phi, lam, qubit, *, q=None)">
    Apply [`U2Gate`](qiskit.circuit.library.U2Gate "qiskit.circuit.library.U2Gate").
  </Function>

  ### u3

  <Function id="qiskit.circuit.library.WeightedAdder.u3" name="u3" signature="WeightedAdder.u3(theta, phi, lam, qubit, *, q=None)">
    Apply [`U3Gate`](qiskit.circuit.library.U3Gate "qiskit.circuit.library.U3Gate").
  </Function>

  ### uc

  <Function id="qiskit.circuit.library.WeightedAdder.uc" name="uc" signature="WeightedAdder.uc(gate_list, q_controls, q_target, up_to_diagonal=False)">
  ...
  <Function id="qiskit.circuit.library.WeightedAdder.ucg" name="ucg" signature="WeightedAdder.ucg(angle_list, q_controls, q_target, up_to_diagonal=False)">
    Deprecated version of uc.
  </Function>

  ### ucrx

  <Function id="qiskit.circuit.library.WeightedAdder.ucrx" name="ucrx" signature="WeightedAdder.ucrx(angle_list, q_controls, q_target)">
  ...
  <Function id="qiskit.circuit.library.WeightedAdder.ucry" name="ucry" signature="WeightedAdder.ucry(angle_list, q_controls, q_target)">
  ...
  <Function id="qiskit.circuit.library.WeightedAdder.ucrz" name="ucrz" signature="WeightedAdder.ucrz(angle_list, q_controls, q_target)">
  ...
  <Function id="qiskit.circuit.library.WeightedAdder.ucx" name="ucx" signature="WeightedAdder.ucx(angle_list, q_controls, q_target)">
    Deprecated version of ucrx.
  </Function>

  ### ucy

  <Function id="qiskit.circuit.library.WeightedAdder.ucy" name="ucy" signature="WeightedAdder.ucy(angle_list, q_controls, q_target)">
    Deprecated version of ucry.
  </Function>

  ### ucz

  <Function id="qiskit.circuit.library.WeightedAdder.ucz" name="ucz" signature="WeightedAdder.ucz(angle_list, q_controls, q_target)">
    Deprecated version of ucrz.
  </Function>

  ### unitary

  <Function id="qiskit.circuit.library.WeightedAdder.unitary" name="unitary" signature="WeightedAdder.unitary(obj, qubits, label=None)">
    Apply unitary gate to q.
  </Function>

  ### width

  <Function id="qiskit.circuit.library.WeightedAdder.width" name="width" signature="WeightedAdder.width()">
  ...
  <Function id="qiskit.circuit.library.WeightedAdder.x" name="x" signature="WeightedAdder.x(qubit, *, label=None, ctrl_state=None, q=None)">
    Apply [`XGate`](qiskit.circuit.library.XGate "qiskit.circuit.library.XGate").
  </Function>

  ### y

  <Function id="qiskit.circuit.library.WeightedAdder.y" name="y" signature="WeightedAdder.y(qubit, *, q=None)">
    Apply [`YGate`](qiskit.circuit.library.YGate "qiskit.circuit.library.YGate").
  </Function>

  ### z

  <Function id="qiskit.circuit.library.WeightedAdder.z" name="z" signature="WeightedAdder.z(qubit, *, q=None)">
