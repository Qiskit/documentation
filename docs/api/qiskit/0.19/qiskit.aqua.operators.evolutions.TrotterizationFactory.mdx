...
<Class id="qiskit.aqua.operators.evolutions.TrotterizationFactory" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.7/qiskit/aqua/operators/evolutions/trotterizations/trotterization_factory.py" signature="TrotterizationFactory">
  ...
  <Function id="qiskit.aqua.operators.evolutions.TrotterizationFactory.build" name="build" signature="static TrotterizationFactory.build(mode='trotter', reps=1)">
    A factory for conveniently creating TrotterizationBase instances.
