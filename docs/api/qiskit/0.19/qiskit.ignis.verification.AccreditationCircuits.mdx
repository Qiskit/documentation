---
title: AccreditationCircuits (v0.19)
description: API reference for qiskit.ignis.verification.AccreditationCircuits in qiskit v0.19
...
<Class id="qiskit.ignis.verification.AccreditationCircuits" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-ignis/tree/stable/0.3/qiskit/ignis/verification/accreditation/circuits.py" signature="AccreditationCircuits(target_circ, two_qubit_gate='cx', coupling_map=None, seed=None)" modifiers="class">
  ...
  *   **seed** (*int*) – seed to the random number generator
  ...
  <span id="accreditationcircuits-generate-circuits" />
  ...
  <span id="accreditationcircuits-target-circuit" />
