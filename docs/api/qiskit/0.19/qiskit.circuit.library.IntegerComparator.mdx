...
<Class id="qiskit.circuit.library.IntegerComparator" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.14/qiskit/circuit/library/arithmetic/integer_comparator.py" signature="IntegerComparator(num_state_qubits=None, value=None, geq=True, name='cmp')">
  Integer Comparator.
...
$$
  ...
  *   **name** (`str`) – Name of the circuit.
  ...
  <Attribute id="qiskit.circuit.library.IntegerComparator.extension_lib" signature="= 'include \&#x22;qelib1.inc\&#x22;;'" />

  ### geq

  <Attribute id="qiskit.circuit.library.IntegerComparator.geq" name="geq" signature="bool">
  ...
  <Attribute id="qiskit.circuit.library.IntegerComparator.header" signature="= 'OPENQASM 2.0;'" />

  ### instances

  <Attribute id="qiskit.circuit.library.IntegerComparator.instances" signature="= 8" />

  ### n\_qubits

  <Attribute id="qiskit.circuit.library.IntegerComparator.n_qubits" name="n_qubits">
    Deprecated, use `num_qubits` instead. Return number of qubits.
  </Attribute>

  ### num\_ancilla\_qubits

  <Attribute id="qiskit.circuit.library.IntegerComparator.num_ancilla_qubits" name="num_ancilla_qubits" signature="int">
  ...
  <Attribute id="qiskit.circuit.library.IntegerComparator.num_state_qubits" name="num_state_qubits" signature="int">
  ...
  <Attribute id="qiskit.circuit.library.IntegerComparator.prefix" signature="= 'circuit'" />
  ...
  <Attribute id="qiskit.circuit.library.IntegerComparator.value" name="value" signature="int">
  ...
  <Function id="qiskit.circuit.library.IntegerComparator.AND" name="AND" signature="IntegerComparator.AND(qr_variables, qb_target, qr_ancillae, flags=None, mct_mode='no-ancilla')">
  ...
  <Function id="qiskit.circuit.library.IntegerComparator.OR" name="OR" signature="IntegerComparator.OR(qr_variables, qb_target, qr_ancillae, flags=None, mct_mode='basic')">
  ...
  <Function id="qiskit.circuit.library.IntegerComparator.__getitem__" name="__getitem__" signature="IntegerComparator.__getitem__(item)">
    Return indexed operation.
  </Function>

  ### \_\_len\_\_

  <Function id="qiskit.circuit.library.IntegerComparator.__len__" name="__len__" signature="IntegerComparator.__len__()">
    Return number of operations in circuit.
  </Function>

  ### add\_register

  <Function id="qiskit.circuit.library.IntegerComparator.add_register" name="add_register" signature="IntegerComparator.add_register(*regs)">
    Add registers.
  </Function>

  ### append

  <Function id="qiskit.circuit.library.IntegerComparator.append" name="append" signature="IntegerComparator.append(instruction, qargs=None, cargs=None)">
  ...
  <Function id="qiskit.circuit.library.IntegerComparator.assign_parameters" name="assign_parameters" signature="IntegerComparator.assign_parameters(param_dict, inplace=False)">
  ...
  <Function id="qiskit.circuit.library.IntegerComparator.barrier" name="barrier" signature="IntegerComparator.barrier(*qargs)">
    Apply `Barrier`. If qargs is None, applies to all.
  </Function>

  ### bind\_parameters

  <Function id="qiskit.circuit.library.IntegerComparator.bind_parameters" name="bind_parameters" signature="IntegerComparator.bind_parameters(value_dict)">
  ...
  <Function id="qiskit.circuit.library.IntegerComparator.cast" name="cast" signature="static IntegerComparator.cast(value, _type)">
    Best effort to cast value to type. Otherwise, returns the value.
  </Function>

  ### cbit\_argument\_conversion

  <Function id="qiskit.circuit.library.IntegerComparator.cbit_argument_conversion" name="cbit_argument_conversion" signature="IntegerComparator.cbit_argument_conversion(clbit_representation)">
  ...
  <Function id="qiskit.circuit.library.IntegerComparator.ccx" name="ccx" signature="IntegerComparator.ccx(control_qubit1, control_qubit2, target_qubit, *, ctl1=None, ctl2=None, tgt=None)">
    Apply [`CCXGate`](qiskit.circuit.library.CCXGate "qiskit.circuit.library.CCXGate").
  </Function>

  ### ch

  <Function id="qiskit.circuit.library.IntegerComparator.ch" name="ch" signature="IntegerComparator.ch(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CHGate`](qiskit.circuit.library.CHGate "qiskit.circuit.library.CHGate").
  </Function>

  ### cls\_instances

  <Function id="qiskit.circuit.library.IntegerComparator.cls_instances" name="cls_instances" signature="classmethod IntegerComparator.cls_instances()">
    Return the current number of instances of this class, useful for auto naming.
  </Function>

  ### cls\_prefix

  <Function id="qiskit.circuit.library.IntegerComparator.cls_prefix" name="cls_prefix" signature="classmethod IntegerComparator.cls_prefix()">
    Return the prefix to use for auto naming.
  </Function>

  ### cnot

  <Function id="qiskit.circuit.library.IntegerComparator.cnot" name="cnot" signature="IntegerComparator.cnot(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CXGate`](qiskit.circuit.library.CXGate "qiskit.circuit.library.CXGate").
  </Function>

  ### combine

  <Function id="qiskit.circuit.library.IntegerComparator.combine" name="combine" signature="IntegerComparator.combine(rhs)">
  ...
  <Function id="qiskit.circuit.library.IntegerComparator.compose" name="compose" signature="IntegerComparator.compose(other, qubits=None, clbits=None, front=False, inplace=False)">
  ...
  <Function id="qiskit.circuit.library.IntegerComparator.copy" name="copy" signature="IntegerComparator.copy(name=None)">
    Copy the circuit.
  ...
  <Function id="qiskit.circuit.library.IntegerComparator.count_ops" name="count_ops" signature="IntegerComparator.count_ops()">
  ...
  <Function id="qiskit.circuit.library.IntegerComparator.crx" name="crx" signature="IntegerComparator.crx(theta, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CRXGate`](qiskit.circuit.library.CRXGate "qiskit.circuit.library.CRXGate").
  </Function>

  ### cry

  <Function id="qiskit.circuit.library.IntegerComparator.cry" name="cry" signature="IntegerComparator.cry(theta, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CRYGate`](qiskit.circuit.library.CRYGate "qiskit.circuit.library.CRYGate").
  </Function>

  ### crz

  <Function id="qiskit.circuit.library.IntegerComparator.crz" name="crz" signature="IntegerComparator.crz(theta, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CRZGate`](qiskit.circuit.library.CRZGate "qiskit.circuit.library.CRZGate").
  </Function>

  ### cswap

  <Function id="qiskit.circuit.library.IntegerComparator.cswap" name="cswap" signature="IntegerComparator.cswap(control_qubit, target_qubit1, target_qubit2, *, label=None, ctrl_state=None, ctl=None, tgt1=None, tgt2=None)">
    Apply [`CSwapGate`](qiskit.circuit.library.CSwapGate "qiskit.circuit.library.CSwapGate").
  </Function>

  ### cu1

  <Function id="qiskit.circuit.library.IntegerComparator.cu1" name="cu1" signature="IntegerComparator.cu1(theta, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CU1Gate`](qiskit.circuit.library.CU1Gate "qiskit.circuit.library.CU1Gate").
  </Function>

  ### cu3

  <Function id="qiskit.circuit.library.IntegerComparator.cu3" name="cu3" signature="IntegerComparator.cu3(theta, phi, lam, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CU3Gate`](qiskit.circuit.library.CU3Gate "qiskit.circuit.library.CU3Gate").
  </Function>

  ### cx

  <Function id="qiskit.circuit.library.IntegerComparator.cx" name="cx" signature="IntegerComparator.cx(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CXGate`](qiskit.circuit.library.CXGate "qiskit.circuit.library.CXGate").
  </Function>

  ### cy

  <Function id="qiskit.circuit.library.IntegerComparator.cy" name="cy" signature="IntegerComparator.cy(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CYGate`](qiskit.circuit.library.CYGate "qiskit.circuit.library.CYGate").
  </Function>

  ### cz

  <Function id="qiskit.circuit.library.IntegerComparator.cz" name="cz" signature="IntegerComparator.cz(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CZGate`](qiskit.circuit.library.CZGate "qiskit.circuit.library.CZGate").
  </Function>

  ### dcx

  <Function id="qiskit.circuit.library.IntegerComparator.dcx" name="dcx" signature="IntegerComparator.dcx(qubit1, qubit2)">
    Apply [`DCXGate`](qiskit.circuit.library.DCXGate "qiskit.circuit.library.DCXGate").
  </Function>

  ### decompose

  <Function id="qiskit.circuit.library.IntegerComparator.decompose" name="decompose" signature="IntegerComparator.decompose()">
  ...
  <Function id="qiskit.circuit.library.IntegerComparator.depth" name="depth" signature="IntegerComparator.depth()">
  ...
  <Function id="qiskit.circuit.library.IntegerComparator.diag_gate" name="diag_gate" signature="IntegerComparator.diag_gate(diag, qubit)">
    Deprecated version of QuantumCircuit.diagonal.
  </Function>

  ### diagonal

  <Function id="qiskit.circuit.library.IntegerComparator.diagonal" name="diagonal" signature="IntegerComparator.diagonal(diag, qubit)">
  ...
  <Function id="qiskit.circuit.library.IntegerComparator.extend" name="extend" signature="IntegerComparator.extend(rhs)">
  ...
  <Function id="qiskit.circuit.library.IntegerComparator.fredkin" name="fredkin" signature="IntegerComparator.fredkin(control_qubit, target_qubit1, target_qubit2, *, ctl=None, tgt1=None, tgt2=None)">
    Apply [`CSwapGate`](qiskit.circuit.library.CSwapGate "qiskit.circuit.library.CSwapGate").
  </Function>

  ### from\_qasm\_file

  <Function id="qiskit.circuit.library.IntegerComparator.from_qasm_file" name="from_qasm_file" signature="static IntegerComparator.from_qasm_file(path)">
  ...
  <Function id="qiskit.circuit.library.IntegerComparator.from_qasm_str" name="from_qasm_str" signature="static IntegerComparator.from_qasm_str(qasm_str)">
  ...
  <Function id="qiskit.circuit.library.IntegerComparator.h" name="h" signature="IntegerComparator.h(qubit, *, q=None)">
    Apply [`HGate`](qiskit.circuit.library.HGate "qiskit.circuit.library.HGate").
  </Function>

  ### hamiltonian

  <Function id="qiskit.circuit.library.IntegerComparator.hamiltonian" name="hamiltonian" signature="IntegerComparator.hamiltonian(operator, time, qubits, label=None)">
    Apply hamiltonian evolution to to qubits.
  </Function>

  ### has\_register

  <Function id="qiskit.circuit.library.IntegerComparator.has_register" name="has_register" signature="IntegerComparator.has_register(register)">
  ...
  <Function id="qiskit.circuit.library.IntegerComparator.i" name="i" signature="IntegerComparator.i(qubit, *, q=None)">
    Apply [`IGate`](qiskit.circuit.library.IGate "qiskit.circuit.library.IGate").
  </Function>

  ### id

  <Function id="qiskit.circuit.library.IntegerComparator.id" name="id" signature="IntegerComparator.id(qubit, *, q=None)">
    Apply [`IGate`](qiskit.circuit.library.IGate "qiskit.circuit.library.IGate").
  </Function>

  ### iden

  <Function id="qiskit.circuit.library.IntegerComparator.iden" name="iden" signature="IntegerComparator.iden(qubit, *, q=None)">
    Deprecated identity gate.
  </Function>

  ### initialize

  <Function id="qiskit.circuit.library.IntegerComparator.initialize" name="initialize" signature="IntegerComparator.initialize(params, qubits)">
    Apply initialize to circuit.
  </Function>

  ### inverse

  <Function id="qiskit.circuit.library.IntegerComparator.inverse" name="inverse" signature="IntegerComparator.inverse()">
    Invert this circuit.
  ...
  <Function id="qiskit.circuit.library.IntegerComparator.iso" name="iso" signature="IntegerComparator.iso(isometry, q_input, q_ancillas_for_output, q_ancillas_zero=None, q_ancillas_dirty=None)">
  ...
  <Function id="qiskit.circuit.library.IntegerComparator.isometry" name="isometry" signature="IntegerComparator.isometry(isometry, q_input, q_ancillas_for_output, q_ancillas_zero=None, q_ancillas_dirty=None)">
    Attach an arbitrary isometry from m to n qubits to a circuit. In particular, this allows to attach arbitrary unitaries on n qubits (m=n) or to prepare any state on n qubits (m=0). The decomposition used here was introduced by Iten et al. in [https://arxiv.org/abs/1501.06911](https://arxiv.org/abs/1501.06911).
  ...
  <Function id="qiskit.circuit.library.IntegerComparator.iswap" name="iswap" signature="IntegerComparator.iswap(qubit1, qubit2)">
    Apply [`iSwapGate`](qiskit.circuit.library.iSwapGate "qiskit.circuit.library.iSwapGate").
  </Function>

  ### mcmt

  <Function id="qiskit.circuit.library.IntegerComparator.mcmt" name="mcmt" signature="IntegerComparator.mcmt(gate, control_qubits, target_qubits, ancilla_qubits=None, mode='no-ancilla', *, single_control_gate_fun=None, q_controls=None, q_ancillae=None, q_targets=None)">
  ...
  <Function id="qiskit.circuit.library.IntegerComparator.mcrx" name="mcrx" signature="IntegerComparator.mcrx(theta, q_controls, q_target, use_basis_gates=False)">
  ...
  <Function id="qiskit.circuit.library.IntegerComparator.mcry" name="mcry" signature="IntegerComparator.mcry(theta, q_controls, q_target, q_ancillae, mode='basic', use_basis_gates=False)">
  ...
  <Function id="qiskit.circuit.library.IntegerComparator.mcrz" name="mcrz" signature="IntegerComparator.mcrz(lam, q_controls, q_target, use_basis_gates=False)">
  ...
  <Function id="qiskit.circuit.library.IntegerComparator.mct" name="mct" signature="IntegerComparator.mct(control_qubits, target_qubit, ancilla_qubits=None, mode='noancilla')">
    Apply `MCXGate`.
  </Function>

  ### mcu1

  <Function id="qiskit.circuit.library.IntegerComparator.mcu1" name="mcu1" signature="IntegerComparator.mcu1(lam, control_qubits, target_qubit)">
    Apply `MCU1Gate`.
  </Function>

  ### mcx

  <Function id="qiskit.circuit.library.IntegerComparator.mcx" name="mcx" signature="IntegerComparator.mcx(control_qubits, target_qubit, ancilla_qubits=None, mode='noancilla')">
    Apply `MCXGate`.
  ...
  <Function id="qiskit.circuit.library.IntegerComparator.measure" name="measure" signature="IntegerComparator.measure(qubit, cbit)">
  ...
  <Function id="qiskit.circuit.library.IntegerComparator.measure_active" name="measure_active" signature="IntegerComparator.measure_active(inplace=True)">
  ...
  <Function id="qiskit.circuit.library.IntegerComparator.measure_all" name="measure_all" signature="IntegerComparator.measure_all(inplace=True)">
  ...
  <Function id="qiskit.circuit.library.IntegerComparator.mirror" name="mirror" signature="IntegerComparator.mirror()">
  ...
  <Function id="qiskit.circuit.library.IntegerComparator.ms" name="ms" signature="IntegerComparator.ms(theta, qubits)">
    Apply [`MSGate`](qiskit.circuit.library.MSGate "qiskit.circuit.library.MSGate").
  </Function>

  ### num\_connected\_components

  <Function id="qiskit.circuit.library.IntegerComparator.num_connected_components" name="num_connected_components" signature="IntegerComparator.num_connected_components(unitary_only=False)">
  ...
  <Function id="qiskit.circuit.library.IntegerComparator.num_nonlocal_gates" name="num_nonlocal_gates" signature="IntegerComparator.num_nonlocal_gates()">
  ...
  <Function id="qiskit.circuit.library.IntegerComparator.num_tensor_factors" name="num_tensor_factors" signature="IntegerComparator.num_tensor_factors()">
  ...
  <Function id="qiskit.circuit.library.IntegerComparator.num_unitary_factors" name="num_unitary_factors" signature="IntegerComparator.num_unitary_factors()">
    Computes the number of tensor factors in the unitary (quantum) part of the circuit only.
  </Function>

  ### qasm

  <Function id="qiskit.circuit.library.IntegerComparator.qasm" name="qasm" signature="IntegerComparator.qasm(formatted=False, filename=None)">
  ...
  <Function id="qiskit.circuit.library.IntegerComparator.qbit_argument_conversion" name="qbit_argument_conversion" signature="IntegerComparator.qbit_argument_conversion(qubit_representation)">
  ...
  <Function id="qiskit.circuit.library.IntegerComparator.r" name="r" signature="IntegerComparator.r(theta, phi, qubit, *, q=None)">
    Apply `RGate`.
  </Function>

  ### rcccx

  <Function id="qiskit.circuit.library.IntegerComparator.rcccx" name="rcccx" signature="IntegerComparator.rcccx(control_qubit1, control_qubit2, control_qubit3, target_qubit)">
    Apply [`RC3XGate`](qiskit.circuit.library.RC3XGate "qiskit.circuit.library.RC3XGate").
  </Function>

  ### rccx

  <Function id="qiskit.circuit.library.IntegerComparator.rccx" name="rccx" signature="IntegerComparator.rccx(control_qubit1, control_qubit2, target_qubit)">
    Apply [`RCCXGate`](qiskit.circuit.library.RCCXGate "qiskit.circuit.library.RCCXGate").
  </Function>

  ### remove\_final\_measurements

  <Function id="qiskit.circuit.library.IntegerComparator.remove_final_measurements" name="remove_final_measurements" signature="IntegerComparator.remove_final_measurements(inplace=True)">
  ...
  <Function id="qiskit.circuit.library.IntegerComparator.reset" name="reset" signature="IntegerComparator.reset(qubit)">
    Reset q.
  </Function>

  ### rx

  <Function id="qiskit.circuit.library.IntegerComparator.rx" name="rx" signature="IntegerComparator.rx(theta, qubit, *, label=None, q=None)">
    Apply [`RXGate`](qiskit.circuit.library.RXGate "qiskit.circuit.library.RXGate").
  </Function>

  ### rxx

  <Function id="qiskit.circuit.library.IntegerComparator.rxx" name="rxx" signature="IntegerComparator.rxx(theta, qubit1, qubit2)">
    Apply [`RXXGate`](qiskit.circuit.library.RXXGate "qiskit.circuit.library.RXXGate").
  </Function>

  ### ry

  <Function id="qiskit.circuit.library.IntegerComparator.ry" name="ry" signature="IntegerComparator.ry(theta, qubit, *, label=None, q=None)">
    Apply [`RYGate`](qiskit.circuit.library.RYGate "qiskit.circuit.library.RYGate").
  </Function>

  ### ryy

  <Function id="qiskit.circuit.library.IntegerComparator.ryy" name="ryy" signature="IntegerComparator.ryy(theta, qubit1, qubit2)">
    Apply [`RYYGate`](qiskit.circuit.library.RYYGate "qiskit.circuit.library.RYYGate").
  </Function>

  ### rz

  <Function id="qiskit.circuit.library.IntegerComparator.rz" name="rz" signature="IntegerComparator.rz(phi, qubit, *, q=None)">
    Apply [`RZGate`](qiskit.circuit.library.RZGate "qiskit.circuit.library.RZGate").
  </Function>

  ### rzx

  <Function id="qiskit.circuit.library.IntegerComparator.rzx" name="rzx" signature="IntegerComparator.rzx(theta, qubit1, qubit2)">
    Apply [`RZXGate`](qiskit.circuit.library.RZXGate "qiskit.circuit.library.RZXGate").
  </Function>

  ### rzz

  <Function id="qiskit.circuit.library.IntegerComparator.rzz" name="rzz" signature="IntegerComparator.rzz(theta, qubit1, qubit2)">
    Apply [`RZZGate`](qiskit.circuit.library.RZZGate "qiskit.circuit.library.RZZGate").
  </Function>

  ### s

  <Function id="qiskit.circuit.library.IntegerComparator.s" name="s" signature="IntegerComparator.s(qubit, *, q=None)">
    Apply [`SGate`](qiskit.circuit.library.SGate "qiskit.circuit.library.SGate").
  </Function>

  ### sdg

  <Function id="qiskit.circuit.library.IntegerComparator.sdg" name="sdg" signature="IntegerComparator.sdg(qubit, *, q=None)">
    Apply [`SdgGate`](qiskit.circuit.library.SdgGate "qiskit.circuit.library.SdgGate").
  </Function>

  ### size

  <Function id="qiskit.circuit.library.IntegerComparator.size" name="size" signature="IntegerComparator.size()">
  ...
  <Function id="qiskit.circuit.library.IntegerComparator.snapshot" name="snapshot" signature="IntegerComparator.snapshot(label, snapshot_type='statevector', qubits=None, params=None)">
  ...
  <Function id="qiskit.circuit.library.IntegerComparator.snapshot_density_matrix" name="snapshot_density_matrix" signature="IntegerComparator.snapshot_density_matrix(label, qubits=None)">
  ...
  <Function id="qiskit.circuit.library.IntegerComparator.snapshot_expectation_value" name="snapshot_expectation_value" signature="IntegerComparator.snapshot_expectation_value(label, op, qubits, single_shot=False, variance=False)">
  ...
  <Function id="qiskit.circuit.library.IntegerComparator.snapshot_probabilities" name="snapshot_probabilities" signature="IntegerComparator.snapshot_probabilities(label, qubits, variance=False)">
  ...
  <Function id="qiskit.circuit.library.IntegerComparator.snapshot_stabilizer" name="snapshot_stabilizer" signature="IntegerComparator.snapshot_stabilizer(label)">
  ...
  <Function id="qiskit.circuit.library.IntegerComparator.snapshot_statevector" name="snapshot_statevector" signature="IntegerComparator.snapshot_statevector(label)">
  ...
  <Function id="qiskit.circuit.library.IntegerComparator.squ" name="squ" signature="IntegerComparator.squ(unitary_matrix, qubit, mode='ZYZ', up_to_diagonal=False, *, u=None)">
  ...
  <Function id="qiskit.circuit.library.IntegerComparator.swap" name="swap" signature="IntegerComparator.swap(qubit1, qubit2)">
    Apply [`SwapGate`](qiskit.circuit.library.SwapGate "qiskit.circuit.library.SwapGate").
  </Function>

  ### t

  <Function id="qiskit.circuit.library.IntegerComparator.t" name="t" signature="IntegerComparator.t(qubit, *, q=None)">
    Apply [`TGate`](qiskit.circuit.library.TGate "qiskit.circuit.library.TGate").
  </Function>

  ### tdg

  <Function id="qiskit.circuit.library.IntegerComparator.tdg" name="tdg" signature="IntegerComparator.tdg(qubit, *, q=None)">
    Apply [`TdgGate`](qiskit.circuit.library.TdgGate "qiskit.circuit.library.TdgGate").
  </Function>

  ### to\_gate

  <Function id="qiskit.circuit.library.IntegerComparator.to_gate" name="to_gate" signature="IntegerComparator.to_gate(parameter_map=None)">
  ...
  <Function id="qiskit.circuit.library.IntegerComparator.to_instruction" name="to_instruction" signature="IntegerComparator.to_instruction(parameter_map=None)">
  ...
  <Function id="qiskit.circuit.library.IntegerComparator.toffoli" name="toffoli" signature="IntegerComparator.toffoli(control_qubit1, control_qubit2, target_qubit, *, ctl1=None, ctl2=None, tgt=None)">
    Apply [`CCXGate`](qiskit.circuit.library.CCXGate "qiskit.circuit.library.CCXGate").
  </Function>

  ### u1

  <Function id="qiskit.circuit.library.IntegerComparator.u1" name="u1" signature="IntegerComparator.u1(theta, qubit, *, q=None)">
    Apply [`U1Gate`](qiskit.circuit.library.U1Gate "qiskit.circuit.library.U1Gate").
  </Function>

  ### u2

  <Function id="qiskit.circuit.library.IntegerComparator.u2" name="u2" signature="IntegerComparator.u2(phi, lam, qubit, *, q=None)">
    Apply [`U2Gate`](qiskit.circuit.library.U2Gate "qiskit.circuit.library.U2Gate").
  </Function>

  ### u3

  <Function id="qiskit.circuit.library.IntegerComparator.u3" name="u3" signature="IntegerComparator.u3(theta, phi, lam, qubit, *, q=None)">
    Apply [`U3Gate`](qiskit.circuit.library.U3Gate "qiskit.circuit.library.U3Gate").
  </Function>

  ### uc

  <Function id="qiskit.circuit.library.IntegerComparator.uc" name="uc" signature="IntegerComparator.uc(gate_list, q_controls, q_target, up_to_diagonal=False)">
  ...
  <Function id="qiskit.circuit.library.IntegerComparator.ucg" name="ucg" signature="IntegerComparator.ucg(angle_list, q_controls, q_target, up_to_diagonal=False)">
    Deprecated version of uc.
  </Function>

  ### ucrx

  <Function id="qiskit.circuit.library.IntegerComparator.ucrx" name="ucrx" signature="IntegerComparator.ucrx(angle_list, q_controls, q_target)">
  ...
  <Function id="qiskit.circuit.library.IntegerComparator.ucry" name="ucry" signature="IntegerComparator.ucry(angle_list, q_controls, q_target)">
  ...
  <Function id="qiskit.circuit.library.IntegerComparator.ucrz" name="ucrz" signature="IntegerComparator.ucrz(angle_list, q_controls, q_target)">
  ...
  <Function id="qiskit.circuit.library.IntegerComparator.ucx" name="ucx" signature="IntegerComparator.ucx(angle_list, q_controls, q_target)">
    Deprecated version of ucrx.
  </Function>

  ### ucy

  <Function id="qiskit.circuit.library.IntegerComparator.ucy" name="ucy" signature="IntegerComparator.ucy(angle_list, q_controls, q_target)">
    Deprecated version of ucry.
  </Function>

  ### ucz

  <Function id="qiskit.circuit.library.IntegerComparator.ucz" name="ucz" signature="IntegerComparator.ucz(angle_list, q_controls, q_target)">
    Deprecated version of ucrz.
  </Function>

  ### unitary

  <Function id="qiskit.circuit.library.IntegerComparator.unitary" name="unitary" signature="IntegerComparator.unitary(obj, qubits, label=None)">
    Apply unitary gate to q.
  </Function>

  ### width

  <Function id="qiskit.circuit.library.IntegerComparator.width" name="width" signature="IntegerComparator.width()">
  ...
  <Function id="qiskit.circuit.library.IntegerComparator.x" name="x" signature="IntegerComparator.x(qubit, *, label=None, ctrl_state=None, q=None)">
    Apply [`XGate`](qiskit.circuit.library.XGate "qiskit.circuit.library.XGate").
  </Function>

  ### y

  <Function id="qiskit.circuit.library.IntegerComparator.y" name="y" signature="IntegerComparator.y(qubit, *, q=None)">
    Apply [`YGate`](qiskit.circuit.library.YGate "qiskit.circuit.library.YGate").
  </Function>

  ### z

  <Function id="qiskit.circuit.library.IntegerComparator.z" name="z" signature="IntegerComparator.z(qubit, *, q=None)">
