---
title: IntegerComparator (v0.19)
description: API reference for qiskit.circuit.library.IntegerComparator in qiskit v0.19
...
<Class id="qiskit.circuit.library.IntegerComparator" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.14/qiskit/circuit/library/arithmetic/integer_comparator.py" signature="IntegerComparator(num_state_qubits=None, value=None, geq=True, name='cmp')" modifiers="class">
  Integer Comparator.
...
$$
  ...
  *   **name** (`str`) – Name of the circuit.
  ...
  <span id="integercomparator-clbits" />
  ...
  <span id="integercomparator-data" />
  ...
  <span id="integercomparator-extension-lib" />

  ### extension\_lib

  <Attribute id="qiskit.circuit.library.IntegerComparator.extension_lib" attributeValue="'include &#x22;qelib1.inc&#x22;;'" />

  <span id="integercomparator-geq" />

  ### geq

  <Attribute id="qiskit.circuit.library.IntegerComparator.geq" attributeTypeHint="bool">
  ...
  <span id="integercomparator-header" />

  ### header

  <Attribute id="qiskit.circuit.library.IntegerComparator.header" attributeValue="'OPENQASM 2.0;'" />

  <span id="integercomparator-instances" />

  ### instances

  <Attribute id="qiskit.circuit.library.IntegerComparator.instances" attributeValue="8" />

  <span id="integercomparator-n-qubits" />

  ### n\_qubits

  <Attribute id="qiskit.circuit.library.IntegerComparator.n_qubits">
    Deprecated, use `num_qubits` instead. Return number of qubits.
  </Attribute>

  <span id="integercomparator-num-ancilla-qubits" />

  ### num\_ancilla\_qubits

  <Attribute id="qiskit.circuit.library.IntegerComparator.num_ancilla_qubits" attributeTypeHint="int">
  ...
  <span id="integercomparator-num-clbits" />
  ...
  <span id="integercomparator-num-parameters" />
  ...
  <span id="integercomparator-num-qubits" />
  ...
  <span id="integercomparator-num-state-qubits" />

  ### num\_state\_qubits

  <Attribute id="qiskit.circuit.library.IntegerComparator.num_state_qubits" attributeTypeHint="int">
  ...
  <span id="integercomparator-parameters" />
  ...
  <span id="integercomparator-qubits" />
  ...
  <span id="integercomparator-value" />

  ### value

  <Attribute id="qiskit.circuit.library.IntegerComparator.value" attributeTypeHint="int">
  ...
  <span id="integercomparator-and" />

  ### AND

  <Function id="qiskit.circuit.library.IntegerComparator.AND" signature="IntegerComparator.AND(qr_variables, qb_target, qr_ancillae, flags=None, mct_mode='no-ancilla')">
  ...
  <span id="integercomparator-or" />

  ### OR

  <Function id="qiskit.circuit.library.IntegerComparator.OR" signature="IntegerComparator.OR(qr_variables, qb_target, qr_ancillae, flags=None, mct_mode='basic')">
  ...
  <span id="integercomparator-getitem" />

  ### \_\_getitem\_\_

  <Function id="qiskit.circuit.library.IntegerComparator.__getitem__" signature="IntegerComparator.__getitem__(item)">
    Return indexed operation.
  </Function>

  <span id="integercomparator-len" />

  ### \_\_len\_\_

  <Function id="qiskit.circuit.library.IntegerComparator.__len__" signature="IntegerComparator.__len__()">
    Return number of operations in circuit.
  </Function>

  <span id="integercomparator-add-register" />

  ### add\_register

  <Function id="qiskit.circuit.library.IntegerComparator.add_register" signature="IntegerComparator.add_register(*regs)">
    Add registers.
  </Function>

  <span id="integercomparator-append" />

  ### append

  <Function id="qiskit.circuit.library.IntegerComparator.append" signature="IntegerComparator.append(instruction, qargs=None, cargs=None)">
  ...
  <span id="integercomparator-assign-parameters" />

  ### assign\_parameters

  <Function id="qiskit.circuit.library.IntegerComparator.assign_parameters" signature="IntegerComparator.assign_parameters(param_dict, inplace=False)">
  ...
  <span id="integercomparator-barrier" />

  ### barrier

  <Function id="qiskit.circuit.library.IntegerComparator.barrier" signature="IntegerComparator.barrier(*qargs)">
    Apply `Barrier`. If qargs is None, applies to all.
  </Function>

  <span id="integercomparator-bind-parameters" />

  ### bind\_parameters

  <Function id="qiskit.circuit.library.IntegerComparator.bind_parameters" signature="IntegerComparator.bind_parameters(value_dict)">
  ...
  <span id="integercomparator-cast" />

  ### cast

  <Function id="qiskit.circuit.library.IntegerComparator.cast" signature="IntegerComparator.cast(value, _type)" modifiers="static">
    Best effort to cast value to type. Otherwise, returns the value.
  </Function>

  <span id="integercomparator-cbit-argument-conversion" />

  ### cbit\_argument\_conversion

  <Function id="qiskit.circuit.library.IntegerComparator.cbit_argument_conversion" signature="IntegerComparator.cbit_argument_conversion(clbit_representation)">
  ...
  <span id="integercomparator-ccx" />

  ### ccx

  <Function id="qiskit.circuit.library.IntegerComparator.ccx" signature="IntegerComparator.ccx(control_qubit1, control_qubit2, target_qubit, *, ctl1=None, ctl2=None, tgt=None)">
    Apply [`CCXGate`](qiskit.circuit.library.CCXGate "qiskit.circuit.library.CCXGate").
  </Function>

  <span id="integercomparator-ch" />

  ### ch

  <Function id="qiskit.circuit.library.IntegerComparator.ch" signature="IntegerComparator.ch(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CHGate`](qiskit.circuit.library.CHGate "qiskit.circuit.library.CHGate").
  </Function>

  <span id="integercomparator-cls-instances" />

  ### cls\_instances

  <Function id="qiskit.circuit.library.IntegerComparator.cls_instances" signature="IntegerComparator.cls_instances()" modifiers="classmethod">
    Return the current number of instances of this class, useful for auto naming.
  </Function>

  <span id="integercomparator-cls-prefix" />

  ### cls\_prefix

  <Function id="qiskit.circuit.library.IntegerComparator.cls_prefix" signature="IntegerComparator.cls_prefix()" modifiers="classmethod">
    Return the prefix to use for auto naming.
  </Function>

  <span id="integercomparator-cnot" />

  ### cnot

  <Function id="qiskit.circuit.library.IntegerComparator.cnot" signature="IntegerComparator.cnot(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CXGate`](qiskit.circuit.library.CXGate "qiskit.circuit.library.CXGate").
  </Function>

  <span id="integercomparator-combine" />

  ### combine

  <Function id="qiskit.circuit.library.IntegerComparator.combine" signature="IntegerComparator.combine(rhs)">
  ...
  <span id="integercomparator-compose" />

  ### compose

  <Function id="qiskit.circuit.library.IntegerComparator.compose" signature="IntegerComparator.compose(other, qubits=None, clbits=None, front=False, inplace=False)">
  ...
  <span id="integercomparator-copy" />

  ### copy

  <Function id="qiskit.circuit.library.IntegerComparator.copy" signature="IntegerComparator.copy(name=None)">
    Copy the circuit.
  ...
  <span id="integercomparator-count-ops" />

  ### count\_ops

  <Function id="qiskit.circuit.library.IntegerComparator.count_ops" signature="IntegerComparator.count_ops()">
  ...
  <span id="integercomparator-crx" />

  ### crx

  <Function id="qiskit.circuit.library.IntegerComparator.crx" signature="IntegerComparator.crx(theta, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CRXGate`](qiskit.circuit.library.CRXGate "qiskit.circuit.library.CRXGate").
  </Function>

  <span id="integercomparator-cry" />

  ### cry

  <Function id="qiskit.circuit.library.IntegerComparator.cry" signature="IntegerComparator.cry(theta, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CRYGate`](qiskit.circuit.library.CRYGate "qiskit.circuit.library.CRYGate").
  </Function>

  <span id="integercomparator-crz" />

  ### crz

  <Function id="qiskit.circuit.library.IntegerComparator.crz" signature="IntegerComparator.crz(theta, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CRZGate`](qiskit.circuit.library.CRZGate "qiskit.circuit.library.CRZGate").
  </Function>

  <span id="integercomparator-cswap" />

  ### cswap

  <Function id="qiskit.circuit.library.IntegerComparator.cswap" signature="IntegerComparator.cswap(control_qubit, target_qubit1, target_qubit2, *, label=None, ctrl_state=None, ctl=None, tgt1=None, tgt2=None)">
    Apply [`CSwapGate`](qiskit.circuit.library.CSwapGate "qiskit.circuit.library.CSwapGate").
  </Function>

  <span id="integercomparator-cu1" />

  ### cu1

  <Function id="qiskit.circuit.library.IntegerComparator.cu1" signature="IntegerComparator.cu1(theta, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CU1Gate`](qiskit.circuit.library.CU1Gate "qiskit.circuit.library.CU1Gate").
  </Function>

  <span id="integercomparator-cu3" />

  ### cu3

  <Function id="qiskit.circuit.library.IntegerComparator.cu3" signature="IntegerComparator.cu3(theta, phi, lam, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CU3Gate`](qiskit.circuit.library.CU3Gate "qiskit.circuit.library.CU3Gate").
  </Function>

  <span id="integercomparator-cx" />

  ### cx

  <Function id="qiskit.circuit.library.IntegerComparator.cx" signature="IntegerComparator.cx(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CXGate`](qiskit.circuit.library.CXGate "qiskit.circuit.library.CXGate").
  </Function>

  <span id="integercomparator-cy" />

  ### cy

  <Function id="qiskit.circuit.library.IntegerComparator.cy" signature="IntegerComparator.cy(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CYGate`](qiskit.circuit.library.CYGate "qiskit.circuit.library.CYGate").
  </Function>

  <span id="integercomparator-cz" />

  ### cz

  <Function id="qiskit.circuit.library.IntegerComparator.cz" signature="IntegerComparator.cz(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CZGate`](qiskit.circuit.library.CZGate "qiskit.circuit.library.CZGate").
  </Function>

  <span id="integercomparator-dcx" />

  ### dcx

  <Function id="qiskit.circuit.library.IntegerComparator.dcx" signature="IntegerComparator.dcx(qubit1, qubit2)">
    Apply [`DCXGate`](qiskit.circuit.library.DCXGate "qiskit.circuit.library.DCXGate").
  </Function>

  <span id="integercomparator-decompose" />

  ### decompose

  <Function id="qiskit.circuit.library.IntegerComparator.decompose" signature="IntegerComparator.decompose()">
  ...
  <span id="integercomparator-depth" />

  ### depth

  <Function id="qiskit.circuit.library.IntegerComparator.depth" signature="IntegerComparator.depth()">
  ...
  <span id="integercomparator-diag-gate" />

  ### diag\_gate

  <Function id="qiskit.circuit.library.IntegerComparator.diag_gate" signature="IntegerComparator.diag_gate(diag, qubit)">
    Deprecated version of QuantumCircuit.diagonal.
  </Function>

  <span id="integercomparator-diagonal" />

  ### diagonal

  <Function id="qiskit.circuit.library.IntegerComparator.diagonal" signature="IntegerComparator.diagonal(diag, qubit)">
  ...
  <span id="integercomparator-extend" />

  ### extend

  <Function id="qiskit.circuit.library.IntegerComparator.extend" signature="IntegerComparator.extend(rhs)">
  ...
  <span id="integercomparator-fredkin" />

  ### fredkin

  <Function id="qiskit.circuit.library.IntegerComparator.fredkin" signature="IntegerComparator.fredkin(control_qubit, target_qubit1, target_qubit2, *, ctl=None, tgt1=None, tgt2=None)">
    Apply [`CSwapGate`](qiskit.circuit.library.CSwapGate "qiskit.circuit.library.CSwapGate").
  </Function>

  <span id="integercomparator-from-qasm-file" />

  ### from\_qasm\_file

  <Function id="qiskit.circuit.library.IntegerComparator.from_qasm_file" signature="IntegerComparator.from_qasm_file(path)" modifiers="static">
  ...
  <span id="integercomparator-from-qasm-str" />

  ### from\_qasm\_str

  <Function id="qiskit.circuit.library.IntegerComparator.from_qasm_str" signature="IntegerComparator.from_qasm_str(qasm_str)" modifiers="static">
  ...
  <span id="integercomparator-h" />

  ### h

  <Function id="qiskit.circuit.library.IntegerComparator.h" signature="IntegerComparator.h(qubit, *, q=None)">
    Apply [`HGate`](qiskit.circuit.library.HGate "qiskit.circuit.library.HGate").
  </Function>

  <span id="integercomparator-hamiltonian" />

  ### hamiltonian

  <Function id="qiskit.circuit.library.IntegerComparator.hamiltonian" signature="IntegerComparator.hamiltonian(operator, time, qubits, label=None)">
    Apply hamiltonian evolution to to qubits.
  </Function>

  <span id="integercomparator-has-register" />

  ### has\_register

  <Function id="qiskit.circuit.library.IntegerComparator.has_register" signature="IntegerComparator.has_register(register)">
  ...
  <span id="integercomparator-i" />

  ### i

  <Function id="qiskit.circuit.library.IntegerComparator.i" signature="IntegerComparator.i(qubit, *, q=None)">
    Apply [`IGate`](qiskit.circuit.library.IGate "qiskit.circuit.library.IGate").
  </Function>

  <span id="integercomparator-id" />

  ### id

  <Function id="qiskit.circuit.library.IntegerComparator.id" signature="IntegerComparator.id(qubit, *, q=None)">
    Apply [`IGate`](qiskit.circuit.library.IGate "qiskit.circuit.library.IGate").
  </Function>

  <span id="integercomparator-iden" />

  ### iden

  <Function id="qiskit.circuit.library.IntegerComparator.iden" signature="IntegerComparator.iden(qubit, *, q=None)">
    Deprecated identity gate.
  </Function>

  <span id="integercomparator-initialize" />

  ### initialize

  <Function id="qiskit.circuit.library.IntegerComparator.initialize" signature="IntegerComparator.initialize(params, qubits)">
    Apply initialize to circuit.
  </Function>

  <span id="integercomparator-inverse" />

  ### inverse

  <Function id="qiskit.circuit.library.IntegerComparator.inverse" signature="IntegerComparator.inverse()">
    Invert this circuit.
  ...
  <span id="integercomparator-iso" />

  ### iso

  <Function id="qiskit.circuit.library.IntegerComparator.iso" signature="IntegerComparator.iso(isometry, q_input, q_ancillas_for_output, q_ancillas_zero=None, q_ancillas_dirty=None)">
  ...
  <span id="integercomparator-isometry" />

  ### isometry

  <Function id="qiskit.circuit.library.IntegerComparator.isometry" signature="IntegerComparator.isometry(isometry, q_input, q_ancillas_for_output, q_ancillas_zero=None, q_ancillas_dirty=None)">
    Attach an arbitrary isometry from m to n qubits to a circuit. In particular, this allows to attach arbitrary unitaries on n qubits (m=n) or to prepare any state on n qubits (m=0). The decomposition used here was introduced by Iten et al. in [https://arxiv.org/abs/1501.06911](https://arxiv.org/abs/1501.06911).
  ...
  <span id="integercomparator-iswap" />

  ### iswap

  <Function id="qiskit.circuit.library.IntegerComparator.iswap" signature="IntegerComparator.iswap(qubit1, qubit2)">
    Apply [`iSwapGate`](qiskit.circuit.library.iSwapGate "qiskit.circuit.library.iSwapGate").
  </Function>

  <span id="integercomparator-mcmt" />

  ### mcmt

  <Function id="qiskit.circuit.library.IntegerComparator.mcmt" signature="IntegerComparator.mcmt(gate, control_qubits, target_qubits, ancilla_qubits=None, mode='no-ancilla', *, single_control_gate_fun=None, q_controls=None, q_ancillae=None, q_targets=None)">
    Apply a multi-control, multi-target using a generic gate.

    This can also be used to implement a generic multi-control gate, as the target could also be of length 1.
  </Function>

  <span id="integercomparator-mcrx" />

  ### mcrx

  <Function id="qiskit.circuit.library.IntegerComparator.mcrx" signature="IntegerComparator.mcrx(theta, q_controls, q_target, use_basis_gates=False)">
  ...
  <span id="integercomparator-mcry" />

  ### mcry

  <Function id="qiskit.circuit.library.IntegerComparator.mcry" signature="IntegerComparator.mcry(theta, q_controls, q_target, q_ancillae, mode='basic', use_basis_gates=False)">
  ...
  <span id="integercomparator-mcrz" />

  ### mcrz

  <Function id="qiskit.circuit.library.IntegerComparator.mcrz" signature="IntegerComparator.mcrz(lam, q_controls, q_target, use_basis_gates=False)">
  ...
  <span id="integercomparator-mct" />

  ### mct

  <Function id="qiskit.circuit.library.IntegerComparator.mct" signature="IntegerComparator.mct(control_qubits, target_qubit, ancilla_qubits=None, mode='noancilla')">
    Apply `MCXGate`.
  </Function>

  <span id="integercomparator-mcu1" />

  ### mcu1

  <Function id="qiskit.circuit.library.IntegerComparator.mcu1" signature="IntegerComparator.mcu1(lam, control_qubits, target_qubit)">
    Apply `MCU1Gate`.
  </Function>

  <span id="integercomparator-mcx" />

  ### mcx

  <Function id="qiskit.circuit.library.IntegerComparator.mcx" signature="IntegerComparator.mcx(control_qubits, target_qubit, ancilla_qubits=None, mode='noancilla')">
    Apply `MCXGate`.
  ...
  <span id="integercomparator-measure" />

  ### measure

  <Function id="qiskit.circuit.library.IntegerComparator.measure" signature="IntegerComparator.measure(qubit, cbit)">
  ...
  <span id="integercomparator-measure-active" />

  ### measure\_active

  <Function id="qiskit.circuit.library.IntegerComparator.measure_active" signature="IntegerComparator.measure_active(inplace=True)">
  ...
  <span id="integercomparator-measure-all" />

  ### measure\_all

  <Function id="qiskit.circuit.library.IntegerComparator.measure_all" signature="IntegerComparator.measure_all(inplace=True)">
  ...
  <span id="integercomparator-mirror" />

  ### mirror

  <Function id="qiskit.circuit.library.IntegerComparator.mirror" signature="IntegerComparator.mirror()">
  ...
  <span id="integercomparator-ms" />

  ### ms

  <Function id="qiskit.circuit.library.IntegerComparator.ms" signature="IntegerComparator.ms(theta, qubits)">
    Apply [`MSGate`](qiskit.circuit.library.MSGate "qiskit.circuit.library.MSGate").
  </Function>

  <span id="integercomparator-num-connected-components" />

  ### num\_connected\_components

  <Function id="qiskit.circuit.library.IntegerComparator.num_connected_components" signature="IntegerComparator.num_connected_components(unitary_only=False)">
  ...
  <span id="integercomparator-num-nonlocal-gates" />

  ### num\_nonlocal\_gates

  <Function id="qiskit.circuit.library.IntegerComparator.num_nonlocal_gates" signature="IntegerComparator.num_nonlocal_gates()">
    Return number of non-local gates (i.e. involving 2+ qubits).

    Conditional nonlocal gates are also included.
  </Function>

  <span id="integercomparator-num-tensor-factors" />

  ### num\_tensor\_factors

  <Function id="qiskit.circuit.library.IntegerComparator.num_tensor_factors" signature="IntegerComparator.num_tensor_factors()">
  ...
  <span id="integercomparator-num-unitary-factors" />

  ### num\_unitary\_factors

  <Function id="qiskit.circuit.library.IntegerComparator.num_unitary_factors" signature="IntegerComparator.num_unitary_factors()">
    Computes the number of tensor factors in the unitary (quantum) part of the circuit only.
  </Function>

  <span id="integercomparator-qasm" />

  ### qasm

  <Function id="qiskit.circuit.library.IntegerComparator.qasm" signature="IntegerComparator.qasm(formatted=False, filename=None)">
  ...
  <span id="integercomparator-qbit-argument-conversion" />

  ### qbit\_argument\_conversion

  <Function id="qiskit.circuit.library.IntegerComparator.qbit_argument_conversion" signature="IntegerComparator.qbit_argument_conversion(qubit_representation)">
  ...
  <span id="integercomparator-r" />

  ### r

  <Function id="qiskit.circuit.library.IntegerComparator.r" signature="IntegerComparator.r(theta, phi, qubit, *, q=None)">
    Apply `RGate`.
  </Function>

  <span id="integercomparator-rcccx" />

  ### rcccx

  <Function id="qiskit.circuit.library.IntegerComparator.rcccx" signature="IntegerComparator.rcccx(control_qubit1, control_qubit2, control_qubit3, target_qubit)">
    Apply [`RC3XGate`](qiskit.circuit.library.RC3XGate "qiskit.circuit.library.RC3XGate").
  </Function>

  <span id="integercomparator-rccx" />

  ### rccx

  <Function id="qiskit.circuit.library.IntegerComparator.rccx" signature="IntegerComparator.rccx(control_qubit1, control_qubit2, target_qubit)">
    Apply [`RCCXGate`](qiskit.circuit.library.RCCXGate "qiskit.circuit.library.RCCXGate").
  </Function>

  <span id="integercomparator-remove-final-measurements" />

  ### remove\_final\_measurements

  <Function id="qiskit.circuit.library.IntegerComparator.remove_final_measurements" signature="IntegerComparator.remove_final_measurements(inplace=True)">
  ...
  <span id="integercomparator-reset" />

  ### reset

  <Function id="qiskit.circuit.library.IntegerComparator.reset" signature="IntegerComparator.reset(qubit)">
    Reset q.
  </Function>

  <span id="integercomparator-rx" />

  ### rx

  <Function id="qiskit.circuit.library.IntegerComparator.rx" signature="IntegerComparator.rx(theta, qubit, *, label=None, q=None)">
    Apply [`RXGate`](qiskit.circuit.library.RXGate "qiskit.circuit.library.RXGate").
  </Function>

  <span id="integercomparator-rxx" />

  ### rxx

  <Function id="qiskit.circuit.library.IntegerComparator.rxx" signature="IntegerComparator.rxx(theta, qubit1, qubit2)">
    Apply [`RXXGate`](qiskit.circuit.library.RXXGate "qiskit.circuit.library.RXXGate").
  </Function>

  <span id="integercomparator-ry" />

  ### ry

  <Function id="qiskit.circuit.library.IntegerComparator.ry" signature="IntegerComparator.ry(theta, qubit, *, label=None, q=None)">
    Apply [`RYGate`](qiskit.circuit.library.RYGate "qiskit.circuit.library.RYGate").
  </Function>

  <span id="integercomparator-ryy" />

  ### ryy

  <Function id="qiskit.circuit.library.IntegerComparator.ryy" signature="IntegerComparator.ryy(theta, qubit1, qubit2)">
    Apply [`RYYGate`](qiskit.circuit.library.RYYGate "qiskit.circuit.library.RYYGate").
  </Function>

  <span id="integercomparator-rz" />

  ### rz

  <Function id="qiskit.circuit.library.IntegerComparator.rz" signature="IntegerComparator.rz(phi, qubit, *, q=None)">
    Apply [`RZGate`](qiskit.circuit.library.RZGate "qiskit.circuit.library.RZGate").
  </Function>

  <span id="integercomparator-rzx" />

  ### rzx

  <Function id="qiskit.circuit.library.IntegerComparator.rzx" signature="IntegerComparator.rzx(theta, qubit1, qubit2)">
    Apply [`RZXGate`](qiskit.circuit.library.RZXGate "qiskit.circuit.library.RZXGate").
  </Function>

  <span id="integercomparator-rzz" />

  ### rzz

  <Function id="qiskit.circuit.library.IntegerComparator.rzz" signature="IntegerComparator.rzz(theta, qubit1, qubit2)">
    Apply [`RZZGate`](qiskit.circuit.library.RZZGate "qiskit.circuit.library.RZZGate").
  </Function>

  <span id="integercomparator-s" />

  ### s

  <Function id="qiskit.circuit.library.IntegerComparator.s" signature="IntegerComparator.s(qubit, *, q=None)">
    Apply [`SGate`](qiskit.circuit.library.SGate "qiskit.circuit.library.SGate").
  </Function>

  <span id="integercomparator-sdg" />

  ### sdg

  <Function id="qiskit.circuit.library.IntegerComparator.sdg" signature="IntegerComparator.sdg(qubit, *, q=None)">
    Apply [`SdgGate`](qiskit.circuit.library.SdgGate "qiskit.circuit.library.SdgGate").
  </Function>

  <span id="integercomparator-size" />

  ### size

  <Function id="qiskit.circuit.library.IntegerComparator.size" signature="IntegerComparator.size()">
  ...
  <span id="integercomparator-snapshot" />

  ### snapshot

  <Function id="qiskit.circuit.library.IntegerComparator.snapshot" signature="IntegerComparator.snapshot(label, snapshot_type='statevector', qubits=None, params=None)">
  ...
  <span id="integercomparator-snapshot-density-matrix" />

  ### snapshot\_density\_matrix

  <Function id="qiskit.circuit.library.IntegerComparator.snapshot_density_matrix" signature="IntegerComparator.snapshot_density_matrix(label, qubits=None)">
  ...
  <span id="integercomparator-snapshot-expectation-value" />

  ### snapshot\_expectation\_value

  <Function id="qiskit.circuit.library.IntegerComparator.snapshot_expectation_value" signature="IntegerComparator.snapshot_expectation_value(label, op, qubits, single_shot=False, variance=False)">
  ...
  <span id="integercomparator-snapshot-probabilities" />

  ### snapshot\_probabilities

  <Function id="qiskit.circuit.library.IntegerComparator.snapshot_probabilities" signature="IntegerComparator.snapshot_probabilities(label, qubits, variance=False)">
  ...
  <span id="integercomparator-snapshot-stabilizer" />

  ### snapshot\_stabilizer

  <Function id="qiskit.circuit.library.IntegerComparator.snapshot_stabilizer" signature="IntegerComparator.snapshot_stabilizer(label)">
  ...
  <span id="integercomparator-snapshot-statevector" />

  ### snapshot\_statevector

  <Function id="qiskit.circuit.library.IntegerComparator.snapshot_statevector" signature="IntegerComparator.snapshot_statevector(label)">
  ...
  <span id="integercomparator-squ" />

  ### squ

  <Function id="qiskit.circuit.library.IntegerComparator.squ" signature="IntegerComparator.squ(unitary_matrix, qubit, mode='ZYZ', up_to_diagonal=False, *, u=None)">
  ...
  <span id="integercomparator-swap" />

  ### swap

  <Function id="qiskit.circuit.library.IntegerComparator.swap" signature="IntegerComparator.swap(qubit1, qubit2)">
    Apply [`SwapGate`](qiskit.circuit.library.SwapGate "qiskit.circuit.library.SwapGate").
  </Function>

  <span id="integercomparator-t" />

  ### t

  <Function id="qiskit.circuit.library.IntegerComparator.t" signature="IntegerComparator.t(qubit, *, q=None)">
    Apply [`TGate`](qiskit.circuit.library.TGate "qiskit.circuit.library.TGate").
  </Function>

  <span id="integercomparator-tdg" />

  ### tdg

  <Function id="qiskit.circuit.library.IntegerComparator.tdg" signature="IntegerComparator.tdg(qubit, *, q=None)">
    Apply [`TdgGate`](qiskit.circuit.library.TdgGate "qiskit.circuit.library.TdgGate").
  </Function>

  <span id="integercomparator-to-gate" />

  ### to\_gate

  <Function id="qiskit.circuit.library.IntegerComparator.to_gate" signature="IntegerComparator.to_gate(parameter_map=None)">
  ...
  <span id="integercomparator-to-instruction" />

  ### to\_instruction

  <Function id="qiskit.circuit.library.IntegerComparator.to_instruction" signature="IntegerComparator.to_instruction(parameter_map=None)">
  ...
  <span id="integercomparator-toffoli" />

  ### toffoli

  <Function id="qiskit.circuit.library.IntegerComparator.toffoli" signature="IntegerComparator.toffoli(control_qubit1, control_qubit2, target_qubit, *, ctl1=None, ctl2=None, tgt=None)">
    Apply [`CCXGate`](qiskit.circuit.library.CCXGate "qiskit.circuit.library.CCXGate").
  </Function>

  <span id="integercomparator-u1" />

  ### u1

  <Function id="qiskit.circuit.library.IntegerComparator.u1" signature="IntegerComparator.u1(theta, qubit, *, q=None)">
    Apply [`U1Gate`](qiskit.circuit.library.U1Gate "qiskit.circuit.library.U1Gate").
  </Function>

  <span id="integercomparator-u2" />

  ### u2

  <Function id="qiskit.circuit.library.IntegerComparator.u2" signature="IntegerComparator.u2(phi, lam, qubit, *, q=None)">
    Apply [`U2Gate`](qiskit.circuit.library.U2Gate "qiskit.circuit.library.U2Gate").
  </Function>

  <span id="integercomparator-u3" />

  ### u3

  <Function id="qiskit.circuit.library.IntegerComparator.u3" signature="IntegerComparator.u3(theta, phi, lam, qubit, *, q=None)">
    Apply [`U3Gate`](qiskit.circuit.library.U3Gate "qiskit.circuit.library.U3Gate").
  </Function>

  <span id="integercomparator-uc" />

  ### uc

  <Function id="qiskit.circuit.library.IntegerComparator.uc" signature="IntegerComparator.uc(gate_list, q_controls, q_target, up_to_diagonal=False)">
  ...
  <span id="integercomparator-ucg" />

  ### ucg

  <Function id="qiskit.circuit.library.IntegerComparator.ucg" signature="IntegerComparator.ucg(angle_list, q_controls, q_target, up_to_diagonal=False)">
    Deprecated version of uc.
  </Function>

  <span id="integercomparator-ucrx" />

  ### ucrx

  <Function id="qiskit.circuit.library.IntegerComparator.ucrx" signature="IntegerComparator.ucrx(angle_list, q_controls, q_target)">
  ...
  <span id="integercomparator-ucry" />

  ### ucry

  <Function id="qiskit.circuit.library.IntegerComparator.ucry" signature="IntegerComparator.ucry(angle_list, q_controls, q_target)">
  ...
  <span id="integercomparator-ucrz" />

  ### ucrz

  <Function id="qiskit.circuit.library.IntegerComparator.ucrz" signature="IntegerComparator.ucrz(angle_list, q_controls, q_target)">
  ...
  <span id="integercomparator-ucx" />

  ### ucx

  <Function id="qiskit.circuit.library.IntegerComparator.ucx" signature="IntegerComparator.ucx(angle_list, q_controls, q_target)">
    Deprecated version of ucrx.
  </Function>

  <span id="integercomparator-ucy" />

  ### ucy

  <Function id="qiskit.circuit.library.IntegerComparator.ucy" signature="IntegerComparator.ucy(angle_list, q_controls, q_target)">
    Deprecated version of ucry.
  </Function>

  <span id="integercomparator-ucz" />

  ### ucz

  <Function id="qiskit.circuit.library.IntegerComparator.ucz" signature="IntegerComparator.ucz(angle_list, q_controls, q_target)">
    Deprecated version of ucrz.
  </Function>

  <span id="integercomparator-unitary" />

  ### unitary

  <Function id="qiskit.circuit.library.IntegerComparator.unitary" signature="IntegerComparator.unitary(obj, qubits, label=None)">
    Apply unitary gate to q.
  </Function>

  <span id="integercomparator-width" />

  ### width

  <Function id="qiskit.circuit.library.IntegerComparator.width" signature="IntegerComparator.width()">
  ...
  <span id="integercomparator-x" />

  ### x

  <Function id="qiskit.circuit.library.IntegerComparator.x" signature="IntegerComparator.x(qubit, *, label=None, ctrl_state=None, q=None)">
    Apply [`XGate`](qiskit.circuit.library.XGate "qiskit.circuit.library.XGate").
  </Function>

  <span id="integercomparator-y" />

  ### y

  <Function id="qiskit.circuit.library.IntegerComparator.y" signature="IntegerComparator.y(qubit, *, q=None)">
    Apply [`YGate`](qiskit.circuit.library.YGate "qiskit.circuit.library.YGate").
  </Function>

  <span id="integercomparator-z" />

  ### z

  <Function id="qiskit.circuit.library.IntegerComparator.z" signature="IntegerComparator.z(qubit, *, q=None)">
