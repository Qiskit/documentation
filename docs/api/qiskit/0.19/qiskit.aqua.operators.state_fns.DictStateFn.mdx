---
title: DictStateFn (v0.19)
description: API reference for qiskit.aqua.operators.state_fns.DictStateFn in qiskit v0.19
...
<Class id="qiskit.aqua.operators.state_fns.DictStateFn" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.7/qiskit/aqua/operators/state_fns/dict_state_fn.py" signature="DictStateFn(primitive=None, coeff=1.0, is_measurement=False)" modifiers="class">
  ...
  **TypeError** – invalid parameters.
  ...
  <span id="dictstatefn-coeff" />

  ### coeff

  <Attribute id="qiskit.aqua.operators.state_fns.DictStateFn.coeff" attributeTypeHint="Union[int, float, complex, qiskit.circuit.parameterexpression.ParameterExpression]">
  ...
  <span id="dictstatefn-is-measurement" />

  ### is\_measurement

  <Attribute id="qiskit.aqua.operators.state_fns.DictStateFn.is_measurement" attributeTypeHint="bool">
  ...
  <span id="dictstatefn-num-qubits" />

  ### num\_qubits

  <Attribute id="qiskit.aqua.operators.state_fns.DictStateFn.num_qubits" attributeTypeHint="int">
  ...
  <span id="dictstatefn-mul" />

  ### \_\_mul\_\_

  <Function id="qiskit.aqua.operators.state_fns.DictStateFn.__mul__" signature="DictStateFn.__mul__(other)">
  ...
  <span id="dictstatefn-assign-parameters" />
  ...
  <span id="dictstatefn-bind-parameters" />
  ...
  <span id="dictstatefn-compose" />

  ### compose

  <Function id="qiskit.aqua.operators.state_fns.DictStateFn.compose" signature="DictStateFn.compose(other)">
  ...
  <span id="dictstatefn-primitive-strings" />
  ...
  <span id="dictstatefn-tensorpower" />
  ...
  <span id="dictstatefn-to-circuit-op" />
  ...
  <span id="dictstatefn-to-density-matrix" />
  ...
  <span id="dictstatefn-to-legacy-op" />
  ...
  <span id="dictstatefn-to-matrix-op" />
  ...
  <span id="dictstatefn-to-spmatrix" />
