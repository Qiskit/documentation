...
<Class id="qiskit.aqua.operators.state_fns.DictStateFn" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.7/qiskit/aqua/operators/state_fns/dict_state_fn.py" signature="DictStateFn(primitive=None, coeff=1.0, is_measurement=False)">
  ...
  **TypeError** – invalid parameters.
  ...
  <Attribute id="qiskit.aqua.operators.state_fns.DictStateFn.coeff" name="coeff" signature="Union[int, float, complex, qiskit.circuit.parameterexpression.ParameterExpression]">
  ...
  <Attribute id="qiskit.aqua.operators.state_fns.DictStateFn.is_measurement" name="is_measurement" signature="bool">
  ...
  <Attribute id="qiskit.aqua.operators.state_fns.DictStateFn.num_qubits" name="num_qubits" signature="int">
  ...
  <Function id="qiskit.aqua.operators.state_fns.DictStateFn.__mul__" name="__mul__" signature="DictStateFn.__mul__(other)">
  ...
  <Function id="qiskit.aqua.operators.state_fns.DictStateFn.compose" name="compose" signature="DictStateFn.compose(other)">
