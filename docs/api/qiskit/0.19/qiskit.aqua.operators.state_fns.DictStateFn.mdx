...
<Class id="qiskit.aqua.operators.state_fns.DictStateFn" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.7/qiskit/aqua/operators/state_fns/dict_state_fn.py" signature="DictStateFn(primitive=None, coeff=1.0, is_measurement=False)">
  ...
  **TypeError** – invalid parameters.
  ...
  <Attribute id="qiskit.aqua.operators.state_fns.DictStateFn.coeff" signature="Union[int, float, complex, qiskit.circuit.parameterexpression.ParameterExpression]">
  ...
  <Attribute id="qiskit.aqua.operators.state_fns.DictStateFn.is_measurement" signature="bool">
  ...
  <Attribute id="qiskit.aqua.operators.state_fns.DictStateFn.num_qubits" signature="int">
