...
<Function id="qiskit.visualization.iplot_histogram" name="iplot_histogram" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.14/qiskit/visualization/interactive/iplot_histogram.py" signature="iplot_histogram(data, figsize=None, number_to_keep=None, sort='asc', legend=None)">
