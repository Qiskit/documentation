---
title: InnerProduct (v0.19)
description: API reference for qiskit.circuit.library.InnerProduct in qiskit v0.19
...
<Class id="qiskit.circuit.library.InnerProduct" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.14/qiskit/circuit/library/boolean_logic/inner_product.py" signature="InnerProduct(num_qubits)" modifiers="class">
  ...
  **Reference Circuit:**
  ...
  <span id="innerproduct-extension-lib" />

  ### extension\_lib

  <Attribute id="qiskit.circuit.library.InnerProduct.extension_lib" attributeValue="'include &#x22;qelib1.inc&#x22;;'" />

  <span id="innerproduct-header" />

  ### header

  <Attribute id="qiskit.circuit.library.InnerProduct.header" attributeValue="'OPENQASM 2.0;'" />

  <span id="innerproduct-instances" />

  ### instances

  <Attribute id="qiskit.circuit.library.InnerProduct.instances" attributeValue="8" />

  <span id="innerproduct-n-qubits" />

  ### n\_qubits

  <Attribute id="qiskit.circuit.library.InnerProduct.n_qubits">
    Deprecated, use `num_qubits` instead. Return number of qubits.
  </Attribute>

  <span id="innerproduct-num-clbits" />
  ...
  <span id="innerproduct-num-parameters" />
  ...
  <span id="innerproduct-num-qubits" />
  ...
  <span id="innerproduct-parameters" />
  ...
  <span id="innerproduct-and" />

  ### AND

  <Function id="qiskit.circuit.library.InnerProduct.AND" signature="InnerProduct.AND(qr_variables, qb_target, qr_ancillae, flags=None, mct_mode='no-ancilla')">
  ...
  <span id="innerproduct-or" />

  ### OR

  <Function id="qiskit.circuit.library.InnerProduct.OR" signature="InnerProduct.OR(qr_variables, qb_target, qr_ancillae, flags=None, mct_mode='basic')">
  ...
  <span id="innerproduct-getitem" />

  ### \_\_getitem\_\_

  <Function id="qiskit.circuit.library.InnerProduct.__getitem__" signature="InnerProduct.__getitem__(item)">
    Return indexed operation.
  </Function>

  <span id="innerproduct-len" />

  ### \_\_len\_\_

  <Function id="qiskit.circuit.library.InnerProduct.__len__" signature="InnerProduct.__len__()">
    Return number of operations in circuit.
  </Function>

  <span id="innerproduct-add-register" />

  ### add\_register

  <Function id="qiskit.circuit.library.InnerProduct.add_register" signature="InnerProduct.add_register(*regs)">
    Add registers.
  </Function>

  <span id="innerproduct-append" />

  ### append

  <Function id="qiskit.circuit.library.InnerProduct.append" signature="InnerProduct.append(instruction, qargs=None, cargs=None)">
  ...
  <span id="innerproduct-assign-parameters" />

  ### assign\_parameters

  <Function id="qiskit.circuit.library.InnerProduct.assign_parameters" signature="InnerProduct.assign_parameters(param_dict, inplace=False)">
  ...
  <span id="innerproduct-barrier" />

  ### barrier

  <Function id="qiskit.circuit.library.InnerProduct.barrier" signature="InnerProduct.barrier(*qargs)">
    Apply `Barrier`. If qargs is None, applies to all.
  </Function>

  <span id="innerproduct-bind-parameters" />

  ### bind\_parameters

  <Function id="qiskit.circuit.library.InnerProduct.bind_parameters" signature="InnerProduct.bind_parameters(value_dict)">
  ...
  <span id="innerproduct-cast" />

  ### cast

  <Function id="qiskit.circuit.library.InnerProduct.cast" signature="InnerProduct.cast(value, _type)" modifiers="static">
    Best effort to cast value to type. Otherwise, returns the value.
  </Function>

  <span id="innerproduct-cbit-argument-conversion" />

  ### cbit\_argument\_conversion

  <Function id="qiskit.circuit.library.InnerProduct.cbit_argument_conversion" signature="InnerProduct.cbit_argument_conversion(clbit_representation)">
  ...
  <span id="innerproduct-ccx" />

  ### ccx

  <Function id="qiskit.circuit.library.InnerProduct.ccx" signature="InnerProduct.ccx(control_qubit1, control_qubit2, target_qubit, *, ctl1=None, ctl2=None, tgt=None)">
    Apply [`CCXGate`](qiskit.circuit.library.CCXGate "qiskit.circuit.library.CCXGate").
  </Function>

  <span id="innerproduct-ch" />

  ### ch

  <Function id="qiskit.circuit.library.InnerProduct.ch" signature="InnerProduct.ch(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CHGate`](qiskit.circuit.library.CHGate "qiskit.circuit.library.CHGate").
  </Function>

  <span id="innerproduct-cls-instances" />

  ### cls\_instances

  <Function id="qiskit.circuit.library.InnerProduct.cls_instances" signature="InnerProduct.cls_instances()" modifiers="classmethod">
    Return the current number of instances of this class, useful for auto naming.
  </Function>

  <span id="innerproduct-cls-prefix" />

  ### cls\_prefix

  <Function id="qiskit.circuit.library.InnerProduct.cls_prefix" signature="InnerProduct.cls_prefix()" modifiers="classmethod">
    Return the prefix to use for auto naming.
  </Function>

  <span id="innerproduct-cnot" />

  ### cnot

  <Function id="qiskit.circuit.library.InnerProduct.cnot" signature="InnerProduct.cnot(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CXGate`](qiskit.circuit.library.CXGate "qiskit.circuit.library.CXGate").
  </Function>

  <span id="innerproduct-combine" />

  ### combine

  <Function id="qiskit.circuit.library.InnerProduct.combine" signature="InnerProduct.combine(rhs)">
  ...
  <span id="innerproduct-compose" />

  ### compose

  <Function id="qiskit.circuit.library.InnerProduct.compose" signature="InnerProduct.compose(other, qubits=None, clbits=None, front=False, inplace=False)">
  ...
  <span id="innerproduct-copy" />

  ### copy

  <Function id="qiskit.circuit.library.InnerProduct.copy" signature="InnerProduct.copy(name=None)">
    Copy the circuit.
  ...
  <span id="innerproduct-count-ops" />

  ### count\_ops

  <Function id="qiskit.circuit.library.InnerProduct.count_ops" signature="InnerProduct.count_ops()">
  ...
  <span id="innerproduct-crx" />

  ### crx

  <Function id="qiskit.circuit.library.InnerProduct.crx" signature="InnerProduct.crx(theta, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CRXGate`](qiskit.circuit.library.CRXGate "qiskit.circuit.library.CRXGate").
  </Function>

  <span id="innerproduct-cry" />

  ### cry

  <Function id="qiskit.circuit.library.InnerProduct.cry" signature="InnerProduct.cry(theta, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CRYGate`](qiskit.circuit.library.CRYGate "qiskit.circuit.library.CRYGate").
  </Function>

  <span id="innerproduct-crz" />

  ### crz

  <Function id="qiskit.circuit.library.InnerProduct.crz" signature="InnerProduct.crz(theta, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CRZGate`](qiskit.circuit.library.CRZGate "qiskit.circuit.library.CRZGate").
  </Function>

  <span id="innerproduct-cswap" />

  ### cswap

  <Function id="qiskit.circuit.library.InnerProduct.cswap" signature="InnerProduct.cswap(control_qubit, target_qubit1, target_qubit2, *, label=None, ctrl_state=None, ctl=None, tgt1=None, tgt2=None)">
    Apply [`CSwapGate`](qiskit.circuit.library.CSwapGate "qiskit.circuit.library.CSwapGate").
  </Function>

  <span id="innerproduct-cu1" />

  ### cu1

  <Function id="qiskit.circuit.library.InnerProduct.cu1" signature="InnerProduct.cu1(theta, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CU1Gate`](qiskit.circuit.library.CU1Gate "qiskit.circuit.library.CU1Gate").
  </Function>

  <span id="innerproduct-cu3" />

  ### cu3

  <Function id="qiskit.circuit.library.InnerProduct.cu3" signature="InnerProduct.cu3(theta, phi, lam, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CU3Gate`](qiskit.circuit.library.CU3Gate "qiskit.circuit.library.CU3Gate").
  </Function>

  <span id="innerproduct-cx" />

  ### cx

  <Function id="qiskit.circuit.library.InnerProduct.cx" signature="InnerProduct.cx(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CXGate`](qiskit.circuit.library.CXGate "qiskit.circuit.library.CXGate").
  </Function>

  <span id="innerproduct-cy" />

  ### cy

  <Function id="qiskit.circuit.library.InnerProduct.cy" signature="InnerProduct.cy(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CYGate`](qiskit.circuit.library.CYGate "qiskit.circuit.library.CYGate").
  </Function>

  <span id="innerproduct-cz" />

  ### cz

  <Function id="qiskit.circuit.library.InnerProduct.cz" signature="InnerProduct.cz(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CZGate`](qiskit.circuit.library.CZGate "qiskit.circuit.library.CZGate").
  </Function>

  <span id="innerproduct-dcx" />

  ### dcx

  <Function id="qiskit.circuit.library.InnerProduct.dcx" signature="InnerProduct.dcx(qubit1, qubit2)">
    Apply [`DCXGate`](qiskit.circuit.library.DCXGate "qiskit.circuit.library.DCXGate").
  </Function>

  <span id="innerproduct-decompose" />

  ### decompose

  <Function id="qiskit.circuit.library.InnerProduct.decompose" signature="InnerProduct.decompose()">
  ...
  <span id="innerproduct-depth" />

  ### depth

  <Function id="qiskit.circuit.library.InnerProduct.depth" signature="InnerProduct.depth()">
  ...
  <span id="innerproduct-diag-gate" />

  ### diag\_gate

  <Function id="qiskit.circuit.library.InnerProduct.diag_gate" signature="InnerProduct.diag_gate(diag, qubit)">
    Deprecated version of QuantumCircuit.diagonal.
  </Function>

  <span id="innerproduct-diagonal" />

  ### diagonal

  <Function id="qiskit.circuit.library.InnerProduct.diagonal" signature="InnerProduct.diagonal(diag, qubit)">
  ...
  <span id="innerproduct-extend" />

  ### extend

  <Function id="qiskit.circuit.library.InnerProduct.extend" signature="InnerProduct.extend(rhs)">
  ...
  <span id="innerproduct-fredkin" />

  ### fredkin

  <Function id="qiskit.circuit.library.InnerProduct.fredkin" signature="InnerProduct.fredkin(control_qubit, target_qubit1, target_qubit2, *, ctl=None, tgt1=None, tgt2=None)">
    Apply [`CSwapGate`](qiskit.circuit.library.CSwapGate "qiskit.circuit.library.CSwapGate").
  </Function>

  <span id="innerproduct-from-qasm-file" />

  ### from\_qasm\_file

  <Function id="qiskit.circuit.library.InnerProduct.from_qasm_file" signature="InnerProduct.from_qasm_file(path)" modifiers="static">
  ...
  <span id="innerproduct-from-qasm-str" />

  ### from\_qasm\_str

  <Function id="qiskit.circuit.library.InnerProduct.from_qasm_str" signature="InnerProduct.from_qasm_str(qasm_str)" modifiers="static">
  ...
  <span id="innerproduct-h" />

  ### h

  <Function id="qiskit.circuit.library.InnerProduct.h" signature="InnerProduct.h(qubit, *, q=None)">
    Apply [`HGate`](qiskit.circuit.library.HGate "qiskit.circuit.library.HGate").
  </Function>

  <span id="innerproduct-hamiltonian" />

  ### hamiltonian

  <Function id="qiskit.circuit.library.InnerProduct.hamiltonian" signature="InnerProduct.hamiltonian(operator, time, qubits, label=None)">
    Apply hamiltonian evolution to to qubits.
  </Function>

  <span id="innerproduct-has-register" />

  ### has\_register

  <Function id="qiskit.circuit.library.InnerProduct.has_register" signature="InnerProduct.has_register(register)">
  ...
  <span id="innerproduct-i" />

  ### i

  <Function id="qiskit.circuit.library.InnerProduct.i" signature="InnerProduct.i(qubit, *, q=None)">
    Apply [`IGate`](qiskit.circuit.library.IGate "qiskit.circuit.library.IGate").
  </Function>

  <span id="innerproduct-id" />

  ### id

  <Function id="qiskit.circuit.library.InnerProduct.id" signature="InnerProduct.id(qubit, *, q=None)">
    Apply [`IGate`](qiskit.circuit.library.IGate "qiskit.circuit.library.IGate").
  </Function>

  <span id="innerproduct-iden" />

  ### iden

  <Function id="qiskit.circuit.library.InnerProduct.iden" signature="InnerProduct.iden(qubit, *, q=None)">
    Deprecated identity gate.
  </Function>

  <span id="innerproduct-initialize" />

  ### initialize

  <Function id="qiskit.circuit.library.InnerProduct.initialize" signature="InnerProduct.initialize(params, qubits)">
    Apply initialize to circuit.
  </Function>

  <span id="innerproduct-inverse" />

  ### inverse

  <Function id="qiskit.circuit.library.InnerProduct.inverse" signature="InnerProduct.inverse()">
    Invert this circuit.
  ...
  <span id="innerproduct-iso" />

  ### iso

  <Function id="qiskit.circuit.library.InnerProduct.iso" signature="InnerProduct.iso(isometry, q_input, q_ancillas_for_output, q_ancillas_zero=None, q_ancillas_dirty=None)">
  ...
  <span id="innerproduct-isometry" />

  ### isometry

  <Function id="qiskit.circuit.library.InnerProduct.isometry" signature="InnerProduct.isometry(isometry, q_input, q_ancillas_for_output, q_ancillas_zero=None, q_ancillas_dirty=None)">
    Attach an arbitrary isometry from m to n qubits to a circuit. In particular, this allows to attach arbitrary unitaries on n qubits (m=n) or to prepare any state on n qubits (m=0). The decomposition used here was introduced by Iten et al. in [https://arxiv.org/abs/1501.06911](https://arxiv.org/abs/1501.06911).
  ...
  <span id="innerproduct-iswap" />

  ### iswap

  <Function id="qiskit.circuit.library.InnerProduct.iswap" signature="InnerProduct.iswap(qubit1, qubit2)">
    Apply [`iSwapGate`](qiskit.circuit.library.iSwapGate "qiskit.circuit.library.iSwapGate").
  </Function>

  <span id="innerproduct-mcmt" />

  ### mcmt

  <Function id="qiskit.circuit.library.InnerProduct.mcmt" signature="InnerProduct.mcmt(gate, control_qubits, target_qubits, ancilla_qubits=None, mode='no-ancilla', *, single_control_gate_fun=None, q_controls=None, q_ancillae=None, q_targets=None)">
    Apply a multi-control, multi-target using a generic gate.

    This can also be used to implement a generic multi-control gate, as the target could also be of length 1.
  </Function>

  <span id="innerproduct-mcrx" />

  ### mcrx

  <Function id="qiskit.circuit.library.InnerProduct.mcrx" signature="InnerProduct.mcrx(theta, q_controls, q_target, use_basis_gates=False)">
  ...
  <span id="innerproduct-mcry" />

  ### mcry

  <Function id="qiskit.circuit.library.InnerProduct.mcry" signature="InnerProduct.mcry(theta, q_controls, q_target, q_ancillae, mode='basic', use_basis_gates=False)">
  ...
  <span id="innerproduct-mcrz" />

  ### mcrz

  <Function id="qiskit.circuit.library.InnerProduct.mcrz" signature="InnerProduct.mcrz(lam, q_controls, q_target, use_basis_gates=False)">
  ...
  <span id="innerproduct-mct" />

  ### mct

  <Function id="qiskit.circuit.library.InnerProduct.mct" signature="InnerProduct.mct(control_qubits, target_qubit, ancilla_qubits=None, mode='noancilla')">
    Apply `MCXGate`.
  </Function>

  <span id="innerproduct-mcu1" />

  ### mcu1

  <Function id="qiskit.circuit.library.InnerProduct.mcu1" signature="InnerProduct.mcu1(lam, control_qubits, target_qubit)">
    Apply `MCU1Gate`.
  </Function>

  <span id="innerproduct-mcx" />

  ### mcx

  <Function id="qiskit.circuit.library.InnerProduct.mcx" signature="InnerProduct.mcx(control_qubits, target_qubit, ancilla_qubits=None, mode='noancilla')">
    Apply `MCXGate`.
  ...
  <span id="innerproduct-measure" />

  ### measure

  <Function id="qiskit.circuit.library.InnerProduct.measure" signature="InnerProduct.measure(qubit, cbit)">
  ...
  <span id="innerproduct-measure-active" />

  ### measure\_active

  <Function id="qiskit.circuit.library.InnerProduct.measure_active" signature="InnerProduct.measure_active(inplace=True)">
  ...
  <span id="innerproduct-measure-all" />

  ### measure\_all

  <Function id="qiskit.circuit.library.InnerProduct.measure_all" signature="InnerProduct.measure_all(inplace=True)">
  ...
  <span id="innerproduct-mirror" />

  ### mirror

  <Function id="qiskit.circuit.library.InnerProduct.mirror" signature="InnerProduct.mirror()">
  ...
  <span id="innerproduct-ms" />

  ### ms

  <Function id="qiskit.circuit.library.InnerProduct.ms" signature="InnerProduct.ms(theta, qubits)">
    Apply [`MSGate`](qiskit.circuit.library.MSGate "qiskit.circuit.library.MSGate").
  </Function>

  <span id="innerproduct-num-connected-components" />

  ### num\_connected\_components

  <Function id="qiskit.circuit.library.InnerProduct.num_connected_components" signature="InnerProduct.num_connected_components(unitary_only=False)">
  ...
  <span id="innerproduct-num-nonlocal-gates" />

  ### num\_nonlocal\_gates

  <Function id="qiskit.circuit.library.InnerProduct.num_nonlocal_gates" signature="InnerProduct.num_nonlocal_gates()">
    Return number of non-local gates (i.e. involving 2+ qubits).

    Conditional nonlocal gates are also included.
  </Function>

  <span id="innerproduct-num-tensor-factors" />

  ### num\_tensor\_factors

  <Function id="qiskit.circuit.library.InnerProduct.num_tensor_factors" signature="InnerProduct.num_tensor_factors()">
  ...
  <span id="innerproduct-num-unitary-factors" />

  ### num\_unitary\_factors

  <Function id="qiskit.circuit.library.InnerProduct.num_unitary_factors" signature="InnerProduct.num_unitary_factors()">
    Computes the number of tensor factors in the unitary (quantum) part of the circuit only.
  </Function>

  <span id="innerproduct-qasm" />

  ### qasm

  <Function id="qiskit.circuit.library.InnerProduct.qasm" signature="InnerProduct.qasm(formatted=False, filename=None)">
  ...
  <span id="innerproduct-qbit-argument-conversion" />

  ### qbit\_argument\_conversion

  <Function id="qiskit.circuit.library.InnerProduct.qbit_argument_conversion" signature="InnerProduct.qbit_argument_conversion(qubit_representation)">
  ...
  <span id="innerproduct-r" />

  ### r

  <Function id="qiskit.circuit.library.InnerProduct.r" signature="InnerProduct.r(theta, phi, qubit, *, q=None)">
    Apply `RGate`.
  </Function>

  <span id="innerproduct-rcccx" />

  ### rcccx

  <Function id="qiskit.circuit.library.InnerProduct.rcccx" signature="InnerProduct.rcccx(control_qubit1, control_qubit2, control_qubit3, target_qubit)">
    Apply [`RC3XGate`](qiskit.circuit.library.RC3XGate "qiskit.circuit.library.RC3XGate").
  </Function>

  <span id="innerproduct-rccx" />

  ### rccx

  <Function id="qiskit.circuit.library.InnerProduct.rccx" signature="InnerProduct.rccx(control_qubit1, control_qubit2, target_qubit)">
    Apply [`RCCXGate`](qiskit.circuit.library.RCCXGate "qiskit.circuit.library.RCCXGate").
  </Function>

  <span id="innerproduct-remove-final-measurements" />

  ### remove\_final\_measurements

  <Function id="qiskit.circuit.library.InnerProduct.remove_final_measurements" signature="InnerProduct.remove_final_measurements(inplace=True)">
  ...
  <span id="innerproduct-reset" />

  ### reset

  <Function id="qiskit.circuit.library.InnerProduct.reset" signature="InnerProduct.reset(qubit)">
    Reset q.
  </Function>

  <span id="innerproduct-rx" />

  ### rx

  <Function id="qiskit.circuit.library.InnerProduct.rx" signature="InnerProduct.rx(theta, qubit, *, label=None, q=None)">
    Apply [`RXGate`](qiskit.circuit.library.RXGate "qiskit.circuit.library.RXGate").
  </Function>

  <span id="innerproduct-rxx" />

  ### rxx

  <Function id="qiskit.circuit.library.InnerProduct.rxx" signature="InnerProduct.rxx(theta, qubit1, qubit2)">
    Apply [`RXXGate`](qiskit.circuit.library.RXXGate "qiskit.circuit.library.RXXGate").
  </Function>

  <span id="innerproduct-ry" />

  ### ry

  <Function id="qiskit.circuit.library.InnerProduct.ry" signature="InnerProduct.ry(theta, qubit, *, label=None, q=None)">
    Apply [`RYGate`](qiskit.circuit.library.RYGate "qiskit.circuit.library.RYGate").
  </Function>

  <span id="innerproduct-ryy" />

  ### ryy

  <Function id="qiskit.circuit.library.InnerProduct.ryy" signature="InnerProduct.ryy(theta, qubit1, qubit2)">
    Apply [`RYYGate`](qiskit.circuit.library.RYYGate "qiskit.circuit.library.RYYGate").
  </Function>

  <span id="innerproduct-rz" />

  ### rz

  <Function id="qiskit.circuit.library.InnerProduct.rz" signature="InnerProduct.rz(phi, qubit, *, q=None)">
    Apply [`RZGate`](qiskit.circuit.library.RZGate "qiskit.circuit.library.RZGate").
  </Function>

  <span id="innerproduct-rzx" />

  ### rzx

  <Function id="qiskit.circuit.library.InnerProduct.rzx" signature="InnerProduct.rzx(theta, qubit1, qubit2)">
    Apply [`RZXGate`](qiskit.circuit.library.RZXGate "qiskit.circuit.library.RZXGate").
  </Function>

  <span id="innerproduct-rzz" />

  ### rzz

  <Function id="qiskit.circuit.library.InnerProduct.rzz" signature="InnerProduct.rzz(theta, qubit1, qubit2)">
    Apply [`RZZGate`](qiskit.circuit.library.RZZGate "qiskit.circuit.library.RZZGate").
  </Function>

  <span id="innerproduct-s" />

  ### s

  <Function id="qiskit.circuit.library.InnerProduct.s" signature="InnerProduct.s(qubit, *, q=None)">
    Apply [`SGate`](qiskit.circuit.library.SGate "qiskit.circuit.library.SGate").
  </Function>

  <span id="innerproduct-sdg" />

  ### sdg

  <Function id="qiskit.circuit.library.InnerProduct.sdg" signature="InnerProduct.sdg(qubit, *, q=None)">
    Apply [`SdgGate`](qiskit.circuit.library.SdgGate "qiskit.circuit.library.SdgGate").
  </Function>

  <span id="innerproduct-size" />

  ### size

  <Function id="qiskit.circuit.library.InnerProduct.size" signature="InnerProduct.size()">
  ...
  <span id="innerproduct-snapshot" />

  ### snapshot

  <Function id="qiskit.circuit.library.InnerProduct.snapshot" signature="InnerProduct.snapshot(label, snapshot_type='statevector', qubits=None, params=None)">
  ...
  <span id="innerproduct-snapshot-density-matrix" />

  ### snapshot\_density\_matrix

  <Function id="qiskit.circuit.library.InnerProduct.snapshot_density_matrix" signature="InnerProduct.snapshot_density_matrix(label, qubits=None)">
  ...
  <span id="innerproduct-snapshot-expectation-value" />

  ### snapshot\_expectation\_value

  <Function id="qiskit.circuit.library.InnerProduct.snapshot_expectation_value" signature="InnerProduct.snapshot_expectation_value(label, op, qubits, single_shot=False, variance=False)">
  ...
  <span id="innerproduct-snapshot-probabilities" />

  ### snapshot\_probabilities

  <Function id="qiskit.circuit.library.InnerProduct.snapshot_probabilities" signature="InnerProduct.snapshot_probabilities(label, qubits, variance=False)">
  ...
  <span id="innerproduct-snapshot-stabilizer" />

  ### snapshot\_stabilizer

  <Function id="qiskit.circuit.library.InnerProduct.snapshot_stabilizer" signature="InnerProduct.snapshot_stabilizer(label)">
  ...
  <span id="innerproduct-snapshot-statevector" />

  ### snapshot\_statevector

  <Function id="qiskit.circuit.library.InnerProduct.snapshot_statevector" signature="InnerProduct.snapshot_statevector(label)">
  ...
  <span id="innerproduct-squ" />

  ### squ

  <Function id="qiskit.circuit.library.InnerProduct.squ" signature="InnerProduct.squ(unitary_matrix, qubit, mode='ZYZ', up_to_diagonal=False, *, u=None)">
  ...
  <span id="innerproduct-swap" />

  ### swap

  <Function id="qiskit.circuit.library.InnerProduct.swap" signature="InnerProduct.swap(qubit1, qubit2)">
    Apply [`SwapGate`](qiskit.circuit.library.SwapGate "qiskit.circuit.library.SwapGate").
  </Function>

  <span id="innerproduct-t" />

  ### t

  <Function id="qiskit.circuit.library.InnerProduct.t" signature="InnerProduct.t(qubit, *, q=None)">
    Apply [`TGate`](qiskit.circuit.library.TGate "qiskit.circuit.library.TGate").
  </Function>

  <span id="innerproduct-tdg" />

  ### tdg

  <Function id="qiskit.circuit.library.InnerProduct.tdg" signature="InnerProduct.tdg(qubit, *, q=None)">
    Apply [`TdgGate`](qiskit.circuit.library.TdgGate "qiskit.circuit.library.TdgGate").
  </Function>

  <span id="innerproduct-to-gate" />

  ### to\_gate

  <Function id="qiskit.circuit.library.InnerProduct.to_gate" signature="InnerProduct.to_gate(parameter_map=None)">
  ...
  <span id="innerproduct-to-instruction" />

  ### to\_instruction

  <Function id="qiskit.circuit.library.InnerProduct.to_instruction" signature="InnerProduct.to_instruction(parameter_map=None)">
  ...
  <span id="innerproduct-toffoli" />

  ### toffoli

  <Function id="qiskit.circuit.library.InnerProduct.toffoli" signature="InnerProduct.toffoli(control_qubit1, control_qubit2, target_qubit, *, ctl1=None, ctl2=None, tgt=None)">
    Apply [`CCXGate`](qiskit.circuit.library.CCXGate "qiskit.circuit.library.CCXGate").
  </Function>

  <span id="innerproduct-u1" />

  ### u1

  <Function id="qiskit.circuit.library.InnerProduct.u1" signature="InnerProduct.u1(theta, qubit, *, q=None)">
    Apply [`U1Gate`](qiskit.circuit.library.U1Gate "qiskit.circuit.library.U1Gate").
  </Function>

  <span id="innerproduct-u2" />

  ### u2

  <Function id="qiskit.circuit.library.InnerProduct.u2" signature="InnerProduct.u2(phi, lam, qubit, *, q=None)">
    Apply [`U2Gate`](qiskit.circuit.library.U2Gate "qiskit.circuit.library.U2Gate").
  </Function>

  <span id="innerproduct-u3" />

  ### u3

  <Function id="qiskit.circuit.library.InnerProduct.u3" signature="InnerProduct.u3(theta, phi, lam, qubit, *, q=None)">
    Apply [`U3Gate`](qiskit.circuit.library.U3Gate "qiskit.circuit.library.U3Gate").
  </Function>

  <span id="innerproduct-uc" />

  ### uc

  <Function id="qiskit.circuit.library.InnerProduct.uc" signature="InnerProduct.uc(gate_list, q_controls, q_target, up_to_diagonal=False)">
  ...
  <span id="innerproduct-ucg" />

  ### ucg

  <Function id="qiskit.circuit.library.InnerProduct.ucg" signature="InnerProduct.ucg(angle_list, q_controls, q_target, up_to_diagonal=False)">
    Deprecated version of uc.
  </Function>

  <span id="innerproduct-ucrx" />

  ### ucrx

  <Function id="qiskit.circuit.library.InnerProduct.ucrx" signature="InnerProduct.ucrx(angle_list, q_controls, q_target)">
  ...
  <span id="innerproduct-ucry" />

  ### ucry

  <Function id="qiskit.circuit.library.InnerProduct.ucry" signature="InnerProduct.ucry(angle_list, q_controls, q_target)">
  ...
  <span id="innerproduct-ucrz" />

  ### ucrz

  <Function id="qiskit.circuit.library.InnerProduct.ucrz" signature="InnerProduct.ucrz(angle_list, q_controls, q_target)">
  ...
  <span id="innerproduct-ucx" />

  ### ucx

  <Function id="qiskit.circuit.library.InnerProduct.ucx" signature="InnerProduct.ucx(angle_list, q_controls, q_target)">
    Deprecated version of ucrx.
  </Function>

  <span id="innerproduct-ucy" />

  ### ucy

  <Function id="qiskit.circuit.library.InnerProduct.ucy" signature="InnerProduct.ucy(angle_list, q_controls, q_target)">
    Deprecated version of ucry.
  </Function>

  <span id="innerproduct-ucz" />

  ### ucz

  <Function id="qiskit.circuit.library.InnerProduct.ucz" signature="InnerProduct.ucz(angle_list, q_controls, q_target)">
    Deprecated version of ucrz.
  </Function>

  <span id="innerproduct-unitary" />

  ### unitary

  <Function id="qiskit.circuit.library.InnerProduct.unitary" signature="InnerProduct.unitary(obj, qubits, label=None)">
    Apply unitary gate to q.
  </Function>

  <span id="innerproduct-width" />

  ### width

  <Function id="qiskit.circuit.library.InnerProduct.width" signature="InnerProduct.width()">
  ...
  <span id="innerproduct-x" />

  ### x

  <Function id="qiskit.circuit.library.InnerProduct.x" signature="InnerProduct.x(qubit, *, label=None, ctrl_state=None, q=None)">
    Apply [`XGate`](qiskit.circuit.library.XGate "qiskit.circuit.library.XGate").
  </Function>

  <span id="innerproduct-y" />

  ### y

  <Function id="qiskit.circuit.library.InnerProduct.y" signature="InnerProduct.y(qubit, *, q=None)">
    Apply [`YGate`](qiskit.circuit.library.YGate "qiskit.circuit.library.YGate").
  </Function>

  <span id="innerproduct-z" />

  ### z

  <Function id="qiskit.circuit.library.InnerProduct.z" signature="InnerProduct.z(qubit, *, q=None)">
