...
<Class id="qiskit.circuit.library.InnerProduct" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.14/qiskit/circuit/library/boolean_logic/inner_product.py" signature="InnerProduct(num_qubits)">
  ...
  **Reference Circuit:**
  ...
  <Attribute id="qiskit.circuit.library.InnerProduct.clbits" name="clbits">
    Returns a list of classical bits in the order that the registers were added.
  </Attribute>

  ### data

  <Attribute id="qiskit.circuit.library.InnerProduct.data" name="data">
  ...
  <Attribute id="qiskit.circuit.library.InnerProduct.extension_lib" signature="= 'include \&#x22;qelib1.inc\&#x22;;'" />

  ### header

  <Attribute id="qiskit.circuit.library.InnerProduct.header" signature="= 'OPENQASM 2.0;'" />

  ### instances

  <Attribute id="qiskit.circuit.library.InnerProduct.instances" signature="= 8" />

  ### n\_qubits

  <Attribute id="qiskit.circuit.library.InnerProduct.n_qubits" name="n_qubits">
    Deprecated, use `num_qubits` instead. Return number of qubits.
  </Attribute>

  ### num\_clbits

  <Attribute id="qiskit.circuit.library.InnerProduct.num_clbits" name="num_clbits">
    Return number of classical bits.
  </Attribute>

  ### num\_parameters

  <Attribute id="qiskit.circuit.library.InnerProduct.num_parameters" name="num_parameters">
    Convenience function to get the number of parameter objects in the circuit.
  </Attribute>

  ### num\_qubits

  <Attribute id="qiskit.circuit.library.InnerProduct.num_qubits" name="num_qubits">
    Return number of qubits.
  </Attribute>

  ### parameters

  <Attribute id="qiskit.circuit.library.InnerProduct.parameters" name="parameters">
    Convenience function to get the parameters defined in the parameter table.
  </Attribute>

  ### prefix

  <Attribute id="qiskit.circuit.library.InnerProduct.prefix" signature="= 'circuit'" />

  ### qubits

  <Attribute id="qiskit.circuit.library.InnerProduct.qubits" name="qubits">
  ...
  <Function id="qiskit.circuit.library.InnerProduct.AND" name="AND" signature="InnerProduct.AND(qr_variables, qb_target, qr_ancillae, flags=None, mct_mode='no-ancilla')">
  ...
  <Function id="qiskit.circuit.library.InnerProduct.OR" name="OR" signature="InnerProduct.OR(qr_variables, qb_target, qr_ancillae, flags=None, mct_mode='basic')">
  ...
  <Function id="qiskit.circuit.library.InnerProduct.__getitem__" name="__getitem__" signature="InnerProduct.__getitem__(item)">
    Return indexed operation.
  </Function>

  ### \_\_len\_\_

  <Function id="qiskit.circuit.library.InnerProduct.__len__" name="__len__" signature="InnerProduct.__len__()">
    Return number of operations in circuit.
  </Function>

  ### add\_register

  <Function id="qiskit.circuit.library.InnerProduct.add_register" name="add_register" signature="InnerProduct.add_register(*regs)">
    Add registers.
  </Function>

  ### append

  <Function id="qiskit.circuit.library.InnerProduct.append" name="append" signature="InnerProduct.append(instruction, qargs=None, cargs=None)">
  ...
  <Function id="qiskit.circuit.library.InnerProduct.assign_parameters" name="assign_parameters" signature="InnerProduct.assign_parameters(param_dict, inplace=False)">
  ...
  <Function id="qiskit.circuit.library.InnerProduct.barrier" name="barrier" signature="InnerProduct.barrier(*qargs)">
    Apply `Barrier`. If qargs is None, applies to all.
  </Function>

  ### bind\_parameters

  <Function id="qiskit.circuit.library.InnerProduct.bind_parameters" name="bind_parameters" signature="InnerProduct.bind_parameters(value_dict)">
  ...
  <Function id="qiskit.circuit.library.InnerProduct.cast" name="cast" signature="static InnerProduct.cast(value, _type)">
    Best effort to cast value to type. Otherwise, returns the value.
  </Function>

  ### cbit\_argument\_conversion

  <Function id="qiskit.circuit.library.InnerProduct.cbit_argument_conversion" name="cbit_argument_conversion" signature="InnerProduct.cbit_argument_conversion(clbit_representation)">
  ...
  <Function id="qiskit.circuit.library.InnerProduct.ccx" name="ccx" signature="InnerProduct.ccx(control_qubit1, control_qubit2, target_qubit, *, ctl1=None, ctl2=None, tgt=None)">
    Apply [`CCXGate`](qiskit.circuit.library.CCXGate "qiskit.circuit.library.CCXGate").
  </Function>

  ### ch

  <Function id="qiskit.circuit.library.InnerProduct.ch" name="ch" signature="InnerProduct.ch(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CHGate`](qiskit.circuit.library.CHGate "qiskit.circuit.library.CHGate").
  </Function>

  ### cls\_instances

  <Function id="qiskit.circuit.library.InnerProduct.cls_instances" name="cls_instances" signature="classmethod InnerProduct.cls_instances()">
    Return the current number of instances of this class, useful for auto naming.
  </Function>

  ### cls\_prefix

  <Function id="qiskit.circuit.library.InnerProduct.cls_prefix" name="cls_prefix" signature="classmethod InnerProduct.cls_prefix()">
    Return the prefix to use for auto naming.
  </Function>

  ### cnot

  <Function id="qiskit.circuit.library.InnerProduct.cnot" name="cnot" signature="InnerProduct.cnot(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CXGate`](qiskit.circuit.library.CXGate "qiskit.circuit.library.CXGate").
  </Function>

  ### combine

  <Function id="qiskit.circuit.library.InnerProduct.combine" name="combine" signature="InnerProduct.combine(rhs)">
  ...
  <Function id="qiskit.circuit.library.InnerProduct.compose" name="compose" signature="InnerProduct.compose(other, qubits=None, clbits=None, front=False, inplace=False)">
  ...
  <Function id="qiskit.circuit.library.InnerProduct.copy" name="copy" signature="InnerProduct.copy(name=None)">
    Copy the circuit.
  ...
  <Function id="qiskit.circuit.library.InnerProduct.count_ops" name="count_ops" signature="InnerProduct.count_ops()">
  ...
  <Function id="qiskit.circuit.library.InnerProduct.crx" name="crx" signature="InnerProduct.crx(theta, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CRXGate`](qiskit.circuit.library.CRXGate "qiskit.circuit.library.CRXGate").
  </Function>

  ### cry

  <Function id="qiskit.circuit.library.InnerProduct.cry" name="cry" signature="InnerProduct.cry(theta, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CRYGate`](qiskit.circuit.library.CRYGate "qiskit.circuit.library.CRYGate").
  </Function>

  ### crz

  <Function id="qiskit.circuit.library.InnerProduct.crz" name="crz" signature="InnerProduct.crz(theta, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CRZGate`](qiskit.circuit.library.CRZGate "qiskit.circuit.library.CRZGate").
  </Function>

  ### cswap

  <Function id="qiskit.circuit.library.InnerProduct.cswap" name="cswap" signature="InnerProduct.cswap(control_qubit, target_qubit1, target_qubit2, *, label=None, ctrl_state=None, ctl=None, tgt1=None, tgt2=None)">
    Apply [`CSwapGate`](qiskit.circuit.library.CSwapGate "qiskit.circuit.library.CSwapGate").
  </Function>

  ### cu1

  <Function id="qiskit.circuit.library.InnerProduct.cu1" name="cu1" signature="InnerProduct.cu1(theta, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CU1Gate`](qiskit.circuit.library.CU1Gate "qiskit.circuit.library.CU1Gate").
  </Function>

  ### cu3

  <Function id="qiskit.circuit.library.InnerProduct.cu3" name="cu3" signature="InnerProduct.cu3(theta, phi, lam, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CU3Gate`](qiskit.circuit.library.CU3Gate "qiskit.circuit.library.CU3Gate").
  </Function>

  ### cx

  <Function id="qiskit.circuit.library.InnerProduct.cx" name="cx" signature="InnerProduct.cx(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CXGate`](qiskit.circuit.library.CXGate "qiskit.circuit.library.CXGate").
  </Function>

  ### cy

  <Function id="qiskit.circuit.library.InnerProduct.cy" name="cy" signature="InnerProduct.cy(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CYGate`](qiskit.circuit.library.CYGate "qiskit.circuit.library.CYGate").
  </Function>

  ### cz

  <Function id="qiskit.circuit.library.InnerProduct.cz" name="cz" signature="InnerProduct.cz(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CZGate`](qiskit.circuit.library.CZGate "qiskit.circuit.library.CZGate").
  </Function>

  ### dcx

  <Function id="qiskit.circuit.library.InnerProduct.dcx" name="dcx" signature="InnerProduct.dcx(qubit1, qubit2)">
    Apply [`DCXGate`](qiskit.circuit.library.DCXGate "qiskit.circuit.library.DCXGate").
  </Function>

  ### decompose

  <Function id="qiskit.circuit.library.InnerProduct.decompose" name="decompose" signature="InnerProduct.decompose()">
  ...
  <Function id="qiskit.circuit.library.InnerProduct.depth" name="depth" signature="InnerProduct.depth()">
  ...
  <Function id="qiskit.circuit.library.InnerProduct.diag_gate" name="diag_gate" signature="InnerProduct.diag_gate(diag, qubit)">
    Deprecated version of QuantumCircuit.diagonal.
  </Function>

  ### diagonal

  <Function id="qiskit.circuit.library.InnerProduct.diagonal" name="diagonal" signature="InnerProduct.diagonal(diag, qubit)">
  ...
  <Function id="qiskit.circuit.library.InnerProduct.extend" name="extend" signature="InnerProduct.extend(rhs)">
  ...
  <Function id="qiskit.circuit.library.InnerProduct.fredkin" name="fredkin" signature="InnerProduct.fredkin(control_qubit, target_qubit1, target_qubit2, *, ctl=None, tgt1=None, tgt2=None)">
    Apply [`CSwapGate`](qiskit.circuit.library.CSwapGate "qiskit.circuit.library.CSwapGate").
  </Function>

  ### from\_qasm\_file

  <Function id="qiskit.circuit.library.InnerProduct.from_qasm_file" name="from_qasm_file" signature="static InnerProduct.from_qasm_file(path)">
  ...
  <Function id="qiskit.circuit.library.InnerProduct.from_qasm_str" name="from_qasm_str" signature="static InnerProduct.from_qasm_str(qasm_str)">
  ...
  <Function id="qiskit.circuit.library.InnerProduct.h" name="h" signature="InnerProduct.h(qubit, *, q=None)">
    Apply [`HGate`](qiskit.circuit.library.HGate "qiskit.circuit.library.HGate").
  </Function>

  ### hamiltonian

  <Function id="qiskit.circuit.library.InnerProduct.hamiltonian" name="hamiltonian" signature="InnerProduct.hamiltonian(operator, time, qubits, label=None)">
    Apply hamiltonian evolution to to qubits.
  </Function>

  ### has\_register

  <Function id="qiskit.circuit.library.InnerProduct.has_register" name="has_register" signature="InnerProduct.has_register(register)">
  ...
  <Function id="qiskit.circuit.library.InnerProduct.i" name="i" signature="InnerProduct.i(qubit, *, q=None)">
    Apply [`IGate`](qiskit.circuit.library.IGate "qiskit.circuit.library.IGate").
  </Function>

  ### id

  <Function id="qiskit.circuit.library.InnerProduct.id" name="id" signature="InnerProduct.id(qubit, *, q=None)">
    Apply [`IGate`](qiskit.circuit.library.IGate "qiskit.circuit.library.IGate").
  </Function>

  ### iden

  <Function id="qiskit.circuit.library.InnerProduct.iden" name="iden" signature="InnerProduct.iden(qubit, *, q=None)">
    Deprecated identity gate.
  </Function>

  ### initialize

  <Function id="qiskit.circuit.library.InnerProduct.initialize" name="initialize" signature="InnerProduct.initialize(params, qubits)">
    Apply initialize to circuit.
  </Function>

  ### inverse

  <Function id="qiskit.circuit.library.InnerProduct.inverse" name="inverse" signature="InnerProduct.inverse()">
    Invert this circuit.
  ...
  <Function id="qiskit.circuit.library.InnerProduct.iso" name="iso" signature="InnerProduct.iso(isometry, q_input, q_ancillas_for_output, q_ancillas_zero=None, q_ancillas_dirty=None)">
  ...
  <Function id="qiskit.circuit.library.InnerProduct.isometry" name="isometry" signature="InnerProduct.isometry(isometry, q_input, q_ancillas_for_output, q_ancillas_zero=None, q_ancillas_dirty=None)">
    Attach an arbitrary isometry from m to n qubits to a circuit. In particular, this allows to attach arbitrary unitaries on n qubits (m=n) or to prepare any state on n qubits (m=0). The decomposition used here was introduced by Iten et al. in [https://arxiv.org/abs/1501.06911](https://arxiv.org/abs/1501.06911).
  ...
  <Function id="qiskit.circuit.library.InnerProduct.iswap" name="iswap" signature="InnerProduct.iswap(qubit1, qubit2)">
    Apply [`iSwapGate`](qiskit.circuit.library.iSwapGate "qiskit.circuit.library.iSwapGate").
  </Function>

  ### mcmt

  <Function id="qiskit.circuit.library.InnerProduct.mcmt" name="mcmt" signature="InnerProduct.mcmt(gate, control_qubits, target_qubits, ancilla_qubits=None, mode='no-ancilla', *, single_control_gate_fun=None, q_controls=None, q_ancillae=None, q_targets=None)">
  ...
  <Function id="qiskit.circuit.library.InnerProduct.mcrx" name="mcrx" signature="InnerProduct.mcrx(theta, q_controls, q_target, use_basis_gates=False)">
  ...
  <Function id="qiskit.circuit.library.InnerProduct.mcry" name="mcry" signature="InnerProduct.mcry(theta, q_controls, q_target, q_ancillae, mode='basic', use_basis_gates=False)">
  ...
  <Function id="qiskit.circuit.library.InnerProduct.mcrz" name="mcrz" signature="InnerProduct.mcrz(lam, q_controls, q_target, use_basis_gates=False)">
  ...
  <Function id="qiskit.circuit.library.InnerProduct.mct" name="mct" signature="InnerProduct.mct(control_qubits, target_qubit, ancilla_qubits=None, mode='noancilla')">
    Apply `MCXGate`.
  </Function>

  ### mcu1

  <Function id="qiskit.circuit.library.InnerProduct.mcu1" name="mcu1" signature="InnerProduct.mcu1(lam, control_qubits, target_qubit)">
    Apply `MCU1Gate`.
  </Function>

  ### mcx

  <Function id="qiskit.circuit.library.InnerProduct.mcx" name="mcx" signature="InnerProduct.mcx(control_qubits, target_qubit, ancilla_qubits=None, mode='noancilla')">
    Apply `MCXGate`.
  ...
  <Function id="qiskit.circuit.library.InnerProduct.measure" name="measure" signature="InnerProduct.measure(qubit, cbit)">
  ...
  <Function id="qiskit.circuit.library.InnerProduct.measure_active" name="measure_active" signature="InnerProduct.measure_active(inplace=True)">
  ...
  <Function id="qiskit.circuit.library.InnerProduct.measure_all" name="measure_all" signature="InnerProduct.measure_all(inplace=True)">
  ...
  <Function id="qiskit.circuit.library.InnerProduct.mirror" name="mirror" signature="InnerProduct.mirror()">
  ...
  <Function id="qiskit.circuit.library.InnerProduct.ms" name="ms" signature="InnerProduct.ms(theta, qubits)">
    Apply [`MSGate`](qiskit.circuit.library.MSGate "qiskit.circuit.library.MSGate").
  </Function>

  ### num\_connected\_components

  <Function id="qiskit.circuit.library.InnerProduct.num_connected_components" name="num_connected_components" signature="InnerProduct.num_connected_components(unitary_only=False)">
  ...
  <Function id="qiskit.circuit.library.InnerProduct.num_nonlocal_gates" name="num_nonlocal_gates" signature="InnerProduct.num_nonlocal_gates()">
  ...
  <Function id="qiskit.circuit.library.InnerProduct.num_tensor_factors" name="num_tensor_factors" signature="InnerProduct.num_tensor_factors()">
  ...
  <Function id="qiskit.circuit.library.InnerProduct.num_unitary_factors" name="num_unitary_factors" signature="InnerProduct.num_unitary_factors()">
    Computes the number of tensor factors in the unitary (quantum) part of the circuit only.
  </Function>

  ### qasm

  <Function id="qiskit.circuit.library.InnerProduct.qasm" name="qasm" signature="InnerProduct.qasm(formatted=False, filename=None)">
  ...
  <Function id="qiskit.circuit.library.InnerProduct.qbit_argument_conversion" name="qbit_argument_conversion" signature="InnerProduct.qbit_argument_conversion(qubit_representation)">
  ...
  <Function id="qiskit.circuit.library.InnerProduct.r" name="r" signature="InnerProduct.r(theta, phi, qubit, *, q=None)">
    Apply `RGate`.
  </Function>

  ### rcccx

  <Function id="qiskit.circuit.library.InnerProduct.rcccx" name="rcccx" signature="InnerProduct.rcccx(control_qubit1, control_qubit2, control_qubit3, target_qubit)">
    Apply [`RC3XGate`](qiskit.circuit.library.RC3XGate "qiskit.circuit.library.RC3XGate").
  </Function>

  ### rccx

  <Function id="qiskit.circuit.library.InnerProduct.rccx" name="rccx" signature="InnerProduct.rccx(control_qubit1, control_qubit2, target_qubit)">
    Apply [`RCCXGate`](qiskit.circuit.library.RCCXGate "qiskit.circuit.library.RCCXGate").
  </Function>

  ### remove\_final\_measurements

  <Function id="qiskit.circuit.library.InnerProduct.remove_final_measurements" name="remove_final_measurements" signature="InnerProduct.remove_final_measurements(inplace=True)">
  ...
  <Function id="qiskit.circuit.library.InnerProduct.reset" name="reset" signature="InnerProduct.reset(qubit)">
    Reset q.
  </Function>

  ### rx

  <Function id="qiskit.circuit.library.InnerProduct.rx" name="rx" signature="InnerProduct.rx(theta, qubit, *, label=None, q=None)">
    Apply [`RXGate`](qiskit.circuit.library.RXGate "qiskit.circuit.library.RXGate").
  </Function>

  ### rxx

  <Function id="qiskit.circuit.library.InnerProduct.rxx" name="rxx" signature="InnerProduct.rxx(theta, qubit1, qubit2)">
    Apply [`RXXGate`](qiskit.circuit.library.RXXGate "qiskit.circuit.library.RXXGate").
  </Function>

  ### ry

  <Function id="qiskit.circuit.library.InnerProduct.ry" name="ry" signature="InnerProduct.ry(theta, qubit, *, label=None, q=None)">
    Apply [`RYGate`](qiskit.circuit.library.RYGate "qiskit.circuit.library.RYGate").
  </Function>

  ### ryy

  <Function id="qiskit.circuit.library.InnerProduct.ryy" name="ryy" signature="InnerProduct.ryy(theta, qubit1, qubit2)">
    Apply [`RYYGate`](qiskit.circuit.library.RYYGate "qiskit.circuit.library.RYYGate").
  </Function>

  ### rz

  <Function id="qiskit.circuit.library.InnerProduct.rz" name="rz" signature="InnerProduct.rz(phi, qubit, *, q=None)">
    Apply [`RZGate`](qiskit.circuit.library.RZGate "qiskit.circuit.library.RZGate").
  </Function>

  ### rzx

  <Function id="qiskit.circuit.library.InnerProduct.rzx" name="rzx" signature="InnerProduct.rzx(theta, qubit1, qubit2)">
    Apply [`RZXGate`](qiskit.circuit.library.RZXGate "qiskit.circuit.library.RZXGate").
  </Function>

  ### rzz

  <Function id="qiskit.circuit.library.InnerProduct.rzz" name="rzz" signature="InnerProduct.rzz(theta, qubit1, qubit2)">
    Apply [`RZZGate`](qiskit.circuit.library.RZZGate "qiskit.circuit.library.RZZGate").
  </Function>

  ### s

  <Function id="qiskit.circuit.library.InnerProduct.s" name="s" signature="InnerProduct.s(qubit, *, q=None)">
    Apply [`SGate`](qiskit.circuit.library.SGate "qiskit.circuit.library.SGate").
  </Function>

  ### sdg

  <Function id="qiskit.circuit.library.InnerProduct.sdg" name="sdg" signature="InnerProduct.sdg(qubit, *, q=None)">
    Apply [`SdgGate`](qiskit.circuit.library.SdgGate "qiskit.circuit.library.SdgGate").
  </Function>

  ### size

  <Function id="qiskit.circuit.library.InnerProduct.size" name="size" signature="InnerProduct.size()">
  ...
  <Function id="qiskit.circuit.library.InnerProduct.snapshot" name="snapshot" signature="InnerProduct.snapshot(label, snapshot_type='statevector', qubits=None, params=None)">
  ...
  <Function id="qiskit.circuit.library.InnerProduct.snapshot_density_matrix" name="snapshot_density_matrix" signature="InnerProduct.snapshot_density_matrix(label, qubits=None)">
  ...
  <Function id="qiskit.circuit.library.InnerProduct.snapshot_expectation_value" name="snapshot_expectation_value" signature="InnerProduct.snapshot_expectation_value(label, op, qubits, single_shot=False, variance=False)">
  ...
  <Function id="qiskit.circuit.library.InnerProduct.snapshot_probabilities" name="snapshot_probabilities" signature="InnerProduct.snapshot_probabilities(label, qubits, variance=False)">
  ...
  <Function id="qiskit.circuit.library.InnerProduct.snapshot_stabilizer" name="snapshot_stabilizer" signature="InnerProduct.snapshot_stabilizer(label)">
  ...
  <Function id="qiskit.circuit.library.InnerProduct.snapshot_statevector" name="snapshot_statevector" signature="InnerProduct.snapshot_statevector(label)">
  ...
  <Function id="qiskit.circuit.library.InnerProduct.squ" name="squ" signature="InnerProduct.squ(unitary_matrix, qubit, mode='ZYZ', up_to_diagonal=False, *, u=None)">
  ...
  <Function id="qiskit.circuit.library.InnerProduct.swap" name="swap" signature="InnerProduct.swap(qubit1, qubit2)">
    Apply [`SwapGate`](qiskit.circuit.library.SwapGate "qiskit.circuit.library.SwapGate").
  </Function>

  ### t

  <Function id="qiskit.circuit.library.InnerProduct.t" name="t" signature="InnerProduct.t(qubit, *, q=None)">
    Apply [`TGate`](qiskit.circuit.library.TGate "qiskit.circuit.library.TGate").
  </Function>

  ### tdg

  <Function id="qiskit.circuit.library.InnerProduct.tdg" name="tdg" signature="InnerProduct.tdg(qubit, *, q=None)">
    Apply [`TdgGate`](qiskit.circuit.library.TdgGate "qiskit.circuit.library.TdgGate").
  </Function>

  ### to\_gate

  <Function id="qiskit.circuit.library.InnerProduct.to_gate" name="to_gate" signature="InnerProduct.to_gate(parameter_map=None)">
  ...
  <Function id="qiskit.circuit.library.InnerProduct.to_instruction" name="to_instruction" signature="InnerProduct.to_instruction(parameter_map=None)">
  ...
  <Function id="qiskit.circuit.library.InnerProduct.toffoli" name="toffoli" signature="InnerProduct.toffoli(control_qubit1, control_qubit2, target_qubit, *, ctl1=None, ctl2=None, tgt=None)">
    Apply [`CCXGate`](qiskit.circuit.library.CCXGate "qiskit.circuit.library.CCXGate").
  </Function>

  ### u1

  <Function id="qiskit.circuit.library.InnerProduct.u1" name="u1" signature="InnerProduct.u1(theta, qubit, *, q=None)">
    Apply [`U1Gate`](qiskit.circuit.library.U1Gate "qiskit.circuit.library.U1Gate").
  </Function>

  ### u2

  <Function id="qiskit.circuit.library.InnerProduct.u2" name="u2" signature="InnerProduct.u2(phi, lam, qubit, *, q=None)">
    Apply [`U2Gate`](qiskit.circuit.library.U2Gate "qiskit.circuit.library.U2Gate").
  </Function>

  ### u3

  <Function id="qiskit.circuit.library.InnerProduct.u3" name="u3" signature="InnerProduct.u3(theta, phi, lam, qubit, *, q=None)">
    Apply [`U3Gate`](qiskit.circuit.library.U3Gate "qiskit.circuit.library.U3Gate").
  </Function>

  ### uc

  <Function id="qiskit.circuit.library.InnerProduct.uc" name="uc" signature="InnerProduct.uc(gate_list, q_controls, q_target, up_to_diagonal=False)">
  ...
  <Function id="qiskit.circuit.library.InnerProduct.ucg" name="ucg" signature="InnerProduct.ucg(angle_list, q_controls, q_target, up_to_diagonal=False)">
    Deprecated version of uc.
  </Function>

  ### ucrx

  <Function id="qiskit.circuit.library.InnerProduct.ucrx" name="ucrx" signature="InnerProduct.ucrx(angle_list, q_controls, q_target)">
  ...
  <Function id="qiskit.circuit.library.InnerProduct.ucry" name="ucry" signature="InnerProduct.ucry(angle_list, q_controls, q_target)">
  ...
  <Function id="qiskit.circuit.library.InnerProduct.ucrz" name="ucrz" signature="InnerProduct.ucrz(angle_list, q_controls, q_target)">
  ...
  <Function id="qiskit.circuit.library.InnerProduct.ucx" name="ucx" signature="InnerProduct.ucx(angle_list, q_controls, q_target)">
    Deprecated version of ucrx.
  </Function>

  ### ucy

  <Function id="qiskit.circuit.library.InnerProduct.ucy" name="ucy" signature="InnerProduct.ucy(angle_list, q_controls, q_target)">
    Deprecated version of ucry.
  </Function>

  ### ucz

  <Function id="qiskit.circuit.library.InnerProduct.ucz" name="ucz" signature="InnerProduct.ucz(angle_list, q_controls, q_target)">
    Deprecated version of ucrz.
  </Function>

  ### unitary

  <Function id="qiskit.circuit.library.InnerProduct.unitary" name="unitary" signature="InnerProduct.unitary(obj, qubits, label=None)">
    Apply unitary gate to q.
  </Function>

  ### width

  <Function id="qiskit.circuit.library.InnerProduct.width" name="width" signature="InnerProduct.width()">
  ...
  <Function id="qiskit.circuit.library.InnerProduct.x" name="x" signature="InnerProduct.x(qubit, *, label=None, ctrl_state=None, q=None)">
    Apply [`XGate`](qiskit.circuit.library.XGate "qiskit.circuit.library.XGate").
  </Function>

  ### y

  <Function id="qiskit.circuit.library.InnerProduct.y" name="y" signature="InnerProduct.y(qubit, *, q=None)">
    Apply [`YGate`](qiskit.circuit.library.YGate "qiskit.circuit.library.YGate").
  </Function>

  ### z

  <Function id="qiskit.circuit.library.InnerProduct.z" name="z" signature="InnerProduct.z(qubit, *, q=None)">
