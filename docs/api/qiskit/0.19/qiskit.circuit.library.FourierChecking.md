...
`FourierChecking(f, g)` [GitHub](https://github.com/qiskit/qiskit/tree/stable/0.14/qiskit/circuit/library/fourier_checking.py "view source code")
...
<span id="qiskit.circuit.library.FourierChecking.AND" />

`FourierChecking.AND(qr_variables, qb_target, qr_ancillae, flags=None, mct_mode='no-ancilla')`
...
<span id="qiskit.circuit.library.FourierChecking.OR" />

`FourierChecking.OR(qr_variables, qb_target, qr_ancillae, flags=None, mct_mode='basic')`
...
`FourierChecking.append(instruction, qargs=None, cargs=None)`
...
`FourierChecking.assign_parameters(param_dict, inplace=False)`
...
`FourierChecking.bind_parameters(value_dict)`
...
`FourierChecking.cbit_argument_conversion(clbit_representation)`
...
`FourierChecking.ccx(control_qubit1, control_qubit2, target_qubit, *, ctl1=None, ctl2=None, tgt=None)`
...
`FourierChecking.ch(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)`
...
`FourierChecking.cnot(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)`
...
`FourierChecking.compose(other, qubits=None, clbits=None, front=False, inplace=False)`
...
`FourierChecking.copy(name=None)`
...
`FourierChecking.crx(theta, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)`
...
`FourierChecking.cry(theta, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)`
...
`FourierChecking.crz(theta, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)`
...
`FourierChecking.cswap(control_qubit, target_qubit1, target_qubit2, *, label=None, ctrl_state=None, ctl=None, tgt1=None, tgt2=None)`
...
`FourierChecking.cu1(theta, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)`
...
`FourierChecking.cu3(theta, phi, lam, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)`
...
`FourierChecking.cx(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)`
...
`FourierChecking.cy(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)`
...
`FourierChecking.cz(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)`
...
`FourierChecking.diagonal(diag, qubit)`
...
`FourierChecking.draw(output=None, scale=0.7, filename=None, style=None, interactive=False, line_length=None, plot_barriers=True, reverse_bits=False, justify=None, vertical_compression='medium', idle_wires=True, with_layout=True, fold=None, ax=None, initial_state=False, cregbundle=False)`
...
`FourierChecking.fredkin(control_qubit, target_qubit1, target_qubit2, *, ctl=None, tgt1=None, tgt2=None)`
...
`static FourierChecking.from_qasm_file(path)`
...
`static FourierChecking.from_qasm_str(qasm_str)`
...
`FourierChecking.has_register(register)`
...
`FourierChecking.iso(isometry, q_input, q_ancillas_for_output, q_ancillas_zero=None, q_ancillas_dirty=None)`
...
`FourierChecking.isometry(isometry, q_input, q_ancillas_for_output, q_ancillas_zero=None, q_ancillas_dirty=None)`
...
`FourierChecking.iswap(qubit1, qubit2)`

Apply [`iSwapGate`](qiskit.circuit.library.iSwapGate "qiskit.circuit.library.iSwapGate").

### mcmt

<span id="qiskit.circuit.library.FourierChecking.mcmt" />

`FourierChecking.mcmt(gate, control_qubits, target_qubits, ancilla_qubits=None, mode='no-ancilla', *, single_control_gate_fun=None, q_controls=None, q_ancillae=None, q_targets=None)`
...
`FourierChecking.mcrx(theta, q_controls, q_target, use_basis_gates=False)`
...
`FourierChecking.mcry(theta, q_controls, q_target, q_ancillae, mode='basic', use_basis_gates=False)`
...
`FourierChecking.mcrz(lam, q_controls, q_target, use_basis_gates=False)`
...
`FourierChecking.mcx(control_qubits, target_qubit, ancilla_qubits=None, mode='noancilla')`
...
`FourierChecking.measure(qubit, cbit)`
...
`FourierChecking.measure_active(inplace=True)`
...
`FourierChecking.measure_all(inplace=True)`
...
<span id="qiskit.circuit.library.FourierChecking.mirror" />
...
`FourierChecking.num_connected_components(unitary_only=False)`
...
`FourierChecking.qasm(formatted=False, filename=None)`
...
`FourierChecking.qbit_argument_conversion(qubit_representation)`
...
`FourierChecking.rcccx(control_qubit1, control_qubit2, control_qubit3, target_qubit)`
...
`FourierChecking.rccx(control_qubit1, control_qubit2, target_qubit)`
...
`FourierChecking.remove_final_measurements(inplace=True)`
...
`FourierChecking.rx(theta, qubit, *, label=None, q=None)`
...
`FourierChecking.rxx(theta, qubit1, qubit2)`
...
`FourierChecking.ry(theta, qubit, *, label=None, q=None)`
...
`FourierChecking.ryy(theta, qubit1, qubit2)`
...
`FourierChecking.rz(phi, qubit, *, q=None)`
...
`FourierChecking.rzx(theta, qubit1, qubit2)`
...
`FourierChecking.rzz(theta, qubit1, qubit2)`
...
`FourierChecking.sdg(qubit, *, q=None)`
...
`FourierChecking.snapshot_density_matrix(label, qubits=None)`
...
`FourierChecking.snapshot_expectation_value(label, op, qubits, single_shot=False, variance=False)`
...
`FourierChecking.snapshot_probabilities(label, qubits, variance=False)`
...
`FourierChecking.snapshot_stabilizer(label)`
...
`FourierChecking.snapshot_statevector(label)`
...
`FourierChecking.squ(unitary_matrix, qubit, mode='ZYZ', up_to_diagonal=False, *, u=None)`
...
`FourierChecking.tdg(qubit, *, q=None)`
...
`FourierChecking.to_instruction(parameter_map=None)`
...
`FourierChecking.toffoli(control_qubit1, control_qubit2, target_qubit, *, ctl1=None, ctl2=None, tgt=None)`
...
`FourierChecking.u2(phi, lam, qubit, *, q=None)`
...
`FourierChecking.u3(theta, phi, lam, qubit, *, q=None)`
...
`FourierChecking.uc(gate_list, q_controls, q_target, up_to_diagonal=False)`
...
`FourierChecking.ucrx(angle_list, q_controls, q_target)`
...
`FourierChecking.ucry(angle_list, q_controls, q_target)`
...
`FourierChecking.ucrz(angle_list, q_controls, q_target)`
...
`FourierChecking.x(qubit, *, label=None, ctrl_state=None, q=None)`
