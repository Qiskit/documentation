---
title: calculate_1q_epc (v0.19)
description: API reference for qiskit.ignis.verification.calculate_1q_epc in qiskit v0.19
in_page_toc_min_heading_level: 1
python_api_type: function
python_api_name: qiskit.ignis.verification.calculate_1q_epc
---

<span id="calculate-1q-epc" />

# calculate\_1q\_epc

<Function id="qiskit.ignis.verification.calculate_1q_epc" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-ignis/tree/stable/0.3/qiskit/ignis/verification/randomized_benchmarking/rb_utils.py" signature="calculate_1q_epc(gate_per_cliff, epg_1q, qubit)">
