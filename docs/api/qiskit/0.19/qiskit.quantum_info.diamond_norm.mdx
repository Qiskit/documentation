---
title: diamond_norm (v0.19)
description: API reference for qiskit.quantum_info.diamond_norm in qiskit v0.19
in_page_toc_min_heading_level: 1
python_api_type: function
python_api_name: qiskit.quantum_info.diamond_norm
---

<span id="diamond-norm" />

# diamond\_norm

<Function id="qiskit.quantum_info.diamond_norm" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.14/qiskit/quantum_info/operators/measures.py" signature="diamond_norm(choi, **kwargs)">
