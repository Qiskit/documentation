...
|                                                                                                                               |                                  |
| ----------------------------------------------------------------------------------------------------------------------------- | -------------------------------- |
| [`QEomEE.aux_operators`](qiskit.chemistry.algorithms.QEomEE.aux_operators "qiskit.chemistry.algorithms.QEomEE.aux_operators") | Returns the auxiliary operators. |
| [`QEomEE.operator`](qiskit.chemistry.algorithms.QEomEE.operator "qiskit.chemistry.algorithms.QEomEE.operator")                | Return the operator.             |
| [`QEomEE.random`](qiskit.chemistry.algorithms.QEomEE.random "qiskit.chemistry.algorithms.QEomEE.random")                      | Return a numpy random.           |

## Methods

|                                                                                                                                                                            |                                                                              |
| -------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------- |
| [`QEomEE.compute_minimum_eigenvalue`](qiskit.chemistry.algorithms.QEomEE.compute_minimum_eigenvalue "qiskit.chemistry.algorithms.QEomEE.compute_minimum_eigenvalue")(\[…]) | Computes minimum eigenvalue.                                                 |
| [`QEomEE.run`](qiskit.chemistry.algorithms.QEomEE.run "qiskit.chemistry.algorithms.QEomEE.run")()                                                                          | Execute the classical algorithm.                                             |
| [`QEomEE.supports_aux_operators`](qiskit.chemistry.algorithms.QEomEE.supports_aux_operators "qiskit.chemistry.algorithms.QEomEE.supports_aux_operators")()                 | Whether computing the expectation value of auxiliary operators is supported. |
