...
<Function id="qiskit.visualization.iplot_state_hinton" github="https://github.com/qiskit/qiskit/tree/stable/0.14/qiskit/visualization/interactive/iplot_hinton.py" signature="iplot_state_hinton(rho, figsize=None)">
