...
<span id="qiskit.circuit.library.ZZFeatureMap.AND" />

`ZZFeatureMap.AND(qr_variables, qb_target, qr_ancillae, flags=None, mct_mode='no-ancilla')`
...
<span id="qiskit.circuit.library.ZZFeatureMap.OR" />

`ZZFeatureMap.OR(qr_variables, qb_target, qr_ancillae, flags=None, mct_mode='basic')`
...
`ZZFeatureMap.add_layer(other, entanglement=None, front=False)`
...
`ZZFeatureMap.append(instruction, qargs=None, cargs=None)`
...
`ZZFeatureMap.assign_parameters(param_dict, inplace=False)`
...
`ZZFeatureMap.bind_parameters(value_dict)`
...
`ZZFeatureMap.cbit_argument_conversion(clbit_representation)`
...
`ZZFeatureMap.ccx(control_qubit1, control_qubit2, target_qubit, *, ctl1=None, ctl2=None, tgt=None)`
...
`ZZFeatureMap.ch(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)`
...
`ZZFeatureMap.cnot(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)`
...
`ZZFeatureMap.crx(theta, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)`
...
`ZZFeatureMap.cry(theta, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)`
...
`ZZFeatureMap.crz(theta, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)`
...
`ZZFeatureMap.cswap(control_qubit, target_qubit1, target_qubit2, *, label=None, ctrl_state=None, ctl=None, tgt1=None, tgt2=None)`
...
`ZZFeatureMap.cu1(theta, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)`
...
`ZZFeatureMap.cu3(theta, phi, lam, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)`
...
`ZZFeatureMap.cx(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)`
...
`ZZFeatureMap.cy(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)`
...
`ZZFeatureMap.cz(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)`
...
`ZZFeatureMap.diagonal(diag, qubit)`
...
`ZZFeatureMap.draw(output=None, scale=0.7, filename=None, style=None, interactive=False, line_length=None, plot_barriers=True, reverse_bits=False, justify=None, vertical_compression='medium', idle_wires=True, with_layout=True, fold=None, ax=None, initial_state=False, cregbundle=False)`
...
`ZZFeatureMap.fredkin(control_qubit, target_qubit1, target_qubit2, *, ctl=None, tgt1=None, tgt2=None)`
...
`static ZZFeatureMap.from_qasm_file(path)`
...
`static ZZFeatureMap.from_qasm_str(qasm_str)`
...
`ZZFeatureMap.get_entangler_map(rep_num, block_num, num_block_qubits)`
...
`ZZFeatureMap.has_register(register)`
...
`ZZFeatureMap.iso(isometry, q_input, q_ancillas_for_output, q_ancillas_zero=None, q_ancillas_dirty=None)`
...
`ZZFeatureMap.isometry(isometry, q_input, q_ancillas_for_output, q_ancillas_zero=None, q_ancillas_dirty=None)`
...
`ZZFeatureMap.iswap(qubit1, qubit2)`
...
`ZZFeatureMap.mcmt(gate, control_qubits, target_qubits, ancilla_qubits=None, mode='no-ancilla', *, single_control_gate_fun=None, q_controls=None, q_ancillae=None, q_targets=None)`
...
`ZZFeatureMap.mcrx(theta, q_controls, q_target, use_basis_gates=False)`
...
`ZZFeatureMap.mcrz(lam, q_controls, q_target, use_basis_gates=False)`
...
`ZZFeatureMap.mcx(control_qubits, target_qubit, ancilla_qubits=None, mode='noancilla')`
...
`ZZFeatureMap.measure(qubit, cbit)`
...
`ZZFeatureMap.measure_active(inplace=True)`
...
`ZZFeatureMap.measure_all(inplace=True)`
...
`ZZFeatureMap.num_connected_components(unitary_only=False)`
...
`ZZFeatureMap.qasm(formatted=False, filename=None)`
...
`ZZFeatureMap.qbit_argument_conversion(qubit_representation)`
...
`ZZFeatureMap.rcccx(control_qubit1, control_qubit2, control_qubit3, target_qubit)`
...
`ZZFeatureMap.rccx(control_qubit1, control_qubit2, target_qubit)`
...
`ZZFeatureMap.remove_final_measurements(inplace=True)`
...
`ZZFeatureMap.rx(theta, qubit, *, label=None, q=None)`
...
`ZZFeatureMap.rxx(theta, qubit1, qubit2)`
...
`ZZFeatureMap.ry(theta, qubit, *, label=None, q=None)`
...
`ZZFeatureMap.ryy(theta, qubit1, qubit2)`
...
`ZZFeatureMap.rz(phi, qubit, *, q=None)`
...
`ZZFeatureMap.rzx(theta, qubit1, qubit2)`
...
`ZZFeatureMap.rzz(theta, qubit1, qubit2)`
...
`ZZFeatureMap.snapshot(label, snapshot_type='statevector', qubits=None, params=None)`
...
`ZZFeatureMap.snapshot_density_matrix(label, qubits=None)`
...
`ZZFeatureMap.snapshot_expectation_value(label, op, qubits, single_shot=False, variance=False)`
...
`ZZFeatureMap.snapshot_probabilities(label, qubits, variance=False)`
...
`ZZFeatureMap.snapshot_stabilizer(label)`
...
`ZZFeatureMap.snapshot_statevector(label)`
...
`ZZFeatureMap.squ(unitary_matrix, qubit, mode='ZYZ', up_to_diagonal=False, *, u=None)`
...
`ZZFeatureMap.swap(qubit1, qubit2)`
...
`ZZFeatureMap.to_gate(parameter_map=None)`
...
`ZZFeatureMap.toffoli(control_qubit1, control_qubit2, target_qubit, *, ctl1=None, ctl2=None, tgt=None)`
...
`ZZFeatureMap.u1(theta, qubit, *, q=None)`
...
`ZZFeatureMap.u2(phi, lam, qubit, *, q=None)`
...
`ZZFeatureMap.u3(theta, phi, lam, qubit, *, q=None)`
...
`ZZFeatureMap.uc(gate_list, q_controls, q_target, up_to_diagonal=False)`
...
`ZZFeatureMap.ucrx(angle_list, q_controls, q_target)`
...
`ZZFeatureMap.ucry(angle_list, q_controls, q_target)`
...
`ZZFeatureMap.ucrz(angle_list, q_controls, q_target)`
...
`ZZFeatureMap.x(qubit, *, label=None, ctrl_state=None, q=None)`
