...
<Class id="qiskit.ignis.characterization.RabiFitter" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-ignis/tree/stable/0.3/qiskit/ignis/characterization/calibrations/fitters.py" signature="RabiFitter(backend_result, xdata, qubits, fit_p0, fit_bounds=None)">
  ...
  <Attribute id="qiskit.ignis.characterization.RabiFitter.backend_result" signature="Union[qiskit.result.result.Result, List[qiskit.result.result.Result]]">
  ...
  <Attribute id="qiskit.ignis.characterization.RabiFitter.description" signature="str">
  ...
  <Attribute id="qiskit.ignis.characterization.RabiFitter.fit_fun" signature="Callable">
  ...
  <Attribute id="qiskit.ignis.characterization.RabiFitter.measured_qubits" signature="List[int]">
  ...
  <Attribute id="qiskit.ignis.characterization.RabiFitter.params" signature="List[float]">
  ...
  <Attribute id="qiskit.ignis.characterization.RabiFitter.params_err" signature="List[float]">
  ...
  <Attribute id="qiskit.ignis.characterization.RabiFitter.series" signature="Optional[List[str]]">
  ...
  <Attribute id="qiskit.ignis.characterization.RabiFitter.xdata" signature="Union[List[float], numpy.array]">
  ...
  <Attribute id="qiskit.ignis.characterization.RabiFitter.ydata" signature="List[Dict]">
