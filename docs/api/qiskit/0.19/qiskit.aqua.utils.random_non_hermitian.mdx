---
title: random_non_hermitian (v0.19)
description: API reference for qiskit.aqua.utils.random_non_hermitian in qiskit v0.19
in_page_toc_min_heading_level: 1
python_api_type: function
python_api_name: qiskit.aqua.utils.random_non_hermitian
---

<span id="random-non-hermitian" />

# random\_non\_hermitian

<Function id="qiskit.aqua.utils.random_non_hermitian" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.7/qiskit/aqua/utils/random_matrix_generator.py" signature="random_non_hermitian(N, M=None, sings=None, K=None, srange=None, sparsity=None, trunc=None)">
