---
title: expectation_counts (v0.19)
description: API reference for qiskit.ignis.verification.expectation_counts in qiskit v0.19
in_page_toc_min_heading_level: 1
python_api_type: function
python_api_name: qiskit.ignis.verification.expectation_counts
---

<span id="expectation-counts" />

# expectation\_counts

<Function id="qiskit.ignis.verification.expectation_counts" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-ignis/tree/stable/0.3/qiskit/ignis/verification/tomography/data.py" signature="expectation_counts(counts)">
