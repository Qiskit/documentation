---
title: iso
description: API reference for qiskit.circuit.library.XOR.iso
in_page_toc_min_heading_level: 1
python_api_type: method
python_api_name: qiskit.circuit.library.XOR.iso
---
...
`XOR.iso(isometry, q_input, q_ancillas_for_output, q_ancillas_zero=None, q_ancillas_dirty=None)`
