...
<Class id="qiskit.ignis.verification.DihedralUtils" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-ignis/tree/stable/0.3/qiskit/ignis/verification/randomized_benchmarking/dihedral_utils.py" signature="DihedralUtils(num_qubits=2, group_tables=None, elmnt=None, gatelist=None, elmnt_key=None)">
  ...
  *   **gatelist** (*list*) – a list of gates corresponding to a CNOTDihedral object.
  ...
  <Function id="qiskit.ignis.verification.DihedralUtils.cnot_dihedral_gates" name="cnot_dihedral_gates" signature="DihedralUtils.cnot_dihedral_gates(idx, G_table, G_keys)">
  ...
  <Function id="qiskit.ignis.verification.DihedralUtils.cnot_dihedral_tables" name="cnot_dihedral_tables" signature="DihedralUtils.cnot_dihedral_tables(num_qubits)">
  ...
  <Function id="qiskit.ignis.verification.DihedralUtils.compose_gates" name="compose_gates" signature="DihedralUtils.compose_gates(elem, next_elem)">
  ...
  <Function id="qiskit.ignis.verification.DihedralUtils.elem_to_gates" name="elem_to_gates" signature="DihedralUtils.elem_to_gates(circ)">
  ...
  <Function id="qiskit.ignis.verification.DihedralUtils.elmnt" name="elmnt" signature="DihedralUtils.elmnt()">
    Return a CNOTDihedral object.
  </Function>

  ### elmnt\_key

  <Function id="qiskit.ignis.verification.DihedralUtils.elmnt_key" name="elmnt_key" signature="DihedralUtils.elmnt_key()">
    Return a unique key of a CNOTDihedral object.
  </Function>

  ### find\_inverse\_gates

  <Function id="qiskit.ignis.verification.DihedralUtils.find_inverse_gates" name="find_inverse_gates" signature="DihedralUtils.find_inverse_gates(num_qubits, elem)">
  ...
  <Function id="qiskit.ignis.verification.DihedralUtils.find_key" name="find_key" signature="DihedralUtils.find_key(elem, num_qubits)">
  ...
  <Function id="qiskit.ignis.verification.DihedralUtils.gatelist" name="gatelist" signature="DihedralUtils.gatelist()">
    Return a list of gates corresponding to a CNOTDihedral object.
  </Function>

  ### group\_tables

  <Function id="qiskit.ignis.verification.DihedralUtils.group_tables" name="group_tables" signature="DihedralUtils.group_tables()">
    Return the CNOT-dihedral group tables.
  </Function>

  ### load\_dihedral\_table

  <Function id="qiskit.ignis.verification.DihedralUtils.load_dihedral_table" name="load_dihedral_table" signature="DihedralUtils.load_dihedral_table(picklefile='cnot_dihedral_2.pickle')">
  ...
  <Function id="qiskit.ignis.verification.DihedralUtils.load_tables" name="load_tables" signature="DihedralUtils.load_tables(num_qubits)">
    Return the CNOT dihedral group tables.
  ...
  <Function id="qiskit.ignis.verification.DihedralUtils.num_qubits" name="num_qubits" signature="DihedralUtils.num_qubits()">
    Return the number of qubits of the CNOTDihedral object.
  </Function>

  ### pickle\_dihedral\_table

  <Function id="qiskit.ignis.verification.DihedralUtils.pickle_dihedral_table" name="pickle_dihedral_table" signature="DihedralUtils.pickle_dihedral_table(num_qubits=2)">
  ...
  <Function id="qiskit.ignis.verification.DihedralUtils.random_gates" name="random_gates" signature="DihedralUtils.random_gates(num_qubits)">
