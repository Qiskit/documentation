---
title: DihedralUtils (v0.19)
description: API reference for qiskit.ignis.verification.DihedralUtils in qiskit v0.19
...
<Class id="qiskit.ignis.verification.DihedralUtils" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-ignis/tree/stable/0.3/qiskit/ignis/verification/randomized_benchmarking/dihedral_utils.py" signature="DihedralUtils(num_qubits=2, group_tables=None, elmnt=None, gatelist=None, elmnt_key=None)" modifiers="class">
  ...
  *   **gatelist** (*list*) – a list of gates corresponding to a CNOTDihedral object.
  ...
  <span id="dihedralutils-cnot-dihedral-gates" />
  ...
  <span id="dihedralutils-cnot-dihedral-tables" />
  ...
  <span id="dihedralutils-compose-gates" />
  ...
  <span id="dihedralutils-elem-to-gates" />
  ...
  <span id="dihedralutils-elmnt-key" />
  ...
  <span id="dihedralutils-find-inverse-gates" />
  ...
  <span id="dihedralutils-find-key" />
  ...
  <span id="dihedralutils-gatelist" />
  ...
  <span id="dihedralutils-group-tables" />
  ...
  <span id="dihedralutils-load-dihedral-table" />
  ...
  <span id="dihedralutils-load-tables" />
  ...
  <span id="dihedralutils-num-qubits" />
  ...
  <span id="dihedralutils-pickle-dihedral-table" />
  ...
  <span id="dihedralutils-random-gates" />
