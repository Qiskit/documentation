...
<Class id="qiskit.scheduler.methods.basic.CircuitPulseDef" signature="CircuitPulseDef(schedule, qubits)">
  Create new instance of CircuitPulseDef(schedule, qubits)

  ### count

  <Function id="qiskit.scheduler.methods.basic.CircuitPulseDef.count" name="count" signature="count(value, /)">
    Return number of occurrences of value.
  </Function>

  ### index

  <Function id="qiskit.scheduler.methods.basic.CircuitPulseDef.index" name="index" signature="index(value, start=0, stop=9223372036854775807, /)">
    Return first index of value.

    Raises ValueError if the value is not present.
  </Function>

  <Attribute id="qiskit.scheduler.methods.basic.CircuitPulseDef.qubits" name="qubits">
    Alias for field number 1
  </Attribute>

  <Attribute id="qiskit.scheduler.methods.basic.CircuitPulseDef.schedule" name="schedule">
...
<Function id="qiskit.scheduler.methods.basic.as_late_as_possible" name="as_late_as_possible" github="https://github.com/qiskit/qiskit/tree/stable/0.14/qiskit/scheduler/methods/basic.py" signature="as_late_as_possible(circuit, schedule_config)">
...
<Function id="qiskit.scheduler.methods.basic.as_soon_as_possible" name="as_soon_as_possible" github="https://github.com/qiskit/qiskit/tree/stable/0.14/qiskit/scheduler/methods/basic.py" signature="as_soon_as_possible(circuit, schedule_config)">
...
<Function id="qiskit.scheduler.methods.basic.translate_gates_to_pulse_defs" name="translate_gates_to_pulse_defs" github="https://github.com/qiskit/qiskit/tree/stable/0.14/qiskit/scheduler/methods/basic.py" signature="translate_gates_to_pulse_defs(circuit, schedule_config)">
