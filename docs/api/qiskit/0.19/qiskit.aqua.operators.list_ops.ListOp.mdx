---
title: ListOp (v0.19)
description: API reference for qiskit.aqua.operators.list_ops.ListOp in qiskit v0.19
...
<Class id="qiskit.aqua.operators.list_ops.ListOp" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.7/qiskit/aqua/operators/list_ops/list_op.py" signature="ListOp(oplist, combo_fn=<function ListOp.<lambda>>, coeff=1.0, abelian=False)" modifiers="class">
  ...
  *   **list.** (*and returns them in a*) –
  ...
  <span id="listop-abelian" />

  ### abelian

  <Attribute id="qiskit.aqua.operators.list_ops.ListOp.abelian" attributeTypeHint="bool">
  ...
  <span id="listop-coeff" />

  ### coeff

  <Attribute id="qiskit.aqua.operators.list_ops.ListOp.coeff" attributeTypeHint="Union[int, float, complex, qiskit.circuit.parameterexpression.ParameterExpression]">
  ...
  <span id="listop-combo-fn" />

  ### combo\_fn

  <Attribute id="qiskit.aqua.operators.list_ops.ListOp.combo_fn" attributeTypeHint="Callable">
  ...
  <span id="listop-distributive" />

  ### distributive

  <Attribute id="qiskit.aqua.operators.list_ops.ListOp.distributive" attributeTypeHint="bool">
  ...
  <span id="listop-num-qubits" />

  ### num\_qubits

  <Attribute id="qiskit.aqua.operators.list_ops.ListOp.num_qubits" attributeTypeHint="int">
  ...
  <span id="listop-oplist" />

  ### oplist

  <Attribute id="qiskit.aqua.operators.list_ops.ListOp.oplist" attributeTypeHint="List[qiskit.aqua.operators.operator_base.OperatorBase]">
  ...
  <span id="listop-getitem" />

  ### \_\_getitem\_\_

  <Function id="qiskit.aqua.operators.list_ops.ListOp.__getitem__" signature="ListOp.__getitem__(offset)">
  ...
  <Function id="qiskit.aqua.operators.list_ops.ListOp.__len__" signature="ListOp.__len__()">
    Length of `oplist`.
  ...
  <Function id="qiskit.aqua.operators.list_ops.ListOp.__mul__" signature="ListOp.__mul__(other)">
  ...
  <span id="listop-assign-parameters" />
  ...
  <span id="listop-bind-parameters" />
  ...
  <span id="listop-compose" />

  ### compose

  <Function id="qiskit.aqua.operators.list_ops.ListOp.compose" signature="ListOp.compose(other)">
  ...
  <span id="listop-primitive-strings" />
