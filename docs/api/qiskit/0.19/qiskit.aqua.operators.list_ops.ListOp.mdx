...
<Class id="qiskit.aqua.operators.list_ops.ListOp" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.7/qiskit/aqua/operators/list_ops/list_op.py" signature="ListOp(oplist, combo_fn=<function ListOp.<lambda>>, coeff=1.0, abelian=False)">
  ...
  *   **list.** (*and returns them in a*) –
  ...
  <Attribute id="qiskit.aqua.operators.list_ops.ListOp.abelian" name="abelian" signature="bool">
  ...
  <Attribute id="qiskit.aqua.operators.list_ops.ListOp.coeff" name="coeff" signature="Union[int, float, complex, qiskit.circuit.parameterexpression.ParameterExpression]">
  ...
  <Attribute id="qiskit.aqua.operators.list_ops.ListOp.combo_fn" name="combo_fn" signature="Callable">
  ...
  <Attribute id="qiskit.aqua.operators.list_ops.ListOp.distributive" name="distributive" signature="bool">
  ...
  <Attribute id="qiskit.aqua.operators.list_ops.ListOp.num_qubits" name="num_qubits" signature="int">
  ...
  <Attribute id="qiskit.aqua.operators.list_ops.ListOp.oplist" name="oplist" signature="List[qiskit.aqua.operators.operator_base.OperatorBase]">
  ...
  <Function id="qiskit.aqua.operators.list_ops.ListOp.__getitem__" name="__getitem__" signature="ListOp.__getitem__(offset)">
  ...
  <Function id="qiskit.aqua.operators.list_ops.ListOp.__len__" name="__len__" signature="ListOp.__len__()">
    Length of `oplist`.
  ...
  <Function id="qiskit.aqua.operators.list_ops.ListOp.__mul__" name="__mul__" signature="ListOp.__mul__(other)">
  ...
  <Function id="qiskit.aqua.operators.list_ops.ListOp.compose" name="compose" signature="ListOp.compose(other)">
