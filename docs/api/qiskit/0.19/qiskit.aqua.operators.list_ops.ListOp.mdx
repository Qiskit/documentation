...
<Class id="qiskit.aqua.operators.list_ops.ListOp" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.7/qiskit/aqua/operators/list_ops/list_op.py" signature="ListOp(oplist, combo_fn=<function ListOp.<lambda>>, coeff=1.0, abelian=False)">
  ...
  *   **list.** (*and returns them in a*) –
  ...
  <Attribute id="qiskit.aqua.operators.list_ops.ListOp.abelian" signature="bool">
  ...
  <Attribute id="qiskit.aqua.operators.list_ops.ListOp.coeff" signature="Union[int, float, complex, qiskit.circuit.parameterexpression.ParameterExpression]">
  ...
  <Attribute id="qiskit.aqua.operators.list_ops.ListOp.combo_fn" signature="Callable">
  ...
  <Attribute id="qiskit.aqua.operators.list_ops.ListOp.distributive" signature="bool">
  ...
  <Attribute id="qiskit.aqua.operators.list_ops.ListOp.num_qubits" signature="int">
  ...
  <Attribute id="qiskit.aqua.operators.list_ops.ListOp.oplist" signature="List[qiskit.aqua.operators.operator_base.OperatorBase]">
