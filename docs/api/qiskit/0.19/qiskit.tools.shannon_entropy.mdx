...
<Function id="qiskit.tools.shannon_entropy" github="https://github.com/qiskit/qiskit/tree/stable/0.14/qiskit/tools/qi/qi.py" signature="shannon_entropy(pvec, base=2)">
