...
$$
  ...
  *   **insert\_barriers** (`bool`) – If True, barriers are inserted in between the evolution instructions and hadamard layers.
  ...
  <Attribute id="qiskit.circuit.library.PauliFeatureMap.clbits" name="clbits">
    Returns a list of classical bits in the order that the registers were added.
  </Attribute>

  ### data

  <Attribute id="qiskit.circuit.library.PauliFeatureMap.data" name="data">
  ...
  <Attribute id="qiskit.circuit.library.PauliFeatureMap.entanglement" name="entanglement" signature="Union[str, List[str], List[List[str]], List[int], List[List[int]], List[List[List[int]]], List[List[List[List[int]]]], Callable[[int], str], Callable[[int], List[List[int]]]]">
  ...
  <Attribute id="qiskit.circuit.library.PauliFeatureMap.entanglement_blocks" name="entanglement_blocks">
  ...
  <Attribute id="qiskit.circuit.library.PauliFeatureMap.extension_lib" signature="= 'include \&#x22;qelib1.inc\&#x22;;'" />

  ### feature\_dimension

  <Attribute id="qiskit.circuit.library.PauliFeatureMap.feature_dimension" name="feature_dimension" signature="int">
  ...
  <Attribute id="qiskit.circuit.library.PauliFeatureMap.header" signature="= 'OPENQASM 2.0;'" />

  ### initial\_state

  <Attribute id="qiskit.circuit.library.PauliFeatureMap.initial_state" name="initial_state" signature="Any">
  ...
  <Attribute id="qiskit.circuit.library.PauliFeatureMap.insert_barriers" name="insert_barriers" signature="bool">
  ...
  <Attribute id="qiskit.circuit.library.PauliFeatureMap.instances" signature="= 8" />

  ### n\_qubits

  <Attribute id="qiskit.circuit.library.PauliFeatureMap.n_qubits" name="n_qubits">
    Deprecated, use `num_qubits` instead. Return number of qubits.
  </Attribute>

  ### num\_clbits

  <Attribute id="qiskit.circuit.library.PauliFeatureMap.num_clbits" name="num_clbits">
    Return number of classical bits.
  </Attribute>

  ### num\_layers

  <Attribute id="qiskit.circuit.library.PauliFeatureMap.num_layers" name="num_layers" signature="int">
  ...
  <Attribute id="qiskit.circuit.library.PauliFeatureMap.num_parameters" name="num_parameters">
    Convenience function to get the number of parameter objects in the circuit.
  </Attribute>

  ### num\_parameters\_settable

  <Attribute id="qiskit.circuit.library.PauliFeatureMap.num_parameters_settable" name="num_parameters_settable">
    The number of distinct parameters.
  </Attribute>

  ### num\_qubits

  <Attribute id="qiskit.circuit.library.PauliFeatureMap.num_qubits" name="num_qubits" signature="int">
  ...
  <Attribute id="qiskit.circuit.library.PauliFeatureMap.ordered_parameters" name="ordered_parameters" signature="List[qiskit.circuit.parameter.Parameter]">
  ...
  <Attribute id="qiskit.circuit.library.PauliFeatureMap.parameter_bounds" name="parameter_bounds" signature="Optional[List[Tuple[float, float]]]">
  ...
  <Attribute id="qiskit.circuit.library.PauliFeatureMap.parameters" name="parameters" signature="Set[qiskit.circuit.parameter.Parameter]">
  ...
  <Attribute id="qiskit.circuit.library.PauliFeatureMap.paulis" name="paulis" signature="List[str]">
  ...
  <Attribute id="qiskit.circuit.library.PauliFeatureMap.preferred_init_points" name="preferred_init_points" signature="Optional[List[float]]">
  ...
  <Attribute id="qiskit.circuit.library.PauliFeatureMap.prefix" signature="= 'circuit'" />

  ### qregs

  <Attribute id="qiskit.circuit.library.PauliFeatureMap.qregs" name="qregs">
    A list of the quantum registers associated with the circuit.
  </Attribute>

  ### qubits

  <Attribute id="qiskit.circuit.library.PauliFeatureMap.qubits" name="qubits">
    Returns a list of quantum bits in the order that the registers were added.
  </Attribute>

  ### reps

  <Attribute id="qiskit.circuit.library.PauliFeatureMap.reps" name="reps" signature="int">
  ...
  <Attribute id="qiskit.circuit.library.PauliFeatureMap.rotation_blocks" name="rotation_blocks" signature="List[qiskit.circuit.instruction.Instruction]">
  ...
  <Function id="qiskit.circuit.library.PauliFeatureMap.AND" name="AND" signature="PauliFeatureMap.AND(qr_variables, qb_target, qr_ancillae, flags=None, mct_mode='no-ancilla')">
  ...
  <Function id="qiskit.circuit.library.PauliFeatureMap.OR" name="OR" signature="PauliFeatureMap.OR(qr_variables, qb_target, qr_ancillae, flags=None, mct_mode='basic')">
  ...
  <Function id="qiskit.circuit.library.PauliFeatureMap.__getitem__" name="__getitem__" signature="PauliFeatureMap.__getitem__(item)">
    Return indexed operation.
  </Function>

  ### \_\_len\_\_

  <Function id="qiskit.circuit.library.PauliFeatureMap.__len__" name="__len__" signature="PauliFeatureMap.__len__()">
    Return number of operations in circuit.
  </Function>

  ### add\_layer

  <Function id="qiskit.circuit.library.PauliFeatureMap.add_layer" name="add_layer" signature="PauliFeatureMap.add_layer(other, entanglement=None, front=False)">
  ...
  <Function id="qiskit.circuit.library.PauliFeatureMap.add_register" name="add_register" signature="PauliFeatureMap.add_register(*regs)">
    Add registers.
  </Function>

  ### append

  <Function id="qiskit.circuit.library.PauliFeatureMap.append" name="append" signature="PauliFeatureMap.append(instruction, qargs=None, cargs=None)">
  ...
  <Function id="qiskit.circuit.library.PauliFeatureMap.assign_parameters" name="assign_parameters" signature="PauliFeatureMap.assign_parameters(param_dict, inplace=False)">
  ...
  <Function id="qiskit.circuit.library.PauliFeatureMap.barrier" name="barrier" signature="PauliFeatureMap.barrier(*qargs)">
    Apply `Barrier`. If qargs is None, applies to all.
  </Function>

  ### bind\_parameters

  <Function id="qiskit.circuit.library.PauliFeatureMap.bind_parameters" name="bind_parameters" signature="PauliFeatureMap.bind_parameters(value_dict)">
  ...
  <Function id="qiskit.circuit.library.PauliFeatureMap.cast" name="cast" signature="static PauliFeatureMap.cast(value, _type)">
    Best effort to cast value to type. Otherwise, returns the value.
  </Function>

  ### cbit\_argument\_conversion

  <Function id="qiskit.circuit.library.PauliFeatureMap.cbit_argument_conversion" name="cbit_argument_conversion" signature="PauliFeatureMap.cbit_argument_conversion(clbit_representation)">
  ...
  <Function id="qiskit.circuit.library.PauliFeatureMap.ccx" name="ccx" signature="PauliFeatureMap.ccx(control_qubit1, control_qubit2, target_qubit, *, ctl1=None, ctl2=None, tgt=None)">
    Apply [`CCXGate`](qiskit.circuit.library.CCXGate "qiskit.circuit.library.CCXGate").
  </Function>

  ### ch

  <Function id="qiskit.circuit.library.PauliFeatureMap.ch" name="ch" signature="PauliFeatureMap.ch(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CHGate`](qiskit.circuit.library.CHGate "qiskit.circuit.library.CHGate").
  </Function>

  ### cls\_instances

  <Function id="qiskit.circuit.library.PauliFeatureMap.cls_instances" name="cls_instances" signature="classmethod PauliFeatureMap.cls_instances()">
    Return the current number of instances of this class, useful for auto naming.
  </Function>

  ### cls\_prefix

  <Function id="qiskit.circuit.library.PauliFeatureMap.cls_prefix" name="cls_prefix" signature="classmethod PauliFeatureMap.cls_prefix()">
    Return the prefix to use for auto naming.
  </Function>

  ### cnot

  <Function id="qiskit.circuit.library.PauliFeatureMap.cnot" name="cnot" signature="PauliFeatureMap.cnot(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CXGate`](qiskit.circuit.library.CXGate "qiskit.circuit.library.CXGate").
  </Function>

  ### combine

  <Function id="qiskit.circuit.library.PauliFeatureMap.combine" name="combine" signature="PauliFeatureMap.combine(rhs)">
  ...
  <Function id="qiskit.circuit.library.PauliFeatureMap.compose" name="compose" signature="PauliFeatureMap.compose(other, qubits=None, clbits=None, front=False, inplace=False)">
  ...
  <Function id="qiskit.circuit.library.PauliFeatureMap.copy" name="copy" signature="PauliFeatureMap.copy(name=None)">
    Copy the circuit.
  ...
  <Function id="qiskit.circuit.library.PauliFeatureMap.count_ops" name="count_ops" signature="PauliFeatureMap.count_ops()">
  ...
  <Function id="qiskit.circuit.library.PauliFeatureMap.crx" name="crx" signature="PauliFeatureMap.crx(theta, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CRXGate`](qiskit.circuit.library.CRXGate "qiskit.circuit.library.CRXGate").
  </Function>

  ### cry

  <Function id="qiskit.circuit.library.PauliFeatureMap.cry" name="cry" signature="PauliFeatureMap.cry(theta, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CRYGate`](qiskit.circuit.library.CRYGate "qiskit.circuit.library.CRYGate").
  </Function>

  ### crz

  <Function id="qiskit.circuit.library.PauliFeatureMap.crz" name="crz" signature="PauliFeatureMap.crz(theta, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CRZGate`](qiskit.circuit.library.CRZGate "qiskit.circuit.library.CRZGate").
  </Function>

  ### cswap

  <Function id="qiskit.circuit.library.PauliFeatureMap.cswap" name="cswap" signature="PauliFeatureMap.cswap(control_qubit, target_qubit1, target_qubit2, *, label=None, ctrl_state=None, ctl=None, tgt1=None, tgt2=None)">
    Apply [`CSwapGate`](qiskit.circuit.library.CSwapGate "qiskit.circuit.library.CSwapGate").
  </Function>

  ### cu1

  <Function id="qiskit.circuit.library.PauliFeatureMap.cu1" name="cu1" signature="PauliFeatureMap.cu1(theta, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CU1Gate`](qiskit.circuit.library.CU1Gate "qiskit.circuit.library.CU1Gate").
  </Function>

  ### cu3

  <Function id="qiskit.circuit.library.PauliFeatureMap.cu3" name="cu3" signature="PauliFeatureMap.cu3(theta, phi, lam, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CU3Gate`](qiskit.circuit.library.CU3Gate "qiskit.circuit.library.CU3Gate").
  </Function>

  ### cx

  <Function id="qiskit.circuit.library.PauliFeatureMap.cx" name="cx" signature="PauliFeatureMap.cx(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CXGate`](qiskit.circuit.library.CXGate "qiskit.circuit.library.CXGate").
  </Function>

  ### cy

  <Function id="qiskit.circuit.library.PauliFeatureMap.cy" name="cy" signature="PauliFeatureMap.cy(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CYGate`](qiskit.circuit.library.CYGate "qiskit.circuit.library.CYGate").
  </Function>

  ### cz

  <Function id="qiskit.circuit.library.PauliFeatureMap.cz" name="cz" signature="PauliFeatureMap.cz(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CZGate`](qiskit.circuit.library.CZGate "qiskit.circuit.library.CZGate").
  </Function>

  ### dcx

  <Function id="qiskit.circuit.library.PauliFeatureMap.dcx" name="dcx" signature="PauliFeatureMap.dcx(qubit1, qubit2)">
    Apply [`DCXGate`](qiskit.circuit.library.DCXGate "qiskit.circuit.library.DCXGate").
  </Function>

  ### decompose

  <Function id="qiskit.circuit.library.PauliFeatureMap.decompose" name="decompose" signature="PauliFeatureMap.decompose()">
  ...
  <Function id="qiskit.circuit.library.PauliFeatureMap.depth" name="depth" signature="PauliFeatureMap.depth()">
  ...
  <Function id="qiskit.circuit.library.PauliFeatureMap.diag_gate" name="diag_gate" signature="PauliFeatureMap.diag_gate(diag, qubit)">
    Deprecated version of QuantumCircuit.diagonal.
  </Function>

  ### diagonal

  <Function id="qiskit.circuit.library.PauliFeatureMap.diagonal" name="diagonal" signature="PauliFeatureMap.diagonal(diag, qubit)">
  ...
  <Function id="qiskit.circuit.library.PauliFeatureMap.extend" name="extend" signature="PauliFeatureMap.extend(rhs)">
  ...
  <Function id="qiskit.circuit.library.PauliFeatureMap.fredkin" name="fredkin" signature="PauliFeatureMap.fredkin(control_qubit, target_qubit1, target_qubit2, *, ctl=None, tgt1=None, tgt2=None)">
    Apply [`CSwapGate`](qiskit.circuit.library.CSwapGate "qiskit.circuit.library.CSwapGate").
  </Function>

  ### from\_qasm\_file

  <Function id="qiskit.circuit.library.PauliFeatureMap.from_qasm_file" name="from_qasm_file" signature="static PauliFeatureMap.from_qasm_file(path)">
  ...
  <Function id="qiskit.circuit.library.PauliFeatureMap.from_qasm_str" name="from_qasm_str" signature="static PauliFeatureMap.from_qasm_str(qasm_str)">
  ...
  <Function id="qiskit.circuit.library.PauliFeatureMap.get_entangler_map" name="get_entangler_map" signature="PauliFeatureMap.get_entangler_map(rep_num, block_num, num_block_qubits)">
  ...
  <Function id="qiskit.circuit.library.PauliFeatureMap.get_unentangled_qubits" name="get_unentangled_qubits" signature="PauliFeatureMap.get_unentangled_qubits()">
  ...
  <Function id="qiskit.circuit.library.PauliFeatureMap.h" name="h" signature="PauliFeatureMap.h(qubit, *, q=None)">
    Apply [`HGate`](qiskit.circuit.library.HGate "qiskit.circuit.library.HGate").
  </Function>

  ### hamiltonian

  <Function id="qiskit.circuit.library.PauliFeatureMap.hamiltonian" name="hamiltonian" signature="PauliFeatureMap.hamiltonian(operator, time, qubits, label=None)">
    Apply hamiltonian evolution to to qubits.
  </Function>

  ### has\_register

  <Function id="qiskit.circuit.library.PauliFeatureMap.has_register" name="has_register" signature="PauliFeatureMap.has_register(register)">
  ...
  <Function id="qiskit.circuit.library.PauliFeatureMap.i" name="i" signature="PauliFeatureMap.i(qubit, *, q=None)">
    Apply [`IGate`](qiskit.circuit.library.IGate "qiskit.circuit.library.IGate").
  </Function>

  ### id

  <Function id="qiskit.circuit.library.PauliFeatureMap.id" name="id" signature="PauliFeatureMap.id(qubit, *, q=None)">
    Apply [`IGate`](qiskit.circuit.library.IGate "qiskit.circuit.library.IGate").
  </Function>

  ### iden

  <Function id="qiskit.circuit.library.PauliFeatureMap.iden" name="iden" signature="PauliFeatureMap.iden(qubit, *, q=None)">
    Deprecated identity gate.
  </Function>

  ### initialize

  <Function id="qiskit.circuit.library.PauliFeatureMap.initialize" name="initialize" signature="PauliFeatureMap.initialize(params, qubits)">
    Apply initialize to circuit.
  </Function>

  ### inverse

  <Function id="qiskit.circuit.library.PauliFeatureMap.inverse" name="inverse" signature="PauliFeatureMap.inverse()">
    Invert this circuit.
  ...
  <Function id="qiskit.circuit.library.PauliFeatureMap.iso" name="iso" signature="PauliFeatureMap.iso(isometry, q_input, q_ancillas_for_output, q_ancillas_zero=None, q_ancillas_dirty=None)">
  ...
  <Function id="qiskit.circuit.library.PauliFeatureMap.isometry" name="isometry" signature="PauliFeatureMap.isometry(isometry, q_input, q_ancillas_for_output, q_ancillas_zero=None, q_ancillas_dirty=None)">
    Attach an arbitrary isometry from m to n qubits to a circuit. In particular, this allows to attach arbitrary unitaries on n qubits (m=n) or to prepare any state on n qubits (m=0). The decomposition used here was introduced by Iten et al. in [https://arxiv.org/abs/1501.06911](https://arxiv.org/abs/1501.06911).
  ...
  <Function id="qiskit.circuit.library.PauliFeatureMap.iswap" name="iswap" signature="PauliFeatureMap.iswap(qubit1, qubit2)">
    Apply [`iSwapGate`](qiskit.circuit.library.iSwapGate "qiskit.circuit.library.iSwapGate").
  </Function>

  ### mcmt

  <Function id="qiskit.circuit.library.PauliFeatureMap.mcmt" name="mcmt" signature="PauliFeatureMap.mcmt(gate, control_qubits, target_qubits, ancilla_qubits=None, mode='no-ancilla', *, single_control_gate_fun=None, q_controls=None, q_ancillae=None, q_targets=None)">
  ...
  <Function id="qiskit.circuit.library.PauliFeatureMap.mcrx" name="mcrx" signature="PauliFeatureMap.mcrx(theta, q_controls, q_target, use_basis_gates=False)">
  ...
  <Function id="qiskit.circuit.library.PauliFeatureMap.mcry" name="mcry" signature="PauliFeatureMap.mcry(theta, q_controls, q_target, q_ancillae, mode='basic', use_basis_gates=False)">
  ...
  <Function id="qiskit.circuit.library.PauliFeatureMap.mcrz" name="mcrz" signature="PauliFeatureMap.mcrz(lam, q_controls, q_target, use_basis_gates=False)">
  ...
  <Function id="qiskit.circuit.library.PauliFeatureMap.mct" name="mct" signature="PauliFeatureMap.mct(control_qubits, target_qubit, ancilla_qubits=None, mode='noancilla')">
    Apply `MCXGate`.
  </Function>

  ### mcu1

  <Function id="qiskit.circuit.library.PauliFeatureMap.mcu1" name="mcu1" signature="PauliFeatureMap.mcu1(lam, control_qubits, target_qubit)">
    Apply `MCU1Gate`.
  </Function>

  ### mcx

  <Function id="qiskit.circuit.library.PauliFeatureMap.mcx" name="mcx" signature="PauliFeatureMap.mcx(control_qubits, target_qubit, ancilla_qubits=None, mode='noancilla')">
    Apply `MCXGate`.
  ...
  <Function id="qiskit.circuit.library.PauliFeatureMap.measure" name="measure" signature="PauliFeatureMap.measure(qubit, cbit)">
  ...
  <Function id="qiskit.circuit.library.PauliFeatureMap.measure_active" name="measure_active" signature="PauliFeatureMap.measure_active(inplace=True)">
  ...
  <Function id="qiskit.circuit.library.PauliFeatureMap.measure_all" name="measure_all" signature="PauliFeatureMap.measure_all(inplace=True)">
  ...
  <Function id="qiskit.circuit.library.PauliFeatureMap.mirror" name="mirror" signature="PauliFeatureMap.mirror()">
  ...
  <Function id="qiskit.circuit.library.PauliFeatureMap.ms" name="ms" signature="PauliFeatureMap.ms(theta, qubits)">
    Apply [`MSGate`](qiskit.circuit.library.MSGate "qiskit.circuit.library.MSGate").
  </Function>

  ### num\_connected\_components

  <Function id="qiskit.circuit.library.PauliFeatureMap.num_connected_components" name="num_connected_components" signature="PauliFeatureMap.num_connected_components(unitary_only=False)">
  ...
  <Function id="qiskit.circuit.library.PauliFeatureMap.num_nonlocal_gates" name="num_nonlocal_gates" signature="PauliFeatureMap.num_nonlocal_gates()">
  ...
  <Function id="qiskit.circuit.library.PauliFeatureMap.num_tensor_factors" name="num_tensor_factors" signature="PauliFeatureMap.num_tensor_factors()">
  ...
  <Function id="qiskit.circuit.library.PauliFeatureMap.num_unitary_factors" name="num_unitary_factors" signature="PauliFeatureMap.num_unitary_factors()">
    Computes the number of tensor factors in the unitary (quantum) part of the circuit only.
  </Function>

  ### pauli\_block

  <Function id="qiskit.circuit.library.PauliFeatureMap.pauli_block" name="pauli_block" signature="PauliFeatureMap.pauli_block(pauli_string)">
    Get the Pauli block for the feature map circuit.
  </Function>

  ### pauli\_evolution

  <Function id="qiskit.circuit.library.PauliFeatureMap.pauli_evolution" name="pauli_evolution" signature="PauliFeatureMap.pauli_evolution(pauli_string, time)">
    Get the evolution block for the given pauli string.
  </Function>

  ### print\_settings

  <Function id="qiskit.circuit.library.PauliFeatureMap.print_settings" name="print_settings" signature="PauliFeatureMap.print_settings()">
  ...
  <Function id="qiskit.circuit.library.PauliFeatureMap.qasm" name="qasm" signature="PauliFeatureMap.qasm(formatted=False, filename=None)">
  ...
  <Function id="qiskit.circuit.library.PauliFeatureMap.qbit_argument_conversion" name="qbit_argument_conversion" signature="PauliFeatureMap.qbit_argument_conversion(qubit_representation)">
  ...
  <Function id="qiskit.circuit.library.PauliFeatureMap.r" name="r" signature="PauliFeatureMap.r(theta, phi, qubit, *, q=None)">
    Apply `RGate`.
  </Function>

  ### rcccx

  <Function id="qiskit.circuit.library.PauliFeatureMap.rcccx" name="rcccx" signature="PauliFeatureMap.rcccx(control_qubit1, control_qubit2, control_qubit3, target_qubit)">
    Apply [`RC3XGate`](qiskit.circuit.library.RC3XGate "qiskit.circuit.library.RC3XGate").
  </Function>

  ### rccx

  <Function id="qiskit.circuit.library.PauliFeatureMap.rccx" name="rccx" signature="PauliFeatureMap.rccx(control_qubit1, control_qubit2, target_qubit)">
    Apply [`RCCXGate`](qiskit.circuit.library.RCCXGate "qiskit.circuit.library.RCCXGate").
  </Function>

  ### remove\_final\_measurements

  <Function id="qiskit.circuit.library.PauliFeatureMap.remove_final_measurements" name="remove_final_measurements" signature="PauliFeatureMap.remove_final_measurements(inplace=True)">
  ...
  <Function id="qiskit.circuit.library.PauliFeatureMap.reset" name="reset" signature="PauliFeatureMap.reset(qubit)">
    Reset q.
  </Function>

  ### rx

  <Function id="qiskit.circuit.library.PauliFeatureMap.rx" name="rx" signature="PauliFeatureMap.rx(theta, qubit, *, label=None, q=None)">
    Apply [`RXGate`](qiskit.circuit.library.RXGate "qiskit.circuit.library.RXGate").
  </Function>

  ### rxx

  <Function id="qiskit.circuit.library.PauliFeatureMap.rxx" name="rxx" signature="PauliFeatureMap.rxx(theta, qubit1, qubit2)">
    Apply [`RXXGate`](qiskit.circuit.library.RXXGate "qiskit.circuit.library.RXXGate").
  </Function>

  ### ry

  <Function id="qiskit.circuit.library.PauliFeatureMap.ry" name="ry" signature="PauliFeatureMap.ry(theta, qubit, *, label=None, q=None)">
    Apply [`RYGate`](qiskit.circuit.library.RYGate "qiskit.circuit.library.RYGate").
  </Function>

  ### ryy

  <Function id="qiskit.circuit.library.PauliFeatureMap.ryy" name="ryy" signature="PauliFeatureMap.ryy(theta, qubit1, qubit2)">
    Apply [`RYYGate`](qiskit.circuit.library.RYYGate "qiskit.circuit.library.RYYGate").
  </Function>

  ### rz

  <Function id="qiskit.circuit.library.PauliFeatureMap.rz" name="rz" signature="PauliFeatureMap.rz(phi, qubit, *, q=None)">
    Apply [`RZGate`](qiskit.circuit.library.RZGate "qiskit.circuit.library.RZGate").
  </Function>

  ### rzx

  <Function id="qiskit.circuit.library.PauliFeatureMap.rzx" name="rzx" signature="PauliFeatureMap.rzx(theta, qubit1, qubit2)">
    Apply [`RZXGate`](qiskit.circuit.library.RZXGate "qiskit.circuit.library.RZXGate").
  </Function>

  ### rzz

  <Function id="qiskit.circuit.library.PauliFeatureMap.rzz" name="rzz" signature="PauliFeatureMap.rzz(theta, qubit1, qubit2)">
    Apply [`RZZGate`](qiskit.circuit.library.RZZGate "qiskit.circuit.library.RZZGate").
  </Function>

  ### s

  <Function id="qiskit.circuit.library.PauliFeatureMap.s" name="s" signature="PauliFeatureMap.s(qubit, *, q=None)">
    Apply [`SGate`](qiskit.circuit.library.SGate "qiskit.circuit.library.SGate").
  </Function>

  ### sdg

  <Function id="qiskit.circuit.library.PauliFeatureMap.sdg" name="sdg" signature="PauliFeatureMap.sdg(qubit, *, q=None)">
    Apply [`SdgGate`](qiskit.circuit.library.SdgGate "qiskit.circuit.library.SdgGate").
  </Function>

  ### size

  <Function id="qiskit.circuit.library.PauliFeatureMap.size" name="size" signature="PauliFeatureMap.size()">
  ...
  <Function id="qiskit.circuit.library.PauliFeatureMap.snapshot" name="snapshot" signature="PauliFeatureMap.snapshot(label, snapshot_type='statevector', qubits=None, params=None)">
  ...
  <Function id="qiskit.circuit.library.PauliFeatureMap.snapshot_density_matrix" name="snapshot_density_matrix" signature="PauliFeatureMap.snapshot_density_matrix(label, qubits=None)">
  ...
  <Function id="qiskit.circuit.library.PauliFeatureMap.snapshot_expectation_value" name="snapshot_expectation_value" signature="PauliFeatureMap.snapshot_expectation_value(label, op, qubits, single_shot=False, variance=False)">
  ...
  <Function id="qiskit.circuit.library.PauliFeatureMap.snapshot_probabilities" name="snapshot_probabilities" signature="PauliFeatureMap.snapshot_probabilities(label, qubits, variance=False)">
  ...
  <Function id="qiskit.circuit.library.PauliFeatureMap.snapshot_stabilizer" name="snapshot_stabilizer" signature="PauliFeatureMap.snapshot_stabilizer(label)">
  ...
  <Function id="qiskit.circuit.library.PauliFeatureMap.snapshot_statevector" name="snapshot_statevector" signature="PauliFeatureMap.snapshot_statevector(label)">
  ...
  <Function id="qiskit.circuit.library.PauliFeatureMap.squ" name="squ" signature="PauliFeatureMap.squ(unitary_matrix, qubit, mode='ZYZ', up_to_diagonal=False, *, u=None)">
  ...
  <Function id="qiskit.circuit.library.PauliFeatureMap.swap" name="swap" signature="PauliFeatureMap.swap(qubit1, qubit2)">
    Apply [`SwapGate`](qiskit.circuit.library.SwapGate "qiskit.circuit.library.SwapGate").
  </Function>

  ### t

  <Function id="qiskit.circuit.library.PauliFeatureMap.t" name="t" signature="PauliFeatureMap.t(qubit, *, q=None)">
    Apply [`TGate`](qiskit.circuit.library.TGate "qiskit.circuit.library.TGate").
  </Function>

  ### tdg

  <Function id="qiskit.circuit.library.PauliFeatureMap.tdg" name="tdg" signature="PauliFeatureMap.tdg(qubit, *, q=None)">
    Apply [`TdgGate`](qiskit.circuit.library.TdgGate "qiskit.circuit.library.TdgGate").
  </Function>

  ### to\_gate

  <Function id="qiskit.circuit.library.PauliFeatureMap.to_gate" name="to_gate" signature="PauliFeatureMap.to_gate(parameter_map=None)">
  ...
  <Function id="qiskit.circuit.library.PauliFeatureMap.to_instruction" name="to_instruction" signature="PauliFeatureMap.to_instruction(parameter_map=None)">
  ...
  <Function id="qiskit.circuit.library.PauliFeatureMap.toffoli" name="toffoli" signature="PauliFeatureMap.toffoli(control_qubit1, control_qubit2, target_qubit, *, ctl1=None, ctl2=None, tgt=None)">
    Apply [`CCXGate`](qiskit.circuit.library.CCXGate "qiskit.circuit.library.CCXGate").
  </Function>

  ### u1

  <Function id="qiskit.circuit.library.PauliFeatureMap.u1" name="u1" signature="PauliFeatureMap.u1(theta, qubit, *, q=None)">
    Apply [`U1Gate`](qiskit.circuit.library.U1Gate "qiskit.circuit.library.U1Gate").
  </Function>

  ### u2

  <Function id="qiskit.circuit.library.PauliFeatureMap.u2" name="u2" signature="PauliFeatureMap.u2(phi, lam, qubit, *, q=None)">
    Apply [`U2Gate`](qiskit.circuit.library.U2Gate "qiskit.circuit.library.U2Gate").
  </Function>

  ### u3

  <Function id="qiskit.circuit.library.PauliFeatureMap.u3" name="u3" signature="PauliFeatureMap.u3(theta, phi, lam, qubit, *, q=None)">
    Apply [`U3Gate`](qiskit.circuit.library.U3Gate "qiskit.circuit.library.U3Gate").
  </Function>

  ### uc

  <Function id="qiskit.circuit.library.PauliFeatureMap.uc" name="uc" signature="PauliFeatureMap.uc(gate_list, q_controls, q_target, up_to_diagonal=False)">
  ...
  <Function id="qiskit.circuit.library.PauliFeatureMap.ucg" name="ucg" signature="PauliFeatureMap.ucg(angle_list, q_controls, q_target, up_to_diagonal=False)">
    Deprecated version of uc.
  </Function>

  ### ucrx

  <Function id="qiskit.circuit.library.PauliFeatureMap.ucrx" name="ucrx" signature="PauliFeatureMap.ucrx(angle_list, q_controls, q_target)">
  ...
  <Function id="qiskit.circuit.library.PauliFeatureMap.ucry" name="ucry" signature="PauliFeatureMap.ucry(angle_list, q_controls, q_target)">
  ...
  <Function id="qiskit.circuit.library.PauliFeatureMap.ucrz" name="ucrz" signature="PauliFeatureMap.ucrz(angle_list, q_controls, q_target)">
  ...
  <Function id="qiskit.circuit.library.PauliFeatureMap.ucx" name="ucx" signature="PauliFeatureMap.ucx(angle_list, q_controls, q_target)">
    Deprecated version of ucrx.
  </Function>

  ### ucy

  <Function id="qiskit.circuit.library.PauliFeatureMap.ucy" name="ucy" signature="PauliFeatureMap.ucy(angle_list, q_controls, q_target)">
    Deprecated version of ucry.
  </Function>

  ### ucz

  <Function id="qiskit.circuit.library.PauliFeatureMap.ucz" name="ucz" signature="PauliFeatureMap.ucz(angle_list, q_controls, q_target)">
    Deprecated version of ucrz.
  </Function>

  ### unitary

  <Function id="qiskit.circuit.library.PauliFeatureMap.unitary" name="unitary" signature="PauliFeatureMap.unitary(obj, qubits, label=None)">
    Apply unitary gate to q.
  </Function>

  ### width

  <Function id="qiskit.circuit.library.PauliFeatureMap.width" name="width" signature="PauliFeatureMap.width()">
  ...
  <Function id="qiskit.circuit.library.PauliFeatureMap.x" name="x" signature="PauliFeatureMap.x(qubit, *, label=None, ctrl_state=None, q=None)">
    Apply [`XGate`](qiskit.circuit.library.XGate "qiskit.circuit.library.XGate").
  </Function>

  ### y

  <Function id="qiskit.circuit.library.PauliFeatureMap.y" name="y" signature="PauliFeatureMap.y(qubit, *, q=None)">
    Apply [`YGate`](qiskit.circuit.library.YGate "qiskit.circuit.library.YGate").
  </Function>

  ### z

  <Function id="qiskit.circuit.library.PauliFeatureMap.z" name="z" signature="PauliFeatureMap.z(qubit, *, q=None)">
