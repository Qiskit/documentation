---
title: MinimumEigensolver (v0.19)
description: API reference for qiskit.aqua.algorithms.MinimumEigensolver in qiskit v0.19
...
<Class id="qiskit.aqua.algorithms.MinimumEigensolver" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.7/qiskit/aqua/algorithms/minimum_eigen_solvers/minimum_eigen_solver.py" signature="MinimumEigensolver" modifiers="class">
  ...
  <span id="minimumeigensolver-aux-operators" />
  ...
  <span id="minimumeigensolver-operator" />
  ...
  <span id="minimumeigensolver-compute-minimum-eigenvalue" />
  ...
  <span id="minimumeigensolver-supports-aux-operators" />
