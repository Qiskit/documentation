---
title: PulseLibraryItem (v0.19)
description: API reference for qiskit.qobj.PulseLibraryItem in qiskit v0.19
...
<Class id="qiskit.qobj.PulseLibraryItem" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.14/qiskit/qobj/pulse_qobj.py" signature="PulseLibraryItem(name, samples)" modifiers="class">
  ...
  *   **samples** (*list\[complex]*) – A list of complex values defining pulse shape.
  ...
  <span id="pulselibraryitem-from-dict" />
  ...
  <span id="pulselibraryitem-to-dict" />
