...
<Function id="qiskit.visualization.iplot_state_qsphere" github="https://github.com/qiskit/qiskit/tree/stable/0.14/qiskit/visualization/interactive/iplot_qsphere.py" signature="iplot_state_qsphere(rho, figsize=None)">
