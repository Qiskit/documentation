...
<Class id="qiskit.circuit.library.FunctionalPauliRotations" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.14/qiskit/circuit/library/arithmetic/functional_pauli_rotations.py" signature="FunctionalPauliRotations(num_state_qubits=None, basis='Y', name='F')">
  ...
  *   **name** (`str`) – The name of the circuit object.
  ...
  <Attribute id="qiskit.circuit.library.FunctionalPauliRotations.basis" name="basis" signature="str">
  ...
  <Attribute id="qiskit.circuit.library.FunctionalPauliRotations.extension_lib" signature="= 'include \&#x22;qelib1.inc\&#x22;;'" />

  ### header

  <Attribute id="qiskit.circuit.library.FunctionalPauliRotations.header" signature="= 'OPENQASM 2.0;'" />

  ### instances

  <Attribute id="qiskit.circuit.library.FunctionalPauliRotations.instances" signature="= 8" />

  ### n\_qubits

  <Attribute id="qiskit.circuit.library.FunctionalPauliRotations.n_qubits" name="n_qubits">
    Deprecated, use `num_qubits` instead. Return number of qubits.
  </Attribute>

  ### num\_ancilla\_qubits

  <Attribute id="qiskit.circuit.library.FunctionalPauliRotations.num_ancilla_qubits" name="num_ancilla_qubits" signature="int">
  ...
  <Attribute id="qiskit.circuit.library.FunctionalPauliRotations.num_state_qubits" name="num_state_qubits" signature="int">
  ...
  <Attribute id="qiskit.circuit.library.FunctionalPauliRotations.prefix" signature="= 'circuit'" />
  ...
  <Function id="qiskit.circuit.library.FunctionalPauliRotations.AND" name="AND" signature="FunctionalPauliRotations.AND(qr_variables, qb_target, qr_ancillae, flags=None, mct_mode='no-ancilla')">
  ...
  <Function id="qiskit.circuit.library.FunctionalPauliRotations.OR" name="OR" signature="FunctionalPauliRotations.OR(qr_variables, qb_target, qr_ancillae, flags=None, mct_mode='basic')">
  ...
  <Function id="qiskit.circuit.library.FunctionalPauliRotations.__getitem__" name="__getitem__" signature="FunctionalPauliRotations.__getitem__(item)">
    Return indexed operation.
  </Function>

  ### \_\_len\_\_

  <Function id="qiskit.circuit.library.FunctionalPauliRotations.__len__" name="__len__" signature="FunctionalPauliRotations.__len__()">
    Return number of operations in circuit.
  </Function>

  ### add\_register

  <Function id="qiskit.circuit.library.FunctionalPauliRotations.add_register" name="add_register" signature="FunctionalPauliRotations.add_register(*regs)">
    Add registers.
  </Function>

  ### append

  <Function id="qiskit.circuit.library.FunctionalPauliRotations.append" name="append" signature="FunctionalPauliRotations.append(instruction, qargs=None, cargs=None)">
  ...
  <Function id="qiskit.circuit.library.FunctionalPauliRotations.assign_parameters" name="assign_parameters" signature="FunctionalPauliRotations.assign_parameters(param_dict, inplace=False)">
  ...
  <Function id="qiskit.circuit.library.FunctionalPauliRotations.barrier" name="barrier" signature="FunctionalPauliRotations.barrier(*qargs)">
    Apply `Barrier`. If qargs is None, applies to all.
  </Function>

  ### bind\_parameters

  <Function id="qiskit.circuit.library.FunctionalPauliRotations.bind_parameters" name="bind_parameters" signature="FunctionalPauliRotations.bind_parameters(value_dict)">
  ...
  <Function id="qiskit.circuit.library.FunctionalPauliRotations.cast" name="cast" signature="static FunctionalPauliRotations.cast(value, _type)">
    Best effort to cast value to type. Otherwise, returns the value.
  </Function>

  ### cbit\_argument\_conversion

  <Function id="qiskit.circuit.library.FunctionalPauliRotations.cbit_argument_conversion" name="cbit_argument_conversion" signature="FunctionalPauliRotations.cbit_argument_conversion(clbit_representation)">
  ...
  <Function id="qiskit.circuit.library.FunctionalPauliRotations.ccx" name="ccx" signature="FunctionalPauliRotations.ccx(control_qubit1, control_qubit2, target_qubit, *, ctl1=None, ctl2=None, tgt=None)">
    Apply [`CCXGate`](qiskit.circuit.library.CCXGate "qiskit.circuit.library.CCXGate").
  </Function>

  ### ch

  <Function id="qiskit.circuit.library.FunctionalPauliRotations.ch" name="ch" signature="FunctionalPauliRotations.ch(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CHGate`](qiskit.circuit.library.CHGate "qiskit.circuit.library.CHGate").
  </Function>

  ### cls\_instances

  <Function id="qiskit.circuit.library.FunctionalPauliRotations.cls_instances" name="cls_instances" signature="classmethod FunctionalPauliRotations.cls_instances()">
    Return the current number of instances of this class, useful for auto naming.
  </Function>

  ### cls\_prefix

  <Function id="qiskit.circuit.library.FunctionalPauliRotations.cls_prefix" name="cls_prefix" signature="classmethod FunctionalPauliRotations.cls_prefix()">
    Return the prefix to use for auto naming.
  </Function>

  ### cnot

  <Function id="qiskit.circuit.library.FunctionalPauliRotations.cnot" name="cnot" signature="FunctionalPauliRotations.cnot(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CXGate`](qiskit.circuit.library.CXGate "qiskit.circuit.library.CXGate").
  </Function>

  ### combine

  <Function id="qiskit.circuit.library.FunctionalPauliRotations.combine" name="combine" signature="FunctionalPauliRotations.combine(rhs)">
  ...
  <Function id="qiskit.circuit.library.FunctionalPauliRotations.compose" name="compose" signature="FunctionalPauliRotations.compose(other, qubits=None, clbits=None, front=False, inplace=False)">
  ...
  <Function id="qiskit.circuit.library.FunctionalPauliRotations.copy" name="copy" signature="FunctionalPauliRotations.copy(name=None)">
    Copy the circuit.
  ...
  <Function id="qiskit.circuit.library.FunctionalPauliRotations.count_ops" name="count_ops" signature="FunctionalPauliRotations.count_ops()">
  ...
  <Function id="qiskit.circuit.library.FunctionalPauliRotations.crx" name="crx" signature="FunctionalPauliRotations.crx(theta, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CRXGate`](qiskit.circuit.library.CRXGate "qiskit.circuit.library.CRXGate").
  </Function>

  ### cry

  <Function id="qiskit.circuit.library.FunctionalPauliRotations.cry" name="cry" signature="FunctionalPauliRotations.cry(theta, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CRYGate`](qiskit.circuit.library.CRYGate "qiskit.circuit.library.CRYGate").
  </Function>

  ### crz

  <Function id="qiskit.circuit.library.FunctionalPauliRotations.crz" name="crz" signature="FunctionalPauliRotations.crz(theta, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CRZGate`](qiskit.circuit.library.CRZGate "qiskit.circuit.library.CRZGate").
  </Function>

  ### cswap

  <Function id="qiskit.circuit.library.FunctionalPauliRotations.cswap" name="cswap" signature="FunctionalPauliRotations.cswap(control_qubit, target_qubit1, target_qubit2, *, label=None, ctrl_state=None, ctl=None, tgt1=None, tgt2=None)">
    Apply [`CSwapGate`](qiskit.circuit.library.CSwapGate "qiskit.circuit.library.CSwapGate").
  </Function>

  ### cu1

  <Function id="qiskit.circuit.library.FunctionalPauliRotations.cu1" name="cu1" signature="FunctionalPauliRotations.cu1(theta, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CU1Gate`](qiskit.circuit.library.CU1Gate "qiskit.circuit.library.CU1Gate").
  </Function>

  ### cu3

  <Function id="qiskit.circuit.library.FunctionalPauliRotations.cu3" name="cu3" signature="FunctionalPauliRotations.cu3(theta, phi, lam, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CU3Gate`](qiskit.circuit.library.CU3Gate "qiskit.circuit.library.CU3Gate").
  </Function>

  ### cx

  <Function id="qiskit.circuit.library.FunctionalPauliRotations.cx" name="cx" signature="FunctionalPauliRotations.cx(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CXGate`](qiskit.circuit.library.CXGate "qiskit.circuit.library.CXGate").
  </Function>

  ### cy

  <Function id="qiskit.circuit.library.FunctionalPauliRotations.cy" name="cy" signature="FunctionalPauliRotations.cy(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CYGate`](qiskit.circuit.library.CYGate "qiskit.circuit.library.CYGate").
  </Function>

  ### cz

  <Function id="qiskit.circuit.library.FunctionalPauliRotations.cz" name="cz" signature="FunctionalPauliRotations.cz(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CZGate`](qiskit.circuit.library.CZGate "qiskit.circuit.library.CZGate").
  </Function>

  ### dcx

  <Function id="qiskit.circuit.library.FunctionalPauliRotations.dcx" name="dcx" signature="FunctionalPauliRotations.dcx(qubit1, qubit2)">
    Apply [`DCXGate`](qiskit.circuit.library.DCXGate "qiskit.circuit.library.DCXGate").
  </Function>

  ### decompose

  <Function id="qiskit.circuit.library.FunctionalPauliRotations.decompose" name="decompose" signature="FunctionalPauliRotations.decompose()">
  ...
  <Function id="qiskit.circuit.library.FunctionalPauliRotations.depth" name="depth" signature="FunctionalPauliRotations.depth()">
  ...
  <Function id="qiskit.circuit.library.FunctionalPauliRotations.diag_gate" name="diag_gate" signature="FunctionalPauliRotations.diag_gate(diag, qubit)">
    Deprecated version of QuantumCircuit.diagonal.
  </Function>

  ### diagonal

  <Function id="qiskit.circuit.library.FunctionalPauliRotations.diagonal" name="diagonal" signature="FunctionalPauliRotations.diagonal(diag, qubit)">
  ...
  <Function id="qiskit.circuit.library.FunctionalPauliRotations.extend" name="extend" signature="FunctionalPauliRotations.extend(rhs)">
  ...
  <Function id="qiskit.circuit.library.FunctionalPauliRotations.fredkin" name="fredkin" signature="FunctionalPauliRotations.fredkin(control_qubit, target_qubit1, target_qubit2, *, ctl=None, tgt1=None, tgt2=None)">
    Apply [`CSwapGate`](qiskit.circuit.library.CSwapGate "qiskit.circuit.library.CSwapGate").
  </Function>

  ### from\_qasm\_file

  <Function id="qiskit.circuit.library.FunctionalPauliRotations.from_qasm_file" name="from_qasm_file" signature="static FunctionalPauliRotations.from_qasm_file(path)">
  ...
  <Function id="qiskit.circuit.library.FunctionalPauliRotations.from_qasm_str" name="from_qasm_str" signature="static FunctionalPauliRotations.from_qasm_str(qasm_str)">
  ...
  <Function id="qiskit.circuit.library.FunctionalPauliRotations.h" name="h" signature="FunctionalPauliRotations.h(qubit, *, q=None)">
    Apply [`HGate`](qiskit.circuit.library.HGate "qiskit.circuit.library.HGate").
  </Function>

  ### hamiltonian

  <Function id="qiskit.circuit.library.FunctionalPauliRotations.hamiltonian" name="hamiltonian" signature="FunctionalPauliRotations.hamiltonian(operator, time, qubits, label=None)">
    Apply hamiltonian evolution to to qubits.
  </Function>

  ### has\_register

  <Function id="qiskit.circuit.library.FunctionalPauliRotations.has_register" name="has_register" signature="FunctionalPauliRotations.has_register(register)">
  ...
  <Function id="qiskit.circuit.library.FunctionalPauliRotations.i" name="i" signature="FunctionalPauliRotations.i(qubit, *, q=None)">
    Apply [`IGate`](qiskit.circuit.library.IGate "qiskit.circuit.library.IGate").
  </Function>

  ### id

  <Function id="qiskit.circuit.library.FunctionalPauliRotations.id" name="id" signature="FunctionalPauliRotations.id(qubit, *, q=None)">
    Apply [`IGate`](qiskit.circuit.library.IGate "qiskit.circuit.library.IGate").
  </Function>

  ### iden

  <Function id="qiskit.circuit.library.FunctionalPauliRotations.iden" name="iden" signature="FunctionalPauliRotations.iden(qubit, *, q=None)">
    Deprecated identity gate.
  </Function>

  ### initialize

  <Function id="qiskit.circuit.library.FunctionalPauliRotations.initialize" name="initialize" signature="FunctionalPauliRotations.initialize(params, qubits)">
    Apply initialize to circuit.
  </Function>

  ### inverse

  <Function id="qiskit.circuit.library.FunctionalPauliRotations.inverse" name="inverse" signature="FunctionalPauliRotations.inverse()">
    Invert this circuit.
  ...
  <Function id="qiskit.circuit.library.FunctionalPauliRotations.iso" name="iso" signature="FunctionalPauliRotations.iso(isometry, q_input, q_ancillas_for_output, q_ancillas_zero=None, q_ancillas_dirty=None)">
  ...
  <Function id="qiskit.circuit.library.FunctionalPauliRotations.isometry" name="isometry" signature="FunctionalPauliRotations.isometry(isometry, q_input, q_ancillas_for_output, q_ancillas_zero=None, q_ancillas_dirty=None)">
    Attach an arbitrary isometry from m to n qubits to a circuit. In particular, this allows to attach arbitrary unitaries on n qubits (m=n) or to prepare any state on n qubits (m=0). The decomposition used here was introduced by Iten et al. in [https://arxiv.org/abs/1501.06911](https://arxiv.org/abs/1501.06911).
  ...
  <Function id="qiskit.circuit.library.FunctionalPauliRotations.iswap" name="iswap" signature="FunctionalPauliRotations.iswap(qubit1, qubit2)">
    Apply [`iSwapGate`](qiskit.circuit.library.iSwapGate "qiskit.circuit.library.iSwapGate").
  </Function>

  ### mcmt

  <Function id="qiskit.circuit.library.FunctionalPauliRotations.mcmt" name="mcmt" signature="FunctionalPauliRotations.mcmt(gate, control_qubits, target_qubits, ancilla_qubits=None, mode='no-ancilla', *, single_control_gate_fun=None, q_controls=None, q_ancillae=None, q_targets=None)">
  ...
  <Function id="qiskit.circuit.library.FunctionalPauliRotations.mcrx" name="mcrx" signature="FunctionalPauliRotations.mcrx(theta, q_controls, q_target, use_basis_gates=False)">
  ...
  <Function id="qiskit.circuit.library.FunctionalPauliRotations.mcry" name="mcry" signature="FunctionalPauliRotations.mcry(theta, q_controls, q_target, q_ancillae, mode='basic', use_basis_gates=False)">
  ...
  <Function id="qiskit.circuit.library.FunctionalPauliRotations.mcrz" name="mcrz" signature="FunctionalPauliRotations.mcrz(lam, q_controls, q_target, use_basis_gates=False)">
  ...
  <Function id="qiskit.circuit.library.FunctionalPauliRotations.mct" name="mct" signature="FunctionalPauliRotations.mct(control_qubits, target_qubit, ancilla_qubits=None, mode='noancilla')">
    Apply `MCXGate`.
  </Function>

  ### mcu1

  <Function id="qiskit.circuit.library.FunctionalPauliRotations.mcu1" name="mcu1" signature="FunctionalPauliRotations.mcu1(lam, control_qubits, target_qubit)">
    Apply `MCU1Gate`.
  </Function>

  ### mcx

  <Function id="qiskit.circuit.library.FunctionalPauliRotations.mcx" name="mcx" signature="FunctionalPauliRotations.mcx(control_qubits, target_qubit, ancilla_qubits=None, mode='noancilla')">
    Apply `MCXGate`.
  ...
  <Function id="qiskit.circuit.library.FunctionalPauliRotations.measure" name="measure" signature="FunctionalPauliRotations.measure(qubit, cbit)">
  ...
  <Function id="qiskit.circuit.library.FunctionalPauliRotations.measure_active" name="measure_active" signature="FunctionalPauliRotations.measure_active(inplace=True)">
  ...
  <Function id="qiskit.circuit.library.FunctionalPauliRotations.measure_all" name="measure_all" signature="FunctionalPauliRotations.measure_all(inplace=True)">
  ...
  <Function id="qiskit.circuit.library.FunctionalPauliRotations.mirror" name="mirror" signature="FunctionalPauliRotations.mirror()">
  ...
  <Function id="qiskit.circuit.library.FunctionalPauliRotations.ms" name="ms" signature="FunctionalPauliRotations.ms(theta, qubits)">
    Apply [`MSGate`](qiskit.circuit.library.MSGate "qiskit.circuit.library.MSGate").
  </Function>

  ### num\_connected\_components

  <Function id="qiskit.circuit.library.FunctionalPauliRotations.num_connected_components" name="num_connected_components" signature="FunctionalPauliRotations.num_connected_components(unitary_only=False)">
  ...
  <Function id="qiskit.circuit.library.FunctionalPauliRotations.num_nonlocal_gates" name="num_nonlocal_gates" signature="FunctionalPauliRotations.num_nonlocal_gates()">
  ...
  <Function id="qiskit.circuit.library.FunctionalPauliRotations.num_tensor_factors" name="num_tensor_factors" signature="FunctionalPauliRotations.num_tensor_factors()">
  ...
  <Function id="qiskit.circuit.library.FunctionalPauliRotations.num_unitary_factors" name="num_unitary_factors" signature="FunctionalPauliRotations.num_unitary_factors()">
    Computes the number of tensor factors in the unitary (quantum) part of the circuit only.
  </Function>

  ### qasm

  <Function id="qiskit.circuit.library.FunctionalPauliRotations.qasm" name="qasm" signature="FunctionalPauliRotations.qasm(formatted=False, filename=None)">
  ...
  <Function id="qiskit.circuit.library.FunctionalPauliRotations.qbit_argument_conversion" name="qbit_argument_conversion" signature="FunctionalPauliRotations.qbit_argument_conversion(qubit_representation)">
  ...
  <Function id="qiskit.circuit.library.FunctionalPauliRotations.r" name="r" signature="FunctionalPauliRotations.r(theta, phi, qubit, *, q=None)">
    Apply `RGate`.
  </Function>

  ### rcccx

  <Function id="qiskit.circuit.library.FunctionalPauliRotations.rcccx" name="rcccx" signature="FunctionalPauliRotations.rcccx(control_qubit1, control_qubit2, control_qubit3, target_qubit)">
    Apply [`RC3XGate`](qiskit.circuit.library.RC3XGate "qiskit.circuit.library.RC3XGate").
  </Function>

  ### rccx

  <Function id="qiskit.circuit.library.FunctionalPauliRotations.rccx" name="rccx" signature="FunctionalPauliRotations.rccx(control_qubit1, control_qubit2, target_qubit)">
    Apply [`RCCXGate`](qiskit.circuit.library.RCCXGate "qiskit.circuit.library.RCCXGate").
  </Function>

  ### remove\_final\_measurements

  <Function id="qiskit.circuit.library.FunctionalPauliRotations.remove_final_measurements" name="remove_final_measurements" signature="FunctionalPauliRotations.remove_final_measurements(inplace=True)">
  ...
  <Function id="qiskit.circuit.library.FunctionalPauliRotations.reset" name="reset" signature="FunctionalPauliRotations.reset(qubit)">
    Reset q.
  </Function>

  ### rx

  <Function id="qiskit.circuit.library.FunctionalPauliRotations.rx" name="rx" signature="FunctionalPauliRotations.rx(theta, qubit, *, label=None, q=None)">
    Apply [`RXGate`](qiskit.circuit.library.RXGate "qiskit.circuit.library.RXGate").
  </Function>

  ### rxx

  <Function id="qiskit.circuit.library.FunctionalPauliRotations.rxx" name="rxx" signature="FunctionalPauliRotations.rxx(theta, qubit1, qubit2)">
    Apply [`RXXGate`](qiskit.circuit.library.RXXGate "qiskit.circuit.library.RXXGate").
  </Function>

  ### ry

  <Function id="qiskit.circuit.library.FunctionalPauliRotations.ry" name="ry" signature="FunctionalPauliRotations.ry(theta, qubit, *, label=None, q=None)">
    Apply [`RYGate`](qiskit.circuit.library.RYGate "qiskit.circuit.library.RYGate").
  </Function>

  ### ryy

  <Function id="qiskit.circuit.library.FunctionalPauliRotations.ryy" name="ryy" signature="FunctionalPauliRotations.ryy(theta, qubit1, qubit2)">
    Apply [`RYYGate`](qiskit.circuit.library.RYYGate "qiskit.circuit.library.RYYGate").
  </Function>

  ### rz

  <Function id="qiskit.circuit.library.FunctionalPauliRotations.rz" name="rz" signature="FunctionalPauliRotations.rz(phi, qubit, *, q=None)">
    Apply [`RZGate`](qiskit.circuit.library.RZGate "qiskit.circuit.library.RZGate").
  </Function>

  ### rzx

  <Function id="qiskit.circuit.library.FunctionalPauliRotations.rzx" name="rzx" signature="FunctionalPauliRotations.rzx(theta, qubit1, qubit2)">
    Apply [`RZXGate`](qiskit.circuit.library.RZXGate "qiskit.circuit.library.RZXGate").
  </Function>

  ### rzz

  <Function id="qiskit.circuit.library.FunctionalPauliRotations.rzz" name="rzz" signature="FunctionalPauliRotations.rzz(theta, qubit1, qubit2)">
    Apply [`RZZGate`](qiskit.circuit.library.RZZGate "qiskit.circuit.library.RZZGate").
  </Function>

  ### s

  <Function id="qiskit.circuit.library.FunctionalPauliRotations.s" name="s" signature="FunctionalPauliRotations.s(qubit, *, q=None)">
    Apply [`SGate`](qiskit.circuit.library.SGate "qiskit.circuit.library.SGate").
  </Function>

  ### sdg

  <Function id="qiskit.circuit.library.FunctionalPauliRotations.sdg" name="sdg" signature="FunctionalPauliRotations.sdg(qubit, *, q=None)">
    Apply [`SdgGate`](qiskit.circuit.library.SdgGate "qiskit.circuit.library.SdgGate").
  </Function>

  ### size

  <Function id="qiskit.circuit.library.FunctionalPauliRotations.size" name="size" signature="FunctionalPauliRotations.size()">
  ...
  <Function id="qiskit.circuit.library.FunctionalPauliRotations.snapshot" name="snapshot" signature="FunctionalPauliRotations.snapshot(label, snapshot_type='statevector', qubits=None, params=None)">
  ...
  <Function id="qiskit.circuit.library.FunctionalPauliRotations.snapshot_density_matrix" name="snapshot_density_matrix" signature="FunctionalPauliRotations.snapshot_density_matrix(label, qubits=None)">
  ...
  <Function id="qiskit.circuit.library.FunctionalPauliRotations.snapshot_expectation_value" name="snapshot_expectation_value" signature="FunctionalPauliRotations.snapshot_expectation_value(label, op, qubits, single_shot=False, variance=False)">
  ...
  <Function id="qiskit.circuit.library.FunctionalPauliRotations.snapshot_probabilities" name="snapshot_probabilities" signature="FunctionalPauliRotations.snapshot_probabilities(label, qubits, variance=False)">
  ...
  <Function id="qiskit.circuit.library.FunctionalPauliRotations.snapshot_stabilizer" name="snapshot_stabilizer" signature="FunctionalPauliRotations.snapshot_stabilizer(label)">
  ...
  <Function id="qiskit.circuit.library.FunctionalPauliRotations.snapshot_statevector" name="snapshot_statevector" signature="FunctionalPauliRotations.snapshot_statevector(label)">
  ...
  <Function id="qiskit.circuit.library.FunctionalPauliRotations.squ" name="squ" signature="FunctionalPauliRotations.squ(unitary_matrix, qubit, mode='ZYZ', up_to_diagonal=False, *, u=None)">
  ...
  <Function id="qiskit.circuit.library.FunctionalPauliRotations.swap" name="swap" signature="FunctionalPauliRotations.swap(qubit1, qubit2)">
    Apply [`SwapGate`](qiskit.circuit.library.SwapGate "qiskit.circuit.library.SwapGate").
  </Function>

  ### t

  <Function id="qiskit.circuit.library.FunctionalPauliRotations.t" name="t" signature="FunctionalPauliRotations.t(qubit, *, q=None)">
    Apply [`TGate`](qiskit.circuit.library.TGate "qiskit.circuit.library.TGate").
  </Function>

  ### tdg

  <Function id="qiskit.circuit.library.FunctionalPauliRotations.tdg" name="tdg" signature="FunctionalPauliRotations.tdg(qubit, *, q=None)">
    Apply [`TdgGate`](qiskit.circuit.library.TdgGate "qiskit.circuit.library.TdgGate").
  </Function>

  ### to\_gate

  <Function id="qiskit.circuit.library.FunctionalPauliRotations.to_gate" name="to_gate" signature="FunctionalPauliRotations.to_gate(parameter_map=None)">
  ...
  <Function id="qiskit.circuit.library.FunctionalPauliRotations.to_instruction" name="to_instruction" signature="FunctionalPauliRotations.to_instruction(parameter_map=None)">
  ...
  <Function id="qiskit.circuit.library.FunctionalPauliRotations.toffoli" name="toffoli" signature="FunctionalPauliRotations.toffoli(control_qubit1, control_qubit2, target_qubit, *, ctl1=None, ctl2=None, tgt=None)">
    Apply [`CCXGate`](qiskit.circuit.library.CCXGate "qiskit.circuit.library.CCXGate").
  </Function>

  ### u1

  <Function id="qiskit.circuit.library.FunctionalPauliRotations.u1" name="u1" signature="FunctionalPauliRotations.u1(theta, qubit, *, q=None)">
    Apply [`U1Gate`](qiskit.circuit.library.U1Gate "qiskit.circuit.library.U1Gate").
  </Function>

  ### u2

  <Function id="qiskit.circuit.library.FunctionalPauliRotations.u2" name="u2" signature="FunctionalPauliRotations.u2(phi, lam, qubit, *, q=None)">
    Apply [`U2Gate`](qiskit.circuit.library.U2Gate "qiskit.circuit.library.U2Gate").
  </Function>

  ### u3

  <Function id="qiskit.circuit.library.FunctionalPauliRotations.u3" name="u3" signature="FunctionalPauliRotations.u3(theta, phi, lam, qubit, *, q=None)">
    Apply [`U3Gate`](qiskit.circuit.library.U3Gate "qiskit.circuit.library.U3Gate").
  </Function>

  ### uc

  <Function id="qiskit.circuit.library.FunctionalPauliRotations.uc" name="uc" signature="FunctionalPauliRotations.uc(gate_list, q_controls, q_target, up_to_diagonal=False)">
  ...
  <Function id="qiskit.circuit.library.FunctionalPauliRotations.ucg" name="ucg" signature="FunctionalPauliRotations.ucg(angle_list, q_controls, q_target, up_to_diagonal=False)">
    Deprecated version of uc.
  </Function>

  ### ucrx

  <Function id="qiskit.circuit.library.FunctionalPauliRotations.ucrx" name="ucrx" signature="FunctionalPauliRotations.ucrx(angle_list, q_controls, q_target)">
  ...
  <Function id="qiskit.circuit.library.FunctionalPauliRotations.ucry" name="ucry" signature="FunctionalPauliRotations.ucry(angle_list, q_controls, q_target)">
  ...
  <Function id="qiskit.circuit.library.FunctionalPauliRotations.ucrz" name="ucrz" signature="FunctionalPauliRotations.ucrz(angle_list, q_controls, q_target)">
  ...
  <Function id="qiskit.circuit.library.FunctionalPauliRotations.ucx" name="ucx" signature="FunctionalPauliRotations.ucx(angle_list, q_controls, q_target)">
    Deprecated version of ucrx.
  </Function>

  ### ucy

  <Function id="qiskit.circuit.library.FunctionalPauliRotations.ucy" name="ucy" signature="FunctionalPauliRotations.ucy(angle_list, q_controls, q_target)">
    Deprecated version of ucry.
  </Function>

  ### ucz

  <Function id="qiskit.circuit.library.FunctionalPauliRotations.ucz" name="ucz" signature="FunctionalPauliRotations.ucz(angle_list, q_controls, q_target)">
    Deprecated version of ucrz.
  </Function>

  ### unitary

  <Function id="qiskit.circuit.library.FunctionalPauliRotations.unitary" name="unitary" signature="FunctionalPauliRotations.unitary(obj, qubits, label=None)">
    Apply unitary gate to q.
  </Function>

  ### width

  <Function id="qiskit.circuit.library.FunctionalPauliRotations.width" name="width" signature="FunctionalPauliRotations.width()">
  ...
  <Function id="qiskit.circuit.library.FunctionalPauliRotations.x" name="x" signature="FunctionalPauliRotations.x(qubit, *, label=None, ctrl_state=None, q=None)">
    Apply [`XGate`](qiskit.circuit.library.XGate "qiskit.circuit.library.XGate").
  </Function>

  ### y

  <Function id="qiskit.circuit.library.FunctionalPauliRotations.y" name="y" signature="FunctionalPauliRotations.y(qubit, *, q=None)">
    Apply [`YGate`](qiskit.circuit.library.YGate "qiskit.circuit.library.YGate").
  </Function>

  ### z

  <Function id="qiskit.circuit.library.FunctionalPauliRotations.z" name="z" signature="FunctionalPauliRotations.z(qubit, *, q=None)">
