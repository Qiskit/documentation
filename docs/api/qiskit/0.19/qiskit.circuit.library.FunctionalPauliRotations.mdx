---
title: FunctionalPauliRotations (v0.19)
description: API reference for qiskit.circuit.library.FunctionalPauliRotations in qiskit v0.19
...
<Class id="qiskit.circuit.library.FunctionalPauliRotations" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.14/qiskit/circuit/library/arithmetic/functional_pauli_rotations.py" signature="FunctionalPauliRotations(num_state_qubits=None, basis='Y', name='F')" modifiers="class">
  ...
  *   **name** (`str`) – The name of the circuit object.
  ...
  <span id="functionalpaulirotations-basis" />

  ### basis

  <Attribute id="qiskit.circuit.library.FunctionalPauliRotations.basis" attributeTypeHint="str">
  ...
  <span id="functionalpaulirotations-clbits" />
  ...
  <span id="functionalpaulirotations-data" />
  ...
  <span id="functionalpaulirotations-extension-lib" />

  ### extension\_lib

  <Attribute id="qiskit.circuit.library.FunctionalPauliRotations.extension_lib" attributeValue="'include &#x22;qelib1.inc&#x22;;'" />

  <span id="functionalpaulirotations-header" />

  ### header

  <Attribute id="qiskit.circuit.library.FunctionalPauliRotations.header" attributeValue="'OPENQASM 2.0;'" />

  <span id="functionalpaulirotations-instances" />

  ### instances

  <Attribute id="qiskit.circuit.library.FunctionalPauliRotations.instances" attributeValue="8" />

  <span id="functionalpaulirotations-n-qubits" />

  ### n\_qubits

  <Attribute id="qiskit.circuit.library.FunctionalPauliRotations.n_qubits">
    Deprecated, use `num_qubits` instead. Return number of qubits.
  </Attribute>

  <span id="functionalpaulirotations-num-ancilla-qubits" />

  ### num\_ancilla\_qubits

  <Attribute id="qiskit.circuit.library.FunctionalPauliRotations.num_ancilla_qubits" attributeTypeHint="int">
  ...
  <span id="functionalpaulirotations-num-clbits" />
  ...
  <span id="functionalpaulirotations-num-parameters" />
  ...
  <span id="functionalpaulirotations-num-qubits" />
  ...
  <span id="functionalpaulirotations-num-state-qubits" />

  ### num\_state\_qubits

  <Attribute id="qiskit.circuit.library.FunctionalPauliRotations.num_state_qubits" attributeTypeHint="int">
  ...
  <span id="functionalpaulirotations-parameters" />
  ...
  <span id="functionalpaulirotations-qubits" />
  ...
  <span id="functionalpaulirotations-and" />

  ### AND

  <Function id="qiskit.circuit.library.FunctionalPauliRotations.AND" signature="FunctionalPauliRotations.AND(qr_variables, qb_target, qr_ancillae, flags=None, mct_mode='no-ancilla')">
  ...
  <span id="functionalpaulirotations-or" />

  ### OR

  <Function id="qiskit.circuit.library.FunctionalPauliRotations.OR" signature="FunctionalPauliRotations.OR(qr_variables, qb_target, qr_ancillae, flags=None, mct_mode='basic')">
  ...
  <span id="functionalpaulirotations-getitem" />

  ### \_\_getitem\_\_

  <Function id="qiskit.circuit.library.FunctionalPauliRotations.__getitem__" signature="FunctionalPauliRotations.__getitem__(item)">
    Return indexed operation.
  </Function>

  <span id="functionalpaulirotations-len" />

  ### \_\_len\_\_

  <Function id="qiskit.circuit.library.FunctionalPauliRotations.__len__" signature="FunctionalPauliRotations.__len__()">
    Return number of operations in circuit.
  </Function>

  <span id="functionalpaulirotations-add-register" />

  ### add\_register

  <Function id="qiskit.circuit.library.FunctionalPauliRotations.add_register" signature="FunctionalPauliRotations.add_register(*regs)">
    Add registers.
  </Function>

  <span id="functionalpaulirotations-append" />

  ### append

  <Function id="qiskit.circuit.library.FunctionalPauliRotations.append" signature="FunctionalPauliRotations.append(instruction, qargs=None, cargs=None)">
  ...
  <span id="functionalpaulirotations-assign-parameters" />

  ### assign\_parameters

  <Function id="qiskit.circuit.library.FunctionalPauliRotations.assign_parameters" signature="FunctionalPauliRotations.assign_parameters(param_dict, inplace=False)">
  ...
  <span id="functionalpaulirotations-barrier" />

  ### barrier

  <Function id="qiskit.circuit.library.FunctionalPauliRotations.barrier" signature="FunctionalPauliRotations.barrier(*qargs)">
    Apply `Barrier`. If qargs is None, applies to all.
  </Function>

  <span id="functionalpaulirotations-bind-parameters" />

  ### bind\_parameters

  <Function id="qiskit.circuit.library.FunctionalPauliRotations.bind_parameters" signature="FunctionalPauliRotations.bind_parameters(value_dict)">
  ...
  <span id="functionalpaulirotations-cast" />

  ### cast

  <Function id="qiskit.circuit.library.FunctionalPauliRotations.cast" signature="FunctionalPauliRotations.cast(value, _type)" modifiers="static">
    Best effort to cast value to type. Otherwise, returns the value.
  </Function>

  <span id="functionalpaulirotations-cbit-argument-conversion" />

  ### cbit\_argument\_conversion

  <Function id="qiskit.circuit.library.FunctionalPauliRotations.cbit_argument_conversion" signature="FunctionalPauliRotations.cbit_argument_conversion(clbit_representation)">
  ...
  <span id="functionalpaulirotations-ccx" />

  ### ccx

  <Function id="qiskit.circuit.library.FunctionalPauliRotations.ccx" signature="FunctionalPauliRotations.ccx(control_qubit1, control_qubit2, target_qubit, *, ctl1=None, ctl2=None, tgt=None)">
    Apply [`CCXGate`](qiskit.circuit.library.CCXGate "qiskit.circuit.library.CCXGate").
  </Function>

  <span id="functionalpaulirotations-ch" />

  ### ch

  <Function id="qiskit.circuit.library.FunctionalPauliRotations.ch" signature="FunctionalPauliRotations.ch(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CHGate`](qiskit.circuit.library.CHGate "qiskit.circuit.library.CHGate").
  </Function>

  <span id="functionalpaulirotations-cls-instances" />

  ### cls\_instances

  <Function id="qiskit.circuit.library.FunctionalPauliRotations.cls_instances" signature="FunctionalPauliRotations.cls_instances()" modifiers="classmethod">
    Return the current number of instances of this class, useful for auto naming.
  </Function>

  <span id="functionalpaulirotations-cls-prefix" />

  ### cls\_prefix

  <Function id="qiskit.circuit.library.FunctionalPauliRotations.cls_prefix" signature="FunctionalPauliRotations.cls_prefix()" modifiers="classmethod">
    Return the prefix to use for auto naming.
  </Function>

  <span id="functionalpaulirotations-cnot" />

  ### cnot

  <Function id="qiskit.circuit.library.FunctionalPauliRotations.cnot" signature="FunctionalPauliRotations.cnot(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CXGate`](qiskit.circuit.library.CXGate "qiskit.circuit.library.CXGate").
  </Function>

  <span id="functionalpaulirotations-combine" />

  ### combine

  <Function id="qiskit.circuit.library.FunctionalPauliRotations.combine" signature="FunctionalPauliRotations.combine(rhs)">
  ...
  <span id="functionalpaulirotations-compose" />

  ### compose

  <Function id="qiskit.circuit.library.FunctionalPauliRotations.compose" signature="FunctionalPauliRotations.compose(other, qubits=None, clbits=None, front=False, inplace=False)">
  ...
  <span id="functionalpaulirotations-copy" />

  ### copy

  <Function id="qiskit.circuit.library.FunctionalPauliRotations.copy" signature="FunctionalPauliRotations.copy(name=None)">
    Copy the circuit.
  ...
  <span id="functionalpaulirotations-count-ops" />

  ### count\_ops

  <Function id="qiskit.circuit.library.FunctionalPauliRotations.count_ops" signature="FunctionalPauliRotations.count_ops()">
  ...
  <span id="functionalpaulirotations-crx" />

  ### crx

  <Function id="qiskit.circuit.library.FunctionalPauliRotations.crx" signature="FunctionalPauliRotations.crx(theta, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CRXGate`](qiskit.circuit.library.CRXGate "qiskit.circuit.library.CRXGate").
  </Function>

  <span id="functionalpaulirotations-cry" />

  ### cry

  <Function id="qiskit.circuit.library.FunctionalPauliRotations.cry" signature="FunctionalPauliRotations.cry(theta, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CRYGate`](qiskit.circuit.library.CRYGate "qiskit.circuit.library.CRYGate").
  </Function>

  <span id="functionalpaulirotations-crz" />

  ### crz

  <Function id="qiskit.circuit.library.FunctionalPauliRotations.crz" signature="FunctionalPauliRotations.crz(theta, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CRZGate`](qiskit.circuit.library.CRZGate "qiskit.circuit.library.CRZGate").
  </Function>

  <span id="functionalpaulirotations-cswap" />

  ### cswap

  <Function id="qiskit.circuit.library.FunctionalPauliRotations.cswap" signature="FunctionalPauliRotations.cswap(control_qubit, target_qubit1, target_qubit2, *, label=None, ctrl_state=None, ctl=None, tgt1=None, tgt2=None)">
    Apply [`CSwapGate`](qiskit.circuit.library.CSwapGate "qiskit.circuit.library.CSwapGate").
  </Function>

  <span id="functionalpaulirotations-cu1" />

  ### cu1

  <Function id="qiskit.circuit.library.FunctionalPauliRotations.cu1" signature="FunctionalPauliRotations.cu1(theta, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CU1Gate`](qiskit.circuit.library.CU1Gate "qiskit.circuit.library.CU1Gate").
  </Function>

  <span id="functionalpaulirotations-cu3" />

  ### cu3

  <Function id="qiskit.circuit.library.FunctionalPauliRotations.cu3" signature="FunctionalPauliRotations.cu3(theta, phi, lam, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CU3Gate`](qiskit.circuit.library.CU3Gate "qiskit.circuit.library.CU3Gate").
  </Function>

  <span id="functionalpaulirotations-cx" />

  ### cx

  <Function id="qiskit.circuit.library.FunctionalPauliRotations.cx" signature="FunctionalPauliRotations.cx(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CXGate`](qiskit.circuit.library.CXGate "qiskit.circuit.library.CXGate").
  </Function>

  <span id="functionalpaulirotations-cy" />

  ### cy

  <Function id="qiskit.circuit.library.FunctionalPauliRotations.cy" signature="FunctionalPauliRotations.cy(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CYGate`](qiskit.circuit.library.CYGate "qiskit.circuit.library.CYGate").
  </Function>

  <span id="functionalpaulirotations-cz" />

  ### cz

  <Function id="qiskit.circuit.library.FunctionalPauliRotations.cz" signature="FunctionalPauliRotations.cz(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CZGate`](qiskit.circuit.library.CZGate "qiskit.circuit.library.CZGate").
  </Function>

  <span id="functionalpaulirotations-dcx" />

  ### dcx

  <Function id="qiskit.circuit.library.FunctionalPauliRotations.dcx" signature="FunctionalPauliRotations.dcx(qubit1, qubit2)">
    Apply [`DCXGate`](qiskit.circuit.library.DCXGate "qiskit.circuit.library.DCXGate").
  </Function>

  <span id="functionalpaulirotations-decompose" />

  ### decompose

  <Function id="qiskit.circuit.library.FunctionalPauliRotations.decompose" signature="FunctionalPauliRotations.decompose()">
  ...
  <span id="functionalpaulirotations-depth" />

  ### depth

  <Function id="qiskit.circuit.library.FunctionalPauliRotations.depth" signature="FunctionalPauliRotations.depth()">
  ...
  <span id="functionalpaulirotations-diag-gate" />

  ### diag\_gate

  <Function id="qiskit.circuit.library.FunctionalPauliRotations.diag_gate" signature="FunctionalPauliRotations.diag_gate(diag, qubit)">
    Deprecated version of QuantumCircuit.diagonal.
  </Function>

  <span id="functionalpaulirotations-diagonal" />

  ### diagonal

  <Function id="qiskit.circuit.library.FunctionalPauliRotations.diagonal" signature="FunctionalPauliRotations.diagonal(diag, qubit)">
  ...
  <span id="functionalpaulirotations-extend" />

  ### extend

  <Function id="qiskit.circuit.library.FunctionalPauliRotations.extend" signature="FunctionalPauliRotations.extend(rhs)">
  ...
  <span id="functionalpaulirotations-fredkin" />

  ### fredkin

  <Function id="qiskit.circuit.library.FunctionalPauliRotations.fredkin" signature="FunctionalPauliRotations.fredkin(control_qubit, target_qubit1, target_qubit2, *, ctl=None, tgt1=None, tgt2=None)">
    Apply [`CSwapGate`](qiskit.circuit.library.CSwapGate "qiskit.circuit.library.CSwapGate").
  </Function>

  <span id="functionalpaulirotations-from-qasm-file" />

  ### from\_qasm\_file

  <Function id="qiskit.circuit.library.FunctionalPauliRotations.from_qasm_file" signature="FunctionalPauliRotations.from_qasm_file(path)" modifiers="static">
  ...
  <span id="functionalpaulirotations-from-qasm-str" />

  ### from\_qasm\_str

  <Function id="qiskit.circuit.library.FunctionalPauliRotations.from_qasm_str" signature="FunctionalPauliRotations.from_qasm_str(qasm_str)" modifiers="static">
  ...
  <span id="functionalpaulirotations-h" />

  ### h

  <Function id="qiskit.circuit.library.FunctionalPauliRotations.h" signature="FunctionalPauliRotations.h(qubit, *, q=None)">
    Apply [`HGate`](qiskit.circuit.library.HGate "qiskit.circuit.library.HGate").
  </Function>

  <span id="functionalpaulirotations-hamiltonian" />

  ### hamiltonian

  <Function id="qiskit.circuit.library.FunctionalPauliRotations.hamiltonian" signature="FunctionalPauliRotations.hamiltonian(operator, time, qubits, label=None)">
    Apply hamiltonian evolution to to qubits.
  </Function>

  <span id="functionalpaulirotations-has-register" />

  ### has\_register

  <Function id="qiskit.circuit.library.FunctionalPauliRotations.has_register" signature="FunctionalPauliRotations.has_register(register)">
  ...
  <span id="functionalpaulirotations-i" />

  ### i

  <Function id="qiskit.circuit.library.FunctionalPauliRotations.i" signature="FunctionalPauliRotations.i(qubit, *, q=None)">
    Apply [`IGate`](qiskit.circuit.library.IGate "qiskit.circuit.library.IGate").
  </Function>

  <span id="functionalpaulirotations-id" />

  ### id

  <Function id="qiskit.circuit.library.FunctionalPauliRotations.id" signature="FunctionalPauliRotations.id(qubit, *, q=None)">
    Apply [`IGate`](qiskit.circuit.library.IGate "qiskit.circuit.library.IGate").
  </Function>

  <span id="functionalpaulirotations-iden" />

  ### iden

  <Function id="qiskit.circuit.library.FunctionalPauliRotations.iden" signature="FunctionalPauliRotations.iden(qubit, *, q=None)">
    Deprecated identity gate.
  </Function>

  <span id="functionalpaulirotations-initialize" />

  ### initialize

  <Function id="qiskit.circuit.library.FunctionalPauliRotations.initialize" signature="FunctionalPauliRotations.initialize(params, qubits)">
    Apply initialize to circuit.
  </Function>

  <span id="functionalpaulirotations-inverse" />

  ### inverse

  <Function id="qiskit.circuit.library.FunctionalPauliRotations.inverse" signature="FunctionalPauliRotations.inverse()">
    Invert this circuit.
  ...
  <span id="functionalpaulirotations-iso" />

  ### iso

  <Function id="qiskit.circuit.library.FunctionalPauliRotations.iso" signature="FunctionalPauliRotations.iso(isometry, q_input, q_ancillas_for_output, q_ancillas_zero=None, q_ancillas_dirty=None)">
  ...
  <span id="functionalpaulirotations-isometry" />

  ### isometry

  <Function id="qiskit.circuit.library.FunctionalPauliRotations.isometry" signature="FunctionalPauliRotations.isometry(isometry, q_input, q_ancillas_for_output, q_ancillas_zero=None, q_ancillas_dirty=None)">
    Attach an arbitrary isometry from m to n qubits to a circuit. In particular, this allows to attach arbitrary unitaries on n qubits (m=n) or to prepare any state on n qubits (m=0). The decomposition used here was introduced by Iten et al. in [https://arxiv.org/abs/1501.06911](https://arxiv.org/abs/1501.06911).
  ...
  <span id="functionalpaulirotations-iswap" />

  ### iswap

  <Function id="qiskit.circuit.library.FunctionalPauliRotations.iswap" signature="FunctionalPauliRotations.iswap(qubit1, qubit2)">
    Apply [`iSwapGate`](qiskit.circuit.library.iSwapGate "qiskit.circuit.library.iSwapGate").
  </Function>

  <span id="functionalpaulirotations-mcmt" />

  ### mcmt

  <Function id="qiskit.circuit.library.FunctionalPauliRotations.mcmt" signature="FunctionalPauliRotations.mcmt(gate, control_qubits, target_qubits, ancilla_qubits=None, mode='no-ancilla', *, single_control_gate_fun=None, q_controls=None, q_ancillae=None, q_targets=None)">
    Apply a multi-control, multi-target using a generic gate.

    This can also be used to implement a generic multi-control gate, as the target could also be of length 1.
  </Function>

  <span id="functionalpaulirotations-mcrx" />

  ### mcrx

  <Function id="qiskit.circuit.library.FunctionalPauliRotations.mcrx" signature="FunctionalPauliRotations.mcrx(theta, q_controls, q_target, use_basis_gates=False)">
  ...
  <span id="functionalpaulirotations-mcry" />

  ### mcry

  <Function id="qiskit.circuit.library.FunctionalPauliRotations.mcry" signature="FunctionalPauliRotations.mcry(theta, q_controls, q_target, q_ancillae, mode='basic', use_basis_gates=False)">
  ...
  <span id="functionalpaulirotations-mcrz" />

  ### mcrz

  <Function id="qiskit.circuit.library.FunctionalPauliRotations.mcrz" signature="FunctionalPauliRotations.mcrz(lam, q_controls, q_target, use_basis_gates=False)">
  ...
  <span id="functionalpaulirotations-mct" />

  ### mct

  <Function id="qiskit.circuit.library.FunctionalPauliRotations.mct" signature="FunctionalPauliRotations.mct(control_qubits, target_qubit, ancilla_qubits=None, mode='noancilla')">
    Apply `MCXGate`.
  </Function>

  <span id="functionalpaulirotations-mcu1" />

  ### mcu1

  <Function id="qiskit.circuit.library.FunctionalPauliRotations.mcu1" signature="FunctionalPauliRotations.mcu1(lam, control_qubits, target_qubit)">
    Apply `MCU1Gate`.
  </Function>

  <span id="functionalpaulirotations-mcx" />

  ### mcx

  <Function id="qiskit.circuit.library.FunctionalPauliRotations.mcx" signature="FunctionalPauliRotations.mcx(control_qubits, target_qubit, ancilla_qubits=None, mode='noancilla')">
    Apply `MCXGate`.
  ...
  <span id="functionalpaulirotations-measure" />

  ### measure

  <Function id="qiskit.circuit.library.FunctionalPauliRotations.measure" signature="FunctionalPauliRotations.measure(qubit, cbit)">
  ...
  <span id="functionalpaulirotations-measure-active" />

  ### measure\_active

  <Function id="qiskit.circuit.library.FunctionalPauliRotations.measure_active" signature="FunctionalPauliRotations.measure_active(inplace=True)">
  ...
  <span id="functionalpaulirotations-measure-all" />

  ### measure\_all

  <Function id="qiskit.circuit.library.FunctionalPauliRotations.measure_all" signature="FunctionalPauliRotations.measure_all(inplace=True)">
  ...
  <span id="functionalpaulirotations-mirror" />

  ### mirror

  <Function id="qiskit.circuit.library.FunctionalPauliRotations.mirror" signature="FunctionalPauliRotations.mirror()">
  ...
  <span id="functionalpaulirotations-ms" />

  ### ms

  <Function id="qiskit.circuit.library.FunctionalPauliRotations.ms" signature="FunctionalPauliRotations.ms(theta, qubits)">
    Apply [`MSGate`](qiskit.circuit.library.MSGate "qiskit.circuit.library.MSGate").
  </Function>

  <span id="functionalpaulirotations-num-connected-components" />

  ### num\_connected\_components

  <Function id="qiskit.circuit.library.FunctionalPauliRotations.num_connected_components" signature="FunctionalPauliRotations.num_connected_components(unitary_only=False)">
  ...
  <span id="functionalpaulirotations-num-nonlocal-gates" />

  ### num\_nonlocal\_gates

  <Function id="qiskit.circuit.library.FunctionalPauliRotations.num_nonlocal_gates" signature="FunctionalPauliRotations.num_nonlocal_gates()">
    Return number of non-local gates (i.e. involving 2+ qubits).

    Conditional nonlocal gates are also included.
  </Function>

  <span id="functionalpaulirotations-num-tensor-factors" />

  ### num\_tensor\_factors

  <Function id="qiskit.circuit.library.FunctionalPauliRotations.num_tensor_factors" signature="FunctionalPauliRotations.num_tensor_factors()">
  ...
  <span id="functionalpaulirotations-num-unitary-factors" />

  ### num\_unitary\_factors

  <Function id="qiskit.circuit.library.FunctionalPauliRotations.num_unitary_factors" signature="FunctionalPauliRotations.num_unitary_factors()">
    Computes the number of tensor factors in the unitary (quantum) part of the circuit only.
  </Function>

  <span id="functionalpaulirotations-qasm" />

  ### qasm

  <Function id="qiskit.circuit.library.FunctionalPauliRotations.qasm" signature="FunctionalPauliRotations.qasm(formatted=False, filename=None)">
  ...
  <span id="functionalpaulirotations-qbit-argument-conversion" />

  ### qbit\_argument\_conversion

  <Function id="qiskit.circuit.library.FunctionalPauliRotations.qbit_argument_conversion" signature="FunctionalPauliRotations.qbit_argument_conversion(qubit_representation)">
  ...
  <span id="functionalpaulirotations-r" />

  ### r

  <Function id="qiskit.circuit.library.FunctionalPauliRotations.r" signature="FunctionalPauliRotations.r(theta, phi, qubit, *, q=None)">
    Apply `RGate`.
  </Function>

  <span id="functionalpaulirotations-rcccx" />

  ### rcccx

  <Function id="qiskit.circuit.library.FunctionalPauliRotations.rcccx" signature="FunctionalPauliRotations.rcccx(control_qubit1, control_qubit2, control_qubit3, target_qubit)">
    Apply [`RC3XGate`](qiskit.circuit.library.RC3XGate "qiskit.circuit.library.RC3XGate").
  </Function>

  <span id="functionalpaulirotations-rccx" />

  ### rccx

  <Function id="qiskit.circuit.library.FunctionalPauliRotations.rccx" signature="FunctionalPauliRotations.rccx(control_qubit1, control_qubit2, target_qubit)">
    Apply [`RCCXGate`](qiskit.circuit.library.RCCXGate "qiskit.circuit.library.RCCXGate").
  </Function>

  <span id="functionalpaulirotations-remove-final-measurements" />

  ### remove\_final\_measurements

  <Function id="qiskit.circuit.library.FunctionalPauliRotations.remove_final_measurements" signature="FunctionalPauliRotations.remove_final_measurements(inplace=True)">
  ...
  <span id="functionalpaulirotations-reset" />

  ### reset

  <Function id="qiskit.circuit.library.FunctionalPauliRotations.reset" signature="FunctionalPauliRotations.reset(qubit)">
    Reset q.
  </Function>

  <span id="functionalpaulirotations-rx" />

  ### rx

  <Function id="qiskit.circuit.library.FunctionalPauliRotations.rx" signature="FunctionalPauliRotations.rx(theta, qubit, *, label=None, q=None)">
    Apply [`RXGate`](qiskit.circuit.library.RXGate "qiskit.circuit.library.RXGate").
  </Function>

  <span id="functionalpaulirotations-rxx" />

  ### rxx

  <Function id="qiskit.circuit.library.FunctionalPauliRotations.rxx" signature="FunctionalPauliRotations.rxx(theta, qubit1, qubit2)">
    Apply [`RXXGate`](qiskit.circuit.library.RXXGate "qiskit.circuit.library.RXXGate").
  </Function>

  <span id="functionalpaulirotations-ry" />

  ### ry

  <Function id="qiskit.circuit.library.FunctionalPauliRotations.ry" signature="FunctionalPauliRotations.ry(theta, qubit, *, label=None, q=None)">
    Apply [`RYGate`](qiskit.circuit.library.RYGate "qiskit.circuit.library.RYGate").
  </Function>

  <span id="functionalpaulirotations-ryy" />

  ### ryy

  <Function id="qiskit.circuit.library.FunctionalPauliRotations.ryy" signature="FunctionalPauliRotations.ryy(theta, qubit1, qubit2)">
    Apply [`RYYGate`](qiskit.circuit.library.RYYGate "qiskit.circuit.library.RYYGate").
  </Function>

  <span id="functionalpaulirotations-rz" />

  ### rz

  <Function id="qiskit.circuit.library.FunctionalPauliRotations.rz" signature="FunctionalPauliRotations.rz(phi, qubit, *, q=None)">
    Apply [`RZGate`](qiskit.circuit.library.RZGate "qiskit.circuit.library.RZGate").
  </Function>

  <span id="functionalpaulirotations-rzx" />

  ### rzx

  <Function id="qiskit.circuit.library.FunctionalPauliRotations.rzx" signature="FunctionalPauliRotations.rzx(theta, qubit1, qubit2)">
    Apply [`RZXGate`](qiskit.circuit.library.RZXGate "qiskit.circuit.library.RZXGate").
  </Function>

  <span id="functionalpaulirotations-rzz" />

  ### rzz

  <Function id="qiskit.circuit.library.FunctionalPauliRotations.rzz" signature="FunctionalPauliRotations.rzz(theta, qubit1, qubit2)">
    Apply [`RZZGate`](qiskit.circuit.library.RZZGate "qiskit.circuit.library.RZZGate").
  </Function>

  <span id="functionalpaulirotations-s" />

  ### s

  <Function id="qiskit.circuit.library.FunctionalPauliRotations.s" signature="FunctionalPauliRotations.s(qubit, *, q=None)">
    Apply [`SGate`](qiskit.circuit.library.SGate "qiskit.circuit.library.SGate").
  </Function>

  <span id="functionalpaulirotations-sdg" />

  ### sdg

  <Function id="qiskit.circuit.library.FunctionalPauliRotations.sdg" signature="FunctionalPauliRotations.sdg(qubit, *, q=None)">
    Apply [`SdgGate`](qiskit.circuit.library.SdgGate "qiskit.circuit.library.SdgGate").
  </Function>

  <span id="functionalpaulirotations-size" />

  ### size

  <Function id="qiskit.circuit.library.FunctionalPauliRotations.size" signature="FunctionalPauliRotations.size()">
  ...
  <span id="functionalpaulirotations-snapshot" />

  ### snapshot

  <Function id="qiskit.circuit.library.FunctionalPauliRotations.snapshot" signature="FunctionalPauliRotations.snapshot(label, snapshot_type='statevector', qubits=None, params=None)">
  ...
  <span id="functionalpaulirotations-snapshot-density-matrix" />

  ### snapshot\_density\_matrix

  <Function id="qiskit.circuit.library.FunctionalPauliRotations.snapshot_density_matrix" signature="FunctionalPauliRotations.snapshot_density_matrix(label, qubits=None)">
  ...
  <span id="functionalpaulirotations-snapshot-expectation-value" />

  ### snapshot\_expectation\_value

  <Function id="qiskit.circuit.library.FunctionalPauliRotations.snapshot_expectation_value" signature="FunctionalPauliRotations.snapshot_expectation_value(label, op, qubits, single_shot=False, variance=False)">
  ...
  <span id="functionalpaulirotations-snapshot-probabilities" />

  ### snapshot\_probabilities

  <Function id="qiskit.circuit.library.FunctionalPauliRotations.snapshot_probabilities" signature="FunctionalPauliRotations.snapshot_probabilities(label, qubits, variance=False)">
  ...
  <span id="functionalpaulirotations-snapshot-stabilizer" />

  ### snapshot\_stabilizer

  <Function id="qiskit.circuit.library.FunctionalPauliRotations.snapshot_stabilizer" signature="FunctionalPauliRotations.snapshot_stabilizer(label)">
  ...
  <span id="functionalpaulirotations-snapshot-statevector" />

  ### snapshot\_statevector

  <Function id="qiskit.circuit.library.FunctionalPauliRotations.snapshot_statevector" signature="FunctionalPauliRotations.snapshot_statevector(label)">
  ...
  <span id="functionalpaulirotations-squ" />

  ### squ

  <Function id="qiskit.circuit.library.FunctionalPauliRotations.squ" signature="FunctionalPauliRotations.squ(unitary_matrix, qubit, mode='ZYZ', up_to_diagonal=False, *, u=None)">
  ...
  <span id="functionalpaulirotations-swap" />

  ### swap

  <Function id="qiskit.circuit.library.FunctionalPauliRotations.swap" signature="FunctionalPauliRotations.swap(qubit1, qubit2)">
    Apply [`SwapGate`](qiskit.circuit.library.SwapGate "qiskit.circuit.library.SwapGate").
  </Function>

  <span id="functionalpaulirotations-t" />

  ### t

  <Function id="qiskit.circuit.library.FunctionalPauliRotations.t" signature="FunctionalPauliRotations.t(qubit, *, q=None)">
    Apply [`TGate`](qiskit.circuit.library.TGate "qiskit.circuit.library.TGate").
  </Function>

  <span id="functionalpaulirotations-tdg" />

  ### tdg

  <Function id="qiskit.circuit.library.FunctionalPauliRotations.tdg" signature="FunctionalPauliRotations.tdg(qubit, *, q=None)">
    Apply [`TdgGate`](qiskit.circuit.library.TdgGate "qiskit.circuit.library.TdgGate").
  </Function>

  <span id="functionalpaulirotations-to-gate" />

  ### to\_gate

  <Function id="qiskit.circuit.library.FunctionalPauliRotations.to_gate" signature="FunctionalPauliRotations.to_gate(parameter_map=None)">
  ...
  <span id="functionalpaulirotations-to-instruction" />

  ### to\_instruction

  <Function id="qiskit.circuit.library.FunctionalPauliRotations.to_instruction" signature="FunctionalPauliRotations.to_instruction(parameter_map=None)">
  ...
  <span id="functionalpaulirotations-toffoli" />

  ### toffoli

  <Function id="qiskit.circuit.library.FunctionalPauliRotations.toffoli" signature="FunctionalPauliRotations.toffoli(control_qubit1, control_qubit2, target_qubit, *, ctl1=None, ctl2=None, tgt=None)">
    Apply [`CCXGate`](qiskit.circuit.library.CCXGate "qiskit.circuit.library.CCXGate").
  </Function>

  <span id="functionalpaulirotations-u1" />

  ### u1

  <Function id="qiskit.circuit.library.FunctionalPauliRotations.u1" signature="FunctionalPauliRotations.u1(theta, qubit, *, q=None)">
    Apply [`U1Gate`](qiskit.circuit.library.U1Gate "qiskit.circuit.library.U1Gate").
  </Function>

  <span id="functionalpaulirotations-u2" />

  ### u2

  <Function id="qiskit.circuit.library.FunctionalPauliRotations.u2" signature="FunctionalPauliRotations.u2(phi, lam, qubit, *, q=None)">
    Apply [`U2Gate`](qiskit.circuit.library.U2Gate "qiskit.circuit.library.U2Gate").
  </Function>

  <span id="functionalpaulirotations-u3" />

  ### u3

  <Function id="qiskit.circuit.library.FunctionalPauliRotations.u3" signature="FunctionalPauliRotations.u3(theta, phi, lam, qubit, *, q=None)">
    Apply [`U3Gate`](qiskit.circuit.library.U3Gate "qiskit.circuit.library.U3Gate").
  </Function>

  <span id="functionalpaulirotations-uc" />

  ### uc

  <Function id="qiskit.circuit.library.FunctionalPauliRotations.uc" signature="FunctionalPauliRotations.uc(gate_list, q_controls, q_target, up_to_diagonal=False)">
  ...
  <span id="functionalpaulirotations-ucg" />

  ### ucg

  <Function id="qiskit.circuit.library.FunctionalPauliRotations.ucg" signature="FunctionalPauliRotations.ucg(angle_list, q_controls, q_target, up_to_diagonal=False)">
    Deprecated version of uc.
  </Function>

  <span id="functionalpaulirotations-ucrx" />

  ### ucrx

  <Function id="qiskit.circuit.library.FunctionalPauliRotations.ucrx" signature="FunctionalPauliRotations.ucrx(angle_list, q_controls, q_target)">
  ...
  <span id="functionalpaulirotations-ucry" />

  ### ucry

  <Function id="qiskit.circuit.library.FunctionalPauliRotations.ucry" signature="FunctionalPauliRotations.ucry(angle_list, q_controls, q_target)">
  ...
  <span id="functionalpaulirotations-ucrz" />

  ### ucrz

  <Function id="qiskit.circuit.library.FunctionalPauliRotations.ucrz" signature="FunctionalPauliRotations.ucrz(angle_list, q_controls, q_target)">
  ...
  <span id="functionalpaulirotations-ucx" />

  ### ucx

  <Function id="qiskit.circuit.library.FunctionalPauliRotations.ucx" signature="FunctionalPauliRotations.ucx(angle_list, q_controls, q_target)">
    Deprecated version of ucrx.
  </Function>

  <span id="functionalpaulirotations-ucy" />

  ### ucy

  <Function id="qiskit.circuit.library.FunctionalPauliRotations.ucy" signature="FunctionalPauliRotations.ucy(angle_list, q_controls, q_target)">
    Deprecated version of ucry.
  </Function>

  <span id="functionalpaulirotations-ucz" />

  ### ucz

  <Function id="qiskit.circuit.library.FunctionalPauliRotations.ucz" signature="FunctionalPauliRotations.ucz(angle_list, q_controls, q_target)">
    Deprecated version of ucrz.
  </Function>

  <span id="functionalpaulirotations-unitary" />

  ### unitary

  <Function id="qiskit.circuit.library.FunctionalPauliRotations.unitary" signature="FunctionalPauliRotations.unitary(obj, qubits, label=None)">
    Apply unitary gate to q.
  </Function>

  <span id="functionalpaulirotations-width" />

  ### width

  <Function id="qiskit.circuit.library.FunctionalPauliRotations.width" signature="FunctionalPauliRotations.width()">
  ...
  <span id="functionalpaulirotations-x" />

  ### x

  <Function id="qiskit.circuit.library.FunctionalPauliRotations.x" signature="FunctionalPauliRotations.x(qubit, *, label=None, ctrl_state=None, q=None)">
    Apply [`XGate`](qiskit.circuit.library.XGate "qiskit.circuit.library.XGate").
  </Function>

  <span id="functionalpaulirotations-y" />

  ### y

  <Function id="qiskit.circuit.library.FunctionalPauliRotations.y" signature="FunctionalPauliRotations.y(qubit, *, q=None)">
    Apply [`YGate`](qiskit.circuit.library.YGate "qiskit.circuit.library.YGate").
  </Function>

  <span id="functionalpaulirotations-z" />

  ### z

  <Function id="qiskit.circuit.library.FunctionalPauliRotations.z" signature="FunctionalPauliRotations.z(qubit, *, q=None)">
