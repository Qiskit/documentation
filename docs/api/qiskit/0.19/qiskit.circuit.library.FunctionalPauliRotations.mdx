...
<Class id="qiskit.circuit.library.FunctionalPauliRotations" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.14/qiskit/circuit/library/arithmetic/functional_pauli_rotations.py" signature="FunctionalPauliRotations(num_state_qubits=None, basis='Y', name='F')">
  ...
  *   **name** (`str`) – The name of the circuit object.
  ...
  <Attribute id="qiskit.circuit.library.FunctionalPauliRotations.basis" signature="str">
  ...
  <Attribute id="qiskit.circuit.library.FunctionalPauliRotations.num_ancilla_qubits" signature="int">
  ...
  <Attribute id="qiskit.circuit.library.FunctionalPauliRotations.num_state_qubits" signature="int">
  ...
  <Function id="qiskit.circuit.library.FunctionalPauliRotations.cast" signature="static FunctionalPauliRotations.cast(value, _type)">
  ...
  <Function id="qiskit.circuit.library.FunctionalPauliRotations.cls_instances" signature="classmethod FunctionalPauliRotations.cls_instances()">
    Return the current number of instances of this class, useful for auto naming.
  </Function>

  ### cls\_prefix

  <Function id="qiskit.circuit.library.FunctionalPauliRotations.cls_prefix" signature="classmethod FunctionalPauliRotations.cls_prefix()">
  ...
  <Function id="qiskit.circuit.library.FunctionalPauliRotations.from_qasm_file" signature="static FunctionalPauliRotations.from_qasm_file(path)">
  ...
  <Function id="qiskit.circuit.library.FunctionalPauliRotations.from_qasm_str" signature="static FunctionalPauliRotations.from_qasm_str(qasm_str)">
