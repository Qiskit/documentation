...
<Class id="qiskit.aqua.algorithms.QSVM" github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.7/qiskit/aqua/algorithms/classifiers/qsvm/qsvm.py" signature="QSVM(feature_map, training_dataset=None, test_dataset=None, datapoints=None, multiclass_extension=None, quantum_instance=None)">
  ...
  **Raises**
  ...
  <Attribute id="qiskit.aqua.algorithms.QSVM.BATCH_SIZE" signature="= 1000" />

  ### backend

  <Attribute id="qiskit.aqua.algorithms.QSVM.backend" name="backend" signature="qiskit.providers.basebackend.BaseBackend">
    Returns backend.
  ...
  <Attribute id="qiskit.aqua.algorithms.QSVM.quantum_instance" name="quantum_instance" signature="Union[None, qiskit.aqua.quantum_instance.QuantumInstance]">
  ...
  <Attribute id="qiskit.aqua.algorithms.QSVM.random" name="random">
    Return a numpy random.
  </Attribute>

  ### ret

  <Attribute id="qiskit.aqua.algorithms.QSVM.ret" name="ret">
    returns result
  </Attribute>
  ...
  <Function id="qiskit.aqua.algorithms.QSVM.construct_circuit" name="construct_circuit" signature="QSVM.construct_circuit(x1, x2, measurement=False)">
  ...
  <Function id="qiskit.aqua.algorithms.QSVM.construct_kernel_matrix" name="construct_kernel_matrix" signature="QSVM.construct_kernel_matrix(x1_vec, x2_vec=None, quantum_instance=None)">
  ...
  <Function id="qiskit.aqua.algorithms.QSVM.get_kernel_matrix" name="get_kernel_matrix" signature="static QSVM.get_kernel_matrix(quantum_instance, feature_map, x1_vec, x2_vec=None)">
    Construct kernel matrix, if x2\_vec is None, self-innerproduct is conducted.
  ...
  <Function id="qiskit.aqua.algorithms.QSVM.load_model" name="load_model" signature="QSVM.load_model(file_path)">
  ...
  <Function id="qiskit.aqua.algorithms.QSVM.predict" name="predict" signature="QSVM.predict(data, quantum_instance=None)">
  ...
  <Function id="qiskit.aqua.algorithms.QSVM.run" name="run" signature="QSVM.run(quantum_instance=None, **kwargs)">
  ...
  <Function id="qiskit.aqua.algorithms.QSVM.save_model" name="save_model" signature="QSVM.save_model(file_path)">
  ...
  <Function id="qiskit.aqua.algorithms.QSVM.set_backend" name="set_backend" signature="QSVM.set_backend(backend, **kwargs)">
  ...
  <Function id="qiskit.aqua.algorithms.QSVM.setup_datapoint" name="setup_datapoint" signature="QSVM.setup_datapoint(datapoints)">
  ...
  <Function id="qiskit.aqua.algorithms.QSVM.setup_test_data" name="setup_test_data" signature="QSVM.setup_test_data(test_dataset)">
  ...
  <Function id="qiskit.aqua.algorithms.QSVM.setup_training_data" name="setup_training_data" signature="QSVM.setup_training_data(training_dataset)">
  ...
  <Function id="qiskit.aqua.algorithms.QSVM.test" name="test" signature="QSVM.test(data, labels, quantum_instance=None)">
    Test the svm.
  ...
  <Function id="qiskit.aqua.algorithms.QSVM.train" name="train" signature="QSVM.train(data, labels, quantum_instance=None)">
    Train the svm.
