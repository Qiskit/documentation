...
<Class id="qiskit.aqua.algorithms.QSVM" github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.7/qiskit/aqua/algorithms/classifiers/qsvm/qsvm.py" signature="QSVM(feature_map, training_dataset=None, test_dataset=None, datapoints=None, multiclass_extension=None, quantum_instance=None)">
  ...
  **Raises**
  ...
  <Attribute id="qiskit.aqua.algorithms.QSVM.backend" signature="qiskit.providers.basebackend.BaseBackend">
    Returns backend.
  ...
  <Attribute id="qiskit.aqua.algorithms.QSVM.quantum_instance" signature="Union[None, qiskit.aqua.quantum_instance.QuantumInstance]">
  ...
  <Function id="qiskit.aqua.algorithms.QSVM.get_kernel_matrix" signature="static QSVM.get_kernel_matrix(quantum_instance, feature_map, x1_vec, x2_vec=None)">
    Construct kernel matrix, if x2\_vec is None, self-innerproduct is conducted.
