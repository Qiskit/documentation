...
|                                                                                                                                                                                                         |                                                             |
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------- |
| [`SwapRZ.num_parameters`](qiskit.aqua.components.variational_forms.SwapRZ.num_parameters "qiskit.aqua.components.variational_forms.SwapRZ.num_parameters")                                              | Number of parameters of the variational form.               |
| [`SwapRZ.num_qubits`](qiskit.aqua.components.variational_forms.SwapRZ.num_qubits "qiskit.aqua.components.variational_forms.SwapRZ.num_qubits")                                                          | Number of qubits of the variational form.                   |
| [`SwapRZ.parameter_bounds`](qiskit.aqua.components.variational_forms.SwapRZ.parameter_bounds "qiskit.aqua.components.variational_forms.SwapRZ.parameter_bounds")                                        | Parameter bounds.                                           |
| [`SwapRZ.preferred_init_points`](qiskit.aqua.components.variational_forms.SwapRZ.preferred_init_points "qiskit.aqua.components.variational_forms.SwapRZ.preferred_init_points")                         | Return preferred init points.                               |
| [`SwapRZ.setting`](qiskit.aqua.components.variational_forms.SwapRZ.setting "qiskit.aqua.components.variational_forms.SwapRZ.setting")                                                                   |                                                             |
| [`SwapRZ.support_parameterized_circuit`](qiskit.aqua.components.variational_forms.SwapRZ.support_parameterized_circuit "qiskit.aqua.components.variational_forms.SwapRZ.support_parameterized_circuit") | Whether or not the sub-class support parameterized circuit. |

## Methods

|                                                                                                                                                                                                       |                                                       |
| ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------- |
| [`SwapRZ.construct_circuit`](qiskit.aqua.components.variational_forms.SwapRZ.construct_circuit "qiskit.aqua.components.variational_forms.SwapRZ.construct_circuit")(parameters\[, q])                 | Construct the variational form, given its parameters. |
| [`SwapRZ.get_entangler_map`](qiskit.aqua.components.variational_forms.SwapRZ.get_entangler_map "qiskit.aqua.components.variational_forms.SwapRZ.get_entangler_map")(map\_type, num\_qubits)           | returns entangler map                                 |
| [`SwapRZ.validate_entangler_map`](qiskit.aqua.components.variational_forms.SwapRZ.validate_entangler_map "qiskit.aqua.components.variational_forms.SwapRZ.validate_entangler_map")(entangler\_map, …) | validate entangler map                                |
