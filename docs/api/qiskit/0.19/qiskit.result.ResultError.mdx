...
<Class id="qiskit.result.ResultError" name="ResultError" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.14/qiskit/result/exceptions.py" signature="ResultError(error)">
  ...
  **error** (*dict*) –
  ...
  <Function id="qiskit.result.ResultError.with_traceback" name="with_traceback" signature="with_traceback()">
