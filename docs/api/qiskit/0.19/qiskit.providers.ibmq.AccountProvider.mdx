---
title: AccountProvider (v0.19)
description: API reference for qiskit.providers.ibmq.AccountProvider in qiskit v0.19
...
<Class id="qiskit.providers.ibmq.AccountProvider" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-ibmq-provider/tree/stable/0.7/qiskit/providers/ibmq/accountprovider.py" signature="AccountProvider(credentials, access_token)" modifiers="class">
  ...
  *   **access\_token** (`str`) – IBM Quantum Experience access token.
  ...
  <span id="accountprovider-backends" />
  ...
  <span id="accountprovider-get-backend" />
