---
title: CommutationAnalysis (v0.19)
description: API reference for qiskit.transpiler.passes.CommutationAnalysis in qiskit v0.19
...
<Class id="qiskit.transpiler.passes.CommutationAnalysis" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.14/qiskit/transpiler/passes/optimization/commutation_analysis.py" signature="CommutationAnalysis(*args, **kwargs)" modifiers="class">
  ...
  <span id="commutationanalysis-is-analysis-pass" />
  ...
  <span id="commutationanalysis-is-transformation-pass" />
  ...
  <span id="commutationanalysis-name" />

  ### name

  <Function id="qiskit.transpiler.passes.CommutationAnalysis.name" signature="CommutationAnalysis.name()">
    Return the name of the pass.
  </Function>

  <span id="commutationanalysis-run" />

  ### run

  <Function id="qiskit.transpiler.passes.CommutationAnalysis.run" signature="CommutationAnalysis.run(dag)">
