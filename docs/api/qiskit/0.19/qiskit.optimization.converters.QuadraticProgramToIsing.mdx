...
<Class id="qiskit.optimization.converters.QuadraticProgramToIsing" github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.7/qiskit/optimization/converters/quadratic_program_to_ising.py" signature="QuadraticProgramToIsing">
