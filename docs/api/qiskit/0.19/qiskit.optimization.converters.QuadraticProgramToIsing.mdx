---
title: QuadraticProgramToIsing (v0.19)
description: API reference for qiskit.optimization.converters.QuadraticProgramToIsing in qiskit v0.19
...
<Class id="qiskit.optimization.converters.QuadraticProgramToIsing" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.7/qiskit/optimization/converters/quadratic_program_to_ising.py" signature="QuadraticProgramToIsing" modifiers="class">
  ...
  <span id="quadraticprogramtoising-encode" />
