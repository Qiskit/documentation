...
<Class id="qiskit.pulse.InstructionScheduleMap" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.14/qiskit/pulse/instruction_schedule_map.py" signature="InstructionScheduleMap">
  ...
  <Attribute id="qiskit.pulse.InstructionScheduleMap.instructions" name="instructions" signature="List[str]">
  ...
  <Function id="qiskit.pulse.InstructionScheduleMap.add" name="add" signature="InstructionScheduleMap.add(instruction, qubits, schedule)">
