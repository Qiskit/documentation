---
title: InstructionScheduleMap (v0.19)
description: API reference for qiskit.pulse.InstructionScheduleMap in qiskit v0.19
...
<Class id="qiskit.pulse.InstructionScheduleMap" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.14/qiskit/pulse/instruction_schedule_map.py" signature="InstructionScheduleMap" modifiers="class">
  ...
  <span id="instructionschedulemap-instructions" />

  ### instructions

  <Attribute id="qiskit.pulse.InstructionScheduleMap.instructions" attributeTypeHint="List[str]">
  ...
  <span id="instructionschedulemap-add" />

  ### add

  <Function id="qiskit.pulse.InstructionScheduleMap.add" signature="InstructionScheduleMap.add(instruction, qubits, schedule)">
  ...
  <span id="instructionschedulemap-assert-has" />
  ...
  <span id="instructionschedulemap-get" />
  ...
  <span id="instructionschedulemap-get-parameters" />
  ...
  <span id="instructionschedulemap-has" />
  ...
  <span id="instructionschedulemap-pop" />
  ...
  <span id="instructionschedulemap-qubit-instructions" />
  ...
  <span id="instructionschedulemap-qubits-with-instruction" />
  ...
  <span id="instructionschedulemap-remove" />
