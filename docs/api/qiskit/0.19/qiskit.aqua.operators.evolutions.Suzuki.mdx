...
<Class id="qiskit.aqua.operators.evolutions.Suzuki" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.7/qiskit/aqua/operators/evolutions/trotterizations/suzuki.py" signature="Suzuki(reps=1, order=2)">
  ...
  *   **order** (`int`) – The order of the expansion to perform.
  ...
  <Attribute id="qiskit.aqua.operators.evolutions.Suzuki.order" name="order" signature="int">
    returns order
  ...
  <Attribute id="qiskit.aqua.operators.evolutions.Suzuki.reps" name="reps" signature="int">
