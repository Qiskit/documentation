---
title: plot_state_qsphere (v0.19)
description: API reference for qiskit.visualization.plot_state_qsphere in qiskit v0.19
in_page_toc_min_heading_level: 1
python_api_type: function
python_api_name: qiskit.visualization.plot_state_qsphere
---

<span id="plot-state-qsphere" />
...
<Function id="qiskit.visualization.plot_state_qsphere" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.14/qiskit/visualization/state_visualization.py" signature="plot_state_qsphere(rho, figsize=None, ax=None)">
  ...
  **Example**
  ...
  ![../\_images/qiskit.visualization.plot\_state\_qsphere\_0\_2.png](/docs/images/api/qiskit/0.19/qiskit.visualization.plot_state_qsphere_0_2.avif) ![../\_images/qiskit.visualization.plot\_state\_qsphere\_0\_3.png](/docs/images/api/qiskit/0.19/qiskit.visualization.plot_state_qsphere_0_3.avif)
</Function>
