...
<Function id="qiskit.visualization.plot_state_qsphere" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.14/qiskit/visualization/state_visualization.py" signature="plot_state_qsphere(rho, figsize=None, ax=None)">
  ...
  **Example**
  ...
  ![../\_images/qiskit.visualization.plot\_state\_qsphere\_0\_2.png](/images/api/qiskit/0.19/qiskit.visualization.plot_state_qsphere_0_2.avif) ![../\_images/qiskit.visualization.plot\_state\_qsphere\_0\_3.png](/images/api/qiskit/0.19/qiskit.visualization.plot_state_qsphere_0_3.avif)
</Function>
