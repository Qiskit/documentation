...
description: API reference for qiskit.optimization.problems.QuadraticProgram in qiskit v0.19
...
<Class id="qiskit.optimization.problems.QuadraticProgram" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.7/qiskit/optimization/problems/quadratic_program.py" signature="QuadraticProgram(name='')" modifiers="class">
  ...
  **name** (`str`) – The name of the quadratic program.
  ...
  <Attribute id="qiskit.optimization.problems.QuadraticProgram.linear_constraints" attributeTypeHint="List[qiskit.optimization.problems.linear_constraint.LinearConstraint]">
  ...
  <Attribute id="qiskit.optimization.problems.QuadraticProgram.linear_constraints_index" attributeTypeHint="Dict[str, int]">
  ...
  <Attribute id="qiskit.optimization.problems.QuadraticProgram.name" attributeTypeHint="str">
  ...
  <Attribute id="qiskit.optimization.problems.QuadraticProgram.objective" attributeTypeHint="qiskit.optimization.problems.quadratic_objective.QuadraticObjective">
  ...
  <Attribute id="qiskit.optimization.problems.QuadraticProgram.quadratic_constraints" attributeTypeHint="List[qiskit.optimization.problems.quadratic_constraint.QuadraticConstraint]">
  ...
  <Attribute id="qiskit.optimization.problems.QuadraticProgram.quadratic_constraints_index" attributeTypeHint="Dict[str, int]">
  ...
  <Attribute id="qiskit.optimization.problems.QuadraticProgram.status" attributeTypeHint="qiskit.optimization.problems.quadratic_program.QuadraticProgramStatus">
  ...
  <Attribute id="qiskit.optimization.problems.QuadraticProgram.variables" attributeTypeHint="List[qiskit.optimization.problems.variable.Variable]">
  ...
  <Attribute id="qiskit.optimization.problems.QuadraticProgram.variables_index" attributeTypeHint="Dict[str, int]">
