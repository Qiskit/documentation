...
<Class id="qiskit.optimization.problems.QuadraticProgram" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.7/qiskit/optimization/problems/quadratic_program.py" signature="QuadraticProgram(name='')">
  ...
  **name** (`str`) – The name of the quadratic program.
  ...
  <Attribute id="qiskit.optimization.problems.QuadraticProgram.linear_constraints" name="linear_constraints" signature="List[qiskit.optimization.problems.linear_constraint.LinearConstraint]">
  ...
  <Attribute id="qiskit.optimization.problems.QuadraticProgram.linear_constraints_index" name="linear_constraints_index" signature="Dict[str, int]">
  ...
  <Attribute id="qiskit.optimization.problems.QuadraticProgram.name" name="name" signature="str">
  ...
  <Attribute id="qiskit.optimization.problems.QuadraticProgram.objective" name="objective" signature="qiskit.optimization.problems.quadratic_objective.QuadraticObjective">
  ...
  <Attribute id="qiskit.optimization.problems.QuadraticProgram.quadratic_constraints" name="quadratic_constraints" signature="List[qiskit.optimization.problems.quadratic_constraint.QuadraticConstraint]">
  ...
  <Attribute id="qiskit.optimization.problems.QuadraticProgram.quadratic_constraints_index" name="quadratic_constraints_index" signature="Dict[str, int]">
  ...
  <Attribute id="qiskit.optimization.problems.QuadraticProgram.status" name="status" signature="qiskit.optimization.problems.quadratic_program.QuadraticProgramStatus">
  ...
  <Attribute id="qiskit.optimization.problems.QuadraticProgram.variables" name="variables" signature="List[qiskit.optimization.problems.variable.Variable]">
  ...
  <Attribute id="qiskit.optimization.problems.QuadraticProgram.variables_index" name="variables_index" signature="Dict[str, int]">
