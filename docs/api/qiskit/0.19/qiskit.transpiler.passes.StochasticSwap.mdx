---
title: StochasticSwap (v0.19)
description: API reference for qiskit.transpiler.passes.StochasticSwap in qiskit v0.19
...
<Class id="qiskit.transpiler.passes.StochasticSwap" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.14/qiskit/transpiler/passes/routing/stochastic_swap.py" signature="StochasticSwap(*args, **kwargs)" modifiers="class">
  ...
  *   **seed** (*int*) – seed for random number generator
  ...
  <span id="stochasticswap-is-analysis-pass" />
  ...
  <span id="stochasticswap-is-transformation-pass" />
