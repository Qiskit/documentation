...
<Function id="qiskit.aqua.utils.random_hermitian" name="random_hermitian" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.7/qiskit/aqua/utils/random_matrix_generator.py" signature="random_hermitian(N, eigs=None, K=None, eigrange=None, sparsity=None, trunc=None)">
