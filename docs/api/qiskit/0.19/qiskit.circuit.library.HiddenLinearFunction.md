...
`HiddenLinearFunction(adjacency_matrix)` [GitHub](https://github.com/qiskit/qiskit/tree/stable/0.14/qiskit/circuit/library/hidden_linear_function.py "view source code")
...
<span id="qiskit.circuit.library.HiddenLinearFunction.AND" />

`HiddenLinearFunction.AND(qr_variables, qb_target, qr_ancillae, flags=None, mct_mode='no-ancilla')`
...
`HiddenLinearFunction.append(instruction, qargs=None, cargs=None)`
...
`HiddenLinearFunction.assign_parameters(param_dict, inplace=False)`
...
`HiddenLinearFunction.cbit_argument_conversion(clbit_representation)`
...
`HiddenLinearFunction.ccx(control_qubit1, control_qubit2, target_qubit, *, ctl1=None, ctl2=None, tgt=None)`
...
`HiddenLinearFunction.ch(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)`
...
`HiddenLinearFunction.cnot(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)`
...
`HiddenLinearFunction.compose(other, qubits=None, clbits=None, front=False, inplace=False)`
...
`HiddenLinearFunction.copy(name=None)`
...
`HiddenLinearFunction.crx(theta, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)`
...
`HiddenLinearFunction.cry(theta, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)`
...
`HiddenLinearFunction.crz(theta, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)`
...
`HiddenLinearFunction.cswap(control_qubit, target_qubit1, target_qubit2, *, label=None, ctrl_state=None, ctl=None, tgt1=None, tgt2=None)`
...
`HiddenLinearFunction.cu1(theta, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)`
...
`HiddenLinearFunction.cx(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)`
...
`HiddenLinearFunction.cy(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)`
...
`HiddenLinearFunction.cz(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)`
...
`HiddenLinearFunction.draw(output=None, scale=0.7, filename=None, style=None, interactive=False, line_length=None, plot_barriers=True, reverse_bits=False, justify=None, vertical_compression='medium', idle_wires=True, with_layout=True, fold=None, ax=None, initial_state=False, cregbundle=False)`
...
`HiddenLinearFunction.fredkin(control_qubit, target_qubit1, target_qubit2, *, ctl=None, tgt1=None, tgt2=None)`
...
`static HiddenLinearFunction.from_qasm_file(path)`
...
`static HiddenLinearFunction.from_qasm_str(qasm_str)`
...
`HiddenLinearFunction.iso(isometry, q_input, q_ancillas_for_output, q_ancillas_zero=None, q_ancillas_dirty=None)`
...
`HiddenLinearFunction.isometry(isometry, q_input, q_ancillas_for_output, q_ancillas_zero=None, q_ancillas_dirty=None)`
...
`HiddenLinearFunction.mcmt(gate, control_qubits, target_qubits, ancilla_qubits=None, mode='no-ancilla', *, single_control_gate_fun=None, q_controls=None, q_ancillae=None, q_targets=None)`
...
`HiddenLinearFunction.mcrx(theta, q_controls, q_target, use_basis_gates=False)`
...
`HiddenLinearFunction.mcry(theta, q_controls, q_target, q_ancillae, mode='basic', use_basis_gates=False)`
...
`HiddenLinearFunction.mcrz(lam, q_controls, q_target, use_basis_gates=False)`
...
`HiddenLinearFunction.mcx(control_qubits, target_qubit, ancilla_qubits=None, mode='noancilla')`
...
`HiddenLinearFunction.measure_active(inplace=True)`
...
`HiddenLinearFunction.measure_all(inplace=True)`
...
`HiddenLinearFunction.num_connected_components(unitary_only=False)`
...
`HiddenLinearFunction.qasm(formatted=False, filename=None)`
...
`HiddenLinearFunction.qbit_argument_conversion(qubit_representation)`
...
`HiddenLinearFunction.rcccx(control_qubit1, control_qubit2, control_qubit3, target_qubit)`
...
`HiddenLinearFunction.rccx(control_qubit1, control_qubit2, target_qubit)`
...
`HiddenLinearFunction.remove_final_measurements(inplace=True)`
...
`HiddenLinearFunction.rx(theta, qubit, *, label=None, q=None)`
...
`HiddenLinearFunction.ry(theta, qubit, *, label=None, q=None)`
...
`HiddenLinearFunction.rz(phi, qubit, *, q=None)`
...
`HiddenLinearFunction.snapshot(label, snapshot_type='statevector', qubits=None, params=None)`
...
`HiddenLinearFunction.snapshot_density_matrix(label, qubits=None)`
...
`HiddenLinearFunction.snapshot_probabilities(label, qubits, variance=False)`
...
`HiddenLinearFunction.squ(unitary_matrix, qubit, mode='ZYZ', up_to_diagonal=False, *, u=None)`
...
`HiddenLinearFunction.tdg(qubit, *, q=None)`
...
`HiddenLinearFunction.to_gate(parameter_map=None)`
...
`HiddenLinearFunction.to_instruction(parameter_map=None)`
...
`HiddenLinearFunction.toffoli(control_qubit1, control_qubit2, target_qubit, *, ctl1=None, ctl2=None, tgt=None)`
...
`HiddenLinearFunction.u2(phi, lam, qubit, *, q=None)`
...
`HiddenLinearFunction.u3(theta, phi, lam, qubit, *, q=None)`
...
`HiddenLinearFunction.uc(gate_list, q_controls, q_target, up_to_diagonal=False)`
...
`HiddenLinearFunction.ucrx(angle_list, q_controls, q_target)`
...
`HiddenLinearFunction.ucry(angle_list, q_controls, q_target)`
...
`HiddenLinearFunction.ucrz(angle_list, q_controls, q_target)`
...
`HiddenLinearFunction.x(qubit, *, label=None, ctrl_state=None, q=None)`
