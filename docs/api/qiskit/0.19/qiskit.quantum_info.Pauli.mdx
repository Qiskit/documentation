...
<Class id="qiskit.quantum_info.Pauli" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.14/qiskit/quantum_info/operators/pauli.py" signature="Pauli(z=None, x=None, label=None)">
  ...
  *   **label** (*str*) – pauli label
  ...
  <Attribute id="qiskit.quantum_info.Pauli.numberofqubits" name="numberofqubits">
  ...
  <Function id="qiskit.quantum_info.Pauli.__len__" name="__len__" signature="Pauli.__len__()">
    Return number of qubits.
  </Function>

  ### \_\_mul\_\_

  <Function id="qiskit.quantum_info.Pauli.__mul__" name="__mul__" signature="Pauli.__mul__(other)">
    Multiply two Paulis.
  ...
  <Function id="qiskit.quantum_info.Pauli.from_label" name="from_label" signature="classmethod Pauli.from_label(label)">
  ...
  <Function id="qiskit.quantum_info.Pauli.sgn_prod" name="sgn_prod" signature="static Pauli.sgn_prod(p1, p2)">
  ...
  <Function id="qiskit.quantum_info.Pauli.to_matrix" name="to_matrix" signature="Pauli.to_matrix()">
  ...
  <Function id="qiskit.quantum_info.Pauli.to_operator" name="to_operator" signature="Pauli.to_operator()">
