...
<Function id="qiskit.visualization.iplot_state_city" name="iplot_state_city" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.14/qiskit/visualization/interactive/iplot_cities.py" signature="iplot_state_city(rho, figsize=None)">
