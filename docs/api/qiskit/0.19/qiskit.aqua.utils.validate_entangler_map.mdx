---
title: validate_entangler_map (v0.19)
description: API reference for qiskit.aqua.utils.validate_entangler_map in qiskit v0.19
in_page_toc_min_heading_level: 1
python_api_type: function
python_api_name: qiskit.aqua.utils.validate_entangler_map
---

<span id="validate-entangler-map" />

# validate\_entangler\_map

<Function id="qiskit.aqua.utils.validate_entangler_map" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.7/qiskit/aqua/utils/entangler_map.py" signature="validate_entangler_map(entangler_map, num_qubits, allow_double_entanglement=False)">
