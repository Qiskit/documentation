...
<Function id="qiskit.providers.aer.noise.device.gate_param_values" github="https://github.com/qiskit/qiskit-aer/tree/stable/0.5/qiskit/providers/aer/noise/device/parameters.py" signature="gate_param_values(properties)">
