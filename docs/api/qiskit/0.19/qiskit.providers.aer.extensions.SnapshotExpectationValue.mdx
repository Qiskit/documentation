---
title: SnapshotExpectationValue (v0.19)
description: API reference for qiskit.providers.aer.extensions.SnapshotExpectationValue in qiskit v0.19
...
<Class id="qiskit.providers.aer.extensions.SnapshotExpectationValue" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-aer/tree/stable/0.5/qiskit/providers/aer/extensions/snapshot_expectation_value.py" signature="SnapshotExpectationValue(label, op, single_shot=False, variance=False)" modifiers="class">
  ...
  **ExtensionError** – if snapshot is invalid.
  ...
  <span id="snapshotexpectationvalue-decompositions" />
  ...
  <span id="snapshotexpectationvalue-definition" />
  ...
  <span id="snapshotexpectationvalue-label" />
  ...
  <span id="snapshotexpectationvalue-params" />
  ...
  <span id="snapshotexpectationvalue-snapshot-type" />
  ...
  <span id="snapshotexpectationvalue-add-decomposition" />
  ...
  <span id="snapshotexpectationvalue-assemble" />
  ...
  <span id="snapshotexpectationvalue-broadcast-arguments" />
  ...
  <span id="snapshotexpectationvalue-c-if" />
  ...
  <span id="snapshotexpectationvalue-copy" />
  ...
  <span id="snapshotexpectationvalue-define-snapshot-register" />
  ...
  <span id="snapshotexpectationvalue-inverse" />
  ...
  <span id="snapshotexpectationvalue-is-parameterized" />
  ...
  <span id="snapshotexpectationvalue-mirror" />
  ...
  <span id="snapshotexpectationvalue-qasm" />
  ...
  <span id="snapshotexpectationvalue-repeat" />
