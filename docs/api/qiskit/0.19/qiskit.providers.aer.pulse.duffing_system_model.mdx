---
title: duffing_system_model (v0.19)
description: API reference for qiskit.providers.aer.pulse.duffing_system_model in qiskit v0.19
in_page_toc_min_heading_level: 1
python_api_type: function
python_api_name: qiskit.providers.aer.pulse.duffing_system_model
---

<span id="duffing-system-model" />
