...
<Class id="qiskit.optimization.problems.LinearExpression" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.7/qiskit/optimization/problems/linear_expression.py" signature="LinearExpression(quadratic_program, coefficients)">
  ...
  *   **coefficients** (`Union`\[`ndarray`, `spmatrix`, `List`\[`float`], `Dict`\[`Union`\[`int`, `str`], `float`]]) – The (sparse) representation of the coefficients.
  ...
  <Attribute id="qiskit.optimization.problems.LinearExpression.coefficients" name="coefficients" signature="scipy.sparse.dok.dok_matrix">
  ...
  <Attribute id="qiskit.optimization.problems.LinearExpression.quadratic_program" name="quadratic_program" signature="Any">
  ...
  <Function id="qiskit.optimization.problems.LinearExpression.__getitem__" name="__getitem__" signature="LinearExpression.__getitem__(i)">
  ...
  <Function id="qiskit.optimization.problems.LinearExpression.evaluate" name="evaluate" signature="LinearExpression.evaluate(x)">
  ...
  <Function id="qiskit.optimization.problems.LinearExpression.to_array" name="to_array" signature="LinearExpression.to_array()">
  ...
  <Function id="qiskit.optimization.problems.LinearExpression.to_dict" name="to_dict" signature="LinearExpression.to_dict(use_name=False)">
