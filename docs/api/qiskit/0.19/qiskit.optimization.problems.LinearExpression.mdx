---
title: LinearExpression (v0.19)
description: API reference for qiskit.optimization.problems.LinearExpression in qiskit v0.19
...
<Class id="qiskit.optimization.problems.LinearExpression" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.7/qiskit/optimization/problems/linear_expression.py" signature="LinearExpression(quadratic_program, coefficients)" modifiers="class">
  ...
  *   **coefficients** (`Union`\[`ndarray`, `spmatrix`, `List`\[`float`], `Dict`\[`Union`\[`int`, `str`], `float`]]) – The (sparse) representation of the coefficients.
  ...
  <span id="linearexpression-coefficients" />
  ...
  <span id="linearexpression-quadratic-program" />
  ...
  <span id="linearexpression-getitem" />
  ...
  <span id="linearexpression-evaluate" />
  ...
  <span id="linearexpression-to-array" />
  ...
  <span id="linearexpression-to-dict" />
