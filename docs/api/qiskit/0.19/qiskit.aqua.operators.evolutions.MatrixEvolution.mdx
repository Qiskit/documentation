---
title: MatrixEvolution (v0.19)
description: API reference for qiskit.aqua.operators.evolutions.MatrixEvolution in qiskit v0.19
...
<Class id="qiskit.aqua.operators.evolutions.MatrixEvolution" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.7/qiskit/aqua/operators/evolutions/matrix_evolution.py" signature="MatrixEvolution" modifiers="class">
  ...
  <span id="matrixevolution-convert" />
