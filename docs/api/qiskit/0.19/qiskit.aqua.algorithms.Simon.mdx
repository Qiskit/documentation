...
<Class id="qiskit.aqua.algorithms.Simon" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.7/qiskit/aqua/algorithms/education/simon.py" signature="Simon(oracle, quantum_instance=None)">
  The Simon algorithm.
  ...
  *   **quantum\_instance** (`Union`\[[`QuantumInstance`](qiskit.aqua.QuantumInstance "qiskit.aqua.quantum_instance.QuantumInstance"), [`BaseBackend`](qiskit.providers.BaseBackend "qiskit.providers.basebackend.BaseBackend"), `None`]) – Quantum Instance or Backend
  ...
  <Attribute id="qiskit.aqua.algorithms.Simon.backend" name="backend" signature="qiskit.providers.basebackend.BaseBackend">
    Returns backend.
  ...
  <Attribute id="qiskit.aqua.algorithms.Simon.quantum_instance" name="quantum_instance" signature="Union[None, qiskit.aqua.quantum_instance.QuantumInstance]">
  ...
  <Function id="qiskit.aqua.algorithms.Simon.construct_circuit" name="construct_circuit" signature="Simon.construct_circuit(measurement=False)">
  ...
  <Function id="qiskit.aqua.algorithms.Simon.run" name="run" signature="Simon.run(quantum_instance=None, **kwargs)">
  ...
  <Function id="qiskit.aqua.algorithms.Simon.set_backend" name="set_backend" signature="Simon.set_backend(backend, **kwargs)">
