...
<Class id="qiskit.aqua.algorithms.Simon" github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.7/qiskit/aqua/algorithms/education/simon.py" signature="Simon(oracle, quantum_instance=None)">
  The Simon algorithm.
