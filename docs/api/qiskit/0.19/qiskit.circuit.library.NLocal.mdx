...
<Class id="qiskit.circuit.library.NLocal" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.14/qiskit/circuit/library/n_local/n_local.py" signature="NLocal(num_qubits=None, rotation_blocks=None, entanglement_blocks=None, entanglement=None, reps=1, insert_barriers=False, parameter_prefix='θ', overwrite_block_parameters=True, skip_final_rotation_layer=False, skip_unentangled_qubits=False, initial_state=None, name='nlocal')">
  ...
  *   **TypeError** – If an `initial_state` is specified but not of the correct type, `qiskit.aqua.components.initial_states.InitialState`.
  ...
  <Attribute id="qiskit.circuit.library.NLocal.entanglement" signature="Union[str, List[str], List[List[str]], List[int], List[List[int]], List[List[List[int]]], List[List[List[List[int]]]], Callable[[int], str], Callable[[int], List[List[int]]]]">
  ...
  <Attribute id="qiskit.circuit.library.NLocal.entanglement_blocks" signature="List[qiskit.circuit.instruction.Instruction]">
  ...
  <Attribute id="qiskit.circuit.library.NLocal.initial_state" signature="Any">
  ...
  <Attribute id="qiskit.circuit.library.NLocal.insert_barriers" signature="bool">
  ...
  <Attribute id="qiskit.circuit.library.NLocal.num_layers" signature="int">
  ...
  <Attribute id="qiskit.circuit.library.NLocal.num_parameters_settable" signature="int">
  ...
  <Attribute id="qiskit.circuit.library.NLocal.num_qubits" signature="int">
  ...
  <Attribute id="qiskit.circuit.library.NLocal.ordered_parameters" signature="List[qiskit.circuit.parameter.Parameter]">
  ...
  <Attribute id="qiskit.circuit.library.NLocal.parameter_bounds" signature="Optional[List[Tuple[float, float]]]">
  ...
  <Attribute id="qiskit.circuit.library.NLocal.parameters" signature="Set[qiskit.circuit.parameter.Parameter]">
  ...
  <Attribute id="qiskit.circuit.library.NLocal.preferred_init_points" signature="Optional[List[float]]">
  ...
  <Attribute id="qiskit.circuit.library.NLocal.reps" signature="int">
  ...
  <Attribute id="qiskit.circuit.library.NLocal.rotation_blocks" signature="List[qiskit.circuit.instruction.Instruction]">
  ...
  <Function id="qiskit.circuit.library.NLocal.cast" signature="static NLocal.cast(value, _type)">
  ...
  <Function id="qiskit.circuit.library.NLocal.cls_instances" signature="classmethod NLocal.cls_instances()">
    Return the current number of instances of this class, useful for auto naming.
  </Function>

  ### cls\_prefix

  <Function id="qiskit.circuit.library.NLocal.cls_prefix" signature="classmethod NLocal.cls_prefix()">
  ...
  <Function id="qiskit.circuit.library.NLocal.from_qasm_file" signature="static NLocal.from_qasm_file(path)">
  ...
  <Function id="qiskit.circuit.library.NLocal.from_qasm_str" signature="static NLocal.from_qasm_str(qasm_str)">
