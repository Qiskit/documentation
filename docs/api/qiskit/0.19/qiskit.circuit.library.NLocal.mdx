---
title: NLocal (v0.19)
description: API reference for qiskit.circuit.library.NLocal in qiskit v0.19
...
<Class id="qiskit.circuit.library.NLocal" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.14/qiskit/circuit/library/n_local/n_local.py" signature="NLocal(num_qubits=None, rotation_blocks=None, entanglement_blocks=None, entanglement=None, reps=1, insert_barriers=False, parameter_prefix='θ', overwrite_block_parameters=True, skip_final_rotation_layer=False, skip_unentangled_qubits=False, initial_state=None, name='nlocal')" modifiers="class">
  ...
  *   **TypeError** – If an `initial_state` is specified but not of the correct type, `qiskit.aqua.components.initial_states.InitialState`.
  ...
  <span id="nlocal-entanglement-blocks" />
  ...
  <span id="nlocal-insert-barriers" />
  ...
  <span id="nlocal-num-parameters-settable" />
  ...
  <span id="nlocal-ordered-parameters" />
  ...
  <span id="nlocal-parameter-bounds" />
  ...
  <span id="nlocal-preferred-init-points" />
  ...
  <span id="nlocal-rotation-blocks" />
  ...
  <span id="nlocal-assign-parameters" />
  ...
  <span id="nlocal-bind-parameters" />
  ...
  <span id="nlocal-cbit-argument-conversion" />
  ...
  <span id="nlocal-get-entangler-map" />
  ...
  <span id="nlocal-get-unentangled-qubits" />
  ...
  <span id="nlocal-num-connected-components" />
  ...
  <span id="nlocal-num-nonlocal-gates" />
  ...
  <span id="nlocal-num-tensor-factors" />
  ...
  <span id="nlocal-num-unitary-factors" />
  ...
  <span id="nlocal-qbit-argument-conversion" />
  ...
  <span id="nlocal-remove-final-measurements" />
  ...
  <span id="nlocal-snapshot-density-matrix" />
  ...
  <span id="nlocal-snapshot-expectation-value" />
  ...
  <span id="nlocal-snapshot-probabilities" />
  ...
  <span id="nlocal-snapshot-stabilizer" />
  ...
  <span id="nlocal-snapshot-statevector" />
