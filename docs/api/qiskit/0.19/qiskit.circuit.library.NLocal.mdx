...
<Class id="qiskit.circuit.library.NLocal" github="https://github.com/qiskit/qiskit/tree/stable/0.14/qiskit/circuit/library/n_local/n_local.py" signature="NLocal(num_qubits=None, rotation_blocks=None, entanglement_blocks=None, entanglement=None, reps=1, insert_barriers=False, parameter_prefix='θ', overwrite_block_parameters=True, skip_final_rotation_layer=False, skip_unentangled_qubits=False, initial_state=None, name='nlocal')">
  ...
  *   **TypeError** – If an `initial_state` is specified but not of the correct type, `qiskit.aqua.components.initial_states.InitialState`.
  ...
  <Attribute id="qiskit.circuit.library.NLocal.entanglement" name="entanglement" signature="Union[str, List[str], List[List[str]], List[int], List[List[int]], List[List[List[int]]], List[List[List[List[int]]]], Callable[[int], str], Callable[[int], List[List[int]]]]">
  ...
  <Attribute id="qiskit.circuit.library.NLocal.entanglement_blocks" name="entanglement_blocks" signature="List[qiskit.circuit.instruction.Instruction]">
  ...
  <Attribute id="qiskit.circuit.library.NLocal.extension_lib" signature="= 'include \&#x22;qelib1.inc\&#x22;;'" />

  ### header

  <Attribute id="qiskit.circuit.library.NLocal.header" signature="= 'OPENQASM 2.0;'" />

  ### initial\_state

  <Attribute id="qiskit.circuit.library.NLocal.initial_state" name="initial_state" signature="Any">
  ...
  <Attribute id="qiskit.circuit.library.NLocal.insert_barriers" name="insert_barriers" signature="bool">
  ...
  <Attribute id="qiskit.circuit.library.NLocal.instances" signature="= 8" />

  ### n\_qubits

  <Attribute id="qiskit.circuit.library.NLocal.n_qubits" name="n_qubits">
  ...
  <Attribute id="qiskit.circuit.library.NLocal.num_layers" name="num_layers" signature="int">
  ...
  <Attribute id="qiskit.circuit.library.NLocal.num_parameters_settable" name="num_parameters_settable" signature="int">
  ...
  <Attribute id="qiskit.circuit.library.NLocal.num_qubits" name="num_qubits" signature="int">
  ...
  <Attribute id="qiskit.circuit.library.NLocal.ordered_parameters" name="ordered_parameters" signature="List[qiskit.circuit.parameter.Parameter]">
  ...
  <Attribute id="qiskit.circuit.library.NLocal.parameter_bounds" name="parameter_bounds" signature="Optional[List[Tuple[float, float]]]">
  ...
  <Attribute id="qiskit.circuit.library.NLocal.parameters" name="parameters" signature="Set[qiskit.circuit.parameter.Parameter]">
  ...
  <Attribute id="qiskit.circuit.library.NLocal.preferred_init_points" name="preferred_init_points" signature="Optional[List[float]]">
  ...
  <Attribute id="qiskit.circuit.library.NLocal.prefix" signature="= 'circuit'" />
  ...
  <Attribute id="qiskit.circuit.library.NLocal.reps" name="reps" signature="int">
  ...
  <Attribute id="qiskit.circuit.library.NLocal.rotation_blocks" name="rotation_blocks" signature="List[qiskit.circuit.instruction.Instruction]">
  ...
  <Function id="qiskit.circuit.library.NLocal.AND" name="AND" signature="NLocal.AND(qr_variables, qb_target, qr_ancillae, flags=None, mct_mode='no-ancilla')">
  ...
  <Function id="qiskit.circuit.library.NLocal.OR" name="OR" signature="NLocal.OR(qr_variables, qb_target, qr_ancillae, flags=None, mct_mode='basic')">
  ...
  <Function id="qiskit.circuit.library.NLocal.__getitem__" name="__getitem__" signature="NLocal.__getitem__(item)">
    Return indexed operation.
  </Function>

  ### \_\_len\_\_

  <Function id="qiskit.circuit.library.NLocal.__len__" name="__len__" signature="NLocal.__len__()">
  ...
  <Function id="qiskit.circuit.library.NLocal.add_register" name="add_register" signature="NLocal.add_register(*regs)">
    Add registers.
  </Function>

  ### append

  <Function id="qiskit.circuit.library.NLocal.append" name="append" signature="NLocal.append(instruction, qargs=None, cargs=None)">
  ...
  <Function id="qiskit.circuit.library.NLocal.assign_parameters" name="assign_parameters" signature="NLocal.assign_parameters(param_dict, inplace=False)">
  ...
  <Function id="qiskit.circuit.library.NLocal.barrier" name="barrier" signature="NLocal.barrier(*qargs)">
    Apply `Barrier`. If qargs is None, applies to all.
  </Function>

  ### bind\_parameters

  <Function id="qiskit.circuit.library.NLocal.bind_parameters" name="bind_parameters" signature="NLocal.bind_parameters(value_dict)">
  ...
  <Function id="qiskit.circuit.library.NLocal.cast" name="cast" signature="static NLocal.cast(value, _type)">
    Best effort to cast value to type. Otherwise, returns the value.
  </Function>

  ### cbit\_argument\_conversion

  <Function id="qiskit.circuit.library.NLocal.cbit_argument_conversion" name="cbit_argument_conversion" signature="NLocal.cbit_argument_conversion(clbit_representation)">
  ...
  <Function id="qiskit.circuit.library.NLocal.ccx" name="ccx" signature="NLocal.ccx(control_qubit1, control_qubit2, target_qubit, *, ctl1=None, ctl2=None, tgt=None)">
    Apply [`CCXGate`](qiskit.circuit.library.CCXGate "qiskit.circuit.library.CCXGate").
  </Function>

  ### ch

  <Function id="qiskit.circuit.library.NLocal.ch" name="ch" signature="NLocal.ch(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CHGate`](qiskit.circuit.library.CHGate "qiskit.circuit.library.CHGate").
  </Function>

  ### cls\_instances

  <Function id="qiskit.circuit.library.NLocal.cls_instances" name="cls_instances" signature="classmethod NLocal.cls_instances()">
    Return the current number of instances of this class, useful for auto naming.
  </Function>

  ### cls\_prefix

  <Function id="qiskit.circuit.library.NLocal.cls_prefix" name="cls_prefix" signature="classmethod NLocal.cls_prefix()">
    Return the prefix to use for auto naming.
  </Function>

  ### cnot

  <Function id="qiskit.circuit.library.NLocal.cnot" name="cnot" signature="NLocal.cnot(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CXGate`](qiskit.circuit.library.CXGate "qiskit.circuit.library.CXGate").
  </Function>

  ### combine

  <Function id="qiskit.circuit.library.NLocal.combine" name="combine" signature="NLocal.combine(rhs)">
  ...
  <Function id="qiskit.circuit.library.NLocal.compose" name="compose" signature="NLocal.compose(other, qubits=None, clbits=None, front=False, inplace=False)">
  ...
  <Function id="qiskit.circuit.library.NLocal.copy" name="copy" signature="NLocal.copy(name=None)">
    Copy the circuit.
  ...
  <Function id="qiskit.circuit.library.NLocal.count_ops" name="count_ops" signature="NLocal.count_ops()">
  ...
  <Function id="qiskit.circuit.library.NLocal.crx" name="crx" signature="NLocal.crx(theta, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CRXGate`](qiskit.circuit.library.CRXGate "qiskit.circuit.library.CRXGate").
  </Function>

  ### cry

  <Function id="qiskit.circuit.library.NLocal.cry" name="cry" signature="NLocal.cry(theta, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CRYGate`](qiskit.circuit.library.CRYGate "qiskit.circuit.library.CRYGate").
  </Function>

  ### crz

  <Function id="qiskit.circuit.library.NLocal.crz" name="crz" signature="NLocal.crz(theta, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CRZGate`](qiskit.circuit.library.CRZGate "qiskit.circuit.library.CRZGate").
  </Function>

  ### cswap

  <Function id="qiskit.circuit.library.NLocal.cswap" name="cswap" signature="NLocal.cswap(control_qubit, target_qubit1, target_qubit2, *, label=None, ctrl_state=None, ctl=None, tgt1=None, tgt2=None)">
    Apply [`CSwapGate`](qiskit.circuit.library.CSwapGate "qiskit.circuit.library.CSwapGate").
  </Function>

  ### cu1

  <Function id="qiskit.circuit.library.NLocal.cu1" name="cu1" signature="NLocal.cu1(theta, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CU1Gate`](qiskit.circuit.library.CU1Gate "qiskit.circuit.library.CU1Gate").
  </Function>

  ### cu3

  <Function id="qiskit.circuit.library.NLocal.cu3" name="cu3" signature="NLocal.cu3(theta, phi, lam, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CU3Gate`](qiskit.circuit.library.CU3Gate "qiskit.circuit.library.CU3Gate").
  </Function>

  ### cx

  <Function id="qiskit.circuit.library.NLocal.cx" name="cx" signature="NLocal.cx(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CXGate`](qiskit.circuit.library.CXGate "qiskit.circuit.library.CXGate").
  </Function>

  ### cy

  <Function id="qiskit.circuit.library.NLocal.cy" name="cy" signature="NLocal.cy(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CYGate`](qiskit.circuit.library.CYGate "qiskit.circuit.library.CYGate").
  </Function>

  ### cz

  <Function id="qiskit.circuit.library.NLocal.cz" name="cz" signature="NLocal.cz(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CZGate`](qiskit.circuit.library.CZGate "qiskit.circuit.library.CZGate").
  </Function>

  ### dcx

  <Function id="qiskit.circuit.library.NLocal.dcx" name="dcx" signature="NLocal.dcx(qubit1, qubit2)">
    Apply [`DCXGate`](qiskit.circuit.library.DCXGate "qiskit.circuit.library.DCXGate").
  </Function>

  ### decompose

  <Function id="qiskit.circuit.library.NLocal.decompose" name="decompose" signature="NLocal.decompose()">
  ...
  <Function id="qiskit.circuit.library.NLocal.depth" name="depth" signature="NLocal.depth()">
  ...
  <Function id="qiskit.circuit.library.NLocal.diag_gate" name="diag_gate" signature="NLocal.diag_gate(diag, qubit)">
    Deprecated version of QuantumCircuit.diagonal.
  </Function>

  ### diagonal

  <Function id="qiskit.circuit.library.NLocal.diagonal" name="diagonal" signature="NLocal.diagonal(diag, qubit)">
  ...
  <Function id="qiskit.circuit.library.NLocal.extend" name="extend" signature="NLocal.extend(rhs)">
  ...
  <Function id="qiskit.circuit.library.NLocal.fredkin" name="fredkin" signature="NLocal.fredkin(control_qubit, target_qubit1, target_qubit2, *, ctl=None, tgt1=None, tgt2=None)">
    Apply [`CSwapGate`](qiskit.circuit.library.CSwapGate "qiskit.circuit.library.CSwapGate").
  </Function>

  ### from\_qasm\_file

  <Function id="qiskit.circuit.library.NLocal.from_qasm_file" name="from_qasm_file" signature="static NLocal.from_qasm_file(path)">
  ...
  <Function id="qiskit.circuit.library.NLocal.from_qasm_str" name="from_qasm_str" signature="static NLocal.from_qasm_str(qasm_str)">
  ...
  <Function id="qiskit.circuit.library.NLocal.h" name="h" signature="NLocal.h(qubit, *, q=None)">
    Apply [`HGate`](qiskit.circuit.library.HGate "qiskit.circuit.library.HGate").
  </Function>

  ### hamiltonian

  <Function id="qiskit.circuit.library.NLocal.hamiltonian" name="hamiltonian" signature="NLocal.hamiltonian(operator, time, qubits, label=None)">
    Apply hamiltonian evolution to to qubits.
  </Function>

  ### has\_register

  <Function id="qiskit.circuit.library.NLocal.has_register" name="has_register" signature="NLocal.has_register(register)">
  ...
  <Function id="qiskit.circuit.library.NLocal.i" name="i" signature="NLocal.i(qubit, *, q=None)">
    Apply [`IGate`](qiskit.circuit.library.IGate "qiskit.circuit.library.IGate").
  </Function>

  ### id

  <Function id="qiskit.circuit.library.NLocal.id" name="id" signature="NLocal.id(qubit, *, q=None)">
    Apply [`IGate`](qiskit.circuit.library.IGate "qiskit.circuit.library.IGate").
  </Function>

  ### iden

  <Function id="qiskit.circuit.library.NLocal.iden" name="iden" signature="NLocal.iden(qubit, *, q=None)">
    Deprecated identity gate.
  </Function>

  ### initialize

  <Function id="qiskit.circuit.library.NLocal.initialize" name="initialize" signature="NLocal.initialize(params, qubits)">
    Apply initialize to circuit.
  </Function>

  ### inverse

  <Function id="qiskit.circuit.library.NLocal.inverse" name="inverse" signature="NLocal.inverse()">
    Invert this circuit.
  ...
  <Function id="qiskit.circuit.library.NLocal.iso" name="iso" signature="NLocal.iso(isometry, q_input, q_ancillas_for_output, q_ancillas_zero=None, q_ancillas_dirty=None)">
  ...
  <Function id="qiskit.circuit.library.NLocal.isometry" name="isometry" signature="NLocal.isometry(isometry, q_input, q_ancillas_for_output, q_ancillas_zero=None, q_ancillas_dirty=None)">
    Attach an arbitrary isometry from m to n qubits to a circuit. In particular, this allows to attach arbitrary unitaries on n qubits (m=n) or to prepare any state on n qubits (m=0). The decomposition used here was introduced by Iten et al. in [https://arxiv.org/abs/1501.06911](https://arxiv.org/abs/1501.06911).
  ...
  <Function id="qiskit.circuit.library.NLocal.iswap" name="iswap" signature="NLocal.iswap(qubit1, qubit2)">
    Apply [`iSwapGate`](qiskit.circuit.library.iSwapGate "qiskit.circuit.library.iSwapGate").
  </Function>

  ### mcmt

  <Function id="qiskit.circuit.library.NLocal.mcmt" name="mcmt" signature="NLocal.mcmt(gate, control_qubits, target_qubits, ancilla_qubits=None, mode='no-ancilla', *, single_control_gate_fun=None, q_controls=None, q_ancillae=None, q_targets=None)">
  ...
  <Function id="qiskit.circuit.library.NLocal.mcrx" name="mcrx" signature="NLocal.mcrx(theta, q_controls, q_target, use_basis_gates=False)">
  ...
  <Function id="qiskit.circuit.library.NLocal.mcry" name="mcry" signature="NLocal.mcry(theta, q_controls, q_target, q_ancillae, mode='basic', use_basis_gates=False)">
  ...
  <Function id="qiskit.circuit.library.NLocal.mcrz" name="mcrz" signature="NLocal.mcrz(lam, q_controls, q_target, use_basis_gates=False)">
  ...
  <Function id="qiskit.circuit.library.NLocal.mct" name="mct" signature="NLocal.mct(control_qubits, target_qubit, ancilla_qubits=None, mode='noancilla')">
    Apply `MCXGate`.
  </Function>

  ### mcu1

  <Function id="qiskit.circuit.library.NLocal.mcu1" name="mcu1" signature="NLocal.mcu1(lam, control_qubits, target_qubit)">
    Apply `MCU1Gate`.
  </Function>

  ### mcx

  <Function id="qiskit.circuit.library.NLocal.mcx" name="mcx" signature="NLocal.mcx(control_qubits, target_qubit, ancilla_qubits=None, mode='noancilla')">
    Apply `MCXGate`.
  ...
  <Function id="qiskit.circuit.library.NLocal.measure" name="measure" signature="NLocal.measure(qubit, cbit)">
  ...
  <Function id="qiskit.circuit.library.NLocal.measure_active" name="measure_active" signature="NLocal.measure_active(inplace=True)">
  ...
  <Function id="qiskit.circuit.library.NLocal.measure_all" name="measure_all" signature="NLocal.measure_all(inplace=True)">
  ...
  <Function id="qiskit.circuit.library.NLocal.mirror" name="mirror" signature="NLocal.mirror()">
  ...
  <Function id="qiskit.circuit.library.NLocal.ms" name="ms" signature="NLocal.ms(theta, qubits)">
    Apply [`MSGate`](qiskit.circuit.library.MSGate "qiskit.circuit.library.MSGate").
  </Function>

  ### num\_connected\_components

  <Function id="qiskit.circuit.library.NLocal.num_connected_components" name="num_connected_components" signature="NLocal.num_connected_components(unitary_only=False)">
  ...
  <Function id="qiskit.circuit.library.NLocal.num_nonlocal_gates" name="num_nonlocal_gates" signature="NLocal.num_nonlocal_gates()">
  ...
  <Function id="qiskit.circuit.library.NLocal.num_tensor_factors" name="num_tensor_factors" signature="NLocal.num_tensor_factors()">
  ...
  <Function id="qiskit.circuit.library.NLocal.num_unitary_factors" name="num_unitary_factors" signature="NLocal.num_unitary_factors()">
    Computes the number of tensor factors in the unitary (quantum) part of the circuit only.
  </Function>
  ...
  <Function id="qiskit.circuit.library.NLocal.qasm" name="qasm" signature="NLocal.qasm(formatted=False, filename=None)">
  ...
  <Function id="qiskit.circuit.library.NLocal.qbit_argument_conversion" name="qbit_argument_conversion" signature="NLocal.qbit_argument_conversion(qubit_representation)">
  ...
  <Function id="qiskit.circuit.library.NLocal.r" name="r" signature="NLocal.r(theta, phi, qubit, *, q=None)">
    Apply `RGate`.
  </Function>

  ### rcccx

  <Function id="qiskit.circuit.library.NLocal.rcccx" name="rcccx" signature="NLocal.rcccx(control_qubit1, control_qubit2, control_qubit3, target_qubit)">
    Apply [`RC3XGate`](qiskit.circuit.library.RC3XGate "qiskit.circuit.library.RC3XGate").
  </Function>

  ### rccx

  <Function id="qiskit.circuit.library.NLocal.rccx" name="rccx" signature="NLocal.rccx(control_qubit1, control_qubit2, target_qubit)">
    Apply [`RCCXGate`](qiskit.circuit.library.RCCXGate "qiskit.circuit.library.RCCXGate").
  </Function>

  ### remove\_final\_measurements

  <Function id="qiskit.circuit.library.NLocal.remove_final_measurements" name="remove_final_measurements" signature="NLocal.remove_final_measurements(inplace=True)">
  ...
  <Function id="qiskit.circuit.library.NLocal.reset" name="reset" signature="NLocal.reset(qubit)">
    Reset q.
  </Function>

  ### rx

  <Function id="qiskit.circuit.library.NLocal.rx" name="rx" signature="NLocal.rx(theta, qubit, *, label=None, q=None)">
    Apply [`RXGate`](qiskit.circuit.library.RXGate "qiskit.circuit.library.RXGate").
  </Function>

  ### rxx

  <Function id="qiskit.circuit.library.NLocal.rxx" name="rxx" signature="NLocal.rxx(theta, qubit1, qubit2)">
    Apply [`RXXGate`](qiskit.circuit.library.RXXGate "qiskit.circuit.library.RXXGate").
  </Function>

  ### ry

  <Function id="qiskit.circuit.library.NLocal.ry" name="ry" signature="NLocal.ry(theta, qubit, *, label=None, q=None)">
    Apply [`RYGate`](qiskit.circuit.library.RYGate "qiskit.circuit.library.RYGate").
  </Function>

  ### ryy

  <Function id="qiskit.circuit.library.NLocal.ryy" name="ryy" signature="NLocal.ryy(theta, qubit1, qubit2)">
    Apply [`RYYGate`](qiskit.circuit.library.RYYGate "qiskit.circuit.library.RYYGate").
  </Function>

  ### rz

  <Function id="qiskit.circuit.library.NLocal.rz" name="rz" signature="NLocal.rz(phi, qubit, *, q=None)">
    Apply [`RZGate`](qiskit.circuit.library.RZGate "qiskit.circuit.library.RZGate").
  </Function>

  ### rzx

  <Function id="qiskit.circuit.library.NLocal.rzx" name="rzx" signature="NLocal.rzx(theta, qubit1, qubit2)">
    Apply [`RZXGate`](qiskit.circuit.library.RZXGate "qiskit.circuit.library.RZXGate").
  </Function>

  ### rzz

  <Function id="qiskit.circuit.library.NLocal.rzz" name="rzz" signature="NLocal.rzz(theta, qubit1, qubit2)">
    Apply [`RZZGate`](qiskit.circuit.library.RZZGate "qiskit.circuit.library.RZZGate").
  </Function>

  ### s

  <Function id="qiskit.circuit.library.NLocal.s" name="s" signature="NLocal.s(qubit, *, q=None)">
    Apply [`SGate`](qiskit.circuit.library.SGate "qiskit.circuit.library.SGate").
  </Function>

  ### sdg

  <Function id="qiskit.circuit.library.NLocal.sdg" name="sdg" signature="NLocal.sdg(qubit, *, q=None)">
    Apply [`SdgGate`](qiskit.circuit.library.SdgGate "qiskit.circuit.library.SdgGate").
  </Function>

  ### size

  <Function id="qiskit.circuit.library.NLocal.size" name="size" signature="NLocal.size()">
  ...
  <Function id="qiskit.circuit.library.NLocal.snapshot" name="snapshot" signature="NLocal.snapshot(label, snapshot_type='statevector', qubits=None, params=None)">
  ...
  <Function id="qiskit.circuit.library.NLocal.snapshot_density_matrix" name="snapshot_density_matrix" signature="NLocal.snapshot_density_matrix(label, qubits=None)">
  ...
  <Function id="qiskit.circuit.library.NLocal.snapshot_expectation_value" name="snapshot_expectation_value" signature="NLocal.snapshot_expectation_value(label, op, qubits, single_shot=False, variance=False)">
  ...
  <Function id="qiskit.circuit.library.NLocal.snapshot_probabilities" name="snapshot_probabilities" signature="NLocal.snapshot_probabilities(label, qubits, variance=False)">
  ...
  <Function id="qiskit.circuit.library.NLocal.snapshot_stabilizer" name="snapshot_stabilizer" signature="NLocal.snapshot_stabilizer(label)">
  ...
  <Function id="qiskit.circuit.library.NLocal.snapshot_statevector" name="snapshot_statevector" signature="NLocal.snapshot_statevector(label)">
  ...
  <Function id="qiskit.circuit.library.NLocal.squ" name="squ" signature="NLocal.squ(unitary_matrix, qubit, mode='ZYZ', up_to_diagonal=False, *, u=None)">
  ...
  <Function id="qiskit.circuit.library.NLocal.swap" name="swap" signature="NLocal.swap(qubit1, qubit2)">
    Apply [`SwapGate`](qiskit.circuit.library.SwapGate "qiskit.circuit.library.SwapGate").
  </Function>

  ### t

  <Function id="qiskit.circuit.library.NLocal.t" name="t" signature="NLocal.t(qubit, *, q=None)">
    Apply [`TGate`](qiskit.circuit.library.TGate "qiskit.circuit.library.TGate").
  </Function>

  ### tdg

  <Function id="qiskit.circuit.library.NLocal.tdg" name="tdg" signature="NLocal.tdg(qubit, *, q=None)">
    Apply [`TdgGate`](qiskit.circuit.library.TdgGate "qiskit.circuit.library.TdgGate").
  </Function>

  ### to\_gate

  <Function id="qiskit.circuit.library.NLocal.to_gate" name="to_gate" signature="NLocal.to_gate(parameter_map=None)">
  ...
  <Function id="qiskit.circuit.library.NLocal.to_instruction" name="to_instruction" signature="NLocal.to_instruction(parameter_map=None)">
  ...
  <Function id="qiskit.circuit.library.NLocal.toffoli" name="toffoli" signature="NLocal.toffoli(control_qubit1, control_qubit2, target_qubit, *, ctl1=None, ctl2=None, tgt=None)">
    Apply [`CCXGate`](qiskit.circuit.library.CCXGate "qiskit.circuit.library.CCXGate").
  </Function>

  ### u1

  <Function id="qiskit.circuit.library.NLocal.u1" name="u1" signature="NLocal.u1(theta, qubit, *, q=None)">
    Apply [`U1Gate`](qiskit.circuit.library.U1Gate "qiskit.circuit.library.U1Gate").
  </Function>

  ### u2

  <Function id="qiskit.circuit.library.NLocal.u2" name="u2" signature="NLocal.u2(phi, lam, qubit, *, q=None)">
    Apply [`U2Gate`](qiskit.circuit.library.U2Gate "qiskit.circuit.library.U2Gate").
  </Function>

  ### u3

  <Function id="qiskit.circuit.library.NLocal.u3" name="u3" signature="NLocal.u3(theta, phi, lam, qubit, *, q=None)">
    Apply [`U3Gate`](qiskit.circuit.library.U3Gate "qiskit.circuit.library.U3Gate").
  </Function>

  ### uc

  <Function id="qiskit.circuit.library.NLocal.uc" name="uc" signature="NLocal.uc(gate_list, q_controls, q_target, up_to_diagonal=False)">
  ...
  <Function id="qiskit.circuit.library.NLocal.ucg" name="ucg" signature="NLocal.ucg(angle_list, q_controls, q_target, up_to_diagonal=False)">
    Deprecated version of uc.
  </Function>

  ### ucrx

  <Function id="qiskit.circuit.library.NLocal.ucrx" name="ucrx" signature="NLocal.ucrx(angle_list, q_controls, q_target)">
  ...
  <Function id="qiskit.circuit.library.NLocal.ucry" name="ucry" signature="NLocal.ucry(angle_list, q_controls, q_target)">
  ...
  <Function id="qiskit.circuit.library.NLocal.ucrz" name="ucrz" signature="NLocal.ucrz(angle_list, q_controls, q_target)">
  ...
  <Function id="qiskit.circuit.library.NLocal.ucx" name="ucx" signature="NLocal.ucx(angle_list, q_controls, q_target)">
    Deprecated version of ucrx.
  </Function>

  ### ucy

  <Function id="qiskit.circuit.library.NLocal.ucy" name="ucy" signature="NLocal.ucy(angle_list, q_controls, q_target)">
    Deprecated version of ucry.
  </Function>

  ### ucz

  <Function id="qiskit.circuit.library.NLocal.ucz" name="ucz" signature="NLocal.ucz(angle_list, q_controls, q_target)">
    Deprecated version of ucrz.
  </Function>

  ### unitary

  <Function id="qiskit.circuit.library.NLocal.unitary" name="unitary" signature="NLocal.unitary(obj, qubits, label=None)">
    Apply unitary gate to q.
  </Function>

  ### width

  <Function id="qiskit.circuit.library.NLocal.width" name="width" signature="NLocal.width()">
  ...
  <Function id="qiskit.circuit.library.NLocal.x" name="x" signature="NLocal.x(qubit, *, label=None, ctrl_state=None, q=None)">
    Apply [`XGate`](qiskit.circuit.library.XGate "qiskit.circuit.library.XGate").
  </Function>

  ### y

  <Function id="qiskit.circuit.library.NLocal.y" name="y" signature="NLocal.y(qubit, *, q=None)">
    Apply [`YGate`](qiskit.circuit.library.YGate "qiskit.circuit.library.YGate").
  </Function>

  ### z

  <Function id="qiskit.circuit.library.NLocal.z" name="z" signature="NLocal.z(qubit, *, q=None)">
