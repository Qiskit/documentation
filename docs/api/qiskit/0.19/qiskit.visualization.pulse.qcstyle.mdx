...
<Class id="qiskit.visualization.pulse.qcstyle.PulseStyle" github="https://github.com/qiskit/qiskit/tree/stable/0.14/qiskit/visualization/pulse/qcstyle.py" signature="PulseStyle(figsize=(7, 5), title_font_size=18, wave_color=None, bg_color=None, num_points=None, dpi=None)">
