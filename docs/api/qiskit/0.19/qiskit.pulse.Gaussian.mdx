...
$$
  ...
  *   **name** (`Optional`\[`str`]) – Display name for this pulse envelope.
  ...
  <Attribute id="qiskit.pulse.Gaussian.amp" name="amp" signature="complex">
  ...
  <Attribute id="qiskit.pulse.Gaussian.id" name="id" signature="int">
  ...
  <Attribute id="qiskit.pulse.Gaussian.parameters" name="parameters" signature="Dict[str, Any]">
  ...
  <Attribute id="qiskit.pulse.Gaussian.sigma" name="sigma" signature="float">
  ...
  <Function id="qiskit.pulse.Gaussian.__call__" name="__call__" signature="Gaussian.__call__(channel)">
    Call self as a function.
  </Function>

  ### draw

  <Function id="qiskit.pulse.Gaussian.draw" name="draw" signature="Gaussian.draw(dt=1, style=None, filename=None, interp_method=None, scale=1, interactive=False, scaling=None)">
    Plot the pulse.
  ...
  <Function id="qiskit.pulse.Gaussian.get_sample_pulse" name="get_sample_pulse" signature="Gaussian.get_sample_pulse()">
