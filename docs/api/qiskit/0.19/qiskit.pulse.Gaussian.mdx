...
$$
  ...
  *   **name** (`Optional`\[`str`]) – Display name for this pulse envelope.
  ...
  <Attribute id="qiskit.pulse.Gaussian.amp" signature="complex">
  ...
  <Attribute id="qiskit.pulse.Gaussian.id" signature="int">
  ...
  <Attribute id="qiskit.pulse.Gaussian.parameters" signature="Dict[str, Any]">
  ...
  <Attribute id="qiskit.pulse.Gaussian.sigma" signature="float">
