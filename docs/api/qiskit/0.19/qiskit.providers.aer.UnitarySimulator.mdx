...
<Class id="qiskit.providers.aer.UnitarySimulator" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-aer/tree/stable/0.5/qiskit/providers/aer/backends/unitary_simulator.py" signature="UnitarySimulator(configuration=None, provider=None)">
  ...
  *   [**AerError**](qiskit.providers.aer.AerError "qiskit.providers.aer.AerError") – if there is no name in the configuration
  ...
  <Function id="qiskit.providers.aer.UnitarySimulator.run" name="run" signature="UnitarySimulator.run(qobj, backend_options=None, noise_model=None, validate=False)">
  ...
  <Function id="qiskit.providers.aer.UnitarySimulator.version" name="version" signature="UnitarySimulator.version()">
