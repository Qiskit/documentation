...
<Class id="qiskit.providers.aer.UnitarySimulator" github="https://github.com/qiskit/qiskit-aer/tree/stable/0.5/qiskit/providers/aer/backends/unitary_simulator.py" signature="UnitarySimulator(configuration=None, provider=None)">
