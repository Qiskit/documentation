---
title: TruthTableOracle (v0.19)
description: API reference for qiskit.aqua.components.oracles.TruthTableOracle in qiskit v0.19
...
<Class id="qiskit.aqua.components.oracles.TruthTableOracle" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.7/qiskit/aqua/components/oracles/truth_table_oracle.py" signature="TruthTableOracle(bitmaps, optimization=False, mct_mode='basic')" modifiers="class">
  ...
  **Raises**
  ...
  <span id="truthtableoracle-ancillary-register" />
  ...
  <span id="truthtableoracle-circuit" />

  ### circuit

  <Attribute id="qiskit.aqua.components.oracles.TruthTableOracle.circuit" />

  <span id="truthtableoracle-output-register" />
  ...
  <span id="truthtableoracle-variable-register" />
  ...
  <span id="truthtableoracle-construct-circuit" />
  ...
  <span id="truthtableoracle-evaluate-classically" />
