...
<Class id="qiskit.aqua.components.oracles.TruthTableOracle" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.7/qiskit/aqua/components/oracles/truth_table_oracle.py" signature="TruthTableOracle(bitmaps, optimization=False, mct_mode='basic')">
  ...
  **Raises**
  ...
  <Attribute id="qiskit.aqua.components.oracles.TruthTableOracle.ancillary_register" name="ancillary_register">
    returns ancillary register
  </Attribute>

  ### circuit

  <Attribute id="qiskit.aqua.components.oracles.TruthTableOracle.circuit" name="circuit" />

  ### output\_register

  <Attribute id="qiskit.aqua.components.oracles.TruthTableOracle.output_register" name="output_register">
    returns output register
  </Attribute>

  ### variable\_register

  <Attribute id="qiskit.aqua.components.oracles.TruthTableOracle.variable_register" name="variable_register">
  ...
  <Function id="qiskit.aqua.components.oracles.TruthTableOracle.construct_circuit" name="construct_circuit" signature="TruthTableOracle.construct_circuit()">
    construct circuit
  </Function>

  ### evaluate\_classically

  <Function id="qiskit.aqua.components.oracles.TruthTableOracle.evaluate_classically" name="evaluate_classically" signature="TruthTableOracle.evaluate_classically(measurement)">
    evaluate classical
  </Function>
</Class>
