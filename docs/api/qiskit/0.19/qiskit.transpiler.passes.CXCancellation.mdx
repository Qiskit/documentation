...
<Class id="qiskit.transpiler.passes.CXCancellation" github="https://github.com/qiskit/qiskit/tree/stable/0.14/qiskit/transpiler/passes/optimization/cx_cancellation.py" signature="CXCancellation(*args, **kwargs)">
