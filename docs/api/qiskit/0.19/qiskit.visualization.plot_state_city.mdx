---
title: plot_state_city (v0.19)
description: API reference for qiskit.visualization.plot_state_city in qiskit v0.19
in_page_toc_min_heading_level: 1
python_api_type: function
python_api_name: qiskit.visualization.plot_state_city
---

<span id="plot-state-city" />

# plot\_state\_city

<Function id="qiskit.visualization.plot_state_city" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.14/qiskit/visualization/state_visualization.py" signature="plot_state_city(rho, title='', figsize=None, color=None, alpha=1, ax_real=None, ax_imag=None)">
  ...
  **Example**
  ...
  ![../\_images/qiskit.visualization.plot\_state\_city\_0\_2.png](/docs/images/api/qiskit/0.19/qiskit.visualization.plot_state_city_0_2.avif) ![../\_images/qiskit.visualization.plot\_state\_city\_0\_3.png](/docs/images/api/qiskit/0.19/qiskit.visualization.plot_state_city_0_3.avif)
</Function>
