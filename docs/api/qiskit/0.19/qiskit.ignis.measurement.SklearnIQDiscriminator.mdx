...
<Class id="qiskit.ignis.measurement.SklearnIQDiscriminator" github="https://github.com/qiskit-community/qiskit-ignis/tree/stable/0.3/qiskit/ignis/measurement/discriminator/iq_discriminators.py" signature="SklearnIQDiscriminator(classifier, cal_results, qubit_mask, expected_states=None, standardize=False, schedules=None)">
  ...
  *   **schedules** (*Union\[List\[str], List\[*[*Schedule*](qiskit.pulse.Schedule "qiskit.pulse.Schedule")*]]*) – The schedules or a subset of schedules in cal\_results used to train the discriminator. The user may also pass the name of the schedules instead of the schedules. If schedules is None, then all the schedules in cal\_results are used.
  ...
  <Attribute id="qiskit.ignis.measurement.SklearnIQDiscriminator.expected_states" name="expected_states">
    Returns the expected states used to train the discriminator.
  </Attribute>

  ### fitted

  <Attribute id="qiskit.ignis.measurement.SklearnIQDiscriminator.fitted" name="fitted">
    True if the discriminator has been fitted to calibration data.
  </Attribute>

  ### schedules

  <Attribute id="qiskit.ignis.measurement.SklearnIQDiscriminator.schedules" name="schedules">
  ...
  <Function id="qiskit.ignis.measurement.SklearnIQDiscriminator.add_data" name="add_data" signature="SklearnIQDiscriminator.add_data(result, expected_states, refit=True, schedules=None)">
    **Parameters**
  ...
  <Function id="qiskit.ignis.measurement.SklearnIQDiscriminator.discriminate" name="discriminate" signature="SklearnIQDiscriminator.discriminate(x_data)">
  ...
  <Function id="qiskit.ignis.measurement.SklearnIQDiscriminator.fit" name="fit" signature="SklearnIQDiscriminator.fit()">
    Fits the discriminator using self.\_xdata and self.\_ydata.
  </Function>

  ### format\_iq\_data

  <Function id="qiskit.ignis.measurement.SklearnIQDiscriminator.format_iq_data" name="format_iq_data" signature="SklearnIQDiscriminator.format_iq_data(iq_data)">
  ...
  <Function id="qiskit.ignis.measurement.SklearnIQDiscriminator.get_xdata" name="get_xdata" signature="SklearnIQDiscriminator.get_xdata(results, schedule_type_to_get, schedules=None)">
  ...
  <Function id="qiskit.ignis.measurement.SklearnIQDiscriminator.get_ydata" name="get_ydata" signature="SklearnIQDiscriminator.get_ydata(results, schedule_type_to_get, schedules=None)">
  ...
  <Function id="qiskit.ignis.measurement.SklearnIQDiscriminator.is_calibration" name="is_calibration" signature="SklearnIQDiscriminator.is_calibration(result_name)">
  ...
  <Function id="qiskit.ignis.measurement.SklearnIQDiscriminator.plot" name="plot" signature="SklearnIQDiscriminator.plot(axs=None, show_boundary=False, show_fitting_data=True, flag_misclassified=False, qubits_to_plot=None, title=True)">
  ...
  <Function id="qiskit.ignis.measurement.SklearnIQDiscriminator.plot_xdata" name="plot_xdata" signature="SklearnIQDiscriminator.plot_xdata(axs, results, color=None)">
