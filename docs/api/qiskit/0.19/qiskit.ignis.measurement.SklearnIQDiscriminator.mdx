---
title: SklearnIQDiscriminator (v0.19)
description: API reference for qiskit.ignis.measurement.SklearnIQDiscriminator in qiskit v0.19
...
<Class id="qiskit.ignis.measurement.SklearnIQDiscriminator" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-ignis/tree/stable/0.3/qiskit/ignis/measurement/discriminator/iq_discriminators.py" signature="SklearnIQDiscriminator(classifier, cal_results, qubit_mask, expected_states=None, standardize=False, schedules=None)" modifiers="class">
  ...
  *   **schedules** (*Union\[List\[str], List\[*[*Schedule*](qiskit.pulse.Schedule "qiskit.pulse.Schedule")*]]*) – The schedules or a subset of schedules in cal\_results used to train the discriminator. The user may also pass the name of the schedules instead of the schedules. If schedules is None, then all the schedules in cal\_results are used.
  ...
  <span id="sklearniqdiscriminator-expected-states" />
  ...
  <span id="sklearniqdiscriminator-fitted" />
  ...
  <span id="sklearniqdiscriminator-schedules" />
  ...
  <span id="sklearniqdiscriminator-add-data" />
  ...
  <span id="sklearniqdiscriminator-discriminate" />
  ...
  <span id="sklearniqdiscriminator-fit" />
  ...
  <span id="sklearniqdiscriminator-format-iq-data" />
  ...
  <span id="sklearniqdiscriminator-get-xdata" />
  ...
  <span id="sklearniqdiscriminator-get-ydata" />
  ...
  <span id="sklearniqdiscriminator-is-calibration" />
  ...
  <span id="sklearniqdiscriminator-plot" />
  ...
  <span id="sklearniqdiscriminator-plot-xdata" />
