...
`level_0_pass_manager(pass_manager_config)` [GitHub](https://github.com/qiskit/qiskit/tree/stable/0.14/qiskit/transpiler/preset_passmanagers/level0.py "view source code")
...
The pass manager then unrolls the circuit to the desired basis, and transforms the circuit to match the coupling map. Finally, extra resets are removed.
