...
<Class id="qiskit.quantum_info.TwoQubitBasisDecomposer" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.14/qiskit/quantum_info/synthesis/two_qubit_decompose.py" signature="TwoQubitBasisDecomposer(gate, basis_fidelity=1.0)">
  ...
  <Function id="qiskit.quantum_info.TwoQubitBasisDecomposer.__call__" name="__call__" signature="TwoQubitBasisDecomposer.__call__(target, basis_fidelity=None)">
