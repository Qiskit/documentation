---
title: TwoQubitBasisDecomposer (v0.19)
description: API reference for qiskit.quantum_info.TwoQubitBasisDecomposer in qiskit v0.19
...
<Class id="qiskit.quantum_info.TwoQubitBasisDecomposer" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.14/qiskit/quantum_info/synthesis/two_qubit_decompose.py" signature="TwoQubitBasisDecomposer(gate, basis_fidelity=1.0)" modifiers="class">
  A class for decomposing 2-qubit unitaries into minimal number of uses of a 2-qubit basis gate.

  ## Methods

  <span id="twoqubitbasisdecomposer-call" />

  ### \_\_call\_\_

  <Function id="qiskit.quantum_info.TwoQubitBasisDecomposer.__call__" signature="TwoQubitBasisDecomposer.__call__(target, basis_fidelity=None)">
  ...
  <span id="twoqubitbasisdecomposer-decomp0" />
  ...
  <span id="twoqubitbasisdecomposer-decomp1" />
  ...
  <span id="twoqubitbasisdecomposer-decomp2-supercontrolled" />
  ...
  <span id="twoqubitbasisdecomposer-decomp3-supercontrolled" />
  ...
  <span id="twoqubitbasisdecomposer-num-basis-gates" />
  ...
  <span id="twoqubitbasisdecomposer-traces" />
