...
$$
  ...
  **adjacency\_matrix** (`Union`\[`List`, `array`]) – input graph as n-by-n list of 0-1 lists
  ...
  <Function id="qiskit.circuit.library.GraphState.cast" signature="static GraphState.cast(value, _type)">
  ...
  <Function id="qiskit.circuit.library.GraphState.cls_instances" signature="classmethod GraphState.cls_instances()">
    Return the current number of instances of this class, useful for auto naming.
  </Function>

  ### cls\_prefix

  <Function id="qiskit.circuit.library.GraphState.cls_prefix" signature="classmethod GraphState.cls_prefix()">
  ...
  <Function id="qiskit.circuit.library.GraphState.from_qasm_file" signature="static GraphState.from_qasm_file(path)">
  ...
  <Function id="qiskit.circuit.library.GraphState.from_qasm_str" signature="static GraphState.from_qasm_str(qasm_str)">
