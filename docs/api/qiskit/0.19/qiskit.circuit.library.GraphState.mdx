...
<Class id="qiskit.circuit.library.GraphState" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.14/qiskit/circuit/library/graph_state.py" signature="GraphState(adjacency_matrix)">
...
$$
  ...
  **adjacency\_matrix** (`Union`\[`List`, `array`]) – input graph as n-by-n list of 0-1 lists
  ...
  <Attribute id="qiskit.circuit.library.GraphState.extension_lib" signature="= 'include \&#x22;qelib1.inc\&#x22;;'" />

  ### header

  <Attribute id="qiskit.circuit.library.GraphState.header" signature="= 'OPENQASM 2.0;'" />

  ### instances

  <Attribute id="qiskit.circuit.library.GraphState.instances" signature="= 8" />

  ### n\_qubits

  <Attribute id="qiskit.circuit.library.GraphState.n_qubits" name="n_qubits">
  ...
  <Attribute id="qiskit.circuit.library.GraphState.prefix" signature="= 'circuit'" />
  ...
  <Function id="qiskit.circuit.library.GraphState.AND" name="AND" signature="GraphState.AND(qr_variables, qb_target, qr_ancillae, flags=None, mct_mode='no-ancilla')">
  ...
  <Function id="qiskit.circuit.library.GraphState.OR" name="OR" signature="GraphState.OR(qr_variables, qb_target, qr_ancillae, flags=None, mct_mode='basic')">
  ...
  <Function id="qiskit.circuit.library.GraphState.__getitem__" name="__getitem__" signature="GraphState.__getitem__(item)">
    Return indexed operation.
  </Function>

  ### \_\_len\_\_

  <Function id="qiskit.circuit.library.GraphState.__len__" name="__len__" signature="GraphState.__len__()">
    Return number of operations in circuit.
  </Function>

  ### add\_register

  <Function id="qiskit.circuit.library.GraphState.add_register" name="add_register" signature="GraphState.add_register(*regs)">
    Add registers.
  </Function>

  ### append

  <Function id="qiskit.circuit.library.GraphState.append" name="append" signature="GraphState.append(instruction, qargs=None, cargs=None)">
  ...
  <Function id="qiskit.circuit.library.GraphState.assign_parameters" name="assign_parameters" signature="GraphState.assign_parameters(param_dict, inplace=False)">
  ...
  <Function id="qiskit.circuit.library.GraphState.barrier" name="barrier" signature="GraphState.barrier(*qargs)">
    Apply `Barrier`. If qargs is None, applies to all.
  </Function>

  ### bind\_parameters

  <Function id="qiskit.circuit.library.GraphState.bind_parameters" name="bind_parameters" signature="GraphState.bind_parameters(value_dict)">
  ...
  <Function id="qiskit.circuit.library.GraphState.cast" name="cast" signature="static GraphState.cast(value, _type)">
    Best effort to cast value to type. Otherwise, returns the value.
  </Function>

  ### cbit\_argument\_conversion

  <Function id="qiskit.circuit.library.GraphState.cbit_argument_conversion" name="cbit_argument_conversion" signature="GraphState.cbit_argument_conversion(clbit_representation)">
  ...
  <Function id="qiskit.circuit.library.GraphState.ccx" name="ccx" signature="GraphState.ccx(control_qubit1, control_qubit2, target_qubit, *, ctl1=None, ctl2=None, tgt=None)">
    Apply [`CCXGate`](qiskit.circuit.library.CCXGate "qiskit.circuit.library.CCXGate").
  </Function>

  ### ch

  <Function id="qiskit.circuit.library.GraphState.ch" name="ch" signature="GraphState.ch(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CHGate`](qiskit.circuit.library.CHGate "qiskit.circuit.library.CHGate").
  </Function>

  ### cls\_instances

  <Function id="qiskit.circuit.library.GraphState.cls_instances" name="cls_instances" signature="classmethod GraphState.cls_instances()">
    Return the current number of instances of this class, useful for auto naming.
  </Function>

  ### cls\_prefix

  <Function id="qiskit.circuit.library.GraphState.cls_prefix" name="cls_prefix" signature="classmethod GraphState.cls_prefix()">
    Return the prefix to use for auto naming.
  </Function>

  ### cnot

  <Function id="qiskit.circuit.library.GraphState.cnot" name="cnot" signature="GraphState.cnot(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CXGate`](qiskit.circuit.library.CXGate "qiskit.circuit.library.CXGate").
  </Function>

  ### combine

  <Function id="qiskit.circuit.library.GraphState.combine" name="combine" signature="GraphState.combine(rhs)">
  ...
  <Function id="qiskit.circuit.library.GraphState.compose" name="compose" signature="GraphState.compose(other, qubits=None, clbits=None, front=False, inplace=False)">
  ...
  <Function id="qiskit.circuit.library.GraphState.copy" name="copy" signature="GraphState.copy(name=None)">
    Copy the circuit.
  ...
  <Function id="qiskit.circuit.library.GraphState.count_ops" name="count_ops" signature="GraphState.count_ops()">
  ...
  <Function id="qiskit.circuit.library.GraphState.crx" name="crx" signature="GraphState.crx(theta, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CRXGate`](qiskit.circuit.library.CRXGate "qiskit.circuit.library.CRXGate").
  </Function>

  ### cry

  <Function id="qiskit.circuit.library.GraphState.cry" name="cry" signature="GraphState.cry(theta, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CRYGate`](qiskit.circuit.library.CRYGate "qiskit.circuit.library.CRYGate").
  </Function>

  ### crz

  <Function id="qiskit.circuit.library.GraphState.crz" name="crz" signature="GraphState.crz(theta, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CRZGate`](qiskit.circuit.library.CRZGate "qiskit.circuit.library.CRZGate").
  </Function>

  ### cswap

  <Function id="qiskit.circuit.library.GraphState.cswap" name="cswap" signature="GraphState.cswap(control_qubit, target_qubit1, target_qubit2, *, label=None, ctrl_state=None, ctl=None, tgt1=None, tgt2=None)">
    Apply [`CSwapGate`](qiskit.circuit.library.CSwapGate "qiskit.circuit.library.CSwapGate").
  </Function>

  ### cu1

  <Function id="qiskit.circuit.library.GraphState.cu1" name="cu1" signature="GraphState.cu1(theta, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CU1Gate`](qiskit.circuit.library.CU1Gate "qiskit.circuit.library.CU1Gate").
  </Function>

  ### cu3

  <Function id="qiskit.circuit.library.GraphState.cu3" name="cu3" signature="GraphState.cu3(theta, phi, lam, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CU3Gate`](qiskit.circuit.library.CU3Gate "qiskit.circuit.library.CU3Gate").
  </Function>

  ### cx

  <Function id="qiskit.circuit.library.GraphState.cx" name="cx" signature="GraphState.cx(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CXGate`](qiskit.circuit.library.CXGate "qiskit.circuit.library.CXGate").
  </Function>

  ### cy

  <Function id="qiskit.circuit.library.GraphState.cy" name="cy" signature="GraphState.cy(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CYGate`](qiskit.circuit.library.CYGate "qiskit.circuit.library.CYGate").
  </Function>

  ### cz

  <Function id="qiskit.circuit.library.GraphState.cz" name="cz" signature="GraphState.cz(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CZGate`](qiskit.circuit.library.CZGate "qiskit.circuit.library.CZGate").
  </Function>

  ### dcx

  <Function id="qiskit.circuit.library.GraphState.dcx" name="dcx" signature="GraphState.dcx(qubit1, qubit2)">
    Apply [`DCXGate`](qiskit.circuit.library.DCXGate "qiskit.circuit.library.DCXGate").
  </Function>

  ### decompose

  <Function id="qiskit.circuit.library.GraphState.decompose" name="decompose" signature="GraphState.decompose()">
  ...
  <Function id="qiskit.circuit.library.GraphState.depth" name="depth" signature="GraphState.depth()">
  ...
  <Function id="qiskit.circuit.library.GraphState.diag_gate" name="diag_gate" signature="GraphState.diag_gate(diag, qubit)">
    Deprecated version of QuantumCircuit.diagonal.
  </Function>

  ### diagonal

  <Function id="qiskit.circuit.library.GraphState.diagonal" name="diagonal" signature="GraphState.diagonal(diag, qubit)">
  ...
  <Function id="qiskit.circuit.library.GraphState.extend" name="extend" signature="GraphState.extend(rhs)">
  ...
  <Function id="qiskit.circuit.library.GraphState.fredkin" name="fredkin" signature="GraphState.fredkin(control_qubit, target_qubit1, target_qubit2, *, ctl=None, tgt1=None, tgt2=None)">
    Apply [`CSwapGate`](qiskit.circuit.library.CSwapGate "qiskit.circuit.library.CSwapGate").
  </Function>

  ### from\_qasm\_file

  <Function id="qiskit.circuit.library.GraphState.from_qasm_file" name="from_qasm_file" signature="static GraphState.from_qasm_file(path)">
  ...
  <Function id="qiskit.circuit.library.GraphState.from_qasm_str" name="from_qasm_str" signature="static GraphState.from_qasm_str(qasm_str)">
  ...
  <Function id="qiskit.circuit.library.GraphState.h" name="h" signature="GraphState.h(qubit, *, q=None)">
    Apply [`HGate`](qiskit.circuit.library.HGate "qiskit.circuit.library.HGate").
  </Function>

  ### hamiltonian

  <Function id="qiskit.circuit.library.GraphState.hamiltonian" name="hamiltonian" signature="GraphState.hamiltonian(operator, time, qubits, label=None)">
    Apply hamiltonian evolution to to qubits.
  </Function>

  ### has\_register

  <Function id="qiskit.circuit.library.GraphState.has_register" name="has_register" signature="GraphState.has_register(register)">
  ...
  <Function id="qiskit.circuit.library.GraphState.i" name="i" signature="GraphState.i(qubit, *, q=None)">
    Apply [`IGate`](qiskit.circuit.library.IGate "qiskit.circuit.library.IGate").
  </Function>

  ### id

  <Function id="qiskit.circuit.library.GraphState.id" name="id" signature="GraphState.id(qubit, *, q=None)">
    Apply [`IGate`](qiskit.circuit.library.IGate "qiskit.circuit.library.IGate").
  </Function>

  ### iden

  <Function id="qiskit.circuit.library.GraphState.iden" name="iden" signature="GraphState.iden(qubit, *, q=None)">
    Deprecated identity gate.
  </Function>

  ### initialize

  <Function id="qiskit.circuit.library.GraphState.initialize" name="initialize" signature="GraphState.initialize(params, qubits)">
    Apply initialize to circuit.
  </Function>

  ### inverse

  <Function id="qiskit.circuit.library.GraphState.inverse" name="inverse" signature="GraphState.inverse()">
    Invert this circuit.
  ...
  <Function id="qiskit.circuit.library.GraphState.iso" name="iso" signature="GraphState.iso(isometry, q_input, q_ancillas_for_output, q_ancillas_zero=None, q_ancillas_dirty=None)">
  ...
  <Function id="qiskit.circuit.library.GraphState.isometry" name="isometry" signature="GraphState.isometry(isometry, q_input, q_ancillas_for_output, q_ancillas_zero=None, q_ancillas_dirty=None)">
    Attach an arbitrary isometry from m to n qubits to a circuit. In particular, this allows to attach arbitrary unitaries on n qubits (m=n) or to prepare any state on n qubits (m=0). The decomposition used here was introduced by Iten et al. in [https://arxiv.org/abs/1501.06911](https://arxiv.org/abs/1501.06911).
  ...
  <Function id="qiskit.circuit.library.GraphState.iswap" name="iswap" signature="GraphState.iswap(qubit1, qubit2)">
    Apply [`iSwapGate`](qiskit.circuit.library.iSwapGate "qiskit.circuit.library.iSwapGate").
  </Function>

  ### mcmt

  <Function id="qiskit.circuit.library.GraphState.mcmt" name="mcmt" signature="GraphState.mcmt(gate, control_qubits, target_qubits, ancilla_qubits=None, mode='no-ancilla', *, single_control_gate_fun=None, q_controls=None, q_ancillae=None, q_targets=None)">
  ...
  <Function id="qiskit.circuit.library.GraphState.mcrx" name="mcrx" signature="GraphState.mcrx(theta, q_controls, q_target, use_basis_gates=False)">
  ...
  <Function id="qiskit.circuit.library.GraphState.mcry" name="mcry" signature="GraphState.mcry(theta, q_controls, q_target, q_ancillae, mode='basic', use_basis_gates=False)">
  ...
  <Function id="qiskit.circuit.library.GraphState.mcrz" name="mcrz" signature="GraphState.mcrz(lam, q_controls, q_target, use_basis_gates=False)">
  ...
  <Function id="qiskit.circuit.library.GraphState.mct" name="mct" signature="GraphState.mct(control_qubits, target_qubit, ancilla_qubits=None, mode='noancilla')">
    Apply `MCXGate`.
  </Function>

  ### mcu1

  <Function id="qiskit.circuit.library.GraphState.mcu1" name="mcu1" signature="GraphState.mcu1(lam, control_qubits, target_qubit)">
    Apply `MCU1Gate`.
  </Function>

  ### mcx

  <Function id="qiskit.circuit.library.GraphState.mcx" name="mcx" signature="GraphState.mcx(control_qubits, target_qubit, ancilla_qubits=None, mode='noancilla')">
    Apply `MCXGate`.
  ...
  <Function id="qiskit.circuit.library.GraphState.measure" name="measure" signature="GraphState.measure(qubit, cbit)">
  ...
  <Function id="qiskit.circuit.library.GraphState.measure_active" name="measure_active" signature="GraphState.measure_active(inplace=True)">
  ...
  <Function id="qiskit.circuit.library.GraphState.measure_all" name="measure_all" signature="GraphState.measure_all(inplace=True)">
  ...
  <Function id="qiskit.circuit.library.GraphState.mirror" name="mirror" signature="GraphState.mirror()">
  ...
  <Function id="qiskit.circuit.library.GraphState.ms" name="ms" signature="GraphState.ms(theta, qubits)">
    Apply [`MSGate`](qiskit.circuit.library.MSGate "qiskit.circuit.library.MSGate").
  </Function>

  ### num\_connected\_components

  <Function id="qiskit.circuit.library.GraphState.num_connected_components" name="num_connected_components" signature="GraphState.num_connected_components(unitary_only=False)">
  ...
  <Function id="qiskit.circuit.library.GraphState.num_nonlocal_gates" name="num_nonlocal_gates" signature="GraphState.num_nonlocal_gates()">
  ...
  <Function id="qiskit.circuit.library.GraphState.num_tensor_factors" name="num_tensor_factors" signature="GraphState.num_tensor_factors()">
  ...
  <Function id="qiskit.circuit.library.GraphState.num_unitary_factors" name="num_unitary_factors" signature="GraphState.num_unitary_factors()">
    Computes the number of tensor factors in the unitary (quantum) part of the circuit only.
  </Function>

  ### qasm

  <Function id="qiskit.circuit.library.GraphState.qasm" name="qasm" signature="GraphState.qasm(formatted=False, filename=None)">
  ...
  <Function id="qiskit.circuit.library.GraphState.qbit_argument_conversion" name="qbit_argument_conversion" signature="GraphState.qbit_argument_conversion(qubit_representation)">
  ...
  <Function id="qiskit.circuit.library.GraphState.r" name="r" signature="GraphState.r(theta, phi, qubit, *, q=None)">
    Apply `RGate`.
  </Function>

  ### rcccx

  <Function id="qiskit.circuit.library.GraphState.rcccx" name="rcccx" signature="GraphState.rcccx(control_qubit1, control_qubit2, control_qubit3, target_qubit)">
    Apply [`RC3XGate`](qiskit.circuit.library.RC3XGate "qiskit.circuit.library.RC3XGate").
  </Function>

  ### rccx

  <Function id="qiskit.circuit.library.GraphState.rccx" name="rccx" signature="GraphState.rccx(control_qubit1, control_qubit2, target_qubit)">
    Apply [`RCCXGate`](qiskit.circuit.library.RCCXGate "qiskit.circuit.library.RCCXGate").
  </Function>

  ### remove\_final\_measurements

  <Function id="qiskit.circuit.library.GraphState.remove_final_measurements" name="remove_final_measurements" signature="GraphState.remove_final_measurements(inplace=True)">
  ...
  <Function id="qiskit.circuit.library.GraphState.reset" name="reset" signature="GraphState.reset(qubit)">
    Reset q.
  </Function>

  ### rx

  <Function id="qiskit.circuit.library.GraphState.rx" name="rx" signature="GraphState.rx(theta, qubit, *, label=None, q=None)">
    Apply [`RXGate`](qiskit.circuit.library.RXGate "qiskit.circuit.library.RXGate").
  </Function>

  ### rxx

  <Function id="qiskit.circuit.library.GraphState.rxx" name="rxx" signature="GraphState.rxx(theta, qubit1, qubit2)">
    Apply [`RXXGate`](qiskit.circuit.library.RXXGate "qiskit.circuit.library.RXXGate").
  </Function>

  ### ry

  <Function id="qiskit.circuit.library.GraphState.ry" name="ry" signature="GraphState.ry(theta, qubit, *, label=None, q=None)">
    Apply [`RYGate`](qiskit.circuit.library.RYGate "qiskit.circuit.library.RYGate").
  </Function>

  ### ryy

  <Function id="qiskit.circuit.library.GraphState.ryy" name="ryy" signature="GraphState.ryy(theta, qubit1, qubit2)">
    Apply [`RYYGate`](qiskit.circuit.library.RYYGate "qiskit.circuit.library.RYYGate").
  </Function>

  ### rz

  <Function id="qiskit.circuit.library.GraphState.rz" name="rz" signature="GraphState.rz(phi, qubit, *, q=None)">
    Apply [`RZGate`](qiskit.circuit.library.RZGate "qiskit.circuit.library.RZGate").
  </Function>

  ### rzx

  <Function id="qiskit.circuit.library.GraphState.rzx" name="rzx" signature="GraphState.rzx(theta, qubit1, qubit2)">
    Apply [`RZXGate`](qiskit.circuit.library.RZXGate "qiskit.circuit.library.RZXGate").
  </Function>

  ### rzz

  <Function id="qiskit.circuit.library.GraphState.rzz" name="rzz" signature="GraphState.rzz(theta, qubit1, qubit2)">
    Apply [`RZZGate`](qiskit.circuit.library.RZZGate "qiskit.circuit.library.RZZGate").
  </Function>

  ### s

  <Function id="qiskit.circuit.library.GraphState.s" name="s" signature="GraphState.s(qubit, *, q=None)">
    Apply [`SGate`](qiskit.circuit.library.SGate "qiskit.circuit.library.SGate").
  </Function>

  ### sdg

  <Function id="qiskit.circuit.library.GraphState.sdg" name="sdg" signature="GraphState.sdg(qubit, *, q=None)">
    Apply [`SdgGate`](qiskit.circuit.library.SdgGate "qiskit.circuit.library.SdgGate").
  </Function>

  ### size

  <Function id="qiskit.circuit.library.GraphState.size" name="size" signature="GraphState.size()">
  ...
  <Function id="qiskit.circuit.library.GraphState.snapshot" name="snapshot" signature="GraphState.snapshot(label, snapshot_type='statevector', qubits=None, params=None)">
  ...
  <Function id="qiskit.circuit.library.GraphState.snapshot_density_matrix" name="snapshot_density_matrix" signature="GraphState.snapshot_density_matrix(label, qubits=None)">
  ...
  <Function id="qiskit.circuit.library.GraphState.snapshot_expectation_value" name="snapshot_expectation_value" signature="GraphState.snapshot_expectation_value(label, op, qubits, single_shot=False, variance=False)">
  ...
  <Function id="qiskit.circuit.library.GraphState.snapshot_probabilities" name="snapshot_probabilities" signature="GraphState.snapshot_probabilities(label, qubits, variance=False)">
  ...
  <Function id="qiskit.circuit.library.GraphState.snapshot_stabilizer" name="snapshot_stabilizer" signature="GraphState.snapshot_stabilizer(label)">
  ...
  <Function id="qiskit.circuit.library.GraphState.snapshot_statevector" name="snapshot_statevector" signature="GraphState.snapshot_statevector(label)">
  ...
  <Function id="qiskit.circuit.library.GraphState.squ" name="squ" signature="GraphState.squ(unitary_matrix, qubit, mode='ZYZ', up_to_diagonal=False, *, u=None)">
  ...
  <Function id="qiskit.circuit.library.GraphState.swap" name="swap" signature="GraphState.swap(qubit1, qubit2)">
    Apply [`SwapGate`](qiskit.circuit.library.SwapGate "qiskit.circuit.library.SwapGate").
  </Function>

  ### t

  <Function id="qiskit.circuit.library.GraphState.t" name="t" signature="GraphState.t(qubit, *, q=None)">
    Apply [`TGate`](qiskit.circuit.library.TGate "qiskit.circuit.library.TGate").
  </Function>

  ### tdg

  <Function id="qiskit.circuit.library.GraphState.tdg" name="tdg" signature="GraphState.tdg(qubit, *, q=None)">
    Apply [`TdgGate`](qiskit.circuit.library.TdgGate "qiskit.circuit.library.TdgGate").
  </Function>

  ### to\_gate

  <Function id="qiskit.circuit.library.GraphState.to_gate" name="to_gate" signature="GraphState.to_gate(parameter_map=None)">
  ...
  <Function id="qiskit.circuit.library.GraphState.to_instruction" name="to_instruction" signature="GraphState.to_instruction(parameter_map=None)">
  ...
  <Function id="qiskit.circuit.library.GraphState.toffoli" name="toffoli" signature="GraphState.toffoli(control_qubit1, control_qubit2, target_qubit, *, ctl1=None, ctl2=None, tgt=None)">
    Apply [`CCXGate`](qiskit.circuit.library.CCXGate "qiskit.circuit.library.CCXGate").
  </Function>

  ### u1

  <Function id="qiskit.circuit.library.GraphState.u1" name="u1" signature="GraphState.u1(theta, qubit, *, q=None)">
    Apply [`U1Gate`](qiskit.circuit.library.U1Gate "qiskit.circuit.library.U1Gate").
  </Function>

  ### u2

  <Function id="qiskit.circuit.library.GraphState.u2" name="u2" signature="GraphState.u2(phi, lam, qubit, *, q=None)">
    Apply [`U2Gate`](qiskit.circuit.library.U2Gate "qiskit.circuit.library.U2Gate").
  </Function>

  ### u3

  <Function id="qiskit.circuit.library.GraphState.u3" name="u3" signature="GraphState.u3(theta, phi, lam, qubit, *, q=None)">
    Apply [`U3Gate`](qiskit.circuit.library.U3Gate "qiskit.circuit.library.U3Gate").
  </Function>

  ### uc

  <Function id="qiskit.circuit.library.GraphState.uc" name="uc" signature="GraphState.uc(gate_list, q_controls, q_target, up_to_diagonal=False)">
  ...
  <Function id="qiskit.circuit.library.GraphState.ucg" name="ucg" signature="GraphState.ucg(angle_list, q_controls, q_target, up_to_diagonal=False)">
    Deprecated version of uc.
  </Function>

  ### ucrx

  <Function id="qiskit.circuit.library.GraphState.ucrx" name="ucrx" signature="GraphState.ucrx(angle_list, q_controls, q_target)">
  ...
  <Function id="qiskit.circuit.library.GraphState.ucry" name="ucry" signature="GraphState.ucry(angle_list, q_controls, q_target)">
  ...
  <Function id="qiskit.circuit.library.GraphState.ucrz" name="ucrz" signature="GraphState.ucrz(angle_list, q_controls, q_target)">
  ...
  <Function id="qiskit.circuit.library.GraphState.ucx" name="ucx" signature="GraphState.ucx(angle_list, q_controls, q_target)">
    Deprecated version of ucrx.
  </Function>

  ### ucy

  <Function id="qiskit.circuit.library.GraphState.ucy" name="ucy" signature="GraphState.ucy(angle_list, q_controls, q_target)">
    Deprecated version of ucry.
  </Function>

  ### ucz

  <Function id="qiskit.circuit.library.GraphState.ucz" name="ucz" signature="GraphState.ucz(angle_list, q_controls, q_target)">
    Deprecated version of ucrz.
  </Function>

  ### unitary

  <Function id="qiskit.circuit.library.GraphState.unitary" name="unitary" signature="GraphState.unitary(obj, qubits, label=None)">
    Apply unitary gate to q.
  </Function>

  ### width

  <Function id="qiskit.circuit.library.GraphState.width" name="width" signature="GraphState.width()">
  ...
  <Function id="qiskit.circuit.library.GraphState.x" name="x" signature="GraphState.x(qubit, *, label=None, ctrl_state=None, q=None)">
    Apply [`XGate`](qiskit.circuit.library.XGate "qiskit.circuit.library.XGate").
  </Function>

  ### y

  <Function id="qiskit.circuit.library.GraphState.y" name="y" signature="GraphState.y(qubit, *, q=None)">
    Apply [`YGate`](qiskit.circuit.library.YGate "qiskit.circuit.library.YGate").
  </Function>

  ### z

  <Function id="qiskit.circuit.library.GraphState.z" name="z" signature="GraphState.z(qubit, *, q=None)">
