---
title: GraphState (v0.19)
description: API reference for qiskit.circuit.library.GraphState in qiskit v0.19
...
<Class id="qiskit.circuit.library.GraphState" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.14/qiskit/circuit/library/graph_state.py" signature="GraphState(adjacency_matrix)" modifiers="class">
...
$$
  ...
  **adjacency\_matrix** (`Union`\[`List`, `array`]) – input graph as n-by-n list of 0-1 lists
  ...
  <span id="graphstate-extension-lib" />

  ### extension\_lib

  <Attribute id="qiskit.circuit.library.GraphState.extension_lib" attributeValue="'include &#x22;qelib1.inc&#x22;;'" />

  <span id="graphstate-header" />

  ### header

  <Attribute id="qiskit.circuit.library.GraphState.header" attributeValue="'OPENQASM 2.0;'" />

  <span id="graphstate-instances" />

  ### instances

  <Attribute id="qiskit.circuit.library.GraphState.instances" attributeValue="8" />

  <span id="graphstate-n-qubits" />

  ### n\_qubits

  <Attribute id="qiskit.circuit.library.GraphState.n_qubits">
    Deprecated, use `num_qubits` instead. Return number of qubits.
  </Attribute>

  <span id="graphstate-num-clbits" />
  ...
  <span id="graphstate-num-parameters" />
  ...
  <span id="graphstate-and" />

  ### AND

  <Function id="qiskit.circuit.library.GraphState.AND" signature="GraphState.AND(qr_variables, qb_target, qr_ancillae, flags=None, mct_mode='no-ancilla')">
  ...
  <span id="graphstate-or" />

  ### OR

  <Function id="qiskit.circuit.library.GraphState.OR" signature="GraphState.OR(qr_variables, qb_target, qr_ancillae, flags=None, mct_mode='basic')">
  ...
  <span id="graphstate-getitem" />

  ### \_\_getitem\_\_

  <Function id="qiskit.circuit.library.GraphState.__getitem__" signature="GraphState.__getitem__(item)">
    Return indexed operation.
  </Function>

  <span id="graphstate-len" />

  ### \_\_len\_\_

  <Function id="qiskit.circuit.library.GraphState.__len__" signature="GraphState.__len__()">
    Return number of operations in circuit.
  </Function>

  <span id="graphstate-add-register" />

  ### add\_register

  <Function id="qiskit.circuit.library.GraphState.add_register" signature="GraphState.add_register(*regs)">
    Add registers.
  </Function>

  <span id="graphstate-append" />

  ### append

  <Function id="qiskit.circuit.library.GraphState.append" signature="GraphState.append(instruction, qargs=None, cargs=None)">
  ...
  <span id="graphstate-assign-parameters" />

  ### assign\_parameters

  <Function id="qiskit.circuit.library.GraphState.assign_parameters" signature="GraphState.assign_parameters(param_dict, inplace=False)">
  ...
  <span id="graphstate-barrier" />

  ### barrier

  <Function id="qiskit.circuit.library.GraphState.barrier" signature="GraphState.barrier(*qargs)">
    Apply `Barrier`. If qargs is None, applies to all.
  </Function>

  <span id="graphstate-bind-parameters" />

  ### bind\_parameters

  <Function id="qiskit.circuit.library.GraphState.bind_parameters" signature="GraphState.bind_parameters(value_dict)">
  ...
  <span id="graphstate-cast" />

  ### cast

  <Function id="qiskit.circuit.library.GraphState.cast" signature="GraphState.cast(value, _type)" modifiers="static">
    Best effort to cast value to type. Otherwise, returns the value.
  </Function>

  <span id="graphstate-cbit-argument-conversion" />

  ### cbit\_argument\_conversion

  <Function id="qiskit.circuit.library.GraphState.cbit_argument_conversion" signature="GraphState.cbit_argument_conversion(clbit_representation)">
  ...
  <span id="graphstate-ccx" />

  ### ccx

  <Function id="qiskit.circuit.library.GraphState.ccx" signature="GraphState.ccx(control_qubit1, control_qubit2, target_qubit, *, ctl1=None, ctl2=None, tgt=None)">
    Apply [`CCXGate`](qiskit.circuit.library.CCXGate "qiskit.circuit.library.CCXGate").
  </Function>

  <span id="graphstate-ch" />

  ### ch

  <Function id="qiskit.circuit.library.GraphState.ch" signature="GraphState.ch(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CHGate`](qiskit.circuit.library.CHGate "qiskit.circuit.library.CHGate").
  </Function>

  <span id="graphstate-cls-instances" />

  ### cls\_instances

  <Function id="qiskit.circuit.library.GraphState.cls_instances" signature="GraphState.cls_instances()" modifiers="classmethod">
    Return the current number of instances of this class, useful for auto naming.
  </Function>

  <span id="graphstate-cls-prefix" />

  ### cls\_prefix

  <Function id="qiskit.circuit.library.GraphState.cls_prefix" signature="GraphState.cls_prefix()" modifiers="classmethod">
    Return the prefix to use for auto naming.
  </Function>

  <span id="graphstate-cnot" />

  ### cnot

  <Function id="qiskit.circuit.library.GraphState.cnot" signature="GraphState.cnot(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CXGate`](qiskit.circuit.library.CXGate "qiskit.circuit.library.CXGate").
  </Function>

  <span id="graphstate-combine" />

  ### combine

  <Function id="qiskit.circuit.library.GraphState.combine" signature="GraphState.combine(rhs)">
  ...
  <span id="graphstate-compose" />

  ### compose

  <Function id="qiskit.circuit.library.GraphState.compose" signature="GraphState.compose(other, qubits=None, clbits=None, front=False, inplace=False)">
  ...
  <span id="graphstate-copy" />

  ### copy

  <Function id="qiskit.circuit.library.GraphState.copy" signature="GraphState.copy(name=None)">
    Copy the circuit.
  ...
  <span id="graphstate-count-ops" />

  ### count\_ops

  <Function id="qiskit.circuit.library.GraphState.count_ops" signature="GraphState.count_ops()">
  ...
  <span id="graphstate-crx" />

  ### crx

  <Function id="qiskit.circuit.library.GraphState.crx" signature="GraphState.crx(theta, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CRXGate`](qiskit.circuit.library.CRXGate "qiskit.circuit.library.CRXGate").
  </Function>

  <span id="graphstate-cry" />

  ### cry

  <Function id="qiskit.circuit.library.GraphState.cry" signature="GraphState.cry(theta, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CRYGate`](qiskit.circuit.library.CRYGate "qiskit.circuit.library.CRYGate").
  </Function>

  <span id="graphstate-crz" />

  ### crz

  <Function id="qiskit.circuit.library.GraphState.crz" signature="GraphState.crz(theta, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CRZGate`](qiskit.circuit.library.CRZGate "qiskit.circuit.library.CRZGate").
  </Function>

  <span id="graphstate-cswap" />

  ### cswap

  <Function id="qiskit.circuit.library.GraphState.cswap" signature="GraphState.cswap(control_qubit, target_qubit1, target_qubit2, *, label=None, ctrl_state=None, ctl=None, tgt1=None, tgt2=None)">
    Apply [`CSwapGate`](qiskit.circuit.library.CSwapGate "qiskit.circuit.library.CSwapGate").
  </Function>

  <span id="graphstate-cu1" />

  ### cu1

  <Function id="qiskit.circuit.library.GraphState.cu1" signature="GraphState.cu1(theta, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CU1Gate`](qiskit.circuit.library.CU1Gate "qiskit.circuit.library.CU1Gate").
  </Function>

  <span id="graphstate-cu3" />

  ### cu3

  <Function id="qiskit.circuit.library.GraphState.cu3" signature="GraphState.cu3(theta, phi, lam, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CU3Gate`](qiskit.circuit.library.CU3Gate "qiskit.circuit.library.CU3Gate").
  </Function>

  <span id="graphstate-cx" />

  ### cx

  <Function id="qiskit.circuit.library.GraphState.cx" signature="GraphState.cx(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CXGate`](qiskit.circuit.library.CXGate "qiskit.circuit.library.CXGate").
  </Function>

  <span id="graphstate-cy" />

  ### cy

  <Function id="qiskit.circuit.library.GraphState.cy" signature="GraphState.cy(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CYGate`](qiskit.circuit.library.CYGate "qiskit.circuit.library.CYGate").
  </Function>

  <span id="graphstate-cz" />

  ### cz

  <Function id="qiskit.circuit.library.GraphState.cz" signature="GraphState.cz(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CZGate`](qiskit.circuit.library.CZGate "qiskit.circuit.library.CZGate").
  </Function>

  <span id="graphstate-dcx" />

  ### dcx

  <Function id="qiskit.circuit.library.GraphState.dcx" signature="GraphState.dcx(qubit1, qubit2)">
    Apply [`DCXGate`](qiskit.circuit.library.DCXGate "qiskit.circuit.library.DCXGate").
  </Function>

  <span id="graphstate-decompose" />

  ### decompose

  <Function id="qiskit.circuit.library.GraphState.decompose" signature="GraphState.decompose()">
  ...
  <span id="graphstate-depth" />

  ### depth

  <Function id="qiskit.circuit.library.GraphState.depth" signature="GraphState.depth()">
  ...
  <span id="graphstate-diag-gate" />

  ### diag\_gate

  <Function id="qiskit.circuit.library.GraphState.diag_gate" signature="GraphState.diag_gate(diag, qubit)">
    Deprecated version of QuantumCircuit.diagonal.
  </Function>

  <span id="graphstate-diagonal" />

  ### diagonal

  <Function id="qiskit.circuit.library.GraphState.diagonal" signature="GraphState.diagonal(diag, qubit)">
  ...
  <span id="graphstate-extend" />

  ### extend

  <Function id="qiskit.circuit.library.GraphState.extend" signature="GraphState.extend(rhs)">
  ...
  <span id="graphstate-fredkin" />

  ### fredkin

  <Function id="qiskit.circuit.library.GraphState.fredkin" signature="GraphState.fredkin(control_qubit, target_qubit1, target_qubit2, *, ctl=None, tgt1=None, tgt2=None)">
    Apply [`CSwapGate`](qiskit.circuit.library.CSwapGate "qiskit.circuit.library.CSwapGate").
  </Function>

  <span id="graphstate-from-qasm-file" />

  ### from\_qasm\_file

  <Function id="qiskit.circuit.library.GraphState.from_qasm_file" signature="GraphState.from_qasm_file(path)" modifiers="static">
  ...
  <span id="graphstate-from-qasm-str" />

  ### from\_qasm\_str

  <Function id="qiskit.circuit.library.GraphState.from_qasm_str" signature="GraphState.from_qasm_str(qasm_str)" modifiers="static">
  ...
  <span id="graphstate-h" />

  ### h

  <Function id="qiskit.circuit.library.GraphState.h" signature="GraphState.h(qubit, *, q=None)">
    Apply [`HGate`](qiskit.circuit.library.HGate "qiskit.circuit.library.HGate").
  </Function>

  <span id="graphstate-hamiltonian" />

  ### hamiltonian

  <Function id="qiskit.circuit.library.GraphState.hamiltonian" signature="GraphState.hamiltonian(operator, time, qubits, label=None)">
    Apply hamiltonian evolution to to qubits.
  </Function>

  <span id="graphstate-has-register" />

  ### has\_register

  <Function id="qiskit.circuit.library.GraphState.has_register" signature="GraphState.has_register(register)">
  ...
  <span id="graphstate-i" />

  ### i

  <Function id="qiskit.circuit.library.GraphState.i" signature="GraphState.i(qubit, *, q=None)">
    Apply [`IGate`](qiskit.circuit.library.IGate "qiskit.circuit.library.IGate").
  </Function>

  <span id="graphstate-id" />

  ### id

  <Function id="qiskit.circuit.library.GraphState.id" signature="GraphState.id(qubit, *, q=None)">
    Apply [`IGate`](qiskit.circuit.library.IGate "qiskit.circuit.library.IGate").
  </Function>

  <span id="graphstate-iden" />

  ### iden

  <Function id="qiskit.circuit.library.GraphState.iden" signature="GraphState.iden(qubit, *, q=None)">
    Deprecated identity gate.
  </Function>

  <span id="graphstate-initialize" />

  ### initialize

  <Function id="qiskit.circuit.library.GraphState.initialize" signature="GraphState.initialize(params, qubits)">
    Apply initialize to circuit.
  </Function>

  <span id="graphstate-inverse" />

  ### inverse

  <Function id="qiskit.circuit.library.GraphState.inverse" signature="GraphState.inverse()">
    Invert this circuit.
  ...
  <span id="graphstate-iso" />

  ### iso

  <Function id="qiskit.circuit.library.GraphState.iso" signature="GraphState.iso(isometry, q_input, q_ancillas_for_output, q_ancillas_zero=None, q_ancillas_dirty=None)">
  ...
  <span id="graphstate-isometry" />

  ### isometry

  <Function id="qiskit.circuit.library.GraphState.isometry" signature="GraphState.isometry(isometry, q_input, q_ancillas_for_output, q_ancillas_zero=None, q_ancillas_dirty=None)">
    Attach an arbitrary isometry from m to n qubits to a circuit. In particular, this allows to attach arbitrary unitaries on n qubits (m=n) or to prepare any state on n qubits (m=0). The decomposition used here was introduced by Iten et al. in [https://arxiv.org/abs/1501.06911](https://arxiv.org/abs/1501.06911).
  ...
  <span id="graphstate-iswap" />

  ### iswap

  <Function id="qiskit.circuit.library.GraphState.iswap" signature="GraphState.iswap(qubit1, qubit2)">
    Apply [`iSwapGate`](qiskit.circuit.library.iSwapGate "qiskit.circuit.library.iSwapGate").
  </Function>

  <span id="graphstate-mcmt" />

  ### mcmt

  <Function id="qiskit.circuit.library.GraphState.mcmt" signature="GraphState.mcmt(gate, control_qubits, target_qubits, ancilla_qubits=None, mode='no-ancilla', *, single_control_gate_fun=None, q_controls=None, q_ancillae=None, q_targets=None)">
    Apply a multi-control, multi-target using a generic gate.

    This can also be used to implement a generic multi-control gate, as the target could also be of length 1.
  </Function>

  <span id="graphstate-mcrx" />

  ### mcrx

  <Function id="qiskit.circuit.library.GraphState.mcrx" signature="GraphState.mcrx(theta, q_controls, q_target, use_basis_gates=False)">
  ...
  <span id="graphstate-mcry" />

  ### mcry

  <Function id="qiskit.circuit.library.GraphState.mcry" signature="GraphState.mcry(theta, q_controls, q_target, q_ancillae, mode='basic', use_basis_gates=False)">
  ...
  <span id="graphstate-mcrz" />

  ### mcrz

  <Function id="qiskit.circuit.library.GraphState.mcrz" signature="GraphState.mcrz(lam, q_controls, q_target, use_basis_gates=False)">
  ...
  <span id="graphstate-mct" />

  ### mct

  <Function id="qiskit.circuit.library.GraphState.mct" signature="GraphState.mct(control_qubits, target_qubit, ancilla_qubits=None, mode='noancilla')">
    Apply `MCXGate`.
  </Function>

  <span id="graphstate-mcu1" />

  ### mcu1

  <Function id="qiskit.circuit.library.GraphState.mcu1" signature="GraphState.mcu1(lam, control_qubits, target_qubit)">
    Apply `MCU1Gate`.
  </Function>

  <span id="graphstate-mcx" />

  ### mcx

  <Function id="qiskit.circuit.library.GraphState.mcx" signature="GraphState.mcx(control_qubits, target_qubit, ancilla_qubits=None, mode='noancilla')">
    Apply `MCXGate`.
  ...
  <span id="graphstate-measure" />

  ### measure

  <Function id="qiskit.circuit.library.GraphState.measure" signature="GraphState.measure(qubit, cbit)">
  ...
  <span id="graphstate-measure-active" />

  ### measure\_active

  <Function id="qiskit.circuit.library.GraphState.measure_active" signature="GraphState.measure_active(inplace=True)">
  ...
  <span id="graphstate-measure-all" />

  ### measure\_all

  <Function id="qiskit.circuit.library.GraphState.measure_all" signature="GraphState.measure_all(inplace=True)">
  ...
  <span id="graphstate-mirror" />

  ### mirror

  <Function id="qiskit.circuit.library.GraphState.mirror" signature="GraphState.mirror()">
  ...
  <span id="graphstate-ms" />

  ### ms

  <Function id="qiskit.circuit.library.GraphState.ms" signature="GraphState.ms(theta, qubits)">
    Apply [`MSGate`](qiskit.circuit.library.MSGate "qiskit.circuit.library.MSGate").
  </Function>

  <span id="graphstate-num-connected-components" />

  ### num\_connected\_components

  <Function id="qiskit.circuit.library.GraphState.num_connected_components" signature="GraphState.num_connected_components(unitary_only=False)">
  ...
  <span id="graphstate-num-nonlocal-gates" />

  ### num\_nonlocal\_gates

  <Function id="qiskit.circuit.library.GraphState.num_nonlocal_gates" signature="GraphState.num_nonlocal_gates()">
    Return number of non-local gates (i.e. involving 2+ qubits).

    Conditional nonlocal gates are also included.
  </Function>

  <span id="graphstate-num-tensor-factors" />

  ### num\_tensor\_factors

  <Function id="qiskit.circuit.library.GraphState.num_tensor_factors" signature="GraphState.num_tensor_factors()">
  ...
  <span id="graphstate-num-unitary-factors" />

  ### num\_unitary\_factors

  <Function id="qiskit.circuit.library.GraphState.num_unitary_factors" signature="GraphState.num_unitary_factors()">
    Computes the number of tensor factors in the unitary (quantum) part of the circuit only.
  </Function>

  <span id="graphstate-qasm" />

  ### qasm

  <Function id="qiskit.circuit.library.GraphState.qasm" signature="GraphState.qasm(formatted=False, filename=None)">
  ...
  <span id="graphstate-qbit-argument-conversion" />

  ### qbit\_argument\_conversion

  <Function id="qiskit.circuit.library.GraphState.qbit_argument_conversion" signature="GraphState.qbit_argument_conversion(qubit_representation)">
  ...
  <span id="graphstate-r" />

  ### r

  <Function id="qiskit.circuit.library.GraphState.r" signature="GraphState.r(theta, phi, qubit, *, q=None)">
    Apply `RGate`.
  </Function>

  <span id="graphstate-rcccx" />

  ### rcccx

  <Function id="qiskit.circuit.library.GraphState.rcccx" signature="GraphState.rcccx(control_qubit1, control_qubit2, control_qubit3, target_qubit)">
    Apply [`RC3XGate`](qiskit.circuit.library.RC3XGate "qiskit.circuit.library.RC3XGate").
  </Function>

  <span id="graphstate-rccx" />

  ### rccx

  <Function id="qiskit.circuit.library.GraphState.rccx" signature="GraphState.rccx(control_qubit1, control_qubit2, target_qubit)">
    Apply [`RCCXGate`](qiskit.circuit.library.RCCXGate "qiskit.circuit.library.RCCXGate").
  </Function>

  <span id="graphstate-remove-final-measurements" />

  ### remove\_final\_measurements

  <Function id="qiskit.circuit.library.GraphState.remove_final_measurements" signature="GraphState.remove_final_measurements(inplace=True)">
  ...
  <span id="graphstate-reset" />

  ### reset

  <Function id="qiskit.circuit.library.GraphState.reset" signature="GraphState.reset(qubit)">
    Reset q.
  </Function>

  <span id="graphstate-rx" />

  ### rx

  <Function id="qiskit.circuit.library.GraphState.rx" signature="GraphState.rx(theta, qubit, *, label=None, q=None)">
    Apply [`RXGate`](qiskit.circuit.library.RXGate "qiskit.circuit.library.RXGate").
  </Function>

  <span id="graphstate-rxx" />

  ### rxx

  <Function id="qiskit.circuit.library.GraphState.rxx" signature="GraphState.rxx(theta, qubit1, qubit2)">
    Apply [`RXXGate`](qiskit.circuit.library.RXXGate "qiskit.circuit.library.RXXGate").
  </Function>

  <span id="graphstate-ry" />

  ### ry

  <Function id="qiskit.circuit.library.GraphState.ry" signature="GraphState.ry(theta, qubit, *, label=None, q=None)">
    Apply [`RYGate`](qiskit.circuit.library.RYGate "qiskit.circuit.library.RYGate").
  </Function>

  <span id="graphstate-ryy" />

  ### ryy

  <Function id="qiskit.circuit.library.GraphState.ryy" signature="GraphState.ryy(theta, qubit1, qubit2)">
    Apply [`RYYGate`](qiskit.circuit.library.RYYGate "qiskit.circuit.library.RYYGate").
  </Function>

  <span id="graphstate-rz" />

  ### rz

  <Function id="qiskit.circuit.library.GraphState.rz" signature="GraphState.rz(phi, qubit, *, q=None)">
    Apply [`RZGate`](qiskit.circuit.library.RZGate "qiskit.circuit.library.RZGate").
  </Function>

  <span id="graphstate-rzx" />

  ### rzx

  <Function id="qiskit.circuit.library.GraphState.rzx" signature="GraphState.rzx(theta, qubit1, qubit2)">
    Apply [`RZXGate`](qiskit.circuit.library.RZXGate "qiskit.circuit.library.RZXGate").
  </Function>

  <span id="graphstate-rzz" />

  ### rzz

  <Function id="qiskit.circuit.library.GraphState.rzz" signature="GraphState.rzz(theta, qubit1, qubit2)">
    Apply [`RZZGate`](qiskit.circuit.library.RZZGate "qiskit.circuit.library.RZZGate").
  </Function>

  <span id="graphstate-s" />

  ### s

  <Function id="qiskit.circuit.library.GraphState.s" signature="GraphState.s(qubit, *, q=None)">
    Apply [`SGate`](qiskit.circuit.library.SGate "qiskit.circuit.library.SGate").
  </Function>

  <span id="graphstate-sdg" />

  ### sdg

  <Function id="qiskit.circuit.library.GraphState.sdg" signature="GraphState.sdg(qubit, *, q=None)">
    Apply [`SdgGate`](qiskit.circuit.library.SdgGate "qiskit.circuit.library.SdgGate").
  </Function>

  <span id="graphstate-size" />

  ### size

  <Function id="qiskit.circuit.library.GraphState.size" signature="GraphState.size()">
  ...
  <span id="graphstate-snapshot" />

  ### snapshot

  <Function id="qiskit.circuit.library.GraphState.snapshot" signature="GraphState.snapshot(label, snapshot_type='statevector', qubits=None, params=None)">
  ...
  <span id="graphstate-snapshot-density-matrix" />

  ### snapshot\_density\_matrix

  <Function id="qiskit.circuit.library.GraphState.snapshot_density_matrix" signature="GraphState.snapshot_density_matrix(label, qubits=None)">
  ...
  <span id="graphstate-snapshot-expectation-value" />

  ### snapshot\_expectation\_value

  <Function id="qiskit.circuit.library.GraphState.snapshot_expectation_value" signature="GraphState.snapshot_expectation_value(label, op, qubits, single_shot=False, variance=False)">
  ...
  <span id="graphstate-snapshot-probabilities" />

  ### snapshot\_probabilities

  <Function id="qiskit.circuit.library.GraphState.snapshot_probabilities" signature="GraphState.snapshot_probabilities(label, qubits, variance=False)">
  ...
  <span id="graphstate-snapshot-stabilizer" />

  ### snapshot\_stabilizer

  <Function id="qiskit.circuit.library.GraphState.snapshot_stabilizer" signature="GraphState.snapshot_stabilizer(label)">
  ...
  <span id="graphstate-snapshot-statevector" />

  ### snapshot\_statevector

  <Function id="qiskit.circuit.library.GraphState.snapshot_statevector" signature="GraphState.snapshot_statevector(label)">
  ...
  <span id="graphstate-squ" />

  ### squ

  <Function id="qiskit.circuit.library.GraphState.squ" signature="GraphState.squ(unitary_matrix, qubit, mode='ZYZ', up_to_diagonal=False, *, u=None)">
  ...
  <span id="graphstate-swap" />

  ### swap

  <Function id="qiskit.circuit.library.GraphState.swap" signature="GraphState.swap(qubit1, qubit2)">
    Apply [`SwapGate`](qiskit.circuit.library.SwapGate "qiskit.circuit.library.SwapGate").
  </Function>

  <span id="graphstate-t" />

  ### t

  <Function id="qiskit.circuit.library.GraphState.t" signature="GraphState.t(qubit, *, q=None)">
    Apply [`TGate`](qiskit.circuit.library.TGate "qiskit.circuit.library.TGate").
  </Function>

  <span id="graphstate-tdg" />

  ### tdg

  <Function id="qiskit.circuit.library.GraphState.tdg" signature="GraphState.tdg(qubit, *, q=None)">
    Apply [`TdgGate`](qiskit.circuit.library.TdgGate "qiskit.circuit.library.TdgGate").
  </Function>

  <span id="graphstate-to-gate" />

  ### to\_gate

  <Function id="qiskit.circuit.library.GraphState.to_gate" signature="GraphState.to_gate(parameter_map=None)">
  ...
  <span id="graphstate-to-instruction" />

  ### to\_instruction

  <Function id="qiskit.circuit.library.GraphState.to_instruction" signature="GraphState.to_instruction(parameter_map=None)">
  ...
  <span id="graphstate-toffoli" />

  ### toffoli

  <Function id="qiskit.circuit.library.GraphState.toffoli" signature="GraphState.toffoli(control_qubit1, control_qubit2, target_qubit, *, ctl1=None, ctl2=None, tgt=None)">
    Apply [`CCXGate`](qiskit.circuit.library.CCXGate "qiskit.circuit.library.CCXGate").
  </Function>

  <span id="graphstate-u1" />

  ### u1

  <Function id="qiskit.circuit.library.GraphState.u1" signature="GraphState.u1(theta, qubit, *, q=None)">
    Apply [`U1Gate`](qiskit.circuit.library.U1Gate "qiskit.circuit.library.U1Gate").
  </Function>

  <span id="graphstate-u2" />

  ### u2

  <Function id="qiskit.circuit.library.GraphState.u2" signature="GraphState.u2(phi, lam, qubit, *, q=None)">
    Apply [`U2Gate`](qiskit.circuit.library.U2Gate "qiskit.circuit.library.U2Gate").
  </Function>

  <span id="graphstate-u3" />

  ### u3

  <Function id="qiskit.circuit.library.GraphState.u3" signature="GraphState.u3(theta, phi, lam, qubit, *, q=None)">
    Apply [`U3Gate`](qiskit.circuit.library.U3Gate "qiskit.circuit.library.U3Gate").
  </Function>

  <span id="graphstate-uc" />

  ### uc

  <Function id="qiskit.circuit.library.GraphState.uc" signature="GraphState.uc(gate_list, q_controls, q_target, up_to_diagonal=False)">
  ...
  <span id="graphstate-ucg" />

  ### ucg

  <Function id="qiskit.circuit.library.GraphState.ucg" signature="GraphState.ucg(angle_list, q_controls, q_target, up_to_diagonal=False)">
    Deprecated version of uc.
  </Function>

  <span id="graphstate-ucrx" />

  ### ucrx

  <Function id="qiskit.circuit.library.GraphState.ucrx" signature="GraphState.ucrx(angle_list, q_controls, q_target)">
  ...
  <span id="graphstate-ucry" />

  ### ucry

  <Function id="qiskit.circuit.library.GraphState.ucry" signature="GraphState.ucry(angle_list, q_controls, q_target)">
  ...
  <span id="graphstate-ucrz" />

  ### ucrz

  <Function id="qiskit.circuit.library.GraphState.ucrz" signature="GraphState.ucrz(angle_list, q_controls, q_target)">
  ...
  <span id="graphstate-ucx" />

  ### ucx

  <Function id="qiskit.circuit.library.GraphState.ucx" signature="GraphState.ucx(angle_list, q_controls, q_target)">
    Deprecated version of ucrx.
  </Function>

  <span id="graphstate-ucy" />

  ### ucy

  <Function id="qiskit.circuit.library.GraphState.ucy" signature="GraphState.ucy(angle_list, q_controls, q_target)">
    Deprecated version of ucry.
  </Function>

  <span id="graphstate-ucz" />

  ### ucz

  <Function id="qiskit.circuit.library.GraphState.ucz" signature="GraphState.ucz(angle_list, q_controls, q_target)">
    Deprecated version of ucrz.
  </Function>

  <span id="graphstate-unitary" />

  ### unitary

  <Function id="qiskit.circuit.library.GraphState.unitary" signature="GraphState.unitary(obj, qubits, label=None)">
    Apply unitary gate to q.
  </Function>

  <span id="graphstate-width" />

  ### width

  <Function id="qiskit.circuit.library.GraphState.width" signature="GraphState.width()">
  ...
  <span id="graphstate-x" />

  ### x

  <Function id="qiskit.circuit.library.GraphState.x" signature="GraphState.x(qubit, *, label=None, ctrl_state=None, q=None)">
    Apply [`XGate`](qiskit.circuit.library.XGate "qiskit.circuit.library.XGate").
  </Function>

  <span id="graphstate-y" />

  ### y

  <Function id="qiskit.circuit.library.GraphState.y" signature="GraphState.y(qubit, *, q=None)">
    Apply [`YGate`](qiskit.circuit.library.YGate "qiskit.circuit.library.YGate").
  </Function>

  <span id="graphstate-z" />

  ### z

  <Function id="qiskit.circuit.library.GraphState.z" signature="GraphState.z(qubit, *, q=None)">
