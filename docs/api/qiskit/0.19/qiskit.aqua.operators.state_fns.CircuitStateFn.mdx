...
<Class id="qiskit.aqua.operators.state_fns.CircuitStateFn" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.7/qiskit/aqua/operators/state_fns/circuit_state_fn.py" signature="CircuitStateFn(primitive=None, coeff=1.0, is_measurement=False)">
  ...
  **TypeError** – Unsupported primitive, or primitive has ClassicalRegisters.
  ...
  <Attribute id="qiskit.aqua.operators.state_fns.CircuitStateFn.coeff" name="coeff" signature="Union[int, float, complex, qiskit.circuit.parameterexpression.ParameterExpression]">
  ...
  <Attribute id="qiskit.aqua.operators.state_fns.CircuitStateFn.is_measurement" name="is_measurement" signature="bool">
  ...
  <Attribute id="qiskit.aqua.operators.state_fns.CircuitStateFn.num_qubits" name="num_qubits" signature="int">
  ...
  <Function id="qiskit.aqua.operators.state_fns.CircuitStateFn.__mul__" name="__mul__" signature="CircuitStateFn.__mul__(other)">
  ...
  <Function id="qiskit.aqua.operators.state_fns.CircuitStateFn.compose" name="compose" signature="CircuitStateFn.compose(other)">
