---
title: CircuitStateFn (v0.19)
description: API reference for qiskit.aqua.operators.state_fns.CircuitStateFn in qiskit v0.19
...
<Class id="qiskit.aqua.operators.state_fns.CircuitStateFn" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.7/qiskit/aqua/operators/state_fns/circuit_state_fn.py" signature="CircuitStateFn(primitive=None, coeff=1.0, is_measurement=False)" modifiers="class">
  ...
  **TypeError** – Unsupported primitive, or primitive has ClassicalRegisters.
  ...
  <span id="circuitstatefn-is-measurement" />
  ...
  <span id="circuitstatefn-num-qubits" />
  ...
  <span id="circuitstatefn-primitive" />
  ...
  <span id="circuitstatefn-adjoint" />
  ...
  <span id="circuitstatefn-assign-parameters" />
  ...
  <span id="circuitstatefn-bind-parameters" />
  ...
  <span id="circuitstatefn-compose" />
  ...
  <span id="circuitstatefn-from-dict" />
  ...
  <span id="circuitstatefn-from-vector" />
  ...
  <span id="circuitstatefn-permute" />
  ...
  <span id="circuitstatefn-primitive-strings" />
  ...
  <span id="circuitstatefn-tensorpower" />
  ...
  <span id="circuitstatefn-to-circuit" />
  ...
  <span id="circuitstatefn-to-circuit-op" />
  ...
  <span id="circuitstatefn-to-density-matrix" />
  ...
  <span id="circuitstatefn-to-instruction" />
  ...
  <span id="circuitstatefn-to-legacy-op" />
  ...
  <span id="circuitstatefn-to-matrix" />
  ...
  <span id="circuitstatefn-to-matrix-op" />
  ...
  <span id="circuitstatefn-traverse" />
