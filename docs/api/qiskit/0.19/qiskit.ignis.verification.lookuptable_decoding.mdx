---
title: lookuptable_decoding (v0.19)
description: API reference for qiskit.ignis.verification.lookuptable_decoding in qiskit v0.19
in_page_toc_min_heading_level: 1
python_api_type: function
python_api_name: qiskit.ignis.verification.lookuptable_decoding
---

<span id="lookuptable-decoding" />
