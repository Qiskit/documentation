---
title: ReadoutError (v0.19)
description: API reference for qiskit.providers.aer.noise.ReadoutError in qiskit v0.19
...
<Class id="qiskit.providers.aer.noise.ReadoutError" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-aer/tree/stable/0.5/qiskit/providers/aer/noise/errors/readout_error.py" signature="ReadoutError(probabilities, atol=1e-08)" modifiers="class">
  ...
  *   **atol** (*double*) – Threshold for checking probabilities are normalized (Default: 1e-8).
  ...
  <span id="readouterror-number-of-qubits" />
  ...
  <span id="readouterror-probabilities" />
  ...
  <span id="readouterror-mul" />

  ### \_\_mul\_\_

  <Function id="qiskit.providers.aer.noise.ReadoutError.__mul__" signature="ReadoutError.__mul__(other)" />

  <span id="readouterror-compose" />
  ...
  <span id="readouterror-to-instruction" />
