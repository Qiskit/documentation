...
<Class id="qiskit.providers.aer.noise.ReadoutError" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-aer/tree/stable/0.5/qiskit/providers/aer/noise/errors/readout_error.py" signature="ReadoutError(probabilities, atol=1e-08)">
  ...
  *   **atol** (*double*) – Threshold for checking probabilities are normalized (Default: 1e-8).
  ...
  <Function id="qiskit.providers.aer.noise.ReadoutError.__mul__" name="__mul__" signature="ReadoutError.__mul__(other)" />
