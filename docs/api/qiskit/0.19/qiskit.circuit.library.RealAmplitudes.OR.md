---
title: OR
description: API reference for qiskit.circuit.library.RealAmplitudes.OR
in_page_toc_min_heading_level: 1
python_api_type: method
python_api_name: qiskit.circuit.library.RealAmplitudes.OR
---

# OR

<span id="qiskit.circuit.library.RealAmplitudes.OR" />
