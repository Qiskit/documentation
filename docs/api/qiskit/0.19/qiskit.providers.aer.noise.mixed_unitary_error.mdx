...
<Function id="qiskit.providers.aer.noise.mixed_unitary_error" github="https://github.com/qiskit/qiskit-aer/tree/stable/0.5/qiskit/providers/aer/noise/errors/standard_errors.py" signature="mixed_unitary_error(noise_ops, standard_gates=True)">
