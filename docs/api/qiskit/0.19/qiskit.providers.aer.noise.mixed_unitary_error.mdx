---
title: mixed_unitary_error (v0.19)
description: API reference for qiskit.providers.aer.noise.mixed_unitary_error in qiskit v0.19
in_page_toc_min_heading_level: 1
python_api_type: function
python_api_name: qiskit.providers.aer.noise.mixed_unitary_error
---

<span id="mixed-unitary-error" />

# mixed\_unitary\_error

<Function id="qiskit.providers.aer.noise.mixed_unitary_error" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-aer/tree/stable/0.5/qiskit/providers/aer/noise/errors/standard_errors.py" signature="mixed_unitary_error(noise_ops, standard_gates=True)">
