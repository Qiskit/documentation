---
title: QuantumCircuit (v0.19)
description: API reference for qiskit.circuit.QuantumCircuit in qiskit v0.19
...
<Class id="qiskit.circuit.QuantumCircuit" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.14/qiskit/circuit/quantumcircuit.py" signature="QuantumCircuit(*regs, name=None)" modifiers="class">
  ...
  **Examples**
  ...
  <span id="quantumcircuit-extension-lib" />

  ### extension\_lib

  <Attribute id="qiskit.circuit.QuantumCircuit.extension_lib" attributeValue="'include &#x22;qelib1.inc&#x22;;'" />

  <span id="quantumcircuit-header" />

  ### header

  <Attribute id="qiskit.circuit.QuantumCircuit.header" attributeValue="'OPENQASM 2.0;'" />

  <span id="quantumcircuit-instances" />

  ### instances

  <Attribute id="qiskit.circuit.QuantumCircuit.instances" attributeValue="8" />

  <span id="quantumcircuit-n-qubits" />

  ### n\_qubits

  <Attribute id="qiskit.circuit.QuantumCircuit.n_qubits">
    Deprecated, use `num_qubits` instead. Return number of qubits.
  </Attribute>

  <span id="quantumcircuit-num-clbits" />
  ...
  <span id="quantumcircuit-num-parameters" />
  ...
  <span id="quantumcircuit-num-qubits" />
  ...
  <span id="quantumcircuit-parameters" />
  ...
  <span id="quantumcircuit-and" />

  ### AND

  <Function id="qiskit.circuit.QuantumCircuit.AND" signature="QuantumCircuit.AND(qr_variables, qb_target, qr_ancillae, flags=None, mct_mode='no-ancilla')">
  ...
  <span id="quantumcircuit-or" />

  ### OR

  <Function id="qiskit.circuit.QuantumCircuit.OR" signature="QuantumCircuit.OR(qr_variables, qb_target, qr_ancillae, flags=None, mct_mode='basic')">
  ...
  <span id="quantumcircuit-getitem" />

  ### \_\_getitem\_\_

  <Function id="qiskit.circuit.QuantumCircuit.__getitem__" signature="QuantumCircuit.__getitem__(item)">
    Return indexed operation.
  </Function>

  <span id="quantumcircuit-len" />

  ### \_\_len\_\_

  <Function id="qiskit.circuit.QuantumCircuit.__len__" signature="QuantumCircuit.__len__()">
    Return number of operations in circuit.
  </Function>

  <span id="quantumcircuit-add-register" />
  ...
  <span id="quantumcircuit-assign-parameters" />

  ### assign\_parameters

  <Function id="qiskit.circuit.QuantumCircuit.assign_parameters" signature="QuantumCircuit.assign_parameters(param_dict, inplace=False)">
  ...
  <span id="quantumcircuit-barrier" />
  ...
  <span id="quantumcircuit-bind-parameters" />

  ### bind\_parameters

  <Function id="qiskit.circuit.QuantumCircuit.bind_parameters" signature="QuantumCircuit.bind_parameters(value_dict)">
  ...
  <span id="quantumcircuit-cbit-argument-conversion" />
  ...
  <span id="quantumcircuit-ccx" />

  ### ccx

  <Function id="qiskit.circuit.QuantumCircuit.ccx" signature="QuantumCircuit.ccx(control_qubit1, control_qubit2, target_qubit, *, ctl1=None, ctl2=None, tgt=None)">
    Apply [`CCXGate`](qiskit.circuit.library.CCXGate "qiskit.circuit.library.CCXGate").
  </Function>

  <span id="quantumcircuit-ch" />

  ### ch

  <Function id="qiskit.circuit.QuantumCircuit.ch" signature="QuantumCircuit.ch(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CHGate`](qiskit.circuit.library.CHGate "qiskit.circuit.library.CHGate").
  </Function>

  <span id="quantumcircuit-cls-instances" />
  ...
  <span id="quantumcircuit-cls-prefix" />
  ...
  <span id="quantumcircuit-cnot" />

  ### cnot

  <Function id="qiskit.circuit.QuantumCircuit.cnot" signature="QuantumCircuit.cnot(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CXGate`](qiskit.circuit.library.CXGate "qiskit.circuit.library.CXGate").
  </Function>

  <span id="quantumcircuit-combine" />
  ...
  <span id="quantumcircuit-compose" />

  ### compose

  <Function id="qiskit.circuit.QuantumCircuit.compose" signature="QuantumCircuit.compose(other, qubits=None, clbits=None, front=False, inplace=False)">
  ...
  <span id="quantumcircuit-count-ops" />
  ...
  <span id="quantumcircuit-crx" />

  ### crx

  <Function id="qiskit.circuit.QuantumCircuit.crx" signature="QuantumCircuit.crx(theta, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CRXGate`](qiskit.circuit.library.CRXGate "qiskit.circuit.library.CRXGate").
  </Function>

  <span id="quantumcircuit-cry" />

  ### cry

  <Function id="qiskit.circuit.QuantumCircuit.cry" signature="QuantumCircuit.cry(theta, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CRYGate`](qiskit.circuit.library.CRYGate "qiskit.circuit.library.CRYGate").
  </Function>

  <span id="quantumcircuit-crz" />

  ### crz

  <Function id="qiskit.circuit.QuantumCircuit.crz" signature="QuantumCircuit.crz(theta, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CRZGate`](qiskit.circuit.library.CRZGate "qiskit.circuit.library.CRZGate").
  </Function>

  <span id="quantumcircuit-cswap" />

  ### cswap

  <Function id="qiskit.circuit.QuantumCircuit.cswap" signature="QuantumCircuit.cswap(control_qubit, target_qubit1, target_qubit2, *, label=None, ctrl_state=None, ctl=None, tgt1=None, tgt2=None)">
    Apply [`CSwapGate`](qiskit.circuit.library.CSwapGate "qiskit.circuit.library.CSwapGate").
  </Function>

  <span id="quantumcircuit-cu1" />

  ### cu1

  <Function id="qiskit.circuit.QuantumCircuit.cu1" signature="QuantumCircuit.cu1(theta, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CU1Gate`](qiskit.circuit.library.CU1Gate "qiskit.circuit.library.CU1Gate").
  </Function>

  <span id="quantumcircuit-cu3" />

  ### cu3

  <Function id="qiskit.circuit.QuantumCircuit.cu3" signature="QuantumCircuit.cu3(theta, phi, lam, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CU3Gate`](qiskit.circuit.library.CU3Gate "qiskit.circuit.library.CU3Gate").
  </Function>

  <span id="quantumcircuit-cx" />

  ### cx

  <Function id="qiskit.circuit.QuantumCircuit.cx" signature="QuantumCircuit.cx(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CXGate`](qiskit.circuit.library.CXGate "qiskit.circuit.library.CXGate").
  </Function>

  <span id="quantumcircuit-cy" />

  ### cy

  <Function id="qiskit.circuit.QuantumCircuit.cy" signature="QuantumCircuit.cy(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CYGate`](qiskit.circuit.library.CYGate "qiskit.circuit.library.CYGate").
  </Function>

  <span id="quantumcircuit-cz" />

  ### cz

  <Function id="qiskit.circuit.QuantumCircuit.cz" signature="QuantumCircuit.cz(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CZGate`](qiskit.circuit.library.CZGate "qiskit.circuit.library.CZGate").
  </Function>

  <span id="quantumcircuit-dcx" />
  ...
  <span id="quantumcircuit-decompose" />
  ...
  <span id="quantumcircuit-diag-gate" />

  ### diag\_gate

  <Function id="qiskit.circuit.QuantumCircuit.diag_gate" signature="QuantumCircuit.diag_gate(diag, qubit)">
    Deprecated version of QuantumCircuit.diagonal.
  </Function>

  <span id="quantumcircuit-diagonal" />
  ...
  <span id="quantumcircuit-fredkin" />

  ### fredkin

  <Function id="qiskit.circuit.QuantumCircuit.fredkin" signature="QuantumCircuit.fredkin(control_qubit, target_qubit1, target_qubit2, *, ctl=None, tgt1=None, tgt2=None)">
    Apply [`CSwapGate`](qiskit.circuit.library.CSwapGate "qiskit.circuit.library.CSwapGate").
  </Function>

  <span id="quantumcircuit-from-qasm-file" />
  ...
  <span id="quantumcircuit-from-qasm-str" />
  ...
  <span id="quantumcircuit-h" />

  ### h

  <Function id="qiskit.circuit.QuantumCircuit.h" signature="QuantumCircuit.h(qubit, *, q=None)">
    Apply [`HGate`](qiskit.circuit.library.HGate "qiskit.circuit.library.HGate").
  </Function>

  <span id="quantumcircuit-hamiltonian" />
  ...
  <span id="quantumcircuit-has-register" />
  ...
  <span id="quantumcircuit-i" />

  ### i

  <Function id="qiskit.circuit.QuantumCircuit.i" signature="QuantumCircuit.i(qubit, *, q=None)">
    Apply [`IGate`](qiskit.circuit.library.IGate "qiskit.circuit.library.IGate").
  </Function>

  <span id="quantumcircuit-id" />

  ### id

  <Function id="qiskit.circuit.QuantumCircuit.id" signature="QuantumCircuit.id(qubit, *, q=None)">
    Apply [`IGate`](qiskit.circuit.library.IGate "qiskit.circuit.library.IGate").
  </Function>

  <span id="quantumcircuit-iden" />

  ### iden

  <Function id="qiskit.circuit.QuantumCircuit.iden" signature="QuantumCircuit.iden(qubit, *, q=None)">
    Deprecated identity gate.
  </Function>

  <span id="quantumcircuit-initialize" />

  ### initialize

  <Function id="qiskit.circuit.QuantumCircuit.initialize" signature="QuantumCircuit.initialize(params, qubits)">
    Apply initialize to circuit.
  </Function>

  <span id="quantumcircuit-inverse" />
  ...
  <span id="quantumcircuit-iso" />

  ### iso

  <Function id="qiskit.circuit.QuantumCircuit.iso" signature="QuantumCircuit.iso(isometry, q_input, q_ancillas_for_output, q_ancillas_zero=None, q_ancillas_dirty=None)">
  ...
  <span id="quantumcircuit-isometry" />

  ### isometry

  <Function id="qiskit.circuit.QuantumCircuit.isometry" signature="QuantumCircuit.isometry(isometry, q_input, q_ancillas_for_output, q_ancillas_zero=None, q_ancillas_dirty=None)">
    Attach an arbitrary isometry from m to n qubits to a circuit. In particular, this allows to attach arbitrary unitaries on n qubits (m=n) or to prepare any state on n qubits (m=0). The decomposition used here was introduced by Iten et al. in [https://arxiv.org/abs/1501.06911](https://arxiv.org/abs/1501.06911).
  ...
  <span id="quantumcircuit-mcmt" />

  ### mcmt

  <Function id="qiskit.circuit.QuantumCircuit.mcmt" signature="QuantumCircuit.mcmt(gate, control_qubits, target_qubits, ancilla_qubits=None, mode='no-ancilla', *, single_control_gate_fun=None, q_controls=None, q_ancillae=None, q_targets=None)">
    Apply a multi-control, multi-target using a generic gate.

    This can also be used to implement a generic multi-control gate, as the target could also be of length 1.
  </Function>

  <span id="quantumcircuit-mcrx" />
  ...
  <span id="quantumcircuit-mcry" />

  ### mcry

  <Function id="qiskit.circuit.QuantumCircuit.mcry" signature="QuantumCircuit.mcry(theta, q_controls, q_target, q_ancillae, mode='basic', use_basis_gates=False)">
  ...
  <span id="quantumcircuit-measure" />
  ...
  <span id="quantumcircuit-measure-active" />
  ...
  <span id="quantumcircuit-measure-all" />
  ...
  <span id="quantumcircuit-mirror" />

  ### mirror

  <Function id="qiskit.circuit.QuantumCircuit.mirror" signature="QuantumCircuit.mirror()">
  ...
  <span id="quantumcircuit-num-connected-components" />
  ...
  <span id="quantumcircuit-num-nonlocal-gates" />
  ...
  <span id="quantumcircuit-num-tensor-factors" />
  ...
  <span id="quantumcircuit-num-unitary-factors" />
  ...
  <span id="quantumcircuit-qasm" />

  ### qasm

  <Function id="qiskit.circuit.QuantumCircuit.qasm" signature="QuantumCircuit.qasm(formatted=False, filename=None)">
  ...
  <span id="quantumcircuit-qbit-argument-conversion" />
  ...
  <span id="quantumcircuit-r" />

  ### r

  <Function id="qiskit.circuit.QuantumCircuit.r" signature="QuantumCircuit.r(theta, phi, qubit, *, q=None)">
    Apply `RGate`.
  </Function>

  <span id="quantumcircuit-rcccx" />
  ...
  <span id="quantumcircuit-remove-final-measurements" />
  ...
  <span id="quantumcircuit-rx" />

  ### rx

  <Function id="qiskit.circuit.QuantumCircuit.rx" signature="QuantumCircuit.rx(theta, qubit, *, label=None, q=None)">
    Apply [`RXGate`](qiskit.circuit.library.RXGate "qiskit.circuit.library.RXGate").
  </Function>

  <span id="quantumcircuit-rxx" />
  ...
  <span id="quantumcircuit-ry" />

  ### ry

  <Function id="qiskit.circuit.QuantumCircuit.ry" signature="QuantumCircuit.ry(theta, qubit, *, label=None, q=None)">
    Apply [`RYGate`](qiskit.circuit.library.RYGate "qiskit.circuit.library.RYGate").
  </Function>

  <span id="quantumcircuit-ryy" />
  ...
  <span id="quantumcircuit-rz" />

  ### rz

  <Function id="qiskit.circuit.QuantumCircuit.rz" signature="QuantumCircuit.rz(phi, qubit, *, q=None)">
    Apply [`RZGate`](qiskit.circuit.library.RZGate "qiskit.circuit.library.RZGate").
  </Function>

  <span id="quantumcircuit-rzx" />
  ...
  <span id="quantumcircuit-s" />

  ### s

  <Function id="qiskit.circuit.QuantumCircuit.s" signature="QuantumCircuit.s(qubit, *, q=None)">
    Apply [`SGate`](qiskit.circuit.library.SGate "qiskit.circuit.library.SGate").
  </Function>

  <span id="quantumcircuit-sdg" />

  ### sdg

  <Function id="qiskit.circuit.QuantumCircuit.sdg" signature="QuantumCircuit.sdg(qubit, *, q=None)">
    Apply [`SdgGate`](qiskit.circuit.library.SdgGate "qiskit.circuit.library.SdgGate").
  </Function>

  <span id="quantumcircuit-size" />
  ...
  <span id="quantumcircuit-snapshot" />
  ...
  <span id="quantumcircuit-snapshot-density-matrix" />
  ...
  <span id="quantumcircuit-snapshot-expectation-value" />
  ...
  <span id="quantumcircuit-snapshot-probabilities" />
  ...
  <span id="quantumcircuit-snapshot-stabilizer" />
  ...
  <span id="quantumcircuit-snapshot-statevector" />
  ...
  <span id="quantumcircuit-t" />

  ### t

  <Function id="qiskit.circuit.QuantumCircuit.t" signature="QuantumCircuit.t(qubit, *, q=None)">
    Apply [`TGate`](qiskit.circuit.library.TGate "qiskit.circuit.library.TGate").
  </Function>

  <span id="quantumcircuit-tdg" />

  ### tdg

  <Function id="qiskit.circuit.QuantumCircuit.tdg" signature="QuantumCircuit.tdg(qubit, *, q=None)">
    Apply [`TdgGate`](qiskit.circuit.library.TdgGate "qiskit.circuit.library.TdgGate").
  </Function>

  <span id="quantumcircuit-to-gate" />

  ### to\_gate

  <Function id="qiskit.circuit.QuantumCircuit.to_gate" signature="QuantumCircuit.to_gate(parameter_map=None)">
  ...
  <span id="quantumcircuit-to-instruction" />

  ### to\_instruction

  <Function id="qiskit.circuit.QuantumCircuit.to_instruction" signature="QuantumCircuit.to_instruction(parameter_map=None)">
  ...
  <span id="quantumcircuit-toffoli" />

  ### toffoli

  <Function id="qiskit.circuit.QuantumCircuit.toffoli" signature="QuantumCircuit.toffoli(control_qubit1, control_qubit2, target_qubit, *, ctl1=None, ctl2=None, tgt=None)">
    Apply [`CCXGate`](qiskit.circuit.library.CCXGate "qiskit.circuit.library.CCXGate").
  </Function>

  <span id="quantumcircuit-u1" />

  ### u1

  <Function id="qiskit.circuit.QuantumCircuit.u1" signature="QuantumCircuit.u1(theta, qubit, *, q=None)">
    Apply [`U1Gate`](qiskit.circuit.library.U1Gate "qiskit.circuit.library.U1Gate").
  </Function>

  <span id="quantumcircuit-u2" />

  ### u2

  <Function id="qiskit.circuit.QuantumCircuit.u2" signature="QuantumCircuit.u2(phi, lam, qubit, *, q=None)">
    Apply [`U2Gate`](qiskit.circuit.library.U2Gate "qiskit.circuit.library.U2Gate").
  </Function>

  <span id="quantumcircuit-u3" />

  ### u3

  <Function id="qiskit.circuit.QuantumCircuit.u3" signature="QuantumCircuit.u3(theta, phi, lam, qubit, *, q=None)">
    Apply [`U3Gate`](qiskit.circuit.library.U3Gate "qiskit.circuit.library.U3Gate").
  </Function>

  <span id="quantumcircuit-uc" />
  ...
  <span id="quantumcircuit-ucg" />

  ### ucg

  <Function id="qiskit.circuit.QuantumCircuit.ucg" signature="QuantumCircuit.ucg(angle_list, q_controls, q_target, up_to_diagonal=False)">
    Deprecated version of uc.
  </Function>

  <span id="quantumcircuit-ucrx" />
  ...
  <span id="quantumcircuit-ucx" />

  ### ucx

  <Function id="qiskit.circuit.QuantumCircuit.ucx" signature="QuantumCircuit.ucx(angle_list, q_controls, q_target)">
    Deprecated version of ucrx.
  </Function>

  <span id="quantumcircuit-ucy" />

  ### ucy

  <Function id="qiskit.circuit.QuantumCircuit.ucy" signature="QuantumCircuit.ucy(angle_list, q_controls, q_target)">
    Deprecated version of ucry.
  </Function>

  <span id="quantumcircuit-ucz" />

  ### ucz

  <Function id="qiskit.circuit.QuantumCircuit.ucz" signature="QuantumCircuit.ucz(angle_list, q_controls, q_target)">
    Deprecated version of ucrz.
  </Function>

  <span id="quantumcircuit-unitary" />
  ...
  <span id="quantumcircuit-x" />

  ### x

  <Function id="qiskit.circuit.QuantumCircuit.x" signature="QuantumCircuit.x(qubit, *, label=None, ctrl_state=None, q=None)">
    Apply [`XGate`](qiskit.circuit.library.XGate "qiskit.circuit.library.XGate").
  </Function>

  <span id="quantumcircuit-y" />

  ### y

  <Function id="qiskit.circuit.QuantumCircuit.y" signature="QuantumCircuit.y(qubit, *, q=None)">
    Apply [`YGate`](qiskit.circuit.library.YGate "qiskit.circuit.library.YGate").
  </Function>

  <span id="quantumcircuit-z" />

  ### z

  <Function id="qiskit.circuit.QuantumCircuit.z" signature="QuantumCircuit.z(qubit, *, q=None)">
