...
<Class id="qiskit.circuit.QuantumCircuit" github="https://github.com/qiskit/qiskit/tree/stable/0.14/qiskit/circuit/quantumcircuit.py" signature="QuantumCircuit(*regs, name=None)">
