...
<Function id="qiskit.tools.backend_monitor" name="backend_monitor" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.14/qiskit/tools/monitor/overview.py" signature="backend_monitor(backend)">
