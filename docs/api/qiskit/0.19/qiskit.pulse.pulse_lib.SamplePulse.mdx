---
title: SamplePulse (v0.19)
description: API reference for qiskit.pulse.pulse_lib.SamplePulse in qiskit v0.19
...
<Class id="qiskit.pulse.pulse_lib.SamplePulse" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.14/qiskit/pulse/pulse_lib/sample_pulse.py" signature="SamplePulse(samples, name=None, epsilon=1e-07)" modifiers="class">
  ...
  *   **epsilon** (`float`) – Pulse sample norm tolerance for clipping. If any sample’s norm exceeds unity by less than or equal to epsilon it will be clipped to unit norm. If the sample norm is greater than 1+epsilon an error will be raised.
  ...
  <span id="samplepulse-id" />

  ### id

  <Attribute id="qiskit.pulse.pulse_lib.SamplePulse.id" attributeTypeHint="int">
  ...
  <span id="samplepulse-samples" />

  ### samples

  <Attribute id="qiskit.pulse.pulse_lib.SamplePulse.samples" attributeTypeHint="numpy.ndarray">
  ...
  <span id="samplepulse-call" />

  ### \_\_call\_\_

  <Function id="qiskit.pulse.pulse_lib.SamplePulse.__call__" signature="SamplePulse.__call__(channel)">
    Call self as a function.
  </Function>

  <span id="samplepulse-draw" />

  ### draw

  <Function id="qiskit.pulse.pulse_lib.SamplePulse.draw" signature="SamplePulse.draw(dt=1, style=None, filename=None, interp_method=None, scale=1, interactive=False, scaling=None)">
