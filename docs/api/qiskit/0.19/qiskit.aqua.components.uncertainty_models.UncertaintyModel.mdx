---
title: UncertaintyModel (v0.19)
description: API reference for qiskit.aqua.components.uncertainty_models.UncertaintyModel in qiskit v0.19
...
<Class id="qiskit.aqua.components.uncertainty_models.UncertaintyModel" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.7/qiskit/aqua/components/uncertainty_models/uncertainty_model.py" signature="UncertaintyModel(num_target_qubits)" modifiers="class">
  ...
  <span id="uncertaintymodel-num-target-qubits" />
  ...
  <span id="uncertaintymodel-build" />
  ...
  <span id="uncertaintymodel-build-controlled" />
  ...
  <span id="uncertaintymodel-build-controlled-inverse" />
  ...
  <span id="uncertaintymodel-build-controlled-inverse-power" />
  ...
  <span id="uncertaintymodel-build-controlled-power" />
  ...
  <span id="uncertaintymodel-build-inverse" />
  ...
  <span id="uncertaintymodel-build-inverse-power" />
  ...
  <span id="uncertaintymodel-build-power" />
  ...
  <span id="uncertaintymodel-get-num-qubits" />
  ...
  <span id="uncertaintymodel-get-num-qubits-controlled" />
  ...
  <span id="uncertaintymodel-required-ancillas" />
  ...
  <span id="uncertaintymodel-required-ancillas-controlled" />
