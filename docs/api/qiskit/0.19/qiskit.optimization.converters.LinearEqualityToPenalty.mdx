---
title: LinearEqualityToPenalty (v0.19)
description: API reference for qiskit.optimization.converters.LinearEqualityToPenalty in qiskit v0.19
...
<Class id="qiskit.optimization.converters.LinearEqualityToPenalty" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.7/qiskit/optimization/converters/linear_equality_to_penalty.py" signature="LinearEqualityToPenalty" modifiers="class">
  ...
  <span id="linearequalitytopenalty-encode" />
