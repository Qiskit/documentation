...
<Class id="qiskit.optimization.converters.LinearEqualityToPenalty" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.7/qiskit/optimization/converters/linear_equality_to_penalty.py" signature="LinearEqualityToPenalty">
  ...
  <Function id="qiskit.optimization.converters.LinearEqualityToPenalty.encode" name="encode" signature="LinearEqualityToPenalty.encode(op, penalty_factor=100000.0, name=None)">
