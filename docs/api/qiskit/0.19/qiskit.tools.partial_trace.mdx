...
<Function id="qiskit.tools.partial_trace" github="https://github.com/qiskit/qiskit/tree/stable/0.14/qiskit/tools/qi/qi.py" signature="partial_trace(state, trace_systems, dimensions=None, reverse=True)">
