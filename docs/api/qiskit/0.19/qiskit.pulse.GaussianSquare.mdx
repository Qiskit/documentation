...
<Class id="qiskit.pulse.GaussianSquare" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.14/qiskit/pulse/pulse_lib/parametric_pulses.py" signature="GaussianSquare(duration, amp, sigma, width, name=None)">
...
$$
  ...
  *   **name** (`Optional`\[`str`]) – Display name for this pulse envelope.
  ...
  <Attribute id="qiskit.pulse.GaussianSquare.amp" name="amp" signature="complex">
  ...
  <Attribute id="qiskit.pulse.GaussianSquare.id" name="id" signature="int">
  ...
  <Attribute id="qiskit.pulse.GaussianSquare.parameters" name="parameters" signature="Dict[str, Any]">
  ...
  <Attribute id="qiskit.pulse.GaussianSquare.sigma" name="sigma" signature="float">
  ...
  <Attribute id="qiskit.pulse.GaussianSquare.width" name="width" signature="float">
  ...
  <Function id="qiskit.pulse.GaussianSquare.__call__" name="__call__" signature="GaussianSquare.__call__(channel)">
    Call self as a function.
  </Function>

  ### draw

  <Function id="qiskit.pulse.GaussianSquare.draw" name="draw" signature="GaussianSquare.draw(dt=1, style=None, filename=None, interp_method=None, scale=1, interactive=False, scaling=None)">
    Plot the pulse.
  ...
  <Function id="qiskit.pulse.GaussianSquare.get_sample_pulse" name="get_sample_pulse" signature="GaussianSquare.get_sample_pulse()">
