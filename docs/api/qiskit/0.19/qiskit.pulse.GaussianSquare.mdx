...
$$
  ...
  *   **name** (`Optional`\[`str`]) – Display name for this pulse envelope.
  ...
  <Attribute id="qiskit.pulse.GaussianSquare.amp" signature="complex">
  ...
  <Attribute id="qiskit.pulse.GaussianSquare.id" signature="int">
  ...
  <Attribute id="qiskit.pulse.GaussianSquare.parameters" signature="Dict[str, Any]">
  ...
  <Attribute id="qiskit.pulse.GaussianSquare.sigma" signature="float">
  ...
  <Attribute id="qiskit.pulse.GaussianSquare.width" signature="float">
