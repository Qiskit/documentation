...
<Function id="qiskit.optimization.applications.ising.vehicle_routing.get_operator" name="get_operator" github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.7/qiskit/optimization/applications/ising/vehicle_routing.py" signature="get_operator(instance, n, K)">
...
<Function id="qiskit.optimization.applications.ising.vehicle_routing.get_vehiclerouting_cost" name="get_vehiclerouting_cost" github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.7/qiskit/optimization/applications/ising/vehicle_routing.py" signature="get_vehiclerouting_cost(instance, n, K, x_sol)">
