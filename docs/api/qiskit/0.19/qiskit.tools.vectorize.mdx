...
<Function id="qiskit.tools.vectorize" name="vectorize" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.14/qiskit/tools/qi/qi.py" signature="vectorize(density_matrix, method='col')">
