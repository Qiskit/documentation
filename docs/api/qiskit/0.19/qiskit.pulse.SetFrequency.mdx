---
title: SetFrequency (v0.19)
description: API reference for qiskit.pulse.SetFrequency in qiskit v0.19
...
<Class id="qiskit.pulse.SetFrequency" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.14/qiskit/pulse/instructions/frequency.py" signature="SetFrequency(frequency, channel, name=None)" modifiers="class">
...
$$
  ...
  *   **name** (`Optional`\[`str`]) – Name of this set channel frequency command.
  ...
  <span id="setfrequency-channel" />

  ### channel

  <Attribute id="qiskit.pulse.SetFrequency.channel" attributeTypeHint="qiskit.pulse.channels.PulseChannel">
  ...
  <span id="setfrequency-channels" />

  ### channels

  <Attribute id="qiskit.pulse.SetFrequency.channels" attributeTypeHint="Tuple[qiskit.pulse.channels.Channel]">
  ...
  <span id="setfrequency-command" />

  ### command

  <Attribute id="qiskit.pulse.SetFrequency.command" attributeTypeHint="qiskit.pulse.commands.command.Command">
  ...
  <span id="setfrequency-duration" />

  ### duration

  <Attribute id="qiskit.pulse.SetFrequency.duration" attributeTypeHint="int">
  ...
  <span id="setfrequency-frequency" />

  ### frequency

  <Attribute id="qiskit.pulse.SetFrequency.frequency" attributeTypeHint="float">
    New frequency.
  ...
  <span id="setfrequency-id" />

  ### id

  <Attribute id="qiskit.pulse.SetFrequency.id" attributeTypeHint="int">
  ...
  <span id="setfrequency-instructions" />

  ### instructions

  <Attribute id="qiskit.pulse.SetFrequency.instructions" attributeTypeHint="Tuple[Tuple[int, qiskit.pulse.instructions.instruction.Instruction]]">
  ...
  <span id="setfrequency-name" />

  ### name

  <Attribute id="qiskit.pulse.SetFrequency.name" attributeTypeHint="str">
  ...
  <span id="setfrequency-operands" />

  ### operands

  <Attribute id="qiskit.pulse.SetFrequency.operands" attributeTypeHint="Tuple">
  ...
  <span id="setfrequency-start-time" />

  ### start\_time

  <Attribute id="qiskit.pulse.SetFrequency.start_time" attributeTypeHint="int">
  ...
  <span id="setfrequency-stop-time" />

  ### stop\_time

  <Attribute id="qiskit.pulse.SetFrequency.stop_time" attributeTypeHint="int">
  ...
  <span id="setfrequency-timeslots" />

  ### timeslots

  <Attribute id="qiskit.pulse.SetFrequency.timeslots" attributeTypeHint="Dict[qiskit.pulse.channels.Channel, List[Tuple[int, int]]]">
  ...
  <span id="setfrequency-ch-duration" />
  ...
  <span id="setfrequency-ch-start-time" />
  ...
  <span id="setfrequency-ch-stop-time" />
  ...
  <span id="setfrequency-draw" />

  ### draw

  <Function id="qiskit.pulse.SetFrequency.draw" signature="SetFrequency.draw(dt=1, style=None, filename=None, interp_method=None, scale=1, channels_to_plot=None, plot_all=False, plot_range=None, interactive=False, table=True, label=False, framechange=True, scaling=None, channels=None)">
  ...
  <span id="setfrequency-union" />

  ### union

  <Function id="qiskit.pulse.SetFrequency.union" signature="SetFrequency.union(*schedules, name=None)">
