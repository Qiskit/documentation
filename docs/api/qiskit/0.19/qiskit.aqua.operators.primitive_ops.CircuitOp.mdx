...
<Class id="qiskit.aqua.operators.primitive_ops.CircuitOp" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.7/qiskit/aqua/operators/primitive_ops/circuit_op.py" signature="CircuitOp(primitive=None, coeff=1.0)">
  ...
  **TypeError** – Unsupported primitive, or primitive has ClassicalRegisters.
  ...
  <Attribute id="qiskit.aqua.operators.primitive_ops.CircuitOp.coeff" signature="Union[int, float, complex, qiskit.circuit.parameterexpression.ParameterExpression]">
  ...
  <Attribute id="qiskit.aqua.operators.primitive_ops.CircuitOp.num_qubits" signature="int">
  ...
  <Attribute id="qiskit.aqua.operators.primitive_ops.CircuitOp.primitive" signature="Union[qiskit.circuit.instruction.Instruction, qiskit.circuit.quantumcircuit.QuantumCircuit, list, numpy.ndarray, scipy.sparse.base.spmatrix, qiskit.quantum_info.operators.operator.Operator, qiskit.quantum_info.operators.pauli.Pauli]">
