...
<Class id="qiskit.aqua.operators.primitive_ops.CircuitOp" github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.7/qiskit/aqua/operators/primitive_ops/circuit_op.py" signature="CircuitOp(primitive=None, coeff=1.0)">
