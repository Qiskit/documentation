---
title: CircuitOp (v0.19)
description: API reference for qiskit.aqua.operators.primitive_ops.CircuitOp in qiskit v0.19
...
<Class id="qiskit.aqua.operators.primitive_ops.CircuitOp" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.7/qiskit/aqua/operators/primitive_ops/circuit_op.py" signature="CircuitOp(primitive=None, coeff=1.0)" modifiers="class">
  ...
  **TypeError** – Unsupported primitive, or primitive has ClassicalRegisters.
  ...
  <span id="circuitop-coeff" />

  ### coeff

  <Attribute id="qiskit.aqua.operators.primitive_ops.CircuitOp.coeff" attributeTypeHint="Union[int, float, complex, qiskit.circuit.parameterexpression.ParameterExpression]">
  ...
  <span id="circuitop-num-qubits" />

  ### num\_qubits

  <Attribute id="qiskit.aqua.operators.primitive_ops.CircuitOp.num_qubits" attributeTypeHint="int">
  ...
  <span id="circuitop-primitive" />

  ### primitive

  <Attribute id="qiskit.aqua.operators.primitive_ops.CircuitOp.primitive" attributeTypeHint="Union[qiskit.circuit.instruction.Instruction, qiskit.circuit.quantumcircuit.QuantumCircuit, list, numpy.ndarray, scipy.sparse.base.spmatrix, qiskit.quantum_info.operators.operator.Operator, qiskit.quantum_info.operators.pauli.Pauli]">
  ...
  <span id="circuitop-mul" />

  ### \_\_mul\_\_

  <Function id="qiskit.aqua.operators.primitive_ops.CircuitOp.__mul__" signature="CircuitOp.__mul__(other)">
  ...
  <span id="circuitop-assign-parameters" />
  ...
  <span id="circuitop-bind-parameters" />
  ...
  <span id="circuitop-compose" />

  ### compose

  <Function id="qiskit.aqua.operators.primitive_ops.CircuitOp.compose" signature="CircuitOp.compose(other)">
  ...
  <span id="circuitop-primitive-strings" />
  ...
  <span id="circuitop-to-circuit-op" />
  ...
  <span id="circuitop-to-instruction" />
  ...
  <span id="circuitop-to-legacy-op" />
  ...
  <span id="circuitop-to-matrix-op" />
