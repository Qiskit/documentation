...
<Class id="qiskit.aqua.operators.primitive_ops.CircuitOp" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.7/qiskit/aqua/operators/primitive_ops/circuit_op.py" signature="CircuitOp(primitive=None, coeff=1.0)">
  ...
  **TypeError** – Unsupported primitive, or primitive has ClassicalRegisters.
  ...
  <Attribute id="qiskit.aqua.operators.primitive_ops.CircuitOp.coeff" name="coeff" signature="Union[int, float, complex, qiskit.circuit.parameterexpression.ParameterExpression]">
  ...
  <Attribute id="qiskit.aqua.operators.primitive_ops.CircuitOp.num_qubits" name="num_qubits" signature="int">
  ...
  <Function id="qiskit.aqua.operators.primitive_ops.CircuitOp.__mul__" name="__mul__" signature="CircuitOp.__mul__(other)">
  ...
  <Function id="qiskit.aqua.operators.primitive_ops.CircuitOp.compose" name="compose" signature="CircuitOp.compose(other)">
