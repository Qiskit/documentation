---
title: PrimitiveOp (v0.19)
description: API reference for qiskit.aqua.operators.primitive_ops.PrimitiveOp in qiskit v0.19
...
<Class id="qiskit.aqua.operators.primitive_ops.PrimitiveOp" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.7/qiskit/aqua/operators/primitive_ops/primitive_op.py" signature="PrimitiveOp(primitive=None, coeff=1.0)" modifiers="class">
  ...
  *   **spmatrix** – MatrixOperator, Pauli): The operator primitive being wrapped.
  ...
  <span id="primitiveop-coeff" />

  ### coeff

  <Attribute id="qiskit.aqua.operators.primitive_ops.PrimitiveOp.coeff" attributeTypeHint="Union[int, float, complex, qiskit.circuit.parameterexpression.ParameterExpression]">
  ...
  <span id="primitiveop-num-qubits" />

  ### num\_qubits

  <Attribute id="qiskit.aqua.operators.primitive_ops.PrimitiveOp.num_qubits" attributeTypeHint="int">
  ...
  <span id="primitiveop-primitive" />

  ### primitive

  <Attribute id="qiskit.aqua.operators.primitive_ops.PrimitiveOp.primitive" attributeTypeHint="Union[qiskit.circuit.instruction.Instruction, qiskit.circuit.quantumcircuit.QuantumCircuit, list, numpy.ndarray, scipy.sparse.base.spmatrix, qiskit.quantum_info.operators.operator.Operator, qiskit.quantum_info.operators.pauli.Pauli]">
  ...
  <span id="primitiveop-mul" />

  ### \_\_mul\_\_

  <Function id="qiskit.aqua.operators.primitive_ops.PrimitiveOp.__mul__" signature="PrimitiveOp.__mul__(other)">
  ...
  <span id="primitiveop-assign-parameters" />
  ...
  <span id="primitiveop-bind-parameters" />
  ...
  <span id="primitiveop-compose" />

  ### compose

  <Function id="qiskit.aqua.operators.primitive_ops.PrimitiveOp.compose" signature="PrimitiveOp.compose(other)">
  ...
  <span id="primitiveop-primitive-strings" />
  ...
  <span id="primitiveop-tensorpower" />
  ...
  <span id="primitiveop-to-circuit" />
  ...
  <span id="primitiveop-to-circuit-op" />
  ...
  <span id="primitiveop-to-instruction" />
  ...
  <span id="primitiveop-to-legacy-op" />
  ...
  <span id="primitiveop-to-matrix-op" />
  ...
  <span id="primitiveop-to-pauli-op" />
