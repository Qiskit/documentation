...
<Class id="qiskit.aqua.operators.primitive_ops.PrimitiveOp" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.7/qiskit/aqua/operators/primitive_ops/primitive_op.py" signature="PrimitiveOp(primitive=None, coeff=1.0)">
  ...
  *   **spmatrix** – MatrixOperator, Pauli): The operator primitive being wrapped.
  ...
  <Attribute id="qiskit.aqua.operators.primitive_ops.PrimitiveOp.coeff" signature="Union[int, float, complex, qiskit.circuit.parameterexpression.ParameterExpression]">
  ...
  <Attribute id="qiskit.aqua.operators.primitive_ops.PrimitiveOp.num_qubits" signature="int">
  ...
  <Attribute id="qiskit.aqua.operators.primitive_ops.PrimitiveOp.primitive" signature="Union[qiskit.circuit.instruction.Instruction, qiskit.circuit.quantumcircuit.QuantumCircuit, list, numpy.ndarray, scipy.sparse.base.spmatrix, qiskit.quantum_info.operators.operator.Operator, qiskit.quantum_info.operators.pauli.Pauli]">
