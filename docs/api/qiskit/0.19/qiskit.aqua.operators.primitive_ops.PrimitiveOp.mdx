...
<Class id="qiskit.aqua.operators.primitive_ops.PrimitiveOp" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.7/qiskit/aqua/operators/primitive_ops/primitive_op.py" signature="PrimitiveOp(primitive=None, coeff=1.0)">
  ...
  *   **spmatrix** – MatrixOperator, Pauli): The operator primitive being wrapped.
  ...
  <Attribute id="qiskit.aqua.operators.primitive_ops.PrimitiveOp.coeff" name="coeff" signature="Union[int, float, complex, qiskit.circuit.parameterexpression.ParameterExpression]">
  ...
  <Attribute id="qiskit.aqua.operators.primitive_ops.PrimitiveOp.num_qubits" name="num_qubits" signature="int">
  ...
  <Function id="qiskit.aqua.operators.primitive_ops.PrimitiveOp.__mul__" name="__mul__" signature="PrimitiveOp.__mul__(other)">
  ...
  <Function id="qiskit.aqua.operators.primitive_ops.PrimitiveOp.compose" name="compose" signature="PrimitiveOp.compose(other)">
