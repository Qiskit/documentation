---
title: Gate (v0.19)
description: API reference for qiskit.circuit.Gate in qiskit v0.19
...
<Class id="qiskit.circuit.Gate" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.14/qiskit/circuit/gate.py" signature="Gate(name, num_qubits, params, label=None)" modifiers="class">
  Unitary gate.
  ...
  *   **label** (`Optional`\[`str`]) – An optional label for the gate.
  ...
  <Attribute id="qiskit.circuit.Gate.label" attributeTypeHint="str">
    Return gate label
  ...
  <span id="gate-add-decomposition" />
  ...
  <span id="gate-broadcast-arguments" />
