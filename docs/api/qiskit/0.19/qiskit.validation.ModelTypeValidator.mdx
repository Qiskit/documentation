...
<Class id="qiskit.validation.ModelTypeValidator" github="https://github.com/qiskit/qiskit/tree/stable/0.14/qiskit/validation/base.py" signature="ModelTypeValidator(*, load_default=<marshmallow.missing>, missing=<marshmallow.missing>, dump_default=<marshmallow.missing>, default=<marshmallow.missing>, data_key=None, attribute=None, validate=None, required=False, allow_none=None, load_only=False, dump_only=False, error_messages=None, metadata=None, **additional_metadata)">
  ...
  <Attribute id="qiskit.validation.ModelTypeValidator.context" name="context">
    The context dictionary for the parent `Schema`.
  </Attribute>

  ### default

  <Attribute id="qiskit.validation.ModelTypeValidator.default" name="default" />

  ### default\_error\_messages

  <Attribute id="qiskit.validation.ModelTypeValidator.default_error_messages" signature="= {'null': 'Field may not be null.', 'required': 'Missing data for required field.', 'validator_failed': 'Invalid value.'}">
  ...
  <Attribute id="qiskit.validation.ModelTypeValidator.missing" name="missing" />

  ### name

  <Attribute id="qiskit.validation.ModelTypeValidator.name" signature="= None" />

  ### parent

  <Attribute id="qiskit.validation.ModelTypeValidator.parent" signature="= None" />

  ### root

  <Attribute id="qiskit.validation.ModelTypeValidator.root" signature="= None" />

  ### valid\_types

  <Attribute id="qiskit.validation.ModelTypeValidator.valid_types" signature="= (,)" />

  ## Methods

  ### check\_type

  <Function id="qiskit.validation.ModelTypeValidator.check_type" name="check_type" signature="ModelTypeValidator.check_type(value, attr, data, **_)">
  ...
  <Function id="qiskit.validation.ModelTypeValidator.deserialize" name="deserialize" signature="ModelTypeValidator.deserialize(value, attr=None, data=None, **kwargs)">
    Deserialize `value`.
  ...
  <Function id="qiskit.validation.ModelTypeValidator.fail" name="fail" signature="ModelTypeValidator.fail(key, **kwargs)">
  ...
  <Function id="qiskit.validation.ModelTypeValidator.get_value" name="get_value" signature="ModelTypeValidator.get_value(obj, attr, accessor=None, default=<marshmallow.missing>)">
  ...
  <Function id="qiskit.validation.ModelTypeValidator.make_error" name="make_error" signature="ModelTypeValidator.make_error(key, **kwargs)">
  ...
  <Function id="qiskit.validation.ModelTypeValidator.make_error_serialize" name="make_error_serialize" signature="ModelTypeValidator.make_error_serialize(key, **kwargs)">
  ...
  <Function id="qiskit.validation.ModelTypeValidator.serialize" name="serialize" signature="ModelTypeValidator.serialize(attr, obj, accessor=None, **kwargs)">
