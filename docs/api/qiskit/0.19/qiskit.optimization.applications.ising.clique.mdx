...
<Function id="qiskit.optimization.applications.ising.clique.get_graph_solution" name="get_graph_solution" github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.7/qiskit/optimization/applications/ising/clique.py" signature="get_graph_solution(x)">
...
<Function id="qiskit.optimization.applications.ising.clique.get_operator" name="get_operator" github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.7/qiskit/optimization/applications/ising/clique.py" signature="get_operator(weight_matrix, K)">
...
<Function id="qiskit.optimization.applications.ising.clique.satisfy_or_not" name="satisfy_or_not" github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.7/qiskit/optimization/applications/ising/clique.py" signature="satisfy_or_not(x, w, K)">
