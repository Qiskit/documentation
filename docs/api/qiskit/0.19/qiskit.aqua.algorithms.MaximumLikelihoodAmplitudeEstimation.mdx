---
title: MaximumLikelihoodAmplitudeEstimation (v0.19)
description: API reference for qiskit.aqua.algorithms.MaximumLikelihoodAmplitudeEstimation in qiskit v0.19
...
<Class id="qiskit.aqua.algorithms.MaximumLikelihoodAmplitudeEstimation" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.7/qiskit/aqua/algorithms/amplitude_estimators/mlae.py" signature="MaximumLikelihoodAmplitudeEstimation(num_oracle_circuits, a_factory=None, q_factory=None, i_objective=None, likelihood_evals=None, quantum_instance=None)" modifiers="class">
  ...
  *   **quantum\_instance** (`Union`\[[`QuantumInstance`](qiskit.aqua.QuantumInstance "qiskit.aqua.quantum_instance.QuantumInstance"), [`BaseBackend`](qiskit.providers.BaseBackend "qiskit.providers.basebackend.BaseBackend"), `None`]) – Quantum Instance or Backend
  ...
  <span id="maximumlikelihoodamplitudeestimation-a-factory" />
  ...
  <span id="maximumlikelihoodamplitudeestimation-backend" />
  ...
  <span id="maximumlikelihoodamplitudeestimation-i-objective" />
  ...
  <span id="maximumlikelihoodamplitudeestimation-q-factory" />
  ...
  <span id="maximumlikelihoodamplitudeestimation-quantum-instance" />
  ...
  <span id="maximumlikelihoodamplitudeestimation-random" />
  ...
  <span id="maximumlikelihoodamplitudeestimation-confidence-interval" />
  ...
  <span id="maximumlikelihoodamplitudeestimation-construct-circuits" />
  ...
  <span id="maximumlikelihoodamplitudeestimation-run" />
  ...
  <span id="maximumlikelihoodamplitudeestimation-set-backend" />
