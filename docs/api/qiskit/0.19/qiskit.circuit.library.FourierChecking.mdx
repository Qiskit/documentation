---
title: FourierChecking (v0.19)
description: API reference for qiskit.circuit.library.FourierChecking in qiskit v0.19
...
<Class id="qiskit.circuit.library.FourierChecking" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.14/qiskit/circuit/library/fourier_checking.py" signature="FourierChecking(f, g)" modifiers="class">
  ...
  **Reference Circuit:**
  ...
  <span id="fourierchecking-clbits" />
  ...
  <span id="fourierchecking-extension-lib" />

  ### extension\_lib

  <Attribute id="qiskit.circuit.library.FourierChecking.extension_lib" attributeValue="'include &#x22;qelib1.inc&#x22;;'" />

  <span id="fourierchecking-header" />

  ### header

  <Attribute id="qiskit.circuit.library.FourierChecking.header" attributeValue="'OPENQASM 2.0;'" />

  <span id="fourierchecking-instances" />

  ### instances

  <Attribute id="qiskit.circuit.library.FourierChecking.instances" attributeValue="8" />

  <span id="fourierchecking-n-qubits" />

  ### n\_qubits

  <Attribute id="qiskit.circuit.library.FourierChecking.n_qubits">
    Deprecated, use `num_qubits` instead. Return number of qubits.
  </Attribute>

  <span id="fourierchecking-num-clbits" />
  ...
  <span id="fourierchecking-num-parameters" />
  ...
  <span id="fourierchecking-num-qubits" />
  ...
  <span id="fourierchecking-parameters" />
  ...
  <span id="fourierchecking-and" />

  ### AND

  <Function id="qiskit.circuit.library.FourierChecking.AND" signature="FourierChecking.AND(qr_variables, qb_target, qr_ancillae, flags=None, mct_mode='no-ancilla')">
  ...
  <span id="fourierchecking-or" />

  ### OR

  <Function id="qiskit.circuit.library.FourierChecking.OR" signature="FourierChecking.OR(qr_variables, qb_target, qr_ancillae, flags=None, mct_mode='basic')">
  ...
  <span id="fourierchecking-getitem" />

  ### \_\_getitem\_\_

  <Function id="qiskit.circuit.library.FourierChecking.__getitem__" signature="FourierChecking.__getitem__(item)">
    Return indexed operation.
  </Function>

  <span id="fourierchecking-len" />

  ### \_\_len\_\_

  <Function id="qiskit.circuit.library.FourierChecking.__len__" signature="FourierChecking.__len__()">
    Return number of operations in circuit.
  </Function>

  <span id="fourierchecking-add-register" />

  ### add\_register

  <Function id="qiskit.circuit.library.FourierChecking.add_register" signature="FourierChecking.add_register(*regs)">
    Add registers.
  </Function>

  <span id="fourierchecking-append" />

  ### append

  <Function id="qiskit.circuit.library.FourierChecking.append" signature="FourierChecking.append(instruction, qargs=None, cargs=None)">
  ...
  <span id="fourierchecking-assign-parameters" />

  ### assign\_parameters

  <Function id="qiskit.circuit.library.FourierChecking.assign_parameters" signature="FourierChecking.assign_parameters(param_dict, inplace=False)">
  ...
  <span id="fourierchecking-barrier" />

  ### barrier

  <Function id="qiskit.circuit.library.FourierChecking.barrier" signature="FourierChecking.barrier(*qargs)">
    Apply `Barrier`. If qargs is None, applies to all.
  </Function>

  <span id="fourierchecking-bind-parameters" />

  ### bind\_parameters

  <Function id="qiskit.circuit.library.FourierChecking.bind_parameters" signature="FourierChecking.bind_parameters(value_dict)">
  ...
  <span id="fourierchecking-cast" />

  ### cast

  <Function id="qiskit.circuit.library.FourierChecking.cast" signature="FourierChecking.cast(value, _type)" modifiers="static">
    Best effort to cast value to type. Otherwise, returns the value.
  </Function>

  <span id="fourierchecking-cbit-argument-conversion" />

  ### cbit\_argument\_conversion

  <Function id="qiskit.circuit.library.FourierChecking.cbit_argument_conversion" signature="FourierChecking.cbit_argument_conversion(clbit_representation)">
  ...
  <span id="fourierchecking-ccx" />

  ### ccx

  <Function id="qiskit.circuit.library.FourierChecking.ccx" signature="FourierChecking.ccx(control_qubit1, control_qubit2, target_qubit, *, ctl1=None, ctl2=None, tgt=None)">
    Apply [`CCXGate`](qiskit.circuit.library.CCXGate "qiskit.circuit.library.CCXGate").
  </Function>

  <span id="fourierchecking-ch" />

  ### ch

  <Function id="qiskit.circuit.library.FourierChecking.ch" signature="FourierChecking.ch(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CHGate`](qiskit.circuit.library.CHGate "qiskit.circuit.library.CHGate").
  </Function>

  <span id="fourierchecking-cls-instances" />

  ### cls\_instances

  <Function id="qiskit.circuit.library.FourierChecking.cls_instances" signature="FourierChecking.cls_instances()" modifiers="classmethod">
    Return the current number of instances of this class, useful for auto naming.
  </Function>

  <span id="fourierchecking-cls-prefix" />

  ### cls\_prefix

  <Function id="qiskit.circuit.library.FourierChecking.cls_prefix" signature="FourierChecking.cls_prefix()" modifiers="classmethod">
    Return the prefix to use for auto naming.
  </Function>

  <span id="fourierchecking-cnot" />

  ### cnot

  <Function id="qiskit.circuit.library.FourierChecking.cnot" signature="FourierChecking.cnot(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CXGate`](qiskit.circuit.library.CXGate "qiskit.circuit.library.CXGate").
  </Function>

  <span id="fourierchecking-combine" />

  ### combine

  <Function id="qiskit.circuit.library.FourierChecking.combine" signature="FourierChecking.combine(rhs)">
  ...
  <span id="fourierchecking-compose" />

  ### compose

  <Function id="qiskit.circuit.library.FourierChecking.compose" signature="FourierChecking.compose(other, qubits=None, clbits=None, front=False, inplace=False)">
  ...
  <span id="fourierchecking-copy" />

  ### copy

  <Function id="qiskit.circuit.library.FourierChecking.copy" signature="FourierChecking.copy(name=None)">
    Copy the circuit.
  ...
  <span id="fourierchecking-count-ops" />

  ### count\_ops

  <Function id="qiskit.circuit.library.FourierChecking.count_ops" signature="FourierChecking.count_ops()">
  ...
  <span id="fourierchecking-crx" />

  ### crx

  <Function id="qiskit.circuit.library.FourierChecking.crx" signature="FourierChecking.crx(theta, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CRXGate`](qiskit.circuit.library.CRXGate "qiskit.circuit.library.CRXGate").
  </Function>

  <span id="fourierchecking-cry" />

  ### cry

  <Function id="qiskit.circuit.library.FourierChecking.cry" signature="FourierChecking.cry(theta, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CRYGate`](qiskit.circuit.library.CRYGate "qiskit.circuit.library.CRYGate").
  </Function>

  <span id="fourierchecking-crz" />

  ### crz

  <Function id="qiskit.circuit.library.FourierChecking.crz" signature="FourierChecking.crz(theta, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CRZGate`](qiskit.circuit.library.CRZGate "qiskit.circuit.library.CRZGate").
  </Function>

  <span id="fourierchecking-cswap" />

  ### cswap

  <Function id="qiskit.circuit.library.FourierChecking.cswap" signature="FourierChecking.cswap(control_qubit, target_qubit1, target_qubit2, *, label=None, ctrl_state=None, ctl=None, tgt1=None, tgt2=None)">
    Apply [`CSwapGate`](qiskit.circuit.library.CSwapGate "qiskit.circuit.library.CSwapGate").
  </Function>

  <span id="fourierchecking-cu1" />

  ### cu1

  <Function id="qiskit.circuit.library.FourierChecking.cu1" signature="FourierChecking.cu1(theta, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CU1Gate`](qiskit.circuit.library.CU1Gate "qiskit.circuit.library.CU1Gate").
  </Function>

  <span id="fourierchecking-cu3" />

  ### cu3

  <Function id="qiskit.circuit.library.FourierChecking.cu3" signature="FourierChecking.cu3(theta, phi, lam, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CU3Gate`](qiskit.circuit.library.CU3Gate "qiskit.circuit.library.CU3Gate").
  </Function>

  <span id="fourierchecking-cx" />

  ### cx

  <Function id="qiskit.circuit.library.FourierChecking.cx" signature="FourierChecking.cx(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CXGate`](qiskit.circuit.library.CXGate "qiskit.circuit.library.CXGate").
  </Function>

  <span id="fourierchecking-cy" />

  ### cy

  <Function id="qiskit.circuit.library.FourierChecking.cy" signature="FourierChecking.cy(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CYGate`](qiskit.circuit.library.CYGate "qiskit.circuit.library.CYGate").
  </Function>

  <span id="fourierchecking-cz" />

  ### cz

  <Function id="qiskit.circuit.library.FourierChecking.cz" signature="FourierChecking.cz(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CZGate`](qiskit.circuit.library.CZGate "qiskit.circuit.library.CZGate").
  </Function>

  <span id="fourierchecking-dcx" />

  ### dcx

  <Function id="qiskit.circuit.library.FourierChecking.dcx" signature="FourierChecking.dcx(qubit1, qubit2)">
    Apply [`DCXGate`](qiskit.circuit.library.DCXGate "qiskit.circuit.library.DCXGate").
  </Function>

  <span id="fourierchecking-decompose" />

  ### decompose

  <Function id="qiskit.circuit.library.FourierChecking.decompose" signature="FourierChecking.decompose()">
  ...
  <span id="fourierchecking-depth" />

  ### depth

  <Function id="qiskit.circuit.library.FourierChecking.depth" signature="FourierChecking.depth()">
  ...
  <span id="fourierchecking-diag-gate" />

  ### diag\_gate

  <Function id="qiskit.circuit.library.FourierChecking.diag_gate" signature="FourierChecking.diag_gate(diag, qubit)">
    Deprecated version of QuantumCircuit.diagonal.
  </Function>

  <span id="fourierchecking-diagonal" />

  ### diagonal

  <Function id="qiskit.circuit.library.FourierChecking.diagonal" signature="FourierChecking.diagonal(diag, qubit)">
  ...
  <span id="fourierchecking-extend" />

  ### extend

  <Function id="qiskit.circuit.library.FourierChecking.extend" signature="FourierChecking.extend(rhs)">
  ...
  <span id="fourierchecking-fredkin" />

  ### fredkin

  <Function id="qiskit.circuit.library.FourierChecking.fredkin" signature="FourierChecking.fredkin(control_qubit, target_qubit1, target_qubit2, *, ctl=None, tgt1=None, tgt2=None)">
    Apply [`CSwapGate`](qiskit.circuit.library.CSwapGate "qiskit.circuit.library.CSwapGate").
  </Function>

  <span id="fourierchecking-from-qasm-file" />

  ### from\_qasm\_file

  <Function id="qiskit.circuit.library.FourierChecking.from_qasm_file" signature="FourierChecking.from_qasm_file(path)" modifiers="static">
  ...
  <span id="fourierchecking-from-qasm-str" />

  ### from\_qasm\_str

  <Function id="qiskit.circuit.library.FourierChecking.from_qasm_str" signature="FourierChecking.from_qasm_str(qasm_str)" modifiers="static">
  ...
  <span id="fourierchecking-h" />

  ### h

  <Function id="qiskit.circuit.library.FourierChecking.h" signature="FourierChecking.h(qubit, *, q=None)">
    Apply [`HGate`](qiskit.circuit.library.HGate "qiskit.circuit.library.HGate").
  </Function>

  <span id="fourierchecking-hamiltonian" />

  ### hamiltonian

  <Function id="qiskit.circuit.library.FourierChecking.hamiltonian" signature="FourierChecking.hamiltonian(operator, time, qubits, label=None)">
    Apply hamiltonian evolution to to qubits.
  </Function>

  <span id="fourierchecking-has-register" />

  ### has\_register

  <Function id="qiskit.circuit.library.FourierChecking.has_register" signature="FourierChecking.has_register(register)">
  ...
  <span id="fourierchecking-i" />

  ### i

  <Function id="qiskit.circuit.library.FourierChecking.i" signature="FourierChecking.i(qubit, *, q=None)">
    Apply [`IGate`](qiskit.circuit.library.IGate "qiskit.circuit.library.IGate").
  </Function>

  <span id="fourierchecking-id" />

  ### id

  <Function id="qiskit.circuit.library.FourierChecking.id" signature="FourierChecking.id(qubit, *, q=None)">
    Apply [`IGate`](qiskit.circuit.library.IGate "qiskit.circuit.library.IGate").
  </Function>

  <span id="fourierchecking-iden" />

  ### iden

  <Function id="qiskit.circuit.library.FourierChecking.iden" signature="FourierChecking.iden(qubit, *, q=None)">
    Deprecated identity gate.
  </Function>

  <span id="fourierchecking-initialize" />

  ### initialize

  <Function id="qiskit.circuit.library.FourierChecking.initialize" signature="FourierChecking.initialize(params, qubits)">
    Apply initialize to circuit.
  </Function>

  <span id="fourierchecking-inverse" />

  ### inverse

  <Function id="qiskit.circuit.library.FourierChecking.inverse" signature="FourierChecking.inverse()">
    Invert this circuit.
  ...
  <span id="fourierchecking-iso" />

  ### iso

  <Function id="qiskit.circuit.library.FourierChecking.iso" signature="FourierChecking.iso(isometry, q_input, q_ancillas_for_output, q_ancillas_zero=None, q_ancillas_dirty=None)">
  ...
  <span id="fourierchecking-isometry" />

  ### isometry

  <Function id="qiskit.circuit.library.FourierChecking.isometry" signature="FourierChecking.isometry(isometry, q_input, q_ancillas_for_output, q_ancillas_zero=None, q_ancillas_dirty=None)">
    Attach an arbitrary isometry from m to n qubits to a circuit. In particular, this allows to attach arbitrary unitaries on n qubits (m=n) or to prepare any state on n qubits (m=0). The decomposition used here was introduced by Iten et al. in [https://arxiv.org/abs/1501.06911](https://arxiv.org/abs/1501.06911).
  ...
  <span id="fourierchecking-iswap" />

  ### iswap

  <Function id="qiskit.circuit.library.FourierChecking.iswap" signature="FourierChecking.iswap(qubit1, qubit2)">
    Apply [`iSwapGate`](qiskit.circuit.library.iSwapGate "qiskit.circuit.library.iSwapGate").
  </Function>

  <span id="fourierchecking-mcmt" />

  ### mcmt

  <Function id="qiskit.circuit.library.FourierChecking.mcmt" signature="FourierChecking.mcmt(gate, control_qubits, target_qubits, ancilla_qubits=None, mode='no-ancilla', *, single_control_gate_fun=None, q_controls=None, q_ancillae=None, q_targets=None)">
    Apply a multi-control, multi-target using a generic gate.

    This can also be used to implement a generic multi-control gate, as the target could also be of length 1.
  </Function>

  <span id="fourierchecking-mcrx" />

  ### mcrx

  <Function id="qiskit.circuit.library.FourierChecking.mcrx" signature="FourierChecking.mcrx(theta, q_controls, q_target, use_basis_gates=False)">
  ...
  <span id="fourierchecking-mcry" />

  ### mcry

  <Function id="qiskit.circuit.library.FourierChecking.mcry" signature="FourierChecking.mcry(theta, q_controls, q_target, q_ancillae, mode='basic', use_basis_gates=False)">
  ...
  <span id="fourierchecking-mcrz" />

  ### mcrz

  <Function id="qiskit.circuit.library.FourierChecking.mcrz" signature="FourierChecking.mcrz(lam, q_controls, q_target, use_basis_gates=False)">
  ...
  <span id="fourierchecking-mct" />

  ### mct

  <Function id="qiskit.circuit.library.FourierChecking.mct" signature="FourierChecking.mct(control_qubits, target_qubit, ancilla_qubits=None, mode='noancilla')">
    Apply `MCXGate`.
  </Function>

  <span id="fourierchecking-mcu1" />

  ### mcu1

  <Function id="qiskit.circuit.library.FourierChecking.mcu1" signature="FourierChecking.mcu1(lam, control_qubits, target_qubit)">
    Apply `MCU1Gate`.
  </Function>

  <span id="fourierchecking-mcx" />

  ### mcx

  <Function id="qiskit.circuit.library.FourierChecking.mcx" signature="FourierChecking.mcx(control_qubits, target_qubit, ancilla_qubits=None, mode='noancilla')">
    Apply `MCXGate`.
  ...
  <span id="fourierchecking-measure" />

  ### measure

  <Function id="qiskit.circuit.library.FourierChecking.measure" signature="FourierChecking.measure(qubit, cbit)">
  ...
  <span id="fourierchecking-measure-active" />

  ### measure\_active

  <Function id="qiskit.circuit.library.FourierChecking.measure_active" signature="FourierChecking.measure_active(inplace=True)">
  ...
  <span id="fourierchecking-measure-all" />

  ### measure\_all

  <Function id="qiskit.circuit.library.FourierChecking.measure_all" signature="FourierChecking.measure_all(inplace=True)">
  ...
  <span id="fourierchecking-mirror" />

  ### mirror

  <Function id="qiskit.circuit.library.FourierChecking.mirror" signature="FourierChecking.mirror()">
  ...
  <span id="fourierchecking-ms" />

  ### ms

  <Function id="qiskit.circuit.library.FourierChecking.ms" signature="FourierChecking.ms(theta, qubits)">
    Apply [`MSGate`](qiskit.circuit.library.MSGate "qiskit.circuit.library.MSGate").
  </Function>

  <span id="fourierchecking-num-connected-components" />

  ### num\_connected\_components

  <Function id="qiskit.circuit.library.FourierChecking.num_connected_components" signature="FourierChecking.num_connected_components(unitary_only=False)">
  ...
  <span id="fourierchecking-num-nonlocal-gates" />

  ### num\_nonlocal\_gates

  <Function id="qiskit.circuit.library.FourierChecking.num_nonlocal_gates" signature="FourierChecking.num_nonlocal_gates()">
    Return number of non-local gates (i.e. involving 2+ qubits).

    Conditional nonlocal gates are also included.
  </Function>

  <span id="fourierchecking-num-tensor-factors" />

  ### num\_tensor\_factors

  <Function id="qiskit.circuit.library.FourierChecking.num_tensor_factors" signature="FourierChecking.num_tensor_factors()">
  ...
  <span id="fourierchecking-num-unitary-factors" />

  ### num\_unitary\_factors

  <Function id="qiskit.circuit.library.FourierChecking.num_unitary_factors" signature="FourierChecking.num_unitary_factors()">
    Computes the number of tensor factors in the unitary (quantum) part of the circuit only.
  </Function>

  <span id="fourierchecking-qasm" />

  ### qasm

  <Function id="qiskit.circuit.library.FourierChecking.qasm" signature="FourierChecking.qasm(formatted=False, filename=None)">
  ...
  <span id="fourierchecking-qbit-argument-conversion" />

  ### qbit\_argument\_conversion

  <Function id="qiskit.circuit.library.FourierChecking.qbit_argument_conversion" signature="FourierChecking.qbit_argument_conversion(qubit_representation)">
  ...
  <span id="fourierchecking-r" />

  ### r

  <Function id="qiskit.circuit.library.FourierChecking.r" signature="FourierChecking.r(theta, phi, qubit, *, q=None)">
    Apply `RGate`.
  </Function>

  <span id="fourierchecking-rcccx" />

  ### rcccx

  <Function id="qiskit.circuit.library.FourierChecking.rcccx" signature="FourierChecking.rcccx(control_qubit1, control_qubit2, control_qubit3, target_qubit)">
    Apply [`RC3XGate`](qiskit.circuit.library.RC3XGate "qiskit.circuit.library.RC3XGate").
  </Function>

  <span id="fourierchecking-rccx" />

  ### rccx

  <Function id="qiskit.circuit.library.FourierChecking.rccx" signature="FourierChecking.rccx(control_qubit1, control_qubit2, target_qubit)">
    Apply [`RCCXGate`](qiskit.circuit.library.RCCXGate "qiskit.circuit.library.RCCXGate").
  </Function>

  <span id="fourierchecking-remove-final-measurements" />

  ### remove\_final\_measurements

  <Function id="qiskit.circuit.library.FourierChecking.remove_final_measurements" signature="FourierChecking.remove_final_measurements(inplace=True)">
  ...
  <span id="fourierchecking-reset" />

  ### reset

  <Function id="qiskit.circuit.library.FourierChecking.reset" signature="FourierChecking.reset(qubit)">
    Reset q.
  </Function>

  <span id="fourierchecking-rx" />

  ### rx

  <Function id="qiskit.circuit.library.FourierChecking.rx" signature="FourierChecking.rx(theta, qubit, *, label=None, q=None)">
    Apply [`RXGate`](qiskit.circuit.library.RXGate "qiskit.circuit.library.RXGate").
  </Function>

  <span id="fourierchecking-rxx" />

  ### rxx

  <Function id="qiskit.circuit.library.FourierChecking.rxx" signature="FourierChecking.rxx(theta, qubit1, qubit2)">
    Apply [`RXXGate`](qiskit.circuit.library.RXXGate "qiskit.circuit.library.RXXGate").
  </Function>

  <span id="fourierchecking-ry" />

  ### ry

  <Function id="qiskit.circuit.library.FourierChecking.ry" signature="FourierChecking.ry(theta, qubit, *, label=None, q=None)">
    Apply [`RYGate`](qiskit.circuit.library.RYGate "qiskit.circuit.library.RYGate").
  </Function>

  <span id="fourierchecking-ryy" />

  ### ryy

  <Function id="qiskit.circuit.library.FourierChecking.ryy" signature="FourierChecking.ryy(theta, qubit1, qubit2)">
    Apply [`RYYGate`](qiskit.circuit.library.RYYGate "qiskit.circuit.library.RYYGate").
  </Function>

  <span id="fourierchecking-rz" />

  ### rz

  <Function id="qiskit.circuit.library.FourierChecking.rz" signature="FourierChecking.rz(phi, qubit, *, q=None)">
    Apply [`RZGate`](qiskit.circuit.library.RZGate "qiskit.circuit.library.RZGate").
  </Function>

  <span id="fourierchecking-rzx" />

  ### rzx

  <Function id="qiskit.circuit.library.FourierChecking.rzx" signature="FourierChecking.rzx(theta, qubit1, qubit2)">
    Apply [`RZXGate`](qiskit.circuit.library.RZXGate "qiskit.circuit.library.RZXGate").
  </Function>

  <span id="fourierchecking-rzz" />

  ### rzz

  <Function id="qiskit.circuit.library.FourierChecking.rzz" signature="FourierChecking.rzz(theta, qubit1, qubit2)">
    Apply [`RZZGate`](qiskit.circuit.library.RZZGate "qiskit.circuit.library.RZZGate").
  </Function>

  <span id="fourierchecking-s" />

  ### s

  <Function id="qiskit.circuit.library.FourierChecking.s" signature="FourierChecking.s(qubit, *, q=None)">
    Apply [`SGate`](qiskit.circuit.library.SGate "qiskit.circuit.library.SGate").
  </Function>

  <span id="fourierchecking-sdg" />

  ### sdg

  <Function id="qiskit.circuit.library.FourierChecking.sdg" signature="FourierChecking.sdg(qubit, *, q=None)">
    Apply [`SdgGate`](qiskit.circuit.library.SdgGate "qiskit.circuit.library.SdgGate").
  </Function>

  <span id="fourierchecking-size" />

  ### size

  <Function id="qiskit.circuit.library.FourierChecking.size" signature="FourierChecking.size()">
  ...
  <span id="fourierchecking-snapshot" />

  ### snapshot

  <Function id="qiskit.circuit.library.FourierChecking.snapshot" signature="FourierChecking.snapshot(label, snapshot_type='statevector', qubits=None, params=None)">
  ...
  <span id="fourierchecking-snapshot-density-matrix" />

  ### snapshot\_density\_matrix

  <Function id="qiskit.circuit.library.FourierChecking.snapshot_density_matrix" signature="FourierChecking.snapshot_density_matrix(label, qubits=None)">
  ...
  <span id="fourierchecking-snapshot-expectation-value" />

  ### snapshot\_expectation\_value

  <Function id="qiskit.circuit.library.FourierChecking.snapshot_expectation_value" signature="FourierChecking.snapshot_expectation_value(label, op, qubits, single_shot=False, variance=False)">
  ...
  <span id="fourierchecking-snapshot-probabilities" />

  ### snapshot\_probabilities

  <Function id="qiskit.circuit.library.FourierChecking.snapshot_probabilities" signature="FourierChecking.snapshot_probabilities(label, qubits, variance=False)">
  ...
  <span id="fourierchecking-snapshot-stabilizer" />

  ### snapshot\_stabilizer

  <Function id="qiskit.circuit.library.FourierChecking.snapshot_stabilizer" signature="FourierChecking.snapshot_stabilizer(label)">
  ...
  <span id="fourierchecking-snapshot-statevector" />

  ### snapshot\_statevector

  <Function id="qiskit.circuit.library.FourierChecking.snapshot_statevector" signature="FourierChecking.snapshot_statevector(label)">
  ...
  <span id="fourierchecking-squ" />

  ### squ

  <Function id="qiskit.circuit.library.FourierChecking.squ" signature="FourierChecking.squ(unitary_matrix, qubit, mode='ZYZ', up_to_diagonal=False, *, u=None)">
  ...
  <span id="fourierchecking-swap" />

  ### swap

  <Function id="qiskit.circuit.library.FourierChecking.swap" signature="FourierChecking.swap(qubit1, qubit2)">
    Apply [`SwapGate`](qiskit.circuit.library.SwapGate "qiskit.circuit.library.SwapGate").
  </Function>

  <span id="fourierchecking-t" />

  ### t

  <Function id="qiskit.circuit.library.FourierChecking.t" signature="FourierChecking.t(qubit, *, q=None)">
    Apply [`TGate`](qiskit.circuit.library.TGate "qiskit.circuit.library.TGate").
  </Function>

  <span id="fourierchecking-tdg" />

  ### tdg

  <Function id="qiskit.circuit.library.FourierChecking.tdg" signature="FourierChecking.tdg(qubit, *, q=None)">
    Apply [`TdgGate`](qiskit.circuit.library.TdgGate "qiskit.circuit.library.TdgGate").
  </Function>

  <span id="fourierchecking-to-gate" />

  ### to\_gate

  <Function id="qiskit.circuit.library.FourierChecking.to_gate" signature="FourierChecking.to_gate(parameter_map=None)">
  ...
  <span id="fourierchecking-to-instruction" />

  ### to\_instruction

  <Function id="qiskit.circuit.library.FourierChecking.to_instruction" signature="FourierChecking.to_instruction(parameter_map=None)">
  ...
  <span id="fourierchecking-toffoli" />

  ### toffoli

  <Function id="qiskit.circuit.library.FourierChecking.toffoli" signature="FourierChecking.toffoli(control_qubit1, control_qubit2, target_qubit, *, ctl1=None, ctl2=None, tgt=None)">
    Apply [`CCXGate`](qiskit.circuit.library.CCXGate "qiskit.circuit.library.CCXGate").
  </Function>

  <span id="fourierchecking-u1" />

  ### u1

  <Function id="qiskit.circuit.library.FourierChecking.u1" signature="FourierChecking.u1(theta, qubit, *, q=None)">
    Apply [`U1Gate`](qiskit.circuit.library.U1Gate "qiskit.circuit.library.U1Gate").
  </Function>

  <span id="fourierchecking-u2" />

  ### u2

  <Function id="qiskit.circuit.library.FourierChecking.u2" signature="FourierChecking.u2(phi, lam, qubit, *, q=None)">
    Apply [`U2Gate`](qiskit.circuit.library.U2Gate "qiskit.circuit.library.U2Gate").
  </Function>

  <span id="fourierchecking-u3" />

  ### u3

  <Function id="qiskit.circuit.library.FourierChecking.u3" signature="FourierChecking.u3(theta, phi, lam, qubit, *, q=None)">
    Apply [`U3Gate`](qiskit.circuit.library.U3Gate "qiskit.circuit.library.U3Gate").
  </Function>

  <span id="fourierchecking-uc" />

  ### uc

  <Function id="qiskit.circuit.library.FourierChecking.uc" signature="FourierChecking.uc(gate_list, q_controls, q_target, up_to_diagonal=False)">
  ...
  <span id="fourierchecking-ucg" />

  ### ucg

  <Function id="qiskit.circuit.library.FourierChecking.ucg" signature="FourierChecking.ucg(angle_list, q_controls, q_target, up_to_diagonal=False)">
    Deprecated version of uc.
  </Function>

  <span id="fourierchecking-ucrx" />

  ### ucrx

  <Function id="qiskit.circuit.library.FourierChecking.ucrx" signature="FourierChecking.ucrx(angle_list, q_controls, q_target)">
  ...
  <span id="fourierchecking-ucry" />

  ### ucry

  <Function id="qiskit.circuit.library.FourierChecking.ucry" signature="FourierChecking.ucry(angle_list, q_controls, q_target)">
  ...
  <span id="fourierchecking-ucrz" />

  ### ucrz

  <Function id="qiskit.circuit.library.FourierChecking.ucrz" signature="FourierChecking.ucrz(angle_list, q_controls, q_target)">
  ...
  <span id="fourierchecking-ucx" />

  ### ucx

  <Function id="qiskit.circuit.library.FourierChecking.ucx" signature="FourierChecking.ucx(angle_list, q_controls, q_target)">
    Deprecated version of ucrx.
  </Function>

  <span id="fourierchecking-ucy" />

  ### ucy

  <Function id="qiskit.circuit.library.FourierChecking.ucy" signature="FourierChecking.ucy(angle_list, q_controls, q_target)">
    Deprecated version of ucry.
  </Function>

  <span id="fourierchecking-ucz" />

  ### ucz

  <Function id="qiskit.circuit.library.FourierChecking.ucz" signature="FourierChecking.ucz(angle_list, q_controls, q_target)">
    Deprecated version of ucrz.
  </Function>

  <span id="fourierchecking-unitary" />

  ### unitary

  <Function id="qiskit.circuit.library.FourierChecking.unitary" signature="FourierChecking.unitary(obj, qubits, label=None)">
    Apply unitary gate to q.
  </Function>

  <span id="fourierchecking-width" />

  ### width

  <Function id="qiskit.circuit.library.FourierChecking.width" signature="FourierChecking.width()">
  ...
  <span id="fourierchecking-x" />

  ### x

  <Function id="qiskit.circuit.library.FourierChecking.x" signature="FourierChecking.x(qubit, *, label=None, ctrl_state=None, q=None)">
    Apply [`XGate`](qiskit.circuit.library.XGate "qiskit.circuit.library.XGate").
  </Function>

  <span id="fourierchecking-y" />

  ### y

  <Function id="qiskit.circuit.library.FourierChecking.y" signature="FourierChecking.y(qubit, *, q=None)">
    Apply [`YGate`](qiskit.circuit.library.YGate "qiskit.circuit.library.YGate").
  </Function>

  <span id="fourierchecking-z" />

  ### z

  <Function id="qiskit.circuit.library.FourierChecking.z" signature="FourierChecking.z(qubit, *, q=None)">
