...
<Class id="qiskit.circuit.library.FourierChecking" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.14/qiskit/circuit/library/fourier_checking.py" signature="FourierChecking(f, g)">
  ...
  **Reference Circuit:**
  ...
  <Attribute id="qiskit.circuit.library.FourierChecking.clbits" name="clbits">
    Returns a list of classical bits in the order that the registers were added.
  </Attribute>

  ### data

  <Attribute id="qiskit.circuit.library.FourierChecking.data" name="data">
  ...
  <Attribute id="qiskit.circuit.library.FourierChecking.extension_lib" signature="= 'include \&#x22;qelib1.inc\&#x22;;'" />

  ### header

  <Attribute id="qiskit.circuit.library.FourierChecking.header" signature="= 'OPENQASM 2.0;'" />

  ### instances

  <Attribute id="qiskit.circuit.library.FourierChecking.instances" signature="= 8" />

  ### n\_qubits

  <Attribute id="qiskit.circuit.library.FourierChecking.n_qubits" name="n_qubits">
    Deprecated, use `num_qubits` instead. Return number of qubits.
  </Attribute>

  ### num\_clbits

  <Attribute id="qiskit.circuit.library.FourierChecking.num_clbits" name="num_clbits">
    Return number of classical bits.
  </Attribute>

  ### num\_parameters

  <Attribute id="qiskit.circuit.library.FourierChecking.num_parameters" name="num_parameters">
    Convenience function to get the number of parameter objects in the circuit.
  </Attribute>

  ### num\_qubits

  <Attribute id="qiskit.circuit.library.FourierChecking.num_qubits" name="num_qubits">
    Return number of qubits.
  </Attribute>

  ### parameters

  <Attribute id="qiskit.circuit.library.FourierChecking.parameters" name="parameters">
    Convenience function to get the parameters defined in the parameter table.
  </Attribute>

  ### prefix

  <Attribute id="qiskit.circuit.library.FourierChecking.prefix" signature="= 'circuit'" />

  ### qubits

  <Attribute id="qiskit.circuit.library.FourierChecking.qubits" name="qubits">
  ...
  <Function id="qiskit.circuit.library.FourierChecking.AND" name="AND" signature="FourierChecking.AND(qr_variables, qb_target, qr_ancillae, flags=None, mct_mode='no-ancilla')">
  ...
  <Function id="qiskit.circuit.library.FourierChecking.OR" name="OR" signature="FourierChecking.OR(qr_variables, qb_target, qr_ancillae, flags=None, mct_mode='basic')">
  ...
  <Function id="qiskit.circuit.library.FourierChecking.__getitem__" name="__getitem__" signature="FourierChecking.__getitem__(item)">
    Return indexed operation.
  </Function>

  ### \_\_len\_\_

  <Function id="qiskit.circuit.library.FourierChecking.__len__" name="__len__" signature="FourierChecking.__len__()">
    Return number of operations in circuit.
  </Function>

  ### add\_register

  <Function id="qiskit.circuit.library.FourierChecking.add_register" name="add_register" signature="FourierChecking.add_register(*regs)">
    Add registers.
  </Function>

  ### append

  <Function id="qiskit.circuit.library.FourierChecking.append" name="append" signature="FourierChecking.append(instruction, qargs=None, cargs=None)">
  ...
  <Function id="qiskit.circuit.library.FourierChecking.assign_parameters" name="assign_parameters" signature="FourierChecking.assign_parameters(param_dict, inplace=False)">
  ...
  <Function id="qiskit.circuit.library.FourierChecking.barrier" name="barrier" signature="FourierChecking.barrier(*qargs)">
    Apply `Barrier`. If qargs is None, applies to all.
  </Function>

  ### bind\_parameters

  <Function id="qiskit.circuit.library.FourierChecking.bind_parameters" name="bind_parameters" signature="FourierChecking.bind_parameters(value_dict)">
  ...
  <Function id="qiskit.circuit.library.FourierChecking.cast" name="cast" signature="static FourierChecking.cast(value, _type)">
    Best effort to cast value to type. Otherwise, returns the value.
  </Function>

  ### cbit\_argument\_conversion

  <Function id="qiskit.circuit.library.FourierChecking.cbit_argument_conversion" name="cbit_argument_conversion" signature="FourierChecking.cbit_argument_conversion(clbit_representation)">
  ...
  <Function id="qiskit.circuit.library.FourierChecking.ccx" name="ccx" signature="FourierChecking.ccx(control_qubit1, control_qubit2, target_qubit, *, ctl1=None, ctl2=None, tgt=None)">
    Apply [`CCXGate`](qiskit.circuit.library.CCXGate "qiskit.circuit.library.CCXGate").
  </Function>

  ### ch

  <Function id="qiskit.circuit.library.FourierChecking.ch" name="ch" signature="FourierChecking.ch(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CHGate`](qiskit.circuit.library.CHGate "qiskit.circuit.library.CHGate").
  </Function>

  ### cls\_instances

  <Function id="qiskit.circuit.library.FourierChecking.cls_instances" name="cls_instances" signature="classmethod FourierChecking.cls_instances()">
    Return the current number of instances of this class, useful for auto naming.
  </Function>

  ### cls\_prefix

  <Function id="qiskit.circuit.library.FourierChecking.cls_prefix" name="cls_prefix" signature="classmethod FourierChecking.cls_prefix()">
    Return the prefix to use for auto naming.
  </Function>

  ### cnot

  <Function id="qiskit.circuit.library.FourierChecking.cnot" name="cnot" signature="FourierChecking.cnot(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CXGate`](qiskit.circuit.library.CXGate "qiskit.circuit.library.CXGate").
  </Function>

  ### combine

  <Function id="qiskit.circuit.library.FourierChecking.combine" name="combine" signature="FourierChecking.combine(rhs)">
  ...
  <Function id="qiskit.circuit.library.FourierChecking.compose" name="compose" signature="FourierChecking.compose(other, qubits=None, clbits=None, front=False, inplace=False)">
  ...
  <Function id="qiskit.circuit.library.FourierChecking.copy" name="copy" signature="FourierChecking.copy(name=None)">
    Copy the circuit.
  ...
  <Function id="qiskit.circuit.library.FourierChecking.count_ops" name="count_ops" signature="FourierChecking.count_ops()">
  ...
  <Function id="qiskit.circuit.library.FourierChecking.crx" name="crx" signature="FourierChecking.crx(theta, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CRXGate`](qiskit.circuit.library.CRXGate "qiskit.circuit.library.CRXGate").
  </Function>

  ### cry

  <Function id="qiskit.circuit.library.FourierChecking.cry" name="cry" signature="FourierChecking.cry(theta, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CRYGate`](qiskit.circuit.library.CRYGate "qiskit.circuit.library.CRYGate").
  </Function>

  ### crz

  <Function id="qiskit.circuit.library.FourierChecking.crz" name="crz" signature="FourierChecking.crz(theta, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CRZGate`](qiskit.circuit.library.CRZGate "qiskit.circuit.library.CRZGate").
  </Function>

  ### cswap

  <Function id="qiskit.circuit.library.FourierChecking.cswap" name="cswap" signature="FourierChecking.cswap(control_qubit, target_qubit1, target_qubit2, *, label=None, ctrl_state=None, ctl=None, tgt1=None, tgt2=None)">
    Apply [`CSwapGate`](qiskit.circuit.library.CSwapGate "qiskit.circuit.library.CSwapGate").
  </Function>

  ### cu1

  <Function id="qiskit.circuit.library.FourierChecking.cu1" name="cu1" signature="FourierChecking.cu1(theta, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CU1Gate`](qiskit.circuit.library.CU1Gate "qiskit.circuit.library.CU1Gate").
  </Function>

  ### cu3

  <Function id="qiskit.circuit.library.FourierChecking.cu3" name="cu3" signature="FourierChecking.cu3(theta, phi, lam, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CU3Gate`](qiskit.circuit.library.CU3Gate "qiskit.circuit.library.CU3Gate").
  </Function>

  ### cx

  <Function id="qiskit.circuit.library.FourierChecking.cx" name="cx" signature="FourierChecking.cx(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CXGate`](qiskit.circuit.library.CXGate "qiskit.circuit.library.CXGate").
  </Function>

  ### cy

  <Function id="qiskit.circuit.library.FourierChecking.cy" name="cy" signature="FourierChecking.cy(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CYGate`](qiskit.circuit.library.CYGate "qiskit.circuit.library.CYGate").
  </Function>

  ### cz

  <Function id="qiskit.circuit.library.FourierChecking.cz" name="cz" signature="FourierChecking.cz(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CZGate`](qiskit.circuit.library.CZGate "qiskit.circuit.library.CZGate").
  </Function>

  ### dcx

  <Function id="qiskit.circuit.library.FourierChecking.dcx" name="dcx" signature="FourierChecking.dcx(qubit1, qubit2)">
    Apply [`DCXGate`](qiskit.circuit.library.DCXGate "qiskit.circuit.library.DCXGate").
  </Function>

  ### decompose

  <Function id="qiskit.circuit.library.FourierChecking.decompose" name="decompose" signature="FourierChecking.decompose()">
  ...
  <Function id="qiskit.circuit.library.FourierChecking.depth" name="depth" signature="FourierChecking.depth()">
  ...
  <Function id="qiskit.circuit.library.FourierChecking.diag_gate" name="diag_gate" signature="FourierChecking.diag_gate(diag, qubit)">
    Deprecated version of QuantumCircuit.diagonal.
  </Function>

  ### diagonal

  <Function id="qiskit.circuit.library.FourierChecking.diagonal" name="diagonal" signature="FourierChecking.diagonal(diag, qubit)">
  ...
  <Function id="qiskit.circuit.library.FourierChecking.extend" name="extend" signature="FourierChecking.extend(rhs)">
  ...
  <Function id="qiskit.circuit.library.FourierChecking.fredkin" name="fredkin" signature="FourierChecking.fredkin(control_qubit, target_qubit1, target_qubit2, *, ctl=None, tgt1=None, tgt2=None)">
    Apply [`CSwapGate`](qiskit.circuit.library.CSwapGate "qiskit.circuit.library.CSwapGate").
  </Function>

  ### from\_qasm\_file

  <Function id="qiskit.circuit.library.FourierChecking.from_qasm_file" name="from_qasm_file" signature="static FourierChecking.from_qasm_file(path)">
  ...
  <Function id="qiskit.circuit.library.FourierChecking.from_qasm_str" name="from_qasm_str" signature="static FourierChecking.from_qasm_str(qasm_str)">
  ...
  <Function id="qiskit.circuit.library.FourierChecking.h" name="h" signature="FourierChecking.h(qubit, *, q=None)">
    Apply [`HGate`](qiskit.circuit.library.HGate "qiskit.circuit.library.HGate").
  </Function>

  ### hamiltonian

  <Function id="qiskit.circuit.library.FourierChecking.hamiltonian" name="hamiltonian" signature="FourierChecking.hamiltonian(operator, time, qubits, label=None)">
    Apply hamiltonian evolution to to qubits.
  </Function>

  ### has\_register

  <Function id="qiskit.circuit.library.FourierChecking.has_register" name="has_register" signature="FourierChecking.has_register(register)">
  ...
  <Function id="qiskit.circuit.library.FourierChecking.i" name="i" signature="FourierChecking.i(qubit, *, q=None)">
    Apply [`IGate`](qiskit.circuit.library.IGate "qiskit.circuit.library.IGate").
  </Function>

  ### id

  <Function id="qiskit.circuit.library.FourierChecking.id" name="id" signature="FourierChecking.id(qubit, *, q=None)">
    Apply [`IGate`](qiskit.circuit.library.IGate "qiskit.circuit.library.IGate").
  </Function>

  ### iden

  <Function id="qiskit.circuit.library.FourierChecking.iden" name="iden" signature="FourierChecking.iden(qubit, *, q=None)">
    Deprecated identity gate.
  </Function>

  ### initialize

  <Function id="qiskit.circuit.library.FourierChecking.initialize" name="initialize" signature="FourierChecking.initialize(params, qubits)">
    Apply initialize to circuit.
  </Function>

  ### inverse

  <Function id="qiskit.circuit.library.FourierChecking.inverse" name="inverse" signature="FourierChecking.inverse()">
    Invert this circuit.
  ...
  <Function id="qiskit.circuit.library.FourierChecking.iso" name="iso" signature="FourierChecking.iso(isometry, q_input, q_ancillas_for_output, q_ancillas_zero=None, q_ancillas_dirty=None)">
  ...
  <Function id="qiskit.circuit.library.FourierChecking.isometry" name="isometry" signature="FourierChecking.isometry(isometry, q_input, q_ancillas_for_output, q_ancillas_zero=None, q_ancillas_dirty=None)">
    Attach an arbitrary isometry from m to n qubits to a circuit. In particular, this allows to attach arbitrary unitaries on n qubits (m=n) or to prepare any state on n qubits (m=0). The decomposition used here was introduced by Iten et al. in [https://arxiv.org/abs/1501.06911](https://arxiv.org/abs/1501.06911).
  ...
  <Function id="qiskit.circuit.library.FourierChecking.iswap" name="iswap" signature="FourierChecking.iswap(qubit1, qubit2)">
    Apply [`iSwapGate`](qiskit.circuit.library.iSwapGate "qiskit.circuit.library.iSwapGate").
  </Function>

  ### mcmt

  <Function id="qiskit.circuit.library.FourierChecking.mcmt" name="mcmt" signature="FourierChecking.mcmt(gate, control_qubits, target_qubits, ancilla_qubits=None, mode='no-ancilla', *, single_control_gate_fun=None, q_controls=None, q_ancillae=None, q_targets=None)">
  ...
  <Function id="qiskit.circuit.library.FourierChecking.mcrx" name="mcrx" signature="FourierChecking.mcrx(theta, q_controls, q_target, use_basis_gates=False)">
  ...
  <Function id="qiskit.circuit.library.FourierChecking.mcry" name="mcry" signature="FourierChecking.mcry(theta, q_controls, q_target, q_ancillae, mode='basic', use_basis_gates=False)">
  ...
  <Function id="qiskit.circuit.library.FourierChecking.mcrz" name="mcrz" signature="FourierChecking.mcrz(lam, q_controls, q_target, use_basis_gates=False)">
  ...
  <Function id="qiskit.circuit.library.FourierChecking.mct" name="mct" signature="FourierChecking.mct(control_qubits, target_qubit, ancilla_qubits=None, mode='noancilla')">
    Apply `MCXGate`.
  </Function>

  ### mcu1

  <Function id="qiskit.circuit.library.FourierChecking.mcu1" name="mcu1" signature="FourierChecking.mcu1(lam, control_qubits, target_qubit)">
    Apply `MCU1Gate`.
  </Function>

  ### mcx

  <Function id="qiskit.circuit.library.FourierChecking.mcx" name="mcx" signature="FourierChecking.mcx(control_qubits, target_qubit, ancilla_qubits=None, mode='noancilla')">
    Apply `MCXGate`.
  ...
  <Function id="qiskit.circuit.library.FourierChecking.measure" name="measure" signature="FourierChecking.measure(qubit, cbit)">
  ...
  <Function id="qiskit.circuit.library.FourierChecking.measure_active" name="measure_active" signature="FourierChecking.measure_active(inplace=True)">
  ...
  <Function id="qiskit.circuit.library.FourierChecking.measure_all" name="measure_all" signature="FourierChecking.measure_all(inplace=True)">
  ...
  <Function id="qiskit.circuit.library.FourierChecking.mirror" name="mirror" signature="FourierChecking.mirror()">
  ...
  <Function id="qiskit.circuit.library.FourierChecking.ms" name="ms" signature="FourierChecking.ms(theta, qubits)">
    Apply [`MSGate`](qiskit.circuit.library.MSGate "qiskit.circuit.library.MSGate").
  </Function>

  ### num\_connected\_components

  <Function id="qiskit.circuit.library.FourierChecking.num_connected_components" name="num_connected_components" signature="FourierChecking.num_connected_components(unitary_only=False)">
  ...
  <Function id="qiskit.circuit.library.FourierChecking.num_nonlocal_gates" name="num_nonlocal_gates" signature="FourierChecking.num_nonlocal_gates()">
  ...
  <Function id="qiskit.circuit.library.FourierChecking.num_tensor_factors" name="num_tensor_factors" signature="FourierChecking.num_tensor_factors()">
  ...
  <Function id="qiskit.circuit.library.FourierChecking.num_unitary_factors" name="num_unitary_factors" signature="FourierChecking.num_unitary_factors()">
    Computes the number of tensor factors in the unitary (quantum) part of the circuit only.
  </Function>

  ### qasm

  <Function id="qiskit.circuit.library.FourierChecking.qasm" name="qasm" signature="FourierChecking.qasm(formatted=False, filename=None)">
  ...
  <Function id="qiskit.circuit.library.FourierChecking.qbit_argument_conversion" name="qbit_argument_conversion" signature="FourierChecking.qbit_argument_conversion(qubit_representation)">
  ...
  <Function id="qiskit.circuit.library.FourierChecking.r" name="r" signature="FourierChecking.r(theta, phi, qubit, *, q=None)">
    Apply `RGate`.
  </Function>

  ### rcccx

  <Function id="qiskit.circuit.library.FourierChecking.rcccx" name="rcccx" signature="FourierChecking.rcccx(control_qubit1, control_qubit2, control_qubit3, target_qubit)">
    Apply [`RC3XGate`](qiskit.circuit.library.RC3XGate "qiskit.circuit.library.RC3XGate").
  </Function>

  ### rccx

  <Function id="qiskit.circuit.library.FourierChecking.rccx" name="rccx" signature="FourierChecking.rccx(control_qubit1, control_qubit2, target_qubit)">
    Apply [`RCCXGate`](qiskit.circuit.library.RCCXGate "qiskit.circuit.library.RCCXGate").
  </Function>

  ### remove\_final\_measurements

  <Function id="qiskit.circuit.library.FourierChecking.remove_final_measurements" name="remove_final_measurements" signature="FourierChecking.remove_final_measurements(inplace=True)">
  ...
  <Function id="qiskit.circuit.library.FourierChecking.reset" name="reset" signature="FourierChecking.reset(qubit)">
    Reset q.
  </Function>

  ### rx

  <Function id="qiskit.circuit.library.FourierChecking.rx" name="rx" signature="FourierChecking.rx(theta, qubit, *, label=None, q=None)">
    Apply [`RXGate`](qiskit.circuit.library.RXGate "qiskit.circuit.library.RXGate").
  </Function>

  ### rxx

  <Function id="qiskit.circuit.library.FourierChecking.rxx" name="rxx" signature="FourierChecking.rxx(theta, qubit1, qubit2)">
    Apply [`RXXGate`](qiskit.circuit.library.RXXGate "qiskit.circuit.library.RXXGate").
  </Function>

  ### ry

  <Function id="qiskit.circuit.library.FourierChecking.ry" name="ry" signature="FourierChecking.ry(theta, qubit, *, label=None, q=None)">
    Apply [`RYGate`](qiskit.circuit.library.RYGate "qiskit.circuit.library.RYGate").
  </Function>

  ### ryy

  <Function id="qiskit.circuit.library.FourierChecking.ryy" name="ryy" signature="FourierChecking.ryy(theta, qubit1, qubit2)">
    Apply [`RYYGate`](qiskit.circuit.library.RYYGate "qiskit.circuit.library.RYYGate").
  </Function>

  ### rz

  <Function id="qiskit.circuit.library.FourierChecking.rz" name="rz" signature="FourierChecking.rz(phi, qubit, *, q=None)">
    Apply [`RZGate`](qiskit.circuit.library.RZGate "qiskit.circuit.library.RZGate").
  </Function>

  ### rzx

  <Function id="qiskit.circuit.library.FourierChecking.rzx" name="rzx" signature="FourierChecking.rzx(theta, qubit1, qubit2)">
    Apply [`RZXGate`](qiskit.circuit.library.RZXGate "qiskit.circuit.library.RZXGate").
  </Function>

  ### rzz

  <Function id="qiskit.circuit.library.FourierChecking.rzz" name="rzz" signature="FourierChecking.rzz(theta, qubit1, qubit2)">
    Apply [`RZZGate`](qiskit.circuit.library.RZZGate "qiskit.circuit.library.RZZGate").
  </Function>

  ### s

  <Function id="qiskit.circuit.library.FourierChecking.s" name="s" signature="FourierChecking.s(qubit, *, q=None)">
    Apply [`SGate`](qiskit.circuit.library.SGate "qiskit.circuit.library.SGate").
  </Function>

  ### sdg

  <Function id="qiskit.circuit.library.FourierChecking.sdg" name="sdg" signature="FourierChecking.sdg(qubit, *, q=None)">
    Apply [`SdgGate`](qiskit.circuit.library.SdgGate "qiskit.circuit.library.SdgGate").
  </Function>

  ### size

  <Function id="qiskit.circuit.library.FourierChecking.size" name="size" signature="FourierChecking.size()">
  ...
  <Function id="qiskit.circuit.library.FourierChecking.snapshot" name="snapshot" signature="FourierChecking.snapshot(label, snapshot_type='statevector', qubits=None, params=None)">
  ...
  <Function id="qiskit.circuit.library.FourierChecking.snapshot_density_matrix" name="snapshot_density_matrix" signature="FourierChecking.snapshot_density_matrix(label, qubits=None)">
  ...
  <Function id="qiskit.circuit.library.FourierChecking.snapshot_expectation_value" name="snapshot_expectation_value" signature="FourierChecking.snapshot_expectation_value(label, op, qubits, single_shot=False, variance=False)">
  ...
  <Function id="qiskit.circuit.library.FourierChecking.snapshot_probabilities" name="snapshot_probabilities" signature="FourierChecking.snapshot_probabilities(label, qubits, variance=False)">
  ...
  <Function id="qiskit.circuit.library.FourierChecking.snapshot_stabilizer" name="snapshot_stabilizer" signature="FourierChecking.snapshot_stabilizer(label)">
  ...
  <Function id="qiskit.circuit.library.FourierChecking.snapshot_statevector" name="snapshot_statevector" signature="FourierChecking.snapshot_statevector(label)">
  ...
  <Function id="qiskit.circuit.library.FourierChecking.squ" name="squ" signature="FourierChecking.squ(unitary_matrix, qubit, mode='ZYZ', up_to_diagonal=False, *, u=None)">
  ...
  <Function id="qiskit.circuit.library.FourierChecking.swap" name="swap" signature="FourierChecking.swap(qubit1, qubit2)">
    Apply [`SwapGate`](qiskit.circuit.library.SwapGate "qiskit.circuit.library.SwapGate").
  </Function>

  ### t

  <Function id="qiskit.circuit.library.FourierChecking.t" name="t" signature="FourierChecking.t(qubit, *, q=None)">
    Apply [`TGate`](qiskit.circuit.library.TGate "qiskit.circuit.library.TGate").
  </Function>

  ### tdg

  <Function id="qiskit.circuit.library.FourierChecking.tdg" name="tdg" signature="FourierChecking.tdg(qubit, *, q=None)">
    Apply [`TdgGate`](qiskit.circuit.library.TdgGate "qiskit.circuit.library.TdgGate").
  </Function>

  ### to\_gate

  <Function id="qiskit.circuit.library.FourierChecking.to_gate" name="to_gate" signature="FourierChecking.to_gate(parameter_map=None)">
  ...
  <Function id="qiskit.circuit.library.FourierChecking.to_instruction" name="to_instruction" signature="FourierChecking.to_instruction(parameter_map=None)">
  ...
  <Function id="qiskit.circuit.library.FourierChecking.toffoli" name="toffoli" signature="FourierChecking.toffoli(control_qubit1, control_qubit2, target_qubit, *, ctl1=None, ctl2=None, tgt=None)">
    Apply [`CCXGate`](qiskit.circuit.library.CCXGate "qiskit.circuit.library.CCXGate").
  </Function>

  ### u1

  <Function id="qiskit.circuit.library.FourierChecking.u1" name="u1" signature="FourierChecking.u1(theta, qubit, *, q=None)">
    Apply [`U1Gate`](qiskit.circuit.library.U1Gate "qiskit.circuit.library.U1Gate").
  </Function>

  ### u2

  <Function id="qiskit.circuit.library.FourierChecking.u2" name="u2" signature="FourierChecking.u2(phi, lam, qubit, *, q=None)">
    Apply [`U2Gate`](qiskit.circuit.library.U2Gate "qiskit.circuit.library.U2Gate").
  </Function>

  ### u3

  <Function id="qiskit.circuit.library.FourierChecking.u3" name="u3" signature="FourierChecking.u3(theta, phi, lam, qubit, *, q=None)">
    Apply [`U3Gate`](qiskit.circuit.library.U3Gate "qiskit.circuit.library.U3Gate").
  </Function>

  ### uc

  <Function id="qiskit.circuit.library.FourierChecking.uc" name="uc" signature="FourierChecking.uc(gate_list, q_controls, q_target, up_to_diagonal=False)">
  ...
  <Function id="qiskit.circuit.library.FourierChecking.ucg" name="ucg" signature="FourierChecking.ucg(angle_list, q_controls, q_target, up_to_diagonal=False)">
    Deprecated version of uc.
  </Function>

  ### ucrx

  <Function id="qiskit.circuit.library.FourierChecking.ucrx" name="ucrx" signature="FourierChecking.ucrx(angle_list, q_controls, q_target)">
  ...
  <Function id="qiskit.circuit.library.FourierChecking.ucry" name="ucry" signature="FourierChecking.ucry(angle_list, q_controls, q_target)">
  ...
  <Function id="qiskit.circuit.library.FourierChecking.ucrz" name="ucrz" signature="FourierChecking.ucrz(angle_list, q_controls, q_target)">
  ...
  <Function id="qiskit.circuit.library.FourierChecking.ucx" name="ucx" signature="FourierChecking.ucx(angle_list, q_controls, q_target)">
    Deprecated version of ucrx.
  </Function>

  ### ucy

  <Function id="qiskit.circuit.library.FourierChecking.ucy" name="ucy" signature="FourierChecking.ucy(angle_list, q_controls, q_target)">
    Deprecated version of ucry.
  </Function>

  ### ucz

  <Function id="qiskit.circuit.library.FourierChecking.ucz" name="ucz" signature="FourierChecking.ucz(angle_list, q_controls, q_target)">
    Deprecated version of ucrz.
  </Function>

  ### unitary

  <Function id="qiskit.circuit.library.FourierChecking.unitary" name="unitary" signature="FourierChecking.unitary(obj, qubits, label=None)">
    Apply unitary gate to q.
  </Function>

  ### width

  <Function id="qiskit.circuit.library.FourierChecking.width" name="width" signature="FourierChecking.width()">
  ...
  <Function id="qiskit.circuit.library.FourierChecking.x" name="x" signature="FourierChecking.x(qubit, *, label=None, ctrl_state=None, q=None)">
    Apply [`XGate`](qiskit.circuit.library.XGate "qiskit.circuit.library.XGate").
  </Function>

  ### y

  <Function id="qiskit.circuit.library.FourierChecking.y" name="y" signature="FourierChecking.y(qubit, *, q=None)">
    Apply [`YGate`](qiskit.circuit.library.YGate "qiskit.circuit.library.YGate").
  </Function>

  ### z

  <Function id="qiskit.circuit.library.FourierChecking.z" name="z" signature="FourierChecking.z(qubit, *, q=None)">
