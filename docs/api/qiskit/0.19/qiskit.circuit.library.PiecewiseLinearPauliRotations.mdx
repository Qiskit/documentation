...
<Class id="qiskit.circuit.library.PiecewiseLinearPauliRotations" github="https://github.com/qiskit/qiskit/tree/stable/0.14/qiskit/circuit/library/arithmetic/piecewise_linear_pauli_rotations.py" signature="PiecewiseLinearPauliRotations(num_state_qubits=None, breakpoints=None, slopes=None, offsets=None, basis='Y', name='pw_lin')">
  ...
  *   **name** (`str`) – The name of the circuit.
  ...
  <Attribute id="qiskit.circuit.library.PiecewiseLinearPauliRotations.basis" signature="str">
  ...
  <Attribute id="qiskit.circuit.library.PiecewiseLinearPauliRotations.breakpoints" signature="List[int]">
  ...
  <Attribute id="qiskit.circuit.library.PiecewiseLinearPauliRotations.contains_zero_breakpoint" signature="bool">
  ...
  <Attribute id="qiskit.circuit.library.PiecewiseLinearPauliRotations.mapped_offsets" signature="List[float]">
  ...
  <Attribute id="qiskit.circuit.library.PiecewiseLinearPauliRotations.mapped_slopes" signature="List[float]">
  ...
  <Attribute id="qiskit.circuit.library.PiecewiseLinearPauliRotations.num_ancilla_qubits" signature="int">
  ...
  <Attribute id="qiskit.circuit.library.PiecewiseLinearPauliRotations.num_state_qubits" signature="int">
  ...
  <Attribute id="qiskit.circuit.library.PiecewiseLinearPauliRotations.offsets" signature="List[float]">
    The breakpoints of the piecewise linear function.
  ...
  <Attribute id="qiskit.circuit.library.PiecewiseLinearPauliRotations.slopes" signature="List[int]">
    The breakpoints of the piecewise linear function.
  ...
  <Function id="qiskit.circuit.library.PiecewiseLinearPauliRotations.cast" signature="static PiecewiseLinearPauliRotations.cast(value, _type)">
  ...
  <Function id="qiskit.circuit.library.PiecewiseLinearPauliRotations.cls_instances" signature="classmethod PiecewiseLinearPauliRotations.cls_instances()">
    Return the current number of instances of this class, useful for auto naming.
  </Function>

  ### cls\_prefix

  <Function id="qiskit.circuit.library.PiecewiseLinearPauliRotations.cls_prefix" signature="classmethod PiecewiseLinearPauliRotations.cls_prefix()">
  ...
  <Function id="qiskit.circuit.library.PiecewiseLinearPauliRotations.from_qasm_file" signature="static PiecewiseLinearPauliRotations.from_qasm_file(path)">
  ...
  <Function id="qiskit.circuit.library.PiecewiseLinearPauliRotations.from_qasm_str" signature="static PiecewiseLinearPauliRotations.from_qasm_str(qasm_str)">
