...
$$
  ...
  *   **name** (`str`) – The name of the circuit.
  ...
  <Attribute id="qiskit.circuit.library.PiecewiseLinearPauliRotations.basis" name="basis" signature="str">
  ...
  <Attribute id="qiskit.circuit.library.PiecewiseLinearPauliRotations.breakpoints" name="breakpoints" signature="List[int]">
  ...
  <Attribute id="qiskit.circuit.library.PiecewiseLinearPauliRotations.contains_zero_breakpoint" name="contains_zero_breakpoint" signature="bool">
  ...
  <Attribute id="qiskit.circuit.library.PiecewiseLinearPauliRotations.extension_lib" signature="= 'include \&#x22;qelib1.inc\&#x22;;'" />

  ### header

  <Attribute id="qiskit.circuit.library.PiecewiseLinearPauliRotations.header" signature="= 'OPENQASM 2.0;'" />

  ### instances

  <Attribute id="qiskit.circuit.library.PiecewiseLinearPauliRotations.instances" signature="= 8" />

  ### mapped\_offsets

  <Attribute id="qiskit.circuit.library.PiecewiseLinearPauliRotations.mapped_offsets" name="mapped_offsets" signature="List[float]">
  ...
  <Attribute id="qiskit.circuit.library.PiecewiseLinearPauliRotations.mapped_slopes" name="mapped_slopes" signature="List[float]">
  ...
  <Attribute id="qiskit.circuit.library.PiecewiseLinearPauliRotations.n_qubits" name="n_qubits">
    Deprecated, use `num_qubits` instead. Return number of qubits.
  </Attribute>

  ### num\_ancilla\_qubits

  <Attribute id="qiskit.circuit.library.PiecewiseLinearPauliRotations.num_ancilla_qubits" name="num_ancilla_qubits" signature="int">
  ...
  <Attribute id="qiskit.circuit.library.PiecewiseLinearPauliRotations.num_state_qubits" name="num_state_qubits" signature="int">
  ...
  <Attribute id="qiskit.circuit.library.PiecewiseLinearPauliRotations.offsets" name="offsets" signature="List[float]">
    The breakpoints of the piecewise linear function.
  ...
  <Attribute id="qiskit.circuit.library.PiecewiseLinearPauliRotations.prefix" signature="= 'circuit'" />
  ...
  <Attribute id="qiskit.circuit.library.PiecewiseLinearPauliRotations.slopes" name="slopes" signature="List[int]">
    The breakpoints of the piecewise linear function.
  ...
  <Function id="qiskit.circuit.library.PiecewiseLinearPauliRotations.AND" name="AND" signature="PiecewiseLinearPauliRotations.AND(qr_variables, qb_target, qr_ancillae, flags=None, mct_mode='no-ancilla')">
  ...
  <Function id="qiskit.circuit.library.PiecewiseLinearPauliRotations.OR" name="OR" signature="PiecewiseLinearPauliRotations.OR(qr_variables, qb_target, qr_ancillae, flags=None, mct_mode='basic')">
  ...
  <Function id="qiskit.circuit.library.PiecewiseLinearPauliRotations.__getitem__" name="__getitem__" signature="PiecewiseLinearPauliRotations.__getitem__(item)">
    Return indexed operation.
  </Function>

  ### \_\_len\_\_

  <Function id="qiskit.circuit.library.PiecewiseLinearPauliRotations.__len__" name="__len__" signature="PiecewiseLinearPauliRotations.__len__()">
    Return number of operations in circuit.
  </Function>

  ### add\_register

  <Function id="qiskit.circuit.library.PiecewiseLinearPauliRotations.add_register" name="add_register" signature="PiecewiseLinearPauliRotations.add_register(*regs)">
    Add registers.
  </Function>

  ### append

  <Function id="qiskit.circuit.library.PiecewiseLinearPauliRotations.append" name="append" signature="PiecewiseLinearPauliRotations.append(instruction, qargs=None, cargs=None)">
  ...
  <Function id="qiskit.circuit.library.PiecewiseLinearPauliRotations.assign_parameters" name="assign_parameters" signature="PiecewiseLinearPauliRotations.assign_parameters(param_dict, inplace=False)">
  ...
  <Function id="qiskit.circuit.library.PiecewiseLinearPauliRotations.barrier" name="barrier" signature="PiecewiseLinearPauliRotations.barrier(*qargs)">
    Apply `Barrier`. If qargs is None, applies to all.
  </Function>

  ### bind\_parameters

  <Function id="qiskit.circuit.library.PiecewiseLinearPauliRotations.bind_parameters" name="bind_parameters" signature="PiecewiseLinearPauliRotations.bind_parameters(value_dict)">
  ...
  <Function id="qiskit.circuit.library.PiecewiseLinearPauliRotations.cast" name="cast" signature="static PiecewiseLinearPauliRotations.cast(value, _type)">
    Best effort to cast value to type. Otherwise, returns the value.
  </Function>

  ### cbit\_argument\_conversion

  <Function id="qiskit.circuit.library.PiecewiseLinearPauliRotations.cbit_argument_conversion" name="cbit_argument_conversion" signature="PiecewiseLinearPauliRotations.cbit_argument_conversion(clbit_representation)">
  ...
  <Function id="qiskit.circuit.library.PiecewiseLinearPauliRotations.ccx" name="ccx" signature="PiecewiseLinearPauliRotations.ccx(control_qubit1, control_qubit2, target_qubit, *, ctl1=None, ctl2=None, tgt=None)">
    Apply [`CCXGate`](qiskit.circuit.library.CCXGate "qiskit.circuit.library.CCXGate").
  </Function>

  ### ch

  <Function id="qiskit.circuit.library.PiecewiseLinearPauliRotations.ch" name="ch" signature="PiecewiseLinearPauliRotations.ch(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CHGate`](qiskit.circuit.library.CHGate "qiskit.circuit.library.CHGate").
  </Function>

  ### cls\_instances

  <Function id="qiskit.circuit.library.PiecewiseLinearPauliRotations.cls_instances" name="cls_instances" signature="classmethod PiecewiseLinearPauliRotations.cls_instances()">
    Return the current number of instances of this class, useful for auto naming.
  </Function>

  ### cls\_prefix

  <Function id="qiskit.circuit.library.PiecewiseLinearPauliRotations.cls_prefix" name="cls_prefix" signature="classmethod PiecewiseLinearPauliRotations.cls_prefix()">
    Return the prefix to use for auto naming.
  </Function>

  ### cnot

  <Function id="qiskit.circuit.library.PiecewiseLinearPauliRotations.cnot" name="cnot" signature="PiecewiseLinearPauliRotations.cnot(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CXGate`](qiskit.circuit.library.CXGate "qiskit.circuit.library.CXGate").
  </Function>

  ### combine

  <Function id="qiskit.circuit.library.PiecewiseLinearPauliRotations.combine" name="combine" signature="PiecewiseLinearPauliRotations.combine(rhs)">
  ...
  <Function id="qiskit.circuit.library.PiecewiseLinearPauliRotations.compose" name="compose" signature="PiecewiseLinearPauliRotations.compose(other, qubits=None, clbits=None, front=False, inplace=False)">
  ...
  <Function id="qiskit.circuit.library.PiecewiseLinearPauliRotations.copy" name="copy" signature="PiecewiseLinearPauliRotations.copy(name=None)">
    Copy the circuit.
  ...
  <Function id="qiskit.circuit.library.PiecewiseLinearPauliRotations.count_ops" name="count_ops" signature="PiecewiseLinearPauliRotations.count_ops()">
  ...
  <Function id="qiskit.circuit.library.PiecewiseLinearPauliRotations.crx" name="crx" signature="PiecewiseLinearPauliRotations.crx(theta, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CRXGate`](qiskit.circuit.library.CRXGate "qiskit.circuit.library.CRXGate").
  </Function>

  ### cry

  <Function id="qiskit.circuit.library.PiecewiseLinearPauliRotations.cry" name="cry" signature="PiecewiseLinearPauliRotations.cry(theta, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CRYGate`](qiskit.circuit.library.CRYGate "qiskit.circuit.library.CRYGate").
  </Function>

  ### crz

  <Function id="qiskit.circuit.library.PiecewiseLinearPauliRotations.crz" name="crz" signature="PiecewiseLinearPauliRotations.crz(theta, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CRZGate`](qiskit.circuit.library.CRZGate "qiskit.circuit.library.CRZGate").
  </Function>

  ### cswap

  <Function id="qiskit.circuit.library.PiecewiseLinearPauliRotations.cswap" name="cswap" signature="PiecewiseLinearPauliRotations.cswap(control_qubit, target_qubit1, target_qubit2, *, label=None, ctrl_state=None, ctl=None, tgt1=None, tgt2=None)">
    Apply [`CSwapGate`](qiskit.circuit.library.CSwapGate "qiskit.circuit.library.CSwapGate").
  </Function>

  ### cu1

  <Function id="qiskit.circuit.library.PiecewiseLinearPauliRotations.cu1" name="cu1" signature="PiecewiseLinearPauliRotations.cu1(theta, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CU1Gate`](qiskit.circuit.library.CU1Gate "qiskit.circuit.library.CU1Gate").
  </Function>

  ### cu3

  <Function id="qiskit.circuit.library.PiecewiseLinearPauliRotations.cu3" name="cu3" signature="PiecewiseLinearPauliRotations.cu3(theta, phi, lam, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CU3Gate`](qiskit.circuit.library.CU3Gate "qiskit.circuit.library.CU3Gate").
  </Function>

  ### cx

  <Function id="qiskit.circuit.library.PiecewiseLinearPauliRotations.cx" name="cx" signature="PiecewiseLinearPauliRotations.cx(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CXGate`](qiskit.circuit.library.CXGate "qiskit.circuit.library.CXGate").
  </Function>

  ### cy

  <Function id="qiskit.circuit.library.PiecewiseLinearPauliRotations.cy" name="cy" signature="PiecewiseLinearPauliRotations.cy(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CYGate`](qiskit.circuit.library.CYGate "qiskit.circuit.library.CYGate").
  </Function>

  ### cz

  <Function id="qiskit.circuit.library.PiecewiseLinearPauliRotations.cz" name="cz" signature="PiecewiseLinearPauliRotations.cz(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CZGate`](qiskit.circuit.library.CZGate "qiskit.circuit.library.CZGate").
  </Function>

  ### dcx

  <Function id="qiskit.circuit.library.PiecewiseLinearPauliRotations.dcx" name="dcx" signature="PiecewiseLinearPauliRotations.dcx(qubit1, qubit2)">
    Apply [`DCXGate`](qiskit.circuit.library.DCXGate "qiskit.circuit.library.DCXGate").
  </Function>

  ### decompose

  <Function id="qiskit.circuit.library.PiecewiseLinearPauliRotations.decompose" name="decompose" signature="PiecewiseLinearPauliRotations.decompose()">
  ...
  <Function id="qiskit.circuit.library.PiecewiseLinearPauliRotations.depth" name="depth" signature="PiecewiseLinearPauliRotations.depth()">
  ...
  <Function id="qiskit.circuit.library.PiecewiseLinearPauliRotations.diag_gate" name="diag_gate" signature="PiecewiseLinearPauliRotations.diag_gate(diag, qubit)">
    Deprecated version of QuantumCircuit.diagonal.
  </Function>

  ### diagonal

  <Function id="qiskit.circuit.library.PiecewiseLinearPauliRotations.diagonal" name="diagonal" signature="PiecewiseLinearPauliRotations.diagonal(diag, qubit)">
  ...
  <Function id="qiskit.circuit.library.PiecewiseLinearPauliRotations.extend" name="extend" signature="PiecewiseLinearPauliRotations.extend(rhs)">
  ...
  <Function id="qiskit.circuit.library.PiecewiseLinearPauliRotations.fredkin" name="fredkin" signature="PiecewiseLinearPauliRotations.fredkin(control_qubit, target_qubit1, target_qubit2, *, ctl=None, tgt1=None, tgt2=None)">
    Apply [`CSwapGate`](qiskit.circuit.library.CSwapGate "qiskit.circuit.library.CSwapGate").
  </Function>

  ### from\_qasm\_file

  <Function id="qiskit.circuit.library.PiecewiseLinearPauliRotations.from_qasm_file" name="from_qasm_file" signature="static PiecewiseLinearPauliRotations.from_qasm_file(path)">
  ...
  <Function id="qiskit.circuit.library.PiecewiseLinearPauliRotations.from_qasm_str" name="from_qasm_str" signature="static PiecewiseLinearPauliRotations.from_qasm_str(qasm_str)">
  ...
  <Function id="qiskit.circuit.library.PiecewiseLinearPauliRotations.h" name="h" signature="PiecewiseLinearPauliRotations.h(qubit, *, q=None)">
    Apply [`HGate`](qiskit.circuit.library.HGate "qiskit.circuit.library.HGate").
  </Function>

  ### hamiltonian

  <Function id="qiskit.circuit.library.PiecewiseLinearPauliRotations.hamiltonian" name="hamiltonian" signature="PiecewiseLinearPauliRotations.hamiltonian(operator, time, qubits, label=None)">
    Apply hamiltonian evolution to to qubits.
  </Function>

  ### has\_register

  <Function id="qiskit.circuit.library.PiecewiseLinearPauliRotations.has_register" name="has_register" signature="PiecewiseLinearPauliRotations.has_register(register)">
  ...
  <Function id="qiskit.circuit.library.PiecewiseLinearPauliRotations.i" name="i" signature="PiecewiseLinearPauliRotations.i(qubit, *, q=None)">
    Apply [`IGate`](qiskit.circuit.library.IGate "qiskit.circuit.library.IGate").
  </Function>

  ### id

  <Function id="qiskit.circuit.library.PiecewiseLinearPauliRotations.id" name="id" signature="PiecewiseLinearPauliRotations.id(qubit, *, q=None)">
    Apply [`IGate`](qiskit.circuit.library.IGate "qiskit.circuit.library.IGate").
  </Function>

  ### iden

  <Function id="qiskit.circuit.library.PiecewiseLinearPauliRotations.iden" name="iden" signature="PiecewiseLinearPauliRotations.iden(qubit, *, q=None)">
    Deprecated identity gate.
  </Function>

  ### initialize

  <Function id="qiskit.circuit.library.PiecewiseLinearPauliRotations.initialize" name="initialize" signature="PiecewiseLinearPauliRotations.initialize(params, qubits)">
    Apply initialize to circuit.
  </Function>

  ### inverse

  <Function id="qiskit.circuit.library.PiecewiseLinearPauliRotations.inverse" name="inverse" signature="PiecewiseLinearPauliRotations.inverse()">
    Invert this circuit.
  ...
  <Function id="qiskit.circuit.library.PiecewiseLinearPauliRotations.iso" name="iso" signature="PiecewiseLinearPauliRotations.iso(isometry, q_input, q_ancillas_for_output, q_ancillas_zero=None, q_ancillas_dirty=None)">
  ...
  <Function id="qiskit.circuit.library.PiecewiseLinearPauliRotations.isometry" name="isometry" signature="PiecewiseLinearPauliRotations.isometry(isometry, q_input, q_ancillas_for_output, q_ancillas_zero=None, q_ancillas_dirty=None)">
    Attach an arbitrary isometry from m to n qubits to a circuit. In particular, this allows to attach arbitrary unitaries on n qubits (m=n) or to prepare any state on n qubits (m=0). The decomposition used here was introduced by Iten et al. in [https://arxiv.org/abs/1501.06911](https://arxiv.org/abs/1501.06911).
  ...
  <Function id="qiskit.circuit.library.PiecewiseLinearPauliRotations.iswap" name="iswap" signature="PiecewiseLinearPauliRotations.iswap(qubit1, qubit2)">
    Apply [`iSwapGate`](qiskit.circuit.library.iSwapGate "qiskit.circuit.library.iSwapGate").
  </Function>

  ### mcmt

  <Function id="qiskit.circuit.library.PiecewiseLinearPauliRotations.mcmt" name="mcmt" signature="PiecewiseLinearPauliRotations.mcmt(gate, control_qubits, target_qubits, ancilla_qubits=None, mode='no-ancilla', *, single_control_gate_fun=None, q_controls=None, q_ancillae=None, q_targets=None)">
  ...
  <Function id="qiskit.circuit.library.PiecewiseLinearPauliRotations.mcrx" name="mcrx" signature="PiecewiseLinearPauliRotations.mcrx(theta, q_controls, q_target, use_basis_gates=False)">
  ...
  <Function id="qiskit.circuit.library.PiecewiseLinearPauliRotations.mcry" name="mcry" signature="PiecewiseLinearPauliRotations.mcry(theta, q_controls, q_target, q_ancillae, mode='basic', use_basis_gates=False)">
  ...
  <Function id="qiskit.circuit.library.PiecewiseLinearPauliRotations.mcrz" name="mcrz" signature="PiecewiseLinearPauliRotations.mcrz(lam, q_controls, q_target, use_basis_gates=False)">
  ...
  <Function id="qiskit.circuit.library.PiecewiseLinearPauliRotations.mct" name="mct" signature="PiecewiseLinearPauliRotations.mct(control_qubits, target_qubit, ancilla_qubits=None, mode='noancilla')">
    Apply `MCXGate`.
  </Function>

  ### mcu1

  <Function id="qiskit.circuit.library.PiecewiseLinearPauliRotations.mcu1" name="mcu1" signature="PiecewiseLinearPauliRotations.mcu1(lam, control_qubits, target_qubit)">
    Apply `MCU1Gate`.
  </Function>

  ### mcx

  <Function id="qiskit.circuit.library.PiecewiseLinearPauliRotations.mcx" name="mcx" signature="PiecewiseLinearPauliRotations.mcx(control_qubits, target_qubit, ancilla_qubits=None, mode='noancilla')">
    Apply `MCXGate`.
  ...
  <Function id="qiskit.circuit.library.PiecewiseLinearPauliRotations.measure" name="measure" signature="PiecewiseLinearPauliRotations.measure(qubit, cbit)">
  ...
  <Function id="qiskit.circuit.library.PiecewiseLinearPauliRotations.measure_active" name="measure_active" signature="PiecewiseLinearPauliRotations.measure_active(inplace=True)">
  ...
  <Function id="qiskit.circuit.library.PiecewiseLinearPauliRotations.measure_all" name="measure_all" signature="PiecewiseLinearPauliRotations.measure_all(inplace=True)">
  ...
  <Function id="qiskit.circuit.library.PiecewiseLinearPauliRotations.mirror" name="mirror" signature="PiecewiseLinearPauliRotations.mirror()">
  ...
  <Function id="qiskit.circuit.library.PiecewiseLinearPauliRotations.ms" name="ms" signature="PiecewiseLinearPauliRotations.ms(theta, qubits)">
    Apply [`MSGate`](qiskit.circuit.library.MSGate "qiskit.circuit.library.MSGate").
  </Function>

  ### num\_connected\_components

  <Function id="qiskit.circuit.library.PiecewiseLinearPauliRotations.num_connected_components" name="num_connected_components" signature="PiecewiseLinearPauliRotations.num_connected_components(unitary_only=False)">
  ...
  <Function id="qiskit.circuit.library.PiecewiseLinearPauliRotations.num_nonlocal_gates" name="num_nonlocal_gates" signature="PiecewiseLinearPauliRotations.num_nonlocal_gates()">
  ...
  <Function id="qiskit.circuit.library.PiecewiseLinearPauliRotations.num_tensor_factors" name="num_tensor_factors" signature="PiecewiseLinearPauliRotations.num_tensor_factors()">
  ...
  <Function id="qiskit.circuit.library.PiecewiseLinearPauliRotations.num_unitary_factors" name="num_unitary_factors" signature="PiecewiseLinearPauliRotations.num_unitary_factors()">
    Computes the number of tensor factors in the unitary (quantum) part of the circuit only.
  </Function>

  ### qasm

  <Function id="qiskit.circuit.library.PiecewiseLinearPauliRotations.qasm" name="qasm" signature="PiecewiseLinearPauliRotations.qasm(formatted=False, filename=None)">
  ...
  <Function id="qiskit.circuit.library.PiecewiseLinearPauliRotations.qbit_argument_conversion" name="qbit_argument_conversion" signature="PiecewiseLinearPauliRotations.qbit_argument_conversion(qubit_representation)">
  ...
  <Function id="qiskit.circuit.library.PiecewiseLinearPauliRotations.r" name="r" signature="PiecewiseLinearPauliRotations.r(theta, phi, qubit, *, q=None)">
    Apply `RGate`.
  </Function>

  ### rcccx

  <Function id="qiskit.circuit.library.PiecewiseLinearPauliRotations.rcccx" name="rcccx" signature="PiecewiseLinearPauliRotations.rcccx(control_qubit1, control_qubit2, control_qubit3, target_qubit)">
    Apply [`RC3XGate`](qiskit.circuit.library.RC3XGate "qiskit.circuit.library.RC3XGate").
  </Function>

  ### rccx

  <Function id="qiskit.circuit.library.PiecewiseLinearPauliRotations.rccx" name="rccx" signature="PiecewiseLinearPauliRotations.rccx(control_qubit1, control_qubit2, target_qubit)">
    Apply [`RCCXGate`](qiskit.circuit.library.RCCXGate "qiskit.circuit.library.RCCXGate").
  </Function>

  ### remove\_final\_measurements

  <Function id="qiskit.circuit.library.PiecewiseLinearPauliRotations.remove_final_measurements" name="remove_final_measurements" signature="PiecewiseLinearPauliRotations.remove_final_measurements(inplace=True)">
  ...
  <Function id="qiskit.circuit.library.PiecewiseLinearPauliRotations.reset" name="reset" signature="PiecewiseLinearPauliRotations.reset(qubit)">
    Reset q.
  </Function>

  ### rx

  <Function id="qiskit.circuit.library.PiecewiseLinearPauliRotations.rx" name="rx" signature="PiecewiseLinearPauliRotations.rx(theta, qubit, *, label=None, q=None)">
    Apply [`RXGate`](qiskit.circuit.library.RXGate "qiskit.circuit.library.RXGate").
  </Function>

  ### rxx

  <Function id="qiskit.circuit.library.PiecewiseLinearPauliRotations.rxx" name="rxx" signature="PiecewiseLinearPauliRotations.rxx(theta, qubit1, qubit2)">
    Apply [`RXXGate`](qiskit.circuit.library.RXXGate "qiskit.circuit.library.RXXGate").
  </Function>

  ### ry

  <Function id="qiskit.circuit.library.PiecewiseLinearPauliRotations.ry" name="ry" signature="PiecewiseLinearPauliRotations.ry(theta, qubit, *, label=None, q=None)">
    Apply [`RYGate`](qiskit.circuit.library.RYGate "qiskit.circuit.library.RYGate").
  </Function>

  ### ryy

  <Function id="qiskit.circuit.library.PiecewiseLinearPauliRotations.ryy" name="ryy" signature="PiecewiseLinearPauliRotations.ryy(theta, qubit1, qubit2)">
    Apply [`RYYGate`](qiskit.circuit.library.RYYGate "qiskit.circuit.library.RYYGate").
  </Function>

  ### rz

  <Function id="qiskit.circuit.library.PiecewiseLinearPauliRotations.rz" name="rz" signature="PiecewiseLinearPauliRotations.rz(phi, qubit, *, q=None)">
    Apply [`RZGate`](qiskit.circuit.library.RZGate "qiskit.circuit.library.RZGate").
  </Function>

  ### rzx

  <Function id="qiskit.circuit.library.PiecewiseLinearPauliRotations.rzx" name="rzx" signature="PiecewiseLinearPauliRotations.rzx(theta, qubit1, qubit2)">
    Apply [`RZXGate`](qiskit.circuit.library.RZXGate "qiskit.circuit.library.RZXGate").
  </Function>

  ### rzz

  <Function id="qiskit.circuit.library.PiecewiseLinearPauliRotations.rzz" name="rzz" signature="PiecewiseLinearPauliRotations.rzz(theta, qubit1, qubit2)">
    Apply [`RZZGate`](qiskit.circuit.library.RZZGate "qiskit.circuit.library.RZZGate").
  </Function>

  ### s

  <Function id="qiskit.circuit.library.PiecewiseLinearPauliRotations.s" name="s" signature="PiecewiseLinearPauliRotations.s(qubit, *, q=None)">
    Apply [`SGate`](qiskit.circuit.library.SGate "qiskit.circuit.library.SGate").
  </Function>

  ### sdg

  <Function id="qiskit.circuit.library.PiecewiseLinearPauliRotations.sdg" name="sdg" signature="PiecewiseLinearPauliRotations.sdg(qubit, *, q=None)">
    Apply [`SdgGate`](qiskit.circuit.library.SdgGate "qiskit.circuit.library.SdgGate").
  </Function>

  ### size

  <Function id="qiskit.circuit.library.PiecewiseLinearPauliRotations.size" name="size" signature="PiecewiseLinearPauliRotations.size()">
  ...
  <Function id="qiskit.circuit.library.PiecewiseLinearPauliRotations.snapshot" name="snapshot" signature="PiecewiseLinearPauliRotations.snapshot(label, snapshot_type='statevector', qubits=None, params=None)">
  ...
  <Function id="qiskit.circuit.library.PiecewiseLinearPauliRotations.snapshot_density_matrix" name="snapshot_density_matrix" signature="PiecewiseLinearPauliRotations.snapshot_density_matrix(label, qubits=None)">
  ...
  <Function id="qiskit.circuit.library.PiecewiseLinearPauliRotations.snapshot_expectation_value" name="snapshot_expectation_value" signature="PiecewiseLinearPauliRotations.snapshot_expectation_value(label, op, qubits, single_shot=False, variance=False)">
  ...
  <Function id="qiskit.circuit.library.PiecewiseLinearPauliRotations.snapshot_probabilities" name="snapshot_probabilities" signature="PiecewiseLinearPauliRotations.snapshot_probabilities(label, qubits, variance=False)">
  ...
  <Function id="qiskit.circuit.library.PiecewiseLinearPauliRotations.snapshot_stabilizer" name="snapshot_stabilizer" signature="PiecewiseLinearPauliRotations.snapshot_stabilizer(label)">
  ...
  <Function id="qiskit.circuit.library.PiecewiseLinearPauliRotations.snapshot_statevector" name="snapshot_statevector" signature="PiecewiseLinearPauliRotations.snapshot_statevector(label)">
  ...
  <Function id="qiskit.circuit.library.PiecewiseLinearPauliRotations.squ" name="squ" signature="PiecewiseLinearPauliRotations.squ(unitary_matrix, qubit, mode='ZYZ', up_to_diagonal=False, *, u=None)">
  ...
  <Function id="qiskit.circuit.library.PiecewiseLinearPauliRotations.swap" name="swap" signature="PiecewiseLinearPauliRotations.swap(qubit1, qubit2)">
    Apply [`SwapGate`](qiskit.circuit.library.SwapGate "qiskit.circuit.library.SwapGate").
  </Function>

  ### t

  <Function id="qiskit.circuit.library.PiecewiseLinearPauliRotations.t" name="t" signature="PiecewiseLinearPauliRotations.t(qubit, *, q=None)">
    Apply [`TGate`](qiskit.circuit.library.TGate "qiskit.circuit.library.TGate").
  </Function>

  ### tdg

  <Function id="qiskit.circuit.library.PiecewiseLinearPauliRotations.tdg" name="tdg" signature="PiecewiseLinearPauliRotations.tdg(qubit, *, q=None)">
    Apply [`TdgGate`](qiskit.circuit.library.TdgGate "qiskit.circuit.library.TdgGate").
  </Function>

  ### to\_gate

  <Function id="qiskit.circuit.library.PiecewiseLinearPauliRotations.to_gate" name="to_gate" signature="PiecewiseLinearPauliRotations.to_gate(parameter_map=None)">
  ...
  <Function id="qiskit.circuit.library.PiecewiseLinearPauliRotations.to_instruction" name="to_instruction" signature="PiecewiseLinearPauliRotations.to_instruction(parameter_map=None)">
  ...
  <Function id="qiskit.circuit.library.PiecewiseLinearPauliRotations.toffoli" name="toffoli" signature="PiecewiseLinearPauliRotations.toffoli(control_qubit1, control_qubit2, target_qubit, *, ctl1=None, ctl2=None, tgt=None)">
    Apply [`CCXGate`](qiskit.circuit.library.CCXGate "qiskit.circuit.library.CCXGate").
  </Function>

  ### u1

  <Function id="qiskit.circuit.library.PiecewiseLinearPauliRotations.u1" name="u1" signature="PiecewiseLinearPauliRotations.u1(theta, qubit, *, q=None)">
    Apply [`U1Gate`](qiskit.circuit.library.U1Gate "qiskit.circuit.library.U1Gate").
  </Function>

  ### u2

  <Function id="qiskit.circuit.library.PiecewiseLinearPauliRotations.u2" name="u2" signature="PiecewiseLinearPauliRotations.u2(phi, lam, qubit, *, q=None)">
    Apply [`U2Gate`](qiskit.circuit.library.U2Gate "qiskit.circuit.library.U2Gate").
  </Function>

  ### u3

  <Function id="qiskit.circuit.library.PiecewiseLinearPauliRotations.u3" name="u3" signature="PiecewiseLinearPauliRotations.u3(theta, phi, lam, qubit, *, q=None)">
    Apply [`U3Gate`](qiskit.circuit.library.U3Gate "qiskit.circuit.library.U3Gate").
  </Function>

  ### uc

  <Function id="qiskit.circuit.library.PiecewiseLinearPauliRotations.uc" name="uc" signature="PiecewiseLinearPauliRotations.uc(gate_list, q_controls, q_target, up_to_diagonal=False)">
  ...
  <Function id="qiskit.circuit.library.PiecewiseLinearPauliRotations.ucg" name="ucg" signature="PiecewiseLinearPauliRotations.ucg(angle_list, q_controls, q_target, up_to_diagonal=False)">
    Deprecated version of uc.
  </Function>

  ### ucrx

  <Function id="qiskit.circuit.library.PiecewiseLinearPauliRotations.ucrx" name="ucrx" signature="PiecewiseLinearPauliRotations.ucrx(angle_list, q_controls, q_target)">
  ...
  <Function id="qiskit.circuit.library.PiecewiseLinearPauliRotations.ucry" name="ucry" signature="PiecewiseLinearPauliRotations.ucry(angle_list, q_controls, q_target)">
  ...
  <Function id="qiskit.circuit.library.PiecewiseLinearPauliRotations.ucrz" name="ucrz" signature="PiecewiseLinearPauliRotations.ucrz(angle_list, q_controls, q_target)">
  ...
  <Function id="qiskit.circuit.library.PiecewiseLinearPauliRotations.ucx" name="ucx" signature="PiecewiseLinearPauliRotations.ucx(angle_list, q_controls, q_target)">
    Deprecated version of ucrx.
  </Function>

  ### ucy

  <Function id="qiskit.circuit.library.PiecewiseLinearPauliRotations.ucy" name="ucy" signature="PiecewiseLinearPauliRotations.ucy(angle_list, q_controls, q_target)">
    Deprecated version of ucry.
  </Function>

  ### ucz

  <Function id="qiskit.circuit.library.PiecewiseLinearPauliRotations.ucz" name="ucz" signature="PiecewiseLinearPauliRotations.ucz(angle_list, q_controls, q_target)">
    Deprecated version of ucrz.
  </Function>

  ### unitary

  <Function id="qiskit.circuit.library.PiecewiseLinearPauliRotations.unitary" name="unitary" signature="PiecewiseLinearPauliRotations.unitary(obj, qubits, label=None)">
    Apply unitary gate to q.
  </Function>

  ### width

  <Function id="qiskit.circuit.library.PiecewiseLinearPauliRotations.width" name="width" signature="PiecewiseLinearPauliRotations.width()">
  ...
  <Function id="qiskit.circuit.library.PiecewiseLinearPauliRotations.x" name="x" signature="PiecewiseLinearPauliRotations.x(qubit, *, label=None, ctrl_state=None, q=None)">
    Apply [`XGate`](qiskit.circuit.library.XGate "qiskit.circuit.library.XGate").
  </Function>

  ### y

  <Function id="qiskit.circuit.library.PiecewiseLinearPauliRotations.y" name="y" signature="PiecewiseLinearPauliRotations.y(qubit, *, q=None)">
    Apply [`YGate`](qiskit.circuit.library.YGate "qiskit.circuit.library.YGate").
  </Function>

  ### z

  <Function id="qiskit.circuit.library.PiecewiseLinearPauliRotations.z" name="z" signature="PiecewiseLinearPauliRotations.z(qubit, *, q=None)">
