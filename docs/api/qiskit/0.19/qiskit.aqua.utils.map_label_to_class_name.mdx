...
<Function id="qiskit.aqua.utils.map_label_to_class_name" github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.7/qiskit/aqua/utils/dataset_helper.py" signature="map_label_to_class_name(predicted_labels, label_to_class)">
