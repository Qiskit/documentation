...
<Class id="qiskit.quantum_info.Clifford" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.14/qiskit/quantum_info/operators/symplectic/clifford.py" signature="Clifford(data, validate=True)">
  ...
  **References**
  ...
  <Function id="qiskit.quantum_info.Clifford.from_dict" signature="static Clifford.from_dict(obj)">
  ...
  <Function id="qiskit.quantum_info.Clifford.set_atol" signature="classmethod Clifford.set_atol(value)">
    Set the class default absolute tolerance parameter for float comparisons.
  </Function>

  ### set\_rtol

  <Function id="qiskit.quantum_info.Clifford.set_rtol" signature="classmethod Clifford.set_rtol(value)">
