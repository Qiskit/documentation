...
<Class id="qiskit.quantum_info.Clifford" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.14/qiskit/quantum_info/operators/symplectic/clifford.py" signature="Clifford(data, validate=True)">
  ...
  **References**
  ...
  <Attribute id="qiskit.quantum_info.Clifford.atol" name="atol">
  ...
  <Attribute id="qiskit.quantum_info.Clifford.rtol" name="rtol">
  ...
  <Function id="qiskit.quantum_info.Clifford.__call__" name="__call__" signature="Clifford.__call__(qargs)">
    Return a clone with qargs set
  </Function>

  ### \_\_getitem\_\_

  <Function id="qiskit.quantum_info.Clifford.__getitem__" name="__getitem__" signature="Clifford.__getitem__(key)">
    Return a stabilizer Pauli row
  </Function>

  ### \_\_mul\_\_

  <Function id="qiskit.quantum_info.Clifford.__mul__" name="__mul__" signature="Clifford.__mul__(other)" />

  ### add

  <Function id="qiskit.quantum_info.Clifford.add" name="add" signature="Clifford.add(other)">
  ...
  <Function id="qiskit.quantum_info.Clifford.multiply" name="multiply" signature="Clifford.multiply(other)">
  ...
  <Function id="qiskit.quantum_info.Clifford.reshape" name="reshape" signature="Clifford.reshape(input_dims=None, output_dims=None)">
  ...
  <Function id="qiskit.quantum_info.Clifford.set_atol" name="set_atol" signature="classmethod Clifford.set_atol(value)">
    Set the class default absolute tolerance parameter for float comparisons.
  </Function>

  ### set\_rtol

  <Function id="qiskit.quantum_info.Clifford.set_rtol" name="set_rtol" signature="classmethod Clifford.set_rtol(value)">
    Set the class default relative tolerance parameter for float comparisons.
  </Function>

  ### subtract

  <Function id="qiskit.quantum_info.Clifford.subtract" name="subtract" signature="Clifford.subtract(other)">
    Return the linear operator self - other.
