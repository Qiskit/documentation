...
<Class id="qiskit.ignis.measurement.QuadraticIQDiscriminator" github="https://github.com/qiskit-community/qiskit-ignis/tree/stable/0.3/qiskit/ignis/measurement/discriminator/iq_discriminators.py" signature="QuadraticIQDiscriminator(cal_results, qubit_mask, expected_states=None, standardize=False, schedules=None, discriminator_parameters=None)">
  ...
  *   **discriminator\_parameters** (*dict*) – parameters for Sklearn’s LDA.
  ...
  <Attribute id="qiskit.ignis.measurement.QuadraticIQDiscriminator.expected_states" name="expected_states">
    Returns the expected states used to train the discriminator.
  </Attribute>

  ### fitted

  <Attribute id="qiskit.ignis.measurement.QuadraticIQDiscriminator.fitted" name="fitted">
    True if the discriminator has been fitted to calibration data.
  </Attribute>

  ### schedules

  <Attribute id="qiskit.ignis.measurement.QuadraticIQDiscriminator.schedules" name="schedules">
  ...
  <Function id="qiskit.ignis.measurement.QuadraticIQDiscriminator.add_data" name="add_data" signature="QuadraticIQDiscriminator.add_data(result, expected_states, refit=True, schedules=None)">
    **Parameters**
  ...
  <Function id="qiskit.ignis.measurement.QuadraticIQDiscriminator.discriminate" name="discriminate" signature="QuadraticIQDiscriminator.discriminate(x_data)">
  ...
  <Function id="qiskit.ignis.measurement.QuadraticIQDiscriminator.fit" name="fit" signature="QuadraticIQDiscriminator.fit()">
    Fits the discriminator using self.\_xdata and self.\_ydata.
  </Function>

  ### format\_iq\_data

  <Function id="qiskit.ignis.measurement.QuadraticIQDiscriminator.format_iq_data" name="format_iq_data" signature="QuadraticIQDiscriminator.format_iq_data(iq_data)">
  ...
  <Function id="qiskit.ignis.measurement.QuadraticIQDiscriminator.get_xdata" name="get_xdata" signature="QuadraticIQDiscriminator.get_xdata(results, schedule_type_to_get, schedules=None)">
  ...
  <Function id="qiskit.ignis.measurement.QuadraticIQDiscriminator.get_ydata" name="get_ydata" signature="QuadraticIQDiscriminator.get_ydata(results, schedule_type_to_get, schedules=None)">
  ...
  <Function id="qiskit.ignis.measurement.QuadraticIQDiscriminator.is_calibration" name="is_calibration" signature="QuadraticIQDiscriminator.is_calibration(result_name)">
  ...
  <Function id="qiskit.ignis.measurement.QuadraticIQDiscriminator.plot" name="plot" signature="QuadraticIQDiscriminator.plot(axs=None, show_boundary=False, show_fitting_data=True, flag_misclassified=False, qubits_to_plot=None, title=True)">
  ...
  <Function id="qiskit.ignis.measurement.QuadraticIQDiscriminator.plot_xdata" name="plot_xdata" signature="QuadraticIQDiscriminator.plot_xdata(axs, results, color=None)">
