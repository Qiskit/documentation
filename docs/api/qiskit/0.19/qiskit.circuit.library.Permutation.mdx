...
<Class id="qiskit.circuit.library.Permutation" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.14/qiskit/circuit/library/generalized_gates/permutation.py" signature="Permutation(num_qubits, pattern=None, seed=None)">
  ...
  **Expanded Circuit:**
  ...
  <Attribute id="qiskit.circuit.library.Permutation.clbits" name="clbits">
    Returns a list of classical bits in the order that the registers were added.
  </Attribute>

  ### data

  <Attribute id="qiskit.circuit.library.Permutation.data" name="data">
  ...
  <Attribute id="qiskit.circuit.library.Permutation.extension_lib" signature="= 'include \&#x22;qelib1.inc\&#x22;;'" />

  ### header

  <Attribute id="qiskit.circuit.library.Permutation.header" signature="= 'OPENQASM 2.0;'" />

  ### instances

  <Attribute id="qiskit.circuit.library.Permutation.instances" signature="= 8" />

  ### n\_qubits

  <Attribute id="qiskit.circuit.library.Permutation.n_qubits" name="n_qubits">
    Deprecated, use `num_qubits` instead. Return number of qubits.
  </Attribute>

  ### num\_clbits

  <Attribute id="qiskit.circuit.library.Permutation.num_clbits" name="num_clbits">
    Return number of classical bits.
  </Attribute>

  ### num\_parameters

  <Attribute id="qiskit.circuit.library.Permutation.num_parameters" name="num_parameters">
    Convenience function to get the number of parameter objects in the circuit.
  </Attribute>

  ### num\_qubits

  <Attribute id="qiskit.circuit.library.Permutation.num_qubits" name="num_qubits">
    Return number of qubits.
  </Attribute>

  ### parameters

  <Attribute id="qiskit.circuit.library.Permutation.parameters" name="parameters">
    Convenience function to get the parameters defined in the parameter table.
  </Attribute>

  ### prefix

  <Attribute id="qiskit.circuit.library.Permutation.prefix" signature="= 'circuit'" />

  ### qubits

  <Attribute id="qiskit.circuit.library.Permutation.qubits" name="qubits">
  ...
  <Function id="qiskit.circuit.library.Permutation.AND" name="AND" signature="Permutation.AND(qr_variables, qb_target, qr_ancillae, flags=None, mct_mode='no-ancilla')">
  ...
  <Function id="qiskit.circuit.library.Permutation.OR" name="OR" signature="Permutation.OR(qr_variables, qb_target, qr_ancillae, flags=None, mct_mode='basic')">
  ...
  <Function id="qiskit.circuit.library.Permutation.__getitem__" name="__getitem__" signature="Permutation.__getitem__(item)">
    Return indexed operation.
  </Function>

  ### \_\_len\_\_

  <Function id="qiskit.circuit.library.Permutation.__len__" name="__len__" signature="Permutation.__len__()">
    Return number of operations in circuit.
  </Function>

  ### add\_register

  <Function id="qiskit.circuit.library.Permutation.add_register" name="add_register" signature="Permutation.add_register(*regs)">
    Add registers.
  </Function>

  ### append

  <Function id="qiskit.circuit.library.Permutation.append" name="append" signature="Permutation.append(instruction, qargs=None, cargs=None)">
  ...
  <Function id="qiskit.circuit.library.Permutation.assign_parameters" name="assign_parameters" signature="Permutation.assign_parameters(param_dict, inplace=False)">
  ...
  <Function id="qiskit.circuit.library.Permutation.barrier" name="barrier" signature="Permutation.barrier(*qargs)">
    Apply `Barrier`. If qargs is None, applies to all.
  </Function>

  ### bind\_parameters

  <Function id="qiskit.circuit.library.Permutation.bind_parameters" name="bind_parameters" signature="Permutation.bind_parameters(value_dict)">
  ...
  <Function id="qiskit.circuit.library.Permutation.cast" name="cast" signature="static Permutation.cast(value, _type)">
    Best effort to cast value to type. Otherwise, returns the value.
  </Function>

  ### cbit\_argument\_conversion

  <Function id="qiskit.circuit.library.Permutation.cbit_argument_conversion" name="cbit_argument_conversion" signature="Permutation.cbit_argument_conversion(clbit_representation)">
  ...
  <Function id="qiskit.circuit.library.Permutation.ccx" name="ccx" signature="Permutation.ccx(control_qubit1, control_qubit2, target_qubit, *, ctl1=None, ctl2=None, tgt=None)">
    Apply [`CCXGate`](qiskit.circuit.library.CCXGate "qiskit.circuit.library.CCXGate").
  </Function>

  ### ch

  <Function id="qiskit.circuit.library.Permutation.ch" name="ch" signature="Permutation.ch(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CHGate`](qiskit.circuit.library.CHGate "qiskit.circuit.library.CHGate").
  </Function>

  ### cls\_instances

  <Function id="qiskit.circuit.library.Permutation.cls_instances" name="cls_instances" signature="classmethod Permutation.cls_instances()">
    Return the current number of instances of this class, useful for auto naming.
  </Function>

  ### cls\_prefix

  <Function id="qiskit.circuit.library.Permutation.cls_prefix" name="cls_prefix" signature="classmethod Permutation.cls_prefix()">
    Return the prefix to use for auto naming.
  </Function>

  ### cnot

  <Function id="qiskit.circuit.library.Permutation.cnot" name="cnot" signature="Permutation.cnot(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CXGate`](qiskit.circuit.library.CXGate "qiskit.circuit.library.CXGate").
  </Function>

  ### combine

  <Function id="qiskit.circuit.library.Permutation.combine" name="combine" signature="Permutation.combine(rhs)">
  ...
  <Function id="qiskit.circuit.library.Permutation.compose" name="compose" signature="Permutation.compose(other, qubits=None, clbits=None, front=False, inplace=False)">
  ...
  <Function id="qiskit.circuit.library.Permutation.copy" name="copy" signature="Permutation.copy(name=None)">
    Copy the circuit.
  ...
  <Function id="qiskit.circuit.library.Permutation.count_ops" name="count_ops" signature="Permutation.count_ops()">
  ...
  <Function id="qiskit.circuit.library.Permutation.crx" name="crx" signature="Permutation.crx(theta, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CRXGate`](qiskit.circuit.library.CRXGate "qiskit.circuit.library.CRXGate").
  </Function>

  ### cry

  <Function id="qiskit.circuit.library.Permutation.cry" name="cry" signature="Permutation.cry(theta, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CRYGate`](qiskit.circuit.library.CRYGate "qiskit.circuit.library.CRYGate").
  </Function>

  ### crz

  <Function id="qiskit.circuit.library.Permutation.crz" name="crz" signature="Permutation.crz(theta, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CRZGate`](qiskit.circuit.library.CRZGate "qiskit.circuit.library.CRZGate").
  </Function>

  ### cswap

  <Function id="qiskit.circuit.library.Permutation.cswap" name="cswap" signature="Permutation.cswap(control_qubit, target_qubit1, target_qubit2, *, label=None, ctrl_state=None, ctl=None, tgt1=None, tgt2=None)">
    Apply [`CSwapGate`](qiskit.circuit.library.CSwapGate "qiskit.circuit.library.CSwapGate").
  </Function>

  ### cu1

  <Function id="qiskit.circuit.library.Permutation.cu1" name="cu1" signature="Permutation.cu1(theta, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CU1Gate`](qiskit.circuit.library.CU1Gate "qiskit.circuit.library.CU1Gate").
  </Function>

  ### cu3

  <Function id="qiskit.circuit.library.Permutation.cu3" name="cu3" signature="Permutation.cu3(theta, phi, lam, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CU3Gate`](qiskit.circuit.library.CU3Gate "qiskit.circuit.library.CU3Gate").
  </Function>

  ### cx

  <Function id="qiskit.circuit.library.Permutation.cx" name="cx" signature="Permutation.cx(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CXGate`](qiskit.circuit.library.CXGate "qiskit.circuit.library.CXGate").
  </Function>

  ### cy

  <Function id="qiskit.circuit.library.Permutation.cy" name="cy" signature="Permutation.cy(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CYGate`](qiskit.circuit.library.CYGate "qiskit.circuit.library.CYGate").
  </Function>

  ### cz

  <Function id="qiskit.circuit.library.Permutation.cz" name="cz" signature="Permutation.cz(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CZGate`](qiskit.circuit.library.CZGate "qiskit.circuit.library.CZGate").
  </Function>

  ### dcx

  <Function id="qiskit.circuit.library.Permutation.dcx" name="dcx" signature="Permutation.dcx(qubit1, qubit2)">
    Apply [`DCXGate`](qiskit.circuit.library.DCXGate "qiskit.circuit.library.DCXGate").
  </Function>

  ### decompose

  <Function id="qiskit.circuit.library.Permutation.decompose" name="decompose" signature="Permutation.decompose()">
  ...
  <Function id="qiskit.circuit.library.Permutation.depth" name="depth" signature="Permutation.depth()">
  ...
  <Function id="qiskit.circuit.library.Permutation.diag_gate" name="diag_gate" signature="Permutation.diag_gate(diag, qubit)">
    Deprecated version of QuantumCircuit.diagonal.
  </Function>

  ### diagonal

  <Function id="qiskit.circuit.library.Permutation.diagonal" name="diagonal" signature="Permutation.diagonal(diag, qubit)">
  ...
  <Function id="qiskit.circuit.library.Permutation.extend" name="extend" signature="Permutation.extend(rhs)">
  ...
  <Function id="qiskit.circuit.library.Permutation.fredkin" name="fredkin" signature="Permutation.fredkin(control_qubit, target_qubit1, target_qubit2, *, ctl=None, tgt1=None, tgt2=None)">
    Apply [`CSwapGate`](qiskit.circuit.library.CSwapGate "qiskit.circuit.library.CSwapGate").
  </Function>

  ### from\_qasm\_file

  <Function id="qiskit.circuit.library.Permutation.from_qasm_file" name="from_qasm_file" signature="static Permutation.from_qasm_file(path)">
  ...
  <Function id="qiskit.circuit.library.Permutation.from_qasm_str" name="from_qasm_str" signature="static Permutation.from_qasm_str(qasm_str)">
  ...
  <Function id="qiskit.circuit.library.Permutation.h" name="h" signature="Permutation.h(qubit, *, q=None)">
    Apply [`HGate`](qiskit.circuit.library.HGate "qiskit.circuit.library.HGate").
  </Function>

  ### hamiltonian

  <Function id="qiskit.circuit.library.Permutation.hamiltonian" name="hamiltonian" signature="Permutation.hamiltonian(operator, time, qubits, label=None)">
    Apply hamiltonian evolution to to qubits.
  </Function>

  ### has\_register

  <Function id="qiskit.circuit.library.Permutation.has_register" name="has_register" signature="Permutation.has_register(register)">
  ...
  <Function id="qiskit.circuit.library.Permutation.i" name="i" signature="Permutation.i(qubit, *, q=None)">
    Apply [`IGate`](qiskit.circuit.library.IGate "qiskit.circuit.library.IGate").
  </Function>

  ### id

  <Function id="qiskit.circuit.library.Permutation.id" name="id" signature="Permutation.id(qubit, *, q=None)">
    Apply [`IGate`](qiskit.circuit.library.IGate "qiskit.circuit.library.IGate").
  </Function>

  ### iden

  <Function id="qiskit.circuit.library.Permutation.iden" name="iden" signature="Permutation.iden(qubit, *, q=None)">
    Deprecated identity gate.
  </Function>

  ### initialize

  <Function id="qiskit.circuit.library.Permutation.initialize" name="initialize" signature="Permutation.initialize(params, qubits)">
    Apply initialize to circuit.
  </Function>

  ### inverse

  <Function id="qiskit.circuit.library.Permutation.inverse" name="inverse" signature="Permutation.inverse()">
    Invert this circuit.
  ...
  <Function id="qiskit.circuit.library.Permutation.iso" name="iso" signature="Permutation.iso(isometry, q_input, q_ancillas_for_output, q_ancillas_zero=None, q_ancillas_dirty=None)">
  ...
  <Function id="qiskit.circuit.library.Permutation.isometry" name="isometry" signature="Permutation.isometry(isometry, q_input, q_ancillas_for_output, q_ancillas_zero=None, q_ancillas_dirty=None)">
    Attach an arbitrary isometry from m to n qubits to a circuit. In particular, this allows to attach arbitrary unitaries on n qubits (m=n) or to prepare any state on n qubits (m=0). The decomposition used here was introduced by Iten et al. in [https://arxiv.org/abs/1501.06911](https://arxiv.org/abs/1501.06911).
  ...
  <Function id="qiskit.circuit.library.Permutation.iswap" name="iswap" signature="Permutation.iswap(qubit1, qubit2)">
    Apply [`iSwapGate`](qiskit.circuit.library.iSwapGate "qiskit.circuit.library.iSwapGate").
  </Function>

  ### mcmt

  <Function id="qiskit.circuit.library.Permutation.mcmt" name="mcmt" signature="Permutation.mcmt(gate, control_qubits, target_qubits, ancilla_qubits=None, mode='no-ancilla', *, single_control_gate_fun=None, q_controls=None, q_ancillae=None, q_targets=None)">
  ...
  <Function id="qiskit.circuit.library.Permutation.mcrx" name="mcrx" signature="Permutation.mcrx(theta, q_controls, q_target, use_basis_gates=False)">
  ...
  <Function id="qiskit.circuit.library.Permutation.mcry" name="mcry" signature="Permutation.mcry(theta, q_controls, q_target, q_ancillae, mode='basic', use_basis_gates=False)">
  ...
  <Function id="qiskit.circuit.library.Permutation.mcrz" name="mcrz" signature="Permutation.mcrz(lam, q_controls, q_target, use_basis_gates=False)">
  ...
  <Function id="qiskit.circuit.library.Permutation.mct" name="mct" signature="Permutation.mct(control_qubits, target_qubit, ancilla_qubits=None, mode='noancilla')">
    Apply `MCXGate`.
  </Function>

  ### mcu1

  <Function id="qiskit.circuit.library.Permutation.mcu1" name="mcu1" signature="Permutation.mcu1(lam, control_qubits, target_qubit)">
    Apply `MCU1Gate`.
  </Function>

  ### mcx

  <Function id="qiskit.circuit.library.Permutation.mcx" name="mcx" signature="Permutation.mcx(control_qubits, target_qubit, ancilla_qubits=None, mode='noancilla')">
    Apply `MCXGate`.
  ...
  <Function id="qiskit.circuit.library.Permutation.measure" name="measure" signature="Permutation.measure(qubit, cbit)">
  ...
  <Function id="qiskit.circuit.library.Permutation.measure_active" name="measure_active" signature="Permutation.measure_active(inplace=True)">
  ...
  <Function id="qiskit.circuit.library.Permutation.measure_all" name="measure_all" signature="Permutation.measure_all(inplace=True)">
  ...
  <Function id="qiskit.circuit.library.Permutation.mirror" name="mirror" signature="Permutation.mirror()">
  ...
  <Function id="qiskit.circuit.library.Permutation.ms" name="ms" signature="Permutation.ms(theta, qubits)">
    Apply [`MSGate`](qiskit.circuit.library.MSGate "qiskit.circuit.library.MSGate").
  </Function>

  ### num\_connected\_components

  <Function id="qiskit.circuit.library.Permutation.num_connected_components" name="num_connected_components" signature="Permutation.num_connected_components(unitary_only=False)">
  ...
  <Function id="qiskit.circuit.library.Permutation.num_nonlocal_gates" name="num_nonlocal_gates" signature="Permutation.num_nonlocal_gates()">
  ...
  <Function id="qiskit.circuit.library.Permutation.num_tensor_factors" name="num_tensor_factors" signature="Permutation.num_tensor_factors()">
  ...
  <Function id="qiskit.circuit.library.Permutation.num_unitary_factors" name="num_unitary_factors" signature="Permutation.num_unitary_factors()">
    Computes the number of tensor factors in the unitary (quantum) part of the circuit only.
  </Function>

  ### qasm

  <Function id="qiskit.circuit.library.Permutation.qasm" name="qasm" signature="Permutation.qasm(formatted=False, filename=None)">
  ...
  <Function id="qiskit.circuit.library.Permutation.qbit_argument_conversion" name="qbit_argument_conversion" signature="Permutation.qbit_argument_conversion(qubit_representation)">
  ...
  <Function id="qiskit.circuit.library.Permutation.r" name="r" signature="Permutation.r(theta, phi, qubit, *, q=None)">
    Apply `RGate`.
  </Function>

  ### rcccx

  <Function id="qiskit.circuit.library.Permutation.rcccx" name="rcccx" signature="Permutation.rcccx(control_qubit1, control_qubit2, control_qubit3, target_qubit)">
    Apply [`RC3XGate`](qiskit.circuit.library.RC3XGate "qiskit.circuit.library.RC3XGate").
  </Function>

  ### rccx

  <Function id="qiskit.circuit.library.Permutation.rccx" name="rccx" signature="Permutation.rccx(control_qubit1, control_qubit2, target_qubit)">
    Apply [`RCCXGate`](qiskit.circuit.library.RCCXGate "qiskit.circuit.library.RCCXGate").
  </Function>

  ### remove\_final\_measurements

  <Function id="qiskit.circuit.library.Permutation.remove_final_measurements" name="remove_final_measurements" signature="Permutation.remove_final_measurements(inplace=True)">
  ...
  <Function id="qiskit.circuit.library.Permutation.reset" name="reset" signature="Permutation.reset(qubit)">
    Reset q.
  </Function>

  ### rx

  <Function id="qiskit.circuit.library.Permutation.rx" name="rx" signature="Permutation.rx(theta, qubit, *, label=None, q=None)">
    Apply [`RXGate`](qiskit.circuit.library.RXGate "qiskit.circuit.library.RXGate").
  </Function>

  ### rxx

  <Function id="qiskit.circuit.library.Permutation.rxx" name="rxx" signature="Permutation.rxx(theta, qubit1, qubit2)">
    Apply [`RXXGate`](qiskit.circuit.library.RXXGate "qiskit.circuit.library.RXXGate").
  </Function>

  ### ry

  <Function id="qiskit.circuit.library.Permutation.ry" name="ry" signature="Permutation.ry(theta, qubit, *, label=None, q=None)">
    Apply [`RYGate`](qiskit.circuit.library.RYGate "qiskit.circuit.library.RYGate").
  </Function>

  ### ryy

  <Function id="qiskit.circuit.library.Permutation.ryy" name="ryy" signature="Permutation.ryy(theta, qubit1, qubit2)">
    Apply [`RYYGate`](qiskit.circuit.library.RYYGate "qiskit.circuit.library.RYYGate").
  </Function>

  ### rz

  <Function id="qiskit.circuit.library.Permutation.rz" name="rz" signature="Permutation.rz(phi, qubit, *, q=None)">
    Apply [`RZGate`](qiskit.circuit.library.RZGate "qiskit.circuit.library.RZGate").
  </Function>

  ### rzx

  <Function id="qiskit.circuit.library.Permutation.rzx" name="rzx" signature="Permutation.rzx(theta, qubit1, qubit2)">
    Apply [`RZXGate`](qiskit.circuit.library.RZXGate "qiskit.circuit.library.RZXGate").
  </Function>

  ### rzz

  <Function id="qiskit.circuit.library.Permutation.rzz" name="rzz" signature="Permutation.rzz(theta, qubit1, qubit2)">
    Apply [`RZZGate`](qiskit.circuit.library.RZZGate "qiskit.circuit.library.RZZGate").
  </Function>

  ### s

  <Function id="qiskit.circuit.library.Permutation.s" name="s" signature="Permutation.s(qubit, *, q=None)">
    Apply [`SGate`](qiskit.circuit.library.SGate "qiskit.circuit.library.SGate").
  </Function>

  ### sdg

  <Function id="qiskit.circuit.library.Permutation.sdg" name="sdg" signature="Permutation.sdg(qubit, *, q=None)">
    Apply [`SdgGate`](qiskit.circuit.library.SdgGate "qiskit.circuit.library.SdgGate").
  </Function>

  ### size

  <Function id="qiskit.circuit.library.Permutation.size" name="size" signature="Permutation.size()">
  ...
  <Function id="qiskit.circuit.library.Permutation.snapshot" name="snapshot" signature="Permutation.snapshot(label, snapshot_type='statevector', qubits=None, params=None)">
  ...
  <Function id="qiskit.circuit.library.Permutation.snapshot_density_matrix" name="snapshot_density_matrix" signature="Permutation.snapshot_density_matrix(label, qubits=None)">
  ...
  <Function id="qiskit.circuit.library.Permutation.snapshot_expectation_value" name="snapshot_expectation_value" signature="Permutation.snapshot_expectation_value(label, op, qubits, single_shot=False, variance=False)">
  ...
  <Function id="qiskit.circuit.library.Permutation.snapshot_probabilities" name="snapshot_probabilities" signature="Permutation.snapshot_probabilities(label, qubits, variance=False)">
  ...
  <Function id="qiskit.circuit.library.Permutation.snapshot_stabilizer" name="snapshot_stabilizer" signature="Permutation.snapshot_stabilizer(label)">
  ...
  <Function id="qiskit.circuit.library.Permutation.snapshot_statevector" name="snapshot_statevector" signature="Permutation.snapshot_statevector(label)">
  ...
  <Function id="qiskit.circuit.library.Permutation.squ" name="squ" signature="Permutation.squ(unitary_matrix, qubit, mode='ZYZ', up_to_diagonal=False, *, u=None)">
  ...
  <Function id="qiskit.circuit.library.Permutation.swap" name="swap" signature="Permutation.swap(qubit1, qubit2)">
    Apply [`SwapGate`](qiskit.circuit.library.SwapGate "qiskit.circuit.library.SwapGate").
  </Function>

  ### t

  <Function id="qiskit.circuit.library.Permutation.t" name="t" signature="Permutation.t(qubit, *, q=None)">
    Apply [`TGate`](qiskit.circuit.library.TGate "qiskit.circuit.library.TGate").
  </Function>

  ### tdg

  <Function id="qiskit.circuit.library.Permutation.tdg" name="tdg" signature="Permutation.tdg(qubit, *, q=None)">
    Apply [`TdgGate`](qiskit.circuit.library.TdgGate "qiskit.circuit.library.TdgGate").
  </Function>

  ### to\_gate

  <Function id="qiskit.circuit.library.Permutation.to_gate" name="to_gate" signature="Permutation.to_gate(parameter_map=None)">
  ...
  <Function id="qiskit.circuit.library.Permutation.to_instruction" name="to_instruction" signature="Permutation.to_instruction(parameter_map=None)">
  ...
  <Function id="qiskit.circuit.library.Permutation.toffoli" name="toffoli" signature="Permutation.toffoli(control_qubit1, control_qubit2, target_qubit, *, ctl1=None, ctl2=None, tgt=None)">
    Apply [`CCXGate`](qiskit.circuit.library.CCXGate "qiskit.circuit.library.CCXGate").
  </Function>

  ### u1

  <Function id="qiskit.circuit.library.Permutation.u1" name="u1" signature="Permutation.u1(theta, qubit, *, q=None)">
    Apply [`U1Gate`](qiskit.circuit.library.U1Gate "qiskit.circuit.library.U1Gate").
  </Function>

  ### u2

  <Function id="qiskit.circuit.library.Permutation.u2" name="u2" signature="Permutation.u2(phi, lam, qubit, *, q=None)">
    Apply [`U2Gate`](qiskit.circuit.library.U2Gate "qiskit.circuit.library.U2Gate").
  </Function>

  ### u3

  <Function id="qiskit.circuit.library.Permutation.u3" name="u3" signature="Permutation.u3(theta, phi, lam, qubit, *, q=None)">
    Apply [`U3Gate`](qiskit.circuit.library.U3Gate "qiskit.circuit.library.U3Gate").
  </Function>

  ### uc

  <Function id="qiskit.circuit.library.Permutation.uc" name="uc" signature="Permutation.uc(gate_list, q_controls, q_target, up_to_diagonal=False)">
  ...
  <Function id="qiskit.circuit.library.Permutation.ucg" name="ucg" signature="Permutation.ucg(angle_list, q_controls, q_target, up_to_diagonal=False)">
    Deprecated version of uc.
  </Function>

  ### ucrx

  <Function id="qiskit.circuit.library.Permutation.ucrx" name="ucrx" signature="Permutation.ucrx(angle_list, q_controls, q_target)">
  ...
  <Function id="qiskit.circuit.library.Permutation.ucry" name="ucry" signature="Permutation.ucry(angle_list, q_controls, q_target)">
  ...
  <Function id="qiskit.circuit.library.Permutation.ucrz" name="ucrz" signature="Permutation.ucrz(angle_list, q_controls, q_target)">
  ...
  <Function id="qiskit.circuit.library.Permutation.ucx" name="ucx" signature="Permutation.ucx(angle_list, q_controls, q_target)">
    Deprecated version of ucrx.
  </Function>

  ### ucy

  <Function id="qiskit.circuit.library.Permutation.ucy" name="ucy" signature="Permutation.ucy(angle_list, q_controls, q_target)">
    Deprecated version of ucry.
  </Function>

  ### ucz

  <Function id="qiskit.circuit.library.Permutation.ucz" name="ucz" signature="Permutation.ucz(angle_list, q_controls, q_target)">
    Deprecated version of ucrz.
  </Function>

  ### unitary

  <Function id="qiskit.circuit.library.Permutation.unitary" name="unitary" signature="Permutation.unitary(obj, qubits, label=None)">
    Apply unitary gate to q.
  </Function>

  ### width

  <Function id="qiskit.circuit.library.Permutation.width" name="width" signature="Permutation.width()">
  ...
  <Function id="qiskit.circuit.library.Permutation.x" name="x" signature="Permutation.x(qubit, *, label=None, ctrl_state=None, q=None)">
    Apply [`XGate`](qiskit.circuit.library.XGate "qiskit.circuit.library.XGate").
  </Function>

  ### y

  <Function id="qiskit.circuit.library.Permutation.y" name="y" signature="Permutation.y(qubit, *, q=None)">
    Apply [`YGate`](qiskit.circuit.library.YGate "qiskit.circuit.library.YGate").
  </Function>

  ### z

  <Function id="qiskit.circuit.library.Permutation.z" name="z" signature="Permutation.z(qubit, *, q=None)">
