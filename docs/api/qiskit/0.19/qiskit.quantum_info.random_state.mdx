...
<Function id="qiskit.quantum_info.random_state" name="random_state" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.14/qiskit/quantum_info/states/random.py" signature="random_state(dim, seed=None)">
