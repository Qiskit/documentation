---
title: circuit_to_gate (v0.19)
description: API reference for qiskit.converters.circuit_to_gate in qiskit v0.19
in_page_toc_min_heading_level: 1
python_api_type: function
python_api_name: qiskit.converters.circuit_to_gate
---

<span id="circuit-to-gate" />

# circuit\_to\_gate

<Function id="qiskit.converters.circuit_to_gate" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.14/qiskit/converters/circuit_to_gate.py" signature="circuit_to_gate(circuit, parameter_map=None, equivalence_library=None)">
