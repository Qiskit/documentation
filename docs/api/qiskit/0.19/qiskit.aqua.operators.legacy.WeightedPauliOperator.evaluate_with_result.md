...
description: API reference for qiskit.aqua.operators.legacy.WeightedPauliOperator.evaluate_with_result
in_page_toc_min_heading_level: 1
python_api_type: method
python_api_name: qiskit.aqua.operators.legacy.WeightedPauliOperator.evaluate_with_result
---
