...
<Class id="qiskit.validation.BaseModel" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.14/qiskit/validation/base.py" signature="BaseModel(validate=True, **kwargs)">
  ...
  <Function id="qiskit.validation.BaseModel.from_dict" name="from_dict" signature="classmethod BaseModel.from_dict(dict_)">
  ...
  <Function id="qiskit.validation.BaseModel.to_dict" name="to_dict" signature="BaseModel.to_dict()">
