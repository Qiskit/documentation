...
<Class id="qiskit.validation.BaseModel" github="https://github.com/qiskit/qiskit/tree/stable/0.14/qiskit/validation/base.py" signature="BaseModel(validate=True, **kwargs)">
