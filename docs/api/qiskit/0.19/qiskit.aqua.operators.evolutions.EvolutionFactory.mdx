...
<Class id="qiskit.aqua.operators.evolutions.EvolutionFactory" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.7/qiskit/aqua/operators/evolutions/evolution_factory.py" signature="EvolutionFactory">
  ...
  <Function id="qiskit.aqua.operators.evolutions.EvolutionFactory.build" name="build" signature="static EvolutionFactory.build(operator=None)">
