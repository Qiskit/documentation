...
<Class id="qiskit.circuit.library.PolynomialPauliRotations" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.14/qiskit/circuit/library/arithmetic/polynomial_pauli_rotations.py" signature="PolynomialPauliRotations(num_state_qubits=None, coeffs=None, basis='Y', reverse=False, name='poly')">
...
$$
  ...
  *   **name** (`str`) – The name of the circuit.
  ...
  <Attribute id="qiskit.circuit.library.PolynomialPauliRotations.basis" name="basis" signature="str">
  ...
  <Attribute id="qiskit.circuit.library.PolynomialPauliRotations.coeffs" name="coeffs" signature="List[float]">
  ...
  <Attribute id="qiskit.circuit.library.PolynomialPauliRotations.degree" name="degree" signature="int">
  ...
  <Attribute id="qiskit.circuit.library.PolynomialPauliRotations.extension_lib" signature="= 'include \&#x22;qelib1.inc\&#x22;;'" />

  ### header

  <Attribute id="qiskit.circuit.library.PolynomialPauliRotations.header" signature="= 'OPENQASM 2.0;'" />

  ### instances

  <Attribute id="qiskit.circuit.library.PolynomialPauliRotations.instances" signature="= 8" />

  ### n\_qubits

  <Attribute id="qiskit.circuit.library.PolynomialPauliRotations.n_qubits" name="n_qubits">
    Deprecated, use `num_qubits` instead. Return number of qubits.
  </Attribute>

  ### num\_ancilla\_qubits

  <Attribute id="qiskit.circuit.library.PolynomialPauliRotations.num_ancilla_qubits" name="num_ancilla_qubits" signature="int">
  ...
  <Attribute id="qiskit.circuit.library.PolynomialPauliRotations.num_state_qubits" name="num_state_qubits" signature="int">
  ...
  <Attribute id="qiskit.circuit.library.PolynomialPauliRotations.prefix" signature="= 'circuit'" />
  ...
  <Attribute id="qiskit.circuit.library.PolynomialPauliRotations.reverse" name="reverse" signature="bool">
  ...
  <Function id="qiskit.circuit.library.PolynomialPauliRotations.AND" name="AND" signature="PolynomialPauliRotations.AND(qr_variables, qb_target, qr_ancillae, flags=None, mct_mode='no-ancilla')">
  ...
  <Function id="qiskit.circuit.library.PolynomialPauliRotations.OR" name="OR" signature="PolynomialPauliRotations.OR(qr_variables, qb_target, qr_ancillae, flags=None, mct_mode='basic')">
  ...
  <Function id="qiskit.circuit.library.PolynomialPauliRotations.__getitem__" name="__getitem__" signature="PolynomialPauliRotations.__getitem__(item)">
    Return indexed operation.
  </Function>

  ### \_\_len\_\_

  <Function id="qiskit.circuit.library.PolynomialPauliRotations.__len__" name="__len__" signature="PolynomialPauliRotations.__len__()">
    Return number of operations in circuit.
  </Function>

  ### add\_register

  <Function id="qiskit.circuit.library.PolynomialPauliRotations.add_register" name="add_register" signature="PolynomialPauliRotations.add_register(*regs)">
    Add registers.
  </Function>

  ### append

  <Function id="qiskit.circuit.library.PolynomialPauliRotations.append" name="append" signature="PolynomialPauliRotations.append(instruction, qargs=None, cargs=None)">
  ...
  <Function id="qiskit.circuit.library.PolynomialPauliRotations.assign_parameters" name="assign_parameters" signature="PolynomialPauliRotations.assign_parameters(param_dict, inplace=False)">
  ...
  <Function id="qiskit.circuit.library.PolynomialPauliRotations.barrier" name="barrier" signature="PolynomialPauliRotations.barrier(*qargs)">
    Apply `Barrier`. If qargs is None, applies to all.
  </Function>

  ### bind\_parameters

  <Function id="qiskit.circuit.library.PolynomialPauliRotations.bind_parameters" name="bind_parameters" signature="PolynomialPauliRotations.bind_parameters(value_dict)">
  ...
  <Function id="qiskit.circuit.library.PolynomialPauliRotations.cast" name="cast" signature="static PolynomialPauliRotations.cast(value, _type)">
    Best effort to cast value to type. Otherwise, returns the value.
  </Function>

  ### cbit\_argument\_conversion

  <Function id="qiskit.circuit.library.PolynomialPauliRotations.cbit_argument_conversion" name="cbit_argument_conversion" signature="PolynomialPauliRotations.cbit_argument_conversion(clbit_representation)">
  ...
  <Function id="qiskit.circuit.library.PolynomialPauliRotations.ccx" name="ccx" signature="PolynomialPauliRotations.ccx(control_qubit1, control_qubit2, target_qubit, *, ctl1=None, ctl2=None, tgt=None)">
    Apply [`CCXGate`](qiskit.circuit.library.CCXGate "qiskit.circuit.library.CCXGate").
  </Function>

  ### ch

  <Function id="qiskit.circuit.library.PolynomialPauliRotations.ch" name="ch" signature="PolynomialPauliRotations.ch(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CHGate`](qiskit.circuit.library.CHGate "qiskit.circuit.library.CHGate").
  </Function>

  ### cls\_instances

  <Function id="qiskit.circuit.library.PolynomialPauliRotations.cls_instances" name="cls_instances" signature="classmethod PolynomialPauliRotations.cls_instances()">
    Return the current number of instances of this class, useful for auto naming.
  </Function>

  ### cls\_prefix

  <Function id="qiskit.circuit.library.PolynomialPauliRotations.cls_prefix" name="cls_prefix" signature="classmethod PolynomialPauliRotations.cls_prefix()">
    Return the prefix to use for auto naming.
  </Function>

  ### cnot

  <Function id="qiskit.circuit.library.PolynomialPauliRotations.cnot" name="cnot" signature="PolynomialPauliRotations.cnot(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CXGate`](qiskit.circuit.library.CXGate "qiskit.circuit.library.CXGate").
  </Function>

  ### combine

  <Function id="qiskit.circuit.library.PolynomialPauliRotations.combine" name="combine" signature="PolynomialPauliRotations.combine(rhs)">
  ...
  <Function id="qiskit.circuit.library.PolynomialPauliRotations.compose" name="compose" signature="PolynomialPauliRotations.compose(other, qubits=None, clbits=None, front=False, inplace=False)">
  ...
  <Function id="qiskit.circuit.library.PolynomialPauliRotations.copy" name="copy" signature="PolynomialPauliRotations.copy(name=None)">
    Copy the circuit.
  ...
  <Function id="qiskit.circuit.library.PolynomialPauliRotations.count_ops" name="count_ops" signature="PolynomialPauliRotations.count_ops()">
  ...
  <Function id="qiskit.circuit.library.PolynomialPauliRotations.crx" name="crx" signature="PolynomialPauliRotations.crx(theta, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CRXGate`](qiskit.circuit.library.CRXGate "qiskit.circuit.library.CRXGate").
  </Function>

  ### cry

  <Function id="qiskit.circuit.library.PolynomialPauliRotations.cry" name="cry" signature="PolynomialPauliRotations.cry(theta, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CRYGate`](qiskit.circuit.library.CRYGate "qiskit.circuit.library.CRYGate").
  </Function>

  ### crz

  <Function id="qiskit.circuit.library.PolynomialPauliRotations.crz" name="crz" signature="PolynomialPauliRotations.crz(theta, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CRZGate`](qiskit.circuit.library.CRZGate "qiskit.circuit.library.CRZGate").
  </Function>

  ### cswap

  <Function id="qiskit.circuit.library.PolynomialPauliRotations.cswap" name="cswap" signature="PolynomialPauliRotations.cswap(control_qubit, target_qubit1, target_qubit2, *, label=None, ctrl_state=None, ctl=None, tgt1=None, tgt2=None)">
    Apply [`CSwapGate`](qiskit.circuit.library.CSwapGate "qiskit.circuit.library.CSwapGate").
  </Function>

  ### cu1

  <Function id="qiskit.circuit.library.PolynomialPauliRotations.cu1" name="cu1" signature="PolynomialPauliRotations.cu1(theta, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CU1Gate`](qiskit.circuit.library.CU1Gate "qiskit.circuit.library.CU1Gate").
  </Function>

  ### cu3

  <Function id="qiskit.circuit.library.PolynomialPauliRotations.cu3" name="cu3" signature="PolynomialPauliRotations.cu3(theta, phi, lam, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CU3Gate`](qiskit.circuit.library.CU3Gate "qiskit.circuit.library.CU3Gate").
  </Function>

  ### cx

  <Function id="qiskit.circuit.library.PolynomialPauliRotations.cx" name="cx" signature="PolynomialPauliRotations.cx(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CXGate`](qiskit.circuit.library.CXGate "qiskit.circuit.library.CXGate").
  </Function>

  ### cy

  <Function id="qiskit.circuit.library.PolynomialPauliRotations.cy" name="cy" signature="PolynomialPauliRotations.cy(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CYGate`](qiskit.circuit.library.CYGate "qiskit.circuit.library.CYGate").
  </Function>

  ### cz

  <Function id="qiskit.circuit.library.PolynomialPauliRotations.cz" name="cz" signature="PolynomialPauliRotations.cz(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CZGate`](qiskit.circuit.library.CZGate "qiskit.circuit.library.CZGate").
  </Function>

  ### dcx

  <Function id="qiskit.circuit.library.PolynomialPauliRotations.dcx" name="dcx" signature="PolynomialPauliRotations.dcx(qubit1, qubit2)">
    Apply [`DCXGate`](qiskit.circuit.library.DCXGate "qiskit.circuit.library.DCXGate").
  </Function>

  ### decompose

  <Function id="qiskit.circuit.library.PolynomialPauliRotations.decompose" name="decompose" signature="PolynomialPauliRotations.decompose()">
  ...
  <Function id="qiskit.circuit.library.PolynomialPauliRotations.depth" name="depth" signature="PolynomialPauliRotations.depth()">
  ...
  <Function id="qiskit.circuit.library.PolynomialPauliRotations.diag_gate" name="diag_gate" signature="PolynomialPauliRotations.diag_gate(diag, qubit)">
    Deprecated version of QuantumCircuit.diagonal.
  </Function>

  ### diagonal

  <Function id="qiskit.circuit.library.PolynomialPauliRotations.diagonal" name="diagonal" signature="PolynomialPauliRotations.diagonal(diag, qubit)">
  ...
  <Function id="qiskit.circuit.library.PolynomialPauliRotations.extend" name="extend" signature="PolynomialPauliRotations.extend(rhs)">
  ...
  <Function id="qiskit.circuit.library.PolynomialPauliRotations.fredkin" name="fredkin" signature="PolynomialPauliRotations.fredkin(control_qubit, target_qubit1, target_qubit2, *, ctl=None, tgt1=None, tgt2=None)">
    Apply [`CSwapGate`](qiskit.circuit.library.CSwapGate "qiskit.circuit.library.CSwapGate").
  </Function>

  ### from\_qasm\_file

  <Function id="qiskit.circuit.library.PolynomialPauliRotations.from_qasm_file" name="from_qasm_file" signature="static PolynomialPauliRotations.from_qasm_file(path)">
  ...
  <Function id="qiskit.circuit.library.PolynomialPauliRotations.from_qasm_str" name="from_qasm_str" signature="static PolynomialPauliRotations.from_qasm_str(qasm_str)">
  ...
  <Function id="qiskit.circuit.library.PolynomialPauliRotations.h" name="h" signature="PolynomialPauliRotations.h(qubit, *, q=None)">
    Apply [`HGate`](qiskit.circuit.library.HGate "qiskit.circuit.library.HGate").
  </Function>

  ### hamiltonian

  <Function id="qiskit.circuit.library.PolynomialPauliRotations.hamiltonian" name="hamiltonian" signature="PolynomialPauliRotations.hamiltonian(operator, time, qubits, label=None)">
    Apply hamiltonian evolution to to qubits.
  </Function>

  ### has\_register

  <Function id="qiskit.circuit.library.PolynomialPauliRotations.has_register" name="has_register" signature="PolynomialPauliRotations.has_register(register)">
  ...
  <Function id="qiskit.circuit.library.PolynomialPauliRotations.i" name="i" signature="PolynomialPauliRotations.i(qubit, *, q=None)">
    Apply [`IGate`](qiskit.circuit.library.IGate "qiskit.circuit.library.IGate").
  </Function>

  ### id

  <Function id="qiskit.circuit.library.PolynomialPauliRotations.id" name="id" signature="PolynomialPauliRotations.id(qubit, *, q=None)">
    Apply [`IGate`](qiskit.circuit.library.IGate "qiskit.circuit.library.IGate").
  </Function>

  ### iden

  <Function id="qiskit.circuit.library.PolynomialPauliRotations.iden" name="iden" signature="PolynomialPauliRotations.iden(qubit, *, q=None)">
    Deprecated identity gate.
  </Function>

  ### initialize

  <Function id="qiskit.circuit.library.PolynomialPauliRotations.initialize" name="initialize" signature="PolynomialPauliRotations.initialize(params, qubits)">
    Apply initialize to circuit.
  </Function>

  ### inverse

  <Function id="qiskit.circuit.library.PolynomialPauliRotations.inverse" name="inverse" signature="PolynomialPauliRotations.inverse()">
    Invert this circuit.
  ...
  <Function id="qiskit.circuit.library.PolynomialPauliRotations.iso" name="iso" signature="PolynomialPauliRotations.iso(isometry, q_input, q_ancillas_for_output, q_ancillas_zero=None, q_ancillas_dirty=None)">
  ...
  <Function id="qiskit.circuit.library.PolynomialPauliRotations.isometry" name="isometry" signature="PolynomialPauliRotations.isometry(isometry, q_input, q_ancillas_for_output, q_ancillas_zero=None, q_ancillas_dirty=None)">
    Attach an arbitrary isometry from m to n qubits to a circuit. In particular, this allows to attach arbitrary unitaries on n qubits (m=n) or to prepare any state on n qubits (m=0). The decomposition used here was introduced by Iten et al. in [https://arxiv.org/abs/1501.06911](https://arxiv.org/abs/1501.06911).
  ...
  <Function id="qiskit.circuit.library.PolynomialPauliRotations.iswap" name="iswap" signature="PolynomialPauliRotations.iswap(qubit1, qubit2)">
    Apply [`iSwapGate`](qiskit.circuit.library.iSwapGate "qiskit.circuit.library.iSwapGate").
  </Function>

  ### mcmt

  <Function id="qiskit.circuit.library.PolynomialPauliRotations.mcmt" name="mcmt" signature="PolynomialPauliRotations.mcmt(gate, control_qubits, target_qubits, ancilla_qubits=None, mode='no-ancilla', *, single_control_gate_fun=None, q_controls=None, q_ancillae=None, q_targets=None)">
  ...
  <Function id="qiskit.circuit.library.PolynomialPauliRotations.mcrx" name="mcrx" signature="PolynomialPauliRotations.mcrx(theta, q_controls, q_target, use_basis_gates=False)">
  ...
  <Function id="qiskit.circuit.library.PolynomialPauliRotations.mcry" name="mcry" signature="PolynomialPauliRotations.mcry(theta, q_controls, q_target, q_ancillae, mode='basic', use_basis_gates=False)">
  ...
  <Function id="qiskit.circuit.library.PolynomialPauliRotations.mcrz" name="mcrz" signature="PolynomialPauliRotations.mcrz(lam, q_controls, q_target, use_basis_gates=False)">
  ...
  <Function id="qiskit.circuit.library.PolynomialPauliRotations.mct" name="mct" signature="PolynomialPauliRotations.mct(control_qubits, target_qubit, ancilla_qubits=None, mode='noancilla')">
    Apply `MCXGate`.
  </Function>

  ### mcu1

  <Function id="qiskit.circuit.library.PolynomialPauliRotations.mcu1" name="mcu1" signature="PolynomialPauliRotations.mcu1(lam, control_qubits, target_qubit)">
    Apply `MCU1Gate`.
  </Function>

  ### mcx

  <Function id="qiskit.circuit.library.PolynomialPauliRotations.mcx" name="mcx" signature="PolynomialPauliRotations.mcx(control_qubits, target_qubit, ancilla_qubits=None, mode='noancilla')">
    Apply `MCXGate`.
  ...
  <Function id="qiskit.circuit.library.PolynomialPauliRotations.measure" name="measure" signature="PolynomialPauliRotations.measure(qubit, cbit)">
  ...
  <Function id="qiskit.circuit.library.PolynomialPauliRotations.measure_active" name="measure_active" signature="PolynomialPauliRotations.measure_active(inplace=True)">
  ...
  <Function id="qiskit.circuit.library.PolynomialPauliRotations.measure_all" name="measure_all" signature="PolynomialPauliRotations.measure_all(inplace=True)">
  ...
  <Function id="qiskit.circuit.library.PolynomialPauliRotations.mirror" name="mirror" signature="PolynomialPauliRotations.mirror()">
  ...
  <Function id="qiskit.circuit.library.PolynomialPauliRotations.ms" name="ms" signature="PolynomialPauliRotations.ms(theta, qubits)">
    Apply [`MSGate`](qiskit.circuit.library.MSGate "qiskit.circuit.library.MSGate").
  </Function>

  ### num\_connected\_components

  <Function id="qiskit.circuit.library.PolynomialPauliRotations.num_connected_components" name="num_connected_components" signature="PolynomialPauliRotations.num_connected_components(unitary_only=False)">
  ...
  <Function id="qiskit.circuit.library.PolynomialPauliRotations.num_nonlocal_gates" name="num_nonlocal_gates" signature="PolynomialPauliRotations.num_nonlocal_gates()">
  ...
  <Function id="qiskit.circuit.library.PolynomialPauliRotations.num_tensor_factors" name="num_tensor_factors" signature="PolynomialPauliRotations.num_tensor_factors()">
  ...
  <Function id="qiskit.circuit.library.PolynomialPauliRotations.num_unitary_factors" name="num_unitary_factors" signature="PolynomialPauliRotations.num_unitary_factors()">
    Computes the number of tensor factors in the unitary (quantum) part of the circuit only.
  </Function>

  ### qasm

  <Function id="qiskit.circuit.library.PolynomialPauliRotations.qasm" name="qasm" signature="PolynomialPauliRotations.qasm(formatted=False, filename=None)">
  ...
  <Function id="qiskit.circuit.library.PolynomialPauliRotations.qbit_argument_conversion" name="qbit_argument_conversion" signature="PolynomialPauliRotations.qbit_argument_conversion(qubit_representation)">
  ...
  <Function id="qiskit.circuit.library.PolynomialPauliRotations.r" name="r" signature="PolynomialPauliRotations.r(theta, phi, qubit, *, q=None)">
    Apply `RGate`.
  </Function>

  ### rcccx

  <Function id="qiskit.circuit.library.PolynomialPauliRotations.rcccx" name="rcccx" signature="PolynomialPauliRotations.rcccx(control_qubit1, control_qubit2, control_qubit3, target_qubit)">
    Apply [`RC3XGate`](qiskit.circuit.library.RC3XGate "qiskit.circuit.library.RC3XGate").
  </Function>

  ### rccx

  <Function id="qiskit.circuit.library.PolynomialPauliRotations.rccx" name="rccx" signature="PolynomialPauliRotations.rccx(control_qubit1, control_qubit2, target_qubit)">
    Apply [`RCCXGate`](qiskit.circuit.library.RCCXGate "qiskit.circuit.library.RCCXGate").
  </Function>

  ### remove\_final\_measurements

  <Function id="qiskit.circuit.library.PolynomialPauliRotations.remove_final_measurements" name="remove_final_measurements" signature="PolynomialPauliRotations.remove_final_measurements(inplace=True)">
  ...
  <Function id="qiskit.circuit.library.PolynomialPauliRotations.reset" name="reset" signature="PolynomialPauliRotations.reset(qubit)">
    Reset q.
  </Function>

  ### rx

  <Function id="qiskit.circuit.library.PolynomialPauliRotations.rx" name="rx" signature="PolynomialPauliRotations.rx(theta, qubit, *, label=None, q=None)">
    Apply [`RXGate`](qiskit.circuit.library.RXGate "qiskit.circuit.library.RXGate").
  </Function>

  ### rxx

  <Function id="qiskit.circuit.library.PolynomialPauliRotations.rxx" name="rxx" signature="PolynomialPauliRotations.rxx(theta, qubit1, qubit2)">
    Apply [`RXXGate`](qiskit.circuit.library.RXXGate "qiskit.circuit.library.RXXGate").
  </Function>

  ### ry

  <Function id="qiskit.circuit.library.PolynomialPauliRotations.ry" name="ry" signature="PolynomialPauliRotations.ry(theta, qubit, *, label=None, q=None)">
    Apply [`RYGate`](qiskit.circuit.library.RYGate "qiskit.circuit.library.RYGate").
  </Function>

  ### ryy

  <Function id="qiskit.circuit.library.PolynomialPauliRotations.ryy" name="ryy" signature="PolynomialPauliRotations.ryy(theta, qubit1, qubit2)">
    Apply [`RYYGate`](qiskit.circuit.library.RYYGate "qiskit.circuit.library.RYYGate").
  </Function>

  ### rz

  <Function id="qiskit.circuit.library.PolynomialPauliRotations.rz" name="rz" signature="PolynomialPauliRotations.rz(phi, qubit, *, q=None)">
    Apply [`RZGate`](qiskit.circuit.library.RZGate "qiskit.circuit.library.RZGate").
  </Function>

  ### rzx

  <Function id="qiskit.circuit.library.PolynomialPauliRotations.rzx" name="rzx" signature="PolynomialPauliRotations.rzx(theta, qubit1, qubit2)">
    Apply [`RZXGate`](qiskit.circuit.library.RZXGate "qiskit.circuit.library.RZXGate").
  </Function>

  ### rzz

  <Function id="qiskit.circuit.library.PolynomialPauliRotations.rzz" name="rzz" signature="PolynomialPauliRotations.rzz(theta, qubit1, qubit2)">
    Apply [`RZZGate`](qiskit.circuit.library.RZZGate "qiskit.circuit.library.RZZGate").
  </Function>

  ### s

  <Function id="qiskit.circuit.library.PolynomialPauliRotations.s" name="s" signature="PolynomialPauliRotations.s(qubit, *, q=None)">
    Apply [`SGate`](qiskit.circuit.library.SGate "qiskit.circuit.library.SGate").
  </Function>

  ### sdg

  <Function id="qiskit.circuit.library.PolynomialPauliRotations.sdg" name="sdg" signature="PolynomialPauliRotations.sdg(qubit, *, q=None)">
    Apply [`SdgGate`](qiskit.circuit.library.SdgGate "qiskit.circuit.library.SdgGate").
  </Function>

  ### size

  <Function id="qiskit.circuit.library.PolynomialPauliRotations.size" name="size" signature="PolynomialPauliRotations.size()">
  ...
  <Function id="qiskit.circuit.library.PolynomialPauliRotations.snapshot" name="snapshot" signature="PolynomialPauliRotations.snapshot(label, snapshot_type='statevector', qubits=None, params=None)">
  ...
  <Function id="qiskit.circuit.library.PolynomialPauliRotations.snapshot_density_matrix" name="snapshot_density_matrix" signature="PolynomialPauliRotations.snapshot_density_matrix(label, qubits=None)">
  ...
  <Function id="qiskit.circuit.library.PolynomialPauliRotations.snapshot_expectation_value" name="snapshot_expectation_value" signature="PolynomialPauliRotations.snapshot_expectation_value(label, op, qubits, single_shot=False, variance=False)">
  ...
  <Function id="qiskit.circuit.library.PolynomialPauliRotations.snapshot_probabilities" name="snapshot_probabilities" signature="PolynomialPauliRotations.snapshot_probabilities(label, qubits, variance=False)">
  ...
  <Function id="qiskit.circuit.library.PolynomialPauliRotations.snapshot_stabilizer" name="snapshot_stabilizer" signature="PolynomialPauliRotations.snapshot_stabilizer(label)">
  ...
  <Function id="qiskit.circuit.library.PolynomialPauliRotations.snapshot_statevector" name="snapshot_statevector" signature="PolynomialPauliRotations.snapshot_statevector(label)">
  ...
  <Function id="qiskit.circuit.library.PolynomialPauliRotations.squ" name="squ" signature="PolynomialPauliRotations.squ(unitary_matrix, qubit, mode='ZYZ', up_to_diagonal=False, *, u=None)">
  ...
  <Function id="qiskit.circuit.library.PolynomialPauliRotations.swap" name="swap" signature="PolynomialPauliRotations.swap(qubit1, qubit2)">
    Apply [`SwapGate`](qiskit.circuit.library.SwapGate "qiskit.circuit.library.SwapGate").
  </Function>

  ### t

  <Function id="qiskit.circuit.library.PolynomialPauliRotations.t" name="t" signature="PolynomialPauliRotations.t(qubit, *, q=None)">
    Apply [`TGate`](qiskit.circuit.library.TGate "qiskit.circuit.library.TGate").
  </Function>

  ### tdg

  <Function id="qiskit.circuit.library.PolynomialPauliRotations.tdg" name="tdg" signature="PolynomialPauliRotations.tdg(qubit, *, q=None)">
    Apply [`TdgGate`](qiskit.circuit.library.TdgGate "qiskit.circuit.library.TdgGate").
  </Function>

  ### to\_gate

  <Function id="qiskit.circuit.library.PolynomialPauliRotations.to_gate" name="to_gate" signature="PolynomialPauliRotations.to_gate(parameter_map=None)">
  ...
  <Function id="qiskit.circuit.library.PolynomialPauliRotations.to_instruction" name="to_instruction" signature="PolynomialPauliRotations.to_instruction(parameter_map=None)">
  ...
  <Function id="qiskit.circuit.library.PolynomialPauliRotations.toffoli" name="toffoli" signature="PolynomialPauliRotations.toffoli(control_qubit1, control_qubit2, target_qubit, *, ctl1=None, ctl2=None, tgt=None)">
    Apply [`CCXGate`](qiskit.circuit.library.CCXGate "qiskit.circuit.library.CCXGate").
  </Function>

  ### u1

  <Function id="qiskit.circuit.library.PolynomialPauliRotations.u1" name="u1" signature="PolynomialPauliRotations.u1(theta, qubit, *, q=None)">
    Apply [`U1Gate`](qiskit.circuit.library.U1Gate "qiskit.circuit.library.U1Gate").
  </Function>

  ### u2

  <Function id="qiskit.circuit.library.PolynomialPauliRotations.u2" name="u2" signature="PolynomialPauliRotations.u2(phi, lam, qubit, *, q=None)">
    Apply [`U2Gate`](qiskit.circuit.library.U2Gate "qiskit.circuit.library.U2Gate").
  </Function>

  ### u3

  <Function id="qiskit.circuit.library.PolynomialPauliRotations.u3" name="u3" signature="PolynomialPauliRotations.u3(theta, phi, lam, qubit, *, q=None)">
    Apply [`U3Gate`](qiskit.circuit.library.U3Gate "qiskit.circuit.library.U3Gate").
  </Function>

  ### uc

  <Function id="qiskit.circuit.library.PolynomialPauliRotations.uc" name="uc" signature="PolynomialPauliRotations.uc(gate_list, q_controls, q_target, up_to_diagonal=False)">
  ...
  <Function id="qiskit.circuit.library.PolynomialPauliRotations.ucg" name="ucg" signature="PolynomialPauliRotations.ucg(angle_list, q_controls, q_target, up_to_diagonal=False)">
    Deprecated version of uc.
  </Function>

  ### ucrx

  <Function id="qiskit.circuit.library.PolynomialPauliRotations.ucrx" name="ucrx" signature="PolynomialPauliRotations.ucrx(angle_list, q_controls, q_target)">
  ...
  <Function id="qiskit.circuit.library.PolynomialPauliRotations.ucry" name="ucry" signature="PolynomialPauliRotations.ucry(angle_list, q_controls, q_target)">
  ...
  <Function id="qiskit.circuit.library.PolynomialPauliRotations.ucrz" name="ucrz" signature="PolynomialPauliRotations.ucrz(angle_list, q_controls, q_target)">
  ...
  <Function id="qiskit.circuit.library.PolynomialPauliRotations.ucx" name="ucx" signature="PolynomialPauliRotations.ucx(angle_list, q_controls, q_target)">
    Deprecated version of ucrx.
  </Function>

  ### ucy

  <Function id="qiskit.circuit.library.PolynomialPauliRotations.ucy" name="ucy" signature="PolynomialPauliRotations.ucy(angle_list, q_controls, q_target)">
    Deprecated version of ucry.
  </Function>

  ### ucz

  <Function id="qiskit.circuit.library.PolynomialPauliRotations.ucz" name="ucz" signature="PolynomialPauliRotations.ucz(angle_list, q_controls, q_target)">
    Deprecated version of ucrz.
  </Function>

  ### unitary

  <Function id="qiskit.circuit.library.PolynomialPauliRotations.unitary" name="unitary" signature="PolynomialPauliRotations.unitary(obj, qubits, label=None)">
    Apply unitary gate to q.
  </Function>

  ### width

  <Function id="qiskit.circuit.library.PolynomialPauliRotations.width" name="width" signature="PolynomialPauliRotations.width()">
  ...
  <Function id="qiskit.circuit.library.PolynomialPauliRotations.x" name="x" signature="PolynomialPauliRotations.x(qubit, *, label=None, ctrl_state=None, q=None)">
    Apply [`XGate`](qiskit.circuit.library.XGate "qiskit.circuit.library.XGate").
  </Function>

  ### y

  <Function id="qiskit.circuit.library.PolynomialPauliRotations.y" name="y" signature="PolynomialPauliRotations.y(qubit, *, q=None)">
    Apply [`YGate`](qiskit.circuit.library.YGate "qiskit.circuit.library.YGate").
  </Function>

  ### z

  <Function id="qiskit.circuit.library.PolynomialPauliRotations.z" name="z" signature="PolynomialPauliRotations.z(qubit, *, q=None)">
