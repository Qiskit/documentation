---
title: PolynomialPauliRotations (v0.19)
description: API reference for qiskit.circuit.library.PolynomialPauliRotations in qiskit v0.19
...
$$
  ...
  *   **name** (`str`) – The name of the circuit.
  ...
  <span id="polynomialpaulirotations-basis" />

  ### basis

  <Attribute id="qiskit.circuit.library.PolynomialPauliRotations.basis" attributeTypeHint="str">
  ...
  <span id="polynomialpaulirotations-clbits" />
  ...
  <span id="polynomialpaulirotations-coeffs" />

  ### coeffs

  <Attribute id="qiskit.circuit.library.PolynomialPauliRotations.coeffs" attributeTypeHint="List[float]">
  ...
  <span id="polynomialpaulirotations-data" />
  ...
  <span id="polynomialpaulirotations-degree" />

  ### degree

  <Attribute id="qiskit.circuit.library.PolynomialPauliRotations.degree" attributeTypeHint="int">
  ...
  <span id="polynomialpaulirotations-extension-lib" />

  ### extension\_lib

  <Attribute id="qiskit.circuit.library.PolynomialPauliRotations.extension_lib" attributeValue="'include &#x22;qelib1.inc&#x22;;'" />

  <span id="polynomialpaulirotations-header" />

  ### header

  <Attribute id="qiskit.circuit.library.PolynomialPauliRotations.header" attributeValue="'OPENQASM 2.0;'" />

  <span id="polynomialpaulirotations-instances" />

  ### instances

  <Attribute id="qiskit.circuit.library.PolynomialPauliRotations.instances" attributeValue="8" />

  <span id="polynomialpaulirotations-n-qubits" />

  ### n\_qubits

  <Attribute id="qiskit.circuit.library.PolynomialPauliRotations.n_qubits">
    Deprecated, use `num_qubits` instead. Return number of qubits.
  </Attribute>

  <span id="polynomialpaulirotations-num-ancilla-qubits" />

  ### num\_ancilla\_qubits

  <Attribute id="qiskit.circuit.library.PolynomialPauliRotations.num_ancilla_qubits" attributeTypeHint="int">
  ...
  <span id="polynomialpaulirotations-num-clbits" />
  ...
  <span id="polynomialpaulirotations-num-parameters" />
  ...
  <span id="polynomialpaulirotations-num-qubits" />
  ...
  <span id="polynomialpaulirotations-num-state-qubits" />

  ### num\_state\_qubits

  <Attribute id="qiskit.circuit.library.PolynomialPauliRotations.num_state_qubits" attributeTypeHint="int">
  ...
  <span id="polynomialpaulirotations-parameters" />
  ...
  <span id="polynomialpaulirotations-qubits" />
  ...
  <span id="polynomialpaulirotations-reverse" />

  ### reverse

  <Attribute id="qiskit.circuit.library.PolynomialPauliRotations.reverse" attributeTypeHint="bool">
  ...
  <span id="polynomialpaulirotations-and" />

  ### AND

  <Function id="qiskit.circuit.library.PolynomialPauliRotations.AND" signature="PolynomialPauliRotations.AND(qr_variables, qb_target, qr_ancillae, flags=None, mct_mode='no-ancilla')">
  ...
  <span id="polynomialpaulirotations-or" />

  ### OR

  <Function id="qiskit.circuit.library.PolynomialPauliRotations.OR" signature="PolynomialPauliRotations.OR(qr_variables, qb_target, qr_ancillae, flags=None, mct_mode='basic')">
  ...
  <span id="polynomialpaulirotations-getitem" />

  ### \_\_getitem\_\_

  <Function id="qiskit.circuit.library.PolynomialPauliRotations.__getitem__" signature="PolynomialPauliRotations.__getitem__(item)">
    Return indexed operation.
  </Function>

  <span id="polynomialpaulirotations-len" />

  ### \_\_len\_\_

  <Function id="qiskit.circuit.library.PolynomialPauliRotations.__len__" signature="PolynomialPauliRotations.__len__()">
    Return number of operations in circuit.
  </Function>

  <span id="polynomialpaulirotations-add-register" />

  ### add\_register

  <Function id="qiskit.circuit.library.PolynomialPauliRotations.add_register" signature="PolynomialPauliRotations.add_register(*regs)">
    Add registers.
  </Function>

  <span id="polynomialpaulirotations-append" />

  ### append

  <Function id="qiskit.circuit.library.PolynomialPauliRotations.append" signature="PolynomialPauliRotations.append(instruction, qargs=None, cargs=None)">
  ...
  <span id="polynomialpaulirotations-assign-parameters" />

  ### assign\_parameters

  <Function id="qiskit.circuit.library.PolynomialPauliRotations.assign_parameters" signature="PolynomialPauliRotations.assign_parameters(param_dict, inplace=False)">
  ...
  <span id="polynomialpaulirotations-barrier" />

  ### barrier

  <Function id="qiskit.circuit.library.PolynomialPauliRotations.barrier" signature="PolynomialPauliRotations.barrier(*qargs)">
    Apply `Barrier`. If qargs is None, applies to all.
  </Function>

  <span id="polynomialpaulirotations-bind-parameters" />

  ### bind\_parameters

  <Function id="qiskit.circuit.library.PolynomialPauliRotations.bind_parameters" signature="PolynomialPauliRotations.bind_parameters(value_dict)">
  ...
  <span id="polynomialpaulirotations-cast" />

  ### cast

  <Function id="qiskit.circuit.library.PolynomialPauliRotations.cast" signature="PolynomialPauliRotations.cast(value, _type)" modifiers="static">
    Best effort to cast value to type. Otherwise, returns the value.
  </Function>

  <span id="polynomialpaulirotations-cbit-argument-conversion" />

  ### cbit\_argument\_conversion

  <Function id="qiskit.circuit.library.PolynomialPauliRotations.cbit_argument_conversion" signature="PolynomialPauliRotations.cbit_argument_conversion(clbit_representation)">
  ...
  <span id="polynomialpaulirotations-ccx" />

  ### ccx

  <Function id="qiskit.circuit.library.PolynomialPauliRotations.ccx" signature="PolynomialPauliRotations.ccx(control_qubit1, control_qubit2, target_qubit, *, ctl1=None, ctl2=None, tgt=None)">
    Apply [`CCXGate`](qiskit.circuit.library.CCXGate "qiskit.circuit.library.CCXGate").
  </Function>

  <span id="polynomialpaulirotations-ch" />

  ### ch

  <Function id="qiskit.circuit.library.PolynomialPauliRotations.ch" signature="PolynomialPauliRotations.ch(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CHGate`](qiskit.circuit.library.CHGate "qiskit.circuit.library.CHGate").
  </Function>

  <span id="polynomialpaulirotations-cls-instances" />

  ### cls\_instances

  <Function id="qiskit.circuit.library.PolynomialPauliRotations.cls_instances" signature="PolynomialPauliRotations.cls_instances()" modifiers="classmethod">
    Return the current number of instances of this class, useful for auto naming.
  </Function>

  <span id="polynomialpaulirotations-cls-prefix" />

  ### cls\_prefix

  <Function id="qiskit.circuit.library.PolynomialPauliRotations.cls_prefix" signature="PolynomialPauliRotations.cls_prefix()" modifiers="classmethod">
    Return the prefix to use for auto naming.
  </Function>

  <span id="polynomialpaulirotations-cnot" />

  ### cnot

  <Function id="qiskit.circuit.library.PolynomialPauliRotations.cnot" signature="PolynomialPauliRotations.cnot(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CXGate`](qiskit.circuit.library.CXGate "qiskit.circuit.library.CXGate").
  </Function>

  <span id="polynomialpaulirotations-combine" />

  ### combine

  <Function id="qiskit.circuit.library.PolynomialPauliRotations.combine" signature="PolynomialPauliRotations.combine(rhs)">
  ...
  <span id="polynomialpaulirotations-compose" />

  ### compose

  <Function id="qiskit.circuit.library.PolynomialPauliRotations.compose" signature="PolynomialPauliRotations.compose(other, qubits=None, clbits=None, front=False, inplace=False)">
  ...
  <span id="polynomialpaulirotations-copy" />

  ### copy

  <Function id="qiskit.circuit.library.PolynomialPauliRotations.copy" signature="PolynomialPauliRotations.copy(name=None)">
    Copy the circuit.
  ...
  <span id="polynomialpaulirotations-count-ops" />

  ### count\_ops

  <Function id="qiskit.circuit.library.PolynomialPauliRotations.count_ops" signature="PolynomialPauliRotations.count_ops()">
  ...
  <span id="polynomialpaulirotations-crx" />

  ### crx

  <Function id="qiskit.circuit.library.PolynomialPauliRotations.crx" signature="PolynomialPauliRotations.crx(theta, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CRXGate`](qiskit.circuit.library.CRXGate "qiskit.circuit.library.CRXGate").
  </Function>

  <span id="polynomialpaulirotations-cry" />

  ### cry

  <Function id="qiskit.circuit.library.PolynomialPauliRotations.cry" signature="PolynomialPauliRotations.cry(theta, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CRYGate`](qiskit.circuit.library.CRYGate "qiskit.circuit.library.CRYGate").
  </Function>

  <span id="polynomialpaulirotations-crz" />

  ### crz

  <Function id="qiskit.circuit.library.PolynomialPauliRotations.crz" signature="PolynomialPauliRotations.crz(theta, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CRZGate`](qiskit.circuit.library.CRZGate "qiskit.circuit.library.CRZGate").
  </Function>

  <span id="polynomialpaulirotations-cswap" />

  ### cswap

  <Function id="qiskit.circuit.library.PolynomialPauliRotations.cswap" signature="PolynomialPauliRotations.cswap(control_qubit, target_qubit1, target_qubit2, *, label=None, ctrl_state=None, ctl=None, tgt1=None, tgt2=None)">
    Apply [`CSwapGate`](qiskit.circuit.library.CSwapGate "qiskit.circuit.library.CSwapGate").
  </Function>

  <span id="polynomialpaulirotations-cu1" />

  ### cu1

  <Function id="qiskit.circuit.library.PolynomialPauliRotations.cu1" signature="PolynomialPauliRotations.cu1(theta, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CU1Gate`](qiskit.circuit.library.CU1Gate "qiskit.circuit.library.CU1Gate").
  </Function>

  <span id="polynomialpaulirotations-cu3" />

  ### cu3

  <Function id="qiskit.circuit.library.PolynomialPauliRotations.cu3" signature="PolynomialPauliRotations.cu3(theta, phi, lam, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CU3Gate`](qiskit.circuit.library.CU3Gate "qiskit.circuit.library.CU3Gate").
  </Function>

  <span id="polynomialpaulirotations-cx" />

  ### cx

  <Function id="qiskit.circuit.library.PolynomialPauliRotations.cx" signature="PolynomialPauliRotations.cx(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CXGate`](qiskit.circuit.library.CXGate "qiskit.circuit.library.CXGate").
  </Function>

  <span id="polynomialpaulirotations-cy" />

  ### cy

  <Function id="qiskit.circuit.library.PolynomialPauliRotations.cy" signature="PolynomialPauliRotations.cy(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CYGate`](qiskit.circuit.library.CYGate "qiskit.circuit.library.CYGate").
  </Function>

  <span id="polynomialpaulirotations-cz" />

  ### cz

  <Function id="qiskit.circuit.library.PolynomialPauliRotations.cz" signature="PolynomialPauliRotations.cz(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CZGate`](qiskit.circuit.library.CZGate "qiskit.circuit.library.CZGate").
  </Function>

  <span id="polynomialpaulirotations-dcx" />

  ### dcx

  <Function id="qiskit.circuit.library.PolynomialPauliRotations.dcx" signature="PolynomialPauliRotations.dcx(qubit1, qubit2)">
    Apply [`DCXGate`](qiskit.circuit.library.DCXGate "qiskit.circuit.library.DCXGate").
  </Function>

  <span id="polynomialpaulirotations-decompose" />

  ### decompose

  <Function id="qiskit.circuit.library.PolynomialPauliRotations.decompose" signature="PolynomialPauliRotations.decompose()">
  ...
  <span id="polynomialpaulirotations-depth" />

  ### depth

  <Function id="qiskit.circuit.library.PolynomialPauliRotations.depth" signature="PolynomialPauliRotations.depth()">
  ...
  <span id="polynomialpaulirotations-diag-gate" />

  ### diag\_gate

  <Function id="qiskit.circuit.library.PolynomialPauliRotations.diag_gate" signature="PolynomialPauliRotations.diag_gate(diag, qubit)">
    Deprecated version of QuantumCircuit.diagonal.
  </Function>

  <span id="polynomialpaulirotations-diagonal" />

  ### diagonal

  <Function id="qiskit.circuit.library.PolynomialPauliRotations.diagonal" signature="PolynomialPauliRotations.diagonal(diag, qubit)">
  ...
  <span id="polynomialpaulirotations-extend" />

  ### extend

  <Function id="qiskit.circuit.library.PolynomialPauliRotations.extend" signature="PolynomialPauliRotations.extend(rhs)">
  ...
  <span id="polynomialpaulirotations-fredkin" />

  ### fredkin

  <Function id="qiskit.circuit.library.PolynomialPauliRotations.fredkin" signature="PolynomialPauliRotations.fredkin(control_qubit, target_qubit1, target_qubit2, *, ctl=None, tgt1=None, tgt2=None)">
    Apply [`CSwapGate`](qiskit.circuit.library.CSwapGate "qiskit.circuit.library.CSwapGate").
  </Function>

  <span id="polynomialpaulirotations-from-qasm-file" />

  ### from\_qasm\_file

  <Function id="qiskit.circuit.library.PolynomialPauliRotations.from_qasm_file" signature="PolynomialPauliRotations.from_qasm_file(path)" modifiers="static">
  ...
  <span id="polynomialpaulirotations-from-qasm-str" />

  ### from\_qasm\_str

  <Function id="qiskit.circuit.library.PolynomialPauliRotations.from_qasm_str" signature="PolynomialPauliRotations.from_qasm_str(qasm_str)" modifiers="static">
  ...
  <span id="polynomialpaulirotations-h" />

  ### h

  <Function id="qiskit.circuit.library.PolynomialPauliRotations.h" signature="PolynomialPauliRotations.h(qubit, *, q=None)">
    Apply [`HGate`](qiskit.circuit.library.HGate "qiskit.circuit.library.HGate").
  </Function>

  <span id="polynomialpaulirotations-hamiltonian" />

  ### hamiltonian

  <Function id="qiskit.circuit.library.PolynomialPauliRotations.hamiltonian" signature="PolynomialPauliRotations.hamiltonian(operator, time, qubits, label=None)">
    Apply hamiltonian evolution to to qubits.
  </Function>

  <span id="polynomialpaulirotations-has-register" />

  ### has\_register

  <Function id="qiskit.circuit.library.PolynomialPauliRotations.has_register" signature="PolynomialPauliRotations.has_register(register)">
  ...
  <span id="polynomialpaulirotations-i" />

  ### i

  <Function id="qiskit.circuit.library.PolynomialPauliRotations.i" signature="PolynomialPauliRotations.i(qubit, *, q=None)">
    Apply [`IGate`](qiskit.circuit.library.IGate "qiskit.circuit.library.IGate").
  </Function>

  <span id="polynomialpaulirotations-id" />

  ### id

  <Function id="qiskit.circuit.library.PolynomialPauliRotations.id" signature="PolynomialPauliRotations.id(qubit, *, q=None)">
    Apply [`IGate`](qiskit.circuit.library.IGate "qiskit.circuit.library.IGate").
  </Function>

  <span id="polynomialpaulirotations-iden" />

  ### iden

  <Function id="qiskit.circuit.library.PolynomialPauliRotations.iden" signature="PolynomialPauliRotations.iden(qubit, *, q=None)">
    Deprecated identity gate.
  </Function>

  <span id="polynomialpaulirotations-initialize" />

  ### initialize

  <Function id="qiskit.circuit.library.PolynomialPauliRotations.initialize" signature="PolynomialPauliRotations.initialize(params, qubits)">
    Apply initialize to circuit.
  </Function>

  <span id="polynomialpaulirotations-inverse" />

  ### inverse

  <Function id="qiskit.circuit.library.PolynomialPauliRotations.inverse" signature="PolynomialPauliRotations.inverse()">
    Invert this circuit.
  ...
  <span id="polynomialpaulirotations-iso" />

  ### iso

  <Function id="qiskit.circuit.library.PolynomialPauliRotations.iso" signature="PolynomialPauliRotations.iso(isometry, q_input, q_ancillas_for_output, q_ancillas_zero=None, q_ancillas_dirty=None)">
  ...
  <span id="polynomialpaulirotations-isometry" />

  ### isometry

  <Function id="qiskit.circuit.library.PolynomialPauliRotations.isometry" signature="PolynomialPauliRotations.isometry(isometry, q_input, q_ancillas_for_output, q_ancillas_zero=None, q_ancillas_dirty=None)">
    Attach an arbitrary isometry from m to n qubits to a circuit. In particular, this allows to attach arbitrary unitaries on n qubits (m=n) or to prepare any state on n qubits (m=0). The decomposition used here was introduced by Iten et al. in [https://arxiv.org/abs/1501.06911](https://arxiv.org/abs/1501.06911).
  ...
  <span id="polynomialpaulirotations-iswap" />

  ### iswap

  <Function id="qiskit.circuit.library.PolynomialPauliRotations.iswap" signature="PolynomialPauliRotations.iswap(qubit1, qubit2)">
    Apply [`iSwapGate`](qiskit.circuit.library.iSwapGate "qiskit.circuit.library.iSwapGate").
  </Function>

  <span id="polynomialpaulirotations-mcmt" />

  ### mcmt

  <Function id="qiskit.circuit.library.PolynomialPauliRotations.mcmt" signature="PolynomialPauliRotations.mcmt(gate, control_qubits, target_qubits, ancilla_qubits=None, mode='no-ancilla', *, single_control_gate_fun=None, q_controls=None, q_ancillae=None, q_targets=None)">
    Apply a multi-control, multi-target using a generic gate.

    This can also be used to implement a generic multi-control gate, as the target could also be of length 1.
  </Function>

  <span id="polynomialpaulirotations-mcrx" />

  ### mcrx

  <Function id="qiskit.circuit.library.PolynomialPauliRotations.mcrx" signature="PolynomialPauliRotations.mcrx(theta, q_controls, q_target, use_basis_gates=False)">
  ...
  <span id="polynomialpaulirotations-mcry" />

  ### mcry

  <Function id="qiskit.circuit.library.PolynomialPauliRotations.mcry" signature="PolynomialPauliRotations.mcry(theta, q_controls, q_target, q_ancillae, mode='basic', use_basis_gates=False)">
  ...
  <span id="polynomialpaulirotations-mcrz" />

  ### mcrz

  <Function id="qiskit.circuit.library.PolynomialPauliRotations.mcrz" signature="PolynomialPauliRotations.mcrz(lam, q_controls, q_target, use_basis_gates=False)">
  ...
  <span id="polynomialpaulirotations-mct" />

  ### mct

  <Function id="qiskit.circuit.library.PolynomialPauliRotations.mct" signature="PolynomialPauliRotations.mct(control_qubits, target_qubit, ancilla_qubits=None, mode='noancilla')">
    Apply `MCXGate`.
  </Function>

  <span id="polynomialpaulirotations-mcu1" />

  ### mcu1

  <Function id="qiskit.circuit.library.PolynomialPauliRotations.mcu1" signature="PolynomialPauliRotations.mcu1(lam, control_qubits, target_qubit)">
    Apply `MCU1Gate`.
  </Function>

  <span id="polynomialpaulirotations-mcx" />

  ### mcx

  <Function id="qiskit.circuit.library.PolynomialPauliRotations.mcx" signature="PolynomialPauliRotations.mcx(control_qubits, target_qubit, ancilla_qubits=None, mode='noancilla')">
    Apply `MCXGate`.
  ...
  <span id="polynomialpaulirotations-measure" />

  ### measure

  <Function id="qiskit.circuit.library.PolynomialPauliRotations.measure" signature="PolynomialPauliRotations.measure(qubit, cbit)">
  ...
  <span id="polynomialpaulirotations-measure-active" />

  ### measure\_active

  <Function id="qiskit.circuit.library.PolynomialPauliRotations.measure_active" signature="PolynomialPauliRotations.measure_active(inplace=True)">
  ...
  <span id="polynomialpaulirotations-measure-all" />

  ### measure\_all

  <Function id="qiskit.circuit.library.PolynomialPauliRotations.measure_all" signature="PolynomialPauliRotations.measure_all(inplace=True)">
  ...
  <span id="polynomialpaulirotations-mirror" />

  ### mirror

  <Function id="qiskit.circuit.library.PolynomialPauliRotations.mirror" signature="PolynomialPauliRotations.mirror()">
  ...
  <span id="polynomialpaulirotations-ms" />

  ### ms

  <Function id="qiskit.circuit.library.PolynomialPauliRotations.ms" signature="PolynomialPauliRotations.ms(theta, qubits)">
    Apply [`MSGate`](qiskit.circuit.library.MSGate "qiskit.circuit.library.MSGate").
  </Function>

  <span id="polynomialpaulirotations-num-connected-components" />

  ### num\_connected\_components

  <Function id="qiskit.circuit.library.PolynomialPauliRotations.num_connected_components" signature="PolynomialPauliRotations.num_connected_components(unitary_only=False)">
  ...
  <span id="polynomialpaulirotations-num-nonlocal-gates" />

  ### num\_nonlocal\_gates

  <Function id="qiskit.circuit.library.PolynomialPauliRotations.num_nonlocal_gates" signature="PolynomialPauliRotations.num_nonlocal_gates()">
    Return number of non-local gates (i.e. involving 2+ qubits).

    Conditional nonlocal gates are also included.
  </Function>

  <span id="polynomialpaulirotations-num-tensor-factors" />

  ### num\_tensor\_factors

  <Function id="qiskit.circuit.library.PolynomialPauliRotations.num_tensor_factors" signature="PolynomialPauliRotations.num_tensor_factors()">
  ...
  <span id="polynomialpaulirotations-num-unitary-factors" />

  ### num\_unitary\_factors

  <Function id="qiskit.circuit.library.PolynomialPauliRotations.num_unitary_factors" signature="PolynomialPauliRotations.num_unitary_factors()">
    Computes the number of tensor factors in the unitary (quantum) part of the circuit only.
  </Function>

  <span id="polynomialpaulirotations-qasm" />

  ### qasm

  <Function id="qiskit.circuit.library.PolynomialPauliRotations.qasm" signature="PolynomialPauliRotations.qasm(formatted=False, filename=None)">
  ...
  <span id="polynomialpaulirotations-qbit-argument-conversion" />

  ### qbit\_argument\_conversion

  <Function id="qiskit.circuit.library.PolynomialPauliRotations.qbit_argument_conversion" signature="PolynomialPauliRotations.qbit_argument_conversion(qubit_representation)">
  ...
  <span id="polynomialpaulirotations-r" />

  ### r

  <Function id="qiskit.circuit.library.PolynomialPauliRotations.r" signature="PolynomialPauliRotations.r(theta, phi, qubit, *, q=None)">
    Apply `RGate`.
  </Function>

  <span id="polynomialpaulirotations-rcccx" />

  ### rcccx

  <Function id="qiskit.circuit.library.PolynomialPauliRotations.rcccx" signature="PolynomialPauliRotations.rcccx(control_qubit1, control_qubit2, control_qubit3, target_qubit)">
    Apply [`RC3XGate`](qiskit.circuit.library.RC3XGate "qiskit.circuit.library.RC3XGate").
  </Function>

  <span id="polynomialpaulirotations-rccx" />

  ### rccx

  <Function id="qiskit.circuit.library.PolynomialPauliRotations.rccx" signature="PolynomialPauliRotations.rccx(control_qubit1, control_qubit2, target_qubit)">
    Apply [`RCCXGate`](qiskit.circuit.library.RCCXGate "qiskit.circuit.library.RCCXGate").
  </Function>

  <span id="polynomialpaulirotations-remove-final-measurements" />

  ### remove\_final\_measurements

  <Function id="qiskit.circuit.library.PolynomialPauliRotations.remove_final_measurements" signature="PolynomialPauliRotations.remove_final_measurements(inplace=True)">
  ...
  <span id="polynomialpaulirotations-reset" />

  ### reset

  <Function id="qiskit.circuit.library.PolynomialPauliRotations.reset" signature="PolynomialPauliRotations.reset(qubit)">
    Reset q.
  </Function>

  <span id="polynomialpaulirotations-rx" />

  ### rx

  <Function id="qiskit.circuit.library.PolynomialPauliRotations.rx" signature="PolynomialPauliRotations.rx(theta, qubit, *, label=None, q=None)">
    Apply [`RXGate`](qiskit.circuit.library.RXGate "qiskit.circuit.library.RXGate").
  </Function>

  <span id="polynomialpaulirotations-rxx" />

  ### rxx

  <Function id="qiskit.circuit.library.PolynomialPauliRotations.rxx" signature="PolynomialPauliRotations.rxx(theta, qubit1, qubit2)">
    Apply [`RXXGate`](qiskit.circuit.library.RXXGate "qiskit.circuit.library.RXXGate").
  </Function>

  <span id="polynomialpaulirotations-ry" />

  ### ry

  <Function id="qiskit.circuit.library.PolynomialPauliRotations.ry" signature="PolynomialPauliRotations.ry(theta, qubit, *, label=None, q=None)">
    Apply [`RYGate`](qiskit.circuit.library.RYGate "qiskit.circuit.library.RYGate").
  </Function>

  <span id="polynomialpaulirotations-ryy" />

  ### ryy

  <Function id="qiskit.circuit.library.PolynomialPauliRotations.ryy" signature="PolynomialPauliRotations.ryy(theta, qubit1, qubit2)">
    Apply [`RYYGate`](qiskit.circuit.library.RYYGate "qiskit.circuit.library.RYYGate").
  </Function>

  <span id="polynomialpaulirotations-rz" />

  ### rz

  <Function id="qiskit.circuit.library.PolynomialPauliRotations.rz" signature="PolynomialPauliRotations.rz(phi, qubit, *, q=None)">
    Apply [`RZGate`](qiskit.circuit.library.RZGate "qiskit.circuit.library.RZGate").
  </Function>

  <span id="polynomialpaulirotations-rzx" />

  ### rzx

  <Function id="qiskit.circuit.library.PolynomialPauliRotations.rzx" signature="PolynomialPauliRotations.rzx(theta, qubit1, qubit2)">
    Apply [`RZXGate`](qiskit.circuit.library.RZXGate "qiskit.circuit.library.RZXGate").
  </Function>

  <span id="polynomialpaulirotations-rzz" />

  ### rzz

  <Function id="qiskit.circuit.library.PolynomialPauliRotations.rzz" signature="PolynomialPauliRotations.rzz(theta, qubit1, qubit2)">
    Apply [`RZZGate`](qiskit.circuit.library.RZZGate "qiskit.circuit.library.RZZGate").
  </Function>

  <span id="polynomialpaulirotations-s" />

  ### s

  <Function id="qiskit.circuit.library.PolynomialPauliRotations.s" signature="PolynomialPauliRotations.s(qubit, *, q=None)">
    Apply [`SGate`](qiskit.circuit.library.SGate "qiskit.circuit.library.SGate").
  </Function>

  <span id="polynomialpaulirotations-sdg" />

  ### sdg

  <Function id="qiskit.circuit.library.PolynomialPauliRotations.sdg" signature="PolynomialPauliRotations.sdg(qubit, *, q=None)">
    Apply [`SdgGate`](qiskit.circuit.library.SdgGate "qiskit.circuit.library.SdgGate").
  </Function>

  <span id="polynomialpaulirotations-size" />

  ### size

  <Function id="qiskit.circuit.library.PolynomialPauliRotations.size" signature="PolynomialPauliRotations.size()">
  ...
  <span id="polynomialpaulirotations-snapshot" />

  ### snapshot

  <Function id="qiskit.circuit.library.PolynomialPauliRotations.snapshot" signature="PolynomialPauliRotations.snapshot(label, snapshot_type='statevector', qubits=None, params=None)">
  ...
  <span id="polynomialpaulirotations-snapshot-density-matrix" />

  ### snapshot\_density\_matrix

  <Function id="qiskit.circuit.library.PolynomialPauliRotations.snapshot_density_matrix" signature="PolynomialPauliRotations.snapshot_density_matrix(label, qubits=None)">
  ...
  <span id="polynomialpaulirotations-snapshot-expectation-value" />

  ### snapshot\_expectation\_value

  <Function id="qiskit.circuit.library.PolynomialPauliRotations.snapshot_expectation_value" signature="PolynomialPauliRotations.snapshot_expectation_value(label, op, qubits, single_shot=False, variance=False)">
  ...
  <span id="polynomialpaulirotations-snapshot-probabilities" />

  ### snapshot\_probabilities

  <Function id="qiskit.circuit.library.PolynomialPauliRotations.snapshot_probabilities" signature="PolynomialPauliRotations.snapshot_probabilities(label, qubits, variance=False)">
  ...
  <span id="polynomialpaulirotations-snapshot-stabilizer" />

  ### snapshot\_stabilizer

  <Function id="qiskit.circuit.library.PolynomialPauliRotations.snapshot_stabilizer" signature="PolynomialPauliRotations.snapshot_stabilizer(label)">
  ...
  <span id="polynomialpaulirotations-snapshot-statevector" />

  ### snapshot\_statevector

  <Function id="qiskit.circuit.library.PolynomialPauliRotations.snapshot_statevector" signature="PolynomialPauliRotations.snapshot_statevector(label)">
  ...
  <span id="polynomialpaulirotations-squ" />

  ### squ

  <Function id="qiskit.circuit.library.PolynomialPauliRotations.squ" signature="PolynomialPauliRotations.squ(unitary_matrix, qubit, mode='ZYZ', up_to_diagonal=False, *, u=None)">
  ...
  <span id="polynomialpaulirotations-swap" />

  ### swap

  <Function id="qiskit.circuit.library.PolynomialPauliRotations.swap" signature="PolynomialPauliRotations.swap(qubit1, qubit2)">
    Apply [`SwapGate`](qiskit.circuit.library.SwapGate "qiskit.circuit.library.SwapGate").
  </Function>

  <span id="polynomialpaulirotations-t" />

  ### t

  <Function id="qiskit.circuit.library.PolynomialPauliRotations.t" signature="PolynomialPauliRotations.t(qubit, *, q=None)">
    Apply [`TGate`](qiskit.circuit.library.TGate "qiskit.circuit.library.TGate").
  </Function>

  <span id="polynomialpaulirotations-tdg" />

  ### tdg

  <Function id="qiskit.circuit.library.PolynomialPauliRotations.tdg" signature="PolynomialPauliRotations.tdg(qubit, *, q=None)">
    Apply [`TdgGate`](qiskit.circuit.library.TdgGate "qiskit.circuit.library.TdgGate").
  </Function>

  <span id="polynomialpaulirotations-to-gate" />

  ### to\_gate

  <Function id="qiskit.circuit.library.PolynomialPauliRotations.to_gate" signature="PolynomialPauliRotations.to_gate(parameter_map=None)">
  ...
  <span id="polynomialpaulirotations-to-instruction" />

  ### to\_instruction

  <Function id="qiskit.circuit.library.PolynomialPauliRotations.to_instruction" signature="PolynomialPauliRotations.to_instruction(parameter_map=None)">
  ...
  <span id="polynomialpaulirotations-toffoli" />

  ### toffoli

  <Function id="qiskit.circuit.library.PolynomialPauliRotations.toffoli" signature="PolynomialPauliRotations.toffoli(control_qubit1, control_qubit2, target_qubit, *, ctl1=None, ctl2=None, tgt=None)">
    Apply [`CCXGate`](qiskit.circuit.library.CCXGate "qiskit.circuit.library.CCXGate").
  </Function>

  <span id="polynomialpaulirotations-u1" />

  ### u1

  <Function id="qiskit.circuit.library.PolynomialPauliRotations.u1" signature="PolynomialPauliRotations.u1(theta, qubit, *, q=None)">
    Apply [`U1Gate`](qiskit.circuit.library.U1Gate "qiskit.circuit.library.U1Gate").
  </Function>

  <span id="polynomialpaulirotations-u2" />

  ### u2

  <Function id="qiskit.circuit.library.PolynomialPauliRotations.u2" signature="PolynomialPauliRotations.u2(phi, lam, qubit, *, q=None)">
    Apply [`U2Gate`](qiskit.circuit.library.U2Gate "qiskit.circuit.library.U2Gate").
  </Function>

  <span id="polynomialpaulirotations-u3" />

  ### u3

  <Function id="qiskit.circuit.library.PolynomialPauliRotations.u3" signature="PolynomialPauliRotations.u3(theta, phi, lam, qubit, *, q=None)">
    Apply [`U3Gate`](qiskit.circuit.library.U3Gate "qiskit.circuit.library.U3Gate").
  </Function>

  <span id="polynomialpaulirotations-uc" />

  ### uc

  <Function id="qiskit.circuit.library.PolynomialPauliRotations.uc" signature="PolynomialPauliRotations.uc(gate_list, q_controls, q_target, up_to_diagonal=False)">
  ...
  <span id="polynomialpaulirotations-ucg" />

  ### ucg

  <Function id="qiskit.circuit.library.PolynomialPauliRotations.ucg" signature="PolynomialPauliRotations.ucg(angle_list, q_controls, q_target, up_to_diagonal=False)">
    Deprecated version of uc.
  </Function>

  <span id="polynomialpaulirotations-ucrx" />

  ### ucrx

  <Function id="qiskit.circuit.library.PolynomialPauliRotations.ucrx" signature="PolynomialPauliRotations.ucrx(angle_list, q_controls, q_target)">
  ...
  <span id="polynomialpaulirotations-ucry" />

  ### ucry

  <Function id="qiskit.circuit.library.PolynomialPauliRotations.ucry" signature="PolynomialPauliRotations.ucry(angle_list, q_controls, q_target)">
  ...
  <span id="polynomialpaulirotations-ucrz" />

  ### ucrz

  <Function id="qiskit.circuit.library.PolynomialPauliRotations.ucrz" signature="PolynomialPauliRotations.ucrz(angle_list, q_controls, q_target)">
  ...
  <span id="polynomialpaulirotations-ucx" />

  ### ucx

  <Function id="qiskit.circuit.library.PolynomialPauliRotations.ucx" signature="PolynomialPauliRotations.ucx(angle_list, q_controls, q_target)">
    Deprecated version of ucrx.
  </Function>

  <span id="polynomialpaulirotations-ucy" />

  ### ucy

  <Function id="qiskit.circuit.library.PolynomialPauliRotations.ucy" signature="PolynomialPauliRotations.ucy(angle_list, q_controls, q_target)">
    Deprecated version of ucry.
  </Function>

  <span id="polynomialpaulirotations-ucz" />

  ### ucz

  <Function id="qiskit.circuit.library.PolynomialPauliRotations.ucz" signature="PolynomialPauliRotations.ucz(angle_list, q_controls, q_target)">
    Deprecated version of ucrz.
  </Function>

  <span id="polynomialpaulirotations-unitary" />

  ### unitary

  <Function id="qiskit.circuit.library.PolynomialPauliRotations.unitary" signature="PolynomialPauliRotations.unitary(obj, qubits, label=None)">
    Apply unitary gate to q.
  </Function>

  <span id="polynomialpaulirotations-width" />

  ### width

  <Function id="qiskit.circuit.library.PolynomialPauliRotations.width" signature="PolynomialPauliRotations.width()">
  ...
  <span id="polynomialpaulirotations-x" />

  ### x

  <Function id="qiskit.circuit.library.PolynomialPauliRotations.x" signature="PolynomialPauliRotations.x(qubit, *, label=None, ctrl_state=None, q=None)">
    Apply [`XGate`](qiskit.circuit.library.XGate "qiskit.circuit.library.XGate").
  </Function>

  <span id="polynomialpaulirotations-y" />

  ### y

  <Function id="qiskit.circuit.library.PolynomialPauliRotations.y" signature="PolynomialPauliRotations.y(qubit, *, q=None)">
    Apply [`YGate`](qiskit.circuit.library.YGate "qiskit.circuit.library.YGate").
  </Function>

  <span id="polynomialpaulirotations-z" />

  ### z

  <Function id="qiskit.circuit.library.PolynomialPauliRotations.z" signature="PolynomialPauliRotations.z(qubit, *, q=None)">
