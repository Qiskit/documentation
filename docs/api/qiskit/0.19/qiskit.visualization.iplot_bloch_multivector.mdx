...
<Function id="qiskit.visualization.iplot_bloch_multivector" name="iplot_bloch_multivector" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.14/qiskit/visualization/interactive/iplot_blochsphere.py" signature="iplot_bloch_multivector(rho, figsize=None)">
