---
title: CustomCircuitOracle (v0.19)
description: API reference for qiskit.aqua.components.oracles.CustomCircuitOracle in qiskit v0.19
...
<Class id="qiskit.aqua.components.oracles.CustomCircuitOracle" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.7/qiskit/aqua/components/oracles/custom_circuit_oracle.py" signature="CustomCircuitOracle(variable_register=None, output_register=None, ancillary_register=None, circuit=None, evaluate_classically_callback=None)" modifiers="class">
  ...
  **Raises**
  ...
  <span id="customcircuitoracle-ancillary-register" />
  ...
  <span id="customcircuitoracle-circuit" />

  ### circuit

  <Attribute id="qiskit.aqua.components.oracles.CustomCircuitOracle.circuit" />

  <span id="customcircuitoracle-output-register" />
  ...
  <span id="customcircuitoracle-variable-register" />
  ...
  <span id="customcircuitoracle-construct-circuit" />
