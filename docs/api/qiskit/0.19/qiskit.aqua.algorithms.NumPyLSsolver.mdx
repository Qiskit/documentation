...
<Class id="qiskit.aqua.algorithms.NumPyLSsolver" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.7/qiskit/aqua/algorithms/linear_solvers/numpy_ls_solver.py" signature="NumPyLSsolver(matrix, vector)">
  ...
  *   **vector** (`Union`\[`List`\[`float`], `ndarray`]) – The input vector of linear system of equations
  ...
  <Attribute id="qiskit.aqua.algorithms.NumPyLSsolver.random" name="random">
  ...
  <Function id="qiskit.aqua.algorithms.NumPyLSsolver.run" name="run" signature="NumPyLSsolver.run()">
