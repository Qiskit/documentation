...
`plot_histogram(data, figsize=(7, 5), color=None, number_to_keep=None, sort='asc', target_string=None, legend=None, bar_labels=True, title=None, ax=None)` [GitHub](https://github.com/qiskit/qiskit/tree/stable/0.14/qiskit/visualization/counts_visualization.py "view source code")
...
![../\_images/qiskit.visualization.plot\_histogram\_0\_2.png](/images/api/qiskit/0.19/qiskit.visualization.plot_histogram_0_2.png) ![../\_images/qiskit.visualization.plot\_histogram\_0\_3.png](/images/api/qiskit/0.19/qiskit.visualization.plot_histogram_0_3.png)
