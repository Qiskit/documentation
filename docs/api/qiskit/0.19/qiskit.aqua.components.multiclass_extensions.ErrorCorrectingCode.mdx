...
<Class id="qiskit.aqua.components.multiclass_extensions.ErrorCorrectingCode" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.7/qiskit/aqua/components/multiclass_extensions/error_correcting_code.py" signature="ErrorCorrectingCode(code_size=4)">
  ...
  **code\_size** (`int`) – Size of error correcting code
  ...
  <Function id="qiskit.aqua.components.multiclass_extensions.ErrorCorrectingCode.predict" name="predict" signature="ErrorCorrectingCode.predict(x)">
  ...
  <Function id="qiskit.aqua.components.multiclass_extensions.ErrorCorrectingCode.set_estimator" name="set_estimator" signature="ErrorCorrectingCode.set_estimator(estimator_cls, params=None)">
  ...
  <Function id="qiskit.aqua.components.multiclass_extensions.ErrorCorrectingCode.test" name="test" signature="ErrorCorrectingCode.test(x, y)">
  ...
  <Function id="qiskit.aqua.components.multiclass_extensions.ErrorCorrectingCode.train" name="train" signature="ErrorCorrectingCode.train(x, y)">
