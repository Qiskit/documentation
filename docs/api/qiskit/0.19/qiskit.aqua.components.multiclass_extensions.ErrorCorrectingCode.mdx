---
title: ErrorCorrectingCode (v0.19)
description: API reference for qiskit.aqua.components.multiclass_extensions.ErrorCorrectingCode in qiskit v0.19
...
<Class id="qiskit.aqua.components.multiclass_extensions.ErrorCorrectingCode" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.7/qiskit/aqua/components/multiclass_extensions/error_correcting_code.py" signature="ErrorCorrectingCode(code_size=4)" modifiers="class">
  ...
  **code\_size** (`int`) – Size of error correcting code
  ...
  <span id="errorcorrectingcode-predict" />
  ...
  <span id="errorcorrectingcode-set-estimator" />
  ...
  <span id="errorcorrectingcode-test" />
  ...
  <span id="errorcorrectingcode-train" />
