...
<Class id="qiskit.pulse.Delay" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.14/qiskit/pulse/instructions/delay.py" signature="Delay(duration, channel=None, name=None)">
  ...
  *   **name** (`Optional`\[`str`]) – Name of the delay for display purposes.
  ...
  <Attribute id="qiskit.pulse.Delay.channel" signature="qiskit.pulse.channels.Channel">
  ...
  <Attribute id="qiskit.pulse.Delay.channels" signature="Tuple[qiskit.pulse.channels.Channel]">
  ...
  <Attribute id="qiskit.pulse.Delay.command" signature="qiskit.pulse.commands.command.Command">
  ...
  <Attribute id="qiskit.pulse.Delay.duration" signature="int">
  ...
  <Attribute id="qiskit.pulse.Delay.id" signature="int">
  ...
  <Attribute id="qiskit.pulse.Delay.instructions" signature="Tuple[Tuple[int, qiskit.pulse.instructions.instruction.Instruction]]">
  ...
  <Attribute id="qiskit.pulse.Delay.name" signature="str">
  ...
  <Attribute id="qiskit.pulse.Delay.operands" signature="Tuple">
  ...
  <Attribute id="qiskit.pulse.Delay.start_time" signature="int">
  ...
  <Attribute id="qiskit.pulse.Delay.stop_time" signature="int">
  ...
  <Attribute id="qiskit.pulse.Delay.timeslots" signature="Dict[qiskit.pulse.channels.Channel, List[Tuple[int, int]]]">
