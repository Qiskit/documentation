...
<Class id="qiskit.pulse.Delay" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.14/qiskit/pulse/instructions/delay.py" signature="Delay(duration, channel=None, name=None)">
  ...
  *   **name** (`Optional`\[`str`]) – Name of the delay for display purposes.
  ...
  <Attribute id="qiskit.pulse.Delay.channel" name="channel" signature="qiskit.pulse.channels.Channel">
  ...
  <Attribute id="qiskit.pulse.Delay.channels" name="channels" signature="Tuple[qiskit.pulse.channels.Channel]">
  ...
  <Attribute id="qiskit.pulse.Delay.command" name="command" signature="qiskit.pulse.commands.command.Command">
  ...
  <Attribute id="qiskit.pulse.Delay.duration" name="duration" signature="int">
  ...
  <Attribute id="qiskit.pulse.Delay.id" name="id" signature="int">
  ...
  <Attribute id="qiskit.pulse.Delay.instructions" name="instructions" signature="Tuple[Tuple[int, qiskit.pulse.instructions.instruction.Instruction]]">
  ...
  <Attribute id="qiskit.pulse.Delay.name" name="name" signature="str">
  ...
  <Attribute id="qiskit.pulse.Delay.operands" name="operands" signature="Tuple">
  ...
  <Attribute id="qiskit.pulse.Delay.start_time" name="start_time" signature="int">
  ...
  <Attribute id="qiskit.pulse.Delay.stop_time" name="stop_time" signature="int">
  ...
  <Attribute id="qiskit.pulse.Delay.timeslots" name="timeslots" signature="Dict[qiskit.pulse.channels.Channel, List[Tuple[int, int]]]">
  ...
  <Function id="qiskit.pulse.Delay.__call__" name="__call__" signature="Delay.__call__(channel)">
  ...
  <Function id="qiskit.pulse.Delay.draw" name="draw" signature="Delay.draw(dt=1, style=None, filename=None, interp_method=None, scale=1, channels_to_plot=None, plot_all=False, plot_range=None, interactive=False, table=True, label=False, framechange=True, scaling=None, channels=None)">
  ...
  <Function id="qiskit.pulse.Delay.union" name="union" signature="Delay.union(*schedules, name=None)">
