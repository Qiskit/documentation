...
<Class id="qiskit.aqua.components.qfts.Approximate" github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.7/qiskit/aqua/components/qfts/approximate.py" signature="Approximate(num_qubits, degree=0)">
  The Approximate QFT.
