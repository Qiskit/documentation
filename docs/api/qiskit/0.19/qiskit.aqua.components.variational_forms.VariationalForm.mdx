---
title: VariationalForm (v0.19)
description: API reference for qiskit.aqua.components.variational_forms.VariationalForm in qiskit v0.19
...
<Class id="qiskit.aqua.components.variational_forms.VariationalForm" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.7/qiskit/aqua/components/variational_forms/variational_form.py" signature="VariationalForm" modifiers="class">
  ...
  <span id="variationalform-num-parameters" />
  ...
  <span id="variationalform-num-qubits" />
  ...
  <span id="variationalform-parameter-bounds" />
  ...
  <span id="variationalform-preferred-init-points" />
  ...
  <span id="variationalform-setting" />

  ### setting

  <Attribute id="qiskit.aqua.components.variational_forms.VariationalForm.setting" />

  <span id="variationalform-support-parameterized-circuit" />
  ...
  <span id="variationalform-construct-circuit" />
  ...
  <span id="variationalform-get-entangler-map" />
  ...
  <span id="variationalform-validate-entangler-map" />
