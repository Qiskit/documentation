...
<span id="qiskit.circuit.library.PiecewiseLinearPauliRotations.AND" />

`PiecewiseLinearPauliRotations.AND(qr_variables, qb_target, qr_ancillae, flags=None, mct_mode='no-ancilla')`
...
<span id="qiskit.circuit.library.PiecewiseLinearPauliRotations.OR" />

`PiecewiseLinearPauliRotations.OR(qr_variables, qb_target, qr_ancillae, flags=None, mct_mode='basic')`
...
<span id="qiskit.circuit.library.PiecewiseLinearPauliRotations.__getitem__" />

`PiecewiseLinearPauliRotations.__getitem__(item)`

Return indexed operation.

### \_\_len\_\_

<span id="qiskit.circuit.library.PiecewiseLinearPauliRotations.__len__" />
...
<span id="qiskit.circuit.library.PiecewiseLinearPauliRotations.add_register" />

`PiecewiseLinearPauliRotations.add_register(*regs)`
...
`PiecewiseLinearPauliRotations.append(instruction, qargs=None, cargs=None)`
...
`PiecewiseLinearPauliRotations.assign_parameters(param_dict, inplace=False)`
...
`PiecewiseLinearPauliRotations.barrier(*qargs)`
...
`PiecewiseLinearPauliRotations.bind_parameters(value_dict)`
...
`static PiecewiseLinearPauliRotations.cast(value, _type)`
...
`PiecewiseLinearPauliRotations.cbit_argument_conversion(clbit_representation)`
...
`PiecewiseLinearPauliRotations.ccx(control_qubit1, control_qubit2, target_qubit, *, ctl1=None, ctl2=None, tgt=None)`
...
`PiecewiseLinearPauliRotations.ch(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)`
...
`classmethod PiecewiseLinearPauliRotations.cls_instances()`
...
`classmethod PiecewiseLinearPauliRotations.cls_prefix()`
...
`PiecewiseLinearPauliRotations.cnot(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)`
...
`PiecewiseLinearPauliRotations.compose(other, qubits=None, clbits=None, front=False, inplace=False)`
...
`PiecewiseLinearPauliRotations.copy(name=None)`
...
`PiecewiseLinearPauliRotations.crx(theta, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)`
...
`PiecewiseLinearPauliRotations.cry(theta, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)`
...
`PiecewiseLinearPauliRotations.crz(theta, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)`
...
`PiecewiseLinearPauliRotations.cswap(control_qubit, target_qubit1, target_qubit2, *, label=None, ctrl_state=None, ctl=None, tgt1=None, tgt2=None)`
...
`PiecewiseLinearPauliRotations.cu1(theta, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)`
...
`PiecewiseLinearPauliRotations.cu3(theta, phi, lam, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)`
...
`PiecewiseLinearPauliRotations.cx(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)`
...
`PiecewiseLinearPauliRotations.cz(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)`
...
`PiecewiseLinearPauliRotations.dcx(qubit1, qubit2)`
...
<span id="qiskit.circuit.library.PiecewiseLinearPauliRotations.diag_gate" />

`PiecewiseLinearPauliRotations.diag_gate(diag, qubit)`
...
`PiecewiseLinearPauliRotations.diagonal(diag, qubit)`
...
`PiecewiseLinearPauliRotations.draw(output=None, scale=0.7, filename=None, style=None, interactive=False, line_length=None, plot_barriers=True, reverse_bits=False, justify=None, vertical_compression='medium', idle_wires=True, with_layout=True, fold=None, ax=None, initial_state=False, cregbundle=False)`
...
`PiecewiseLinearPauliRotations.extend(rhs)`
...
`PiecewiseLinearPauliRotations.fredkin(control_qubit, target_qubit1, target_qubit2, *, ctl=None, tgt1=None, tgt2=None)`
...
`static PiecewiseLinearPauliRotations.from_qasm_file(path)`
...
`static PiecewiseLinearPauliRotations.from_qasm_str(qasm_str)`
...
`PiecewiseLinearPauliRotations.h(qubit, *, q=None)`
...
`PiecewiseLinearPauliRotations.hamiltonian(operator, time, qubits, label=None)`
...
`PiecewiseLinearPauliRotations.has_register(register)`
...
`PiecewiseLinearPauliRotations.i(qubit, *, q=None)`
...
<span id="qiskit.circuit.library.PiecewiseLinearPauliRotations.iden" />

`PiecewiseLinearPauliRotations.iden(qubit, *, q=None)`
...
`PiecewiseLinearPauliRotations.initialize(params, qubits)`
...
`PiecewiseLinearPauliRotations.iso(isometry, q_input, q_ancillas_for_output, q_ancillas_zero=None, q_ancillas_dirty=None)`
...
`PiecewiseLinearPauliRotations.isometry(isometry, q_input, q_ancillas_for_output, q_ancillas_zero=None, q_ancillas_dirty=None)`
...
`PiecewiseLinearPauliRotations.iswap(qubit1, qubit2)`

Apply [`iSwapGate`](qiskit.circuit.library.iSwapGate "qiskit.circuit.library.iSwapGate").

### mcmt

<span id="qiskit.circuit.library.PiecewiseLinearPauliRotations.mcmt" />

`PiecewiseLinearPauliRotations.mcmt(gate, control_qubits, target_qubits, ancilla_qubits=None, mode='no-ancilla', *, single_control_gate_fun=None, q_controls=None, q_ancillae=None, q_targets=None)`
...
`PiecewiseLinearPauliRotations.mcrx(theta, q_controls, q_target, use_basis_gates=False)`
...
`PiecewiseLinearPauliRotations.mcry(theta, q_controls, q_target, q_ancillae, mode='basic', use_basis_gates=False)`
...
`PiecewiseLinearPauliRotations.mcrz(lam, q_controls, q_target, use_basis_gates=False)`
...
`PiecewiseLinearPauliRotations.mct(control_qubits, target_qubit, ancilla_qubits=None, mode='noancilla')`
...
`PiecewiseLinearPauliRotations.mcu1(lam, control_qubits, target_qubit)`
...
`PiecewiseLinearPauliRotations.mcx(control_qubits, target_qubit, ancilla_qubits=None, mode='noancilla')`
...
<span id="qiskit.circuit.library.PiecewiseLinearPauliRotations.measure" />

`PiecewiseLinearPauliRotations.measure(qubit, cbit)`
...
`PiecewiseLinearPauliRotations.measure_active(inplace=True)`
...
`PiecewiseLinearPauliRotations.measure_all(inplace=True)`
...
<span id="qiskit.circuit.library.PiecewiseLinearPauliRotations.mirror" />
...
`PiecewiseLinearPauliRotations.ms(theta, qubits)`

Apply [`MSGate`](qiskit.circuit.library.MSGate "qiskit.circuit.library.MSGate").

### num\_connected\_components

<span id="qiskit.circuit.library.PiecewiseLinearPauliRotations.num_connected_components" />

`PiecewiseLinearPauliRotations.num_connected_components(unitary_only=False)`
...
<span id="qiskit.circuit.library.PiecewiseLinearPauliRotations.num_nonlocal_gates" />
...
<span id="qiskit.circuit.library.PiecewiseLinearPauliRotations.num_tensor_factors" />
...
<span id="qiskit.circuit.library.PiecewiseLinearPauliRotations.num_unitary_factors" />
...
<span id="qiskit.circuit.library.PiecewiseLinearPauliRotations.qasm" />

`PiecewiseLinearPauliRotations.qasm(formatted=False, filename=None)`
...
<span id="qiskit.circuit.library.PiecewiseLinearPauliRotations.qbit_argument_conversion" />

`PiecewiseLinearPauliRotations.qbit_argument_conversion(qubit_representation)`
...
<span id="qiskit.circuit.library.PiecewiseLinearPauliRotations.r" />

`PiecewiseLinearPauliRotations.r(theta, phi, qubit, *, q=None)`

Apply `RGate`.

### rcccx

<span id="qiskit.circuit.library.PiecewiseLinearPauliRotations.rcccx" />

`PiecewiseLinearPauliRotations.rcccx(control_qubit1, control_qubit2, control_qubit3, target_qubit)`

Apply [`RC3XGate`](qiskit.circuit.library.RC3XGate "qiskit.circuit.library.RC3XGate").

### rccx

<span id="qiskit.circuit.library.PiecewiseLinearPauliRotations.rccx" />

`PiecewiseLinearPauliRotations.rccx(control_qubit1, control_qubit2, target_qubit)`

Apply [`RCCXGate`](qiskit.circuit.library.RCCXGate "qiskit.circuit.library.RCCXGate").

### remove\_final\_measurements

<span id="qiskit.circuit.library.PiecewiseLinearPauliRotations.remove_final_measurements" />

`PiecewiseLinearPauliRotations.remove_final_measurements(inplace=True)`
...
<span id="qiskit.circuit.library.PiecewiseLinearPauliRotations.rx" />

`PiecewiseLinearPauliRotations.rx(theta, qubit, *, label=None, q=None)`

Apply [`RXGate`](qiskit.circuit.library.RXGate "qiskit.circuit.library.RXGate").

### rxx

<span id="qiskit.circuit.library.PiecewiseLinearPauliRotations.rxx" />

`PiecewiseLinearPauliRotations.rxx(theta, qubit1, qubit2)`

Apply [`RXXGate`](qiskit.circuit.library.RXXGate "qiskit.circuit.library.RXXGate").

### ry

<span id="qiskit.circuit.library.PiecewiseLinearPauliRotations.ry" />

`PiecewiseLinearPauliRotations.ry(theta, qubit, *, label=None, q=None)`

Apply [`RYGate`](qiskit.circuit.library.RYGate "qiskit.circuit.library.RYGate").

### ryy

<span id="qiskit.circuit.library.PiecewiseLinearPauliRotations.ryy" />

`PiecewiseLinearPauliRotations.ryy(theta, qubit1, qubit2)`
...
<span id="qiskit.circuit.library.PiecewiseLinearPauliRotations.rzx" />

`PiecewiseLinearPauliRotations.rzx(theta, qubit1, qubit2)`

Apply [`RZXGate`](qiskit.circuit.library.RZXGate "qiskit.circuit.library.RZXGate").

### rzz

<span id="qiskit.circuit.library.PiecewiseLinearPauliRotations.rzz" />

`PiecewiseLinearPauliRotations.rzz(theta, qubit1, qubit2)`

Apply [`RZZGate`](qiskit.circuit.library.RZZGate "qiskit.circuit.library.RZZGate").

### s

<span id="qiskit.circuit.library.PiecewiseLinearPauliRotations.s" />

`PiecewiseLinearPauliRotations.s(qubit, *, q=None)`

Apply [`SGate`](qiskit.circuit.library.SGate "qiskit.circuit.library.SGate").

### sdg

<span id="qiskit.circuit.library.PiecewiseLinearPauliRotations.sdg" />

`PiecewiseLinearPauliRotations.sdg(qubit, *, q=None)`

Apply [`SdgGate`](qiskit.circuit.library.SdgGate "qiskit.circuit.library.SdgGate").

### size

<span id="qiskit.circuit.library.PiecewiseLinearPauliRotations.size" />
...
<span id="qiskit.circuit.library.PiecewiseLinearPauliRotations.snapshot" />

`PiecewiseLinearPauliRotations.snapshot(label, snapshot_type='statevector', qubits=None, params=None)`
...
<span id="qiskit.circuit.library.PiecewiseLinearPauliRotations.snapshot_density_matrix" />

`PiecewiseLinearPauliRotations.snapshot_density_matrix(label, qubits=None)`
...
<span id="qiskit.circuit.library.PiecewiseLinearPauliRotations.snapshot_expectation_value" />

`PiecewiseLinearPauliRotations.snapshot_expectation_value(label, op, qubits, single_shot=False, variance=False)`
...
<span id="qiskit.circuit.library.PiecewiseLinearPauliRotations.snapshot_probabilities" />

`PiecewiseLinearPauliRotations.snapshot_probabilities(label, qubits, variance=False)`
...
<span id="qiskit.circuit.library.PiecewiseLinearPauliRotations.snapshot_stabilizer" />

`PiecewiseLinearPauliRotations.snapshot_stabilizer(label)`
...
<span id="qiskit.circuit.library.PiecewiseLinearPauliRotations.snapshot_statevector" />

`PiecewiseLinearPauliRotations.snapshot_statevector(label)`
...
<span id="qiskit.circuit.library.PiecewiseLinearPauliRotations.squ" />

`PiecewiseLinearPauliRotations.squ(unitary_matrix, qubit, mode='ZYZ', up_to_diagonal=False, *, u=None)`
...
<span id="qiskit.circuit.library.PiecewiseLinearPauliRotations.swap" />

`PiecewiseLinearPauliRotations.swap(qubit1, qubit2)`

Apply [`SwapGate`](qiskit.circuit.library.SwapGate "qiskit.circuit.library.SwapGate").

### t

<span id="qiskit.circuit.library.PiecewiseLinearPauliRotations.t" />

`PiecewiseLinearPauliRotations.t(qubit, *, q=None)`

Apply [`TGate`](qiskit.circuit.library.TGate "qiskit.circuit.library.TGate").

### tdg

<span id="qiskit.circuit.library.PiecewiseLinearPauliRotations.tdg" />

`PiecewiseLinearPauliRotations.tdg(qubit, *, q=None)`

Apply [`TdgGate`](qiskit.circuit.library.TdgGate "qiskit.circuit.library.TdgGate").

### to\_gate

<span id="qiskit.circuit.library.PiecewiseLinearPauliRotations.to_gate" />

`PiecewiseLinearPauliRotations.to_gate(parameter_map=None)`
...
<span id="qiskit.circuit.library.PiecewiseLinearPauliRotations.to_instruction" />

`PiecewiseLinearPauliRotations.to_instruction(parameter_map=None)`
...
<span id="qiskit.circuit.library.PiecewiseLinearPauliRotations.toffoli" />

`PiecewiseLinearPauliRotations.toffoli(control_qubit1, control_qubit2, target_qubit, *, ctl1=None, ctl2=None, tgt=None)`

Apply [`CCXGate`](qiskit.circuit.library.CCXGate "qiskit.circuit.library.CCXGate").

### u1

<span id="qiskit.circuit.library.PiecewiseLinearPauliRotations.u1" />

`PiecewiseLinearPauliRotations.u1(theta, qubit, *, q=None)`

Apply [`U1Gate`](qiskit.circuit.library.U1Gate "qiskit.circuit.library.U1Gate").

### u2

<span id="qiskit.circuit.library.PiecewiseLinearPauliRotations.u2" />

`PiecewiseLinearPauliRotations.u2(phi, lam, qubit, *, q=None)`

Apply [`U2Gate`](qiskit.circuit.library.U2Gate "qiskit.circuit.library.U2Gate").

### u3

<span id="qiskit.circuit.library.PiecewiseLinearPauliRotations.u3" />

`PiecewiseLinearPauliRotations.u3(theta, phi, lam, qubit, *, q=None)`

Apply [`U3Gate`](qiskit.circuit.library.U3Gate "qiskit.circuit.library.U3Gate").

### uc

<span id="qiskit.circuit.library.PiecewiseLinearPauliRotations.uc" />

`PiecewiseLinearPauliRotations.uc(gate_list, q_controls, q_target, up_to_diagonal=False)`
...
<span id="qiskit.circuit.library.PiecewiseLinearPauliRotations.ucg" />

`PiecewiseLinearPauliRotations.ucg(angle_list, q_controls, q_target, up_to_diagonal=False)`

Deprecated version of uc.

### ucrx

<span id="qiskit.circuit.library.PiecewiseLinearPauliRotations.ucrx" />

`PiecewiseLinearPauliRotations.ucrx(angle_list, q_controls, q_target)`
...
<span id="qiskit.circuit.library.PiecewiseLinearPauliRotations.ucry" />

`PiecewiseLinearPauliRotations.ucry(angle_list, q_controls, q_target)`
...
<span id="qiskit.circuit.library.PiecewiseLinearPauliRotations.ucrz" />

`PiecewiseLinearPauliRotations.ucrz(angle_list, q_controls, q_target)`
...
<span id="qiskit.circuit.library.PiecewiseLinearPauliRotations.ucx" />

`PiecewiseLinearPauliRotations.ucx(angle_list, q_controls, q_target)`

Deprecated version of ucrx.

### ucy

<span id="qiskit.circuit.library.PiecewiseLinearPauliRotations.ucy" />

`PiecewiseLinearPauliRotations.ucy(angle_list, q_controls, q_target)`

Deprecated version of ucry.

### ucz

<span id="qiskit.circuit.library.PiecewiseLinearPauliRotations.ucz" />

`PiecewiseLinearPauliRotations.ucz(angle_list, q_controls, q_target)`

Deprecated version of ucrz.

### unitary

<span id="qiskit.circuit.library.PiecewiseLinearPauliRotations.unitary" />

`PiecewiseLinearPauliRotations.unitary(obj, qubits, label=None)`

Apply unitary gate to q.

### width

<span id="qiskit.circuit.library.PiecewiseLinearPauliRotations.width" />
...
<span id="qiskit.circuit.library.PiecewiseLinearPauliRotations.x" />

`PiecewiseLinearPauliRotations.x(qubit, *, label=None, ctrl_state=None, q=None)`

Apply [`XGate`](qiskit.circuit.library.XGate "qiskit.circuit.library.XGate").

### y

<span id="qiskit.circuit.library.PiecewiseLinearPauliRotations.y" />

`PiecewiseLinearPauliRotations.y(qubit, *, q=None)`

Apply [`YGate`](qiskit.circuit.library.YGate "qiskit.circuit.library.YGate").

### z

<span id="qiskit.circuit.library.PiecewiseLinearPauliRotations.z" />

`PiecewiseLinearPauliRotations.z(qubit, *, q=None)`
