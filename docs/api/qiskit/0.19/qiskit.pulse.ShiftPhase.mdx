...
<Class id="qiskit.pulse.ShiftPhase" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.14/qiskit/pulse/instructions/phase.py" signature="ShiftPhase(phase, channel=None, name=None)">
...
$$
  ...
  *   **name** (`Optional`\[`str`]) – Display name for this instruction.
  ...
  <Attribute id="qiskit.pulse.ShiftPhase.channel" name="channel" signature="qiskit.pulse.channels.PulseChannel">
  ...
  <Attribute id="qiskit.pulse.ShiftPhase.channels" name="channels" signature="Tuple[qiskit.pulse.channels.Channel]">
  ...
  <Attribute id="qiskit.pulse.ShiftPhase.command" name="command" signature="qiskit.pulse.commands.command.Command">
  ...
  <Attribute id="qiskit.pulse.ShiftPhase.duration" name="duration" signature="int">
  ...
  <Attribute id="qiskit.pulse.ShiftPhase.id" name="id" signature="int">
  ...
  <Attribute id="qiskit.pulse.ShiftPhase.instructions" name="instructions" signature="Tuple[Tuple[int, qiskit.pulse.instructions.instruction.Instruction]]">
  ...
  <Attribute id="qiskit.pulse.ShiftPhase.name" name="name" signature="str">
  ...
  <Attribute id="qiskit.pulse.ShiftPhase.operands" name="operands" signature="Tuple">
  ...
  <Attribute id="qiskit.pulse.ShiftPhase.phase" name="phase" signature="float">
  ...
  <Attribute id="qiskit.pulse.ShiftPhase.start_time" name="start_time" signature="int">
  ...
  <Attribute id="qiskit.pulse.ShiftPhase.stop_time" name="stop_time" signature="int">
  ...
  <Attribute id="qiskit.pulse.ShiftPhase.timeslots" name="timeslots" signature="Dict[qiskit.pulse.channels.Channel, List[Tuple[int, int]]]">
  ...
  <Function id="qiskit.pulse.ShiftPhase.__call__" name="__call__" signature="ShiftPhase.__call__(channel)">
  ...
  <Function id="qiskit.pulse.ShiftPhase.append" name="append" signature="ShiftPhase.append(schedule, name=None)">
  ...
  <Function id="qiskit.pulse.ShiftPhase.ch_duration" name="ch_duration" signature="ShiftPhase.ch_duration(*channels)">
  ...
  <Function id="qiskit.pulse.ShiftPhase.ch_start_time" name="ch_start_time" signature="ShiftPhase.ch_start_time(*channels)">
  ...
  <Function id="qiskit.pulse.ShiftPhase.ch_stop_time" name="ch_stop_time" signature="ShiftPhase.ch_stop_time(*channels)">
  ...
  <Function id="qiskit.pulse.ShiftPhase.draw" name="draw" signature="ShiftPhase.draw(dt=1, style=None, filename=None, interp_method=None, scale=1, channels_to_plot=None, plot_all=False, plot_range=None, interactive=False, table=True, label=False, framechange=True, scaling=None, channels=None)">
  ...
  <Function id="qiskit.pulse.ShiftPhase.flatten" name="flatten" signature="ShiftPhase.flatten()">
  ...
  <Function id="qiskit.pulse.ShiftPhase.insert" name="insert" signature="ShiftPhase.insert(start_time, schedule, name=None)">
  ...
  <Function id="qiskit.pulse.ShiftPhase.shift" name="shift" signature="ShiftPhase.shift(time, name=None)">
  ...
  <Function id="qiskit.pulse.ShiftPhase.union" name="union" signature="ShiftPhase.union(*schedules, name=None)">
