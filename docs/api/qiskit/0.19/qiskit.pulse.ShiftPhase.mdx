...
$$
  ...
  *   **name** (`Optional`\[`str`]) – Display name for this instruction.
  ...
  <Attribute id="qiskit.pulse.ShiftPhase.channel" signature="qiskit.pulse.channels.PulseChannel">
  ...
  <Attribute id="qiskit.pulse.ShiftPhase.channels" signature="Tuple[qiskit.pulse.channels.Channel]">
  ...
  <Attribute id="qiskit.pulse.ShiftPhase.command" signature="qiskit.pulse.commands.command.Command">
  ...
  <Attribute id="qiskit.pulse.ShiftPhase.duration" signature="int">
  ...
  <Attribute id="qiskit.pulse.ShiftPhase.id" signature="int">
  ...
  <Attribute id="qiskit.pulse.ShiftPhase.instructions" signature="Tuple[Tuple[int, qiskit.pulse.instructions.instruction.Instruction]]">
  ...
  <Attribute id="qiskit.pulse.ShiftPhase.name" signature="str">
  ...
  <Attribute id="qiskit.pulse.ShiftPhase.operands" signature="Tuple">
  ...
  <Attribute id="qiskit.pulse.ShiftPhase.phase" signature="float">
  ...
  <Attribute id="qiskit.pulse.ShiftPhase.start_time" signature="int">
  ...
  <Attribute id="qiskit.pulse.ShiftPhase.stop_time" signature="int">
  ...
  <Attribute id="qiskit.pulse.ShiftPhase.timeslots" signature="Dict[qiskit.pulse.channels.Channel, List[Tuple[int, int]]]">
