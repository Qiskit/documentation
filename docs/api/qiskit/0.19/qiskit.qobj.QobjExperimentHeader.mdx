...
<Class id="qiskit.qobj.QobjExperimentHeader" github="https://github.com/qiskit/qiskit/tree/stable/0.14/qiskit/qobj/qasm_qobj.py" signature="QobjExperimentHeader(**kwargs)">
