---
title: QobjExperimentHeader (v0.19)
description: API reference for qiskit.qobj.QobjExperimentHeader in qiskit v0.19
...
<Class id="qiskit.qobj.QobjExperimentHeader" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.14/qiskit/qobj/qasm_qobj.py" signature="QobjExperimentHeader(**kwargs)" modifiers="class">
  ...
  **kwargs** – arbitrary keyword arguments that can be accessed as attributes of the object.
  ...
  <span id="qobjexperimentheader-from-dict" />
  ...
  <span id="qobjexperimentheader-to-dict" />
