...
`IQFT.construct_circuit(mode='circuit', qubits=None, circuit=None, do_swaps=True)` [GitHub](https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.7/qiskit/aqua/components/iqfts/iqft.py "view source code")
