...
$$
  ...
  *   **name** (`Optional`\[`str`]) – Display name for this pulse envelope.
  ...
  <Attribute id="qiskit.pulse.pulse_lib.Constant.amp" signature="complex">
  ...
  <Attribute id="qiskit.pulse.pulse_lib.Constant.id" signature="int">
  ...
  <Attribute id="qiskit.pulse.pulse_lib.Constant.parameters" signature="Dict[str, Any]">
