...
<Class id="qiskit.optimization.algorithms.CplexOptimizer" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.7/qiskit/optimization/algorithms/cplex_optimizer.py" signature="CplexOptimizer(disp=False)">
  ...
  **NameError** – CPLEX is not installed.
  ...
  <Attribute id="qiskit.optimization.algorithms.CplexOptimizer.disp" name="disp" signature="bool">
  ...
  <Function id="qiskit.optimization.algorithms.CplexOptimizer.get_compatibility_msg" name="get_compatibility_msg" signature="CplexOptimizer.get_compatibility_msg(problem)">
  ...
  <Function id="qiskit.optimization.algorithms.CplexOptimizer.is_compatible" name="is_compatible" signature="CplexOptimizer.is_compatible(problem)">
  ...
  <Function id="qiskit.optimization.algorithms.CplexOptimizer.is_cplex_installed" name="is_cplex_installed" signature="static CplexOptimizer.is_cplex_installed()">
    Returns True if cplex is installed
  </Function>

  ### solve

  <Function id="qiskit.optimization.algorithms.CplexOptimizer.solve" name="solve" signature="CplexOptimizer.solve(problem)">
