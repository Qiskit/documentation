---
title: CplexOptimizer (v0.19)
description: API reference for qiskit.optimization.algorithms.CplexOptimizer in qiskit v0.19
...
<Class id="qiskit.optimization.algorithms.CplexOptimizer" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.7/qiskit/optimization/algorithms/cplex_optimizer.py" signature="CplexOptimizer(disp=False)" modifiers="class">
  ...
  **NameError** – CPLEX is not installed.
  ...
  <span id="cplexoptimizer-disp" />

  ### disp

  <Attribute id="qiskit.optimization.algorithms.CplexOptimizer.disp" attributeTypeHint="bool">
  ...
  <span id="cplexoptimizer-get-compatibility-msg" />
  ...
  <span id="cplexoptimizer-is-compatible" />
  ...
  <span id="cplexoptimizer-is-cplex-installed" />
