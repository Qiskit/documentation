---
title: snapshot
description: API reference for qiskit.circuit.library.XOR.snapshot
in_page_toc_min_heading_level: 1
python_api_type: method
python_api_name: qiskit.circuit.library.XOR.snapshot
---
...
`XOR.snapshot(label, snapshot_type='statevector', qubits=None, params=None)`
