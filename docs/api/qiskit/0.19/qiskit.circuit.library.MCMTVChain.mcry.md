---
title: mcry
description: API reference for qiskit.circuit.library.MCMTVChain.mcry
in_page_toc_min_heading_level: 1
python_api_type: method
python_api_name: qiskit.circuit.library.MCMTVChain.mcry
---
...
`MCMTVChain.mcry(theta, q_controls, q_target, q_ancillae, mode='basic', use_basis_gates=False)`
