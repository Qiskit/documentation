---
title: mcrz
description: API reference for qiskit.circuit.library.XOR.mcrz
in_page_toc_min_heading_level: 1
python_api_type: method
python_api_name: qiskit.circuit.library.XOR.mcrz
---
...
`XOR.mcrz(lam, q_controls, q_target, use_basis_gates=False)`
