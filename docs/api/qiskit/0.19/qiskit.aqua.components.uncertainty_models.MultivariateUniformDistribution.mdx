...
`MultivariateUniformDistribution(num_qubits, low=None, high=None)` [GitHub](https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.7/qiskit/aqua/components/uncertainty_models/multivariate_uniform_distribution.py "view source code")
