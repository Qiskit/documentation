---
title: WeightedPauliOperator (v0.19)
description: API reference for qiskit.aqua.operators.legacy.WeightedPauliOperator in qiskit v0.19
...
<Class id="qiskit.aqua.operators.legacy.WeightedPauliOperator" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.7/qiskit/aqua/operators/legacy/weighted_pauli_operator.py" signature="WeightedPauliOperator(paulis, basis=None, z2_symmetries=None, atol=1e-12, name=None)" modifiers="class">
  ...
  *   **name** (*str, optional*) – the name of operator.
  ...
  <span id="weightedpaulioperator-atol" />
  ...
  <span id="weightedpaulioperator-basis" />
  ...
  <span id="weightedpaulioperator-name" />
  ...
  <span id="weightedpaulioperator-num-qubits" />
  ...
  <span id="weightedpaulioperator-paulis" />
  ...
  <span id="weightedpaulioperator-z2-symmetries" />
  ...
  <span id="weightedpaulioperator-mul" />

  ### \_\_mul\_\_

  <Function id="qiskit.aqua.operators.legacy.WeightedPauliOperator.__mul__" signature="WeightedPauliOperator.__mul__(other)">
    Overload self \* other
  </Function>

  <span id="weightedpaulioperator-add" />
  ...
  <span id="weightedpaulioperator-anticommute-with" />
  ...
  <span id="weightedpaulioperator-chop" />
  ...
  <span id="weightedpaulioperator-commute-with" />
  ...
  <span id="weightedpaulioperator-construct-evaluation-circuit" />
  ...
  <span id="weightedpaulioperator-copy" />
  ...
  <span id="weightedpaulioperator-evaluate-with-result" />
  ...
  <span id="weightedpaulioperator-evaluate-with-statevector" />
  ...
  <span id="weightedpaulioperator-evaluation-instruction" />
  ...
  <span id="weightedpaulioperator-evolve" />
  ...
  <span id="weightedpaulioperator-evolve-instruction" />
  ...
  <span id="weightedpaulioperator-from-dict" />
  ...
  <span id="weightedpaulioperator-from-file" />
  ...
  <span id="weightedpaulioperator-from-list" />
  ...
  <span id="weightedpaulioperator-is-empty" />
  ...
  <span id="weightedpaulioperator-multiply" />
  ...
  <span id="weightedpaulioperator-print-details" />
  ...
  <span id="weightedpaulioperator-reorder-paulis" />
  ...
  <span id="weightedpaulioperator-rounding" />
  ...
  <span id="weightedpaulioperator-simplify" />
  ...
  <span id="weightedpaulioperator-sub" />
  ...
  <span id="weightedpaulioperator-to-dict" />
  ...
  <span id="weightedpaulioperator-to-file" />
  ...
  <span id="weightedpaulioperator-to-opflow" />
