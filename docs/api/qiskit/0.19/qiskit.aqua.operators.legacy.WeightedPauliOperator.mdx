...
<Class id="qiskit.aqua.operators.legacy.WeightedPauliOperator" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.7/qiskit/aqua/operators/legacy/weighted_pauli_operator.py" signature="WeightedPauliOperator(paulis, basis=None, z2_symmetries=None, atol=1e-12, name=None)">
  ...
  *   **name** (*str, optional*) – the name of operator.
  ...
  <Attribute id="qiskit.aqua.operators.legacy.WeightedPauliOperator.atol" name="atol">
    get atol
  </Attribute>

  ### basis

  <Attribute id="qiskit.aqua.operators.legacy.WeightedPauliOperator.basis" name="basis">
    returns basis
  </Attribute>

  ### name

  <Attribute id="qiskit.aqua.operators.legacy.WeightedPauliOperator.name" name="name">
    returns name
  </Attribute>

  ### num\_qubits

  <Attribute id="qiskit.aqua.operators.legacy.WeightedPauliOperator.num_qubits" name="num_qubits">
  ...
  <Attribute id="qiskit.aqua.operators.legacy.WeightedPauliOperator.paulis" name="paulis">
    get paulis
  </Attribute>

  ### z2\_symmetries

  <Attribute id="qiskit.aqua.operators.legacy.WeightedPauliOperator.z2_symmetries" name="z2_symmetries">
  ...
  <Function id="qiskit.aqua.operators.legacy.WeightedPauliOperator.__mul__" name="__mul__" signature="WeightedPauliOperator.__mul__(other)">
    Overload self \* other
  </Function>

  ### add

  <Function id="qiskit.aqua.operators.legacy.WeightedPauliOperator.add" name="add" signature="WeightedPauliOperator.add(other, copy=False)">
    Perform self + other.
  ...
  <Function id="qiskit.aqua.operators.legacy.WeightedPauliOperator.anticommute_with" name="anticommute_with" signature="WeightedPauliOperator.anticommute_with(other)">
    Anti commutes with
  </Function>

  ### chop

  <Function id="qiskit.aqua.operators.legacy.WeightedPauliOperator.chop" name="chop" signature="WeightedPauliOperator.chop(threshold=None, copy=False)">
  ...
  <Function id="qiskit.aqua.operators.legacy.WeightedPauliOperator.commute_with" name="commute_with" signature="WeightedPauliOperator.commute_with(other)">
    Commutes with
  </Function>

  ### construct\_evaluation\_circuit

  <Function id="qiskit.aqua.operators.legacy.WeightedPauliOperator.construct_evaluation_circuit" name="construct_evaluation_circuit" signature="WeightedPauliOperator.construct_evaluation_circuit(wave_function, statevector_mode, qr=None, cr=None, use_simulator_snapshot_mode=False, circuit_name_prefix='')">
  ...
  <Function id="qiskit.aqua.operators.legacy.WeightedPauliOperator.copy" name="copy" signature="WeightedPauliOperator.copy()">
    Get a copy of self
  </Function>

  ### evaluate\_with\_result

  <Function id="qiskit.aqua.operators.legacy.WeightedPauliOperator.evaluate_with_result" name="evaluate_with_result" signature="WeightedPauliOperator.evaluate_with_result(result, statevector_mode, use_simulator_snapshot_mode=False, circuit_name_prefix='')">
  ...
  <Function id="qiskit.aqua.operators.legacy.WeightedPauliOperator.evaluate_with_statevector" name="evaluate_with_statevector" signature="WeightedPauliOperator.evaluate_with_statevector(quantum_state)">
    **Parameters**
  ...
  <Function id="qiskit.aqua.operators.legacy.WeightedPauliOperator.evaluation_instruction" name="evaluation_instruction" signature="WeightedPauliOperator.evaluation_instruction(statevector_mode, use_simulator_snapshot_mode=False)">
    **Parameters**
  ...
  <Function id="qiskit.aqua.operators.legacy.WeightedPauliOperator.evolve" name="evolve" signature="WeightedPauliOperator.evolve(state_in=None, evo_time=0, num_time_slices=1, quantum_registers=None, expansion_mode='trotter', expansion_order=1)">
  ...
  <Function id="qiskit.aqua.operators.legacy.WeightedPauliOperator.evolve_instruction" name="evolve_instruction" signature="WeightedPauliOperator.evolve_instruction(evo_time=0, num_time_slices=1, expansion_mode='trotter', expansion_order=1)">
    Carry out the eoh evolution for the operator under supplied specifications.
  ...
  <Function id="qiskit.aqua.operators.legacy.WeightedPauliOperator.from_dict" name="from_dict" signature="classmethod WeightedPauliOperator.from_dict(dictionary, before_04=False)">
  ...
  <Function id="qiskit.aqua.operators.legacy.WeightedPauliOperator.from_file" name="from_file" signature="classmethod WeightedPauliOperator.from_file(file_name, before_04=False)">
  ...
  <Function id="qiskit.aqua.operators.legacy.WeightedPauliOperator.from_list" name="from_list" signature="classmethod WeightedPauliOperator.from_list(paulis, weights=None, name=None)">
  ...
  <Function id="qiskit.aqua.operators.legacy.WeightedPauliOperator.is_empty" name="is_empty" signature="WeightedPauliOperator.is_empty()">
  ...
  <Function id="qiskit.aqua.operators.legacy.WeightedPauliOperator.multiply" name="multiply" signature="WeightedPauliOperator.multiply(other)">
  ...
  <Function id="qiskit.aqua.operators.legacy.WeightedPauliOperator.print_details" name="print_details" signature="WeightedPauliOperator.print_details()">
  ...
  <Function id="qiskit.aqua.operators.legacy.WeightedPauliOperator.reorder_paulis" name="reorder_paulis" signature="WeightedPauliOperator.reorder_paulis()">
  ...
  <Function id="qiskit.aqua.operators.legacy.WeightedPauliOperator.rounding" name="rounding" signature="WeightedPauliOperator.rounding(decimals, copy=False)">
    Rounding the weight.
  ...
  <Function id="qiskit.aqua.operators.legacy.WeightedPauliOperator.simplify" name="simplify" signature="WeightedPauliOperator.simplify(copy=False)">
  ...
  <Function id="qiskit.aqua.operators.legacy.WeightedPauliOperator.sub" name="sub" signature="WeightedPauliOperator.sub(other, copy=False)">
    Perform self - other.
  ...
  <Function id="qiskit.aqua.operators.legacy.WeightedPauliOperator.to_dict" name="to_dict" signature="WeightedPauliOperator.to_dict()">
  ...
  <Function id="qiskit.aqua.operators.legacy.WeightedPauliOperator.to_file" name="to_file" signature="WeightedPauliOperator.to_file(file_name)">
  ...
  <Function id="qiskit.aqua.operators.legacy.WeightedPauliOperator.to_opflow" name="to_opflow" signature="WeightedPauliOperator.to_opflow(reverse_endianness=False)">
    to op flow
  </Function>
</Class>
