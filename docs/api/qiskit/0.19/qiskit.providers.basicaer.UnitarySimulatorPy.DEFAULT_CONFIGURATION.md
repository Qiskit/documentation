...
description: API reference for qiskit.providers.basicaer.UnitarySimulatorPy.DEFAULT_CONFIGURATION
in_page_toc_min_heading_level: 1
python_api_type: attribute
python_api_name: qiskit.providers.basicaer.UnitarySimulatorPy.DEFAULT_CONFIGURATION
---
