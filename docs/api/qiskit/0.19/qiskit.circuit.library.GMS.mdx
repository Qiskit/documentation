...
<Class id="qiskit.circuit.library.GMS" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.14/qiskit/circuit/library/generalized_gates/gms.py" signature="GMS(num_qubits, theta)">
...
$$
  ...
  *   **theta** (`Union`\[`List`\[`List`\[`float`]], `ndarray`]) – a num\_qubits x num\_qubits symmetric matrix of interaction angles for each qubit pair. The upper triangle is considered.
  ...
  <Attribute id="qiskit.circuit.library.GMS.extension_lib" signature="= 'include \&#x22;qelib1.inc\&#x22;;'" />

  ### header

  <Attribute id="qiskit.circuit.library.GMS.header" signature="= 'OPENQASM 2.0;'" />

  ### instances

  <Attribute id="qiskit.circuit.library.GMS.instances" signature="= 8" />

  ### n\_qubits

  <Attribute id="qiskit.circuit.library.GMS.n_qubits" name="n_qubits">
  ...
  <Attribute id="qiskit.circuit.library.GMS.prefix" signature="= 'circuit'" />
  ...
  <Function id="qiskit.circuit.library.GMS.AND" name="AND" signature="GMS.AND(qr_variables, qb_target, qr_ancillae, flags=None, mct_mode='no-ancilla')">
  ...
  <Function id="qiskit.circuit.library.GMS.OR" name="OR" signature="GMS.OR(qr_variables, qb_target, qr_ancillae, flags=None, mct_mode='basic')">
  ...
  <Function id="qiskit.circuit.library.GMS.__getitem__" name="__getitem__" signature="GMS.__getitem__(item)">
    Return indexed operation.
  </Function>

  ### \_\_len\_\_

  <Function id="qiskit.circuit.library.GMS.__len__" name="__len__" signature="GMS.__len__()">
    Return number of operations in circuit.
  </Function>

  ### add\_register

  <Function id="qiskit.circuit.library.GMS.add_register" name="add_register" signature="GMS.add_register(*regs)">
    Add registers.
  </Function>

  ### append

  <Function id="qiskit.circuit.library.GMS.append" name="append" signature="GMS.append(instruction, qargs=None, cargs=None)">
  ...
  <Function id="qiskit.circuit.library.GMS.assign_parameters" name="assign_parameters" signature="GMS.assign_parameters(param_dict, inplace=False)">
  ...
  <Function id="qiskit.circuit.library.GMS.barrier" name="barrier" signature="GMS.barrier(*qargs)">
    Apply `Barrier`. If qargs is None, applies to all.
  </Function>

  ### bind\_parameters

  <Function id="qiskit.circuit.library.GMS.bind_parameters" name="bind_parameters" signature="GMS.bind_parameters(value_dict)">
  ...
  <Function id="qiskit.circuit.library.GMS.cast" name="cast" signature="static GMS.cast(value, _type)">
    Best effort to cast value to type. Otherwise, returns the value.
  </Function>

  ### cbit\_argument\_conversion

  <Function id="qiskit.circuit.library.GMS.cbit_argument_conversion" name="cbit_argument_conversion" signature="GMS.cbit_argument_conversion(clbit_representation)">
  ...
  <Function id="qiskit.circuit.library.GMS.ccx" name="ccx" signature="GMS.ccx(control_qubit1, control_qubit2, target_qubit, *, ctl1=None, ctl2=None, tgt=None)">
    Apply [`CCXGate`](qiskit.circuit.library.CCXGate "qiskit.circuit.library.CCXGate").
  </Function>

  ### ch

  <Function id="qiskit.circuit.library.GMS.ch" name="ch" signature="GMS.ch(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CHGate`](qiskit.circuit.library.CHGate "qiskit.circuit.library.CHGate").
  </Function>

  ### cls\_instances

  <Function id="qiskit.circuit.library.GMS.cls_instances" name="cls_instances" signature="classmethod GMS.cls_instances()">
    Return the current number of instances of this class, useful for auto naming.
  </Function>

  ### cls\_prefix

  <Function id="qiskit.circuit.library.GMS.cls_prefix" name="cls_prefix" signature="classmethod GMS.cls_prefix()">
    Return the prefix to use for auto naming.
  </Function>

  ### cnot

  <Function id="qiskit.circuit.library.GMS.cnot" name="cnot" signature="GMS.cnot(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CXGate`](qiskit.circuit.library.CXGate "qiskit.circuit.library.CXGate").
  </Function>

  ### combine

  <Function id="qiskit.circuit.library.GMS.combine" name="combine" signature="GMS.combine(rhs)">
  ...
  <Function id="qiskit.circuit.library.GMS.compose" name="compose" signature="GMS.compose(other, qubits=None, clbits=None, front=False, inplace=False)">
  ...
  <Function id="qiskit.circuit.library.GMS.copy" name="copy" signature="GMS.copy(name=None)">
    Copy the circuit.
  ...
  <Function id="qiskit.circuit.library.GMS.count_ops" name="count_ops" signature="GMS.count_ops()">
  ...
  <Function id="qiskit.circuit.library.GMS.crx" name="crx" signature="GMS.crx(theta, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CRXGate`](qiskit.circuit.library.CRXGate "qiskit.circuit.library.CRXGate").
  </Function>

  ### cry

  <Function id="qiskit.circuit.library.GMS.cry" name="cry" signature="GMS.cry(theta, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CRYGate`](qiskit.circuit.library.CRYGate "qiskit.circuit.library.CRYGate").
  </Function>

  ### crz

  <Function id="qiskit.circuit.library.GMS.crz" name="crz" signature="GMS.crz(theta, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CRZGate`](qiskit.circuit.library.CRZGate "qiskit.circuit.library.CRZGate").
  </Function>

  ### cswap

  <Function id="qiskit.circuit.library.GMS.cswap" name="cswap" signature="GMS.cswap(control_qubit, target_qubit1, target_qubit2, *, label=None, ctrl_state=None, ctl=None, tgt1=None, tgt2=None)">
    Apply [`CSwapGate`](qiskit.circuit.library.CSwapGate "qiskit.circuit.library.CSwapGate").
  </Function>

  ### cu1

  <Function id="qiskit.circuit.library.GMS.cu1" name="cu1" signature="GMS.cu1(theta, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CU1Gate`](qiskit.circuit.library.CU1Gate "qiskit.circuit.library.CU1Gate").
  </Function>

  ### cu3

  <Function id="qiskit.circuit.library.GMS.cu3" name="cu3" signature="GMS.cu3(theta, phi, lam, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CU3Gate`](qiskit.circuit.library.CU3Gate "qiskit.circuit.library.CU3Gate").
  </Function>

  ### cx

  <Function id="qiskit.circuit.library.GMS.cx" name="cx" signature="GMS.cx(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CXGate`](qiskit.circuit.library.CXGate "qiskit.circuit.library.CXGate").
  </Function>

  ### cy

  <Function id="qiskit.circuit.library.GMS.cy" name="cy" signature="GMS.cy(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CYGate`](qiskit.circuit.library.CYGate "qiskit.circuit.library.CYGate").
  </Function>

  ### cz

  <Function id="qiskit.circuit.library.GMS.cz" name="cz" signature="GMS.cz(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CZGate`](qiskit.circuit.library.CZGate "qiskit.circuit.library.CZGate").
  </Function>

  ### dcx

  <Function id="qiskit.circuit.library.GMS.dcx" name="dcx" signature="GMS.dcx(qubit1, qubit2)">
    Apply [`DCXGate`](qiskit.circuit.library.DCXGate "qiskit.circuit.library.DCXGate").
  </Function>

  ### decompose

  <Function id="qiskit.circuit.library.GMS.decompose" name="decompose" signature="GMS.decompose()">
  ...
  <Function id="qiskit.circuit.library.GMS.depth" name="depth" signature="GMS.depth()">
  ...
  <Function id="qiskit.circuit.library.GMS.diag_gate" name="diag_gate" signature="GMS.diag_gate(diag, qubit)">
    Deprecated version of QuantumCircuit.diagonal.
  </Function>

  ### diagonal

  <Function id="qiskit.circuit.library.GMS.diagonal" name="diagonal" signature="GMS.diagonal(diag, qubit)">
  ...
  <Function id="qiskit.circuit.library.GMS.extend" name="extend" signature="GMS.extend(rhs)">
  ...
  <Function id="qiskit.circuit.library.GMS.fredkin" name="fredkin" signature="GMS.fredkin(control_qubit, target_qubit1, target_qubit2, *, ctl=None, tgt1=None, tgt2=None)">
    Apply [`CSwapGate`](qiskit.circuit.library.CSwapGate "qiskit.circuit.library.CSwapGate").
  </Function>

  ### from\_qasm\_file

  <Function id="qiskit.circuit.library.GMS.from_qasm_file" name="from_qasm_file" signature="static GMS.from_qasm_file(path)">
  ...
  <Function id="qiskit.circuit.library.GMS.from_qasm_str" name="from_qasm_str" signature="static GMS.from_qasm_str(qasm_str)">
  ...
  <Function id="qiskit.circuit.library.GMS.h" name="h" signature="GMS.h(qubit, *, q=None)">
    Apply [`HGate`](qiskit.circuit.library.HGate "qiskit.circuit.library.HGate").
  </Function>

  ### hamiltonian

  <Function id="qiskit.circuit.library.GMS.hamiltonian" name="hamiltonian" signature="GMS.hamiltonian(operator, time, qubits, label=None)">
    Apply hamiltonian evolution to to qubits.
  </Function>

  ### has\_register

  <Function id="qiskit.circuit.library.GMS.has_register" name="has_register" signature="GMS.has_register(register)">
  ...
  <Function id="qiskit.circuit.library.GMS.i" name="i" signature="GMS.i(qubit, *, q=None)">
    Apply [`IGate`](qiskit.circuit.library.IGate "qiskit.circuit.library.IGate").
  </Function>

  ### id

  <Function id="qiskit.circuit.library.GMS.id" name="id" signature="GMS.id(qubit, *, q=None)">
    Apply [`IGate`](qiskit.circuit.library.IGate "qiskit.circuit.library.IGate").
  </Function>

  ### iden

  <Function id="qiskit.circuit.library.GMS.iden" name="iden" signature="GMS.iden(qubit, *, q=None)">
    Deprecated identity gate.
  </Function>

  ### initialize

  <Function id="qiskit.circuit.library.GMS.initialize" name="initialize" signature="GMS.initialize(params, qubits)">
    Apply initialize to circuit.
  </Function>

  ### inverse

  <Function id="qiskit.circuit.library.GMS.inverse" name="inverse" signature="GMS.inverse()">
    Invert this circuit.
  ...
  <Function id="qiskit.circuit.library.GMS.iso" name="iso" signature="GMS.iso(isometry, q_input, q_ancillas_for_output, q_ancillas_zero=None, q_ancillas_dirty=None)">
  ...
  <Function id="qiskit.circuit.library.GMS.isometry" name="isometry" signature="GMS.isometry(isometry, q_input, q_ancillas_for_output, q_ancillas_zero=None, q_ancillas_dirty=None)">
    Attach an arbitrary isometry from m to n qubits to a circuit. In particular, this allows to attach arbitrary unitaries on n qubits (m=n) or to prepare any state on n qubits (m=0). The decomposition used here was introduced by Iten et al. in [https://arxiv.org/abs/1501.06911](https://arxiv.org/abs/1501.06911).
  ...
  <Function id="qiskit.circuit.library.GMS.iswap" name="iswap" signature="GMS.iswap(qubit1, qubit2)">
    Apply [`iSwapGate`](qiskit.circuit.library.iSwapGate "qiskit.circuit.library.iSwapGate").
  </Function>

  ### mcmt

  <Function id="qiskit.circuit.library.GMS.mcmt" name="mcmt" signature="GMS.mcmt(gate, control_qubits, target_qubits, ancilla_qubits=None, mode='no-ancilla', *, single_control_gate_fun=None, q_controls=None, q_ancillae=None, q_targets=None)">
  ...
  <Function id="qiskit.circuit.library.GMS.mcrx" name="mcrx" signature="GMS.mcrx(theta, q_controls, q_target, use_basis_gates=False)">
  ...
  <Function id="qiskit.circuit.library.GMS.mcry" name="mcry" signature="GMS.mcry(theta, q_controls, q_target, q_ancillae, mode='basic', use_basis_gates=False)">
  ...
  <Function id="qiskit.circuit.library.GMS.mcrz" name="mcrz" signature="GMS.mcrz(lam, q_controls, q_target, use_basis_gates=False)">
  ...
  <Function id="qiskit.circuit.library.GMS.mct" name="mct" signature="GMS.mct(control_qubits, target_qubit, ancilla_qubits=None, mode='noancilla')">
    Apply `MCXGate`.
  </Function>

  ### mcu1

  <Function id="qiskit.circuit.library.GMS.mcu1" name="mcu1" signature="GMS.mcu1(lam, control_qubits, target_qubit)">
    Apply `MCU1Gate`.
  </Function>

  ### mcx

  <Function id="qiskit.circuit.library.GMS.mcx" name="mcx" signature="GMS.mcx(control_qubits, target_qubit, ancilla_qubits=None, mode='noancilla')">
    Apply `MCXGate`.
  ...
  <Function id="qiskit.circuit.library.GMS.measure" name="measure" signature="GMS.measure(qubit, cbit)">
  ...
  <Function id="qiskit.circuit.library.GMS.measure_active" name="measure_active" signature="GMS.measure_active(inplace=True)">
  ...
  <Function id="qiskit.circuit.library.GMS.measure_all" name="measure_all" signature="GMS.measure_all(inplace=True)">
  ...
  <Function id="qiskit.circuit.library.GMS.mirror" name="mirror" signature="GMS.mirror()">
  ...
  <Function id="qiskit.circuit.library.GMS.ms" name="ms" signature="GMS.ms(theta, qubits)">
    Apply [`MSGate`](qiskit.circuit.library.MSGate "qiskit.circuit.library.MSGate").
  </Function>

  ### num\_connected\_components

  <Function id="qiskit.circuit.library.GMS.num_connected_components" name="num_connected_components" signature="GMS.num_connected_components(unitary_only=False)">
  ...
  <Function id="qiskit.circuit.library.GMS.num_nonlocal_gates" name="num_nonlocal_gates" signature="GMS.num_nonlocal_gates()">
  ...
  <Function id="qiskit.circuit.library.GMS.num_tensor_factors" name="num_tensor_factors" signature="GMS.num_tensor_factors()">
  ...
  <Function id="qiskit.circuit.library.GMS.num_unitary_factors" name="num_unitary_factors" signature="GMS.num_unitary_factors()">
    Computes the number of tensor factors in the unitary (quantum) part of the circuit only.
  </Function>

  ### qasm

  <Function id="qiskit.circuit.library.GMS.qasm" name="qasm" signature="GMS.qasm(formatted=False, filename=None)">
  ...
  <Function id="qiskit.circuit.library.GMS.qbit_argument_conversion" name="qbit_argument_conversion" signature="GMS.qbit_argument_conversion(qubit_representation)">
  ...
  <Function id="qiskit.circuit.library.GMS.r" name="r" signature="GMS.r(theta, phi, qubit, *, q=None)">
    Apply `RGate`.
  </Function>

  ### rcccx

  <Function id="qiskit.circuit.library.GMS.rcccx" name="rcccx" signature="GMS.rcccx(control_qubit1, control_qubit2, control_qubit3, target_qubit)">
    Apply [`RC3XGate`](qiskit.circuit.library.RC3XGate "qiskit.circuit.library.RC3XGate").
  </Function>

  ### rccx

  <Function id="qiskit.circuit.library.GMS.rccx" name="rccx" signature="GMS.rccx(control_qubit1, control_qubit2, target_qubit)">
    Apply [`RCCXGate`](qiskit.circuit.library.RCCXGate "qiskit.circuit.library.RCCXGate").
  </Function>

  ### remove\_final\_measurements

  <Function id="qiskit.circuit.library.GMS.remove_final_measurements" name="remove_final_measurements" signature="GMS.remove_final_measurements(inplace=True)">
  ...
  <Function id="qiskit.circuit.library.GMS.reset" name="reset" signature="GMS.reset(qubit)">
    Reset q.
  </Function>

  ### rx

  <Function id="qiskit.circuit.library.GMS.rx" name="rx" signature="GMS.rx(theta, qubit, *, label=None, q=None)">
    Apply [`RXGate`](qiskit.circuit.library.RXGate "qiskit.circuit.library.RXGate").
  </Function>

  ### rxx

  <Function id="qiskit.circuit.library.GMS.rxx" name="rxx" signature="GMS.rxx(theta, qubit1, qubit2)">
    Apply [`RXXGate`](qiskit.circuit.library.RXXGate "qiskit.circuit.library.RXXGate").
  </Function>

  ### ry

  <Function id="qiskit.circuit.library.GMS.ry" name="ry" signature="GMS.ry(theta, qubit, *, label=None, q=None)">
    Apply [`RYGate`](qiskit.circuit.library.RYGate "qiskit.circuit.library.RYGate").
  </Function>

  ### ryy

  <Function id="qiskit.circuit.library.GMS.ryy" name="ryy" signature="GMS.ryy(theta, qubit1, qubit2)">
    Apply [`RYYGate`](qiskit.circuit.library.RYYGate "qiskit.circuit.library.RYYGate").
  </Function>

  ### rz

  <Function id="qiskit.circuit.library.GMS.rz" name="rz" signature="GMS.rz(phi, qubit, *, q=None)">
    Apply [`RZGate`](qiskit.circuit.library.RZGate "qiskit.circuit.library.RZGate").
  </Function>

  ### rzx

  <Function id="qiskit.circuit.library.GMS.rzx" name="rzx" signature="GMS.rzx(theta, qubit1, qubit2)">
    Apply [`RZXGate`](qiskit.circuit.library.RZXGate "qiskit.circuit.library.RZXGate").
  </Function>

  ### rzz

  <Function id="qiskit.circuit.library.GMS.rzz" name="rzz" signature="GMS.rzz(theta, qubit1, qubit2)">
    Apply [`RZZGate`](qiskit.circuit.library.RZZGate "qiskit.circuit.library.RZZGate").
  </Function>

  ### s

  <Function id="qiskit.circuit.library.GMS.s" name="s" signature="GMS.s(qubit, *, q=None)">
    Apply [`SGate`](qiskit.circuit.library.SGate "qiskit.circuit.library.SGate").
  </Function>

  ### sdg

  <Function id="qiskit.circuit.library.GMS.sdg" name="sdg" signature="GMS.sdg(qubit, *, q=None)">
    Apply [`SdgGate`](qiskit.circuit.library.SdgGate "qiskit.circuit.library.SdgGate").
  </Function>

  ### size

  <Function id="qiskit.circuit.library.GMS.size" name="size" signature="GMS.size()">
  ...
  <Function id="qiskit.circuit.library.GMS.snapshot" name="snapshot" signature="GMS.snapshot(label, snapshot_type='statevector', qubits=None, params=None)">
  ...
  <Function id="qiskit.circuit.library.GMS.snapshot_density_matrix" name="snapshot_density_matrix" signature="GMS.snapshot_density_matrix(label, qubits=None)">
  ...
  <Function id="qiskit.circuit.library.GMS.snapshot_expectation_value" name="snapshot_expectation_value" signature="GMS.snapshot_expectation_value(label, op, qubits, single_shot=False, variance=False)">
  ...
  <Function id="qiskit.circuit.library.GMS.snapshot_probabilities" name="snapshot_probabilities" signature="GMS.snapshot_probabilities(label, qubits, variance=False)">
  ...
  <Function id="qiskit.circuit.library.GMS.snapshot_stabilizer" name="snapshot_stabilizer" signature="GMS.snapshot_stabilizer(label)">
  ...
  <Function id="qiskit.circuit.library.GMS.snapshot_statevector" name="snapshot_statevector" signature="GMS.snapshot_statevector(label)">
  ...
  <Function id="qiskit.circuit.library.GMS.squ" name="squ" signature="GMS.squ(unitary_matrix, qubit, mode='ZYZ', up_to_diagonal=False, *, u=None)">
  ...
  <Function id="qiskit.circuit.library.GMS.swap" name="swap" signature="GMS.swap(qubit1, qubit2)">
    Apply [`SwapGate`](qiskit.circuit.library.SwapGate "qiskit.circuit.library.SwapGate").
  </Function>

  ### t

  <Function id="qiskit.circuit.library.GMS.t" name="t" signature="GMS.t(qubit, *, q=None)">
    Apply [`TGate`](qiskit.circuit.library.TGate "qiskit.circuit.library.TGate").
  </Function>

  ### tdg

  <Function id="qiskit.circuit.library.GMS.tdg" name="tdg" signature="GMS.tdg(qubit, *, q=None)">
    Apply [`TdgGate`](qiskit.circuit.library.TdgGate "qiskit.circuit.library.TdgGate").
  </Function>

  ### to\_gate

  <Function id="qiskit.circuit.library.GMS.to_gate" name="to_gate" signature="GMS.to_gate(parameter_map=None)">
  ...
  <Function id="qiskit.circuit.library.GMS.to_instruction" name="to_instruction" signature="GMS.to_instruction(parameter_map=None)">
  ...
  <Function id="qiskit.circuit.library.GMS.toffoli" name="toffoli" signature="GMS.toffoli(control_qubit1, control_qubit2, target_qubit, *, ctl1=None, ctl2=None, tgt=None)">
    Apply [`CCXGate`](qiskit.circuit.library.CCXGate "qiskit.circuit.library.CCXGate").
  </Function>

  ### u1

  <Function id="qiskit.circuit.library.GMS.u1" name="u1" signature="GMS.u1(theta, qubit, *, q=None)">
    Apply [`U1Gate`](qiskit.circuit.library.U1Gate "qiskit.circuit.library.U1Gate").
  </Function>

  ### u2

  <Function id="qiskit.circuit.library.GMS.u2" name="u2" signature="GMS.u2(phi, lam, qubit, *, q=None)">
    Apply [`U2Gate`](qiskit.circuit.library.U2Gate "qiskit.circuit.library.U2Gate").
  </Function>

  ### u3

  <Function id="qiskit.circuit.library.GMS.u3" name="u3" signature="GMS.u3(theta, phi, lam, qubit, *, q=None)">
    Apply [`U3Gate`](qiskit.circuit.library.U3Gate "qiskit.circuit.library.U3Gate").
  </Function>

  ### uc

  <Function id="qiskit.circuit.library.GMS.uc" name="uc" signature="GMS.uc(gate_list, q_controls, q_target, up_to_diagonal=False)">
  ...
  <Function id="qiskit.circuit.library.GMS.ucg" name="ucg" signature="GMS.ucg(angle_list, q_controls, q_target, up_to_diagonal=False)">
    Deprecated version of uc.
  </Function>

  ### ucrx

  <Function id="qiskit.circuit.library.GMS.ucrx" name="ucrx" signature="GMS.ucrx(angle_list, q_controls, q_target)">
  ...
  <Function id="qiskit.circuit.library.GMS.ucry" name="ucry" signature="GMS.ucry(angle_list, q_controls, q_target)">
  ...
  <Function id="qiskit.circuit.library.GMS.ucrz" name="ucrz" signature="GMS.ucrz(angle_list, q_controls, q_target)">
  ...
  <Function id="qiskit.circuit.library.GMS.ucx" name="ucx" signature="GMS.ucx(angle_list, q_controls, q_target)">
    Deprecated version of ucrx.
  </Function>

  ### ucy

  <Function id="qiskit.circuit.library.GMS.ucy" name="ucy" signature="GMS.ucy(angle_list, q_controls, q_target)">
    Deprecated version of ucry.
  </Function>

  ### ucz

  <Function id="qiskit.circuit.library.GMS.ucz" name="ucz" signature="GMS.ucz(angle_list, q_controls, q_target)">
    Deprecated version of ucrz.
  </Function>

  ### unitary

  <Function id="qiskit.circuit.library.GMS.unitary" name="unitary" signature="GMS.unitary(obj, qubits, label=None)">
    Apply unitary gate to q.
  </Function>

  ### width

  <Function id="qiskit.circuit.library.GMS.width" name="width" signature="GMS.width()">
  ...
  <Function id="qiskit.circuit.library.GMS.x" name="x" signature="GMS.x(qubit, *, label=None, ctrl_state=None, q=None)">
    Apply [`XGate`](qiskit.circuit.library.XGate "qiskit.circuit.library.XGate").
  </Function>

  ### y

  <Function id="qiskit.circuit.library.GMS.y" name="y" signature="GMS.y(qubit, *, q=None)">
    Apply [`YGate`](qiskit.circuit.library.YGate "qiskit.circuit.library.YGate").
  </Function>

  ### z

  <Function id="qiskit.circuit.library.GMS.z" name="z" signature="GMS.z(qubit, *, q=None)">
