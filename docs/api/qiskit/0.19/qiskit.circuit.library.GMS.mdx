...
$$
  ...
  *   **theta** (`Union`\[`List`\[`List`\[`float`]], `ndarray`]) – a num\_qubits x num\_qubits symmetric matrix of interaction angles for each qubit pair. The upper triangle is considered.
  ...
  <Function id="qiskit.circuit.library.GMS.cast" signature="static GMS.cast(value, _type)">
  ...
  <Function id="qiskit.circuit.library.GMS.cls_instances" signature="classmethod GMS.cls_instances()">
    Return the current number of instances of this class, useful for auto naming.
  </Function>

  ### cls\_prefix

  <Function id="qiskit.circuit.library.GMS.cls_prefix" signature="classmethod GMS.cls_prefix()">
  ...
  <Function id="qiskit.circuit.library.GMS.from_qasm_file" signature="static GMS.from_qasm_file(path)">
  ...
  <Function id="qiskit.circuit.library.GMS.from_qasm_str" signature="static GMS.from_qasm_str(qasm_str)">
