---
title: GMS (v0.19)
description: API reference for qiskit.circuit.library.GMS in qiskit v0.19
...
<Class id="qiskit.circuit.library.GMS" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.14/qiskit/circuit/library/generalized_gates/gms.py" signature="GMS(num_qubits, theta)" modifiers="class">
...
$$
  ...
  **References:**
  ...
  \[1] Sørensen, A. and Mølmer, K., Multi-particle entanglement of hot trapped ions. Physical Review Letters. 82 (9): 1835–1838. [arXiv:quant-ph/9810040](https://arxiv.org/abs/quant-ph/9810040)
  ...
  *   **theta** (`Union`\[`List`\[`List`\[`float`]], `ndarray`]) – a num\_qubits x num\_qubits symmetric matrix of interaction angles for each qubit pair. The upper triangle is considered.
  ...
  <span id="gms-instances" />

  ### instances

  <Attribute id="qiskit.circuit.library.GMS.instances" attributeValue="8" />

  <span id="gms-n-qubits" />

  ### n\_qubits

  <Attribute id="qiskit.circuit.library.GMS.n_qubits">
    Deprecated, use `num_qubits` instead. Return number of qubits.
  </Attribute>

  <span id="gms-num-clbits" />
  ...
  <Function id="qiskit.circuit.library.GMS.AND" signature="GMS.AND(qr_variables, qb_target, qr_ancillae, flags=None, mct_mode='no-ancilla')">
  ...
  <Function id="qiskit.circuit.library.GMS.OR" signature="GMS.OR(qr_variables, qb_target, qr_ancillae, flags=None, mct_mode='basic')">
  ...
  <Function id="qiskit.circuit.library.GMS.__getitem__" signature="GMS.__getitem__(item)">
  ...
  <Function id="qiskit.circuit.library.GMS.__len__" signature="GMS.__len__()">
    Return number of operations in circuit.
  </Function>

  <span id="gms-add-register" />

  ### add\_register

  <Function id="qiskit.circuit.library.GMS.add_register" signature="GMS.add_register(*regs)">
    Add registers.
  </Function>
  ...
  <Function id="qiskit.circuit.library.GMS.append" signature="GMS.append(instruction, qargs=None, cargs=None)">
  ...
  <span id="gms-assign-parameters" />

  ### assign\_parameters

  <Function id="qiskit.circuit.library.GMS.assign_parameters" signature="GMS.assign_parameters(param_dict, inplace=False)">
  ...
  <Function id="qiskit.circuit.library.GMS.barrier" signature="GMS.barrier(*qargs)">
    Apply `Barrier`. If qargs is None, applies to all.
  </Function>

  <span id="gms-bind-parameters" />

  ### bind\_parameters

  <Function id="qiskit.circuit.library.GMS.bind_parameters" signature="GMS.bind_parameters(value_dict)">
  ...
  <Function id="qiskit.circuit.library.GMS.cast" signature="GMS.cast(value, _type)" modifiers="static">
    Best effort to cast value to type. Otherwise, returns the value.
  </Function>

  <span id="gms-cbit-argument-conversion" />

  ### cbit\_argument\_conversion

  <Function id="qiskit.circuit.library.GMS.cbit_argument_conversion" signature="GMS.cbit_argument_conversion(clbit_representation)">
  ...
  <Function id="qiskit.circuit.library.GMS.ccx" signature="GMS.ccx(control_qubit1, control_qubit2, target_qubit, *, ctl1=None, ctl2=None, tgt=None)">
  ...
  <Function id="qiskit.circuit.library.GMS.ch" signature="GMS.ch(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CHGate`](qiskit.circuit.library.CHGate "qiskit.circuit.library.CHGate").
  </Function>

  <span id="gms-cls-instances" />

  ### cls\_instances

  <Function id="qiskit.circuit.library.GMS.cls_instances" signature="GMS.cls_instances()" modifiers="classmethod">
    Return the current number of instances of this class, useful for auto naming.
  </Function>

  <span id="gms-cls-prefix" />

  ### cls\_prefix

  <Function id="qiskit.circuit.library.GMS.cls_prefix" signature="GMS.cls_prefix()" modifiers="classmethod">
  ...
  <Function id="qiskit.circuit.library.GMS.cnot" signature="GMS.cnot(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
  ...
  <Function id="qiskit.circuit.library.GMS.combine" signature="GMS.combine(rhs)">
  ...
  <Function id="qiskit.circuit.library.GMS.compose" signature="GMS.compose(other, qubits=None, clbits=None, front=False, inplace=False)">
  ...
  <Function id="qiskit.circuit.library.GMS.copy" signature="GMS.copy(name=None)">
    Copy the circuit.
  ...
  <span id="gms-count-ops" />

  ### count\_ops

  <Function id="qiskit.circuit.library.GMS.count_ops" signature="GMS.count_ops()">
  ...
  <Function id="qiskit.circuit.library.GMS.crx" signature="GMS.crx(theta, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
  ...
  <Function id="qiskit.circuit.library.GMS.cry" signature="GMS.cry(theta, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
  ...
  <Function id="qiskit.circuit.library.GMS.crz" signature="GMS.crz(theta, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
  ...
  <Function id="qiskit.circuit.library.GMS.cswap" signature="GMS.cswap(control_qubit, target_qubit1, target_qubit2, *, label=None, ctrl_state=None, ctl=None, tgt1=None, tgt2=None)">
  ...
  <Function id="qiskit.circuit.library.GMS.cu1" signature="GMS.cu1(theta, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
  ...
  <Function id="qiskit.circuit.library.GMS.cu3" signature="GMS.cu3(theta, phi, lam, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
  ...
  <Function id="qiskit.circuit.library.GMS.cx" signature="GMS.cx(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CXGate`](qiskit.circuit.library.CXGate "qiskit.circuit.library.CXGate").
  </Function>
  ...
  <Function id="qiskit.circuit.library.GMS.cy" signature="GMS.cy(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
  ...
  <Function id="qiskit.circuit.library.GMS.cz" signature="GMS.cz(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
  ...
  <Function id="qiskit.circuit.library.GMS.dcx" signature="GMS.dcx(qubit1, qubit2)">
    Apply [`DCXGate`](qiskit.circuit.library.DCXGate "qiskit.circuit.library.DCXGate").
  </Function>

  <span id="gms-decompose" />

  ### decompose

  <Function id="qiskit.circuit.library.GMS.decompose" signature="GMS.decompose()">
  ...
  <Function id="qiskit.circuit.library.GMS.depth" signature="GMS.depth()">
  ...
  <span id="gms-diag-gate" />

  ### diag\_gate

  <Function id="qiskit.circuit.library.GMS.diag_gate" signature="GMS.diag_gate(diag, qubit)">
    Deprecated version of QuantumCircuit.diagonal.
  </Function>

  <span id="gms-diagonal" />

  ### diagonal

  <Function id="qiskit.circuit.library.GMS.diagonal" signature="GMS.diagonal(diag, qubit)">
  ...
  <Function id="qiskit.circuit.library.GMS.extend" signature="GMS.extend(rhs)">
  ...
  <Function id="qiskit.circuit.library.GMS.fredkin" signature="GMS.fredkin(control_qubit, target_qubit1, target_qubit2, *, ctl=None, tgt1=None, tgt2=None)">
    Apply [`CSwapGate`](qiskit.circuit.library.CSwapGate "qiskit.circuit.library.CSwapGate").
  </Function>

  <span id="gms-from-qasm-file" />

  ### from\_qasm\_file

  <Function id="qiskit.circuit.library.GMS.from_qasm_file" signature="GMS.from_qasm_file(path)" modifiers="static">
  ...
  <span id="gms-from-qasm-str" />

  ### from\_qasm\_str

  <Function id="qiskit.circuit.library.GMS.from_qasm_str" signature="GMS.from_qasm_str(qasm_str)" modifiers="static">
  ...
  <Function id="qiskit.circuit.library.GMS.h" signature="GMS.h(qubit, *, q=None)">
    Apply [`HGate`](qiskit.circuit.library.HGate "qiskit.circuit.library.HGate").
  </Function>

  <span id="gms-hamiltonian" />

  ### hamiltonian

  <Function id="qiskit.circuit.library.GMS.hamiltonian" signature="GMS.hamiltonian(operator, time, qubits, label=None)">
    Apply hamiltonian evolution to to qubits.
  </Function>

  <span id="gms-has-register" />

  ### has\_register

  <Function id="qiskit.circuit.library.GMS.has_register" signature="GMS.has_register(register)">
  ...
  <Function id="qiskit.circuit.library.GMS.i" signature="GMS.i(qubit, *, q=None)">
  ...
  <Function id="qiskit.circuit.library.GMS.id" signature="GMS.id(qubit, *, q=None)">
    Apply [`IGate`](qiskit.circuit.library.IGate "qiskit.circuit.library.IGate").
  </Function>
  ...
  <Function id="qiskit.circuit.library.GMS.iden" signature="GMS.iden(qubit, *, q=None)">
    Deprecated identity gate.
  </Function>

  <span id="gms-initialize" />

  ### initialize

  <Function id="qiskit.circuit.library.GMS.initialize" signature="GMS.initialize(params, qubits)">
  ...
  <Function id="qiskit.circuit.library.GMS.inverse" signature="GMS.inverse()">
    Invert this circuit.
  ...
  <Function id="qiskit.circuit.library.GMS.iso" signature="GMS.iso(isometry, q_input, q_ancillas_for_output, q_ancillas_zero=None, q_ancillas_dirty=None)">
  ...
  <span id="gms-isometry" />

  ### isometry

  <Function id="qiskit.circuit.library.GMS.isometry" signature="GMS.isometry(isometry, q_input, q_ancillas_for_output, q_ancillas_zero=None, q_ancillas_dirty=None)">
    Attach an arbitrary isometry from m to n qubits to a circuit. In particular, this allows to attach arbitrary unitaries on n qubits (m=n) or to prepare any state on n qubits (m=0). The decomposition used here was introduced by Iten et al. in [https://arxiv.org/abs/1501.06911](https://arxiv.org/abs/1501.06911).
  ...
  <Function id="qiskit.circuit.library.GMS.iswap" signature="GMS.iswap(qubit1, qubit2)">
  ...
  <Function id="qiskit.circuit.library.GMS.mcmt" signature="GMS.mcmt(gate, control_qubits, target_qubits, ancilla_qubits=None, mode='no-ancilla', *, single_control_gate_fun=None, q_controls=None, q_ancillae=None, q_targets=None)">
  ...
  <Function id="qiskit.circuit.library.GMS.mcrx" signature="GMS.mcrx(theta, q_controls, q_target, use_basis_gates=False)">
  ...
  <Function id="qiskit.circuit.library.GMS.mcry" signature="GMS.mcry(theta, q_controls, q_target, q_ancillae, mode='basic', use_basis_gates=False)">
  ...
  <Function id="qiskit.circuit.library.GMS.mcrz" signature="GMS.mcrz(lam, q_controls, q_target, use_basis_gates=False)">
  ...
  <Function id="qiskit.circuit.library.GMS.mct" signature="GMS.mct(control_qubits, target_qubit, ancilla_qubits=None, mode='noancilla')">
    Apply `MCXGate`.
  </Function>
  ...
  <Function id="qiskit.circuit.library.GMS.mcu1" signature="GMS.mcu1(lam, control_qubits, target_qubit)">
    Apply `MCU1Gate`.
  </Function>
  ...
  <Function id="qiskit.circuit.library.GMS.mcx" signature="GMS.mcx(control_qubits, target_qubit, ancilla_qubits=None, mode='noancilla')">
    Apply `MCXGate`.
  ...
  <Function id="qiskit.circuit.library.GMS.measure" signature="GMS.measure(qubit, cbit)">
  ...
  <span id="gms-measure-active" />

  ### measure\_active

  <Function id="qiskit.circuit.library.GMS.measure_active" signature="GMS.measure_active(inplace=True)">
  ...
  <span id="gms-measure-all" />

  ### measure\_all

  <Function id="qiskit.circuit.library.GMS.measure_all" signature="GMS.measure_all(inplace=True)">
  ...
  <Function id="qiskit.circuit.library.GMS.mirror" signature="GMS.mirror()">
  ...
  <Function id="qiskit.circuit.library.GMS.ms" signature="GMS.ms(theta, qubits)">
    Apply [`MSGate`](qiskit.circuit.library.MSGate "qiskit.circuit.library.MSGate").
  </Function>

  <span id="gms-num-connected-components" />

  ### num\_connected\_components

  <Function id="qiskit.circuit.library.GMS.num_connected_components" signature="GMS.num_connected_components(unitary_only=False)">
  ...
  <span id="gms-num-nonlocal-gates" />

  ### num\_nonlocal\_gates

  <Function id="qiskit.circuit.library.GMS.num_nonlocal_gates" signature="GMS.num_nonlocal_gates()">
    Return number of non-local gates (i.e. involving 2+ qubits).

    Conditional nonlocal gates are also included.
  </Function>

  <span id="gms-num-tensor-factors" />

  ### num\_tensor\_factors

  <Function id="qiskit.circuit.library.GMS.num_tensor_factors" signature="GMS.num_tensor_factors()">
  ...
  <span id="gms-num-unitary-factors" />

  ### num\_unitary\_factors

  <Function id="qiskit.circuit.library.GMS.num_unitary_factors" signature="GMS.num_unitary_factors()">
    Computes the number of tensor factors in the unitary (quantum) part of the circuit only.
  </Function>
  ...
  <Function id="qiskit.circuit.library.GMS.qasm" signature="GMS.qasm(formatted=False, filename=None)">
  ...
  <span id="gms-qbit-argument-conversion" />

  ### qbit\_argument\_conversion

  <Function id="qiskit.circuit.library.GMS.qbit_argument_conversion" signature="GMS.qbit_argument_conversion(qubit_representation)">
  ...
  <Function id="qiskit.circuit.library.GMS.r" signature="GMS.r(theta, phi, qubit, *, q=None)">
    Apply `RGate`.
  </Function>
  ...
  <Function id="qiskit.circuit.library.GMS.rcccx" signature="GMS.rcccx(control_qubit1, control_qubit2, control_qubit3, target_qubit)">
  ...
  <Function id="qiskit.circuit.library.GMS.rccx" signature="GMS.rccx(control_qubit1, control_qubit2, target_qubit)">
    Apply [`RCCXGate`](qiskit.circuit.library.RCCXGate "qiskit.circuit.library.RCCXGate").
  </Function>

  <span id="gms-remove-final-measurements" />

  ### remove\_final\_measurements

  <Function id="qiskit.circuit.library.GMS.remove_final_measurements" signature="GMS.remove_final_measurements(inplace=True)">
  ...
  <Function id="qiskit.circuit.library.GMS.reset" signature="GMS.reset(qubit)">
    Reset q.
  </Function>
  ...
  <Function id="qiskit.circuit.library.GMS.rx" signature="GMS.rx(theta, qubit, *, label=None, q=None)">
  ...
  <Function id="qiskit.circuit.library.GMS.rxx" signature="GMS.rxx(theta, qubit1, qubit2)">
  ...
  <Function id="qiskit.circuit.library.GMS.ry" signature="GMS.ry(theta, qubit, *, label=None, q=None)">
  ...
  <Function id="qiskit.circuit.library.GMS.ryy" signature="GMS.ryy(theta, qubit1, qubit2)">
  ...
  <Function id="qiskit.circuit.library.GMS.rz" signature="GMS.rz(phi, qubit, *, q=None)">
  ...
  <Function id="qiskit.circuit.library.GMS.rzx" signature="GMS.rzx(theta, qubit1, qubit2)">
  ...
  <Function id="qiskit.circuit.library.GMS.rzz" signature="GMS.rzz(theta, qubit1, qubit2)">
  ...
  <Function id="qiskit.circuit.library.GMS.s" signature="GMS.s(qubit, *, q=None)">
  ...
  <Function id="qiskit.circuit.library.GMS.sdg" signature="GMS.sdg(qubit, *, q=None)">
  ...
  <Function id="qiskit.circuit.library.GMS.size" signature="GMS.size()">
  ...
  <span id="gms-snapshot" />

  ### snapshot

  <Function id="qiskit.circuit.library.GMS.snapshot" signature="GMS.snapshot(label, snapshot_type='statevector', qubits=None, params=None)">
  ...
  <span id="gms-snapshot-density-matrix" />

  ### snapshot\_density\_matrix

  <Function id="qiskit.circuit.library.GMS.snapshot_density_matrix" signature="GMS.snapshot_density_matrix(label, qubits=None)">
  ...
  <span id="gms-snapshot-expectation-value" />

  ### snapshot\_expectation\_value

  <Function id="qiskit.circuit.library.GMS.snapshot_expectation_value" signature="GMS.snapshot_expectation_value(label, op, qubits, single_shot=False, variance=False)">
  ...
  <span id="gms-snapshot-probabilities" />

  ### snapshot\_probabilities

  <Function id="qiskit.circuit.library.GMS.snapshot_probabilities" signature="GMS.snapshot_probabilities(label, qubits, variance=False)">
  ...
  <span id="gms-snapshot-stabilizer" />

  ### snapshot\_stabilizer

  <Function id="qiskit.circuit.library.GMS.snapshot_stabilizer" signature="GMS.snapshot_stabilizer(label)">
  ...
  <span id="gms-snapshot-statevector" />

  ### snapshot\_statevector

  <Function id="qiskit.circuit.library.GMS.snapshot_statevector" signature="GMS.snapshot_statevector(label)">
  ...
  <Function id="qiskit.circuit.library.GMS.squ" signature="GMS.squ(unitary_matrix, qubit, mode='ZYZ', up_to_diagonal=False, *, u=None)">
  ...
  <Function id="qiskit.circuit.library.GMS.swap" signature="GMS.swap(qubit1, qubit2)">
  ...
  <Function id="qiskit.circuit.library.GMS.t" signature="GMS.t(qubit, *, q=None)">
  ...
  <Function id="qiskit.circuit.library.GMS.tdg" signature="GMS.tdg(qubit, *, q=None)">
  ...
  <Function id="qiskit.circuit.library.GMS.to_gate" signature="GMS.to_gate(parameter_map=None)">
  ...
  <span id="gms-to-instruction" />

  ### to\_instruction

  <Function id="qiskit.circuit.library.GMS.to_instruction" signature="GMS.to_instruction(parameter_map=None)">
  ...
  <Function id="qiskit.circuit.library.GMS.toffoli" signature="GMS.toffoli(control_qubit1, control_qubit2, target_qubit, *, ctl1=None, ctl2=None, tgt=None)">
    Apply [`CCXGate`](qiskit.circuit.library.CCXGate "qiskit.circuit.library.CCXGate").
  </Function>
  ...
  <Function id="qiskit.circuit.library.GMS.u1" signature="GMS.u1(theta, qubit, *, q=None)">
  ...
  <Function id="qiskit.circuit.library.GMS.u2" signature="GMS.u2(phi, lam, qubit, *, q=None)">
  ...
  <Function id="qiskit.circuit.library.GMS.u3" signature="GMS.u3(theta, phi, lam, qubit, *, q=None)">
  ...
  <Function id="qiskit.circuit.library.GMS.uc" signature="GMS.uc(gate_list, q_controls, q_target, up_to_diagonal=False)">
  ...
  <Function id="qiskit.circuit.library.GMS.ucg" signature="GMS.ucg(angle_list, q_controls, q_target, up_to_diagonal=False)">
  ...
  <Function id="qiskit.circuit.library.GMS.ucrx" signature="GMS.ucrx(angle_list, q_controls, q_target)">
  ...
  <Function id="qiskit.circuit.library.GMS.ucry" signature="GMS.ucry(angle_list, q_controls, q_target)">
  ...
  <Function id="qiskit.circuit.library.GMS.ucrz" signature="GMS.ucrz(angle_list, q_controls, q_target)">
  ...
  <Function id="qiskit.circuit.library.GMS.ucx" signature="GMS.ucx(angle_list, q_controls, q_target)">
  ...
  <Function id="qiskit.circuit.library.GMS.ucy" signature="GMS.ucy(angle_list, q_controls, q_target)">
  ...
  <Function id="qiskit.circuit.library.GMS.ucz" signature="GMS.ucz(angle_list, q_controls, q_target)">
  ...
  <Function id="qiskit.circuit.library.GMS.unitary" signature="GMS.unitary(obj, qubits, label=None)">
  ...
  <Function id="qiskit.circuit.library.GMS.width" signature="GMS.width()">
  ...
  <Function id="qiskit.circuit.library.GMS.x" signature="GMS.x(qubit, *, label=None, ctrl_state=None, q=None)">
  ...
  <Function id="qiskit.circuit.library.GMS.y" signature="GMS.y(qubit, *, q=None)">
  ...
  <Function id="qiskit.circuit.library.GMS.z" signature="GMS.z(qubit, *, q=None)">
