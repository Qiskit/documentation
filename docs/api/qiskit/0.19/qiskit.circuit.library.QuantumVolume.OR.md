---
title: OR
description: API reference for qiskit.circuit.library.QuantumVolume.OR
in_page_toc_min_heading_level: 1
python_api_type: method
python_api_name: qiskit.circuit.library.QuantumVolume.OR
---

# OR

<span id="qiskit.circuit.library.QuantumVolume.OR" />

`QuantumVolume.OR(qr_variables, qb_target, qr_ancillae, flags=None, mct_mode='basic')`
