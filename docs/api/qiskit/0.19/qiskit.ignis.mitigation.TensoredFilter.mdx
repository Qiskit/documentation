---
title: TensoredFilter (v0.19)
description: API reference for qiskit.ignis.mitigation.TensoredFilter in qiskit v0.19
...
<Class id="qiskit.ignis.mitigation.TensoredFilter" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-ignis/tree/stable/0.3/qiskit/ignis/mitigation/measurement/filters.py" signature="TensoredFilter(cal_matrices, substate_labels_list)" modifiers="class">
  ...
  *   **substate\_labels\_list** (`list`) – for each calibration matrix a list of the states (as strings, states in the subspace)
  ...
  <span id="tensoredfilter-cal-matrices" />
  ...
  <span id="tensoredfilter-nqubits" />
  ...
  <span id="tensoredfilter-qubit-list-sizes" />
  ...
  <span id="tensoredfilter-substate-labels-list" />
