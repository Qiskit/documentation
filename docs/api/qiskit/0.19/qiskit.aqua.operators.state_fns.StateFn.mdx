...
<Class id="qiskit.aqua.operators.state_fns.StateFn" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.7/qiskit/aqua/operators/state_fns/state_fn.py" signature="StateFn(primitive=None, coeff=1.0, is_measurement=False)">
  ...
  *   **is\_measurement** (`bool`) – Whether the StateFn is a measurement operator
  ...
  <Attribute id="qiskit.aqua.operators.state_fns.StateFn.coeff" name="coeff" signature="Union[int, float, complex, qiskit.circuit.parameterexpression.ParameterExpression]">
  ...
  <Attribute id="qiskit.aqua.operators.state_fns.StateFn.is_measurement" name="is_measurement" signature="bool">
  ...
  <Attribute id="qiskit.aqua.operators.state_fns.StateFn.num_qubits" name="num_qubits" signature="int">
  ...
  <Function id="qiskit.aqua.operators.state_fns.StateFn.__mul__" name="__mul__" signature="StateFn.__mul__(other)">
  ...
  <Function id="qiskit.aqua.operators.state_fns.StateFn.compose" name="compose" signature="StateFn.compose(other)">
