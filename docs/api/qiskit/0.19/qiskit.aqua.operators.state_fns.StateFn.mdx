---
title: StateFn (v0.19)
description: API reference for qiskit.aqua.operators.state_fns.StateFn in qiskit v0.19
...
<Class id="qiskit.aqua.operators.state_fns.StateFn" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.7/qiskit/aqua/operators/state_fns/state_fn.py" signature="StateFn(primitive=None, coeff=1.0, is_measurement=False)" modifiers="class">
  ...
  *   **is\_measurement** (`bool`) – Whether the StateFn is a measurement operator
  ...
  <span id="statefn-is-measurement" />
  ...
  <span id="statefn-assign-parameters" />
  ...
  <span id="statefn-bind-parameters" />
  ...
  <span id="statefn-primitive-strings" />
  ...
  <span id="statefn-to-density-matrix" />
