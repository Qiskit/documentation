...
<Function id="qiskit.scheduler.utils.format_meas_map" name="format_meas_map" github="https://github.com/qiskit/qiskit/tree/stable/0.14/qiskit/scheduler/utils.py" signature="format_meas_map(meas_map)">
...
<Function id="qiskit.scheduler.utils.measure" name="measure" github="https://github.com/qiskit/qiskit/tree/stable/0.14/qiskit/scheduler/utils.py" signature="measure(qubits, backend=None, inst_map=None, meas_map=None, qubit_mem_slots=None, measure_name='measure')">
...
<Function id="qiskit.scheduler.utils.measure_all" name="measure_all" github="https://github.com/qiskit/qiskit/tree/stable/0.14/qiskit/scheduler/utils.py" signature="measure_all(backend)">
