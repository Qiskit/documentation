---
title: ScheduleConfig (v0.19)
description: API reference for qiskit.scheduler.ScheduleConfig in qiskit v0.19
...
<Class id="qiskit.scheduler.ScheduleConfig" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.14/qiskit/scheduler/config.py" signature="ScheduleConfig(inst_map, meas_map)" modifiers="class">
