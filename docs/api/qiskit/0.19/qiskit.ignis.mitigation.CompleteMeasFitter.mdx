---
title: CompleteMeasFitter (v0.19)
description: API reference for qiskit.ignis.mitigation.CompleteMeasFitter in qiskit v0.19
...
<Class id="qiskit.ignis.mitigation.CompleteMeasFitter" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-ignis/tree/stable/0.3/qiskit/ignis/mitigation/measurement/fitters.py" signature="CompleteMeasFitter(results, state_labels, qubit_list=None, circlabel='')" modifiers="class">
  ...
  *   **circlabel** (`str`) – if the qubits were labeled.
  ...
  <span id="completemeasfitter-cal-matrix" />
  ...
  <span id="completemeasfitter-filter" />
  ...
  <span id="completemeasfitter-qubit-list" />
  ...
  <span id="completemeasfitter-state-labels" />
  ...
  <span id="completemeasfitter-add-data" />
  ...
  <span id="completemeasfitter-plot-calibration" />
  ...
  <span id="completemeasfitter-readout-fidelity" />
  ...
  <span id="completemeasfitter-subset-fitter" />
