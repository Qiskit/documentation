...
description: API reference for qiskit.circuit.library.MCMTVChain.to_instruction
in_page_toc_min_heading_level: 1
python_api_type: method
python_api_name: qiskit.circuit.library.MCMTVChain.to_instruction
---
...
`MCMTVChain.to_instruction(parameter_map=None)`
