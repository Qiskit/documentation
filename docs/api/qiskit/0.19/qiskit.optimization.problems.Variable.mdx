...
<Class id="qiskit.optimization.problems.Variable" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.7/qiskit/optimization/problems/variable.py" signature="Variable(quadratic_program, name, lowerbound=0, upperbound=1e+20, vartype=VarType.CONTINUOUS)">
  ...
  **Raises**
  ...
  <Attribute id="qiskit.optimization.problems.Variable.lowerbound" signature="Union[float, int]">
  ...
  <Attribute id="qiskit.optimization.problems.Variable.name" signature="str">
  ...
  <Attribute id="qiskit.optimization.problems.Variable.quadratic_program" signature="Any">
  ...
  <Attribute id="qiskit.optimization.problems.Variable.upperbound" signature="Union[float, int]">
  ...
  <Attribute id="qiskit.optimization.problems.Variable.vartype" signature="qiskit.optimization.problems.variable.VarType">
