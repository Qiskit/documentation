...
<Class id="qiskit.aqua.algorithms.BernsteinVazirani" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.7/qiskit/aqua/algorithms/education/bernstein_vazirani.py" signature="BernsteinVazirani(oracle, quantum_instance=None)">
  ...
  *   **quantum\_instance** (`Union`\[[`QuantumInstance`](qiskit.aqua.QuantumInstance "qiskit.aqua.quantum_instance.QuantumInstance"), [`BaseBackend`](qiskit.providers.BaseBackend "qiskit.providers.basebackend.BaseBackend"), `None`]) – Quantum Instance or Backend
  ...
  <Attribute id="qiskit.aqua.algorithms.BernsteinVazirani.backend" name="backend" signature="qiskit.providers.basebackend.BaseBackend">
    Returns backend.
  ...
  <Attribute id="qiskit.aqua.algorithms.BernsteinVazirani.quantum_instance" name="quantum_instance" signature="Union[None, qiskit.aqua.quantum_instance.QuantumInstance]">
  ...
  <Attribute id="qiskit.aqua.algorithms.BernsteinVazirani.random" name="random">
  ...
  <Function id="qiskit.aqua.algorithms.BernsteinVazirani.construct_circuit" name="construct_circuit" signature="BernsteinVazirani.construct_circuit(measurement=False)">
  ...
  <Function id="qiskit.aqua.algorithms.BernsteinVazirani.run" name="run" signature="BernsteinVazirani.run(quantum_instance=None, **kwargs)">
  ...
  <Function id="qiskit.aqua.algorithms.BernsteinVazirani.set_backend" name="set_backend" signature="BernsteinVazirani.set_backend(backend, **kwargs)">
