---
title: QOTP (v0.19)
description: API reference for qiskit.ignis.verification.QOTP in qiskit v0.19
...
<Function id="qiskit.ignis.verification.QOTP" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-ignis/tree/stable/0.3/qiskit/ignis/verification/accreditation/qotp.py" signature="QOTP(circ, num, two_qubit_gate='cx', coupling_map=None, seed=None)">
