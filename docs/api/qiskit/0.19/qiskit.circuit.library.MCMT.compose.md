---
title: compose
description: API reference for qiskit.circuit.library.MCMT.compose
in_page_toc_min_heading_level: 1
python_api_type: method
python_api_name: qiskit.circuit.library.MCMT.compose
---
...
`MCMT.compose(other, qubits=None, clbits=None, front=False, inplace=False)`
