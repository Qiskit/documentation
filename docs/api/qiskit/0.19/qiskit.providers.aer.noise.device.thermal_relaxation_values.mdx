---
title: thermal_relaxation_values (v0.19)
description: API reference for qiskit.providers.aer.noise.device.thermal_relaxation_values in qiskit v0.19
in_page_toc_min_heading_level: 1
python_api_type: function
python_api_name: qiskit.providers.aer.noise.device.thermal_relaxation_values
---

<span id="thermal-relaxation-values" />

# thermal\_relaxation\_values

<Function id="qiskit.providers.aer.noise.device.thermal_relaxation_values" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-aer/tree/stable/0.5/qiskit/providers/aer/noise/device/parameters.py" signature="thermal_relaxation_values(properties)">
