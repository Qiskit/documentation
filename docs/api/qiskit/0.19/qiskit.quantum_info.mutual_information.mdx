---
title: mutual_information (v0.19)
description: API reference for qiskit.quantum_info.mutual_information in qiskit v0.19
in_page_toc_min_heading_level: 1
python_api_type: function
python_api_name: qiskit.quantum_info.mutual_information
---

<span id="mutual-information" />

# mutual\_information

<Function id="qiskit.quantum_info.mutual_information" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.14/qiskit/quantum_info/states/measures.py" signature="mutual_information(state, base=2)">
