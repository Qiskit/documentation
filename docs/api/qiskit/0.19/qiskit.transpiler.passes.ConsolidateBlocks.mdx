---
title: ConsolidateBlocks (v0.19)
description: API reference for qiskit.transpiler.passes.ConsolidateBlocks in qiskit v0.19
...
<Class id="qiskit.transpiler.passes.ConsolidateBlocks" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.14/qiskit/transpiler/passes/optimization/consolidate_blocks.py" signature="ConsolidateBlocks(*args, **kwargs)" modifiers="class">
  ...
  *   **force\_consolidate** (*bool*) – Force block consolidation
  ...
  <span id="consolidateblocks-is-analysis-pass" />
  ...
  <span id="consolidateblocks-is-transformation-pass" />
  ...
  <span id="consolidateblocks-name" />
