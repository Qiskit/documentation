...
<Class id="qiskit.aqua.operators.legacy.MatrixOperator" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.7/qiskit/aqua/operators/legacy/matrix_operator.py" signature="MatrixOperator(matrix, basis=None, z2_symmetries=None, atol=1e-12, name=None)">
  ...
  *   **name** (*str*) – name
  ...
  <Function id="qiskit.aqua.operators.legacy.MatrixOperator.__mul__" name="__mul__" signature="MatrixOperator.__mul__(other)">
