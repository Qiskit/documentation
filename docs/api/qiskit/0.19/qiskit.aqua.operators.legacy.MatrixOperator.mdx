---
title: MatrixOperator (v0.19)
description: API reference for qiskit.aqua.operators.legacy.MatrixOperator in qiskit v0.19
...
<Class id="qiskit.aqua.operators.legacy.MatrixOperator" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.7/qiskit/aqua/operators/legacy/matrix_operator.py" signature="MatrixOperator(matrix, basis=None, z2_symmetries=None, atol=1e-12, name=None)" modifiers="class">
  ...
  *   **name** (*str*) – name
  ...
  <span id="matrixoperator-dense-matrix" />
  ...
  <span id="matrixoperator-dia-matrix" />
  ...
  <span id="matrixoperator-num-qubits" />
  ...
  <span id="matrixoperator-z2-symmetries" />
  ...
  <span id="matrixoperator-construct-evaluation-circuit" />
  ...
  <span id="matrixoperator-evaluate-with-result" />
  ...
  <span id="matrixoperator-evaluate-with-statevector" />
  ...
  <span id="matrixoperator-is-empty" />
  ...
  <span id="matrixoperator-print-details" />
