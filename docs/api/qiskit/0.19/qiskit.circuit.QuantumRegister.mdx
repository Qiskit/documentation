...
<Class id="qiskit.circuit.QuantumRegister" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.14/qiskit/circuit/quantumregister.py" signature="QuantumRegister(size, name=None)">
  ...
  <Attribute id="qiskit.circuit.QuantumRegister.instances_counter" signature="= count(0)" />
  ...
  <Attribute id="qiskit.circuit.QuantumRegister.prefix" signature="= 'q'" />
