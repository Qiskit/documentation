---
title: add_implicit_acquires (v0.19)
description: API reference for qiskit.pulse.reschedule.add_implicit_acquires in qiskit v0.19
in_page_toc_min_heading_level: 1
python_api_type: function
python_api_name: qiskit.pulse.reschedule.add_implicit_acquires
---

<span id="add-implicit-acquires" />

# add\_implicit\_acquires

<Function id="qiskit.pulse.reschedule.add_implicit_acquires" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.14/qiskit/pulse/reschedule.py" signature="add_implicit_acquires(schedule, meas_map)">
