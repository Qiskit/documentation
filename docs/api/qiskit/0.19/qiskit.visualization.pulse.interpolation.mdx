---
title: interpolation (v0.19)
description: API reference for qiskit.visualization.pulse.interpolation in qiskit v0.19
...
<Function id="qiskit.visualization.pulse.interpolation.interp1d" github="https://github.com/qiskit/qiskit/tree/stable/0.14/qiskit/visualization/pulse/interpolation.py" signature="interp1d(time, samples, nop, kind='linear')">
...
<Function id="qiskit.visualization.pulse.interpolation.step_wise" github="https://github.com/qiskit/qiskit/tree/stable/0.14/qiskit/visualization/pulse/interpolation.py" signature="step_wise(time, samples, nop)">
