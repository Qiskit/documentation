...
<Function id="qiskit.visualization.pulse.interpolation.cubic_spline" name="cubic_spline" signature="cubic_spline(time: numpy.ndarray, samples: numpy.ndarray, nop: int, *, kind: str = 'cubic') → Tuple[numpy.ndarray, numpy.ndarray, numpy.ndarray]">
...
<Function id="qiskit.visualization.pulse.interpolation.interp1d" name="interp1d" github="https://github.com/qiskit/qiskit/tree/stable/0.14/qiskit/visualization/pulse/interpolation.py" signature="interp1d(time, samples, nop, kind='linear')">
...
<Function id="qiskit.visualization.pulse.interpolation.linear" name="linear" signature="linear(time: numpy.ndarray, samples: numpy.ndarray, nop: int, *, kind: str = 'linear') → Tuple[numpy.ndarray, numpy.ndarray, numpy.ndarray]">
...
<Function id="qiskit.visualization.pulse.interpolation.step_wise" name="step_wise" github="https://github.com/qiskit/qiskit/tree/stable/0.14/qiskit/visualization/pulse/interpolation.py" signature="step_wise(time, samples, nop)">
