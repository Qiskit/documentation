---
title: NoiseAdaptiveLayout (v0.19)
description: API reference for qiskit.transpiler.passes.NoiseAdaptiveLayout in qiskit v0.19
...
<Class id="qiskit.transpiler.passes.NoiseAdaptiveLayout" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.14/qiskit/transpiler/passes/layout/noise_adaptive_layout.py" signature="NoiseAdaptiveLayout(*args, **kwargs)" modifiers="class">
  ...
  **Raises**
  ...
  <span id="noiseadaptivelayout-is-analysis-pass" />
  ...
  <span id="noiseadaptivelayout-is-transformation-pass" />
  ...
  <span id="noiseadaptivelayout-name" />
  ...
  <span id="noiseadaptivelayout-run" />
