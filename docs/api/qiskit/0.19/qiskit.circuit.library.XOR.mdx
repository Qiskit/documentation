...
<Class id="qiskit.circuit.library.XOR" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.14/qiskit/circuit/library/boolean_logic/quantum_xor.py" signature="XOR(num_qubits, amount=None, seed=None)">
  ...
  **Reference Circuit:**
  ...
  <Attribute id="qiskit.circuit.library.XOR.extension_lib" signature="= 'include \&#x22;qelib1.inc\&#x22;;'" />

  ### header

  <Attribute id="qiskit.circuit.library.XOR.header" signature="= 'OPENQASM 2.0;'" />

  ### instances

  <Attribute id="qiskit.circuit.library.XOR.instances" signature="= 8" />

  ### n\_qubits

  <Attribute id="qiskit.circuit.library.XOR.n_qubits" name="n_qubits">
  ...
  <Attribute id="qiskit.circuit.library.XOR.prefix" signature="= 'circuit'" />
  ...
  <Function id="qiskit.circuit.library.XOR.AND" name="AND" signature="XOR.AND(qr_variables, qb_target, qr_ancillae, flags=None, mct_mode='no-ancilla')">
  ...
  <Function id="qiskit.circuit.library.XOR.OR" name="OR" signature="XOR.OR(qr_variables, qb_target, qr_ancillae, flags=None, mct_mode='basic')">
  ...
  <Function id="qiskit.circuit.library.XOR.__getitem__" name="__getitem__" signature="XOR.__getitem__(item)">
    Return indexed operation.
  </Function>

  ### \_\_len\_\_

  <Function id="qiskit.circuit.library.XOR.__len__" name="__len__" signature="XOR.__len__()">
    Return number of operations in circuit.
  </Function>

  ### add\_register

  <Function id="qiskit.circuit.library.XOR.add_register" name="add_register" signature="XOR.add_register(*regs)">
    Add registers.
  </Function>

  ### append

  <Function id="qiskit.circuit.library.XOR.append" name="append" signature="XOR.append(instruction, qargs=None, cargs=None)">
  ...
  <Function id="qiskit.circuit.library.XOR.assign_parameters" name="assign_parameters" signature="XOR.assign_parameters(param_dict, inplace=False)">
  ...
  <Function id="qiskit.circuit.library.XOR.barrier" name="barrier" signature="XOR.barrier(*qargs)">
    Apply `Barrier`. If qargs is None, applies to all.
  </Function>

  ### bind\_parameters

  <Function id="qiskit.circuit.library.XOR.bind_parameters" name="bind_parameters" signature="XOR.bind_parameters(value_dict)">
  ...
  <Function id="qiskit.circuit.library.XOR.cast" name="cast" signature="static XOR.cast(value, _type)">
    Best effort to cast value to type. Otherwise, returns the value.
  </Function>

  ### cbit\_argument\_conversion

  <Function id="qiskit.circuit.library.XOR.cbit_argument_conversion" name="cbit_argument_conversion" signature="XOR.cbit_argument_conversion(clbit_representation)">
  ...
  <Function id="qiskit.circuit.library.XOR.ccx" name="ccx" signature="XOR.ccx(control_qubit1, control_qubit2, target_qubit, *, ctl1=None, ctl2=None, tgt=None)">
    Apply [`CCXGate`](qiskit.circuit.library.CCXGate "qiskit.circuit.library.CCXGate").
  </Function>

  ### ch

  <Function id="qiskit.circuit.library.XOR.ch" name="ch" signature="XOR.ch(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CHGate`](qiskit.circuit.library.CHGate "qiskit.circuit.library.CHGate").
  </Function>

  ### cls\_instances

  <Function id="qiskit.circuit.library.XOR.cls_instances" name="cls_instances" signature="classmethod XOR.cls_instances()">
    Return the current number of instances of this class, useful for auto naming.
  </Function>

  ### cls\_prefix

  <Function id="qiskit.circuit.library.XOR.cls_prefix" name="cls_prefix" signature="classmethod XOR.cls_prefix()">
    Return the prefix to use for auto naming.
  </Function>

  ### cnot

  <Function id="qiskit.circuit.library.XOR.cnot" name="cnot" signature="XOR.cnot(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CXGate`](qiskit.circuit.library.CXGate "qiskit.circuit.library.CXGate").
  </Function>

  ### combine

  <Function id="qiskit.circuit.library.XOR.combine" name="combine" signature="XOR.combine(rhs)">
  ...
  <Function id="qiskit.circuit.library.XOR.compose" name="compose" signature="XOR.compose(other, qubits=None, clbits=None, front=False, inplace=False)">
  ...
  <Function id="qiskit.circuit.library.XOR.copy" name="copy" signature="XOR.copy(name=None)">
    Copy the circuit.
  ...
  <Function id="qiskit.circuit.library.XOR.count_ops" name="count_ops" signature="XOR.count_ops()">
  ...
  <Function id="qiskit.circuit.library.XOR.crx" name="crx" signature="XOR.crx(theta, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CRXGate`](qiskit.circuit.library.CRXGate "qiskit.circuit.library.CRXGate").
  </Function>

  ### cry

  <Function id="qiskit.circuit.library.XOR.cry" name="cry" signature="XOR.cry(theta, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CRYGate`](qiskit.circuit.library.CRYGate "qiskit.circuit.library.CRYGate").
  </Function>

  ### crz

  <Function id="qiskit.circuit.library.XOR.crz" name="crz" signature="XOR.crz(theta, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CRZGate`](qiskit.circuit.library.CRZGate "qiskit.circuit.library.CRZGate").
  </Function>

  ### cswap

  <Function id="qiskit.circuit.library.XOR.cswap" name="cswap" signature="XOR.cswap(control_qubit, target_qubit1, target_qubit2, *, label=None, ctrl_state=None, ctl=None, tgt1=None, tgt2=None)">
    Apply [`CSwapGate`](qiskit.circuit.library.CSwapGate "qiskit.circuit.library.CSwapGate").
  </Function>

  ### cu1

  <Function id="qiskit.circuit.library.XOR.cu1" name="cu1" signature="XOR.cu1(theta, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CU1Gate`](qiskit.circuit.library.CU1Gate "qiskit.circuit.library.CU1Gate").
  </Function>

  ### cu3

  <Function id="qiskit.circuit.library.XOR.cu3" name="cu3" signature="XOR.cu3(theta, phi, lam, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CU3Gate`](qiskit.circuit.library.CU3Gate "qiskit.circuit.library.CU3Gate").
  </Function>

  ### cx

  <Function id="qiskit.circuit.library.XOR.cx" name="cx" signature="XOR.cx(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CXGate`](qiskit.circuit.library.CXGate "qiskit.circuit.library.CXGate").
  </Function>

  ### cy

  <Function id="qiskit.circuit.library.XOR.cy" name="cy" signature="XOR.cy(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CYGate`](qiskit.circuit.library.CYGate "qiskit.circuit.library.CYGate").
  </Function>

  ### cz

  <Function id="qiskit.circuit.library.XOR.cz" name="cz" signature="XOR.cz(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CZGate`](qiskit.circuit.library.CZGate "qiskit.circuit.library.CZGate").
  </Function>

  ### dcx

  <Function id="qiskit.circuit.library.XOR.dcx" name="dcx" signature="XOR.dcx(qubit1, qubit2)">
    Apply [`DCXGate`](qiskit.circuit.library.DCXGate "qiskit.circuit.library.DCXGate").
  </Function>

  ### decompose

  <Function id="qiskit.circuit.library.XOR.decompose" name="decompose" signature="XOR.decompose()">
  ...
  <Function id="qiskit.circuit.library.XOR.depth" name="depth" signature="XOR.depth()">
  ...
  <Function id="qiskit.circuit.library.XOR.diag_gate" name="diag_gate" signature="XOR.diag_gate(diag, qubit)">
    Deprecated version of QuantumCircuit.diagonal.
  </Function>

  ### diagonal

  <Function id="qiskit.circuit.library.XOR.diagonal" name="diagonal" signature="XOR.diagonal(diag, qubit)">
  ...
  <Function id="qiskit.circuit.library.XOR.extend" name="extend" signature="XOR.extend(rhs)">
  ...
  <Function id="qiskit.circuit.library.XOR.fredkin" name="fredkin" signature="XOR.fredkin(control_qubit, target_qubit1, target_qubit2, *, ctl=None, tgt1=None, tgt2=None)">
    Apply [`CSwapGate`](qiskit.circuit.library.CSwapGate "qiskit.circuit.library.CSwapGate").
  </Function>

  ### from\_qasm\_file

  <Function id="qiskit.circuit.library.XOR.from_qasm_file" name="from_qasm_file" signature="static XOR.from_qasm_file(path)">
  ...
  <Function id="qiskit.circuit.library.XOR.from_qasm_str" name="from_qasm_str" signature="static XOR.from_qasm_str(qasm_str)">
  ...
  <Function id="qiskit.circuit.library.XOR.h" name="h" signature="XOR.h(qubit, *, q=None)">
    Apply [`HGate`](qiskit.circuit.library.HGate "qiskit.circuit.library.HGate").
  </Function>

  ### hamiltonian

  <Function id="qiskit.circuit.library.XOR.hamiltonian" name="hamiltonian" signature="XOR.hamiltonian(operator, time, qubits, label=None)">
    Apply hamiltonian evolution to to qubits.
  </Function>

  ### has\_register

  <Function id="qiskit.circuit.library.XOR.has_register" name="has_register" signature="XOR.has_register(register)">
  ...
  <Function id="qiskit.circuit.library.XOR.i" name="i" signature="XOR.i(qubit, *, q=None)">
    Apply [`IGate`](qiskit.circuit.library.IGate "qiskit.circuit.library.IGate").
  </Function>

  ### id

  <Function id="qiskit.circuit.library.XOR.id" name="id" signature="XOR.id(qubit, *, q=None)">
    Apply [`IGate`](qiskit.circuit.library.IGate "qiskit.circuit.library.IGate").
  </Function>

  ### iden

  <Function id="qiskit.circuit.library.XOR.iden" name="iden" signature="XOR.iden(qubit, *, q=None)">
    Deprecated identity gate.
  </Function>

  ### initialize

  <Function id="qiskit.circuit.library.XOR.initialize" name="initialize" signature="XOR.initialize(params, qubits)">
    Apply initialize to circuit.
  </Function>

  ### inverse

  <Function id="qiskit.circuit.library.XOR.inverse" name="inverse" signature="XOR.inverse()">
    Invert this circuit.
  ...
  <Function id="qiskit.circuit.library.XOR.iso" name="iso" signature="XOR.iso(isometry, q_input, q_ancillas_for_output, q_ancillas_zero=None, q_ancillas_dirty=None)">
  ...
  <Function id="qiskit.circuit.library.XOR.isometry" name="isometry" signature="XOR.isometry(isometry, q_input, q_ancillas_for_output, q_ancillas_zero=None, q_ancillas_dirty=None)">
    Attach an arbitrary isometry from m to n qubits to a circuit. In particular, this allows to attach arbitrary unitaries on n qubits (m=n) or to prepare any state on n qubits (m=0). The decomposition used here was introduced by Iten et al. in [https://arxiv.org/abs/1501.06911](https://arxiv.org/abs/1501.06911).
  ...
  <Function id="qiskit.circuit.library.XOR.iswap" name="iswap" signature="XOR.iswap(qubit1, qubit2)">
    Apply [`iSwapGate`](qiskit.circuit.library.iSwapGate "qiskit.circuit.library.iSwapGate").
  </Function>

  ### mcmt

  <Function id="qiskit.circuit.library.XOR.mcmt" name="mcmt" signature="XOR.mcmt(gate, control_qubits, target_qubits, ancilla_qubits=None, mode='no-ancilla', *, single_control_gate_fun=None, q_controls=None, q_ancillae=None, q_targets=None)">
  ...
  <Function id="qiskit.circuit.library.XOR.mcrx" name="mcrx" signature="XOR.mcrx(theta, q_controls, q_target, use_basis_gates=False)">
  ...
  <Function id="qiskit.circuit.library.XOR.mcry" name="mcry" signature="XOR.mcry(theta, q_controls, q_target, q_ancillae, mode='basic', use_basis_gates=False)">
  ...
  <Function id="qiskit.circuit.library.XOR.mcrz" name="mcrz" signature="XOR.mcrz(lam, q_controls, q_target, use_basis_gates=False)">
  ...
  <Function id="qiskit.circuit.library.XOR.mct" name="mct" signature="XOR.mct(control_qubits, target_qubit, ancilla_qubits=None, mode='noancilla')">
    Apply `MCXGate`.
  </Function>

  ### mcu1

  <Function id="qiskit.circuit.library.XOR.mcu1" name="mcu1" signature="XOR.mcu1(lam, control_qubits, target_qubit)">
    Apply `MCU1Gate`.
  </Function>

  ### mcx

  <Function id="qiskit.circuit.library.XOR.mcx" name="mcx" signature="XOR.mcx(control_qubits, target_qubit, ancilla_qubits=None, mode='noancilla')">
    Apply `MCXGate`.
  ...
  <Function id="qiskit.circuit.library.XOR.measure" name="measure" signature="XOR.measure(qubit, cbit)">
  ...
  <Function id="qiskit.circuit.library.XOR.measure_active" name="measure_active" signature="XOR.measure_active(inplace=True)">
  ...
  <Function id="qiskit.circuit.library.XOR.measure_all" name="measure_all" signature="XOR.measure_all(inplace=True)">
  ...
  <Function id="qiskit.circuit.library.XOR.mirror" name="mirror" signature="XOR.mirror()">
  ...
  <Function id="qiskit.circuit.library.XOR.ms" name="ms" signature="XOR.ms(theta, qubits)">
    Apply [`MSGate`](qiskit.circuit.library.MSGate "qiskit.circuit.library.MSGate").
  </Function>

  ### num\_connected\_components

  <Function id="qiskit.circuit.library.XOR.num_connected_components" name="num_connected_components" signature="XOR.num_connected_components(unitary_only=False)">
  ...
  <Function id="qiskit.circuit.library.XOR.num_nonlocal_gates" name="num_nonlocal_gates" signature="XOR.num_nonlocal_gates()">
  ...
  <Function id="qiskit.circuit.library.XOR.num_tensor_factors" name="num_tensor_factors" signature="XOR.num_tensor_factors()">
  ...
  <Function id="qiskit.circuit.library.XOR.num_unitary_factors" name="num_unitary_factors" signature="XOR.num_unitary_factors()">
    Computes the number of tensor factors in the unitary (quantum) part of the circuit only.
  </Function>

  ### qasm

  <Function id="qiskit.circuit.library.XOR.qasm" name="qasm" signature="XOR.qasm(formatted=False, filename=None)">
  ...
  <Function id="qiskit.circuit.library.XOR.qbit_argument_conversion" name="qbit_argument_conversion" signature="XOR.qbit_argument_conversion(qubit_representation)">
  ...
  <Function id="qiskit.circuit.library.XOR.r" name="r" signature="XOR.r(theta, phi, qubit, *, q=None)">
    Apply `RGate`.
  </Function>

  ### rcccx

  <Function id="qiskit.circuit.library.XOR.rcccx" name="rcccx" signature="XOR.rcccx(control_qubit1, control_qubit2, control_qubit3, target_qubit)">
    Apply [`RC3XGate`](qiskit.circuit.library.RC3XGate "qiskit.circuit.library.RC3XGate").
  </Function>

  ### rccx

  <Function id="qiskit.circuit.library.XOR.rccx" name="rccx" signature="XOR.rccx(control_qubit1, control_qubit2, target_qubit)">
    Apply [`RCCXGate`](qiskit.circuit.library.RCCXGate "qiskit.circuit.library.RCCXGate").
  </Function>

  ### remove\_final\_measurements

  <Function id="qiskit.circuit.library.XOR.remove_final_measurements" name="remove_final_measurements" signature="XOR.remove_final_measurements(inplace=True)">
  ...
  <Function id="qiskit.circuit.library.XOR.reset" name="reset" signature="XOR.reset(qubit)">
    Reset q.
  </Function>

  ### rx

  <Function id="qiskit.circuit.library.XOR.rx" name="rx" signature="XOR.rx(theta, qubit, *, label=None, q=None)">
    Apply [`RXGate`](qiskit.circuit.library.RXGate "qiskit.circuit.library.RXGate").
  </Function>

  ### rxx

  <Function id="qiskit.circuit.library.XOR.rxx" name="rxx" signature="XOR.rxx(theta, qubit1, qubit2)">
    Apply [`RXXGate`](qiskit.circuit.library.RXXGate "qiskit.circuit.library.RXXGate").
  </Function>

  ### ry

  <Function id="qiskit.circuit.library.XOR.ry" name="ry" signature="XOR.ry(theta, qubit, *, label=None, q=None)">
    Apply [`RYGate`](qiskit.circuit.library.RYGate "qiskit.circuit.library.RYGate").
  </Function>

  ### ryy

  <Function id="qiskit.circuit.library.XOR.ryy" name="ryy" signature="XOR.ryy(theta, qubit1, qubit2)">
    Apply [`RYYGate`](qiskit.circuit.library.RYYGate "qiskit.circuit.library.RYYGate").
  </Function>

  ### rz

  <Function id="qiskit.circuit.library.XOR.rz" name="rz" signature="XOR.rz(phi, qubit, *, q=None)">
    Apply [`RZGate`](qiskit.circuit.library.RZGate "qiskit.circuit.library.RZGate").
  </Function>

  ### rzx

  <Function id="qiskit.circuit.library.XOR.rzx" name="rzx" signature="XOR.rzx(theta, qubit1, qubit2)">
    Apply [`RZXGate`](qiskit.circuit.library.RZXGate "qiskit.circuit.library.RZXGate").
  </Function>

  ### rzz

  <Function id="qiskit.circuit.library.XOR.rzz" name="rzz" signature="XOR.rzz(theta, qubit1, qubit2)">
    Apply [`RZZGate`](qiskit.circuit.library.RZZGate "qiskit.circuit.library.RZZGate").
  </Function>

  ### s

  <Function id="qiskit.circuit.library.XOR.s" name="s" signature="XOR.s(qubit, *, q=None)">
    Apply [`SGate`](qiskit.circuit.library.SGate "qiskit.circuit.library.SGate").
  </Function>

  ### sdg

  <Function id="qiskit.circuit.library.XOR.sdg" name="sdg" signature="XOR.sdg(qubit, *, q=None)">
    Apply [`SdgGate`](qiskit.circuit.library.SdgGate "qiskit.circuit.library.SdgGate").
  </Function>

  ### size

  <Function id="qiskit.circuit.library.XOR.size" name="size" signature="XOR.size()">
  ...
  <Function id="qiskit.circuit.library.XOR.snapshot" name="snapshot" signature="XOR.snapshot(label, snapshot_type='statevector', qubits=None, params=None)">
  ...
  <Function id="qiskit.circuit.library.XOR.snapshot_density_matrix" name="snapshot_density_matrix" signature="XOR.snapshot_density_matrix(label, qubits=None)">
  ...
  <Function id="qiskit.circuit.library.XOR.snapshot_expectation_value" name="snapshot_expectation_value" signature="XOR.snapshot_expectation_value(label, op, qubits, single_shot=False, variance=False)">
  ...
  <Function id="qiskit.circuit.library.XOR.snapshot_probabilities" name="snapshot_probabilities" signature="XOR.snapshot_probabilities(label, qubits, variance=False)">
  ...
  <Function id="qiskit.circuit.library.XOR.snapshot_stabilizer" name="snapshot_stabilizer" signature="XOR.snapshot_stabilizer(label)">
  ...
  <Function id="qiskit.circuit.library.XOR.snapshot_statevector" name="snapshot_statevector" signature="XOR.snapshot_statevector(label)">
  ...
  <Function id="qiskit.circuit.library.XOR.squ" name="squ" signature="XOR.squ(unitary_matrix, qubit, mode='ZYZ', up_to_diagonal=False, *, u=None)">
  ...
  <Function id="qiskit.circuit.library.XOR.swap" name="swap" signature="XOR.swap(qubit1, qubit2)">
    Apply [`SwapGate`](qiskit.circuit.library.SwapGate "qiskit.circuit.library.SwapGate").
  </Function>

  ### t

  <Function id="qiskit.circuit.library.XOR.t" name="t" signature="XOR.t(qubit, *, q=None)">
    Apply [`TGate`](qiskit.circuit.library.TGate "qiskit.circuit.library.TGate").
  </Function>

  ### tdg

  <Function id="qiskit.circuit.library.XOR.tdg" name="tdg" signature="XOR.tdg(qubit, *, q=None)">
    Apply [`TdgGate`](qiskit.circuit.library.TdgGate "qiskit.circuit.library.TdgGate").
  </Function>

  ### to\_gate

  <Function id="qiskit.circuit.library.XOR.to_gate" name="to_gate" signature="XOR.to_gate(parameter_map=None)">
  ...
  <Function id="qiskit.circuit.library.XOR.to_instruction" name="to_instruction" signature="XOR.to_instruction(parameter_map=None)">
  ...
  <Function id="qiskit.circuit.library.XOR.toffoli" name="toffoli" signature="XOR.toffoli(control_qubit1, control_qubit2, target_qubit, *, ctl1=None, ctl2=None, tgt=None)">
    Apply [`CCXGate`](qiskit.circuit.library.CCXGate "qiskit.circuit.library.CCXGate").
  </Function>

  ### u1

  <Function id="qiskit.circuit.library.XOR.u1" name="u1" signature="XOR.u1(theta, qubit, *, q=None)">
    Apply [`U1Gate`](qiskit.circuit.library.U1Gate "qiskit.circuit.library.U1Gate").
  </Function>

  ### u2

  <Function id="qiskit.circuit.library.XOR.u2" name="u2" signature="XOR.u2(phi, lam, qubit, *, q=None)">
    Apply [`U2Gate`](qiskit.circuit.library.U2Gate "qiskit.circuit.library.U2Gate").
  </Function>

  ### u3

  <Function id="qiskit.circuit.library.XOR.u3" name="u3" signature="XOR.u3(theta, phi, lam, qubit, *, q=None)">
    Apply [`U3Gate`](qiskit.circuit.library.U3Gate "qiskit.circuit.library.U3Gate").
  </Function>

  ### uc

  <Function id="qiskit.circuit.library.XOR.uc" name="uc" signature="XOR.uc(gate_list, q_controls, q_target, up_to_diagonal=False)">
  ...
  <Function id="qiskit.circuit.library.XOR.ucg" name="ucg" signature="XOR.ucg(angle_list, q_controls, q_target, up_to_diagonal=False)">
    Deprecated version of uc.
  </Function>

  ### ucrx

  <Function id="qiskit.circuit.library.XOR.ucrx" name="ucrx" signature="XOR.ucrx(angle_list, q_controls, q_target)">
  ...
  <Function id="qiskit.circuit.library.XOR.ucry" name="ucry" signature="XOR.ucry(angle_list, q_controls, q_target)">
  ...
  <Function id="qiskit.circuit.library.XOR.ucrz" name="ucrz" signature="XOR.ucrz(angle_list, q_controls, q_target)">
  ...
  <Function id="qiskit.circuit.library.XOR.ucx" name="ucx" signature="XOR.ucx(angle_list, q_controls, q_target)">
    Deprecated version of ucrx.
  </Function>

  ### ucy

  <Function id="qiskit.circuit.library.XOR.ucy" name="ucy" signature="XOR.ucy(angle_list, q_controls, q_target)">
    Deprecated version of ucry.
  </Function>

  ### ucz

  <Function id="qiskit.circuit.library.XOR.ucz" name="ucz" signature="XOR.ucz(angle_list, q_controls, q_target)">
    Deprecated version of ucrz.
  </Function>

  ### unitary

  <Function id="qiskit.circuit.library.XOR.unitary" name="unitary" signature="XOR.unitary(obj, qubits, label=None)">
    Apply unitary gate to q.
  </Function>

  ### width

  <Function id="qiskit.circuit.library.XOR.width" name="width" signature="XOR.width()">
  ...
  <Function id="qiskit.circuit.library.XOR.x" name="x" signature="XOR.x(qubit, *, label=None, ctrl_state=None, q=None)">
    Apply [`XGate`](qiskit.circuit.library.XGate "qiskit.circuit.library.XGate").
  </Function>

  ### y

  <Function id="qiskit.circuit.library.XOR.y" name="y" signature="XOR.y(qubit, *, q=None)">
    Apply [`YGate`](qiskit.circuit.library.YGate "qiskit.circuit.library.YGate").
  </Function>

  ### z

  <Function id="qiskit.circuit.library.XOR.z" name="z" signature="XOR.z(qubit, *, q=None)">
