...
`XOR(num_qubits, amount=None, seed=None)` [GitHub](https://github.com/qiskit/qiskit/tree/stable/0.14/qiskit/circuit/library/boolean_logic/quantum_xor.py "view source code")
...
`XOR.append(instruction, qargs=None, cargs=None)`
...
`XOR.cnot(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)`
...
`XOR.crz(theta, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)`
...
`XOR.cswap(control_qubit, target_qubit1, target_qubit2, *, label=None, ctrl_state=None, ctl=None, tgt1=None, tgt2=None)`
...
`XOR.cu1(theta, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)`
...
`XOR.cu3(theta, phi, lam, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)`
...
`XOR.cx(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)`
...
`XOR.cy(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)`
...
`static XOR.from_qasm_str(qasm_str)`
...
`XOR.measure_active(inplace=True)`
...
<span id="qiskit.circuit.library.XOR.mirror" />
...
`XOR.num_connected_components(unitary_only=False)`
...
`XOR.qasm(formatted=False, filename=None)`
...
`XOR.qbit_argument_conversion(qubit_representation)`
...
`XOR.rcccx(control_qubit1, control_qubit2, control_qubit3, target_qubit)`
...
`XOR.rx(theta, qubit, *, label=None, q=None)`
...
`XOR.ry(theta, qubit, *, label=None, q=None)`
...
`XOR.snapshot_density_matrix(label, qubits=None)`
...
`XOR.snapshot_expectation_value(label, op, qubits, single_shot=False, variance=False)`
...
`XOR.squ(unitary_matrix, qubit, mode='ZYZ', up_to_diagonal=False, *, u=None)`
...
`XOR.to_gate(parameter_map=None)`
...
`XOR.u3(theta, phi, lam, qubit, *, q=None)`
...
<span id="qiskit.circuit.library.XOR.ucg" />

`XOR.ucg(angle_list, q_controls, q_target, up_to_diagonal=False)`
...
`XOR.x(qubit, *, label=None, ctrl_state=None, q=None)`
