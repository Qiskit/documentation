---
title: XOR (v0.19)
description: API reference for qiskit.circuit.library.XOR in qiskit v0.19
...
<Class id="qiskit.circuit.library.XOR" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.14/qiskit/circuit/library/boolean_logic/quantum_xor.py" signature="XOR(num_qubits, amount=None, seed=None)" modifiers="class">
  ...
  **Reference Circuit:**
  ...
  <span id="xor-instances" />

  ### instances

  <Attribute id="qiskit.circuit.library.XOR.instances" attributeValue="8" />

  <span id="xor-n-qubits" />

  ### n\_qubits

  <Attribute id="qiskit.circuit.library.XOR.n_qubits">
    Deprecated, use `num_qubits` instead. Return number of qubits.
  </Attribute>

  <span id="xor-num-clbits" />
  ...
  <Function id="qiskit.circuit.library.XOR.AND" signature="XOR.AND(qr_variables, qb_target, qr_ancillae, flags=None, mct_mode='no-ancilla')">
  ...
  <Function id="qiskit.circuit.library.XOR.OR" signature="XOR.OR(qr_variables, qb_target, qr_ancillae, flags=None, mct_mode='basic')">
  ...
  <Function id="qiskit.circuit.library.XOR.__getitem__" signature="XOR.__getitem__(item)">
  ...
  <Function id="qiskit.circuit.library.XOR.__len__" signature="XOR.__len__()">
    Return number of operations in circuit.
  </Function>

  <span id="xor-add-register" />

  ### add\_register

  <Function id="qiskit.circuit.library.XOR.add_register" signature="XOR.add_register(*regs)">
    Add registers.
  </Function>
  ...
  <Function id="qiskit.circuit.library.XOR.append" signature="XOR.append(instruction, qargs=None, cargs=None)">
  ...
  <span id="xor-assign-parameters" />

  ### assign\_parameters

  <Function id="qiskit.circuit.library.XOR.assign_parameters" signature="XOR.assign_parameters(param_dict, inplace=False)">
  ...
  <Function id="qiskit.circuit.library.XOR.barrier" signature="XOR.barrier(*qargs)">
    Apply `Barrier`. If qargs is None, applies to all.
  </Function>

  <span id="xor-bind-parameters" />

  ### bind\_parameters

  <Function id="qiskit.circuit.library.XOR.bind_parameters" signature="XOR.bind_parameters(value_dict)">
  ...
  <Function id="qiskit.circuit.library.XOR.cast" signature="XOR.cast(value, _type)" modifiers="static">
    Best effort to cast value to type. Otherwise, returns the value.
  </Function>

  <span id="xor-cbit-argument-conversion" />

  ### cbit\_argument\_conversion

  <Function id="qiskit.circuit.library.XOR.cbit_argument_conversion" signature="XOR.cbit_argument_conversion(clbit_representation)">
  ...
  <Function id="qiskit.circuit.library.XOR.ccx" signature="XOR.ccx(control_qubit1, control_qubit2, target_qubit, *, ctl1=None, ctl2=None, tgt=None)">
  ...
  <Function id="qiskit.circuit.library.XOR.ch" signature="XOR.ch(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CHGate`](qiskit.circuit.library.CHGate "qiskit.circuit.library.CHGate").
  </Function>

  <span id="xor-cls-instances" />

  ### cls\_instances

  <Function id="qiskit.circuit.library.XOR.cls_instances" signature="XOR.cls_instances()" modifiers="classmethod">
    Return the current number of instances of this class, useful for auto naming.
  </Function>

  <span id="xor-cls-prefix" />

  ### cls\_prefix

  <Function id="qiskit.circuit.library.XOR.cls_prefix" signature="XOR.cls_prefix()" modifiers="classmethod">
  ...
  <Function id="qiskit.circuit.library.XOR.cnot" signature="XOR.cnot(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
  ...
  <Function id="qiskit.circuit.library.XOR.combine" signature="XOR.combine(rhs)">
  ...
  <Function id="qiskit.circuit.library.XOR.compose" signature="XOR.compose(other, qubits=None, clbits=None, front=False, inplace=False)">
  ...
  <Function id="qiskit.circuit.library.XOR.copy" signature="XOR.copy(name=None)">
    Copy the circuit.
  ...
  <span id="xor-count-ops" />

  ### count\_ops

  <Function id="qiskit.circuit.library.XOR.count_ops" signature="XOR.count_ops()">
  ...
  <Function id="qiskit.circuit.library.XOR.crx" signature="XOR.crx(theta, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
  ...
  <Function id="qiskit.circuit.library.XOR.cry" signature="XOR.cry(theta, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
  ...
  <Function id="qiskit.circuit.library.XOR.crz" signature="XOR.crz(theta, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
  ...
  <Function id="qiskit.circuit.library.XOR.cswap" signature="XOR.cswap(control_qubit, target_qubit1, target_qubit2, *, label=None, ctrl_state=None, ctl=None, tgt1=None, tgt2=None)">
  ...
  <Function id="qiskit.circuit.library.XOR.cu1" signature="XOR.cu1(theta, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
  ...
  <Function id="qiskit.circuit.library.XOR.cu3" signature="XOR.cu3(theta, phi, lam, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
  ...
  <Function id="qiskit.circuit.library.XOR.cx" signature="XOR.cx(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CXGate`](qiskit.circuit.library.CXGate "qiskit.circuit.library.CXGate").
  </Function>
  ...
  <Function id="qiskit.circuit.library.XOR.cy" signature="XOR.cy(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
  ...
  <Function id="qiskit.circuit.library.XOR.cz" signature="XOR.cz(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
  ...
  <Function id="qiskit.circuit.library.XOR.dcx" signature="XOR.dcx(qubit1, qubit2)">
    Apply [`DCXGate`](qiskit.circuit.library.DCXGate "qiskit.circuit.library.DCXGate").
  </Function>

  <span id="xor-decompose" />

  ### decompose

  <Function id="qiskit.circuit.library.XOR.decompose" signature="XOR.decompose()">
  ...
  <Function id="qiskit.circuit.library.XOR.depth" signature="XOR.depth()">
  ...
  <span id="xor-diag-gate" />

  ### diag\_gate

  <Function id="qiskit.circuit.library.XOR.diag_gate" signature="XOR.diag_gate(diag, qubit)">
    Deprecated version of QuantumCircuit.diagonal.
  </Function>

  <span id="xor-diagonal" />

  ### diagonal

  <Function id="qiskit.circuit.library.XOR.diagonal" signature="XOR.diagonal(diag, qubit)">
  ...
  <Function id="qiskit.circuit.library.XOR.extend" signature="XOR.extend(rhs)">
  ...
  <Function id="qiskit.circuit.library.XOR.fredkin" signature="XOR.fredkin(control_qubit, target_qubit1, target_qubit2, *, ctl=None, tgt1=None, tgt2=None)">
    Apply [`CSwapGate`](qiskit.circuit.library.CSwapGate "qiskit.circuit.library.CSwapGate").
  </Function>

  <span id="xor-from-qasm-file" />

  ### from\_qasm\_file

  <Function id="qiskit.circuit.library.XOR.from_qasm_file" signature="XOR.from_qasm_file(path)" modifiers="static">
  ...
  <span id="xor-from-qasm-str" />

  ### from\_qasm\_str

  <Function id="qiskit.circuit.library.XOR.from_qasm_str" signature="XOR.from_qasm_str(qasm_str)" modifiers="static">
  ...
  <Function id="qiskit.circuit.library.XOR.h" signature="XOR.h(qubit, *, q=None)">
    Apply [`HGate`](qiskit.circuit.library.HGate "qiskit.circuit.library.HGate").
  </Function>

  <span id="xor-hamiltonian" />

  ### hamiltonian

  <Function id="qiskit.circuit.library.XOR.hamiltonian" signature="XOR.hamiltonian(operator, time, qubits, label=None)">
    Apply hamiltonian evolution to to qubits.
  </Function>

  <span id="xor-has-register" />

  ### has\_register

  <Function id="qiskit.circuit.library.XOR.has_register" signature="XOR.has_register(register)">
  ...
  <Function id="qiskit.circuit.library.XOR.i" signature="XOR.i(qubit, *, q=None)">
  ...
  <Function id="qiskit.circuit.library.XOR.id" signature="XOR.id(qubit, *, q=None)">
    Apply [`IGate`](qiskit.circuit.library.IGate "qiskit.circuit.library.IGate").
  </Function>
  ...
  <Function id="qiskit.circuit.library.XOR.iden" signature="XOR.iden(qubit, *, q=None)">
    Deprecated identity gate.
  </Function>

  <span id="xor-initialize" />

  ### initialize

  <Function id="qiskit.circuit.library.XOR.initialize" signature="XOR.initialize(params, qubits)">
  ...
  <Function id="qiskit.circuit.library.XOR.inverse" signature="XOR.inverse()">
    Invert this circuit.
  ...
  <Function id="qiskit.circuit.library.XOR.iso" signature="XOR.iso(isometry, q_input, q_ancillas_for_output, q_ancillas_zero=None, q_ancillas_dirty=None)">
  ...
  <span id="xor-isometry" />

  ### isometry

  <Function id="qiskit.circuit.library.XOR.isometry" signature="XOR.isometry(isometry, q_input, q_ancillas_for_output, q_ancillas_zero=None, q_ancillas_dirty=None)">
    Attach an arbitrary isometry from m to n qubits to a circuit. In particular, this allows to attach arbitrary unitaries on n qubits (m=n) or to prepare any state on n qubits (m=0). The decomposition used here was introduced by Iten et al. in [https://arxiv.org/abs/1501.06911](https://arxiv.org/abs/1501.06911).
  ...
  <Function id="qiskit.circuit.library.XOR.iswap" signature="XOR.iswap(qubit1, qubit2)">
  ...
  <Function id="qiskit.circuit.library.XOR.mcmt" signature="XOR.mcmt(gate, control_qubits, target_qubits, ancilla_qubits=None, mode='no-ancilla', *, single_control_gate_fun=None, q_controls=None, q_ancillae=None, q_targets=None)">
  ...
  <Function id="qiskit.circuit.library.XOR.mcrx" signature="XOR.mcrx(theta, q_controls, q_target, use_basis_gates=False)">
  ...
  <Function id="qiskit.circuit.library.XOR.mcry" signature="XOR.mcry(theta, q_controls, q_target, q_ancillae, mode='basic', use_basis_gates=False)">
  ...
  <Function id="qiskit.circuit.library.XOR.mcrz" signature="XOR.mcrz(lam, q_controls, q_target, use_basis_gates=False)">
  ...
  <Function id="qiskit.circuit.library.XOR.mct" signature="XOR.mct(control_qubits, target_qubit, ancilla_qubits=None, mode='noancilla')">
    Apply `MCXGate`.
  </Function>
  ...
  <Function id="qiskit.circuit.library.XOR.mcu1" signature="XOR.mcu1(lam, control_qubits, target_qubit)">
    Apply `MCU1Gate`.
  </Function>
  ...
  <Function id="qiskit.circuit.library.XOR.mcx" signature="XOR.mcx(control_qubits, target_qubit, ancilla_qubits=None, mode='noancilla')">
    Apply `MCXGate`.
  ...
  <Function id="qiskit.circuit.library.XOR.measure" signature="XOR.measure(qubit, cbit)">
  ...
  <span id="xor-measure-active" />

  ### measure\_active

  <Function id="qiskit.circuit.library.XOR.measure_active" signature="XOR.measure_active(inplace=True)">
  ...
  <span id="xor-measure-all" />

  ### measure\_all

  <Function id="qiskit.circuit.library.XOR.measure_all" signature="XOR.measure_all(inplace=True)">
  ...
  <Function id="qiskit.circuit.library.XOR.mirror" signature="XOR.mirror()">
  ...
  <Function id="qiskit.circuit.library.XOR.ms" signature="XOR.ms(theta, qubits)">
    Apply [`MSGate`](qiskit.circuit.library.MSGate "qiskit.circuit.library.MSGate").
  </Function>

  <span id="xor-num-connected-components" />

  ### num\_connected\_components

  <Function id="qiskit.circuit.library.XOR.num_connected_components" signature="XOR.num_connected_components(unitary_only=False)">
  ...
  <span id="xor-num-nonlocal-gates" />

  ### num\_nonlocal\_gates

  <Function id="qiskit.circuit.library.XOR.num_nonlocal_gates" signature="XOR.num_nonlocal_gates()">
    Return number of non-local gates (i.e. involving 2+ qubits).

    Conditional nonlocal gates are also included.
  </Function>

  <span id="xor-num-tensor-factors" />

  ### num\_tensor\_factors

  <Function id="qiskit.circuit.library.XOR.num_tensor_factors" signature="XOR.num_tensor_factors()">
  ...
  <span id="xor-num-unitary-factors" />

  ### num\_unitary\_factors

  <Function id="qiskit.circuit.library.XOR.num_unitary_factors" signature="XOR.num_unitary_factors()">
    Computes the number of tensor factors in the unitary (quantum) part of the circuit only.
  </Function>
  ...
  <Function id="qiskit.circuit.library.XOR.qasm" signature="XOR.qasm(formatted=False, filename=None)">
  ...
  <span id="xor-qbit-argument-conversion" />

  ### qbit\_argument\_conversion

  <Function id="qiskit.circuit.library.XOR.qbit_argument_conversion" signature="XOR.qbit_argument_conversion(qubit_representation)">
  ...
  <Function id="qiskit.circuit.library.XOR.r" signature="XOR.r(theta, phi, qubit, *, q=None)">
    Apply `RGate`.
  </Function>
  ...
  <Function id="qiskit.circuit.library.XOR.rcccx" signature="XOR.rcccx(control_qubit1, control_qubit2, control_qubit3, target_qubit)">
  ...
  <Function id="qiskit.circuit.library.XOR.rccx" signature="XOR.rccx(control_qubit1, control_qubit2, target_qubit)">
    Apply [`RCCXGate`](qiskit.circuit.library.RCCXGate "qiskit.circuit.library.RCCXGate").
  </Function>

  <span id="xor-remove-final-measurements" />

  ### remove\_final\_measurements

  <Function id="qiskit.circuit.library.XOR.remove_final_measurements" signature="XOR.remove_final_measurements(inplace=True)">
  ...
  <Function id="qiskit.circuit.library.XOR.reset" signature="XOR.reset(qubit)">
    Reset q.
  </Function>
  ...
  <Function id="qiskit.circuit.library.XOR.rx" signature="XOR.rx(theta, qubit, *, label=None, q=None)">
  ...
  <Function id="qiskit.circuit.library.XOR.rxx" signature="XOR.rxx(theta, qubit1, qubit2)">
  ...
  <Function id="qiskit.circuit.library.XOR.ry" signature="XOR.ry(theta, qubit, *, label=None, q=None)">
  ...
  <Function id="qiskit.circuit.library.XOR.ryy" signature="XOR.ryy(theta, qubit1, qubit2)">
  ...
  <Function id="qiskit.circuit.library.XOR.rz" signature="XOR.rz(phi, qubit, *, q=None)">
  ...
  <Function id="qiskit.circuit.library.XOR.rzx" signature="XOR.rzx(theta, qubit1, qubit2)">
  ...
  <Function id="qiskit.circuit.library.XOR.rzz" signature="XOR.rzz(theta, qubit1, qubit2)">
  ...
  <Function id="qiskit.circuit.library.XOR.s" signature="XOR.s(qubit, *, q=None)">
  ...
  <Function id="qiskit.circuit.library.XOR.sdg" signature="XOR.sdg(qubit, *, q=None)">
  ...
  <Function id="qiskit.circuit.library.XOR.size" signature="XOR.size()">
  ...
  <span id="xor-snapshot" />

  ### snapshot

  <Function id="qiskit.circuit.library.XOR.snapshot" signature="XOR.snapshot(label, snapshot_type='statevector', qubits=None, params=None)">
  ...
  <span id="xor-snapshot-density-matrix" />

  ### snapshot\_density\_matrix

  <Function id="qiskit.circuit.library.XOR.snapshot_density_matrix" signature="XOR.snapshot_density_matrix(label, qubits=None)">
  ...
  <span id="xor-snapshot-expectation-value" />

  ### snapshot\_expectation\_value

  <Function id="qiskit.circuit.library.XOR.snapshot_expectation_value" signature="XOR.snapshot_expectation_value(label, op, qubits, single_shot=False, variance=False)">
  ...
  <span id="xor-snapshot-probabilities" />

  ### snapshot\_probabilities

  <Function id="qiskit.circuit.library.XOR.snapshot_probabilities" signature="XOR.snapshot_probabilities(label, qubits, variance=False)">
  ...
  <span id="xor-snapshot-stabilizer" />

  ### snapshot\_stabilizer

  <Function id="qiskit.circuit.library.XOR.snapshot_stabilizer" signature="XOR.snapshot_stabilizer(label)">
  ...
  <span id="xor-snapshot-statevector" />

  ### snapshot\_statevector

  <Function id="qiskit.circuit.library.XOR.snapshot_statevector" signature="XOR.snapshot_statevector(label)">
  ...
  <Function id="qiskit.circuit.library.XOR.squ" signature="XOR.squ(unitary_matrix, qubit, mode='ZYZ', up_to_diagonal=False, *, u=None)">
  ...
  <Function id="qiskit.circuit.library.XOR.swap" signature="XOR.swap(qubit1, qubit2)">
  ...
  <Function id="qiskit.circuit.library.XOR.t" signature="XOR.t(qubit, *, q=None)">
  ...
  <Function id="qiskit.circuit.library.XOR.tdg" signature="XOR.tdg(qubit, *, q=None)">
  ...
  <Function id="qiskit.circuit.library.XOR.to_gate" signature="XOR.to_gate(parameter_map=None)">
  ...
  <span id="xor-to-instruction" />

  ### to\_instruction

  <Function id="qiskit.circuit.library.XOR.to_instruction" signature="XOR.to_instruction(parameter_map=None)">
  ...
  <Function id="qiskit.circuit.library.XOR.toffoli" signature="XOR.toffoli(control_qubit1, control_qubit2, target_qubit, *, ctl1=None, ctl2=None, tgt=None)">
    Apply [`CCXGate`](qiskit.circuit.library.CCXGate "qiskit.circuit.library.CCXGate").
  </Function>
  ...
  <Function id="qiskit.circuit.library.XOR.u1" signature="XOR.u1(theta, qubit, *, q=None)">
  ...
  <Function id="qiskit.circuit.library.XOR.u2" signature="XOR.u2(phi, lam, qubit, *, q=None)">
  ...
  <Function id="qiskit.circuit.library.XOR.u3" signature="XOR.u3(theta, phi, lam, qubit, *, q=None)">
  ...
  <Function id="qiskit.circuit.library.XOR.uc" signature="XOR.uc(gate_list, q_controls, q_target, up_to_diagonal=False)">
  ...
  <Function id="qiskit.circuit.library.XOR.ucg" signature="XOR.ucg(angle_list, q_controls, q_target, up_to_diagonal=False)">
  ...
  <Function id="qiskit.circuit.library.XOR.ucrx" signature="XOR.ucrx(angle_list, q_controls, q_target)">
  ...
  <Function id="qiskit.circuit.library.XOR.ucry" signature="XOR.ucry(angle_list, q_controls, q_target)">
  ...
  <Function id="qiskit.circuit.library.XOR.ucrz" signature="XOR.ucrz(angle_list, q_controls, q_target)">
  ...
  <Function id="qiskit.circuit.library.XOR.ucx" signature="XOR.ucx(angle_list, q_controls, q_target)">
  ...
  <Function id="qiskit.circuit.library.XOR.ucy" signature="XOR.ucy(angle_list, q_controls, q_target)">
  ...
  <Function id="qiskit.circuit.library.XOR.ucz" signature="XOR.ucz(angle_list, q_controls, q_target)">
  ...
  <Function id="qiskit.circuit.library.XOR.unitary" signature="XOR.unitary(obj, qubits, label=None)">
  ...
  <Function id="qiskit.circuit.library.XOR.width" signature="XOR.width()">
  ...
  <Function id="qiskit.circuit.library.XOR.x" signature="XOR.x(qubit, *, label=None, ctrl_state=None, q=None)">
  ...
  <Function id="qiskit.circuit.library.XOR.y" signature="XOR.y(qubit, *, q=None)">
  ...
  <Function id="qiskit.circuit.library.XOR.z" signature="XOR.z(qubit, *, q=None)">
