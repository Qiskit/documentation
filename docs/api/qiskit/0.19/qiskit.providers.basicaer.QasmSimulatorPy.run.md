---
title: run
description: API reference for qiskit.providers.basicaer.QasmSimulatorPy.run
in_page_toc_min_heading_level: 1
python_api_type: method
python_api_name: qiskit.providers.basicaer.QasmSimulatorPy.run
---
...
`QasmSimulatorPy.run(qobj, backend_options=None)`
