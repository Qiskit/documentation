---
title: append
description: API reference for qiskit.circuit.library.MCMT.append
in_page_toc_min_heading_level: 1
python_api_type: method
python_api_name: qiskit.circuit.library.MCMT.append
---
...
`MCMT.append(instruction, qargs=None, cargs=None)`
