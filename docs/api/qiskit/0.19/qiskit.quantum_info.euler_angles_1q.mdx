...
<Function id="qiskit.quantum_info.euler_angles_1q" github="https://github.com/qiskit/qiskit/tree/stable/0.14/qiskit/quantum_info/synthesis/two_qubit_decompose.py" signature="euler_angles_1q(unitary_matrix)">
