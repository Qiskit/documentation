...
<Class id="qiskit.optimization.problems.LinearConstraint" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.7/qiskit/optimization/problems/linear_constraint.py" signature="LinearConstraint(quadratic_program, name, linear, sense, rhs)">
  ...
  *   **rhs** (`float`) – The right-hand-side of the constraint.
  ...
  <Attribute id="qiskit.optimization.problems.LinearConstraint.linear" signature="qiskit.optimization.problems.linear_expression.LinearExpression">
  ...
  <Attribute id="qiskit.optimization.problems.LinearConstraint.name" signature="str">
  ...
  <Attribute id="qiskit.optimization.problems.LinearConstraint.quadratic_program" signature="Any">
  ...
  <Attribute id="qiskit.optimization.problems.LinearConstraint.rhs" signature="float">
  ...
  <Attribute id="qiskit.optimization.problems.LinearConstraint.sense" signature="qiskit.optimization.problems.constraint.ConstraintSense">
