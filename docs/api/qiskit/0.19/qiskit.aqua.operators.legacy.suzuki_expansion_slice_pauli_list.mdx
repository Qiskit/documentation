---
title: suzuki_expansion_slice_pauli_list (v0.19)
description: API reference for qiskit.aqua.operators.legacy.suzuki_expansion_slice_pauli_list in qiskit v0.19
in_page_toc_min_heading_level: 1
python_api_type: function
python_api_name: qiskit.aqua.operators.legacy.suzuki_expansion_slice_pauli_list
---

<span id="suzuki-expansion-slice-pauli-list" />
