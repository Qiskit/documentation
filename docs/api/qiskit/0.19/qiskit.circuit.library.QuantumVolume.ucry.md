---
title: ucry
description: API reference for qiskit.circuit.library.QuantumVolume.ucry
in_page_toc_min_heading_level: 1
python_api_type: method
python_api_name: qiskit.circuit.library.QuantumVolume.ucry
---
...
`QuantumVolume.ucry(angle_list, q_controls, q_target)`
