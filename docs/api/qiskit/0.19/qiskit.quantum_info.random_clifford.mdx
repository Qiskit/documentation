---
title: random_clifford (v0.19)
description: API reference for qiskit.quantum_info.random_clifford in qiskit v0.19
in_page_toc_min_heading_level: 1
python_api_type: function
python_api_name: qiskit.quantum_info.random_clifford
---

<span id="random-clifford" />

# random\_clifford

<Function id="qiskit.quantum_info.random_clifford" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.14/qiskit/quantum_info/operators/symplectic/random.py" signature="random_clifford(num_qubits, seed=None)">
