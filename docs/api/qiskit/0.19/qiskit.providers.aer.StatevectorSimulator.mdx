...
<Class id="qiskit.providers.aer.StatevectorSimulator" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-aer/tree/stable/0.5/qiskit/providers/aer/backends/statevector_simulator.py" signature="StatevectorSimulator(configuration=None, provider=None)">
  ...
  *   [**AerError**](qiskit.providers.aer.AerError "qiskit.providers.aer.AerError") – if there is no name in the configuration
  ...
  <Function id="qiskit.providers.aer.StatevectorSimulator.run" name="run" signature="StatevectorSimulator.run(qobj, backend_options=None, noise_model=None, validate=False)">
  ...
  <Function id="qiskit.providers.aer.StatevectorSimulator.version" name="version" signature="StatevectorSimulator.version()">
