---
title: StatevectorSimulator (v0.19)
description: API reference for qiskit.providers.aer.StatevectorSimulator in qiskit v0.19
...
<Class id="qiskit.providers.aer.StatevectorSimulator" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-aer/tree/stable/0.5/qiskit/providers/aer/backends/statevector_simulator.py" signature="StatevectorSimulator(configuration=None, provider=None)" modifiers="class">
  ...
  *   [**AerError**](qiskit.providers.aer.AerError "qiskit.providers.aer.AerError") – if there is no name in the configuration
  ...
  <span id="statevectorsimulator-default-configuration" />
  ...
  <span id="statevectorsimulator-max-qubit-memory" />
  ...
  <span id="statevectorsimulator-configuration" />
  ...
  <span id="statevectorsimulator-name" />
  ...
  <span id="statevectorsimulator-properties" />
  ...
  <span id="statevectorsimulator-provider" />
  ...
  <span id="statevectorsimulator-run" />
  ...
  <span id="statevectorsimulator-status" />
  ...
  <span id="statevectorsimulator-version" />
