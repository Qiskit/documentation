---
title: LinearPauliRotations (v0.19)
description: API reference for qiskit.circuit.library.LinearPauliRotations in qiskit v0.19
...
<Class id="qiskit.circuit.library.LinearPauliRotations" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.14/qiskit/circuit/library/arithmetic/linear_pauli_rotations.py" signature="LinearPauliRotations(num_state_qubits=None, slope=1, offset=0, basis='Y', name='LinRot')" modifiers="class">
...
$$
  ...
  *   **name** (`str`) – The name of the circuit object.
  ...
  <span id="linearpaulirotations-basis" />

  ### basis

  <Attribute id="qiskit.circuit.library.LinearPauliRotations.basis" attributeTypeHint="str">
  ...
  <span id="linearpaulirotations-clbits" />
  ...
  <span id="linearpaulirotations-data" />
  ...
  <span id="linearpaulirotations-extension-lib" />

  ### extension\_lib

  <Attribute id="qiskit.circuit.library.LinearPauliRotations.extension_lib" attributeValue="'include &#x22;qelib1.inc&#x22;;'" />

  <span id="linearpaulirotations-header" />

  ### header

  <Attribute id="qiskit.circuit.library.LinearPauliRotations.header" attributeValue="'OPENQASM 2.0;'" />

  <span id="linearpaulirotations-instances" />

  ### instances

  <Attribute id="qiskit.circuit.library.LinearPauliRotations.instances" attributeValue="8" />

  <span id="linearpaulirotations-n-qubits" />

  ### n\_qubits

  <Attribute id="qiskit.circuit.library.LinearPauliRotations.n_qubits">
    Deprecated, use `num_qubits` instead. Return number of qubits.
  </Attribute>

  <span id="linearpaulirotations-num-ancilla-qubits" />

  ### num\_ancilla\_qubits

  <Attribute id="qiskit.circuit.library.LinearPauliRotations.num_ancilla_qubits" attributeTypeHint="int">
  ...
  <span id="linearpaulirotations-num-clbits" />
  ...
  <span id="linearpaulirotations-num-parameters" />
  ...
  <span id="linearpaulirotations-num-qubits" />
  ...
  <span id="linearpaulirotations-num-state-qubits" />

  ### num\_state\_qubits

  <Attribute id="qiskit.circuit.library.LinearPauliRotations.num_state_qubits" attributeTypeHint="int">
  ...
  <span id="linearpaulirotations-offset" />

  ### offset

  <Attribute id="qiskit.circuit.library.LinearPauliRotations.offset" attributeTypeHint="float">
  ...
  <span id="linearpaulirotations-parameters" />
  ...
  <span id="linearpaulirotations-qubits" />
  ...
  <span id="linearpaulirotations-slope" />

  ### slope

  <Attribute id="qiskit.circuit.library.LinearPauliRotations.slope" attributeTypeHint="float">
  ...
  <span id="linearpaulirotations-and" />

  ### AND

  <Function id="qiskit.circuit.library.LinearPauliRotations.AND" signature="LinearPauliRotations.AND(qr_variables, qb_target, qr_ancillae, flags=None, mct_mode='no-ancilla')">
  ...
  <span id="linearpaulirotations-or" />

  ### OR

  <Function id="qiskit.circuit.library.LinearPauliRotations.OR" signature="LinearPauliRotations.OR(qr_variables, qb_target, qr_ancillae, flags=None, mct_mode='basic')">
  ...
  <span id="linearpaulirotations-getitem" />

  ### \_\_getitem\_\_

  <Function id="qiskit.circuit.library.LinearPauliRotations.__getitem__" signature="LinearPauliRotations.__getitem__(item)">
    Return indexed operation.
  </Function>

  <span id="linearpaulirotations-len" />

  ### \_\_len\_\_

  <Function id="qiskit.circuit.library.LinearPauliRotations.__len__" signature="LinearPauliRotations.__len__()">
    Return number of operations in circuit.
  </Function>

  <span id="linearpaulirotations-add-register" />

  ### add\_register

  <Function id="qiskit.circuit.library.LinearPauliRotations.add_register" signature="LinearPauliRotations.add_register(*regs)">
    Add registers.
  </Function>

  <span id="linearpaulirotations-append" />

  ### append

  <Function id="qiskit.circuit.library.LinearPauliRotations.append" signature="LinearPauliRotations.append(instruction, qargs=None, cargs=None)">
  ...
  <span id="linearpaulirotations-assign-parameters" />

  ### assign\_parameters

  <Function id="qiskit.circuit.library.LinearPauliRotations.assign_parameters" signature="LinearPauliRotations.assign_parameters(param_dict, inplace=False)">
  ...
  <span id="linearpaulirotations-barrier" />

  ### barrier

  <Function id="qiskit.circuit.library.LinearPauliRotations.barrier" signature="LinearPauliRotations.barrier(*qargs)">
    Apply `Barrier`. If qargs is None, applies to all.
  </Function>

  <span id="linearpaulirotations-bind-parameters" />

  ### bind\_parameters

  <Function id="qiskit.circuit.library.LinearPauliRotations.bind_parameters" signature="LinearPauliRotations.bind_parameters(value_dict)">
  ...
  <span id="linearpaulirotations-cast" />

  ### cast

  <Function id="qiskit.circuit.library.LinearPauliRotations.cast" signature="LinearPauliRotations.cast(value, _type)" modifiers="static">
    Best effort to cast value to type. Otherwise, returns the value.
  </Function>

  <span id="linearpaulirotations-cbit-argument-conversion" />

  ### cbit\_argument\_conversion

  <Function id="qiskit.circuit.library.LinearPauliRotations.cbit_argument_conversion" signature="LinearPauliRotations.cbit_argument_conversion(clbit_representation)">
  ...
  <span id="linearpaulirotations-ccx" />

  ### ccx

  <Function id="qiskit.circuit.library.LinearPauliRotations.ccx" signature="LinearPauliRotations.ccx(control_qubit1, control_qubit2, target_qubit, *, ctl1=None, ctl2=None, tgt=None)">
    Apply [`CCXGate`](qiskit.circuit.library.CCXGate "qiskit.circuit.library.CCXGate").
  </Function>

  <span id="linearpaulirotations-ch" />

  ### ch

  <Function id="qiskit.circuit.library.LinearPauliRotations.ch" signature="LinearPauliRotations.ch(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CHGate`](qiskit.circuit.library.CHGate "qiskit.circuit.library.CHGate").
  </Function>

  <span id="linearpaulirotations-cls-instances" />

  ### cls\_instances

  <Function id="qiskit.circuit.library.LinearPauliRotations.cls_instances" signature="LinearPauliRotations.cls_instances()" modifiers="classmethod">
    Return the current number of instances of this class, useful for auto naming.
  </Function>

  <span id="linearpaulirotations-cls-prefix" />

  ### cls\_prefix

  <Function id="qiskit.circuit.library.LinearPauliRotations.cls_prefix" signature="LinearPauliRotations.cls_prefix()" modifiers="classmethod">
    Return the prefix to use for auto naming.
  </Function>

  <span id="linearpaulirotations-cnot" />

  ### cnot

  <Function id="qiskit.circuit.library.LinearPauliRotations.cnot" signature="LinearPauliRotations.cnot(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CXGate`](qiskit.circuit.library.CXGate "qiskit.circuit.library.CXGate").
  </Function>

  <span id="linearpaulirotations-combine" />

  ### combine

  <Function id="qiskit.circuit.library.LinearPauliRotations.combine" signature="LinearPauliRotations.combine(rhs)">
  ...
  <span id="linearpaulirotations-compose" />

  ### compose

  <Function id="qiskit.circuit.library.LinearPauliRotations.compose" signature="LinearPauliRotations.compose(other, qubits=None, clbits=None, front=False, inplace=False)">
  ...
  <span id="linearpaulirotations-copy" />

  ### copy

  <Function id="qiskit.circuit.library.LinearPauliRotations.copy" signature="LinearPauliRotations.copy(name=None)">
    Copy the circuit.
  ...
  <span id="linearpaulirotations-count-ops" />

  ### count\_ops

  <Function id="qiskit.circuit.library.LinearPauliRotations.count_ops" signature="LinearPauliRotations.count_ops()">
  ...
  <span id="linearpaulirotations-crx" />

  ### crx

  <Function id="qiskit.circuit.library.LinearPauliRotations.crx" signature="LinearPauliRotations.crx(theta, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CRXGate`](qiskit.circuit.library.CRXGate "qiskit.circuit.library.CRXGate").
  </Function>

  <span id="linearpaulirotations-cry" />

  ### cry

  <Function id="qiskit.circuit.library.LinearPauliRotations.cry" signature="LinearPauliRotations.cry(theta, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CRYGate`](qiskit.circuit.library.CRYGate "qiskit.circuit.library.CRYGate").
  </Function>

  <span id="linearpaulirotations-crz" />

  ### crz

  <Function id="qiskit.circuit.library.LinearPauliRotations.crz" signature="LinearPauliRotations.crz(theta, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CRZGate`](qiskit.circuit.library.CRZGate "qiskit.circuit.library.CRZGate").
  </Function>

  <span id="linearpaulirotations-cswap" />

  ### cswap

  <Function id="qiskit.circuit.library.LinearPauliRotations.cswap" signature="LinearPauliRotations.cswap(control_qubit, target_qubit1, target_qubit2, *, label=None, ctrl_state=None, ctl=None, tgt1=None, tgt2=None)">
    Apply [`CSwapGate`](qiskit.circuit.library.CSwapGate "qiskit.circuit.library.CSwapGate").
  </Function>

  <span id="linearpaulirotations-cu1" />

  ### cu1

  <Function id="qiskit.circuit.library.LinearPauliRotations.cu1" signature="LinearPauliRotations.cu1(theta, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CU1Gate`](qiskit.circuit.library.CU1Gate "qiskit.circuit.library.CU1Gate").
  </Function>

  <span id="linearpaulirotations-cu3" />

  ### cu3

  <Function id="qiskit.circuit.library.LinearPauliRotations.cu3" signature="LinearPauliRotations.cu3(theta, phi, lam, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CU3Gate`](qiskit.circuit.library.CU3Gate "qiskit.circuit.library.CU3Gate").
  </Function>

  <span id="linearpaulirotations-cx" />

  ### cx

  <Function id="qiskit.circuit.library.LinearPauliRotations.cx" signature="LinearPauliRotations.cx(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CXGate`](qiskit.circuit.library.CXGate "qiskit.circuit.library.CXGate").
  </Function>

  <span id="linearpaulirotations-cy" />

  ### cy

  <Function id="qiskit.circuit.library.LinearPauliRotations.cy" signature="LinearPauliRotations.cy(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CYGate`](qiskit.circuit.library.CYGate "qiskit.circuit.library.CYGate").
  </Function>

  <span id="linearpaulirotations-cz" />

  ### cz

  <Function id="qiskit.circuit.library.LinearPauliRotations.cz" signature="LinearPauliRotations.cz(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CZGate`](qiskit.circuit.library.CZGate "qiskit.circuit.library.CZGate").
  </Function>

  <span id="linearpaulirotations-dcx" />

  ### dcx

  <Function id="qiskit.circuit.library.LinearPauliRotations.dcx" signature="LinearPauliRotations.dcx(qubit1, qubit2)">
    Apply [`DCXGate`](qiskit.circuit.library.DCXGate "qiskit.circuit.library.DCXGate").
  </Function>

  <span id="linearpaulirotations-decompose" />

  ### decompose

  <Function id="qiskit.circuit.library.LinearPauliRotations.decompose" signature="LinearPauliRotations.decompose()">
  ...
  <span id="linearpaulirotations-depth" />

  ### depth

  <Function id="qiskit.circuit.library.LinearPauliRotations.depth" signature="LinearPauliRotations.depth()">
  ...
  <span id="linearpaulirotations-diag-gate" />

  ### diag\_gate

  <Function id="qiskit.circuit.library.LinearPauliRotations.diag_gate" signature="LinearPauliRotations.diag_gate(diag, qubit)">
    Deprecated version of QuantumCircuit.diagonal.
  </Function>

  <span id="linearpaulirotations-diagonal" />

  ### diagonal

  <Function id="qiskit.circuit.library.LinearPauliRotations.diagonal" signature="LinearPauliRotations.diagonal(diag, qubit)">
  ...
  <span id="linearpaulirotations-draw" />
  ...
  <span id="linearpaulirotations-extend" />

  ### extend

  <Function id="qiskit.circuit.library.LinearPauliRotations.extend" signature="LinearPauliRotations.extend(rhs)">
  ...
  <span id="linearpaulirotations-fredkin" />

  ### fredkin

  <Function id="qiskit.circuit.library.LinearPauliRotations.fredkin" signature="LinearPauliRotations.fredkin(control_qubit, target_qubit1, target_qubit2, *, ctl=None, tgt1=None, tgt2=None)">
    Apply [`CSwapGate`](qiskit.circuit.library.CSwapGate "qiskit.circuit.library.CSwapGate").
  </Function>

  <span id="linearpaulirotations-from-qasm-file" />

  ### from\_qasm\_file

  <Function id="qiskit.circuit.library.LinearPauliRotations.from_qasm_file" signature="LinearPauliRotations.from_qasm_file(path)" modifiers="static">
  ...
  <span id="linearpaulirotations-from-qasm-str" />

  ### from\_qasm\_str

  <Function id="qiskit.circuit.library.LinearPauliRotations.from_qasm_str" signature="LinearPauliRotations.from_qasm_str(qasm_str)" modifiers="static">
  ...
  <span id="linearpaulirotations-h" />

  ### h

  <Function id="qiskit.circuit.library.LinearPauliRotations.h" signature="LinearPauliRotations.h(qubit, *, q=None)">
    Apply [`HGate`](qiskit.circuit.library.HGate "qiskit.circuit.library.HGate").
  </Function>

  <span id="linearpaulirotations-hamiltonian" />

  ### hamiltonian

  <Function id="qiskit.circuit.library.LinearPauliRotations.hamiltonian" signature="LinearPauliRotations.hamiltonian(operator, time, qubits, label=None)">
    Apply hamiltonian evolution to to qubits.
  </Function>

  <span id="linearpaulirotations-has-register" />

  ### has\_register

  <Function id="qiskit.circuit.library.LinearPauliRotations.has_register" signature="LinearPauliRotations.has_register(register)">
  ...
  <span id="linearpaulirotations-i" />

  ### i

  <Function id="qiskit.circuit.library.LinearPauliRotations.i" signature="LinearPauliRotations.i(qubit, *, q=None)">
    Apply [`IGate`](qiskit.circuit.library.IGate "qiskit.circuit.library.IGate").
  </Function>

  <span id="linearpaulirotations-id" />

  ### id

  <Function id="qiskit.circuit.library.LinearPauliRotations.id" signature="LinearPauliRotations.id(qubit, *, q=None)">
    Apply [`IGate`](qiskit.circuit.library.IGate "qiskit.circuit.library.IGate").
  </Function>

  <span id="linearpaulirotations-iden" />

  ### iden

  <Function id="qiskit.circuit.library.LinearPauliRotations.iden" signature="LinearPauliRotations.iden(qubit, *, q=None)">
    Deprecated identity gate.
  </Function>

  <span id="linearpaulirotations-initialize" />

  ### initialize

  <Function id="qiskit.circuit.library.LinearPauliRotations.initialize" signature="LinearPauliRotations.initialize(params, qubits)">
    Apply initialize to circuit.
  </Function>

  <span id="linearpaulirotations-inverse" />

  ### inverse

  <Function id="qiskit.circuit.library.LinearPauliRotations.inverse" signature="LinearPauliRotations.inverse()">
    Invert this circuit.
  ...
  <span id="linearpaulirotations-iso" />

  ### iso

  <Function id="qiskit.circuit.library.LinearPauliRotations.iso" signature="LinearPauliRotations.iso(isometry, q_input, q_ancillas_for_output, q_ancillas_zero=None, q_ancillas_dirty=None)">
  ...
  <span id="linearpaulirotations-isometry" />

  ### isometry

  <Function id="qiskit.circuit.library.LinearPauliRotations.isometry" signature="LinearPauliRotations.isometry(isometry, q_input, q_ancillas_for_output, q_ancillas_zero=None, q_ancillas_dirty=None)">
    Attach an arbitrary isometry from m to n qubits to a circuit. In particular, this allows to attach arbitrary unitaries on n qubits (m=n) or to prepare any state on n qubits (m=0). The decomposition used here was introduced by Iten et al. in [https://arxiv.org/abs/1501.06911](https://arxiv.org/abs/1501.06911).
  ...
  <span id="linearpaulirotations-iswap" />

  ### iswap

  <Function id="qiskit.circuit.library.LinearPauliRotations.iswap" signature="LinearPauliRotations.iswap(qubit1, qubit2)">
    Apply [`iSwapGate`](qiskit.circuit.library.iSwapGate "qiskit.circuit.library.iSwapGate").
  </Function>

  <span id="linearpaulirotations-mcmt" />

  ### mcmt

  <Function id="qiskit.circuit.library.LinearPauliRotations.mcmt" signature="LinearPauliRotations.mcmt(gate, control_qubits, target_qubits, ancilla_qubits=None, mode='no-ancilla', *, single_control_gate_fun=None, q_controls=None, q_ancillae=None, q_targets=None)">
    Apply a multi-control, multi-target using a generic gate.

    This can also be used to implement a generic multi-control gate, as the target could also be of length 1.
  </Function>

  <span id="linearpaulirotations-mcrx" />

  ### mcrx

  <Function id="qiskit.circuit.library.LinearPauliRotations.mcrx" signature="LinearPauliRotations.mcrx(theta, q_controls, q_target, use_basis_gates=False)">
  ...
  <span id="linearpaulirotations-mcry" />

  ### mcry

  <Function id="qiskit.circuit.library.LinearPauliRotations.mcry" signature="LinearPauliRotations.mcry(theta, q_controls, q_target, q_ancillae, mode='basic', use_basis_gates=False)">
  ...
  <span id="linearpaulirotations-mcrz" />

  ### mcrz

  <Function id="qiskit.circuit.library.LinearPauliRotations.mcrz" signature="LinearPauliRotations.mcrz(lam, q_controls, q_target, use_basis_gates=False)">
  ...
  <span id="linearpaulirotations-mct" />

  ### mct

  <Function id="qiskit.circuit.library.LinearPauliRotations.mct" signature="LinearPauliRotations.mct(control_qubits, target_qubit, ancilla_qubits=None, mode='noancilla')">
    Apply `MCXGate`.
  </Function>

  <span id="linearpaulirotations-mcu1" />

  ### mcu1

  <Function id="qiskit.circuit.library.LinearPauliRotations.mcu1" signature="LinearPauliRotations.mcu1(lam, control_qubits, target_qubit)">
    Apply `MCU1Gate`.
  </Function>

  <span id="linearpaulirotations-mcx" />

  ### mcx

  <Function id="qiskit.circuit.library.LinearPauliRotations.mcx" signature="LinearPauliRotations.mcx(control_qubits, target_qubit, ancilla_qubits=None, mode='noancilla')">
    Apply `MCXGate`.
  ...
  <span id="linearpaulirotations-measure" />

  ### measure

  <Function id="qiskit.circuit.library.LinearPauliRotations.measure" signature="LinearPauliRotations.measure(qubit, cbit)">
  ...
  <span id="linearpaulirotations-measure-active" />

  ### measure\_active

  <Function id="qiskit.circuit.library.LinearPauliRotations.measure_active" signature="LinearPauliRotations.measure_active(inplace=True)">
  ...
  <span id="linearpaulirotations-measure-all" />

  ### measure\_all

  <Function id="qiskit.circuit.library.LinearPauliRotations.measure_all" signature="LinearPauliRotations.measure_all(inplace=True)">
  ...
  <span id="linearpaulirotations-mirror" />

  ### mirror

  <Function id="qiskit.circuit.library.LinearPauliRotations.mirror" signature="LinearPauliRotations.mirror()">
  ...
  <span id="linearpaulirotations-ms" />

  ### ms

  <Function id="qiskit.circuit.library.LinearPauliRotations.ms" signature="LinearPauliRotations.ms(theta, qubits)">
    Apply [`MSGate`](qiskit.circuit.library.MSGate "qiskit.circuit.library.MSGate").
  </Function>

  <span id="linearpaulirotations-num-connected-components" />

  ### num\_connected\_components

  <Function id="qiskit.circuit.library.LinearPauliRotations.num_connected_components" signature="LinearPauliRotations.num_connected_components(unitary_only=False)">
  ...
  <span id="linearpaulirotations-num-nonlocal-gates" />

  ### num\_nonlocal\_gates

  <Function id="qiskit.circuit.library.LinearPauliRotations.num_nonlocal_gates" signature="LinearPauliRotations.num_nonlocal_gates()">
    Return number of non-local gates (i.e. involving 2+ qubits).

    Conditional nonlocal gates are also included.
  </Function>

  <span id="linearpaulirotations-num-tensor-factors" />

  ### num\_tensor\_factors

  <Function id="qiskit.circuit.library.LinearPauliRotations.num_tensor_factors" signature="LinearPauliRotations.num_tensor_factors()">
  ...
  <span id="linearpaulirotations-num-unitary-factors" />

  ### num\_unitary\_factors

  <Function id="qiskit.circuit.library.LinearPauliRotations.num_unitary_factors" signature="LinearPauliRotations.num_unitary_factors()">
    Computes the number of tensor factors in the unitary (quantum) part of the circuit only.
  </Function>

  <span id="linearpaulirotations-qasm" />

  ### qasm

  <Function id="qiskit.circuit.library.LinearPauliRotations.qasm" signature="LinearPauliRotations.qasm(formatted=False, filename=None)">
  ...
  <span id="linearpaulirotations-qbit-argument-conversion" />

  ### qbit\_argument\_conversion

  <Function id="qiskit.circuit.library.LinearPauliRotations.qbit_argument_conversion" signature="LinearPauliRotations.qbit_argument_conversion(qubit_representation)">
  ...
  <span id="linearpaulirotations-r" />

  ### r

  <Function id="qiskit.circuit.library.LinearPauliRotations.r" signature="LinearPauliRotations.r(theta, phi, qubit, *, q=None)">
    Apply `RGate`.
  </Function>

  <span id="linearpaulirotations-rcccx" />

  ### rcccx

  <Function id="qiskit.circuit.library.LinearPauliRotations.rcccx" signature="LinearPauliRotations.rcccx(control_qubit1, control_qubit2, control_qubit3, target_qubit)">
    Apply [`RC3XGate`](qiskit.circuit.library.RC3XGate "qiskit.circuit.library.RC3XGate").
  </Function>

  <span id="linearpaulirotations-rccx" />

  ### rccx

  <Function id="qiskit.circuit.library.LinearPauliRotations.rccx" signature="LinearPauliRotations.rccx(control_qubit1, control_qubit2, target_qubit)">
    Apply [`RCCXGate`](qiskit.circuit.library.RCCXGate "qiskit.circuit.library.RCCXGate").
  </Function>

  <span id="linearpaulirotations-remove-final-measurements" />

  ### remove\_final\_measurements

  <Function id="qiskit.circuit.library.LinearPauliRotations.remove_final_measurements" signature="LinearPauliRotations.remove_final_measurements(inplace=True)">
  ...
  <span id="linearpaulirotations-reset" />

  ### reset

  <Function id="qiskit.circuit.library.LinearPauliRotations.reset" signature="LinearPauliRotations.reset(qubit)">
    Reset q.
  </Function>

  <span id="linearpaulirotations-rx" />

  ### rx

  <Function id="qiskit.circuit.library.LinearPauliRotations.rx" signature="LinearPauliRotations.rx(theta, qubit, *, label=None, q=None)">
    Apply [`RXGate`](qiskit.circuit.library.RXGate "qiskit.circuit.library.RXGate").
  </Function>

  <span id="linearpaulirotations-rxx" />

  ### rxx

  <Function id="qiskit.circuit.library.LinearPauliRotations.rxx" signature="LinearPauliRotations.rxx(theta, qubit1, qubit2)">
    Apply [`RXXGate`](qiskit.circuit.library.RXXGate "qiskit.circuit.library.RXXGate").
  </Function>

  <span id="linearpaulirotations-ry" />

  ### ry

  <Function id="qiskit.circuit.library.LinearPauliRotations.ry" signature="LinearPauliRotations.ry(theta, qubit, *, label=None, q=None)">
    Apply [`RYGate`](qiskit.circuit.library.RYGate "qiskit.circuit.library.RYGate").
  </Function>

  <span id="linearpaulirotations-ryy" />

  ### ryy

  <Function id="qiskit.circuit.library.LinearPauliRotations.ryy" signature="LinearPauliRotations.ryy(theta, qubit1, qubit2)">
    Apply [`RYYGate`](qiskit.circuit.library.RYYGate "qiskit.circuit.library.RYYGate").
  </Function>

  <span id="linearpaulirotations-rz" />

  ### rz

  <Function id="qiskit.circuit.library.LinearPauliRotations.rz" signature="LinearPauliRotations.rz(phi, qubit, *, q=None)">
    Apply [`RZGate`](qiskit.circuit.library.RZGate "qiskit.circuit.library.RZGate").
  </Function>

  <span id="linearpaulirotations-rzx" />

  ### rzx

  <Function id="qiskit.circuit.library.LinearPauliRotations.rzx" signature="LinearPauliRotations.rzx(theta, qubit1, qubit2)">
    Apply [`RZXGate`](qiskit.circuit.library.RZXGate "qiskit.circuit.library.RZXGate").
  </Function>

  <span id="linearpaulirotations-rzz" />

  ### rzz

  <Function id="qiskit.circuit.library.LinearPauliRotations.rzz" signature="LinearPauliRotations.rzz(theta, qubit1, qubit2)">
    Apply [`RZZGate`](qiskit.circuit.library.RZZGate "qiskit.circuit.library.RZZGate").
  </Function>

  <span id="linearpaulirotations-s" />

  ### s

  <Function id="qiskit.circuit.library.LinearPauliRotations.s" signature="LinearPauliRotations.s(qubit, *, q=None)">
    Apply [`SGate`](qiskit.circuit.library.SGate "qiskit.circuit.library.SGate").
  </Function>

  <span id="linearpaulirotations-sdg" />

  ### sdg

  <Function id="qiskit.circuit.library.LinearPauliRotations.sdg" signature="LinearPauliRotations.sdg(qubit, *, q=None)">
    Apply [`SdgGate`](qiskit.circuit.library.SdgGate "qiskit.circuit.library.SdgGate").
  </Function>

  <span id="linearpaulirotations-size" />

  ### size

  <Function id="qiskit.circuit.library.LinearPauliRotations.size" signature="LinearPauliRotations.size()">
  ...
  <span id="linearpaulirotations-snapshot" />

  ### snapshot

  <Function id="qiskit.circuit.library.LinearPauliRotations.snapshot" signature="LinearPauliRotations.snapshot(label, snapshot_type='statevector', qubits=None, params=None)">
  ...
  <span id="linearpaulirotations-snapshot-density-matrix" />

  ### snapshot\_density\_matrix

  <Function id="qiskit.circuit.library.LinearPauliRotations.snapshot_density_matrix" signature="LinearPauliRotations.snapshot_density_matrix(label, qubits=None)">
  ...
  <span id="linearpaulirotations-snapshot-expectation-value" />

  ### snapshot\_expectation\_value

  <Function id="qiskit.circuit.library.LinearPauliRotations.snapshot_expectation_value" signature="LinearPauliRotations.snapshot_expectation_value(label, op, qubits, single_shot=False, variance=False)">
  ...
  <span id="linearpaulirotations-snapshot-probabilities" />

  ### snapshot\_probabilities

  <Function id="qiskit.circuit.library.LinearPauliRotations.snapshot_probabilities" signature="LinearPauliRotations.snapshot_probabilities(label, qubits, variance=False)">
  ...
  <span id="linearpaulirotations-snapshot-stabilizer" />

  ### snapshot\_stabilizer

  <Function id="qiskit.circuit.library.LinearPauliRotations.snapshot_stabilizer" signature="LinearPauliRotations.snapshot_stabilizer(label)">
  ...
  <span id="linearpaulirotations-snapshot-statevector" />

  ### snapshot\_statevector

  <Function id="qiskit.circuit.library.LinearPauliRotations.snapshot_statevector" signature="LinearPauliRotations.snapshot_statevector(label)">
  ...
  <span id="linearpaulirotations-squ" />

  ### squ

  <Function id="qiskit.circuit.library.LinearPauliRotations.squ" signature="LinearPauliRotations.squ(unitary_matrix, qubit, mode='ZYZ', up_to_diagonal=False, *, u=None)">
  ...
  <span id="linearpaulirotations-swap" />

  ### swap

  <Function id="qiskit.circuit.library.LinearPauliRotations.swap" signature="LinearPauliRotations.swap(qubit1, qubit2)">
    Apply [`SwapGate`](qiskit.circuit.library.SwapGate "qiskit.circuit.library.SwapGate").
  </Function>

  <span id="linearpaulirotations-t" />

  ### t

  <Function id="qiskit.circuit.library.LinearPauliRotations.t" signature="LinearPauliRotations.t(qubit, *, q=None)">
    Apply [`TGate`](qiskit.circuit.library.TGate "qiskit.circuit.library.TGate").
  </Function>

  <span id="linearpaulirotations-tdg" />

  ### tdg

  <Function id="qiskit.circuit.library.LinearPauliRotations.tdg" signature="LinearPauliRotations.tdg(qubit, *, q=None)">
    Apply [`TdgGate`](qiskit.circuit.library.TdgGate "qiskit.circuit.library.TdgGate").
  </Function>

  <span id="linearpaulirotations-to-gate" />

  ### to\_gate

  <Function id="qiskit.circuit.library.LinearPauliRotations.to_gate" signature="LinearPauliRotations.to_gate(parameter_map=None)">
  ...
  <span id="linearpaulirotations-to-instruction" />

  ### to\_instruction

  <Function id="qiskit.circuit.library.LinearPauliRotations.to_instruction" signature="LinearPauliRotations.to_instruction(parameter_map=None)">
  ...
  <span id="linearpaulirotations-toffoli" />

  ### toffoli

  <Function id="qiskit.circuit.library.LinearPauliRotations.toffoli" signature="LinearPauliRotations.toffoli(control_qubit1, control_qubit2, target_qubit, *, ctl1=None, ctl2=None, tgt=None)">
    Apply [`CCXGate`](qiskit.circuit.library.CCXGate "qiskit.circuit.library.CCXGate").
  </Function>

  <span id="linearpaulirotations-u1" />

  ### u1

  <Function id="qiskit.circuit.library.LinearPauliRotations.u1" signature="LinearPauliRotations.u1(theta, qubit, *, q=None)">
    Apply [`U1Gate`](qiskit.circuit.library.U1Gate "qiskit.circuit.library.U1Gate").
  </Function>

  <span id="linearpaulirotations-u2" />

  ### u2

  <Function id="qiskit.circuit.library.LinearPauliRotations.u2" signature="LinearPauliRotations.u2(phi, lam, qubit, *, q=None)">
    Apply [`U2Gate`](qiskit.circuit.library.U2Gate "qiskit.circuit.library.U2Gate").
  </Function>

  <span id="linearpaulirotations-u3" />

  ### u3

  <Function id="qiskit.circuit.library.LinearPauliRotations.u3" signature="LinearPauliRotations.u3(theta, phi, lam, qubit, *, q=None)">
    Apply [`U3Gate`](qiskit.circuit.library.U3Gate "qiskit.circuit.library.U3Gate").
  </Function>

  <span id="linearpaulirotations-uc" />

  ### uc

  <Function id="qiskit.circuit.library.LinearPauliRotations.uc" signature="LinearPauliRotations.uc(gate_list, q_controls, q_target, up_to_diagonal=False)">
  ...
  <span id="linearpaulirotations-ucg" />

  ### ucg

  <Function id="qiskit.circuit.library.LinearPauliRotations.ucg" signature="LinearPauliRotations.ucg(angle_list, q_controls, q_target, up_to_diagonal=False)">
    Deprecated version of uc.
  </Function>

  <span id="linearpaulirotations-ucrx" />

  ### ucrx

  <Function id="qiskit.circuit.library.LinearPauliRotations.ucrx" signature="LinearPauliRotations.ucrx(angle_list, q_controls, q_target)">
  ...
  <span id="linearpaulirotations-ucry" />

  ### ucry

  <Function id="qiskit.circuit.library.LinearPauliRotations.ucry" signature="LinearPauliRotations.ucry(angle_list, q_controls, q_target)">
  ...
  <span id="linearpaulirotations-ucrz" />

  ### ucrz

  <Function id="qiskit.circuit.library.LinearPauliRotations.ucrz" signature="LinearPauliRotations.ucrz(angle_list, q_controls, q_target)">
  ...
  <span id="linearpaulirotations-ucx" />

  ### ucx

  <Function id="qiskit.circuit.library.LinearPauliRotations.ucx" signature="LinearPauliRotations.ucx(angle_list, q_controls, q_target)">
    Deprecated version of ucrx.
  </Function>

  <span id="linearpaulirotations-ucy" />

  ### ucy

  <Function id="qiskit.circuit.library.LinearPauliRotations.ucy" signature="LinearPauliRotations.ucy(angle_list, q_controls, q_target)">
    Deprecated version of ucry.
  </Function>

  <span id="linearpaulirotations-ucz" />

  ### ucz

  <Function id="qiskit.circuit.library.LinearPauliRotations.ucz" signature="LinearPauliRotations.ucz(angle_list, q_controls, q_target)">
    Deprecated version of ucrz.
  </Function>

  <span id="linearpaulirotations-unitary" />

  ### unitary

  <Function id="qiskit.circuit.library.LinearPauliRotations.unitary" signature="LinearPauliRotations.unitary(obj, qubits, label=None)">
    Apply unitary gate to q.
  </Function>

  <span id="linearpaulirotations-width" />

  ### width

  <Function id="qiskit.circuit.library.LinearPauliRotations.width" signature="LinearPauliRotations.width()">
  ...
  <span id="linearpaulirotations-x" />

  ### x

  <Function id="qiskit.circuit.library.LinearPauliRotations.x" signature="LinearPauliRotations.x(qubit, *, label=None, ctrl_state=None, q=None)">
    Apply [`XGate`](qiskit.circuit.library.XGate "qiskit.circuit.library.XGate").
  </Function>

  <span id="linearpaulirotations-y" />

  ### y

  <Function id="qiskit.circuit.library.LinearPauliRotations.y" signature="LinearPauliRotations.y(qubit, *, q=None)">
    Apply [`YGate`](qiskit.circuit.library.YGate "qiskit.circuit.library.YGate").
  </Function>

  <span id="linearpaulirotations-z" />

  ### z

  <Function id="qiskit.circuit.library.LinearPauliRotations.z" signature="LinearPauliRotations.z(qubit, *, q=None)">
