...
<Class id="qiskit.circuit.library.LinearPauliRotations" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.14/qiskit/circuit/library/arithmetic/linear_pauli_rotations.py" signature="LinearPauliRotations(num_state_qubits=None, slope=1, offset=0, basis='Y', name='LinRot')">
...
$$
  ...
  *   **name** (`str`) – The name of the circuit object.
  ...
  <Attribute id="qiskit.circuit.library.LinearPauliRotations.basis" name="basis" signature="str">
  ...
  <Attribute id="qiskit.circuit.library.LinearPauliRotations.extension_lib" signature="= 'include \&#x22;qelib1.inc\&#x22;;'" />

  ### header

  <Attribute id="qiskit.circuit.library.LinearPauliRotations.header" signature="= 'OPENQASM 2.0;'" />

  ### instances

  <Attribute id="qiskit.circuit.library.LinearPauliRotations.instances" signature="= 8" />

  ### n\_qubits

  <Attribute id="qiskit.circuit.library.LinearPauliRotations.n_qubits" name="n_qubits">
    Deprecated, use `num_qubits` instead. Return number of qubits.
  </Attribute>

  ### num\_ancilla\_qubits

  <Attribute id="qiskit.circuit.library.LinearPauliRotations.num_ancilla_qubits" name="num_ancilla_qubits" signature="int">
  ...
  <Attribute id="qiskit.circuit.library.LinearPauliRotations.num_state_qubits" name="num_state_qubits" signature="int">
  ...
  <Attribute id="qiskit.circuit.library.LinearPauliRotations.offset" name="offset" signature="float">
  ...
  <Attribute id="qiskit.circuit.library.LinearPauliRotations.prefix" signature="= 'circuit'" />
  ...
  <Attribute id="qiskit.circuit.library.LinearPauliRotations.slope" name="slope" signature="float">
  ...
  <Function id="qiskit.circuit.library.LinearPauliRotations.AND" name="AND" signature="LinearPauliRotations.AND(qr_variables, qb_target, qr_ancillae, flags=None, mct_mode='no-ancilla')">
  ...
  <Function id="qiskit.circuit.library.LinearPauliRotations.OR" name="OR" signature="LinearPauliRotations.OR(qr_variables, qb_target, qr_ancillae, flags=None, mct_mode='basic')">
  ...
  <Function id="qiskit.circuit.library.LinearPauliRotations.__getitem__" name="__getitem__" signature="LinearPauliRotations.__getitem__(item)">
    Return indexed operation.
  </Function>

  ### \_\_len\_\_

  <Function id="qiskit.circuit.library.LinearPauliRotations.__len__" name="__len__" signature="LinearPauliRotations.__len__()">
    Return number of operations in circuit.
  </Function>

  ### add\_register

  <Function id="qiskit.circuit.library.LinearPauliRotations.add_register" name="add_register" signature="LinearPauliRotations.add_register(*regs)">
    Add registers.
  </Function>

  ### append

  <Function id="qiskit.circuit.library.LinearPauliRotations.append" name="append" signature="LinearPauliRotations.append(instruction, qargs=None, cargs=None)">
  ...
  <Function id="qiskit.circuit.library.LinearPauliRotations.assign_parameters" name="assign_parameters" signature="LinearPauliRotations.assign_parameters(param_dict, inplace=False)">
  ...
  <Function id="qiskit.circuit.library.LinearPauliRotations.barrier" name="barrier" signature="LinearPauliRotations.barrier(*qargs)">
    Apply `Barrier`. If qargs is None, applies to all.
  </Function>

  ### bind\_parameters

  <Function id="qiskit.circuit.library.LinearPauliRotations.bind_parameters" name="bind_parameters" signature="LinearPauliRotations.bind_parameters(value_dict)">
  ...
  <Function id="qiskit.circuit.library.LinearPauliRotations.cast" name="cast" signature="static LinearPauliRotations.cast(value, _type)">
    Best effort to cast value to type. Otherwise, returns the value.
  </Function>

  ### cbit\_argument\_conversion

  <Function id="qiskit.circuit.library.LinearPauliRotations.cbit_argument_conversion" name="cbit_argument_conversion" signature="LinearPauliRotations.cbit_argument_conversion(clbit_representation)">
  ...
  <Function id="qiskit.circuit.library.LinearPauliRotations.ccx" name="ccx" signature="LinearPauliRotations.ccx(control_qubit1, control_qubit2, target_qubit, *, ctl1=None, ctl2=None, tgt=None)">
    Apply [`CCXGate`](qiskit.circuit.library.CCXGate "qiskit.circuit.library.CCXGate").
  </Function>

  ### ch

  <Function id="qiskit.circuit.library.LinearPauliRotations.ch" name="ch" signature="LinearPauliRotations.ch(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CHGate`](qiskit.circuit.library.CHGate "qiskit.circuit.library.CHGate").
  </Function>

  ### cls\_instances

  <Function id="qiskit.circuit.library.LinearPauliRotations.cls_instances" name="cls_instances" signature="classmethod LinearPauliRotations.cls_instances()">
    Return the current number of instances of this class, useful for auto naming.
  </Function>

  ### cls\_prefix

  <Function id="qiskit.circuit.library.LinearPauliRotations.cls_prefix" name="cls_prefix" signature="classmethod LinearPauliRotations.cls_prefix()">
    Return the prefix to use for auto naming.
  </Function>

  ### cnot

  <Function id="qiskit.circuit.library.LinearPauliRotations.cnot" name="cnot" signature="LinearPauliRotations.cnot(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CXGate`](qiskit.circuit.library.CXGate "qiskit.circuit.library.CXGate").
  </Function>

  ### combine

  <Function id="qiskit.circuit.library.LinearPauliRotations.combine" name="combine" signature="LinearPauliRotations.combine(rhs)">
  ...
  <Function id="qiskit.circuit.library.LinearPauliRotations.compose" name="compose" signature="LinearPauliRotations.compose(other, qubits=None, clbits=None, front=False, inplace=False)">
  ...
  <Function id="qiskit.circuit.library.LinearPauliRotations.copy" name="copy" signature="LinearPauliRotations.copy(name=None)">
    Copy the circuit.
  ...
  <Function id="qiskit.circuit.library.LinearPauliRotations.count_ops" name="count_ops" signature="LinearPauliRotations.count_ops()">
  ...
  <Function id="qiskit.circuit.library.LinearPauliRotations.crx" name="crx" signature="LinearPauliRotations.crx(theta, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CRXGate`](qiskit.circuit.library.CRXGate "qiskit.circuit.library.CRXGate").
  </Function>

  ### cry

  <Function id="qiskit.circuit.library.LinearPauliRotations.cry" name="cry" signature="LinearPauliRotations.cry(theta, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CRYGate`](qiskit.circuit.library.CRYGate "qiskit.circuit.library.CRYGate").
  </Function>

  ### crz

  <Function id="qiskit.circuit.library.LinearPauliRotations.crz" name="crz" signature="LinearPauliRotations.crz(theta, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CRZGate`](qiskit.circuit.library.CRZGate "qiskit.circuit.library.CRZGate").
  </Function>

  ### cswap

  <Function id="qiskit.circuit.library.LinearPauliRotations.cswap" name="cswap" signature="LinearPauliRotations.cswap(control_qubit, target_qubit1, target_qubit2, *, label=None, ctrl_state=None, ctl=None, tgt1=None, tgt2=None)">
    Apply [`CSwapGate`](qiskit.circuit.library.CSwapGate "qiskit.circuit.library.CSwapGate").
  </Function>

  ### cu1

  <Function id="qiskit.circuit.library.LinearPauliRotations.cu1" name="cu1" signature="LinearPauliRotations.cu1(theta, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CU1Gate`](qiskit.circuit.library.CU1Gate "qiskit.circuit.library.CU1Gate").
  </Function>

  ### cu3

  <Function id="qiskit.circuit.library.LinearPauliRotations.cu3" name="cu3" signature="LinearPauliRotations.cu3(theta, phi, lam, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CU3Gate`](qiskit.circuit.library.CU3Gate "qiskit.circuit.library.CU3Gate").
  </Function>

  ### cx

  <Function id="qiskit.circuit.library.LinearPauliRotations.cx" name="cx" signature="LinearPauliRotations.cx(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CXGate`](qiskit.circuit.library.CXGate "qiskit.circuit.library.CXGate").
  </Function>

  ### cy

  <Function id="qiskit.circuit.library.LinearPauliRotations.cy" name="cy" signature="LinearPauliRotations.cy(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CYGate`](qiskit.circuit.library.CYGate "qiskit.circuit.library.CYGate").
  </Function>

  ### cz

  <Function id="qiskit.circuit.library.LinearPauliRotations.cz" name="cz" signature="LinearPauliRotations.cz(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)">
    Apply [`CZGate`](qiskit.circuit.library.CZGate "qiskit.circuit.library.CZGate").
  </Function>

  ### dcx

  <Function id="qiskit.circuit.library.LinearPauliRotations.dcx" name="dcx" signature="LinearPauliRotations.dcx(qubit1, qubit2)">
    Apply [`DCXGate`](qiskit.circuit.library.DCXGate "qiskit.circuit.library.DCXGate").
  </Function>

  ### decompose

  <Function id="qiskit.circuit.library.LinearPauliRotations.decompose" name="decompose" signature="LinearPauliRotations.decompose()">
  ...
  <Function id="qiskit.circuit.library.LinearPauliRotations.depth" name="depth" signature="LinearPauliRotations.depth()">
  ...
  <Function id="qiskit.circuit.library.LinearPauliRotations.diag_gate" name="diag_gate" signature="LinearPauliRotations.diag_gate(diag, qubit)">
    Deprecated version of QuantumCircuit.diagonal.
  </Function>

  ### diagonal

  <Function id="qiskit.circuit.library.LinearPauliRotations.diagonal" name="diagonal" signature="LinearPauliRotations.diagonal(diag, qubit)">
  ...
  <Function id="qiskit.circuit.library.LinearPauliRotations.extend" name="extend" signature="LinearPauliRotations.extend(rhs)">
  ...
  <Function id="qiskit.circuit.library.LinearPauliRotations.fredkin" name="fredkin" signature="LinearPauliRotations.fredkin(control_qubit, target_qubit1, target_qubit2, *, ctl=None, tgt1=None, tgt2=None)">
    Apply [`CSwapGate`](qiskit.circuit.library.CSwapGate "qiskit.circuit.library.CSwapGate").
  </Function>

  ### from\_qasm\_file

  <Function id="qiskit.circuit.library.LinearPauliRotations.from_qasm_file" name="from_qasm_file" signature="static LinearPauliRotations.from_qasm_file(path)">
  ...
  <Function id="qiskit.circuit.library.LinearPauliRotations.from_qasm_str" name="from_qasm_str" signature="static LinearPauliRotations.from_qasm_str(qasm_str)">
  ...
  <Function id="qiskit.circuit.library.LinearPauliRotations.h" name="h" signature="LinearPauliRotations.h(qubit, *, q=None)">
    Apply [`HGate`](qiskit.circuit.library.HGate "qiskit.circuit.library.HGate").
  </Function>

  ### hamiltonian

  <Function id="qiskit.circuit.library.LinearPauliRotations.hamiltonian" name="hamiltonian" signature="LinearPauliRotations.hamiltonian(operator, time, qubits, label=None)">
    Apply hamiltonian evolution to to qubits.
  </Function>

  ### has\_register

  <Function id="qiskit.circuit.library.LinearPauliRotations.has_register" name="has_register" signature="LinearPauliRotations.has_register(register)">
  ...
  <Function id="qiskit.circuit.library.LinearPauliRotations.i" name="i" signature="LinearPauliRotations.i(qubit, *, q=None)">
    Apply [`IGate`](qiskit.circuit.library.IGate "qiskit.circuit.library.IGate").
  </Function>

  ### id

  <Function id="qiskit.circuit.library.LinearPauliRotations.id" name="id" signature="LinearPauliRotations.id(qubit, *, q=None)">
    Apply [`IGate`](qiskit.circuit.library.IGate "qiskit.circuit.library.IGate").
  </Function>

  ### iden

  <Function id="qiskit.circuit.library.LinearPauliRotations.iden" name="iden" signature="LinearPauliRotations.iden(qubit, *, q=None)">
    Deprecated identity gate.
  </Function>

  ### initialize

  <Function id="qiskit.circuit.library.LinearPauliRotations.initialize" name="initialize" signature="LinearPauliRotations.initialize(params, qubits)">
    Apply initialize to circuit.
  </Function>

  ### inverse

  <Function id="qiskit.circuit.library.LinearPauliRotations.inverse" name="inverse" signature="LinearPauliRotations.inverse()">
    Invert this circuit.
  ...
  <Function id="qiskit.circuit.library.LinearPauliRotations.iso" name="iso" signature="LinearPauliRotations.iso(isometry, q_input, q_ancillas_for_output, q_ancillas_zero=None, q_ancillas_dirty=None)">
  ...
  <Function id="qiskit.circuit.library.LinearPauliRotations.isometry" name="isometry" signature="LinearPauliRotations.isometry(isometry, q_input, q_ancillas_for_output, q_ancillas_zero=None, q_ancillas_dirty=None)">
    Attach an arbitrary isometry from m to n qubits to a circuit. In particular, this allows to attach arbitrary unitaries on n qubits (m=n) or to prepare any state on n qubits (m=0). The decomposition used here was introduced by Iten et al. in [https://arxiv.org/abs/1501.06911](https://arxiv.org/abs/1501.06911).
  ...
  <Function id="qiskit.circuit.library.LinearPauliRotations.iswap" name="iswap" signature="LinearPauliRotations.iswap(qubit1, qubit2)">
    Apply [`iSwapGate`](qiskit.circuit.library.iSwapGate "qiskit.circuit.library.iSwapGate").
  </Function>

  ### mcmt

  <Function id="qiskit.circuit.library.LinearPauliRotations.mcmt" name="mcmt" signature="LinearPauliRotations.mcmt(gate, control_qubits, target_qubits, ancilla_qubits=None, mode='no-ancilla', *, single_control_gate_fun=None, q_controls=None, q_ancillae=None, q_targets=None)">
  ...
  <Function id="qiskit.circuit.library.LinearPauliRotations.mcrx" name="mcrx" signature="LinearPauliRotations.mcrx(theta, q_controls, q_target, use_basis_gates=False)">
  ...
  <Function id="qiskit.circuit.library.LinearPauliRotations.mcry" name="mcry" signature="LinearPauliRotations.mcry(theta, q_controls, q_target, q_ancillae, mode='basic', use_basis_gates=False)">
  ...
  <Function id="qiskit.circuit.library.LinearPauliRotations.mcrz" name="mcrz" signature="LinearPauliRotations.mcrz(lam, q_controls, q_target, use_basis_gates=False)">
  ...
  <Function id="qiskit.circuit.library.LinearPauliRotations.mct" name="mct" signature="LinearPauliRotations.mct(control_qubits, target_qubit, ancilla_qubits=None, mode='noancilla')">
    Apply `MCXGate`.
  </Function>

  ### mcu1

  <Function id="qiskit.circuit.library.LinearPauliRotations.mcu1" name="mcu1" signature="LinearPauliRotations.mcu1(lam, control_qubits, target_qubit)">
    Apply `MCU1Gate`.
  </Function>

  ### mcx

  <Function id="qiskit.circuit.library.LinearPauliRotations.mcx" name="mcx" signature="LinearPauliRotations.mcx(control_qubits, target_qubit, ancilla_qubits=None, mode='noancilla')">
    Apply `MCXGate`.
  ...
  <Function id="qiskit.circuit.library.LinearPauliRotations.measure" name="measure" signature="LinearPauliRotations.measure(qubit, cbit)">
  ...
  <Function id="qiskit.circuit.library.LinearPauliRotations.measure_active" name="measure_active" signature="LinearPauliRotations.measure_active(inplace=True)">
  ...
  <Function id="qiskit.circuit.library.LinearPauliRotations.measure_all" name="measure_all" signature="LinearPauliRotations.measure_all(inplace=True)">
  ...
  <Function id="qiskit.circuit.library.LinearPauliRotations.mirror" name="mirror" signature="LinearPauliRotations.mirror()">
  ...
  <Function id="qiskit.circuit.library.LinearPauliRotations.ms" name="ms" signature="LinearPauliRotations.ms(theta, qubits)">
    Apply [`MSGate`](qiskit.circuit.library.MSGate "qiskit.circuit.library.MSGate").
  </Function>

  ### num\_connected\_components

  <Function id="qiskit.circuit.library.LinearPauliRotations.num_connected_components" name="num_connected_components" signature="LinearPauliRotations.num_connected_components(unitary_only=False)">
  ...
  <Function id="qiskit.circuit.library.LinearPauliRotations.num_nonlocal_gates" name="num_nonlocal_gates" signature="LinearPauliRotations.num_nonlocal_gates()">
  ...
  <Function id="qiskit.circuit.library.LinearPauliRotations.num_tensor_factors" name="num_tensor_factors" signature="LinearPauliRotations.num_tensor_factors()">
  ...
  <Function id="qiskit.circuit.library.LinearPauliRotations.num_unitary_factors" name="num_unitary_factors" signature="LinearPauliRotations.num_unitary_factors()">
    Computes the number of tensor factors in the unitary (quantum) part of the circuit only.
  </Function>

  ### qasm

  <Function id="qiskit.circuit.library.LinearPauliRotations.qasm" name="qasm" signature="LinearPauliRotations.qasm(formatted=False, filename=None)">
  ...
  <Function id="qiskit.circuit.library.LinearPauliRotations.qbit_argument_conversion" name="qbit_argument_conversion" signature="LinearPauliRotations.qbit_argument_conversion(qubit_representation)">
  ...
  <Function id="qiskit.circuit.library.LinearPauliRotations.r" name="r" signature="LinearPauliRotations.r(theta, phi, qubit, *, q=None)">
    Apply `RGate`.
  </Function>

  ### rcccx

  <Function id="qiskit.circuit.library.LinearPauliRotations.rcccx" name="rcccx" signature="LinearPauliRotations.rcccx(control_qubit1, control_qubit2, control_qubit3, target_qubit)">
    Apply [`RC3XGate`](qiskit.circuit.library.RC3XGate "qiskit.circuit.library.RC3XGate").
  </Function>

  ### rccx

  <Function id="qiskit.circuit.library.LinearPauliRotations.rccx" name="rccx" signature="LinearPauliRotations.rccx(control_qubit1, control_qubit2, target_qubit)">
    Apply [`RCCXGate`](qiskit.circuit.library.RCCXGate "qiskit.circuit.library.RCCXGate").
  </Function>

  ### remove\_final\_measurements

  <Function id="qiskit.circuit.library.LinearPauliRotations.remove_final_measurements" name="remove_final_measurements" signature="LinearPauliRotations.remove_final_measurements(inplace=True)">
  ...
  <Function id="qiskit.circuit.library.LinearPauliRotations.reset" name="reset" signature="LinearPauliRotations.reset(qubit)">
    Reset q.
  </Function>

  ### rx

  <Function id="qiskit.circuit.library.LinearPauliRotations.rx" name="rx" signature="LinearPauliRotations.rx(theta, qubit, *, label=None, q=None)">
    Apply [`RXGate`](qiskit.circuit.library.RXGate "qiskit.circuit.library.RXGate").
  </Function>

  ### rxx

  <Function id="qiskit.circuit.library.LinearPauliRotations.rxx" name="rxx" signature="LinearPauliRotations.rxx(theta, qubit1, qubit2)">
    Apply [`RXXGate`](qiskit.circuit.library.RXXGate "qiskit.circuit.library.RXXGate").
  </Function>

  ### ry

  <Function id="qiskit.circuit.library.LinearPauliRotations.ry" name="ry" signature="LinearPauliRotations.ry(theta, qubit, *, label=None, q=None)">
    Apply [`RYGate`](qiskit.circuit.library.RYGate "qiskit.circuit.library.RYGate").
  </Function>

  ### ryy

  <Function id="qiskit.circuit.library.LinearPauliRotations.ryy" name="ryy" signature="LinearPauliRotations.ryy(theta, qubit1, qubit2)">
    Apply [`RYYGate`](qiskit.circuit.library.RYYGate "qiskit.circuit.library.RYYGate").
  </Function>

  ### rz

  <Function id="qiskit.circuit.library.LinearPauliRotations.rz" name="rz" signature="LinearPauliRotations.rz(phi, qubit, *, q=None)">
    Apply [`RZGate`](qiskit.circuit.library.RZGate "qiskit.circuit.library.RZGate").
  </Function>

  ### rzx

  <Function id="qiskit.circuit.library.LinearPauliRotations.rzx" name="rzx" signature="LinearPauliRotations.rzx(theta, qubit1, qubit2)">
    Apply [`RZXGate`](qiskit.circuit.library.RZXGate "qiskit.circuit.library.RZXGate").
  </Function>

  ### rzz

  <Function id="qiskit.circuit.library.LinearPauliRotations.rzz" name="rzz" signature="LinearPauliRotations.rzz(theta, qubit1, qubit2)">
    Apply [`RZZGate`](qiskit.circuit.library.RZZGate "qiskit.circuit.library.RZZGate").
  </Function>

  ### s

  <Function id="qiskit.circuit.library.LinearPauliRotations.s" name="s" signature="LinearPauliRotations.s(qubit, *, q=None)">
    Apply [`SGate`](qiskit.circuit.library.SGate "qiskit.circuit.library.SGate").
  </Function>

  ### sdg

  <Function id="qiskit.circuit.library.LinearPauliRotations.sdg" name="sdg" signature="LinearPauliRotations.sdg(qubit, *, q=None)">
    Apply [`SdgGate`](qiskit.circuit.library.SdgGate "qiskit.circuit.library.SdgGate").
  </Function>

  ### size

  <Function id="qiskit.circuit.library.LinearPauliRotations.size" name="size" signature="LinearPauliRotations.size()">
  ...
  <Function id="qiskit.circuit.library.LinearPauliRotations.snapshot" name="snapshot" signature="LinearPauliRotations.snapshot(label, snapshot_type='statevector', qubits=None, params=None)">
  ...
  <Function id="qiskit.circuit.library.LinearPauliRotations.snapshot_density_matrix" name="snapshot_density_matrix" signature="LinearPauliRotations.snapshot_density_matrix(label, qubits=None)">
  ...
  <Function id="qiskit.circuit.library.LinearPauliRotations.snapshot_expectation_value" name="snapshot_expectation_value" signature="LinearPauliRotations.snapshot_expectation_value(label, op, qubits, single_shot=False, variance=False)">
  ...
  <Function id="qiskit.circuit.library.LinearPauliRotations.snapshot_probabilities" name="snapshot_probabilities" signature="LinearPauliRotations.snapshot_probabilities(label, qubits, variance=False)">
  ...
  <Function id="qiskit.circuit.library.LinearPauliRotations.snapshot_stabilizer" name="snapshot_stabilizer" signature="LinearPauliRotations.snapshot_stabilizer(label)">
  ...
  <Function id="qiskit.circuit.library.LinearPauliRotations.snapshot_statevector" name="snapshot_statevector" signature="LinearPauliRotations.snapshot_statevector(label)">
  ...
  <Function id="qiskit.circuit.library.LinearPauliRotations.squ" name="squ" signature="LinearPauliRotations.squ(unitary_matrix, qubit, mode='ZYZ', up_to_diagonal=False, *, u=None)">
  ...
  <Function id="qiskit.circuit.library.LinearPauliRotations.swap" name="swap" signature="LinearPauliRotations.swap(qubit1, qubit2)">
    Apply [`SwapGate`](qiskit.circuit.library.SwapGate "qiskit.circuit.library.SwapGate").
  </Function>

  ### t

  <Function id="qiskit.circuit.library.LinearPauliRotations.t" name="t" signature="LinearPauliRotations.t(qubit, *, q=None)">
    Apply [`TGate`](qiskit.circuit.library.TGate "qiskit.circuit.library.TGate").
  </Function>

  ### tdg

  <Function id="qiskit.circuit.library.LinearPauliRotations.tdg" name="tdg" signature="LinearPauliRotations.tdg(qubit, *, q=None)">
    Apply [`TdgGate`](qiskit.circuit.library.TdgGate "qiskit.circuit.library.TdgGate").
  </Function>

  ### to\_gate

  <Function id="qiskit.circuit.library.LinearPauliRotations.to_gate" name="to_gate" signature="LinearPauliRotations.to_gate(parameter_map=None)">
  ...
  <Function id="qiskit.circuit.library.LinearPauliRotations.to_instruction" name="to_instruction" signature="LinearPauliRotations.to_instruction(parameter_map=None)">
  ...
  <Function id="qiskit.circuit.library.LinearPauliRotations.toffoli" name="toffoli" signature="LinearPauliRotations.toffoli(control_qubit1, control_qubit2, target_qubit, *, ctl1=None, ctl2=None, tgt=None)">
    Apply [`CCXGate`](qiskit.circuit.library.CCXGate "qiskit.circuit.library.CCXGate").
  </Function>

  ### u1

  <Function id="qiskit.circuit.library.LinearPauliRotations.u1" name="u1" signature="LinearPauliRotations.u1(theta, qubit, *, q=None)">
    Apply [`U1Gate`](qiskit.circuit.library.U1Gate "qiskit.circuit.library.U1Gate").
  </Function>

  ### u2

  <Function id="qiskit.circuit.library.LinearPauliRotations.u2" name="u2" signature="LinearPauliRotations.u2(phi, lam, qubit, *, q=None)">
    Apply [`U2Gate`](qiskit.circuit.library.U2Gate "qiskit.circuit.library.U2Gate").
  </Function>

  ### u3

  <Function id="qiskit.circuit.library.LinearPauliRotations.u3" name="u3" signature="LinearPauliRotations.u3(theta, phi, lam, qubit, *, q=None)">
    Apply [`U3Gate`](qiskit.circuit.library.U3Gate "qiskit.circuit.library.U3Gate").
  </Function>

  ### uc

  <Function id="qiskit.circuit.library.LinearPauliRotations.uc" name="uc" signature="LinearPauliRotations.uc(gate_list, q_controls, q_target, up_to_diagonal=False)">
  ...
  <Function id="qiskit.circuit.library.LinearPauliRotations.ucg" name="ucg" signature="LinearPauliRotations.ucg(angle_list, q_controls, q_target, up_to_diagonal=False)">
    Deprecated version of uc.
  </Function>

  ### ucrx

  <Function id="qiskit.circuit.library.LinearPauliRotations.ucrx" name="ucrx" signature="LinearPauliRotations.ucrx(angle_list, q_controls, q_target)">
  ...
  <Function id="qiskit.circuit.library.LinearPauliRotations.ucry" name="ucry" signature="LinearPauliRotations.ucry(angle_list, q_controls, q_target)">
  ...
  <Function id="qiskit.circuit.library.LinearPauliRotations.ucrz" name="ucrz" signature="LinearPauliRotations.ucrz(angle_list, q_controls, q_target)">
  ...
  <Function id="qiskit.circuit.library.LinearPauliRotations.ucx" name="ucx" signature="LinearPauliRotations.ucx(angle_list, q_controls, q_target)">
    Deprecated version of ucrx.
  </Function>

  ### ucy

  <Function id="qiskit.circuit.library.LinearPauliRotations.ucy" name="ucy" signature="LinearPauliRotations.ucy(angle_list, q_controls, q_target)">
    Deprecated version of ucry.
  </Function>

  ### ucz

  <Function id="qiskit.circuit.library.LinearPauliRotations.ucz" name="ucz" signature="LinearPauliRotations.ucz(angle_list, q_controls, q_target)">
    Deprecated version of ucrz.
  </Function>

  ### unitary

  <Function id="qiskit.circuit.library.LinearPauliRotations.unitary" name="unitary" signature="LinearPauliRotations.unitary(obj, qubits, label=None)">
    Apply unitary gate to q.
  </Function>

  ### width

  <Function id="qiskit.circuit.library.LinearPauliRotations.width" name="width" signature="LinearPauliRotations.width()">
  ...
  <Function id="qiskit.circuit.library.LinearPauliRotations.x" name="x" signature="LinearPauliRotations.x(qubit, *, label=None, ctrl_state=None, q=None)">
    Apply [`XGate`](qiskit.circuit.library.XGate "qiskit.circuit.library.XGate").
  </Function>

  ### y

  <Function id="qiskit.circuit.library.LinearPauliRotations.y" name="y" signature="LinearPauliRotations.y(qubit, *, q=None)">
    Apply [`YGate`](qiskit.circuit.library.YGate "qiskit.circuit.library.YGate").
  </Function>

  ### z

  <Function id="qiskit.circuit.library.LinearPauliRotations.z" name="z" signature="LinearPauliRotations.z(qubit, *, q=None)">
