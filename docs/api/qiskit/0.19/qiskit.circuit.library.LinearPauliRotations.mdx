...
<span id="qiskit.circuit.library.LinearPauliRotations.AND" />

`LinearPauliRotations.AND(qr_variables, qb_target, qr_ancillae, flags=None, mct_mode='no-ancilla')`
...
<span id="qiskit.circuit.library.LinearPauliRotations.OR" />

`LinearPauliRotations.OR(qr_variables, qb_target, qr_ancillae, flags=None, mct_mode='basic')`
...
<span id="qiskit.circuit.library.LinearPauliRotations.__len__" />
...
`LinearPauliRotations.assign_parameters(param_dict, inplace=False)`
...
`static LinearPauliRotations.cast(value, _type)`
...
`LinearPauliRotations.ccx(control_qubit1, control_qubit2, target_qubit, *, ctl1=None, ctl2=None, tgt=None)`
...
`classmethod LinearPauliRotations.cls_prefix()`
...
`LinearPauliRotations.compose(other, qubits=None, clbits=None, front=False, inplace=False)`
...
`LinearPauliRotations.cry(theta, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)`
...
`LinearPauliRotations.crz(theta, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)`
...
`LinearPauliRotations.cswap(control_qubit, target_qubit1, target_qubit2, *, label=None, ctrl_state=None, ctl=None, tgt1=None, tgt2=None)`
...
`LinearPauliRotations.cu3(theta, phi, lam, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)`
...
`LinearPauliRotations.cx(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)`
...
`LinearPauliRotations.cy(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)`
...
`LinearPauliRotations.cz(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)`
...
`LinearPauliRotations.fredkin(control_qubit, target_qubit1, target_qubit2, *, ctl=None, tgt1=None, tgt2=None)`
...
`static LinearPauliRotations.from_qasm_file(path)`
...
`LinearPauliRotations.h(qubit, *, q=None)`
...
`LinearPauliRotations.hamiltonian(operator, time, qubits, label=None)`
...
`LinearPauliRotations.id(qubit, *, q=None)`

Apply [`IGate`](qiskit.circuit.library.IGate "qiskit.circuit.library.IGate").

### iden

<span id="qiskit.circuit.library.LinearPauliRotations.iden" />

`LinearPauliRotations.iden(qubit, *, q=None)`
...
`LinearPauliRotations.iso(isometry, q_input, q_ancillas_for_output, q_ancillas_zero=None, q_ancillas_dirty=None)`
...
`LinearPauliRotations.mcmt(gate, control_qubits, target_qubits, ancilla_qubits=None, mode='no-ancilla', *, single_control_gate_fun=None, q_controls=None, q_ancillae=None, q_targets=None)`
...
`LinearPauliRotations.mcry(theta, q_controls, q_target, q_ancillae, mode='basic', use_basis_gates=False)`
...
`LinearPauliRotations.mcrz(lam, q_controls, q_target, use_basis_gates=False)`
...
`LinearPauliRotations.measure_active(inplace=True)`
...
`LinearPauliRotations.measure_all(inplace=True)`
...
`LinearPauliRotations.qasm(formatted=False, filename=None)`
...
`LinearPauliRotations.qbit_argument_conversion(qubit_representation)`
...
`LinearPauliRotations.rcccx(control_qubit1, control_qubit2, control_qubit3, target_qubit)`
...
`LinearPauliRotations.rccx(control_qubit1, control_qubit2, target_qubit)`
...
`LinearPauliRotations.rx(theta, qubit, *, label=None, q=None)`
...
`LinearPauliRotations.ry(theta, qubit, *, label=None, q=None)`
...
`LinearPauliRotations.sdg(qubit, *, q=None)`
...
`LinearPauliRotations.snapshot(label, snapshot_type='statevector', qubits=None, params=None)`
...
`LinearPauliRotations.snapshot_expectation_value(label, op, qubits, single_shot=False, variance=False)`
...
`LinearPauliRotations.squ(unitary_matrix, qubit, mode='ZYZ', up_to_diagonal=False, *, u=None)`
...
`LinearPauliRotations.to_gate(parameter_map=None)`
...
`LinearPauliRotations.to_instruction(parameter_map=None)`
...
`LinearPauliRotations.toffoli(control_qubit1, control_qubit2, target_qubit, *, ctl1=None, ctl2=None, tgt=None)`
...
`LinearPauliRotations.u2(phi, lam, qubit, *, q=None)`
...
`LinearPauliRotations.u3(theta, phi, lam, qubit, *, q=None)`
...
<span id="qiskit.circuit.library.LinearPauliRotations.ucg" />

`LinearPauliRotations.ucg(angle_list, q_controls, q_target, up_to_diagonal=False)`
...
`LinearPauliRotations.ucrx(angle_list, q_controls, q_target)`
...
`LinearPauliRotations.ucrz(angle_list, q_controls, q_target)`
...
<span id="qiskit.circuit.library.LinearPauliRotations.ucz" />

`LinearPauliRotations.ucz(angle_list, q_controls, q_target)`
...
`LinearPauliRotations.x(qubit, *, label=None, ctrl_state=None, q=None)`
...
`LinearPauliRotations.y(qubit, *, q=None)`
