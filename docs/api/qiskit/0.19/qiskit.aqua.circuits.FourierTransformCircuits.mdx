...
<Class id="qiskit.aqua.circuits.FourierTransformCircuits" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.7/qiskit/aqua/circuits/fourier_transform_circuits.py" signature="FourierTransformCircuits">
  ...
  <Function id="qiskit.aqua.circuits.FourierTransformCircuits.construct_circuit" name="construct_circuit" signature="static FourierTransformCircuits.construct_circuit(circuit=None, qubits=None, inverse=False, approximation_degree=0, do_swaps=True)">
