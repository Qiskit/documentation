...
<Class id="qiskit.aqua.circuits.FourierTransformCircuits" github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.7/qiskit/aqua/circuits/fourier_transform_circuits.py" signature="FourierTransformCircuits">
