---
title: FourierTransformCircuits (v0.19)
description: API reference for qiskit.aqua.circuits.FourierTransformCircuits in qiskit v0.19
...
<Class id="qiskit.aqua.circuits.FourierTransformCircuits" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.7/qiskit/aqua/circuits/fourier_transform_circuits.py" signature="FourierTransformCircuits" modifiers="class">
  ...
  <span id="fouriertransformcircuits-construct-circuit" />
