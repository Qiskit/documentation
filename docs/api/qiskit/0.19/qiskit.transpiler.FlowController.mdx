...
<Class id="qiskit.transpiler.FlowController" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.14/qiskit/transpiler/runningpassmanager.py" signature="FlowController(passes, options, **partial_controller)">
  ...
  <Attribute id="qiskit.transpiler.FlowController.registered_controllers" signature="= {'condition': , 'do_while': }" />
