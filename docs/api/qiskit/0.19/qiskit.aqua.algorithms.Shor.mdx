...
<Class id="qiskit.aqua.algorithms.Shor" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.7/qiskit/aqua/algorithms/factorizers/shor.py" signature="Shor(N=15, a=2, quantum_instance=None)">
  ...
  *   **quantum\_instance** (`Union`\[[`QuantumInstance`](qiskit.aqua.QuantumInstance "qiskit.aqua.quantum_instance.QuantumInstance"), [`BaseBackend`](qiskit.providers.BaseBackend "qiskit.providers.basebackend.BaseBackend"), `None`]) –
  ...
  <Attribute id="qiskit.aqua.algorithms.Shor.backend" name="backend" signature="qiskit.providers.basebackend.BaseBackend">
    Returns backend.
  ...
  <Attribute id="qiskit.aqua.algorithms.Shor.quantum_instance" name="quantum_instance" signature="Union[None, qiskit.aqua.quantum_instance.QuantumInstance]">
  ...
  <Attribute id="qiskit.aqua.algorithms.Shor.random" name="random">
  ...
  <Function id="qiskit.aqua.algorithms.Shor.construct_circuit" name="construct_circuit" signature="Shor.construct_circuit(measurement=False)">
    Construct circuit.
  ...
  <Function id="qiskit.aqua.algorithms.Shor.run" name="run" signature="Shor.run(quantum_instance=None, **kwargs)">
  ...
  <Function id="qiskit.aqua.algorithms.Shor.set_backend" name="set_backend" signature="Shor.set_backend(backend, **kwargs)">
