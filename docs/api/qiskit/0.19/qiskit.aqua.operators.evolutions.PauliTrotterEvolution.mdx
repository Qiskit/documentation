---
title: PauliTrotterEvolution (v0.19)
description: API reference for qiskit.aqua.operators.evolutions.PauliTrotterEvolution in qiskit v0.19
...
<Class id="qiskit.aqua.operators.evolutions.PauliTrotterEvolution" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.7/qiskit/aqua/operators/evolutions/pauli_trotter_evolution.py" signature="PauliTrotterEvolution(trotter_mode='trotter', reps=1)" modifiers="class">
  ...
  *   **Pauli.** (*# rather than each*) –
  ...
  <span id="paulitrotterevolution-trotter" />
  ...
  <span id="paulitrotterevolution-convert" />
  ...
  <span id="paulitrotterevolution-evolution-for-abelian-paulisum" />
  ...
  <span id="paulitrotterevolution-evolution-for-pauli" />
