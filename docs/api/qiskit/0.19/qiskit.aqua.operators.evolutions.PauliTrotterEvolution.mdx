...
<Class id="qiskit.aqua.operators.evolutions.PauliTrotterEvolution" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.7/qiskit/aqua/operators/evolutions/pauli_trotter_evolution.py" signature="PauliTrotterEvolution(trotter_mode='trotter', reps=1)">
  ...
  *   **Pauli.** (*# rather than each*) –
  ...
  <Attribute id="qiskit.aqua.operators.evolutions.PauliTrotterEvolution.trotter" signature="qiskit.aqua.operators.evolutions.trotterizations.trotterization_base.TrotterizationBase">
