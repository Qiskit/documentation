...
<Class id="qiskit.aqua.components.qfts.Standard" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.7/qiskit/aqua/components/qfts/standard.py" signature="Standard(num_qubits)">
  The Standard QFT.
  ...
  **num\_qubits** (`int`) – The number of qubits
  ...
  <Function id="qiskit.aqua.components.qfts.Standard.construct_circuit" name="construct_circuit" signature="Standard.construct_circuit(mode='circuit', qubits=None, circuit=None, do_swaps=True)">
