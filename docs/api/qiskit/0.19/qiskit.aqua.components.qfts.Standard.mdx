...
<Class id="qiskit.aqua.components.qfts.Standard" github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.7/qiskit/aqua/components/qfts/standard.py" signature="Standard(num_qubits)">
  The Standard QFT.
