---
title: QuantumInstance (v0.19)
description: API reference for qiskit.aqua.QuantumInstance in qiskit v0.19
...
<Class id="qiskit.aqua.QuantumInstance" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.7/qiskit/aqua/quantum_instance.py" signature="QuantumInstance(backend, shots=1024, seed_simulator=None, max_credits=10, basis_gates=None, coupling_map=None, initial_layout=None, pass_manager=None, seed_transpiler=None, optimization_level=None, backend_options=None, noise_model=None, timeout=None, wait=5, skip_qobj_validation=True, measurement_error_mitigation_cls=None, cals_matrix_refresh_period=30, measurement_error_mitigation_shots=None, job_callback=None)" modifiers="class">
  ...
  *   [**AquaError**](qiskit.aqua.AquaError "qiskit.aqua.AquaError") – set backend\_options but the backend does not support that
  ...
  <span id="quantuminstance-backend-options-qasm-only" />
  ...
  <span id="quantuminstance-backend" />
  ...
  <span id="quantuminstance-backend-config" />
  ...
  <span id="quantuminstance-backend-name" />
  ...
  <span id="quantuminstance-backend-options" />
  ...
  <span id="quantuminstance-cals-matrix-refresh-period" />
  ...
  <span id="quantuminstance-circuit-summary" />
  ...
  <span id="quantuminstance-compile-config" />
  ...
  <span id="quantuminstance-is-local" />
  ...
  <span id="quantuminstance-is-simulator" />
  ...
  <span id="quantuminstance-is-statevector" />
  ...
  <span id="quantuminstance-measurement-error-mitigation-cls" />
  ...
  <span id="quantuminstance-measurement-error-mitigation-shots" />
  ...
  <span id="quantuminstance-noise-config" />
  ...
  <span id="quantuminstance-qjob-config" />
  ...
  <span id="quantuminstance-run-config" />
  ...
  <span id="quantuminstance-skip-qobj-validation" />
  ...
  <span id="quantuminstance-assemble" />
  ...
  <span id="quantuminstance-cals-matrix" />
  ...
  <span id="quantuminstance-execute" />
  ...
  <span id="quantuminstance-maybe-refresh-cals-matrix" />
  ...
  <span id="quantuminstance-set-config" />
  ...
  <span id="quantuminstance-transpile" />
