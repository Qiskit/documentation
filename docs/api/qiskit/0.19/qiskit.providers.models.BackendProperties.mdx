---
title: BackendProperties (v0.19)
description: API reference for qiskit.providers.models.BackendProperties in qiskit v0.19
...
<Class id="qiskit.providers.models.BackendProperties" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.14/qiskit/providers/models/backendproperties.py" signature="BackendProperties(backend_name, backend_version, last_update_date, qubits, gates, general, **kwargs)" modifiers="class">
  ...
  *   **kwargs** – optional additional fields
  ...
  <span id="backendproperties-frequency" />
  ...
  <span id="backendproperties-from-dict" />
  ...
  <span id="backendproperties-gate-error" />
  ...
  <span id="backendproperties-gate-length" />
  ...
  <span id="backendproperties-gate-property" />
  ...
  <span id="backendproperties-qubit-property" />
  ...
  <span id="backendproperties-readout-error" />
  ...
  <span id="backendproperties-to-dict" />
