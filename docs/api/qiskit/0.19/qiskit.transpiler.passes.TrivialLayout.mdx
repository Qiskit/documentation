---
title: TrivialLayout (v0.19)
description: API reference for qiskit.transpiler.passes.TrivialLayout in qiskit v0.19
...
<Class id="qiskit.transpiler.passes.TrivialLayout" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.14/qiskit/transpiler/passes/layout/trivial_layout.py" signature="TrivialLayout(*args, **kwargs)" modifiers="class">
  ...
  **Raises**
  ...
  <span id="triviallayout-is-analysis-pass" />
  ...
  <span id="triviallayout-is-transformation-pass" />
