...
<Function id="qiskit.assembler.disassemble" github="https://github.com/qiskit/qiskit/tree/stable/0.14/qiskit/assembler/disassemble.py" signature="disassemble(qobj)">
