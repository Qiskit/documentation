...
<Class id="qiskit.aqua.operators.evolutions.EvolvedOp" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.7/qiskit/aqua/operators/evolutions/evolved_op.py" signature="EvolvedOp(primitive, coeff=1.0)">
  ...
  *   **coeff** (`Union`\[`int`, `float`, `complex`, [`ParameterExpression`](qiskit.circuit.ParameterExpression "qiskit.circuit.parameterexpression.ParameterExpression"), `None`]) – A coefficient multiplying the operator
  ...
  <Attribute id="qiskit.aqua.operators.evolutions.EvolvedOp.coeff" name="coeff" signature="Union[int, float, complex, qiskit.circuit.parameterexpression.ParameterExpression]">
  ...
  <Attribute id="qiskit.aqua.operators.evolutions.EvolvedOp.num_qubits" name="num_qubits" signature="int">
  ...
  <Function id="qiskit.aqua.operators.evolutions.EvolvedOp.__mul__" name="__mul__" signature="EvolvedOp.__mul__(other)">
  ...
  <Function id="qiskit.aqua.operators.evolutions.EvolvedOp.compose" name="compose" signature="EvolvedOp.compose(other)">
