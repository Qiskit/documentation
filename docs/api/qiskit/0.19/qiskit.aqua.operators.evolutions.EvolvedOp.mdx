---
title: EvolvedOp (v0.19)
description: API reference for qiskit.aqua.operators.evolutions.EvolvedOp in qiskit v0.19
...
<Class id="qiskit.aqua.operators.evolutions.EvolvedOp" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.7/qiskit/aqua/operators/evolutions/evolved_op.py" signature="EvolvedOp(primitive, coeff=1.0)" modifiers="class">
  ...
  *   **coeff** (`Union`\[`int`, `float`, `complex`, [`ParameterExpression`](qiskit.circuit.ParameterExpression "qiskit.circuit.parameterexpression.ParameterExpression"), `None`]) – A coefficient multiplying the operator
  ...
  <span id="evolvedop-assign-parameters" />
  ...
  <span id="evolvedop-bind-parameters" />
  ...
  <span id="evolvedop-primitive-strings" />
  ...
  <span id="evolvedop-to-circuit-op" />
  ...
  <span id="evolvedop-to-instruction" />
  ...
  <span id="evolvedop-to-legacy-op" />
  ...
  <span id="evolvedop-to-matrix-op" />
