...
<Class id="qiskit.chemistry.algorithms.QEomVQE" github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.7/qiskit/chemistry/algorithms/eigen_solvers/q_eom_vqe.py" signature="QEomVQE(operator, var_form, optimizer, num_orbitals, num_particles, initial_point=None, max_evals_grouped=1, callback=None, qubit_mapping='parity', two_qubit_reduction=True, is_eom_matrix_symmetric=True, active_occupied=None, active_unoccupied=None, se_list=None, de_list=None, z2_symmetries=None, untapered_op=None, aux_operators=None, quantum_instance=None)">
  ...
  **ValueError** – invalid parameter
  ...
  <Attribute id="qiskit.chemistry.algorithms.QEomVQE.aux_operators" signature="Optional[List[Optional[qiskit.aqua.operators.operator_base.OperatorBase]]]">
  ...
  <Attribute id="qiskit.chemistry.algorithms.QEomVQE.backend" signature="qiskit.providers.basebackend.BaseBackend">
    Returns backend.
  ...
  <Attribute id="qiskit.chemistry.algorithms.QEomVQE.expectation" signature="qiskit.aqua.operators.expectations.expectation_base.ExpectationBase">
  ...
  <Attribute id="qiskit.chemistry.algorithms.QEomVQE.initial_point" signature="Optional[numpy.ndarray]">
  ...
  <Attribute id="qiskit.chemistry.algorithms.QEomVQE.operator" signature="Optional[qiskit.aqua.operators.operator_base.OperatorBase]">
    Returns operator
  ...
  <Attribute id="qiskit.chemistry.algorithms.QEomVQE.optimal_params" signature="List[float]">
  ...
  <Attribute id="qiskit.chemistry.algorithms.QEomVQE.optimizer" signature="Optional[qiskit.aqua.components.optimizers.optimizer.Optimizer]">
    Returns optimizer
  ...
  <Attribute id="qiskit.chemistry.algorithms.QEomVQE.quantum_instance" signature="Union[None, qiskit.aqua.quantum_instance.QuantumInstance]">
  ...
  <Attribute id="qiskit.chemistry.algorithms.QEomVQE.var_form" signature="Optional[Union[qiskit.circuit.quantumcircuit.QuantumCircuit, qiskit.aqua.components.variational_forms.variational_form.VariationalForm]]">
