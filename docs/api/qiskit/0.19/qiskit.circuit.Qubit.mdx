...
<Class id="qiskit.circuit.Qubit" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.14/qiskit/circuit/quantumregister.py" signature="Qubit(register, index)">
