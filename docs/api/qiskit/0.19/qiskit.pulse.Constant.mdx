...
$$
  ...
  *   **name** (`Optional`\[`str`]) – Display name for this pulse envelope.
  ...
  <Attribute id="qiskit.pulse.Constant.amp" signature="complex">
  ...
  <Attribute id="qiskit.pulse.Constant.id" signature="int">
  ...
  <Attribute id="qiskit.pulse.Constant.parameters" signature="Dict[str, Any]">
