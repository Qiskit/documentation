...
`InnerProduct(num_qubits)` [GitHub](https://github.com/qiskit/qiskit/tree/stable/0.14/qiskit/circuit/library/boolean_logic/inner_product.py "view source code")
...
<span id="qiskit.circuit.library.InnerProduct.AND" />

`InnerProduct.AND(qr_variables, qb_target, qr_ancillae, flags=None, mct_mode='no-ancilla')`
...
<span id="qiskit.circuit.library.InnerProduct.OR" />

`InnerProduct.OR(qr_variables, qb_target, qr_ancillae, flags=None, mct_mode='basic')`
...
`InnerProduct.append(instruction, qargs=None, cargs=None)`
...
`InnerProduct.assign_parameters(param_dict, inplace=False)`
...
`InnerProduct.cbit_argument_conversion(clbit_representation)`
...
`InnerProduct.ccx(control_qubit1, control_qubit2, target_qubit, *, ctl1=None, ctl2=None, tgt=None)`
...
`InnerProduct.ch(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)`
...
`InnerProduct.cnot(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)`
...
`InnerProduct.compose(other, qubits=None, clbits=None, front=False, inplace=False)`
...
`InnerProduct.crx(theta, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)`
...
`InnerProduct.cry(theta, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)`
...
`InnerProduct.crz(theta, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)`
...
`InnerProduct.cswap(control_qubit, target_qubit1, target_qubit2, *, label=None, ctrl_state=None, ctl=None, tgt1=None, tgt2=None)`
...
`InnerProduct.cu1(theta, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)`
...
`InnerProduct.cu3(theta, phi, lam, control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)`
...
`InnerProduct.cx(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)`
...
`InnerProduct.cy(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)`
...
`InnerProduct.cz(control_qubit, target_qubit, *, label=None, ctrl_state=None, ctl=None, tgt=None)`
...
`InnerProduct.draw(output=None, scale=0.7, filename=None, style=None, interactive=False, line_length=None, plot_barriers=True, reverse_bits=False, justify=None, vertical_compression='medium', idle_wires=True, with_layout=True, fold=None, ax=None, initial_state=False, cregbundle=False)`
...
`InnerProduct.fredkin(control_qubit, target_qubit1, target_qubit2, *, ctl=None, tgt1=None, tgt2=None)`
...
`static InnerProduct.from_qasm_file(path)`
...
`static InnerProduct.from_qasm_str(qasm_str)`
...
`InnerProduct.iso(isometry, q_input, q_ancillas_for_output, q_ancillas_zero=None, q_ancillas_dirty=None)`
...
`InnerProduct.isometry(isometry, q_input, q_ancillas_for_output, q_ancillas_zero=None, q_ancillas_dirty=None)`
...
`InnerProduct.mcmt(gate, control_qubits, target_qubits, ancilla_qubits=None, mode='no-ancilla', *, single_control_gate_fun=None, q_controls=None, q_ancillae=None, q_targets=None)`
...
`InnerProduct.mcrx(theta, q_controls, q_target, use_basis_gates=False)`
...
`InnerProduct.mcrz(lam, q_controls, q_target, use_basis_gates=False)`
...
`InnerProduct.mcx(control_qubits, target_qubit, ancilla_qubits=None, mode='noancilla')`
...
`InnerProduct.measure_active(inplace=True)`
...
`InnerProduct.measure_all(inplace=True)`
...
`InnerProduct.num_connected_components(unitary_only=False)`
...
`InnerProduct.qasm(formatted=False, filename=None)`
...
`InnerProduct.qbit_argument_conversion(qubit_representation)`
...
`InnerProduct.rcccx(control_qubit1, control_qubit2, control_qubit3, target_qubit)`
...
`InnerProduct.rccx(control_qubit1, control_qubit2, target_qubit)`
...
`InnerProduct.rx(theta, qubit, *, label=None, q=None)`
...
`InnerProduct.ry(theta, qubit, *, label=None, q=None)`
...
`InnerProduct.rz(phi, qubit, *, q=None)`
...
`InnerProduct.snapshot(label, snapshot_type='statevector', qubits=None, params=None)`
...
`InnerProduct.snapshot_density_matrix(label, qubits=None)`
...
`InnerProduct.snapshot_expectation_value(label, op, qubits, single_shot=False, variance=False)`
...
`InnerProduct.snapshot_probabilities(label, qubits, variance=False)`
...
`InnerProduct.squ(unitary_matrix, qubit, mode='ZYZ', up_to_diagonal=False, *, u=None)`
...
`InnerProduct.to_gate(parameter_map=None)`
...
`InnerProduct.to_instruction(parameter_map=None)`
...
`InnerProduct.toffoli(control_qubit1, control_qubit2, target_qubit, *, ctl1=None, ctl2=None, tgt=None)`
...
`InnerProduct.u2(phi, lam, qubit, *, q=None)`
...
`InnerProduct.u3(theta, phi, lam, qubit, *, q=None)`
...
`InnerProduct.uc(gate_list, q_controls, q_target, up_to_diagonal=False)`
...
`InnerProduct.ucrx(angle_list, q_controls, q_target)`
...
`InnerProduct.ucry(angle_list, q_controls, q_target)`
...
`InnerProduct.ucrz(angle_list, q_controls, q_target)`
...
`InnerProduct.x(qubit, *, label=None, ctrl_state=None, q=None)`
