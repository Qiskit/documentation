...
<Class id="qiskit.aqua.components.iqfts.IQFT" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.7/qiskit/aqua/components/iqfts/iqft.py" signature="IQFT">
  ...
  <Function id="qiskit.aqua.components.iqfts.IQFT.construct_circuit" name="construct_circuit" signature="IQFT.construct_circuit(mode='circuit', qubits=None, circuit=None, do_swaps=True)">
