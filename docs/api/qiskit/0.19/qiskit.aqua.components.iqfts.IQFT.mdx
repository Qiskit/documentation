...
<Class id="qiskit.aqua.components.iqfts.IQFT" github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.7/qiskit/aqua/components/iqfts/iqft.py" signature="IQFT">
