---
title: QuadraticProgramToQubo (v0.19)
description: API reference for qiskit.optimization.converters.QuadraticProgramToQubo in qiskit v0.19
...
<Class id="qiskit.optimization.converters.QuadraticProgramToQubo" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.7/qiskit/optimization/converters/quadratic_program_to_qubo.py" signature="QuadraticProgramToQubo(penalty=None)" modifiers="class">
  ...
  **penalty** (`Optional`\[`float`]) – Penalty factor to scale equality constraints that are added to objective.
  ...
  <span id="quadraticprogramtoqubo-decode" />
  ...
  <span id="quadraticprogramtoqubo-encode" />
  ...
  <span id="quadraticprogramtoqubo-get-compatibility-msg" />
  ...
  <span id="quadraticprogramtoqubo-is-compatible" />
