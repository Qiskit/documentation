...
<Class id="qiskit.optimization.converters.QuadraticProgramToQubo" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.7/qiskit/optimization/converters/quadratic_program_to_qubo.py" signature="QuadraticProgramToQubo(penalty=None)">
  ...
  **penalty** (`Optional`\[`float`]) – Penalty factor to scale equality constraints that are added to objective.
  ...
  <Function id="qiskit.optimization.converters.QuadraticProgramToQubo.decode" name="decode" signature="QuadraticProgramToQubo.decode(result)">
  ...
  <Function id="qiskit.optimization.converters.QuadraticProgramToQubo.encode" name="encode" signature="QuadraticProgramToQubo.encode(problem)">
