...
<Class id="qiskit.result.BaseReadoutMitigator" github="https://github.com/qiskit/qiskit/tree/stable/1.0/qiskit/result/mitigation/base_readout_mitigator.py" signature="qiskit.result.BaseReadoutMitigator">
  ...
  <Function id="qiskit.result.BaseReadoutMitigator.expectation_value" name="expectation_value" signature="abstract expectation_value(data, diagonal, qubits=None, clbits=None, shots=None)">
  ...
  <Function id="qiskit.result.BaseReadoutMitigator.quasi_probabilities" name="quasi_probabilities" signature="abstract quasi_probabilities(data, qubits=None, clbits=None, shots=None)">
