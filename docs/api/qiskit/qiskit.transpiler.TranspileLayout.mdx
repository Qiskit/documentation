...
<Class id="qiskit.transpiler.TranspileLayout" github="https://github.com/Qiskit/qiskit/tree/stable/1.0/qiskit/transpiler/layout.py#L372-L658" signature="qiskit.transpiler.TranspileLayout(initial_layout, input_qubit_mapping, final_layout=None, _input_qubit_count=None, _output_qubit_list=None)">
