---
title: quantum_info (latest version)
description: API reference for qiskit.quantum_info in the latest version of qiskit
...
|                                                                                                                 |                                                                               |
| --------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------- |
| [`Operator`](quantum-info-operator "qiskit.quantum_info.Operator")(data\[, input\_dims, output\_dims])          | Matrix operator class                                                         |
| [`Pauli`](quantum-info-pauli "qiskit.quantum_info.Pauli")(\[data])                                              | N-qubit Pauli operator.                                                       |
| [`Clifford`](quantum-info-clifford "qiskit.quantum_info.Clifford")(data\[, validate, copy])                     | An N-qubit unitary operator from the Clifford group.                          |
| [`ScalarOp`](quantum-info-scalar-op "qiskit.quantum_info.ScalarOp")(\[dims, coeff])                             | Scalar identity operator class.                                               |
| [`SparseObservable`](quantum-info-sparse-observable "qiskit.quantum_info.SparseObservable")                     | An observable over Pauli bases that stores its data in a qubit-sparse format. |
| [`SparsePauliOp`](quantum-info-sparse-pauli-op "qiskit.quantum_info.SparsePauliOp")(data\[, coeffs, ...])       | Sparse N-qubit operator in a Pauli basis representation.                      |
| [`CNOTDihedral`](quantum-info-cnot-dihedral "qiskit.quantum_info.CNOTDihedral")(\[data, num\_qubits, validate]) | An N-qubit operator from the CNOT-Dihedral group.                             |
| [`PauliList`](quantum-info-pauli-list "qiskit.quantum_info.PauliList")(data)                                    | List of N-qubit Pauli operators.                                              |
| [`pauli_basis`](quantum-info-pauli-basis "qiskit.quantum_info.pauli_basis")(num\_qubits\[, weight])             | Return the ordered PauliList for the n-qubit Pauli basis.                     |
...
|                                                                                                             |                        |
| ----------------------------------------------------------------------------------------------------------- | ---------------------- |
| [`Statevector`](quantum-info-statevector "qiskit.quantum_info.Statevector")(data\[, dims])                  | Statevector class      |
| [`DensityMatrix`](quantum-info-density-matrix "qiskit.quantum_info.DensityMatrix")(data\[, dims])           | DensityMatrix class    |
| [`StabilizerState`](quantum-info-stabilizer-state "qiskit.quantum_info.StabilizerState")(data\[, validate]) | StabilizerState class. |

## Channels

|                                                                                                                 |                                                                  |
| --------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------- |
| [`Choi`](quantum-info-choi "qiskit.quantum_info.Choi")(data\[, input\_dims, output\_dims])                      | Choi-matrix representation of a Quantum Channel.                 |
| [`SuperOp`](quantum-info-super-op "qiskit.quantum_info.SuperOp")(data\[, input\_dims, output\_dims])            | Superoperator representation of a quantum channel.               |
| [`Kraus`](quantum-info-kraus "qiskit.quantum_info.Kraus")(data\[, input\_dims, output\_dims])                   | Kraus representation of a quantum channel.                       |
| [`Stinespring`](quantum-info-stinespring "qiskit.quantum_info.Stinespring")(data\[, input\_dims, output\_dims]) | Stinespring representation of a quantum channel.                 |
| [`Chi`](quantum-info-chi "qiskit.quantum_info.Chi")(data\[, input\_dims, output\_dims])                         | Pauli basis Chi-matrix representation of a quantum channel.      |
| [`PTM`](quantum-info-ptm "qiskit.quantum_info.PTM")(data\[, input\_dims, output\_dims])                         | Pauli Transfer Matrix (PTM) representation of a Quantum Channel. |

## Measures

### average\_gate\_fidelity

<Function id="qiskit.quantum_info.average_gate_fidelity" github="https://github.com/Qiskit/qiskit/tree/stable/1.3/qiskit/quantum_info/operators/measures.py#L145-L204" signature="qiskit.quantum_info.average_gate_fidelity(channel, target=None, require_cp=True, require_tp=False)">
...
$$
  ...
  *   **channel** (*QuantumChannel or* [*Operator*](quantum-info-operator "qiskit.quantum_info.Operator")) – noisy quantum channel.
  *   **target** ([*Operator*](quantum-info-operator "qiskit.quantum_info.Operator") *or None*) – target unitary operator. If None target is the identity operator \[Default: None].
...
<Function id="qiskit.quantum_info.process_fidelity" github="https://github.com/Qiskit/qiskit/tree/stable/1.3/qiskit/quantum_info/operators/measures.py#L34-L142" signature="qiskit.quantum_info.process_fidelity(channel, target=None, require_cp=True, require_tp=True)">
...
$$
  ...
  where $F$ is the [`state_fidelity()`](#qiskit.quantum_info.state_fidelity "qiskit.quantum_info.state_fidelity"), $\rho_{\mathcal{E}} = \Lambda_{\mathcal{E}} / d$ is the normalized [`Choi`](quantum-info-choi "qiskit.quantum_info.Choi") matrix for the channel $\mathcal{E}$, and $d$ is the input dimension of $\mathcal{E}$.
...
$$
  ...
  where $S_{\mathcal{E}}, S_{U}$ are the [`SuperOp`](quantum-info-super-op "qiskit.quantum_info.SuperOp") matrices for the *input* quantum channel $\mathcal{E}$ and *target* unitary $U$ respectively, and $d$ is the input dimension of the channel.

  **Parameters**

  *   **channel** ([*Operator*](quantum-info-operator "qiskit.quantum_info.Operator") *or QuantumChannel*) – input quantum channel.
  *   **target** ([*Operator*](quantum-info-operator "qiskit.quantum_info.Operator") *or QuantumChannel or None*) – target quantum channel. If None target is the identity operator \[Default: None].
  *   **require\_cp** ([*bool*](https://docs.python.org/3/library/functions.html#bool "(in Python v3.13)")) – check if input and target channels are completely-positive and if non-CP log warning containing negative eigenvalues of Choi-matrix \[Default: True].
  *   **require\_tp** ([*bool*](https://docs.python.org/3/library/functions.html#bool "(in Python v3.13)")) – check if input and target channels are trace-preserving and if non-TP log warning containing negative eigenvalues of partial Choi-matrix $Tr_{\text{out}}[\mathcal{E}] - I$ \[Default: True].
...
<Function id="qiskit.quantum_info.gate_error" github="https://github.com/Qiskit/qiskit/tree/stable/1.3/qiskit/quantum_info/operators/measures.py#L207-L251" signature="qiskit.quantum_info.gate_error(channel, target=None, require_cp=True, require_tp=False)">
...
<Function id="qiskit.quantum_info.diamond_norm" github="https://github.com/Qiskit/qiskit/tree/stable/1.3/qiskit/quantum_info/operators/measures.py#L254-L350" signature="qiskit.quantum_info.diamond_norm(choi, solver='SCS', **kwargs)">
  ...
  *   **choi** ([*Choi*](quantum-info-choi "qiskit.quantum_info.Choi") *or QuantumChannel*) – a quantum channel object or Choi-matrix array.
...
<Function id="qiskit.quantum_info.state_fidelity" github="https://github.com/Qiskit/qiskit/tree/stable/1.3/qiskit/quantum_info/states/measures.py#L29-L79" signature="qiskit.quantum_info.state_fidelity(state1, state2, validate=True)">
...
$$
  ...
  *   **state1** ([*Statevector*](quantum-info-statevector "qiskit.quantum_info.Statevector")  *or*[*DensityMatrix*](quantum-info-density-matrix "qiskit.quantum_info.DensityMatrix")) – the first quantum state.
  *   **state2** ([*Statevector*](quantum-info-statevector "qiskit.quantum_info.Statevector")  *or*[*DensityMatrix*](quantum-info-density-matrix "qiskit.quantum_info.DensityMatrix")) – the second quantum state.
...
<Function id="qiskit.quantum_info.purity" github="https://github.com/Qiskit/qiskit/tree/stable/1.3/qiskit/quantum_info/states/measures.py#L82-L102" signature="qiskit.quantum_info.purity(state, validate=True)">
...
$$
  ...
  *   **state** ([*Statevector*](quantum-info-statevector "qiskit.quantum_info.Statevector")  *or*[*DensityMatrix*](quantum-info-density-matrix "qiskit.quantum_info.DensityMatrix")) – a quantum state.
...
<Function id="qiskit.quantum_info.concurrence" github="https://github.com/Qiskit/qiskit/tree/stable/1.3/qiskit/quantum_info/states/measures.py#L165-L222" signature="qiskit.quantum_info.concurrence(state)">
  Calculate the concurrence of a quantum state.

  The concurrence of a bipartite [`Statevector`](quantum-info-statevector "qiskit.quantum_info.Statevector") $|\psi\rangle$ is given by
...
$$
  ...
  **state** ([*Statevector*](quantum-info-statevector "qiskit.quantum_info.Statevector")  *or*[*DensityMatrix*](quantum-info-density-matrix "qiskit.quantum_info.DensityMatrix")) – a 2-qubit quantum state.
...
<Function id="qiskit.quantum_info.entropy" github="https://github.com/Qiskit/qiskit/tree/stable/1.3/qiskit/quantum_info/states/measures.py#L105-L131" signature="qiskit.quantum_info.entropy(state, base=2)">
...
<Function id="qiskit.quantum_info.entanglement_of_formation" github="https://github.com/Qiskit/qiskit/tree/stable/1.3/qiskit/quantum_info/states/measures.py#L225-L257" signature="qiskit.quantum_info.entanglement_of_formation(state)">
...
<Function id="qiskit.quantum_info.mutual_information" github="https://github.com/Qiskit/qiskit/tree/stable/1.3/qiskit/quantum_info/states/measures.py#L134-L162" signature="qiskit.quantum_info.mutual_information(state, base=2)">
...
$$
  ...
  *   **state** ([*Statevector*](quantum-info-statevector "qiskit.quantum_info.Statevector")  *or*[*DensityMatrix*](quantum-info-density-matrix "qiskit.quantum_info.DensityMatrix")) – a bipartite state.
  *   **base** ([*int*](https://docs.python.org/3/library/functions.html#int "(in Python v3.13)")) – the base of the logarithm \[Default: 2].
...
|                                                                                |                                    |
| ------------------------------------------------------------------------------ | ---------------------------------- |
| [`Quaternion`](quantum-info-quaternion "qiskit.quantum_info.Quaternion")(data) | A class representing a Quaternion. |

### partial\_trace

<Function id="qiskit.quantum_info.partial_trace" github="https://github.com/Qiskit/qiskit/tree/stable/1.3/qiskit/quantum_info/states/utils.py#L29-L80" signature="qiskit.quantum_info.partial_trace(state, qargs)">
  Return reduced density matrix by tracing out part of quantum state.

  If all subsystems are traced over this returns the [`trace()`](quantum-info-density-matrix#trace "qiskit.quantum_info.DensityMatrix.trace") of the input state.

  **Parameters**

  *   **state** ([*Statevector*](quantum-info-statevector "qiskit.quantum_info.Statevector")  *or*[*DensityMatrix*](quantum-info-density-matrix "qiskit.quantum_info.DensityMatrix")) – the input state.
  ...
  **Return type**
  ...
  [DensityMatrix](quantum-info-density-matrix "qiskit.quantum_info.DensityMatrix")
...
<Function id="qiskit.quantum_info.schmidt_decomposition" github="https://github.com/Qiskit/qiskit/tree/stable/1.3/qiskit/quantum_info/states/utils.py#L126-L208" signature="qiskit.quantum_info.schmidt_decomposition(state, qargs)">
...
<Function id="qiskit.quantum_info.shannon_entropy" github="https://github.com/Qiskit/qiskit/tree/stable/1.3/qiskit/quantum_info/states/utils.py#L83-L123" signature="qiskit.quantum_info.shannon_entropy(pvec, base=2)">
...
<Function id="qiskit.quantum_info.commutator" github="https://github.com/Qiskit/qiskit/tree/stable/1.3/qiskit/quantum_info/operators/utils/commutator.py#L23-L36" signature="qiskit.quantum_info.commutator(a, b)">
...
<Function id="qiskit.quantum_info.anti_commutator" github="https://github.com/Qiskit/qiskit/tree/stable/1.3/qiskit/quantum_info/operators/utils/anti_commutator.py#L23-L36" signature="qiskit.quantum_info.anti_commutator(a, b)">
...
<Function id="qiskit.quantum_info.double_commutator" github="https://github.com/Qiskit/qiskit/tree/stable/1.3/qiskit/quantum_info/operators/utils/double_commutator.py#L23-L76" signature="qiskit.quantum_info.double_commutator(a, b, c, *, commutator=True)">
...
<Function id="qiskit.quantum_info.random_statevector" github="https://github.com/Qiskit/qiskit/tree/stable/1.3/qiskit/quantum_info/states/random.py#L29-L60" signature="qiskit.quantum_info.random_statevector(dims, seed=None)">
  ...
  **Return type**
  ...
  [Statevector](quantum-info-statevector "qiskit.quantum_info.Statevector")
...
<Function id="qiskit.quantum_info.random_density_matrix" github="https://github.com/Qiskit/qiskit/tree/stable/1.3/qiskit/quantum_info/states/random.py#L63-L98" signature="qiskit.quantum_info.random_density_matrix(dims, rank=None, method='Hilbert-Schmidt', seed=None)">
...
<Function id="qiskit.quantum_info.random_unitary" github="https://github.com/Qiskit/qiskit/tree/stable/1.3/qiskit/quantum_info/operators/random.py#L32-L56" signature="qiskit.quantum_info.random_unitary(dims, seed=None)">
  ...
  **Return type**
  ...
  [Operator](quantum-info-operator "qiskit.quantum_info.Operator")
</Function>

### random\_hermitian

<Function id="qiskit.quantum_info.random_hermitian" github="https://github.com/Qiskit/qiskit/tree/stable/1.3/qiskit/quantum_info/operators/random.py#L59-L102" signature="qiskit.quantum_info.random_hermitian(dims, traceless=False, seed=None)">
...
<Function id="qiskit.quantum_info.random_pauli" github="https://github.com/Qiskit/qiskit/tree/stable/1.3/qiskit/quantum_info/operators/symplectic/random.py#L28-L54" signature="qiskit.quantum_info.random_pauli(num_qubits, group_phase=False, seed=None)">
  ...
  **Return type**
  ...
  [Pauli](quantum-info-pauli "qiskit.quantum_info.Pauli")
</Function>

### random\_clifford

<Function id="qiskit.quantum_info.random_clifford" github="https://github.com/Qiskit/qiskit/tree/stable/1.3/qiskit/quantum_info/operators/symplectic/random.py#L90-L117" signature="qiskit.quantum_info.random_clifford(num_qubits, seed=None)">
  ...
  **Return type**
  ...
  [Clifford](quantum-info-clifford "qiskit.quantum_info.Clifford")
...
<Function id="qiskit.quantum_info.random_quantum_channel" github="https://github.com/Qiskit/qiskit/tree/stable/1.3/qiskit/quantum_info/operators/random.py#L105-L154" signature="qiskit.quantum_info.random_quantum_channel(input_dims=None, output_dims=None, rank=None, seed=None)">
  ...
  **Return type**
  ...
  [Stinespring](quantum-info-stinespring "qiskit.quantum_info.Stinespring")
...
<Function id="qiskit.quantum_info.random_cnotdihedral" github="https://github.com/Qiskit/qiskit/tree/stable/1.3/qiskit/quantum_info/operators/dihedral/random.py#L22-L64" signature="qiskit.quantum_info.random_cnotdihedral(num_qubits, seed=None)">
  ...
  **Return type**
  ...
  [CNOTDihedral](quantum-info-cnot-dihedral "qiskit.quantum_info.CNOTDihedral")
</Function>

### random\_pauli\_list

<Function id="qiskit.quantum_info.random_pauli_list" github="https://github.com/Qiskit/qiskit/tree/stable/1.3/qiskit/quantum_info/operators/symplectic/random.py#L57-L87" signature="qiskit.quantum_info.random_pauli_list(num_qubits, size=1, seed=None, phase=True)">
  ...
  **Return type**
  ...
  [PauliList](quantum-info-pauli-list "qiskit.quantum_info.PauliList")
</Function>
...
<Function id="qiskit.quantum_info.hellinger_distance" github="https://github.com/Qiskit/qiskit/tree/stable/1.3/qiskit/quantum_info/analysis/distance.py#L18-L54" signature="qiskit.quantum_info.hellinger_distance(dist_p, dist_q)">
...
<Function id="qiskit.quantum_info.hellinger_fidelity" github="https://github.com/Qiskit/qiskit/tree/stable/1.3/qiskit/quantum_info/analysis/distance.py#L57-L102" signature="qiskit.quantum_info.hellinger_fidelity(dist_p, dist_q)">
...
|                                                                                                                    |                                                                                                                                                                                                  |
| ------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| [`Z2Symmetries`](quantum-info-z-2-symmetries "qiskit.quantum_info.Z2Symmetries")(symmetries, sq\_paulis, sq\_list) | The \$Z\_2\$ symmetry converter identifies symmetries from the problem hamiltonian and uses them to provide a tapered - more efficient - representation of operators as Paulis for this problem. |
