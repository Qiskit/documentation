...
<span id="qiskit.primitives.BaseSamplerV1" />

`qiskit.primitives.BaseSamplerV1(*, options=None)` [GitHub](https://github.com/qiskit/qiskit/tree/stable/1.0/qiskit/primitives/base/base_sampler.py "view source code")
...
<span id="qiskit.primitives.BaseSamplerV1.options" />
...
<span id="qiskit.primitives.BaseSamplerV1.run" />
...
<span id="qiskit.primitives.BaseSamplerV1.set_options" />
