...
<Class id="qiskit.providers.Options" github="https://github.com/qiskit/qiskit/tree/stable/1.0/qiskit/providers/options.py" signature="qiskit.providers.Options(**kwargs)">
