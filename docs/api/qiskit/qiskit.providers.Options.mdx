...
<Class id="qiskit.providers.Options" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.0/qiskit/providers/options.py#L19-L273" signature="qiskit.providers.Options(**kwargs)">
  ...
  <Attribute id="qiskit.providers.Options.validator" name="validator" />

  ## Methods

  ### get

  <Function id="qiskit.providers.Options.get" name="get" signature="get(k[, d]) → D[k] if k in D, else d.  d defaults to None." />

  ### items

  <Function id="qiskit.providers.Options.items" name="items" signature="items() → a set-like object providing a view on D's items" />

  ### keys

  <Function id="qiskit.providers.Options.keys" name="keys" signature="keys() → a set-like object providing a view on D's keys" />

  ### set\_validator

  <Function id="qiskit.providers.Options.set_validator" name="set_validator" github="https://github.com/Qiskit/qiskit/tree/stable/1.0/qiskit/providers/options.py#L180-L232" signature="set_validator(field, validator_value)">
  ...
  <Function id="qiskit.providers.Options.update_options" name="update_options" github="https://github.com/Qiskit/qiskit/tree/stable/1.0/qiskit/providers/options.py#L234-L256" signature="update_options(**fields)">
    Update options with kwargs
  </Function>

  ### values

  <Function id="qiskit.providers.Options.values" name="values" signature="values() → an object providing a view on D's values" />
</Class>
