...
<Class id="qiskit.providers.Options" github="https://github.com/Qiskit/qiskit/tree/stable/1.0/qiskit/providers/options.py#L19-L273" signature="qiskit.providers.Options(**kwargs)">
