...
<Class id="qiskit.pulse.instructions.TimeBlockade" github="https://github.com/Qiskit/qiskit/tree/stable/1.0/qiskit/pulse/instructions/directives.py#L61-L146" signature="qiskit.pulse.instructions.TimeBlockade(duration, channel, name=None)">
  Bases: `Directive`
