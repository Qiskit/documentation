...
<Class id="qiskit.transpiler.passes.DenseLayout" github="https://github.com/qiskit/qiskit/tree/stable/1.0/qiskit/transpiler/passes/layout/dense_layout.py" signature="qiskit.transpiler.passes.DenseLayout(*args, **kwargs)">
