...
`qiskit.circuit.library.FourierChecking(f, g)` [GitHub](https://github.com/qiskit/qiskit/tree/stable/1.0/qiskit/circuit/library/fourier_checking.py "view source code")
