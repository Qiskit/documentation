...
<Class id="qiskit.transpiler.PassManager" github="https://github.com/Qiskit/qiskit/tree/stable/1.0/qiskit/transpiler/passmanager.py#L37-L213" signature="qiskit.transpiler.PassManager(passes=(), max_iteration=1000)">
