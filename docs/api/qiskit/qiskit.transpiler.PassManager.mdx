...
<Class id="qiskit.transpiler.PassManager" github="https://github.com/qiskit/qiskit/tree/stable/1.0/qiskit/transpiler/passmanager.py" signature="qiskit.transpiler.PassManager(passes=(), max_iteration=1000)">
  ...
  *   **max\_iteration** ([*int*](https://docs.python.org/3/library/functions.html#int "(in Python v3.12)")) – The maximum number of iterations the schedule will be looped if the condition is not met.
  ...
  <Function id="qiskit.transpiler.PassManager.append" name="append" signature="append(passes)">
  ...
  <Function id="qiskit.transpiler.PassManager.replace" name="replace" signature="replace(index, passes)">
  ...
  <Function id="qiskit.transpiler.PassManager.run" name="run" signature="run(circuits, output_name=None, callback=None, num_processes=None)">
