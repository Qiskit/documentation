...
$$
  ...
  <Attribute id="qiskit.circuit.library.CU3Gate.base_class" name="base_class">
  ...
  <Attribute id="qiskit.circuit.library.CU3Gate.condition" name="condition">
  ...
  <Attribute id="qiskit.circuit.library.CU3Gate.mutable" name="mutable">
