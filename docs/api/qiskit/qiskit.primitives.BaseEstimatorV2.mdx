...
<Class id="qiskit.primitives.BaseEstimatorV2" github="https://github.com/qiskit/qiskit/tree/stable/1.0/qiskit/primitives/base/base_estimator.py" signature="qiskit.primitives.BaseEstimatorV2">
  ...
  <Function id="qiskit.primitives.BaseEstimatorV2.run" name="run" signature="abstract run(pubs, *, precision=None)">
