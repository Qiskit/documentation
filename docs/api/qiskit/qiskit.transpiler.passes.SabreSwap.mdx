...
<Class id="qiskit.transpiler.passes.SabreSwap" github="https://github.com/qiskit/qiskit/tree/stable/1.0/qiskit/transpiler/passes/routing/sabre_swap.py" signature="qiskit.transpiler.passes.SabreSwap(*args, **kwargs)">
  ...
  **Raises**
  ...
  <Function id="qiskit.transpiler.passes.SabreSwap.execute" name="execute" signature="execute(passmanager_ir, state, callback=None)">
  ...
  <Function id="qiskit.transpiler.passes.SabreSwap.name" name="name" signature="name()">
    Name of the pass.
  ...
  <Function id="qiskit.transpiler.passes.SabreSwap.run" name="run" signature="run(dag)">
  ...
  <Function id="qiskit.transpiler.passes.SabreSwap.update_status" name="update_status" signature="update_status(state, run_state)">
