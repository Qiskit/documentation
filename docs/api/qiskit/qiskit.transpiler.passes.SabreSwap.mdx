...
<Class id="qiskit.transpiler.passes.SabreSwap" github="https://github.com/Qiskit/qiskit/tree/stable/1.0/qiskit/transpiler/passes/routing/sabre_swap.py#L45-L265" signature="qiskit.transpiler.passes.SabreSwap(*args, **kwargs)">
