...
<Class id="qiskit.transpiler.passes.SabreSwap" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/transpiler/passes/routing/sabre_swap.py#L33-L254" signature="qiskit.transpiler.passes.SabreSwap(*args, **kwargs)" modifiers="class">
  ...
  **Raises**
  ...
  <Attribute id="qiskit.transpiler.passes.SabreSwap.coupling_map" name="coupling_map" headingLevel={3} />

  <Attribute id="qiskit.transpiler.passes.SabreSwap.dist_matrix" name="dist_matrix" headingLevel={3} />

  <Attribute id="qiskit.transpiler.passes.SabreSwap.is_analysis_pass" name="is_analysis_pass" headingLevel={3}>
    Check if the pass is an analysis pass.

    If the pass is an AnalysisPass, that means that the pass can analyze the DAG and write the results of that analysis in the property set. Modifications on the DAG are not allowed by this kind of pass.
  </Attribute>

  <Attribute id="qiskit.transpiler.passes.SabreSwap.is_transformation_pass" name="is_transformation_pass" headingLevel={3}>
