...
<Class id="qiskit.passmanager.MultiStagePassManager" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/passmanager/multistage_passmanager.py#L24-L247" signature="qiskit.passmanager.MultiStagePassManager(**stages)" modifiers="class">
  ...
  *   lower the IR, for example as `Task[IR1, IR2]`.
  ...
  <Admonition title="Note" type="note">
    While [`Task`](qiskit.passmanager.Task "qiskit.passmanager.Task") object defines the task interface, custom passes should only derive from the base class [`GenericPass`](qiskit.passmanager.GenericPass "qiskit.passmanager.GenericPass"). The `Task` base is an internal interface, and later Qiskit releases may place more restrictions on the available types of `Task`.
  </Admonition>
  ...
  **stages** ([*BasePassManager*](qiskit.passmanager.BasePassManager "qiskit.passmanager.passmanager.BasePassManager")*\[*[*Any*](https://docs.python.org/3/library/typing.html#typing.Any)*] |* [*Task*](qiskit.passmanager.Task "qiskit.passmanager.base_tasks.Task")*\[*[*Any*](https://docs.python.org/3/library/typing.html#typing.Any)*,* [*Any*](https://docs.python.org/3/library/typing.html#typing.Any)*] |* [*Iterable*](https://docs.python.org/3/library/collections.abc.html#collections.abc.Iterable)*\[*[*Task*](qiskit.passmanager.Task "qiskit.passmanager.base_tasks.Task")*\[*[*Any*](https://docs.python.org/3/library/typing.html#typing.Any)*,* [*Any*](https://docs.python.org/3/library/typing.html#typing.Any)*]]*) –
