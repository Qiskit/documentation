...
<Class id="qiskit.transpiler.passes.synthesis.hls_plugins.LayerLnnSynthesisClifford" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.4/qiskit/transpiler/passes/synthesis/hls_plugins.py#L569-L584" signature="qiskit.transpiler.passes.synthesis.hls_plugins.LayerLnnSynthesisClifford" modifiers="class">
  ...
  <Function id="qiskit.transpiler.passes.synthesis.hls_plugins.LayerLnnSynthesisClifford.run" github="https://github.com/Qiskit/qiskit/tree/stable/1.4/qiskit/transpiler/passes/synthesis/hls_plugins.py#L578-L584" signature="run(high_level_object, coupling_map=None, target=None, qubits=None, **options)">
