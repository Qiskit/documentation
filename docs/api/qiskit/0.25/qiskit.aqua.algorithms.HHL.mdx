...
$$
  ...
  **ValueError** – Invalid input
  ...
  <Function id="qiskit.aqua.algorithms.HHL.backend" signature="backend" modifiers="property">
    Returns backend.
  ...
  <Function id="qiskit.aqua.algorithms.HHL.quantum_instance" signature="quantum_instance" modifiers="property">
  ...
  <Function id="qiskit.aqua.algorithms.HHL.random" signature="random" modifiers="property">
