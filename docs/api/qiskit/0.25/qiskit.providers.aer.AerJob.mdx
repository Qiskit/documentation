...
<Class id="qiskit.providers.aer.AerJob" github="https://github.com/qiskit/qiskit-aer/tree/stable/0.8/qiskit/providers/aer/aerjob.py" signature="AerJob(backend, job_id, fn, qobj, *args)">
  AerJob class.

  ### \_executor

  <Attribute id="qiskit.providers.aer.AerJob._executor" name="_executor">
  ...
  *   **kwargs** – Any key value metadata to associate with this job.
  ...
  <Function id="qiskit.providers.aer.AerJob.__init__" name="__init__" signature="__init__(backend, job_id, fn, qobj, *args)">
    Initializes the asynchronous job.
  ...
  <Function id="qiskit.providers.aer.AerJob.backend" name="backend" signature="backend()">
    Return the instance of the backend used for this job.
  </Function>

  ### cancel

  <Function id="qiskit.providers.aer.AerJob.cancel" name="cancel" signature="cancel()">
    Attempt to cancel the job.
  </Function>

  ### cancelled

  <Function id="qiskit.providers.aer.AerJob.cancelled" name="cancelled" signature="cancelled()">
  ...
  <Function id="qiskit.providers.aer.AerJob.done" name="done" signature="done()">
  ...
  <Function id="qiskit.providers.aer.AerJob.in_final_state" name="in_final_state" signature="in_final_state()">
  ...
  <Function id="qiskit.providers.aer.AerJob.job_id" name="job_id" signature="job_id()">
  ...
  <Function id="qiskit.providers.aer.AerJob.qobj" name="qobj" signature="qobj()">
  ...
  <Function id="qiskit.providers.aer.AerJob.result" name="result" signature="result(timeout=None)">
  ...
  <Function id="qiskit.providers.aer.AerJob.running" name="running" signature="running()">
  ...
  <Function id="qiskit.providers.aer.AerJob.status" name="status" signature="status()">
  ...
  <Function id="qiskit.providers.aer.AerJob.submit" name="submit" signature="submit()">
  ...
  <Function id="qiskit.providers.aer.AerJob.wait_for_final_state" name="wait_for_final_state" signature="wait_for_final_state(timeout=None, wait=5, callback=None)">
