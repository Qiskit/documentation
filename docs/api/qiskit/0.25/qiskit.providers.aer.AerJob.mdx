---
title: AerJob (v0.25)
description: API reference for qiskit.providers.aer.AerJob in qiskit v0.25
...
<Class id="qiskit.providers.aer.AerJob" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-aer/tree/stable/0.8/qiskit/providers/aer/aerjob.py" signature="AerJob(backend, job_id, fn, qobj, *args)" modifiers="class">
  AerJob class.
