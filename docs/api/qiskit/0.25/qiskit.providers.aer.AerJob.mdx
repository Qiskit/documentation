...
<Class id="qiskit.providers.aer.AerJob" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-aer/tree/stable/0.8/qiskit/providers/aer/aerjob.py" signature="AerJob(backend, job_id, fn, qobj, *args)">
  AerJob class.
