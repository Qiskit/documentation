...
<Class id="qiskit.transpiler.passes.NoiseAdaptiveLayout" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.17/qiskit/transpiler/passes/layout/noise_adaptive_layout.py" signature="NoiseAdaptiveLayout(*args, **kwargs)" modifiers="class">
  ...
  **Raises**
  ...
  <Function id="qiskit.transpiler.passes.NoiseAdaptiveLayout.__init__" signature="__init__(backend_prop)">
    NoiseAdaptiveLayout initializer.
  ...
  <Function id="qiskit.transpiler.passes.NoiseAdaptiveLayout.is_analysis_pass" signature="is_analysis_pass" modifiers="property">
  ...
  <Function id="qiskit.transpiler.passes.NoiseAdaptiveLayout.is_transformation_pass" signature="is_transformation_pass" modifiers="property">
