...
<Class id="qiskit.quantum_info.Quaternion" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.17/qiskit/quantum_info/synthesis/quaternion.py" signature="Quaternion(data)">
  A class representing a Quaternion.

  ### \_\_init\_\_

  <Function id="qiskit.quantum_info.Quaternion.__init__" name="__init__" signature="__init__(data)">
