...
<Class id="qiskit.aqua.algorithms.SklearnSVM" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/aqua/algorithms/classifiers/sklearn_svm/sklearn_svm.py" signature="SklearnSVM(training_dataset, test_dataset=None, datapoints=None, gamma=None, multiclass_extension=None)">
  ...
  **Raises**
  ...
  <Function id="qiskit.aqua.algorithms.SklearnSVM.class_to_label" signature="property class_to_label">
    returns class to label
  </Function>

  ### label\_to\_class

  <Function id="qiskit.aqua.algorithms.SklearnSVM.label_to_class" signature="property label_to_class">
  ...
  <Function id="qiskit.aqua.algorithms.SklearnSVM.random" signature="property random">
    Return a numpy random.
  </Function>

  ### ret

  <Function id="qiskit.aqua.algorithms.SklearnSVM.ret" signature="property ret">
    returns result
  </Function>
