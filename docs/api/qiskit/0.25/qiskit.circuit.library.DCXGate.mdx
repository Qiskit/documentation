...
<Class id="qiskit.circuit.library.DCXGate" github="https://github.com/qiskit/qiskit/tree/stable/0.17/qiskit/circuit/library/standard_gates/dcx.py" signature="DCXGate">
  Double-CNOT gate.
...
$$
  ...
  <Function id="qiskit.circuit.library.DCXGate.soft_compare" name="soft_compare" signature="soft_compare(other)">
