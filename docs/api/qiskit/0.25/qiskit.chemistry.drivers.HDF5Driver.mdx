...
<Class id="qiskit.chemistry.drivers.HDF5Driver" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/chemistry/drivers/hdf5d/hdf5driver.py" signature="HDF5Driver(hdf5_input='molecule.hdf5')">
  ...
  **hdf5\_input** (`str`) – Path to HDF5 file
  ...
  <Function id="qiskit.chemistry.drivers.HDF5Driver.__init__" name="__init__" signature="__init__(hdf5_input='molecule.hdf5')">
    **Parameters**
  ...
  <Function id="qiskit.chemistry.drivers.HDF5Driver.basis" name="basis" signature="property basis">
    return basis
  ...
  <Function id="qiskit.chemistry.drivers.HDF5Driver.hf_method" name="hf_method" signature="property hf_method">
  ...
  <Function id="qiskit.chemistry.drivers.HDF5Driver.molecule" name="molecule" signature="property molecule">
    return molecule
  ...
  <Function id="qiskit.chemistry.drivers.HDF5Driver.run" name="run" signature="run()">
  ...
  <Function id="qiskit.chemistry.drivers.HDF5Driver.supports_molecule" name="supports_molecule" signature="property supports_molecule">
  ...
  <Function id="qiskit.chemistry.drivers.HDF5Driver.work_path" name="work_path" signature="property work_path">
    Returns work path.
  </Function>
</Class>
