...
<Class id="qiskit.transpiler.TransformationPass" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.17/qiskit/transpiler/basepasses.py" signature="TransformationPass(*args, **kwargs)" modifiers="class">
  A transformation pass: change DAG, not property set.

  ### \_\_init\_\_

  <Function id="qiskit.transpiler.TransformationPass.__init__" signature="__init__()">
  ...
  <Function id="qiskit.transpiler.TransformationPass.is_analysis_pass" signature="is_analysis_pass" modifiers="property">
  ...
  <Function id="qiskit.transpiler.TransformationPass.is_transformation_pass" signature="is_transformation_pass" modifiers="property">
