...
<Class id="qiskit.algorithms.optimizers.Optimizer" github="https://github.com/qiskit/qiskit/tree/stable/0.17/qiskit/algorithms/optimizers/optimizer.py" signature="Optimizer">
