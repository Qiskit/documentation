...
<Class id="qiskit.providers.aer.pulse.PulseSystemModel" github="https://github.com/qiskit/qiskit-aer/tree/stable/0.8/qiskit/providers/aer/pulse/system_models/pulse_system_model.py" signature="PulseSystemModel(hamiltonian=None, u_channel_lo=None, control_channel_labels=None, subsystem_list=None, dt=None)">
  ...
  **Raises**
  ...
  <Function id="qiskit.providers.aer.pulse.PulseSystemModel.__init__" name="__init__" signature="__init__(hamiltonian=None, u_channel_lo=None, control_channel_labels=None, subsystem_list=None, dt=None)">
    Initialize a PulseSystemModel.
  ...
  <Function id="qiskit.providers.aer.pulse.PulseSystemModel.calculate_channel_frequencies" name="calculate_channel_frequencies" signature="calculate_channel_frequencies(qubit_lo_freq=None)">
  ...
  <Function id="qiskit.providers.aer.pulse.PulseSystemModel.control_channel_index" name="control_channel_index" signature="control_channel_index(label)">
  ...
  <Function id="qiskit.providers.aer.pulse.PulseSystemModel.from_backend" name="from_backend" signature="classmethod from_backend(backend, subsystem_list=None)">
  ...
  <Function id="qiskit.providers.aer.pulse.PulseSystemModel.from_config" name="from_config" signature="classmethod from_config(configuration, subsystem_list=None)">
