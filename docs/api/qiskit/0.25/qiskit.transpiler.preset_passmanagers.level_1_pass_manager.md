...
`level_1_pass_manager(pass_manager_config)` [GitHub](https://github.com/qiskit/qiskit/tree/stable/0.17/qiskit/transpiler/preset_passmanagers/level1.py "view source code")
