---
title: TwoQubitReduction (v0.25)
description: API reference for qiskit.opflow.converters.TwoQubitReduction in qiskit v0.25
...
<Class id="qiskit.opflow.converters.TwoQubitReduction" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.17/qiskit/opflow/converters/two_qubit_reduction.py" signature="TwoQubitReduction(num_particles)" modifiers="class">
