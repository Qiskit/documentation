...
<Class id="qiskit.ignis.mitigation.ExpvalMeasMitigatorFitter" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-ignis/tree/stable/0.6/qiskit/ignis/mitigation/expval/fitter.py" signature="ExpvalMeasMitigatorFitter(result, metadata)">
  ...
  *   **metadata** (`List`\[`Dict`\[`str`, `any`]]) – mitigation generator metadata.
  ...
  <Function id="qiskit.ignis.mitigation.ExpvalMeasMitigatorFitter.__init__" name="__init__" signature="__init__(result, metadata)">
    Fit a measurement error mitigator object from experiment data.
  ...
  <Function id="qiskit.ignis.mitigation.ExpvalMeasMitigatorFitter.fit" name="fit" signature="fit(method=None, generators=None)">
  ...
  <Function id="qiskit.ignis.mitigation.ExpvalMeasMitigatorFitter.mitigator" name="mitigator" signature="property mitigator">
