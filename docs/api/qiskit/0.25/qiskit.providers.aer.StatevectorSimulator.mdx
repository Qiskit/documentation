...
<Class id="qiskit.providers.aer.StatevectorSimulator" github="https://github.com/qiskit/qiskit-aer/tree/stable/0.8/qiskit/providers/aer/backends/statevector_simulator.py" signature="StatevectorSimulator(configuration=None, properties=None, provider=None, **backend_options)">
  ...
  **Raises**
  ...
  <Function id="qiskit.providers.aer.StatevectorSimulator.run" name="run" signature="run(circuits, backend_options=None, validate=False, **run_options)">
  ...
  <Function id="qiskit.providers.aer.StatevectorSimulator.set_option" name="set_option" signature="set_option(key, value)">
  ...
  <Function id="qiskit.providers.aer.StatevectorSimulator.set_options" name="set_options" signature="set_options(**fields)">
