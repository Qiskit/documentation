...
<Class id="qiskit.aqua.operators.list_ops.SummedOp" github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/aqua/operators/list_ops/summed_op.py" signature="SummedOp(oplist, coeff=1.0, abelian=False)">
  ...
  *   **abelian** (`bool`) – Indicates whether the Operators in `oplist` are known to mutually commute.
  ...
  <Function id="qiskit.aqua.operators.list_ops.SummedOp.__init__" name="__init__" signature="__init__(oplist, coeff=1.0, abelian=False)">
    **Parameters**
  ...
  <Function id="qiskit.aqua.operators.list_ops.SummedOp.abelian" name="abelian" signature="property abelian">
  ...
  <Function id="qiskit.aqua.operators.list_ops.SummedOp.add" name="add" signature="add(other)">
  ...
  <Function id="qiskit.aqua.operators.list_ops.SummedOp.adjoint" name="adjoint" signature="adjoint()">
  ...
  <Function id="qiskit.aqua.operators.list_ops.SummedOp.assign_parameters" name="assign_parameters" signature="assign_parameters(param_dict)">
  ...
  <Function id="qiskit.aqua.operators.list_ops.SummedOp.bind_parameters" name="bind_parameters" signature="bind_parameters(param_dict)">
  ...
  <Function id="qiskit.aqua.operators.list_ops.SummedOp.coeff" name="coeff" signature="property coeff">
  ...
  <Function id="qiskit.aqua.operators.list_ops.SummedOp.collapse_summands" name="collapse_summands" signature="collapse_summands()">
  ...
  <Function id="qiskit.aqua.operators.list_ops.SummedOp.combo_fn" name="combo_fn" signature="property combo_fn">
  ...
  <Function id="qiskit.aqua.operators.list_ops.SummedOp.compose" name="compose" signature="compose(other, permutation=None, front=False)">
  ...
  <Function id="qiskit.aqua.operators.list_ops.SummedOp.distributive" name="distributive" signature="property distributive">
  ...
  <Function id="qiskit.aqua.operators.list_ops.SummedOp.equals" name="equals" signature="equals(other)">
  ...
  <Function id="qiskit.aqua.operators.list_ops.SummedOp.eval" name="eval" signature="eval(front=None)">
  ...
  <Function id="qiskit.aqua.operators.list_ops.SummedOp.exp_i" name="exp_i" signature="exp_i()">
  ...
  <Function id="qiskit.aqua.operators.list_ops.SummedOp.grad_combo_fn" name="grad_combo_fn" signature="property grad_combo_fn">
  ...
  <Function id="qiskit.aqua.operators.list_ops.SummedOp.log_i" name="log_i" signature="log_i(massive=False)">
  ...
  <Function id="qiskit.aqua.operators.list_ops.SummedOp.mul" name="mul" signature="mul(scalar)">
  ...
  <Function id="qiskit.aqua.operators.list_ops.SummedOp.neg" name="neg" signature="neg()">
  ...
  <Function id="qiskit.aqua.operators.list_ops.SummedOp.num_qubits" name="num_qubits" signature="property num_qubits">
  ...
  <Function id="qiskit.aqua.operators.list_ops.SummedOp.oplist" name="oplist" signature="property oplist">
  ...
  <Function id="qiskit.aqua.operators.list_ops.SummedOp.parameters" name="parameters" signature="property parameters">
    Return a set of Parameter objects contained in the Operator.
  </Function>

  ### permute

  <Function id="qiskit.aqua.operators.list_ops.SummedOp.permute" name="permute" signature="permute(permutation)">
  ...
  <Function id="qiskit.aqua.operators.list_ops.SummedOp.power" name="power" signature="power(exponent)">
  ...
  <Function id="qiskit.aqua.operators.list_ops.SummedOp.primitive_strings" name="primitive_strings" signature="primitive_strings()">
  ...
  <Function id="qiskit.aqua.operators.list_ops.SummedOp.print_details" name="print_details" signature="print_details()">
    Print out the operator in details. :returns: a formatted string describes the operator. :rtype: str
  </Function>

  ### reduce

  <Function id="qiskit.aqua.operators.list_ops.SummedOp.reduce" name="reduce" signature="reduce()">
  ...
  <Function id="qiskit.aqua.operators.list_ops.SummedOp.tensor" name="tensor" signature="tensor(other)">
  ...
  <Function id="qiskit.aqua.operators.list_ops.SummedOp.tensorpower" name="tensorpower" signature="tensorpower(other)">
  ...
  <Function id="qiskit.aqua.operators.list_ops.SummedOp.to_circuit" name="to_circuit" signature="to_circuit()">
  ...
  <Function id="qiskit.aqua.operators.list_ops.SummedOp.to_circuit_op" name="to_circuit_op" signature="to_circuit_op()">
  ...
  <Function id="qiskit.aqua.operators.list_ops.SummedOp.to_legacy_op" name="to_legacy_op" signature="to_legacy_op(massive=False)">
  ...
  <Function id="qiskit.aqua.operators.list_ops.SummedOp.to_matrix" name="to_matrix" signature="to_matrix(massive=False)">
  ...
  <Function id="qiskit.aqua.operators.list_ops.SummedOp.to_matrix_op" name="to_matrix_op" signature="to_matrix_op(massive=False)">
  ...
  <Function id="qiskit.aqua.operators.list_ops.SummedOp.to_pauli_op" name="to_pauli_op" signature="to_pauli_op(massive=False)">
  ...
  <Function id="qiskit.aqua.operators.list_ops.SummedOp.to_spmatrix" name="to_spmatrix" signature="to_spmatrix()">
  ...
  <Function id="qiskit.aqua.operators.list_ops.SummedOp.traverse" name="traverse" signature="traverse(convert_fn, coeff=None)">
