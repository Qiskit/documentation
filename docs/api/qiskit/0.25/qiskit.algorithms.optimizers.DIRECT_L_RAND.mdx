...
<Class id="qiskit.algorithms.optimizers.DIRECT_L_RAND" github="https://github.com/qiskit/qiskit/tree/stable/0.17/qiskit/algorithms/optimizers/nlopts/direct_l_rand.py" signature="DIRECT_L_RAND(max_evals=1000)">
