...
<Class id="qiskit.transpiler.AnalysisPass" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.17/qiskit/transpiler/basepasses.py" signature="AnalysisPass(*args, **kwargs)">
  An analysis pass: change property set, not DAG.

  ### \_\_init\_\_

  <Function id="qiskit.transpiler.AnalysisPass.__init__" name="__init__" signature="__init__()">
  ...
  <Function id="qiskit.transpiler.AnalysisPass.is_analysis_pass" name="is_analysis_pass" signature="property is_analysis_pass">
  ...
  <Function id="qiskit.transpiler.AnalysisPass.is_transformation_pass" name="is_transformation_pass" signature="property is_transformation_pass">
