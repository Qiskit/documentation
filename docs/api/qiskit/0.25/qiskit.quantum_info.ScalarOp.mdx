...
<Class id="qiskit.quantum_info.ScalarOp" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.17/qiskit/quantum_info/operators/scalar_op.py" signature="ScalarOp(dims=None, coeff=1)" modifiers="class">
  ...
  **QiskitError** – If the optional coefficient is invalid.
  ...
  <Function id="qiskit.quantum_info.ScalarOp.atol" signature="atol" modifiers="property">
    Default absolute tolerance parameter for float comparisons.
  </Function>

  ### coeff

  <Function id="qiskit.quantum_info.ScalarOp.coeff" signature="coeff" modifiers="property">
  ...
  <Function id="qiskit.quantum_info.ScalarOp.dim" signature="dim" modifiers="property">
  ...
  <Function id="qiskit.quantum_info.ScalarOp.num_qubits" signature="num_qubits" modifiers="property">
  ...
  <Function id="qiskit.quantum_info.ScalarOp.qargs" signature="qargs" modifiers="property">
  ...
  <Function id="qiskit.quantum_info.ScalarOp.rtol" signature="rtol" modifiers="property">
