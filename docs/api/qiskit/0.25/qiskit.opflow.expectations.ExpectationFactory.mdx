...
description: API reference for qiskit.opflow.expectations.ExpectationFactory in qiskit v0.25
...
<Class id="qiskit.opflow.expectations.ExpectationFactory" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.17/qiskit/opflow/expectations/expectation_factory.py" signature="ExpectationFactory" modifiers="class">
  ...
  <Function id="qiskit.opflow.expectations.ExpectationFactory.__init__" signature="__init__()">
