...
<Class id="qiskit.opflow.expectations.ExpectationFactory" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.17/qiskit/opflow/expectations/expectation_factory.py" signature="ExpectationFactory">
  ...
  <Function id="qiskit.opflow.expectations.ExpectationFactory.__init__" name="__init__" signature="__init__()">
  ...
  <Function id="qiskit.opflow.expectations.ExpectationFactory.build" name="build" signature="static build(operator, backend=None, include_custom=True)">
