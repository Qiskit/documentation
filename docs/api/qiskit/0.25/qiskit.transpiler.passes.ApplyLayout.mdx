...
<Class id="qiskit.transpiler.passes.ApplyLayout" github="https://github.com/qiskit/qiskit/tree/stable/0.17/qiskit/transpiler/passes/layout/apply_layout.py" signature="ApplyLayout(*args, **kwargs)">
