...
<Class id="qiskit.aqua.operators.expectations.ExpectationFactory" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/aqua/operators/expectations/expectation_factory.py" signature="ExpectationFactory">
  ...
  <Function id="qiskit.aqua.operators.expectations.ExpectationFactory.__init__" name="__init__" signature="__init__()">
  ...
  <Function id="qiskit.aqua.operators.expectations.ExpectationFactory.build" name="build" signature="static build(operator, backend=None, include_custom=True)">
