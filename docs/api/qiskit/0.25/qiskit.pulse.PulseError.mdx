...
<Class id="qiskit.pulse.PulseError" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.17/qiskit/pulse/exceptions.py" signature="PulseError(*message)">
