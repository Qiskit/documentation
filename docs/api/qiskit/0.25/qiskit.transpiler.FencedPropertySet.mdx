...
<Class id="qiskit.transpiler.FencedPropertySet" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.17/qiskit/transpiler/fencedobjs.py" signature="FencedPropertySet(property_set_instance)">
  A property set that cannot be written (via \_\_setitem\_\_)

  ### \_\_init\_\_

  <Function id="qiskit.transpiler.FencedPropertySet.__init__" name="__init__" signature="__init__(property_set_instance)">
