...
<Class id="qiskit.aqua.circuits.WeightedSumOperator" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/aqua/circuits/weighted_sum_operator.py" signature="WeightedSumOperator(num_state_qubits, weights, i_state=None, i_sum=None)" modifiers="class">
  ...
  **Raises**
  ...
  <Function id="qiskit.aqua.circuits.WeightedSumOperator.num_carry_qubits" signature="num_carry_qubits" modifiers="property">
    returns num carry qubits
  </Function>

  ### num\_state\_qubits

  <Function id="qiskit.aqua.circuits.WeightedSumOperator.num_state_qubits" signature="num_state_qubits" modifiers="property">
    returns num state qubits
  </Function>

  ### num\_sum\_qubits

  <Function id="qiskit.aqua.circuits.WeightedSumOperator.num_sum_qubits" signature="num_sum_qubits" modifiers="property">
    returns num sum qubits
  </Function>

  ### num\_target\_qubits

  <Function id="qiskit.aqua.circuits.WeightedSumOperator.num_target_qubits" signature="num_target_qubits" modifiers="property">
  ...
  <Function id="qiskit.aqua.circuits.WeightedSumOperator.weights" signature="weights" modifiers="property">
    returns weights
  </Function>
</Class>
