...
<Function id="qiskit.quantum_info.random_stabilizer_table" name="random_stabilizer_table" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.17/qiskit/quantum_info/operators/symplectic/random.py" signature="random_stabilizer_table(num_qubits, size=1, seed=None)">
