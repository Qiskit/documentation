...
<Class id="qiskit.circuit.library.TwoLocal" github="https://github.com/qiskit/qiskit/tree/stable/0.17/qiskit/circuit/library/n_local/two_local.py" signature="TwoLocal(num_qubits=None, rotation_blocks=None, entanglement_blocks=None, entanglement='full', reps=3, skip_unentangled_qubits=False, skip_final_rotation_layer=False, parameter_prefix='θ', insert_barriers=False, initial_state=None)">
  ...
  *   **initial\_state** (`Optional`\[`Any`]) – A QuantumCircuit object to prepend to the circuit.
  ...
  <Function id="qiskit.circuit.library.TwoLocal.__init__" name="__init__" signature="__init__(num_qubits=None, rotation_blocks=None, entanglement_blocks=None, entanglement='full', reps=3, skip_unentangled_qubits=False, skip_final_rotation_layer=False, parameter_prefix='θ', insert_barriers=False, initial_state=None)">
    Construct a new two-local circuit.
  ...
  <Function id="qiskit.circuit.library.TwoLocal.add_bits" name="add_bits" signature="add_bits(bits)">
    Add Bits to the circuit.
  </Function>

  ### add\_calibration

  <Function id="qiskit.circuit.library.TwoLocal.add_calibration" name="add_calibration" signature="add_calibration(gate, qubits, schedule, params=None)">
  ...
  <Function id="qiskit.circuit.library.TwoLocal.add_layer" name="add_layer" signature="add_layer(other, entanglement=None, front=False)">
  ...
  <Function id="qiskit.circuit.library.TwoLocal.add_register" name="add_register" signature="add_register(*regs)">
    Add registers.
  </Function>

  ### ancillas

  <Function id="qiskit.circuit.library.TwoLocal.ancillas" name="ancillas" signature="property ancillas">
    Returns a list of ancilla bits in the order that the registers were added.
  </Function>

  ### append

  <Function id="qiskit.circuit.library.TwoLocal.append" name="append" signature="append(instruction, qargs=None, cargs=None)">
  ...
  <Function id="qiskit.circuit.library.TwoLocal.assign_parameters" name="assign_parameters" signature="assign_parameters(parameters, inplace=False, param_dict=None)">
  ...
  <Function id="qiskit.circuit.library.TwoLocal.barrier" name="barrier" signature="barrier(*qargs)">
    Apply `Barrier`. If qargs is None, applies to all.
  </Function>

  ### bind\_parameters

  <Function id="qiskit.circuit.library.TwoLocal.bind_parameters" name="bind_parameters" signature="bind_parameters(values, value_dict=None)">
  ...
  <Function id="qiskit.circuit.library.TwoLocal.calibrations" name="calibrations" signature="property calibrations">
  ...
  <Function id="qiskit.circuit.library.TwoLocal.cast" name="cast" signature="static cast(value, _type)">
    Best effort to cast value to type. Otherwise, returns the value.
  </Function>

  ### cbit\_argument\_conversion

  <Function id="qiskit.circuit.library.TwoLocal.cbit_argument_conversion" name="cbit_argument_conversion" signature="cbit_argument_conversion(clbit_representation)">
  ...
  <Function id="qiskit.circuit.library.TwoLocal.ccx" name="ccx" signature="ccx(control_qubit1, control_qubit2, target_qubit)">
    Apply [`CCXGate`](qiskit.circuit.library.CCXGate "qiskit.circuit.library.CCXGate").
  </Function>

  ### ch

  <Function id="qiskit.circuit.library.TwoLocal.ch" name="ch" signature="ch(control_qubit, target_qubit, label=None, ctrl_state=None)">
    Apply [`CHGate`](qiskit.circuit.library.CHGate "qiskit.circuit.library.CHGate").
  </Function>

  ### clbits

  <Function id="qiskit.circuit.library.TwoLocal.clbits" name="clbits" signature="property clbits">
    Returns a list of classical bits in the order that the registers were added.
  </Function>

  ### cls\_instances

  <Function id="qiskit.circuit.library.TwoLocal.cls_instances" name="cls_instances" signature="classmethod cls_instances()">
    Return the current number of instances of this class, useful for auto naming.
  </Function>

  ### cls\_prefix

  <Function id="qiskit.circuit.library.TwoLocal.cls_prefix" name="cls_prefix" signature="classmethod cls_prefix()">
    Return the prefix to use for auto naming.
  </Function>

  ### cnot

  <Function id="qiskit.circuit.library.TwoLocal.cnot" name="cnot" signature="cnot(control_qubit, target_qubit, label=None, ctrl_state=None)">
    Apply [`CXGate`](qiskit.circuit.library.CXGate "qiskit.circuit.library.CXGate").
  </Function>

  ### combine

  <Function id="qiskit.circuit.library.TwoLocal.combine" name="combine" signature="combine(rhs)">
  ...
  <Function id="qiskit.circuit.library.TwoLocal.compose" name="compose" signature="compose(other, qubits=None, clbits=None, front=False, inplace=False)">
  ...
  <Function id="qiskit.circuit.library.TwoLocal.control" name="control" signature="control(num_ctrl_qubits=1, label=None, ctrl_state=None)">
  ...
  <Function id="qiskit.circuit.library.TwoLocal.copy" name="copy" signature="copy(name=None)">
    Copy the circuit.
  ...
  <Function id="qiskit.circuit.library.TwoLocal.count_ops" name="count_ops" signature="count_ops()">
  ...
  <Function id="qiskit.circuit.library.TwoLocal.cp" name="cp" signature="cp(theta, control_qubit, target_qubit, label=None, ctrl_state=None)">
    Apply [`CPhaseGate`](qiskit.circuit.library.CPhaseGate "qiskit.circuit.library.CPhaseGate").
  </Function>

  ### crx

  <Function id="qiskit.circuit.library.TwoLocal.crx" name="crx" signature="crx(theta, control_qubit, target_qubit, label=None, ctrl_state=None)">
    Apply [`CRXGate`](qiskit.circuit.library.CRXGate "qiskit.circuit.library.CRXGate").
  </Function>

  ### cry

  <Function id="qiskit.circuit.library.TwoLocal.cry" name="cry" signature="cry(theta, control_qubit, target_qubit, label=None, ctrl_state=None)">
    Apply [`CRYGate`](qiskit.circuit.library.CRYGate "qiskit.circuit.library.CRYGate").
  </Function>

  ### crz

  <Function id="qiskit.circuit.library.TwoLocal.crz" name="crz" signature="crz(theta, control_qubit, target_qubit, label=None, ctrl_state=None)">
    Apply [`CRZGate`](qiskit.circuit.library.CRZGate "qiskit.circuit.library.CRZGate").
  </Function>

  ### cswap

  <Function id="qiskit.circuit.library.TwoLocal.cswap" name="cswap" signature="cswap(control_qubit, target_qubit1, target_qubit2, label=None, ctrl_state=None)">
    Apply [`CSwapGate`](qiskit.circuit.library.CSwapGate "qiskit.circuit.library.CSwapGate").
  </Function>

  ### csx

  <Function id="qiskit.circuit.library.TwoLocal.csx" name="csx" signature="csx(control_qubit, target_qubit, label=None, ctrl_state=None)">
    Apply [`CSXGate`](qiskit.circuit.library.CSXGate "qiskit.circuit.library.CSXGate").
  </Function>

  ### cu

  <Function id="qiskit.circuit.library.TwoLocal.cu" name="cu" signature="cu(theta, phi, lam, gamma, control_qubit, target_qubit, label=None, ctrl_state=None)">
    Apply [`CUGate`](qiskit.circuit.library.CUGate "qiskit.circuit.library.CUGate").
  </Function>

  ### cu1

  <Function id="qiskit.circuit.library.TwoLocal.cu1" name="cu1" signature="cu1(theta, control_qubit, target_qubit, label=None, ctrl_state=None)">
    Apply [`CU1Gate`](qiskit.circuit.library.CU1Gate "qiskit.circuit.library.CU1Gate").
  </Function>

  ### cu3

  <Function id="qiskit.circuit.library.TwoLocal.cu3" name="cu3" signature="cu3(theta, phi, lam, control_qubit, target_qubit, label=None, ctrl_state=None)">
    Apply [`CU3Gate`](qiskit.circuit.library.CU3Gate "qiskit.circuit.library.CU3Gate").
  </Function>

  ### cx

  <Function id="qiskit.circuit.library.TwoLocal.cx" name="cx" signature="cx(control_qubit, target_qubit, label=None, ctrl_state=None)">
    Apply [`CXGate`](qiskit.circuit.library.CXGate "qiskit.circuit.library.CXGate").
  </Function>

  ### cy

  <Function id="qiskit.circuit.library.TwoLocal.cy" name="cy" signature="cy(control_qubit, target_qubit, label=None, ctrl_state=None)">
    Apply [`CYGate`](qiskit.circuit.library.CYGate "qiskit.circuit.library.CYGate").
  </Function>

  ### cz

  <Function id="qiskit.circuit.library.TwoLocal.cz" name="cz" signature="cz(control_qubit, target_qubit, label=None, ctrl_state=None)">
    Apply [`CZGate`](qiskit.circuit.library.CZGate "qiskit.circuit.library.CZGate").
  </Function>

  ### data

  <Function id="qiskit.circuit.library.TwoLocal.data" name="data" signature="property data">
  ...
  <Function id="qiskit.circuit.library.TwoLocal.dcx" name="dcx" signature="dcx(qubit1, qubit2)">
    Apply [`DCXGate`](qiskit.circuit.library.DCXGate "qiskit.circuit.library.DCXGate").
  </Function>

  ### decompose

  <Function id="qiskit.circuit.library.TwoLocal.decompose" name="decompose" signature="decompose()">
  ...
  <Function id="qiskit.circuit.library.TwoLocal.delay" name="delay" signature="delay(duration, qarg=None, unit='dt')">
  ...
  <Function id="qiskit.circuit.library.TwoLocal.depth" name="depth" signature="depth()">
  ...
  <Function id="qiskit.circuit.library.TwoLocal.diagonal" name="diagonal" signature="diagonal(diag, qubit)">
  ...
  <Function id="qiskit.circuit.library.TwoLocal.ecr" name="ecr" signature="ecr(qubit1, qubit2)">
    Apply [`ECRGate`](qiskit.circuit.library.ECRGate "qiskit.circuit.library.ECRGate").
  </Function>

  ### entanglement

  <Function id="qiskit.circuit.library.TwoLocal.entanglement" name="entanglement" signature="property entanglement">
  ...
  <Function id="qiskit.circuit.library.TwoLocal.entanglement_blocks" name="entanglement_blocks" signature="property entanglement_blocks">
  ...
  <Function id="qiskit.circuit.library.TwoLocal.extend" name="extend" signature="extend(rhs)">
  ...
  <Function id="qiskit.circuit.library.TwoLocal.fredkin" name="fredkin" signature="fredkin(control_qubit, target_qubit1, target_qubit2)">
    Apply [`CSwapGate`](qiskit.circuit.library.CSwapGate "qiskit.circuit.library.CSwapGate").
  </Function>

  ### from\_qasm\_file

  <Function id="qiskit.circuit.library.TwoLocal.from_qasm_file" name="from_qasm_file" signature="static from_qasm_file(path)">
  ...
  <Function id="qiskit.circuit.library.TwoLocal.from_qasm_str" name="from_qasm_str" signature="static from_qasm_str(qasm_str)">
  ...
  <Function id="qiskit.circuit.library.TwoLocal.get_entangler_map" name="get_entangler_map" signature="get_entangler_map(rep_num, block_num, num_block_qubits)">
  ...
  <Function id="qiskit.circuit.library.TwoLocal.get_unentangled_qubits" name="get_unentangled_qubits" signature="get_unentangled_qubits()">
  ...
  <Function id="qiskit.circuit.library.TwoLocal.global_phase" name="global_phase" signature="property global_phase">
    Return the global phase of the circuit in radians.
  </Function>

  ### h

  <Function id="qiskit.circuit.library.TwoLocal.h" name="h" signature="h(qubit)">
    Apply [`HGate`](qiskit.circuit.library.HGate "qiskit.circuit.library.HGate").
  </Function>

  ### hamiltonian

  <Function id="qiskit.circuit.library.TwoLocal.hamiltonian" name="hamiltonian" signature="hamiltonian(operator, time, qubits, label=None)">
    Apply hamiltonian evolution to qubits.
  </Function>

  ### has\_register

  <Function id="qiskit.circuit.library.TwoLocal.has_register" name="has_register" signature="has_register(register)">
  ...
  <Function id="qiskit.circuit.library.TwoLocal.i" name="i" signature="i(qubit)">
    Apply [`IGate`](qiskit.circuit.library.IGate "qiskit.circuit.library.IGate").
  </Function>

  ### id

  <Function id="qiskit.circuit.library.TwoLocal.id" name="id" signature="id(qubit)">
    Apply [`IGate`](qiskit.circuit.library.IGate "qiskit.circuit.library.IGate").
  </Function>

  ### initial\_state

  <Function id="qiskit.circuit.library.TwoLocal.initial_state" name="initial_state" signature="property initial_state">
  ...
  <Function id="qiskit.circuit.library.TwoLocal.initialize" name="initialize" signature="initialize(params, qubits=None)">
  ...
  <Function id="qiskit.circuit.library.TwoLocal.insert_barriers" name="insert_barriers" signature="property insert_barriers">
  ...
  <Function id="qiskit.circuit.library.TwoLocal.inverse" name="inverse" signature="inverse()">
  ...
  <Function id="qiskit.circuit.library.TwoLocal.iso" name="iso" signature="iso(isometry, q_input, q_ancillas_for_output, q_ancillas_zero=None, q_ancillas_dirty=None)">
  ...
  <Function id="qiskit.circuit.library.TwoLocal.isometry" name="isometry" signature="isometry(isometry, q_input, q_ancillas_for_output, q_ancillas_zero=None, q_ancillas_dirty=None)">
    Attach an arbitrary isometry from m to n qubits to a circuit. In particular, this allows to attach arbitrary unitaries on n qubits (m=n) or to prepare any state on n qubits (m=0). The decomposition used here was introduced by Iten et al. in [https://arxiv.org/abs/1501.06911](https://arxiv.org/abs/1501.06911).
  ...
  <Function id="qiskit.circuit.library.TwoLocal.iswap" name="iswap" signature="iswap(qubit1, qubit2)">
    Apply [`iSwapGate`](qiskit.circuit.library.iSwapGate "qiskit.circuit.library.iSwapGate").
  </Function>

  ### mcp

  <Function id="qiskit.circuit.library.TwoLocal.mcp" name="mcp" signature="mcp(lam, control_qubits, target_qubit)">
    Apply [`MCPhaseGate`](qiskit.circuit.library.MCPhaseGate "qiskit.circuit.library.MCPhaseGate").
  </Function>

  ### mcrx

  <Function id="qiskit.circuit.library.TwoLocal.mcrx" name="mcrx" signature="mcrx(theta, q_controls, q_target, use_basis_gates=False)">
  ...
  <Function id="qiskit.circuit.library.TwoLocal.mcry" name="mcry" signature="mcry(theta, q_controls, q_target, q_ancillae=None, mode=None, use_basis_gates=False)">
  ...
  <Function id="qiskit.circuit.library.TwoLocal.mcrz" name="mcrz" signature="mcrz(lam, q_controls, q_target, use_basis_gates=False)">
  ...
  <Function id="qiskit.circuit.library.TwoLocal.mct" name="mct" signature="mct(control_qubits, target_qubit, ancilla_qubits=None, mode='noancilla')">
    Apply [`MCXGate`](qiskit.circuit.library.MCXGate "qiskit.circuit.library.MCXGate").
  </Function>

  ### mcu1

  <Function id="qiskit.circuit.library.TwoLocal.mcu1" name="mcu1" signature="mcu1(lam, control_qubits, target_qubit)">
    Apply `MCU1Gate`.
  </Function>

  ### mcx

  <Function id="qiskit.circuit.library.TwoLocal.mcx" name="mcx" signature="mcx(control_qubits, target_qubit, ancilla_qubits=None, mode='noancilla')">
    Apply [`MCXGate`](qiskit.circuit.library.MCXGate "qiskit.circuit.library.MCXGate").
  ...
  <Function id="qiskit.circuit.library.TwoLocal.measure" name="measure" signature="measure(qubit, cbit)">
  ...
  <Function id="qiskit.circuit.library.TwoLocal.measure_active" name="measure_active" signature="measure_active(inplace=True)">
  ...
  <Function id="qiskit.circuit.library.TwoLocal.measure_all" name="measure_all" signature="measure_all(inplace=True)">
  ...
  <Function id="qiskit.circuit.library.TwoLocal.metadata" name="metadata" signature="property metadata">
  ...
  <Function id="qiskit.circuit.library.TwoLocal.ms" name="ms" signature="ms(theta, qubits)">
    Apply [`MSGate`](qiskit.circuit.library.MSGate "qiskit.circuit.library.MSGate").
  </Function>

  ### num\_ancillas

  <Function id="qiskit.circuit.library.TwoLocal.num_ancillas" name="num_ancillas" signature="property num_ancillas">
    Return the number of ancilla qubits.
  </Function>

  ### num\_clbits

  <Function id="qiskit.circuit.library.TwoLocal.num_clbits" name="num_clbits" signature="property num_clbits">
    Return number of classical bits.
  </Function>

  ### num\_connected\_components

  <Function id="qiskit.circuit.library.TwoLocal.num_connected_components" name="num_connected_components" signature="num_connected_components(unitary_only=False)">
  ...
  <Function id="qiskit.circuit.library.TwoLocal.num_layers" name="num_layers" signature="property num_layers">
  ...
  <Function id="qiskit.circuit.library.TwoLocal.num_nonlocal_gates" name="num_nonlocal_gates" signature="num_nonlocal_gates()">
  ...
  <Function id="qiskit.circuit.library.TwoLocal.num_parameters" name="num_parameters" signature="property num_parameters">
  ...
  <Function id="qiskit.circuit.library.TwoLocal.num_parameters_settable" name="num_parameters_settable" signature="property num_parameters_settable">
  ...
  <Function id="qiskit.circuit.library.TwoLocal.num_qubits" name="num_qubits" signature="property num_qubits">
  ...
  <Function id="qiskit.circuit.library.TwoLocal.num_tensor_factors" name="num_tensor_factors" signature="num_tensor_factors()">
  ...
  <Function id="qiskit.circuit.library.TwoLocal.num_unitary_factors" name="num_unitary_factors" signature="num_unitary_factors()">
    Computes the number of tensor factors in the unitary (quantum) part of the circuit only.
  </Function>

  ### ordered\_parameters

  <Function id="qiskit.circuit.library.TwoLocal.ordered_parameters" name="ordered_parameters" signature="property ordered_parameters">
  ...
  <Function id="qiskit.circuit.library.TwoLocal.p" name="p" signature="p(theta, qubit)">
  ...
  <Function id="qiskit.circuit.library.TwoLocal.parameters" name="parameters" signature="property parameters">
  ...
  <Function id="qiskit.circuit.library.TwoLocal.pauli" name="pauli" signature="pauli(pauli_string, qubits)">
    Apply `PauliGate`.
  </Function>

  ### power

  <Function id="qiskit.circuit.library.TwoLocal.power" name="power" signature="power(power, matrix_power=False)">
  ...
  <Function id="qiskit.circuit.library.TwoLocal.preferred_init_points" name="preferred_init_points" signature="property preferred_init_points">
  ...
  <Function id="qiskit.circuit.library.TwoLocal.print_settings" name="print_settings" signature="print_settings()">
  ...
  <Function id="qiskit.circuit.library.TwoLocal.qasm" name="qasm" signature="qasm(formatted=False, filename=None)">
  ...
  <Function id="qiskit.circuit.library.TwoLocal.qbit_argument_conversion" name="qbit_argument_conversion" signature="qbit_argument_conversion(qubit_representation)">
  ...
  <Function id="qiskit.circuit.library.TwoLocal.qregs" name="qregs" signature="property qregs">
    A list of the quantum registers associated with the circuit.
  </Function>

  ### qubit\_duration

  <Function id="qiskit.circuit.library.TwoLocal.qubit_duration" name="qubit_duration" signature="qubit_duration(*qubits)">
  ...
  <Function id="qiskit.circuit.library.TwoLocal.qubit_start_time" name="qubit_start_time" signature="qubit_start_time(*qubits)">
  ...
  <Function id="qiskit.circuit.library.TwoLocal.qubit_stop_time" name="qubit_stop_time" signature="qubit_stop_time(*qubits)">
  ...
  <Function id="qiskit.circuit.library.TwoLocal.qubits" name="qubits" signature="property qubits">
    Returns a list of quantum bits in the order that the registers were added.
  </Function>

  ### r

  <Function id="qiskit.circuit.library.TwoLocal.r" name="r" signature="r(theta, phi, qubit)">
    Apply [`RGate`](qiskit.circuit.library.RGate "qiskit.circuit.library.RGate").
  </Function>

  ### rcccx

  <Function id="qiskit.circuit.library.TwoLocal.rcccx" name="rcccx" signature="rcccx(control_qubit1, control_qubit2, control_qubit3, target_qubit)">
    Apply [`RC3XGate`](qiskit.circuit.library.RC3XGate "qiskit.circuit.library.RC3XGate").
  </Function>

  ### rccx

  <Function id="qiskit.circuit.library.TwoLocal.rccx" name="rccx" signature="rccx(control_qubit1, control_qubit2, target_qubit)">
    Apply [`RCCXGate`](qiskit.circuit.library.RCCXGate "qiskit.circuit.library.RCCXGate").
  </Function>

  ### remove\_final\_measurements

  <Function id="qiskit.circuit.library.TwoLocal.remove_final_measurements" name="remove_final_measurements" signature="remove_final_measurements(inplace=True)">
  ...
  <Function id="qiskit.circuit.library.TwoLocal.repeat" name="repeat" signature="repeat(reps)">
  ...
  <Function id="qiskit.circuit.library.TwoLocal.reps" name="reps" signature="property reps">
  ...
  <Function id="qiskit.circuit.library.TwoLocal.reset" name="reset" signature="reset(qubit)">
    Reset q.
  </Function>

  ### reverse\_bits

  <Function id="qiskit.circuit.library.TwoLocal.reverse_bits" name="reverse_bits" signature="reverse_bits()">
  ...
  <Function id="qiskit.circuit.library.TwoLocal.reverse_ops" name="reverse_ops" signature="reverse_ops()">
  ...
  <Function id="qiskit.circuit.library.TwoLocal.rotation_blocks" name="rotation_blocks" signature="property rotation_blocks">
  ...
  <Function id="qiskit.circuit.library.TwoLocal.rv" name="rv" signature="rv(vx, vy, vz, qubit)">
    Apply [`RVGate`](qiskit.circuit.library.RVGate "qiskit.circuit.library.RVGate").
  </Function>

  ### rx

  <Function id="qiskit.circuit.library.TwoLocal.rx" name="rx" signature="rx(theta, qubit, label=None)">
    Apply [`RXGate`](qiskit.circuit.library.RXGate "qiskit.circuit.library.RXGate").
  </Function>

  ### rxx

  <Function id="qiskit.circuit.library.TwoLocal.rxx" name="rxx" signature="rxx(theta, qubit1, qubit2)">
    Apply [`RXXGate`](qiskit.circuit.library.RXXGate "qiskit.circuit.library.RXXGate").
  </Function>

  ### ry

  <Function id="qiskit.circuit.library.TwoLocal.ry" name="ry" signature="ry(theta, qubit, label=None)">
    Apply [`RYGate`](qiskit.circuit.library.RYGate "qiskit.circuit.library.RYGate").
  </Function>

  ### ryy

  <Function id="qiskit.circuit.library.TwoLocal.ryy" name="ryy" signature="ryy(theta, qubit1, qubit2)">
    Apply [`RYYGate`](qiskit.circuit.library.RYYGate "qiskit.circuit.library.RYYGate").
  </Function>

  ### rz

  <Function id="qiskit.circuit.library.TwoLocal.rz" name="rz" signature="rz(phi, qubit)">
    Apply [`RZGate`](qiskit.circuit.library.RZGate "qiskit.circuit.library.RZGate").
  </Function>

  ### rzx

  <Function id="qiskit.circuit.library.TwoLocal.rzx" name="rzx" signature="rzx(theta, qubit1, qubit2)">
    Apply [`RZXGate`](qiskit.circuit.library.RZXGate "qiskit.circuit.library.RZXGate").
  </Function>

  ### rzz

  <Function id="qiskit.circuit.library.TwoLocal.rzz" name="rzz" signature="rzz(theta, qubit1, qubit2)">
    Apply [`RZZGate`](qiskit.circuit.library.RZZGate "qiskit.circuit.library.RZZGate").
  </Function>

  ### s

  <Function id="qiskit.circuit.library.TwoLocal.s" name="s" signature="s(qubit)">
    Apply [`SGate`](qiskit.circuit.library.SGate "qiskit.circuit.library.SGate").
  </Function>

  ### save\_amplitudes

  <Function id="qiskit.circuit.library.TwoLocal.save_amplitudes" name="save_amplitudes" signature="save_amplitudes(params, label='amplitudes', pershot=False, conditional=False)">
  ...
  <Function id="qiskit.circuit.library.TwoLocal.save_amplitudes_squared" name="save_amplitudes_squared" signature="save_amplitudes_squared(params, label='amplitudes_squared', unnormalized=False, pershot=False, conditional=False)">
  ...
  <Function id="qiskit.circuit.library.TwoLocal.save_density_matrix" name="save_density_matrix" signature="save_density_matrix(qubits=None, label='density_matrix', unnormalized=False, pershot=False, conditional=False)">
  ...
  <Function id="qiskit.circuit.library.TwoLocal.save_expectation_value" name="save_expectation_value" signature="save_expectation_value(operator, qubits, label='expectation_value', unnormalized=False, pershot=False, conditional=False)">
  ...
  <Function id="qiskit.circuit.library.TwoLocal.save_expectation_value_variance" name="save_expectation_value_variance" signature="save_expectation_value_variance(operator, qubits, label='expectation_value_variance', unnormalized=False, pershot=False, conditional=False)">
    Save the expectation value of a Hermitian operator.
  ...
  <Function id="qiskit.circuit.library.TwoLocal.save_matrix_product_state" name="save_matrix_product_state" signature="save_matrix_product_state(label='matrix_product_state', pershot=False, conditional=False)">
  ...
  <Function id="qiskit.circuit.library.TwoLocal.save_probabilities" name="save_probabilities" signature="save_probabilities(qubits=None, label='probabilities', unnormalized=False, pershot=False, conditional=False)">
  ...
  <Function id="qiskit.circuit.library.TwoLocal.save_probabilities_dict" name="save_probabilities_dict" signature="save_probabilities_dict(qubits=None, label='probabilities', unnormalized=False, pershot=False, conditional=False)">
    Save measurement outcome probabilities vector.
  ...
  <Function id="qiskit.circuit.library.TwoLocal.save_stabilizer" name="save_stabilizer" signature="save_stabilizer(label='stabilizer', pershot=False, conditional=False)">
  ...
  <Function id="qiskit.circuit.library.TwoLocal.save_state" name="save_state" signature="save_state(label=None, pershot=False, conditional=False)">
  ...
  <Function id="qiskit.circuit.library.TwoLocal.save_statevector" name="save_statevector" signature="save_statevector(label='statevector', pershot=False, conditional=False)">
  ...
  <Function id="qiskit.circuit.library.TwoLocal.save_statevector_dict" name="save_statevector_dict" signature="save_statevector_dict(label='statevector', pershot=False, conditional=False)">
  ...
  <Function id="qiskit.circuit.library.TwoLocal.save_superop" name="save_superop" signature="save_superop(label='superop', pershot=False)">
  ...
  <Function id="qiskit.circuit.library.TwoLocal.save_unitary" name="save_unitary" signature="save_unitary(label='unitary', pershot=False)">
  ...
  <Function id="qiskit.circuit.library.TwoLocal.sdg" name="sdg" signature="sdg(qubit)">
    Apply [`SdgGate`](qiskit.circuit.library.SdgGate "qiskit.circuit.library.SdgGate").
  </Function>

  ### set\_density\_matrix

  <Function id="qiskit.circuit.library.TwoLocal.set_density_matrix" name="set_density_matrix" signature="set_density_matrix(state)">
  ...
  <Function id="qiskit.circuit.library.TwoLocal.set_matrix_product_state" name="set_matrix_product_state" signature="set_matrix_product_state(state)">
  ...
  <Function id="qiskit.circuit.library.TwoLocal.set_stabilizer" name="set_stabilizer" signature="set_stabilizer(state)">
  ...
  <Function id="qiskit.circuit.library.TwoLocal.set_statevector" name="set_statevector" signature="set_statevector(state)">
  ...
  <Function id="qiskit.circuit.library.TwoLocal.set_superop" name="set_superop" signature="set_superop(state)">
  ...
  <Function id="qiskit.circuit.library.TwoLocal.set_unitary" name="set_unitary" signature="set_unitary(state)">
  ...
  <Function id="qiskit.circuit.library.TwoLocal.size" name="size" signature="size()">
  ...
  <Function id="qiskit.circuit.library.TwoLocal.snapshot" name="snapshot" signature="snapshot(label, snapshot_type='statevector', qubits=None, params=None)">
  ...
  <Function id="qiskit.circuit.library.TwoLocal.snapshot_density_matrix" name="snapshot_density_matrix" signature="snapshot_density_matrix(label, qubits=None)">
  ...
  <Function id="qiskit.circuit.library.TwoLocal.snapshot_expectation_value" name="snapshot_expectation_value" signature="snapshot_expectation_value(label, op, qubits, single_shot=False, variance=False)">
  ...
  <Function id="qiskit.circuit.library.TwoLocal.snapshot_probabilities" name="snapshot_probabilities" signature="snapshot_probabilities(label, qubits, variance=False)">
  ...
  <Function id="qiskit.circuit.library.TwoLocal.snapshot_stabilizer" name="snapshot_stabilizer" signature="snapshot_stabilizer(label)">
  ...
  <Function id="qiskit.circuit.library.TwoLocal.snapshot_statevector" name="snapshot_statevector" signature="snapshot_statevector(label)">
  ...
  <Function id="qiskit.circuit.library.TwoLocal.squ" name="squ" signature="squ(unitary_matrix, qubit, mode='ZYZ', up_to_diagonal=False, *, u=None)">
  ...
  <Function id="qiskit.circuit.library.TwoLocal.swap" name="swap" signature="swap(qubit1, qubit2)">
    Apply [`SwapGate`](qiskit.circuit.library.SwapGate "qiskit.circuit.library.SwapGate").
  </Function>

  ### sx

  <Function id="qiskit.circuit.library.TwoLocal.sx" name="sx" signature="sx(qubit)">
    Apply [`SXGate`](qiskit.circuit.library.SXGate "qiskit.circuit.library.SXGate").
  </Function>

  ### sxdg

  <Function id="qiskit.circuit.library.TwoLocal.sxdg" name="sxdg" signature="sxdg(qubit)">
    Apply [`SXdgGate`](qiskit.circuit.library.SXdgGate "qiskit.circuit.library.SXdgGate").
  </Function>

  ### t

  <Function id="qiskit.circuit.library.TwoLocal.t" name="t" signature="t(qubit)">
    Apply [`TGate`](qiskit.circuit.library.TGate "qiskit.circuit.library.TGate").
  </Function>

  ### tdg

  <Function id="qiskit.circuit.library.TwoLocal.tdg" name="tdg" signature="tdg(qubit)">
    Apply [`TdgGate`](qiskit.circuit.library.TdgGate "qiskit.circuit.library.TdgGate").
  </Function>

  ### tensor

  <Function id="qiskit.circuit.library.TwoLocal.tensor" name="tensor" signature="tensor(other, inplace=False)">
  ...
  <Function id="qiskit.circuit.library.TwoLocal.to_gate" name="to_gate" signature="to_gate(parameter_map=None, label=None)">
  ...
  <Function id="qiskit.circuit.library.TwoLocal.to_instruction" name="to_instruction" signature="to_instruction(parameter_map=None)">
  ...
  <Function id="qiskit.circuit.library.TwoLocal.toffoli" name="toffoli" signature="toffoli(control_qubit1, control_qubit2, target_qubit)">
    Apply [`CCXGate`](qiskit.circuit.library.CCXGate "qiskit.circuit.library.CCXGate").
  </Function>

  ### u

  <Function id="qiskit.circuit.library.TwoLocal.u" name="u" signature="u(theta, phi, lam, qubit)">
    Apply [`UGate`](qiskit.circuit.library.UGate "qiskit.circuit.library.UGate").
  </Function>

  ### u1

  <Function id="qiskit.circuit.library.TwoLocal.u1" name="u1" signature="u1(theta, qubit)">
    Apply [`U1Gate`](qiskit.circuit.library.U1Gate "qiskit.circuit.library.U1Gate").
  </Function>

  ### u2

  <Function id="qiskit.circuit.library.TwoLocal.u2" name="u2" signature="u2(phi, lam, qubit)">
    Apply [`U2Gate`](qiskit.circuit.library.U2Gate "qiskit.circuit.library.U2Gate").
  </Function>

  ### u3

  <Function id="qiskit.circuit.library.TwoLocal.u3" name="u3" signature="u3(theta, phi, lam, qubit)">
    Apply [`U3Gate`](qiskit.circuit.library.U3Gate "qiskit.circuit.library.U3Gate").
  </Function>

  ### uc

  <Function id="qiskit.circuit.library.TwoLocal.uc" name="uc" signature="uc(gate_list, q_controls, q_target, up_to_diagonal=False)">
  ...
  <Function id="qiskit.circuit.library.TwoLocal.ucrx" name="ucrx" signature="ucrx(angle_list, q_controls, q_target)">
  ...
  <Function id="qiskit.circuit.library.TwoLocal.ucry" name="ucry" signature="ucry(angle_list, q_controls, q_target)">
  ...
  <Function id="qiskit.circuit.library.TwoLocal.ucrz" name="ucrz" signature="ucrz(angle_list, q_controls, q_target)">
  ...
  <Function id="qiskit.circuit.library.TwoLocal.unitary" name="unitary" signature="unitary(obj, qubits, label=None)">
    Apply unitary gate to q.
  </Function>

  ### width

  <Function id="qiskit.circuit.library.TwoLocal.width" name="width" signature="width()">
  ...
  <Function id="qiskit.circuit.library.TwoLocal.x" name="x" signature="x(qubit, label=None)">
    Apply [`XGate`](qiskit.circuit.library.XGate "qiskit.circuit.library.XGate").
  </Function>

  ### y

  <Function id="qiskit.circuit.library.TwoLocal.y" name="y" signature="y(qubit)">
    Apply [`YGate`](qiskit.circuit.library.YGate "qiskit.circuit.library.YGate").
  </Function>

  ### z

  <Function id="qiskit.circuit.library.TwoLocal.z" name="z" signature="z(qubit)">
