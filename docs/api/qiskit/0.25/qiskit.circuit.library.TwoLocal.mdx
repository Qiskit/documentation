...
<Class id="qiskit.circuit.library.TwoLocal" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.17/qiskit/circuit/library/n_local/two_local.py" signature="TwoLocal(num_qubits=None, rotation_blocks=None, entanglement_blocks=None, entanglement='full', reps=3, skip_unentangled_qubits=False, skip_final_rotation_layer=False, parameter_prefix='θ', insert_barriers=False, initial_state=None)" modifiers="class">
  ...
  *   **initial\_state** (`Optional`\[`Any`]) – A QuantumCircuit object to prepend to the circuit.
  ...
  <Function id="qiskit.circuit.library.TwoLocal.ancillas" signature="ancillas" modifiers="property">
  ...
  <Function id="qiskit.circuit.library.TwoLocal.calibrations" signature="calibrations" modifiers="property">
  ...
  <Function id="qiskit.circuit.library.TwoLocal.clbits" signature="clbits" modifiers="property">
  ...
  <Function id="qiskit.circuit.library.TwoLocal.data" signature="data" modifiers="property">
  ...
  <Function id="qiskit.circuit.library.TwoLocal.entanglement" signature="entanglement" modifiers="property">
  ...
  <Function id="qiskit.circuit.library.TwoLocal.entanglement_blocks" signature="entanglement_blocks" modifiers="property">
  ...
  <Function id="qiskit.circuit.library.TwoLocal.global_phase" signature="global_phase" modifiers="property">
  ...
  <Function id="qiskit.circuit.library.TwoLocal.initial_state" signature="initial_state" modifiers="property">
  ...
  <Function id="qiskit.circuit.library.TwoLocal.insert_barriers" signature="insert_barriers" modifiers="property">
  ...
  <Function id="qiskit.circuit.library.TwoLocal.metadata" signature="metadata" modifiers="property">
  ...
  <Function id="qiskit.circuit.library.TwoLocal.num_ancillas" signature="num_ancillas" modifiers="property">
    Return the number of ancilla qubits.
  </Function>

  ### num\_clbits

  <Function id="qiskit.circuit.library.TwoLocal.num_clbits" signature="num_clbits" modifiers="property">
  ...
  <Function id="qiskit.circuit.library.TwoLocal.num_layers" signature="num_layers" modifiers="property">
  ...
  <Function id="qiskit.circuit.library.TwoLocal.num_parameters" signature="num_parameters" modifiers="property">
  ...
  <Function id="qiskit.circuit.library.TwoLocal.num_parameters_settable" signature="num_parameters_settable" modifiers="property">
  ...
  <Function id="qiskit.circuit.library.TwoLocal.num_qubits" signature="num_qubits" modifiers="property">
  ...
  <Function id="qiskit.circuit.library.TwoLocal.ordered_parameters" signature="ordered_parameters" modifiers="property">
  ...
  <Function id="qiskit.circuit.library.TwoLocal.parameter_bounds" signature="parameter_bounds" modifiers="property">
  ...
  <Function id="qiskit.circuit.library.TwoLocal.parameters" signature="parameters" modifiers="property">
  ...
  <Function id="qiskit.circuit.library.TwoLocal.preferred_init_points" signature="preferred_init_points" modifiers="property">
  ...
  <Function id="qiskit.circuit.library.TwoLocal.qregs" signature="qregs" modifiers="property">
  ...
  <Function id="qiskit.circuit.library.TwoLocal.qubits" signature="qubits" modifiers="property">
  ...
  <Function id="qiskit.circuit.library.TwoLocal.reps" signature="reps" modifiers="property">
  ...
  <Function id="qiskit.circuit.library.TwoLocal.rotation_blocks" signature="rotation_blocks" modifiers="property">
