...
<Class id="qiskit.aqua.algorithms.NumPyLSsolver" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/aqua/algorithms/linear_solvers/numpy_ls_solver.py" signature="NumPyLSsolver(matrix, vector)">
  ...
  *   **vector** (`Union`\[`List`\[`float`], `ndarray`]) – The input vector of linear system of equations
  ...
  <Function id="qiskit.aqua.algorithms.NumPyLSsolver.__init__" name="__init__" signature="__init__(matrix, vector)">
    **Parameters**
  ...
  <Function id="qiskit.aqua.algorithms.NumPyLSsolver.random" name="random" signature="property random">
    Return a numpy random.
  </Function>

  ### run

  <Function id="qiskit.aqua.algorithms.NumPyLSsolver.run" name="run" signature="run()">
