...
<Class id="qiskit.quantum_info.Pauli" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.17/qiskit/quantum_info/operators/symplectic/pauli.py" signature="Pauli(data=None, x=None, *, z=None, label=None)">
...
$$
  ...
  **QiskitError** – if input array is invalid shape.
  ...
  <Function id="qiskit.quantum_info.Pauli.dim" signature="property dim">
  ...
  <Function id="qiskit.quantum_info.Pauli.from_label" signature="static from_label(*args, **kwargs)">
  ...
  <Function id="qiskit.quantum_info.Pauli.num_qubits" signature="property num_qubits">
  ...
  <Function id="qiskit.quantum_info.Pauli.pauli_single" signature="classmethod pauli_single(num_qubits, index, pauli_label)">
  ...
  <Function id="qiskit.quantum_info.Pauli.phase" signature="property phase">
  ...
  <Function id="qiskit.quantum_info.Pauli.qargs" signature="property qargs">
    Return the qargs for the operator.
  </Function>

  ### random

  <Function id="qiskit.quantum_info.Pauli.random" signature="classmethod random(num_qubits, seed=None)">
  ...
  <Function id="qiskit.quantum_info.Pauli.set_truncation" signature="classmethod set_truncation(val)">
  ...
  <Function id="qiskit.quantum_info.Pauli.sgn_prod" signature="static sgn_prod(*args, **kwargs)">
  ...
  <Function id="qiskit.quantum_info.Pauli.x" signature="property x">
    The x vector for the Pauli.
  </Function>

  ### z

  <Function id="qiskit.quantum_info.Pauli.z" signature="property z">
