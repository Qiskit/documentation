...
<Class id="qiskit.chemistry.algorithms.QEomEE" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/chemistry/algorithms/eigen_solvers/q_eom_ee.py" signature="QEomEE(operator, num_orbitals, num_particles, qubit_mapping='parity', two_qubit_reduction=True, active_occupied=None, active_unoccupied=None, is_eom_matrix_symmetric=True, se_list=None, de_list=None, z2_symmetries=None, untapered_op=None, aux_operators=None)">
  ...
  **ValueError** – invalid parameter
  ...
  <Function id="qiskit.chemistry.algorithms.QEomEE.aux_operators" signature="property aux_operators">
  ...
  <Function id="qiskit.chemistry.algorithms.QEomEE.filter_criterion" signature="property filter_criterion">
  ...
  <Function id="qiskit.chemistry.algorithms.QEomEE.operator" signature="property operator">
    Return the operator.
  ...
  <Function id="qiskit.chemistry.algorithms.QEomEE.random" signature="property random">
  ...
  <Function id="qiskit.chemistry.algorithms.QEomEE.supports_aux_operators" signature="classmethod supports_aux_operators()">
