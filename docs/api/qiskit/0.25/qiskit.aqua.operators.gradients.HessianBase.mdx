---
title: HessianBase (v0.25)
description: API reference for qiskit.aqua.operators.gradients.HessianBase in qiskit v0.25
...
<Class id="qiskit.aqua.operators.gradients.HessianBase" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/aqua/operators/gradients/hessian_base.py" signature="HessianBase(hess_method='param_shift', **kwargs)" modifiers="class">
  ...
  **ValueError** – If method != `fin_diff` and `epsilon` is not None.
  ...
  <Function id="qiskit.aqua.operators.gradients.HessianBase.__init__" signature="__init__(hess_method='param_shift', **kwargs)">
    **Parameters**
  ...
  <Function id="qiskit.aqua.operators.gradients.HessianBase.convert" signature="convert(operator, params=None)" modifiers="abstract">
    **Parameters**
  ...
  <Function id="qiskit.aqua.operators.gradients.HessianBase.gradient_wrapper" signature="gradient_wrapper(operator, bind_params, grad_params=None, backend=None)">
  ...
  <Function id="qiskit.aqua.operators.gradients.HessianBase.parameter_expression_grad" signature="parameter_expression_grad(param_expr, param)" modifiers="static">
