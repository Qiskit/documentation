...
<Class id="qiskit.aqua.operators.gradients.HessianBase" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/aqua/operators/gradients/hessian_base.py" signature="HessianBase(hess_method='param_shift', **kwargs)">
  ...
  **ValueError** – If method != `fin_diff` and `epsilon` is not None.
  ...
  <Function id="qiskit.aqua.operators.gradients.HessianBase.__init__" name="__init__" signature="__init__(hess_method='param_shift', **kwargs)">
    **Parameters**
  ...
  <Function id="qiskit.aqua.operators.gradients.HessianBase.convert" name="convert" signature="abstract convert(operator, params=None)">
    **Parameters**
  ...
  <Function id="qiskit.aqua.operators.gradients.HessianBase.gradient_wrapper" name="gradient_wrapper" signature="gradient_wrapper(operator, bind_params, grad_params=None, backend=None)">
  ...
  <Function id="qiskit.aqua.operators.gradients.HessianBase.hess_method" name="hess_method" signature="property hess_method">
  ...
  <Function id="qiskit.aqua.operators.gradients.HessianBase.parameter_expression_grad" name="parameter_expression_grad" signature="static parameter_expression_grad(param_expr, param)">
