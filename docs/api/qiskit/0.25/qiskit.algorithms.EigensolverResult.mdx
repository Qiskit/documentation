---
title: EigensolverResult (v0.25)
description: API reference for qiskit.algorithms.EigensolverResult in qiskit v0.25
...
<Class id="qiskit.algorithms.EigensolverResult" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.17/qiskit/algorithms/eigen_solvers/eigen_solver.py" signature="EigensolverResult" modifiers="class">
  Eigensolver Result.
