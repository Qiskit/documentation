...
<Function id="qiskit.providers.ibmq.utils.update_qobj_config" name="update_qobj_config" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-ibmq-provider/tree/stable/0.12/qiskit/providers/ibmq/utils/qobj_utils.py" signature="update_qobj_config(qobj, backend_options=None, noise_model=None)">
