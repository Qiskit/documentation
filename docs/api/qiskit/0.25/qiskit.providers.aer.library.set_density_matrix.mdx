...
<Function id="qiskit.providers.aer.library.set_density_matrix" name="set_density_matrix" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-aer/tree/stable/0.8/qiskit/providers/aer/library/set_instructions/set_density_matrix.py" signature="set_density_matrix(self, state)">
