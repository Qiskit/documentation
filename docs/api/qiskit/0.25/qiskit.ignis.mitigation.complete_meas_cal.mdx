...
<Function id="qiskit.ignis.mitigation.complete_meas_cal" name="complete_meas_cal" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-ignis/tree/stable/0.6/qiskit/ignis/mitigation/measurement/circuits.py" signature="complete_meas_cal(qubit_list=None, qr=None, cr=None, circlabel='')">
