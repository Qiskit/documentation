...
<Class id="qiskit.aqua.components.oracles.TruthTableOracle" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/aqua/components/oracles/truth_table_oracle.py" signature="TruthTableOracle(bitmaps, optimization=False, mct_mode='basic')" modifiers="class">
  ...
  **Raises**
  ...
  <Function id="qiskit.aqua.components.oracles.TruthTableOracle.ancillary_register" signature="ancillary_register" modifiers="property">
    returns ancillary register
  </Function>

  ### circuit

  <Function id="qiskit.aqua.components.oracles.TruthTableOracle.circuit" signature="circuit" modifiers="property" />
  ...
  <Function id="qiskit.aqua.components.oracles.TruthTableOracle.output_register" signature="output_register" modifiers="property">
    returns output register
  </Function>

  ### variable\_register

  <Function id="qiskit.aqua.components.oracles.TruthTableOracle.variable_register" signature="variable_register" modifiers="property">
