...
<Class id="qiskit.transpiler.passes.FixedPoint" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.17/qiskit/transpiler/passes/utils/fixed_point.py" signature="FixedPoint(*args, **kwargs)">
  ...
  **property\_to\_check** (*str*) – The property to check if a fixed point was reached.
  ...
  <Function id="qiskit.transpiler.passes.FixedPoint.is_analysis_pass" signature="property is_analysis_pass">
  ...
  <Function id="qiskit.transpiler.passes.FixedPoint.is_transformation_pass" signature="property is_transformation_pass">
