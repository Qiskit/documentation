---
title: suzuki_expansion_slice_pauli_list (v0.25)
description: API reference for qiskit.aqua.operators.legacy.suzuki_expansion_slice_pauli_list in qiskit v0.25
...
<Function id="qiskit.aqua.operators.legacy.suzuki_expansion_slice_pauli_list" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/aqua/operators/legacy/common.py" signature="suzuki_expansion_slice_pauli_list(pauli_list, lam_coef, expansion_order)">
