...
<Class id="qiskit.algorithms.LinearSolverResult" github="https://github.com/qiskit/qiskit/tree/stable/0.17/qiskit/algorithms/linear_solvers/linear_solver.py" signature="LinearSolverResult">
