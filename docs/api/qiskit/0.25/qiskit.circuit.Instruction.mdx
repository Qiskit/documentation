...
<Class id="qiskit.circuit.Instruction" github="https://github.com/qiskit/qiskit/tree/stable/0.17/qiskit/circuit/instruction.py" signature="Instruction(name, num_qubits, num_clbits, params, duration=None, unit='dt')">
