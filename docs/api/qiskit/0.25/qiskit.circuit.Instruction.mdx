...
<Class id="qiskit.circuit.Instruction" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.17/qiskit/circuit/instruction.py" signature="Instruction(name, num_qubits, num_clbits, params, duration=None, unit='dt')">
  ...
  **CircuitError** – when the register is not in the correct format.
  ...
  <Function id="qiskit.circuit.Instruction.__init__" name="__init__" signature="__init__(name, num_qubits, num_clbits, params, duration=None, unit='dt')">
    Create a new instruction.
