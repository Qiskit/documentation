...
<Class id="qiskit.opflow.evolutions.EvolutionBase" github="https://github.com/qiskit/qiskit/tree/stable/0.17/qiskit/opflow/evolutions/evolution_base.py" signature="EvolutionBase">
  ...
  <Function id="qiskit.opflow.evolutions.EvolutionBase.__init__" name="__init__" signature="__init__()">
