---
title: YGate (v0.25)
description: API reference for qiskit.circuit.library.YGate in qiskit v0.25
...
<Class id="qiskit.circuit.library.YGate" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.17/qiskit/circuit/library/standard_gates/y.py" signature="YGate(label=None)" modifiers="class">
...
$$
  ...
  <Function id="qiskit.circuit.library.YGate.soft_compare" signature="soft_compare(other)">
