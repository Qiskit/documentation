...
<Class id="qiskit.circuit.library.YGate" github="https://github.com/qiskit/qiskit/tree/stable/0.17/qiskit/circuit/library/standard_gates/y.py" signature="YGate(label=None)">
  ...
  **Circuit symbol:**
  ...
  <Function id="qiskit.circuit.library.YGate.__init__" name="__init__" signature="__init__(label=None)">
    Create new Y gate.
  </Function>
  ...
  <Function id="qiskit.circuit.library.YGate.add_decomposition" name="add_decomposition" signature="add_decomposition(decomposition)">
    Add a decomposition of the instruction to the SessionEquivalenceLibrary.
  </Function>

  ### assemble

  <Function id="qiskit.circuit.library.YGate.assemble" name="assemble" signature="assemble()">
  ...
  <Function id="qiskit.circuit.library.YGate.broadcast_arguments" name="broadcast_arguments" signature="broadcast_arguments(qargs, cargs)">
  ...
  <Function id="qiskit.circuit.library.YGate.c_if" name="c_if" signature="c_if(classical, val)">
    Add classical condition on register classical and value val.
  </Function>

  ### control

  <Function id="qiskit.circuit.library.YGate.control" name="control" signature="control(num_ctrl_qubits=1, label=None, ctrl_state=None)">
  ...
  <Function id="qiskit.circuit.library.YGate.copy" name="copy" signature="copy(name=None)">
  ...
  <Function id="qiskit.circuit.library.YGate.decompositions" name="decompositions" signature="property decompositions">
    Get the decompositions of the instruction from the SessionEquivalenceLibrary.
  </Function>

  ### definition

  <Function id="qiskit.circuit.library.YGate.definition" name="definition" signature="property definition">
    Return definition in terms of other basic gates.
  </Function>

  ### duration

  <Function id="qiskit.circuit.library.YGate.duration" name="duration" signature="property duration">
    Get the duration.
  </Function>

  ### inverse

  <Function id="qiskit.circuit.library.YGate.inverse" name="inverse" signature="inverse()">
    Return inverted Y gate ($Y{\dagger} = Y$)
  </Function>

  ### is\_parameterized

  <Function id="qiskit.circuit.library.YGate.is_parameterized" name="is_parameterized" signature="is_parameterized()">
    Return True .IFF. instruction is parameterized else False
  </Function>

  ### label

  <Function id="qiskit.circuit.library.YGate.label" name="label" signature="property label">
    Return gate label
  ...
  <Function id="qiskit.circuit.library.YGate.mirror" name="mirror" signature="mirror()">
  ...
  <Function id="qiskit.circuit.library.YGate.params" name="params" signature="property params">
    return instruction params.
  </Function>

  ### power

  <Function id="qiskit.circuit.library.YGate.power" name="power" signature="power(exponent)">
  ...
  <Function id="qiskit.circuit.library.YGate.qasm" name="qasm" signature="qasm()">
  ...
  <Function id="qiskit.circuit.library.YGate.repeat" name="repeat" signature="repeat(n)">
  ...
  <Function id="qiskit.circuit.library.YGate.reverse_ops" name="reverse_ops" signature="reverse_ops()">
  ...
  <Function id="qiskit.circuit.library.YGate.soft_compare" name="soft_compare" signature="soft_compare(other)">
  ...
  <Function id="qiskit.circuit.library.YGate.to_matrix" name="to_matrix" signature="to_matrix()">
  ...
  <Function id="qiskit.circuit.library.YGate.unit" name="unit" signature="property unit">
    Get the time unit of duration.
  </Function>

  ### validate\_parameter

  <Function id="qiskit.circuit.library.YGate.validate_parameter" name="validate_parameter" signature="validate_parameter(parameter)">
