...
<Class id="qiskit.circuit.library.Barrier" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.17/qiskit/circuit/barrier.py" signature="Barrier(num_qubits)">
  Barrier instruction.
  ...
  <Function id="qiskit.circuit.library.Barrier.__init__" name="__init__" signature="__init__(num_qubits)">
    Create new barrier instruction.
  </Function>
  ...
  <Function id="qiskit.circuit.library.Barrier.decompositions" name="decompositions" signature="property decompositions">
    Get the decompositions of the instruction from the SessionEquivalenceLibrary.
  </Function>

  ### definition

  <Function id="qiskit.circuit.library.Barrier.definition" name="definition" signature="property definition">
    Return definition in terms of other basic gates.
  </Function>

  ### duration

  <Function id="qiskit.circuit.library.Barrier.duration" name="duration" signature="property duration">
    Get the duration.
  </Function>
  ...
  <Function id="qiskit.circuit.library.Barrier.mirror" name="mirror" signature="mirror()">
  ...
  <Function id="qiskit.circuit.library.Barrier.params" name="params" signature="property params">
  ...
  <Function id="qiskit.circuit.library.Barrier.unit" name="unit" signature="property unit">
