...
<Class id="qiskit.aqua.operators.evolutions.Suzuki" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/aqua/operators/evolutions/trotterizations/suzuki.py" signature="Suzuki(reps=1, order=2)">
  ...
  *   **order** (`int`) – The order of the expansion to perform.
  ...
  <Function id="qiskit.aqua.operators.evolutions.Suzuki.order" signature="property order">
    returns order
  ...
  <Function id="qiskit.aqua.operators.evolutions.Suzuki.reps" signature="property reps">
