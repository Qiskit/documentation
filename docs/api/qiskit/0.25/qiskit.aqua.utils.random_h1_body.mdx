...
<Function id="qiskit.aqua.utils.random_h1_body" name="random_h1_body" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/aqua/utils/random_matrix_generator.py" signature="random_h1_body(N)">
