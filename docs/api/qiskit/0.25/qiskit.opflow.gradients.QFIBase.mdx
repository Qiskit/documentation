...
<Class id="qiskit.opflow.gradients.QFIBase" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.17/qiskit/opflow/gradients/qfi_base.py" signature="QFIBase(qfi_method='lin_comb_full')">
  ...
  **ValueError** – if `qfi_method` is neither a `CircuitQFI` object nor one of the predefined strings.
  ...
  <Function id="qiskit.opflow.gradients.QFIBase.__init__" name="__init__" signature="__init__(qfi_method='lin_comb_full')">
    **Parameters**
  ...
  <Function id="qiskit.opflow.gradients.QFIBase.convert" name="convert" signature="abstract convert(operator, params=None)">
    **Parameters**
  ...
  <Function id="qiskit.opflow.gradients.QFIBase.gradient_wrapper" name="gradient_wrapper" signature="gradient_wrapper(operator, bind_params, grad_params=None, backend=None)">
  ...
  <Function id="qiskit.opflow.gradients.QFIBase.parameter_expression_grad" name="parameter_expression_grad" signature="static parameter_expression_grad(param_expr, param)">
  ...
  <Function id="qiskit.opflow.gradients.QFIBase.qfi_method" name="qfi_method" signature="property qfi_method">
    Returns `CircuitQFI`.
