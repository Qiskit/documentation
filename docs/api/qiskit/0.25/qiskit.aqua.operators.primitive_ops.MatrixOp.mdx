---
title: MatrixOp (v0.25)
description: API reference for qiskit.aqua.operators.primitive_ops.MatrixOp in qiskit v0.25
...
<Class id="qiskit.aqua.operators.primitive_ops.MatrixOp" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/aqua/operators/primitive_ops/matrix_op.py" signature="MatrixOp(primitive, coeff=1.0)" modifiers="class">
  ...
  *   **ValueError** – invalid parameters.
  ...
  <Function id="qiskit.aqua.operators.primitive_ops.MatrixOp.__init__" signature="__init__(primitive, coeff=1.0)">
    **Parameters**
  ...
  <Function id="qiskit.aqua.operators.primitive_ops.MatrixOp.add" signature="add(other)">
  ...
  <Function id="qiskit.aqua.operators.primitive_ops.MatrixOp.adjoint" signature="adjoint()">
  ...
  <Function id="qiskit.aqua.operators.primitive_ops.MatrixOp.assign_parameters" signature="assign_parameters(param_dict)">
  ...
  <Function id="qiskit.aqua.operators.primitive_ops.MatrixOp.bind_parameters" signature="bind_parameters(param_dict)">
  ...
  <Function id="qiskit.aqua.operators.primitive_ops.MatrixOp.compose" signature="compose(other, permutation=None, front=False)">
  ...
  <Function id="qiskit.aqua.operators.primitive_ops.MatrixOp.equals" signature="equals(other)">
  ...
  <Function id="qiskit.aqua.operators.primitive_ops.MatrixOp.eval" signature="eval(front=None)">
  ...
  <Function id="qiskit.aqua.operators.primitive_ops.MatrixOp.exp_i" signature="exp_i()">
  ...
  <Function id="qiskit.aqua.operators.primitive_ops.MatrixOp.log_i" signature="log_i(massive=False)">
  ...
  <Function id="qiskit.aqua.operators.primitive_ops.MatrixOp.mul" signature="mul(scalar)">
  ...
  <Function id="qiskit.aqua.operators.primitive_ops.MatrixOp.neg" signature="neg()">
  ...
  <Function id="qiskit.aqua.operators.primitive_ops.MatrixOp.permute" signature="permute(permutation=None)">
  ...
  <Function id="qiskit.aqua.operators.primitive_ops.MatrixOp.power" signature="power(exponent)">
  ...
  <Function id="qiskit.aqua.operators.primitive_ops.MatrixOp.primitive_strings" signature="primitive_strings()">
  ...
  <Function id="qiskit.aqua.operators.primitive_ops.MatrixOp.reduce" signature="reduce()">
  ...
  <Function id="qiskit.aqua.operators.primitive_ops.MatrixOp.tensor" signature="tensor(other)">
  ...
  <Function id="qiskit.aqua.operators.primitive_ops.MatrixOp.tensorpower" signature="tensorpower(other)">
  ...
  <Function id="qiskit.aqua.operators.primitive_ops.MatrixOp.to_circuit" signature="to_circuit()">
  ...
  <Function id="qiskit.aqua.operators.primitive_ops.MatrixOp.to_circuit_op" signature="to_circuit_op()">
  ...
  <Function id="qiskit.aqua.operators.primitive_ops.MatrixOp.to_instruction" signature="to_instruction()">
  ...
  <Function id="qiskit.aqua.operators.primitive_ops.MatrixOp.to_legacy_op" signature="to_legacy_op(massive=False)">
  ...
  <Function id="qiskit.aqua.operators.primitive_ops.MatrixOp.to_matrix" signature="to_matrix(massive=False)">
  ...
  <Function id="qiskit.aqua.operators.primitive_ops.MatrixOp.to_matrix_op" signature="to_matrix_op(massive=False)">
  ...
  <Function id="qiskit.aqua.operators.primitive_ops.MatrixOp.to_pauli_op" signature="to_pauli_op(massive=False)">
