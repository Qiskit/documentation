...
<Class id="qiskit.aqua.operators.primitive_ops.MatrixOp" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/aqua/operators/primitive_ops/matrix_op.py" signature="MatrixOp(primitive, coeff=1.0)">
  ...
  *   **ValueError** – invalid parameters.
  ...
  <Function id="qiskit.aqua.operators.primitive_ops.MatrixOp.__init__" name="__init__" signature="__init__(primitive, coeff=1.0)">
    **Parameters**
  ...
  <Function id="qiskit.aqua.operators.primitive_ops.MatrixOp.add" name="add" signature="add(other)">
  ...
  <Function id="qiskit.aqua.operators.primitive_ops.MatrixOp.adjoint" name="adjoint" signature="adjoint()">
  ...
  <Function id="qiskit.aqua.operators.primitive_ops.MatrixOp.assign_parameters" name="assign_parameters" signature="assign_parameters(param_dict)">
  ...
  <Function id="qiskit.aqua.operators.primitive_ops.MatrixOp.bind_parameters" name="bind_parameters" signature="bind_parameters(param_dict)">
  ...
  <Function id="qiskit.aqua.operators.primitive_ops.MatrixOp.coeff" name="coeff" signature="property coeff">
  ...
  <Function id="qiskit.aqua.operators.primitive_ops.MatrixOp.compose" name="compose" signature="compose(other, permutation=None, front=False)">
  ...
  <Function id="qiskit.aqua.operators.primitive_ops.MatrixOp.equals" name="equals" signature="equals(other)">
  ...
  <Function id="qiskit.aqua.operators.primitive_ops.MatrixOp.eval" name="eval" signature="eval(front=None)">
  ...
  <Function id="qiskit.aqua.operators.primitive_ops.MatrixOp.exp_i" name="exp_i" signature="exp_i()">
  ...
  <Function id="qiskit.aqua.operators.primitive_ops.MatrixOp.log_i" name="log_i" signature="log_i(massive=False)">
  ...
  <Function id="qiskit.aqua.operators.primitive_ops.MatrixOp.mul" name="mul" signature="mul(scalar)">
  ...
  <Function id="qiskit.aqua.operators.primitive_ops.MatrixOp.neg" name="neg" signature="neg()">
  ...
  <Function id="qiskit.aqua.operators.primitive_ops.MatrixOp.num_qubits" name="num_qubits" signature="property num_qubits">
  ...
  <Function id="qiskit.aqua.operators.primitive_ops.MatrixOp.parameters" name="parameters" signature="property parameters">
    Return a set of Parameter objects contained in the Operator.
  </Function>

  ### permute

  <Function id="qiskit.aqua.operators.primitive_ops.MatrixOp.permute" name="permute" signature="permute(permutation=None)">
  ...
  <Function id="qiskit.aqua.operators.primitive_ops.MatrixOp.power" name="power" signature="power(exponent)">
  ...
  <Function id="qiskit.aqua.operators.primitive_ops.MatrixOp.primitive" name="primitive" signature="property primitive">
  ...
  <Function id="qiskit.aqua.operators.primitive_ops.MatrixOp.primitive_strings" name="primitive_strings" signature="primitive_strings()">
  ...
  <Function id="qiskit.aqua.operators.primitive_ops.MatrixOp.reduce" name="reduce" signature="reduce()">
  ...
  <Function id="qiskit.aqua.operators.primitive_ops.MatrixOp.tensor" name="tensor" signature="tensor(other)">
  ...
  <Function id="qiskit.aqua.operators.primitive_ops.MatrixOp.tensorpower" name="tensorpower" signature="tensorpower(other)">
  ...
  <Function id="qiskit.aqua.operators.primitive_ops.MatrixOp.to_circuit" name="to_circuit" signature="to_circuit()">
  ...
  <Function id="qiskit.aqua.operators.primitive_ops.MatrixOp.to_circuit_op" name="to_circuit_op" signature="to_circuit_op()">
  ...
  <Function id="qiskit.aqua.operators.primitive_ops.MatrixOp.to_instruction" name="to_instruction" signature="to_instruction()">
  ...
  <Function id="qiskit.aqua.operators.primitive_ops.MatrixOp.to_legacy_op" name="to_legacy_op" signature="to_legacy_op(massive=False)">
  ...
  <Function id="qiskit.aqua.operators.primitive_ops.MatrixOp.to_matrix" name="to_matrix" signature="to_matrix(massive=False)">
  ...
  <Function id="qiskit.aqua.operators.primitive_ops.MatrixOp.to_matrix_op" name="to_matrix_op" signature="to_matrix_op(massive=False)">
  ...
  <Function id="qiskit.aqua.operators.primitive_ops.MatrixOp.to_pauli_op" name="to_pauli_op" signature="to_pauli_op(massive=False)">
