---
title: LinearSolver (v0.25)
description: API reference for qiskit.algorithms.LinearSolver in qiskit v0.25
...
<Class id="qiskit.algorithms.LinearSolver" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.17/qiskit/algorithms/linear_solvers/linear_solver.py" signature="LinearSolver" modifiers="class">
  An abstract class for linear system solvers in Qiskit.

  ### \_\_init\_\_

  <Function id="qiskit.algorithms.LinearSolver.__init__" signature="__init__()">
  ...
  <Function id="qiskit.algorithms.LinearSolver.solve" signature="solve(matrix, vector, observable=None, observable_circuit=None, post_processing=None)" modifiers="abstract">
