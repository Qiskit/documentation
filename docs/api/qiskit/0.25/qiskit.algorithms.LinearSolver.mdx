...
<Class id="qiskit.algorithms.LinearSolver" github="https://github.com/qiskit/qiskit/tree/stable/0.17/qiskit/algorithms/linear_solvers/linear_solver.py" signature="LinearSolver">
  An abstract class for linear system solvers in Qiskit.

  ### \_\_init\_\_

  <Function id="qiskit.algorithms.LinearSolver.__init__" name="__init__" signature="__init__()">
  ...
  <Function id="qiskit.algorithms.LinearSolver.solve" name="solve" signature="abstract solve(matrix, vector, observable=None, observable_circuit=None, post_processing=None)">
