...
<Class id="qiskit.pulse.MemorySlot" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.17/qiskit/pulse/channels.py" signature="MemorySlot(index)">
  ...
  **index** (`int`) – Index of channel.
  ...
  <Function id="qiskit.pulse.MemorySlot.index" signature="property index">
  ...
  <Function id="qiskit.pulse.MemorySlot.name" signature="property name">
  ...
  <Function id="qiskit.pulse.MemorySlot.parameters" signature="property parameters">
