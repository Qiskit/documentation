---
title: combine_counts (v0.25)
description: API reference for qiskit.ignis.verification.combine_counts in qiskit v0.25
...
<Function id="qiskit.ignis.verification.combine_counts" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-ignis/tree/stable/0.6/qiskit/ignis/verification/tomography/data.py" signature="combine_counts(counts1, counts2)">
