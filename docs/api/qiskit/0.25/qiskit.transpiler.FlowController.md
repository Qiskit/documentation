...
`FlowController(passes, options, **partial_controller)` [GitHub](https://github.com/qiskit/qiskit/tree/stable/0.17/qiskit/transpiler/runningpassmanager.py "view source code")
