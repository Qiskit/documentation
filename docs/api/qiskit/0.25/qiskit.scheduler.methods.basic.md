...
`as_late_as_possible(circuit, schedule_config)` [GitHub](https://github.com/qiskit/qiskit/tree/stable/0.17/qiskit/scheduler/methods/basic.py "view source code")
...
`as_soon_as_possible(circuit, schedule_config)` [GitHub](https://github.com/qiskit/qiskit/tree/stable/0.17/qiskit/scheduler/methods/basic.py "view source code")
