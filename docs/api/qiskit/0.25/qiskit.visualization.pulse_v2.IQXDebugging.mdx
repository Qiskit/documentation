---
title: IQXDebugging (v0.25)
description: API reference for qiskit.visualization.pulse_v2.IQXDebugging in qiskit v0.25
in_page_toc_min_heading_level: 1
python_api_type: class
python_api_name: qiskit.visualization.pulse_v2.IQXDebugging
---

<span id="qiskit-visualization-pulse-v2-iqxdebugging" />
