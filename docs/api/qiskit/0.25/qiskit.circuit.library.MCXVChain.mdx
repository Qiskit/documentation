...
<Class id="qiskit.circuit.library.MCXVChain" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.17/qiskit/circuit/library/standard_gates/x.py" signature="MCXVChain(num_ctrl_qubits=None, dirty_ancillas=False, label=None, ctrl_state=None)">
  ...
  <Function id="qiskit.circuit.library.MCXVChain.ctrl_state" signature="property ctrl_state">
  ...
  <Function id="qiskit.circuit.library.MCXVChain.decompositions" signature="property decompositions">
    Get the decompositions of the instruction from the SessionEquivalenceLibrary.
  </Function>

  ### definition

  <Function id="qiskit.circuit.library.MCXVChain.definition" signature="property definition">
  ...
  <Function id="qiskit.circuit.library.MCXVChain.duration" signature="property duration">
    Get the duration.
  </Function>

  ### get\_num\_ancilla\_qubits

  <Function id="qiskit.circuit.library.MCXVChain.get_num_ancilla_qubits" signature="static get_num_ancilla_qubits(num_ctrl_qubits, mode='v-chain')">
  ...
  <Function id="qiskit.circuit.library.MCXVChain.label" signature="property label">
    Return gate label
  ...
  <Function id="qiskit.circuit.library.MCXVChain.name" signature="property name">
  ...
  <Function id="qiskit.circuit.library.MCXVChain.num_ancilla_qubits" signature="property num_ancilla_qubits">
    The number of ancilla qubits.
  </Function>

  ### num\_ctrl\_qubits

  <Function id="qiskit.circuit.library.MCXVChain.num_ctrl_qubits" signature="property num_ctrl_qubits">
  ...
  <Function id="qiskit.circuit.library.MCXVChain.params" signature="property params">
  ...
  <Function id="qiskit.circuit.library.MCXVChain.unit" signature="property unit">
