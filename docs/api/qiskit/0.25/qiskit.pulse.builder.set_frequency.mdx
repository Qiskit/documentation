---
title: set_frequency (v0.25)
description: API reference for qiskit.pulse.builder.set_frequency in qiskit v0.25
...
<Function id="qiskit.pulse.builder.set_frequency" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.17/qiskit/pulse/builder.py" signature="set_frequency(frequency, channel, name=None)">
