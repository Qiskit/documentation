---
title: ErrorCorrectingCode (v0.25)
description: API reference for qiskit.aqua.components.multiclass_extensions.ErrorCorrectingCode in qiskit v0.25
...
<Class id="qiskit.aqua.components.multiclass_extensions.ErrorCorrectingCode" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/aqua/components/multiclass_extensions/error_correcting_code.py" signature="ErrorCorrectingCode(code_size=4)" modifiers="class">
  ...
  **code\_size** (`int`) – Size of error correcting code
  ...
  <Function id="qiskit.aqua.components.multiclass_extensions.ErrorCorrectingCode.__init__" signature="__init__(code_size=4)">
    **Parameters**
  ...
  <Function id="qiskit.aqua.components.multiclass_extensions.ErrorCorrectingCode.predict" signature="predict(x)">
  ...
  <Function id="qiskit.aqua.components.multiclass_extensions.ErrorCorrectingCode.set_estimator" signature="set_estimator(estimator_cls, params=None)">
  ...
  <Function id="qiskit.aqua.components.multiclass_extensions.ErrorCorrectingCode.test" signature="test(x, y)">
  ...
  <Function id="qiskit.aqua.components.multiclass_extensions.ErrorCorrectingCode.train" signature="train(x, y)">
