...
<Class id="qiskit.chemistry.drivers.Molecule" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/chemistry/drivers/molecule.py" signature="Molecule(geometry, multiplicity=1, charge=0, degrees_of_freedom=None, masses=None)" modifiers="class">
  ...
  **ValueError** – Length of masses must match length of geometries.
  ...
  <Function id="qiskit.chemistry.drivers.Molecule.charge" signature="charge" modifiers="property">
    Get charge
  ...
  <Function id="qiskit.chemistry.drivers.Molecule.geometry" signature="geometry" modifiers="property">
  ...
  <Function id="qiskit.chemistry.drivers.Molecule.masses" signature="masses" modifiers="property">
    Get masses
  ...
  <Function id="qiskit.chemistry.drivers.Molecule.multiplicity" signature="multiplicity" modifiers="property">
    Get multiplicity
  ...
  <Function id="qiskit.chemistry.drivers.Molecule.perturbations" signature="perturbations" modifiers="property">
    Get perturbations
  ...
  <Function id="qiskit.chemistry.drivers.Molecule.units" signature="units" modifiers="property">
