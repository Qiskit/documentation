...
<Class id="qiskit.providers.basicaer.BasicAerProvider" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.17/qiskit/providers/basicaer/basicaerprovider.py" signature="BasicAerProvider">
  Provider for Basic Aer backends.

  ### \_\_init\_\_

  <Function id="qiskit.providers.basicaer.BasicAerProvider.__init__" name="__init__" signature="__init__()">
