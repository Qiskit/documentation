---
title: MultivariateVariationalDistribution (v0.25)
description: API reference for qiskit.aqua.components.uncertainty_models.MultivariateVariationalDistribution in qiskit v0.25
