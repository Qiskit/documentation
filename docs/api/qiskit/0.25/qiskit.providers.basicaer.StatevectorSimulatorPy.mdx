...
<Class id="qiskit.providers.basicaer.StatevectorSimulatorPy" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.17/qiskit/providers/basicaer/statevector_simulator.py" signature="StatevectorSimulatorPy(configuration=None, provider=None, **fields)">
  ...
  **AttributeError** – if input field not a valid options
  ...
  <Function id="qiskit.providers.basicaer.StatevectorSimulatorPy.__init__" name="__init__" signature="__init__(configuration=None, provider=None, **fields)">
    Initialize a backend class
  ...
  <Function id="qiskit.providers.basicaer.StatevectorSimulatorPy.options" name="options" signature="property options">
  ...
  <Function id="qiskit.providers.basicaer.StatevectorSimulatorPy.run" name="run" signature="run(qobj, **backend_options)">
