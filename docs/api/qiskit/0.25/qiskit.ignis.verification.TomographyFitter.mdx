...
<Class id="qiskit.ignis.verification.TomographyFitter" github="https://github.com/qiskit-community/qiskit-ignis/tree/stable/0.6/qiskit/ignis/verification/tomography/fitters/base_fitter.py" signature="TomographyFitter(result, circuits, meas_basis='Pauli', prep_basis='Pauli')">
  ...
  *   **prep\_basis** (`Union`\[`TomographyBasis`, `str`]) – (default: ‘Pauli’) A function to return preparation operators. See Additional Information
  ...
  <Function id="qiskit.ignis.verification.TomographyFitter.__init__" name="__init__" signature="__init__(result, circuits, meas_basis='Pauli', prep_basis='Pauli')">
    Initialize tomography fitter with experimental data.
  ...
  <Function id="qiskit.ignis.verification.TomographyFitter.add_data" name="add_data" signature="add_data(results, circuits)">
  ...
  <Function id="qiskit.ignis.verification.TomographyFitter.data" name="data" signature="property data">
    Return tomography data
  </Function>

  ### fit

  <Function id="qiskit.ignis.verification.TomographyFitter.fit" name="fit" signature="fit(method='auto', standard_weights=True, beta=0.5, psd=True, trace=None, trace_preserving=False, **kwargs)">
  ...
  <Function id="qiskit.ignis.verification.TomographyFitter.measure_basis" name="measure_basis" signature="property measure_basis">
    Return the tomography measurement basis.
  </Function>

  ### preparation\_basis

  <Function id="qiskit.ignis.verification.TomographyFitter.preparation_basis" name="preparation_basis" signature="property preparation_basis">
    Return the tomography preparation basis.
  </Function>

  ### set\_measure\_basis

  <Function id="qiskit.ignis.verification.TomographyFitter.set_measure_basis" name="set_measure_basis" signature="set_measure_basis(basis)">
  ...
  <Function id="qiskit.ignis.verification.TomographyFitter.set_preparation_basis" name="set_preparation_basis" signature="set_preparation_basis(basis)">
