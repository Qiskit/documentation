---
title: MaximumLikelihoodAmplitudeEstimationResult (v0.25)
description: API reference for qiskit.aqua.algorithms.MaximumLikelihoodAmplitudeEstimationResult in qiskit v0.25
