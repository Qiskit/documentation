...
<Class id="qiskit.providers.aer.library.SaveStatevector" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-aer/tree/stable/0.8/qiskit/providers/aer/library/save_instructions/save_statevector.py" signature="SaveStatevector(num_qubits, label='statevector', pershot=False, conditional=False)">
  ...
  *   **conditional** (*bool*) – if True save data conditional on the current classical register values \[Default: False].
  ...
  <Function id="qiskit.providers.aer.library.SaveStatevector.decompositions" signature="property decompositions">
    Get the decompositions of the instruction from the SessionEquivalenceLibrary.
  </Function>

  ### definition

  <Function id="qiskit.providers.aer.library.SaveStatevector.definition" signature="property definition">
    Return definition in terms of other basic gates.
  </Function>

  ### duration

  <Function id="qiskit.providers.aer.library.SaveStatevector.duration" signature="property duration">
    Get the duration.
  </Function>
  ...
  <Function id="qiskit.providers.aer.library.SaveStatevector.params" signature="property params">
  ...
  <Function id="qiskit.providers.aer.library.SaveStatevector.unit" signature="property unit">
