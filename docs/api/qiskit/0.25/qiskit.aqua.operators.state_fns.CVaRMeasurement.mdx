...
<Class id="qiskit.aqua.operators.state_fns.CVaRMeasurement" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/aqua/operators/state_fns/cvar_measurement.py" signature="CVaRMeasurement(primitive=None, alpha=1.0, coeff=1.0)">
  ...
  *   [**AquaError**](qiskit.aqua.AquaError "qiskit.aqua.AquaError") – If the primitive is not diagonal.
  ...
  <Function id="qiskit.aqua.operators.state_fns.CVaRMeasurement.__init__" name="__init__" signature="__init__(primitive=None, alpha=1.0, coeff=1.0)">
    **Parameters**
  ...
  <Function id="qiskit.aqua.operators.state_fns.CVaRMeasurement.add" name="add" signature="add(other)">
  ...
  <Function id="qiskit.aqua.operators.state_fns.CVaRMeasurement.adjoint" name="adjoint" signature="adjoint()">
  ...
  <Function id="qiskit.aqua.operators.state_fns.CVaRMeasurement.alpha" name="alpha" signature="property alpha">
  ...
  <Function id="qiskit.aqua.operators.state_fns.CVaRMeasurement.assign_parameters" name="assign_parameters" signature="assign_parameters(param_dict)">
  ...
  <Function id="qiskit.aqua.operators.state_fns.CVaRMeasurement.bind_parameters" name="bind_parameters" signature="bind_parameters(param_dict)">
  ...
  <Function id="qiskit.aqua.operators.state_fns.CVaRMeasurement.coeff" name="coeff" signature="property coeff">
  ...
  <Function id="qiskit.aqua.operators.state_fns.CVaRMeasurement.compose" name="compose" signature="compose(other, permutation=None, front=False)">
  ...
  <Function id="qiskit.aqua.operators.state_fns.CVaRMeasurement.compute_cvar" name="compute_cvar" signature="compute_cvar(energies, probabilities)">
  ...
  <Function id="qiskit.aqua.operators.state_fns.CVaRMeasurement.equals" name="equals" signature="equals(other)">
  ...
  <Function id="qiskit.aqua.operators.state_fns.CVaRMeasurement.eval" name="eval" signature="eval(front=None)">
  ...
  <Function id="qiskit.aqua.operators.state_fns.CVaRMeasurement.eval_variance" name="eval_variance" signature="eval_variance(front=None)">
  ...
  <Function id="qiskit.aqua.operators.state_fns.CVaRMeasurement.get_outcome_energies_probabilities" name="get_outcome_energies_probabilities" signature="get_outcome_energies_probabilities(front=None)">
  ...
  <Function id="qiskit.aqua.operators.state_fns.CVaRMeasurement.is_measurement" name="is_measurement" signature="property is_measurement">
  ...
  <Function id="qiskit.aqua.operators.state_fns.CVaRMeasurement.mul" name="mul" signature="mul(scalar)">
  ...
  <Function id="qiskit.aqua.operators.state_fns.CVaRMeasurement.neg" name="neg" signature="neg()">
  ...
  <Function id="qiskit.aqua.operators.state_fns.CVaRMeasurement.num_qubits" name="num_qubits" signature="property num_qubits">
  ...
  <Function id="qiskit.aqua.operators.state_fns.CVaRMeasurement.parameters" name="parameters" signature="property parameters">
    Return a set of Parameter objects contained in the Operator.
  </Function>

  ### permute

  <Function id="qiskit.aqua.operators.state_fns.CVaRMeasurement.permute" name="permute" signature="permute(permutation)">
  ...
  <Function id="qiskit.aqua.operators.state_fns.CVaRMeasurement.power" name="power" signature="power(exponent)">
  ...
  <Function id="qiskit.aqua.operators.state_fns.CVaRMeasurement.primitive" name="primitive" signature="property primitive">
    The primitive which defines the behavior of the underlying State function.
  </Function>

  ### primitive\_strings

  <Function id="qiskit.aqua.operators.state_fns.CVaRMeasurement.primitive_strings" name="primitive_strings" signature="primitive_strings()">
  ...
  <Function id="qiskit.aqua.operators.state_fns.CVaRMeasurement.reduce" name="reduce" signature="reduce()">
  ...
  <Function id="qiskit.aqua.operators.state_fns.CVaRMeasurement.sample" name="sample" signature="sample(shots=1024, massive=False, reverse_endianness=False)">
  ...
  <Function id="qiskit.aqua.operators.state_fns.CVaRMeasurement.tensor" name="tensor" signature="tensor(other)">
  ...
  <Function id="qiskit.aqua.operators.state_fns.CVaRMeasurement.tensorpower" name="tensorpower" signature="tensorpower(other)">
  ...
  <Function id="qiskit.aqua.operators.state_fns.CVaRMeasurement.to_circuit_op" name="to_circuit_op" signature="to_circuit_op()">
    Not defined.
  ...
  <Function id="qiskit.aqua.operators.state_fns.CVaRMeasurement.to_density_matrix" name="to_density_matrix" signature="to_density_matrix(massive=False)">
    Not defined.
  ...
  <Function id="qiskit.aqua.operators.state_fns.CVaRMeasurement.to_legacy_op" name="to_legacy_op" signature="to_legacy_op(massive=False)">
  ...
  <Function id="qiskit.aqua.operators.state_fns.CVaRMeasurement.to_matrix" name="to_matrix" signature="to_matrix(massive=False)">
    Not defined.
  ...
  <Function id="qiskit.aqua.operators.state_fns.CVaRMeasurement.to_matrix_op" name="to_matrix_op" signature="to_matrix_op(massive=False)">
    Not defined.
  ...
  <Function id="qiskit.aqua.operators.state_fns.CVaRMeasurement.traverse" name="traverse" signature="traverse(convert_fn, coeff=None)">
