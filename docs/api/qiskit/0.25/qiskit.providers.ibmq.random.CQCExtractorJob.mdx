...
<Class id="qiskit.providers.ibmq.random.CQCExtractorJob" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-ibmq-provider/tree/stable/0.12/qiskit/providers/ibmq/random/cqcextractorjob.py" signature="CQCExtractorJob(job_id, client, parameters=None)">
  ...
  *   **parameters** (`Optional`\[`Dict`]) – Parameters used for this job.
  ...
  <Function id="qiskit.providers.ibmq.random.CQCExtractorJob.__init__" name="__init__" signature="__init__(job_id, client, parameters=None)">
    CQCExtractorJob constructor.
  ...
  <Function id="qiskit.providers.ibmq.random.CQCExtractorJob.block_until_ready" name="block_until_ready" signature="block_until_ready(timeout=None, wait=10)">
  ...
  <Function id="qiskit.providers.ibmq.random.CQCExtractorJob.extractor_method" name="extractor_method" signature="property extractor_method">
  ...
  <Function id="qiskit.providers.ibmq.random.CQCExtractorJob.parameters" name="parameters" signature="property parameters">
  ...
  <Function id="qiskit.providers.ibmq.random.CQCExtractorJob.status" name="status" signature="status()">
