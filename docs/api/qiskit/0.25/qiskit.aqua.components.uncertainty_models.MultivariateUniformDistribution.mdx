---
title: MultivariateUniformDistribution (v0.25)
description: API reference for qiskit.aqua.components.uncertainty_models.MultivariateUniformDistribution in qiskit v0.25
