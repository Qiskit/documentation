...
<Class id="qiskit.optimization.algorithms.OptimizationResult" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/optimization/algorithms/optimization_algorithm.py" signature="OptimizationResult(x, fval, variables, status, raw_results=None, samples=None)" modifiers="class">
  ...
  **Raises**
  ...
  <Function id="qiskit.optimization.algorithms.OptimizationResult.__init__" signature="__init__(x, fval, variables, status, raw_results=None, samples=None)">
    **Parameters**
  ...
  <Function id="qiskit.optimization.algorithms.OptimizationResult.fval" signature="fval" modifiers="property">
  ...
  <Function id="qiskit.optimization.algorithms.OptimizationResult.raw_results" signature="raw_results" modifiers="property">
  ...
  <Function id="qiskit.optimization.algorithms.OptimizationResult.samples" signature="samples" modifiers="property">
  ...
  <Function id="qiskit.optimization.algorithms.OptimizationResult.status" signature="status" modifiers="property">
  ...
  <Function id="qiskit.optimization.algorithms.OptimizationResult.variable_names" signature="variable_names" modifiers="property">
  ...
  <Function id="qiskit.optimization.algorithms.OptimizationResult.variables" signature="variables" modifiers="property">
  ...
  <Function id="qiskit.optimization.algorithms.OptimizationResult.variables_dict" signature="variables_dict" modifiers="property">
  ...
  <Function id="qiskit.optimization.algorithms.OptimizationResult.x" signature="x" modifiers="property">
