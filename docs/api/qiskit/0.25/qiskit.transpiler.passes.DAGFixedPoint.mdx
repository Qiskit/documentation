...
<Class id="qiskit.transpiler.passes.DAGFixedPoint" github="https://github.com/qiskit/qiskit/tree/stable/0.17/qiskit/transpiler/passes/utils/dag_fixed_point.py" signature="DAGFixedPoint(*args, **kwargs)">
