---
title: GateDirection (v0.25)
description: API reference for qiskit.transpiler.passes.GateDirection in qiskit v0.25
...
<Class id="qiskit.transpiler.passes.GateDirection" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.17/qiskit/transpiler/passes/utils/gate_direction.py" signature="GateDirection(*args, **kwargs)" modifiers="class">
