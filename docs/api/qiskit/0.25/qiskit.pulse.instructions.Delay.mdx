...
<Class id="qiskit.pulse.instructions.Delay" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.17/qiskit/pulse/instructions/delay.py" signature="Delay(duration, channel, name=None)" modifiers="class">
  ...
  *   **name** (`Optional`\[`str`]) – Name of the delay for display purposes.
  ...
  <Function id="qiskit.pulse.instructions.Delay.channel" signature="channel" modifiers="property">
  ...
  <Function id="qiskit.pulse.instructions.Delay.channels" signature="channels" modifiers="property">
  ...
  <Function id="qiskit.pulse.instructions.Delay.duration" signature="duration" modifiers="property">
  ...
  <Function id="qiskit.pulse.instructions.Delay.id" signature="id" modifiers="property">
  ...
  <Function id="qiskit.pulse.instructions.Delay.instructions" signature="instructions" modifiers="property">
  ...
  <Function id="qiskit.pulse.instructions.Delay.name" signature="name" modifiers="property">
  ...
  <Function id="qiskit.pulse.instructions.Delay.operands" signature="operands" modifiers="property">
  ...
  <Function id="qiskit.pulse.instructions.Delay.parameters" signature="parameters" modifiers="property">
  ...
  <Function id="qiskit.pulse.instructions.Delay.start_time" signature="start_time" modifiers="property">
  ...
  <Function id="qiskit.pulse.instructions.Delay.stop_time" signature="stop_time" modifiers="property">
