...
<Class id="qiskit.finance.data_providers.BaseDataProvider" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/finance/data_providers/_base_data_provider.py" signature="BaseDataProvider">
  ...
  <Function id="qiskit.finance.data_providers.BaseDataProvider.__init__" signature="abstract __init__()">
  ...
  <Function id="qiskit.finance.data_providers.BaseDataProvider.run" signature="abstract run()">
    Loads data.
