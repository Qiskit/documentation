...
<Function id="qiskit.pulse.builder.qubit_channels" name="qubit_channels" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.17/qiskit/pulse/builder.py" signature="qubit_channels(qubit)">
