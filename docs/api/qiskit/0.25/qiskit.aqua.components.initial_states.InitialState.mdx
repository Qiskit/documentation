...
<Class id="qiskit.aqua.components.initial_states.InitialState" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/aqua/components/initial_states/initial_state.py" signature="InitialState">
  ...
  <Function id="qiskit.aqua.components.initial_states.InitialState.__init__" signature="abstract __init__()">
  ...
  <Function id="qiskit.aqua.components.initial_states.InitialState.bitstr" signature="property bitstr" />

  ### construct\_circuit

  <Function id="qiskit.aqua.components.initial_states.InitialState.construct_circuit" signature="abstract construct_circuit(mode='circuit', register=None)">
