...
<Class id="qiskit.aqua.components.neural_networks.NumPyDiscriminator" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/aqua/components/neural_networks/numpy_discriminator.py" signature="NumPyDiscriminator(n_features=1, n_out=1)">
  ...
  *   **n\_out** (`int`) – Dimension of the discriminator’s output vector.
  ...
  <Function id="qiskit.aqua.components.neural_networks.NumPyDiscriminator.__init__" name="__init__" signature="__init__(n_features=1, n_out=1)">
    **Parameters**
  ...
  <Function id="qiskit.aqua.components.neural_networks.NumPyDiscriminator.discriminator_net" name="discriminator_net" signature="property discriminator_net">
    Get discriminator
  ...
  <Function id="qiskit.aqua.components.neural_networks.NumPyDiscriminator.get_label" name="get_label" signature="get_label(x, detach=False)">
  ...
  <Function id="qiskit.aqua.components.neural_networks.NumPyDiscriminator.load_model" name="load_model" signature="load_model(load_dir)">
  ...
  <Function id="qiskit.aqua.components.neural_networks.NumPyDiscriminator.loss" name="loss" signature="loss(x, y, weights=None)">
  ...
  <Function id="qiskit.aqua.components.neural_networks.NumPyDiscriminator.save_model" name="save_model" signature="save_model(snapshot_dir)">
  ...
  <Function id="qiskit.aqua.components.neural_networks.NumPyDiscriminator.set_seed" name="set_seed" signature="set_seed(seed)">
    Set seed. :param seed: seed :type seed: int
  </Function>

  ### train

  <Function id="qiskit.aqua.components.neural_networks.NumPyDiscriminator.train" name="train" signature="train(data, weights, penalty=False, quantum_instance=None, shots=None)">
