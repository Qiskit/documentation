...
$$
  ...
  *   **name** (`Optional`\[`str`]) – Display name for this instruction.
  ...
  <Function id="qiskit.pulse.instructions.SetPhase.channel" signature="property channel">
  ...
  <Function id="qiskit.pulse.instructions.SetPhase.channels" signature="property channels">
  ...
  <Function id="qiskit.pulse.instructions.SetPhase.duration" signature="property duration">
  ...
  <Function id="qiskit.pulse.instructions.SetPhase.id" signature="property id">
  ...
  <Function id="qiskit.pulse.instructions.SetPhase.instructions" signature="property instructions">
  ...
  <Function id="qiskit.pulse.instructions.SetPhase.name" signature="property name">
  ...
  <Function id="qiskit.pulse.instructions.SetPhase.operands" signature="property operands">
  ...
  <Function id="qiskit.pulse.instructions.SetPhase.parameters" signature="property parameters">
  ...
  <Function id="qiskit.pulse.instructions.SetPhase.phase" signature="property phase">
  ...
  <Function id="qiskit.pulse.instructions.SetPhase.start_time" signature="property start_time">
  ...
  <Function id="qiskit.pulse.instructions.SetPhase.stop_time" signature="property stop_time">
