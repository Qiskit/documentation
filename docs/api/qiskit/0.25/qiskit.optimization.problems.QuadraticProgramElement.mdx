...
<Class id="qiskit.optimization.problems.QuadraticProgramElement" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/optimization/problems/quadratic_program_element.py" signature="QuadraticProgramElement(quadratic_program)">
  ...
  **TypeError** – QuadraticProgram instance expected.
  ...
  <Function id="qiskit.optimization.problems.QuadraticProgramElement.__init__" name="__init__" signature="__init__(quadratic_program)">
    Initialize object with parent QuadraticProgram.
  ...
  <Function id="qiskit.optimization.problems.QuadraticProgramElement.quadratic_program" name="quadratic_program" signature="property quadratic_program">
