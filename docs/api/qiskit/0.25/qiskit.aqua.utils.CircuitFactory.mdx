...
<Class id="qiskit.aqua.utils.CircuitFactory" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/aqua/utils/circuit_factory.py" signature="CircuitFactory(num_target_qubits)">
  ...
  <Function id="qiskit.aqua.utils.CircuitFactory.build" signature="abstract build(qc, q, q_ancillas=None, params=None)">
  ...
  <Function id="qiskit.aqua.utils.CircuitFactory.num_target_qubits" signature="property num_target_qubits">
