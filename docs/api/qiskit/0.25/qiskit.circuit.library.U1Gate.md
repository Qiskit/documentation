...
`U1Gate(theta, label=None)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.17/qiskit/circuit/library/standard_gates/u1.py "view source code")
...
<span id="qiskit.circuit.library.U1Gate.__init__" />
...
<span id="qiskit.circuit.library.U1Gate.reverse_ops" />
...
<span id="qiskit.circuit.library.U1Gate.soft_compare" />
...
<span id="qiskit.circuit.library.U1Gate.validate_parameter" />
