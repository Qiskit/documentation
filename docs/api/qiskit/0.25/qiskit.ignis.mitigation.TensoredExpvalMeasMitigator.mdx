---
title: TensoredExpvalMeasMitigator (v0.25)
description: API reference for qiskit.ignis.mitigation.TensoredExpvalMeasMitigator in qiskit v0.25
...
<Class id="qiskit.ignis.mitigation.TensoredExpvalMeasMitigator" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-ignis/tree/stable/0.6/qiskit/ignis/mitigation/expval/tensored_mitigator.py" signature="TensoredExpvalMeasMitigator(amats)" modifiers="class">
  ...
  **amats** (`List`\[`ndarray`]) – list of single-qubit readout error assignment matrices.
  ...
  <Function id="qiskit.ignis.mitigation.TensoredExpvalMeasMitigator.__init__" signature="__init__(amats)">
    Initialize a TensorMeasurementMitigator
  ...
  <Function id="qiskit.ignis.mitigation.TensoredExpvalMeasMitigator.assignment_fidelity" signature="assignment_fidelity(qubits=None)">
  ...
  <Function id="qiskit.ignis.mitigation.TensoredExpvalMeasMitigator.assignment_matrix" signature="assignment_matrix(qubits=None)">
  ...
  <Function id="qiskit.ignis.mitigation.TensoredExpvalMeasMitigator.expectation_value" signature="expectation_value(counts, diagonal=None, qubits=None, clbits=None)">
  ...
  <Function id="qiskit.ignis.mitigation.TensoredExpvalMeasMitigator.mitigation_matrix" signature="mitigation_matrix(qubits=None)">
  ...
  <Function id="qiskit.ignis.mitigation.TensoredExpvalMeasMitigator.mitigation_overhead" signature="mitigation_overhead(qubits=None)">
  ...
  <Function id="qiskit.ignis.mitigation.TensoredExpvalMeasMitigator.plot_assignment_matrix" signature="plot_assignment_matrix(qubits=None, ax=None)">
  ...
  <Function id="qiskit.ignis.mitigation.TensoredExpvalMeasMitigator.plot_mitigation_matrix" signature="plot_mitigation_matrix(qubits=None, ax=None)">
  ...
  <Function id="qiskit.ignis.mitigation.TensoredExpvalMeasMitigator.required_shots" signature="required_shots(delta, qubits=None)">
  ...
  <Function id="qiskit.ignis.mitigation.TensoredExpvalMeasMitigator.stddev_upper_bound" signature="stddev_upper_bound(shots=1, qubits=None)">
