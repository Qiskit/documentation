...
<Class id="qiskit.pulse.Instruction" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.17/qiskit/pulse/instructions/instruction.py" signature="Instruction(operands, duration=None, channels=None, name=None)">
  ...
  *   [**PulseError**](qiskit.pulse.PulseError "qiskit.pulse.PulseError") – If the input `channels` are not all of type `Channel`.
  ...
  <Function id="qiskit.pulse.Instruction.__init__" name="__init__" signature="__init__(operands, duration=None, channels=None, name=None)">
    Instruction initializer.
  ...
  <Function id="qiskit.pulse.Instruction.append" name="append" signature="append(schedule, name=None)">
  ...
  <Function id="qiskit.pulse.Instruction.assign_parameters" name="assign_parameters" signature="assign_parameters(value_dict)">
  ...
  <Function id="qiskit.pulse.Instruction.ch_duration" name="ch_duration" signature="ch_duration(*channels)">
  ...
  <Function id="qiskit.pulse.Instruction.ch_start_time" name="ch_start_time" signature="ch_start_time(*channels)">
  ...
  <Function id="qiskit.pulse.Instruction.ch_stop_time" name="ch_stop_time" signature="ch_stop_time(*channels)">
  ...
  <Function id="qiskit.pulse.Instruction.channels" name="channels" signature="abstract property channels">
  ...
  <Function id="qiskit.pulse.Instruction.draw" name="draw" signature="draw(dt=1, style=None, filename=None, interp_method=None, scale=1, plot_all=False, plot_range=None, interactive=False, table=True, label=False, framechange=True, channels=None)">
  ...
  <Function id="qiskit.pulse.Instruction.duration" name="duration" signature="property duration">
  ...
  <Function id="qiskit.pulse.Instruction.flatten" name="flatten" signature="flatten()">
  ...
  <Function id="qiskit.pulse.Instruction.id" name="id" signature="property id">
  ...
  <Function id="qiskit.pulse.Instruction.insert" name="insert" signature="insert(start_time, schedule, name=None)">
  ...
  <Function id="qiskit.pulse.Instruction.instructions" name="instructions" signature="property instructions">
  ...
  <Function id="qiskit.pulse.Instruction.is_parameterized" name="is_parameterized" signature="is_parameterized()">
  ...
  <Function id="qiskit.pulse.Instruction.name" name="name" signature="property name">
  ...
  <Function id="qiskit.pulse.Instruction.operands" name="operands" signature="property operands">
  ...
  <Function id="qiskit.pulse.Instruction.parameters" name="parameters" signature="property parameters">
  ...
  <Function id="qiskit.pulse.Instruction.shift" name="shift" signature="shift(time, name=None)">
  ...
  <Function id="qiskit.pulse.Instruction.start_time" name="start_time" signature="property start_time">
  ...
  <Function id="qiskit.pulse.Instruction.stop_time" name="stop_time" signature="property stop_time">
