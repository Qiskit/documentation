...
<Class id="qiskit.pulse.Instruction" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.17/qiskit/pulse/instructions/instruction.py" signature="Instruction(operands, duration=None, channels=None, name=None)">
  ...
  *   [**PulseError**](qiskit.pulse.PulseError "qiskit.pulse.PulseError") – If the input `channels` are not all of type `Channel`.
  ...
  <Function id="qiskit.pulse.Instruction.channels" signature="abstract property channels">
  ...
  <Function id="qiskit.pulse.Instruction.duration" signature="property duration">
  ...
  <Function id="qiskit.pulse.Instruction.id" signature="property id">
  ...
  <Function id="qiskit.pulse.Instruction.instructions" signature="property instructions">
  ...
  <Function id="qiskit.pulse.Instruction.name" signature="property name">
  ...
  <Function id="qiskit.pulse.Instruction.operands" signature="property operands">
  ...
  <Function id="qiskit.pulse.Instruction.parameters" signature="property parameters">
  ...
  <Function id="qiskit.pulse.Instruction.start_time" signature="property start_time">
  ...
  <Function id="qiskit.pulse.Instruction.stop_time" signature="property stop_time">
