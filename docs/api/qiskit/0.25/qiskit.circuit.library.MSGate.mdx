---
title: MSGate (v0.25)
description: API reference for qiskit.circuit.library.MSGate in qiskit v0.25
...
<Class id="qiskit.circuit.library.MSGate" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.17/qiskit/circuit/library/standard_gates/ms.py" signature="MSGate(num_qubits, theta, label=None)" modifiers="class">
