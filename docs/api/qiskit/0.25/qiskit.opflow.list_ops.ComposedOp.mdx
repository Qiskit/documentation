...
<Class id="qiskit.opflow.list_ops.ComposedOp" github="https://github.com/qiskit/qiskit/tree/stable/0.17/qiskit/opflow/list_ops/composed_op.py" signature="ComposedOp(oplist, coeff=1.0, abelian=False)">
