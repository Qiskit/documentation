...
`PauliExpectation(group_paulis=True)` [GitHub](https://github.com/qiskit/qiskit/tree/stable/0.17/qiskit/opflow/expectations/pauli_expectation.py "view source code")
...
<span id="qiskit.opflow.expectations.PauliExpectation.__init__" />
