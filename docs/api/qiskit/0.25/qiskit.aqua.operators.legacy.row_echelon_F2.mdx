---
title: row_echelon_F2 (v0.25)
description: API reference for qiskit.aqua.operators.legacy.row_echelon_F2 in qiskit v0.25
in_page_toc_min_heading_level: 1
python_api_type: function
python_api_name: qiskit.aqua.operators.legacy.row_echelon_F2
---

<span id="qiskit-aqua-operators-legacy-row-echelon-f2" />
