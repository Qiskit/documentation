...
<Class id="qiskit.aqua.operators.gradients.NaturalGradient" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/aqua/operators/gradients/natural_gradient.py" signature="NaturalGradient(grad_method='lin_comb', qfi_method='lin_comb_full', regularization=None, **kwargs)">
  ...
  *   **kwargs** (*dict*) – Optional parameters for a CircuitGradient
  ...
  <Function id="qiskit.aqua.operators.gradients.NaturalGradient.grad_method" signature="property grad_method">
  ...
  <Function id="qiskit.aqua.operators.gradients.NaturalGradient.parameter_expression_grad" signature="static parameter_expression_grad(param_expr, param)">
  ...
  <Function id="qiskit.aqua.operators.gradients.NaturalGradient.qfi_method" signature="property qfi_method">
    Returns `CircuitQFI`.
  ...
  <Function id="qiskit.aqua.operators.gradients.NaturalGradient.regularization" signature="property regularization">
