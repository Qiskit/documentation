...
<Class id="qiskit.algorithms.MinimumEigensolverResult" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.17/qiskit/algorithms/minimum_eigen_solvers/minimum_eigen_solver.py" signature="MinimumEigensolverResult" modifiers="class">
  ...
  <Function id="qiskit.algorithms.MinimumEigensolverResult.aux_operator_eigenvalues" signature="aux_operator_eigenvalues" modifiers="property">
  ...
  <Function id="qiskit.algorithms.MinimumEigensolverResult.eigenstate" signature="eigenstate" modifiers="property">
    return eigen state
  ...
  <Function id="qiskit.algorithms.MinimumEigensolverResult.eigenvalue" signature="eigenvalue" modifiers="property">
    returns eigen value
