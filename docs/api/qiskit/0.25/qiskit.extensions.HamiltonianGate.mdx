...
<Class id="qiskit.extensions.HamiltonianGate" github="https://github.com/qiskit/qiskit/tree/stable/0.17/qiskit/extensions/hamiltonian_gate.py" signature="HamiltonianGate(data, time, label=None)">
