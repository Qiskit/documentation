...
<Class id="qiskit.pulse.MeasureChannel" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.17/qiskit/pulse/channels.py" signature="MeasureChannel(index)">
  ...
  **index** (`int`) – Index of channel.
  ...
  <Function id="qiskit.pulse.MeasureChannel.__init__" name="__init__" signature="__init__(index)">
    Channel class.
  ...
  <Function id="qiskit.pulse.MeasureChannel.assign" name="assign" signature="assign(parameter, value)">
  ...
  <Function id="qiskit.pulse.MeasureChannel.index" name="index" signature="property index">
  ...
  <Function id="qiskit.pulse.MeasureChannel.is_parameterized" name="is_parameterized" signature="is_parameterized()">
  ...
  <Function id="qiskit.pulse.MeasureChannel.name" name="name" signature="property name">
  ...
  <Function id="qiskit.pulse.MeasureChannel.parameters" name="parameters" signature="property parameters">
