...
<Class id="qiskit.transpiler.InstructionDurations" github="https://github.com/qiskit/qiskit/tree/stable/0.17/qiskit/transpiler/instruction_durations.py" signature="InstructionDurations(instruction_durations=None, dt=None)">
