...
```python
<matplotlib.axes._subplots.AxesSubplot at 0x7f9f1fac6bd0>
```

![../\_images/qiskit.ignis.mitigation.expval\_meas\_mitigator\_circuits\_0\_1.png](/images/api/qiskit/0.25/qiskit.ignis.mitigation.expval_meas_mitigator_circuits_0_1.png)
