---
title: save_amplitudes (v0.25)
description: API reference for qiskit.providers.aer.library.save_amplitudes in qiskit v0.25
...
<Function id="qiskit.providers.aer.library.save_amplitudes" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-aer/tree/stable/0.8/qiskit/providers/aer/library/save_instructions/save_amplitudes.py" signature="save_amplitudes(self, params, label='amplitudes', pershot=False, conditional=False)">
