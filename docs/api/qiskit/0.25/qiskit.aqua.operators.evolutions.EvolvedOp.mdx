---
title: EvolvedOp (v0.25)
description: API reference for qiskit.aqua.operators.evolutions.EvolvedOp in qiskit v0.25
...
<Class id="qiskit.aqua.operators.evolutions.EvolvedOp" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/aqua/operators/evolutions/evolved_op.py" signature="EvolvedOp(primitive, coeff=1.0)" modifiers="class">
  ...
  *   **coeff** (`Union`\[`int`, `float`, `complex`, `ParameterExpression`, `None`]) – A coefficient multiplying the operator
  ...
  <Attribute id="qiskit.aqua.operators.evolutions.EvolvedOp.coeff">
  ...
  <Attribute id="qiskit.aqua.operators.evolutions.EvolvedOp.num_qubits">
  ...
  <Attribute id="qiskit.aqua.operators.evolutions.EvolvedOp.parameters">
  ...
  <Attribute id="qiskit.aqua.operators.evolutions.EvolvedOp.primitive">
