...
<Class id="qiskit.optimization.problems.LinearExpression" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/optimization/problems/linear_expression.py" signature="LinearExpression(quadratic_program, coefficients)">
  ...
  *   **coefficients** (`Union`\[`ndarray`, `spmatrix`, `List`\[`float`], `Dict`\[`Union`\[`int`, `str`], `float`]]) – The (sparse) representation of the coefficients.
  ...
  <Function id="qiskit.optimization.problems.LinearExpression.__init__" name="__init__" signature="__init__(quadratic_program, coefficients)">
    Creates a new linear expression.
  ...
  <Function id="qiskit.optimization.problems.LinearExpression.coefficients" name="coefficients" signature="property coefficients">
  ...
  <Function id="qiskit.optimization.problems.LinearExpression.evaluate" name="evaluate" signature="evaluate(x)">
  ...
  <Function id="qiskit.optimization.problems.LinearExpression.evaluate_gradient" name="evaluate_gradient" signature="evaluate_gradient(x)">
  ...
  <Function id="qiskit.optimization.problems.LinearExpression.quadratic_program" name="quadratic_program" signature="property quadratic_program">
  ...
  <Function id="qiskit.optimization.problems.LinearExpression.to_array" name="to_array" signature="to_array()">
  ...
  <Function id="qiskit.optimization.problems.LinearExpression.to_dict" name="to_dict" signature="to_dict(use_name=False)">
