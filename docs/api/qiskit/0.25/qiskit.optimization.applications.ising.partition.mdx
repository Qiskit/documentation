...
<Function id="qiskit.optimization.applications.ising.partition.get_operator" name="get_operator" github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/optimization/applications/ising/partition.py" signature="get_operator(values)">
...
<Function id="qiskit.optimization.applications.ising.partition.partition_value" name="partition_value" github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/optimization/applications/ising/partition.py" signature="partition_value(x, number_list)">
