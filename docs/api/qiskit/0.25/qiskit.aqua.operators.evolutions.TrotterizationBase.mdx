...
<Class id="qiskit.aqua.operators.evolutions.TrotterizationBase" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/aqua/operators/evolutions/trotterizations/trotterization_base.py" signature="TrotterizationBase(reps=1)">
  ...
  <Function id="qiskit.aqua.operators.evolutions.TrotterizationBase.__init__" name="__init__" signature="__init__(reps=1)">
  ...
  <Function id="qiskit.aqua.operators.evolutions.TrotterizationBase.convert" name="convert" signature="abstract convert(operator)">
  ...
  <Function id="qiskit.aqua.operators.evolutions.TrotterizationBase.reps" name="reps" signature="property reps">
