...
<Class id="qiskit.aqua.components.eigs.EigsQPE" github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/aqua/components/eigs/eigs_qpe.py" signature="EigsQPE(operator, iqft, num_time_slices=1, num_ancillae=1, expansion_mode='trotter', expansion_order=1, evo_time=None, negative_evals=False, ne_qfts=None)">
  ...
  *   **ne\_qfts** (`Optional`\[`List`]) – The QFT and IQFT circuits for handling negative eigenvalues
  ...
  <Function id="qiskit.aqua.components.eigs.EigsQPE.__init__" name="__init__" signature="__init__(operator, iqft, num_time_slices=1, num_ancillae=1, expansion_mode='trotter', expansion_order=1, evo_time=None, negative_evals=False, ne_qfts=None)">
    **Parameters**
  ...
  <Function id="qiskit.aqua.components.eigs.EigsQPE.construct_circuit" name="construct_circuit" signature="construct_circuit(mode, register=None)">
  ...
  <Function id="qiskit.aqua.components.eigs.EigsQPE.construct_inverse" name="construct_inverse" signature="construct_inverse(mode, circuit)">
  ...
  <Function id="qiskit.aqua.components.eigs.EigsQPE.get_register_sizes" name="get_register_sizes" signature="get_register_sizes()">
    get register sizes
  </Function>

  ### get\_scaling

  <Function id="qiskit.aqua.components.eigs.EigsQPE.get_scaling" name="get_scaling" signature="get_scaling()">
    get scaling
  </Function>
</Class>
