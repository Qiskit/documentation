...
<Class id="qiskit.opflow.primitive_ops.PrimitiveOp" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.17/qiskit/opflow/primitive_ops/primitive_op.py" signature="PrimitiveOp(primitive, coeff=1.0)">
  ...
  *   **coeff** (`Union`\[`complex`, `ParameterExpression`]) – A coefficient multiplying the primitive.
  ...
  <Function id="qiskit.opflow.primitive_ops.PrimitiveOp.coeff" signature="property coeff">
  ...
  <Function id="qiskit.opflow.primitive_ops.PrimitiveOp.instance_id" signature="property instance_id">
  ...
  <Function id="qiskit.opflow.primitive_ops.PrimitiveOp.num_qubits" signature="property num_qubits">
  ...
  <Function id="qiskit.opflow.primitive_ops.PrimitiveOp.parameters" signature="property parameters">
  ...
  <Function id="qiskit.opflow.primitive_ops.PrimitiveOp.primitive" signature="property primitive">
