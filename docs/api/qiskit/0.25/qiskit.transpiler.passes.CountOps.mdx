...
<Class id="qiskit.transpiler.passes.CountOps" github="https://github.com/qiskit/qiskit/tree/stable/0.17/qiskit/transpiler/passes/analysis/count_ops.py" signature="CountOps(*args, **kwargs)">
