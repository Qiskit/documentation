...
$$
  ...
  **Additional Information:**
  ...
  <Function id="qiskit.quantum_info.Kraus.atol" signature="property atol">
  ...
  <Function id="qiskit.quantum_info.Kraus.data" signature="property data">
    Return list of Kraus matrices for channel.
  </Function>

  ### dim

  <Function id="qiskit.quantum_info.Kraus.dim" signature="property dim">
  ...
  <Function id="qiskit.quantum_info.Kraus.num_qubits" signature="property num_qubits">
  ...
  <Function id="qiskit.quantum_info.Kraus.qargs" signature="property qargs">
  ...
  <Function id="qiskit.quantum_info.Kraus.rtol" signature="property rtol">
