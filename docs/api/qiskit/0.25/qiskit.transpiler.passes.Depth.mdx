...
<Class id="qiskit.transpiler.passes.Depth" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.17/qiskit/transpiler/passes/analysis/depth.py" signature="Depth(*args, **kwargs)" modifiers="class">
  Calculate the depth of a DAG circuit.

  ### \_\_init\_\_

  <Function id="qiskit.transpiler.passes.Depth.__init__" signature="__init__()">
  ...
  <Function id="qiskit.transpiler.passes.Depth.is_analysis_pass" signature="is_analysis_pass" modifiers="property">
  ...
  <Function id="qiskit.transpiler.passes.Depth.is_transformation_pass" signature="is_transformation_pass" modifiers="property">
