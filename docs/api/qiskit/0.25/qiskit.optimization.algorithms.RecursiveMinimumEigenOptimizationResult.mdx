---
title: RecursiveMinimumEigenOptimizationResult (v0.25)
description: API reference for qiskit.optimization.algorithms.RecursiveMinimumEigenOptimizationResult in qiskit v0.25
