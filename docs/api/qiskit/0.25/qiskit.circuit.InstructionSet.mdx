...
<Class id="qiskit.circuit.InstructionSet" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.17/qiskit/circuit/instructionset.py" signature="InstructionSet">
  ...
  <Function id="qiskit.circuit.InstructionSet.__init__" name="__init__" signature="__init__()">
    New collection of instructions.
  ...
  <Function id="qiskit.circuit.InstructionSet.add" name="add" signature="add(gate, qargs, cargs)">
