...
<Class id="qiskit.aqua.operators.expectations.MatrixExpectation" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/aqua/operators/expectations/matrix_expectation.py" signature="MatrixExpectation">
  ...
  <Function id="qiskit.aqua.operators.expectations.MatrixExpectation.__init__" name="__init__" signature="__init__()">
  ...
  <Function id="qiskit.aqua.operators.expectations.MatrixExpectation.compute_variance" name="compute_variance" signature="compute_variance(exp_op)">
  ...
  <Function id="qiskit.aqua.operators.expectations.MatrixExpectation.convert" name="convert" signature="convert(operator)">
