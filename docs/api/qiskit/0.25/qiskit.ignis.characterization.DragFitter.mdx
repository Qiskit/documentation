...
<Class id="qiskit.ignis.characterization.DragFitter" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-ignis/tree/stable/0.6/qiskit/ignis/characterization/calibrations/fitters.py" signature="DragFitter(backend_result, xdata, qubits, fit_p0, fit_bounds=None)" modifiers="class">
  ...
  <Function id="qiskit.ignis.characterization.DragFitter.backend_result" signature="backend_result" modifiers="property">
  ...
  <Function id="qiskit.ignis.characterization.DragFitter.description" signature="description" modifiers="property">
  ...
  <Function id="qiskit.ignis.characterization.DragFitter.fit_fun" signature="fit_fun" modifiers="property">
  ...
  <Function id="qiskit.ignis.characterization.DragFitter.measured_qubits" signature="measured_qubits" modifiers="property">
  ...
  <Function id="qiskit.ignis.characterization.DragFitter.params" signature="params" modifiers="property">
  ...
  <Function id="qiskit.ignis.characterization.DragFitter.params_err" signature="params_err" modifiers="property">
  ...
  <Function id="qiskit.ignis.characterization.DragFitter.series" signature="series" modifiers="property">
  ...
  <Function id="qiskit.ignis.characterization.DragFitter.xdata" signature="xdata" modifiers="property">
  ...
  <Function id="qiskit.ignis.characterization.DragFitter.ydata" signature="ydata" modifiers="property">
