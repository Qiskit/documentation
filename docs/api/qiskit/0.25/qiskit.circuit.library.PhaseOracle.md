...
`PhaseOracle(expression, synthesizer=None)` [GitHub](https://github.com/qiskit/qiskit/tree/stable/0.17/qiskit/circuit/library/phase_oracle.py "view source code")
...
| [`compose`](#qiskit.circuit.library.PhaseOracle.compose "qiskit.circuit.library.PhaseOracle.compose")(other\[, qubits, clbits, front, inplace])                                                 | Compose circuit with `other` circuit or instruction, optionally permuting wires.                                                    |
...
| [`pauli`](#qiskit.circuit.library.PhaseOracle.pauli "qiskit.circuit.library.PhaseOracle.pauli")(pauli\_string, qubits)                                                                          | Apply `PauliGate`.                                                                                                                  |
...
| [`qasm`](#qiskit.circuit.library.PhaseOracle.qasm "qiskit.circuit.library.PhaseOracle.qasm")(\[formatted, filename])                                                                            | Return OpenQASM string.                                                                                                             |
...
| [`to_instruction`](#qiskit.circuit.library.PhaseOracle.to_instruction "qiskit.circuit.library.PhaseOracle.to_instruction")(\[parameter\_map])                                                   | Create an Instruction out of this circuit.                                                                                          |
...
![../\_images/qiskit.circuit.library.PhaseOracle\_2\_0.png](/images/api/qiskit/0.25/qiskit.circuit.library.PhaseOracle_2_0.png)
...
Evaluate the oracle on a bitstring. This evaluation is done classically without any quantum circuit. :type bitstring: `str` :param bitstring: The bitstring for which to evaluate.
