---
title: RXXGate (v0.25)
description: API reference for qiskit.circuit.library.RXXGate in qiskit v0.25
...
<Class id="qiskit.circuit.library.RXXGate" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.17/qiskit/circuit/library/standard_gates/rxx.py" signature="RXXGate(theta)" modifiers="class">
...
$$
  ...
  **Examples:**
  ...
  <Function id="qiskit.circuit.library.RXXGate.soft_compare" signature="soft_compare(other)">
