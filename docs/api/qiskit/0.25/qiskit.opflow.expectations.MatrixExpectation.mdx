---
title: MatrixExpectation (v0.25)
description: API reference for qiskit.opflow.expectations.MatrixExpectation in qiskit v0.25
...
<Class id="qiskit.opflow.expectations.MatrixExpectation" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.17/qiskit/opflow/expectations/matrix_expectation.py" signature="MatrixExpectation" modifiers="class">
  ...
  <Function id="qiskit.opflow.expectations.MatrixExpectation.__init__" signature="__init__()">
