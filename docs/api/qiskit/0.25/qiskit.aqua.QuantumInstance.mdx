...
<Class id="qiskit.aqua.QuantumInstance" github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/aqua/quantum_instance.py" signature="QuantumInstance(backend, shots=1024, seed_simulator=None, max_credits=10, basis_gates=None, coupling_map=None, initial_layout=None, pass_manager=None, seed_transpiler=None, optimization_level=None, backend_options=None, noise_model=None, timeout=None, wait=5.0, skip_qobj_validation=True, measurement_error_mitigation_cls=None, cals_matrix_refresh_period=30, measurement_error_mitigation_shots=None, job_callback=None)">
  ...
  *   [**AquaError**](qiskit.aqua.AquaError "qiskit.aqua.AquaError") – set backend\_options but the backend does not support that
  ...
  <Function id="qiskit.aqua.QuantumInstance.__init__" name="__init__" signature="__init__(backend, shots=1024, seed_simulator=None, max_credits=10, basis_gates=None, coupling_map=None, initial_layout=None, pass_manager=None, seed_transpiler=None, optimization_level=None, backend_options=None, noise_model=None, timeout=None, wait=5.0, skip_qobj_validation=True, measurement_error_mitigation_cls=None, cals_matrix_refresh_period=30, measurement_error_mitigation_shots=None, job_callback=None)">
    Quantum Instance holds a Qiskit Terra backend as well as configuration for circuit transpilation and execution. When provided to an Aqua algorithm the algorithm will execute the circuits it needs to run using the instance.
  ...
  <Function id="qiskit.aqua.QuantumInstance.assemble" name="assemble" signature="assemble(circuits)">
    assemble circuits
  ...
  <Function id="qiskit.aqua.QuantumInstance.backend" name="backend" signature="property backend">
    Return BaseBackend backend object.
  </Function>

  ### backend\_config

  <Function id="qiskit.aqua.QuantumInstance.backend_config" name="backend_config" signature="property backend_config">
    Getter of backend\_config.
  </Function>

  ### backend\_name

  <Function id="qiskit.aqua.QuantumInstance.backend_name" name="backend_name" signature="property backend_name">
    Return backend name.
  </Function>

  ### backend\_options

  <Function id="qiskit.aqua.QuantumInstance.backend_options" name="backend_options" signature="property backend_options">
    Getter of backend\_options.
  </Function>

  ### cals\_matrix

  <Function id="qiskit.aqua.QuantumInstance.cals_matrix" name="cals_matrix" signature="cals_matrix(qubit_index=None)">
  ...
  <Function id="qiskit.aqua.QuantumInstance.cals_matrix_refresh_period" name="cals_matrix_refresh_period" signature="property cals_matrix_refresh_period">
    returns matrix refresh period
  </Function>

  ### circuit\_summary

  <Function id="qiskit.aqua.QuantumInstance.circuit_summary" name="circuit_summary" signature="property circuit_summary">
    Getter of circuit summary.
  </Function>

  ### compile\_config

  <Function id="qiskit.aqua.QuantumInstance.compile_config" name="compile_config" signature="property compile_config">
    Getter of compile\_config.
  </Function>

  ### execute

  <Function id="qiskit.aqua.QuantumInstance.execute" name="execute" signature="execute(circuits, had_transpiled=False)">
  ...
  <Function id="qiskit.aqua.QuantumInstance.is_local" name="is_local" signature="property is_local">
    Return True if backend is a local backend.
  </Function>

  ### is\_simulator

  <Function id="qiskit.aqua.QuantumInstance.is_simulator" name="is_simulator" signature="property is_simulator">
    Return True if backend is a simulator.
  </Function>

  ### is\_statevector

  <Function id="qiskit.aqua.QuantumInstance.is_statevector" name="is_statevector" signature="property is_statevector">
    Return True if backend is a statevector-type simulator.
  </Function>

  ### maybe\_refresh\_cals\_matrix

  <Function id="qiskit.aqua.QuantumInstance.maybe_refresh_cals_matrix" name="maybe_refresh_cals_matrix" signature="maybe_refresh_cals_matrix(timestamp=None)">
  ...
  <Function id="qiskit.aqua.QuantumInstance.measurement_error_mitigation_cls" name="measurement_error_mitigation_cls" signature="property measurement_error_mitigation_cls">
    returns measurement error mitigation cls
  </Function>

  ### measurement\_error\_mitigation\_shots

  <Function id="qiskit.aqua.QuantumInstance.measurement_error_mitigation_shots" name="measurement_error_mitigation_shots" signature="property measurement_error_mitigation_shots">
    returns measurement error mitigation shots
  </Function>

  ### noise\_config

  <Function id="qiskit.aqua.QuantumInstance.noise_config" name="noise_config" signature="property noise_config">
    Getter of noise\_config.
  </Function>

  ### qjob\_config

  <Function id="qiskit.aqua.QuantumInstance.qjob_config" name="qjob_config" signature="property qjob_config">
    Getter of qjob\_config.
  </Function>

  ### reset\_execution\_results

  <Function id="qiskit.aqua.QuantumInstance.reset_execution_results" name="reset_execution_results" signature="reset_execution_results()">
  ...
  <Function id="qiskit.aqua.QuantumInstance.run_config" name="run_config" signature="property run_config">
    Getter of run\_config.
  </Function>

  ### set\_config

  <Function id="qiskit.aqua.QuantumInstance.set_config" name="set_config" signature="set_config(**kwargs)">
    Set configurations for the quantum instance.
  </Function>

  ### skip\_qobj\_validation

  <Function id="qiskit.aqua.QuantumInstance.skip_qobj_validation" name="skip_qobj_validation" signature="property skip_qobj_validation">
    checks if skip qobj validation
  </Function>

  ### time\_taken

  <Function id="qiskit.aqua.QuantumInstance.time_taken" name="time_taken" signature="property time_taken">
  ...
  <Function id="qiskit.aqua.QuantumInstance.transpile" name="transpile" signature="transpile(circuits)">
