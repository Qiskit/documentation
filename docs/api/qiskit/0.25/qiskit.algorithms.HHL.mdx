...
<Class id="qiskit.algorithms.HHL" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.17/qiskit/algorithms/linear_solvers/hhl.py" signature="HHL(epsilon=0.01, expectation=None, quantum_instance=None)">
  ...
  *   **quantum\_instance** (`Union`\[`Backend`, `BaseBackend`, `QuantumInstance`, `None`]) – Quantum Instance or Backend. If None, a Statevector calculation is done.
  ...
  <Function id="qiskit.algorithms.HHL.__init__" name="__init__" signature="__init__(epsilon=0.01, expectation=None, quantum_instance=None)">
    **Parameters**
  ...
  <Function id="qiskit.algorithms.HHL.construct_circuit" name="construct_circuit" signature="construct_circuit(matrix, vector)">
  ...
  <Function id="qiskit.algorithms.HHL.expectation" name="expectation" signature="property expectation">
  ...
  <Function id="qiskit.algorithms.HHL.quantum_instance" name="quantum_instance" signature="property quantum_instance">
  ...
  <Function id="qiskit.algorithms.HHL.scaling" name="scaling" signature="property scaling">
  ...
  <Function id="qiskit.algorithms.HHL.solve" name="solve" signature="solve(matrix, vector, observable=None, observable_circuit=None, post_processing=None)">
