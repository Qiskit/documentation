---
title: RGate (v0.25)
description: API reference for qiskit.circuit.library.RGate in qiskit v0.25
...
<Class id="qiskit.circuit.library.RGate" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.17/qiskit/circuit/library/standard_gates/r.py" signature="RGate(theta, phi)" modifiers="class">
