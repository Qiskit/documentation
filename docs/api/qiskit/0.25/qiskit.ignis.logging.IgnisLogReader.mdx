...
<Class id="qiskit.ignis.logging.IgnisLogReader" github="https://github.com/qiskit-community/qiskit-ignis/tree/stable/0.6/qiskit/ignis/logging/ignis_logging.py" signature="IgnisLogReader">
