---
title: RemoveResetInZeroState (v0.25)
description: API reference for qiskit.transpiler.passes.RemoveResetInZeroState in qiskit v0.25
...
<Class id="qiskit.transpiler.passes.RemoveResetInZeroState" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.17/qiskit/transpiler/passes/optimization/remove_reset_in_zero_state.py" signature="RemoveResetInZeroState(*args, **kwargs)" modifiers="class">
