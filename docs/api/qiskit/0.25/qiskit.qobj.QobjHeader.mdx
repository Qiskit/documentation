...
<Class id="qiskit.qobj.QobjHeader" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.17/qiskit/qobj/common.py" signature="QobjHeader(**kwargs)">
  ...
  **kwargs** – arbitrary keyword arguments that can be accessed as attributes of the object.
  ...
  <Function id="qiskit.qobj.QobjHeader.__init__" name="__init__" signature="__init__(**kwargs)">
    Instantiate a new Qobj dict field object.
  ...
  <Function id="qiskit.qobj.QobjHeader.from_dict" name="from_dict" signature="classmethod from_dict(data)">
  ...
  <Function id="qiskit.qobj.QobjHeader.to_dict" name="to_dict" signature="to_dict()">
