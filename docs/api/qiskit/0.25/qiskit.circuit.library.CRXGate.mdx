...
<Class id="qiskit.circuit.library.CRXGate" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.17/qiskit/circuit/library/standard_gates/rx.py" signature="CRXGate(theta, label=None, ctrl_state=None)" modifiers="class">
  Controlled-RX gate.
...
$$
  ...
  <Function id="qiskit.circuit.library.CRXGate.__init__" signature="__init__(theta, label=None, ctrl_state=None)">
    Create new CRX gate.
  </Function>
  ...
  <Function id="qiskit.circuit.library.CRXGate.add_decomposition" signature="add_decomposition(decomposition)">
    Add a decomposition of the instruction to the SessionEquivalenceLibrary.
  </Function>

  ### assemble

  <Function id="qiskit.circuit.library.CRXGate.assemble" signature="assemble()">
  ...
  <Function id="qiskit.circuit.library.CRXGate.broadcast_arguments" signature="broadcast_arguments(qargs, cargs)">
  ...
  <Function id="qiskit.circuit.library.CRXGate.c_if" signature="c_if(classical, val)">
    Add classical condition on register classical and value val.
  </Function>

  ### control

  <Function id="qiskit.circuit.library.CRXGate.control" signature="control(num_ctrl_qubits=1, label=None, ctrl_state=None)">
  ...
  <Function id="qiskit.circuit.library.CRXGate.copy" signature="copy(name=None)">
  ...
  <Function id="qiskit.circuit.library.CRXGate.ctrl_state" signature="ctrl_state" modifiers="property">
  ...
  <Function id="qiskit.circuit.library.CRXGate.decompositions" signature="decompositions" modifiers="property">
    Get the decompositions of the instruction from the SessionEquivalenceLibrary.
  </Function>

  ### definition

  <Function id="qiskit.circuit.library.CRXGate.definition" signature="definition" modifiers="property">
  ...
  <Function id="qiskit.circuit.library.CRXGate.duration" signature="duration" modifiers="property">
    Get the duration.
  </Function>

  ### inverse

  <Function id="qiskit.circuit.library.CRXGate.inverse" signature="inverse()">
    Return inverse CRX gate (i.e. with the negative rotation angle).
  </Function>

  ### is\_parameterized

  <Function id="qiskit.circuit.library.CRXGate.is_parameterized" signature="is_parameterized()">
    Return True .IFF. instruction is parameterized else False
  </Function>

  ### label

  <Function id="qiskit.circuit.library.CRXGate.label" signature="label" modifiers="property">
    Return gate label
  ...
  <Function id="qiskit.circuit.library.CRXGate.mirror" signature="mirror()">
  ...
  <Function id="qiskit.circuit.library.CRXGate.name" signature="name" modifiers="property">
  ...
  <Function id="qiskit.circuit.library.CRXGate.num_ctrl_qubits" signature="num_ctrl_qubits" modifiers="property">
  ...
  <Function id="qiskit.circuit.library.CRXGate.params" signature="params" modifiers="property">
  ...
  <Function id="qiskit.circuit.library.CRXGate.power" signature="power(exponent)">
  ...
  <Function id="qiskit.circuit.library.CRXGate.qasm" signature="qasm()">
  ...
  <Function id="qiskit.circuit.library.CRXGate.repeat" signature="repeat(n)">
  ...
  <Function id="qiskit.circuit.library.CRXGate.reverse_ops" signature="reverse_ops()">
  ...
  <Function id="qiskit.circuit.library.CRXGate.soft_compare" signature="soft_compare(other)">
  ...
  <Function id="qiskit.circuit.library.CRXGate.to_matrix" signature="to_matrix()">
  ...
  <Function id="qiskit.circuit.library.CRXGate.unit" signature="unit" modifiers="property">
    Get the time unit of duration.
  </Function>

  ### validate\_parameter

  <Function id="qiskit.circuit.library.CRXGate.validate_parameter" signature="validate_parameter(parameter)">
