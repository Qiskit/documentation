...
<Class id="qiskit.aqua.components.uncertainty_models.UniformDistribution" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/aqua/components/uncertainty_models/uniform_distribution.py" signature="UniformDistribution(num_target_qubits, low=0, high=1)" modifiers="class">
  ...
  *   **high** (`float`) – Upper bound, i.e., the value corresponding to |1…1> (assuming an equidistant grid)
  ...
  <Function id="qiskit.aqua.components.uncertainty_models.UniformDistribution.high" signature="high" modifiers="property">
    returns high
  </Function>

  ### low

  <Function id="qiskit.aqua.components.uncertainty_models.UniformDistribution.low" signature="low" modifiers="property">
    returns low
  </Function>

  ### num\_target\_qubits

  <Function id="qiskit.aqua.components.uncertainty_models.UniformDistribution.num_target_qubits" signature="num_target_qubits" modifiers="property">
    Returns the number of target qubits
  </Function>

  ### num\_values

  <Function id="qiskit.aqua.components.uncertainty_models.UniformDistribution.num_values" signature="num_values" modifiers="property">
  ...
  <Function id="qiskit.aqua.components.uncertainty_models.UniformDistribution.probabilities" signature="probabilities" modifiers="property">
  ...
  <Function id="qiskit.aqua.components.uncertainty_models.UniformDistribution.values" signature="values" modifiers="property">
    returns values
  </Function>
</Class>
