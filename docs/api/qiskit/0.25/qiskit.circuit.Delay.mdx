...
<Class id="qiskit.circuit.Delay" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.17/qiskit/circuit/delay.py" signature="Delay(duration, unit='dt')">
  ...
  <Function id="qiskit.circuit.Delay.__init__" name="__init__" signature="__init__(duration, unit='dt')">
    Create new delay instruction.
  </Function>
  ...
  <Function id="qiskit.circuit.Delay.decompositions" name="decompositions" signature="property decompositions">
    Get the decompositions of the instruction from the SessionEquivalenceLibrary.
  </Function>

  ### definition

  <Function id="qiskit.circuit.Delay.definition" name="definition" signature="property definition">
    Return definition in terms of other basic gates.
  </Function>

  ### duration

  <Function id="qiskit.circuit.Delay.duration" name="duration" signature="property duration">
  ...
  <Function id="qiskit.circuit.Delay.mirror" name="mirror" signature="mirror()">
  ...
  <Function id="qiskit.circuit.Delay.params" name="params" signature="property params">
  ...
  <Function id="qiskit.circuit.Delay.unit" name="unit" signature="property unit">
