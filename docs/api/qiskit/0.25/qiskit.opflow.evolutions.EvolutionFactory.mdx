...
<Class id="qiskit.opflow.evolutions.EvolutionFactory" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.17/qiskit/opflow/evolutions/evolution_factory.py" signature="EvolutionFactory">
  A factory class for convenient automatic selection of an Evolution algorithm based on the Operator to be converted.

  ### \_\_init\_\_

  <Function id="qiskit.opflow.evolutions.EvolutionFactory.__init__" name="__init__" signature="__init__()">
  ...
  <Function id="qiskit.opflow.evolutions.EvolutionFactory.build" name="build" signature="static build(operator=None)">
