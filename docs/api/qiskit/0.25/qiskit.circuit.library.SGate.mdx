---
title: SGate (v0.25)
description: API reference for qiskit.circuit.library.SGate in qiskit v0.25
...
<Class id="qiskit.circuit.library.SGate" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.17/qiskit/circuit/library/standard_gates/s.py" signature="SGate(label=None)" modifiers="class">
...
$$
  ...
  **Circuit symbol:**
  ...
  <Function id="qiskit.circuit.library.SGate.soft_compare" signature="soft_compare(other)">
