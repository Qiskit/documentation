...
`ZFeatureMap(feature_dimension, reps=2, data_map_func=None, insert_barriers=False)` [GitHub](https://github.com/qiskit/qiskit/tree/stable/0.17/qiskit/circuit/library/data_preparation/z_feature_map.py "view source code")
...
`__init__(feature_dimension, reps=2, data_map_func=None, insert_barriers=False)`
...
| [`compose`](#qiskit.circuit.library.ZFeatureMap.compose "qiskit.circuit.library.ZFeatureMap.compose")(other\[, qubits, clbits, front, inplace])                                                 | Compose circuit with `other` circuit or instruction, optionally permuting wires.                                                    |
...
| [`pauli`](#qiskit.circuit.library.ZFeatureMap.pauli "qiskit.circuit.library.ZFeatureMap.pauli")(pauli\_string, qubits)                                                                          | Apply `PauliGate`.                                                                                                                  |
...
| [`qasm`](#qiskit.circuit.library.ZFeatureMap.qasm "qiskit.circuit.library.ZFeatureMap.qasm")(\[formatted, filename])                                                                            | Return OpenQASM string.                                                                                                             |
...
| [`to_instruction`](#qiskit.circuit.library.ZFeatureMap.to_instruction "qiskit.circuit.library.ZFeatureMap.to_instruction")(\[parameter\_map])                                                   | Create an Instruction out of this circuit.                                                                                          |
...
![../\_images/qiskit.circuit.library.ZFeatureMap\_0\_0.png](/images/api/qiskit/0.25/qiskit.circuit.library.ZFeatureMap_0_0.png)
