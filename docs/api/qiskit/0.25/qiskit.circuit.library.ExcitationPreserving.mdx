---
title: ExcitationPreserving (v0.25)
description: API reference for qiskit.circuit.library.ExcitationPreserving in qiskit v0.25
  ...
  **ValueError** – If the selected mode is not supported.
  ...
  <Function id="qiskit.circuit.library.ExcitationPreserving.draw" signature="draw(output=None, scale=None, filename=None, style=None, interactive=False, plot_barriers=True, reverse_bits=False, justify=None, vertical_compression='medium', idle_wires=True, with_layout=True, fold=None, ax=None, initial_state=False, cregbundle=True)">
    ...
    **Example**
    ...
    ![../\_images/qiskit.circuit.library.ExcitationPreserving\_0\_0.png](/docs/images/api/qiskit/0.25/qiskit.circuit.library.ExcitationPreserving_0_0.avif)
  </Function>
