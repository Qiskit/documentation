---
title: save_state (v0.25)
description: API reference for qiskit.providers.aer.library.save_state in qiskit v0.25
in_page_toc_min_heading_level: 1
python_api_type: function
python_api_name: qiskit.providers.aer.library.save_state
---

<span id="qiskit-providers-aer-library-save-state" />
