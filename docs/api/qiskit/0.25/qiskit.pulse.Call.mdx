...
<Class id="qiskit.pulse.Call" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.17/qiskit/pulse/instructions/call.py" signature="Call(subroutine, value_dict=None, name=None)">
  ...
  **Raises**
  ...
  <Function id="qiskit.pulse.Call.__init__" name="__init__" signature="__init__(subroutine, value_dict=None, name=None)">
    Define new subroutine.
  ...
  <Function id="qiskit.pulse.Call.append" name="append" signature="append(schedule, name=None)">
  ...
  <Function id="qiskit.pulse.Call.arguments" name="arguments" signature="property arguments">
  ...
  <Function id="qiskit.pulse.Call.assign_parameters" name="assign_parameters" signature="assign_parameters(value_dict)">
  ...
  <Function id="qiskit.pulse.Call.assigned_subroutine" name="assigned_subroutine" signature="assigned_subroutine()">
  ...
  <Function id="qiskit.pulse.Call.ch_duration" name="ch_duration" signature="ch_duration(*channels)">
  ...
  <Function id="qiskit.pulse.Call.ch_start_time" name="ch_start_time" signature="ch_start_time(*channels)">
  ...
  <Function id="qiskit.pulse.Call.ch_stop_time" name="ch_stop_time" signature="ch_stop_time(*channels)">
  ...
  <Function id="qiskit.pulse.Call.channels" name="channels" signature="property channels">
  ...
  <Function id="qiskit.pulse.Call.draw" name="draw" signature="draw(dt=1, style=None, filename=None, interp_method=None, scale=1, plot_all=False, plot_range=None, interactive=False, table=True, label=False, framechange=True, channels=None)">
  ...
  <Function id="qiskit.pulse.Call.duration" name="duration" signature="property duration">
  ...
  <Function id="qiskit.pulse.Call.flatten" name="flatten" signature="flatten()">
  ...
  <Function id="qiskit.pulse.Call.id" name="id" signature="property id">
  ...
  <Function id="qiskit.pulse.Call.insert" name="insert" signature="insert(start_time, schedule, name=None)">
  ...
  <Function id="qiskit.pulse.Call.instructions" name="instructions" signature="property instructions">
  ...
  <Function id="qiskit.pulse.Call.is_parameterized" name="is_parameterized" signature="is_parameterized()">
  ...
  <Function id="qiskit.pulse.Call.name" name="name" signature="property name">
  ...
  <Function id="qiskit.pulse.Call.operands" name="operands" signature="property operands">
  ...
  <Function id="qiskit.pulse.Call.parameters" name="parameters" signature="property parameters">
  ...
  <Function id="qiskit.pulse.Call.shift" name="shift" signature="shift(time, name=None)">
  ...
  <Function id="qiskit.pulse.Call.start_time" name="start_time" signature="property start_time">
  ...
  <Function id="qiskit.pulse.Call.stop_time" name="stop_time" signature="property stop_time">
  ...
  <Function id="qiskit.pulse.Call.subroutine" name="subroutine" signature="property subroutine">
