...
<Class id="qiskit.chemistry.drivers.BosonicDriver" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/chemistry/drivers/bosonic_driver.py" signature="BosonicDriver(molecule=None, basis='sto3g', hf_method='rhf', supports_molecule=False)">
  ...
  **Raises**
  ...
  <Function id="qiskit.chemistry.drivers.BosonicDriver.__init__" signature="abstract __init__(molecule=None, basis='sto3g', hf_method='rhf', supports_molecule=False)">
    **Parameters**
  ...
  <Function id="qiskit.chemistry.drivers.BosonicDriver.basis" signature="property basis">
    return basis
  ...
  <Function id="qiskit.chemistry.drivers.BosonicDriver.hf_method" signature="property hf_method">
  ...
  <Function id="qiskit.chemistry.drivers.BosonicDriver.molecule" signature="property molecule">
    return molecule
  ...
  <Function id="qiskit.chemistry.drivers.BosonicDriver.run" signature="abstract run()">
  ...
  <Function id="qiskit.chemistry.drivers.BosonicDriver.supports_molecule" signature="property supports_molecule">
