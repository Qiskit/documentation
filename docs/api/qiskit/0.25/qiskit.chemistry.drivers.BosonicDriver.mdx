...
<Class id="qiskit.chemistry.drivers.BosonicDriver" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/chemistry/drivers/bosonic_driver.py" signature="BosonicDriver(molecule=None, basis='sto3g', hf_method='rhf', supports_molecule=False)" modifiers="class">
  ...
  **Raises**
  ...
  <Function id="qiskit.chemistry.drivers.BosonicDriver.basis" signature="basis" modifiers="property">
    return basis
  ...
  <Function id="qiskit.chemistry.drivers.BosonicDriver.hf_method" signature="hf_method" modifiers="property">
  ...
  <Function id="qiskit.chemistry.drivers.BosonicDriver.molecule" signature="molecule" modifiers="property">
    return molecule
  ...
  <Function id="qiskit.chemistry.drivers.BosonicDriver.supports_molecule" signature="supports_molecule" modifiers="property">
