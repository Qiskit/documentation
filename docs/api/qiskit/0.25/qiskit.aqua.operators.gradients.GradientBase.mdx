...
<Class id="qiskit.aqua.operators.gradients.GradientBase" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/aqua/operators/gradients/gradient_base.py" signature="GradientBase(grad_method='param_shift', **kwargs)">
  ...
  **ValueError** – If method != `fin_diff` and `epsilon` is not None.
  ...
  <Function id="qiskit.aqua.operators.gradients.GradientBase.__init__" name="__init__" signature="__init__(grad_method='param_shift', **kwargs)">
    **Parameters**
  ...
  <Function id="qiskit.aqua.operators.gradients.GradientBase.convert" name="convert" signature="abstract convert(operator, params=None)">
    **Parameters**
  ...
  <Function id="qiskit.aqua.operators.gradients.GradientBase.grad_method" name="grad_method" signature="property grad_method">
  ...
  <Function id="qiskit.aqua.operators.gradients.GradientBase.gradient_wrapper" name="gradient_wrapper" signature="gradient_wrapper(operator, bind_params, grad_params=None, backend=None)">
  ...
  <Function id="qiskit.aqua.operators.gradients.GradientBase.parameter_expression_grad" name="parameter_expression_grad" signature="static parameter_expression_grad(param_expr, param)">
