...
<Class id="qiskit.aqua.components.neural_networks.QuantumGenerator" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/aqua/components/neural_networks/quantum_generator.py" signature="QuantumGenerator(bounds, num_qubits, generator_circuit=None, init_params=None, optimizer=None, gradient_function=None, snapshot_dir=None)">
  ...
  **Raises**
  ...
  <Function id="qiskit.aqua.components.neural_networks.QuantumGenerator.discriminator" signature="property discriminator">
    Get discriminator.
  ...
  <Function id="qiskit.aqua.components.neural_networks.QuantumGenerator.optimizer" signature="property optimizer">
    Get optimizer.
  ...
  <Function id="qiskit.aqua.components.neural_networks.QuantumGenerator.parameter_values" signature="property parameter_values">
  ...
  <Function id="qiskit.aqua.components.neural_networks.QuantumGenerator.seed" signature="property seed">
    Get seed.
