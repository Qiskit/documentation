...
<Class id="qiskit.circuit.library.CSXGate" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.17/qiskit/circuit/library/standard_gates/sx.py" signature="CSXGate(label=None, ctrl_state=None)">
  Controlled-√X gate.
...
$$
  ...
  <Function id="qiskit.circuit.library.CSXGate.name" signature="property name">
