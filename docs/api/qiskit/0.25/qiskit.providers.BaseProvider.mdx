...
<Class id="qiskit.providers.BaseProvider" github="https://github.com/qiskit/qiskit/tree/stable/0.17/qiskit/providers/baseprovider.py" signature="BaseProvider(*args, **kwargs)">
  Base class for a Backend Provider.

  ### \_\_init\_\_

  <Function id="qiskit.providers.BaseProvider.__init__" name="__init__" signature="__init__(*args, **kwargs)">
  ...
  <Function id="qiskit.providers.BaseProvider.backends" name="backends" signature="abstract backends(name=None, **kwargs)">
  ...
  <Function id="qiskit.providers.BaseProvider.get_backend" name="get_backend" signature="get_backend(name=None, **kwargs)">
