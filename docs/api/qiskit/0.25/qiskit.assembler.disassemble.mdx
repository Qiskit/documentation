---
title: disassemble (v0.25)
description: API reference for qiskit.assembler.disassemble in qiskit v0.25
...
<Function id="qiskit.assembler.disassemble" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.17/qiskit/assembler/disassemble.py" signature="disassemble(qobj)">
