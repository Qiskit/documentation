...
<Class id="qiskit.providers.BackendV2" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.1/qiskit/providers/backend.py#L267-L647" signature="qiskit.providers.BackendV2(provider=None, name=None, description=None, online_date=None, backend_version=None, **fields)" modifiers="class">
  ...
  <Function id="qiskit.providers.BackendV2._default_options" github="https://github.com/Qiskit/qiskit/tree/stable/1.1/qiskit/providers/backend.py#L420-L434" signature="_default_options()" modifiers="abstract classmethod">
  ...
  **Raises**
  ...
  <Function id="qiskit.providers.BackendV2.acquire_channel" github="https://github.com/Qiskit/qiskit/tree/stable/1.1/qiskit/providers/backend.py#L548-L561" signature="acquire_channel(qubit)">
  ...
  <Function id="qiskit.providers.BackendV2.control_channel" github="https://github.com/Qiskit/qiskit/tree/stable/1.1/qiskit/providers/backend.py#L563-L583" signature="control_channel(qubits)">
  ...
  <Function id="qiskit.providers.BackendV2.drive_channel" github="https://github.com/Qiskit/qiskit/tree/stable/1.1/qiskit/providers/backend.py#L518-L531" signature="drive_channel(qubit)">
  ...
  <Function id="qiskit.providers.BackendV2.measure_channel" github="https://github.com/Qiskit/qiskit/tree/stable/1.1/qiskit/providers/backend.py#L533-L546" signature="measure_channel(qubit)">
  ...
  <Function id="qiskit.providers.BackendV2.qubit_properties" github="https://github.com/Qiskit/qiskit/tree/stable/1.1/qiskit/providers/backend.py#L484-L516" signature="qubit_properties(qubit)">
  ...
  <Function id="qiskit.providers.BackendV2.run" github="https://github.com/Qiskit/qiskit/tree/stable/1.1/qiskit/providers/backend.py#L623-L647" signature="run(run_input, **options)" modifiers="abstract">
    Run on the backend.
  ...
  <Function id="qiskit.providers.BackendV2.set_options" github="https://github.com/Qiskit/qiskit/tree/stable/1.1/qiskit/providers/backend.py#L585-L602" signature="set_options(**fields)">
