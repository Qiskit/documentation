...
<Class id="qiskit.transpiler.passes.UnitarySynthesis" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/2.1/qiskit/transpiler/passes/synthesis/unitary_synthesis.py#L54-L349" signature="qiskit.transpiler.passes.UnitarySynthesis(*args, **kwargs)" modifiers="class">
  ...
  **Raises**
  ...
  <Function id="qiskit.transpiler.passes.UnitarySynthesis.execute" github="https://github.com/Qiskit/qiskit/tree/stable/2.1/qiskit/transpiler/basepasses.py#L161-L180" signature="execute(passmanager_ir, state, callback=None)">
  ...
  <Function id="qiskit.transpiler.passes.UnitarySynthesis.name" github="https://github.com/Qiskit/qiskit/tree/stable/2.1/qiskit/passmanager/base_tasks.py#L68-L70" signature="name()">
    Name of the pass.
  ...
  <Function id="qiskit.transpiler.passes.UnitarySynthesis.run" github="https://github.com/Qiskit/qiskit/tree/stable/2.1/qiskit/transpiler/passes/synthesis/unitary_synthesis.py#L159-L266" signature="run(dag)">
  ...
  <Function id="qiskit.transpiler.passes.UnitarySynthesis.update_status" github="https://github.com/Qiskit/qiskit/tree/stable/2.1/qiskit/transpiler/basepasses.py#L182-L190" signature="update_status(state, run_state)">
