---
title: InstructionProperties (latest version)
description: API reference for qiskit.transpiler.InstructionProperties in the latest version of qiskit
...
<Class id="qiskit.transpiler.InstructionProperties" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/2.4/qiskit/transpiler/target.py#L52-L87" signature="qiskit.transpiler.InstructionProperties(duration=None, error=None, *args, **kwargs)" modifiers="class">
