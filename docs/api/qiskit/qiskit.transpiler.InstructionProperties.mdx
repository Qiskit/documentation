...
<Class id="qiskit.transpiler.InstructionProperties" github="https://github.com/Qiskit/qiskit/tree/stable/1.0/qiskit/transpiler/target.py#L58-L136" signature="qiskit.transpiler.InstructionProperties(duration=None, error=None, calibration=None)">
