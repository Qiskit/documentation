...
<Class id="qiskit.primitives.PubResult" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.0/qiskit/primitives/containers/pub_result.py#L24-L51" signature="qiskit.primitives.PubResult(data, metadata=None)">
