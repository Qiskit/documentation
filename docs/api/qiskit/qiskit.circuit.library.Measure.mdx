...
<Class id="qiskit.circuit.library.Measure" github="https://github.com/qiskit/qiskit/tree/stable/1.0/qiskit/circuit/measure.py" signature="qiskit.circuit.library.Measure(*args, _force_mutable=False, **kwargs)">
  ...
  <Function id="qiskit.circuit.library.Measure.inverse" name="inverse" signature="inverse(annotated=False)">
  ...
  <Function id="qiskit.circuit.library.Measure.to_mutable" name="to_mutable" signature="to_mutable()">
