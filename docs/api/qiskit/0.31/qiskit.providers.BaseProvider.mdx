...
<Class id="qiskit.providers.BaseProvider" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/providers/baseprovider.py" signature="BaseProvider(*args, **kwargs)">
  Bases: `abc.ABC`
  ...
  <Function id="qiskit.providers.BaseProvider.backends" name="backends" signature="abstract BaseProvider.backends(name=None, **kwargs)">
  ...
  <Function id="qiskit.providers.BaseProvider.get_backend" name="get_backend" signature="BaseProvider.get_backend(name=None, **kwargs)">
