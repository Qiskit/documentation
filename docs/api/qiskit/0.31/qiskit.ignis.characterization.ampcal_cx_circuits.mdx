---
title: ampcal_cx_circuits (v0.31)
description: API reference for qiskit.ignis.characterization.ampcal_cx_circuits in qiskit v0.31
...
<Function id="qiskit.ignis.characterization.ampcal_cx_circuits" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-ignis/tree/stable/0.6/qiskit/ignis/characterization/gates/circuits.py" signature="ampcal_cx_circuits(max_reps, qubits, control_qubits)">
