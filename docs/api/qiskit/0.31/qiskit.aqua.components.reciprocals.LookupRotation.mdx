...
<Class id="qiskit.aqua.components.reciprocals.LookupRotation" github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/aqua/components/reciprocals/lookup_rotation.py" signature="LookupRotation(pat_length=None, subpat_length=None, scale=0, negative_evals=False, evo_time=None, lambda_min=None)">
  ...
  *   **lambda\_min** (`Optional`\[`float`]) – The smallest expected eigenvalue
  ...
  <Function id="qiskit.aqua.components.reciprocals.LookupRotation.construct_circuit" name="construct_circuit" signature="LookupRotation.construct_circuit(mode, inreg)">
  ...
  <Function id="qiskit.aqua.components.reciprocals.LookupRotation.sv_to_resvec" name="sv_to_resvec" signature="LookupRotation.sv_to_resvec(statevector, num_q)">
