---
title: average_gate_fidelity (v0.31)
description: API reference for qiskit.quantum_info.average_gate_fidelity in qiskit v0.31
...
<Function id="qiskit.quantum_info.average_gate_fidelity" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/quantum_info/operators/measures.py" signature="average_gate_fidelity(channel, target=None, require_cp=True, require_tp=False)">
