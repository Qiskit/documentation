...
<Function id="qiskit.pulse.builder.seconds_to_samples" github="https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/pulse/builder.py" signature="seconds_to_samples(seconds)">
