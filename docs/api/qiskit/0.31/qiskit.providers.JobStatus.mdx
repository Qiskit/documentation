---
title: JobStatus (v0.31)
description: API reference for qiskit.providers.JobStatus in qiskit v0.31
...
<Class id="qiskit.providers.JobStatus" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/providers/jobstatus.py" signature="JobStatus(value)" modifiers="class">
  Bases: `enum.Enum`
