...
<Class id="qiskit.providers.JobV1" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/providers/job.py" signature="JobV1(backend, job_id, **kwargs)">
  ...
  *   **kwargs** – Any key value metadata to associate with this job.
  ...
  <Function id="qiskit.providers.JobV1.result" signature="abstract JobV1.result()">
  ...
  <Function id="qiskit.providers.JobV1.status" signature="abstract JobV1.status()">
    Return the status of the job, among the values of `JobStatus`.
  </Function>

  ### submit

  <Function id="qiskit.providers.JobV1.submit" signature="abstract JobV1.submit()">
