...
<Class id="qiskit.providers.ibmq.managed.ManagedResults" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-ibmq-provider/tree/stable/0.17/qiskit/providers/ibmq/managed/managedresults.py" signature="ManagedResults(job_set, backend_name, success)">
  Bases: `object`
  ...
  *   **success** (`bool`) – `True` if all experiments were successful and results available. `False` otherwise.
  ...
  <Function id="qiskit.providers.ibmq.managed.ManagedResults.combine_results" name="combine_results" signature="ManagedResults.combine_results()">
  ...
  <Function id="qiskit.providers.ibmq.managed.ManagedResults.data" name="data" signature="ManagedResults.data(experiment)">
  ...
  <Function id="qiskit.providers.ibmq.managed.ManagedResults.get_counts" name="get_counts" signature="ManagedResults.get_counts(experiment)">
  ...
  <Function id="qiskit.providers.ibmq.managed.ManagedResults.get_memory" name="get_memory" signature="ManagedResults.get_memory(experiment)">
  ...
  <Function id="qiskit.providers.ibmq.managed.ManagedResults.get_statevector" name="get_statevector" signature="ManagedResults.get_statevector(experiment, decimals=None)">
  ...
  <Function id="qiskit.providers.ibmq.managed.ManagedResults.get_unitary" name="get_unitary" signature="ManagedResults.get_unitary(experiment, decimals=None)">
