...
<Class id="qiskit.chemistry.algorithms.pes_samplers.PolynomialExtrapolator" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/chemistry/algorithms/pes_samplers/extrapolator.py" signature="PolynomialExtrapolator(degree=1)">
  ...
  **degree** (`int`) – Degree of polynomial to use for fitting in extrapolation.
  ...
  <Function id="qiskit.chemistry.algorithms.pes_samplers.PolynomialExtrapolator.extrapolate" name="extrapolate" signature="PolynomialExtrapolator.extrapolate(points, param_dict)">
  ...
  <Function id="qiskit.chemistry.algorithms.pes_samplers.PolynomialExtrapolator.factory" name="factory" signature="static PolynomialExtrapolator.factory(mode, **kwargs)">
