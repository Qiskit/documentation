---
title: Drag (v0.31)
description: API reference for qiskit.pulse.Drag in qiskit v0.31
...
<Class id="qiskit.pulse.Drag" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/pulse/library/parametric_pulses.py" signature="Drag(duration, amp, sigma, beta, name=None)" modifiers="class">
...
$$
  ...
  *   **name** (`Optional`\[`str`]) – Display name for this pulse envelope.
  ...
  <Function id="qiskit.pulse.Drag.assign" signature="Drag.assign(parameter, value)">
  ...
  <span id="qiskit-pulse-drag-assign-parameters" />

  ### assign\_parameters

  <Function id="qiskit.pulse.Drag.assign_parameters" signature="Drag.assign_parameters(value_dict)">
  ...
  <Function id="qiskit.pulse.Drag.draw" signature="Drag.draw(dt=None, style=None, filename=None, interp_method=None, scale=None, interactive=None, draw_title=None, backend=None, time_range=None, time_unit='dt', show_waveform_info=True, plotter='mpl2d', axis=None)">
  ...
  <span id="qiskit-pulse-drag-get-waveform" />

  ### get\_waveform

  <Function id="qiskit.pulse.Drag.get_waveform" signature="Drag.get_waveform()">
  ...
  <span id="qiskit-pulse-drag-is-parameterized" />

  ### is\_parameterized

  <Function id="qiskit.pulse.Drag.is_parameterized" signature="Drag.is_parameterized()">
  ...
  <span id="qiskit-pulse-drag-validate-parameters" />

  ### validate\_parameters

  <Function id="qiskit.pulse.Drag.validate_parameters" signature="Drag.validate_parameters()">
    Validate parameters.
  ...
  <Attribute id="qiskit.pulse.Drag.limit_amplitude" attributeValue="True" />
