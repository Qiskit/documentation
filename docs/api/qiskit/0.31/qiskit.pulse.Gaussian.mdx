...
<Class id="qiskit.pulse.Gaussian" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/pulse/library/parametric_pulses.py" signature="Gaussian(duration, amp, sigma, name=None)">
...
$$
  ...
  *   **name** (`Optional`\[`str`]) – Display name for this pulse envelope.
  ...
  <Function id="qiskit.pulse.Gaussian.assign" name="assign" signature="Gaussian.assign(parameter, value)">
  ...
  <Function id="qiskit.pulse.Gaussian.assign_parameters" name="assign_parameters" signature="Gaussian.assign_parameters(value_dict)">
  ...
  <Function id="qiskit.pulse.Gaussian.draw" name="draw" signature="Gaussian.draw(dt=None, style=None, filename=None, interp_method=None, scale=None, interactive=None, draw_title=None, backend=None, time_range=None, time_unit='dt', show_waveform_info=True, plotter='mpl2d', axis=None)">
  ...
  <Function id="qiskit.pulse.Gaussian.get_waveform" name="get_waveform" signature="Gaussian.get_waveform()">
  ...
  <Function id="qiskit.pulse.Gaussian.is_parameterized" name="is_parameterized" signature="Gaussian.is_parameterized()">
  ...
  <Function id="qiskit.pulse.Gaussian.validate_parameters" name="validate_parameters" signature="Gaussian.validate_parameters()">
    Validate parameters.
  ...
  <Attribute id="qiskit.pulse.Gaussian.amp" name="amp">
  ...
  <Attribute id="qiskit.pulse.Gaussian.id" name="id">
  ...
  <Attribute id="qiskit.pulse.Gaussian.limit_amplitude" name="limit_amplitude" attributeValue="= True" />

  ### parameters

  <Attribute id="qiskit.pulse.Gaussian.parameters" name="parameters">
    **Return type**
  ...
  <Attribute id="qiskit.pulse.Gaussian.sigma" name="sigma">
