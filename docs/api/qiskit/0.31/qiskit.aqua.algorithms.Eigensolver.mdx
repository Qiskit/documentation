...
<Class id="qiskit.aqua.algorithms.Eigensolver" github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/aqua/algorithms/eigen_solvers/eigen_solver.py" signature="Eigensolver">
  ...
  <Function id="qiskit.aqua.algorithms.Eigensolver.compute_eigenvalues" signature="abstract Eigensolver.compute_eigenvalues(operator=None, aux_operators=None)">
  ...
  <Function id="qiskit.aqua.algorithms.Eigensolver.supports_aux_operators" signature="classmethod Eigensolver.supports_aux_operators()">
