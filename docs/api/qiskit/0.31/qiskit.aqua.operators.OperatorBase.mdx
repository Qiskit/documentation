---
title: OperatorBase (v0.31)
description: API reference for qiskit.aqua.operators.OperatorBase in qiskit v0.31
...
<Class id="qiskit.aqua.operators.OperatorBase" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/aqua/operators/operator_base.py" signature="OperatorBase" modifiers="class">
  ...
  <span id="qiskit-aqua-operators-operatorbase-assign-parameters" />
  ...
  <span id="qiskit-aqua-operators-operatorbase-bind-parameters" />
  ...
  <Function id="qiskit.aqua.operators.OperatorBase.compose" signature="OperatorBase.compose(other, permutation=None, front=False)" modifiers="abstract">
  ...
  <Function id="qiskit.aqua.operators.OperatorBase.permute" signature="OperatorBase.permute(permutation)" modifiers="abstract">
  ...
  <span id="qiskit-aqua-operators-operatorbase-primitive-strings" />
  ...
  <span id="qiskit-aqua-operators-operatorbase-to-legacy-op" />
  ...
  <span id="qiskit-aqua-operators-operatorbase-to-matrix" />
