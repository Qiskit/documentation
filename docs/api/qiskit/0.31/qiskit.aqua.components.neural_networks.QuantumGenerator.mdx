...
<Class id="qiskit.aqua.components.neural_networks.QuantumGenerator" github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/aqua/components/neural_networks/quantum_generator.py" signature="QuantumGenerator(bounds, num_qubits, generator_circuit=None, init_params=None, optimizer=None, gradient_function=None, snapshot_dir=None)">
  ...
  **Raises**
  ...
  <Function id="qiskit.aqua.components.neural_networks.QuantumGenerator.construct_circuit" name="construct_circuit" signature="QuantumGenerator.construct_circuit(params=None)">
  ...
  <Function id="qiskit.aqua.components.neural_networks.QuantumGenerator.get_output" name="get_output" signature="QuantumGenerator.get_output(quantum_instance, params=None, shots=None)">
  ...
  <Function id="qiskit.aqua.components.neural_networks.QuantumGenerator.loss" name="loss" signature="QuantumGenerator.loss(x, weights)">
  ...
  <Function id="qiskit.aqua.components.neural_networks.QuantumGenerator.set_discriminator" name="set_discriminator" signature="QuantumGenerator.set_discriminator(discriminator)">
  ...
  <Function id="qiskit.aqua.components.neural_networks.QuantumGenerator.set_seed" name="set_seed" signature="QuantumGenerator.set_seed(seed)">
    Set seed.
  ...
  <Function id="qiskit.aqua.components.neural_networks.QuantumGenerator.train" name="train" signature="QuantumGenerator.train(quantum_instance=None, shots=None)">
  ...
  <Attribute id="qiskit.aqua.components.neural_networks.QuantumGenerator.discriminator" name="discriminator">
    Get discriminator.
  ...
  <Attribute id="qiskit.aqua.components.neural_networks.QuantumGenerator.optimizer" name="optimizer">
    Get optimizer.
  ...
  <Attribute id="qiskit.aqua.components.neural_networks.QuantumGenerator.parameter_values" name="parameter_values">
  ...
  <Attribute id="qiskit.aqua.components.neural_networks.QuantumGenerator.seed" name="seed">
    Get seed.
