...
<Function id="qiskit.aqua.utils.get_feature_dimension" name="get_feature_dimension" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/aqua/utils/dataset_helper.py" signature="get_feature_dimension(dataset)">
