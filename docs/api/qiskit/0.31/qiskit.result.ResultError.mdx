---
title: ResultError (v0.31)
description: API reference for qiskit.result.ResultError in qiskit v0.31
...
<Class id="qiskit.result.ResultError" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/result/exceptions.py" signature="ResultError(error)" modifiers="exception">
