...
<Class id="qiskit.providers.ibmq.experiment.IBMExperimentEntryNotFound" github="https://github.com/qiskit/qiskit-ibmq-provider/tree/stable/0.17/qiskit/providers/ibmq/experiment/exceptions.py" signature="IBMExperimentEntryNotFound(*message)">
