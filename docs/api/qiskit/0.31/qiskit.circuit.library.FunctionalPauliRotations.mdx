---
title: FunctionalPauliRotations (v0.31)
description: API reference for qiskit.circuit.library.FunctionalPauliRotations in qiskit v0.31
...
<Class id="qiskit.circuit.library.FunctionalPauliRotations" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/circuit/library/arithmetic/functional_pauli_rotations.py" signature="FunctionalPauliRotations(num_state_qubits=None, basis='Y', name='F')" modifiers="class">
  ...
  *   **name** (`str`) – The name of the circuit object.
  ...
  <Attribute id="qiskit.circuit.library.FunctionalPauliRotations.instances" attributeValue="16" />
