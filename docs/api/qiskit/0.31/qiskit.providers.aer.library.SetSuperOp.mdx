---
title: SetSuperOp (v0.31)
description: API reference for qiskit.providers.aer.library.SetSuperOp in qiskit v0.31
...
<Class id="qiskit.providers.aer.library.SetSuperOp" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-aer/tree/stable/0.9/qiskit/providers/aer/library/set_instructions/set_superop.py" signature="SetSuperOp(state)" modifiers="class">
