...
<Class id="qiskit.chemistry.components.variational_forms.CHC" github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/chemistry/components/variational_forms/chc.py" signature="CHC(num_qubits=None, reps=1, ladder=False, excitations=None, entanglement='full', initial_state=None)">
  ...
  *   **initial\_state** (`Union`\[`QuantumCircuit`, `InitialState`, `None`]) – an initial state to prepend to the variational form
  ...
  <Function id="qiskit.chemistry.components.variational_forms.CHC.construct_circuit" name="construct_circuit" signature="CHC.construct_circuit(parameters, q=None)">
  ...
  <Function id="qiskit.chemistry.components.variational_forms.CHC.get_entangler_map" name="get_entangler_map" signature="static CHC.get_entangler_map(map_type, num_qubits, offset=0)">
    returns entangler map
  </Function>

  ### validate\_entangler\_map

  <Function id="qiskit.chemistry.components.variational_forms.CHC.validate_entangler_map" name="validate_entangler_map" signature="static CHC.validate_entangler_map(entangler_map, num_qubits)">
  ...
  <Attribute id="qiskit.chemistry.components.variational_forms.CHC.num_parameters" name="num_parameters">
  ...
  <Attribute id="qiskit.chemistry.components.variational_forms.CHC.num_qubits" name="num_qubits">
  ...
  <Attribute id="qiskit.chemistry.components.variational_forms.CHC.parameter_bounds" name="parameter_bounds">
    Parameter bounds.
  ...
  <Attribute id="qiskit.chemistry.components.variational_forms.CHC.preferred_init_points" name="preferred_init_points">
  ...
  <Attribute id="qiskit.chemistry.components.variational_forms.CHC.setting" name="setting" />

  ### support\_parameterized\_circuit

  <Attribute id="qiskit.chemistry.components.variational_forms.CHC.support_parameterized_circuit" name="support_parameterized_circuit">
