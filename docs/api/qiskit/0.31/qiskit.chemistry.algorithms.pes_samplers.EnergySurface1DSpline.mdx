...
<Class id="qiskit.chemistry.algorithms.pes_samplers.EnergySurface1DSpline" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/chemistry/algorithms/pes_samplers/potentials/energy_surface_spline.py" signature="EnergySurface1DSpline">
  ...
  <Function id="qiskit.chemistry.algorithms.pes_samplers.EnergySurface1DSpline.eval" name="eval" signature="EnergySurface1DSpline.eval(x)">
  ...
  <Function id="qiskit.chemistry.algorithms.pes_samplers.EnergySurface1DSpline.fit" name="fit" signature="EnergySurface1DSpline.fit(xdata, ydata, initial_vals=None, bounds_list=None)">
  ...
  <Function id="qiskit.chemistry.algorithms.pes_samplers.EnergySurface1DSpline.get_equilibrium_geometry" name="get_equilibrium_geometry" signature="EnergySurface1DSpline.get_equilibrium_geometry(scaling=1.0)">
  ...
  <Function id="qiskit.chemistry.algorithms.pes_samplers.EnergySurface1DSpline.get_minimal_energy" name="get_minimal_energy" signature="EnergySurface1DSpline.get_minimal_energy(scaling=1.0)">
  ...
  <Function id="qiskit.chemistry.algorithms.pes_samplers.EnergySurface1DSpline.get_trust_region" name="get_trust_region" signature="EnergySurface1DSpline.get_trust_region()">
