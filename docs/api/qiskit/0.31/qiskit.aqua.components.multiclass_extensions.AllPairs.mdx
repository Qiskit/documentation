...
<Class id="qiskit.aqua.components.multiclass_extensions.AllPairs" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/aqua/components/multiclass_extensions/all_pairs.py" signature="AllPairs">
  ...
  <Function id="qiskit.aqua.components.multiclass_extensions.AllPairs.predict" name="predict" signature="AllPairs.predict(x)">
  ...
  <Function id="qiskit.aqua.components.multiclass_extensions.AllPairs.set_estimator" name="set_estimator" signature="AllPairs.set_estimator(estimator_cls, params=None)">
  ...
  <Function id="qiskit.aqua.components.multiclass_extensions.AllPairs.test" name="test" signature="AllPairs.test(x, y)">
  ...
  <Function id="qiskit.aqua.components.multiclass_extensions.AllPairs.train" name="train" signature="AllPairs.train(x, y)">
