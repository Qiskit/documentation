---
title: AllPairs (v0.31)
description: API reference for qiskit.aqua.components.multiclass_extensions.AllPairs in qiskit v0.31
...
<Class id="qiskit.aqua.components.multiclass_extensions.AllPairs" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/aqua/components/multiclass_extensions/all_pairs.py" signature="AllPairs" modifiers="class">
  ...
  <span id="qiskit-aqua-components-multiclass-extensions-allpairs-predict" />
  ...
  <span id="qiskit-aqua-components-multiclass-extensions-allpairs-set-estimator" />
  ...
  <span id="qiskit-aqua-components-multiclass-extensions-allpairs-test" />
  ...
  <span id="qiskit-aqua-components-multiclass-extensions-allpairs-train" />
