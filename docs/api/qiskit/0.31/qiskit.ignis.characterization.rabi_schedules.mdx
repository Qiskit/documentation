---
title: rabi_schedules (v0.31)
description: API reference for qiskit.ignis.characterization.rabi_schedules in qiskit v0.31
...
<Function id="qiskit.ignis.characterization.rabi_schedules" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-ignis/tree/stable/0.6/qiskit/ignis/characterization/calibrations/pulse_schedules.py" signature="rabi_schedules(amp_list, qubits, pulse_width, pulse_sigma=None, width_sigma_ratio=4, drives=None, inst_map=None, meas_map=None)">
