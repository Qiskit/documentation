...
<Function id="qiskit.ignis.characterization.anglecal_1Q_circuits" github="https://github.com/qiskit-community/qiskit-ignis/tree/stable/0.6/qiskit/ignis/characterization/gates/circuits.py" signature="anglecal_1Q_circuits(max_reps, qubits, angleerr=0.0)">
