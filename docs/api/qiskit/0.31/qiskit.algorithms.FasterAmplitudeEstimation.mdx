---
title: FasterAmplitudeEstimation (v0.31)
description: API reference for qiskit.algorithms.FasterAmplitudeEstimation in qiskit v0.31
...
<Class id="qiskit.algorithms.FasterAmplitudeEstimation" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/algorithms/amplitude_estimators/fae.py" signature="FasterAmplitudeEstimation(delta, maxiter, rescale=True, quantum_instance=None)" modifiers="class">
