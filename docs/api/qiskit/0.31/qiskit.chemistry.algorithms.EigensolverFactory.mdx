...
<Class id="qiskit.chemistry.algorithms.EigensolverFactory" github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/chemistry/algorithms/excited_states_solvers/eigensolver_factories/eigensolver_factory.py" signature="EigensolverFactory">
  Bases: `abc.ABC`
  ...
  <Function id="qiskit.chemistry.algorithms.EigensolverFactory.get_solver" name="get_solver" signature="abstract EigensolverFactory.get_solver(transformation)">
