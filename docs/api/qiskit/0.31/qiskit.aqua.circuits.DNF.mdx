...
<Class id="qiskit.aqua.circuits.DNF" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/aqua/circuits/boolean_logical_circuits.py" signature="DNF(ast, num_vars=None)">
  ...
  **Raises**
  ...
  <Function id="qiskit.aqua.circuits.DNF.compute_num_ancillae" name="compute_num_ancillae" signature="DNF.compute_num_ancillae(mct_mode='basic')">
    returns the number of ancillary qubits needed
  </Function>

  ### construct\_circuit

  <Function id="qiskit.aqua.circuits.DNF.construct_circuit" name="construct_circuit" signature="DNF.construct_circuit(circuit=None, variable_register=None, clause_register=None, output_register=None, ancillary_register=None, mct_mode='basic')">
    Construct circuit.
  ...
  <Attribute id="qiskit.aqua.circuits.DNF.ancillary_register" name="ancillary_register">
    returns ancillary register
  </Attribute>

  ### clause\_register

  <Attribute id="qiskit.aqua.circuits.DNF.clause_register" name="clause_register">
    returns clause register
  </Attribute>

  ### num\_clauses

  <Attribute id="qiskit.aqua.circuits.DNF.num_clauses" name="num_clauses">
    returns num clauses
  </Attribute>

  ### num\_variables

  <Attribute id="qiskit.aqua.circuits.DNF.num_variables" name="num_variables">
    return num variables
  </Attribute>

  ### output\_register

  <Attribute id="qiskit.aqua.circuits.DNF.output_register" name="output_register">
    returns output register
  </Attribute>

  ### variable\_register

  <Attribute id="qiskit.aqua.circuits.DNF.variable_register" name="variable_register">
