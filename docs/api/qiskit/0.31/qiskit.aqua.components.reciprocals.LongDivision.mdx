---
title: LongDivision (v0.31)
description: API reference for qiskit.aqua.components.reciprocals.LongDivision in qiskit v0.31
...
<Class id="qiskit.aqua.components.reciprocals.LongDivision" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/aqua/components/reciprocals/long_division.py" signature="LongDivision(scale=0, precision=None, negative_evals=False, evo_time=None, lambda_min=None)" modifiers="class">
  ...
  *   **lambda\_min** (`Optional`\[`float`]) – The smallest expected eigenvalue
  ...
  <span id="qiskit-aqua-components-reciprocals-longdivision-construct-circuit" />

  ### construct\_circuit

  <Function id="qiskit.aqua.components.reciprocals.LongDivision.construct_circuit" signature="LongDivision.construct_circuit(mode, register=None, circuit=None)">
  ...
  <span id="qiskit-aqua-components-reciprocals-longdivision-sv-to-resvec" />

  ### sv\_to\_resvec

  <Function id="qiskit.aqua.components.reciprocals.LongDivision.sv_to_resvec" signature="LongDivision.sv_to_resvec(statevector, num_q)">
