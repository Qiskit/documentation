---
title: PyTorchDiscriminator (v0.31)
description: API reference for qiskit.aqua.components.neural_networks.PyTorchDiscriminator in qiskit v0.31
...
<Class id="qiskit.aqua.components.neural_networks.PyTorchDiscriminator" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/aqua/components/neural_networks/pytorch_discriminator.py" signature="PyTorchDiscriminator(n_features=1, n_out=1)" modifiers="class">
  ...
  **Raises**
  ...
  <span id="qiskit-aqua-components-neural-networks-pytorchdiscriminator-get-label" />
  ...
  <span id="qiskit-aqua-components-neural-networks-pytorchdiscriminator-gradient-penalty" />
  ...
  <span id="qiskit-aqua-components-neural-networks-pytorchdiscriminator-load-model" />
  ...
  <span id="qiskit-aqua-components-neural-networks-pytorchdiscriminator-loss" />
  ...
  <span id="qiskit-aqua-components-neural-networks-pytorchdiscriminator-save-model" />
  ...
  <span id="qiskit-aqua-components-neural-networks-pytorchdiscriminator-set-seed" />
  ...
  <span id="qiskit-aqua-components-neural-networks-pytorchdiscriminator-train" />
