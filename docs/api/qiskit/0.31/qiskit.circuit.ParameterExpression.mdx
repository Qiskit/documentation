---
title: ParameterExpression (v0.31)
description: API reference for qiskit.circuit.ParameterExpression in qiskit v0.31
...
<Class id="qiskit.circuit.ParameterExpression" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/circuit/parameterexpression.py" signature="ParameterExpression(symbol_map, expr)" modifiers="class">
  Bases: `object`
