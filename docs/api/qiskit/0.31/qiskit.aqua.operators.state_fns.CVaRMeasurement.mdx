...
<Class id="qiskit.aqua.operators.state_fns.CVaRMeasurement" github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/aqua/operators/state_fns/cvar_measurement.py" signature="CVaRMeasurement(primitive=None, alpha=1.0, coeff=1.0)">
  ...
  *   [**AquaError**](qiskit.aqua.AquaError "qiskit.aqua.AquaError") – If the primitive is not diagonal.
  ...
  <Function id="qiskit.aqua.operators.state_fns.CVaRMeasurement.add" name="add" signature="CVaRMeasurement.add(other)">
  ...
  <Function id="qiskit.aqua.operators.state_fns.CVaRMeasurement.adjoint" name="adjoint" signature="CVaRMeasurement.adjoint()">
  ...
  <Function id="qiskit.aqua.operators.state_fns.CVaRMeasurement.assign_parameters" name="assign_parameters" signature="CVaRMeasurement.assign_parameters(param_dict)">
  ...
  <Function id="qiskit.aqua.operators.state_fns.CVaRMeasurement.bind_parameters" name="bind_parameters" signature="CVaRMeasurement.bind_parameters(param_dict)">
  ...
  <Function id="qiskit.aqua.operators.state_fns.CVaRMeasurement.compose" name="compose" signature="CVaRMeasurement.compose(other, permutation=None, front=False)">
  ...
  <Function id="qiskit.aqua.operators.state_fns.CVaRMeasurement.compute_cvar" name="compute_cvar" signature="CVaRMeasurement.compute_cvar(energies, probabilities)">
  ...
  <Function id="qiskit.aqua.operators.state_fns.CVaRMeasurement.equals" name="equals" signature="CVaRMeasurement.equals(other)">
  ...
  <Function id="qiskit.aqua.operators.state_fns.CVaRMeasurement.eval" name="eval" signature="CVaRMeasurement.eval(front=None)">
  ...
  <Function id="qiskit.aqua.operators.state_fns.CVaRMeasurement.eval_variance" name="eval_variance" signature="CVaRMeasurement.eval_variance(front=None)">
  ...
  <Function id="qiskit.aqua.operators.state_fns.CVaRMeasurement.get_outcome_energies_probabilities" name="get_outcome_energies_probabilities" signature="CVaRMeasurement.get_outcome_energies_probabilities(front=None)">
  ...
  <Function id="qiskit.aqua.operators.state_fns.CVaRMeasurement.mul" name="mul" signature="CVaRMeasurement.mul(scalar)">
  ...
  <Function id="qiskit.aqua.operators.state_fns.CVaRMeasurement.neg" name="neg" signature="CVaRMeasurement.neg()">
  ...
  <Function id="qiskit.aqua.operators.state_fns.CVaRMeasurement.permute" name="permute" signature="CVaRMeasurement.permute(permutation)">
  ...
  <Function id="qiskit.aqua.operators.state_fns.CVaRMeasurement.power" name="power" signature="CVaRMeasurement.power(exponent)">
  ...
  <Function id="qiskit.aqua.operators.state_fns.CVaRMeasurement.primitive_strings" name="primitive_strings" signature="CVaRMeasurement.primitive_strings()">
  ...
  <Function id="qiskit.aqua.operators.state_fns.CVaRMeasurement.reduce" name="reduce" signature="CVaRMeasurement.reduce()">
  ...
  <Function id="qiskit.aqua.operators.state_fns.CVaRMeasurement.sample" name="sample" signature="CVaRMeasurement.sample(shots=1024, massive=False, reverse_endianness=False)">
  ...
  <Function id="qiskit.aqua.operators.state_fns.CVaRMeasurement.tensor" name="tensor" signature="CVaRMeasurement.tensor(other)">
  ...
  <Function id="qiskit.aqua.operators.state_fns.CVaRMeasurement.tensorpower" name="tensorpower" signature="CVaRMeasurement.tensorpower(other)">
  ...
  <Function id="qiskit.aqua.operators.state_fns.CVaRMeasurement.to_circuit_op" name="to_circuit_op" signature="CVaRMeasurement.to_circuit_op()">
    Not defined.
  ...
  <Function id="qiskit.aqua.operators.state_fns.CVaRMeasurement.to_density_matrix" name="to_density_matrix" signature="CVaRMeasurement.to_density_matrix(massive=False)">
    Not defined.
  ...
  <Function id="qiskit.aqua.operators.state_fns.CVaRMeasurement.to_legacy_op" name="to_legacy_op" signature="CVaRMeasurement.to_legacy_op(massive=False)">
  ...
  <Function id="qiskit.aqua.operators.state_fns.CVaRMeasurement.to_matrix" name="to_matrix" signature="CVaRMeasurement.to_matrix(massive=False)">
    Not defined.
  ...
  <Function id="qiskit.aqua.operators.state_fns.CVaRMeasurement.to_matrix_op" name="to_matrix_op" signature="CVaRMeasurement.to_matrix_op(massive=False)">
    Not defined.
  ...
  <Function id="qiskit.aqua.operators.state_fns.CVaRMeasurement.traverse" name="traverse" signature="CVaRMeasurement.traverse(convert_fn, coeff=None)">
  ...
  <Attribute id="qiskit.aqua.operators.state_fns.CVaRMeasurement.ENABLE_DEPRECATION" name="ENABLE_DEPRECATION" attributeValue="= True" />

  ### INDENTATION

  <Attribute id="qiskit.aqua.operators.state_fns.CVaRMeasurement.INDENTATION" name="INDENTATION" attributeValue="= '  '" />

  ### alpha

  <Attribute id="qiskit.aqua.operators.state_fns.CVaRMeasurement.alpha" name="alpha">
  ...
  <Attribute id="qiskit.aqua.operators.state_fns.CVaRMeasurement.coeff" name="coeff">
  ...
  <Attribute id="qiskit.aqua.operators.state_fns.CVaRMeasurement.is_measurement" name="is_measurement">
  ...
  <Attribute id="qiskit.aqua.operators.state_fns.CVaRMeasurement.num_qubits" name="num_qubits">
    **Return type**
  ...
  <Attribute id="qiskit.aqua.operators.state_fns.CVaRMeasurement.parameters" name="parameters" />

  ### primitive

  <Attribute id="qiskit.aqua.operators.state_fns.CVaRMeasurement.primitive" name="primitive">
