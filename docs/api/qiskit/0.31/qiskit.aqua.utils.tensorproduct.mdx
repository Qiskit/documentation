...
<Function id="qiskit.aqua.utils.tensorproduct" name="tensorproduct" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/aqua/utils/tensor_product.py" signature="tensorproduct(*args)">
