---
title: BaseJob (v0.31)
description: API reference for qiskit.providers.BaseJob in qiskit v0.31
...
<Class id="qiskit.providers.BaseJob" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/providers/basejob.py" signature="BaseJob(backend, job_id)" modifiers="class">
  Bases: `abc.ABC`
  ...
  *   **job\_id** (`str`) – a unique id in the context of the backend used to run the job.
  ...
  <span id="qiskit-providers-basejob-in-final-state" />
  ...
  <span id="qiskit-providers-basejob-job-id" />
  ...
  <span id="qiskit-providers-basejob-wait-for-final-state" />
