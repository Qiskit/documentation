...
<Class id="qiskit.chemistry.algorithms.ExcitedStatesEigensolver" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/chemistry/algorithms/excited_states_solvers/excited_states_eigensolver.py" signature="ExcitedStatesEigensolver(transformation, solver)">
  ...
  *   **solver** (`Union`\[`Eigensolver`, `EigensolverFactory`]) – Minimum Eigensolver or MESFactory object.
  ...
  <Function id="qiskit.chemistry.algorithms.ExcitedStatesEigensolver.solve" name="solve" signature="ExcitedStatesEigensolver.solve(driver, aux_operators=None)">
  ...
  <Attribute id="qiskit.chemistry.algorithms.ExcitedStatesEigensolver.solver" name="solver">
  ...
  <Attribute id="qiskit.chemistry.algorithms.ExcitedStatesEigensolver.transformation" name="transformation">
