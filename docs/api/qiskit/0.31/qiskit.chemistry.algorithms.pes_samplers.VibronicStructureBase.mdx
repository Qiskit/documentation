...
<Class id="qiskit.chemistry.algorithms.pes_samplers.VibronicStructureBase" github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/chemistry/algorithms/pes_samplers/potentials/potential_base.py" signature="VibronicStructureBase(molecule)">
  ...
  <Function id="qiskit.chemistry.algorithms.pes_samplers.VibronicStructureBase.get_num_modes" signature="abstract VibronicStructureBase.get_num_modes()">
  ...
  <Function id="qiskit.chemistry.algorithms.pes_samplers.VibronicStructureBase.vibrational_energy_level" signature="abstract VibronicStructureBase.vibrational_energy_level(n)">
