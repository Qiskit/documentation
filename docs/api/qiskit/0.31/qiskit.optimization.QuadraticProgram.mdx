---
title: QuadraticProgram (v0.31)
description: API reference for qiskit.optimization.QuadraticProgram in qiskit v0.31
...
<Class id="qiskit.optimization.QuadraticProgram" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/optimization/problems/quadratic_program.py" signature="QuadraticProgram(name='')" modifiers="class">
  ...
  **name** (`str`) – The name of the quadratic program.
  ...
  <span id="qiskit-optimization-quadraticprogram-binary-var" />
  ...
  <span id="qiskit-optimization-quadraticprogram-binary-var-dict" />

  ### binary\_var\_dict

  <Function id="qiskit.optimization.QuadraticProgram.binary_var_dict" signature="QuadraticProgram.binary_var_dict(keys, name=None, key_format='{}')">
  ...
  <span id="qiskit-optimization-quadraticprogram-binary-var-list" />

  ### binary\_var\_list

  <Function id="qiskit.optimization.QuadraticProgram.binary_var_list" signature="QuadraticProgram.binary_var_list(keys, name=None, key_format='{}')">
  ...
  <span id="qiskit-optimization-quadraticprogram-continuous-var" />
  ...
  <span id="qiskit-optimization-quadraticprogram-continuous-var-dict" />

  ### continuous\_var\_dict

  <Function id="qiskit.optimization.QuadraticProgram.continuous_var_dict" signature="QuadraticProgram.continuous_var_dict(keys, lowerbound=0, upperbound=1e+20, name=None, key_format='{}')">
  ...
  <span id="qiskit-optimization-quadraticprogram-continuous-var-list" />

  ### continuous\_var\_list

  <Function id="qiskit.optimization.QuadraticProgram.continuous_var_list" signature="QuadraticProgram.continuous_var_list(keys, lowerbound=0, upperbound=1e+20, name=None, key_format='{}')">
  ...
  <span id="qiskit-optimization-quadraticprogram-export-as-lp-string" />
  ...
  <span id="qiskit-optimization-quadraticprogram-from-docplex" />
  ...
  <span id="qiskit-optimization-quadraticprogram-from-ising" />

  ### from\_ising

  <Function id="qiskit.optimization.QuadraticProgram.from_ising" signature="QuadraticProgram.from_ising(qubit_op, offset=0.0, linear=False)">
  ...
  <span id="qiskit-optimization-quadraticprogram-get-feasibility-info" />

  ### get\_feasibility\_info

  <Function id="qiskit.optimization.QuadraticProgram.get_feasibility_info" signature="QuadraticProgram.get_feasibility_info(x)">
  ...
  <span id="qiskit-optimization-quadraticprogram-get-linear-constraint" />
  ...
  <span id="qiskit-optimization-quadraticprogram-get-num-binary-vars" />
  ...
  <span id="qiskit-optimization-quadraticprogram-get-num-continuous-vars" />
  ...
  <span id="qiskit-optimization-quadraticprogram-get-num-integer-vars" />
  ...
  <span id="qiskit-optimization-quadraticprogram-get-num-linear-constraints" />
  ...
  <span id="qiskit-optimization-quadraticprogram-get-num-quadratic-constraints" />
  ...
  <span id="qiskit-optimization-quadraticprogram-get-num-vars" />
  ...
  <span id="qiskit-optimization-quadraticprogram-get-quadratic-constraint" />
  ...
  <span id="qiskit-optimization-quadraticprogram-get-variable" />
  ...
  <span id="qiskit-optimization-quadraticprogram-integer-var" />
  ...
  <span id="qiskit-optimization-quadraticprogram-integer-var-dict" />

  ### integer\_var\_dict

  <Function id="qiskit.optimization.QuadraticProgram.integer_var_dict" signature="QuadraticProgram.integer_var_dict(keys, lowerbound=0, upperbound=1e+20, name=None, key_format='{}')">
  ...
  <span id="qiskit-optimization-quadraticprogram-integer-var-list" />

  ### integer\_var\_list

  <Function id="qiskit.optimization.QuadraticProgram.integer_var_list" signature="QuadraticProgram.integer_var_list(keys, lowerbound=0, upperbound=1e+20, name=None, key_format='{}')">
  ...
  <span id="qiskit-optimization-quadraticprogram-is-feasible" />

  ### is\_feasible

  <Function id="qiskit.optimization.QuadraticProgram.is_feasible" signature="QuadraticProgram.is_feasible(x)">
  ...
  <span id="qiskit-optimization-quadraticprogram-linear-constraint" />
  ...
  <span id="qiskit-optimization-quadraticprogram-pprint-as-string" />
  ...
  <span id="qiskit-optimization-quadraticprogram-quadratic-constraint" />
  ...
  <span id="qiskit-optimization-quadraticprogram-read-from-lp-file" />
  ...
  <span id="qiskit-optimization-quadraticprogram-remove-linear-constraint" />
  ...
  <span id="qiskit-optimization-quadraticprogram-remove-quadratic-constraint" />
  ...
  <span id="qiskit-optimization-quadraticprogram-substitute-variables" />
  ...
  <span id="qiskit-optimization-quadraticprogram-to-docplex" />
  ...
  <span id="qiskit-optimization-quadraticprogram-to-ising" />

  ### to\_ising

  <Function id="qiskit.optimization.QuadraticProgram.to_ising" signature="QuadraticProgram.to_ising()">
  ...
  <span id="qiskit-optimization-quadraticprogram-write-to-lp-file" />
