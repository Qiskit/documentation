...
<Class id="qiskit.optimization.QuadraticProgram" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/optimization/problems/quadratic_program.py" signature="QuadraticProgram(name='')">
  Bases: `object`
  ...
  **name** (`str`) – The name of the quadratic program.
  ...
  <Function id="qiskit.optimization.QuadraticProgram.binary_var" name="binary_var" signature="QuadraticProgram.binary_var(name=None)">
  ...
  <Function id="qiskit.optimization.QuadraticProgram.binary_var_dict" name="binary_var_dict" signature="QuadraticProgram.binary_var_dict(keys, name=None, key_format='{}')">
  ...
  <Function id="qiskit.optimization.QuadraticProgram.binary_var_list" name="binary_var_list" signature="QuadraticProgram.binary_var_list(keys, name=None, key_format='{}')">
  ...
  <Function id="qiskit.optimization.QuadraticProgram.clear" name="clear" signature="QuadraticProgram.clear()">
  ...
  <Function id="qiskit.optimization.QuadraticProgram.continuous_var" name="continuous_var" signature="QuadraticProgram.continuous_var(lowerbound=0, upperbound=1e+20, name=None)">
  ...
  <Function id="qiskit.optimization.QuadraticProgram.continuous_var_dict" name="continuous_var_dict" signature="QuadraticProgram.continuous_var_dict(keys, lowerbound=0, upperbound=1e+20, name=None, key_format='{}')">
  ...
  <Function id="qiskit.optimization.QuadraticProgram.continuous_var_list" name="continuous_var_list" signature="QuadraticProgram.continuous_var_list(keys, lowerbound=0, upperbound=1e+20, name=None, key_format='{}')">
  ...
  <Function id="qiskit.optimization.QuadraticProgram.export_as_lp_string" name="export_as_lp_string" signature="QuadraticProgram.export_as_lp_string()">
  ...
  <Function id="qiskit.optimization.QuadraticProgram.from_docplex" name="from_docplex" signature="QuadraticProgram.from_docplex(model)">
  ...
  <Function id="qiskit.optimization.QuadraticProgram.from_ising" name="from_ising" signature="QuadraticProgram.from_ising(qubit_op, offset=0.0, linear=False)">
  ...
  <Function id="qiskit.optimization.QuadraticProgram.get_feasibility_info" name="get_feasibility_info" signature="QuadraticProgram.get_feasibility_info(x)">
  ...
  <Function id="qiskit.optimization.QuadraticProgram.get_linear_constraint" name="get_linear_constraint" signature="QuadraticProgram.get_linear_constraint(i)">
  ...
  <Function id="qiskit.optimization.QuadraticProgram.get_num_binary_vars" name="get_num_binary_vars" signature="QuadraticProgram.get_num_binary_vars()">
  ...
  <Function id="qiskit.optimization.QuadraticProgram.get_num_continuous_vars" name="get_num_continuous_vars" signature="QuadraticProgram.get_num_continuous_vars()">
  ...
  <Function id="qiskit.optimization.QuadraticProgram.get_num_integer_vars" name="get_num_integer_vars" signature="QuadraticProgram.get_num_integer_vars()">
  ...
  <Function id="qiskit.optimization.QuadraticProgram.get_num_linear_constraints" name="get_num_linear_constraints" signature="QuadraticProgram.get_num_linear_constraints()">
  ...
  <Function id="qiskit.optimization.QuadraticProgram.get_num_quadratic_constraints" name="get_num_quadratic_constraints" signature="QuadraticProgram.get_num_quadratic_constraints()">
  ...
  <Function id="qiskit.optimization.QuadraticProgram.get_num_vars" name="get_num_vars" signature="QuadraticProgram.get_num_vars(vartype=None)">
  ...
  <Function id="qiskit.optimization.QuadraticProgram.get_quadratic_constraint" name="get_quadratic_constraint" signature="QuadraticProgram.get_quadratic_constraint(i)">
  ...
  <Function id="qiskit.optimization.QuadraticProgram.get_variable" name="get_variable" signature="QuadraticProgram.get_variable(i)">
  ...
  <Function id="qiskit.optimization.QuadraticProgram.integer_var" name="integer_var" signature="QuadraticProgram.integer_var(lowerbound=0, upperbound=1e+20, name=None)">
  ...
  <Function id="qiskit.optimization.QuadraticProgram.integer_var_dict" name="integer_var_dict" signature="QuadraticProgram.integer_var_dict(keys, lowerbound=0, upperbound=1e+20, name=None, key_format='{}')">
  ...
  <Function id="qiskit.optimization.QuadraticProgram.integer_var_list" name="integer_var_list" signature="QuadraticProgram.integer_var_list(keys, lowerbound=0, upperbound=1e+20, name=None, key_format='{}')">
  ...
  <Function id="qiskit.optimization.QuadraticProgram.is_feasible" name="is_feasible" signature="QuadraticProgram.is_feasible(x)">
  ...
  <Function id="qiskit.optimization.QuadraticProgram.linear_constraint" name="linear_constraint" signature="QuadraticProgram.linear_constraint(linear=None, sense='<=', rhs=0.0, name=None)">
  ...
  <Function id="qiskit.optimization.QuadraticProgram.maximize" name="maximize" signature="QuadraticProgram.maximize(constant=0.0, linear=None, quadratic=None)">
  ...
  <Function id="qiskit.optimization.QuadraticProgram.minimize" name="minimize" signature="QuadraticProgram.minimize(constant=0.0, linear=None, quadratic=None)">
  ...
  <Function id="qiskit.optimization.QuadraticProgram.pprint_as_string" name="pprint_as_string" signature="QuadraticProgram.pprint_as_string()">
  ...
  <Function id="qiskit.optimization.QuadraticProgram.prettyprint" name="prettyprint" signature="QuadraticProgram.prettyprint(out=None)">
  ...
  <Function id="qiskit.optimization.QuadraticProgram.quadratic_constraint" name="quadratic_constraint" signature="QuadraticProgram.quadratic_constraint(linear=None, quadratic=None, sense='<=', rhs=0.0, name=None)">
  ...
  <Function id="qiskit.optimization.QuadraticProgram.read_from_lp_file" name="read_from_lp_file" signature="QuadraticProgram.read_from_lp_file(filename)">
  ...
  <Function id="qiskit.optimization.QuadraticProgram.remove_linear_constraint" name="remove_linear_constraint" signature="QuadraticProgram.remove_linear_constraint(i)">
  ...
  <Function id="qiskit.optimization.QuadraticProgram.remove_quadratic_constraint" name="remove_quadratic_constraint" signature="QuadraticProgram.remove_quadratic_constraint(i)">
  ...
  <Function id="qiskit.optimization.QuadraticProgram.substitute_variables" name="substitute_variables" signature="QuadraticProgram.substitute_variables(constants=None, variables=None)">
  ...
  <Function id="qiskit.optimization.QuadraticProgram.to_docplex" name="to_docplex" signature="QuadraticProgram.to_docplex()">
  ...
  <Function id="qiskit.optimization.QuadraticProgram.to_ising" name="to_ising" signature="QuadraticProgram.to_ising()">
  ...
  <Function id="qiskit.optimization.QuadraticProgram.write_to_lp_file" name="write_to_lp_file" signature="QuadraticProgram.write_to_lp_file(filename)">
  ...
  <Attribute id="qiskit.optimization.QuadraticProgram.linear_constraints" name="linear_constraints">
  ...
  <Attribute id="qiskit.optimization.QuadraticProgram.linear_constraints_index" name="linear_constraints_index">
  ...
  <Attribute id="qiskit.optimization.QuadraticProgram.name" name="name">
  ...
  <Attribute id="qiskit.optimization.QuadraticProgram.objective" name="objective">
  ...
  <Attribute id="qiskit.optimization.QuadraticProgram.quadratic_constraints" name="quadratic_constraints">
  ...
  <Attribute id="qiskit.optimization.QuadraticProgram.quadratic_constraints_index" name="quadratic_constraints_index">
  ...
  <Attribute id="qiskit.optimization.QuadraticProgram.variables" name="variables">
  ...
  <Attribute id="qiskit.optimization.QuadraticProgram.variables_index" name="variables_index">
