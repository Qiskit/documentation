---
title: IBMQBackend (v0.31)
description: API reference for qiskit.providers.ibmq.IBMQBackend in qiskit v0.31
...
<Class id="qiskit.providers.ibmq.IBMQBackend" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-ibmq-provider/tree/stable/0.17/qiskit/providers/ibmq/ibmqbackend.py" signature="IBMQBackend(configuration, provider, credentials, api_client)" modifiers="class">
