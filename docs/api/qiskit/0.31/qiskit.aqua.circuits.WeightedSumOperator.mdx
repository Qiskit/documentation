---
title: WeightedSumOperator (v0.31)
description: API reference for qiskit.aqua.circuits.WeightedSumOperator in qiskit v0.31
...
<Class id="qiskit.aqua.circuits.WeightedSumOperator" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/aqua/circuits/weighted_sum_operator.py" signature="WeightedSumOperator(num_state_qubits, weights, i_state=None, i_sum=None)" modifiers="class">
  ...
  **Raises**
  ...
  <span id="qiskit-aqua-circuits-weightedsumoperator-build-controlled" />
  ...
  <span id="qiskit-aqua-circuits-weightedsumoperator-build-controlled-inverse" />
  ...
  <span id="qiskit-aqua-circuits-weightedsumoperator-build-controlled-inverse-power" />
  ...
  <span id="qiskit-aqua-circuits-weightedsumoperator-build-controlled-power" />
  ...
  <span id="qiskit-aqua-circuits-weightedsumoperator-build-inverse" />
  ...
  <span id="qiskit-aqua-circuits-weightedsumoperator-build-inverse-power" />
  ...
  <span id="qiskit-aqua-circuits-weightedsumoperator-build-power" />
  ...
  <span id="qiskit-aqua-circuits-weightedsumoperator-get-num-qubits" />
  ...
  <span id="qiskit-aqua-circuits-weightedsumoperator-get-num-qubits-controlled" />
  ...
  <span id="qiskit-aqua-circuits-weightedsumoperator-get-required-sum-qubits" />
  ...
  <span id="qiskit-aqua-circuits-weightedsumoperator-required-ancillas" />
  ...
  <span id="qiskit-aqua-circuits-weightedsumoperator-required-ancillas-controlled" />
