---
title: TPBGroupedWeightedPauliOperator (v0.31)
description: API reference for qiskit.aqua.operators.legacy.TPBGroupedWeightedPauliOperator in qiskit v0.31
...
<Class id="qiskit.aqua.operators.legacy.TPBGroupedWeightedPauliOperator" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/aqua/operators/legacy/tpb_grouped_weighted_pauli_operator.py" signature="TPBGroupedWeightedPauliOperator(paulis, basis, z2_symmetries=None, atol=1e-12, name=None, grouping_func=None, kwargs=None)" modifiers="class">
  ...
  *   **kwargs** (*dict*) – Optional parameters for grouping function call
  ...
  <Function id="qiskit.aqua.operators.legacy.TPBGroupedWeightedPauliOperator.add" signature="TPBGroupedWeightedPauliOperator.add(other, copy=False)">
    Perform self + other.
  ...
  <span id="qiskit-aqua-operators-legacy-tpbgroupedweightedpaulioperator-anticommute-with" />

  ### anticommute\_with

  <Function id="qiskit.aqua.operators.legacy.TPBGroupedWeightedPauliOperator.anticommute_with" signature="TPBGroupedWeightedPauliOperator.anticommute_with(other)">
    Anti commutes with
  </Function>
  ...
  <Function id="qiskit.aqua.operators.legacy.TPBGroupedWeightedPauliOperator.chop" signature="TPBGroupedWeightedPauliOperator.chop(threshold=None, copy=False)">
  ...
  <span id="qiskit-aqua-operators-legacy-tpbgroupedweightedpaulioperator-commute-with" />

  ### commute\_with

  <Function id="qiskit.aqua.operators.legacy.TPBGroupedWeightedPauliOperator.commute_with" signature="TPBGroupedWeightedPauliOperator.commute_with(other)">
    Commutes with
  </Function>

  <span id="qiskit-aqua-operators-legacy-tpbgroupedweightedpaulioperator-construct-evaluation-circuit" />

  ### construct\_evaluation\_circuit

  <Function id="qiskit.aqua.operators.legacy.TPBGroupedWeightedPauliOperator.construct_evaluation_circuit" signature="TPBGroupedWeightedPauliOperator.construct_evaluation_circuit(wave_function, statevector_mode, qr=None, cr=None, use_simulator_snapshot_mode=False, circuit_name_prefix='')">
  ...
  <Function id="qiskit.aqua.operators.legacy.TPBGroupedWeightedPauliOperator.copy" signature="TPBGroupedWeightedPauliOperator.copy()">
    Get a copy of self
  </Function>

  <span id="qiskit-aqua-operators-legacy-tpbgroupedweightedpaulioperator-evaluate-with-result" />

  ### evaluate\_with\_result

  <Function id="qiskit.aqua.operators.legacy.TPBGroupedWeightedPauliOperator.evaluate_with_result" signature="TPBGroupedWeightedPauliOperator.evaluate_with_result(result, statevector_mode, use_simulator_snapshot_mode=False, circuit_name_prefix='')">
  ...
  <span id="qiskit-aqua-operators-legacy-tpbgroupedweightedpaulioperator-evaluate-with-statevector" />

  ### evaluate\_with\_statevector

  <Function id="qiskit.aqua.operators.legacy.TPBGroupedWeightedPauliOperator.evaluate_with_statevector" signature="TPBGroupedWeightedPauliOperator.evaluate_with_statevector(quantum_state)">
    **Parameters**
  ...
  <span id="qiskit-aqua-operators-legacy-tpbgroupedweightedpaulioperator-evaluation-instruction" />

  ### evaluation\_instruction

  <Function id="qiskit.aqua.operators.legacy.TPBGroupedWeightedPauliOperator.evaluation_instruction" signature="TPBGroupedWeightedPauliOperator.evaluation_instruction(statevector_mode, use_simulator_snapshot_mode=False)">
    **Parameters**
  ...
  <Function id="qiskit.aqua.operators.legacy.TPBGroupedWeightedPauliOperator.evolve" signature="TPBGroupedWeightedPauliOperator.evolve(state_in=None, evo_time=0, num_time_slices=1, quantum_registers=None, expansion_mode='trotter', expansion_order=1)">
  ...
  <span id="qiskit-aqua-operators-legacy-tpbgroupedweightedpaulioperator-evolve-instruction" />

  ### evolve\_instruction

  <Function id="qiskit.aqua.operators.legacy.TPBGroupedWeightedPauliOperator.evolve_instruction" signature="TPBGroupedWeightedPauliOperator.evolve_instruction(evo_time=0, num_time_slices=1, expansion_mode='trotter', expansion_order=1)">
    Carry out the eoh evolution for the operator under supplied specifications.
  ...
  <span id="qiskit-aqua-operators-legacy-tpbgroupedweightedpaulioperator-from-dict" />

  ### from\_dict

  <Function id="qiskit.aqua.operators.legacy.TPBGroupedWeightedPauliOperator.from_dict" signature="TPBGroupedWeightedPauliOperator.from_dict(dictionary, before_04=False)" modifiers="classmethod">
  ...
  <span id="qiskit-aqua-operators-legacy-tpbgroupedweightedpaulioperator-from-file" />

  ### from\_file

  <Function id="qiskit.aqua.operators.legacy.TPBGroupedWeightedPauliOperator.from_file" signature="TPBGroupedWeightedPauliOperator.from_file(file_name, before_04=False)" modifiers="classmethod">
  ...
  <span id="qiskit-aqua-operators-legacy-tpbgroupedweightedpaulioperator-from-list" />

  ### from\_list

  <Function id="qiskit.aqua.operators.legacy.TPBGroupedWeightedPauliOperator.from_list" signature="TPBGroupedWeightedPauliOperator.from_list(paulis, weights=None, name=None)" modifiers="classmethod">
  ...
  <span id="qiskit-aqua-operators-legacy-tpbgroupedweightedpaulioperator-is-empty" />

  ### is\_empty

  <Function id="qiskit.aqua.operators.legacy.TPBGroupedWeightedPauliOperator.is_empty" signature="TPBGroupedWeightedPauliOperator.is_empty()">
  ...
  <Function id="qiskit.aqua.operators.legacy.TPBGroupedWeightedPauliOperator.multiply" signature="TPBGroupedWeightedPauliOperator.multiply(other)">
    Perform self \* other.
  ...
  <span id="qiskit-aqua-operators-legacy-tpbgroupedweightedpaulioperator-print-details" />

  ### print\_details

  <Function id="qiskit.aqua.operators.legacy.TPBGroupedWeightedPauliOperator.print_details" signature="TPBGroupedWeightedPauliOperator.print_details()">
  ...
  <span id="qiskit-aqua-operators-legacy-tpbgroupedweightedpaulioperator-reorder-paulis" />

  ### reorder\_paulis

  <Function id="qiskit.aqua.operators.legacy.TPBGroupedWeightedPauliOperator.reorder_paulis" signature="TPBGroupedWeightedPauliOperator.reorder_paulis()">
  ...
  <Function id="qiskit.aqua.operators.legacy.TPBGroupedWeightedPauliOperator.rounding" signature="TPBGroupedWeightedPauliOperator.rounding(decimals, copy=False)">
    Rounding the weight.
  ...
  <Function id="qiskit.aqua.operators.legacy.TPBGroupedWeightedPauliOperator.simplify" signature="TPBGroupedWeightedPauliOperator.simplify(copy=False)">
  ...
  <span id="qiskit-aqua-operators-legacy-tpbgroupedweightedpaulioperator-sorted-grouping" />

  ### sorted\_grouping

  <Function id="qiskit.aqua.operators.legacy.TPBGroupedWeightedPauliOperator.sorted_grouping" signature="TPBGroupedWeightedPauliOperator.sorted_grouping(weighted_pauli_operator, method='largest-degree')" modifiers="classmethod">
  ...
  <Function id="qiskit.aqua.operators.legacy.TPBGroupedWeightedPauliOperator.sub" signature="TPBGroupedWeightedPauliOperator.sub(other, copy=False)">
    Perform self - other.
  ...
  <span id="qiskit-aqua-operators-legacy-tpbgroupedweightedpaulioperator-to-dict" />

  ### to\_dict

  <Function id="qiskit.aqua.operators.legacy.TPBGroupedWeightedPauliOperator.to_dict" signature="TPBGroupedWeightedPauliOperator.to_dict()">
  ...
  <span id="qiskit-aqua-operators-legacy-tpbgroupedweightedpaulioperator-to-file" />

  ### to\_file

  <Function id="qiskit.aqua.operators.legacy.TPBGroupedWeightedPauliOperator.to_file" signature="TPBGroupedWeightedPauliOperator.to_file(file_name)">
  ...
  <span id="qiskit-aqua-operators-legacy-tpbgroupedweightedpaulioperator-to-opflow" />

  ### to\_opflow

  <Function id="qiskit.aqua.operators.legacy.TPBGroupedWeightedPauliOperator.to_opflow" signature="TPBGroupedWeightedPauliOperator.to_opflow(reverse_endianness=False)">
    to op flow
  </Function>

  <span id="qiskit-aqua-operators-legacy-tpbgroupedweightedpaulioperator-unsorted-grouping" />

  ### unsorted\_grouping

  <Function id="qiskit.aqua.operators.legacy.TPBGroupedWeightedPauliOperator.unsorted_grouping" signature="TPBGroupedWeightedPauliOperator.unsorted_grouping(weighted_pauli_operator)" modifiers="classmethod">
