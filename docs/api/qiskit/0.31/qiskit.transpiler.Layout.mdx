...
<Class id="qiskit.transpiler.Layout" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/transpiler/layout.py" signature="Layout(input_dict=None)">
  Bases: `object`
  ...
  <Function id="qiskit.transpiler.Layout.from_qubit_list" signature="static Layout.from_qubit_list(qubit_list, *qregs)">
