...
<Class id="qiskit.opflow.state_fns.CVaRMeasurement" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/opflow/state_fns/cvar_measurement.py" signature="CVaRMeasurement(primitive=None, alpha=1.0, coeff=1.0)">
  ...
  *   [**OpflowError**](qiskit.opflow.OpflowError "qiskit.opflow.OpflowError") – If the primitive is not diagonal.
  ...
  <Function id="qiskit.opflow.state_fns.CVaRMeasurement.add" name="add" signature="CVaRMeasurement.add(other)">
  ...
  <Function id="qiskit.opflow.state_fns.CVaRMeasurement.adjoint" name="adjoint" signature="CVaRMeasurement.adjoint()">
  ...
  <Function id="qiskit.opflow.state_fns.CVaRMeasurement.compute_cvar" name="compute_cvar" signature="CVaRMeasurement.compute_cvar(energies, probabilities)">
  ...
  <Function id="qiskit.opflow.state_fns.CVaRMeasurement.eval" name="eval" signature="CVaRMeasurement.eval(front=None)">
  ...
  <Function id="qiskit.opflow.state_fns.CVaRMeasurement.eval_variance" name="eval_variance" signature="CVaRMeasurement.eval_variance(front=None)">
  ...
  <Function id="qiskit.opflow.state_fns.CVaRMeasurement.get_outcome_energies_probabilities" name="get_outcome_energies_probabilities" signature="CVaRMeasurement.get_outcome_energies_probabilities(front=None)">
  ...
  <Function id="qiskit.opflow.state_fns.CVaRMeasurement.mul" name="mul" signature="CVaRMeasurement.mul(scalar)">
  ...
  <Function id="qiskit.opflow.state_fns.CVaRMeasurement.sample" name="sample" signature="CVaRMeasurement.sample(shots=1024, massive=False, reverse_endianness=False)">
  ...
  <Function id="qiskit.opflow.state_fns.CVaRMeasurement.tensor" name="tensor" signature="CVaRMeasurement.tensor(other)">
  ...
  <Function id="qiskit.opflow.state_fns.CVaRMeasurement.to_circuit_op" name="to_circuit_op" signature="CVaRMeasurement.to_circuit_op()">
    Not defined.
  </Function>

  ### to\_density\_matrix

  <Function id="qiskit.opflow.state_fns.CVaRMeasurement.to_density_matrix" name="to_density_matrix" signature="CVaRMeasurement.to_density_matrix(massive=False)">
    Not defined.
  </Function>

  ### to\_matrix

  <Function id="qiskit.opflow.state_fns.CVaRMeasurement.to_matrix" name="to_matrix" signature="CVaRMeasurement.to_matrix(massive=False)">
    Not defined.
  </Function>

  ### to\_matrix\_op

  <Function id="qiskit.opflow.state_fns.CVaRMeasurement.to_matrix_op" name="to_matrix_op" signature="CVaRMeasurement.to_matrix_op(massive=False)">
    Not defined.
  </Function>

  ### traverse

  <Function id="qiskit.opflow.state_fns.CVaRMeasurement.traverse" name="traverse" signature="CVaRMeasurement.traverse(convert_fn, coeff=None)">
  ...
  <Attribute id="qiskit.opflow.state_fns.CVaRMeasurement.primitive" name="primitive" attributeTypeHint="qiskit.opflow.operator_base.OperatorBase">
