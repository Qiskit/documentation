...
<Class id="qiskit.ignis.mitigation.ExpvalMeasMitigatorFitter" github="https://github.com/qiskit-community/qiskit-ignis/tree/stable/0.6/qiskit/ignis/mitigation/expval/fitter.py" signature="ExpvalMeasMitigatorFitter(result, metadata)">
  Bases: `object`
