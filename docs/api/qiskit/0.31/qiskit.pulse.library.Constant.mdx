...
<Class id="qiskit.pulse.library.Constant" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/pulse/library/parametric_pulses.py" signature="Constant(duration, amp, name=None)">
...
$$
  ...
  *   **name** (`Optional`\[`str`]) – Display name for this pulse envelope.
  ...
  <Function id="qiskit.pulse.library.Constant.assign" name="assign" signature="Constant.assign(parameter, value)">
  ...
  <Function id="qiskit.pulse.library.Constant.assign_parameters" name="assign_parameters" signature="Constant.assign_parameters(value_dict)">
  ...
  <Function id="qiskit.pulse.library.Constant.draw" name="draw" signature="Constant.draw(dt=None, style=None, filename=None, interp_method=None, scale=None, interactive=None, draw_title=None, backend=None, time_range=None, time_unit='dt', show_waveform_info=True, plotter='mpl2d', axis=None)">
  ...
  <Function id="qiskit.pulse.library.Constant.get_waveform" name="get_waveform" signature="Constant.get_waveform()">
  ...
  <Function id="qiskit.pulse.library.Constant.is_parameterized" name="is_parameterized" signature="Constant.is_parameterized()">
  ...
  <Function id="qiskit.pulse.library.Constant.validate_parameters" name="validate_parameters" signature="Constant.validate_parameters()">
    Validate parameters.
  ...
  <Attribute id="qiskit.pulse.library.Constant.amp" name="amp">
  ...
  <Attribute id="qiskit.pulse.library.Constant.id" name="id">
  ...
  <Attribute id="qiskit.pulse.library.Constant.limit_amplitude" name="limit_amplitude" attributeValue="= True" />

  ### parameters

  <Attribute id="qiskit.pulse.library.Constant.parameters" name="parameters">
    **Return type**
