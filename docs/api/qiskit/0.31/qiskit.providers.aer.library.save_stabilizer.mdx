...
<Function id="qiskit.providers.aer.library.save_stabilizer" github="https://github.com/qiskit/qiskit-aer/tree/stable/0.9/qiskit/providers/aer/library/save_instructions/save_stabilizer.py" signature="save_stabilizer(self, label='stabilizer', pershot=False, conditional=False)">
