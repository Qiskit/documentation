...
<Class id="qiskit.providers.aer.AerProvider" github="https://github.com/qiskit/qiskit-aer/tree/stable/0.9/qiskit/providers/aer/aerprovider.py" signature="AerProvider">
