---
title: concurrence (v0.31)
description: API reference for qiskit.quantum_info.concurrence in qiskit v0.31
...
<Function id="qiskit.quantum_info.concurrence" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/quantum_info/states/measures.py" signature="concurrence(state)">
