---
title: GaussianLogResult (v0.31)
description: API reference for qiskit.chemistry.drivers.GaussianLogResult in qiskit v0.31
...
<Class id="qiskit.chemistry.drivers.GaussianLogResult" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/chemistry/drivers/gaussiand/gaussian_log_result.py" signature="GaussianLogResult(log)" modifiers="class">
  Bases: `object`
  ...
  **ValueError** – Invalid Input
  ...
  <span id="qiskit-chemistry-drivers-gaussianlogresult-get-watson-hamiltonian" />
