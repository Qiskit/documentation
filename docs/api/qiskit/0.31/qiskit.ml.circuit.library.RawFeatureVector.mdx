...
<Class id="qiskit.ml.circuit.library.RawFeatureVector" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/ml/circuit/library/raw_feature_vector.py" signature="RawFeatureVector(feature_dimension)">
  ...
  **feature\_dimension** (`Optional`\[`int`]) – The feature dimension and number of qubits.
  ...
  <Function id="qiskit.ml.circuit.library.RawFeatureVector.add_bits" name="add_bits" signature="RawFeatureVector.add_bits(bits)">
    Add Bits to the circuit.
  </Function>

  ### add\_calibration

  <Function id="qiskit.ml.circuit.library.RawFeatureVector.add_calibration" name="add_calibration" signature="RawFeatureVector.add_calibration(gate, qubits, schedule, params=None)">
  ...
  <Function id="qiskit.ml.circuit.library.RawFeatureVector.add_register" name="add_register" signature="RawFeatureVector.add_register(*regs)">
    Add registers.
  </Function>

  ### append

  <Function id="qiskit.ml.circuit.library.RawFeatureVector.append" name="append" signature="RawFeatureVector.append(instruction, qargs=None, cargs=None)">
  ...
  <Function id="qiskit.ml.circuit.library.RawFeatureVector.assign_parameters" name="assign_parameters" signature="RawFeatureVector.assign_parameters(parameters, inplace=False)">
    Call the initialize instruction.
  </Function>

  ### barrier

  <Function id="qiskit.ml.circuit.library.RawFeatureVector.barrier" name="barrier" signature="RawFeatureVector.barrier(*qargs)">
    Apply `Barrier`. If qargs is None, applies to all.
  </Function>

  ### bind\_parameters

  <Function id="qiskit.ml.circuit.library.RawFeatureVector.bind_parameters" name="bind_parameters" signature="RawFeatureVector.bind_parameters(values)">
    Bind parameters.
  </Function>

  ### cast

  <Function id="qiskit.ml.circuit.library.RawFeatureVector.cast" name="cast" signature="static RawFeatureVector.cast(value, _type)">
    Best effort to cast value to type. Otherwise, returns the value.
  </Function>

  ### cbit\_argument\_conversion

  <Function id="qiskit.ml.circuit.library.RawFeatureVector.cbit_argument_conversion" name="cbit_argument_conversion" signature="RawFeatureVector.cbit_argument_conversion(clbit_representation)">
  ...
  <Function id="qiskit.ml.circuit.library.RawFeatureVector.ccx" name="ccx" signature="RawFeatureVector.ccx(control_qubit1, control_qubit2, target_qubit, ctrl_state=None)">
    Apply [`CCXGate`](qiskit.circuit.library.CCXGate "qiskit.circuit.library.CCXGate").
  </Function>

  ### ch

  <Function id="qiskit.ml.circuit.library.RawFeatureVector.ch" name="ch" signature="RawFeatureVector.ch(control_qubit, target_qubit, label=None, ctrl_state=None)">
    Apply [`CHGate`](qiskit.circuit.library.CHGate "qiskit.circuit.library.CHGate").
  </Function>

  ### cls\_instances

  <Function id="qiskit.ml.circuit.library.RawFeatureVector.cls_instances" name="cls_instances" signature="classmethod RawFeatureVector.cls_instances()">
    Return the current number of instances of this class, useful for auto naming.
  </Function>

  ### cls\_prefix

  <Function id="qiskit.ml.circuit.library.RawFeatureVector.cls_prefix" name="cls_prefix" signature="classmethod RawFeatureVector.cls_prefix()">
    Return the prefix to use for auto naming.
  </Function>

  ### cnot

  <Function id="qiskit.ml.circuit.library.RawFeatureVector.cnot" name="cnot" signature="RawFeatureVector.cnot(control_qubit, target_qubit, label=None, ctrl_state=None)">
    Apply [`CXGate`](qiskit.circuit.library.CXGate "qiskit.circuit.library.CXGate").
  </Function>

  ### combine

  <Function id="qiskit.ml.circuit.library.RawFeatureVector.combine" name="combine" signature="RawFeatureVector.combine(rhs)">
  ...
  <Function id="qiskit.ml.circuit.library.RawFeatureVector.compose" name="compose" signature="RawFeatureVector.compose(other, qubits=None, clbits=None, front=False, inplace=False, wrap=False)">
  ...
  <Function id="qiskit.ml.circuit.library.RawFeatureVector.control" name="control" signature="RawFeatureVector.control(num_ctrl_qubits=1, label=None, ctrl_state=None)">
  ...
  <Function id="qiskit.ml.circuit.library.RawFeatureVector.copy" name="copy" signature="RawFeatureVector.copy(name=None)">
    Copy the circuit.
  ...
  <Function id="qiskit.ml.circuit.library.RawFeatureVector.count_ops" name="count_ops" signature="RawFeatureVector.count_ops()">
  ...
  <Function id="qiskit.ml.circuit.library.RawFeatureVector.cp" name="cp" signature="RawFeatureVector.cp(theta, control_qubit, target_qubit, label=None, ctrl_state=None)">
    Apply [`CPhaseGate`](qiskit.circuit.library.CPhaseGate "qiskit.circuit.library.CPhaseGate").
  </Function>

  ### crx

  <Function id="qiskit.ml.circuit.library.RawFeatureVector.crx" name="crx" signature="RawFeatureVector.crx(theta, control_qubit, target_qubit, label=None, ctrl_state=None)">
    Apply [`CRXGate`](qiskit.circuit.library.CRXGate "qiskit.circuit.library.CRXGate").
  </Function>

  ### cry

  <Function id="qiskit.ml.circuit.library.RawFeatureVector.cry" name="cry" signature="RawFeatureVector.cry(theta, control_qubit, target_qubit, label=None, ctrl_state=None)">
    Apply [`CRYGate`](qiskit.circuit.library.CRYGate "qiskit.circuit.library.CRYGate").
  </Function>

  ### crz

  <Function id="qiskit.ml.circuit.library.RawFeatureVector.crz" name="crz" signature="RawFeatureVector.crz(theta, control_qubit, target_qubit, label=None, ctrl_state=None)">
    Apply [`CRZGate`](qiskit.circuit.library.CRZGate "qiskit.circuit.library.CRZGate").
  </Function>

  ### cswap

  <Function id="qiskit.ml.circuit.library.RawFeatureVector.cswap" name="cswap" signature="RawFeatureVector.cswap(control_qubit, target_qubit1, target_qubit2, label=None, ctrl_state=None)">
    Apply [`CSwapGate`](qiskit.circuit.library.CSwapGate "qiskit.circuit.library.CSwapGate").
  </Function>

  ### csx

  <Function id="qiskit.ml.circuit.library.RawFeatureVector.csx" name="csx" signature="RawFeatureVector.csx(control_qubit, target_qubit, label=None, ctrl_state=None)">
    Apply [`CSXGate`](qiskit.circuit.library.CSXGate "qiskit.circuit.library.CSXGate").
  </Function>

  ### cu

  <Function id="qiskit.ml.circuit.library.RawFeatureVector.cu" name="cu" signature="RawFeatureVector.cu(theta, phi, lam, gamma, control_qubit, target_qubit, label=None, ctrl_state=None)">
    Apply [`CUGate`](qiskit.circuit.library.CUGate "qiskit.circuit.library.CUGate").
  </Function>

  ### cu1

  <Function id="qiskit.ml.circuit.library.RawFeatureVector.cu1" name="cu1" signature="RawFeatureVector.cu1(theta, control_qubit, target_qubit, label=None, ctrl_state=None)">
    Apply [`CU1Gate`](qiskit.circuit.library.CU1Gate "qiskit.circuit.library.CU1Gate").
  </Function>

  ### cu3

  <Function id="qiskit.ml.circuit.library.RawFeatureVector.cu3" name="cu3" signature="RawFeatureVector.cu3(theta, phi, lam, control_qubit, target_qubit, label=None, ctrl_state=None)">
    Apply [`CU3Gate`](qiskit.circuit.library.CU3Gate "qiskit.circuit.library.CU3Gate").
  </Function>

  ### cx

  <Function id="qiskit.ml.circuit.library.RawFeatureVector.cx" name="cx" signature="RawFeatureVector.cx(control_qubit, target_qubit, label=None, ctrl_state=None)">
    Apply [`CXGate`](qiskit.circuit.library.CXGate "qiskit.circuit.library.CXGate").
  </Function>

  ### cy

  <Function id="qiskit.ml.circuit.library.RawFeatureVector.cy" name="cy" signature="RawFeatureVector.cy(control_qubit, target_qubit, label=None, ctrl_state=None)">
    Apply [`CYGate`](qiskit.circuit.library.CYGate "qiskit.circuit.library.CYGate").
  </Function>

  ### cz

  <Function id="qiskit.ml.circuit.library.RawFeatureVector.cz" name="cz" signature="RawFeatureVector.cz(control_qubit, target_qubit, label=None, ctrl_state=None)">
    Apply [`CZGate`](qiskit.circuit.library.CZGate "qiskit.circuit.library.CZGate").
  </Function>

  ### dcx

  <Function id="qiskit.ml.circuit.library.RawFeatureVector.dcx" name="dcx" signature="RawFeatureVector.dcx(qubit1, qubit2)">
    Apply [`DCXGate`](qiskit.circuit.library.DCXGate "qiskit.circuit.library.DCXGate").
  </Function>

  ### decompose

  <Function id="qiskit.ml.circuit.library.RawFeatureVector.decompose" name="decompose" signature="RawFeatureVector.decompose()">
  ...
  <Function id="qiskit.ml.circuit.library.RawFeatureVector.delay" name="delay" signature="RawFeatureVector.delay(duration, qarg=None, unit='dt')">
  ...
  <Function id="qiskit.ml.circuit.library.RawFeatureVector.depth" name="depth" signature="RawFeatureVector.depth()">
  ...
  <Function id="qiskit.ml.circuit.library.RawFeatureVector.diagonal" name="diagonal" signature="RawFeatureVector.diagonal(diag, qubit)">
  ...
  <Function id="qiskit.ml.circuit.library.RawFeatureVector.ecr" name="ecr" signature="RawFeatureVector.ecr(qubit1, qubit2)">
    Apply [`ECRGate`](qiskit.circuit.library.ECRGate "qiskit.circuit.library.ECRGate").
  </Function>

  ### extend

  <Function id="qiskit.ml.circuit.library.RawFeatureVector.extend" name="extend" signature="RawFeatureVector.extend(rhs)">
  ...
  <Function id="qiskit.ml.circuit.library.RawFeatureVector.fredkin" name="fredkin" signature="RawFeatureVector.fredkin(control_qubit, target_qubit1, target_qubit2)">
    Apply [`CSwapGate`](qiskit.circuit.library.CSwapGate "qiskit.circuit.library.CSwapGate").
  </Function>

  ### from\_qasm\_file

  <Function id="qiskit.ml.circuit.library.RawFeatureVector.from_qasm_file" name="from_qasm_file" signature="static RawFeatureVector.from_qasm_file(path)">
  ...
  <Function id="qiskit.ml.circuit.library.RawFeatureVector.from_qasm_str" name="from_qasm_str" signature="static RawFeatureVector.from_qasm_str(qasm_str)">
  ...
  <Function id="qiskit.ml.circuit.library.RawFeatureVector.get_instructions" name="get_instructions" signature="RawFeatureVector.get_instructions(name)">
  ...
  <Function id="qiskit.ml.circuit.library.RawFeatureVector.h" name="h" signature="RawFeatureVector.h(qubit)">
    Apply [`HGate`](qiskit.circuit.library.HGate "qiskit.circuit.library.HGate").
  </Function>

  ### hamiltonian

  <Function id="qiskit.ml.circuit.library.RawFeatureVector.hamiltonian" name="hamiltonian" signature="RawFeatureVector.hamiltonian(operator, time, qubits, label=None)">
    Apply hamiltonian evolution to qubits.
  </Function>

  ### has\_register

  <Function id="qiskit.ml.circuit.library.RawFeatureVector.has_register" name="has_register" signature="RawFeatureVector.has_register(register)">
  ...
  <Function id="qiskit.ml.circuit.library.RawFeatureVector.i" name="i" signature="RawFeatureVector.i(qubit)">
    Apply [`IGate`](qiskit.circuit.library.IGate "qiskit.circuit.library.IGate").
  </Function>

  ### id

  <Function id="qiskit.ml.circuit.library.RawFeatureVector.id" name="id" signature="RawFeatureVector.id(qubit)">
    Apply [`IGate`](qiskit.circuit.library.IGate "qiskit.circuit.library.IGate").
  </Function>

  ### initialize

  <Function id="qiskit.ml.circuit.library.RawFeatureVector.initialize" name="initialize" signature="RawFeatureVector.initialize(params, qubits=None)">
  ...
  <Function id="qiskit.ml.circuit.library.RawFeatureVector.inverse" name="inverse" signature="RawFeatureVector.inverse()">
  ...
  <Function id="qiskit.ml.circuit.library.RawFeatureVector.iso" name="iso" signature="RawFeatureVector.iso(isometry, q_input, q_ancillas_for_output, q_ancillas_zero=None, q_ancillas_dirty=None, epsilon=1e-10)">
  ...
  <Function id="qiskit.ml.circuit.library.RawFeatureVector.isometry" name="isometry" signature="RawFeatureVector.isometry(isometry, q_input, q_ancillas_for_output, q_ancillas_zero=None, q_ancillas_dirty=None, epsilon=1e-10)">
    Attach an arbitrary isometry from m to n qubits to a circuit. In particular, this allows to attach arbitrary unitaries on n qubits (m=n) or to prepare any state on n qubits (m=0). The decomposition used here was introduced by Iten et al. in [https://arxiv.org/abs/1501.06911](https://arxiv.org/abs/1501.06911).
  ...
  <Function id="qiskit.ml.circuit.library.RawFeatureVector.iswap" name="iswap" signature="RawFeatureVector.iswap(qubit1, qubit2)">
    Apply [`iSwapGate`](qiskit.circuit.library.iSwapGate "qiskit.circuit.library.iSwapGate").
  </Function>

  ### mcp

  <Function id="qiskit.ml.circuit.library.RawFeatureVector.mcp" name="mcp" signature="RawFeatureVector.mcp(lam, control_qubits, target_qubit)">
    Apply [`MCPhaseGate`](qiskit.circuit.library.MCPhaseGate "qiskit.circuit.library.MCPhaseGate").
  </Function>

  ### mcrx

  <Function id="qiskit.ml.circuit.library.RawFeatureVector.mcrx" name="mcrx" signature="RawFeatureVector.mcrx(theta, q_controls, q_target, use_basis_gates=False)">
  ...
  <Function id="qiskit.ml.circuit.library.RawFeatureVector.mcry" name="mcry" signature="RawFeatureVector.mcry(theta, q_controls, q_target, q_ancillae=None, mode=None, use_basis_gates=False)">
  ...
  <Function id="qiskit.ml.circuit.library.RawFeatureVector.mcrz" name="mcrz" signature="RawFeatureVector.mcrz(lam, q_controls, q_target, use_basis_gates=False)">
  ...
  <Function id="qiskit.ml.circuit.library.RawFeatureVector.mct" name="mct" signature="RawFeatureVector.mct(control_qubits, target_qubit, ancilla_qubits=None, mode='noancilla')">
    Apply [`MCXGate`](qiskit.circuit.library.MCXGate "qiskit.circuit.library.MCXGate").
  </Function>

  ### mcu1

  <Function id="qiskit.ml.circuit.library.RawFeatureVector.mcu1" name="mcu1" signature="RawFeatureVector.mcu1(lam, control_qubits, target_qubit)">
    Apply `MCU1Gate`.
  </Function>

  ### mcx

  <Function id="qiskit.ml.circuit.library.RawFeatureVector.mcx" name="mcx" signature="RawFeatureVector.mcx(control_qubits, target_qubit, ancilla_qubits=None, mode='noancilla')">
    Apply [`MCXGate`](qiskit.circuit.library.MCXGate "qiskit.circuit.library.MCXGate").
  ...
  <Function id="qiskit.ml.circuit.library.RawFeatureVector.measure" name="measure" signature="RawFeatureVector.measure(qubit, cbit)">
  ...
  <Function id="qiskit.ml.circuit.library.RawFeatureVector.measure_active" name="measure_active" signature="RawFeatureVector.measure_active(inplace=True)">
  ...
  <Function id="qiskit.ml.circuit.library.RawFeatureVector.measure_all" name="measure_all" signature="RawFeatureVector.measure_all(inplace=True)">
  ...
  <Function id="qiskit.ml.circuit.library.RawFeatureVector.ms" name="ms" signature="RawFeatureVector.ms(theta, qubits)">
    Apply [`MSGate`](qiskit.circuit.library.MSGate "qiskit.circuit.library.MSGate").
  </Function>

  ### num\_connected\_components

  <Function id="qiskit.ml.circuit.library.RawFeatureVector.num_connected_components" name="num_connected_components" signature="RawFeatureVector.num_connected_components(unitary_only=False)">
  ...
  <Function id="qiskit.ml.circuit.library.RawFeatureVector.num_nonlocal_gates" name="num_nonlocal_gates" signature="RawFeatureVector.num_nonlocal_gates()">
  ...
  <Function id="qiskit.ml.circuit.library.RawFeatureVector.num_tensor_factors" name="num_tensor_factors" signature="RawFeatureVector.num_tensor_factors()">
  ...
  <Function id="qiskit.ml.circuit.library.RawFeatureVector.num_unitary_factors" name="num_unitary_factors" signature="RawFeatureVector.num_unitary_factors()">
    Computes the number of tensor factors in the unitary (quantum) part of the circuit only.
  </Function>

  ### p

  <Function id="qiskit.ml.circuit.library.RawFeatureVector.p" name="p" signature="RawFeatureVector.p(theta, qubit)">
    Apply [`PhaseGate`](qiskit.circuit.library.PhaseGate "qiskit.circuit.library.PhaseGate").
  </Function>

  ### pauli

  <Function id="qiskit.ml.circuit.library.RawFeatureVector.pauli" name="pauli" signature="RawFeatureVector.pauli(pauli_string, qubits)">
    Apply [`PauliGate`](qiskit.circuit.library.PauliGate "qiskit.circuit.library.PauliGate").
  </Function>

  ### power

  <Function id="qiskit.ml.circuit.library.RawFeatureVector.power" name="power" signature="RawFeatureVector.power(power, matrix_power=False)">
  ...
  <Function id="qiskit.ml.circuit.library.RawFeatureVector.qasm" name="qasm" signature="RawFeatureVector.qasm(formatted=False, filename=None, encoding=None)">
  ...
  <Function id="qiskit.ml.circuit.library.RawFeatureVector.qbit_argument_conversion" name="qbit_argument_conversion" signature="RawFeatureVector.qbit_argument_conversion(qubit_representation)">
  ...
  <Function id="qiskit.ml.circuit.library.RawFeatureVector.qubit_duration" name="qubit_duration" signature="RawFeatureVector.qubit_duration(*qubits)">
  ...
  <Function id="qiskit.ml.circuit.library.RawFeatureVector.qubit_start_time" name="qubit_start_time" signature="RawFeatureVector.qubit_start_time(*qubits)">
  ...
  <Function id="qiskit.ml.circuit.library.RawFeatureVector.qubit_stop_time" name="qubit_stop_time" signature="RawFeatureVector.qubit_stop_time(*qubits)">
  ...
  <Function id="qiskit.ml.circuit.library.RawFeatureVector.r" name="r" signature="RawFeatureVector.r(theta, phi, qubit)">
    Apply [`RGate`](qiskit.circuit.library.RGate "qiskit.circuit.library.RGate").
  </Function>

  ### rcccx

  <Function id="qiskit.ml.circuit.library.RawFeatureVector.rcccx" name="rcccx" signature="RawFeatureVector.rcccx(control_qubit1, control_qubit2, control_qubit3, target_qubit)">
    Apply [`RC3XGate`](qiskit.circuit.library.RC3XGate "qiskit.circuit.library.RC3XGate").
  </Function>

  ### rccx

  <Function id="qiskit.ml.circuit.library.RawFeatureVector.rccx" name="rccx" signature="RawFeatureVector.rccx(control_qubit1, control_qubit2, target_qubit)">
    Apply [`RCCXGate`](qiskit.circuit.library.RCCXGate "qiskit.circuit.library.RCCXGate").
  </Function>

  ### remove\_final\_measurements

  <Function id="qiskit.ml.circuit.library.RawFeatureVector.remove_final_measurements" name="remove_final_measurements" signature="RawFeatureVector.remove_final_measurements(inplace=True)">
  ...
  <Function id="qiskit.ml.circuit.library.RawFeatureVector.repeat" name="repeat" signature="RawFeatureVector.repeat(reps)">
  ...
  <Function id="qiskit.ml.circuit.library.RawFeatureVector.reset" name="reset" signature="RawFeatureVector.reset(qubit)">
    Reset q.
  </Function>

  ### reverse\_bits

  <Function id="qiskit.ml.circuit.library.RawFeatureVector.reverse_bits" name="reverse_bits" signature="RawFeatureVector.reverse_bits()">
  ...
  <Function id="qiskit.ml.circuit.library.RawFeatureVector.reverse_ops" name="reverse_ops" signature="RawFeatureVector.reverse_ops()">
  ...
  <Function id="qiskit.ml.circuit.library.RawFeatureVector.rv" name="rv" signature="RawFeatureVector.rv(vx, vy, vz, qubit)">
    Apply [`RVGate`](qiskit.circuit.library.RVGate "qiskit.circuit.library.RVGate").
  </Function>

  ### rx

  <Function id="qiskit.ml.circuit.library.RawFeatureVector.rx" name="rx" signature="RawFeatureVector.rx(theta, qubit, label=None)">
    Apply [`RXGate`](qiskit.circuit.library.RXGate "qiskit.circuit.library.RXGate").
  </Function>

  ### rxx

  <Function id="qiskit.ml.circuit.library.RawFeatureVector.rxx" name="rxx" signature="RawFeatureVector.rxx(theta, qubit1, qubit2)">
    Apply [`RXXGate`](qiskit.circuit.library.RXXGate "qiskit.circuit.library.RXXGate").
  </Function>

  ### ry

  <Function id="qiskit.ml.circuit.library.RawFeatureVector.ry" name="ry" signature="RawFeatureVector.ry(theta, qubit, label=None)">
    Apply [`RYGate`](qiskit.circuit.library.RYGate "qiskit.circuit.library.RYGate").
  </Function>

  ### ryy

  <Function id="qiskit.ml.circuit.library.RawFeatureVector.ryy" name="ryy" signature="RawFeatureVector.ryy(theta, qubit1, qubit2)">
    Apply [`RYYGate`](qiskit.circuit.library.RYYGate "qiskit.circuit.library.RYYGate").
  </Function>

  ### rz

  <Function id="qiskit.ml.circuit.library.RawFeatureVector.rz" name="rz" signature="RawFeatureVector.rz(phi, qubit)">
    Apply [`RZGate`](qiskit.circuit.library.RZGate "qiskit.circuit.library.RZGate").
  </Function>

  ### rzx

  <Function id="qiskit.ml.circuit.library.RawFeatureVector.rzx" name="rzx" signature="RawFeatureVector.rzx(theta, qubit1, qubit2)">
    Apply [`RZXGate`](qiskit.circuit.library.RZXGate "qiskit.circuit.library.RZXGate").
  </Function>

  ### rzz

  <Function id="qiskit.ml.circuit.library.RawFeatureVector.rzz" name="rzz" signature="RawFeatureVector.rzz(theta, qubit1, qubit2)">
    Apply [`RZZGate`](qiskit.circuit.library.RZZGate "qiskit.circuit.library.RZZGate").
  </Function>

  ### s

  <Function id="qiskit.ml.circuit.library.RawFeatureVector.s" name="s" signature="RawFeatureVector.s(qubit)">
    Apply [`SGate`](qiskit.circuit.library.SGate "qiskit.circuit.library.SGate").
  </Function>

  ### save\_amplitudes

  <Function id="qiskit.ml.circuit.library.RawFeatureVector.save_amplitudes" name="save_amplitudes" signature="RawFeatureVector.save_amplitudes(params, label='amplitudes', pershot=False, conditional=False)">
  ...
  <Function id="qiskit.ml.circuit.library.RawFeatureVector.save_amplitudes_squared" name="save_amplitudes_squared" signature="RawFeatureVector.save_amplitudes_squared(params, label='amplitudes_squared', unnormalized=False, pershot=False, conditional=False)">
  ...
  <Function id="qiskit.ml.circuit.library.RawFeatureVector.save_density_matrix" name="save_density_matrix" signature="RawFeatureVector.save_density_matrix(qubits=None, label='density_matrix', unnormalized=False, pershot=False, conditional=False)">
  ...
  <Function id="qiskit.ml.circuit.library.RawFeatureVector.save_expectation_value" name="save_expectation_value" signature="RawFeatureVector.save_expectation_value(operator, qubits, label='expectation_value', unnormalized=False, pershot=False, conditional=False)">
  ...
  <Function id="qiskit.ml.circuit.library.RawFeatureVector.save_expectation_value_variance" name="save_expectation_value_variance" signature="RawFeatureVector.save_expectation_value_variance(operator, qubits, label='expectation_value_variance', unnormalized=False, pershot=False, conditional=False)">
    Save the expectation value of a Hermitian operator.
  ...
  <Function id="qiskit.ml.circuit.library.RawFeatureVector.save_matrix_product_state" name="save_matrix_product_state" signature="RawFeatureVector.save_matrix_product_state(label='matrix_product_state', pershot=False, conditional=False)">
  ...
  <Function id="qiskit.ml.circuit.library.RawFeatureVector.save_probabilities" name="save_probabilities" signature="RawFeatureVector.save_probabilities(qubits=None, label='probabilities', unnormalized=False, pershot=False, conditional=False)">
  ...
  <Function id="qiskit.ml.circuit.library.RawFeatureVector.save_probabilities_dict" name="save_probabilities_dict" signature="RawFeatureVector.save_probabilities_dict(qubits=None, label='probabilities', unnormalized=False, pershot=False, conditional=False)">
    Save measurement outcome probabilities vector.
  ...
  <Function id="qiskit.ml.circuit.library.RawFeatureVector.save_stabilizer" name="save_stabilizer" signature="RawFeatureVector.save_stabilizer(label='stabilizer', pershot=False, conditional=False)">
  ...
  <Function id="qiskit.ml.circuit.library.RawFeatureVector.save_state" name="save_state" signature="RawFeatureVector.save_state(label=None, pershot=False, conditional=False)">
  ...
  <Function id="qiskit.ml.circuit.library.RawFeatureVector.save_statevector" name="save_statevector" signature="RawFeatureVector.save_statevector(label='statevector', pershot=False, conditional=False)">
  ...
  <Function id="qiskit.ml.circuit.library.RawFeatureVector.save_statevector_dict" name="save_statevector_dict" signature="RawFeatureVector.save_statevector_dict(label='statevector', pershot=False, conditional=False)">
  ...
  <Function id="qiskit.ml.circuit.library.RawFeatureVector.save_superop" name="save_superop" signature="RawFeatureVector.save_superop(label='superop', pershot=False)">
  ...
  <Function id="qiskit.ml.circuit.library.RawFeatureVector.save_unitary" name="save_unitary" signature="RawFeatureVector.save_unitary(label='unitary', pershot=False)">
  ...
  <Function id="qiskit.ml.circuit.library.RawFeatureVector.sdg" name="sdg" signature="RawFeatureVector.sdg(qubit)">
    Apply [`SdgGate`](qiskit.circuit.library.SdgGate "qiskit.circuit.library.SdgGate").
  </Function>

  ### set\_density\_matrix

  <Function id="qiskit.ml.circuit.library.RawFeatureVector.set_density_matrix" name="set_density_matrix" signature="RawFeatureVector.set_density_matrix(state)">
  ...
  <Function id="qiskit.ml.circuit.library.RawFeatureVector.set_matrix_product_state" name="set_matrix_product_state" signature="RawFeatureVector.set_matrix_product_state(state)">
  ...
  <Function id="qiskit.ml.circuit.library.RawFeatureVector.set_stabilizer" name="set_stabilizer" signature="RawFeatureVector.set_stabilizer(state)">
  ...
  <Function id="qiskit.ml.circuit.library.RawFeatureVector.set_statevector" name="set_statevector" signature="RawFeatureVector.set_statevector(state)">
  ...
  <Function id="qiskit.ml.circuit.library.RawFeatureVector.set_superop" name="set_superop" signature="RawFeatureVector.set_superop(state)">
  ...
  <Function id="qiskit.ml.circuit.library.RawFeatureVector.set_unitary" name="set_unitary" signature="RawFeatureVector.set_unitary(state)">
  ...
  <Function id="qiskit.ml.circuit.library.RawFeatureVector.size" name="size" signature="RawFeatureVector.size()">
  ...
  <Function id="qiskit.ml.circuit.library.RawFeatureVector.snapshot" name="snapshot" signature="RawFeatureVector.snapshot(label, snapshot_type='statevector', qubits=None, params=None)">
  ...
  <Function id="qiskit.ml.circuit.library.RawFeatureVector.snapshot_density_matrix" name="snapshot_density_matrix" signature="RawFeatureVector.snapshot_density_matrix(label, qubits=None)">
  ...
  <Function id="qiskit.ml.circuit.library.RawFeatureVector.snapshot_expectation_value" name="snapshot_expectation_value" signature="RawFeatureVector.snapshot_expectation_value(label, op, qubits, single_shot=False, variance=False)">
  ...
  <Function id="qiskit.ml.circuit.library.RawFeatureVector.snapshot_probabilities" name="snapshot_probabilities" signature="RawFeatureVector.snapshot_probabilities(label, qubits, variance=False)">
  ...
  <Function id="qiskit.ml.circuit.library.RawFeatureVector.snapshot_stabilizer" name="snapshot_stabilizer" signature="RawFeatureVector.snapshot_stabilizer(label)">
  ...
  <Function id="qiskit.ml.circuit.library.RawFeatureVector.snapshot_statevector" name="snapshot_statevector" signature="RawFeatureVector.snapshot_statevector(label)">
  ...
  <Function id="qiskit.ml.circuit.library.RawFeatureVector.squ" name="squ" signature="RawFeatureVector.squ(unitary_matrix, qubit, mode='ZYZ', up_to_diagonal=False, *, u=None)">
  ...
  <Function id="qiskit.ml.circuit.library.RawFeatureVector.swap" name="swap" signature="RawFeatureVector.swap(qubit1, qubit2)">
    Apply [`SwapGate`](qiskit.circuit.library.SwapGate "qiskit.circuit.library.SwapGate").
  </Function>

  ### sx

  <Function id="qiskit.ml.circuit.library.RawFeatureVector.sx" name="sx" signature="RawFeatureVector.sx(qubit)">
    Apply [`SXGate`](qiskit.circuit.library.SXGate "qiskit.circuit.library.SXGate").
  </Function>

  ### sxdg

  <Function id="qiskit.ml.circuit.library.RawFeatureVector.sxdg" name="sxdg" signature="RawFeatureVector.sxdg(qubit)">
    Apply [`SXdgGate`](qiskit.circuit.library.SXdgGate "qiskit.circuit.library.SXdgGate").
  </Function>

  ### t

  <Function id="qiskit.ml.circuit.library.RawFeatureVector.t" name="t" signature="RawFeatureVector.t(qubit)">
    Apply [`TGate`](qiskit.circuit.library.TGate "qiskit.circuit.library.TGate").
  </Function>

  ### tdg

  <Function id="qiskit.ml.circuit.library.RawFeatureVector.tdg" name="tdg" signature="RawFeatureVector.tdg(qubit)">
    Apply [`TdgGate`](qiskit.circuit.library.TdgGate "qiskit.circuit.library.TdgGate").
  </Function>

  ### tensor

  <Function id="qiskit.ml.circuit.library.RawFeatureVector.tensor" name="tensor" signature="RawFeatureVector.tensor(other, inplace=False)">
  ...
  <Function id="qiskit.ml.circuit.library.RawFeatureVector.to_gate" name="to_gate" signature="RawFeatureVector.to_gate(parameter_map=None, label=None)">
  ...
  <Function id="qiskit.ml.circuit.library.RawFeatureVector.to_instruction" name="to_instruction" signature="RawFeatureVector.to_instruction(parameter_map=None, label=None)">
  ...
  <Function id="qiskit.ml.circuit.library.RawFeatureVector.toffoli" name="toffoli" signature="RawFeatureVector.toffoli(control_qubit1, control_qubit2, target_qubit)">
    Apply [`CCXGate`](qiskit.circuit.library.CCXGate "qiskit.circuit.library.CCXGate").
  </Function>

  ### u

  <Function id="qiskit.ml.circuit.library.RawFeatureVector.u" name="u" signature="RawFeatureVector.u(theta, phi, lam, qubit)">
    Apply [`UGate`](qiskit.circuit.library.UGate "qiskit.circuit.library.UGate").
  </Function>

  ### u1

  <Function id="qiskit.ml.circuit.library.RawFeatureVector.u1" name="u1" signature="RawFeatureVector.u1(theta, qubit)">
    Apply [`U1Gate`](qiskit.circuit.library.U1Gate "qiskit.circuit.library.U1Gate").
  </Function>

  ### u2

  <Function id="qiskit.ml.circuit.library.RawFeatureVector.u2" name="u2" signature="RawFeatureVector.u2(phi, lam, qubit)">
    Apply [`U2Gate`](qiskit.circuit.library.U2Gate "qiskit.circuit.library.U2Gate").
  </Function>

  ### u3

  <Function id="qiskit.ml.circuit.library.RawFeatureVector.u3" name="u3" signature="RawFeatureVector.u3(theta, phi, lam, qubit)">
    Apply [`U3Gate`](qiskit.circuit.library.U3Gate "qiskit.circuit.library.U3Gate").
  </Function>

  ### uc

  <Function id="qiskit.ml.circuit.library.RawFeatureVector.uc" name="uc" signature="RawFeatureVector.uc(gate_list, q_controls, q_target, up_to_diagonal=False)">
  ...
  <Function id="qiskit.ml.circuit.library.RawFeatureVector.ucrx" name="ucrx" signature="RawFeatureVector.ucrx(angle_list, q_controls, q_target)">
  ...
  <Function id="qiskit.ml.circuit.library.RawFeatureVector.ucry" name="ucry" signature="RawFeatureVector.ucry(angle_list, q_controls, q_target)">
  ...
  <Function id="qiskit.ml.circuit.library.RawFeatureVector.ucrz" name="ucrz" signature="RawFeatureVector.ucrz(angle_list, q_controls, q_target)">
  ...
  <Function id="qiskit.ml.circuit.library.RawFeatureVector.unitary" name="unitary" signature="RawFeatureVector.unitary(obj, qubits, label=None)">
    Apply unitary gate to q.
  </Function>

  ### width

  <Function id="qiskit.ml.circuit.library.RawFeatureVector.width" name="width" signature="RawFeatureVector.width()">
  ...
  <Function id="qiskit.ml.circuit.library.RawFeatureVector.x" name="x" signature="RawFeatureVector.x(qubit, label=None)">
    Apply [`XGate`](qiskit.circuit.library.XGate "qiskit.circuit.library.XGate").
  </Function>

  ### y

  <Function id="qiskit.ml.circuit.library.RawFeatureVector.y" name="y" signature="RawFeatureVector.y(qubit)">
    Apply [`YGate`](qiskit.circuit.library.YGate "qiskit.circuit.library.YGate").
  </Function>

  ### z

  <Function id="qiskit.ml.circuit.library.RawFeatureVector.z" name="z" signature="RawFeatureVector.z(qubit)">
  ...
  <Attribute id="qiskit.ml.circuit.library.RawFeatureVector.ancillas" name="ancillas">
    Returns a list of ancilla bits in the order that the registers were added.
  </Attribute>

  ### calibrations

  <Attribute id="qiskit.ml.circuit.library.RawFeatureVector.calibrations" name="calibrations">
  ...
  <Attribute id="qiskit.ml.circuit.library.RawFeatureVector.clbits" name="clbits">
    Returns a list of classical bits in the order that the registers were added.
  </Attribute>

  ### data

  <Attribute id="qiskit.ml.circuit.library.RawFeatureVector.data" name="data" />

  ### extension\_lib

  <Attribute id="qiskit.ml.circuit.library.RawFeatureVector.extension_lib" name="extension_lib" attributeValue="'include &#x22;qelib1.inc&#x22;;'" />

  ### feature\_dimension

  <Attribute id="qiskit.ml.circuit.library.RawFeatureVector.feature_dimension" name="feature_dimension">
  ...
  <Attribute id="qiskit.ml.circuit.library.RawFeatureVector.global_phase" name="global_phase">
    Return the global phase of the circuit in radians.
  </Attribute>

  ### header

  <Attribute id="qiskit.ml.circuit.library.RawFeatureVector.header" name="header" attributeValue="'OPENQASM 2.0;'" />

  ### instances

  <Attribute id="qiskit.ml.circuit.library.RawFeatureVector.instances" name="instances" attributeValue="16" />

  ### metadata

  <Attribute id="qiskit.ml.circuit.library.RawFeatureVector.metadata" name="metadata">
  ...
  <Attribute id="qiskit.ml.circuit.library.RawFeatureVector.num_ancillas" name="num_ancillas">
    Return the number of ancilla qubits.
  </Attribute>

  ### num\_clbits

  <Attribute id="qiskit.ml.circuit.library.RawFeatureVector.num_clbits" name="num_clbits">
    Return number of classical bits.
  </Attribute>

  ### num\_parameters

  <Attribute id="qiskit.ml.circuit.library.RawFeatureVector.num_parameters" name="num_parameters">
    **Return type**
  ...
  <Attribute id="qiskit.ml.circuit.library.RawFeatureVector.num_qubits" name="num_qubits">
  ...
  <Attribute id="qiskit.ml.circuit.library.RawFeatureVector.ordered_parameters" name="ordered_parameters">
  ...
  <Attribute id="qiskit.ml.circuit.library.RawFeatureVector.parameters" name="parameters">
    Return the free parameters in the RawFeatureVector.
  ...
  <Attribute id="qiskit.ml.circuit.library.RawFeatureVector.prefix" name="prefix" attributeValue="'circuit'" />

  ### qregs

  <Attribute id="qiskit.ml.circuit.library.RawFeatureVector.qregs" name="qregs">
    A list of the quantum registers associated with the circuit.
  </Attribute>

  ### qubits

  <Attribute id="qiskit.ml.circuit.library.RawFeatureVector.qubits" name="qubits">
