---
title: OneAgainstRest (v0.31)
description: API reference for qiskit.aqua.components.multiclass_extensions.OneAgainstRest in qiskit v0.31
...
<Class id="qiskit.aqua.components.multiclass_extensions.OneAgainstRest" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/aqua/components/multiclass_extensions/one_against_rest.py" signature="OneAgainstRest" modifiers="class">
  ...
  <span id="qiskit-aqua-components-multiclass-extensions-oneagainstrest-predict" />
  ...
  <span id="qiskit-aqua-components-multiclass-extensions-oneagainstrest-set-estimator" />
  ...
  <span id="qiskit-aqua-components-multiclass-extensions-oneagainstrest-test" />
  ...
  <span id="qiskit-aqua-components-multiclass-extensions-oneagainstrest-train" />
