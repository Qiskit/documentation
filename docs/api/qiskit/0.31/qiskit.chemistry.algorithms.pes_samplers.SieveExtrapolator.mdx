...
<Class id="qiskit.chemistry.algorithms.pes_samplers.SieveExtrapolator" github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/chemistry/algorithms/pes_samplers/extrapolator.py" signature="SieveExtrapolator(extrapolator=None, window=2, filter_before=True, filter_after=True)">
  ...
  *   **filter\_after** (`bool`) – Keyword to perform clustering after extrapolation.
  ...
  <Function id="qiskit.chemistry.algorithms.pes_samplers.SieveExtrapolator.extrapolate" name="extrapolate" signature="SieveExtrapolator.extrapolate(points, param_dict)">
  ...
  <Function id="qiskit.chemistry.algorithms.pes_samplers.SieveExtrapolator.factory" name="factory" signature="static SieveExtrapolator.factory(mode, **kwargs)">
