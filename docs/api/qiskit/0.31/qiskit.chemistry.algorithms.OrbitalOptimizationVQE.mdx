...
<Class id="qiskit.chemistry.algorithms.OrbitalOptimizationVQE" github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/chemistry/algorithms/ground_state_solvers/orbital_optimization_vqe.py" signature="OrbitalOptimizationVQE(transformation, solver, initial_point=None, orbital_rotation=None, bounds=None, iterative_oo=True, iterative_oo_iterations=2)">
  ...
  **Raises**
  ...
  <Function id="qiskit.chemistry.algorithms.OrbitalOptimizationVQE.evaluate_operators" name="evaluate_operators" signature="OrbitalOptimizationVQE.evaluate_operators(state, operators)">
  ...
  <Function id="qiskit.chemistry.algorithms.OrbitalOptimizationVQE.returns_groundstate" name="returns_groundstate" signature="OrbitalOptimizationVQE.returns_groundstate()">
  ...
  <Function id="qiskit.chemistry.algorithms.OrbitalOptimizationVQE.solve" name="solve" signature="OrbitalOptimizationVQE.solve(driver, aux_operators=None)">
  ...
  <Attribute id="qiskit.chemistry.algorithms.OrbitalOptimizationVQE.solver" name="solver">
  ...
  <Attribute id="qiskit.chemistry.algorithms.OrbitalOptimizationVQE.transformation" name="transformation">
