---
title: RZXCalibrationBuilder (v0.31)
description: API reference for qiskit.transpiler.passes.RZXCalibrationBuilder in qiskit v0.31
...
<Class id="qiskit.transpiler.passes.RZXCalibrationBuilder" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/transpiler/passes/scheduling/calibration_creators.py" signature="RZXCalibrationBuilder(backend)" modifiers="class">
