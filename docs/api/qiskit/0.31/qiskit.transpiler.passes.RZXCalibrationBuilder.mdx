...
<Class id="qiskit.transpiler.passes.RZXCalibrationBuilder" github="https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/transpiler/passes/scheduling/calibration_creators.py" signature="RZXCalibrationBuilder(backend)">
  ...
  **QiskitError** – if open pulse is not supported by the backend.
  ...
  <Function id="qiskit.transpiler.passes.RZXCalibrationBuilder.get_calibration" name="get_calibration" signature="RZXCalibrationBuilder.get_calibration(params, qubits)">
    **Parameters**
  ...
  <Function id="qiskit.transpiler.passes.RZXCalibrationBuilder.supported" name="supported" signature="RZXCalibrationBuilder.supported(node_op)">
    **Parameters**
