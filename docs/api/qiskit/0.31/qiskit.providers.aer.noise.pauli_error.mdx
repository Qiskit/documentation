...
<Function id="qiskit.providers.aer.noise.pauli_error" github="https://github.com/qiskit/qiskit-aer/tree/stable/0.9/qiskit/providers/aer/noise/errors/standard_errors.py" signature="pauli_error(noise_ops, standard_gates=True)">
