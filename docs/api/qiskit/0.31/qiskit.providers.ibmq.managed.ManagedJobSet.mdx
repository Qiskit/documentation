---
title: ManagedJobSet (v0.31)
description: API reference for qiskit.providers.ibmq.managed.ManagedJobSet in qiskit v0.31
...
<Class id="qiskit.providers.ibmq.managed.ManagedJobSet" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-ibmq-provider/tree/stable/0.17/qiskit/providers/ibmq/managed/managedjobset.py" signature="ManagedJobSet(name=None, short_id=None)" modifiers="class">
  Bases: `object`
