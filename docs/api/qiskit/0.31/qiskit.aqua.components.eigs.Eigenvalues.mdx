---
title: Eigenvalues (v0.31)
description: API reference for qiskit.aqua.components.eigs.Eigenvalues in qiskit v0.31
...
<Class id="qiskit.aqua.components.eigs.Eigenvalues" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/aqua/components/eigs/eigs.py" signature="Eigenvalues" modifiers="class">
  ...
  <span id="qiskit-aqua-components-eigs-eigenvalues-construct-circuit" />
  ...
  <span id="qiskit-aqua-components-eigs-eigenvalues-construct-inverse" />
  ...
  <span id="qiskit-aqua-components-eigs-eigenvalues-get-register-sizes" />
  ...
  <span id="qiskit-aqua-components-eigs-eigenvalues-get-scaling" />
