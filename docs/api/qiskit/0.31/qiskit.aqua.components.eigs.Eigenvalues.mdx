...
<Class id="qiskit.aqua.components.eigs.Eigenvalues" github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/aqua/components/eigs/eigs.py" signature="Eigenvalues">
  Bases: `abc.ABC`
