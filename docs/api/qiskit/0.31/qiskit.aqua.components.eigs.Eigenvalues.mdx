...
<Class id="qiskit.aqua.components.eigs.Eigenvalues" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/aqua/components/eigs/eigs.py" signature="Eigenvalues">
  ...
  <Function id="qiskit.aqua.components.eigs.Eigenvalues.construct_circuit" signature="abstract Eigenvalues.construct_circuit(mode, register=None)">
  ...
  <Function id="qiskit.aqua.components.eigs.Eigenvalues.get_register_sizes" signature="abstract Eigenvalues.get_register_sizes()">
    get register sizes
  </Function>

  ### get\_scaling

  <Function id="qiskit.aqua.components.eigs.Eigenvalues.get_scaling" signature="abstract Eigenvalues.get_scaling()">
    get scaling
  </Function>
</Class>
