...
<Class id="qiskit.ignis.mitigation.CTMPExpvalMeasMitigator" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-ignis/tree/stable/0.6/qiskit/ignis/mitigation/expval/ctmp_mitigator.py" signature="CTMPExpvalMeasMitigator(generators, rates, num_qubits=None, seed=None)">
  ...
  <Function id="qiskit.ignis.mitigation.CTMPExpvalMeasMitigator.assignment_fidelity" name="assignment_fidelity" signature="CTMPExpvalMeasMitigator.assignment_fidelity(qubits=None)">
  ...
  <Function id="qiskit.ignis.mitigation.CTMPExpvalMeasMitigator.assignment_matrix" name="assignment_matrix" signature="CTMPExpvalMeasMitigator.assignment_matrix(qubits=None)">
  ...
  <Function id="qiskit.ignis.mitigation.CTMPExpvalMeasMitigator.expectation_value" name="expectation_value" signature="CTMPExpvalMeasMitigator.expectation_value(counts, diagonal=None, qubits=None, clbits=None)">
  ...
  <Function id="qiskit.ignis.mitigation.CTMPExpvalMeasMitigator.generator_matrix" name="generator_matrix" signature="CTMPExpvalMeasMitigator.generator_matrix(qubits=None)">
  ...
  <Function id="qiskit.ignis.mitigation.CTMPExpvalMeasMitigator.mitigation_matrix" name="mitigation_matrix" signature="CTMPExpvalMeasMitigator.mitigation_matrix(qubits=None)">
  ...
  <Function id="qiskit.ignis.mitigation.CTMPExpvalMeasMitigator.mitigation_overhead" name="mitigation_overhead" signature="CTMPExpvalMeasMitigator.mitigation_overhead(qubits=None)">
  ...
  <Function id="qiskit.ignis.mitigation.CTMPExpvalMeasMitigator.noise_strength" name="noise_strength" signature="CTMPExpvalMeasMitigator.noise_strength(qubits=None)">
  ...
  <Function id="qiskit.ignis.mitigation.CTMPExpvalMeasMitigator.plot_assignment_matrix" name="plot_assignment_matrix" signature="CTMPExpvalMeasMitigator.plot_assignment_matrix(qubits=None, ax=None)">
  ...
  <Function id="qiskit.ignis.mitigation.CTMPExpvalMeasMitigator.plot_mitigation_matrix" name="plot_mitigation_matrix" signature="CTMPExpvalMeasMitigator.plot_mitigation_matrix(qubits=None, ax=None)">
  ...
  <Function id="qiskit.ignis.mitigation.CTMPExpvalMeasMitigator.required_shots" name="required_shots" signature="CTMPExpvalMeasMitigator.required_shots(delta, qubits=None)">
  ...
  <Function id="qiskit.ignis.mitigation.CTMPExpvalMeasMitigator.seed" name="seed" signature="CTMPExpvalMeasMitigator.seed(value=None)">
    Set the seed for the quantum state RNG.
  </Function>

  ### stddev\_upper\_bound

  <Function id="qiskit.ignis.mitigation.CTMPExpvalMeasMitigator.stddev_upper_bound" name="stddev_upper_bound" signature="CTMPExpvalMeasMitigator.stddev_upper_bound(shots=1, qubits=None)">
