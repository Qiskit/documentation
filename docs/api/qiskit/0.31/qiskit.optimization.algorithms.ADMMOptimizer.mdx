...
<Class id="qiskit.optimization.algorithms.ADMMOptimizer" github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/optimization/algorithms/admm_optimizer.py" signature="ADMMOptimizer(qubo_optimizer=None, continuous_optimizer=None, params=None)">
  ...
  *   **params** (`Optional`\[`ADMMParameters`]) – An instance of ADMMParameters.
  ...
  <Function id="qiskit.optimization.algorithms.ADMMOptimizer.get_compatibility_msg" name="get_compatibility_msg" signature="ADMMOptimizer.get_compatibility_msg(problem)">
  ...
  <Function id="qiskit.optimization.algorithms.ADMMOptimizer.is_compatible" name="is_compatible" signature="ADMMOptimizer.is_compatible(problem)">
    Checks whether a given problem can be solved with the optimizer implementing this method.
  ...
  <Function id="qiskit.optimization.algorithms.ADMMOptimizer.solve" name="solve" signature="ADMMOptimizer.solve(problem)">
  ...
  <Attribute id="qiskit.optimization.algorithms.ADMMOptimizer.parameters" name="parameters">
