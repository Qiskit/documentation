---
title: IBMQJobManager (v0.31)
description: API reference for qiskit.providers.ibmq.managed.IBMQJobManager in qiskit v0.31
...
<Class id="qiskit.providers.ibmq.managed.IBMQJobManager" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-ibmq-provider/tree/stable/0.17/qiskit/providers/ibmq/managed/ibmqjobmanager.py" signature="IBMQJobManager" modifiers="class">
  Bases: `object`
