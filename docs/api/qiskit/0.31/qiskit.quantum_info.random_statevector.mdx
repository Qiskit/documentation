---
title: random_statevector (v0.31)
description: API reference for qiskit.quantum_info.random_statevector in qiskit v0.31
...
<Function id="qiskit.quantum_info.random_statevector" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/quantum_info/states/random.py" signature="random_statevector(dims, seed=None)">
