---
title: UniformDistribution (v0.31)
description: API reference for qiskit.aqua.components.uncertainty_models.UniformDistribution in qiskit v0.31
...
<Class id="qiskit.aqua.components.uncertainty_models.UniformDistribution" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/aqua/components/uncertainty_models/uniform_distribution.py" signature="UniformDistribution(num_target_qubits, low=0, high=1)" modifiers="class">
  ...
  *   **high** (`float`) – Upper bound, i.e., the value corresponding to |1…1> (assuming an equidistant grid)
  ...
  <span id="qiskit-aqua-components-uncertainty-models-uniformdistribution-build" />
  ...
  <span id="qiskit-aqua-components-uncertainty-models-uniformdistribution-build-controlled" />
  ...
  <span id="qiskit-aqua-components-uncertainty-models-uniformdistribution-build-controlled-inverse" />
  ...
  <span id="qiskit-aqua-components-uncertainty-models-uniformdistribution-build-controlled-inverse-power" />
  ...
  <span id="qiskit-aqua-components-uncertainty-models-uniformdistribution-build-controlled-power" />
  ...
  <span id="qiskit-aqua-components-uncertainty-models-uniformdistribution-build-inverse" />
  ...
  <span id="qiskit-aqua-components-uncertainty-models-uniformdistribution-build-inverse-power" />
  ...
  <span id="qiskit-aqua-components-uncertainty-models-uniformdistribution-build-power" />
  ...
  <span id="qiskit-aqua-components-uncertainty-models-uniformdistribution-get-num-qubits" />
  ...
  <span id="qiskit-aqua-components-uncertainty-models-uniformdistribution-get-num-qubits-controlled" />
  ...
  <span id="qiskit-aqua-components-uncertainty-models-uniformdistribution-pdf-to-probabilities" />
  ...
  <span id="qiskit-aqua-components-uncertainty-models-uniformdistribution-required-ancillas" />
  ...
  <span id="qiskit-aqua-components-uncertainty-models-uniformdistribution-required-ancillas-controlled" />
