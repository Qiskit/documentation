...
<Class id="qiskit.aqua.operators.state_fns.StateFn" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/aqua/operators/state_fns/state_fn.py" signature="StateFn(primitive=None, coeff=1.0, is_measurement=False)">
  ...
  *   **is\_measurement** (`bool`) – Whether the StateFn is a measurement operator
  ...
  <Function id="qiskit.aqua.operators.state_fns.StateFn.add" name="add" signature="StateFn.add(other)">
  ...
  <Function id="qiskit.aqua.operators.state_fns.StateFn.adjoint" name="adjoint" signature="StateFn.adjoint()">
  ...
  <Function id="qiskit.aqua.operators.state_fns.StateFn.assign_parameters" name="assign_parameters" signature="StateFn.assign_parameters(param_dict)">
  ...
  <Function id="qiskit.aqua.operators.state_fns.StateFn.bind_parameters" name="bind_parameters" signature="StateFn.bind_parameters(param_dict)">
  ...
  <Function id="qiskit.aqua.operators.state_fns.StateFn.compose" name="compose" signature="StateFn.compose(other, permutation=None, front=False)">
  ...
  <Function id="qiskit.aqua.operators.state_fns.StateFn.equals" name="equals" signature="StateFn.equals(other)">
  ...
  <Function id="qiskit.aqua.operators.state_fns.StateFn.eval" name="eval" signature="StateFn.eval(front=None)">
  ...
  <Function id="qiskit.aqua.operators.state_fns.StateFn.mul" name="mul" signature="StateFn.mul(scalar)">
  ...
  <Function id="qiskit.aqua.operators.state_fns.StateFn.neg" name="neg" signature="StateFn.neg()">
  ...
  <Function id="qiskit.aqua.operators.state_fns.StateFn.permute" name="permute" signature="StateFn.permute(permutation)">
  ...
  <Function id="qiskit.aqua.operators.state_fns.StateFn.power" name="power" signature="StateFn.power(exponent)">
  ...
  <Function id="qiskit.aqua.operators.state_fns.StateFn.primitive_strings" name="primitive_strings" signature="StateFn.primitive_strings()">
  ...
  <Function id="qiskit.aqua.operators.state_fns.StateFn.reduce" name="reduce" signature="StateFn.reduce()">
  ...
  <Function id="qiskit.aqua.operators.state_fns.StateFn.sample" name="sample" signature="StateFn.sample(shots=1024, massive=False, reverse_endianness=False)">
  ...
  <Function id="qiskit.aqua.operators.state_fns.StateFn.tensor" name="tensor" signature="StateFn.tensor(other)">
  ...
  <Function id="qiskit.aqua.operators.state_fns.StateFn.tensorpower" name="tensorpower" signature="StateFn.tensorpower(other)">
  ...
  <Function id="qiskit.aqua.operators.state_fns.StateFn.to_density_matrix" name="to_density_matrix" signature="StateFn.to_density_matrix(massive=False)">
  ...
  <Function id="qiskit.aqua.operators.state_fns.StateFn.to_legacy_op" name="to_legacy_op" signature="StateFn.to_legacy_op(massive=False)">
  ...
  <Function id="qiskit.aqua.operators.state_fns.StateFn.to_matrix" name="to_matrix" signature="StateFn.to_matrix(massive=False)">
  ...
  <Function id="qiskit.aqua.operators.state_fns.StateFn.to_matrix_op" name="to_matrix_op" signature="StateFn.to_matrix_op(massive=False)">
  ...
  <Function id="qiskit.aqua.operators.state_fns.StateFn.traverse" name="traverse" signature="StateFn.traverse(convert_fn, coeff=None)">
  ...
  <Attribute id="qiskit.aqua.operators.state_fns.StateFn.ENABLE_DEPRECATION" name="ENABLE_DEPRECATION" attributeValue="= True" />

  ### INDENTATION

  <Attribute id="qiskit.aqua.operators.state_fns.StateFn.INDENTATION" name="INDENTATION" attributeValue="= '  '" />

  ### coeff

  <Attribute id="qiskit.aqua.operators.state_fns.StateFn.coeff" name="coeff">
  ...
  <Attribute id="qiskit.aqua.operators.state_fns.StateFn.is_measurement" name="is_measurement">
  ...
  <Attribute id="qiskit.aqua.operators.state_fns.StateFn.num_qubits" name="num_qubits">
    **Return type**
  ...
  <Attribute id="qiskit.aqua.operators.state_fns.StateFn.parameters" name="parameters" />

  ### primitive

  <Attribute id="qiskit.aqua.operators.state_fns.StateFn.primitive" name="primitive">
