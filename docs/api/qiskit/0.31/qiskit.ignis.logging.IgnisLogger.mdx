---
title: IgnisLogger (v0.31)
description: API reference for qiskit.ignis.logging.IgnisLogger in qiskit v0.31
...
<Class id="qiskit.ignis.logging.IgnisLogger" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-ignis/tree/stable/0.6/qiskit/ignis/logging/ignis_logging.py" signature="IgnisLogger(name, level=0)" modifiers="class">
  ...
  *   **level** (*logging.NOTSET*) – Verbosity level (use logging package enums)
  ...
  <span id="qiskit-ignis-logging-ignislogger-disable-file-logging" />
  ...
  <span id="qiskit-ignis-logging-ignislogger-enable-file-logging" />
  ...
  <Function id="qiskit.ignis.logging.IgnisLogger.findCaller" signature="IgnisLogger.findCaller(stack_info=False)">
  ...
  <span id="qiskit-ignis-logging-ignislogger-log-to-file" />
