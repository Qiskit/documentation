...
<Class id="qiskit.chemistry.BosonicOperator" github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/chemistry/bosonic_operator.py" signature="BosonicOperator(h, basis)">
  Bases: `object`
