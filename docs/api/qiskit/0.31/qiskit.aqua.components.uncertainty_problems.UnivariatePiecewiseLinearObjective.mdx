---
title: UnivariatePiecewiseLinearObjective (v0.31)
description: API reference for qiskit.aqua.components.uncertainty_problems.UnivariatePiecewiseLinearObjective in qiskit v0.31
