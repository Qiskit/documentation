---
title: QasmExperimentCalibrations (v0.31)
description: API reference for qiskit.qobj.QasmExperimentCalibrations in qiskit v0.31
...
<Class id="qiskit.qobj.QasmExperimentCalibrations" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/qobj/qasm_qobj.py" signature="QasmExperimentCalibrations(gates)" modifiers="class">
  Bases: `object`
