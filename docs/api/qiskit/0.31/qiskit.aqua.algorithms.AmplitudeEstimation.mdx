...
$$
  ...
  *   **i\_objective** (`Optional`\[`int`]) – Deprecated, use `objective_qubits`. The index of the objective qubit, i.e. the qubit marking ‘good’ solutions with the state $|1\rangle$ and ‘bad’ solutions with the state $0\rangle$.
  ...
  <Function id="qiskit.aqua.algorithms.AmplitudeEstimation.confidence_interval" name="confidence_interval" signature="AmplitudeEstimation.confidence_interval(alpha, kind='likelihood_ratio')">
  ...
  <Function id="qiskit.aqua.algorithms.AmplitudeEstimation.construct_circuit" name="construct_circuit" signature="AmplitudeEstimation.construct_circuit(measurement=False)">
  ...
  <Function id="qiskit.aqua.algorithms.AmplitudeEstimation.is_good_state" name="is_good_state" signature="AmplitudeEstimation.is_good_state(measurement)">
  ...
  <Function id="qiskit.aqua.algorithms.AmplitudeEstimation.post_processing" name="post_processing" signature="AmplitudeEstimation.post_processing(value)">
  ...
  <Function id="qiskit.aqua.algorithms.AmplitudeEstimation.run" name="run" signature="AmplitudeEstimation.run(quantum_instance=None, **kwargs)">
  ...
  <Function id="qiskit.aqua.algorithms.AmplitudeEstimation.set_backend" name="set_backend" signature="AmplitudeEstimation.set_backend(backend, **kwargs)">
  ...
  <Attribute id="qiskit.aqua.algorithms.AmplitudeEstimation.a_factory" name="a_factory">
  ...
  <Attribute id="qiskit.aqua.algorithms.AmplitudeEstimation.backend" name="backend">
    Returns backend.
  ...
  <Attribute id="qiskit.aqua.algorithms.AmplitudeEstimation.grover_operator" name="grover_operator">
  ...
  <Attribute id="qiskit.aqua.algorithms.AmplitudeEstimation.i_objective" name="i_objective">
  ...
  <Attribute id="qiskit.aqua.algorithms.AmplitudeEstimation.objective_qubits" name="objective_qubits">
  ...
  <Attribute id="qiskit.aqua.algorithms.AmplitudeEstimation.q_factory" name="q_factory">
...
$$
  ...
  <Attribute id="qiskit.aqua.algorithms.AmplitudeEstimation.quantum_instance" name="quantum_instance">
  ...
  <Attribute id="qiskit.aqua.algorithms.AmplitudeEstimation.random" name="random">
    Return a numpy random.
  </Attribute>

  ### state\_preparation

  <Attribute id="qiskit.aqua.algorithms.AmplitudeEstimation.state_preparation" name="state_preparation">
