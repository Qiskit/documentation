...
<Function id="qiskit.assembler.assemble_circuits" name="assemble_circuits" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/assembler/assemble_circuits.py" signature="assemble_circuits(circuits, run_config, qobj_id, qobj_header)">
