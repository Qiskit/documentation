...
<Function id="qiskit.visualization.plot_error_map" github="https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/visualization/gate_map.py" signature="plot_error_map(backend, figsize=(12, 9), show_title=True)">
