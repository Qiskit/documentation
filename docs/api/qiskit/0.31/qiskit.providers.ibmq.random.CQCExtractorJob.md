...
`CQCExtractorJob(job_id, client, parameters=None)`[GitHub](https://github.com/qiskit/qiskit-ibmq-provider/tree/stable/0.17/qiskit/providers/ibmq/random/cqcextractorjob.py "view source code")
...
`CQCExtractorJob.block_until_ready(timeout=None, wait=10)`[GitHub](https://github.com/qiskit/qiskit-ibmq-provider/tree/stable/0.17/qiskit/providers/ibmq/random/cqcextractorjob.py "view source code")
...
`CQCExtractorJob.status()`[GitHub](https://github.com/qiskit/qiskit-ibmq-provider/tree/stable/0.17/qiskit/providers/ibmq/random/cqcextractorjob.py "view source code")
