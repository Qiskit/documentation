...
<Class id="qiskit.providers.ibmq.experiment.IBMExperimentError" github="https://github.com/qiskit/qiskit-ibmq-provider/tree/stable/0.17/qiskit/providers/ibmq/experiment/exceptions.py" signature="IBMExperimentError(*message)">
