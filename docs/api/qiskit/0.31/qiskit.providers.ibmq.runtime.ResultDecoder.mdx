...
<Class id="qiskit.providers.ibmq.runtime.ResultDecoder" github="https://github.com/qiskit/qiskit-ibmq-provider/tree/stable/0.17/qiskit/providers/ibmq/runtime/program/result_decoder.py" signature="ResultDecoder">
  Bases: `object`
