---
title: Grover (v0.31)
description: API reference for qiskit.algorithms.Grover in qiskit v0.31
...
<Class id="qiskit.algorithms.Grover" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/algorithms/amplitude_amplifiers/grover.py" signature="Grover(iterations=None, growth_rate=None, sample_from_iterations=False, quantum_instance=None)" modifiers="class">
