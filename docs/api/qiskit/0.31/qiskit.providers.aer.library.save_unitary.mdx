...
<Function id="qiskit.providers.aer.library.save_unitary" github="https://github.com/qiskit/qiskit-aer/tree/stable/0.9/qiskit/providers/aer/library/save_instructions/save_unitary.py" signature="save_unitary(self, label='unitary', pershot=False)">
