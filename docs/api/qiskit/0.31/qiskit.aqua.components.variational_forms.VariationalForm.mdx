...
<Class id="qiskit.aqua.components.variational_forms.VariationalForm" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/aqua/components/variational_forms/variational_form.py" signature="VariationalForm">
  ...
  <Function id="qiskit.aqua.components.variational_forms.VariationalForm.construct_circuit" signature="abstract VariationalForm.construct_circuit(parameters, q=None)">
  ...
  <Function id="qiskit.aqua.components.variational_forms.VariationalForm.get_entangler_map" signature="static VariationalForm.get_entangler_map(map_type, num_qubits, offset=0)">
    returns entangler map
  </Function>

  ### validate\_entangler\_map

  <Function id="qiskit.aqua.components.variational_forms.VariationalForm.validate_entangler_map" signature="static VariationalForm.validate_entangler_map(entangler_map, num_qubits)">
