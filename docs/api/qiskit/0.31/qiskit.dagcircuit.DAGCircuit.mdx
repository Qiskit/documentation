...
<Class id="qiskit.dagcircuit.DAGCircuit" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/dagcircuit/dagcircuit.py" signature="DAGCircuit">
  Bases: `object`
  ...
  <Function id="qiskit.dagcircuit.DAGCircuit.apply_operation_back" name="apply_operation_back" signature="DAGCircuit.apply_operation_back(op, qargs=None, cargs=None, condition=None)">
  ...
  <Function id="qiskit.dagcircuit.DAGCircuit.apply_operation_front" name="apply_operation_front" signature="DAGCircuit.apply_operation_front(op, qargs, cargs, condition=None)">
  ...
  <Function id="qiskit.dagcircuit.DAGCircuit.compose" name="compose" signature="DAGCircuit.compose(other, edge_map=None, qubits=None, clbits=None, front=False, inplace=True)">
  ...
  <Function id="qiskit.dagcircuit.DAGCircuit.compose_back" name="compose_back" signature="DAGCircuit.compose_back(input_circuit, edge_map=None)">
  ...
  <Function id="qiskit.dagcircuit.DAGCircuit.extend_back" name="extend_back" signature="DAGCircuit.extend_back(dag, edge_map=None)">
  ...
  <Function id="qiskit.dagcircuit.DAGCircuit.threeQ_or_more_gates" name="threeQ_or_more_gates" signature="DAGCircuit.threeQ_or_more_gates()">
  ...
  <Function id="qiskit.dagcircuit.DAGCircuit.topological_nodes" name="topological_nodes" signature="DAGCircuit.topological_nodes()">
  ...
  <Function id="qiskit.dagcircuit.DAGCircuit.topological_op_nodes" name="topological_op_nodes" signature="DAGCircuit.topological_op_nodes()">
  ...
  <Function id="qiskit.dagcircuit.DAGCircuit.twoQ_gates" name="twoQ_gates" signature="DAGCircuit.twoQ_gates()">
