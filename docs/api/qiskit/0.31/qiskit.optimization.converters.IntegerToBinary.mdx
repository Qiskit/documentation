...
<Class id="qiskit.optimization.converters.IntegerToBinary" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/optimization/converters/integer_to_binary.py" signature="IntegerToBinary">
  ...
  **\[1]: Sahar Karimi, Pooya Ronagh (2017), Practical Integer-to-Binary Mapping for Quantum**
  ...
  <Function id="qiskit.optimization.converters.IntegerToBinary.convert" name="convert" signature="IntegerToBinary.convert(problem)">
  ...
  <Function id="qiskit.optimization.converters.IntegerToBinary.interpret" name="interpret" signature="IntegerToBinary.interpret(x)">
