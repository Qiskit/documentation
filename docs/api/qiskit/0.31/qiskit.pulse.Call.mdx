...
<Class id="qiskit.pulse.Call" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/pulse/instructions/call.py" signature="Call(subroutine, value_dict=None, name=None)">
  ...
  **Raises**
  ...
  <Function id="qiskit.pulse.Call.append" name="append" signature="Call.append(schedule, name=None)">
  ...
  <Function id="qiskit.pulse.Call.assign_parameters" name="assign_parameters" signature="Call.assign_parameters(value_dict)">
  ...
  <Function id="qiskit.pulse.Call.assigned_subroutine" name="assigned_subroutine" signature="Call.assigned_subroutine()">
  ...
  <Function id="qiskit.pulse.Call.ch_duration" name="ch_duration" signature="Call.ch_duration(*channels)">
  ...
  <Function id="qiskit.pulse.Call.ch_start_time" name="ch_start_time" signature="Call.ch_start_time(*channels)">
  ...
  <Function id="qiskit.pulse.Call.ch_stop_time" name="ch_stop_time" signature="Call.ch_stop_time(*channels)">
  ...
  <Function id="qiskit.pulse.Call.draw" name="draw" signature="Call.draw(dt=1, style=None, filename=None, interp_method=None, scale=1, plot_all=False, plot_range=None, interactive=False, table=True, label=False, framechange=True, channels=None)">
  ...
  <Function id="qiskit.pulse.Call.flatten" name="flatten" signature="Call.flatten()">
  ...
  <Function id="qiskit.pulse.Call.insert" name="insert" signature="Call.insert(start_time, schedule, name=None)">
  ...
  <Function id="qiskit.pulse.Call.is_parameterized" name="is_parameterized" signature="Call.is_parameterized()">
  ...
  <Function id="qiskit.pulse.Call.shift" name="shift" signature="Call.shift(time, name=None)">
  ...
  <Attribute id="qiskit.pulse.Call.arguments" name="arguments">
  ...
  <Attribute id="qiskit.pulse.Call.channels" name="channels">
  ...
  <Attribute id="qiskit.pulse.Call.duration" name="duration">
  ...
  <Attribute id="qiskit.pulse.Call.id" name="id">
  ...
  <Attribute id="qiskit.pulse.Call.instructions" name="instructions">
  ...
  <Attribute id="qiskit.pulse.Call.name" name="name">
  ...
  <Attribute id="qiskit.pulse.Call.operands" name="operands">
  ...
  <Attribute id="qiskit.pulse.Call.parameters" name="parameters">
  ...
  <Attribute id="qiskit.pulse.Call.prefix" name="prefix" attributeValue="= 'call'" />

  ### start\_time

  <Attribute id="qiskit.pulse.Call.start_time" name="start_time">
  ...
  <Attribute id="qiskit.pulse.Call.stop_time" name="stop_time">
  ...
  <Attribute id="qiskit.pulse.Call.subroutine" name="subroutine">
