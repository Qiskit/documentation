...
<Class id="qiskit.chemistry.QMolecule" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/chemistry/qmolecule.py" signature="QMolecule(filename=None)">
  Bases: `object`
  ...
  <Function id="qiskit.chemistry.QMolecule.Z" name="Z" signature="QMolecule.Z(natom)" />

  ### has\_dipole\_integrals

  <Function id="qiskit.chemistry.QMolecule.has_dipole_integrals" name="has_dipole_integrals" signature="QMolecule.has_dipole_integrals()">
    Check if dipole integrals are present.
  </Function>

  ### load

  <Function id="qiskit.chemistry.QMolecule.load" name="load" signature="QMolecule.load()">
    loads info saved.
  </Function>

  ### log

  <Function id="qiskit.chemistry.QMolecule.log" name="log" signature="QMolecule.log()">
    log properties
  </Function>

  ### onee\_to\_spin

  <Function id="qiskit.chemistry.QMolecule.onee_to_spin" name="onee_to_spin" signature="static QMolecule.onee_to_spin(mohij, mohij_b=None, threshold=1e-12)">
  ...
  <Function id="qiskit.chemistry.QMolecule.oneeints2mo" name="oneeints2mo" signature="static QMolecule.oneeints2mo(ints, moc)">
  ...
  <Function id="qiskit.chemistry.QMolecule.remove_file" name="remove_file" signature="QMolecule.remove_file(file_name=None)">
    remove file
  </Function>

  ### save

  <Function id="qiskit.chemistry.QMolecule.save" name="save" signature="QMolecule.save(file_name=None)">
    Saves the info from the driver.
  </Function>

  ### twoe\_to\_spin

  <Function id="qiskit.chemistry.QMolecule.twoe_to_spin" name="twoe_to_spin" signature="static QMolecule.twoe_to_spin(mohijkl, mohijkl_bb=None, mohijkl_ba=None, threshold=1e-12)">
  ...
  <Function id="qiskit.chemistry.QMolecule.twoeints2mo" name="twoeints2mo" signature="static QMolecule.twoeints2mo(ints, moc)">
  ...
  <Function id="qiskit.chemistry.QMolecule.twoeints2mo_general" name="twoeints2mo_general" signature="static QMolecule.twoeints2mo_general(ints, moc1, moc2, moc3, moc4)" />

  ## Attributes

  ### BOHR

  <Attribute id="qiskit.chemistry.QMolecule.BOHR" name="BOHR" attributeValue="0.52917721092" />

  ### DEBYE

  <Attribute id="qiskit.chemistry.QMolecule.DEBYE" name="DEBYE" attributeValue="0.393430307" />

  ### QMOLECULE\_VERSION

  <Attribute id="qiskit.chemistry.QMolecule.QMOLECULE_VERSION" name="QMOLECULE_VERSION" attributeValue="2" />

  ### core\_orbitals

  <Attribute id="qiskit.chemistry.QMolecule.core_orbitals" name="core_orbitals">
  ...
  <Attribute id="qiskit.chemistry.QMolecule.filename" name="filename">
    returns temp file path
  </Attribute>

  ### one\_body\_integrals

  <Attribute id="qiskit.chemistry.QMolecule.one_body_integrals" name="one_body_integrals">
    Returns one body electron integrals.
  </Attribute>

  ### symbols

  <Attribute id="qiskit.chemistry.QMolecule.symbols" name="symbols" attributeValue="['_', 'H', 'He', 'Li', 'Be', 'B', 'C', 'N', 'O', 'F', 'Ne', 'Na', 'Mg', 'Al', 'Si', 'P', 'S', 'Cl', 'Ar', 'K', 'Ca', 'Sc', 'Ti', 'V', 'Cr', 'Mn', 'Fe', 'Co', 'Ni', 'Cu', 'Zn', 'Ga', 'Ge', 'As', 'Se', 'Br', 'Kr', 'Rb', 'Sr', 'Y', 'Zr', 'Nb', 'Mo', 'Tc', 'Ru', 'Rh', 'Pd', 'Ag', 'Cd', 'In', 'Sn', 'Sb', 'Te', 'I', 'Xe', 'Cs', 'Ba', 'La', 'Ce', 'Pr', 'Nd', 'Pm', 'Sm', 'Eu', 'Gd', 'Tb', 'Dy', 'Ho', 'Er', 'Tm', 'Yb', 'Lu', 'Hf', 'Ta', 'W', 'Re', 'Os', 'Ir', 'Pt', 'Au', 'Hg', 'Tl', 'Pb', 'Bi', 'Po', 'At', 'Rn', 'Fr', 'Ra', 'Ac', 'Th', 'Pa', 'U', 'Np', 'Pu', 'Am', 'Cm', 'Bk', 'Cf', 'Es', 'Fm', 'Md', 'No', 'Lr', 'Rf', 'Db', 'Sg', 'Bh', 'Hs', 'Mt', 'Ds', 'Rg', 'Cn', 'Nh', 'Fl', 'Mc', 'Lv', 'Ts', 'Og']" />

  ### two\_body\_integrals

  <Attribute id="qiskit.chemistry.QMolecule.two_body_integrals" name="two_body_integrals">
    Returns two body electron integrals.
  </Attribute>

  ### x\_dipole\_integrals

  <Attribute id="qiskit.chemistry.QMolecule.x_dipole_integrals" name="x_dipole_integrals">
    returns x\_dipole\_integrals
  </Attribute>

  ### y\_dipole\_integrals

  <Attribute id="qiskit.chemistry.QMolecule.y_dipole_integrals" name="y_dipole_integrals">
    returns y\_dipole\_integrals
  </Attribute>

  ### z\_dipole\_integrals

  <Attribute id="qiskit.chemistry.QMolecule.z_dipole_integrals" name="z_dipole_integrals">
