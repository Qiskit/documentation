---
title: SPSA (v0.31)
description: API reference for qiskit.aqua.components.optimizers.SPSA in qiskit v0.31
...
<Class id="qiskit.aqua.components.optimizers.SPSA" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/aqua/components/optimizers/spsa.py" signature="SPSA(maxiter=1000, save_steps=1, last_avg=1, c0=0.6283185307179586, c1=0.1, c2=0.602, c3=0.101, c4=0, skip_calibration=False, max_trials=None)" modifiers="class">
  ...
  *   **max\_trials** (`Optional`\[`int`]) – Deprecated, use maxiter.
  ...
  <span id="qiskit-aqua-components-optimizers-spsa-get-support-level" />
  ...
  <span id="qiskit-aqua-components-optimizers-spsa-gradient-num-diff" />
  ...
  <span id="qiskit-aqua-components-optimizers-spsa-print-options" />
  ...
  <span id="qiskit-aqua-components-optimizers-spsa-set-max-evals-grouped" />
  ...
  <span id="qiskit-aqua-components-optimizers-spsa-set-options" />
  ...
  <span id="qiskit-aqua-components-optimizers-spsa-wrap-function" />
