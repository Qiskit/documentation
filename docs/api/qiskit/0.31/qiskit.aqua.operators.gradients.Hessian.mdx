---
title: Hessian (v0.31)
description: API reference for qiskit.aqua.operators.gradients.Hessian in qiskit v0.31
...
<Class id="qiskit.aqua.operators.gradients.Hessian" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/aqua/operators/gradients/hessian.py" signature="Hessian(hess_method='param_shift', **kwargs)" modifiers="class">
  ...
  **ValueError** – If method != `fin_diff` and `epsilon` is not None.
  ...
  <span id="qiskit-aqua-operators-gradients-hessian-get-hessian" />
  ...
  <span id="qiskit-aqua-operators-gradients-hessian-gradient-wrapper" />
  ...
  <span id="qiskit-aqua-operators-gradients-hessian-parameter-expression-grad" />
