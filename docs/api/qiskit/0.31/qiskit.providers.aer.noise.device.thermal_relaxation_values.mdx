...
<Function id="qiskit.providers.aer.noise.device.thermal_relaxation_values" name="thermal_relaxation_values" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-aer/tree/stable/0.9/qiskit/providers/aer/noise/device/parameters.py" signature="thermal_relaxation_values(properties)">
