...
<Class id="qiskit.providers.ibmq.job.IBMQJobInvalidStateError" name="IBMQJobInvalidStateError" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-ibmq-provider/tree/stable/0.17/qiskit/providers/ibmq/job/exceptions.py" signature="IBMQJobInvalidStateError(*message)">
