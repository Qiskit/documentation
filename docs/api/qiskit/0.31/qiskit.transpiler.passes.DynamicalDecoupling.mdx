...
<Class id="qiskit.transpiler.passes.DynamicalDecoupling" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/transpiler/passes/scheduling/dynamical_decoupling.py" signature="DynamicalDecoupling(*args, **kwargs)">
  ...
  ![../\_images/qiskit.transpiler.passes.DynamicalDecoupling\_1\_0.png](/images/api/qiskit/0.31/qiskit.transpiler.passes.DynamicalDecoupling_1_0.png)
  ...
  ![../\_images/qiskit.transpiler.passes.DynamicalDecoupling\_2\_0.png](/images/api/qiskit/0.31/qiskit.transpiler.passes.DynamicalDecoupling_2_0.png)
  ...
  *   **skip\_reset\_qubits** (*bool*) – if True, does not insert DD on idle periods that immediately follow initialized/reset qubits (as qubits in the ground state are less susceptile to decoherence).
  ...
  <Function id="qiskit.transpiler.passes.DynamicalDecoupling.name" name="name" signature="DynamicalDecoupling.name()">
    Return the name of the pass.
  </Function>

  ### run

  <Function id="qiskit.transpiler.passes.DynamicalDecoupling.run" name="run" signature="DynamicalDecoupling.run(dag)">
