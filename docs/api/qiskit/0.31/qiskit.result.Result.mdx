...
<Class id="qiskit.result.Result" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/result/result.py" signature="Result(backend_name, backend_version, qobj_id, job_id, success, results, date=None, status=None, header=None, **kwargs)">
  ...
  <Function id="qiskit.result.Result.data" name="data" signature="Result.data(experiment=None)">
  ...
  <Function id="qiskit.result.Result.from_dict" name="from_dict" signature="classmethod Result.from_dict(data)">
  ...
  <Function id="qiskit.result.Result.get_counts" name="get_counts" signature="Result.get_counts(experiment=None)">
  ...
  <Function id="qiskit.result.Result.get_memory" name="get_memory" signature="Result.get_memory(experiment=None)">
  ...
  <Function id="qiskit.result.Result.get_statevector" name="get_statevector" signature="Result.get_statevector(experiment=None, decimals=None)">
  ...
  <Function id="qiskit.result.Result.get_unitary" name="get_unitary" signature="Result.get_unitary(experiment=None, decimals=None)">
  ...
  <Function id="qiskit.result.Result.to_dict" name="to_dict" signature="Result.to_dict()">
