---
title: InnerProduct (v0.31)
description: API reference for qiskit.circuit.library.InnerProduct in qiskit v0.31
...
$$
  ...
  **num\_qubits** (`int`) – width of top and bottom registers (half total circuit width)
  ...
  <Attribute id="qiskit.circuit.library.InnerProduct.instances" attributeValue="16" />
