...
<Class id="qiskit.synthesis.MatrixExponential" github="https://github.com/qiskit/qiskit/tree/stable/1.0/qiskit/synthesis/evolution/matrix_synthesis.py" signature="qiskit.synthesis.MatrixExponential">
