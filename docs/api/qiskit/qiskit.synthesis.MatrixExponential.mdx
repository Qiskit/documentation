...
<Class id="qiskit.synthesis.MatrixExponential" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/synthesis/evolution/matrix_synthesis.py#L21-L46" signature="qiskit.synthesis.MatrixExponential" modifiers="class">
  ...
  <Attribute id="qiskit.synthesis.MatrixExponential.settings" name="settings" headingLevel={3}>
  ...
  <Function id="qiskit.synthesis.MatrixExponential.synthesize" github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/synthesis/evolution/matrix_synthesis.py#L30-L46" signature="synthesize(evolution)">
