...
<Class id="qiskit.synthesis.MatrixExponential" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.0/qiskit/synthesis/evolution/matrix_synthesis.py#L20-L47" signature="qiskit.synthesis.MatrixExponential">
  ...
  <Function id="qiskit.synthesis.MatrixExponential.synthesize" name="synthesize" github="https://github.com/Qiskit/qiskit/tree/stable/1.0/qiskit/synthesis/evolution/matrix_synthesis.py#L29-L47" signature="synthesize(evolution)">
