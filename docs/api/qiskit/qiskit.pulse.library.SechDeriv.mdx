...
<Function id="qiskit.pulse.library.SechDeriv" name="SechDeriv" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.0/qiskit/pulse/library/symbolic_pulses.py#L1902-L1962" signature="qiskit.pulse.library.SechDeriv(duration, amp, sigma, angle=0.0, name=None, limit_amplitude=None)">
