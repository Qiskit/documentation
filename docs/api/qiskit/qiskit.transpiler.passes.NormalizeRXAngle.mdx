...
<Class id="qiskit.transpiler.passes.NormalizeRXAngle" github="https://github.com/Qiskit/qiskit/tree/stable/1.0/qiskit/transpiler/passes/optimization/normalize_rx_angle.py#L28-L149" signature="qiskit.transpiler.passes.NormalizeRXAngle(*args, **kwargs)">
