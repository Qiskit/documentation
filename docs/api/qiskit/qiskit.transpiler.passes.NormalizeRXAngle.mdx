...
<Class id="qiskit.transpiler.passes.NormalizeRXAngle" github="https://github.com/qiskit/qiskit/tree/stable/1.0/qiskit/transpiler/passes/optimization/normalize_rx_angle.py" signature="qiskit.transpiler.passes.NormalizeRXAngle(*args, **kwargs)">
