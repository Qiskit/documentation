...
<Class id="qiskit.transpiler.passes.InverseCancellation" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/2.1/qiskit/transpiler/passes/optimization/inverse_cancellation.py#L27-L95" signature="qiskit.transpiler.passes.InverseCancellation(*args, **kwargs)" modifiers="class">
  ...
  **Raises**
  ...
  <Function id="qiskit.transpiler.passes.InverseCancellation.execute" github="https://github.com/Qiskit/qiskit/tree/stable/2.1/qiskit/transpiler/basepasses.py#L161-L180" signature="execute(passmanager_ir, state, callback=None)">
  ...
  <Function id="qiskit.transpiler.passes.InverseCancellation.name" github="https://github.com/Qiskit/qiskit/tree/stable/2.1/qiskit/passmanager/base_tasks.py#L68-L70" signature="name()">
    Name of the pass.
  ...
  <Function id="qiskit.transpiler.passes.InverseCancellation.run" github="https://github.com/Qiskit/qiskit/tree/stable/2.1/qiskit/transpiler/passes/optimization/inverse_cancellation.py#L78-L95" signature="run(dag)">
  ...
  <Function id="qiskit.transpiler.passes.InverseCancellation.update_status" github="https://github.com/Qiskit/qiskit/tree/stable/2.1/qiskit/transpiler/basepasses.py#L182-L190" signature="update_status(state, run_state)">
