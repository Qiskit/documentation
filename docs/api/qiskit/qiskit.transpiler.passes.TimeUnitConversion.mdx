...
<Class id="qiskit.transpiler.passes.TimeUnitConversion" github="https://github.com/qiskit/qiskit/tree/stable/1.0/qiskit/transpiler/passes/scheduling/time_unit_conversion.py" signature="qiskit.transpiler.passes.TimeUnitConversion(*args, **kwargs)">
