...
<Class id="qiskit.circuit.library.PauliTwoDesign" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/circuit/library/n_local/pauli_two_design.py#L121-L247" signature="qiskit.circuit.library.PauliTwoDesign(num_qubits=None, reps=3, seed=None, insert_barriers=False, name='PauliTwoDesign')" modifiers="class">
  ...
  *   **name** ([*str*](https://docs.python.org/3/library/stdtypes.html#str)) – The name to use for the generated circuit.
  ...
  <Attribute id="qiskit.circuit.library.PauliTwoDesign.num_parameters_settable" name="num_parameters_settable" headingLevel={3}>
  ...
  <Attribute id="qiskit.circuit.library.PauliTwoDesign.name" name="name" headingLevel={3}>
    <AttributeTypeHint>
