...
<Class id="qiskit.transpiler.Layout" github="https://github.com/qiskit/qiskit/tree/stable/1.0/qiskit/transpiler/layout.py" signature="qiskit.transpiler.Layout(input_dict=None)">
