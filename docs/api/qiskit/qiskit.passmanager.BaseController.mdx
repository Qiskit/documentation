...
<Class id="qiskit.passmanager.BaseController" github="https://github.com/qiskit/qiskit/tree/stable/1.0/qiskit/passmanager/base_tasks.py" signature="qiskit.passmanager.BaseController(options=None)">
