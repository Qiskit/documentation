...
<Function id="qiskit.qasm3.dump" github="https://github.com/Qiskit/qiskit/tree/stable/1.3/qiskit/qasm3/__init__.py#L287-L297" signature="qiskit.qasm3.dump(circuit, stream, **kwargs)">
...
<Function id="qiskit.qasm3.dumps" github="https://github.com/Qiskit/qiskit/tree/stable/1.3/qiskit/qasm3/__init__.py#L274-L284" signature="qiskit.qasm3.dumps(circuit, **kwargs)">
...
<Function id="qiskit.qasm3.load" github="https://github.com/Qiskit/qiskit/tree/stable/1.3/qiskit/qasm3/__init__.py#L300-L322" signature="qiskit.qasm3.load(filename)">
...
<Function id="qiskit.qasm3.loads" github="https://github.com/Qiskit/qiskit/tree/stable/1.3/qiskit/qasm3/__init__.py#L325-L345" signature="qiskit.qasm3.loads(program)">
