...
<Class id="qiskit.aqua.components.oracles.TruthTableOracle" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/aqua/components/oracles/truth_table_oracle.py" signature="TruthTableOracle(bitmaps, optimization=False, mct_mode='basic')">
  ...
  **Raises**
  ...
  <Function id="qiskit.aqua.components.oracles.TruthTableOracle.ancillary_register" signature="property ancillary_register">
    returns ancillary register
  </Function>

  ### circuit

  <Function id="qiskit.aqua.components.oracles.TruthTableOracle.circuit" signature="property circuit" />
  ...
  <Function id="qiskit.aqua.components.oracles.TruthTableOracle.output_register" signature="property output_register">
    returns output register
  </Function>

  ### variable\_register

  <Function id="qiskit.aqua.components.oracles.TruthTableOracle.variable_register" signature="property variable_register">
