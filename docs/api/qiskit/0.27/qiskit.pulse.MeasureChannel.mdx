...
<Class id="qiskit.pulse.MeasureChannel" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.17/qiskit/pulse/channels.py" signature="MeasureChannel(index)" modifiers="class">
  ...
  **index** (`int`) – Index of channel.
  ...
  <Function id="qiskit.pulse.MeasureChannel.index" signature="index" modifiers="property">
  ...
  <Function id="qiskit.pulse.MeasureChannel.name" signature="name" modifiers="property">
  ...
  <Function id="qiskit.pulse.MeasureChannel.parameters" signature="parameters" modifiers="property">
