...
<Class id="qiskit.pulse.MeasureChannel" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.17/qiskit/pulse/channels.py" signature="MeasureChannel(index)">
  ...
  **index** (`int`) – Index of channel.
  ...
  <Function id="qiskit.pulse.MeasureChannel.index" signature="property index">
  ...
  <Function id="qiskit.pulse.MeasureChannel.name" signature="property name">
  ...
  <Function id="qiskit.pulse.MeasureChannel.parameters" signature="property parameters">
