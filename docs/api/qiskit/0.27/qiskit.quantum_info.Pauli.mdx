...
<Class id="qiskit.quantum_info.Pauli" github="https://github.com/qiskit/qiskit/tree/stable/0.17/qiskit/quantum_info/operators/symplectic/pauli.py" signature="Pauli(data=None, x=None, *, z=None, label=None)">
...
$$
  ...
  **QiskitError** – if input array is invalid shape.
  ...
  <Function id="qiskit.quantum_info.Pauli.__init__" name="__init__" signature="__init__(data=None, x=None, *, z=None, label=None)">
    Initialize the Pauli.
  ...
  <Function id="qiskit.quantum_info.Pauli.adjoint" name="adjoint" signature="adjoint()">
    Return the adjoint of the Operator.
  </Function>

  ### anticommutes

  <Function id="qiskit.quantum_info.Pauli.anticommutes" name="anticommutes" signature="anticommutes(other, qargs=None)">
  ...
  <Function id="qiskit.quantum_info.Pauli.append_paulis" name="append_paulis" signature="append_paulis(paulis=None, pauli_labels=None)">
  ...
  <Function id="qiskit.quantum_info.Pauli.commutes" name="commutes" signature="commutes(other, qargs=None)">
  ...
  <Function id="qiskit.quantum_info.Pauli.compose" name="compose" signature="compose(other, qargs=None, front=False, inplace=False)">
  ...
  <Function id="qiskit.quantum_info.Pauli.conjugate" name="conjugate" signature="conjugate()">
    Return the conjugate of each Pauli in the list.
  </Function>

  ### copy

  <Function id="qiskit.quantum_info.Pauli.copy" name="copy" signature="copy()">
    Make a deep copy of current operator.
  </Function>

  ### delete

  <Function id="qiskit.quantum_info.Pauli.delete" name="delete" signature="delete(qubits)">
  ...
  <Function id="qiskit.quantum_info.Pauli.delete_qubits" name="delete_qubits" signature="delete_qubits(indices)">
  ...
  <Function id="qiskit.quantum_info.Pauli.dim" name="dim" signature="property dim">
    Return tuple (input\_shape, output\_shape).
  </Function>

  ### dot

  <Function id="qiskit.quantum_info.Pauli.dot" name="dot" signature="dot(other, qargs=None, inplace=False)">
  ...
  <Function id="qiskit.quantum_info.Pauli.equiv" name="equiv" signature="equiv(other)">
  ...
  <Function id="qiskit.quantum_info.Pauli.evolve" name="evolve" signature="evolve(other, qargs=None)">
  ...
  <Function id="qiskit.quantum_info.Pauli.expand" name="expand" signature="expand(other)">
  ...
  <Function id="qiskit.quantum_info.Pauli.from_label" name="from_label" signature="static from_label(*args, **kwargs)">
  ...
  <Function id="qiskit.quantum_info.Pauli.input_dims" name="input_dims" signature="input_dims(qargs=None)">
    Return tuple of input dimension for specified subsystems.
  </Function>

  ### insert

  <Function id="qiskit.quantum_info.Pauli.insert" name="insert" signature="insert(qubits, value)">
  ...
  <Function id="qiskit.quantum_info.Pauli.insert_paulis" name="insert_paulis" signature="insert_paulis(indices=None, paulis=None, pauli_labels=None)">
  ...
  <Function id="qiskit.quantum_info.Pauli.inverse" name="inverse" signature="inverse()">
    Return the inverse of the Pauli.
  </Function>

  ### kron

  <Function id="qiskit.quantum_info.Pauli.kron" name="kron" signature="kron(other)">
  ...
  <Function id="qiskit.quantum_info.Pauli.num_qubits" name="num_qubits" signature="property num_qubits">
    Return the number of qubits if a N-qubit operator or None otherwise.
  </Function>

  ### output\_dims

  <Function id="qiskit.quantum_info.Pauli.output_dims" name="output_dims" signature="output_dims(qargs=None)">
    Return tuple of output dimension for specified subsystems.
  </Function>

  ### pauli\_single

  <Function id="qiskit.quantum_info.Pauli.pauli_single" name="pauli_single" signature="classmethod pauli_single(num_qubits, index, pauli_label)">
  ...
  <Function id="qiskit.quantum_info.Pauli.phase" name="phase" signature="property phase">
    Return the group phase exponent for the Pauli.
  </Function>

  ### power

  <Function id="qiskit.quantum_info.Pauli.power" name="power" signature="power(n)">
  ...
  <Function id="qiskit.quantum_info.Pauli.qargs" name="qargs" signature="property qargs">
    Return the qargs for the operator.
  </Function>

  ### random

  <Function id="qiskit.quantum_info.Pauli.random" name="random" signature="classmethod random(num_qubits, seed=None)">
  ...
  <Function id="qiskit.quantum_info.Pauli.reshape" name="reshape" signature="reshape(input_dims=None, output_dims=None, num_qubits=None)">
  ...
  <Function id="qiskit.quantum_info.Pauli.set_truncation" name="set_truncation" signature="classmethod set_truncation(val)">
  ...
  <Function id="qiskit.quantum_info.Pauli.sgn_prod" name="sgn_prod" signature="static sgn_prod(*args, **kwargs)">
  ...
  <Function id="qiskit.quantum_info.Pauli.tensor" name="tensor" signature="tensor(other)">
  ...
  <Function id="qiskit.quantum_info.Pauli.to_instruction" name="to_instruction" signature="to_instruction()">
    Convert to Pauli circuit instruction.
  </Function>

  ### to\_label

  <Function id="qiskit.quantum_info.Pauli.to_label" name="to_label" signature="to_label()">
  ...
  <Function id="qiskit.quantum_info.Pauli.to_matrix" name="to_matrix" signature="to_matrix(sparse=False)">
  ...
  <Function id="qiskit.quantum_info.Pauli.to_spmatrix" name="to_spmatrix" signature="to_spmatrix()">
  ...
  <Function id="qiskit.quantum_info.Pauli.transpose" name="transpose" signature="transpose()">
    Return the transpose of each Pauli in the list.
  </Function>

  ### update\_x

  <Function id="qiskit.quantum_info.Pauli.update_x" name="update_x" signature="update_x(x, indices=None)">
  ...
  <Function id="qiskit.quantum_info.Pauli.update_z" name="update_z" signature="update_z(z, indices=None)">
  ...
  <Function id="qiskit.quantum_info.Pauli.x" name="x" signature="property x">
    The x vector for the Pauli.
  </Function>

  ### z

  <Function id="qiskit.quantum_info.Pauli.z" name="z" signature="property z">
