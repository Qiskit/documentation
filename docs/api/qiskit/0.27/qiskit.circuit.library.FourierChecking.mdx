...
<Class id="qiskit.circuit.library.FourierChecking" github="https://github.com/qiskit/qiskit/tree/stable/0.17/qiskit/circuit/library/fourier_checking.py" signature="FourierChecking(f, g)">
