...
$$
  ...
  *   **insert\_barriers** (`bool`) – If True, barriers are inserted in between the evolution instructions and hadamard layers.
  ...
  <Function id="qiskit.circuit.library.PauliFeatureMap.__init__" signature="__init__(feature_dimension=None, reps=2, entanglement='full', alpha=2.0, paulis=None, data_map_func=None, parameter_prefix='x', insert_barriers=False)">
    Create a new Pauli expansion circuit.
  ...
  <Function id="qiskit.circuit.library.PauliFeatureMap.add_bits" signature="add_bits(bits)">
  ...
  <Function id="qiskit.circuit.library.PauliFeatureMap.alpha" signature="alpha" modifiers="property">
  ...
  <Function id="qiskit.circuit.library.PauliFeatureMap.ancillas" signature="ancillas" modifiers="property">
  ...
  <Function id="qiskit.circuit.library.PauliFeatureMap.assign_parameters" signature="assign_parameters(parameters, inplace=False, param_dict=None)">
  ...
  <Function id="qiskit.circuit.library.PauliFeatureMap.bind_parameters" signature="bind_parameters(values, value_dict=None)">
  ...
  <Function id="qiskit.circuit.library.PauliFeatureMap.calibrations" signature="calibrations" modifiers="property">
  ...
  <Function id="qiskit.circuit.library.PauliFeatureMap.clbits" signature="clbits" modifiers="property">
  ...
  <Function id="qiskit.circuit.library.PauliFeatureMap.data" signature="data" modifiers="property">
  ...
  <Function id="qiskit.circuit.library.PauliFeatureMap.ecr" signature="ecr(qubit1, qubit2)">
    Apply [`ECRGate`](qiskit.circuit.library.ECRGate "qiskit.circuit.library.ECRGate").
  </Function>

  ### entanglement

  <Function id="qiskit.circuit.library.PauliFeatureMap.entanglement" signature="entanglement" modifiers="property">
  ...
  <Function id="qiskit.circuit.library.PauliFeatureMap.entanglement_blocks" signature="entanglement_blocks" modifiers="property">
  ...
  <Function id="qiskit.circuit.library.PauliFeatureMap.feature_dimension" signature="feature_dimension" modifiers="property">
  ...
  <Function id="qiskit.circuit.library.PauliFeatureMap.global_phase" signature="global_phase" modifiers="property">
  ...
  <Function id="qiskit.circuit.library.PauliFeatureMap.initial_state" signature="initial_state" modifiers="property">
  ...
  <Function id="qiskit.circuit.library.PauliFeatureMap.initialize" signature="initialize(params, qubits=None)">
  ...
  <Function id="qiskit.circuit.library.PauliFeatureMap.insert_barriers" signature="insert_barriers" modifiers="property">
  ...
  <Function id="qiskit.circuit.library.PauliFeatureMap.mcry" signature="mcry(theta, q_controls, q_target, q_ancillae=None, mode=None, use_basis_gates=False)">
  ...
  <Function id="qiskit.circuit.library.PauliFeatureMap.metadata" signature="metadata" modifiers="property">
  ...
  <Function id="qiskit.circuit.library.PauliFeatureMap.num_ancillas" signature="num_ancillas" modifiers="property">
    Return the number of ancilla qubits.
  </Function>

  ### num\_clbits

  <Function id="qiskit.circuit.library.PauliFeatureMap.num_clbits" signature="num_clbits" modifiers="property">
  ...
  <Function id="qiskit.circuit.library.PauliFeatureMap.num_layers" signature="num_layers" modifiers="property">
  ...
  <Function id="qiskit.circuit.library.PauliFeatureMap.num_parameters" signature="num_parameters" modifiers="property">
  ...
  <Function id="qiskit.circuit.library.PauliFeatureMap.num_parameters_settable" signature="num_parameters_settable" modifiers="property">
    The number of distinct parameters.
  </Function>

  ### num\_qubits

  <Function id="qiskit.circuit.library.PauliFeatureMap.num_qubits" signature="num_qubits" modifiers="property">
  ...
  <Function id="qiskit.circuit.library.PauliFeatureMap.ordered_parameters" signature="ordered_parameters" modifiers="property">
  ...
  <Function id="qiskit.circuit.library.PauliFeatureMap.parameter_bounds" signature="parameter_bounds" modifiers="property">
  ...
  <Function id="qiskit.circuit.library.PauliFeatureMap.parameters" signature="parameters" modifiers="property">
  ...
  <Function id="qiskit.circuit.library.PauliFeatureMap.pauli" signature="pauli(pauli_string, qubits)">
    Apply `PauliGate`.
  </Function>
  ...
  <Function id="qiskit.circuit.library.PauliFeatureMap.paulis" signature="paulis" modifiers="property">
  ...
  <Function id="qiskit.circuit.library.PauliFeatureMap.preferred_init_points" signature="preferred_init_points" modifiers="property">
  ...
  <Function id="qiskit.circuit.library.PauliFeatureMap.qregs" signature="qregs" modifiers="property">
  ...
  <Function id="qiskit.circuit.library.PauliFeatureMap.qubits" signature="qubits" modifiers="property">
  ...
  <Function id="qiskit.circuit.library.PauliFeatureMap.reps" signature="reps" modifiers="property">
  ...
  <Function id="qiskit.circuit.library.PauliFeatureMap.rotation_blocks" signature="rotation_blocks" modifiers="property">
  ...
  <Function id="qiskit.circuit.library.PauliFeatureMap.rv" signature="rv(vx, vy, vz, qubit)">
  ...
  <Function id="qiskit.circuit.library.PauliFeatureMap.save_amplitudes" signature="save_amplitudes(params, label='amplitudes', pershot=False, conditional=False)">
  ...
  <Function id="qiskit.circuit.library.PauliFeatureMap.save_amplitudes_squared" signature="save_amplitudes_squared(params, label='amplitudes_squared', unnormalized=False, pershot=False, conditional=False)">
  ...
  <Function id="qiskit.circuit.library.PauliFeatureMap.save_density_matrix" signature="save_density_matrix(qubits=None, label='density_matrix', unnormalized=False, pershot=False, conditional=False)">
  ...
  <Function id="qiskit.circuit.library.PauliFeatureMap.save_expectation_value" signature="save_expectation_value(operator, qubits, label='expectation_value', unnormalized=False, pershot=False, conditional=False)">
  ...
  <Function id="qiskit.circuit.library.PauliFeatureMap.save_expectation_value_variance" signature="save_expectation_value_variance(operator, qubits, label='expectation_value_variance', unnormalized=False, pershot=False, conditional=False)">
    Save the expectation value of a Hermitian operator.
  ...
  <Function id="qiskit.circuit.library.PauliFeatureMap.save_matrix_product_state" signature="save_matrix_product_state(label='matrix_product_state', pershot=False, conditional=False)">
  ...
  <Function id="qiskit.circuit.library.PauliFeatureMap.save_probabilities" signature="save_probabilities(qubits=None, label='probabilities', unnormalized=False, pershot=False, conditional=False)">
  ...
  <Function id="qiskit.circuit.library.PauliFeatureMap.save_probabilities_dict" signature="save_probabilities_dict(qubits=None, label='probabilities', unnormalized=False, pershot=False, conditional=False)">
    Save measurement outcome probabilities vector.
  ...
  <Function id="qiskit.circuit.library.PauliFeatureMap.save_stabilizer" signature="save_stabilizer(label='stabilizer', pershot=False, conditional=False)">
  ...
  <Function id="qiskit.circuit.library.PauliFeatureMap.save_state" signature="save_state(label=None, pershot=False, conditional=False)">
  ...
  <Function id="qiskit.circuit.library.PauliFeatureMap.save_statevector" signature="save_statevector(label='statevector', pershot=False, conditional=False)">
  ...
  <Function id="qiskit.circuit.library.PauliFeatureMap.save_statevector_dict" signature="save_statevector_dict(label='statevector', pershot=False, conditional=False)">
  ...
  <Function id="qiskit.circuit.library.PauliFeatureMap.save_superop" signature="save_superop(label='superop', pershot=False)">
  ...
  <Function id="qiskit.circuit.library.PauliFeatureMap.save_unitary" signature="save_unitary(label='unitary', pershot=False)">
  ...
  <Function id="qiskit.circuit.library.PauliFeatureMap.set_density_matrix" signature="set_density_matrix(state)">
  ...
  <Function id="qiskit.circuit.library.PauliFeatureMap.set_matrix_product_state" signature="set_matrix_product_state(state)">
  ...
  <Function id="qiskit.circuit.library.PauliFeatureMap.set_stabilizer" signature="set_stabilizer(state)">
  ...
  <Function id="qiskit.circuit.library.PauliFeatureMap.set_statevector" signature="set_statevector(state)">
  ...
  <Function id="qiskit.circuit.library.PauliFeatureMap.set_superop" signature="set_superop(state)">
  ...
  <Function id="qiskit.circuit.library.PauliFeatureMap.set_unitary" signature="set_unitary(state)">
  ...
  <Function id="qiskit.circuit.library.PauliFeatureMap.tensor" signature="tensor(other, inplace=False)">
