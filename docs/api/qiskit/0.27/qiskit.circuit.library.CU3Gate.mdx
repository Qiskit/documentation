...
<Class id="qiskit.circuit.library.CU3Gate" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.17/qiskit/circuit/library/standard_gates/u3.py" signature="CU3Gate(theta, phi, lam, label=None, ctrl_state=None)">
...
$$
  ...
  <Function id="qiskit.circuit.library.CU3Gate.__init__" name="__init__" signature="__init__(theta, phi, lam, label=None, ctrl_state=None)">
    Create new CU3 gate.
  </Function>
  ...
  <Function id="qiskit.circuit.library.CU3Gate.add_decomposition" name="add_decomposition" signature="add_decomposition(decomposition)">
    Add a decomposition of the instruction to the SessionEquivalenceLibrary.
  </Function>

  ### assemble

  <Function id="qiskit.circuit.library.CU3Gate.assemble" name="assemble" signature="assemble()">
  ...
  <Function id="qiskit.circuit.library.CU3Gate.broadcast_arguments" name="broadcast_arguments" signature="broadcast_arguments(qargs, cargs)">
  ...
  <Function id="qiskit.circuit.library.CU3Gate.c_if" name="c_if" signature="c_if(classical, val)">
    Add classical condition on register classical and value val.
  </Function>

  ### control

  <Function id="qiskit.circuit.library.CU3Gate.control" name="control" signature="control(num_ctrl_qubits=1, label=None, ctrl_state=None)">
  ...
  <Function id="qiskit.circuit.library.CU3Gate.copy" name="copy" signature="copy(name=None)">
  ...
  <Function id="qiskit.circuit.library.CU3Gate.ctrl_state" name="ctrl_state" signature="property ctrl_state">
  ...
  <Function id="qiskit.circuit.library.CU3Gate.decompositions" name="decompositions" signature="property decompositions">
    Get the decompositions of the instruction from the SessionEquivalenceLibrary.
  </Function>

  ### definition

  <Function id="qiskit.circuit.library.CU3Gate.definition" name="definition" signature="property definition">
  ...
  <Function id="qiskit.circuit.library.CU3Gate.duration" name="duration" signature="property duration">
    Get the duration.
  </Function>

  ### inverse

  <Function id="qiskit.circuit.library.CU3Gate.inverse" name="inverse" signature="inverse()">
  ...
  <Function id="qiskit.circuit.library.CU3Gate.is_parameterized" name="is_parameterized" signature="is_parameterized()">
    Return True .IFF. instruction is parameterized else False
  </Function>

  ### label

  <Function id="qiskit.circuit.library.CU3Gate.label" name="label" signature="property label">
    Return gate label
  ...
  <Function id="qiskit.circuit.library.CU3Gate.mirror" name="mirror" signature="mirror()">
  ...
  <Function id="qiskit.circuit.library.CU3Gate.name" name="name" signature="property name">
  ...
  <Function id="qiskit.circuit.library.CU3Gate.num_ctrl_qubits" name="num_ctrl_qubits" signature="property num_ctrl_qubits">
  ...
  <Function id="qiskit.circuit.library.CU3Gate.params" name="params" signature="property params">
  ...
  <Function id="qiskit.circuit.library.CU3Gate.power" name="power" signature="power(exponent)">
  ...
  <Function id="qiskit.circuit.library.CU3Gate.qasm" name="qasm" signature="qasm()">
  ...
  <Function id="qiskit.circuit.library.CU3Gate.repeat" name="repeat" signature="repeat(n)">
  ...
  <Function id="qiskit.circuit.library.CU3Gate.reverse_ops" name="reverse_ops" signature="reverse_ops()">
  ...
  <Function id="qiskit.circuit.library.CU3Gate.soft_compare" name="soft_compare" signature="soft_compare(other)">
  ...
  <Function id="qiskit.circuit.library.CU3Gate.to_matrix" name="to_matrix" signature="to_matrix()">
  ...
  <Function id="qiskit.circuit.library.CU3Gate.unit" name="unit" signature="property unit">
    Get the time unit of duration.
  </Function>

  ### validate\_parameter

  <Function id="qiskit.circuit.library.CU3Gate.validate_parameter" name="validate_parameter" signature="validate_parameter(parameter)">
