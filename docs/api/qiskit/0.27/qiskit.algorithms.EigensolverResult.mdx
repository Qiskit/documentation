...
<Class id="qiskit.algorithms.EigensolverResult" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.17/qiskit/algorithms/eigen_solvers/eigen_solver.py" signature="EigensolverResult">
  Eigensolver Result.

  ### \_\_init\_\_

  <Function id="qiskit.algorithms.EigensolverResult.__init__" name="__init__" signature="__init__()">
  ...
  <Function id="qiskit.algorithms.EigensolverResult.aux_operator_eigenvalues" name="aux_operator_eigenvalues" signature="property aux_operator_eigenvalues">
  ...
  <Function id="qiskit.algorithms.EigensolverResult.combine" name="combine" signature="combine(result)">
  ...
  <Function id="qiskit.algorithms.EigensolverResult.eigenstates" name="eigenstates" signature="property eigenstates">
    return eigen states
  ...
  <Function id="qiskit.algorithms.EigensolverResult.eigenvalues" name="eigenvalues" signature="property eigenvalues">
