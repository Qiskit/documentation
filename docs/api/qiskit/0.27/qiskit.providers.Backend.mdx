...
<Class id="qiskit.providers.Backend" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.17/qiskit/providers/backend.py" signature="Backend">
  ...
  <Function id="qiskit.providers.Backend.__init__" name="__init__" signature="__init__()">
