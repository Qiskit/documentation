...
<Class id="qiskit.optimization.algorithms.MinimumEigenOptimizationResult" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/optimization/algorithms/minimum_eigen_optimizer.py" signature="MinimumEigenOptimizationResult(x, fval, variables, status, samples=None, min_eigen_solver_result=None, raw_samples=None)" modifiers="class">
  ...
  *   **raw\_samples** (`Optional`\[`List`\[`SolutionSample`]]) – the x values of the QUBO, the objective function value of the QUBO, and the probability of sampling.
  ...
  <Function id="qiskit.optimization.algorithms.MinimumEigenOptimizationResult.fval" signature="fval" modifiers="property">
  ...
  <Function id="qiskit.optimization.algorithms.MinimumEigenOptimizationResult.min_eigen_solver_result" signature="min_eigen_solver_result" modifiers="property">
  ...
  <Function id="qiskit.optimization.algorithms.MinimumEigenOptimizationResult.raw_results" signature="raw_results" modifiers="property">
  ...
  <Function id="qiskit.optimization.algorithms.MinimumEigenOptimizationResult.raw_samples" signature="raw_samples" modifiers="property">
  ...
  <Function id="qiskit.optimization.algorithms.MinimumEigenOptimizationResult.samples" signature="samples" modifiers="property">
  ...
  <Function id="qiskit.optimization.algorithms.MinimumEigenOptimizationResult.status" signature="status" modifiers="property">
  ...
  <Function id="qiskit.optimization.algorithms.MinimumEigenOptimizationResult.variable_names" signature="variable_names" modifiers="property">
  ...
  <Function id="qiskit.optimization.algorithms.MinimumEigenOptimizationResult.variables" signature="variables" modifiers="property">
  ...
  <Function id="qiskit.optimization.algorithms.MinimumEigenOptimizationResult.variables_dict" signature="variables_dict" modifiers="property">
  ...
  <Function id="qiskit.optimization.algorithms.MinimumEigenOptimizationResult.x" signature="x" modifiers="property">
