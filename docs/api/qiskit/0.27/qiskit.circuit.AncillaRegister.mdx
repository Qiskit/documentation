...
<Class id="qiskit.circuit.AncillaRegister" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.17/qiskit/circuit/quantumregister.py" signature="AncillaRegister(size=None, name=None, bits=None)" modifiers="class">
  ...
  *   **CircuitError** – if `bits` contained bits of an incorrect type.
  ...
  <Function id="qiskit.circuit.AncillaRegister.name" signature="name" modifiers="property">
  ...
  <Function id="qiskit.circuit.AncillaRegister.size" signature="size" modifiers="property">
