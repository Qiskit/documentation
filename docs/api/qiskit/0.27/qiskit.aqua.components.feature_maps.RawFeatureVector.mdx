...
<Class id="qiskit.aqua.components.feature_maps.RawFeatureVector" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/aqua/components/feature_maps/raw_feature_vector.py" signature="RawFeatureVector(feature_dimension=2)" modifiers="class">
  ...
  **feature\_dimension** (`int`) – The feature dimension, has a minimum value of 1.
  ...
  <Function id="qiskit.aqua.components.feature_maps.RawFeatureVector.feature_dimension" signature="feature_dimension" modifiers="property">
  ...
  <Function id="qiskit.aqua.components.feature_maps.RawFeatureVector.num_qubits" signature="num_qubits" modifiers="property">
    returns number of qubits
  </Function>

  ### support\_parameterized\_circuit

  <Function id="qiskit.aqua.components.feature_maps.RawFeatureVector.support_parameterized_circuit" signature="support_parameterized_circuit" modifiers="property">
