...
<Class id="qiskit.transpiler.passes.Optimize1qGates" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.17/qiskit/transpiler/passes/optimization/optimize_1q_gates.py" signature="Optimize1qGates(*args, **kwargs)">
  ...
  *   **eps** (*float*) – EPS to check against
  ...
  <Function id="qiskit.transpiler.passes.Optimize1qGates.compose_u3" signature="static compose_u3(theta1, phi1, lambda1, theta2, phi2, lambda2)">
  ...
  <Function id="qiskit.transpiler.passes.Optimize1qGates.is_analysis_pass" signature="property is_analysis_pass">
  ...
  <Function id="qiskit.transpiler.passes.Optimize1qGates.is_transformation_pass" signature="property is_transformation_pass">
  ...
  <Function id="qiskit.transpiler.passes.Optimize1qGates.yzy_to_zyz" signature="static yzy_to_zyz(xi, theta1, theta2, eps=1e-09)">
