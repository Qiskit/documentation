---
title: PauliSumOp (v0.27)
description: API reference for qiskit.opflow.primitive_ops.PauliSumOp in qiskit v0.27
in_page_toc_min_heading_level: 1
python_api_type: class
python_api_name: qiskit.opflow.primitive_ops.PauliSumOp
---

<span id="qiskit-opflow-primitive-ops-paulisumop" />
