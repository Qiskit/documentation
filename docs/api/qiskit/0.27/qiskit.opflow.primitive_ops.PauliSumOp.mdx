...
<Class id="qiskit.opflow.primitive_ops.PauliSumOp" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.17/qiskit/opflow/primitive_ops/pauli_sum_op.py" signature="PauliSumOp(primitive, coeff=1.0, grouping_type='None')">
  ...
  **TypeError** – invalid parameters.
  ...
  <Function id="qiskit.opflow.primitive_ops.PauliSumOp.__init__" name="__init__" signature="__init__(primitive, coeff=1.0, grouping_type='None')">
    **Parameters**
  ...
  <Function id="qiskit.opflow.primitive_ops.PauliSumOp.add" name="add" signature="add(other)">
  ...
  <Function id="qiskit.opflow.primitive_ops.PauliSumOp.adjoint" name="adjoint" signature="adjoint()">
  ...
  <Function id="qiskit.opflow.primitive_ops.PauliSumOp.assign_parameters" name="assign_parameters" signature="assign_parameters(param_dict)">
  ...
  <Function id="qiskit.opflow.primitive_ops.PauliSumOp.bind_parameters" name="bind_parameters" signature="bind_parameters(param_dict)">
  ...
  <Function id="qiskit.opflow.primitive_ops.PauliSumOp.coeff" name="coeff" signature="property coeff">
  ...
  <Function id="qiskit.opflow.primitive_ops.PauliSumOp.coeffs" name="coeffs" signature="property coeffs">
    Return the Pauli coefficients.
  </Function>

  ### compose

  <Function id="qiskit.opflow.primitive_ops.PauliSumOp.compose" name="compose" signature="compose(other, permutation=None, front=False)">
  ...
  <Function id="qiskit.opflow.primitive_ops.PauliSumOp.copy" name="copy" signature="copy()">
  ...
  <Function id="qiskit.opflow.primitive_ops.PauliSumOp.equals" name="equals" signature="equals(other)">
  ...
  <Function id="qiskit.opflow.primitive_ops.PauliSumOp.eval" name="eval" signature="eval(front=None)">
  ...
  <Function id="qiskit.opflow.primitive_ops.PauliSumOp.exp_i" name="exp_i" signature="exp_i()">
  ...
  <Function id="qiskit.opflow.primitive_ops.PauliSumOp.from_list" name="from_list" signature="classmethod from_list(pauli_list, coeff=1.0)">
  ...
  <Function id="qiskit.opflow.primitive_ops.PauliSumOp.grouping_type" name="grouping_type" signature="property grouping_type">
    Type of Grouping
  ...
  <Function id="qiskit.opflow.primitive_ops.PauliSumOp.instance_id" name="instance_id" signature="property instance_id">
  ...
  <Function id="qiskit.opflow.primitive_ops.PauliSumOp.is_zero" name="is_zero" signature="is_zero()">
  ...
  <Function id="qiskit.opflow.primitive_ops.PauliSumOp.log_i" name="log_i" signature="log_i(massive=False)">
  ...
  <Function id="qiskit.opflow.primitive_ops.PauliSumOp.matrix_iter" name="matrix_iter" signature="matrix_iter(sparse=False)">
  ...
  <Function id="qiskit.opflow.primitive_ops.PauliSumOp.mul" name="mul" signature="mul(scalar)">
  ...
  <Function id="qiskit.opflow.primitive_ops.PauliSumOp.neg" name="neg" signature="neg()">
  ...
  <Function id="qiskit.opflow.primitive_ops.PauliSumOp.num_qubits" name="num_qubits" signature="property num_qubits">
  ...
  <Function id="qiskit.opflow.primitive_ops.PauliSumOp.parameters" name="parameters" signature="property parameters">
    Return a set of Parameter objects contained in the Operator.
  </Function>

  ### permute

  <Function id="qiskit.opflow.primitive_ops.PauliSumOp.permute" name="permute" signature="permute(permutation)">
  ...
  <Function id="qiskit.opflow.primitive_ops.PauliSumOp.power" name="power" signature="power(exponent)">
  ...
  <Function id="qiskit.opflow.primitive_ops.PauliSumOp.primitive" name="primitive" signature="property primitive">
  ...
  <Function id="qiskit.opflow.primitive_ops.PauliSumOp.primitive_strings" name="primitive_strings" signature="primitive_strings()">
  ...
  <Function id="qiskit.opflow.primitive_ops.PauliSumOp.reduce" name="reduce" signature="reduce(atol=None, rtol=None)">
  ...
  <Function id="qiskit.opflow.primitive_ops.PauliSumOp.tensor" name="tensor" signature="tensor(other)">
  ...
  <Function id="qiskit.opflow.primitive_ops.PauliSumOp.tensorpower" name="tensorpower" signature="tensorpower(other)">
  ...
  <Function id="qiskit.opflow.primitive_ops.PauliSumOp.to_circuit" name="to_circuit" signature="to_circuit()">
  ...
  <Function id="qiskit.opflow.primitive_ops.PauliSumOp.to_circuit_op" name="to_circuit_op" signature="to_circuit_op()">
  ...
  <Function id="qiskit.opflow.primitive_ops.PauliSumOp.to_instruction" name="to_instruction" signature="to_instruction()">
  ...
  <Function id="qiskit.opflow.primitive_ops.PauliSumOp.to_matrix" name="to_matrix" signature="to_matrix(massive=False)">
  ...
  <Function id="qiskit.opflow.primitive_ops.PauliSumOp.to_matrix_op" name="to_matrix_op" signature="to_matrix_op(massive=False)">
  ...
  <Function id="qiskit.opflow.primitive_ops.PauliSumOp.to_pauli_op" name="to_pauli_op" signature="to_pauli_op(massive=False)">
  ...
  <Function id="qiskit.opflow.primitive_ops.PauliSumOp.to_spmatrix" name="to_spmatrix" signature="to_spmatrix()">
