...
<Class id="qiskit.opflow.converters.ConverterBase" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.17/qiskit/opflow/converters/converter_base.py" signature="ConverterBase">
  ...
  <Function id="qiskit.opflow.converters.ConverterBase.__init__" name="__init__" signature="__init__()">
