...
<Class id="qiskit.opflow.gradients.CircuitQFI" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.17/qiskit/opflow/gradients/circuit_qfis/circuit_qfi.py" signature="CircuitQFI">
  ...
  <Function id="qiskit.opflow.gradients.CircuitQFI.__init__" name="__init__" signature="__init__()">
  ...
  <Function id="qiskit.opflow.gradients.CircuitQFI.convert" name="convert" signature="abstract convert(operator, params)">
    **Parameters**
