...
<Class id="qiskit.aqua.operators.converters.ConverterBase" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/aqua/operators/converters/converter_base.py" signature="ConverterBase">
  ...
  <Function id="qiskit.aqua.operators.converters.ConverterBase.__init__" name="__init__" signature="__init__()">
  ...
  <Function id="qiskit.aqua.operators.converters.ConverterBase.convert" name="convert" signature="abstract convert(operator)">
