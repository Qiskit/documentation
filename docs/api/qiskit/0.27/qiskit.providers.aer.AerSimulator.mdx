---
title: AerSimulator (v0.27)
description: API reference for qiskit.providers.aer.AerSimulator in qiskit v0.27
...
<Class id="qiskit.providers.aer.AerSimulator" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-aer/tree/stable/0.8/qiskit/providers/aer/backends/aer_simulator.py" signature="AerSimulator(configuration=None, properties=None, provider=None, **backend_options)" modifiers="class">
  ...
  **Raises**
  ...
  <Function id="qiskit.providers.aer.AerSimulator.__init__" signature="__init__(configuration=None, properties=None, provider=None, **backend_options)">
    Aer class for backends.
  ...
  <Function id="qiskit.providers.aer.AerSimulator.available_devices" signature="available_devices()">
    Return the available simulation methods.
  </Function>

  ### available\_methods

  <Function id="qiskit.providers.aer.AerSimulator.available_methods" signature="available_methods()">
    Return the available simulation methods.
  </Function>

  ### clear\_options

  <Function id="qiskit.providers.aer.AerSimulator.clear_options" signature="clear_options()">
    Reset the simulator options to default values.
  </Function>

  ### configuration

  <Function id="qiskit.providers.aer.AerSimulator.configuration" signature="configuration()">
  ...
  <Function id="qiskit.providers.aer.AerSimulator.defaults" signature="defaults()">
  ...
  <Function id="qiskit.providers.aer.AerSimulator.from_backend" signature="from_backend(backend, **options)" modifiers="classmethod">
    Initialize simulator from backend.
  </Function>

  ### name

  <Function id="qiskit.providers.aer.AerSimulator.name" signature="name()">
  ...
  <Function id="qiskit.providers.aer.AerSimulator.properties" signature="properties()">
  ...
  <Function id="qiskit.providers.aer.AerSimulator.provider" signature="provider()">
  ...
  <Function id="qiskit.providers.aer.AerSimulator.run" signature="run(circuits, backend_options=None, validate=False, **run_options)">
  ...
  <Function id="qiskit.providers.aer.AerSimulator.set_option" signature="set_option(key, value)">
  ...
  <Function id="qiskit.providers.aer.AerSimulator.set_options" signature="set_options(**fields)">
  ...
  <Function id="qiskit.providers.aer.AerSimulator.status" signature="status()">
