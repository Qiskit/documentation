...
|                                                                                                                                                        |                                                                                                                                                                               |
| ------------------------------------------------------------------------------------------------------------------------------------------------------ | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [`__init__`](#qiskit.opflow.primitive_ops.CircuitOp.__init__ "qiskit.opflow.primitive_ops.CircuitOp.__init__")(primitive\[, coeff])                    | **type primitive**`Union`\[`Instruction`, `QuantumCircuit`]                                                                                                                   |
| [`add`](#qiskit.opflow.primitive_ops.CircuitOp.add "qiskit.opflow.primitive_ops.CircuitOp.add")(other)                                                 | Return Operator addition of self and other, overloaded by `+`.                                                                                                                |
...
| [`assign_parameters`](#qiskit.opflow.primitive_ops.CircuitOp.assign_parameters "qiskit.opflow.primitive_ops.CircuitOp.assign_parameters")(param\_dict) | Binds scalar values to any Terra `Parameters` in the coefficients or primitives of the Operator, or substitutes one `Parameter` for another.                                  |
| [`bind_parameters`](#qiskit.opflow.primitive_ops.CircuitOp.bind_parameters "qiskit.opflow.primitive_ops.CircuitOp.bind_parameters")(param\_dict)       | Same as assign\_parameters, but maintained for consistency with QuantumCircuit in Terra (which has both assign\_parameters and bind\_parameters).                             |
| [`compose`](#qiskit.opflow.primitive_ops.CircuitOp.compose "qiskit.opflow.primitive_ops.CircuitOp.compose")(other\[, permutation, front])              | Return Operator Composition between self and other (linear algebra-style: A\@B(x) = A(B(x))), overloaded by `@`.                                                              |
| [`copy`](#qiskit.opflow.primitive_ops.CircuitOp.copy "qiskit.opflow.primitive_ops.CircuitOp.copy")()                                                   | Return a deep copy of the Operator.                                                                                                                                           |
| [`equals`](#qiskit.opflow.primitive_ops.CircuitOp.equals "qiskit.opflow.primitive_ops.CircuitOp.equals")(other)                                        | Evaluate Equality between Operators, overloaded by `==`.                                                                                                                      |
| [`eval`](#qiskit.opflow.primitive_ops.CircuitOp.eval "qiskit.opflow.primitive_ops.CircuitOp.eval")(\[front])                                           | Evaluate the Operator’s underlying function, either on a binary string or another Operator.                                                                                   |
| [`exp_i`](#qiskit.opflow.primitive_ops.CircuitOp.exp_i "qiskit.opflow.primitive_ops.CircuitOp.exp_i")()                                                | Return Operator exponentiation, equaling e^(-i \* op)                                                                                                                         |
| [`log_i`](#qiskit.opflow.primitive_ops.CircuitOp.log_i "qiskit.opflow.primitive_ops.CircuitOp.log_i")(\[massive])                                      | Return a `MatrixOp` equivalent to log(H)/-i for this operator H.                                                                                                              |
| [`mul`](#qiskit.opflow.primitive_ops.CircuitOp.mul "qiskit.opflow.primitive_ops.CircuitOp.mul")(scalar)                                                | Returns the scalar multiplication of the Operator, overloaded by `*`, including support for Terra’s `Parameters`, which can be bound to values later (via `bind_parameters`). |
| [`neg`](#qiskit.opflow.primitive_ops.CircuitOp.neg "qiskit.opflow.primitive_ops.CircuitOp.neg")()                                                      | Return the Operator’s negation, effectively just multiplying by -1.0, overloaded by `-`.                                                                                      |
| [`permute`](#qiskit.opflow.primitive_ops.CircuitOp.permute "qiskit.opflow.primitive_ops.CircuitOp.permute")(permutation)                               | Permute the qubits of the circuit.                                                                                                                                            |
| [`power`](#qiskit.opflow.primitive_ops.CircuitOp.power "qiskit.opflow.primitive_ops.CircuitOp.power")(exponent)                                        | Return Operator composed with self multiple times, overloaded by `**`.                                                                                                        |
...
| [`tensor`](#qiskit.opflow.primitive_ops.CircuitOp.tensor "qiskit.opflow.primitive_ops.CircuitOp.tensor")(other)                                        | Return tensor product between self and other, overloaded by `^`.                                                                                                              |
| [`tensorpower`](#qiskit.opflow.primitive_ops.CircuitOp.tensorpower "qiskit.opflow.primitive_ops.CircuitOp.tensorpower")(other)                         | Return tensor product with self multiple times, overloaded by `^`.                                                                                                            |
...
| [`to_matrix`](#qiskit.opflow.primitive_ops.CircuitOp.to_matrix "qiskit.opflow.primitive_ops.CircuitOp.to_matrix")(\[massive])                          | Return NumPy representation of the Operator.                                                                                                                                  |
| [`to_matrix_op`](#qiskit.opflow.primitive_ops.CircuitOp.to_matrix_op "qiskit.opflow.primitive_ops.CircuitOp.to_matrix_op")(\[massive])                 | Returns a `MatrixOp` equivalent to this Operator.                                                                                                                             |
| [`to_pauli_op`](#qiskit.opflow.primitive_ops.CircuitOp.to_pauli_op "qiskit.opflow.primitive_ops.CircuitOp.to_pauli_op")(\[massive])                    | Returns a sum of `PauliOp` s equivalent to this Operator.                                                                                                                     |
| [`to_spmatrix`](#qiskit.opflow.primitive_ops.CircuitOp.to_spmatrix "qiskit.opflow.primitive_ops.CircuitOp.to_spmatrix")()                              | Return SciPy sparse matrix representation of the Operator.                                                                                                                    |
...
| ----------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------- |
| `INDENTATION`                                                                                                           |                                                                 |
| [`coeff`](#qiskit.opflow.primitive_ops.CircuitOp.coeff "qiskit.opflow.primitive_ops.CircuitOp.coeff")                   | The scalar coefficient multiplying the Operator.                |
| [`instance_id`](#qiskit.opflow.primitive_ops.CircuitOp.instance_id "qiskit.opflow.primitive_ops.CircuitOp.instance_id") | Return the unique instance id.                                  |
| [`num_qubits`](#qiskit.opflow.primitive_ops.CircuitOp.num_qubits "qiskit.opflow.primitive_ops.CircuitOp.num_qubits")    | The number of qubits over which the Operator is defined.        |
