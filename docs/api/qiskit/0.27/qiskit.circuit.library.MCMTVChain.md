...
`MCMTVChain(gate, num_ctrl_qubits, num_target_qubits, label=None)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.17/qiskit/circuit/library/generalized_gates/mcmt.py "view source code")
...
![../\_images/qiskit.circuit.library.MCMTVChain\_0\_1.png](/images/api/qiskit/0.27/qiskit.circuit.library.MCMTVChain_0_1.png)
...
<span id="qiskit.circuit.library.MCMTVChain.__init__" />

`__init__(gate, num_ctrl_qubits, num_target_qubits, label=None)`
...
|                                                                                                                                                                                               |                                                                                                                                     |
| --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------- |
| [`__init__`](#qiskit.circuit.library.MCMTVChain.__init__ "qiskit.circuit.library.MCMTVChain.__init__")(gate, num\_ctrl\_qubits, …\[, label])                                                  | Create a new multi-control multi-target gate.                                                                                       |
| [`add_bits`](#qiskit.circuit.library.MCMTVChain.add_bits "qiskit.circuit.library.MCMTVChain.add_bits")(bits)                                                                                  | Add Bits to the circuit.                                                                                                            |
| [`add_calibration`](#qiskit.circuit.library.MCMTVChain.add_calibration "qiskit.circuit.library.MCMTVChain.add_calibration")(gate, qubits, schedule\[, params])                                | Register a low-level, custom pulse definition for the given gate.                                                                   |
| [`add_register`](#qiskit.circuit.library.MCMTVChain.add_register "qiskit.circuit.library.MCMTVChain.add_register")(\*regs)                                                                    | Add registers.                                                                                                                      |
| [`append`](#qiskit.circuit.library.MCMTVChain.append "qiskit.circuit.library.MCMTVChain.append")(instruction\[, qargs, cargs])                                                                | Append one or more instructions to the end of the circuit, modifying the circuit in place.                                          |
| [`assign_parameters`](#qiskit.circuit.library.MCMTVChain.assign_parameters "qiskit.circuit.library.MCMTVChain.assign_parameters")(parameters\[, inplace, …])                                  | Assign parameters to new parameters or values.                                                                                      |
| [`barrier`](#qiskit.circuit.library.MCMTVChain.barrier "qiskit.circuit.library.MCMTVChain.barrier")(\*qargs)                                                                                  | Apply `Barrier`.                                                                                                                    |
| [`bind_parameters`](#qiskit.circuit.library.MCMTVChain.bind_parameters "qiskit.circuit.library.MCMTVChain.bind_parameters")(values\[, value\_dict])                                           | Assign numeric parameters to values yielding a new circuit.                                                                         |
| [`cast`](#qiskit.circuit.library.MCMTVChain.cast "qiskit.circuit.library.MCMTVChain.cast")(value, \_type)                                                                                     | Best effort to cast value to type.                                                                                                  |
| [`cbit_argument_conversion`](#qiskit.circuit.library.MCMTVChain.cbit_argument_conversion "qiskit.circuit.library.MCMTVChain.cbit_argument_conversion")(clbit\_representation)                 | Converts several classical bit representations (such as indexes, range, etc.) into a list of classical bits.                        |
| [`ccx`](#qiskit.circuit.library.MCMTVChain.ccx "qiskit.circuit.library.MCMTVChain.ccx")(control\_qubit1, control\_qubit2, target\_qubit)                                                      | Apply [`CCXGate`](qiskit.circuit.library.CCXGate "qiskit.circuit.library.CCXGate").                                                 |
| [`ch`](#qiskit.circuit.library.MCMTVChain.ch "qiskit.circuit.library.MCMTVChain.ch")(control\_qubit, target\_qubit\[, label, …])                                                              | Apply [`CHGate`](qiskit.circuit.library.CHGate "qiskit.circuit.library.CHGate").                                                    |
| [`cls_instances`](#qiskit.circuit.library.MCMTVChain.cls_instances "qiskit.circuit.library.MCMTVChain.cls_instances")()                                                                       | Return the current number of instances of this class, useful for auto naming.                                                       |
| [`cls_prefix`](#qiskit.circuit.library.MCMTVChain.cls_prefix "qiskit.circuit.library.MCMTVChain.cls_prefix")()                                                                                | Return the prefix to use for auto naming.                                                                                           |
| [`cnot`](#qiskit.circuit.library.MCMTVChain.cnot "qiskit.circuit.library.MCMTVChain.cnot")(control\_qubit, target\_qubit\[, label, …])                                                        | Apply [`CXGate`](qiskit.circuit.library.CXGate "qiskit.circuit.library.CXGate").                                                    |
| [`combine`](#qiskit.circuit.library.MCMTVChain.combine "qiskit.circuit.library.MCMTVChain.combine")(rhs)                                                                                      | DEPRECATED - Returns rhs appended to self if self contains compatible registers.                                                    |
| [`compose`](#qiskit.circuit.library.MCMTVChain.compose "qiskit.circuit.library.MCMTVChain.compose")(other\[, qubits, clbits, front, inplace])                                                 | Compose circuit with `other` circuit or instruction, optionally permuting wires.                                                    |
| [`control`](#qiskit.circuit.library.MCMTVChain.control "qiskit.circuit.library.MCMTVChain.control")(\[num\_ctrl\_qubits, label, ctrl\_state])                                                 | Return the controlled version of the MCMT circuit.                                                                                  |
| [`copy`](#qiskit.circuit.library.MCMTVChain.copy "qiskit.circuit.library.MCMTVChain.copy")(\[name])                                                                                           | Copy the circuit.                                                                                                                   |
| [`count_ops`](#qiskit.circuit.library.MCMTVChain.count_ops "qiskit.circuit.library.MCMTVChain.count_ops")()                                                                                   | Count each operation kind in the circuit.                                                                                           |
| [`cp`](#qiskit.circuit.library.MCMTVChain.cp "qiskit.circuit.library.MCMTVChain.cp")(theta, control\_qubit, target\_qubit\[, …])                                                              | Apply [`CPhaseGate`](qiskit.circuit.library.CPhaseGate "qiskit.circuit.library.CPhaseGate").                                        |
| [`crx`](#qiskit.circuit.library.MCMTVChain.crx "qiskit.circuit.library.MCMTVChain.crx")(theta, control\_qubit, target\_qubit\[, …])                                                           | Apply [`CRXGate`](qiskit.circuit.library.CRXGate "qiskit.circuit.library.CRXGate").                                                 |
| [`cry`](#qiskit.circuit.library.MCMTVChain.cry "qiskit.circuit.library.MCMTVChain.cry")(theta, control\_qubit, target\_qubit\[, …])                                                           | Apply [`CRYGate`](qiskit.circuit.library.CRYGate "qiskit.circuit.library.CRYGate").                                                 |
| [`crz`](#qiskit.circuit.library.MCMTVChain.crz "qiskit.circuit.library.MCMTVChain.crz")(theta, control\_qubit, target\_qubit\[, …])                                                           | Apply [`CRZGate`](qiskit.circuit.library.CRZGate "qiskit.circuit.library.CRZGate").                                                 |
| [`cswap`](#qiskit.circuit.library.MCMTVChain.cswap "qiskit.circuit.library.MCMTVChain.cswap")(control\_qubit, target\_qubit1, …\[, …])                                                        | Apply [`CSwapGate`](qiskit.circuit.library.CSwapGate "qiskit.circuit.library.CSwapGate").                                           |
| [`csx`](#qiskit.circuit.library.MCMTVChain.csx "qiskit.circuit.library.MCMTVChain.csx")(control\_qubit, target\_qubit\[, label, …])                                                           | Apply [`CSXGate`](qiskit.circuit.library.CSXGate "qiskit.circuit.library.CSXGate").                                                 |
| [`cu`](#qiskit.circuit.library.MCMTVChain.cu "qiskit.circuit.library.MCMTVChain.cu")(theta, phi, lam, gamma, control\_qubit, …)                                                               | Apply [`CUGate`](qiskit.circuit.library.CUGate "qiskit.circuit.library.CUGate").                                                    |
| [`cu1`](#qiskit.circuit.library.MCMTVChain.cu1 "qiskit.circuit.library.MCMTVChain.cu1")(theta, control\_qubit, target\_qubit\[, …])                                                           | Apply [`CU1Gate`](qiskit.circuit.library.CU1Gate "qiskit.circuit.library.CU1Gate").                                                 |
| [`cu3`](#qiskit.circuit.library.MCMTVChain.cu3 "qiskit.circuit.library.MCMTVChain.cu3")(theta, phi, lam, control\_qubit, target\_qubit)                                                       | Apply [`CU3Gate`](qiskit.circuit.library.CU3Gate "qiskit.circuit.library.CU3Gate").                                                 |
| [`cx`](#qiskit.circuit.library.MCMTVChain.cx "qiskit.circuit.library.MCMTVChain.cx")(control\_qubit, target\_qubit\[, label, …])                                                              | Apply [`CXGate`](qiskit.circuit.library.CXGate "qiskit.circuit.library.CXGate").                                                    |
| [`cy`](#qiskit.circuit.library.MCMTVChain.cy "qiskit.circuit.library.MCMTVChain.cy")(control\_qubit, target\_qubit\[, label, …])                                                              | Apply [`CYGate`](qiskit.circuit.library.CYGate "qiskit.circuit.library.CYGate").                                                    |
| [`cz`](#qiskit.circuit.library.MCMTVChain.cz "qiskit.circuit.library.MCMTVChain.cz")(control\_qubit, target\_qubit\[, label, …])                                                              | Apply [`CZGate`](qiskit.circuit.library.CZGate "qiskit.circuit.library.CZGate").                                                    |
| [`dcx`](#qiskit.circuit.library.MCMTVChain.dcx "qiskit.circuit.library.MCMTVChain.dcx")(qubit1, qubit2)                                                                                       | Apply [`DCXGate`](qiskit.circuit.library.DCXGate "qiskit.circuit.library.DCXGate").                                                 |
| [`decompose`](#qiskit.circuit.library.MCMTVChain.decompose "qiskit.circuit.library.MCMTVChain.decompose")()                                                                                   | Call a decomposition pass on this circuit, to decompose one level (shallow decompose).                                              |
| [`delay`](#qiskit.circuit.library.MCMTVChain.delay "qiskit.circuit.library.MCMTVChain.delay")(duration\[, qarg, unit])                                                                        | Apply [`Delay`](qiskit.circuit.Delay "qiskit.circuit.Delay").                                                                       |
| [`depth`](#qiskit.circuit.library.MCMTVChain.depth "qiskit.circuit.library.MCMTVChain.depth")()                                                                                               | Return circuit depth (i.e., length of critical path).                                                                               |
| [`diagonal`](#qiskit.circuit.library.MCMTVChain.diagonal "qiskit.circuit.library.MCMTVChain.diagonal")(diag, qubit)                                                                           | Attach a diagonal gate to a circuit.                                                                                                |
| [`draw`](#qiskit.circuit.library.MCMTVChain.draw "qiskit.circuit.library.MCMTVChain.draw")(\[output, scale, filename, style, …])                                                              | Draw the quantum circuit.                                                                                                           |
| [`ecr`](#qiskit.circuit.library.MCMTVChain.ecr "qiskit.circuit.library.MCMTVChain.ecr")(qubit1, qubit2)                                                                                       | Apply [`ECRGate`](qiskit.circuit.library.ECRGate "qiskit.circuit.library.ECRGate").                                                 |
| [`extend`](#qiskit.circuit.library.MCMTVChain.extend "qiskit.circuit.library.MCMTVChain.extend")(rhs)                                                                                         | DEPRECATED - Append QuantumCircuit to the RHS if it contains compatible registers.                                                  |
| [`fredkin`](#qiskit.circuit.library.MCMTVChain.fredkin "qiskit.circuit.library.MCMTVChain.fredkin")(control\_qubit, target\_qubit1, …)                                                        | Apply [`CSwapGate`](qiskit.circuit.library.CSwapGate "qiskit.circuit.library.CSwapGate").                                           |
| [`from_qasm_file`](#qiskit.circuit.library.MCMTVChain.from_qasm_file "qiskit.circuit.library.MCMTVChain.from_qasm_file")(path)                                                                | Take in a QASM file and generate a QuantumCircuit object.                                                                           |
| [`from_qasm_str`](#qiskit.circuit.library.MCMTVChain.from_qasm_str "qiskit.circuit.library.MCMTVChain.from_qasm_str")(qasm\_str)                                                              | Take in a QASM string and generate a QuantumCircuit object.                                                                         |
| [`h`](#qiskit.circuit.library.MCMTVChain.h "qiskit.circuit.library.MCMTVChain.h")(qubit)                                                                                                      | Apply [`HGate`](qiskit.circuit.library.HGate "qiskit.circuit.library.HGate").                                                       |
| [`hamiltonian`](#qiskit.circuit.library.MCMTVChain.hamiltonian "qiskit.circuit.library.MCMTVChain.hamiltonian")(operator, time, qubits\[, label])                                             | Apply hamiltonian evolution to qubits.                                                                                              |
| [`has_register`](#qiskit.circuit.library.MCMTVChain.has_register "qiskit.circuit.library.MCMTVChain.has_register")(register)                                                                  | Test if this circuit has the register r.                                                                                            |
| [`i`](#qiskit.circuit.library.MCMTVChain.i "qiskit.circuit.library.MCMTVChain.i")(qubit)                                                                                                      | Apply [`IGate`](qiskit.circuit.library.IGate "qiskit.circuit.library.IGate").                                                       |
| [`id`](#qiskit.circuit.library.MCMTVChain.id "qiskit.circuit.library.MCMTVChain.id")(qubit)                                                                                                   | Apply [`IGate`](qiskit.circuit.library.IGate "qiskit.circuit.library.IGate").                                                       |
| [`initialize`](#qiskit.circuit.library.MCMTVChain.initialize "qiskit.circuit.library.MCMTVChain.initialize")(params\[, qubits])                                                               | Initialize qubits in a specific state.                                                                                              |
...
| [`iso`](#qiskit.circuit.library.MCMTVChain.iso "qiskit.circuit.library.MCMTVChain.iso")(isometry, q\_input, q\_ancillas\_for\_output)                                                         | Attach an arbitrary isometry from m to n qubits to a circuit.                                                                       |
| [`isometry`](#qiskit.circuit.library.MCMTVChain.isometry "qiskit.circuit.library.MCMTVChain.isometry")(isometry, q\_input, …\[, …])                                                           | Attach an arbitrary isometry from m to n qubits to a circuit.                                                                       |
| [`iswap`](#qiskit.circuit.library.MCMTVChain.iswap "qiskit.circuit.library.MCMTVChain.iswap")(qubit1, qubit2)                                                                                 | Apply [`iSwapGate`](qiskit.circuit.library.iSwapGate "qiskit.circuit.library.iSwapGate").                                           |
| [`mcp`](#qiskit.circuit.library.MCMTVChain.mcp "qiskit.circuit.library.MCMTVChain.mcp")(lam, control\_qubits, target\_qubit)                                                                  | Apply [`MCPhaseGate`](qiskit.circuit.library.MCPhaseGate "qiskit.circuit.library.MCPhaseGate").                                     |
| [`mcrx`](#qiskit.circuit.library.MCMTVChain.mcrx "qiskit.circuit.library.MCMTVChain.mcrx")(theta, q\_controls, q\_target\[, …])                                                               | Apply Multiple-Controlled X rotation gate                                                                                           |
| [`mcry`](#qiskit.circuit.library.MCMTVChain.mcry "qiskit.circuit.library.MCMTVChain.mcry")(theta, q\_controls, q\_target\[, …])                                                               | Apply Multiple-Controlled Y rotation gate                                                                                           |
| [`mcrz`](#qiskit.circuit.library.MCMTVChain.mcrz "qiskit.circuit.library.MCMTVChain.mcrz")(lam, q\_controls, q\_target\[, …])                                                                 | Apply Multiple-Controlled Z rotation gate                                                                                           |
| [`mct`](#qiskit.circuit.library.MCMTVChain.mct "qiskit.circuit.library.MCMTVChain.mct")(control\_qubits, target\_qubit\[, …])                                                                 | Apply [`MCXGate`](qiskit.circuit.library.MCXGate "qiskit.circuit.library.MCXGate").                                                 |
| [`mcu1`](#qiskit.circuit.library.MCMTVChain.mcu1 "qiskit.circuit.library.MCMTVChain.mcu1")(lam, control\_qubits, target\_qubit)                                                               | Apply `MCU1Gate`.                                                                                                                   |
| [`mcx`](#qiskit.circuit.library.MCMTVChain.mcx "qiskit.circuit.library.MCMTVChain.mcx")(control\_qubits, target\_qubit\[, …])                                                                 | Apply [`MCXGate`](qiskit.circuit.library.MCXGate "qiskit.circuit.library.MCXGate").                                                 |
| [`measure`](#qiskit.circuit.library.MCMTVChain.measure "qiskit.circuit.library.MCMTVChain.measure")(qubit, cbit)                                                                              | Measure quantum bit into classical bit (tuples).                                                                                    |
| [`measure_active`](#qiskit.circuit.library.MCMTVChain.measure_active "qiskit.circuit.library.MCMTVChain.measure_active")(\[inplace])                                                          | Adds measurement to all non-idle qubits.                                                                                            |
| [`measure_all`](#qiskit.circuit.library.MCMTVChain.measure_all "qiskit.circuit.library.MCMTVChain.measure_all")(\[inplace])                                                                   | Adds measurement to all qubits.                                                                                                     |
| [`ms`](#qiskit.circuit.library.MCMTVChain.ms "qiskit.circuit.library.MCMTVChain.ms")(theta, qubits)                                                                                           | Apply [`MSGate`](qiskit.circuit.library.MSGate "qiskit.circuit.library.MSGate").                                                    |
| [`num_connected_components`](#qiskit.circuit.library.MCMTVChain.num_connected_components "qiskit.circuit.library.MCMTVChain.num_connected_components")(\[unitary\_only])                      | How many non-entangled subcircuits can the circuit be factored to.                                                                  |
| [`num_nonlocal_gates`](#qiskit.circuit.library.MCMTVChain.num_nonlocal_gates "qiskit.circuit.library.MCMTVChain.num_nonlocal_gates")()                                                        | Return number of non-local gates (i.e.                                                                                              |
| [`num_tensor_factors`](#qiskit.circuit.library.MCMTVChain.num_tensor_factors "qiskit.circuit.library.MCMTVChain.num_tensor_factors")()                                                        | Computes the number of tensor factors in the unitary (quantum) part of the circuit only.                                            |
| [`num_unitary_factors`](#qiskit.circuit.library.MCMTVChain.num_unitary_factors "qiskit.circuit.library.MCMTVChain.num_unitary_factors")()                                                     | Computes the number of tensor factors in the unitary (quantum) part of the circuit only.                                            |
| [`p`](#qiskit.circuit.library.MCMTVChain.p "qiskit.circuit.library.MCMTVChain.p")(theta, qubit)                                                                                               | Apply [`PhaseGate`](qiskit.circuit.library.PhaseGate "qiskit.circuit.library.PhaseGate").                                           |
| [`pauli`](#qiskit.circuit.library.MCMTVChain.pauli "qiskit.circuit.library.MCMTVChain.pauli")(pauli\_string, qubits)                                                                          | Apply `PauliGate`.                                                                                                                  |
| [`power`](#qiskit.circuit.library.MCMTVChain.power "qiskit.circuit.library.MCMTVChain.power")(power\[, matrix\_power])                                                                        | Raise this circuit to the power of `power`.                                                                                         |
| [`qasm`](#qiskit.circuit.library.MCMTVChain.qasm "qiskit.circuit.library.MCMTVChain.qasm")(\[formatted, filename])                                                                            | Return OpenQASM string.                                                                                                             |
| [`qbit_argument_conversion`](#qiskit.circuit.library.MCMTVChain.qbit_argument_conversion "qiskit.circuit.library.MCMTVChain.qbit_argument_conversion")(qubit\_representation)                 | Converts several qubit representations (such as indexes, range, etc.) into a list of qubits.                                        |
| [`qubit_duration`](#qiskit.circuit.library.MCMTVChain.qubit_duration "qiskit.circuit.library.MCMTVChain.qubit_duration")(\*qubits)                                                            | Return the duration between the start and stop time of the first and last instructions, excluding delays, over the supplied qubits. |
| [`qubit_start_time`](#qiskit.circuit.library.MCMTVChain.qubit_start_time "qiskit.circuit.library.MCMTVChain.qubit_start_time")(\*qubits)                                                      | Return the start time of the first instruction, excluding delays, over the supplied qubits.                                         |
| [`qubit_stop_time`](#qiskit.circuit.library.MCMTVChain.qubit_stop_time "qiskit.circuit.library.MCMTVChain.qubit_stop_time")(\*qubits)                                                         | Return the stop time of the last instruction, excluding delays, over the supplied qubits.                                           |
| [`r`](#qiskit.circuit.library.MCMTVChain.r "qiskit.circuit.library.MCMTVChain.r")(theta, phi, qubit)                                                                                          | Apply [`RGate`](qiskit.circuit.library.RGate "qiskit.circuit.library.RGate").                                                       |
| [`rcccx`](#qiskit.circuit.library.MCMTVChain.rcccx "qiskit.circuit.library.MCMTVChain.rcccx")(control\_qubit1, control\_qubit2, …)                                                            | Apply [`RC3XGate`](qiskit.circuit.library.RC3XGate "qiskit.circuit.library.RC3XGate").                                              |
| [`rccx`](#qiskit.circuit.library.MCMTVChain.rccx "qiskit.circuit.library.MCMTVChain.rccx")(control\_qubit1, control\_qubit2, …)                                                               | Apply [`RCCXGate`](qiskit.circuit.library.RCCXGate "qiskit.circuit.library.RCCXGate").                                              |
| [`remove_final_measurements`](#qiskit.circuit.library.MCMTVChain.remove_final_measurements "qiskit.circuit.library.MCMTVChain.remove_final_measurements")(\[inplace])                         | Removes final measurement on all qubits if they are present.                                                                        |
| [`repeat`](#qiskit.circuit.library.MCMTVChain.repeat "qiskit.circuit.library.MCMTVChain.repeat")(reps)                                                                                        | Repeat this circuit `reps` times.                                                                                                   |
| [`reset`](#qiskit.circuit.library.MCMTVChain.reset "qiskit.circuit.library.MCMTVChain.reset")(qubit)                                                                                          | Reset q.                                                                                                                            |
| [`reverse_bits`](#qiskit.circuit.library.MCMTVChain.reverse_bits "qiskit.circuit.library.MCMTVChain.reverse_bits")()                                                                          | Return a circuit with the opposite order of wires.                                                                                  |
| [`reverse_ops`](#qiskit.circuit.library.MCMTVChain.reverse_ops "qiskit.circuit.library.MCMTVChain.reverse_ops")()                                                                             | Reverse the circuit by reversing the order of instructions.                                                                         |
| [`rv`](#qiskit.circuit.library.MCMTVChain.rv "qiskit.circuit.library.MCMTVChain.rv")(vx, vy, vz, qubit)                                                                                       | Apply [`RVGate`](qiskit.circuit.library.RVGate "qiskit.circuit.library.RVGate").                                                    |
| [`rx`](#qiskit.circuit.library.MCMTVChain.rx "qiskit.circuit.library.MCMTVChain.rx")(theta, qubit\[, label])                                                                                  | Apply [`RXGate`](qiskit.circuit.library.RXGate "qiskit.circuit.library.RXGate").                                                    |
| [`rxx`](#qiskit.circuit.library.MCMTVChain.rxx "qiskit.circuit.library.MCMTVChain.rxx")(theta, qubit1, qubit2)                                                                                | Apply [`RXXGate`](qiskit.circuit.library.RXXGate "qiskit.circuit.library.RXXGate").                                                 |
| [`ry`](#qiskit.circuit.library.MCMTVChain.ry "qiskit.circuit.library.MCMTVChain.ry")(theta, qubit\[, label])                                                                                  | Apply [`RYGate`](qiskit.circuit.library.RYGate "qiskit.circuit.library.RYGate").                                                    |
| [`ryy`](#qiskit.circuit.library.MCMTVChain.ryy "qiskit.circuit.library.MCMTVChain.ryy")(theta, qubit1, qubit2)                                                                                | Apply [`RYYGate`](qiskit.circuit.library.RYYGate "qiskit.circuit.library.RYYGate").                                                 |
| [`rz`](#qiskit.circuit.library.MCMTVChain.rz "qiskit.circuit.library.MCMTVChain.rz")(phi, qubit)                                                                                              | Apply [`RZGate`](qiskit.circuit.library.RZGate "qiskit.circuit.library.RZGate").                                                    |
| [`rzx`](#qiskit.circuit.library.MCMTVChain.rzx "qiskit.circuit.library.MCMTVChain.rzx")(theta, qubit1, qubit2)                                                                                | Apply [`RZXGate`](qiskit.circuit.library.RZXGate "qiskit.circuit.library.RZXGate").                                                 |
| [`rzz`](#qiskit.circuit.library.MCMTVChain.rzz "qiskit.circuit.library.MCMTVChain.rzz")(theta, qubit1, qubit2)                                                                                | Apply [`RZZGate`](qiskit.circuit.library.RZZGate "qiskit.circuit.library.RZZGate").                                                 |
| [`s`](#qiskit.circuit.library.MCMTVChain.s "qiskit.circuit.library.MCMTVChain.s")(qubit)                                                                                                      | Apply [`SGate`](qiskit.circuit.library.SGate "qiskit.circuit.library.SGate").                                                       |
| [`save_amplitudes`](#qiskit.circuit.library.MCMTVChain.save_amplitudes "qiskit.circuit.library.MCMTVChain.save_amplitudes")(params\[, label, pershot, …])                                     | Save complex statevector amplitudes.                                                                                                |
| [`save_amplitudes_squared`](#qiskit.circuit.library.MCMTVChain.save_amplitudes_squared "qiskit.circuit.library.MCMTVChain.save_amplitudes_squared")(params\[, label, …])                      | Save squared statevector amplitudes (probabilities).                                                                                |
| [`save_density_matrix`](#qiskit.circuit.library.MCMTVChain.save_density_matrix "qiskit.circuit.library.MCMTVChain.save_density_matrix")(\[qubits, label, …])                                  | Save the current simulator quantum state as a density matrix.                                                                       |
| [`save_expectation_value`](#qiskit.circuit.library.MCMTVChain.save_expectation_value "qiskit.circuit.library.MCMTVChain.save_expectation_value")(operator, qubits\[, …])                      | Save the expectation value of a Hermitian operator.                                                                                 |
| [`save_expectation_value_variance`](#qiskit.circuit.library.MCMTVChain.save_expectation_value_variance "qiskit.circuit.library.MCMTVChain.save_expectation_value_variance")(operator, qubits) | Save the expectation value of a Hermitian operator.                                                                                 |
| [`save_matrix_product_state`](#qiskit.circuit.library.MCMTVChain.save_matrix_product_state "qiskit.circuit.library.MCMTVChain.save_matrix_product_state")(\[label, pershot, …])               | Save the current simulator quantum state as a matrix product state.                                                                 |
| [`save_probabilities`](#qiskit.circuit.library.MCMTVChain.save_probabilities "qiskit.circuit.library.MCMTVChain.save_probabilities")(\[qubits, label, …])                                     | Save measurement outcome probabilities vector.                                                                                      |
| [`save_probabilities_dict`](#qiskit.circuit.library.MCMTVChain.save_probabilities_dict "qiskit.circuit.library.MCMTVChain.save_probabilities_dict")(\[qubits, label, …])                      | Save measurement outcome probabilities vector.                                                                                      |
| [`save_stabilizer`](#qiskit.circuit.library.MCMTVChain.save_stabilizer "qiskit.circuit.library.MCMTVChain.save_stabilizer")(\[label, pershot, conditional])                                   | Save the current stabilizer simulator quantum state as a Clifford.                                                                  |
| [`save_state`](#qiskit.circuit.library.MCMTVChain.save_state "qiskit.circuit.library.MCMTVChain.save_state")(\[label, pershot, conditional])                                                  | Save the current simulator quantum state.                                                                                           |
| [`save_statevector`](#qiskit.circuit.library.MCMTVChain.save_statevector "qiskit.circuit.library.MCMTVChain.save_statevector")(\[label, pershot, conditional])                                | Save the current simulator quantum state as a statevector.                                                                          |
| [`save_statevector_dict`](#qiskit.circuit.library.MCMTVChain.save_statevector_dict "qiskit.circuit.library.MCMTVChain.save_statevector_dict")(\[label, pershot, …])                           | Save the current simulator quantum state as a statevector as a dict.                                                                |
| [`save_superop`](#qiskit.circuit.library.MCMTVChain.save_superop "qiskit.circuit.library.MCMTVChain.save_superop")(\[label, pershot])                                                         | Save the current state of the superop simulator.                                                                                    |
| [`save_unitary`](#qiskit.circuit.library.MCMTVChain.save_unitary "qiskit.circuit.library.MCMTVChain.save_unitary")(\[label, pershot])                                                         | Save the current state of the unitary simulator.                                                                                    |
| [`sdg`](#qiskit.circuit.library.MCMTVChain.sdg "qiskit.circuit.library.MCMTVChain.sdg")(qubit)                                                                                                | Apply [`SdgGate`](qiskit.circuit.library.SdgGate "qiskit.circuit.library.SdgGate").                                                 |
| [`set_density_matrix`](#qiskit.circuit.library.MCMTVChain.set_density_matrix "qiskit.circuit.library.MCMTVChain.set_density_matrix")(state)                                                   | Set the density matrix state of the simulator.                                                                                      |
| [`set_matrix_product_state`](#qiskit.circuit.library.MCMTVChain.set_matrix_product_state "qiskit.circuit.library.MCMTVChain.set_matrix_product_state")(state)                                 | Set the matrix product state of the simulator.                                                                                      |
| [`set_stabilizer`](#qiskit.circuit.library.MCMTVChain.set_stabilizer "qiskit.circuit.library.MCMTVChain.set_stabilizer")(state)                                                               | Set the Clifford stabilizer state of the simulator.                                                                                 |
| [`set_statevector`](#qiskit.circuit.library.MCMTVChain.set_statevector "qiskit.circuit.library.MCMTVChain.set_statevector")(state)                                                            | Set the statevector state of the simulator.                                                                                         |
| [`set_superop`](#qiskit.circuit.library.MCMTVChain.set_superop "qiskit.circuit.library.MCMTVChain.set_superop")(state)                                                                        | Set the superop state of the simulator.                                                                                             |
| [`set_unitary`](#qiskit.circuit.library.MCMTVChain.set_unitary "qiskit.circuit.library.MCMTVChain.set_unitary")(state)                                                                        | Set the state state of the simulator.                                                                                               |
| [`size`](#qiskit.circuit.library.MCMTVChain.size "qiskit.circuit.library.MCMTVChain.size")()                                                                                                  | Returns total number of gate operations in circuit.                                                                                 |
| [`snapshot`](#qiskit.circuit.library.MCMTVChain.snapshot "qiskit.circuit.library.MCMTVChain.snapshot")(label\[, snapshot\_type, qubits, params])                                              | Take a statevector snapshot of the internal simulator representation.                                                               |
| [`snapshot_density_matrix`](#qiskit.circuit.library.MCMTVChain.snapshot_density_matrix "qiskit.circuit.library.MCMTVChain.snapshot_density_matrix")(label\[, qubits])                         | Take a density matrix snapshot of simulator state.                                                                                  |
| [`snapshot_expectation_value`](#qiskit.circuit.library.MCMTVChain.snapshot_expectation_value "qiskit.circuit.library.MCMTVChain.snapshot_expectation_value")(label, op, qubits)               | Take a snapshot of expectation value \<O> of an Operator.                                                                           |
| [`snapshot_probabilities`](#qiskit.circuit.library.MCMTVChain.snapshot_probabilities "qiskit.circuit.library.MCMTVChain.snapshot_probabilities")(label, qubits\[, variance])                  | Take a probability snapshot of the simulator state.                                                                                 |
| [`snapshot_stabilizer`](#qiskit.circuit.library.MCMTVChain.snapshot_stabilizer "qiskit.circuit.library.MCMTVChain.snapshot_stabilizer")(label)                                                | Take a stabilizer snapshot of the simulator state.                                                                                  |
| [`snapshot_statevector`](#qiskit.circuit.library.MCMTVChain.snapshot_statevector "qiskit.circuit.library.MCMTVChain.snapshot_statevector")(label)                                             | Take a statevector snapshot of the simulator state.                                                                                 |
| [`squ`](#qiskit.circuit.library.MCMTVChain.squ "qiskit.circuit.library.MCMTVChain.squ")(unitary\_matrix, qubit\[, mode, …])                                                                   | Decompose an arbitrary 2\*2 unitary into three rotation gates.                                                                      |
| [`swap`](#qiskit.circuit.library.MCMTVChain.swap "qiskit.circuit.library.MCMTVChain.swap")(qubit1, qubit2)                                                                                    | Apply [`SwapGate`](qiskit.circuit.library.SwapGate "qiskit.circuit.library.SwapGate").                                              |
| [`sx`](#qiskit.circuit.library.MCMTVChain.sx "qiskit.circuit.library.MCMTVChain.sx")(qubit)                                                                                                   | Apply [`SXGate`](qiskit.circuit.library.SXGate "qiskit.circuit.library.SXGate").                                                    |
| [`sxdg`](#qiskit.circuit.library.MCMTVChain.sxdg "qiskit.circuit.library.MCMTVChain.sxdg")(qubit)                                                                                             | Apply [`SXdgGate`](qiskit.circuit.library.SXdgGate "qiskit.circuit.library.SXdgGate").                                              |
| [`t`](#qiskit.circuit.library.MCMTVChain.t "qiskit.circuit.library.MCMTVChain.t")(qubit)                                                                                                      | Apply [`TGate`](qiskit.circuit.library.TGate "qiskit.circuit.library.TGate").                                                       |
| [`tdg`](#qiskit.circuit.library.MCMTVChain.tdg "qiskit.circuit.library.MCMTVChain.tdg")(qubit)                                                                                                | Apply [`TdgGate`](qiskit.circuit.library.TdgGate "qiskit.circuit.library.TdgGate").                                                 |
| [`tensor`](#qiskit.circuit.library.MCMTVChain.tensor "qiskit.circuit.library.MCMTVChain.tensor")(other\[, inplace])                                                                           | Tensor `self` with `other`.                                                                                                         |
| [`to_gate`](#qiskit.circuit.library.MCMTVChain.to_gate "qiskit.circuit.library.MCMTVChain.to_gate")(\[parameter\_map, label])                                                                 | Create a Gate out of this circuit.                                                                                                  |
| [`to_instruction`](#qiskit.circuit.library.MCMTVChain.to_instruction "qiskit.circuit.library.MCMTVChain.to_instruction")(\[parameter\_map])                                                   | Create an Instruction out of this circuit.                                                                                          |
| [`toffoli`](#qiskit.circuit.library.MCMTVChain.toffoli "qiskit.circuit.library.MCMTVChain.toffoli")(control\_qubit1, control\_qubit2, …)                                                      | Apply [`CCXGate`](qiskit.circuit.library.CCXGate "qiskit.circuit.library.CCXGate").                                                 |
| [`u`](#qiskit.circuit.library.MCMTVChain.u "qiskit.circuit.library.MCMTVChain.u")(theta, phi, lam, qubit)                                                                                     | Apply [`UGate`](qiskit.circuit.library.UGate "qiskit.circuit.library.UGate").                                                       |
| [`u1`](#qiskit.circuit.library.MCMTVChain.u1 "qiskit.circuit.library.MCMTVChain.u1")(theta, qubit)                                                                                            | Apply [`U1Gate`](qiskit.circuit.library.U1Gate "qiskit.circuit.library.U1Gate").                                                    |
| [`u2`](#qiskit.circuit.library.MCMTVChain.u2 "qiskit.circuit.library.MCMTVChain.u2")(phi, lam, qubit)                                                                                         | Apply [`U2Gate`](qiskit.circuit.library.U2Gate "qiskit.circuit.library.U2Gate").                                                    |
| [`u3`](#qiskit.circuit.library.MCMTVChain.u3 "qiskit.circuit.library.MCMTVChain.u3")(theta, phi, lam, qubit)                                                                                  | Apply [`U3Gate`](qiskit.circuit.library.U3Gate "qiskit.circuit.library.U3Gate").                                                    |
| [`uc`](#qiskit.circuit.library.MCMTVChain.uc "qiskit.circuit.library.MCMTVChain.uc")(gate\_list, q\_controls, q\_target\[, …])                                                                | Attach a uniformly controlled gates (also called multiplexed gates) to a circuit.                                                   |
| [`ucrx`](#qiskit.circuit.library.MCMTVChain.ucrx "qiskit.circuit.library.MCMTVChain.ucrx")(angle\_list, q\_controls, q\_target)                                                               | Attach a uniformly controlled (also called multiplexed) Rx rotation gate to a circuit.                                              |
| [`ucry`](#qiskit.circuit.library.MCMTVChain.ucry "qiskit.circuit.library.MCMTVChain.ucry")(angle\_list, q\_controls, q\_target)                                                               | Attach a uniformly controlled (also called multiplexed) Ry rotation gate to a circuit.                                              |
| [`ucrz`](#qiskit.circuit.library.MCMTVChain.ucrz "qiskit.circuit.library.MCMTVChain.ucrz")(angle\_list, q\_controls, q\_target)                                                               | Attach a uniformly controlled (also called multiplexed gates) Rz rotation gate to a circuit.                                        |
| [`unitary`](#qiskit.circuit.library.MCMTVChain.unitary "qiskit.circuit.library.MCMTVChain.unitary")(obj, qubits\[, label])                                                                    | Apply unitary gate to q.                                                                                                            |
| [`width`](#qiskit.circuit.library.MCMTVChain.width "qiskit.circuit.library.MCMTVChain.width")()                                                                                               | Return number of qubits plus clbits in circuit.                                                                                     |
| [`x`](#qiskit.circuit.library.MCMTVChain.x "qiskit.circuit.library.MCMTVChain.x")(qubit\[, label])                                                                                            | Apply [`XGate`](qiskit.circuit.library.XGate "qiskit.circuit.library.XGate").                                                       |
| [`y`](#qiskit.circuit.library.MCMTVChain.y "qiskit.circuit.library.MCMTVChain.y")(qubit)                                                                                                      | Apply [`YGate`](qiskit.circuit.library.YGate "qiskit.circuit.library.YGate").                                                       |
| [`z`](#qiskit.circuit.library.MCMTVChain.z "qiskit.circuit.library.MCMTVChain.z")(qubit)                                                                                                      | Apply [`ZGate`](qiskit.circuit.library.ZGate "qiskit.circuit.library.ZGate").                                                       |

## Attributes

|                                                                                                                                      |                                                                              |
| ------------------------------------------------------------------------------------------------------------------------------------ | ---------------------------------------------------------------------------- |
| [`ancillas`](#qiskit.circuit.library.MCMTVChain.ancillas "qiskit.circuit.library.MCMTVChain.ancillas")                               | Returns a list of ancilla bits in the order that the registers were added.   |
| [`calibrations`](#qiskit.circuit.library.MCMTVChain.calibrations "qiskit.circuit.library.MCMTVChain.calibrations")                   | Return calibration dictionary.                                               |
| [`clbits`](#qiskit.circuit.library.MCMTVChain.clbits "qiskit.circuit.library.MCMTVChain.clbits")                                     | Returns a list of classical bits in the order that the registers were added. |
| [`data`](#qiskit.circuit.library.MCMTVChain.data "qiskit.circuit.library.MCMTVChain.data")                                           | Return the circuit data (instructions and context).                          |
| `extension_lib`                                                                                                                      |                                                                              |
| [`global_phase`](#qiskit.circuit.library.MCMTVChain.global_phase "qiskit.circuit.library.MCMTVChain.global_phase")                   | Return the global phase of the circuit in radians.                           |
| `header`                                                                                                                             |                                                                              |
| `instances`                                                                                                                          |                                                                              |
| [`metadata`](#qiskit.circuit.library.MCMTVChain.metadata "qiskit.circuit.library.MCMTVChain.metadata")                               | The user provided metadata associated with the circuit                       |
| [`num_ancilla_qubits`](#qiskit.circuit.library.MCMTVChain.num_ancilla_qubits "qiskit.circuit.library.MCMTVChain.num_ancilla_qubits") | Return the number of ancilla qubits required.                                |
| [`num_ancillas`](#qiskit.circuit.library.MCMTVChain.num_ancillas "qiskit.circuit.library.MCMTVChain.num_ancillas")                   | Return the number of ancilla qubits.                                         |
| [`num_clbits`](#qiskit.circuit.library.MCMTVChain.num_clbits "qiskit.circuit.library.MCMTVChain.num_clbits")                         | Return number of classical bits.                                             |
| [`num_parameters`](#qiskit.circuit.library.MCMTVChain.num_parameters "qiskit.circuit.library.MCMTVChain.num_parameters")             | Convenience function to get the number of parameter objects in the circuit.  |
| [`num_qubits`](#qiskit.circuit.library.MCMTVChain.num_qubits "qiskit.circuit.library.MCMTVChain.num_qubits")                         | Return number of qubits.                                                     |
| [`parameters`](#qiskit.circuit.library.MCMTVChain.parameters "qiskit.circuit.library.MCMTVChain.parameters")                         | Convenience function to get the parameters defined in the parameter table.   |
| `prefix`                                                                                                                             |                                                                              |
| [`qubits`](#qiskit.circuit.library.MCMTVChain.qubits "qiskit.circuit.library.MCMTVChain.qubits")                                     | Returns a list of quantum bits in the order that the registers were added.   |

### add\_bits

<span id="qiskit.circuit.library.MCMTVChain.add_bits" />
...
<span id="qiskit.circuit.library.MCMTVChain.add_calibration" />
...
<span id="qiskit.circuit.library.MCMTVChain.append" />
...
<span id="qiskit.circuit.library.MCMTVChain.assign_parameters" />
...
<span id="qiskit.circuit.library.MCMTVChain.bind_parameters" />

`bind_parameters(values, value_dict=None)`

Assign numeric parameters to values yielding a new circuit.

To assign new Parameter objects or bind the values in-place, without yielding a new circuit, use the [`assign_parameters()`](#qiskit.circuit.library.MCMTVChain.assign_parameters "qiskit.circuit.library.MCMTVChain.assign_parameters") method.
...
<span id="qiskit.circuit.library.MCMTVChain.cbit_argument_conversion" />
...
<span id="qiskit.circuit.library.MCMTVChain.ccx" />
...
<span id="qiskit.circuit.library.MCMTVChain.ch" />
...
<span id="qiskit.circuit.library.MCMTVChain.cnot" />
...
<span id="qiskit.circuit.library.MCMTVChain.combine" />
...
<span id="qiskit.circuit.library.MCMTVChain.compose" />
...
<span id="qiskit.circuit.library.MCMTVChain.control" />
...
<span id="qiskit.circuit.library.MCMTVChain.copy" />
...
<span id="qiskit.circuit.library.MCMTVChain.cp" />
...
<span id="qiskit.circuit.library.MCMTVChain.crx" />
...
<span id="qiskit.circuit.library.MCMTVChain.cry" />
...
<span id="qiskit.circuit.library.MCMTVChain.crz" />
...
<span id="qiskit.circuit.library.MCMTVChain.cswap" />
...
<span id="qiskit.circuit.library.MCMTVChain.csx" />
...
<span id="qiskit.circuit.library.MCMTVChain.cu" />
...
<span id="qiskit.circuit.library.MCMTVChain.cu1" />
...
<span id="qiskit.circuit.library.MCMTVChain.cu3" />
...
<span id="qiskit.circuit.library.MCMTVChain.cy" />
...
<span id="qiskit.circuit.library.MCMTVChain.cz" />
...
<span id="qiskit.circuit.library.MCMTVChain.dcx" />
...
<span id="qiskit.circuit.library.MCMTVChain.decompose" />
...
<span id="qiskit.circuit.library.MCMTVChain.delay" />
...
<span id="qiskit.circuit.library.MCMTVChain.depth" />
...
<span id="qiskit.circuit.library.MCMTVChain.diagonal" />
...
<span id="qiskit.circuit.library.MCMTVChain.draw" />
...
![../\_images/qiskit.circuit.library.MCMTVChain\_3\_0.png](/images/api/qiskit/0.27/qiskit.circuit.library.MCMTVChain_3_0.png) ![../\_images/qiskit.circuit.library.MCMTVChain\_3\_1.png](/images/api/qiskit/0.27/qiskit.circuit.library.MCMTVChain_3_1.png)

### ecr

<span id="qiskit.circuit.library.MCMTVChain.ecr" />
...
<span id="qiskit.circuit.library.MCMTVChain.extend" />
...
<span id="qiskit.circuit.library.MCMTVChain.fredkin" />
...
<span id="qiskit.circuit.library.MCMTVChain.from_qasm_file" />
...
<span id="qiskit.circuit.library.MCMTVChain.from_qasm_str" />
...
<span id="qiskit.circuit.library.MCMTVChain.has_register" />
...
<span id="qiskit.circuit.library.MCMTVChain.i" />
...
<span id="qiskit.circuit.library.MCMTVChain.id" />
...
<span id="qiskit.circuit.library.MCMTVChain.iso" />
...
<span id="qiskit.circuit.library.MCMTVChain.isometry" />
...
<span id="qiskit.circuit.library.MCMTVChain.iswap" />
...
<span id="qiskit.circuit.library.MCMTVChain.mcp" />
...
<span id="qiskit.circuit.library.MCMTVChain.mcrx" />
...
<span id="qiskit.circuit.library.MCMTVChain.mcry" />
...
<span id="qiskit.circuit.library.MCMTVChain.mcrz" />
...
<span id="qiskit.circuit.library.MCMTVChain.mcx" />
...
<span id="qiskit.circuit.library.MCMTVChain.measure" />
...
<span id="qiskit.circuit.library.MCMTVChain.measure_active" />
...
<span id="qiskit.circuit.library.MCMTVChain.measure_all" />
...
<span id="qiskit.circuit.library.MCMTVChain.num_connected_components" />
...
<span id="qiskit.circuit.library.MCMTVChain.num_tensor_factors" />
...
<span id="qiskit.circuit.library.MCMTVChain.num_unitary_factors" />
...
<span id="qiskit.circuit.library.MCMTVChain.p" />
...
<span id="qiskit.circuit.library.MCMTVChain.pauli" />
...
<span id="qiskit.circuit.library.MCMTVChain.power" />
...
<span id="qiskit.circuit.library.MCMTVChain.qasm" />
...
<span id="qiskit.circuit.library.MCMTVChain.qbit_argument_conversion" />
...
<span id="qiskit.circuit.library.MCMTVChain.qubit_duration" />
...
<span id="qiskit.circuit.library.MCMTVChain.qubit_start_time" />
...
<span id="qiskit.circuit.library.MCMTVChain.qubit_stop_time" />
...
<span id="qiskit.circuit.library.MCMTVChain.r" />
...
<span id="qiskit.circuit.library.MCMTVChain.rcccx" />
...
<span id="qiskit.circuit.library.MCMTVChain.rccx" />
...
<span id="qiskit.circuit.library.MCMTVChain.remove_final_measurements" />
...
<span id="qiskit.circuit.library.MCMTVChain.repeat" />
...
<span id="qiskit.circuit.library.MCMTVChain.reverse_bits" />
...
<span id="qiskit.circuit.library.MCMTVChain.reverse_ops" />
...
<span id="qiskit.circuit.library.MCMTVChain.rv" />
...
<span id="qiskit.circuit.library.MCMTVChain.rx" />
...
<span id="qiskit.circuit.library.MCMTVChain.rxx" />
...
<span id="qiskit.circuit.library.MCMTVChain.ry" />
...
<span id="qiskit.circuit.library.MCMTVChain.ryy" />
...
<span id="qiskit.circuit.library.MCMTVChain.rz" />
...
<span id="qiskit.circuit.library.MCMTVChain.rzx" />
...
<span id="qiskit.circuit.library.MCMTVChain.rzz" />
...
<span id="qiskit.circuit.library.MCMTVChain.save_amplitudes" />
...
<span id="qiskit.circuit.library.MCMTVChain.save_amplitudes_squared" />
...
<span id="qiskit.circuit.library.MCMTVChain.save_density_matrix" />
...
<span id="qiskit.circuit.library.MCMTVChain.save_expectation_value" />
...
<span id="qiskit.circuit.library.MCMTVChain.save_expectation_value_variance" />
...
<span id="qiskit.circuit.library.MCMTVChain.save_matrix_product_state" />
...
<span id="qiskit.circuit.library.MCMTVChain.save_probabilities" />
...
<span id="qiskit.circuit.library.MCMTVChain.save_probabilities_dict" />
...
<span id="qiskit.circuit.library.MCMTVChain.save_stabilizer" />
...
<span id="qiskit.circuit.library.MCMTVChain.save_state" />
...
<span id="qiskit.circuit.library.MCMTVChain.save_statevector" />
...
<span id="qiskit.circuit.library.MCMTVChain.save_statevector_dict" />
...
<span id="qiskit.circuit.library.MCMTVChain.save_superop" />
...
<span id="qiskit.circuit.library.MCMTVChain.save_unitary" />
...
<span id="qiskit.circuit.library.MCMTVChain.sdg" />
...
<span id="qiskit.circuit.library.MCMTVChain.set_density_matrix" />
...
<span id="qiskit.circuit.library.MCMTVChain.set_matrix_product_state" />
...
<span id="qiskit.circuit.library.MCMTVChain.set_stabilizer" />
...
<span id="qiskit.circuit.library.MCMTVChain.set_statevector" />
...
<span id="qiskit.circuit.library.MCMTVChain.set_superop" />
...
<span id="qiskit.circuit.library.MCMTVChain.set_unitary" />
...
<span id="qiskit.circuit.library.MCMTVChain.size" />
...
<span id="qiskit.circuit.library.MCMTVChain.snapshot" />
...
<span id="qiskit.circuit.library.MCMTVChain.snapshot_density_matrix" />
...
<span id="qiskit.circuit.library.MCMTVChain.snapshot_expectation_value" />
...
<span id="qiskit.circuit.library.MCMTVChain.snapshot_probabilities" />
...
<span id="qiskit.circuit.library.MCMTVChain.snapshot_stabilizer" />
...
<span id="qiskit.circuit.library.MCMTVChain.snapshot_statevector" />
...
<span id="qiskit.circuit.library.MCMTVChain.squ" />
...
<span id="qiskit.circuit.library.MCMTVChain.sx" />
...
<span id="qiskit.circuit.library.MCMTVChain.sxdg" />
...
<span id="qiskit.circuit.library.MCMTVChain.tdg" />
...
<span id="qiskit.circuit.library.MCMTVChain.tensor" />
...
<span id="qiskit.circuit.library.MCMTVChain.to_gate" />
...
<span id="qiskit.circuit.library.MCMTVChain.to_instruction" />
...
<span id="qiskit.circuit.library.MCMTVChain.toffoli" />
...
<span id="qiskit.circuit.library.MCMTVChain.u" />
...
<span id="qiskit.circuit.library.MCMTVChain.u1" />
...
<span id="qiskit.circuit.library.MCMTVChain.u2" />
...
<span id="qiskit.circuit.library.MCMTVChain.u3" />
...
<span id="qiskit.circuit.library.MCMTVChain.uc" />
...
<span id="qiskit.circuit.library.MCMTVChain.ucrx" />
...
<span id="qiskit.circuit.library.MCMTVChain.ucry" />
...
<span id="qiskit.circuit.library.MCMTVChain.ucrz" />
...
<span id="qiskit.circuit.library.MCMTVChain.unitary" />
...
<span id="qiskit.circuit.library.MCMTVChain.width" />
...
<span id="qiskit.circuit.library.MCMTVChain.x" />
...
<span id="qiskit.circuit.library.MCMTVChain.y" />
