...
<Class id="qiskit.opflow.state_fns.CircuitStateFn" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.17/qiskit/opflow/state_fns/circuit_state_fn.py" signature="CircuitStateFn(primitive=None, coeff=1.0, is_measurement=False)">
  ...
  **TypeError** – Unsupported primitive, or primitive has ClassicalRegisters.
  ...
  <Function id="qiskit.opflow.state_fns.CircuitStateFn.__init__" signature="__init__(primitive=None, coeff=1.0, is_measurement=False)">
    **Parameters**
  ...
  <Function id="qiskit.opflow.state_fns.CircuitStateFn.bind_parameters" signature="bind_parameters(param_dict)">
  ...
  <Function id="qiskit.opflow.state_fns.CircuitStateFn.coeff" signature="property coeff">
  ...
  <Function id="qiskit.opflow.state_fns.CircuitStateFn.copy" signature="copy()">
  ...
  <Function id="qiskit.opflow.state_fns.CircuitStateFn.equals" signature="equals(other)">
  ...
  <Function id="qiskit.opflow.state_fns.CircuitStateFn.from_dict" signature="static from_dict(density_dict)">
  ...
  <Function id="qiskit.opflow.state_fns.CircuitStateFn.from_vector" signature="static from_vector(statevector)">
  ...
  <Function id="qiskit.opflow.state_fns.CircuitStateFn.instance_id" signature="property instance_id">
  ...
  <Function id="qiskit.opflow.state_fns.CircuitStateFn.is_measurement" signature="property is_measurement">
  ...
  <Function id="qiskit.opflow.state_fns.CircuitStateFn.mul" signature="mul(scalar)">
  ...
  <Function id="qiskit.opflow.state_fns.CircuitStateFn.neg" signature="neg()">
  ...
  <Function id="qiskit.opflow.state_fns.CircuitStateFn.num_qubits" signature="property num_qubits">
  ...
  <Function id="qiskit.opflow.state_fns.CircuitStateFn.parameters" signature="property parameters">
  ...
  <Function id="qiskit.opflow.state_fns.CircuitStateFn.power" signature="power(exponent)">
  ...
  <Function id="qiskit.opflow.state_fns.CircuitStateFn.primitive" signature="property primitive">
  ...
  <Function id="qiskit.opflow.state_fns.CircuitStateFn.tensorpower" signature="tensorpower(other)">
  ...
  <Function id="qiskit.opflow.state_fns.CircuitStateFn.to_matrix_op" signature="to_matrix_op(massive=False)">
  ...
  <Function id="qiskit.opflow.state_fns.CircuitStateFn.to_spmatrix" signature="to_spmatrix()">
  ...
  <Function id="qiskit.opflow.state_fns.CircuitStateFn.traverse" signature="traverse(convert_fn, coeff=None)">
