...
description: API reference for qiskit.opflow.state_fns.CircuitStateFn in qiskit v0.27
in_page_toc_min_heading_level: 1
python_api_type: class
python_api_name: qiskit.opflow.state_fns.CircuitStateFn
---

<span id="qiskit-opflow-state-fns-circuitstatefn" />

# qiskit.opflow\.state\_fns.CircuitStateFn

<Class id="qiskit.opflow.state_fns.CircuitStateFn" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.17/qiskit/opflow/state_fns/circuit_state_fn.py" signature="CircuitStateFn(primitive=None, coeff=1.0, is_measurement=False)" modifiers="class">
  ...
  **TypeError** – Unsupported primitive, or primitive has ClassicalRegisters.
  ...
  <Attribute id="qiskit.opflow.state_fns.CircuitStateFn.primitive">
