...
<Class id="qiskit.pulse.Acquire" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.17/qiskit/pulse/instructions/acquire.py" signature="Acquire(duration, channel, mem_slot=None, reg_slot=None, kernel=None, discriminator=None, name=None)" modifiers="class">
  ...
  **Raises**
  ...
  <Function id="qiskit.pulse.Acquire.is_parameterized" signature="is_parameterized()">
  ...
  <Function id="qiskit.pulse.Acquire.parameters" signature="parameters" modifiers="property">
