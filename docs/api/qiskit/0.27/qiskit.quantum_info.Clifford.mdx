...
<Class id="qiskit.quantum_info.Clifford" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.17/qiskit/quantum_info/operators/symplectic/clifford.py" signature="Clifford(data, validate=True)" modifiers="class">
  ...
  **References**
  ...
  <Function id="qiskit.quantum_info.Clifford.destabilizer" signature="destabilizer" modifiers="property">
    Return the destabilizer block of the StabilizerTable.
  </Function>

  ### dim

  <Function id="qiskit.quantum_info.Clifford.dim" signature="dim" modifiers="property">
  ...
  <Function id="qiskit.quantum_info.Clifford.num_qubits" signature="num_qubits" modifiers="property">
  ...
  <Function id="qiskit.quantum_info.Clifford.qargs" signature="qargs" modifiers="property">
  ...
  <Function id="qiskit.quantum_info.Clifford.stabilizer" signature="stabilizer" modifiers="property">
    Return the stabilizer block of the StabilizerTable.
  </Function>

  ### table

  <Function id="qiskit.quantum_info.Clifford.table" signature="table" modifiers="property">
