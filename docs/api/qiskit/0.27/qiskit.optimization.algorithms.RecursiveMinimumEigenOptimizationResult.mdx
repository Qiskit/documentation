---
title: RecursiveMinimumEigenOptimizationResult (v0.27)
description: API reference for qiskit.optimization.algorithms.RecursiveMinimumEigenOptimizationResult in qiskit v0.27
