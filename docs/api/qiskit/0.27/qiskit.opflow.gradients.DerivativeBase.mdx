...
<Class id="qiskit.opflow.gradients.DerivativeBase" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.17/qiskit/opflow/gradients/derivative_base.py" signature="DerivativeBase">
  ...
  <Function id="qiskit.opflow.gradients.DerivativeBase.__init__" signature="__init__()">
  ...
  <Function id="qiskit.opflow.gradients.DerivativeBase.convert" signature="abstract convert(operator, params=None)">
    **Parameters**
  ...
  <Function id="qiskit.opflow.gradients.DerivativeBase.gradient_wrapper" signature="gradient_wrapper(operator, bind_params, grad_params=None, backend=None)">
  ...
  <Function id="qiskit.opflow.gradients.DerivativeBase.parameter_expression_grad" signature="static parameter_expression_grad(param_expr, param)">
