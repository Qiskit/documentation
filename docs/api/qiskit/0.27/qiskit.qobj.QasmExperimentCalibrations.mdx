---
title: QasmExperimentCalibrations (v0.27)
description: API reference for qiskit.qobj.QasmExperimentCalibrations in qiskit v0.27
...
<Class id="qiskit.qobj.QasmExperimentCalibrations" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.17/qiskit/qobj/qasm_qobj.py" signature="QasmExperimentCalibrations(gates)" modifiers="class">
