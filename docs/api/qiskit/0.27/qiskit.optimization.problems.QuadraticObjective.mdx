...
<Class id="qiskit.optimization.problems.QuadraticObjective" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/optimization/problems/quadratic_objective.py" signature="QuadraticObjective(quadratic_program, constant=0.0, linear=None, quadratic=None, sense=<ObjSense.MINIMIZE: 1>)" modifiers="class">
  ...
  *   **sense** (`ObjSense`) – The optimization sense of the objective.
  ...
  <Function id="qiskit.optimization.problems.QuadraticObjective.constant" signature="constant" modifiers="property">
  ...
  <Function id="qiskit.optimization.problems.QuadraticObjective.linear" signature="linear" modifiers="property">
  ...
  <Function id="qiskit.optimization.problems.QuadraticObjective.quadratic" signature="quadratic" modifiers="property">
  ...
  <Function id="qiskit.optimization.problems.QuadraticObjective.quadratic_program" signature="quadratic_program" modifiers="property">
  ...
  <Function id="qiskit.optimization.problems.QuadraticObjective.sense" signature="sense" modifiers="property">
