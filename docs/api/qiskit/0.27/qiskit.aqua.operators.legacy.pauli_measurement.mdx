---
title: pauli_measurement (v0.27)
description: API reference for qiskit.aqua.operators.legacy.pauli_measurement in qiskit v0.27
...
<Function id="qiskit.aqua.operators.legacy.pauli_measurement" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/aqua/operators/legacy/common.py" signature="pauli_measurement(circuit, pauli, qr, cr, barrier=False)">
