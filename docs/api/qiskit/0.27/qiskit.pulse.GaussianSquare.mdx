...
<Class id="qiskit.pulse.GaussianSquare" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.17/qiskit/pulse/library/parametric_pulses.py" signature="GaussianSquare(duration, amp, sigma, width, name=None)">
...
$$
  ...
  *   **name** (`Optional`\[`str`]) – Display name for this pulse envelope.
  ...
  <Function id="qiskit.pulse.GaussianSquare.__init__" name="__init__" signature="__init__(duration, amp, sigma, width, name=None)">
    Initialize the gaussian square pulse.
  ...
  <Function id="qiskit.pulse.GaussianSquare.amp" name="amp" signature="property amp">
  ...
  <Function id="qiskit.pulse.GaussianSquare.assign" name="assign" signature="assign(parameter, value)">
  ...
  <Function id="qiskit.pulse.GaussianSquare.assign_parameters" name="assign_parameters" signature="assign_parameters(value_dict)">
  ...
  <Function id="qiskit.pulse.GaussianSquare.draw" name="draw" signature="draw(dt=None, style=None, filename=None, interp_method=None, scale=None, interactive=None, draw_title=None, backend=None, time_range=None, time_unit='dt', show_waveform_info=True, plotter='mpl2d', axis=None)">
  ...
  <Function id="qiskit.pulse.GaussianSquare.get_waveform" name="get_waveform" signature="get_waveform()">
  ...
  <Function id="qiskit.pulse.GaussianSquare.id" name="id" signature="property id">
  ...
  <Function id="qiskit.pulse.GaussianSquare.is_parameterized" name="is_parameterized" signature="is_parameterized()">
  ...
  <Function id="qiskit.pulse.GaussianSquare.parameters" name="parameters" signature="property parameters">
  ...
  <Function id="qiskit.pulse.GaussianSquare.sigma" name="sigma" signature="property sigma">
  ...
  <Function id="qiskit.pulse.GaussianSquare.validate_parameters" name="validate_parameters" signature="validate_parameters()">
    Validate parameters.
  ...
  <Function id="qiskit.pulse.GaussianSquare.width" name="width" signature="property width">
