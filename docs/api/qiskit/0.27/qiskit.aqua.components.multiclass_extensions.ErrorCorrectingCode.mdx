...
<Class id="qiskit.aqua.components.multiclass_extensions.ErrorCorrectingCode" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/aqua/components/multiclass_extensions/error_correcting_code.py" signature="ErrorCorrectingCode(code_size=4)">
  ...
  **code\_size** (`int`) – Size of error correcting code
  ...
  <Function id="qiskit.aqua.components.multiclass_extensions.ErrorCorrectingCode.__init__" name="__init__" signature="__init__(code_size=4)">
    **Parameters**
  ...
  <Function id="qiskit.aqua.components.multiclass_extensions.ErrorCorrectingCode.predict" name="predict" signature="predict(x)">
  ...
  <Function id="qiskit.aqua.components.multiclass_extensions.ErrorCorrectingCode.set_estimator" name="set_estimator" signature="set_estimator(estimator_cls, params=None)">
  ...
  <Function id="qiskit.aqua.components.multiclass_extensions.ErrorCorrectingCode.test" name="test" signature="test(x, y)">
  ...
  <Function id="qiskit.aqua.components.multiclass_extensions.ErrorCorrectingCode.train" name="train" signature="train(x, y)">
