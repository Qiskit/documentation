...
<Class id="qiskit.transpiler.passes.CheckCXDirection" github="https://github.com/qiskit/qiskit/tree/stable/0.17/qiskit/transpiler/passes/utils/check_cx_direction.py" signature="CheckCXDirection(*args, **kwargs)">
