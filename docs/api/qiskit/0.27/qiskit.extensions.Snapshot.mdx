...
<Class id="qiskit.extensions.Snapshot" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.17/qiskit/extensions/simulator/snapshot.py" signature="Snapshot(label, snapshot_type='statevector', num_qubits=0, num_clbits=0, params=None)">
  ...
  **ExtensionError** – if snapshot label is invalid.
  ...
  <Function id="qiskit.extensions.Snapshot.decompositions" signature="property decompositions">
    Get the decompositions of the instruction from the SessionEquivalenceLibrary.
  </Function>

  ### definition

  <Function id="qiskit.extensions.Snapshot.definition" signature="property definition">
    Return definition in terms of other basic gates.
  </Function>

  ### duration

  <Function id="qiskit.extensions.Snapshot.duration" signature="property duration">
    Get the duration.
  </Function>
  ...
  <Function id="qiskit.extensions.Snapshot.label" signature="property label">
  ...
  <Function id="qiskit.extensions.Snapshot.params" signature="property params">
  ...
  <Function id="qiskit.extensions.Snapshot.snapshot_type" signature="property snapshot_type">
  ...
  <Function id="qiskit.extensions.Snapshot.unit" signature="property unit">
