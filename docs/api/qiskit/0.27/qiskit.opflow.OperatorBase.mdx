...
<Class id="qiskit.opflow.OperatorBase" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.17/qiskit/opflow/operator_base.py" signature="OperatorBase">
  ...
  <Function id="qiskit.opflow.OperatorBase.__init__" signature="__init__()">
  ...
  <Function id="qiskit.opflow.OperatorBase.add" signature="abstract add(other)">
  ...
  <Function id="qiskit.opflow.OperatorBase.adjoint" signature="abstract adjoint()">
  ...
  <Function id="qiskit.opflow.OperatorBase.assign_parameters" signature="abstract assign_parameters(param_dict)">
  ...
  <Function id="qiskit.opflow.OperatorBase.compose" signature="abstract compose(other, permutation=None, front=False)">
  ...
  <Function id="qiskit.opflow.OperatorBase.equals" signature="abstract equals(other)">
  ...
  <Function id="qiskit.opflow.OperatorBase.eval" signature="abstract eval(front=None)">
  ...
  <Function id="qiskit.opflow.OperatorBase.instance_id" signature="property instance_id">
  ...
  <Function id="qiskit.opflow.OperatorBase.mul" signature="abstract mul(scalar)">
  ...
  <Function id="qiskit.opflow.OperatorBase.num_qubits" signature="abstract property num_qubits">
  ...
  <Function id="qiskit.opflow.OperatorBase.parameters" signature="abstract property parameters">
    Return a set of Parameter objects contained in the Operator.
  </Function>

  ### permute

  <Function id="qiskit.opflow.OperatorBase.permute" signature="abstract permute(permutation)">
  ...
  <Function id="qiskit.opflow.OperatorBase.power" signature="abstract power(exponent)">
  ...
  <Function id="qiskit.opflow.OperatorBase.primitive_strings" signature="abstract primitive_strings()">
  ...
  <Function id="qiskit.opflow.OperatorBase.reduce" signature="abstract reduce()">
  ...
  <Function id="qiskit.opflow.OperatorBase.tensor" signature="abstract tensor(other)">
  ...
  <Function id="qiskit.opflow.OperatorBase.tensorpower" signature="abstract tensorpower(other)">
  ...
  <Function id="qiskit.opflow.OperatorBase.to_circuit_op" signature="abstract to_circuit_op()">
  ...
  <Function id="qiskit.opflow.OperatorBase.to_matrix" signature="abstract to_matrix(massive=False)">
  ...
  <Function id="qiskit.opflow.OperatorBase.to_matrix_op" signature="abstract to_matrix_op(massive=False)">
