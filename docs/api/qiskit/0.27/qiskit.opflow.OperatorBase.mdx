---
title: OperatorBase (v0.27)
description: API reference for qiskit.opflow.OperatorBase in qiskit v0.27
...
<Class id="qiskit.opflow.OperatorBase" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.17/qiskit/opflow/operator_base.py" signature="OperatorBase" modifiers="class">
  ...
  <Function id="qiskit.opflow.OperatorBase.num_qubits" signature="num_qubits" modifiers="abstract property">
  ...
  <Function id="qiskit.opflow.OperatorBase.parameters" signature="parameters" modifiers="abstract property">
  ...
  <Function id="qiskit.opflow.OperatorBase.power" signature="power(exponent)" modifiers="abstract">
