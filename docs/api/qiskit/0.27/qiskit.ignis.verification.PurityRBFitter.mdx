...
<Class id="qiskit.ignis.verification.PurityRBFitter" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-ignis/tree/stable/0.6/qiskit/ignis/verification/randomized_benchmarking/fitters.py" signature="PurityRBFitter(purity_result, npurity, cliff_lengths, rb_pattern=None)">
  ...
  *   **rb\_pattern** (*list*) – the pattern for the RB sequences.
  ...
  <Function id="qiskit.ignis.verification.PurityRBFitter.__init__" name="__init__" signature="__init__(purity_result, npurity, cliff_lengths, rb_pattern=None)">
    **Parameters**
  ...
  <Function id="qiskit.ignis.verification.PurityRBFitter.F234" name="F234" signature="static F234(n, a, b)">
    Function than maps: 2^n x 3^n –> 4^n , namely: (a,b) –> c where a in 2^n, b in 3^n, c in 4^n
  </Function>

  ### add\_data

  <Function id="qiskit.ignis.verification.PurityRBFitter.add_data" name="add_data" signature="add_data(new_purity_result, rerun_fit=True)">
    Add a new result.
  ...
  <Function id="qiskit.ignis.verification.PurityRBFitter.add_zdict_ops" name="add_zdict_ops" signature="add_zdict_ops()">
    Creating all Z-correlators in order to compute the expectation values.
  </Function>

  ### calc\_data

  <Function id="qiskit.ignis.verification.PurityRBFitter.calc_data" name="calc_data" signature="calc_data()">
  ...
  <Function id="qiskit.ignis.verification.PurityRBFitter.calc_statistics" name="calc_statistics" signature="calc_statistics()">
  ...
  <Function id="qiskit.ignis.verification.PurityRBFitter.cliff_lengths" name="cliff_lengths" signature="property cliff_lengths">
    Return clifford lengths.
  </Function>

  ### fit

  <Function id="qiskit.ignis.verification.PurityRBFitter.fit" name="fit" signature="property fit">
    Return the purity fit parameters.
  </Function>

  ### fit\_data

  <Function id="qiskit.ignis.verification.PurityRBFitter.fit_data" name="fit_data" signature="fit_data()">
  ...
  <Function id="qiskit.ignis.verification.PurityRBFitter.fit_data_pattern" name="fit_data_pattern" signature="fit_data_pattern(patt_ind, fit_guess)">
  ...
  <Function id="qiskit.ignis.verification.PurityRBFitter.plot_rb_data" name="plot_rb_data" signature="plot_rb_data(pattern_index=0, ax=None, add_label=True, show_plt=True)">
    Plot purity RB data of a single pattern.
  </Function>

  ### raw\_data

  <Function id="qiskit.ignis.verification.PurityRBFitter.raw_data" name="raw_data" signature="property raw_data">
    Return raw data.
  </Function>

  ### rb\_fit\_fun

  <Function id="qiskit.ignis.verification.PurityRBFitter.rb_fit_fun" name="rb_fit_fun" signature="property rb_fit_fun">
    Return the fit function rb\_fit\_fun.
  </Function>

  ### rbfit\_pur

  <Function id="qiskit.ignis.verification.PurityRBFitter.rbfit_pur" name="rbfit_pur" signature="property rbfit_pur">
    Return the purity RB fitter.
  </Function>

  ### results

  <Function id="qiskit.ignis.verification.PurityRBFitter.results" name="results" signature="property results">
    Return all the results.
  </Function>

  ### seeds

  <Function id="qiskit.ignis.verification.PurityRBFitter.seeds" name="seeds" signature="property seeds">
    Return the number of loaded seeds.
  </Function>

  ### ydata

  <Function id="qiskit.ignis.verification.PurityRBFitter.ydata" name="ydata" signature="property ydata">
