...
<Class id="qiskit.ignis.verification.PurityRBFitter" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-ignis/tree/stable/0.6/qiskit/ignis/verification/randomized_benchmarking/fitters.py" signature="PurityRBFitter(purity_result, npurity, cliff_lengths, rb_pattern=None)">
  ...
  *   **rb\_pattern** (*list*) – the pattern for the RB sequences.
  ...
  <Function id="qiskit.ignis.verification.PurityRBFitter.F234" signature="static F234(n, a, b)">
  ...
  <Function id="qiskit.ignis.verification.PurityRBFitter.cliff_lengths" signature="property cliff_lengths">
    Return clifford lengths.
  </Function>

  ### fit

  <Function id="qiskit.ignis.verification.PurityRBFitter.fit" signature="property fit">
  ...
  <Function id="qiskit.ignis.verification.PurityRBFitter.raw_data" signature="property raw_data">
    Return raw data.
  </Function>

  ### rb\_fit\_fun

  <Function id="qiskit.ignis.verification.PurityRBFitter.rb_fit_fun" signature="property rb_fit_fun">
    Return the fit function rb\_fit\_fun.
  </Function>

  ### rbfit\_pur

  <Function id="qiskit.ignis.verification.PurityRBFitter.rbfit_pur" signature="property rbfit_pur">
    Return the purity RB fitter.
  </Function>

  ### results

  <Function id="qiskit.ignis.verification.PurityRBFitter.results" signature="property results">
    Return all the results.
  </Function>

  ### seeds

  <Function id="qiskit.ignis.verification.PurityRBFitter.seeds" signature="property seeds">
    Return the number of loaded seeds.
  </Function>

  ### ydata

  <Function id="qiskit.ignis.verification.PurityRBFitter.ydata" signature="property ydata">
