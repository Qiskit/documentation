...
<Class id="qiskit.transpiler.FencedDAGCircuit" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.17/qiskit/transpiler/fencedobjs.py" signature="FencedDAGCircuit(dag_circuit_instance)">
  A dag circuit that cannot be modified (via remove\_op\_node)

  ### \_\_init\_\_

  <Function id="qiskit.transpiler.FencedDAGCircuit.__init__" name="__init__" signature="__init__(dag_circuit_instance)">
