...
`QFT(num_qubits=None, approximation_degree=0, do_swaps=True, inverse=False, insert_barriers=False, name='qft')` [GitHub](https://github.com/qiskit/qiskit/tree/stable/0.17/qiskit/circuit/library/basis_change/qft.py "view source code")
...
![../\_images/qiskit.circuit.library.QFT\_0\_1.png](/images/api/qiskit/0.27/qiskit.circuit.library.QFT_0_1.png)

The inverse QFT can be obtained by calling the `inverse` method on this class. The respective circuit diagram is:

![../\_images/qiskit.circuit.library.QFT\_1\_1.png](/images/api/qiskit/0.27/qiskit.circuit.library.QFT_1_1.png)
...
![../\_images/qiskit.circuit.library.QFT\_2\_1.png](/images/api/qiskit/0.27/qiskit.circuit.library.QFT_2_1.png)
...
| [`compose`](#qiskit.circuit.library.QFT.compose "qiskit.circuit.library.QFT.compose")(other\[, qubits, clbits, front, inplace])                                                 | Compose circuit with `other` circuit or instruction, optionally permuting wires.                                                    |
...
| [`pauli`](#qiskit.circuit.library.QFT.pauli "qiskit.circuit.library.QFT.pauli")(pauli\_string, qubits)                                                                          | Apply `PauliGate`.                                                                                                                  |
...
| [`qasm`](#qiskit.circuit.library.QFT.qasm "qiskit.circuit.library.QFT.qasm")(\[formatted, filename])                                                                            | Return OpenQASM string.                                                                                                             |
...
| [`to_instruction`](#qiskit.circuit.library.QFT.to_instruction "qiskit.circuit.library.QFT.to_instruction")(\[parameter\_map])                                                   | Create an Instruction out of this circuit.                                                                                          |
...
![../\_images/qiskit.circuit.library.QFT\_5\_0.png](/images/api/qiskit/0.27/qiskit.circuit.library.QFT_5_0.png) ![../\_images/qiskit.circuit.library.QFT\_5\_1.png](/images/api/qiskit/0.27/qiskit.circuit.library.QFT_5_1.png)
