...
<Class id="qiskit.pulse.library.GaussianSquare" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.17/qiskit/pulse/library/parametric_pulses.py" signature="GaussianSquare(duration, amp, sigma, width, name=None)">
...
$$
  ...
  *   **name** (`Optional`\[`str`]) – Display name for this pulse envelope.
  ...
  <Function id="qiskit.pulse.library.GaussianSquare.__init__" name="__init__" signature="__init__(duration, amp, sigma, width, name=None)">
    Initialize the gaussian square pulse.
  ...
  <Function id="qiskit.pulse.library.GaussianSquare.amp" name="amp" signature="property amp">
  ...
  <Function id="qiskit.pulse.library.GaussianSquare.assign" name="assign" signature="assign(parameter, value)">
  ...
  <Function id="qiskit.pulse.library.GaussianSquare.assign_parameters" name="assign_parameters" signature="assign_parameters(value_dict)">
  ...
  <Function id="qiskit.pulse.library.GaussianSquare.draw" name="draw" signature="draw(dt=None, style=None, filename=None, interp_method=None, scale=None, interactive=None, draw_title=None, backend=None, time_range=None, time_unit='dt', show_waveform_info=True, plotter='mpl2d', axis=None)">
  ...
  <Function id="qiskit.pulse.library.GaussianSquare.get_waveform" name="get_waveform" signature="get_waveform()">
  ...
  <Function id="qiskit.pulse.library.GaussianSquare.id" name="id" signature="property id">
  ...
  <Function id="qiskit.pulse.library.GaussianSquare.is_parameterized" name="is_parameterized" signature="is_parameterized()">
  ...
  <Function id="qiskit.pulse.library.GaussianSquare.parameters" name="parameters" signature="property parameters">
  ...
  <Function id="qiskit.pulse.library.GaussianSquare.sigma" name="sigma" signature="property sigma">
  ...
  <Function id="qiskit.pulse.library.GaussianSquare.validate_parameters" name="validate_parameters" signature="validate_parameters()">
    Validate parameters.
  ...
  <Function id="qiskit.pulse.library.GaussianSquare.width" name="width" signature="property width">
