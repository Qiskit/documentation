...
<Class id="qiskit.visualization.qcstyle.DefaultStyle" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.17/qiskit/visualization/qcstyle.py" signature="DefaultStyle">
  ...
  **displaycolor (dict): the color codes to use for each circuit element in**
  ...
  <Function id="qiskit.visualization.qcstyle.DefaultStyle.__init__" name="__init__" signature="__init__()">
