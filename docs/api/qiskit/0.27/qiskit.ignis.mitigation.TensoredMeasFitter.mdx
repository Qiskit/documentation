...
<Class id="qiskit.ignis.mitigation.TensoredMeasFitter" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-ignis/tree/stable/0.6/qiskit/ignis/mitigation/measurement/fitters.py" signature="TensoredMeasFitter(results, mit_pattern, substate_labels_list=None, circlabel='')">
  ...
  **ValueError** – if the mit\_pattern doesn’t match the substate\_labels\_list
  ...
  <Function id="qiskit.ignis.mitigation.TensoredMeasFitter.__init__" name="__init__" signature="__init__(results, mit_pattern, substate_labels_list=None, circlabel='')">
    Initialize a measurement calibration matrix from the results of running the circuits returned by measurement\_calibration\_circuits.
  ...
  <Function id="qiskit.ignis.mitigation.TensoredMeasFitter.add_data" name="add_data" signature="add_data(new_results, rebuild_cal_matrix=True)">
  ...
  <Function id="qiskit.ignis.mitigation.TensoredMeasFitter.cal_matrices" name="cal_matrices" signature="property cal_matrices">
    Return cal\_matrices.
  </Function>

  ### filter

  <Function id="qiskit.ignis.mitigation.TensoredMeasFitter.filter" name="filter" signature="property filter">
    Return a measurement filter using the cal matrices.
  </Function>

  ### nqubits

  <Function id="qiskit.ignis.mitigation.TensoredMeasFitter.nqubits" name="nqubits" signature="property nqubits">
    Return \_qubit\_list\_sizes.
  </Function>

  ### plot\_calibration

  <Function id="qiskit.ignis.mitigation.TensoredMeasFitter.plot_calibration" name="plot_calibration" signature="plot_calibration(cal_index=0, ax=None, show_plot=True)">
  ...
  <Function id="qiskit.ignis.mitigation.TensoredMeasFitter.readout_fidelity" name="readout_fidelity" signature="readout_fidelity(cal_index=0, label_list=None)">
  ...
  <Function id="qiskit.ignis.mitigation.TensoredMeasFitter.substate_labels_list" name="substate_labels_list" signature="property substate_labels_list">
