...
<Function id="qiskit.visualization.array_to_latex" github="https://github.com/qiskit/qiskit/tree/stable/0.17/qiskit/visualization/array.py" signature="array_to_latex(array, precision=5, prefix='', source=False, max_size=8)">
