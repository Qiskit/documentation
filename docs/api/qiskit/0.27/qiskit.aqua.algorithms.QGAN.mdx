...
<Class id="qiskit.aqua.algorithms.QGAN" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/aqua/algorithms/distribution_learners/qgan.py" signature="QGAN(data, bounds=None, num_qubits=None, batch_size=500, num_epochs=3000, seed=7, discriminator=None, generator=None, tol_rel_ent=None, snapshot_dir=None, quantum_instance=None)" modifiers="class">
  ...
  **Raises**
  ...
  <Function id="qiskit.aqua.algorithms.QGAN.backend" signature="backend" modifiers="property">
    Returns backend.
  ...
  <Function id="qiskit.aqua.algorithms.QGAN.d_loss" signature="d_loss" modifiers="property">
  ...
  <Function id="qiskit.aqua.algorithms.QGAN.discriminator" signature="discriminator" modifiers="property">
    Returns discriminator
  </Function>

  ### g\_loss

  <Function id="qiskit.aqua.algorithms.QGAN.g_loss" signature="g_loss" modifiers="property">
  ...
  <Function id="qiskit.aqua.algorithms.QGAN.generator" signature="generator" modifiers="property">
    Returns generator
  </Function>
  ...
  <Function id="qiskit.aqua.algorithms.QGAN.quantum_instance" signature="quantum_instance" modifiers="property">
  ...
  <Function id="qiskit.aqua.algorithms.QGAN.random" signature="random" modifiers="property">
    Return a numpy random.
  </Function>

  ### rel\_entr

  <Function id="qiskit.aqua.algorithms.QGAN.rel_entr" signature="rel_entr" modifiers="property">
  ...
  <Function id="qiskit.aqua.algorithms.QGAN.seed" signature="seed" modifiers="property">
    Returns random seed
  </Function>
  ...
  <Function id="qiskit.aqua.algorithms.QGAN.tol_rel_ent" signature="tol_rel_ent" modifiers="property">
