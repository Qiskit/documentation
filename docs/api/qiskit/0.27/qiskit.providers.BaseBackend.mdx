...
<Class id="qiskit.providers.BaseBackend" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.17/qiskit/providers/basebackend.py" signature="BaseBackend(configuration, provider=None)">
  ...
  **QiskitError** – if an error occurred when instantiating the backend.
  ...
  <Function id="qiskit.providers.BaseBackend.__init__" name="__init__" signature="abstract __init__(configuration, provider=None)">
    Base class for backends.
  ...
  <Function id="qiskit.providers.BaseBackend.configuration" name="configuration" signature="configuration()">
  ...
  <Function id="qiskit.providers.BaseBackend.name" name="name" signature="name()">
  ...
  <Function id="qiskit.providers.BaseBackend.properties" name="properties" signature="properties()">
  ...
  <Function id="qiskit.providers.BaseBackend.provider" name="provider" signature="provider()">
  ...
  <Function id="qiskit.providers.BaseBackend.run" name="run" signature="abstract run(qobj)">
  ...
  <Function id="qiskit.providers.BaseBackend.status" name="status" signature="status()">
  ...
  <Function id="qiskit.providers.BaseBackend.version" name="version" signature="version()">
