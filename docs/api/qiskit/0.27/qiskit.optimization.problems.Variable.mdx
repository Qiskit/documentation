...
<Class id="qiskit.optimization.problems.Variable" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/optimization/problems/variable.py" signature="Variable(quadratic_program, name, lowerbound=0, upperbound=1e+20, vartype=<VarType.CONTINUOUS: 0>)" modifiers="class">
  ...
  **Raises**
  ...
  <Function id="qiskit.optimization.problems.Variable.lowerbound" signature="lowerbound" modifiers="property">
  ...
  <Function id="qiskit.optimization.problems.Variable.name" signature="name" modifiers="property">
  ...
  <Function id="qiskit.optimization.problems.Variable.quadratic_program" signature="quadratic_program" modifiers="property">
  ...
  <Function id="qiskit.optimization.problems.Variable.upperbound" signature="upperbound" modifiers="property">
  ...
  <Function id="qiskit.optimization.problems.Variable.vartype" signature="vartype" modifiers="property">
