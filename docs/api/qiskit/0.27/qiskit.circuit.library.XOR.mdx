...
`XOR(num_qubits, amount=None, seed=None)` [GitHub](https://github.com/qiskit/qiskit/tree/stable/0.17/qiskit/circuit/library/boolean_logic/quantum_xor.py "view source code")
...
![../\_images/qiskit.circuit.library.XOR\_0\_1.png](/images/api/qiskit/0.27/qiskit.circuit.library.XOR_0_1.png)
...
![../\_images/qiskit.circuit.library.XOR\_1\_1.png](/images/api/qiskit/0.27/qiskit.circuit.library.XOR_1_1.png)
...
| [`compose`](#qiskit.circuit.library.XOR.compose "qiskit.circuit.library.XOR.compose")(other\[, qubits, clbits, front, inplace])                                                 | Compose circuit with `other` circuit or instruction, optionally permuting wires.                                                    |
...
| [`pauli`](#qiskit.circuit.library.XOR.pauli "qiskit.circuit.library.XOR.pauli")(pauli\_string, qubits)                                                                          | Apply `PauliGate`.                                                                                                                  |
...
| [`qasm`](#qiskit.circuit.library.XOR.qasm "qiskit.circuit.library.XOR.qasm")(\[formatted, filename])                                                                            | Return OpenQASM string.                                                                                                             |
...
| [`to_instruction`](#qiskit.circuit.library.XOR.to_instruction "qiskit.circuit.library.XOR.to_instruction")(\[parameter\_map])                                                   | Create an Instruction out of this circuit.                                                                                          |
...
![../\_images/qiskit.circuit.library.XOR\_4\_0.png](/images/api/qiskit/0.27/qiskit.circuit.library.XOR_4_0.png) ![../\_images/qiskit.circuit.library.XOR\_4\_1.png](/images/api/qiskit/0.27/qiskit.circuit.library.XOR_4_1.png)
