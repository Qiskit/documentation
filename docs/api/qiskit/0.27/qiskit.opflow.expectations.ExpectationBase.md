...
`ExpectationBase`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.17/qiskit/opflow/expectations/expectation_base.py "view source code")
...
<span id="qiskit.opflow.expectations.ExpectationBase.__init__" />
