...
`BOBYQA(maxiter=1000)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.17/qiskit/algorithms/optimizers/bobyqa.py "view source code")
...
<span id="qiskit.algorithms.optimizers.BOBYQA.__init__" />
