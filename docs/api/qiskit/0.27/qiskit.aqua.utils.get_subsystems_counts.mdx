...
<Function id="qiskit.aqua.utils.get_subsystems_counts" name="get_subsystems_counts" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/aqua/utils/subsystem.py" signature="get_subsystems_counts(complete_system_counts, post_select_index=None, post_select_flag=None)">
