---
title: NLocal (v0.27)
description: API reference for qiskit.circuit.library.NLocal in qiskit v0.27
  ...
  *   **ValueError** – If reps parameter is less than or equal to 0.
  ...
  <Function id="qiskit.circuit.library.NLocal.draw" signature="draw(output=None, scale=None, filename=None, style=None, interactive=False, plot_barriers=True, reverse_bits=False, justify=None, vertical_compression='medium', idle_wires=True, with_layout=True, fold=None, ax=None, initial_state=False, cregbundle=True)">
    ...
    **Example**
    ...
    ![../\_images/qiskit.circuit.library.NLocal\_0\_0.png](/docs/images/api/qiskit/0.27/qiskit.circuit.library.NLocal_0_0.avif) ![../\_images/qiskit.circuit.library.NLocal\_0\_1.png](/docs/images/api/qiskit/0.27/qiskit.circuit.library.NLocal_0_1.avif)
  </Function>
