...
<Class id="qiskit.qasm.Qasm" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.17/qiskit/qasm/qasm.py" signature="Qasm(filename=None, data=None)">
  ...
  <Function id="qiskit.qasm.Qasm.__init__" name="__init__" signature="__init__(filename=None, data=None)">
    Create an OPENQASM circuit object.
  </Function>
  ...
  <Function id="qiskit.qasm.Qasm.generate_tokens" name="generate_tokens" signature="generate_tokens()">
    Returns a generator of the tokens.
  </Function>

  ### parse

  <Function id="qiskit.qasm.Qasm.parse" name="parse" signature="parse()">
    Parse the data.
  </Function>

  ### return\_filename

  <Function id="qiskit.qasm.Qasm.return_filename" name="return_filename" signature="return_filename()">
    Return the filename.
  </Function>
</Class>
