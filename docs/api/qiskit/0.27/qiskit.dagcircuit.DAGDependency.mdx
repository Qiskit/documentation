---
title: DAGDependency (v0.27)
description: API reference for qiskit.dagcircuit.DAGDependency in qiskit v0.27
...
<Class id="qiskit.dagcircuit.DAGDependency" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.17/qiskit/dagcircuit/dagdependency.py" signature="DAGDependency" modifiers="class">
