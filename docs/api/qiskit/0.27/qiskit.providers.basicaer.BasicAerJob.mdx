...
<Class id="qiskit.providers.basicaer.BasicAerJob" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.17/qiskit/providers/basicaer/basicaerjob.py" signature="BasicAerJob(backend, job_id, result)">
  BasicAerJob class.
  ...
  *   **kwargs** – Any key value metadata to associate with this job.
  ...
  <Function id="qiskit.providers.basicaer.BasicAerJob.__init__" name="__init__" signature="__init__(backend, job_id, result)">
    Initializes the asynchronous job.
