...
<Class id="qiskit.providers.aer.AerProvider" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-aer/tree/stable/0.8/qiskit/providers/aer/aerprovider.py" signature="AerProvider">
  Provider for Qiskit Aer backends.

  ### \_\_init\_\_

  <Function id="qiskit.providers.aer.AerProvider.__init__" name="__init__" signature="__init__()">
