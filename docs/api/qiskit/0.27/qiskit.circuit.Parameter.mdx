...
<Class id="qiskit.circuit.Parameter" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.17/qiskit/circuit/parameter.py" signature="Parameter(name)">
  ...
  **name** (`str`) – name of the `Parameter`, used for visual representation. This can be any unicode string, e.g. “ϕ”.
  ...
  <Function id="qiskit.circuit.Parameter.__init__" name="__init__" signature="__init__(name)">
    Create a new named [`Parameter`](#qiskit.circuit.Parameter "qiskit.circuit.Parameter").
  ...
  <Function id="qiskit.circuit.Parameter.bind" name="bind" signature="bind(parameter_values)">
  ...
  <Function id="qiskit.circuit.Parameter.name" name="name" signature="property name">
    Returns the name of the [`Parameter`](#qiskit.circuit.Parameter "qiskit.circuit.Parameter").
  </Function>

  ### parameters

  <Function id="qiskit.circuit.Parameter.parameters" name="parameters" signature="property parameters">
  ...
  <Function id="qiskit.circuit.Parameter.subs" name="subs" signature="subs(parameter_map)">
