...
<Class id="qiskit.providers.models.JobStatus" github="https://github.com/qiskit/qiskit/tree/stable/0.17/qiskit/providers/models/jobstatus.py" signature="JobStatus(job_id, status, status_msg, **kwargs)">
  Model for JobStatus.
  ...
  <Function id="qiskit.providers.models.JobStatus.__init__" name="__init__" signature="__init__(job_id, status, status_msg, **kwargs)">
  ...
  <Function id="qiskit.providers.models.JobStatus.from_dict" name="from_dict" signature="classmethod from_dict(data)">
  ...
  <Function id="qiskit.providers.models.JobStatus.to_dict" name="to_dict" signature="to_dict()">
