...
<Function id="qiskit.quantum_info.random_clifford" name="random_clifford" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.17/qiskit/quantum_info/operators/symplectic/random.py" signature="random_clifford(num_qubits, seed=None)">
