---
title: IBMQFactory (v0.27)
description: API reference for qiskit.providers.ibmq.IBMQFactory in qiskit v0.27
...
<Class id="qiskit.providers.ibmq.IBMQFactory" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-ibmq-provider/tree/stable/0.14/qiskit/providers/ibmq/ibmqfactory.py" signature="IBMQFactory" modifiers="class">
  ...
  <Function id="qiskit.providers.ibmq.IBMQFactory.__init__" signature="__init__()">
    IBMQFactory constructor.
  </Function>
  ...
  <Function id="qiskit.providers.ibmq.IBMQFactory.active_account" signature="active_account()">
  ...
  <Function id="qiskit.providers.ibmq.IBMQFactory.delete_account" signature="delete_account()" modifiers="static">
  ...
  <Function id="qiskit.providers.ibmq.IBMQFactory.disable_account" signature="disable_account()">
  ...
  <Function id="qiskit.providers.ibmq.IBMQFactory.enable_account" signature="enable_account(token, url='https://auth.quantum-computing.ibm.com/api', hub=None, group=None, project=None, **kwargs)">
  ...
  <Function id="qiskit.providers.ibmq.IBMQFactory.get_provider" signature="get_provider(hub=None, group=None, project=None)">
  ...
  <Function id="qiskit.providers.ibmq.IBMQFactory.load_account" signature="load_account()">
  ...
  <Function id="qiskit.providers.ibmq.IBMQFactory.providers" signature="providers(hub=None, group=None, project=None)">
  ...
  <Function id="qiskit.providers.ibmq.IBMQFactory.save_account" signature="save_account(token, url='https://auth.quantum-computing.ibm.com/api', hub=None, group=None, project=None, overwrite=False, **kwargs)" modifiers="static">
  ...
  <Function id="qiskit.providers.ibmq.IBMQFactory.stored_account" signature="stored_account()" modifiers="static">
  ...
  <Function id="qiskit.providers.ibmq.IBMQFactory.update_account" signature="update_account(force=False)" modifiers="static">
