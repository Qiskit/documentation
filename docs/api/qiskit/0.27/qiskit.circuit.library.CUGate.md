...
`CUGate(theta, phi, lam, gamma, label=None, ctrl_state=None)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.17/qiskit/circuit/library/standard_gates/u.py "view source code")
...
<span id="qiskit.circuit.library.CUGate.__init__" />
...
<span id="qiskit.circuit.library.CUGate.add_decomposition" />
...
<span id="qiskit.circuit.library.CUGate.assemble" />
...
<span id="qiskit.circuit.library.CUGate.broadcast_arguments" />
...
<span id="qiskit.circuit.library.CUGate.c_if" />
...
<span id="qiskit.circuit.library.CUGate.control" />
...
<span id="qiskit.circuit.library.CUGate.copy" />
...
<span id="qiskit.circuit.library.CUGate.is_parameterized" />
...
<span id="qiskit.circuit.library.CUGate.mirror" />
...
<span id="qiskit.circuit.library.CUGate.power" />
...
<span id="qiskit.circuit.library.CUGate.qasm" />
...
<span id="qiskit.circuit.library.CUGate.repeat" />
...
<span id="qiskit.circuit.library.CUGate.reverse_ops" />
...
<span id="qiskit.circuit.library.CUGate.soft_compare" />
...
<span id="qiskit.circuit.library.CUGate.to_matrix" />
...
<span id="qiskit.circuit.library.CUGate.validate_parameter" />
