...
<Class id="qiskit.transpiler.TransformationPass" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.17/qiskit/transpiler/basepasses.py" signature="TransformationPass(*args, **kwargs)">
  ...
  <Function id="qiskit.transpiler.TransformationPass.is_analysis_pass" signature="property is_analysis_pass">
  ...
  <Function id="qiskit.transpiler.TransformationPass.is_transformation_pass" signature="property is_transformation_pass">
  ...
  <Function id="qiskit.transpiler.TransformationPass.run" signature="abstract run(dag)">
