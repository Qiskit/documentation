...
<Function id="qiskit.quantum_info.decompose_clifford" github="https://github.com/qiskit/qiskit/tree/stable/0.17/qiskit/quantum_info/synthesis/clifford_decompose.py" signature="decompose_clifford(clifford, method=None)">
