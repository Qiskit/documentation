...
`StabilizerTable(data, phase=None)` [GitHub](https://github.com/qiskit/qiskit/tree/stable/0.17/qiskit/quantum_info/operators/symplectic/stabilizer_table.py "view source code")
...
```python
Initial Ordering
StabilizerTable: ['+II', '-YY', '-IX', '+ZX', '-XY', '+YI', '-XZ', '+YY', '-YX', '-XI', '-IZ', '+ZI', '-II', '+XI', '-ZX', '+IY', '+IZ', '+YX', '-XX', '-ZI', '+YZ', '-ZZ', '+XY', '+XX', '-ZY', '-YI', '-YZ', '+ZY', '-IY', '+ZZ', '+IX', '+XZ']
