...
<Class id="qiskit.aqua.components.optimizers.POWELL" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/aqua/components/optimizers/powell.py" signature="POWELL(maxiter=None, maxfev=1000, disp=False, xtol=0.0001, tol=None)" modifiers="class">
  Powell optimizer.
