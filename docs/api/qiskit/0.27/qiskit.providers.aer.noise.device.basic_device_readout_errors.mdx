...
<Function id="qiskit.providers.aer.noise.device.basic_device_readout_errors" name="basic_device_readout_errors" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-aer/tree/stable/0.8/qiskit/providers/aer/noise/device/models.py" signature="basic_device_readout_errors(properties)">
