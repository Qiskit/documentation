...
<Class id="qiskit.pulse.instructions.Delay" github="https://github.com/qiskit/qiskit/tree/stable/0.17/qiskit/pulse/instructions/delay.py" signature="Delay(duration, channel, name=None)">
