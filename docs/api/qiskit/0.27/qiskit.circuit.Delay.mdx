---
title: Delay (v0.27)
description: API reference for qiskit.circuit.Delay in qiskit v0.27
...
<Class id="qiskit.circuit.Delay" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.17/qiskit/circuit/delay.py" signature="Delay(duration, unit='dt')" modifiers="class">
