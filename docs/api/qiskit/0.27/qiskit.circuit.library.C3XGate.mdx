...
<Class id="qiskit.circuit.library.C3XGate" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.17/qiskit/circuit/library/standard_gates/x.py" signature="C3XGate(angle=None, label=None, ctrl_state=None)" modifiers="class">
  ...
  <Function id="qiskit.circuit.library.C3XGate.ctrl_state" signature="ctrl_state" modifiers="property">
  ...
  <Function id="qiskit.circuit.library.C3XGate.decompositions" signature="decompositions" modifiers="property">
    Get the decompositions of the instruction from the SessionEquivalenceLibrary.
  </Function>

  ### definition

  <Function id="qiskit.circuit.library.C3XGate.definition" signature="definition" modifiers="property">
  ...
  <Function id="qiskit.circuit.library.C3XGate.duration" signature="duration" modifiers="property">
    Get the duration.
  </Function>
  ...
  <Function id="qiskit.circuit.library.C3XGate.label" signature="label" modifiers="property">
    Return gate label
  ...
  <Function id="qiskit.circuit.library.C3XGate.name" signature="name" modifiers="property">
  ...
  <Function id="qiskit.circuit.library.C3XGate.num_ctrl_qubits" signature="num_ctrl_qubits" modifiers="property">
  ...
  <Function id="qiskit.circuit.library.C3XGate.params" signature="params" modifiers="property">
  ...
  <Function id="qiskit.circuit.library.C3XGate.unit" signature="unit" modifiers="property">
