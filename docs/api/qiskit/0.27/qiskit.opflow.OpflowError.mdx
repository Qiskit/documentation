...
`OpflowError(*message)` [GitHub](https://github.com/qiskit/qiskit/tree/stable/0.17/qiskit/opflow/exceptions.py "view source code")
...
<span id="qiskit.opflow.OpflowError.with_traceback" />
