---
title: FasterAmplitudeEstimation (v0.27)
description: API reference for qiskit.algorithms.FasterAmplitudeEstimation in qiskit v0.27
...
<Class id="qiskit.algorithms.FasterAmplitudeEstimation" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.17/qiskit/algorithms/amplitude_estimators/fae.py" signature="FasterAmplitudeEstimation(delta, maxiter, rescale=True, quantum_instance=None)" modifiers="class">
  ...
  *   **quantum\_instance** (`Union`\[`QuantumInstance`, `BaseBackend`, `Backend`, `None`]) – The quantum instance or backend to run the circuits.
  ...
  <Function id="qiskit.algorithms.FasterAmplitudeEstimation.__init__" signature="__init__(delta, maxiter, rescale=True, quantum_instance=None)">
    **Parameters**
