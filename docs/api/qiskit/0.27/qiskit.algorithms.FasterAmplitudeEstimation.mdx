...
<Class id="qiskit.algorithms.FasterAmplitudeEstimation" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.17/qiskit/algorithms/amplitude_estimators/fae.py" signature="FasterAmplitudeEstimation(delta, maxiter, rescale=True, quantum_instance=None)">
  ...
  *   **quantum\_instance** (`Union`\[`QuantumInstance`, `BaseBackend`, `Backend`, `None`]) – The quantum instance or backend to run the circuits.
  ...
  <Function id="qiskit.algorithms.FasterAmplitudeEstimation.__init__" name="__init__" signature="__init__(delta, maxiter, rescale=True, quantum_instance=None)">
    **Parameters**
  ...
  <Function id="qiskit.algorithms.FasterAmplitudeEstimation.construct_circuit" name="construct_circuit" signature="construct_circuit(estimation_problem, k, measurement=False)">
  ...
  <Function id="qiskit.algorithms.FasterAmplitudeEstimation.estimate" name="estimate" signature="estimate(estimation_problem)">
  ...
  <Function id="qiskit.algorithms.FasterAmplitudeEstimation.quantum_instance" name="quantum_instance" signature="property quantum_instance">
