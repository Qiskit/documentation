...
<Class id="qiskit.aqua.operators.evolutions.Suzuki" github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/aqua/operators/evolutions/trotterizations/suzuki.py" signature="Suzuki(reps=1, order=2)">
  ...
  *   **order** (`int`) – The order of the expansion to perform.
  ...
  <Function id="qiskit.aqua.operators.evolutions.Suzuki.__init__" name="__init__" signature="__init__(reps=1, order=2)">
    **Parameters**
  ...
  <Function id="qiskit.aqua.operators.evolutions.Suzuki.convert" name="convert" signature="convert(operator)">
  ...
  <Function id="qiskit.aqua.operators.evolutions.Suzuki.order" name="order" signature="property order">
    returns order
  ...
  <Function id="qiskit.aqua.operators.evolutions.Suzuki.reps" name="reps" signature="property reps">
