---
title: name_args (v0.27)
description: API reference for qiskit.aqua.utils.name_args in qiskit v0.27
...
<Function id="qiskit.aqua.utils.name_args" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/aqua/utils/name_unnamed_args.py" signature="name_args(mapping, skip=0)">
