...
<Class id="qiskit.algorithms.Shor" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.17/qiskit/algorithms/factorizers/shor.py" signature="Shor(quantum_instance=None)">
  ...
  **quantum\_instance** (`Union`\[`QuantumInstance`, `BaseBackend`, `Backend`, `None`]) – Quantum Instance or Backend
  ...
  <Function id="qiskit.algorithms.Shor.__init__" name="__init__" signature="__init__(quantum_instance=None)">
    **Parameters**
  ...
  <Function id="qiskit.algorithms.Shor.construct_circuit" name="construct_circuit" signature="construct_circuit(N, a=2, measurement=False)">
    Construct circuit.
  ...
  <Function id="qiskit.algorithms.Shor.factor" name="factor" signature="factor(N, a=2)">
  ...
  <Function id="qiskit.algorithms.Shor.modinv" name="modinv" signature="static modinv(a, m)">
  ...
  <Function id="qiskit.algorithms.Shor.quantum_instance" name="quantum_instance" signature="property quantum_instance">
