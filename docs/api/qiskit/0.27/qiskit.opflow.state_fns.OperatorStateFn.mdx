...
<Class id="qiskit.opflow.state_fns.OperatorStateFn" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.17/qiskit/opflow/state_fns/operator_state_fn.py" signature="OperatorStateFn(primitive, coeff=1.0, is_measurement=False)" modifiers="class">
  ...
  *   **is\_measurement** (`bool`) – Whether the StateFn is a measurement operator
  ...
  <Function id="qiskit.opflow.state_fns.OperatorStateFn.__init__" signature="__init__(primitive, coeff=1.0, is_measurement=False)">
    **Parameters**
  ...
  <Function id="qiskit.opflow.state_fns.OperatorStateFn.assign_parameters" signature="assign_parameters(param_dict)">
  ...
  <Function id="qiskit.opflow.state_fns.OperatorStateFn.bind_parameters" signature="bind_parameters(param_dict)">
  ...
  <Function id="qiskit.opflow.state_fns.OperatorStateFn.coeff" signature="coeff" modifiers="property">
  ...
  <Function id="qiskit.opflow.state_fns.OperatorStateFn.compose" signature="compose(other, permutation=None, front=False)">
  ...
  <Function id="qiskit.opflow.state_fns.OperatorStateFn.copy" signature="copy()">
  ...
  <Function id="qiskit.opflow.state_fns.OperatorStateFn.equals" signature="equals(other)">
  ...
  <Function id="qiskit.opflow.state_fns.OperatorStateFn.instance_id" signature="instance_id" modifiers="property">
  ...
  <Function id="qiskit.opflow.state_fns.OperatorStateFn.is_measurement" signature="is_measurement" modifiers="property">
  ...
  <Function id="qiskit.opflow.state_fns.OperatorStateFn.mul" signature="mul(scalar)">
  ...
  <Function id="qiskit.opflow.state_fns.OperatorStateFn.neg" signature="neg()">
  ...
  <Function id="qiskit.opflow.state_fns.OperatorStateFn.num_qubits" signature="num_qubits" modifiers="property">
  ...
  <Function id="qiskit.opflow.state_fns.OperatorStateFn.parameters" signature="parameters" modifiers="property">
  ...
  <Function id="qiskit.opflow.state_fns.OperatorStateFn.power" signature="power(exponent)">
  ...
  <Function id="qiskit.opflow.state_fns.OperatorStateFn.primitive" signature="primitive" modifiers="property">
  ...
  <Function id="qiskit.opflow.state_fns.OperatorStateFn.reduce" signature="reduce()">
  ...
  <Function id="qiskit.opflow.state_fns.OperatorStateFn.tensorpower" signature="tensorpower(other)">
  ...
  <Function id="qiskit.opflow.state_fns.OperatorStateFn.to_spmatrix" signature="to_spmatrix()">
  ...
  <Function id="qiskit.opflow.state_fns.OperatorStateFn.traverse" signature="traverse(convert_fn, coeff=None)">
