...
<Class id="qiskit.pulse.Drag" github="https://github.com/qiskit/qiskit/tree/stable/0.17/qiskit/pulse/library/parametric_pulses.py" signature="Drag(duration, amp, sigma, beta, name=None)">
...
$$
  ...
  *   **name** (`Optional`\[`str`]) – Display name for this pulse envelope.
  ...
  <Function id="qiskit.pulse.Drag.__init__" name="__init__" signature="__init__(duration, amp, sigma, beta, name=None)">
    Initialize the drag pulse.
  ...
  <Function id="qiskit.pulse.Drag.amp" name="amp" signature="property amp">
  ...
  <Function id="qiskit.pulse.Drag.assign" name="assign" signature="assign(parameter, value)">
  ...
  <Function id="qiskit.pulse.Drag.assign_parameters" name="assign_parameters" signature="assign_parameters(value_dict)">
  ...
  <Function id="qiskit.pulse.Drag.beta" name="beta" signature="property beta">
  ...
  <Function id="qiskit.pulse.Drag.draw" name="draw" signature="draw(dt=None, style=None, filename=None, interp_method=None, scale=None, interactive=None, draw_title=None, backend=None, time_range=None, time_unit='dt', show_waveform_info=True, plotter='mpl2d', axis=None)">
  ...
  <Function id="qiskit.pulse.Drag.get_waveform" name="get_waveform" signature="get_waveform()">
  ...
  <Function id="qiskit.pulse.Drag.id" name="id" signature="property id">
  ...
  <Function id="qiskit.pulse.Drag.is_parameterized" name="is_parameterized" signature="is_parameterized()">
  ...
  <Function id="qiskit.pulse.Drag.parameters" name="parameters" signature="property parameters">
  ...
  <Function id="qiskit.pulse.Drag.sigma" name="sigma" signature="property sigma">
  ...
  <Function id="qiskit.pulse.Drag.validate_parameters" name="validate_parameters" signature="validate_parameters()">
    Validate parameters.
