...
<Class id="qiskit.aqua.components.eigs.Eigenvalues" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/aqua/components/eigs/eigs.py" signature="Eigenvalues">
  ...
  <Function id="qiskit.aqua.components.eigs.Eigenvalues.__init__" name="__init__" signature="abstract __init__()">
  ...
  <Function id="qiskit.aqua.components.eigs.Eigenvalues.construct_circuit" name="construct_circuit" signature="abstract construct_circuit(mode, register=None)">
  ...
  <Function id="qiskit.aqua.components.eigs.Eigenvalues.construct_inverse" name="construct_inverse" signature="construct_inverse(mode, circuit)">
  ...
  <Function id="qiskit.aqua.components.eigs.Eigenvalues.get_register_sizes" name="get_register_sizes" signature="abstract get_register_sizes()">
    get register sizes
  </Function>

  ### get\_scaling

  <Function id="qiskit.aqua.components.eigs.Eigenvalues.get_scaling" name="get_scaling" signature="abstract get_scaling()">
    get scaling
  </Function>
</Class>
