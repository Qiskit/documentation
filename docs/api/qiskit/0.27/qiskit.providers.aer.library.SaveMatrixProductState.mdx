---
title: SaveMatrixProductState (v0.27)
description: API reference for qiskit.providers.aer.library.SaveMatrixProductState in qiskit v0.27
...
<Class id="qiskit.providers.aer.library.SaveMatrixProductState" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-aer/tree/stable/0.8/qiskit/providers/aer/library/save_instructions/save_matrix_product_state.py" signature="SaveMatrixProductState(num_qubits, label='matrix_product_state', pershot=False, conditional=False)" modifiers="class">
  ...
  *   **conditional** (*bool*) – if True save data conditional on the current classical register values \[Default: False].
  ...
  <Function id="qiskit.providers.aer.library.SaveMatrixProductState.__init__" signature="__init__(num_qubits, label='matrix_product_state', pershot=False, conditional=False)">
    Create new instruction to save the matrix product state.
  ...
  <Function id="qiskit.providers.aer.library.SaveMatrixProductState.add_decomposition" signature="add_decomposition(decomposition)">
    Add a decomposition of the instruction to the SessionEquivalenceLibrary.
  </Function>

  ### assemble

  <Function id="qiskit.providers.aer.library.SaveMatrixProductState.assemble" signature="assemble()">
    Return the QasmQobjInstruction for the intructions.
  </Function>

  ### broadcast\_arguments

  <Function id="qiskit.providers.aer.library.SaveMatrixProductState.broadcast_arguments" signature="broadcast_arguments(qargs, cargs)">
  ...
  <Function id="qiskit.providers.aer.library.SaveMatrixProductState.c_if" signature="c_if(classical, val)">
    Add classical condition on register classical and value val.
  </Function>

  ### copy

  <Function id="qiskit.providers.aer.library.SaveMatrixProductState.copy" signature="copy(name=None)">
  ...
  <Function id="qiskit.providers.aer.library.SaveMatrixProductState.inverse" signature="inverse()">
    Special case. Return self.
  </Function>

  ### is\_parameterized

  <Function id="qiskit.providers.aer.library.SaveMatrixProductState.is_parameterized" signature="is_parameterized()">
    Return True .IFF. instruction is parameterized else False
  </Function>

  ### mirror

  <Function id="qiskit.providers.aer.library.SaveMatrixProductState.mirror" signature="mirror()">
  ...
  <Function id="qiskit.providers.aer.library.SaveMatrixProductState.qasm" signature="qasm()">
  ...
  <Function id="qiskit.providers.aer.library.SaveMatrixProductState.repeat" signature="repeat(n)">
  ...
  <Function id="qiskit.providers.aer.library.SaveMatrixProductState.reverse_ops" signature="reverse_ops()">
  ...
  <Function id="qiskit.providers.aer.library.SaveMatrixProductState.soft_compare" signature="soft_compare(other)">
  ...
  <Function id="qiskit.providers.aer.library.SaveMatrixProductState.validate_parameter" signature="validate_parameter(parameter)">
