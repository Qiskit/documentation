...
<Class id="qiskit.providers.aer.library.SaveMatrixProductState" github="https://github.com/qiskit/qiskit-aer/tree/stable/0.8/qiskit/providers/aer/library/save_instructions/save_matrix_product_state.py" signature="SaveMatrixProductState(num_qubits, label='matrix_product_state', pershot=False, conditional=False)">
