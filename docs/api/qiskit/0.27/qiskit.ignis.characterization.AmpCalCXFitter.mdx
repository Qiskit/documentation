---
title: AmpCalCXFitter (v0.27)
description: API reference for qiskit.ignis.characterization.AmpCalCXFitter in qiskit v0.27
...
<Class id="qiskit.ignis.characterization.AmpCalCXFitter" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-ignis/tree/stable/0.6/qiskit/ignis/characterization/gates/fitters.py" signature="AmpCalCXFitter(backend_result, xdata, qubits, fit_p0, fit_bounds)" modifiers="class">
