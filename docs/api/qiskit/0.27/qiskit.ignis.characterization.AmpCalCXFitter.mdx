...
<Class id="qiskit.ignis.characterization.AmpCalCXFitter" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-ignis/tree/stable/0.6/qiskit/ignis/characterization/gates/fitters.py" signature="AmpCalCXFitter(backend_result, xdata, qubits, fit_p0, fit_bounds)">
  ...
  <Function id="qiskit.ignis.characterization.AmpCalCXFitter.__init__" signature="__init__(backend_result, xdata, qubits, fit_p0, fit_bounds)">
    See BaseFitter \_\_init\_\_
  </Function>
  ...
  <Function id="qiskit.ignis.characterization.AmpCalCXFitter.add_data" signature="add_data(results, recalc=True, refit=True)">
  ...
  <Function id="qiskit.ignis.characterization.AmpCalCXFitter.angle_err" signature="angle_err(qind=- 1)">
  ...
  <Function id="qiskit.ignis.characterization.AmpCalCXFitter.backend_result" signature="property backend_result">
  ...
  <Function id="qiskit.ignis.characterization.AmpCalCXFitter.description" signature="property description">
  ...
  <Function id="qiskit.ignis.characterization.AmpCalCXFitter.fit_data" signature="fit_data(qid=- 1, p0=None, bounds=None, series=None)">
    Fit the curve.
  ...
  <Function id="qiskit.ignis.characterization.AmpCalCXFitter.fit_fun" signature="property fit_fun">
  ...
  <Function id="qiskit.ignis.characterization.AmpCalCXFitter.measured_qubits" signature="property measured_qubits">
  ...
  <Function id="qiskit.ignis.characterization.AmpCalCXFitter.params" signature="property params">
  ...
  <Function id="qiskit.ignis.characterization.AmpCalCXFitter.params_err" signature="property params_err">
  ...
  <Function id="qiskit.ignis.characterization.AmpCalCXFitter.plot" signature="plot(qind, series='0', ax=None, show_plot=False)">
    Plot err data.
  ...
  <Function id="qiskit.ignis.characterization.AmpCalCXFitter.series" signature="property series">
  ...
  <Function id="qiskit.ignis.characterization.AmpCalCXFitter.xdata" signature="property xdata">
  ...
  <Function id="qiskit.ignis.characterization.AmpCalCXFitter.ydata" signature="property ydata">
