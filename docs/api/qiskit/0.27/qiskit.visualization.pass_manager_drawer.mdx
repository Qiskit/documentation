...
<Function id="qiskit.visualization.pass_manager_drawer" name="pass_manager_drawer" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.17/qiskit/visualization/pass_manager_visualization.py" signature="pass_manager_drawer(pass_manager, filename=None, style=None, raw=False)">
