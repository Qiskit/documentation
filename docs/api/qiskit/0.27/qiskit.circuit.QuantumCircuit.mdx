...
<Class id="qiskit.circuit.QuantumCircuit" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.17/qiskit/circuit/quantumcircuit.py" signature="QuantumCircuit(*regs, name=None, global_phase=0, metadata=None)">
  ...
  **Examples**
  ...
  <Function id="qiskit.circuit.QuantumCircuit.__init__" signature="__init__(*regs, name=None, global_phase=0, metadata=None)">
  ...
  <Function id="qiskit.circuit.QuantumCircuit.ancillas" signature="property ancillas">
  ...
  <Function id="qiskit.circuit.QuantumCircuit.assign_parameters" signature="assign_parameters(parameters, inplace=False, param_dict=None)">
  ...
  <Function id="qiskit.circuit.QuantumCircuit.barrier" signature="barrier(*qargs)">
    Apply `Barrier`. If qargs is None, applies to all.
  </Function>

  ### bind\_parameters

  <Function id="qiskit.circuit.QuantumCircuit.bind_parameters" signature="bind_parameters(values, value_dict=None)">
  ...
  <Function id="qiskit.circuit.QuantumCircuit.calibrations" signature="property calibrations">
  ...
  <Function id="qiskit.circuit.QuantumCircuit.cast" signature="static cast(value, _type)">
  ...
  <Function id="qiskit.circuit.QuantumCircuit.ccx" signature="ccx(control_qubit1, control_qubit2, target_qubit)">
  ...
  <Function id="qiskit.circuit.QuantumCircuit.clbits" signature="property clbits">
    Returns a list of classical bits in the order that the registers were added.
  </Function>

  ### cls\_instances

  <Function id="qiskit.circuit.QuantumCircuit.cls_instances" signature="classmethod cls_instances()">
    Return the current number of instances of this class, useful for auto naming.
  </Function>

  ### cls\_prefix

  <Function id="qiskit.circuit.QuantumCircuit.cls_prefix" signature="classmethod cls_prefix()">
  ...
  <Function id="qiskit.circuit.QuantumCircuit.combine" signature="combine(rhs)">
  ...
  <Function id="qiskit.circuit.QuantumCircuit.compose" signature="compose(other, qubits=None, clbits=None, front=False, inplace=False)">
  ...
  <Function id="qiskit.circuit.QuantumCircuit.cu1" signature="cu1(theta, control_qubit, target_qubit, label=None, ctrl_state=None)">
    Apply [`CU1Gate`](qiskit.circuit.library.CU1Gate "qiskit.circuit.library.CU1Gate").
  </Function>

  ### cu3

  <Function id="qiskit.circuit.QuantumCircuit.cu3" signature="cu3(theta, phi, lam, control_qubit, target_qubit, label=None, ctrl_state=None)">
  ...
  <Function id="qiskit.circuit.QuantumCircuit.data" signature="property data">
  ...
  <Function id="qiskit.circuit.QuantumCircuit.decompose" signature="decompose()">
  ...
  <Function id="qiskit.circuit.QuantumCircuit.depth" signature="depth()">
  ...
  <Function id="qiskit.circuit.QuantumCircuit.draw" signature="draw(output=None, scale=None, filename=None, style=None, interactive=False, plot_barriers=True, reverse_bits=False, justify=None, vertical_compression='medium', idle_wires=True, with_layout=True, fold=None, ax=None, initial_state=False, cregbundle=True)">
  ...
  <Function id="qiskit.circuit.QuantumCircuit.extend" signature="extend(rhs)">
  ...
  <Function id="qiskit.circuit.QuantumCircuit.from_qasm_file" signature="static from_qasm_file(path)">
  ...
  <Function id="qiskit.circuit.QuantumCircuit.from_qasm_str" signature="static from_qasm_str(qasm_str)">
  ...
  <Function id="qiskit.circuit.QuantumCircuit.global_phase" signature="property global_phase">
  ...
  <Function id="qiskit.circuit.QuantumCircuit.initialize" signature="initialize(params, qubits=None)">
  ...
  <Function id="qiskit.circuit.QuantumCircuit.iso" signature="iso(isometry, q_input, q_ancillas_for_output, q_ancillas_zero=None, q_ancillas_dirty=None)">
  ...
  <Function id="qiskit.circuit.QuantumCircuit.isometry" signature="isometry(isometry, q_input, q_ancillas_for_output, q_ancillas_zero=None, q_ancillas_dirty=None)">
    Attach an arbitrary isometry from m to n qubits to a circuit. In particular, this allows to attach arbitrary unitaries on n qubits (m=n) or to prepare any state on n qubits (m=0). The decomposition used here was introduced by Iten et al. in [https://arxiv.org/abs/1501.06911](https://arxiv.org/abs/1501.06911).
  ...
  <Function id="qiskit.circuit.QuantumCircuit.mcu1" signature="mcu1(lam, control_qubits, target_qubit)">
    Apply `MCU1Gate`.
  </Function>
  ...
  <Function id="qiskit.circuit.QuantumCircuit.measure_all" signature="measure_all(inplace=True)">
  ...
  <Function id="qiskit.circuit.QuantumCircuit.metadata" signature="property metadata">
  ...
  <Function id="qiskit.circuit.QuantumCircuit.num_ancillas" signature="property num_ancillas">
    Return the number of ancilla qubits.
  </Function>

  ### num\_clbits

  <Function id="qiskit.circuit.QuantumCircuit.num_clbits" signature="property num_clbits">
  ...
  <Function id="qiskit.circuit.QuantumCircuit.num_parameters" signature="property num_parameters">
    Convenience function to get the number of parameter objects in the circuit.
  </Function>

  ### num\_qubits

  <Function id="qiskit.circuit.QuantumCircuit.num_qubits" signature="property num_qubits">
  ...
  <Function id="qiskit.circuit.QuantumCircuit.parameters" signature="property parameters">
  ...
  <Function id="qiskit.circuit.QuantumCircuit.qasm" signature="qasm(formatted=False, filename=None)">
  ...
  <Function id="qiskit.circuit.QuantumCircuit.qubits" signature="property qubits">
  ...
  <Function id="qiskit.circuit.QuantumCircuit.save_amplitudes" signature="save_amplitudes(params, label='amplitudes', pershot=False, conditional=False)">
  ...
  <Function id="qiskit.circuit.QuantumCircuit.save_amplitudes_squared" signature="save_amplitudes_squared(params, label='amplitudes_squared', unnormalized=False, pershot=False, conditional=False)">
  ...
  <Function id="qiskit.circuit.QuantumCircuit.save_density_matrix" signature="save_density_matrix(qubits=None, label='density_matrix', unnormalized=False, pershot=False, conditional=False)">
  ...
  <Function id="qiskit.circuit.QuantumCircuit.save_expectation_value" signature="save_expectation_value(operator, qubits, label='expectation_value', unnormalized=False, pershot=False, conditional=False)">
  ...
  <Function id="qiskit.circuit.QuantumCircuit.save_expectation_value_variance" signature="save_expectation_value_variance(operator, qubits, label='expectation_value_variance', unnormalized=False, pershot=False, conditional=False)">
    Save the expectation value of a Hermitian operator.
  ...
  <Function id="qiskit.circuit.QuantumCircuit.save_matrix_product_state" signature="save_matrix_product_state(label='matrix_product_state', pershot=False, conditional=False)">
  ...
  <Function id="qiskit.circuit.QuantumCircuit.save_probabilities" signature="save_probabilities(qubits=None, label='probabilities', unnormalized=False, pershot=False, conditional=False)">
  ...
  <Function id="qiskit.circuit.QuantumCircuit.save_probabilities_dict" signature="save_probabilities_dict(qubits=None, label='probabilities', unnormalized=False, pershot=False, conditional=False)">
    Save measurement outcome probabilities vector.
  ...
  <Function id="qiskit.circuit.QuantumCircuit.save_stabilizer" signature="save_stabilizer(label='stabilizer', pershot=False, conditional=False)">
  ...
  <Function id="qiskit.circuit.QuantumCircuit.save_state" signature="save_state(label=None, pershot=False, conditional=False)">
  ...
  <Function id="qiskit.circuit.QuantumCircuit.save_statevector" signature="save_statevector(label='statevector', pershot=False, conditional=False)">
  ...
  <Function id="qiskit.circuit.QuantumCircuit.save_statevector_dict" signature="save_statevector_dict(label='statevector', pershot=False, conditional=False)">
  ...
  <Function id="qiskit.circuit.QuantumCircuit.save_superop" signature="save_superop(label='superop', pershot=False)">
  ...
  <Function id="qiskit.circuit.QuantumCircuit.save_unitary" signature="save_unitary(label='unitary', pershot=False)">
  ...
  <Function id="qiskit.circuit.QuantumCircuit.set_density_matrix" signature="set_density_matrix(state)">
  ...
  <Function id="qiskit.circuit.QuantumCircuit.set_matrix_product_state" signature="set_matrix_product_state(state)">
  ...
  <Function id="qiskit.circuit.QuantumCircuit.set_stabilizer" signature="set_stabilizer(state)">
  ...
  <Function id="qiskit.circuit.QuantumCircuit.set_statevector" signature="set_statevector(state)">
  ...
  <Function id="qiskit.circuit.QuantumCircuit.set_superop" signature="set_superop(state)">
  ...
  <Function id="qiskit.circuit.QuantumCircuit.set_unitary" signature="set_unitary(state)">
  ...
  <Function id="qiskit.circuit.QuantumCircuit.size" signature="size()">
  ...
  <Function id="qiskit.circuit.QuantumCircuit.snapshot_density_matrix" signature="snapshot_density_matrix(label, qubits=None)">
  ...
  <Function id="qiskit.circuit.QuantumCircuit.snapshot_expectation_value" signature="snapshot_expectation_value(label, op, qubits, single_shot=False, variance=False)">
  ...
  <Function id="qiskit.circuit.QuantumCircuit.snapshot_probabilities" signature="snapshot_probabilities(label, qubits, variance=False)">
  ...
  <Function id="qiskit.circuit.QuantumCircuit.snapshot_stabilizer" signature="snapshot_stabilizer(label)">
  ...
  <Function id="qiskit.circuit.QuantumCircuit.snapshot_statevector" signature="snapshot_statevector(label)">
  ...
  <Function id="qiskit.circuit.QuantumCircuit.squ" signature="squ(unitary_matrix, qubit, mode='ZYZ', up_to_diagonal=False, *, u=None)">
  ...
  <Function id="qiskit.circuit.QuantumCircuit.to_instruction" signature="to_instruction(parameter_map=None)">
  ...
  <Function id="qiskit.circuit.QuantumCircuit.u1" signature="u1(theta, qubit)">
    Apply [`U1Gate`](qiskit.circuit.library.U1Gate "qiskit.circuit.library.U1Gate").
  </Function>

  ### u2

  <Function id="qiskit.circuit.QuantumCircuit.u2" signature="u2(phi, lam, qubit)">
    Apply [`U2Gate`](qiskit.circuit.library.U2Gate "qiskit.circuit.library.U2Gate").
  </Function>

  ### u3

  <Function id="qiskit.circuit.QuantumCircuit.u3" signature="u3(theta, phi, lam, qubit)">
