...
<Class id="qiskit.aqua.operators.gradients.DerivativeBase" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/aqua/operators/gradients/derivative_base.py" signature="DerivativeBase">
  ...
  <Function id="qiskit.aqua.operators.gradients.DerivativeBase.convert" signature="abstract convert(operator, params=None)">
    **Parameters**
  ...
  <Function id="qiskit.aqua.operators.gradients.DerivativeBase.parameter_expression_grad" signature="static parameter_expression_grad(param_expr, param)">
