...
<Class id="qiskit.visualization.pulse_v2.IQXSimple" github="https://github.com/qiskit/qiskit/tree/stable/0.17/qiskit/visualization/pulse_v2/stylesheet.py" signature="IQXSimple(**kwargs)">
