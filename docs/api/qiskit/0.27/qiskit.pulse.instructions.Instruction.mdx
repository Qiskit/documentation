...
<Class id="qiskit.pulse.instructions.Instruction" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.17/qiskit/pulse/instructions/instruction.py" signature="Instruction(operands, duration=None, channels=None, name=None)">
  ...
  *   [**PulseError**](qiskit.pulse.PulseError "qiskit.pulse.PulseError") – If the input `channels` are not all of type `Channel`.
  ...
  <Function id="qiskit.pulse.instructions.Instruction.channels" signature="abstract property channels">
  ...
  <Function id="qiskit.pulse.instructions.Instruction.duration" signature="property duration">
  ...
  <Function id="qiskit.pulse.instructions.Instruction.id" signature="property id">
  ...
  <Function id="qiskit.pulse.instructions.Instruction.instructions" signature="property instructions">
  ...
  <Function id="qiskit.pulse.instructions.Instruction.name" signature="property name">
  ...
  <Function id="qiskit.pulse.instructions.Instruction.operands" signature="property operands">
  ...
  <Function id="qiskit.pulse.instructions.Instruction.parameters" signature="property parameters">
  ...
  <Function id="qiskit.pulse.instructions.Instruction.start_time" signature="property start_time">
  ...
  <Function id="qiskit.pulse.instructions.Instruction.stop_time" signature="property stop_time">
