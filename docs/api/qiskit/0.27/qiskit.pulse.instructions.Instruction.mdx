...
<Class id="qiskit.pulse.instructions.Instruction" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.17/qiskit/pulse/instructions/instruction.py" signature="Instruction(operands, duration=None, channels=None, name=None)" modifiers="class">
  ...
  *   [**PulseError**](qiskit.pulse.PulseError "qiskit.pulse.PulseError") – If the input `channels` are not all of type `Channel`.
  ...
  <Function id="qiskit.pulse.instructions.Instruction.__init__" signature="__init__(operands, duration=None, channels=None, name=None)">
    Instruction initializer.
  ...
  <Function id="qiskit.pulse.instructions.Instruction.channels" signature="channels" modifiers="abstract property">
  ...
  <Function id="qiskit.pulse.instructions.Instruction.duration" signature="duration" modifiers="property">
  ...
  <Function id="qiskit.pulse.instructions.Instruction.id" signature="id" modifiers="property">
  ...
  <Function id="qiskit.pulse.instructions.Instruction.instructions" signature="instructions" modifiers="property">
  ...
  <Function id="qiskit.pulse.instructions.Instruction.is_parameterized" signature="is_parameterized()">
  ...
  <Function id="qiskit.pulse.instructions.Instruction.name" signature="name" modifiers="property">
  ...
  <Function id="qiskit.pulse.instructions.Instruction.operands" signature="operands" modifiers="property">
  ...
  <Function id="qiskit.pulse.instructions.Instruction.parameters" signature="parameters" modifiers="property">
  ...
  <Function id="qiskit.pulse.instructions.Instruction.start_time" signature="start_time" modifiers="property">
  ...
  <Function id="qiskit.pulse.instructions.Instruction.stop_time" signature="stop_time" modifiers="property">
