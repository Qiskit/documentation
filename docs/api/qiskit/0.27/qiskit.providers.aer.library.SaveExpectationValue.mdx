...
<Class id="qiskit.providers.aer.library.SaveExpectationValue" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-aer/tree/stable/0.8/qiskit/providers/aer/library/save_instructions/save_expectation_value.py" signature="SaveExpectationValue(operator, label='expectation_value', unnormalized=False, pershot=False, conditional=False)">
  ...
  **ExtensionError** – if the input operator is invalid or not Hermitian.
  ...
  <Function id="qiskit.providers.aer.library.SaveExpectationValue.decompositions" signature="property decompositions">
    Get the decompositions of the instruction from the SessionEquivalenceLibrary.
  </Function>

  ### definition

  <Function id="qiskit.providers.aer.library.SaveExpectationValue.definition" signature="property definition">
    Return definition in terms of other basic gates.
  </Function>

  ### duration

  <Function id="qiskit.providers.aer.library.SaveExpectationValue.duration" signature="property duration">
    Get the duration.
  </Function>
  ...
  <Function id="qiskit.providers.aer.library.SaveExpectationValue.params" signature="property params">
  ...
  <Function id="qiskit.providers.aer.library.SaveExpectationValue.unit" signature="property unit">
