...
<Class id="qiskit.pulse.Play" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.17/qiskit/pulse/instructions/play.py" signature="Play(pulse, channel, name=None)" modifiers="class">
  ...
  **Raises**
  ...
  <Function id="qiskit.pulse.Play.is_parameterized" signature="is_parameterized()">
  ...
  <Function id="qiskit.pulse.Play.parameters" signature="parameters" modifiers="property">
