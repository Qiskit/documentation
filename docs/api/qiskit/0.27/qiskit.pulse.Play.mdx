...
<Class id="qiskit.pulse.Play" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.17/qiskit/pulse/instructions/play.py" signature="Play(pulse, channel, name=None)">
  ...
  **Raises**
  ...
  <Function id="qiskit.pulse.Play.is_parameterized" name="is_parameterized" signature="is_parameterized()">
  ...
  <Function id="qiskit.pulse.Play.parameters" name="parameters" signature="property parameters">
