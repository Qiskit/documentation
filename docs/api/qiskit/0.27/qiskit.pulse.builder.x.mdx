---
title: x (v0.27)
description: API reference for qiskit.pulse.builder.x in qiskit v0.27
...
<Function id="qiskit.pulse.builder.x" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.17/qiskit/pulse/builder.py" signature="x(qubit)">
