...
`ZZFeatureMap(feature_dimension, reps=2, entanglement='full', data_map_func=None, insert_barriers=False)` [GitHub](https://github.com/qiskit/qiskit/tree/stable/0.17/qiskit/circuit/library/data_preparation/zz_feature_map.py "view source code")
...
| [`ecr`](#qiskit.circuit.library.ZZFeatureMap.ecr "qiskit.circuit.library.ZZFeatureMap.ecr")(qubit1, qubit2)                                                                                       | Apply [`ECRGate`](qiskit.circuit.library.ECRGate "qiskit.circuit.library.ECRGate").                                                 |
...
| [`pauli`](#qiskit.circuit.library.ZZFeatureMap.pauli "qiskit.circuit.library.ZZFeatureMap.pauli")(pauli\_string, qubits)                                                                          | Apply `PauliGate`.                                                                                                                  |
...
| [`r`](#qiskit.circuit.library.ZZFeatureMap.r "qiskit.circuit.library.ZZFeatureMap.r")(theta, phi, qubit)                                                                                          | Apply [`RGate`](qiskit.circuit.library.RGate "qiskit.circuit.library.RGate").                                                       |
...
| [`rv`](#qiskit.circuit.library.ZZFeatureMap.rv "qiskit.circuit.library.ZZFeatureMap.rv")(vx, vy, vz, qubit)                                                                                       | Apply [`RVGate`](qiskit.circuit.library.RVGate "qiskit.circuit.library.RVGate").                                                    |
...
| [`save_expectation_value`](#qiskit.circuit.library.ZZFeatureMap.save_expectation_value "qiskit.circuit.library.ZZFeatureMap.save_expectation_value")(operator, qubits\[, …])                      | Save the expectation value of a Hermitian operator.                                                                                 |
...
<span id="qiskit.circuit.library.ZZFeatureMap.add_bits" />
...
![../\_images/qiskit.circuit.library.ZZFeatureMap\_0\_0.png](/images/api/qiskit/0.27/qiskit.circuit.library.ZZFeatureMap_0_0.png) ![../\_images/qiskit.circuit.library.ZZFeatureMap\_0\_1.png](/images/api/qiskit/0.27/qiskit.circuit.library.ZZFeatureMap_0_1.png)

### ecr

<span id="qiskit.circuit.library.ZZFeatureMap.ecr" />
...
<span id="qiskit.circuit.library.ZZFeatureMap.pauli" />
...
<span id="qiskit.circuit.library.ZZFeatureMap.rv" />
...
<span id="qiskit.circuit.library.ZZFeatureMap.save_amplitudes" />
...
<span id="qiskit.circuit.library.ZZFeatureMap.save_amplitudes_squared" />
...
<span id="qiskit.circuit.library.ZZFeatureMap.save_density_matrix" />
...
<span id="qiskit.circuit.library.ZZFeatureMap.save_expectation_value" />
...
<span id="qiskit.circuit.library.ZZFeatureMap.save_expectation_value_variance" />
...
<span id="qiskit.circuit.library.ZZFeatureMap.save_matrix_product_state" />
...
<span id="qiskit.circuit.library.ZZFeatureMap.save_probabilities" />
...
<span id="qiskit.circuit.library.ZZFeatureMap.save_probabilities_dict" />
...
<span id="qiskit.circuit.library.ZZFeatureMap.save_stabilizer" />
...
<span id="qiskit.circuit.library.ZZFeatureMap.save_state" />
...
<span id="qiskit.circuit.library.ZZFeatureMap.save_statevector" />
...
<span id="qiskit.circuit.library.ZZFeatureMap.save_statevector_dict" />
...
<span id="qiskit.circuit.library.ZZFeatureMap.save_superop" />
...
<span id="qiskit.circuit.library.ZZFeatureMap.save_unitary" />
...
<span id="qiskit.circuit.library.ZZFeatureMap.set_density_matrix" />
...
<span id="qiskit.circuit.library.ZZFeatureMap.set_matrix_product_state" />
...
<span id="qiskit.circuit.library.ZZFeatureMap.set_stabilizer" />
...
<span id="qiskit.circuit.library.ZZFeatureMap.set_statevector" />
...
<span id="qiskit.circuit.library.ZZFeatureMap.set_superop" />
...
<span id="qiskit.circuit.library.ZZFeatureMap.set_unitary" />
...
<span id="qiskit.circuit.library.ZZFeatureMap.tensor" />
