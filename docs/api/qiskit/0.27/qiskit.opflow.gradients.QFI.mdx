...
<Class id="qiskit.opflow.gradients.QFI" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.17/qiskit/opflow/gradients/qfi.py" signature="QFI(qfi_method='lin_comb_full')">
...
$$
  ...
  **ValueError** – if `qfi_method` is neither a `CircuitQFI` object nor one of the predefined strings.
  ...
  <Function id="qiskit.opflow.gradients.QFI.__init__" name="__init__" signature="__init__(qfi_method='lin_comb_full')">
    **Parameters**
  ...
  <Function id="qiskit.opflow.gradients.QFI.convert" name="convert" signature="convert(operator, params=None)">
    **Parameters**
  ...
  <Function id="qiskit.opflow.gradients.QFI.gradient_wrapper" name="gradient_wrapper" signature="gradient_wrapper(operator, bind_params, grad_params=None, backend=None)">
  ...
  <Function id="qiskit.opflow.gradients.QFI.parameter_expression_grad" name="parameter_expression_grad" signature="static parameter_expression_grad(param_expr, param)">
  ...
  <Function id="qiskit.opflow.gradients.QFI.qfi_method" name="qfi_method" signature="property qfi_method">
    Returns `CircuitQFI`.
