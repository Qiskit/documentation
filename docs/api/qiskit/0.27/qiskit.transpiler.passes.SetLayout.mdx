...
<Class id="qiskit.transpiler.passes.SetLayout" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.17/qiskit/transpiler/passes/layout/set_layout.py" signature="SetLayout(*args, **kwargs)">
  ...
  **layout** ([*Layout*](qiskit.transpiler.Layout "qiskit.transpiler.Layout")) – the layout to set.
  ...
  <Function id="qiskit.transpiler.passes.SetLayout.is_analysis_pass" signature="property is_analysis_pass">
  ...
  <Function id="qiskit.transpiler.passes.SetLayout.is_transformation_pass" signature="property is_transformation_pass">
