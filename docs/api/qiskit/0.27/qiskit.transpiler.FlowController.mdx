...
<Class id="qiskit.transpiler.FlowController" github="https://github.com/qiskit/qiskit/tree/stable/0.17/qiskit/transpiler/runningpassmanager.py" signature="FlowController(passes, options, **partial_controller)">
