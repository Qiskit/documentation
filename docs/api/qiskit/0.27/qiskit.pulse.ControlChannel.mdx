...
<Class id="qiskit.pulse.ControlChannel" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.17/qiskit/pulse/channels.py" signature="ControlChannel(index)">
  ...
  **index** (`int`) – Index of channel.
  ...
  <Function id="qiskit.pulse.ControlChannel.__init__" name="__init__" signature="__init__(index)">
    Channel class.
  ...
  <Function id="qiskit.pulse.ControlChannel.assign" name="assign" signature="assign(parameter, value)">
  ...
  <Function id="qiskit.pulse.ControlChannel.index" name="index" signature="property index">
  ...
  <Function id="qiskit.pulse.ControlChannel.is_parameterized" name="is_parameterized" signature="is_parameterized()">
  ...
  <Function id="qiskit.pulse.ControlChannel.name" name="name" signature="property name">
  ...
  <Function id="qiskit.pulse.ControlChannel.parameters" name="parameters" signature="property parameters">
