...
<Class id="qiskit.pulse.ControlChannel" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.17/qiskit/pulse/channels.py" signature="ControlChannel(index)">
  ...
  **index** (`int`) – Index of channel.
  ...
  <Function id="qiskit.pulse.ControlChannel.index" signature="property index">
  ...
  <Function id="qiskit.pulse.ControlChannel.name" signature="property name">
  ...
  <Function id="qiskit.pulse.ControlChannel.parameters" signature="property parameters">
