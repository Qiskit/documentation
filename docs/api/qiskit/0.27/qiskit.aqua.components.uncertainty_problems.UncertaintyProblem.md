# qiskit.aqua.components.uncertainty\_problems.UncertaintyProblem[¶](#qiskit-aqua-components-uncertainty-problems-uncertaintyproblem "Permalink to this headline")
