...
`ComposedOp(oplist, coeff=1.0, abelian=False)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.17/qiskit/opflow/list_ops/composed_op.py "view source code")
...
<span id="qiskit.opflow.list_ops.ComposedOp.__init__" />
...
| [`mul`](#qiskit.opflow.list_ops.ComposedOp.mul "qiskit.opflow.list_ops.ComposedOp.mul")(scalar)                                                       | Returns the scalar multiplication of the Operator, overloaded by `*`, including support for Terra’s `Parameters`, which can be bound to values later (via `bind_parameters`). |
...
<span id="qiskit.opflow.list_ops.ComposedOp.add" />
...
<span id="qiskit.opflow.list_ops.ComposedOp.assign_parameters" />
...
<span id="qiskit.opflow.list_ops.ComposedOp.bind_parameters" />
...
<span id="qiskit.opflow.list_ops.ComposedOp.copy" />
...
<span id="qiskit.opflow.list_ops.ComposedOp.equals" />
...
<span id="qiskit.opflow.list_ops.ComposedOp.exp_i" />
...
<span id="qiskit.opflow.list_ops.ComposedOp.log_i" />
...
<span id="qiskit.opflow.list_ops.ComposedOp.mul" />
...
<span id="qiskit.opflow.list_ops.ComposedOp.neg" />
...
<span id="qiskit.opflow.list_ops.ComposedOp.permute" />
...
<span id="qiskit.opflow.list_ops.ComposedOp.power" />
...
<span id="qiskit.opflow.list_ops.ComposedOp.primitive_strings" />
...
<span id="qiskit.opflow.list_ops.ComposedOp.tensor" />
...
<span id="qiskit.opflow.list_ops.ComposedOp.tensorpower" />
...
<span id="qiskit.opflow.list_ops.ComposedOp.to_circuit_op" />
...
<span id="qiskit.opflow.list_ops.ComposedOp.to_matrix_op" />
...
<span id="qiskit.opflow.list_ops.ComposedOp.to_pauli_op" />
...
<span id="qiskit.opflow.list_ops.ComposedOp.to_spmatrix" />
...
<span id="qiskit.opflow.list_ops.ComposedOp.traverse" />
