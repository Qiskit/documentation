...
<Class id="qiskit.optimization.problems.QuadraticConstraint" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/optimization/problems/quadratic_constraint.py" signature="QuadraticConstraint(quadratic_program, name, linear, quadratic, sense, rhs)">
  ...
  *   **rhs** (`float`) – The right-hand-side of the constraint.
  ...
  <Function id="qiskit.optimization.problems.QuadraticConstraint.__init__" name="__init__" signature="__init__(quadratic_program, name, linear, quadratic, sense, rhs)">
    Constructs a quadratic constraint, consisting of a linear and a quadratic term.
  ...
  <Attribute id="qiskit.optimization.problems.QuadraticConstraint.Sense" name="Sense">
    alias of `qiskit.optimization.problems.constraint.ConstraintSense`
  </Attribute>

  ### evaluate

  <Function id="qiskit.optimization.problems.QuadraticConstraint.evaluate" name="evaluate" signature="evaluate(x)">
  ...
  <Function id="qiskit.optimization.problems.QuadraticConstraint.linear" name="linear" signature="property linear">
  ...
  <Function id="qiskit.optimization.problems.QuadraticConstraint.name" name="name" signature="property name">
  ...
  <Function id="qiskit.optimization.problems.QuadraticConstraint.quadratic" name="quadratic" signature="property quadratic">
  ...
  <Function id="qiskit.optimization.problems.QuadraticConstraint.quadratic_program" name="quadratic_program" signature="property quadratic_program">
  ...
  <Function id="qiskit.optimization.problems.QuadraticConstraint.rhs" name="rhs" signature="property rhs">
  ...
  <Function id="qiskit.optimization.problems.QuadraticConstraint.sense" name="sense" signature="property sense">
