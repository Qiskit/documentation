...
<Class id="qiskit.aqua.circuits.ESOP" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/aqua/circuits/boolean_logical_circuits.py" signature="ESOP(ast, num_vars=None)">
  ...
  **Raises**
  ...
  <Function id="qiskit.aqua.circuits.ESOP.__init__" name="__init__" signature="__init__(ast, num_vars=None)">
    Constructor.
  ...
  <Function id="qiskit.aqua.circuits.ESOP.ancillary_register" name="ancillary_register" signature="property ancillary_register">
    returns ancillary register
  </Function>

  ### clause\_register

  <Function id="qiskit.aqua.circuits.ESOP.clause_register" name="clause_register" signature="property clause_register">
    returns clause register
  </Function>

  ### compute\_num\_ancillae

  <Function id="qiskit.aqua.circuits.ESOP.compute_num_ancillae" name="compute_num_ancillae" signature="compute_num_ancillae(mct_mode='basic')">
    returns the number of ancillary qubits needed
  </Function>

  ### construct\_circuit

  <Function id="qiskit.aqua.circuits.ESOP.construct_circuit" name="construct_circuit" signature="construct_circuit(circuit=None, variable_register=None, output_register=None, output_idx=None, ancillary_register=None, mct_mode='basic')">
    Construct circuit.
  ...
  <Function id="qiskit.aqua.circuits.ESOP.num_clauses" name="num_clauses" signature="property num_clauses">
    returns num clauses
  </Function>

  ### num\_variables

  <Function id="qiskit.aqua.circuits.ESOP.num_variables" name="num_variables" signature="property num_variables">
    return num variables
  </Function>

  ### output\_register

  <Function id="qiskit.aqua.circuits.ESOP.output_register" name="output_register" signature="property output_register">
    returns output register
  </Function>

  ### variable\_register

  <Function id="qiskit.aqua.circuits.ESOP.variable_register" name="variable_register" signature="property variable_register">
