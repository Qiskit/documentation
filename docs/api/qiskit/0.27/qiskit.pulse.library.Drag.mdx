...
<Class id="qiskit.pulse.library.Drag" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.17/qiskit/pulse/library/parametric_pulses.py" signature="Drag(duration, amp, sigma, beta, name=None)" modifiers="class">
...
$$
  ...
  *   **name** (`Optional`\[`str`]) – Display name for this pulse envelope.
  ...
  <Function id="qiskit.pulse.library.Drag.amp" signature="amp" modifiers="property">
  ...
  <Function id="qiskit.pulse.library.Drag.beta" signature="beta" modifiers="property">
  ...
  <Function id="qiskit.pulse.library.Drag.id" signature="id" modifiers="property">
  ...
  <Function id="qiskit.pulse.library.Drag.parameters" signature="parameters" modifiers="property">
  ...
  <Function id="qiskit.pulse.library.Drag.sigma" signature="sigma" modifiers="property">
