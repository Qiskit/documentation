...
<Class id="qiskit.quantum_info.ScalarOp" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.17/qiskit/quantum_info/operators/scalar_op.py" signature="ScalarOp(dims=None, coeff=1)">
  ...
  **QiskitError** – If the optional coefficient is invalid.
  ...
  <Function id="qiskit.quantum_info.ScalarOp.atol" signature="property atol">
    Default absolute tolerance parameter for float comparisons.
  </Function>

  ### coeff

  <Function id="qiskit.quantum_info.ScalarOp.coeff" signature="property coeff">
  ...
  <Function id="qiskit.quantum_info.ScalarOp.dim" signature="property dim">
  ...
  <Function id="qiskit.quantum_info.ScalarOp.num_qubits" signature="property num_qubits">
  ...
  <Function id="qiskit.quantum_info.ScalarOp.qargs" signature="property qargs">
  ...
  <Function id="qiskit.quantum_info.ScalarOp.rtol" signature="property rtol">
