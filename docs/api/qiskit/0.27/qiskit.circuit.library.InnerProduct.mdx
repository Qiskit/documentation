...
<Class id="qiskit.circuit.library.InnerProduct" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.17/qiskit/circuit/library/boolean_logic/inner_product.py" signature="InnerProduct(num_qubits)">
  ...
  **Reference Circuit:**
  ...
  <Function id="qiskit.circuit.library.InnerProduct.ccx" name="ccx" signature="ccx(control_qubit1, control_qubit2, target_qubit)">
  ...
  <Function id="qiskit.circuit.library.InnerProduct.compose" name="compose" signature="compose(other, qubits=None, clbits=None, front=False, inplace=False)">
  ...
  <Function id="qiskit.circuit.library.InnerProduct.iso" name="iso" signature="iso(isometry, q_input, q_ancillas_for_output, q_ancillas_zero=None, q_ancillas_dirty=None)">
  ...
  <Function id="qiskit.circuit.library.InnerProduct.isometry" name="isometry" signature="isometry(isometry, q_input, q_ancillas_for_output, q_ancillas_zero=None, q_ancillas_dirty=None)">
    Attach an arbitrary isometry from m to n qubits to a circuit. In particular, this allows to attach arbitrary unitaries on n qubits (m=n) or to prepare any state on n qubits (m=0). The decomposition used here was introduced by Iten et al. in [https://arxiv.org/abs/1501.06911](https://arxiv.org/abs/1501.06911).
  ...
  <Function id="qiskit.circuit.library.InnerProduct.qasm" name="qasm" signature="qasm(formatted=False, filename=None)">
  ...
  <Function id="qiskit.circuit.library.InnerProduct.to_instruction" name="to_instruction" signature="to_instruction(parameter_map=None)">
