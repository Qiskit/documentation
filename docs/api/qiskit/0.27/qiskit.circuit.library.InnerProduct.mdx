...
<Class id="qiskit.circuit.library.InnerProduct" github="https://github.com/qiskit/qiskit/tree/stable/0.17/qiskit/circuit/library/boolean_logic/inner_product.py" signature="InnerProduct(num_qubits)">
