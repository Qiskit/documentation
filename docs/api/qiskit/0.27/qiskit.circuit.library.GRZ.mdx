...
<Class id="qiskit.circuit.library.GRZ" github="https://github.com/qiskit/qiskit/tree/stable/0.17/qiskit/circuit/library/generalized_gates/gr.py" signature="GRZ(num_qubits, phi)">
  Global RZ gate.
