...
<Class id="qiskit.circuit.library.Barrier" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.17/qiskit/circuit/barrier.py" signature="Barrier(num_qubits)" modifiers="class">
  Barrier instruction.
  ...
  <Function id="qiskit.circuit.library.Barrier.decompositions" signature="decompositions" modifiers="property">
    Get the decompositions of the instruction from the SessionEquivalenceLibrary.
  </Function>

  ### definition

  <Function id="qiskit.circuit.library.Barrier.definition" signature="definition" modifiers="property">
    Return definition in terms of other basic gates.
  </Function>

  ### duration

  <Function id="qiskit.circuit.library.Barrier.duration" signature="duration" modifiers="property">
    Get the duration.
  </Function>
  ...
  <Function id="qiskit.circuit.library.Barrier.params" signature="params" modifiers="property">
  ...
  <Function id="qiskit.circuit.library.Barrier.unit" signature="unit" modifiers="property">
