...
<Class id="qiskit.pulse.library.Waveform" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.17/qiskit/pulse/library/waveform.py" signature="Waveform(samples, name=None, epsilon=1e-07)" modifiers="class">
  ...
  *   **epsilon** (`float`) – Pulse sample norm tolerance for clipping. If any sample’s norm exceeds unity by less than or equal to epsilon it will be clipped to unit norm. If the sample norm is greater than 1+epsilon an error will be raised.
  ...
  <Function id="qiskit.pulse.library.Waveform.id" signature="id" modifiers="property">
  ...
  <Function id="qiskit.pulse.library.Waveform.parameters" signature="parameters" modifiers="property">
  ...
  <Function id="qiskit.pulse.library.Waveform.samples" signature="samples" modifiers="property">
