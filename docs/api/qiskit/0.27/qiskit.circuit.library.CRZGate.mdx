---
title: CRZGate (v0.27)
description: API reference for qiskit.circuit.library.CRZGate in qiskit v0.27
...
<Class id="qiskit.circuit.library.CRZGate" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.17/qiskit/circuit/library/standard_gates/rz.py" signature="CRZGate(theta, label=None, ctrl_state=None)" modifiers="class">
  Controlled-RZ gate.
...
$$
  ...
  <Function id="qiskit.circuit.library.CRZGate.__init__" signature="__init__(theta, label=None, ctrl_state=None)">
    Create new CRZ gate.
  </Function>
  ...
  <Function id="qiskit.circuit.library.CRZGate.add_decomposition" signature="add_decomposition(decomposition)">
    Add a decomposition of the instruction to the SessionEquivalenceLibrary.
  </Function>

  ### assemble

  <Function id="qiskit.circuit.library.CRZGate.assemble" signature="assemble()">
  ...
  <Function id="qiskit.circuit.library.CRZGate.broadcast_arguments" signature="broadcast_arguments(qargs, cargs)">
  ...
  <Function id="qiskit.circuit.library.CRZGate.c_if" signature="c_if(classical, val)">
    Add classical condition on register classical and value val.
  </Function>

  ### control

  <Function id="qiskit.circuit.library.CRZGate.control" signature="control(num_ctrl_qubits=1, label=None, ctrl_state=None)">
  ...
  <Function id="qiskit.circuit.library.CRZGate.copy" signature="copy(name=None)">
  ...
  <Function id="qiskit.circuit.library.CRZGate.inverse" signature="inverse()">
    Return inverse CRZ gate (i.e. with the negative rotation angle).
  </Function>

  ### is\_parameterized

  <Function id="qiskit.circuit.library.CRZGate.is_parameterized" signature="is_parameterized()">
  ...
  <Function id="qiskit.circuit.library.CRZGate.mirror" signature="mirror()">
  ...
  <Function id="qiskit.circuit.library.CRZGate.power" signature="power(exponent)">
  ...
  <Function id="qiskit.circuit.library.CRZGate.qasm" signature="qasm()">
  ...
  <Function id="qiskit.circuit.library.CRZGate.repeat" signature="repeat(n)">
  ...
  <Function id="qiskit.circuit.library.CRZGate.reverse_ops" signature="reverse_ops()">
  ...
  <Function id="qiskit.circuit.library.CRZGate.soft_compare" signature="soft_compare(other)">
  ...
  <Function id="qiskit.circuit.library.CRZGate.to_matrix" signature="to_matrix()">
  ...
  <Function id="qiskit.circuit.library.CRZGate.validate_parameter" signature="validate_parameter(parameter)">
