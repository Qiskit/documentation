...
$$
  ...
  **\[1]: Boyer et al., Tight bounds on quantum searching**
  ...
  <Function id="qiskit.algorithms.Grover.optimal_num_iterations" signature="static optimal_num_iterations(num_solutions, num_qubits)">
  ...
  <Function id="qiskit.algorithms.Grover.quantum_instance" signature="property quantum_instance">
