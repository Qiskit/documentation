...
<Class id="qiskit.algorithms.Grover" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.17/qiskit/algorithms/amplitude_amplifiers/grover.py" signature="Grover(iterations=None, growth_rate=None, sample_from_iterations=False, quantum_instance=None)">
...
$$
  ...
  *   **quantum\_instance** (`Union`\[`QuantumInstance`, `BaseBackend`, `Backend`, `None`]) – A Quantum Instance or Backend to run the circuits.
  ...
  **\[1]: Boyer et al., Tight bounds on quantum searching**
  ...
  <Function id="qiskit.algorithms.Grover.__init__" name="__init__" signature="__init__(iterations=None, growth_rate=None, sample_from_iterations=False, quantum_instance=None)">
    **Parameters**
  ...
  <Function id="qiskit.algorithms.Grover.amplify" name="amplify" signature="amplify(amplification_problem)">
  ...
  <Function id="qiskit.algorithms.Grover.construct_circuit" name="construct_circuit" signature="construct_circuit(problem, power=None, measurement=False)">
  ...
  <Function id="qiskit.algorithms.Grover.optimal_num_iterations" name="optimal_num_iterations" signature="static optimal_num_iterations(num_solutions, num_qubits)">
  ...
  <Function id="qiskit.algorithms.Grover.quantum_instance" name="quantum_instance" signature="property quantum_instance">
