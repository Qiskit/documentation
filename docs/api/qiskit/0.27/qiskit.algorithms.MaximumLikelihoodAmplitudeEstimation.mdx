...
<Class id="qiskit.algorithms.MaximumLikelihoodAmplitudeEstimation" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.17/qiskit/algorithms/amplitude_estimators/mlae.py" signature="MaximumLikelihoodAmplitudeEstimation(evaluation_schedule, minimizer=None, quantum_instance=None)">
  ...
  **ValueError** – If the number of oracle circuits is smaller than 1.
  ...
  <Function id="qiskit.algorithms.MaximumLikelihoodAmplitudeEstimation.compute_confidence_interval" signature="static compute_confidence_interval(result, alpha, kind='fisher', apply_post_processing=False)">
  ...
  <Function id="qiskit.algorithms.MaximumLikelihoodAmplitudeEstimation.quantum_instance" signature="property quantum_instance">
