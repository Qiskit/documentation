...
<Class id="qiskit.aqua.operators.evolutions.Trotter" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/aqua/operators/evolutions/trotterizations/trotter.py" signature="Trotter(reps=1)">
  ...
  **reps** (`int`) – The number of times to repeat the Trotterization circuit.
  ...
  <Function id="qiskit.aqua.operators.evolutions.Trotter.__init__" name="__init__" signature="__init__(reps=1)">
    **Parameters**
  ...
  <Function id="qiskit.aqua.operators.evolutions.Trotter.convert" name="convert" signature="convert(operator)">
  ...
  <Function id="qiskit.aqua.operators.evolutions.Trotter.order" name="order" signature="property order">
    returns order
  ...
  <Function id="qiskit.aqua.operators.evolutions.Trotter.reps" name="reps" signature="property reps">
