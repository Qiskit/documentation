...
`GR(num_qubits, theta, phi)` [GitHub](https://github.com/qiskit/qiskit/tree/stable/0.17/qiskit/circuit/library/generalized_gates/gr.py "view source code")
...
![../\_images/qiskit.circuit.library.GR\_0\_1.png](/images/api/qiskit/0.27/qiskit.circuit.library.GR_0_1.png)
...
<span id="qiskit.circuit.library.GR.__init__" />

`__init__(num_qubits, theta, phi)`
...
|                                                                                                                                                                               |                                                                                                                                     |
| ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------- |
| [`__init__`](#qiskit.circuit.library.GR.__init__ "qiskit.circuit.library.GR.__init__")(num\_qubits, theta, phi)                                                               | Create a new Global R (GR) gate.                                                                                                    |
| [`add_bits`](#qiskit.circuit.library.GR.add_bits "qiskit.circuit.library.GR.add_bits")(bits)                                                                                  | Add Bits to the circuit.                                                                                                            |
| [`add_calibration`](#qiskit.circuit.library.GR.add_calibration "qiskit.circuit.library.GR.add_calibration")(gate, qubits, schedule\[, params])                                | Register a low-level, custom pulse definition for the given gate.                                                                   |
| [`add_register`](#qiskit.circuit.library.GR.add_register "qiskit.circuit.library.GR.add_register")(\*regs)                                                                    | Add registers.                                                                                                                      |
| [`append`](#qiskit.circuit.library.GR.append "qiskit.circuit.library.GR.append")(instruction\[, qargs, cargs])                                                                | Append one or more instructions to the end of the circuit, modifying the circuit in place.                                          |
| [`assign_parameters`](#qiskit.circuit.library.GR.assign_parameters "qiskit.circuit.library.GR.assign_parameters")(parameters\[, inplace, …])                                  | Assign parameters to new parameters or values.                                                                                      |
| [`barrier`](#qiskit.circuit.library.GR.barrier "qiskit.circuit.library.GR.barrier")(\*qargs)                                                                                  | Apply `Barrier`.                                                                                                                    |
| [`bind_parameters`](#qiskit.circuit.library.GR.bind_parameters "qiskit.circuit.library.GR.bind_parameters")(values\[, value\_dict])                                           | Assign numeric parameters to values yielding a new circuit.                                                                         |
| [`cast`](#qiskit.circuit.library.GR.cast "qiskit.circuit.library.GR.cast")(value, \_type)                                                                                     | Best effort to cast value to type.                                                                                                  |
| [`cbit_argument_conversion`](#qiskit.circuit.library.GR.cbit_argument_conversion "qiskit.circuit.library.GR.cbit_argument_conversion")(clbit\_representation)                 | Converts several classical bit representations (such as indexes, range, etc.) into a list of classical bits.                        |
| [`ccx`](#qiskit.circuit.library.GR.ccx "qiskit.circuit.library.GR.ccx")(control\_qubit1, control\_qubit2, target\_qubit)                                                      | Apply [`CCXGate`](qiskit.circuit.library.CCXGate "qiskit.circuit.library.CCXGate").                                                 |
| [`ch`](#qiskit.circuit.library.GR.ch "qiskit.circuit.library.GR.ch")(control\_qubit, target\_qubit\[, label, …])                                                              | Apply [`CHGate`](qiskit.circuit.library.CHGate "qiskit.circuit.library.CHGate").                                                    |
| [`cls_instances`](#qiskit.circuit.library.GR.cls_instances "qiskit.circuit.library.GR.cls_instances")()                                                                       | Return the current number of instances of this class, useful for auto naming.                                                       |
| [`cls_prefix`](#qiskit.circuit.library.GR.cls_prefix "qiskit.circuit.library.GR.cls_prefix")()                                                                                | Return the prefix to use for auto naming.                                                                                           |
| [`cnot`](#qiskit.circuit.library.GR.cnot "qiskit.circuit.library.GR.cnot")(control\_qubit, target\_qubit\[, label, …])                                                        | Apply [`CXGate`](qiskit.circuit.library.CXGate "qiskit.circuit.library.CXGate").                                                    |
| [`combine`](#qiskit.circuit.library.GR.combine "qiskit.circuit.library.GR.combine")(rhs)                                                                                      | DEPRECATED - Returns rhs appended to self if self contains compatible registers.                                                    |
| [`compose`](#qiskit.circuit.library.GR.compose "qiskit.circuit.library.GR.compose")(other\[, qubits, clbits, front, inplace])                                                 | Compose circuit with `other` circuit or instruction, optionally permuting wires.                                                    |
| [`control`](#qiskit.circuit.library.GR.control "qiskit.circuit.library.GR.control")(\[num\_ctrl\_qubits, label, ctrl\_state])                                                 | Control this circuit on `num_ctrl_qubits` qubits.                                                                                   |
| [`copy`](#qiskit.circuit.library.GR.copy "qiskit.circuit.library.GR.copy")(\[name])                                                                                           | Copy the circuit.                                                                                                                   |
| [`count_ops`](#qiskit.circuit.library.GR.count_ops "qiskit.circuit.library.GR.count_ops")()                                                                                   | Count each operation kind in the circuit.                                                                                           |
| [`cp`](#qiskit.circuit.library.GR.cp "qiskit.circuit.library.GR.cp")(theta, control\_qubit, target\_qubit\[, …])                                                              | Apply [`CPhaseGate`](qiskit.circuit.library.CPhaseGate "qiskit.circuit.library.CPhaseGate").                                        |
| [`crx`](#qiskit.circuit.library.GR.crx "qiskit.circuit.library.GR.crx")(theta, control\_qubit, target\_qubit\[, …])                                                           | Apply [`CRXGate`](qiskit.circuit.library.CRXGate "qiskit.circuit.library.CRXGate").                                                 |
| [`cry`](#qiskit.circuit.library.GR.cry "qiskit.circuit.library.GR.cry")(theta, control\_qubit, target\_qubit\[, …])                                                           | Apply [`CRYGate`](qiskit.circuit.library.CRYGate "qiskit.circuit.library.CRYGate").                                                 |
| [`crz`](#qiskit.circuit.library.GR.crz "qiskit.circuit.library.GR.crz")(theta, control\_qubit, target\_qubit\[, …])                                                           | Apply [`CRZGate`](qiskit.circuit.library.CRZGate "qiskit.circuit.library.CRZGate").                                                 |
| [`cswap`](#qiskit.circuit.library.GR.cswap "qiskit.circuit.library.GR.cswap")(control\_qubit, target\_qubit1, …\[, …])                                                        | Apply [`CSwapGate`](qiskit.circuit.library.CSwapGate "qiskit.circuit.library.CSwapGate").                                           |
| [`csx`](#qiskit.circuit.library.GR.csx "qiskit.circuit.library.GR.csx")(control\_qubit, target\_qubit\[, label, …])                                                           | Apply [`CSXGate`](qiskit.circuit.library.CSXGate "qiskit.circuit.library.CSXGate").                                                 |
| [`cu`](#qiskit.circuit.library.GR.cu "qiskit.circuit.library.GR.cu")(theta, phi, lam, gamma, control\_qubit, …)                                                               | Apply [`CUGate`](qiskit.circuit.library.CUGate "qiskit.circuit.library.CUGate").                                                    |
| [`cu1`](#qiskit.circuit.library.GR.cu1 "qiskit.circuit.library.GR.cu1")(theta, control\_qubit, target\_qubit\[, …])                                                           | Apply [`CU1Gate`](qiskit.circuit.library.CU1Gate "qiskit.circuit.library.CU1Gate").                                                 |
| [`cu3`](#qiskit.circuit.library.GR.cu3 "qiskit.circuit.library.GR.cu3")(theta, phi, lam, control\_qubit, target\_qubit)                                                       | Apply [`CU3Gate`](qiskit.circuit.library.CU3Gate "qiskit.circuit.library.CU3Gate").                                                 |
| [`cx`](#qiskit.circuit.library.GR.cx "qiskit.circuit.library.GR.cx")(control\_qubit, target\_qubit\[, label, …])                                                              | Apply [`CXGate`](qiskit.circuit.library.CXGate "qiskit.circuit.library.CXGate").                                                    |
| [`cy`](#qiskit.circuit.library.GR.cy "qiskit.circuit.library.GR.cy")(control\_qubit, target\_qubit\[, label, …])                                                              | Apply [`CYGate`](qiskit.circuit.library.CYGate "qiskit.circuit.library.CYGate").                                                    |
| [`cz`](#qiskit.circuit.library.GR.cz "qiskit.circuit.library.GR.cz")(control\_qubit, target\_qubit\[, label, …])                                                              | Apply [`CZGate`](qiskit.circuit.library.CZGate "qiskit.circuit.library.CZGate").                                                    |
| [`dcx`](#qiskit.circuit.library.GR.dcx "qiskit.circuit.library.GR.dcx")(qubit1, qubit2)                                                                                       | Apply [`DCXGate`](qiskit.circuit.library.DCXGate "qiskit.circuit.library.DCXGate").                                                 |
| [`decompose`](#qiskit.circuit.library.GR.decompose "qiskit.circuit.library.GR.decompose")()                                                                                   | Call a decomposition pass on this circuit, to decompose one level (shallow decompose).                                              |
| [`delay`](#qiskit.circuit.library.GR.delay "qiskit.circuit.library.GR.delay")(duration\[, qarg, unit])                                                                        | Apply [`Delay`](qiskit.circuit.Delay "qiskit.circuit.Delay").                                                                       |
| [`depth`](#qiskit.circuit.library.GR.depth "qiskit.circuit.library.GR.depth")()                                                                                               | Return circuit depth (i.e., length of critical path).                                                                               |
| [`diagonal`](#qiskit.circuit.library.GR.diagonal "qiskit.circuit.library.GR.diagonal")(diag, qubit)                                                                           | Attach a diagonal gate to a circuit.                                                                                                |
| [`draw`](#qiskit.circuit.library.GR.draw "qiskit.circuit.library.GR.draw")(\[output, scale, filename, style, …])                                                              | Draw the quantum circuit.                                                                                                           |
| [`ecr`](#qiskit.circuit.library.GR.ecr "qiskit.circuit.library.GR.ecr")(qubit1, qubit2)                                                                                       | Apply [`ECRGate`](qiskit.circuit.library.ECRGate "qiskit.circuit.library.ECRGate").                                                 |
| [`extend`](#qiskit.circuit.library.GR.extend "qiskit.circuit.library.GR.extend")(rhs)                                                                                         | DEPRECATED - Append QuantumCircuit to the RHS if it contains compatible registers.                                                  |
| [`fredkin`](#qiskit.circuit.library.GR.fredkin "qiskit.circuit.library.GR.fredkin")(control\_qubit, target\_qubit1, …)                                                        | Apply [`CSwapGate`](qiskit.circuit.library.CSwapGate "qiskit.circuit.library.CSwapGate").                                           |
| [`from_qasm_file`](#qiskit.circuit.library.GR.from_qasm_file "qiskit.circuit.library.GR.from_qasm_file")(path)                                                                | Take in a QASM file and generate a QuantumCircuit object.                                                                           |
| [`from_qasm_str`](#qiskit.circuit.library.GR.from_qasm_str "qiskit.circuit.library.GR.from_qasm_str")(qasm\_str)                                                              | Take in a QASM string and generate a QuantumCircuit object.                                                                         |
| [`h`](#qiskit.circuit.library.GR.h "qiskit.circuit.library.GR.h")(qubit)                                                                                                      | Apply [`HGate`](qiskit.circuit.library.HGate "qiskit.circuit.library.HGate").                                                       |
| [`hamiltonian`](#qiskit.circuit.library.GR.hamiltonian "qiskit.circuit.library.GR.hamiltonian")(operator, time, qubits\[, label])                                             | Apply hamiltonian evolution to qubits.                                                                                              |
| [`has_register`](#qiskit.circuit.library.GR.has_register "qiskit.circuit.library.GR.has_register")(register)                                                                  | Test if this circuit has the register r.                                                                                            |
| [`i`](#qiskit.circuit.library.GR.i "qiskit.circuit.library.GR.i")(qubit)                                                                                                      | Apply [`IGate`](qiskit.circuit.library.IGate "qiskit.circuit.library.IGate").                                                       |
| [`id`](#qiskit.circuit.library.GR.id "qiskit.circuit.library.GR.id")(qubit)                                                                                                   | Apply [`IGate`](qiskit.circuit.library.IGate "qiskit.circuit.library.IGate").                                                       |
| [`initialize`](#qiskit.circuit.library.GR.initialize "qiskit.circuit.library.GR.initialize")(params\[, qubits])                                                               | Initialize qubits in a specific state.                                                                                              |
| [`inverse`](#qiskit.circuit.library.GR.inverse "qiskit.circuit.library.GR.inverse")()                                                                                         | Invert (take adjoint of) this circuit.                                                                                              |
| [`iso`](#qiskit.circuit.library.GR.iso "qiskit.circuit.library.GR.iso")(isometry, q\_input, q\_ancillas\_for\_output)                                                         | Attach an arbitrary isometry from m to n qubits to a circuit.                                                                       |
| [`isometry`](#qiskit.circuit.library.GR.isometry "qiskit.circuit.library.GR.isometry")(isometry, q\_input, …\[, …])                                                           | Attach an arbitrary isometry from m to n qubits to a circuit.                                                                       |
| [`iswap`](#qiskit.circuit.library.GR.iswap "qiskit.circuit.library.GR.iswap")(qubit1, qubit2)                                                                                 | Apply [`iSwapGate`](qiskit.circuit.library.iSwapGate "qiskit.circuit.library.iSwapGate").                                           |
| [`mcp`](#qiskit.circuit.library.GR.mcp "qiskit.circuit.library.GR.mcp")(lam, control\_qubits, target\_qubit)                                                                  | Apply [`MCPhaseGate`](qiskit.circuit.library.MCPhaseGate "qiskit.circuit.library.MCPhaseGate").                                     |
| [`mcrx`](#qiskit.circuit.library.GR.mcrx "qiskit.circuit.library.GR.mcrx")(theta, q\_controls, q\_target\[, …])                                                               | Apply Multiple-Controlled X rotation gate                                                                                           |
| [`mcry`](#qiskit.circuit.library.GR.mcry "qiskit.circuit.library.GR.mcry")(theta, q\_controls, q\_target\[, …])                                                               | Apply Multiple-Controlled Y rotation gate                                                                                           |
| [`mcrz`](#qiskit.circuit.library.GR.mcrz "qiskit.circuit.library.GR.mcrz")(lam, q\_controls, q\_target\[, …])                                                                 | Apply Multiple-Controlled Z rotation gate                                                                                           |
| [`mct`](#qiskit.circuit.library.GR.mct "qiskit.circuit.library.GR.mct")(control\_qubits, target\_qubit\[, …])                                                                 | Apply [`MCXGate`](qiskit.circuit.library.MCXGate "qiskit.circuit.library.MCXGate").                                                 |
| [`mcu1`](#qiskit.circuit.library.GR.mcu1 "qiskit.circuit.library.GR.mcu1")(lam, control\_qubits, target\_qubit)                                                               | Apply `MCU1Gate`.                                                                                                                   |
| [`mcx`](#qiskit.circuit.library.GR.mcx "qiskit.circuit.library.GR.mcx")(control\_qubits, target\_qubit\[, …])                                                                 | Apply [`MCXGate`](qiskit.circuit.library.MCXGate "qiskit.circuit.library.MCXGate").                                                 |
| [`measure`](#qiskit.circuit.library.GR.measure "qiskit.circuit.library.GR.measure")(qubit, cbit)                                                                              | Measure quantum bit into classical bit (tuples).                                                                                    |
| [`measure_active`](#qiskit.circuit.library.GR.measure_active "qiskit.circuit.library.GR.measure_active")(\[inplace])                                                          | Adds measurement to all non-idle qubits.                                                                                            |
| [`measure_all`](#qiskit.circuit.library.GR.measure_all "qiskit.circuit.library.GR.measure_all")(\[inplace])                                                                   | Adds measurement to all qubits.                                                                                                     |
| [`ms`](#qiskit.circuit.library.GR.ms "qiskit.circuit.library.GR.ms")(theta, qubits)                                                                                           | Apply [`MSGate`](qiskit.circuit.library.MSGate "qiskit.circuit.library.MSGate").                                                    |
| [`num_connected_components`](#qiskit.circuit.library.GR.num_connected_components "qiskit.circuit.library.GR.num_connected_components")(\[unitary\_only])                      | How many non-entangled subcircuits can the circuit be factored to.                                                                  |
| [`num_nonlocal_gates`](#qiskit.circuit.library.GR.num_nonlocal_gates "qiskit.circuit.library.GR.num_nonlocal_gates")()                                                        | Return number of non-local gates (i.e.                                                                                              |
| [`num_tensor_factors`](#qiskit.circuit.library.GR.num_tensor_factors "qiskit.circuit.library.GR.num_tensor_factors")()                                                        | Computes the number of tensor factors in the unitary (quantum) part of the circuit only.                                            |
| [`num_unitary_factors`](#qiskit.circuit.library.GR.num_unitary_factors "qiskit.circuit.library.GR.num_unitary_factors")()                                                     | Computes the number of tensor factors in the unitary (quantum) part of the circuit only.                                            |
| [`p`](#qiskit.circuit.library.GR.p "qiskit.circuit.library.GR.p")(theta, qubit)                                                                                               | Apply [`PhaseGate`](qiskit.circuit.library.PhaseGate "qiskit.circuit.library.PhaseGate").                                           |
| [`pauli`](#qiskit.circuit.library.GR.pauli "qiskit.circuit.library.GR.pauli")(pauli\_string, qubits)                                                                          | Apply `PauliGate`.                                                                                                                  |
| [`power`](#qiskit.circuit.library.GR.power "qiskit.circuit.library.GR.power")(power\[, matrix\_power])                                                                        | Raise this circuit to the power of `power`.                                                                                         |
| [`qasm`](#qiskit.circuit.library.GR.qasm "qiskit.circuit.library.GR.qasm")(\[formatted, filename])                                                                            | Return OpenQASM string.                                                                                                             |
| [`qbit_argument_conversion`](#qiskit.circuit.library.GR.qbit_argument_conversion "qiskit.circuit.library.GR.qbit_argument_conversion")(qubit\_representation)                 | Converts several qubit representations (such as indexes, range, etc.) into a list of qubits.                                        |
| [`qubit_duration`](#qiskit.circuit.library.GR.qubit_duration "qiskit.circuit.library.GR.qubit_duration")(\*qubits)                                                            | Return the duration between the start and stop time of the first and last instructions, excluding delays, over the supplied qubits. |
| [`qubit_start_time`](#qiskit.circuit.library.GR.qubit_start_time "qiskit.circuit.library.GR.qubit_start_time")(\*qubits)                                                      | Return the start time of the first instruction, excluding delays, over the supplied qubits.                                         |
| [`qubit_stop_time`](#qiskit.circuit.library.GR.qubit_stop_time "qiskit.circuit.library.GR.qubit_stop_time")(\*qubits)                                                         | Return the stop time of the last instruction, excluding delays, over the supplied qubits.                                           |
| [`r`](#qiskit.circuit.library.GR.r "qiskit.circuit.library.GR.r")(theta, phi, qubit)                                                                                          | Apply [`RGate`](qiskit.circuit.library.RGate "qiskit.circuit.library.RGate").                                                       |
| [`rcccx`](#qiskit.circuit.library.GR.rcccx "qiskit.circuit.library.GR.rcccx")(control\_qubit1, control\_qubit2, …)                                                            | Apply [`RC3XGate`](qiskit.circuit.library.RC3XGate "qiskit.circuit.library.RC3XGate").                                              |
| [`rccx`](#qiskit.circuit.library.GR.rccx "qiskit.circuit.library.GR.rccx")(control\_qubit1, control\_qubit2, …)                                                               | Apply [`RCCXGate`](qiskit.circuit.library.RCCXGate "qiskit.circuit.library.RCCXGate").                                              |
| [`remove_final_measurements`](#qiskit.circuit.library.GR.remove_final_measurements "qiskit.circuit.library.GR.remove_final_measurements")(\[inplace])                         | Removes final measurement on all qubits if they are present.                                                                        |
| [`repeat`](#qiskit.circuit.library.GR.repeat "qiskit.circuit.library.GR.repeat")(reps)                                                                                        | Repeat this circuit `reps` times.                                                                                                   |
| [`reset`](#qiskit.circuit.library.GR.reset "qiskit.circuit.library.GR.reset")(qubit)                                                                                          | Reset q.                                                                                                                            |
| [`reverse_bits`](#qiskit.circuit.library.GR.reverse_bits "qiskit.circuit.library.GR.reverse_bits")()                                                                          | Return a circuit with the opposite order of wires.                                                                                  |
| [`reverse_ops`](#qiskit.circuit.library.GR.reverse_ops "qiskit.circuit.library.GR.reverse_ops")()                                                                             | Reverse the circuit by reversing the order of instructions.                                                                         |
| [`rv`](#qiskit.circuit.library.GR.rv "qiskit.circuit.library.GR.rv")(vx, vy, vz, qubit)                                                                                       | Apply [`RVGate`](qiskit.circuit.library.RVGate "qiskit.circuit.library.RVGate").                                                    |
| [`rx`](#qiskit.circuit.library.GR.rx "qiskit.circuit.library.GR.rx")(theta, qubit\[, label])                                                                                  | Apply [`RXGate`](qiskit.circuit.library.RXGate "qiskit.circuit.library.RXGate").                                                    |
| [`rxx`](#qiskit.circuit.library.GR.rxx "qiskit.circuit.library.GR.rxx")(theta, qubit1, qubit2)                                                                                | Apply [`RXXGate`](qiskit.circuit.library.RXXGate "qiskit.circuit.library.RXXGate").                                                 |
| [`ry`](#qiskit.circuit.library.GR.ry "qiskit.circuit.library.GR.ry")(theta, qubit\[, label])                                                                                  | Apply [`RYGate`](qiskit.circuit.library.RYGate "qiskit.circuit.library.RYGate").                                                    |
| [`ryy`](#qiskit.circuit.library.GR.ryy "qiskit.circuit.library.GR.ryy")(theta, qubit1, qubit2)                                                                                | Apply [`RYYGate`](qiskit.circuit.library.RYYGate "qiskit.circuit.library.RYYGate").                                                 |
| [`rz`](#qiskit.circuit.library.GR.rz "qiskit.circuit.library.GR.rz")(phi, qubit)                                                                                              | Apply [`RZGate`](qiskit.circuit.library.RZGate "qiskit.circuit.library.RZGate").                                                    |
| [`rzx`](#qiskit.circuit.library.GR.rzx "qiskit.circuit.library.GR.rzx")(theta, qubit1, qubit2)                                                                                | Apply [`RZXGate`](qiskit.circuit.library.RZXGate "qiskit.circuit.library.RZXGate").                                                 |
| [`rzz`](#qiskit.circuit.library.GR.rzz "qiskit.circuit.library.GR.rzz")(theta, qubit1, qubit2)                                                                                | Apply [`RZZGate`](qiskit.circuit.library.RZZGate "qiskit.circuit.library.RZZGate").                                                 |
| [`s`](#qiskit.circuit.library.GR.s "qiskit.circuit.library.GR.s")(qubit)                                                                                                      | Apply [`SGate`](qiskit.circuit.library.SGate "qiskit.circuit.library.SGate").                                                       |
| [`save_amplitudes`](#qiskit.circuit.library.GR.save_amplitudes "qiskit.circuit.library.GR.save_amplitudes")(params\[, label, pershot, …])                                     | Save complex statevector amplitudes.                                                                                                |
| [`save_amplitudes_squared`](#qiskit.circuit.library.GR.save_amplitudes_squared "qiskit.circuit.library.GR.save_amplitudes_squared")(params\[, label, …])                      | Save squared statevector amplitudes (probabilities).                                                                                |
| [`save_density_matrix`](#qiskit.circuit.library.GR.save_density_matrix "qiskit.circuit.library.GR.save_density_matrix")(\[qubits, label, …])                                  | Save the current simulator quantum state as a density matrix.                                                                       |
| [`save_expectation_value`](#qiskit.circuit.library.GR.save_expectation_value "qiskit.circuit.library.GR.save_expectation_value")(operator, qubits\[, …])                      | Save the expectation value of a Hermitian operator.                                                                                 |
| [`save_expectation_value_variance`](#qiskit.circuit.library.GR.save_expectation_value_variance "qiskit.circuit.library.GR.save_expectation_value_variance")(operator, qubits) | Save the expectation value of a Hermitian operator.                                                                                 |
| [`save_matrix_product_state`](#qiskit.circuit.library.GR.save_matrix_product_state "qiskit.circuit.library.GR.save_matrix_product_state")(\[label, pershot, …])               | Save the current simulator quantum state as a matrix product state.                                                                 |
| [`save_probabilities`](#qiskit.circuit.library.GR.save_probabilities "qiskit.circuit.library.GR.save_probabilities")(\[qubits, label, …])                                     | Save measurement outcome probabilities vector.                                                                                      |
| [`save_probabilities_dict`](#qiskit.circuit.library.GR.save_probabilities_dict "qiskit.circuit.library.GR.save_probabilities_dict")(\[qubits, label, …])                      | Save measurement outcome probabilities vector.                                                                                      |
| [`save_stabilizer`](#qiskit.circuit.library.GR.save_stabilizer "qiskit.circuit.library.GR.save_stabilizer")(\[label, pershot, conditional])                                   | Save the current stabilizer simulator quantum state as a Clifford.                                                                  |
| [`save_state`](#qiskit.circuit.library.GR.save_state "qiskit.circuit.library.GR.save_state")(\[label, pershot, conditional])                                                  | Save the current simulator quantum state.                                                                                           |
| [`save_statevector`](#qiskit.circuit.library.GR.save_statevector "qiskit.circuit.library.GR.save_statevector")(\[label, pershot, conditional])                                | Save the current simulator quantum state as a statevector.                                                                          |
| [`save_statevector_dict`](#qiskit.circuit.library.GR.save_statevector_dict "qiskit.circuit.library.GR.save_statevector_dict")(\[label, pershot, …])                           | Save the current simulator quantum state as a statevector as a dict.                                                                |
| [`save_superop`](#qiskit.circuit.library.GR.save_superop "qiskit.circuit.library.GR.save_superop")(\[label, pershot])                                                         | Save the current state of the superop simulator.                                                                                    |
| [`save_unitary`](#qiskit.circuit.library.GR.save_unitary "qiskit.circuit.library.GR.save_unitary")(\[label, pershot])                                                         | Save the current state of the unitary simulator.                                                                                    |
| [`sdg`](#qiskit.circuit.library.GR.sdg "qiskit.circuit.library.GR.sdg")(qubit)                                                                                                | Apply [`SdgGate`](qiskit.circuit.library.SdgGate "qiskit.circuit.library.SdgGate").                                                 |
| [`set_density_matrix`](#qiskit.circuit.library.GR.set_density_matrix "qiskit.circuit.library.GR.set_density_matrix")(state)                                                   | Set the density matrix state of the simulator.                                                                                      |
| [`set_matrix_product_state`](#qiskit.circuit.library.GR.set_matrix_product_state "qiskit.circuit.library.GR.set_matrix_product_state")(state)                                 | Set the matrix product state of the simulator.                                                                                      |
| [`set_stabilizer`](#qiskit.circuit.library.GR.set_stabilizer "qiskit.circuit.library.GR.set_stabilizer")(state)                                                               | Set the Clifford stabilizer state of the simulator.                                                                                 |
| [`set_statevector`](#qiskit.circuit.library.GR.set_statevector "qiskit.circuit.library.GR.set_statevector")(state)                                                            | Set the statevector state of the simulator.                                                                                         |
| [`set_superop`](#qiskit.circuit.library.GR.set_superop "qiskit.circuit.library.GR.set_superop")(state)                                                                        | Set the superop state of the simulator.                                                                                             |
| [`set_unitary`](#qiskit.circuit.library.GR.set_unitary "qiskit.circuit.library.GR.set_unitary")(state)                                                                        | Set the state state of the simulator.                                                                                               |
| [`size`](#qiskit.circuit.library.GR.size "qiskit.circuit.library.GR.size")()                                                                                                  | Returns total number of gate operations in circuit.                                                                                 |
| [`snapshot`](#qiskit.circuit.library.GR.snapshot "qiskit.circuit.library.GR.snapshot")(label\[, snapshot\_type, qubits, params])                                              | Take a statevector snapshot of the internal simulator representation.                                                               |
| [`snapshot_density_matrix`](#qiskit.circuit.library.GR.snapshot_density_matrix "qiskit.circuit.library.GR.snapshot_density_matrix")(label\[, qubits])                         | Take a density matrix snapshot of simulator state.                                                                                  |
| [`snapshot_expectation_value`](#qiskit.circuit.library.GR.snapshot_expectation_value "qiskit.circuit.library.GR.snapshot_expectation_value")(label, op, qubits)               | Take a snapshot of expectation value \<O> of an Operator.                                                                           |
| [`snapshot_probabilities`](#qiskit.circuit.library.GR.snapshot_probabilities "qiskit.circuit.library.GR.snapshot_probabilities")(label, qubits\[, variance])                  | Take a probability snapshot of the simulator state.                                                                                 |
| [`snapshot_stabilizer`](#qiskit.circuit.library.GR.snapshot_stabilizer "qiskit.circuit.library.GR.snapshot_stabilizer")(label)                                                | Take a stabilizer snapshot of the simulator state.                                                                                  |
| [`snapshot_statevector`](#qiskit.circuit.library.GR.snapshot_statevector "qiskit.circuit.library.GR.snapshot_statevector")(label)                                             | Take a statevector snapshot of the simulator state.                                                                                 |
| [`squ`](#qiskit.circuit.library.GR.squ "qiskit.circuit.library.GR.squ")(unitary\_matrix, qubit\[, mode, …])                                                                   | Decompose an arbitrary 2\*2 unitary into three rotation gates.                                                                      |
| [`swap`](#qiskit.circuit.library.GR.swap "qiskit.circuit.library.GR.swap")(qubit1, qubit2)                                                                                    | Apply [`SwapGate`](qiskit.circuit.library.SwapGate "qiskit.circuit.library.SwapGate").                                              |
| [`sx`](#qiskit.circuit.library.GR.sx "qiskit.circuit.library.GR.sx")(qubit)                                                                                                   | Apply [`SXGate`](qiskit.circuit.library.SXGate "qiskit.circuit.library.SXGate").                                                    |
| [`sxdg`](#qiskit.circuit.library.GR.sxdg "qiskit.circuit.library.GR.sxdg")(qubit)                                                                                             | Apply [`SXdgGate`](qiskit.circuit.library.SXdgGate "qiskit.circuit.library.SXdgGate").                                              |
| [`t`](#qiskit.circuit.library.GR.t "qiskit.circuit.library.GR.t")(qubit)                                                                                                      | Apply [`TGate`](qiskit.circuit.library.TGate "qiskit.circuit.library.TGate").                                                       |
| [`tdg`](#qiskit.circuit.library.GR.tdg "qiskit.circuit.library.GR.tdg")(qubit)                                                                                                | Apply [`TdgGate`](qiskit.circuit.library.TdgGate "qiskit.circuit.library.TdgGate").                                                 |
| [`tensor`](#qiskit.circuit.library.GR.tensor "qiskit.circuit.library.GR.tensor")(other\[, inplace])                                                                           | Tensor `self` with `other`.                                                                                                         |
| [`to_gate`](#qiskit.circuit.library.GR.to_gate "qiskit.circuit.library.GR.to_gate")(\[parameter\_map, label])                                                                 | Create a Gate out of this circuit.                                                                                                  |
| [`to_instruction`](#qiskit.circuit.library.GR.to_instruction "qiskit.circuit.library.GR.to_instruction")(\[parameter\_map])                                                   | Create an Instruction out of this circuit.                                                                                          |
| [`toffoli`](#qiskit.circuit.library.GR.toffoli "qiskit.circuit.library.GR.toffoli")(control\_qubit1, control\_qubit2, …)                                                      | Apply [`CCXGate`](qiskit.circuit.library.CCXGate "qiskit.circuit.library.CCXGate").                                                 |
| [`u`](#qiskit.circuit.library.GR.u "qiskit.circuit.library.GR.u")(theta, phi, lam, qubit)                                                                                     | Apply [`UGate`](qiskit.circuit.library.UGate "qiskit.circuit.library.UGate").                                                       |
| [`u1`](#qiskit.circuit.library.GR.u1 "qiskit.circuit.library.GR.u1")(theta, qubit)                                                                                            | Apply [`U1Gate`](qiskit.circuit.library.U1Gate "qiskit.circuit.library.U1Gate").                                                    |
| [`u2`](#qiskit.circuit.library.GR.u2 "qiskit.circuit.library.GR.u2")(phi, lam, qubit)                                                                                         | Apply [`U2Gate`](qiskit.circuit.library.U2Gate "qiskit.circuit.library.U2Gate").                                                    |
| [`u3`](#qiskit.circuit.library.GR.u3 "qiskit.circuit.library.GR.u3")(theta, phi, lam, qubit)                                                                                  | Apply [`U3Gate`](qiskit.circuit.library.U3Gate "qiskit.circuit.library.U3Gate").                                                    |
| [`uc`](#qiskit.circuit.library.GR.uc "qiskit.circuit.library.GR.uc")(gate\_list, q\_controls, q\_target\[, …])                                                                | Attach a uniformly controlled gates (also called multiplexed gates) to a circuit.                                                   |
| [`ucrx`](#qiskit.circuit.library.GR.ucrx "qiskit.circuit.library.GR.ucrx")(angle\_list, q\_controls, q\_target)                                                               | Attach a uniformly controlled (also called multiplexed) Rx rotation gate to a circuit.                                              |
| [`ucry`](#qiskit.circuit.library.GR.ucry "qiskit.circuit.library.GR.ucry")(angle\_list, q\_controls, q\_target)                                                               | Attach a uniformly controlled (also called multiplexed) Ry rotation gate to a circuit.                                              |
| [`ucrz`](#qiskit.circuit.library.GR.ucrz "qiskit.circuit.library.GR.ucrz")(angle\_list, q\_controls, q\_target)                                                               | Attach a uniformly controlled (also called multiplexed gates) Rz rotation gate to a circuit.                                        |
| [`unitary`](#qiskit.circuit.library.GR.unitary "qiskit.circuit.library.GR.unitary")(obj, qubits\[, label])                                                                    | Apply unitary gate to q.                                                                                                            |
| [`width`](#qiskit.circuit.library.GR.width "qiskit.circuit.library.GR.width")()                                                                                               | Return number of qubits plus clbits in circuit.                                                                                     |
| [`x`](#qiskit.circuit.library.GR.x "qiskit.circuit.library.GR.x")(qubit\[, label])                                                                                            | Apply [`XGate`](qiskit.circuit.library.XGate "qiskit.circuit.library.XGate").                                                       |
| [`y`](#qiskit.circuit.library.GR.y "qiskit.circuit.library.GR.y")(qubit)                                                                                                      | Apply [`YGate`](qiskit.circuit.library.YGate "qiskit.circuit.library.YGate").                                                       |
| [`z`](#qiskit.circuit.library.GR.z "qiskit.circuit.library.GR.z")(qubit)                                                                                                      | Apply [`ZGate`](qiskit.circuit.library.ZGate "qiskit.circuit.library.ZGate").                                                       |

## Attributes

|                                                                                                          |                                                                              |
| -------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------- |
| [`ancillas`](#qiskit.circuit.library.GR.ancillas "qiskit.circuit.library.GR.ancillas")                   | Returns a list of ancilla bits in the order that the registers were added.   |
| [`calibrations`](#qiskit.circuit.library.GR.calibrations "qiskit.circuit.library.GR.calibrations")       | Return calibration dictionary.                                               |
| [`clbits`](#qiskit.circuit.library.GR.clbits "qiskit.circuit.library.GR.clbits")                         | Returns a list of classical bits in the order that the registers were added. |
| [`data`](#qiskit.circuit.library.GR.data "qiskit.circuit.library.GR.data")                               | Return the circuit data (instructions and context).                          |
| `extension_lib`                                                                                          |                                                                              |
| [`global_phase`](#qiskit.circuit.library.GR.global_phase "qiskit.circuit.library.GR.global_phase")       | Return the global phase of the circuit in radians.                           |
| `header`                                                                                                 |                                                                              |
| `instances`                                                                                              |                                                                              |
| [`metadata`](#qiskit.circuit.library.GR.metadata "qiskit.circuit.library.GR.metadata")                   | The user provided metadata associated with the circuit                       |
| [`num_ancillas`](#qiskit.circuit.library.GR.num_ancillas "qiskit.circuit.library.GR.num_ancillas")       | Return the number of ancilla qubits.                                         |
| [`num_clbits`](#qiskit.circuit.library.GR.num_clbits "qiskit.circuit.library.GR.num_clbits")             | Return number of classical bits.                                             |
| [`num_parameters`](#qiskit.circuit.library.GR.num_parameters "qiskit.circuit.library.GR.num_parameters") | Convenience function to get the number of parameter objects in the circuit.  |
| [`num_qubits`](#qiskit.circuit.library.GR.num_qubits "qiskit.circuit.library.GR.num_qubits")             | Return number of qubits.                                                     |
| [`parameters`](#qiskit.circuit.library.GR.parameters "qiskit.circuit.library.GR.parameters")             | Convenience function to get the parameters defined in the parameter table.   |
| `prefix`                                                                                                 |                                                                              |
| [`qubits`](#qiskit.circuit.library.GR.qubits "qiskit.circuit.library.GR.qubits")                         | Returns a list of quantum bits in the order that the registers were added.   |

### add\_bits

<span id="qiskit.circuit.library.GR.add_bits" />
...
<span id="qiskit.circuit.library.GR.add_calibration" />
...
<span id="qiskit.circuit.library.GR.add_register" />
...
<span id="qiskit.circuit.library.GR.append" />
...
<span id="qiskit.circuit.library.GR.assign_parameters" />
...
<span id="qiskit.circuit.library.GR.barrier" />
...
<span id="qiskit.circuit.library.GR.bind_parameters" />

`bind_parameters(values, value_dict=None)`

Assign numeric parameters to values yielding a new circuit.

To assign new Parameter objects or bind the values in-place, without yielding a new circuit, use the [`assign_parameters()`](#qiskit.circuit.library.GR.assign_parameters "qiskit.circuit.library.GR.assign_parameters") method.
...
<span id="qiskit.circuit.library.GR.cast" />
...
<span id="qiskit.circuit.library.GR.cbit_argument_conversion" />
...
<span id="qiskit.circuit.library.GR.ccx" />
...
<span id="qiskit.circuit.library.GR.ch" />
...
<span id="qiskit.circuit.library.GR.cls_instances" />
...
<span id="qiskit.circuit.library.GR.cls_prefix" />
...
<span id="qiskit.circuit.library.GR.cnot" />
...
<span id="qiskit.circuit.library.GR.combine" />
...
<span id="qiskit.circuit.library.GR.compose" />
...
<span id="qiskit.circuit.library.GR.control" />
...
<span id="qiskit.circuit.library.GR.copy" />
...
<span id="qiskit.circuit.library.GR.count_ops" />
...
<span id="qiskit.circuit.library.GR.cp" />
...
<span id="qiskit.circuit.library.GR.crx" />
...
<span id="qiskit.circuit.library.GR.cry" />
...
<span id="qiskit.circuit.library.GR.crz" />
...
<span id="qiskit.circuit.library.GR.cswap" />
...
<span id="qiskit.circuit.library.GR.csx" />
...
<span id="qiskit.circuit.library.GR.cu" />
...
<span id="qiskit.circuit.library.GR.cu1" />
...
<span id="qiskit.circuit.library.GR.cu3" />
...
<span id="qiskit.circuit.library.GR.cx" />
...
<span id="qiskit.circuit.library.GR.cy" />
...
<span id="qiskit.circuit.library.GR.cz" />
...
<span id="qiskit.circuit.library.GR.dcx" />
...
<span id="qiskit.circuit.library.GR.decompose" />
...
<span id="qiskit.circuit.library.GR.delay" />
...
<span id="qiskit.circuit.library.GR.depth" />
...
<span id="qiskit.circuit.library.GR.diagonal" />
...
<span id="qiskit.circuit.library.GR.draw" />
...
![../\_images/qiskit.circuit.library.GR\_3\_0.png](/images/api/qiskit/0.27/qiskit.circuit.library.GR_3_0.png) ![../\_images/qiskit.circuit.library.GR\_3\_1.png](/images/api/qiskit/0.27/qiskit.circuit.library.GR_3_1.png)

### ecr

<span id="qiskit.circuit.library.GR.ecr" />
...
<span id="qiskit.circuit.library.GR.extend" />
...
<span id="qiskit.circuit.library.GR.fredkin" />
...
<span id="qiskit.circuit.library.GR.from_qasm_file" />
...
<span id="qiskit.circuit.library.GR.from_qasm_str" />
...
<span id="qiskit.circuit.library.GR.h" />
...
<span id="qiskit.circuit.library.GR.hamiltonian" />
...
<span id="qiskit.circuit.library.GR.has_register" />
...
<span id="qiskit.circuit.library.GR.i" />
...
<span id="qiskit.circuit.library.GR.id" />
...
<span id="qiskit.circuit.library.GR.initialize" />
...
<span id="qiskit.circuit.library.GR.inverse" />
...
<span id="qiskit.circuit.library.GR.iso" />
...
<span id="qiskit.circuit.library.GR.isometry" />
...
<span id="qiskit.circuit.library.GR.iswap" />
...
<span id="qiskit.circuit.library.GR.mcp" />
...
<span id="qiskit.circuit.library.GR.mcrx" />
...
<span id="qiskit.circuit.library.GR.mcry" />
...
<span id="qiskit.circuit.library.GR.mcrz" />
...
<span id="qiskit.circuit.library.GR.mct" />
...
<span id="qiskit.circuit.library.GR.mcu1" />
...
<span id="qiskit.circuit.library.GR.mcx" />
...
<span id="qiskit.circuit.library.GR.measure" />
...
<span id="qiskit.circuit.library.GR.measure_active" />
...
<span id="qiskit.circuit.library.GR.measure_all" />
...
<span id="qiskit.circuit.library.GR.ms" />
...
<span id="qiskit.circuit.library.GR.num_connected_components" />
...
<span id="qiskit.circuit.library.GR.num_nonlocal_gates" />
...
<span id="qiskit.circuit.library.GR.num_tensor_factors" />
...
<span id="qiskit.circuit.library.GR.num_unitary_factors" />
...
<span id="qiskit.circuit.library.GR.p" />
...
<span id="qiskit.circuit.library.GR.pauli" />
...
<span id="qiskit.circuit.library.GR.power" />
...
<span id="qiskit.circuit.library.GR.qasm" />
...
<span id="qiskit.circuit.library.GR.qbit_argument_conversion" />
...
<span id="qiskit.circuit.library.GR.qubit_duration" />
...
<span id="qiskit.circuit.library.GR.qubit_start_time" />
...
<span id="qiskit.circuit.library.GR.qubit_stop_time" />
...
<span id="qiskit.circuit.library.GR.r" />
...
<span id="qiskit.circuit.library.GR.rcccx" />
...
<span id="qiskit.circuit.library.GR.rccx" />
...
<span id="qiskit.circuit.library.GR.remove_final_measurements" />
...
<span id="qiskit.circuit.library.GR.repeat" />
...
<span id="qiskit.circuit.library.GR.reset" />
...
<span id="qiskit.circuit.library.GR.reverse_bits" />
...
<span id="qiskit.circuit.library.GR.reverse_ops" />
...
<span id="qiskit.circuit.library.GR.rv" />
...
<span id="qiskit.circuit.library.GR.rx" />
...
<span id="qiskit.circuit.library.GR.rxx" />
...
<span id="qiskit.circuit.library.GR.ry" />
...
<span id="qiskit.circuit.library.GR.ryy" />
...
<span id="qiskit.circuit.library.GR.rz" />
...
<span id="qiskit.circuit.library.GR.rzx" />
...
<span id="qiskit.circuit.library.GR.rzz" />
...
<span id="qiskit.circuit.library.GR.s" />
...
<span id="qiskit.circuit.library.GR.save_amplitudes" />
...
<span id="qiskit.circuit.library.GR.save_amplitudes_squared" />
...
<span id="qiskit.circuit.library.GR.save_density_matrix" />
...
<span id="qiskit.circuit.library.GR.save_expectation_value" />
...
<span id="qiskit.circuit.library.GR.save_expectation_value_variance" />
...
<span id="qiskit.circuit.library.GR.save_matrix_product_state" />
...
<span id="qiskit.circuit.library.GR.save_probabilities" />
...
<span id="qiskit.circuit.library.GR.save_probabilities_dict" />
...
<span id="qiskit.circuit.library.GR.save_stabilizer" />
...
<span id="qiskit.circuit.library.GR.save_state" />
...
<span id="qiskit.circuit.library.GR.save_statevector" />
...
<span id="qiskit.circuit.library.GR.save_statevector_dict" />
...
<span id="qiskit.circuit.library.GR.save_superop" />
...
<span id="qiskit.circuit.library.GR.save_unitary" />
...
<span id="qiskit.circuit.library.GR.sdg" />
...
<span id="qiskit.circuit.library.GR.set_density_matrix" />
...
<span id="qiskit.circuit.library.GR.set_matrix_product_state" />
...
<span id="qiskit.circuit.library.GR.set_stabilizer" />
...
<span id="qiskit.circuit.library.GR.set_statevector" />
...
<span id="qiskit.circuit.library.GR.set_superop" />
...
<span id="qiskit.circuit.library.GR.set_unitary" />
...
<span id="qiskit.circuit.library.GR.size" />
...
<span id="qiskit.circuit.library.GR.snapshot" />
...
<span id="qiskit.circuit.library.GR.snapshot_density_matrix" />
...
<span id="qiskit.circuit.library.GR.snapshot_expectation_value" />
...
<span id="qiskit.circuit.library.GR.snapshot_probabilities" />
...
<span id="qiskit.circuit.library.GR.snapshot_stabilizer" />
...
<span id="qiskit.circuit.library.GR.snapshot_statevector" />
...
<span id="qiskit.circuit.library.GR.squ" />
...
<span id="qiskit.circuit.library.GR.swap" />
...
<span id="qiskit.circuit.library.GR.sx" />
...
<span id="qiskit.circuit.library.GR.sxdg" />
...
<span id="qiskit.circuit.library.GR.t" />
...
<span id="qiskit.circuit.library.GR.tdg" />
...
<span id="qiskit.circuit.library.GR.tensor" />
...
<span id="qiskit.circuit.library.GR.to_gate" />
...
<span id="qiskit.circuit.library.GR.to_instruction" />
...
<span id="qiskit.circuit.library.GR.toffoli" />
...
<span id="qiskit.circuit.library.GR.u" />
...
<span id="qiskit.circuit.library.GR.u1" />
...
<span id="qiskit.circuit.library.GR.u2" />
...
<span id="qiskit.circuit.library.GR.u3" />
...
<span id="qiskit.circuit.library.GR.uc" />
...
<span id="qiskit.circuit.library.GR.ucrx" />
...
<span id="qiskit.circuit.library.GR.ucry" />
...
<span id="qiskit.circuit.library.GR.ucrz" />
...
<span id="qiskit.circuit.library.GR.unitary" />
...
<span id="qiskit.circuit.library.GR.width" />
...
<span id="qiskit.circuit.library.GR.x" />
...
<span id="qiskit.circuit.library.GR.y" />
...
<span id="qiskit.circuit.library.GR.z" />
