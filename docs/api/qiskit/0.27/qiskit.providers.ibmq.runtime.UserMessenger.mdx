...
<Class id="qiskit.providers.ibmq.runtime.UserMessenger" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-ibmq-provider/tree/stable/0.14/qiskit/providers/ibmq/runtime/program/user_messenger.py" signature="UserMessenger">
  ...
  <Function id="qiskit.providers.ibmq.runtime.UserMessenger.__init__" name="__init__" signature="__init__()">
  ...
  <Function id="qiskit.providers.ibmq.runtime.UserMessenger.publish" name="publish" signature="publish(message, encoder=<class 'qiskit.providers.ibmq.runtime.utils.RuntimeEncoder'>, final=False)">
    Publish message.
