...
<Class id="qiskit.chemistry.results.BOPESSamplerResult" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/chemistry/results/bopes_sampler_result.py" signature="BOPESSamplerResult(points, energies, raw_results)">
  ...
  <Function id="qiskit.chemistry.results.BOPESSamplerResult.energies" signature="property energies">
  ...
  <Function id="qiskit.chemistry.results.BOPESSamplerResult.points" signature="property points">
  ...
  <Function id="qiskit.chemistry.results.BOPESSamplerResult.raw_results" signature="property raw_results">
