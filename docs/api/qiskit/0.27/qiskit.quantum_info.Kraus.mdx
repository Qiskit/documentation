...
<Class id="qiskit.quantum_info.Kraus" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.17/qiskit/quantum_info/operators/channel/kraus.py" signature="Kraus(data, input_dims=None, output_dims=None)" modifiers="class">
...
$$
  ...
  **Additional Information:**
  ...
  <Function id="qiskit.quantum_info.Kraus.atol" signature="atol" modifiers="property">
  ...
  <Function id="qiskit.quantum_info.Kraus.data" signature="data" modifiers="property">
    Return list of Kraus matrices for channel.
  </Function>

  ### dim

  <Function id="qiskit.quantum_info.Kraus.dim" signature="dim" modifiers="property">
  ...
  <Function id="qiskit.quantum_info.Kraus.num_qubits" signature="num_qubits" modifiers="property">
  ...
  <Function id="qiskit.quantum_info.Kraus.qargs" signature="qargs" modifiers="property">
    Return the qargs for the operator.
  </Function>

  ### reshape

  <Function id="qiskit.quantum_info.Kraus.reshape" signature="reshape(input_dims=None, output_dims=None, num_qubits=None)">
  ...
  <Function id="qiskit.quantum_info.Kraus.rtol" signature="rtol" modifiers="property">
