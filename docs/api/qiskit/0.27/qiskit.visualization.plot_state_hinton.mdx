...
<Function id="qiskit.visualization.plot_state_hinton" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.17/qiskit/visualization/state_visualization.py" signature="plot_state_hinton(state, title='', figsize=None, ax_real=None, ax_imag=None, *, rho=None)">
  ...
  **Example**
  ...
  ![../\_images/qiskit.visualization.plot\_state\_hinton\_0\_0.png](/images/api/qiskit/0.27/qiskit.visualization.plot_state_hinton_0_0.avif) ![../\_images/qiskit.visualization.plot\_state\_hinton\_0\_1.png](/images/api/qiskit/0.27/qiskit.visualization.plot_state_hinton_0_1.avif)
</Function>
