---
title: u2 (v0.27)
description: API reference for qiskit.pulse.builder.u2 in qiskit v0.27
...
<Function id="qiskit.pulse.builder.u2" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.17/qiskit/pulse/builder.py" signature="u2(phi, lam, qubit)">
