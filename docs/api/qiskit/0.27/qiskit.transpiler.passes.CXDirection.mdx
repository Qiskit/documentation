...
<Class id="qiskit.transpiler.passes.CXDirection" github="https://github.com/qiskit/qiskit/tree/stable/0.17/qiskit/transpiler/passes/utils/cx_direction.py" signature="CXDirection(*args, **kwargs)">
