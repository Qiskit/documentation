---
title: EquivalenceLibrary (v0.27)
description: API reference for qiskit.circuit.EquivalenceLibrary in qiskit v0.27
...
<Class id="qiskit.circuit.EquivalenceLibrary" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.17/qiskit/circuit/equivalence.py" signature="EquivalenceLibrary(*, base=None)" modifiers="class">
  ...
  **base** (*Optional\[*[*EquivalenceLibrary*](#qiskit.circuit.EquivalenceLibrary "qiskit.circuit.EquivalenceLibrary")*]*) – Base equivalence library to will be referenced if an entry is not found in this library.
  ...
  <Function id="qiskit.circuit.EquivalenceLibrary.__init__" signature="__init__(*, base=None)">
    Create a new equivalence library.
  ...
  <Function id="qiskit.circuit.EquivalenceLibrary.draw" signature="draw(filename=None)">
