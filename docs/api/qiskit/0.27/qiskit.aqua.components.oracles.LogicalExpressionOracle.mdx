...
<Class id="qiskit.aqua.components.oracles.LogicalExpressionOracle" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/aqua/components/oracles/logical_expression_oracle.py" signature="LogicalExpressionOracle(expression, optimization=False, mct_mode='basic')" modifiers="class">
  ...
  **Raises**
  ...
  <Function id="qiskit.aqua.components.oracles.LogicalExpressionOracle.ancillary_register" signature="ancillary_register" modifiers="property">
    returns ancillary register
  </Function>

  ### circuit

  <Function id="qiskit.aqua.components.oracles.LogicalExpressionOracle.circuit" signature="circuit" modifiers="property" />
  ...
  <Function id="qiskit.aqua.components.oracles.LogicalExpressionOracle.output_register" signature="output_register" modifiers="property">
    returns output register
  </Function>

  ### variable\_register

  <Function id="qiskit.aqua.components.oracles.LogicalExpressionOracle.variable_register" signature="variable_register" modifiers="property">
