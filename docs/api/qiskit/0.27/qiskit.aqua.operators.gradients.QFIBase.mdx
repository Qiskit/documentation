---
title: QFIBase (v0.27)
description: API reference for qiskit.aqua.operators.gradients.QFIBase in qiskit v0.27
...
<Class id="qiskit.aqua.operators.gradients.QFIBase" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/aqua/operators/gradients/qfi_base.py" signature="QFIBase(qfi_method='lin_comb_full')" modifiers="class">
  ...
  **ValueError** – if `qfi_method` is neither a `CircuitQFI` object nor one of the predefined strings.
  ...
  <Function id="qiskit.aqua.operators.gradients.QFIBase.__init__" signature="__init__(qfi_method='lin_comb_full')">
    **Parameters**
  ...
  <Function id="qiskit.aqua.operators.gradients.QFIBase.convert" signature="convert(operator, params=None)" modifiers="abstract">
    **Parameters**
  ...
  <Function id="qiskit.aqua.operators.gradients.QFIBase.gradient_wrapper" signature="gradient_wrapper(operator, bind_params, grad_params=None, backend=None)">
  ...
  <Function id="qiskit.aqua.operators.gradients.QFIBase.parameter_expression_grad" signature="parameter_expression_grad(param_expr, param)" modifiers="static">
  ...
  <Attribute id="qiskit.aqua.operators.gradients.QFIBase.qfi_method">
    Returns `CircuitQFI`.
