...
<Class id="qiskit.chemistry.drivers.HDF5Driver" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/chemistry/drivers/hdf5d/hdf5driver.py" signature="HDF5Driver(hdf5_input='molecule.hdf5')" modifiers="class">
  ...
  **hdf5\_input** (`str`) – Path to HDF5 file
  ...
  <Function id="qiskit.chemistry.drivers.HDF5Driver.basis" signature="basis" modifiers="property">
    return basis
  ...
  <Function id="qiskit.chemistry.drivers.HDF5Driver.hf_method" signature="hf_method" modifiers="property">
  ...
  <Function id="qiskit.chemistry.drivers.HDF5Driver.molecule" signature="molecule" modifiers="property">
    return molecule
  ...
  <Function id="qiskit.chemistry.drivers.HDF5Driver.supports_molecule" signature="supports_molecule" modifiers="property">
  ...
  <Function id="qiskit.chemistry.drivers.HDF5Driver.work_path" signature="work_path" modifiers="property">
    Returns work path.
  </Function>
</Class>
