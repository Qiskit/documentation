...
<Class id="qiskit.pulse.MemorySlot" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.17/qiskit/pulse/channels.py" signature="MemorySlot(index)" modifiers="class">
  ...
  **index** (`int`) – Index of channel.
  ...
  <Function id="qiskit.pulse.MemorySlot.index" signature="index" modifiers="property">
  ...
  <Function id="qiskit.pulse.MemorySlot.name" signature="name" modifiers="property">
  ...
  <Function id="qiskit.pulse.MemorySlot.parameters" signature="parameters" modifiers="property">
