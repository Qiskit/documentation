...
`QuantumVolume(num_qubits, depth=None, seed=None, classical_permutation=True)` [GitHub](https://github.com/qiskit/qiskit/tree/stable/0.17/qiskit/circuit/library/quantum_volume.py "view source code")
...
![../\_images/qiskit.circuit.library.QuantumVolume\_0\_0.png](/images/api/qiskit/0.27/qiskit.circuit.library.QuantumVolume_0_0.png) ![../\_images/qiskit.circuit.library.QuantumVolume\_0\_1.png](/images/api/qiskit/0.27/qiskit.circuit.library.QuantumVolume_0_1.png)

**Expanded Circuit:**

![../\_images/qiskit.circuit.library.QuantumVolume\_1\_1.png](/images/api/qiskit/0.27/qiskit.circuit.library.QuantumVolume_1_1.png)
...
| [`compose`](#qiskit.circuit.library.QuantumVolume.compose "qiskit.circuit.library.QuantumVolume.compose")(other\[, qubits, clbits, front, inplace])                                                 | Compose circuit with `other` circuit or instruction, optionally permuting wires.                                                    |
...
| [`pauli`](#qiskit.circuit.library.QuantumVolume.pauli "qiskit.circuit.library.QuantumVolume.pauli")(pauli\_string, qubits)                                                                          | Apply `PauliGate`.                                                                                                                  |
...
| [`qasm`](#qiskit.circuit.library.QuantumVolume.qasm "qiskit.circuit.library.QuantumVolume.qasm")(\[formatted, filename])                                                                            | Return OpenQASM string.                                                                                                             |
...
| [`to_instruction`](#qiskit.circuit.library.QuantumVolume.to_instruction "qiskit.circuit.library.QuantumVolume.to_instruction")(\[parameter\_map])                                                   | Create an Instruction out of this circuit.                                                                                          |
...
![../\_images/qiskit.circuit.library.QuantumVolume\_4\_0.png](/images/api/qiskit/0.27/qiskit.circuit.library.QuantumVolume_4_0.png) ![../\_images/qiskit.circuit.library.QuantumVolume\_4\_1.png](/images/api/qiskit/0.27/qiskit.circuit.library.QuantumVolume_4_1.png)
