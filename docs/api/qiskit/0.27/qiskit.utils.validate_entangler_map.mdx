---
title: validate_entangler_map (v0.27)
description: API reference for qiskit.utils.validate_entangler_map in qiskit v0.27
...
<Function id="qiskit.utils.validate_entangler_map" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.17/qiskit/utils/entangler_map.py" signature="validate_entangler_map(entangler_map, num_qubits, allow_double_entanglement=False)">
