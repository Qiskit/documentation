---
title: AbelianGrouper (v0.27)
description: API reference for qiskit.opflow.converters.AbelianGrouper in qiskit v0.27
...
<Class id="qiskit.opflow.converters.AbelianGrouper" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.17/qiskit/opflow/converters/abelian_grouper.py" signature="AbelianGrouper(traverse=True)" modifiers="class">
  ...
  **traverse** (`bool`) – Whether to convert only the Operator passed to `convert`, or traverse down that Operator.
  ...
  <Function id="qiskit.opflow.converters.AbelianGrouper.__init__" signature="__init__(traverse=True)">
    **Parameters**
