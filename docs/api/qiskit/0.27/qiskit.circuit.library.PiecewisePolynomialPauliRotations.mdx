...
$$
  ...
  *   **name** (`str`) – The name of the circuit.
  ...
  <Function id="qiskit.circuit.library.PiecewisePolynomialPauliRotations.__init__" signature="__init__(num_state_qubits=None, breakpoints=None, coeffs=None, basis='Y', name='pw_poly')">
    **Parameters**
  ...
  <Function id="qiskit.circuit.library.PiecewisePolynomialPauliRotations.add_bits" signature="add_bits(bits)">
    Add Bits to the circuit.
  </Function>

  ### add\_calibration

  <Function id="qiskit.circuit.library.PiecewisePolynomialPauliRotations.add_calibration" signature="add_calibration(gate, qubits, schedule, params=None)">
  ...
  <Function id="qiskit.circuit.library.PiecewisePolynomialPauliRotations.add_register" signature="add_register(*regs)">
    Add registers.
  </Function>

  ### ancillas

  <Function id="qiskit.circuit.library.PiecewisePolynomialPauliRotations.ancillas" signature="ancillas" modifiers="property">
    Returns a list of ancilla bits in the order that the registers were added.
  </Function>

  ### append

  <Function id="qiskit.circuit.library.PiecewisePolynomialPauliRotations.append" signature="append(instruction, qargs=None, cargs=None)">
  ...
  <Function id="qiskit.circuit.library.PiecewisePolynomialPauliRotations.assign_parameters" signature="assign_parameters(parameters, inplace=False, param_dict=None)">
  ...
  <Function id="qiskit.circuit.library.PiecewisePolynomialPauliRotations.barrier" signature="barrier(*qargs)">
    Apply `Barrier`. If qargs is None, applies to all.
  </Function>

  ### basis

  <Function id="qiskit.circuit.library.PiecewisePolynomialPauliRotations.basis" signature="basis" modifiers="property">
  ...
  <Function id="qiskit.circuit.library.PiecewisePolynomialPauliRotations.bind_parameters" signature="bind_parameters(values, value_dict=None)">
  ...
  <Function id="qiskit.circuit.library.PiecewisePolynomialPauliRotations.breakpoints" signature="breakpoints" modifiers="property">
  ...
  <Function id="qiskit.circuit.library.PiecewisePolynomialPauliRotations.calibrations" signature="calibrations" modifiers="property">
  ...
  <Function id="qiskit.circuit.library.PiecewisePolynomialPauliRotations.cast" signature="cast(value, _type)" modifiers="static">
    Best effort to cast value to type. Otherwise, returns the value.
  </Function>

  ### cbit\_argument\_conversion

  <Function id="qiskit.circuit.library.PiecewisePolynomialPauliRotations.cbit_argument_conversion" signature="cbit_argument_conversion(clbit_representation)">
  ...
  <Function id="qiskit.circuit.library.PiecewisePolynomialPauliRotations.ccx" signature="ccx(control_qubit1, control_qubit2, target_qubit)">
    Apply [`CCXGate`](qiskit.circuit.library.CCXGate "qiskit.circuit.library.CCXGate").
  </Function>

  ### ch

  <Function id="qiskit.circuit.library.PiecewisePolynomialPauliRotations.ch" signature="ch(control_qubit, target_qubit, label=None, ctrl_state=None)">
    Apply [`CHGate`](qiskit.circuit.library.CHGate "qiskit.circuit.library.CHGate").
  </Function>

  ### clbits

  <Function id="qiskit.circuit.library.PiecewisePolynomialPauliRotations.clbits" signature="clbits" modifiers="property">
    Returns a list of classical bits in the order that the registers were added.
  </Function>

  ### cls\_instances

  <Function id="qiskit.circuit.library.PiecewisePolynomialPauliRotations.cls_instances" signature="cls_instances()" modifiers="classmethod">
    Return the current number of instances of this class, useful for auto naming.
  </Function>

  ### cls\_prefix

  <Function id="qiskit.circuit.library.PiecewisePolynomialPauliRotations.cls_prefix" signature="cls_prefix()" modifiers="classmethod">
    Return the prefix to use for auto naming.
  </Function>

  ### cnot

  <Function id="qiskit.circuit.library.PiecewisePolynomialPauliRotations.cnot" signature="cnot(control_qubit, target_qubit, label=None, ctrl_state=None)">
    Apply [`CXGate`](qiskit.circuit.library.CXGate "qiskit.circuit.library.CXGate").
  </Function>

  ### coeffs

  <Function id="qiskit.circuit.library.PiecewisePolynomialPauliRotations.coeffs" signature="coeffs" modifiers="property">
  ...
  <Function id="qiskit.circuit.library.PiecewisePolynomialPauliRotations.combine" signature="combine(rhs)">
  ...
  <Function id="qiskit.circuit.library.PiecewisePolynomialPauliRotations.compose" signature="compose(other, qubits=None, clbits=None, front=False, inplace=False)">
  ...
  <Function id="qiskit.circuit.library.PiecewisePolynomialPauliRotations.contains_zero_breakpoint" signature="contains_zero_breakpoint" modifiers="property">
  ...
  <Function id="qiskit.circuit.library.PiecewisePolynomialPauliRotations.control" signature="control(num_ctrl_qubits=1, label=None, ctrl_state=None)">
  ...
  <Function id="qiskit.circuit.library.PiecewisePolynomialPauliRotations.copy" signature="copy(name=None)">
    Copy the circuit.
  ...
  <Function id="qiskit.circuit.library.PiecewisePolynomialPauliRotations.count_ops" signature="count_ops()">
  ...
  <Function id="qiskit.circuit.library.PiecewisePolynomialPauliRotations.cp" signature="cp(theta, control_qubit, target_qubit, label=None, ctrl_state=None)">
    Apply [`CPhaseGate`](qiskit.circuit.library.CPhaseGate "qiskit.circuit.library.CPhaseGate").
  </Function>

  ### crx

  <Function id="qiskit.circuit.library.PiecewisePolynomialPauliRotations.crx" signature="crx(theta, control_qubit, target_qubit, label=None, ctrl_state=None)">
    Apply [`CRXGate`](qiskit.circuit.library.CRXGate "qiskit.circuit.library.CRXGate").
  </Function>

  ### cry

  <Function id="qiskit.circuit.library.PiecewisePolynomialPauliRotations.cry" signature="cry(theta, control_qubit, target_qubit, label=None, ctrl_state=None)">
    Apply [`CRYGate`](qiskit.circuit.library.CRYGate "qiskit.circuit.library.CRYGate").
  </Function>

  ### crz

  <Function id="qiskit.circuit.library.PiecewisePolynomialPauliRotations.crz" signature="crz(theta, control_qubit, target_qubit, label=None, ctrl_state=None)">
    Apply [`CRZGate`](qiskit.circuit.library.CRZGate "qiskit.circuit.library.CRZGate").
  </Function>

  ### cswap

  <Function id="qiskit.circuit.library.PiecewisePolynomialPauliRotations.cswap" signature="cswap(control_qubit, target_qubit1, target_qubit2, label=None, ctrl_state=None)">
    Apply [`CSwapGate`](qiskit.circuit.library.CSwapGate "qiskit.circuit.library.CSwapGate").
  </Function>

  ### csx

  <Function id="qiskit.circuit.library.PiecewisePolynomialPauliRotations.csx" signature="csx(control_qubit, target_qubit, label=None, ctrl_state=None)">
    Apply [`CSXGate`](qiskit.circuit.library.CSXGate "qiskit.circuit.library.CSXGate").
  </Function>

  ### cu

  <Function id="qiskit.circuit.library.PiecewisePolynomialPauliRotations.cu" signature="cu(theta, phi, lam, gamma, control_qubit, target_qubit, label=None, ctrl_state=None)">
    Apply [`CUGate`](qiskit.circuit.library.CUGate "qiskit.circuit.library.CUGate").
  </Function>

  ### cu1

  <Function id="qiskit.circuit.library.PiecewisePolynomialPauliRotations.cu1" signature="cu1(theta, control_qubit, target_qubit, label=None, ctrl_state=None)">
    Apply [`CU1Gate`](qiskit.circuit.library.CU1Gate "qiskit.circuit.library.CU1Gate").
  </Function>

  ### cu3

  <Function id="qiskit.circuit.library.PiecewisePolynomialPauliRotations.cu3" signature="cu3(theta, phi, lam, control_qubit, target_qubit, label=None, ctrl_state=None)">
    Apply [`CU3Gate`](qiskit.circuit.library.CU3Gate "qiskit.circuit.library.CU3Gate").
  </Function>

  ### cx

  <Function id="qiskit.circuit.library.PiecewisePolynomialPauliRotations.cx" signature="cx(control_qubit, target_qubit, label=None, ctrl_state=None)">
    Apply [`CXGate`](qiskit.circuit.library.CXGate "qiskit.circuit.library.CXGate").
  </Function>

  ### cy

  <Function id="qiskit.circuit.library.PiecewisePolynomialPauliRotations.cy" signature="cy(control_qubit, target_qubit, label=None, ctrl_state=None)">
    Apply [`CYGate`](qiskit.circuit.library.CYGate "qiskit.circuit.library.CYGate").
  </Function>

  ### cz

  <Function id="qiskit.circuit.library.PiecewisePolynomialPauliRotations.cz" signature="cz(control_qubit, target_qubit, label=None, ctrl_state=None)">
    Apply [`CZGate`](qiskit.circuit.library.CZGate "qiskit.circuit.library.CZGate").
  </Function>

  ### data

  <Function id="qiskit.circuit.library.PiecewisePolynomialPauliRotations.data" signature="data" modifiers="property">
  ...
  <Function id="qiskit.circuit.library.PiecewisePolynomialPauliRotations.dcx" signature="dcx(qubit1, qubit2)">
    Apply [`DCXGate`](qiskit.circuit.library.DCXGate "qiskit.circuit.library.DCXGate").
  </Function>

  ### decompose

  <Function id="qiskit.circuit.library.PiecewisePolynomialPauliRotations.decompose" signature="decompose()">
  ...
  <Function id="qiskit.circuit.library.PiecewisePolynomialPauliRotations.delay" signature="delay(duration, qarg=None, unit='dt')">
  ...
  <Function id="qiskit.circuit.library.PiecewisePolynomialPauliRotations.depth" signature="depth()">
  ...
  <Function id="qiskit.circuit.library.PiecewisePolynomialPauliRotations.diagonal" signature="diagonal(diag, qubit)">
  ...
  <Function id="qiskit.circuit.library.PiecewisePolynomialPauliRotations.ecr" signature="ecr(qubit1, qubit2)">
    Apply [`ECRGate`](qiskit.circuit.library.ECRGate "qiskit.circuit.library.ECRGate").
  </Function>

  ### evaluate

  <Function id="qiskit.circuit.library.PiecewisePolynomialPauliRotations.evaluate" signature="evaluate(x)">
  ...
  <Function id="qiskit.circuit.library.PiecewisePolynomialPauliRotations.extend" signature="extend(rhs)">
  ...
  <Function id="qiskit.circuit.library.PiecewisePolynomialPauliRotations.fredkin" signature="fredkin(control_qubit, target_qubit1, target_qubit2)">
    Apply [`CSwapGate`](qiskit.circuit.library.CSwapGate "qiskit.circuit.library.CSwapGate").
  </Function>

  ### from\_qasm\_file

  <Function id="qiskit.circuit.library.PiecewisePolynomialPauliRotations.from_qasm_file" signature="from_qasm_file(path)" modifiers="static">
  ...
  <Function id="qiskit.circuit.library.PiecewisePolynomialPauliRotations.from_qasm_str" signature="from_qasm_str(qasm_str)" modifiers="static">
  ...
  <Function id="qiskit.circuit.library.PiecewisePolynomialPauliRotations.global_phase" signature="global_phase" modifiers="property">
    Return the global phase of the circuit in radians.
  </Function>

  ### h

  <Function id="qiskit.circuit.library.PiecewisePolynomialPauliRotations.h" signature="h(qubit)">
    Apply [`HGate`](qiskit.circuit.library.HGate "qiskit.circuit.library.HGate").
  </Function>

  ### hamiltonian

  <Function id="qiskit.circuit.library.PiecewisePolynomialPauliRotations.hamiltonian" signature="hamiltonian(operator, time, qubits, label=None)">
    Apply hamiltonian evolution to qubits.
  </Function>

  ### has\_register

  <Function id="qiskit.circuit.library.PiecewisePolynomialPauliRotations.has_register" signature="has_register(register)">
  ...
  <Function id="qiskit.circuit.library.PiecewisePolynomialPauliRotations.i" signature="i(qubit)">
    Apply [`IGate`](qiskit.circuit.library.IGate "qiskit.circuit.library.IGate").
  </Function>

  ### id

  <Function id="qiskit.circuit.library.PiecewisePolynomialPauliRotations.id" signature="id(qubit)">
    Apply [`IGate`](qiskit.circuit.library.IGate "qiskit.circuit.library.IGate").
  </Function>

  ### initialize

  <Function id="qiskit.circuit.library.PiecewisePolynomialPauliRotations.initialize" signature="initialize(params, qubits=None)">
  ...
  <Function id="qiskit.circuit.library.PiecewisePolynomialPauliRotations.inverse" signature="inverse()">
  ...
  <Function id="qiskit.circuit.library.PiecewisePolynomialPauliRotations.iso" signature="iso(isometry, q_input, q_ancillas_for_output, q_ancillas_zero=None, q_ancillas_dirty=None)">
  ...
  <Function id="qiskit.circuit.library.PiecewisePolynomialPauliRotations.isometry" signature="isometry(isometry, q_input, q_ancillas_for_output, q_ancillas_zero=None, q_ancillas_dirty=None)">
    Attach an arbitrary isometry from m to n qubits to a circuit. In particular, this allows to attach arbitrary unitaries on n qubits (m=n) or to prepare any state on n qubits (m=0). The decomposition used here was introduced by Iten et al. in [https://arxiv.org/abs/1501.06911](https://arxiv.org/abs/1501.06911).
  ...
  <Function id="qiskit.circuit.library.PiecewisePolynomialPauliRotations.iswap" signature="iswap(qubit1, qubit2)">
    Apply [`iSwapGate`](qiskit.circuit.library.iSwapGate "qiskit.circuit.library.iSwapGate").
  </Function>

  ### mapped\_coeffs

  <Function id="qiskit.circuit.library.PiecewisePolynomialPauliRotations.mapped_coeffs" signature="mapped_coeffs" modifiers="property">
  ...
  <Function id="qiskit.circuit.library.PiecewisePolynomialPauliRotations.mcp" signature="mcp(lam, control_qubits, target_qubit)">
    Apply [`MCPhaseGate`](qiskit.circuit.library.MCPhaseGate "qiskit.circuit.library.MCPhaseGate").
  </Function>

  ### mcrx

  <Function id="qiskit.circuit.library.PiecewisePolynomialPauliRotations.mcrx" signature="mcrx(theta, q_controls, q_target, use_basis_gates=False)">
  ...
  <Function id="qiskit.circuit.library.PiecewisePolynomialPauliRotations.mcry" signature="mcry(theta, q_controls, q_target, q_ancillae=None, mode=None, use_basis_gates=False)">
  ...
  <Function id="qiskit.circuit.library.PiecewisePolynomialPauliRotations.mcrz" signature="mcrz(lam, q_controls, q_target, use_basis_gates=False)">
  ...
  <Function id="qiskit.circuit.library.PiecewisePolynomialPauliRotations.mct" signature="mct(control_qubits, target_qubit, ancilla_qubits=None, mode='noancilla')">
    Apply [`MCXGate`](qiskit.circuit.library.MCXGate "qiskit.circuit.library.MCXGate").
  </Function>

  ### mcu1

  <Function id="qiskit.circuit.library.PiecewisePolynomialPauliRotations.mcu1" signature="mcu1(lam, control_qubits, target_qubit)">
    Apply `MCU1Gate`.
  </Function>

  ### mcx

  <Function id="qiskit.circuit.library.PiecewisePolynomialPauliRotations.mcx" signature="mcx(control_qubits, target_qubit, ancilla_qubits=None, mode='noancilla')">
    Apply [`MCXGate`](qiskit.circuit.library.MCXGate "qiskit.circuit.library.MCXGate").
  ...
  <Function id="qiskit.circuit.library.PiecewisePolynomialPauliRotations.measure" signature="measure(qubit, cbit)">
  ...
  <Function id="qiskit.circuit.library.PiecewisePolynomialPauliRotations.measure_active" signature="measure_active(inplace=True)">
  ...
  <Function id="qiskit.circuit.library.PiecewisePolynomialPauliRotations.measure_all" signature="measure_all(inplace=True)">
  ...
  <Function id="qiskit.circuit.library.PiecewisePolynomialPauliRotations.metadata" signature="metadata" modifiers="property">
  ...
  <Function id="qiskit.circuit.library.PiecewisePolynomialPauliRotations.ms" signature="ms(theta, qubits)">
    Apply [`MSGate`](qiskit.circuit.library.MSGate "qiskit.circuit.library.MSGate").
  </Function>

  ### num\_ancilla\_qubits

  <Function id="qiskit.circuit.library.PiecewisePolynomialPauliRotations.num_ancilla_qubits" signature="num_ancilla_qubits" modifiers="property">
  ...
  <Function id="qiskit.circuit.library.PiecewisePolynomialPauliRotations.num_ancillas" signature="num_ancillas" modifiers="property">
    Return the number of ancilla qubits.
  </Function>

  ### num\_clbits

  <Function id="qiskit.circuit.library.PiecewisePolynomialPauliRotations.num_clbits" signature="num_clbits" modifiers="property">
    Return number of classical bits.
  </Function>

  ### num\_connected\_components

  <Function id="qiskit.circuit.library.PiecewisePolynomialPauliRotations.num_connected_components" signature="num_connected_components(unitary_only=False)">
  ...
  <Function id="qiskit.circuit.library.PiecewisePolynomialPauliRotations.num_nonlocal_gates" signature="num_nonlocal_gates()">
  ...
  <Function id="qiskit.circuit.library.PiecewisePolynomialPauliRotations.num_parameters" signature="num_parameters" modifiers="property">
  ...
  <Function id="qiskit.circuit.library.PiecewisePolynomialPauliRotations.num_qubits" signature="num_qubits" modifiers="property">
    Return number of qubits.
  </Function>

  ### num\_state\_qubits

  <Function id="qiskit.circuit.library.PiecewisePolynomialPauliRotations.num_state_qubits" signature="num_state_qubits" modifiers="property">
  ...
  <Function id="qiskit.circuit.library.PiecewisePolynomialPauliRotations.num_tensor_factors" signature="num_tensor_factors()">
  ...
  <Function id="qiskit.circuit.library.PiecewisePolynomialPauliRotations.num_unitary_factors" signature="num_unitary_factors()">
    Computes the number of tensor factors in the unitary (quantum) part of the circuit only.
  </Function>

  ### p

  <Function id="qiskit.circuit.library.PiecewisePolynomialPauliRotations.p" signature="p(theta, qubit)">
    Apply [`PhaseGate`](qiskit.circuit.library.PhaseGate "qiskit.circuit.library.PhaseGate").
  </Function>

  ### parameters

  <Function id="qiskit.circuit.library.PiecewisePolynomialPauliRotations.parameters" signature="parameters" modifiers="property">
  ...
  <Function id="qiskit.circuit.library.PiecewisePolynomialPauliRotations.pauli" signature="pauli(pauli_string, qubits)">
    Apply `PauliGate`.
  </Function>

  ### power

  <Function id="qiskit.circuit.library.PiecewisePolynomialPauliRotations.power" signature="power(power, matrix_power=False)">
  ...
  <Function id="qiskit.circuit.library.PiecewisePolynomialPauliRotations.qasm" signature="qasm(formatted=False, filename=None)">
  ...
  <Function id="qiskit.circuit.library.PiecewisePolynomialPauliRotations.qbit_argument_conversion" signature="qbit_argument_conversion(qubit_representation)">
  ...
  <Function id="qiskit.circuit.library.PiecewisePolynomialPauliRotations.qregs" signature="qregs" modifiers="property">
    A list of the quantum registers associated with the circuit.
  </Function>

  ### qubit\_duration

  <Function id="qiskit.circuit.library.PiecewisePolynomialPauliRotations.qubit_duration" signature="qubit_duration(*qubits)">
  ...
  <Function id="qiskit.circuit.library.PiecewisePolynomialPauliRotations.qubit_start_time" signature="qubit_start_time(*qubits)">
  ...
  <Function id="qiskit.circuit.library.PiecewisePolynomialPauliRotations.qubit_stop_time" signature="qubit_stop_time(*qubits)">
  ...
  <Function id="qiskit.circuit.library.PiecewisePolynomialPauliRotations.qubits" signature="qubits" modifiers="property">
    Returns a list of quantum bits in the order that the registers were added.
  </Function>

  ### r

  <Function id="qiskit.circuit.library.PiecewisePolynomialPauliRotations.r" signature="r(theta, phi, qubit)">
    Apply [`RGate`](qiskit.circuit.library.RGate "qiskit.circuit.library.RGate").
  </Function>

  ### rcccx

  <Function id="qiskit.circuit.library.PiecewisePolynomialPauliRotations.rcccx" signature="rcccx(control_qubit1, control_qubit2, control_qubit3, target_qubit)">
    Apply [`RC3XGate`](qiskit.circuit.library.RC3XGate "qiskit.circuit.library.RC3XGate").
  </Function>

  ### rccx

  <Function id="qiskit.circuit.library.PiecewisePolynomialPauliRotations.rccx" signature="rccx(control_qubit1, control_qubit2, target_qubit)">
    Apply [`RCCXGate`](qiskit.circuit.library.RCCXGate "qiskit.circuit.library.RCCXGate").
  </Function>

  ### remove\_final\_measurements

  <Function id="qiskit.circuit.library.PiecewisePolynomialPauliRotations.remove_final_measurements" signature="remove_final_measurements(inplace=True)">
  ...
  <Function id="qiskit.circuit.library.PiecewisePolynomialPauliRotations.repeat" signature="repeat(reps)">
  ...
  <Function id="qiskit.circuit.library.PiecewisePolynomialPauliRotations.reset" signature="reset(qubit)">
    Reset q.
  </Function>

  ### reverse\_bits

  <Function id="qiskit.circuit.library.PiecewisePolynomialPauliRotations.reverse_bits" signature="reverse_bits()">
  ...
  <Function id="qiskit.circuit.library.PiecewisePolynomialPauliRotations.reverse_ops" signature="reverse_ops()">
  ...
  <Function id="qiskit.circuit.library.PiecewisePolynomialPauliRotations.rv" signature="rv(vx, vy, vz, qubit)">
    Apply [`RVGate`](qiskit.circuit.library.RVGate "qiskit.circuit.library.RVGate").
  </Function>

  ### rx

  <Function id="qiskit.circuit.library.PiecewisePolynomialPauliRotations.rx" signature="rx(theta, qubit, label=None)">
    Apply [`RXGate`](qiskit.circuit.library.RXGate "qiskit.circuit.library.RXGate").
  </Function>

  ### rxx

  <Function id="qiskit.circuit.library.PiecewisePolynomialPauliRotations.rxx" signature="rxx(theta, qubit1, qubit2)">
    Apply [`RXXGate`](qiskit.circuit.library.RXXGate "qiskit.circuit.library.RXXGate").
  </Function>

  ### ry

  <Function id="qiskit.circuit.library.PiecewisePolynomialPauliRotations.ry" signature="ry(theta, qubit, label=None)">
    Apply [`RYGate`](qiskit.circuit.library.RYGate "qiskit.circuit.library.RYGate").
  </Function>

  ### ryy

  <Function id="qiskit.circuit.library.PiecewisePolynomialPauliRotations.ryy" signature="ryy(theta, qubit1, qubit2)">
    Apply [`RYYGate`](qiskit.circuit.library.RYYGate "qiskit.circuit.library.RYYGate").
  </Function>

  ### rz

  <Function id="qiskit.circuit.library.PiecewisePolynomialPauliRotations.rz" signature="rz(phi, qubit)">
    Apply [`RZGate`](qiskit.circuit.library.RZGate "qiskit.circuit.library.RZGate").
  </Function>

  ### rzx

  <Function id="qiskit.circuit.library.PiecewisePolynomialPauliRotations.rzx" signature="rzx(theta, qubit1, qubit2)">
    Apply [`RZXGate`](qiskit.circuit.library.RZXGate "qiskit.circuit.library.RZXGate").
  </Function>

  ### rzz

  <Function id="qiskit.circuit.library.PiecewisePolynomialPauliRotations.rzz" signature="rzz(theta, qubit1, qubit2)">
    Apply [`RZZGate`](qiskit.circuit.library.RZZGate "qiskit.circuit.library.RZZGate").
  </Function>

  ### s

  <Function id="qiskit.circuit.library.PiecewisePolynomialPauliRotations.s" signature="s(qubit)">
    Apply [`SGate`](qiskit.circuit.library.SGate "qiskit.circuit.library.SGate").
  </Function>

  ### save\_amplitudes

  <Function id="qiskit.circuit.library.PiecewisePolynomialPauliRotations.save_amplitudes" signature="save_amplitudes(params, label='amplitudes', pershot=False, conditional=False)">
  ...
  <Function id="qiskit.circuit.library.PiecewisePolynomialPauliRotations.save_amplitudes_squared" signature="save_amplitudes_squared(params, label='amplitudes_squared', unnormalized=False, pershot=False, conditional=False)">
  ...
  <Function id="qiskit.circuit.library.PiecewisePolynomialPauliRotations.save_density_matrix" signature="save_density_matrix(qubits=None, label='density_matrix', unnormalized=False, pershot=False, conditional=False)">
  ...
  <Function id="qiskit.circuit.library.PiecewisePolynomialPauliRotations.save_expectation_value" signature="save_expectation_value(operator, qubits, label='expectation_value', unnormalized=False, pershot=False, conditional=False)">
  ...
  <Function id="qiskit.circuit.library.PiecewisePolynomialPauliRotations.save_expectation_value_variance" signature="save_expectation_value_variance(operator, qubits, label='expectation_value_variance', unnormalized=False, pershot=False, conditional=False)">
    Save the expectation value of a Hermitian operator.
  ...
  <Function id="qiskit.circuit.library.PiecewisePolynomialPauliRotations.save_matrix_product_state" signature="save_matrix_product_state(label='matrix_product_state', pershot=False, conditional=False)">
  ...
  <Function id="qiskit.circuit.library.PiecewisePolynomialPauliRotations.save_probabilities" signature="save_probabilities(qubits=None, label='probabilities', unnormalized=False, pershot=False, conditional=False)">
  ...
  <Function id="qiskit.circuit.library.PiecewisePolynomialPauliRotations.save_probabilities_dict" signature="save_probabilities_dict(qubits=None, label='probabilities', unnormalized=False, pershot=False, conditional=False)">
    Save measurement outcome probabilities vector.
  ...
  <Function id="qiskit.circuit.library.PiecewisePolynomialPauliRotations.save_stabilizer" signature="save_stabilizer(label='stabilizer', pershot=False, conditional=False)">
  ...
  <Function id="qiskit.circuit.library.PiecewisePolynomialPauliRotations.save_state" signature="save_state(label=None, pershot=False, conditional=False)">
  ...
  <Function id="qiskit.circuit.library.PiecewisePolynomialPauliRotations.save_statevector" signature="save_statevector(label='statevector', pershot=False, conditional=False)">
  ...
  <Function id="qiskit.circuit.library.PiecewisePolynomialPauliRotations.save_statevector_dict" signature="save_statevector_dict(label='statevector', pershot=False, conditional=False)">
  ...
  <Function id="qiskit.circuit.library.PiecewisePolynomialPauliRotations.save_superop" signature="save_superop(label='superop', pershot=False)">
  ...
  <Function id="qiskit.circuit.library.PiecewisePolynomialPauliRotations.save_unitary" signature="save_unitary(label='unitary', pershot=False)">
  ...
  <Function id="qiskit.circuit.library.PiecewisePolynomialPauliRotations.sdg" signature="sdg(qubit)">
    Apply [`SdgGate`](qiskit.circuit.library.SdgGate "qiskit.circuit.library.SdgGate").
  </Function>

  ### set\_density\_matrix

  <Function id="qiskit.circuit.library.PiecewisePolynomialPauliRotations.set_density_matrix" signature="set_density_matrix(state)">
  ...
  <Function id="qiskit.circuit.library.PiecewisePolynomialPauliRotations.set_matrix_product_state" signature="set_matrix_product_state(state)">
  ...
  <Function id="qiskit.circuit.library.PiecewisePolynomialPauliRotations.set_stabilizer" signature="set_stabilizer(state)">
  ...
  <Function id="qiskit.circuit.library.PiecewisePolynomialPauliRotations.set_statevector" signature="set_statevector(state)">
  ...
  <Function id="qiskit.circuit.library.PiecewisePolynomialPauliRotations.set_superop" signature="set_superop(state)">
  ...
  <Function id="qiskit.circuit.library.PiecewisePolynomialPauliRotations.set_unitary" signature="set_unitary(state)">
  ...
  <Function id="qiskit.circuit.library.PiecewisePolynomialPauliRotations.size" signature="size()">
  ...
  <Function id="qiskit.circuit.library.PiecewisePolynomialPauliRotations.snapshot" signature="snapshot(label, snapshot_type='statevector', qubits=None, params=None)">
  ...
  <Function id="qiskit.circuit.library.PiecewisePolynomialPauliRotations.snapshot_density_matrix" signature="snapshot_density_matrix(label, qubits=None)">
  ...
  <Function id="qiskit.circuit.library.PiecewisePolynomialPauliRotations.snapshot_expectation_value" signature="snapshot_expectation_value(label, op, qubits, single_shot=False, variance=False)">
  ...
  <Function id="qiskit.circuit.library.PiecewisePolynomialPauliRotations.snapshot_probabilities" signature="snapshot_probabilities(label, qubits, variance=False)">
  ...
  <Function id="qiskit.circuit.library.PiecewisePolynomialPauliRotations.snapshot_stabilizer" signature="snapshot_stabilizer(label)">
  ...
  <Function id="qiskit.circuit.library.PiecewisePolynomialPauliRotations.snapshot_statevector" signature="snapshot_statevector(label)">
  ...
  <Function id="qiskit.circuit.library.PiecewisePolynomialPauliRotations.squ" signature="squ(unitary_matrix, qubit, mode='ZYZ', up_to_diagonal=False, *, u=None)">
  ...
  <Function id="qiskit.circuit.library.PiecewisePolynomialPauliRotations.swap" signature="swap(qubit1, qubit2)">
    Apply [`SwapGate`](qiskit.circuit.library.SwapGate "qiskit.circuit.library.SwapGate").
  </Function>

  ### sx

  <Function id="qiskit.circuit.library.PiecewisePolynomialPauliRotations.sx" signature="sx(qubit)">
    Apply [`SXGate`](qiskit.circuit.library.SXGate "qiskit.circuit.library.SXGate").
  </Function>

  ### sxdg

  <Function id="qiskit.circuit.library.PiecewisePolynomialPauliRotations.sxdg" signature="sxdg(qubit)">
    Apply [`SXdgGate`](qiskit.circuit.library.SXdgGate "qiskit.circuit.library.SXdgGate").
  </Function>

  ### t

  <Function id="qiskit.circuit.library.PiecewisePolynomialPauliRotations.t" signature="t(qubit)">
    Apply [`TGate`](qiskit.circuit.library.TGate "qiskit.circuit.library.TGate").
  </Function>

  ### tdg

  <Function id="qiskit.circuit.library.PiecewisePolynomialPauliRotations.tdg" signature="tdg(qubit)">
    Apply [`TdgGate`](qiskit.circuit.library.TdgGate "qiskit.circuit.library.TdgGate").
  </Function>

  ### tensor

  <Function id="qiskit.circuit.library.PiecewisePolynomialPauliRotations.tensor" signature="tensor(other, inplace=False)">
  ...
  <Function id="qiskit.circuit.library.PiecewisePolynomialPauliRotations.to_gate" signature="to_gate(parameter_map=None, label=None)">
  ...
  <Function id="qiskit.circuit.library.PiecewisePolynomialPauliRotations.to_instruction" signature="to_instruction(parameter_map=None)">
  ...
  <Function id="qiskit.circuit.library.PiecewisePolynomialPauliRotations.toffoli" signature="toffoli(control_qubit1, control_qubit2, target_qubit)">
    Apply [`CCXGate`](qiskit.circuit.library.CCXGate "qiskit.circuit.library.CCXGate").
  </Function>

  ### u

  <Function id="qiskit.circuit.library.PiecewisePolynomialPauliRotations.u" signature="u(theta, phi, lam, qubit)">
    Apply [`UGate`](qiskit.circuit.library.UGate "qiskit.circuit.library.UGate").
  </Function>

  ### u1

  <Function id="qiskit.circuit.library.PiecewisePolynomialPauliRotations.u1" signature="u1(theta, qubit)">
    Apply [`U1Gate`](qiskit.circuit.library.U1Gate "qiskit.circuit.library.U1Gate").
  </Function>

  ### u2

  <Function id="qiskit.circuit.library.PiecewisePolynomialPauliRotations.u2" signature="u2(phi, lam, qubit)">
    Apply [`U2Gate`](qiskit.circuit.library.U2Gate "qiskit.circuit.library.U2Gate").
  </Function>

  ### u3

  <Function id="qiskit.circuit.library.PiecewisePolynomialPauliRotations.u3" signature="u3(theta, phi, lam, qubit)">
    Apply [`U3Gate`](qiskit.circuit.library.U3Gate "qiskit.circuit.library.U3Gate").
  </Function>

  ### uc

  <Function id="qiskit.circuit.library.PiecewisePolynomialPauliRotations.uc" signature="uc(gate_list, q_controls, q_target, up_to_diagonal=False)">
  ...
  <Function id="qiskit.circuit.library.PiecewisePolynomialPauliRotations.ucrx" signature="ucrx(angle_list, q_controls, q_target)">
  ...
  <Function id="qiskit.circuit.library.PiecewisePolynomialPauliRotations.ucry" signature="ucry(angle_list, q_controls, q_target)">
  ...
  <Function id="qiskit.circuit.library.PiecewisePolynomialPauliRotations.ucrz" signature="ucrz(angle_list, q_controls, q_target)">
  ...
  <Function id="qiskit.circuit.library.PiecewisePolynomialPauliRotations.unitary" signature="unitary(obj, qubits, label=None)">
    Apply unitary gate to q.
  </Function>

  ### width

  <Function id="qiskit.circuit.library.PiecewisePolynomialPauliRotations.width" signature="width()">
  ...
  <Function id="qiskit.circuit.library.PiecewisePolynomialPauliRotations.x" signature="x(qubit, label=None)">
    Apply [`XGate`](qiskit.circuit.library.XGate "qiskit.circuit.library.XGate").
  </Function>

  ### y

  <Function id="qiskit.circuit.library.PiecewisePolynomialPauliRotations.y" signature="y(qubit)">
    Apply [`YGate`](qiskit.circuit.library.YGate "qiskit.circuit.library.YGate").
  </Function>

  ### z

  <Function id="qiskit.circuit.library.PiecewisePolynomialPauliRotations.z" signature="z(qubit)">
