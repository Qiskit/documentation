---
title: ProviderV1 (v0.27)
description: API reference for qiskit.providers.ProviderV1 in qiskit v0.27
...
<Class id="qiskit.providers.ProviderV1" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.17/qiskit/providers/provider.py" signature="ProviderV1" modifiers="class">
