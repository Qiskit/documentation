...
<Class id="qiskit.chemistry.algorithms.EigensolverFactory" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/chemistry/algorithms/excited_states_solvers/eigensolver_factories/eigensolver_factory.py" signature="EigensolverFactory">
  A factory to construct a eigensolver based on a qubit operator transformation.

  ### \_\_init\_\_

  <Function id="qiskit.chemistry.algorithms.EigensolverFactory.__init__" name="__init__" signature="__init__()">
  ...
  <Function id="qiskit.chemistry.algorithms.EigensolverFactory.get_solver" name="get_solver" signature="abstract get_solver(transformation)">
