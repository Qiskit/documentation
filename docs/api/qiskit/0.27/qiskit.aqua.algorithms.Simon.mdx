...
<Class id="qiskit.aqua.algorithms.Simon" github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/aqua/algorithms/education/simon.py" signature="Simon(oracle, quantum_instance=None)">
  The Simon algorithm.
  ...
  *   **quantum\_instance** (`Union`\[`QuantumInstance`, `Backend`, `BaseBackend`, `None`]) – Quantum Instance or Backend
  ...
  <Function id="qiskit.aqua.algorithms.Simon.__init__" name="__init__" signature="__init__(oracle, quantum_instance=None)">
    **Parameters**
  ...
  <Function id="qiskit.aqua.algorithms.Simon.backend" name="backend" signature="property backend">
    Returns backend.
  ...
  <Function id="qiskit.aqua.algorithms.Simon.construct_circuit" name="construct_circuit" signature="construct_circuit(measurement=False)">
  ...
  <Function id="qiskit.aqua.algorithms.Simon.quantum_instance" name="quantum_instance" signature="property quantum_instance">
  ...
  <Function id="qiskit.aqua.algorithms.Simon.random" name="random" signature="property random">
    Return a numpy random.
  </Function>

  ### run

  <Function id="qiskit.aqua.algorithms.Simon.run" name="run" signature="run(quantum_instance=None, **kwargs)">
  ...
  <Function id="qiskit.aqua.algorithms.Simon.set_backend" name="set_backend" signature="set_backend(backend, **kwargs)">
