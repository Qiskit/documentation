...
<Class id="qiskit.optimization.algorithms.GroverOptimizer" github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/optimization/algorithms/grover_optimizer.py" signature="GroverOptimizer(num_value_qubits, num_iterations=3, quantum_instance=None, converters=None, penalty=None)">
  ...
  **TypeError** – When there one of converters is an invalid type.
  ...
  <Function id="qiskit.optimization.algorithms.GroverOptimizer.__init__" name="__init__" signature="__init__(num_value_qubits, num_iterations=3, quantum_instance=None, converters=None, penalty=None)">
    **Parameters**
  ...
  <Function id="qiskit.optimization.algorithms.GroverOptimizer.get_compatibility_msg" name="get_compatibility_msg" signature="get_compatibility_msg(problem)">
  ...
  <Function id="qiskit.optimization.algorithms.GroverOptimizer.is_compatible" name="is_compatible" signature="is_compatible(problem)">
  ...
  <Function id="qiskit.optimization.algorithms.GroverOptimizer.quantum_instance" name="quantum_instance" signature="property quantum_instance">
  ...
  <Function id="qiskit.optimization.algorithms.GroverOptimizer.solve" name="solve" signature="solve(problem)">
