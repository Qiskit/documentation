...
$$
  ...
  **ValueError** – If the number of evaluation qubits is smaller than 1.
  ...
  <Function id="qiskit.algorithms.AmplitudeEstimation.__init__" signature="__init__(num_eval_qubits, phase_estimation_circuit=None, iqft=None, quantum_instance=None)">
    **Parameters**
  ...
  <Function id="qiskit.algorithms.AmplitudeEstimation.compute_confidence_interval" signature="static compute_confidence_interval(result, alpha=0.05, kind='likelihood_ratio')">
  ...
  <Function id="qiskit.algorithms.AmplitudeEstimation.compute_mle" signature="static compute_mle(result, apply_post_processing=False)">
  ...
  <Function id="qiskit.algorithms.AmplitudeEstimation.quantum_instance" signature="property quantum_instance">
