...
<Class id="qiskit.algorithms.AmplitudeEstimation" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.17/qiskit/algorithms/amplitude_estimators/ae.py" signature="AmplitudeEstimation(num_eval_qubits, phase_estimation_circuit=None, iqft=None, quantum_instance=None)">
...
$$
  ...
  **ValueError** – If the number of evaluation qubits is smaller than 1.
  ...
  <Function id="qiskit.algorithms.AmplitudeEstimation.__init__" name="__init__" signature="__init__(num_eval_qubits, phase_estimation_circuit=None, iqft=None, quantum_instance=None)">
    **Parameters**
  ...
  <Function id="qiskit.algorithms.AmplitudeEstimation.compute_confidence_interval" name="compute_confidence_interval" signature="static compute_confidence_interval(result, alpha=0.05, kind='likelihood_ratio')">
  ...
  <Function id="qiskit.algorithms.AmplitudeEstimation.compute_mle" name="compute_mle" signature="static compute_mle(result, apply_post_processing=False)">
  ...
  <Function id="qiskit.algorithms.AmplitudeEstimation.construct_circuit" name="construct_circuit" signature="construct_circuit(estimation_problem, measurement=False)">
  ...
  <Function id="qiskit.algorithms.AmplitudeEstimation.estimate" name="estimate" signature="estimate(estimation_problem)">
  ...
  <Function id="qiskit.algorithms.AmplitudeEstimation.evaluate_measurements" name="evaluate_measurements" signature="evaluate_measurements(circuit_results, threshold=1e-06)">
  ...
  <Function id="qiskit.algorithms.AmplitudeEstimation.quantum_instance" name="quantum_instance" signature="property quantum_instance">
