...
`random_stabilizer_table(num_qubits, size=1, seed=None)` [GitHub](https://github.com/qiskit/qiskit/tree/stable/0.17/qiskit/quantum_info/operators/symplectic/random.py "view source code")
