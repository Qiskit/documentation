---
title: pad (v0.27)
description: API reference for qiskit.pulse.transforms.pad in qiskit v0.27
...
<Function id="qiskit.pulse.transforms.pad" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.17/qiskit/pulse/transforms/alignments.py" signature="pad(schedule, channels=None, until=None, inplace=False)">
