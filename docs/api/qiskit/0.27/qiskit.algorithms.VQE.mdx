...
<Class id="qiskit.algorithms.VQE" github="https://github.com/qiskit/qiskit/tree/stable/0.17/qiskit/algorithms/minimum_eigen_solvers/vqe.py" signature="VQE(ansatz=None, optimizer=None, initial_point=None, gradient=None, expectation=None, include_custom=False, max_evals_grouped=1, callback=None, quantum_instance=None)">
  ...
  *   **quantum\_instance** (`Union`\[`QuantumInstance`, `BaseBackend`, `Backend`, `None`]) – Quantum Instance or Backend
  ...
  <Function id="qiskit.algorithms.VQE.__init__" name="__init__" signature="__init__(ansatz=None, optimizer=None, initial_point=None, gradient=None, expectation=None, include_custom=False, max_evals_grouped=1, callback=None, quantum_instance=None)">
    **Parameters**
  ...
  <Function id="qiskit.algorithms.VQE.ansatz" name="ansatz" signature="property ansatz">
    Returns the ansatz
  ...
  <Function id="qiskit.algorithms.VQE.cleanup_parameterized_circuits" name="cleanup_parameterized_circuits" signature="cleanup_parameterized_circuits()">
    set parameterized circuits to None
  </Function>

  ### compute\_minimum\_eigenvalue

  <Function id="qiskit.algorithms.VQE.compute_minimum_eigenvalue" name="compute_minimum_eigenvalue" signature="compute_minimum_eigenvalue(operator, aux_operators=None)">
  ...
  <Function id="qiskit.algorithms.VQE.construct_circuit" name="construct_circuit" signature="construct_circuit(parameter, operator)">
  ...
  <Function id="qiskit.algorithms.VQE.construct_expectation" name="construct_expectation" signature="construct_expectation(parameter, operator)">
  ...
  <Function id="qiskit.algorithms.VQE.expectation" name="expectation" signature="property expectation">
  ...
  <Function id="qiskit.algorithms.VQE.find_minimum" name="find_minimum" signature="find_minimum(initial_point=None, ansatz=None, cost_fn=None, optimizer=None, gradient_fn=None)">
  ...
  <Function id="qiskit.algorithms.VQE.get_optimal_circuit" name="get_optimal_circuit" signature="get_optimal_circuit()">
  ...
  <Function id="qiskit.algorithms.VQE.get_optimal_cost" name="get_optimal_cost" signature="get_optimal_cost()">
  ...
  <Function id="qiskit.algorithms.VQE.get_optimal_vector" name="get_optimal_vector" signature="get_optimal_vector()">
  ...
  <Function id="qiskit.algorithms.VQE.get_prob_vector_for_params" name="get_prob_vector_for_params" signature="get_prob_vector_for_params(construct_circuit_fn, params_s, quantum_instance, construct_circuit_args=None)">
    Helper function to get probability vectors for a set of params
  </Function>

  ### get\_probabilities\_for\_counts

  <Function id="qiskit.algorithms.VQE.get_probabilities_for_counts" name="get_probabilities_for_counts" signature="get_probabilities_for_counts(counts)">
    get probabilities for counts
  </Function>

  ### initial\_point

  <Function id="qiskit.algorithms.VQE.initial_point" name="initial_point" signature="property initial_point">
  ...
  <Function id="qiskit.algorithms.VQE.optimal_params" name="optimal_params" signature="property optimal_params">
  ...
  <Function id="qiskit.algorithms.VQE.optimizer" name="optimizer" signature="property optimizer">
    Returns optimizer
  ...
  <Function id="qiskit.algorithms.VQE.print_settings" name="print_settings" signature="print_settings()">
  ...
  <Function id="qiskit.algorithms.VQE.quantum_instance" name="quantum_instance" signature="property quantum_instance">
  ...
  <Function id="qiskit.algorithms.VQE.setting" name="setting" signature="property setting">
    Prepare the setting of VQE as a string.
  </Function>

  ### supports\_aux\_operators

  <Function id="qiskit.algorithms.VQE.supports_aux_operators" name="supports_aux_operators" signature="classmethod supports_aux_operators()">
