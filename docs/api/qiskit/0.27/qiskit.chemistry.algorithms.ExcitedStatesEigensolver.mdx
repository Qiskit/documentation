...
<Class id="qiskit.chemistry.algorithms.ExcitedStatesEigensolver" github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/chemistry/algorithms/excited_states_solvers/excited_states_eigensolver.py" signature="ExcitedStatesEigensolver(transformation, solver)">
