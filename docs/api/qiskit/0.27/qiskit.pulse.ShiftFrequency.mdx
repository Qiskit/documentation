...
<Class id="qiskit.pulse.ShiftFrequency" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.17/qiskit/pulse/instructions/frequency.py" signature="ShiftFrequency(frequency, channel, name=None)" modifiers="class">
  ...
  *   **name** (`Optional`\[`str`]) – Name of this set channel frequency instruction.
  ...
  <Function id="qiskit.pulse.ShiftFrequency.channel" signature="channel" modifiers="property">
  ...
  <Function id="qiskit.pulse.ShiftFrequency.channels" signature="channels" modifiers="property">
  ...
  <Function id="qiskit.pulse.ShiftFrequency.duration" signature="duration" modifiers="property">
  ...
  <Function id="qiskit.pulse.ShiftFrequency.frequency" signature="frequency" modifiers="property">
  ...
  <Function id="qiskit.pulse.ShiftFrequency.id" signature="id" modifiers="property">
  ...
  <Function id="qiskit.pulse.ShiftFrequency.instructions" signature="instructions" modifiers="property">
  ...
  <Function id="qiskit.pulse.ShiftFrequency.is_parameterized" signature="is_parameterized()">
  ...
  <Function id="qiskit.pulse.ShiftFrequency.name" signature="name" modifiers="property">
  ...
  <Function id="qiskit.pulse.ShiftFrequency.operands" signature="operands" modifiers="property">
  ...
  <Function id="qiskit.pulse.ShiftFrequency.parameters" signature="parameters" modifiers="property">
  ...
  <Function id="qiskit.pulse.ShiftFrequency.start_time" signature="start_time" modifiers="property">
  ...
  <Function id="qiskit.pulse.ShiftFrequency.stop_time" signature="stop_time" modifiers="property">
