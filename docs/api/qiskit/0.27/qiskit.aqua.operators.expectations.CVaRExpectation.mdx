---
title: CVaRExpectation (v0.27)
description: API reference for qiskit.aqua.operators.expectations.CVaRExpectation in qiskit v0.27
...
<Class id="qiskit.aqua.operators.expectations.CVaRExpectation" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/aqua/operators/expectations/cvar_expectation.py" signature="CVaRExpectation(alpha, expectation=None)" modifiers="class">
  ...
  **NotImplementedError** – If the `expectation` is an AerPauliExpecation.
  ...
  <Function id="qiskit.aqua.operators.expectations.CVaRExpectation.__init__" signature="__init__(alpha, expectation=None)">
    **Parameters**
  ...
  <Function id="qiskit.aqua.operators.expectations.CVaRExpectation.compute_variance" signature="compute_variance(exp_op)">
  ...
  <Function id="qiskit.aqua.operators.expectations.CVaRExpectation.convert" signature="convert(operator)">
