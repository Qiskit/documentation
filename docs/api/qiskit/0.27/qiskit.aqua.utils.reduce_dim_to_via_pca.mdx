...
<Function id="qiskit.aqua.utils.reduce_dim_to_via_pca" name="reduce_dim_to_via_pca" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/aqua/utils/dataset_helper.py" signature="reduce_dim_to_via_pca(x, dim)">
