...
<Class id="qiskit.aqua.algorithms.Shor" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/aqua/algorithms/factorizers/shor.py" signature="Shor(N=15, a=2, quantum_instance=None)">
  ...
  *   **quantum\_instance** (`Union`\[`QuantumInstance`, `Backend`, `BaseBackend`, `None`]) –
  ...
  <Function id="qiskit.aqua.algorithms.Shor.__init__" name="__init__" signature="__init__(N=15, a=2, quantum_instance=None)">
    **Parameters**
  ...
  <Function id="qiskit.aqua.algorithms.Shor.backend" name="backend" signature="property backend">
    Returns backend.
  ...
  <Function id="qiskit.aqua.algorithms.Shor.construct_circuit" name="construct_circuit" signature="construct_circuit(measurement=False)">
    Construct circuit.
  ...
  <Function id="qiskit.aqua.algorithms.Shor.modinv" name="modinv" signature="static modinv(a, m)">
  ...
  <Function id="qiskit.aqua.algorithms.Shor.quantum_instance" name="quantum_instance" signature="property quantum_instance">
  ...
  <Function id="qiskit.aqua.algorithms.Shor.random" name="random" signature="property random">
    Return a numpy random.
  </Function>

  ### run

  <Function id="qiskit.aqua.algorithms.Shor.run" name="run" signature="run(quantum_instance=None, **kwargs)">
  ...
  <Function id="qiskit.aqua.algorithms.Shor.set_backend" name="set_backend" signature="set_backend(backend, **kwargs)">
