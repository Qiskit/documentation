...
`OR(num_variable_qubits, flags=None, mcx_mode='noancilla')`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.17/qiskit/circuit/library/boolean_logic/quantum_or.py "view source code")
...
![../\_images/qiskit.circuit.library.OR\_0\_1.png](/images/api/qiskit/0.27/qiskit.circuit.library.OR_0_1.png)
...
![../\_images/qiskit.circuit.library.OR\_1\_1.png](/images/api/qiskit/0.27/qiskit.circuit.library.OR_1_1.png)
...
| [`compose`](#qiskit.circuit.library.OR.compose "qiskit.circuit.library.OR.compose")(other\[, qubits, clbits, front, inplace])                                                 | Compose circuit with `other` circuit or instruction, optionally permuting wires.                                                    |
...
| [`pauli`](#qiskit.circuit.library.OR.pauli "qiskit.circuit.library.OR.pauli")(pauli\_string, qubits)                                                                          | Apply `PauliGate`.                                                                                                                  |
...
| [`qasm`](#qiskit.circuit.library.OR.qasm "qiskit.circuit.library.OR.qasm")(\[formatted, filename])                                                                            | Return OpenQASM string.                                                                                                             |
...
| [`to_instruction`](#qiskit.circuit.library.OR.to_instruction "qiskit.circuit.library.OR.to_instruction")(\[parameter\_map])                                                   | Create an Instruction out of this circuit.                                                                                          |
...
![../\_images/qiskit.circuit.library.OR\_4\_0.png](/images/api/qiskit/0.27/qiskit.circuit.library.OR_4_0.png) ![../\_images/qiskit.circuit.library.OR\_4\_1.png](/images/api/qiskit/0.27/qiskit.circuit.library.OR_4_1.png)
