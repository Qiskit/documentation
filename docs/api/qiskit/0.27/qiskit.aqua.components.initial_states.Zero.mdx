...
<Class id="qiskit.aqua.components.initial_states.Zero" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/aqua/components/initial_states/zero.py" signature="Zero(num_qubits)">
  ...
  **num\_qubits** (`int`) – Number of qubits, has a minimum value of 1.
  ...
  <Function id="qiskit.aqua.components.initial_states.Zero.__init__" name="__init__" signature="__init__(num_qubits)">
    **Parameters**
  ...
  <Function id="qiskit.aqua.components.initial_states.Zero.bitstr" name="bitstr" signature="property bitstr" />

  ### construct\_circuit

  <Function id="qiskit.aqua.components.initial_states.Zero.construct_circuit" name="construct_circuit" signature="construct_circuit(mode='circuit', register=None)">
