...
<Class id="qiskit.ignis.verification.AccreditationFitter" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-ignis/tree/stable/0.6/qiskit/ignis/verification/accreditation/fitters.py" signature="AccreditationFitter">
  ...
  <Function id="qiskit.ignis.verification.AccreditationFitter.__init__" name="__init__" signature="__init__()">
  ...
  <Function id="qiskit.ignis.verification.AccreditationFitter.bound_variation_distance" name="bound_variation_distance" signature="bound_variation_distance(theta)">
  ...
  <Function id="qiskit.ignis.verification.AccreditationFitter.single_protocol_run" name="single_protocol_run" signature="single_protocol_run(results, postp_list, v_zero)">
