...
<Class id="qiskit.transpiler.CouplingMap" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.17/qiskit/transpiler/coupling.py" signature="CouplingMap(couplinglist=None, description=None)">
  ...
  *   **description** (*str*) – A string to describe the coupling map.
  ...
  <Function id="qiskit.transpiler.CouplingMap.distance_matrix" signature="property distance_matrix">
  ...
  <Function id="qiskit.transpiler.CouplingMap.is_symmetric" signature="property is_symmetric">
  ...
  <Function id="qiskit.transpiler.CouplingMap.physical_qubits" signature="property physical_qubits">
