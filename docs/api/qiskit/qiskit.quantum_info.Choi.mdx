...
<Class id="qiskit.quantum_info.Choi" github="https://github.com/Qiskit/qiskit/tree/stable/1.0/qiskit/quantum_info/operators/channel/choi.py#L34-L213" signature="qiskit.quantum_info.Choi(data, input_dims=None, output_dims=None)">
