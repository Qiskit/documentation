...
<Class id="qiskit.transpiler.passes.AlignMeasures" github="https://github.com/Qiskit/qiskit/tree/stable/1.0/qiskit/transpiler/passes/scheduling/alignments/align_measures.py#L32-L208" signature="qiskit.transpiler.passes.AlignMeasures(*args, **kwargs)">
