...
$$
  ...
  *   **name** ([*str*](https://docs.python.org/3/library/stdtypes.html#str)) – The name of the circuit.
  ...
  <Attribute id="qiskit.circuit.library.PiecewisePolynomialPauliRotations.breakpoints" name="breakpoints" headingLevel={3}>
  ...
  <Attribute id="qiskit.circuit.library.PiecewisePolynomialPauliRotations.coeffs" name="coeffs" headingLevel={3}>
  ...
  <Attribute id="qiskit.circuit.library.PiecewisePolynomialPauliRotations.contains_zero_breakpoint" name="contains_zero_breakpoint" headingLevel={3}>
  ...
  <Attribute id="qiskit.circuit.library.PiecewisePolynomialPauliRotations.mapped_coeffs" name="mapped_coeffs" headingLevel={3}>
  ...
  <Attribute id="qiskit.circuit.library.PiecewisePolynomialPauliRotations.name" name="name" headingLevel={3}>
  ...
  <Function id="qiskit.circuit.library.PiecewisePolynomialPauliRotations.evaluate" github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/circuit/library/arithmetic/piecewise_polynomial_pauli_rotations.py#L210-L224" signature="evaluate(x)">
