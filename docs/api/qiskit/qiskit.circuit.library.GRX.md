...
`qiskit.circuit.library.GRX(num_qubits, theta)`
...
*   **theta** ([*float*](https://docs.python.org/3/library/functions.html#float "(in Python v3.11)")) – rotation angle about x-axis
