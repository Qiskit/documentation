---
title: timeline_drawer (latest version)
description: API reference for qiskit.visualization.timeline_drawer in the latest version of qiskit
...
<Function id="qiskit.visualization.timeline_drawer" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.3/qiskit/visualization/timeline/interface.py#L33-L439" signature="qiskit.visualization.timeline_drawer(program, style=None, time_range=None, disable_bits=None, show_clbits=None, idle_wires=None, plot_barriers=None, show_delays=None, show_labels=True, plotter='mpl', axis=None, filename=None, target=None, *, show_idle=None, show_barriers=None)">
  ...
  *   **program** ([*QuantumCircuit*](circuit-quantum-circuit "qiskit.circuit.quantumcircuit.QuantumCircuit")) – Program to visualize. This program should be a QuantumCircuit which is transpiled with a scheduling\_method, thus containing gate time information.
  ...
  *   **target** ([*Target*](transpiler-target "qiskit.transpiler.target.Target") *| None*) – The target for the backend the timeline is being generated for.
  ...
  *   **program** ([*QuantumCircuit*](circuit-quantum-circuit "qiskit.circuit.quantumcircuit.QuantumCircuit")) –
  ...
  *   **target** ([*Target*](transpiler-target "qiskit.transpiler.target.Target") *| None*) –
  ...
  **Examples**
  ...
  ![Output from the previous code.](/images/api/qiskit/qiskit-visualization-timeline_drawer-1.avif)
  ...
  ![Output from the previous code.](/images/api/qiskit/qiskit-visualization-timeline_drawer-2.avif)
  ...
  ![Output from the previous code.](/images/api/qiskit/qiskit-visualization-timeline_drawer-3.avif)
