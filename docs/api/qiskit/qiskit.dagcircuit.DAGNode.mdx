...
<Class id="qiskit.dagcircuit.DAGNode" isDedicatedPage={true} signature="qiskit.dagcircuit.DAGNode" modifiers="class">
  ...
  <Function id="qiskit.dagcircuit.DAGNode.semantic_eq" github="https://github.com/Qiskit/qiskit/tree/stable/1.2/qiskit/dagcircuit/dagnode.py#L181-L237" signature="semantic_eq(node1, node2, bit_indices1, bit_indices2)" modifiers="static">
