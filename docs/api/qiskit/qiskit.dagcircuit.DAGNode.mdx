...
<Class id="qiskit.dagcircuit.DAGNode" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.0/qiskit/dagcircuit/dagnode.py#L170-L247" signature="qiskit.dagcircuit.DAGNode(nid=-1)">
  ...
  <Function id="qiskit.dagcircuit.DAGNode.semantic_eq" github="https://github.com/Qiskit/qiskit/tree/stable/1.0/qiskit/dagcircuit/dagnode.py#L190-L247" signature="static semantic_eq(node1, node2, bit_indices1, bit_indices2)">
