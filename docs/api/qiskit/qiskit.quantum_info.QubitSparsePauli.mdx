...
<Class id="qiskit.quantum_info.QubitSparsePauli" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/quantum_info/__init__.py" signature="qiskit.quantum_info.QubitSparsePauli(data, /, num_qubits=None)" modifiers="class">
  ...
  <Class id="qiskit.quantum_info.QubitSparsePauli.Pauli" github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/quantum_info/__init__.py" signature="Pauli" modifiers="class">
    ...
    <Attribute id="qiskit.quantum_info.QubitSparsePauli.Pauli.X" name="X" headingLevel={5}>
      <AttributeTypeHint>= 2</AttributeTypeHint>

      The Pauli $X$ operator. Uses the single-letter label `"X"`.
    </Attribute>

    <Attribute id="qiskit.quantum_info.QubitSparsePauli.Pauli.Y" name="Y" headingLevel={5}>
      <AttributeTypeHint>= 3</AttributeTypeHint>

      The Pauli $Y$ operator. Uses the single-letter label `"Y"`.
    </Attribute>

    <Attribute id="qiskit.quantum_info.QubitSparsePauli.Pauli.Z" name="Z" headingLevel={5}>
  ...
  <Attribute id="qiskit.quantum_info.QubitSparsePauli.indices" name="indices" headingLevel={3}>
    Read-only view onto the indices of each non-identity single-qubit term.

    The indices will always be in sorted order.
  </Attribute>

  <Attribute id="qiskit.quantum_info.QubitSparsePauli.num_qubits" name="num_qubits" headingLevel={3}>
    The number of qubits the term is defined on.
  </Attribute>

  <Attribute id="qiskit.quantum_info.QubitSparsePauli.paulis" name="paulis" headingLevel={3}>
