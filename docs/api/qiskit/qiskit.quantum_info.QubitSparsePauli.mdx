...
<Class id="qiskit.quantum_info.QubitSparsePauli" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/2.4/qiskit/quantum_info/__init__.py" signature="qiskit.quantum_info.QubitSparsePauli(data, /, num_qubits=None)" modifiers="class">
  ...
  <Class id="qiskit.quantum_info.QubitSparsePauli.Pauli" github="https://github.com/Qiskit/qiskit/tree/stable/2.4/qiskit/quantum_info/__init__.py" signature="Pauli" modifiers="class">
