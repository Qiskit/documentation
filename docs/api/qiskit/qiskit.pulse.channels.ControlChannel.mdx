---
title: ControlChannel (latest version)
description: API reference for qiskit.pulse.channels.ControlChannel in the latest version of qiskit
...
<Class id="qiskit.pulse.channels.ControlChannel" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.3/qiskit/pulse/channels.py#L191-L197" signature="qiskit.pulse.channels.ControlChannel(*args, **kwargs)" modifiers="class">
  Bases: `PulseChannel`
  ...
  **index** – Index of channel.
  ...
  <Function id="qiskit.pulse.channels.ControlChannel.is_parameterized" github="https://github.com/Qiskit/qiskit/tree/stable/1.3/qiskit/pulse/channels.py#L137-L139" signature="is_parameterized()">
