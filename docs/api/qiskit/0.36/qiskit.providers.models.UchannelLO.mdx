...
<Class id="qiskit.providers.models.UchannelLO" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.20/qiskit/providers/models/backendconfiguration.py" signature="UchannelLO(q, scale)">
  Bases: `object`
