...
<Function id="qiskit.ignis.characterization.update_u_gates" github="https://github.com/qiskit-community/qiskit-ignis/tree/stable/0.7/qiskit/ignis/characterization/calibrations/ibmq_utils.py" signature="update_u_gates(drag_params, pi2_pulse_schedules=None, qubits=None, inst_map=None, drives=None)">
