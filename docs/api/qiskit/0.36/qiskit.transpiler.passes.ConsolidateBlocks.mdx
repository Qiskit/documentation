---
title: ConsolidateBlocks (v0.36)
description: API reference for qiskit.transpiler.passes.ConsolidateBlocks in qiskit v0.36
...
<Class id="qiskit.transpiler.passes.ConsolidateBlocks" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.20/qiskit/transpiler/passes/optimization/consolidate_blocks.py" signature="ConsolidateBlocks(*args, **kwargs)" modifiers="class">
