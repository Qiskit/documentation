...
<Class id="qiskit.providers.ibmq.managed.ManagedJob" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-ibmq-provider/tree/stable/0.19/qiskit/providers/ibmq/managed/managedjob.py" signature="ManagedJob(start_index, experiments_count, job=None)">
  Bases: `object`
  ...
  *   **job** (`Optional`\[`IBMQJob`]) – Job to be managed, or `None` if not already known.
  ...
  <Function id="qiskit.providers.ibmq.managed.ManagedJob.cancel" name="cancel" signature="ManagedJob.cancel()">
  ...
  <Function id="qiskit.providers.ibmq.managed.ManagedJob.error_message" name="error_message" signature="ManagedJob.error_message()">
  ...
  <Function id="qiskit.providers.ibmq.managed.ManagedJob.qobj" name="qobj" signature="ManagedJob.qobj()">
  ...
  <Function id="qiskit.providers.ibmq.managed.ManagedJob.result" name="result" signature="ManagedJob.result(timeout=None, partial=False, refresh=False)">
  ...
  <Function id="qiskit.providers.ibmq.managed.ManagedJob.status" name="status" signature="ManagedJob.status()">
  ...
  <Function id="qiskit.providers.ibmq.managed.ManagedJob.submit" name="submit" signature="ManagedJob.submit(circuits, job_name, backend, executor, submit_lock, job_share_level=None, job_tags=None, **run_config)">
    Submit the job.
