...
<Class id="qiskit.pulse.library.Drag" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.20/qiskit/pulse/library/parametric_pulses.py" signature="Drag(duration, amp, sigma, beta, name=None, limit_amplitude=None)">
...
$$
  ...
  *   **limit\_amplitude** (`Optional`\[`bool`]) – If `True`, then limit the amplitude of the waveform to 1. The default is `True` and the amplitude is constrained to 1.
  ...
  <Attribute id="qiskit.pulse.library.Drag.amp" name="amp">
  ...
  <Attribute id="qiskit.pulse.library.Drag.beta" name="beta">
  ...
  <Attribute id="qiskit.pulse.library.Drag.sigma" name="sigma">
