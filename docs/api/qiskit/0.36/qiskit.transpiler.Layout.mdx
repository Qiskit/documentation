---
title: Layout (v0.36)
description: API reference for qiskit.transpiler.Layout in qiskit v0.36
...
<Class id="qiskit.transpiler.Layout" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.20/qiskit/transpiler/layout.py" signature="Layout(input_dict=None)" modifiers="class">
  Bases: `object`
