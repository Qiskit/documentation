...
`Reset` [GitHub](https://github.com/qiskit/qiskit/tree/stable/0.20/qiskit/circuit/reset.py "view source code")
...
`Reset.broadcast_arguments(qargs, cargs)` [GitHub](https://github.com/qiskit/qiskit/tree/stable/0.20/qiskit/circuit/reset.py "view source code")
...
<span id="qiskit.circuit.Reset.name" />

### name

Return the name.

<span id="qiskit.circuit.Reset.num_clbits" />

### num\_clbits

Return the number of clbits.

<span id="qiskit.circuit.Reset.num_qubits" />
