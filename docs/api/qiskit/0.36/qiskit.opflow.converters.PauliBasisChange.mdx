...
<Class id="qiskit.opflow.converters.PauliBasisChange" github="https://github.com/qiskit/qiskit/tree/stable/0.20/qiskit/opflow/converters/pauli_basis_change.py" signature="PauliBasisChange(destination_basis=None, traverse=True, replacement_fn=None)">
