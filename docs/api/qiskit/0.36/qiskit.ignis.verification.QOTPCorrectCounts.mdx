...
<Function id="qiskit.ignis.verification.QOTPCorrectCounts" github="https://github.com/qiskit-community/qiskit-ignis/tree/stable/0.7/qiskit/ignis/verification/accreditation/qotp.py" signature="QOTPCorrectCounts(qotp_counts, qotp_postp)">
