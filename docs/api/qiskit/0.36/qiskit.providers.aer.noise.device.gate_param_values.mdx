---
title: gate_param_values (v0.36)
description: API reference for qiskit.providers.aer.noise.device.gate_param_values in qiskit v0.36
...
<Function id="qiskit.providers.aer.noise.device.gate_param_values" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-aer/tree/stable/0.10/qiskit/providers/aer/noise/device/parameters.py" signature="gate_param_values(properties)">
