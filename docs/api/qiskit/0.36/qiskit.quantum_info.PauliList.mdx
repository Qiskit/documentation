---
title: PauliList (v0.36)
description: API reference for qiskit.quantum_info.PauliList in qiskit v0.36
...
<Class id="qiskit.quantum_info.PauliList" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.20/qiskit/quantum_info/operators/symplectic/pauli_list.py" signature="PauliList(data)" modifiers="class">
