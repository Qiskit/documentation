...
<Class id="qiskit.primitives.SamplerResult" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.20/qiskit/primitives/sampler_result.py" signature="SamplerResult(quasi_dists, metadata)">
  Bases: `object`
