...
<Class id="qiskit.circuit.library.GRX" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.20/qiskit/circuit/library/generalized_gates/gr.py" signature="GRX(num_qubits, theta)">
