---
title: MCMT (v0.36)
description: API reference for qiskit.circuit.library.MCMT in qiskit v0.36
...
<Class id="qiskit.circuit.library.MCMT" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.20/qiskit/circuit/library/generalized_gates/mcmt.py" signature="MCMT(gate, num_ctrl_qubits, num_target_qubits, label=None)" modifiers="class">
