---
title: inline_subroutines (v0.36)
description: API reference for qiskit.pulse.transforms.inline_subroutines in qiskit v0.36
...
<Function id="qiskit.pulse.transforms.inline_subroutines" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.20/qiskit/pulse/transforms/canonicalization.py" signature="inline_subroutines(program)">
