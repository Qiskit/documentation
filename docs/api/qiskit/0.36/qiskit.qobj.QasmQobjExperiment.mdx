---
title: QasmQobjExperiment (v0.36)
description: API reference for qiskit.qobj.QasmQobjExperiment in qiskit v0.36
...
<Class id="qiskit.qobj.QasmQobjExperiment" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.20/qiskit/qobj/qasm_qobj.py" signature="QasmQobjExperiment(config=None, header=None, instructions=None)" modifiers="class">
  Bases: `object`
