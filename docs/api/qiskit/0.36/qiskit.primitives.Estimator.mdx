...
<Class id="qiskit.primitives.Estimator" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.20/qiskit/primitives/estimator.py" signature="Estimator(circuits, observables, parameters=None)">
