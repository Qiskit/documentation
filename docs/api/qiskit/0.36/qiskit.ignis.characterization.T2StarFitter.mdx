---
title: T2StarFitter (v0.36)
description: API reference for qiskit.ignis.characterization.T2StarFitter in qiskit v0.36
...
$$
  ...
  *   **time\_unit** (`str`) – unit of delay times in xdata.
  ...
  <span id="qiskit-ignis-characterization-t2starfitter-add-data" />
  ...
  <span id="qiskit-ignis-characterization-t2starfitter-fit-data" />
  ...
  <span id="qiskit-ignis-characterization-t2starfitter-guess-params" />
  ...
  <span id="qiskit-ignis-characterization-t2starfitter-time-err" />
