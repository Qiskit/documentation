---
title: RabiFitter (v0.36)
description: API reference for qiskit.ignis.characterization.RabiFitter in qiskit v0.36
...
<Class id="qiskit.ignis.characterization.RabiFitter" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-ignis/tree/stable/0.7/qiskit/ignis/characterization/calibrations/fitters.py" signature="RabiFitter(backend_result, xdata, qubits, fit_p0, fit_bounds=None)" modifiers="class">
  ...
  <span id="qiskit-ignis-characterization-rabifitter-add-data" />
  ...
  <span id="qiskit-ignis-characterization-rabifitter-fit-data" />
  ...
  <span id="qiskit-ignis-characterization-rabifitter-guess-params" />
  ...
  <span id="qiskit-ignis-characterization-rabifitter-pi2-amplitude" />
  ...
  <span id="qiskit-ignis-characterization-rabifitter-pi-amplitude" />
