---
title: Operator (v0.36)
description: API reference for qiskit.quantum_info.Operator in qiskit v0.36
...
<Class id="qiskit.quantum_info.Operator" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.20/qiskit/quantum_info/operators/operator.py" signature="Operator(data, input_dims=None, output_dims=None)" modifiers="class">
...
$$
  ...
  **Additional Information:**
  ...
  <Function id="qiskit.quantum_info.Operator.from_circuit" signature="Operator.from_circuit(circuit, ignore_set_layout=False, layout=None)" modifiers="classmethod">
