---
title: MatrixExponential (v0.36)
description: API reference for qiskit.synthesis.MatrixExponential in qiskit v0.36
...
<Class id="qiskit.synthesis.MatrixExponential" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.20/qiskit/synthesis/evolution/matrix_synthesis.py" signature="MatrixExponential" modifiers="class">
  ...
  <Function id="qiskit.synthesis.MatrixExponential.synthesize" signature="MatrixExponential.synthesize(evolution)">
