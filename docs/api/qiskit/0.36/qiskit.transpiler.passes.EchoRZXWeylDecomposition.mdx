...
<Class id="qiskit.transpiler.passes.EchoRZXWeylDecomposition" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.20/qiskit/transpiler/passes/optimization/echo_rzx_weyl_decomposition.py" signature="EchoRZXWeylDecomposition(*args, **kwargs)">
  ...
  **instruction\_schedule\_map** ([*InstructionScheduleMap*](qiskit.pulse.InstructionScheduleMap "qiskit.pulse.InstructionScheduleMap")) – the mapping from circuit [`Instruction`](qiskit.circuit.Instruction "qiskit.circuit.Instruction") names and arguments to [`Schedule`](qiskit.pulse.Schedule "qiskit.pulse.Schedule")s.
  ...
  <Function id="qiskit.transpiler.passes.EchoRZXWeylDecomposition.name" name="name" signature="EchoRZXWeylDecomposition.name()">
    Return the name of the pass.
  </Function>

  ### run

  <Function id="qiskit.transpiler.passes.EchoRZXWeylDecomposition.run" name="run" signature="EchoRZXWeylDecomposition.run(dag)">
  ...
  <Attribute id="qiskit.transpiler.passes.EchoRZXWeylDecomposition.is_analysis_pass" name="is_analysis_pass">
  ...
  <Attribute id="qiskit.transpiler.passes.EchoRZXWeylDecomposition.is_transformation_pass" name="is_transformation_pass">
