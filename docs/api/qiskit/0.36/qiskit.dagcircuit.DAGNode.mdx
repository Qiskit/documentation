...
<Class id="qiskit.dagcircuit.DAGNode" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.20/qiskit/dagcircuit/dagnode.py" signature="DAGNode(type=None, op=None, name=None, qargs=None, cargs=None, wire=None, nid=- 1)">
  Bases: `object`
  ...
  <Function id="qiskit.dagcircuit.DAGNode.semantic_eq" name="semantic_eq" signature="static DAGNode.semantic_eq(node1, node2, bit_indices1=None, bit_indices2=None)">
