...
<Class id="qiskit.providers.ibmq.runtime.IBMRuntimeService" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-ibmq-provider/tree/stable/0.19/qiskit/providers/ibmq/runtime/ibm_runtime_service.py" signature="IBMRuntimeService(provider)">
  Bases: `object`
  ...
  **provider** (`AccountProvider`) – IBM Quantum account provider.
  ...
  <Function id="qiskit.providers.ibmq.runtime.IBMRuntimeService.delete_job" name="delete_job" signature="IBMRuntimeService.delete_job(job_id)">
  ...
  <Function id="qiskit.providers.ibmq.runtime.IBMRuntimeService.delete_program" name="delete_program" signature="IBMRuntimeService.delete_program(program_id)">
  ...
  <Function id="qiskit.providers.ibmq.runtime.IBMRuntimeService.job" name="job" signature="IBMRuntimeService.job(job_id)">
  ...
  <Function id="qiskit.providers.ibmq.runtime.IBMRuntimeService.jobs" name="jobs" signature="IBMRuntimeService.jobs(limit=10, skip=0, pending=None, program_id=None)">
  ...
  <Function id="qiskit.providers.ibmq.runtime.IBMRuntimeService.logout" name="logout" signature="IBMRuntimeService.logout()">
  ...
  <Function id="qiskit.providers.ibmq.runtime.IBMRuntimeService.pprint_programs" name="pprint_programs" signature="IBMRuntimeService.pprint_programs(refresh=False, detailed=False, limit=20, skip=0)">
  ...
  <Function id="qiskit.providers.ibmq.runtime.IBMRuntimeService.program" name="program" signature="IBMRuntimeService.program(program_id, refresh=False)">
  ...
  <Function id="qiskit.providers.ibmq.runtime.IBMRuntimeService.programs" name="programs" signature="IBMRuntimeService.programs(refresh=False, limit=20, skip=0)">
  ...
  <Function id="qiskit.providers.ibmq.runtime.IBMRuntimeService.run" name="run" signature="IBMRuntimeService.run(program_id, options, inputs, callback=None, result_decoder=None, image='')">
  ...
  <Function id="qiskit.providers.ibmq.runtime.IBMRuntimeService.set_program_visibility" name="set_program_visibility" signature="IBMRuntimeService.set_program_visibility(program_id, public)">
  ...
  <Function id="qiskit.providers.ibmq.runtime.IBMRuntimeService.update_program" name="update_program" signature="IBMRuntimeService.update_program(program_id, data=None, metadata=None, name=None, description=None, max_execution_time=None, spec=None)">
  ...
  <Function id="qiskit.providers.ibmq.runtime.IBMRuntimeService.upload_program" name="upload_program" signature="IBMRuntimeService.upload_program(data, metadata=None)">
