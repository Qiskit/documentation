...
<Class id="qiskit.qobj.QobjMeasurementOption" github="https://github.com/qiskit/qiskit/tree/stable/0.20/qiskit/qobj/pulse_qobj.py" signature="QobjMeasurementOption(name, params=None)">
  Bases: `object`
