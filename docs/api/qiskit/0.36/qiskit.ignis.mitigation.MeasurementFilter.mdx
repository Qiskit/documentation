...
<Class id="qiskit.ignis.mitigation.MeasurementFilter" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-ignis/tree/stable/0.7/qiskit/ignis/mitigation/measurement/filters.py" signature="MeasurementFilter(cal_matrix, state_labels)">
  Bases: `object`
  ...
  *   **state\_labels** (`list`) – the states for the ordering of the cal matrix
  ...
  <Function id="qiskit.ignis.mitigation.MeasurementFilter.apply" name="apply" signature="MeasurementFilter.apply(raw_data, method='least_squares')">
  ...
  <Attribute id="qiskit.ignis.mitigation.MeasurementFilter.cal_matrix" name="cal_matrix">
    Return cal\_matrix.
  </Attribute>

  ### state\_labels

  <Attribute id="qiskit.ignis.mitigation.MeasurementFilter.state_labels" name="state_labels">
