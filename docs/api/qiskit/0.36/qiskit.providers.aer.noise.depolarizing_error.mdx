...
<Function id="qiskit.providers.aer.noise.depolarizing_error" name="depolarizing_error" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-aer/tree/stable/0.10/qiskit/providers/aer/noise/errors/standard_errors.py" signature="depolarizing_error(param, num_qubits, standard_gates=None)">
