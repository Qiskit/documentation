...
<Class id="qiskit.providers.BaseProvider" github="https://github.com/qiskit/qiskit/tree/stable/0.20/qiskit/providers/baseprovider.py" signature="BaseProvider(*args, **kwargs)">
  Bases: `abc.ABC`
