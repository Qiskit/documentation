...
<Function id="qiskit.utils.local_hardware_info" github="https://github.com/qiskit/qiskit/tree/stable/0.20/qiskit/utils/multiprocessing.py" signature="local_hardware_info()">
