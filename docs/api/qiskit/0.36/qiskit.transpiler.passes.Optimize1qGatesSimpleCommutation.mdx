---
title: Optimize1qGatesSimpleCommutation (v0.36)
description: API reference for qiskit.transpiler.passes.Optimize1qGatesSimpleCommutation in qiskit v0.36
...
<Class id="qiskit.transpiler.passes.Optimize1qGatesSimpleCommutation" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.20/qiskit/transpiler/passes/optimization/optimize_1q_commutation.py" signature="Optimize1qGatesSimpleCommutation(*args, **kwargs)" modifiers="class">
