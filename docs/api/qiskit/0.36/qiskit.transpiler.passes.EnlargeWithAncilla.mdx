---
title: EnlargeWithAncilla (v0.36)
description: API reference for qiskit.transpiler.passes.EnlargeWithAncilla in qiskit v0.36
...
<Class id="qiskit.transpiler.passes.EnlargeWithAncilla" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.20/qiskit/transpiler/passes/layout/enlarge_with_ancilla.py" signature="EnlargeWithAncilla(*args, **kwargs)" modifiers="class">
