---
title: StochasticSwap (v0.36)
description: API reference for qiskit.transpiler.passes.StochasticSwap in qiskit v0.36
...
<Class id="qiskit.transpiler.passes.StochasticSwap" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.20/qiskit/transpiler/passes/routing/stochastic_swap.py" signature="StochasticSwap(*args, **kwargs)" modifiers="class">
