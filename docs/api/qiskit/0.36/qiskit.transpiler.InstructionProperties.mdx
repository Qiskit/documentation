---
title: InstructionProperties (v0.36)
description: API reference for qiskit.transpiler.InstructionProperties in qiskit v0.36
...
<Class id="qiskit.transpiler.InstructionProperties" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.20/qiskit/transpiler/target.py" signature="InstructionProperties(duration=None, error=None, calibration=None)" modifiers="class">
  Bases: `object`
