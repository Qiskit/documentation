---
title: TensoredMeasFitter (v0.36)
description: API reference for qiskit.utils.mitigation.TensoredMeasFitter in qiskit v0.36
...
<Class id="qiskit.utils.mitigation.TensoredMeasFitter" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.20/qiskit/utils/mitigation/fitters.py" signature="TensoredMeasFitter(results, mit_pattern, substate_labels_list=None, circlabel='')" modifiers="class">
  Bases: `object`
  ...
  **ValueError** – if the mit\_pattern doesn’t match the substate\_labels\_list
  ...
  <span id="qiskit-utils-mitigation-tensoredmeasfitter-add-data" />
  ...
  <span id="qiskit-utils-mitigation-tensoredmeasfitter-readout-fidelity" />
