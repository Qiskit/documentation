  ...
  *   **name** (`str`) – The name of the object.
  ...
  <Function id="qiskit.algorithms.linear_solvers.LinearSystemMatrix.draw" signature="LinearSystemMatrix.draw(*args, **kwargs)">
    ...
    **Example**
    ...
    ![../\_images/qiskit.algorithms.linear\_solvers.LinearSystemMatrix.draw\_0\_0.png](/images/api/qiskit/0.36/qiskit.algorithms.linear_solvers.LinearSystemMatrix.draw_0_0.avif)
  </Function>
