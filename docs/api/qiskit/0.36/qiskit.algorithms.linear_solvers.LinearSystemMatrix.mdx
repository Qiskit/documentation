---
title: LinearSystemMatrix (v0.36)
description: API reference for qiskit.algorithms.linear_solvers.LinearSystemMatrix in qiskit v0.36
...
<Class id="qiskit.algorithms.linear_solvers.LinearSystemMatrix" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.20/qiskit/algorithms/linear_solvers/matrices/linear_system_matrix.py" signature="LinearSystemMatrix(num_state_qubits, tolerance, evolution_time, name='ls_matrix')" modifiers="class">
  ...
  *   **name** (`str`) – The name of the object.
  ...
  <Function id="qiskit.algorithms.linear_solvers.LinearSystemMatrix.decompose" signature="LinearSystemMatrix.decompose(gates_to_decompose=None)">
  ...
  <Function id="qiskit.algorithms.linear_solvers.LinearSystemMatrix.draw" signature="LinearSystemMatrix.draw(*args, **kwargs)">
    ...
    **Example**
    ...
    ![../\_images/qiskit.algorithms.linear\_solvers.LinearSystemMatrix.draw\_0\_0.png](/docs/images/api/qiskit/0.36/qiskit.algorithms.linear_solvers.LinearSystemMatrix.draw_0_0.avif)
  </Function>
  ...
  <Attribute id="qiskit.algorithms.linear_solvers.LinearSystemMatrix.instances" attributeValue="9" />
