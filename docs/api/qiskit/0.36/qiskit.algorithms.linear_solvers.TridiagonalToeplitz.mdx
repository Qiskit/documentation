---
title: TridiagonalToeplitz (v0.36)
description: API reference for qiskit.algorithms.linear_solvers.TridiagonalToeplitz in qiskit v0.36
  ...
  *   **name** (`str`) – The name of the object.
  ...
  <Function id="qiskit.algorithms.linear_solvers.TridiagonalToeplitz.draw" signature="TridiagonalToeplitz.draw(*args, **kwargs)">
    ...
    **Example**
    ...
    ![../\_images/qiskit.algorithms.linear\_solvers.TridiagonalToeplitz.draw\_0\_0.png](/docs/images/api/qiskit/0.36/qiskit.algorithms.linear_solvers.TridiagonalToeplitz.draw_0_0.avif)
  </Function>
