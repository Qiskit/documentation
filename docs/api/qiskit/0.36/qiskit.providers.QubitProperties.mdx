---
title: QubitProperties (v0.36)
description: API reference for qiskit.providers.QubitProperties in qiskit v0.36
...
<Class id="qiskit.providers.QubitProperties" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.20/qiskit/providers/backend.py" signature="QubitProperties(t1=None, t2=None, frequency=None)" modifiers="class">
  Bases: `object`
