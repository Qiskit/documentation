...
<Class id="qiskit.ignis.mitigation.ExpvalMeasMitigatorFitter" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-ignis/tree/stable/0.7/qiskit/ignis/mitigation/expval/fitter.py" signature="ExpvalMeasMitigatorFitter(result, metadata)">
  Bases: `object`
  ...
  *   **metadata** (`List`\[`Dict`\[`str`, `any`]]) – mitigation generator metadata.
  ...
  <Function id="qiskit.ignis.mitigation.ExpvalMeasMitigatorFitter.fit" name="fit" signature="ExpvalMeasMitigatorFitter.fit(method=None, generators=None)">
  ...
  <Attribute id="qiskit.ignis.mitigation.ExpvalMeasMitigatorFitter.mitigator" name="mitigator">
