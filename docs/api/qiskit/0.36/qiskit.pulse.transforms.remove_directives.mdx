...
<Function id="qiskit.pulse.transforms.remove_directives" name="remove_directives" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.20/qiskit/pulse/transforms/canonicalization.py" signature="remove_directives(schedule)">
  Remove directives.
