...
<Class id="qiskit.providers.basicaer.BasicAerError" github="https://github.com/qiskit/qiskit/tree/stable/0.20/qiskit/providers/basicaer/exceptions.py" signature="BasicAerError(*message)">
