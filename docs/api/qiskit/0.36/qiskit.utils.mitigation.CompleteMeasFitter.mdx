...
<Class id="qiskit.utils.mitigation.CompleteMeasFitter" github="https://github.com/qiskit/qiskit/tree/stable/0.20/qiskit/utils/mitigation/fitters.py" signature="CompleteMeasFitter(results, state_labels, qubit_list=None, circlabel='')">
  Bases: `object`
  ...
  *   **circlabel** (`str`) – if the qubits were labeled.
  ...
  <Function id="qiskit.utils.mitigation.CompleteMeasFitter.subset_fitter" name="subset_fitter" signature="CompleteMeasFitter.subset_fitter(qubit_sublist=None)">
