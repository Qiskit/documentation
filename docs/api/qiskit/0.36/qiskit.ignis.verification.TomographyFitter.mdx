...
<Class id="qiskit.ignis.verification.TomographyFitter" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-ignis/tree/stable/0.7/qiskit/ignis/verification/tomography/fitters/base_fitter.py" signature="TomographyFitter(result, circuits, meas_basis='Pauli', prep_basis='Pauli')">
  Bases: `object`
  ...
  *   **prep\_basis** (`Union`\[`TomographyBasis`, `str`]) – (default: ‘Pauli’) A function to return preparation operators. See Additional Information
  ...
  <Function id="qiskit.ignis.verification.TomographyFitter.add_data" name="add_data" signature="TomographyFitter.add_data(results, circuits)">
  ...
  <Function id="qiskit.ignis.verification.TomographyFitter.fit" name="fit" signature="TomographyFitter.fit(method='auto', standard_weights=True, beta=0.5, psd=True, trace=None, trace_preserving=False, **kwargs)">
  ...
  <Function id="qiskit.ignis.verification.TomographyFitter.set_measure_basis" name="set_measure_basis" signature="TomographyFitter.set_measure_basis(basis)">
  ...
  <Function id="qiskit.ignis.verification.TomographyFitter.set_preparation_basis" name="set_preparation_basis" signature="TomographyFitter.set_preparation_basis(basis)">
  ...
  <Attribute id="qiskit.ignis.verification.TomographyFitter.data" name="data">
    Return tomography data
  </Attribute>

  ### measure\_basis

  <Attribute id="qiskit.ignis.verification.TomographyFitter.measure_basis" name="measure_basis">
    Return the tomography measurement basis.
  </Attribute>

  ### preparation\_basis

  <Attribute id="qiskit.ignis.verification.TomographyFitter.preparation_basis" name="preparation_basis">
