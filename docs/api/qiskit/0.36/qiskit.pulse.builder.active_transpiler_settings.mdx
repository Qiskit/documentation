...
<Function id="qiskit.pulse.builder.active_transpiler_settings" name="active_transpiler_settings" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.20/qiskit/pulse/builder.py" signature="active_transpiler_settings()">
