---
title: TensoredFilter (v0.36)
description: API reference for qiskit.ignis.mitigation.TensoredFilter in qiskit v0.36
...
<Class id="qiskit.ignis.mitigation.TensoredFilter" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-ignis/tree/stable/0.7/qiskit/ignis/mitigation/measurement/filters.py" signature="TensoredFilter(cal_matrices, substate_labels_list, mit_pattern)" modifiers="class">
  Bases: `object`
