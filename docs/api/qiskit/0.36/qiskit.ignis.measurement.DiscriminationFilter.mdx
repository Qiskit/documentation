---
title: DiscriminationFilter (v0.36)
description: API reference for qiskit.ignis.measurement.DiscriminationFilter in qiskit v0.36
...
<Class id="qiskit.ignis.measurement.DiscriminationFilter" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-ignis/tree/stable/0.7/qiskit/ignis/measurement/discriminator/filters.py" signature="DiscriminationFilter(discriminator, base=None)" modifiers="class">
  Bases: `object`
