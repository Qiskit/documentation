...
<Class id="qiskit.ignis.measurement.DiscriminationFilter" github="https://github.com/qiskit-community/qiskit-ignis/tree/stable/0.7/qiskit/ignis/measurement/discriminator/filters.py" signature="DiscriminationFilter(discriminator, base=None)">
  Bases: `object`
