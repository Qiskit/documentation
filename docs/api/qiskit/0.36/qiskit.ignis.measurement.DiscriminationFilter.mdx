...
<Class id="qiskit.ignis.measurement.DiscriminationFilter" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-ignis/tree/stable/0.7/qiskit/ignis/measurement/discriminator/filters.py" signature="DiscriminationFilter(discriminator, base=None)">
  Bases: `object`
  ...
  *   **base** (`Optional`\[`int`]) – the base of the expected states. If it is not given the base is inferred from the expected\_state instance of discriminator.
  ...
  <Function id="qiskit.ignis.measurement.DiscriminationFilter.apply" name="apply" signature="DiscriminationFilter.apply(raw_data)">
  ...
  <Function id="qiskit.ignis.measurement.DiscriminationFilter.count" name="count" signature="DiscriminationFilter.count(y_data)">
  ...
  <Function id="qiskit.ignis.measurement.DiscriminationFilter.get_base" name="get_base" signature="static DiscriminationFilter.get_base(expected_states)">
