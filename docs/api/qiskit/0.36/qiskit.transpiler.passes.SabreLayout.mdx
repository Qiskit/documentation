...
<Class id="qiskit.transpiler.passes.SabreLayout" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.20/qiskit/transpiler/passes/layout/sabre_layout.py" signature="SabreLayout(*args, **kwargs)">
  ...
  *   **max\_iterations** (*int*) – number of forward-backward iterations.
  ...
  <Function id="qiskit.transpiler.passes.SabreLayout.name" name="name" signature="SabreLayout.name()">
    Return the name of the pass.
  </Function>

  ### run

  <Function id="qiskit.transpiler.passes.SabreLayout.run" name="run" signature="SabreLayout.run(dag)">
