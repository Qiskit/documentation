---
title: ShorResult (v0.36)
description: API reference for qiskit.algorithms.ShorResult in qiskit v0.36
...
<Class id="qiskit.algorithms.ShorResult" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.20/qiskit/algorithms/factorizers/shor.py" signature="ShorResult" modifiers="class">
