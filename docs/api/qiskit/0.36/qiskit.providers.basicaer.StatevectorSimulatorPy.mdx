...
<Class id="qiskit.providers.basicaer.StatevectorSimulatorPy" github="https://github.com/qiskit/qiskit/tree/stable/0.20/qiskit/providers/basicaer/statevector_simulator.py" signature="StatevectorSimulatorPy(configuration=None, provider=None, **fields)">
