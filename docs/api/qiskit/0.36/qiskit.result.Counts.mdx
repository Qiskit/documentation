---
title: Counts (v0.36)
description: API reference for qiskit.result.Counts in qiskit v0.36
...
<Class id="qiskit.result.Counts" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.20/qiskit/result/counts.py" signature="Counts(data, time_taken=None, creg_sizes=None, memory_slots=None)" modifiers="class">
  Bases: `dict`
