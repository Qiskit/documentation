---
title: PiecewisePolynomialPauliRotations (v0.36)
description: API reference for qiskit.circuit.library.PiecewisePolynomialPauliRotations in qiskit v0.36
...
$$
  ...
  *   **name** (`str`) – The name of the circuit.
  ...
  <Attribute id="qiskit.circuit.library.PiecewisePolynomialPauliRotations.instances" attributeValue="9" />
