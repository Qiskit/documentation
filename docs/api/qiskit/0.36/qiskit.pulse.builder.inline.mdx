---
title: inline (v0.36)
description: API reference for qiskit.pulse.builder.inline in qiskit v0.36
...
<Function id="qiskit.pulse.builder.inline" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.20/qiskit/pulse/builder.py" signature="inline()">
