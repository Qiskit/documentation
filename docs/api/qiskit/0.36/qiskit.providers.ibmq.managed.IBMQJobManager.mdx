...
<Class id="qiskit.providers.ibmq.managed.IBMQJobManager" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-ibmq-provider/tree/stable/0.19/qiskit/providers/ibmq/managed/ibmqjobmanager.py" signature="IBMQJobManager">
  Bases: `object`
  ...
  <Function id="qiskit.providers.ibmq.managed.IBMQJobManager.job_sets" name="job_sets" signature="IBMQJobManager.job_sets(name=None)">
  ...
  <Function id="qiskit.providers.ibmq.managed.IBMQJobManager.report" name="report" signature="IBMQJobManager.report(detailed=True)">
  ...
  <Function id="qiskit.providers.ibmq.managed.IBMQJobManager.retrieve_job_set" name="retrieve_job_set" signature="IBMQJobManager.retrieve_job_set(job_set_id, provider, refresh=False)">
  ...
  <Function id="qiskit.providers.ibmq.managed.IBMQJobManager.run" name="run" signature="IBMQJobManager.run(experiments, backend, name=None, max_experiments_per_job=None, job_share_level=None, job_tags=None, **run_config)">
