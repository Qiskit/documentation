---
title: PropertySet (v0.36)
description: API reference for qiskit.transpiler.PropertySet in qiskit v0.36
...
<Class id="qiskit.transpiler.PropertySet" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.20/qiskit/transpiler/propertyset.py" signature="PropertySet" modifiers="class">
  Bases: `dict`
