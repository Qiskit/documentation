...
<Class id="qiskit.opflow.gradients.QFIBase" github="https://github.com/qiskit/qiskit/tree/stable/0.20/qiskit/opflow/gradients/qfi_base.py" signature="QFIBase(qfi_method='lin_comb_full')">
