...
<Function id="qiskit.pulse.builder.active_circuit_scheduler_settings" github="https://github.com/qiskit/qiskit/tree/stable/0.20/qiskit/pulse/builder.py" signature="active_circuit_scheduler_settings()">
