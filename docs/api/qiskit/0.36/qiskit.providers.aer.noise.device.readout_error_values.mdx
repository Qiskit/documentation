---
title: readout_error_values (v0.36)
description: API reference for qiskit.providers.aer.noise.device.readout_error_values in qiskit v0.36
...
<Function id="qiskit.providers.aer.noise.device.readout_error_values" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-aer/tree/stable/0.10/qiskit/providers/aer/noise/device/parameters.py" signature="readout_error_values(properties)">
