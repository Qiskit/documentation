---
title: align_left (v0.36)
description: API reference for qiskit.pulse.builder.align_left in qiskit v0.36
...
<Function id="qiskit.pulse.builder.align_left" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.20/qiskit/pulse/builder.py" signature="align_left()">
