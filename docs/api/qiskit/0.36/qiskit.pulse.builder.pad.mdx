...
<Function id="qiskit.pulse.builder.pad" name="pad" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.20/qiskit/pulse/builder.py" signature="pad(*chs)">
