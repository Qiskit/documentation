...
<Class id="qiskit.providers.aer.jobs.AerJobSet" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-aer/tree/stable/0.10/qiskit/providers/aer/jobs/aerjobset.py" signature="AerJobSet(backend, job_id, fn, experiments, executor=None)">
  ...
  *   **executor** (*ThreadPoolExecutor or dask.distributed.client*) – The executor to be used to submit the job.
  ...
  <Function id="qiskit.providers.aer.jobs.AerJobSet.backend" name="backend" signature="AerJobSet.backend()">
  ...
  <Function id="qiskit.providers.aer.jobs.AerJobSet.cancel" name="cancel" signature="AerJobSet.cancel()">
  ...
  <Function id="qiskit.providers.aer.jobs.AerJobSet.cancelled" name="cancelled" signature="AerJobSet.cancelled()">
  ...
  <Function id="qiskit.providers.aer.jobs.AerJobSet.done" name="done" signature="AerJobSet.done()">
  ...
  <Function id="qiskit.providers.aer.jobs.AerJobSet.executor" name="executor" signature="AerJobSet.executor()">
    Return the executor for this job
  </Function>

  ### in\_final\_state

  <Function id="qiskit.providers.aer.jobs.AerJobSet.in_final_state" name="in_final_state" signature="AerJobSet.in_final_state()">
  ...
  <Function id="qiskit.providers.aer.jobs.AerJobSet.job" name="job" signature="AerJobSet.job(experiment)">
  ...
  <Function id="qiskit.providers.aer.jobs.AerJobSet.job_id" name="job_id" signature="AerJobSet.job_id()">
  ...
  <Function id="qiskit.providers.aer.jobs.AerJobSet.result" name="result" signature="AerJobSet.result(timeout=None)">
  ...
  <Function id="qiskit.providers.aer.jobs.AerJobSet.running" name="running" signature="AerJobSet.running()">
  ...
  <Function id="qiskit.providers.aer.jobs.AerJobSet.status" name="status" signature="AerJobSet.status(worker)">
  ...
  <Function id="qiskit.providers.aer.jobs.AerJobSet.submit" name="submit" signature="AerJobSet.submit()">
  ...
  <Function id="qiskit.providers.aer.jobs.AerJobSet.wait_for_final_state" name="wait_for_final_state" signature="AerJobSet.wait_for_final_state(timeout=None, wait=5, callback=None)">
  ...
  <Function id="qiskit.providers.aer.jobs.AerJobSet.worker" name="worker" signature="AerJobSet.worker(experiment)">
  ...
  <Function id="qiskit.providers.aer.jobs.AerJobSet.worker_job" name="worker_job" signature="AerJobSet.worker_job(worker)">
  ...
  <Function id="qiskit.providers.aer.jobs.AerJobSet.worker_results" name="worker_results" signature="AerJobSet.worker_results(worker, timeout=None)">
  ...
  <Attribute id="qiskit.providers.aer.jobs.AerJobSet.version" name="version" attributeValue="= 1" />
</Class>
