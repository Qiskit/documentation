...
<Function id="qiskit.quantum_info.pauli_basis" name="pauli_basis" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.20/qiskit/quantum_info/operators/symplectic/pauli_utils.py" signature="pauli_basis(num_qubits, weight=False, pauli_list=False)">
