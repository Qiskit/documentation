---
title: PulseSimulator (v0.36)
description: API reference for qiskit.providers.aer.PulseSimulator in qiskit v0.36
...
<Class id="qiskit.providers.aer.PulseSimulator" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-aer/tree/stable/0.10/qiskit/providers/aer/backends/pulse_simulator.py" signature="PulseSimulator(configuration=None, properties=None, defaults=None, provider=None, **backend_options)" modifiers="class">
  ...
  **Raises**
  ...
  <span id="qiskit-providers-aer-pulsesimulator-clear-options" />
  ...
  <span id="qiskit-providers-aer-pulsesimulator-from-backend" />
  ...
  <Function id="qiskit.providers.aer.PulseSimulator.run" signature="PulseSimulator.run(schedules, validate=True, **run_options)">
  ...
  <span id="qiskit-providers-aer-pulsesimulator-set-option" />
  ...
  <span id="qiskit-providers-aer-pulsesimulator-set-options" />
