...
<Function id="qiskit.converters.dag_to_circuit" name="dag_to_circuit" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.20/qiskit/converters/dag_to_circuit.py" signature="dag_to_circuit(dag)">
