...
<Class id="qiskit.algorithms.Shor" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.20/qiskit/algorithms/factorizers/shor.py" signature="Shor(quantum_instance=None)">
  Bases: `object`
  ...
  **quantum\_instance** (`Union`\[`Backend`, `BaseBackend`, `QuantumInstance`, `None`]) – Quantum Instance or Backend
  ...
  <Function id="qiskit.algorithms.Shor.construct_circuit" name="construct_circuit" signature="Shor.construct_circuit(N, a=2, measurement=False)">
  ...
  <Function id="qiskit.algorithms.Shor.factor" name="factor" signature="Shor.factor(N, a=2)">
  ...
  <Function id="qiskit.algorithms.Shor.modinv" name="modinv" signature="static Shor.modinv(a, m)">
  ...
  <Attribute id="qiskit.algorithms.Shor.quantum_instance" name="quantum_instance">
