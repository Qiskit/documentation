---
title: Statevector (v0.36)
description: API reference for qiskit.quantum_info.Statevector in qiskit v0.36
...
<Class id="qiskit.quantum_info.Statevector" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.20/qiskit/quantum_info/states/statevector.py" signature="Statevector(data, dims=None)" modifiers="class">
