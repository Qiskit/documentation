...
<Class id="qiskit.transpiler.passes.RemoveFinalMeasurements" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.20/qiskit/transpiler/passes/utils/remove_final_measurements.py" signature="RemoveFinalMeasurements(*args, **kwargs)">
  ...
  <Function id="qiskit.transpiler.passes.RemoveFinalMeasurements.name" name="name" signature="RemoveFinalMeasurements.name()">
    Return the name of the pass.
  </Function>

  ### run

  <Function id="qiskit.transpiler.passes.RemoveFinalMeasurements.run" name="run" signature="RemoveFinalMeasurements.run(dag)">
  ...
  <Attribute id="qiskit.transpiler.passes.RemoveFinalMeasurements.is_analysis_pass" name="is_analysis_pass">
  ...
  <Attribute id="qiskit.transpiler.passes.RemoveFinalMeasurements.is_transformation_pass" name="is_transformation_pass">
