---
title: Qobj (v0.36)
description: API reference for qiskit.qobj.Qobj in qiskit v0.36
...
<Class id="qiskit.qobj.Qobj" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.20/qiskit/qobj/__init__.py" signature="Qobj(qobj_id=None, config=None, experiments=None, header=None)" modifiers="class">
