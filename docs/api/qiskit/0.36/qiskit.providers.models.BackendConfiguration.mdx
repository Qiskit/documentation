---
title: BackendConfiguration (v0.36)
description: API reference for qiskit.providers.models.BackendConfiguration in qiskit v0.36
...
<Class id="qiskit.providers.models.BackendConfiguration" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.20/qiskit/providers/models/backendconfiguration.py" signature="BackendConfiguration(backend_name, backend_version, n_qubits, basis_gates, gates, local, simulator, conditional, open_pulse, memory, max_shots, coupling_map, supported_instructions=None, dynamic_reprate_enabled=False, rep_delay_range=None, default_rep_delay=None, max_experiments=None, sample_name=None, n_registers=None, register_map=None, configurable=None, credits_required=None, online_date=None, display_name=None, description=None, tags=None, dt=None, dtm=None, processor_type=None, parametric_pulses=None, **kwargs)" modifiers="class">
  ...
  *   **\*\*kwargs** – optional fields
  ...
  <span id="qiskit-providers-models-backendconfiguration-from-dict" />
  ...
  <span id="qiskit-providers-models-backendconfiguration-to-dict" />
