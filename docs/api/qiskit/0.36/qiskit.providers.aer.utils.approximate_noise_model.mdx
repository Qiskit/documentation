---
title: approximate_noise_model (v0.36)
description: API reference for qiskit.providers.aer.utils.approximate_noise_model in qiskit v0.36
...
<Function id="qiskit.providers.aer.utils.approximate_noise_model" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-aer/tree/stable/0.10/qiskit/providers/aer/utils/noise_transformation.py" signature="approximate_noise_model(model, *, operator_string=None, operator_dict=None, operator_list=None)">
