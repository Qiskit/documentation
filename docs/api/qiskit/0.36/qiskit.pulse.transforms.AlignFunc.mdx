...
<Class id="qiskit.pulse.transforms.AlignFunc" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.20/qiskit/pulse/transforms/alignments.py" signature="AlignFunc(duration, func)">
  ...
  *   **func** (`Callable`) – A function that takes an index of sub-schedule and returns the fractional coordinate of of that sub-schedule. The returned value should be defined within \[0, 1]. The pulse index starts from 1.
  ...
  <Attribute id="qiskit.pulse.transforms.AlignFunc.is_sequential" name="is_sequential" attributeValue="True" />
</Class>
