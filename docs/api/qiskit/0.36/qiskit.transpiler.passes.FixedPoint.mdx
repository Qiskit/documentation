---
title: FixedPoint (v0.36)
description: API reference for qiskit.transpiler.passes.FixedPoint in qiskit v0.36
...
<Class id="qiskit.transpiler.passes.FixedPoint" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.20/qiskit/transpiler/passes/utils/fixed_point.py" signature="FixedPoint(*args, **kwargs)" modifiers="class">
