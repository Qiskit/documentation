...
<Class id="qiskit.opflow.state_fns.StateFn" github="https://github.com/qiskit/qiskit/tree/stable/0.20/qiskit/opflow/state_fns/state_fn.py" signature="StateFn(primitive=None, coeff=1.0, is_measurement=False)">
