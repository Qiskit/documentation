...
<Class id="qiskit.providers.BaseJob" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.20/qiskit/providers/basejob.py" signature="BaseJob(backend, job_id)">
  Bases: `abc.ABC`
