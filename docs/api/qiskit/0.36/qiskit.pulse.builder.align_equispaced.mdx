---
title: align_equispaced (v0.36)
description: API reference for qiskit.pulse.builder.align_equispaced in qiskit v0.36
...
<Function id="qiskit.pulse.builder.align_equispaced" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.20/qiskit/pulse/builder.py" signature="align_equispaced(duration)">
  ...
  ![../\_images/qiskit.pulse.builder.align\_equispaced\_0\_0.png](/docs/images/api/qiskit/0.36/qiskit.pulse.builder.align_equispaced_0_0.avif)
