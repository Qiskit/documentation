...
<Function id="qiskit.ignis.verification.expectation_counts" name="expectation_counts" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-ignis/tree/stable/0.7/qiskit/ignis/verification/tomography/data.py" signature="expectation_counts(counts)">
