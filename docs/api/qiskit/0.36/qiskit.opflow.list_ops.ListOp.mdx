---
title: ListOp (v0.36)
description: API reference for qiskit.opflow.list_ops.ListOp in qiskit v0.36
...
<Class id="qiskit.opflow.list_ops.ListOp" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.20/qiskit/opflow/list_ops/list_op.py" signature="ListOp(oplist, combo_fn=None, coeff=1.0, abelian=False, grad_combo_fn=None)" modifiers="class">
