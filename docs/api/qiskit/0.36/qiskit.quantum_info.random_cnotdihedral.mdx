...
<Function id="qiskit.quantum_info.random_cnotdihedral" github="https://github.com/qiskit/qiskit/tree/stable/0.20/qiskit/quantum_info/operators/dihedral/random.py" signature="random_cnotdihedral(num_qubits, seed=None)">
