---
title: DefaultStyle (v0.36)
description: API reference for qiskit.visualization.qcstyle.DefaultStyle in qiskit v0.36
...
<Class id="qiskit.visualization.qcstyle.DefaultStyle" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.20/qiskit/visualization/qcstyle.py" signature="DefaultStyle" modifiers="class">
  Bases: `object`
