---
title: PauliOp (v0.36)
description: API reference for qiskit.opflow.primitive_ops.PauliOp in qiskit v0.36
...
<Class id="qiskit.opflow.primitive_ops.PauliOp" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.20/qiskit/opflow/primitive_ops/pauli_op.py" signature="PauliOp(primitive, coeff=1.0)" modifiers="class">
