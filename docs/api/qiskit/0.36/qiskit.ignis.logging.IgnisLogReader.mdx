---
title: IgnisLogReader (v0.36)
description: API reference for qiskit.ignis.logging.IgnisLogReader in qiskit v0.36
...
<Class id="qiskit.ignis.logging.IgnisLogReader" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-ignis/tree/stable/0.7/qiskit/ignis/logging/ignis_logging.py" signature="IgnisLogReader" modifiers="class">
  Bases: `object`
  ...
  <span id="qiskit-ignis-logging-ignislogreader-get-log-files" />
  ...
  <span id="qiskit-ignis-logging-ignislogreader-read-values" />
