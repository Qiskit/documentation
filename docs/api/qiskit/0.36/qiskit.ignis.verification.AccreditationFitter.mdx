...
<Class id="qiskit.ignis.verification.AccreditationFitter" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-ignis/tree/stable/0.7/qiskit/ignis/verification/accreditation/fitters.py" signature="AccreditationFitter">
  Bases: `object`
  ...
  **References**
  ...
  <Function id="qiskit.ignis.verification.AccreditationFitter.AppendResults" name="AppendResults" signature="AccreditationFitter.AppendResults(results, postp_list, v_zero)">
  ...
  <Function id="qiskit.ignis.verification.AccreditationFitter.AppendStrings" name="AppendStrings" signature="AccreditationFitter.AppendStrings(strings, postp_list, v_zero)">
  ...
  <Function id="qiskit.ignis.verification.AccreditationFitter.FullAccreditation" name="FullAccreditation" signature="AccreditationFitter.FullAccreditation(confidence)">
  ...
  <Function id="qiskit.ignis.verification.AccreditationFitter.MeanAccreditation" name="MeanAccreditation" signature="AccreditationFitter.MeanAccreditation(confidence)">
  ...
  <Function id="qiskit.ignis.verification.AccreditationFitter.Reset" name="Reset" signature="AccreditationFitter.Reset()">
