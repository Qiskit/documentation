...
<Class id="qiskit.circuit.classicalfunction.ClassicalFunctionParseError" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.20/qiskit/circuit/classicalfunction/exceptions.py" signature="ClassicalFunctionParseError(*message)">
