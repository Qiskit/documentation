---
title: dag_drawer (v0.36)
description: API reference for qiskit.visualization.dag_drawer in qiskit v0.36
...
<Function id="qiskit.visualization.dag_drawer" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.20/qiskit/visualization/dag_visualization.py" signature="dag_drawer(dag, scale=0.7, filename=None, style='color')">
  ...
  **Example**
  ...
  ![../\_images/qiskit.visualization.dag\_drawer\_0\_0.png](/docs/images/api/qiskit/0.36/qiskit.visualization.dag_drawer_0_0.avif)
</Function>
