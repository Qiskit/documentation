---
title: save_expectation_value_variance (v0.36)
description: API reference for qiskit.providers.aer.library.save_expectation_value_variance in qiskit v0.36
