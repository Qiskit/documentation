---
title: add_implicit_acquires (v0.36)
description: API reference for qiskit.pulse.transforms.add_implicit_acquires in qiskit v0.36
...
<Function id="qiskit.pulse.transforms.add_implicit_acquires" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.20/qiskit/pulse/transforms/canonicalization.py" signature="add_implicit_acquires(schedule, meas_map)">
