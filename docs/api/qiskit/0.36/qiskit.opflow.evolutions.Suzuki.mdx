...
<Class id="qiskit.opflow.evolutions.Suzuki" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.20/qiskit/opflow/evolutions/trotterizations/suzuki.py" signature="Suzuki(reps=1, order=2)">
  ...
  *   **order** (`int`) – The order of the expansion to perform.
  ...
  <Function id="qiskit.opflow.evolutions.Suzuki.convert" name="convert" signature="Suzuki.convert(operator)">
