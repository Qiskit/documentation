...
<span id="qiskit.transpiler.passes.SabrePreLayout" />

`qiskit.transpiler.passes.SabrePreLayout(*args, **kwargs)` [GitHub](https://github.com/qiskit/qiskit/tree/stable/1.0/qiskit/transpiler/passes/layout/sabre_pre_layout.py "view source code")
...
<span id="qiskit.transpiler.passes.SabrePreLayout.is_analysis_pass" />
...
<span id="qiskit.transpiler.passes.SabrePreLayout.is_transformation_pass" />
...
<span id="qiskit.transpiler.passes.SabrePreLayout.execute" />
...
<span id="qiskit.transpiler.passes.SabrePreLayout.name" />
...
<span id="qiskit.transpiler.passes.SabrePreLayout.run" />
...
<span id="qiskit.transpiler.passes.SabrePreLayout.update_status" />
