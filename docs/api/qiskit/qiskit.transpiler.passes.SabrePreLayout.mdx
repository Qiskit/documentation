...
<Class id="qiskit.transpiler.passes.SabrePreLayout" github="https://github.com/qiskit/qiskit/tree/stable/1.0/qiskit/transpiler/passes/layout/sabre_pre_layout.py" signature="qiskit.transpiler.passes.SabrePreLayout(*args, **kwargs)">
  ...
  **raises TranspilerError**
  ...
  <Function id="qiskit.transpiler.passes.SabrePreLayout.execute" name="execute" signature="execute(passmanager_ir, state, callback=None)">
  ...
  <Function id="qiskit.transpiler.passes.SabrePreLayout.name" name="name" signature="name()">
    Name of the pass.
  ...
  <Function id="qiskit.transpiler.passes.SabrePreLayout.run" name="run" signature="run(dag)">
  ...
  <Function id="qiskit.transpiler.passes.SabrePreLayout.update_status" name="update_status" signature="update_status(state, run_state)">
