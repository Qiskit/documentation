...
<Class id="qiskit.providers.basic_provider.BasicProvider" github="https://github.com/qiskit/qiskit/tree/stable/1.0/qiskit/providers/basic_provider/basic_provider.py" signature="qiskit.providers.basic_provider.BasicProvider">
  ...
  <Function id="qiskit.providers.basic_provider.BasicProvider.backends" name="backends" signature="backends(name=None, filters=None, **kwargs)">
  ...
  <Function id="qiskit.providers.basic_provider.BasicProvider.get_backend" name="get_backend" signature="get_backend(name=None, **kwargs)">
