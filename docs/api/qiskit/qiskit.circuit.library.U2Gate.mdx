...
<Class id="qiskit.circuit.library.U2Gate" github="https://github.com/qiskit/qiskit/tree/stable/1.0/qiskit/circuit/library/standard_gates/u2.py" signature="qiskit.circuit.library.U2Gate(phi, lam, label=None, *, duration=None, unit='dt')">
...
$$
  ...
  <Function id="qiskit.circuit.library.U2Gate.inverse" name="inverse" signature="inverse(annotated=False)">
