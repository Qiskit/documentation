...
<Class id="qiskit.transpiler.passes.ValidatePulseGates" github="https://github.com/Qiskit/qiskit/tree/stable/1.0/qiskit/transpiler/passes/scheduling/alignments/pulse_gate_validation.py#L21-L97" signature="qiskit.transpiler.passes.ValidatePulseGates(*args, **kwargs)">
