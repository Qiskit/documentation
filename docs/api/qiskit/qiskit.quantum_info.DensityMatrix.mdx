...
<Class id="qiskit.quantum_info.DensityMatrix" github="https://github.com/Qiskit/qiskit/tree/stable/1.0/qiskit/quantum_info/states/densitymatrix.py#L40-L848" signature="qiskit.quantum_info.DensityMatrix(data, dims=None)">
