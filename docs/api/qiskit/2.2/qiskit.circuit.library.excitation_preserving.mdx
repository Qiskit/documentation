---
title: excitation_preserving (v2.2)
description: API reference for qiskit.circuit.library.excitation_preserving in qiskit v2.2
...
$$
  ...
  ![Circuit diagram output by the previous code.](/docs/images/api/qiskit/2.2/qiskit-circuit-library-excitation_preserving-1.avif)
  ...
  ![Circuit diagram output by the previous code.](/docs/images/api/qiskit/2.2/qiskit-circuit-library-excitation_preserving-2_00.avif)

  ![Circuit diagram output by the previous code.](/docs/images/api/qiskit/2.2/qiskit-circuit-library-excitation_preserving-2_01.avif)
