---
title: FourierChecking (v2.2)
description: API reference for qiskit.circuit.library.FourierChecking in qiskit v2.2
...
<Class id="qiskit.circuit.library.FourierChecking" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/2.2/qiskit/circuit/library/fourier_checking.py#L25-L101" signature="qiskit.circuit.library.FourierChecking(f, g)" modifiers="class">
  ...
  **Reference Circuit:**
  ...
  ![Diagram illustrating the previously described circuit.](/docs/images/api/qiskit/2.2/qiskit-circuit-library-FourierChecking-1.avif)
