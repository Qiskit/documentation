---
title: GraphStateGate (v2.2)
description: API reference for qiskit.circuit.library.GraphStateGate in qiskit v2.2
...
$$
  ...
  ![Circuit diagram output by the previous code.](/docs/images/api/qiskit/2.2/qiskit-circuit-library-GraphStateGate-1.avif)
