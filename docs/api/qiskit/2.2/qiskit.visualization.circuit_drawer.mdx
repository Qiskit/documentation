---
title: circuit_drawer (v2.2)
description: API reference for qiskit.visualization.circuit_drawer in qiskit v2.2
...
<Function id="qiskit.visualization.circuit_drawer" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/2.2/qiskit/visualization/circuit/circuit_visualization.py#L56-L375" signature="qiskit.visualization.circuit_drawer(circuit, scale=None, filename=None, style=None, output=None, interactive=False, plot_barriers=True, reverse_bits=None, justify=None, vertical_compression='medium', idle_wires=None, with_layout=True, fold=None, ax=None, initial_state=False, cregbundle=None, wire_order=None, expr_len=30, measure_arrows=None)">
  ...
  **Example**
  ...
  ![Circuit diagram output by the previous code.](/docs/images/api/qiskit/2.2/qiskit-visualization-circuit_drawer-1.avif)
</Function>
