---
title: hidden_linear_function (v2.2)
description: API reference for qiskit.circuit.library.hidden_linear_function in qiskit v2.2
...
<Function id="qiskit.circuit.library.hidden_linear_function" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/2.2/qiskit/circuit/library/hidden_linear_function.py#L92-L163" signature="qiskit.circuit.library.hidden_linear_function(adjacency_matrix)">
...
$$
  ...
  ![Circuit diagram output by the previous code.](/docs/images/api/qiskit/2.2/qiskit-circuit-library-hidden_linear_function-1.avif)
