---
title: StarPreRouting (v2.2)
description: API reference for qiskit.transpiler.passes.StarPreRouting in qiskit v2.2
...
<Class id="qiskit.transpiler.passes.StarPreRouting" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/2.2/qiskit/transpiler/passes/routing/star_prerouting.py#L86-L433" signature="qiskit.transpiler.passes.StarPreRouting(*args, **kwargs)" modifiers="class">
  ...
  > ```
  >
  > ![Circuit diagram output by the previous code.](/docs/images/api/qiskit/2.2/qiskit-transpiler-passes-StarPreRouting-1.avif)
