---
title: HalfAdderSynthesisDefault (v2.2)
description: API reference for qiskit.transpiler.passes.synthesis.hls_plugins.HalfAdderSynthesisDefault in qiskit v2.2
