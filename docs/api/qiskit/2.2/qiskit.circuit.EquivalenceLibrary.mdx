---
title: EquivalenceLibrary (v2.2)
description: API reference for qiskit.circuit.EquivalenceLibrary in qiskit v2.2
...
<Class id="qiskit.circuit.EquivalenceLibrary" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/2.2/qiskit/circuit/equivalence.py#L29-L94" signature="qiskit.circuit.EquivalenceLibrary" modifiers="class">
  ...
  <Function id="qiskit.circuit.EquivalenceLibrary.draw" github="https://github.com/Qiskit/qiskit/tree/stable/2.2/qiskit/circuit/equivalence.py#L33-L58" signature="draw(filename=None)">
