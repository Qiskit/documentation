---
title: DCXGate (v2.2)
description: API reference for qiskit.circuit.library.DCXGate in qiskit v2.2
...
<Class id="qiskit.circuit.library.DCXGate" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/2.2/qiskit/circuit/library/standard_gates/dcx.py#L21-L80" signature="qiskit.circuit.library.DCXGate(*args, _force_mutable=False, **kwargs)" modifiers="class">
...
$$
  ...
  **label** – An optional label for the gate.
  ...
  <Function id="qiskit.circuit.library.DCXGate.add_decomposition" github="https://github.com/Qiskit/qiskit/tree/stable/2.2/qiskit/circuit/instruction.py#L320-L325" signature="add_decomposition(decomposition)">
    Add a decomposition of the instruction to the SessionEquivalenceLibrary.
  </Function>

  ### broadcast\_arguments

  <Function id="qiskit.circuit.library.DCXGate.broadcast_arguments" github="https://github.com/Qiskit/qiskit/tree/stable/2.2/qiskit/circuit/gate.py#L187-L244" signature="broadcast_arguments(qargs, cargs)">
  ...
  <Function id="qiskit.circuit.library.DCXGate.control" github="https://github.com/Qiskit/qiskit/tree/stable/2.2/qiskit/circuit/gate.py#L104-L144" signature="control(num_ctrl_qubits=1, label=None, ctrl_state=None, annotated=None)">
  ...
  <Function id="qiskit.circuit.library.DCXGate.copy" github="https://github.com/Qiskit/qiskit/tree/stable/2.2/qiskit/circuit/instruction.py#L430-L445" signature="copy(name=None)">
  ...
  <Function id="qiskit.circuit.library.DCXGate.inverse" github="https://github.com/Qiskit/qiskit/tree/stable/2.2/qiskit/circuit/instruction.py#L373-L428" signature="inverse(annotated=False)">
  ...
  <Function id="qiskit.circuit.library.DCXGate.is_parameterized" github="https://github.com/Qiskit/qiskit/tree/stable/2.2/qiskit/circuit/instruction.py#L285-L290" signature="is_parameterized()">
    Return whether the `Instruction` contains [compile-time parameters](circuit#circuit-compile-time-parameters).
  </Function>

  ### power

  <Function id="qiskit.circuit.library.DCXGate.power" github="https://github.com/Qiskit/qiskit/tree/stable/2.2/qiskit/circuit/gate.py#L62-L93" signature="power(exponent, annotated=False)">
  ...
  <Function id="qiskit.circuit.library.DCXGate.repeat" github="https://github.com/Qiskit/qiskit/tree/stable/2.2/qiskit/circuit/instruction.py#L493-L523" signature="repeat(n)">
  ...
  <Function id="qiskit.circuit.library.DCXGate.reverse_ops" github="https://github.com/Qiskit/qiskit/tree/stable/2.2/qiskit/circuit/instruction.py#L347-L371" signature="reverse_ops()">
  ...
  <Function id="qiskit.circuit.library.DCXGate.soft_compare" github="https://github.com/Qiskit/qiskit/tree/stable/2.2/qiskit/circuit/instruction.py#L216-L256" signature="soft_compare(other)">
  ...
  <Function id="qiskit.circuit.library.DCXGate.to_matrix" github="https://github.com/Qiskit/qiskit/tree/stable/2.2/qiskit/circuit/gate.py#L48-L60" signature="to_matrix()">
  ...
  <Function id="qiskit.circuit.library.DCXGate.to_mutable" github="https://github.com/Qiskit/qiskit/tree/stable/2.2/qiskit/circuit/instruction.py#L145-L153" signature="to_mutable()">
  ...
  <Function id="qiskit.circuit.library.DCXGate.validate_parameter" github="https://github.com/Qiskit/qiskit/tree/stable/2.2/qiskit/circuit/gate.py#L246-L260" signature="validate_parameter(parameter)">
