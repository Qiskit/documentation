---
title: PubResult (v2.2)
description: API reference for qiskit.primitives.PubResult in qiskit v2.2
...
<Class id="qiskit.primitives.PubResult" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/2.2/qiskit/primitives/containers/pub_result.py#L24-L51" signature="qiskit.primitives.PubResult(data, metadata=None)" modifiers="class">
