---
title: WrapAngles (v2.2)
description: API reference for qiskit.transpiler.passes.WrapAngles in qiskit v2.2
...
<Class id="qiskit.transpiler.passes.WrapAngles" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/2.2/qiskit/transpiler/passes/utils/wrap_angles.py#L23-L90" signature="qiskit.transpiler.passes.WrapAngles(*args, **kwargs)" modifiers="class">
  ...
  ![Circuit digram of the output from running the WrapAngles pass](/docs/images/api/qiskit/2.2/qiskit-transpiler-passes-WrapAngles-1.avif)
