---
title: ModularAdderSynthesisD00 (v2.2)
description: API reference for qiskit.transpiler.passes.synthesis.hls_plugins.ModularAdderSynthesisD00 in qiskit v2.2
