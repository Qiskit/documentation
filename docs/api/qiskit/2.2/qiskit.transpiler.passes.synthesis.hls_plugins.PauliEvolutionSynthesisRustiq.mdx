---
title: PauliEvolutionSynthesisRustiq (v2.2)
description: API reference for qiskit.transpiler.passes.synthesis.hls_plugins.PauliEvolutionSynthesisRustiq in qiskit v2.2
