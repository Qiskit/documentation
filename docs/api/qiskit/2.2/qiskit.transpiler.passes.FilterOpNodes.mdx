---
title: FilterOpNodes (v2.2)
description: API reference for qiskit.transpiler.passes.FilterOpNodes in qiskit v2.2
...
<Class id="qiskit.transpiler.passes.FilterOpNodes" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/2.2/qiskit/transpiler/passes/utils/filter_op_nodes.py#L24-L66" signature="qiskit.transpiler.passes.FilterOpNodes(*args, **kwargs)" modifiers="class">
  ...
  **Example**
  ...
  ![Circuit diagram output by the previous code.](/docs/images/api/qiskit/2.2/qiskit-transpiler-passes-FilterOpNodes-1.avif)
