---
title: transpiler (v2.2)
description: API reference for qiskit.transpiler in qiskit v2.2
...
![The transpilation process takes the input circuit, applies the transpilation       passes, then produces the output circuit.](/docs/images/api/qiskit/2.2/transpiling_core_steps.avif)
...
![Illustration of how virtual qubits from an input circuit could be mapped to hardware qubits on a backend device's connectivity map.](/docs/images/api/qiskit/2.2/mapping.avif)
...
![Diagram illustrating the previously described circuit.](/docs/images/api/qiskit/2.2/transpiler-8.avif)
...
![Circuit diagram output by the previous code.](/docs/images/api/qiskit/2.2/transpiler-9.avif)
...
![Output from circuit timeline drawer.](/docs/images/api/qiskit/2.2/transpiler-10.avif)
