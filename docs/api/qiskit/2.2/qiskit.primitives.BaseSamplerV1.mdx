---
title: BaseSamplerV1 (v2.2)
description: API reference for qiskit.primitives.BaseSamplerV1 in qiskit v2.2
...
<Class id="qiskit.primitives.BaseSamplerV1" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/2.2/qiskit/primitives/base/base_sampler.py#L77-L196" signature="qiskit.primitives.BaseSamplerV1(*, options=None)" modifiers="class">
  ...
  **options** ([*dict*](https://docs.python.org/3/library/stdtypes.html#dict) *| None*) – Default options.
  ...
  <Function id="qiskit.primitives.BaseSamplerV1.run" github="https://github.com/Qiskit/qiskit/tree/stable/2.2/qiskit/primitives/base/base_sampler.py#L156-L187" signature="run(circuits, parameter_values=None, **run_options)">
  ...
  <Function id="qiskit.primitives.BaseSamplerV1.set_options" github="https://github.com/Qiskit/qiskit/tree/stable/2.2/qiskit/primitives/base/base_primitive_v1.py#L39-L45" signature="set_options(**fields)">
