---
title: GRX (v2.2)
description: API reference for qiskit.circuit.library.GRX in qiskit v2.2
...
<Class id="qiskit.circuit.library.GRX" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/2.2/qiskit/circuit/library/generalized_gates/gr.py#L73-L119" signature="qiskit.circuit.library.GRX(num_qubits, theta)" modifiers="class">
...
$$
  ...
  **Expanded Circuit:**
  ...
  ![Diagram illustrating the previously described circuit.](/docs/images/api/qiskit/2.2/qiskit-circuit-library-GRX-1.avif)
