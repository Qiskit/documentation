---
title: TokenSwapperSynthesisPermutation (v2.2)
description: API reference for qiskit.transpiler.passes.synthesis.hls_plugins.TokenSwapperSynthesisPermutation in qiskit v2.2
...
<Class id="qiskit.transpiler.passes.synthesis.hls_plugins.TokenSwapperSynthesisPermutation" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/2.2/qiskit/transpiler/passes/synthesis/hls_plugins.py#L986-L1062" signature="qiskit.transpiler.passes.synthesis.hls_plugins.TokenSwapperSynthesisPermutation" modifiers="class">
  ...
  *   parallel\_threshold: The argument to the token swapper specifying the number of nodes in the graph beyond which the algorithm will use parallel processing.
  ...
  <Function id="qiskit.transpiler.passes.synthesis.hls_plugins.TokenSwapperSynthesisPermutation.run" github="https://github.com/Qiskit/qiskit/tree/stable/2.2/qiskit/transpiler/passes/synthesis/hls_plugins.py#L1018-L1062" signature="run(high_level_object, coupling_map=None, target=None, qubits=None, **options)">
