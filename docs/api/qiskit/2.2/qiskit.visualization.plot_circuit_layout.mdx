---
title: plot_circuit_layout (v2.2)
description: API reference for qiskit.visualization.plot_circuit_layout in qiskit v2.2
...
<Function id="qiskit.visualization.plot_circuit_layout" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/2.2/qiskit/visualization/gate_map.py#L1129-L1228" signature="qiskit.visualization.plot_circuit_layout(circuit, backend, view='virtual', qubit_coordinates=None)">
  ...
  **Example**
  ...
  ![Output from the previous code.](/docs/images/api/qiskit/2.2/qiskit-visualization-plot_circuit_layout-1.avif)
</Function>
