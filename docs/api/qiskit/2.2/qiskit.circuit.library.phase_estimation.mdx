---
title: phase_estimation (v2.2)
description: API reference for qiskit.circuit.library.phase_estimation in qiskit v2.2
...
$$
  ...
  **Return type**
  ...
  ![A phase estimation circuit.](/docs/images/api/qiskit/2.2/qiskit-circuit-library-phase_estimation-1.avif)
