---
title: Parameter (v2.2)
description: API reference for qiskit.circuit.Parameter in qiskit v2.2
...
<Class id="qiskit.circuit.Parameter" isDedicatedPage={true} signature="qiskit.circuit.Parameter" modifiers="class">
  ...
  **Examples**
  ...
  ![Circuit diagram output by the previous code.](/docs/images/api/qiskit/2.2/qiskit-circuit-Parameter-1_00.avif)

  ![Circuit diagram output by the previous code.](/docs/images/api/qiskit/2.2/qiskit-circuit-Parameter-1_01.avif)
