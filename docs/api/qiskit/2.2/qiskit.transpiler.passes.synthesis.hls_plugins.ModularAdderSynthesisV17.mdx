---
title: ModularAdderSynthesisV17 (v2.2)
description: API reference for qiskit.transpiler.passes.synthesis.hls_plugins.ModularAdderSynthesisV17 in qiskit v2.2
