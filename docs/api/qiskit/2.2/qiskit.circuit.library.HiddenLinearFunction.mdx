---
title: HiddenLinearFunction (v2.2)
description: API reference for qiskit.circuit.library.HiddenLinearFunction in qiskit v2.2
...
<Class id="qiskit.circuit.library.HiddenLinearFunction" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/2.2/qiskit/circuit/library/hidden_linear_function.py#L23-L89" signature="qiskit.circuit.library.HiddenLinearFunction(adjacency_matrix)" modifiers="class">
...
$$
  ...
  ![Diagram illustrating the previously described circuit.](/docs/images/api/qiskit/2.2/qiskit-circuit-library-HiddenLinearFunction-1.avif)
