---
title: grover_operator (v2.2)
description: API reference for qiskit.circuit.library.grover_operator in qiskit v2.2
...
$$
  ...
  ![Circuit diagram output by the previous code.](/docs/images/api/qiskit/2.2/qiskit-circuit-library-grover_operator-1.avif)
  ...
  ![Circuit diagram output by the previous code.](/docs/images/api/qiskit/2.2/qiskit-circuit-library-grover_operator-2.avif)
  ...
  ![Circuit diagram output by the previous code.](/docs/images/api/qiskit/2.2/qiskit-circuit-library-grover_operator-3.avif)
  ...
  ![Circuit diagram output by the previous code.](/docs/images/api/qiskit/2.2/qiskit-circuit-library-grover_operator-4.avif)
