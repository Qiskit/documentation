---
title: PiecewisePolynomialPauliRotationsGate (v2.2)
description: API reference for qiskit.circuit.library.PiecewisePolynomialPauliRotationsGate in qiskit v2.2
