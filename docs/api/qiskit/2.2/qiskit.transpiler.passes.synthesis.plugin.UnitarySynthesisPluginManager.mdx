---
title: UnitarySynthesisPluginManager (v2.2)
description: API reference for qiskit.transpiler.passes.synthesis.plugin.UnitarySynthesisPluginManager in qiskit v2.2
