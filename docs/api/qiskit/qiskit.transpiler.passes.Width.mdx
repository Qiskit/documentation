...
`qiskit.transpiler.passes.Width(*args, **kwargs)` [GitHub](https://github.com/qiskit/qiskit/tree/stable/1.0/qiskit/transpiler/passes/analysis/width.py "view source code")
...
<span id="qiskit.transpiler.passes.Width.execute" />
...
<span id="qiskit.transpiler.passes.Width.update_status" />
