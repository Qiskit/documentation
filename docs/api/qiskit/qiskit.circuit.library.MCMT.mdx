...
<Class id="qiskit.circuit.library.MCMT" github="https://github.com/qiskit/qiskit/tree/stable/1.0/qiskit/circuit/library/generalized_gates/mcmt.py" signature="qiskit.circuit.library.MCMT(gate, num_ctrl_qubits, num_target_qubits)">
