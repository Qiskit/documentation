---
title: CUGate (latest version)
description: API reference for qiskit.circuit.library.CUGate in the latest version of qiskit
...
<Class id="qiskit.circuit.library.CUGate" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/circuit/library/standard_gates/u.py#L223-L396" signature="qiskit.circuit.library.CUGate(theta, phi, lam, gamma, label=None, ctrl_state=None, *, _base_label=None)" modifiers="class">
  ...
  Can be applied to a [`QuantumCircuit`](/docs/api/qiskit/qiskit.circuit.QuantumCircuit "qiskit.circuit.QuantumCircuit") with the [`cu()`](/docs/api/qiskit/qiskit.circuit.QuantumCircuit#cu "qiskit.circuit.QuantumCircuit.cu") method.
...
$$
  ...
  *   **ctrl\_state** ([*int*](https://docs.python.org/3/library/functions.html#int)  *|*[*str*](https://docs.python.org/3/library/stdtypes.html#str) *| None*)
  ...
  <Attribute id="qiskit.circuit.library.CUGate.base_class" name="base_class" headingLevel={3}>
  ...
  <Attribute id="qiskit.circuit.library.CUGate.ctrl_state" name="ctrl_state" headingLevel={3}>
    Return the control state of the gate as a decimal integer.
  </Attribute>

  <Attribute id="qiskit.circuit.library.CUGate.decompositions" name="decompositions" headingLevel={3}>
    Get the decompositions of the instruction from the SessionEquivalenceLibrary.
  </Attribute>

  <Attribute id="qiskit.circuit.library.CUGate.definition" name="definition" headingLevel={3}>
  ...
  <Attribute id="qiskit.circuit.library.CUGate.label" name="label" headingLevel={3}>
    Return instruction label
  </Attribute>

  <Attribute id="qiskit.circuit.library.CUGate.mutable" name="mutable" headingLevel={3}>
    Is this instance is a mutable unique instance or not.

    If this attribute is `False` the gate instance is a shared singleton and is not mutable.
  </Attribute>

  <Attribute id="qiskit.circuit.library.CUGate.name" name="name" headingLevel={3}>
  ...
  <Attribute id="qiskit.circuit.library.CUGate.num_clbits" name="num_clbits" headingLevel={3}>
    Return the number of clbits.
  </Attribute>

  <Attribute id="qiskit.circuit.library.CUGate.num_ctrl_qubits" name="num_ctrl_qubits" headingLevel={3}>
  ...
  <Attribute id="qiskit.circuit.library.CUGate.num_qubits" name="num_qubits" headingLevel={3}>
    Return the number of qubits.
  </Attribute>

  <Attribute id="qiskit.circuit.library.CUGate.params" name="params" headingLevel={3} />

  ## Methods

  ### add\_decomposition

  <Function id="qiskit.circuit.library.CUGate.add_decomposition" github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/circuit/instruction.py#L318-L323" signature="add_decomposition(decomposition)">
    Add a decomposition of the instruction to the SessionEquivalenceLibrary.
  </Function>

  ### broadcast\_arguments

  <Function id="qiskit.circuit.library.CUGate.broadcast_arguments" github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/circuit/gate.py#L206-L263" signature="broadcast_arguments(qargs, cargs)">
  ...
  <Function id="qiskit.circuit.library.CUGate.control" github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/circuit/gate.py#L105-L163" signature="control(num_ctrl_qubits=1, label=None, ctrl_state=None, annotated=None)">
  ...
  <Function id="qiskit.circuit.library.CUGate.copy" github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/circuit/instruction.py#L428-L443" signature="copy(name=None)">
  ...
  <Function id="qiskit.circuit.library.CUGate.inverse" github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/circuit/library/standard_gates/u.py#L328-L349" signature="inverse(annotated=False)">
  ...
  <Function id="qiskit.circuit.library.CUGate.is_parameterized" github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/circuit/instruction.py#L283-L288" signature="is_parameterized()">
    Return whether the `Instruction` contains [compile-time parameters](/docs/api/qiskit/circuit#circuit-compile-time-parameters).
  </Function>

  ### power

  <Function id="qiskit.circuit.library.CUGate.power" github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/circuit/gate.py#L63-L94" signature="power(exponent, annotated=False)">
  ...
  <Function id="qiskit.circuit.library.CUGate.repeat" github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/circuit/instruction.py#L491-L521" signature="repeat(n)">
  ...
  <Function id="qiskit.circuit.library.CUGate.reverse_ops" github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/circuit/instruction.py#L345-L369" signature="reverse_ops()">
  ...
  <Function id="qiskit.circuit.library.CUGate.soft_compare" github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/circuit/instruction.py#L214-L254" signature="soft_compare(other)">
  ...
  <Function id="qiskit.circuit.library.CUGate.to_matrix" github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/circuit/gate.py#L49-L61" signature="to_matrix()">
  ...
  <Function id="qiskit.circuit.library.CUGate.to_mutable" github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/circuit/instruction.py#L144-L152" signature="to_mutable()">
  ...
  <Function id="qiskit.circuit.library.CUGate.validate_parameter" github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/circuit/gate.py#L265-L279" signature="validate_parameter(parameter)">
