---
title: UnitarySynthesisPluginManager (v1.1)
description: API reference for qiskit.transpiler.passes.synthesis.plugin.UnitarySynthesisPluginManager in qiskit v1.1
