---
title: HighLevelSynthesisPluginManager (v1.1)
description: API reference for qiskit.transpiler.passes.synthesis.plugin.HighLevelSynthesisPluginManager in qiskit v1.1
