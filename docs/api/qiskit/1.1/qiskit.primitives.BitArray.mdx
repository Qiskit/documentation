---
title: BitArray (v1.1)
description: API reference for qiskit.primitives.BitArray in qiskit v1.1
...
<Class id="qiskit.primitives.BitArray" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.1/qiskit/primitives/containers/bit_array.py#L59-L643" signature="qiskit.primitives.BitArray(array, num_bits)" modifiers="class">
  Bases: `ShapedMixin`
  ...
  *   [**ValueError**](https://docs.python.org/3/library/exceptions.html#ValueError) – If the input array has fewer than two axes, or the size of the last axis is not the smallest number of bytes that can contain `num_bits`.
  ...
  <Function id="qiskit.primitives.BitArray.concatenate" github="https://github.com/Qiskit/qiskit/tree/stable/1.1/qiskit/primitives/containers/bit_array.py#L515-L564" signature="concatenate(bit_arrays, axis=0)" modifiers="static">
  ...
  <Function id="qiskit.primitives.BitArray.concatenate_bits" github="https://github.com/Qiskit/qiskit/tree/stable/1.1/qiskit/primitives/containers/bit_array.py#L602-L643" signature="concatenate_bits(bit_arrays)" modifiers="static">
  ...
  <Function id="qiskit.primitives.BitArray.concatenate_shots" github="https://github.com/Qiskit/qiskit/tree/stable/1.1/qiskit/primitives/containers/bit_array.py#L566-L600" signature="concatenate_shots(bit_arrays)" modifiers="static">
  ...
  <Function id="qiskit.primitives.BitArray.expectation_values" github="https://github.com/Qiskit/qiskit/tree/stable/1.1/qiskit/primitives/containers/bit_array.py#L471-L513" signature="expectation_values(observables)">
  ...
  <Function id="qiskit.primitives.BitArray.from_samples" github="https://github.com/Qiskit/qiskit/tree/stable/1.1/qiskit/primitives/containers/bit_array.py#L264-L308" signature="from_samples(samples, num_bits=None)" modifiers="static">
  ...
  <Function id="qiskit.primitives.BitArray.get_bitstrings" github="https://github.com/Qiskit/qiskit/tree/stable/1.1/qiskit/primitives/containers/bit_array.py#L338-L351" signature="get_bitstrings(loc=None)">
  ...
  <Function id="qiskit.primitives.BitArray.get_counts" github="https://github.com/Qiskit/qiskit/tree/stable/1.1/qiskit/primitives/containers/bit_array.py#L310-L322" signature="get_counts(loc=None)">
  ...
  <Function id="qiskit.primitives.BitArray.get_int_counts" github="https://github.com/Qiskit/qiskit/tree/stable/1.1/qiskit/primitives/containers/bit_array.py#L324-L336" signature="get_int_counts(loc=None)">
  ...
  <Function id="qiskit.primitives.BitArray.reshape" github="https://github.com/Qiskit/qiskit/tree/stable/1.1/qiskit/primitives/containers/bit_array.py#L353-L379" signature="reshape(*shape)">
  ...
  <Function id="qiskit.primitives.BitArray.slice_bits" github="https://github.com/Qiskit/qiskit/tree/stable/1.1/qiskit/primitives/containers/bit_array.py#L411-L446" signature="slice_bits(indices)">
    ...
    **Raises**
    ...
    [**ValueError**](https://docs.python.org/3/library/exceptions.html#ValueError) – If there are any invalid indices of the bit axis.
  ...
  <Function id="qiskit.primitives.BitArray.slice_shots" github="https://github.com/Qiskit/qiskit/tree/stable/1.1/qiskit/primitives/containers/bit_array.py#L448-L469" signature="slice_shots(indices)">
    ...
    **Raises**
    ...
    [**ValueError**](https://docs.python.org/3/library/exceptions.html#ValueError) – If there are any invalid indices of the shots axis.
  ...
  <Function id="qiskit.primitives.BitArray.transpose" github="https://github.com/Qiskit/qiskit/tree/stable/1.1/qiskit/primitives/containers/bit_array.py#L381-L409" signature="transpose(*axes)">
