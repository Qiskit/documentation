---
title: QubitProperties (v1.1)
description: API reference for qiskit.providers.QubitProperties in qiskit v1.1
...
<Class id="qiskit.providers.QubitProperties" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.1/qiskit/providers/backend.py#L239-L264" signature="qiskit.providers.QubitProperties(t1=None, t2=None, frequency=None)" modifiers="class">
