---
title: Square (v1.1)
description: API reference for qiskit.pulse.library.Square in qiskit v1.1
...
$$
  ...
  *   **amp** ([*float*](https://docs.python.org/3/library/functions.html#float)  *|*[*ParameterExpression*](qiskit.circuit.ParameterExpression "qiskit.circuit.ParameterExpression")) – The magnitude of the amplitude of the square wave. Wave range is \[-amp,\`amp\`].
