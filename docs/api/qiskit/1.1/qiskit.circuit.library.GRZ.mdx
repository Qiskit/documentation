---
title: GRZ (v1.1)
description: API reference for qiskit.circuit.library.GRZ in qiskit v1.1
...
$$
  ...
  **Expanded Circuit:**
  ...
  ![../\_images/qiskit-circuit-library-GRZ-1.png](/docs/images/api/qiskit/1.1/qiskit-circuit-library-GRZ-1.avif)
