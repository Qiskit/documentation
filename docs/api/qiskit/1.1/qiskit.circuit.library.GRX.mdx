---
title: GRX (v1.1)
description: API reference for qiskit.circuit.library.GRX in qiskit v1.1
...
$$
  ...
  **Expanded Circuit:**
  ...
  ![../\_images/qiskit-circuit-library-GRX-1.png](/docs/images/api/qiskit/1.1/qiskit-circuit-library-GRX-1.avif)
