---
title: OR (v1.1)
description: API reference for qiskit.circuit.library.OR in qiskit v1.1
...
<Class id="qiskit.circuit.library.OR" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.1/qiskit/circuit/library/boolean_logic/quantum_or.py#L22-L98" signature="qiskit.circuit.library.OR(num_variable_qubits, flags=None, mcx_mode='noancilla')" modifiers="class">
  ...
  ![../\_images/qiskit-circuit-library-OR-1.png](/docs/images/api/qiskit/1.1/qiskit-circuit-library-OR-1.avif)
  ...
  ![../\_images/qiskit-circuit-library-OR-2.png](/docs/images/api/qiskit/1.1/qiskit-circuit-library-OR-2.avif)
