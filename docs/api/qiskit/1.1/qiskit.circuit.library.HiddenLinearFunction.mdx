---
title: HiddenLinearFunction (v1.1)
description: API reference for qiskit.circuit.library.HiddenLinearFunction in qiskit v1.1
...
$$
  ...
  **Reference Circuit:**
  ...
  > ![../\_images/qiskit-circuit-library-HiddenLinearFunction-1.png](/docs/images/api/qiskit/1.1/qiskit-circuit-library-HiddenLinearFunction-1.avif)
