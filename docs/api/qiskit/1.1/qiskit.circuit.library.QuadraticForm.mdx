---
title: QuadraticForm (v1.1)
description: API reference for qiskit.circuit.library.QuadraticForm in qiskit v1.1
...
$$
  ...
  *   **offset** ([*float*](https://docs.python.org/3/library/functions.html#float)  *|*[*ParameterExpression*](qiskit.circuit.ParameterExpression "qiskit.circuit.parameterexpression.ParameterExpression") *| None*) – A constant offset, $c$.
