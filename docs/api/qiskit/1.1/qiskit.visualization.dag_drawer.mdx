---
title: dag_drawer (v1.1)
description: API reference for qiskit.visualization.dag_drawer in qiskit v1.1
...
<Function id="qiskit.visualization.dag_drawer" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.1/qiskit/utils/lazy_tester.py#L29-L230" signature="qiskit.visualization.dag_drawer(dag, scale=0.7, filename=None, style='color')">
