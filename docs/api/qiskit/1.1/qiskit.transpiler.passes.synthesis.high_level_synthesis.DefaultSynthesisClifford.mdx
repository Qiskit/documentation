---
title: DefaultSynthesisClifford (v1.1)
description: API reference for qiskit.transpiler.passes.synthesis.high_level_synthesis.DefaultSynthesisClifford in qiskit v1.1
