---
title: GR (v1.1)
description: API reference for qiskit.circuit.library.GR in qiskit v1.1
...
$$
  ...
  **Expanded Circuit:**
  ...
  ![../\_images/qiskit-circuit-library-GR-1.png](/docs/images/api/qiskit/1.1/qiskit-circuit-library-GR-1.avif)
