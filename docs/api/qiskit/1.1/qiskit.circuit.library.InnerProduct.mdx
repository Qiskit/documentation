---
title: InnerProduct (v1.1)
description: API reference for qiskit.circuit.library.InnerProduct in qiskit v1.1
...
$$
  ...
  **Reference Circuit:**
  ...
  ![../\_images/qiskit-circuit-library-InnerProduct-1.png](/docs/images/api/qiskit/1.1/qiskit-circuit-library-InnerProduct-1.avif)
