...
<Class id="qiskit.transpiler.passes.PadDelay" github="https://github.com/qiskit/qiskit/tree/stable/1.0/qiskit/transpiler/passes/scheduling/padding/pad_delay.py" signature="qiskit.transpiler.passes.PadDelay(*args, **kwargs)">
  Bases: `BasePadding`
