...
<Class id="qiskit.transpiler.passes.ConstrainedReschedule" github="https://github.com/qiskit/qiskit/tree/stable/1.0/qiskit/transpiler/passes/scheduling/alignments/reschedule.py" signature="qiskit.transpiler.passes.ConstrainedReschedule(*args, **kwargs)">
  ...
  *   **pulse\_alignment** – Integer number representing the minimum time resolution to trigger gate instruction in units of `dt`.
  ...
  <Function id="qiskit.transpiler.passes.ConstrainedReschedule.execute" name="execute" signature="execute(passmanager_ir, state, callback=None)">
  ...
  <Function id="qiskit.transpiler.passes.ConstrainedReschedule.name" name="name" signature="name()">
    Name of the pass.
  ...
  <Function id="qiskit.transpiler.passes.ConstrainedReschedule.run" name="run" signature="run(dag)">
    Run rescheduler.
  ...
  <Function id="qiskit.transpiler.passes.ConstrainedReschedule.update_status" name="update_status" signature="update_status(state, run_state)">
