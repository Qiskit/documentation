...
<Class id="qiskit.quantum_info.PTM" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.16/qiskit/quantum_info/operators/channel/ptm.py" signature="PTM(data, input_dims=None, output_dims=None)" modifiers="class">
...
$$
  ...
  **Additional Information:**
  ...
  <Function id="qiskit.quantum_info.PTM.__init__" signature="__init__(data, input_dims=None, output_dims=None)">
    Initialize a PTM quantum channel operator.
  ...
  <Function id="qiskit.quantum_info.PTM.add" signature="add(other)">
  ...
  <Function id="qiskit.quantum_info.PTM.adjoint" signature="adjoint()">
    Return the adjoint of the operator.
  </Function>

  ### atol

  <Function id="qiskit.quantum_info.PTM.atol" signature="atol" modifiers="property">
    The default absolute tolerance parameter for float comparisons.
  </Function>

  ### compose

  <Function id="qiskit.quantum_info.PTM.compose" signature="compose(other, qargs=None, front=False)">
  ...
  <Function id="qiskit.quantum_info.PTM.conjugate" signature="conjugate()">
    Return the conjugate of the QuantumChannel.
  </Function>

  ### copy

  <Function id="qiskit.quantum_info.PTM.copy" signature="copy()">
    Make a deep copy of current operator.
  </Function>

  ### data

  <Function id="qiskit.quantum_info.PTM.data" signature="data" modifiers="property">
    Return data.
  </Function>

  ### dim

  <Function id="qiskit.quantum_info.PTM.dim" signature="dim" modifiers="property">
    Return tuple (input\_shape, output\_shape).
  </Function>

  ### dot

  <Function id="qiskit.quantum_info.PTM.dot" signature="dot(other, qargs=None)">
  ...
  <Function id="qiskit.quantum_info.PTM.expand" signature="expand(other)">
  ...
  <Function id="qiskit.quantum_info.PTM.input_dims" signature="input_dims(qargs=None)">
    Return tuple of input dimension for specified subsystems.
  </Function>

  ### is\_cp

  <Function id="qiskit.quantum_info.PTM.is_cp" signature="is_cp(atol=None, rtol=None)">
    Test if Choi-matrix is completely-positive (CP)
  </Function>

  ### is\_cptp

  <Function id="qiskit.quantum_info.PTM.is_cptp" signature="is_cptp(atol=None, rtol=None)">
    Return True if completely-positive trace-preserving (CPTP).
  </Function>

  ### is\_tp

  <Function id="qiskit.quantum_info.PTM.is_tp" signature="is_tp(atol=None, rtol=None)">
    Test if a channel is completely-positive (CP)
  </Function>

  ### is\_unitary

  <Function id="qiskit.quantum_info.PTM.is_unitary" signature="is_unitary(atol=None, rtol=None)">
    Return True if QuantumChannel is a unitary channel.
  </Function>

  ### multiply

  <Function id="qiskit.quantum_info.PTM.multiply" signature="multiply(other)">
  ...
  <Function id="qiskit.quantum_info.PTM.num_qubits" signature="num_qubits" modifiers="property">
    Return the number of qubits if a N-qubit operator or None otherwise.
  </Function>

  ### output\_dims

  <Function id="qiskit.quantum_info.PTM.output_dims" signature="output_dims(qargs=None)">
    Return tuple of output dimension for specified subsystems.
  </Function>

  ### power

  <Function id="qiskit.quantum_info.PTM.power" signature="power(n)">
  ...
  <Function id="qiskit.quantum_info.PTM.qargs" signature="qargs" modifiers="property">
    Return the qargs for the operator.
  </Function>

  ### reshape

  <Function id="qiskit.quantum_info.PTM.reshape" signature="reshape(input_dims=None, output_dims=None)">
  ...
  <Function id="qiskit.quantum_info.PTM.rtol" signature="rtol" modifiers="property">
    The relative tolerance parameter for float comparisons.
  </Function>

  ### set\_atol

  <Function id="qiskit.quantum_info.PTM.set_atol" signature="set_atol(value)" modifiers="classmethod">
  ...
  <Function id="qiskit.quantum_info.PTM.set_rtol" signature="set_rtol(value)" modifiers="classmethod">
  ...
  <Function id="qiskit.quantum_info.PTM.subtract" signature="subtract(other)">
    Return the linear operator self - other.
  ...
  <Function id="qiskit.quantum_info.PTM.tensor" signature="tensor(other)">
  ...
  <Function id="qiskit.quantum_info.PTM.to_instruction" signature="to_instruction()">
  ...
  <Function id="qiskit.quantum_info.PTM.to_operator" signature="to_operator()">
    Try to convert channel to a unitary representation Operator.
  </Function>

  ### transpose

  <Function id="qiskit.quantum_info.PTM.transpose" signature="transpose()">
