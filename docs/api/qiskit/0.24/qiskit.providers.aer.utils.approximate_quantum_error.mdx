---
title: approximate_quantum_error (v0.24)
description: API reference for qiskit.providers.aer.utils.approximate_quantum_error in qiskit v0.24
...
<Function id="qiskit.providers.aer.utils.approximate_quantum_error" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-aer/tree/stable/0.7/qiskit/providers/aer/utils/noise_transformation.py" signature="approximate_quantum_error(error, *, operator_string=None, operator_dict=None, operator_list=None)">
