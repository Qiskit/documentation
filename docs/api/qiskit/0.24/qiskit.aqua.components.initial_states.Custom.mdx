...
<Class id="qiskit.aqua.components.initial_states.Custom" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.8/qiskit/aqua/components/initial_states/custom.py" signature="Custom(num_qubits, state='zero', state_vector=None, circuit=None)">
  ...
  **Raises**
  ...
  <Function id="qiskit.aqua.components.initial_states.Custom.bitstr" signature="property bitstr" />
