...
<Function id="qiskit.converters.circuit_to_dag" github="https://github.com/qiskit/qiskit/tree/stable/0.16/qiskit/converters/circuit_to_dag.py" signature="circuit_to_dag(circuit)">
