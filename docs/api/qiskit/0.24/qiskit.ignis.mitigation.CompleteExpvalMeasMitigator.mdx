...
<Class id="qiskit.ignis.mitigation.CompleteExpvalMeasMitigator" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-ignis/tree/stable/0.5/qiskit/ignis/mitigation/expval/complete_mitigator.py" signature="CompleteExpvalMeasMitigator(amat)">
  ...
  **amat** (*np.array*) – readout error assignment matrix.
  ...
  <Function id="qiskit.ignis.mitigation.CompleteExpvalMeasMitigator.__init__" name="__init__" signature="__init__(amat)">
    Initialize a TensorMeasurementMitigator
  ...
  <Function id="qiskit.ignis.mitigation.CompleteExpvalMeasMitigator.assignment_fidelity" name="assignment_fidelity" signature="assignment_fidelity(qubits=None)">
  ...
  <Function id="qiskit.ignis.mitigation.CompleteExpvalMeasMitigator.assignment_matrix" name="assignment_matrix" signature="assignment_matrix(qubits=None)">
  ...
  <Function id="qiskit.ignis.mitigation.CompleteExpvalMeasMitigator.expectation_value" name="expectation_value" signature="expectation_value(counts, diagonal=None, qubits=None, clbits=None)">
  ...
  <Function id="qiskit.ignis.mitigation.CompleteExpvalMeasMitigator.mitigation_matrix" name="mitigation_matrix" signature="mitigation_matrix(qubits=None)">
  ...
  <Function id="qiskit.ignis.mitigation.CompleteExpvalMeasMitigator.mitigation_overhead" name="mitigation_overhead" signature="mitigation_overhead(qubits=None)">
  ...
  <Function id="qiskit.ignis.mitigation.CompleteExpvalMeasMitigator.plot_assignment_matrix" name="plot_assignment_matrix" signature="plot_assignment_matrix(qubits=None, ax=None)">
  ...
  <Function id="qiskit.ignis.mitigation.CompleteExpvalMeasMitigator.plot_mitigation_matrix" name="plot_mitigation_matrix" signature="plot_mitigation_matrix(qubits=None, ax=None)">
  ...
  <Function id="qiskit.ignis.mitigation.CompleteExpvalMeasMitigator.required_shots" name="required_shots" signature="required_shots(delta, qubits=None)">
  ...
  <Function id="qiskit.ignis.mitigation.CompleteExpvalMeasMitigator.stddev_upper_bound" name="stddev_upper_bound" signature="stddev_upper_bound(shots=1, qubits=None)">
