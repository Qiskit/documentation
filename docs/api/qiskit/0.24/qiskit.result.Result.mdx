...
<Class id="qiskit.result.Result" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.16/qiskit/result/result.py" signature="Result(backend_name, backend_version, qobj_id, job_id, success, results, date=None, status=None, header=None, **kwargs)">
  Model for Results.
  ...
  <Function id="qiskit.result.Result.__init__" name="__init__" signature="__init__(backend_name, backend_version, qobj_id, job_id, success, results, date=None, status=None, header=None, **kwargs)">
  ...
  <Function id="qiskit.result.Result.data" name="data" signature="data(experiment=None)">
  ...
  <Function id="qiskit.result.Result.from_dict" name="from_dict" signature="classmethod from_dict(data)">
  ...
  <Function id="qiskit.result.Result.get_counts" name="get_counts" signature="get_counts(experiment=None)">
  ...
  <Function id="qiskit.result.Result.get_memory" name="get_memory" signature="get_memory(experiment=None)">
  ...
  <Function id="qiskit.result.Result.get_statevector" name="get_statevector" signature="get_statevector(experiment=None, decimals=None)">
  ...
  <Function id="qiskit.result.Result.get_unitary" name="get_unitary" signature="get_unitary(experiment=None, decimals=None)">
  ...
  <Function id="qiskit.result.Result.to_dict" name="to_dict" signature="to_dict()">
