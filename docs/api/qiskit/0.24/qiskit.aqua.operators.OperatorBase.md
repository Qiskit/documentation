...
`OperatorBase` [GitHub](https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.8/qiskit/aqua/operators/operator_base.py "view source code")
...
<span id="qiskit.aqua.operators.OperatorBase.__init__" />
