...
<Class id="qiskit.aqua.algorithms.NumPyLSsolver" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.8/qiskit/aqua/algorithms/linear_solvers/numpy_ls_solver.py" signature="NumPyLSsolver(matrix, vector)">
  ...
  *   **vector** (`Union`\[`List`\[`float`], `ndarray`]) – The input vector of linear system of equations
  ...
  <Function id="qiskit.aqua.algorithms.NumPyLSsolver.random" signature="property random">
