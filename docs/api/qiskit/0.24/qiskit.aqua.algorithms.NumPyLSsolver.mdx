...
<Class id="qiskit.aqua.algorithms.NumPyLSsolver" github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.8/qiskit/aqua/algorithms/linear_solvers/numpy_ls_solver.py" signature="NumPyLSsolver(matrix, vector)">
