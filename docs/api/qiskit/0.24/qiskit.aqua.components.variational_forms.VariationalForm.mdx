...
<Class id="qiskit.aqua.components.variational_forms.VariationalForm" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.8/qiskit/aqua/components/variational_forms/variational_form.py" signature="VariationalForm">
  ...
  <Function id="qiskit.aqua.components.variational_forms.VariationalForm.__init__" signature="abstract __init__()">
  ...
  <Function id="qiskit.aqua.components.variational_forms.VariationalForm.construct_circuit" signature="abstract construct_circuit(parameters, q=None)">
  ...
  <Function id="qiskit.aqua.components.variational_forms.VariationalForm.get_entangler_map" signature="static get_entangler_map(map_type, num_qubits, offset=0)">
    returns entangler map
  </Function>

  ### num\_parameters

  <Function id="qiskit.aqua.components.variational_forms.VariationalForm.num_parameters" signature="property num_parameters">
  ...
  <Function id="qiskit.aqua.components.variational_forms.VariationalForm.num_qubits" signature="property num_qubits">
  ...
  <Function id="qiskit.aqua.components.variational_forms.VariationalForm.parameter_bounds" signature="property parameter_bounds">
    Parameter bounds.
  ...
  <Function id="qiskit.aqua.components.variational_forms.VariationalForm.preferred_init_points" signature="property preferred_init_points">
  ...
  <Function id="qiskit.aqua.components.variational_forms.VariationalForm.setting" signature="property setting" />

  ### support\_parameterized\_circuit

  <Function id="qiskit.aqua.components.variational_forms.VariationalForm.support_parameterized_circuit" signature="property support_parameterized_circuit">
  ...
  <Function id="qiskit.aqua.components.variational_forms.VariationalForm.validate_entangler_map" signature="static validate_entangler_map(entangler_map, num_qubits)">
