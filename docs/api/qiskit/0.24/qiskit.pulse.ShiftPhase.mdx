...
<Class id="qiskit.pulse.ShiftPhase" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.16/qiskit/pulse/instructions/phase.py" signature="ShiftPhase(phase, channel, name=None)">
...
$$
  ...
  *   **name** (`Optional`\[`str`]) – Display name for this instruction.
  ...
  <Function id="qiskit.pulse.ShiftPhase.command" name="command" signature="property command">
  ...
  <Function id="qiskit.pulse.ShiftPhase.timeslots" name="timeslots" signature="property timeslots">
