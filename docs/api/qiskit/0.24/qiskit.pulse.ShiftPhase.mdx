...
$$
  ...
  *   **name** (`Optional`\[`str`]) – Display name for this instruction.
  ...
  <Function id="qiskit.pulse.ShiftPhase.command" signature="command" modifiers="property">
  ...
  <Function id="qiskit.pulse.ShiftPhase.timeslots" signature="timeslots" modifiers="property">
