...
<Class id="qiskit.transpiler.passes.Size" github="https://github.com/qiskit/qiskit/tree/stable/0.16/qiskit/transpiler/passes/analysis/size.py" signature="Size(*args, **kwargs)">
