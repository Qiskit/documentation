---
title: marginal_counts (v0.24)
description: API reference for qiskit.result.marginal_counts in qiskit v0.24
...
<Function id="qiskit.result.marginal_counts" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.16/qiskit/result/utils.py" signature="marginal_counts(result, indices=None, inplace=False)">
