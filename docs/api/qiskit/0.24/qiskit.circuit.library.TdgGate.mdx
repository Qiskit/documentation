...
<Class id="qiskit.circuit.library.TdgGate" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.16/qiskit/circuit/library/standard_gates/t.py" signature="TdgGate(label=None)" modifiers="class">
...
$$
  ...
  **Circuit symbol:**
  ...
  <Function id="qiskit.circuit.library.TdgGate.__init__" signature="__init__(label=None)">
    Create new Tdg gate.
  </Function>
  ...
  <Function id="qiskit.circuit.library.TdgGate.add_decomposition" signature="add_decomposition(decomposition)">
    Add a decomposition of the instruction to the SessionEquivalenceLibrary.
  </Function>

  ### assemble

  <Function id="qiskit.circuit.library.TdgGate.assemble" signature="assemble()">
  ...
  <Function id="qiskit.circuit.library.TdgGate.broadcast_arguments" signature="broadcast_arguments(qargs, cargs)">
  ...
  <Function id="qiskit.circuit.library.TdgGate.c_if" signature="c_if(classical, val)">
    Add classical condition on register classical and value val.
  </Function>

  ### control

  <Function id="qiskit.circuit.library.TdgGate.control" signature="control(num_ctrl_qubits=1, label=None, ctrl_state=None)">
  ...
  <Function id="qiskit.circuit.library.TdgGate.copy" signature="copy(name=None)">
  ...
  <Function id="qiskit.circuit.library.TdgGate.decompositions" signature="decompositions" modifiers="property">
    Get the decompositions of the instruction from the SessionEquivalenceLibrary.
  </Function>

  ### definition

  <Function id="qiskit.circuit.library.TdgGate.definition" signature="definition" modifiers="property">
    Return definition in terms of other basic gates.
  </Function>

  ### duration

  <Function id="qiskit.circuit.library.TdgGate.duration" signature="duration" modifiers="property">
    Get the duration.
  </Function>

  ### inverse

  <Function id="qiskit.circuit.library.TdgGate.inverse" signature="inverse()">
    Return inverse Tdg gate (i.e. T).
  </Function>

  ### is\_parameterized

  <Function id="qiskit.circuit.library.TdgGate.is_parameterized" signature="is_parameterized()">
    Return True .IFF. instruction is parameterized else False
  </Function>

  ### label

  <Function id="qiskit.circuit.library.TdgGate.label" signature="label" modifiers="property">
    Return gate label
  ...
  <Function id="qiskit.circuit.library.TdgGate.mirror" signature="mirror()">
  ...
  <Function id="qiskit.circuit.library.TdgGate.params" signature="params" modifiers="property">
    return instruction params.
  </Function>

  ### power

  <Function id="qiskit.circuit.library.TdgGate.power" signature="power(exponent)">
  ...
  <Function id="qiskit.circuit.library.TdgGate.qasm" signature="qasm()">
  ...
  <Function id="qiskit.circuit.library.TdgGate.repeat" signature="repeat(n)">
  ...
  <Function id="qiskit.circuit.library.TdgGate.reverse_ops" signature="reverse_ops()">
  ...
  <Function id="qiskit.circuit.library.TdgGate.to_matrix" signature="to_matrix()">
    Return a numpy.array for the inverse T gate.
  </Function>

  ### unit

  <Function id="qiskit.circuit.library.TdgGate.unit" signature="unit" modifiers="property">
    Get the time unit of duration.
  </Function>

  ### validate\_parameter

  <Function id="qiskit.circuit.library.TdgGate.validate_parameter" signature="validate_parameter(parameter)">
