---
title: MultivariateVariationalDistribution (v0.24)
description: API reference for qiskit.aqua.components.uncertainty_models.MultivariateVariationalDistribution in qiskit v0.24
