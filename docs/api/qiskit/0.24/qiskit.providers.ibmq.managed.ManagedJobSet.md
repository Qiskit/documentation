...
# qiskit.providers.ibmq.managed.ManagedJobSet[¶](#qiskit-providers-ibmq-managed-managedjobset "Permalink to this headline")
...
*   **assemble\_config** (`Any`) – Additional arguments used to configure the Qobj assembly. Refer to the [`qiskit.compiler.assemble()`](qiskit.compiler.assemble#qiskit.compiler.assemble "qiskit.compiler.assemble") documentation for details on these arguments.
