...
<Class id="qiskit.circuit.Reset" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.16/qiskit/circuit/reset.py" signature="Reset" modifiers="class">
  Qubit reset.
  ...
  <Function id="qiskit.circuit.Reset.decompositions" signature="decompositions" modifiers="property">
    Get the decompositions of the instruction from the SessionEquivalenceLibrary.
  </Function>

  ### definition

  <Function id="qiskit.circuit.Reset.definition" signature="definition" modifiers="property">
    Return definition in terms of other basic gates.
  </Function>

  ### duration

  <Function id="qiskit.circuit.Reset.duration" signature="duration" modifiers="property">
    Get the duration.
  </Function>
  ...
  <Function id="qiskit.circuit.Reset.params" signature="params" modifiers="property">
  ...
  <Function id="qiskit.circuit.Reset.unit" signature="unit" modifiers="property">
