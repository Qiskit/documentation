...
<Function id="qiskit.pulse.builder.align_func" name="align_func" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.16/qiskit/pulse/builder.py" signature="align_func(duration, func)">
