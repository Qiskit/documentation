...
<Class id="qiskit.aqua.circuits.CNF" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.8/qiskit/aqua/circuits/boolean_logical_circuits.py" signature="CNF(ast, num_vars=None)">
  ...
  **Raises**
  ...
  <Function id="qiskit.aqua.circuits.CNF.__init__" name="__init__" signature="__init__(ast, num_vars=None)">
    Constructor.
  ...
  <Function id="qiskit.aqua.circuits.CNF.ancillary_register" name="ancillary_register" signature="property ancillary_register">
    returns ancillary register
  </Function>

  ### clause\_register

  <Function id="qiskit.aqua.circuits.CNF.clause_register" name="clause_register" signature="property clause_register">
    returns clause register
  </Function>

  ### compute\_num\_ancillae

  <Function id="qiskit.aqua.circuits.CNF.compute_num_ancillae" name="compute_num_ancillae" signature="compute_num_ancillae(mct_mode='basic')">
    returns the number of ancillary qubits needed
  </Function>

  ### construct\_circuit

  <Function id="qiskit.aqua.circuits.CNF.construct_circuit" name="construct_circuit" signature="construct_circuit(circuit=None, variable_register=None, clause_register=None, output_register=None, ancillary_register=None, mct_mode='basic')">
    Construct circuit.
  ...
  <Function id="qiskit.aqua.circuits.CNF.num_clauses" name="num_clauses" signature="property num_clauses">
    returns num clauses
  </Function>

  ### num\_variables

  <Function id="qiskit.aqua.circuits.CNF.num_variables" name="num_variables" signature="property num_variables">
    return num variables
  </Function>

  ### output\_register

  <Function id="qiskit.aqua.circuits.CNF.output_register" name="output_register" signature="property output_register">
    returns output register
  </Function>

  ### variable\_register

  <Function id="qiskit.aqua.circuits.CNF.variable_register" name="variable_register" signature="property variable_register">
