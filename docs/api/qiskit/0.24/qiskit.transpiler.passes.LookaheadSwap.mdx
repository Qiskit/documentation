...
<Class id="qiskit.transpiler.passes.LookaheadSwap" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.16/qiskit/transpiler/passes/routing/lookahead_swap.py" signature="LookaheadSwap(*args, **kwargs)" modifiers="class">
  ...
  *   **search\_width** (*int*) – lookahead tree width when ranking best SWAP options.
  ...
  <Function id="qiskit.transpiler.passes.LookaheadSwap.__init__" signature="__init__(coupling_map, search_depth=4, search_width=4)">
    LookaheadSwap initializer.
  ...
  <Function id="qiskit.transpiler.passes.LookaheadSwap.is_analysis_pass" signature="is_analysis_pass" modifiers="property">
  ...
  <Function id="qiskit.transpiler.passes.LookaheadSwap.is_transformation_pass" signature="is_transformation_pass" modifiers="property">
  ...
  <Function id="qiskit.transpiler.passes.LookaheadSwap.name" signature="name()">
    Return the name of the pass.
  </Function>

  ### run

  <Function id="qiskit.transpiler.passes.LookaheadSwap.run" signature="run(dag)">
