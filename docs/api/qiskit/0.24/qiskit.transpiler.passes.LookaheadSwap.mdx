...
<Class id="qiskit.transpiler.passes.LookaheadSwap" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.16/qiskit/transpiler/passes/routing/lookahead_swap.py" signature="LookaheadSwap(*args, **kwargs)">
  ...
  *   **search\_width** (*int*) – lookahead tree width when ranking best SWAP options.
  ...
  <Function id="qiskit.transpiler.passes.LookaheadSwap.__init__" name="__init__" signature="__init__(coupling_map, search_depth=4, search_width=4)">
    LookaheadSwap initializer.
  ...
  <Function id="qiskit.transpiler.passes.LookaheadSwap.is_analysis_pass" name="is_analysis_pass" signature="property is_analysis_pass">
  ...
  <Function id="qiskit.transpiler.passes.LookaheadSwap.is_transformation_pass" name="is_transformation_pass" signature="property is_transformation_pass">
