...
<Class id="qiskit.optimization.QiskitOptimizationError" github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.8/qiskit/optimization/exceptions.py" signature="QiskitOptimizationError(*message)">
