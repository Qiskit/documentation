---
title: WatsonHamiltonian (v0.24)
description: API reference for qiskit.chemistry.WatsonHamiltonian in qiskit v0.24
...
<Class id="qiskit.chemistry.WatsonHamiltonian" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.8/qiskit/chemistry/watson_hamiltonian.py" signature="WatsonHamiltonian(data, num_modes)" modifiers="class">
