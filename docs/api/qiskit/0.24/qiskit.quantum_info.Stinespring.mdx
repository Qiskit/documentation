...
<Class id="qiskit.quantum_info.Stinespring" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.16/qiskit/quantum_info/operators/channel/stinespring.py" signature="Stinespring(data, input_dims=None, output_dims=None)">
...
$$
  ...
  **Additional Information:**
  ...
  <Function id="qiskit.quantum_info.Stinespring.__init__" name="__init__" signature="__init__(data, input_dims=None, output_dims=None)">
    Initialize a quantum channel Stinespring operator.
  ...
  <Function id="qiskit.quantum_info.Stinespring.add" name="add" signature="add(other)">
  ...
  <Function id="qiskit.quantum_info.Stinespring.adjoint" name="adjoint" signature="adjoint()">
    Return the adjoint of the operator.
  </Function>

  ### atol

  <Function id="qiskit.quantum_info.Stinespring.atol" name="atol" signature="property atol">
    The default absolute tolerance parameter for float comparisons.
  </Function>

  ### compose

  <Function id="qiskit.quantum_info.Stinespring.compose" name="compose" signature="compose(other, qargs=None, front=False)">
  ...
  <Function id="qiskit.quantum_info.Stinespring.conjugate" name="conjugate" signature="conjugate()">
    Return the conjugate of the QuantumChannel.
  </Function>

  ### copy

  <Function id="qiskit.quantum_info.Stinespring.copy" name="copy" signature="copy()">
    Make a deep copy of current operator.
  </Function>

  ### data

  <Function id="qiskit.quantum_info.Stinespring.data" name="data" signature="property data">
    Return data.
  </Function>

  ### dim

  <Function id="qiskit.quantum_info.Stinespring.dim" name="dim" signature="property dim">
    Return tuple (input\_shape, output\_shape).
  </Function>

  ### dot

  <Function id="qiskit.quantum_info.Stinespring.dot" name="dot" signature="dot(other, qargs=None)">
  ...
  <Function id="qiskit.quantum_info.Stinespring.expand" name="expand" signature="expand(other)">
  ...
  <Function id="qiskit.quantum_info.Stinespring.input_dims" name="input_dims" signature="input_dims(qargs=None)">
    Return tuple of input dimension for specified subsystems.
  </Function>

  ### is\_cp

  <Function id="qiskit.quantum_info.Stinespring.is_cp" name="is_cp" signature="is_cp(atol=None, rtol=None)">
    Test if Choi-matrix is completely-positive (CP)
  </Function>

  ### is\_cptp

  <Function id="qiskit.quantum_info.Stinespring.is_cptp" name="is_cptp" signature="is_cptp(atol=None, rtol=None)">
    Return True if completely-positive trace-preserving.
  </Function>

  ### is\_tp

  <Function id="qiskit.quantum_info.Stinespring.is_tp" name="is_tp" signature="is_tp(atol=None, rtol=None)">
    Test if a channel is completely-positive (CP)
  </Function>

  ### is\_unitary

  <Function id="qiskit.quantum_info.Stinespring.is_unitary" name="is_unitary" signature="is_unitary(atol=None, rtol=None)">
    Return True if QuantumChannel is a unitary channel.
  </Function>

  ### multiply

  <Function id="qiskit.quantum_info.Stinespring.multiply" name="multiply" signature="multiply(other)">
  ...
  <Function id="qiskit.quantum_info.Stinespring.num_qubits" name="num_qubits" signature="property num_qubits">
    Return the number of qubits if a N-qubit operator or None otherwise.
  </Function>

  ### output\_dims

  <Function id="qiskit.quantum_info.Stinespring.output_dims" name="output_dims" signature="output_dims(qargs=None)">
    Return tuple of output dimension for specified subsystems.
  </Function>

  ### power

  <Function id="qiskit.quantum_info.Stinespring.power" name="power" signature="power(n)">
  ...
  <Function id="qiskit.quantum_info.Stinespring.qargs" name="qargs" signature="property qargs">
    Return the qargs for the operator.
  </Function>

  ### reshape

  <Function id="qiskit.quantum_info.Stinespring.reshape" name="reshape" signature="reshape(input_dims=None, output_dims=None)">
  ...
  <Function id="qiskit.quantum_info.Stinespring.rtol" name="rtol" signature="property rtol">
    The relative tolerance parameter for float comparisons.
  </Function>

  ### set\_atol

  <Function id="qiskit.quantum_info.Stinespring.set_atol" name="set_atol" signature="classmethod set_atol(value)">
  ...
  <Function id="qiskit.quantum_info.Stinespring.set_rtol" name="set_rtol" signature="classmethod set_rtol(value)">
  ...
  <Function id="qiskit.quantum_info.Stinespring.subtract" name="subtract" signature="subtract(other)">
    Return the linear operator self - other.
  ...
  <Function id="qiskit.quantum_info.Stinespring.tensor" name="tensor" signature="tensor(other)">
  ...
  <Function id="qiskit.quantum_info.Stinespring.to_instruction" name="to_instruction" signature="to_instruction()">
  ...
  <Function id="qiskit.quantum_info.Stinespring.to_operator" name="to_operator" signature="to_operator()">
    Try to convert channel to a unitary representation Operator.
  </Function>

  ### transpose

  <Function id="qiskit.quantum_info.Stinespring.transpose" name="transpose" signature="transpose()">
