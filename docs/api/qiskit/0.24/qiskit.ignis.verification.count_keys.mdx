...
<Function id="qiskit.ignis.verification.count_keys" github="https://github.com/qiskit-community/qiskit-ignis/tree/stable/0.5/qiskit/ignis/verification/tomography/data.py" signature="count_keys(num_qubits)">
