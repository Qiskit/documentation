...
<Function id="qiskit.validation.jsonschema.validate_json_against_schema" github="https://github.com/qiskit/qiskit/tree/stable/0.16/qiskit/validation/jsonschema/schema_validation.py" signature="validate_json_against_schema(json_dict, schema, err_msg=None)">
