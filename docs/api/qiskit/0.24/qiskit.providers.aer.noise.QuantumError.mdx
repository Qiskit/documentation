...
<Class id="qiskit.providers.aer.noise.QuantumError" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-aer/tree/stable/0.7/qiskit/providers/aer/noise/errors/quantum_error.py" signature="QuantumError(noise_ops, number_of_qubits=None, standard_gates=True, atol=1e-08)">
  ...
  **NoiseError** – If input noise\_ops are not a CPTP map.
  ...
  <Function id="qiskit.providers.aer.noise.QuantumError.atol" signature="property atol">
    The default absolute tolerance parameter for float comparisons.
  </Function>

  ### circuits

  <Function id="qiskit.providers.aer.noise.QuantumError.circuits" signature="property circuits">
  ...
  <Function id="qiskit.providers.aer.noise.QuantumError.number_of_qubits" signature="property number_of_qubits">
  ...
  <Function id="qiskit.providers.aer.noise.QuantumError.probabilities" signature="property probabilities">
    Return the list of error probabilities.
  </Function>

  ### rtol

  <Function id="qiskit.providers.aer.noise.QuantumError.rtol" signature="property rtol">
    The relative tolerance parameter for float comparisons.
  </Function>

  ### set\_atol

  <Function id="qiskit.providers.aer.noise.QuantumError.set_atol" signature="classmethod set_atol(value)">
    Set the class default absolute tolerance parameter for float comparisons.
  </Function>

  ### set\_rtol

  <Function id="qiskit.providers.aer.noise.QuantumError.set_rtol" signature="classmethod set_rtol(value)">
    Set the class default relative tolerance parameter for float comparisons.
  </Function>

  ### size

  <Function id="qiskit.providers.aer.noise.QuantumError.size" signature="property size">
