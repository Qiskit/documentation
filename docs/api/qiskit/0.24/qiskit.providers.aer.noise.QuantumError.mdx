...
<Class id="qiskit.providers.aer.noise.QuantumError" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-aer/tree/stable/0.7/qiskit/providers/aer/noise/errors/quantum_error.py" signature="QuantumError(noise_ops, number_of_qubits=None, standard_gates=True, atol=1e-08)" modifiers="class">
  ...
  **NoiseError** – If input noise\_ops are not a CPTP map.
  ...
  <Function id="qiskit.providers.aer.noise.QuantumError.atol" signature="atol" modifiers="property">
    The default absolute tolerance parameter for float comparisons.
  </Function>

  ### circuits

  <Function id="qiskit.providers.aer.noise.QuantumError.circuits" signature="circuits" modifiers="property">
  ...
  <Function id="qiskit.providers.aer.noise.QuantumError.number_of_qubits" signature="number_of_qubits" modifiers="property">
  ...
  <Function id="qiskit.providers.aer.noise.QuantumError.probabilities" signature="probabilities" modifiers="property">
    Return the list of error probabilities.
  </Function>

  ### rtol

  <Function id="qiskit.providers.aer.noise.QuantumError.rtol" signature="rtol" modifiers="property">
  ...
  <Function id="qiskit.providers.aer.noise.QuantumError.size" signature="size" modifiers="property">
