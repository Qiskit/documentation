...
<Class id="qiskit.providers.aer.noise.QuantumError" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-aer/tree/stable/0.7/qiskit/providers/aer/noise/errors/quantum_error.py" signature="QuantumError(noise_ops, number_of_qubits=None, standard_gates=True, atol=1e-08)">
  ...
  **NoiseError** – If input noise\_ops are not a CPTP map.
  ...
  <Function id="qiskit.providers.aer.noise.QuantumError.__init__" name="__init__" signature="__init__(noise_ops, number_of_qubits=None, standard_gates=True, atol=1e-08)">
    Create a quantum error for a noise model.
  ...
  <Function id="qiskit.providers.aer.noise.QuantumError.atol" name="atol" signature="property atol">
    The default absolute tolerance parameter for float comparisons.
  </Function>

  ### circuits

  <Function id="qiskit.providers.aer.noise.QuantumError.circuits" name="circuits" signature="property circuits">
    Return the list of error circuits.
  </Function>

  ### compose

  <Function id="qiskit.providers.aer.noise.QuantumError.compose" name="compose" signature="compose(other, front=False)">
  ...
  <Function id="qiskit.providers.aer.noise.QuantumError.copy" name="copy" signature="copy()">
    Make a copy of current QuantumError.
  </Function>

  ### dot

  <Function id="qiskit.providers.aer.noise.QuantumError.dot" name="dot" signature="dot(other)">
  ...
  <Function id="qiskit.providers.aer.noise.QuantumError.error_term" name="error_term" signature="error_term(position)">
  ...
  <Function id="qiskit.providers.aer.noise.QuantumError.expand" name="expand" signature="expand(other)">
  ...
  <Function id="qiskit.providers.aer.noise.QuantumError.ideal" name="ideal" signature="ideal()">
    Return True if current error object is an identity
  </Function>

  ### number\_of\_qubits

  <Function id="qiskit.providers.aer.noise.QuantumError.number_of_qubits" name="number_of_qubits" signature="property number_of_qubits">
    Return the number of qubits for the error.
  </Function>

  ### power

  <Function id="qiskit.providers.aer.noise.QuantumError.power" name="power" signature="power(n)">
  ...
  <Function id="qiskit.providers.aer.noise.QuantumError.probabilities" name="probabilities" signature="property probabilities">
    Return the list of error probabilities.
  </Function>

  ### rtol

  <Function id="qiskit.providers.aer.noise.QuantumError.rtol" name="rtol" signature="property rtol">
    The relative tolerance parameter for float comparisons.
  </Function>

  ### set\_atol

  <Function id="qiskit.providers.aer.noise.QuantumError.set_atol" name="set_atol" signature="classmethod set_atol(value)">
    Set the class default absolute tolerance parameter for float comparisons.
  </Function>

  ### set\_rtol

  <Function id="qiskit.providers.aer.noise.QuantumError.set_rtol" name="set_rtol" signature="classmethod set_rtol(value)">
    Set the class default relative tolerance parameter for float comparisons.
  </Function>

  ### size

  <Function id="qiskit.providers.aer.noise.QuantumError.size" name="size" signature="property size">
    Return the number of error circuit.
  </Function>

  ### tensor

  <Function id="qiskit.providers.aer.noise.QuantumError.tensor" name="tensor" signature="tensor(other)">
    Return the tensor product quantum error channel self ⊗ other.
  ...
  <Function id="qiskit.providers.aer.noise.QuantumError.to_dict" name="to_dict" signature="to_dict()">
    Return the current error as a dictionary.
  </Function>

  ### to\_instruction

  <Function id="qiskit.providers.aer.noise.QuantumError.to_instruction" name="to_instruction" signature="to_instruction()">
    Convert the QuantumError to a circuit Instruction.
  </Function>

  ### to\_quantumchannel

  <Function id="qiskit.providers.aer.noise.QuantumError.to_quantumchannel" name="to_quantumchannel" signature="to_quantumchannel()">
