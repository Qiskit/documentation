...
<Function id="qiskit.converters.circuit_to_gate" name="circuit_to_gate" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.16/qiskit/converters/circuit_to_gate.py" signature="circuit_to_gate(circuit, parameter_map=None, equivalence_library=None, label=None)">
