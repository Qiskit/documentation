---
title: sequence (v0.24)
description: API reference for qiskit.compiler.sequence in qiskit v0.24
...
<Function id="qiskit.compiler.sequence" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.16/qiskit/compiler/sequence.py" signature="sequence(scheduled_circuits, backend=None, inst_map=None, meas_map=None, dt=None)">
