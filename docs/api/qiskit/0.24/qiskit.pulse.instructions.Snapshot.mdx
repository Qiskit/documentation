...
<Class id="qiskit.pulse.instructions.Snapshot" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.16/qiskit/pulse/instructions/snapshot.py" signature="Snapshot(label, snapshot_type='statevector', name=None)">
  ...
  **Raises**
  ...
  <Function id="qiskit.pulse.instructions.Snapshot.__init__" name="__init__" signature="__init__(label, snapshot_type='statevector', name=None)">
    Create new snapshot.
  ...
  <Function id="qiskit.pulse.instructions.Snapshot.assign_parameters" name="assign_parameters" signature="assign_parameters(value_dict)">
  ...
  <Function id="qiskit.pulse.instructions.Snapshot.channel" name="channel" signature="property channel">
  ...
  <Function id="qiskit.pulse.instructions.Snapshot.channels" name="channels" signature="property channels">
  ...
  <Function id="qiskit.pulse.instructions.Snapshot.command" name="command" signature="property command">
  ...
  <Function id="qiskit.pulse.instructions.Snapshot.draw" name="draw" signature="draw(dt=1, style=None, filename=None, interp_method=None, scale=1, plot_all=False, plot_range=None, interactive=False, table=True, label=False, framechange=True, channels=None)">
  ...
  <Function id="qiskit.pulse.instructions.Snapshot.duration" name="duration" signature="property duration">
  ...
  <Function id="qiskit.pulse.instructions.Snapshot.flatten" name="flatten" signature="flatten()">
  ...
  <Function id="qiskit.pulse.instructions.Snapshot.id" name="id" signature="property id">
  ...
  <Function id="qiskit.pulse.instructions.Snapshot.instructions" name="instructions" signature="property instructions">
  ...
  <Function id="qiskit.pulse.instructions.Snapshot.label" name="label" signature="property label">
    Label of snapshot.
  ...
  <Function id="qiskit.pulse.instructions.Snapshot.name" name="name" signature="property name">
  ...
  <Function id="qiskit.pulse.instructions.Snapshot.operands" name="operands" signature="property operands">
  ...
  <Function id="qiskit.pulse.instructions.Snapshot.start_time" name="start_time" signature="property start_time">
  ...
  <Function id="qiskit.pulse.instructions.Snapshot.stop_time" name="stop_time" signature="property stop_time">
  ...
  <Function id="qiskit.pulse.instructions.Snapshot.timeslots" name="timeslots" signature="property timeslots">
  ...
  <Function id="qiskit.pulse.instructions.Snapshot.type" name="type" signature="property type">
    Type of snapshot.
