...
<Class id="qiskit.pulse.instructions.Snapshot" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.16/qiskit/pulse/instructions/snapshot.py" signature="Snapshot(label, snapshot_type='statevector', name=None)">
  ...
  **Raises**
  ...
  <Function id="qiskit.pulse.instructions.Snapshot.command" signature="property command">
  ...
  <Function id="qiskit.pulse.instructions.Snapshot.timeslots" signature="property timeslots">
