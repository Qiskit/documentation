...
<Class id="qiskit.qobj.PulseQobjConfig" github="https://github.com/qiskit/qiskit/tree/stable/0.16/qiskit/qobj/pulse_qobj.py" signature="PulseQobjConfig(meas_level, meas_return, pulse_library, qubit_lo_freq, meas_lo_freq, memory_slot_size=None, rep_time=None, rep_delay=None, shots=None, max_credits=None, seed_simulator=None, memory_slots=None, **kwargs)">
  ...
  *   **kwargs** – Additional free form key value fields to add to the configuration
  ...
  <Function id="qiskit.qobj.PulseQobjConfig.__init__" name="__init__" signature="__init__(meas_level, meas_return, pulse_library, qubit_lo_freq, meas_lo_freq, memory_slot_size=None, rep_time=None, rep_delay=None, shots=None, max_credits=None, seed_simulator=None, memory_slots=None, **kwargs)">
    Instantiate a PulseQobjConfig object.
  ...
  <Function id="qiskit.qobj.PulseQobjConfig.from_dict" name="from_dict" signature="classmethod from_dict(data)">
  ...
  <Function id="qiskit.qobj.PulseQobjConfig.to_dict" name="to_dict" signature="to_dict()">
