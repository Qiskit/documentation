...
<Function id="qiskit.quantum_info.concurrence" name="concurrence" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.16/qiskit/quantum_info/states/measures.py" signature="concurrence(state)">
