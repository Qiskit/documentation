...
<Class id="qiskit.aqua.operators.gradients.CircuitGradient" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.8/qiskit/aqua/operators/gradients/circuit_gradients/circuit_gradient.py" signature="CircuitGradient">
  ...
  <Function id="qiskit.aqua.operators.gradients.CircuitGradient.__init__" name="__init__" signature="__init__()">
  ...
  <Function id="qiskit.aqua.operators.gradients.CircuitGradient.convert" name="convert" signature="abstract convert(operator, params=None)">
    **Parameters**
