---
title: CircuitGradient (v0.24)
description: API reference for qiskit.aqua.operators.gradients.CircuitGradient in qiskit v0.24
...
<Class id="qiskit.aqua.operators.gradients.CircuitGradient" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.8/qiskit/aqua/operators/gradients/circuit_gradients/circuit_gradient.py" signature="CircuitGradient" modifiers="class">
