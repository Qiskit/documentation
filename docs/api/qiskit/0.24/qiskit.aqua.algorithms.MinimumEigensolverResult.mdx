...
<Class id="qiskit.aqua.algorithms.MinimumEigensolverResult" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.8/qiskit/aqua/algorithms/minimum_eigen_solvers/minimum_eigen_solver.py" signature="MinimumEigensolverResult(a_dict=None)" modifiers="class">
  ...
  <Function id="qiskit.aqua.algorithms.MinimumEigensolverResult.aux_operator_eigenvalues" signature="aux_operator_eigenvalues" modifiers="property">
  ...
  <Function id="qiskit.aqua.algorithms.MinimumEigensolverResult.eigenstate" signature="eigenstate" modifiers="property">
    return eigen state
  ...
  <Function id="qiskit.aqua.algorithms.MinimumEigensolverResult.eigenvalue" signature="eigenvalue" modifiers="property">
    returns eigen value
