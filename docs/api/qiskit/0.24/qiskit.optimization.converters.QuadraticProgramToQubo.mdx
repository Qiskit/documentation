...
<Class id="qiskit.optimization.converters.QuadraticProgramToQubo" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.8/qiskit/optimization/converters/quadratic_program_to_qubo.py" signature="QuadraticProgramToQubo(penalty=None)">
  ...
  **penalty** (`Optional`\[`float`]) – Penalty factor to scale equality constraints that are added to objective. If None is passed, penalty factor will be automatically calculated.
  ...
  <Function id="qiskit.optimization.converters.QuadraticProgramToQubo.__init__" name="__init__" signature="__init__(penalty=None)">
    **Parameters**
  ...
  <Function id="qiskit.optimization.converters.QuadraticProgramToQubo.convert" name="convert" signature="convert(problem)">
  ...
  <Function id="qiskit.optimization.converters.QuadraticProgramToQubo.decode" name="decode" signature="decode(result)">
  ...
  <Function id="qiskit.optimization.converters.QuadraticProgramToQubo.encode" name="encode" signature="encode(problem)">
  ...
  <Function id="qiskit.optimization.converters.QuadraticProgramToQubo.get_compatibility_msg" name="get_compatibility_msg" signature="static get_compatibility_msg(problem)">
  ...
  <Function id="qiskit.optimization.converters.QuadraticProgramToQubo.interpret" name="interpret" signature="interpret(result)">
  ...
  <Function id="qiskit.optimization.converters.QuadraticProgramToQubo.is_compatible" name="is_compatible" signature="is_compatible(problem)">
  ...
  <Function id="qiskit.optimization.converters.QuadraticProgramToQubo.penalty" name="penalty" signature="property penalty">
