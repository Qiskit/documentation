...
<Class id="qiskit.pulse.Play" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.16/qiskit/pulse/instructions/play.py" signature="Play(pulse, channel, name=None)">
  ...
  **Raises**
  ...
  <Function id="qiskit.pulse.Play.__init__" name="__init__" signature="__init__(pulse, channel, name=None)">
    Create a new pulse instruction.
  ...
  <Function id="qiskit.pulse.Play.append" name="append" signature="append(schedule, name=None)">
  ...
  <Function id="qiskit.pulse.Play.assign_parameters" name="assign_parameters" signature="assign_parameters(value_dict)">
  ...
  <Function id="qiskit.pulse.Play.ch_duration" name="ch_duration" signature="ch_duration(*channels)">
  ...
  <Function id="qiskit.pulse.Play.ch_start_time" name="ch_start_time" signature="ch_start_time(*channels)">
  ...
  <Function id="qiskit.pulse.Play.ch_stop_time" name="ch_stop_time" signature="ch_stop_time(*channels)">
  ...
  <Function id="qiskit.pulse.Play.channel" name="channel" signature="property channel">
  ...
  <Function id="qiskit.pulse.Play.channels" name="channels" signature="property channels">
  ...
  <Function id="qiskit.pulse.Play.command" name="command" signature="property command">
  ...
  <Function id="qiskit.pulse.Play.draw" name="draw" signature="draw(dt=1, style=None, filename=None, interp_method=None, scale=1, plot_all=False, plot_range=None, interactive=False, table=True, label=False, framechange=True, channels=None)">
  ...
  <Function id="qiskit.pulse.Play.duration" name="duration" signature="property duration">
  ...
  <Function id="qiskit.pulse.Play.flatten" name="flatten" signature="flatten()">
  ...
  <Function id="qiskit.pulse.Play.id" name="id" signature="property id">
  ...
  <Function id="qiskit.pulse.Play.insert" name="insert" signature="insert(start_time, schedule, name=None)">
  ...
  <Function id="qiskit.pulse.Play.instructions" name="instructions" signature="property instructions">
  ...
  <Function id="qiskit.pulse.Play.name" name="name" signature="property name">
  ...
  <Function id="qiskit.pulse.Play.operands" name="operands" signature="property operands">
  ...
  <Function id="qiskit.pulse.Play.pulse" name="pulse" signature="property pulse">
  ...
  <Function id="qiskit.pulse.Play.shift" name="shift" signature="shift(time, name=None)">
  ...
  <Function id="qiskit.pulse.Play.start_time" name="start_time" signature="property start_time">
  ...
  <Function id="qiskit.pulse.Play.stop_time" name="stop_time" signature="property stop_time">
  ...
  <Function id="qiskit.pulse.Play.timeslots" name="timeslots" signature="property timeslots">
