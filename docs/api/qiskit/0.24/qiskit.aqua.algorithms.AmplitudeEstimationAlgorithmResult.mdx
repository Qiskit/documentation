...
<Class id="qiskit.aqua.algorithms.AmplitudeEstimationAlgorithmResult" github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.8/qiskit/aqua/algorithms/amplitude_estimators/ae_algorithm.py" signature="AmplitudeEstimationAlgorithmResult(a_dict=None)">
