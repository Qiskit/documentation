...
<Class id="qiskit.aqua.algorithms.QuantumAlgorithm" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.8/qiskit/aqua/algorithms/quantum_algorithm.py" signature="QuantumAlgorithm(quantum_instance)" modifiers="class">
  ...
  <Function id="qiskit.aqua.algorithms.QuantumAlgorithm.backend" signature="backend" modifiers="property">
    Returns backend.
  ...
  <Function id="qiskit.aqua.algorithms.QuantumAlgorithm.quantum_instance" signature="quantum_instance" modifiers="property">
  ...
  <Function id="qiskit.aqua.algorithms.QuantumAlgorithm.random" signature="random" modifiers="property">
