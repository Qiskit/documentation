...
<Class id="qiskit.aqua.components.optimizers.CRS" github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.8/qiskit/aqua/components/optimizers/nlopts/crs.py" signature="CRS(max_evals=1000)">
