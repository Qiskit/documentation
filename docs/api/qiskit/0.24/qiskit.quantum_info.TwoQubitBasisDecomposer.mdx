---
title: TwoQubitBasisDecomposer (v0.24)
description: API reference for qiskit.quantum_info.TwoQubitBasisDecomposer in qiskit v0.24
...
<Class id="qiskit.quantum_info.TwoQubitBasisDecomposer" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.16/qiskit/quantum_info/synthesis/two_qubit_decompose.py" signature="TwoQubitBasisDecomposer(gate, basis_fidelity=1.0, euler_basis=None)" modifiers="class">
  ...
  *   **euler\_basis** (*str*) – Basis string to be provided to OneQubitEulerDecomposer for 1Q synthesis. Valid options are \[‘ZYZ’, ‘ZXZ’, ‘XYX’, ‘U’, ‘U3’, ‘U1X’, ‘PSX’, ‘ZSX’, ‘RR’]. Default ‘U3’.
  ...
  <Function id="qiskit.quantum_info.TwoQubitBasisDecomposer.__init__" signature="__init__(gate, basis_fidelity=1.0, euler_basis=None)">
  ...
  <Function id="qiskit.quantum_info.TwoQubitBasisDecomposer.decomp0" signature="decomp0(target, eps=1e-15)" modifiers="static">
  ...
  <Function id="qiskit.quantum_info.TwoQubitBasisDecomposer.decomp1" signature="decomp1(target)">
  ...
  <Function id="qiskit.quantum_info.TwoQubitBasisDecomposer.decomp2_supercontrolled" signature="decomp2_supercontrolled(target)">
  ...
  <Function id="qiskit.quantum_info.TwoQubitBasisDecomposer.decomp3_supercontrolled" signature="decomp3_supercontrolled(target)">
  ...
  <Function id="qiskit.quantum_info.TwoQubitBasisDecomposer.num_basis_gates" signature="num_basis_gates(unitary)">
    Computes the number of basis gates needed in a decomposition of input unitary
  </Function>

  ### traces

  <Function id="qiskit.quantum_info.TwoQubitBasisDecomposer.traces" signature="traces(target)">
