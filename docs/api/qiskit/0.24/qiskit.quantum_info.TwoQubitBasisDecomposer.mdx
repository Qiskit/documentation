...
<Class id="qiskit.quantum_info.TwoQubitBasisDecomposer" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.16/qiskit/quantum_info/synthesis/two_qubit_decompose.py" signature="TwoQubitBasisDecomposer(gate, basis_fidelity=1.0, euler_basis=None)">
  ...
  *   **euler\_basis** (*str*) – Basis string to be provided to OneQubitEulerDecomposer for 1Q synthesis. Valid options are \[‘ZYZ’, ‘ZXZ’, ‘XYX’, ‘U’, ‘U3’, ‘U1X’, ‘PSX’, ‘ZSX’, ‘RR’]. Default ‘U3’.
  ...
  <Function id="qiskit.quantum_info.TwoQubitBasisDecomposer.__init__" name="__init__" signature="__init__(gate, basis_fidelity=1.0, euler_basis=None)">
  ...
  <Function id="qiskit.quantum_info.TwoQubitBasisDecomposer.decomp0" name="decomp0" signature="static decomp0(target, eps=1e-15)">
