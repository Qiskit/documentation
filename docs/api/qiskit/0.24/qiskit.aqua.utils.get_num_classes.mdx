...
<Function id="qiskit.aqua.utils.get_num_classes" name="get_num_classes" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.8/qiskit/aqua/utils/dataset_helper.py" signature="get_num_classes(dataset)">
