---
title: play (v0.24)
description: API reference for qiskit.pulse.builder.play in qiskit v0.24
...
<Function id="qiskit.pulse.builder.play" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.16/qiskit/pulse/builder.py" signature="play(pulse, channel)">
