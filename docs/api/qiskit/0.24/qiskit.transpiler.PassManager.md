...
`PassManager(passes=None, max_iteration=1000, callback=None)` [GitHub](https://github.com/qiskit/qiskit/tree/stable/0.16/qiskit/transpiler/passmanager.py "view source code")
