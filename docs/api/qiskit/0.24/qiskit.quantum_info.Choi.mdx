...
$$
  ...
  **Additional Information:**
  ...
  <Function id="qiskit.quantum_info.Choi.set_atol" signature="classmethod set_atol(value)">
  ...
  <Function id="qiskit.quantum_info.Choi.set_rtol" signature="classmethod set_rtol(value)">
