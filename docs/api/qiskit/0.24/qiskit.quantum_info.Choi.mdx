...
<Class id="qiskit.quantum_info.Choi" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.16/qiskit/quantum_info/operators/channel/choi.py" signature="Choi(data, input_dims=None, output_dims=None)">
...
$$
  ...
  **Additional Information:**
  ...
  <Function id="qiskit.quantum_info.Choi.add" name="add" signature="add(other)">
  ...
  <Function id="qiskit.quantum_info.Choi.multiply" name="multiply" signature="multiply(other)">
  ...
  <Function id="qiskit.quantum_info.Choi.reshape" name="reshape" signature="reshape(input_dims=None, output_dims=None)">
  ...
  <Function id="qiskit.quantum_info.Choi.set_atol" name="set_atol" signature="classmethod set_atol(value)">
  ...
  <Function id="qiskit.quantum_info.Choi.set_rtol" name="set_rtol" signature="classmethod set_rtol(value)">
  ...
  <Function id="qiskit.quantum_info.Choi.subtract" name="subtract" signature="subtract(other)">
    Return the linear operator self - other.
