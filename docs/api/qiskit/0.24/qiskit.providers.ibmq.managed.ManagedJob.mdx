...
<Class id="qiskit.providers.ibmq.managed.ManagedJob" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-ibmq-provider/tree/stable/0.12/qiskit/providers/ibmq/managed/managedjob.py" signature="ManagedJob(start_index, experiments_count, job=None)">
  ...
  *   **job** (`Optional`\[`IBMQJob`]) – Job to be managed, or `None` if not already known.
  ...
  <Function id="qiskit.providers.ibmq.managed.ManagedJob.__init__" name="__init__" signature="__init__(start_index, experiments_count, job=None)">
    ManagedJob constructor.
  ...
  <Function id="qiskit.providers.ibmq.managed.ManagedJob.cancel" name="cancel" signature="cancel()">
  ...
  <Function id="qiskit.providers.ibmq.managed.ManagedJob.error_message" name="error_message" signature="error_message()">
  ...
  <Function id="qiskit.providers.ibmq.managed.ManagedJob.qobj" name="qobj" signature="qobj()">
  ...
  <Function id="qiskit.providers.ibmq.managed.ManagedJob.result" name="result" signature="result(timeout=None, partial=False, refresh=False)">
  ...
  <Function id="qiskit.providers.ibmq.managed.ManagedJob.status" name="status" signature="status()">
  ...
  <Function id="qiskit.providers.ibmq.managed.ManagedJob.submit" name="submit" signature="submit(qobj, job_name, backend, executor, submit_lock, job_share_level, job_tags=None)">
    Submit the job.
