---
title: DifferentialExtrapolator (v0.24)
description: API reference for qiskit.chemistry.algorithms.pes_samplers.DifferentialExtrapolator in qiskit v0.24
...
<Class id="qiskit.chemistry.algorithms.pes_samplers.DifferentialExtrapolator" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.8/qiskit/chemistry/algorithms/pes_samplers/extrapolator.py" signature="DifferentialExtrapolator(degree=1, model=None)" modifiers="class">
