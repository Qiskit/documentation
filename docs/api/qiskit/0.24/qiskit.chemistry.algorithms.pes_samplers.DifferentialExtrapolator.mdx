...
<Class id="qiskit.chemistry.algorithms.pes_samplers.DifferentialExtrapolator" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.8/qiskit/chemistry/algorithms/pes_samplers/extrapolator.py" signature="DifferentialExtrapolator(degree=1, model=None)">
  ...
  *   **degree** (`int`) – Specifies (degree -1) derivatives to be added as ‘features’ in regression model.
  ...
  <Function id="qiskit.chemistry.algorithms.pes_samplers.DifferentialExtrapolator.__init__" name="__init__" signature="__init__(degree=1, model=None)">
    Constructor.
  ...
  <Function id="qiskit.chemistry.algorithms.pes_samplers.DifferentialExtrapolator.extrapolate" name="extrapolate" signature="extrapolate(points, param_dict)">
  ...
  <Function id="qiskit.chemistry.algorithms.pes_samplers.DifferentialExtrapolator.factory" name="factory" signature="static factory(mode, **kwargs)">
