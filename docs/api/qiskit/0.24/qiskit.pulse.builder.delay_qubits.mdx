...
<Function id="qiskit.pulse.builder.delay_qubits" name="delay_qubits" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.16/qiskit/pulse/builder.py" signature="delay_qubits(duration, *qubits)">
