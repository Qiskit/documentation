...
<Function id="qiskit.ml.datasets.sample_ad_hoc_data" github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.8/qiskit/ml/datasets/ad_hoc.py" signature="sample_ad_hoc_data(sample_total, test_size, n)">
