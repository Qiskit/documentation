...
<Class id="qiskit.optimization.algorithms.ADMMState" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.8/qiskit/optimization/algorithms/admm_optimizer.py" signature="ADMMState(op, rho_initial)">
  ...
  *   **rho\_initial** (`float`) – Initial value of the rho parameter.
  ...
  <Function id="qiskit.optimization.algorithms.ADMMState.__init__" name="__init__" signature="__init__(op, rho_initial)">
    **Parameters**
