---
title: ADMMState (v0.24)
description: API reference for qiskit.optimization.algorithms.ADMMState in qiskit v0.24
...
<Class id="qiskit.optimization.algorithms.ADMMState" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.8/qiskit/optimization/algorithms/admm_optimizer.py" signature="ADMMState(op, rho_initial)" modifiers="class">
