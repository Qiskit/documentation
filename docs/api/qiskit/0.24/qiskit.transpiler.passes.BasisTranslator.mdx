...
<Class id="qiskit.transpiler.passes.BasisTranslator" github="https://github.com/qiskit/qiskit/tree/stable/0.16/qiskit/transpiler/passes/basis/basis_translator.py" signature="BasisTranslator(*args, **kwargs)">
