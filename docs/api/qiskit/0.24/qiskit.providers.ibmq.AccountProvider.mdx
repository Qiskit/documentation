...
<Class id="qiskit.providers.ibmq.AccountProvider" github="https://github.com/qiskit/qiskit-ibmq-provider/tree/stable/0.12/qiskit/providers/ibmq/accountprovider.py" signature="AccountProvider(credentials, access_token)">
