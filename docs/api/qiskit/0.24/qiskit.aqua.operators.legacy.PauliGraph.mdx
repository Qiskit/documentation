...
<Class id="qiskit.aqua.operators.legacy.PauliGraph" github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.8/qiskit/aqua/operators/legacy/pauli_graph.py" signature="PauliGraph(paulis, mode='largest-degree')">
  Pauli Graph.
