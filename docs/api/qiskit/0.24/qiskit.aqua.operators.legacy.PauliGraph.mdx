...
<Class id="qiskit.aqua.operators.legacy.PauliGraph" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.8/qiskit/aqua/operators/legacy/pauli_graph.py" signature="PauliGraph(paulis, mode='largest-degree')">
  Pauli Graph.

  ### \_\_init\_\_

  <Function id="qiskit.aqua.operators.legacy.PauliGraph.__init__" name="__init__" signature="__init__(paulis, mode='largest-degree')">
  ...
  <Function id="qiskit.aqua.operators.legacy.PauliGraph.grouped_paulis" name="grouped_paulis" signature="property grouped_paulis">
