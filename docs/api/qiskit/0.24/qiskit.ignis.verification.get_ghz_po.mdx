---
title: get_ghz_po (v0.24)
description: API reference for qiskit.ignis.verification.get_ghz_po in qiskit v0.24
...
<Function id="qiskit.ignis.verification.get_ghz_po" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-ignis/tree/stable/0.5/qiskit/ignis/verification/entanglement/linear.py" signature="get_ghz_po(n, delta)">
