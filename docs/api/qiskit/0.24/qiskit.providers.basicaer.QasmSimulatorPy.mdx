...
<Class id="qiskit.providers.basicaer.QasmSimulatorPy" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.16/qiskit/providers/basicaer/qasm_simulator.py" signature="QasmSimulatorPy(configuration=None, provider=None)">
  ...
  **QiskitError** – if an error occurred when instantiating the backend.
  ...
  <Function id="qiskit.providers.basicaer.QasmSimulatorPy.__init__" name="__init__" signature="__init__(configuration=None, provider=None)">
    Base class for backends.
  ...
  <Function id="qiskit.providers.basicaer.QasmSimulatorPy.run" name="run" signature="run(qobj, backend_options=None)">
  ...
  <Function id="qiskit.providers.basicaer.QasmSimulatorPy.version" name="version" signature="version()">
