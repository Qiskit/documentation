...
<Class id="qiskit.providers.BaseJob" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.16/qiskit/providers/basejob.py" signature="BaseJob(backend, job_id)">
  ...
  *   **job\_id** (`str`) – a unique id in the context of the backend used to run the job.
  ...
  <Function id="qiskit.providers.BaseJob.__init__" name="__init__" signature="__init__(backend, job_id)">
    Initializes the asynchronous job.
  ...
  <Function id="qiskit.providers.BaseJob.backend" name="backend" signature="backend()">
  ...
  <Function id="qiskit.providers.BaseJob.cancel" name="cancel" signature="abstract cancel()">
    Attempt to cancel the job.
  </Function>

  ### cancelled

  <Function id="qiskit.providers.BaseJob.cancelled" name="cancelled" signature="cancelled()">
  ...
  <Function id="qiskit.providers.BaseJob.done" name="done" signature="done()">
  ...
  <Function id="qiskit.providers.BaseJob.in_final_state" name="in_final_state" signature="in_final_state()">
  ...
  <Function id="qiskit.providers.BaseJob.job_id" name="job_id" signature="job_id()">
  ...
  <Function id="qiskit.providers.BaseJob.result" name="result" signature="abstract result()">
    Return the results of the job.
  </Function>

  ### running

  <Function id="qiskit.providers.BaseJob.running" name="running" signature="running()">
  ...
  <Function id="qiskit.providers.BaseJob.status" name="status" signature="abstract status()">
    Return the status of the job, among the values of `JobStatus`.
  </Function>

  ### submit

  <Function id="qiskit.providers.BaseJob.submit" name="submit" signature="abstract submit()">
    Submit the job to the backend for execution.
  </Function>

  ### wait\_for\_final\_state

  <Function id="qiskit.providers.BaseJob.wait_for_final_state" name="wait_for_final_state" signature="wait_for_final_state(timeout=None, wait=5, callback=None)">
