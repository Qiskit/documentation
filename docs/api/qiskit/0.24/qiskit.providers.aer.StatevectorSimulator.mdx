...
<Class id="qiskit.providers.aer.StatevectorSimulator" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-aer/tree/stable/0.7/qiskit/providers/aer/backends/statevector_simulator.py" signature="StatevectorSimulator(configuration=None, properties=None, provider=None, **backend_options)">
  ...
  **Raises**
  ...
  <Function id="qiskit.providers.aer.StatevectorSimulator.__init__" name="__init__" signature="__init__(configuration=None, properties=None, provider=None, **backend_options)">
    Aer class for backends.
  ...
  <Function id="qiskit.providers.aer.StatevectorSimulator.available_methods" name="available_methods" signature="available_methods()">
    Return the available simulation methods.
  </Function>

  ### clear\_options

  <Function id="qiskit.providers.aer.StatevectorSimulator.clear_options" name="clear_options" signature="clear_options()">
    Reset the simulator options to default values.
  </Function>

  ### configuration

  <Function id="qiskit.providers.aer.StatevectorSimulator.configuration" name="configuration" signature="configuration()">
  ...
  <Function id="qiskit.providers.aer.StatevectorSimulator.defaults" name="defaults" signature="defaults()">
  ...
  <Function id="qiskit.providers.aer.StatevectorSimulator.name" name="name" signature="name()">
  ...
  <Function id="qiskit.providers.aer.StatevectorSimulator.options" name="options" signature="property options">
    Return the current simulator options
  </Function>

  ### properties

  <Function id="qiskit.providers.aer.StatevectorSimulator.properties" name="properties" signature="properties()">
  ...
  <Function id="qiskit.providers.aer.StatevectorSimulator.provider" name="provider" signature="provider()">
  ...
  <Function id="qiskit.providers.aer.StatevectorSimulator.run" name="run" signature="run(qobj, backend_options=None, validate=False, **run_options)">
  ...
  <Function id="qiskit.providers.aer.StatevectorSimulator.set_options" name="set_options" signature="set_options(**backend_options)">
    Set the simulator options
  </Function>

  ### status

  <Function id="qiskit.providers.aer.StatevectorSimulator.status" name="status" signature="status()">
  ...
  <Function id="qiskit.providers.aer.StatevectorSimulator.version" name="version" signature="version()">
