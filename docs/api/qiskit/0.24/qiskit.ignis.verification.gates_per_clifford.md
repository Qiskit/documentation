...
`gates_per_clifford(transpiled_circuits_list, clifford_lengths, basis, qubits)` [GitHub](https://github.com/qiskit-community/qiskit-ignis/tree/stable/0.5/qiskit/ignis/verification/randomized_benchmarking/rb_utils.py "view source code")
...
```python
{0: {'cx': 1.5131428571428571,
     'id': 0.0,
     'u1': 0.13942857142857143,
     'u2': 1.696,
     'u3': 0.17942857142857144},
 1: {'cx': 1.5131428571428571,
     'id': 0.0,
     'u1': 0.12685714285714286,
     'u2': 1.7348571428571429,
     'u3': 0.13028571428571428}}
```
