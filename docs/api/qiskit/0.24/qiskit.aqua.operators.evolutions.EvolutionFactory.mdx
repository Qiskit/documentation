...
<Class id="qiskit.aqua.operators.evolutions.EvolutionFactory" github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.8/qiskit/aqua/operators/evolutions/evolution_factory.py" signature="EvolutionFactory">
