...
<Class id="qiskit.aqua.operators.evolutions.EvolutionFactory" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.8/qiskit/aqua/operators/evolutions/evolution_factory.py" signature="EvolutionFactory">
  A factory class for convenient automatic selection of an Evolution algorithm based on the Operator to be converted.

  ### \_\_init\_\_

  <Function id="qiskit.aqua.operators.evolutions.EvolutionFactory.__init__" name="__init__" signature="__init__()">
  ...
  <Function id="qiskit.aqua.operators.evolutions.EvolutionFactory.build" name="build" signature="static build(operator=None)">
