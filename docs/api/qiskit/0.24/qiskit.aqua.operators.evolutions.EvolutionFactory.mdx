---
title: EvolutionFactory (v0.24)
description: API reference for qiskit.aqua.operators.evolutions.EvolutionFactory in qiskit v0.24
...
<Class id="qiskit.aqua.operators.evolutions.EvolutionFactory" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.8/qiskit/aqua/operators/evolutions/evolution_factory.py" signature="EvolutionFactory" modifiers="class">
