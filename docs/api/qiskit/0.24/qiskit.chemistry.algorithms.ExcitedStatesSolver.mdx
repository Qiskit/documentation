...
<Class id="qiskit.chemistry.algorithms.ExcitedStatesSolver" github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.8/qiskit/chemistry/algorithms/excited_states_solvers/excited_states_solver.py" signature="ExcitedStatesSolver">
