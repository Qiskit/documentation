...
<Class id="qiskit.chemistry.algorithms.ExcitedStatesSolver" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.8/qiskit/chemistry/algorithms/excited_states_solvers/excited_states_solver.py" signature="ExcitedStatesSolver">
  The excited states calculation interface

  ### \_\_init\_\_

  <Function id="qiskit.chemistry.algorithms.ExcitedStatesSolver.__init__" name="__init__" signature="__init__()">
  ...
  <Function id="qiskit.chemistry.algorithms.ExcitedStatesSolver.solve" name="solve" signature="abstract solve(driver, aux_operators=None)">
