...
<Class id="qiskit.aqua.circuits.StateVectorCircuit" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.8/qiskit/aqua/circuits/statevector_circuit.py" signature="StateVectorCircuit(state_vector)">
  ...
  **Raises**
  ...
  <Function id="qiskit.aqua.circuits.StateVectorCircuit.__init__" name="__init__" signature="__init__(state_vector)">
    Constructor.
  ...
  <Function id="qiskit.aqua.circuits.StateVectorCircuit.construct_circuit" name="construct_circuit" signature="construct_circuit(circuit=None, register=None)">
