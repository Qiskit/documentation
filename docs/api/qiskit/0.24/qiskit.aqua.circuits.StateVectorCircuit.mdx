...
<Class id="qiskit.aqua.circuits.StateVectorCircuit" github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.8/qiskit/aqua/circuits/statevector_circuit.py" signature="StateVectorCircuit(state_vector)">
