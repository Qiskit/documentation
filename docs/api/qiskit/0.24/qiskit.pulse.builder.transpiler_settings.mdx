...
<Function id="qiskit.pulse.builder.transpiler_settings" github="https://github.com/qiskit/qiskit/tree/stable/0.16/qiskit/pulse/builder.py" signature="transpiler_settings(**settings)">
