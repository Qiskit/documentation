...
<Class id="qiskit.aqua.operators.evolutions.EvolvedOp" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.8/qiskit/aqua/operators/evolutions/evolved_op.py" signature="EvolvedOp(primitive, coeff=1.0)" modifiers="class">
  ...
  *   **coeff** (`Union`\[`int`, `float`, `complex`, `ParameterExpression`, `None`]) – A coefficient multiplying the operator
  ...
  <Function id="qiskit.aqua.operators.evolutions.EvolvedOp.__init__" signature="__init__(primitive, coeff=1.0)">
    **Parameters**
  ...
  <Function id="qiskit.aqua.operators.evolutions.EvolvedOp.add" signature="add(other)">
  ...
  <Function id="qiskit.aqua.operators.evolutions.EvolvedOp.adjoint" signature="adjoint()">
  ...
  <Function id="qiskit.aqua.operators.evolutions.EvolvedOp.assign_parameters" signature="assign_parameters(param_dict)">
  ...
  <Function id="qiskit.aqua.operators.evolutions.EvolvedOp.bind_parameters" signature="bind_parameters(param_dict)">
  ...
  <Function id="qiskit.aqua.operators.evolutions.EvolvedOp.coeff" signature="coeff" modifiers="property">
  ...
  <Function id="qiskit.aqua.operators.evolutions.EvolvedOp.compose" signature="compose(other, permutation=None, front=False)">
  ...
  <Function id="qiskit.aqua.operators.evolutions.EvolvedOp.equals" signature="equals(other)">
  ...
  <Function id="qiskit.aqua.operators.evolutions.EvolvedOp.eval" signature="eval(front=None)">
  ...
  <Function id="qiskit.aqua.operators.evolutions.EvolvedOp.exp_i" signature="exp_i()">
  ...
  <Function id="qiskit.aqua.operators.evolutions.EvolvedOp.log_i" signature="log_i(massive=False)">
  ...
  <Function id="qiskit.aqua.operators.evolutions.EvolvedOp.mul" signature="mul(scalar)">
  ...
  <Function id="qiskit.aqua.operators.evolutions.EvolvedOp.neg" signature="neg()">
  ...
  <Function id="qiskit.aqua.operators.evolutions.EvolvedOp.num_qubits" signature="num_qubits" modifiers="property">
  ...
  <Function id="qiskit.aqua.operators.evolutions.EvolvedOp.parameters" signature="parameters" modifiers="property">
    Return a set of Parameter objects contained in the Operator.
  </Function>

  ### permute

  <Function id="qiskit.aqua.operators.evolutions.EvolvedOp.permute" signature="permute(permutation)">
  ...
  <Function id="qiskit.aqua.operators.evolutions.EvolvedOp.power" signature="power(exponent)">
  ...
  <Function id="qiskit.aqua.operators.evolutions.EvolvedOp.primitive" signature="primitive" modifiers="property">
  ...
  <Function id="qiskit.aqua.operators.evolutions.EvolvedOp.primitive_strings" signature="primitive_strings()">
  ...
  <Function id="qiskit.aqua.operators.evolutions.EvolvedOp.reduce" signature="reduce()">
  ...
  <Function id="qiskit.aqua.operators.evolutions.EvolvedOp.tensor" signature="tensor(other)">
  ...
  <Function id="qiskit.aqua.operators.evolutions.EvolvedOp.tensorpower" signature="tensorpower(other)">
  ...
  <Function id="qiskit.aqua.operators.evolutions.EvolvedOp.to_circuit" signature="to_circuit()">
  ...
  <Function id="qiskit.aqua.operators.evolutions.EvolvedOp.to_circuit_op" signature="to_circuit_op()">
  ...
  <Function id="qiskit.aqua.operators.evolutions.EvolvedOp.to_instruction" signature="to_instruction(massive=False)">
  ...
  <Function id="qiskit.aqua.operators.evolutions.EvolvedOp.to_legacy_op" signature="to_legacy_op(massive=False)">
  ...
  <Function id="qiskit.aqua.operators.evolutions.EvolvedOp.to_matrix" signature="to_matrix(massive=False)">
  ...
  <Function id="qiskit.aqua.operators.evolutions.EvolvedOp.to_matrix_op" signature="to_matrix_op(massive=False)">
  ...
  <Function id="qiskit.aqua.operators.evolutions.EvolvedOp.to_pauli_op" signature="to_pauli_op(massive=False)">
