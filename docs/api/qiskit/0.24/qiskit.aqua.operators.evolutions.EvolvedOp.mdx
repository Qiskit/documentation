...
<Class id="qiskit.aqua.operators.evolutions.EvolvedOp" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.8/qiskit/aqua/operators/evolutions/evolved_op.py" signature="EvolvedOp(primitive, coeff=1.0)">
  ...
  *   **coeff** (`Union`\[`int`, `float`, `complex`, `ParameterExpression`, `None`]) – A coefficient multiplying the operator
  ...
  <Function id="qiskit.aqua.operators.evolutions.EvolvedOp.coeff" signature="property coeff">
  ...
  <Function id="qiskit.aqua.operators.evolutions.EvolvedOp.num_qubits" signature="property num_qubits">
  ...
  <Function id="qiskit.aqua.operators.evolutions.EvolvedOp.parameters" signature="property parameters">
  ...
  <Function id="qiskit.aqua.operators.evolutions.EvolvedOp.primitive" signature="property primitive">
