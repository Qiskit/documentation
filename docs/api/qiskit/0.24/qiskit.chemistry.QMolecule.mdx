...
<Class id="qiskit.chemistry.QMolecule" github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.8/qiskit/chemistry/qmolecule.py" signature="QMolecule(filename=None)">
