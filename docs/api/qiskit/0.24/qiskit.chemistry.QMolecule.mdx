...
<Class id="qiskit.chemistry.QMolecule" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.8/qiskit/chemistry/qmolecule.py" signature="QMolecule(filename=None)">
  ...
  <Function id="qiskit.chemistry.QMolecule.core_orbitals" signature="property core_orbitals">
  ...
  <Function id="qiskit.chemistry.QMolecule.filename" signature="property filename">
  ...
  <Function id="qiskit.chemistry.QMolecule.one_body_integrals" signature="property one_body_integrals">
    Returns one body electron integrals.
  </Function>

  ### onee\_to\_spin

  <Function id="qiskit.chemistry.QMolecule.onee_to_spin" signature="static onee_to_spin(mohij, mohij_b=None, threshold=1e-12)">
  ...
  <Function id="qiskit.chemistry.QMolecule.oneeints2mo" signature="static oneeints2mo(ints, moc)">
  ...
  <Function id="qiskit.chemistry.QMolecule.two_body_integrals" signature="property two_body_integrals">
    Returns two body electron integrals.
  </Function>

  ### twoe\_to\_spin

  <Function id="qiskit.chemistry.QMolecule.twoe_to_spin" signature="static twoe_to_spin(mohijkl, mohijkl_bb=None, mohijkl_ba=None, threshold=1e-12)">
  ...
  <Function id="qiskit.chemistry.QMolecule.twoeints2mo" signature="static twoeints2mo(ints, moc)">
  ...
  <Function id="qiskit.chemistry.QMolecule.twoeints2mo_general" signature="static twoeints2mo_general(ints, moc1, moc2, moc3, moc4)" />

  ### x\_dipole\_integrals

  <Function id="qiskit.chemistry.QMolecule.x_dipole_integrals" signature="property x_dipole_integrals">
    returns x\_dipole\_integrals
  </Function>

  ### y\_dipole\_integrals

  <Function id="qiskit.chemistry.QMolecule.y_dipole_integrals" signature="property y_dipole_integrals">
    returns y\_dipole\_integrals
  </Function>

  ### z\_dipole\_integrals

  <Function id="qiskit.chemistry.QMolecule.z_dipole_integrals" signature="property z_dipole_integrals">
