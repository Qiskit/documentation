...
<Class id="qiskit.transpiler.InstructionDurations" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.16/qiskit/transpiler/instruction_durations.py" signature="InstructionDurations(instruction_durations=None, dt=None)">
  ...
  <Function id="qiskit.transpiler.InstructionDurations.__init__" name="__init__" signature="__init__(instruction_durations=None, dt=None)">
  ...
  <Function id="qiskit.transpiler.InstructionDurations.from_backend" name="from_backend" signature="classmethod from_backend(backend)">
  ...
  <Function id="qiskit.transpiler.InstructionDurations.get" name="get" signature="get(inst, qubits, unit='dt')">
  ...
  <Function id="qiskit.transpiler.InstructionDurations.units_used" name="units_used" signature="units_used()">
  ...
  <Function id="qiskit.transpiler.InstructionDurations.update" name="update" signature="update(inst_durations, dt=None)">
