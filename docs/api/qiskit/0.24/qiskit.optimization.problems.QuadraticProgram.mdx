...
<Class id="qiskit.optimization.problems.QuadraticProgram" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.8/qiskit/optimization/problems/quadratic_program.py" signature="QuadraticProgram(name='')">
  ...
  **name** (`str`) – The name of the quadratic program.
  ...
  <Function id="qiskit.optimization.problems.QuadraticProgram.__init__" name="__init__" signature="__init__(name='')">
    **Parameters**
  ...
  <Function id="qiskit.optimization.problems.QuadraticProgram.binary_var" name="binary_var" signature="binary_var(name=None)">
  ...
  <Function id="qiskit.optimization.problems.QuadraticProgram.clear" name="clear" signature="clear()">
  ...
  <Function id="qiskit.optimization.problems.QuadraticProgram.continuous_var" name="continuous_var" signature="continuous_var(lowerbound=0, upperbound=1e+20, name=None)">
  ...
  <Function id="qiskit.optimization.problems.QuadraticProgram.export_as_lp_string" name="export_as_lp_string" signature="export_as_lp_string()">
  ...
  <Function id="qiskit.optimization.problems.QuadraticProgram.from_docplex" name="from_docplex" signature="from_docplex(model)">
  ...
  <Function id="qiskit.optimization.problems.QuadraticProgram.from_ising" name="from_ising" signature="from_ising(qubit_op, offset=0.0, linear=False)">
  ...
  <Function id="qiskit.optimization.problems.QuadraticProgram.get_feasibility_info" name="get_feasibility_info" signature="get_feasibility_info(x)">
  ...
  <Function id="qiskit.optimization.problems.QuadraticProgram.get_linear_constraint" name="get_linear_constraint" signature="get_linear_constraint(i)">
  ...
  <Function id="qiskit.optimization.problems.QuadraticProgram.get_num_binary_vars" name="get_num_binary_vars" signature="get_num_binary_vars()">
  ...
  <Function id="qiskit.optimization.problems.QuadraticProgram.get_num_continuous_vars" name="get_num_continuous_vars" signature="get_num_continuous_vars()">
  ...
  <Function id="qiskit.optimization.problems.QuadraticProgram.get_num_integer_vars" name="get_num_integer_vars" signature="get_num_integer_vars()">
  ...
  <Function id="qiskit.optimization.problems.QuadraticProgram.get_num_linear_constraints" name="get_num_linear_constraints" signature="get_num_linear_constraints()">
  ...
  <Function id="qiskit.optimization.problems.QuadraticProgram.get_num_quadratic_constraints" name="get_num_quadratic_constraints" signature="get_num_quadratic_constraints()">
  ...
  <Function id="qiskit.optimization.problems.QuadraticProgram.get_num_vars" name="get_num_vars" signature="get_num_vars(vartype=None)">
  ...
  <Function id="qiskit.optimization.problems.QuadraticProgram.get_quadratic_constraint" name="get_quadratic_constraint" signature="get_quadratic_constraint(i)">
  ...
  <Function id="qiskit.optimization.problems.QuadraticProgram.get_variable" name="get_variable" signature="get_variable(i)">
  ...
  <Function id="qiskit.optimization.problems.QuadraticProgram.integer_var" name="integer_var" signature="integer_var(lowerbound=0, upperbound=1e+20, name=None)">
  ...
  <Function id="qiskit.optimization.problems.QuadraticProgram.is_feasible" name="is_feasible" signature="is_feasible(x)">
  ...
  <Function id="qiskit.optimization.problems.QuadraticProgram.linear_constraint" name="linear_constraint" signature="linear_constraint(linear=None, sense='<=', rhs=0.0, name=None)">
  ...
  <Function id="qiskit.optimization.problems.QuadraticProgram.linear_constraints" name="linear_constraints" signature="property linear_constraints">
  ...
  <Function id="qiskit.optimization.problems.QuadraticProgram.linear_constraints_index" name="linear_constraints_index" signature="property linear_constraints_index">
  ...
  <Function id="qiskit.optimization.problems.QuadraticProgram.maximize" name="maximize" signature="maximize(constant=0.0, linear=None, quadratic=None)">
  ...
  <Function id="qiskit.optimization.problems.QuadraticProgram.minimize" name="minimize" signature="minimize(constant=0.0, linear=None, quadratic=None)">
  ...
  <Function id="qiskit.optimization.problems.QuadraticProgram.name" name="name" signature="property name">
  ...
  <Function id="qiskit.optimization.problems.QuadraticProgram.objective" name="objective" signature="property objective">
  ...
  <Function id="qiskit.optimization.problems.QuadraticProgram.pprint_as_string" name="pprint_as_string" signature="pprint_as_string()">
  ...
  <Function id="qiskit.optimization.problems.QuadraticProgram.prettyprint" name="prettyprint" signature="prettyprint(out=None)">
  ...
  <Function id="qiskit.optimization.problems.QuadraticProgram.quadratic_constraint" name="quadratic_constraint" signature="quadratic_constraint(linear=None, quadratic=None, sense='<=', rhs=0.0, name=None)">
  ...
  <Function id="qiskit.optimization.problems.QuadraticProgram.quadratic_constraints" name="quadratic_constraints" signature="property quadratic_constraints">
  ...
  <Function id="qiskit.optimization.problems.QuadraticProgram.quadratic_constraints_index" name="quadratic_constraints_index" signature="property quadratic_constraints_index">
  ...
  <Function id="qiskit.optimization.problems.QuadraticProgram.read_from_lp_file" name="read_from_lp_file" signature="read_from_lp_file(filename)">
  ...
  <Function id="qiskit.optimization.problems.QuadraticProgram.remove_linear_constraint" name="remove_linear_constraint" signature="remove_linear_constraint(i)">
  ...
  <Function id="qiskit.optimization.problems.QuadraticProgram.remove_quadratic_constraint" name="remove_quadratic_constraint" signature="remove_quadratic_constraint(i)">
  ...
  <Function id="qiskit.optimization.problems.QuadraticProgram.status" name="status" signature="property status">
  ...
  <Function id="qiskit.optimization.problems.QuadraticProgram.substitute_variables" name="substitute_variables" signature="substitute_variables(constants=None, variables=None)">
  ...
  <Function id="qiskit.optimization.problems.QuadraticProgram.to_docplex" name="to_docplex" signature="to_docplex()">
  ...
  <Function id="qiskit.optimization.problems.QuadraticProgram.to_ising" name="to_ising" signature="to_ising()">
  ...
  <Function id="qiskit.optimization.problems.QuadraticProgram.variables" name="variables" signature="property variables">
  ...
  <Function id="qiskit.optimization.problems.QuadraticProgram.variables_index" name="variables_index" signature="property variables_index">
  ...
  <Function id="qiskit.optimization.problems.QuadraticProgram.write_to_lp_file" name="write_to_lp_file" signature="write_to_lp_file(filename)">
