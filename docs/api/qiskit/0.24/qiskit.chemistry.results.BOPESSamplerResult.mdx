...
<Class id="qiskit.chemistry.results.BOPESSamplerResult" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.8/qiskit/chemistry/results/bopes_sampler_result.py" signature="BOPESSamplerResult(points, energies, raw_results)">
