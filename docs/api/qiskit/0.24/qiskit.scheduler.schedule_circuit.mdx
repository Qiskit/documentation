---
title: schedule_circuit (v0.24)
description: API reference for qiskit.scheduler.schedule_circuit in qiskit v0.24
...
<Function id="qiskit.scheduler.schedule_circuit.schedule_circuit" github="https://github.com/qiskit/qiskit/tree/stable/0.16/qiskit/scheduler/schedule_circuit.py" signature="schedule_circuit(circuit, schedule_config, method=None)">
