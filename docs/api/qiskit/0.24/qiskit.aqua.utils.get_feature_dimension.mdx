...
<Function id="qiskit.aqua.utils.get_feature_dimension" github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.8/qiskit/aqua/utils/dataset_helper.py" signature="get_feature_dimension(dataset)">
