...
<Class id="qiskit.aqua.components.multiclass_extensions.AllPairs" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.8/qiskit/aqua/components/multiclass_extensions/all_pairs.py" signature="AllPairs">
  ...
  <Function id="qiskit.aqua.components.multiclass_extensions.AllPairs.__init__" name="__init__" signature="__init__()">
  ...
  <Function id="qiskit.aqua.components.multiclass_extensions.AllPairs.predict" name="predict" signature="predict(x)">
  ...
  <Function id="qiskit.aqua.components.multiclass_extensions.AllPairs.set_estimator" name="set_estimator" signature="set_estimator(estimator_cls, params=None)">
  ...
  <Function id="qiskit.aqua.components.multiclass_extensions.AllPairs.test" name="test" signature="test(x, y)">
  ...
  <Function id="qiskit.aqua.components.multiclass_extensions.AllPairs.train" name="train" signature="train(x, y)">
