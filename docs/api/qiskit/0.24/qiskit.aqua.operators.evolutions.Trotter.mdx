...
<Class id="qiskit.aqua.operators.evolutions.Trotter" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.8/qiskit/aqua/operators/evolutions/trotterizations/trotter.py" signature="Trotter(reps=1)">
  ...
  **reps** (`int`) – The number of times to repeat the Trotterization circuit.
  ...
  <Function id="qiskit.aqua.operators.evolutions.Trotter.order" signature="property order">
    returns order
  ...
  <Function id="qiskit.aqua.operators.evolutions.Trotter.reps" signature="property reps">
