...
<Class id="qiskit.transpiler.PassManagerConfig" github="https://github.com/qiskit/qiskit/tree/stable/0.16/qiskit/transpiler/passmanager_config.py" signature="PassManagerConfig(initial_layout=None, basis_gates=None, coupling_map=None, layout_method=None, routing_method=None, translation_method=None, scheduling_method=None, instruction_durations=None, backend_properties=None, seed_transpiler=None)">
  ...
  *   **seed\_transpiler** (*int*) – Sets random seed for the stochastic parts of the transpiler.
  ...
  <Function id="qiskit.transpiler.PassManagerConfig.__init__" name="__init__" signature="__init__(initial_layout=None, basis_gates=None, coupling_map=None, layout_method=None, routing_method=None, translation_method=None, scheduling_method=None, instruction_durations=None, backend_properties=None, seed_transpiler=None)">
    Initialize a PassManagerConfig object
