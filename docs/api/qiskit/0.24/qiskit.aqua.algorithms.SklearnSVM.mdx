...
<Class id="qiskit.aqua.algorithms.SklearnSVM" github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.8/qiskit/aqua/algorithms/classifiers/sklearn_svm/sklearn_svm.py" signature="SklearnSVM(training_dataset, test_dataset=None, datapoints=None, gamma=None, multiclass_extension=None)">
  ...
  **Raises**
  ...
  <Function id="qiskit.aqua.algorithms.SklearnSVM.__init__" name="__init__" signature="__init__(training_dataset, test_dataset=None, datapoints=None, gamma=None, multiclass_extension=None)">
    **Parameters**
  ...
  <Function id="qiskit.aqua.algorithms.SklearnSVM.class_to_label" name="class_to_label" signature="property class_to_label">
    returns class to label
  </Function>

  ### label\_to\_class

  <Function id="qiskit.aqua.algorithms.SklearnSVM.label_to_class" name="label_to_class" signature="property label_to_class">
    returns label to class
  </Function>

  ### load\_model

  <Function id="qiskit.aqua.algorithms.SklearnSVM.load_model" name="load_model" signature="load_model(file_path)">
  ...
  <Function id="qiskit.aqua.algorithms.SklearnSVM.predict" name="predict" signature="predict(data)">
  ...
  <Function id="qiskit.aqua.algorithms.SklearnSVM.random" name="random" signature="property random">
    Return a numpy random.
  </Function>

  ### ret

  <Function id="qiskit.aqua.algorithms.SklearnSVM.ret" name="ret" signature="property ret">
    returns result
  </Function>

  ### run

  <Function id="qiskit.aqua.algorithms.SklearnSVM.run" name="run" signature="run()">
  ...
  <Function id="qiskit.aqua.algorithms.SklearnSVM.save_model" name="save_model" signature="save_model(file_path)">
  ...
  <Function id="qiskit.aqua.algorithms.SklearnSVM.test" name="test" signature="test(data, labels)">
    Test the SVM
  ...
  <Function id="qiskit.aqua.algorithms.SklearnSVM.train" name="train" signature="train(data, labels)">
    Train the SVM
