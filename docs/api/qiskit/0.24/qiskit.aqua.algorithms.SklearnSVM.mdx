...
<Class id="qiskit.aqua.algorithms.SklearnSVM" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.8/qiskit/aqua/algorithms/classifiers/sklearn_svm/sklearn_svm.py" signature="SklearnSVM(training_dataset, test_dataset=None, datapoints=None, gamma=None, multiclass_extension=None)" modifiers="class">
  ...
  **Raises**
  ...
  <Function id="qiskit.aqua.algorithms.SklearnSVM.class_to_label" signature="class_to_label" modifiers="property">
    returns class to label
  </Function>

  ### label\_to\_class

  <Function id="qiskit.aqua.algorithms.SklearnSVM.label_to_class" signature="label_to_class" modifiers="property">
  ...
  <Function id="qiskit.aqua.algorithms.SklearnSVM.random" signature="random" modifiers="property">
    Return a numpy random.
  </Function>

  ### ret

  <Function id="qiskit.aqua.algorithms.SklearnSVM.ret" signature="ret" modifiers="property">
    returns result
  </Function>
