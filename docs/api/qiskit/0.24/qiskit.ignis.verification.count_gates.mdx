...
<Function id="qiskit.ignis.verification.count_gates" github="https://github.com/qiskit-community/qiskit-ignis/tree/stable/0.5/qiskit/ignis/verification/randomized_benchmarking/rb_utils.py" signature="count_gates(qobj, basis, qubits)">
