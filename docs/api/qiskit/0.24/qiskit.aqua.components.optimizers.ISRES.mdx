...
<Class id="qiskit.aqua.components.optimizers.ISRES" github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.8/qiskit/aqua/components/optimizers/nlopts/isres.py" signature="ISRES(max_evals=1000)">
