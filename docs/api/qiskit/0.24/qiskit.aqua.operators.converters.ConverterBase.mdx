...
<Class id="qiskit.aqua.operators.converters.ConverterBase" github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.8/qiskit/aqua/operators/converters/converter_base.py" signature="ConverterBase">
