---
title: ConverterBase (v0.24)
description: API reference for qiskit.aqua.operators.converters.ConverterBase in qiskit v0.24
...
<Class id="qiskit.aqua.operators.converters.ConverterBase" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.8/qiskit/aqua/operators/converters/converter_base.py" signature="ConverterBase" modifiers="class">
