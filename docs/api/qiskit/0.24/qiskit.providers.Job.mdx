...
<Class id="qiskit.providers.Job" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.16/qiskit/providers/job.py" signature="Job">
  ...
  <Function id="qiskit.providers.Job.__init__" name="__init__" signature="__init__()">
