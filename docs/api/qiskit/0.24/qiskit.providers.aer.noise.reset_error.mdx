...
<Function id="qiskit.providers.aer.noise.reset_error" github="https://github.com/qiskit/qiskit-aer/tree/stable/0.7/qiskit/providers/aer/noise/errors/standard_errors.py" signature="reset_error(prob0, prob1=0)">
