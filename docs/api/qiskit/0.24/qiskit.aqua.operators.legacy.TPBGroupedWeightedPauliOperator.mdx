...
<Class id="qiskit.aqua.operators.legacy.TPBGroupedWeightedPauliOperator" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.8/qiskit/aqua/operators/legacy/tpb_grouped_weighted_pauli_operator.py" signature="TPBGroupedWeightedPauliOperator(paulis, basis, z2_symmetries=None, atol=1e-12, name=None, grouping_func=None, kwargs=None)" modifiers="class">
  ...
  *   **kwargs** (*dict*) – Optional parameters for grouping function call
  ...
  <Function id="qiskit.aqua.operators.legacy.TPBGroupedWeightedPauliOperator.atol" signature="atol" modifiers="property">
    get atol
  </Function>

  ### basis

  <Function id="qiskit.aqua.operators.legacy.TPBGroupedWeightedPauliOperator.basis" signature="basis" modifiers="property">
    returns basis
  </Function>
  ...
  <Function id="qiskit.aqua.operators.legacy.TPBGroupedWeightedPauliOperator.grouping_func" signature="grouping_func" modifiers="property">
  ...
  <Function id="qiskit.aqua.operators.legacy.TPBGroupedWeightedPauliOperator.kwargs" signature="kwargs" modifiers="property">
    returns kwargs
  </Function>
  ...
  <Function id="qiskit.aqua.operators.legacy.TPBGroupedWeightedPauliOperator.name" signature="name" modifiers="property">
    returns name
  </Function>

  ### num\_groups

  <Function id="qiskit.aqua.operators.legacy.TPBGroupedWeightedPauliOperator.num_groups" signature="num_groups" modifiers="property">
    returns number of groups
  </Function>

  ### num\_qubits

  <Function id="qiskit.aqua.operators.legacy.TPBGroupedWeightedPauliOperator.num_qubits" signature="num_qubits" modifiers="property">
  ...
  <Function id="qiskit.aqua.operators.legacy.TPBGroupedWeightedPauliOperator.paulis" signature="paulis" modifiers="property">
    get paulis
  </Function>
  ...
  <Function id="qiskit.aqua.operators.legacy.TPBGroupedWeightedPauliOperator.z2_symmetries" signature="z2_symmetries" modifiers="property">
