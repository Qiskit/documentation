---
title: pauli_basis (v0.24)
description: API reference for qiskit.quantum_info.pauli_basis in qiskit v0.24
...
<Function id="qiskit.quantum_info.pauli_basis" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.16/qiskit/quantum_info/operators/symplectic/pauli_utils.py" signature="pauli_basis(num_qubits, weight=False)">
