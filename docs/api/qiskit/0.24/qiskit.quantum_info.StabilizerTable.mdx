...
<Class id="qiskit.quantum_info.StabilizerTable" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.16/qiskit/quantum_info/operators/symplectic/stabilizer_table.py" signature="StabilizerTable(data, phase=None)">
...
$$
  ...
  **Additional Information:**
  ...
  <Function id="qiskit.quantum_info.StabilizerTable.__init__" name="__init__" signature="__init__(data, phase=None)">
    Initialize the StabilizerTable.
  ...
  <Function id="qiskit.quantum_info.StabilizerTable.X" name="X" signature="property X">
    The X block of the [`array`](#qiskit.quantum_info.StabilizerTable.array "qiskit.quantum_info.StabilizerTable.array").
  </Function>

  ### Z

  <Function id="qiskit.quantum_info.StabilizerTable.Z" name="Z" signature="property Z">
    The Z block of the [`array`](#qiskit.quantum_info.StabilizerTable.array "qiskit.quantum_info.StabilizerTable.array").
  </Function>

  ### add

  <Function id="qiskit.quantum_info.StabilizerTable.add" name="add" signature="add(other)">
  ...
  <Function id="qiskit.quantum_info.StabilizerTable.adjoint" name="adjoint" signature="adjoint()">
    Return the adjoint of the operator.
  </Function>

  ### anticommutes\_with\_all

  <Function id="qiskit.quantum_info.StabilizerTable.anticommutes_with_all" name="anticommutes_with_all" signature="anticommutes_with_all(other)">
  ...
  <Function id="qiskit.quantum_info.StabilizerTable.argsort" name="argsort" signature="argsort(weight=False)">
  ...
  <Function id="qiskit.quantum_info.StabilizerTable.array" name="array" signature="property array">
    The underlying boolean array.
  </Function>

  ### atol

  <Function id="qiskit.quantum_info.StabilizerTable.atol" name="atol" signature="property atol">
    The default absolute tolerance parameter for float comparisons.
  </Function>

  ### commutes

  <Function id="qiskit.quantum_info.StabilizerTable.commutes" name="commutes" signature="commutes(pauli)">
  ...
  <Function id="qiskit.quantum_info.StabilizerTable.commutes_with_all" name="commutes_with_all" signature="commutes_with_all(other)">
    Return indexes of rows that commute other.
  ...
  <Function id="qiskit.quantum_info.StabilizerTable.compose" name="compose" signature="compose(other, qargs=None, front=False)">
  ...
  <Function id="qiskit.quantum_info.StabilizerTable.conjugate" name="conjugate" signature="conjugate()">
    Not implemented.
  </Function>

  ### copy

  <Function id="qiskit.quantum_info.StabilizerTable.copy" name="copy" signature="copy()">
    Return a copy of the StabilizerTable.
  </Function>

  ### delete

  <Function id="qiskit.quantum_info.StabilizerTable.delete" name="delete" signature="delete(ind, qubit=False)">
  ...
  <Function id="qiskit.quantum_info.StabilizerTable.dim" name="dim" signature="property dim">
    Return tuple (input\_shape, output\_shape).
  </Function>

  ### dot

  <Function id="qiskit.quantum_info.StabilizerTable.dot" name="dot" signature="dot(other, qargs=None)">
  ...
  <Function id="qiskit.quantum_info.StabilizerTable.expand" name="expand" signature="expand(other)">
  ...
  <Function id="qiskit.quantum_info.StabilizerTable.from_labels" name="from_labels" signature="classmethod from_labels(labels)">
  ...
  <Function id="qiskit.quantum_info.StabilizerTable.input_dims" name="input_dims" signature="input_dims(qargs=None)">
    Return tuple of input dimension for specified subsystems.
  </Function>

  ### insert

  <Function id="qiskit.quantum_info.StabilizerTable.insert" name="insert" signature="insert(ind, value, qubit=False)">
  ...
  <Function id="qiskit.quantum_info.StabilizerTable.label_iter" name="label_iter" signature="label_iter()">
  ...
  <Function id="qiskit.quantum_info.StabilizerTable.matrix_iter" name="matrix_iter" signature="matrix_iter(sparse=False)">
  ...
  <Function id="qiskit.quantum_info.StabilizerTable.multiply" name="multiply" signature="multiply(other)">
  ...
  <Function id="qiskit.quantum_info.StabilizerTable.num_qubits" name="num_qubits" signature="property num_qubits">
    Return the number of qubits if a N-qubit operator or None otherwise.
  </Function>

  ### output\_dims

  <Function id="qiskit.quantum_info.StabilizerTable.output_dims" name="output_dims" signature="output_dims(qargs=None)">
    Return tuple of output dimension for specified subsystems.
  </Function>

  ### pauli

  <Function id="qiskit.quantum_info.StabilizerTable.pauli" name="pauli" signature="property pauli">
    Return PauliTable
  </Function>

  ### phase

  <Function id="qiskit.quantum_info.StabilizerTable.phase" name="phase" signature="property phase">
    Return phase vector
  </Function>

  ### power

  <Function id="qiskit.quantum_info.StabilizerTable.power" name="power" signature="power(n)">
  ...
  <Function id="qiskit.quantum_info.StabilizerTable.qargs" name="qargs" signature="property qargs">
    Return the qargs for the operator.
  </Function>

  ### reshape

  <Function id="qiskit.quantum_info.StabilizerTable.reshape" name="reshape" signature="reshape(input_dims=None, output_dims=None)">
  ...
  <Function id="qiskit.quantum_info.StabilizerTable.rtol" name="rtol" signature="property rtol">
    The relative tolerance parameter for float comparisons.
  </Function>

  ### set\_atol

  <Function id="qiskit.quantum_info.StabilizerTable.set_atol" name="set_atol" signature="classmethod set_atol(value)">
  ...
  <Function id="qiskit.quantum_info.StabilizerTable.set_rtol" name="set_rtol" signature="classmethod set_rtol(value)">
  ...
  <Function id="qiskit.quantum_info.StabilizerTable.shape" name="shape" signature="property shape">
    The full shape of the [`array()`](#qiskit.quantum_info.StabilizerTable.array "qiskit.quantum_info.StabilizerTable.array")
  </Function>

  ### size

  <Function id="qiskit.quantum_info.StabilizerTable.size" name="size" signature="property size">
    The number of Pauli rows in the table.
  </Function>

  ### sort

  <Function id="qiskit.quantum_info.StabilizerTable.sort" name="sort" signature="sort(weight=False)">
  ...
  <Function id="qiskit.quantum_info.StabilizerTable.subtract" name="subtract" signature="subtract(other)">
    Return the linear operator self - other.
  ...
  <Function id="qiskit.quantum_info.StabilizerTable.tensor" name="tensor" signature="tensor(other)">
  ...
  <Function id="qiskit.quantum_info.StabilizerTable.to_labels" name="to_labels" signature="to_labels(array=False)">
  ...
  <Function id="qiskit.quantum_info.StabilizerTable.to_matrix" name="to_matrix" signature="to_matrix(sparse=False, array=False)">
  ...
  <Function id="qiskit.quantum_info.StabilizerTable.transpose" name="transpose" signature="transpose()">
    Not implemented.
  </Function>

  ### unique

  <Function id="qiskit.quantum_info.StabilizerTable.unique" name="unique" signature="unique(return_index=False, return_counts=False)">
