...
<Class id="qiskit.pulse.InstructionScheduleMap" github="https://github.com/qiskit/qiskit/tree/stable/0.16/qiskit/pulse/instruction_schedule_map.py" signature="InstructionScheduleMap">
