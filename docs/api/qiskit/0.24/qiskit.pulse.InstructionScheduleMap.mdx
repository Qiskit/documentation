...
<Class id="qiskit.pulse.InstructionScheduleMap" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.16/qiskit/pulse/instruction_schedule_map.py" signature="InstructionScheduleMap">
  ...
  <Function id="qiskit.pulse.InstructionScheduleMap.add" name="add" signature="add(instruction, qubits, schedule)">
