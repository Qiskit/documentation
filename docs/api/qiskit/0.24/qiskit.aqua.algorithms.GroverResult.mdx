...
<Class id="qiskit.aqua.algorithms.GroverResult" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.8/qiskit/aqua/algorithms/amplitude_amplifiers/grover.py" signature="GroverResult(a_dict=None)">
  Grover Result.

  ### \_\_init\_\_

  <Function id="qiskit.aqua.algorithms.GroverResult.__init__" name="__init__" signature="__init__(a_dict=None)">
  ...
  <Function id="qiskit.aqua.algorithms.GroverResult.assignment" name="assignment" signature="property assignment">
    return assignment
  ...
  <Function id="qiskit.aqua.algorithms.GroverResult.circuit" name="circuit" signature="property circuit">
    return circuit
  ...
  <Function id="qiskit.aqua.algorithms.GroverResult.clear" name="clear" signature="clear()">
    **Return type**
  ...
  <Function id="qiskit.aqua.algorithms.GroverResult.combine" name="combine" signature="combine(result)">
  ...
  <Function id="qiskit.aqua.algorithms.GroverResult.from_dict" name="from_dict" signature="static from_dict(a_dict)">
  ...
  <Function id="qiskit.aqua.algorithms.GroverResult.get" name="get" signature="get(k[, d]) → D[k] if k in D, else d. d defaults to None." />

  ### items

  <Function id="qiskit.aqua.algorithms.GroverResult.items" name="items" signature="items() → a set-like object providing a view on D’s items" />

  ### keys

  <Function id="qiskit.aqua.algorithms.GroverResult.keys" name="keys" signature="keys() → a set-like object providing a view on D’s keys" />

  ### measurement

  <Function id="qiskit.aqua.algorithms.GroverResult.measurement" name="measurement" signature="property measurement">
    returns measurement
  ...
  <Function id="qiskit.aqua.algorithms.GroverResult.oracle_evaluation" name="oracle_evaluation" signature="property oracle_evaluation">
  ...
  <Function id="qiskit.aqua.algorithms.GroverResult.pop" name="pop" signature="pop(key, default=None)">
  ...
  <Function id="qiskit.aqua.algorithms.GroverResult.popitem" name="popitem" signature="popitem()">
  ...
  <Function id="qiskit.aqua.algorithms.GroverResult.setdefault" name="setdefault" signature="setdefault(k[, d]) → D.get(k,d), also set D[k]=d if k not in D" />

  ### top\_measurement

  <Function id="qiskit.aqua.algorithms.GroverResult.top_measurement" name="top_measurement" signature="property top_measurement">
  ...
  <Function id="qiskit.aqua.algorithms.GroverResult.update" name="update" signature="update(*args, **kwargs)">
  ...
  <Function id="qiskit.aqua.algorithms.GroverResult.values" name="values" signature="values() → an object providing a view on D’s values" />
</Class>
