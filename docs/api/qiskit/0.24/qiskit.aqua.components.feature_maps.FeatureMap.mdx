...
<Class id="qiskit.aqua.components.feature_maps.FeatureMap" github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.8/qiskit/aqua/components/feature_maps/feature_map.py" signature="FeatureMap">
