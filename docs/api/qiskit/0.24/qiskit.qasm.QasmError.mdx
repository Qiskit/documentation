...
<Class id="qiskit.qasm.QasmError" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.16/qiskit/qasm/exceptions.py" signature="QasmError(*msg)">
