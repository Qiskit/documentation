...
<Class id="qiskit.aqua.algorithms.BernsteinVazirani" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.8/qiskit/aqua/algorithms/education/bernstein_vazirani.py" signature="BernsteinVazirani(oracle, quantum_instance=None)">
  ...
  *   **quantum\_instance** (`Union`\[`QuantumInstance`, `Backend`, `BaseBackend`, `None`]) – Quantum Instance or Backend
  ...
  <Function id="qiskit.aqua.algorithms.BernsteinVazirani.backend" signature="property backend">
    Returns backend.
  ...
  <Function id="qiskit.aqua.algorithms.BernsteinVazirani.quantum_instance" signature="property quantum_instance">
  ...
  <Function id="qiskit.aqua.algorithms.BernsteinVazirani.random" signature="property random">
