...
<span id="qiskit-quantum-info-mutual-information" />

# qiskit.quantum\_info.mutual\_information

<span id="qiskit.quantum_info.mutual_information" />

`mutual_information(state, base=2)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.16/qiskit/quantum_info/states/measures.py "view source code")
