...
<Class id="qiskit.qobj.GateCalibration" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.16/qiskit/qobj/qasm_qobj.py" signature="GateCalibration(name, qubits, params, instructions)">
  ...
  *   **instructions** (*list(*[*PulseQobjInstruction*](qiskit.qobj.PulseQobjInstruction "qiskit.qobj.PulseQobjInstruction")*)*) – The gate implementation.
  ...
  <Function id="qiskit.qobj.GateCalibration.__init__" name="__init__" signature="__init__(name, qubits, params, instructions)">
    Initialize a single gate calibration. Instructions may reference waveforms which should be made available in the pulse\_library.
  ...
  <Function id="qiskit.qobj.GateCalibration.from_dict" name="from_dict" signature="classmethod from_dict(data)">
  ...
  <Function id="qiskit.qobj.GateCalibration.to_dict" name="to_dict" signature="to_dict()">
