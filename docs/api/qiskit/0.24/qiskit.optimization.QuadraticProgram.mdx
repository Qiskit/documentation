...
<Class id="qiskit.optimization.QuadraticProgram" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.8/qiskit/optimization/problems/quadratic_program.py" signature="QuadraticProgram(name='')" modifiers="class">
  ...
  **name** (`str`) – The name of the quadratic program.
  ...
  <Function id="qiskit.optimization.QuadraticProgram.__init__" signature="__init__(name='')">
    **Parameters**
  ...
  <Attribute id="qiskit.optimization.QuadraticProgram.Status">
    alias of `QuadraticProgramStatus`
  </Attribute>

  ### binary\_var

  <Function id="qiskit.optimization.QuadraticProgram.binary_var" signature="binary_var(name=None)">
  ...
  <Function id="qiskit.optimization.QuadraticProgram.clear" signature="clear()">
  ...
  <Function id="qiskit.optimization.QuadraticProgram.continuous_var" signature="continuous_var(lowerbound=0, upperbound=1e+20, name=None)">
  ...
  <Function id="qiskit.optimization.QuadraticProgram.export_as_lp_string" signature="export_as_lp_string()">
  ...
  <Function id="qiskit.optimization.QuadraticProgram.from_docplex" signature="from_docplex(model)">
  ...
  <Function id="qiskit.optimization.QuadraticProgram.from_ising" signature="from_ising(qubit_op, offset=0.0, linear=False)">
  ...
  <Function id="qiskit.optimization.QuadraticProgram.get_feasibility_info" signature="get_feasibility_info(x)">
  ...
  <Function id="qiskit.optimization.QuadraticProgram.get_linear_constraint" signature="get_linear_constraint(i)">
  ...
  <Function id="qiskit.optimization.QuadraticProgram.get_num_binary_vars" signature="get_num_binary_vars()">
  ...
  <Function id="qiskit.optimization.QuadraticProgram.get_num_continuous_vars" signature="get_num_continuous_vars()">
  ...
  <Function id="qiskit.optimization.QuadraticProgram.get_num_integer_vars" signature="get_num_integer_vars()">
  ...
  <Function id="qiskit.optimization.QuadraticProgram.get_num_linear_constraints" signature="get_num_linear_constraints()">
  ...
  <Function id="qiskit.optimization.QuadraticProgram.get_num_quadratic_constraints" signature="get_num_quadratic_constraints()">
  ...
  <Function id="qiskit.optimization.QuadraticProgram.get_num_vars" signature="get_num_vars(vartype=None)">
  ...
  <Function id="qiskit.optimization.QuadraticProgram.get_quadratic_constraint" signature="get_quadratic_constraint(i)">
  ...
  <Function id="qiskit.optimization.QuadraticProgram.get_variable" signature="get_variable(i)">
  ...
  <Function id="qiskit.optimization.QuadraticProgram.integer_var" signature="integer_var(lowerbound=0, upperbound=1e+20, name=None)">
  ...
  <Function id="qiskit.optimization.QuadraticProgram.is_feasible" signature="is_feasible(x)">
  ...
  <Function id="qiskit.optimization.QuadraticProgram.linear_constraint" signature="linear_constraint(linear=None, sense='<=', rhs=0.0, name=None)">
  ...
  <Function id="qiskit.optimization.QuadraticProgram.linear_constraints" signature="linear_constraints" modifiers="property">
  ...
  <Function id="qiskit.optimization.QuadraticProgram.linear_constraints_index" signature="linear_constraints_index" modifiers="property">
  ...
  <Function id="qiskit.optimization.QuadraticProgram.maximize" signature="maximize(constant=0.0, linear=None, quadratic=None)">
  ...
  <Function id="qiskit.optimization.QuadraticProgram.minimize" signature="minimize(constant=0.0, linear=None, quadratic=None)">
  ...
  <Function id="qiskit.optimization.QuadraticProgram.name" signature="name" modifiers="property">
  ...
  <Function id="qiskit.optimization.QuadraticProgram.objective" signature="objective" modifiers="property">
  ...
  <Function id="qiskit.optimization.QuadraticProgram.pprint_as_string" signature="pprint_as_string()">
  ...
  <Function id="qiskit.optimization.QuadraticProgram.prettyprint" signature="prettyprint(out=None)">
  ...
  <Function id="qiskit.optimization.QuadraticProgram.quadratic_constraint" signature="quadratic_constraint(linear=None, quadratic=None, sense='<=', rhs=0.0, name=None)">
  ...
  <Function id="qiskit.optimization.QuadraticProgram.quadratic_constraints" signature="quadratic_constraints" modifiers="property">
  ...
  <Function id="qiskit.optimization.QuadraticProgram.quadratic_constraints_index" signature="quadratic_constraints_index" modifiers="property">
  ...
  <Function id="qiskit.optimization.QuadraticProgram.read_from_lp_file" signature="read_from_lp_file(filename)">
  ...
  <Function id="qiskit.optimization.QuadraticProgram.remove_linear_constraint" signature="remove_linear_constraint(i)">
  ...
  <Function id="qiskit.optimization.QuadraticProgram.remove_quadratic_constraint" signature="remove_quadratic_constraint(i)">
  ...
  <Function id="qiskit.optimization.QuadraticProgram.status" signature="status" modifiers="property">
  ...
  <Function id="qiskit.optimization.QuadraticProgram.substitute_variables" signature="substitute_variables(constants=None, variables=None)">
  ...
  <Function id="qiskit.optimization.QuadraticProgram.to_docplex" signature="to_docplex()">
  ...
  <Function id="qiskit.optimization.QuadraticProgram.to_ising" signature="to_ising()">
  ...
  <Function id="qiskit.optimization.QuadraticProgram.variables" signature="variables" modifiers="property">
  ...
  <Function id="qiskit.optimization.QuadraticProgram.variables_index" signature="variables_index" modifiers="property">
  ...
  <Function id="qiskit.optimization.QuadraticProgram.write_to_lp_file" signature="write_to_lp_file(filename)">
