---
title: QuadraticProgram (v0.24)
description: API reference for qiskit.optimization.QuadraticProgram in qiskit v0.24
...
<Class id="qiskit.optimization.QuadraticProgram" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.8/qiskit/optimization/problems/quadratic_program.py" signature="QuadraticProgram(name='')" modifiers="class">
  ...
  **name** (`str`) – The name of the quadratic program.
  ...
  <Attribute id="qiskit.optimization.QuadraticProgram.linear_constraints">
  ...
  <Attribute id="qiskit.optimization.QuadraticProgram.linear_constraints_index">
  ...
  <Attribute id="qiskit.optimization.QuadraticProgram.name">
  ...
  <Attribute id="qiskit.optimization.QuadraticProgram.objective">
  ...
  <Attribute id="qiskit.optimization.QuadraticProgram.quadratic_constraints">
  ...
  <Attribute id="qiskit.optimization.QuadraticProgram.quadratic_constraints_index">
  ...
  <Attribute id="qiskit.optimization.QuadraticProgram.variables">
  ...
  <Attribute id="qiskit.optimization.QuadraticProgram.variables_index">
