...
<Function id="qiskit.quantum_info.pauli_group" github="https://github.com/qiskit/qiskit/tree/stable/0.16/qiskit/quantum_info/operators/pauli.py" signature="pauli_group(number_of_qubits, case='weight')">
