...
<Class id="qiskit.dagcircuit.DAGCircuit" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.16/qiskit/dagcircuit/dagcircuit.py" signature="DAGCircuit">
  ...
  <Function id="qiskit.dagcircuit.DAGCircuit.clbits" name="clbits" signature="property clbits">
  ...
  <Function id="qiskit.dagcircuit.DAGCircuit.qubits" name="qubits" signature="property qubits">
