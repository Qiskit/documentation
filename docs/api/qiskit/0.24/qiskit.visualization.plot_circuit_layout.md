...
`plot_circuit_layout(circuit, backend, view='virtual')`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.16/qiskit/visualization/gate_map.py "view source code")
...
![../\_images/qiskit.visualization.plot\_circuit\_layout\_1\_0.png](/images/api/qiskit/0.24/qiskit.visualization.plot_circuit_layout_1_0.png) ![../\_images/qiskit.visualization.plot\_circuit\_layout\_1\_1.png](/images/api/qiskit/0.24/qiskit.visualization.plot_circuit_layout_1_1.png)
