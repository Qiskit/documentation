...
<Class id="qiskit.circuit.AncillaRegister" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.16/qiskit/circuit/quantumregister.py" signature="AncillaRegister(size, name=None)">
  ...
  <Function id="qiskit.circuit.AncillaRegister.__init__" name="__init__" signature="__init__(size, name=None)">
    Create a new generic register.
  </Function>
