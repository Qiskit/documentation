...
<Class id="qiskit.aqua.operators.gradients.Hessian" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.8/qiskit/aqua/operators/gradients/hessian.py" signature="Hessian(hess_method='param_shift', **kwargs)">
  ...
  **ValueError** – If method != `fin_diff` and `epsilon` is not None.
  ...
  <Function id="qiskit.aqua.operators.gradients.Hessian.__init__" name="__init__" signature="__init__(hess_method='param_shift', **kwargs)">
    **Parameters**
  ...
  <Function id="qiskit.aqua.operators.gradients.Hessian.convert" name="convert" signature="convert(operator, params=None)">
    **Parameters**
  ...
  <Function id="qiskit.aqua.operators.gradients.Hessian.get_hessian" name="get_hessian" signature="get_hessian(operator, params=None)">
  ...
  <Function id="qiskit.aqua.operators.gradients.Hessian.gradient_wrapper" name="gradient_wrapper" signature="gradient_wrapper(operator, bind_params, grad_params=None, backend=None)">
  ...
  <Function id="qiskit.aqua.operators.gradients.Hessian.hess_method" name="hess_method" signature="property hess_method">
  ...
  <Function id="qiskit.aqua.operators.gradients.Hessian.parameter_expression_grad" name="parameter_expression_grad" signature="static parameter_expression_grad(param_expr, param)">
