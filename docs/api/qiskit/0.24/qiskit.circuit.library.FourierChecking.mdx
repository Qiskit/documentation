...
`FourierChecking(f, g)` [GitHub](https://github.com/qiskit/qiskit/tree/stable/0.16/qiskit/circuit/library/fourier_checking.py "view source code")
...
| [`assign_parameters`](#qiskit.circuit.library.FourierChecking.assign_parameters "qiskit.circuit.library.FourierChecking.assign_parameters")(param\_dict\[, inplace])                      | Assign parameters to new parameters or values.                                                                                      |
...
| [`bind_parameters`](#qiskit.circuit.library.FourierChecking.bind_parameters "qiskit.circuit.library.FourierChecking.bind_parameters")(value\_dict)                                        | Assign numeric parameters to values yielding a new circuit.                                                                         |
...
| [`combine`](#qiskit.circuit.library.FourierChecking.combine "qiskit.circuit.library.FourierChecking.combine")(rhs)                                                                        | Append rhs to self if self contains compatible registers.                                                                           |
...
| [`diag_gate`](#qiskit.circuit.library.FourierChecking.diag_gate "qiskit.circuit.library.FourierChecking.diag_gate")(diag, qubit)                                                          | Deprecated version of QuantumCircuit.diagonal.                                                                                      |
...
| [`extend`](#qiskit.circuit.library.FourierChecking.extend "qiskit.circuit.library.FourierChecking.extend")(rhs)                                                                           | Append QuantumCircuit to the right hand side if it contains compatible registers.                                                   |
...
| [`hamiltonian`](#qiskit.circuit.library.FourierChecking.hamiltonian "qiskit.circuit.library.FourierChecking.hamiltonian")(operator, time, qubits\[, label])                               | Apply hamiltonian evolution to to qubits.                                                                                           |
...
| [`initialize`](#qiskit.circuit.library.FourierChecking.initialize "qiskit.circuit.library.FourierChecking.initialize")(params, qubits)                                                    | Apply initialize to circuit.                                                                                                        |
...
| [`mcmt`](#qiskit.circuit.library.FourierChecking.mcmt "qiskit.circuit.library.FourierChecking.mcmt")(gate, control\_qubits, target\_qubits\[, …])                                         | Apply a multi-control, multi-target using a generic gate.                                                                           |
...
| [`mcry`](#qiskit.circuit.library.FourierChecking.mcry "qiskit.circuit.library.FourierChecking.mcry")(theta, q\_controls, q\_target, q\_ancillae)                                          | Apply Multiple-Controlled Y rotation gate                                                                                           |
...
| [`mirror`](#qiskit.circuit.library.FourierChecking.mirror "qiskit.circuit.library.FourierChecking.mirror")()                                                                              | DEPRECATED: use circuit.reverse\_ops().                                                                                             |
...
| [`r`](#qiskit.circuit.library.FourierChecking.r "qiskit.circuit.library.FourierChecking.r")(theta, phi, qubit)                                                                            | Apply `RGate`.                                                                                                                      |
