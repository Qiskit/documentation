...
<Function id="qiskit.converters.circuit_to_instruction" github="https://github.com/qiskit/qiskit/tree/stable/0.16/qiskit/converters/circuit_to_instruction.py" signature="circuit_to_instruction(circuit, parameter_map=None, equivalence_library=None)">
