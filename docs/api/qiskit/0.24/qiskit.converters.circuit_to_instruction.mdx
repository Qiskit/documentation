---
title: circuit_to_instruction (v0.24)
description: API reference for qiskit.converters.circuit_to_instruction in qiskit v0.24
...
<Function id="qiskit.converters.circuit_to_instruction" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.16/qiskit/converters/circuit_to_instruction.py" signature="circuit_to_instruction(circuit, parameter_map=None, equivalence_library=None)">
