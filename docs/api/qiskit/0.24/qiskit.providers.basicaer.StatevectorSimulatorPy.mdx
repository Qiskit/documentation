...
<Class id="qiskit.providers.basicaer.StatevectorSimulatorPy" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.16/qiskit/providers/basicaer/statevector_simulator.py" signature="StatevectorSimulatorPy(configuration=None, provider=None)">
  ...
  **QiskitError** – if an error occurred when instantiating the backend.
  ...
  <Function id="qiskit.providers.basicaer.StatevectorSimulatorPy.__init__" name="__init__" signature="__init__(configuration=None, provider=None)">
    Base class for backends.
  ...
  <Function id="qiskit.providers.basicaer.StatevectorSimulatorPy.run" name="run" signature="run(qobj, backend_options=None)">
  ...
  <Function id="qiskit.providers.basicaer.StatevectorSimulatorPy.version" name="version" signature="version()">
