---
title: phase_amplitude_damping_error (v0.24)
description: API reference for qiskit.providers.aer.noise.phase_amplitude_damping_error in qiskit v0.24
