...
<Class id="qiskit.qobj.PulseQobjInstruction" github="https://github.com/qiskit/qiskit/tree/stable/0.16/qiskit/qobj/pulse_qobj.py" signature="PulseQobjInstruction(name, t0, ch=None, conditional=None, val=None, phase=None, duration=None, qubits=None, memory_slot=None, register_slot=None, kernels=None, discriminators=None, label=None, type=None, pulse_shape=None, parameters=None, frequency=None)">
  ...
  *   **parameters** (*dict*) – The parameters for a parametric pulse
  ...
  <Function id="qiskit.qobj.PulseQobjInstruction.__init__" name="__init__" signature="__init__(name, t0, ch=None, conditional=None, val=None, phase=None, duration=None, qubits=None, memory_slot=None, register_slot=None, kernels=None, discriminators=None, label=None, type=None, pulse_shape=None, parameters=None, frequency=None)">
    Instantiate a new PulseQobjInstruction object.
  ...
  <Function id="qiskit.qobj.PulseQobjInstruction.from_dict" name="from_dict" signature="classmethod from_dict(data)">
  ...
  <Function id="qiskit.qobj.PulseQobjInstruction.to_dict" name="to_dict" signature="to_dict()">
