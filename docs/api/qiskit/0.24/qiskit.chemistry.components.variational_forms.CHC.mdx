...
<Class id="qiskit.chemistry.components.variational_forms.CHC" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.8/qiskit/chemistry/components/variational_forms/chc.py" signature="CHC(num_qubits=None, reps=1, ladder=False, excitations=None, entanglement='full', initial_state=None)">
  ...
  *   **initial\_state** (`Optional`\[`InitialState`]) – an initial state object
  ...
  <Function id="qiskit.chemistry.components.variational_forms.CHC.get_entangler_map" signature="static get_entangler_map(map_type, num_qubits, offset=0)">
    returns entangler map
  </Function>

  ### num\_parameters

  <Function id="qiskit.chemistry.components.variational_forms.CHC.num_parameters" signature="property num_parameters">
  ...
  <Function id="qiskit.chemistry.components.variational_forms.CHC.num_qubits" signature="property num_qubits">
  ...
  <Function id="qiskit.chemistry.components.variational_forms.CHC.parameter_bounds" signature="property parameter_bounds">
    Parameter bounds.
  ...
  <Function id="qiskit.chemistry.components.variational_forms.CHC.preferred_init_points" signature="property preferred_init_points">
  ...
  <Function id="qiskit.chemistry.components.variational_forms.CHC.setting" signature="property setting" />

  ### support\_parameterized\_circuit

  <Function id="qiskit.chemistry.components.variational_forms.CHC.support_parameterized_circuit" signature="property support_parameterized_circuit">
  ...
  <Function id="qiskit.chemistry.components.variational_forms.CHC.validate_entangler_map" signature="static validate_entangler_map(entangler_map, num_qubits)">
