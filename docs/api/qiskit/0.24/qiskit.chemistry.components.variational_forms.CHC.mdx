...
<Class id="qiskit.chemistry.components.variational_forms.CHC" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.8/qiskit/chemistry/components/variational_forms/chc.py" signature="CHC(num_qubits=None, reps=1, ladder=False, excitations=None, entanglement='full', initial_state=None)" modifiers="class">
  ...
  *   **initial\_state** (`Optional`\[`InitialState`]) – an initial state object
  ...
  <Function id="qiskit.chemistry.components.variational_forms.CHC.num_parameters" signature="num_parameters" modifiers="property">
  ...
  <Function id="qiskit.chemistry.components.variational_forms.CHC.num_qubits" signature="num_qubits" modifiers="property">
  ...
  <Function id="qiskit.chemistry.components.variational_forms.CHC.parameter_bounds" signature="parameter_bounds" modifiers="property">
    Parameter bounds.
  ...
  <Function id="qiskit.chemistry.components.variational_forms.CHC.preferred_init_points" signature="preferred_init_points" modifiers="property">
  ...
  <Function id="qiskit.chemistry.components.variational_forms.CHC.setting" signature="setting" modifiers="property" />

  ### support\_parameterized\_circuit

  <Function id="qiskit.chemistry.components.variational_forms.CHC.support_parameterized_circuit" signature="support_parameterized_circuit" modifiers="property">
