...
<Function id="qiskit.aqua.operators.legacy.commutator" github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.8/qiskit/aqua/operators/legacy/common.py" signature="commutator(op_a, op_b, op_c=None, sign=False, threshold=1e-12)">
