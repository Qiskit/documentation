...
<Function id="qiskit.pulse.builder.seconds_to_samples" name="seconds_to_samples" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.16/qiskit/pulse/builder.py" signature="seconds_to_samples(seconds)">
