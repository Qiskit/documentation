...
<Class id="qiskit.circuit.library.C4XGate" github="https://github.com/qiskit/qiskit/tree/stable/0.16/qiskit/circuit/library/standard_gates/x.py" signature="C4XGate(label=None, ctrl_state=None)">
