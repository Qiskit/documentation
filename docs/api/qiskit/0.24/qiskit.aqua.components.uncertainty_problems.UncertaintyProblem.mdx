...
<Class id="qiskit.aqua.components.uncertainty_problems.UncertaintyProblem" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.8/qiskit/aqua/components/uncertainty_problems/uncertainty_problem.py" signature="UncertaintyProblem(num_qubits)">
  ...
  <Function id="qiskit.aqua.components.uncertainty_problems.UncertaintyProblem.build" signature="abstract build(qc, q, q_ancillas=None, params=None)">
  ...
  <Function id="qiskit.aqua.components.uncertainty_problems.UncertaintyProblem.num_target_qubits" signature="property num_target_qubits">
