---
title: UncertaintyProblem (v0.24)
description: API reference for qiskit.aqua.components.uncertainty_problems.UncertaintyProblem in qiskit v0.24
...
<Class id="qiskit.aqua.components.uncertainty_problems.UncertaintyProblem" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.8/qiskit/aqua/components/uncertainty_problems/uncertainty_problem.py" signature="UncertaintyProblem(num_qubits)" modifiers="class">
