...
<Class id="qiskit.ignis.verification.AccreditationFitter" github="https://github.com/qiskit-community/qiskit-ignis/tree/stable/0.5/qiskit/ignis/verification/accreditation/fitters.py" signature="AccreditationFitter">
