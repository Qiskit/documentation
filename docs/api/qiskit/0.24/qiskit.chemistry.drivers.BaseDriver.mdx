...
<Class id="qiskit.chemistry.drivers.BaseDriver" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.8/qiskit/chemistry/drivers/base_driver.py" signature="BaseDriver(molecule=None, basis='sto3g', hf_method='rhf', supports_molecule=False)">
  ...
  **Raises**
  ...
  <Function id="qiskit.chemistry.drivers.BaseDriver.__init__" signature="abstract __init__(molecule=None, basis='sto3g', hf_method='rhf', supports_molecule=False)">
    **Parameters**
  ...
  <Function id="qiskit.chemistry.drivers.BaseDriver.basis" signature="property basis">
    return basis
  ...
  <Function id="qiskit.chemistry.drivers.BaseDriver.hf_method" signature="property hf_method">
  ...
  <Function id="qiskit.chemistry.drivers.BaseDriver.molecule" signature="property molecule">
    return molecule
  ...
  <Function id="qiskit.chemistry.drivers.BaseDriver.supports_molecule" signature="property supports_molecule">
