...
<Class id="qiskit.chemistry.drivers.BaseDriver" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.8/qiskit/chemistry/drivers/base_driver.py" signature="BaseDriver(molecule=None, basis='sto3g', hf_method='rhf', supports_molecule=False)" modifiers="class">
  ...
  **Raises**
  ...
  <Function id="qiskit.chemistry.drivers.BaseDriver.basis" signature="basis" modifiers="property">
    return basis
  ...
  <Function id="qiskit.chemistry.drivers.BaseDriver.hf_method" signature="hf_method" modifiers="property">
  ...
  <Function id="qiskit.chemistry.drivers.BaseDriver.molecule" signature="molecule" modifiers="property">
    return molecule
  ...
  <Function id="qiskit.chemistry.drivers.BaseDriver.supports_molecule" signature="supports_molecule" modifiers="property">
