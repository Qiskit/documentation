...
<Function id="qiskit.pulse.builder.measure_all" name="measure_all" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.16/qiskit/pulse/builder.py" signature="measure_all()">
