...
<Class id="qiskit.quantum_info.SparsePauliOp" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.16/qiskit/quantum_info/operators/symplectic/sparse_pauli_op.py" signature="SparsePauliOp(data, coeffs=None)">
  ...
  **QiskitError** – If the input data or coeffs are invalid.
  ...
  <Function id="qiskit.quantum_info.SparsePauliOp.__init__" name="__init__" signature="__init__(data, coeffs=None)">
    Initialize an operator object.
  ...
  <Function id="qiskit.quantum_info.SparsePauliOp.add" name="add" signature="add(other)">
  ...
  <Function id="qiskit.quantum_info.SparsePauliOp.atol" name="atol" signature="property atol">
    The default absolute tolerance parameter for float comparisons.
  </Function>

  ### coeffs

  <Function id="qiskit.quantum_info.SparsePauliOp.coeffs" name="coeffs" signature="property coeffs">
  ...
  <Function id="qiskit.quantum_info.SparsePauliOp.dim" name="dim" signature="property dim">
  ...
  <Function id="qiskit.quantum_info.SparsePauliOp.from_list" name="from_list" signature="static from_list(obj)">
  ...
  <Function id="qiskit.quantum_info.SparsePauliOp.multiply" name="multiply" signature="multiply(other)">
  ...
  <Function id="qiskit.quantum_info.SparsePauliOp.num_qubits" name="num_qubits" signature="property num_qubits">
  ...
  <Function id="qiskit.quantum_info.SparsePauliOp.qargs" name="qargs" signature="property qargs">
    Return the qargs for the operator.
  </Function>

  ### reshape

  <Function id="qiskit.quantum_info.SparsePauliOp.reshape" name="reshape" signature="reshape(input_dims=None, output_dims=None)">
  ...
  <Function id="qiskit.quantum_info.SparsePauliOp.rtol" name="rtol" signature="property rtol">
    The relative tolerance parameter for float comparisons.
  </Function>

  ### set\_atol

  <Function id="qiskit.quantum_info.SparsePauliOp.set_atol" name="set_atol" signature="classmethod set_atol(value)">
  ...
  <Function id="qiskit.quantum_info.SparsePauliOp.set_rtol" name="set_rtol" signature="classmethod set_rtol(value)">
  ...
  <Function id="qiskit.quantum_info.SparsePauliOp.size" name="size" signature="property size">
    The number of Pauli of Pauli terms in the operator.
  </Function>

  ### subtract

  <Function id="qiskit.quantum_info.SparsePauliOp.subtract" name="subtract" signature="subtract(other)">
    Return the linear operator self - other.
  ...
  <Function id="qiskit.quantum_info.SparsePauliOp.table" name="table" signature="property table">
