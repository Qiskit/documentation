...
<Class id="qiskit.quantum_info.SparsePauliOp" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.16/qiskit/quantum_info/operators/symplectic/sparse_pauli_op.py" signature="SparsePauliOp(data, coeffs=None)">
  ...
  **QiskitError** – If the input data or coeffs are invalid.
  ...
  <Function id="qiskit.quantum_info.SparsePauliOp.atol" signature="property atol">
    The default absolute tolerance parameter for float comparisons.
  </Function>

  ### coeffs

  <Function id="qiskit.quantum_info.SparsePauliOp.coeffs" signature="property coeffs">
  ...
  <Function id="qiskit.quantum_info.SparsePauliOp.dim" signature="property dim">
  ...
  <Function id="qiskit.quantum_info.SparsePauliOp.from_list" signature="static from_list(obj)">
  ...
  <Function id="qiskit.quantum_info.SparsePauliOp.num_qubits" signature="property num_qubits">
  ...
  <Function id="qiskit.quantum_info.SparsePauliOp.qargs" signature="property qargs">
  ...
  <Function id="qiskit.quantum_info.SparsePauliOp.rtol" signature="property rtol">
    The relative tolerance parameter for float comparisons.
  </Function>

  ### set\_atol

  <Function id="qiskit.quantum_info.SparsePauliOp.set_atol" signature="classmethod set_atol(value)">
  ...
  <Function id="qiskit.quantum_info.SparsePauliOp.set_rtol" signature="classmethod set_rtol(value)">
  ...
  <Function id="qiskit.quantum_info.SparsePauliOp.size" signature="property size">
  ...
  <Function id="qiskit.quantum_info.SparsePauliOp.table" signature="property table">
