...
<Class id="qiskit.circuit.library.AND" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.16/qiskit/circuit/library/boolean_logic/quantum_and.py" signature="AND(num_variable_qubits, flags=None, mcx_mode='noancilla')">
  ...
  *   **mcx\_mode** (`str`) – The mode to be used to implement the multi-controlled X gate.
  ...
  <Function id="qiskit.circuit.library.AND.assign_parameters" name="assign_parameters" signature="assign_parameters(param_dict, inplace=False)">
  ...
  <Function id="qiskit.circuit.library.AND.bind_parameters" name="bind_parameters" signature="bind_parameters(value_dict)">
  ...
  <Function id="qiskit.circuit.library.AND.ccx" name="ccx" signature="ccx(control_qubit1, control_qubit2, target_qubit)">
  ...
  <Function id="qiskit.circuit.library.AND.compose" name="compose" signature="compose(other, qubits=None, clbits=None, front=False, inplace=False)">
  ...
  <Function id="qiskit.circuit.library.AND.diag_gate" name="diag_gate" signature="diag_gate(diag, qubit)">
  ...
  <Function id="qiskit.circuit.library.AND.initialize" name="initialize" signature="initialize(params, qubits)">
  ...
  <Function id="qiskit.circuit.library.AND.iso" name="iso" signature="iso(isometry, q_input, q_ancillas_for_output, q_ancillas_zero=None, q_ancillas_dirty=None)">
  ...
  <Function id="qiskit.circuit.library.AND.isometry" name="isometry" signature="isometry(isometry, q_input, q_ancillas_for_output, q_ancillas_zero=None, q_ancillas_dirty=None)">
    Attach an arbitrary isometry from m to n qubits to a circuit. In particular, this allows to attach arbitrary unitaries on n qubits (m=n) or to prepare any state on n qubits (m=0). The decomposition used here was introduced by Iten et al. in [https://arxiv.org/abs/1501.06911](https://arxiv.org/abs/1501.06911).
  ...
  <Function id="qiskit.circuit.library.AND.mcmt" name="mcmt" signature="mcmt(gate, control_qubits, target_qubits, ancilla_qubits=None, mode='noancilla', *, single_control_gate_fun=None, q_controls=None, q_ancillae=None, q_targets=None)">
  ...
  <Function id="qiskit.circuit.library.AND.mcry" name="mcry" signature="mcry(theta, q_controls, q_target, q_ancillae, mode=None, use_basis_gates=False)">
  ...
  <Function id="qiskit.circuit.library.AND.mirror" name="mirror" signature="mirror()">
  ...
  <Function id="qiskit.circuit.library.AND.qasm" name="qasm" signature="qasm(formatted=False, filename=None)">
  ...
  <Function id="qiskit.circuit.library.AND.to_instruction" name="to_instruction" signature="to_instruction(parameter_map=None)">
