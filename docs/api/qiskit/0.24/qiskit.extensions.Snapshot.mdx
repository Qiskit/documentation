...
<Class id="qiskit.extensions.Snapshot" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.16/qiskit/extensions/simulator/snapshot.py" signature="Snapshot(label, snapshot_type='statevector', num_qubits=0, num_clbits=0, params=None)">
  ...
  **ExtensionError** – if snapshot label is invalid.
  ...
  <Function id="qiskit.extensions.Snapshot.__init__" name="__init__" signature="__init__(label, snapshot_type='statevector', num_qubits=0, num_clbits=0, params=None)">
    Create new snapshot instruction.
  ...
  <Function id="qiskit.extensions.Snapshot.decompositions" name="decompositions" signature="property decompositions">
    Get the decompositions of the instruction from the SessionEquivalenceLibrary.
  </Function>

  ### definition

  <Function id="qiskit.extensions.Snapshot.definition" name="definition" signature="property definition">
    Return definition in terms of other basic gates.
  </Function>

  ### duration

  <Function id="qiskit.extensions.Snapshot.duration" name="duration" signature="property duration">
    Get the duration.
  </Function>
  ...
  <Function id="qiskit.extensions.Snapshot.label" name="label" signature="property label">
    Return snapshot label
  </Function>

  ### mirror

  <Function id="qiskit.extensions.Snapshot.mirror" name="mirror" signature="mirror()">
  ...
  <Function id="qiskit.extensions.Snapshot.params" name="params" signature="property params">
  ...
  <Function id="qiskit.extensions.Snapshot.snapshot_type" name="snapshot_type" signature="property snapshot_type">
    Return snapshot type
  </Function>

  ### unit

  <Function id="qiskit.extensions.Snapshot.unit" name="unit" signature="property unit">
