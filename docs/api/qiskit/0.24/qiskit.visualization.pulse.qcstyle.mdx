...
<Class id="qiskit.visualization.pulse.qcstyle.ComplexColors" signature="ComplexColors(real, imaginary)">
  Create new instance of ComplexColors(real, imaginary)

  ### count

  <Function id="qiskit.visualization.pulse.qcstyle.ComplexColors.count" name="count" signature="count(value, /)">
    Return number of occurrences of value.
  </Function>

  ### imaginary

  <Function id="qiskit.visualization.pulse.qcstyle.ComplexColors.imaginary" name="imaginary" signature="property imaginary">
    Alias for field number 1
  </Function>

  ### index

  <Function id="qiskit.visualization.pulse.qcstyle.ComplexColors.index" name="index" signature="index(value, start=0, stop=9223372036854775807, /)">
  ...
  <Function id="qiskit.visualization.pulse.qcstyle.ComplexColors.real" name="real" signature="property real">
    Alias for field number 0
  </Function>
</Class>

<Class id="qiskit.visualization.pulse.qcstyle.PulseStyle" github="https://github.com/qiskit/qiskit/tree/stable/0.16/qiskit/visualization/pulse/qcstyle.py" signature="PulseStyle(figsize=(7.0, 5.0), title_font_size=18, wave_color=('#ff0000', '#0000ff'), bg_color='#f2f3f4', num_points=1000, dpi=None)">
...
<Class id="qiskit.visualization.pulse.qcstyle.SchedTableColors" signature="SchedTableColors(time, channel, event)">
  Create new instance of SchedTableColors(time, channel, event)

  ### channel

  <Function id="qiskit.visualization.pulse.qcstyle.SchedTableColors.channel" name="channel" signature="property channel">
    Alias for field number 1
  </Function>

  ### count

  <Function id="qiskit.visualization.pulse.qcstyle.SchedTableColors.count" name="count" signature="count(value, /)">
    Return number of occurrences of value.
  </Function>

  ### event

  <Function id="qiskit.visualization.pulse.qcstyle.SchedTableColors.event" name="event" signature="property event">
    Alias for field number 2
  </Function>

  ### index

  <Function id="qiskit.visualization.pulse.qcstyle.SchedTableColors.index" name="index" signature="index(value, start=0, stop=9223372036854775807, /)">
    Return first index of value.
  ...
  <Function id="qiskit.visualization.pulse.qcstyle.SchedTableColors.time" name="time" signature="property time">
    Alias for field number 0
  </Function>
</Class>
