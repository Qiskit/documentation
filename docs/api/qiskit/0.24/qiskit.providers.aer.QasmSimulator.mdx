...
<Class id="qiskit.providers.aer.QasmSimulator" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-aer/tree/stable/0.7/qiskit/providers/aer/backends/qasm_simulator.py" signature="QasmSimulator(configuration=None, properties=None, provider=None, **backend_options)">
  ...
  **Raises**
  ...
  <Function id="qiskit.providers.aer.QasmSimulator.run" name="run" signature="run(qobj, backend_options=None, validate=False, **run_options)">
  ...
  <Function id="qiskit.providers.aer.QasmSimulator.set_options" name="set_options" signature="set_options(**backend_options)">
  ...
  <Function id="qiskit.providers.aer.QasmSimulator.version" name="version" signature="version()">
