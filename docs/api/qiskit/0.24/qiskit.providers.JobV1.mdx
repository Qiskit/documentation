...
<Class id="qiskit.providers.JobV1" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.16/qiskit/providers/job.py" signature="JobV1(backend, job_id, **kwargs)">
