...
<Class id="qiskit.providers.aer.extensions.SnapshotProbabilities" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-aer/tree/stable/0.7/qiskit/providers/aer/extensions/snapshot_probabilities.py" signature="SnapshotProbabilities(label, num_qubits, variance=False)" modifiers="class">
  ...
  **ExtensionError** – if snapshot is invalid.
  ...
  <Function id="qiskit.providers.aer.extensions.SnapshotProbabilities.decompositions" signature="decompositions" modifiers="property">
  ...
  <Function id="qiskit.providers.aer.extensions.SnapshotProbabilities.definition" signature="definition" modifiers="property">
    Return definition in terms of other basic gates.
  </Function>

  ### duration

  <Function id="qiskit.providers.aer.extensions.SnapshotProbabilities.duration" signature="duration" modifiers="property">
    Get the duration.
  </Function>
  ...
  <Function id="qiskit.providers.aer.extensions.SnapshotProbabilities.label" signature="label" modifiers="property">
  ...
  <Function id="qiskit.providers.aer.extensions.SnapshotProbabilities.params" signature="params" modifiers="property">
  ...
  <Function id="qiskit.providers.aer.extensions.SnapshotProbabilities.snapshot_type" signature="snapshot_type" modifiers="property">
    Return snapshot type
  </Function>

  ### unit

  <Function id="qiskit.providers.aer.extensions.SnapshotProbabilities.unit" signature="unit" modifiers="property">
