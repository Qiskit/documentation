...
<Class id="qiskit.providers.ibmq.managed.ManagedResults" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-ibmq-provider/tree/stable/0.12/qiskit/providers/ibmq/managed/managedresults.py" signature="ManagedResults(job_set, backend_name, success)">
  ...
  *   **success** (`bool`) – `True` if all experiments were successful and results available. `False` otherwise.
  ...
  <Attribute id="qiskit.providers.ibmq.managed.ManagedResults.backend_name" name="backend_name">
    Name of the backend used to run the experiments.
  </Attribute>

  ### success

  <Attribute id="qiskit.providers.ibmq.managed.ManagedResults.success" name="success">
    Whether all experiments were successful.
  </Attribute>

  ### \_\_init\_\_

  <Function id="qiskit.providers.ibmq.managed.ManagedResults.__init__" name="__init__" signature="__init__(job_set, backend_name, success)">
    ManagedResults constructor.
  ...
  <Function id="qiskit.providers.ibmq.managed.ManagedResults.combine_results" name="combine_results" signature="combine_results()">
  ...
  <Function id="qiskit.providers.ibmq.managed.ManagedResults.data" name="data" signature="data(experiment)">
  ...
  <Function id="qiskit.providers.ibmq.managed.ManagedResults.get_counts" name="get_counts" signature="get_counts(experiment)">
  ...
  <Function id="qiskit.providers.ibmq.managed.ManagedResults.get_memory" name="get_memory" signature="get_memory(experiment)">
  ...
  <Function id="qiskit.providers.ibmq.managed.ManagedResults.get_statevector" name="get_statevector" signature="get_statevector(experiment, decimals=None)">
  ...
  <Function id="qiskit.providers.ibmq.managed.ManagedResults.get_unitary" name="get_unitary" signature="get_unitary(experiment, decimals=None)">
