...
<Function id="qiskit.assembler.disassemble" name="disassemble" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.16/qiskit/assembler/disassemble.py" signature="disassemble(qobj)">
