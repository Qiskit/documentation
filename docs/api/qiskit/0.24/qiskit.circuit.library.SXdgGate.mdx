...
<Class id="qiskit.circuit.library.SXdgGate" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.16/qiskit/circuit/library/standard_gates/sx.py" signature="SXdgGate(label=None)" modifiers="class">
