...
<Class id="qiskit.chemistry.results.VibronicStructureResult" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.8/qiskit/chemistry/results/vibronic_structure_result.py" signature="VibronicStructureResult(a_dict=None)">
