...
<Class id="qiskit.transpiler.passes.TemplateOptimization" github="https://github.com/qiskit/qiskit/tree/stable/0.16/qiskit/transpiler/passes/optimization/template_optimization.py" signature="TemplateOptimization(*args, **kwargs)">
