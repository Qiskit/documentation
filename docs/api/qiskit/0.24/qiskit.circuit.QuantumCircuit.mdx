...
`QuantumCircuit(*regs, name=None, global_phase=0)` [GitHub](https://github.com/qiskit/qiskit/tree/stable/0.16/qiskit/circuit/quantumcircuit.py "view source code")
...
`__init__(*regs, name=None, global_phase=0)`
