...
<Function id="qiskit.visualization.plot_histogram" github="https://github.com/qiskit/qiskit/tree/stable/0.16/qiskit/visualization/counts_visualization.py" signature="plot_histogram(data, figsize=(7, 5), color=None, number_to_keep=None, sort='asc', target_string=None, legend=None, bar_labels=True, title=None, ax=None)">
