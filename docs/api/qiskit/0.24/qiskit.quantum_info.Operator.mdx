...
<Class id="qiskit.quantum_info.Operator" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.16/qiskit/quantum_info/operators/operator.py" signature="Operator(data, input_dims=None, output_dims=None)">
...
$$
  ...
  **Additional Information:**
  ...
  <Function id="qiskit.quantum_info.Operator.__init__" name="__init__" signature="__init__(data, input_dims=None, output_dims=None)">
    Initialize an operator object.
  ...
  <Function id="qiskit.quantum_info.Operator.add" name="add" signature="add(other)">
  ...
  <Function id="qiskit.quantum_info.Operator.adjoint" name="adjoint" signature="adjoint()">
    Return the adjoint of the operator.
  </Function>

  ### atol

  <Function id="qiskit.quantum_info.Operator.atol" name="atol" signature="property atol">
    The default absolute tolerance parameter for float comparisons.
  </Function>

  ### compose

  <Function id="qiskit.quantum_info.Operator.compose" name="compose" signature="compose(other, qargs=None, front=False)">
  ...
  <Function id="qiskit.quantum_info.Operator.conjugate" name="conjugate" signature="conjugate()">
    Return the conjugate of the operator.
  </Function>

  ### copy

  <Function id="qiskit.quantum_info.Operator.copy" name="copy" signature="copy()">
    Make a deep copy of current operator.
  </Function>

  ### data

  <Function id="qiskit.quantum_info.Operator.data" name="data" signature="property data">
    Return data.
  </Function>

  ### dim

  <Function id="qiskit.quantum_info.Operator.dim" name="dim" signature="property dim">
    Return tuple (input\_shape, output\_shape).
  </Function>

  ### dot

  <Function id="qiskit.quantum_info.Operator.dot" name="dot" signature="dot(other, qargs=None)">
  ...
  <Function id="qiskit.quantum_info.Operator.equiv" name="equiv" signature="equiv(other, rtol=None, atol=None)">
  ...
  <Function id="qiskit.quantum_info.Operator.expand" name="expand" signature="expand(other)">
  ...
  <Function id="qiskit.quantum_info.Operator.from_label" name="from_label" signature="classmethod from_label(label)">
  ...
  <Function id="qiskit.quantum_info.Operator.input_dims" name="input_dims" signature="input_dims(qargs=None)">
    Return tuple of input dimension for specified subsystems.
  </Function>

  ### is\_unitary

  <Function id="qiskit.quantum_info.Operator.is_unitary" name="is_unitary" signature="is_unitary(atol=None, rtol=None)">
    Return True if operator is a unitary matrix.
  </Function>

  ### multiply

  <Function id="qiskit.quantum_info.Operator.multiply" name="multiply" signature="multiply(other)">
  ...
  <Function id="qiskit.quantum_info.Operator.num_qubits" name="num_qubits" signature="property num_qubits">
    Return the number of qubits if a N-qubit operator or None otherwise.
  </Function>

  ### output\_dims

  <Function id="qiskit.quantum_info.Operator.output_dims" name="output_dims" signature="output_dims(qargs=None)">
    Return tuple of output dimension for specified subsystems.
  </Function>

  ### power

  <Function id="qiskit.quantum_info.Operator.power" name="power" signature="power(n)">
  ...
  <Function id="qiskit.quantum_info.Operator.qargs" name="qargs" signature="property qargs">
    Return the qargs for the operator.
  </Function>

  ### reshape

  <Function id="qiskit.quantum_info.Operator.reshape" name="reshape" signature="reshape(input_dims=None, output_dims=None)">
  ...
  <Function id="qiskit.quantum_info.Operator.rtol" name="rtol" signature="property rtol">
    The relative tolerance parameter for float comparisons.
  </Function>

  ### set\_atol

  <Function id="qiskit.quantum_info.Operator.set_atol" name="set_atol" signature="classmethod set_atol(value)">
  ...
  <Function id="qiskit.quantum_info.Operator.set_rtol" name="set_rtol" signature="classmethod set_rtol(value)">
  ...
  <Function id="qiskit.quantum_info.Operator.subtract" name="subtract" signature="subtract(other)">
    Return the linear operator self - other.
  ...
  <Function id="qiskit.quantum_info.Operator.tensor" name="tensor" signature="tensor(other)">
  ...
  <Function id="qiskit.quantum_info.Operator.to_instruction" name="to_instruction" signature="to_instruction()">
    Convert to a UnitaryGate instruction.
  </Function>

  ### to\_operator

  <Function id="qiskit.quantum_info.Operator.to_operator" name="to_operator" signature="to_operator()">
    Convert operator to matrix operator class
  </Function>

  ### transpose

  <Function id="qiskit.quantum_info.Operator.transpose" name="transpose" signature="transpose()">
