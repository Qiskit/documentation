...
<Class id="qiskit.aqua.components.uncertainty_models.LogNormalDistribution" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.8/qiskit/aqua/components/uncertainty_models/log_normal_distribution.py" signature="LogNormalDistribution(num_target_qubits, mu=0, sigma=1, low=0, high=1)">
  ...
  *   **high** (`float`) – Upper bound, i.e., the value corresponding to |1…1> (assuming an equidistant grid)
  ...
  <Function id="qiskit.aqua.components.uncertainty_models.LogNormalDistribution.high" signature="property high">
    returns high
  </Function>

  ### low

  <Function id="qiskit.aqua.components.uncertainty_models.LogNormalDistribution.low" signature="property low">
    returns low
  </Function>

  ### num\_target\_qubits

  <Function id="qiskit.aqua.components.uncertainty_models.LogNormalDistribution.num_target_qubits" signature="property num_target_qubits">
    Returns the number of target qubits
  </Function>

  ### num\_values

  <Function id="qiskit.aqua.components.uncertainty_models.LogNormalDistribution.num_values" signature="property num_values">
    returns number of values
  </Function>

  ### pdf\_to\_probabilities

  <Function id="qiskit.aqua.components.uncertainty_models.LogNormalDistribution.pdf_to_probabilities" signature="static pdf_to_probabilities(pdf, low, high, num_values)">
  ...
  <Function id="qiskit.aqua.components.uncertainty_models.LogNormalDistribution.probabilities" signature="property probabilities">
  ...
  <Function id="qiskit.aqua.components.uncertainty_models.LogNormalDistribution.values" signature="property values">
    returns values
  </Function>
</Class>
