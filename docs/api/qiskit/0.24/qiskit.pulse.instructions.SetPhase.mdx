...
$$
  ...
  *   **name** (`Optional`\[`str`]) – Display name for this instruction.
  ...
  <Function id="qiskit.pulse.instructions.SetPhase.command" signature="command" modifiers="property">
  ...
  <Function id="qiskit.pulse.instructions.SetPhase.timeslots" signature="timeslots" modifiers="property">
