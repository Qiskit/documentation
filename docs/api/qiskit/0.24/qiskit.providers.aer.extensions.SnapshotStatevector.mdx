...
<Class id="qiskit.providers.aer.extensions.SnapshotStatevector" github="https://github.com/qiskit/qiskit-aer/tree/stable/0.7/qiskit/providers/aer/extensions/snapshot_statevector.py" signature="SnapshotStatevector(label, num_qubits=0)">
