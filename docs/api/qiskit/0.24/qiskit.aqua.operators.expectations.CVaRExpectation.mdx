...
<Class id="qiskit.aqua.operators.expectations.CVaRExpectation" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.8/qiskit/aqua/operators/expectations/cvar_expectation.py" signature="CVaRExpectation(alpha, expectation=None)">
  ...
  **NotImplementedError** – If the `expectation` is an AerPauliExpecation.
  ...
  <Function id="qiskit.aqua.operators.expectations.CVaRExpectation.__init__" name="__init__" signature="__init__(alpha, expectation=None)">
    **Parameters**
  ...
  <Function id="qiskit.aqua.operators.expectations.CVaRExpectation.compute_variance" name="compute_variance" signature="compute_variance(exp_op)">
    Not implemented.
  ...
  <Function id="qiskit.aqua.operators.expectations.CVaRExpectation.convert" name="convert" signature="convert(operator)">
