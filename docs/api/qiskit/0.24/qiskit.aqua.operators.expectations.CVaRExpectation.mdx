---
title: CVaRExpectation (v0.24)
description: API reference for qiskit.aqua.operators.expectations.CVaRExpectation in qiskit v0.24
...
<Class id="qiskit.aqua.operators.expectations.CVaRExpectation" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.8/qiskit/aqua/operators/expectations/cvar_expectation.py" signature="CVaRExpectation(alpha, expectation=None)" modifiers="class">
