...
`circuit_to_dagdependency(circuit)` [GitHub](https://github.com/qiskit/qiskit/tree/stable/0.16/qiskit/converters/circuit_to_dagdependency.py "view source code")
