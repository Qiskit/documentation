...
<Class id="qiskit.ignis.verification.Plotter" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-ignis/tree/stable/0.5/qiskit/ignis/verification/entanglement/analysis.py" signature="Plotter(label)">
  Various plots of the ground state in MQC and PO experiments

  ### \_\_init\_\_

  <Function id="qiskit.ignis.verification.Plotter.__init__" name="__init__" signature="__init__(label)">
  ...
  <Function id="qiskit.ignis.verification.Plotter.get_fourier_info" name="get_fourier_info" signature="get_fourier_info(qn, x, y, y_m, p_dict)">
  ...
  <Function id="qiskit.ignis.verification.Plotter.sin_plotter" name="sin_plotter" signature="sin_plotter(x, y, y_m=None)">
  ...
  <Function id="qiskit.ignis.verification.Plotter.title_maker" name="title_maker" signature="title_maker()">
