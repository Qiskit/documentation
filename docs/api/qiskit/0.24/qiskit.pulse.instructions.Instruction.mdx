...
<Class id="qiskit.pulse.instructions.Instruction" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.16/qiskit/pulse/instructions/instruction.py" signature="Instruction(operands, duration, channels, name=None)">
  ...
  *   [**PulseError**](qiskit.pulse.PulseError "qiskit.pulse.PulseError") – If the input `channels` are not all of type `Channel`.
  ...
  <Function id="qiskit.pulse.instructions.Instruction.channels" signature="property channels">
  ...
  <Function id="qiskit.pulse.instructions.Instruction.command" signature="property command">
  ...
  <Function id="qiskit.pulse.instructions.Instruction.timeslots" signature="property timeslots">
