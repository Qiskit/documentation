---
title: active_backend (v0.24)
description: API reference for qiskit.pulse.builder.active_backend in qiskit v0.24
...
<Function id="qiskit.pulse.builder.active_backend" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.16/qiskit/pulse/builder.py" signature="active_backend()">
