...
<Class id="qiskit.aqua.operators.expectations.AerPauliExpectation" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.8/qiskit/aqua/operators/expectations/aer_pauli_expectation.py" signature="AerPauliExpectation">
  ...
  <Function id="qiskit.aqua.operators.expectations.AerPauliExpectation.__init__" name="__init__" signature="__init__()">
  ...
  <Function id="qiskit.aqua.operators.expectations.AerPauliExpectation.compute_variance" name="compute_variance" signature="compute_variance(exp_op)">
  ...
  <Function id="qiskit.aqua.operators.expectations.AerPauliExpectation.convert" name="convert" signature="convert(operator)">
