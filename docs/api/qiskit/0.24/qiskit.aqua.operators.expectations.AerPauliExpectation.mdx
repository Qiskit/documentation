---
title: AerPauliExpectation (v0.24)
description: API reference for qiskit.aqua.operators.expectations.AerPauliExpectation in qiskit v0.24
...
<Class id="qiskit.aqua.operators.expectations.AerPauliExpectation" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.8/qiskit/aqua/operators/expectations/aer_pauli_expectation.py" signature="AerPauliExpectation" modifiers="class">
