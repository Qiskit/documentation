...
<Class id="qiskit.aqua.algorithms.QSVM" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.8/qiskit/aqua/algorithms/classifiers/qsvm/qsvm.py" signature="QSVM(feature_map, training_dataset=None, test_dataset=None, datapoints=None, multiclass_extension=None, lambda2=0.001, quantum_instance=None)">
  ...
  **Raises**
  ...
  <Function id="qiskit.aqua.algorithms.QSVM.backend" signature="property backend">
    Returns backend.
  ...
  <Function id="qiskit.aqua.algorithms.QSVM.get_kernel_matrix" signature="static get_kernel_matrix(quantum_instance, feature_map, x1_vec, x2_vec=None, enforce_psd=True)">
    Construct kernel matrix, if x2\_vec is None, self-innerproduct is conducted.
  ...
  <Function id="qiskit.aqua.algorithms.QSVM.quantum_instance" signature="property quantum_instance">
  ...
  <Function id="qiskit.aqua.algorithms.QSVM.random" signature="property random">
    Return a numpy random.
  </Function>

  ### ret

  <Function id="qiskit.aqua.algorithms.QSVM.ret" signature="property ret">
    returns result
  </Function>
