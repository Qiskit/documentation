---
title: pauli_error (v0.24)
description: API reference for qiskit.providers.aer.noise.pauli_error in qiskit v0.24
...
<Function id="qiskit.providers.aer.noise.pauli_error" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-aer/tree/stable/0.7/qiskit/providers/aer/noise/errors/standard_errors.py" signature="pauli_error(noise_ops, standard_gates=True)">
