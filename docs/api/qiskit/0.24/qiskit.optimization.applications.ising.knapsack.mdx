...
<Function id="qiskit.optimization.applications.ising.knapsack.get_operator" name="get_operator" github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.8/qiskit/optimization/applications/ising/knapsack.py" signature="get_operator(values, weights, max_weight)">
...
<Function id="qiskit.optimization.applications.ising.knapsack.get_solution" name="get_solution" github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.8/qiskit/optimization/applications/ising/knapsack.py" signature="get_solution(x, values)">
...
<Function id="qiskit.optimization.applications.ising.knapsack.knapsack_value_weight" name="knapsack_value_weight" github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.8/qiskit/optimization/applications/ising/knapsack.py" signature="knapsack_value_weight(solution, values, weights)">
