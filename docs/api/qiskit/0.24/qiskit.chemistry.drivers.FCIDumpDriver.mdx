...
<Class id="qiskit.chemistry.drivers.FCIDumpDriver" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.8/qiskit/chemistry/drivers/fcidumpd/fcidumpdriver.py" signature="FCIDumpDriver(fcidump_input, atoms=None)" modifiers="class">
  ...
  **Raises**
  ...
  <Function id="qiskit.chemistry.drivers.FCIDumpDriver.basis" signature="basis" modifiers="property">
    return basis
  ...
  <Function id="qiskit.chemistry.drivers.FCIDumpDriver.hf_method" signature="hf_method" modifiers="property">
  ...
  <Function id="qiskit.chemistry.drivers.FCIDumpDriver.molecule" signature="molecule" modifiers="property">
    return molecule
  ...
  <Function id="qiskit.chemistry.drivers.FCIDumpDriver.supports_molecule" signature="supports_molecule" modifiers="property">
