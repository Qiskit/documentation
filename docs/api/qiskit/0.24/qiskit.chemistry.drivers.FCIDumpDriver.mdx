...
<Class id="qiskit.chemistry.drivers.FCIDumpDriver" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.8/qiskit/chemistry/drivers/fcidumpd/fcidumpdriver.py" signature="FCIDumpDriver(fcidump_input, atoms=None)">
  ...
  **Raises**
  ...
  <Function id="qiskit.chemistry.drivers.FCIDumpDriver.basis" signature="property basis">
    return basis
  ...
  <Function id="qiskit.chemistry.drivers.FCIDumpDriver.dump" signature="static dump(q_mol, outpath, orbsym=None, isym=1)">
  ...
  <Function id="qiskit.chemistry.drivers.FCIDumpDriver.hf_method" signature="property hf_method">
  ...
  <Function id="qiskit.chemistry.drivers.FCIDumpDriver.molecule" signature="property molecule">
    return molecule
  ...
  <Function id="qiskit.chemistry.drivers.FCIDumpDriver.supports_molecule" signature="property supports_molecule">
