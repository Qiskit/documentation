...
<Class id="qiskit.optimization.converters.InequalityToEquality" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.8/qiskit/optimization/converters/inequality_to_equality.py" signature="InequalityToEquality(mode='auto')">
  ...
  *   **’auto’: Try to use integer variables but if it’s not possible,**
  ...
  <Function id="qiskit.optimization.converters.InequalityToEquality.decode" name="decode" signature="decode(result)">
  ...
  <Function id="qiskit.optimization.converters.InequalityToEquality.encode" name="encode" signature="encode(problem)">
  ...
  <Function id="qiskit.optimization.converters.InequalityToEquality.interpret" name="interpret" signature="interpret(result)">
