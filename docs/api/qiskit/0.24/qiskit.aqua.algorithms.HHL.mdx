...
$$
  ...
  **ValueError** – Invalid input
  ...
  <Function id="qiskit.aqua.algorithms.HHL.backend" signature="property backend">
    Returns backend.
  ...
  <Function id="qiskit.aqua.algorithms.HHL.expand_to_hermitian" signature="static expand_to_hermitian(matrix, vector)">
  ...
  <Function id="qiskit.aqua.algorithms.HHL.expand_to_powerdim" signature="static expand_to_powerdim(matrix, vector)">
  ...
  <Function id="qiskit.aqua.algorithms.HHL.matrix_resize" signature="static matrix_resize(matrix, vector)">
  ...
  <Function id="qiskit.aqua.algorithms.HHL.quantum_instance" signature="property quantum_instance">
  ...
  <Function id="qiskit.aqua.algorithms.HHL.random" signature="property random">
