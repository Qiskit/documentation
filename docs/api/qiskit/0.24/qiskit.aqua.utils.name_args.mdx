...
<Function id="qiskit.aqua.utils.name_args" name="name_args" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.8/qiskit/aqua/utils/name_unnamed_args.py" signature="name_args(mapping, skip=0)">
