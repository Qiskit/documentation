...
<Class id="qiskit.ignis.verification.RBFitter" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-ignis/tree/stable/0.5/qiskit/ignis/verification/randomized_benchmarking/fitters.py" signature="RBFitter(backend_result, cliff_lengths, rb_pattern=None)">
  ...
  *   **rb\_pattern** (*list*) – the pattern for the RB sequences.
  ...
  <Function id="qiskit.ignis.verification.RBFitter.__init__" name="__init__" signature="__init__(backend_result, cliff_lengths, rb_pattern=None)">
    **Parameters**
  ...
  <Function id="qiskit.ignis.verification.RBFitter.add_data" name="add_data" signature="add_data(new_backend_result, rerun_fit=True)">
  ...
  <Function id="qiskit.ignis.verification.RBFitter.calc_data" name="calc_data" signature="calc_data()">
  ...
  <Function id="qiskit.ignis.verification.RBFitter.calc_statistics" name="calc_statistics" signature="calc_statistics()">
  ...
  <Function id="qiskit.ignis.verification.RBFitter.cliff_lengths" name="cliff_lengths" signature="property cliff_lengths">
    Return clifford lengths.
  </Function>

  ### fit

  <Function id="qiskit.ignis.verification.RBFitter.fit" name="fit" signature="property fit">
    Return fit.
  </Function>

  ### fit\_data

  <Function id="qiskit.ignis.verification.RBFitter.fit_data" name="fit_data" signature="fit_data()">
  ...
  <Function id="qiskit.ignis.verification.RBFitter.fit_data_pattern" name="fit_data_pattern" signature="fit_data_pattern(patt_ind, fit_guess)">
  ...
  <Function id="qiskit.ignis.verification.RBFitter.plot_rb_data" name="plot_rb_data" signature="plot_rb_data(pattern_index=0, ax=None, add_label=True, show_plt=True)">
  ...
  <Function id="qiskit.ignis.verification.RBFitter.raw_data" name="raw_data" signature="property raw_data">
    Return raw data.
  </Function>

  ### rb\_fit\_fun

  <Function id="qiskit.ignis.verification.RBFitter.rb_fit_fun" name="rb_fit_fun" signature="property rb_fit_fun">
    Return the fit function rb\_fit\_fun.
  </Function>

  ### results

  <Function id="qiskit.ignis.verification.RBFitter.results" name="results" signature="property results">
    Return all the results.
  </Function>

  ### seeds

  <Function id="qiskit.ignis.verification.RBFitter.seeds" name="seeds" signature="property seeds">
    Return the number of loaded seeds.
  </Function>

  ### ydata

  <Function id="qiskit.ignis.verification.RBFitter.ydata" name="ydata" signature="property ydata">
