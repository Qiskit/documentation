...
<Class id="qiskit.ignis.verification.RBFitter" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-ignis/tree/stable/0.5/qiskit/ignis/verification/randomized_benchmarking/fitters.py" signature="RBFitter(backend_result, cliff_lengths, rb_pattern=None)">
  ...
  *   **rb\_pattern** (*list*) – the pattern for the RB sequences.
  ...
  <Function id="qiskit.ignis.verification.RBFitter.cliff_lengths" signature="property cliff_lengths">
    Return clifford lengths.
  </Function>

  ### fit

  <Function id="qiskit.ignis.verification.RBFitter.fit" signature="property fit">
    Return fit.
  </Function>
  ...
  <Function id="qiskit.ignis.verification.RBFitter.raw_data" signature="property raw_data">
    Return raw data.
  </Function>

  ### rb\_fit\_fun

  <Function id="qiskit.ignis.verification.RBFitter.rb_fit_fun" signature="property rb_fit_fun">
    Return the fit function rb\_fit\_fun.
  </Function>

  ### results

  <Function id="qiskit.ignis.verification.RBFitter.results" signature="property results">
    Return all the results.
  </Function>

  ### seeds

  <Function id="qiskit.ignis.verification.RBFitter.seeds" signature="property seeds">
    Return the number of loaded seeds.
  </Function>

  ### ydata

  <Function id="qiskit.ignis.verification.RBFitter.ydata" signature="property ydata">
