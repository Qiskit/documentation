---
title: VarFormBased (v0.24)
description: API reference for qiskit.aqua.components.initial_states.VarFormBased in qiskit v0.24
...
<Class id="qiskit.aqua.components.initial_states.VarFormBased" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.8/qiskit/aqua/components/initial_states/var_form_based.py" signature="VarFormBased(var_form, params)" modifiers="class">
  ...
  **ValueError** – Invalid input
  ...
  <Function id="qiskit.aqua.components.initial_states.VarFormBased.__init__" signature="__init__(var_form, params)">
    **Parameters**
  ...
  <Function id="qiskit.aqua.components.initial_states.VarFormBased.construct_circuit" signature="construct_circuit(mode='circuit', register=None)">
