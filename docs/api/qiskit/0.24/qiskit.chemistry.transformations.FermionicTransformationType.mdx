...
<Class id="qiskit.chemistry.transformations.FermionicTransformationType" github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.8/qiskit/chemistry/transformations/fermionic_transformation.py" signature="FermionicTransformationType(value)">
