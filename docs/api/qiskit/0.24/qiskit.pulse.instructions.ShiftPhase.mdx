...
<Class id="qiskit.pulse.instructions.ShiftPhase" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.16/qiskit/pulse/instructions/phase.py" signature="ShiftPhase(phase, channel, name=None)">
...
$$
  ...
  *   **name** (`Optional`\[`str`]) – Display name for this instruction.
  ...
  <Function id="qiskit.pulse.instructions.ShiftPhase.channel" signature="property channel">
  ...
  <Function id="qiskit.pulse.instructions.ShiftPhase.channels" signature="property channels">
  ...
  <Function id="qiskit.pulse.instructions.ShiftPhase.command" signature="property command">
  ...
  <Function id="qiskit.pulse.instructions.ShiftPhase.duration" signature="property duration">
  ...
  <Function id="qiskit.pulse.instructions.ShiftPhase.id" signature="property id">
  ...
  <Function id="qiskit.pulse.instructions.ShiftPhase.instructions" signature="property instructions">
  ...
  <Function id="qiskit.pulse.instructions.ShiftPhase.name" signature="property name">
  ...
  <Function id="qiskit.pulse.instructions.ShiftPhase.operands" signature="property operands">
  ...
  <Function id="qiskit.pulse.instructions.ShiftPhase.phase" signature="property phase">
  ...
  <Function id="qiskit.pulse.instructions.ShiftPhase.start_time" signature="property start_time">
  ...
  <Function id="qiskit.pulse.instructions.ShiftPhase.stop_time" signature="property stop_time">
  ...
  <Function id="qiskit.pulse.instructions.ShiftPhase.timeslots" signature="property timeslots">
