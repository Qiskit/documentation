---
title: diamond_norm (v0.24)
description: API reference for qiskit.quantum_info.diamond_norm in qiskit v0.24
...
<Function id="qiskit.quantum_info.diamond_norm" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.16/qiskit/quantum_info/operators/measures.py" signature="diamond_norm(choi, **kwargs)">
