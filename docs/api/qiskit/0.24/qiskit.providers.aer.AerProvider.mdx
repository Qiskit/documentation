...
<Class id="qiskit.providers.aer.AerProvider" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-aer/tree/stable/0.7/qiskit/providers/aer/aerprovider.py" signature="AerProvider(*args, **kwargs)">
  Provider for Qiskit Aer backends.

  ### \_\_init\_\_

  <Function id="qiskit.providers.aer.AerProvider.__init__" name="__init__" signature="__init__(*args, **kwargs)">
  ...
  <Function id="qiskit.providers.aer.AerProvider.backends" name="backends" signature="backends(name=None, filters=None, **kwargs)">
  ...
  <Function id="qiskit.providers.aer.AerProvider.get_backend" name="get_backend" signature="get_backend(name=None, **kwargs)">
