...
<Class id="qiskit.ignis.verification.ProcessTomographyFitter" github="https://github.com/qiskit-community/qiskit-ignis/tree/stable/0.5/qiskit/ignis/verification/tomography/fitters/process_fitter.py" signature="ProcessTomographyFitter(result, circuits, meas_basis='Pauli', prep_basis='Pauli')">
