...
<Class id="qiskit.pulse.instructions.ShiftFrequency" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.16/qiskit/pulse/instructions/frequency.py" signature="ShiftFrequency(frequency, channel, name=None)">
  ...
  *   **name** (`Optional`\[`str`]) – Name of this set channel frequency instruction.
  ...
  <Function id="qiskit.pulse.instructions.ShiftFrequency.command" signature="property command">
  ...
  <Function id="qiskit.pulse.instructions.ShiftFrequency.timeslots" signature="property timeslots">
