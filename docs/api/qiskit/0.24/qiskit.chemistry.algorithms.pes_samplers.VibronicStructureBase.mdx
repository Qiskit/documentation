...
<Class id="qiskit.chemistry.algorithms.pes_samplers.VibronicStructureBase" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.8/qiskit/chemistry/algorithms/pes_samplers/potentials/potential_base.py" signature="VibronicStructureBase(molecule)">
  Class to hold a molecular vibronic structure providing access to vibrational modes and energy levels.

  ### \_\_init\_\_

  <Function id="qiskit.chemistry.algorithms.pes_samplers.VibronicStructureBase.__init__" name="__init__" signature="__init__(molecule)">
  ...
  <Function id="qiskit.chemistry.algorithms.pes_samplers.VibronicStructureBase.get_maximum_trusted_level" name="get_maximum_trusted_level" signature="get_maximum_trusted_level(n=0)">
  ...
  <Function id="qiskit.chemistry.algorithms.pes_samplers.VibronicStructureBase.get_num_modes" name="get_num_modes" signature="abstract get_num_modes()">
  ...
  <Function id="qiskit.chemistry.algorithms.pes_samplers.VibronicStructureBase.update_molecule" name="update_molecule" signature="update_molecule(molecule)">
  ...
  <Function id="qiskit.chemistry.algorithms.pes_samplers.VibronicStructureBase.vibrational_energy_level" name="vibrational_energy_level" signature="abstract vibrational_energy_level(n)">
