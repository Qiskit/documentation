---
title: VibronicStructureBase (v0.24)
description: API reference for qiskit.chemistry.algorithms.pes_samplers.VibronicStructureBase in qiskit v0.24
...
<Class id="qiskit.chemistry.algorithms.pes_samplers.VibronicStructureBase" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.8/qiskit/chemistry/algorithms/pes_samplers/potentials/potential_base.py" signature="VibronicStructureBase(molecule)" modifiers="class">
