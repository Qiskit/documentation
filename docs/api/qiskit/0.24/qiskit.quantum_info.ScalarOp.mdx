...
<Class id="qiskit.quantum_info.ScalarOp" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.16/qiskit/quantum_info/operators/scalar_op.py" signature="ScalarOp(dims, coeff=1)">
  ...
  **QiskitError** – If the optional coefficient is invalid.
  ...
  <Function id="qiskit.quantum_info.ScalarOp.__init__" name="__init__" signature="__init__(dims, coeff=1)">
    Initialize an operator object.
  ...
  <Function id="qiskit.quantum_info.ScalarOp.add" name="add" signature="add(other)">
  ...
  <Function id="qiskit.quantum_info.ScalarOp.multiply" name="multiply" signature="multiply(other)">
  ...
  <Function id="qiskit.quantum_info.ScalarOp.reshape" name="reshape" signature="reshape(input_dims=None, output_dims=None)">
  ...
  <Function id="qiskit.quantum_info.ScalarOp.set_atol" name="set_atol" signature="classmethod set_atol(value)">
  ...
  <Function id="qiskit.quantum_info.ScalarOp.set_rtol" name="set_rtol" signature="classmethod set_rtol(value)">
  ...
  <Function id="qiskit.quantum_info.ScalarOp.subtract" name="subtract" signature="subtract(other)">
    Return the linear operator self - other.
