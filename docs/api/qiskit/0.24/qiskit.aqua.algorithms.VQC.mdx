...
<Class id="qiskit.aqua.algorithms.VQC" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.8/qiskit/aqua/algorithms/classifiers/vqc.py" signature="VQC(optimizer, feature_map, var_form, training_dataset, test_dataset=None, datapoints=None, max_evals_grouped=1, minibatch_size=- 1, callback=None, quantum_instance=None)" modifiers="class">
  ...
  **Raises**
  ...
  <Function id="qiskit.aqua.algorithms.VQC.__init__" signature="__init__(optimizer, feature_map, var_form, training_dataset, test_dataset=None, datapoints=None, max_evals_grouped=1, minibatch_size=- 1, callback=None, quantum_instance=None)">
    **Parameters**
  ...
  <Function id="qiskit.aqua.algorithms.VQC.backend" signature="backend" modifiers="property">
    Returns backend.
  ...
  <Function id="qiskit.aqua.algorithms.VQC.class_to_label" signature="class_to_label" modifiers="property">
  ...
  <Function id="qiskit.aqua.algorithms.VQC.datapoints" signature="datapoints" modifiers="property">
    return data points
  </Function>

  ### feature\_map

  <Function id="qiskit.aqua.algorithms.VQC.feature_map" signature="feature_map" modifiers="property">
  ...
  <Function id="qiskit.aqua.algorithms.VQC.initial_point" signature="initial_point" modifiers="property">
  ...
  <Function id="qiskit.aqua.algorithms.VQC.label_to_class" signature="label_to_class" modifiers="property">
  ...
  <Function id="qiskit.aqua.algorithms.VQC.optimal_params" signature="optimal_params" modifiers="property">
    returns optimal parameters
  </Function>

  ### optimizer

  <Function id="qiskit.aqua.algorithms.VQC.optimizer" signature="optimizer" modifiers="property">
    Returns optimizer
  ...
  <Function id="qiskit.aqua.algorithms.VQC.quantum_instance" signature="quantum_instance" modifiers="property">
  ...
  <Function id="qiskit.aqua.algorithms.VQC.random" signature="random" modifiers="property">
    Return a numpy random.
  </Function>

  ### ret

  <Function id="qiskit.aqua.algorithms.VQC.ret" signature="ret" modifiers="property">
    returns result
  </Function>
  ...
  <Function id="qiskit.aqua.algorithms.VQC.test_dataset" signature="test_dataset" modifiers="property">
  ...
  <Function id="qiskit.aqua.algorithms.VQC.training_dataset" signature="training_dataset" modifiers="property">
    returns training dataset
  </Function>

  ### var\_form

  <Function id="qiskit.aqua.algorithms.VQC.var_form" signature="var_form" modifiers="property">
