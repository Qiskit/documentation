...
<Class id="qiskit.aqua.components.reciprocals.Reciprocal" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.8/qiskit/aqua/components/reciprocals/reciprocal.py" signature="Reciprocal">
  ...
  <Function id="qiskit.aqua.components.reciprocals.Reciprocal.__init__" signature="abstract __init__()">
  ...
  <Function id="qiskit.aqua.components.reciprocals.Reciprocal.construct_circuit" signature="abstract construct_circuit(mode, register=None, circuit=None)">
  ...
  <Function id="qiskit.aqua.components.reciprocals.Reciprocal.sv_to_resvec" signature="abstract sv_to_resvec(statevector, num_q)">
