...
<Class id="qiskit.chemistry.components.initial_states.HartreeFock" github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.8/qiskit/chemistry/components/initial_states/hartree_fock.py" signature="HartreeFock(num_orbitals, num_particles, qubit_mapping='parity', two_qubit_reduction=True, sq_list=None)">
  ...
  *   **ValueError** – wrong setting for computed num\_qubits and supplied num\_qubits.
  ...
  <Function id="qiskit.chemistry.components.initial_states.HartreeFock.__init__" name="__init__" signature="__init__(num_orbitals, num_particles, qubit_mapping='parity', two_qubit_reduction=True, sq_list=None)">
    **Parameters**
  ...
  <Function id="qiskit.chemistry.components.initial_states.HartreeFock.bitstr" name="bitstr" signature="property bitstr">
    Getter of the bit string represented the statevector.
  </Function>

  ### construct\_circuit

  <Function id="qiskit.chemistry.components.initial_states.HartreeFock.construct_circuit" name="construct_circuit" signature="construct_circuit(mode='circuit', register=None)">
