...
<Function id="qiskit.quantum_info.entropy" github="https://github.com/qiskit/qiskit/tree/stable/0.16/qiskit/quantum_info/states/measures.py" signature="entropy(state, base=2)">
