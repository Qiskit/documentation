...
<Function id="qiskit.transpiler.preset_passmanagers.level_1_pass_manager" github="https://github.com/qiskit/qiskit/tree/stable/0.16/qiskit/transpiler/preset_passmanagers/level1.py" signature="level_1_pass_manager(pass_manager_config)">
