---
title: portfolio_diversification (v0.24)
description: API reference for qiskit.finance.applications.ising.portfolio_diversification in qiskit v0.24
...
<Function id="qiskit.finance.applications.ising.portfolio_diversification.get_operator" github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.8/qiskit/finance/applications/ising/portfolio_diversification.py" signature="get_operator(rho, n, q)">
...
<Function id="qiskit.finance.applications.ising.portfolio_diversification.get_portfoliodiversification_value" github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.8/qiskit/finance/applications/ising/portfolio_diversification.py" signature="get_portfoliodiversification_value(rho, n, q, x_state)">
