...
<Class id="qiskit.aqua.circuits.DNF" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.8/qiskit/aqua/circuits/boolean_logical_circuits.py" signature="DNF(ast, num_vars=None)">
  ...
  **Raises**
  ...
  <Function id="qiskit.aqua.circuits.DNF.ancillary_register" signature="property ancillary_register">
    returns ancillary register
  </Function>

  ### clause\_register

  <Function id="qiskit.aqua.circuits.DNF.clause_register" signature="property clause_register">
  ...
  <Function id="qiskit.aqua.circuits.DNF.num_clauses" signature="property num_clauses">
    returns num clauses
  </Function>

  ### num\_variables

  <Function id="qiskit.aqua.circuits.DNF.num_variables" signature="property num_variables">
    return num variables
  </Function>

  ### output\_register

  <Function id="qiskit.aqua.circuits.DNF.output_register" signature="property output_register">
    returns output register
  </Function>

  ### variable\_register

  <Function id="qiskit.aqua.circuits.DNF.variable_register" signature="property variable_register">
