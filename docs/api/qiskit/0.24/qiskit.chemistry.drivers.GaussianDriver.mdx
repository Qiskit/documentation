...
<Class id="qiskit.chemistry.drivers.GaussianDriver" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.8/qiskit/chemistry/drivers/gaussiand/gaussiandriver.py" signature="GaussianDriver(config='# rhf/sto-3g scf(conventional)\\n\\nh2 molecule\\n\\n0 1\\nH 0.0 0.0 0.0\\nH 0.0 0.0 0.735\\n\\n', molecule=None, basis='sto-3g', hf_method=<HFMethodType.RHF: 'rhf'>)" modifiers="class">
  ...
  **Raises**
  ...
  <Function id="qiskit.chemistry.drivers.GaussianDriver.basis" signature="basis" modifiers="property">
    return basis
  ...
  <Function id="qiskit.chemistry.drivers.GaussianDriver.hf_method" signature="hf_method" modifiers="property">
  ...
  <Function id="qiskit.chemistry.drivers.GaussianDriver.molecule" signature="molecule" modifiers="property">
    return molecule
  ...
  <Function id="qiskit.chemistry.drivers.GaussianDriver.supports_molecule" signature="supports_molecule" modifiers="property">
