...
<Class id="qiskit.ignis.characterization.AmpCalFitter" github="https://github.com/qiskit-community/qiskit-ignis/tree/stable/0.5/qiskit/ignis/characterization/gates/fitters.py" signature="AmpCalFitter(backend_result, xdata, qubits, fit_p0, fit_bounds)">
