...
<Class id="qiskit.quantum_info.Pauli" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.16/qiskit/quantum_info/operators/pauli.py" signature="Pauli(z=None, x=None, label=None)">
  ...
  *   **label** (*str*) – pauli label
  ...
  <Function id="qiskit.quantum_info.Pauli.__init__" name="__init__" signature="__init__(z=None, x=None, label=None)">
    Make the Pauli object.
  ...
  <Function id="qiskit.quantum_info.Pauli.from_label" name="from_label" signature="classmethod from_label(label)">
  ...
  <Function id="qiskit.quantum_info.Pauli.sgn_prod" name="sgn_prod" signature="static sgn_prod(p1, p2)">
  ...
  <Function id="qiskit.quantum_info.Pauli.to_matrix" name="to_matrix" signature="to_matrix()">
  ...
  <Function id="qiskit.quantum_info.Pauli.to_operator" name="to_operator" signature="to_operator()">
