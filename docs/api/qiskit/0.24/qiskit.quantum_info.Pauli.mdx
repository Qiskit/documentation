...
<Class id="qiskit.quantum_info.Pauli" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.16/qiskit/quantum_info/operators/pauli.py" signature="Pauli(z=None, x=None, label=None)" modifiers="class">
  ...
  *   **label** (*str*) – pauli label
  ...
  <Function id="qiskit.quantum_info.Pauli.num_qubits" signature="num_qubits" modifiers="property">
    Number of qubits.
  </Function>
  ...
  <Function id="qiskit.quantum_info.Pauli.x" signature="x" modifiers="property">
    Getter of x.
  </Function>

  ### z

  <Function id="qiskit.quantum_info.Pauli.z" signature="z" modifiers="property">
    Getter of z.
  </Function>
</Class>
