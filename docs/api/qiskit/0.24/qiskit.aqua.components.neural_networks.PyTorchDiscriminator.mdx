...
<Class id="qiskit.aqua.components.neural_networks.PyTorchDiscriminator" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.8/qiskit/aqua/components/neural_networks/pytorch_discriminator.py" signature="PyTorchDiscriminator(n_features=1, n_out=1)">
  ...
  **Raises**
  ...
  <Function id="qiskit.aqua.components.neural_networks.PyTorchDiscriminator.__init__" name="__init__" signature="__init__(n_features=1, n_out=1)">
    **Parameters**
  ...
  <Function id="qiskit.aqua.components.neural_networks.PyTorchDiscriminator.discriminator_net" name="discriminator_net" signature="property discriminator_net">
    Get discriminator
  ...
  <Function id="qiskit.aqua.components.neural_networks.PyTorchDiscriminator.get_label" name="get_label" signature="get_label(x, detach=False)">
  ...
  <Function id="qiskit.aqua.components.neural_networks.PyTorchDiscriminator.gradient_penalty" name="gradient_penalty" signature="gradient_penalty(x, lambda_=5.0, k=0.01, c=1.0)">
  ...
  <Function id="qiskit.aqua.components.neural_networks.PyTorchDiscriminator.load_model" name="load_model" signature="load_model(load_dir)">
  ...
  <Function id="qiskit.aqua.components.neural_networks.PyTorchDiscriminator.loss" name="loss" signature="loss(x, y, weights=None)">
    Loss function
  ...
  <Function id="qiskit.aqua.components.neural_networks.PyTorchDiscriminator.save_model" name="save_model" signature="save_model(snapshot_dir)">
  ...
  <Function id="qiskit.aqua.components.neural_networks.PyTorchDiscriminator.set_seed" name="set_seed" signature="set_seed(seed)">
    Set seed.
  ...
  <Function id="qiskit.aqua.components.neural_networks.PyTorchDiscriminator.train" name="train" signature="train(data, weights, penalty=True, quantum_instance=None, shots=None)">
