...
<Class id="qiskit.circuit.library.IQP" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.16/qiskit/circuit/library/iqp.py" signature="IQP(interactions)" modifiers="class">
  ...
  **CircuitError** – if the inputs is not as symmetric matrix.
  ...
  <Function id="qiskit.circuit.library.IQP.assign_parameters" signature="assign_parameters(param_dict, inplace=False)">
  ...
  <Function id="qiskit.circuit.library.IQP.bind_parameters" signature="bind_parameters(value_dict)">
  ...
  <Function id="qiskit.circuit.library.IQP.diag_gate" signature="diag_gate(diag, qubit)">
  ...
  <Function id="qiskit.circuit.library.IQP.initialize" signature="initialize(params, qubits)">
  ...
  <Function id="qiskit.circuit.library.IQP.mcmt" signature="mcmt(gate, control_qubits, target_qubits, ancilla_qubits=None, mode='noancilla', *, single_control_gate_fun=None, q_controls=None, q_ancillae=None, q_targets=None)">
  ...
  <Function id="qiskit.circuit.library.IQP.mcry" signature="mcry(theta, q_controls, q_target, q_ancillae, mode=None, use_basis_gates=False)">
  ...
  <Function id="qiskit.circuit.library.IQP.mirror" signature="mirror()">
