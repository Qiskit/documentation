...
<Class id="qiskit.ignis.characterization.RabiFitter" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-ignis/tree/stable/0.5/qiskit/ignis/characterization/calibrations/fitters.py" signature="RabiFitter(backend_result, xdata, qubits, fit_p0, fit_bounds=None)">
  ...
  <Function id="qiskit.ignis.characterization.RabiFitter.__init__" name="__init__" signature="__init__(backend_result, xdata, qubits, fit_p0, fit_bounds=None)">
    See BaseCalibrationFitter \_\_init\_\_
  ...
  <Function id="qiskit.ignis.characterization.RabiFitter.add_data" name="add_data" signature="add_data(results, recalc=True, refit=True)">
  ...
  <Function id="qiskit.ignis.characterization.RabiFitter.backend_result" name="backend_result" signature="property backend_result">
  ...
  <Function id="qiskit.ignis.characterization.RabiFitter.description" name="description" signature="property description">
  ...
  <Function id="qiskit.ignis.characterization.RabiFitter.fit_data" name="fit_data" signature="fit_data(qid=- 1, p0=None, bounds=None, series=None)">
    Fit the curve.
  ...
  <Function id="qiskit.ignis.characterization.RabiFitter.fit_fun" name="fit_fun" signature="property fit_fun">
  ...
  <Function id="qiskit.ignis.characterization.RabiFitter.guess_params" name="guess_params" signature="guess_params(qind=0)">
  ...
  <Function id="qiskit.ignis.characterization.RabiFitter.measured_qubits" name="measured_qubits" signature="property measured_qubits">
  ...
  <Function id="qiskit.ignis.characterization.RabiFitter.params" name="params" signature="property params">
  ...
  <Function id="qiskit.ignis.characterization.RabiFitter.params_err" name="params_err" signature="property params_err">
  ...
  <Function id="qiskit.ignis.characterization.RabiFitter.pi2_amplitude" name="pi2_amplitude" signature="pi2_amplitude(qind=- 1)">
  ...
  <Function id="qiskit.ignis.characterization.RabiFitter.pi_amplitude" name="pi_amplitude" signature="pi_amplitude(qind=- 1)">
  ...
  <Function id="qiskit.ignis.characterization.RabiFitter.plot" name="plot" signature="plot(qind, series='0', ax=None, show_plot=False)">
  ...
  <Function id="qiskit.ignis.characterization.RabiFitter.series" name="series" signature="property series">
  ...
  <Function id="qiskit.ignis.characterization.RabiFitter.xdata" name="xdata" signature="property xdata">
  ...
  <Function id="qiskit.ignis.characterization.RabiFitter.ydata" name="ydata" signature="property ydata">
