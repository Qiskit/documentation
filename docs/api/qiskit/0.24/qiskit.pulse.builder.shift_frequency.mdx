...
<Function id="qiskit.pulse.builder.shift_frequency" name="shift_frequency" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.16/qiskit/pulse/builder.py" signature="shift_frequency(frequency, channel)">
