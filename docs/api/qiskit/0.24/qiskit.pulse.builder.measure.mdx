---
title: measure (v0.24)
description: API reference for qiskit.pulse.builder.measure in qiskit v0.24
...
<Function id="qiskit.pulse.builder.measure" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.16/qiskit/pulse/builder.py" signature="measure(qubits, registers=None)">
