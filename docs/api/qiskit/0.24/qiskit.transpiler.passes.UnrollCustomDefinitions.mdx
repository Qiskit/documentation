...
<Class id="qiskit.transpiler.passes.UnrollCustomDefinitions" github="https://github.com/qiskit/qiskit/tree/stable/0.16/qiskit/transpiler/passes/basis/unroll_custom_definitions.py" signature="UnrollCustomDefinitions(*args, **kwargs)">
