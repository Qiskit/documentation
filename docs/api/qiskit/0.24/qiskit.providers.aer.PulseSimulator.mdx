...
<Class id="qiskit.providers.aer.PulseSimulator" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-aer/tree/stable/0.7/qiskit/providers/aer/backends/pulse_simulator.py" signature="PulseSimulator(configuration=None, properties=None, defaults=None, provider=None, **backend_options)">
  ...
  **Raises**
  ...
  <Function id="qiskit.providers.aer.PulseSimulator.__init__" name="__init__" signature="__init__(configuration=None, properties=None, defaults=None, provider=None, **backend_options)">
    Aer class for backends.
  ...
  <Function id="qiskit.providers.aer.PulseSimulator.available_methods" name="available_methods" signature="available_methods()">
    Return the available simulation methods.
  </Function>

  ### clear\_options

  <Function id="qiskit.providers.aer.PulseSimulator.clear_options" name="clear_options" signature="clear_options()">
    Reset the simulator options to default values.
  </Function>

  ### configuration

  <Function id="qiskit.providers.aer.PulseSimulator.configuration" name="configuration" signature="configuration()">
  ...
  <Function id="qiskit.providers.aer.PulseSimulator.defaults" name="defaults" signature="defaults()">
  ...
  <Function id="qiskit.providers.aer.PulseSimulator.from_backend" name="from_backend" signature="classmethod from_backend(backend, **options)">
    Initialize simulator from backend.
  </Function>

  ### name

  <Function id="qiskit.providers.aer.PulseSimulator.name" name="name" signature="name()">
  ...
  <Function id="qiskit.providers.aer.PulseSimulator.options" name="options" signature="property options">
    Return the current simulator options
  </Function>

  ### properties

  <Function id="qiskit.providers.aer.PulseSimulator.properties" name="properties" signature="properties()">
  ...
  <Function id="qiskit.providers.aer.PulseSimulator.provider" name="provider" signature="provider()">
  ...
  <Function id="qiskit.providers.aer.PulseSimulator.run" name="run" signature="run(qobj, *args, backend_options=None, validate=True, **run_options)">
  ...
  <Function id="qiskit.providers.aer.PulseSimulator.set_options" name="set_options" signature="set_options(**backend_options)">
    Set the simulator options
  </Function>

  ### status

  <Function id="qiskit.providers.aer.PulseSimulator.status" name="status" signature="status()">
  ...
  <Function id="qiskit.providers.aer.PulseSimulator.version" name="version" signature="version()">
