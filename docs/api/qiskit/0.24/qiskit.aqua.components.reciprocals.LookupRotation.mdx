...
<Class id="qiskit.aqua.components.reciprocals.LookupRotation" github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.8/qiskit/aqua/components/reciprocals/lookup_rotation.py" signature="LookupRotation(pat_length=None, subpat_length=None, scale=0, negative_evals=False, evo_time=None, lambda_min=None)">
  ...
  *   **lambda\_min** (`Optional`\[`float`]) – The smallest expected eigenvalue
  ...
  <Function id="qiskit.aqua.components.reciprocals.LookupRotation.__init__" name="__init__" signature="__init__(pat_length=None, subpat_length=None, scale=0, negative_evals=False, evo_time=None, lambda_min=None)">
    **Parameters**
  ...
  <Function id="qiskit.aqua.components.reciprocals.LookupRotation.construct_circuit" name="construct_circuit" signature="construct_circuit(mode, inreg)">
  ...
  <Function id="qiskit.aqua.components.reciprocals.LookupRotation.sv_to_resvec" name="sv_to_resvec" signature="sv_to_resvec(statevector, num_q)">
