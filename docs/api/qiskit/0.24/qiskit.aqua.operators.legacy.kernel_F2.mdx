...
<Function id="qiskit.aqua.operators.legacy.kernel_F2" github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.8/qiskit/aqua/operators/legacy/common.py" signature="kernel_F2(matrix_in)">
