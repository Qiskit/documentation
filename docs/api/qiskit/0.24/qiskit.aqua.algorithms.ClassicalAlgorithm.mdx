...
<Class id="qiskit.aqua.algorithms.ClassicalAlgorithm" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.8/qiskit/aqua/algorithms/classical_algorithm.py" signature="ClassicalAlgorithm">
