---
title: ClassicalAlgorithm (v0.24)
description: API reference for qiskit.aqua.algorithms.ClassicalAlgorithm in qiskit v0.24
...
<Class id="qiskit.aqua.algorithms.ClassicalAlgorithm" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.8/qiskit/aqua/algorithms/classical_algorithm.py" signature="ClassicalAlgorithm" modifiers="class">
