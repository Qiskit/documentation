...
<Class id="qiskit.transpiler.passes.BarrierBeforeFinalMeasurements" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.16/qiskit/transpiler/passes/utils/barrier_before_final_measurements.py" signature="BarrierBeforeFinalMeasurements(*args, **kwargs)" modifiers="class">
  ...
  <Function id="qiskit.transpiler.passes.BarrierBeforeFinalMeasurements.is_analysis_pass" signature="is_analysis_pass" modifiers="property">
  ...
  <Function id="qiskit.transpiler.passes.BarrierBeforeFinalMeasurements.is_transformation_pass" signature="is_transformation_pass" modifiers="property">
