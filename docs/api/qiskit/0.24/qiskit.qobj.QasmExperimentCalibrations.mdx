...
<Class id="qiskit.qobj.QasmExperimentCalibrations" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.16/qiskit/qobj/qasm_qobj.py" signature="QasmExperimentCalibrations(gates)">
  ...
  **gates** (*list(*[*GateCalibration*](qiskit.qobj.GateCalibration "qiskit.qobj.GateCalibration")*)*) –
  ...
  <Function id="qiskit.qobj.QasmExperimentCalibrations.__init__" name="__init__" signature="__init__(gates)">
    Initialize a container for calibrations.
  ...
  <Function id="qiskit.qobj.QasmExperimentCalibrations.from_dict" name="from_dict" signature="classmethod from_dict(data)">
  ...
  <Function id="qiskit.qobj.QasmExperimentCalibrations.to_dict" name="to_dict" signature="to_dict()">
