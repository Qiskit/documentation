...
`remap_noise_model(noise_model, remapping, discard_qubits=False, warnings=True)` [GitHub](https://github.com/qiskit/qiskit-aer/tree/stable/0.7/qiskit/providers/aer/utils/noise_remapper.py "view source code")
