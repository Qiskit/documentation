...
<Class id="qiskit.pulse.SetFrequency" github="https://github.com/qiskit/qiskit/tree/stable/0.16/qiskit/pulse/instructions/frequency.py" signature="SetFrequency(frequency, channel, name=None)">
