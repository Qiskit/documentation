...
`TruthTableOracle(bitmaps, optimization=False, mct_mode='basic')` [GitHub](https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.8/qiskit/aqua/components/oracles/truth_table_oracle.py "view source code")
...
<span id="qiskit.aqua.components.oracles.TruthTableOracle.__init__" />
