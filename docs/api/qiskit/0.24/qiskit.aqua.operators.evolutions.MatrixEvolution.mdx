...
<Class id="qiskit.aqua.operators.evolutions.MatrixEvolution" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.8/qiskit/aqua/operators/evolutions/matrix_evolution.py" signature="MatrixEvolution">
  ...
  <Function id="qiskit.aqua.operators.evolutions.MatrixEvolution.__init__" name="__init__" signature="__init__()">
  ...
  <Function id="qiskit.aqua.operators.evolutions.MatrixEvolution.convert" name="convert" signature="convert(operator)">
