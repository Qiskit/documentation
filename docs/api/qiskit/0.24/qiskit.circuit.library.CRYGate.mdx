...
<Class id="qiskit.circuit.library.CRYGate" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.16/qiskit/circuit/library/standard_gates/ry.py" signature="CRYGate(theta, label=None, ctrl_state=None)" modifiers="class">
  Controlled-RY gate.
...
$$
  ...
  <Function id="qiskit.circuit.library.CRYGate.ctrl_state" signature="ctrl_state" modifiers="property">
  ...
  <Function id="qiskit.circuit.library.CRYGate.decompositions" signature="decompositions" modifiers="property">
    Get the decompositions of the instruction from the SessionEquivalenceLibrary.
  </Function>

  ### definition

  <Function id="qiskit.circuit.library.CRYGate.definition" signature="definition" modifiers="property">
  ...
  <Function id="qiskit.circuit.library.CRYGate.duration" signature="duration" modifiers="property">
    Get the duration.
  </Function>
  ...
  <Function id="qiskit.circuit.library.CRYGate.label" signature="label" modifiers="property">
    Return gate label
  ...
  <Function id="qiskit.circuit.library.CRYGate.num_ctrl_qubits" signature="num_ctrl_qubits" modifiers="property">
  ...
  <Function id="qiskit.circuit.library.CRYGate.params" signature="params" modifiers="property">
  ...
  <Function id="qiskit.circuit.library.CRYGate.unit" signature="unit" modifiers="property">
