...
<Class id="qiskit.validation.jsonschema.SchemaValidationError" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.16/qiskit/validation/jsonschema/exceptions.py" signature="SchemaValidationError(*message)">
