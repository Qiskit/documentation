...
<Class id="qiskit.optimization.algorithms.ADMMOptimizationResult" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.8/qiskit/optimization/algorithms/admm_optimizer.py" signature="ADMMOptimizationResult(x, fval, variables, state, status)">
  ...
  *   **status** (`OptimizationResultStatus`) – Termination status of an optimization algorithm
  ...
  <Function id="qiskit.optimization.algorithms.ADMMOptimizationResult.fval" signature="property fval">
  ...
  <Function id="qiskit.optimization.algorithms.ADMMOptimizationResult.raw_results" signature="property raw_results">
  ...
  <Function id="qiskit.optimization.algorithms.ADMMOptimizationResult.state" signature="property state">
    returns state
  ...
  <Function id="qiskit.optimization.algorithms.ADMMOptimizationResult.status" signature="property status">
  ...
  <Function id="qiskit.optimization.algorithms.ADMMOptimizationResult.variable_names" signature="property variable_names">
  ...
  <Function id="qiskit.optimization.algorithms.ADMMOptimizationResult.variables" signature="property variables">
  ...
  <Function id="qiskit.optimization.algorithms.ADMMOptimizationResult.variables_dict" signature="property variables_dict">
  ...
  <Function id="qiskit.optimization.algorithms.ADMMOptimizationResult.x" signature="property x">
