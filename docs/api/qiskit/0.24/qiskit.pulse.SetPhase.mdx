...
$$
  ...
  *   **name** (`Optional`\[`str`]) – Display name for this instruction.
  ...
  <Function id="qiskit.pulse.SetPhase.command" signature="command" modifiers="property">
  ...
  <Function id="qiskit.pulse.SetPhase.timeslots" signature="timeslots" modifiers="property">
