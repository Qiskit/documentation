...
<Class id="qiskit.aqua.algorithms.QPE" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.8/qiskit/aqua/algorithms/minimum_eigen_solvers/qpe.py" signature="QPE(operator=None, state_in=None, iqft=None, num_time_slices=1, num_ancillae=1, expansion_mode='trotter', expansion_order=1, shallow_circuit_concat=False, quantum_instance=None)">
  ...
  *   **quantum\_instance** (`Union`\[`QuantumInstance`, `Backend`, `BaseBackend`, `None`]) – Quantum Instance or Backend
  ...
  <Function id="qiskit.aqua.algorithms.QPE.aux_operators" signature="property aux_operators">
  ...
  <Function id="qiskit.aqua.algorithms.QPE.backend" signature="property backend">
    Returns backend.
  ...
  <Function id="qiskit.aqua.algorithms.QPE.operator" signature="property operator">
    Returns operator
  ...
  <Function id="qiskit.aqua.algorithms.QPE.quantum_instance" signature="property quantum_instance">
  ...
  <Function id="qiskit.aqua.algorithms.QPE.random" signature="property random">
  ...
  <Function id="qiskit.aqua.algorithms.QPE.supports_aux_operators" signature="classmethod supports_aux_operators()">
