...
<Class id="qiskit.aqua.algorithms.QPE" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.8/qiskit/aqua/algorithms/minimum_eigen_solvers/qpe.py" signature="QPE(operator=None, state_in=None, iqft=None, num_time_slices=1, num_ancillae=1, expansion_mode='trotter', expansion_order=1, shallow_circuit_concat=False, quantum_instance=None)" modifiers="class">
  ...
  *   **quantum\_instance** (`Union`\[`QuantumInstance`, `Backend`, `BaseBackend`, `None`]) – Quantum Instance or Backend
  ...
  <Function id="qiskit.aqua.algorithms.QPE.__init__" signature="__init__(operator=None, state_in=None, iqft=None, num_time_slices=1, num_ancillae=1, expansion_mode='trotter', expansion_order=1, shallow_circuit_concat=False, quantum_instance=None)">
    **Parameters**
  ...
  <Function id="qiskit.aqua.algorithms.QPE.aux_operators" signature="aux_operators" modifiers="property">
  ...
  <Function id="qiskit.aqua.algorithms.QPE.backend" signature="backend" modifiers="property">
    Returns backend.
  ...
  <Function id="qiskit.aqua.algorithms.QPE.compute_minimum_eigenvalue" signature="compute_minimum_eigenvalue(operator=None, aux_operators=None)">
  ...
  <Function id="qiskit.aqua.algorithms.QPE.construct_circuit" signature="construct_circuit(measurement=False)">
    Construct circuit.
  ...
  <Function id="qiskit.aqua.algorithms.QPE.operator" signature="operator" modifiers="property">
    Returns operator
  ...
  <Function id="qiskit.aqua.algorithms.QPE.quantum_instance" signature="quantum_instance" modifiers="property">
  ...
  <Function id="qiskit.aqua.algorithms.QPE.random" signature="random" modifiers="property">
    Return a numpy random.
  </Function>

  ### run

  <Function id="qiskit.aqua.algorithms.QPE.run" signature="run(quantum_instance=None, **kwargs)">
  ...
  <Function id="qiskit.aqua.algorithms.QPE.set_backend" signature="set_backend(backend, **kwargs)">
  ...
  <Function id="qiskit.aqua.algorithms.QPE.supports_aux_operators" signature="supports_aux_operators()" modifiers="classmethod">
