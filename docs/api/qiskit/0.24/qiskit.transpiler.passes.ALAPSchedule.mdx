...
<Class id="qiskit.transpiler.passes.ALAPSchedule" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.16/qiskit/transpiler/passes/scheduling/alap.py" signature="ALAPSchedule(*args, **kwargs)">
  ALAP Scheduling.
  ...
  **durations** ([*InstructionDurations*](qiskit.transpiler.InstructionDurations "qiskit.transpiler.InstructionDurations")) – Durations of instructions to be used in scheduling
  ...
  <Function id="qiskit.transpiler.passes.ALAPSchedule.__init__" name="__init__" signature="__init__(durations)">
    ALAPSchedule initializer.
  ...
  <Function id="qiskit.transpiler.passes.ALAPSchedule.is_analysis_pass" name="is_analysis_pass" signature="property is_analysis_pass">
  ...
  <Function id="qiskit.transpiler.passes.ALAPSchedule.is_transformation_pass" name="is_transformation_pass" signature="property is_transformation_pass">
  ...
  <Function id="qiskit.transpiler.passes.ALAPSchedule.run" name="run" signature="run(dag, time_unit=None)">
