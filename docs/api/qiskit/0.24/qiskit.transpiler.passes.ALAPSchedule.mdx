...
<Class id="qiskit.transpiler.passes.ALAPSchedule" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.16/qiskit/transpiler/passes/scheduling/alap.py" signature="ALAPSchedule(*args, **kwargs)" modifiers="class">
  ALAP Scheduling.
  ...
  **durations** ([*InstructionDurations*](qiskit.transpiler.InstructionDurations "qiskit.transpiler.InstructionDurations")) – Durations of instructions to be used in scheduling
  ...
  <Function id="qiskit.transpiler.passes.ALAPSchedule.is_analysis_pass" signature="is_analysis_pass" modifiers="property">
  ...
  <Function id="qiskit.transpiler.passes.ALAPSchedule.is_transformation_pass" signature="is_transformation_pass" modifiers="property">
  ...
  <Function id="qiskit.transpiler.passes.ALAPSchedule.run" signature="run(dag, time_unit=None)">
