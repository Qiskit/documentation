...
<Function id="qiskit.aqua.utils.random_h2_body" github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.8/qiskit/aqua/utils/random_matrix_generator.py" signature="random_h2_body(N, M)">
