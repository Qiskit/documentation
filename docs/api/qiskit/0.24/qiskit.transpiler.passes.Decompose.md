...
`Decompose(gate=None)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.16/qiskit/transpiler/passes/basis/decompose.py "view source code")
...
<span id="qiskit.transpiler.passes.Decompose.__init__" />
