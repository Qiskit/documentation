...
<Class id="qiskit.providers.basicaer.BasicAerJob" github="https://github.com/qiskit/qiskit/tree/stable/0.16/qiskit/providers/basicaer/basicaerjob.py" signature="BasicAerJob(backend, job_id, fn, qobj)">
  BasicAerJob class.
