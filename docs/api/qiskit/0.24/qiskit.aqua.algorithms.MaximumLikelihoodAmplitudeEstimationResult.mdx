...
<Class id="qiskit.aqua.algorithms.MaximumLikelihoodAmplitudeEstimationResult" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.8/qiskit/aqua/algorithms/amplitude_estimators/mlae.py" signature="MaximumLikelihoodAmplitudeEstimationResult(a_dict=None)">
