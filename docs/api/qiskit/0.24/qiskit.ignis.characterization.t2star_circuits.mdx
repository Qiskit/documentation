...
<Function id="qiskit.ignis.characterization.t2star_circuits" github="https://github.com/qiskit-community/qiskit-ignis/tree/stable/0.5/qiskit/ignis/characterization/coherence/circuits.py" signature="t2star_circuits(num_of_gates, gate_time, qubits, nosc=0)">
