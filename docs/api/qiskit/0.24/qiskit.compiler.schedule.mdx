...
<Function id="qiskit.compiler.schedule" github="https://github.com/qiskit/qiskit/tree/stable/0.16/qiskit/compiler/schedule.py" signature="schedule(circuits, backend=None, inst_map=None, meas_map=None, dt=None, method=None)">
