...
<Class id="qiskit.aqua.algorithms.MaximumLikelihoodAmplitudeEstimation" github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.8/qiskit/aqua/algorithms/amplitude_estimators/mlae.py" signature="MaximumLikelihoodAmplitudeEstimation(num_oracle_circuits, state_preparation=None, grover_operator=None, objective_qubits=None, post_processing=None, a_factory=None, q_factory=None, i_objective=None, likelihood_evals=None, quantum_instance=None)">
  ...
  *   **quantum\_instance** (`Union`\[`QuantumInstance`, `Backend`, `BaseBackend`, `None`]) – Quantum Instance or Backend
  ...
  <Function id="qiskit.aqua.algorithms.MaximumLikelihoodAmplitudeEstimation.__init__" name="__init__" signature="__init__(num_oracle_circuits, state_preparation=None, grover_operator=None, objective_qubits=None, post_processing=None, a_factory=None, q_factory=None, i_objective=None, likelihood_evals=None, quantum_instance=None)">
    **Parameters**
  ...
  <Function id="qiskit.aqua.algorithms.MaximumLikelihoodAmplitudeEstimation.a_factory" name="a_factory" signature="property a_factory">
  ...
  <Function id="qiskit.aqua.algorithms.MaximumLikelihoodAmplitudeEstimation.backend" name="backend" signature="property backend">
    Returns backend.
  ...
  <Function id="qiskit.aqua.algorithms.MaximumLikelihoodAmplitudeEstimation.confidence_interval" name="confidence_interval" signature="confidence_interval(alpha, kind='fisher')">
  ...
  <Function id="qiskit.aqua.algorithms.MaximumLikelihoodAmplitudeEstimation.construct_circuits" name="construct_circuits" signature="construct_circuits(measurement=False)">
  ...
  <Function id="qiskit.aqua.algorithms.MaximumLikelihoodAmplitudeEstimation.grover_operator" name="grover_operator" signature="property grover_operator">
  ...
  <Function id="qiskit.aqua.algorithms.MaximumLikelihoodAmplitudeEstimation.i_objective" name="i_objective" signature="property i_objective">
  ...
  <Function id="qiskit.aqua.algorithms.MaximumLikelihoodAmplitudeEstimation.is_good_state" name="is_good_state" signature="is_good_state(measurement)">
  ...
  <Function id="qiskit.aqua.algorithms.MaximumLikelihoodAmplitudeEstimation.objective_qubits" name="objective_qubits" signature="property objective_qubits">
  ...
  <Function id="qiskit.aqua.algorithms.MaximumLikelihoodAmplitudeEstimation.post_processing" name="post_processing" signature="post_processing(value)">
  ...
  <Function id="qiskit.aqua.algorithms.MaximumLikelihoodAmplitudeEstimation.q_factory" name="q_factory" signature="property q_factory">
...
$$
  ...
  <Function id="qiskit.aqua.algorithms.MaximumLikelihoodAmplitudeEstimation.quantum_instance" name="quantum_instance" signature="property quantum_instance">
  ...
  <Function id="qiskit.aqua.algorithms.MaximumLikelihoodAmplitudeEstimation.random" name="random" signature="property random">
    Return a numpy random.
  </Function>

  ### run

  <Function id="qiskit.aqua.algorithms.MaximumLikelihoodAmplitudeEstimation.run" name="run" signature="run(quantum_instance=None, **kwargs)">
  ...
  <Function id="qiskit.aqua.algorithms.MaximumLikelihoodAmplitudeEstimation.set_backend" name="set_backend" signature="set_backend(backend, **kwargs)">
  ...
  <Function id="qiskit.aqua.algorithms.MaximumLikelihoodAmplitudeEstimation.state_preparation" name="state_preparation" signature="property state_preparation">
