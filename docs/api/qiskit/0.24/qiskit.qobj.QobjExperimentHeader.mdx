---
title: QobjExperimentHeader (v0.24)
description: API reference for qiskit.qobj.QobjExperimentHeader in qiskit v0.24
...
<Class id="qiskit.qobj.QobjExperimentHeader" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.16/qiskit/qobj/common.py" signature="QobjExperimentHeader(**kwargs)" modifiers="class">
