...
<Class id="qiskit.aqua.components.optimizers.DIRECT_L" github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.8/qiskit/aqua/components/optimizers/nlopts/direct_l.py" signature="DIRECT_L(max_evals=1000)">
