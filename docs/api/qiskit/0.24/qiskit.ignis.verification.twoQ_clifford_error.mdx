...
<Function id="qiskit.ignis.verification.twoQ_clifford_error" github="https://github.com/qiskit-community/qiskit-ignis/tree/stable/0.5/qiskit/ignis/verification/randomized_benchmarking/rb_utils.py" signature="twoQ_clifford_error(ngates, gate_qubit, gate_err)">
