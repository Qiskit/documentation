...
<Class id="qiskit.circuit.library.GRZ" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.16/qiskit/circuit/library/generalized_gates/gr.py" signature="GRZ(num_qubits, phi)">
  Global RZ gate.
...
$$
  ...
  *   **phi** (`float`) – rotation angle about z-axis
  ...
  | [`assign_parameters`](#qiskit.circuit.library.GRZ.assign_parameters "qiskit.circuit.library.GRZ.assign_parameters")(param\_dict\[, inplace])                      | Assign parameters to new parameters or values.                                                                                      |
  | [`barrier`](#qiskit.circuit.library.GRZ.barrier "qiskit.circuit.library.GRZ.barrier")(\*qargs)                                                                    | Apply `Barrier`.                                                                                                                    |
  | [`bind_parameters`](#qiskit.circuit.library.GRZ.bind_parameters "qiskit.circuit.library.GRZ.bind_parameters")(value\_dict)                                        | Assign numeric parameters to values yielding a new circuit.                                                                         |
  ...
  | [`combine`](#qiskit.circuit.library.GRZ.combine "qiskit.circuit.library.GRZ.combine")(rhs)                                                                        | Append rhs to self if self contains compatible registers.                                                                           |
  ...
  | [`diag_gate`](#qiskit.circuit.library.GRZ.diag_gate "qiskit.circuit.library.GRZ.diag_gate")(diag, qubit)                                                          | Deprecated version of QuantumCircuit.diagonal.                                                                                      |
  ...
  | [`extend`](#qiskit.circuit.library.GRZ.extend "qiskit.circuit.library.GRZ.extend")(rhs)                                                                           | Append QuantumCircuit to the right hand side if it contains compatible registers.                                                   |
  ...
  | [`hamiltonian`](#qiskit.circuit.library.GRZ.hamiltonian "qiskit.circuit.library.GRZ.hamiltonian")(operator, time, qubits\[, label])                               | Apply hamiltonian evolution to to qubits.                                                                                           |
  ...
  | [`initialize`](#qiskit.circuit.library.GRZ.initialize "qiskit.circuit.library.GRZ.initialize")(params, qubits)                                                    | Apply initialize to circuit.                                                                                                        |
  ...
  | [`mcmt`](#qiskit.circuit.library.GRZ.mcmt "qiskit.circuit.library.GRZ.mcmt")(gate, control\_qubits, target\_qubits\[, …])                                         | Apply a multi-control, multi-target using a generic gate.                                                                           |
  ...
  | [`mcry`](#qiskit.circuit.library.GRZ.mcry "qiskit.circuit.library.GRZ.mcry")(theta, q\_controls, q\_target, q\_ancillae)                                          | Apply Multiple-Controlled Y rotation gate                                                                                           |
  ...
  | [`mirror`](#qiskit.circuit.library.GRZ.mirror "qiskit.circuit.library.GRZ.mirror")()                                                                              | DEPRECATED: use circuit.reverse\_ops().                                                                                             |
  ...
  | [`r`](#qiskit.circuit.library.GRZ.r "qiskit.circuit.library.GRZ.r")(theta, phi, qubit)                                                                            | Apply `RGate`.                                                                                                                      |
  ...
  <Function id="qiskit.circuit.library.GRZ.assign_parameters" name="assign_parameters" signature="assign_parameters(param_dict, inplace=False)">
  ...
  <Function id="qiskit.circuit.library.GRZ.bind_parameters" name="bind_parameters" signature="bind_parameters(value_dict)">
  ...
  <Function id="qiskit.circuit.library.GRZ.diag_gate" name="diag_gate" signature="diag_gate(diag, qubit)">
  ...
  <Function id="qiskit.circuit.library.GRZ.initialize" name="initialize" signature="initialize(params, qubits)">
  ...
  <Function id="qiskit.circuit.library.GRZ.mcmt" name="mcmt" signature="mcmt(gate, control_qubits, target_qubits, ancilla_qubits=None, mode='noancilla', *, single_control_gate_fun=None, q_controls=None, q_ancillae=None, q_targets=None)">
  ...
  <Function id="qiskit.circuit.library.GRZ.mcry" name="mcry" signature="mcry(theta, q_controls, q_target, q_ancillae, mode=None, use_basis_gates=False)">
  ...
  <Function id="qiskit.circuit.library.GRZ.mirror" name="mirror" signature="mirror()">
