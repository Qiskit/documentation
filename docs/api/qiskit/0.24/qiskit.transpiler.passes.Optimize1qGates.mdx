...
<Class id="qiskit.transpiler.passes.Optimize1qGates" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.16/qiskit/transpiler/passes/optimization/optimize_1q_gates.py" signature="Optimize1qGates(*args, **kwargs)" modifiers="class">
  ...
  *   **eps** (*float*) – EPS to check against
  ...
  <Function id="qiskit.transpiler.passes.Optimize1qGates.__init__" signature="__init__(basis=None, eps=1e-15)">
    Optimize1qGates initializer.
  ...
  <Function id="qiskit.transpiler.passes.Optimize1qGates.is_analysis_pass" signature="is_analysis_pass" modifiers="property">
  ...
  <Function id="qiskit.transpiler.passes.Optimize1qGates.is_transformation_pass" signature="is_transformation_pass" modifiers="property">
