...
<Class id="qiskit.aqua.AquaError" name="AquaError" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.8/qiskit/aqua/aqua_error.py" signature="AquaError(*message)">
