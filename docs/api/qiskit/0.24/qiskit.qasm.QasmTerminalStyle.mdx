...
<Class id="qiskit.qasm.QasmTerminalStyle" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.16/qiskit/qasm/pygments/lexer.py" signature="QasmTerminalStyle">
  A style for OpenQasm in a Terminal env (e.g. Jupyter print).

  ### \_\_init\_\_

  <Function id="qiskit.qasm.QasmTerminalStyle.__init__" name="__init__" signature="__init__()">
