...
<Class id="qiskit.finance.data_providers.BaseDataProvider" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.8/qiskit/finance/data_providers/_base_data_provider.py" signature="BaseDataProvider">
  ...
  <Function id="qiskit.finance.data_providers.BaseDataProvider.__init__" name="__init__" signature="abstract __init__()">
  ...
  <Function id="qiskit.finance.data_providers.BaseDataProvider.get_coordinates" name="get_coordinates" signature="get_coordinates()">
  ...
  <Function id="qiskit.finance.data_providers.BaseDataProvider.get_covariance_matrix" name="get_covariance_matrix" signature="get_covariance_matrix()">
  ...
  <Function id="qiskit.finance.data_providers.BaseDataProvider.get_mean_vector" name="get_mean_vector" signature="get_mean_vector()">
  ...
  <Function id="qiskit.finance.data_providers.BaseDataProvider.get_period_return_covariance_matrix" name="get_period_return_covariance_matrix" signature="get_period_return_covariance_matrix()">
    Returns a vector containing the mean value of each asset.
  ...
  <Function id="qiskit.finance.data_providers.BaseDataProvider.get_period_return_mean_vector" name="get_period_return_mean_vector" signature="get_period_return_mean_vector()">
    Returns a vector containing the mean value of each asset.
  ...
  <Function id="qiskit.finance.data_providers.BaseDataProvider.get_similarity_matrix" name="get_similarity_matrix" signature="get_similarity_matrix()">
  ...
  <Function id="qiskit.finance.data_providers.BaseDataProvider.run" name="run" signature="abstract run()">
    Loads data.
