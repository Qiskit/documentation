...
<Function id="qiskit.converters.dagdependency_to_circuit" github="https://github.com/qiskit/qiskit/tree/stable/0.16/qiskit/converters/dagdependency_to_circuit.py" signature="dagdependency_to_circuit(dagdependency)">
