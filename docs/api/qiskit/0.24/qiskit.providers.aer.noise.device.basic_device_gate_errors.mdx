---
title: basic_device_gate_errors (v0.24)
description: API reference for qiskit.providers.aer.noise.device.basic_device_gate_errors in qiskit v0.24
...
<Function id="qiskit.providers.aer.noise.device.basic_device_gate_errors" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-aer/tree/stable/0.7/qiskit/providers/aer/noise/device/models.py" signature="basic_device_gate_errors(properties, gate_error=True, thermal_relaxation=True, gate_lengths=None, gate_length_units='ns', temperature=0, standard_gates=True, warnings=True)">
