...
`PauliExpectation(group_paulis=True)` [GitHub](https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.8/qiskit/aqua/operators/expectations/pauli_expectation.py "view source code")
