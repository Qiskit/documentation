...
<Class id="qiskit.chemistry.core.Hamiltonian" github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.8/qiskit/chemistry/core/hamiltonian.py" signature="Hamiltonian(transformation=<TransformationType.FULL: 'full'>, qubit_mapping=<QubitMappingType.PARITY: 'parity'>, two_qubit_reduction=True, freeze_core=False, orbital_reduction=None, z2symmetry_reduction=None)">
  ...
  **Raises**
  ...
  <Function id="qiskit.chemistry.core.Hamiltonian.__init__" name="__init__" signature="__init__(transformation=<TransformationType.FULL: 'full'>, qubit_mapping=<QubitMappingType.PARITY: 'parity'>, two_qubit_reduction=True, freeze_core=False, orbital_reduction=None, z2symmetry_reduction=None)">
    **Parameters**
  ...
  <Function id="qiskit.chemistry.core.Hamiltonian.molecule_info" name="molecule_info" signature="property molecule_info">
    returns molecule info
  </Function>

  ### process\_algorithm\_result

  <Function id="qiskit.chemistry.core.Hamiltonian.process_algorithm_result" name="process_algorithm_result" signature="process_algorithm_result(algo_result)">
  ...
  <Function id="qiskit.chemistry.core.Hamiltonian.run" name="run" signature="run(qmolecule)">
    run method
