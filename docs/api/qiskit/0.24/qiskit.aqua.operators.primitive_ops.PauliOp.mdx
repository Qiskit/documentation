...
<Class id="qiskit.aqua.operators.primitive_ops.PauliOp" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.8/qiskit/aqua/operators/primitive_ops/pauli_op.py" signature="PauliOp(primitive, coeff=1.0)" modifiers="class">
  ...
  **TypeError** – invalid parameters.
  ...
  <Function id="qiskit.aqua.operators.primitive_ops.PauliOp.__init__" signature="__init__(primitive, coeff=1.0)">
    **Parameters**
  ...
  <Function id="qiskit.aqua.operators.primitive_ops.PauliOp.add" signature="add(other)">
  ...
  <Function id="qiskit.aqua.operators.primitive_ops.PauliOp.adjoint" signature="adjoint()">
  ...
  <Function id="qiskit.aqua.operators.primitive_ops.PauliOp.assign_parameters" signature="assign_parameters(param_dict)">
  ...
  <Function id="qiskit.aqua.operators.primitive_ops.PauliOp.bind_parameters" signature="bind_parameters(param_dict)">
  ...
  <Function id="qiskit.aqua.operators.primitive_ops.PauliOp.coeff" signature="coeff" modifiers="property">
  ...
  <Function id="qiskit.aqua.operators.primitive_ops.PauliOp.commutes" signature="commutes(other_op)">
  ...
  <Function id="qiskit.aqua.operators.primitive_ops.PauliOp.compose" signature="compose(other, permutation=None, front=False)">
  ...
  <Function id="qiskit.aqua.operators.primitive_ops.PauliOp.equals" signature="equals(other)">
  ...
  <Function id="qiskit.aqua.operators.primitive_ops.PauliOp.eval" signature="eval(front=None)">
  ...
  <Function id="qiskit.aqua.operators.primitive_ops.PauliOp.exp_i" signature="exp_i()">
  ...
  <Function id="qiskit.aqua.operators.primitive_ops.PauliOp.log_i" signature="log_i(massive=False)">
  ...
  <Function id="qiskit.aqua.operators.primitive_ops.PauliOp.mul" signature="mul(scalar)">
  ...
  <Function id="qiskit.aqua.operators.primitive_ops.PauliOp.neg" signature="neg()">
  ...
  <Function id="qiskit.aqua.operators.primitive_ops.PauliOp.num_qubits" signature="num_qubits" modifiers="property">
  ...
  <Function id="qiskit.aqua.operators.primitive_ops.PauliOp.parameters" signature="parameters" modifiers="property">
    Return a set of Parameter objects contained in the Operator.
  </Function>

  ### permute

  <Function id="qiskit.aqua.operators.primitive_ops.PauliOp.permute" signature="permute(permutation)">
  ...
  <Function id="qiskit.aqua.operators.primitive_ops.PauliOp.power" signature="power(exponent)">
  ...
  <Function id="qiskit.aqua.operators.primitive_ops.PauliOp.primitive" signature="primitive" modifiers="property">
  ...
  <Function id="qiskit.aqua.operators.primitive_ops.PauliOp.primitive_strings" signature="primitive_strings()">
  ...
  <Function id="qiskit.aqua.operators.primitive_ops.PauliOp.reduce" signature="reduce()">
  ...
  <Function id="qiskit.aqua.operators.primitive_ops.PauliOp.tensor" signature="tensor(other)">
  ...
  <Function id="qiskit.aqua.operators.primitive_ops.PauliOp.tensorpower" signature="tensorpower(other)">
  ...
  <Function id="qiskit.aqua.operators.primitive_ops.PauliOp.to_circuit" signature="to_circuit()">
  ...
  <Function id="qiskit.aqua.operators.primitive_ops.PauliOp.to_circuit_op" signature="to_circuit_op()">
  ...
  <Function id="qiskit.aqua.operators.primitive_ops.PauliOp.to_instruction" signature="to_instruction()">
  ...
  <Function id="qiskit.aqua.operators.primitive_ops.PauliOp.to_legacy_op" signature="to_legacy_op(massive=False)">
  ...
  <Function id="qiskit.aqua.operators.primitive_ops.PauliOp.to_matrix" signature="to_matrix(massive=False)">
  ...
  <Function id="qiskit.aqua.operators.primitive_ops.PauliOp.to_matrix_op" signature="to_matrix_op(massive=False)">
  ...
  <Function id="qiskit.aqua.operators.primitive_ops.PauliOp.to_pauli_op" signature="to_pauli_op(massive=False)">
  ...
  <Function id="qiskit.aqua.operators.primitive_ops.PauliOp.to_spmatrix" signature="to_spmatrix()">
