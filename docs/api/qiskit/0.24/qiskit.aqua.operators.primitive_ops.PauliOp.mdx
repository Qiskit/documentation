...
<Class id="qiskit.aqua.operators.primitive_ops.PauliOp" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.8/qiskit/aqua/operators/primitive_ops/pauli_op.py" signature="PauliOp(primitive, coeff=1.0)">
  ...
  **TypeError** – invalid parameters.
  ...
  <Function id="qiskit.aqua.operators.primitive_ops.PauliOp.__init__" name="__init__" signature="__init__(primitive, coeff=1.0)">
    **Parameters**
  ...
  <Function id="qiskit.aqua.operators.primitive_ops.PauliOp.add" name="add" signature="add(other)">
  ...
  <Function id="qiskit.aqua.operators.primitive_ops.PauliOp.adjoint" name="adjoint" signature="adjoint()">
  ...
  <Function id="qiskit.aqua.operators.primitive_ops.PauliOp.assign_parameters" name="assign_parameters" signature="assign_parameters(param_dict)">
  ...
  <Function id="qiskit.aqua.operators.primitive_ops.PauliOp.bind_parameters" name="bind_parameters" signature="bind_parameters(param_dict)">
  ...
  <Function id="qiskit.aqua.operators.primitive_ops.PauliOp.coeff" name="coeff" signature="property coeff">
  ...
  <Function id="qiskit.aqua.operators.primitive_ops.PauliOp.commutes" name="commutes" signature="commutes(other_op)">
  ...
  <Function id="qiskit.aqua.operators.primitive_ops.PauliOp.compose" name="compose" signature="compose(other, permutation=None, front=False)">
  ...
  <Function id="qiskit.aqua.operators.primitive_ops.PauliOp.equals" name="equals" signature="equals(other)">
  ...
  <Function id="qiskit.aqua.operators.primitive_ops.PauliOp.eval" name="eval" signature="eval(front=None)">
  ...
  <Function id="qiskit.aqua.operators.primitive_ops.PauliOp.exp_i" name="exp_i" signature="exp_i()">
  ...
  <Function id="qiskit.aqua.operators.primitive_ops.PauliOp.log_i" name="log_i" signature="log_i(massive=False)">
  ...
  <Function id="qiskit.aqua.operators.primitive_ops.PauliOp.mul" name="mul" signature="mul(scalar)">
  ...
  <Function id="qiskit.aqua.operators.primitive_ops.PauliOp.neg" name="neg" signature="neg()">
  ...
  <Function id="qiskit.aqua.operators.primitive_ops.PauliOp.num_qubits" name="num_qubits" signature="property num_qubits">
  ...
  <Function id="qiskit.aqua.operators.primitive_ops.PauliOp.parameters" name="parameters" signature="property parameters">
    Return a set of Parameter objects contained in the Operator.
  </Function>

  ### permute

  <Function id="qiskit.aqua.operators.primitive_ops.PauliOp.permute" name="permute" signature="permute(permutation)">
  ...
  <Function id="qiskit.aqua.operators.primitive_ops.PauliOp.power" name="power" signature="power(exponent)">
  ...
  <Function id="qiskit.aqua.operators.primitive_ops.PauliOp.primitive" name="primitive" signature="property primitive">
  ...
  <Function id="qiskit.aqua.operators.primitive_ops.PauliOp.primitive_strings" name="primitive_strings" signature="primitive_strings()">
  ...
  <Function id="qiskit.aqua.operators.primitive_ops.PauliOp.reduce" name="reduce" signature="reduce()">
  ...
  <Function id="qiskit.aqua.operators.primitive_ops.PauliOp.tensor" name="tensor" signature="tensor(other)">
  ...
  <Function id="qiskit.aqua.operators.primitive_ops.PauliOp.tensorpower" name="tensorpower" signature="tensorpower(other)">
  ...
  <Function id="qiskit.aqua.operators.primitive_ops.PauliOp.to_circuit" name="to_circuit" signature="to_circuit()">
  ...
  <Function id="qiskit.aqua.operators.primitive_ops.PauliOp.to_circuit_op" name="to_circuit_op" signature="to_circuit_op()">
  ...
  <Function id="qiskit.aqua.operators.primitive_ops.PauliOp.to_instruction" name="to_instruction" signature="to_instruction()">
  ...
  <Function id="qiskit.aqua.operators.primitive_ops.PauliOp.to_legacy_op" name="to_legacy_op" signature="to_legacy_op(massive=False)">
  ...
  <Function id="qiskit.aqua.operators.primitive_ops.PauliOp.to_matrix" name="to_matrix" signature="to_matrix(massive=False)">
  ...
  <Function id="qiskit.aqua.operators.primitive_ops.PauliOp.to_matrix_op" name="to_matrix_op" signature="to_matrix_op(massive=False)">
  ...
  <Function id="qiskit.aqua.operators.primitive_ops.PauliOp.to_pauli_op" name="to_pauli_op" signature="to_pauli_op(massive=False)">
  ...
  <Function id="qiskit.aqua.operators.primitive_ops.PauliOp.to_spmatrix" name="to_spmatrix" signature="to_spmatrix()">
