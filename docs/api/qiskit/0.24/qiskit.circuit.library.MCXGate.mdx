...
<Class id="qiskit.circuit.library.MCXGate" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.16/qiskit/circuit/library/standard_gates/x.py" signature="MCXGate(num_ctrl_qubits=None, label=None, ctrl_state=None)">
  ...
  <Function id="qiskit.circuit.library.MCXGate.ctrl_state" signature="property ctrl_state">
  ...
  <Function id="qiskit.circuit.library.MCXGate.decompositions" signature="property decompositions">
    Get the decompositions of the instruction from the SessionEquivalenceLibrary.
  </Function>

  ### definition

  <Function id="qiskit.circuit.library.MCXGate.definition" signature="property definition">
  ...
  <Function id="qiskit.circuit.library.MCXGate.duration" signature="property duration">
    Get the duration.
  </Function>

  ### get\_num\_ancilla\_qubits

  <Function id="qiskit.circuit.library.MCXGate.get_num_ancilla_qubits" signature="static get_num_ancilla_qubits(num_ctrl_qubits, mode='noancilla')">
  ...
  <Function id="qiskit.circuit.library.MCXGate.label" signature="property label">
    Return gate label
  ...
  <Function id="qiskit.circuit.library.MCXGate.num_ancilla_qubits" signature="property num_ancilla_qubits">
    The number of ancilla qubits.
  </Function>

  ### num\_ctrl\_qubits

  <Function id="qiskit.circuit.library.MCXGate.num_ctrl_qubits" signature="property num_ctrl_qubits">
  ...
  <Function id="qiskit.circuit.library.MCXGate.params" signature="property params">
  ...
  <Function id="qiskit.circuit.library.MCXGate.unit" signature="property unit">
