...
<Class id="qiskit.chemistry.FermionicOperator" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.8/qiskit/chemistry/fermionic_operator.py" signature="FermionicOperator(h1, h2=None, ph_trans_shift=None)">
  ...
  *   **ph\_trans\_shift** (*float*) – energy shift caused by particle hole transformation
  ...
  <Function id="qiskit.chemistry.FermionicOperator.__init__" name="__init__" signature="__init__(h1, h2=None, ph_trans_shift=None)">
    This class requires the integrals stored in the ‘*chemist*’ notation
  ...
  <Function id="qiskit.chemistry.FermionicOperator.fermion_mode_elimination" name="fermion_mode_elimination" signature="fermion_mode_elimination(fermion_mode_array)">
    Eliminate modes.
  ...
  <Function id="qiskit.chemistry.FermionicOperator.fermion_mode_freezing" name="fermion_mode_freezing" signature="fermion_mode_freezing(fermion_mode_array)">
  ...
  <Function id="qiskit.chemistry.FermionicOperator.h1" name="h1" signature="property h1">
    Getter of one body integral tensor.
  </Function>

  ### h2

  <Function id="qiskit.chemistry.FermionicOperator.h2" name="h2" signature="property h2">
    Getter of two body integral tensor.
  </Function>

  ### mapping

  <Function id="qiskit.chemistry.FermionicOperator.mapping" name="mapping" signature="mapping(map_type, threshold=1e-08)">
  ...
  <Function id="qiskit.chemistry.FermionicOperator.modes" name="modes" signature="property modes">
    Getter of modes.
  </Function>

  ### particle\_hole\_transformation

  <Function id="qiskit.chemistry.FermionicOperator.particle_hole_transformation" name="particle_hole_transformation" signature="particle_hole_transformation(num_particles)">
  ...
  <Function id="qiskit.chemistry.FermionicOperator.total_angular_momentum" name="total_angular_momentum" signature="total_angular_momentum()">
  ...
  <Function id="qiskit.chemistry.FermionicOperator.total_magnetization" name="total_magnetization" signature="total_magnetization()">
  ...
  <Function id="qiskit.chemistry.FermionicOperator.total_particle_number" name="total_particle_number" signature="total_particle_number()">
  ...
  <Function id="qiskit.chemistry.FermionicOperator.transform" name="transform" signature="transform(unitary_matrix)">
