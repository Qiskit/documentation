...
<Class id="qiskit.providers.aer.noise.NoiseModel" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-aer/tree/stable/0.7/qiskit/providers/aer/noise/noise_model.py" signature="NoiseModel(basis_gates=None)">
  ...
  **basis\_gates** (*list\[str] or None*) – Specify an initial basis\_gates for the noise model. If None a default value of \[‘id’, ‘u3’, ‘cx’] is used (Default: None).
  ...
  <Function id="qiskit.providers.aer.noise.NoiseModel.basis_gates" signature="property basis_gates">
    Return basis\_gates for compiling to the noise model.
  </Function>

  ### from\_backend

  <Function id="qiskit.providers.aer.noise.NoiseModel.from_backend" signature="classmethod from_backend(backend, gate_error=True, readout_error=True, thermal_relaxation=True, temperature=0, gate_lengths=None, gate_length_units='ns', standard_gates=True, warnings=True)">
  ...
  <Function id="qiskit.providers.aer.noise.NoiseModel.from_dict" signature="static from_dict(noise_dict)">
  ...
  <Function id="qiskit.providers.aer.noise.NoiseModel.noise_instructions" signature="property noise_instructions">
    Return the set of noisy instructions for this noise model.
  </Function>

  ### noise\_qubits

  <Function id="qiskit.providers.aer.noise.NoiseModel.noise_qubits" signature="property noise_qubits">
  ...
  <Function id="qiskit.providers.aer.noise.NoiseModel.set_x90_single_qubit_gates" signature="set_x90_single_qubit_gates(instructions)">
