...
<Class id="qiskit.aqua.components.oracles.Oracle" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.8/qiskit/aqua/components/oracles/oracle.py" signature="Oracle(*args, **kwargs)">
  ...
  *   **kwargs** (*dict*) – kwargs
  ...
  <Function id="qiskit.aqua.components.oracles.Oracle.__init__" signature="abstract __init__(*args, **kwargs)">
  ...
  <Function id="qiskit.aqua.components.oracles.Oracle.ancillary_register" signature="abstract property ancillary_register">
    returns ancillary register
  </Function>

  ### circuit

  <Function id="qiskit.aqua.components.oracles.Oracle.circuit" signature="property circuit" />

  ### construct\_circuit

  <Function id="qiskit.aqua.components.oracles.Oracle.construct_circuit" signature="abstract construct_circuit()">
  ...
  <Function id="qiskit.aqua.components.oracles.Oracle.output_register" signature="abstract property output_register">
    returns output register
  </Function>

  ### variable\_register

  <Function id="qiskit.aqua.components.oracles.Oracle.variable_register" signature="abstract property variable_register">
