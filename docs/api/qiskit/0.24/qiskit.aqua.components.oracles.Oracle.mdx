...
<Class id="qiskit.aqua.components.oracles.Oracle" github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.8/qiskit/aqua/components/oracles/oracle.py" signature="Oracle(*args, **kwargs)">
