...
<Class id="qiskit.aqua.algorithms.NumPyMinimumEigensolver" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.8/qiskit/aqua/algorithms/minimum_eigen_solvers/numpy_minimum_eigen_solver.py" signature="NumPyMinimumEigensolver(operator=None, aux_operators=None, filter_criterion=None)">
  ...
  *   **filter\_criterion** (`Optional`\[`Callable`\[\[`Union`\[`List`, `ndarray`], `float`, `Optional`\[`List`\[`float`]]], `bool`]]) – callable that allows to filter eigenvalues/eigenstates. The minimum eigensolver is only searching over feasible states and returns an eigenstate that has the smallest eigenvalue among feasible states. The callable has the signature filter(eigenstate, eigenvalue, aux\_values) and must return a boolean to indicate whether to consider this value or not. If there is no feasible element, the result can even be empty.
  ...
  <Function id="qiskit.aqua.algorithms.NumPyMinimumEigensolver.__init__" name="__init__" signature="__init__(operator=None, aux_operators=None, filter_criterion=None)">
    **Parameters**
  ...
  <Function id="qiskit.aqua.algorithms.NumPyMinimumEigensolver.aux_operators" name="aux_operators" signature="property aux_operators">
  ...
  <Function id="qiskit.aqua.algorithms.NumPyMinimumEigensolver.compute_minimum_eigenvalue" name="compute_minimum_eigenvalue" signature="compute_minimum_eigenvalue(operator=None, aux_operators=None)">
  ...
  <Function id="qiskit.aqua.algorithms.NumPyMinimumEigensolver.filter_criterion" name="filter_criterion" signature="property filter_criterion">
  ...
  <Function id="qiskit.aqua.algorithms.NumPyMinimumEigensolver.operator" name="operator" signature="property operator">
    Return the operator.
  ...
  <Function id="qiskit.aqua.algorithms.NumPyMinimumEigensolver.random" name="random" signature="property random">
    Return a numpy random.
  </Function>

  ### run

  <Function id="qiskit.aqua.algorithms.NumPyMinimumEigensolver.run" name="run" signature="run()">
  ...
  <Function id="qiskit.aqua.algorithms.NumPyMinimumEigensolver.supports_aux_operators" name="supports_aux_operators" signature="classmethod supports_aux_operators()">
