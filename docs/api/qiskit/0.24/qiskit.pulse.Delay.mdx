...
<Class id="qiskit.pulse.Delay" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.16/qiskit/pulse/instructions/delay.py" signature="Delay(duration, channel, name=None)">
  ...
  *   **name** (`Optional`\[`str`]) – Name of the delay for display purposes.
  ...
  <Function id="qiskit.pulse.Delay.command" name="command" signature="property command">
  ...
  <Function id="qiskit.pulse.Delay.timeslots" name="timeslots" signature="property timeslots">
