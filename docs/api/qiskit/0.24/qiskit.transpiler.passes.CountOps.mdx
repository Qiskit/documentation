...
<Class id="qiskit.transpiler.passes.CountOps" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.16/qiskit/transpiler/passes/analysis/count_ops.py" signature="CountOps(*args, **kwargs)">
