...
<Class id="qiskit.transpiler.passes.FullAncillaAllocation" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.16/qiskit/transpiler/passes/layout/full_ancilla_allocation.py" signature="FullAncillaAllocation(*args, **kwargs)">
  ...
  **coupling\_map** (*Coupling*) – directed graph representing a coupling map.
  ...
  <Function id="qiskit.transpiler.passes.FullAncillaAllocation.is_analysis_pass" signature="property is_analysis_pass">
  ...
  <Function id="qiskit.transpiler.passes.FullAncillaAllocation.is_transformation_pass" signature="property is_transformation_pass">
