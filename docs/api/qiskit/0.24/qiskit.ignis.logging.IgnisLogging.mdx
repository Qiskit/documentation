...
<Class id="qiskit.ignis.logging.IgnisLogging" github="https://github.com/qiskit-community/qiskit-ignis/tree/stable/0.5/qiskit/ignis/logging/ignis_logging.py" signature="IgnisLogging(log_config_path=None)">
