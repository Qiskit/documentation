...
<Class id="qiskit.aqua.operators.evolutions.TrotterizationFactory" github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.8/qiskit/aqua/operators/evolutions/trotterizations/trotterization_factory.py" signature="TrotterizationFactory">
