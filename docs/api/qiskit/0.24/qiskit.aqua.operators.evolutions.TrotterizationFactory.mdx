...
<Class id="qiskit.aqua.operators.evolutions.TrotterizationFactory" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.8/qiskit/aqua/operators/evolutions/trotterizations/trotterization_factory.py" signature="TrotterizationFactory">
  A factory for conveniently creating TrotterizationBase instances.

  ### \_\_init\_\_

  <Function id="qiskit.aqua.operators.evolutions.TrotterizationFactory.__init__" name="__init__" signature="__init__()">
  ...
  <Function id="qiskit.aqua.operators.evolutions.TrotterizationFactory.build" name="build" signature="static build(mode='trotter', reps=1)">
    A factory for conveniently creating TrotterizationBase instances.
