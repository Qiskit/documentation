...
<Class id="qiskit.providers.aer.AerJob" github="https://github.com/qiskit/qiskit-aer/tree/stable/0.7/qiskit/providers/aer/aerjob.py" signature="AerJob(backend, job_id, fn, qobj, *args)">
  AerJob class.
