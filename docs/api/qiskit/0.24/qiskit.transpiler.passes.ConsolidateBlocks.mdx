...
<Class id="qiskit.transpiler.passes.ConsolidateBlocks" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.16/qiskit/transpiler/passes/optimization/consolidate_blocks.py" signature="ConsolidateBlocks(*args, **kwargs)">
  ...
  *   **basis\_gates** (*List(str)*) – Basis gates from which to choose a KAK gate.
  ...
  <Function id="qiskit.transpiler.passes.ConsolidateBlocks.__init__" name="__init__" signature="__init__(kak_basis_gate=None, force_consolidate=False, basis_gates=None)">
    ConsolidateBlocks initializer.
  ...
  <Function id="qiskit.transpiler.passes.ConsolidateBlocks.is_analysis_pass" name="is_analysis_pass" signature="property is_analysis_pass">
  ...
  <Function id="qiskit.transpiler.passes.ConsolidateBlocks.is_transformation_pass" name="is_transformation_pass" signature="property is_transformation_pass">
