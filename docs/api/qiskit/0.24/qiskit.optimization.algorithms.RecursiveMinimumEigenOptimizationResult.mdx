---
title: RecursiveMinimumEigenOptimizationResult (v0.24)
description: API reference for qiskit.optimization.algorithms.RecursiveMinimumEigenOptimizationResult in qiskit v0.24
