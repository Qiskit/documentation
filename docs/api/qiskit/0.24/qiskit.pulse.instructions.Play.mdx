...
<Class id="qiskit.pulse.instructions.Play" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.16/qiskit/pulse/instructions/play.py" signature="Play(pulse, channel, name=None)">
  ...
  **Raises**
  ...
  <Function id="qiskit.pulse.instructions.Play.command" name="command" signature="property command">
  ...
  <Function id="qiskit.pulse.instructions.Play.timeslots" name="timeslots" signature="property timeslots">
