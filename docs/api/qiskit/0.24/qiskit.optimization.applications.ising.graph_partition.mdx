---
title: graph_partition (v0.24)
description: API reference for qiskit.optimization.applications.ising.graph_partition in qiskit v0.24
...
<Function id="qiskit.optimization.applications.ising.graph_partition.get_graph_solution" github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.8/qiskit/optimization/applications/ising/graph_partition.py" signature="get_graph_solution(x)">
...
<Function id="qiskit.optimization.applications.ising.graph_partition.get_operator" github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.8/qiskit/optimization/applications/ising/graph_partition.py" signature="get_operator(weight_matrix)">
...
<Function id="qiskit.optimization.applications.ising.graph_partition.objective_value" github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.8/qiskit/optimization/applications/ising/graph_partition.py" signature="objective_value(x, w)">
