...
<Class id="qiskit.aqua.components.multiclass_extensions.MulticlassExtension" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.8/qiskit/aqua/components/multiclass_extensions/multiclass_extension.py" signature="MulticlassExtension">
  ...
  <Function id="qiskit.aqua.components.multiclass_extensions.MulticlassExtension.__init__" name="__init__" signature="abstract __init__()">
  ...
  <Function id="qiskit.aqua.components.multiclass_extensions.MulticlassExtension.predict" name="predict" signature="abstract predict(x)">
  ...
  <Function id="qiskit.aqua.components.multiclass_extensions.MulticlassExtension.set_estimator" name="set_estimator" signature="set_estimator(estimator_cls, params=None)">
  ...
  <Function id="qiskit.aqua.components.multiclass_extensions.MulticlassExtension.test" name="test" signature="abstract test(x, y)">
  ...
  <Function id="qiskit.aqua.components.multiclass_extensions.MulticlassExtension.train" name="train" signature="abstract train(x, y)">
