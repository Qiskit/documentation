...
<Class id="qiskit.ignis.mitigation.CTMPExpvalMeasMitigator" github="https://github.com/qiskit-community/qiskit-ignis/tree/stable/0.5/qiskit/ignis/mitigation/expval/ctmp_mitigator.py" signature="CTMPExpvalMeasMitigator(generators, rates, num_qubits=None, seed=None)">
