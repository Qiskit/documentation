...
<Class id="qiskit.ignis.mitigation.CTMPExpvalMeasMitigator" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-ignis/tree/stable/0.5/qiskit/ignis/mitigation/expval/ctmp_mitigator.py" signature="CTMPExpvalMeasMitigator(generators, rates, num_qubits=None, seed=None)">
  ...
  <Function id="qiskit.ignis.mitigation.CTMPExpvalMeasMitigator.__init__" name="__init__" signature="__init__(generators, rates, num_qubits=None, seed=None)">
    Initialize a TensorMeasurementMitigator
  </Function>
  ...
  <Function id="qiskit.ignis.mitigation.CTMPExpvalMeasMitigator.assignment_fidelity" name="assignment_fidelity" signature="assignment_fidelity(qubits=None)">
  ...
  <Function id="qiskit.ignis.mitigation.CTMPExpvalMeasMitigator.assignment_matrix" name="assignment_matrix" signature="assignment_matrix(qubits=None)">
  ...
  <Function id="qiskit.ignis.mitigation.CTMPExpvalMeasMitigator.expectation_value" name="expectation_value" signature="expectation_value(counts, diagonal=None, qubits=None, clbits=None)">
  ...
  <Function id="qiskit.ignis.mitigation.CTMPExpvalMeasMitigator.generator_matrix" name="generator_matrix" signature="generator_matrix(qubits=None)">
  ...
  <Function id="qiskit.ignis.mitigation.CTMPExpvalMeasMitigator.mitigation_matrix" name="mitigation_matrix" signature="mitigation_matrix(qubits=None)">
  ...
  <Function id="qiskit.ignis.mitigation.CTMPExpvalMeasMitigator.mitigation_overhead" name="mitigation_overhead" signature="mitigation_overhead(qubits=None)">
  ...
  <Function id="qiskit.ignis.mitigation.CTMPExpvalMeasMitigator.noise_strength" name="noise_strength" signature="noise_strength(qubits=None)">
  ...
  <Function id="qiskit.ignis.mitigation.CTMPExpvalMeasMitigator.plot_assignment_matrix" name="plot_assignment_matrix" signature="plot_assignment_matrix(qubits=None, ax=None)">
  ...
  <Function id="qiskit.ignis.mitigation.CTMPExpvalMeasMitigator.plot_mitigation_matrix" name="plot_mitigation_matrix" signature="plot_mitigation_matrix(qubits=None, ax=None)">
  ...
  <Function id="qiskit.ignis.mitigation.CTMPExpvalMeasMitigator.required_shots" name="required_shots" signature="required_shots(delta, qubits=None)">
  ...
  <Function id="qiskit.ignis.mitigation.CTMPExpvalMeasMitigator.seed" name="seed" signature="seed(value=None)">
    Set the seed for the quantum state RNG.
  </Function>

  ### stddev\_upper\_bound

  <Function id="qiskit.ignis.mitigation.CTMPExpvalMeasMitigator.stddev_upper_bound" name="stddev_upper_bound" signature="stddev_upper_bound(shots=1, qubits=None)">
