...
<Class id="qiskit.aqua.algorithms.Eigensolver" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.8/qiskit/aqua/algorithms/eigen_solvers/eigen_solver.py" signature="Eigensolver">
  ...
  <Function id="qiskit.aqua.algorithms.Eigensolver.__init__" name="__init__" signature="__init__()">
