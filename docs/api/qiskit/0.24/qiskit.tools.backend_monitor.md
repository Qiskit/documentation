...
<span id="qiskit-tools-backend-monitor" />

# qiskit.tools.backend\_monitor

<span id="qiskit.tools.backend_monitor" />

`backend_monitor(backend)` [GitHub](https://github.com/qiskit/qiskit/tree/stable/0.16/qiskit/tools/monitor/overview.py "view source code")
