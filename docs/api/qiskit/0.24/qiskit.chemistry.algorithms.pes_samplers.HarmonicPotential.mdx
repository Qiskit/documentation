...
<Class id="qiskit.chemistry.algorithms.pes_samplers.HarmonicPotential" github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.8/qiskit/chemistry/algorithms/pes_samplers/potentials/harmonic_potential.py" signature="HarmonicPotential(molecule)">
