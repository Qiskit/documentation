...
<Class id="qiskit.chemistry.MP2Info" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.8/qiskit/chemistry/mp2info.py" signature="MP2Info(qmolecule, threshold=1e-12)">
  ...
  *   **threshold** (*float*) – Computed coefficients and energy deltas will be set to zero if their value is below this threshold
  ...
  <Function id="qiskit.chemistry.MP2Info.__init__" name="__init__" signature="__init__(qmolecule, threshold=1e-12)">
    A utility class for MP2 info
  ...
  <Function id="qiskit.chemistry.MP2Info.mp2_delta" name="mp2_delta" signature="property mp2_delta">
  ...
  <Function id="qiskit.chemistry.MP2Info.mp2_energy" name="mp2_energy" signature="property mp2_energy">
  ...
  <Function id="qiskit.chemistry.MP2Info.mp2_get_term_info" name="mp2_get_term_info" signature="mp2_get_term_info(excitation_list, freeze_core=False, orbital_reduction=None)">
  ...
  <Function id="qiskit.chemistry.MP2Info.mp2_terms" name="mp2_terms" signature="mp2_terms(freeze_core=False, orbital_reduction=None)">
