...
<Class id="qiskit.chemistry.MP2Info" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.8/qiskit/chemistry/mp2info.py" signature="MP2Info(qmolecule, threshold=1e-12)" modifiers="class">
  ...
  *   **threshold** (*float*) – Computed coefficients and energy deltas will be set to zero if their value is below this threshold
  ...
  <Function id="qiskit.chemistry.MP2Info.mp2_delta" signature="mp2_delta" modifiers="property">
  ...
  <Function id="qiskit.chemistry.MP2Info.mp2_energy" signature="mp2_energy" modifiers="property">
