...
<Class id="qiskit.pulse.ShiftFrequency" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.16/qiskit/pulse/instructions/frequency.py" signature="ShiftFrequency(frequency, channel, name=None)">
  ...
  *   **name** (`Optional`\[`str`]) – Name of this set channel frequency instruction.
  ...
  <Function id="qiskit.pulse.ShiftFrequency.channel" signature="property channel">
  ...
  <Function id="qiskit.pulse.ShiftFrequency.channels" signature="property channels">
  ...
  <Function id="qiskit.pulse.ShiftFrequency.command" signature="property command">
  ...
  <Function id="qiskit.pulse.ShiftFrequency.duration" signature="property duration">
  ...
  <Function id="qiskit.pulse.ShiftFrequency.frequency" signature="property frequency">
  ...
  <Function id="qiskit.pulse.ShiftFrequency.id" signature="property id">
  ...
  <Function id="qiskit.pulse.ShiftFrequency.instructions" signature="property instructions">
  ...
  <Function id="qiskit.pulse.ShiftFrequency.name" signature="property name">
  ...
  <Function id="qiskit.pulse.ShiftFrequency.operands" signature="property operands">
  ...
  <Function id="qiskit.pulse.ShiftFrequency.start_time" signature="property start_time">
  ...
  <Function id="qiskit.pulse.ShiftFrequency.stop_time" signature="property stop_time">
  ...
  <Function id="qiskit.pulse.ShiftFrequency.timeslots" signature="property timeslots">
