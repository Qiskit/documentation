...
<Class id="qiskit.circuit.Delay" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.16/qiskit/circuit/delay.py" signature="Delay(duration, unit='dt')">
  ...
  <Function id="qiskit.circuit.Delay.decompositions" signature="property decompositions">
    Get the decompositions of the instruction from the SessionEquivalenceLibrary.
  </Function>

  ### definition

  <Function id="qiskit.circuit.Delay.definition" signature="property definition">
    Return definition in terms of other basic gates.
  </Function>

  ### duration

  <Function id="qiskit.circuit.Delay.duration" signature="property duration">
  ...
  <Function id="qiskit.circuit.Delay.params" signature="property params">
  ...
  <Function id="qiskit.circuit.Delay.unit" signature="property unit">
