...
<Class id="qiskit.transpiler.passes.Width" github="https://github.com/qiskit/qiskit/tree/stable/0.16/qiskit/transpiler/passes/analysis/width.py" signature="Width(*args, **kwargs)">
