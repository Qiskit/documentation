...
<Class id="qiskit.transpiler.passes.Width" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.16/qiskit/transpiler/passes/analysis/width.py" signature="Width(*args, **kwargs)" modifiers="class">
  ...
  <Function id="qiskit.transpiler.passes.Width.is_analysis_pass" signature="is_analysis_pass" modifiers="property">
  ...
  <Function id="qiskit.transpiler.passes.Width.is_transformation_pass" signature="is_transformation_pass" modifiers="property">
