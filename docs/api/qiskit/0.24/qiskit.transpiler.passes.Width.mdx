...
<Class id="qiskit.transpiler.passes.Width" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.16/qiskit/transpiler/passes/analysis/width.py" signature="Width(*args, **kwargs)">
  ...
  <Function id="qiskit.transpiler.passes.Width.is_analysis_pass" signature="property is_analysis_pass">
  ...
  <Function id="qiskit.transpiler.passes.Width.is_transformation_pass" signature="property is_transformation_pass">
