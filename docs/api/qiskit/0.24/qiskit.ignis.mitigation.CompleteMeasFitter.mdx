...
<Class id="qiskit.ignis.mitigation.CompleteMeasFitter" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-ignis/tree/stable/0.5/qiskit/ignis/mitigation/measurement/fitters.py" signature="CompleteMeasFitter(results, state_labels, qubit_list=None, circlabel='')" modifiers="class">
  ...
  *   **circlabel** (`str`) – if the qubits were labeled.
  ...
  <Function id="qiskit.ignis.mitigation.CompleteMeasFitter.cal_matrix" signature="cal_matrix" modifiers="property">
    Return cal\_matrix.
  </Function>

  ### filter

  <Function id="qiskit.ignis.mitigation.CompleteMeasFitter.filter" signature="filter" modifiers="property">
  ...
  <Function id="qiskit.ignis.mitigation.CompleteMeasFitter.qubit_list" signature="qubit_list" modifiers="property">
  ...
  <Function id="qiskit.ignis.mitigation.CompleteMeasFitter.state_labels" signature="state_labels" modifiers="property">
