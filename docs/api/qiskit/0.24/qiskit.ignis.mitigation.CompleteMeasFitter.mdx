...
<Class id="qiskit.ignis.mitigation.CompleteMeasFitter" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-ignis/tree/stable/0.5/qiskit/ignis/mitigation/measurement/fitters.py" signature="CompleteMeasFitter(results, state_labels, qubit_list=None, circlabel='')">
  ...
  *   **circlabel** (`str`) – if the qubits were labeled.
  ...
  <Function id="qiskit.ignis.mitigation.CompleteMeasFitter.__init__" name="__init__" signature="__init__(results, state_labels, qubit_list=None, circlabel='')">
    Initialize a measurement calibration matrix from the results of running the circuits returned by measurement\_calibration\_circuits
  ...
  <Function id="qiskit.ignis.mitigation.CompleteMeasFitter.add_data" name="add_data" signature="add_data(new_results, rebuild_cal_matrix=True)">
  ...
  <Function id="qiskit.ignis.mitigation.CompleteMeasFitter.cal_matrix" name="cal_matrix" signature="property cal_matrix">
    Return cal\_matrix.
  </Function>

  ### filter

  <Function id="qiskit.ignis.mitigation.CompleteMeasFitter.filter" name="filter" signature="property filter">
    Return a measurement filter using the cal matrix.
  </Function>

  ### plot\_calibration

  <Function id="qiskit.ignis.mitigation.CompleteMeasFitter.plot_calibration" name="plot_calibration" signature="plot_calibration(ax=None, show_plot=True)">
  ...
  <Function id="qiskit.ignis.mitigation.CompleteMeasFitter.qubit_list" name="qubit_list" signature="property qubit_list">
    Return list of qubits.
  </Function>

  ### readout\_fidelity

  <Function id="qiskit.ignis.mitigation.CompleteMeasFitter.readout_fidelity" name="readout_fidelity" signature="readout_fidelity(label_list=None)">
  ...
  <Function id="qiskit.ignis.mitigation.CompleteMeasFitter.state_labels" name="state_labels" signature="property state_labels">
    Return state\_labels.
  </Function>

  ### subset\_fitter

  <Function id="qiskit.ignis.mitigation.CompleteMeasFitter.subset_fitter" name="subset_fitter" signature="subset_fitter(qubit_sublist=None)">
