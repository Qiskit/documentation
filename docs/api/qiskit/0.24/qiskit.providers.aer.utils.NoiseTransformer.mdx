...
<Class id="qiskit.providers.aer.utils.NoiseTransformer" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-aer/tree/stable/0.7/qiskit/providers/aer/utils/noise_transformation.py" signature="NoiseTransformer">
  Transforms one quantum channel to another based on a specified criteria.

  ### \_\_init\_\_

  <Function id="qiskit.providers.aer.utils.NoiseTransformer.__init__" name="__init__" signature="__init__()">
  ...
  <Function id="qiskit.providers.aer.utils.NoiseTransformer.channel_matrix_representation" name="channel_matrix_representation" signature="channel_matrix_representation(operators)">
  ...
  <Function id="qiskit.providers.aer.utils.NoiseTransformer.compute_P" name="compute_P" signature="compute_P(As)">
  ...
  <Function id="qiskit.providers.aer.utils.NoiseTransformer.compute_channel_operation" name="compute_channel_operation" signature="static compute_channel_operation(rho, operators)">
  ...
  <Function id="qiskit.providers.aer.utils.NoiseTransformer.compute_q" name="compute_q" signature="compute_q(As, C)">
  ...
  <Function id="qiskit.providers.aer.utils.NoiseTransformer.fidelity" name="fidelity" signature="static fidelity(channel)">
    Calculates channel fidelity
  </Function>

  ### flatten\_matrix

  <Function id="qiskit.providers.aer.utils.NoiseTransformer.flatten_matrix" name="flatten_matrix" signature="static flatten_matrix(m)">
    **Parameters**
  ...
  <Function id="qiskit.providers.aer.utils.NoiseTransformer.generate_channel_matrices" name="generate_channel_matrices" signature="generate_channel_matrices(transform_channel_operators_list)">
  ...
  <Function id="qiskit.providers.aer.utils.NoiseTransformer.generate_channel_quadratic_programming_matrices" name="generate_channel_quadratic_programming_matrices" signature="generate_channel_quadratic_programming_matrices(channel, symbols)">
  ...
  <Function id="qiskit.providers.aer.utils.NoiseTransformer.get_const_matrix_from_channel" name="get_const_matrix_from_channel" signature="static get_const_matrix_from_channel(channel, symbols)">
  ...
  <Function id="qiskit.providers.aer.utils.NoiseTransformer.get_matrix_from_channel" name="get_matrix_from_channel" signature="static get_matrix_from_channel(channel, symbol)">
  ...
  <Function id="qiskit.providers.aer.utils.NoiseTransformer.operator_circuit" name="operator_circuit" signature="operator_circuit(operator)">
  ...
  <Function id="qiskit.providers.aer.utils.NoiseTransformer.operator_matrix" name="operator_matrix" signature="operator_matrix(operator)">
  ...
  <Function id="qiskit.providers.aer.utils.NoiseTransformer.prepare_channel_operator_list" name="prepare_channel_operator_list" signature="static prepare_channel_operator_list(ops_list)">
  ...
  <Function id="qiskit.providers.aer.utils.NoiseTransformer.prepare_honesty_constraint" name="prepare_honesty_constraint" signature="prepare_honesty_constraint(transform_channel_operators_list)">
  ...
  <Function id="qiskit.providers.aer.utils.NoiseTransformer.solve_quadratic_program" name="solve_quadratic_program" signature="solve_quadratic_program(P, q)">
  ...
  <Function id="qiskit.providers.aer.utils.NoiseTransformer.transform_by_given_channel" name="transform_by_given_channel" signature="transform_by_given_channel(channel_matrices, const_channel_matrix)">
  ...
  <Function id="qiskit.providers.aer.utils.NoiseTransformer.transform_by_operator_list" name="transform_by_operator_list" signature="transform_by_operator_list(transform_channel_operators, noise_kraus_operators)">
