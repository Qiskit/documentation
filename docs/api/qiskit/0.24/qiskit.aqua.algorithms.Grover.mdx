...
$$
  ...
  **\[1]: Boyer et al., Tight bounds on quantum searching**
  ...
  <Function id="qiskit.aqua.algorithms.Grover.backend" signature="backend" modifiers="property">
    Returns backend.
  ...
  <Function id="qiskit.aqua.algorithms.Grover.grover_operator" signature="grover_operator" modifiers="property">
  ...
  <Function id="qiskit.aqua.algorithms.Grover.quantum_instance" signature="quantum_instance" modifiers="property">
  ...
  <Function id="qiskit.aqua.algorithms.Grover.random" signature="random" modifiers="property">
