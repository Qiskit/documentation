...
$$
  ...
  **\[1]: Boyer et al., Tight bounds on quantum searching**
  ...
  <Function id="qiskit.aqua.algorithms.Grover.__init__" name="__init__" signature="__init__(oracle, good_state=None, state_preparation=None, iterations=1, sample_from_iterations=False, post_processing=None, grover_operator=None, quantum_instance=None, init_state=None, incremental=False, num_iterations=None, lam=None, rotation_counts=None, mct_mode=None)">
    **Parameters**
  ...
  <Function id="qiskit.aqua.algorithms.Grover.backend" name="backend" signature="property backend">
    Returns backend.
  ...
  <Function id="qiskit.aqua.algorithms.Grover.construct_circuit" name="construct_circuit" signature="construct_circuit(power=None, measurement=False)">
  ...
  <Function id="qiskit.aqua.algorithms.Grover.grover_operator" name="grover_operator" signature="property grover_operator">
  ...
  <Function id="qiskit.aqua.algorithms.Grover.is_good_state" name="is_good_state" signature="is_good_state(bitstr)">
  ...
  <Function id="qiskit.aqua.algorithms.Grover.optimal_num_iterations" name="optimal_num_iterations" signature="static optimal_num_iterations(num_solutions, num_qubits)">
  ...
  <Function id="qiskit.aqua.algorithms.Grover.post_processing" name="post_processing" signature="post_processing(measurement)">
  ...
  <Function id="qiskit.aqua.algorithms.Grover.quantum_instance" name="quantum_instance" signature="property quantum_instance">
  ...
  <Function id="qiskit.aqua.algorithms.Grover.random" name="random" signature="property random">
    Return a numpy random.
  </Function>

  ### run

  <Function id="qiskit.aqua.algorithms.Grover.run" name="run" signature="run(quantum_instance=None, **kwargs)">
  ...
  <Function id="qiskit.aqua.algorithms.Grover.set_backend" name="set_backend" signature="set_backend(backend, **kwargs)">
