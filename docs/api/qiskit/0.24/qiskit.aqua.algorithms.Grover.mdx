...
$$
  ...
  **\[1]: Boyer et al., Tight bounds on quantum searching**
  ...
  <Function id="qiskit.aqua.algorithms.Grover.backend" signature="property backend">
    Returns backend.
  ...
  <Function id="qiskit.aqua.algorithms.Grover.grover_operator" signature="property grover_operator">
  ...
  <Function id="qiskit.aqua.algorithms.Grover.optimal_num_iterations" signature="static optimal_num_iterations(num_solutions, num_qubits)">
  ...
  <Function id="qiskit.aqua.algorithms.Grover.quantum_instance" signature="property quantum_instance">
  ...
  <Function id="qiskit.aqua.algorithms.Grover.random" signature="property random">
