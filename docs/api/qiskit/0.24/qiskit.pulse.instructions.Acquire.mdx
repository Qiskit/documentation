...
<Class id="qiskit.pulse.instructions.Acquire" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.16/qiskit/pulse/instructions/acquire.py" signature="Acquire(duration, channel, mem_slot=None, reg_slot=None, kernel=None, discriminator=None, name=None)">
  ...
  **Raises**
  ...
  <Function id="qiskit.pulse.instructions.Acquire.acquires" name="acquires" signature="property acquires">
  ...
  <Function id="qiskit.pulse.instructions.Acquire.command" name="command" signature="property command">
  ...
  <Function id="qiskit.pulse.instructions.Acquire.mem_slots" name="mem_slots" signature="property mem_slots">
    MemorySlots.
  ...
  <Function id="qiskit.pulse.instructions.Acquire.reg_slots" name="reg_slots" signature="property reg_slots">
    RegisterSlots.
  ...
  <Function id="qiskit.pulse.instructions.Acquire.timeslots" name="timeslots" signature="property timeslots">
