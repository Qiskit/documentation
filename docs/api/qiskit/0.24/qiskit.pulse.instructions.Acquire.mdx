...
<Class id="qiskit.pulse.instructions.Acquire" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.16/qiskit/pulse/instructions/acquire.py" signature="Acquire(duration, channel, mem_slot=None, reg_slot=None, kernel=None, discriminator=None, name=None)">
  ...
  **Raises**
  ...
  <Function id="qiskit.pulse.instructions.Acquire.acquire" signature="property acquire">
  ...
  <Function id="qiskit.pulse.instructions.Acquire.acquires" signature="property acquires">
  ...
  <Function id="qiskit.pulse.instructions.Acquire.channel" signature="property channel">
  ...
  <Function id="qiskit.pulse.instructions.Acquire.channels" signature="property channels">
  ...
  <Function id="qiskit.pulse.instructions.Acquire.command" signature="property command">
  ...
  <Function id="qiskit.pulse.instructions.Acquire.discriminator" signature="property discriminator">
  ...
  <Function id="qiskit.pulse.instructions.Acquire.duration" signature="property duration">
  ...
  <Function id="qiskit.pulse.instructions.Acquire.id" signature="property id">
  ...
  <Function id="qiskit.pulse.instructions.Acquire.instructions" signature="property instructions">
  ...
  <Function id="qiskit.pulse.instructions.Acquire.kernel" signature="property kernel">
  ...
  <Function id="qiskit.pulse.instructions.Acquire.mem_slot" signature="property mem_slot">
  ...
  <Function id="qiskit.pulse.instructions.Acquire.mem_slots" signature="property mem_slots">
    MemorySlots.
  ...
  <Function id="qiskit.pulse.instructions.Acquire.name" signature="property name">
  ...
  <Function id="qiskit.pulse.instructions.Acquire.operands" signature="property operands">
  ...
  <Function id="qiskit.pulse.instructions.Acquire.reg_slot" signature="property reg_slot">
  ...
  <Function id="qiskit.pulse.instructions.Acquire.reg_slots" signature="property reg_slots">
    RegisterSlots.
  ...
  <Function id="qiskit.pulse.instructions.Acquire.start_time" signature="property start_time">
  ...
  <Function id="qiskit.pulse.instructions.Acquire.stop_time" signature="property stop_time">
  ...
  <Function id="qiskit.pulse.instructions.Acquire.timeslots" signature="property timeslots">
