...
<Class id="qiskit.pulse.instructions.Acquire" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.16/qiskit/pulse/instructions/acquire.py" signature="Acquire(duration, channel, mem_slot=None, reg_slot=None, kernel=None, discriminator=None, name=None)" modifiers="class">
  ...
  **Raises**
  ...
  <Function id="qiskit.pulse.instructions.Acquire.acquire" signature="acquire" modifiers="property">
  ...
  <Function id="qiskit.pulse.instructions.Acquire.acquires" signature="acquires" modifiers="property">
  ...
  <Function id="qiskit.pulse.instructions.Acquire.channel" signature="channel" modifiers="property">
  ...
  <Function id="qiskit.pulse.instructions.Acquire.channels" signature="channels" modifiers="property">
  ...
  <Function id="qiskit.pulse.instructions.Acquire.command" signature="command" modifiers="property">
  ...
  <Function id="qiskit.pulse.instructions.Acquire.discriminator" signature="discriminator" modifiers="property">
  ...
  <Function id="qiskit.pulse.instructions.Acquire.duration" signature="duration" modifiers="property">
  ...
  <Function id="qiskit.pulse.instructions.Acquire.id" signature="id" modifiers="property">
  ...
  <Function id="qiskit.pulse.instructions.Acquire.instructions" signature="instructions" modifiers="property">
  ...
  <Function id="qiskit.pulse.instructions.Acquire.kernel" signature="kernel" modifiers="property">
  ...
  <Function id="qiskit.pulse.instructions.Acquire.mem_slot" signature="mem_slot" modifiers="property">
  ...
  <Function id="qiskit.pulse.instructions.Acquire.mem_slots" signature="mem_slots" modifiers="property">
    MemorySlots.
  ...
  <Function id="qiskit.pulse.instructions.Acquire.name" signature="name" modifiers="property">
  ...
  <Function id="qiskit.pulse.instructions.Acquire.operands" signature="operands" modifiers="property">
  ...
  <Function id="qiskit.pulse.instructions.Acquire.reg_slot" signature="reg_slot" modifiers="property">
  ...
  <Function id="qiskit.pulse.instructions.Acquire.reg_slots" signature="reg_slots" modifiers="property">
    RegisterSlots.
  ...
  <Function id="qiskit.pulse.instructions.Acquire.start_time" signature="start_time" modifiers="property">
  ...
  <Function id="qiskit.pulse.instructions.Acquire.stop_time" signature="stop_time" modifiers="property">
  ...
  <Function id="qiskit.pulse.instructions.Acquire.timeslots" signature="timeslots" modifiers="property">
