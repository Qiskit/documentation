...
<Class id="qiskit.aqua.algorithms.EigensolverResult" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.8/qiskit/aqua/algorithms/eigen_solvers/eigen_solver.py" signature="EigensolverResult(a_dict=None)">
  Eigensolver Result.

  ### \_\_init\_\_

  <Function id="qiskit.aqua.algorithms.EigensolverResult.__init__" name="__init__" signature="__init__(a_dict=None)">
  ...
  <Function id="qiskit.aqua.algorithms.EigensolverResult.aux_operator_eigenvalues" name="aux_operator_eigenvalues" signature="property aux_operator_eigenvalues">
  ...
  <Function id="qiskit.aqua.algorithms.EigensolverResult.clear" name="clear" signature="clear()">
    **Return type**
  ...
  <Function id="qiskit.aqua.algorithms.EigensolverResult.combine" name="combine" signature="combine(result)">
  ...
  <Function id="qiskit.aqua.algorithms.EigensolverResult.eigenstates" name="eigenstates" signature="property eigenstates">
    return eigen states
  ...
  <Function id="qiskit.aqua.algorithms.EigensolverResult.eigenvalues" name="eigenvalues" signature="property eigenvalues">
  ...
  <Function id="qiskit.aqua.algorithms.EigensolverResult.from_dict" name="from_dict" signature="static from_dict(a_dict)">
  ...
  <Function id="qiskit.aqua.algorithms.EigensolverResult.get" name="get" signature="get(k[, d]) → D[k] if k in D, else d. d defaults to None." />

  ### items

  <Function id="qiskit.aqua.algorithms.EigensolverResult.items" name="items" signature="items() → a set-like object providing a view on D’s items" />

  ### keys

  <Function id="qiskit.aqua.algorithms.EigensolverResult.keys" name="keys" signature="keys() → a set-like object providing a view on D’s keys" />

  ### pop

  <Function id="qiskit.aqua.algorithms.EigensolverResult.pop" name="pop" signature="pop(key, default=None)">
  ...
  <Function id="qiskit.aqua.algorithms.EigensolverResult.popitem" name="popitem" signature="popitem()">
  ...
  <Function id="qiskit.aqua.algorithms.EigensolverResult.setdefault" name="setdefault" signature="setdefault(k[, d]) → D.get(k,d), also set D[k]=d if k not in D" />

  ### update

  <Function id="qiskit.aqua.algorithms.EigensolverResult.update" name="update" signature="update(*args, **kwargs)">
  ...
  <Function id="qiskit.aqua.algorithms.EigensolverResult.values" name="values" signature="values() → an object providing a view on D’s values" />
</Class>
