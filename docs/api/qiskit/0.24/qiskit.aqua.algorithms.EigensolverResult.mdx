...
<Class id="qiskit.aqua.algorithms.EigensolverResult" github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.8/qiskit/aqua/algorithms/eigen_solvers/eigen_solver.py" signature="EigensolverResult(a_dict=None)">
  Eigensolver Result.
