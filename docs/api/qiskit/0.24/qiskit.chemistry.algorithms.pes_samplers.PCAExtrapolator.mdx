...
<Class id="qiskit.chemistry.algorithms.pes_samplers.PCAExtrapolator" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.8/qiskit/chemistry/algorithms/pes_samplers/extrapolator.py" signature="PCAExtrapolator(extrapolator=None, kernel=None, window=2)">
  ...
  **Raises**
  ...
  <Function id="qiskit.chemistry.algorithms.pes_samplers.PCAExtrapolator.__init__" name="__init__" signature="__init__(extrapolator=None, kernel=None, window=2)">
    Constructor.
  ...
  <Function id="qiskit.chemistry.algorithms.pes_samplers.PCAExtrapolator.extrapolate" name="extrapolate" signature="extrapolate(points, param_dict)">
  ...
  <Function id="qiskit.chemistry.algorithms.pes_samplers.PCAExtrapolator.factory" name="factory" signature="static factory(mode, **kwargs)">
