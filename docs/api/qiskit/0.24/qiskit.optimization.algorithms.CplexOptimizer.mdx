---
title: CplexOptimizer (v0.24)
description: API reference for qiskit.optimization.algorithms.CplexOptimizer in qiskit v0.24
...
<Class id="qiskit.optimization.algorithms.CplexOptimizer" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.8/qiskit/optimization/algorithms/cplex_optimizer.py" signature="CplexOptimizer(disp=False)" modifiers="class">
  ...
  **Raises**
  ...
  <Function id="qiskit.optimization.algorithms.CplexOptimizer.__init__" signature="__init__(disp=False)">
    Initializes the CplexOptimizer.
  ...
  <Function id="qiskit.optimization.algorithms.CplexOptimizer.get_compatibility_msg" signature="get_compatibility_msg(problem)">
  ...
  <Function id="qiskit.optimization.algorithms.CplexOptimizer.is_compatible" signature="is_compatible(problem)">
  ...
  <Function id="qiskit.optimization.algorithms.CplexOptimizer.is_cplex_installed" signature="is_cplex_installed()" modifiers="static">
    Returns True if cplex is installed
  </Function>

  ### solve

  <Function id="qiskit.optimization.algorithms.CplexOptimizer.solve" signature="solve(problem)">
