...
$$
  ...
  *   **name** (`Optional`\[`str`]) – Display name for this pulse envelope.
  ...
  <Function id="qiskit.pulse.library.Constant.amp" signature="property amp">
  ...
  <Function id="qiskit.pulse.library.Constant.id" signature="property id">
  ...
  <Function id="qiskit.pulse.library.Constant.parameters" signature="property parameters">
