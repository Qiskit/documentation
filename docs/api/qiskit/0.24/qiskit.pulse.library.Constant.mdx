...
<Class id="qiskit.pulse.library.Constant" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.16/qiskit/pulse/library/parametric_pulses.py" signature="Constant(duration, amp, name=None)" modifiers="class">
...
$$
  ...
  *   **name** (`Optional`\[`str`]) – Display name for this pulse envelope.
  ...
  <Function id="qiskit.pulse.library.Constant.__init__" signature="__init__(duration, amp, name=None)">
    Initialize the constant-valued pulse.
  ...
  <Function id="qiskit.pulse.library.Constant.amp" signature="amp" modifiers="property">
  ...
  <Function id="qiskit.pulse.library.Constant.assign_parameters" signature="assign_parameters(value_dict)">
  ...
  <Function id="qiskit.pulse.library.Constant.draw" signature="draw(dt=1, style=None, filename=None, interp_method=None, scale=1, interactive=False)">
    Plot the pulse.
  ...
  <Function id="qiskit.pulse.library.Constant.get_sample_pulse" signature="get_sample_pulse()">
    Deprecated.
  ...
  <Function id="qiskit.pulse.library.Constant.get_waveform" signature="get_waveform()">
  ...
  <Function id="qiskit.pulse.library.Constant.id" signature="id" modifiers="property">
  ...
  <Function id="qiskit.pulse.library.Constant.parameters" signature="parameters" modifiers="property">
  ...
  <Function id="qiskit.pulse.library.Constant.validate_parameters" signature="validate_parameters()">
    Validate parameters.
