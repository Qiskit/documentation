...
<Class id="qiskit.pulse.library.Constant" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.16/qiskit/pulse/library/parametric_pulses.py" signature="Constant(duration, amp, name=None)">
...
$$
  ...
  *   **name** (`Optional`\[`str`]) – Display name for this pulse envelope.
  ...
  <Function id="qiskit.pulse.library.Constant.__init__" name="__init__" signature="__init__(duration, amp, name=None)">
    Initialize the constant-valued pulse.
  ...
  <Function id="qiskit.pulse.library.Constant.amp" name="amp" signature="property amp">
  ...
  <Function id="qiskit.pulse.library.Constant.assign_parameters" name="assign_parameters" signature="assign_parameters(value_dict)">
  ...
  <Function id="qiskit.pulse.library.Constant.draw" name="draw" signature="draw(dt=1, style=None, filename=None, interp_method=None, scale=1, interactive=False)">
    Plot the pulse.
  ...
  <Function id="qiskit.pulse.library.Constant.get_sample_pulse" name="get_sample_pulse" signature="get_sample_pulse()">
    Deprecated.
  ...
  <Function id="qiskit.pulse.library.Constant.get_waveform" name="get_waveform" signature="get_waveform()">
  ...
  <Function id="qiskit.pulse.library.Constant.id" name="id" signature="property id">
  ...
  <Function id="qiskit.pulse.library.Constant.parameters" name="parameters" signature="property parameters">
  ...
  <Function id="qiskit.pulse.library.Constant.validate_parameters" name="validate_parameters" signature="validate_parameters()">
    Validate parameters.
