...
<Class id="qiskit.ignis.verification.AccreditationCircuits" github="https://github.com/qiskit-community/qiskit-ignis/tree/stable/0.5/qiskit/ignis/verification/accreditation/circuits.py" signature="AccreditationCircuits(target_circ, two_qubit_gate='cx', coupling_map=None, seed=None)">
