...
<Class id="qiskit.pulse.Acquire" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.16/qiskit/pulse/instructions/acquire.py" signature="Acquire(duration, channel, mem_slot=None, reg_slot=None, kernel=None, discriminator=None, name=None)">
  ...
  **Raises**
  ...
  <Function id="qiskit.pulse.Acquire.__init__" name="__init__" signature="__init__(duration, channel, mem_slot=None, reg_slot=None, kernel=None, discriminator=None, name=None)">
    Create a new Acquire instruction.
  ...
  <Function id="qiskit.pulse.Acquire.acquire" name="acquire" signature="property acquire">
  ...
  <Function id="qiskit.pulse.Acquire.acquires" name="acquires" signature="property acquires">
  ...
  <Function id="qiskit.pulse.Acquire.append" name="append" signature="append(schedule, name=None)">
  ...
  <Function id="qiskit.pulse.Acquire.assign_parameters" name="assign_parameters" signature="assign_parameters(value_dict)">
  ...
  <Function id="qiskit.pulse.Acquire.ch_duration" name="ch_duration" signature="ch_duration(*channels)">
  ...
  <Function id="qiskit.pulse.Acquire.ch_start_time" name="ch_start_time" signature="ch_start_time(*channels)">
  ...
  <Function id="qiskit.pulse.Acquire.ch_stop_time" name="ch_stop_time" signature="ch_stop_time(*channels)">
  ...
  <Function id="qiskit.pulse.Acquire.channel" name="channel" signature="property channel">
  ...
  <Function id="qiskit.pulse.Acquire.channels" name="channels" signature="property channels">
  ...
  <Function id="qiskit.pulse.Acquire.command" name="command" signature="property command">
  ...
  <Function id="qiskit.pulse.Acquire.discriminator" name="discriminator" signature="property discriminator">
  ...
  <Function id="qiskit.pulse.Acquire.draw" name="draw" signature="draw(dt=1, style=None, filename=None, interp_method=None, scale=1, plot_all=False, plot_range=None, interactive=False, table=True, label=False, framechange=True, channels=None)">
  ...
  <Function id="qiskit.pulse.Acquire.duration" name="duration" signature="property duration">
  ...
  <Function id="qiskit.pulse.Acquire.flatten" name="flatten" signature="flatten()">
  ...
  <Function id="qiskit.pulse.Acquire.id" name="id" signature="property id">
  ...
  <Function id="qiskit.pulse.Acquire.insert" name="insert" signature="insert(start_time, schedule, name=None)">
  ...
  <Function id="qiskit.pulse.Acquire.instructions" name="instructions" signature="property instructions">
  ...
  <Function id="qiskit.pulse.Acquire.kernel" name="kernel" signature="property kernel">
  ...
  <Function id="qiskit.pulse.Acquire.mem_slot" name="mem_slot" signature="property mem_slot">
  ...
  <Function id="qiskit.pulse.Acquire.mem_slots" name="mem_slots" signature="property mem_slots">
    MemorySlots.
  ...
  <Function id="qiskit.pulse.Acquire.name" name="name" signature="property name">
  ...
  <Function id="qiskit.pulse.Acquire.operands" name="operands" signature="property operands">
  ...
  <Function id="qiskit.pulse.Acquire.reg_slot" name="reg_slot" signature="property reg_slot">
  ...
  <Function id="qiskit.pulse.Acquire.reg_slots" name="reg_slots" signature="property reg_slots">
    RegisterSlots.
  ...
  <Function id="qiskit.pulse.Acquire.shift" name="shift" signature="shift(time, name=None)">
  ...
  <Function id="qiskit.pulse.Acquire.start_time" name="start_time" signature="property start_time">
  ...
  <Function id="qiskit.pulse.Acquire.stop_time" name="stop_time" signature="property stop_time">
  ...
  <Function id="qiskit.pulse.Acquire.timeslots" name="timeslots" signature="property timeslots">
