...
<Function id="qiskit.aqua.utils.get_subsystem_density_matrix" name="get_subsystem_density_matrix" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.8/qiskit/aqua/utils/subsystem.py" signature="get_subsystem_density_matrix(statevector, trace_systems)">
