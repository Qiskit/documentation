...
<Class id="qiskit.aqua.algorithms.HHLResult" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.8/qiskit/aqua/algorithms/linear_solvers/hhl.py" signature="HHLResult(a_dict=None)">
  HHL Result.
  ...
  <Function id="qiskit.aqua.algorithms.HHLResult.circuit_info" signature="property circuit_info">
    return circuit info
  ...
  <Function id="qiskit.aqua.algorithms.HHLResult.from_dict" signature="static from_dict(a_dict)">
  ...
  <Function id="qiskit.aqua.algorithms.HHLResult.matrix" signature="property matrix">
    return matrix
  ...
  <Function id="qiskit.aqua.algorithms.HHLResult.output" signature="property output">
    return output
  ...
  <Function id="qiskit.aqua.algorithms.HHLResult.probability_result" signature="property probability_result">
  ...
  <Function id="qiskit.aqua.algorithms.HHLResult.solution" signature="property solution">
    return solution
  ...
  <Function id="qiskit.aqua.algorithms.HHLResult.vector" signature="property vector">
    return vector
