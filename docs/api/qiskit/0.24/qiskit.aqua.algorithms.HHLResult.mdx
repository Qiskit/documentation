...
<Class id="qiskit.aqua.algorithms.HHLResult" github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.8/qiskit/aqua/algorithms/linear_solvers/hhl.py" signature="HHLResult(a_dict=None)">
  HHL Result.
