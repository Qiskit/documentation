...
<Class id="qiskit.pulse.instructions.Delay" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.16/qiskit/pulse/instructions/delay.py" signature="Delay(duration, channel, name=None)" modifiers="class">
  ...
  *   **name** (`Optional`\[`str`]) – Name of the delay for display purposes.
  ...
  <Function id="qiskit.pulse.instructions.Delay.command" signature="command" modifiers="property">
  ...
  <Function id="qiskit.pulse.instructions.Delay.timeslots" signature="timeslots" modifiers="property">
