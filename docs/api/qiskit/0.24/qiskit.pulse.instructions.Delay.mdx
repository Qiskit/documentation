...
<Class id="qiskit.pulse.instructions.Delay" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.16/qiskit/pulse/instructions/delay.py" signature="Delay(duration, channel, name=None)">
  ...
  *   **name** (`Optional`\[`str`]) – Name of the delay for display purposes.
  ...
  <Function id="qiskit.pulse.instructions.Delay.channel" signature="property channel">
  ...
  <Function id="qiskit.pulse.instructions.Delay.channels" signature="property channels">
  ...
  <Function id="qiskit.pulse.instructions.Delay.command" signature="property command">
  ...
  <Function id="qiskit.pulse.instructions.Delay.duration" signature="property duration">
  ...
  <Function id="qiskit.pulse.instructions.Delay.id" signature="property id">
  ...
  <Function id="qiskit.pulse.instructions.Delay.instructions" signature="property instructions">
  ...
  <Function id="qiskit.pulse.instructions.Delay.name" signature="property name">
  ...
  <Function id="qiskit.pulse.instructions.Delay.operands" signature="property operands">
  ...
  <Function id="qiskit.pulse.instructions.Delay.start_time" signature="property start_time">
  ...
  <Function id="qiskit.pulse.instructions.Delay.stop_time" signature="property stop_time">
  ...
  <Function id="qiskit.pulse.instructions.Delay.timeslots" signature="property timeslots">
