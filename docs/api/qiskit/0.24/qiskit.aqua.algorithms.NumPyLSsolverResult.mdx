...
<Class id="qiskit.aqua.algorithms.NumPyLSsolverResult" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.8/qiskit/aqua/algorithms/linear_solvers/numpy_ls_solver.py" signature="NumPyLSsolverResult(a_dict=None)" modifiers="class">
  ...
  <Function id="qiskit.aqua.algorithms.NumPyLSsolverResult.eigvals" signature="eigvals" modifiers="property">
    return eigvals
  ...
  <Function id="qiskit.aqua.algorithms.NumPyLSsolverResult.solution" signature="solution" modifiers="property">
    return solution
