...
<Class id="qiskit.aqua.algorithms.NumPyLSsolverResult" github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.8/qiskit/aqua/algorithms/linear_solvers/numpy_ls_solver.py" signature="NumPyLSsolverResult(a_dict=None)">
