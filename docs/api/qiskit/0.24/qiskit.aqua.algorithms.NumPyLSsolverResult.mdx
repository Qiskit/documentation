...
<Class id="qiskit.aqua.algorithms.NumPyLSsolverResult" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.8/qiskit/aqua/algorithms/linear_solvers/numpy_ls_solver.py" signature="NumPyLSsolverResult(a_dict=None)">
  ...
  <Function id="qiskit.aqua.algorithms.NumPyLSsolverResult.eigvals" signature="property eigvals">
    return eigvals
  ...
  <Function id="qiskit.aqua.algorithms.NumPyLSsolverResult.from_dict" signature="static from_dict(a_dict)">
  ...
  <Function id="qiskit.aqua.algorithms.NumPyLSsolverResult.solution" signature="property solution">
    return solution
