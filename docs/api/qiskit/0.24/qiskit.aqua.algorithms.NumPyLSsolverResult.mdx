...
<Class id="qiskit.aqua.algorithms.NumPyLSsolverResult" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.8/qiskit/aqua/algorithms/linear_solvers/numpy_ls_solver.py" signature="NumPyLSsolverResult(a_dict=None)">
  Numpy LinearSystem Result.

  ### \_\_init\_\_

  <Function id="qiskit.aqua.algorithms.NumPyLSsolverResult.__init__" name="__init__" signature="__init__(a_dict=None)">
  ...
  <Function id="qiskit.aqua.algorithms.NumPyLSsolverResult.clear" name="clear" signature="clear()">
    **Return type**
  ...
  <Function id="qiskit.aqua.algorithms.NumPyLSsolverResult.combine" name="combine" signature="combine(result)">
  ...
  <Function id="qiskit.aqua.algorithms.NumPyLSsolverResult.eigvals" name="eigvals" signature="property eigvals">
    return eigvals
  ...
  <Function id="qiskit.aqua.algorithms.NumPyLSsolverResult.from_dict" name="from_dict" signature="static from_dict(a_dict)">
  ...
  <Function id="qiskit.aqua.algorithms.NumPyLSsolverResult.get" name="get" signature="get(k[, d]) → D[k] if k in D, else d. d defaults to None." />

  ### items

  <Function id="qiskit.aqua.algorithms.NumPyLSsolverResult.items" name="items" signature="items() → a set-like object providing a view on D’s items" />

  ### keys

  <Function id="qiskit.aqua.algorithms.NumPyLSsolverResult.keys" name="keys" signature="keys() → a set-like object providing a view on D’s keys" />

  ### pop

  <Function id="qiskit.aqua.algorithms.NumPyLSsolverResult.pop" name="pop" signature="pop(key, default=None)">
  ...
  <Function id="qiskit.aqua.algorithms.NumPyLSsolverResult.popitem" name="popitem" signature="popitem()">
  ...
  <Function id="qiskit.aqua.algorithms.NumPyLSsolverResult.setdefault" name="setdefault" signature="setdefault(k[, d]) → D.get(k,d), also set D[k]=d if k not in D" />

  ### solution

  <Function id="qiskit.aqua.algorithms.NumPyLSsolverResult.solution" name="solution" signature="property solution">
    return solution
  ...
  <Function id="qiskit.aqua.algorithms.NumPyLSsolverResult.update" name="update" signature="update(*args, **kwargs)">
  ...
  <Function id="qiskit.aqua.algorithms.NumPyLSsolverResult.values" name="values" signature="values() → an object providing a view on D’s values" />
</Class>
