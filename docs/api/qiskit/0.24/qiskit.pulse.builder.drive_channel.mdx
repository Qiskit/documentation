...
<Function id="qiskit.pulse.builder.drive_channel" github="https://github.com/qiskit/qiskit/tree/stable/0.16/qiskit/pulse/builder.py" signature="drive_channel(qubit)">
