---
title: Counts (v0.24)
description: API reference for qiskit.result.Counts in qiskit v0.24
...
<Class id="qiskit.result.Counts" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.16/qiskit/result/counts.py" signature="Counts(data, time_taken=None, creg_sizes=None, memory_slots=None)" modifiers="class">
  ...
  *   **QiskitError** – If a dit string key is input with creg\_sizes and/or memory\_slots
  ...
  <Function id="qiskit.result.Counts.__init__" signature="__init__(data, time_taken=None, creg_sizes=None, memory_slots=None)">
    Build a counts object
  ...
  <Function id="qiskit.result.Counts.hex_outcomes" signature="hex_outcomes()">
  ...
  <Function id="qiskit.result.Counts.int_outcomes" signature="int_outcomes()">
  ...
  <Function id="qiskit.result.Counts.most_frequent" signature="most_frequent()">
  ...
  <Function id="qiskit.result.Counts.popitem" signature="popitem() → (k, v), remove and return some (key, value) pair as a">
