...
<Class id="qiskit.result.Counts" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.16/qiskit/result/counts.py" signature="Counts(data, time_taken=None, creg_sizes=None, memory_slots=None)">
  ...
  *   **QiskitError** – If a dit string key is input with creg\_sizes and/or memory\_slots
  ...
  <Function id="qiskit.result.Counts.__init__" name="__init__" signature="__init__(data, time_taken=None, creg_sizes=None, memory_slots=None)">
    Build a counts object
  ...
  <Function id="qiskit.result.Counts.popitem" name="popitem" signature="popitem() → (k, v), remove and return some (key, value) pair as a">
