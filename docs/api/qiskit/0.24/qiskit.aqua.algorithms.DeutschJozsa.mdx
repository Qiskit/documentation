...
<Class id="qiskit.aqua.algorithms.DeutschJozsa" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.8/qiskit/aqua/algorithms/education/deutsch_jozsa.py" signature="DeutschJozsa(oracle, quantum_instance=None)">
  ...
  *   **quantum\_instance** (`Union`\[`QuantumInstance`, `Backend`, `BaseBackend`, `None`]) – Quantum Instance or Backend
  ...
  <Function id="qiskit.aqua.algorithms.DeutschJozsa.__init__" name="__init__" signature="__init__(oracle, quantum_instance=None)">
    **Parameters**
  ...
  <Function id="qiskit.aqua.algorithms.DeutschJozsa.backend" name="backend" signature="property backend">
    Returns backend.
  ...
  <Function id="qiskit.aqua.algorithms.DeutschJozsa.construct_circuit" name="construct_circuit" signature="construct_circuit(measurement=False)">
  ...
  <Function id="qiskit.aqua.algorithms.DeutschJozsa.quantum_instance" name="quantum_instance" signature="property quantum_instance">
  ...
  <Function id="qiskit.aqua.algorithms.DeutschJozsa.random" name="random" signature="property random">
    Return a numpy random.
  </Function>

  ### run

  <Function id="qiskit.aqua.algorithms.DeutschJozsa.run" name="run" signature="run(quantum_instance=None, **kwargs)">
  ...
  <Function id="qiskit.aqua.algorithms.DeutschJozsa.set_backend" name="set_backend" signature="set_backend(backend, **kwargs)">
