...
<Class id="qiskit.circuit.QuantumRegister" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.16/qiskit/circuit/quantumregister.py" signature="QuantumRegister(size, name=None)">
  ...
  <Function id="qiskit.circuit.QuantumRegister.__init__" name="__init__" signature="__init__(size, name=None)">
    Create a new generic register.
  </Function>
