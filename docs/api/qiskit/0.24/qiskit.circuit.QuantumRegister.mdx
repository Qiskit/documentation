...
<Class id="qiskit.circuit.QuantumRegister" github="https://github.com/qiskit/qiskit/tree/stable/0.16/qiskit/circuit/quantumregister.py" signature="QuantumRegister(size, name=None)">
