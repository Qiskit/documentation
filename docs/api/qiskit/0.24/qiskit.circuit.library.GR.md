...
`GR(num_qubits, theta, phi)` [GitHub](https://github.com/qiskit/qiskit/tree/stable/0.16/qiskit/circuit/library/generalized_gates/gr.py "view source code")
...
<span id="qiskit.circuit.library.GR.diag_gate" />
...
<span id="qiskit.circuit.library.GR.mcmt" />
...
<span id="qiskit.circuit.library.GR.mirror" />
