---
title: summarize_circuits (v0.24)
description: API reference for qiskit.aqua.utils.summarize_circuits in qiskit v0.24
...
<Function id="qiskit.aqua.utils.summarize_circuits" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.8/qiskit/aqua/utils/circuit_utils.py" signature="summarize_circuits(circuits)">
