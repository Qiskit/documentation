...
<Function id="qiskit.pulse.builder.measure_channel" github="https://github.com/qiskit/qiskit/tree/stable/0.16/qiskit/pulse/builder.py" signature="measure_channel(qubit)">
