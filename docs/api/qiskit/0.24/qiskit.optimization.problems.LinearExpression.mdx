...
<Class id="qiskit.optimization.problems.LinearExpression" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.8/qiskit/optimization/problems/linear_expression.py" signature="LinearExpression(quadratic_program, coefficients)">
  ...
  *   **coefficients** (`Union`\[`ndarray`, `spmatrix`, `List`\[`float`], `Dict`\[`Union`\[`int`, `str`], `float`]]) – The (sparse) representation of the coefficients.
  ...
  <Function id="qiskit.optimization.problems.LinearExpression.coefficients" signature="property coefficients">
  ...
  <Function id="qiskit.optimization.problems.LinearExpression.quadratic_program" signature="property quadratic_program">
