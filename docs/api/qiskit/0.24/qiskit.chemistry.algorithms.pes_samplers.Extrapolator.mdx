...
<Class id="qiskit.chemistry.algorithms.pes_samplers.Extrapolator" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.8/qiskit/chemistry/algorithms/pes_samplers/extrapolator.py" signature="Extrapolator">
  ...
  <Function id="qiskit.chemistry.algorithms.pes_samplers.Extrapolator.__init__" name="__init__" signature="__init__()">
  ...
  <Function id="qiskit.chemistry.algorithms.pes_samplers.Extrapolator.extrapolate" name="extrapolate" signature="abstract extrapolate(points, param_dict)">
  ...
  <Function id="qiskit.chemistry.algorithms.pes_samplers.Extrapolator.factory" name="factory" signature="static factory(mode, **kwargs)">
