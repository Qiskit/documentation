---
title: Extrapolator (v0.24)
description: API reference for qiskit.chemistry.algorithms.pes_samplers.Extrapolator in qiskit v0.24
...
<Class id="qiskit.chemistry.algorithms.pes_samplers.Extrapolator" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.8/qiskit/chemistry/algorithms/pes_samplers/extrapolator.py" signature="Extrapolator" modifiers="class">
