...
<Class id="qiskit.transpiler.passes.CheckMap" github="https://github.com/qiskit/qiskit/tree/stable/0.16/qiskit/transpiler/passes/utils/check_map.py" signature="CheckMap(*args, **kwargs)">
