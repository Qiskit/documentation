---
title: LinearsolverResult (v0.24)
description: API reference for qiskit.aqua.algorithms.LinearsolverResult in qiskit v0.24
...
<Class id="qiskit.aqua.algorithms.LinearsolverResult" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.8/qiskit/aqua/algorithms/linear_solvers/linear_solver_result.py" signature="LinearsolverResult(a_dict=None)" modifiers="class">
