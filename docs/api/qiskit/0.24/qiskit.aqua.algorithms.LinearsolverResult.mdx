...
<Class id="qiskit.aqua.algorithms.LinearsolverResult" github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.8/qiskit/aqua/algorithms/linear_solvers/linear_solver_result.py" signature="LinearsolverResult(a_dict=None)">
