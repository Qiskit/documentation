...
<Class id="qiskit.aqua.algorithms.LinearsolverResult" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.8/qiskit/aqua/algorithms/linear_solvers/linear_solver_result.py" signature="LinearsolverResult(a_dict=None)">
  ...
  <Function id="qiskit.aqua.algorithms.LinearsolverResult.from_dict" signature="static from_dict(a_dict)">
  ...
  <Function id="qiskit.aqua.algorithms.LinearsolverResult.solution" signature="property solution">
    return solution
