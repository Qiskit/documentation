---
title: remap_noise_model (v0.24)
description: API reference for qiskit.providers.aer.utils.remap_noise_model in qiskit v0.24
...
<Function id="qiskit.providers.aer.utils.remap_noise_model" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-aer/tree/stable/0.7/qiskit/providers/aer/utils/noise_remapper.py" signature="remap_noise_model(noise_model, remapping, discard_qubits=False, warnings=True)">
