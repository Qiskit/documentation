...
<Class id="qiskit.aqua.operators.legacy.LegacyBaseOperator" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.8/qiskit/aqua/operators/legacy/base_operator.py" signature="LegacyBaseOperator(basis=None, z2_symmetries=None, name=None)">
  ...
  <Function id="qiskit.aqua.operators.legacy.LegacyBaseOperator.__init__" signature="abstract __init__(basis=None, z2_symmetries=None, name=None)">
    Constructor.
  </Function>
  ...
  <Function id="qiskit.aqua.operators.legacy.LegacyBaseOperator.basis" signature="property basis">
    returns basis
  </Function>

  ### chop

  <Function id="qiskit.aqua.operators.legacy.LegacyBaseOperator.chop" signature="abstract chop(threshold, copy=False)" />

  ### construct\_evaluation\_circuit

  <Function id="qiskit.aqua.operators.legacy.LegacyBaseOperator.construct_evaluation_circuit" signature="abstract construct_evaluation_circuit(wave_function, statevector_mode, **kwargs)">
    Build circuits to compute the expectation w\.r.t the wavefunction.
  </Function>

  ### evaluate\_with\_result

  <Function id="qiskit.aqua.operators.legacy.LegacyBaseOperator.evaluate_with_result" signature="abstract evaluate_with_result(result, statevector_mode, **kwargs)">
  ...
  <Function id="qiskit.aqua.operators.legacy.LegacyBaseOperator.evolve" signature="abstract evolve(state_in, evo_time, num_time_slices, expansion_mode, expansion_order, **kwargs)">
    Time evolution, exp^(-jt H).
  </Function>

  ### is\_empty

  <Function id="qiskit.aqua.operators.legacy.LegacyBaseOperator.is_empty" signature="abstract is_empty()">
    Check Operator is empty or not
  </Function>

  ### name

  <Function id="qiskit.aqua.operators.legacy.LegacyBaseOperator.name" signature="property name">
    returns name
  </Function>

  ### num\_qubits

  <Function id="qiskit.aqua.operators.legacy.LegacyBaseOperator.num_qubits" signature="abstract property num_qubits">
    Returns number of qubits for operator
  </Function>

  ### print\_details

  <Function id="qiskit.aqua.operators.legacy.LegacyBaseOperator.print_details" signature="abstract print_details()">
    print details
  </Function>

  ### to\_opflow

  <Function id="qiskit.aqua.operators.legacy.LegacyBaseOperator.to_opflow" signature="abstract to_opflow()">
    Convert to new Operator format.
  </Function>

  ### z2\_symmetries

  <Function id="qiskit.aqua.operators.legacy.LegacyBaseOperator.z2_symmetries" signature="property z2_symmetries">
