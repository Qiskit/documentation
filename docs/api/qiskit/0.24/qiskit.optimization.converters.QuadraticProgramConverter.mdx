...
<Class id="qiskit.optimization.converters.QuadraticProgramConverter" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.8/qiskit/optimization/converters/quadratic_program_converter.py" signature="QuadraticProgramConverter">
  ...
  <Function id="qiskit.optimization.converters.QuadraticProgramConverter.decode" name="decode" signature="decode(result)">
  ...
  <Function id="qiskit.optimization.converters.QuadraticProgramConverter.encode" name="encode" signature="encode(problem)">
  ...
  <Function id="qiskit.optimization.converters.QuadraticProgramConverter.interpret" name="interpret" signature="abstract interpret(result)">
