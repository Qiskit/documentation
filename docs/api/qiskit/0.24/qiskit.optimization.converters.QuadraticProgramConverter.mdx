...
<Class id="qiskit.optimization.converters.QuadraticProgramConverter" github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.8/qiskit/optimization/converters/quadratic_program_converter.py" signature="QuadraticProgramConverter">
