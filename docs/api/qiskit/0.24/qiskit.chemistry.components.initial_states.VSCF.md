...
`VSCF(basis)` [GitHub](https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.8/qiskit/chemistry/components/initial_states/vscf.py "view source code")
...
<span id="qiskit.chemistry.components.initial_states.VSCF.__init__" />
...
| [`construct_circuit`](#qiskit.chemistry.components.initial_states.VSCF.construct_circuit "qiskit.chemistry.components.initial_states.VSCF.construct_circuit")(\[mode, register]) | Construct the circuit of desired initial state. |
