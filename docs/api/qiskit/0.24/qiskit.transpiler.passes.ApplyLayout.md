...
`ApplyLayout(*args, **kwargs)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.16/qiskit/transpiler/passes/layout/apply_layout.py "view source code")
...
<span id="qiskit.transpiler.passes.ApplyLayout.__init__" />
