...
<Class id="qiskit.aqua.operators.converters.PauliBasisChange" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.8/qiskit/aqua/operators/converters/pauli_basis_change.py" signature="PauliBasisChange(destination_basis=None, traverse=True, replacement_fn=None)">
  ...
  *   **replacement\_fn** (`Optional`\[`Callable`]) –
  ...
  <Function id="qiskit.aqua.operators.converters.PauliBasisChange.destination" signature="property destination">
  ...
  <Function id="qiskit.aqua.operators.converters.PauliBasisChange.measurement_replacement_fn" signature="static measurement_replacement_fn(cob_instr_op, dest_pauli_op)">
  ...
  <Function id="qiskit.aqua.operators.converters.PauliBasisChange.operator_replacement_fn" signature="static operator_replacement_fn(cob_instr_op, dest_pauli_op)">
  ...
  <Function id="qiskit.aqua.operators.converters.PauliBasisChange.statefn_replacement_fn" signature="static statefn_replacement_fn(cob_instr_op, dest_pauli_op)">
