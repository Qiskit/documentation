...
<Class id="qiskit.pulse.Instruction" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.16/qiskit/pulse/instructions/instruction.py" signature="Instruction(operands, duration, channels, name=None)">
  ...
  *   [**PulseError**](qiskit.pulse.PulseError "qiskit.pulse.PulseError") – If the input `channels` are not all of type `Channel`.
  ...
  <Function id="qiskit.pulse.Instruction.__init__" name="__init__" signature="__init__(operands, duration, channels, name=None)">
    Instruction initializer.
  ...
  <Function id="qiskit.pulse.Instruction.channels" name="channels" signature="property channels">
  ...
  <Function id="qiskit.pulse.Instruction.command" name="command" signature="property command">
  ...
  <Function id="qiskit.pulse.Instruction.timeslots" name="timeslots" signature="property timeslots">
