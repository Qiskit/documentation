...
<Class id="qiskit.pulse.Instruction" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.16/qiskit/pulse/instructions/instruction.py" signature="Instruction(operands, duration, channels, name=None)" modifiers="class">
  ...
  *   [**PulseError**](qiskit.pulse.PulseError "qiskit.pulse.PulseError") – If the input `channels` are not all of type `Channel`.
  ...
  <Function id="qiskit.pulse.Instruction.channels" signature="channels" modifiers="property">
  ...
  <Function id="qiskit.pulse.Instruction.command" signature="command" modifiers="property">
  ...
  <Function id="qiskit.pulse.Instruction.duration" signature="duration" modifiers="property">
  ...
  <Function id="qiskit.pulse.Instruction.id" signature="id" modifiers="property">
  ...
  <Function id="qiskit.pulse.Instruction.instructions" signature="instructions" modifiers="property">
  ...
  <Function id="qiskit.pulse.Instruction.name" signature="name" modifiers="property">
  ...
  <Function id="qiskit.pulse.Instruction.operands" signature="operands" modifiers="property">
  ...
  <Function id="qiskit.pulse.Instruction.start_time" signature="start_time" modifiers="property">
  ...
  <Function id="qiskit.pulse.Instruction.stop_time" signature="stop_time" modifiers="property">
  ...
  <Function id="qiskit.pulse.Instruction.timeslots" signature="timeslots" modifiers="property">
