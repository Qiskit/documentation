...
<Class id="qiskit.aqua.operators.list_ops.ListOp" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.8/qiskit/aqua/operators/list_ops/list_op.py" signature="ListOp(oplist, combo_fn=<function ListOp.<lambda>>, coeff=1.0, abelian=False, grad_combo_fn=None)">
  ...
  *   **returns them in a list.** (*and*) –
  ...
  <Function id="qiskit.aqua.operators.list_ops.ListOp.__init__" name="__init__" signature="__init__(oplist, combo_fn=<function ListOp.<lambda>>, coeff=1.0, abelian=False, grad_combo_fn=None)">
    **Parameters**
  ...
  <Function id="qiskit.aqua.operators.list_ops.ListOp.abelian" name="abelian" signature="property abelian">
  ...
  <Function id="qiskit.aqua.operators.list_ops.ListOp.add" name="add" signature="add(other)">
  ...
  <Function id="qiskit.aqua.operators.list_ops.ListOp.adjoint" name="adjoint" signature="adjoint()">
  ...
  <Function id="qiskit.aqua.operators.list_ops.ListOp.assign_parameters" name="assign_parameters" signature="assign_parameters(param_dict)">
  ...
  <Function id="qiskit.aqua.operators.list_ops.ListOp.bind_parameters" name="bind_parameters" signature="bind_parameters(param_dict)">
  ...
  <Function id="qiskit.aqua.operators.list_ops.ListOp.coeff" name="coeff" signature="property coeff">
  ...
  <Function id="qiskit.aqua.operators.list_ops.ListOp.combo_fn" name="combo_fn" signature="property combo_fn">
  ...
  <Function id="qiskit.aqua.operators.list_ops.ListOp.compose" name="compose" signature="compose(other, permutation=None, front=False)">
  ...
  <Function id="qiskit.aqua.operators.list_ops.ListOp.distributive" name="distributive" signature="property distributive">
  ...
  <Function id="qiskit.aqua.operators.list_ops.ListOp.equals" name="equals" signature="equals(other)">
  ...
  <Function id="qiskit.aqua.operators.list_ops.ListOp.eval" name="eval" signature="eval(front=None)">
  ...
  <Function id="qiskit.aqua.operators.list_ops.ListOp.exp_i" name="exp_i" signature="exp_i()">
  ...
  <Function id="qiskit.aqua.operators.list_ops.ListOp.grad_combo_fn" name="grad_combo_fn" signature="property grad_combo_fn">
  ...
  <Function id="qiskit.aqua.operators.list_ops.ListOp.log_i" name="log_i" signature="log_i(massive=False)">
  ...
  <Function id="qiskit.aqua.operators.list_ops.ListOp.mul" name="mul" signature="mul(scalar)">
  ...
  <Function id="qiskit.aqua.operators.list_ops.ListOp.neg" name="neg" signature="neg()">
  ...
  <Function id="qiskit.aqua.operators.list_ops.ListOp.num_qubits" name="num_qubits" signature="property num_qubits">
  ...
  <Function id="qiskit.aqua.operators.list_ops.ListOp.oplist" name="oplist" signature="property oplist">
  ...
  <Function id="qiskit.aqua.operators.list_ops.ListOp.parameters" name="parameters" signature="property parameters">
    Return a set of Parameter objects contained in the Operator.
  </Function>

  ### permute

  <Function id="qiskit.aqua.operators.list_ops.ListOp.permute" name="permute" signature="permute(permutation)">
  ...
  <Function id="qiskit.aqua.operators.list_ops.ListOp.power" name="power" signature="power(exponent)">
  ...
  <Function id="qiskit.aqua.operators.list_ops.ListOp.primitive_strings" name="primitive_strings" signature="primitive_strings()">
  ...
  <Function id="qiskit.aqua.operators.list_ops.ListOp.reduce" name="reduce" signature="reduce()">
  ...
  <Function id="qiskit.aqua.operators.list_ops.ListOp.tensor" name="tensor" signature="tensor(other)">
  ...
  <Function id="qiskit.aqua.operators.list_ops.ListOp.tensorpower" name="tensorpower" signature="tensorpower(other)">
  ...
  <Function id="qiskit.aqua.operators.list_ops.ListOp.to_circuit_op" name="to_circuit_op" signature="to_circuit_op()">
  ...
  <Function id="qiskit.aqua.operators.list_ops.ListOp.to_legacy_op" name="to_legacy_op" signature="to_legacy_op(massive=False)">
  ...
  <Function id="qiskit.aqua.operators.list_ops.ListOp.to_matrix" name="to_matrix" signature="to_matrix(massive=False)">
  ...
  <Function id="qiskit.aqua.operators.list_ops.ListOp.to_matrix_op" name="to_matrix_op" signature="to_matrix_op(massive=False)">
  ...
  <Function id="qiskit.aqua.operators.list_ops.ListOp.to_pauli_op" name="to_pauli_op" signature="to_pauli_op(massive=False)">
  ...
  <Function id="qiskit.aqua.operators.list_ops.ListOp.to_spmatrix" name="to_spmatrix" signature="to_spmatrix()">
  ...
  <Function id="qiskit.aqua.operators.list_ops.ListOp.traverse" name="traverse" signature="traverse(convert_fn, coeff=None)">
