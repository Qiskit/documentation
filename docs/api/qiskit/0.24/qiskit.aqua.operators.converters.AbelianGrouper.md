...
`AbelianGrouper(traverse=True)` [GitHub](https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.8/qiskit/aqua/operators/converters/abelian_grouper.py "view source code")
