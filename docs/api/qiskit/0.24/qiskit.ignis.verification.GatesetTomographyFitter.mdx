...
<Class id="qiskit.ignis.verification.GatesetTomographyFitter" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-ignis/tree/stable/0.5/qiskit/ignis/verification/tomography/fitters/gateset_fitter.py" signature="GatesetTomographyFitter(result, circuits, gateset_basis='default')">
  ...
  **Additional information:**
  ...
  <Function id="qiskit.ignis.verification.GatesetTomographyFitter.__init__" name="__init__" signature="__init__(result, circuits, gateset_basis='default')">
    Initialize gateset tomography fitter with experimental data.
  ...
  <Function id="qiskit.ignis.verification.GatesetTomographyFitter.fit" name="fit" signature="fit()">
  ...
  <Function id="qiskit.ignis.verification.GatesetTomographyFitter.linear_inversion" name="linear_inversion" signature="linear_inversion()">
