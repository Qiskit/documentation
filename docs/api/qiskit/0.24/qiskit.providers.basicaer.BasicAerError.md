...
`BasicAerError(*message)` [GitHub](https://github.com/qiskit/qiskit/tree/stable/0.16/qiskit/providers/basicaer/exceptions.py "view source code")
...
<span id="qiskit.providers.basicaer.BasicAerError.with_traceback" />
