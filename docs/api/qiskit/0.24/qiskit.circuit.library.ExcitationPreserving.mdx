...
$$
  ...
  **ValueError** – If the selected mode is not supported.
  ...
  <Function id="qiskit.circuit.library.ExcitationPreserving.assign_parameters" name="assign_parameters" signature="assign_parameters(param_dict, inplace=False)">
  ...
  <Function id="qiskit.circuit.library.ExcitationPreserving.bind_parameters" name="bind_parameters" signature="bind_parameters(value_dict)">
  ...
  <Function id="qiskit.circuit.library.ExcitationPreserving.diag_gate" name="diag_gate" signature="diag_gate(diag, qubit)">
  ...
  <Function id="qiskit.circuit.library.ExcitationPreserving.initialize" name="initialize" signature="initialize(params, qubits)">
  ...
  <Function id="qiskit.circuit.library.ExcitationPreserving.mcmt" name="mcmt" signature="mcmt(gate, control_qubits, target_qubits, ancilla_qubits=None, mode='noancilla', *, single_control_gate_fun=None, q_controls=None, q_ancillae=None, q_targets=None)">
  ...
  <Function id="qiskit.circuit.library.ExcitationPreserving.mcry" name="mcry" signature="mcry(theta, q_controls, q_target, q_ancillae, mode=None, use_basis_gates=False)">
  ...
  <Function id="qiskit.circuit.library.ExcitationPreserving.mirror" name="mirror" signature="mirror()">
