...
<Class id="qiskit.aqua.components.uncertainty_models.UnivariateVariationalDistribution" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.8/qiskit/aqua/components/uncertainty_models/univariate_variational_distribution.py" signature="UnivariateVariationalDistribution(num_qubits, var_form, params, low=0, high=1)" modifiers="class">
  ...
  *   **high** (`float`) – Upper bound
  ...
  <Function id="qiskit.aqua.components.uncertainty_models.UnivariateVariationalDistribution.high" signature="high" modifiers="property">
    returns high
  </Function>

  ### low

  <Function id="qiskit.aqua.components.uncertainty_models.UnivariateVariationalDistribution.low" signature="low" modifiers="property">
    returns low
  </Function>

  ### num\_target\_qubits

  <Function id="qiskit.aqua.components.uncertainty_models.UnivariateVariationalDistribution.num_target_qubits" signature="num_target_qubits" modifiers="property">
    Returns the number of target qubits
  </Function>

  ### num\_values

  <Function id="qiskit.aqua.components.uncertainty_models.UnivariateVariationalDistribution.num_values" signature="num_values" modifiers="property">
  ...
  <Function id="qiskit.aqua.components.uncertainty_models.UnivariateVariationalDistribution.probabilities" signature="probabilities" modifiers="property">
  ...
  <Function id="qiskit.aqua.components.uncertainty_models.UnivariateVariationalDistribution.values" signature="values" modifiers="property">
    returns values
  </Function>
</Class>
