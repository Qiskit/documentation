...
<Class id="qiskit.circuit.library.CSXGate" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.16/qiskit/circuit/library/standard_gates/sx.py" signature="CSXGate(label=None, ctrl_state=None)" modifiers="class">
  Controlled-√X gate.
...
$$
  ...
  <Function id="qiskit.circuit.library.CSXGate.__init__" signature="__init__(label=None, ctrl_state=None)">
    Create new CSX gate.
  </Function>
  ...
  <Function id="qiskit.circuit.library.CSXGate.add_decomposition" signature="add_decomposition(decomposition)">
    Add a decomposition of the instruction to the SessionEquivalenceLibrary.
  </Function>

  ### assemble

  <Function id="qiskit.circuit.library.CSXGate.assemble" signature="assemble()">
  ...
  <Function id="qiskit.circuit.library.CSXGate.broadcast_arguments" signature="broadcast_arguments(qargs, cargs)">
  ...
  <Function id="qiskit.circuit.library.CSXGate.c_if" signature="c_if(classical, val)">
    Add classical condition on register classical and value val.
  </Function>

  ### control

  <Function id="qiskit.circuit.library.CSXGate.control" signature="control(num_ctrl_qubits=1, label=None, ctrl_state=None)">
  ...
  <Function id="qiskit.circuit.library.CSXGate.copy" signature="copy(name=None)">
  ...
  <Function id="qiskit.circuit.library.CSXGate.ctrl_state" signature="ctrl_state" modifiers="property">
  ...
  <Function id="qiskit.circuit.library.CSXGate.decompositions" signature="decompositions" modifiers="property">
    Get the decompositions of the instruction from the SessionEquivalenceLibrary.
  </Function>

  ### definition

  <Function id="qiskit.circuit.library.CSXGate.definition" signature="definition" modifiers="property">
  ...
  <Function id="qiskit.circuit.library.CSXGate.duration" signature="duration" modifiers="property">
    Get the duration.
  </Function>

  ### inverse

  <Function id="qiskit.circuit.library.CSXGate.inverse" signature="inverse()">
  ...
  <Function id="qiskit.circuit.library.CSXGate.is_parameterized" signature="is_parameterized()">
    Return True .IFF. instruction is parameterized else False
  </Function>

  ### label

  <Function id="qiskit.circuit.library.CSXGate.label" signature="label" modifiers="property">
    Return gate label
  ...
  <Function id="qiskit.circuit.library.CSXGate.mirror" signature="mirror()">
  ...
  <Function id="qiskit.circuit.library.CSXGate.num_ctrl_qubits" signature="num_ctrl_qubits" modifiers="property">
  ...
  <Function id="qiskit.circuit.library.CSXGate.params" signature="params" modifiers="property">
  ...
  <Function id="qiskit.circuit.library.CSXGate.power" signature="power(exponent)">
  ...
  <Function id="qiskit.circuit.library.CSXGate.qasm" signature="qasm()">
  ...
  <Function id="qiskit.circuit.library.CSXGate.repeat" signature="repeat(n)">
  ...
  <Function id="qiskit.circuit.library.CSXGate.reverse_ops" signature="reverse_ops()">
  ...
  <Function id="qiskit.circuit.library.CSXGate.to_matrix" signature="to_matrix()">
    Return a numpy.array for the CSX gate.
  </Function>

  ### unit

  <Function id="qiskit.circuit.library.CSXGate.unit" signature="unit" modifiers="property">
    Get the time unit of duration.
  </Function>

  ### validate\_parameter

  <Function id="qiskit.circuit.library.CSXGate.validate_parameter" signature="validate_parameter(parameter)">
