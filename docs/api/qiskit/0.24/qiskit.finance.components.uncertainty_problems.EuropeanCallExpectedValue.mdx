---
title: EuropeanCallExpectedValue (v0.24)
description: API reference for qiskit.finance.components.uncertainty_problems.EuropeanCallExpectedValue in qiskit v0.24
