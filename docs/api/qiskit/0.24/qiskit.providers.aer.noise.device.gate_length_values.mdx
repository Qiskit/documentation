---
title: gate_length_values (v0.24)
description: API reference for qiskit.providers.aer.noise.device.gate_length_values in qiskit v0.24
...
<Function id="qiskit.providers.aer.noise.device.gate_length_values" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-aer/tree/stable/0.7/qiskit/providers/aer/noise/device/parameters.py" signature="gate_length_values(properties)">
