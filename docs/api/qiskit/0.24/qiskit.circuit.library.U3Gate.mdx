...
<Class id="qiskit.circuit.library.U3Gate" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.16/qiskit/circuit/library/standard_gates/u3.py" signature="U3Gate(theta, phi, lam, label=None)" modifiers="class">
...
$$
  ...
  <Function id="qiskit.circuit.library.U3Gate.__init__" signature="__init__(theta, phi, lam, label=None)">
    Create new U3 gate.
  </Function>
  ...
  <Function id="qiskit.circuit.library.U3Gate.add_decomposition" signature="add_decomposition(decomposition)">
    Add a decomposition of the instruction to the SessionEquivalenceLibrary.
  </Function>

  ### assemble

  <Function id="qiskit.circuit.library.U3Gate.assemble" signature="assemble()">
  ...
  <Function id="qiskit.circuit.library.U3Gate.broadcast_arguments" signature="broadcast_arguments(qargs, cargs)">
  ...
  <Function id="qiskit.circuit.library.U3Gate.c_if" signature="c_if(classical, val)">
    Add classical condition on register classical and value val.
  </Function>

  ### control

  <Function id="qiskit.circuit.library.U3Gate.control" signature="control(num_ctrl_qubits=1, label=None, ctrl_state=None)">
  ...
  <Function id="qiskit.circuit.library.U3Gate.copy" signature="copy(name=None)">
  ...
  <Function id="qiskit.circuit.library.U3Gate.decompositions" signature="decompositions" modifiers="property">
    Get the decompositions of the instruction from the SessionEquivalenceLibrary.
  </Function>

  ### definition

  <Function id="qiskit.circuit.library.U3Gate.definition" signature="definition" modifiers="property">
    Return definition in terms of other basic gates.
  </Function>

  ### duration

  <Function id="qiskit.circuit.library.U3Gate.duration" signature="duration" modifiers="property">
    Get the duration.
  </Function>

  ### inverse

  <Function id="qiskit.circuit.library.U3Gate.inverse" signature="inverse()">
  ...
  <Function id="qiskit.circuit.library.U3Gate.is_parameterized" signature="is_parameterized()">
    Return True .IFF. instruction is parameterized else False
  </Function>

  ### label

  <Function id="qiskit.circuit.library.U3Gate.label" signature="label" modifiers="property">
    Return gate label
  ...
  <Function id="qiskit.circuit.library.U3Gate.mirror" signature="mirror()">
  ...
  <Function id="qiskit.circuit.library.U3Gate.params" signature="params" modifiers="property">
    return instruction params.
  </Function>

  ### power

  <Function id="qiskit.circuit.library.U3Gate.power" signature="power(exponent)">
  ...
  <Function id="qiskit.circuit.library.U3Gate.qasm" signature="qasm()">
  ...
  <Function id="qiskit.circuit.library.U3Gate.repeat" signature="repeat(n)">
  ...
  <Function id="qiskit.circuit.library.U3Gate.reverse_ops" signature="reverse_ops()">
  ...
  <Function id="qiskit.circuit.library.U3Gate.to_matrix" signature="to_matrix()">
    Return a Numpy.array for the U3 gate.
  </Function>

  ### unit

  <Function id="qiskit.circuit.library.U3Gate.unit" signature="unit" modifiers="property">
    Get the time unit of duration.
  </Function>

  ### validate\_parameter

  <Function id="qiskit.circuit.library.U3Gate.validate_parameter" signature="validate_parameter(parameter)">
