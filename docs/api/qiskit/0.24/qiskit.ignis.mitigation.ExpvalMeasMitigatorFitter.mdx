...
<Class id="qiskit.ignis.mitigation.ExpvalMeasMitigatorFitter" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-ignis/tree/stable/0.5/qiskit/ignis/mitigation/expval/fitter.py" signature="ExpvalMeasMitigatorFitter(result, metadata)">
  ...
  *   **metadata** (`List`\[`Dict`\[`str`, `any`]]) – mitigation generator metadata.
  ...
  <Function id="qiskit.ignis.mitigation.ExpvalMeasMitigatorFitter.mitigator" signature="property mitigator">
