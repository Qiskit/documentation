...
<span id="qiskit-quantum-info-random-density-matrix" />

# qiskit.quantum\_info.random\_density\_matrix

<span id="qiskit.quantum_info.random_density_matrix" />

`random_density_matrix(dims, rank=None, method='Hilbert-Schmidt', seed=None)` [GitHub](https://github.com/qiskit/qiskit/tree/stable/0.16/qiskit/quantum_info/states/random.py "view source code")
