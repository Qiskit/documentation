...
<Class id="qiskit.aqua.operators.legacy.MatrixOperator" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.8/qiskit/aqua/operators/legacy/matrix_operator.py" signature="MatrixOperator(matrix, basis=None, z2_symmetries=None, atol=1e-12, name=None)" modifiers="class">
  ...
  *   **name** (*str*) – name
  ...
  <Function id="qiskit.aqua.operators.legacy.MatrixOperator.atol" signature="atol" modifiers="property">
    return atol
  </Function>

  ### basis

  <Function id="qiskit.aqua.operators.legacy.MatrixOperator.basis" signature="basis" modifiers="property">
    returns basis
  </Function>
  ...
  <Function id="qiskit.aqua.operators.legacy.MatrixOperator.dense_matrix" signature="dense_matrix" modifiers="property">
    Getter of matrix in dense matrix form.
  </Function>

  ### dia\_matrix

  <Function id="qiskit.aqua.operators.legacy.MatrixOperator.dia_matrix" signature="dia_matrix" modifiers="property">
    diagonal matrix
  </Function>
  ...
  <Function id="qiskit.aqua.operators.legacy.MatrixOperator.matrix" signature="matrix" modifiers="property">
    Getter of matrix.
  </Function>

  ### name

  <Function id="qiskit.aqua.operators.legacy.MatrixOperator.name" signature="name" modifiers="property">
    returns name
  </Function>

  ### num\_qubits

  <Function id="qiskit.aqua.operators.legacy.MatrixOperator.num_qubits" signature="num_qubits" modifiers="property">
  ...
  <Function id="qiskit.aqua.operators.legacy.MatrixOperator.z2_symmetries" signature="z2_symmetries" modifiers="property">
