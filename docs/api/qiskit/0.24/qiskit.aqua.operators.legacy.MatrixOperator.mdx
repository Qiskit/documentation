...
<Class id="qiskit.aqua.operators.legacy.MatrixOperator" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.8/qiskit/aqua/operators/legacy/matrix_operator.py" signature="MatrixOperator(matrix, basis=None, z2_symmetries=None, atol=1e-12, name=None)">
  ...
  *   **name** (*str*) – name
  ...
  <Function id="qiskit.aqua.operators.legacy.MatrixOperator.__init__" name="__init__" signature="__init__(matrix, basis=None, z2_symmetries=None, atol=1e-12, name=None)">
    **Parameters**
  ...
  <Function id="qiskit.aqua.operators.legacy.MatrixOperator.add" name="add" signature="add(other, copy=False)" />

  ### atol

  <Function id="qiskit.aqua.operators.legacy.MatrixOperator.atol" name="atol" signature="property atol">
    return atol
  </Function>

  ### basis

  <Function id="qiskit.aqua.operators.legacy.MatrixOperator.basis" name="basis" signature="property basis">
    returns basis
  </Function>

  ### chop

  <Function id="qiskit.aqua.operators.legacy.MatrixOperator.chop" name="chop" signature="chop(threshold=None, copy=False)">
  ...
  <Function id="qiskit.aqua.operators.legacy.MatrixOperator.construct_evaluation_circuit" name="construct_evaluation_circuit" signature="construct_evaluation_circuit(wave_function, statevector_mode=True, use_simulator_snapshot_mode=None, circuit_name_prefix='')">
  ...
  <Function id="qiskit.aqua.operators.legacy.MatrixOperator.copy" name="copy" signature="copy()">
    Get a copy of self.
  </Function>

  ### dense\_matrix

  <Function id="qiskit.aqua.operators.legacy.MatrixOperator.dense_matrix" name="dense_matrix" signature="property dense_matrix">
    Getter of matrix in dense matrix form.
  </Function>

  ### dia\_matrix

  <Function id="qiskit.aqua.operators.legacy.MatrixOperator.dia_matrix" name="dia_matrix" signature="property dia_matrix">
    diagonal matrix
  </Function>

  ### evaluate\_with\_result

  <Function id="qiskit.aqua.operators.legacy.MatrixOperator.evaluate_with_result" name="evaluate_with_result" signature="evaluate_with_result(result, statevector_mode=True, use_simulator_snapshot_mode=None, circuit_name_prefix='')">
  ...
  <Function id="qiskit.aqua.operators.legacy.MatrixOperator.evaluate_with_statevector" name="evaluate_with_statevector" signature="evaluate_with_statevector(quantum_state)">
    **Parameters**
  ...
  <Function id="qiskit.aqua.operators.legacy.MatrixOperator.evolve" name="evolve" signature="evolve(state_in, evo_time=0, num_time_slices=0, expansion_mode='trotter', expansion_order=1)">
  ...
  <Function id="qiskit.aqua.operators.legacy.MatrixOperator.is_empty" name="is_empty" signature="is_empty()">
  ...
  <Function id="qiskit.aqua.operators.legacy.MatrixOperator.matrix" name="matrix" signature="property matrix">
    Getter of matrix.
  </Function>

  ### name

  <Function id="qiskit.aqua.operators.legacy.MatrixOperator.name" name="name" signature="property name">
    returns name
  </Function>

  ### num\_qubits

  <Function id="qiskit.aqua.operators.legacy.MatrixOperator.num_qubits" name="num_qubits" signature="property num_qubits">
  ...
  <Function id="qiskit.aqua.operators.legacy.MatrixOperator.print_details" name="print_details" signature="print_details()">
    **Returns**
  ...
  <Function id="qiskit.aqua.operators.legacy.MatrixOperator.sub" name="sub" signature="sub(other, copy=False)" />

  ### to\_opflow

  <Function id="qiskit.aqua.operators.legacy.MatrixOperator.to_opflow" name="to_opflow" signature="to_opflow()">
    to op flow
  </Function>

  ### z2\_symmetries

  <Function id="qiskit.aqua.operators.legacy.MatrixOperator.z2_symmetries" name="z2_symmetries" signature="property z2_symmetries">
