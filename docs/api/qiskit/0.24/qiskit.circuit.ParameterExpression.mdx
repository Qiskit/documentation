...
<Class id="qiskit.circuit.ParameterExpression" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.16/qiskit/circuit/parameterexpression.py" signature="ParameterExpression(symbol_map, expr)">
  ...
  *   **expr** (*sympy.Expr*) – Expression of `sympy.Symbol` s.
  ...
  <Function id="qiskit.circuit.ParameterExpression.__init__" name="__init__" signature="__init__(symbol_map, expr)">
    Create a new [`ParameterExpression`](#qiskit.circuit.ParameterExpression "qiskit.circuit.ParameterExpression").
  ...
  <Function id="qiskit.circuit.ParameterExpression.bind" name="bind" signature="bind(parameter_values)">
  ...
  <Function id="qiskit.circuit.ParameterExpression.parameters" name="parameters" signature="property parameters">
  ...
  <Function id="qiskit.circuit.ParameterExpression.subs" name="subs" signature="subs(parameter_map)">
