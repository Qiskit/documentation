...
<Class id="qiskit.ignis.verification.QVFitter" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-ignis/tree/stable/0.5/qiskit/ignis/verification/quantum_volume/fitters.py" signature="QVFitter(backend_result=None, statevector_result=None, qubit_lists=None)" modifiers="class">
  ...
  *   **qubit\_lists** (*list*) – list of qubit lists (what was passed to the circuit generation)
  ...
  <Function id="qiskit.ignis.verification.QVFitter.depths" signature="depths" modifiers="property">
    Return depth list.
  </Function>

  ### heavy\_output\_counts

  <Function id="qiskit.ignis.verification.QVFitter.heavy_output_counts" signature="heavy_output_counts" modifiers="property">
    Return the number of heavy output counts as measured.
  </Function>

  ### heavy\_output\_prob\_ideal

  <Function id="qiskit.ignis.verification.QVFitter.heavy_output_prob_ideal" signature="heavy_output_prob_ideal" modifiers="property">
    Return the heavy output probability ideally.
  </Function>

  ### heavy\_outputs

  <Function id="qiskit.ignis.verification.QVFitter.heavy_outputs" signature="heavy_outputs" modifiers="property">
  ...
  <Function id="qiskit.ignis.verification.QVFitter.qubit_lists" signature="qubit_lists" modifiers="property">
    Return depth list.
  </Function>
  ...
  <Function id="qiskit.ignis.verification.QVFitter.results" signature="results" modifiers="property">
    Return all the results.
  </Function>

  ### ydata

  <Function id="qiskit.ignis.verification.QVFitter.ydata" signature="ydata" modifiers="property">
