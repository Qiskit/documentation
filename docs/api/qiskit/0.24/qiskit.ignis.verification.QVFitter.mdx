...
<Class id="qiskit.ignis.verification.QVFitter" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-ignis/tree/stable/0.5/qiskit/ignis/verification/quantum_volume/fitters.py" signature="QVFitter(backend_result=None, statevector_result=None, qubit_lists=None)">
  ...
  *   **qubit\_lists** (*list*) – list of qubit lists (what was passed to the circuit generation)
  ...
  <Function id="qiskit.ignis.verification.QVFitter.depths" signature="property depths">
    Return depth list.
  </Function>

  ### heavy\_output\_counts

  <Function id="qiskit.ignis.verification.QVFitter.heavy_output_counts" signature="property heavy_output_counts">
    Return the number of heavy output counts as measured.
  </Function>

  ### heavy\_output\_prob\_ideal

  <Function id="qiskit.ignis.verification.QVFitter.heavy_output_prob_ideal" signature="property heavy_output_prob_ideal">
    Return the heavy output probability ideally.
  </Function>

  ### heavy\_outputs

  <Function id="qiskit.ignis.verification.QVFitter.heavy_outputs" signature="property heavy_outputs">
  ...
  <Function id="qiskit.ignis.verification.QVFitter.qubit_lists" signature="property qubit_lists">
    Return depth list.
  </Function>
  ...
  <Function id="qiskit.ignis.verification.QVFitter.results" signature="property results">
    Return all the results.
  </Function>

  ### ydata

  <Function id="qiskit.ignis.verification.QVFitter.ydata" signature="property ydata">
