...
<Class id="qiskit.optimization.problems.QuadraticExpression" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.8/qiskit/optimization/problems/quadratic_expression.py" signature="QuadraticExpression(quadratic_program, coefficients)">
  ...
  *   **coefficients** (`Union`\[`ndarray`, `spmatrix`, `List`\[`List`\[`float`]], `Dict`\[`Tuple`\[`Union`\[`int`, `str`], `Union`\[`int`, `str`]], `float`]]) – The (sparse) representation of the coefficients.
  ...
  <Function id="qiskit.optimization.problems.QuadraticExpression.__init__" name="__init__" signature="__init__(quadratic_program, coefficients)">
    Creates a new quadratic expression.
  ...
  <Function id="qiskit.optimization.problems.QuadraticExpression.coefficients" name="coefficients" signature="property coefficients">
  ...
  <Function id="qiskit.optimization.problems.QuadraticExpression.evaluate" name="evaluate" signature="evaluate(x)">
  ...
  <Function id="qiskit.optimization.problems.QuadraticExpression.evaluate_gradient" name="evaluate_gradient" signature="evaluate_gradient(x)">
  ...
  <Function id="qiskit.optimization.problems.QuadraticExpression.quadratic_program" name="quadratic_program" signature="property quadratic_program">
  ...
  <Function id="qiskit.optimization.problems.QuadraticExpression.to_array" name="to_array" signature="to_array(symmetric=False)">
  ...
  <Function id="qiskit.optimization.problems.QuadraticExpression.to_dict" name="to_dict" signature="to_dict(symmetric=False, use_name=False)">
