...
$$
  ...
  *   **name** (`Optional`\[`str`]) – Name of this set channel frequency instruction.
  ...
  <Function id="qiskit.pulse.instructions.SetFrequency.command" signature="command" modifiers="property">
  ...
  <Function id="qiskit.pulse.instructions.SetFrequency.timeslots" signature="timeslots" modifiers="property">
