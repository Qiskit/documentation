...
$$
  ...
  *   **name** (`Optional`\[`str`]) – Name of this set channel frequency instruction.
  ...
  <Function id="qiskit.pulse.instructions.SetFrequency.command" name="command" signature="property command">
  ...
  <Function id="qiskit.pulse.instructions.SetFrequency.timeslots" name="timeslots" signature="property timeslots">
