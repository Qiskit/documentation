...
<Function id="qiskit.aqua.utils.tensorproduct" github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.8/qiskit/aqua/utils/tensor_product.py" signature="tensorproduct(*args)">
