---
title: tensorproduct (v0.24)
description: API reference for qiskit.aqua.utils.tensorproduct in qiskit v0.24
...
<Function id="qiskit.aqua.utils.tensorproduct" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.8/qiskit/aqua/utils/tensor_product.py" signature="tensorproduct(*args)">
