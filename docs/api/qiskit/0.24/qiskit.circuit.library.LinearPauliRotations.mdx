...
<Class id="qiskit.circuit.library.LinearPauliRotations" github="https://github.com/qiskit/qiskit/tree/stable/0.16/qiskit/circuit/library/arithmetic/linear_pauli_rotations.py" signature="LinearPauliRotations(num_state_qubits=None, slope=1, offset=0, basis='Y', name='LinRot')">
