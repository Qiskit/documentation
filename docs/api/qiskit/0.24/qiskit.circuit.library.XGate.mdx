...
$$
  ...
  <Function id="qiskit.circuit.library.XGate.decompositions" signature="property decompositions">
    Get the decompositions of the instruction from the SessionEquivalenceLibrary.
  </Function>

  ### definition

  <Function id="qiskit.circuit.library.XGate.definition" signature="property definition">
    Return definition in terms of other basic gates.
  </Function>

  ### duration

  <Function id="qiskit.circuit.library.XGate.duration" signature="property duration">
    Get the duration.
  </Function>
  ...
  <Function id="qiskit.circuit.library.XGate.label" signature="property label">
    Return gate label
  ...
  <Function id="qiskit.circuit.library.XGate.params" signature="property params">
  ...
  <Function id="qiskit.circuit.library.XGate.unit" signature="property unit">
