...
<Class id="qiskit.aqua.algorithms.NumPyEigensolver" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.8/qiskit/aqua/algorithms/eigen_solvers/numpy_eigen_solver.py" signature="NumPyEigensolver(operator=None, k=1, aux_operators=None, filter_criterion=None)">
  ...
  *   **filter\_criterion** (`Optional`\[`Callable`\[\[`Union`\[`List`, `ndarray`], `float`, `Optional`\[`List`\[`float`]]], `bool`]]) – callable that allows to filter eigenvalues/eigenstates, only feasible eigenstates are returned in the results. The callable has the signature filter(eigenstate, eigenvalue, aux\_values) and must return a boolean to indicate whether to keep this value in the final returned result or not. If the number of elements that satisfies the criterion is smaller than k then the returned list has fewer elements and can even be empty.
  ...
  <Function id="qiskit.aqua.algorithms.NumPyEigensolver.__init__" name="__init__" signature="__init__(operator=None, k=1, aux_operators=None, filter_criterion=None)">
    **Parameters**
  ...
  <Function id="qiskit.aqua.algorithms.NumPyEigensolver.aux_operators" name="aux_operators" signature="property aux_operators">
  ...
  <Function id="qiskit.aqua.algorithms.NumPyEigensolver.compute_eigenvalues" name="compute_eigenvalues" signature="compute_eigenvalues(operator=None, aux_operators=None)">
  ...
  <Function id="qiskit.aqua.algorithms.NumPyEigensolver.filter_criterion" name="filter_criterion" signature="property filter_criterion">
  ...
  <Function id="qiskit.aqua.algorithms.NumPyEigensolver.k" name="k" signature="property k">
  ...
  <Function id="qiskit.aqua.algorithms.NumPyEigensolver.operator" name="operator" signature="property operator">
    Return the operator.
  ...
  <Function id="qiskit.aqua.algorithms.NumPyEigensolver.random" name="random" signature="property random">
    Return a numpy random.
  </Function>

  ### run

  <Function id="qiskit.aqua.algorithms.NumPyEigensolver.run" name="run" signature="run()">
  ...
  <Function id="qiskit.aqua.algorithms.NumPyEigensolver.supports_aux_operators" name="supports_aux_operators" signature="classmethod supports_aux_operators()">
