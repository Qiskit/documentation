...
<Class id="qiskit.optimization.applications.ising.tsp.TspData" signature="TspData(name, dim, coord, w)" modifiers="class">
  ...
  <Function id="qiskit.optimization.applications.ising.tsp.TspData.coord" signature="coord" modifiers="property">
  ...
  <Function id="qiskit.optimization.applications.ising.tsp.TspData.dim" signature="dim" modifiers="property">
  ...
  <Function id="qiskit.optimization.applications.ising.tsp.TspData.name" signature="name" modifiers="property">
    Alias for field number 0
  </Function>

  #### w

  <Function id="qiskit.optimization.applications.ising.tsp.TspData.w" signature="w" modifiers="property">
...
<Function id="qiskit.optimization.applications.ising.tsp.calc_distance" github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.8/qiskit/optimization/applications/ising/tsp.py" signature="calc_distance(coord, name='tmp')">
  calculate distance
</Function>

### get\_operator

<Function id="qiskit.optimization.applications.ising.tsp.get_operator" github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.8/qiskit/optimization/applications/ising/tsp.py" signature="get_operator(ins, penalty=100000.0)">
...
<Function id="qiskit.optimization.applications.ising.tsp.get_tsp_solution" github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.8/qiskit/optimization/applications/ising/tsp.py" signature="get_tsp_solution(x)">
...
<Function id="qiskit.optimization.applications.ising.tsp.parse_tsplib_format" github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.8/qiskit/optimization/applications/ising/tsp.py" signature="parse_tsplib_format(filename)">
...
<Function id="qiskit.optimization.applications.ising.tsp.random_tsp" github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.8/qiskit/optimization/applications/ising/tsp.py" signature="random_tsp(n, low=0, high=100, savefile=None, seed=None, name='tmp')">
...
<Function id="qiskit.optimization.applications.ising.tsp.tsp_feasible" github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.8/qiskit/optimization/applications/ising/tsp.py" signature="tsp_feasible(x)">
...
<Function id="qiskit.optimization.applications.ising.tsp.tsp_value" github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.8/qiskit/optimization/applications/ising/tsp.py" signature="tsp_value(z, w)">
