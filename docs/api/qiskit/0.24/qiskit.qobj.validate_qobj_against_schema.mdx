...
<Function id="qiskit.qobj.validate_qobj_against_schema" name="validate_qobj_against_schema" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.16/qiskit/qobj/utils.py" signature="validate_qobj_against_schema(qobj)">
