...
<Class id="qiskit.transpiler.passes.CrosstalkAdaptiveSchedule" github="https://github.com/qiskit/qiskit/tree/stable/0.16/qiskit/transpiler/passes/optimization/crosstalk_adaptive_schedule.py" signature="CrosstalkAdaptiveSchedule(*args, **kwargs)">
