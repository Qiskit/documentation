...
<Class id="qiskit.chemistry.transformations.BosonicTransformation" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.8/qiskit/chemistry/transformations/bosonic_transformation.py" signature="BosonicTransformation(qubit_mapping=<BosonicQubitMappingType.DIRECT: 'direct'>, transformation_type=<BosonicTransformationType.HARMONIC: 'harmonic'>, basis_size=2, truncation=3)">
  ...
  *   **truncation** (`int`) – where is the Hamiltonian expansion truncation (1 for having only 1-body terms, 2 for having on 1- and 2-body terms…)
  ...
  <Function id="qiskit.chemistry.transformations.BosonicTransformation.__init__" name="__init__" signature="__init__(qubit_mapping=<BosonicQubitMappingType.DIRECT: 'direct'>, transformation_type=<BosonicTransformationType.HARMONIC: 'harmonic'>, basis_size=2, truncation=3)">
    **Parameters**
  ...
  <Function id="qiskit.chemistry.transformations.BosonicTransformation.basis" name="basis" signature="property basis">
  ...
  <Function id="qiskit.chemistry.transformations.BosonicTransformation.build_hopping_operators" name="build_hopping_operators" signature="build_hopping_operators(excitations='sd')">
    **Parameters**
  ...
  <Function id="qiskit.chemistry.transformations.BosonicTransformation.commutation_rule" name="commutation_rule" signature="property commutation_rule">
  ...
  <Function id="qiskit.chemistry.transformations.BosonicTransformation.get_default_filter_criterion" name="get_default_filter_criterion" signature="get_default_filter_criterion()">
  ...
  <Function id="qiskit.chemistry.transformations.BosonicTransformation.interpret" name="interpret" signature="interpret(raw_result)">
  ...
  <Function id="qiskit.chemistry.transformations.BosonicTransformation.num_modes" name="num_modes" signature="property num_modes">
    the number of modes
  ...
  <Function id="qiskit.chemistry.transformations.BosonicTransformation.transform" name="transform" signature="transform(driver, aux_operators=None)">
  ...
  <Function id="qiskit.chemistry.transformations.BosonicTransformation.untapered_qubit_op" name="untapered_qubit_op" signature="property untapered_qubit_op">
