...
<Class id="qiskit.dagcircuit.DAGNode" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.16/qiskit/dagcircuit/dagnode.py" signature="DAGNode(type=None, op=None, name=None, qargs=None, cargs=None, condition=None, wire=None, nid=- 1)" modifiers="class">
  ...
  <Function id="qiskit.dagcircuit.DAGNode.op" signature="op" modifiers="property">
    Returns the Instruction object corresponding to the op for the node, else None
  </Function>

  ### qargs

  <Function id="qiskit.dagcircuit.DAGNode.qargs" signature="qargs" modifiers="property">
  ...
  <Function id="qiskit.dagcircuit.DAGNode.wire" signature="wire" modifiers="property">
