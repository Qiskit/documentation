---
title: QasmQobj (v0.24)
description: API reference for qiskit.qobj.QasmQobj in qiskit v0.24
...
<Class id="qiskit.qobj.QasmQobj" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.16/qiskit/qobj/qasm_qobj.py" signature="QasmQobj(qobj_id=None, config=None, experiments=None, header=None)" modifiers="class">
  A QASM Qobj.
  ...
  *   **experiments** (*list*) – A list of lists of [`QasmQobjExperiment`](qiskit.qobj.QasmQobjExperiment "qiskit.qobj.QasmQobjExperiment") objects representing an experiment
  ...
  <Function id="qiskit.qobj.QasmQobj.__init__" signature="__init__(qobj_id=None, config=None, experiments=None, header=None)">
    Instatiate a new QASM Qobj Object.
  ...
  <Function id="qiskit.qobj.QasmQobj.from_dict" signature="from_dict(data)" modifiers="classmethod">
  ...
  <Function id="qiskit.qobj.QasmQobj.to_dict" signature="to_dict(validate=False)">
