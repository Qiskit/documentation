...
<Class id="qiskit.chemistry.algorithms.pes_samplers.EnergySurface1DSpline" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.8/qiskit/chemistry/algorithms/pes_samplers/potentials/energy_surface_spline.py" signature="EnergySurface1DSpline">
  ...
  <Function id="qiskit.chemistry.algorithms.pes_samplers.EnergySurface1DSpline.__init__" name="__init__" signature="__init__()">
    A spline interpolation method for data fitting.
  ...
  <Function id="qiskit.chemistry.algorithms.pes_samplers.EnergySurface1DSpline.eval" name="eval" signature="eval(x)">
  ...
  <Function id="qiskit.chemistry.algorithms.pes_samplers.EnergySurface1DSpline.fit" name="fit" signature="fit(xdata, ydata, initial_vals=None, bounds_list=None)">
  ...
  <Function id="qiskit.chemistry.algorithms.pes_samplers.EnergySurface1DSpline.get_equilibrium_geometry" name="get_equilibrium_geometry" signature="get_equilibrium_geometry(scaling=1.0)">
  ...
  <Function id="qiskit.chemistry.algorithms.pes_samplers.EnergySurface1DSpline.get_minimal_energy" name="get_minimal_energy" signature="get_minimal_energy(scaling=1.0)">
  ...
  <Function id="qiskit.chemistry.algorithms.pes_samplers.EnergySurface1DSpline.get_trust_region" name="get_trust_region" signature="get_trust_region()">
