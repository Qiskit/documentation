...
<Class id="qiskit.chemistry.algorithms.QEomEE" github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.8/qiskit/chemistry/algorithms/eigen_solvers/q_eom_ee.py" signature="QEomEE(operator, num_orbitals, num_particles, qubit_mapping='parity', two_qubit_reduction=True, active_occupied=None, active_unoccupied=None, is_eom_matrix_symmetric=True, se_list=None, de_list=None, z2_symmetries=None, untapered_op=None, aux_operators=None)">
  ...
  **ValueError** – invalid parameter
  ...
  <Function id="qiskit.chemistry.algorithms.QEomEE.__init__" name="__init__" signature="__init__(operator, num_orbitals, num_particles, qubit_mapping='parity', two_qubit_reduction=True, active_occupied=None, active_unoccupied=None, is_eom_matrix_symmetric=True, se_list=None, de_list=None, z2_symmetries=None, untapered_op=None, aux_operators=None)">
    **Parameters**
  ...
  <Function id="qiskit.chemistry.algorithms.QEomEE.aux_operators" name="aux_operators" signature="property aux_operators">
  ...
  <Function id="qiskit.chemistry.algorithms.QEomEE.compute_minimum_eigenvalue" name="compute_minimum_eigenvalue" signature="compute_minimum_eigenvalue(operator=None, aux_operators=None)">
  ...
  <Function id="qiskit.chemistry.algorithms.QEomEE.filter_criterion" name="filter_criterion" signature="property filter_criterion">
  ...
  <Function id="qiskit.chemistry.algorithms.QEomEE.operator" name="operator" signature="property operator">
    Return the operator.
  ...
  <Function id="qiskit.chemistry.algorithms.QEomEE.random" name="random" signature="property random">
    Return a numpy random.
  </Function>

  ### run

  <Function id="qiskit.chemistry.algorithms.QEomEE.run" name="run" signature="run()">
  ...
  <Function id="qiskit.chemistry.algorithms.QEomEE.supports_aux_operators" name="supports_aux_operators" signature="classmethod supports_aux_operators()">
