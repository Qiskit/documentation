...
<Class id="qiskit.chemistry.algorithms.ExcitedStatesEigensolver" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.8/qiskit/chemistry/algorithms/excited_states_solvers/excited_states_eigensolver.py" signature="ExcitedStatesEigensolver(transformation, solver)">
  ...
  *   **solver** (`Union`\[`Eigensolver`, `EigensolverFactory`]) – Minimum Eigensolver or MESFactory object.
  ...
  <Function id="qiskit.chemistry.algorithms.ExcitedStatesEigensolver.__init__" name="__init__" signature="__init__(transformation, solver)">
    **Parameters**
  ...
  <Function id="qiskit.chemistry.algorithms.ExcitedStatesEigensolver.solve" name="solve" signature="solve(driver, aux_operators=None)">
  ...
  <Function id="qiskit.chemistry.algorithms.ExcitedStatesEigensolver.solver" name="solver" signature="property solver">
  ...
  <Function id="qiskit.chemistry.algorithms.ExcitedStatesEigensolver.transformation" name="transformation" signature="property transformation">
