...
<Class id="qiskit.qasm.Qasm" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.16/qiskit/qasm/qasm.py" signature="Qasm(filename=None, data=None)">
