...
<Class id="qiskit.pulse.Snapshot" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.16/qiskit/pulse/instructions/snapshot.py" signature="Snapshot(label, snapshot_type='statevector', name=None)">
  ...
  **Raises**
  ...
  <Function id="qiskit.pulse.Snapshot.__init__" name="__init__" signature="__init__(label, snapshot_type='statevector', name=None)">
    Create new snapshot.
  ...
  | [`channels`](#qiskit.pulse.Snapshot.channels "qiskit.pulse.Snapshot.channels")             | Returns channels that this schedule uses.                                                                                                                    |
  | [`command`](#qiskit.pulse.Snapshot.command "qiskit.pulse.Snapshot.command")                | The associated command.                                                                                                                                      |
  ...
  | [`timeslots`](#qiskit.pulse.Snapshot.timeslots "qiskit.pulse.Snapshot.timeslots")          | Occupied time slots by this instruction.                                                                                                                     |
  | [`type`](#qiskit.pulse.Snapshot.type "qiskit.pulse.Snapshot.type")                         | Type of snapshot.                                                                                                                                            |

  ### append

  <Function id="qiskit.pulse.Snapshot.append" name="append" signature="append(schedule, name=None)">
  ...
  <Function id="qiskit.pulse.Snapshot.assign_parameters" name="assign_parameters" signature="assign_parameters(value_dict)">
  ...
  <Function id="qiskit.pulse.Snapshot.ch_duration" name="ch_duration" signature="ch_duration(*channels)">
  ...
  <Function id="qiskit.pulse.Snapshot.ch_start_time" name="ch_start_time" signature="ch_start_time(*channels)">
  ...
  <Function id="qiskit.pulse.Snapshot.ch_stop_time" name="ch_stop_time" signature="ch_stop_time(*channels)">
  ...
  <Function id="qiskit.pulse.Snapshot.channel" name="channel" signature="property channel">
  ...
  <Function id="qiskit.pulse.Snapshot.channels" name="channels" signature="property channels">
  ...
  <Function id="qiskit.pulse.Snapshot.command" name="command" signature="property command">
  ...
  <Function id="qiskit.pulse.Snapshot.draw" name="draw" signature="draw(dt=1, style=None, filename=None, interp_method=None, scale=1, plot_all=False, plot_range=None, interactive=False, table=True, label=False, framechange=True, channels=None)">
  ...
  <Function id="qiskit.pulse.Snapshot.duration" name="duration" signature="property duration">
  ...
  <Function id="qiskit.pulse.Snapshot.flatten" name="flatten" signature="flatten()">
  ...
  <Function id="qiskit.pulse.Snapshot.id" name="id" signature="property id">
  ...
  <Function id="qiskit.pulse.Snapshot.insert" name="insert" signature="insert(start_time, schedule, name=None)">
  ...
  <Function id="qiskit.pulse.Snapshot.instructions" name="instructions" signature="property instructions">
  ...
  <Function id="qiskit.pulse.Snapshot.label" name="label" signature="property label">
    Label of snapshot.
  ...
  <Function id="qiskit.pulse.Snapshot.name" name="name" signature="property name">
  ...
  <Function id="qiskit.pulse.Snapshot.operands" name="operands" signature="property operands">
  ...
  <Function id="qiskit.pulse.Snapshot.shift" name="shift" signature="shift(time, name=None)">
  ...
  <Function id="qiskit.pulse.Snapshot.start_time" name="start_time" signature="property start_time">
  ...
  <Function id="qiskit.pulse.Snapshot.stop_time" name="stop_time" signature="property stop_time">
  ...
  <Function id="qiskit.pulse.Snapshot.timeslots" name="timeslots" signature="property timeslots">
  ...
  <Function id="qiskit.pulse.Snapshot.type" name="type" signature="property type">
    Type of snapshot.
