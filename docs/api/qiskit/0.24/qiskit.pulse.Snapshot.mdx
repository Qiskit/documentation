...
<Class id="qiskit.pulse.Snapshot" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.16/qiskit/pulse/instructions/snapshot.py" signature="Snapshot(label, snapshot_type='statevector', name=None)">
  ...
  **Raises**
  ...
  <Function id="qiskit.pulse.Snapshot.channel" signature="property channel">
  ...
  <Function id="qiskit.pulse.Snapshot.channels" signature="property channels">
  ...
  <Function id="qiskit.pulse.Snapshot.command" signature="property command">
  ...
  <Function id="qiskit.pulse.Snapshot.duration" signature="property duration">
  ...
  <Function id="qiskit.pulse.Snapshot.id" signature="property id">
  ...
  <Function id="qiskit.pulse.Snapshot.instructions" signature="property instructions">
  ...
  <Function id="qiskit.pulse.Snapshot.label" signature="property label">
    Label of snapshot.
  ...
  <Function id="qiskit.pulse.Snapshot.name" signature="property name">
  ...
  <Function id="qiskit.pulse.Snapshot.operands" signature="property operands">
  ...
  <Function id="qiskit.pulse.Snapshot.start_time" signature="property start_time">
  ...
  <Function id="qiskit.pulse.Snapshot.stop_time" signature="property stop_time">
  ...
  <Function id="qiskit.pulse.Snapshot.timeslots" signature="property timeslots">
  ...
  <Function id="qiskit.pulse.Snapshot.type" signature="property type">
    Type of snapshot.
