---
title: get_subsystems_counts (v0.24)
description: API reference for qiskit.aqua.utils.get_subsystems_counts in qiskit v0.24
...
<Function id="qiskit.aqua.utils.get_subsystems_counts" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.8/qiskit/aqua/utils/subsystem.py" signature="get_subsystems_counts(complete_system_counts, post_select_index=None, post_select_flag=None)">
