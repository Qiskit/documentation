...
<span id="qiskit-providers-aer-noise-mixed-unitary-error" />

# qiskit.providers.aer.noise.mixed\_unitary\_error

<span id="qiskit.providers.aer.noise.mixed_unitary_error" />

`mixed_unitary_error(noise_ops, standard_gates=True)` [GitHub](https://github.com/qiskit/qiskit-aer/tree/stable/0.7/qiskit/providers/aer/noise/errors/standard_errors.py "view source code")
