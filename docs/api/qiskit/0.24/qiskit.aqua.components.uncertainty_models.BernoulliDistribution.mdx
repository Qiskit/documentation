...
<Class id="qiskit.aqua.components.uncertainty_models.BernoulliDistribution" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.8/qiskit/aqua/components/uncertainty_models/bernoulli_distribution.py" signature="BernoulliDistribution(p, low=0, high=1)">
  ...
  *   **high** (`float`) – High value
  ...
  <Function id="qiskit.aqua.components.uncertainty_models.BernoulliDistribution.high" signature="property high">
    returns high
  </Function>

  ### low

  <Function id="qiskit.aqua.components.uncertainty_models.BernoulliDistribution.low" signature="property low">
    returns low
  </Function>

  ### num\_target\_qubits

  <Function id="qiskit.aqua.components.uncertainty_models.BernoulliDistribution.num_target_qubits" signature="property num_target_qubits">
    Returns the number of target qubits
  </Function>

  ### num\_values

  <Function id="qiskit.aqua.components.uncertainty_models.BernoulliDistribution.num_values" signature="property num_values">
    returns number of values
  </Function>

  ### p

  <Function id="qiskit.aqua.components.uncertainty_models.BernoulliDistribution.p" signature="property p" />

  ### pdf\_to\_probabilities

  <Function id="qiskit.aqua.components.uncertainty_models.BernoulliDistribution.pdf_to_probabilities" signature="static pdf_to_probabilities(pdf, low, high, num_values)">
  ...
  <Function id="qiskit.aqua.components.uncertainty_models.BernoulliDistribution.probabilities" signature="property probabilities">
  ...
  <Function id="qiskit.aqua.components.uncertainty_models.BernoulliDistribution.values" signature="property values">
    returns values
  </Function>
</Class>
