...
<Function id="qiskit.quantum_info.random_state" github="https://github.com/qiskit/qiskit/tree/stable/0.16/qiskit/quantum_info/states/random.py" signature="random_state(dim, seed=None)">
