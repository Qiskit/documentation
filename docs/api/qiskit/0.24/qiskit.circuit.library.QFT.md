...
`QFT(num_qubits=None, approximation_degree=0, do_swaps=True, inverse=False, insert_barriers=False, name='qft')` [GitHub](https://github.com/qiskit/qiskit/tree/stable/0.16/qiskit/circuit/library/basis_change/qft.py "view source code")
...
| [`assign_parameters`](#qiskit.circuit.library.QFT.assign_parameters "qiskit.circuit.library.QFT.assign_parameters")(param\_dict\[, inplace])                      | Assign parameters to new parameters or values.                                                                                      |
| [`barrier`](#qiskit.circuit.library.QFT.barrier "qiskit.circuit.library.QFT.barrier")(\*qargs)                                                                    | Apply `Barrier`.                                                                                                                    |
| [`bind_parameters`](#qiskit.circuit.library.QFT.bind_parameters "qiskit.circuit.library.QFT.bind_parameters")(value\_dict)                                        | Assign numeric parameters to values yielding a new circuit.                                                                         |
...
| [`combine`](#qiskit.circuit.library.QFT.combine "qiskit.circuit.library.QFT.combine")(rhs)                                                                        | Append rhs to self if self contains compatible registers.                                                                           |
...
| [`diag_gate`](#qiskit.circuit.library.QFT.diag_gate "qiskit.circuit.library.QFT.diag_gate")(diag, qubit)                                                          | Deprecated version of QuantumCircuit.diagonal.                                                                                      |
...
| [`extend`](#qiskit.circuit.library.QFT.extend "qiskit.circuit.library.QFT.extend")(rhs)                                                                           | Append QuantumCircuit to the right hand side if it contains compatible registers.                                                   |
...
| [`hamiltonian`](#qiskit.circuit.library.QFT.hamiltonian "qiskit.circuit.library.QFT.hamiltonian")(operator, time, qubits\[, label])                               | Apply hamiltonian evolution to to qubits.                                                                                           |
...
| [`initialize`](#qiskit.circuit.library.QFT.initialize "qiskit.circuit.library.QFT.initialize")(params, qubits)                                                    | Apply initialize to circuit.                                                                                                        |
...
| [`mcmt`](#qiskit.circuit.library.QFT.mcmt "qiskit.circuit.library.QFT.mcmt")(gate, control\_qubits, target\_qubits\[, …])                                         | Apply a multi-control, multi-target using a generic gate.                                                                           |
...
| [`mcry`](#qiskit.circuit.library.QFT.mcry "qiskit.circuit.library.QFT.mcry")(theta, q\_controls, q\_target, q\_ancillae)                                          | Apply Multiple-Controlled Y rotation gate                                                                                           |
...
| [`mirror`](#qiskit.circuit.library.QFT.mirror "qiskit.circuit.library.QFT.mirror")()                                                                              | DEPRECATED: use circuit.reverse\_ops().                                                                                             |
...
| [`r`](#qiskit.circuit.library.QFT.r "qiskit.circuit.library.QFT.r")(theta, phi, qubit)                                                                            | Apply `RGate`.                                                                                                                      |
...
<span id="qiskit.circuit.library.QFT.diag_gate" />
...
<span id="qiskit.circuit.library.QFT.mcmt" />
...
<span id="qiskit.circuit.library.QFT.mirror" />
