...
<Function id="qiskit.converters.dag_to_dagdependency" name="dag_to_dagdependency" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.16/qiskit/converters/dag_to_dagdependency.py" signature="dag_to_dagdependency(dag)">
