...
<Class id="qiskit.transpiler.passes.DAGLongestPath" github="https://github.com/qiskit/qiskit/tree/stable/0.16/qiskit/transpiler/passes/analysis/dag_longest_path.py" signature="DAGLongestPath(*args, **kwargs)">
