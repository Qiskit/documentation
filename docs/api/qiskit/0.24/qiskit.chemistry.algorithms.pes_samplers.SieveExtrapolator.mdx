...
<Class id="qiskit.chemistry.algorithms.pes_samplers.SieveExtrapolator" github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.8/qiskit/chemistry/algorithms/pes_samplers/extrapolator.py" signature="SieveExtrapolator(extrapolator=None, window=2, filter_before=True, filter_after=True)">
  ...
  *   **filter\_after** (`bool`) – Keyword to perform clustering after extrapolation.
  ...
  <Function id="qiskit.chemistry.algorithms.pes_samplers.SieveExtrapolator.__init__" name="__init__" signature="__init__(extrapolator=None, window=2, filter_before=True, filter_after=True)">
    Constructor.
  ...
  <Function id="qiskit.chemistry.algorithms.pes_samplers.SieveExtrapolator.extrapolate" name="extrapolate" signature="extrapolate(points, param_dict)">
  ...
  <Function id="qiskit.chemistry.algorithms.pes_samplers.SieveExtrapolator.factory" name="factory" signature="static factory(mode, **kwargs)">
