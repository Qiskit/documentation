...
<Class id="qiskit.aqua.operators.legacy.Z2Symmetries" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.8/qiskit/aqua/operators/legacy/weighted_pauli_operator.py" signature="Z2Symmetries(symmetries, sq_paulis, sq_list, tapering_values=None)">
  Z2 Symmetries
  ...
  **Raises**
  ...
  <Function id="qiskit.aqua.operators.legacy.Z2Symmetries.__init__" name="__init__" signature="__init__(symmetries, sq_paulis, sq_list, tapering_values=None)">
    **Parameters**
  ...
  <Function id="qiskit.aqua.operators.legacy.Z2Symmetries.cliffords" name="cliffords" signature="property cliffords">
  ...
  <Function id="qiskit.aqua.operators.legacy.Z2Symmetries.consistent_tapering" name="consistent_tapering" signature="consistent_tapering(operator)">
  ...
  <Function id="qiskit.aqua.operators.legacy.Z2Symmetries.copy" name="copy" signature="copy()">
    Get a copy of self.
  ...
  <Function id="qiskit.aqua.operators.legacy.Z2Symmetries.find_Z2_symmetries" name="find_Z2_symmetries" signature="classmethod find_Z2_symmetries(operator)">
  ...
  <Function id="qiskit.aqua.operators.legacy.Z2Symmetries.is_empty" name="is_empty" signature="is_empty()">
  ...
  <Function id="qiskit.aqua.operators.legacy.Z2Symmetries.sq_list" name="sq_list" signature="property sq_list">
    returns sq list
  </Function>

  ### sq\_paulis

  <Function id="qiskit.aqua.operators.legacy.Z2Symmetries.sq_paulis" name="sq_paulis" signature="property sq_paulis">
    returns sq paulis
  </Function>

  ### symmetries

  <Function id="qiskit.aqua.operators.legacy.Z2Symmetries.symmetries" name="symmetries" signature="property symmetries">
    return symmetries
  </Function>

  ### taper

  <Function id="qiskit.aqua.operators.legacy.Z2Symmetries.taper" name="taper" signature="taper(operator, tapering_values=None)">
  ...
  <Function id="qiskit.aqua.operators.legacy.Z2Symmetries.tapering_values" name="tapering_values" signature="property tapering_values">
    returns tapering values
  </Function>

  ### two\_qubit\_reduction

  <Function id="qiskit.aqua.operators.legacy.Z2Symmetries.two_qubit_reduction" name="two_qubit_reduction" signature="static two_qubit_reduction(operator, num_particles)">
