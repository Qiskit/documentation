...
<Class id="qiskit.aqua.operators.legacy.Z2Symmetries" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.8/qiskit/aqua/operators/legacy/weighted_pauli_operator.py" signature="Z2Symmetries(symmetries, sq_paulis, sq_list, tapering_values=None)">
  ...
  **Raises**
  ...
  <Function id="qiskit.aqua.operators.legacy.Z2Symmetries.cliffords" signature="property cliffords">
  ...
  <Function id="qiskit.aqua.operators.legacy.Z2Symmetries.find_Z2_symmetries" signature="classmethod find_Z2_symmetries(operator)">
  ...
  <Function id="qiskit.aqua.operators.legacy.Z2Symmetries.sq_list" signature="property sq_list">
    returns sq list
  </Function>

  ### sq\_paulis

  <Function id="qiskit.aqua.operators.legacy.Z2Symmetries.sq_paulis" signature="property sq_paulis">
    returns sq paulis
  </Function>

  ### symmetries

  <Function id="qiskit.aqua.operators.legacy.Z2Symmetries.symmetries" signature="property symmetries">
    return symmetries
  </Function>
  ...
  <Function id="qiskit.aqua.operators.legacy.Z2Symmetries.tapering_values" signature="property tapering_values">
    returns tapering values
  </Function>

  ### two\_qubit\_reduction

  <Function id="qiskit.aqua.operators.legacy.Z2Symmetries.two_qubit_reduction" signature="static two_qubit_reduction(operator, num_particles)">
