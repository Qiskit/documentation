...
<Class id="qiskit.circuit.InstructionSet" github="https://github.com/qiskit/qiskit/tree/stable/0.16/qiskit/circuit/instructionset.py" signature="InstructionSet">
