---
title: IBMQBackend (v0.24)
description: API reference for qiskit.providers.ibmq.IBMQBackend in qiskit v0.24
...
<Class id="qiskit.providers.ibmq.IBMQBackend" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-ibmq-provider/tree/stable/0.12/qiskit/providers/ibmq/ibmqbackend.py" signature="IBMQBackend(configuration, provider, credentials, api_client)" modifiers="class">
  ...
  *   **api\_client** (`AccountClient`) – IBM Quantum Experience client used to communicate with the server.
  ...
  <Function id="qiskit.providers.ibmq.IBMQBackend.__init__" signature="__init__(configuration, provider, credentials, api_client)">
    IBMQBackend constructor.
  ...
  <Function id="qiskit.providers.ibmq.IBMQBackend.active_jobs" signature="active_jobs(limit=10)">
  ...
  <Function id="qiskit.providers.ibmq.IBMQBackend.configuration" signature="configuration()">
  ...
  <Function id="qiskit.providers.ibmq.IBMQBackend.defaults" signature="defaults(refresh=False)">
  ...
  <Function id="qiskit.providers.ibmq.IBMQBackend.job_limit" signature="job_limit()">
  ...
  <Function id="qiskit.providers.ibmq.IBMQBackend.jobs" signature="jobs(limit=10, skip=0, status=None, job_name=None, start_datetime=None, end_datetime=None, job_tags=None, job_tags_operator='OR', experiment_id=None, descending=True, db_filter=None)">
  ...
  <Function id="qiskit.providers.ibmq.IBMQBackend.name" signature="name()">
  ...
  <Function id="qiskit.providers.ibmq.IBMQBackend.properties" signature="properties(refresh=False, datetime=None)">
  ...
  <Function id="qiskit.providers.ibmq.IBMQBackend.provider" signature="provider()">
  ...
  <Function id="qiskit.providers.ibmq.IBMQBackend.remaining_jobs_count" signature="remaining_jobs_count()">
  ...
  <Function id="qiskit.providers.ibmq.IBMQBackend.reservations" signature="reservations(start_datetime=None, end_datetime=None)">
  ...
  <Function id="qiskit.providers.ibmq.IBMQBackend.retrieve_job" signature="retrieve_job(job_id)">
  ...
  <Function id="qiskit.providers.ibmq.IBMQBackend.set_options" signature="set_options(**fields)">
  ...
  <Function id="qiskit.providers.ibmq.IBMQBackend.status" signature="status()">
