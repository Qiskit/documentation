...
<Function id="qiskit.pulse.builder.set_frequency" github="https://github.com/qiskit/qiskit/tree/stable/0.16/qiskit/pulse/builder.py" signature="set_frequency(frequency, channel)">
