...
<Class id="qiskit.aqua.algorithms.IterativeAmplitudeEstimationResult" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.8/qiskit/aqua/algorithms/amplitude_estimators/iqae.py" signature="IterativeAmplitudeEstimationResult(a_dict=None)">
  ...
  <Function id="qiskit.aqua.algorithms.IterativeAmplitudeEstimationResult.a_estimation" signature="property a_estimation">
  ...
  <Function id="qiskit.aqua.algorithms.IterativeAmplitudeEstimationResult.a_intervals" signature="property a_intervals">
    return a\_intervals
  ...
  <Function id="qiskit.aqua.algorithms.IterativeAmplitudeEstimationResult.actual_epsilon" signature="property actual_epsilon">
    return mle
  ...
  <Function id="qiskit.aqua.algorithms.IterativeAmplitudeEstimationResult.alpha" signature="property alpha">
    return alpha
  ...
  <Function id="qiskit.aqua.algorithms.IterativeAmplitudeEstimationResult.confidence_interval" signature="property confidence_interval">
  ...
  <Function id="qiskit.aqua.algorithms.IterativeAmplitudeEstimationResult.estimation" signature="property estimation">
    return estimation
  ...
  <Function id="qiskit.aqua.algorithms.IterativeAmplitudeEstimationResult.from_dict" signature="static from_dict(a_dict)">
  ...
  <Function id="qiskit.aqua.algorithms.IterativeAmplitudeEstimationResult.num_oracle_queries" signature="property num_oracle_queries">
  ...
  <Function id="qiskit.aqua.algorithms.IterativeAmplitudeEstimationResult.powers" signature="property powers">
    return powers
  ...
  <Function id="qiskit.aqua.algorithms.IterativeAmplitudeEstimationResult.ratios" signature="property ratios">
    return ratios
  ...
  <Function id="qiskit.aqua.algorithms.IterativeAmplitudeEstimationResult.theta_intervals" signature="property theta_intervals">
  ...
  <Function id="qiskit.aqua.algorithms.IterativeAmplitudeEstimationResult.value_confidence_interval" signature="property value_confidence_interval">
