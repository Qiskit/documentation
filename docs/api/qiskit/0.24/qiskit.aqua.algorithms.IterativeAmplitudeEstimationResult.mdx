...
<Class id="qiskit.aqua.algorithms.IterativeAmplitudeEstimationResult" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.8/qiskit/aqua/algorithms/amplitude_estimators/iqae.py" signature="IterativeAmplitudeEstimationResult(a_dict=None)">
  IterativeAmplitudeEstimation Result.

  ### \_\_init\_\_

  <Function id="qiskit.aqua.algorithms.IterativeAmplitudeEstimationResult.__init__" name="__init__" signature="__init__(a_dict=None)">
  ...
  <Function id="qiskit.aqua.algorithms.IterativeAmplitudeEstimationResult.a_estimation" name="a_estimation" signature="property a_estimation">
  ...
  <Function id="qiskit.aqua.algorithms.IterativeAmplitudeEstimationResult.a_intervals" name="a_intervals" signature="property a_intervals">
    return a\_intervals
  ...
  <Function id="qiskit.aqua.algorithms.IterativeAmplitudeEstimationResult.actual_epsilon" name="actual_epsilon" signature="property actual_epsilon">
    return mle
  ...
  <Function id="qiskit.aqua.algorithms.IterativeAmplitudeEstimationResult.alpha" name="alpha" signature="property alpha">
    return alpha
  ...
  <Function id="qiskit.aqua.algorithms.IterativeAmplitudeEstimationResult.clear" name="clear" signature="clear()">
    **Return type**
  ...
  <Function id="qiskit.aqua.algorithms.IterativeAmplitudeEstimationResult.combine" name="combine" signature="combine(result)">
  ...
  <Function id="qiskit.aqua.algorithms.IterativeAmplitudeEstimationResult.confidence_interval" name="confidence_interval" signature="property confidence_interval">
  ...
  <Function id="qiskit.aqua.algorithms.IterativeAmplitudeEstimationResult.estimation" name="estimation" signature="property estimation">
    return estimation
  ...
  <Function id="qiskit.aqua.algorithms.IterativeAmplitudeEstimationResult.from_dict" name="from_dict" signature="static from_dict(a_dict)">
  ...
  <Function id="qiskit.aqua.algorithms.IterativeAmplitudeEstimationResult.get" name="get" signature="get(k[, d]) → D[k] if k in D, else d. d defaults to None." />

  ### items

  <Function id="qiskit.aqua.algorithms.IterativeAmplitudeEstimationResult.items" name="items" signature="items() → a set-like object providing a view on D’s items" />

  ### keys

  <Function id="qiskit.aqua.algorithms.IterativeAmplitudeEstimationResult.keys" name="keys" signature="keys() → a set-like object providing a view on D’s keys" />

  ### num\_oracle\_queries

  <Function id="qiskit.aqua.algorithms.IterativeAmplitudeEstimationResult.num_oracle_queries" name="num_oracle_queries" signature="property num_oracle_queries">
  ...
  <Function id="qiskit.aqua.algorithms.IterativeAmplitudeEstimationResult.pop" name="pop" signature="pop(key, default=None)">
  ...
  <Function id="qiskit.aqua.algorithms.IterativeAmplitudeEstimationResult.popitem" name="popitem" signature="popitem()">
  ...
  <Function id="qiskit.aqua.algorithms.IterativeAmplitudeEstimationResult.powers" name="powers" signature="property powers">
    return powers
  ...
  <Function id="qiskit.aqua.algorithms.IterativeAmplitudeEstimationResult.ratios" name="ratios" signature="property ratios">
    return ratios
  ...
  <Function id="qiskit.aqua.algorithms.IterativeAmplitudeEstimationResult.setdefault" name="setdefault" signature="setdefault(k[, d]) → D.get(k,d), also set D[k]=d if k not in D" />

  ### theta\_intervals

  <Function id="qiskit.aqua.algorithms.IterativeAmplitudeEstimationResult.theta_intervals" name="theta_intervals" signature="property theta_intervals">
  ...
  <Function id="qiskit.aqua.algorithms.IterativeAmplitudeEstimationResult.update" name="update" signature="update(*args, **kwargs)">
  ...
  <Function id="qiskit.aqua.algorithms.IterativeAmplitudeEstimationResult.value_confidence_interval" name="value_confidence_interval" signature="property value_confidence_interval">
  ...
  <Function id="qiskit.aqua.algorithms.IterativeAmplitudeEstimationResult.values" name="values" signature="values() → an object providing a view on D’s values" />
</Class>
