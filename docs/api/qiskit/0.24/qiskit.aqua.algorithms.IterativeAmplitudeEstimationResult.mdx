...
<Class id="qiskit.aqua.algorithms.IterativeAmplitudeEstimationResult" github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.8/qiskit/aqua/algorithms/amplitude_estimators/iqae.py" signature="IterativeAmplitudeEstimationResult(a_dict=None)">
