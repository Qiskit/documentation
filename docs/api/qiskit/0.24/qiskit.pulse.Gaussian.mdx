...
<Class id="qiskit.pulse.Gaussian" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.16/qiskit/pulse/library/parametric_pulses.py" signature="Gaussian(duration, amp, sigma, name=None)">
...
$$
  ...
  *   **name** (`Optional`\[`str`]) – Display name for this pulse envelope.
  ...
  <Function id="qiskit.pulse.Gaussian.draw" name="draw" signature="draw(dt=1, style=None, filename=None, interp_method=None, scale=1, interactive=False)">
    Plot the pulse.
  ...
  <Function id="qiskit.pulse.Gaussian.get_sample_pulse" name="get_sample_pulse" signature="get_sample_pulse()">
    Deprecated.
