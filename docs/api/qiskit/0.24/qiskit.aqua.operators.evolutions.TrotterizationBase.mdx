...
<Class id="qiskit.aqua.operators.evolutions.TrotterizationBase" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.8/qiskit/aqua/operators/evolutions/trotterizations/trotterization_base.py" signature="TrotterizationBase(reps=1)">
  ...
  <Function id="qiskit.aqua.operators.evolutions.TrotterizationBase.convert" signature="abstract convert(operator)">
  ...
  <Function id="qiskit.aqua.operators.evolutions.TrotterizationBase.reps" signature="property reps">
