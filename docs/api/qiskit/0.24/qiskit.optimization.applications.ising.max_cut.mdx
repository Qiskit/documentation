...
<Function id="qiskit.optimization.applications.ising.max_cut.get_graph_solution" name="get_graph_solution" github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.8/qiskit/optimization/applications/ising/max_cut.py" signature="get_graph_solution(x)">
...
<Function id="qiskit.optimization.applications.ising.max_cut.get_operator" name="get_operator" github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.8/qiskit/optimization/applications/ising/max_cut.py" signature="get_operator(weight_matrix)">
...
<Function id="qiskit.optimization.applications.ising.max_cut.max_cut_value" name="max_cut_value" github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.8/qiskit/optimization/applications/ising/max_cut.py" signature="max_cut_value(x, w)">
