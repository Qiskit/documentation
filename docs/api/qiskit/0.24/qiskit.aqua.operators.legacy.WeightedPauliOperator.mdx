...
<Class id="qiskit.aqua.operators.legacy.WeightedPauliOperator" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.8/qiskit/aqua/operators/legacy/weighted_pauli_operator.py" signature="WeightedPauliOperator(paulis, basis=None, z2_symmetries=None, atol=1e-12, name=None)">
  ...
  *   **name** (`Optional`\[`str`]) – the name of operator.
  ...
  <Function id="qiskit.aqua.operators.legacy.WeightedPauliOperator.__init__" name="__init__" signature="__init__(paulis, basis=None, z2_symmetries=None, atol=1e-12, name=None)">
    **Parameters**
  ...
  <Function id="qiskit.aqua.operators.legacy.WeightedPauliOperator.add" name="add" signature="add(other, copy=False)">
    Perform self + other.
  ...
  <Function id="qiskit.aqua.operators.legacy.WeightedPauliOperator.anticommute_with" name="anticommute_with" signature="anticommute_with(other)">
    Anti commutes with
  </Function>

  ### atol

  <Function id="qiskit.aqua.operators.legacy.WeightedPauliOperator.atol" name="atol" signature="property atol">
    get atol
  </Function>

  ### basis

  <Function id="qiskit.aqua.operators.legacy.WeightedPauliOperator.basis" name="basis" signature="property basis">
    returns basis
  </Function>

  ### chop

  <Function id="qiskit.aqua.operators.legacy.WeightedPauliOperator.chop" name="chop" signature="chop(threshold=None, copy=False)">
  ...
  <Function id="qiskit.aqua.operators.legacy.WeightedPauliOperator.commute_with" name="commute_with" signature="commute_with(other)">
    Commutes with
  </Function>

  ### construct\_evaluation\_circuit

  <Function id="qiskit.aqua.operators.legacy.WeightedPauliOperator.construct_evaluation_circuit" name="construct_evaluation_circuit" signature="construct_evaluation_circuit(wave_function, statevector_mode, qr=None, cr=None, use_simulator_snapshot_mode=False, circuit_name_prefix='')">
  ...
  <Function id="qiskit.aqua.operators.legacy.WeightedPauliOperator.copy" name="copy" signature="copy()">
    Get a copy of self
  </Function>

  ### evaluate\_with\_result

  <Function id="qiskit.aqua.operators.legacy.WeightedPauliOperator.evaluate_with_result" name="evaluate_with_result" signature="evaluate_with_result(result, statevector_mode, use_simulator_snapshot_mode=False, circuit_name_prefix='')">
  ...
  <Function id="qiskit.aqua.operators.legacy.WeightedPauliOperator.evaluate_with_statevector" name="evaluate_with_statevector" signature="evaluate_with_statevector(quantum_state)">
    **Parameters**
  ...
  <Function id="qiskit.aqua.operators.legacy.WeightedPauliOperator.evaluation_instruction" name="evaluation_instruction" signature="evaluation_instruction(statevector_mode, use_simulator_snapshot_mode=False)">
    **Parameters**
  ...
  <Function id="qiskit.aqua.operators.legacy.WeightedPauliOperator.evolve" name="evolve" signature="evolve(state_in=None, evo_time=0, num_time_slices=1, quantum_registers=None, expansion_mode='trotter', expansion_order=1)">
  ...
  <Function id="qiskit.aqua.operators.legacy.WeightedPauliOperator.evolve_instruction" name="evolve_instruction" signature="evolve_instruction(evo_time=0, num_time_slices=1, expansion_mode='trotter', expansion_order=1)">
    Carry out the eoh evolution for the operator under supplied specifications.
  ...
  <Function id="qiskit.aqua.operators.legacy.WeightedPauliOperator.from_dict" name="from_dict" signature="classmethod from_dict(dictionary, before_04=False)">
  ...
  <Function id="qiskit.aqua.operators.legacy.WeightedPauliOperator.from_file" name="from_file" signature="classmethod from_file(file_name, before_04=False)">
  ...
  <Function id="qiskit.aqua.operators.legacy.WeightedPauliOperator.from_list" name="from_list" signature="classmethod from_list(paulis, weights=None, name=None)">
  ...
  <Function id="qiskit.aqua.operators.legacy.WeightedPauliOperator.is_empty" name="is_empty" signature="is_empty()">
  ...
  <Function id="qiskit.aqua.operators.legacy.WeightedPauliOperator.multiply" name="multiply" signature="multiply(other)">
  ...
  <Function id="qiskit.aqua.operators.legacy.WeightedPauliOperator.name" name="name" signature="property name">
    returns name
  </Function>

  ### num\_qubits

  <Function id="qiskit.aqua.operators.legacy.WeightedPauliOperator.num_qubits" name="num_qubits" signature="property num_qubits">
  ...
  <Function id="qiskit.aqua.operators.legacy.WeightedPauliOperator.paulis" name="paulis" signature="property paulis">
    get paulis
  </Function>

  ### print\_details

  <Function id="qiskit.aqua.operators.legacy.WeightedPauliOperator.print_details" name="print_details" signature="print_details()">
  ...
  <Function id="qiskit.aqua.operators.legacy.WeightedPauliOperator.reorder_paulis" name="reorder_paulis" signature="reorder_paulis()">
  ...
  <Function id="qiskit.aqua.operators.legacy.WeightedPauliOperator.rounding" name="rounding" signature="rounding(decimals, copy=False)">
    Rounding the weight.
  ...
  <Function id="qiskit.aqua.operators.legacy.WeightedPauliOperator.simplify" name="simplify" signature="simplify(copy=False)">
  ...
  <Function id="qiskit.aqua.operators.legacy.WeightedPauliOperator.sub" name="sub" signature="sub(other, copy=False)">
    Perform self - other.
  ...
  <Function id="qiskit.aqua.operators.legacy.WeightedPauliOperator.to_dict" name="to_dict" signature="to_dict()">
  ...
  <Function id="qiskit.aqua.operators.legacy.WeightedPauliOperator.to_file" name="to_file" signature="to_file(file_name)">
  ...
  <Function id="qiskit.aqua.operators.legacy.WeightedPauliOperator.to_opflow" name="to_opflow" signature="to_opflow(reverse_endianness=False)">
    to op flow
  </Function>

  ### z2\_symmetries

  <Function id="qiskit.aqua.operators.legacy.WeightedPauliOperator.z2_symmetries" name="z2_symmetries" signature="property z2_symmetries">
