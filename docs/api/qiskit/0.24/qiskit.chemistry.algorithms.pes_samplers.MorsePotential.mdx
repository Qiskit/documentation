...
<Class id="qiskit.chemistry.algorithms.pes_samplers.MorsePotential" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.8/qiskit/chemistry/algorithms/pes_samplers/potentials/morse_potential.py" signature="MorsePotential(molecule)">
  ...
  **ValueError** – Only implemented for diatomic molecules
  ...
  <Function id="qiskit.chemistry.algorithms.pes_samplers.MorsePotential.__init__" name="__init__" signature="__init__(molecule)">
    Initializes the potential to the zero-function. [`fit()`](#qiskit.chemistry.algorithms.pes_samplers.MorsePotential.fit "qiskit.chemistry.algorithms.pes_samplers.MorsePotential.fit") should be used afterwards to fit the potential to computed molecular energies.
  ...
  <Function id="qiskit.chemistry.algorithms.pes_samplers.MorsePotential.dissociation_energy" name="dissociation_energy" signature="dissociation_energy(scaling=1.0)">
  ...
  <Function id="qiskit.chemistry.algorithms.pes_samplers.MorsePotential.eval" name="eval" signature="eval(x)">
  ...
  <Function id="qiskit.chemistry.algorithms.pes_samplers.MorsePotential.fit" name="fit" signature="fit(xdata, ydata, initial_vals=None, bounds_list=None)">
  ...
  <Function id="qiskit.chemistry.algorithms.pes_samplers.MorsePotential.fit_function" name="fit_function" signature="static fit_function(x, d_e, alpha, r_0, m_shift)">
  ...
  <Function id="qiskit.chemistry.algorithms.pes_samplers.MorsePotential.fundamental_frequency" name="fundamental_frequency" signature="fundamental_frequency()">
  ...
  <Function id="qiskit.chemistry.algorithms.pes_samplers.MorsePotential.get_equilibrium_geometry" name="get_equilibrium_geometry" signature="get_equilibrium_geometry(scaling=1.0)">
  ...
  <Function id="qiskit.chemistry.algorithms.pes_samplers.MorsePotential.get_maximum_trusted_level" name="get_maximum_trusted_level" signature="get_maximum_trusted_level(n=0)">
  ...
  <Function id="qiskit.chemistry.algorithms.pes_samplers.MorsePotential.get_minimal_energy" name="get_minimal_energy" signature="get_minimal_energy(scaling=1.0)">
  ...
  <Function id="qiskit.chemistry.algorithms.pes_samplers.MorsePotential.get_num_modes" name="get_num_modes" signature="get_num_modes()">
  ...
  <Function id="qiskit.chemistry.algorithms.pes_samplers.MorsePotential.get_trust_region" name="get_trust_region" signature="get_trust_region()">
  ...
  <Function id="qiskit.chemistry.algorithms.pes_samplers.MorsePotential.update_molecule" name="update_molecule" signature="update_molecule(molecule)">
  ...
  <Function id="qiskit.chemistry.algorithms.pes_samplers.MorsePotential.vibrational_energy_level" name="vibrational_energy_level" signature="vibrational_energy_level(n)">
  ...
  <Function id="qiskit.chemistry.algorithms.pes_samplers.MorsePotential.wave_number" name="wave_number" signature="wave_number()">
