...
<Class id="qiskit.chemistry.components.bosonic_bases.BosonicBasis" github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.8/qiskit/chemistry/components/bosonic_bases/bosonic_basis.py" signature="BosonicBasis">
