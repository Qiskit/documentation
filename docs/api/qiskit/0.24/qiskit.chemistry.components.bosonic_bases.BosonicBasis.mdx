...
<Class id="qiskit.chemistry.components.bosonic_bases.BosonicBasis" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.8/qiskit/chemistry/components/bosonic_bases/bosonic_basis.py" signature="BosonicBasis">
  Basis to express a second quantization Bosonic Hamiltonian.

  ### \_\_init\_\_

  <Function id="qiskit.chemistry.components.bosonic_bases.BosonicBasis.__init__" name="__init__" signature="__init__()">
  ...
  <Function id="qiskit.chemistry.components.bosonic_bases.BosonicBasis.convert" name="convert" signature="convert(threshold=1e-06)">
