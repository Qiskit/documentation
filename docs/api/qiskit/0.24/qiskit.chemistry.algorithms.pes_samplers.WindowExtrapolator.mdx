...
<Class id="qiskit.chemistry.algorithms.pes_samplers.WindowExtrapolator" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.8/qiskit/chemistry/algorithms/pes_samplers/extrapolator.py" signature="WindowExtrapolator(extrapolator=None, window=2)" modifiers="class">
  ...
  *   **window** (`int`) – Number of previous points to use for extrapolation. A value of zero indicates that all previous points will be used for bootstrapping.
  ...
  <Function id="qiskit.chemistry.algorithms.pes_samplers.WindowExtrapolator.extrapolator" signature="extrapolator" modifiers="property">
  ...
  <Function id="qiskit.chemistry.algorithms.pes_samplers.WindowExtrapolator.window" signature="window" modifiers="property">
