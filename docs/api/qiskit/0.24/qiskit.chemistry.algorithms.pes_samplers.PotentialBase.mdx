...
<Class id="qiskit.chemistry.algorithms.pes_samplers.PotentialBase" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.8/qiskit/chemistry/algorithms/pes_samplers/potentials/potential_base.py" signature="PotentialBase(molecule)">
  Class to hold prescribed 1D potentials (e.g. Morse/Harmonic) over a degree of freedom.

  ### \_\_init\_\_

  <Function id="qiskit.chemistry.algorithms.pes_samplers.PotentialBase.__init__" name="__init__" signature="__init__(molecule)">
  ...
  <Function id="qiskit.chemistry.algorithms.pes_samplers.PotentialBase.dissociation_energy" name="dissociation_energy" signature="abstract dissociation_energy(scaling=1.0)">
  ...
  <Function id="qiskit.chemistry.algorithms.pes_samplers.PotentialBase.eval" name="eval" signature="abstract eval(x)">
  ...
  <Function id="qiskit.chemistry.algorithms.pes_samplers.PotentialBase.fit" name="fit" signature="abstract fit(xdata, ydata, initial_vals=None, bounds_list=None)">
  ...
  <Function id="qiskit.chemistry.algorithms.pes_samplers.PotentialBase.get_equilibrium_geometry" name="get_equilibrium_geometry" signature="abstract get_equilibrium_geometry(scaling=1.0)">
  ...
  <Function id="qiskit.chemistry.algorithms.pes_samplers.PotentialBase.get_maximum_trusted_level" name="get_maximum_trusted_level" signature="get_maximum_trusted_level(n=0)">
  ...
  <Function id="qiskit.chemistry.algorithms.pes_samplers.PotentialBase.get_minimal_energy" name="get_minimal_energy" signature="abstract get_minimal_energy(scaling=1.0)">
  ...
  <Function id="qiskit.chemistry.algorithms.pes_samplers.PotentialBase.get_num_modes" name="get_num_modes" signature="get_num_modes()">
  ...
  <Function id="qiskit.chemistry.algorithms.pes_samplers.PotentialBase.get_trust_region" name="get_trust_region" signature="get_trust_region()">
  ...
  <Function id="qiskit.chemistry.algorithms.pes_samplers.PotentialBase.update_molecule" name="update_molecule" signature="update_molecule(molecule)">
  ...
  <Function id="qiskit.chemistry.algorithms.pes_samplers.PotentialBase.vibrational_energy_level" name="vibrational_energy_level" signature="abstract vibrational_energy_level(n)">
