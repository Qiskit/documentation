...
<Class id="qiskit.aqua.operators.gradients.NaturalGradient" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.8/qiskit/aqua/operators/gradients/natural_gradient.py" signature="NaturalGradient(grad_method='lin_comb', qfi_method='lin_comb_full', regularization=None, **kwargs)">
  ...
  *   **kwargs** (*dict*) – Optional parameters for a CircuitGradient
  ...
  <Function id="qiskit.aqua.operators.gradients.NaturalGradient.__init__" name="__init__" signature="__init__(grad_method='lin_comb', qfi_method='lin_comb_full', regularization=None, **kwargs)">
    **Parameters**
  ...
  <Function id="qiskit.aqua.operators.gradients.NaturalGradient.convert" name="convert" signature="convert(operator, params=None)">
    **Parameters**
  ...
  <Function id="qiskit.aqua.operators.gradients.NaturalGradient.grad_method" name="grad_method" signature="property grad_method">
  ...
  <Function id="qiskit.aqua.operators.gradients.NaturalGradient.gradient_wrapper" name="gradient_wrapper" signature="gradient_wrapper(operator, bind_params, grad_params=None, backend=None)">
  ...
  <Function id="qiskit.aqua.operators.gradients.NaturalGradient.parameter_expression_grad" name="parameter_expression_grad" signature="static parameter_expression_grad(param_expr, param)">
  ...
  <Function id="qiskit.aqua.operators.gradients.NaturalGradient.qfi_method" name="qfi_method" signature="property qfi_method">
    Returns `CircuitQFI`.
  ...
  <Function id="qiskit.aqua.operators.gradients.NaturalGradient.regularization" name="regularization" signature="property regularization">
