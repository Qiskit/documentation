...
$$
  ...
  *   **i\_objective** (`Optional`\[`int`]) – index of target qubit to apply the rotation to
  ...
  <Function id="qiskit.aqua.components.uncertainty_problems.UnivariatePiecewiseLinearObjective.num_target_qubits" signature="num_target_qubits" modifiers="property">
