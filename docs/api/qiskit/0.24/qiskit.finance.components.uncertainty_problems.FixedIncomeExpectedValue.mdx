---
title: FixedIncomeExpectedValue (v0.24)
description: API reference for qiskit.finance.components.uncertainty_problems.FixedIncomeExpectedValue in qiskit v0.24
