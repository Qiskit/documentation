...
<Class id="qiskit.chemistry.algorithms.QEomVQE" github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.8/qiskit/chemistry/algorithms/eigen_solvers/q_eom_vqe.py" signature="QEomVQE(operator, var_form, optimizer, num_orbitals, num_particles, initial_point=None, max_evals_grouped=1, callback=None, qubit_mapping='parity', two_qubit_reduction=True, is_eom_matrix_symmetric=True, active_occupied=None, active_unoccupied=None, se_list=None, de_list=None, z2_symmetries=None, untapered_op=None, aux_operators=None, quantum_instance=None)">
  ...
  **ValueError** – invalid parameter
  ...
  <Function id="qiskit.chemistry.algorithms.QEomVQE.__init__" name="__init__" signature="__init__(operator, var_form, optimizer, num_orbitals, num_particles, initial_point=None, max_evals_grouped=1, callback=None, qubit_mapping='parity', two_qubit_reduction=True, is_eom_matrix_symmetric=True, active_occupied=None, active_unoccupied=None, se_list=None, de_list=None, z2_symmetries=None, untapered_op=None, aux_operators=None, quantum_instance=None)">
    **Parameters**
  ...
  <Function id="qiskit.chemistry.algorithms.QEomVQE.aux_operators" name="aux_operators" signature="property aux_operators">
  ...
  <Function id="qiskit.chemistry.algorithms.QEomVQE.backend" name="backend" signature="property backend">
    Returns backend.
  ...
  <Function id="qiskit.chemistry.algorithms.QEomVQE.cleanup_parameterized_circuits" name="cleanup_parameterized_circuits" signature="cleanup_parameterized_circuits()">
    set parameterized circuits to None
  </Function>

  ### compute\_minimum\_eigenvalue

  <Function id="qiskit.chemistry.algorithms.QEomVQE.compute_minimum_eigenvalue" name="compute_minimum_eigenvalue" signature="compute_minimum_eigenvalue(operator=None, aux_operators=None)">
  ...
  <Function id="qiskit.chemistry.algorithms.QEomVQE.construct_circuit" name="construct_circuit" signature="construct_circuit(parameter)">
  ...
  <Function id="qiskit.chemistry.algorithms.QEomVQE.construct_expectation" name="construct_expectation" signature="construct_expectation(parameter)">
  ...
  <Function id="qiskit.chemistry.algorithms.QEomVQE.expectation" name="expectation" signature="property expectation">
  ...
  <Function id="qiskit.chemistry.algorithms.QEomVQE.find_minimum" name="find_minimum" signature="find_minimum(initial_point=None, var_form=None, cost_fn=None, optimizer=None, gradient_fn=None)">
  ...
  <Function id="qiskit.chemistry.algorithms.QEomVQE.get_optimal_circuit" name="get_optimal_circuit" signature="get_optimal_circuit()">
  ...
  <Function id="qiskit.chemistry.algorithms.QEomVQE.get_optimal_cost" name="get_optimal_cost" signature="get_optimal_cost()">
  ...
  <Function id="qiskit.chemistry.algorithms.QEomVQE.get_optimal_vector" name="get_optimal_vector" signature="get_optimal_vector()">
  ...
  <Function id="qiskit.chemistry.algorithms.QEomVQE.get_prob_vector_for_params" name="get_prob_vector_for_params" signature="get_prob_vector_for_params(construct_circuit_fn, params_s, quantum_instance, construct_circuit_args=None)">
    Helper function to get probability vectors for a set of params
  </Function>

  ### get\_probabilities\_for\_counts

  <Function id="qiskit.chemistry.algorithms.QEomVQE.get_probabilities_for_counts" name="get_probabilities_for_counts" signature="get_probabilities_for_counts(counts)">
    get probabilities for counts
  </Function>

  ### initial\_point

  <Function id="qiskit.chemistry.algorithms.QEomVQE.initial_point" name="initial_point" signature="property initial_point">
  ...
  <Function id="qiskit.chemistry.algorithms.QEomVQE.operator" name="operator" signature="property operator">
    Returns operator
  ...
  <Function id="qiskit.chemistry.algorithms.QEomVQE.optimal_params" name="optimal_params" signature="property optimal_params">
  ...
  <Function id="qiskit.chemistry.algorithms.QEomVQE.optimizer" name="optimizer" signature="property optimizer">
    Returns optimizer
  ...
  <Function id="qiskit.chemistry.algorithms.QEomVQE.print_settings" name="print_settings" signature="print_settings()">
  ...
  <Function id="qiskit.chemistry.algorithms.QEomVQE.quantum_instance" name="quantum_instance" signature="property quantum_instance">
  ...
  <Function id="qiskit.chemistry.algorithms.QEomVQE.random" name="random" signature="property random">
    Return a numpy random.
  </Function>

  ### run

  <Function id="qiskit.chemistry.algorithms.QEomVQE.run" name="run" signature="run(quantum_instance=None, **kwargs)">
  ...
  <Function id="qiskit.chemistry.algorithms.QEomVQE.set_backend" name="set_backend" signature="set_backend(backend, **kwargs)">
  ...
  <Function id="qiskit.chemistry.algorithms.QEomVQE.setting" name="setting" signature="property setting">
    Prepare the setting of VQE as a string.
  </Function>

  ### supports\_aux\_operators

  <Function id="qiskit.chemistry.algorithms.QEomVQE.supports_aux_operators" name="supports_aux_operators" signature="classmethod supports_aux_operators()">
  ...
  <Function id="qiskit.chemistry.algorithms.QEomVQE.var_form" name="var_form" signature="property var_form">
