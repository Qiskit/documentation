...
<Class id="qiskit.transpiler.passes.RemoveResetInZeroState" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.16/qiskit/transpiler/passes/optimization/remove_reset_in_zero_state.py" signature="RemoveResetInZeroState(*args, **kwargs)" modifiers="class">
  ...
  <Function id="qiskit.transpiler.passes.RemoveResetInZeroState.is_analysis_pass" signature="is_analysis_pass" modifiers="property">
  ...
  <Function id="qiskit.transpiler.passes.RemoveResetInZeroState.is_transformation_pass" signature="is_transformation_pass" modifiers="property">
