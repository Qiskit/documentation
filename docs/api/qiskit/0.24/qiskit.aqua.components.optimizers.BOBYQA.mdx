...
<Class id="qiskit.aqua.components.optimizers.BOBYQA" github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.8/qiskit/aqua/components/optimizers/bobyqa.py" signature="BOBYQA(maxiter=1000)">
