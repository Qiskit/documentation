...
<Class id="qiskit.aqua.components.optimizers.BOBYQA" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.8/qiskit/aqua/components/optimizers/bobyqa.py" signature="BOBYQA(maxiter=1000)">
