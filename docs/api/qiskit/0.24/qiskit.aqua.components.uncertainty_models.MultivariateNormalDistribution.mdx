---
title: MultivariateNormalDistribution (v0.24)
description: API reference for qiskit.aqua.components.uncertainty_models.MultivariateNormalDistribution in qiskit v0.24
