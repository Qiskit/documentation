---
title: TensoredExpvalMeasMitigator (v0.24)
description: API reference for qiskit.ignis.mitigation.TensoredExpvalMeasMitigator in qiskit v0.24
...
<Class id="qiskit.ignis.mitigation.TensoredExpvalMeasMitigator" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-ignis/tree/stable/0.5/qiskit/ignis/mitigation/expval/tensored_mitigator.py" signature="TensoredExpvalMeasMitigator(amats)" modifiers="class">
