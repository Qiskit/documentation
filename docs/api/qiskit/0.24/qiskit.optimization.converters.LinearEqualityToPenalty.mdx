...
<Class id="qiskit.optimization.converters.LinearEqualityToPenalty" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.8/qiskit/optimization/converters/linear_equality_to_penalty.py" signature="LinearEqualityToPenalty(penalty=None)">
  ...
  **penalty** (`Optional`\[`float`]) – Penalty factor to scale equality constraints that are added to objective. If None is passed, penalty factor will be automatically calculated.
  ...
  <Function id="qiskit.optimization.converters.LinearEqualityToPenalty.__init__" name="__init__" signature="__init__(penalty=None)">
    **Parameters**
  ...
  <Function id="qiskit.optimization.converters.LinearEqualityToPenalty.convert" name="convert" signature="convert(problem)">
  ...
  <Function id="qiskit.optimization.converters.LinearEqualityToPenalty.decode" name="decode" signature="decode(result)">
  ...
  <Function id="qiskit.optimization.converters.LinearEqualityToPenalty.encode" name="encode" signature="encode(problem)">
  ...
  <Function id="qiskit.optimization.converters.LinearEqualityToPenalty.interpret" name="interpret" signature="interpret(result)">
  ...
  <Function id="qiskit.optimization.converters.LinearEqualityToPenalty.penalty" name="penalty" signature="property penalty">
