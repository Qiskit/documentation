---
title: stable_set (v0.24)
description: API reference for qiskit.optimization.applications.ising.stable_set in qiskit v0.24
...
<Function id="qiskit.optimization.applications.ising.stable_set.get_graph_solution" github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.8/qiskit/optimization/applications/ising/stable_set.py" signature="get_graph_solution(x)">
...
<Function id="qiskit.optimization.applications.ising.stable_set.get_operator" github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.8/qiskit/optimization/applications/ising/stable_set.py" signature="get_operator(w)">
...
<Function id="qiskit.optimization.applications.ising.stable_set.stable_set_value" github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.8/qiskit/optimization/applications/ising/stable_set.py" signature="stable_set_value(x, w)">
