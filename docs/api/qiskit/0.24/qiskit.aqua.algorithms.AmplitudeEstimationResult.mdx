...
<Class id="qiskit.aqua.algorithms.AmplitudeEstimationResult" github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.8/qiskit/aqua/algorithms/amplitude_estimators/ae.py" signature="AmplitudeEstimationResult(a_dict=None)">
