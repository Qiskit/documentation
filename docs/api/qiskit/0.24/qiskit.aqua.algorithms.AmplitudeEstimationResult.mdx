...
<Class id="qiskit.aqua.algorithms.AmplitudeEstimationResult" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.8/qiskit/aqua/algorithms/amplitude_estimators/ae.py" signature="AmplitudeEstimationResult(a_dict=None)">
  AmplitudeEstimation Result.

  ### \_\_init\_\_

  <Function id="qiskit.aqua.algorithms.AmplitudeEstimationResult.__init__" name="__init__" signature="__init__(a_dict=None)">
  ...
  <Function id="qiskit.aqua.algorithms.AmplitudeEstimationResult.a_estimation" name="a_estimation" signature="property a_estimation">
  ...
  <Function id="qiskit.aqua.algorithms.AmplitudeEstimationResult.a_samples" name="a_samples" signature="property a_samples">
    return a\_samples
  ...
  <Function id="qiskit.aqua.algorithms.AmplitudeEstimationResult.circuit_result" name="circuit_result" signature="property circuit_result">
  ...
  <Function id="qiskit.aqua.algorithms.AmplitudeEstimationResult.clear" name="clear" signature="clear()">
    **Return type**
  ...
  <Function id="qiskit.aqua.algorithms.AmplitudeEstimationResult.combine" name="combine" signature="combine(result)">
  ...
  <Function id="qiskit.aqua.algorithms.AmplitudeEstimationResult.confidence_interval" name="confidence_interval" signature="property confidence_interval">
  ...
  <Function id="qiskit.aqua.algorithms.AmplitudeEstimationResult.estimation" name="estimation" signature="property estimation">
    return estimation
  ...
  <Function id="qiskit.aqua.algorithms.AmplitudeEstimationResult.from_dict" name="from_dict" signature="static from_dict(a_dict)">
  ...
  <Function id="qiskit.aqua.algorithms.AmplitudeEstimationResult.get" name="get" signature="get(k[, d]) → D[k] if k in D, else d. d defaults to None." />

  ### items

  <Function id="qiskit.aqua.algorithms.AmplitudeEstimationResult.items" name="items" signature="items() → a set-like object providing a view on D’s items" />

  ### keys

  <Function id="qiskit.aqua.algorithms.AmplitudeEstimationResult.keys" name="keys" signature="keys() → a set-like object providing a view on D’s keys" />

  ### mapped\_a\_samples

  <Function id="qiskit.aqua.algorithms.AmplitudeEstimationResult.mapped_a_samples" name="mapped_a_samples" signature="property mapped_a_samples">
  ...
  <Function id="qiskit.aqua.algorithms.AmplitudeEstimationResult.mapped_values" name="mapped_values" signature="property mapped_values">
  ...
  <Function id="qiskit.aqua.algorithms.AmplitudeEstimationResult.max_probability" name="max_probability" signature="property max_probability">
  ...
  <Function id="qiskit.aqua.algorithms.AmplitudeEstimationResult.ml_value" name="ml_value" signature="property ml_value">
    returns ml\_value
  ...
  <Function id="qiskit.aqua.algorithms.AmplitudeEstimationResult.mle" name="mle" signature="property mle">
    return mle
  ...
  <Function id="qiskit.aqua.algorithms.AmplitudeEstimationResult.num_oracle_queries" name="num_oracle_queries" signature="property num_oracle_queries">
  ...
  <Function id="qiskit.aqua.algorithms.AmplitudeEstimationResult.pop" name="pop" signature="pop(key, default=None)">
  ...
  <Function id="qiskit.aqua.algorithms.AmplitudeEstimationResult.popitem" name="popitem" signature="popitem()">
  ...
  <Function id="qiskit.aqua.algorithms.AmplitudeEstimationResult.probabilities" name="probabilities" signature="property probabilities">
  ...
  <Function id="qiskit.aqua.algorithms.AmplitudeEstimationResult.setdefault" name="setdefault" signature="setdefault(k[, d]) → D.get(k,d), also set D[k]=d if k not in D" />

  ### shots

  <Function id="qiskit.aqua.algorithms.AmplitudeEstimationResult.shots" name="shots" signature="property shots">
    return shots
  ...
  <Function id="qiskit.aqua.algorithms.AmplitudeEstimationResult.update" name="update" signature="update(*args, **kwargs)">
  ...
  <Function id="qiskit.aqua.algorithms.AmplitudeEstimationResult.values" name="values" signature="values() → an object providing a view on D’s values" />

  ### y\_measurements

  <Function id="qiskit.aqua.algorithms.AmplitudeEstimationResult.y_measurements" name="y_measurements" signature="property y_measurements">
