---
title: covariance (v0.24)
description: API reference for qiskit.aqua.operators.legacy.covariance in qiskit v0.24
...
<Function id="qiskit.aqua.operators.legacy.covariance" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.8/qiskit/aqua/operators/legacy/common.py" signature="covariance(data, pauli_1, pauli_2, avg_1, avg_2)">
