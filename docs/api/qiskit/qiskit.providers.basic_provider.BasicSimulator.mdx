...
<Class id="qiskit.providers.basic_provider.BasicSimulator" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.1/qiskit/providers/basic_provider/basic_simulator.py#L66-L803" signature="qiskit.providers.basic_provider.BasicSimulator(provider=None, target=None, **fields)" modifiers="class">
  ...
  **Raises**
  ...
  <Function id="qiskit.providers.basic_provider.BasicSimulator.acquire_channel" github="https://github.com/Qiskit/qiskit/tree/stable/1.1/qiskit/providers/backend.py#L548-L561" signature="acquire_channel(qubit)">
  ...
  <Function id="qiskit.providers.basic_provider.BasicSimulator.control_channel" github="https://github.com/Qiskit/qiskit/tree/stable/1.1/qiskit/providers/backend.py#L563-L583" signature="control_channel(qubits)">
  ...
  <Function id="qiskit.providers.basic_provider.BasicSimulator.drive_channel" github="https://github.com/Qiskit/qiskit/tree/stable/1.1/qiskit/providers/backend.py#L518-L531" signature="drive_channel(qubit)">
  ...
  <Function id="qiskit.providers.basic_provider.BasicSimulator.measure_channel" github="https://github.com/Qiskit/qiskit/tree/stable/1.1/qiskit/providers/backend.py#L533-L546" signature="measure_channel(qubit)">
  ...
  <Function id="qiskit.providers.basic_provider.BasicSimulator.qubit_properties" github="https://github.com/Qiskit/qiskit/tree/stable/1.1/qiskit/providers/backend.py#L484-L516" signature="qubit_properties(qubit)">
  ...
  <Function id="qiskit.providers.basic_provider.BasicSimulator.set_options" github="https://github.com/Qiskit/qiskit/tree/stable/1.1/qiskit/providers/backend.py#L585-L602" signature="set_options(**fields)">
