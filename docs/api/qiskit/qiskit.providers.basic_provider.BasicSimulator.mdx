...
<Class id="qiskit.providers.basic_provider.BasicSimulator" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/providers/basic_provider/basic_simulator.py#L70-L810" signature="qiskit.providers.basic_provider.BasicSimulator(provider=None, target=None, **fields)" modifiers="class">
  ...
  **Raises**
  ...
  ### MAX\_QUBITS\_CLIFFORD <AttributeTypeHint>= 2048</AttributeTypeHint>

  <Attribute id="qiskit.providers.basic_provider.BasicSimulator.MAX_QUBITS_CLIFFORD" />

  ### MAX\_QUBITS\_STATEVECTOR <AttributeTypeHint>= 24</AttributeTypeHint>

  <Attribute id="qiskit.providers.basic_provider.BasicSimulator.MAX_QUBITS_STATEVECTOR" />
  ...
  <Attribute id="qiskit.providers.basic_provider.BasicSimulator.version" />
