...
<Class id="qiskit.providers.basic_provider.BasicSimulator" github="https://github.com/qiskit/qiskit/tree/stable/1.0/qiskit/providers/basic_provider/basic_simulator.py" signature="qiskit.providers.basic_provider.BasicSimulator(provider=None, target=None, **fields)">
  ...
  **Raises**
  ...
  <Function id="qiskit.providers.basic_provider.BasicSimulator.acquire_channel" name="acquire_channel" signature="acquire_channel(qubit)">
  ...
  <Function id="qiskit.providers.basic_provider.BasicSimulator.configuration" name="configuration" signature="configuration()">
  ...
  <Function id="qiskit.providers.basic_provider.BasicSimulator.control_channel" name="control_channel" signature="control_channel(qubits)">
  ...
  <Function id="qiskit.providers.basic_provider.BasicSimulator.drive_channel" name="drive_channel" signature="drive_channel(qubit)">
  ...
  <Function id="qiskit.providers.basic_provider.BasicSimulator.measure_channel" name="measure_channel" signature="measure_channel(qubit)">
  ...
  <Function id="qiskit.providers.basic_provider.BasicSimulator.qubit_properties" name="qubit_properties" signature="qubit_properties(qubit)">
  ...
  <Function id="qiskit.providers.basic_provider.BasicSimulator.run" name="run" signature="run(run_input, **backend_options)">
    Run on the backend.
  ...
  <Function id="qiskit.providers.basic_provider.BasicSimulator.run_experiment" name="run_experiment" signature="run_experiment(experiment)">
  ...
  <Function id="qiskit.providers.basic_provider.BasicSimulator.set_options" name="set_options" signature="set_options(**fields)">
