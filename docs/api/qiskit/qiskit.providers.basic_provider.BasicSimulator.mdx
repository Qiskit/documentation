...
<Class id="qiskit.providers.basic_provider.BasicSimulator" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.3/qiskit/providers/basic_provider/basic_simulator.py#L67-L821" signature="qiskit.providers.basic_provider.BasicSimulator(provider=None, target=None, **fields)" modifiers="class">
  ...
  **Raises**
  ...
  <Function id="qiskit.providers.basic_provider.BasicSimulator.acquire_channel" github="https://github.com/Qiskit/qiskit/tree/stable/1.3/qiskit/providers/backend.py#L566-L580" signature="acquire_channel(qubit)">
  ...
  <Function id="qiskit.providers.basic_provider.BasicSimulator.configuration" github="https://github.com/Qiskit/qiskit/tree/stable/1.3/qiskit/providers/basic_provider/basic_simulator.py#L216-L274" signature="configuration()">
  ...
  <Function id="qiskit.providers.basic_provider.BasicSimulator.control_channel" github="https://github.com/Qiskit/qiskit/tree/stable/1.3/qiskit/providers/backend.py#L582-L603" signature="control_channel(qubits)">
  ...
  <Function id="qiskit.providers.basic_provider.BasicSimulator.drive_channel" github="https://github.com/Qiskit/qiskit/tree/stable/1.3/qiskit/providers/backend.py#L534-L548" signature="drive_channel(qubit)">
  ...
  <Function id="qiskit.providers.basic_provider.BasicSimulator.measure_channel" github="https://github.com/Qiskit/qiskit/tree/stable/1.3/qiskit/providers/backend.py#L550-L564" signature="measure_channel(qubit)">
  ...
  <Function id="qiskit.providers.basic_provider.BasicSimulator.qubit_properties" github="https://github.com/Qiskit/qiskit/tree/stable/1.3/qiskit/providers/backend.py#L500-L532" signature="qubit_properties(qubit)">
  ...
  <Function id="qiskit.providers.basic_provider.BasicSimulator.run" github="https://github.com/Qiskit/qiskit/tree/stable/1.3/qiskit/providers/basic_provider/basic_simulator.py#L517-L561" signature="run(run_input, **backend_options)">
    Run on the backend.
  ...
  <Function id="qiskit.providers.basic_provider.BasicSimulator.run_experiment" github="https://github.com/Qiskit/qiskit/tree/stable/1.3/qiskit/providers/basic_provider/basic_simulator.py#L596-L800" signature="run_experiment(experiment)">
  ...
  <Function id="qiskit.providers.basic_provider.BasicSimulator.set_options" github="https://github.com/Qiskit/qiskit/tree/stable/1.3/qiskit/providers/backend.py#L605-L622" signature="set_options(**fields)">
