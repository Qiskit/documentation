...
`qiskit.circuit.singleton.SingletonInstruction(*args, _force_mutable=False, **kwargs)`
...
`qiskit.circuit.singleton.SingletonGate(*args, _force_mutable=False, **kwargs)`
...
`qiskit.circuit.singleton.SingletonControlledGate(*args, _force_mutable=False, **kwargs)`
