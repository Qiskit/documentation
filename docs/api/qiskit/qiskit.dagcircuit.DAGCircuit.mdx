...
<Class id="qiskit.dagcircuit.DAGCircuit" isDedicatedPage={true} signature="qiskit.dagcircuit.DAGCircuit" modifiers="class">
  ...
  <Attribute id="qiskit.dagcircuit.DAGCircuit.clbits" name="clbits" headingLevel={3}>
  ...
  <Attribute id="qiskit.dagcircuit.DAGCircuit.cregs" name="cregs" headingLevel={3}>
    Returns the dict containing the ClassicalRegisters in the circuit
  </Attribute>

  <Attribute id="qiskit.dagcircuit.DAGCircuit.duration" name="duration" headingLevel={3}>
  ...
  <Attribute id="qiskit.dagcircuit.DAGCircuit.global_phase" name="global_phase" headingLevel={3}>
    Return the global phase of the circuit.
  </Attribute>

  <Attribute id="qiskit.dagcircuit.DAGCircuit.input_map" name="input_map" headingLevel={3} />

  <Attribute id="qiskit.dagcircuit.DAGCircuit.metadata" name="metadata" headingLevel={3}>
    Circuit metadata
  </Attribute>

  <Attribute id="qiskit.dagcircuit.DAGCircuit.name" name="name" headingLevel={3}>
    Circuit name. Generally, this corresponds to the name of the QuantumCircuit from which the DAG was generated.
  </Attribute>

  <Attribute id="qiskit.dagcircuit.DAGCircuit.node_counter" name="node_counter" headingLevel={3}>
    Returns the number of nodes in the dag.
  </Attribute>

  <Attribute id="qiskit.dagcircuit.DAGCircuit.num_captured_stretches" name="num_captured_stretches" headingLevel={3}>
    Number of captured stretches tracked by the circuit.
  </Attribute>

  <Attribute id="qiskit.dagcircuit.DAGCircuit.num_captured_vars" name="num_captured_vars" headingLevel={3}>
    Number of captured classical variables tracked by the circuit.
  </Attribute>

  <Attribute id="qiskit.dagcircuit.DAGCircuit.num_declared_stretches" name="num_declared_stretches" headingLevel={3}>
    Number of declared local stretches tracked by the circuit.
  </Attribute>

  <Attribute id="qiskit.dagcircuit.DAGCircuit.num_declared_vars" name="num_declared_vars" headingLevel={3}>
    Number of declared local classical variables tracked by the circuit.
  </Attribute>

  <Attribute id="qiskit.dagcircuit.DAGCircuit.num_input_vars" name="num_input_vars" headingLevel={3}>
    Number of input classical variables tracked by the circuit.
  </Attribute>

  <Attribute id="qiskit.dagcircuit.DAGCircuit.num_stretches" name="num_stretches" headingLevel={3}>
    Total number of stretches tracked by the circuit.
  </Attribute>

  <Attribute id="qiskit.dagcircuit.DAGCircuit.num_vars" name="num_vars" headingLevel={3}>
    Total number of classical variables tracked by the circuit.
  </Attribute>

  <Attribute id="qiskit.dagcircuit.DAGCircuit.output_map" name="output_map" headingLevel={3} />

  <Attribute id="qiskit.dagcircuit.DAGCircuit.qregs" name="qregs" headingLevel={3}>
    Returns the dict containing the QuantumRegisters in the circuit
  </Attribute>

  <Attribute id="qiskit.dagcircuit.DAGCircuit.qubits" name="qubits" headingLevel={3}>
  ...
  <Attribute id="qiskit.dagcircuit.DAGCircuit.unit" name="unit" headingLevel={3}>
    Returns the unit that duration is specified in.

    DEPRECATED since Qiskit 1.3.0 and will be removed in Qiskit 3.0.0
  </Attribute>

  <Attribute id="qiskit.dagcircuit.DAGCircuit.wires" name="wires" headingLevel={3}>
  ...
  <Function id="qiskit.dagcircuit.DAGCircuit.op_nodes" signature="op_nodes(op=None, include_directives=True)">
    ...
    *   **op** ([*Type*](/docs/api/qiskit/circuit_classical#qiskit.circuit.classical.types.Type "qiskit.circuit.classical.types.Type")) – [`qiskit.circuit.Operation`](qiskit.circuit.Operation "qiskit.circuit.Operation") subclass op nodes to return. If None, return all op nodes.
  ...
  <Function id="qiskit.dagcircuit.DAGCircuit.size" signature="size(*, recurse=False)">
    ...
    **Raises**
    ...
    [**DAGCircuitError**](/docs/api/qiskit/dagcircuit#qiskit.dagcircuit.DAGCircuitError "qiskit.dagcircuit.DAGCircuitError") – if an unknown [`ControlFlowOp`](qiskit.circuit.ControlFlowOp "qiskit.circuit.ControlFlowOp") is present in a call with `recurse=True`, or any control flow is present in a non-recursive call.
  </Function>
