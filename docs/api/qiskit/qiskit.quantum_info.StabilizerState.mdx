...
<Class id="qiskit.quantum_info.StabilizerState" github="https://github.com/qiskit/qiskit/tree/stable/1.0/qiskit/quantum_info/states/stabilizerstate.py" signature="qiskit.quantum_info.StabilizerState(data, validate=True)">
  Bases: `QuantumState`
  ...
  *   **validate** (*boolean*) – validate that the stabilizer state data is a valid Clifford.
  ...
  <Function id="qiskit.quantum_info.StabilizerState.from_stabilizer_list" name="from_stabilizer_list" signature="classmethod from_stabilizer_list(stabilizers, allow_redundant=False, allow_underconstrained=False)">
