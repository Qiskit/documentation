...
<Class id="qiskit.result.ResultError" github="https://github.com/qiskit/qiskit/tree/stable/1.0/qiskit/result/exceptions.py" signature="qiskit.result.ResultError(error)">
