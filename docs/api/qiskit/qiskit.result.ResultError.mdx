...
<Class id="qiskit.result.ResultError" name="ResultError" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/1.0/qiskit/result/exceptions.py" signature="qiskit.result.ResultError(error)">
