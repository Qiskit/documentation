---
title: Parameter (v2.3)
description: API reference for qiskit.circuit.Parameter in qiskit v2.3
...
<Class id="qiskit.circuit.Parameter" isDedicatedPage={true} signature="qiskit.circuit.Parameter(name, uuid=None)" modifiers="class">
  ...
  **Examples**
  ...
  ![Circuit diagram output by the previous code.](/docs/images/api/qiskit/2.3/qiskit-circuit-Parameter-1_00.avif)

  ![Circuit diagram output by the previous code.](/docs/images/api/qiskit/2.3/qiskit-circuit-Parameter-1_01.avif)
