---
title: result (v2.3)
description: API reference for qiskit.result in qiskit v2.3
...
<Function id="qiskit.result.marginal_counts" github="https://github.com/Qiskit/qiskit/tree/stable/2.3/qiskit/result/utils.py#L32-L98" signature="qiskit.result.marginal_counts(result, indices=None, inplace=False, format_marginal=False, marginalize_memory=True)">
  Marginalize counts from an experiment over some indices of interest.

  **Parameters**

  *   **result** ([*dict*](https://docs.python.org/3/library/stdtypes.html#dict)  *|*[*Result*](qiskit.result.Result "qiskit.result.result.Result")) – result to be marginalized (a Result object or a dict(str, int) of counts).
  *   **indices** ([*List*](https://docs.python.org/3/library/typing.html#typing.List)*\[*[*int*](https://docs.python.org/3/library/functions.html#int)*] | None*) – The bit positions of interest to marginalize over. If `None` (default), do not marginalize at all.
  ...
  **Return type**
  ...
  [Result](qiskit.result.Result "qiskit.result.Result") or [dict](https://docs.python.org/3/library/stdtypes.html#dict)([str](https://docs.python.org/3/library/stdtypes.html#str), [int](https://docs.python.org/3/library/functions.html#int))
...
<Function id="qiskit.result.marginal_distribution" github="https://github.com/Qiskit/qiskit/tree/stable/2.3/qiskit/result/utils.py#L198-L242" signature="qiskit.result.marginal_distribution(counts, indices=None, format_marginal=False)">
  Marginalize counts from an experiment over some indices of interest.
  ...
  *   **indices** ([*Sequence*](https://docs.python.org/3/library/typing.html#typing.Sequence)*\[*[*int*](https://docs.python.org/3/library/functions.html#int)*] | None*) – The bit positions of interest to marginalize over. If `None` (default), do not marginalize at all.
  *   **format\_marginal** ([*bool*](https://docs.python.org/3/library/functions.html#bool)) – Default: False. If True, takes the output of marginalize and formats it with placeholders between cregs and for non-indices.
...
<Function id="qiskit.result.marginal_memory" github="https://github.com/Qiskit/qiskit/tree/stable/2.3/qiskit/result/utils.py#L127-L195" signature="qiskit.result.marginal_memory(memory, indices=None, int_return=False, hex_return=False, avg_data=False, parallel_threshold=1000)">
...
<Function id="qiskit.result.sampled_expectation_value" github="https://github.com/Qiskit/qiskit/tree/stable/2.3/qiskit/result/sampled_expval.py#L37-L90" signature="qiskit.result.sampled_expectation_value(dist, oper)">
  ...
  *   **dist** ([*dict*](https://docs.python.org/3/library/stdtypes.html#dict)  *|*[*result.Counts*](qiskit.result.Counts "qiskit.result.Counts")  *|*[*QuasiDistribution*](qiskit.result.QuasiDistribution "qiskit.result.QuasiDistribution")  *|*[*ProbDistribution*](qiskit.result.ProbDistribution "qiskit.result.ProbDistribution")) – Input sampled distribution.
  *   **oper** ([*str*](https://docs.python.org/3/library/stdtypes.html#str)  *|*[*quantum\_info.Pauli*](qiskit.quantum_info.Pauli "qiskit.quantum_info.Pauli")  *|*[*quantum\_info.SparsePauliOp*](qiskit.quantum_info.SparsePauliOp "qiskit.quantum_info.SparsePauliOp")  *|*[*quantum\_info.SparseObservable*](qiskit.quantum_info.SparseObservable "qiskit.quantum_info.SparseObservable")) – The operator for the observable.
