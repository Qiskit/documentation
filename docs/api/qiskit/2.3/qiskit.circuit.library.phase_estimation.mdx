---
title: phase_estimation (v2.3)
description: API reference for qiskit.circuit.library.phase_estimation in qiskit v2.3
...
$$
  ...
  **Return type**
  ...
  ![A phase estimation circuit.](/docs/images/api/qiskit/2.3/qiskit-circuit-library-phase_estimation-1.avif)
