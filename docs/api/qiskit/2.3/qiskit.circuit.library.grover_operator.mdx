---
title: grover_operator (v2.3)
description: API reference for qiskit.circuit.library.grover_operator in qiskit v2.3
...
$$
  ...
  ![Circuit diagram output by the previous code.](/docs/images/api/qiskit/2.3/qiskit-circuit-library-grover_operator-1.avif)
  ...
  ![Circuit diagram output by the previous code.](/docs/images/api/qiskit/2.3/qiskit-circuit-library-grover_operator-2.avif)
  ...
  ![Circuit diagram output by the previous code.](/docs/images/api/qiskit/2.3/qiskit-circuit-library-grover_operator-3.avif)
  ...
  ![Circuit diagram output by the previous code.](/docs/images/api/qiskit/2.3/qiskit-circuit-library-grover_operator-4.avif)
