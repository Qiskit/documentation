---
title: StabilizerState (v2.3)
description: API reference for qiskit.quantum_info.StabilizerState in qiskit v2.3
...
<Class id="qiskit.quantum_info.StabilizerState" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/2.3/qiskit/quantum_info/states/stabilizerstate.py#L36-L805" signature="qiskit.quantum_info.StabilizerState(data, validate=True)" modifiers="class">
  Bases: `QuantumState`
  ...
  *   **validate** ([*bool*](https://docs.python.org/3/library/functions.html#bool)) – validate that the stabilizer state data is a valid Clifford.
  ...
  <Function id="qiskit.quantum_info.StabilizerState.conjugate" github="https://github.com/Qiskit/qiskit/tree/stable/2.3/qiskit/quantum_info/states/stabilizerstate.py#L196-L200" signature="conjugate()">
    Return the conjugate of the operator.
  </Function>

  ### copy

  <Function id="qiskit.quantum_info.StabilizerState.copy" github="https://github.com/Qiskit/qiskit/tree/stable/2.3/qiskit/quantum_info/states/quantum_state.py#L74-L76" signature="copy()">
    Make a copy of current operator.
  </Function>

  ### dims

  <Function id="qiskit.quantum_info.StabilizerState.dims" github="https://github.com/Qiskit/qiskit/tree/stable/2.3/qiskit/quantum_info/states/quantum_state.py#L70-L72" signature="dims(qargs=None)">
    Return tuple of input dimension for specified subsystems.
  </Function>

  ### equiv

  <Function id="qiskit.quantum_info.StabilizerState.equiv" github="https://github.com/Qiskit/qiskit/tree/stable/2.3/qiskit/quantum_info/states/stabilizerstate.py#L354-L393" signature="equiv(other)">
  ...
  <Function id="qiskit.quantum_info.StabilizerState.evolve" github="https://github.com/Qiskit/qiskit/tree/stable/2.3/qiskit/quantum_info/states/stabilizerstate.py#L238-L260" signature="evolve(other, qargs=None)">
  ...
  <Function id="qiskit.quantum_info.StabilizerState.expand" github="https://github.com/Qiskit/qiskit/tree/stable/2.3/qiskit/quantum_info/states/stabilizerstate.py#L220-L236" signature="expand(other)">
  ...
  <Function id="qiskit.quantum_info.StabilizerState.expectation_value" github="https://github.com/Qiskit/qiskit/tree/stable/2.3/qiskit/quantum_info/states/stabilizerstate.py#L262-L287" signature="expectation_value(oper, qargs=None)">
    Compute the expectation value of a Pauli or SparsePauliOp operator.

    **Parameters**

    *   **oper** ([*Pauli*](qiskit.quantum_info.Pauli "qiskit.quantum_info.operators.symplectic.pauli.Pauli")  *|*[*SparsePauliOp*](qiskit.quantum_info.SparsePauliOp "qiskit.quantum_info.operators.symplectic.sparse_pauli_op.SparsePauliOp")) – A Pauli or SparsePauliOp operator to evaluate the expectation value.
    *   **qargs** ([*list*](https://docs.python.org/3/library/stdtypes.html#list) *| None*) – Subsystems to apply the operator on.
  ...
  <Function id="qiskit.quantum_info.StabilizerState.from_stabilizer_list" github="https://github.com/Qiskit/qiskit/tree/stable/2.3/qiskit/quantum_info/states/stabilizerstate.py#L113-L141" signature="from_stabilizer_list(stabilizers, allow_redundant=False, allow_underconstrained=False)" modifiers="classmethod">
  ...
  <Function id="qiskit.quantum_info.StabilizerState.is_valid" github="https://github.com/Qiskit/qiskit/tree/stable/2.3/qiskit/quantum_info/states/stabilizerstate.py#L154-L156" signature="is_valid(atol=None, rtol=None)">
    Return True if a valid StabilizerState.
  </Function>

  ### measure

  <Function id="qiskit.quantum_info.StabilizerState.measure" github="https://github.com/Qiskit/qiskit/tree/stable/2.3/qiskit/quantum_info/states/stabilizerstate.py#L518-L546" signature="measure(qargs=None)">
  ...
  <Function id="qiskit.quantum_info.StabilizerState.probabilities" github="https://github.com/Qiskit/qiskit/tree/stable/2.3/qiskit/quantum_info/states/stabilizerstate.py#L395-L419" signature="probabilities(qargs=None, decimals=None)">
  ...
  <Function id="qiskit.quantum_info.StabilizerState.probabilities_dict" github="https://github.com/Qiskit/qiskit/tree/stable/2.3/qiskit/quantum_info/states/stabilizerstate.py#L457-L479" signature="probabilities_dict(qargs=None, decimals=None)">
  ...
  <Function id="qiskit.quantum_info.StabilizerState.probabilities_dict_from_bitstring" github="https://github.com/Qiskit/qiskit/tree/stable/2.3/qiskit/quantum_info/states/stabilizerstate.py#L421-L455" signature="probabilities_dict_from_bitstring(outcome_bitstring, qargs=None, decimals=None)">
  ...
  <Function id="qiskit.quantum_info.StabilizerState.purity" github="https://github.com/Qiskit/qiskit/tree/stable/2.3/qiskit/quantum_info/states/stabilizerstate.py#L178-L190" signature="purity()">
  ...
  <Function id="qiskit.quantum_info.StabilizerState.reset" github="https://github.com/Qiskit/qiskit/tree/stable/2.3/qiskit/quantum_info/states/stabilizerstate.py#L481-L516" signature="reset(qargs=None)">
  ...
  <Function id="qiskit.quantum_info.StabilizerState.sample_counts" github="https://github.com/Qiskit/qiskit/tree/stable/2.3/qiskit/quantum_info/states/quantum_state.py#L277-L304" signature="sample_counts(shots, qargs=None)">
    ...
    **Return type**
    ...
    >
    > The seed for random number generator used for sampling can be set to a fixed value by using the state’s [`seed()`](#qiskit.quantum_info.StabilizerState.seed "qiskit.quantum_info.StabilizerState.seed") method.
  </Function>

  ### sample\_memory

  <Function id="qiskit.quantum_info.StabilizerState.sample_memory" github="https://github.com/Qiskit/qiskit/tree/stable/2.3/qiskit/quantum_info/states/stabilizerstate.py#L548-L572" signature="sample_memory(shots, qargs=None)">
  ...
  <Function id="qiskit.quantum_info.StabilizerState.seed" github="https://github.com/Qiskit/qiskit/tree/stable/2.3/qiskit/quantum_info/states/quantum_state.py#L78-L85" signature="seed(value=None)">
    Set the seed for the quantum state RNG.
  </Function>

  ### tensor

  <Function id="qiskit.quantum_info.StabilizerState.tensor" github="https://github.com/Qiskit/qiskit/tree/stable/2.3/qiskit/quantum_info/states/stabilizerstate.py#L202-L218" signature="tensor(other)">
  ...
  <Function id="qiskit.quantum_info.StabilizerState.to_operator" github="https://github.com/Qiskit/qiskit/tree/stable/2.3/qiskit/quantum_info/states/stabilizerstate.py#L192-L194" signature="to_operator()">
  ...
  <Function id="qiskit.quantum_info.StabilizerState.trace" github="https://github.com/Qiskit/qiskit/tree/stable/2.3/qiskit/quantum_info/states/stabilizerstate.py#L164-L176" signature="trace()">
