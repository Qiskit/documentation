---
title: StatevectorSampler (v2.3)
description: API reference for qiskit.primitives.StatevectorSampler in qiskit v2.3
...
<Class id="qiskit.primitives.StatevectorSampler" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/2.3/qiskit/primitives/statevector_sampler.py#L51-L204" signature="qiskit.primitives.StatevectorSampler(*, default_shots=1024, seed=None)" modifiers="class">
  ...
  *   **seed** (*np.random.Generator |* [*int*](https://docs.python.org/3/library/functions.html#int) *| None*) – The seed or Generator object for random number generation. If None, a random seeded default RNG will be used.
  ...
  <Function id="qiskit.primitives.StatevectorSampler.run" github="https://github.com/Qiskit/qiskit/tree/stable/2.3/qiskit/primitives/statevector_sampler.py#L156-L171" signature="run(pubs, *, shots=None)">
