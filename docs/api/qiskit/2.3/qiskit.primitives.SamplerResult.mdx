---
title: SamplerResult (v2.3)
description: API reference for qiskit.primitives.SamplerResult in qiskit v2.3
...
<Class id="qiskit.primitives.SamplerResult" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/2.3/qiskit/primitives/base/sampler_result_v1.py#L26-L45" signature="qiskit.primitives.SamplerResult(quasi_dists, metadata)" modifiers="class">
