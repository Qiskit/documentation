---
title: GR (v2.3)
description: API reference for qiskit.circuit.library.GR in qiskit v2.3
...
$$
  ...
  ![Diagram illustrating the previously described circuit.](/docs/images/api/qiskit/2.3/qiskit-circuit-library-GR-1.avif)
