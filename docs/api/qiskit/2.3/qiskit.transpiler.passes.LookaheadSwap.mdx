---
title: LookaheadSwap (v2.3)
description: API reference for qiskit.transpiler.passes.LookaheadSwap in qiskit v2.3
...
<Class id="qiskit.transpiler.passes.LookaheadSwap" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/2.3/qiskit/transpiler/passes/routing/lookahead_swap.py#L50-L191" signature="qiskit.transpiler.passes.LookaheadSwap(*args, **kwargs)" modifiers="class">
  ...
  *   **fake\_run** ([*bool*](https://docs.python.org/3/library/functions.html#bool)) – if true, it will only pretend to do routing, i.e., no swap is effectively added.
  ...
  <Function id="qiskit.transpiler.passes.LookaheadSwap.execute" github="https://github.com/Qiskit/qiskit/tree/stable/2.3/qiskit/transpiler/basepasses.py#L161-L180" signature="execute(passmanager_ir, state, callback=None)">
  ...
  <Function id="qiskit.transpiler.passes.LookaheadSwap.name" github="https://github.com/Qiskit/qiskit/tree/stable/2.3/qiskit/passmanager/base_tasks.py#L68-L70" signature="name()">
    Name of the pass.
  ...
  <Function id="qiskit.transpiler.passes.LookaheadSwap.run" github="https://github.com/Qiskit/qiskit/tree/stable/2.3/qiskit/transpiler/passes/routing/lookahead_swap.py#L108-L191" signature="run(dag)">
  ...
  <Function id="qiskit.transpiler.passes.LookaheadSwap.update_status" github="https://github.com/Qiskit/qiskit/tree/stable/2.3/qiskit/transpiler/basepasses.py#L182-L190" signature="update_status(state, run_state)">
