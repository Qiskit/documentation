---
title: PiecewisePolynomialPauliRotationsGate (v2.3)
description: API reference for qiskit.circuit.library.PiecewisePolynomialPauliRotationsGate in qiskit v2.3
