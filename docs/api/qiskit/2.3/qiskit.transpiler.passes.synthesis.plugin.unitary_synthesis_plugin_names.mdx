---
title: unitary_synthesis_plugin_names (v2.3)
description: API reference for qiskit.transpiler.passes.synthesis.plugin.unitary_synthesis_plugin_names in qiskit v2.3
...
<Function id="qiskit.transpiler.passes.synthesis.plugin.unitary_synthesis_plugin_names" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/2.3/qiskit/transpiler/passes/synthesis/plugin.py#L657-L667" signature="qiskit.transpiler.passes.synthesis.plugin.unitary_synthesis_plugin_names()">
