---
title: InnerProduct (v2.3)
description: API reference for qiskit.circuit.library.InnerProduct in qiskit v2.3
...
$$
  ...
  **Reference Circuit:**
  ...
  ![Diagram illustrating the previously described circuit.](/docs/images/api/qiskit/2.3/qiskit-circuit-library-InnerProduct-1.avif)
