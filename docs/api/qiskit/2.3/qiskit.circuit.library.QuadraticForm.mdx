---
title: QuadraticForm (v2.3)
description: API reference for qiskit.circuit.library.QuadraticForm in qiskit v2.3
...
$$
  ...
  *   [**ValueError**](https://docs.python.org/3/library/exceptions.html#ValueError) – If `num_result_qubits` is unspecified but cannot be determined because some values of the quadratic form are parameterized.
  ...
  <Function id="qiskit.circuit.library.QuadraticForm.required_result_qubits" github="https://github.com/Qiskit/qiskit/tree/stable/2.3/qiskit/circuit/library/arithmetic/quadratic_form.py#L178-L195" signature="required_result_qubits(quadratic, linear, offset)" modifiers="static">
