---
title: PiecewiseChebyshevGate (v2.3)
description: API reference for qiskit.circuit.library.PiecewiseChebyshevGate in qiskit v2.3
...
<Class id="qiskit.circuit.library.PiecewiseChebyshevGate" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/2.3/qiskit/circuit/library/arithmetic/piecewise_chebyshev.py#L361-L508" signature="qiskit.circuit.library.PiecewiseChebyshevGate(f_x, num_state_qubits, degree=None, breakpoints=None, label=None)" modifiers="class">
  ...
  **Examples**
  ...
  ![Example of generating a circuit with the piecewise Chebyshev gate.](/docs/images/api/qiskit/2.3/qiskit-circuit-library-PiecewiseChebyshevGate-1.avif)
