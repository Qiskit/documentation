---
title: WrapAngles (v2.3)
description: API reference for qiskit.transpiler.passes.WrapAngles in qiskit v2.3
...
<Class id="qiskit.transpiler.passes.WrapAngles" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/2.3/qiskit/transpiler/passes/utils/wrap_angles.py#L21-L108" signature="qiskit.transpiler.passes.WrapAngles(*args, **kwargs)" modifiers="class">
  ...
  ![Circuit diagram of the output from running the WrapAngles pass](/docs/images/api/qiskit/2.3/qiskit-transpiler-passes-WrapAngles-1.avif)
