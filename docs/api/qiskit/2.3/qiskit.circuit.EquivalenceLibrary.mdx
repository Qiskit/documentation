---
title: EquivalenceLibrary (v2.3)
description: API reference for qiskit.circuit.EquivalenceLibrary in qiskit v2.3
...
<Class id="qiskit.circuit.EquivalenceLibrary" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/2.3/qiskit/circuit/equivalence.py#L29-L98" signature="qiskit.circuit.EquivalenceLibrary(base=None)" modifiers="class">
  ...
  <Function id="qiskit.circuit.EquivalenceLibrary.draw" github="https://github.com/Qiskit/qiskit/tree/stable/2.3/qiskit/circuit/equivalence.py#L33-L62" signature="draw(filename=None)">
