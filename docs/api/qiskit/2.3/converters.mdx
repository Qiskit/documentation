---
title: converters (v2.3)
description: API reference for qiskit.converters in qiskit v2.3
...
<Function id="qiskit.converters.dag_to_circuit" github="https://github.com/Qiskit/qiskit/tree/stable/2.3/qiskit/converters/dag_to_circuit.py#L19-L75" signature="qiskit.converters.dag_to_circuit(dag, copy_operations=True)">
  ...
  **Example**
  ...
  ![Circuit diagram output by the previous code.](/docs/images/api/qiskit/2.3/converters-3.avif)
</Function>
