---
title: QuantumVolume (v2.3)
description: API reference for qiskit.circuit.library.QuantumVolume in qiskit v2.3
...
<Class id="qiskit.circuit.library.QuantumVolume" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/2.3/qiskit/circuit/library/quantum_volume.py#L26-L135" signature="qiskit.circuit.library.QuantumVolume(num_qubits, depth=None, seed=None, classical_permutation=True, *, flatten=False)" modifiers="class">
  ...
  ![Diagram illustrating the previously described circuit.](/docs/images/api/qiskit/2.3/qiskit-circuit-library-QuantumVolume-1.avif)

  Expanded Circuit:

  ![Diagram illustrating the previously described circuit.](/docs/images/api/qiskit/2.3/qiskit-circuit-library-QuantumVolume-2.avif)
