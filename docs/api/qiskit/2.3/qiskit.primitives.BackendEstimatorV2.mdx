---
title: BackendEstimatorV2 (v2.3)
description: API reference for qiskit.primitives.BackendEstimatorV2 in qiskit v2.3
...
<Class id="qiskit.primitives.BackendEstimatorV2" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/2.3/qiskit/primitives/backend_estimator_v2.py#L170-L510" signature="qiskit.primitives.BackendEstimatorV2(*, backend, options=None)" modifiers="class">
...
$$
  ...
  *   **options** ([*dict*](https://docs.python.org/3/library/stdtypes.html#dict) *| None*) – The options to control the default precision (`default_precision`), the operator grouping (`abelian_grouping`), and the random seed for the simulator (`seed_simulator`).
  ...
  <Function id="qiskit.primitives.BackendEstimatorV2.run" github="https://github.com/Qiskit/qiskit/tree/stable/2.3/qiskit/primitives/backend_estimator_v2.py#L256-L265" signature="run(pubs, *, precision=None)">
