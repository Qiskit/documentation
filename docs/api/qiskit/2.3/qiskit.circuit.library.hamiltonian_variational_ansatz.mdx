---
title: hamiltonian_variational_ansatz (v2.3)
description: API reference for qiskit.circuit.library.hamiltonian_variational_ansatz in qiskit v2.3
...
<Function id="qiskit.circuit.library.hamiltonian_variational_ansatz" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/2.3/qiskit/circuit/library/n_local/evolved_operator_ansatz.py#L189-L279" signature="qiskit.circuit.library.hamiltonian_variational_ansatz(hamiltonian, reps=1, insert_barriers=False, name='HVA', parameter_prefix='t')">
...
$$
  ...
  ![Circuit diagram output by the previous code.](/docs/images/api/qiskit/2.3/qiskit-circuit-library-hamiltonian_variational_ansatz-1.avif)
  ...
  ![Circuit diagram output by the previous code.](/docs/images/api/qiskit/2.3/qiskit-circuit-library-hamiltonian_variational_ansatz-2.avif)
