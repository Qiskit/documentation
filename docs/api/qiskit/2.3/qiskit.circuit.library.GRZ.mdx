---
title: GRZ (v2.3)
description: API reference for qiskit.circuit.library.GRZ in qiskit v2.3
...
$$
  ...
  **Expanded Circuit:**
  ...
  ![Diagram illustrating the previously described circuit.](/docs/images/api/qiskit/2.3/qiskit-circuit-library-GRZ-1.avif)
