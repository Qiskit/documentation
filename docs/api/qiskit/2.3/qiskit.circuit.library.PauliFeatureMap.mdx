---
title: PauliFeatureMap (v2.3)
description: API reference for qiskit.circuit.library.PauliFeatureMap in qiskit v2.3
...
<Class id="qiskit.circuit.library.PauliFeatureMap" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/2.3/qiskit/circuit/library/data_preparation/pauli_feature_map.py#L386-L703" signature="qiskit.circuit.library.PauliFeatureMap(feature_dimension=None, reps=2, entanglement='full', alpha=2.0, paulis=None, data_map_func=None, parameter_prefix='x', insert_barriers=False, name='PauliFeatureMap')" modifiers="class">
...
$$
  ...
  *   **data\_map\_func** (*Optional\[Callable\[\[np.ndarray],* [*float*](https://docs.python.org/3/library/functions.html#float)*]]*) – A mapping function for the data `x` which can be supplied to override the default mapping.
  ...
  *   **name** ([*str*](https://docs.python.org/3/library/stdtypes.html#str)) –
  ...
  <Function id="qiskit.circuit.library.PauliFeatureMap.get_entangler_map" github="https://github.com/Qiskit/qiskit/tree/stable/2.3/qiskit/circuit/library/data_preparation/pauli_feature_map.py#L666-L703" signature="get_entangler_map(rep_num, block_num, num_block_qubits)">
  ...
  <Function id="qiskit.circuit.library.PauliFeatureMap.pauli_block" github="https://github.com/Qiskit/qiskit/tree/stable/2.3/qiskit/circuit/library/data_preparation/pauli_feature_map.py#L620-L624" signature="pauli_block(pauli_string)">
    Get the Pauli block for the feature map circuit.
  </Function>

  ### pauli\_evolution

  <Function id="qiskit.circuit.library.PauliFeatureMap.pauli_evolution" github="https://github.com/Qiskit/qiskit/tree/stable/2.3/qiskit/circuit/library/data_preparation/pauli_feature_map.py#L626-L664" signature="pauli_evolution(pauli_string, time)">
