---
title: CliffordUnitarySynthesis (v2.3)
description: API reference for qiskit.transpiler.passes.synthesis.clifford_unitary_synth_plugin.CliffordUnitarySynthesis in qiskit v2.3
...
<Class id="qiskit.transpiler.passes.synthesis.clifford_unitary_synth_plugin.CliffordUnitarySynthesis" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/2.3/qiskit/transpiler/passes/synthesis/clifford_unitary_synth_plugin.py#L36-L123" signature="qiskit.transpiler.passes.synthesis.clifford_unitary_synth_plugin.CliffordUnitarySynthesis" modifiers="class">
  ...
  *   max\_qubits: the maximum number of qubits to consider (the default value is 3).
  ...
  <Function id="qiskit.transpiler.passes.synthesis.clifford_unitary_synth_plugin.CliffordUnitarySynthesis.run" github="https://github.com/Qiskit/qiskit/tree/stable/2.3/qiskit/transpiler/passes/synthesis/clifford_unitary_synth_plugin.py#L91-L123" signature="run(unitary, **options)">
