---
title: RossSelingerSynthesis (v2.3)
description: API reference for qiskit.transpiler.passes.synthesis.ross_selinger_plugin.RossSelingerSynthesis in qiskit v2.3
