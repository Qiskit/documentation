---
title: dag_drawer (v2.3)
description: API reference for qiskit.visualization.dag_drawer in qiskit v2.3
...
<Function id="qiskit.visualization.dag_drawer" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/2.3/qiskit/visualization/dag_visualization.py#L77-L394" signature="qiskit.visualization.dag_drawer(dag, scale=0.7, filename=None, style='color')">
