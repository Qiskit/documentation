---
title: StatevectorEstimator (v2.3)
description: API reference for qiskit.primitives.StatevectorEstimator in qiskit v2.3
...
<Class id="qiskit.primitives.StatevectorEstimator" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/2.3/qiskit/primitives/statevector_estimator.py#L31-L176" signature="qiskit.primitives.StatevectorEstimator(*, default_precision=0.0, seed=None)" modifiers="class">
  ...
  ![Output from the previous code.](/docs/images/api/qiskit/2.3/qiskit-primitives-StatevectorEstimator-1.avif)
