---
title: BackendV2 (v2.3)
description: API reference for qiskit.providers.BackendV2 in qiskit v2.3
...
<Class id="qiskit.providers.BackendV2" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/2.3/qiskit/providers/backend.py#L39-L337" signature="qiskit.providers.BackendV2(provider=None, name=None, description=None, online_date=None, backend_version=None, **fields)" modifiers="class">
  ...
  <Function id="qiskit.providers.BackendV2._default_options" github="https://github.com/Qiskit/qiskit/tree/stable/2.3/qiskit/providers/backend.py#L184-L198" signature="_default_options()" modifiers="abstract classmethod">
  ...
  **Raises**
  ...
  <Function id="qiskit.providers.BackendV2.qubit_properties" github="https://github.com/Qiskit/qiskit/tree/stable/2.3/qiskit/providers/backend.py#L242-L274" signature="qubit_properties(qubit)">
    ...
    **Return type**
    ...
    [*QubitProperties*](qiskit.providers.QubitProperties "qiskit._accelerate.target.QubitProperties") | [*List*](https://docs.python.org/3/library/typing.html#typing.List)\[[*QubitProperties*](qiskit.providers.QubitProperties "qiskit._accelerate.target.QubitProperties")]
  </Function>

  ### run

  <Function id="qiskit.providers.BackendV2.run" github="https://github.com/Qiskit/qiskit/tree/stable/2.3/qiskit/providers/backend.py#L314-L337" signature="run(run_input, **options)" modifiers="abstract">
    Run on the backend.
  ...
  <Function id="qiskit.providers.BackendV2.set_options" github="https://github.com/Qiskit/qiskit/tree/stable/2.3/qiskit/providers/backend.py#L276-L293" signature="set_options(**fields)">
