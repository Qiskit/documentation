---
title: PhaseEstimation (v2.3)
description: API reference for qiskit.circuit.library.PhaseEstimation in qiskit v2.3
...
$$
  ...
  *   **name** ([*str*](https://docs.python.org/3/library/stdtypes.html#str)) – The name of the circuit.
  ...
  ![Diagram illustrating the previously described circuit.](/docs/images/api/qiskit/2.3/qiskit-circuit-library-PhaseEstimation-1.avif)
