---
title: PMHSynthesisLinearFunction (v2.3)
description: API reference for qiskit.transpiler.passes.synthesis.hls_plugins.PMHSynthesisLinearFunction in qiskit v2.3
