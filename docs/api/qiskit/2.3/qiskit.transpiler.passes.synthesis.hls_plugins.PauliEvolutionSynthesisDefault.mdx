---
title: PauliEvolutionSynthesisDefault (v2.3)
description: API reference for qiskit.transpiler.passes.synthesis.hls_plugins.PauliEvolutionSynthesisDefault in qiskit v2.3
...
<Class id="qiskit.transpiler.passes.synthesis.hls_plugins.PauliEvolutionSynthesisDefault" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/2.3/qiskit/transpiler/passes/synthesis/hls_plugins.py#L2062-L2088" signature="qiskit.transpiler.passes.synthesis.hls_plugins.PauliEvolutionSynthesisDefault" modifiers="class">
  ...
  *   **preserve\_order: If `False`, allow re-ordering the Pauli terms in the Hamiltonian to**
  ...
  <Function id="qiskit.transpiler.passes.synthesis.hls_plugins.PauliEvolutionSynthesisDefault.run" github="https://github.com/Qiskit/qiskit/tree/stable/2.3/qiskit/transpiler/passes/synthesis/hls_plugins.py#L2075-L2088" signature="run(high_level_object, coupling_map=None, target=None, qubits=None, **options)">
