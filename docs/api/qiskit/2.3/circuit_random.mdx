---
title: random (v2.3)
description: API reference for qiskit.circuit.random in qiskit v2.3
...
<Function id="qiskit.circuit.random.random_circuit" github="https://github.com/Qiskit/qiskit/tree/stable/2.3/qiskit/circuit/random/utils.py#L460-L684" signature="qiskit.circuit.random.random_circuit(num_qubits, depth, max_operands=4, measure=False, conditional=False, reset=False, seed=None, num_operand_distribution=None)">
  ...
  ![Circuit diagram output by the previous code.](/docs/images/api/qiskit/2.3/circuit_random-1.avif)
...
<Function id="qiskit.circuit.random.random_circuit_from_graph" github="https://github.com/Qiskit/qiskit/tree/stable/2.3/qiskit/circuit/random/utils.py#L79-L457" signature="qiskit.circuit.random.random_circuit_from_graph(interaction_graph, min_2q_gate_per_edge=1, max_operands=2, measure=False, conditional=False, reset=False, seed=None, insert_1q_oper=True, prob_conditional=0.1, prob_reset=0.1)">
  ...
  ![Pass in interaction graph and minimum 2Q gate per edge as a bare minimum.](/docs/images/api/qiskit/2.3/circuit_random-2.avif)
...
<Function id="qiskit.circuit.random.random_clifford_circuit" github="https://github.com/Qiskit/qiskit/tree/stable/2.3/qiskit/circuit/random/utils.py#L687-L755" signature="qiskit.circuit.random.random_clifford_circuit(num_qubits, num_gates, gates='all', seed=None)">
  ...
  ![Circuit diagram output by the previous code.](/docs/images/api/qiskit/2.3/circuit_random-3.avif)
