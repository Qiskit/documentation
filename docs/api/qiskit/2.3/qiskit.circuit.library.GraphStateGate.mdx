---
title: GraphStateGate (v2.3)
description: API reference for qiskit.circuit.library.GraphStateGate in qiskit v2.3
...
$$
  ...
  ![Circuit diagram output by the previous code.](/docs/images/api/qiskit/2.3/qiskit-circuit-library-GraphStateGate-1.avif)
