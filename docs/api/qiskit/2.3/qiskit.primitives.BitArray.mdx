---
title: BitArray (v2.3)
description: API reference for qiskit.primitives.BitArray in qiskit v2.3
...
<Class id="qiskit.primitives.BitArray" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/2.3/qiskit/primitives/containers/bit_array.py#L59-L783" signature="qiskit.primitives.BitArray(array, num_bits)" modifiers="class">
  ...
  *   [**ValueError**](https://docs.python.org/3/library/exceptions.html#ValueError) – If the input array has fewer than two axes, or the size of the last axis is not the smallest number of bytes that can contain `num_bits`.
  ...
  <Function id="qiskit.primitives.BitArray.concatenate_bits" github="https://github.com/Qiskit/qiskit/tree/stable/2.3/qiskit/primitives/containers/bit_array.py#L742-L783" signature="concatenate_bits(bit_arrays)" modifiers="static">
    ...
    **bit\_arrays** ([*Sequence*](https://docs.python.org/3/library/typing.html#typing.Sequence)*\[*[*BitArray*](#qiskit.primitives.BitArray "qiskit.primitives.containers.bit_array.BitArray")*]*) – Bit arrays that have (1) the same number of shots, and (2) the same shape.
  ...
  <Function id="qiskit.primitives.BitArray.concatenate_shots" github="https://github.com/Qiskit/qiskit/tree/stable/2.3/qiskit/primitives/containers/bit_array.py#L706-L740" signature="concatenate_shots(bit_arrays)" modifiers="static">
    ...
    **bit\_arrays** ([*Sequence*](https://docs.python.org/3/library/typing.html#typing.Sequence)*\[*[*BitArray*](#qiskit.primitives.BitArray "qiskit.primitives.containers.bit_array.BitArray")*]*) – The bit arrays must have (1) the same number of bits, and (2) the same shape.
  ...
  <Function id="qiskit.primitives.BitArray.slice_bits" github="https://github.com/Qiskit/qiskit/tree/stable/2.3/qiskit/primitives/containers/bit_array.py#L460-L495" signature="slice_bits(indices)">
    ...
    **indices** ([*int*](https://docs.python.org/3/library/functions.html#int)  *|*[*Sequence*](https://docs.python.org/3/library/typing.html#typing.Sequence)*\[*[*int*](https://docs.python.org/3/library/functions.html#int)*]*) – The bit positions of interest to slice along.
  ...
  <Function id="qiskit.primitives.BitArray.slice_shots" github="https://github.com/Qiskit/qiskit/tree/stable/2.3/qiskit/primitives/containers/bit_array.py#L497-L518" signature="slice_shots(indices)">
    ...
    **indices** ([*int*](https://docs.python.org/3/library/functions.html#int)  *|*[*Sequence*](https://docs.python.org/3/library/typing.html#typing.Sequence)*\[*[*int*](https://docs.python.org/3/library/functions.html#int)*]*) – The shots positions of interest to slice along.
