---
title: fourier_checking (v2.3)
description: API reference for qiskit.circuit.library.fourier_checking in qiskit v2.3
...
<Function id="qiskit.circuit.library.fourier_checking" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/2.3/qiskit/circuit/library/fourier_checking.py#L104-L160" signature="qiskit.circuit.library.fourier_checking(f, g)">
  ...
  ![Circuit diagram output by the previous code.](/docs/images/api/qiskit/2.3/qiskit-circuit-library-fourier_checking-1.avif)
