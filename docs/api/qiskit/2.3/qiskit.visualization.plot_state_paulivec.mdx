---
title: plot_state_paulivec (v2.3)
description: API reference for qiskit.visualization.plot_state_paulivec in qiskit v2.3
...
<Function id="qiskit.visualization.plot_state_paulivec" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/2.3/qiskit/visualization/state_visualization.py#L625-L742" signature="qiskit.visualization.plot_state_paulivec(state, title='', figsize=None, color=None, ax=None, *, filename=None)">
...
$$
  ...
  **Examples**
  ...
  ![Output from the previous code.](/docs/images/api/qiskit/2.3/qiskit-visualization-plot_state_paulivec-1.avif)
  ...
  ![Output from the previous code.](/docs/images/api/qiskit/2.3/qiskit-visualization-plot_state_paulivec-2.avif)
</Function>
