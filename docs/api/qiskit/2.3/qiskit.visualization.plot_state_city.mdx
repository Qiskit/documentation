---
title: plot_state_city (v2.3)
description: API reference for qiskit.visualization.plot_state_city in qiskit v2.3
...
<Function id="qiskit.visualization.plot_state_city" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/2.3/qiskit/visualization/state_visualization.py#L372-L622" signature="qiskit.visualization.plot_state_city(state, title='', figsize=None, color=None, alpha=1, ax_real=None, ax_imag=None, *, filename=None)">
  ...
  **Examples**
  ...
  ![Output from the previous code.](/docs/images/api/qiskit/2.3/qiskit-visualization-plot_state_city-1.avif)
  ...
  ![Output from the previous code.](/docs/images/api/qiskit/2.3/qiskit-visualization-plot_state_city-2.avif)
</Function>
