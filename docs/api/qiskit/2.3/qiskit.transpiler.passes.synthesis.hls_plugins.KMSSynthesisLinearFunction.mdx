---
title: KMSSynthesisLinearFunction (v2.3)
description: API reference for qiskit.transpiler.passes.synthesis.hls_plugins.KMSSynthesisLinearFunction in qiskit v2.3
