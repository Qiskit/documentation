---
title: PhasedQubitSparsePauli (v2.3)
description: API reference for qiskit.quantum_info.PhasedQubitSparsePauli in qiskit v2.3
...
<Class id="qiskit.quantum_info.PhasedQubitSparsePauli" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/2.3/qiskit/quantum_info/__init__.py" signature="qiskit.quantum_info.PhasedQubitSparsePauli(data, /, num_qubits=None)" modifiers="class">
