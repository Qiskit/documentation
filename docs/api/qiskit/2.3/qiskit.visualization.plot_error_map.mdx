---
title: plot_error_map (v2.3)
description: API reference for qiskit.visualization.plot_error_map in qiskit v2.3
...
<Function id="qiskit.visualization.plot_error_map" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/2.3/qiskit/visualization/gate_map.py#L1236-L1429" signature="qiskit.visualization.plot_error_map(backend, figsize=(15, 12), show_title=True, qubit_coordinates=None)">
  ...
  **Example**
  ...
  ![Output from the previous code.](/docs/images/api/qiskit/2.3/qiskit-visualization-plot_error_map-1.avif)
</Function>
