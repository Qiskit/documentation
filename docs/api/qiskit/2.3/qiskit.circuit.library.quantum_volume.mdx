---
title: quantum_volume (v2.3)
description: API reference for qiskit.circuit.library.quantum_volume in qiskit v2.3
...
<Function id="qiskit.circuit.library.quantum_volume" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/2.3/qiskit/circuit/library/quantum_volume.py#L138-L185" signature="qiskit.circuit.library.quantum_volume(num_qubits, depth=None, seed=None)">
  ...
  **Return type**
  ...
  ![Diagram illustrating the previously described circuit.](/docs/images/api/qiskit/2.3/qiskit-circuit-library-quantum_volume-1.avif)
