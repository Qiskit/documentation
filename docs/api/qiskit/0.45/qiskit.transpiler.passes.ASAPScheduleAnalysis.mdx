...
description: API reference for qiskit.transpiler.passes.ASAPScheduleAnalysis in qiskit v0.45
...
<Class id="qiskit.transpiler.passes.ASAPScheduleAnalysis" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/transpiler/passes/scheduling/scheduling/asap.py" signature="qiskit.transpiler.passes.ASAPScheduleAnalysis(*args, **kwargs)" modifiers="class">
  Bases: `BaseScheduler`
