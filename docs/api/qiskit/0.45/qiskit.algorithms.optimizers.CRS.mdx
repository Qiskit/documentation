...
<Class id="qiskit.algorithms.optimizers.CRS" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/algorithms/optimizers/nlopts/crs.py" signature="qiskit.algorithms.optimizers.CRS(max_evals=1000)">
