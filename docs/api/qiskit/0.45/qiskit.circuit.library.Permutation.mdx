...
<Class id="qiskit.circuit.library.Permutation" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/circuit/library/generalized_gates/permutation.py" signature="qiskit.circuit.library.Permutation(num_qubits, pattern=None, seed=None)" modifiers="class">
  ...
  **Reference Circuit:**
  ...
  ![../\_images/qiskit-circuit-library-Permutation-1.png](/images/api/qiskit/0.45/qiskit-circuit-library-Permutation-1.avif)

  **Expanded Circuit:**

  ![../\_images/qiskit-circuit-library-Permutation-2.png](/images/api/qiskit/0.45/qiskit-circuit-library-Permutation-2.avif)
