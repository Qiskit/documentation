---
title: UCPauliRotGate (v0.45)
description: API reference for qiskit.circuit.library.UCPauliRotGate in qiskit v0.45
...
<Class id="qiskit.circuit.library.UCPauliRotGate" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/circuit/library/generalized_gates/uc_pauli_rot.py" signature="qiskit.circuit.library.UCPauliRotGate(angle_list, rot_axis)" modifiers="class">
