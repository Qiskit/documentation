---
title: GRY (v0.45)
description: API reference for qiskit.circuit.library.GRY in qiskit v0.45
...
<Class id="qiskit.circuit.library.GRY" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/circuit/library/generalized_gates/gr.py" signature="qiskit.circuit.library.GRY(num_qubits, theta)" modifiers="class">
...
$$
  ...
  **Expanded Circuit:**
  ...
  ![../\_images/qiskit-circuit-library-GRY-1.png](/docs/images/api/qiskit/0.45/qiskit-circuit-library-GRY-1.avif)
  ...
  *   **theta** ([*float*](https://docs.python.org/3/library/functions.html#float "(in Python v3.12)")) – rotation angle about y-axis
  ...
  <Attribute id="qiskit.circuit.library.GRY.instances" attributeValue="188" />
