---
title: RelativeBarrier (v0.45)
description: API reference for qiskit.pulse.instructions.RelativeBarrier in qiskit v0.45
...
<Class id="qiskit.pulse.instructions.RelativeBarrier" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/pulse/instructions/directives.py" signature="qiskit.pulse.instructions.RelativeBarrier(*channels, name=None)" modifiers="class">
  Bases: `Directive`
  ...
  *   **name** ([*str*](https://docs.python.org/3/library/stdtypes.html#str "(in Python v3.12)") *| None*) – Name of the directive for display purposes.
  ...
  <Function id="qiskit.pulse.instructions.RelativeBarrier.append" signature="append(schedule, name=None)">
  ...
  <Function id="qiskit.pulse.instructions.RelativeBarrier.ch_duration" signature="ch_duration(*channels)">
  ...
  <Function id="qiskit.pulse.instructions.RelativeBarrier.ch_start_time" signature="ch_start_time(*channels)">
  ...
  <Function id="qiskit.pulse.instructions.RelativeBarrier.ch_stop_time" signature="ch_stop_time(*channels)">
  ...
  <Function id="qiskit.pulse.instructions.RelativeBarrier.draw" signature="draw(dt=1, style=None, filename=None, interp_method=None, scale=1, plot_all=False, plot_range=None, interactive=False, table=True, label=False, framechange=True, channels=None)">
  ...
  <Function id="qiskit.pulse.instructions.RelativeBarrier.insert" signature="insert(start_time, schedule, name=None)">
  ...
  <Function id="qiskit.pulse.instructions.RelativeBarrier.is_parameterized" signature="is_parameterized()">
  ...
  <Function id="qiskit.pulse.instructions.RelativeBarrier.shift" signature="shift(time, name=None)">
