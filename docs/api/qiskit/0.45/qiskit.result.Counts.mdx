---
title: Counts (v0.45)
description: API reference for qiskit.result.Counts in qiskit v0.45
...
<Class id="qiskit.result.Counts" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/result/counts.py" signature="qiskit.result.Counts(data, time_taken=None, creg_sizes=None, memory_slots=None)" modifiers="class">
