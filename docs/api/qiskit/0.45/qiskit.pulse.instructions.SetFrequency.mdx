---
title: SetFrequency (v0.45)
description: API reference for qiskit.pulse.instructions.SetFrequency in qiskit v0.45
...
<Class id="qiskit.pulse.instructions.SetFrequency" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/pulse/instructions/frequency.py" signature="qiskit.pulse.instructions.SetFrequency(frequency, channel, name=None)" modifiers="class">
