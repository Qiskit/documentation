...
<Class id="qiskit.pulse.instructions.SetFrequency" github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/pulse/instructions/frequency.py" signature="qiskit.pulse.instructions.SetFrequency(frequency, channel, name=None)">
