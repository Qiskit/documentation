...
<Class id="qiskit.pulse.instructions.SetFrequency" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/pulse/instructions/frequency.py" signature="qiskit.pulse.instructions.SetFrequency(frequency, channel, name=None)">
...
$$
  ...
  *   **name** ([*str*](https://docs.python.org/3/library/stdtypes.html#str "(in Python v3.12)") *| None*) – Name of this set channel frequency instruction.
  ...
  <Function id="qiskit.pulse.instructions.SetFrequency.append" name="append" signature="append(schedule, name=None)">
  ...
  <Function id="qiskit.pulse.instructions.SetFrequency.ch_duration" name="ch_duration" signature="ch_duration(*channels)">
  ...
  <Function id="qiskit.pulse.instructions.SetFrequency.ch_start_time" name="ch_start_time" signature="ch_start_time(*channels)">
  ...
  <Function id="qiskit.pulse.instructions.SetFrequency.ch_stop_time" name="ch_stop_time" signature="ch_stop_time(*channels)">
  ...
  <Function id="qiskit.pulse.instructions.SetFrequency.draw" name="draw" signature="draw(dt=1, style=None, filename=None, interp_method=None, scale=1, plot_all=False, plot_range=None, interactive=False, table=True, label=False, framechange=True, channels=None)">
  ...
  <Function id="qiskit.pulse.instructions.SetFrequency.insert" name="insert" signature="insert(start_time, schedule, name=None)">
  ...
  <Function id="qiskit.pulse.instructions.SetFrequency.is_parameterized" name="is_parameterized" signature="is_parameterized()">
  ...
  <Function id="qiskit.pulse.instructions.SetFrequency.shift" name="shift" signature="shift(time, name=None)">
