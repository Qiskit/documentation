...
<Class id="qiskit.circuit.InstructionSet" github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/circuit/instructionset.py" signature="qiskit.circuit.InstructionSet(*, resource_requester=None)">
