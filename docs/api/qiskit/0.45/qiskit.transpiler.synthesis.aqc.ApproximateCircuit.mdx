---
title: ApproximateCircuit (v0.45)
description: API reference for qiskit.transpiler.synthesis.aqc.ApproximateCircuit in qiskit v0.45
...
<Class id="qiskit.transpiler.synthesis.aqc.ApproximateCircuit" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/transpiler/synthesis/aqc/approximate.py" signature="qiskit.transpiler.synthesis.aqc.ApproximateCircuit(num_qubits, name=None)" modifiers="class">
  ...
  *   **name** (*Optional\[*[*str*](https://docs.python.org/3/library/stdtypes.html#str "(in Python v3.12)")*]*) – a name of the circuit.
  ...
  <Attribute id="qiskit.transpiler.synthesis.aqc.ApproximateCircuit.instances" attributeValue="159" />
