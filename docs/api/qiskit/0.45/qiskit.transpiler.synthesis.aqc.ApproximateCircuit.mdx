...
<Class id="qiskit.transpiler.synthesis.aqc.ApproximateCircuit" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/transpiler/synthesis/aqc/approximate.py" signature="qiskit.transpiler.synthesis.aqc.ApproximateCircuit(num_qubits, name=None)">
