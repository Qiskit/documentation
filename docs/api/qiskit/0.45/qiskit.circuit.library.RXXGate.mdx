---
title: RXXGate (v0.45)
description: API reference for qiskit.circuit.library.RXXGate in qiskit v0.45
...
<Class id="qiskit.circuit.library.RXXGate" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/circuit/library/standard_gates/rxx.py" signature="qiskit.circuit.library.RXXGate(theta, label=None, *, duration=None, unit='dt')" modifiers="class">
