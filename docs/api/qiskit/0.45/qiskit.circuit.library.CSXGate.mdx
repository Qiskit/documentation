...
<Class id="qiskit.circuit.library.CSXGate" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/circuit/library/standard_gates/sx.py" signature="qiskit.circuit.library.CSXGate(*args, _force_mutable=False, **kwargs)">
