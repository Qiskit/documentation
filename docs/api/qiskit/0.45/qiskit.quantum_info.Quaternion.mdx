...
<Class id="qiskit.quantum_info.Quaternion" github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/quantum_info/synthesis/quaternion.py" signature="qiskit.quantum_info.Quaternion(data)">
