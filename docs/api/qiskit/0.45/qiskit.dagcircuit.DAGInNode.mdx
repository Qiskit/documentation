---
title: DAGInNode (v0.45)
description: API reference for qiskit.dagcircuit.DAGInNode in qiskit v0.45
...
<Class id="qiskit.dagcircuit.DAGInNode" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/dagcircuit/dagnode.py" signature="qiskit.dagcircuit.DAGInNode(wire)" modifiers="class">
