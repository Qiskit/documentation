...
<Class id="qiskit.dagcircuit.DAGInNode" github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/dagcircuit/dagnode.py" signature="qiskit.dagcircuit.DAGInNode(wire)">
