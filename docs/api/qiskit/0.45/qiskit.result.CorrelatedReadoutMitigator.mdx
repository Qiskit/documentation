...
<Class id="qiskit.result.CorrelatedReadoutMitigator" github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/result/mitigation/correlated_readout_mitigator.py" signature="qiskit.result.CorrelatedReadoutMitigator(assignment_matrix, qubits=None)">
