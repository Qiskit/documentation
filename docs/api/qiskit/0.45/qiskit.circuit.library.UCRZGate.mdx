---
title: UCRZGate (v0.45)
description: API reference for qiskit.circuit.library.UCRZGate in qiskit v0.45
...
<Class id="qiskit.circuit.library.UCRZGate" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/circuit/library/generalized_gates/ucrz.py" signature="qiskit.circuit.library.UCRZGate(angle_list)" modifiers="class">
