...
<Class id="qiskit.circuit.CircuitError" github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/circuit/exceptions.py" signature="qiskit.circuit.CircuitError(*message)">
