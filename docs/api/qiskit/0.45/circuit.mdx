---
title: circuit (v0.45)
description: API reference for qiskit.circuit in qiskit v0.45
...
![../\_images/circuit-1.png](/docs/images/api/qiskit/0.45/circuit-1.avif)
...
![../\_images/circuit-2.png](/docs/images/api/qiskit/0.45/circuit-2.avif)
...
![../\_images/circuit-3.png](/docs/images/api/qiskit/0.45/circuit-3.avif)
...
![../\_images/circuit-4.png](/docs/images/api/qiskit/0.45/circuit-4.avif)
...
![../\_images/depth.gif](/docs/images/api/qiskit/0.45/depth.gif)
...
<Function id="qiskit.circuit.random.random_circuit" github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/circuit/random/utils.py" signature="qiskit.circuit.random.random_circuit(num_qubits, depth, max_operands=4, measure=False, conditional=False, reset=False, seed=None)">
  ...
  ![../\_images/circuit-5.png](/docs/images/api/qiskit/0.45/circuit-5.avif)
...
<Class id="qiskit.circuit.CircuitError" github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/circuit/exceptions.py" signature="qiskit.circuit.CircuitError(*message)" modifiers="exception">
