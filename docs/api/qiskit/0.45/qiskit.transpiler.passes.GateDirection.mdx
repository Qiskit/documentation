---
title: GateDirection (v0.45)
description: API reference for qiskit.transpiler.passes.GateDirection in qiskit v0.45
...
<Class id="qiskit.transpiler.passes.GateDirection" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/transpiler/passes/utils/gate_direction.py" signature="qiskit.transpiler.passes.GateDirection(*args, **kwargs)" modifiers="class">
