...
<Class id="qiskit.circuit.library.AND" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/circuit/library/boolean_logic/quantum_and.py" signature="qiskit.circuit.library.AND(num_variable_qubits, flags=None, mcx_mode='noancilla')" modifiers="class">
  ...
  ![../\_images/qiskit-circuit-library-AND-1.png](/images/api/qiskit/0.45/qiskit-circuit-library-AND-1.avif)
  ...
  ![../\_images/qiskit-circuit-library-AND-2.png](/images/api/qiskit/0.45/qiskit-circuit-library-AND-2.avif)
