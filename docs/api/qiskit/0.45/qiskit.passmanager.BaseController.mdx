---
title: BaseController (v0.45)
description: API reference for qiskit.passmanager.BaseController in qiskit v0.45
...
<Class id="qiskit.passmanager.BaseController" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/passmanager/base_tasks.py" signature="qiskit.passmanager.BaseController(options=None)" modifiers="class">
