...
<Class id="qiskit.result.BaseReadoutMitigator" github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/result/mitigation/base_readout_mitigator.py" signature="qiskit.result.BaseReadoutMitigator">
