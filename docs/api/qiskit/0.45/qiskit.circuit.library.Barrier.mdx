---
title: Barrier (v0.45)
description: API reference for qiskit.circuit.library.Barrier in qiskit v0.45
...
<Class id="qiskit.circuit.library.Barrier" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/circuit/barrier.py" signature="qiskit.circuit.library.Barrier(num_qubits, label=None)" modifiers="class">
