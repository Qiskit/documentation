...
<Class id="qiskit.algorithms.gradients.ReverseEstimatorGradient" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/algorithms/gradients/reverse/reverse_gradient.py" signature="qiskit.algorithms.gradients.ReverseEstimatorGradient(derivative_type=DerivativeType.REAL)">
  ...
  **derivative\_type** (*DerivativeType*) – Defines whether the real, imaginary or real plus imaginary part of the gradient is returned.
  ...
  <Function id="qiskit.algorithms.gradients.ReverseEstimatorGradient.run" name="run" signature="run(circuits, observables, parameter_values, parameters=None, **options)">
  ...
  <Function id="qiskit.algorithms.gradients.ReverseEstimatorGradient.update_default_options" name="update_default_options" signature="update_default_options(**options)">
