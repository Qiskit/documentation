...
<Class id="qiskit.qobj.QasmExperimentCalibrations" github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/qobj/qasm_qobj.py" signature="qiskit.qobj.QasmExperimentCalibrations(gates)">
