---
title: QasmExperimentCalibrations (v0.45)
description: API reference for qiskit.qobj.QasmExperimentCalibrations in qiskit v0.45
...
<Class id="qiskit.qobj.QasmExperimentCalibrations" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/qobj/qasm_qobj.py" signature="qiskit.qobj.QasmExperimentCalibrations(gates)" modifiers="class">
