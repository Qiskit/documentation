---
title: NFT (v0.45)
description: API reference for qiskit.algorithms.optimizers.NFT in qiskit v0.45
...
<Class id="qiskit.algorithms.optimizers.NFT" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/algorithms/optimizers/nft.py" signature="qiskit.algorithms.optimizers.NFT(maxiter=None, maxfev=1024, disp=False, reset_interval=32, options=None, **kwargs)" modifiers="class">
