...
<Class id="qiskit.providers.BackendV2Converter" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/providers/backend_compat.py" signature="qiskit.providers.BackendV2Converter(backend, name_mapping=None, add_delay=False, filter_faulty=False)">
  ...
  *   **filter\_faulty** ([*bool*](https://docs.python.org/3/library/functions.html#bool "(in Python v3.12)")) – If the [`BackendProperties`](qiskit.providers.models.BackendProperties "qiskit.providers.models.BackendProperties") object (if present) for `backend` has any qubits or gates flagged as non-operational filter those from the output target.
  ...
  <Function id="qiskit.providers.BackendV2Converter.acquire_channel" name="acquire_channel" signature="acquire_channel(qubit)">
  ...
  <Function id="qiskit.providers.BackendV2Converter.control_channel" name="control_channel" signature="control_channel(qubits)">
  ...
  <Function id="qiskit.providers.BackendV2Converter.drive_channel" name="drive_channel" signature="drive_channel(qubit)">
  ...
  <Function id="qiskit.providers.BackendV2Converter.measure_channel" name="measure_channel" signature="measure_channel(qubit)">
  ...
  <Function id="qiskit.providers.BackendV2Converter.qubit_properties" name="qubit_properties" signature="qubit_properties(qubit)">
  ...
  <Function id="qiskit.providers.BackendV2Converter.run" name="run" signature="run(run_input, **options)">
    Run on the backend.
  ...
  <Function id="qiskit.providers.BackendV2Converter.set_options" name="set_options" signature="set_options(**fields)">
