---
title: BackendV2Converter (v0.45)
description: API reference for qiskit.providers.BackendV2Converter in qiskit v0.45
...
<Class id="qiskit.providers.BackendV2Converter" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/providers/backend_compat.py" signature="qiskit.providers.BackendV2Converter(backend, name_mapping=None, add_delay=False, filter_faulty=False)" modifiers="class">
