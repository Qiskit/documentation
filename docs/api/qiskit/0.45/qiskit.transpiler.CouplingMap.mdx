---
title: CouplingMap (v0.45)
description: API reference for qiskit.transpiler.CouplingMap in qiskit v0.45
...
<Class id="qiskit.transpiler.CouplingMap" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/transpiler/coupling.py" signature="qiskit.transpiler.CouplingMap(couplinglist=None, description=None)" modifiers="class">
