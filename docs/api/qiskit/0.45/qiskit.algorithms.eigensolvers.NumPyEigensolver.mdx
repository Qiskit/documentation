...
<Class id="qiskit.algorithms.eigensolvers.NumPyEigensolver" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/algorithms/eigensolvers/numpy_eigensolver.py" signature="qiskit.algorithms.eigensolvers.NumPyEigensolver(k=1, filter_criterion=None)">
