---
title: CheckGateDirection (v0.45)
description: API reference for qiskit.transpiler.passes.CheckGateDirection in qiskit v0.45
...
<Class id="qiskit.transpiler.passes.CheckGateDirection" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/transpiler/passes/utils/check_gate_direction.py" signature="qiskit.transpiler.passes.CheckGateDirection(*args, **kwargs)" modifiers="class">
