---
title: InstructionDurations (v0.45)
description: API reference for qiskit.transpiler.InstructionDurations in qiskit v0.45
...
<Class id="qiskit.transpiler.InstructionDurations" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/transpiler/instruction_durations.py" signature="qiskit.transpiler.InstructionDurations(instruction_durations=None, dt=None)" modifiers="class">
