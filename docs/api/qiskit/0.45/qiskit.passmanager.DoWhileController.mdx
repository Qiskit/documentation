...
<Class id="qiskit.passmanager.DoWhileController" github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/passmanager/flow_controllers.py" signature="qiskit.passmanager.DoWhileController(tasks=(), do_while=None, *, options=None)">
