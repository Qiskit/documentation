---
title: IQP (v0.45)
description: API reference for qiskit.circuit.library.IQP in qiskit v0.45
...
<Class id="qiskit.circuit.library.IQP" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/circuit/library/iqp.py" signature="qiskit.circuit.library.IQP(interactions)" modifiers="class">
  ...
  **Reference Circuit:**
  ...
  ![../\_images/qiskit-circuit-library-IQP-1.png](/docs/images/api/qiskit/0.45/qiskit-circuit-library-IQP-1.avif)

  **Expanded Circuit:**

  > ![../\_images/qiskit-circuit-library-IQP-2.png](/docs/images/api/qiskit/0.45/qiskit-circuit-library-IQP-2.avif)
