---
title: RXCalibrationBuilder (v0.45)
description: API reference for qiskit.transpiler.passes.RXCalibrationBuilder in qiskit v0.45
...
<Class id="qiskit.transpiler.passes.RXCalibrationBuilder" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/transpiler/passes/calibration/rx_builder.py" signature="qiskit.transpiler.passes.RXCalibrationBuilder(*args, **kwargs)" modifiers="class">
