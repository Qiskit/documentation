...
<Class id="qiskit.transpiler.passes.RXCalibrationBuilder" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/transpiler/passes/calibration/rx_builder.py" signature="qiskit.transpiler.passes.RXCalibrationBuilder(*args, **kwargs)">
