...
<Class id="qiskit.algorithms.optimizers.CG" github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/algorithms/optimizers/cg.py" signature="qiskit.algorithms.optimizers.CG(maxiter=20, disp=False, gtol=1e-05, tol=None, eps=1.4901161193847656e-08, options=None, max_evals_grouped=1, **kwargs)">
