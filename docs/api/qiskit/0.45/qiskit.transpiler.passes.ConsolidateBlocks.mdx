...
<Class id="qiskit.transpiler.passes.ConsolidateBlocks" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/transpiler/passes/optimization/consolidate_blocks.py" signature="qiskit.transpiler.passes.ConsolidateBlocks(*args, **kwargs)">
  ...
  *   **target** ([*Target*](qiskit.transpiler.Target "qiskit.transpiler.Target")) – The target object for the compilation target backend.
  ...
  <Attribute id="qiskit.transpiler.passes.ConsolidateBlocks.is_analysis_pass" name="is_analysis_pass">
  ...
  <Attribute id="qiskit.transpiler.passes.ConsolidateBlocks.is_transformation_pass" name="is_transformation_pass">
  ...
  <Function id="qiskit.transpiler.passes.ConsolidateBlocks.execute" name="execute" signature="execute(passmanager_ir, state, callback=None)">
  ...
  <Function id="qiskit.transpiler.passes.ConsolidateBlocks.name" name="name" signature="name()">
    Name of the pass.
  ...
  <Function id="qiskit.transpiler.passes.ConsolidateBlocks.run" name="run" signature="run(dag)">
  ...
  <Function id="qiskit.transpiler.passes.ConsolidateBlocks.update_status" name="update_status" signature="update_status(state, run_state)">
