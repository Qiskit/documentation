...
description: API reference for qiskit.providers.fake_provider.FakeValenciaV2 in qiskit v0.45
...
<Class id="qiskit.providers.fake_provider.FakeValenciaV2" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/providers/fake_provider/backends/valencia/fake_valencia.py" signature="qiskit.providers.fake_provider.FakeValenciaV2" modifiers="class">
