...
<Class id="qiskit.circuit.library.PhaseEstimation" github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/circuit/library/phase_estimation.py" signature="qiskit.circuit.library.PhaseEstimation(num_evaluation_qubits, unitary, iqft=None, name='QPE')">
