---
title: FakeHanoiV2 (v0.45)
description: API reference for qiskit.providers.fake_provider.FakeHanoiV2 in qiskit v0.45
...
<Class id="qiskit.providers.fake_provider.FakeHanoiV2" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/providers/fake_provider/backends/hanoi/fake_hanoi.py" signature="qiskit.providers.fake_provider.FakeHanoiV2" modifiers="class">
