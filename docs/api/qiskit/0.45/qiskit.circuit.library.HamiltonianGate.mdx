...
<Class id="qiskit.circuit.library.HamiltonianGate" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/circuit/library/hamiltonian_gate.py" signature="qiskit.circuit.library.HamiltonianGate(data, time, label=None)">
  ...
  **Raises**
  ...
  <Function id="qiskit.circuit.library.HamiltonianGate.inverse" name="inverse" signature="inverse()">
    Return the adjoint of the unitary.
  </Function>

  ### qasm

  <Function id="qiskit.circuit.library.HamiltonianGate.qasm" name="qasm" signature="qasm()">
