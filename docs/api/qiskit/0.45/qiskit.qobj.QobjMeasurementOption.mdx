---
title: QobjMeasurementOption (v0.45)
description: API reference for qiskit.qobj.QobjMeasurementOption in qiskit v0.45
...
<Class id="qiskit.qobj.QobjMeasurementOption" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/qobj/pulse_qobj.py" signature="qiskit.qobj.QobjMeasurementOption(name, params=None)" modifiers="class">
