---
title: FakePrague (v0.45)
description: API reference for qiskit.providers.fake_provider.FakePrague in qiskit v0.45
...
<Class id="qiskit.providers.fake_provider.FakePrague" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/providers/fake_provider/backends/prague/fake_prague.py" signature="qiskit.providers.fake_provider.FakePrague" modifiers="class">
