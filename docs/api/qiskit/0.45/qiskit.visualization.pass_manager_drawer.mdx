---
title: pass_manager_drawer (v0.45)
description: API reference for qiskit.visualization.pass_manager_drawer in qiskit v0.45
...
<Function id="qiskit.visualization.pass_manager_drawer" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/visualization/pass_manager_visualization.py" signature="qiskit.visualization.pass_manager_drawer(pass_manager, filename=None, style=None, raw=False)">
