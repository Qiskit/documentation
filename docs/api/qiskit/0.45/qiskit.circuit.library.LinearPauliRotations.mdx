---
title: LinearPauliRotations (v0.45)
description: API reference for qiskit.circuit.library.LinearPauliRotations in qiskit v0.45
...
<Class id="qiskit.circuit.library.LinearPauliRotations" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/circuit/library/arithmetic/linear_pauli_rotations.py" signature="qiskit.circuit.library.LinearPauliRotations(num_state_qubits=None, slope=1, offset=0, basis='Y', name='LinRot')" modifiers="class">
...
$$
  ...
  *   **name** ([*str*](https://docs.python.org/3/library/stdtypes.html#str "(in Python v3.12)")) – The name of the circuit object.
  ...
  <Attribute id="qiskit.circuit.library.LinearPauliRotations.instances" attributeValue="181" />
