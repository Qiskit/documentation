---
title: AnnotatedOperation (v0.45)
description: API reference for qiskit.circuit.AnnotatedOperation in qiskit v0.45
...
<Class id="qiskit.circuit.AnnotatedOperation" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/circuit/annotated_operation.py" signature="qiskit.circuit.AnnotatedOperation(base_op, modifiers)" modifiers="class">
