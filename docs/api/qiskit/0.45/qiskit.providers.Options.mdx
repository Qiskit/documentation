---
title: Options (v0.45)
description: API reference for qiskit.providers.Options in qiskit v0.45
...
<Class id="qiskit.providers.Options" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/providers/options.py" signature="qiskit.providers.Options(**kwargs)" modifiers="class">
  ...
  <Function id="qiskit.providers.Options.set_validator" signature="set_validator(field, validator_value)">
