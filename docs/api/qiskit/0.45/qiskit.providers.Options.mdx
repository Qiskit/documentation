...
<Class id="qiskit.providers.Options" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/providers/options.py" signature="qiskit.providers.Options(**kwargs)">
  ...
  <Function id="qiskit.providers.Options.set_validator" name="set_validator" signature="set_validator(field, validator_value)">
  ...
  <Function id="qiskit.providers.Options.update_options" name="update_options" signature="update_options(**fields)">
