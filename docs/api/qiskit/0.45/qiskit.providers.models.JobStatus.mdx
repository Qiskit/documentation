...
<Class id="qiskit.providers.models.JobStatus" github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/providers/models/jobstatus.py" signature="qiskit.providers.models.JobStatus(job_id, status, status_msg, **kwargs)">
