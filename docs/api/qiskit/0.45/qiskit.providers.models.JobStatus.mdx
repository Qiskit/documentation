---
title: JobStatus (v0.45)
description: API reference for qiskit.providers.models.JobStatus in qiskit v0.45
...
<Class id="qiskit.providers.models.JobStatus" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/providers/models/jobstatus.py" signature="qiskit.providers.models.JobStatus(job_id, status, status_msg, **kwargs)" modifiers="class">
