---
title: DenseLayout (v0.45)
description: API reference for qiskit.transpiler.passes.DenseLayout in qiskit v0.45
...
<Class id="qiskit.transpiler.passes.DenseLayout" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/transpiler/passes/layout/dense_layout.py" signature="qiskit.transpiler.passes.DenseLayout(*args, **kwargs)" modifiers="class">
  ...
  *   **target** ([*Target*](qiskit.transpiler.Target "qiskit.transpiler.Target")) – A target representing the target backend.
  ...
  <Function id="qiskit.transpiler.passes.DenseLayout.execute" signature="execute(passmanager_ir, state, callback=None)">
  ...
  <Function id="qiskit.transpiler.passes.DenseLayout.update_status" signature="update_status(state, run_state)">
