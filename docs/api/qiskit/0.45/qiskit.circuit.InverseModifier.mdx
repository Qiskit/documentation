...
<Class id="qiskit.circuit.InverseModifier" github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/circuit/annotated_operation.py" signature="qiskit.circuit.InverseModifier">
  Bases: `Modifier`
