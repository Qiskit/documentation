...
<Class id="qiskit.circuit.library.RYGate" github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/circuit/library/standard_gates/ry.py" signature="qiskit.circuit.library.RYGate(theta, label=None, *, duration=None, unit='dt')">
