...
<Class id="qiskit.providers.fake_provider.FakeMumbaiV2" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/providers/fake_provider/backends/mumbai/fake_mumbai.py" signature="qiskit.providers.fake_provider.FakeMumbaiV2">
