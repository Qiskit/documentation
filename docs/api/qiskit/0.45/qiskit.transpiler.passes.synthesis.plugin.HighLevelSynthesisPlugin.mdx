---
title: HighLevelSynthesisPlugin (v0.45)
description: API reference for qiskit.transpiler.passes.synthesis.plugin.HighLevelSynthesisPlugin in qiskit v0.45
...
<Class id="qiskit.transpiler.passes.synthesis.plugin.HighLevelSynthesisPlugin" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/transpiler/passes/synthesis/plugin.py" signature="qiskit.transpiler.passes.synthesis.plugin.HighLevelSynthesisPlugin" modifiers="class">
  ...
  <Function id="qiskit.transpiler.passes.synthesis.plugin.HighLevelSynthesisPlugin.run" signature="run(high_level_object, coupling_map=None, target=None, qubits=None, **options)" modifiers="abstract">
