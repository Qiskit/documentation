---
title: ASAPSchedule (v0.45)
description: API reference for qiskit.transpiler.passes.ASAPSchedule in qiskit v0.45
...
<Class id="qiskit.transpiler.passes.ASAPSchedule" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/transpiler/passes/scheduling/asap.py" signature="qiskit.transpiler.passes.ASAPSchedule(*args, **kwargs)" modifiers="class">
  ...
  <Function id="qiskit.transpiler.passes.ASAPSchedule.execute" signature="execute(passmanager_ir, state, callback=None)">
  ...
  <Function id="qiskit.transpiler.passes.ASAPSchedule.run" signature="run(dag)">
  ...
  <Function id="qiskit.transpiler.passes.ASAPSchedule.update_status" signature="update_status(state, run_state)">
