...
description: API reference for qiskit.providers.models.UchannelLO in qiskit v0.45
...
<Class id="qiskit.providers.models.UchannelLO" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/providers/models/backendconfiguration.py" signature="qiskit.providers.models.UchannelLO(q, scale)" modifiers="class">
