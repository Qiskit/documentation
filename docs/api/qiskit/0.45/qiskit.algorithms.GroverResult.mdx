---
title: GroverResult (v0.45)
description: API reference for qiskit.algorithms.GroverResult in qiskit v0.45
...
<Class id="qiskit.algorithms.GroverResult" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/algorithms/amplitude_amplifiers/grover.py" signature="qiskit.algorithms.GroverResult" modifiers="class">
