...
<Class id="qiskit.opflow.evolutions.MatrixEvolution" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/opflow/evolutions/matrix_evolution.py" signature="qiskit.opflow.evolutions.MatrixEvolution">
