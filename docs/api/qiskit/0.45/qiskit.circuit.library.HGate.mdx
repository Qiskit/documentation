...
<Class id="qiskit.circuit.library.HGate" github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/circuit/library/standard_gates/h.py" signature="qiskit.circuit.library.HGate(*args, _force_mutable=False, **kwargs)">
