...
<Class id="qiskit.utils.mitigation.CompleteMeasFitter" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/utils/mitigation/fitters.py" signature="qiskit.utils.mitigation.CompleteMeasFitter(results, state_labels, qubit_list=None, circlabel='')">
  ...
  *   **circlabel** ([*str*](https://docs.python.org/3/library/stdtypes.html#str "(in Python v3.12)")) – if the qubits were labeled.
  ...
  <Function id="qiskit.utils.mitigation.CompleteMeasFitter.add_data" name="add_data" signature="add_data(new_results, rebuild_cal_matrix=True)">
  ...
  <Function id="qiskit.utils.mitigation.CompleteMeasFitter.readout_fidelity" name="readout_fidelity" signature="readout_fidelity(label_list=None)">
  ...
  <Function id="qiskit.utils.mitigation.CompleteMeasFitter.subset_fitter" name="subset_fitter" signature="subset_fitter(qubit_sublist)">
