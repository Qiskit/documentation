...
description: API reference for qiskit.providers.fake_provider.FakeSydneyV2 in qiskit v0.45
...
<Class id="qiskit.providers.fake_provider.FakeSydneyV2" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/providers/fake_provider/backends/sydney/fake_sydney.py" signature="qiskit.providers.fake_provider.FakeSydneyV2" modifiers="class">
