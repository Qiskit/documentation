...
<Class id="qiskit.opflow.expectations.AerPauliExpectation" github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/opflow/expectations/aer_pauli_expectation.py" signature="qiskit.opflow.expectations.AerPauliExpectation">
