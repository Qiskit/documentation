...
<Class id="qiskit.opflow.OpflowError" github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/opflow/exceptions.py" signature="qiskit.opflow.OpflowError(*message)">
