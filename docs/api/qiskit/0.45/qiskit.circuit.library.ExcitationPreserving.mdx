---
title: ExcitationPreserving (v0.45)
description: API reference for qiskit.circuit.library.ExcitationPreserving in qiskit v0.45
...
$$
  ...
  **Raises**
  ...
  <Attribute id="qiskit.circuit.library.ExcitationPreserving.instances" attributeValue="167" />
