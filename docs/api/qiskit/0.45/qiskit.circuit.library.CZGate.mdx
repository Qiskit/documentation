---
title: CZGate (v0.45)
description: API reference for qiskit.circuit.library.CZGate in qiskit v0.45
...
<Class id="qiskit.circuit.library.CZGate" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/circuit/library/standard_gates/z.py" signature="qiskit.circuit.library.CZGate(*args, _force_mutable=False, **kwargs)" modifiers="class">
