...
<Class id="qiskit.pulse.transforms.AlignRight" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/pulse/transforms/alignments.py" signature="qiskit.pulse.transforms.AlignRight">
  ...
  <Function id="qiskit.pulse.transforms.AlignRight.align" name="align" signature="align(schedule)">
