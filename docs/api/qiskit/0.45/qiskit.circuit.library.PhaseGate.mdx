...
<Class id="qiskit.circuit.library.PhaseGate" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/circuit/library/standard_gates/p.py" signature="qiskit.circuit.library.PhaseGate(theta, label=None, *, duration=None, unit='dt')">
