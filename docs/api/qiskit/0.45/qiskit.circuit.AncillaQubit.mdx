---
title: AncillaQubit (v0.45)
description: API reference for qiskit.circuit.AncillaQubit in qiskit v0.45
...
<Class id="qiskit.circuit.AncillaQubit" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/circuit/quantumregister.py" signature="qiskit.circuit.AncillaQubit(register=None, index=None)" modifiers="class">
