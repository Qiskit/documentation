...
<Class id="qiskit.opflow.gradients.Gradient" github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/opflow/gradients/gradient.py" signature="qiskit.opflow.gradients.Gradient(grad_method='param_shift', **kwargs)">
