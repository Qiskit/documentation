---
title: SteppableOptimizer (v0.45)
description: API reference for qiskit.algorithms.optimizers.SteppableOptimizer in qiskit v0.45
...
<Class id="qiskit.algorithms.optimizers.SteppableOptimizer" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/algorithms/optimizers/steppable_optimizer.py" signature="qiskit.algorithms.optimizers.SteppableOptimizer(maxiter=100)" modifiers="class">
