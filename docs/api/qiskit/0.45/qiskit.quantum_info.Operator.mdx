...
$$
  ...
  **Additional Information:**
  ...
  <Function id="qiskit.quantum_info.Operator.draw" signature="draw(output=None, **drawer_args)">
  ...
  <Function id="qiskit.quantum_info.Operator.from_circuit" signature="classmethod from_circuit(circuit, ignore_set_layout=False, layout=None, final_layout=None)">
