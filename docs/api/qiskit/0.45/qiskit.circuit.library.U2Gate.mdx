---
title: U2Gate (v0.45)
description: API reference for qiskit.circuit.library.U2Gate in qiskit v0.45
...
<Class id="qiskit.circuit.library.U2Gate" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/circuit/library/standard_gates/u2.py" signature="qiskit.circuit.library.U2Gate(phi, lam, label=None, *, duration=None, unit='dt')" modifiers="class">
