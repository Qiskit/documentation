...
<Class id="qiskit.opflow.state_fns.CVaRMeasurement" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/opflow/state_fns/cvar_measurement.py" signature="qiskit.opflow.state_fns.CVaRMeasurement(*args, **kwargs)">
  ...
  *   [**OpflowError**](opflow#qiskit.opflow.OpflowError "qiskit.opflow.OpflowError") – If the primitive is not diagonal.
  ...
  <Attribute id="qiskit.opflow.state_fns.CVaRMeasurement.INDENTATION" name="INDENTATION" attributeValue="= '  '" />

  ### alpha

  <Attribute id="qiskit.opflow.state_fns.CVaRMeasurement.alpha" name="alpha">
  ...
  <Attribute id="qiskit.opflow.state_fns.CVaRMeasurement.coeff" name="coeff">
    A coefficient by which the state function is multiplied.
  </Attribute>

  ### instance\_id

  <Attribute id="qiskit.opflow.state_fns.CVaRMeasurement.instance_id" name="instance_id">
    Return the unique instance id.
  </Attribute>

  ### is\_measurement

  <Attribute id="qiskit.opflow.state_fns.CVaRMeasurement.is_measurement" name="is_measurement">
    Whether the StateFn object is a measurement Operator.
  </Attribute>

  ### num\_qubits

  <Attribute id="qiskit.opflow.state_fns.CVaRMeasurement.num_qubits" name="num_qubits" />

  ### parameters

  <Attribute id="qiskit.opflow.state_fns.CVaRMeasurement.parameters" name="parameters" />

  ### primitive

  <Attribute id="qiskit.opflow.state_fns.CVaRMeasurement.primitive" name="primitive" attributeTypeHint="OperatorBase">
    The primitive which defines the behavior of the underlying State function.
  </Attribute>

  ### settings

  <Attribute id="qiskit.opflow.state_fns.CVaRMeasurement.settings" name="settings">
    Return settings.
  </Attribute>
  ...
  <Function id="qiskit.opflow.state_fns.CVaRMeasurement.add" name="add" signature="add(other)">
  ...
  <Function id="qiskit.opflow.state_fns.CVaRMeasurement.adjoint" name="adjoint" signature="adjoint()">
  ...
  <Function id="qiskit.opflow.state_fns.CVaRMeasurement.compute_cvar" name="compute_cvar" signature="compute_cvar(energies, probabilities)">
  ...
  <Function id="qiskit.opflow.state_fns.CVaRMeasurement.eval" name="eval" signature="eval(front=None)">
  ...
  <Function id="qiskit.opflow.state_fns.CVaRMeasurement.eval_variance" name="eval_variance" signature="eval_variance(front=None)">
  ...
  <Function id="qiskit.opflow.state_fns.CVaRMeasurement.get_outcome_energies_probabilities" name="get_outcome_energies_probabilities" signature="get_outcome_energies_probabilities(front=None)">
  ...
  <Function id="qiskit.opflow.state_fns.CVaRMeasurement.mul" name="mul" signature="mul(scalar)">
  ...
  <Function id="qiskit.opflow.state_fns.CVaRMeasurement.sample" name="sample" signature="sample(shots=1024, massive=False, reverse_endianness=False)">
  ...
  <Function id="qiskit.opflow.state_fns.CVaRMeasurement.tensor" name="tensor" signature="tensor(other)">
  ...
  <Function id="qiskit.opflow.state_fns.CVaRMeasurement.to_circuit_op" name="to_circuit_op" signature="to_circuit_op()">
    Not defined.
  </Function>

  ### to\_density\_matrix

  <Function id="qiskit.opflow.state_fns.CVaRMeasurement.to_density_matrix" name="to_density_matrix" signature="to_density_matrix(massive=False)">
    Not defined.
  </Function>

  ### to\_matrix

  <Function id="qiskit.opflow.state_fns.CVaRMeasurement.to_matrix" name="to_matrix" signature="to_matrix(massive=False)">
    Not defined.
  </Function>

  ### to\_matrix\_op

  <Function id="qiskit.opflow.state_fns.CVaRMeasurement.to_matrix_op" name="to_matrix_op" signature="to_matrix_op(massive=False)">
    Not defined.
  </Function>

  ### traverse

  <Function id="qiskit.opflow.state_fns.CVaRMeasurement.traverse" name="traverse" signature="traverse(convert_fn, coeff=None)">
