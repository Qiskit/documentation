---
title: GradientBase (v0.45)
description: API reference for qiskit.opflow.gradients.GradientBase in qiskit v0.45
...
<Class id="qiskit.opflow.gradients.GradientBase" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/opflow/gradients/gradient_base.py" signature="qiskit.opflow.gradients.GradientBase(grad_method='param_shift', **kwargs)" modifiers="class">
