...
description: API reference for qiskit.providers.fake_provider.FakeGeneva in qiskit v0.45
...
<Class id="qiskit.providers.fake_provider.FakeGeneva" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/providers/fake_provider/backends/geneva/fake_geneva.py" signature="qiskit.providers.fake_provider.FakeGeneva" modifiers="class">
