...
description: API reference for qiskit.providers.fake_provider.FakeOurenseV2 in qiskit v0.45
...
<Class id="qiskit.providers.fake_provider.FakeOurenseV2" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/providers/fake_provider/backends/ourense/fake_ourense.py" signature="qiskit.providers.fake_provider.FakeOurenseV2" modifiers="class">
