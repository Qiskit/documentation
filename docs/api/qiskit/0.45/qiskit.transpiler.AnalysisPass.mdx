...
<Class id="qiskit.transpiler.AnalysisPass" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/transpiler/basepasses.py" signature="qiskit.transpiler.AnalysisPass(*args, **kwargs)">
  Bases: `BasePass`
