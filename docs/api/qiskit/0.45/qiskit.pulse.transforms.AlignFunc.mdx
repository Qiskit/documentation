...
<Class id="qiskit.pulse.transforms.AlignFunc" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/pulse/transforms/alignments.py" signature="qiskit.pulse.transforms.AlignFunc(duration, func)">
