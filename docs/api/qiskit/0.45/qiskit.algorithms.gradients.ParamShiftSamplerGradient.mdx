...
<Class id="qiskit.algorithms.gradients.ParamShiftSamplerGradient" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/algorithms/gradients/param_shift/param_shift_sampler_gradient.py" signature="qiskit.algorithms.gradients.ParamShiftSamplerGradient(sampler, options=None)">
