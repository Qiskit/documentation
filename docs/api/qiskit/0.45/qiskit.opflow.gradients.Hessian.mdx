...
<Class id="qiskit.opflow.gradients.Hessian" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/opflow/gradients/hessian.py" signature="qiskit.opflow.gradients.Hessian(hess_method='param_shift', **kwargs)">
