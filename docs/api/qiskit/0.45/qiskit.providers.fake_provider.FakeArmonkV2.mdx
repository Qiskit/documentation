...
<Class id="qiskit.providers.fake_provider.FakeArmonkV2" github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/providers/fake_provider/backends/armonk/fake_armonk.py" signature="qiskit.providers.fake_provider.FakeArmonkV2">
