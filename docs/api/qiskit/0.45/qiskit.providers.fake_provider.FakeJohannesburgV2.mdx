...
<Class id="qiskit.providers.fake_provider.FakeJohannesburgV2" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/providers/fake_provider/backends/johannesburg/fake_johannesburg.py" signature="qiskit.providers.fake_provider.FakeJohannesburgV2">
