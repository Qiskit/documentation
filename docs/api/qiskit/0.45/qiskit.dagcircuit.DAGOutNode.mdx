---
title: DAGOutNode (v0.45)
description: API reference for qiskit.dagcircuit.DAGOutNode in qiskit v0.45
...
<Class id="qiskit.dagcircuit.DAGOutNode" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/dagcircuit/dagnode.py" signature="qiskit.dagcircuit.DAGOutNode(wire)" modifiers="class">
