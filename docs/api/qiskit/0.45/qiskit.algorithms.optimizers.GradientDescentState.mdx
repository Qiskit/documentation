---
title: GradientDescentState (v0.45)
description: API reference for qiskit.algorithms.optimizers.GradientDescentState in qiskit v0.45
...
<Class id="qiskit.algorithms.optimizers.GradientDescentState" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/algorithms/optimizers/gradient_descent.py" signature="qiskit.algorithms.optimizers.GradientDescentState(x, fun, jac, nfev, njev, nit, stepsize, learning_rate)" modifiers="class">
