...
<Class id="qiskit.primitives.BaseSampler" github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/primitives/base/base_sampler.py" signature="qiskit.primitives.BaseSampler(*, options=None)">
