---
title: PiecewiseLinearPauliRotations (v0.45)
description: API reference for qiskit.circuit.library.PiecewiseLinearPauliRotations in qiskit v0.45
...
$$
  ...
  *   **name** ([*str*](https://docs.python.org/3/library/stdtypes.html#str "(in Python v3.12)")) – The name of the circuit.
  ...
  <Attribute id="qiskit.circuit.library.PiecewiseLinearPauliRotations.instances" attributeValue="328" />
