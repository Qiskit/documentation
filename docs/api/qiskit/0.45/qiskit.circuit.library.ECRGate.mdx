...
<Class id="qiskit.circuit.library.ECRGate" github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/circuit/library/standard_gates/ecr.py" signature="qiskit.circuit.library.ECRGate(*args, _force_mutable=False, **kwargs)">
