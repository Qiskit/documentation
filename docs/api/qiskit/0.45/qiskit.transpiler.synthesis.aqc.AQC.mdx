...
<Class id="qiskit.transpiler.synthesis.aqc.AQC" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/transpiler/synthesis/aqc/aqc.py" signature="qiskit.transpiler.synthesis.aqc.AQC(optimizer=None, seed=None)">
  ...
  *   **seed** ([*int*](https://docs.python.org/3/library/functions.html#int "(in Python v3.12)") *| None*) – a seed value to be used by a random number generator.
  ...
  <Function id="qiskit.transpiler.synthesis.aqc.AQC.compile_unitary" name="compile_unitary" signature="compile_unitary(target_matrix, approximate_circuit, approximating_objective, initial_point=None)">
