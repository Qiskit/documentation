...
<Class id="qiskit.transpiler.synthesis.aqc.AQC" github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/transpiler/synthesis/aqc/aqc.py" signature="qiskit.transpiler.synthesis.aqc.AQC(optimizer=None, seed=None)">
