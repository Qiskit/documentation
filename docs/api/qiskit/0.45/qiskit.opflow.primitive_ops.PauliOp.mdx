---
title: PauliOp (v0.45)
description: API reference for qiskit.opflow.primitive_ops.PauliOp in qiskit v0.45
...
<Class id="qiskit.opflow.primitive_ops.PauliOp" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/opflow/primitive_ops/pauli_op.py" signature="qiskit.opflow.primitive_ops.PauliOp(*args, **kwargs)" modifiers="class">
  ...
  **Raises**
  ...
  <Attribute id="qiskit.opflow.primitive_ops.PauliOp.primitive" attributeTypeHint="Pauli">
