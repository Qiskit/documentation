---
title: NormalizeRXAngle (v0.45)
description: API reference for qiskit.transpiler.passes.NormalizeRXAngle in qiskit v0.45
...
<Class id="qiskit.transpiler.passes.NormalizeRXAngle" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/transpiler/passes/optimization/normalize_rx_angle.py" signature="qiskit.transpiler.passes.NormalizeRXAngle(*args, **kwargs)" modifiers="class">
