---
title: LieTrotter (v0.45)
description: API reference for qiskit.synthesis.LieTrotter in qiskit v0.45
...
<Class id="qiskit.synthesis.LieTrotter" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/synthesis/evolution/lie_trotter.py" signature="qiskit.synthesis.LieTrotter(reps=1, insert_barriers=False, cx_structure='chain', atomic_evolution=None)" modifiers="class">
