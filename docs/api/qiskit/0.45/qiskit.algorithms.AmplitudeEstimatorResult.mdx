---
title: AmplitudeEstimatorResult (v0.45)
description: API reference for qiskit.algorithms.AmplitudeEstimatorResult in qiskit v0.45
...
<Class id="qiskit.algorithms.AmplitudeEstimatorResult" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/algorithms/amplitude_estimators/amplitude_estimator.py" signature="qiskit.algorithms.AmplitudeEstimatorResult" modifiers="class">
