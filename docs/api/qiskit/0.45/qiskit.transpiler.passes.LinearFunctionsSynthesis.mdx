...
<Class id="qiskit.transpiler.passes.LinearFunctionsSynthesis" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/transpiler/passes/synthesis/linear_functions_synthesis.py" signature="qiskit.transpiler.passes.LinearFunctionsSynthesis(*args, **kwargs)">
  ...
  <Attribute id="qiskit.transpiler.passes.LinearFunctionsSynthesis.is_analysis_pass" name="is_analysis_pass">
  ...
  <Attribute id="qiskit.transpiler.passes.LinearFunctionsSynthesis.is_transformation_pass" name="is_transformation_pass">
  ...
  <Function id="qiskit.transpiler.passes.LinearFunctionsSynthesis.execute" name="execute" signature="execute(passmanager_ir, state, callback=None)">
  ...
  <Function id="qiskit.transpiler.passes.LinearFunctionsSynthesis.name" name="name" signature="name()">
    Name of the pass.
  ...
  <Function id="qiskit.transpiler.passes.LinearFunctionsSynthesis.run" name="run" signature="run(dag)">
  ...
  <Function id="qiskit.transpiler.passes.LinearFunctionsSynthesis.update_status" name="update_status" signature="update_status(state, run_state)">
