---
title: InnerProduct (v0.45)
description: API reference for qiskit.circuit.library.InnerProduct in qiskit v0.45
...
<Class id="qiskit.circuit.library.InnerProduct" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/circuit/library/boolean_logic/inner_product.py" signature="qiskit.circuit.library.InnerProduct(num_qubits)" modifiers="class">
...
$$
  ...
  **Reference Circuit:**
  ...
  ![../\_images/qiskit-circuit-library-InnerProduct-1.png](/docs/images/api/qiskit/0.45/qiskit-circuit-library-InnerProduct-1.avif)
  ...
  **num\_qubits** ([*int*](https://docs.python.org/3/library/functions.html#int "(in Python v3.12)")) – width of top and bottom registers (half total circuit width)
  ...
  <Attribute id="qiskit.circuit.library.InnerProduct.instances" attributeValue="179" />
