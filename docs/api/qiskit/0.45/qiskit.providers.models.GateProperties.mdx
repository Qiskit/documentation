---
title: GateProperties (v0.45)
description: API reference for qiskit.providers.models.GateProperties in qiskit v0.45
...
<Class id="qiskit.providers.models.GateProperties" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/providers/models/backendproperties.py" signature="qiskit.providers.models.GateProperties(qubits, gate, parameters, **kwargs)" modifiers="class">
