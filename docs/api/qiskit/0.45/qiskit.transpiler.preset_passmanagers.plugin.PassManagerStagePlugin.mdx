...
<Class id="qiskit.transpiler.preset_passmanagers.plugin.PassManagerStagePlugin" github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/transpiler/preset_passmanagers/plugin.py" signature="qiskit.transpiler.preset_passmanagers.plugin.PassManagerStagePlugin">
