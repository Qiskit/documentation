---
title: AQCSynthesisPlugin (v0.45)
description: API reference for qiskit.transpiler.synthesis.aqc.AQCSynthesisPlugin in qiskit v0.45
...
<Class id="qiskit.transpiler.synthesis.aqc.AQCSynthesisPlugin" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/transpiler/synthesis/aqc/aqc_plugin.py" signature="qiskit.transpiler.synthesis.aqc.AQCSynthesisPlugin" modifiers="class">
  ...
  **initial\_point ([`ndarray`](https://numpy.org/doc/stable/reference/generated/numpy.ndarray.html#numpy.ndarray "(in NumPy v1.26)"))**
  ...
  <Attribute id="qiskit.transpiler.synthesis.aqc.AQCSynthesisPlugin.supports_gate_errors_by_qubit">
  ...
  <Attribute id="qiskit.transpiler.synthesis.aqc.AQCSynthesisPlugin.supports_gate_lengths_by_qubit">
  ...
  <Function id="qiskit.transpiler.synthesis.aqc.AQCSynthesisPlugin.run" signature="run(unitary, **options)">
