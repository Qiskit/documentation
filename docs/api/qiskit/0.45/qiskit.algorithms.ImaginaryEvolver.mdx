...
<Class id="qiskit.algorithms.ImaginaryEvolver" github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/algorithms/evolvers/imaginary_evolver.py" signature="qiskit.algorithms.ImaginaryEvolver">
