---
title: LocalReadoutMitigator (v0.45)
description: API reference for qiskit.result.LocalReadoutMitigator in qiskit v0.45
...
<Class id="qiskit.result.LocalReadoutMitigator" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/result/mitigation/local_readout_mitigator.py" signature="qiskit.result.LocalReadoutMitigator(assignment_matrices=None, qubits=None, backend=None)" modifiers="class">
  ...
  **Raises**
  ...
  <Function id="qiskit.result.LocalReadoutMitigator.assignment_matrix" signature="assignment_matrix(qubits=None)">
  ...
  <Function id="qiskit.result.LocalReadoutMitigator.expectation_value" signature="expectation_value(data, diagonal=None, qubits=None, clbits=None, shots=None)">
  ...
  <Function id="qiskit.result.LocalReadoutMitigator.mitigation_matrix" signature="mitigation_matrix(qubits=None)">
  ...
  <Function id="qiskit.result.LocalReadoutMitigator.quasi_probabilities" signature="quasi_probabilities(data, qubits=None, clbits=None, shots=None)">
  ...
  <Function id="qiskit.result.LocalReadoutMitigator.stddev_upper_bound" signature="stddev_upper_bound(shots, qubits=None)">
