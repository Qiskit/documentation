...
<Class id="qiskit.circuit.classicalfunction.BooleanExpression" github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/circuit/classicalfunction/boolean_expression.py" signature="qiskit.circuit.classicalfunction.BooleanExpression(expression, name=None, var_order=None)">
