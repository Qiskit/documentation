...
<Class id="qiskit.circuit.ClassicalRegister" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/circuit/classicalregister.py" signature="qiskit.circuit.ClassicalRegister(size=None, name=None, bits=None)">
