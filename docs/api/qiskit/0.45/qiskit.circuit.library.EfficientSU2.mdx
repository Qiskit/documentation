...
<Class id="qiskit.circuit.library.EfficientSU2" github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/circuit/library/n_local/efficient_su2.py" signature="qiskit.circuit.library.EfficientSU2(num_qubits=None, su2_gates=None, entanglement='reverse_linear', reps=3, skip_unentangled_qubits=False, skip_final_rotation_layer=False, parameter_prefix='θ', insert_barriers=False, initial_state=None, name='EfficientSU2', flatten=None)">
  ...
  *   **flatten** ([*bool*](https://docs.python.org/3/library/functions.html#bool "(in Python v3.12)") *| None*) – Set this to `True` to output a flat circuit instead of nesting it inside multiple layers of gate objects. By default currently the contents of the output circuit will be wrapped in nested objects for cleaner visualization. However, if you’re using this circuit for anything besides visualization its **strongly** recommended to set this flag to `True` to avoid a large performance overhead for parameter binding.
  ...
  <Attribute id="qiskit.circuit.library.EfficientSU2.ancillas" name="ancillas">
    Returns a list of ancilla bits in the order that the registers were added.
  </Attribute>

  ### calibrations

  <Attribute id="qiskit.circuit.library.EfficientSU2.calibrations" name="calibrations">
  ...
  <Attribute id="qiskit.circuit.library.EfficientSU2.clbits" name="clbits">
    Returns a list of classical bits in the order that the registers were added.
  </Attribute>

  ### data

  <Attribute id="qiskit.circuit.library.EfficientSU2.data" name="data" />

  ### entanglement

  <Attribute id="qiskit.circuit.library.EfficientSU2.entanglement" name="entanglement">
  ...
  <Attribute id="qiskit.circuit.library.EfficientSU2.entanglement_blocks" name="entanglement_blocks">
  ...
  <Attribute id="qiskit.circuit.library.EfficientSU2.extension_lib" name="extension_lib" attributeValue="= 'include &#x22;qelib1.inc&#x22;;'" />

  ### flatten

  <Attribute id="qiskit.circuit.library.EfficientSU2.flatten" name="flatten">
    Returns whether the circuit is wrapped in nested gates/instructions or flattened.
  </Attribute>

  ### global\_phase

  <Attribute id="qiskit.circuit.library.EfficientSU2.global_phase" name="global_phase">
    Return the global phase of the current circuit scope in radians.
  </Attribute>

  ### header

  <Attribute id="qiskit.circuit.library.EfficientSU2.header" name="header" attributeValue="= 'OPENQASM 2.0;'" />

  ### initial\_state

  <Attribute id="qiskit.circuit.library.EfficientSU2.initial_state" name="initial_state">
  ...
  <Attribute id="qiskit.circuit.library.EfficientSU2.insert_barriers" name="insert_barriers">
  ...
  <Attribute id="qiskit.circuit.library.EfficientSU2.instances" name="instances" attributeValue="= 167" />

  ### layout

  <Attribute id="qiskit.circuit.library.EfficientSU2.layout" name="layout">
  ...
  <Attribute id="qiskit.circuit.library.EfficientSU2.metadata" name="metadata">
  ...
  <Attribute id="qiskit.circuit.library.EfficientSU2.num_ancillas" name="num_ancillas">
    Return the number of ancilla qubits.
  </Attribute>

  ### num\_clbits

  <Attribute id="qiskit.circuit.library.EfficientSU2.num_clbits" name="num_clbits">
    Return number of classical bits.
  </Attribute>

  ### num\_layers

  <Attribute id="qiskit.circuit.library.EfficientSU2.num_layers" name="num_layers">
  ...
  <Attribute id="qiskit.circuit.library.EfficientSU2.num_parameters" name="num_parameters" />

  ### num\_parameters\_settable

  <Attribute id="qiskit.circuit.library.EfficientSU2.num_parameters_settable" name="num_parameters_settable">
  ...
  <Attribute id="qiskit.circuit.library.EfficientSU2.num_qubits" name="num_qubits">
  ...
  <Attribute id="qiskit.circuit.library.EfficientSU2.op_start_times" name="op_start_times">
  ...
  <Attribute id="qiskit.circuit.library.EfficientSU2.ordered_parameters" name="ordered_parameters">
  ...
  <Attribute id="qiskit.circuit.library.EfficientSU2.parameter_bounds" name="parameter_bounds">
  ...
  <Attribute id="qiskit.circuit.library.EfficientSU2.parameters" name="parameters" />

  ### preferred\_init\_points

  <Attribute id="qiskit.circuit.library.EfficientSU2.preferred_init_points" name="preferred_init_points">
  ...
  <Attribute id="qiskit.circuit.library.EfficientSU2.prefix" name="prefix" attributeValue="= 'circuit'" />

  ### qregs

  <Attribute id="qiskit.circuit.library.EfficientSU2.qregs" name="qregs" attributeTypeHint="list[QuantumRegister]">
    A list of the quantum registers associated with the circuit.
  </Attribute>

  ### qubits

  <Attribute id="qiskit.circuit.library.EfficientSU2.qubits" name="qubits">
    Returns a list of quantum bits in the order that the registers were added.
  </Attribute>

  ### reps

  <Attribute id="qiskit.circuit.library.EfficientSU2.reps" name="reps">
  ...
  <Attribute id="qiskit.circuit.library.EfficientSU2.rotation_blocks" name="rotation_blocks">
