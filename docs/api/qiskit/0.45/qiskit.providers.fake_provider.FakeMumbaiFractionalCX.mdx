---
title: FakeMumbaiFractionalCX (v0.45)
description: API reference for qiskit.providers.fake_provider.FakeMumbaiFractionalCX in qiskit v0.45
...
<Class id="qiskit.providers.fake_provider.FakeMumbaiFractionalCX" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/providers/fake_provider/fake_mumbai_v2.py" signature="qiskit.providers.fake_provider.FakeMumbaiFractionalCX" modifiers="class">
  ...
  **Raises**
  ...
  <Attribute id="qiskit.providers.fake_provider.FakeMumbaiFractionalCX.name">
    Name of the backend.
  </Attribute>

  ### description

  <Attribute id="qiskit.providers.fake_provider.FakeMumbaiFractionalCX.description">
    Optional human-readable description.
  </Attribute>

  ### online\_date

  <Attribute id="qiskit.providers.fake_provider.FakeMumbaiFractionalCX.online_date">
    Date that the backend came online.
  </Attribute>

  ### backend\_version

  <Attribute id="qiskit.providers.fake_provider.FakeMumbaiFractionalCX.backend_version">
  ...
  <Function id="qiskit.providers.fake_provider.FakeMumbaiFractionalCX.acquire_channel" signature="acquire_channel(qubit)">
  ...
  <Function id="qiskit.providers.fake_provider.FakeMumbaiFractionalCX.control_channel" signature="control_channel(qubits)">
  ...
  <Function id="qiskit.providers.fake_provider.FakeMumbaiFractionalCX.drive_channel" signature="drive_channel(qubit)">
  ...
  <Function id="qiskit.providers.fake_provider.FakeMumbaiFractionalCX.measure_channel" signature="measure_channel(qubit)">
  ...
  <Function id="qiskit.providers.fake_provider.FakeMumbaiFractionalCX.qubit_properties" signature="qubit_properties(qubit)">
  ...
  <Function id="qiskit.providers.fake_provider.FakeMumbaiFractionalCX.run" signature="run(run_input, **options)">
    Run on the backend.
  ...
  <Function id="qiskit.providers.fake_provider.FakeMumbaiFractionalCX.set_options" signature="set_options(**fields)">
