...
<Class id="qiskit.providers.fake_provider.FakeCasablancaV2" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/providers/fake_provider/backends/casablanca/fake_casablanca.py" signature="qiskit.providers.fake_provider.FakeCasablancaV2">
  ...
  <Attribute id="qiskit.providers.fake_provider.FakeCasablancaV2.backend_name" name="backend_name" attributeValue="= 'fake_casablanca'" />
  ...
  <Attribute id="qiskit.providers.fake_provider.FakeCasablancaV2.dirname" name="dirname" attributeValue="= '/home/runner/work/qiskit/qiskit/qiskit/providers/fake_provider/backends/casablanca'" />
  ...
  <Attribute id="qiskit.providers.fake_provider.FakeCasablancaV2.name" name="name">
    Name of the backend.
  </Attribute>

  ### description

  <Attribute id="qiskit.providers.fake_provider.FakeCasablancaV2.description" name="description">
    Optional human-readable description.
  </Attribute>

  ### online\_date

  <Attribute id="qiskit.providers.fake_provider.FakeCasablancaV2.online_date" name="online_date">
    Date that the backend came online.
  </Attribute>

  ### backend\_version

  <Attribute id="qiskit.providers.fake_provider.FakeCasablancaV2.backend_version" name="backend_version">
  ...
  <Function id="qiskit.providers.fake_provider.FakeCasablancaV2.acquire_channel" name="acquire_channel" signature="acquire_channel(qubit)">
  ...
  <Function id="qiskit.providers.fake_provider.FakeCasablancaV2.control_channel" name="control_channel" signature="control_channel(qubits)">
  ...
  <Function id="qiskit.providers.fake_provider.FakeCasablancaV2.drive_channel" name="drive_channel" signature="drive_channel(qubit)">
  ...
  <Function id="qiskit.providers.fake_provider.FakeCasablancaV2.measure_channel" name="measure_channel" signature="measure_channel(qubit)">
  ...
  <Function id="qiskit.providers.fake_provider.FakeCasablancaV2.qubit_properties" name="qubit_properties" signature="qubit_properties(qubit)">
  ...
  <Function id="qiskit.providers.fake_provider.FakeCasablancaV2.run" name="run" signature="run(run_input, **options)">
  ...
  <Function id="qiskit.providers.fake_provider.FakeCasablancaV2.set_options" name="set_options" signature="set_options(**fields)">
