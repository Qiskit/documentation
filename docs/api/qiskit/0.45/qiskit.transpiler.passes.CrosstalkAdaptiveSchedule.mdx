---
title: CrosstalkAdaptiveSchedule (v0.45)
description: API reference for qiskit.transpiler.passes.CrosstalkAdaptiveSchedule in qiskit v0.45
...
<Class id="qiskit.transpiler.passes.CrosstalkAdaptiveSchedule" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/transpiler/passes/optimization/crosstalk_adaptive_schedule.py" signature="qiskit.transpiler.passes.CrosstalkAdaptiveSchedule(*args, **kwargs)" modifiers="class">
