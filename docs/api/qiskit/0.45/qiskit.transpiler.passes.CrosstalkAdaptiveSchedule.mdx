...
<Class id="qiskit.transpiler.passes.CrosstalkAdaptiveSchedule" github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/transpiler/passes/optimization/crosstalk_adaptive_schedule.py" signature="qiskit.transpiler.passes.CrosstalkAdaptiveSchedule(*args, **kwargs)">
