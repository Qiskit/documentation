---
title: SetPhase (v0.45)
description: API reference for qiskit.pulse.instructions.SetPhase in qiskit v0.45
...
<Class id="qiskit.pulse.instructions.SetPhase" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/pulse/instructions/phase.py" signature="qiskit.pulse.instructions.SetPhase(phase, channel, name=None)" modifiers="class">
