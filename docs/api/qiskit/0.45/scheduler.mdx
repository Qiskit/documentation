---
title: scheduler (v0.45)
description: API reference for qiskit.scheduler in qiskit v0.45
...
<Class id="qiskit.scheduler.ScheduleConfig" github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/scheduler/config.py" signature="qiskit.scheduler.ScheduleConfig(inst_map, meas_map, dt)" modifiers="class">
...
<Function id="qiskit.scheduler.schedule_circuit.schedule_circuit" github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/scheduler/schedule_circuit.py" signature="qiskit.scheduler.schedule_circuit.schedule_circuit(circuit, schedule_config, method=None, backend=None)">
...
<Function id="qiskit.scheduler.methods.as_soon_as_possible" github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/scheduler/methods/basic.py" signature="qiskit.scheduler.methods.as_soon_as_possible(circuit, schedule_config, backend=None)">
...
<Function id="qiskit.scheduler.methods.as_late_as_possible" github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/scheduler/methods/basic.py" signature="qiskit.scheduler.methods.as_late_as_possible(circuit, schedule_config, backend=None)">
