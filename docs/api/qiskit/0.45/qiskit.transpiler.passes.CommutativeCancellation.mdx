...
<Class id="qiskit.transpiler.passes.CommutativeCancellation" github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/transpiler/passes/optimization/commutative_cancellation.py" signature="qiskit.transpiler.passes.CommutativeCancellation(*args, **kwargs)">
