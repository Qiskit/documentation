---
title: CommutativeCancellation (v0.45)
description: API reference for qiskit.transpiler.passes.CommutativeCancellation in qiskit v0.45
...
<Class id="qiskit.transpiler.passes.CommutativeCancellation" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/transpiler/passes/optimization/commutative_cancellation.py" signature="qiskit.transpiler.passes.CommutativeCancellation(*args, **kwargs)" modifiers="class">
