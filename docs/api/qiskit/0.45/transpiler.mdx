...
<Class id="qiskit.transpiler.TranspilerError" name="TranspilerError" github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/transpiler/exceptions.py" signature="qiskit.transpiler.TranspilerError(*message)">
...
<Class id="qiskit.transpiler.TranspilerAccessError" name="TranspilerAccessError" github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/transpiler/exceptions.py" signature="qiskit.transpiler.TranspilerAccessError(*message)">
...
<Class id="qiskit.transpiler.CouplingError" name="CouplingError" github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/transpiler/exceptions.py" signature="qiskit.transpiler.CouplingError(*msg)">
...
<Class id="qiskit.transpiler.LayoutError" name="LayoutError" github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/transpiler/exceptions.py" signature="qiskit.transpiler.LayoutError(*msg)">
