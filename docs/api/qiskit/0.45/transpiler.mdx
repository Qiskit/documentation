...
<Class id="qiskit.transpiler.TranspilerError" github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/transpiler/exceptions.py" signature="qiskit.transpiler.TranspilerError(*message)">
...
<Class id="qiskit.transpiler.TranspilerAccessError" github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/transpiler/exceptions.py" signature="qiskit.transpiler.TranspilerAccessError(*message)">
...
<Class id="qiskit.transpiler.CouplingError" github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/transpiler/exceptions.py" signature="qiskit.transpiler.CouplingError(*msg)">
...
<Class id="qiskit.transpiler.LayoutError" github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/transpiler/exceptions.py" signature="qiskit.transpiler.LayoutError(*msg)">
