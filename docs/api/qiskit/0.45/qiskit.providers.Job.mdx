...
<Class id="qiskit.providers.Job" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/providers/job.py" signature="qiskit.providers.Job">
