...
<Class id="qiskit.primitives.Sampler" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/primitives/sampler.py" signature="qiskit.primitives.Sampler(*, options=None)">
