---
title: Sampler (v0.45)
description: API reference for qiskit.primitives.Sampler in qiskit v0.45
...
<Class id="qiskit.primitives.Sampler" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/primitives/sampler.py" signature="qiskit.primitives.Sampler(*, options=None)" modifiers="class">
