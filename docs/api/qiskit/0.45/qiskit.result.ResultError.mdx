...
<Class id="qiskit.result.ResultError" github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/result/exceptions.py" signature="qiskit.result.ResultError(error)">
