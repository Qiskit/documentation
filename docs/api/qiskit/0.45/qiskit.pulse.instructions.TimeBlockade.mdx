---
title: TimeBlockade (v0.45)
description: API reference for qiskit.pulse.instructions.TimeBlockade in qiskit v0.45
...
<Class id="qiskit.pulse.instructions.TimeBlockade" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/pulse/instructions/directives.py" signature="qiskit.pulse.instructions.TimeBlockade(duration, channel, name=None)" modifiers="class">
  Bases: `Directive`
