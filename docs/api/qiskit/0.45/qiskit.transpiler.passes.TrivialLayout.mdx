...
<Class id="qiskit.transpiler.passes.TrivialLayout" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/transpiler/passes/layout/trivial_layout.py" signature="qiskit.transpiler.passes.TrivialLayout(*args, **kwargs)">
