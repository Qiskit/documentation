---
title: FakeManilaV2 (v0.45)
description: API reference for qiskit.providers.fake_provider.FakeManilaV2 in qiskit v0.45
...
<Class id="qiskit.providers.fake_provider.FakeManilaV2" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/providers/fake_provider/backends/manila/fake_manila.py" signature="qiskit.providers.fake_provider.FakeManilaV2" modifiers="class">
