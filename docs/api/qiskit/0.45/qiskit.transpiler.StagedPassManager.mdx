...
<Class id="qiskit.transpiler.StagedPassManager" github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/transpiler/passmanager.py" signature="qiskit.transpiler.StagedPassManager(stages=None, **kwargs)">
