---
title: InstructionScheduleMap (v0.45)
description: API reference for qiskit.pulse.InstructionScheduleMap in qiskit v0.45
...
<Class id="qiskit.pulse.InstructionScheduleMap" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/pulse/instruction_schedule_map.py" signature="qiskit.pulse.InstructionScheduleMap" modifiers="class">
