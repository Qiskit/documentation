...
<Class id="qiskit.pulse.InstructionScheduleMap" github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/pulse/instruction_schedule_map.py" signature="qiskit.pulse.InstructionScheduleMap">
