...
<Class id="qiskit.opflow.evolutions.EvolutionBase" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/opflow/evolutions/evolution_base.py" signature="qiskit.opflow.evolutions.EvolutionBase">
  ...
  <Function id="qiskit.opflow.evolutions.EvolutionBase.convert" name="convert" signature="abstract convert(operator)">
