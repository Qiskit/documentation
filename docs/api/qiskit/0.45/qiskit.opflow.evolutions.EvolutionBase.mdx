---
title: EvolutionBase (v0.45)
description: API reference for qiskit.opflow.evolutions.EvolutionBase in qiskit v0.45
...
<Class id="qiskit.opflow.evolutions.EvolutionBase" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/opflow/evolutions/evolution_base.py" signature="qiskit.opflow.evolutions.EvolutionBase" modifiers="class">
