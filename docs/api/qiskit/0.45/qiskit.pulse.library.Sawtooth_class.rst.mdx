...
<Function id="qiskit.pulse.library.Sawtooth" github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/pulse/library/symbolic_pulses.py" signature="qiskit.pulse.library.Sawtooth(duration, amp, phase, freq=None, angle=0.0, name=None, limit_amplitude=None)">
  A sawtooth pulse.
