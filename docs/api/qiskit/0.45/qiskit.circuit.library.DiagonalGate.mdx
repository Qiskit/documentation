---
title: DiagonalGate (v0.45)
description: API reference for qiskit.circuit.library.DiagonalGate in qiskit v0.45
...
<Class id="qiskit.circuit.library.DiagonalGate" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/circuit/library/generalized_gates/diagonal.py" signature="qiskit.circuit.library.DiagonalGate(diag)" modifiers="class">
