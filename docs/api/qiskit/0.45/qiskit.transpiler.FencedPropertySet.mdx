...
<Class id="qiskit.transpiler.FencedPropertySet" github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/transpiler/fencedobjs.py" signature="qiskit.transpiler.FencedPropertySet(property_set_instance)">
  Bases: `FencedObject`
