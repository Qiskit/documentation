---
title: MemorySlot (v0.45)
description: API reference for qiskit.pulse.channels.MemorySlot in qiskit v0.45
...
<Class id="qiskit.pulse.channels.MemorySlot" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/pulse/channels.py" signature="qiskit.pulse.channels.MemorySlot(*args, **kwargs)" modifiers="class">
