...
<Class id="qiskit.transpiler.synthesis.aqc.DefaultCNOTUnitObjective" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/transpiler/synthesis/aqc/cnot_unit_objective.py" signature="qiskit.transpiler.synthesis.aqc.DefaultCNOTUnitObjective(num_qubits, cnots)">
