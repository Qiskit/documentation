---
title: AbelianGrouper (v0.45)
description: API reference for qiskit.opflow.converters.AbelianGrouper in qiskit v0.45
...
<Class id="qiskit.opflow.converters.AbelianGrouper" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/opflow/converters/abelian_grouper.py" signature="qiskit.opflow.converters.AbelianGrouper(traverse=True)" modifiers="class">
