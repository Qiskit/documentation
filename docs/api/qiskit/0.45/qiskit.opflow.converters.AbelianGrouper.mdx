...
<Class id="qiskit.opflow.converters.AbelianGrouper" github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/opflow/converters/abelian_grouper.py" signature="qiskit.opflow.converters.AbelianGrouper(traverse=True)">
