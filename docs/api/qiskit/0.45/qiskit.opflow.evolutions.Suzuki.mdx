...
<Class id="qiskit.opflow.evolutions.Suzuki" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/opflow/evolutions/trotterizations/suzuki.py" signature="qiskit.opflow.evolutions.Suzuki(reps=1, order=2)">
  ...
  *   **order** ([*int*](https://docs.python.org/3/library/functions.html#int "(in Python v3.12)")) – The order of the expansion to perform.
  ...
  <Attribute id="qiskit.opflow.evolutions.Suzuki.order" name="order">
    returns order
  </Attribute>

  ### reps

  <Attribute id="qiskit.opflow.evolutions.Suzuki.reps" name="reps">
  ...
  <Function id="qiskit.opflow.evolutions.Suzuki.convert" name="convert" signature="convert(operator)">
