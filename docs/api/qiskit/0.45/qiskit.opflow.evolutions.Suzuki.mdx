...
<Class id="qiskit.opflow.evolutions.Suzuki" github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/opflow/evolutions/trotterizations/suzuki.py" signature="qiskit.opflow.evolutions.Suzuki(reps=1, order=2)">
