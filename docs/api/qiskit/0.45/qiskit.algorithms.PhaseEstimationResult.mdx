---
title: PhaseEstimationResult (v0.45)
description: API reference for qiskit.algorithms.PhaseEstimationResult in qiskit v0.45
...
<Class id="qiskit.algorithms.PhaseEstimationResult" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/algorithms/phase_estimators/phase_estimation_result.py" signature="qiskit.algorithms.PhaseEstimationResult(num_evaluation_qubits, circuit_result, phases)" modifiers="class">
