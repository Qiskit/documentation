...
<Class id="qiskit.quantum_info.Chi" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/quantum_info/operators/channel/chi.py" signature="qiskit.quantum_info.Chi(data, input_dims=None, output_dims=None)">
