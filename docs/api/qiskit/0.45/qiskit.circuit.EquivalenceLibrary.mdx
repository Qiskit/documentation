...
<Class id="qiskit.circuit.EquivalenceLibrary" github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/circuit/equivalence.py" signature="qiskit.circuit.EquivalenceLibrary(*, base=None)">
