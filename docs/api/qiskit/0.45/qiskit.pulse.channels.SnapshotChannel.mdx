---
title: SnapshotChannel (v0.45)
description: API reference for qiskit.pulse.channels.SnapshotChannel in qiskit v0.45
...
<Class id="qiskit.pulse.channels.SnapshotChannel" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/pulse/channels.py" signature="qiskit.pulse.channels.SnapshotChannel(*args, **kwargs)" modifiers="class">
