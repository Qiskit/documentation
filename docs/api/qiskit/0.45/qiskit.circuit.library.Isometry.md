...
<span id="qiskit.circuit.library.Isometry.base_class" />
...
<span id="qiskit.circuit.library.Isometry.condition" />

### condition

The classical condition on the instruction.

<span id="qiskit.circuit.library.Isometry.condition_bits" />

### condition\_bits

Get Clbits in condition.

<span id="qiskit.circuit.library.Isometry.decompositions" />

### decompositions

Get the decompositions of the instruction from the SessionEquivalenceLibrary.

<span id="qiskit.circuit.library.Isometry.definition" />

### definition

Return definition in terms of other basic gates.

<span id="qiskit.circuit.library.Isometry.duration" />

### duration

Get the duration.

<span id="qiskit.circuit.library.Isometry.label" />

### label

Return instruction label

<span id="qiskit.circuit.library.Isometry.mutable" />
...
<span id="qiskit.circuit.library.Isometry.name" />

### name

Return the name.

<span id="qiskit.circuit.library.Isometry.num_clbits" />

### num\_clbits

Return the number of clbits.

<span id="qiskit.circuit.library.Isometry.num_qubits" />

### num\_qubits

Return the number of qubits.

<span id="qiskit.circuit.library.Isometry.params" />

### params

return instruction params.

<span id="qiskit.circuit.library.Isometry.unit" />
...
<span id="qiskit.circuit.library.Isometry.inv_gate" />
...
<span id="qiskit.circuit.library.Isometry.validate_parameter" />
