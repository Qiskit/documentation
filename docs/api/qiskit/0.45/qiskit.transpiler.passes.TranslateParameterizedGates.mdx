...
<Class id="qiskit.transpiler.passes.TranslateParameterizedGates" github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/transpiler/passes/basis/translate_parameterized.py" signature="qiskit.transpiler.passes.TranslateParameterizedGates(*args, **kwargs)">
