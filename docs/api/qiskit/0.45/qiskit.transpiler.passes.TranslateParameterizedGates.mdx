---
title: TranslateParameterizedGates (v0.45)
description: API reference for qiskit.transpiler.passes.TranslateParameterizedGates in qiskit v0.45
...
<Class id="qiskit.transpiler.passes.TranslateParameterizedGates" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/transpiler/passes/basis/translate_parameterized.py" signature="qiskit.transpiler.passes.TranslateParameterizedGates(*args, **kwargs)" modifiers="class">
