...
description: API reference for qiskit.providers.fake_provider.FakeSantiagoV2 in qiskit v0.45
...
<Class id="qiskit.providers.fake_provider.FakeSantiagoV2" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/providers/fake_provider/backends/santiago/fake_santiago.py" signature="qiskit.providers.fake_provider.FakeSantiagoV2" modifiers="class">
  ...
  <Attribute id="qiskit.providers.fake_provider.FakeSantiagoV2.dirname" attributeValue="'/home/runner/work/qiskit/qiskit/qiskit/providers/fake_provider/backends/santiago'" />
  ...
  <Attribute id="qiskit.providers.fake_provider.FakeSantiagoV2.name">
    Name of the backend.
  </Attribute>

  ### description

  <Attribute id="qiskit.providers.fake_provider.FakeSantiagoV2.description">
    Optional human-readable description.
  </Attribute>

  ### online\_date

  <Attribute id="qiskit.providers.fake_provider.FakeSantiagoV2.online_date">
    Date that the backend came online.
  </Attribute>

  ### backend\_version

  <Attribute id="qiskit.providers.fake_provider.FakeSantiagoV2.backend_version">
  ...
  <Function id="qiskit.providers.fake_provider.FakeSantiagoV2.acquire_channel" signature="acquire_channel(qubit)">
  ...
  <Function id="qiskit.providers.fake_provider.FakeSantiagoV2.control_channel" signature="control_channel(qubits)">
  ...
  <Function id="qiskit.providers.fake_provider.FakeSantiagoV2.drive_channel" signature="drive_channel(qubit)">
  ...
  <Function id="qiskit.providers.fake_provider.FakeSantiagoV2.measure_channel" signature="measure_channel(qubit)">
  ...
  <Function id="qiskit.providers.fake_provider.FakeSantiagoV2.qubit_properties" signature="qubit_properties(qubit)">
  ...
  <Function id="qiskit.providers.fake_provider.FakeSantiagoV2.run" signature="run(run_input, **options)">
  ...
  <Function id="qiskit.providers.fake_provider.FakeSantiagoV2.set_options" signature="set_options(**fields)">
