...
<Class id="qiskit.pulse.instructions.ShiftFrequency" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/pulse/instructions/frequency.py" signature="qiskit.pulse.instructions.ShiftFrequency(frequency, channel, name=None)">
