...
<Class id="qiskit.transpiler.passes.PulseGates" github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/transpiler/passes/calibration/pulse_gate.py" signature="qiskit.transpiler.passes.PulseGates(*args, **kwargs)">
