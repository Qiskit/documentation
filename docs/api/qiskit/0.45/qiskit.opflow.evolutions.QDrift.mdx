---
title: QDrift (v0.45)
description: API reference for qiskit.opflow.evolutions.QDrift in qiskit v0.45
...
<Class id="qiskit.opflow.evolutions.QDrift" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/opflow/evolutions/trotterizations/qdrift.py" signature="qiskit.opflow.evolutions.QDrift(reps=1)" modifiers="class">
