---
title: SuperOp (v0.45)
description: API reference for qiskit.quantum_info.SuperOp in qiskit v0.45
...
<Class id="qiskit.quantum_info.SuperOp" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/quantum_info/operators/channel/superop.py" signature="qiskit.quantum_info.SuperOp(data, input_dims=None, output_dims=None)" modifiers="class">
