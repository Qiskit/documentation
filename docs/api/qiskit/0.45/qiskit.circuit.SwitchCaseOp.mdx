---
title: SwitchCaseOp (v0.45)
description: API reference for qiskit.circuit.SwitchCaseOp in qiskit v0.45
...
<Class id="qiskit.circuit.SwitchCaseOp" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/circuit/controlflow/switch_case.py" signature="qiskit.circuit.SwitchCaseOp(target, cases, *, label=None)" modifiers="class">
