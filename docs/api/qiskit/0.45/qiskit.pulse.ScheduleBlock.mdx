...
<Class id="qiskit.pulse.ScheduleBlock" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/pulse/schedule.py" signature="qiskit.pulse.ScheduleBlock(name=None, metadata=None, alignment_context=None)">
  ...
  **Raises**
  ...
  <Function id="qiskit.pulse.ScheduleBlock.append" name="append" signature="append(block, name=None, inplace=True)">
  ...
  <Function id="qiskit.pulse.ScheduleBlock.assign_parameters" name="assign_parameters" signature="assign_parameters(value_dict, inplace=True)">
  ...
  <Function id="qiskit.pulse.ScheduleBlock.assign_references" name="assign_references" signature="assign_references(subroutine_dict, inplace=True)">
  ...
  <Function id="qiskit.pulse.ScheduleBlock.ch_duration" name="ch_duration" signature="ch_duration(*channels)">
  ...
  <Function id="qiskit.pulse.ScheduleBlock.draw" name="draw" signature="draw(style=None, backend=None, time_range=None, time_unit='dt', disable_channels=None, show_snapshot=True, show_framechange=True, show_waveform_info=True, show_barrier=True, plotter='mpl2d', axis=None)">
    Plot the schedule.
  ...
  <Function id="qiskit.pulse.ScheduleBlock.exclude" name="exclude" signature="exclude(*filter_funcs, channels=None, instruction_types=None, check_subroutine=True)">
  ...
  <Function id="qiskit.pulse.ScheduleBlock.filter" name="filter" signature="filter(*filter_funcs, channels=None, instruction_types=None, check_subroutine=True)">
  ...
  <Function id="qiskit.pulse.ScheduleBlock.get_parameters" name="get_parameters" signature="get_parameters(parameter_name)">
  ...
  <Function id="qiskit.pulse.ScheduleBlock.initialize_from" name="initialize_from" signature="classmethod initialize_from(other_program, name=None)">
  ...
  <Function id="qiskit.pulse.ScheduleBlock.is_parameterized" name="is_parameterized" signature="is_parameterized()">
  ...
  <Function id="qiskit.pulse.ScheduleBlock.is_referenced" name="is_referenced" signature="is_referenced()">
  ...
  <Function id="qiskit.pulse.ScheduleBlock.is_schedulable" name="is_schedulable" signature="is_schedulable()">
  ...
  <Function id="qiskit.pulse.ScheduleBlock.replace" name="replace" signature="replace(old, new, inplace=True)">
  ...
  <Function id="qiskit.pulse.ScheduleBlock.scoped_parameters" name="scoped_parameters" signature="scoped_parameters()">
  ...
  <Function id="qiskit.pulse.ScheduleBlock.search_parameters" name="search_parameters" signature="search_parameters(parameter_regex)">
