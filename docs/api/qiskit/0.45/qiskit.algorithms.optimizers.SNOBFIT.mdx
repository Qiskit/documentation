...
<Class id="qiskit.algorithms.optimizers.SNOBFIT" github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/algorithms/optimizers/snobfit.py" signature="qiskit.algorithms.optimizers.SNOBFIT(maxiter=1000, maxfail=10, maxmp=None, verbose=False)">
