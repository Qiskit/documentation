---
title: PulseQobjExperimentConfig (v0.45)
description: API reference for qiskit.qobj.PulseQobjExperimentConfig in qiskit v0.45
...
<Class id="qiskit.qobj.PulseQobjExperimentConfig" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/qobj/pulse_qobj.py" signature="qiskit.qobj.PulseQobjExperimentConfig(qubit_lo_freq=None, meas_lo_freq=None, **kwargs)" modifiers="class">
  Bases: `QobjDictField`
