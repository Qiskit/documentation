---
title: PauliExpectation (v0.45)
description: API reference for qiskit.opflow.expectations.PauliExpectation in qiskit v0.45
...
<Class id="qiskit.opflow.expectations.PauliExpectation" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/opflow/expectations/pauli_expectation.py" signature="qiskit.opflow.expectations.PauliExpectation(group_paulis=True)" modifiers="class">
