...
<Class id="qiskit.transpiler.passes.LookaheadSwap" github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/transpiler/passes/routing/lookahead_swap.py" signature="qiskit.transpiler.passes.LookaheadSwap(*args, **kwargs)">
