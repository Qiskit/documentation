...
`qiskit.transpiler.synthesis.aqc.AQCSynthesisPlugin` [GitHub](https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/transpiler/synthesis/aqc/aqc_plugin.py "view source code")
