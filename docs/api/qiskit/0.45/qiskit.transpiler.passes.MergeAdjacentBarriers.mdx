---
title: MergeAdjacentBarriers (v0.45)
description: API reference for qiskit.transpiler.passes.MergeAdjacentBarriers in qiskit v0.45
...
<Class id="qiskit.transpiler.passes.MergeAdjacentBarriers" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/transpiler/passes/utils/merge_adjacent_barriers.py" signature="qiskit.transpiler.passes.MergeAdjacentBarriers(*args, **kwargs)" modifiers="class">
