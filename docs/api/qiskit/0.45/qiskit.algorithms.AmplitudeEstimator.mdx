---
title: AmplitudeEstimator (v0.45)
description: API reference for qiskit.algorithms.AmplitudeEstimator in qiskit v0.45
...
<Class id="qiskit.algorithms.AmplitudeEstimator" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/algorithms/amplitude_estimators/amplitude_estimator.py" signature="qiskit.algorithms.AmplitudeEstimator" modifiers="class">
