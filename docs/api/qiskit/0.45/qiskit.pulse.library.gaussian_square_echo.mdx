---
title: gaussian_square_echo (v0.45)
description: API reference for qiskit.pulse.library.gaussian_square_echo in qiskit v0.45
...
<Function id="qiskit.pulse.library.gaussian_square_echo" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/pulse/library/symbolic_pulses.py" signature="qiskit.pulse.library.gaussian_square_echo(duration, amp, sigma, width=None, angle=0.0, active_amp=0.0, active_angle=0.0, risefall_sigma_ratio=None, name=None, limit_amplitude=None)">
