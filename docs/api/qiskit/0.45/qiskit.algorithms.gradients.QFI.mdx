---
title: QFI (v0.45)
description: API reference for qiskit.algorithms.gradients.QFI in qiskit v0.45
...
<Class id="qiskit.algorithms.gradients.QFI" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/algorithms/gradients/qfi.py" signature="qiskit.algorithms.gradients.QFI(qgt, options=None)" modifiers="class">
