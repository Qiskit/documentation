...
<Class id="qiskit.transpiler.passes.Optimize1qGates" github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/transpiler/passes/optimization/optimize_1q_gates.py" signature="qiskit.transpiler.passes.Optimize1qGates(*args, **kwargs)">
