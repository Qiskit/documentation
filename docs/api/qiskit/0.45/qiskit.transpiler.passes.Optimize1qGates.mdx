...
<Class id="qiskit.transpiler.passes.Optimize1qGates" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/transpiler/passes/optimization/optimize_1q_gates.py" signature="qiskit.transpiler.passes.Optimize1qGates(*args, **kwargs)">
  ...
  *   **target** ([*Target*](qiskit.transpiler.Target "qiskit.transpiler.Target")) – The [`Target`](qiskit.transpiler.Target "qiskit.transpiler.Target") representing the target backend, if both `basis` and `target` are specified then this argument will take precedence and `basis` will be ignored.
  ...
  <Function id="qiskit.transpiler.passes.Optimize1qGates.compose_u3" name="compose_u3" signature="static compose_u3(theta1, phi1, lambda1, theta2, phi2, lambda2)">
  ...
  <Function id="qiskit.transpiler.passes.Optimize1qGates.execute" name="execute" signature="execute(passmanager_ir, state, callback=None)">
  ...
  <Function id="qiskit.transpiler.passes.Optimize1qGates.name" name="name" signature="name()">
    Name of the pass.
  ...
  <Function id="qiskit.transpiler.passes.Optimize1qGates.run" name="run" signature="run(dag)">
  ...
  <Function id="qiskit.transpiler.passes.Optimize1qGates.update_status" name="update_status" signature="update_status(state, run_state)">
  ...
  <Function id="qiskit.transpiler.passes.Optimize1qGates.yzy_to_zyz" name="yzy_to_zyz" signature="static yzy_to_zyz(xi, theta1, theta2, eps=1e-09)">
