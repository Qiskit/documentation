---
title: Optimize1qGates (v0.45)
description: API reference for qiskit.transpiler.passes.Optimize1qGates in qiskit v0.45
...
<Class id="qiskit.transpiler.passes.Optimize1qGates" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/transpiler/passes/optimization/optimize_1q_gates.py" signature="qiskit.transpiler.passes.Optimize1qGates(*args, **kwargs)" modifiers="class">
