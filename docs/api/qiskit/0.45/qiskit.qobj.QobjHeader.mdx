...
<Class id="qiskit.qobj.QobjHeader" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/qobj/common.py" signature="qiskit.qobj.QobjHeader(**kwargs)">
  Bases: `QobjDictField`
