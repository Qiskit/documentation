...
<Function id="qiskit.visualization.array_to_latex" github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/visualization/array.py" signature="qiskit.visualization.array_to_latex(array, precision=10, prefix='', source=False, max_size=8)">
