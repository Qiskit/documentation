...
<Class id="qiskit.transpiler.passes.ApplyLayout" github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/transpiler/passes/layout/apply_layout.py" signature="qiskit.transpiler.passes.ApplyLayout(*args, **kwargs)">
