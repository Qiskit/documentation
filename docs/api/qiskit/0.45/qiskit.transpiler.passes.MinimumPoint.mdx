---
title: MinimumPoint (v0.45)
description: API reference for qiskit.transpiler.passes.MinimumPoint in qiskit v0.45
...
<Class id="qiskit.transpiler.passes.MinimumPoint" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/transpiler/passes/utils/minimum_point.py" signature="qiskit.transpiler.passes.MinimumPoint(*args, **kwargs)" modifiers="class">
