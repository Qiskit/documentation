...
<Class id="qiskit.transpiler.passes.UnrollCustomDefinitions" github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/transpiler/passes/basis/unroll_custom_definitions.py" signature="qiskit.transpiler.passes.UnrollCustomDefinitions(*args, **kwargs)">
