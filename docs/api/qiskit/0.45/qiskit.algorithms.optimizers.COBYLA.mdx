---
title: COBYLA (v0.45)
description: API reference for qiskit.algorithms.optimizers.COBYLA in qiskit v0.45
...
<Class id="qiskit.algorithms.optimizers.COBYLA" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/algorithms/optimizers/cobyla.py" signature="qiskit.algorithms.optimizers.COBYLA(maxiter=1000, disp=False, rhobeg=1.0, tol=None, options=None, **kwargs)" modifiers="class">
