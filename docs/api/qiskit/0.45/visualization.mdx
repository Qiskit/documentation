...
<Class id="qiskit.visualization.VisualizationError" name="VisualizationError" github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/visualization/exceptions.py" signature="qiskit.visualization.VisualizationError(*message)">
