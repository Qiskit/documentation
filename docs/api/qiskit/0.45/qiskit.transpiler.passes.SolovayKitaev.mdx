---
title: SolovayKitaev (v0.45)
description: API reference for qiskit.transpiler.passes.SolovayKitaev in qiskit v0.45
...
<Class id="qiskit.transpiler.passes.SolovayKitaev" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/transpiler/passes/synthesis/solovay_kitaev_synthesis.py" signature="qiskit.transpiler.passes.SolovayKitaev(*args, **kwargs)" modifiers="class">
