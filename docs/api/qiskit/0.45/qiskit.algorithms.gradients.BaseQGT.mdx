---
title: BaseQGT (v0.45)
description: API reference for qiskit.algorithms.gradients.BaseQGT in qiskit v0.45
...
<Class id="qiskit.algorithms.gradients.BaseQGT" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/algorithms/gradients/base/base_qgt.py" signature="qiskit.algorithms.gradients.BaseQGT(estimator, phase_fix=True, derivative_type=DerivativeType.COMPLEX, options=None)" modifiers="class">
