---
title: IterativeAmplitudeEstimationResult (v0.45)
description: API reference for qiskit.algorithms.IterativeAmplitudeEstimationResult in qiskit v0.45
...
<Class id="qiskit.algorithms.IterativeAmplitudeEstimationResult" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/algorithms/amplitude_estimators/iae.py" signature="qiskit.algorithms.IterativeAmplitudeEstimationResult" modifiers="class">
