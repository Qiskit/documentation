...
<Class id="qiskit.transpiler.passes.Optimize1qGatesDecomposition" github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/transpiler/passes/optimization/optimize_1q_decomposition.py" signature="qiskit.transpiler.passes.Optimize1qGatesDecomposition(*args, **kwargs)">
