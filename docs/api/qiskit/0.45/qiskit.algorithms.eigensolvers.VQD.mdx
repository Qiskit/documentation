---
title: VQD (v0.45)
description: API reference for qiskit.algorithms.eigensolvers.VQD in qiskit v0.45
...
<Class id="qiskit.algorithms.eigensolvers.VQD" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/algorithms/eigensolvers/vqd.py" signature="qiskit.algorithms.eigensolvers.VQD(estimator, fidelity, ansatz, optimizer, *, k=2, betas=None, initial_point=None, callback=None)" modifiers="class">
