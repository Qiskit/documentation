...
<Class id="qiskit.providers.fake_provider.FakeVigoV2" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/providers/fake_provider/backends/vigo/fake_vigo.py" signature="qiskit.providers.fake_provider.FakeVigoV2">
