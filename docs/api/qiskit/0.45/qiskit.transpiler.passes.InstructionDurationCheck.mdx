---
title: InstructionDurationCheck (v0.45)
description: API reference for qiskit.transpiler.passes.InstructionDurationCheck in qiskit v0.45
...
<Class id="qiskit.transpiler.passes.InstructionDurationCheck" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/transpiler/passes/scheduling/alignments/check_durations.py" signature="qiskit.transpiler.passes.InstructionDurationCheck(*args, **kwargs)" modifiers="class">
