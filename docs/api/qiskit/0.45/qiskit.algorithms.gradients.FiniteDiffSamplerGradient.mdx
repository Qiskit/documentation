...
<Class id="qiskit.algorithms.gradients.FiniteDiffSamplerGradient" github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/algorithms/gradients/finite_diff/finite_diff_sampler_gradient.py" signature="qiskit.algorithms.gradients.FiniteDiffSamplerGradient(sampler, epsilon, options=None, *, method='central')">
