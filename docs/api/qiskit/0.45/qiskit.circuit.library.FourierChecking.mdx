...
<Class id="qiskit.circuit.library.FourierChecking" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/circuit/library/fourier_checking.py" signature="qiskit.circuit.library.FourierChecking(f, g)">
  ...
  **Reference Circuit:**
  ...
  <Attribute id="qiskit.circuit.library.FourierChecking.instances" name="instances" attributeValue="175" />
