---
title: plot_state_hinton (v0.45)
description: API reference for qiskit.visualization.plot_state_hinton in qiskit v0.45
...
<Function id="qiskit.visualization.plot_state_hinton" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/visualization/state_visualization.py" signature="qiskit.visualization.plot_state_hinton(state, title='', figsize=None, ax_real=None, ax_imag=None, *, filename=None)">
  ...
  **Examples**
  ...
  ![../\_images/qiskit-visualization-plot\_state\_hinton-1.png](/docs/images/api/qiskit/0.45/qiskit-visualization-plot_state_hinton-1.avif)
</Function>
