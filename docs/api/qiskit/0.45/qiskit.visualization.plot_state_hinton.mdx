...
<Function id="qiskit.visualization.plot_state_hinton" github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/visualization/state_visualization.py" signature="qiskit.visualization.plot_state_hinton(state, title='', figsize=None, ax_real=None, ax_imag=None, *, filename=None)">
