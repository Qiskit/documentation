---
title: Reset (v0.45)
description: API reference for qiskit.circuit.library.Reset in qiskit v0.45
...
<Class id="qiskit.circuit.library.Reset" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/circuit/reset.py" signature="qiskit.circuit.library.Reset(label=None, *, duration=None, unit='dt')" modifiers="class">
