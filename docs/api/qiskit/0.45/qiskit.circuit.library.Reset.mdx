...
<Class id="qiskit.circuit.library.Reset" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/circuit/reset.py" signature="qiskit.circuit.library.Reset(label=None, *, duration=None, unit='dt')">
