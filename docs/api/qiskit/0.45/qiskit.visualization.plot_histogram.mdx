...
<Function id="qiskit.visualization.plot_histogram" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/visualization/counts_visualization.py" signature="qiskit.visualization.plot_histogram(data, figsize=(7, 5), color=None, number_to_keep=None, sort='asc', target_string=None, legend=None, bar_labels=True, title=None, ax=None, filename=None)">
  ...
  **Examples**
  ...
  ![../\_images/qiskit-visualization-plot\_histogram-1\_00.png](/images/api/qiskit/0.45/qiskit-visualization-plot_histogram-1_00.avif)

  ![../\_images/qiskit-visualization-plot\_histogram-1\_01.png](/images/api/qiskit/0.45/qiskit-visualization-plot_histogram-1_01.avif)

  ![../\_images/qiskit-visualization-plot\_histogram-1\_02.png](/images/api/qiskit/0.45/qiskit-visualization-plot_histogram-1_02.avif)
</Function>
