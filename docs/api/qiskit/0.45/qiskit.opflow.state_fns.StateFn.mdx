...
<Class id="qiskit.opflow.state_fns.StateFn" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/opflow/state_fns/state_fn.py" signature="qiskit.opflow.state_fns.StateFn(primitive=None, coeff=1.0, is_measurement=False)">
