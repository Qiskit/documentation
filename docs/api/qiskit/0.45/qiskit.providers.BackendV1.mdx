...
<Class id="qiskit.providers.BackendV1" github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/providers/backend.py" signature="qiskit.providers.BackendV1(configuration, provider=None, **fields)">
