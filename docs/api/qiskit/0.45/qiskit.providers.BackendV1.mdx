---
title: BackendV1 (v0.45)
description: API reference for qiskit.providers.BackendV1 in qiskit v0.45
...
<Class id="qiskit.providers.BackendV1" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/providers/backend.py" signature="qiskit.providers.BackendV1(configuration, provider=None, **fields)" modifiers="class">
