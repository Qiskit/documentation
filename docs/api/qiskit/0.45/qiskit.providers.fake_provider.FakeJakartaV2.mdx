...
<Class id="qiskit.providers.fake_provider.FakeJakartaV2" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/providers/fake_provider/backends/jakarta/fake_jakarta.py" signature="qiskit.providers.fake_provider.FakeJakartaV2">
