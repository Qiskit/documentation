...
<Class id="qiskit.pulse.instructions.ShiftPhase" github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/pulse/instructions/phase.py" signature="qiskit.pulse.instructions.ShiftPhase(phase, channel, name=None)">
