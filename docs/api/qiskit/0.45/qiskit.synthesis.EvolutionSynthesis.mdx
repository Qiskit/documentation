...
<Class id="qiskit.synthesis.EvolutionSynthesis" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/synthesis/evolution/evolution_synthesis.py" signature="qiskit.synthesis.EvolutionSynthesis">
  ...
  <Function id="qiskit.synthesis.EvolutionSynthesis.synthesize" name="synthesize" signature="abstract synthesize(evolution)">
