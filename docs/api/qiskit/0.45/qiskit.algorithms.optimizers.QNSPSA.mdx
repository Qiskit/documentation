...
<Class id="qiskit.algorithms.optimizers.QNSPSA" github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/algorithms/optimizers/qnspsa.py" signature="qiskit.algorithms.optimizers.QNSPSA(fidelity, maxiter=100, blocking=True, allowed_increase=None, learning_rate=None, perturbation=None, resamplings=1, perturbation_dims=None, regularization=None, hessian_delay=0, lse_solver=None, initial_hessian=None, callback=None, termination_checker=None)">
  ...
  *   **termination\_checker** (*TERMINATIONCHECKER | None*) – A callback function executed at the end of each iteration step. The arguments are, in this order: the parameters, the function value, the number of function evaluations, the stepsize, whether the step was accepted. If the callback returns True, the optimization is terminated. To prevent additional evaluations of the objective method, if the objective has not yet been evaluated, the objective is estimated by taking the mean of the objective evaluations used in the estimate of the gradient.
  ...
  <Function id="qiskit.algorithms.optimizers.QNSPSA.calibrate" name="calibrate" signature="static calibrate(loss, initial_point, c=0.2, stability_constant=0, target_magnitude=None, alpha=0.602, gamma=0.101, modelspace=False, max_evals_grouped=1)">
...
$$
  ...
  <Function id="qiskit.algorithms.optimizers.QNSPSA.estimate_stddev" name="estimate_stddev" signature="static estimate_stddev(loss, initial_point, avg=25, max_evals_grouped=1)">
  ...
  <Function id="qiskit.algorithms.optimizers.QNSPSA.get_fidelity" name="get_fidelity" signature="static get_fidelity(circuit, backend=None, expectation=None, *, sampler=None)">
...
$$
  ...
  <Function id="qiskit.algorithms.optimizers.QNSPSA.gradient_num_diff" name="gradient_num_diff" signature="static gradient_num_diff(x_center, f, epsilon, max_evals_grouped=None)">
  ...
  <Function id="qiskit.algorithms.optimizers.QNSPSA.minimize" name="minimize" signature="minimize(fun, x0, jac=None, bounds=None)">
