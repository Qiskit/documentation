---
title: QFIBase (v0.45)
description: API reference for qiskit.opflow.gradients.QFIBase in qiskit v0.45
...
<Class id="qiskit.opflow.gradients.QFIBase" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/opflow/gradients/qfi_base.py" signature="qiskit.opflow.gradients.QFIBase(qfi_method='lin_comb_full')" modifiers="class">
