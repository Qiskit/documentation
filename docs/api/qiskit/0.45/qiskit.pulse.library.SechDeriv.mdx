---
title: SechDeriv (v0.45)
description: API reference for qiskit.pulse.library.SechDeriv in qiskit v0.45
...
<Function id="qiskit.pulse.library.SechDeriv" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/pulse/library/symbolic_pulses.py" signature="qiskit.pulse.library.SechDeriv(duration, amp, sigma, angle=0.0, name=None, limit_amplitude=None)">
