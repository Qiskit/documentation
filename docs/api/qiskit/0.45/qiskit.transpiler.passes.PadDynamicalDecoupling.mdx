---
title: PadDynamicalDecoupling (v0.45)
description: API reference for qiskit.transpiler.passes.PadDynamicalDecoupling in qiskit v0.45
...
<Class id="qiskit.transpiler.passes.PadDynamicalDecoupling" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/transpiler/passes/scheduling/padding/dynamical_decoupling.py" signature="qiskit.transpiler.passes.PadDynamicalDecoupling(*args, **kwargs)" modifiers="class">
  Bases: `BasePadding`
  ...
  ![../\_images/qiskit-transpiler-passes-PadDynamicalDecoupling-1\_00.png](/docs/images/api/qiskit/0.45/qiskit-transpiler-passes-PadDynamicalDecoupling-1_00.avif)

  ![../\_images/qiskit-transpiler-passes-PadDynamicalDecoupling-1\_01.png](/docs/images/api/qiskit/0.45/qiskit-transpiler-passes-PadDynamicalDecoupling-1_01.avif)
  ...
  *   [**TypeError**](https://docs.python.org/3/library/exceptions.html#TypeError "(in Python v3.12)") – If `dd_sequence` is not specified
  ...
  <Function id="qiskit.transpiler.passes.PadDynamicalDecoupling.execute" signature="execute(passmanager_ir, state, callback=None)">
  ...
  <Function id="qiskit.transpiler.passes.PadDynamicalDecoupling.name" signature="name()">
    Name of the pass.
  ...
  <Function id="qiskit.transpiler.passes.PadDynamicalDecoupling.run" signature="run(dag)">
  ...
  <Function id="qiskit.transpiler.passes.PadDynamicalDecoupling.update_status" signature="update_status(state, run_state)">
