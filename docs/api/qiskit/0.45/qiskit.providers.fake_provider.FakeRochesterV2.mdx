...
<Class id="qiskit.providers.fake_provider.FakeRochesterV2" github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/providers/fake_provider/backends/rochester/fake_rochester.py" signature="qiskit.providers.fake_provider.FakeRochesterV2">
