...
<Class id="qiskit.transpiler.passes.HoareOptimizer" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/transpiler/passes/optimization/hoare_opt.py" signature="qiskit.transpiler.passes.HoareOptimizer(*args, **kwargs)">
