...
<Class id="qiskit.passmanager.PassManagerState" github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/passmanager/compilation_status.py" signature="qiskit.passmanager.PassManagerState(workflow_status, property_set)">
