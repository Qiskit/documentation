...
<Class id="qiskit.circuit.Qubit" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/circuit/quantumregister.py" signature="qiskit.circuit.Qubit(register=None, index=None)">
  ...
  **Raises**
  ...
  <Attribute id="qiskit.circuit.Qubit.index" name="index">
  ...
  <Attribute id="qiskit.circuit.Qubit.register" name="register">
