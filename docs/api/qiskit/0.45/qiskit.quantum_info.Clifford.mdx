...
<Class id="qiskit.quantum_info.Clifford" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/quantum_info/operators/symplectic/clifford.py" signature="qiskit.quantum_info.Clifford(data, validate=True, copy=True)">
  ...
  **References**
  ...
  <Function id="qiskit.quantum_info.Clifford.from_dict" signature="classmethod from_dict(obj)">
  ...
  <Function id="qiskit.quantum_info.Clifford.from_linear_function" signature="classmethod from_linear_function(linear_function)">
  ...
  <Function id="qiskit.quantum_info.Clifford.from_matrix" signature="classmethod from_matrix(matrix)">
  ...
  <Function id="qiskit.quantum_info.Clifford.from_operator" signature="classmethod from_operator(operator)">
  ...
  <Function id="qiskit.quantum_info.Clifford.from_permutation" signature="classmethod from_permutation(permutation_gate)">
