...
<Class id="qiskit.transpiler.passes.Unroller" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/transpiler/passes/basis/unroller.py" signature="qiskit.transpiler.passes.Unroller(*args, **kwargs)">
