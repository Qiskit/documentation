---
title: SabrePreLayout (v0.45)
description: API reference for qiskit.transpiler.passes.SabrePreLayout in qiskit v0.45
...
<Class id="qiskit.transpiler.passes.SabrePreLayout" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/transpiler/passes/layout/sabre_pre_layout.py" signature="qiskit.transpiler.passes.SabrePreLayout(*args, **kwargs)" modifiers="class">
