---
title: IterativePhaseEstimation (v0.45)
description: API reference for qiskit.algorithms.IterativePhaseEstimation in qiskit v0.45
...
<Class id="qiskit.algorithms.IterativePhaseEstimation" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/algorithms/phase_estimators/ipe.py" signature="qiskit.algorithms.IterativePhaseEstimation(num_iterations, quantum_instance=None, sampler=None)" modifiers="class">
