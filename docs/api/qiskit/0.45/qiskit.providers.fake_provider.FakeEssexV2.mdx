...
<Class id="qiskit.providers.fake_provider.FakeEssexV2" github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/providers/fake_provider/backends/essex/fake_essex.py" signature="qiskit.providers.fake_provider.FakeEssexV2">
