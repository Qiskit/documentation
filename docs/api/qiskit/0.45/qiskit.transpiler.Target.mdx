...
<Class id="qiskit.transpiler.Target" github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/transpiler/target.py" signature="qiskit.transpiler.Target(description=None, num_qubits=0, dt=None, granularity=1, min_length=1, pulse_alignment=1, acquire_alignment=1, qubit_properties=None, concurrent_measurements=None)">
  ...
  **Raises**
  ...
  <Attribute id="qiskit.transpiler.Target.aquire_alignment" name="aquire_alignment">
  ...
  <Function id="qiskit.transpiler.Target.add_instruction" name="add_instruction" signature="add_instruction(instruction, properties=None, name=None)">
  ...
  <Function id="qiskit.transpiler.Target.build_coupling_map" name="build_coupling_map" signature="build_coupling_map(two_q_gate=None, filter_idle_qubits=False)">
  ...
  <Function id="qiskit.transpiler.Target.durations" name="durations" signature="durations()">
  ...
  <Function id="qiskit.transpiler.Target.from_configuration" name="from_configuration" signature="classmethod from_configuration(basis_gates, num_qubits=None, coupling_map=None, inst_map=None, backend_properties=None, instruction_durations=None, concurrent_measurements=None, dt=None, timing_constraints=None, custom_name_mapping=None)">
  ...
  <Function id="qiskit.transpiler.Target.get_calibration" name="get_calibration" signature="get_calibration(operation_name, qargs, *args, **kwargs)">
  ...
  <Function id="qiskit.transpiler.Target.get_non_global_operation_names" name="get_non_global_operation_names" signature="get_non_global_operation_names(strict_direction=False)">
  ...
  <Function id="qiskit.transpiler.Target.has_calibration" name="has_calibration" signature="has_calibration(operation_name, qargs)">
  ...
  <Function id="qiskit.transpiler.Target.instruction_properties" name="instruction_properties" signature="instruction_properties(index)">
  ...
  <Function id="qiskit.transpiler.Target.instruction_schedule_map" name="instruction_schedule_map" signature="instruction_schedule_map()">
  ...
  <Function id="qiskit.transpiler.Target.instruction_supported" name="instruction_supported" signature="instruction_supported(operation_name=None, qargs=None, operation_class=None, parameters=None)">
  ...
  <Function id="qiskit.transpiler.Target.items" name="items" signature="items() → a set-like object providing a view on D's items" />

  ### keys

  <Function id="qiskit.transpiler.Target.keys" name="keys" signature="keys() → a set-like object providing a view on D's keys" />

  ### operation\_from\_name

  <Function id="qiskit.transpiler.Target.operation_from_name" name="operation_from_name" signature="operation_from_name(instruction)">
  ...
  <Function id="qiskit.transpiler.Target.operation_names_for_qargs" name="operation_names_for_qargs" signature="operation_names_for_qargs(qargs)">
  ...
  <Function id="qiskit.transpiler.Target.operations_for_qargs" name="operations_for_qargs" signature="operations_for_qargs(qargs)">
  ...
  <Function id="qiskit.transpiler.Target.qargs_for_operation_name" name="qargs_for_operation_name" signature="qargs_for_operation_name(operation)">
  ...
  <Function id="qiskit.transpiler.Target.timing_constraints" name="timing_constraints" signature="timing_constraints()">
  ...
  <Function id="qiskit.transpiler.Target.update_from_instruction_schedule_map" name="update_from_instruction_schedule_map" signature="update_from_instruction_schedule_map(inst_map, inst_name_map=None, error_dict=None)">
  ...
  <Function id="qiskit.transpiler.Target.update_instruction_properties" name="update_instruction_properties" signature="update_instruction_properties(instruction, qargs, properties)">
  ...
  <Function id="qiskit.transpiler.Target.values" name="values" signature="values() → an object providing a view on D's values" />
</Class>
