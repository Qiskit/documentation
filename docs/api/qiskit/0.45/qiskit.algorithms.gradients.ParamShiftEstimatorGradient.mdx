...
<Class id="qiskit.algorithms.gradients.ParamShiftEstimatorGradient" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/algorithms/gradients/param_shift/param_shift_estimator_gradient.py" signature="qiskit.algorithms.gradients.ParamShiftEstimatorGradient(estimator, options=None, derivative_type=DerivativeType.REAL)">
  ...
  *   **derivative\_type** (*DerivativeType*) –
  ...
  <Function id="qiskit.algorithms.gradients.ParamShiftEstimatorGradient.run" name="run" signature="run(circuits, observables, parameter_values, parameters=None, **options)">
  ...
  <Function id="qiskit.algorithms.gradients.ParamShiftEstimatorGradient.update_default_options" name="update_default_options" signature="update_default_options(**options)">
