---
title: CheckMap (v0.45)
description: API reference for qiskit.transpiler.passes.CheckMap in qiskit v0.45
...
<Class id="qiskit.transpiler.passes.CheckMap" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/transpiler/passes/utils/check_map.py" signature="qiskit.transpiler.passes.CheckMap(*args, **kwargs)" modifiers="class">
