...
<Class id="qiskit.transpiler.passes.SabreSwap" github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/transpiler/passes/routing/sabre_swap.py" signature="qiskit.transpiler.passes.SabreSwap(*args, **kwargs)">
