...
<Class id="qiskit.opflow.OperatorBase" github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/opflow/operator_base.py" signature="qiskit.opflow.OperatorBase">
