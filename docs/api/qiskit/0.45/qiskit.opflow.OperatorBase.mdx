...
<Class id="qiskit.opflow.OperatorBase" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/opflow/operator_base.py" signature="qiskit.opflow.OperatorBase">
  ...
  <Function id="qiskit.opflow.OperatorBase.is_hermitian" name="is_hermitian" signature="is_hermitian()">
