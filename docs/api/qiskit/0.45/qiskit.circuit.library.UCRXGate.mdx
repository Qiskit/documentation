---
title: UCRXGate (v0.45)
description: API reference for qiskit.circuit.library.UCRXGate in qiskit v0.45
...
<Class id="qiskit.circuit.library.UCRXGate" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/circuit/library/generalized_gates/ucrx.py" signature="qiskit.circuit.library.UCRXGate(angle_list)" modifiers="class">
