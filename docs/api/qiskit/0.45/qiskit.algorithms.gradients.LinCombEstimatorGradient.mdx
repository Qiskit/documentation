---
title: LinCombEstimatorGradient (v0.45)
description: API reference for qiskit.algorithms.gradients.LinCombEstimatorGradient in qiskit v0.45
...
<Class id="qiskit.algorithms.gradients.LinCombEstimatorGradient" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/algorithms/gradients/lin_comb/lin_comb_estimator_gradient.py" signature="qiskit.algorithms.gradients.LinCombEstimatorGradient(estimator, derivative_type=DerivativeType.REAL, options=None)" modifiers="class">
