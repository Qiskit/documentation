---
title: DIRECT_L (v0.45)
description: API reference for qiskit.algorithms.optimizers.DIRECT_L in qiskit v0.45
...
<Class id="qiskit.algorithms.optimizers.DIRECT_L" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/algorithms/optimizers/nlopts/direct_l.py" signature="qiskit.algorithms.optimizers.DIRECT_L(max_evals=1000)" modifiers="class">
