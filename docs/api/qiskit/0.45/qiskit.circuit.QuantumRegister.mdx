---
title: QuantumRegister (v0.45)
description: API reference for qiskit.circuit.QuantumRegister in qiskit v0.45
...
<Class id="qiskit.circuit.QuantumRegister" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/circuit/quantumregister.py" signature="qiskit.circuit.QuantumRegister(size=None, name=None, bits=None)" modifiers="class">
