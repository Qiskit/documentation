---
title: FakeOslo (v0.45)
description: API reference for qiskit.providers.fake_provider.FakeOslo in qiskit v0.45
...
<Class id="qiskit.providers.fake_provider.FakeOslo" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/providers/fake_provider/backends/oslo/fake_oslo.py" signature="qiskit.providers.fake_provider.FakeOslo" modifiers="class">
