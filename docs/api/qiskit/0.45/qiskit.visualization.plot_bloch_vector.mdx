...
<Function id="qiskit.visualization.plot_bloch_vector" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/visualization/state_visualization.py" signature="qiskit.visualization.plot_bloch_vector(bloch, title='', ax=None, figsize=None, coord_type='cartesian', font_size=None)">
  ...
  **Examples**
  ...
  ![../\_images/qiskit-visualization-plot\_bloch\_vector-1.png](/images/api/qiskit/0.45/qiskit-visualization-plot_bloch_vector-1.avif)
  ...
  ![../\_images/qiskit-visualization-plot\_bloch\_vector-2.png](/images/api/qiskit/0.45/qiskit-visualization-plot_bloch_vector-2.avif)
</Function>
