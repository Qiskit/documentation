---
title: SingleQubitUnitary (v0.45)
description: API reference for qiskit.extensions.SingleQubitUnitary in qiskit v0.45
...
<Class id="qiskit.extensions.SingleQubitUnitary" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/extensions/quantum_initializer/squ.py" signature="qiskit.extensions.SingleQubitUnitary(unitary_matrix, mode='ZYZ', up_to_diagonal=False)" modifiers="class">
