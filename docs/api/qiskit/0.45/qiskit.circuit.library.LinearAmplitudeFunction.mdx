---
title: LinearAmplitudeFunction (v0.45)
description: API reference for qiskit.circuit.library.LinearAmplitudeFunction in qiskit v0.45
...
$$
  ...
  *   **name** ([*str*](https://docs.python.org/3/library/stdtypes.html#str "(in Python v3.12)")) – Name of the circuit.
  ...
  <Attribute id="qiskit.circuit.library.LinearAmplitudeFunction.instances" attributeValue="181" />
