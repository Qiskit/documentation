...
<Class id="qiskit.passmanager.FlowControllerLinear" github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/passmanager/flow_controllers.py" signature="qiskit.passmanager.FlowControllerLinear(tasks=(), *, options=None)">
