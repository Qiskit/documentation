---
title: NumPyEigensolver (v0.45)
description: API reference for qiskit.algorithms.NumPyEigensolver in qiskit v0.45
...
<Class id="qiskit.algorithms.NumPyEigensolver" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/algorithms/eigen_solvers/numpy_eigen_solver.py" signature="qiskit.algorithms.NumPyEigensolver(k=1, filter_criterion=None)" modifiers="class">
