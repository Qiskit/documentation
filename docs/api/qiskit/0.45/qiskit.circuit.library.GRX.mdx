---
title: GRX (v0.45)
description: API reference for qiskit.circuit.library.GRX in qiskit v0.45
...
$$
  ...
  **Expanded Circuit:**
  ...
  ![../\_images/qiskit-circuit-library-GRX-1.png](/docs/images/api/qiskit/0.45/qiskit-circuit-library-GRX-1.avif)
