...
<Class id="qiskit.qasm2.QASM2Error" github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/qasm2/exceptions.py" signature="qiskit.qasm2.QASM2Error(*message)">
...
<Class id="qiskit.qasm2.QASM2ParseError" github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/qasm2/exceptions.py" signature="qiskit.qasm2.QASM2ParseError(*message)">
...
<Class id="qiskit.qasm2.QASM2ExportError" github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/qasm2/exceptions.py" signature="qiskit.qasm2.QASM2ExportError(*message)">
