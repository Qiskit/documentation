...
<Class id="qiskit.transpiler.passes.ContainsInstruction" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/transpiler/passes/utils/contains_instruction.py" signature="qiskit.transpiler.passes.ContainsInstruction(*args, **kwargs)">
  ...
  *   **recurse** ([*bool*](https://docs.python.org/3/library/functions.html#bool "(in Python v3.12)")) – if `True` (default), then recurse into control-flow operations.
  ...
  <Function id="qiskit.transpiler.passes.ContainsInstruction.execute" name="execute" signature="execute(passmanager_ir, state, callback=None)">
  ...
  <Function id="qiskit.transpiler.passes.ContainsInstruction.update_status" name="update_status" signature="update_status(state, run_state)">
