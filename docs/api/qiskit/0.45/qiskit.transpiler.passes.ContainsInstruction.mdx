...
<Class id="qiskit.transpiler.passes.ContainsInstruction" github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/transpiler/passes/utils/contains_instruction.py" signature="qiskit.transpiler.passes.ContainsInstruction(*args, **kwargs)">
