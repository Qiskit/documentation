---
title: ContainsInstruction (v0.45)
description: API reference for qiskit.transpiler.passes.ContainsInstruction in qiskit v0.45
...
<Class id="qiskit.transpiler.passes.ContainsInstruction" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/transpiler/passes/utils/contains_instruction.py" signature="qiskit.transpiler.passes.ContainsInstruction(*args, **kwargs)" modifiers="class">
