---
title: qpy (v0.45)
description: API reference for qiskit.qpy in qiskit v0.45
...
<Function id="qiskit.qpy.load" github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/qpy/interface.py" signature="qiskit.qpy.load(file_obj, metadata_deserializer=None)">
...
<Function id="qiskit.qpy.dump" github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/qpy/interface.py" signature="qiskit.qpy.dump(programs, file_obj, metadata_serializer=None, use_symengine=False)">
...
<Class id="qiskit.qpy.QpyError" github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/qpy/exceptions.py" signature="qiskit.qpy.QpyError(*message)" modifiers="exception">
