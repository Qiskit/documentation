...
<Class id="qiskit.opflow.state_fns.CircuitStateFn" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/opflow/state_fns/circuit_state_fn.py" signature="qiskit.opflow.state_fns.CircuitStateFn(*args, **kwargs)">
