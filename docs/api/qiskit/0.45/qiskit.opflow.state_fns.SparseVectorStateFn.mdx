---
title: SparseVectorStateFn (v0.45)
description: API reference for qiskit.opflow.state_fns.SparseVectorStateFn in qiskit v0.45
...
<Class id="qiskit.opflow.state_fns.SparseVectorStateFn" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/opflow/state_fns/sparse_vector_state_fn.py" signature="qiskit.opflow.state_fns.SparseVectorStateFn(*args, **kwargs)" modifiers="class">
