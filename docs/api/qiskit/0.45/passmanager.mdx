---
title: passmanager (v0.45)
description: API reference for qiskit.passmanager in qiskit v0.45
...
<Class id="qiskit.passmanager.PassManagerError" github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/passmanager/exceptions.py" signature="qiskit.passmanager.PassManagerError(*message)" modifiers="exception">
  Pass manager error.
