...
<Class id="qiskit.passmanager.PassManagerError" github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/passmanager/exceptions.py" signature="qiskit.passmanager.PassManagerError(*message)">
  Pass manager error.
