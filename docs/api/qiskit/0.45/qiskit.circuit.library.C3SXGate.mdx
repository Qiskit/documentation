...
<Class id="qiskit.circuit.library.C3SXGate" github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/circuit/library/standard_gates/x.py" signature="qiskit.circuit.library.C3SXGate(*args, _force_mutable=False, **kwargs)">
