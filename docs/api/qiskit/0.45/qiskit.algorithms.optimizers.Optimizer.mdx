---
title: Optimizer (v0.45)
description: API reference for qiskit.algorithms.optimizers.Optimizer in qiskit v0.45
...
<Class id="qiskit.algorithms.optimizers.Optimizer" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/algorithms/optimizers/optimizer.py" signature="qiskit.algorithms.optimizers.Optimizer" modifiers="class">
