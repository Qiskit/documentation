---
title: Gaussian (v0.45)
description: API reference for qiskit.pulse.library.Gaussian in qiskit v0.45
...
<Class id="qiskit.pulse.library.Gaussian" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/pulse/library/symbolic_pulses.py" signature="qiskit.pulse.library.Gaussian(duration, amp, sigma, angle=None, name=None, limit_amplitude=None)" modifiers="class">
