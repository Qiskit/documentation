...
<span id="qiskit.providers.fake_provider.FakeCairoV2.name" />

### name

Name of the backend.

<span id="qiskit.providers.fake_provider.FakeCairoV2.description" />

### description

Optional human-readable description.

<span id="qiskit.providers.fake_provider.FakeCairoV2.online_date" />

### online\_date

Date that the backend came online.

<span id="qiskit.providers.fake_provider.FakeCairoV2.backend_version" />
