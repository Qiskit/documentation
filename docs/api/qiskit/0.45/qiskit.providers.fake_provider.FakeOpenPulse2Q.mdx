...
<Class id="qiskit.providers.fake_provider.FakeOpenPulse2Q" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/providers/fake_provider/fake_openpulse_2q.py" signature="qiskit.providers.fake_provider.FakeOpenPulse2Q">
