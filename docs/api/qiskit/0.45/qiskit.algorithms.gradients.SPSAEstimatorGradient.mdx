---
title: SPSAEstimatorGradient (v0.45)
description: API reference for qiskit.algorithms.gradients.SPSAEstimatorGradient in qiskit v0.45
...
<Class id="qiskit.algorithms.gradients.SPSAEstimatorGradient" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/algorithms/gradients/spsa/spsa_estimator_gradient.py" signature="qiskit.algorithms.gradients.SPSAEstimatorGradient(estimator, epsilon, batch_size=1, seed=None, options=None)" modifiers="class">
