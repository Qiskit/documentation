---
title: ExpectationBase (v0.45)
description: API reference for qiskit.opflow.expectations.ExpectationBase in qiskit v0.45
...
<Class id="qiskit.opflow.expectations.ExpectationBase" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/opflow/expectations/expectation_base.py" signature="qiskit.opflow.expectations.ExpectationBase" modifiers="class">
