...
<Class id="qiskit.opflow.expectations.ExpectationBase" github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/opflow/expectations/expectation_base.py" signature="qiskit.opflow.expectations.ExpectationBase">
