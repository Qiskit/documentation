...
<Class id="qiskit.transpiler.passes.RemoveFinalMeasurements" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/transpiler/passes/utils/remove_final_measurements.py" signature="qiskit.transpiler.passes.RemoveFinalMeasurements(*args, **kwargs)">
  ...
  <Function id="qiskit.transpiler.passes.RemoveFinalMeasurements.execute" name="execute" signature="execute(passmanager_ir, state, callback=None)">
  ...
  <Function id="qiskit.transpiler.passes.RemoveFinalMeasurements.update_status" name="update_status" signature="update_status(state, run_state)">
