---
title: MatrixExponential (v0.45)
description: API reference for qiskit.synthesis.MatrixExponential in qiskit v0.45
...
<Class id="qiskit.synthesis.MatrixExponential" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/synthesis/evolution/matrix_synthesis.py" signature="qiskit.synthesis.MatrixExponential" modifiers="class">
