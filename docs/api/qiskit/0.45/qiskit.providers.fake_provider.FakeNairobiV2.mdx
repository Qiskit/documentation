...
<Class id="qiskit.providers.fake_provider.FakeNairobiV2" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/providers/fake_provider/backends/nairobi/fake_nairobi.py" signature="qiskit.providers.fake_provider.FakeNairobiV2">
