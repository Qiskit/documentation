...
<Class id="qiskit.transpiler.passes.TemplateOptimization" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/transpiler/passes/optimization/template_optimization.py" signature="qiskit.transpiler.passes.TemplateOptimization(*args, **kwargs)">
