...
<Class id="qiskit.opflow.primitive_ops.PrimitiveOp" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/opflow/primitive_ops/primitive_op.py" signature="qiskit.opflow.primitive_ops.PrimitiveOp(primitive, coeff=1.0)">
  ...
  **Return type**
  ...
  <Function id="qiskit.opflow.primitive_ops.PrimitiveOp.add" name="add" signature="add(other)">
  ...
  <Function id="qiskit.opflow.primitive_ops.PrimitiveOp.adjoint" name="adjoint" signature="adjoint()">
  ...
  <Function id="qiskit.opflow.primitive_ops.PrimitiveOp.assign_parameters" name="assign_parameters" signature="assign_parameters(param_dict)">
  ...
  <Function id="qiskit.opflow.primitive_ops.PrimitiveOp.compose" name="compose" signature="compose(other, permutation=None, front=False)">
  ...
  <Function id="qiskit.opflow.primitive_ops.PrimitiveOp.equals" name="equals" signature="equals(other)">
  ...
  <Function id="qiskit.opflow.primitive_ops.PrimitiveOp.eval" name="eval" signature="eval(front=None)">
  ...
  <Function id="qiskit.opflow.primitive_ops.PrimitiveOp.exp_i" name="exp_i" signature="exp_i()">
  ...
  <Function id="qiskit.opflow.primitive_ops.PrimitiveOp.log_i" name="log_i" signature="log_i(massive=False)">
  ...
  <Function id="qiskit.opflow.primitive_ops.PrimitiveOp.mul" name="mul" signature="mul(scalar)">
  ...
  <Function id="qiskit.opflow.primitive_ops.PrimitiveOp.permute" name="permute" signature="permute(permutation)">
  ...
  <Function id="qiskit.opflow.primitive_ops.PrimitiveOp.primitive_strings" name="primitive_strings" signature="primitive_strings()">
  ...
  <Function id="qiskit.opflow.primitive_ops.PrimitiveOp.reduce" name="reduce" signature="reduce()">
  ...
  <Function id="qiskit.opflow.primitive_ops.PrimitiveOp.tensor" name="tensor" signature="tensor(other)">
  ...
  <Function id="qiskit.opflow.primitive_ops.PrimitiveOp.tensorpower" name="tensorpower" signature="tensorpower(other)">
  ...
  <Function id="qiskit.opflow.primitive_ops.PrimitiveOp.to_circuit" name="to_circuit" signature="to_circuit()">
  ...
  <Function id="qiskit.opflow.primitive_ops.PrimitiveOp.to_circuit_op" name="to_circuit_op" signature="to_circuit_op()">
  ...
  <Function id="qiskit.opflow.primitive_ops.PrimitiveOp.to_instruction" name="to_instruction" signature="to_instruction()">
  ...
  <Function id="qiskit.opflow.primitive_ops.PrimitiveOp.to_matrix" name="to_matrix" signature="to_matrix(massive=False)">
  ...
  <Function id="qiskit.opflow.primitive_ops.PrimitiveOp.to_matrix_op" name="to_matrix_op" signature="to_matrix_op(massive=False)">
  ...
  <Function id="qiskit.opflow.primitive_ops.PrimitiveOp.to_pauli_op" name="to_pauli_op" signature="to_pauli_op(massive=False)">
