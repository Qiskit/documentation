...
<Class id="qiskit.circuit.classicalfunction.ClassicalFunction" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/circuit/classicalfunction/classicalfunction.py" signature="qiskit.circuit.classicalfunction.ClassicalFunction(source, name=None)">
  ...
  **Raises**
  ...
  <Attribute id="qiskit.circuit.classicalfunction.ClassicalFunction.base_class" name="base_class">
  ...
  <Attribute id="qiskit.circuit.classicalfunction.ClassicalFunction.condition" name="condition">
  ...
  <Attribute id="qiskit.circuit.classicalfunction.ClassicalFunction.mutable" name="mutable">
