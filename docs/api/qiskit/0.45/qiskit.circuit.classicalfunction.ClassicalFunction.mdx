---
title: ClassicalFunction (v0.45)
description: API reference for qiskit.circuit.classicalfunction.ClassicalFunction in qiskit v0.45
...
<Class id="qiskit.circuit.classicalfunction.ClassicalFunction" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/circuit/classicalfunction/classicalfunction.py" signature="qiskit.circuit.classicalfunction.ClassicalFunction(source, name=None)" modifiers="class">
