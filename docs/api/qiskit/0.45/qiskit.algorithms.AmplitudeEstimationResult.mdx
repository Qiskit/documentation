---
title: AmplitudeEstimationResult (v0.45)
description: API reference for qiskit.algorithms.AmplitudeEstimationResult in qiskit v0.45
...
<Class id="qiskit.algorithms.AmplitudeEstimationResult" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/algorithms/amplitude_estimators/ae.py" signature="qiskit.algorithms.AmplitudeEstimationResult" modifiers="class">
