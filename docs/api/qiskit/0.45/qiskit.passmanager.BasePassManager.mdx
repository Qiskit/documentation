...
<Class id="qiskit.passmanager.BasePassManager" github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/passmanager/passmanager.py" signature="qiskit.passmanager.BasePassManager(tasks=(), max_iteration=1000)">
