...
<Class id="qiskit.opflow.evolutions.TrotterizationFactory" github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/opflow/evolutions/trotterizations/trotterization_factory.py" signature="qiskit.opflow.evolutions.TrotterizationFactory">
