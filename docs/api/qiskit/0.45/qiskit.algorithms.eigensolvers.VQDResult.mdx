...
description: API reference for qiskit.algorithms.eigensolvers.VQDResult in qiskit v0.45
...
<Class id="qiskit.algorithms.eigensolvers.VQDResult" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/algorithms/eigensolvers/vqd.py" signature="qiskit.algorithms.eigensolvers.VQDResult" modifiers="class">
