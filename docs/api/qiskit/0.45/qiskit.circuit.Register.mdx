...
<Class id="qiskit.circuit.Register" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/circuit/register.py" signature="qiskit.circuit.Register(size=None, name=None, bits=None)">
  ...
  *   [**CircuitError**](circuit#qiskit.circuit.CircuitError "qiskit.circuit.CircuitError") – if `bits` contained bits of an incorrect type.
  ...
  <Attribute id="qiskit.circuit.Register.bit_type" name="bit_type" attributeValue="None" />

  ### instances\_counter

  <Attribute id="qiskit.circuit.Register.instances_counter" name="instances_counter" attributeValue="count(0)" />
  ...
  <Attribute id="qiskit.circuit.Register.name_format" name="name_format" attributeValue="re.compile('[a-z][a-zA-Z0-9_]*')" />

  ### prefix

  <Attribute id="qiskit.circuit.Register.prefix" name="prefix" attributeValue="'reg'" />
