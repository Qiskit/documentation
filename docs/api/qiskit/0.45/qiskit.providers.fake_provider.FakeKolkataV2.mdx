---
title: FakeKolkataV2 (v0.45)
description: API reference for qiskit.providers.fake_provider.FakeKolkataV2 in qiskit v0.45
...
<Class id="qiskit.providers.fake_provider.FakeKolkataV2" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/providers/fake_provider/backends/kolkata/fake_kolkata.py" signature="qiskit.providers.fake_provider.FakeKolkataV2" modifiers="class">
  ...
  <Attribute id="qiskit.providers.fake_provider.FakeKolkataV2.dirname" attributeValue="'/home/runner/work/qiskit/qiskit/qiskit/providers/fake_provider/backends/kolkata'" />
  ...
  <Attribute id="qiskit.providers.fake_provider.FakeKolkataV2.name">
    Name of the backend.
  </Attribute>

  ### description

  <Attribute id="qiskit.providers.fake_provider.FakeKolkataV2.description">
    Optional human-readable description.
  </Attribute>

  ### online\_date

  <Attribute id="qiskit.providers.fake_provider.FakeKolkataV2.online_date">
    Date that the backend came online.
  </Attribute>

  ### backend\_version

  <Attribute id="qiskit.providers.fake_provider.FakeKolkataV2.backend_version">
  ...
  <Function id="qiskit.providers.fake_provider.FakeKolkataV2.acquire_channel" signature="acquire_channel(qubit)">
  ...
  <Function id="qiskit.providers.fake_provider.FakeKolkataV2.control_channel" signature="control_channel(qubits)">
  ...
  <Function id="qiskit.providers.fake_provider.FakeKolkataV2.drive_channel" signature="drive_channel(qubit)">
  ...
  <Function id="qiskit.providers.fake_provider.FakeKolkataV2.measure_channel" signature="measure_channel(qubit)">
  ...
  <Function id="qiskit.providers.fake_provider.FakeKolkataV2.qubit_properties" signature="qubit_properties(qubit)">
  ...
  <Function id="qiskit.providers.fake_provider.FakeKolkataV2.run" signature="run(run_input, **options)">
  ...
  <Function id="qiskit.providers.fake_provider.FakeKolkataV2.set_options" signature="set_options(**fields)">
