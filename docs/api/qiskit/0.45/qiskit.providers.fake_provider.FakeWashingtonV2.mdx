...
<Class id="qiskit.providers.fake_provider.FakeWashingtonV2" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/providers/fake_provider/backends/washington/fake_washington.py" signature="qiskit.providers.fake_provider.FakeWashingtonV2">
