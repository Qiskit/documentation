---
title: PauliBasisChange (v0.45)
description: API reference for qiskit.opflow.converters.PauliBasisChange in qiskit v0.45
...
<Class id="qiskit.opflow.converters.PauliBasisChange" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/opflow/converters/pauli_basis_change.py" signature="qiskit.opflow.converters.PauliBasisChange(destination_basis=None, traverse=True, replacement_fn=None)" modifiers="class">
