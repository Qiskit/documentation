---
title: AlignLeft (v0.45)
description: API reference for qiskit.pulse.transforms.AlignLeft in qiskit v0.45
...
<Class id="qiskit.pulse.transforms.AlignLeft" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/pulse/transforms/alignments.py" signature="qiskit.pulse.transforms.AlignLeft" modifiers="class">
