---
title: RZXGate (v0.45)
description: API reference for qiskit.circuit.library.RZXGate in qiskit v0.45
...
<Class id="qiskit.circuit.library.RZXGate" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/circuit/library/standard_gates/rzx.py" signature="qiskit.circuit.library.RZXGate(theta, label=None, *, duration=None, unit='dt')" modifiers="class">
