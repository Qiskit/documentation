...
<Class id="qiskit.circuit.library.RZXGate" github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/circuit/library/standard_gates/rzx.py" signature="qiskit.circuit.library.RZXGate(theta, label=None, *, duration=None, unit='dt')">
