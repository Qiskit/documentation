...
<Class id="qiskit.circuit.library.RZXGate" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/circuit/library/standard_gates/rzx.py" signature="qiskit.circuit.library.RZXGate(theta, label=None, *, duration=None, unit='dt')">
...
$$
  ...
  **Examples:**
  ...
  <Attribute id="qiskit.circuit.library.RZXGate.base_class" name="base_class">
  ...
  <Attribute id="qiskit.circuit.library.RZXGate.condition" name="condition">
    The classical condition on the instruction.
  </Attribute>

  ### condition\_bits

  <Attribute id="qiskit.circuit.library.RZXGate.condition_bits" name="condition_bits">
  ...
  <Attribute id="qiskit.circuit.library.RZXGate.duration" name="duration">
    Get the duration.
  </Attribute>

  ### label

  <Attribute id="qiskit.circuit.library.RZXGate.label" name="label">
    Return instruction label
  </Attribute>

  ### mutable

  <Attribute id="qiskit.circuit.library.RZXGate.mutable" name="mutable">
  ...
  <Attribute id="qiskit.circuit.library.RZXGate.name" name="name">
    Return the name.
  </Attribute>

  ### num\_clbits

  <Attribute id="qiskit.circuit.library.RZXGate.num_clbits" name="num_clbits">
    Return the number of clbits.
  </Attribute>

  ### num\_qubits

  <Attribute id="qiskit.circuit.library.RZXGate.num_qubits" name="num_qubits">
  ...
  <Attribute id="qiskit.circuit.library.RZXGate.unit" name="unit">
