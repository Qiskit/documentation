...
<Class id="qiskit.primitives.EstimatorResult" github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/primitives/base/estimator_result.py" signature="qiskit.primitives.EstimatorResult(values, metadata)">
