---
title: FakeManhattanV2 (v0.45)
description: API reference for qiskit.providers.fake_provider.FakeManhattanV2 in qiskit v0.45
...
<Class id="qiskit.providers.fake_provider.FakeManhattanV2" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/providers/fake_provider/backends/manhattan/fake_manhattan.py" signature="qiskit.providers.fake_provider.FakeManhattanV2" modifiers="class">
  ...
  <Attribute id="qiskit.providers.fake_provider.FakeManhattanV2.dirname" attributeValue="'/home/runner/work/qiskit/qiskit/qiskit/providers/fake_provider/backends/manhattan'" />
  ...
  <Attribute id="qiskit.providers.fake_provider.FakeManhattanV2.name">
    Name of the backend.
  </Attribute>

  ### description

  <Attribute id="qiskit.providers.fake_provider.FakeManhattanV2.description">
    Optional human-readable description.
  </Attribute>

  ### online\_date

  <Attribute id="qiskit.providers.fake_provider.FakeManhattanV2.online_date">
    Date that the backend came online.
  </Attribute>

  ### backend\_version

  <Attribute id="qiskit.providers.fake_provider.FakeManhattanV2.backend_version">
  ...
  <Function id="qiskit.providers.fake_provider.FakeManhattanV2.acquire_channel" signature="acquire_channel(qubit)">
  ...
  <Function id="qiskit.providers.fake_provider.FakeManhattanV2.control_channel" signature="control_channel(qubits)">
  ...
  <Function id="qiskit.providers.fake_provider.FakeManhattanV2.drive_channel" signature="drive_channel(qubit)">
  ...
  <Function id="qiskit.providers.fake_provider.FakeManhattanV2.measure_channel" signature="measure_channel(qubit)">
  ...
  <Function id="qiskit.providers.fake_provider.FakeManhattanV2.qubit_properties" signature="qubit_properties(qubit)">
  ...
  <Function id="qiskit.providers.fake_provider.FakeManhattanV2.run" signature="run(run_input, **options)">
  ...
  <Function id="qiskit.providers.fake_provider.FakeManhattanV2.set_options" signature="set_options(**fields)">
