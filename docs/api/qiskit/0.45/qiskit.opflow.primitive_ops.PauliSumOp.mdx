...
<Class id="qiskit.opflow.primitive_ops.PauliSumOp" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/opflow/primitive_ops/pauli_sum_op.py" signature="qiskit.opflow.primitive_ops.PauliSumOp(*args, **kwargs)">
  ...
  **Raises**
  ...
  <Function id="qiskit.opflow.primitive_ops.PauliSumOp.from_list" name="from_list" signature="classmethod from_list(pauli_list, coeff=1.0, dtype=<class 'complex'>)">
  ...
  <Function id="qiskit.opflow.primitive_ops.PauliSumOp.is_hermitian" name="is_hermitian" signature="is_hermitian()">
