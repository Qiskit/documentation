...
<Class id="qiskit.transpiler.passes.SabreLayout" github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/transpiler/passes/layout/sabre_layout.py" signature="qiskit.transpiler.passes.SabreLayout(*args, **kwargs)">
