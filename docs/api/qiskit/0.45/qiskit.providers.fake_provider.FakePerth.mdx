---
title: FakePerth (v0.45)
description: API reference for qiskit.providers.fake_provider.FakePerth in qiskit v0.45
...
<Class id="qiskit.providers.fake_provider.FakePerth" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/providers/fake_provider/backends/perth/fake_perth.py" signature="qiskit.providers.fake_provider.FakePerth" modifiers="class">
