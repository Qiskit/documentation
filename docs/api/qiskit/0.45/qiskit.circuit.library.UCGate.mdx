---
title: UCGate (v0.45)
description: API reference for qiskit.circuit.library.UCGate in qiskit v0.45
...
<Class id="qiskit.circuit.library.UCGate" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/circuit/library/generalized_gates/uc.py" signature="qiskit.circuit.library.UCGate(gate_list, up_to_diagonal=False)" modifiers="class">
...
$$
  ...
  **Raises**
  ...
  <Function id="qiskit.circuit.library.UCGate.inverse" signature="inverse()">
    Return the inverse.
  ...
  <Function id="qiskit.circuit.library.UCGate.validate_parameter" signature="validate_parameter(parameter)">
