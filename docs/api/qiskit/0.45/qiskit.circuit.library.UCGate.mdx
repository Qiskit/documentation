...
<Class id="qiskit.circuit.library.UCGate" github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/circuit/library/generalized_gates/uc.py" signature="qiskit.circuit.library.UCGate(gate_list, up_to_diagonal=False)">
