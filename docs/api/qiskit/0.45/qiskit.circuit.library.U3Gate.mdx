...
<Class id="qiskit.circuit.library.U3Gate" github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/circuit/library/standard_gates/u3.py" signature="qiskit.circuit.library.U3Gate(theta, phi, lam, label=None, *, duration=None, unit='dt')">
