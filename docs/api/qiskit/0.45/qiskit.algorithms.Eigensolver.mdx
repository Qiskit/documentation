...
<Class id="qiskit.algorithms.Eigensolver" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/algorithms/eigen_solvers/eigen_solver.py" signature="qiskit.algorithms.Eigensolver">
  ...
  <Function id="qiskit.algorithms.Eigensolver.compute_eigenvalues" signature="abstract compute_eigenvalues(operator, aux_operators=None)">
  ...
  <Function id="qiskit.algorithms.Eigensolver.supports_aux_operators" signature="classmethod supports_aux_operators()">
