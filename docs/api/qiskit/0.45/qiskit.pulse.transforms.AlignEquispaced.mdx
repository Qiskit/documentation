...
<Class id="qiskit.pulse.transforms.AlignEquispaced" github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/pulse/transforms/alignments.py" signature="qiskit.pulse.transforms.AlignEquispaced(duration)">
