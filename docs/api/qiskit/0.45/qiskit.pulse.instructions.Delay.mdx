---
title: Delay (v0.45)
description: API reference for qiskit.pulse.instructions.Delay in qiskit v0.45
...
<Class id="qiskit.pulse.instructions.Delay" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/pulse/instructions/delay.py" signature="qiskit.pulse.instructions.Delay(duration, channel, name=None)" modifiers="class">
