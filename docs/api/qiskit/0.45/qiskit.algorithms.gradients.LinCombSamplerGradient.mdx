...
<Class id="qiskit.algorithms.gradients.LinCombSamplerGradient" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/algorithms/gradients/lin_comb/lin_comb_sampler_gradient.py" signature="qiskit.algorithms.gradients.LinCombSamplerGradient(sampler, options=None)">
