...
<Class id="qiskit.transpiler.InstructionProperties" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/transpiler/target.py" signature="qiskit.transpiler.InstructionProperties(duration=None, error=None, calibration=None)">
