---
title: PropertySet (v0.45)
description: API reference for qiskit.passmanager.PropertySet in qiskit v0.45
...
<Class id="qiskit.passmanager.PropertySet" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/passmanager/compilation_status.py" signature="qiskit.passmanager.PropertySet" modifiers="class">
