...
<Class id="qiskit.transpiler.FencedDAGCircuit" github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/transpiler/fencedobjs.py" signature="qiskit.transpiler.FencedDAGCircuit(dag_circuit_instance)">
  Bases: `FencedObject`
