...
<Class id="qiskit.transpiler.passes.ALAPSchedule" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/transpiler/passes/scheduling/alap.py" signature="qiskit.transpiler.passes.ALAPSchedule(*args, **kwargs)">
