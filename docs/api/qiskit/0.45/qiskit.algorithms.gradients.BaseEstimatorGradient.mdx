---
title: BaseEstimatorGradient (v0.45)
description: API reference for qiskit.algorithms.gradients.BaseEstimatorGradient in qiskit v0.45
...
<Class id="qiskit.algorithms.gradients.BaseEstimatorGradient" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/algorithms/gradients/base/base_estimator_gradient.py" signature="qiskit.algorithms.gradients.BaseEstimatorGradient(estimator, options=None, derivative_type=DerivativeType.REAL)" modifiers="class">
