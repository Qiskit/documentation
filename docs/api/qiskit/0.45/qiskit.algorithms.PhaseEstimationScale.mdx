---
title: PhaseEstimationScale (v0.45)
description: API reference for qiskit.algorithms.PhaseEstimationScale in qiskit v0.45
...
<Class id="qiskit.algorithms.PhaseEstimationScale" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/algorithms/phase_estimators/phase_estimation_scale.py" signature="qiskit.algorithms.PhaseEstimationScale(bound)" modifiers="class">
