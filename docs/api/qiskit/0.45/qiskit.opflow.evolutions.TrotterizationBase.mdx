...
<Class id="qiskit.opflow.evolutions.TrotterizationBase" github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/opflow/evolutions/trotterizations/trotterization_base.py" signature="qiskit.opflow.evolutions.TrotterizationBase(reps=1)">
