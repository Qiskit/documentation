---
title: SetLayout (v0.45)
description: API reference for qiskit.transpiler.passes.SetLayout in qiskit v0.45
...
<Class id="qiskit.transpiler.passes.SetLayout" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/transpiler/passes/layout/set_layout.py" signature="qiskit.transpiler.passes.SetLayout(*args, **kwargs)" modifiers="class">
