---
title: AskData (v0.45)
description: API reference for qiskit.algorithms.optimizers.AskData in qiskit v0.45
...
<Class id="qiskit.algorithms.optimizers.AskData" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/algorithms/optimizers/steppable_optimizer.py" signature="qiskit.algorithms.optimizers.AskData(x_fun=None, x_jac=None)" modifiers="class">
