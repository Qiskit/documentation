...
<Class id="qiskit.circuit.Bit" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/circuit/bit.py" signature="qiskit.circuit.Bit(register=None, index=None)">
