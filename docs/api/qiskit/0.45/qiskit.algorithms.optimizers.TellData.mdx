...
<Class id="qiskit.algorithms.optimizers.TellData" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/algorithms/optimizers/steppable_optimizer.py" signature="qiskit.algorithms.optimizers.TellData(eval_fun=None, eval_jac=None)">
  ...
  *   **eval\_jac** (*POINT |* [*list*](https://docs.python.org/3/library/stdtypes.html#list "(in Python v3.12)")*\[POINT] | None*) – Image of the gradient-jacobian at `x_jac`.
  ...
  <Attribute id="qiskit.algorithms.optimizers.TellData.eval_fun" name="eval_fun" attributeTypeHint="float | list[float] | None" attributeValue="= None" />

  ### eval\_jac

  <Attribute id="qiskit.algorithms.optimizers.TellData.eval_jac" name="eval_jac" attributeTypeHint="POINT | list[POINT] | None" attributeValue="= None" />
</Class>
