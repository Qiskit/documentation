---
title: Backend (v0.45)
description: API reference for qiskit.providers.Backend in qiskit v0.45
...
<Class id="qiskit.providers.Backend" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/providers/backend.py" signature="qiskit.providers.Backend" modifiers="class">
