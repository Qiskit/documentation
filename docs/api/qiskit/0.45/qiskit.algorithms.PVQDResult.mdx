...
<Class id="qiskit.algorithms.PVQDResult" github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/algorithms/time_evolvers/pvqd/pvqd_result.py" signature="qiskit.algorithms.PVQDResult(evolved_state, aux_ops_evaluated=None, times=None, parameters=None, fidelities=None, estimated_error=None, observables=None)">
  ...
  *   **observables** ([*list*](https://docs.python.org/3/library/stdtypes.html#list "(in Python v3.12)")*\[*[*list*](https://docs.python.org/3/library/stdtypes.html#list "(in Python v3.12)")*\[*[*float*](https://docs.python.org/3/library/functions.html#float "(in Python v3.12)")*]] | None*) – The value of the observables evaluated at each iteration.
  ...
  <Function id="qiskit.algorithms.PVQDResult.combine" name="combine" signature="combine(result)">
