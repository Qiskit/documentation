---
title: DAGDependency (v0.45)
description: API reference for qiskit.dagcircuit.DAGDependency in qiskit v0.45
...
<Class id="qiskit.dagcircuit.DAGDependency" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/dagcircuit/dagdependency.py" signature="qiskit.dagcircuit.DAGDependency" modifiers="class">
  ...
  **Reference:**
  ...
  <Function id="qiskit.dagcircuit.DAGDependency.replace_block_with_op" signature="replace_block_with_op(node_block, op, wire_pos_map, cycle_check=True)">
