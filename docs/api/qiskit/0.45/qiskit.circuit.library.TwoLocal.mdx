...
<Class id="qiskit.circuit.library.TwoLocal" github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/circuit/library/n_local/two_local.py" signature="qiskit.circuit.library.TwoLocal(num_qubits=None, rotation_blocks=None, entanglement_blocks=None, entanglement='full', reps=3, skip_unentangled_qubits=False, skip_final_rotation_layer=False, parameter_prefix='θ', insert_barriers=False, initial_state=None, name='TwoLocal', flatten=None)">
  ...
  *   **flatten** ([*bool*](https://docs.python.org/3/library/functions.html#bool "(in Python v3.12)") *| None*) – Set this to `True` to output a flat circuit instead of nesting it inside multiple layers of gate objects. By default currently the contents of the output circuit will be wrapped in nested objects for cleaner visualization. However, if you’re using this circuit for anything besides visualization its **strongly** recommended to set this flag to `True` to avoid a large performance overhead for parameter binding.
  ...
  <Attribute id="qiskit.circuit.library.TwoLocal.ancillas" name="ancillas">
    Returns a list of ancilla bits in the order that the registers were added.
  </Attribute>

  ### calibrations

  <Attribute id="qiskit.circuit.library.TwoLocal.calibrations" name="calibrations">
  ...
  <Attribute id="qiskit.circuit.library.TwoLocal.entanglement" name="entanglement">
  ...
  <Attribute id="qiskit.circuit.library.TwoLocal.entanglement_blocks" name="entanglement_blocks">
  ...
  <Attribute id="qiskit.circuit.library.TwoLocal.extension_lib" name="extension_lib" attributeValue="= 'include &#x22;qelib1.inc&#x22;;'" />

  ### flatten

  <Attribute id="qiskit.circuit.library.TwoLocal.flatten" name="flatten">
    Returns whether the circuit is wrapped in nested gates/instructions or flattened.
  </Attribute>

  ### global\_phase

  <Attribute id="qiskit.circuit.library.TwoLocal.global_phase" name="global_phase">
    Return the global phase of the current circuit scope in radians.
  </Attribute>

  ### header

  <Attribute id="qiskit.circuit.library.TwoLocal.header" name="header" attributeValue="= 'OPENQASM 2.0;'" />

  ### initial\_state

  <Attribute id="qiskit.circuit.library.TwoLocal.initial_state" name="initial_state">
  ...
  <Attribute id="qiskit.circuit.library.TwoLocal.insert_barriers" name="insert_barriers">
  ...
  <Attribute id="qiskit.circuit.library.TwoLocal.instances" name="instances" attributeValue="= 159" />

  ### layout

  <Attribute id="qiskit.circuit.library.TwoLocal.layout" name="layout">
  ...
  <Attribute id="qiskit.circuit.library.TwoLocal.metadata" name="metadata">
  ...
  <Attribute id="qiskit.circuit.library.TwoLocal.num_ancillas" name="num_ancillas">
  ...
  <Attribute id="qiskit.circuit.library.TwoLocal.num_layers" name="num_layers">
  ...
  <Attribute id="qiskit.circuit.library.TwoLocal.num_parameters_settable" name="num_parameters_settable">
  ...
  <Attribute id="qiskit.circuit.library.TwoLocal.num_qubits" name="num_qubits">
  ...
  <Attribute id="qiskit.circuit.library.TwoLocal.op_start_times" name="op_start_times">
  ...
  <Attribute id="qiskit.circuit.library.TwoLocal.ordered_parameters" name="ordered_parameters">
  ...
  <Attribute id="qiskit.circuit.library.TwoLocal.parameter_bounds" name="parameter_bounds">
  ...
  <Attribute id="qiskit.circuit.library.TwoLocal.parameters" name="parameters" />

  ### preferred\_init\_points

  <Attribute id="qiskit.circuit.library.TwoLocal.preferred_init_points" name="preferred_init_points">
  ...
  <Attribute id="qiskit.circuit.library.TwoLocal.prefix" name="prefix" attributeValue="= 'circuit'" />

  ### qregs

  <Attribute id="qiskit.circuit.library.TwoLocal.qregs" name="qregs" attributeTypeHint="list[QuantumRegister]">
  ...
  <Attribute id="qiskit.circuit.library.TwoLocal.reps" name="reps">
  ...
  <Attribute id="qiskit.circuit.library.TwoLocal.rotation_blocks" name="rotation_blocks">
