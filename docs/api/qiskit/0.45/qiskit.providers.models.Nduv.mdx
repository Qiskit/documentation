...
<Class id="qiskit.providers.models.Nduv" github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/providers/models/backendproperties.py" signature="qiskit.providers.models.Nduv(date, name, unit, value)">
