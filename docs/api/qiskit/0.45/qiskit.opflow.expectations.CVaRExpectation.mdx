---
title: CVaRExpectation (v0.45)
description: API reference for qiskit.opflow.expectations.CVaRExpectation in qiskit v0.45
...
<Class id="qiskit.opflow.expectations.CVaRExpectation" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/opflow/expectations/cvar_expectation.py" signature="qiskit.opflow.expectations.CVaRExpectation(alpha, expectation=None)" modifiers="class">
