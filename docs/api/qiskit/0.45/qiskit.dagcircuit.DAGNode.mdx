...
<Class id="qiskit.dagcircuit.DAGNode" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/dagcircuit/dagnode.py" signature="qiskit.dagcircuit.DAGNode(nid=-1)">
