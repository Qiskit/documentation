---
title: RYYGate (v0.45)
description: API reference for qiskit.circuit.library.RYYGate in qiskit v0.45
...
<Class id="qiskit.circuit.library.RYYGate" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.45/qiskit/circuit/library/standard_gates/ryy.py" signature="qiskit.circuit.library.RYYGate(theta, label=None, *, duration=None, unit='dt')" modifiers="class">
