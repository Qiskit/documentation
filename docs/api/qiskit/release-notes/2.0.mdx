...
*   Fixed an issue in the [`ElidePermutations`](/docs/api/qiskit/qiskit.transpiler.passes.ElidePermutations "qiskit.transpiler.passes.ElidePermutations") transpiler pass, where the output permutation was not updated correctly in the presence of [`PermutationGate`](/docs/api/qiskit/qiskit.circuit.library.PermutationGate "qiskit.circuit.library.PermutationGate") operations. This would result in an incorrect output circuit and an incorrect `virtual_permutation_layout` property in the `property_set` being set. When run as part of a larger [`PassManager`](/docs/api/qiskit/qiskit.transpiler.PassManager "qiskit.transpiler.PassManager") this would also result in an incorrect [`TranspileLayout`](/docs/api/qiskit/qiskit.transpiler.TranspileLayout "qiskit.transpiler.TranspileLayout") being returned in the [`QuantumCircuit.layout`](/docs/api/qiskit/qiskit.circuit.QuantumCircuit#layout "qiskit.circuit.QuantumCircuit.layout") in the output circuit.

*   Fixed a bug in the [`HighLevelSynthesis`](/docs/api/qiskit/qiskit.transpiler.passes.HighLevelSynthesis "qiskit.transpiler.passes.HighLevelSynthesis") pass when unrolling nested/custom [`Instruction`](/docs/api/qiskit/qiskit.circuit.Instruction "qiskit.circuit.Instruction") objects. If the [`QuantumCircuit`](/docs/api/qiskit/qiskit.circuit.QuantumCircuit "qiskit.circuit.QuantumCircuit") returned by [`Instruction.definition`](/docs/api/qiskit/qiskit.circuit.Instruction#definition "qiskit.circuit.Instruction.definition") of a custom object contained any [`Clbit`](/docs/api/qiskit/circuit#qiskit.circuit.Clbit "qiskit.circuit.Clbit") objects, these classical bits would incorrectly use the internal index inside the [`Instruction.definition`](/docs/api/qiskit/qiskit.circuit.Instruction#definition "qiskit.circuit.Instruction.definition") [`QuantumCircuit`](/docs/api/qiskit/qiskit.circuit.QuantumCircuit "qiskit.circuit.QuantumCircuit") instead of mapping them to the corresponding index in the outer [`QuantumCircuit`](/docs/api/qiskit/qiskit.circuit.QuantumCircuit "qiskit.circuit.QuantumCircuit").
...
*   Fixed a compatibility issue with the minimum supported version of [rustworkx](https://www.rustworkx.org/), 0.15. With certain inputs the [`VF2Layout`](/docs/api/qiskit/qiskit.transpiler.passes.VF2Layout "qiskit.transpiler.passes.VF2Layout") and [`VF2PostLayout`](/docs/api/qiskit/qiskit.transpiler.passes.VF2PostLayout "qiskit.transpiler.passes.VF2PostLayout") were previously using a rustworkx method that was added in rustworkx 0.16.0 which would cause an error when using an older rustworkx release which is listed as supported.
...
*   Fixed the [`name`](/docs/api/qiskit/qiskit.circuit.Gate#name "qiskit.circuit.Gate.name") attribute of the [`OrGate`](/docs/api/qiskit/qiskit.circuit.library.OrGate "qiskit.circuit.library.OrGate") class so that it now is set to `"or"` to uniquely identify this gate. It was previously incorrectly set to `"and"` which made it impossible to distinguish it from [`AndGate`](/docs/api/qiskit/qiskit.circuit.library.AndGate "qiskit.circuit.library.AndGate") or have synthesis plugins to synthesize an [`OrGate`](/docs/api/qiskit/qiskit.circuit.library.OrGate "qiskit.circuit.library.OrGate").
...
*   Fixed a bug in the circuit functions [`evolved_operator_ansatz()`](/docs/api/qiskit/qiskit.circuit.library.evolved_operator_ansatz "qiskit.circuit.library.evolved_operator_ansatz"), [`qaoa_ansatz()`](/docs/api/qiskit/qiskit.circuit.library.qaoa_ansatz "qiskit.circuit.library.qaoa_ansatz") and [`hamiltonian_variational_ansatz()`](/docs/api/qiskit/qiskit.circuit.library.hamiltonian_variational_ansatz "qiskit.circuit.library.hamiltonian_variational_ansatz"), where the parameters had a zero complex component. This was normally not an issue unless the parameter was translated to SymPy using the [`ParameterExpression.sympify()`](/docs/api/qiskit/qiskit.circuit.ParameterExpression#sympify "qiskit.circuit.ParameterExpression.sympify") method, which would then raise an error.
