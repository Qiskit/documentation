...
*   The naming of gate objects and methods have been updated to be more consistent. The following changes have been made:
    ...
    *   Gates are named according to their action, not their alternative names (`CCX`, not `Toffoli`)
    ...
    | `FredkinGate` | `CSwapGate`      | `cswap`            |                    | [`cswap()`](/api/qiskit/qiskit.circuit.QuantumCircuit#cswap "qiskit.circuit.QuantumCircuit.cswap") and [`fredkin()`](/api/qiskit/0.44/qiskit.circuit.QuantumCircuit#fredkin "qiskit.circuit.QuantumCircuit.fredkin") |                                                                                                                                                                                      |
