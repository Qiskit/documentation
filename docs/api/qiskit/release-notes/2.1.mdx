...
*   The [Qiskit C API (qiskit.h)](/docs/api/qiskit/cdoc/index#c-api) now supports building a [`Target`](/docs/api/qiskit/qiskit.transpiler.Target "qiskit.transpiler.Target") to represent a transpilation target. For example:
