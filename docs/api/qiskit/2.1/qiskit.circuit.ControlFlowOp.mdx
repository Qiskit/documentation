---
title: ControlFlowOp (v2.1)
description: API reference for qiskit.circuit.ControlFlowOp in qiskit v2.1
...
<Class id="qiskit.circuit.ControlFlowOp" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/2.1/qiskit/circuit/controlflow/control_flow.py#L28-L94" signature="qiskit.circuit.ControlFlowOp(*args, **kwargs)" modifiers="class">
  ...
  *   [**TypeError**](https://docs.python.org/3/library/exceptions.html#TypeError) – when the optional label is provided, but it is not a string.
  ...
  <Function id="qiskit.circuit.ControlFlowOp.add_decomposition" github="https://github.com/Qiskit/qiskit/tree/stable/2.1/qiskit/circuit/instruction.py#L321-L326" signature="add_decomposition(decomposition)">
    Add a decomposition of the instruction to the SessionEquivalenceLibrary.
  </Function>

  ### broadcast\_arguments

  <Function id="qiskit.circuit.ControlFlowOp.broadcast_arguments" github="https://github.com/Qiskit/qiskit/tree/stable/2.1/qiskit/circuit/instruction.py#L455-L484" signature="broadcast_arguments(qargs, cargs)">
  ...
  <Function id="qiskit.circuit.ControlFlowOp.copy" github="https://github.com/Qiskit/qiskit/tree/stable/2.1/qiskit/circuit/instruction.py#L431-L446" signature="copy(name=None)">
  ...
  <Function id="qiskit.circuit.ControlFlowOp.inverse" github="https://github.com/Qiskit/qiskit/tree/stable/2.1/qiskit/circuit/instruction.py#L374-L429" signature="inverse(annotated=False)">
  ...
  <Function id="qiskit.circuit.ControlFlowOp.is_parameterized" github="https://github.com/Qiskit/qiskit/tree/stable/2.1/qiskit/circuit/instruction.py#L286-L291" signature="is_parameterized()">
  ...
  <Function id="qiskit.circuit.ControlFlowOp.iter_captured_stretches" github="https://github.com/Qiskit/qiskit/tree/stable/2.1/qiskit/circuit/controlflow/control_flow.py#L86-L94" signature="iter_captured_stretches()">
  ...
  <Function id="qiskit.circuit.ControlFlowOp.iter_captured_vars" github="https://github.com/Qiskit/qiskit/tree/stable/2.1/qiskit/circuit/controlflow/control_flow.py#L77-L84" signature="iter_captured_vars()">
  ...
  <Function id="qiskit.circuit.ControlFlowOp.repeat" github="https://github.com/Qiskit/qiskit/tree/stable/2.1/qiskit/circuit/instruction.py#L494-L524" signature="repeat(n)">
  ...
  <Function id="qiskit.circuit.ControlFlowOp.replace_blocks" github="https://github.com/Qiskit/qiskit/tree/stable/2.1/qiskit/circuit/controlflow/control_flow.py#L48-L75" signature="replace_blocks(blocks)" modifiers="abstract">
  ...
  <Function id="qiskit.circuit.ControlFlowOp.reverse_ops" github="https://github.com/Qiskit/qiskit/tree/stable/2.1/qiskit/circuit/instruction.py#L348-L372" signature="reverse_ops()">
  ...
  <Function id="qiskit.circuit.ControlFlowOp.soft_compare" github="https://github.com/Qiskit/qiskit/tree/stable/2.1/qiskit/circuit/instruction.py#L217-L257" signature="soft_compare(other)">
  ...
  <Function id="qiskit.circuit.ControlFlowOp.to_mutable" github="https://github.com/Qiskit/qiskit/tree/stable/2.1/qiskit/circuit/instruction.py#L146-L154" signature="to_mutable()">
  ...
  <Function id="qiskit.circuit.ControlFlowOp.validate_parameter" github="https://github.com/Qiskit/qiskit/tree/stable/2.1/qiskit/circuit/instruction.py#L282-L284" signature="validate_parameter(parameter)">
