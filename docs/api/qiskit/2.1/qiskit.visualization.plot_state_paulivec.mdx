---
title: plot_state_paulivec (v2.1)
description: API reference for qiskit.visualization.plot_state_paulivec in qiskit v2.1
...
$$
  ...
  **Examples**
  ...
  ![Output from the previous code.](/docs/images/api/qiskit/2.1/qiskit-visualization-plot_state_paulivec-1.avif)
  ...
  ![Output from the previous code.](/docs/images/api/qiskit/2.1/qiskit-visualization-plot_state_paulivec-2.avif)
</Function>
