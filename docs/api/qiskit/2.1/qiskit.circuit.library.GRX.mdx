---
title: GRX (v2.1)
description: API reference for qiskit.circuit.library.GRX in qiskit v2.1
...
$$
  ...
  **Expanded Circuit:**
  ...
  ![Diagram illustrating the previously described circuit.](/docs/images/api/qiskit/2.1/qiskit-circuit-library-GRX-1.avif)
