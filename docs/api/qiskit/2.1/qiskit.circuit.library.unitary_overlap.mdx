---
title: unitary_overlap (v2.1)
description: API reference for qiskit.circuit.library.unitary_overlap in qiskit v2.1
...
$$
  ...
  **Reference Circuit:**
  ...
  ![Circuit diagram output by the previous code.](/docs/images/api/qiskit/2.1/qiskit-circuit-library-unitary_overlap-1.avif)
