---
title: plot_state_qsphere (v2.1)
description: API reference for qiskit.visualization.plot_state_qsphere in qiskit v2.1
...
<Function id="qiskit.visualization.plot_state_qsphere" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/2.1/qiskit/visualization/state_visualization.py#L802-L1089" signature="qiskit.visualization.plot_state_qsphere(state, figsize=None, ax=None, show_state_labels=True, show_state_phases=False, use_degrees=False, *, filename=None)">
  ...
  **Examples**
  ...
  ![Output from the previous code.](/docs/images/api/qiskit/2.1/qiskit-visualization-plot_state_qsphere-1.avif)
  ...
  ![Output from the previous code.](/docs/images/api/qiskit/2.1/qiskit-visualization-plot_state_qsphere-2.avif)
</Function>
