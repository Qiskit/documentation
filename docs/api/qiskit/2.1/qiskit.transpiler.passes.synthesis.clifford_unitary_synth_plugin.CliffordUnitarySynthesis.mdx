---
title: CliffordUnitarySynthesis (v2.1)
description: API reference for qiskit.transpiler.passes.synthesis.clifford_unitary_synth_plugin.CliffordUnitarySynthesis in qiskit v2.1
