---
title: InnerProduct (v2.1)
description: API reference for qiskit.circuit.library.InnerProduct in qiskit v2.1
...
$$
  ...
  **Reference Circuit:**
  ...
  ![Diagram illustrating the previously described circuit.](/docs/images/api/qiskit/2.1/qiskit-circuit-library-InnerProduct-1.avif)
