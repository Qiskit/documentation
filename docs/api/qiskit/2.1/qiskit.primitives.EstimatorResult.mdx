---
title: EstimatorResult (v2.1)
description: API reference for qiskit.primitives.EstimatorResult in qiskit v2.1
...
<Class id="qiskit.primitives.EstimatorResult" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/2.1/qiskit/primitives/base/estimator_result_v1.py#L27-L46" signature="qiskit.primitives.EstimatorResult(values, metadata)" modifiers="class">
