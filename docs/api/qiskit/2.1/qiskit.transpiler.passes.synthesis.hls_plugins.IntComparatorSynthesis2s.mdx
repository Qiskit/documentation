---
title: IntComparatorSynthesis2s (v2.1)
description: API reference for qiskit.transpiler.passes.synthesis.hls_plugins.IntComparatorSynthesis2s in qiskit v2.1
