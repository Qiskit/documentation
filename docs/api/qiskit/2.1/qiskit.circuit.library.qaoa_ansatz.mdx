---
title: qaoa_ansatz (v2.1)
description: API reference for qiskit.circuit.library.qaoa_ansatz in qiskit v2.1
...
<Function id="qiskit.circuit.library.qaoa_ansatz" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/2.1/qiskit/circuit/library/n_local/qaoa_ansatz.py#L33-L105" signature="qiskit.circuit.library.qaoa_ansatz(cost_operator, reps=1, initial_state=None, mixer_operator=None, insert_barriers=False, name='QAOA', flatten=True)">
  ...
  **Examples**
  ...
  ![Circuit diagram output by the previous code.](/docs/images/api/qiskit/2.1/qiskit-circuit-library-qaoa_ansatz-1.avif)
