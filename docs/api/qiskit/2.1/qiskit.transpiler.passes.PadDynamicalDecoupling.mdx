---
title: PadDynamicalDecoupling (v2.1)
description: API reference for qiskit.transpiler.passes.PadDynamicalDecoupling in qiskit v2.1
...
<Class id="qiskit.transpiler.passes.PadDynamicalDecoupling" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/2.1/qiskit/transpiler/passes/scheduling/padding/dynamical_decoupling.py#L36-L408" signature="qiskit.transpiler.passes.PadDynamicalDecoupling(*args, **kwargs)" modifiers="class">
  Bases: `BasePadding`
  ...
  ![Output from the previous code.](/docs/images/api/qiskit/2.1/qiskit-transpiler-passes-PadDynamicalDecoupling-1_00.avif)

  ![Output from the previous code.](/docs/images/api/qiskit/2.1/qiskit-transpiler-passes-PadDynamicalDecoupling-1_01.avif)
  ...
  *   [**TypeError**](https://docs.python.org/3/library/exceptions.html#TypeError) – If `dd_sequence` is not specified
  ...
  <Function id="qiskit.transpiler.passes.PadDynamicalDecoupling.execute" github="https://github.com/Qiskit/qiskit/tree/stable/2.1/qiskit/transpiler/basepasses.py#L161-L180" signature="execute(passmanager_ir, state, callback=None)">
  ...
  <Function id="qiskit.transpiler.passes.PadDynamicalDecoupling.get_duration" github="https://github.com/Qiskit/qiskit/tree/stable/2.1/qiskit/transpiler/passes/scheduling/padding/base_padding.py#L74-L95" signature="get_duration(node, dag)">
    Get duration of a given node in the circuit.
  </Function>

  ### name

  <Function id="qiskit.transpiler.passes.PadDynamicalDecoupling.name" github="https://github.com/Qiskit/qiskit/tree/stable/2.1/qiskit/passmanager/base_tasks.py#L68-L70" signature="name()">
    Name of the pass.
  ...
  <Function id="qiskit.transpiler.passes.PadDynamicalDecoupling.run" github="https://github.com/Qiskit/qiskit/tree/stable/2.1/qiskit/transpiler/passes/scheduling/padding/base_padding.py#L97-L191" signature="run(dag)">
  ...
  <Function id="qiskit.transpiler.passes.PadDynamicalDecoupling.update_status" github="https://github.com/Qiskit/qiskit/tree/stable/2.1/qiskit/transpiler/basepasses.py#L182-L190" signature="update_status(state, run_state)">
