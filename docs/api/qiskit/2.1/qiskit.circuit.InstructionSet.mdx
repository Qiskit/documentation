---
title: InstructionSet (v2.1)
description: API reference for qiskit.circuit.InstructionSet in qiskit v2.1
...
<Class id="qiskit.circuit.InstructionSet" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/2.1/qiskit/circuit/instructionset.py#L30-L132" signature="qiskit.circuit.InstructionSet(*, resource_requester=None)" modifiers="class">
  ...
  **resource\_requester** (*Callable\[...,* [*ClassicalRegister*](circuit#qiskit.circuit.ClassicalRegister "qiskit.circuit.ClassicalRegister")  *|*[*Clbit*](circuit#qiskit.circuit.Clbit "qiskit.circuit.Clbit")*] | None*) –
  ...
  <Function id="qiskit.circuit.InstructionSet.add" github="https://github.com/Qiskit/qiskit/tree/stable/2.1/qiskit/circuit/instructionset.py#L76-L84" signature="add(instruction, qargs=None, cargs=None)">
    Add an instruction and its context (where it is attached).
  </Function>

  ### inverse

  <Function id="qiskit.circuit.InstructionSet.inverse" github="https://github.com/Qiskit/qiskit/tree/stable/2.1/qiskit/circuit/instructionset.py#L91-L108" signature="inverse(annotated=False)">
