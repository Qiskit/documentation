---
title: PMHSynthesisLinearFunction (v2.1)
description: API reference for qiskit.transpiler.passes.synthesis.hls_plugins.PMHSynthesisLinearFunction in qiskit v2.1
