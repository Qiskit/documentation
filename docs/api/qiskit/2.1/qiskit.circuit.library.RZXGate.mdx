---
title: RZXGate (v2.1)
description: API reference for qiskit.circuit.library.RZXGate in qiskit v2.1
...
<Class id="qiskit.circuit.library.RZXGate" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/2.1/qiskit/circuit/library/standard_gates/rzx.py#L24-L211" signature="qiskit.circuit.library.RZXGate(theta, label=None)" modifiers="class">
...
$$
  ...
  *   **label** (*Optional\[*[*str*](https://docs.python.org/3/library/stdtypes.html#str)*]*) –
  ...
  <Function id="qiskit.circuit.library.RZXGate.add_decomposition" github="https://github.com/Qiskit/qiskit/tree/stable/2.1/qiskit/circuit/instruction.py#L321-L326" signature="add_decomposition(decomposition)">
    Add a decomposition of the instruction to the SessionEquivalenceLibrary.
  </Function>

  ### broadcast\_arguments

  <Function id="qiskit.circuit.library.RZXGate.broadcast_arguments" github="https://github.com/Qiskit/qiskit/tree/stable/2.1/qiskit/circuit/gate.py#L188-L245" signature="broadcast_arguments(qargs, cargs)">
  ...
  <Function id="qiskit.circuit.library.RZXGate.control" github="https://github.com/Qiskit/qiskit/tree/stable/2.1/qiskit/circuit/library/standard_gates/rzx.py#L143-L174" signature="control(num_ctrl_qubits=1, label=None, ctrl_state=None, annotated=None)">
  ...
  <Function id="qiskit.circuit.library.RZXGate.copy" github="https://github.com/Qiskit/qiskit/tree/stable/2.1/qiskit/circuit/instruction.py#L431-L446" signature="copy(name=None)">
  ...
  <Function id="qiskit.circuit.library.RZXGate.inverse" github="https://github.com/Qiskit/qiskit/tree/stable/2.1/qiskit/circuit/library/standard_gates/rzx.py#L176-L188" signature="inverse(annotated=False)">
  ...
  <Function id="qiskit.circuit.library.RZXGate.is_parameterized" github="https://github.com/Qiskit/qiskit/tree/stable/2.1/qiskit/circuit/instruction.py#L286-L291" signature="is_parameterized()">
    Return whether the `Instruction` contains [compile-time parameters](circuit#circuit-compile-time-parameters).
  </Function>

  ### power

  <Function id="qiskit.circuit.library.RZXGate.power" github="https://github.com/Qiskit/qiskit/tree/stable/2.1/qiskit/circuit/library/standard_gates/rzx.py#L204-L206" signature="power(exponent, annotated=False)">
  ...
  <Function id="qiskit.circuit.library.RZXGate.repeat" github="https://github.com/Qiskit/qiskit/tree/stable/2.1/qiskit/circuit/instruction.py#L494-L524" signature="repeat(n)">
  ...
  <Function id="qiskit.circuit.library.RZXGate.reverse_ops" github="https://github.com/Qiskit/qiskit/tree/stable/2.1/qiskit/circuit/instruction.py#L348-L372" signature="reverse_ops()">
  ...
  <Function id="qiskit.circuit.library.RZXGate.soft_compare" github="https://github.com/Qiskit/qiskit/tree/stable/2.1/qiskit/circuit/instruction.py#L217-L257" signature="soft_compare(other)">
  ...
  <Function id="qiskit.circuit.library.RZXGate.to_matrix" github="https://github.com/Qiskit/qiskit/tree/stable/2.1/qiskit/circuit/gate.py#L49-L61" signature="to_matrix()">
  ...
  <Function id="qiskit.circuit.library.RZXGate.to_mutable" github="https://github.com/Qiskit/qiskit/tree/stable/2.1/qiskit/circuit/instruction.py#L146-L154" signature="to_mutable()">
  ...
  <Function id="qiskit.circuit.library.RZXGate.validate_parameter" github="https://github.com/Qiskit/qiskit/tree/stable/2.1/qiskit/circuit/gate.py#L247-L261" signature="validate_parameter(parameter)">
