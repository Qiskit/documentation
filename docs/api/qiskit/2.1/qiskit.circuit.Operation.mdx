---
title: Operation (v2.1)
description: API reference for qiskit.circuit.Operation in qiskit v2.1
...
<Class id="qiskit.circuit.Operation" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/2.1/qiskit/circuit/operation.py#L18-L68" signature="qiskit.circuit.Operation" modifiers="class">
  ...
  **Example**
  ...
  ![Circuit diagram output by the previous code.](/docs/images/api/qiskit/2.1/qiskit-circuit-Operation-1.avif)
