---
title: plot_bloch_multivector (v2.1)
description: API reference for qiskit.visualization.plot_bloch_multivector in qiskit v2.1
...
<Function id="qiskit.visualization.plot_bloch_multivector" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/2.1/qiskit/visualization/state_visualization.py#L257-L369" signature="qiskit.visualization.plot_bloch_multivector(state, title='', figsize=None, *, reverse_bits=False, filename=None, font_size=None, title_font_size=None, title_pad=1)">
  ...
  **Examples**
  ...
  ![Output from the previous code.](/docs/images/api/qiskit/2.1/qiskit-visualization-plot_bloch_multivector-1.avif)
  ...
  ![Output from the previous code.](/docs/images/api/qiskit/2.1/qiskit-visualization-plot_bloch_multivector-2.avif)
</Function>
