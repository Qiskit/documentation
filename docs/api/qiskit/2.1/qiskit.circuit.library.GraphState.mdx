---
title: GraphState (v2.1)
description: API reference for qiskit.circuit.library.GraphState in qiskit v2.1
...
$$
  ...
  **Reference Circuit:**
  ...
  ![Diagram illustrating the previously described circuit.](/docs/images/api/qiskit/2.1/qiskit-circuit-library-GraphState-1.avif)
