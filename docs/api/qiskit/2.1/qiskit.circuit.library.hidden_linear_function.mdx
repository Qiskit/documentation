---
title: hidden_linear_function (v2.1)
description: API reference for qiskit.circuit.library.hidden_linear_function in qiskit v2.1
...
$$
  ...
  **Reference Circuit:**
  ...
  ![Circuit diagram output by the previous code.](/docs/images/api/qiskit/2.1/qiskit-circuit-library-hidden_linear_function-1.avif)
