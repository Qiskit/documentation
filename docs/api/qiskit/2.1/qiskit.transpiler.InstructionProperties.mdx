---
title: InstructionProperties (v2.1)
description: API reference for qiskit.transpiler.InstructionProperties in qiskit v2.1
...
<Class id="qiskit.transpiler.InstructionProperties" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/2.1/qiskit/transpiler/target.py#L53-L90" signature="qiskit.transpiler.InstructionProperties(duration=None, error=None, *args, **kwargs)" modifiers="class">
