---
title: qpy (v2.1)
description: API reference for qiskit.qpy in qiskit v2.1
...
<Function id="qiskit.qpy.load" github="https://github.com/Qiskit/qiskit/tree/stable/2.1/qiskit/qpy/interface.py#L214-L354" signature="qiskit.qpy.load(file_obj, metadata_deserializer=None, annotation_factories=None)">
...
<Function id="qiskit.qpy.dump" github="https://github.com/Qiskit/qiskit/tree/stable/2.1/qiskit/qpy/interface.py#L78-L211" signature="qiskit.qpy.dump(programs, file_obj, metadata_serializer=None, use_symengine=False, version=15, annotation_factories=None)">
...
<Function id="qiskit.qpy.get_qpy_version" github="https://github.com/Qiskit/qiskit/tree/stable/2.1/qiskit/qpy/interface.py#L357-L384" signature="qiskit.qpy.get_qpy_version(file_obj)">
...
<Class id="qiskit.qpy.QpyError" github="https://github.com/Qiskit/qiskit/tree/stable/2.1/qiskit/qpy/exceptions.py#L18-L28" signature="qiskit.qpy.QpyError(*message)" modifiers="exception">
...
<Class id="qiskit.qpy.UnsupportedFeatureForVersion" github="https://github.com/Qiskit/qiskit/tree/stable/2.1/qiskit/qpy/exceptions.py#L31-L48" signature="qiskit.qpy.UnsupportedFeatureForVersion(feature, required, target)" modifiers="exception">
...
<Class id="qiskit.qpy.QPYLoadingDeprecatedFeatureWarning" github="https://github.com/Qiskit/qiskit/tree/stable/2.1/qiskit/qpy/exceptions.py#L51-L53" signature="qiskit.qpy.QPYLoadingDeprecatedFeatureWarning" modifiers="exception">
...
The file header is immediately followed by the circuit payloads. Each individual circuit is composed of the following parts in order from top to bottom:
