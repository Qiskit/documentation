---
title: preset_passmanagers (v2.1)
description: API reference for qiskit.transpiler.preset_passmanagers in qiskit v2.1
...
<Function id="qiskit.transpiler.preset_passmanagers.level_3_pass_manager" github="https://github.com/Qiskit/qiskit/tree/stable/2.1/qiskit/transpiler/preset_passmanagers/level3.py#L27-L109" signature="qiskit.transpiler.preset_passmanagers.level_3_pass_manager(pass_manager_config)">
