---
title: FlowControllerLinear (v2.1)
description: API reference for qiskit.passmanager.FlowControllerLinear in qiskit v2.1
...
<Class id="qiskit.passmanager.FlowControllerLinear" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/2.1/qiskit/passmanager/flow_controllers.py#L27-L49" signature="qiskit.passmanager.FlowControllerLinear(tasks=(), *, options=None)" modifiers="class">
  ...
  *   **tasks** (*Task | Iterable\[Task]*) –
  ...
  <Function id="qiskit.passmanager.FlowControllerLinear.execute" github="https://github.com/Qiskit/qiskit/tree/stable/2.1/qiskit/passmanager/base_tasks.py#L202-L230" signature="execute(passmanager_ir, state, callback=None)">
  ...
  <Function id="qiskit.passmanager.FlowControllerLinear.iter_tasks" github="https://github.com/Qiskit/qiskit/tree/stable/2.1/qiskit/passmanager/flow_controllers.py#L47-L49" signature="iter_tasks(state)">
