---
title: TranspileLayout (v2.1)
description: API reference for qiskit.transpiler.TranspileLayout in qiskit v2.1
...
<Class id="qiskit.transpiler.TranspileLayout" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/2.1/qiskit/transpiler/layout.py#L442-L740" signature="qiskit.transpiler.TranspileLayout(initial_layout, input_qubit_mapping, final_layout=None, _input_qubit_count=None, _output_qubit_list=None)" modifiers="class">
  ...
  ![Circuit diagram output by the previous code.](/docs/images/api/qiskit/2.1/qiskit-transpiler-TranspileLayout-1.avif)
  ...
  ![Circuit diagram output by the previous code.](/docs/images/api/qiskit/2.1/qiskit-transpiler-TranspileLayout-2.avif)
  ...
  ![Circuit diagram output by the previous code.](/docs/images/api/qiskit/2.1/qiskit-transpiler-TranspileLayout-3.avif)
  ...
  *   **\_output\_qubit\_list** (*List\[*[*Qubit*](circuit#qiskit.circuit.Qubit "qiskit.circuit.Qubit")*] | None*) –
  ...
  <Function id="qiskit.transpiler.TranspileLayout.final_index_layout" github="https://github.com/Qiskit/qiskit/tree/stable/2.1/qiskit/transpiler/layout.py#L624-L692" signature="final_index_layout(filter_ancillas=True)">
  ...
  <Function id="qiskit.transpiler.TranspileLayout.final_virtual_layout" github="https://github.com/Qiskit/qiskit/tree/stable/2.1/qiskit/transpiler/layout.py#L694-L740" signature="final_virtual_layout(filter_ancillas=True)">
  ...
  <Function id="qiskit.transpiler.TranspileLayout.initial_index_layout" github="https://github.com/Qiskit/qiskit/tree/stable/2.1/qiskit/transpiler/layout.py#L584-L606" signature="initial_index_layout(filter_ancillas=False)">
  ...
  <Function id="qiskit.transpiler.TranspileLayout.initial_virtual_layout" github="https://github.com/Qiskit/qiskit/tree/stable/2.1/qiskit/transpiler/layout.py#L559-L582" signature="initial_virtual_layout(filter_ancillas=False)">
  ...
  <Function id="qiskit.transpiler.TranspileLayout.routing_permutation" github="https://github.com/Qiskit/qiskit/tree/stable/2.1/qiskit/transpiler/layout.py#L608-L622" signature="routing_permutation()">
