---
title: LookaheadSwap (v2.1)
description: API reference for qiskit.transpiler.passes.LookaheadSwap in qiskit v2.1
...
<Class id="qiskit.transpiler.passes.LookaheadSwap" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/2.1/qiskit/transpiler/passes/routing/lookahead_swap.py#L50-L191" signature="qiskit.transpiler.passes.LookaheadSwap(*args, **kwargs)" modifiers="class">
  ...
  *   **fake\_run** ([*bool*](https://docs.python.org/3/library/functions.html#bool)) – if true, it will only pretend to do routing, i.e., no swap is effectively added.
  ...
  <Function id="qiskit.transpiler.passes.LookaheadSwap.run" github="https://github.com/Qiskit/qiskit/tree/stable/2.1/qiskit/transpiler/passes/routing/lookahead_swap.py#L108-L191" signature="run(dag)">
