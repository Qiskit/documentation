---
title: high_level_synthesis_plugin_names (v2.1)
description: API reference for qiskit.transpiler.passes.synthesis.plugin.high_level_synthesis_plugin_names in qiskit v2.1
...
<Function id="qiskit.transpiler.passes.synthesis.plugin.high_level_synthesis_plugin_names" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/2.1/qiskit/transpiler/passes/synthesis/plugin.py#L726-L742" signature="qiskit.transpiler.passes.synthesis.plugin.high_level_synthesis_plugin_names(op_name)">
