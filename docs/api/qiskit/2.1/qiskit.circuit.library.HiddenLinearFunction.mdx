---
title: HiddenLinearFunction (v2.1)
description: API reference for qiskit.circuit.library.HiddenLinearFunction in qiskit v2.1
...
$$
  ...
  **Reference Circuit:**
  ...
  > ![Diagram illustrating the previously described circuit.](/docs/images/api/qiskit/2.1/qiskit-circuit-library-HiddenLinearFunction-1.avif)
