---
title: PauliLindbladMap (v2.1)
description: API reference for qiskit.quantum_info.PauliLindbladMap in qiskit v2.1
...
<Class id="qiskit.quantum_info.PauliLindbladMap" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/2.1/qiskit/quantum_info/__init__.py" signature="qiskit.quantum_info.PauliLindbladMap" modifiers="class">
...
$$
  ...
  <Class id="qiskit.quantum_info.PauliLindbladMap.GeneratorTerm" github="https://github.com/Qiskit/qiskit/tree/stable/2.1/qiskit/quantum_info/__init__.py" signature="GeneratorTerm" modifiers="class">
    Bases: [`object`](https://docs.python.org/3/library/functions.html#object)
