---
title: visualization (v2.1)
description: API reference for qiskit.visualization in qiskit v2.1
...
![Output from the previous code.](/docs/images/api/qiskit/2.1/visualization-1.avif)
...
![Output from the previous code.](/docs/images/api/qiskit/2.1/visualization-2.avif)
...
![Output from the previous code.](/docs/images/api/qiskit/2.1/visualization-3.avif)
...
![Output from the previous code.](/docs/images/api/qiskit/2.1/visualization-4.avif)
...
![Output from the previous code.](/docs/images/api/qiskit/2.1/visualization-5.avif)
...
![Output from the previous code.](/docs/images/api/qiskit/2.1/visualization-6.avif)
...
<Class id="qiskit.visualization.VisualizationError" github="https://github.com/Qiskit/qiskit/tree/stable/2.1/qiskit/visualization/exceptions.py#L18-L21" signature="qiskit.visualization.VisualizationError(*message)" modifiers="exception">
