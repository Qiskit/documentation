---
title: phase_estimation (v2.1)
description: API reference for qiskit.circuit.library.phase_estimation in qiskit v2.1
...
$$
  ...
  **Reference Circuit:**
  ...
  ![Circuit diagram output by the previous code.](/docs/images/api/qiskit/2.1/qiskit-circuit-library-phase_estimation-1.avif)
