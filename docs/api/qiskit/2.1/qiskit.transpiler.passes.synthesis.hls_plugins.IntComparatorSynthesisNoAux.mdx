---
title: IntComparatorSynthesisNoAux (v2.1)
description: API reference for qiskit.transpiler.passes.synthesis.hls_plugins.IntComparatorSynthesisNoAux in qiskit v2.1
