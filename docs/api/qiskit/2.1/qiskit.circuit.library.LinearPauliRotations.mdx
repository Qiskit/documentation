---
title: LinearPauliRotations (v2.1)
description: API reference for qiskit.circuit.library.LinearPauliRotations in qiskit v2.1
...
<Class id="qiskit.circuit.library.LinearPauliRotations" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/2.1/qiskit/circuit/library/arithmetic/linear_pauli_rotations.py#L25-L169" signature="qiskit.circuit.library.LinearPauliRotations(num_state_qubits=None, slope=1, offset=0, basis='Y', name='LinRot')" modifiers="class">
