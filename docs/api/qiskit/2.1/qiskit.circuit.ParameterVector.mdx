---
title: ParameterVector (v2.1)
description: API reference for qiskit.circuit.ParameterVector in qiskit v2.1
...
<Class id="qiskit.circuit.ParameterVector" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/2.1/qiskit/circuit/parametervector.py#L55-L140" signature="qiskit.circuit.ParameterVector(name, length=0)" modifiers="class">
  ...
  This class fulfill the [`collections.abc.Sequence`](https://docs.python.org/3/library/collections.abc.html#collections.abc.Sequence) interface.
  ...
  <Function id="qiskit.circuit.ParameterVector.index" github="https://github.com/Qiskit/qiskit/tree/stable/2.1/qiskit/circuit/parametervector.py#L91-L95" signature="index(value)">
  ...
  <Function id="qiskit.circuit.ParameterVector.resize" github="https://github.com/Qiskit/qiskit/tree/stable/2.1/qiskit/circuit/parametervector.py#L112-L140" signature="resize(length)">
