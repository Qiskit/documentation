---
title: PropertySet (v2.1)
description: API reference for qiskit.passmanager.PropertySet in qiskit v2.1
...
<Class id="qiskit.passmanager.PropertySet" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/2.1/qiskit/passmanager/compilation_status.py#L20-L24" signature="qiskit.passmanager.PropertySet" modifiers="class">
