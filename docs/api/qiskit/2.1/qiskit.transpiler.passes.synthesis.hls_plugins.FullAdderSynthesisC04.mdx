---
title: FullAdderSynthesisC04 (v2.1)
description: API reference for qiskit.transpiler.passes.synthesis.hls_plugins.FullAdderSynthesisC04 in qiskit v2.1
...
<Class id="qiskit.transpiler.passes.synthesis.hls_plugins.FullAdderSynthesisC04" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/2.1/qiskit/transpiler/passes/synthesis/hls_plugins.py#L1831-L1844" signature="qiskit.transpiler.passes.synthesis.hls_plugins.FullAdderSynthesisC04" modifiers="class">
  ...
  <Function id="qiskit.transpiler.passes.synthesis.hls_plugins.FullAdderSynthesisC04.run" github="https://github.com/Qiskit/qiskit/tree/stable/2.1/qiskit/transpiler/passes/synthesis/hls_plugins.py#L1840-L1844" signature="run(high_level_object, coupling_map=None, target=None, qubits=None, **options)">
