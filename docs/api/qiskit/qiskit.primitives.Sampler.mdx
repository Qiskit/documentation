...
<Class id="qiskit.primitives.Sampler" github="https://github.com/Qiskit/qiskit/tree/stable/1.0/qiskit/primitives/sampler.py#L38-L155" signature="qiskit.primitives.Sampler(*, options=None)">
