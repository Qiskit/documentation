...
<Class id="qiskit.circuit.library.QuadraticForm" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/circuit/library/arithmetic/quadratic_form.py#L30-L193" signature="qiskit.circuit.library.QuadraticForm(num_result_qubits=None, quadratic=None, linear=None, offset=None, little_endian=True)" modifiers="class">
...
$$
  ...
  *   [**ValueError**](https://docs.python.org/3/library/exceptions.html#ValueError) – If `num_result_qubits` is unspecified but cannot be determined because some values of the quadratic form are parameterized.
  ...
  <Attribute id="qiskit.circuit.library.QuadraticForm.name" name="name" headingLevel={3}>
    <AttributeTypeHint>
  ...
  <Function id="qiskit.circuit.library.QuadraticForm.required_result_qubits" github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/circuit/library/arithmetic/quadratic_form.py#L176-L193" signature="required_result_qubits(quadratic, linear, offset)" modifiers="static">
