...
<Class id="qiskit.circuit.library.SXdgGate" github="https://github.com/qiskit/qiskit/tree/stable/1.0/qiskit/circuit/library/standard_gates/sx.py" signature="qiskit.circuit.library.SXdgGate(*args, _force_mutable=False, **kwargs)">
...
$$
  ...
  <Function id="qiskit.circuit.library.SXdgGate.inverse" name="inverse" signature="inverse(annotated=False)">
