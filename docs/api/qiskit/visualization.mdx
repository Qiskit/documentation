...
![Output from the previous code.](/images/api/qiskit/visualization-1.png)
...
![Output from the previous code.](/images/api/qiskit/visualization-2.png)
...
![Output from the previous code.](/images/api/qiskit/visualization-3.png)
...
![Output from the previous code.](/images/api/qiskit/visualization-4.png)
...
![Output from the previous code.](/images/api/qiskit/visualization-5.png)
...
![Output from the previous code.](/images/api/qiskit/visualization-6.png)
