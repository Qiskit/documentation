---
title: RecursiveMinimumEigenOptimizationResult (v0.30)
description: API reference for qiskit.optimization.algorithms.RecursiveMinimumEigenOptimizationResult in qiskit v0.30
