...
<Function id="qiskit.quantum_info.hellinger_distance" name="hellinger_distance" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/quantum_info/analysis/distance.py" signature="hellinger_distance(dist_p, dist_q)">
