...
<Class id="qiskit.optimization.problems.QuadraticConstraint" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/optimization/problems/quadratic_constraint.py" signature="QuadraticConstraint(quadratic_program, name, linear, quadratic, sense, rhs)">
  ...
  *   **rhs** (`float`) – The right-hand-side of the constraint.
  ...
  <Attribute id="qiskit.optimization.problems.QuadraticConstraint.linear" name="linear">
  ...
  <Attribute id="qiskit.optimization.problems.QuadraticConstraint.name" name="name">
  ...
  <Attribute id="qiskit.optimization.problems.QuadraticConstraint.quadratic" name="quadratic">
  ...
  <Attribute id="qiskit.optimization.problems.QuadraticConstraint.quadratic_program" name="quadratic_program">
  ...
  <Attribute id="qiskit.optimization.problems.QuadraticConstraint.rhs" name="rhs">
