...
<Class id="qiskit.transpiler.InstructionDurations" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/transpiler/instruction_durations.py" signature="InstructionDurations(instruction_durations=None, dt=None)">
  Bases: `object`
  ...
  <Function id="qiskit.transpiler.InstructionDurations.get" name="get" signature="InstructionDurations.get(inst, qubits, unit='dt')">
