...
<Class id="qiskit.aqua.components.uncertainty_models.BernoulliDistribution" github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/aqua/components/uncertainty_models/bernoulli_distribution.py" signature="BernoulliDistribution(p, low=0, high=1)">
  ...
  *   **high** (`float`) – High value
  ...
  <Function id="qiskit.aqua.components.uncertainty_models.BernoulliDistribution.pdf_to_probabilities" signature="static BernoulliDistribution.pdf_to_probabilities(pdf, low, high, num_values)">
