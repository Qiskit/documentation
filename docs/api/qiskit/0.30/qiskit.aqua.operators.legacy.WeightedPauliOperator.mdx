...
<Class id="qiskit.aqua.operators.legacy.WeightedPauliOperator" github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/aqua/operators/legacy/weighted_pauli_operator.py" signature="WeightedPauliOperator(paulis, basis=None, z2_symmetries=None, atol=1e-12, name=None)">
  ...
  *   **name** (`Optional`\[`str`]) – the name of operator.
  ...
  <Function id="qiskit.aqua.operators.legacy.WeightedPauliOperator.from_dict" signature="classmethod WeightedPauliOperator.from_dict(dictionary, before_04=False)">
  ...
  <Function id="qiskit.aqua.operators.legacy.WeightedPauliOperator.from_file" signature="classmethod WeightedPauliOperator.from_file(file_name, before_04=False)">
  ...
  <Function id="qiskit.aqua.operators.legacy.WeightedPauliOperator.from_list" signature="classmethod WeightedPauliOperator.from_list(paulis, weights=None, name=None)">
