...
<Class id="qiskit.providers.ibmq.runtime.UserMessenger" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-ibmq-provider/tree/stable/0.16/qiskit/providers/ibmq/runtime/program/user_messenger.py" signature="UserMessenger">
  Bases: `object`
  ...
  <Function id="qiskit.providers.ibmq.runtime.UserMessenger.publish" name="publish" signature="UserMessenger.publish(message, encoder=<class 'qiskit.providers.ibmq.runtime.utils.RuntimeEncoder'>, final=False)">
    Publish message.
