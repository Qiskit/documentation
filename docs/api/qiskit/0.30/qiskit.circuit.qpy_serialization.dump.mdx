---
title: dump (v0.30)
description: API reference for qiskit.circuit.qpy_serialization.dump in qiskit v0.30
...
<Function id="qiskit.circuit.qpy_serialization.dump" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/circuit/qpy_serialization.py" signature="dump(circuits, file_obj)">
