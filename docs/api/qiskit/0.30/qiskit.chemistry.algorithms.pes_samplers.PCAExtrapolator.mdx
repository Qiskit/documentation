...
<Class id="qiskit.chemistry.algorithms.pes_samplers.PCAExtrapolator" github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/chemistry/algorithms/pes_samplers/extrapolator.py" signature="PCAExtrapolator(extrapolator=None, kernel=None, window=2)">
  ...
  **Raises**
  ...
  <Function id="qiskit.chemistry.algorithms.pes_samplers.PCAExtrapolator.extrapolate" name="extrapolate" signature="PCAExtrapolator.extrapolate(points, param_dict)">
  ...
  <Function id="qiskit.chemistry.algorithms.pes_samplers.PCAExtrapolator.factory" name="factory" signature="static PCAExtrapolator.factory(mode, **kwargs)">
