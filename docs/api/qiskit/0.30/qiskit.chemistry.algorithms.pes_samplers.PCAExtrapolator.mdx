---
title: PCAExtrapolator (v0.30)
description: API reference for qiskit.chemistry.algorithms.pes_samplers.PCAExtrapolator in qiskit v0.30
...
<Class id="qiskit.chemistry.algorithms.pes_samplers.PCAExtrapolator" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/chemistry/algorithms/pes_samplers/extrapolator.py" signature="PCAExtrapolator(extrapolator=None, kernel=None, window=2)" modifiers="class">
  ...
  **Raises**
  ...
  <span id="qiskit-chemistry-algorithms-pes-samplers-pcaextrapolator-extrapolate" />

  ### extrapolate

  <Function id="qiskit.chemistry.algorithms.pes_samplers.PCAExtrapolator.extrapolate" signature="PCAExtrapolator.extrapolate(points, param_dict)">
  ...
  <span id="qiskit-chemistry-algorithms-pes-samplers-pcaextrapolator-factory" />

  ### factory

  <Function id="qiskit.chemistry.algorithms.pes_samplers.PCAExtrapolator.factory" signature="PCAExtrapolator.factory(mode, **kwargs)" modifiers="static">
