...
<Class id="qiskit.chemistry.QiskitChemistryError" github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/chemistry/qiskit_chemistry_error.py" signature="QiskitChemistryError(*message)">
