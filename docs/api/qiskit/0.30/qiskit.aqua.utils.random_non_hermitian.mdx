...
<Function id="qiskit.aqua.utils.random_non_hermitian" name="random_non_hermitian" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/aqua/utils/random_matrix_generator.py" signature="random_non_hermitian(N, M=None, sings=None, K=None, srange=None, sparsity=None, trunc=None)">
