---
title: Counts (v0.30)
description: API reference for qiskit.result.Counts in qiskit v0.30
...
<Class id="qiskit.result.Counts" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/result/counts.py" signature="Counts(data, time_taken=None, creg_sizes=None, memory_slots=None)" modifiers="class">
  Bases: `dict`
  ...
  *   **QiskitError** – If a dit string key is input with creg\_sizes and/or memory\_slots
  ...
  <Function id="qiskit.result.Counts.popitem" signature="Counts.popitem() → (k, v), remove and return some (key, value) pair as a">
