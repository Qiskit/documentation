...
<Class id="qiskit.aqua.circuits.ESOP" github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/aqua/circuits/boolean_logical_circuits.py" signature="ESOP(ast, num_vars=None)">
  ...
  **Raises**
  ...
  <Function id="qiskit.aqua.circuits.ESOP.compute_num_ancillae" name="compute_num_ancillae" signature="ESOP.compute_num_ancillae(mct_mode='basic')">
