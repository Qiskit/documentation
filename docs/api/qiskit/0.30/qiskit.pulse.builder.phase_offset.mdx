---
title: phase_offset (v0.30)
description: API reference for qiskit.pulse.builder.phase_offset in qiskit v0.30
...
<Function id="qiskit.pulse.builder.phase_offset" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/pulse/builder.py" signature="phase_offset(phase, *channels)">
