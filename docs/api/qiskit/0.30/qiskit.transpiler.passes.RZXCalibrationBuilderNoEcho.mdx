...
<Class id="qiskit.transpiler.passes.RZXCalibrationBuilderNoEcho" github="https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/transpiler/passes/scheduling/calibration_creators.py" signature="RZXCalibrationBuilderNoEcho(backend)">
  ...
  **QiskitError** – if open pulse is not supported by the backend.
  ...
  <Function id="qiskit.transpiler.passes.RZXCalibrationBuilderNoEcho.get_calibration" name="get_calibration" signature="RZXCalibrationBuilderNoEcho.get_calibration(params, qubits)">
  ...
  <Function id="qiskit.transpiler.passes.RZXCalibrationBuilderNoEcho.supported" name="supported" signature="RZXCalibrationBuilderNoEcho.supported(node_op)">
    **Parameters**
