...
<Class id="qiskit.aqua.operators.gradients.DerivativeBase" github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/aqua/operators/gradients/derivative_base.py" signature="DerivativeBase">
  ...
  <Function id="qiskit.aqua.operators.gradients.DerivativeBase.convert" name="convert" signature="abstract DerivativeBase.convert(operator, params=None)">
    **Parameters**
  ...
  <Function id="qiskit.aqua.operators.gradients.DerivativeBase.gradient_wrapper" name="gradient_wrapper" signature="DerivativeBase.gradient_wrapper(operator, bind_params, grad_params=None, backend=None)">
  ...
  <Function id="qiskit.aqua.operators.gradients.DerivativeBase.parameter_expression_grad" name="parameter_expression_grad" signature="static DerivativeBase.parameter_expression_grad(param_expr, param)">
