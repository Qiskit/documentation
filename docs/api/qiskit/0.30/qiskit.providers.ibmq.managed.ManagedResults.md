...
`ManagedResults.combine_results()` [GitHub](https://github.com/qiskit/qiskit-ibmq-provider/tree/stable/0.16/qiskit/providers/ibmq/managed/managedresults.py "view source code")
...
`ManagedResults.data(experiment)` [GitHub](https://github.com/qiskit/qiskit-ibmq-provider/tree/stable/0.16/qiskit/providers/ibmq/managed/managedresults.py "view source code")
...
`ManagedResults.get_counts(experiment)` [GitHub](https://github.com/qiskit/qiskit-ibmq-provider/tree/stable/0.16/qiskit/providers/ibmq/managed/managedresults.py "view source code")
...
`ManagedResults.get_memory(experiment)` [GitHub](https://github.com/qiskit/qiskit-ibmq-provider/tree/stable/0.16/qiskit/providers/ibmq/managed/managedresults.py "view source code")
...
`ManagedResults.get_statevector(experiment, decimals=None)` [GitHub](https://github.com/qiskit/qiskit-ibmq-provider/tree/stable/0.16/qiskit/providers/ibmq/managed/managedresults.py "view source code")
...
`ManagedResults.get_unitary(experiment, decimals=None)` [GitHub](https://github.com/qiskit/qiskit-ibmq-provider/tree/stable/0.16/qiskit/providers/ibmq/managed/managedresults.py "view source code")
