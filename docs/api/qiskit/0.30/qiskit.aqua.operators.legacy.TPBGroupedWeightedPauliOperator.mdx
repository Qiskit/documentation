...
<Class id="qiskit.aqua.operators.legacy.TPBGroupedWeightedPauliOperator" github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/aqua/operators/legacy/tpb_grouped_weighted_pauli_operator.py" signature="TPBGroupedWeightedPauliOperator(paulis, basis, z2_symmetries=None, atol=1e-12, name=None, grouping_func=None, kwargs=None)">
  ...
  *   **kwargs** (*dict*) – Optional parameters for grouping function call
  ...
  <Function id="qiskit.aqua.operators.legacy.TPBGroupedWeightedPauliOperator.from_dict" signature="classmethod TPBGroupedWeightedPauliOperator.from_dict(dictionary, before_04=False)">
  ...
  <Function id="qiskit.aqua.operators.legacy.TPBGroupedWeightedPauliOperator.from_file" signature="classmethod TPBGroupedWeightedPauliOperator.from_file(file_name, before_04=False)">
  ...
  <Function id="qiskit.aqua.operators.legacy.TPBGroupedWeightedPauliOperator.from_list" signature="classmethod TPBGroupedWeightedPauliOperator.from_list(paulis, weights=None, name=None)">
  ...
  <Function id="qiskit.aqua.operators.legacy.TPBGroupedWeightedPauliOperator.sorted_grouping" signature="classmethod TPBGroupedWeightedPauliOperator.sorted_grouping(weighted_pauli_operator, method='largest-degree')">
  ...
  <Function id="qiskit.aqua.operators.legacy.TPBGroupedWeightedPauliOperator.unsorted_grouping" signature="classmethod TPBGroupedWeightedPauliOperator.unsorted_grouping(weighted_pauli_operator)">
