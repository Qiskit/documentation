...
<Class id="qiskit.providers.ibmq.IBMQBackendValueError" github="https://github.com/qiskit/qiskit-ibmq-provider/tree/stable/0.16/qiskit/providers/ibmq/exceptions.py" signature="IBMQBackendValueError(*message)">
