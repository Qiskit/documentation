...
<Class id="qiskit.providers.ibmq.experiment.IBMExperimentEntryExists" github="https://github.com/qiskit/qiskit-ibmq-provider/tree/stable/0.16/qiskit/providers/ibmq/experiment/exceptions.py" signature="IBMExperimentEntryExists(*message)">
