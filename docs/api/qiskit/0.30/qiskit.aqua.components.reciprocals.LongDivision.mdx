...
<Class id="qiskit.aqua.components.reciprocals.LongDivision" github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/aqua/components/reciprocals/long_division.py" signature="LongDivision(scale=0, precision=None, negative_evals=False, evo_time=None, lambda_min=None)">
  ...
  *   **lambda\_min** (`Optional`\[`float`]) – The smallest expected eigenvalue
  ...
  <Function id="qiskit.aqua.components.reciprocals.LongDivision.construct_circuit" name="construct_circuit" signature="LongDivision.construct_circuit(mode, register=None, circuit=None)">
  ...
  <Function id="qiskit.aqua.components.reciprocals.LongDivision.sv_to_resvec" name="sv_to_resvec" signature="LongDivision.sv_to_resvec(statevector, num_q)">
