---
title: thermal_relaxation_error (v0.30)
description: API reference for qiskit.providers.aer.noise.thermal_relaxation_error in qiskit v0.30
...
<Function id="qiskit.providers.aer.noise.thermal_relaxation_error" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-aer/tree/stable/0.9/qiskit/providers/aer/noise/errors/standard_errors.py" signature="thermal_relaxation_error(t1, t2, time, excited_state_population=0)">
