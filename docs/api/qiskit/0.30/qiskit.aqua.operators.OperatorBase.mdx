...
<Class id="qiskit.aqua.operators.OperatorBase" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/aqua/operators/operator_base.py" signature="OperatorBase">
  Bases: `abc.ABC`
  ...
  <Function id="qiskit.aqua.operators.OperatorBase.add" name="add" signature="abstract OperatorBase.add(other)">
  ...
  <Function id="qiskit.aqua.operators.OperatorBase.adjoint" name="adjoint" signature="abstract OperatorBase.adjoint()">
  ...
  <Function id="qiskit.aqua.operators.OperatorBase.assign_parameters" name="assign_parameters" signature="abstract OperatorBase.assign_parameters(param_dict)">
  ...
  <Function id="qiskit.aqua.operators.OperatorBase.bind_parameters" name="bind_parameters" signature="OperatorBase.bind_parameters(param_dict)">
  ...
  <Function id="qiskit.aqua.operators.OperatorBase.compose" name="compose" signature="abstract OperatorBase.compose(other, permutation=None, front=False)">
  ...
  <Function id="qiskit.aqua.operators.OperatorBase.equals" name="equals" signature="abstract OperatorBase.equals(other)">
  ...
  <Function id="qiskit.aqua.operators.OperatorBase.eval" name="eval" signature="abstract OperatorBase.eval(front=None)">
  ...
  <Function id="qiskit.aqua.operators.OperatorBase.mul" name="mul" signature="abstract OperatorBase.mul(scalar)">
  ...
  <Function id="qiskit.aqua.operators.OperatorBase.neg" name="neg" signature="OperatorBase.neg()">
  ...
  <Function id="qiskit.aqua.operators.OperatorBase.permute" name="permute" signature="abstract OperatorBase.permute(permutation)">
  ...
  <Function id="qiskit.aqua.operators.OperatorBase.power" name="power" signature="abstract OperatorBase.power(exponent)">
  ...
  <Function id="qiskit.aqua.operators.OperatorBase.primitive_strings" name="primitive_strings" signature="abstract OperatorBase.primitive_strings()">
  ...
  <Function id="qiskit.aqua.operators.OperatorBase.reduce" name="reduce" signature="abstract OperatorBase.reduce()">
  ...
  <Function id="qiskit.aqua.operators.OperatorBase.tensor" name="tensor" signature="abstract OperatorBase.tensor(other)">
  ...
  <Function id="qiskit.aqua.operators.OperatorBase.tensorpower" name="tensorpower" signature="abstract OperatorBase.tensorpower(other)">
  ...
  <Function id="qiskit.aqua.operators.OperatorBase.to_legacy_op" name="to_legacy_op" signature="abstract OperatorBase.to_legacy_op(massive=False)">
  ...
  <Function id="qiskit.aqua.operators.OperatorBase.to_matrix" name="to_matrix" signature="abstract OperatorBase.to_matrix(massive=False)">
  ...
  <Attribute id="qiskit.aqua.operators.OperatorBase.ENABLE_DEPRECATION" name="ENABLE_DEPRECATION" attributeValue="= True" />

  ### INDENTATION

  <Attribute id="qiskit.aqua.operators.OperatorBase.INDENTATION" name="INDENTATION" attributeValue="= '  '" />

  ### num\_qubits

  <Attribute id="qiskit.aqua.operators.OperatorBase.num_qubits" name="num_qubits">
  ...
  <Attribute id="qiskit.aqua.operators.OperatorBase.parameters" name="parameters">
