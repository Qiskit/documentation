---
title: QFIBase (v0.30)
description: API reference for qiskit.aqua.operators.gradients.QFIBase in qiskit v0.30
...
<Class id="qiskit.aqua.operators.gradients.QFIBase" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/aqua/operators/gradients/qfi_base.py" signature="QFIBase(qfi_method='lin_comb_full')" modifiers="class">
  ...
  **ValueError** – if `qfi_method` is neither a `CircuitQFI` object nor one of the predefined strings.
  ...
  <Function id="qiskit.aqua.operators.gradients.QFIBase.convert" signature="QFIBase.convert(operator, params=None)" modifiers="abstract">
    **Parameters**
  ...
  <span id="qiskit-aqua-operators-gradients-qfibase-gradient-wrapper" />

  ### gradient\_wrapper

  <Function id="qiskit.aqua.operators.gradients.QFIBase.gradient_wrapper" signature="QFIBase.gradient_wrapper(operator, bind_params, grad_params=None, backend=None)">
  ...
  <span id="qiskit-aqua-operators-gradients-qfibase-parameter-expression-grad" />

  ### parameter\_expression\_grad

  <Function id="qiskit.aqua.operators.gradients.QFIBase.parameter_expression_grad" signature="QFIBase.parameter_expression_grad(param_expr, param)" modifiers="static">
