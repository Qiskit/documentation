---
title: UnivariatePiecewiseLinearObjective (v0.30)
description: API reference for qiskit.aqua.components.uncertainty_problems.UnivariatePiecewiseLinearObjective in qiskit v0.30
