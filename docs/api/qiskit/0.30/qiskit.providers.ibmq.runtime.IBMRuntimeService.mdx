...
<Class id="qiskit.providers.ibmq.runtime.IBMRuntimeService" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-ibmq-provider/tree/stable/0.16/qiskit/providers/ibmq/runtime/ibm_runtime_service.py" signature="IBMRuntimeService(provider)">
  Bases: `object`
  ...
  **provider** (`AccountProvider`) – IBM Quantum account provider.
  ...
  <Function id="qiskit.providers.ibmq.runtime.IBMRuntimeService.jobs" name="jobs" signature="IBMRuntimeService.jobs(limit=10, skip=0, pending=None)">
  ...
  <Function id="qiskit.providers.ibmq.runtime.IBMRuntimeService.pprint_programs" name="pprint_programs" signature="IBMRuntimeService.pprint_programs(refresh=False)">
  ...
  <Function id="qiskit.providers.ibmq.runtime.IBMRuntimeService.programs" name="programs" signature="IBMRuntimeService.programs(refresh=False)">
  ...
  <Function id="qiskit.providers.ibmq.runtime.IBMRuntimeService.run" name="run" signature="IBMRuntimeService.run(program_id, options, inputs, callback=None, result_decoder=None)">
  ...
  <Function id="qiskit.providers.ibmq.runtime.IBMRuntimeService.upload_program" name="upload_program" signature="IBMRuntimeService.upload_program(data, metadata=None, name=None, max_execution_time=None, description=None, version=None, backend_requirements=None, parameters=None, return_values=None, interim_results=None)">
