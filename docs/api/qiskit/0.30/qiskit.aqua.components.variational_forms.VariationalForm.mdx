---
title: VariationalForm (v0.30)
description: API reference for qiskit.aqua.components.variational_forms.VariationalForm in qiskit v0.30
...
<Class id="qiskit.aqua.components.variational_forms.VariationalForm" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/aqua/components/variational_forms/variational_form.py" signature="VariationalForm" modifiers="class">
  ...
  <span id="qiskit-aqua-components-variational-forms-variationalform-construct-circuit" />
  ...
  <span id="qiskit-aqua-components-variational-forms-variationalform-get-entangler-map" />
  ...
  <span id="qiskit-aqua-components-variational-forms-variationalform-validate-entangler-map" />
