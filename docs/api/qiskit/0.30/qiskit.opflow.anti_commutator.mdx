...
<Function id="qiskit.opflow.anti_commutator" name="anti_commutator" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/opflow/utils.py" signature="anti_commutator(op_a, op_b)">
