...
<Class id="qiskit.aqua.MissingOptionalLibraryError" name="MissingOptionalLibraryError" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/aqua/missing_optional_library_error.py" signature="MissingOptionalLibraryError(libname, name, pip_install=None, msg=None)">
