...
<Function id="qiskit.ignis.verification.combine_counts" github="https://github.com/qiskit-community/qiskit-ignis/tree/stable/0.6/qiskit/ignis/verification/tomography/data.py" signature="combine_counts(counts1, counts2)">
