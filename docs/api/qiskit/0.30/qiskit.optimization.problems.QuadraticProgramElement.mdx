...
<Class id="qiskit.optimization.problems.QuadraticProgramElement" github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/optimization/problems/quadratic_program_element.py" signature="QuadraticProgramElement(quadratic_program)">
  Bases: `object`
  ...
  **TypeError** – QuadraticProgram instance expected.
  ...
  <Attribute id="qiskit.optimization.problems.QuadraticProgramElement.quadratic_program" name="quadratic_program">
