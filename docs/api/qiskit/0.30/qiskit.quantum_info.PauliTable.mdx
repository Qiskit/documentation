...
<Class id="qiskit.quantum_info.PauliTable" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/quantum_info/operators/symplectic/pauli_table.py" signature="PauliTable(data)">
...
$$
  ...
  **Additional Information:**
  ...
  <Function id="qiskit.quantum_info.PauliTable.reshape" name="reshape" signature="PauliTable.reshape(input_dims=None, output_dims=None, num_qubits=None)">
  ...
  <Attribute id="qiskit.quantum_info.PauliTable.settings" name="settings">
    Return settings.
