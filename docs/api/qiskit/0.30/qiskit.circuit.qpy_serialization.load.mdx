...
<Function id="qiskit.circuit.qpy_serialization.load" name="load" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/circuit/qpy_serialization.py" signature="load(file_obj)">
