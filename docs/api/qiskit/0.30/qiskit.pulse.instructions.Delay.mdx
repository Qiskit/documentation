---
title: Delay (v0.30)
description: API reference for qiskit.pulse.instructions.Delay in qiskit v0.30
...
<Class id="qiskit.pulse.instructions.Delay" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/pulse/instructions/delay.py" signature="Delay(duration, channel, name=None)" modifiers="class">
  ...
  *   **name** (`Optional`\[`str`]) – Name of the delay for display purposes.
  ...
  <span id="qiskit-pulse-instructions-delay-assign-parameters" />

  ### assign\_parameters

  <Function id="qiskit.pulse.instructions.Delay.assign_parameters" signature="Delay.assign_parameters(value_dict)">
