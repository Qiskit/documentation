---
title: QasmHTMLStyle (v0.30)
description: API reference for qiskit.qasm.QasmHTMLStyle in qiskit v0.30
...
<Class id="qiskit.qasm.QasmHTMLStyle" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/qasm/pygments/lexer.py" signature="QasmHTMLStyle" modifiers="class">
  ...
  <Attribute id="qiskit.qasm.QasmHTMLStyle.web_style_gallery_exclude" attributeValue="False" />
</Class>
