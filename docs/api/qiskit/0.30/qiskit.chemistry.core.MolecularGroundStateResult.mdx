---
title: MolecularGroundStateResult (v0.30)
description: API reference for qiskit.chemistry.core.MolecularGroundStateResult in qiskit v0.30
...
<Class id="qiskit.chemistry.core.MolecularGroundStateResult" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/chemistry/core/chemistry_operator.py" signature="MolecularGroundStateResult(a_dict=None)" modifiers="class">
  ...
  <span id="qiskit-chemistry-core-moleculargroundstateresult-has-dipole" />
  ...
  <span id="qiskit-chemistry-core-moleculargroundstateresult-has-observables" />
