---
title: BosonicTransformation (v0.30)
description: API reference for qiskit.chemistry.transformations.BosonicTransformation in qiskit v0.30
...
<Class id="qiskit.chemistry.transformations.BosonicTransformation" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/chemistry/transformations/bosonic_transformation.py" signature="BosonicTransformation(qubit_mapping=<BosonicQubitMappingType.DIRECT: 'direct'>, transformation_type=<BosonicTransformationType.HARMONIC: 'harmonic'>, basis_size=2, truncation=3)" modifiers="class">
  ...
  *   **truncation** (`int`) – where is the Hamiltonian expansion truncation (1 for having only 1-body terms, 2 for having on 1- and 2-body terms…)
  ...
  <span id="qiskit-chemistry-transformations-bosonictransformation-build-hopping-operators" />

  ### build\_hopping\_operators

  <Function id="qiskit.chemistry.transformations.BosonicTransformation.build_hopping_operators" signature="BosonicTransformation.build_hopping_operators(excitations='sd')">
    **Parameters**
  ...
  <span id="qiskit-chemistry-transformations-bosonictransformation-get-default-filter-criterion" />

  ### get\_default\_filter\_criterion

  <Function id="qiskit.chemistry.transformations.BosonicTransformation.get_default_filter_criterion" signature="BosonicTransformation.get_default_filter_criterion()">
  ...
  <Function id="qiskit.chemistry.transformations.BosonicTransformation.interpret" signature="BosonicTransformation.interpret(raw_result)">
  ...
  <Function id="qiskit.chemistry.transformations.BosonicTransformation.transform" signature="BosonicTransformation.transform(driver, aux_operators=None)">
