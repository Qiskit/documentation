...
<Function id="qiskit.aqua.utils.summarize_circuits" github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/aqua/utils/circuit_utils.py" signature="summarize_circuits(circuits)">
