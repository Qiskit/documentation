---
title: PolynomialPauliRotations (v0.30)
description: API reference for qiskit.circuit.library.PolynomialPauliRotations in qiskit v0.30
...
$$
  ...
  *   **name** (`str`) – The name of the circuit.
  ...
  <Attribute id="qiskit.circuit.library.PolynomialPauliRotations.instances" attributeValue="16" />
