---
title: OpenQASMLexer (v0.30)
description: API reference for qiskit.qasm.OpenQASMLexer in qiskit v0.30
...
<Class id="qiskit.qasm.OpenQASMLexer" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/qasm/pygments/lexer.py" signature="OpenQASMLexer(*args, **kwds)" modifiers="class">
