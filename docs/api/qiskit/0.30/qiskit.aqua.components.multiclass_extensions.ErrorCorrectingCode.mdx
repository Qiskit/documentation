---
title: ErrorCorrectingCode (v0.30)
description: API reference for qiskit.aqua.components.multiclass_extensions.ErrorCorrectingCode in qiskit v0.30
...
<Class id="qiskit.aqua.components.multiclass_extensions.ErrorCorrectingCode" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/aqua/components/multiclass_extensions/error_correcting_code.py" signature="ErrorCorrectingCode(code_size=4)" modifiers="class">
  ...
  **code\_size** (`int`) – Size of error correcting code
  ...
  <span id="qiskit-aqua-components-multiclass-extensions-errorcorrectingcode-predict" />
  ...
  <span id="qiskit-aqua-components-multiclass-extensions-errorcorrectingcode-set-estimator" />
  ...
  <span id="qiskit-aqua-components-multiclass-extensions-errorcorrectingcode-test" />
  ...
  <span id="qiskit-aqua-components-multiclass-extensions-errorcorrectingcode-train" />
