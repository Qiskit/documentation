...
<Function id="qiskit.ignis.verification.gates_per_clifford" name="gates_per_clifford" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-ignis/tree/stable/0.6/qiskit/ignis/verification/randomized_benchmarking/rb_utils.py" signature="gates_per_clifford(transpiled_circuits_list, clifford_lengths, basis, qubits)">
