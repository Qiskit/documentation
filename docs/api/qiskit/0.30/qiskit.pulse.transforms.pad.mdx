---
title: pad (v0.30)
description: API reference for qiskit.pulse.transforms.pad in qiskit v0.30
...
<Function id="qiskit.pulse.transforms.pad" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/pulse/transforms/canonicalization.py" signature="pad(schedule, channels=None, until=None, inplace=False)">
