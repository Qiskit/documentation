---
title: QPE (v0.30)
description: API reference for qiskit.aqua.algorithms.QPE in qiskit v0.30
...
<Class id="qiskit.aqua.algorithms.QPE" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/aqua/algorithms/minimum_eigen_solvers/qpe.py" signature="QPE(operator=None, state_in=None, iqft=None, num_time_slices=1, num_ancillae=1, expansion_mode='trotter', expansion_order=1, shallow_circuit_concat=False, quantum_instance=None)" modifiers="class">
  ...
  *   **quantum\_instance** (`Union`\[`QuantumInstance`, `Backend`, `BaseBackend`, `None`]) – Quantum Instance or Backend
  ...
  <span id="qiskit-aqua-algorithms-qpe-compute-minimum-eigenvalue" />
  ...
  <span id="qiskit-aqua-algorithms-qpe-construct-circuit" />
  ...
  <span id="qiskit-aqua-algorithms-qpe-set-backend" />
  ...
  <span id="qiskit-aqua-algorithms-qpe-supports-aux-operators" />
