...
<Class id="qiskit.aqua.algorithms.QPE" github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/aqua/algorithms/minimum_eigen_solvers/qpe.py" signature="QPE(operator=None, state_in=None, iqft=None, num_time_slices=1, num_ancillae=1, expansion_mode='trotter', expansion_order=1, shallow_circuit_concat=False, quantum_instance=None)">
  ...
  *   **quantum\_instance** (`Union`\[`QuantumInstance`, `Backend`, `BaseBackend`, `None`]) – Quantum Instance or Backend
  ...
  <Function id="qiskit.aqua.algorithms.QPE.compute_minimum_eigenvalue" name="compute_minimum_eigenvalue" signature="QPE.compute_minimum_eigenvalue(operator=None, aux_operators=None)">
  ...
  <Function id="qiskit.aqua.algorithms.QPE.construct_circuit" name="construct_circuit" signature="QPE.construct_circuit(measurement=False)">
    Construct circuit.
  ...
  <Function id="qiskit.aqua.algorithms.QPE.run" name="run" signature="QPE.run(quantum_instance=None, **kwargs)">
  ...
  <Function id="qiskit.aqua.algorithms.QPE.set_backend" name="set_backend" signature="QPE.set_backend(backend, **kwargs)">
  ...
  <Function id="qiskit.aqua.algorithms.QPE.supports_aux_operators" name="supports_aux_operators" signature="classmethod QPE.supports_aux_operators()">
  ...
  <Attribute id="qiskit.aqua.algorithms.QPE.aux_operators" name="aux_operators">
  ...
  <Attribute id="qiskit.aqua.algorithms.QPE.backend" name="backend">
    Returns backend.
  ...
  <Attribute id="qiskit.aqua.algorithms.QPE.operator" name="operator">
    Returns operator
  ...
  <Attribute id="qiskit.aqua.algorithms.QPE.quantum_instance" name="quantum_instance">
  ...
  <Attribute id="qiskit.aqua.algorithms.QPE.random" name="random">
