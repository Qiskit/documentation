...
<Function id="qiskit.providers.aer.noise.device.basic_device_readout_errors" github="https://github.com/qiskit/qiskit-aer/tree/stable/0.9/qiskit/providers/aer/noise/device/models.py" signature="basic_device_readout_errors(properties)">
