...
<Class id="qiskit.aqua.operators.gradients.NaturalGradient" github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/aqua/operators/gradients/natural_gradient.py" signature="NaturalGradient(grad_method='lin_comb', qfi_method='lin_comb_full', regularization=None, **kwargs)">
  ...
  *   **kwargs** (*dict*) – Optional parameters for a CircuitGradient
  ...
  <Function id="qiskit.aqua.operators.gradients.NaturalGradient.convert" name="convert" signature="NaturalGradient.convert(operator, params=None)">
    **Parameters**
  ...
  <Function id="qiskit.aqua.operators.gradients.NaturalGradient.gradient_wrapper" name="gradient_wrapper" signature="NaturalGradient.gradient_wrapper(operator, bind_params, grad_params=None, backend=None)">
  ...
  <Function id="qiskit.aqua.operators.gradients.NaturalGradient.parameter_expression_grad" name="parameter_expression_grad" signature="static NaturalGradient.parameter_expression_grad(param_expr, param)">
  ...
  <Attribute id="qiskit.aqua.operators.gradients.NaturalGradient.grad_method" name="grad_method">
  ...
  <Attribute id="qiskit.aqua.operators.gradients.NaturalGradient.qfi_method" name="qfi_method">
    Returns `CircuitQFI`.
  ...
  <Attribute id="qiskit.aqua.operators.gradients.NaturalGradient.regularization" name="regularization">
