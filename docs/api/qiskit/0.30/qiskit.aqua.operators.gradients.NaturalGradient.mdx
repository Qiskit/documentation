---
title: NaturalGradient (v0.30)
description: API reference for qiskit.aqua.operators.gradients.NaturalGradient in qiskit v0.30
...
<Class id="qiskit.aqua.operators.gradients.NaturalGradient" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/aqua/operators/gradients/natural_gradient.py" signature="NaturalGradient(grad_method='lin_comb', qfi_method='lin_comb_full', regularization=None, **kwargs)" modifiers="class">
  ...
  *   **kwargs** (*dict*) – Optional parameters for a CircuitGradient
  ...
  <Function id="qiskit.aqua.operators.gradients.NaturalGradient.convert" signature="NaturalGradient.convert(operator, params=None)">
    **Parameters**
  ...
  <span id="qiskit-aqua-operators-gradients-naturalgradient-gradient-wrapper" />

  ### gradient\_wrapper

  <Function id="qiskit.aqua.operators.gradients.NaturalGradient.gradient_wrapper" signature="NaturalGradient.gradient_wrapper(operator, bind_params, grad_params=None, backend=None)">
  ...
  <span id="qiskit-aqua-operators-gradients-naturalgradient-parameter-expression-grad" />

  ### parameter\_expression\_grad

  <Function id="qiskit.aqua.operators.gradients.NaturalGradient.parameter_expression_grad" signature="NaturalGradient.parameter_expression_grad(param_expr, param)" modifiers="static">
