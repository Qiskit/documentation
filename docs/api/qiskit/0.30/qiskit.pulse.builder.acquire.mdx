...
<Function id="qiskit.pulse.builder.acquire" github="https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/pulse/builder.py" signature="acquire(duration, qubit_or_channel, register, **metadata)">
