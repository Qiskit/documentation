...
description: API reference for qiskit.utils.summarize_circuits in qiskit v0.30
...
<Function id="qiskit.utils.summarize_circuits" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/utils/circuit_utils.py" signature="summarize_circuits(circuits)">
