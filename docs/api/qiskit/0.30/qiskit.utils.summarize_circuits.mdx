...
<Function id="qiskit.utils.summarize_circuits" github="https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/utils/circuit_utils.py" signature="summarize_circuits(circuits)">
