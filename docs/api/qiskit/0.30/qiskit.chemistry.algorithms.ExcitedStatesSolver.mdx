...
<Class id="qiskit.chemistry.algorithms.ExcitedStatesSolver" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/chemistry/algorithms/excited_states_solvers/excited_states_solver.py" signature="ExcitedStatesSolver">
  Bases: `abc.ABC`
  ...
  <Function id="qiskit.chemistry.algorithms.ExcitedStatesSolver.solve" signature="abstract ExcitedStatesSolver.solve(driver, aux_operators=None)">
