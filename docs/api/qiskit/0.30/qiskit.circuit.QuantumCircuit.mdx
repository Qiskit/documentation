---
title: QuantumCircuit (v0.30)
description: API reference for qiskit.circuit.QuantumCircuit in qiskit v0.30
...
<Class id="qiskit.circuit.QuantumCircuit" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/circuit/quantumcircuit.py" signature="QuantumCircuit(*regs, name=None, global_phase=0, metadata=None)" modifiers="class">
  Bases: `object`
  ...
  **Examples**
  ...
  <Function id="qiskit.circuit.QuantumCircuit.assign_parameters" signature="QuantumCircuit.assign_parameters(parameters, inplace=False, param_dict=None)">
  ...
  <Function id="qiskit.circuit.QuantumCircuit.bind_parameters" signature="QuantumCircuit.bind_parameters(values, value_dict=None)">
  ...
  <Function id="qiskit.circuit.QuantumCircuit.cast" signature="QuantumCircuit.cast(value, _type)" modifiers="static">
  ...
  <Function id="qiskit.circuit.QuantumCircuit.decompose" signature="QuantumCircuit.decompose()">
  ...
  <Function id="qiskit.circuit.QuantumCircuit.depth" signature="QuantumCircuit.depth()">
  ...
  <Function id="qiskit.circuit.QuantumCircuit.draw" signature="QuantumCircuit.draw(output=None, scale=None, filename=None, style=None, interactive=False, plot_barriers=True, reverse_bits=False, justify=None, vertical_compression='medium', idle_wires=True, with_layout=True, fold=None, ax=None, initial_state=False, cregbundle=True)">
    ...
    **Example**
    ...
    ![../\_images/qiskit.circuit.QuantumCircuit.draw\_0\_0.png](/docs/images/api/qiskit/0.30/qiskit.circuit.QuantumCircuit.draw_0_0.avif)
  </Function>
  ...
  <Function id="qiskit.circuit.QuantumCircuit.measure_all" signature="QuantumCircuit.measure_all(inplace=True)">
  ...
  <Function id="qiskit.circuit.QuantumCircuit.size" signature="QuantumCircuit.size()">
  ...
  <Function id="qiskit.circuit.QuantumCircuit.squ" signature="QuantumCircuit.squ(unitary_matrix, qubit, mode='ZYZ', up_to_diagonal=False, *, u=None)">
  ...
  <Attribute id="qiskit.circuit.QuantumCircuit.instances" attributeValue="16" />
