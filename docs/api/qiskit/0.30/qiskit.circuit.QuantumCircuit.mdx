...
<Class id="qiskit.circuit.QuantumCircuit" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/circuit/quantumcircuit.py" signature="QuantumCircuit(*regs, name=None, global_phase=0, metadata=None)">
  Bases: `object`
  ...
  **Examples**
  ...
  <Function id="qiskit.circuit.QuantumCircuit.assign_parameters" name="assign_parameters" signature="QuantumCircuit.assign_parameters(parameters, inplace=False, param_dict=None)">
  ...
  <Function id="qiskit.circuit.QuantumCircuit.bind_parameters" name="bind_parameters" signature="QuantumCircuit.bind_parameters(values, value_dict=None)">
  ...
  <Function id="qiskit.circuit.QuantumCircuit.cast" name="cast" signature="static QuantumCircuit.cast(value, _type)">
  ...
  <Function id="qiskit.circuit.QuantumCircuit.decompose" name="decompose" signature="QuantumCircuit.decompose()">
  ...
  <Function id="qiskit.circuit.QuantumCircuit.depth" name="depth" signature="QuantumCircuit.depth()">
  ...
  <Function id="qiskit.circuit.QuantumCircuit.measure_all" name="measure_all" signature="QuantumCircuit.measure_all(inplace=True)">
  ...
  <Function id="qiskit.circuit.QuantumCircuit.size" name="size" signature="QuantumCircuit.size()">
  ...
  <Function id="qiskit.circuit.QuantumCircuit.squ" name="squ" signature="QuantumCircuit.squ(unitary_matrix, qubit, mode='ZYZ', up_to_diagonal=False, *, u=None)">
  ...
  <Attribute id="qiskit.circuit.QuantumCircuit.instances" name="instances" attributeValue="= 16" />
