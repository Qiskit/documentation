...
<Class id="qiskit.aqua.operators.gradients.GradientBase" github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/aqua/operators/gradients/gradient_base.py" signature="GradientBase(grad_method='param_shift', **kwargs)">
  ...
  **ValueError** – If method != `fin_diff` and `epsilon` is not None.
  ...
  <Function id="qiskit.aqua.operators.gradients.GradientBase.convert" signature="abstract GradientBase.convert(operator, params=None)">
    **Parameters**
  ...
  <Function id="qiskit.aqua.operators.gradients.GradientBase.parameter_expression_grad" signature="static GradientBase.parameter_expression_grad(param_expr, param)">
  ...
  <Attribute id="qiskit.aqua.operators.gradients.GradientBase.grad_method" name="grad_method">
