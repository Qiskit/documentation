...
<Function id="qiskit.ignis.verification.get_ghz_po_para" github="https://github.com/qiskit-community/qiskit-ignis/tree/stable/0.6/qiskit/ignis/verification/entanglement/linear.py" signature="get_ghz_po_para(n)">
