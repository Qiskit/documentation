---
title: HarmonicPotential (v0.30)
description: API reference for qiskit.chemistry.algorithms.pes_samplers.HarmonicPotential in qiskit v0.30
...
<Class id="qiskit.chemistry.algorithms.pes_samplers.HarmonicPotential" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/chemistry/algorithms/pes_samplers/potentials/harmonic_potential.py" signature="HarmonicPotential(molecule)" modifiers="class">
  ...
  **ValueError** – Only implemented for diatomic molecules
  ...
  <span id="qiskit-chemistry-algorithms-pes-samplers-harmonicpotential-dissociation-energy" />
  ...
  <span id="qiskit-chemistry-algorithms-pes-samplers-harmonicpotential-eval" />
  ...
  <span id="qiskit-chemistry-algorithms-pes-samplers-harmonicpotential-fit" />
  ...
  <span id="qiskit-chemistry-algorithms-pes-samplers-harmonicpotential-fit-function" />
  ...
  <span id="qiskit-chemistry-algorithms-pes-samplers-harmonicpotential-fundamental-frequency" />
  ...
  <span id="qiskit-chemistry-algorithms-pes-samplers-harmonicpotential-get-equilibrium-geometry" />
  ...
  <span id="qiskit-chemistry-algorithms-pes-samplers-harmonicpotential-get-maximum-trusted-level" />
  ...
  <span id="qiskit-chemistry-algorithms-pes-samplers-harmonicpotential-get-minimal-energy" />
  ...
  <span id="qiskit-chemistry-algorithms-pes-samplers-harmonicpotential-get-num-modes" />
  ...
  <span id="qiskit-chemistry-algorithms-pes-samplers-harmonicpotential-get-trust-region" />
  ...
  <span id="qiskit-chemistry-algorithms-pes-samplers-harmonicpotential-process-fit-data" />
  ...
  <span id="qiskit-chemistry-algorithms-pes-samplers-harmonicpotential-update-molecule" />
  ...
  <span id="qiskit-chemistry-algorithms-pes-samplers-harmonicpotential-vibrational-energy-level" />
  ...
  <span id="qiskit-chemistry-algorithms-pes-samplers-harmonicpotential-wave-number" />
