---
title: IQP (v0.30)
description: API reference for qiskit.circuit.library.IQP in qiskit v0.30
...
<Class id="qiskit.circuit.library.IQP" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/circuit/library/iqp.py" signature="IQP(interactions)" modifiers="class">
  ...
  **Reference Circuit:**
  ...
  ![../\_images/qiskit.circuit.library.IQP\_0\_0.png](/docs/images/api/qiskit/0.30/qiskit.circuit.library.IQP_0_0.avif)
