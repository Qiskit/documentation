...
<Class id="qiskit.pulse.GaussianSquare" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/pulse/library/parametric_pulses.py" signature="GaussianSquare(duration, amp, sigma, width=None, risefall_sigma_ratio=None, name=None)">
...
$$
  ...
  *   **name** (`Optional`\[`str`]) – Display name for this pulse envelope.
  ...
  <Function id="qiskit.pulse.GaussianSquare.assign" name="assign" signature="GaussianSquare.assign(parameter, value)">
  ...
  <Function id="qiskit.pulse.GaussianSquare.assign_parameters" name="assign_parameters" signature="GaussianSquare.assign_parameters(value_dict)">
  ...
  <Function id="qiskit.pulse.GaussianSquare.draw" name="draw" signature="GaussianSquare.draw(dt=None, style=None, filename=None, interp_method=None, scale=None, interactive=None, draw_title=None, backend=None, time_range=None, time_unit='dt', show_waveform_info=True, plotter='mpl2d', axis=None)">
  ...
  <Function id="qiskit.pulse.GaussianSquare.get_waveform" name="get_waveform" signature="GaussianSquare.get_waveform()">
  ...
  <Function id="qiskit.pulse.GaussianSquare.is_parameterized" name="is_parameterized" signature="GaussianSquare.is_parameterized()">
  ...
  <Function id="qiskit.pulse.GaussianSquare.validate_parameters" name="validate_parameters" signature="GaussianSquare.validate_parameters()">
    Validate parameters.
  ...
  <Attribute id="qiskit.pulse.GaussianSquare.amp" name="amp">
  ...
  <Attribute id="qiskit.pulse.GaussianSquare.id" name="id">
  ...
  <Attribute id="qiskit.pulse.GaussianSquare.limit_amplitude" name="limit_amplitude" attributeValue="= True" />

  ### parameters

  <Attribute id="qiskit.pulse.GaussianSquare.parameters" name="parameters">
    **Return type**
  ...
  <Attribute id="qiskit.pulse.GaussianSquare.risefall_sigma_ratio" name="risefall_sigma_ratio">
  ...
  <Attribute id="qiskit.pulse.GaussianSquare.sigma" name="sigma">
  ...
  <Attribute id="qiskit.pulse.GaussianSquare.width" name="width">
