...
<Class id="qiskit.aqua.operators.legacy.MatrixOperator" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/aqua/operators/legacy/matrix_operator.py" signature="MatrixOperator(matrix, basis=None, z2_symmetries=None, atol=1e-12, name=None)">
  ...
  *   **name** (*str*) – name
  ...
  <Function id="qiskit.aqua.operators.legacy.MatrixOperator.add" name="add" signature="MatrixOperator.add(other, copy=False)" />

  ### chop

  <Function id="qiskit.aqua.operators.legacy.MatrixOperator.chop" name="chop" signature="MatrixOperator.chop(threshold=None, copy=False)">
  ...
  <Function id="qiskit.aqua.operators.legacy.MatrixOperator.construct_evaluation_circuit" name="construct_evaluation_circuit" signature="MatrixOperator.construct_evaluation_circuit(wave_function, statevector_mode=True, use_simulator_snapshot_mode=None, circuit_name_prefix='')">
  ...
  <Function id="qiskit.aqua.operators.legacy.MatrixOperator.copy" name="copy" signature="MatrixOperator.copy()">
    Get a copy of self.
  </Function>

  ### evaluate\_with\_result

  <Function id="qiskit.aqua.operators.legacy.MatrixOperator.evaluate_with_result" name="evaluate_with_result" signature="MatrixOperator.evaluate_with_result(result, statevector_mode=True, use_simulator_snapshot_mode=None, circuit_name_prefix='')">
  ...
  <Function id="qiskit.aqua.operators.legacy.MatrixOperator.evaluate_with_statevector" name="evaluate_with_statevector" signature="MatrixOperator.evaluate_with_statevector(quantum_state)">
    **Parameters**
  ...
  <Function id="qiskit.aqua.operators.legacy.MatrixOperator.evolve" name="evolve" signature="MatrixOperator.evolve(state_in, evo_time=0, num_time_slices=0, expansion_mode='trotter', expansion_order=1)">
  ...
  <Function id="qiskit.aqua.operators.legacy.MatrixOperator.is_empty" name="is_empty" signature="MatrixOperator.is_empty()">
  ...
  <Function id="qiskit.aqua.operators.legacy.MatrixOperator.print_details" name="print_details" signature="MatrixOperator.print_details()">
    **Returns**
  ...
  <Function id="qiskit.aqua.operators.legacy.MatrixOperator.sub" name="sub" signature="MatrixOperator.sub(other, copy=False)" />

  ### to\_opflow

  <Function id="qiskit.aqua.operators.legacy.MatrixOperator.to_opflow" name="to_opflow" signature="MatrixOperator.to_opflow()">
    to op flow
  </Function>
  ...
  <Attribute id="qiskit.aqua.operators.legacy.MatrixOperator.atol" name="atol">
    return atol
  </Attribute>

  ### basis

  <Attribute id="qiskit.aqua.operators.legacy.MatrixOperator.basis" name="basis">
    returns basis
  </Attribute>

  ### dense\_matrix

  <Attribute id="qiskit.aqua.operators.legacy.MatrixOperator.dense_matrix" name="dense_matrix">
    Getter of matrix in dense matrix form.
  </Attribute>

  ### dia\_matrix

  <Attribute id="qiskit.aqua.operators.legacy.MatrixOperator.dia_matrix" name="dia_matrix">
    diagonal matrix
  </Attribute>

  ### matrix

  <Attribute id="qiskit.aqua.operators.legacy.MatrixOperator.matrix" name="matrix">
    Getter of matrix.
  </Attribute>

  ### name

  <Attribute id="qiskit.aqua.operators.legacy.MatrixOperator.name" name="name">
    returns name
  </Attribute>

  ### num\_qubits

  <Attribute id="qiskit.aqua.operators.legacy.MatrixOperator.num_qubits" name="num_qubits">
  ...
  <Attribute id="qiskit.aqua.operators.legacy.MatrixOperator.z2_symmetries" name="z2_symmetries">
