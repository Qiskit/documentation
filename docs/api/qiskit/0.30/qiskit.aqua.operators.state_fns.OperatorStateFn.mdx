...
<Class id="qiskit.aqua.operators.state_fns.OperatorStateFn" github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/aqua/operators/state_fns/operator_state_fn.py" signature="OperatorStateFn(primitive=None, coeff=1.0, is_measurement=False)">
