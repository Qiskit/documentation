...
<Class id="qiskit.aqua.operators.state_fns.OperatorStateFn" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/aqua/operators/state_fns/operator_state_fn.py" signature="OperatorStateFn(primitive=None, coeff=1.0, is_measurement=False)">
  ...
  *   **is\_measurement** (`bool`) – Whether the StateFn is a measurement operator
  ...
  <Function id="qiskit.aqua.operators.state_fns.OperatorStateFn.add" name="add" signature="OperatorStateFn.add(other)">
  ...
  <Function id="qiskit.aqua.operators.state_fns.OperatorStateFn.adjoint" name="adjoint" signature="OperatorStateFn.adjoint()">
  ...
  <Function id="qiskit.aqua.operators.state_fns.OperatorStateFn.assign_parameters" name="assign_parameters" signature="OperatorStateFn.assign_parameters(param_dict)">
  ...
  <Function id="qiskit.aqua.operators.state_fns.OperatorStateFn.bind_parameters" name="bind_parameters" signature="OperatorStateFn.bind_parameters(param_dict)">
  ...
  <Function id="qiskit.aqua.operators.state_fns.OperatorStateFn.compose" name="compose" signature="OperatorStateFn.compose(other, permutation=None, front=False)">
  ...
  <Function id="qiskit.aqua.operators.state_fns.OperatorStateFn.equals" name="equals" signature="OperatorStateFn.equals(other)">
  ...
  <Function id="qiskit.aqua.operators.state_fns.OperatorStateFn.eval" name="eval" signature="OperatorStateFn.eval(front=None)">
  ...
  <Function id="qiskit.aqua.operators.state_fns.OperatorStateFn.mul" name="mul" signature="OperatorStateFn.mul(scalar)">
  ...
  <Function id="qiskit.aqua.operators.state_fns.OperatorStateFn.neg" name="neg" signature="OperatorStateFn.neg()">
  ...
  <Function id="qiskit.aqua.operators.state_fns.OperatorStateFn.permute" name="permute" signature="OperatorStateFn.permute(permutation)">
  ...
  <Function id="qiskit.aqua.operators.state_fns.OperatorStateFn.power" name="power" signature="OperatorStateFn.power(exponent)">
  ...
  <Function id="qiskit.aqua.operators.state_fns.OperatorStateFn.primitive_strings" name="primitive_strings" signature="OperatorStateFn.primitive_strings()">
  ...
  <Function id="qiskit.aqua.operators.state_fns.OperatorStateFn.reduce" name="reduce" signature="OperatorStateFn.reduce()">
  ...
  <Function id="qiskit.aqua.operators.state_fns.OperatorStateFn.sample" name="sample" signature="OperatorStateFn.sample(shots=1024, massive=False, reverse_endianness=False)">
  ...
  <Function id="qiskit.aqua.operators.state_fns.OperatorStateFn.tensor" name="tensor" signature="OperatorStateFn.tensor(other)">
  ...
  <Function id="qiskit.aqua.operators.state_fns.OperatorStateFn.tensorpower" name="tensorpower" signature="OperatorStateFn.tensorpower(other)">
  ...
  <Function id="qiskit.aqua.operators.state_fns.OperatorStateFn.to_circuit_op" name="to_circuit_op" signature="OperatorStateFn.to_circuit_op()">
  ...
  <Function id="qiskit.aqua.operators.state_fns.OperatorStateFn.to_density_matrix" name="to_density_matrix" signature="OperatorStateFn.to_density_matrix(massive=False)">
  ...
  <Function id="qiskit.aqua.operators.state_fns.OperatorStateFn.to_legacy_op" name="to_legacy_op" signature="OperatorStateFn.to_legacy_op(massive=False)">
  ...
  <Function id="qiskit.aqua.operators.state_fns.OperatorStateFn.to_matrix" name="to_matrix" signature="OperatorStateFn.to_matrix(massive=False)">
  ...
  <Function id="qiskit.aqua.operators.state_fns.OperatorStateFn.to_matrix_op" name="to_matrix_op" signature="OperatorStateFn.to_matrix_op(massive=False)">
  ...
  <Function id="qiskit.aqua.operators.state_fns.OperatorStateFn.traverse" name="traverse" signature="OperatorStateFn.traverse(convert_fn, coeff=None)">
  ...
  <Attribute id="qiskit.aqua.operators.state_fns.OperatorStateFn.ENABLE_DEPRECATION" name="ENABLE_DEPRECATION" attributeValue="= True" />

  ### INDENTATION

  <Attribute id="qiskit.aqua.operators.state_fns.OperatorStateFn.INDENTATION" name="INDENTATION" attributeValue="= '  '" />

  ### coeff

  <Attribute id="qiskit.aqua.operators.state_fns.OperatorStateFn.coeff" name="coeff">
  ...
  <Attribute id="qiskit.aqua.operators.state_fns.OperatorStateFn.is_measurement" name="is_measurement">
  ...
  <Attribute id="qiskit.aqua.operators.state_fns.OperatorStateFn.num_qubits" name="num_qubits">
    **Return type**
  ...
  <Attribute id="qiskit.aqua.operators.state_fns.OperatorStateFn.parameters" name="parameters" />

  ### primitive

  <Attribute id="qiskit.aqua.operators.state_fns.OperatorStateFn.primitive" name="primitive">
