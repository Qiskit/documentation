---
title: PhaseGate (v0.30)
description: API reference for qiskit.circuit.library.PhaseGate in qiskit v0.30
...
<Class id="qiskit.circuit.library.PhaseGate" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/circuit/library/standard_gates/p.py" signature="PhaseGate(theta, label=None)" modifiers="class">
