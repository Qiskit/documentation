...
<Class id="qiskit.ignis.verification.Plotter" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-ignis/tree/stable/0.6/qiskit/ignis/verification/entanglement/analysis.py" signature="Plotter(label)">
  Bases: `object`
