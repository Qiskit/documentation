...
<Function id="qiskit.pulse.builder.num_qubits" name="num_qubits" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/pulse/builder.py" signature="num_qubits()">
