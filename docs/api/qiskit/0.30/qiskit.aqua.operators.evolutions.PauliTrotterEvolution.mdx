...
<Class id="qiskit.aqua.operators.evolutions.PauliTrotterEvolution" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/aqua/operators/evolutions/pauli_trotter_evolution.py" signature="PauliTrotterEvolution(trotter_mode='trotter', reps=1)">
  ...
  *   **rather than each Pauli.** (*#*) –
  ...
  <Function id="qiskit.aqua.operators.evolutions.PauliTrotterEvolution.convert" name="convert" signature="PauliTrotterEvolution.convert(operator)">
  ...
  <Function id="qiskit.aqua.operators.evolutions.PauliTrotterEvolution.evolution_for_abelian_paulisum" name="evolution_for_abelian_paulisum" signature="PauliTrotterEvolution.evolution_for_abelian_paulisum(op_sum)">
  ...
  <Function id="qiskit.aqua.operators.evolutions.PauliTrotterEvolution.evolution_for_pauli" name="evolution_for_pauli" signature="PauliTrotterEvolution.evolution_for_pauli(pauli_op)">
  ...
  <Attribute id="qiskit.aqua.operators.evolutions.PauliTrotterEvolution.trotter" name="trotter">
