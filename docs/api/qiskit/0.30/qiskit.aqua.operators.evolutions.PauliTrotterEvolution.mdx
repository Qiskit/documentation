---
title: PauliTrotterEvolution (v0.30)
description: API reference for qiskit.aqua.operators.evolutions.PauliTrotterEvolution in qiskit v0.30
...
<Class id="qiskit.aqua.operators.evolutions.PauliTrotterEvolution" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/aqua/operators/evolutions/pauli_trotter_evolution.py" signature="PauliTrotterEvolution(trotter_mode='trotter', reps=1)" modifiers="class">
  ...
  *   **rather than each Pauli.** (*#*) –
  ...
  <span id="qiskit-aqua-operators-evolutions-paulitrotterevolution-evolution-for-abelian-paulisum" />
  ...
  <span id="qiskit-aqua-operators-evolutions-paulitrotterevolution-evolution-for-pauli" />
