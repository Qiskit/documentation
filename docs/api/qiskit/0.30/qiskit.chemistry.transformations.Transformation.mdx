...
<Class id="qiskit.chemistry.transformations.Transformation" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/chemistry/transformations/transformation.py" signature="Transformation">
  ...
  <Function id="qiskit.chemistry.transformations.Transformation.build_hopping_operators" signature="abstract Transformation.build_hopping_operators(excitations='sd')">
  ...
  <Function id="qiskit.chemistry.transformations.Transformation.interpret" signature="abstract Transformation.interpret(raw_result)">
  ...
  <Function id="qiskit.chemistry.transformations.Transformation.transform" signature="abstract Transformation.transform(driver, aux_operators=None)">
