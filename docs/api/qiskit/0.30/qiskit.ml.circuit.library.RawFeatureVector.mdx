...
<Class id="qiskit.ml.circuit.library.RawFeatureVector" github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/ml/circuit/library/raw_feature_vector.py" signature="RawFeatureVector(feature_dimension)">
  ...
  **feature\_dimension** (`Optional`\[`int`]) – The feature dimension and number of qubits.
  ...
  <Function id="qiskit.ml.circuit.library.RawFeatureVector.cast" signature="static RawFeatureVector.cast(value, _type)">
  ...
  <Function id="qiskit.ml.circuit.library.RawFeatureVector.cls_instances" signature="classmethod RawFeatureVector.cls_instances()">
    Return the current number of instances of this class, useful for auto naming.
  </Function>

  ### cls\_prefix

  <Function id="qiskit.ml.circuit.library.RawFeatureVector.cls_prefix" signature="classmethod RawFeatureVector.cls_prefix()">
  ...
  <Function id="qiskit.ml.circuit.library.RawFeatureVector.from_qasm_file" signature="static RawFeatureVector.from_qasm_file(path)">
  ...
  <Function id="qiskit.ml.circuit.library.RawFeatureVector.from_qasm_str" signature="static RawFeatureVector.from_qasm_str(qasm_str)">
