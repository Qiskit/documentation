---
title: ShiftPhase (v0.30)
description: API reference for qiskit.pulse.ShiftPhase in qiskit v0.30
...
<Class id="qiskit.pulse.ShiftPhase" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/pulse/instructions/phase.py" signature="ShiftPhase(phase, channel, name=None)" modifiers="class">
...
$$
  ...
  *   **name** (`Optional`\[`str`]) – Display name for this instruction.
  ...
  <Function id="qiskit.pulse.ShiftPhase.append" signature="ShiftPhase.append(schedule, name=None)">
  ...
  <span id="qiskit-pulse-shiftphase-assign-parameters" />

  ### assign\_parameters

  <Function id="qiskit.pulse.ShiftPhase.assign_parameters" signature="ShiftPhase.assign_parameters(value_dict)">
  ...
  <span id="qiskit-pulse-shiftphase-ch-duration" />

  ### ch\_duration

  <Function id="qiskit.pulse.ShiftPhase.ch_duration" signature="ShiftPhase.ch_duration(*channels)">
  ...
  <span id="qiskit-pulse-shiftphase-ch-start-time" />

  ### ch\_start\_time

  <Function id="qiskit.pulse.ShiftPhase.ch_start_time" signature="ShiftPhase.ch_start_time(*channels)">
  ...
  <span id="qiskit-pulse-shiftphase-ch-stop-time" />

  ### ch\_stop\_time

  <Function id="qiskit.pulse.ShiftPhase.ch_stop_time" signature="ShiftPhase.ch_stop_time(*channels)">
  ...
  <Function id="qiskit.pulse.ShiftPhase.draw" signature="ShiftPhase.draw(dt=1, style=None, filename=None, interp_method=None, scale=1, plot_all=False, plot_range=None, interactive=False, table=True, label=False, framechange=True, channels=None)">
  ...
  <Function id="qiskit.pulse.ShiftPhase.flatten" signature="ShiftPhase.flatten()">
  ...
  <Function id="qiskit.pulse.ShiftPhase.insert" signature="ShiftPhase.insert(start_time, schedule, name=None)">
  ...
  <span id="qiskit-pulse-shiftphase-is-parameterized" />

  ### is\_parameterized

  <Function id="qiskit.pulse.ShiftPhase.is_parameterized" signature="ShiftPhase.is_parameterized()">
  ...
  <Function id="qiskit.pulse.ShiftPhase.shift" signature="ShiftPhase.shift(time, name=None)">
