---
title: HamiltonianPhaseEstimation (v0.30)
description: API reference for qiskit.algorithms.HamiltonianPhaseEstimation in qiskit v0.30
...
<Class id="qiskit.algorithms.HamiltonianPhaseEstimation" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/algorithms/phase_estimators/hamiltonian_phase_estimation.py" signature="HamiltonianPhaseEstimation(num_evaluation_qubits, quantum_instance=None)" modifiers="class">
  Bases: `object`
