...
<Class id="qiskit.aqua.components.neural_networks.GenerativeNetwork" github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/aqua/components/neural_networks/generative_network.py" signature="GenerativeNetwork">
  ...
  <Function id="qiskit.aqua.components.neural_networks.GenerativeNetwork.get_output" name="get_output" signature="abstract GenerativeNetwork.get_output(quantum_instance, params, shots)">
  ...
  <Function id="qiskit.aqua.components.neural_networks.GenerativeNetwork.loss" name="loss" signature="abstract GenerativeNetwork.loss()">
    Loss function used for optimization
  </Function>

  ### set\_discriminator

  <Function id="qiskit.aqua.components.neural_networks.GenerativeNetwork.set_discriminator" name="set_discriminator" signature="abstract GenerativeNetwork.set_discriminator(discriminator)">
  ...
  <Function id="qiskit.aqua.components.neural_networks.GenerativeNetwork.set_seed" name="set_seed" signature="abstract GenerativeNetwork.set_seed(seed)">
    Set seed.
  ...
  <Function id="qiskit.aqua.components.neural_networks.GenerativeNetwork.train" name="train" signature="abstract GenerativeNetwork.train(quantum_instance=None, shots=None)">
  ...
  <Attribute id="qiskit.aqua.components.neural_networks.GenerativeNetwork.parameter_values" name="parameter_values">
