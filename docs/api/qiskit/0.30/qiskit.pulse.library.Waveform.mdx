---
title: Waveform (v0.30)
description: API reference for qiskit.pulse.library.Waveform in qiskit v0.30
...
<Class id="qiskit.pulse.library.Waveform" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/pulse/library/waveform.py" signature="Waveform(samples, name=None, epsilon=1e-07, limit_amplitude=None)" modifiers="class">
  ...
  *   **limit\_amplitude** (`Optional`\[`bool`]) – Passed to parent Pulse
  ...
  <span id="qiskit-pulse-library-waveform-assign-parameters" />
