---
title: QobjExperimentHeader (v0.30)
description: API reference for qiskit.qobj.QobjExperimentHeader in qiskit v0.30
...
<Class id="qiskit.qobj.QobjExperimentHeader" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/qobj/common.py" signature="QobjExperimentHeader(**kwargs)" modifiers="class">
