...
<Class id="qiskit.optimization.problems.QuadraticObjective" github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/optimization/problems/quadratic_objective.py" signature="QuadraticObjective(quadratic_program, constant=0.0, linear=None, quadratic=None, sense=<ObjSense.MINIMIZE: 1>)">
  ...
  *   **sense** (`ObjSense`) – The optimization sense of the objective.
  ...
  <Function id="qiskit.optimization.problems.QuadraticObjective.evaluate_gradient" name="evaluate_gradient" signature="QuadraticObjective.evaluate_gradient(x)">
  ...
  <Attribute id="qiskit.optimization.problems.QuadraticObjective.constant" name="constant">
  ...
  <Attribute id="qiskit.optimization.problems.QuadraticObjective.linear" name="linear">
  ...
  <Attribute id="qiskit.optimization.problems.QuadraticObjective.quadratic" name="quadratic">
  ...
  <Attribute id="qiskit.optimization.problems.QuadraticObjective.quadratic_program" name="quadratic_program">
