...
<Function id="qiskit.providers.ibmq.utils.seconds_to_duration" name="seconds_to_duration" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-ibmq-provider/tree/stable/0.16/qiskit/providers/ibmq/utils/converters.py" signature="seconds_to_duration(seconds)">
