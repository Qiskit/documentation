---
title: QuantumInstance (v0.30)
description: API reference for qiskit.aqua.QuantumInstance in qiskit v0.30
...
<Class id="qiskit.aqua.QuantumInstance" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/aqua/quantum_instance.py" signature="QuantumInstance(backend, shots=1024, seed_simulator=None, max_credits=10, basis_gates=None, coupling_map=None, initial_layout=None, pass_manager=None, seed_transpiler=None, optimization_level=None, backend_options=None, noise_model=None, timeout=None, wait=5.0, skip_qobj_validation=True, measurement_error_mitigation_cls=None, cals_matrix_refresh_period=30, measurement_error_mitigation_shots=None, job_callback=None)" modifiers="class">
  ...
  *   [**AquaError**](qiskit.aqua.AquaError "qiskit.aqua.AquaError") – set backend\_options but the backend does not support that
  ...
  <span id="qiskit-aqua-quantuminstance-cals-matrix" />
  ...
  <span id="qiskit-aqua-quantuminstance-maybe-refresh-cals-matrix" />
  ...
  <span id="qiskit-aqua-quantuminstance-reset-execution-results" />
  ...
  <span id="qiskit-aqua-quantuminstance-set-config" />
