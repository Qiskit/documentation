---
title: BOPESSampler (v0.30)
description: API reference for qiskit.chemistry.algorithms.BOPESSampler in qiskit v0.30
...
<Class id="qiskit.chemistry.algorithms.BOPESSampler" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/chemistry/algorithms/pes_samplers/bopes_sampler.py" signature="BOPESSampler(gss, tolerance=0.001, bootstrap=True, num_bootstrap=None, extrapolator=None)" modifiers="class">
  ...
  **Raises**
  ...
  <Function id="qiskit.chemistry.algorithms.BOPESSampler.sample" signature="BOPESSampler.sample(driver, points)">
