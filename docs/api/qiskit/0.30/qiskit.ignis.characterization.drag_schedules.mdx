---
title: drag_schedules (v0.30)
description: API reference for qiskit.ignis.characterization.drag_schedules in qiskit v0.30
...
<Function id="qiskit.ignis.characterization.drag_schedules" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-ignis/tree/stable/0.6/qiskit/ignis/characterization/calibrations/pulse_schedules.py" signature="drag_schedules(beta_list, qubits, pulse_amp, pulse_width, pulse_sigma=None, width_sigma_ratio=4, drives=None, inst_map=None, meas_map=None)">
