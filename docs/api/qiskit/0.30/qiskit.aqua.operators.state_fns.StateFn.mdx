...
`StateFn.to_legacy_op(massive=False)`
...
<span id="qiskit.aqua.operators.state_fns.StateFn.ENABLE_DEPRECATION" />

### ENABLE\_DEPRECATION

`= True`

<span id="qiskit.aqua.operators.state_fns.StateFn.INDENTATION" />
