---
title: StateFn (v0.30)
description: API reference for qiskit.aqua.operators.state_fns.StateFn in qiskit v0.30
...
<Class id="qiskit.aqua.operators.state_fns.StateFn" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/aqua/operators/state_fns/state_fn.py" signature="StateFn(primitive=None, coeff=1.0, is_measurement=False)" modifiers="class">
  ...
  *   **is\_measurement** (`bool`) – Whether the StateFn is a measurement operator
  ...
  <span id="qiskit-aqua-operators-state-fns-statefn-add" />
  ...
  <span id="qiskit-aqua-operators-state-fns-statefn-adjoint" />
  ...
  <span id="qiskit-aqua-operators-state-fns-statefn-assign-parameters" />
  ...
  <span id="qiskit-aqua-operators-state-fns-statefn-bind-parameters" />
  ...
  <span id="qiskit-aqua-operators-state-fns-statefn-compose" />

  ### compose

  <Function id="qiskit.aqua.operators.state_fns.StateFn.compose" signature="StateFn.compose(other, permutation=None, front=False)">
  ...
  <span id="qiskit-aqua-operators-state-fns-statefn-equals" />
  ...
  <span id="qiskit-aqua-operators-state-fns-statefn-eval" />
  ...
  <span id="qiskit-aqua-operators-state-fns-statefn-mul" />
  ...
  <span id="qiskit-aqua-operators-state-fns-statefn-neg" />
  ...
  <span id="qiskit-aqua-operators-state-fns-statefn-permute" />

  ### permute

  <Function id="qiskit.aqua.operators.state_fns.StateFn.permute" signature="StateFn.permute(permutation)">
  ...
  <span id="qiskit-aqua-operators-state-fns-statefn-power" />
  ...
  <span id="qiskit-aqua-operators-state-fns-statefn-primitive-strings" />
  ...
  <span id="qiskit-aqua-operators-state-fns-statefn-reduce" />
  ...
  <span id="qiskit-aqua-operators-state-fns-statefn-sample" />
  ...
  <span id="qiskit-aqua-operators-state-fns-statefn-tensor" />
  ...
  <span id="qiskit-aqua-operators-state-fns-statefn-tensorpower" />
  ...
  <span id="qiskit-aqua-operators-state-fns-statefn-to-density-matrix" />
  ...
  <span id="qiskit-aqua-operators-state-fns-statefn-to-legacy-op" />
  ...
  <span id="qiskit-aqua-operators-state-fns-statefn-to-matrix" />
  ...
  <span id="qiskit-aqua-operators-state-fns-statefn-to-matrix-op" />
  ...
  <span id="qiskit-aqua-operators-state-fns-statefn-traverse" />
  ...
  <Attribute id="qiskit.aqua.operators.state_fns.StateFn.ENABLE_DEPRECATION" attributeValue="True" />

  ### INDENTATION

  <Attribute id="qiskit.aqua.operators.state_fns.StateFn.INDENTATION" attributeValue="'  '" />
