---
title: MaximumLikelihoodAmplitudeEstimation (v0.30)
description: API reference for qiskit.aqua.algorithms.MaximumLikelihoodAmplitudeEstimation in qiskit v0.30
