...
<Class id="qiskit.pulse.Drag" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/pulse/library/parametric_pulses.py" signature="Drag(duration, amp, sigma, beta, name=None)">
...
$$
  ...
  *   **name** (`Optional`\[`str`]) – Display name for this pulse envelope.
  ...
  <Function id="qiskit.pulse.Drag.assign" name="assign" signature="Drag.assign(parameter, value)">
  ...
  <Function id="qiskit.pulse.Drag.assign_parameters" name="assign_parameters" signature="Drag.assign_parameters(value_dict)">
  ...
  <Function id="qiskit.pulse.Drag.draw" name="draw" signature="Drag.draw(dt=None, style=None, filename=None, interp_method=None, scale=None, interactive=None, draw_title=None, backend=None, time_range=None, time_unit='dt', show_waveform_info=True, plotter='mpl2d', axis=None)">
  ...
  <Function id="qiskit.pulse.Drag.get_waveform" name="get_waveform" signature="Drag.get_waveform()">
  ...
  <Function id="qiskit.pulse.Drag.is_parameterized" name="is_parameterized" signature="Drag.is_parameterized()">
  ...
  <Function id="qiskit.pulse.Drag.validate_parameters" name="validate_parameters" signature="Drag.validate_parameters()">
    Validate parameters.
  ...
  <Attribute id="qiskit.pulse.Drag.amp" name="amp">
  ...
  <Attribute id="qiskit.pulse.Drag.beta" name="beta">
  ...
  <Attribute id="qiskit.pulse.Drag.id" name="id">
  ...
  <Attribute id="qiskit.pulse.Drag.limit_amplitude" name="limit_amplitude" attributeValue="True" />

  ### parameters

  <Attribute id="qiskit.pulse.Drag.parameters" name="parameters">
    **Return type**
  ...
  <Attribute id="qiskit.pulse.Drag.sigma" name="sigma">
