---
title: StabilizerState (latest version)
description: API reference for qiskit.quantum_info.StabilizerState in the latest version of qiskit
...
<Class id="qiskit.quantum_info.StabilizerState" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.3/qiskit/quantum_info/states/stabilizerstate.py#L36-L774" signature="qiskit.quantum_info.StabilizerState(data, validate=True)" modifiers="class">
  Bases: `QuantumState`

  StabilizerState class. Stabilizer simulator using the convention from reference \[1]. Based on the internal class [`Clifford`](quantum-info-clifford "qiskit.quantum_info.Clifford").
  ...
  *   **data** ([*StabilizerState*](#qiskit.quantum_info.StabilizerState "qiskit.quantum_info.StabilizerState")  *|*[*Clifford*](quantum-info-clifford "qiskit.quantum_info.Clifford")  *|*[*Pauli*](quantum-info-pauli "qiskit.quantum_info.Pauli")  *|*[*QuantumCircuit*](circuit-quantum-circuit "qiskit.circuit.QuantumCircuit")  *|*[*circuit.instruction.Instruction*](circuit-instruction "qiskit.circuit.instruction.Instruction")) – Data from which the stabilizer state can be constructed.
  *   **validate** ([*bool*](https://docs.python.org/3/library/functions.html#bool "(in Python v3.13)")) – validate that the stabilizer state data is a valid Clifford.
  ...
  <Function id="qiskit.quantum_info.StabilizerState.conjugate" github="https://github.com/Qiskit/qiskit/tree/stable/1.3/qiskit/quantum_info/states/stabilizerstate.py#L192-L196" signature="conjugate()">
    Return the conjugate of the operator.
  </Function>

  ### copy

  <Function id="qiskit.quantum_info.StabilizerState.copy" github="https://github.com/Qiskit/qiskit/tree/stable/1.3/qiskit/quantum_info/states/quantum_state.py#L74-L76" signature="copy()">
    Make a copy of current operator.
  </Function>

  ### dims

  <Function id="qiskit.quantum_info.StabilizerState.dims" github="https://github.com/Qiskit/qiskit/tree/stable/1.3/qiskit/quantum_info/states/quantum_state.py#L70-L72" signature="dims(qargs=None)">
    Return tuple of input dimension for specified subsystems.
  </Function>

  ### equiv

  <Function id="qiskit.quantum_info.StabilizerState.equiv" github="https://github.com/Qiskit/qiskit/tree/stable/1.3/qiskit/quantum_info/states/stabilizerstate.py#L323-L362" signature="equiv(other)">
  ...
  <Function id="qiskit.quantum_info.StabilizerState.evolve" github="https://github.com/Qiskit/qiskit/tree/stable/1.3/qiskit/quantum_info/states/stabilizerstate.py#L234-L256" signature="evolve(other, qargs=None)">
    Evolve a stabilizer state by a Clifford operator.

    **Parameters**

    *   **other** ([*Clifford*](quantum-info-clifford "qiskit.quantum_info.Clifford")  *or*[*QuantumCircuit*](circuit-quantum-circuit "qiskit.circuit.QuantumCircuit")  *or*[*qiskit.circuit.Instruction*](circuit-instruction "qiskit.circuit.Instruction")) – The Clifford operator to evolve by.
  ...
  <Function id="qiskit.quantum_info.StabilizerState.expand" github="https://github.com/Qiskit/qiskit/tree/stable/1.3/qiskit/quantum_info/states/stabilizerstate.py#L216-L232" signature="expand(other)">
  ...
  <Function id="qiskit.quantum_info.StabilizerState.expectation_value" github="https://github.com/Qiskit/qiskit/tree/stable/1.3/qiskit/quantum_info/states/stabilizerstate.py#L258-L321" signature="expectation_value(oper, qargs=None)">
    Compute the expectation value of a Pauli operator.

    **Parameters**

    *   **oper** ([*Pauli*](quantum-info-pauli "qiskit.quantum_info.Pauli")) – a Pauli operator to evaluate expval.
  ...
  <Function id="qiskit.quantum_info.StabilizerState.from_stabilizer_list" github="https://github.com/Qiskit/qiskit/tree/stable/1.3/qiskit/quantum_info/states/stabilizerstate.py#L109-L137" signature="from_stabilizer_list(stabilizers, allow_redundant=False, allow_underconstrained=False)" modifiers="classmethod">
  ...
  <Function id="qiskit.quantum_info.StabilizerState.is_valid" github="https://github.com/Qiskit/qiskit/tree/stable/1.3/qiskit/quantum_info/states/stabilizerstate.py#L150-L152" signature="is_valid(atol=None, rtol=None)">
    Return True if a valid StabilizerState.
  </Function>

  ### measure

  <Function id="qiskit.quantum_info.StabilizerState.measure" github="https://github.com/Qiskit/qiskit/tree/stable/1.3/qiskit/quantum_info/states/stabilizerstate.py#L487-L515" signature="measure(qargs=None)">
  ...
  <Function id="qiskit.quantum_info.StabilizerState.probabilities" github="https://github.com/Qiskit/qiskit/tree/stable/1.3/qiskit/quantum_info/states/stabilizerstate.py#L364-L388" signature="probabilities(qargs=None, decimals=None)">
  ...
  <Function id="qiskit.quantum_info.StabilizerState.probabilities_dict" github="https://github.com/Qiskit/qiskit/tree/stable/1.3/qiskit/quantum_info/states/stabilizerstate.py#L426-L448" signature="probabilities_dict(qargs=None, decimals=None)">
  ...
  <Function id="qiskit.quantum_info.StabilizerState.probabilities_dict_from_bitstring" github="https://github.com/Qiskit/qiskit/tree/stable/1.3/qiskit/quantum_info/states/stabilizerstate.py#L390-L424" signature="probabilities_dict_from_bitstring(outcome_bitstring, qargs=None, decimals=None)">
  ...
  <Function id="qiskit.quantum_info.StabilizerState.purity" github="https://github.com/Qiskit/qiskit/tree/stable/1.3/qiskit/quantum_info/states/stabilizerstate.py#L174-L186" signature="purity()">
  ...
  <Function id="qiskit.quantum_info.StabilizerState.reset" github="https://github.com/Qiskit/qiskit/tree/stable/1.3/qiskit/quantum_info/states/stabilizerstate.py#L450-L485" signature="reset(qargs=None)">
  ...
  <Function id="qiskit.quantum_info.StabilizerState.sample_counts" github="https://github.com/Qiskit/qiskit/tree/stable/1.3/qiskit/quantum_info/states/quantum_state.py#L277-L304" signature="sample_counts(shots, qargs=None)">
    ...
    **Return type**
    ...
    [Counts](result-counts "qiskit.result.Counts")
  ...
  <Function id="qiskit.quantum_info.StabilizerState.sample_memory" github="https://github.com/Qiskit/qiskit/tree/stable/1.3/qiskit/quantum_info/states/stabilizerstate.py#L517-L541" signature="sample_memory(shots, qargs=None)">
  ...
  <Function id="qiskit.quantum_info.StabilizerState.seed" github="https://github.com/Qiskit/qiskit/tree/stable/1.3/qiskit/quantum_info/states/quantum_state.py#L78-L85" signature="seed(value=None)">
    Set the seed for the quantum state RNG.
  </Function>

  ### tensor

  <Function id="qiskit.quantum_info.StabilizerState.tensor" github="https://github.com/Qiskit/qiskit/tree/stable/1.3/qiskit/quantum_info/states/stabilizerstate.py#L198-L214" signature="tensor(other)">
  ...
  <Function id="qiskit.quantum_info.StabilizerState.to_operator" github="https://github.com/Qiskit/qiskit/tree/stable/1.3/qiskit/quantum_info/states/stabilizerstate.py#L188-L190" signature="to_operator()">
  ...
  <Function id="qiskit.quantum_info.StabilizerState.trace" github="https://github.com/Qiskit/qiskit/tree/stable/1.3/qiskit/quantum_info/states/stabilizerstate.py#L160-L172" signature="trace()">
