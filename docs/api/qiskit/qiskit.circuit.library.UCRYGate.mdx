...
<Class id="qiskit.circuit.library.UCRYGate" github="https://github.com/qiskit/qiskit/tree/stable/1.0/qiskit/circuit/library/generalized_gates/ucry.py" signature="qiskit.circuit.library.UCRYGate(angle_list)">
