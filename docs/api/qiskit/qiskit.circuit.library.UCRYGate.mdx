...
<Class id="qiskit.circuit.library.UCRYGate" github="https://github.com/Qiskit/qiskit/tree/stable/1.0/qiskit/circuit/library/generalized_gates/ucry.py#L20-L32" signature="qiskit.circuit.library.UCRYGate(angle_list)">
