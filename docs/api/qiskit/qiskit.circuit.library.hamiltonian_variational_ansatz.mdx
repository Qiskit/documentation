...
$$
  ...
  ![Circuit diagram output by the previous code.](/docs/images/api/qiskit/qiskit-circuit-library-hamiltonian_variational_ansatz-1.avif)
  ...
  ![Circuit diagram output by the previous code.](/docs/images/api/qiskit/qiskit-circuit-library-hamiltonian_variational_ansatz-2.avif)
