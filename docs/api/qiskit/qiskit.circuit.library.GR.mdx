...
<Class id="qiskit.circuit.library.GR" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/circuit/library/generalized_gates/gr.py#L19-L70" signature="qiskit.circuit.library.GR(num_qubits, theta, phi)" modifiers="class">
...
$$
  ...
  *   **phi** ([*float*](https://docs.python.org/3/library/functions.html#float)) – angle of rotation axis in xy-plane
  ...
  <Attribute id="qiskit.circuit.library.GR.name" name="name" headingLevel={3}>
