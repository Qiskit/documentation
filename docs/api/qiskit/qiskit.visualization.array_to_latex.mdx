...
<Function id="qiskit.visualization.array_to_latex" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/visualization/array.py#L149-L207" signature="qiskit.visualization.array_to_latex(array, precision=10, prefix='', source=False, max_size=8)">
  ...
  *   [**MissingOptionalLibraryError**](/docs/api/qiskit/exceptions#qiskit.exceptions.MissingOptionalLibraryError "qiskit.exceptions.MissingOptionalLibraryError") – If `source` is `False` and `IPython.display.Latex` cannot be imported. Or if sympy is not installed.
</Function>
