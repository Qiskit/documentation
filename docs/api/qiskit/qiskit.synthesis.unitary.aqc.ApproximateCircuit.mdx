...
<Class id="qiskit.synthesis.unitary.aqc.ApproximateCircuit" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/synthesis/unitary/aqc/approximate.py#L21-L52" signature="qiskit.synthesis.unitary.aqc.ApproximateCircuit(num_qubits, name=None)" modifiers="class">
  ...
  *   **name** ([*str*](https://docs.python.org/3/library/stdtypes.html#str)) – a name of the circuit.
  ...
  <Attribute id="qiskit.synthesis.unitary.aqc.ApproximateCircuit.thetas" name="thetas" headingLevel={3}>
  ...
  <Attribute id="qiskit.synthesis.unitary.aqc.ApproximateCircuit.name" name="name" headingLevel={3}>
  ...
  <Function id="qiskit.synthesis.unitary.aqc.ApproximateCircuit.build" github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/synthesis/unitary/aqc/approximate.py#L43-L52" signature="build(thetas)" modifiers="abstractmethod">
