...
<Class id="qiskit.providers.ProviderV1" github="https://github.com/Qiskit/qiskit/tree/stable/1.0/qiskit/providers/provider.py#L32-L79" signature="qiskit.providers.ProviderV1">
