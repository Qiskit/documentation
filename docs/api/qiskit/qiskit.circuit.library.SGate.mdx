...
<Class id="qiskit.circuit.library.SGate" github="https://github.com/qiskit/qiskit/tree/stable/1.0/qiskit/circuit/library/standard_gates/s.py" signature="qiskit.circuit.library.SGate(*args, _force_mutable=False, **kwargs)">
...
$$
  ...
  **Circuit symbol:**
  ...
  <Function id="qiskit.circuit.library.SGate.inverse" name="inverse" signature="inverse(annotated=False)">
