...
<Class id="qiskit.circuit.library.SGate" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.0/qiskit/circuit/library/standard_gates/s.py#L29-L104" signature="qiskit.circuit.library.SGate(*args, _force_mutable=False, **kwargs)">
...
$$
  ...
  **Circuit symbol:**
  ...
  <Attribute id="qiskit.circuit.library.SGate.base_class" name="base_class">
  ...
  <Attribute id="qiskit.circuit.library.SGate.condition" name="condition">
    The classical condition on the instruction.
  </Attribute>

  ### condition\_bits

  <Attribute id="qiskit.circuit.library.SGate.condition_bits" name="condition_bits">
  ...
  <Attribute id="qiskit.circuit.library.SGate.duration" name="duration">
    Get the duration.
  </Attribute>

  ### label

  <Attribute id="qiskit.circuit.library.SGate.label" name="label">
    Return instruction label
  </Attribute>

  ### mutable

  <Attribute id="qiskit.circuit.library.SGate.mutable" name="mutable">
  ...
  <Attribute id="qiskit.circuit.library.SGate.name" name="name">
    Return the name.
  </Attribute>

  ### num\_clbits

  <Attribute id="qiskit.circuit.library.SGate.num_clbits" name="num_clbits">
    Return the number of clbits.
  </Attribute>

  ### num\_qubits

  <Attribute id="qiskit.circuit.library.SGate.num_qubits" name="num_qubits">
  ...
  <Attribute id="qiskit.circuit.library.SGate.unit" name="unit">
  ...
  <Function id="qiskit.circuit.library.SGate.inverse" name="inverse" github="https://github.com/Qiskit/qiskit/tree/stable/1.0/qiskit/circuit/library/standard_gates/s.py#L83-L95" signature="inverse(annotated=False)">
  ...
  <Function id="qiskit.circuit.library.SGate.power" name="power" github="https://github.com/Qiskit/qiskit/tree/stable/1.0/qiskit/circuit/library/standard_gates/s.py#L97-L101" signature="power(exponent)">
