...
<Class id="qiskit.primitives.BackendSamplerV2" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/2.3/qiskit/primitives/backend_sampler_v2.py#L81-L268" signature="qiskit.primitives.BackendSamplerV2(*, backend, options=None)" modifiers="class">
  ...
  *   **options** ([*dict*](https://docs.python.org/3/library/stdtypes.html#dict) *| None*) – The options to control the default shots (`default_shots`) and the random seed for the simulator (`seed_simulator`).
  ...
  <Function id="qiskit.primitives.BackendSamplerV2.run" github="https://github.com/Qiskit/qiskit/tree/stable/2.3/qiskit/primitives/backend_sampler_v2.py#L144-L153" signature="run(pubs, *, shots=None)">
    ...
    *   **pubs** ([*Iterable*](https://docs.python.org/3/library/typing.html#typing.Iterable)*\[SamplerPubLike]*) – An iterable of pub-like objects. For example, a list of circuits or tuples `(circuit, parameter_values)`.
