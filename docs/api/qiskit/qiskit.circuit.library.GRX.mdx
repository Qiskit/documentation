...
<Class id="qiskit.circuit.library.GRX" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/2.1/qiskit/circuit/library/generalized_gates/gr.py#L74-L120" signature="qiskit.circuit.library.GRX(num_qubits, theta)" modifiers="class">
...
$$
  ...
  *   **theta** ([*float*](https://docs.python.org/3/library/functions.html#float "(in Python v3.13)")) – rotation angle about x-axis
  ...
  <Attribute id="qiskit.circuit.library.GRX.instances" attributeValue="169" />
