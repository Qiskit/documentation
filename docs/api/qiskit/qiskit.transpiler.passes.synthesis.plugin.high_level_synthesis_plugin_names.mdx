...
<Function id="qiskit.transpiler.passes.synthesis.plugin.high_level_synthesis_plugin_names" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/2.2/qiskit/transpiler/passes/synthesis/plugin.py#L722-L738" signature="qiskit.transpiler.passes.synthesis.plugin.high_level_synthesis_plugin_names(op_name)">
