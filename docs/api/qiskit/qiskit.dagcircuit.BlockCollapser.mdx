...
<Class id="qiskit.dagcircuit.BlockCollapser" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/2.0/qiskit/dagcircuit/collect_blocks.py#L340-L407" signature="qiskit.dagcircuit.BlockCollapser(dag)" modifiers="class">
  ...
  **Raises**
  ...
  <Function id="qiskit.dagcircuit.BlockCollapser.collapse_to_operation" github="https://github.com/Qiskit/qiskit/tree/stable/2.0/qiskit/dagcircuit/collect_blocks.py#L358-L407" signature="collapse_to_operation(blocks, collapse_fn)">
