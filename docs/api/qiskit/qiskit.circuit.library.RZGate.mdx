...
<Class id="qiskit.circuit.library.RZGate" github="https://github.com/qiskit/qiskit/tree/stable/1.0/qiskit/circuit/library/standard_gates/rz.py" signature="qiskit.circuit.library.RZGate(phi, label=None, *, duration=None, unit='dt')">
...
$$
  ...
  <Function id="qiskit.circuit.library.RZGate.control" name="control" signature="control(num_ctrl_qubits=1, label=None, ctrl_state=None, annotated=False)">
  ...
  <Function id="qiskit.circuit.library.RZGate.inverse" name="inverse" signature="inverse(annotated=False)">
