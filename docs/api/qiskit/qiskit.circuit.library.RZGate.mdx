...
<Class id="qiskit.circuit.library.RZGate" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/2.4/qiskit/circuit/library/standard_gates/rz.py#L25-L164" signature="qiskit.circuit.library.RZGate(phi, label=None)" modifiers="class">
...
$$
  ...
  *   **label** ([*str*](https://docs.python.org/3/library/stdtypes.html#str) *| None*) – An optional label for the gate.
  ...
  <Function id="qiskit.circuit.library.RZGate.add_decomposition" github="https://github.com/Qiskit/qiskit/tree/stable/2.4/qiskit/circuit/instruction.py#L318-L323" signature="add_decomposition(decomposition)">
    Add a decomposition of the instruction to the SessionEquivalenceLibrary.
  </Function>

  ### broadcast\_arguments

  <Function id="qiskit.circuit.library.RZGate.broadcast_arguments" github="https://github.com/Qiskit/qiskit/tree/stable/2.4/qiskit/circuit/gate.py#L206-L263" signature="broadcast_arguments(qargs, cargs)">
  ...
  <Function id="qiskit.circuit.library.RZGate.control" github="https://github.com/Qiskit/qiskit/tree/stable/2.4/qiskit/circuit/library/standard_gates/rz.py#L89-L130" signature="control(num_ctrl_qubits=1, label=None, ctrl_state=None, annotated=None)">
  ...
  <Function id="qiskit.circuit.library.RZGate.copy" github="https://github.com/Qiskit/qiskit/tree/stable/2.4/qiskit/circuit/instruction.py#L428-L443" signature="copy(name=None)">
  ...
  <Function id="qiskit.circuit.library.RZGate.inverse" github="https://github.com/Qiskit/qiskit/tree/stable/2.4/qiskit/circuit/library/standard_gates/rz.py#L132-L146" signature="inverse(annotated=False)">
  ...
  <Function id="qiskit.circuit.library.RZGate.is_parameterized" github="https://github.com/Qiskit/qiskit/tree/stable/2.4/qiskit/circuit/instruction.py#L283-L288" signature="is_parameterized()">
    Return whether the `Instruction` contains [compile-time parameters](circuit#circuit-compile-time-parameters).
  </Function>

  ### power

  <Function id="qiskit.circuit.library.RZGate.power" github="https://github.com/Qiskit/qiskit/tree/stable/2.4/qiskit/circuit/library/standard_gates/rz.py#L157-L159" signature="power(exponent, annotated=False)">
  ...
  <Function id="qiskit.circuit.library.RZGate.repeat" github="https://github.com/Qiskit/qiskit/tree/stable/2.4/qiskit/circuit/instruction.py#L491-L521" signature="repeat(n)">
  ...
  <Function id="qiskit.circuit.library.RZGate.reverse_ops" github="https://github.com/Qiskit/qiskit/tree/stable/2.4/qiskit/circuit/instruction.py#L345-L369" signature="reverse_ops()">
  ...
  <Function id="qiskit.circuit.library.RZGate.soft_compare" github="https://github.com/Qiskit/qiskit/tree/stable/2.4/qiskit/circuit/instruction.py#L214-L254" signature="soft_compare(other)">
  ...
  <Function id="qiskit.circuit.library.RZGate.to_matrix" github="https://github.com/Qiskit/qiskit/tree/stable/2.4/qiskit/circuit/gate.py#L49-L61" signature="to_matrix()">
  ...
  <Function id="qiskit.circuit.library.RZGate.to_mutable" github="https://github.com/Qiskit/qiskit/tree/stable/2.4/qiskit/circuit/instruction.py#L144-L152" signature="to_mutable()">
  ...
  <Function id="qiskit.circuit.library.RZGate.validate_parameter" github="https://github.com/Qiskit/qiskit/tree/stable/2.4/qiskit/circuit/gate.py#L265-L279" signature="validate_parameter(parameter)">
