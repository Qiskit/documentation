...
<Class id="qiskit.circuit.library.RZGate" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.0/qiskit/circuit/library/standard_gates/rz.py#L22-L148" signature="qiskit.circuit.library.RZGate(phi, label=None, *, duration=None, unit='dt')">
...
$$
  ...
  <Attribute id="qiskit.circuit.library.RZGate.base_class" name="base_class">
  ...
  <Attribute id="qiskit.circuit.library.RZGate.condition" name="condition">
    The classical condition on the instruction.
  </Attribute>

  ### condition\_bits

  <Attribute id="qiskit.circuit.library.RZGate.condition_bits" name="condition_bits">
  ...
  <Attribute id="qiskit.circuit.library.RZGate.duration" name="duration">
    Get the duration.
  </Attribute>

  ### label

  <Attribute id="qiskit.circuit.library.RZGate.label" name="label">
    Return instruction label
  </Attribute>

  ### mutable

  <Attribute id="qiskit.circuit.library.RZGate.mutable" name="mutable">
  ...
  <Attribute id="qiskit.circuit.library.RZGate.name" name="name">
    Return the name.
  </Attribute>

  ### num\_clbits

  <Attribute id="qiskit.circuit.library.RZGate.num_clbits" name="num_clbits">
    Return the number of clbits.
  </Attribute>

  ### num\_qubits

  <Attribute id="qiskit.circuit.library.RZGate.num_qubits" name="num_qubits">
  ...
  <Attribute id="qiskit.circuit.library.RZGate.unit" name="unit">
  ...
  <Function id="qiskit.circuit.library.RZGate.control" name="control" github="https://github.com/Qiskit/qiskit/tree/stable/1.0/qiskit/circuit/library/standard_gates/rz.py#L85-L115" signature="control(num_ctrl_qubits=1, label=None, ctrl_state=None, annotated=False)">
  ...
  <Function id="qiskit.circuit.library.RZGate.inverse" name="inverse" github="https://github.com/Qiskit/qiskit/tree/stable/1.0/qiskit/circuit/library/standard_gates/rz.py#L117-L131" signature="inverse(annotated=False)">
  ...
  <Function id="qiskit.circuit.library.RZGate.power" name="power" github="https://github.com/Qiskit/qiskit/tree/stable/1.0/qiskit/circuit/library/standard_gates/rz.py#L140-L143" signature="power(exponent)">
