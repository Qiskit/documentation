...
<Function id="qiskit.pulse.builder.control_channels" github="https://github.com/qiskit/qiskit/tree/stable/0.21/qiskit/pulse/builder.py" signature="control_channels(*qubits)">
