...
<Class id="qiskit.providers.ibmq.managed.IBMQJobManagerError" name="IBMQJobManagerError" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-ibmq-provider/tree/stable/0.19/qiskit/providers/ibmq/managed/exceptions.py" signature="IBMQJobManagerError(*message)">
