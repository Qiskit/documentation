...
<Function id="qiskit.qpy.load" github="https://github.com/qiskit/qiskit/tree/stable/0.21/qiskit/qpy/interface.py" signature="load(file_obj, metadata_deserializer=None)">
