---
title: Barrier (v0.38)
description: API reference for qiskit.circuit.library.Barrier in qiskit v0.38
...
<Class id="qiskit.circuit.library.Barrier" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.21/qiskit/circuit/barrier.py" signature="Barrier(num_qubits)" modifiers="class">
