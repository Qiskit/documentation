---
title: Job (v0.38)
description: API reference for qiskit.providers.Job in qiskit v0.38
...
<Class id="qiskit.providers.Job" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.21/qiskit/providers/job.py" signature="Job" modifiers="class">
  Bases: `object`
