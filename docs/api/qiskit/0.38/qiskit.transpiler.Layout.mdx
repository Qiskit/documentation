---
title: Layout (v0.38)
description: API reference for qiskit.transpiler.Layout in qiskit v0.38
...
<Class id="qiskit.transpiler.Layout" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.21/qiskit/transpiler/layout.py" signature="Layout(input_dict=None)" modifiers="class">
  Bases: `object`
