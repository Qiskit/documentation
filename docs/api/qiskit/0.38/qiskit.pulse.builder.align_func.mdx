---
title: align_func (v0.38)
description: API reference for qiskit.pulse.builder.align_func in qiskit v0.38
...
<Function id="qiskit.pulse.builder.align_func" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.21/qiskit/pulse/builder.py" signature="align_func(duration, func)">
  ...
  ![../\_images/qiskit.pulse.builder.align\_func\_0\_0.png](/docs/images/api/qiskit/0.38/qiskit.pulse.builder.align_func_0_0.avif)
