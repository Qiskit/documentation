---
title: FourierChecking (v0.38)
description: API reference for qiskit.circuit.library.FourierChecking in qiskit v0.38
...
<Class id="qiskit.circuit.library.FourierChecking" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.21/qiskit/circuit/library/fourier_checking.py" signature="FourierChecking(f, g)" modifiers="class">
  ...
  **Reference Circuit:**
  ...
  <Attribute id="qiskit.circuit.library.FourierChecking.instances" attributeValue="87" />
