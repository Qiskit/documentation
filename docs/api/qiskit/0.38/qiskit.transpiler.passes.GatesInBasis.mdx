---
title: GatesInBasis (v0.38)
description: API reference for qiskit.transpiler.passes.GatesInBasis in qiskit v0.38
...
<Class id="qiskit.transpiler.passes.GatesInBasis" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.21/qiskit/transpiler/passes/utils/gates_basis.py" signature="GatesInBasis(*args, **kwargs)" modifiers="class">
