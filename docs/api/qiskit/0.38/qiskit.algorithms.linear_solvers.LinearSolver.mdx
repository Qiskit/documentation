...
<Class id="qiskit.algorithms.linear_solvers.LinearSolver" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.21/qiskit/algorithms/linear_solvers/linear_solver.py" signature="LinearSolver">
  Bases: `abc.ABC`
  ...
  <Function id="qiskit.algorithms.linear_solvers.LinearSolver.solve" name="solve" signature="abstract LinearSolver.solve(matrix, vector, observable=None, observable_circuit=None, post_processing=None)">
