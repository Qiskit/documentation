...
<Class id="qiskit.pulse.channels.AcquireChannel" github="https://github.com/qiskit/qiskit/tree/stable/0.21/qiskit/pulse/channels.py" signature="AcquireChannel(index)">
