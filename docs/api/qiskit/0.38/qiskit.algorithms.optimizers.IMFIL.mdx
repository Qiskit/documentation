---
title: IMFIL (v0.38)
description: API reference for qiskit.algorithms.optimizers.IMFIL in qiskit v0.38
...
<Class id="qiskit.algorithms.optimizers.IMFIL" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.21/qiskit/algorithms/optimizers/imfil.py" signature="IMFIL(maxiter=1000)" modifiers="class">
