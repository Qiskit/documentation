...
<Class id="qiskit.providers.BackendPropertyError" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.21/qiskit/providers/exceptions.py" signature="BackendPropertyError(*message)">
