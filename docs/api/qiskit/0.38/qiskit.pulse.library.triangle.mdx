---
title: triangle (v0.38)
description: API reference for qiskit.pulse.library.triangle in qiskit v0.38
...
<Function id="qiskit.pulse.library.triangle" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.21/qiskit/pulse/library/discrete.py" signature="triangle(duration, amp, freq=None, phase=0, name=None)">
...
$$
  ...
  **Example**
  ...
  ![../\_images/qiskit.pulse.library.triangle\_0\_1.png](/docs/images/api/qiskit/0.38/qiskit.pulse.library.triangle_0_1.avif)
