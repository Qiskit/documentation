---
title: QFI (v0.38)
description: API reference for qiskit.opflow.gradients.QFI in qiskit v0.38
...
<Class id="qiskit.opflow.gradients.QFI" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.21/qiskit/opflow/gradients/qfi.py" signature="QFI(qfi_method='lin_comb_full')" modifiers="class">
