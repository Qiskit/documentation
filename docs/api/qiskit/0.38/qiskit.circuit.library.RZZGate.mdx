---
title: RZZGate (v0.38)
description: API reference for qiskit.circuit.library.RZZGate in qiskit v0.38
...
<Class id="qiskit.circuit.library.RZZGate" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.21/qiskit/circuit/library/standard_gates/rzz.py" signature="RZZGate(theta, label=None)" modifiers="class">
