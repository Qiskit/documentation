...
<Function id="qiskit.utils.deprecate_arguments" name="deprecate_arguments" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.21/qiskit/utils/deprecation.py" signature="deprecate_arguments(kwarg_map)">
