...
<Class id="qiskit.opflow.evolutions.Suzuki" github="https://github.com/qiskit/qiskit/tree/stable/0.21/qiskit/opflow/evolutions/trotterizations/suzuki.py" signature="Suzuki(reps=1, order=2)">
