...
<Function id="qiskit.pulse.transforms.block_to_dag" name="block_to_dag" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.21/qiskit/pulse/transforms/dag.py" signature="block_to_dag(block)">
