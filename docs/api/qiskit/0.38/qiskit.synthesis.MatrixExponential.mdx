---
title: MatrixExponential (v0.38)
description: API reference for qiskit.synthesis.MatrixExponential in qiskit v0.38
...
<Class id="qiskit.synthesis.MatrixExponential" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.21/qiskit/synthesis/evolution/matrix_synthesis.py" signature="MatrixExponential" modifiers="class">
