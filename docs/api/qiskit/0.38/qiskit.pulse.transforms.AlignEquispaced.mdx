...
<Class id="qiskit.pulse.transforms.AlignEquispaced" github="https://github.com/qiskit/qiskit/tree/stable/0.21/qiskit/pulse/transforms/alignments.py" signature="AlignEquispaced(duration)">
