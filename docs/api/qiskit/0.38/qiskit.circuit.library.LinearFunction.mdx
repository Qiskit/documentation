---
title: LinearFunction (v0.38)
description: API reference for qiskit.circuit.library.LinearFunction in qiskit v0.38
...
<Class id="qiskit.circuit.library.LinearFunction" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.21/qiskit/circuit/library/generalized_gates/linear_function.py" signature="LinearFunction(linear, validate_input=False)" modifiers="class">
