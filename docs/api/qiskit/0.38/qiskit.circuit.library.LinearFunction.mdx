...
<Class id="qiskit.circuit.library.LinearFunction" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.21/qiskit/circuit/library/generalized_gates/linear_function.py" signature="LinearFunction(linear, validate_input=False)">
...
$$
  ...
  **CircuitError** – if the input is invalid: either a matrix is non \{square, invertible}, or a quantum circuit contains non-linear gates.
  ...
  <Function id="qiskit.circuit.library.LinearFunction.is_permutation" name="is_permutation" signature="LinearFunction.is_permutation()">
  ...
  <Function id="qiskit.circuit.library.LinearFunction.permutation_pattern" name="permutation_pattern" signature="LinearFunction.permutation_pattern()">
  ...
  <Function id="qiskit.circuit.library.LinearFunction.synthesize" name="synthesize" signature="LinearFunction.synthesize()">
  ...
  <Function id="qiskit.circuit.library.LinearFunction.validate_parameter" name="validate_parameter" signature="LinearFunction.validate_parameter(parameter)">
