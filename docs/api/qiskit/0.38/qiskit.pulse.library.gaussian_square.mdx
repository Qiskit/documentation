---
title: gaussian_square (v0.38)
description: API reference for qiskit.pulse.library.gaussian_square in qiskit v0.38
...
<Function id="qiskit.pulse.library.gaussian_square" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.21/qiskit/pulse/library/discrete.py" signature="gaussian_square(duration, amp, sigma, risefall=None, width=None, name=None, zero_ends=True)">
