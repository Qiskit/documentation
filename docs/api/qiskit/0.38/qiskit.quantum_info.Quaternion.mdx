---
title: Quaternion (v0.38)
description: API reference for qiskit.quantum_info.Quaternion in qiskit v0.38
...
<Class id="qiskit.quantum_info.Quaternion" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.21/qiskit/quantum_info/synthesis/quaternion.py" signature="Quaternion(data)" modifiers="class">
  Bases: `object`
