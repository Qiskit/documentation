...
<Class id="qiskit.algorithms.optimizers.UMDA" github="https://github.com/qiskit/qiskit/tree/stable/0.21/qiskit/algorithms/optimizers/umda.py" signature="UMDA(maxiter=100, size_gen=20, alpha=0.5)">
  ...
  *   **alpha** (`float`) – Percentage (0, 1] of the population to be selected as elite selection.
  ...
  <Function id="qiskit.algorithms.optimizers.UMDA.gradient_num_diff" name="gradient_num_diff" signature="static UMDA.gradient_num_diff(x_center, f, epsilon, max_evals_grouped=1)">
