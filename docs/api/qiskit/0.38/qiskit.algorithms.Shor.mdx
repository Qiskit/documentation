---
title: Shor (v0.38)
description: API reference for qiskit.algorithms.Shor in qiskit v0.38
...
<Class id="qiskit.algorithms.Shor" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.21/qiskit/algorithms/factorizers/shor.py" signature="Shor(quantum_instance=None)" modifiers="class">
  Bases: `object`
