---
title: StagedPassManager (v0.38)
description: API reference for qiskit.transpiler.StagedPassManager in qiskit v0.38
...
<Class id="qiskit.transpiler.StagedPassManager" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.21/qiskit/transpiler/passmanager.py" signature="StagedPassManager(stages=None, **kwargs)" modifiers="class">
