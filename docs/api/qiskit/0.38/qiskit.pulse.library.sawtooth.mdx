---
title: sawtooth (v0.38)
description: API reference for qiskit.pulse.library.sawtooth in qiskit v0.38
...
$$
  ...
  **Example**
  ...
  ![../\_images/qiskit.pulse.library.sawtooth\_0\_1.png](/docs/images/api/qiskit/0.38/qiskit.pulse.library.sawtooth_0_1.avif)
