...
<Class id="qiskit.algorithms.linear_solvers.NumPyLinearSolver" github="https://github.com/qiskit/qiskit/tree/stable/0.21/qiskit/algorithms/linear_solvers/numpy_linear_solver.py" signature="NumPyLinearSolver">
