...
<Class id="qiskit.transpiler.passes.PadDynamicalDecoupling" github="https://github.com/qiskit/qiskit/tree/stable/0.21/qiskit/transpiler/passes/scheduling/padding/dynamical_decoupling.py" signature="PadDynamicalDecoupling(durations, dd_sequence, qubits=None, spacing=None, skip_reset_qubits=True, pulse_alignment=1, extra_slack_distribution='middle')">
  ...
  ![../\_images/qiskit.transpiler.passes.PadDynamicalDecoupling\_1\_0.png](/images/api/qiskit/0.38/qiskit.transpiler.passes.PadDynamicalDecoupling_1_0.png)
  ...
  ![../\_images/qiskit.transpiler.passes.PadDynamicalDecoupling\_2\_0.png](/images/api/qiskit/0.38/qiskit.transpiler.passes.PadDynamicalDecoupling_2_0.png)
  ...
  *   [**TranspilerError**](qiskit.transpiler.TranspilerError "qiskit.transpiler.TranspilerError") – When pulse gate with the duration which is non-multiple of the alignment constraint value is found.
  ...
  <Function id="qiskit.transpiler.passes.PadDynamicalDecoupling.name" name="name" signature="PadDynamicalDecoupling.name()">
    Return the name of the pass.
  </Function>

  ### run

  <Function id="qiskit.transpiler.passes.PadDynamicalDecoupling.run" name="run" signature="PadDynamicalDecoupling.run(dag)">
