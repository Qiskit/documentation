...
<Class id="qiskit.qobj.PulseQobjExperiment" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.21/qiskit/qobj/pulse_qobj.py" signature="PulseQobjExperiment(instructions, config=None, header=None)">
  Bases: `object`
