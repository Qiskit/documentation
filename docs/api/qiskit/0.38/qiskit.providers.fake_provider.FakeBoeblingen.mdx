---
title: FakeBoeblingen (v0.38)
description: API reference for qiskit.providers.fake_provider.FakeBoeblingen in qiskit v0.38
...
<Class id="qiskit.providers.fake_provider.FakeBoeblingen" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.21/qiskit/providers/fake_provider/backends/boeblingen/fake_boeblingen.py" signature="FakeBoeblingen" modifiers="class">
