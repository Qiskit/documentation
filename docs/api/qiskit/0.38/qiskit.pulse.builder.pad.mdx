---
title: pad (v0.38)
description: API reference for qiskit.pulse.builder.pad in qiskit v0.38
...
<Function id="qiskit.pulse.builder.pad" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.21/qiskit/pulse/builder.py" signature="pad(*chs)">
