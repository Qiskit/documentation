...
<Function id="qiskit.pulse.transforms.add_implicit_acquires" name="add_implicit_acquires" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.21/qiskit/pulse/transforms/canonicalization.py" signature="add_implicit_acquires(schedule, meas_map)">
