...
<Class id="qiskit.dagcircuit.DAGDependency" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.21/qiskit/dagcircuit/dagdependency.py" signature="DAGDependency">
  Bases: `object`
  ...
  **Reference:**
  ...
  <Function id="qiskit.dagcircuit.DAGDependency.to_networkx" name="to_networkx" signature="DAGDependency.to_networkx()">
