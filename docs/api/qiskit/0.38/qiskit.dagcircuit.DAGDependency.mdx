---
title: DAGDependency (v0.38)
description: API reference for qiskit.dagcircuit.DAGDependency in qiskit v0.38
...
<Class id="qiskit.dagcircuit.DAGDependency" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.21/qiskit/dagcircuit/dagdependency.py" signature="DAGDependency" modifiers="class">
  Bases: `object`
  ...
  **Reference:**
  ...
  <span id="qiskit-dagcircuit-dagdependency-to-networkx" />
