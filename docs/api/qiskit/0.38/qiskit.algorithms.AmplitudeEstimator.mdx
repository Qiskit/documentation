---
title: AmplitudeEstimator (v0.38)
description: API reference for qiskit.algorithms.AmplitudeEstimator in qiskit v0.38
...
<Class id="qiskit.algorithms.AmplitudeEstimator" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.21/qiskit/algorithms/amplitude_estimators/amplitude_estimator.py" signature="AmplitudeEstimator" modifiers="class">
  Bases: `abc.ABC`
