...
<Class id="qiskit.algorithms.AmplitudeEstimator" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.21/qiskit/algorithms/amplitude_estimators/amplitude_estimator.py" signature="AmplitudeEstimator">
  Bases: `abc.ABC`
