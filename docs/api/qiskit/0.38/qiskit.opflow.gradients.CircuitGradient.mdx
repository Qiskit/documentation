...
<Class id="qiskit.opflow.gradients.CircuitGradient" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.21/qiskit/opflow/gradients/circuit_gradients/circuit_gradient.py" signature="CircuitGradient">
  ...
  <Function id="qiskit.opflow.gradients.CircuitGradient.convert" name="convert" signature="abstract CircuitGradient.convert(operator, params=None)">
    **Parameters**
