...
<Class id="qiskit_aer.noise.NoiseModel" github="https://github.com/qiskit/qiskit-aer/tree/stable/0.11/qiskit_aer/noise/noise_model.py" signature="NoiseModel(basis_gates=None)">
  Bases: `object`
