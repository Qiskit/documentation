...
<Function id="qiskit.pulse.builder.set_frequency" name="set_frequency" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.21/qiskit/pulse/builder.py" signature="set_frequency(frequency, channel, name=None)">
