...
`FakeJohannesburg` [GitHub](https://github.com/qiskit/qiskit/tree/stable/0.21/qiskit/providers/fake_provider/backends/johannesburg/fake_johannesburg.py "view source code")
...
<span id="qiskit.providers.fake_provider.FakeJohannesburg.defaults" />

`FakeJohannesburg.defaults()`
...
<span id="qiskit.providers.fake_provider.FakeJohannesburg.defs_filename" />

### defs\_filename

`= 'defs_johannesburg.json'`
