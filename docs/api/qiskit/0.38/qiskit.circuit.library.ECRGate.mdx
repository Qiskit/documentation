---
title: ECRGate (v0.38)
description: API reference for qiskit.circuit.library.ECRGate in qiskit v0.38
...
<Class id="qiskit.circuit.library.ECRGate" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.21/qiskit/circuit/library/standard_gates/ecr.py" signature="ECRGate" modifiers="class">
