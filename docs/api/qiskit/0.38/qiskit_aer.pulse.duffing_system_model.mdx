---
title: duffing_system_model (v0.38)
description: API reference for qiskit_aer.pulse.duffing_system_model in qiskit v0.38
in_page_toc_min_heading_level: 1
python_api_type: function
python_api_name: qiskit_aer.pulse.duffing_system_model
---

<span id="qiskit-aer-pulse-duffing-system-model" />

# qiskit\_aer.pulse.duffing\_system\_model

<Function id="qiskit_aer.pulse.duffing_system_model" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-aer/tree/stable/0.11/qiskit_aer/pulse/system_models/duffing_model_generators.py" signature="duffing_system_model(dim_oscillators, oscillator_freqs, anharm_freqs, drive_strengths, coupling_dict, dt)">
