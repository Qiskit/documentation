...
<Function id="qiskit.pulse.transforms.remove_trivial_barriers" name="remove_trivial_barriers" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.21/qiskit/pulse/transforms/canonicalization.py" signature="remove_trivial_barriers(schedule)">
