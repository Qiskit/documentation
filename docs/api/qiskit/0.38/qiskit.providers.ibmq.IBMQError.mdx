...
<Class id="qiskit.providers.ibmq.IBMQError" github="https://github.com/qiskit/qiskit-ibmq-provider/tree/stable/0.19/qiskit/providers/ibmq/exceptions.py" signature="IBMQError(*message)">
