...
<Class id="qiskit.primitives.EstimatorResult" github="https://github.com/qiskit/qiskit/tree/stable/0.21/qiskit/primitives/estimator_result.py" signature="EstimatorResult(values, metadata)">
  Bases: `object`
