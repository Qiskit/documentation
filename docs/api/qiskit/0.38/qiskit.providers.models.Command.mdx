...
<Class id="qiskit.providers.models.Command" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.21/qiskit/providers/models/pulsedefaults.py" signature="Command(name, qubits=None, sequence=None, **kwargs)">
  Bases: `object`
