...
<Function id="qiskit.qasm3.dump" name="dump" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.21/qiskit/qasm3/__init__.py" signature="dump(circuit, stream, **kwargs)">
