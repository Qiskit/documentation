---
title: IGate (v0.38)
description: API reference for qiskit.circuit.library.IGate in qiskit v0.38
...
<Class id="qiskit.circuit.library.IGate" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.21/qiskit/circuit/library/standard_gates/i.py" signature="IGate(label=None)" modifiers="class">
