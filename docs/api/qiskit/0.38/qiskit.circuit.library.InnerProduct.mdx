---
title: InnerProduct (v0.38)
description: API reference for qiskit.circuit.library.InnerProduct in qiskit v0.38
...
<Class id="qiskit.circuit.library.InnerProduct" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.21/qiskit/circuit/library/boolean_logic/inner_product.py" signature="InnerProduct(num_qubits)" modifiers="class">
...
$$
  ...
  **num\_qubits** (`int`) – width of top and bottom registers (half total circuit width)
  ...
  <Attribute id="qiskit.circuit.library.InnerProduct.instances" attributeValue="87" />
