...
`ParameterVector.index(value)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.21/qiskit/circuit/parametervector.py "view source code")
...
`ParameterVector.resize(length)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.21/qiskit/circuit/parametervector.py "view source code")
