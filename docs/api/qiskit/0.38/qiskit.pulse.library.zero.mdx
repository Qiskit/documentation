...
<Function id="qiskit.pulse.library.zero" github="https://github.com/qiskit/qiskit/tree/stable/0.21/qiskit/pulse/library/discrete.py" signature="zero(duration, name=None)">
