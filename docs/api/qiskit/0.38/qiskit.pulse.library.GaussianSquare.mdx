...
<Class id="qiskit.pulse.library.GaussianSquare" github="https://github.com/qiskit/qiskit/tree/stable/0.21/qiskit/pulse/library/symbolic_pulses.py" signature="GaussianSquare(duration, amp, sigma, width=None, risefall_sigma_ratio=None, name=None, limit_amplitude=None)">
  ...
  **Raises**
  ...
  <Function id="qiskit.pulse.library.GaussianSquare.draw" name="draw" signature="GaussianSquare.draw(style=None, backend=None, time_range=None, time_unit='dt', show_waveform_info=True, plotter='mpl2d', axis=None)">
  ...
  <Attribute id="qiskit.pulse.library.GaussianSquare.constraints" name="constraints">
  ...
  <Attribute id="qiskit.pulse.library.GaussianSquare.duration" name="duration" />

  ### envelope

  <Attribute id="qiskit.pulse.library.GaussianSquare.envelope" name="envelope">
  ...
  <Attribute id="qiskit.pulse.library.GaussianSquare.name" name="name" />
  ...
  <Attribute id="qiskit.pulse.library.GaussianSquare.pulse_type" name="pulse_type">
  ...
  <Attribute id="qiskit.pulse.library.GaussianSquare.valid_amp_conditions" name="valid_amp_conditions">
