---
title: Backend (v0.38)
description: API reference for qiskit.providers.Backend in qiskit v0.38
...
<Class id="qiskit.providers.Backend" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.21/qiskit/providers/backend.py" signature="Backend" modifiers="class">
  Bases: `object`
