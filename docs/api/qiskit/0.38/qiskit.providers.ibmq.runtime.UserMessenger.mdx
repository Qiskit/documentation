---
title: UserMessenger (v0.38)
description: API reference for qiskit.providers.ibmq.runtime.UserMessenger in qiskit v0.38
...
<Class id="qiskit.providers.ibmq.runtime.UserMessenger" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-ibmq-provider/tree/stable/0.19/qiskit/providers/ibmq/runtime/program/user_messenger.py" signature="UserMessenger" modifiers="class">
  Bases: `object`
