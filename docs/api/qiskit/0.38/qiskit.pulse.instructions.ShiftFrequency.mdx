---
title: ShiftFrequency (v0.38)
description: API reference for qiskit.pulse.instructions.ShiftFrequency in qiskit v0.38
...
<Class id="qiskit.pulse.instructions.ShiftFrequency" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.21/qiskit/pulse/instructions/frequency.py" signature="ShiftFrequency(frequency, channel, name=None)" modifiers="class">
