---
title: FakeQuito (v0.38)
description: API reference for qiskit.providers.fake_provider.FakeQuito in qiskit v0.38
...
<Class id="qiskit.providers.fake_provider.FakeQuito" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.21/qiskit/providers/fake_provider/backends/quito/fake_quito.py" signature="FakeQuito" modifiers="class">
