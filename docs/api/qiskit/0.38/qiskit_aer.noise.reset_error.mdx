---
title: reset_error (v0.38)
description: API reference for qiskit_aer.noise.reset_error in qiskit v0.38
in_page_toc_min_heading_level: 1
python_api_type: function
python_api_name: qiskit_aer.noise.reset_error
---

<span id="qiskit-aer-noise-reset-error" />

# qiskit\_aer.noise.reset\_error

<Function id="qiskit_aer.noise.reset_error" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-aer/tree/stable/0.11/qiskit_aer/noise/errors/standard_errors.py" signature="reset_error(prob0, prob1=0)">
