...
<Class id="qiskit_aer.utils.NoiseTransformer" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-aer/tree/stable/0.11/qiskit_aer/utils/noise_transformation.py" signature="NoiseTransformer">
  Bases: `object`
  ...
  <Function id="qiskit_aer.utils.NoiseTransformer.compute_channel_operation" signature="static NoiseTransformer.compute_channel_operation(rho, operators)">
  ...
  <Function id="qiskit_aer.utils.NoiseTransformer.fidelity" signature="static NoiseTransformer.fidelity(channel)">
    Calculates channel fidelity
  </Function>

  ### flatten\_matrix

  <Function id="qiskit_aer.utils.NoiseTransformer.flatten_matrix" signature="static NoiseTransformer.flatten_matrix(m)">
    **Parameters**
  ...
  <Function id="qiskit_aer.utils.NoiseTransformer.get_const_matrix_from_channel" signature="static NoiseTransformer.get_const_matrix_from_channel(channel, symbols)">
  ...
  <Function id="qiskit_aer.utils.NoiseTransformer.get_matrix_from_channel" signature="static NoiseTransformer.get_matrix_from_channel(channel, symbol)">
  ...
  <Function id="qiskit_aer.utils.NoiseTransformer.prepare_channel_operator_list" signature="static NoiseTransformer.prepare_channel_operator_list(ops_list)">
