...
<Class id="qiskit.transpiler.synthesis.aqc.CNOTUnitObjective" github="https://github.com/qiskit/qiskit/tree/stable/0.21/qiskit/transpiler/synthesis/aqc/cnot_unit_objective.py" signature="CNOTUnitObjective(num_qubits, cnots)">
