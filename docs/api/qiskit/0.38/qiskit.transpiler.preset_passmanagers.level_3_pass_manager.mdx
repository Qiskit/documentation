...
<Function id="qiskit.transpiler.preset_passmanagers.level_3_pass_manager" name="level_3_pass_manager" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.21/qiskit/transpiler/preset_passmanagers/level3.py" signature="level_3_pass_manager(pass_manager_config)">
