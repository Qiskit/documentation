---
title: Choi (v0.38)
description: API reference for qiskit.quantum_info.Choi in qiskit v0.38
...
<Class id="qiskit.quantum_info.Choi" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.21/qiskit/quantum_info/operators/channel/choi.py" signature="Choi(data, input_dims=None, output_dims=None)" modifiers="class">
