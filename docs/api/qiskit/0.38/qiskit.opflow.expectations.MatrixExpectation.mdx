...
<Class id="qiskit.opflow.expectations.MatrixExpectation" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.21/qiskit/opflow/expectations/matrix_expectation.py" signature="MatrixExpectation">
  ...
  <Function id="qiskit.opflow.expectations.MatrixExpectation.compute_variance" name="compute_variance" signature="MatrixExpectation.compute_variance(exp_op)">
  ...
  <Function id="qiskit.opflow.expectations.MatrixExpectation.convert" name="convert" signature="MatrixExpectation.convert(operator)">
