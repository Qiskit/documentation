...
<Class id="qiskit.opflow.expectations.MatrixExpectation" github="https://github.com/qiskit/qiskit/tree/stable/0.21/qiskit/opflow/expectations/matrix_expectation.py" signature="MatrixExpectation">
