...
<Class id="qiskit.opflow.list_ops.SummedOp" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.21/qiskit/opflow/list_ops/summed_op.py" signature="SummedOp(oplist, coeff=1.0, abelian=False)">
  ...
  *   **abelian** (`bool`) – Indicates whether the Operators in `oplist` are known to mutually commute.
  ...
  <Function id="qiskit.opflow.list_ops.SummedOp.add" name="add" signature="SummedOp.add(other)">
  ...
  <Function id="qiskit.opflow.list_ops.SummedOp.collapse_summands" name="collapse_summands" signature="SummedOp.collapse_summands()">
  ...
  <Function id="qiskit.opflow.list_ops.SummedOp.equals" name="equals" signature="SummedOp.equals(other)">
  ...
  <Function id="qiskit.opflow.list_ops.SummedOp.reduce" name="reduce" signature="SummedOp.reduce()">
  ...
  <Function id="qiskit.opflow.list_ops.SummedOp.to_circuit" name="to_circuit" signature="SummedOp.to_circuit()">
  ...
  <Function id="qiskit.opflow.list_ops.SummedOp.to_matrix_op" name="to_matrix_op" signature="SummedOp.to_matrix_op(massive=False)">
  ...
  <Function id="qiskit.opflow.list_ops.SummedOp.to_pauli_op" name="to_pauli_op" signature="SummedOp.to_pauli_op(massive=False)">
  ...
  <Attribute id="qiskit.opflow.list_ops.SummedOp.INDENTATION" name="INDENTATION" attributeValue="'  '" />

  ### abelian

  <Attribute id="qiskit.opflow.list_ops.SummedOp.abelian" name="abelian">
  ...
  <Attribute id="qiskit.opflow.list_ops.SummedOp.coeff" name="coeff">
  ...
  <Attribute id="qiskit.opflow.list_ops.SummedOp.coeffs" name="coeffs">
  ...
  <Attribute id="qiskit.opflow.list_ops.SummedOp.combo_fn" name="combo_fn">
  ...
  <Attribute id="qiskit.opflow.list_ops.SummedOp.distributive" name="distributive">
    **Return type**
  ...
  <Attribute id="qiskit.opflow.list_ops.SummedOp.grad_combo_fn" name="grad_combo_fn">
  ...
  <Attribute id="qiskit.opflow.list_ops.SummedOp.instance_id" name="instance_id">
  ...
  <Attribute id="qiskit.opflow.list_ops.SummedOp.num_qubits" name="num_qubits">
    **Return type**
  ...
  <Attribute id="qiskit.opflow.list_ops.SummedOp.oplist" name="oplist">
  ...
  <Attribute id="qiskit.opflow.list_ops.SummedOp.parameters" name="parameters" />

  ### settings

  <Attribute id="qiskit.opflow.list_ops.SummedOp.settings" name="settings">
    Return settings.
