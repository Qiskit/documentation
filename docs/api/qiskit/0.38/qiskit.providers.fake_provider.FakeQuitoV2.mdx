...
description: API reference for qiskit.providers.fake_provider.FakeQuitoV2 in qiskit v0.38
...
<Class id="qiskit.providers.fake_provider.FakeQuitoV2" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.21/qiskit/providers/fake_provider/backends/quito/fake_quito.py" signature="FakeQuitoV2" modifiers="class">
