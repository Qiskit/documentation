...
<Function id="qiskit.converters.dagdependency_to_dag" name="dagdependency_to_dag" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.21/qiskit/converters/dagdependency_to_dag.py" signature="dagdependency_to_dag(dagdependency)">
