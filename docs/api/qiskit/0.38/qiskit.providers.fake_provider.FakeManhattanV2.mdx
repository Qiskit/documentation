...
<Class id="qiskit.providers.fake_provider.FakeManhattanV2" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.21/qiskit/providers/fake_provider/backends/manhattan/fake_manhattan.py" signature="FakeManhattanV2">
