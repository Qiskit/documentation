...
<Class id="qiskit.transpiler.passes.synthesis.plugin.UnitarySynthesisPlugin" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.21/qiskit/transpiler/passes/synthesis/plugin.py" signature="UnitarySynthesisPlugin">
  Bases: `abc.ABC`
