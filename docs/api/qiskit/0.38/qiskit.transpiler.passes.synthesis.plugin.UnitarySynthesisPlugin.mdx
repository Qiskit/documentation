---
title: UnitarySynthesisPlugin (v0.38)
description: API reference for qiskit.transpiler.passes.synthesis.plugin.UnitarySynthesisPlugin in qiskit v0.38
...
<Class id="qiskit.transpiler.passes.synthesis.plugin.UnitarySynthesisPlugin" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.21/qiskit/transpiler/passes/synthesis/plugin.py" signature="UnitarySynthesisPlugin" modifiers="class">
  Bases: `abc.ABC`
  ...
  <Function id="qiskit.transpiler.passes.synthesis.plugin.UnitarySynthesisPlugin.run" signature="UnitarySynthesisPlugin.run(unitary, **options)" modifiers="abstract">
