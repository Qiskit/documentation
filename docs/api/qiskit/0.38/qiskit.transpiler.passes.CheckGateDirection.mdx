...
<Class id="qiskit.transpiler.passes.CheckGateDirection" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.21/qiskit/transpiler/passes/utils/check_gate_direction.py" signature="CheckGateDirection(*args, **kwargs)">
