...
<Function id="qiskit.pulse.builder.play" github="https://github.com/qiskit/qiskit/tree/stable/0.21/qiskit/pulse/builder.py" signature="play(pulse, channel, name=None)">
