...
`ProbDistribution.binary_probabilities(num_bits=None)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.21/qiskit/result/distributions/probability.py "view source code")
...
`ProbDistribution.hex_probabilities()`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.21/qiskit/result/distributions/probability.py "view source code")
