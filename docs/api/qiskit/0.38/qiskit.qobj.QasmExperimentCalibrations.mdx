...
<Class id="qiskit.qobj.QasmExperimentCalibrations" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.21/qiskit/qobj/qasm_qobj.py" signature="QasmExperimentCalibrations(gates)">
  Bases: `object`
  ...
  **gates** (*list(*[*GateCalibration*](qiskit.qobj.GateCalibration "qiskit.qobj.GateCalibration")*)*) –
  ...
  <Function id="qiskit.qobj.QasmExperimentCalibrations.from_dict" name="from_dict" signature="classmethod QasmExperimentCalibrations.from_dict(data)">
  ...
  <Function id="qiskit.qobj.QasmExperimentCalibrations.to_dict" name="to_dict" signature="QasmExperimentCalibrations.to_dict()">
