...
`AmplitudeAmplifier`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.21/qiskit/algorithms/amplitude_amplifiers/amplitude_amplifier.py "view source code")
...
`abstract AmplitudeAmplifier.amplify(amplification_problem)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.21/qiskit/algorithms/amplitude_amplifiers/amplitude_amplifier.py "view source code")
