---
title: QasmHTMLStyle (v0.38)
description: API reference for qiskit.qasm.QasmHTMLStyle in qiskit v0.38
...
<Class id="qiskit.qasm.QasmHTMLStyle" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.21/qiskit/qasm/pygments/lexer.py" signature="QasmHTMLStyle" modifiers="class">
