...
<Class id="qiskit.transpiler.passes.ALAPScheduleAnalysis" github="https://github.com/qiskit/qiskit/tree/stable/0.21/qiskit/transpiler/passes/scheduling/scheduling/alap.py" signature="ALAPScheduleAnalysis(durations)">
