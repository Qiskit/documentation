...
<Class id="qiskit.providers.ibmq.IBMQBackendValueError" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-ibmq-provider/tree/stable/0.19/qiskit/providers/ibmq/exceptions.py" signature="IBMQBackendValueError(*message)">
