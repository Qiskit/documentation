...
<Function id="qiskit.pulse.builder.samples_to_seconds" github="https://github.com/qiskit/qiskit/tree/stable/0.21/qiskit/pulse/builder.py" signature="samples_to_seconds(samples)">
