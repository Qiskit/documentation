...
<Class id="qiskit.circuit.classicalfunction.ClassicalFunctionCompilerTypeError" github="https://github.com/qiskit/qiskit/tree/stable/0.21/qiskit/circuit/classicalfunction/exceptions.py" signature="ClassicalFunctionCompilerTypeError(*message)">
