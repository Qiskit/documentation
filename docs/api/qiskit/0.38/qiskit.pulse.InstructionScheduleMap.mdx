...
<Class id="qiskit.pulse.InstructionScheduleMap" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.21/qiskit/pulse/instruction_schedule_map.py" signature="InstructionScheduleMap">
  Bases: `object`
  ...
  <Function id="qiskit.pulse.InstructionScheduleMap.add" name="add" signature="InstructionScheduleMap.add(instruction, qubits, schedule, arguments=None)">
  ...
  <Function id="qiskit.pulse.InstructionScheduleMap.assert_has" name="assert_has" signature="InstructionScheduleMap.assert_has(instruction, qubits)">
  ...
  <Function id="qiskit.pulse.InstructionScheduleMap.get" name="get" signature="InstructionScheduleMap.get(instruction, qubits, *params, **kwparams)">
  ...
  <Function id="qiskit.pulse.InstructionScheduleMap.get_parameters" name="get_parameters" signature="InstructionScheduleMap.get_parameters(instruction, qubits)">
  ...
  <Function id="qiskit.pulse.InstructionScheduleMap.has" name="has" signature="InstructionScheduleMap.has(instruction, qubits)">
  ...
  <Function id="qiskit.pulse.InstructionScheduleMap.has_custom_gate" name="has_custom_gate" signature="InstructionScheduleMap.has_custom_gate()">
  ...
  <Function id="qiskit.pulse.InstructionScheduleMap.pop" name="pop" signature="InstructionScheduleMap.pop(instruction, qubits, *params, **kwparams)">
  ...
  <Function id="qiskit.pulse.InstructionScheduleMap.qubit_instructions" name="qubit_instructions" signature="InstructionScheduleMap.qubit_instructions(qubits)">
  ...
  <Function id="qiskit.pulse.InstructionScheduleMap.qubits_with_instruction" name="qubits_with_instruction" signature="InstructionScheduleMap.qubits_with_instruction(instruction)">
  ...
  <Function id="qiskit.pulse.InstructionScheduleMap.remove" name="remove" signature="InstructionScheduleMap.remove(instruction, qubits)">
  ...
  <Attribute id="qiskit.pulse.InstructionScheduleMap.instructions" name="instructions">
