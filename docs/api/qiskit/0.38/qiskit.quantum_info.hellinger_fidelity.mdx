---
title: hellinger_fidelity (v0.38)
description: API reference for qiskit.quantum_info.hellinger_fidelity in qiskit v0.38
...
<Function id="qiskit.quantum_info.hellinger_fidelity" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.21/qiskit/quantum_info/analysis/distance.py" signature="hellinger_fidelity(dist_p, dist_q)">
