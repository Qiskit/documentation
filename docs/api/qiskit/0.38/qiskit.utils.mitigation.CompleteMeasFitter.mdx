...
<Class id="qiskit.utils.mitigation.CompleteMeasFitter" github="https://github.com/qiskit/qiskit/tree/stable/0.21/qiskit/utils/mitigation/fitters.py" signature="CompleteMeasFitter(results, state_labels, qubit_list=None, circlabel='')">
  Bases: `object`
