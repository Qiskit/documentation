---
title: PiecewiseLinearPauliRotations (v0.38)
description: API reference for qiskit.circuit.library.PiecewiseLinearPauliRotations in qiskit v0.38
...
$$
  ...
  *   **name** (`str`) – The name of the circuit.
  ...
  <Attribute id="qiskit.circuit.library.PiecewiseLinearPauliRotations.instances" attributeValue="87" />
