...
<Class id="qiskit.providers.fake_provider.FakeLagosV2" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.21/qiskit/providers/fake_provider/backends/lagos/fake_lagos.py" signature="FakeLagosV2">
