...
<Class id="qiskit.pulse.library.Drag" github="https://github.com/qiskit/qiskit/tree/stable/0.21/qiskit/pulse/library/symbolic_pulses.py" signature="Drag(duration, amp, sigma, beta, name=None, limit_amplitude=None)">
