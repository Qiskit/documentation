...
<Class id="qiskit.pulse.transforms.AlignSequential" github="https://github.com/qiskit/qiskit/tree/stable/0.21/qiskit/pulse/transforms/alignments.py" signature="AlignSequential">
