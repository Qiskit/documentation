...
`FakeBelemV2` [GitHub](https://github.com/qiskit/qiskit/tree/stable/0.21/qiskit/providers/fake_provider/backends/belem/fake_belem.py "view source code")
...
<span id="qiskit.providers.fake_provider.FakeBelemV2.acquire_channel" />

`FakeBelemV2.acquire_channel(qubit)`
...
<span id="qiskit.providers.fake_provider.FakeBelemV2.control_channel" />

`FakeBelemV2.control_channel(qubits)`
...
<span id="qiskit.providers.fake_provider.FakeBelemV2.drive_channel" />

`FakeBelemV2.drive_channel(qubit)`
...
<span id="qiskit.providers.fake_provider.FakeBelemV2.measure_channel" />

`FakeBelemV2.measure_channel(qubit)`
...
<span id="qiskit.providers.fake_provider.FakeBelemV2.qubit_properties" />

`FakeBelemV2.qubit_properties(qubit)`
...
<span id="qiskit.providers.fake_provider.FakeBelemV2.run" />

`FakeBelemV2.run(run_input, **options)`
...
<span id="qiskit.providers.fake_provider.FakeBelemV2.set_options" />

`FakeBelemV2.set_options(**fields)`
...
<span id="qiskit.providers.fake_provider.FakeBelemV2.backend_name" />

### backend\_name

`= 'fake_belem_v2'`

<span id="qiskit.providers.fake_provider.FakeBelemV2.conf_filename" />

### conf\_filename

`= 'conf_belem.json'`

<span id="qiskit.providers.fake_provider.FakeBelemV2.coupling_map" />

### coupling\_map

Return the [`CouplingMap`](qiskit.transpiler.CouplingMap "qiskit.transpiler.CouplingMap") object

<span id="qiskit.providers.fake_provider.FakeBelemV2.defs_filename" />

### defs\_filename

`= 'defs_belem.json'`

<span id="qiskit.providers.fake_provider.FakeBelemV2.dirname" />

### dirname

`= '/home/runner/work/qiskit/qiskit/.tox/docs/lib/python3.8/site-packages/qiskit/providers/fake_provider/backends/belem'`

<span id="qiskit.providers.fake_provider.FakeBelemV2.dt" />
...
<span id="qiskit.providers.fake_provider.FakeBelemV2.dtm" />
...
<span id="qiskit.providers.fake_provider.FakeBelemV2.instruction_durations" />

### instruction\_durations

Return the [`InstructionDurations`](qiskit.transpiler.InstructionDurations "qiskit.transpiler.InstructionDurations") object.

<span id="qiskit.providers.fake_provider.FakeBelemV2.instruction_schedule_map" />
...
<span id="qiskit.providers.fake_provider.FakeBelemV2.instructions" />
...
<span id="qiskit.providers.fake_provider.FakeBelemV2.max_circuits" />

### max\_circuits

<span id="qiskit.providers.fake_provider.FakeBelemV2.meas_map" />
...
<span id="qiskit.providers.fake_provider.FakeBelemV2.num_qubits" />
...
<span id="qiskit.providers.fake_provider.FakeBelemV2.operation_names" />
...
<span id="qiskit.providers.fake_provider.FakeBelemV2.operations" />
...
<span id="qiskit.providers.fake_provider.FakeBelemV2.options" />
...
<span id="qiskit.providers.fake_provider.FakeBelemV2.props_filename" />

### props\_filename

`= 'props_belem.json'`

<span id="qiskit.providers.fake_provider.FakeBelemV2.provider" />
...
<span id="qiskit.providers.fake_provider.FakeBelemV2.target" />
...
<span id="qiskit.providers.fake_provider.FakeBelemV2.version" />
