---
title: GRZ (v0.38)
description: API reference for qiskit.circuit.library.GRZ in qiskit v0.38
...
<Class id="qiskit.circuit.library.GRZ" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.21/qiskit/circuit/library/generalized_gates/gr.py" signature="GRZ(num_qubits, phi)" modifiers="class">
...
$$
  ...
  *   **phi** (`float`) – rotation angle about z-axis
  ...
  <Attribute id="qiskit.circuit.library.GRZ.instances" attributeValue="87" />
