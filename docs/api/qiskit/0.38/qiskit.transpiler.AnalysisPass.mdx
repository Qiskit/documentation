---
title: AnalysisPass (v0.38)
description: API reference for qiskit.transpiler.AnalysisPass in qiskit v0.38
...
<Class id="qiskit.transpiler.AnalysisPass" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.21/qiskit/transpiler/basepasses.py" signature="AnalysisPass(*args, **kwargs)" modifiers="class">
