---
title: QuasiDistribution (v0.38)
description: API reference for qiskit.result.QuasiDistribution in qiskit v0.38
...
<Class id="qiskit.result.QuasiDistribution" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.21/qiskit/result/distributions/quasi.py" signature="QuasiDistribution(data, shots=None, stddev_upper_bound=None)" modifiers="class">
  Bases: `dict`
