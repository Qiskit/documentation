...
<Class id="qiskit.transpiler.passes.ContainsInstruction" github="https://github.com/qiskit/qiskit/tree/stable/0.21/qiskit/transpiler/passes/utils/contains_instruction.py" signature="ContainsInstruction(*args, **kwargs)">
