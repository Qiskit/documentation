...
<Class id="qiskit.providers.models.JobStatus" github="https://github.com/qiskit/qiskit/tree/stable/0.21/qiskit/providers/models/jobstatus.py" signature="JobStatus(job_id, status, status_msg, **kwargs)">
  Bases: `object`
