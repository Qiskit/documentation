...
<Class id="qiskit.pulse.instructions.SetPhase" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.21/qiskit/pulse/instructions/phase.py" signature="SetPhase(phase, channel, name=None)">
