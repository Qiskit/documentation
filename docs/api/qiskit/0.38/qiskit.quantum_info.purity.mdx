...
<Function id="qiskit.quantum_info.purity" name="purity" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.21/qiskit/quantum_info/states/measures.py" signature="purity(state, validate=True)">
