...
<Class id="qiskit.pulse.instructions.Call" github="https://github.com/qiskit/qiskit/tree/stable/0.21/qiskit/pulse/instructions/call.py" signature="Call(subroutine, value_dict=None, name=None)">
