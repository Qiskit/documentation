...
description: API reference for qiskit_aer.StatevectorSimulator
...
The StatevectorSimulator supports CPU and GPU simulation methods and additional configurable options. These may be set using the appropriate kwargs during initialization. They can also be set of updated using the [`set_options()`](qiskit_aer.StatevectorSimulator#set_options "qiskit_aer.StatevectorSimulator.set_options") method.

Run-time options may also be specified as kwargs using the [`run()`](qiskit_aer.StatevectorSimulator#run "qiskit_aer.StatevectorSimulator.run") method. These will not be stored in the backend and will only apply to that execution. They will also override any previously set options.
...
*   `device` (str): Set the simulation device (Default: `"CPU"`). Use [`available_devices()`](qiskit_aer.StatevectorSimulator#available_devices "qiskit_aer.StatevectorSimulator.available_devices") to return a list of devices supported on the current system.
...
<span id="qiskit_aer.StatevectorSimulator.clear_options" />
...
<span id="qiskit_aer.StatevectorSimulator.configuration" />
...
<span id="qiskit_aer.StatevectorSimulator.defaults" />
...
<span id="qiskit_aer.StatevectorSimulator.name" />
...
<span id="qiskit_aer.StatevectorSimulator.properties" />
...
<span id="qiskit_aer.StatevectorSimulator.provider" />
...
<span id="qiskit_aer.StatevectorSimulator.run" />
...
<span id="qiskit_aer.StatevectorSimulator.set_options" />
...
<span id="qiskit_aer.StatevectorSimulator.status" />
...
<span id="qiskit_aer.StatevectorSimulator.options" />

### options

Return the options for the backend

The options of a backend are the dynamic parameters defining how the backend is used. These are used to control the [`run()`](qiskit_aer.StatevectorSimulator#run "qiskit_aer.StatevectorSimulator.run") method.

<span id="qiskit_aer.StatevectorSimulator.version" />
