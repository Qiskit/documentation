---
title: ImaginaryEvolver (v0.38)
description: API reference for qiskit.algorithms.ImaginaryEvolver in qiskit v0.38
...
<Class id="qiskit.algorithms.ImaginaryEvolver" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.21/qiskit/algorithms/evolvers/imaginary_evolver.py" signature="ImaginaryEvolver" modifiers="class">
  Bases: `abc.ABC`
