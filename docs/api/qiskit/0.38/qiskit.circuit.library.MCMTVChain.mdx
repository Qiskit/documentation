---
title: MCMTVChain (v0.38)
description: API reference for qiskit.circuit.library.MCMTVChain in qiskit v0.38
...
<Class id="qiskit.circuit.library.MCMTVChain" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.21/qiskit/circuit/library/generalized_gates/mcmt.py" signature="MCMTVChain(gate, num_ctrl_qubits, num_target_qubits, label=None)" modifiers="class">
  ...
  *   **AttributeError** – If the number of controls or targets is 0.
  ...
  <Attribute id="qiskit.circuit.library.MCMTVChain.instances" attributeValue="87" />

  ### label

  <Attribute id="qiskit.circuit.library.MCMTVChain.label">
    Get label.
  </Attribute>
