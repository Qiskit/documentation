...
<Class id="qiskit.circuit.AncillaRegister" github="https://github.com/qiskit/qiskit/tree/stable/0.21/qiskit/circuit/quantumregister.py" signature="AncillaRegister(size=None, name=None, bits=None)">
