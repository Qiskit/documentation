...
<Class id="qiskit.opflow.converters.TwoQubitReduction" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.21/qiskit/opflow/converters/two_qubit_reduction.py" signature="TwoQubitReduction(num_particles)">
