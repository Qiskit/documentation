...
<Class id="qiskit.transpiler.passes.CXCancellation" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.21/qiskit/transpiler/passes/optimization/cx_cancellation.py" signature="CXCancellation(*args, **kwargs)">
