---
title: C4XGate (v0.38)
description: API reference for qiskit.circuit.library.C4XGate in qiskit v0.38
...
<Class id="qiskit.circuit.library.C4XGate" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.21/qiskit/circuit/library/standard_gates/x.py" signature="C4XGate(label=None, ctrl_state=None)" modifiers="class">
