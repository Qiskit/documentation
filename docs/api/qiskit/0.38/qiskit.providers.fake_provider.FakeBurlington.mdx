---
title: FakeBurlington (v0.38)
description: API reference for qiskit.providers.fake_provider.FakeBurlington in qiskit v0.38
...
<Class id="qiskit.providers.fake_provider.FakeBurlington" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.21/qiskit/providers/fake_provider/backends/burlington/fake_burlington.py" signature="FakeBurlington" modifiers="class">
  ...
  *   **time\_alive** (*int*) – time to wait before returning result
  ...
  <Attribute id="qiskit.providers.fake_provider.FakeBurlington.dirname" attributeValue="'/home/runner/work/qiskit/qiskit/.tox/docs/lib/python3.8/site-packages/qiskit/providers/fake_provider/backends/burlington'" />
