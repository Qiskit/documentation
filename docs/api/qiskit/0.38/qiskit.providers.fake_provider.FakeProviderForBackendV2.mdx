...
<Class id="qiskit.providers.fake_provider.FakeProviderForBackendV2" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.21/qiskit/providers/fake_provider/fake_provider.py" signature="FakeProviderForBackendV2">
