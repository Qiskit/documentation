...
<Class id="qiskit.transpiler.passes.InverseCancellation" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.21/qiskit/transpiler/passes/optimization/inverse_cancellation.py" signature="InverseCancellation(gates_to_cancel)">
  ...
  **Raises**
  ...
  <Function id="qiskit.transpiler.passes.InverseCancellation.name" name="name" signature="InverseCancellation.name()">
    Return the name of the pass.
  </Function>

  ### run

  <Function id="qiskit.transpiler.passes.InverseCancellation.run" name="run" signature="InverseCancellation.run(dag)">
