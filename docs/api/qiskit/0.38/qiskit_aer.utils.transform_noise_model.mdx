...
<Function id="qiskit_aer.utils.transform_noise_model" github="https://github.com/qiskit/qiskit-aer/tree/stable/0.11/qiskit_aer/utils/noise_transformation.py" signature="transform_noise_model(noise_model, func)">
