...
<Class id="qiskit.pulse.library.Gaussian" github="https://github.com/qiskit/qiskit/tree/stable/0.21/qiskit/pulse/library/symbolic_pulses.py" signature="Gaussian(duration, amp, sigma, name=None, limit_amplitude=None)">
