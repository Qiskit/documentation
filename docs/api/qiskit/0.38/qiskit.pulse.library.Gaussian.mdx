...
<Class id="qiskit.pulse.library.Gaussian" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.21/qiskit/pulse/library/symbolic_pulses.py" signature="Gaussian(duration, amp, sigma, name=None, limit_amplitude=None)">
...
$$
  ...
  *   **limit\_amplitude** (`Optional`\[`bool`]) – If `True`, then limit the amplitude of the waveform to 1. The default is `True` and the amplitude is constrained to 1.
  ...
  <Function id="qiskit.pulse.library.Gaussian.draw" name="draw" signature="Gaussian.draw(style=None, backend=None, time_range=None, time_unit='dt', show_waveform_info=True, plotter='mpl2d', axis=None)">
  ...
  <Function id="qiskit.pulse.library.Gaussian.get_waveform" name="get_waveform" signature="Gaussian.get_waveform()">
...
$$
  ...
  <Function id="qiskit.pulse.library.Gaussian.is_parameterized" name="is_parameterized" signature="Gaussian.is_parameterized()">
  ...
  <Function id="qiskit.pulse.library.Gaussian.validate_parameters" name="validate_parameters" signature="Gaussian.validate_parameters()">
    Validate parameters.
  ...
  <Attribute id="qiskit.pulse.library.Gaussian.constraints" name="constraints">
  ...
  <Attribute id="qiskit.pulse.library.Gaussian.duration" name="duration" />

  ### envelope

  <Attribute id="qiskit.pulse.library.Gaussian.envelope" name="envelope">
  ...
  <Attribute id="qiskit.pulse.library.Gaussian.id" name="id">
  ...
  <Attribute id="qiskit.pulse.library.Gaussian.limit_amplitude" name="limit_amplitude" attributeValue="True" />

  ### name

  <Attribute id="qiskit.pulse.library.Gaussian.name" name="name" />

  ### parameters

  <Attribute id="qiskit.pulse.library.Gaussian.parameters" name="parameters">
    **Return type**
  ...
  <Attribute id="qiskit.pulse.library.Gaussian.pulse_type" name="pulse_type">
  ...
  <Attribute id="qiskit.pulse.library.Gaussian.valid_amp_conditions" name="valid_amp_conditions">
