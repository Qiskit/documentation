...
<Function id="qiskit.pulse.transforms.compress_pulses" name="compress_pulses" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.21/qiskit/pulse/transforms/canonicalization.py" signature="compress_pulses(schedules)">
