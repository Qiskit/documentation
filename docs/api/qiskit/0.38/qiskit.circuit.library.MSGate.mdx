---
title: MSGate (v0.38)
description: API reference for qiskit.circuit.library.MSGate in qiskit v0.38
...
<Class id="qiskit.circuit.library.MSGate" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.21/qiskit/circuit/library/generalized_gates/gms.py" signature="MSGate(num_qubits, theta, label=None)" modifiers="class">
