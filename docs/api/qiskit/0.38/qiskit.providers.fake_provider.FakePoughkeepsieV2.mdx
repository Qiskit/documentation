---
title: FakePoughkeepsieV2 (v0.38)
description: API reference for qiskit.providers.fake_provider.FakePoughkeepsieV2 in qiskit v0.38
...
<Class id="qiskit.providers.fake_provider.FakePoughkeepsieV2" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.21/qiskit/providers/fake_provider/backends/poughkeepsie/fake_poughkeepsie.py" signature="FakePoughkeepsieV2" modifiers="class">
