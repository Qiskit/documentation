...
`static Optimize1qGates.compose_u3(theta1, phi1, lambda1, theta2, phi2, lambda2)` [GitHub](https://github.com/qiskit/qiskit/tree/stable/0.21/qiskit/transpiler/passes/optimization/optimize_1q_gates.py "view source code")
...
`Optimize1qGates.run(dag)` [GitHub](https://github.com/qiskit/qiskit/tree/stable/0.21/qiskit/transpiler/passes/optimization/optimize_1q_gates.py "view source code")
...
`static Optimize1qGates.yzy_to_zyz(xi, theta1, theta2, eps=1e-09)` [GitHub](https://github.com/qiskit/qiskit/tree/stable/0.21/qiskit/transpiler/passes/optimization/optimize_1q_gates.py "view source code")
