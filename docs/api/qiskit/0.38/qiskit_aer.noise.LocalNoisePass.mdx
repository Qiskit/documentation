...
<Class id="qiskit_aer.noise.LocalNoisePass" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-aer/tree/stable/0.11/qiskit_aer/noise/passes/local_noise_pass.py" signature="LocalNoisePass(func, op_types=None, method='append')">
  ...
  **Raises**
  ...
  <Function id="qiskit_aer.noise.LocalNoisePass.name" name="name" signature="LocalNoisePass.name()">
    Return the name of the pass.
  </Function>

  ### run

  <Function id="qiskit_aer.noise.LocalNoisePass.run" name="run" signature="LocalNoisePass.run(dag)">
  ...
  <Attribute id="qiskit_aer.noise.LocalNoisePass.is_analysis_pass" name="is_analysis_pass">
  ...
  <Attribute id="qiskit_aer.noise.LocalNoisePass.is_transformation_pass" name="is_transformation_pass">
