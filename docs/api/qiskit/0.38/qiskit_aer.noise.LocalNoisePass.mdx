---
title: LocalNoisePass (v0.38)
description: API reference for qiskit_aer.noise.LocalNoisePass in qiskit v0.38
...
<Class id="qiskit_aer.noise.LocalNoisePass" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-aer/tree/stable/0.11/qiskit_aer/noise/passes/local_noise_pass.py" signature="LocalNoisePass(func, op_types=None, method='append')" modifiers="class">
  ...
  **Raises**
  ...
  <span id="qiskit-aer-noise-localnoisepass-name" />
  ...
  <span id="qiskit-aer-noise-localnoisepass-run" />
