...
<Class id="qiskit.primitives.BindingsArray" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/primitives/containers/bindings_array.py#L55-L320" signature="qiskit.primitives.BindingsArray(data=None, shape=None)" modifiers="class">
  Bases: `ShapedMixin`
  ...
  *   [**TypeError**](https://docs.python.org/3/library/exceptions.html#TypeError) – If some of the values can’t be cast to a float type.
  ...
  <Attribute id="qiskit.primitives.BindingsArray.data" name="data" headingLevel={3}>
    The keyword values of this array.
  </Attribute>

  <Attribute id="qiskit.primitives.BindingsArray.ndim" name="ndim" headingLevel={3} />

  <Attribute id="qiskit.primitives.BindingsArray.num_parameters" name="num_parameters" headingLevel={3}>
    The total number of parameters.
  </Attribute>

  <Attribute id="qiskit.primitives.BindingsArray.shape" name="shape" headingLevel={3} />

  <Attribute id="qiskit.primitives.BindingsArray.size" name="size" headingLevel={3} />

  ## Methods

  ### as\_array

  <Function id="qiskit.primitives.BindingsArray.as_array" github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/primitives/containers/bindings_array.py#L172-L216" signature="as_array(parameters=None)">
  ...
  <Function id="qiskit.primitives.BindingsArray.bind" github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/primitives/containers/bindings_array.py#L218-L239" signature="bind(circuit, loc)">
  ...
  <Function id="qiskit.primitives.BindingsArray.bind_all" github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/primitives/containers/bindings_array.py#L241-L253" signature="bind_all(circuit)">
  ...
  <Function id="qiskit.primitives.BindingsArray.coerce" github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/primitives/containers/bindings_array.py#L293-L311" signature="coerce(bindings_array)" modifiers="classmethod">
  ...
  <Function id="qiskit.primitives.BindingsArray.ravel" github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/primitives/containers/bindings_array.py#L255-L264" signature="ravel()">
  ...
  <Function id="qiskit.primitives.BindingsArray.reshape" github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/primitives/containers/bindings_array.py#L266-L291" signature="reshape(*shape)">
  ...
  <Function id="qiskit.primitives.BindingsArray.validate" github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/primitives/containers/bindings_array.py#L313-L320" signature="validate()">
