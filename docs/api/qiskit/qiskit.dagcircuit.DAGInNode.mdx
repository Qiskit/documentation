...
<Class id="qiskit.dagcircuit.DAGInNode" github="https://github.com/Qiskit/qiskit/tree/stable/1.0/qiskit/dagcircuit/dagnode.py#L289-L304" signature="qiskit.dagcircuit.DAGInNode(wire)">
