...
<Class id="qiskit.dagcircuit.DAGInNode" isDedicatedPage={true} signature="qiskit.dagcircuit.DAGInNode" modifiers="class">
  ...
  <Function id="qiskit.dagcircuit.DAGInNode.semantic_eq" github="https://github.com/Qiskit/qiskit/tree/stable/1.2/qiskit/dagcircuit/dagnode.py#L181-L237" signature="semantic_eq(node1, node2, bit_indices1, bit_indices2)" modifiers="static">
