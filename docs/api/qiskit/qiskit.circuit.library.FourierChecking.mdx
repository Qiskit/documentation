...
<Class id="qiskit.circuit.library.FourierChecking" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.3/qiskit/circuit/library/fourier_checking.py#L25-L100" signature="qiskit.circuit.library.FourierChecking(f, g)" modifiers="class">
