...
<Class id="qiskit.qobj.QasmQobjExperiment" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.0/qiskit/qobj/qasm_qobj.py#L196-L275" signature="qiskit.qobj.QasmQobjExperiment(config=None, header=None, instructions=None)">
  ...
  *   **instructions** ([*list*](https://docs.python.org/3/library/stdtypes.html#list "(in Python v3.12)")) – A list of [`QasmQobjInstruction`](qiskit.qobj.QasmQobjInstruction "qiskit.qobj.QasmQobjInstruction") objects
  ...
  <Function id="qiskit.qobj.QasmQobjExperiment.from_dict" github="https://github.com/Qiskit/qiskit/tree/stable/1.0/qiskit/qobj/qasm_qobj.py#L248-L269" signature="classmethod from_dict(data)">
