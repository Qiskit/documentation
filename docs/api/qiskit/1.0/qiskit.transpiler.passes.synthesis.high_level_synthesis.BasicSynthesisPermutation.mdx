---
title: BasicSynthesisPermutation (v1.0)
description: API reference for qiskit.transpiler.passes.synthesis.high_level_synthesis.BasicSynthesisPermutation in qiskit v1.0
