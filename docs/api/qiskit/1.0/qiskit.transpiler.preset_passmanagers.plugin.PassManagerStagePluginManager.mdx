---
title: PassManagerStagePluginManager (v1.0)
description: API reference for qiskit.transpiler.preset_passmanagers.plugin.PassManagerStagePluginManager in qiskit v1.0
