---
title: GraphState (v1.0)
description: API reference for qiskit.circuit.library.GraphState in qiskit v1.0
...
$$
  ...
  **Reference Circuit:**
  ...
  ![../\_images/qiskit-circuit-library-GraphState-1.png](/docs/images/api/qiskit/1.0/qiskit-circuit-library-GraphState-1.avif)
