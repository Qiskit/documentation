---
title: GRZ (v1.0)
description: API reference for qiskit.circuit.library.GRZ in qiskit v1.0
...
$$
  ...
  **Expanded Circuit:**
  ...
  ![../\_images/qiskit-circuit-library-GRZ-1.png](/docs/images/api/qiskit/1.0/qiskit-circuit-library-GRZ-1.avif)
