...
description: API reference for qiskit.transpiler in qiskit v1.0
...
![../\_images/transpiling\_core\_steps.png](/docs/images/api/qiskit/1.0/transpiling_core_steps.avif)
...
![../\_images/transpiler-4.png](/docs/images/api/qiskit/1.0/transpiler-4.avif)
...
![../\_images/transpiler-5.png](/docs/images/api/qiskit/1.0/transpiler-5.avif)
...
2.  A Toffoli, or controlled-controlled-not gate (`ccx`), is a three-qubit gate. Given that our basis gate set includes only single- and two-qubit gates, it is obvious that this gate must be decomposed. This decomposition is quite costly:
    ...
    ![../\_images/transpiler-6.png](/docs/images/api/qiskit/1.0/transpiler-6.avif)
...
![../\_images/mapping.png](/docs/images/api/qiskit/1.0/mapping.avif)
...
![../\_images/transpiler-7.png](/docs/images/api/qiskit/1.0/transpiler-7.avif)
...
*   **Layout Using Optimization Level 0**
    ...
    > ```
    >
    > ![../\_images/transpiler-8.png](/docs/images/api/qiskit/1.0/transpiler-8.avif)
...
*   **Layout Using Optimization Level 3**
    ...
    > ```
    >
    > ![../\_images/transpiler-9.png](/docs/images/api/qiskit/1.0/transpiler-9.avif)
...
![../\_images/transpiler-10.png](/docs/images/api/qiskit/1.0/transpiler-10.avif)
...
![../\_images/transpiler-11.png](/docs/images/api/qiskit/1.0/transpiler-11.avif)
...
![../\_images/transpiler-12.png](/docs/images/api/qiskit/1.0/transpiler-12.avif)
...
![../\_images/transpiler-13.png](/docs/images/api/qiskit/1.0/transpiler-13.avif)
...
![../\_images/transpiler-14.png](/docs/images/api/qiskit/1.0/transpiler-14.avif)
...
![../\_images/transpiler-15.png](/docs/images/api/qiskit/1.0/transpiler-15.avif)
...
![../\_images/transpiler-16.png](/docs/images/api/qiskit/1.0/transpiler-16.avif)
...
![../\_images/transpiler-17.png](/docs/images/api/qiskit/1.0/transpiler-17.avif)
