---
title: GRX (v1.0)
description: API reference for qiskit.circuit.library.GRX in qiskit v1.0
...
$$
  ...
  **Expanded Circuit:**
  ...
  ![../\_images/qiskit-circuit-library-GRX-1.png](/docs/images/api/qiskit/1.0/qiskit-circuit-library-GRX-1.avif)
