---
title: QFT (v1.0)
description: API reference for qiskit.circuit.library.QFT in qiskit v1.0
...
$$
  ...
  ![../\_images/qiskit-circuit-library-QFT-1.png](/docs/images/api/qiskit/1.0/qiskit-circuit-library-QFT-1.avif)

  The inverse QFT can be obtained by calling the `inverse` method on this class. The respective circuit diagram is:

  ![../\_images/qiskit-circuit-library-QFT-2.png](/docs/images/api/qiskit/1.0/qiskit-circuit-library-QFT-2.avif)
  ...
  ![../\_images/qiskit-circuit-library-QFT-3.png](/docs/images/api/qiskit/1.0/qiskit-circuit-library-QFT-3.avif)
