---
title: Parameter (v1.0)
description: API reference for qiskit.circuit.Parameter in qiskit v1.0
...
<Class id="qiskit.circuit.Parameter" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.0/qiskit/circuit/parameter.py#L27-L170" signature="qiskit.circuit.Parameter(name, *, uuid=None)" modifiers="class">
  ...
  **Examples**
  ...
  ![../\_images/qiskit-circuit-Parameter-1\_00.png](/docs/images/api/qiskit/1.0/qiskit-circuit-Parameter-1_00.avif)

  ![../\_images/qiskit-circuit-Parameter-1\_01.png](/docs/images/api/qiskit/1.0/qiskit-circuit-Parameter-1_01.avif)
