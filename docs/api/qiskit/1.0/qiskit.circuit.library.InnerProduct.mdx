---
title: InnerProduct (v1.0)
description: API reference for qiskit.circuit.library.InnerProduct in qiskit v1.0
...
$$
  ...
  **Reference Circuit:**
  ...
  ![../\_images/qiskit-circuit-library-InnerProduct-1.png](/docs/images/api/qiskit/1.0/qiskit-circuit-library-InnerProduct-1.avif)
