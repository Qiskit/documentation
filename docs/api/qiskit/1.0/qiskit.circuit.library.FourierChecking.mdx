---
title: FourierChecking (v1.0)
description: API reference for qiskit.circuit.library.FourierChecking in qiskit v1.0
...
<Class id="qiskit.circuit.library.FourierChecking" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.0/qiskit/circuit/library/fourier_checking.py#L24-L97" signature="qiskit.circuit.library.FourierChecking(f, g)" modifiers="class">
  ...
  **Reference Circuit:**
  ...
  ![../\_images/qiskit-circuit-library-FourierChecking-1.png](/docs/images/api/qiskit/1.0/qiskit-circuit-library-FourierChecking-1.avif)
