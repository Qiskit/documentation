---
title: GR (v1.0)
description: API reference for qiskit.circuit.library.GR in qiskit v1.0
...
$$
  ...
  **Expanded Circuit:**
  ...
  ![../\_images/qiskit-circuit-library-GR-1.png](/docs/images/api/qiskit/1.0/qiskit-circuit-library-GR-1.avif)
