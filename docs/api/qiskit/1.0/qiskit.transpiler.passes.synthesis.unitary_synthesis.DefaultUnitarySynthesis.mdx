---
title: DefaultUnitarySynthesis (v1.0)
description: API reference for qiskit.transpiler.passes.synthesis.unitary_synthesis.DefaultUnitarySynthesis in qiskit v1.0
