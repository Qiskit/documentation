---
title: DAGDependency (v1.0)
description: API reference for qiskit.dagcircuit.DAGDependency in qiskit v1.0
...
<Class id="qiskit.dagcircuit.DAGDependency" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.0/qiskit/dagcircuit/dagdependency.py#L50-L610" signature="qiskit.dagcircuit.DAGDependency" modifiers="class">
  ...
  **Reference:**
  ...
  <Function id="qiskit.dagcircuit.DAGDependency.add_op_node" github="https://github.com/Qiskit/qiskit/tree/stable/1.0/qiskit/dagcircuit/dagdependency.py#L419-L429" signature="add_op_node(operation, qargs, cargs)">
    ...
    *   **qargs** ([*list*](https://docs.python.org/3/library/stdtypes.html#list)*\[*[*Qubit*](qiskit.circuit.Qubit "qiskit.circuit.Qubit")*]*) – list of qubits on which the operation acts
    *   **cargs** ([*list*](https://docs.python.org/3/library/stdtypes.html#list)*\[*[*Clbit*](qiskit.circuit.Clbit "qiskit.circuit.Clbit")*]*) – list of classical wires to attach to
  </Function>
  ...
  <Function id="qiskit.dagcircuit.DAGDependency.replace_block_with_op" github="https://github.com/Qiskit/qiskit/tree/stable/1.0/qiskit/dagcircuit/dagdependency.py#L539-L610" signature="replace_block_with_op(node_block, op, wire_pos_map, cycle_check=True)">
    ...
    *   **wire\_pos\_map** (*Dict\[*[*Qubit*](qiskit.circuit.Qubit "qiskit.circuit.Qubit")*,* [*int*](https://docs.python.org/3/library/functions.html#int)*]*) – The dictionary mapping the qarg to the position. This is necessary to reconstruct the qarg order over multiple gates in the combined single op node.
