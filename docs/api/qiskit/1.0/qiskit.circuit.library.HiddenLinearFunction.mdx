---
title: HiddenLinearFunction (v1.0)
description: API reference for qiskit.circuit.library.HiddenLinearFunction in qiskit v1.0
...
$$
  ...
  **Reference Circuit:**
  ...
  > ![../\_images/qiskit-circuit-library-HiddenLinearFunction-1.png](/docs/images/api/qiskit/1.0/qiskit-circuit-library-HiddenLinearFunction-1.avif)
