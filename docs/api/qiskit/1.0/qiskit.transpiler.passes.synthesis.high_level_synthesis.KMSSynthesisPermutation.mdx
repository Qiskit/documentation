---
title: KMSSynthesisPermutation (v1.0)
description: API reference for qiskit.transpiler.passes.synthesis.high_level_synthesis.KMSSynthesisPermutation in qiskit v1.0
