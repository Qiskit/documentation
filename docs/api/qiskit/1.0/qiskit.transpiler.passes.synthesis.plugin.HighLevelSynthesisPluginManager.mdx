---
title: HighLevelSynthesisPluginManager (v1.0)
description: API reference for qiskit.transpiler.passes.synthesis.plugin.HighLevelSynthesisPluginManager in qiskit v1.0
