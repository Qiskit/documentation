---
title: UnitarySynthesisPluginManager (v1.0)
description: API reference for qiskit.transpiler.passes.synthesis.plugin.UnitarySynthesisPluginManager in qiskit v1.0
