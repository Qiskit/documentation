---
title: random (v2.4)
description: API reference for qiskit.circuit.random in qiskit v2.4
...
<Function id="qiskit.circuit.random.random_circuit" github="https://github.com/Qiskit/qiskit/tree/stable/2.4/qiskit/circuit/random/utils.py#L458-L682" signature="qiskit.circuit.random.random_circuit(num_qubits, depth, max_operands=4, measure=False, conditional=False, reset=False, seed=None, num_operand_distribution=None)">
  ...
  ![Circuit diagram output by the previous code.](/docs/images/api/qiskit/2.4/circuit_random-1.avif)
...
<Function id="qiskit.circuit.random.random_circuit_from_graph" github="https://github.com/Qiskit/qiskit/tree/stable/2.4/qiskit/circuit/random/utils.py#L79-L455" signature="qiskit.circuit.random.random_circuit_from_graph(interaction_graph, min_2q_gate_per_edge=1, max_operands=2, measure=False, conditional=False, reset=False, seed=None, insert_1q_oper=True, prob_conditional=0.1, prob_reset=0.1)">
  ...
  ![Pass in interaction graph and minimum 2Q gate per edge as a bare minimum.](/docs/images/api/qiskit/2.4/circuit_random-2.avif)
...
<Function id="qiskit.circuit.random.random_clifford_circuit" github="https://github.com/Qiskit/qiskit/tree/stable/2.4/qiskit/circuit/random/utils.py#L685-L753" signature="qiskit.circuit.random.random_clifford_circuit(num_qubits, num_gates, gates='all', seed=None)">
  ...
  ![Circuit diagram output by the previous code.](/docs/images/api/qiskit/2.4/circuit_random-3.avif)
