---
title: GMS (v2.4)
description: API reference for qiskit.circuit.library.GMS in qiskit v2.4
...
<Class id="qiskit.circuit.library.GMS" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/2.4/qiskit/circuit/library/generalized_gates/gms.py#L30-L102" signature="qiskit.circuit.library.GMS(num_qubits, theta)" modifiers="class">
  ...
  ![Diagram illustrating the previously described circuit.](/docs/images/api/qiskit/2.4/qiskit-circuit-library-GMS-1.avif)
