---
title: BaseEstimatorV1 (v2.4)
description: API reference for qiskit.primitives.BaseEstimatorV1 in qiskit v2.4
...
<Class id="qiskit.primitives.BaseEstimatorV1" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/2.4/qiskit/primitives/base/base_estimator.py#L96-L247" signature="qiskit.primitives.BaseEstimatorV1(*, options=None)" modifiers="class">
...
$$
  ...
  **options** ([*dict*](https://docs.python.org/3/library/stdtypes.html#dict) *| None*) – Default options.
  ...
  <Function id="qiskit.primitives.BaseEstimatorV1.run" github="https://github.com/Qiskit/qiskit/tree/stable/2.4/qiskit/primitives/base/base_estimator.py#L180-L237" signature="run(circuits, observables, parameter_values=None, **run_options)">
  ...
  <Function id="qiskit.primitives.BaseEstimatorV1.set_options" github="https://github.com/Qiskit/qiskit/tree/stable/2.4/qiskit/primitives/base/base_primitive_v1.py#L39-L45" signature="set_options(**fields)">
