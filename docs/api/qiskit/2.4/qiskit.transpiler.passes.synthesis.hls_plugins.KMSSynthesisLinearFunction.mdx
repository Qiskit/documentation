---
title: KMSSynthesisLinearFunction (v2.4)
description: API reference for qiskit.transpiler.passes.synthesis.hls_plugins.KMSSynthesisLinearFunction in qiskit v2.4
