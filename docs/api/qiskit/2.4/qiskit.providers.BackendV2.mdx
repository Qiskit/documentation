---
title: BackendV2 (v2.4)
description: API reference for qiskit.providers.BackendV2 in qiskit v2.4
...
<Class id="qiskit.providers.BackendV2" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/2.4/qiskit/providers/backend.py#L38-L330" signature="qiskit.providers.BackendV2(provider=None, name=None, description=None, online_date=None, backend_version=None, **fields)" modifiers="class">
  ...
  <Function id="qiskit.providers.BackendV2._default_options" github="https://github.com/Qiskit/qiskit/tree/stable/2.4/qiskit/providers/backend.py#L181-L194" signature="_default_options()" modifiers="abstractmethod classmethod">
  ...
  **Raises**
  ...
  <Function id="qiskit.providers.BackendV2.qubit_properties" github="https://github.com/Qiskit/qiskit/tree/stable/2.4/qiskit/providers/backend.py#L238-L268" signature="qubit_properties(qubit)">
  ...
  <Function id="qiskit.providers.BackendV2.run" github="https://github.com/Qiskit/qiskit/tree/stable/2.4/qiskit/providers/backend.py#L308-L330" signature="run(run_input, **options)" modifiers="abstractmethod">
    Run on the backend.
    ...
    *   **run\_input** ([*QuantumCircuit*](/docs/api/qiskit/2.4/qiskit.circuit.QuantumCircuit "qiskit.circuit.QuantumCircuit")  *or*[*list*](https://docs.python.org/3/library/stdtypes.html#list)) – An individual or a list of [`QuantumCircuit`](/docs/api/qiskit/2.4/qiskit.circuit.QuantumCircuit "qiskit.circuit.QuantumCircuit") objects to run on the backend.
  ...
  <Function id="qiskit.providers.BackendV2.set_options" github="https://github.com/Qiskit/qiskit/tree/stable/2.4/qiskit/providers/backend.py#L270-L287" signature="set_options(**fields)">
