---
title: Counts (v2.4)
description: API reference for qiskit.result.Counts in qiskit v2.4
...
<Class id="qiskit.result.Counts" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/2.4/qiskit/result/counts.py#L27-L194" signature="qiskit.result.Counts(data, time_taken=None, creg_sizes=None, memory_slots=None)" modifiers="class">
  ...
  *   [**QiskitError**](/docs/api/qiskit/2.4/exceptions#qiskit.exceptions.QiskitError "qiskit.exceptions.QiskitError") – If a dit string key is input with `creg_sizes` and/or `memory_slots`.
  ...
  <Function id="qiskit.result.Counts.clear" signature="clear()">
    Remove all items from the dict.
  </Function>

  ### copy

  <Function id="qiskit.result.Counts.copy" signature="copy()">
    Return a shallow copy of the dict.
  </Function>

  ### fromkeys

  <Function id="qiskit.result.Counts.fromkeys" signature="fromkeys(iterable, value=None, /)" modifiers="classmethod">
  ...
  <Function id="qiskit.result.Counts.hex_outcomes" github="https://github.com/Qiskit/qiskit/tree/stable/2.4/qiskit/result/counts.py#L142-L163" signature="hex_outcomes()">
    ...
    **Raises**
    ...
    [**QiskitError**](/docs/api/qiskit/2.4/exceptions#qiskit.exceptions.QiskitError "qiskit.exceptions.QiskitError") – If the Counts object contains counts for dit strings
  </Function>

  ### int\_outcomes

  <Function id="qiskit.result.Counts.int_outcomes" github="https://github.com/Qiskit/qiskit/tree/stable/2.4/qiskit/result/counts.py#L165-L185" signature="int_outcomes()">
  ...
  <Function id="qiskit.result.Counts.items" signature="items()">
    Return a set-like object providing a view on the dict’s items.
  </Function>

  ### keys

  <Function id="qiskit.result.Counts.keys" signature="keys()">
    Return a set-like object providing a view on the dict’s keys.
  </Function>

  ### most\_frequent

  <Function id="qiskit.result.Counts.most_frequent" github="https://github.com/Qiskit/qiskit/tree/stable/2.4/qiskit/result/counts.py#L123-L140" signature="most_frequent()">
    ...
    **Raises**
    ...
    [**QiskitError**](/docs/api/qiskit/2.4/exceptions#qiskit.exceptions.QiskitError "qiskit.exceptions.QiskitError") – when there is >1 count with the same max counts, or an empty object.
  </Function>
  ...
  <Function id="qiskit.result.Counts.shots" github="https://github.com/Qiskit/qiskit/tree/stable/2.4/qiskit/result/counts.py#L192-L194" signature="shots()">
    Return the number of shots
  </Function>

  ### update

  <Function id="qiskit.result.Counts.update" signature="update([E, ]**F) → None.  Update D from mapping/iterable E and F.">
    If E is present and has a .keys() method, then does: for k in E.keys(): D\[k] = E\[k] If E is present and lacks a .keys() method, then does: for k, v in E: D\[k] = v In either case, this is followed by: for k in F: D\[k] = F\[k]
  </Function>

  ### values

  <Function id="qiskit.result.Counts.values" signature="values()">
