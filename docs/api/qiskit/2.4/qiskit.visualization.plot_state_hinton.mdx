---
title: plot_state_hinton (v2.4)
description: API reference for qiskit.visualization.plot_state_hinton in qiskit v2.4
...
<Function id="qiskit.visualization.plot_state_hinton" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/2.4/qiskit/visualization/state_visualization.py#L37-L183" signature="qiskit.visualization.plot_state_hinton(state, title='', figsize=None, ax_real=None, ax_imag=None, *, filename=None)">
  ...
  *   [**VisualizationError**](/docs/api/qiskit/2.4/visualization#qiskit.visualization.VisualizationError "qiskit.visualization.VisualizationError") – Input is not a valid N-qubit state.
  ...
  **Examples**
  ...
  ![Output from the previous code.](/docs/images/api/qiskit/2.4/qiskit-visualization-plot_state_hinton-1.avif)
</Function>
