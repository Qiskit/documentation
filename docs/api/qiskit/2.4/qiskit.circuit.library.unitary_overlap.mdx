---
title: unitary_overlap (v2.4)
description: API reference for qiskit.circuit.library.unitary_overlap in qiskit v2.4
...
$$
  ...
  ![Circuit diagram output by the previous code.](/docs/images/api/qiskit/2.4/qiskit-circuit-library-unitary_overlap-1.avif)
