---
title: EstimatorResult (v2.4)
description: API reference for qiskit.primitives.EstimatorResult in qiskit v2.4
...
<Class id="qiskit.primitives.EstimatorResult" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/2.4/qiskit/primitives/base/estimator_result_v1.py#L27-L46" signature="qiskit.primitives.EstimatorResult(values, metadata)" modifiers="class">
