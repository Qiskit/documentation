---
title: LinearAmplitudeFunction (v2.4)
description: API reference for qiskit.circuit.library.LinearAmplitudeFunction in qiskit v2.4
...
$$
  ...
  *   **name** ([*str*](https://docs.python.org/3/library/stdtypes.html#str)) – Name of the circuit.
  ...
  <Function id="qiskit.circuit.library.LinearAmplitudeFunction.post_processing" github="https://github.com/Qiskit/qiskit/tree/stable/2.4/qiskit/circuit/library/arithmetic/linear_amplitude_function.py#L162-L181" signature="post_processing(scaled_value)">
