---
title: qpy (v2.4)
description: API reference for qiskit.qpy in qiskit v2.4
...
<Function id="qiskit.qpy.dump" github="https://github.com/Qiskit/qiskit/tree/stable/2.4/qiskit/qpy/interface.py#L89-L274" signature="qiskit.qpy.dump(programs, file_obj, metadata_serializer=None, use_symengine=False, version=17, annotation_factories=None)">
  ...
  *   **metadata\_serializer** ([*type*](/docs/api/qiskit/2.4/qiskit.dagcircuit.DAGDepNode#type "qiskit.dagcircuit.DAGDepNode.type")*\[JSONEncoder] | None*) – An optional JSONEncoder class that will be passed the `.metadata` attribute for each program in `programs` and will be used as the `cls` kwarg on the json.dump()\` call to JSON serialize that dictionary.
  ...
  *   **version** ([*int*](https://docs.python.org/3/library/functions.html#int)) –
      ...
      The QPY format version to emit. By default this defaults to the latest supported format of [`QPY_VERSION`](#qiskit.qpy.QPY_VERSION "qiskit.qpy.QPY_VERSION"), however for compatibility reasons if you need to load the generated QPY payload with an older version of Qiskit you can also select an older QPY format version down to the minimum supported export version, which only can change during a Qiskit major version release, to generate an older QPY format version. You can access the current QPY version and minimum compatible version with [`qpy.QPY_VERSION`](#qiskit.qpy.QPY_VERSION "qiskit.qpy.QPY_VERSION") and [`qpy.QPY_COMPATIBILITY_VERSION`](#qiskit.qpy.QPY_COMPATIBILITY_VERSION "qiskit.qpy.QPY_COMPATIBILITY_VERSION") respectively.
        ...
        <Admonition title="Note" type="note">
          If serializing a [`QuantumCircuit`](qiskit.circuit.QuantumCircuit "qiskit.circuit.QuantumCircuit") that contains [`ParameterExpression`](/docs/api/qiskit/2.4/qiskit.circuit.ParameterExpression "qiskit.circuit.ParameterExpression") objects with `version` set low with the intent to load the payload using a historical release of Qiskit, it is safest to set the `use_symengine` flag to `False`. Versions of Qiskit prior to 1.2.4 cannot load QPY files containing `symengine`-serialized [`ParameterExpression`](/docs/api/qiskit/2.4/qiskit.circuit.ParameterExpression "qiskit.circuit.ParameterExpression") objects unless the version of `symengine` used between the loading and generating environments matches.
        </Admonition>

  *   **annotation\_factories** (*Mapping\[*[*str*](https://docs.python.org/3/library/stdtypes.html#str)*, Callable\[\[],* [*annotation.QPYSerializer*](circuit_annotation#qiskit.circuit.annotation.QPYSerializer "qiskit.circuit.annotation.QPYSerializer")*]] | None*) – Mapping of namespaces to functions that create new instances of `annotation.QPUSerializer`, for handling the dumping of custom [`Annotation`](/docs/api/qiskit/2.4/qiskit.circuit.Annotation "qiskit.circuit.Annotation") objects. The subsequent call to [`load()`](#qiskit.qpy.load "qiskit.qpy.load") will need to use similar serializer objects, that understand the custom output format of those serializers.
...
Note that circuit metadata and custom [`Annotation`](/docs/api/qiskit/2.4/qiskit.circuit.Annotation "qiskit.circuit.Annotation") objects are serialized and deserialized by user-supplied classes, as the objects themselves are completely user-custom, so the forwards- and backwards-compatibility of these is limited by what the user provides.
...
<Admonition title="Note" type="note">
  With versions of Qiskit before 1.2.4, the `use_symengine=True` argument to [`qpy.dump()`](#qiskit.qpy.dump "qiskit.qpy.dump") could cause problems with backwards compatibility if there were [`ParameterExpression`](/docs/api/qiskit/2.4/qiskit.circuit.ParameterExpression "qiskit.circuit.ParameterExpression") objects to serialize. In particular:
...
Version 17 adds support for serializing and deserializing [`PauliEvolutionGate`](/docs/api/qiskit/2.4/qiskit.circuit.library.PauliEvolutionGate "qiskit.circuit.library.PauliEvolutionGate") containing [`SparseObservable`](/docs/api/qiskit/2.4/qiskit.quantum_info.SparseObservable "qiskit.quantum_info.SparseObservable") as operator(s).

<span id="changes-to-pauli-evolution" />

#### Changes to PAULI\_EVOLUTION

The format of PAULI\_EVOLUTION itself remains unchanged, but the format of the operators that immediately follow the packed evolution gate is updated. Instead of operator\_count elements defined by SPARSE\_PAULI\_OP\_LIST\_ELEM format, the payload now specifies the type of each operator to account for either operators of type [`SparsePauliOp`](/docs/api/qiskit/2.4/qiskit.quantum_info.SparsePauliOp "qiskit.quantum_info.SparsePauliOp") or of [`SparseObservable`](/docs/api/qiskit/2.4/qiskit.quantum_info.SparseObservable "qiskit.quantum_info.SparseObservable").

The new payload following PAULI\_EVOLUTION now contains exactly operator\_count sequences of a bool (`"!?"`) followed by the operator. If the bool is `True`, the operator is a [`SparseObservable`](/docs/api/qiskit/2.4/qiskit.quantum_info.SparseObservable "qiskit.quantum_info.SparseObservable") and interpreted with the new SPARSE\_OBSERVABLE format (see below). If it is `False`, the operator is a [`SparsePauliOp`](/docs/api/qiskit/2.4/qiskit.quantum_info.SparsePauliOp "qiskit.quantum_info.SparsePauliOp") and interpreted according to the existing SPARSE\_PAULI\_OP\_LIST\_ELEM format.

<span id="new-sparse-observable" />

#### New SPARSE\_OBSERVABLE

The SPARSE\_OBSERVABLE format represents an instance of a [`SparseObservable`](/docs/api/qiskit/2.4/qiskit.quantum_info.SparseObservable "qiskit.quantum_info.SparseObservable"), given by
...
> *   The bit term elements are of type “!H” and represents the u8 value of the [`SparseObservable.BitTerm`](/docs/api/qiskit/2.4/qiskit.quantum_info.SparseObservable#bitterm "qiskit.quantum_info.SparseObservable.BitTerm")
...
The struct itself is unchanged. However, for a `PARAM_EXPR_ELEM_V13` representing a [`ParameterExpression.subs()`](/docs/api/qiskit/2.4/qiskit.circuit.ParameterExpression#subs "qiskit.circuit.ParameterExpression.subs") call (with `op_code = 15`, and therefore `lhs_type = 'p'` and `rhs_type = 'n'`), the trailing [MAPPING](#qpy-mapping) now maps keys of the raw bytes of the [`Parameter`](/docs/api/qiskit/2.4/qiskit.circuit.Parameter "qiskit.circuit.Parameter") UUIDs to the substituted values. Previously (in QPY versions 13 and 14), this mapping stored the parameter names as the keys.
...
Version 13 added a native Qiskit serialization representation for [`ParameterExpression`](/docs/api/qiskit/2.4/qiskit.circuit.ParameterExpression "qiskit.circuit.ParameterExpression"). Previous QPY versions relied on either `sympy` or `symengine` to serialize the underlying symbolic expression. Starting in Version 13, QPY now represents the sequence of API calls used to create the [`ParameterExpression`](/docs/api/qiskit/2.4/qiskit.circuit.ParameterExpression "qiskit.circuit.ParameterExpression").

The main change in the serialization format is in the [PARAMETER\_EXPR](#qpy-param-expr-v3) payload. The `expr_size` bytes following the head now contain an array of `PARAM_EXPR_ELEM_V13` structs. The intent is for this array to be read one struct at a time, where each struct describes one of the calls to make to reconstruct the [`ParameterExpression`](/docs/api/qiskit/2.4/qiskit.circuit.ParameterExpression "qiskit.circuit.ParameterExpression").
...
The `op_code` field is used to define the operation added to the [`ParameterExpression`](/docs/api/qiskit/2.4/qiskit.circuit.ParameterExpression "qiskit.circuit.ParameterExpression"). The value can be:

| `op_code` | [`ParameterExpression`](/docs/api/qiskit/2.4/qiskit.circuit.ParameterExpression "qiskit.circuit.ParameterExpression") method      |
| --------- | --------------------------------------------------------------------------------------------------------------------------------- |
| 0         | `__add__()`                                                                                                                       |
| 1         | `__sub__()`                                                                                                                       |
| 2         | `__mul__()`                                                                                                                       |
| 3         | `__truediv__()`                                                                                                                   |
| 4         | `__pow__()`                                                                                                                       |
| 5         | [`sin()`](/docs/api/qiskit/2.4/qiskit.circuit.ParameterExpression#sin "qiskit.circuit.ParameterExpression.sin")                   |
| 6         | [`cos()`](/docs/api/qiskit/2.4/qiskit.circuit.ParameterExpression#cos "qiskit.circuit.ParameterExpression.cos")                   |
| 7         | [`tan()`](/docs/api/qiskit/2.4/qiskit.circuit.ParameterExpression#tan "qiskit.circuit.ParameterExpression.tan")                   |
| 8         | [`arcsin()`](/docs/api/qiskit/2.4/qiskit.circuit.ParameterExpression#arcsin "qiskit.circuit.ParameterExpression.arcsin")          |
| 9         | [`arccos()`](/docs/api/qiskit/2.4/qiskit.circuit.ParameterExpression#arccos "qiskit.circuit.ParameterExpression.arccos")          |
| 10        | [`exp()`](/docs/api/qiskit/2.4/qiskit.circuit.ParameterExpression#exp "qiskit.circuit.ParameterExpression.exp")                   |
| 11        | [`log()`](/docs/api/qiskit/2.4/qiskit.circuit.ParameterExpression#log "qiskit.circuit.ParameterExpression.log")                   |
| 12        | [`sign()`](/docs/api/qiskit/2.4/qiskit.circuit.ParameterExpression#sign "qiskit.circuit.ParameterExpression.sign")                |
| 13        | [`gradient()`](/docs/api/qiskit/2.4/qiskit.circuit.ParameterExpression#gradient "qiskit.circuit.ParameterExpression.gradient")    |
| 14        | [`conjugate()`](/docs/api/qiskit/2.4/qiskit.circuit.ParameterExpression#conjugate "qiskit.circuit.ParameterExpression.conjugate") |
| 15        | [`subs()`](/docs/api/qiskit/2.4/qiskit.circuit.ParameterExpression#subs "qiskit.circuit.ParameterExpression.subs")                |
| 16        | [`abs()`](/docs/api/qiskit/2.4/qiskit.circuit.ParameterExpression#abs "qiskit.circuit.ParameterExpression.abs")                   |
| 17        | [`arctan()`](/docs/api/qiskit/2.4/qiskit.circuit.ParameterExpression#arctan "qiskit.circuit.ParameterExpression.arctan")          |
| 255       | NULL                                                                                                                              |
...
| ----- | ------------------------------------------------------------------------------------------------------------------------------------------------ |
| `n`   | `None`                                                                                                                                           |
| `p`   | [`Parameter`](/docs/api/qiskit/2.4/qiskit.circuit.Parameter "qiskit.circuit.Parameter")                                                          |
| `f`   | `float`                                                                                                                                          |
| `c`   | `complex`                                                                                                                                        |
| `i`   | `int`                                                                                                                                            |
| `s`   | Recursive [`ParameterExpression`](/docs/api/qiskit/2.4/qiskit.circuit.ParameterExpression "qiskit.circuit.ParameterExpression") definition start |
| `e`   | Recursive [`ParameterExpression`](/docs/api/qiskit/2.4/qiskit.circuit.ParameterExpression "qiskit.circuit.ParameterExpression") definition stop  |
| `u`   | substitution                                                                                                                                     |

If the type value is `f`, `c`, or `i`, the corresponding `lhs` or `rhs` field widths are 128 bits each. In the case of floats, the literal value is encoded as a double with 0 padding, while complex numbers are encoded as real part followed by imaginary part, taking up 64 bits each. For `i`, the value is encoded as a 64 bit signed integer with 0 padding for the full 128 bit width. `n` is used to represent a `None` and typically isn’t directly used as it indicates an argument that’s not used. For `p` the data is the UUID for the [`Parameter`](/docs/api/qiskit/2.4/qiskit.circuit.Parameter "qiskit.circuit.Parameter") which can be looked up in the symbol map described in the `map_elements` outer [PARAMETER\_EXPR](#qpy-param-expr-v3) payload. If the type value is `s` this marks the start of a a new recursive section for a nested [`ParameterExpression`](/docs/api/qiskit/2.4/qiskit.circuit.ParameterExpression "qiskit.circuit.ParameterExpression"). For example, in the following snippet there is an inner `expr` contained in `final_expr`, constituting a nested expression:
...
*   symengine-native serialization for objects of type [`ParameterExpression`](/docs/api/qiskit/2.4/qiskit.circuit.ParameterExpression "qiskit.circuit.ParameterExpression") as well as symbolic expressions in Pulse schedule blocks.
*   new fields in the [`TranspileLayout`](/docs/api/qiskit/2.4/qiskit.transpiler.TranspileLayout "qiskit.transpiler.TranspileLayout") class added in the Qiskit 0.45.0 release.
...
The rest of the layout data after the `LAYOUT` struct is represented as in previous versions. If `input qubit_count` is \< 0 that indicates that both `_input_qubit_count` and `_output_qubit_list` in the [`TranspileLayout`](/docs/api/qiskit/2.4/qiskit.transpiler.TranspileLayout "qiskit.transpiler.TranspileLayout") object are `None`.
...
To support the use of [`Expr`](circuit_classical#qiskit.circuit.classical.expr.Expr "qiskit.circuit.classical.expr.Expr") nodes in the fields [`IfElseOp.condition`](/docs/api/qiskit/2.4/qiskit.circuit.IfElseOp#condition "qiskit.circuit.IfElseOp.condition"), [`WhileLoopOp.condition`](/docs/api/qiskit/2.4/qiskit.circuit.WhileLoopOp#condition "qiskit.circuit.WhileLoopOp.condition") and `SwitchCaseOp.target`, the INSTRUCTION struct is changed in an ABI compatible-manner to [its previous definition](#qpy-instruction-v5). The new struct is the C struct:
...
Version 8 adds support for handling a [`TranspileLayout`](/docs/api/qiskit/2.4/qiskit.transpiler.TranspileLayout "qiskit.transpiler.TranspileLayout") stored in the [`QuantumCircuit.layout`](qiskit.circuit.QuantumCircuit#layout "qiskit.circuit.QuantumCircuit.layout") attribute. In version 8 immediately following the calibrations block at the end of the circuit payload there is now the `LAYOUT` struct. This struct outlines the size of the three attributes of a [`TranspileLayout`](/docs/api/qiskit/2.4/qiskit.transpiler.TranspileLayout "qiskit.transpiler.TranspileLayout") class.
...
Immediately following the `LAYOUT` struct there is a [REGISTERS](#qpy-registers) struct for `extra_registers` (specifically the format introduced in [Version 4](#qpy-version-4)) standalone register definitions that aren’t present in the circuit. Then there are `initial_layout_size` `INITIAL_LAYOUT_BIT` structs to define the [`TranspileLayout.initial_layout`](/docs/api/qiskit/2.4/qiskit.transpiler.TranspileLayout#initial_layout "qiskit.transpiler.TranspileLayout.initial_layout") attribute.
...
The CUSTOM\_INSTRUCTION block in QPY version 5 adds a new field `base_gate_size` which is used to define the size of the [`qiskit.circuit.Instruction`](/docs/api/qiskit/2.4/qiskit.circuit.Instruction "qiskit.circuit.Instruction") object stored in the `ControlledGate.base_gate` attribute for a custom [`ControlledGate`](/docs/api/qiskit/2.4/qiskit.circuit.ControlledGate "qiskit.circuit.ControlledGate") object. With this change the CUSTOM\_INSTRUCTION metadata block becomes:
...
Version 3 of the QPY format is identical to [Version 2](#qpy-version-2) except that it defines a struct format to represent a [`PauliEvolutionGate`](/docs/api/qiskit/2.4/qiskit.circuit.library.PauliEvolutionGate "qiskit.circuit.library.PauliEvolutionGate") natively in QPY. To accomplish this the [CUSTOM\_DEFINITIONS](#qpy-custom-definition) struct now supports a new type value `'p'` to represent a [`PauliEvolutionGate`](/docs/api/qiskit/2.4/qiskit.circuit.library.PauliEvolutionGate "qiskit.circuit.library.PauliEvolutionGate"). Enties in the custom instructions tables have unique name generated that start with the string `"###PauliEvolutionGate_"` followed by a uuid string. This gate name is reserved in QPY and if you have a custom [`Instruction`](/docs/api/qiskit/2.4/qiskit.circuit.Instruction "qiskit.circuit.Instruction") object with a definition set and that name prefix it will error. If it’s of type `'p'` the data payload is defined as follows:
...
This represents the high level [`PauliEvolutionGate`](/docs/api/qiskit/2.4/qiskit.circuit.library.PauliEvolutionGate "qiskit.circuit.library.PauliEvolutionGate")
...
This represents an instance of [`SparsePauliOp`](/docs/api/qiskit/2.4/qiskit.quantum_info.SparsePauliOp "qiskit.quantum_info.SparsePauliOp").
...
A PARAMETER\_VECTOR\_ELEMENT represents a [`ParameterVectorElement`](/docs/api/qiskit/2.4/qiskit.circuit.ParameterVectorElement "qiskit.circuit.ParameterVectorElement") object the data for a INSTRUCTION\_PARAM. The contents of the PARAMETER\_VECTOR\_ELEMENT are defined as:
...
Additionally, since QPY format version v3 distinguishes between a [`Parameter`](/docs/api/qiskit/2.4/qiskit.circuit.Parameter "qiskit.circuit.Parameter") and [`ParameterVectorElement`](/docs/api/qiskit/2.4/qiskit.circuit.ParameterVectorElement "qiskit.circuit.ParameterVectorElement") the payload for a [`ParameterExpression`](/docs/api/qiskit/2.4/qiskit.circuit.ParameterExpression "qiskit.circuit.ParameterExpression") needs to be updated to distinguish between the types. The following is the modified payload format which is mostly identical to the format in Version 1 and [Version 2](#qpy-version-2) but just modifies the `map_elements` struct to include a symbol type field.

A PARAMETER\_EXPR represents a [`ParameterExpression`](/docs/api/qiskit/2.4/qiskit.circuit.ParameterExpression "qiskit.circuit.ParameterExpression") object that the data for an INSTRUCTION\_PARAM. The contents of a PARAMETER\_EXPR are defined as:
