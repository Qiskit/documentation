---
title: QuadraticForm (v2.4)
description: API reference for qiskit.circuit.library.QuadraticForm in qiskit v2.4
...
<Class id="qiskit.circuit.library.QuadraticForm" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/2.4/qiskit/circuit/library/arithmetic/quadratic_form.py#L30-L193" signature="qiskit.circuit.library.QuadraticForm(num_result_qubits=None, quadratic=None, linear=None, offset=None, little_endian=True)" modifiers="class">
  Bases: [`QuantumCircuit`](/docs/api/qiskit/2.4/qiskit.circuit.QuantumCircuit "qiskit.circuit.quantumcircuit.QuantumCircuit")
...
$$
  ...
  *   **quadratic** (*np.ndarray |* [*list*](https://docs.python.org/3/library/stdtypes.html#list)*\[*[*list*](https://docs.python.org/3/library/stdtypes.html#list)*\[*[*float*](https://docs.python.org/3/library/functions.html#float)  *|*[*ParameterExpression*](qiskit.circuit.ParameterExpression "qiskit.circuit.ParameterExpression")*]] | None*) – A matrix containing the quadratic coefficients, $A$.
  *   **linear** (*np.ndarray |* [*list*](https://docs.python.org/3/library/stdtypes.html#list)*\[*[*float*](https://docs.python.org/3/library/functions.html#float)  *|*[*ParameterExpression*](qiskit.circuit.ParameterExpression "qiskit.circuit.ParameterExpression")*] | None*) – An array containing the linear coefficients, $b$.
  *   **offset** ([*float*](https://docs.python.org/3/library/functions.html#float)  *|*[*ParameterExpression*](qiskit.circuit.ParameterExpression "qiskit.circuit.ParameterExpression") *| None*) – A constant offset, $c$.
  ...
  *   [**ValueError**](https://docs.python.org/3/library/exceptions.html#ValueError) – If `num_result_qubits` is unspecified but cannot be determined because some values of the quadratic form are parameterized.
  ...
  <Function id="qiskit.circuit.library.QuadraticForm.required_result_qubits" github="https://github.com/Qiskit/qiskit/tree/stable/2.4/qiskit/circuit/library/arithmetic/quadratic_form.py#L176-L193" signature="required_result_qubits(quadratic, linear, offset)" modifiers="static">
