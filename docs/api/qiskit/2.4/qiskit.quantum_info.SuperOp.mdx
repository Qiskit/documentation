---
title: SuperOp (v2.4)
description: API reference for qiskit.quantum_info.SuperOp in qiskit v2.4
...
$$
  ...
  **Raises**
  ...
  [**QiskitError**](/docs/api/qiskit/2.4/exceptions#qiskit.exceptions.QiskitError "qiskit.exceptions.QiskitError") – if input data cannot be initialized as a superoperator.
