---
title: AnnotatedOperation (v2.4)
description: API reference for qiskit.circuit.AnnotatedOperation in qiskit v2.4
...
<Class id="qiskit.circuit.AnnotatedOperation" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/2.4/qiskit/circuit/annotated_operation.py#L59-L241" signature="qiskit.circuit.AnnotatedOperation(base_op, modifiers)" modifiers="class">
  ...
  An “annotated operation” allows to add a list of modifiers to the “base” operation. For now, the only supported modifiers are of types [`InverseModifier`](/docs/api/qiskit/2.4/circuit#qiskit.circuit.InverseModifier "qiskit.circuit.InverseModifier"), [`ControlModifier`](/docs/api/qiskit/2.4/circuit#qiskit.circuit.ControlModifier "qiskit.circuit.ControlModifier") and [`PowerModifier`](/docs/api/qiskit/2.4/circuit#qiskit.circuit.PowerModifier "qiskit.circuit.PowerModifier").
  ...
  *   **modifiers** (*Modifier |* [*list*](https://docs.python.org/3/library/stdtypes.html#list)*\[Modifier]*) – ordered list of modifiers. Supported modifiers include `InverseModifier`, `ControlModifier` and `PowerModifier`.
  ...
  <Function id="qiskit.circuit.AnnotatedOperation.control" github="https://github.com/Qiskit/qiskit/tree/stable/2.4/qiskit/circuit/annotated_operation.py#L158-L185" signature="control(num_ctrl_qubits=1, label=None, ctrl_state=None, annotated=None)">
  ...
  <Function id="qiskit.circuit.AnnotatedOperation.copy" github="https://github.com/Qiskit/qiskit/tree/stable/2.4/qiskit/circuit/annotated_operation.py#L133-L135" signature="copy()">
  ...
  <Function id="qiskit.circuit.AnnotatedOperation.inverse" github="https://github.com/Qiskit/qiskit/tree/stable/2.4/qiskit/circuit/annotated_operation.py#L187-L202" signature="inverse(annotated=True)">
  ...
  <Function id="qiskit.circuit.AnnotatedOperation.power" github="https://github.com/Qiskit/qiskit/tree/stable/2.4/qiskit/circuit/annotated_operation.py#L204-L220" signature="power(exponent, annotated=False)">
  ...
  <Function id="qiskit.circuit.AnnotatedOperation.to_matrix" github="https://github.com/Qiskit/qiskit/tree/stable/2.4/qiskit/circuit/annotated_operation.py#L137-L156" signature="to_matrix()">
    Return a matrix representation (allowing to construct Operator).
  </Function>

  ### validate\_parameter

  <Function id="qiskit.circuit.AnnotatedOperation.validate_parameter" github="https://github.com/Qiskit/qiskit/tree/stable/2.4/qiskit/circuit/annotated_operation.py#L236-L241" signature="validate_parameter(parameter)">
