---
title: array_to_latex (v2.4)
description: API reference for qiskit.visualization.array_to_latex in qiskit v2.4
...
<Function id="qiskit.visualization.array_to_latex" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/2.4/qiskit/visualization/array.py#L149-L207" signature="qiskit.visualization.array_to_latex(array, precision=10, prefix='', source=False, max_size=8)">
  ...
  *   [**MissingOptionalLibraryError**](/docs/api/qiskit/2.4/exceptions#qiskit.exceptions.MissingOptionalLibraryError "qiskit.exceptions.MissingOptionalLibraryError") – If `source` is `False` and `IPython.display.Latex` cannot be imported. Or if sympy is not installed.
</Function>
