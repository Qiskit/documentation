---
title: ApproximateCircuit (v2.4)
description: API reference for qiskit.synthesis.unitary.aqc.ApproximateCircuit in qiskit v2.4
...
<Class id="qiskit.synthesis.unitary.aqc.ApproximateCircuit" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/2.4/qiskit/synthesis/unitary/aqc/approximate.py#L21-L52" signature="qiskit.synthesis.unitary.aqc.ApproximateCircuit(num_qubits, name=None)" modifiers="class">
  Bases: [`QuantumCircuit`](/docs/api/qiskit/2.4/qiskit.circuit.QuantumCircuit "qiskit.circuit.quantumcircuit.QuantumCircuit"), [`ABC`](https://docs.python.org/3/library/abc.html#abc.ABC)
  ...
  *   **name** ([*str*](https://docs.python.org/3/library/stdtypes.html#str)) – a name of the circuit.
  ...
  <Function id="qiskit.synthesis.unitary.aqc.ApproximateCircuit.build" github="https://github.com/Qiskit/qiskit/tree/stable/2.4/qiskit/synthesis/unitary/aqc/approximate.py#L43-L52" signature="build(thetas)" modifiers="abstractmethod">
