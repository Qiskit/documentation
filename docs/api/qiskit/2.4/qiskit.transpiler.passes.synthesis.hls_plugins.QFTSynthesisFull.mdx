---
title: QFTSynthesisFull (v2.4)
description: API reference for qiskit.transpiler.passes.synthesis.hls_plugins.QFTSynthesisFull in qiskit v2.4
...
<Class id="qiskit.transpiler.passes.synthesis.hls_plugins.QFTSynthesisFull" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/2.4/qiskit/transpiler/passes/synthesis/hls_plugins.py#L879-L936" signature="qiskit.transpiler.passes.synthesis.hls_plugins.QFTSynthesisFull" modifiers="class">
  ...
  **References**
  ...
  <Function id="qiskit.transpiler.passes.synthesis.hls_plugins.QFTSynthesisFull.run" github="https://github.com/Qiskit/qiskit/tree/stable/2.4/qiskit/transpiler/passes/synthesis/hls_plugins.py#L914-L936" signature="run(high_level_object, coupling_map=None, target=None, qubits=None, **options)">
