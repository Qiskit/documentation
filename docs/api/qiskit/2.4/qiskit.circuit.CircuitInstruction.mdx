---
title: CircuitInstruction (v2.4)
description: API reference for qiskit.circuit.CircuitInstruction in qiskit v2.4
...
<Class id="qiskit.circuit.CircuitInstruction" isDedicatedPage={true} signature="qiskit.circuit.CircuitInstruction(operation, qubits=None, clbits=None)" modifiers="class">
  ...
  A single instruction in a [`QuantumCircuit`](/docs/api/qiskit/2.4/qiskit.circuit.QuantumCircuit "qiskit.circuit.QuantumCircuit"), comprised of the [`operation`](#qiskit.circuit.CircuitInstruction.operation "qiskit.circuit.CircuitInstruction.operation") and various operands.
