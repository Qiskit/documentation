---
title: plot_state_paulivec (v2.4)
description: API reference for qiskit.visualization.plot_state_paulivec in qiskit v2.4
...
<Function id="qiskit.visualization.plot_state_paulivec" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/2.4/qiskit/visualization/state_visualization.py#L622-L739" signature="qiskit.visualization.plot_state_paulivec(state, title='', figsize=None, color=None, ax=None, *, filename=None)">
...
$$
  ...
  *   [**VisualizationError**](/docs/api/qiskit/2.4/visualization#qiskit.visualization.VisualizationError "qiskit.visualization.VisualizationError") – if input is not a valid N-qubit state.
  ...
  **Examples**
  ...
  ![Output from the previous code.](/docs/images/api/qiskit/2.4/qiskit-visualization-plot_state_paulivec-1.avif)
  ...
  ![Output from the previous code.](/docs/images/api/qiskit/2.4/qiskit-visualization-plot_state_paulivec-2.avif)
</Function>
