---
title: hidden_linear_function (v2.4)
description: API reference for qiskit.circuit.library.hidden_linear_function in qiskit v2.4
...
<Function id="qiskit.circuit.library.hidden_linear_function" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/2.4/qiskit/circuit/library/hidden_linear_function.py#L92-L163" signature="qiskit.circuit.library.hidden_linear_function(adjacency_matrix)">
...
$$
  ...
  ![Circuit diagram output by the previous code.](/docs/images/api/qiskit/2.4/qiskit-circuit-library-hidden_linear_function-1.avif)

  **Parameters**

  **adjacency\_matrix** ([*list*](https://docs.python.org/3/library/stdtypes.html#list)  *|*[*ndarray*](https://numpy.org/doc/stable/reference/generated/numpy.ndarray.html#numpy.ndarray)) – a symmetric n-by-n list of 0-1 lists. n will be the number of qubits.

  **Raises**

  [**CircuitError**](/docs/api/qiskit/2.4/circuit#qiskit.circuit.CircuitError "qiskit.circuit.CircuitError") – If A is not symmetric.
