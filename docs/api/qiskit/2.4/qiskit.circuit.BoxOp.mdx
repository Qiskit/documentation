---
title: BoxOp (v2.4)
description: API reference for qiskit.circuit.BoxOp in qiskit v2.4
...
<Class id="qiskit.circuit.BoxOp" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/2.4/qiskit/circuit/controlflow/box.py#L28-L131" signature="qiskit.circuit.BoxOp(body, duration=None, unit=None, label=None, annotations=())" modifiers="class">
  ...
  Typically you create this by using the builder-interface form of [`QuantumCircuit.box()`](/docs/api/qiskit/2.4/qiskit.circuit.QuantumCircuit#box "qiskit.circuit.QuantumCircuit.box").

  Default constructor of [`BoxOp`](#qiskit.circuit.BoxOp "qiskit.circuit.BoxOp").

  **Parameters**

  *   **body** ([*QuantumCircuit*](/docs/api/qiskit/2.4/qiskit.circuit.QuantumCircuit "qiskit.circuit.QuantumCircuit")) – the circuit to use as the body of the box. This should explicitly close over any [`expr.Var`](/docs/api/qiskit/2.4/circuit_classical#qiskit.circuit.classical.expr.Var "qiskit.circuit.classical.expr.Var") variables that must be incident from the outer circuit. The required number of qubits and clbits for the resulting instruction are inferred from the number in the circuit, even if they are idle.
  ...
  *   **annotations** ([*Iterable*](https://docs.python.org/3/library/typing.html#typing.Iterable)*\[*[*Annotation*](qiskit.circuit.Annotation "qiskit.circuit.Annotation")*]*) – any [`Annotation`](qiskit.circuit.Annotation "qiskit.circuit.Annotation")s to apply to the box. In cases where order is important, annotations are to be interpreted in the same order they appear in the iterable.
  ...
  <Attribute id="qiskit.circuit.BoxOp.body">
    The `body` [`QuantumCircuit`](/docs/api/qiskit/2.4/qiskit.circuit.QuantumCircuit "qiskit.circuit.QuantumCircuit") of the operation.
