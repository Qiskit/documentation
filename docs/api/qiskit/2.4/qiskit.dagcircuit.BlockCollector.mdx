---
title: BlockCollector (v2.4)
description: API reference for qiskit.dagcircuit.BlockCollector in qiskit v2.4
...
<Class id="qiskit.dagcircuit.BlockCollector" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/2.4/qiskit/dagcircuit/collect_blocks.py#L29-L254" signature="qiskit.dagcircuit.BlockCollector(dag)" modifiers="class">
  ...
  **Raises**
  ...
  [**DAGCircuitError**](/docs/api/qiskit/2.4/dagcircuit#qiskit.dagcircuit.DAGCircuitError "qiskit.dagcircuit.DAGCircuitError") – the input object is not a DAG.
