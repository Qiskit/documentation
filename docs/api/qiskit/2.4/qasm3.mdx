---
title: qasm3 (v2.4)
description: API reference for qiskit.qasm3 in qiskit v2.4
...
<Function id="qiskit.qasm3.dump" github="https://github.com/Qiskit/qiskit/tree/stable/2.4/qiskit/qasm3/__init__.py#L298-L308" signature="qiskit.qasm3.dump(circuit, stream, **kwargs)">
...
<Function id="qiskit.qasm3.dumps" github="https://github.com/Qiskit/qiskit/tree/stable/2.4/qiskit/qasm3/__init__.py#L285-L295" signature="qiskit.qasm3.dumps(circuit, **kwargs)">
...
<Class id="qiskit.qasm3.Exporter" github="https://github.com/Qiskit/qiskit/tree/stable/2.4/qiskit/qasm3/exporter.py#L191-L283" signature="qiskit.qasm3.Exporter(includes=('stdgates.inc', ), basis_gates=('U', ), disable_constants=False, alias_classical_registers=None, allow_aliasing=None, indent='  ', experimental=<ExperimentalFeatures: 0>, annotation_handlers=None, implicit_defcals=None)" modifiers="class">
  ...
  *   **annotation\_handlers** ([*dict*](https://docs.python.org/3/library/stdtypes.html#dict)*\[*[*str*](https://docs.python.org/3/library/stdtypes.html#str)*,* [*OpenQASM3Serializer*](circuit_annotation#qiskit.circuit.annotation.OpenQASM3Serializer "qiskit.circuit.annotation.OpenQASM3Serializer")*] | None*) – a mapping of namespaces to annotation serializers. When an [`Annotation`](/docs/api/qiskit/2.4/qiskit.circuit.Annotation "qiskit.circuit.Annotation") object is encountered, the most specific namespace in this mapping that matches the annotation’s [`namespace`](/docs/api/qiskit/2.4/qiskit.circuit.Annotation#namespace "qiskit.circuit.Annotation.namespace") attribute will be used to serialize it.

  *   **implicit\_defcals** ([*dict*](https://docs.python.org/3/library/stdtypes.html#dict)*\[*[*str*](https://docs.python.org/3/library/stdtypes.html#str)*, DefcalInstruction] | None*) – mapping of [`Instruction.name`](/docs/api/qiskit/2.4/qiskit.circuit.Instruction#name "qiskit.circuit.Instruction.name")s to an associated `DefcalInstruction` object. All instructions with the key name in the input circuit should be output as if there is a `defcal` statement corresponding to the given `DefcalInstruction` defined. The key name and the `DefcalInstruction.name` do not need to match. The `defcal` name cannot collide with an OpenQASM 3 keyword.

  #### dump

  <Function id="qiskit.qasm3.Exporter.dump" github="https://github.com/Qiskit/qiskit/tree/stable/2.4/qiskit/qasm3/exporter.py#L269-L283" signature="dump(circuit, stream)">
    Convert the circuit to OpenQASM 3, dumping the result to a file or text stream.
  </Function>

  #### dumps

  <Function id="qiskit.qasm3.Exporter.dumps" github="https://github.com/Qiskit/qiskit/tree/stable/2.4/qiskit/qasm3/exporter.py#L263-L267" signature="dumps(circuit)">
...
<Class id="qiskit.qasm3.QASM3ExporterError" github="https://github.com/Qiskit/qiskit/tree/stable/2.4/qiskit/qasm3/exceptions.py#L22-L23" signature="qiskit.qasm3.QASM3ExporterError(*message)" modifiers="exception">
  Bases: `QASM3Error`
...
<Class id="qiskit.qasm3.ExperimentalFeatures" github="https://github.com/Qiskit/qiskit/tree/stable/2.4/qiskit/qasm3/experimental.py#L21-L70" signature="qiskit.qasm3.ExperimentalFeatures(*values)" modifiers="class">
...
<Function id="qiskit.qasm3.load" github="https://github.com/Qiskit/qiskit/tree/stable/2.4/qiskit/qasm3/__init__.py#L311-L338" signature="qiskit.qasm3.load(filename, *, num_qubits=None, annotation_handlers=None)">
...
<Function id="qiskit.qasm3.loads" github="https://github.com/Qiskit/qiskit/tree/stable/2.4/qiskit/qasm3/__init__.py#L341-L436" signature="qiskit.qasm3.loads(program, *, num_qubits=None, annotation_handlers=None)">
...
<Class id="qiskit.qasm3.QASM3ImporterError" github="https://github.com/Qiskit/qiskit/tree/stable/2.4/qiskit/qasm3/exceptions.py#L26-L27" signature="qiskit.qasm3.QASM3ImporterError(*message)" modifiers="exception">
  Bases: `QASM3Error`
...
![Circuit diagram output by the previous code.](/docs/images/api/qiskit/2.4/qasm3-3.avif)
...
<Class id="qiskit.qasm3.CustomGate" signature="qiskit.qasm3.CustomGate(constructor, name, num_params, num_qubits)" modifiers="class">
  ...
  <Attribute id="qiskit.qasm3.CustomGate.constructor">
    A callable Python object that takes `num_params` angles as positional arguments, and returns a [`Gate`](/docs/api/qiskit/2.4/qiskit.circuit.Gate "qiskit.circuit.Gate") object representing the gate.
  </Attribute>
