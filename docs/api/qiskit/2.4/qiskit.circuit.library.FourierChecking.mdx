---
title: FourierChecking (v2.4)
description: API reference for qiskit.circuit.library.FourierChecking in qiskit v2.4
...
<Class id="qiskit.circuit.library.FourierChecking" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/2.4/qiskit/circuit/library/fourier_checking.py#L25-L101" signature="qiskit.circuit.library.FourierChecking(f, g)" modifiers="class">
  ...
  **Raises**
  ...
  [**CircuitError**](/docs/api/qiskit/2.4/circuit#qiskit.circuit.CircuitError "qiskit.circuit.CircuitError") – if the inputs f and g are not valid.

  **Reference Circuit:**

  ![Diagram illustrating the previously described circuit.](/docs/images/api/qiskit/2.4/qiskit-circuit-library-FourierChecking-1.avif)
