---
title: UCGate (v2.4)
description: API reference for qiskit.circuit.library.UCGate in qiskit v2.4
...
<Class id="qiskit.circuit.library.UCGate" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/2.4/qiskit/circuit/library/generalized_gates/uc.py#L39-L300" signature="qiskit.circuit.library.UCGate(gate_list, up_to_diagonal=False, mux_simp=True)" modifiers="class">
...
$$
  ...
  *   **mux\_simp** ([*bool*](https://docs.python.org/3/library/functions.html#bool)) – Determines whether the search for repetitions is conducted (default: True). The intention is to perform a possible simplification in the number of controls and operators.

  **Raises**

  [**QiskitError**](/docs/api/qiskit/2.4/exceptions#qiskit.exceptions.QiskitError "qiskit.exceptions.QiskitError") – in case of bad input to the constructor
  ...
  <Function id="qiskit.circuit.library.UCGate.add_decomposition" github="https://github.com/Qiskit/qiskit/tree/stable/2.4/qiskit/circuit/instruction.py#L318-L323" signature="add_decomposition(decomposition)">
    Add a decomposition of the instruction to the SessionEquivalenceLibrary.
  </Function>

  ### broadcast\_arguments

  <Function id="qiskit.circuit.library.UCGate.broadcast_arguments" github="https://github.com/Qiskit/qiskit/tree/stable/2.4/qiskit/circuit/gate.py#L206-L263" signature="broadcast_arguments(qargs, cargs)">
  ...
  <Function id="qiskit.circuit.library.UCGate.control" github="https://github.com/Qiskit/qiskit/tree/stable/2.4/qiskit/circuit/gate.py#L105-L163" signature="control(num_ctrl_qubits=1, label=None, ctrl_state=None, annotated=None)">
  ...
  <Function id="qiskit.circuit.library.UCGate.copy" github="https://github.com/Qiskit/qiskit/tree/stable/2.4/qiskit/circuit/instruction.py#L428-L443" signature="copy(name=None)">
  ...
  <Function id="qiskit.circuit.library.UCGate.inverse" github="https://github.com/Qiskit/qiskit/tree/stable/2.4/qiskit/circuit/library/generalized_gates/uc.py#L172-L194" signature="inverse(annotated=False)">
    Return the inverse.
  ...
  <Function id="qiskit.circuit.library.UCGate.is_parameterized" github="https://github.com/Qiskit/qiskit/tree/stable/2.4/qiskit/circuit/instruction.py#L283-L288" signature="is_parameterized()">
  ...
  <Function id="qiskit.circuit.library.UCGate.power" github="https://github.com/Qiskit/qiskit/tree/stable/2.4/qiskit/circuit/gate.py#L63-L94" signature="power(exponent, annotated=False)">
  ...
  <Function id="qiskit.circuit.library.UCGate.repeat" github="https://github.com/Qiskit/qiskit/tree/stable/2.4/qiskit/circuit/instruction.py#L491-L521" signature="repeat(n)">
  ...
  <Function id="qiskit.circuit.library.UCGate.reverse_ops" github="https://github.com/Qiskit/qiskit/tree/stable/2.4/qiskit/circuit/instruction.py#L345-L369" signature="reverse_ops()">
  ...
  <Function id="qiskit.circuit.library.UCGate.soft_compare" github="https://github.com/Qiskit/qiskit/tree/stable/2.4/qiskit/circuit/instruction.py#L214-L254" signature="soft_compare(other)">
  ...
  <Function id="qiskit.circuit.library.UCGate.to_matrix" github="https://github.com/Qiskit/qiskit/tree/stable/2.4/qiskit/circuit/gate.py#L49-L61" signature="to_matrix()">
  ...
  <Function id="qiskit.circuit.library.UCGate.to_mutable" github="https://github.com/Qiskit/qiskit/tree/stable/2.4/qiskit/circuit/instruction.py#L144-L152" signature="to_mutable()">
  ...
  <Function id="qiskit.circuit.library.UCGate.validate_parameter" github="https://github.com/Qiskit/qiskit/tree/stable/2.4/qiskit/circuit/library/generalized_gates/uc.py#L295-L300" signature="validate_parameter(parameter)">
