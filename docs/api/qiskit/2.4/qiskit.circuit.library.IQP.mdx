---
title: IQP (v2.4)
description: API reference for qiskit.circuit.library.IQP in qiskit v2.4
...
<Class id="qiskit.circuit.library.IQP" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/2.4/qiskit/circuit/library/iqp.py#L24-L83" signature="qiskit.circuit.library.IQP(interactions)" modifiers="class">
  ...
  ![Diagram illustrating the previously described circuit.](/docs/images/api/qiskit/2.4/qiskit-circuit-library-IQP-1.avif)

  Expanded Circuit:

  ![Diagram illustrating the previously described circuit.](/docs/images/api/qiskit/2.4/qiskit-circuit-library-IQP-2.avif)
  ...
  **Raises**
  ...
  [**CircuitError**](/docs/api/qiskit/2.4/circuit#qiskit.circuit.CircuitError "qiskit.circuit.CircuitError") – if the input is not a symmetric matrix.
