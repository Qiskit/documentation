---
title: BasicSimulator (v2.4)
description: API reference for qiskit.providers.basic_provider.BasicSimulator in qiskit v2.4
...
<Class id="qiskit.providers.basic_provider.BasicSimulator" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/2.4/qiskit/providers/basic_provider/basic_simulator.py#L70-L810" signature="qiskit.providers.basic_provider.BasicSimulator(provider=None, target=None, **fields)" modifiers="class">
  ...
  **Raises**
  ...
  <Function id="qiskit.providers.basic_provider.BasicSimulator.run" github="https://github.com/Qiskit/qiskit/tree/stable/2.4/qiskit/providers/basic_provider/basic_simulator.py#L438-L489" signature="run(run_input, **run_options)">
    ...
    *   **run\_input** ([*QuantumCircuit*](/docs/api/qiskit/2.4/qiskit.circuit.QuantumCircuit "qiskit.circuit.QuantumCircuit")  *or*[*list*](https://docs.python.org/3/library/stdtypes.html#list)) – the QuantumCircuit (or list of QuantumCircuit objects) to run
