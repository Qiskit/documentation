---
title: plot_gate_map (v2.4)
description: API reference for qiskit.visualization.plot_gate_map in qiskit v2.4
...
<Function id="qiskit.visualization.plot_gate_map" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/2.4/qiskit/visualization/gate_map.py#L27-L934" signature="qiskit.visualization.plot_gate_map(backend, figsize=None, plot_directed=False, label_qubits=True, qubit_size=None, line_width=4, font_size=None, qubit_color=None, qubit_labels=None, line_color=None, font_color='white', ax=None, filename=None, qubit_coordinates=None)">
  ...
  *   [**QiskitError**](/docs/api/qiskit/2.4/exceptions#qiskit.exceptions.QiskitError "qiskit.exceptions.QiskitError") – If you tried to pass a simulator or the backend is None, but one of num\_qubits, mpl\_data, or cmap is None.
  *   [**MissingOptionalLibraryError**](/docs/api/qiskit/2.4/exceptions#qiskit.exceptions.MissingOptionalLibraryError "qiskit.exceptions.MissingOptionalLibraryError") – If matplotlib not installed.
  ...
  **Example**
  ...
  ![Output from the previous code.](/docs/images/api/qiskit/2.4/qiskit-visualization-plot_gate_map-1.avif)
</Function>
