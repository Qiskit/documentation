---
title: PiecewisePolynomialPauliRotations (v2.4)
description: API reference for qiskit.circuit.library.PiecewisePolynomialPauliRotations in qiskit v2.4
...
$$
  ...
  *   **name** ([*str*](https://docs.python.org/3/library/stdtypes.html#str)) – The name of the circuit.
  ...
  <Function id="qiskit.circuit.library.PiecewisePolynomialPauliRotations.evaluate" github="https://github.com/Qiskit/qiskit/tree/stable/2.4/qiskit/circuit/library/arithmetic/piecewise_polynomial_pauli_rotations.py#L210-L224" signature="evaluate(x)">
