---
title: SolovayKitaevDecomposition (v2.4)
description: API reference for qiskit.synthesis.SolovayKitaevDecomposition in qiskit v2.4
...
<Class id="qiskit.synthesis.SolovayKitaevDecomposition" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/2.4/qiskit/synthesis/discrete_basis/solovay_kitaev.py#L33-L273" signature="qiskit.synthesis.SolovayKitaevDecomposition(basic_approximations=None, *, basis_gates=None, depth=12, check_input=False)" modifiers="class">
  ...
  <Admonition title="Note" type="note">
    If `basic_approximations` is passed as `.npy` file, pickle is used internally to load the data. This is a potential security vulnerability and only trusted files should be loaded.
  </Admonition>
  ...
  *   **basic\_approximations** ([*str*](https://docs.python.org/3/library/stdtypes.html#str)  *|*[*dict*](https://docs.python.org/3/library/stdtypes.html#dict)*\[*[*str*](https://docs.python.org/3/library/stdtypes.html#str)*, np.ndarray] |* [*list*](https://docs.python.org/3/library/stdtypes.html#list)*\[GateSequence] | None*) –
      ...
      A specification of the basic SO(3) approximations in terms of discrete gates. At each iteration of this algorithm, the remaining error is approximated with the closest sequence of gates in this set. If a `str`, this specifies a filename from which to load the approximation. If a `dict`, then this contains `{gates: effective_SO3_matrix}` pairs, e.g. `{"h t": np.array([[0, 0.7071, -0.7071], [0, -0.7071, -0.7071], [-1, 0, 0]]}`. If a list, this contains the same information as the dict, but already converted to `GateSequence` objects, which contain the SO(3) matrix and gates.
  ...
  *   **check\_input** ([*bool*](https://docs.python.org/3/library/functions.html#bool)) – If `True`, perform intermediate steps checking whether the matrices are of expected form.
  ...
  <Function id="qiskit.synthesis.SolovayKitaevDecomposition.find_basic_approximation" github="https://github.com/Qiskit/qiskit/tree/stable/2.4/qiskit/synthesis/discrete_basis/solovay_kitaev.py#L259-L273" signature="find_basic_approximation(sequence)">
    ...
    <Admonition title="Deprecated since version 2.3" type="danger">
      The method `qiskit.synthesis.discrete_basis.solovay_kitaev.SolovayKitaevDecomposition.find_basic_approximation()` is deprecated as of Qiskit 2.3. It will be removed no earlier than 3 months after the release date. Use query\_basic\_approximation instead, which takes a Gate or matrix as input and returns a QuantumCircuit object.
    </Admonition>
  ...
  <Function id="qiskit.synthesis.SolovayKitaevDecomposition.load_basic_approximations" github="https://github.com/Qiskit/qiskit/tree/stable/2.4/qiskit/synthesis/discrete_basis/solovay_kitaev.py#L117-L176" signature="load_basic_approximations(data)" modifiers="static">
    Load basic approximations.

    <Admonition title="Note" type="note">
      If `data` is given as string, this method internally relies on pickle to load the file. This is a potential security vulnerability and only trusted files should be loaded.
    </Admonition>
  ...
  <Function id="qiskit.synthesis.SolovayKitaevDecomposition.query_basic_approximation" github="https://github.com/Qiskit/qiskit/tree/stable/2.4/qiskit/synthesis/discrete_basis/solovay_kitaev.py#L249-L257" signature="query_basic_approximation(gate)">
    Query a basic approximation of a matrix.

    **Parameters**

    **gate** ([*ndarray*](https://numpy.org/doc/stable/reference/generated/numpy.ndarray.html#numpy.ndarray)  *|*[*Gate*](qiskit.circuit.Gate "qiskit.circuit.gate.Gate"))
  ...
  <Function id="qiskit.synthesis.SolovayKitaevDecomposition.run" github="https://github.com/Qiskit/qiskit/tree/stable/2.4/qiskit/synthesis/discrete_basis/solovay_kitaev.py#L206-L247" signature="run(gate_matrix, recursion_degree, return_dag=False, check_input=True)">
    Run the algorithm.
    ...
    *   **return\_dag** ([*bool*](https://docs.python.org/3/library/functions.html#bool)) – If `True` return a [`DAGCircuit`](qiskit.dagcircuit.DAGCircuit "qiskit.dagcircuit.DAGCircuit"), else a [`QuantumCircuit`](/docs/api/qiskit/2.4/qiskit.circuit.QuantumCircuit "qiskit.circuit.QuantumCircuit").
    ...
    **Return type**
    ...
    [QuantumCircuit](/docs/api/qiskit/2.4/qiskit.circuit.QuantumCircuit "qiskit.circuit.QuantumCircuit") | [DAGCircuit](qiskit.dagcircuit.DAGCircuit "qiskit.dagcircuit.DAGCircuit")
  </Function>

  ### save\_basic\_approximations

  <Function id="qiskit.synthesis.SolovayKitaevDecomposition.save_basic_approximations" github="https://github.com/Qiskit/qiskit/tree/stable/2.4/qiskit/synthesis/discrete_basis/solovay_kitaev.py#L178-L204" signature="save_basic_approximations(filename)">
