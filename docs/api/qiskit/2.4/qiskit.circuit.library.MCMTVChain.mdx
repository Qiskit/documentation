---
title: MCMTVChain (v2.4)
description: API reference for qiskit.circuit.library.MCMTVChain in qiskit v2.4
...
<Class id="qiskit.circuit.library.MCMTVChain" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/2.4/qiskit/circuit/library/generalized_gates/mcmt.py#L123-L185" signature="qiskit.circuit.library.MCMTVChain(gate, num_ctrl_qubits, num_target_qubits)" modifiers="class">
  ...
  ![Diagram illustrating the previously described circuit.](/docs/images/api/qiskit/2.4/qiskit-circuit-library-MCMTVChain-1.avif)
  ...
  *   **gate** ([*Gate*](qiskit.circuit.Gate "qiskit.circuit.Gate") *| Callable\[\[*[*QuantumCircuit*](/docs/api/qiskit/2.4/qiskit.circuit.QuantumCircuit "qiskit.circuit.QuantumCircuit")*,* [*circuit.Qubit*](/docs/api/qiskit/2.4/circuit#qiskit.circuit.Qubit "qiskit.circuit.Qubit")*,* [*circuit.Qubit*](/docs/api/qiskit/2.4/circuit#qiskit.circuit.Qubit "qiskit.circuit.Qubit")*],* [*circuit.Instruction*](qiskit.circuit.Instruction "qiskit.circuit.Instruction")*]*)
  ...
  *   **num\_target\_qubits** ([*int*](https://docs.python.org/3/library/functions.html#int))
  ...
  <Function id="qiskit.circuit.library.MCMTVChain.inverse" github="https://github.com/Qiskit/qiskit/tree/stable/2.4/qiskit/circuit/library/generalized_gates/mcmt.py#L184-L185" signature="inverse(annotated=False)">
