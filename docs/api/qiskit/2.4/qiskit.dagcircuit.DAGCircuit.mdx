...
description: API reference for qiskit.dagcircuit.DAGCircuit in qiskit v2.4
...
<Class id="qiskit.dagcircuit.DAGCircuit" isDedicatedPage={true} signature="qiskit.dagcircuit.DAGCircuit" modifiers="class">
  ...
  <Attribute id="qiskit.dagcircuit.DAGCircuit.clbits">
    Returns the current sequence of registered [`Clbit`](/docs/api/qiskit/2.4/circuit#qiskit.circuit.Clbit "qiskit.circuit.Clbit") instances as a list.
    ...
    **Return type**
    ...
    list([`Clbit`](/docs/api/qiskit/2.4/circuit#qiskit.circuit.Clbit "qiskit.circuit.Clbit"))
  </Attribute>
  ...
  <Attribute id="qiskit.dagcircuit.DAGCircuit.qubits">
    Returns the current sequence of registered [`Qubit`](/docs/api/qiskit/2.4/circuit#qiskit.circuit.Qubit "qiskit.circuit.Qubit") instances as a list.
    ...
    **Return type**
    ...
    list([`Qubit`](/docs/api/qiskit/2.4/circuit#qiskit.circuit.Qubit "qiskit.circuit.Qubit"))
  </Attribute>
  ...
  <Function id="qiskit.dagcircuit.DAGCircuit.apply_operation_back" signature="apply_operation_back(op, qargs=None, cargs=None, *, check=True)">
    ...
    **Raises**
    ...
    [**DAGCircuitError**](/docs/api/qiskit/2.4/dagcircuit#qiskit.dagcircuit.DAGCircuitError "qiskit.dagcircuit.DAGCircuitError") – if a leaf node is connected to multiple outputs
  </Function>
  ...
  <Function id="qiskit.dagcircuit.DAGCircuit.apply_operation_front" signature="apply_operation_front(op, qargs=None, cargs=None, *, check=True)">
    ...
    **Raises**
    ...
    [**DAGCircuitError**](/docs/api/qiskit/2.4/dagcircuit#qiskit.dagcircuit.DAGCircuitError "qiskit.dagcircuit.DAGCircuitError") – if initial nodes connected to multiple out edges
  </Function>
  ...
  <Function id="qiskit.dagcircuit.DAGCircuit.compose" signature="compose(other, qubits=None, clbits=None, front=False, inplace=True, *, inline_captures=False)">
    ...
    *   **qubits** ([*list*](https://docs.python.org/3/library/stdtypes.html#list)*\[*[*Qubit*](/docs/api/qiskit/2.4/circuit#qiskit.circuit.Qubit "qiskit.circuit.Qubit")*|*[*int*](https://docs.python.org/3/library/functions.html#int)*]*) – qubits of self to compose onto.
    *   **clbits** ([*list*](https://docs.python.org/3/library/stdtypes.html#list)*\[*[*Clbit*](/docs/api/qiskit/2.4/circuit#qiskit.circuit.Clbit "qiskit.circuit.Clbit")*|*[*int*](https://docs.python.org/3/library/functions.html#int)*]*) – clbits of self to compose onto.
    ...
    **Raises**
    ...
    [**DAGCircuitError**](/docs/api/qiskit/2.4/dagcircuit#qiskit.dagcircuit.DAGCircuitError "qiskit.dagcircuit.DAGCircuitError") – if `other` is wider or there are duplicate edge mappings.
  </Function>
  ...
  <Function id="qiskit.dagcircuit.DAGCircuit.depth" signature="depth(*, recurse=False)">
    ...
    *   [**DAGCircuitError**](/docs/api/qiskit/2.4/dagcircuit#qiskit.dagcircuit.DAGCircuitError "qiskit.dagcircuit.DAGCircuitError") – if not a directed acyclic graph
    *   [**DAGCircuitError**](/docs/api/qiskit/2.4/dagcircuit#qiskit.dagcircuit.DAGCircuitError "qiskit.dagcircuit.DAGCircuitError") – if unknown control flow is present in a recursive call, or any control flow is present in a non-recursive call.
  </Function>
  ...
  <Function id="qiskit.dagcircuit.DAGCircuit.find_bit" signature="find_bit(bit)">
    ...
    **bit** ([*Bit*](/docs/api/qiskit/2.4/circuit#qiskit.circuit.Bit "qiskit.circuit.Bit")) – The bit to locate.
  ...
  <Function id="qiskit.dagcircuit.DAGCircuit.idle_wires" signature="idle_wires(ignore=None)">
    ...
    **Raises**
    ...
    [**DAGCircuitError**](/docs/api/qiskit/2.4/dagcircuit#qiskit.dagcircuit.DAGCircuitError "qiskit.dagcircuit.DAGCircuitError") – If the DAG is invalid
  </Function>
  ...
  <Function id="qiskit.dagcircuit.DAGCircuit.nodes_on_wire" signature="nodes_on_wire(wire, only_ops=False)">
    ...
    *   **wire** ([*Bit*](/docs/api/qiskit/2.4/circuit#qiskit.circuit.Bit "qiskit.circuit.Bit")) – the wire to be looked at.
    ...
    **Raises**
    ...
    [**DAGCircuitError**](/docs/api/qiskit/2.4/dagcircuit#qiskit.dagcircuit.DAGCircuitError "qiskit.dagcircuit.DAGCircuitError") – if the given wire doesn’t exist in the DAG
  </Function>
  ...
  <Function id="qiskit.dagcircuit.DAGCircuit.op_nodes" signature="op_nodes(op=None, include_directives=True)">
    ...
    *   **op** ([*Type*](/docs/api/qiskit/2.4/circuit_classical#qiskit.circuit.classical.types.Type "qiskit.circuit.classical.types.Type")) – [`qiskit.circuit.Operation`](qiskit.circuit.Operation "qiskit.circuit.Operation") subclass op nodes to return. If None, return all op nodes.
  ...
  <Function id="qiskit.dagcircuit.DAGCircuit.quantum_causal_cone" signature="quantum_causal_cone(qubit)">
    ...
    **qubit** ([*Qubit*](/docs/api/qiskit/2.4/circuit#qiskit.circuit.Qubit "qiskit.circuit.Qubit")) – The output qubit for which we want to find the causal cone.
    ...
    **Return type**
    ...
    Set\[[*Qubit*](/docs/api/qiskit/2.4/circuit#qiskit.circuit.Qubit "qiskit.circuit.Qubit")]
  </Function>
  ...
  <Function id="qiskit.dagcircuit.DAGCircuit.remove_clbits" signature="remove_clbits(*clbits)">
    ...
    **clbits** (*List\[*[*Clbit*](/docs/api/qiskit/2.4/circuit#qiskit.circuit.Clbit "qiskit.circuit.Clbit")*]*) – The bits to remove.

    **Raises**

    [**DAGCircuitError**](/docs/api/qiskit/2.4/dagcircuit#qiskit.dagcircuit.DAGCircuitError "qiskit.dagcircuit.DAGCircuitError") – a clbit is not a [`Clbit`](/docs/api/qiskit/2.4/circuit#qiskit.circuit.Clbit "qiskit.circuit.Clbit"), is not in the circuit, or is not idle.
  </Function>
  ...
  <Function id="qiskit.dagcircuit.DAGCircuit.remove_cregs" signature="remove_cregs(*cregs)">
    ...
    *   [**DAGCircuitError**](/docs/api/qiskit/2.4/dagcircuit#qiskit.dagcircuit.DAGCircuitError "qiskit.dagcircuit.DAGCircuitError") – a creg is not a ClassicalRegister, or is not in
    *   **the circuit.** –
  </Function>
  ...
  <Function id="qiskit.dagcircuit.DAGCircuit.remove_qregs" signature="remove_qregs(*qregs)">
    ...
    *   [**DAGCircuitError**](/docs/api/qiskit/2.4/dagcircuit#qiskit.dagcircuit.DAGCircuitError "qiskit.dagcircuit.DAGCircuitError") – a qreg is not a QuantumRegister, or is not in
    *   **the circuit.** –
  </Function>
  ...
  <Function id="qiskit.dagcircuit.DAGCircuit.remove_qubits" signature="remove_qubits(*qubits)">
    ...
    **qubits** (*List\[*[*Qubit*](/docs/api/qiskit/2.4/circuit#qiskit.circuit.Qubit "qiskit.circuit.Qubit")*]*) – The bits to remove.

    **Raises**

    [**DAGCircuitError**](/docs/api/qiskit/2.4/dagcircuit#qiskit.dagcircuit.DAGCircuitError "qiskit.dagcircuit.DAGCircuitError") – a qubit is not a [`Qubit`](/docs/api/qiskit/2.4/circuit#qiskit.circuit.Qubit "qiskit.circuit.Qubit"), is not in the circuit, or is not idle.
  </Function>
  ...
  <Function id="qiskit.dagcircuit.DAGCircuit.replace_block_with_op" signature="replace_block_with_op(node_block, op, wire_pos_map, cycle_check=True)">
    ...
    **Raises**
    ...
    [**DAGCircuitError**](/docs/api/qiskit/2.4/dagcircuit#qiskit.dagcircuit.DAGCircuitError "qiskit.dagcircuit.DAGCircuitError") – if `cycle_check` is set to `True` and replacing the specified block introduces a cycle or if `node_block` is empty.
  ...
  <Function id="qiskit.dagcircuit.DAGCircuit.size" signature="size(*, recurse=False)">
    ...
    **Raises**
    ...
    [**DAGCircuitError**](/docs/api/qiskit/2.4/dagcircuit#qiskit.dagcircuit.DAGCircuitError "qiskit.dagcircuit.DAGCircuitError") – if an unknown [`ControlFlowOp`](qiskit.circuit.ControlFlowOp "qiskit.circuit.ControlFlowOp") is present in a call with `recurse=True`, or any control flow is present in a non-recursive call.
  </Function>
  ...
  <Function id="qiskit.dagcircuit.DAGCircuit.substitute_node" signature="substitute_node(node, op, inplace=False, propagate_condition=None)">
    ...
    *   [**DAGCircuitError**](/docs/api/qiskit/2.4/dagcircuit#qiskit.dagcircuit.DAGCircuitError "qiskit.dagcircuit.DAGCircuitError") – If replacement operation was incompatible with
  ...
  <Function id="qiskit.dagcircuit.DAGCircuit.substitute_node_with_dag" signature="substitute_node_with_dag(node, input_dag, wires=None, propagate_condition=None)">
    ...
    **Raises**
    ...
    [**DAGCircuitError**](/docs/api/qiskit/2.4/dagcircuit#qiskit.dagcircuit.DAGCircuitError "qiskit.dagcircuit.DAGCircuitError") – if met with unexpected predecessor/successors
  </Function>
  ...
  <Function id="qiskit.dagcircuit.DAGCircuit.swap_nodes" signature="swap_nodes(node1, node2)">
    ...
    **Raises**
    ...
    [**DAGCircuitError**](/docs/api/qiskit/2.4/dagcircuit#qiskit.dagcircuit.DAGCircuitError "qiskit.dagcircuit.DAGCircuitError") – if either node is not an OpNode or nodes are not connected
  </Function>

  ### to\_circuit

  <Function id="qiskit.dagcircuit.DAGCircuit.to_circuit" signature="to_circuit(*, copy_operations=True)">
    Convert this DAG to a [`QuantumCircuit`](/docs/api/qiskit/2.4/qiskit.circuit.QuantumCircuit "qiskit.circuit.QuantumCircuit").

    This is a simple wrapper around [`dag_to_circuit()`](/docs/api/qiskit/2.4/converters#qiskit.converters.dag_to_circuit "qiskit.converters.dag_to_circuit").
    ...
    **Returns**
    ...
    a [`QuantumCircuit`](/docs/api/qiskit/2.4/qiskit.circuit.QuantumCircuit "qiskit.circuit.QuantumCircuit") representing this same DAG.
  </Function>
