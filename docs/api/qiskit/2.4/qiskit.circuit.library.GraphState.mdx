---
title: GraphState (v2.4)
description: API reference for qiskit.circuit.library.GraphState in qiskit v2.4
...
$$
  ...
  ![Diagram illustrating the previously described circuit.](/docs/images/api/qiskit/2.4/qiskit-circuit-library-GraphState-1.avif)
