---
title: PiecewisePolynomialPauliRotationsGate (v2.4)
description: API reference for qiskit.circuit.library.PiecewisePolynomialPauliRotationsGate in qiskit v2.4
