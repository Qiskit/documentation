---
title: HamiltonianGate (v2.4)
description: API reference for qiskit.circuit.library.HamiltonianGate in qiskit v2.4
...
<Class id="qiskit.circuit.library.HamiltonianGate" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/2.4/qiskit/circuit/library/hamiltonian_gate.py#L39-L142" signature="qiskit.circuit.library.HamiltonianGate(data, time, label=None)" modifiers="class">
  ...
  **Raises**
  ...
  <Function id="qiskit.circuit.library.HamiltonianGate.add_decomposition" github="https://github.com/Qiskit/qiskit/tree/stable/2.4/qiskit/circuit/instruction.py#L318-L323" signature="add_decomposition(decomposition)">
    Add a decomposition of the instruction to the SessionEquivalenceLibrary.
  </Function>

  ### adjoint

  <Function id="qiskit.circuit.library.HamiltonianGate.adjoint" github="https://github.com/Qiskit/qiskit/tree/stable/2.4/qiskit/circuit/library/hamiltonian_gate.py#L120-L122" signature="adjoint()">
    Return the adjoint of the unitary.
  </Function>

  ### broadcast\_arguments

  <Function id="qiskit.circuit.library.HamiltonianGate.broadcast_arguments" github="https://github.com/Qiskit/qiskit/tree/stable/2.4/qiskit/circuit/gate.py#L206-L263" signature="broadcast_arguments(qargs, cargs)">
  ...
  <Function id="qiskit.circuit.library.HamiltonianGate.conjugate" github="https://github.com/Qiskit/qiskit/tree/stable/2.4/qiskit/circuit/library/hamiltonian_gate.py#L116-L118" signature="conjugate()">
    Return the conjugate of the Hamiltonian.
  </Function>

  ### control

  <Function id="qiskit.circuit.library.HamiltonianGate.control" github="https://github.com/Qiskit/qiskit/tree/stable/2.4/qiskit/circuit/gate.py#L105-L163" signature="control(num_ctrl_qubits=1, label=None, ctrl_state=None, annotated=None)">
  ...
  <Function id="qiskit.circuit.library.HamiltonianGate.copy" github="https://github.com/Qiskit/qiskit/tree/stable/2.4/qiskit/circuit/instruction.py#L428-L443" signature="copy(name=None)">
  ...
  <Function id="qiskit.circuit.library.HamiltonianGate.inverse" github="https://github.com/Qiskit/qiskit/tree/stable/2.4/qiskit/circuit/library/hamiltonian_gate.py#L112-L114" signature="inverse(annotated=False)">
    Return the adjoint of the unitary.
  ...
  <Function id="qiskit.circuit.library.HamiltonianGate.is_parameterized" github="https://github.com/Qiskit/qiskit/tree/stable/2.4/qiskit/circuit/instruction.py#L283-L288" signature="is_parameterized()">
  ...
  <Function id="qiskit.circuit.library.HamiltonianGate.power" github="https://github.com/Qiskit/qiskit/tree/stable/2.4/qiskit/circuit/gate.py#L63-L94" signature="power(exponent, annotated=False)">
  ...
  <Function id="qiskit.circuit.library.HamiltonianGate.repeat" github="https://github.com/Qiskit/qiskit/tree/stable/2.4/qiskit/circuit/instruction.py#L491-L521" signature="repeat(n)">
  ...
  <Function id="qiskit.circuit.library.HamiltonianGate.reverse_ops" github="https://github.com/Qiskit/qiskit/tree/stable/2.4/qiskit/circuit/instruction.py#L345-L369" signature="reverse_ops()">
  ...
  <Function id="qiskit.circuit.library.HamiltonianGate.soft_compare" github="https://github.com/Qiskit/qiskit/tree/stable/2.4/qiskit/circuit/instruction.py#L214-L254" signature="soft_compare(other)">
  ...
  <Function id="qiskit.circuit.library.HamiltonianGate.to_matrix" github="https://github.com/Qiskit/qiskit/tree/stable/2.4/qiskit/circuit/gate.py#L49-L61" signature="to_matrix()">
  ...
  <Function id="qiskit.circuit.library.HamiltonianGate.to_mutable" github="https://github.com/Qiskit/qiskit/tree/stable/2.4/qiskit/circuit/instruction.py#L144-L152" signature="to_mutable()">
  ...
  <Function id="qiskit.circuit.library.HamiltonianGate.transpose" github="https://github.com/Qiskit/qiskit/tree/stable/2.4/qiskit/circuit/library/hamiltonian_gate.py#L124-L126" signature="transpose()">
    Return the transpose of the Hamiltonian.
  </Function>

  ### validate\_parameter

  <Function id="qiskit.circuit.library.HamiltonianGate.validate_parameter" github="https://github.com/Qiskit/qiskit/tree/stable/2.4/qiskit/circuit/library/hamiltonian_gate.py#L135-L142" signature="validate_parameter(parameter)">
