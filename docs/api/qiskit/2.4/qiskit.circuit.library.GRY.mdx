---
title: GRY (v2.4)
description: API reference for qiskit.circuit.library.GRY in qiskit v2.4
...
<Class id="qiskit.circuit.library.GRY" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/2.4/qiskit/circuit/library/generalized_gates/gr.py#L122-L168" signature="qiskit.circuit.library.GRY(num_qubits, theta)" modifiers="class">
...
$$
  ...
  **Expanded Circuit:**
  ...
  ![Diagram illustrating the previously described circuit.](/docs/images/api/qiskit/2.4/qiskit-circuit-library-GRY-1.avif)
