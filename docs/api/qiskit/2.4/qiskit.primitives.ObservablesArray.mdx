---
title: ObservablesArray (v2.4)
description: API reference for qiskit.primitives.ObservablesArray in qiskit v2.4
  ...
  **Raises**
  ...
  <Function id="qiskit.primitives.ObservablesArray.apply_layout" github="https://github.com/Qiskit/qiskit/tree/stable/2.4/qiskit/primitives/containers/observables_array.py#L344-L373" signature="apply_layout(layout, num_qubits=None)">
    ...
    **Raises**
    ...
    [**QiskitError**](/docs/api/qiskit/2.4/exceptions#qiskit.exceptions.QiskitError "qiskit.exceptions.QiskitError") –
