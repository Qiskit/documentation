---
title: IntComparatorSynthesisNoAux (v2.4)
description: API reference for qiskit.transpiler.passes.synthesis.hls_plugins.IntComparatorSynthesisNoAux in qiskit v2.4
