---
title: DefaultSynthesisClifford (v2.4)
description: API reference for qiskit.transpiler.passes.synthesis.hls_plugins.DefaultSynthesisClifford in qiskit v2.4
