---
title: BindingsArray (v2.4)
description: API reference for qiskit.primitives.BindingsArray in qiskit v2.4
...
<Class id="qiskit.primitives.BindingsArray" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/2.4/qiskit/primitives/containers/bindings_array.py#L55-L320" signature="qiskit.primitives.BindingsArray(data=None, shape=None)" modifiers="class">
  Bases: `ShapedMixin`
  ...
  *   [**TypeError**](https://docs.python.org/3/library/exceptions.html#TypeError) – If some of the values can’t be cast to a float type.
  ...
  <Function id="qiskit.primitives.BindingsArray.as_array" github="https://github.com/Qiskit/qiskit/tree/stable/2.4/qiskit/primitives/containers/bindings_array.py#L172-L216" signature="as_array(parameters=None)">
  ...
  <Function id="qiskit.primitives.BindingsArray.bind" github="https://github.com/Qiskit/qiskit/tree/stable/2.4/qiskit/primitives/containers/bindings_array.py#L218-L239" signature="bind(circuit, loc)">
    Return a new circuit bound to the values at the provided index.

    **Parameters**

    *   **circuit** ([*QuantumCircuit*](/docs/api/qiskit/2.4/qiskit.circuit.QuantumCircuit "qiskit.circuit.quantumcircuit.QuantumCircuit")) – The circuit to bind.
  ...
  <Function id="qiskit.primitives.BindingsArray.bind_all" github="https://github.com/Qiskit/qiskit/tree/stable/2.4/qiskit/primitives/containers/bindings_array.py#L241-L253" signature="bind_all(circuit)">
  ...
  <Function id="qiskit.primitives.BindingsArray.coerce" github="https://github.com/Qiskit/qiskit/tree/stable/2.4/qiskit/primitives/containers/bindings_array.py#L293-L311" signature="coerce(bindings_array)" modifiers="classmethod">
  ...
  <Function id="qiskit.primitives.BindingsArray.ravel" github="https://github.com/Qiskit/qiskit/tree/stable/2.4/qiskit/primitives/containers/bindings_array.py#L255-L264" signature="ravel()">
  ...
  <Function id="qiskit.primitives.BindingsArray.reshape" github="https://github.com/Qiskit/qiskit/tree/stable/2.4/qiskit/primitives/containers/bindings_array.py#L266-L291" signature="reshape(*shape)">
  ...
  <Function id="qiskit.primitives.BindingsArray.validate" github="https://github.com/Qiskit/qiskit/tree/stable/2.4/qiskit/primitives/containers/bindings_array.py#L313-L320" signature="validate()">
