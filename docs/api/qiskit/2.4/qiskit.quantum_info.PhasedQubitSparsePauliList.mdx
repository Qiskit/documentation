---
title: PhasedQubitSparsePauliList (v2.4)
description: API reference for qiskit.quantum_info.PhasedQubitSparsePauliList in qiskit v2.4
...
<Class id="qiskit.quantum_info.PhasedQubitSparsePauliList" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/2.4/qiskit/quantum_info/__init__.py" signature="qiskit.quantum_info.PhasedQubitSparsePauliList(data, /, num_qubits=None)" modifiers="class">
