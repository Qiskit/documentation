---
title: result (v2.4)
description: API reference for qiskit.result in qiskit v2.4
...
|                                                                                                                           |                                                            |
| ------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------- |
| [`Result`](/docs/api/qiskit/2.4/qiskit.result.Result "qiskit.result.Result")(\*\[, backend\_name, backend\_version, ...]) | Model for Results.                                         |
| [`ResultError`](/docs/api/qiskit/2.4/qiskit.result.ResultError "qiskit.result.ResultError")(error)                        | Exceptions raised due to errors in result output.          |
| [`Counts`](/docs/api/qiskit/2.4/qiskit.result.Counts "qiskit.result.Counts")(data\[, time\_taken, creg\_sizes, ...])      | A class to store a counts result from a circuit execution. |
...
<Function id="qiskit.result.marginal_counts" github="https://github.com/Qiskit/qiskit/tree/stable/2.4/qiskit/result/utils.py#L33-L99" signature="qiskit.result.marginal_counts(result, indices=None, inplace=False, format_marginal=False, marginalize_memory=True)">
  ...
  *   **result** ([*dict*](https://docs.python.org/3/library/stdtypes.html#dict)  *|*[*Result*](/docs/api/qiskit/2.4/qiskit.result.Result "qiskit.result.result.Result")) – result to be marginalized (a Result object or a dict(str, int) of counts).
  ...
  **Return type**
  ...
  [Result](/docs/api/qiskit/2.4/qiskit.result.Result "qiskit.result.Result") or [dict](https://docs.python.org/3/library/stdtypes.html#dict)([str](https://docs.python.org/3/library/stdtypes.html#str), [int](https://docs.python.org/3/library/functions.html#int))
...
|                                                                                                                                    |                                                          |
| ---------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------- |
| [`ProbDistribution`](/docs/api/qiskit/2.4/qiskit.result.ProbDistribution "qiskit.result.ProbDistribution")(data\[, shots])         | A generic dict-like class for probability distributions. |
| [`QuasiDistribution`](/docs/api/qiskit/2.4/qiskit.result.QuasiDistribution "qiskit.result.QuasiDistribution")(data\[, shots, ...]) | A dict-like class for representing quasi-probabilities.  |
...
<Function id="qiskit.result.sampled_expectation_value" github="https://github.com/Qiskit/qiskit/tree/stable/2.4/qiskit/result/sampled_expval.py#L37-L90" signature="qiskit.result.sampled_expectation_value(dist, oper)">
  ...
  *   **dist** ([*dict*](https://docs.python.org/3/library/stdtypes.html#dict)  *|*[*result.Counts*](/docs/api/qiskit/2.4/qiskit.result.Counts "qiskit.result.Counts")  *|*[*QuasiDistribution*](/docs/api/qiskit/2.4/qiskit.result.QuasiDistribution "qiskit.result.QuasiDistribution")  *|*[*ProbDistribution*](/docs/api/qiskit/2.4/qiskit.result.ProbDistribution "qiskit.result.ProbDistribution")) – Input sampled distribution.
  *   **oper** ([*str*](https://docs.python.org/3/library/stdtypes.html#str)  *|*[*quantum\_info.Pauli*](/docs/api/qiskit/2.4/qiskit.quantum_info.Pauli "qiskit.quantum_info.Pauli")  *|*[*quantum\_info.SparsePauliOp*](/docs/api/qiskit/2.4/qiskit.quantum_info.SparsePauliOp "qiskit.quantum_info.SparsePauliOp")  *|*[*quantum\_info.SparseObservable*](/docs/api/qiskit/2.4/qiskit.quantum_info.SparseObservable "qiskit.quantum_info.SparseObservable")) – The operator for the observable.
