---
title: evolved_operator_ansatz (v2.4)
description: API reference for qiskit.circuit.library.evolved_operator_ansatz in qiskit v2.4
...
$$
  ...
  ![Circuit diagram output by the previous code.](/docs/images/api/qiskit/2.4/qiskit-circuit-library-evolved_operator_ansatz-1.avif)
