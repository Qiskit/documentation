---
title: UnitarySynthesisPluginManager (v2.4)
description: API reference for qiskit.transpiler.passes.synthesis.plugin.UnitarySynthesisPluginManager in qiskit v2.4
