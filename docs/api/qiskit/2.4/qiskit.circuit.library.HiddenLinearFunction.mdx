---
title: HiddenLinearFunction (v2.4)
description: API reference for qiskit.circuit.library.HiddenLinearFunction in qiskit v2.4
...
$$
  ...
  ![Diagram illustrating the previously described circuit.](/docs/images/api/qiskit/2.4/qiskit-circuit-library-HiddenLinearFunction-1.avif)
