---
title: SabreLayout (v2.4)
description: API reference for qiskit.transpiler.passes.SabreLayout in qiskit v2.4
...
<Class id="qiskit.transpiler.passes.SabreLayout" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/2.4/qiskit/transpiler/passes/layout/sabre_layout.py#L38-L363" signature="qiskit.transpiler.passes.SabreLayout(*args, **kwargs)" modifiers="class">
  ...
  **raises both `routing_pass` and `layout_trials` are specified**
  ...
  <Function id="qiskit.transpiler.passes.SabreLayout.execute" github="https://github.com/Qiskit/qiskit/tree/stable/2.4/qiskit/transpiler/basepasses.py#L161-L180" signature="execute(passmanager_ir, state, callback=None)">
  ...
  <Function id="qiskit.transpiler.passes.SabreLayout.name" github="https://github.com/Qiskit/qiskit/tree/stable/2.4/qiskit/passmanager/base_tasks.py#L67-L69" signature="name()">
    Name of the pass.
  ...
  <Function id="qiskit.transpiler.passes.SabreLayout.run" github="https://github.com/Qiskit/qiskit/tree/stable/2.4/qiskit/transpiler/passes/layout/sabre_layout.py#L191-L334" signature="run(dag)">
    ...
    **Raises**
    ...
    [**TranspilerError**](/docs/api/qiskit/2.4/transpiler#qiskit.transpiler.TranspilerError "qiskit.transpiler.TranspilerError") – if dag wider than the target.
  </Function>

  ### update\_status

  <Function id="qiskit.transpiler.passes.SabreLayout.update_status" github="https://github.com/Qiskit/qiskit/tree/stable/2.4/qiskit/transpiler/basepasses.py#L182-L190" signature="update_status(state, run_state)">
