...
`qiskit.circuit.library.GraphState(adjacency_matrix)`
...
**adjacency\_matrix** ([*list*](https://docs.python.org/3/library/stdtypes.html#list "(in Python v3.11)") *| np.ndarray*) – input graph as n-by-n list of 0-1 lists
