...
<Class id="qiskit.providers.JobStatus" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/2.0/qiskit/providers/jobstatus.py#L18-L27" signature="qiskit.providers.JobStatus(value)" modifiers="class">
