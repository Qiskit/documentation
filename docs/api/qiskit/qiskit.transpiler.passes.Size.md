...
`qiskit.transpiler.passes.Size(*args, **kwargs)` [GitHub](https://github.com/qiskit/qiskit/tree/stable/1.0/qiskit/transpiler/passes/analysis/size.py "view source code")
...
<span id="qiskit.transpiler.passes.Size.execute" />
...
<span id="qiskit.transpiler.passes.Size.update_status" />
