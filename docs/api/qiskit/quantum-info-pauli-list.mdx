...
<Class id="qiskit.quantum_info.PauliList" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.3/qiskit/quantum_info/operators/symplectic/pauli_list.py#L33-L1230" signature="qiskit.quantum_info.PauliList(data)" modifiers="class">
  Bases: `BasePauli`, `LinearMixin`, `GroupMixin`

  List of N-qubit Pauli operators.

  This class is an efficient representation of a list of [`Pauli`](quantum-info-pauli "qiskit.quantum_info.Pauli") operators. It supports 1D numpy array indexing returning a [`Pauli`](quantum-info-pauli "qiskit.quantum_info.Pauli") for integer indexes or a [`PauliList`](#qiskit.quantum_info.PauliList "qiskit.quantum_info.PauliList") for slice or list indices.
  ...
  **Initialization**
  ...
  > **`PauliList(list[str])`**
  >
  > where strings are same representation with [`Pauli`](quantum-info-pauli "qiskit.quantum_info.Pauli").
  >
  > **`PauliList(Pauli) and PauliList(list[Pauli])`**
  >
  > where Pauli is [`Pauli`](quantum-info-pauli "qiskit.quantum_info.Pauli").
  >
  ...
  **data** ([*Pauli*](quantum-info-pauli "qiskit.quantum_info.Pauli")  *or*[*list*](https://docs.python.org/3/library/stdtypes.html#list "(in Python v3.13)")) – input data for Paulis. If input is a list each item in the list must be a Pauli object or Pauli str.
  ...
  **Additional Information:**
  ...
  <Function id="qiskit.quantum_info.PauliList.adjoint" github="https://github.com/Qiskit/qiskit/tree/stable/1.3/qiskit/quantum_info/operators/symplectic/pauli_list.py#L818-L820" signature="adjoint()">
    Return the adjoint of each Pauli in the list.
  </Function>

  ### anticommutes

  <Function id="qiskit.quantum_info.PauliList.anticommutes" github="https://github.com/Qiskit/qiskit/tree/stable/1.3/qiskit/quantum_info/operators/symplectic/pauli_list.py#L846-L856" signature="anticommutes(other, qargs=None)">
  ...
  <Function id="qiskit.quantum_info.PauliList.anticommutes_with_all" github="https://github.com/Qiskit/qiskit/tree/stable/1.3/qiskit/quantum_info/operators/symplectic/pauli_list.py#L873-L886" signature="anticommutes_with_all(other)">
  ...
  <Function id="qiskit.quantum_info.PauliList.argsort" github="https://github.com/Qiskit/qiskit/tree/stable/1.3/qiskit/quantum_info/operators/symplectic/pauli_list.py#L470-L531" signature="argsort(weight=False, phase=False)">
  ...
  <Function id="qiskit.quantum_info.PauliList.commutes" github="https://github.com/Qiskit/qiskit/tree/stable/1.3/qiskit/quantum_info/operators/symplectic/pauli_list.py#L830-L844" signature="commutes(other, qargs=None)">
  ...
  <Function id="qiskit.quantum_info.PauliList.commutes_with_all" github="https://github.com/Qiskit/qiskit/tree/stable/1.3/qiskit/quantum_info/operators/symplectic/pauli_list.py#L858-L871" signature="commutes_with_all(other)">
    Return indexes of rows that commute `other`.
  ...
  <Function id="qiskit.quantum_info.PauliList.compose" github="https://github.com/Qiskit/qiskit/tree/stable/1.3/qiskit/quantum_info/operators/symplectic/pauli_list.py#L702-L735" signature="compose(other, qargs=None, front=False, inplace=False)">
  ...
  <Function id="qiskit.quantum_info.PauliList.conjugate" github="https://github.com/Qiskit/qiskit/tree/stable/1.3/qiskit/quantum_info/operators/symplectic/pauli_list.py#L810-L812" signature="conjugate()">
    Return the conjugate of each Pauli in the list.
  </Function>

  ### copy

  <Function id="qiskit.quantum_info.PauliList.copy" github="https://github.com/Qiskit/qiskit/tree/stable/1.3/qiskit/quantum_info/operators/symplectic/base_pauli.py#L63-L72" signature="copy()">
    Make a deep copy of current operator.
  </Function>

  ### delete

  <Function id="qiskit.quantum_info.PauliList.delete" github="https://github.com/Qiskit/qiskit/tree/stable/1.3/qiskit/quantum_info/operators/symplectic/pauli_list.py#L359-L404" signature="delete(ind, qubit=False)">
  ...
  <Function id="qiskit.quantum_info.PauliList.dot" github="https://github.com/Qiskit/qiskit/tree/stable/1.3/qiskit/quantum_info/operators/symplectic/pauli_list.py#L737-L754" signature="dot(other, qargs=None, inplace=False)">
  ...
  <Function id="qiskit.quantum_info.PauliList.equiv" github="https://github.com/Qiskit/qiskit/tree/stable/1.3/qiskit/quantum_info/operators/symplectic/pauli_list.py#L235-L247" signature="equiv(other)">
    Entrywise comparison of Pauli equivalence up to global phase.

    **Parameters**

    **other** ([*PauliList*](#qiskit.quantum_info.PauliList "qiskit.quantum_info.PauliList")  *or*[*Pauli*](quantum-info-pauli "qiskit.quantum_info.Pauli")) – a comparison object.
  ...
  <Function id="qiskit.quantum_info.PauliList.evolve" github="https://github.com/Qiskit/qiskit/tree/stable/1.3/qiskit/quantum_info/operators/symplectic/pauli_list.py#L912-L949" signature="evolve(other, qargs=None, frame='h')">
    ...
    *   **other** ([*Pauli*](quantum-info-pauli "qiskit.quantum_info.Pauli")  *or*[*Clifford*](quantum-info-clifford "qiskit.quantum_info.Clifford")  *or*[*QuantumCircuit*](circuit-quantum-circuit "qiskit.circuit.QuantumCircuit")) – The Clifford operator to evolve by.
  ...
  <Function id="qiskit.quantum_info.PauliList.expand" github="https://github.com/Qiskit/qiskit/tree/stable/1.3/qiskit/quantum_info/operators/symplectic/pauli_list.py#L679-L700" signature="expand(other)">
  ...
  <Function id="qiskit.quantum_info.PauliList.from_symplectic" github="https://github.com/Qiskit/qiskit/tree/stable/1.3/qiskit/quantum_info/operators/symplectic/pauli_list.py#L1108-L1125" signature="from_symplectic(z, x, phase=0)" modifiers="classmethod">
  ...
  <Function id="qiskit.quantum_info.PauliList.group_commuting" github="https://github.com/Qiskit/qiskit/tree/stable/1.3/qiskit/quantum_info/operators/symplectic/pauli_list.py#L1210-L1230" signature="group_commuting(qubit_wise=False)">
  ...
  <Function id="qiskit.quantum_info.PauliList.group_qubit_wise_commuting" github="https://github.com/Qiskit/qiskit/tree/stable/1.3/qiskit/quantum_info/operators/symplectic/pauli_list.py#L1202-L1208" signature="group_qubit_wise_commuting()">
  ...
  <Function id="qiskit.quantum_info.PauliList.input_dims" github="https://github.com/Qiskit/qiskit/tree/stable/1.3/qiskit/quantum_info/operators/base_operator.py#L135-L137" signature="input_dims(qargs=None)">
    Return tuple of input dimension for specified subsystems.
  </Function>

  ### insert

  <Function id="qiskit.quantum_info.PauliList.insert" github="https://github.com/Qiskit/qiskit/tree/stable/1.3/qiskit/quantum_info/operators/symplectic/pauli_list.py#L406-L468" signature="insert(ind, value, qubit=False)">
  ...
  <Function id="qiskit.quantum_info.PauliList.inverse" github="https://github.com/Qiskit/qiskit/tree/stable/1.3/qiskit/quantum_info/operators/symplectic/pauli_list.py#L822-L824" signature="inverse()">
    Return the inverse of each Pauli in the list.
  </Function>

  ### label\_iter

  <Function id="qiskit.quantum_info.PauliList.label_iter" github="https://github.com/Qiskit/qiskit/tree/stable/1.3/qiskit/quantum_info/operators/symplectic/pauli_list.py#L1053-L1073" signature="label_iter()">
  ...
  <Function id="qiskit.quantum_info.PauliList.matrix_iter" github="https://github.com/Qiskit/qiskit/tree/stable/1.3/qiskit/quantum_info/operators/symplectic/pauli_list.py#L1075-L1102" signature="matrix_iter(sparse=False)">
  ...
  <Function id="qiskit.quantum_info.PauliList.noncommutation_graph" github="https://github.com/Qiskit/qiskit/tree/stable/1.3/qiskit/quantum_info/operators/symplectic/pauli_list.py#L1158-L1178" signature="noncommutation_graph(qubit_wise)">
    ...
    **Return type**
    ...
    [rustworkx.PyGraph](https://www.rustworkx.org/apiref/rustworkx.PyGraph.html#rustworkx.PyGraph "(in rustworkx v0.15)")
  </Function>

  ### output\_dims

  <Function id="qiskit.quantum_info.PauliList.output_dims" github="https://github.com/Qiskit/qiskit/tree/stable/1.3/qiskit/quantum_info/operators/base_operator.py#L139-L141" signature="output_dims(qargs=None)">
    Return tuple of output dimension for specified subsystems.
  </Function>

  ### power

  <Function id="qiskit.quantum_info.PauliList.power" github="https://github.com/Qiskit/qiskit/tree/stable/1.3/qiskit/quantum_info/operators/mixins/group.py#L151-L171" signature="power(n)">
  ...
  <Function id="qiskit.quantum_info.PauliList.reshape" github="https://github.com/Qiskit/qiskit/tree/stable/1.3/qiskit/quantum_info/operators/base_operator.py#L106-L133" signature="reshape(input_dims=None, output_dims=None, num_qubits=None)">
  ...
  <Function id="qiskit.quantum_info.PauliList.sort" github="https://github.com/Qiskit/qiskit/tree/stable/1.3/qiskit/quantum_info/operators/symplectic/pauli_list.py#L533-L589" signature="sort(weight=False, phase=False)">
  ...
  <Function id="qiskit.quantum_info.PauliList.tensor" github="https://github.com/Qiskit/qiskit/tree/stable/1.3/qiskit/quantum_info/operators/symplectic/pauli_list.py#L661-L677" signature="tensor(other)">
  ...
  <Function id="qiskit.quantum_info.PauliList.to_labels" github="https://github.com/Qiskit/qiskit/tree/stable/1.3/qiskit/quantum_info/operators/symplectic/pauli_list.py#L951-L997" signature="to_labels(array=False)">
  ...
  <Function id="qiskit.quantum_info.PauliList.to_matrix" github="https://github.com/Qiskit/qiskit/tree/stable/1.3/qiskit/quantum_info/operators/symplectic/pauli_list.py#L999-L1047" signature="to_matrix(sparse=False, array=False)">
  ...
  <Function id="qiskit.quantum_info.PauliList.transpose" github="https://github.com/Qiskit/qiskit/tree/stable/1.3/qiskit/quantum_info/operators/symplectic/pauli_list.py#L814-L816" signature="transpose()">
    Return the transpose of each Pauli in the list.
  </Function>

  ### unique

  <Function id="qiskit.quantum_info.PauliList.unique" github="https://github.com/Qiskit/qiskit/tree/stable/1.3/qiskit/quantum_info/operators/symplectic/pauli_list.py#L591-L655" signature="unique(return_index=False, return_counts=False)">
