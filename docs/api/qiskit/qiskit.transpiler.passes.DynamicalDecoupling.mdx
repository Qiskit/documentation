...
<Class id="qiskit.transpiler.passes.DynamicalDecoupling" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.3/qiskit/transpiler/passes/scheduling/dynamical_decoupling.py#L31-L313" signature="qiskit.transpiler.passes.DynamicalDecoupling(*args, **kwargs)" modifiers="class">
  ...
  ![Output from the previous code.](/images/api/qiskit/qiskit-transpiler-passes-DynamicalDecoupling-1_00.png)

  ![Output from the previous code.](/images/api/qiskit/qiskit-transpiler-passes-DynamicalDecoupling-1_01.png)
