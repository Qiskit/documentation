...
<Class id="qiskit.transpiler.passes.DynamicalDecoupling" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.3/qiskit/transpiler/passes/scheduling/dynamical_decoupling.py#L31-L312" signature="qiskit.transpiler.passes.DynamicalDecoupling(*args, **kwargs)" modifiers="class">
  ...
  *   **target** ([*Target*](qiskit.transpiler.Target "qiskit.transpiler.Target")) – The [`Target`](qiskit.transpiler.Target "qiskit.transpiler.Target") representing the target backend, if both `durations` and this are specified then this argument will take precedence and `durations` will be ignored.
  ...
  <Function id="qiskit.transpiler.passes.DynamicalDecoupling.run" github="https://github.com/Qiskit/qiskit/tree/stable/1.3/qiskit/transpiler/passes/scheduling/dynamical_decoupling.py#L154-L282" signature="run(dag)">
