...
<Class id="qiskit.quantum_info.QubitSparsePauliList" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/quantum_info/__init__.py" signature="qiskit.quantum_info.QubitSparsePauliList(data, /, num_qubits=None)" modifiers="class">
  ...
  <Attribute id="qiskit.quantum_info.QubitSparsePauliList.num_qubits" name="num_qubits" headingLevel={3}>
  ...
  <Attribute id="qiskit.quantum_info.QubitSparsePauliList.num_terms" name="num_terms" headingLevel={3}>
