...
$$
  ...
  **Examples**
  ...
  ![Circuit diagram output by the previous code.](/images/api/qiskit/qiskit-circuit-library-grover_operator-1.avif)
  ...
  ![Circuit diagram output by the previous code.](/images/api/qiskit/qiskit-circuit-library-grover_operator-2.avif)
  ...
  ![Circuit diagram output by the previous code.](/images/api/qiskit/qiskit-circuit-library-grover_operator-3.avif)

  The oracle and the zero reflection can also be passed as [`qiskit.quantum_info`](quantum-info#module-qiskit.quantum_info "qiskit.quantum_info") objects:
  ...
  ![Circuit diagram output by the previous code.](/images/api/qiskit/qiskit-circuit-library-grover_operator-4.avif)
  ...
  *   **oracle** ([*QuantumCircuit*](circuit-quantum-circuit "qiskit.circuit.QuantumCircuit")  *|*[*Statevector*](quantum-info-statevector "qiskit.quantum_info.Statevector")) – The phase oracle implementing a reflection about the bad state. Note that this is not a bitflip oracle, see the docstring for more information.
  *   **state\_preparation** ([*QuantumCircuit*](circuit-quantum-circuit "qiskit.circuit.QuantumCircuit") *| None*) – The operator preparing the good and bad state. For Grover’s algorithm, this is a n-qubit Hadamard gate and for amplitude amplification or estimation the operator $\mathcal{A}$.
  *   **zero\_reflection** ([*QuantumCircuit*](circuit-quantum-circuit "qiskit.circuit.QuantumCircuit")  *|*[*DensityMatrix*](quantum-info-density-matrix "qiskit.quantum_info.DensityMatrix")  *|*[*Operator*](quantum-info-operator "qiskit.quantum_info.Operator") *| None*) – The reflection about the zero state, $\mathcal{S}_0$.
