...
<Class id="qiskit.transpiler.passes.ConsolidateBlocks" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/2.2/qiskit/transpiler/passes/optimization/consolidate_blocks.py#L58-L187" signature="qiskit.transpiler.passes.ConsolidateBlocks(*args, **kwargs)" modifiers="class">
  ...
  *   **target** ([*Target*](qiskit.transpiler.Target "qiskit.transpiler.Target")) – The target object for the compilation target backend.
  ...
  <Function id="qiskit.transpiler.passes.ConsolidateBlocks.run" github="https://github.com/Qiskit/qiskit/tree/stable/2.2/qiskit/transpiler/passes/optimization/consolidate_blocks.py#L126-L164" signature="run(dag)">
