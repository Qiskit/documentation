...
<Class id="qiskit.transpiler.passes.ConsolidateBlocks" github="https://github.com/qiskit/qiskit/tree/stable/1.0/qiskit/transpiler/passes/optimization/consolidate_blocks.py" signature="qiskit.transpiler.passes.ConsolidateBlocks(*args, **kwargs)">
