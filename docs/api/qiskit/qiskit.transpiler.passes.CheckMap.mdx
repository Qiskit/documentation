...
<Class id="qiskit.transpiler.passes.CheckMap" github="https://github.com/Qiskit/qiskit/tree/stable/1.0/qiskit/transpiler/passes/utils/check_map.py#L21-L94" signature="qiskit.transpiler.passes.CheckMap(*args, **kwargs)">
