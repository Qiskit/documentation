...
<Class id="qiskit.quantum_info.PTM" github="https://github.com/Qiskit/qiskit/tree/stable/1.0/qiskit/quantum_info/operators/channel/ptm.py#L32-L199" signature="qiskit.quantum_info.PTM(data, input_dims=None, output_dims=None)">
