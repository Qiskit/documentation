---
title: Decompose (v0.39)
description: API reference for qiskit.transpiler.passes.Decompose in qiskit v0.39
...
<Class id="qiskit.transpiler.passes.Decompose" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.22/qiskit/transpiler/passes/basis/decompose.py" signature="Decompose(gate=None, gates_to_decompose=None)" modifiers="class">
