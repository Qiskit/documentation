...
`eval_observables(quantum_instance, quantum_state, observables, expectation, threshold=1e-12)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.22/qiskit/algorithms/aux_ops_evaluator.py "view source code")
