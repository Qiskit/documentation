...
<Class id="qiskit.algorithms.linear_solvers.LinearSystemObservable" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.22/qiskit/algorithms/linear_solvers/observables/linear_system_observable.py" signature="LinearSystemObservable">
  Bases: `abc.ABC`
