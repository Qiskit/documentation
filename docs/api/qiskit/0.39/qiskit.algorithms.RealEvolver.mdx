---
title: RealEvolver (v0.39)
description: API reference for qiskit.algorithms.RealEvolver in qiskit v0.39
...
<Class id="qiskit.algorithms.RealEvolver" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.22/qiskit/algorithms/evolvers/real_evolver.py" signature="RealEvolver" modifiers="class">
  Bases: `abc.ABC`
