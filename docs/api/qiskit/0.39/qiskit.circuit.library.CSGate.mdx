---
title: CSGate (v0.39)
description: API reference for qiskit.circuit.library.CSGate in qiskit v0.39
...
<Class id="qiskit.circuit.library.CSGate" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.22/qiskit/circuit/library/standard_gates/s.py" signature="CSGate(label=None, ctrl_state=None)" modifiers="class">
