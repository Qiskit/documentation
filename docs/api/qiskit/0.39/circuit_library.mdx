---
title: library (v0.39)
description: API reference for qiskit.circuit.library in qiskit v0.39
...
![../\_images/circuit\_library\_0\_0.png](/docs/images/api/qiskit/0.39/circuit_library_0_0.avif)
