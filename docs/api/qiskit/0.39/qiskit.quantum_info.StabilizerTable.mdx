---
title: StabilizerTable (v0.39)
description: API reference for qiskit.quantum_info.StabilizerTable in qiskit v0.39
...
<Class id="qiskit.quantum_info.StabilizerTable" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.22/qiskit/quantum_info/operators/symplectic/stabilizer_table.py" signature="StabilizerTable(data, phase=None)" modifiers="class">
