---
title: ResetAfterMeasureSimplification (v0.39)
description: API reference for qiskit.transpiler.passes.ResetAfterMeasureSimplification in qiskit v0.39
...
<Class id="qiskit.transpiler.passes.ResetAfterMeasureSimplification" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.22/qiskit/transpiler/passes/optimization/reset_after_measure_simplification.py" signature="ResetAfterMeasureSimplification(*args, **kwargs)" modifiers="class">
