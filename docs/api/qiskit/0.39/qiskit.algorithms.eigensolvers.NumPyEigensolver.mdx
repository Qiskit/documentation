...
<Class id="qiskit.algorithms.eigensolvers.NumPyEigensolver" github="https://github.com/qiskit/qiskit/tree/stable/0.22/qiskit/algorithms/eigensolvers/numpy_eigensolver.py" signature="NumPyEigensolver(k=1, filter_criterion=None)">
