...
description: API reference for qiskit.algorithms.eigensolvers.NumPyEigensolver in qiskit v0.39
...
<Class id="qiskit.algorithms.eigensolvers.NumPyEigensolver" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.22/qiskit/algorithms/eigensolvers/numpy_eigensolver.py" signature="NumPyEigensolver(k=1, filter_criterion=None)" modifiers="class">
