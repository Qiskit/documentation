...
<Class id="qiskit.transpiler.passes.AlignMeasures" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.22/qiskit/transpiler/passes/scheduling/alignments/align_measures.py" signature="AlignMeasures(alignment=1)">
