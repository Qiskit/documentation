...
<Class id="qiskit.algorithms.gradients.LinCombEstimatorGradient" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.22/qiskit/algorithms/gradients/lin_comb_estimator_gradient.py" signature="LinCombEstimatorGradient(estimator, **options)">
