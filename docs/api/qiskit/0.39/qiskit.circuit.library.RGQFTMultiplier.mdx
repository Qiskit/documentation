---
title: RGQFTMultiplier (v0.39)
description: API reference for qiskit.circuit.library.RGQFTMultiplier in qiskit v0.39
...
<Class id="qiskit.circuit.library.RGQFTMultiplier" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.22/qiskit/circuit/library/arithmetic/multipliers/rg_qft_multiplier.py" signature="RGQFTMultiplier(num_state_qubits, num_result_qubits=None, name='RGQFTMultiplier')" modifiers="class">
  ...
  *   **name** (`str`) – The name of the circuit object.
  ...
  <Attribute id="qiskit.circuit.library.RGQFTMultiplier.instances" attributeValue="94" />
