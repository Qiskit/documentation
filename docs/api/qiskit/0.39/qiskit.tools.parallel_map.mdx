---
title: parallel_map (v0.39)
description: API reference for qiskit.tools.parallel_map in qiskit v0.39
...
<Function id="qiskit.tools.parallel_map" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.22/qiskit/tools/parallel.py" signature="parallel_map(task, values, task_args=(), task_kwargs={}, num_processes=2)">
