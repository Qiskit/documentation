---
title: control_channels (v0.39)
description: API reference for qiskit.pulse.builder.control_channels in qiskit v0.39
...
<Function id="qiskit.pulse.builder.control_channels" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.22/qiskit/pulse/builder.py" signature="control_channels(*qubits)">
