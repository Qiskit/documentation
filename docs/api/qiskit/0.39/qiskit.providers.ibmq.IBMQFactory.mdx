---
title: IBMQFactory (v0.39)
description: API reference for qiskit.providers.ibmq.IBMQFactory in qiskit v0.39
...
<Class id="qiskit.providers.ibmq.IBMQFactory" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-ibmq-provider/tree/stable/0.19/qiskit/providers/ibmq/ibmqfactory.py" signature="IBMQFactory" modifiers="class">
  ...
  <span id="qiskit-providers-ibmq-ibmqfactory-active-account" />
  ...
  <span id="qiskit-providers-ibmq-ibmqfactory-delete-account" />
  ...
  <span id="qiskit-providers-ibmq-ibmqfactory-disable-account" />
  ...
  <span id="qiskit-providers-ibmq-ibmqfactory-enable-account" />
  ...
  <span id="qiskit-providers-ibmq-ibmqfactory-get-provider" />
  ...
  <span id="qiskit-providers-ibmq-ibmqfactory-load-account" />
  ...
  <span id="qiskit-providers-ibmq-ibmqfactory-save-account" />
  ...
  <span id="qiskit-providers-ibmq-ibmqfactory-stored-account" />
  ...
  <span id="qiskit-providers-ibmq-ibmqfactory-update-account" />
