...
<Function id="qiskit.visualization.plot_state_city" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.22/qiskit/visualization/state_visualization.py" signature="plot_state_city(state, title='', figsize=None, color=None, alpha=1, ax_real=None, ax_imag=None, *, rho=None, filename=None)">
  ...
  **Examples**
  ...
  ![../\_images/qiskit.visualization.plot\_state\_city\_0\_0.png](/images/api/qiskit/0.39/qiskit.visualization.plot_state_city_0_0.avif)
  ...
  ![../\_images/qiskit.visualization.plot\_state\_city\_1\_0.png](/images/api/qiskit/0.39/qiskit.visualization.plot_state_city_1_0.avif)
</Function>
