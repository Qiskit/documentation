---
title: FakeGeneva (v0.39)
description: API reference for qiskit.providers.fake_provider.FakeGeneva in qiskit v0.39
...
<Class id="qiskit.providers.fake_provider.FakeGeneva" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.22/qiskit/providers/fake_provider/backends/geneva/fake_geneva.py" signature="FakeGeneva" modifiers="class">
