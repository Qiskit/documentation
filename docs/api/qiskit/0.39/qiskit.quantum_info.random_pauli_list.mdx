...
<Function id="qiskit.quantum_info.random_pauli_list" github="https://github.com/qiskit/qiskit/tree/stable/0.22/qiskit/quantum_info/operators/symplectic/random.py" signature="random_pauli_list(num_qubits, size=1, seed=None, phase=True)">
