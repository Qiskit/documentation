...
<Class id="qiskit.providers.fake_provider.FakeMumbaiFractionalCX" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.22/qiskit/providers/fake_provider/fake_mumbai_v2.py" signature="FakeMumbaiFractionalCX">
