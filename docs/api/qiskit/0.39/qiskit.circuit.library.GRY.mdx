---
title: GRY (v0.39)
description: API reference for qiskit.circuit.library.GRY in qiskit v0.39
...
<Class id="qiskit.circuit.library.GRY" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.22/qiskit/circuit/library/generalized_gates/gr.py" signature="GRY(num_qubits, theta)" modifiers="class">
...
$$
  ...
  *   **theta** (`float`) – rotation angle about y-axis
  ...
  <Attribute id="qiskit.circuit.library.GRY.instances" attributeValue="94" />
