...
<Function id="qiskit.pulse.library.gaussian_deriv" name="gaussian_deriv" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.22/qiskit/pulse/library/discrete.py" signature="gaussian_deriv(duration, amp, sigma, name=None)">
