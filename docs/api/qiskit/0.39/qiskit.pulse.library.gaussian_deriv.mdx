---
title: gaussian_deriv (v0.39)
description: API reference for qiskit.pulse.library.gaussian_deriv in qiskit v0.39
...
<Function id="qiskit.pulse.library.gaussian_deriv" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.22/qiskit/pulse/library/discrete.py" signature="gaussian_deriv(duration, amp, sigma, name=None)">
