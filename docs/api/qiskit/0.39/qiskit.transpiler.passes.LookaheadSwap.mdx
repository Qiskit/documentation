---
title: LookaheadSwap (v0.39)
description: API reference for qiskit.transpiler.passes.LookaheadSwap in qiskit v0.39
...
<Class id="qiskit.transpiler.passes.LookaheadSwap" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.22/qiskit/transpiler/passes/routing/lookahead_swap.py" signature="LookaheadSwap(*args, **kwargs)" modifiers="class">
