---
title: Provider (v0.39)
description: API reference for qiskit.providers.Provider in qiskit v0.39
...
<Class id="qiskit.providers.Provider" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.22/qiskit/providers/provider.py" signature="Provider" modifiers="class">
  Bases: `object`
