...
<Class id="qiskit.transpiler.passes.ApplyLayout" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.22/qiskit/transpiler/passes/layout/apply_layout.py" signature="ApplyLayout(*args, **kwargs)">
  ...
  <Function id="qiskit.transpiler.passes.ApplyLayout.name" name="name" signature="ApplyLayout.name()">
    Return the name of the pass.
  </Function>

  ### run

  <Function id="qiskit.transpiler.passes.ApplyLayout.run" name="run" signature="ApplyLayout.run(dag)">
