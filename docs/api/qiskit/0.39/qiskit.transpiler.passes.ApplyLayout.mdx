---
title: ApplyLayout (v0.39)
description: API reference for qiskit.transpiler.passes.ApplyLayout in qiskit v0.39
...
<Class id="qiskit.transpiler.passes.ApplyLayout" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.22/qiskit/transpiler/passes/layout/apply_layout.py" signature="ApplyLayout(*args, **kwargs)" modifiers="class">
