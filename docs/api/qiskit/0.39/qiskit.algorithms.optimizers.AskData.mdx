...
<Class id="qiskit.algorithms.optimizers.AskData" github="https://github.com/qiskit/qiskit/tree/stable/0.22/qiskit/algorithms/optimizers/steppable_optimizer.py" signature="AskData(x_fun=None, x_jac=None)">
  Bases: `abc.ABC`
