...
<Class id="qiskit.algorithms.optimizers.AskData" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.22/qiskit/algorithms/optimizers/steppable_optimizer.py" signature="AskData(x_fun=None, x_jac=None)">
  Bases: `abc.ABC`
  ...
  *   **optimizer.** –
  ...
  <Attribute id="qiskit.algorithms.optimizers.AskData.x_fun" name="x_fun" attributeTypeHint="Optional[Union[float, numpy.ndarray, List[Union[float, numpy.ndarray]]]]" attributeValue="= None" />

  ### x\_jac

  <Attribute id="qiskit.algorithms.optimizers.AskData.x_jac" name="x_jac" attributeTypeHint="Optional[Union[float, numpy.ndarray, List[Union[float, numpy.ndarray]]]]" attributeValue="= None" />
</Class>
