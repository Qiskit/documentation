...
<Function id="qiskit.quantum_info.random_unitary" github="https://github.com/qiskit/qiskit/tree/stable/0.22/qiskit/quantum_info/operators/random.py" signature="random_unitary(dims, seed=None)">
