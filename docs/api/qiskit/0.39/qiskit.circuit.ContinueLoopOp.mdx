---
title: ContinueLoopOp (v0.39)
description: API reference for qiskit.circuit.ContinueLoopOp in qiskit v0.39
...
<Class id="qiskit.circuit.ContinueLoopOp" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.22/qiskit/circuit/controlflow/continue_loop.py" signature="ContinueLoopOp(num_qubits, num_clbits, label=None)" modifiers="class">
