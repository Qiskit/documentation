---
title: OptimizeCliffords (v0.39)
description: API reference for qiskit.transpiler.passes.OptimizeCliffords in qiskit v0.39
...
<Class id="qiskit.transpiler.passes.OptimizeCliffords" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.22/qiskit/transpiler/passes/optimization/optimize_cliffords.py" signature="OptimizeCliffords(*args, **kwargs)" modifiers="class">
