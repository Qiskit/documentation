...
`sawtooth(duration, amp, freq=None, phase=0, name=None)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.22/qiskit/pulse/library/discrete.py "view source code")
...
```python
[<matplotlib.lines.Line2D at 0x7fa9c1d4c7f0>]
```

![../\_images/qiskit.pulse.library.sawtooth\_0\_1.png](/images/api/qiskit/0.39/qiskit.pulse.library.sawtooth_0_1.png)
