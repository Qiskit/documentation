...
`FakeTokyo.properties()`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.22/qiskit/providers/fake_provider/backends/tokyo/fake_tokyo.py "view source code")
