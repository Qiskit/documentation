---
title: circuit_to_dagdependency (v0.39)
description: API reference for qiskit.converters.circuit_to_dagdependency in qiskit v0.39
...
<Function id="qiskit.converters.circuit_to_dagdependency" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.22/qiskit/converters/circuit_to_dagdependency.py" signature="circuit_to_dagdependency(circuit, create_preds_and_succs=True)">
