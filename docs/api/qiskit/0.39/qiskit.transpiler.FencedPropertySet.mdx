...
<Class id="qiskit.transpiler.FencedPropertySet" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.22/qiskit/transpiler/fencedobjs.py" signature="FencedPropertySet(property_set_instance)">
