---
title: FakeQuitoV2 (v0.39)
description: API reference for qiskit.providers.fake_provider.FakeQuitoV2 in qiskit v0.39
...
<Class id="qiskit.providers.fake_provider.FakeQuitoV2" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.22/qiskit/providers/fake_provider/backends/quito/fake_quito.py" signature="FakeQuitoV2" modifiers="class">
  ...
  <Attribute id="qiskit.providers.fake_provider.FakeQuitoV2.backend_name" attributeValue="'fake_quito_v2'" />

  ### conf\_filename

  <Attribute id="qiskit.providers.fake_provider.FakeQuitoV2.conf_filename" attributeValue="'conf_quito.json'" />

  ### coupling\_map

  <Attribute id="qiskit.providers.fake_provider.FakeQuitoV2.coupling_map">
    Return the [`CouplingMap`](qiskit.transpiler.CouplingMap "qiskit.transpiler.CouplingMap") object
  </Attribute>

  ### defs\_filename

  <Attribute id="qiskit.providers.fake_provider.FakeQuitoV2.defs_filename" attributeValue="'defs_quito.json'" />

  ### dirname

  <Attribute id="qiskit.providers.fake_provider.FakeQuitoV2.dirname" attributeValue="'/home/runner/work/qiskit/qiskit/.tox/docs/lib/python3.8/site-packages/qiskit/providers/fake_provider/backends/quito'" />

  ### dt

  <Attribute id="qiskit.providers.fake_provider.FakeQuitoV2.dt">
  ...
  <Attribute id="qiskit.providers.fake_provider.FakeQuitoV2.dtm">
  ...
  <Attribute id="qiskit.providers.fake_provider.FakeQuitoV2.instruction_durations">
  ...
  <Attribute id="qiskit.providers.fake_provider.FakeQuitoV2.instruction_schedule_map">
  ...
  <Attribute id="qiskit.providers.fake_provider.FakeQuitoV2.instructions">
  ...
  <Attribute id="qiskit.providers.fake_provider.FakeQuitoV2.max_circuits" />

  ### meas\_map

  <Attribute id="qiskit.providers.fake_provider.FakeQuitoV2.meas_map">
  ...
  <Attribute id="qiskit.providers.fake_provider.FakeQuitoV2.num_qubits">
  ...
  <Attribute id="qiskit.providers.fake_provider.FakeQuitoV2.operation_names">
  ...
  <Attribute id="qiskit.providers.fake_provider.FakeQuitoV2.operations">
  ...
  <Attribute id="qiskit.providers.fake_provider.FakeQuitoV2.options">
  ...
  <Attribute id="qiskit.providers.fake_provider.FakeQuitoV2.props_filename" attributeValue="'props_quito.json'" />

  ### provider

  <Attribute id="qiskit.providers.fake_provider.FakeQuitoV2.provider">
  ...
  <Attribute id="qiskit.providers.fake_provider.FakeQuitoV2.target">
  ...
  <Attribute id="qiskit.providers.fake_provider.FakeQuitoV2.version" attributeValue="2" />
</Class>
