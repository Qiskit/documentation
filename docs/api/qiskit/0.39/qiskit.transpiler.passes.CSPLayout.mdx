---
title: CSPLayout (v0.39)
description: API reference for qiskit.transpiler.passes.CSPLayout in qiskit v0.39
...
<Class id="qiskit.transpiler.passes.CSPLayout" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.22/qiskit/transpiler/passes/layout/csp_layout.py" signature="CSPLayout(*args, **kwargs)" modifiers="class">
