...
<Class id="qiskit.primitives.EstimatorResult" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.22/qiskit/primitives/base/estimator_result.py" signature="EstimatorResult(values, metadata)">
  ...
  *   **metadata** (*list\[dict]*) – List of the metadata.
  ...
  <Function id="qiskit.primitives.EstimatorResult.decompose" name="decompose" signature="EstimatorResult.decompose()">
