---
title: EstimatorResult (v0.39)
description: API reference for qiskit.primitives.EstimatorResult in qiskit v0.39
...
<Class id="qiskit.primitives.EstimatorResult" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.22/qiskit/primitives/base/estimator_result.py" signature="EstimatorResult(values, metadata)" modifiers="class">
