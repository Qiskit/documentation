---
title: random_hermitian (v0.39)
description: API reference for qiskit.quantum_info.random_hermitian in qiskit v0.39
...
<Function id="qiskit.quantum_info.random_hermitian" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.22/qiskit/quantum_info/operators/random.py" signature="random_hermitian(dims, traceless=False, seed=None)">
