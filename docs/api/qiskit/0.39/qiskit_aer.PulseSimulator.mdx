...
<Class id="qiskit_aer.PulseSimulator" github="https://github.com/qiskit/qiskit-aer/tree/stable/0.11/qiskit_aer/backends/pulse_simulator.py" signature="PulseSimulator(configuration=None, properties=None, defaults=None, provider=None, **backend_options)">
