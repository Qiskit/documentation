...
<Class id="qiskit.providers.ProviderV1" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.22/qiskit/providers/provider.py" signature="ProviderV1">
