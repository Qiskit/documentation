...
<Class id="qiskit.algorithms.Shor" github="https://github.com/qiskit/qiskit/tree/stable/0.22/qiskit/algorithms/factorizers/shor.py" signature="Shor(quantum_instance=None)">
  Bases: `object`
