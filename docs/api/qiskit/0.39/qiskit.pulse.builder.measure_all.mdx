---
title: measure_all (v0.39)
description: API reference for qiskit.pulse.builder.measure_all in qiskit v0.39
...
<Function id="qiskit.pulse.builder.measure_all" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.22/qiskit/pulse/builder.py" signature="measure_all()">
