---
title: Exporter (v0.39)
description: API reference for qiskit.qasm3.Exporter in qiskit v0.39
...
<Class id="qiskit.qasm3.Exporter" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.22/qiskit/qasm3/exporter.py" signature="Exporter(includes=('stdgates.inc',), basis_gates=('U',), disable_constants=False, alias_classical_registers=False, indent='  ')" modifiers="class">
  Bases: `object`
