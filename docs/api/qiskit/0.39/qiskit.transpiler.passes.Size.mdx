---
title: Size (v0.39)
description: API reference for qiskit.transpiler.passes.Size in qiskit v0.39
...
<Class id="qiskit.transpiler.passes.Size" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.22/qiskit/transpiler/passes/analysis/size.py" signature="Size(*args, **kwargs)" modifiers="class">
