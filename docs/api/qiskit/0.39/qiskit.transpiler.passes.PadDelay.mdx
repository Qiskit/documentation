...
<Class id="qiskit.transpiler.passes.PadDelay" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.22/qiskit/transpiler/passes/scheduling/padding/pad_delay.py" signature="PadDelay(fill_very_end=True)">
  ...
  **fill\_very\_end** (`bool`) – Set `True` to fill the end of circuit with delay.
  ...
  <Function id="qiskit.transpiler.passes.PadDelay.name" name="name" signature="PadDelay.name()">
    Return the name of the pass.
  </Function>

  ### run

  <Function id="qiskit.transpiler.passes.PadDelay.run" name="run" signature="PadDelay.run(dag)">
