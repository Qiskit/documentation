---
title: TwoQubitBasisDecomposer (v0.39)
description: API reference for qiskit.quantum_info.TwoQubitBasisDecomposer in qiskit v0.39
...
<Class id="qiskit.quantum_info.TwoQubitBasisDecomposer" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.22/qiskit/quantum_info/synthesis/two_qubit_decompose.py" signature="TwoQubitBasisDecomposer(gate, basis_fidelity=1.0, euler_basis=None, pulse_optimize=None)" modifiers="class">
  Bases: `object`
