...
<Class id="qiskit.opflow.state_fns.SparseVectorStateFn" github="https://github.com/qiskit/qiskit/tree/stable/0.22/qiskit/opflow/state_fns/sparse_vector_state_fn.py" signature="SparseVectorStateFn(primitive, coeff=1.0, is_measurement=False)">
