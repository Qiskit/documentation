---
title: LinearAmplitudeFunction (v0.39)
description: API reference for qiskit.circuit.library.LinearAmplitudeFunction in qiskit v0.39
...
<Class id="qiskit.circuit.library.LinearAmplitudeFunction" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.22/qiskit/circuit/library/arithmetic/linear_amplitude_function.py" signature="LinearAmplitudeFunction(num_state_qubits, slope, offset, domain, image, rescaling_factor=1, breakpoints=None, name='F')" modifiers="class">
...
$$
  ...
  *   **name** (`str`) – Name of the circuit.
  ...
  <Attribute id="qiskit.circuit.library.LinearAmplitudeFunction.instances" attributeValue="94" />
