...
<Function id="qiskit.pulse.transforms.target_qobj_transform" github="https://github.com/qiskit/qiskit/tree/stable/0.22/qiskit/pulse/transforms/base_transforms.py" signature="target_qobj_transform(sched, remove_directives=True)">
