...
<Class id="qiskit.algorithms.eigensolvers.Eigensolver" github="https://github.com/qiskit/qiskit/tree/stable/0.22/qiskit/algorithms/eigensolvers/eigensolver.py" signature="Eigensolver">
  Bases: `abc.ABC`
