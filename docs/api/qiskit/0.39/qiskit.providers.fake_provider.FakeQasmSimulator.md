...
`FakeQasmSimulator.properties()`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.22/qiskit/providers/fake_provider/fake_qasm_simulator.py "view source code")
