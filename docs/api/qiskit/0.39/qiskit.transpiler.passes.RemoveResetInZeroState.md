...
`RemoveResetInZeroState(*args, **kwargs)` [GitHub](https://github.com/qiskit/qiskit/tree/stable/0.22/qiskit/transpiler/passes/optimization/remove_reset_in_zero_state.py "view source code")
...
`RemoveResetInZeroState.run(dag)` [GitHub](https://github.com/qiskit/qiskit/tree/stable/0.22/qiskit/transpiler/passes/optimization/remove_reset_in_zero_state.py "view source code")
