...
<Function id="qiskit.pulse.builder.samples_to_seconds" name="samples_to_seconds" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.22/qiskit/pulse/builder.py" signature="samples_to_seconds(samples)">
