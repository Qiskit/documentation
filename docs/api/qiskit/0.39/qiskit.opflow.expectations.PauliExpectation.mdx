...
<Class id="qiskit.opflow.expectations.PauliExpectation" github="https://github.com/qiskit/qiskit/tree/stable/0.22/qiskit/opflow/expectations/pauli_expectation.py" signature="PauliExpectation(group_paulis=True)">
