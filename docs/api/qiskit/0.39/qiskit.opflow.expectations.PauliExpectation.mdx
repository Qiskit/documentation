---
title: PauliExpectation (v0.39)
description: API reference for qiskit.opflow.expectations.PauliExpectation in qiskit v0.39
...
<Class id="qiskit.opflow.expectations.PauliExpectation" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.22/qiskit/opflow/expectations/pauli_expectation.py" signature="PauliExpectation(group_paulis=True)" modifiers="class">
