...
<Class id="qiskit.providers.basicaer.BasicAerProvider" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.22/qiskit/providers/basicaer/basicaerprovider.py" signature="BasicAerProvider">
  ...
  <Function id="qiskit.providers.basicaer.BasicAerProvider.backends" name="backends" signature="BasicAerProvider.backends(name=None, filters=None, **kwargs)">
  ...
  <Function id="qiskit.providers.basicaer.BasicAerProvider.get_backend" name="get_backend" signature="BasicAerProvider.get_backend(name=None, **kwargs)">
  ...
  <Attribute id="qiskit.providers.basicaer.BasicAerProvider.version" name="version" attributeValue="1" />
</Class>
