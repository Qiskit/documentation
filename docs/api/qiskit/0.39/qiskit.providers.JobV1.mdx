---
title: JobV1 (v0.39)
description: API reference for qiskit.providers.JobV1 in qiskit v0.39
...
<Class id="qiskit.providers.JobV1" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.22/qiskit/providers/job.py" signature="JobV1(backend, job_id, **kwargs)" modifiers="class">
