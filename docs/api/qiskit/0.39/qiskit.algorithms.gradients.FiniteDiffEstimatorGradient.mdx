...
`FiniteDiffEstimatorGradient(estimator, epsilon, **options)` [GitHub](https://github.com/qiskit/qiskit/tree/stable/0.22/qiskit/algorithms/gradients/finite_diff_estimator_gradient.py "view source code")
