...
`HessianBase(hess_method='param_shift', **kwargs)` [GitHub](https://github.com/qiskit/qiskit/tree/stable/0.22/qiskit/opflow/gradients/hessian_base.py "view source code")
