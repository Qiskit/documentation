---
title: decompose_clifford (v0.39)
description: API reference for qiskit.quantum_info.decompose_clifford in qiskit v0.39
...
<Function id="qiskit.quantum_info.decompose_clifford" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.22/qiskit/quantum_info/synthesis/clifford_decompose.py" signature="decompose_clifford(clifford, method=None)">
