---
title: AlignFunc (v0.39)
description: API reference for qiskit.pulse.transforms.AlignFunc in qiskit v0.39
...
<Class id="qiskit.pulse.transforms.AlignFunc" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.22/qiskit/pulse/transforms/alignments.py" signature="AlignFunc(duration, func)" modifiers="class">
