---
title: CYGate (v0.39)
description: API reference for qiskit.circuit.library.CYGate in qiskit v0.39
...
<Class id="qiskit.circuit.library.CYGate" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.22/qiskit/circuit/library/standard_gates/y.py" signature="CYGate(label=None, ctrl_state=None)" modifiers="class">
