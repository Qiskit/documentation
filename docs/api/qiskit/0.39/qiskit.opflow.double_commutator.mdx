...
<Function id="qiskit.opflow.double_commutator" github="https://github.com/qiskit/qiskit/tree/stable/0.22/qiskit/opflow/utils.py" signature="double_commutator(op_a, op_b, op_c, sign=False)">
