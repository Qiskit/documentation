...
<Function id="qiskit.pulse.builder.active_backend" github="https://github.com/qiskit/qiskit/tree/stable/0.22/qiskit/pulse/builder.py" signature="active_backend()">
