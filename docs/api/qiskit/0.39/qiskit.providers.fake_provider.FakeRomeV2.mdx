...
description: API reference for qiskit.providers.fake_provider.FakeRomeV2 in qiskit v0.39
...
<Class id="qiskit.providers.fake_provider.FakeRomeV2" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.22/qiskit/providers/fake_provider/backends/rome/fake_rome.py" signature="FakeRomeV2" modifiers="class">
