...
description: API reference for qiskit.providers.fake_provider.FakePerth in qiskit v0.39
...
<Class id="qiskit.providers.fake_provider.FakePerth" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.22/qiskit/providers/fake_provider/backends/perth/fake_perth.py" signature="FakePerth" modifiers="class">
