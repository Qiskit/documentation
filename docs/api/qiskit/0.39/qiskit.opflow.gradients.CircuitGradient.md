...
`abstract CircuitGradient.convert(operator, params=None)` [GitHub](https://github.com/qiskit/qiskit/tree/stable/0.22/qiskit/opflow/gradients/circuit_gradients/circuit_gradient.py "view source code")
