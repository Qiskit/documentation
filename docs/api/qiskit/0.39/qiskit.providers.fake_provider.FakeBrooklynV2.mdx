...
description: API reference for qiskit.providers.fake_provider.FakeBrooklynV2 in qiskit v0.39
...
<Class id="qiskit.providers.fake_provider.FakeBrooklynV2" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.22/qiskit/providers/fake_provider/backends/brooklyn/fake_brooklyn.py" signature="FakeBrooklynV2" modifiers="class">
