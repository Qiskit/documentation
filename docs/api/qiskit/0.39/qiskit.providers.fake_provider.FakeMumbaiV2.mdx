...
`FakeMumbaiV2` [GitHub](https://github.com/qiskit/qiskit/tree/stable/0.22/qiskit/providers/fake_provider/backends/mumbai/fake_mumbai.py "view source code")
...
`FakeMumbaiV2.acquire_channel(qubit)`
...
`FakeMumbaiV2.control_channel(qubits)`
...
`FakeMumbaiV2.drive_channel(qubit)`
...
`FakeMumbaiV2.measure_channel(qubit)`
...
`FakeMumbaiV2.qubit_properties(qubit)`
...
`FakeMumbaiV2.run(run_input, **options)`
...
`FakeMumbaiV2.set_options(**fields)`
...
<span id="qiskit.providers.fake_provider.FakeMumbaiV2.dt" />
...
<span id="qiskit.providers.fake_provider.FakeMumbaiV2.version" />
