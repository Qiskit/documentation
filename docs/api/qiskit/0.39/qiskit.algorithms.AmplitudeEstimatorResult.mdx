---
title: AmplitudeEstimatorResult (v0.39)
description: API reference for qiskit.algorithms.AmplitudeEstimatorResult in qiskit v0.39
...
<Class id="qiskit.algorithms.AmplitudeEstimatorResult" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.22/qiskit/algorithms/amplitude_estimators/amplitude_estimator.py" signature="AmplitudeEstimatorResult" modifiers="class">
