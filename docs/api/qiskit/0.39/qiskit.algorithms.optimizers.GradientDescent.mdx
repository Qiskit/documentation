...
<Class id="qiskit.algorithms.optimizers.GradientDescent" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.22/qiskit/algorithms/optimizers/gradient_descent.py" signature="GradientDescent(maxiter=100, learning_rate=0.01, tol=1e-07, callback=None, perturbation=None)">
...
$$
  ...
  **ValueError** – If `learning_rate` is an array and its lenght is less than `maxiter`.
  ...
  <Function id="qiskit.algorithms.optimizers.GradientDescent.ask" name="ask" signature="GradientDescent.ask()">
  ...
  <Function id="qiskit.algorithms.optimizers.GradientDescent.continue_condition" name="continue_condition" signature="GradientDescent.continue_condition()">
  ...
  <Function id="qiskit.algorithms.optimizers.GradientDescent.create_result" name="create_result" signature="GradientDescent.create_result()">
  ...
  <Function id="qiskit.algorithms.optimizers.GradientDescent.evaluate" name="evaluate" signature="GradientDescent.evaluate(ask_data)">
  ...
  <Function id="qiskit.algorithms.optimizers.GradientDescent.get_support_level" name="get_support_level" signature="GradientDescent.get_support_level()">
    Get the support level dictionary.
  </Function>

  ### gradient\_num\_diff

  <Function id="qiskit.algorithms.optimizers.GradientDescent.gradient_num_diff" name="gradient_num_diff" signature="static GradientDescent.gradient_num_diff(x_center, f, epsilon, max_evals_grouped=None)">
  ...
  <Function id="qiskit.algorithms.optimizers.GradientDescent.minimize" name="minimize" signature="GradientDescent.minimize(fun, x0, jac=None, bounds=None)">
  ...
  <Function id="qiskit.algorithms.optimizers.GradientDescent.print_options" name="print_options" signature="GradientDescent.print_options()">
    Print algorithm-specific options.
  </Function>

  ### set\_max\_evals\_grouped

  <Function id="qiskit.algorithms.optimizers.GradientDescent.set_max_evals_grouped" name="set_max_evals_grouped" signature="GradientDescent.set_max_evals_grouped(limit)">
    Set max evals grouped
  </Function>

  ### set\_options

  <Function id="qiskit.algorithms.optimizers.GradientDescent.set_options" name="set_options" signature="GradientDescent.set_options(**kwargs)">
  ...
  <Function id="qiskit.algorithms.optimizers.GradientDescent.start" name="start" signature="GradientDescent.start(fun, x0, jac=None, bounds=None)">
  ...
  <Function id="qiskit.algorithms.optimizers.GradientDescent.step" name="step" signature="GradientDescent.step()">
  ...
  <Function id="qiskit.algorithms.optimizers.GradientDescent.tell" name="tell" signature="GradientDescent.tell(ask_data, tell_data)">
  ...
  <Function id="qiskit.algorithms.optimizers.GradientDescent.wrap_function" name="wrap_function" signature="static GradientDescent.wrap_function(function, args)">
  ...
  <Attribute id="qiskit.algorithms.optimizers.GradientDescent.bounds_support_level" name="bounds_support_level">
    Returns bounds support level
  </Attribute>

  ### gradient\_support\_level

  <Attribute id="qiskit.algorithms.optimizers.GradientDescent.gradient_support_level" name="gradient_support_level">
    Returns gradient support level
  </Attribute>

  ### initial\_point\_support\_level

  <Attribute id="qiskit.algorithms.optimizers.GradientDescent.initial_point_support_level" name="initial_point_support_level">
    Returns initial point support level
  </Attribute>

  ### is\_bounds\_ignored

  <Attribute id="qiskit.algorithms.optimizers.GradientDescent.is_bounds_ignored" name="is_bounds_ignored">
    Returns is bounds ignored
  </Attribute>

  ### is\_bounds\_required

  <Attribute id="qiskit.algorithms.optimizers.GradientDescent.is_bounds_required" name="is_bounds_required">
    Returns is bounds required
  </Attribute>

  ### is\_bounds\_supported

  <Attribute id="qiskit.algorithms.optimizers.GradientDescent.is_bounds_supported" name="is_bounds_supported">
    Returns is bounds supported
  </Attribute>

  ### is\_gradient\_ignored

  <Attribute id="qiskit.algorithms.optimizers.GradientDescent.is_gradient_ignored" name="is_gradient_ignored">
    Returns is gradient ignored
  </Attribute>

  ### is\_gradient\_required

  <Attribute id="qiskit.algorithms.optimizers.GradientDescent.is_gradient_required" name="is_gradient_required">
    Returns is gradient required
  </Attribute>

  ### is\_gradient\_supported

  <Attribute id="qiskit.algorithms.optimizers.GradientDescent.is_gradient_supported" name="is_gradient_supported">
    Returns is gradient supported
  </Attribute>

  ### is\_initial\_point\_ignored

  <Attribute id="qiskit.algorithms.optimizers.GradientDescent.is_initial_point_ignored" name="is_initial_point_ignored">
    Returns is initial point ignored
  </Attribute>

  ### is\_initial\_point\_required

  <Attribute id="qiskit.algorithms.optimizers.GradientDescent.is_initial_point_required" name="is_initial_point_required">
    Returns is initial point required
  </Attribute>

  ### is\_initial\_point\_supported

  <Attribute id="qiskit.algorithms.optimizers.GradientDescent.is_initial_point_supported" name="is_initial_point_supported">
    Returns is initial point supported
  </Attribute>

  ### perturbation

  <Attribute id="qiskit.algorithms.optimizers.GradientDescent.perturbation" name="perturbation">
  ...
  <Attribute id="qiskit.algorithms.optimizers.GradientDescent.setting" name="setting">
    Return setting
  </Attribute>

  ### settings

  <Attribute id="qiskit.algorithms.optimizers.GradientDescent.settings" name="settings">
    **Return type**
  ...
  <Attribute id="qiskit.algorithms.optimizers.GradientDescent.state" name="state">
  ...
  <Attribute id="qiskit.algorithms.optimizers.GradientDescent.tol" name="tol">
