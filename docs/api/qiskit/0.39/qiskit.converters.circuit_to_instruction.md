...
`circuit_to_instruction(circuit, parameter_map=None, equivalence_library=None, label=None)` [GitHub](https://github.com/qiskit/qiskit/tree/stable/0.22/qiskit/converters/circuit_to_instruction.py "view source code")
...
```python
Instruction(name='circuit-85', num_qubits=3, num_clbits=3, params=[])
```
