...
<Class id="qiskit.transpiler.passes.HighLevelSynthesis" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.22/qiskit/transpiler/passes/synthesis/high_level_synthesis.py" signature="HighLevelSynthesis(*args, **kwargs)">
  ...
  <Function id="qiskit.transpiler.passes.HighLevelSynthesis.name" name="name" signature="HighLevelSynthesis.name()">
    Return the name of the pass.
  </Function>

  ### run

  <Function id="qiskit.transpiler.passes.HighLevelSynthesis.run" name="run" signature="HighLevelSynthesis.run(dag)">
