---
title: PhaseEstimationScale (v0.39)
description: API reference for qiskit.algorithms.PhaseEstimationScale in qiskit v0.39
...
<Class id="qiskit.algorithms.PhaseEstimationScale" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.22/qiskit/algorithms/phase_estimators/phase_estimation_scale.py" signature="PhaseEstimationScale(bound)" modifiers="class">
  Bases: `object`
