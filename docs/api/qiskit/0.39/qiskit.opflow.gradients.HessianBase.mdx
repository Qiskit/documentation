---
title: HessianBase (v0.39)
description: API reference for qiskit.opflow.gradients.HessianBase in qiskit v0.39
...
<Class id="qiskit.opflow.gradients.HessianBase" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.22/qiskit/opflow/gradients/hessian_base.py" signature="HessianBase(hess_method='param_shift', **kwargs)" modifiers="class">
