---
title: SetPhase (v0.39)
description: API reference for qiskit.pulse.instructions.SetPhase in qiskit v0.39
...
<Class id="qiskit.pulse.instructions.SetPhase" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.22/qiskit/pulse/instructions/phase.py" signature="SetPhase(phase, channel, name=None)" modifiers="class">
