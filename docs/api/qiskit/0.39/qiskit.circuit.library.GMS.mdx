---
title: GMS (v0.39)
description: API reference for qiskit.circuit.library.GMS in qiskit v0.39
...
<Class id="qiskit.circuit.library.GMS" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.22/qiskit/circuit/library/generalized_gates/gms.py" signature="GMS(num_qubits, theta)" modifiers="class">
...
$$
  ...
  *   **theta** (`Union`\[`List`\[`List`\[`float`]], `ndarray`]) – a num\_qubits x num\_qubits symmetric matrix of interaction angles for each qubit pair. The upper triangle is considered.
  ...
  <Attribute id="qiskit.circuit.library.GMS.instances" attributeValue="94" />
