...
<Class id="qiskit.transpiler.passes.ValidatePulseGates" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.22/qiskit/transpiler/passes/scheduling/alignments/pulse_gate_validation.py" signature="ValidatePulseGates(granularity=1, min_length=1)">
