---
title: ManagedResults (v0.39)
description: API reference for qiskit.providers.ibmq.managed.ManagedResults in qiskit v0.39
...
<Class id="qiskit.providers.ibmq.managed.ManagedResults" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-ibmq-provider/tree/stable/0.19/qiskit/providers/ibmq/managed/managedresults.py" signature="ManagedResults(job_set, backend_name, success)" modifiers="class">
  Bases: `object`
