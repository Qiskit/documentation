---
title: FakeLima (v0.39)
description: API reference for qiskit.providers.fake_provider.FakeLima in qiskit v0.39
...
<Class id="qiskit.providers.fake_provider.FakeLima" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.22/qiskit/providers/fake_provider/backends/lima/fake_lima.py" signature="FakeLima" modifiers="class">
