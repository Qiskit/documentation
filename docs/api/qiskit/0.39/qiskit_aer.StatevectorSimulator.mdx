...
<Class id="qiskit_aer.StatevectorSimulator" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-aer/tree/stable/0.11/qiskit_aer/backends/statevector_simulator.py" signature="StatevectorSimulator(configuration=None, properties=None, provider=None, **backend_options)">
  ...
  **Raises**
  ...
  <Function id="qiskit_aer.StatevectorSimulator.available_devices" name="available_devices" signature="StatevectorSimulator.available_devices()">
    Return the available simulation methods.
  </Function>

  ### available\_methods

  <Function id="qiskit_aer.StatevectorSimulator.available_methods" name="available_methods" signature="StatevectorSimulator.available_methods()">
    Return the available simulation methods.
  </Function>

  ### clear\_options

  <Function id="qiskit_aer.StatevectorSimulator.clear_options" name="clear_options" signature="StatevectorSimulator.clear_options()">
    Reset the simulator options to default values.
  </Function>

  ### configuration

  <Function id="qiskit_aer.StatevectorSimulator.configuration" name="configuration" signature="StatevectorSimulator.configuration()">
  ...
  <Function id="qiskit_aer.StatevectorSimulator.defaults" name="defaults" signature="StatevectorSimulator.defaults()">
  ...
  <Function id="qiskit_aer.StatevectorSimulator.name" name="name" signature="StatevectorSimulator.name()">
  ...
  <Function id="qiskit_aer.StatevectorSimulator.properties" name="properties" signature="StatevectorSimulator.properties()">
  ...
  <Function id="qiskit_aer.StatevectorSimulator.provider" name="provider" signature="StatevectorSimulator.provider()">
  ...
  <Function id="qiskit_aer.StatevectorSimulator.run" name="run" signature="StatevectorSimulator.run(circuits, validate=False, parameter_binds=None, **run_options)">
  ...
  <Function id="qiskit_aer.StatevectorSimulator.set_option" name="set_option" signature="StatevectorSimulator.set_option(key, value)">
  ...
  <Function id="qiskit_aer.StatevectorSimulator.set_options" name="set_options" signature="StatevectorSimulator.set_options(**fields)">
    Set the simulator options
  </Function>

  ### status

  <Function id="qiskit_aer.StatevectorSimulator.status" name="status" signature="StatevectorSimulator.status()">
  ...
  <Attribute id="qiskit_aer.StatevectorSimulator.options" name="options">
  ...
  <Attribute id="qiskit_aer.StatevectorSimulator.version" name="version" attributeValue="= 1" />
</Class>
