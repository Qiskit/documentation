---
title: random_cnotdihedral (v0.39)
description: API reference for qiskit.quantum_info.random_cnotdihedral in qiskit v0.39
...
<Function id="qiskit.quantum_info.random_cnotdihedral" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.22/qiskit/quantum_info/operators/dihedral/random.py" signature="random_cnotdihedral(num_qubits, seed=None)">
