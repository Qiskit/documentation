---
title: FakeCambridgeV2 (v0.39)
description: API reference for qiskit.providers.fake_provider.FakeCambridgeV2 in qiskit v0.39
...
<Class id="qiskit.providers.fake_provider.FakeCambridgeV2" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.22/qiskit/providers/fake_provider/backends/cambridge/fake_cambridge.py" signature="FakeCambridgeV2" modifiers="class">
