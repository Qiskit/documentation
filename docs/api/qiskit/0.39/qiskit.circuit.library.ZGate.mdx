---
title: ZGate (v0.39)
description: API reference for qiskit.circuit.library.ZGate in qiskit v0.39
...
<Class id="qiskit.circuit.library.ZGate" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.22/qiskit/circuit/library/standard_gates/z.py" signature="ZGate(label=None)" modifiers="class">
