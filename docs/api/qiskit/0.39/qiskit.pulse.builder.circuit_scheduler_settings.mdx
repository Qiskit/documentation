...
<Function id="qiskit.pulse.builder.circuit_scheduler_settings" github="https://github.com/qiskit/qiskit/tree/stable/0.22/qiskit/pulse/builder.py" signature="circuit_scheduler_settings(**settings)">
