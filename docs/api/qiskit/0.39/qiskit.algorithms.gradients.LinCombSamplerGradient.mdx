---
title: LinCombSamplerGradient (v0.39)
description: API reference for qiskit.algorithms.gradients.LinCombSamplerGradient in qiskit v0.39
...
<Class id="qiskit.algorithms.gradients.LinCombSamplerGradient" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.22/qiskit/algorithms/gradients/lin_comb_sampler_gradient.py" signature="LinCombSamplerGradient(sampler, **options)" modifiers="class">
