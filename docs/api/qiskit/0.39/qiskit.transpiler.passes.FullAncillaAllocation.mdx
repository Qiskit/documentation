---
title: FullAncillaAllocation (v0.39)
description: API reference for qiskit.transpiler.passes.FullAncillaAllocation in qiskit v0.39
...
<Class id="qiskit.transpiler.passes.FullAncillaAllocation" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.22/qiskit/transpiler/passes/layout/full_ancilla_allocation.py" signature="FullAncillaAllocation(*args, **kwargs)" modifiers="class">
