...
<Class id="qiskit.transpiler.passes.LinearFunctionsToPermutations" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.22/qiskit/transpiler/passes/synthesis/linear_functions_synthesis.py" signature="LinearFunctionsToPermutations(*args, **kwargs)">
