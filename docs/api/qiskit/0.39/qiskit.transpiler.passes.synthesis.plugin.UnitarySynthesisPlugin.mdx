...
<Class id="qiskit.transpiler.passes.synthesis.plugin.UnitarySynthesisPlugin" github="https://github.com/qiskit/qiskit/tree/stable/0.22/qiskit/transpiler/passes/synthesis/plugin.py" signature="UnitarySynthesisPlugin">
  Bases: `abc.ABC`
