---
title: set_phase (v0.39)
description: API reference for qiskit.pulse.builder.set_phase in qiskit v0.39
...
<Function id="qiskit.pulse.builder.set_phase" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.22/qiskit/pulse/builder.py" signature="set_phase(phase, channel, name=None)">
