---
title: marginal_counts (v0.39)
description: API reference for qiskit.result.marginal_counts in qiskit v0.39
...
<Function id="qiskit.result.marginal_counts" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.22/qiskit/result/utils.py" signature="marginal_counts(result, indices=None, inplace=False, format_marginal=False, marginalize_memory=True)">
