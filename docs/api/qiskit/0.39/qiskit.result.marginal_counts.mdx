...
<Function id="qiskit.result.marginal_counts" github="https://github.com/qiskit/qiskit/tree/stable/0.22/qiskit/result/utils.py" signature="marginal_counts(result, indices=None, inplace=False, format_marginal=False, marginalize_memory=True)">
