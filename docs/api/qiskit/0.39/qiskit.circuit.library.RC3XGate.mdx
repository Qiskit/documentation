---
title: RC3XGate (v0.39)
description: API reference for qiskit.circuit.library.RC3XGate in qiskit v0.39
...
<Class id="qiskit.circuit.library.RC3XGate" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.22/qiskit/circuit/library/standard_gates/x.py" signature="RC3XGate(label=None)" modifiers="class">
