...
<Function id="qiskit.result.sampled_expectation_value" name="sampled_expectation_value" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.22/qiskit/result/sampled_expval.py" signature="sampled_expectation_value(dist, oper)">
