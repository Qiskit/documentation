---
title: CorrelatedReadoutMitigator (v0.39)
description: API reference for qiskit.result.CorrelatedReadoutMitigator in qiskit v0.39
...
<Class id="qiskit.result.CorrelatedReadoutMitigator" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.22/qiskit/result/mitigation/correlated_readout_mitigator.py" signature="CorrelatedReadoutMitigator(assignment_matrix, qubits=None)" modifiers="class">
