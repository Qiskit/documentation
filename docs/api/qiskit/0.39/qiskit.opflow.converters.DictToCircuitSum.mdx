...
<Class id="qiskit.opflow.converters.DictToCircuitSum" github="https://github.com/qiskit/qiskit/tree/stable/0.22/qiskit/opflow/converters/dict_to_circuit_sum.py" signature="DictToCircuitSum(traverse=True, convert_dicts=True, convert_vectors=True)">
