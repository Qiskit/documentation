---
title: RealTimeEvolver (v0.39)
description: API reference for qiskit.algorithms.RealTimeEvolver in qiskit v0.39
...
<Class id="qiskit.algorithms.RealTimeEvolver" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.22/qiskit/algorithms/time_evolvers/real_time_evolver.py" signature="RealTimeEvolver" modifiers="class">
  Bases: `abc.ABC`
