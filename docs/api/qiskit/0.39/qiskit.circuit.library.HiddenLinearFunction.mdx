---
title: HiddenLinearFunction (v0.39)
description: API reference for qiskit.circuit.library.HiddenLinearFunction in qiskit v0.39
...
<Class id="qiskit.circuit.library.HiddenLinearFunction" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.22/qiskit/circuit/library/hidden_linear_function.py" signature="HiddenLinearFunction(adjacency_matrix)" modifiers="class">
...
$$
  ...
  **CircuitError** – If A is not symmetric.
  ...
  <Attribute id="qiskit.circuit.library.HiddenLinearFunction.instances" attributeValue="94" />
