---
title: UMDA (v0.39)
description: API reference for qiskit.algorithms.optimizers.UMDA in qiskit v0.39
...
<Class id="qiskit.algorithms.optimizers.UMDA" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.22/qiskit/algorithms/optimizers/umda.py" signature="UMDA(maxiter=100, size_gen=20, alpha=0.5)" modifiers="class">
