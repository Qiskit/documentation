...
<Class id="qiskit.algorithms.optimizers.UMDA" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.22/qiskit/algorithms/optimizers/umda.py" signature="UMDA(maxiter=100, size_gen=20, alpha=0.5)">
  ...
  *   **alpha** (`float`) – Percentage (0, 1] of the population to be selected as elite selection.
  ...
  <Function id="qiskit.algorithms.optimizers.UMDA.get_support_level" name="get_support_level" signature="UMDA.get_support_level()">
    Get the support level dictionary.
  </Function>

  ### gradient\_num\_diff

  <Function id="qiskit.algorithms.optimizers.UMDA.gradient_num_diff" name="gradient_num_diff" signature="static UMDA.gradient_num_diff(x_center, f, epsilon, max_evals_grouped=None)">
  ...
  <Function id="qiskit.algorithms.optimizers.UMDA.minimize" name="minimize" signature="UMDA.minimize(fun, x0, jac=None, bounds=None)">
  ...
  <Function id="qiskit.algorithms.optimizers.UMDA.print_options" name="print_options" signature="UMDA.print_options()">
    Print algorithm-specific options.
  </Function>

  ### set\_max\_evals\_grouped

  <Function id="qiskit.algorithms.optimizers.UMDA.set_max_evals_grouped" name="set_max_evals_grouped" signature="UMDA.set_max_evals_grouped(limit)">
    Set max evals grouped
  </Function>

  ### set\_options

  <Function id="qiskit.algorithms.optimizers.UMDA.set_options" name="set_options" signature="UMDA.set_options(**kwargs)">
  ...
  <Function id="qiskit.algorithms.optimizers.UMDA.wrap_function" name="wrap_function" signature="static UMDA.wrap_function(function, args)">
