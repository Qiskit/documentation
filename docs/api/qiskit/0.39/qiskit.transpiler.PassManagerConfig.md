...
`classmethod PassManagerConfig.from_backend(backend, **pass_manager_options)` [GitHub](https://github.com/qiskit/qiskit/tree/stable/0.22/qiskit/transpiler/passmanager_config.py "view source code")
