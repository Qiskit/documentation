...
<Class id="qiskit.transpiler.Target" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.22/qiskit/transpiler/target.py" signature="Target(description=None, num_qubits=0, dt=None, granularity=1, min_length=1, pulse_alignment=1, aquire_alignment=1, qubit_properties=None)">
  ...
  *   **qubit\_properties\`** –
  ...
  <Function id="qiskit.transpiler.Target.add_instruction" name="add_instruction" signature="Target.add_instruction(instruction, properties=None, name=None)">
  ...
  <Function id="qiskit.transpiler.Target.build_coupling_map" name="build_coupling_map" signature="Target.build_coupling_map(two_q_gate=None)">
  ...
  <Function id="qiskit.transpiler.Target.durations" name="durations" signature="Target.durations()">
  ...
  <Function id="qiskit.transpiler.Target.get" name="get" signature="Target.get(k[, d]) → D[k] if k in D, else d.  d defaults to None." />

  ### get\_non\_global\_operation\_names

  <Function id="qiskit.transpiler.Target.get_non_global_operation_names" name="get_non_global_operation_names" signature="Target.get_non_global_operation_names(strict_direction=False)">
  ...
  <Function id="qiskit.transpiler.Target.instruction_properties" name="instruction_properties" signature="Target.instruction_properties(index)">
  ...
  <Function id="qiskit.transpiler.Target.instruction_schedule_map" name="instruction_schedule_map" signature="Target.instruction_schedule_map()">
  ...
  <Function id="qiskit.transpiler.Target.instruction_supported" name="instruction_supported" signature="Target.instruction_supported(operation_name=None, qargs=None, operation_class=None, parameters=None)">
  ...
  <Function id="qiskit.transpiler.Target.items" name="items" signature="Target.items() → a set-like object providing a view on D's items" />

  ### keys

  <Function id="qiskit.transpiler.Target.keys" name="keys" signature="Target.keys() → a set-like object providing a view on D's keys" />

  ### operation\_from\_name

  <Function id="qiskit.transpiler.Target.operation_from_name" name="operation_from_name" signature="Target.operation_from_name(instruction)">
  ...
  <Function id="qiskit.transpiler.Target.operation_names_for_qargs" name="operation_names_for_qargs" signature="Target.operation_names_for_qargs(qargs)">
  ...
  <Function id="qiskit.transpiler.Target.operations_for_qargs" name="operations_for_qargs" signature="Target.operations_for_qargs(qargs)">
  ...
  <Function id="qiskit.transpiler.Target.qargs_for_operation_name" name="qargs_for_operation_name" signature="Target.qargs_for_operation_name(operation)">
  ...
  <Function id="qiskit.transpiler.Target.timing_constraints" name="timing_constraints" signature="Target.timing_constraints()">
  ...
  <Function id="qiskit.transpiler.Target.update_from_instruction_schedule_map" name="update_from_instruction_schedule_map" signature="Target.update_from_instruction_schedule_map(inst_map, inst_name_map=None, error_dict=None)">
  ...
  <Function id="qiskit.transpiler.Target.update_instruction_properties" name="update_instruction_properties" signature="Target.update_instruction_properties(instruction, qargs, properties)">
  ...
  <Function id="qiskit.transpiler.Target.values" name="values" signature="Target.values() → an object providing a view on D's values" />
