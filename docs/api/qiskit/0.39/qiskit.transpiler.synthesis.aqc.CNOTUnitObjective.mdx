---
title: CNOTUnitObjective (v0.39)
description: API reference for qiskit.transpiler.synthesis.aqc.CNOTUnitObjective in qiskit v0.39
...
<Class id="qiskit.transpiler.synthesis.aqc.CNOTUnitObjective" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.22/qiskit/transpiler/synthesis/aqc/cnot_unit_objective.py" signature="CNOTUnitObjective(num_qubits, cnots)" modifiers="class">
