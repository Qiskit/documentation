---
title: C3SXGate (v0.39)
description: API reference for qiskit.circuit.library.C3SXGate in qiskit v0.39
...
<Class id="qiskit.circuit.library.C3SXGate" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.22/qiskit/circuit/library/standard_gates/x.py" signature="C3SXGate(label=None, ctrl_state=None)" modifiers="class">
