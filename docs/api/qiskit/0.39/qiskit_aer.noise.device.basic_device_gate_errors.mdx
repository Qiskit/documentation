---
title: basic_device_gate_errors (v0.39)
description: API reference for qiskit_aer.noise.device.basic_device_gate_errors in qiskit v0.39
...
<Function id="qiskit_aer.noise.device.basic_device_gate_errors" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-aer/tree/stable/0.11/qiskit_aer/noise/device/models.py" signature="basic_device_gate_errors(properties, gate_error=True, thermal_relaxation=True, gate_lengths=None, gate_length_units='ns', temperature=0, standard_gates=None, warnings=None, target=None)">
