...
<Class id="qiskit.providers.QiskitBackendNotFoundError" name="QiskitBackendNotFoundError" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.22/qiskit/providers/exceptions.py" signature="QiskitBackendNotFoundError(*message)">
