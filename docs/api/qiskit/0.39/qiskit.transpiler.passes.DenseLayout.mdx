---
title: DenseLayout (v0.39)
description: API reference for qiskit.transpiler.passes.DenseLayout in qiskit v0.39
...
<Class id="qiskit.transpiler.passes.DenseLayout" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.22/qiskit/transpiler/passes/layout/dense_layout.py" signature="DenseLayout(*args, **kwargs)" modifiers="class">
