---
title: EchoRZXWeylDecomposition (v0.39)
description: API reference for qiskit.transpiler.passes.EchoRZXWeylDecomposition in qiskit v0.39
...
<Class id="qiskit.transpiler.passes.EchoRZXWeylDecomposition" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.22/qiskit/transpiler/passes/optimization/echo_rzx_weyl_decomposition.py" signature="EchoRZXWeylDecomposition(*args, **kwargs)" modifiers="class">
