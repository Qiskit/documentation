---
title: CVaRMeasurement (v0.39)
description: API reference for qiskit.opflow.state_fns.CVaRMeasurement in qiskit v0.39
...
<Class id="qiskit.opflow.state_fns.CVaRMeasurement" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.22/qiskit/opflow/state_fns/cvar_measurement.py" signature="CVaRMeasurement(primitive=None, alpha=1.0, coeff=1.0)" modifiers="class">
