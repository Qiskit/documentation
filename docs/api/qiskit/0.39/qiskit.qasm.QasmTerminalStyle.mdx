---
title: QasmTerminalStyle (v0.39)
description: API reference for qiskit.qasm.QasmTerminalStyle in qiskit v0.39
...
<Class id="qiskit.qasm.QasmTerminalStyle" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.22/qiskit/qasm/pygments/lexer.py" signature="QasmTerminalStyle" modifiers="class">
