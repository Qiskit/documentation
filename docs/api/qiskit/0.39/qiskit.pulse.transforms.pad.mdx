---
title: pad (v0.39)
description: API reference for qiskit.pulse.transforms.pad in qiskit v0.39
...
<Function id="qiskit.pulse.transforms.pad" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.22/qiskit/pulse/transforms/canonicalization.py" signature="pad(schedule, channels=None, until=None, inplace=False)">
