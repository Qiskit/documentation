...
<Class id="qiskit.algorithms.gradients.BaseSamplerGradient" github="https://github.com/qiskit/qiskit/tree/stable/0.22/qiskit/algorithms/gradients/base_sampler_gradient.py" signature="BaseSamplerGradient(sampler, options=None)">
  Bases: `abc.ABC`
