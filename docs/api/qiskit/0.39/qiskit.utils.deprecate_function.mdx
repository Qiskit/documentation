...
`deprecate_function(msg, stacklevel=2, category=<class 'DeprecationWarning'>)` [GitHub](https://github.com/qiskit/qiskit/tree/stable/0.22/qiskit/utils/deprecation.py "view source code")
