---
title: ApproximatingObjective (v0.39)
description: API reference for qiskit.transpiler.synthesis.aqc.ApproximatingObjective in qiskit v0.39
...
<Class id="qiskit.transpiler.synthesis.aqc.ApproximatingObjective" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.22/qiskit/transpiler/synthesis/aqc/approximate.py" signature="ApproximatingObjective" modifiers="class">
  Bases: `abc.ABC`
