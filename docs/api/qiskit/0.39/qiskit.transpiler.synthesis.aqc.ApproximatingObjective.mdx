...
<Class id="qiskit.transpiler.synthesis.aqc.ApproximatingObjective" github="https://github.com/qiskit/qiskit/tree/stable/0.22/qiskit/transpiler/synthesis/aqc/approximate.py" signature="ApproximatingObjective">
  Bases: `abc.ABC`
