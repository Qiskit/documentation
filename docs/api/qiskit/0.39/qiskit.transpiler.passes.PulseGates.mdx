---
title: PulseGates (v0.39)
description: API reference for qiskit.transpiler.passes.PulseGates in qiskit v0.39
...
<Class id="qiskit.transpiler.passes.PulseGates" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.22/qiskit/transpiler/passes/calibration/pulse_gate.py" signature="PulseGates(inst_map)" modifiers="class">
  ...
  **inst\_map** ([`InstructionScheduleMap`](qiskit.pulse.InstructionScheduleMap "qiskit.pulse.instruction_schedule_map.InstructionScheduleMap")) – Instruction schedule map that user may override.
  ...
  <span id="qiskit-transpiler-passes-pulsegates-get-calibration" />
