...
<Class id="qiskit.transpiler.passes.PulseGates" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.22/qiskit/transpiler/passes/calibration/pulse_gate.py" signature="PulseGates(inst_map)">
  ...
  **inst\_map** ([`InstructionScheduleMap`](qiskit.pulse.InstructionScheduleMap "qiskit.pulse.instruction_schedule_map.InstructionScheduleMap")) – Instruction schedule map that user may override.
  ...
  <Function id="qiskit.transpiler.passes.PulseGates.get_calibration" name="get_calibration" signature="PulseGates.get_calibration(node_op, qubits)">
  ...
  <Function id="qiskit.transpiler.passes.PulseGates.name" name="name" signature="PulseGates.name()">
    Return the name of the pass.
  </Function>

  ### run

  <Function id="qiskit.transpiler.passes.PulseGates.run" name="run" signature="PulseGates.run(dag)">
  ...
  <Function id="qiskit.transpiler.passes.PulseGates.supported" name="supported" signature="PulseGates.supported(node_op, qubits)">
  ...
  <Attribute id="qiskit.transpiler.passes.PulseGates.is_analysis_pass" name="is_analysis_pass">
  ...
  <Attribute id="qiskit.transpiler.passes.PulseGates.is_transformation_pass" name="is_transformation_pass">
