---
title: UchannelLO (v0.39)
description: API reference for qiskit.providers.models.UchannelLO in qiskit v0.39
...
<Class id="qiskit.providers.models.UchannelLO" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.22/qiskit/providers/models/backendconfiguration.py" signature="UchannelLO(q, scale)" modifiers="class">
  Bases: `object`
