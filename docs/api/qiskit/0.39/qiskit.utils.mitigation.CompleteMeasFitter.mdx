...
<Class id="qiskit.utils.mitigation.CompleteMeasFitter" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.22/qiskit/utils/mitigation/fitters.py" signature="CompleteMeasFitter(results, state_labels, qubit_list=None, circlabel='')">
  Bases: `object`
  ...
  *   **circlabel** (`str`) – if the qubits were labeled.
  ...
  <Function id="qiskit.utils.mitigation.CompleteMeasFitter.add_data" name="add_data" signature="CompleteMeasFitter.add_data(new_results, rebuild_cal_matrix=True)">
  ...
  <Function id="qiskit.utils.mitigation.CompleteMeasFitter.readout_fidelity" name="readout_fidelity" signature="CompleteMeasFitter.readout_fidelity(label_list=None)">
  ...
  <Function id="qiskit.utils.mitigation.CompleteMeasFitter.subset_fitter" name="subset_fitter" signature="CompleteMeasFitter.subset_fitter(qubit_sublist)">
  ...
  <Attribute id="qiskit.utils.mitigation.CompleteMeasFitter.cal_matrix" name="cal_matrix">
    Return cal\_matrix.
  </Attribute>

  ### filter

  <Attribute id="qiskit.utils.mitigation.CompleteMeasFitter.filter" name="filter">
    Return a measurement filter using the cal matrix.
  </Attribute>

  ### qubit\_list

  <Attribute id="qiskit.utils.mitigation.CompleteMeasFitter.qubit_list" name="qubit_list">
    Return list of qubits.
  </Attribute>

  ### state\_labels

  <Attribute id="qiskit.utils.mitigation.CompleteMeasFitter.state_labels" name="state_labels">
