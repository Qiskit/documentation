---
title: CompleteMeasFitter (v0.39)
description: API reference for qiskit.utils.mitigation.CompleteMeasFitter in qiskit v0.39
...
<Class id="qiskit.utils.mitigation.CompleteMeasFitter" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.22/qiskit/utils/mitigation/fitters.py" signature="CompleteMeasFitter(results, state_labels, qubit_list=None, circlabel='')" modifiers="class">
  Bases: `object`
