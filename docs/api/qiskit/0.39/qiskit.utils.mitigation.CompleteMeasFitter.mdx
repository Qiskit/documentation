...
`CompleteMeasFitter(results, state_labels, qubit_list=None, circlabel='')` [GitHub](https://github.com/qiskit/qiskit/tree/stable/0.22/qiskit/utils/mitigation/fitters.py "view source code")
