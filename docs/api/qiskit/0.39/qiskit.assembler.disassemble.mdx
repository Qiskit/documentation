---
title: disassemble (v0.39)
description: API reference for qiskit.assembler.disassemble in qiskit v0.39
...
<Function id="qiskit.assembler.disassemble" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.22/qiskit/assembler/disassemble.py" signature="disassemble(qobj)">
