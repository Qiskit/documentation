---
title: EquivalenceLibrary (v0.39)
description: API reference for qiskit.circuit.EquivalenceLibrary in qiskit v0.39
...
<Class id="qiskit.circuit.EquivalenceLibrary" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.22/qiskit/circuit/equivalence.py" signature="EquivalenceLibrary(*, base=None)" modifiers="class">
  Bases: `object`
