---
title: ast_to_dag (v0.39)
description: API reference for qiskit.converters.ast_to_dag in qiskit v0.39
...
<Function id="qiskit.converters.ast_to_dag" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.22/qiskit/converters/ast_to_dag.py" signature="ast_to_dag(ast)">
  ...
  **Example**
  ...
  ![../\_images/qiskit.converters.ast\_to\_dag\_0\_0.png](/docs/images/api/qiskit/0.39/qiskit.converters.ast_to_dag_0_0.avif)
</Function>
