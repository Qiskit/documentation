---
title: IGate (v0.39)
description: API reference for qiskit.circuit.library.IGate in qiskit v0.39
...
<Class id="qiskit.circuit.library.IGate" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.22/qiskit/circuit/library/standard_gates/i.py" signature="IGate(label=None)" modifiers="class">
