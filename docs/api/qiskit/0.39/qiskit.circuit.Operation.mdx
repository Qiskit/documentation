---
title: Operation (v0.39)
description: API reference for qiskit.circuit.Operation in qiskit v0.39
...
<Class id="qiskit.circuit.Operation" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.22/qiskit/circuit/operation.py" signature="Operation" modifiers="class">
  Bases: `abc.ABC`
