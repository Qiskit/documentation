...
<Function id="qiskit.transpiler.preset_passmanagers.plugin.list_stage_plugins" name="list_stage_plugins" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.22/qiskit/transpiler/preset_passmanagers/plugin.py" signature="list_stage_plugins(stage_name)">
