---
title: ECRGate (v0.39)
description: API reference for qiskit.circuit.library.ECRGate in qiskit v0.39
...
<Class id="qiskit.circuit.library.ECRGate" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.22/qiskit/circuit/library/standard_gates/ecr.py" signature="ECRGate" modifiers="class">
