---
title: BackendProperties (v0.39)
description: API reference for qiskit.providers.models.BackendProperties in qiskit v0.39
...
<Class id="qiskit.providers.models.BackendProperties" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.22/qiskit/providers/models/backendproperties.py" signature="BackendProperties(backend_name, backend_version, last_update_date, qubits, gates, general, **kwargs)" modifiers="class">
  Bases: `object`
