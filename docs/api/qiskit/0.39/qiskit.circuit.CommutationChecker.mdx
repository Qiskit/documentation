...
<Class id="qiskit.circuit.CommutationChecker" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.22/qiskit/circuit/commutation_checker.py" signature="CommutationChecker">
  Bases: `object`
  ...
  <Function id="qiskit.circuit.CommutationChecker.commute" name="commute" signature="CommutationChecker.commute(op1, qargs1, cargs1, op2, qargs2, cargs2)">
