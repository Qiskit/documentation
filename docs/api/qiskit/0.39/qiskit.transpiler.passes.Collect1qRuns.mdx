---
title: Collect1qRuns (v0.39)
description: API reference for qiskit.transpiler.passes.Collect1qRuns in qiskit v0.39
...
<Class id="qiskit.transpiler.passes.Collect1qRuns" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.22/qiskit/transpiler/passes/optimization/collect_1q_runs.py" signature="Collect1qRuns(*args, **kwargs)" modifiers="class">
