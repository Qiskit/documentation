...
`FakePoughkeepsieV2` [GitHub](https://github.com/qiskit/qiskit/tree/stable/0.22/qiskit/providers/fake_provider/backends/poughkeepsie/fake_poughkeepsie.py "view source code")
...
`= '/home/runner/work/qiskit/qiskit/.tox/docs/lib/python3.8/site-packages/qiskit/providers/fake_provider/backends/poughkeepsie'`
