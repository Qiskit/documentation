...
<Class id="qiskit.visualization.qcstyle.DefaultStyle" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.22/qiskit/visualization/circuit/qcstyle.py" signature="DefaultStyle">
  Bases: `object`
