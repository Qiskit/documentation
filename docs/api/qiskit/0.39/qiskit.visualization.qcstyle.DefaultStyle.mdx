---
title: DefaultStyle (v0.39)
description: API reference for qiskit.visualization.qcstyle.DefaultStyle in qiskit v0.39
...
<Class id="qiskit.visualization.qcstyle.DefaultStyle" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.22/qiskit/visualization/circuit/qcstyle.py" signature="DefaultStyle" modifiers="class">
  Bases: `object`
