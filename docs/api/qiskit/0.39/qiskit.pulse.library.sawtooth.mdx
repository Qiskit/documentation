---
title: sawtooth (v0.39)
description: API reference for qiskit.pulse.library.sawtooth in qiskit v0.39
...
<Function id="qiskit.pulse.library.sawtooth" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.22/qiskit/pulse/library/discrete.py" signature="sawtooth(duration, amp, freq=None, phase=0, name=None)">
...
$$
  ...
  **Example**
  ...
  ![../\_images/qiskit.pulse.library.sawtooth\_0\_1.png](/docs/images/api/qiskit/0.39/qiskit.pulse.library.sawtooth_0_1.avif)
