...
`Hessian(hess_method='param_shift', **kwargs)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.22/qiskit/opflow/gradients/hessian.py "view source code")
...
`Hessian.convert(operator, params=None)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.22/qiskit/opflow/gradients/hessian.py "view source code")
...
`Hessian.get_hessian(operator, params=None)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.22/qiskit/opflow/gradients/hessian.py "view source code")
