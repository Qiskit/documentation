---
title: RegisterSlot (v0.39)
description: API reference for qiskit.pulse.channels.RegisterSlot in qiskit v0.39
...
<Class id="qiskit.pulse.channels.RegisterSlot" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.22/qiskit/pulse/channels.py" signature="RegisterSlot(index)" modifiers="class">
