---
title: plot_bloch_multivector (v0.39)
description: API reference for qiskit.visualization.plot_bloch_multivector in qiskit v0.39
...
<Function id="qiskit.visualization.plot_bloch_multivector" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.22/qiskit/visualization/state_visualization.py" signature="plot_bloch_multivector(state, title='', figsize=None, *, rho=None, reverse_bits=False, filename=None)">
  ...
  **Examples**
  ...
  ![../\_images/qiskit.visualization.plot\_bloch\_multivector\_0\_0.png](/docs/images/api/qiskit/0.39/qiskit.visualization.plot_bloch_multivector_0_0.avif)
  ...
  ![../\_images/qiskit.visualization.plot\_bloch\_multivector\_1\_0.png](/docs/images/api/qiskit/0.39/qiskit.visualization.plot_bloch_multivector_1_0.avif)
</Function>
