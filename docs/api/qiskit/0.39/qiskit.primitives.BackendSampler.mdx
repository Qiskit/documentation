...
<Class id="qiskit.primitives.BackendSampler" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.22/qiskit/primitives/backend_sampler.py" signature="BackendSampler(backend, options=None, bound_pass_manager=None, skip_transpilation=False)">
  ...
  **ValueError** – If backend is not provided
  ...
  <Function id="qiskit.primitives.BackendSampler.close" name="close" signature="BackendSampler.close()">
    Close the session and free resources
  </Function>

  ### run

  <Function id="qiskit.primitives.BackendSampler.run" name="run" signature="BackendSampler.run(circuits, parameter_values=None, **run_options)">
  ...
  <Function id="qiskit.primitives.BackendSampler.set_options" name="set_options" signature="BackendSampler.set_options(**fields)">
  ...
  <Function id="qiskit.primitives.BackendSampler.set_transpile_options" name="set_transpile_options" signature="BackendSampler.set_transpile_options(**fields)">
  ...
  <Attribute id="qiskit.primitives.BackendSampler.circuits" name="circuits">
  ...
  <Attribute id="qiskit.primitives.BackendSampler.parameters" name="parameters">
