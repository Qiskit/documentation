---
title: RZZGate (v0.39)
description: API reference for qiskit.circuit.library.RZZGate in qiskit v0.39
...
<Class id="qiskit.circuit.library.RZZGate" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.22/qiskit/circuit/library/standard_gates/rzz.py" signature="RZZGate(theta, label=None)" modifiers="class">
