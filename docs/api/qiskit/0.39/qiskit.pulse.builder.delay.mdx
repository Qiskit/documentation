---
title: delay (v0.39)
description: API reference for qiskit.pulse.builder.delay in qiskit v0.39
...
<Function id="qiskit.pulse.builder.delay" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.22/qiskit/pulse/builder.py" signature="delay(duration, channel, name=None)">
