...
`classmethod PulseDefaults.from_dict(data)` [GitHub](https://github.com/qiskit/qiskit/tree/stable/0.22/qiskit/providers/models/pulsedefaults.py "view source code")
...
`PulseDefaults.to_dict()` [GitHub](https://github.com/qiskit/qiskit/tree/stable/0.22/qiskit/providers/models/pulsedefaults.py "view source code")
