---
title: measure (v0.39)
description: API reference for qiskit.pulse.builder.measure in qiskit v0.39
...
<Function id="qiskit.pulse.builder.measure" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.22/qiskit/pulse/builder.py" signature="measure(qubits, registers=None)">
