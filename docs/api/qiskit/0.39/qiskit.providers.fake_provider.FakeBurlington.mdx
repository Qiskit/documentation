---
title: FakeBurlington (v0.39)
description: API reference for qiskit.providers.fake_provider.FakeBurlington in qiskit v0.39
...
<Class id="qiskit.providers.fake_provider.FakeBurlington" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.22/qiskit/providers/fake_provider/backends/burlington/fake_burlington.py" signature="FakeBurlington" modifiers="class">
