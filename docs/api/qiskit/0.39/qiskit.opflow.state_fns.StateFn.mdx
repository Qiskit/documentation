...
<Class id="qiskit.opflow.state_fns.StateFn" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.22/qiskit/opflow/state_fns/state_fn.py" signature="StateFn(primitive=None, coeff=1.0, is_measurement=False)">
  ...
  *   **is\_measurement** (`bool`) – Whether the StateFn is a measurement operator
  ...
  <Function id="qiskit.opflow.state_fns.StateFn.add" name="add" signature="StateFn.add(other)">
  ...
  <Function id="qiskit.opflow.state_fns.StateFn.adjoint" name="adjoint" signature="StateFn.adjoint()">
  ...
  <Function id="qiskit.opflow.state_fns.StateFn.assign_parameters" name="assign_parameters" signature="StateFn.assign_parameters(param_dict)">
  ...
  <Function id="qiskit.opflow.state_fns.StateFn.compose" name="compose" signature="StateFn.compose(other, permutation=None, front=False)">
  ...
  <Function id="qiskit.opflow.state_fns.StateFn.equals" name="equals" signature="StateFn.equals(other)">
  ...
  <Function id="qiskit.opflow.state_fns.StateFn.eval" name="eval" signature="StateFn.eval(front=None)">
  ...
  <Function id="qiskit.opflow.state_fns.StateFn.mul" name="mul" signature="StateFn.mul(scalar)">
  ...
  <Function id="qiskit.opflow.state_fns.StateFn.permute" name="permute" signature="StateFn.permute(permutation)">
  ...
  <Function id="qiskit.opflow.state_fns.StateFn.power" name="power" signature="StateFn.power(exponent)">
  ...
  <Function id="qiskit.opflow.state_fns.StateFn.primitive_strings" name="primitive_strings" signature="StateFn.primitive_strings()">
  ...
  <Function id="qiskit.opflow.state_fns.StateFn.reduce" name="reduce" signature="StateFn.reduce()">
  ...
  <Function id="qiskit.opflow.state_fns.StateFn.sample" name="sample" signature="StateFn.sample(shots=1024, massive=False, reverse_endianness=False)">
  ...
  <Function id="qiskit.opflow.state_fns.StateFn.tensor" name="tensor" signature="StateFn.tensor(other)">
  ...
  <Function id="qiskit.opflow.state_fns.StateFn.tensorpower" name="tensorpower" signature="StateFn.tensorpower(other)">
  ...
  <Function id="qiskit.opflow.state_fns.StateFn.to_circuit_op" name="to_circuit_op" signature="StateFn.to_circuit_op()">
  ...
  <Function id="qiskit.opflow.state_fns.StateFn.to_density_matrix" name="to_density_matrix" signature="StateFn.to_density_matrix(massive=False)">
  ...
  <Function id="qiskit.opflow.state_fns.StateFn.to_matrix" name="to_matrix" signature="StateFn.to_matrix(massive=False)">
  ...
  <Function id="qiskit.opflow.state_fns.StateFn.to_matrix_op" name="to_matrix_op" signature="StateFn.to_matrix_op(massive=False)">
  ...
  <Function id="qiskit.opflow.state_fns.StateFn.traverse" name="traverse" signature="StateFn.traverse(convert_fn, coeff=None)">
  ...
  <Attribute id="qiskit.opflow.state_fns.StateFn.INDENTATION" name="INDENTATION" attributeValue="= '  '" />

  ### coeff

  <Attribute id="qiskit.opflow.state_fns.StateFn.coeff" name="coeff">
  ...
  <Attribute id="qiskit.opflow.state_fns.StateFn.instance_id" name="instance_id">
  ...
  <Attribute id="qiskit.opflow.state_fns.StateFn.is_measurement" name="is_measurement">
  ...
  <Attribute id="qiskit.opflow.state_fns.StateFn.num_qubits" name="num_qubits">
    **Return type**
  ...
  <Attribute id="qiskit.opflow.state_fns.StateFn.parameters" name="parameters" />

  ### primitive

  <Attribute id="qiskit.opflow.state_fns.StateFn.primitive" name="primitive">
    The primitive which defines the behavior of the underlying State function.
  </Attribute>

  ### settings

  <Attribute id="qiskit.opflow.state_fns.StateFn.settings" name="settings">
    Return settings.
