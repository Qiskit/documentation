---
title: RuntimeJob (v0.39)
description: API reference for qiskit.providers.ibmq.runtime.RuntimeJob in qiskit v0.39
...
<Class id="qiskit.providers.ibmq.runtime.RuntimeJob" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-ibmq-provider/tree/stable/0.19/qiskit/providers/ibmq/runtime/runtime_job.py" signature="RuntimeJob(backend, api_client, credentials, job_id, program_id, params=None, creation_date=None, user_callback=None, result_decoder=<class 'qiskit.providers.ibmq.runtime.program.result_decoder.ResultDecoder'>, image='')" modifiers="class">
  ...
  *   **image** (`Optional`\[`str`]) – Runtime image used for this job: image\_name:tag.
  ...
  <span id="qiskit-providers-ibmq-runtime-runtimejob-cancel-result-streaming" />
  ...
  <span id="qiskit-providers-ibmq-runtime-runtimejob-error-message" />
  ...
  <span id="qiskit-providers-ibmq-runtime-runtimejob-job-id" />
  ...
  <span id="qiskit-providers-ibmq-runtime-runtimejob-stream-results" />
  ...
  <span id="qiskit-providers-ibmq-runtime-runtimejob-wait-for-final-state" />
  ...
  <Attribute id="qiskit.providers.ibmq.runtime.RuntimeJob.image">
