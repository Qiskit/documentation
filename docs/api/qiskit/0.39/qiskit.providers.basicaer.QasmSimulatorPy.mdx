...
<Class id="qiskit.providers.basicaer.QasmSimulatorPy" github="https://github.com/qiskit/qiskit/tree/stable/0.22/qiskit/providers/basicaer/qasm_simulator.py" signature="QasmSimulatorPy(configuration=None, provider=None, **fields)">
