...
<Class id="qiskit.quantum_info.PauliList" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.22/qiskit/quantum_info/operators/symplectic/pauli_list.py" signature="PauliList(data)">
  ...
  **Additional Information:**
  ...
  <Function id="qiskit.quantum_info.PauliList.sort" name="sort" signature="PauliList.sort(weight=False, phase=False)">
    ...
    **Example**
    ...
    ```python
    Initial Ordering
    ['ZX', 'ZI', 'XI', 'IX', 'ZY', 'XX', 'YY', 'YX', 'XY', 'XZ', 'YZ', 'IZ',
     'IY', 'II', 'YI', 'ZZ']
