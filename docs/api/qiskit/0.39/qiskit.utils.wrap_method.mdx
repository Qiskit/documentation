...
<Function id="qiskit.utils.wrap_method" name="wrap_method" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.22/qiskit/utils/classtools.py" signature="wrap_method(cls, name, *, before=None, after=None)">
