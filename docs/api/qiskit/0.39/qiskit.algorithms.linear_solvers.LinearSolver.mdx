...
<Class id="qiskit.algorithms.linear_solvers.LinearSolver" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.22/qiskit/algorithms/linear_solvers/linear_solver.py" signature="LinearSolver">
  ...
  <Function id="qiskit.algorithms.linear_solvers.LinearSolver.solve" signature="abstract LinearSolver.solve(matrix, vector, observable=None, observable_circuit=None, post_processing=None)">
