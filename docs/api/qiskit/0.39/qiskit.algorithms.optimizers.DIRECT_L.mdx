...
<Class id="qiskit.algorithms.optimizers.DIRECT_L" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.22/qiskit/algorithms/optimizers/nlopts/direct_l.py" signature="DIRECT_L(max_evals=1000)">
  ...
  **MissingOptionalLibraryError** – NLopt library not installed.
  ...
  <Function id="qiskit.algorithms.optimizers.DIRECT_L.gradient_num_diff" signature="static DIRECT_L.gradient_num_diff(x_center, f, epsilon, max_evals_grouped=None)">
