---
title: QuantumError (v0.39)
description: API reference for qiskit_aer.noise.QuantumError in qiskit v0.39
...
<Class id="qiskit_aer.noise.QuantumError" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-aer/tree/stable/0.11/qiskit_aer/noise/errors/quantum_error.py" signature="QuantumError(noise_ops, number_of_qubits=None, standard_gates=None, atol=None)" modifiers="class">
  ...
  **NoiseError** – If input noise\_ops is invalid, e.g. it’s not a CPTP map.
  ...
  <span id="qiskit-aer-noise-quantumerror-compose" />
  ...
  <span id="qiskit-aer-noise-quantumerror-copy" />
  ...
  <span id="qiskit-aer-noise-quantumerror-dot" />
  ...
  <span id="qiskit-aer-noise-quantumerror-error-term" />
  ...
  <span id="qiskit-aer-noise-quantumerror-expand" />
  ...
  <span id="qiskit-aer-noise-quantumerror-ideal" />
  ...
  <span id="qiskit-aer-noise-quantumerror-input-dims" />
  ...
  <span id="qiskit-aer-noise-quantumerror-output-dims" />
  ...
  <span id="qiskit-aer-noise-quantumerror-power" />
  ...
  <span id="qiskit-aer-noise-quantumerror-reshape" />
  ...
  <span id="qiskit-aer-noise-quantumerror-set-atol" />
  ...
  <span id="qiskit-aer-noise-quantumerror-set-rtol" />
  ...
  <span id="qiskit-aer-noise-quantumerror-tensor" />
  ...
  <span id="qiskit-aer-noise-quantumerror-to-dict" />
  ...
  <span id="qiskit-aer-noise-quantumerror-to-instruction" />
  ...
  <span id="qiskit-aer-noise-quantumerror-to-quantumchannel" />
