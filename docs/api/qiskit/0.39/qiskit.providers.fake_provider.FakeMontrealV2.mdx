...
<Class id="qiskit.providers.fake_provider.FakeMontrealV2" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.22/qiskit/providers/fake_provider/backends/montreal/fake_montreal.py" signature="FakeMontrealV2">
