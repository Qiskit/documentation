...
<Class id="qiskit.providers.fake_provider.FakeBackend5QV2" github="https://github.com/qiskit/qiskit/tree/stable/0.22/qiskit/providers/fake_provider/fake_backend_v2.py" signature="FakeBackend5QV2(bidirectional=True)">
  ...
  **AttributeError** – If a field is specified that’s outside the backend’s options
  ...
  <Function id="qiskit.providers.fake_provider.FakeBackend5QV2.acquire_channel" signature="FakeBackend5QV2.acquire_channel(qubit)">
  ...
  <Function id="qiskit.providers.fake_provider.FakeBackend5QV2.control_channel" signature="FakeBackend5QV2.control_channel(qubits)">
  ...
  <Function id="qiskit.providers.fake_provider.FakeBackend5QV2.drive_channel" signature="FakeBackend5QV2.drive_channel(qubit)">
  ...
  <Function id="qiskit.providers.fake_provider.FakeBackend5QV2.measure_channel" signature="FakeBackend5QV2.measure_channel(qubit)">
  ...
  <Function id="qiskit.providers.fake_provider.FakeBackend5QV2.qubit_properties" signature="FakeBackend5QV2.qubit_properties(qubit)">
  ...
  <Function id="qiskit.providers.fake_provider.FakeBackend5QV2.run" signature="FakeBackend5QV2.run(run_input, **options)">
    Run on the backend.
  ...
  <Function id="qiskit.providers.fake_provider.FakeBackend5QV2.set_options" signature="FakeBackend5QV2.set_options(**fields)">
