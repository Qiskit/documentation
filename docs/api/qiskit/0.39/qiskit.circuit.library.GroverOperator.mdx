---
title: GroverOperator (v0.39)
description: API reference for qiskit.circuit.library.GroverOperator in qiskit v0.39
...
$$
  ...
  *   **name** (`str`) – The name of the circuit.
  ...
  <Attribute id="qiskit.circuit.library.GroverOperator.instances" attributeValue="94" />
