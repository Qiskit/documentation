...
<Class id="qiskit.primitives.Sampler" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.22/qiskit/primitives/sampler.py" signature="Sampler(circuits: Iterable[QuantumCircuit] | QuantumCircuit | None = None, parameters: Iterable[Iterable[Parameter]] | None = None, **kwargs)">
  ...
  **QiskitError** – if some classical bits are not used for measurements.
  ...
  <Function id="qiskit.primitives.Sampler.close" name="close" signature="Sampler.close()">
    Close the session and free resources
  </Function>

  ### run

  <Function id="qiskit.primitives.Sampler.run" name="run" signature="Sampler.run(circuits, parameter_values=None, **run_options)">
  ...
  <Function id="qiskit.primitives.Sampler.set_options" name="set_options" signature="Sampler.set_options(**fields)">
  ...
  <Attribute id="qiskit.primitives.Sampler.circuits" name="circuits">
  ...
  <Attribute id="qiskit.primitives.Sampler.options" name="options">
  ...
  <Attribute id="qiskit.primitives.Sampler.parameters" name="parameters">
