---
title: GR (v0.39)
description: API reference for qiskit.circuit.library.GR in qiskit v0.39
...
<Class id="qiskit.circuit.library.GR" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.22/qiskit/circuit/library/generalized_gates/gr.py" signature="GR(num_qubits, theta, phi)" modifiers="class">
...
$$
  ...
  *   **phi** (`float`) – angle of rotation axis in xy-plane
  ...
  <Attribute id="qiskit.circuit.library.GR.instances" attributeValue="94" />
