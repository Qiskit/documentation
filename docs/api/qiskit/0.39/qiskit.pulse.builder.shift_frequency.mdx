---
title: shift_frequency (v0.39)
description: API reference for qiskit.pulse.builder.shift_frequency in qiskit v0.39
...
<Function id="qiskit.pulse.builder.shift_frequency" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.22/qiskit/pulse/builder.py" signature="shift_frequency(frequency, channel, name=None)">
