...
`classmethod PulseQobjConfig.from_dict(data)` [GitHub](https://github.com/qiskit/qiskit/tree/stable/0.22/qiskit/qobj/pulse_qobj.py "view source code")
...
`PulseQobjConfig.to_dict()` [GitHub](https://github.com/qiskit/qiskit/tree/stable/0.22/qiskit/qobj/pulse_qobj.py "view source code")
