...
<Class id="qiskit.providers.QubitProperties" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.22/qiskit/providers/backend.py" signature="QubitProperties(t1=None, t2=None, frequency=None)">
  Bases: `object`
