...
`CollectLinearFunctions(*args, **kwargs)` [GitHub](https://github.com/qiskit/qiskit/tree/stable/0.22/qiskit/transpiler/passes/optimization/collect_linear_functions.py "view source code")
