...
<Class id="qiskit.opflow.gradients.NaturalGradient" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.22/qiskit/opflow/gradients/natural_gradient.py" signature="NaturalGradient(grad_method='lin_comb', qfi_method='lin_comb_full', regularization=None, **kwargs)">
  ...
  *   **kwargs** (*dict*) – Optional parameters for a CircuitGradient
  ...
  <Function id="qiskit.opflow.gradients.NaturalGradient.convert" name="convert" signature="NaturalGradient.convert(operator, params=None)">
    **Parameters**
  ...
  <Function id="qiskit.opflow.gradients.NaturalGradient.nat_grad_combo_fn" name="nat_grad_combo_fn" signature="static NaturalGradient.nat_grad_combo_fn(x, regularization=None)">
  ...
  <Attribute id="qiskit.opflow.gradients.NaturalGradient.grad_method" name="grad_method">
  ...
  <Attribute id="qiskit.opflow.gradients.NaturalGradient.qfi_method" name="qfi_method">
    Returns `CircuitQFI`.
  ...
  <Attribute id="qiskit.opflow.gradients.NaturalGradient.regularization" name="regularization">
