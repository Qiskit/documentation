---
title: Backend (v0.39)
description: API reference for qiskit.providers.Backend in qiskit v0.39
...
<Class id="qiskit.providers.Backend" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.22/qiskit/providers/backend.py" signature="Backend" modifiers="class">
  Bases: `object`
