...
description: API reference for qiskit.providers.fake_provider in qiskit v0.39
...
![../\_images/providers\_fake\_provider\_2\_0.png](/docs/images/api/qiskit/0.39/providers_fake_provider_2_0.avif)
