---
title: plot_circuit_layout (v0.39)
description: API reference for qiskit.visualization.plot_circuit_layout in qiskit v0.39
...
<Function id="qiskit.visualization.plot_circuit_layout" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.22/qiskit/visualization/gate_map.py" signature="plot_circuit_layout(circuit, backend, view='virtual', qubit_coordinates=None)">
  ...
  **Example**
  ...
  ![../\_images/qiskit.visualization.plot\_circuit\_layout\_1\_0.png](/docs/images/api/qiskit/0.39/qiskit.visualization.plot_circuit_layout_1_0.avif)
</Function>
