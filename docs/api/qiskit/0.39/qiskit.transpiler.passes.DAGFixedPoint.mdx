---
title: DAGFixedPoint (v0.39)
description: API reference for qiskit.transpiler.passes.DAGFixedPoint in qiskit v0.39
...
<Class id="qiskit.transpiler.passes.DAGFixedPoint" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.22/qiskit/transpiler/passes/utils/dag_fixed_point.py" signature="DAGFixedPoint(*args, **kwargs)" modifiers="class">
