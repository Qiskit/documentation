---
title: name_args (v0.39)
description: API reference for qiskit.utils.name_args in qiskit v0.39
...
<Function id="qiskit.utils.name_args" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.22/qiskit/utils/name_unnamed_args.py" signature="name_args(mapping, skip=0)">
