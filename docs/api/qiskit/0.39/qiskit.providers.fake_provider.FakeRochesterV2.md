...
<span id="qiskit.providers.fake_provider.FakeRochesterV2" />

`FakeRochesterV2` [GitHub](https://github.com/qiskit/qiskit/tree/stable/0.22/qiskit/providers/fake_provider/backends/rochester/fake_rochester.py "view source code")
...
<span id="qiskit.providers.fake_provider.FakeRochesterV2.acquire_channel" />

`FakeRochesterV2.acquire_channel(qubit)`
...
<span id="qiskit.providers.fake_provider.FakeRochesterV2.control_channel" />

`FakeRochesterV2.control_channel(qubits)`
...
<span id="qiskit.providers.fake_provider.FakeRochesterV2.drive_channel" />

`FakeRochesterV2.drive_channel(qubit)`
...
<span id="qiskit.providers.fake_provider.FakeRochesterV2.measure_channel" />

`FakeRochesterV2.measure_channel(qubit)`
...
<span id="qiskit.providers.fake_provider.FakeRochesterV2.qubit_properties" />

`FakeRochesterV2.qubit_properties(qubit)`
...
<span id="qiskit.providers.fake_provider.FakeRochesterV2.run" />

`FakeRochesterV2.run(run_input, **options)`
...
<span id="qiskit.providers.fake_provider.FakeRochesterV2.set_options" />

`FakeRochesterV2.set_options(**fields)`
...
<span id="qiskit.providers.fake_provider.FakeRochesterV2.backend_name" />

### backend\_name

`= 'fake_rochester_v2'`

<span id="qiskit.providers.fake_provider.FakeRochesterV2.conf_filename" />

### conf\_filename

`= 'conf_rochester.json'`

<span id="qiskit.providers.fake_provider.FakeRochesterV2.coupling_map" />

### coupling\_map

Return the [`CouplingMap`](qiskit.transpiler.CouplingMap "qiskit.transpiler.CouplingMap") object

<span id="qiskit.providers.fake_provider.FakeRochesterV2.defs_filename" />

### defs\_filename

`= None`

<span id="qiskit.providers.fake_provider.FakeRochesterV2.dirname" />

### dirname

`= '/home/runner/work/qiskit/qiskit/.tox/docs/lib/python3.8/site-packages/qiskit/providers/fake_provider/backends/rochester'`

<span id="qiskit.providers.fake_provider.FakeRochesterV2.dt" />
...
<span id="qiskit.providers.fake_provider.FakeRochesterV2.dtm" />
...
<span id="qiskit.providers.fake_provider.FakeRochesterV2.instruction_durations" />

### instruction\_durations

Return the [`InstructionDurations`](qiskit.transpiler.InstructionDurations "qiskit.transpiler.InstructionDurations") object.

<span id="qiskit.providers.fake_provider.FakeRochesterV2.instruction_schedule_map" />
...
<span id="qiskit.providers.fake_provider.FakeRochesterV2.instructions" />
...
<span id="qiskit.providers.fake_provider.FakeRochesterV2.max_circuits" />

### max\_circuits

<span id="qiskit.providers.fake_provider.FakeRochesterV2.meas_map" />
...
<span id="qiskit.providers.fake_provider.FakeRochesterV2.num_qubits" />
...
<span id="qiskit.providers.fake_provider.FakeRochesterV2.operation_names" />
...
<span id="qiskit.providers.fake_provider.FakeRochesterV2.operations" />
...
<span id="qiskit.providers.fake_provider.FakeRochesterV2.options" />
...
<span id="qiskit.providers.fake_provider.FakeRochesterV2.props_filename" />

### props\_filename

`= 'props_rochester.json'`

<span id="qiskit.providers.fake_provider.FakeRochesterV2.provider" />
...
<span id="qiskit.providers.fake_provider.FakeRochesterV2.target" />
...
<span id="qiskit.providers.fake_provider.FakeRochesterV2.version" />
