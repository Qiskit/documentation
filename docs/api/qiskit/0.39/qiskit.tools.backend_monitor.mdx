...
<Function id="qiskit.tools.backend_monitor" github="https://github.com/qiskit/qiskit/tree/stable/0.22/qiskit/tools/monitor/overview.py" signature="backend_monitor(backend)">
