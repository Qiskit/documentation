---
title: SNOBFIT (v0.39)
description: API reference for qiskit.algorithms.optimizers.SNOBFIT in qiskit v0.39
...
<Class id="qiskit.algorithms.optimizers.SNOBFIT" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.22/qiskit/algorithms/optimizers/snobfit.py" signature="SNOBFIT(maxiter=1000, maxfail=10, maxmp=None, verbose=False)" modifiers="class">
