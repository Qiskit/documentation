...
<Function id="qiskit.pulse.transforms.block_to_schedule" name="block_to_schedule" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.22/qiskit/pulse/transforms/canonicalization.py" signature="block_to_schedule(block)">
