...
description: API reference for qiskit.algorithms.PhaseEstimation in qiskit v0.39
...
<Class id="qiskit.algorithms.PhaseEstimation" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.22/qiskit/algorithms/phase_estimators/phase_estimation.py" signature="PhaseEstimation(num_evaluation_qubits, quantum_instance=None, sampler=None)" modifiers="class">
...
$$
  ...
  **Raises**
  ...
  <Function id="qiskit.algorithms.PhaseEstimation.estimate" signature="PhaseEstimation.estimate(unitary, state_preparation=None)">
