---
title: FakeBogotaV2 (v0.39)
description: API reference for qiskit.providers.fake_provider.FakeBogotaV2 in qiskit v0.39
...
<Class id="qiskit.providers.fake_provider.FakeBogotaV2" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.22/qiskit/providers/fake_provider/backends/bogota/fake_bogota.py" signature="FakeBogotaV2" modifiers="class">
