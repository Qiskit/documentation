---
title: RZGate (v0.39)
description: API reference for qiskit.circuit.library.RZGate in qiskit v0.39
...
<Class id="qiskit.circuit.library.RZGate" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.22/qiskit/circuit/library/standard_gates/rz.py" signature="RZGate(phi, label=None)" modifiers="class">
