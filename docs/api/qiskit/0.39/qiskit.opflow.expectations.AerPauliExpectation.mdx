---
title: AerPauliExpectation (v0.39)
description: API reference for qiskit.opflow.expectations.AerPauliExpectation in qiskit v0.39
...
<Class id="qiskit.opflow.expectations.AerPauliExpectation" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.22/qiskit/opflow/expectations/aer_pauli_expectation.py" signature="AerPauliExpectation" modifiers="class">
