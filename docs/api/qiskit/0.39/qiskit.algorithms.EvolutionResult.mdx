---
title: EvolutionResult (v0.39)
description: API reference for qiskit.algorithms.EvolutionResult in qiskit v0.39
...
<Class id="qiskit.algorithms.EvolutionResult" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.22/qiskit/algorithms/evolvers/evolution_result.py" signature="EvolutionResult(evolved_state, aux_ops_evaluated=None)" modifiers="class">
