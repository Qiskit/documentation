...
<Class id="qiskit.providers.BackendV2Converter" github="https://github.com/qiskit/qiskit/tree/stable/0.22/qiskit/providers/backend_compat.py" signature="BackendV2Converter(backend, name_mapping=None, add_delay=False)">
