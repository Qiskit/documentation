---
title: BackendV2Converter (v0.39)
description: API reference for qiskit.providers.BackendV2Converter in qiskit v0.39
...
<Class id="qiskit.providers.BackendV2Converter" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.22/qiskit/providers/backend_compat.py" signature="BackendV2Converter(backend, name_mapping=None, add_delay=False)" modifiers="class">
