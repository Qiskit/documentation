...
<Function id="qiskit.converters.dagdependency_to_circuit" name="dagdependency_to_circuit" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.22/qiskit/converters/dagdependency_to_circuit.py" signature="dagdependency_to_circuit(dagdependency)">
