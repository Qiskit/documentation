---
title: DictStateFn (v0.39)
description: API reference for qiskit.opflow.state_fns.DictStateFn in qiskit v0.39
...
<Class id="qiskit.opflow.state_fns.DictStateFn" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.22/qiskit/opflow/state_fns/dict_state_fn.py" signature="DictStateFn(primitive=None, coeff=1.0, is_measurement=False, from_operator=False)" modifiers="class">
