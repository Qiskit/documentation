---
title: SetFrequency (v0.39)
description: API reference for qiskit.pulse.instructions.SetFrequency in qiskit v0.39
...
<Class id="qiskit.pulse.instructions.SetFrequency" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.22/qiskit/pulse/instructions/frequency.py" signature="SetFrequency(frequency, channel, name=None)" modifiers="class">
