...
`FakeValenciaV2` [GitHub](https://github.com/qiskit/qiskit/tree/stable/0.22/qiskit/providers/fake_provider/backends/valencia/fake_valencia.py "view source code")
...
<span id="qiskit.providers.fake_provider.FakeValenciaV2.acquire_channel" />

`FakeValenciaV2.acquire_channel(qubit)`
...
<span id="qiskit.providers.fake_provider.FakeValenciaV2.control_channel" />

`FakeValenciaV2.control_channel(qubits)`
...
<span id="qiskit.providers.fake_provider.FakeValenciaV2.drive_channel" />

`FakeValenciaV2.drive_channel(qubit)`
...
<span id="qiskit.providers.fake_provider.FakeValenciaV2.measure_channel" />

`FakeValenciaV2.measure_channel(qubit)`
...
<span id="qiskit.providers.fake_provider.FakeValenciaV2.qubit_properties" />

`FakeValenciaV2.qubit_properties(qubit)`
...
<span id="qiskit.providers.fake_provider.FakeValenciaV2.run" />

`FakeValenciaV2.run(run_input, **options)`
...
<span id="qiskit.providers.fake_provider.FakeValenciaV2.set_options" />

`FakeValenciaV2.set_options(**fields)`
...
<span id="qiskit.providers.fake_provider.FakeValenciaV2.backend_name" />

### backend\_name

`= 'fake_valencia_v2'`

<span id="qiskit.providers.fake_provider.FakeValenciaV2.conf_filename" />

### conf\_filename

`= 'conf_valencia.json'`

<span id="qiskit.providers.fake_provider.FakeValenciaV2.coupling_map" />

### coupling\_map

Return the [`CouplingMap`](qiskit.transpiler.CouplingMap "qiskit.transpiler.CouplingMap") object

<span id="qiskit.providers.fake_provider.FakeValenciaV2.defs_filename" />

### defs\_filename

`= 'defs_valencia.json'`

<span id="qiskit.providers.fake_provider.FakeValenciaV2.dirname" />

### dirname

`= '/home/runner/work/qiskit/qiskit/.tox/docs/lib/python3.8/site-packages/qiskit/providers/fake_provider/backends/valencia'`

<span id="qiskit.providers.fake_provider.FakeValenciaV2.dt" />
...
<span id="qiskit.providers.fake_provider.FakeValenciaV2.dtm" />
...
<span id="qiskit.providers.fake_provider.FakeValenciaV2.instruction_durations" />

### instruction\_durations

Return the [`InstructionDurations`](qiskit.transpiler.InstructionDurations "qiskit.transpiler.InstructionDurations") object.

<span id="qiskit.providers.fake_provider.FakeValenciaV2.instruction_schedule_map" />
...
<span id="qiskit.providers.fake_provider.FakeValenciaV2.instructions" />
...
<span id="qiskit.providers.fake_provider.FakeValenciaV2.max_circuits" />

### max\_circuits

<span id="qiskit.providers.fake_provider.FakeValenciaV2.meas_map" />
...
<span id="qiskit.providers.fake_provider.FakeValenciaV2.num_qubits" />
...
<span id="qiskit.providers.fake_provider.FakeValenciaV2.operation_names" />
...
<span id="qiskit.providers.fake_provider.FakeValenciaV2.operations" />
...
<span id="qiskit.providers.fake_provider.FakeValenciaV2.options" />
...
<span id="qiskit.providers.fake_provider.FakeValenciaV2.props_filename" />

### props\_filename

`= 'props_valencia.json'`

<span id="qiskit.providers.fake_provider.FakeValenciaV2.provider" />
...
<span id="qiskit.providers.fake_provider.FakeValenciaV2.target" />
...
<span id="qiskit.providers.fake_provider.FakeValenciaV2.version" />
