...
<Class id="qiskit.primitives.BaseEstimator" github="https://github.com/qiskit/qiskit/tree/stable/0.22/qiskit/primitives/base/base_estimator.py" signature="BaseEstimator(circuits: Iterable[QuantumCircuit] | QuantumCircuit | None = None, observables: Iterable[SparsePauliOp] | SparsePauliOp | None = None, parameters: Iterable[Iterable[Parameter]] | None = None, **kwargs)">
  ...
  **ValueError** – For mismatch of circuits and parameters list.
  ...
  <Function id="qiskit.primitives.BaseEstimator.close" name="close" signature="BaseEstimator.close()">
    Close the session and free resources
  </Function>

  ### run

  <Function id="qiskit.primitives.BaseEstimator.run" name="run" signature="BaseEstimator.run(circuits, observables, parameter_values=None, **run_options)">
  ...
  <Function id="qiskit.primitives.BaseEstimator.set_options" name="set_options" signature="BaseEstimator.set_options(**fields)">
  ...
  <Attribute id="qiskit.primitives.BaseEstimator.circuits" name="circuits">
  ...
  <Attribute id="qiskit.primitives.BaseEstimator.observables" name="observables">
  ...
  <Attribute id="qiskit.primitives.BaseEstimator.options" name="options">
  ...
  <Attribute id="qiskit.primitives.BaseEstimator.parameters" name="parameters">
