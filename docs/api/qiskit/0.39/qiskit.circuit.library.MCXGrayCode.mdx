---
title: MCXGrayCode (v0.39)
description: API reference for qiskit.circuit.library.MCXGrayCode in qiskit v0.39
...
<Class id="qiskit.circuit.library.MCXGrayCode" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.22/qiskit/circuit/library/standard_gates/x.py" signature="MCXGrayCode(num_ctrl_qubits, label=None, ctrl_state=None)" modifiers="class">
