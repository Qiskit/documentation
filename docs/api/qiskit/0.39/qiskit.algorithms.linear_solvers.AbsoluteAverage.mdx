...
<Class id="qiskit.algorithms.linear_solvers.AbsoluteAverage" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.22/qiskit/algorithms/linear_solvers/observables/absolute_average.py" signature="AbsoluteAverage">
  ...
  **Examples**
  ...
  <Function id="qiskit.algorithms.linear_solvers.AbsoluteAverage.evaluate_classically" name="evaluate_classically" signature="AbsoluteAverage.evaluate_classically(solution)">
  ...
  <Function id="qiskit.algorithms.linear_solvers.AbsoluteAverage.observable" name="observable" signature="AbsoluteAverage.observable(num_qubits)">
  ...
  <Function id="qiskit.algorithms.linear_solvers.AbsoluteAverage.observable_circuit" name="observable_circuit" signature="AbsoluteAverage.observable_circuit(num_qubits)">
  ...
  <Function id="qiskit.algorithms.linear_solvers.AbsoluteAverage.post_processing" name="post_processing" signature="AbsoluteAverage.post_processing(solution, num_qubits, scaling=1)">
