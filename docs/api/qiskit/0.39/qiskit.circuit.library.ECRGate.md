...
`ECRGate` [GitHub](https://github.com/qiskit/qiskit/tree/stable/0.22/qiskit/circuit/library/standard_gates/ecr.py "view source code")
...
`ECRGate.to_matrix()` [GitHub](https://github.com/qiskit/qiskit/tree/stable/0.22/qiskit/circuit/library/standard_gates/ecr.py "view source code")
