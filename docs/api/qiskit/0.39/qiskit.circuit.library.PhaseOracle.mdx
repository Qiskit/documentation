...
<Class id="qiskit.circuit.library.PhaseOracle" github="https://github.com/qiskit/qiskit/tree/stable/0.22/qiskit/circuit/library/phase_oracle.py" signature="PhaseOracle(expression, synthesizer=None)">
