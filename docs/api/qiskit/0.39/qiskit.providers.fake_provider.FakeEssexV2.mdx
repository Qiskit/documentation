...
<span id="qiskit.providers.fake_provider.FakeEssexV2" />

`FakeEssexV2` [GitHub](https://github.com/qiskit/qiskit/tree/stable/0.22/qiskit/providers/fake_provider/backends/essex/fake_essex.py "view source code")
...
<span id="qiskit.providers.fake_provider.FakeEssexV2.acquire_channel" />

`FakeEssexV2.acquire_channel(qubit)`
...
<span id="qiskit.providers.fake_provider.FakeEssexV2.control_channel" />

`FakeEssexV2.control_channel(qubits)`
...
<span id="qiskit.providers.fake_provider.FakeEssexV2.drive_channel" />

`FakeEssexV2.drive_channel(qubit)`
...
<span id="qiskit.providers.fake_provider.FakeEssexV2.measure_channel" />

`FakeEssexV2.measure_channel(qubit)`
...
<span id="qiskit.providers.fake_provider.FakeEssexV2.qubit_properties" />

`FakeEssexV2.qubit_properties(qubit)`
...
<span id="qiskit.providers.fake_provider.FakeEssexV2.run" />

`FakeEssexV2.run(run_input, **options)`
...
<span id="qiskit.providers.fake_provider.FakeEssexV2.set_options" />

`FakeEssexV2.set_options(**fields)`
...
<span id="qiskit.providers.fake_provider.FakeEssexV2.backend_name" />

### backend\_name

`= 'fake_essex_v2'`

<span id="qiskit.providers.fake_provider.FakeEssexV2.conf_filename" />

### conf\_filename

`= 'conf_essex.json'`

<span id="qiskit.providers.fake_provider.FakeEssexV2.coupling_map" />

### coupling\_map

Return the [`CouplingMap`](qiskit.transpiler.CouplingMap "qiskit.transpiler.CouplingMap") object

<span id="qiskit.providers.fake_provider.FakeEssexV2.defs_filename" />

### defs\_filename

`= None`

<span id="qiskit.providers.fake_provider.FakeEssexV2.dirname" />

### dirname

`= '/home/runner/work/qiskit/qiskit/.tox/docs/lib/python3.8/site-packages/qiskit/providers/fake_provider/backends/essex'`

<span id="qiskit.providers.fake_provider.FakeEssexV2.dt" />
...
<span id="qiskit.providers.fake_provider.FakeEssexV2.dtm" />
...
<span id="qiskit.providers.fake_provider.FakeEssexV2.instruction_durations" />

### instruction\_durations

Return the [`InstructionDurations`](qiskit.transpiler.InstructionDurations "qiskit.transpiler.InstructionDurations") object.

<span id="qiskit.providers.fake_provider.FakeEssexV2.instruction_schedule_map" />
...
<span id="qiskit.providers.fake_provider.FakeEssexV2.instructions" />
...
<span id="qiskit.providers.fake_provider.FakeEssexV2.max_circuits" />

### max\_circuits

<span id="qiskit.providers.fake_provider.FakeEssexV2.meas_map" />
...
<span id="qiskit.providers.fake_provider.FakeEssexV2.num_qubits" />
...
<span id="qiskit.providers.fake_provider.FakeEssexV2.operation_names" />
...
<span id="qiskit.providers.fake_provider.FakeEssexV2.operations" />
...
<span id="qiskit.providers.fake_provider.FakeEssexV2.options" />
...
<span id="qiskit.providers.fake_provider.FakeEssexV2.props_filename" />

### props\_filename

`= 'props_essex.json'`

<span id="qiskit.providers.fake_provider.FakeEssexV2.provider" />
...
<span id="qiskit.providers.fake_provider.FakeEssexV2.target" />
...
<span id="qiskit.providers.fake_provider.FakeEssexV2.version" />
