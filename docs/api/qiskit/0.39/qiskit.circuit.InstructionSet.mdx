---
title: InstructionSet (v0.39)
description: API reference for qiskit.circuit.InstructionSet in qiskit v0.39
...
<Class id="qiskit.circuit.InstructionSet" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.22/qiskit/circuit/instructionset.py" signature="InstructionSet(circuit_cregs=None, *, resource_requester=None)" modifiers="class">
  Bases: `object`
