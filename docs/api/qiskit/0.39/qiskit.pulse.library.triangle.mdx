---
title: triangle (v0.39)
description: API reference for qiskit.pulse.library.triangle in qiskit v0.39
...
$$
  ...
  **Example**
  ...
  ![../\_images/qiskit.pulse.library.triangle\_0\_1.png](/docs/images/api/qiskit/0.39/qiskit.pulse.library.triangle_0_1.avif)
