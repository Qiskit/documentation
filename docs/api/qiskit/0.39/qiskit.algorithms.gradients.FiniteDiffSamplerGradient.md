...
`FiniteDiffSamplerGradient(sampler, epsilon, **options)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.22/qiskit/algorithms/gradients/finite_diff_sampler_gradient.py "view source code")
