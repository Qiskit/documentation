---
title: ShiftFrequency (v0.39)
description: API reference for qiskit.pulse.instructions.ShiftFrequency in qiskit v0.39
...
<Class id="qiskit.pulse.instructions.ShiftFrequency" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.22/qiskit/pulse/instructions/frequency.py" signature="ShiftFrequency(frequency, channel, name=None)" modifiers="class">
