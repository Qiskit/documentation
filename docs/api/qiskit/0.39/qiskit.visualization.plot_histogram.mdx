...
<Function id="qiskit.visualization.plot_histogram" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.22/qiskit/visualization/counts_visualization.py" signature="plot_histogram(data, figsize=(7, 5), color=None, number_to_keep=None, sort='asc', target_string=None, legend=None, bar_labels=True, title=None, ax=None, filename=None)">
  ...
  **Examples**
  ...
  ![../\_images/qiskit.visualization.plot\_histogram\_0\_0.png](/images/api/qiskit/0.39/qiskit.visualization.plot_histogram_0_0.png)
  ...
  ![../\_images/qiskit.visualization.plot\_histogram\_1\_0.png](/images/api/qiskit/0.39/qiskit.visualization.plot_histogram_1_0.png) ![../\_images/qiskit.visualization.plot\_histogram\_1\_1.png](/images/api/qiskit/0.39/qiskit.visualization.plot_histogram_1_1.png)
</Function>
