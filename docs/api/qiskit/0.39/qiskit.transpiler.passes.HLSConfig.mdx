...
<Class id="qiskit.transpiler.passes.HLSConfig" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.22/qiskit/transpiler/passes/synthesis/high_level_synthesis.py" signature="HLSConfig(use_default_on_unspecified=True, **kwargs)">
  Bases: `object`
  ...
  *   **kwargs** – a dictionary mapping higher-level-objects to lists of synthesis methods.
  ...
  <Function id="qiskit.transpiler.passes.HLSConfig.set_methods" name="set_methods" signature="HLSConfig.set_methods(hls_name, hls_methods)">
