...
<Class id="qiskit.transpiler.passes.HLSConfig" github="https://github.com/qiskit/qiskit/tree/stable/0.22/qiskit/transpiler/passes/synthesis/high_level_synthesis.py" signature="HLSConfig(use_default_on_unspecified=True, **kwargs)">
  Bases: `object`
