---
title: QuantumRegister (v0.39)
description: API reference for qiskit.circuit.QuantumRegister in qiskit v0.39
...
<Class id="qiskit.circuit.QuantumRegister" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.22/qiskit/circuit/quantumregister.py" signature="QuantumRegister(size=None, name=None, bits=None)" modifiers="class">
