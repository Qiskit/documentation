---
title: Barrier (v0.39)
description: API reference for qiskit.circuit.library.Barrier in qiskit v0.39
...
<Class id="qiskit.circuit.library.Barrier" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.22/qiskit/circuit/barrier.py" signature="Barrier(num_qubits, label=None)" modifiers="class">
