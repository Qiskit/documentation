---
title: Hessian (v0.39)
description: API reference for qiskit.opflow.gradients.Hessian in qiskit v0.39
...
<Class id="qiskit.opflow.gradients.Hessian" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.22/qiskit/opflow/gradients/hessian.py" signature="Hessian(hess_method='param_shift', **kwargs)" modifiers="class">
