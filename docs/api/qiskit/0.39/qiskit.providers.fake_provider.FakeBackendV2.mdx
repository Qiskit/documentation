...
<Class id="qiskit.providers.fake_provider.FakeBackendV2" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.22/qiskit/providers/fake_provider/fake_backend_v2.py" signature="FakeBackendV2">
