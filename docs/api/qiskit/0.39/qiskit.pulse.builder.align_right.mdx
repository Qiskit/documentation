---
title: align_right (v0.39)
description: API reference for qiskit.pulse.builder.align_right in qiskit v0.39
...
<Function id="qiskit.pulse.builder.align_right" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.22/qiskit/pulse/builder.py" signature="align_right()">
