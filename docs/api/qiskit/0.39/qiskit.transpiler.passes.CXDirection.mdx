---
title: CXDirection (v0.39)
description: API reference for qiskit.transpiler.passes.CXDirection in qiskit v0.39
...
<Class id="qiskit.transpiler.passes.CXDirection" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.22/qiskit/transpiler/passes/utils/cx_direction.py" signature="CXDirection(*args, **kwargs)" modifiers="class">
