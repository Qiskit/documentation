...
<Class id="qiskit.opflow.evolutions.MatrixEvolution" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.22/qiskit/opflow/evolutions/matrix_evolution.py" signature="MatrixEvolution">
  ...
  <Function id="qiskit.opflow.evolutions.MatrixEvolution.convert" name="convert" signature="MatrixEvolution.convert(operator)">
