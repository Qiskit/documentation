...
<Class id="qiskit.transpiler.passes.RemoveFinalMeasurements" github="https://github.com/qiskit/qiskit/tree/stable/0.22/qiskit/transpiler/passes/utils/remove_final_measurements.py" signature="RemoveFinalMeasurements(*args, **kwargs)">
