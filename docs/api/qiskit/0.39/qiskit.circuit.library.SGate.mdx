---
title: SGate (v0.39)
description: API reference for qiskit.circuit.library.SGate in qiskit v0.39
...
<Class id="qiskit.circuit.library.SGate" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.22/qiskit/circuit/library/standard_gates/s.py" signature="SGate(label=None)" modifiers="class">
