...
<Class id="qiskit.transpiler.passes.synthesis.plugin.UnitarySynthesisPluginManager" github="https://github.com/qiskit/qiskit/tree/stable/0.22/qiskit/transpiler/passes/synthesis/plugin.py" signature="UnitarySynthesisPluginManager">
  Bases: `object`
