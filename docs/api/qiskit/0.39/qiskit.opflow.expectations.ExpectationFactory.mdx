---
title: ExpectationFactory (v0.39)
description: API reference for qiskit.opflow.expectations.ExpectationFactory in qiskit v0.39
...
<Class id="qiskit.opflow.expectations.ExpectationFactory" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.22/qiskit/opflow/expectations/expectation_factory.py" signature="ExpectationFactory" modifiers="class">
  Bases: `object`
