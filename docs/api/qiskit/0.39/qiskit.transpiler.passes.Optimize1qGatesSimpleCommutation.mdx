...
<Class id="qiskit.transpiler.passes.Optimize1qGatesSimpleCommutation" github="https://github.com/qiskit/qiskit/tree/stable/0.22/qiskit/transpiler/passes/optimization/optimize_1q_commutation.py" signature="Optimize1qGatesSimpleCommutation(*args, **kwargs)">
