---
title: MCMT (v0.39)
description: API reference for qiskit.circuit.library.MCMT in qiskit v0.39
...
<Class id="qiskit.circuit.library.MCMT" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.22/qiskit/circuit/library/generalized_gates/mcmt.py" signature="MCMT(gate, num_ctrl_qubits, num_target_qubits, label=None)" modifiers="class">
  ...
  *   **AttributeError** – If the number of controls or targets is 0.
  ...
  <Attribute id="qiskit.circuit.library.MCMT.instances" attributeValue="94" />
