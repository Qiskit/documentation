...
`IQP(interactions)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.22/qiskit/circuit/library/iqp.py "view source code")
...
![../\_images/qiskit.circuit.library.IQP\_0\_0.png](/images/api/qiskit/0.39/qiskit.circuit.library.IQP_0_0.png)
