---
title: AlgorithmJob (v0.39)
description: API reference for qiskit.algorithms.AlgorithmJob in qiskit v0.39
...
<Class id="qiskit.algorithms.AlgorithmJob" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.22/qiskit/algorithms/algorithm_job.py" signature="AlgorithmJob(function, *args, **kwargs)" modifiers="class">
