...
<Class id="qiskit.quantum_info.XXDecomposer" github="https://github.com/qiskit/qiskit/tree/stable/0.22/qiskit/quantum_info/synthesis/xx_decompose/decomposer.py" signature="XXDecomposer(euler_basis='U', embodiments=None, backup_optimizer=None)">
  Bases: `object`
