---
title: CheckCXDirection (v0.39)
description: API reference for qiskit.transpiler.passes.CheckCXDirection in qiskit v0.39
...
<Class id="qiskit.transpiler.passes.CheckCXDirection" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.22/qiskit/transpiler/passes/utils/check_cx_direction.py" signature="CheckCXDirection(*args, **kwargs)" modifiers="class">
