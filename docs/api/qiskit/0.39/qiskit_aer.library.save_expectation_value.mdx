---
title: save_expectation_value (v0.39)
description: API reference for qiskit_aer.library.save_expectation_value in qiskit v0.39
in_page_toc_min_heading_level: 1
python_api_type: function
python_api_name: qiskit_aer.library.save_expectation_value
---

<span id="qiskit-aer-library-save-expectation-value" />
