---
title: GradientBase (v0.39)
description: API reference for qiskit.opflow.gradients.GradientBase in qiskit v0.39
...
<Class id="qiskit.opflow.gradients.GradientBase" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.22/qiskit/opflow/gradients/gradient_base.py" signature="GradientBase(grad_method='param_shift', **kwargs)" modifiers="class">
