...
<Class id="qiskit.algorithms.linear_solvers.NumPyLinearSolver" github="https://github.com/qiskit/qiskit/tree/stable/0.22/qiskit/algorithms/linear_solvers/numpy_linear_solver.py" signature="NumPyLinearSolver">
