...
<Class id="qiskit.algorithms.optimizers.Minimizer" github="https://github.com/qiskit/qiskit/tree/stable/0.22/qiskit/algorithms/optimizers/optimizer.py" signature="Minimizer(*args, **kwargs)">
  Bases: `Protocol`
