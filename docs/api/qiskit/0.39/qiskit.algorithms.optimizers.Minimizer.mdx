---
title: Minimizer (v0.39)
description: API reference for qiskit.algorithms.optimizers.Minimizer in qiskit v0.39
...
<Class id="qiskit.algorithms.optimizers.Minimizer" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.22/qiskit/algorithms/optimizers/optimizer.py" signature="Minimizer(*args, **kwargs)" modifiers="class">
  Bases: `Protocol`
