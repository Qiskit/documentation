...
<Class id="qiskit_aer.noise.NoiseModel" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-aer/tree/stable/0.11/qiskit_aer/noise/noise_model.py" signature="NoiseModel(basis_gates=None)">
  Bases: `object`
  ...
  **basis\_gates** (*list\[str] or None*) – Specify an initial basis\_gates for the noise model. If None a default value of \[‘id’, ‘rz’, ‘sx’, ‘cx’] is used (Default: None).
  ...
  <Function id="qiskit_aer.noise.NoiseModel.add_all_qubit_quantum_error" name="add_all_qubit_quantum_error" signature="NoiseModel.add_all_qubit_quantum_error(error, instructions, warnings=True)">
  ...
  <Function id="qiskit_aer.noise.NoiseModel.add_all_qubit_readout_error" name="add_all_qubit_readout_error" signature="NoiseModel.add_all_qubit_readout_error(error, warnings=True)">
  ...
  <Function id="qiskit_aer.noise.NoiseModel.add_basis_gates" name="add_basis_gates" signature="NoiseModel.add_basis_gates(instructions, warnings=False)">
  ...
  <Function id="qiskit_aer.noise.NoiseModel.add_nonlocal_quantum_error" name="add_nonlocal_quantum_error" signature="NoiseModel.add_nonlocal_quantum_error(error, instructions, qubits, noise_qubits, warnings=True)">
  ...
  <Function id="qiskit_aer.noise.NoiseModel.add_quantum_error" name="add_quantum_error" signature="NoiseModel.add_quantum_error(error, instructions, qubits, warnings=True)">
  ...
  <Function id="qiskit_aer.noise.NoiseModel.add_readout_error" name="add_readout_error" signature="NoiseModel.add_readout_error(error, qubits, warnings=True)">
  ...
  <Function id="qiskit_aer.noise.NoiseModel.from_backend" name="from_backend" signature="classmethod NoiseModel.from_backend(backend, gate_error=True, readout_error=True, thermal_relaxation=True, temperature=0, gate_lengths=None, gate_length_units='ns', standard_gates=None, warnings=None)">
  ...
  <Function id="qiskit_aer.noise.NoiseModel.from_dict" name="from_dict" signature="static NoiseModel.from_dict(noise_dict)">
  ...
  <Function id="qiskit_aer.noise.NoiseModel.is_ideal" name="is_ideal" signature="NoiseModel.is_ideal()">
    Return True if the noise model has no noise terms.
  </Function>

  ### reset

  <Function id="qiskit_aer.noise.NoiseModel.reset" name="reset" signature="NoiseModel.reset()">
    Reset the noise model.
  </Function>

  ### to\_dict

  <Function id="qiskit_aer.noise.NoiseModel.to_dict" name="to_dict" signature="NoiseModel.to_dict(serializable=False)">
  ...
  <Attribute id="qiskit_aer.noise.NoiseModel.basis_gates" name="basis_gates">
    Return basis\_gates for compiling to the noise model.
  </Attribute>

  ### noise\_instructions

  <Attribute id="qiskit_aer.noise.NoiseModel.noise_instructions" name="noise_instructions">
    Return the set of noisy instructions for this noise model.
  </Attribute>

  ### noise\_qubits

  <Attribute id="qiskit_aer.noise.NoiseModel.noise_qubits" name="noise_qubits">
