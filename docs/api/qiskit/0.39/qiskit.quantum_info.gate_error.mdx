---
title: gate_error (v0.39)
description: API reference for qiskit.quantum_info.gate_error in qiskit v0.39
...
<Function id="qiskit.quantum_info.gate_error" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.22/qiskit/quantum_info/operators/measures.py" signature="gate_error(channel, target=None, require_cp=True, require_tp=False)">
