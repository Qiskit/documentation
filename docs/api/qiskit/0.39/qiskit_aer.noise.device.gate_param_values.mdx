---
title: gate_param_values (v0.39)
description: API reference for qiskit_aer.noise.device.gate_param_values in qiskit v0.39
in_page_toc_min_heading_level: 1
python_api_type: function
python_api_name: qiskit_aer.noise.device.gate_param_values
---

<span id="qiskit-aer-noise-device-gate-param-values" />

# qiskit\_aer.noise.device.gate\_param\_values

<Function id="qiskit_aer.noise.device.gate_param_values" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-aer/tree/stable/0.11/qiskit_aer/noise/device/parameters.py" signature="gate_param_values(properties)">
