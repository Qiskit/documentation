---
title: Commuting2qGateRouter (v0.39)
description: API reference for qiskit.transpiler.passes.Commuting2qGateRouter in qiskit v0.39
...
<Class id="qiskit.transpiler.passes.Commuting2qGateRouter" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.22/qiskit/transpiler/passes/routing/commuting_2q_gate_routing/commuting_2q_gate_router.py" signature="Commuting2qGateRouter(swap_strategy=None, edge_coloring=None)" modifiers="class">
