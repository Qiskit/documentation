...
<span id="qiskit.providers.fake_provider.FakeArmonkV2" />

`FakeArmonkV2` [GitHub](https://github.com/qiskit/qiskit/tree/stable/0.22/qiskit/providers/fake_provider/backends/armonk/fake_armonk.py "view source code")
...
<span id="qiskit.providers.fake_provider.FakeArmonkV2.acquire_channel" />

`FakeArmonkV2.acquire_channel(qubit)`
...
<span id="qiskit.providers.fake_provider.FakeArmonkV2.control_channel" />

`FakeArmonkV2.control_channel(qubits)`
...
<span id="qiskit.providers.fake_provider.FakeArmonkV2.drive_channel" />

`FakeArmonkV2.drive_channel(qubit)`
...
<span id="qiskit.providers.fake_provider.FakeArmonkV2.measure_channel" />

`FakeArmonkV2.measure_channel(qubit)`
...
<span id="qiskit.providers.fake_provider.FakeArmonkV2.qubit_properties" />

`FakeArmonkV2.qubit_properties(qubit)`
...
<span id="qiskit.providers.fake_provider.FakeArmonkV2.run" />

`FakeArmonkV2.run(run_input, **options)`
...
<span id="qiskit.providers.fake_provider.FakeArmonkV2.set_options" />

`FakeArmonkV2.set_options(**fields)`
...
<span id="qiskit.providers.fake_provider.FakeArmonkV2.backend_name" />

### backend\_name

`= 'fake_armonk_v2'`

<span id="qiskit.providers.fake_provider.FakeArmonkV2.conf_filename" />

### conf\_filename

`= 'conf_armonk.json'`

<span id="qiskit.providers.fake_provider.FakeArmonkV2.coupling_map" />

### coupling\_map

Return the [`CouplingMap`](qiskit.transpiler.CouplingMap "qiskit.transpiler.CouplingMap") object

<span id="qiskit.providers.fake_provider.FakeArmonkV2.defs_filename" />

### defs\_filename

`= 'defs_armonk.json'`

<span id="qiskit.providers.fake_provider.FakeArmonkV2.dirname" />

### dirname

`= '/home/runner/work/qiskit/qiskit/.tox/docs/lib/python3.8/site-packages/qiskit/providers/fake_provider/backends/armonk'`

<span id="qiskit.providers.fake_provider.FakeArmonkV2.dt" />
...
<span id="qiskit.providers.fake_provider.FakeArmonkV2.dtm" />
...
<span id="qiskit.providers.fake_provider.FakeArmonkV2.instruction_durations" />

### instruction\_durations

Return the [`InstructionDurations`](qiskit.transpiler.InstructionDurations "qiskit.transpiler.InstructionDurations") object.

<span id="qiskit.providers.fake_provider.FakeArmonkV2.instruction_schedule_map" />
...
<span id="qiskit.providers.fake_provider.FakeArmonkV2.instructions" />
...
<span id="qiskit.providers.fake_provider.FakeArmonkV2.max_circuits" />

### max\_circuits

<span id="qiskit.providers.fake_provider.FakeArmonkV2.meas_map" />
...
<span id="qiskit.providers.fake_provider.FakeArmonkV2.num_qubits" />
...
<span id="qiskit.providers.fake_provider.FakeArmonkV2.operation_names" />
...
<span id="qiskit.providers.fake_provider.FakeArmonkV2.operations" />
...
<span id="qiskit.providers.fake_provider.FakeArmonkV2.options" />
...
<span id="qiskit.providers.fake_provider.FakeArmonkV2.props_filename" />

### props\_filename

`= 'props_armonk.json'`

<span id="qiskit.providers.fake_provider.FakeArmonkV2.provider" />
...
<span id="qiskit.providers.fake_provider.FakeArmonkV2.target" />
...
<span id="qiskit.providers.fake_provider.FakeArmonkV2.version" />
