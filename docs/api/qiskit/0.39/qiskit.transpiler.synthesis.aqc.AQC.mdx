---
title: AQC (v0.39)
description: API reference for qiskit.transpiler.synthesis.aqc.AQC in qiskit v0.39
...
<Class id="qiskit.transpiler.synthesis.aqc.AQC" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.22/qiskit/transpiler/synthesis/aqc/aqc.py" signature="AQC(optimizer=None, seed=None)" modifiers="class">
  Bases: `object`
