...
<Class id="qiskit.algorithms.ImaginaryTimeEvolver" github="https://github.com/qiskit/qiskit/tree/stable/0.22/qiskit/algorithms/time_evolvers/imaginary_time_evolver.py" signature="ImaginaryTimeEvolver">
  Bases: `abc.ABC`
