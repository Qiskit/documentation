---
title: GRZ (v0.39)
description: API reference for qiskit.circuit.library.GRZ in qiskit v0.39
...
<Class id="qiskit.circuit.library.GRZ" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.22/qiskit/circuit/library/generalized_gates/gr.py" signature="GRZ(num_qubits, phi)" modifiers="class">
...
$$
  ...
  *   **phi** (`float`) – rotation angle about z-axis
  ...
  <Attribute id="qiskit.circuit.library.GRZ.instances" attributeValue="94" />
