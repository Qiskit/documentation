...
<Class id="qiskit.transpiler.passes.TrivialLayout" github="https://github.com/qiskit/qiskit/tree/stable/0.22/qiskit/transpiler/passes/layout/trivial_layout.py" signature="TrivialLayout(*args, **kwargs)">
