---
title: QasmExperimentCalibrations (v0.39)
description: API reference for qiskit.qobj.QasmExperimentCalibrations in qiskit v0.39
...
<Class id="qiskit.qobj.QasmExperimentCalibrations" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.22/qiskit/qobj/qasm_qobj.py" signature="QasmExperimentCalibrations(gates)" modifiers="class">
  Bases: `object`
