---
title: evolutions (v0.39)
description: API reference for qiskit.opflow.evolutions in qiskit v0.39
...
| [`QDrift`](qiskit.opflow.evolutions.QDrift "qiskit.opflow.evolutions.QDrift")(\[reps])                                       | The QDrift Trotterization method, which selects each term in the Trotterization randomly, with a probability proportional to its weight.                                          |
