---
title: MCXGate (v0.39)
description: API reference for qiskit.circuit.library.MCXGate in qiskit v0.39
...
<Class id="qiskit.circuit.library.MCXGate" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.22/qiskit/circuit/library/standard_gates/x.py" signature="MCXGate(num_ctrl_qubits, label=None, ctrl_state=None, _name='mcx')" modifiers="class">
