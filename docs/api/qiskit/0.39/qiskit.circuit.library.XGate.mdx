---
title: XGate (v0.39)
description: API reference for qiskit.circuit.library.XGate in qiskit v0.39
...
<Class id="qiskit.circuit.library.XGate" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.22/qiskit/circuit/library/standard_gates/x.py" signature="XGate(label=None)" modifiers="class">
