---
title: OperatorBase (v0.39)
description: API reference for qiskit.opflow.OperatorBase in qiskit v0.39
...
<Class id="qiskit.opflow.OperatorBase" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.22/qiskit/opflow/operator_base.py" signature="OperatorBase" modifiers="class">
