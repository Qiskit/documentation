---
title: BaseStateFidelity (v0.39)
description: API reference for qiskit.algorithms.state_fidelities.BaseStateFidelity in qiskit v0.39
...
<Class id="qiskit.algorithms.state_fidelities.BaseStateFidelity" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.22/qiskit/algorithms/state_fidelities/base_state_fidelity.py" signature="BaseStateFidelity" modifiers="class">
  Bases: `abc.ABC`
