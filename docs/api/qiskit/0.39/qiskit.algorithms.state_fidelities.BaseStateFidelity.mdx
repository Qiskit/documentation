...
$$
  ...
  <Function id="qiskit.algorithms.state_fidelities.BaseStateFidelity.create_fidelity_circuit" signature="abstract BaseStateFidelity.create_fidelity_circuit(circuit_1, circuit_2)">
