---
title: cx (v0.39)
description: API reference for qiskit.pulse.builder.cx in qiskit v0.39
...
<Function id="qiskit.pulse.builder.cx" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.22/qiskit/pulse/builder.py" signature="cx(control, target)">
