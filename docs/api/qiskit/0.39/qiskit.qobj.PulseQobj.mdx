...
<Class id="qiskit.qobj.PulseQobj" github="https://github.com/qiskit/qiskit/tree/stable/0.22/qiskit/qobj/pulse_qobj.py" signature="PulseQobj(qobj_id, config, experiments, header=None)">
  Bases: `object`
