...
<Function id="qiskit.pulse.builder.delay_qubits" github="https://github.com/qiskit/qiskit/tree/stable/0.22/qiskit/pulse/builder.py" signature="delay_qubits(duration, *qubits)">
