...
<Function id="qiskit.assembler.assemble_schedules" name="assemble_schedules" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.22/qiskit/assembler/assemble_schedules.py" signature="assemble_schedules(schedules, qobj_id, qobj_header, run_config)">
