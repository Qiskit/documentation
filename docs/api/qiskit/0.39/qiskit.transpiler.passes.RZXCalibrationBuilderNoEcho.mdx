...
<Class id="qiskit.transpiler.passes.RZXCalibrationBuilderNoEcho" github="https://github.com/qiskit/qiskit/tree/stable/0.22/qiskit/transpiler/passes/calibration/rzx_builder.py" signature="RZXCalibrationBuilderNoEcho(instruction_schedule_map=None, qubit_channel_mapping=None, verbose=True)">
  ...
  **QiskitError** – Instruction schedule map is not provided.
  ...
  <Function id="qiskit.transpiler.passes.RZXCalibrationBuilderNoEcho.rescale_cr_inst" signature="static RZXCalibrationBuilderNoEcho.rescale_cr_inst(instruction, theta, sample_mult=16)">
    **Parameters**
