...
<Class id="qiskit.algorithms.linear_solvers.MatrixFunctional" github="https://github.com/qiskit/qiskit/tree/stable/0.22/qiskit/algorithms/linear_solvers/observables/matrix_functional.py" signature="MatrixFunctional(main_diag, off_diag)">
