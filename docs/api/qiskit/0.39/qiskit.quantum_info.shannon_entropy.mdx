---
title: shannon_entropy (v0.39)
description: API reference for qiskit.quantum_info.shannon_entropy in qiskit v0.39
...
<Function id="qiskit.quantum_info.shannon_entropy" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.22/qiskit/quantum_info/states/utils.py" signature="shannon_entropy(pvec, base=2)">
