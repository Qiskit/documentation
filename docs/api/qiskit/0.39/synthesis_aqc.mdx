---
title: aqc (v0.39)
description: API reference for qiskit.transpiler.synthesis.aqc in qiskit v0.39
...
<Function id="qiskit.transpiler.synthesis.aqc.make_cnot_network" github="https://github.com/qiskit/qiskit/tree/stable/0.22/qiskit/transpiler/synthesis/aqc/cnot_structures.py" signature="make_cnot_network(num_qubits, network_layout='spin', connectivity_type='full', depth=0)">
