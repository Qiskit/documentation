---
title: square (v0.39)
description: API reference for qiskit.pulse.library.square in qiskit v0.39
...
<Function id="qiskit.pulse.library.square" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.22/qiskit/pulse/library/discrete.py" signature="square(duration, amp, freq=None, phase=0, name=None)">
