...
`ParamShiftEstimatorGradient(estimator, **options)` [GitHub](https://github.com/qiskit/qiskit/tree/stable/0.22/qiskit/algorithms/gradients/param_shift_estimator_gradient.py "view source code")
