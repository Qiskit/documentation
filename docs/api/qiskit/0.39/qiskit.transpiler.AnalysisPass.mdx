---
title: AnalysisPass (v0.39)
description: API reference for qiskit.transpiler.AnalysisPass in qiskit v0.39
...
<Class id="qiskit.transpiler.AnalysisPass" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.22/qiskit/transpiler/basepasses.py" signature="AnalysisPass(*args, **kwargs)" modifiers="class">
