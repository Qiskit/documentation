---
title: LinearSolverResult (v0.39)
description: API reference for qiskit.algorithms.linear_solvers.LinearSolverResult in qiskit v0.39
...
<Class id="qiskit.algorithms.linear_solvers.LinearSolverResult" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.22/qiskit/algorithms/linear_solvers/linear_solver.py" signature="LinearSolverResult" modifiers="class">
