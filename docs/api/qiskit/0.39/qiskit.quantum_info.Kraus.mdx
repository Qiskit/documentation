...
<Class id="qiskit.quantum_info.Kraus" github="https://github.com/qiskit/qiskit/tree/stable/0.22/qiskit/quantum_info/operators/channel/kraus.py" signature="Kraus(data, input_dims=None, output_dims=None)">
