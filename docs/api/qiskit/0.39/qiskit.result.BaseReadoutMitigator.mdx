...
<Class id="qiskit.result.BaseReadoutMitigator" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.22/qiskit/result/mitigation/base_readout_mitigator.py" signature="BaseReadoutMitigator">
  Bases: `abc.ABC`
  ...
  <Function id="qiskit.result.BaseReadoutMitigator.expectation_value" name="expectation_value" signature="abstract BaseReadoutMitigator.expectation_value(data, diagonal, qubits=None, clbits=None, shots=None)">
  ...
  <Function id="qiskit.result.BaseReadoutMitigator.quasi_probabilities" name="quasi_probabilities" signature="abstract BaseReadoutMitigator.quasi_probabilities(data, qubits=None, clbits=None, shots=None)">
