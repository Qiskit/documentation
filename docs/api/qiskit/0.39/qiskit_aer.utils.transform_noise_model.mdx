---
title: transform_noise_model (v0.39)
description: API reference for qiskit_aer.utils.transform_noise_model in qiskit v0.39
in_page_toc_min_heading_level: 1
python_api_type: function
python_api_name: qiskit_aer.utils.transform_noise_model
---

<span id="qiskit-aer-utils-transform-noise-model" />

# qiskit\_aer.utils.transform\_noise\_model

<Function id="qiskit_aer.utils.transform_noise_model" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-aer/tree/stable/0.11/qiskit_aer/utils/noise_transformation.py" signature="transform_noise_model(noise_model, func)">
