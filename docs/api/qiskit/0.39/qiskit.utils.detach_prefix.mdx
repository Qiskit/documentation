---
title: detach_prefix (v0.39)
description: API reference for qiskit.utils.detach_prefix in qiskit v0.39
...
<Function id="qiskit.utils.detach_prefix" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.22/qiskit/utils/units.py" signature="detach_prefix(value, decimal=None)">
