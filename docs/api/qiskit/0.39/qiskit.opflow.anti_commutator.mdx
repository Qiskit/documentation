---
title: anti_commutator (v0.39)
description: API reference for qiskit.opflow.anti_commutator in qiskit v0.39
...
<Function id="qiskit.opflow.anti_commutator" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.22/qiskit/opflow/utils.py" signature="anti_commutator(op_a, op_b)">
