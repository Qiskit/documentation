...
<Class id="qiskit.qobj.QobjMeasurementOption" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.22/qiskit/qobj/pulse_qobj.py" signature="QobjMeasurementOption(name, params=None)">
  Bases: `object`
