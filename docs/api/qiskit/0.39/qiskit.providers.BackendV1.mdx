---
title: BackendV1 (v0.39)
description: API reference for qiskit.providers.BackendV1 in qiskit v0.39
...
<Class id="qiskit.providers.BackendV1" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.22/qiskit/providers/backend.py" signature="BackendV1(configuration, provider=None, **fields)" modifiers="class">
