...
<span id="qiskit.providers.fake_provider.FakeGuadalupeV2" />

`FakeGuadalupeV2`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.22/qiskit/providers/fake_provider/backends/guadalupe/fake_guadalupe.py "view source code")
...
<span id="qiskit.providers.fake_provider.FakeGuadalupeV2.acquire_channel" />

`FakeGuadalupeV2.acquire_channel(qubit)`
...
<span id="qiskit.providers.fake_provider.FakeGuadalupeV2.control_channel" />

`FakeGuadalupeV2.control_channel(qubits)`
...
<span id="qiskit.providers.fake_provider.FakeGuadalupeV2.drive_channel" />

`FakeGuadalupeV2.drive_channel(qubit)`
...
<span id="qiskit.providers.fake_provider.FakeGuadalupeV2.measure_channel" />

`FakeGuadalupeV2.measure_channel(qubit)`
...
<span id="qiskit.providers.fake_provider.FakeGuadalupeV2.qubit_properties" />

`FakeGuadalupeV2.qubit_properties(qubit)`
...
<span id="qiskit.providers.fake_provider.FakeGuadalupeV2.run" />

`FakeGuadalupeV2.run(run_input, **options)`
...
<span id="qiskit.providers.fake_provider.FakeGuadalupeV2.set_options" />

`FakeGuadalupeV2.set_options(**fields)`
...
<span id="qiskit.providers.fake_provider.FakeGuadalupeV2.backend_name" />

### backend\_name

`= 'fake_guadalupe_v2'`

<span id="qiskit.providers.fake_provider.FakeGuadalupeV2.conf_filename" />

### conf\_filename

`= 'conf_guadalupe.json'`

<span id="qiskit.providers.fake_provider.FakeGuadalupeV2.coupling_map" />

### coupling\_map

Return the [`CouplingMap`](qiskit.transpiler.CouplingMap "qiskit.transpiler.CouplingMap") object

<span id="qiskit.providers.fake_provider.FakeGuadalupeV2.defs_filename" />

### defs\_filename

`= 'defs_guadalupe.json'`

<span id="qiskit.providers.fake_provider.FakeGuadalupeV2.dirname" />

### dirname

`= '/home/runner/work/qiskit/qiskit/.tox/docs/lib/python3.8/site-packages/qiskit/providers/fake_provider/backends/guadalupe'`

<span id="qiskit.providers.fake_provider.FakeGuadalupeV2.dt" />
...
<span id="qiskit.providers.fake_provider.FakeGuadalupeV2.dtm" />
...
<span id="qiskit.providers.fake_provider.FakeGuadalupeV2.instruction_durations" />

### instruction\_durations

Return the [`InstructionDurations`](qiskit.transpiler.InstructionDurations "qiskit.transpiler.InstructionDurations") object.

<span id="qiskit.providers.fake_provider.FakeGuadalupeV2.instruction_schedule_map" />
...
<span id="qiskit.providers.fake_provider.FakeGuadalupeV2.instructions" />
...
<span id="qiskit.providers.fake_provider.FakeGuadalupeV2.max_circuits" />

### max\_circuits

<span id="qiskit.providers.fake_provider.FakeGuadalupeV2.meas_map" />
...
<span id="qiskit.providers.fake_provider.FakeGuadalupeV2.num_qubits" />
...
<span id="qiskit.providers.fake_provider.FakeGuadalupeV2.operation_names" />
...
<span id="qiskit.providers.fake_provider.FakeGuadalupeV2.operations" />
...
<span id="qiskit.providers.fake_provider.FakeGuadalupeV2.options" />
...
<span id="qiskit.providers.fake_provider.FakeGuadalupeV2.props_filename" />

### props\_filename

`= 'props_guadalupe.json'`

<span id="qiskit.providers.fake_provider.FakeGuadalupeV2.provider" />
...
<span id="qiskit.providers.fake_provider.FakeGuadalupeV2.target" />
...
<span id="qiskit.providers.fake_provider.FakeGuadalupeV2.version" />
