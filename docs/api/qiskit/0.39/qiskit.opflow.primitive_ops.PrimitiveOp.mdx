...
<Class id="qiskit.opflow.primitive_ops.PrimitiveOp" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.22/qiskit/opflow/primitive_ops/primitive_op.py" signature="PrimitiveOp(primitive, coeff=1.0)">
  ...
  *   **coeff** (`Union`\[`complex`, [`ParameterExpression`](qiskit.circuit.ParameterExpression "qiskit.circuit.parameterexpression.ParameterExpression")]) – A coefficient multiplying the primitive.
  ...
  <Function id="qiskit.opflow.primitive_ops.PrimitiveOp.add" name="add" signature="PrimitiveOp.add(other)">
  ...
  <Function id="qiskit.opflow.primitive_ops.PrimitiveOp.adjoint" name="adjoint" signature="PrimitiveOp.adjoint()">
  ...
  <Function id="qiskit.opflow.primitive_ops.PrimitiveOp.assign_parameters" name="assign_parameters" signature="PrimitiveOp.assign_parameters(param_dict)">
  ...
  <Function id="qiskit.opflow.primitive_ops.PrimitiveOp.compose" name="compose" signature="PrimitiveOp.compose(other, permutation=None, front=False)">
  ...
  <Function id="qiskit.opflow.primitive_ops.PrimitiveOp.equals" name="equals" signature="PrimitiveOp.equals(other)">
  ...
  <Function id="qiskit.opflow.primitive_ops.PrimitiveOp.eval" name="eval" signature="PrimitiveOp.eval(front=None)">
  ...
  <Function id="qiskit.opflow.primitive_ops.PrimitiveOp.exp_i" name="exp_i" signature="PrimitiveOp.exp_i()">
  ...
  <Function id="qiskit.opflow.primitive_ops.PrimitiveOp.log_i" name="log_i" signature="PrimitiveOp.log_i(massive=False)">
  ...
  <Function id="qiskit.opflow.primitive_ops.PrimitiveOp.mul" name="mul" signature="PrimitiveOp.mul(scalar)">
  ...
  <Function id="qiskit.opflow.primitive_ops.PrimitiveOp.permute" name="permute" signature="PrimitiveOp.permute(permutation)">
  ...
  <Function id="qiskit.opflow.primitive_ops.PrimitiveOp.primitive_strings" name="primitive_strings" signature="PrimitiveOp.primitive_strings()">
  ...
  <Function id="qiskit.opflow.primitive_ops.PrimitiveOp.reduce" name="reduce" signature="PrimitiveOp.reduce()">
  ...
  <Function id="qiskit.opflow.primitive_ops.PrimitiveOp.tensor" name="tensor" signature="PrimitiveOp.tensor(other)">
  ...
  <Function id="qiskit.opflow.primitive_ops.PrimitiveOp.tensorpower" name="tensorpower" signature="PrimitiveOp.tensorpower(other)">
  ...
  <Function id="qiskit.opflow.primitive_ops.PrimitiveOp.to_circuit" name="to_circuit" signature="PrimitiveOp.to_circuit()">
  ...
  <Function id="qiskit.opflow.primitive_ops.PrimitiveOp.to_circuit_op" name="to_circuit_op" signature="PrimitiveOp.to_circuit_op()">
  ...
  <Function id="qiskit.opflow.primitive_ops.PrimitiveOp.to_instruction" name="to_instruction" signature="PrimitiveOp.to_instruction()">
  ...
  <Function id="qiskit.opflow.primitive_ops.PrimitiveOp.to_matrix" name="to_matrix" signature="PrimitiveOp.to_matrix(massive=False)">
  ...
  <Function id="qiskit.opflow.primitive_ops.PrimitiveOp.to_matrix_op" name="to_matrix_op" signature="PrimitiveOp.to_matrix_op(massive=False)">
  ...
  <Function id="qiskit.opflow.primitive_ops.PrimitiveOp.to_pauli_op" name="to_pauli_op" signature="PrimitiveOp.to_pauli_op(massive=False)">
  ...
  <Attribute id="qiskit.opflow.primitive_ops.PrimitiveOp.INDENTATION" name="INDENTATION" attributeValue="'  '" />

  ### coeff

  <Attribute id="qiskit.opflow.primitive_ops.PrimitiveOp.coeff" name="coeff">
  ...
  <Attribute id="qiskit.opflow.primitive_ops.PrimitiveOp.instance_id" name="instance_id">
  ...
  <Attribute id="qiskit.opflow.primitive_ops.PrimitiveOp.num_qubits" name="num_qubits">
    **Return type**
  ...
  <Attribute id="qiskit.opflow.primitive_ops.PrimitiveOp.parameters" name="parameters" />

  ### primitive

  <Attribute id="qiskit.opflow.primitive_ops.PrimitiveOp.primitive" name="primitive">
  ...
  <Attribute id="qiskit.opflow.primitive_ops.PrimitiveOp.settings" name="settings">
