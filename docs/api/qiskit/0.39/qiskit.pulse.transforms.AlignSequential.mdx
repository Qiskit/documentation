---
title: AlignSequential (v0.39)
description: API reference for qiskit.pulse.transforms.AlignSequential in qiskit v0.39
...
<Class id="qiskit.pulse.transforms.AlignSequential" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.22/qiskit/pulse/transforms/alignments.py" signature="AlignSequential" modifiers="class">
