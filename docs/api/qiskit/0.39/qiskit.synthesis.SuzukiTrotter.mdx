---
title: SuzukiTrotter (v0.39)
description: API reference for qiskit.synthesis.SuzukiTrotter in qiskit v0.39
...
<Class id="qiskit.synthesis.SuzukiTrotter" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.22/qiskit/synthesis/evolution/suzuki_trotter.py" signature="SuzukiTrotter(order=2, reps=1, insert_barriers=False, cx_structure='chain', atomic_evolution=None)" modifiers="class">
