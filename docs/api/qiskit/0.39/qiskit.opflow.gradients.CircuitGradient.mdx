---
title: CircuitGradient (v0.39)
description: API reference for qiskit.opflow.gradients.CircuitGradient in qiskit v0.39
...
<Class id="qiskit.opflow.gradients.CircuitGradient" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.22/qiskit/opflow/gradients/circuit_gradients/circuit_gradient.py" signature="CircuitGradient" modifiers="class">
