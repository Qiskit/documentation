---
title: LearningRate (v0.39)
description: API reference for qiskit.algorithms.optimizers.optimizer_utils.LearningRate in qiskit v0.39
...
<Class id="qiskit.algorithms.optimizers.optimizer_utils.LearningRate" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.22/qiskit/algorithms/optimizers/optimizer_utils/learning_rate.py" signature="LearningRate(learning_rate)" modifiers="class">
  Bases: `Generator`
