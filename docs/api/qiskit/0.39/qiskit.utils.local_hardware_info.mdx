...
<Function id="qiskit.utils.local_hardware_info" name="local_hardware_info" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.22/qiskit/utils/multiprocessing.py" signature="local_hardware_info()">
