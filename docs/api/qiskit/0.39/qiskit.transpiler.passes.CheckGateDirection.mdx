...
<Class id="qiskit.transpiler.passes.CheckGateDirection" github="https://github.com/qiskit/qiskit/tree/stable/0.22/qiskit/transpiler/passes/utils/check_gate_direction.py" signature="CheckGateDirection(*args, **kwargs)">
