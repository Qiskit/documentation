...
`circuit_to_dag(circuit)` [GitHub](https://github.com/qiskit/qiskit/tree/stable/0.22/qiskit/converters/circuit_to_dag.py "view source code")
...
![../\_images/qiskit.converters.circuit\_to\_dag\_0\_0.png](/images/api/qiskit/0.39/qiskit.converters.circuit_to_dag_0_0.png)
