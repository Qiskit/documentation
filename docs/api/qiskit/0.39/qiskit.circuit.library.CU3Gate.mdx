---
title: CU3Gate (v0.39)
description: API reference for qiskit.circuit.library.CU3Gate in qiskit v0.39
...
<Class id="qiskit.circuit.library.CU3Gate" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.22/qiskit/circuit/library/standard_gates/u3.py" signature="CU3Gate(theta, phi, lam, label=None, ctrl_state=None)" modifiers="class">
