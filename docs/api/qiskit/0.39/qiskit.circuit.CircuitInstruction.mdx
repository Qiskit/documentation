---
title: CircuitInstruction (v0.39)
description: API reference for qiskit.circuit.CircuitInstruction in qiskit v0.39
...
<Class id="qiskit.circuit.CircuitInstruction" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.22/qiskit/circuit/quantumcircuitdata.py" signature="CircuitInstruction(operation, qubits=(), clbits=())" modifiers="class">
  Bases: `object`
