...
<Class id="qiskit.circuit.CircuitInstruction" github="https://github.com/qiskit/qiskit/tree/stable/0.22/qiskit/circuit/quantumcircuitdata.py" signature="CircuitInstruction(operation, qubits=(), clbits=())">
  Bases: `object`
