...
<Class id="qiskit.circuit.CircuitInstruction" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.22/qiskit/circuit/quantumcircuitdata.py" signature="CircuitInstruction(operation, qubits=(), clbits=())">
  Bases: `object`
  ...
  <Function id="qiskit.circuit.CircuitInstruction.copy" name="copy" signature="CircuitInstruction.copy()">
  ...
  <Function id="qiskit.circuit.CircuitInstruction.replace" name="replace" signature="CircuitInstruction.replace(operation=None, qubits=None, clbits=None)">
  ...
  <Attribute id="qiskit.circuit.CircuitInstruction.operation" name="operation" attributeTypeHint="qiskit.circuit.instruction.Instruction">
    The logical operation that this instruction represents an execution of.
  </Attribute>

  ### qubits

  <Attribute id="qiskit.circuit.CircuitInstruction.qubits" name="qubits" attributeTypeHint="Tuple[qiskit.circuit.quantumregister.Qubit, ...]">
    A sequence of the qubits that the operation is applied to.
  </Attribute>

  ### clbits

  <Attribute id="qiskit.circuit.CircuitInstruction.clbits" name="clbits" attributeTypeHint="Tuple[qiskit.circuit.classicalregister.Clbit, ...]">
