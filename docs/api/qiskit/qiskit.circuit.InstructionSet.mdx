...
<Class id="qiskit.circuit.InstructionSet" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/circuit/instructionset.py#L31-L133" signature="qiskit.circuit.InstructionSet(*, resource_requester=None)" modifiers="class">
  ...
  **resource\_requester** (*Callable\[...,* [*ClassicalRegister*](/docs/api/qiskit/circuit#qiskit.circuit.ClassicalRegister "qiskit.circuit.ClassicalRegister")  *|*[*Clbit*](/docs/api/qiskit/circuit#qiskit.circuit.Clbit "qiskit.circuit.Clbit")*] | None*) –
  ...
  <Attribute id="qiskit.circuit.InstructionSet.cargs" name="cargs" headingLevel={3}>
    Legacy getter for the cargs components of an instruction set. This does not support mutation.
  </Attribute>

  <Attribute id="qiskit.circuit.InstructionSet.instructions" name="instructions" headingLevel={3}>
    Legacy getter for the instruction components of an instruction set. This does not support mutation.
  </Attribute>

  <Attribute id="qiskit.circuit.InstructionSet.qargs" name="qargs" headingLevel={3}>
  ...
  <Function id="qiskit.circuit.InstructionSet.add" github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/circuit/instructionset.py#L77-L85" signature="add(instruction, qargs=None, cargs=None)">
    Add an instruction and its context (where it is attached).
  </Function>

  ### inverse

  <Function id="qiskit.circuit.InstructionSet.inverse" github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/circuit/instructionset.py#L92-L109" signature="inverse(annotated=False)">
