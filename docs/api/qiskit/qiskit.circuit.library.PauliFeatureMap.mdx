...
$$
  ...
  *   **name** ([*str*](https://docs.python.org/3/library/stdtypes.html#str)) – Name of the circuit.
  ...
  <Attribute id="qiskit.circuit.library.PauliFeatureMap.alpha" name="alpha" headingLevel={3}>
  ...
  <Attribute id="qiskit.circuit.library.PauliFeatureMap.entanglement_blocks" name="entanglement_blocks" headingLevel={3}>
  ...
  <Attribute id="qiskit.circuit.library.PauliFeatureMap.feature_dimension" name="feature_dimension" headingLevel={3}>
  ...
  <Attribute id="qiskit.circuit.library.PauliFeatureMap.num_parameters_settable" name="num_parameters_settable" headingLevel={3}>
    The number of distinct parameters.
  </Attribute>

  <Attribute id="qiskit.circuit.library.PauliFeatureMap.paulis" name="paulis" headingLevel={3}>
  ...
  <Attribute id="qiskit.circuit.library.PauliFeatureMap.name" name="name" headingLevel={3}>
  ...
  <Function id="qiskit.circuit.library.PauliFeatureMap.get_entangler_map" github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/circuit/library/data_preparation/pauli_feature_map.py#L666-L703" signature="get_entangler_map(rep_num, block_num, num_block_qubits)">
  ...
  <Function id="qiskit.circuit.library.PauliFeatureMap.pauli_block" github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/circuit/library/data_preparation/pauli_feature_map.py#L620-L624" signature="pauli_block(pauli_string)">
    Get the Pauli block for the feature map circuit.
  </Function>

  ### pauli\_evolution

  <Function id="qiskit.circuit.library.PauliFeatureMap.pauli_evolution" github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/circuit/library/data_preparation/pauli_feature_map.py#L626-L664" signature="pauli_evolution(pauli_string, time)">
