...
<Function id="qiskit.utils.add_deprecation_to_docstring" github="https://github.com/Qiskit/qiskit/tree/stable/2.4/qiskit/utils/deprecation.py#L311-L383" signature="qiskit.utils.add_deprecation_to_docstring(func, msg, *, since, pending)">
...
<Function id="qiskit.utils.deprecate_func" github="https://github.com/Qiskit/qiskit/tree/stable/2.4/qiskit/utils/deprecation.py#L24-L102" signature="qiskit.utils.deprecate_func(*, since, additional_msg=None, pending=False, package_name='Qiskit', removal_timeline='no earlier than 3 months after the release date', is_property=False, stacklevel=2)">
...
<Function id="qiskit.utils.apply_prefix" github="https://github.com/Qiskit/qiskit/tree/stable/2.4/qiskit/utils/units.py#L24-L71" signature="qiskit.utils.apply_prefix(value, unit)">
  Given a SI unit prefix and value, apply the prefix to convert to standard SI unit.

  **Parameters**

  *   **value** ([*float*](https://docs.python.org/3/library/functions.html#float)  *|*[*ParameterExpression*](qiskit.circuit.ParameterExpression "qiskit.circuit.ParameterExpression")) – The number to apply prefix to.
  ...
  **Return type**
  ...
  [float](https://docs.python.org/3/library/functions.html#float) | [ParameterExpression](qiskit.circuit.ParameterExpression "qiskit.circuit.ParameterExpression")
  ...
  *   **value** ([*float*](https://docs.python.org/3/library/functions.html#float)  *|*[*ParameterExpression*](qiskit.circuit.ParameterExpression "qiskit.circuit.ParameterExpression"))
...
<Function id="qiskit.utils.detach_prefix" github="https://github.com/Qiskit/qiskit/tree/stable/2.4/qiskit/utils/units.py#L74-L146" signature="qiskit.utils.detach_prefix(value, decimal=None)">
...
<Function id="qiskit.utils.wrap_method" github="https://github.com/Qiskit/qiskit/tree/stable/2.4/qiskit/utils/classtools.py#L120-L148" signature="qiskit.utils.wrap_method(cls, name, *, before=None, after=None)">
  ...
  *   **cls** ([*type*](qiskit.dagcircuit.DAGDepNode#type "qiskit.dagcircuit.DAGDepNode.type")) – the class to modify.
...
<Function id="qiskit.utils.default_num_processes" github="https://github.com/Qiskit/qiskit/tree/stable/2.4/qiskit/utils/parallel.py#L97-L130" signature="qiskit.utils.default_num_processes()">
...
<Function id="qiskit.utils.is_main_process" github="https://github.com/Qiskit/qiskit/tree/stable/2.4/qiskit/utils/parallel.py#L151-L162" signature="qiskit.utils.is_main_process()">
...
<Function id="qiskit.utils.local_hardware_info" github="https://github.com/Qiskit/qiskit/tree/stable/2.4/qiskit/utils/parallel.py#L133-L148" signature="qiskit.utils.local_hardware_info()">
...
<Function id="qiskit.utils.should_run_in_parallel" github="https://github.com/Qiskit/qiskit/tree/stable/2.4/qiskit/utils/parallel.py#L171-L221" signature="qiskit.utils.should_run_in_parallel(num_processes=None)">
  ...
  <Function id="qiskit.utils.should_run_in_parallel.override" github="https://github.com/Qiskit/qiskit/tree/stable/2.4/qiskit/utils/parallel.py#L244-L261" signature="should_run_in_parallel.override(value)">
  ...
  <Function id="qiskit.utils.should_run_in_parallel.ignore_user_settings" github="https://github.com/Qiskit/qiskit/tree/stable/2.4/qiskit/utils/parallel.py#L224-L241" signature="should_run_in_parallel.ignore_user_settings()">
...
<Function id="qiskit.utils.parallel_map" github="https://github.com/Qiskit/qiskit/tree/stable/2.4/qiskit/utils/parallel.py#L268-L318" signature="qiskit.utils.parallel_map(task, values, task_args=(), task_kwargs=None, num_processes=None)">
...
<Attribute id="qiskit.utils.optionals.HAS_SYMENGINE">
  [Symengine](https://github.com/symengine/symengine) is a fast C++ backend for the symbolic-manipulation library [Sympy](https://www.sympy.org/en/index.html). This dependency is used to load legacy QPY formats, where this package was used to handle [`Parameter`](qiskit.circuit.Parameter "qiskit.circuit.Parameter")s.
</Attribute>
...
<Class id="qiskit.utils.LazyDependencyManager" github="https://github.com/Qiskit/qiskit/tree/stable/2.4/qiskit/utils/lazy_tester.py#L45-L239" signature="qiskit.utils.LazyDependencyManager(*, name=None, callback=None, install=None, msg=None)" modifiers="class">
  ...
  *   **msg** – an extra message to include in the error raised if this is required.
  ...
  <Function id="qiskit.utils.LazyDependencyManager._is_available" github="https://github.com/Qiskit/qiskit/tree/stable/2.4/qiskit/utils/lazy_tester.py#L105-L113" signature="_is_available()" modifiers="abstractmethod">
  ...
  <Function id="qiskit.utils.LazyDependencyManager.disable_locally" github="https://github.com/Qiskit/qiskit/tree/stable/2.4/qiskit/utils/lazy_tester.py#L226-L239" signature="disable_locally()">
  ...
  <Function id="qiskit.utils.LazyDependencyManager.require_in_call" github="https://github.com/Qiskit/qiskit/tree/stable/2.4/qiskit/utils/lazy_tester.py#L128-L168" signature="require_in_call(feature_or_callable: Callable) → Callable" extraSignatures={["require_in_call(feature_or_callable: str) → Callable[[Callable], Callable]"]}>
  ...
  <Function id="qiskit.utils.LazyDependencyManager.require_in_instance" github="https://github.com/Qiskit/qiskit/tree/stable/2.4/qiskit/utils/lazy_tester.py#L176-L208" signature="require_in_instance(feature_or_class: type) → type" extraSignatures={["require_in_instance(feature_or_class: str) → Callable[[type], type]"]}>
  ...
  <Function id="qiskit.utils.LazyDependencyManager.require_now" github="https://github.com/Qiskit/qiskit/tree/stable/2.4/qiskit/utils/lazy_tester.py#L210-L224" signature="require_now(feature)">
...
<Class id="qiskit.utils.LazyImportTester" github="https://github.com/Qiskit/qiskit/tree/stable/2.4/qiskit/utils/lazy_tester.py#L242-L324" signature="qiskit.utils.LazyImportTester(name_map_or_modules, *, name=None, callback=None, install=None, msg=None)" modifiers="class">
  ...
  *   **callback** ([*Callable*](https://docs.python.org/3/library/collections.abc.html#collections.abc.Callable)*\[\[*[*bool*](https://docs.python.org/3/library/functions.html#bool)*], None] | None*)
  *   **install** ([*str*](https://docs.python.org/3/library/stdtypes.html#str) *| None*)
...
<Class id="qiskit.utils.LazySubprocessTester" github="https://github.com/Qiskit/qiskit/tree/stable/2.4/qiskit/utils/lazy_tester.py#L327-L364" signature="qiskit.utils.LazySubprocessTester(command, *, name=None, callback=None, install=None, msg=None)" modifiers="class">
  Bases: [`LazyDependencyManager`](#qiskit.utils.LazyDependencyManager "qiskit.utils.lazy_tester.LazyDependencyManager")
