---
title: singleton (latest version)
description: API reference for qiskit.circuit.singleton in the latest version of qiskit
...
The machinery in this module is for defining subclasses of [`Instruction`](/docs/api/qiskit/qiskit.circuit.Instruction "qiskit.circuit.Instruction") and [`Gate`](/docs/api/qiskit/qiskit.circuit.Gate "qiskit.circuit.Gate") that preferentially return a shared immutable singleton instance when instantiated. Taking the example of [`XGate`](/docs/api/qiskit/qiskit.circuit.library.XGate "qiskit.circuit.library.XGate"), the final user-facing result is that:

*   There is a regular class called `XGate`, which derives from [`Gate`](/docs/api/qiskit/qiskit.circuit.Gate "qiskit.circuit.Gate").
*   Doing something like `XGate(label="my_gate")` produces an object whose type is exactly `XGate`, and all the mutability works completely as expected; all the methods resolve to exactly those defined by [`XGate`](/docs/api/qiskit/qiskit.circuit.library.XGate "qiskit.circuit.library.XGate"), [`Gate`](/docs/api/qiskit/qiskit.circuit.Gate "qiskit.circuit.Gate"), or parents.
*   Doing `XGate()` produces a singleton object whose type is a synthetic `_SingletonXGate` class, which derives [`XGate`](/docs/api/qiskit/qiskit.circuit.library.XGate "qiskit.circuit.library.XGate") but overrides [`__setattr__()`](https://docs.python.org/3/reference/datamodel.html#object.__setattr__) to make itself immutable. The object itself has precisely the same instance attributes as `XGate()` would have if there was no singleton handling. This object will return itself under [`copy()`](https://docs.python.org/3/library/copy.html#copy.copy), [`deepcopy()`](https://docs.python.org/3/library/copy.html#copy.deepcopy) and roundtrip through [`pickle`](https://docs.python.org/3/library/pickle.html#module-pickle).

The same can be true for, for example, [`Measure`](circuit#qiskit.circuit.Measure "qiskit.circuit.Measure"), except that it’s a subclass of [`Instruction`](/docs/api/qiskit/qiskit.circuit.Instruction "qiskit.circuit.Instruction") only, and not [`Gate`](/docs/api/qiskit/qiskit.circuit.Gate "qiskit.circuit.Gate").
...
From a library-author perspective, the minimum that is needed to enhance a [`Gate`](/docs/api/qiskit/qiskit.circuit.Gate "qiskit.circuit.Gate") or [`Instruction`](/docs/api/qiskit/qiskit.circuit.Instruction "qiskit.circuit.Instruction") with this behavior is to inherit from [`SingletonGate`](#qiskit.circuit.singleton.SingletonGate "qiskit.circuit.singleton.SingletonGate") ([`SingletonInstruction`](#qiskit.circuit.singleton.SingletonInstruction "qiskit.circuit.singleton.SingletonInstruction")) instead of [`Gate`](/docs/api/qiskit/qiskit.circuit.Gate "qiskit.circuit.Gate") ([`Instruction`](/docs/api/qiskit/qiskit.circuit.Instruction "qiskit.circuit.Instruction")), and for the `__init__` method to have defaults for all of its arguments (these will be the state of the singleton instance). For example:
...
The public classes correspond to the standard classes [`Instruction`](/docs/api/qiskit/qiskit.circuit.Instruction "qiskit.circuit.Instruction") and [`Gate`](/docs/api/qiskit/qiskit.circuit.Gate "qiskit.circuit.Gate"), respectively, and are subclasses of these.

### SingletonInstruction

<Class id="qiskit.circuit.singleton.SingletonInstruction" github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/circuit/singleton.py#L497-L515" signature="qiskit.circuit.singleton.SingletonInstruction(*args, _force_mutable=False, **kwargs)" modifiers="class">
  Bases: [`Instruction`](/docs/api/qiskit/qiskit.circuit.Instruction "qiskit.circuit.instruction.Instruction"), `_SingletonBase`

  A base class to use for [`Instruction`](/docs/api/qiskit/qiskit.circuit.Instruction "qiskit.circuit.Instruction") objects that by default are singleton instances.
  ...
  The exception to be aware of with this class though are the [`Instruction`](/docs/api/qiskit/qiskit.circuit.Instruction "qiskit.circuit.Instruction") attribute [`label`](/docs/api/qiskit/qiskit.circuit.Instruction#label "qiskit.circuit.Instruction.label") which can be set differently for specific instances of gates. For [`SingletonInstruction`](#qiskit.circuit.singleton.SingletonInstruction "qiskit.circuit.singleton.SingletonInstruction") usage to be sound setting these attributes is not available and they can only be set at creation time, or on an object that has been specifically made mutable using [`to_mutable()`](/docs/api/qiskit/qiskit.circuit.Instruction#to_mutable "qiskit.circuit.Instruction.to_mutable"). If any of these attributes are used during creation, then instead of using a single shared global instance of the same gate a new separate instance will be created.
</Class>

### SingletonGate

<Class id="qiskit.circuit.singleton.SingletonGate" github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/circuit/singleton.py#L527-L534" signature="qiskit.circuit.singleton.SingletonGate(*args, _force_mutable=False, **kwargs)" modifiers="class">
  Bases: [`Gate`](/docs/api/qiskit/qiskit.circuit.Gate "qiskit.circuit.gate.Gate"), `_SingletonBase`

  A base class to use for [`Gate`](/docs/api/qiskit/qiskit.circuit.Gate "qiskit.circuit.Gate") objects that by default are singleton instances.

  This class is very similar to [`SingletonInstruction`](#qiskit.circuit.singleton.SingletonInstruction "qiskit.circuit.singleton.SingletonInstruction"), except implies unitary [`Gate`](/docs/api/qiskit/qiskit.circuit.Gate "qiskit.circuit.Gate") semantics as well. The same caveats around setting attributes in that class apply here as well.
</Class>

### SingletonControlledGate

<Class id="qiskit.circuit.singleton.SingletonControlledGate" github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/circuit/singleton.py#L547-L559" signature="qiskit.circuit.singleton.SingletonControlledGate(*args, _force_mutable=False, **kwargs)" modifiers="class">
  Bases: [`ControlledGate`](/docs/api/qiskit/qiskit.circuit.ControlledGate "qiskit.circuit.controlledgate.ControlledGate"), `_SingletonBase`

  A base class to use for [`ControlledGate`](/docs/api/qiskit/qiskit.circuit.ControlledGate "qiskit.circuit.ControlledGate") objects that by default are singleton instances

  This class is very similar to [`SingletonInstruction`](#qiskit.circuit.singleton.SingletonInstruction "qiskit.circuit.singleton.SingletonInstruction"), except implies unitary [`ControlledGate`](/docs/api/qiskit/qiskit.circuit.ControlledGate "qiskit.circuit.ControlledGate") semantics as well. The same caveats around setting attributes in that class apply here as well.
</Class>
...
*All* subclasses of [`Instruction`](/docs/api/qiskit/qiskit.circuit.Instruction "qiskit.circuit.Instruction") have a [`mutable`](/docs/api/qiskit/qiskit.circuit.Instruction#mutable "qiskit.circuit.Instruction.mutable") property. For most instructions this is `True`, while for the singleton instances it is `False`. One can use the [`to_mutable()`](/docs/api/qiskit/qiskit.circuit.Instruction#to_mutable "qiskit.circuit.Instruction.to_mutable") method to get a version of the instruction that is owned and safe to mutate.
...
You should not rely on [`type`](https://docs.python.org/3/library/functions.html#type) having an exact value; use [`isinstance()`](https://docs.python.org/3/library/functions.html#isinstance) instead for type checking. If you need to reliably retrieve the base class from an [`Instruction`](/docs/api/qiskit/qiskit.circuit.Instruction "qiskit.circuit.Instruction"), see the [`Instruction.base_class`](/docs/api/qiskit/qiskit.circuit.Instruction#base_class "qiskit.circuit.Instruction.base_class") attribute; singleton instances set this correctly. For most cases in using Qiskit, [`Instruction.name`](/docs/api/qiskit/qiskit.circuit.Instruction#name "qiskit.circuit.Instruction.name") is a more suitable determiner of what an instruction “means” in a circuit.
...
<Function id="qiskit.circuit.singleton.SingletonInstruction._singleton_lookup_key" github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/circuit/singleton.py#L408-L448" signature="SingletonInstruction._singleton_lookup_key(*_args, **_kwargs)" modifiers="static">
...
There are several moving parts to tackle here. The behavior of having `XGate()` return some singleton object that is an (inexact) instance of [`XGate`](/docs/api/qiskit/qiskit.circuit.library.XGate "qiskit.circuit.library.XGate") but *without* calling `__init__` requires us to override [`type.__call__`](https://docs.python.org/3/library/functions.html#type). This means that [`XGate`](/docs/api/qiskit/qiskit.circuit.library.XGate "qiskit.circuit.library.XGate") must have a metaclass that defines `__call__` to return the singleton instance.
...
1.  Before creating any singletons, we separately define the overrides needed to make an [`Instruction`](/docs/api/qiskit/qiskit.circuit.Instruction "qiskit.circuit.Instruction") and a [`Gate`](/docs/api/qiskit/qiskit.circuit.Gate "qiskit.circuit.Gate") immutable. This is `_SingletonInstructionOverrides` and the other `_*Overrides` classes.
