...
`qiskit.transpiler.passes.DenseLayout(*args, **kwargs)` [GitHub](https://github.com/qiskit/qiskit/tree/stable/1.0/qiskit/transpiler/passes/layout/dense_layout.py "view source code")
...
<span id="qiskit.transpiler.passes.DenseLayout.execute" />
...
<span id="qiskit.transpiler.passes.DenseLayout.update_status" />
