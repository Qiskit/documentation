...
<Class id="qiskit.transpiler.CouplingMap" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.0/qiskit/transpiler/coupling.py#L31-L500" signature="qiskit.transpiler.CouplingMap(couplinglist=None, description=None)">
  ...
  *   **description** ([*str*](https://docs.python.org/3/library/stdtypes.html#str "(in Python v3.12)")) – A string to describe the coupling map.
  ...
  <Function id="qiskit.transpiler.CouplingMap.from_full" github="https://github.com/Qiskit/qiskit/tree/stable/1.0/qiskit/transpiler/coupling.py#L294-L306" signature="classmethod from_full(num_qubits, bidirectional=True)">
  ...
  <Function id="qiskit.transpiler.CouplingMap.from_grid" github="https://github.com/Qiskit/qiskit/tree/stable/1.0/qiskit/transpiler/coupling.py#L322-L329" signature="classmethod from_grid(num_rows, num_columns, bidirectional=True)">
  ...
  <Function id="qiskit.transpiler.CouplingMap.from_heavy_hex" github="https://github.com/Qiskit/qiskit/tree/stable/1.0/qiskit/transpiler/coupling.py#L331-L353" signature="classmethod from_heavy_hex(distance, bidirectional=True)">
  ...
  <Function id="qiskit.transpiler.CouplingMap.from_heavy_square" github="https://github.com/Qiskit/qiskit/tree/stable/1.0/qiskit/transpiler/coupling.py#L355-L379" signature="classmethod from_heavy_square(distance, bidirectional=True)">
  ...
  <Function id="qiskit.transpiler.CouplingMap.from_hexagonal_lattice" github="https://github.com/Qiskit/qiskit/tree/stable/1.0/qiskit/transpiler/coupling.py#L381-L398" signature="classmethod from_hexagonal_lattice(rows, cols, bidirectional=True)">
  ...
  <Function id="qiskit.transpiler.CouplingMap.from_line" github="https://github.com/Qiskit/qiskit/tree/stable/1.0/qiskit/transpiler/coupling.py#L308-L313" signature="classmethod from_line(num_qubits, bidirectional=True)">
  ...
  <Function id="qiskit.transpiler.CouplingMap.from_ring" github="https://github.com/Qiskit/qiskit/tree/stable/1.0/qiskit/transpiler/coupling.py#L315-L320" signature="classmethod from_ring(num_qubits, bidirectional=True)">
