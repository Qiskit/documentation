...
<Class id="qiskit.transpiler.CouplingMap" github="https://github.com/Qiskit/qiskit/tree/stable/1.0/qiskit/transpiler/coupling.py#L31-L500" signature="qiskit.transpiler.CouplingMap(couplinglist=None, description=None)">
