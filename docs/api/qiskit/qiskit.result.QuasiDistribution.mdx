...
<Class id="qiskit.result.QuasiDistribution" github="https://github.com/qiskit/qiskit/tree/stable/1.0/qiskit/result/distributions/quasi.py" signature="qiskit.result.QuasiDistribution(data, shots=None, stddev_upper_bound=None)">
