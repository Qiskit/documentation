...
<Class id="qiskit.circuit.library.XXMinusYYGate" github="https://github.com/qiskit/qiskit/tree/stable/1.0/qiskit/circuit/library/standard_gates/xx_minus_yy.py" signature="qiskit.circuit.library.XXMinusYYGate(theta, beta=0, label='(XX-YY)', *, duration=None, unit='dt')">
...
$$
  ...
  *   **label** ([*str*](https://docs.python.org/3/library/stdtypes.html#str "(in Python v3.12)") *| None*) – The label of the gate.
  ...
  <Function id="qiskit.circuit.library.XXMinusYYGate.inverse" name="inverse" signature="inverse(annotated=False)">
    Inverse gate.
  ...
  <Function id="qiskit.circuit.library.XXMinusYYGate.power" name="power" signature="power(exponent)">
