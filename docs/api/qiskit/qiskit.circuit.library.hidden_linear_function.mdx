...
<Class id="qiskit.circuit.library.hidden_linear_function" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.3/qiskit/circuit/library/hidden_linear_function.py#L91-L161" signature="qiskit.circuit.library.hidden_linear_function(adjacency_matrix)" modifiers="class">
  Bases:
...
$$
  ...
  **Reference Circuit:**
  ...
  ![../\_images/qiskit-circuit-library-hidden\_linear\_function-1.png](/images/api/qiskit/qiskit-circuit-library-hidden_linear_function-1.png)
