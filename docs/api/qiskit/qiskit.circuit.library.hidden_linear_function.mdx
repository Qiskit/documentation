...
<Function id="qiskit.circuit.library.hidden_linear_function" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/circuit/library/hidden_linear_function.py#L92-L163" signature="qiskit.circuit.library.hidden_linear_function(adjacency_matrix)">
...
$$
  ...
  ![Circuit diagram output by the previous code.](/docs/images/api/qiskit/qiskit-circuit-library-hidden_linear_function-1.avif)
  ...
  **Raises**
  ...
  [**CircuitError**](/docs/api/qiskit/circuit#qiskit.circuit.CircuitError "qiskit.circuit.CircuitError") – If A is not symmetric.
