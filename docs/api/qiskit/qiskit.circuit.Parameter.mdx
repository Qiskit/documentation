...
<Class id="qiskit.circuit.Parameter" isDedicatedPage={true} signature="qiskit.circuit.Parameter(name, uuid=None)" modifiers="class">
  ...
  **Examples**
  ...
  <Attribute id="qiskit.circuit.Parameter.name" name="name" headingLevel={3}>
    Returns the name of the [`Parameter`](#qiskit.circuit.Parameter "qiskit.circuit.Parameter").
  </Attribute>

  <Attribute id="qiskit.circuit.Parameter.num_parameters" name="num_parameters" headingLevel={3}>
  ...
  <Attribute id="qiskit.circuit.Parameter.parameters" name="parameters" headingLevel={3}>
  ...
  <Attribute id="qiskit.circuit.Parameter.uuid" name="uuid" headingLevel={3}>
