...
<Class id="qiskit.result.Result" github="https://github.com/Qiskit/qiskit/tree/stable/1.0/qiskit/result/result.py#L29-L397" signature="qiskit.result.Result(backend_name, backend_version, qobj_id, job_id, success, results, date=None, status=None, header=None, **kwargs)">
