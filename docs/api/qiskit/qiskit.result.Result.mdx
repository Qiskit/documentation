...
<Class id="qiskit.result.Result" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/2.2/qiskit/result/result.py#L26-L385" signature="qiskit.result.Result(*, backend_name=None, backend_version=None, job_id=None, success=None, results=None, date=None, status=None, header=None, **kwargs)" modifiers="class">
  ...
  <Function id="qiskit.result.Result.data" github="https://github.com/Qiskit/qiskit/tree/stable/2.2/qiskit/result/result.py#L126-L176" signature="data(experiment=None)">
  ...
  <Function id="qiskit.result.Result.from_dict" github="https://github.com/Qiskit/qiskit/tree/stable/2.2/qiskit/result/result.py#L109-L124" signature="from_dict(data)" modifiers="classmethod">
  ...
  <Function id="qiskit.result.Result.get_counts" github="https://github.com/Qiskit/qiskit/tree/stable/2.2/qiskit/result/result.py#L232-L282" signature="get_counts(experiment=None)">
  ...
  <Function id="qiskit.result.Result.get_memory" github="https://github.com/Qiskit/qiskit/tree/stable/2.2/qiskit/result/result.py#L178-L230" signature="get_memory(experiment=None)">
  ...
  <Function id="qiskit.result.Result.get_statevector" github="https://github.com/Qiskit/qiskit/tree/stable/2.2/qiskit/result/result.py#L284-L304" signature="get_statevector(experiment=None, decimals=None)">
  ...
  <Function id="qiskit.result.Result.get_unitary" github="https://github.com/Qiskit/qiskit/tree/stable/2.2/qiskit/result/result.py#L306-L325" signature="get_unitary(experiment=None, decimals=None)">
  ...
  <Function id="qiskit.result.Result.to_dict" github="https://github.com/Qiskit/qiskit/tree/stable/2.2/qiskit/result/result.py#L84-L101" signature="to_dict()">
