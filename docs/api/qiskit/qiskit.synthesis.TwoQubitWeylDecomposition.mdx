...
<Class id="qiskit.synthesis.TwoQubitWeylDecomposition" github="https://github.com/qiskit/qiskit/tree/stable/1.0/qiskit/synthesis/two_qubit/two_qubit_decompose.py" signature="qiskit.synthesis.TwoQubitWeylDecomposition(unitary_matrix, *, fidelity=0.999999999, _unpickling=False)">
...
$$
  ...
  *   **fidelity** – The target fidelity of the decomposed operation.
  ...
  <Function id="qiskit.synthesis.TwoQubitWeylDecomposition.actual_fidelity" name="actual_fidelity" signature="actual_fidelity(**kwargs)">
  ...
  <Function id="qiskit.synthesis.TwoQubitWeylDecomposition.circuit" name="circuit" signature="circuit(*, euler_basis=None, simplify=False, atol=1e-12)">
  ...
  <Function id="qiskit.synthesis.TwoQubitWeylDecomposition.from_bytes" name="from_bytes" signature="classmethod from_bytes(bytes_in, *, requested_fidelity, **kwargs)">
  ...
  <Function id="qiskit.synthesis.TwoQubitWeylDecomposition.specialize" name="specialize" signature="specialize()">
