...
$$
  ...
  *   **fidelity** – The target fidelity of the decomposed operation.
  ...
  <Function id="qiskit.synthesis.TwoQubitWeylDecomposition.from_bytes" github="https://github.com/Qiskit/qiskit/tree/stable/1.0/qiskit/synthesis/two_qubit/two_qubit_decompose.py#L477-L487" signature="classmethod from_bytes(bytes_in, *, requested_fidelity, **kwargs)">
