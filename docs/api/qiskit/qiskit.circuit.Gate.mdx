...
<Class id="qiskit.circuit.Gate" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.3/qiskit/circuit/gate.py#L25-L263" signature="qiskit.circuit.Gate(name, num_qubits, params, label=None, duration=None, unit='dt')" modifiers="class">
  ...
  *   **label** ([*str*](https://docs.python.org/3/library/stdtypes.html#str "(in Python v3.13)") *| None*) – An optional label for the gate.
  ...
  <Function id="qiskit.circuit.Gate.add_decomposition" github="https://github.com/Qiskit/qiskit/tree/stable/1.3/qiskit/circuit/instruction.py#L353-L358" signature="add_decomposition(decomposition)">
    Add a decomposition of the instruction to the SessionEquivalenceLibrary.
  </Function>

  ### assemble

  <Function id="qiskit.circuit.Gate.assemble" github="https://github.com/Qiskit/qiskit/tree/stable/1.3/qiskit/circuit/instruction.py#L382-L392" signature="assemble()">
  ...
  <Function id="qiskit.circuit.Gate.broadcast_arguments" github="https://github.com/Qiskit/qiskit/tree/stable/1.3/qiskit/circuit/gate.py#L190-L247" signature="broadcast_arguments(qargs, cargs)">
  ...
  <Function id="qiskit.circuit.Gate.c_if" github="https://github.com/Qiskit/qiskit/tree/stable/1.3/qiskit/circuit/instruction.py#L521-L540" signature="c_if(classical, val)">
  ...
  <Function id="qiskit.circuit.Gate.control" github="https://github.com/Qiskit/qiskit/tree/stable/1.3/qiskit/circuit/gate.py#L107-L147" signature="control(num_ctrl_qubits=1, label=None, ctrl_state=None, annotated=None)">
  ...
  <Function id="qiskit.circuit.Gate.copy" github="https://github.com/Qiskit/qiskit/tree/stable/1.3/qiskit/circuit/instruction.py#L542-L557" signature="copy(name=None)">
  ...
  <Function id="qiskit.circuit.Gate.inverse" github="https://github.com/Qiskit/qiskit/tree/stable/1.3/qiskit/circuit/instruction.py#L464-L519" signature="inverse(annotated=False)">
  ...
  <Function id="qiskit.circuit.Gate.is_parameterized" github="https://github.com/Qiskit/qiskit/tree/stable/1.3/qiskit/circuit/instruction.py#L318-L323" signature="is_parameterized()">
  ...
  <Function id="qiskit.circuit.Gate.power" github="https://github.com/Qiskit/qiskit/tree/stable/1.3/qiskit/circuit/gate.py#L65-L96" signature="power(exponent, annotated=False)">
  ...
  <Function id="qiskit.circuit.Gate.repeat" github="https://github.com/Qiskit/qiskit/tree/stable/1.3/qiskit/circuit/instruction.py#L605-L647" signature="repeat(n)">
  ...
  <Function id="qiskit.circuit.Gate.reverse_ops" github="https://github.com/Qiskit/qiskit/tree/stable/1.3/qiskit/circuit/instruction.py#L438-L462" signature="reverse_ops()">
  ...
  <Function id="qiskit.circuit.Gate.soft_compare" github="https://github.com/Qiskit/qiskit/tree/stable/1.3/qiskit/circuit/instruction.py#L249-L289" signature="soft_compare(other)">
  ...
  <Function id="qiskit.circuit.Gate.to_matrix" github="https://github.com/Qiskit/qiskit/tree/stable/1.3/qiskit/circuit/gate.py#L51-L63" signature="to_matrix()">
  ...
  <Function id="qiskit.circuit.Gate.to_mutable" github="https://github.com/Qiskit/qiskit/tree/stable/1.3/qiskit/circuit/instruction.py#L168-L176" signature="to_mutable()">
  ...
  <Function id="qiskit.circuit.Gate.validate_parameter" github="https://github.com/Qiskit/qiskit/tree/stable/1.3/qiskit/circuit/gate.py#L249-L263" signature="validate_parameter(parameter)">
