...
`qiskit.visualization.plot_error_map(backend, figsize=(12, 9), show_title=True, qubit_coordinates=None)`
...
*   **show\_title** ([*bool*](https://docs.python.org/3/library/functions.html#bool "(in Python v3.11)")) – Show the title or not.
...
![../\_images/qiskit-visualization-plot\_error\_map-1.png](/images/api/qiskit/qiskit-visualization-plot_error_map-1.png)
