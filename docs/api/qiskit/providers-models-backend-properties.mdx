...
description: API reference for qiskit.providers.models.BackendProperties in the latest version of qiskit
...
<Class id="qiskit.providers.models.BackendProperties" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.3/qiskit/providers/models/backendproperties.py#L166-L517" signature="qiskit.providers.models.BackendProperties(backend_name, backend_version, last_update_date, qubits, gates, general, **kwargs)" modifiers="class">
  ...
  *   **qubits** ([*list*](https://docs.python.org/3/library/stdtypes.html#list "(in Python v3.13)")) – System qubit parameters as a list of lists of [`Nduv`](providers-models-nduv "qiskit.providers.models.Nduv") objects
  *   **gates** ([*list*](https://docs.python.org/3/library/stdtypes.html#list "(in Python v3.13)")) – System gate parameters as a list of [`GateProperties`](providers-models-gate-properties "qiskit.providers.models.GateProperties") objects
  *   **general** ([*list*](https://docs.python.org/3/library/stdtypes.html#list "(in Python v3.13)")) – General parameters as a list of [`Nduv`](providers-models-nduv "qiskit.providers.models.Nduv") objects
