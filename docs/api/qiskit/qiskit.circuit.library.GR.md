...
`qiskit.circuit.library.GR(num_qubits, theta, phi)`
...
![../\_images/qiskit-circuit-library-GR-1.png](/images/api/qiskit/qiskit-circuit-library-GR-1.png)
...
*   **theta** ([*float*](https://docs.python.org/3/library/functions.html#float "(in Python v3.11)")) – rotation angle about axis determined by phi
*   **phi** ([*float*](https://docs.python.org/3/library/functions.html#float "(in Python v3.11)")) – angle of rotation axis in xy-plane
