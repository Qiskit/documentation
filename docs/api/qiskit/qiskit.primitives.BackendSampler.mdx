...
<Class id="qiskit.primitives.BackendSampler" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.0/qiskit/primitives/backend_sampler.py#L33-L213" signature="qiskit.primitives.BackendSampler(backend, options=None, bound_pass_manager=None, skip_transpilation=False)">
  ...
  **Raises**
  ...
  <Attribute id="qiskit.primitives.BackendSampler.backend" name="backend">
    Returns: The backend which this sampler object based on
  </Attribute>

  ### options

  <Attribute id="qiskit.primitives.BackendSampler.options" name="options">
  ...
  <Attribute id="qiskit.primitives.BackendSampler.preprocessed_circuits" name="preprocessed_circuits">
  ...
  <Attribute id="qiskit.primitives.BackendSampler.transpile_options" name="transpile_options">
    Return the transpiler options for transpiling the circuits.
  </Attribute>

  ### transpiled\_circuits

  <Attribute id="qiskit.primitives.BackendSampler.transpiled_circuits" name="transpiled_circuits">
  ...
  <Function id="qiskit.primitives.BackendSampler.run" name="run" github="https://github.com/Qiskit/qiskit/tree/stable/1.0/qiskit/primitives/base/base_sampler.py#L110-L141" signature="run(circuits, parameter_values=None, **run_options)">
  ...
  <Function id="qiskit.primitives.BackendSampler.set_options" name="set_options" github="https://github.com/Qiskit/qiskit/tree/stable/1.0/qiskit/primitives/base/base_primitive.py#L39-L45" signature="set_options(**fields)">
  ...
  <Function id="qiskit.primitives.BackendSampler.set_transpile_options" name="set_transpile_options" github="https://github.com/Qiskit/qiskit/tree/stable/1.0/qiskit/primitives/backend_sampler.py#L121-L130" signature="set_transpile_options(**fields)">
