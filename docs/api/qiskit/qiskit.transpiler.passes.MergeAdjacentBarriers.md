...
`qiskit.transpiler.passes.MergeAdjacentBarriers(*args, **kwargs)`
...
<span id="qiskit.transpiler.passes.MergeAdjacentBarriers.execute" />
...
<span id="qiskit.transpiler.passes.MergeAdjacentBarriers.update_status" />
