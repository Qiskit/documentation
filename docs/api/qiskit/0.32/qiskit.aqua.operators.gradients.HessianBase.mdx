---
title: HessianBase (v0.32)
description: API reference for qiskit.aqua.operators.gradients.HessianBase in qiskit v0.32
...
<Class id="qiskit.aqua.operators.gradients.HessianBase" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/aqua/operators/gradients/hessian_base.py" signature="HessianBase(hess_method='param_shift', **kwargs)" modifiers="class">
  ...
  **ValueError** – If method != `fin_diff` and `epsilon` is not None.
  ...
  <Function id="qiskit.aqua.operators.gradients.HessianBase.convert" signature="HessianBase.convert(operator, params=None)" modifiers="abstract">
    **Parameters**
  ...
  <span id="qiskit-aqua-operators-gradients-hessianbase-gradient-wrapper" />

  ### gradient\_wrapper

  <Function id="qiskit.aqua.operators.gradients.HessianBase.gradient_wrapper" signature="HessianBase.gradient_wrapper(operator, bind_params, grad_params=None, backend=None)">
  ...
  <span id="qiskit-aqua-operators-gradients-hessianbase-parameter-expression-grad" />

  ### parameter\_expression\_grad

  <Function id="qiskit.aqua.operators.gradients.HessianBase.parameter_expression_grad" signature="HessianBase.parameter_expression_grad(param_expr, param)" modifiers="static">
  ...
  <Attribute id="qiskit.aqua.operators.gradients.HessianBase.hess_method">
