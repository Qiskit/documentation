...
`OptimizationResult(x, fval, variables, status, raw_results=None, samples=None)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/optimization/algorithms/optimization_algorithm.py "view source code")
