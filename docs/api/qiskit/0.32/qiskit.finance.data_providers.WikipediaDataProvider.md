...
`WikipediaDataProvider(token=None, tickers=None, start=datetime.datetime(2016, 1, 1, 0, 0), end=datetime.datetime(2016, 1, 30, 0, 0))`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/finance/data_providers/wikipedia_data_provider.py "view source code")
...
`WikipediaDataProvider.run()`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/finance/data_providers/wikipedia_data_provider.py "view source code")
