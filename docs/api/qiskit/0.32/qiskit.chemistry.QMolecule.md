...
`QMolecule(filename=None)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/chemistry/qmolecule.py "view source code")
...
`QMolecule.Z(natom)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/chemistry/qmolecule.py "view source code")

### has\_dipole\_integrals

<span id="qiskit.chemistry.QMolecule.has_dipole_integrals" />

`QMolecule.has_dipole_integrals()`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/chemistry/qmolecule.py "view source code")
...
`QMolecule.load()`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/chemistry/qmolecule.py "view source code")
...
`QMolecule.log()`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/chemistry/qmolecule.py "view source code")
...
`static QMolecule.onee_to_spin(mohij, mohij_b=None, threshold=1e-12)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/chemistry/qmolecule.py "view source code")
...
`static QMolecule.oneeints2mo(ints, moc)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/chemistry/qmolecule.py "view source code")
...
`QMolecule.remove_file(file_name=None)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/chemistry/qmolecule.py "view source code")
...
`QMolecule.save(file_name=None)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/chemistry/qmolecule.py "view source code")
...
`static QMolecule.twoe_to_spin(mohijkl, mohijkl_bb=None, mohijkl_ba=None, threshold=1e-12)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/chemistry/qmolecule.py "view source code")
...
`static QMolecule.twoeints2mo(ints, moc)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/chemistry/qmolecule.py "view source code")
...
`static QMolecule.twoeints2mo_general(ints, moc1, moc2, moc3, moc4)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/chemistry/qmolecule.py "view source code")
