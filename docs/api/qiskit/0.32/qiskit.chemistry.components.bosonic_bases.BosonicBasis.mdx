...
<Class id="qiskit.chemistry.components.bosonic_bases.BosonicBasis" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/chemistry/components/bosonic_bases/bosonic_basis.py" signature="BosonicBasis">
  Bases: `object`
  ...
  <Function id="qiskit.chemistry.components.bosonic_bases.BosonicBasis.convert" name="convert" signature="BosonicBasis.convert(threshold=1e-06)">
