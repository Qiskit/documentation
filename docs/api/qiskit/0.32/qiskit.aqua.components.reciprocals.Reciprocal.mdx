...
<Class id="qiskit.aqua.components.reciprocals.Reciprocal" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/aqua/components/reciprocals/reciprocal.py" signature="Reciprocal">
  ...
  <Function id="qiskit.aqua.components.reciprocals.Reciprocal.construct_circuit" signature="abstract Reciprocal.construct_circuit(mode, register=None, circuit=None)">
  ...
  <Function id="qiskit.aqua.components.reciprocals.Reciprocal.sv_to_resvec" signature="abstract Reciprocal.sv_to_resvec(statevector, num_q)">
