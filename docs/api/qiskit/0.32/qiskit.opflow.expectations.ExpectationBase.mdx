...
<Class id="qiskit.opflow.expectations.ExpectationBase" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/opflow/expectations/expectation_base.py" signature="ExpectationBase">
  ...
  <Function id="qiskit.opflow.expectations.ExpectationBase.compute_variance" name="compute_variance" signature="abstract ExpectationBase.compute_variance(exp_op)">
  ...
  <Function id="qiskit.opflow.expectations.ExpectationBase.convert" name="convert" signature="abstract ExpectationBase.convert(operator)">
