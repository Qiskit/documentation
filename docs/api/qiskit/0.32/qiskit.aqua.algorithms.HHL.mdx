---
title: HHL (v0.32)
description: API reference for qiskit.aqua.algorithms.HHL in qiskit v0.32
...
$$
  ...
  **ValueError** – Invalid input
  ...
  <span id="qiskit-aqua-algorithms-hhl-construct-circuit" />
  ...
  <span id="qiskit-aqua-algorithms-hhl-expand-to-hermitian" />
  ...
  <span id="qiskit-aqua-algorithms-hhl-expand-to-powerdim" />
  ...
  <span id="qiskit-aqua-algorithms-hhl-matrix-resize" />
  ...
  <span id="qiskit-aqua-algorithms-hhl-set-backend" />
