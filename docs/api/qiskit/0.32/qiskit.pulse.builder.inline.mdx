---
title: inline (v0.32)
description: API reference for qiskit.pulse.builder.inline in qiskit v0.32
...
<Function id="qiskit.pulse.builder.inline" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/pulse/builder.py" signature="inline()">
