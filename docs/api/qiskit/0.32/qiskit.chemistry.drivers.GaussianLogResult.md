...
`GaussianLogResult(log)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/chemistry/drivers/gaussiand/gaussian_log_result.py "view source code")
...
`GaussianLogResult.get_watson_hamiltonian(normalize=True)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/chemistry/drivers/gaussiand/gaussian_log_result.py "view source code")
