...
<Class id="qiskit.ignis.measurement.DiscriminationFilter" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-ignis/tree/stable/0.6/qiskit/ignis/measurement/discriminator/filters.py" signature="DiscriminationFilter(discriminator, base=None)">
  Bases: `object`
