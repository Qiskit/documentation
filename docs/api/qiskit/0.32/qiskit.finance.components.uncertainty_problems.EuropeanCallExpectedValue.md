...
`EuropeanCallExpectedValue(uncertainty_model, strike_price, c_approx, i_state=None, i_compare=None, i_objective=None)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/finance/components/uncertainty_problems/european_call_expected_value.py "view source code")
...
`EuropeanCallExpectedValue.build(qc, q, q_ancillas=None, params=None)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/finance/components/uncertainty_problems/european_call_expected_value.py "view source code")
...
`EuropeanCallExpectedValue.required_ancillas()`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/finance/components/uncertainty_problems/european_call_expected_value.py "view source code")
...
`EuropeanCallExpectedValue.value_to_estimation(value)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/finance/components/uncertainty_problems/european_call_expected_value.py "view source code")
