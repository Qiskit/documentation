...
<Class id="qiskit.aqua.operators.list_ops.ListOp" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/aqua/operators/list_ops/list_op.py" signature="ListOp(oplist, combo_fn=<function ListOp.<lambda>>, coeff=1.0, abelian=False, grad_combo_fn=None)">
  ...
  *   **returns them in a list.** (*and*) –
  ...
  <Function id="qiskit.aqua.operators.list_ops.ListOp.add" name="add" signature="ListOp.add(other)">
  ...
  <Function id="qiskit.aqua.operators.list_ops.ListOp.adjoint" name="adjoint" signature="ListOp.adjoint()">
  ...
  <Function id="qiskit.aqua.operators.list_ops.ListOp.assign_parameters" name="assign_parameters" signature="ListOp.assign_parameters(param_dict)">
  ...
  <Function id="qiskit.aqua.operators.list_ops.ListOp.bind_parameters" name="bind_parameters" signature="ListOp.bind_parameters(param_dict)">
  ...
  <Function id="qiskit.aqua.operators.list_ops.ListOp.compose" name="compose" signature="ListOp.compose(other, permutation=None, front=False)">
  ...
  <Function id="qiskit.aqua.operators.list_ops.ListOp.equals" name="equals" signature="ListOp.equals(other)">
  ...
  <Function id="qiskit.aqua.operators.list_ops.ListOp.eval" name="eval" signature="ListOp.eval(front=None)">
  ...
  <Function id="qiskit.aqua.operators.list_ops.ListOp.exp_i" name="exp_i" signature="ListOp.exp_i()">
  ...
  <Function id="qiskit.aqua.operators.list_ops.ListOp.log_i" name="log_i" signature="ListOp.log_i(massive=False)">
  ...
  <Function id="qiskit.aqua.operators.list_ops.ListOp.mul" name="mul" signature="ListOp.mul(scalar)">
  ...
  <Function id="qiskit.aqua.operators.list_ops.ListOp.neg" name="neg" signature="ListOp.neg()">
  ...
  <Function id="qiskit.aqua.operators.list_ops.ListOp.permute" name="permute" signature="ListOp.permute(permutation)">
  ...
  <Function id="qiskit.aqua.operators.list_ops.ListOp.power" name="power" signature="ListOp.power(exponent)">
  ...
  <Function id="qiskit.aqua.operators.list_ops.ListOp.primitive_strings" name="primitive_strings" signature="ListOp.primitive_strings()">
  ...
  <Function id="qiskit.aqua.operators.list_ops.ListOp.reduce" name="reduce" signature="ListOp.reduce()">
  ...
  <Function id="qiskit.aqua.operators.list_ops.ListOp.tensor" name="tensor" signature="ListOp.tensor(other)">
  ...
  <Function id="qiskit.aqua.operators.list_ops.ListOp.tensorpower" name="tensorpower" signature="ListOp.tensorpower(other)">
  ...
  <Function id="qiskit.aqua.operators.list_ops.ListOp.to_circuit_op" name="to_circuit_op" signature="ListOp.to_circuit_op()">
  ...
  <Function id="qiskit.aqua.operators.list_ops.ListOp.to_legacy_op" name="to_legacy_op" signature="ListOp.to_legacy_op(massive=False)">
  ...
  <Function id="qiskit.aqua.operators.list_ops.ListOp.to_matrix" name="to_matrix" signature="ListOp.to_matrix(massive=False)">
  ...
  <Function id="qiskit.aqua.operators.list_ops.ListOp.to_matrix_op" name="to_matrix_op" signature="ListOp.to_matrix_op(massive=False)">
  ...
  <Function id="qiskit.aqua.operators.list_ops.ListOp.to_pauli_op" name="to_pauli_op" signature="ListOp.to_pauli_op(massive=False)">
  ...
  <Function id="qiskit.aqua.operators.list_ops.ListOp.to_spmatrix" name="to_spmatrix" signature="ListOp.to_spmatrix()">
  ...
  <Function id="qiskit.aqua.operators.list_ops.ListOp.traverse" name="traverse" signature="ListOp.traverse(convert_fn, coeff=None)">
  ...
  <Attribute id="qiskit.aqua.operators.list_ops.ListOp.ENABLE_DEPRECATION" name="ENABLE_DEPRECATION" attributeValue="True" />

  ### INDENTATION

  <Attribute id="qiskit.aqua.operators.list_ops.ListOp.INDENTATION" name="INDENTATION" attributeValue="'  '" />

  ### abelian

  <Attribute id="qiskit.aqua.operators.list_ops.ListOp.abelian" name="abelian">
  ...
  <Attribute id="qiskit.aqua.operators.list_ops.ListOp.coeff" name="coeff">
  ...
  <Attribute id="qiskit.aqua.operators.list_ops.ListOp.combo_fn" name="combo_fn">
  ...
  <Attribute id="qiskit.aqua.operators.list_ops.ListOp.distributive" name="distributive">
  ...
  <Attribute id="qiskit.aqua.operators.list_ops.ListOp.grad_combo_fn" name="grad_combo_fn">
  ...
  <Attribute id="qiskit.aqua.operators.list_ops.ListOp.num_qubits" name="num_qubits">
    **Return type**
  ...
  <Attribute id="qiskit.aqua.operators.list_ops.ListOp.oplist" name="oplist">
  ...
  <Attribute id="qiskit.aqua.operators.list_ops.ListOp.parameters" name="parameters" />
</Class>
