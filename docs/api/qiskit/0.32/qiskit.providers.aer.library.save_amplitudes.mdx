...
<Function id="qiskit.providers.aer.library.save_amplitudes" name="save_amplitudes" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-aer/tree/stable/0.9/qiskit/providers/aer/library/save_instructions/save_amplitudes.py" signature="save_amplitudes(self, params, label='amplitudes', pershot=False, conditional=False)">
