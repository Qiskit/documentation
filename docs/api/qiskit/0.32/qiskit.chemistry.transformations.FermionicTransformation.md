...
`FermionicTransformation.build_hopping_operators(excitations='sd')`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/chemistry/transformations/fermionic_transformation.py "view source code")
...
`FermionicTransformation.get_default_filter_criterion()`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/chemistry/transformations/fermionic_transformation.py "view source code")
...
`FermionicTransformation.interpret(raw_result)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/chemistry/transformations/fermionic_transformation.py "view source code")
...
`FermionicTransformation.transform(driver, aux_operators=None)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/chemistry/transformations/fermionic_transformation.py "view source code")
