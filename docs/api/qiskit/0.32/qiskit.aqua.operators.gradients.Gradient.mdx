---
title: Gradient (v0.32)
description: API reference for qiskit.aqua.operators.gradients.Gradient in qiskit v0.32
...
<Class id="qiskit.aqua.operators.gradients.Gradient" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/aqua/operators/gradients/gradient.py" signature="Gradient(grad_method='param_shift', **kwargs)" modifiers="class">
  ...
  **ValueError** – If method != `fin_diff` and `epsilon` is not None.
  ...
  <span id="qiskit-aqua-operators-gradients-gradient-get-gradient" />
  ...
  <span id="qiskit-aqua-operators-gradients-gradient-gradient-wrapper" />
  ...
  <span id="qiskit-aqua-operators-gradients-gradient-parameter-expression-grad" />
