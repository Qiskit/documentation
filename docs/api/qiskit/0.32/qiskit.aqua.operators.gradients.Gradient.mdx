...
<Class id="qiskit.aqua.operators.gradients.Gradient" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/aqua/operators/gradients/gradient.py" signature="Gradient(grad_method='param_shift', **kwargs)">
  ...
  **ValueError** – If method != `fin_diff` and `epsilon` is not None.
  ...
  <Function id="qiskit.aqua.operators.gradients.Gradient.convert" name="convert" signature="Gradient.convert(operator, params=None)">
    **Parameters**
  ...
  <Function id="qiskit.aqua.operators.gradients.Gradient.get_gradient" name="get_gradient" signature="Gradient.get_gradient(operator, params)">
  ...
  <Function id="qiskit.aqua.operators.gradients.Gradient.gradient_wrapper" name="gradient_wrapper" signature="Gradient.gradient_wrapper(operator, bind_params, grad_params=None, backend=None)">
  ...
  <Function id="qiskit.aqua.operators.gradients.Gradient.parameter_expression_grad" name="parameter_expression_grad" signature="static Gradient.parameter_expression_grad(param_expr, param)">
  ...
  <Attribute id="qiskit.aqua.operators.gradients.Gradient.grad_method" name="grad_method">
