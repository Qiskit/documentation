...
`OptimizationResultStatus(value)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/optimization/algorithms/optimization_algorithm.py "view source code")
