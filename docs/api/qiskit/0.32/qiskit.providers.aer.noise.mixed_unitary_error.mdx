...
<Function id="qiskit.providers.aer.noise.mixed_unitary_error" name="mixed_unitary_error" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-aer/tree/stable/0.9/qiskit/providers/aer/noise/errors/standard_errors.py" signature="mixed_unitary_error(noise_ops, standard_gates=True)">
