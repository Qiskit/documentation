...
<Class id="qiskit.chemistry.drivers.FCIDumpDriver" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/chemistry/drivers/fcidumpd/fcidumpdriver.py" signature="FCIDumpDriver(fcidump_input, atoms=None)">
  ...
  **Raises**
  ...
  <Function id="qiskit.chemistry.drivers.FCIDumpDriver.dump" name="dump" signature="static FCIDumpDriver.dump(q_mol, outpath, orbsym=None, isym=1)">
  ...
  <Function id="qiskit.chemistry.drivers.FCIDumpDriver.run" name="run" signature="FCIDumpDriver.run()">
  ...
  <Attribute id="qiskit.chemistry.drivers.FCIDumpDriver.basis" name="basis">
    return basis
  ...
  <Attribute id="qiskit.chemistry.drivers.FCIDumpDriver.hf_method" name="hf_method">
  ...
  <Attribute id="qiskit.chemistry.drivers.FCIDumpDriver.molecule" name="molecule">
    return molecule
  ...
  <Attribute id="qiskit.chemistry.drivers.FCIDumpDriver.supports_molecule" name="supports_molecule">
