...
<Class id="qiskit.aqua.algorithms.IterativeAmplitudeEstimation" github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/aqua/algorithms/amplitude_estimators/iqae.py" signature="IterativeAmplitudeEstimation(epsilon, alpha, confint_method='beta', min_ratio=2, state_preparation=None, grover_operator=None, objective_qubits=None, post_processing=None, a_factory=None, q_factory=None, i_objective=None, initial_state=None, quantum_instance=None)">
  ...
  **Raises**
  ...
  <Function id="qiskit.aqua.algorithms.IterativeAmplitudeEstimation.construct_circuit" name="construct_circuit" signature="IterativeAmplitudeEstimation.construct_circuit(k, measurement=False)">
  ...
  <Function id="qiskit.aqua.algorithms.IterativeAmplitudeEstimation.is_good_state" name="is_good_state" signature="IterativeAmplitudeEstimation.is_good_state(measurement)">
  ...
  <Function id="qiskit.aqua.algorithms.IterativeAmplitudeEstimation.post_processing" name="post_processing" signature="IterativeAmplitudeEstimation.post_processing(value)">
  ...
  <Function id="qiskit.aqua.algorithms.IterativeAmplitudeEstimation.run" name="run" signature="IterativeAmplitudeEstimation.run(quantum_instance=None, **kwargs)">
  ...
  <Function id="qiskit.aqua.algorithms.IterativeAmplitudeEstimation.set_backend" name="set_backend" signature="IterativeAmplitudeEstimation.set_backend(backend, **kwargs)">
  ...
  <Attribute id="qiskit.aqua.algorithms.IterativeAmplitudeEstimation.a_factory" name="a_factory">
  ...
  <Attribute id="qiskit.aqua.algorithms.IterativeAmplitudeEstimation.backend" name="backend">
    Returns backend.
  ...
  <Attribute id="qiskit.aqua.algorithms.IterativeAmplitudeEstimation.grover_operator" name="grover_operator">
  ...
  <Attribute id="qiskit.aqua.algorithms.IterativeAmplitudeEstimation.i_objective" name="i_objective">
  ...
  <Attribute id="qiskit.aqua.algorithms.IterativeAmplitudeEstimation.objective_qubits" name="objective_qubits">
  ...
  <Attribute id="qiskit.aqua.algorithms.IterativeAmplitudeEstimation.precision" name="precision">
  ...
  <Attribute id="qiskit.aqua.algorithms.IterativeAmplitudeEstimation.q_factory" name="q_factory">
  ...
  <Attribute id="qiskit.aqua.algorithms.IterativeAmplitudeEstimation.quantum_instance" name="quantum_instance">
  ...
  <Attribute id="qiskit.aqua.algorithms.IterativeAmplitudeEstimation.random" name="random">
    Return a numpy random.
  </Attribute>

  ### state\_preparation

  <Attribute id="qiskit.aqua.algorithms.IterativeAmplitudeEstimation.state_preparation" name="state_preparation">
