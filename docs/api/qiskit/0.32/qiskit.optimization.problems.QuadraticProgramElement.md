...
`QuadraticProgramElement(quadratic_program)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/optimization/problems/quadratic_program_element.py "view source code")
