---
title: LinearIQDiscriminator (v0.32)
description: API reference for qiskit.ignis.measurement.LinearIQDiscriminator in qiskit v0.32
...
<Class id="qiskit.ignis.measurement.LinearIQDiscriminator" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-ignis/tree/stable/0.6/qiskit/ignis/measurement/discriminator/iq_discriminators.py" signature="LinearIQDiscriminator(cal_results, qubit_mask, expected_states=None, standardize=False, schedules=None, discriminator_parameters=None)" modifiers="class">
  ...
  **ImportError** – If scikit-learn is not installed
  ...
  <span id="qiskit-ignis-measurement-lineariqdiscriminator-add-data" />
  ...
  <span id="qiskit-ignis-measurement-lineariqdiscriminator-format-iq-data" />
  ...
  <span id="qiskit-ignis-measurement-lineariqdiscriminator-get-xdata" />
  ...
  <span id="qiskit-ignis-measurement-lineariqdiscriminator-get-ydata" />
  ...
  <span id="qiskit-ignis-measurement-lineariqdiscriminator-is-calibration" />
  ...
  <span id="qiskit-ignis-measurement-lineariqdiscriminator-plot-xdata" />
