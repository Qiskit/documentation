...
`PrimitiveOp.to_legacy_op(massive=False)`
...
<span id="qiskit.aqua.operators.primitive_ops.PrimitiveOp.ENABLE_DEPRECATION" />

### ENABLE\_DEPRECATION

`= True`

<span id="qiskit.aqua.operators.primitive_ops.PrimitiveOp.INDENTATION" />
