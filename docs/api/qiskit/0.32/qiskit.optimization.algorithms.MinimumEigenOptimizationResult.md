...
`MinimumEigenOptimizationResult(x, fval, variables, status, samples=None, min_eigen_solver_result=None, raw_samples=None)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/optimization/algorithms/minimum_eigen_optimizer.py "view source code")
...
`MinimumEigenOptimizationResult.get_correlations()`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/optimization/algorithms/minimum_eigen_optimizer.py "view source code")
