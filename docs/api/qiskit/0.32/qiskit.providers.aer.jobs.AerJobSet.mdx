---
title: AerJobSet (v0.32)
description: API reference for qiskit.providers.aer.jobs.AerJobSet in qiskit v0.32
...
<Class id="qiskit.providers.aer.jobs.AerJobSet" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-aer/tree/stable/0.9/qiskit/providers/aer/jobs/aerjobset.py" signature="AerJobSet(backend, job_id, fn, experiments, executor=None)" modifiers="class">
  ...
  *   **executor** (*ThreadPoolExecutor or dask.distributed.client*) – The executor to be used to submit the job.
  ...
  <span id="qiskit-providers-aer-jobs-aerjobset-in-final-state" />
  ...
  <span id="qiskit-providers-aer-jobs-aerjobset-job-id" />
  ...
  <span id="qiskit-providers-aer-jobs-aerjobset-wait-for-final-state" />
  ...
  <span id="qiskit-providers-aer-jobs-aerjobset-worker-job" />
  ...
  <span id="qiskit-providers-aer-jobs-aerjobset-worker-results" />
