...
<Class id="qiskit.optimization.algorithms.CobylaOptimizer" github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/optimization/algorithms/cobyla_optimizer.py" signature="CobylaOptimizer(rhobeg=1.0, rhoend=0.0001, maxfun=1000, disp=None, catol=0.0002, trials=1, clip=100.0)">
  ...
  *   **clip** (`float`) – Clipping parameter for the initial guesses in the multi-start method. If a variable is unbounded then the lower bound and/or upper bound are replaced with the `-clip` or `clip` values correspondingly for the initial guesses.
  ...
  <Function id="qiskit.optimization.algorithms.CobylaOptimizer.get_compatibility_msg" name="get_compatibility_msg" signature="CobylaOptimizer.get_compatibility_msg(problem)">
  ...
  <Function id="qiskit.optimization.algorithms.CobylaOptimizer.is_compatible" name="is_compatible" signature="CobylaOptimizer.is_compatible(problem)">
  ...
  <Function id="qiskit.optimization.algorithms.CobylaOptimizer.multi_start_solve" name="multi_start_solve" signature="CobylaOptimizer.multi_start_solve(minimize, problem)">
  ...
  <Function id="qiskit.optimization.algorithms.CobylaOptimizer.solve" name="solve" signature="CobylaOptimizer.solve(problem)">
  ...
  <Attribute id="qiskit.optimization.algorithms.CobylaOptimizer.clip" name="clip">
  ...
  <Attribute id="qiskit.optimization.algorithms.CobylaOptimizer.trials" name="trials">
