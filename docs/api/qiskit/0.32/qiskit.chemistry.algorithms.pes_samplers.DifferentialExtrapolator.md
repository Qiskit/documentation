...
`DifferentialExtrapolator(degree=1, model=None)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/chemistry/algorithms/pes_samplers/extrapolator.py "view source code")
...
`DifferentialExtrapolator.extrapolate(points, param_dict)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/chemistry/algorithms/pes_samplers/extrapolator.py "view source code")
