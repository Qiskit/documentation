...
`BOPESSamplerResult(points, energies, raw_results)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/chemistry/results/bopes_sampler_result.py "view source code")
...
`BOPESSamplerResult.point_results(point)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/chemistry/results/bopes_sampler_result.py "view source code")
