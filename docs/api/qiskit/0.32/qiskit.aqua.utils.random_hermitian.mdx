---
title: random_hermitian (v0.32)
description: API reference for qiskit.aqua.utils.random_hermitian in qiskit v0.32
...
<Function id="qiskit.aqua.utils.random_hermitian" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/aqua/utils/random_matrix_generator.py" signature="random_hermitian(N, eigs=None, K=None, eigrange=None, sparsity=None, trunc=None)">
