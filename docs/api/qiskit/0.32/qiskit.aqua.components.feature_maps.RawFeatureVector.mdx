...
<Class id="qiskit.aqua.components.feature_maps.RawFeatureVector" github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/aqua/components/feature_maps/raw_feature_vector.py" signature="RawFeatureVector(feature_dimension=2)">
  ...
  **feature\_dimension** (`int`) – The feature dimension, has a minimum value of 1.
  ...
  <Function id="qiskit.aqua.components.feature_maps.RawFeatureVector.get_entangler_map" signature="static RawFeatureVector.get_entangler_map(map_type, num_qubits)">
    get entangle map
  </Function>

  ### validate\_entangler\_map

  <Function id="qiskit.aqua.components.feature_maps.RawFeatureVector.validate_entangler_map" signature="static RawFeatureVector.validate_entangler_map(entangler_map, num_qubits)">
  ...
  <Attribute id="qiskit.aqua.components.feature_maps.RawFeatureVector.feature_dimension" name="feature_dimension">
    returns feature dimension
  </Attribute>

  ### num\_qubits

  <Attribute id="qiskit.aqua.components.feature_maps.RawFeatureVector.num_qubits" name="num_qubits">
    returns number of qubits
  </Attribute>

  ### support\_parameterized\_circuit

  <Attribute id="qiskit.aqua.components.feature_maps.RawFeatureVector.support_parameterized_circuit" name="support_parameterized_circuit">
