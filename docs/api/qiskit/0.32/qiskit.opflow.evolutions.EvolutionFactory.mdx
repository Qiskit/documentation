---
title: EvolutionFactory (v0.32)
description: API reference for qiskit.opflow.evolutions.EvolutionFactory in qiskit v0.32
...
<Class id="qiskit.opflow.evolutions.EvolutionFactory" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/opflow/evolutions/evolution_factory.py" signature="EvolutionFactory" modifiers="class">
  Bases: `object`
