...
<Class id="qiskit.optimization.problems.Variable" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/optimization/problems/variable.py" signature="Variable(quadratic_program, name, lowerbound=0, upperbound=1e+20, vartype=<VarType.CONTINUOUS: 0>)">
  ...
  **Raises**
  ...
  <Attribute id="qiskit.optimization.problems.Variable.lowerbound" name="lowerbound">
  ...
  <Attribute id="qiskit.optimization.problems.Variable.name" name="name">
  ...
  <Attribute id="qiskit.optimization.problems.Variable.quadratic_program" name="quadratic_program">
  ...
  <Attribute id="qiskit.optimization.problems.Variable.upperbound" name="upperbound">
  ...
  <Attribute id="qiskit.optimization.problems.Variable.vartype" name="vartype">
