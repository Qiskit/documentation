...
`GroundStateSolver(transformation)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/chemistry/algorithms/ground_state_solvers/ground_state_solver.py "view source code")
...
`abstract GroundStateSolver.evaluate_operators(state, operators)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/chemistry/algorithms/ground_state_solvers/ground_state_solver.py "view source code")
...
`abstract GroundStateSolver.returns_groundstate()`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/chemistry/algorithms/ground_state_solvers/ground_state_solver.py "view source code")
...
`abstract GroundStateSolver.solve(driver, aux_operators=None)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/chemistry/algorithms/ground_state_solvers/ground_state_solver.py "view source code")
