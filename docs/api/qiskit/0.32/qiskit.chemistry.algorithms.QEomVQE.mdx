...
<Class id="qiskit.chemistry.algorithms.QEomVQE" github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/chemistry/algorithms/eigen_solvers/q_eom_vqe.py" signature="QEomVQE(operator, var_form, optimizer, num_orbitals, num_particles, initial_point=None, max_evals_grouped=1, callback=None, qubit_mapping='parity', two_qubit_reduction=True, is_eom_matrix_symmetric=True, active_occupied=None, active_unoccupied=None, se_list=None, de_list=None, z2_symmetries=None, untapered_op=None, aux_operators=None, quantum_instance=None)">
  ...
  **ValueError** – invalid parameter
  ...
  <Function id="qiskit.chemistry.algorithms.QEomVQE.supports_aux_operators" signature="classmethod QEomVQE.supports_aux_operators()">
  ...
  <Attribute id="qiskit.chemistry.algorithms.QEomVQE.aux_operators" name="aux_operators">
  ...
  <Attribute id="qiskit.chemistry.algorithms.QEomVQE.backend" name="backend">
    Returns backend.
  ...
  <Attribute id="qiskit.chemistry.algorithms.QEomVQE.expectation" name="expectation">
  ...
  <Attribute id="qiskit.chemistry.algorithms.QEomVQE.initial_point" name="initial_point">
  ...
  <Attribute id="qiskit.chemistry.algorithms.QEomVQE.operator" name="operator">
    Returns operator
  ...
  <Attribute id="qiskit.chemistry.algorithms.QEomVQE.optimal_params" name="optimal_params">
  ...
  <Attribute id="qiskit.chemistry.algorithms.QEomVQE.optimizer" name="optimizer">
    Returns optimizer
  ...
  <Attribute id="qiskit.chemistry.algorithms.QEomVQE.quantum_instance" name="quantum_instance">
  ...
  <Attribute id="qiskit.chemistry.algorithms.QEomVQE.var_form" name="var_form">
