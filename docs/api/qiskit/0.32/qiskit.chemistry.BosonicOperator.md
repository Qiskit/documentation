...
`BosonicOperator(h, basis)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/chemistry/bosonic_operator.py "view source code")
...
`BosonicOperator.direct_mapping_filtering_criterion(state, value, aux_values=None)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/chemistry/bosonic_operator.py "view source code")
...
`BosonicOperator.mapping(qubit_mapping='direct', threshold=1e-08)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/chemistry/bosonic_operator.py "view source code")
...
`BosonicOperator.number_occupied_modals_per_mode(mode)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/chemistry/bosonic_operator.py "view source code")
