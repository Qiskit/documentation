---
title: AncillaRegister (v0.32)
description: API reference for qiskit.circuit.AncillaRegister in qiskit v0.32
...
<Class id="qiskit.circuit.AncillaRegister" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/circuit/quantumregister.py" signature="AncillaRegister(size=None, name=None, bits=None)" modifiers="class">
