...
`QEOM(ground_state_solver, excitations='sd')`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/chemistry/algorithms/excited_states_solvers/qeom.py "view source code")
...
`QEOM.solve(driver, aux_operators=None)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/chemistry/algorithms/excited_states_solvers/qeom.py "view source code")
