...
<Function id="qiskit.ignis.verification.postselection_decoding" github="https://github.com/qiskit-community/qiskit-ignis/tree/stable/0.6/qiskit/ignis/verification/topological_codes/fitters.py" signature="postselection_decoding(results)">
