---
title: library (v0.32)
description: API reference for qiskit.ml.circuit.library in qiskit v0.32
...
<span id="circuit-library-for-machine-learning-applications-qiskit-ml-circuit-library" />
