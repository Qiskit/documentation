---
title: StatevectorSimulator (v0.32)
description: API reference for qiskit.providers.aer.StatevectorSimulator in qiskit v0.32
...
<Class id="qiskit.providers.aer.StatevectorSimulator" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-aer/tree/stable/0.9/qiskit/providers/aer/backends/statevector_simulator.py" signature="StatevectorSimulator(configuration=None, properties=None, provider=None, **backend_options)" modifiers="class">
