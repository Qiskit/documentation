---
title: RemoveDiagonalGatesBeforeMeasure (v0.32)
description: API reference for qiskit.transpiler.passes.RemoveDiagonalGatesBeforeMeasure in qiskit v0.32
...
<Class id="qiskit.transpiler.passes.RemoveDiagonalGatesBeforeMeasure" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/transpiler/passes/optimization/remove_diagonal_gates_before_measure.py" signature="RemoveDiagonalGatesBeforeMeasure(*args, **kwargs)" modifiers="class">
