...
<Class id="qiskit.chemistry.transformations.BosonicTransformation" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/chemistry/transformations/bosonic_transformation.py" signature="BosonicTransformation(qubit_mapping=<BosonicQubitMappingType.DIRECT: 'direct'>, transformation_type=<BosonicTransformationType.HARMONIC: 'harmonic'>, basis_size=2, truncation=3)">
  ...
  *   **truncation** (`int`) – where is the Hamiltonian expansion truncation (1 for having only 1-body terms, 2 for having on 1- and 2-body terms…)
  ...
  <Function id="qiskit.chemistry.transformations.BosonicTransformation.build_hopping_operators" name="build_hopping_operators" signature="BosonicTransformation.build_hopping_operators(excitations='sd')">
    **Parameters**
  ...
  <Function id="qiskit.chemistry.transformations.BosonicTransformation.get_default_filter_criterion" name="get_default_filter_criterion" signature="BosonicTransformation.get_default_filter_criterion()">
  ...
  <Function id="qiskit.chemistry.transformations.BosonicTransformation.interpret" name="interpret" signature="BosonicTransformation.interpret(raw_result)">
  ...
  <Function id="qiskit.chemistry.transformations.BosonicTransformation.transform" name="transform" signature="BosonicTransformation.transform(driver, aux_operators=None)">
  ...
  <Attribute id="qiskit.chemistry.transformations.BosonicTransformation.basis" name="basis">
  ...
  <Attribute id="qiskit.chemistry.transformations.BosonicTransformation.commutation_rule" name="commutation_rule">
  ...
  <Attribute id="qiskit.chemistry.transformations.BosonicTransformation.num_modes" name="num_modes">
    the number of modes
  ...
  <Attribute id="qiskit.chemistry.transformations.BosonicTransformation.untapered_qubit_op" name="untapered_qubit_op">
