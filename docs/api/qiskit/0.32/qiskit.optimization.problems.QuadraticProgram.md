...
`QuadraticProgram(name='')`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/optimization/problems/quadratic_program.py "view source code")
...
`QuadraticProgram.binary_var(name=None)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/optimization/problems/quadratic_program.py "view source code")
...
`QuadraticProgram.binary_var_dict(keys, name=None, key_format='{}')`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/optimization/problems/quadratic_program.py "view source code")
...
`QuadraticProgram.binary_var_list(keys, name=None, key_format='{}')`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/optimization/problems/quadratic_program.py "view source code")
...
`QuadraticProgram.clear()`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/optimization/problems/quadratic_program.py "view source code")
...
`QuadraticProgram.continuous_var(lowerbound=0, upperbound=1e+20, name=None)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/optimization/problems/quadratic_program.py "view source code")
...
`QuadraticProgram.continuous_var_dict(keys, lowerbound=0, upperbound=1e+20, name=None, key_format='{}')`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/optimization/problems/quadratic_program.py "view source code")
...
`QuadraticProgram.continuous_var_list(keys, lowerbound=0, upperbound=1e+20, name=None, key_format='{}')`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/optimization/problems/quadratic_program.py "view source code")
...
`QuadraticProgram.export_as_lp_string()`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/optimization/problems/quadratic_program.py "view source code")
...
`QuadraticProgram.from_docplex(model)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/optimization/problems/quadratic_program.py "view source code")
...
`QuadraticProgram.from_ising(qubit_op, offset=0.0, linear=False)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/optimization/problems/quadratic_program.py "view source code")
...
`QuadraticProgram.get_feasibility_info(x)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/optimization/problems/quadratic_program.py "view source code")
...
`QuadraticProgram.get_linear_constraint(i)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/optimization/problems/quadratic_program.py "view source code")
...
`QuadraticProgram.get_num_binary_vars()`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/optimization/problems/quadratic_program.py "view source code")
...
`QuadraticProgram.get_num_continuous_vars()`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/optimization/problems/quadratic_program.py "view source code")
...
`QuadraticProgram.get_num_integer_vars()`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/optimization/problems/quadratic_program.py "view source code")
...
`QuadraticProgram.get_num_linear_constraints()`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/optimization/problems/quadratic_program.py "view source code")
...
`QuadraticProgram.get_num_quadratic_constraints()`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/optimization/problems/quadratic_program.py "view source code")
...
`QuadraticProgram.get_num_vars(vartype=None)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/optimization/problems/quadratic_program.py "view source code")
...
`QuadraticProgram.get_quadratic_constraint(i)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/optimization/problems/quadratic_program.py "view source code")
...
`QuadraticProgram.get_variable(i)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/optimization/problems/quadratic_program.py "view source code")
...
`QuadraticProgram.integer_var(lowerbound=0, upperbound=1e+20, name=None)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/optimization/problems/quadratic_program.py "view source code")
...
`QuadraticProgram.integer_var_dict(keys, lowerbound=0, upperbound=1e+20, name=None, key_format='{}')`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/optimization/problems/quadratic_program.py "view source code")
...
`QuadraticProgram.integer_var_list(keys, lowerbound=0, upperbound=1e+20, name=None, key_format='{}')`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/optimization/problems/quadratic_program.py "view source code")
...
`QuadraticProgram.is_feasible(x)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/optimization/problems/quadratic_program.py "view source code")
...
`QuadraticProgram.linear_constraint(linear=None, sense='<=', rhs=0.0, name=None)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/optimization/problems/quadratic_program.py "view source code")
...
`QuadraticProgram.maximize(constant=0.0, linear=None, quadratic=None)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/optimization/problems/quadratic_program.py "view source code")
...
`QuadraticProgram.minimize(constant=0.0, linear=None, quadratic=None)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/optimization/problems/quadratic_program.py "view source code")
...
`QuadraticProgram.pprint_as_string()`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/optimization/problems/quadratic_program.py "view source code")
...
`QuadraticProgram.prettyprint(out=None)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/optimization/problems/quadratic_program.py "view source code")
...
`QuadraticProgram.quadratic_constraint(linear=None, quadratic=None, sense='<=', rhs=0.0, name=None)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/optimization/problems/quadratic_program.py "view source code")
...
`QuadraticProgram.read_from_lp_file(filename)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/optimization/problems/quadratic_program.py "view source code")
...
`QuadraticProgram.remove_linear_constraint(i)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/optimization/problems/quadratic_program.py "view source code")
...
`QuadraticProgram.remove_quadratic_constraint(i)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/optimization/problems/quadratic_program.py "view source code")
...
`QuadraticProgram.substitute_variables(constants=None, variables=None)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/optimization/problems/quadratic_program.py "view source code")
...
`QuadraticProgram.to_docplex()`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/optimization/problems/quadratic_program.py "view source code")
...
`QuadraticProgram.to_ising()`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/optimization/problems/quadratic_program.py "view source code")
...
`QuadraticProgram.write_to_lp_file(filename)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/optimization/problems/quadratic_program.py "view source code")
...
<span id="qiskit.optimization.problems.QuadraticProgram.linear_constraints" />
...
<span id="qiskit.optimization.problems.QuadraticProgram.quadratic_constraints_index" />
