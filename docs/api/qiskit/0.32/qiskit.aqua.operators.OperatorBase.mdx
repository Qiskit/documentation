...
<Class id="qiskit.aqua.operators.OperatorBase" github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/aqua/operators/operator_base.py" signature="OperatorBase">
  ...
  <Function id="qiskit.aqua.operators.OperatorBase.add" signature="abstract OperatorBase.add(other)">
  ...
  <Function id="qiskit.aqua.operators.OperatorBase.adjoint" signature="abstract OperatorBase.adjoint()">
  ...
  <Function id="qiskit.aqua.operators.OperatorBase.assign_parameters" signature="abstract OperatorBase.assign_parameters(param_dict)">
  ...
  <Function id="qiskit.aqua.operators.OperatorBase.compose" signature="abstract OperatorBase.compose(other, permutation=None, front=False)">
  ...
  <Function id="qiskit.aqua.operators.OperatorBase.equals" signature="abstract OperatorBase.equals(other)">
  ...
  <Function id="qiskit.aqua.operators.OperatorBase.eval" signature="abstract OperatorBase.eval(front=None)">
  ...
  <Function id="qiskit.aqua.operators.OperatorBase.mul" signature="abstract OperatorBase.mul(scalar)">
  ...
  <Function id="qiskit.aqua.operators.OperatorBase.permute" signature="abstract OperatorBase.permute(permutation)">
  ...
  <Function id="qiskit.aqua.operators.OperatorBase.power" signature="abstract OperatorBase.power(exponent)">
  ...
  <Function id="qiskit.aqua.operators.OperatorBase.primitive_strings" signature="abstract OperatorBase.primitive_strings()">
  ...
  <Function id="qiskit.aqua.operators.OperatorBase.reduce" signature="abstract OperatorBase.reduce()">
  ...
  <Function id="qiskit.aqua.operators.OperatorBase.tensor" signature="abstract OperatorBase.tensor(other)">
  ...
  <Function id="qiskit.aqua.operators.OperatorBase.tensorpower" signature="abstract OperatorBase.tensorpower(other)">
  ...
  <Function id="qiskit.aqua.operators.OperatorBase.to_legacy_op" signature="abstract OperatorBase.to_legacy_op(massive=False)">
  ...
  <Function id="qiskit.aqua.operators.OperatorBase.to_matrix" signature="abstract OperatorBase.to_matrix(massive=False)">
