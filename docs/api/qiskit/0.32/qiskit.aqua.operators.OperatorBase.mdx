...
<Class id="qiskit.aqua.operators.OperatorBase" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/aqua/operators/operator_base.py" signature="OperatorBase">
  ...
  <Attribute id="qiskit.aqua.operators.OperatorBase.ENABLE_DEPRECATION" attributeValue="True" />

  ### INDENTATION

  <Attribute id="qiskit.aqua.operators.OperatorBase.INDENTATION" attributeValue="'  '" />

  ### num\_qubits

  <Attribute id="qiskit.aqua.operators.OperatorBase.num_qubits">
  ...
  <Attribute id="qiskit.aqua.operators.OperatorBase.parameters">
