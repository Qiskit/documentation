...
<Class id="qiskit.aqua.components.initial_states.InitialState" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/aqua/components/initial_states/initial_state.py" signature="InitialState">
  ...
  <Function id="qiskit.aqua.components.initial_states.InitialState.construct_circuit" name="construct_circuit" signature="abstract InitialState.construct_circuit(mode='circuit', register=None)">
  ...
  <Attribute id="qiskit.aqua.components.initial_states.InitialState.bitstr" name="bitstr" />
</Class>
