---
title: WindowExtrapolator (v0.32)
description: API reference for qiskit.chemistry.algorithms.pes_samplers.WindowExtrapolator in qiskit v0.32
...
<Class id="qiskit.chemistry.algorithms.pes_samplers.WindowExtrapolator" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/chemistry/algorithms/pes_samplers/extrapolator.py" signature="WindowExtrapolator(extrapolator=None, window=2)" modifiers="class">
  ...
  *   **window** (`int`) – Number of previous points to use for extrapolation. A value of zero indicates that all previous points will be used for bootstrapping.
  ...
  <span id="qiskit-chemistry-algorithms-pes-samplers-windowextrapolator-extrapolate" />

  ### extrapolate

  <Function id="qiskit.chemistry.algorithms.pes_samplers.WindowExtrapolator.extrapolate" signature="WindowExtrapolator.extrapolate(points, param_dict)">
  ...
  <span id="qiskit-chemistry-algorithms-pes-samplers-windowextrapolator-factory" />

  ### factory

  <Function id="qiskit.chemistry.algorithms.pes_samplers.WindowExtrapolator.factory" signature="WindowExtrapolator.factory(mode, **kwargs)" modifiers="static">
