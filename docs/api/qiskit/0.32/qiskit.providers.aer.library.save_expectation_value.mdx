---
title: save_expectation_value (v0.32)
description: API reference for qiskit.providers.aer.library.save_expectation_value in qiskit v0.32
...
<Function id="qiskit.providers.aer.library.save_expectation_value" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-aer/tree/stable/0.9/qiskit/providers/aer/library/save_instructions/save_expectation_value.py" signature="save_expectation_value(self, operator, qubits, label='expectation_value', unnormalized=False, pershot=False, conditional=False)">
