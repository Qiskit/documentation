...
`VibronicStructureResult(a_dict=None)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/chemistry/results/vibronic_structure_result.py "view source code")
