...
`CHC(num_qubits=None, reps=1, ladder=False, excitations=None, entanglement='full', initial_state=None)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/chemistry/components/variational_forms/chc.py "view source code")
...
`CHC.construct_circuit(parameters, q=None)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/chemistry/components/variational_forms/chc.py "view source code")
