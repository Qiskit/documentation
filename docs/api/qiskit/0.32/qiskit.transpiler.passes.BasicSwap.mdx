---
title: BasicSwap (v0.32)
description: API reference for qiskit.transpiler.passes.BasicSwap in qiskit v0.32
...
<Class id="qiskit.transpiler.passes.BasicSwap" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/transpiler/passes/routing/basic_swap.py" signature="BasicSwap(*args, **kwargs)" modifiers="class">
