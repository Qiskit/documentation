...
<Class id="qiskit.transpiler.passes.BasicSwap" github="https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/transpiler/passes/routing/basic_swap.py" signature="BasicSwap(*args, **kwargs)">
