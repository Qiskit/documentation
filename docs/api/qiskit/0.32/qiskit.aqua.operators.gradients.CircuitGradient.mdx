---
title: CircuitGradient (v0.32)
description: API reference for qiskit.aqua.operators.gradients.CircuitGradient in qiskit v0.32
...
<Class id="qiskit.aqua.operators.gradients.CircuitGradient" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/aqua/operators/gradients/circuit_gradients/circuit_gradient.py" signature="CircuitGradient" modifiers="class">
  ...
  <Function id="qiskit.aqua.operators.gradients.CircuitGradient.convert" signature="CircuitGradient.convert(operator, params=None)" modifiers="abstract">
    **Parameters**
