...
`FixedIncomeExpectedValue(uncertainty_model, A, b, cash_flow, c_approx, i_state=None, i_objective=None)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/finance/components/uncertainty_problems/fixed_income_expected_value.py "view source code")
...
`FixedIncomeExpectedValue.build(qc, q, q_ancillas=None, params=None)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/finance/components/uncertainty_problems/fixed_income_expected_value.py "view source code")
...
`FixedIncomeExpectedValue.required_ancillas()`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/finance/components/uncertainty_problems/fixed_income_expected_value.py "view source code")
...
`FixedIncomeExpectedValue.required_ancillas_controlled()`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/finance/components/uncertainty_problems/fixed_income_expected_value.py "view source code")
...
`FixedIncomeExpectedValue.value_to_estimation(value)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/finance/components/uncertainty_problems/fixed_income_expected_value.py "view source code")
