...
<Class id="qiskit.chemistry.algorithms.pes_samplers.Extrapolator" github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/chemistry/algorithms/pes_samplers/extrapolator.py" signature="Extrapolator">
  ...
  <Function id="qiskit.chemistry.algorithms.pes_samplers.Extrapolator.extrapolate" signature="abstract Extrapolator.extrapolate(points, param_dict)">
  ...
  <Function id="qiskit.chemistry.algorithms.pes_samplers.Extrapolator.factory" signature="static Extrapolator.factory(mode, **kwargs)">
