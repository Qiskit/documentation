---
title: shift_frequency (v0.32)
description: API reference for qiskit.pulse.builder.shift_frequency in qiskit v0.32
...
<Function id="qiskit.pulse.builder.shift_frequency" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/pulse/builder.py" signature="shift_frequency(frequency, channel, name=None)">
