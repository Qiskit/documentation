...
<Class id="qiskit.algorithms.LinearSolver" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/algorithms/linear_solvers/linear_solver.py" signature="LinearSolver">
  Bases: `abc.ABC`
  ...
  <Function id="qiskit.algorithms.LinearSolver.solve" signature="abstract LinearSolver.solve(matrix, vector, observable=None, observable_circuit=None, post_processing=None)">
