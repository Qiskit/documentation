...
`MultiStartOptimizer(trials=1, clip=100.0)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/optimization/algorithms/multistart_optimizer.py "view source code")
...
`MultiStartOptimizer.multi_start_solve(minimize, problem)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/optimization/algorithms/multistart_optimizer.py "view source code")
