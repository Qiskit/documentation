...
`HarmonicBasis(watson_hamiltonian, basis, truncation_order=3)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/chemistry/components/bosonic_bases/harmonic_basis.py "view source code")
...
`HarmonicBasis.convert(threshold=1e-06)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/chemistry/components/bosonic_bases/harmonic_basis.py "view source code")
