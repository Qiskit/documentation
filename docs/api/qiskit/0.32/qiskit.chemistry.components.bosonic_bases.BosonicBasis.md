...
`BosonicBasis`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/chemistry/components/bosonic_bases/bosonic_basis.py "view source code")
...
`BosonicBasis.convert(threshold=1e-06)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/chemistry/components/bosonic_bases/bosonic_basis.py "view source code")
