---
title: measure (v0.32)
description: API reference for qiskit.pulse.builder.measure in qiskit v0.32
...
<Function id="qiskit.pulse.builder.measure" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/pulse/builder.py" signature="measure(qubits, registers=None)">
