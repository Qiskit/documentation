---
title: ElectronicStructureResult (v0.32)
description: API reference for qiskit.chemistry.results.ElectronicStructureResult in qiskit v0.32
...
<Class id="qiskit.chemistry.results.ElectronicStructureResult" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/chemistry/results/electronic_structure_result.py" signature="ElectronicStructureResult(a_dict=None)" modifiers="class">
  ...
  <span id="qiskit-chemistry-results-electronicstructureresult-has-dipole" />
  ...
  <span id="qiskit-chemistry-results-electronicstructureresult-has-observables" />
