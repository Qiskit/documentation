...
<Class id="qiskit.opflow.state_fns.OperatorStateFn" github="https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/opflow/state_fns/operator_state_fn.py" signature="OperatorStateFn(primitive, coeff=1.0, is_measurement=False)">
