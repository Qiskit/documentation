...
<Class id="qiskit.aqua.operators.list_ops.ComposedOp" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/aqua/operators/list_ops/composed_op.py" signature="ComposedOp(oplist, coeff=1.0, abelian=False)">
  ...
  *   **abelian** (`bool`) – Indicates whether the Operators in `oplist` are known to mutually commute.
  ...
  <Function id="qiskit.aqua.operators.list_ops.ComposedOp.add" name="add" signature="ComposedOp.add(other)">
  ...
  <Function id="qiskit.aqua.operators.list_ops.ComposedOp.adjoint" name="adjoint" signature="ComposedOp.adjoint()">
  ...
  <Function id="qiskit.aqua.operators.list_ops.ComposedOp.assign_parameters" name="assign_parameters" signature="ComposedOp.assign_parameters(param_dict)">
  ...
  <Function id="qiskit.aqua.operators.list_ops.ComposedOp.bind_parameters" name="bind_parameters" signature="ComposedOp.bind_parameters(param_dict)">
  ...
  <Function id="qiskit.aqua.operators.list_ops.ComposedOp.compose" name="compose" signature="ComposedOp.compose(other, permutation=None, front=False)">
  ...
  <Function id="qiskit.aqua.operators.list_ops.ComposedOp.equals" name="equals" signature="ComposedOp.equals(other)">
  ...
  <Function id="qiskit.aqua.operators.list_ops.ComposedOp.eval" name="eval" signature="ComposedOp.eval(front=None)">
  ...
  <Function id="qiskit.aqua.operators.list_ops.ComposedOp.exp_i" name="exp_i" signature="ComposedOp.exp_i()">
  ...
  <Function id="qiskit.aqua.operators.list_ops.ComposedOp.log_i" name="log_i" signature="ComposedOp.log_i(massive=False)">
  ...
  <Function id="qiskit.aqua.operators.list_ops.ComposedOp.mul" name="mul" signature="ComposedOp.mul(scalar)">
  ...
  <Function id="qiskit.aqua.operators.list_ops.ComposedOp.neg" name="neg" signature="ComposedOp.neg()">
  ...
  <Function id="qiskit.aqua.operators.list_ops.ComposedOp.non_distributive_reduce" name="non_distributive_reduce" signature="ComposedOp.non_distributive_reduce()">
  ...
  <Function id="qiskit.aqua.operators.list_ops.ComposedOp.permute" name="permute" signature="ComposedOp.permute(permutation)">
  ...
  <Function id="qiskit.aqua.operators.list_ops.ComposedOp.power" name="power" signature="ComposedOp.power(exponent)">
  ...
  <Function id="qiskit.aqua.operators.list_ops.ComposedOp.primitive_strings" name="primitive_strings" signature="ComposedOp.primitive_strings()">
  ...
  <Function id="qiskit.aqua.operators.list_ops.ComposedOp.reduce" name="reduce" signature="ComposedOp.reduce()">
  ...
  <Function id="qiskit.aqua.operators.list_ops.ComposedOp.tensor" name="tensor" signature="ComposedOp.tensor(other)">
  ...
  <Function id="qiskit.aqua.operators.list_ops.ComposedOp.tensorpower" name="tensorpower" signature="ComposedOp.tensorpower(other)">
  ...
  <Function id="qiskit.aqua.operators.list_ops.ComposedOp.to_circuit" name="to_circuit" signature="ComposedOp.to_circuit()">
  ...
  <Function id="qiskit.aqua.operators.list_ops.ComposedOp.to_circuit_op" name="to_circuit_op" signature="ComposedOp.to_circuit_op()">
  ...
  <Function id="qiskit.aqua.operators.list_ops.ComposedOp.to_legacy_op" name="to_legacy_op" signature="ComposedOp.to_legacy_op(massive=False)">
  ...
  <Function id="qiskit.aqua.operators.list_ops.ComposedOp.to_matrix" name="to_matrix" signature="ComposedOp.to_matrix(massive=False)">
  ...
  <Function id="qiskit.aqua.operators.list_ops.ComposedOp.to_matrix_op" name="to_matrix_op" signature="ComposedOp.to_matrix_op(massive=False)">
  ...
  <Function id="qiskit.aqua.operators.list_ops.ComposedOp.to_pauli_op" name="to_pauli_op" signature="ComposedOp.to_pauli_op(massive=False)">
  ...
  <Function id="qiskit.aqua.operators.list_ops.ComposedOp.to_spmatrix" name="to_spmatrix" signature="ComposedOp.to_spmatrix()">
  ...
  <Function id="qiskit.aqua.operators.list_ops.ComposedOp.traverse" name="traverse" signature="ComposedOp.traverse(convert_fn, coeff=None)">
  ...
  <Attribute id="qiskit.aqua.operators.list_ops.ComposedOp.ENABLE_DEPRECATION" name="ENABLE_DEPRECATION" attributeValue="= True" />

  ### INDENTATION

  <Attribute id="qiskit.aqua.operators.list_ops.ComposedOp.INDENTATION" name="INDENTATION" attributeValue="= '  '" />

  ### abelian

  <Attribute id="qiskit.aqua.operators.list_ops.ComposedOp.abelian" name="abelian">
  ...
  <Attribute id="qiskit.aqua.operators.list_ops.ComposedOp.coeff" name="coeff">
  ...
  <Attribute id="qiskit.aqua.operators.list_ops.ComposedOp.combo_fn" name="combo_fn">
  ...
  <Attribute id="qiskit.aqua.operators.list_ops.ComposedOp.distributive" name="distributive">
    **Return type**
  ...
  <Attribute id="qiskit.aqua.operators.list_ops.ComposedOp.grad_combo_fn" name="grad_combo_fn">
  ...
  <Attribute id="qiskit.aqua.operators.list_ops.ComposedOp.num_qubits" name="num_qubits">
    **Return type**
  ...
  <Attribute id="qiskit.aqua.operators.list_ops.ComposedOp.oplist" name="oplist">
  ...
  <Attribute id="qiskit.aqua.operators.list_ops.ComposedOp.parameters" name="parameters" />
</Class>
