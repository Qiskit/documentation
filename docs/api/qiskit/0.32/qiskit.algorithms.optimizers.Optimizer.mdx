...
description: API reference for qiskit.algorithms.optimizers.Optimizer in qiskit v0.32
...
<Class id="qiskit.algorithms.optimizers.Optimizer" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/algorithms/optimizers/optimizer.py" signature="Optimizer" modifiers="class">
  ...
  <Function id="qiskit.algorithms.optimizers.Optimizer.optimize" signature="Optimizer.optimize(num_vars, objective_function, gradient_function=None, variable_bounds=None, initial_point=None)" modifiers="abstract">
