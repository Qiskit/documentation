...
$$
  ...
  **\[1]: Boyer et al., Tight bounds on quantum searching**
  ...
  <Function id="qiskit.aqua.algorithms.Grover.construct_circuit" name="construct_circuit" signature="Grover.construct_circuit(power=None, measurement=False)">
  ...
  <Function id="qiskit.aqua.algorithms.Grover.is_good_state" name="is_good_state" signature="Grover.is_good_state(bitstr)">
  ...
  <Function id="qiskit.aqua.algorithms.Grover.optimal_num_iterations" name="optimal_num_iterations" signature="static Grover.optimal_num_iterations(num_solutions, num_qubits)">
  ...
  <Function id="qiskit.aqua.algorithms.Grover.post_processing" name="post_processing" signature="Grover.post_processing(measurement)">
  ...
  <Function id="qiskit.aqua.algorithms.Grover.run" name="run" signature="Grover.run(quantum_instance=None, **kwargs)">
  ...
  <Function id="qiskit.aqua.algorithms.Grover.set_backend" name="set_backend" signature="Grover.set_backend(backend, **kwargs)">
  ...
  <Attribute id="qiskit.aqua.algorithms.Grover.backend" name="backend">
    Returns backend.
  ...
  <Attribute id="qiskit.aqua.algorithms.Grover.grover_operator" name="grover_operator">
  ...
  <Attribute id="qiskit.aqua.algorithms.Grover.quantum_instance" name="quantum_instance">
  ...
  <Attribute id="qiskit.aqua.algorithms.Grover.random" name="random">
