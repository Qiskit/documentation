---
title: ScheduleConfig (v0.32)
description: API reference for qiskit.scheduler.ScheduleConfig in qiskit v0.32
...
<Class id="qiskit.scheduler.ScheduleConfig" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/scheduler/config.py" signature="ScheduleConfig(inst_map, meas_map, dt)" modifiers="class">
  Bases: `object`
