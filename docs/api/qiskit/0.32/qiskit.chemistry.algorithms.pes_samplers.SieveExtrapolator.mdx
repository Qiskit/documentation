---
title: SieveExtrapolator (v0.32)
description: API reference for qiskit.chemistry.algorithms.pes_samplers.SieveExtrapolator in qiskit v0.32
...
<Class id="qiskit.chemistry.algorithms.pes_samplers.SieveExtrapolator" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/chemistry/algorithms/pes_samplers/extrapolator.py" signature="SieveExtrapolator(extrapolator=None, window=2, filter_before=True, filter_after=True)" modifiers="class">
  ...
  *   **filter\_after** (`bool`) – Keyword to perform clustering after extrapolation.
  ...
  <span id="qiskit-chemistry-algorithms-pes-samplers-sieveextrapolator-extrapolate" />

  ### extrapolate

  <Function id="qiskit.chemistry.algorithms.pes_samplers.SieveExtrapolator.extrapolate" signature="SieveExtrapolator.extrapolate(points, param_dict)">
  ...
  <span id="qiskit-chemistry-algorithms-pes-samplers-sieveextrapolator-factory" />

  ### factory

  <Function id="qiskit.chemistry.algorithms.pes_samplers.SieveExtrapolator.factory" signature="SieveExtrapolator.factory(mode, **kwargs)" modifiers="static">
