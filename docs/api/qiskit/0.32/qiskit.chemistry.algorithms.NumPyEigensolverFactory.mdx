...
<Class id="qiskit.chemistry.algorithms.NumPyEigensolverFactory" github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/chemistry/algorithms/excited_states_solvers/eigensolver_factories/numpy_eigensolver_factory.py" signature="NumPyEigensolverFactory(filter_criterion=None, k=100, use_default_filter_criterion=False)">
  ...
  *   **use\_default\_filter\_criterion** – whether to use the transformation’s default filter criterion if `filter_criterion` is `None`.
  ...
  <Function id="qiskit.chemistry.algorithms.NumPyEigensolverFactory.get_solver" name="get_solver" signature="NumPyEigensolverFactory.get_solver(transformation)">
  ...
  <Attribute id="qiskit.chemistry.algorithms.NumPyEigensolverFactory.filter_criterion" name="filter_criterion">
  ...
  <Attribute id="qiskit.chemistry.algorithms.NumPyEigensolverFactory.k" name="k">
  ...
  <Attribute id="qiskit.chemistry.algorithms.NumPyEigensolverFactory.use_default_filter_criterion" name="use_default_filter_criterion">
