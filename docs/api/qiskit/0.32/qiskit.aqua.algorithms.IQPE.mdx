...
<Class id="qiskit.aqua.algorithms.IQPE" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/aqua/algorithms/minimum_eigen_solvers/iqpe.py" signature="IQPE(operator=None, state_in=None, num_time_slices=1, num_iterations=1, expansion_mode='suzuki', expansion_order=2, shallow_circuit_concat=False, quantum_instance=None)">
  ...
  *   **quantum\_instance** (`Union`\[`QuantumInstance`, `Backend`, `BaseBackend`, `None`]) – Quantum Instance or Backend
  ...
  <Function id="qiskit.aqua.algorithms.IQPE.supports_aux_operators" name="supports_aux_operators" signature="classmethod IQPE.supports_aux_operators()">
  ...
  <Attribute id="qiskit.aqua.algorithms.IQPE.aux_operators" name="aux_operators">
  ...
  <Attribute id="qiskit.aqua.algorithms.IQPE.backend" name="backend">
    Returns backend.
  ...
  <Attribute id="qiskit.aqua.algorithms.IQPE.operator" name="operator">
    Returns operator
  ...
  <Attribute id="qiskit.aqua.algorithms.IQPE.quantum_instance" name="quantum_instance">
