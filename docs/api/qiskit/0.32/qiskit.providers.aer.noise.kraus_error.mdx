...
<Function id="qiskit.providers.aer.noise.kraus_error" name="kraus_error" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-aer/tree/stable/0.9/qiskit/providers/aer/noise/errors/standard_errors.py" signature="kraus_error(noise_ops, standard_gates=True, canonical_kraus=False)">
