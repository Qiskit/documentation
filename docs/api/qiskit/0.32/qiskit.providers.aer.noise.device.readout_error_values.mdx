...
<Function id="qiskit.providers.aer.noise.device.readout_error_values" name="readout_error_values" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-aer/tree/stable/0.9/qiskit/providers/aer/noise/device/parameters.py" signature="readout_error_values(properties)">
