...
`ElectronicStructureResult(a_dict=None)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/chemistry/results/electronic_structure_result.py "view source code")
...
`ElectronicStructureResult.has_dipole()`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/chemistry/results/electronic_structure_result.py "view source code")
...
`ElectronicStructureResult.has_observables()`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/chemistry/results/electronic_structure_result.py "view source code")
