---
title: SetPhase (v0.32)
description: API reference for qiskit.pulse.instructions.SetPhase in qiskit v0.32
...
$$
  ...
  *   **name** (`Optional`\[`str`]) – Display name for this instruction.
  ...
  <span id="qiskit-pulse-instructions-setphase-assign-parameters" />
