...
`Extrapolator`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/chemistry/algorithms/pes_samplers/extrapolator.py "view source code")
...
`abstract Extrapolator.extrapolate(points, param_dict)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/chemistry/algorithms/pes_samplers/extrapolator.py "view source code")
...
`static Extrapolator.factory(mode, **kwargs)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/chemistry/algorithms/pes_samplers/extrapolator.py "view source code")
