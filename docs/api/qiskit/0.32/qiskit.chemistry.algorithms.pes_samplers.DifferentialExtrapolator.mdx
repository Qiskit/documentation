...
<Class id="qiskit.chemistry.algorithms.pes_samplers.DifferentialExtrapolator" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/chemistry/algorithms/pes_samplers/extrapolator.py" signature="DifferentialExtrapolator(degree=1, model=None)">
  ...
  *   **degree** (`int`) – Specifies (degree -1) derivatives to be added as ‘features’ in regression model.
  ...
  <Function id="qiskit.chemistry.algorithms.pes_samplers.DifferentialExtrapolator.extrapolate" name="extrapolate" signature="DifferentialExtrapolator.extrapolate(points, param_dict)">
  ...
  <Function id="qiskit.chemistry.algorithms.pes_samplers.DifferentialExtrapolator.factory" name="factory" signature="static DifferentialExtrapolator.factory(mode, **kwargs)">
