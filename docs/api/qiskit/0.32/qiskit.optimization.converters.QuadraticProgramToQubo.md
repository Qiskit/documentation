...
`QuadraticProgramToQubo(penalty=None)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/optimization/converters/quadratic_program_to_qubo.py "view source code")
...
`QuadraticProgramToQubo.convert(problem)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/optimization/converters/quadratic_program_to_qubo.py "view source code")
...
`static QuadraticProgramToQubo.get_compatibility_msg(problem)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/optimization/converters/quadratic_program_to_qubo.py "view source code")
...
`QuadraticProgramToQubo.interpret(x)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/optimization/converters/quadratic_program_to_qubo.py "view source code")
...
`QuadraticProgramToQubo.is_compatible(problem)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/optimization/converters/quadratic_program_to_qubo.py "view source code")
