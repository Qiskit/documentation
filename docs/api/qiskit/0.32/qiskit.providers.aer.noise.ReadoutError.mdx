...
<Class id="qiskit.providers.aer.noise.ReadoutError" github="https://github.com/qiskit/qiskit-aer/tree/stable/0.9/qiskit/providers/aer/noise/errors/readout_error.py" signature="ReadoutError(probabilities, atol=1e-08)">
  Bases: `object`
