...
<Class id="qiskit.chemistry.algorithms.pes_samplers.EnergySurfaceBase" github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/chemistry/algorithms/pes_samplers/potentials/potential_base.py" signature="EnergySurfaceBase">
  ...
  <Function id="qiskit.chemistry.algorithms.pes_samplers.EnergySurfaceBase.eval" signature="abstract EnergySurfaceBase.eval(x)">
  ...
  <Function id="qiskit.chemistry.algorithms.pes_samplers.EnergySurfaceBase.fit" signature="abstract EnergySurfaceBase.fit(xdata, ydata, initial_vals=None, bounds_list=None)">
  ...
  <Function id="qiskit.chemistry.algorithms.pes_samplers.EnergySurfaceBase.get_equilibrium_geometry" signature="abstract EnergySurfaceBase.get_equilibrium_geometry(scaling=1.0)">
  ...
  <Function id="qiskit.chemistry.algorithms.pes_samplers.EnergySurfaceBase.get_minimal_energy" signature="abstract EnergySurfaceBase.get_minimal_energy(scaling=1.0)">
  ...
  <Function id="qiskit.chemistry.algorithms.pes_samplers.EnergySurfaceBase.get_trust_region" signature="abstract EnergySurfaceBase.get_trust_region()">
