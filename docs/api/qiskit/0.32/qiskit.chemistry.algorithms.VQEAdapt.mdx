...
<Class id="qiskit.chemistry.algorithms.VQEAdapt" github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/chemistry/algorithms/minimum_eigen_solvers/vqe_adapt.py" signature="VQEAdapt(operator, var_form_base, optimizer, initial_point=None, excitation_pool=None, threshold=1e-05, delta=1, max_iterations=None, max_evals_grouped=1, aux_operators=None, quantum_instance=None)">
  ...
  *   **See also** – qiskit/chemistry/components/variational\_forms/uccsd\_adapt.py
  ...
  <Attribute id="qiskit.chemistry.algorithms.VQEAdapt.backend" name="backend">
    Returns backend.
  ...
  <Attribute id="qiskit.chemistry.algorithms.VQEAdapt.initial_point" name="initial_point">
  ...
  <Attribute id="qiskit.chemistry.algorithms.VQEAdapt.optimizer" name="optimizer">
    Returns optimizer
  ...
  <Attribute id="qiskit.chemistry.algorithms.VQEAdapt.quantum_instance" name="quantum_instance">
  ...
  <Attribute id="qiskit.chemistry.algorithms.VQEAdapt.var_form" name="var_form">
