---
title: MultivariateUniformDistribution (v0.32)
description: API reference for qiskit.aqua.components.uncertainty_models.MultivariateUniformDistribution in qiskit v0.32
