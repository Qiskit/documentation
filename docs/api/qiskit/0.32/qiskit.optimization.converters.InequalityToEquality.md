...
`InequalityToEquality(mode='auto')`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/optimization/converters/inequality_to_equality.py "view source code")
...
`InequalityToEquality.convert(problem)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/optimization/converters/inequality_to_equality.py "view source code")
...
`InequalityToEquality.interpret(x)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/optimization/converters/inequality_to_equality.py "view source code")
