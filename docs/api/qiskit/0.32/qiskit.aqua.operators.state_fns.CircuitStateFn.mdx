...
<span id="qiskit.aqua.operators.state_fns.CircuitStateFn.ENABLE_DEPRECATION" />

### ENABLE\_DEPRECATION

`= True`

<span id="qiskit.aqua.operators.state_fns.CircuitStateFn.INDENTATION" />
...
<span id="qiskit.aqua.operators.state_fns.CircuitStateFn.parameters" />

### parameters

<span id="qiskit.aqua.operators.state_fns.CircuitStateFn.primitive" />
