...
<Class id="qiskit.aqua.algorithms.VQC" github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/aqua/algorithms/classifiers/vqc.py" signature="VQC(optimizer, feature_map, var_form, training_dataset, test_dataset=None, datapoints=None, max_evals_grouped=1, minibatch_size=- 1, callback=None, use_sigmoid_cross_entropy=False, quantum_instance=None)">
  ...
  **Raises**
  ...
  <Attribute id="qiskit.aqua.algorithms.VQC.backend" name="backend">
    Returns backend.
  ...
  <Attribute id="qiskit.aqua.algorithms.VQC.feature_map" name="feature_map">
  ...
  <Attribute id="qiskit.aqua.algorithms.VQC.initial_point" name="initial_point">
  ...
  <Attribute id="qiskit.aqua.algorithms.VQC.optimizer" name="optimizer">
    Returns optimizer
  ...
  <Attribute id="qiskit.aqua.algorithms.VQC.quantum_instance" name="quantum_instance">
  ...
  <Attribute id="qiskit.aqua.algorithms.VQC.var_form" name="var_form">
