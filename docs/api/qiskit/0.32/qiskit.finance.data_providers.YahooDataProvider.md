...
`YahooDataProvider(tickers=None, start=datetime.datetime(2016, 1, 1, 0, 0), end=datetime.datetime(2016, 1, 30, 0, 0))`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/finance/data_providers/yahoo_data_provider.py "view source code")
...
`YahooDataProvider.run()`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/finance/data_providers/yahoo_data_provider.py "view source code")
