...
`MolecularGroundStateResult(a_dict=None)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/chemistry/core/chemistry_operator.py "view source code")
...
`MolecularGroundStateResult.has_dipole()`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/chemistry/core/chemistry_operator.py "view source code")
...
`MolecularGroundStateResult.has_observables()`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/chemistry/core/chemistry_operator.py "view source code")
