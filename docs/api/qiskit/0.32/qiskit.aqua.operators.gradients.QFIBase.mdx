...
<Class id="qiskit.aqua.operators.gradients.QFIBase" github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/aqua/operators/gradients/qfi_base.py" signature="QFIBase(qfi_method='lin_comb_full')">
  ...
  **ValueError** – if `qfi_method` is neither a `CircuitQFI` object nor one of the predefined strings.
  ...
  <Function id="qiskit.aqua.operators.gradients.QFIBase.convert" signature="abstract QFIBase.convert(operator, params=None)">
    **Parameters**
  ...
  <Function id="qiskit.aqua.operators.gradients.QFIBase.parameter_expression_grad" signature="static QFIBase.parameter_expression_grad(param_expr, param)">
