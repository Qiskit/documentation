...
<Class id="qiskit.transpiler.StagedPassManager" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/transpiler/passmanager.py#L236-L443" signature="qiskit.transpiler.StagedPassManager(stages=None, **kwargs)" modifiers="class">
  ...
  *   [**ValueError**](https://docs.python.org/3/library/exceptions.html#ValueError) – If an invalid stage name is specified.
  ...
  <Attribute id="qiskit.transpiler.StagedPassManager.expanded_stages" name="expanded_stages" headingLevel={3}>
    Expanded Pass manager stages including `pre_` and `post_` phases.
  </Attribute>

  <Attribute id="qiskit.transpiler.StagedPassManager.invalid_stage_regex" name="invalid_stage_regex" headingLevel={3}>
    <AttributeTypeHint>= {"re.compile('\\\\s|\\\\+|\\\\-|\\\\*|\\\\/|\\\\\\\\|\\\\%|\\\\<|\\\\>|\\\\@|\\\\!|\\\\~|\\\\^|\\\\&|\\\\:|\\\\[|\\\\]|\\\\{|\\\\}|\\\\(|\\\\)')"}</AttributeTypeHint>
  </Attribute>

  <Attribute id="qiskit.transpiler.StagedPassManager.stages" name="stages" headingLevel={3}>
    Pass manager stages
  </Attribute>
