...
`qiskit.transpiler.passes.Commuting2qGateRouter(*args, **kwargs)`
...
<span id="qiskit.transpiler.passes.Commuting2qGateRouter.execute" />
...
<span id="qiskit.transpiler.passes.Commuting2qGateRouter.update_status" />
