---
title: ProviderV1 (v1.2)
description: API reference for qiskit.providers.ProviderV1 in qiskit v1.2
...
<Class id="qiskit.providers.ProviderV1" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.2/qiskit/providers/provider.py#L42-L95" signature="qiskit.providers.ProviderV1" modifiers="class">
  ...
  <Function id="qiskit.providers.ProviderV1.get_backend" github="https://github.com/Qiskit/qiskit/tree/stable/1.2/qiskit/providers/provider.py#L47-L73" signature="get_backend(name=None, **kwargs)">
