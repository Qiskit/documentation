...
<Class id="qiskit.transpiler.passes.CheckMap" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.2/qiskit/transpiler/passes/utils/check_map.py#L20-L91" signature="qiskit.transpiler.passes.CheckMap(*args, **kwargs)" modifiers="class">
  ...
  *   **property\_set\_field** ([*str*](https://docs.python.org/3/library/stdtypes.html#str)) – An optional string to specify the property set field to store the result of the check. If not default the result is stored in `"is_swap_mapped"`.
