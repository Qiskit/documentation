---
title: CU3Gate (v1.2)
description: API reference for qiskit.circuit.library.CU3Gate in qiskit v1.2
...
$$
  ...
  <Function id="qiskit.circuit.library.CU3Gate.inverse" github="https://github.com/Qiskit/qiskit/tree/stable/1.2/qiskit/circuit/library/standard_gates/u3.py#L306-L323" signature="inverse(annotated=False)">
