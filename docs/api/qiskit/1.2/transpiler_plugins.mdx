---
title: plugin (v1.2)
description: API reference for qiskit.transpiler.preset_passmanagers.plugin in qiskit v1.2
...
<Function id="qiskit.transpiler.preset_passmanagers.plugin.list_stage_plugins" github="https://github.com/Qiskit/qiskit/tree/stable/1.2/qiskit/transpiler/preset_passmanagers/plugin.py#L283-L309" signature="qiskit.transpiler.preset_passmanagers.plugin.list_stage_plugins(stage_name)">
...
<Function id="qiskit.transpiler.preset_passmanagers.plugin.passmanager_stage_plugins" github="https://github.com/Qiskit/qiskit/tree/stable/1.2/qiskit/transpiler/preset_passmanagers/plugin.py#L312-L353" signature="qiskit.transpiler.preset_passmanagers.plugin.passmanager_stage_plugins(stage)">
