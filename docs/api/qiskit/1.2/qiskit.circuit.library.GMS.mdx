---
title: GMS (v1.2)
description: API reference for qiskit.circuit.library.GMS in qiskit v1.2
...
<Class id="qiskit.circuit.library.GMS" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.2/qiskit/circuit/library/generalized_gates/gms.py#L27-L93" signature="qiskit.circuit.library.GMS(num_qubits, theta)" modifiers="class">
  ...
  **Expanded Circuit:**
  ...
  ![../\_images/qiskit-circuit-library-GMS-1.png](/docs/images/api/qiskit/1.2/qiskit-circuit-library-GMS-1.avif)
