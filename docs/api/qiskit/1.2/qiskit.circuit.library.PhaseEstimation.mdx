---
title: PhaseEstimation (v1.2)
description: API reference for qiskit.circuit.library.PhaseEstimation in qiskit v1.2
...
$$
  ...
  **Reference Circuit:**
  ...
  ![../\_images/qiskit-circuit-library-PhaseEstimation-1.png](/docs/images/api/qiskit/1.2/qiskit-circuit-library-PhaseEstimation-1.avif)
