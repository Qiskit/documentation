---
title: AND (v1.2)
description: API reference for qiskit.circuit.library.AND in qiskit v1.2
...
<Class id="qiskit.circuit.library.AND" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.2/qiskit/circuit/library/boolean_logic/quantum_and.py#L21-L97" signature="qiskit.circuit.library.AND(num_variable_qubits, flags=None, mcx_mode='noancilla')" modifiers="class">
  ...
  ![../\_images/qiskit-circuit-library-AND-1.png](/docs/images/api/qiskit/1.2/qiskit-circuit-library-AND-1.avif)
  ...
  ![../\_images/qiskit-circuit-library-AND-2.png](/docs/images/api/qiskit/1.2/qiskit-circuit-library-AND-2.avif)
