---
title: RGate (v1.2)
description: API reference for qiskit.circuit.library.RGate in qiskit v1.2
...
<Class id="qiskit.circuit.library.RGate" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.2/qiskit/circuit/library/standard_gates/r.py#L26-L117" signature="qiskit.circuit.library.RGate(theta, phi, label=None, *, duration=None, unit='dt')" modifiers="class">
...
$$
  ...
  <Function id="qiskit.circuit.library.RGate.inverse" github="https://github.com/Qiskit/qiskit/tree/stable/1.2/qiskit/circuit/library/standard_gates/r.py#L85-L97" signature="inverse(annotated=False)">
  ...
  <Function id="qiskit.circuit.library.RGate.power" github="https://github.com/Qiskit/qiskit/tree/stable/1.2/qiskit/circuit/library/standard_gates/r.py#L110-L112" signature="power(exponent, annotated=False)">
