---
title: PropertySet (v1.2)
description: API reference for qiskit.passmanager.PropertySet in qiskit v1.2
...
<Class id="qiskit.passmanager.PropertySet" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.2/qiskit/passmanager/compilation_status.py#L20-L24" signature="qiskit.passmanager.PropertySet" modifiers="class">
