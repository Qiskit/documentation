---
title: Estimator (v1.2)
description: API reference for qiskit.primitives.Estimator in qiskit v1.2
...
<Class id="qiskit.primitives.Estimator" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.2/qiskit/primitives/estimator.py#L39-L165" signature="qiskit.primitives.Estimator(*, options=None)" modifiers="class">
  ...
  **Raises**
  ...
  <Function id="qiskit.primitives.Estimator.run" github="https://github.com/Qiskit/qiskit/tree/stable/1.2/qiskit/primitives/base/base_estimator.py#L121-L178" signature="run(circuits, observables, parameter_values=None, **run_options)">
  ...
  <Function id="qiskit.primitives.Estimator.set_options" github="https://github.com/Qiskit/qiskit/tree/stable/1.2/qiskit/primitives/base/base_primitive.py#L39-L45" signature="set_options(**fields)">
