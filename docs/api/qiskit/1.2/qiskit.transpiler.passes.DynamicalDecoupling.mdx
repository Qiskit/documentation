...
<Class id="qiskit.transpiler.passes.DynamicalDecoupling" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.2/qiskit/transpiler/passes/scheduling/dynamical_decoupling.py#L30-L307" signature="qiskit.transpiler.passes.DynamicalDecoupling(*args, **kwargs)" modifiers="class">
  ...
  ![../\_images/qiskit-transpiler-passes-DynamicalDecoupling-1\_00.png](/docs/images/api/qiskit/1.2/qiskit-transpiler-passes-DynamicalDecoupling-1_00.avif)

  ![../\_images/qiskit-transpiler-passes-DynamicalDecoupling-1\_01.png](/docs/images/api/qiskit/1.2/qiskit-transpiler-passes-DynamicalDecoupling-1_01.avif)
