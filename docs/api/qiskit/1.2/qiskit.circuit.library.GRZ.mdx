---
title: GRZ (v1.2)
description: API reference for qiskit.circuit.library.GRZ in qiskit v1.2
...
<Class id="qiskit.circuit.library.GRZ" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.2/qiskit/circuit/library/generalized_gates/gr.py#L169-L215" signature="qiskit.circuit.library.GRZ(num_qubits, phi)" modifiers="class">
...
$$
  ...
  **Expanded Circuit:**
  ...
  ![../\_images/qiskit-circuit-library-GRZ-1.png](/docs/images/api/qiskit/1.2/qiskit-circuit-library-GRZ-1.avif)
