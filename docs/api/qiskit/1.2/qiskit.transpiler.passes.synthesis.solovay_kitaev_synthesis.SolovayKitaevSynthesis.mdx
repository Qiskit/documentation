---
title: SolovayKitaevSynthesis (v1.2)
description: API reference for qiskit.transpiler.passes.synthesis.solovay_kitaev_synthesis.SolovayKitaevSynthesis in qiskit v1.2
