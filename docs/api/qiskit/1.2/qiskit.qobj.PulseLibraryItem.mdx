---
title: PulseLibraryItem (v1.2)
description: API reference for qiskit.qobj.PulseLibraryItem in qiskit v1.2
...
<Class id="qiskit.qobj.PulseLibraryItem" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.2/qiskit/qobj/pulse_qobj.py#L533-L588" signature="qiskit.qobj.PulseLibraryItem(name, samples)" modifiers="class">
  ...
  *   **samples** ([*list*](https://docs.python.org/3/library/stdtypes.html#list)*\[*[*complex*](https://docs.python.org/3/library/functions.html#complex)*]*) – A list of complex values defining pulse shape.
  ...
  <Function id="qiskit.qobj.PulseLibraryItem.from_dict" github="https://github.com/Qiskit/qiskit/tree/stable/1.2/qiskit/qobj/pulse_qobj.py#L566-L576" signature="from_dict(data)" modifiers="classmethod">
  ...
  <Function id="qiskit.qobj.PulseLibraryItem.to_dict" github="https://github.com/Qiskit/qiskit/tree/stable/1.2/qiskit/qobj/pulse_qobj.py#L558-L564" signature="to_dict()">
