---
title: DefaultSynthesisLinearFunction (v1.2)
description: API reference for qiskit.transpiler.passes.synthesis.high_level_synthesis.DefaultSynthesisLinearFunction in qiskit v1.2
...
<Class id="qiskit.transpiler.passes.synthesis.high_level_synthesis.DefaultSynthesisLinearFunction" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.2/qiskit/transpiler/passes/synthesis/high_level_synthesis.py#L816-L826" signature="qiskit.transpiler.passes.synthesis.high_level_synthesis.DefaultSynthesisLinearFunction" modifiers="class">
