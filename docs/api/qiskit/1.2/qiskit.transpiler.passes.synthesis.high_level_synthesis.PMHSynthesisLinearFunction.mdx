---
title: PMHSynthesisLinearFunction (v1.2)
description: API reference for qiskit.transpiler.passes.synthesis.high_level_synthesis.PMHSynthesisLinearFunction in qiskit v1.2
...
<Class id="qiskit.transpiler.passes.synthesis.high_level_synthesis.PMHSynthesisLinearFunction" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.2/qiskit/transpiler/passes/synthesis/high_level_synthesis.py#L874-L923" signature="qiskit.transpiler.passes.synthesis.high_level_synthesis.PMHSynthesisLinearFunction" modifiers="class">
