---
title: TGate (v1.2)
description: API reference for qiskit.circuit.library.TGate in qiskit v1.2
...
<Class id="qiskit.circuit.library.TGate" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.2/qiskit/circuit/library/standard_gates/t.py#L27-L102" signature="qiskit.circuit.library.TGate(*args, _force_mutable=False, **kwargs)" modifiers="class">
...
$$
  ...
  **Circuit symbol:**
  ...
  <Function id="qiskit.circuit.library.TGate.inverse" github="https://github.com/Qiskit/qiskit/tree/stable/1.2/qiskit/circuit/library/standard_gates/t.py#L84-L96" signature="inverse(annotated=False)">
  ...
  <Function id="qiskit.circuit.library.TGate.power" github="https://github.com/Qiskit/qiskit/tree/stable/1.2/qiskit/circuit/library/standard_gates/t.py#L98-L99" signature="power(exponent, annotated=False)">
