---
title: plugin (v1.2)
description: API reference for qiskit.transpiler.passes.synthesis.plugin in qiskit v1.2
...
| ----------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------- |
| `"full"`    | [`QFTSynthesisFull`](qiskit.transpiler.passes.synthesis.high_level_synthesis.QFTSynthesisFull "qiskit.transpiler.passes.synthesis.high_level_synthesis.QFTSynthesisFull") | all-to-all            |
| `"line"`    | [`QFTSynthesisLine`](qiskit.transpiler.passes.synthesis.high_level_synthesis.QFTSynthesisLine "qiskit.transpiler.passes.synthesis.high_level_synthesis.QFTSynthesisLine") | linear                |
| `"default"` | [`QFTSynthesisFull`](qiskit.transpiler.passes.synthesis.high_level_synthesis.QFTSynthesisFull "qiskit.transpiler.passes.synthesis.high_level_synthesis.QFTSynthesisFull") | all-to-all            |

|                                                                                                                                                                             |                                                               |
| --------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------- |
| [`QFTSynthesisFull`](qiskit.transpiler.passes.synthesis.high_level_synthesis.QFTSynthesisFull "qiskit.transpiler.passes.synthesis.high_level_synthesis.QFTSynthesisFull")() | Synthesis plugin for QFT gates using all-to-all connectivity. |
| [`QFTSynthesisLine`](qiskit.transpiler.passes.synthesis.high_level_synthesis.QFTSynthesisLine "qiskit.transpiler.passes.synthesis.high_level_synthesis.QFTSynthesisLine")() | Synthesis plugin for QFT gates using linear connectivity.     |
