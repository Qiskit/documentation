---
title: StatePreparation (v1.2)
description: API reference for qiskit.circuit.library.StatePreparation in qiskit v1.2
...
<Class id="qiskit.circuit.library.StatePreparation" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.2/qiskit/circuit/library/data_preparation/state_preparation.py#L35-L244" signature="qiskit.circuit.library.StatePreparation(params, num_qubits=None, inverse=False, label=None, normalize=False)" modifiers="class">
  ...
  **References**
  ...
  <Function id="qiskit.circuit.library.StatePreparation.broadcast_arguments" github="https://github.com/Qiskit/qiskit/tree/stable/1.2/qiskit/circuit/library/data_preparation/state_preparation.py#L212-L221" signature="broadcast_arguments(qargs, cargs)">
  ...
  <Function id="qiskit.circuit.library.StatePreparation.inverse" github="https://github.com/Qiskit/qiskit/tree/stable/1.2/qiskit/circuit/library/data_preparation/state_preparation.py#L203-L210" signature="inverse(annotated=False)">
    Return inverted StatePreparation
  </Function>

  ### validate\_parameter

  <Function id="qiskit.circuit.library.StatePreparation.validate_parameter" github="https://github.com/Qiskit/qiskit/tree/stable/1.2/qiskit/circuit/library/data_preparation/state_preparation.py#L223-L241" signature="validate_parameter(parameter)">
