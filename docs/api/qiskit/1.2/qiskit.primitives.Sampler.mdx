---
title: Sampler (v1.2)
description: API reference for qiskit.primitives.Sampler in qiskit v1.2
...
<Class id="qiskit.primitives.Sampler" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.2/qiskit/primitives/sampler.py#L39-L162" signature="qiskit.primitives.Sampler(*, options=None)" modifiers="class">
  ...
  **Raises**
  ...
  <Function id="qiskit.primitives.Sampler.run" github="https://github.com/Qiskit/qiskit/tree/stable/1.2/qiskit/primitives/base/base_sampler.py#L111-L142" signature="run(circuits, parameter_values=None, **run_options)">
  ...
  <Function id="qiskit.primitives.Sampler.set_options" github="https://github.com/Qiskit/qiskit/tree/stable/1.2/qiskit/primitives/base/base_primitive.py#L39-L45" signature="set_options(**fields)">
