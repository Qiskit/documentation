...
<Class id="qiskit.qobj.QasmQobjExperiment" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.2/qiskit/qobj/qasm_qobj.py#L205-L290" signature="qiskit.qobj.QasmQobjExperiment(config=None, header=None, instructions=None)" modifiers="class">
  ...
  *   **instructions** ([*list*](https://docs.python.org/3/library/stdtypes.html#list)) – A list of [`QasmQobjInstruction`](qiskit.qobj.QasmQobjInstruction "qiskit.qobj.QasmQobjInstruction") objects
