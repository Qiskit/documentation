---
title: BackendV2Converter (v1.2)
description: API reference for qiskit.providers.BackendV2Converter in qiskit v1.2
...
<Class id="qiskit.providers.BackendV2Converter" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.2/qiskit/providers/backend_compat.py#L330-L452" signature="qiskit.providers.BackendV2Converter(backend, name_mapping=None, add_delay=True, filter_faulty=True)" modifiers="class">
  ...
  *   **filter\_faulty** ([*bool*](https://docs.python.org/3/library/functions.html#bool "(in Python v3.13)")) – If the [`BackendProperties`](qiskit.providers.models.BackendProperties "qiskit.providers.models.BackendProperties") object (if present) for `backend` has any qubits or gates flagged as non-operational filter those from the output target.
  ...
  <Function id="qiskit.providers.BackendV2Converter.acquire_channel" github="https://github.com/Qiskit/qiskit/tree/stable/1.2/qiskit/providers/backend_compat.py#L445-L446" signature="acquire_channel(qubit)">
  ...
  <Function id="qiskit.providers.BackendV2Converter.control_channel" github="https://github.com/Qiskit/qiskit/tree/stable/1.2/qiskit/providers/backend_compat.py#L448-L449" signature="control_channel(qubits)">
  ...
  <Function id="qiskit.providers.BackendV2Converter.drive_channel" github="https://github.com/Qiskit/qiskit/tree/stable/1.2/qiskit/providers/backend_compat.py#L439-L440" signature="drive_channel(qubit)">
  ...
  <Function id="qiskit.providers.BackendV2Converter.measure_channel" github="https://github.com/Qiskit/qiskit/tree/stable/1.2/qiskit/providers/backend_compat.py#L442-L443" signature="measure_channel(qubit)">
  ...
  <Function id="qiskit.providers.BackendV2Converter.qubit_properties" github="https://github.com/Qiskit/qiskit/tree/stable/1.2/qiskit/providers/backend.py#L493-L525" signature="qubit_properties(qubit)">
  ...
  <Function id="qiskit.providers.BackendV2Converter.run" github="https://github.com/Qiskit/qiskit/tree/stable/1.2/qiskit/providers/backend_compat.py#L451-L452" signature="run(run_input, **options)">
    Run on the backend.
  ...
  <Function id="qiskit.providers.BackendV2Converter.set_options" github="https://github.com/Qiskit/qiskit/tree/stable/1.2/qiskit/providers/backend.py#L594-L611" signature="set_options(**fields)">
