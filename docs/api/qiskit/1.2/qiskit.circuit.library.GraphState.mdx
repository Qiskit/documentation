---
title: GraphState (v1.2)
description: API reference for qiskit.circuit.library.GraphState in qiskit v1.2
...
$$
  ...
  **Reference Circuit:**
  ...
  ![../\_images/qiskit-circuit-library-GraphState-1.png](/docs/images/api/qiskit/1.2/qiskit-circuit-library-GraphState-1.avif)
