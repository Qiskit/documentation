---
title: circuit_drawer (v1.2)
description: API reference for qiskit.visualization.circuit_drawer in qiskit v1.2
...
<Function id="qiskit.visualization.circuit_drawer" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.2/qiskit/visualization/circuit/circuit_visualization.py#L56-L355" signature="qiskit.visualization.circuit_drawer(circuit, scale=None, filename=None, style=None, output=None, interactive=False, plot_barriers=True, reverse_bits=None, justify=None, vertical_compression='medium', idle_wires=None, with_layout=True, fold=None, ax=None, initial_state=False, cregbundle=None, wire_order=None, expr_len=30)">
  ...
  **Example**
  ...
  ![../\_images/qiskit-visualization-circuit\_drawer-1.png](/docs/images/api/qiskit/1.2/qiskit-visualization-circuit_drawer-1.avif)
</Function>
