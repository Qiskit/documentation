---
title: GRX (v1.2)
description: API reference for qiskit.circuit.library.GRX in qiskit v1.2
...
<Class id="qiskit.circuit.library.GRX" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.2/qiskit/circuit/library/generalized_gates/gr.py#L73-L118" signature="qiskit.circuit.library.GRX(num_qubits, theta)" modifiers="class">
...
$$
  ...
  **Expanded Circuit:**
  ...
  ![../\_images/qiskit-circuit-library-GRX-1.png](/docs/images/api/qiskit/1.2/qiskit-circuit-library-GRX-1.avif)
