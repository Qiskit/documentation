---
title: HiddenLinearFunction (v1.2)
description: API reference for qiskit.circuit.library.HiddenLinearFunction in qiskit v1.2
...
<Class id="qiskit.circuit.library.HiddenLinearFunction" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.2/qiskit/circuit/library/hidden_linear_function.py#L22-L98" signature="qiskit.circuit.library.HiddenLinearFunction(adjacency_matrix)" modifiers="class">
...
$$
  ...
  **Reference Circuit:**
  ...
  > ![../\_images/qiskit-circuit-library-HiddenLinearFunction-1.png](/docs/images/api/qiskit/1.2/qiskit-circuit-library-HiddenLinearFunction-1.avif)
