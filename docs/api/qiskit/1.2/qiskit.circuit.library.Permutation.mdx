---
title: Permutation (v1.2)
description: API reference for qiskit.circuit.library.Permutation in qiskit v1.2
...
<Class id="qiskit.circuit.library.Permutation" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.2/qiskit/circuit/library/generalized_gates/permutation.py#L27-L92" signature="qiskit.circuit.library.Permutation(num_qubits, pattern=None, seed=None)" modifiers="class">
  ...
  **Reference Circuit:**
  ...
  ![../\_images/qiskit-circuit-library-Permutation-1.png](/docs/images/api/qiskit/1.2/qiskit-circuit-library-Permutation-1.avif)

  **Expanded Circuit:**

  ![../\_images/qiskit-circuit-library-Permutation-2.png](/docs/images/api/qiskit/1.2/qiskit-circuit-library-Permutation-2.avif)
