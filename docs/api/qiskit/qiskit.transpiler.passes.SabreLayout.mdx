...
<Class id="qiskit.transpiler.passes.SabreLayout" github="https://github.com/Qiskit/qiskit/tree/stable/1.0/qiskit/transpiler/passes/layout/sabre_layout.py#L51-L449" signature="qiskit.transpiler.passes.SabreLayout(*args, **kwargs)">
