...
<Class id="qiskit.transpiler.passes.RXCalibrationBuilder" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.3/qiskit/transpiler/passes/calibration/rx_builder.py#L30-L142" signature="qiskit.transpiler.passes.RXCalibrationBuilder(*args, **kwargs)" modifiers="class">
  ...
  *   **target** ([*Target*](transpiler-target "qiskit.transpiler.Target")) – Should contain a SX calibration that will be
  *   **calibrations.** (*used for bootstrapping RX*) –
  ...
  <Function id="qiskit.transpiler.passes.RXCalibrationBuilder.execute" github="https://github.com/Qiskit/qiskit/tree/stable/1.3/qiskit/transpiler/basepasses.py#L189-L211" signature="execute(passmanager_ir, state, callback=None)">
  ...
  <Function id="qiskit.transpiler.passes.RXCalibrationBuilder.get_calibration" github="https://github.com/Qiskit/qiskit/tree/stable/1.3/qiskit/transpiler/passes/calibration/rx_builder.py#L116-L142" signature="get_calibration(node_op, qubits)">
    Generate RX calibration for the rotation angle specified in node\_op.

    **Parameters**

    *   **node\_op** ([*Instruction*](circuit-instruction "qiskit.circuit.instruction.Instruction")) –
    *   **qubits** ([*list*](https://docs.python.org/3/library/stdtypes.html#list "(in Python v3.13)")) –

    **Return type**

    [*Schedule*](pulse-schedule "qiskit.pulse.schedule.Schedule") | [*ScheduleBlock*](pulse-schedule-block "qiskit.pulse.schedule.ScheduleBlock")
  </Function>

  ### name

  <Function id="qiskit.transpiler.passes.RXCalibrationBuilder.name" github="https://github.com/Qiskit/qiskit/tree/stable/1.3/qiskit/passmanager/base_tasks.py#L68-L70" signature="name()">
    Name of the pass.
  ...
  <Function id="qiskit.transpiler.passes.RXCalibrationBuilder.run" github="https://github.com/Qiskit/qiskit/tree/stable/1.3/qiskit/transpiler/passes/calibration/base_builder.py#L54-L79" signature="run(dag)">
  ...
  <Function id="qiskit.transpiler.passes.RXCalibrationBuilder.supported" github="https://github.com/Qiskit/qiskit/tree/stable/1.3/qiskit/transpiler/passes/calibration/rx_builder.py#L98-L114" signature="supported(node_op, qubits)">
  ...
  <Function id="qiskit.transpiler.passes.RXCalibrationBuilder.update_status" github="https://github.com/Qiskit/qiskit/tree/stable/1.3/qiskit/transpiler/basepasses.py#L213-L221" signature="update_status(state, run_state)">
