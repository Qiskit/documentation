...
<Function id="qiskit.providers.convert_to_target" name="convert_to_target" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/1.0/qiskit/providers/backend_compat.py" signature="qiskit.providers.convert_to_target(configuration, properties=None, defaults=None, custom_name_mapping=None, add_delay=True, filter_faulty=True)">
