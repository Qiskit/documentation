...
<Class id="qiskit.circuit.library.SXGate" github="https://github.com/Qiskit/qiskit/tree/stable/1.0/qiskit/circuit/library/standard_gates/sx.py#L26-L135" signature="qiskit.circuit.library.SXGate(*args, _force_mutable=False, **kwargs)">
