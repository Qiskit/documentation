...
<Class id="qiskit.circuit.library.RZZGate" github="https://github.com/qiskit/qiskit/tree/stable/1.0/qiskit/circuit/library/standard_gates/rzz.py" signature="qiskit.circuit.library.RZZGate(theta, label=None, *, duration=None, unit='dt')">
