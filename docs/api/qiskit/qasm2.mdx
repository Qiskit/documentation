...
<Function id="qiskit.qasm2.load" github="https://github.com/Qiskit/qiskit/tree/stable/2.3/qiskit/qasm2/__init__.py#L617-L669" signature="qiskit.qasm2.load(filename, *, include_path=('.',), include_input_directory='append', custom_instructions=(), custom_classical=(), strict=False)">
  ...
  *   **filename** ([*str*](https://docs.python.org/3/library/stdtypes.html#str)  *|*[*PathLike*](https://docs.python.org/3/library/os.html#os.PathLike)) – The OpenQASM 2 program in a string.
