...
<Class id="qiskit.circuit.library.TdgGate" github="https://github.com/qiskit/qiskit/tree/stable/1.0/qiskit/circuit/library/standard_gates/t.py" signature="qiskit.circuit.library.TdgGate(*args, _force_mutable=False, **kwargs)">
...
$$
  ...
  **Circuit symbol:**
  ...
  <Function id="qiskit.circuit.library.TdgGate.inverse" name="inverse" signature="inverse(annotated=False)">
