...
<Class id="qiskit.circuit.library.TdgGate" github="https://github.com/Qiskit/qiskit/tree/stable/1.0/qiskit/circuit/library/standard_gates/t.py#L103-L176" signature="qiskit.circuit.library.TdgGate(*args, _force_mutable=False, **kwargs)">
