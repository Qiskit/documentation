...
<Class id="qiskit.circuit.library.HiddenLinearFunction" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/2.1/qiskit/circuit/library/hidden_linear_function.py#L23-L89" signature="qiskit.circuit.library.HiddenLinearFunction(adjacency_matrix)" modifiers="class">
...
$$
  ...
  **Raises**
  ...
  <Attribute id="qiskit.circuit.library.HiddenLinearFunction.instances" attributeValue="292" />
