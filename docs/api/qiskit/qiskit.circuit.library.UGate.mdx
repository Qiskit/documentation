...
<Class id="qiskit.circuit.library.UGate" github="https://github.com/qiskit/qiskit/tree/stable/1.0/qiskit/circuit/library/standard_gates/u.py" signature="qiskit.circuit.library.UGate(theta, phi, lam, label=None, *, duration=None, unit='dt')">
...
$$
  ...
  <Function id="qiskit.circuit.library.UGate.control" name="control" signature="control(num_ctrl_qubits=1, label=None, ctrl_state=None, annotated=False)">
  ...
  <Function id="qiskit.circuit.library.UGate.inverse" name="inverse" signature="inverse(annotated=False)">
