...
*   **num\_qubits** ([*int*](https://docs.python.org/3/library/functions.html#int "(in Python v3.11)")) – the width of circuit.
*   **amount** ([*int*](https://docs.python.org/3/library/functions.html#int "(in Python v3.11)") *| None*) – the xor amount in decimal form.
*   **seed** ([*int*](https://docs.python.org/3/library/functions.html#int "(in Python v3.11)") *| None*) – random seed in case a random xor is requested.
...
![../\_images/qiskit-circuit-library-XOR-1.png](/images/api/qiskit/qiskit-circuit-library-XOR-1.png)
