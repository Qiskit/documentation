...
<Class id="qiskit.synthesis.unitary.aqc.CNOTUnitObjective" github="https://github.com/Qiskit/qiskit/tree/stable/1.0/qiskit/synthesis/unitary/aqc/cnot_unit_objective.py#L27-L58" signature="qiskit.synthesis.unitary.aqc.CNOTUnitObjective(num_qubits, cnots)">
