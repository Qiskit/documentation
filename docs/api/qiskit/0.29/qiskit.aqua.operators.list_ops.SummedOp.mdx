...
<Class id="qiskit.aqua.operators.list_ops.SummedOp" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/aqua/operators/list_ops/summed_op.py" signature="SummedOp(oplist, coeff=1.0, abelian=False)">
  ...
  *   **abelian** (`bool`) – Indicates whether the Operators in `oplist` are known to mutually commute.
  ...
  <Function id="qiskit.aqua.operators.list_ops.SummedOp.add" name="add" signature="SummedOp.add(other)">
  ...
  <Function id="qiskit.aqua.operators.list_ops.SummedOp.adjoint" name="adjoint" signature="SummedOp.adjoint()">
  ...
  <Function id="qiskit.aqua.operators.list_ops.SummedOp.assign_parameters" name="assign_parameters" signature="SummedOp.assign_parameters(param_dict)">
  ...
  <Function id="qiskit.aqua.operators.list_ops.SummedOp.bind_parameters" name="bind_parameters" signature="SummedOp.bind_parameters(param_dict)">
  ...
  <Function id="qiskit.aqua.operators.list_ops.SummedOp.collapse_summands" name="collapse_summands" signature="SummedOp.collapse_summands()">
  ...
  <Function id="qiskit.aqua.operators.list_ops.SummedOp.compose" name="compose" signature="SummedOp.compose(other, permutation=None, front=False)">
  ...
  <Function id="qiskit.aqua.operators.list_ops.SummedOp.equals" name="equals" signature="SummedOp.equals(other)">
  ...
  <Function id="qiskit.aqua.operators.list_ops.SummedOp.eval" name="eval" signature="SummedOp.eval(front=None)">
  ...
  <Function id="qiskit.aqua.operators.list_ops.SummedOp.exp_i" name="exp_i" signature="SummedOp.exp_i()">
  ...
  <Function id="qiskit.aqua.operators.list_ops.SummedOp.log_i" name="log_i" signature="SummedOp.log_i(massive=False)">
  ...
  <Function id="qiskit.aqua.operators.list_ops.SummedOp.mul" name="mul" signature="SummedOp.mul(scalar)">
  ...
  <Function id="qiskit.aqua.operators.list_ops.SummedOp.neg" name="neg" signature="SummedOp.neg()">
  ...
  <Function id="qiskit.aqua.operators.list_ops.SummedOp.permute" name="permute" signature="SummedOp.permute(permutation)">
  ...
  <Function id="qiskit.aqua.operators.list_ops.SummedOp.power" name="power" signature="SummedOp.power(exponent)">
  ...
  <Function id="qiskit.aqua.operators.list_ops.SummedOp.primitive_strings" name="primitive_strings" signature="SummedOp.primitive_strings()">
  ...
  <Function id="qiskit.aqua.operators.list_ops.SummedOp.print_details" name="print_details" signature="SummedOp.print_details()">
    Print out the operator in details. :returns: a formatted string describes the operator. :rtype: str
  </Function>

  ### reduce

  <Function id="qiskit.aqua.operators.list_ops.SummedOp.reduce" name="reduce" signature="SummedOp.reduce()">
  ...
  <Function id="qiskit.aqua.operators.list_ops.SummedOp.tensor" name="tensor" signature="SummedOp.tensor(other)">
  ...
  <Function id="qiskit.aqua.operators.list_ops.SummedOp.tensorpower" name="tensorpower" signature="SummedOp.tensorpower(other)">
  ...
  <Function id="qiskit.aqua.operators.list_ops.SummedOp.to_circuit" name="to_circuit" signature="SummedOp.to_circuit()">
  ...
  <Function id="qiskit.aqua.operators.list_ops.SummedOp.to_circuit_op" name="to_circuit_op" signature="SummedOp.to_circuit_op()">
  ...
  <Function id="qiskit.aqua.operators.list_ops.SummedOp.to_legacy_op" name="to_legacy_op" signature="SummedOp.to_legacy_op(massive=False)">
  ...
  <Function id="qiskit.aqua.operators.list_ops.SummedOp.to_matrix" name="to_matrix" signature="SummedOp.to_matrix(massive=False)">
  ...
  <Function id="qiskit.aqua.operators.list_ops.SummedOp.to_matrix_op" name="to_matrix_op" signature="SummedOp.to_matrix_op(massive=False)">
  ...
  <Function id="qiskit.aqua.operators.list_ops.SummedOp.to_pauli_op" name="to_pauli_op" signature="SummedOp.to_pauli_op(massive=False)">
  ...
  <Function id="qiskit.aqua.operators.list_ops.SummedOp.to_spmatrix" name="to_spmatrix" signature="SummedOp.to_spmatrix()">
  ...
  <Function id="qiskit.aqua.operators.list_ops.SummedOp.traverse" name="traverse" signature="SummedOp.traverse(convert_fn, coeff=None)">
  ...
  <Attribute id="qiskit.aqua.operators.list_ops.SummedOp.ENABLE_DEPRECATION" name="ENABLE_DEPRECATION" attributeValue="= True" />

  ### INDENTATION

  <Attribute id="qiskit.aqua.operators.list_ops.SummedOp.INDENTATION" name="INDENTATION" attributeValue="= '  '" />

  ### abelian

  <Attribute id="qiskit.aqua.operators.list_ops.SummedOp.abelian" name="abelian">
  ...
  <Attribute id="qiskit.aqua.operators.list_ops.SummedOp.coeff" name="coeff">
  ...
  <Attribute id="qiskit.aqua.operators.list_ops.SummedOp.combo_fn" name="combo_fn">
  ...
  <Attribute id="qiskit.aqua.operators.list_ops.SummedOp.distributive" name="distributive">
    **Return type**
  ...
  <Attribute id="qiskit.aqua.operators.list_ops.SummedOp.grad_combo_fn" name="grad_combo_fn">
  ...
  <Attribute id="qiskit.aqua.operators.list_ops.SummedOp.num_qubits" name="num_qubits">
    **Return type**
  ...
  <Attribute id="qiskit.aqua.operators.list_ops.SummedOp.oplist" name="oplist">
  ...
  <Attribute id="qiskit.aqua.operators.list_ops.SummedOp.parameters" name="parameters" />
</Class>
