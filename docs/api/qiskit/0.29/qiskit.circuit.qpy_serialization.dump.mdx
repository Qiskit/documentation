...
<Function id="qiskit.circuit.qpy_serialization.dump" github="https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/circuit/qpy_serialization.py" signature="dump(circuits, file_obj)">
