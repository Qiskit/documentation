...
<Class id="qiskit.providers.ibmq.job.IBMQJobInvalidStateError" github="https://github.com/qiskit/qiskit-ibmq-provider/tree/stable/0.16/qiskit/providers/ibmq/job/exceptions.py" signature="IBMQJobInvalidStateError(*message)">
