---
title: MultivariateLogNormalDistribution (v0.29)
description: API reference for qiskit.aqua.components.uncertainty_models.MultivariateLogNormalDistribution in qiskit v0.29
