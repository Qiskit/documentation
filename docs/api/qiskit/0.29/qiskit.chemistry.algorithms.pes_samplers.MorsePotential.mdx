...
<Class id="qiskit.chemistry.algorithms.pes_samplers.MorsePotential" github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/chemistry/algorithms/pes_samplers/potentials/morse_potential.py" signature="MorsePotential(molecule)">
  ...
  **ValueError** – Only implemented for diatomic molecules
  ...
  <Function id="qiskit.chemistry.algorithms.pes_samplers.MorsePotential.dissociation_energy" name="dissociation_energy" signature="MorsePotential.dissociation_energy(scaling=1.0)">
  ...
  <Function id="qiskit.chemistry.algorithms.pes_samplers.MorsePotential.eval" name="eval" signature="MorsePotential.eval(x)">
  ...
  <Function id="qiskit.chemistry.algorithms.pes_samplers.MorsePotential.fit" name="fit" signature="MorsePotential.fit(xdata, ydata, initial_vals=None, bounds_list=None)">
  ...
  <Function id="qiskit.chemistry.algorithms.pes_samplers.MorsePotential.fit_function" name="fit_function" signature="static MorsePotential.fit_function(x, d_e, alpha, r_0, m_shift)">
  ...
  <Function id="qiskit.chemistry.algorithms.pes_samplers.MorsePotential.fundamental_frequency" name="fundamental_frequency" signature="MorsePotential.fundamental_frequency()">
  ...
  <Function id="qiskit.chemistry.algorithms.pes_samplers.MorsePotential.get_equilibrium_geometry" name="get_equilibrium_geometry" signature="MorsePotential.get_equilibrium_geometry(scaling=1.0)">
  ...
  <Function id="qiskit.chemistry.algorithms.pes_samplers.MorsePotential.get_maximum_trusted_level" name="get_maximum_trusted_level" signature="MorsePotential.get_maximum_trusted_level(n=0)">
  ...
  <Function id="qiskit.chemistry.algorithms.pes_samplers.MorsePotential.get_minimal_energy" name="get_minimal_energy" signature="MorsePotential.get_minimal_energy(scaling=1.0)">
  ...
  <Function id="qiskit.chemistry.algorithms.pes_samplers.MorsePotential.get_num_modes" name="get_num_modes" signature="MorsePotential.get_num_modes()">
  ...
  <Function id="qiskit.chemistry.algorithms.pes_samplers.MorsePotential.get_trust_region" name="get_trust_region" signature="MorsePotential.get_trust_region()">
  ...
  <Function id="qiskit.chemistry.algorithms.pes_samplers.MorsePotential.update_molecule" name="update_molecule" signature="MorsePotential.update_molecule(molecule)">
  ...
  <Function id="qiskit.chemistry.algorithms.pes_samplers.MorsePotential.vibrational_energy_level" name="vibrational_energy_level" signature="MorsePotential.vibrational_energy_level(n)">
  ...
  <Function id="qiskit.chemistry.algorithms.pes_samplers.MorsePotential.wave_number" name="wave_number" signature="MorsePotential.wave_number()">
