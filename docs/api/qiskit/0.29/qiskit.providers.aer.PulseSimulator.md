...
|                                                                                                                                                                                            |                                                  |
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------ |
| [`available_methods`](qiskit.providers.aer.PulseSimulator.available_methods#qiskit.providers.aer.PulseSimulator.available_methods "qiskit.providers.aer.PulseSimulator.available_methods") | Return the available simulation methods.         |
...
| [`set_options`](qiskit.providers.aer.PulseSimulator.set_options#qiskit.providers.aer.PulseSimulator.set_options "qiskit.providers.aer.PulseSimulator.set_options")                         | Set the options fields for the backend           |
