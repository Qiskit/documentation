---
title: CplexOptimizer (v0.29)
description: API reference for qiskit.optimization.algorithms.CplexOptimizer in qiskit v0.29
...
<Class id="qiskit.optimization.algorithms.CplexOptimizer" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/optimization/algorithms/cplex_optimizer.py" signature="CplexOptimizer(disp=False)" modifiers="class">
  ...
  **Raises**
  ...
  <span id="qiskit-optimization-algorithms-cplexoptimizer-get-compatibility-msg" />
  ...
  <span id="qiskit-optimization-algorithms-cplexoptimizer-is-compatible" />
  ...
  <span id="qiskit-optimization-algorithms-cplexoptimizer-is-cplex-installed" />
