---
title: barrier (v0.29)
description: API reference for qiskit.pulse.builder.barrier in qiskit v0.29
...
<Function id="qiskit.pulse.builder.barrier" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/pulse/builder.py" signature="barrier(*channels_or_qubits, name=None)">
