...
<Class id="qiskit.aqua.algorithms.IterativeAmplitudeEstimationResult" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/aqua/algorithms/amplitude_estimators/iqae.py" signature="IterativeAmplitudeEstimationResult(a_dict=None)">
  ...
  <Function id="qiskit.aqua.algorithms.IterativeAmplitudeEstimationResult.from_dict" signature="static IterativeAmplitudeEstimationResult.from_dict(a_dict)">
  ...
  <Function id="qiskit.aqua.algorithms.IterativeAmplitudeEstimationResult.fromkeys" signature="classmethod IterativeAmplitudeEstimationResult.fromkeys(iterable, value=None)" />
