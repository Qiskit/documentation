...
<Function id="qiskit.providers.aer.utils.remap_noise_model" github="https://github.com/qiskit/qiskit-aer/tree/stable/0.8/qiskit/providers/aer/utils/noise_remapper.py" signature="remap_noise_model(noise_model, remapping, discard_qubits=False, warnings=True)">
