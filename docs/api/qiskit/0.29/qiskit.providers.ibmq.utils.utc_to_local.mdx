---
title: utc_to_local (v0.29)
description: API reference for qiskit.providers.ibmq.utils.utc_to_local in qiskit v0.29
...
<Function id="qiskit.providers.ibmq.utils.utc_to_local" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-ibmq-provider/tree/stable/0.16/qiskit/providers/ibmq/utils/converters.py" signature="utc_to_local(utc_dt)">
