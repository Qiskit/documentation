---
title: Molecule (v0.29)
description: API reference for qiskit.chemistry.drivers.Molecule in qiskit v0.29
...
<Class id="qiskit.chemistry.drivers.Molecule" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/chemistry/drivers/molecule.py" signature="Molecule(geometry, multiplicity=1, charge=0, degrees_of_freedom=None, masses=None)" modifiers="class">
  ...
  **ValueError** – Length of masses must match length of geometries.
  ...
  <span id="qiskit-chemistry-drivers-molecule-absolute-angle" />

  ### absolute\_angle

  <Function id="qiskit.chemistry.drivers.Molecule.absolute_angle" signature="Molecule.absolute_angle(angle, geometry, atom_trio)" modifiers="classmethod">
    **Parameters**
  ...
  <span id="qiskit-chemistry-drivers-molecule-absolute-bending" />

  ### absolute\_bending

  <Function id="qiskit.chemistry.drivers.Molecule.absolute_bending" signature="Molecule.absolute_bending(bend, geometry, atom_trio)" modifiers="classmethod">
    **Parameters**
  ...
  <span id="qiskit-chemistry-drivers-molecule-absolute-distance" />

  ### absolute\_distance

  <Function id="qiskit.chemistry.drivers.Molecule.absolute_distance" signature="Molecule.absolute_distance(distance, geometry, atom_pair)" modifiers="classmethod">
    **Parameters**
  ...
  <span id="qiskit-chemistry-drivers-molecule-absolute-stretching" />

  ### absolute\_stretching

  <Function id="qiskit.chemistry.drivers.Molecule.absolute_stretching" signature="Molecule.absolute_stretching(perturbation, geometry, atom_pair)" modifiers="classmethod">
    **Parameters**
  ...
  <span id="qiskit-chemistry-drivers-molecule-relative-bending" />

  ### relative\_bending

  <Function id="qiskit.chemistry.drivers.Molecule.relative_bending" signature="Molecule.relative_bending(bend, geometry, atom_trio)" modifiers="classmethod">
    **Parameters**
  ...
  <span id="qiskit-chemistry-drivers-molecule-relative-stretching" />

  ### relative\_stretching

  <Function id="qiskit.chemistry.drivers.Molecule.relative_stretching" signature="Molecule.relative_stretching(perturbation, geometry, atom_pair)" modifiers="classmethod">
    **Parameters**
