...
<Class id="qiskit.optimization.converters.InequalityToEquality" github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/optimization/converters/inequality_to_equality.py" signature="InequalityToEquality(mode='auto')">
  ...
  *   **’auto’: Try to use integer variables but if it’s not possible,**
  ...
  <Function id="qiskit.optimization.converters.InequalityToEquality.convert" name="convert" signature="InequalityToEquality.convert(problem)">
  ...
  <Function id="qiskit.optimization.converters.InequalityToEquality.interpret" name="interpret" signature="InequalityToEquality.interpret(x)">
  ...
  <Attribute id="qiskit.optimization.converters.InequalityToEquality.mode" name="mode">
