---
title: NumPyDiscriminator (v0.29)
description: API reference for qiskit.aqua.components.neural_networks.NumPyDiscriminator in qiskit v0.29
...
<Class id="qiskit.aqua.components.neural_networks.NumPyDiscriminator" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/aqua/components/neural_networks/numpy_discriminator.py" signature="NumPyDiscriminator(n_features=1, n_out=1)" modifiers="class">
  ...
  *   **n\_out** (`int`) – Dimension of the discriminator’s output vector.
  ...
  <span id="qiskit-aqua-components-neural-networks-numpydiscriminator-get-label" />
  ...
  <span id="qiskit-aqua-components-neural-networks-numpydiscriminator-load-model" />
  ...
  <span id="qiskit-aqua-components-neural-networks-numpydiscriminator-loss" />
  ...
  <span id="qiskit-aqua-components-neural-networks-numpydiscriminator-save-model" />
  ...
  <span id="qiskit-aqua-components-neural-networks-numpydiscriminator-set-seed" />
  ...
  <span id="qiskit-aqua-components-neural-networks-numpydiscriminator-train" />
