---
title: Constant (v0.29)
description: API reference for qiskit.pulse.library.Constant in qiskit v0.29
...
<Class id="qiskit.pulse.library.Constant" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/pulse/library/parametric_pulses.py" signature="Constant(duration, amp, name=None)" modifiers="class">
...
$$
  ...
  *   **name** (`Optional`\[`str`]) – Display name for this pulse envelope.
  ...
  <Function id="qiskit.pulse.library.Constant.assign" signature="Constant.assign(parameter, value)">
  ...
  <span id="qiskit-pulse-library-constant-assign-parameters" />

  ### assign\_parameters

  <Function id="qiskit.pulse.library.Constant.assign_parameters" signature="Constant.assign_parameters(value_dict)">
  ...
  <Function id="qiskit.pulse.library.Constant.draw" signature="Constant.draw(dt=None, style=None, filename=None, interp_method=None, scale=None, interactive=None, draw_title=None, backend=None, time_range=None, time_unit='dt', show_waveform_info=True, plotter='mpl2d', axis=None)">
  ...
  <span id="qiskit-pulse-library-constant-get-waveform" />
  ...
  <span id="qiskit-pulse-library-constant-is-parameterized" />
  ...
  <span id="qiskit-pulse-library-constant-validate-parameters" />
