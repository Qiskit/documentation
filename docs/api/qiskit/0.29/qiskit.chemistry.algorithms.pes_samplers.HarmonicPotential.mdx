...
<Class id="qiskit.chemistry.algorithms.pes_samplers.HarmonicPotential" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/chemistry/algorithms/pes_samplers/potentials/harmonic_potential.py" signature="HarmonicPotential(molecule)">
  ...
  **ValueError** – Only implemented for diatomic molecules
  ...
  <Function id="qiskit.chemistry.algorithms.pes_samplers.HarmonicPotential.dissociation_energy" name="dissociation_energy" signature="HarmonicPotential.dissociation_energy(scaling=1.0)">
  ...
  <Function id="qiskit.chemistry.algorithms.pes_samplers.HarmonicPotential.eval" name="eval" signature="HarmonicPotential.eval(x)">
  ...
  <Function id="qiskit.chemistry.algorithms.pes_samplers.HarmonicPotential.fit" name="fit" signature="HarmonicPotential.fit(xdata, ydata, initial_vals=None, bounds_list=None)">
  ...
  <Function id="qiskit.chemistry.algorithms.pes_samplers.HarmonicPotential.fit_function" name="fit_function" signature="static HarmonicPotential.fit_function(x, k, r_0, m_shift)">
  ...
  <Function id="qiskit.chemistry.algorithms.pes_samplers.HarmonicPotential.fundamental_frequency" name="fundamental_frequency" signature="HarmonicPotential.fundamental_frequency()">
  ...
  <Function id="qiskit.chemistry.algorithms.pes_samplers.HarmonicPotential.get_equilibrium_geometry" name="get_equilibrium_geometry" signature="HarmonicPotential.get_equilibrium_geometry(scaling=1.0)">
  ...
  <Function id="qiskit.chemistry.algorithms.pes_samplers.HarmonicPotential.get_maximum_trusted_level" name="get_maximum_trusted_level" signature="HarmonicPotential.get_maximum_trusted_level(n=0)">
  ...
  <Function id="qiskit.chemistry.algorithms.pes_samplers.HarmonicPotential.get_minimal_energy" name="get_minimal_energy" signature="HarmonicPotential.get_minimal_energy(scaling=1.0)">
  ...
  <Function id="qiskit.chemistry.algorithms.pes_samplers.HarmonicPotential.get_num_modes" name="get_num_modes" signature="HarmonicPotential.get_num_modes()">
  ...
  <Function id="qiskit.chemistry.algorithms.pes_samplers.HarmonicPotential.get_trust_region" name="get_trust_region" signature="HarmonicPotential.get_trust_region()">
  ...
  <Function id="qiskit.chemistry.algorithms.pes_samplers.HarmonicPotential.process_fit_data" name="process_fit_data" signature="classmethod HarmonicPotential.process_fit_data(xdata, ydata)">
  ...
  <Function id="qiskit.chemistry.algorithms.pes_samplers.HarmonicPotential.update_molecule" name="update_molecule" signature="HarmonicPotential.update_molecule(molecule)">
  ...
  <Function id="qiskit.chemistry.algorithms.pes_samplers.HarmonicPotential.vibrational_energy_level" name="vibrational_energy_level" signature="HarmonicPotential.vibrational_energy_level(n)">
  ...
  <Function id="qiskit.chemistry.algorithms.pes_samplers.HarmonicPotential.wave_number" name="wave_number" signature="HarmonicPotential.wave_number()">
