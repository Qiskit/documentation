...
<Function id="qiskit.providers.aer.noise.device.gate_length_values" github="https://github.com/qiskit/qiskit-aer/tree/stable/0.8/qiskit/providers/aer/noise/device/parameters.py" signature="gate_length_values(properties)">
