---
title: GroverOperator (v0.29)
description: API reference for qiskit.circuit.library.GroverOperator in qiskit v0.29
...
$$
  ...
  *   **name** (`str`) – The name of the circuit.
  ...
  <Attribute id="qiskit.circuit.library.GroverOperator.instances" attributeValue="16" />
