...
<Class id="qiskit.aqua.components.initial_states.Zero" github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/aqua/components/initial_states/zero.py" signature="Zero(num_qubits)">
  ...
  **num\_qubits** (`int`) – Number of qubits, has a minimum value of 1.
  ...
  <Function id="qiskit.aqua.components.initial_states.Zero.construct_circuit" name="construct_circuit" signature="Zero.construct_circuit(mode='circuit', register=None)">
  ...
  <Attribute id="qiskit.aqua.components.initial_states.Zero.bitstr" name="bitstr" />
</Class>
