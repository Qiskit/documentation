...
$$
  ...
  **ValueError** – if `qfi_method` is neither a `CircuitQFI` object nor one of the predefined strings.
  ...
  <Function id="qiskit.aqua.operators.gradients.QFI.convert" name="convert" signature="QFI.convert(operator, params=None)">
    **Parameters**
  ...
  <Function id="qiskit.aqua.operators.gradients.QFI.gradient_wrapper" name="gradient_wrapper" signature="QFI.gradient_wrapper(operator, bind_params, grad_params=None, backend=None)">
  ...
  <Function id="qiskit.aqua.operators.gradients.QFI.parameter_expression_grad" name="parameter_expression_grad" signature="static QFI.parameter_expression_grad(param_expr, param)">
  ...
  <Attribute id="qiskit.aqua.operators.gradients.QFI.qfi_method" name="qfi_method">
    Returns `CircuitQFI`.
