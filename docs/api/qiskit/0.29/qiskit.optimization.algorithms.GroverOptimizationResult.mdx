...
<Class id="qiskit.optimization.algorithms.GroverOptimizationResult" github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/optimization/algorithms/grover_optimizer.py" signature="GroverOptimizationResult(x, fval, variables, operation_counts, n_input_qubits, n_output_qubits, intermediate_fval, threshold, status)">
  ...
  *   **status** (`OptimizationResultStatus`) – the termination status of the optimization algorithm.
  ...
  <Attribute id="qiskit.optimization.algorithms.GroverOptimizationResult.fval" name="fval">
  ...
  <Attribute id="qiskit.optimization.algorithms.GroverOptimizationResult.intermediate_fval" name="intermediate_fval">
  ...
  <Attribute id="qiskit.optimization.algorithms.GroverOptimizationResult.n_input_qubits" name="n_input_qubits">
  ...
  <Attribute id="qiskit.optimization.algorithms.GroverOptimizationResult.n_output_qubits" name="n_output_qubits">
  ...
  <Attribute id="qiskit.optimization.algorithms.GroverOptimizationResult.operation_counts" name="operation_counts">
  ...
  <Attribute id="qiskit.optimization.algorithms.GroverOptimizationResult.raw_results" name="raw_results">
  ...
  <Attribute id="qiskit.optimization.algorithms.GroverOptimizationResult.samples" name="samples">
  ...
  <Attribute id="qiskit.optimization.algorithms.GroverOptimizationResult.status" name="status">
  ...
  <Attribute id="qiskit.optimization.algorithms.GroverOptimizationResult.threshold" name="threshold">
  ...
  <Attribute id="qiskit.optimization.algorithms.GroverOptimizationResult.variable_names" name="variable_names">
  ...
  <Attribute id="qiskit.optimization.algorithms.GroverOptimizationResult.variables" name="variables">
  ...
  <Attribute id="qiskit.optimization.algorithms.GroverOptimizationResult.variables_dict" name="variables_dict">
  ...
  <Attribute id="qiskit.optimization.algorithms.GroverOptimizationResult.x" name="x">
