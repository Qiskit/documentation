---
title: RecursiveMinimumEigenOptimizationResult (v0.29)
description: API reference for qiskit.optimization.algorithms.RecursiveMinimumEigenOptimizationResult in qiskit v0.29
