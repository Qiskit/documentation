...
<Class id="qiskit.pulse.instructions.Call" github="https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/pulse/instructions/call.py" signature="Call(subroutine, value_dict=None, name=None)">
  ...
  **Raises**
  ...
  <Function id="qiskit.pulse.instructions.Call.assign_parameters" signature="Call.assign_parameters(value_dict)">
  ...
  <Function id="qiskit.pulse.instructions.Call.flatten" signature="Call.flatten()">
