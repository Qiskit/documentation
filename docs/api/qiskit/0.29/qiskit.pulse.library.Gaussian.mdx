...
<Class id="qiskit.pulse.library.Gaussian" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/pulse/library/parametric_pulses.py" signature="Gaussian(duration, amp, sigma, name=None)">
...
$$
  ...
  *   **name** (`Optional`\[`str`]) – Display name for this pulse envelope.
  ...
  <Function id="qiskit.pulse.library.Gaussian.assign" name="assign" signature="Gaussian.assign(parameter, value)">
  ...
  <Function id="qiskit.pulse.library.Gaussian.assign_parameters" name="assign_parameters" signature="Gaussian.assign_parameters(value_dict)">
  ...
  <Function id="qiskit.pulse.library.Gaussian.draw" name="draw" signature="Gaussian.draw(dt=None, style=None, filename=None, interp_method=None, scale=None, interactive=None, draw_title=None, backend=None, time_range=None, time_unit='dt', show_waveform_info=True, plotter='mpl2d', axis=None)">
  ...
  <Attribute id="qiskit.pulse.library.Gaussian.amp" name="amp">
  ...
  <Attribute id="qiskit.pulse.library.Gaussian.sigma" name="sigma">
