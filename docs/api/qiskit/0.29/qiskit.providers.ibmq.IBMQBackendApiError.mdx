...
<Class id="qiskit.providers.ibmq.IBMQBackendApiError" github="https://github.com/qiskit/qiskit-ibmq-provider/tree/stable/0.16/qiskit/providers/ibmq/exceptions.py" signature="IBMQBackendApiError(*message)">
