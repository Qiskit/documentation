...
<Class id="qiskit.aqua.operators.gradients.DerivativeBase" github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/aqua/operators/gradients/derivative_base.py" signature="DerivativeBase">
