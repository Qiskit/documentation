---
title: DerivativeBase (v0.29)
description: API reference for qiskit.aqua.operators.gradients.DerivativeBase in qiskit v0.29
...
<Class id="qiskit.aqua.operators.gradients.DerivativeBase" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/aqua/operators/gradients/derivative_base.py" signature="DerivativeBase" modifiers="class">
  ...
  <Function id="qiskit.aqua.operators.gradients.DerivativeBase.convert" signature="DerivativeBase.convert(operator, params=None)" modifiers="abstract">
    **Parameters**
  ...
  <span id="qiskit-aqua-operators-gradients-derivativebase-gradient-wrapper" />

  ### gradient\_wrapper

  <Function id="qiskit.aqua.operators.gradients.DerivativeBase.gradient_wrapper" signature="DerivativeBase.gradient_wrapper(operator, bind_params, grad_params=None, backend=None)">
  ...
  <span id="qiskit-aqua-operators-gradients-derivativebase-parameter-expression-grad" />

  ### parameter\_expression\_grad

  <Function id="qiskit.aqua.operators.gradients.DerivativeBase.parameter_expression_grad" signature="DerivativeBase.parameter_expression_grad(param_expr, param)" modifiers="static">
