...
<Class id="qiskit.transpiler.passes.FixedPoint" github="https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/transpiler/passes/utils/fixed_point.py" signature="FixedPoint(*args, **kwargs)">
