...
<Function id="qiskit.providers.aer.library.set_unitary" name="set_unitary" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-aer/tree/stable/0.8/qiskit/providers/aer/library/set_instructions/set_unitary.py" signature="set_unitary(self, state)">
