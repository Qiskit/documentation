---
title: Waveform (v0.29)
description: API reference for qiskit.pulse.Waveform in qiskit v0.29
...
<Class id="qiskit.pulse.Waveform" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/pulse/library/waveform.py" signature="Waveform(samples, name=None, epsilon=1e-07, limit_amplitude=None)" modifiers="class">
  ...
  *   **limit\_amplitude** (`Optional`\[`bool`]) – Passed to parent Pulse
  ...
  <span id="qiskit-pulse-waveform-assign-parameters" />

  ### assign\_parameters

  <Function id="qiskit.pulse.Waveform.assign_parameters" signature="Waveform.assign_parameters(value_dict)">
  ...
  <Function id="qiskit.pulse.Waveform.draw" signature="Waveform.draw(dt=None, style=None, filename=None, interp_method=None, scale=None, interactive=None, draw_title=None, backend=None, time_range=None, time_unit='dt', show_waveform_info=True, plotter='mpl2d', axis=None)">
  ...
  <span id="qiskit-pulse-waveform-is-parameterized" />

  ### is\_parameterized

  <Function id="qiskit.pulse.Waveform.is_parameterized" signature="Waveform.is_parameterized()">
  ...
  <Attribute id="qiskit.pulse.Waveform.limit_amplitude" attributeValue="True" />

  ### parameters

  <Attribute id="qiskit.pulse.Waveform.parameters">
