...
<Class id="qiskit.pulse.library.GaussianSquare" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/pulse/library/parametric_pulses.py" signature="GaussianSquare(duration, amp, sigma, width=None, risefall_sigma_ratio=None, name=None)">
...
$$
  ...
  *   **name** (`Optional`\[`str`]) – Display name for this pulse envelope.
  ...
  <Function id="qiskit.pulse.library.GaussianSquare.assign" name="assign" signature="GaussianSquare.assign(parameter, value)">
  ...
  <Function id="qiskit.pulse.library.GaussianSquare.assign_parameters" name="assign_parameters" signature="GaussianSquare.assign_parameters(value_dict)">
  ...
  <Function id="qiskit.pulse.library.GaussianSquare.draw" name="draw" signature="GaussianSquare.draw(dt=None, style=None, filename=None, interp_method=None, scale=None, interactive=None, draw_title=None, backend=None, time_range=None, time_unit='dt', show_waveform_info=True, plotter='mpl2d', axis=None)">
  ...
  <Function id="qiskit.pulse.library.GaussianSquare.get_waveform" name="get_waveform" signature="GaussianSquare.get_waveform()">
  ...
  <Function id="qiskit.pulse.library.GaussianSquare.is_parameterized" name="is_parameterized" signature="GaussianSquare.is_parameterized()">
  ...
  <Function id="qiskit.pulse.library.GaussianSquare.validate_parameters" name="validate_parameters" signature="GaussianSquare.validate_parameters()">
    Validate parameters.
  ...
  <Attribute id="qiskit.pulse.library.GaussianSquare.amp" name="amp">
  ...
  <Attribute id="qiskit.pulse.library.GaussianSquare.id" name="id">
  ...
  <Attribute id="qiskit.pulse.library.GaussianSquare.limit_amplitude" name="limit_amplitude" attributeValue="True" />

  ### parameters

  <Attribute id="qiskit.pulse.library.GaussianSquare.parameters" name="parameters">
    **Return type**
  ...
  <Attribute id="qiskit.pulse.library.GaussianSquare.risefall_sigma_ratio" name="risefall_sigma_ratio">
  ...
  <Attribute id="qiskit.pulse.library.GaussianSquare.sigma" name="sigma">
  ...
  <Attribute id="qiskit.pulse.library.GaussianSquare.width" name="width">
