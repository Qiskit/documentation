...
<Class id="qiskit.aqua.operators.legacy.Z2Symmetries" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/aqua/operators/legacy/weighted_pauli_operator.py" signature="Z2Symmetries(symmetries, sq_paulis, sq_list, tapering_values=None)">
  ...
  **Raises**
  ...
  <Function id="qiskit.aqua.operators.legacy.Z2Symmetries.consistent_tapering" name="consistent_tapering" signature="Z2Symmetries.consistent_tapering(operator)">
  ...
  <Function id="qiskit.aqua.operators.legacy.Z2Symmetries.copy" name="copy" signature="Z2Symmetries.copy()">
    Get a copy of self.
  ...
  <Function id="qiskit.aqua.operators.legacy.Z2Symmetries.find_Z2_symmetries" name="find_Z2_symmetries" signature="classmethod Z2Symmetries.find_Z2_symmetries(operator)">
  ...
  <Function id="qiskit.aqua.operators.legacy.Z2Symmetries.is_empty" name="is_empty" signature="Z2Symmetries.is_empty()">
  ...
  <Function id="qiskit.aqua.operators.legacy.Z2Symmetries.taper" name="taper" signature="Z2Symmetries.taper(operator, tapering_values=None)">
  ...
  <Function id="qiskit.aqua.operators.legacy.Z2Symmetries.two_qubit_reduction" name="two_qubit_reduction" signature="static Z2Symmetries.two_qubit_reduction(operator, num_particles)">
  ...
  <Attribute id="qiskit.aqua.operators.legacy.Z2Symmetries.cliffords" name="cliffords">
  ...
  <Attribute id="qiskit.aqua.operators.legacy.Z2Symmetries.sq_list" name="sq_list">
    returns sq list
  </Attribute>

  ### sq\_paulis

  <Attribute id="qiskit.aqua.operators.legacy.Z2Symmetries.sq_paulis" name="sq_paulis">
    returns sq paulis
  </Attribute>

  ### symmetries

  <Attribute id="qiskit.aqua.operators.legacy.Z2Symmetries.symmetries" name="symmetries">
    return symmetries
  </Attribute>

  ### tapering\_values

  <Attribute id="qiskit.aqua.operators.legacy.Z2Symmetries.tapering_values" name="tapering_values">
