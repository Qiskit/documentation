...
<Class id="qiskit.aqua.operators.legacy.Z2Symmetries" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/aqua/operators/legacy/weighted_pauli_operator.py" signature="Z2Symmetries(symmetries, sq_paulis, sq_list, tapering_values=None)">
  ...
  **Raises**
  ...
  <Function id="qiskit.aqua.operators.legacy.Z2Symmetries.find_Z2_symmetries" signature="classmethod Z2Symmetries.find_Z2_symmetries(operator)">
  ...
  <Function id="qiskit.aqua.operators.legacy.Z2Symmetries.two_qubit_reduction" signature="static Z2Symmetries.two_qubit_reduction(operator, num_particles)">
