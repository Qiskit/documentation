...
<Class id="qiskit.ignis.verification.GatesetTomographyFitter" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-ignis/tree/stable/0.6/qiskit/ignis/verification/tomography/fitters/gateset_fitter.py" signature="GatesetTomographyFitter(result, circuits, gateset_basis='default')">
  Bases: `object`
  ...
  **Additional information:**
  ...
  <Function id="qiskit.ignis.verification.GatesetTomographyFitter.fit" name="fit" signature="GatesetTomographyFitter.fit()">
  ...
  <Function id="qiskit.ignis.verification.GatesetTomographyFitter.linear_inversion" name="linear_inversion" signature="GatesetTomographyFitter.linear_inversion()">
