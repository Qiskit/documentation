---
title: plot_state_city (v0.29)
description: API reference for qiskit.visualization.plot_state_city in qiskit v0.29
...
<Function id="qiskit.visualization.plot_state_city" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/visualization/state_visualization.py" signature="plot_state_city(state, title='', figsize=None, color=None, alpha=1, ax_real=None, ax_imag=None, *, rho=None)">
  ...
  **Example**
  ...
  ![../\_images/qiskit.visualization.plot\_state\_city\_0\_0.png](/docs/images/api/qiskit/0.29/qiskit.visualization.plot_state_city_0_0.avif)
</Function>
