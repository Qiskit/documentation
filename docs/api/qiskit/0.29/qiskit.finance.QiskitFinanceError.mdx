...
<Class id="qiskit.finance.QiskitFinanceError" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/finance/exceptions.py" signature="QiskitFinanceError(*message)">
