---
title: AccreditationCircuits (v0.29)
description: API reference for qiskit.ignis.verification.AccreditationCircuits in qiskit v0.29
...
<Class id="qiskit.ignis.verification.AccreditationCircuits" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-ignis/tree/stable/0.6/qiskit/ignis/verification/accreditation/circuits.py" signature="AccreditationCircuits(target_circ, two_qubit_gate='cx', coupling_map=None, seed=None)" modifiers="class">
  Bases: `object`
  ...
  *   **seed** (*int*) – seed to the random number generator
  ...
  <span id="qiskit-ignis-verification-accreditationcircuits-generate-circuits" />

  ### generate\_circuits

  <Function id="qiskit.ignis.verification.AccreditationCircuits.generate_circuits" signature="AccreditationCircuits.generate_circuits(num_trap)">
  ...
  <span id="qiskit-ignis-verification-accreditationcircuits-target-circuit" />

  ### target\_circuit

  <Function id="qiskit.ignis.verification.AccreditationCircuits.target_circuit" signature="AccreditationCircuits.target_circuit(target_circ, two_qubit_gate='cx', coupling_map=None)">
