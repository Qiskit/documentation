...
<Class id="qiskit.chemistry.BosonicOperator" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/chemistry/bosonic_operator.py" signature="BosonicOperator(h, basis)">
  ...
  *   **basis** (`List`\[`int`]) – Is a list defining the number of modals per mode. E.g. for a 3 modes system with 4 modals per mode basis = \[4,4,4].
  ...
  <Function id="qiskit.chemistry.BosonicOperator.direct_mapping_filtering_criterion" name="direct_mapping_filtering_criterion" signature="BosonicOperator.direct_mapping_filtering_criterion(state, value, aux_values=None)">
  ...
  <Function id="qiskit.chemistry.BosonicOperator.mapping" name="mapping" signature="BosonicOperator.mapping(qubit_mapping='direct', threshold=1e-08)">
  ...
  <Function id="qiskit.chemistry.BosonicOperator.number_occupied_modals_per_mode" name="number_occupied_modals_per_mode" signature="BosonicOperator.number_occupied_modals_per_mode(mode)">
