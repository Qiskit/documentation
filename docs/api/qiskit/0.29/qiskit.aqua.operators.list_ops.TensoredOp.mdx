...
<Class id="qiskit.aqua.operators.list_ops.TensoredOp" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/aqua/operators/list_ops/tensored_op.py" signature="TensoredOp(oplist, coeff=1.0, abelian=False)">
  ...
  *   **abelian** (`bool`) – Indicates whether the Operators in `oplist` are known to mutually commute.
  ...
  <Function id="qiskit.aqua.operators.list_ops.TensoredOp.add" name="add" signature="TensoredOp.add(other)">
  ...
  <Function id="qiskit.aqua.operators.list_ops.TensoredOp.adjoint" name="adjoint" signature="TensoredOp.adjoint()">
  ...
  <Function id="qiskit.aqua.operators.list_ops.TensoredOp.assign_parameters" name="assign_parameters" signature="TensoredOp.assign_parameters(param_dict)">
  ...
  <Function id="qiskit.aqua.operators.list_ops.TensoredOp.bind_parameters" name="bind_parameters" signature="TensoredOp.bind_parameters(param_dict)">
  ...
  <Function id="qiskit.aqua.operators.list_ops.TensoredOp.compose" name="compose" signature="TensoredOp.compose(other, permutation=None, front=False)">
  ...
  <Function id="qiskit.aqua.operators.list_ops.TensoredOp.equals" name="equals" signature="TensoredOp.equals(other)">
  ...
  <Function id="qiskit.aqua.operators.list_ops.TensoredOp.eval" name="eval" signature="TensoredOp.eval(front=None)">
  ...
  <Function id="qiskit.aqua.operators.list_ops.TensoredOp.exp_i" name="exp_i" signature="TensoredOp.exp_i()">
  ...
  <Function id="qiskit.aqua.operators.list_ops.TensoredOp.log_i" name="log_i" signature="TensoredOp.log_i(massive=False)">
  ...
  <Function id="qiskit.aqua.operators.list_ops.TensoredOp.mul" name="mul" signature="TensoredOp.mul(scalar)">
  ...
  <Function id="qiskit.aqua.operators.list_ops.TensoredOp.neg" name="neg" signature="TensoredOp.neg()">
  ...
  <Function id="qiskit.aqua.operators.list_ops.TensoredOp.permute" name="permute" signature="TensoredOp.permute(permutation)">
  ...
  <Function id="qiskit.aqua.operators.list_ops.TensoredOp.power" name="power" signature="TensoredOp.power(exponent)">
  ...
  <Function id="qiskit.aqua.operators.list_ops.TensoredOp.primitive_strings" name="primitive_strings" signature="TensoredOp.primitive_strings()">
  ...
  <Function id="qiskit.aqua.operators.list_ops.TensoredOp.reduce" name="reduce" signature="TensoredOp.reduce()">
  ...
  <Function id="qiskit.aqua.operators.list_ops.TensoredOp.tensor" name="tensor" signature="TensoredOp.tensor(other)">
  ...
  <Function id="qiskit.aqua.operators.list_ops.TensoredOp.tensorpower" name="tensorpower" signature="TensoredOp.tensorpower(other)">
  ...
  <Function id="qiskit.aqua.operators.list_ops.TensoredOp.to_circuit" name="to_circuit" signature="TensoredOp.to_circuit()">
  ...
  <Function id="qiskit.aqua.operators.list_ops.TensoredOp.to_circuit_op" name="to_circuit_op" signature="TensoredOp.to_circuit_op()">
  ...
  <Function id="qiskit.aqua.operators.list_ops.TensoredOp.to_legacy_op" name="to_legacy_op" signature="TensoredOp.to_legacy_op(massive=False)">
  ...
  <Function id="qiskit.aqua.operators.list_ops.TensoredOp.to_matrix" name="to_matrix" signature="TensoredOp.to_matrix(massive=False)">
  ...
  <Function id="qiskit.aqua.operators.list_ops.TensoredOp.to_matrix_op" name="to_matrix_op" signature="TensoredOp.to_matrix_op(massive=False)">
  ...
  <Function id="qiskit.aqua.operators.list_ops.TensoredOp.to_pauli_op" name="to_pauli_op" signature="TensoredOp.to_pauli_op(massive=False)">
  ...
  <Function id="qiskit.aqua.operators.list_ops.TensoredOp.to_spmatrix" name="to_spmatrix" signature="TensoredOp.to_spmatrix()">
  ...
  <Function id="qiskit.aqua.operators.list_ops.TensoredOp.traverse" name="traverse" signature="TensoredOp.traverse(convert_fn, coeff=None)">
  ...
  <Attribute id="qiskit.aqua.operators.list_ops.TensoredOp.ENABLE_DEPRECATION" name="ENABLE_DEPRECATION" attributeValue="= True" />

  ### INDENTATION

  <Attribute id="qiskit.aqua.operators.list_ops.TensoredOp.INDENTATION" name="INDENTATION" attributeValue="= '  '" />

  ### abelian

  <Attribute id="qiskit.aqua.operators.list_ops.TensoredOp.abelian" name="abelian">
  ...
  <Attribute id="qiskit.aqua.operators.list_ops.TensoredOp.coeff" name="coeff">
  ...
  <Attribute id="qiskit.aqua.operators.list_ops.TensoredOp.combo_fn" name="combo_fn">
  ...
  <Attribute id="qiskit.aqua.operators.list_ops.TensoredOp.distributive" name="distributive">
    **Return type**
  ...
  <Attribute id="qiskit.aqua.operators.list_ops.TensoredOp.grad_combo_fn" name="grad_combo_fn">
  ...
  <Attribute id="qiskit.aqua.operators.list_ops.TensoredOp.num_qubits" name="num_qubits">
    **Return type**
  ...
  <Attribute id="qiskit.aqua.operators.list_ops.TensoredOp.oplist" name="oplist">
  ...
  <Attribute id="qiskit.aqua.operators.list_ops.TensoredOp.parameters" name="parameters" />
</Class>
