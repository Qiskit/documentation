...
<Class id="qiskit.aqua.operators.gradients.CircuitQFI" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/aqua/operators/gradients/circuit_qfis/circuit_qfi.py" signature="CircuitQFI">
  ...
  <Function id="qiskit.aqua.operators.gradients.CircuitQFI.convert" name="convert" signature="abstract CircuitQFI.convert(operator, params=None)">
    **Parameters**
