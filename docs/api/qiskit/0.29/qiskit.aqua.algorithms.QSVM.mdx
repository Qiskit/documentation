...
<Class id="qiskit.aqua.algorithms.QSVM" github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/aqua/algorithms/classifiers/qsvm/qsvm.py" signature="QSVM(feature_map, training_dataset=None, test_dataset=None, datapoints=None, multiclass_extension=None, lambda2=0.001, quantum_instance=None)">
  ...
  **Raises**
  ...
  <Function id="qiskit.aqua.algorithms.QSVM.get_kernel_matrix" signature="static QSVM.get_kernel_matrix(quantum_instance, feature_map, x1_vec, x2_vec=None, enforce_psd=True)">
    Construct kernel matrix, if x2\_vec is None, self-innerproduct is conducted.
  ...
  <Attribute id="qiskit.aqua.algorithms.QSVM.BATCH_SIZE" name="BATCH_SIZE" attributeValue="= 1000" />

  ### backend

  <Attribute id="qiskit.aqua.algorithms.QSVM.backend" name="backend">
    Returns backend.
  ...
  <Attribute id="qiskit.aqua.algorithms.QSVM.quantum_instance" name="quantum_instance">
