...
<Class id="qiskit.quantum_info.Pauli" github="https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/quantum_info/operators/symplectic/pauli.py" signature="Pauli(data=None, x=None, *, z=None, label=None)">
  ...
  **QiskitError** – if input array is invalid shape.
  ...
  <Function id="qiskit.quantum_info.Pauli.from_label" signature="static Pauli.from_label(*args, **kwargs)">
  ...
  <Function id="qiskit.quantum_info.Pauli.pauli_single" signature="classmethod Pauli.pauli_single(num_qubits, index, pauli_label)">
  ...
  <Function id="qiskit.quantum_info.Pauli.random" signature="classmethod Pauli.random(num_qubits, seed=None)">
  ...
  <Function id="qiskit.quantum_info.Pauli.set_truncation" signature="classmethod Pauli.set_truncation(val)">
  ...
  <Function id="qiskit.quantum_info.Pauli.sgn_prod" signature="static Pauli.sgn_prod(*args, **kwargs)">
