...
<Function id="qiskit.utils.name_args" name="name_args" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/utils/name_unnamed_args.py" signature="name_args(mapping, skip=0)">
