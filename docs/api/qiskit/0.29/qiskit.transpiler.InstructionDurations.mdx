---
title: InstructionDurations (v0.29)
description: API reference for qiskit.transpiler.InstructionDurations in qiskit v0.29
...
<Class id="qiskit.transpiler.InstructionDurations" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/transpiler/instruction_durations.py" signature="InstructionDurations(instruction_durations=None, dt=None)" modifiers="class">
  Bases: `object`
  ...
  <Function id="qiskit.transpiler.InstructionDurations.get" signature="InstructionDurations.get(inst, qubits, unit='dt')">
