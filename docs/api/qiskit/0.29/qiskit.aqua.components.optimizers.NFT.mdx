---
title: NFT (v0.29)
description: API reference for qiskit.aqua.components.optimizers.NFT in qiskit v0.29
...
<Class id="qiskit.aqua.components.optimizers.NFT" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/aqua/components/optimizers/nft.py" signature="NFT(maxiter=None, maxfev=1024, disp=False, reset_interval=32)" modifiers="class">
  ...
  **[1](#id1)**
  ...
  <span id="qiskit-aqua-components-optimizers-nft-get-support-level" />
  ...
  <span id="qiskit-aqua-components-optimizers-nft-gradient-num-diff" />
  ...
  <span id="qiskit-aqua-components-optimizers-nft-print-options" />
  ...
  <span id="qiskit-aqua-components-optimizers-nft-set-max-evals-grouped" />
  ...
  <span id="qiskit-aqua-components-optimizers-nft-set-options" />
  ...
  <span id="qiskit-aqua-components-optimizers-nft-wrap-function" />
