---
title: NoiseModel (v0.29)
description: API reference for qiskit.providers.aer.noise.NoiseModel in qiskit v0.29
...
<Class id="qiskit.providers.aer.noise.NoiseModel" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-aer/tree/stable/0.8/qiskit/providers/aer/noise/noise_model.py" signature="NoiseModel(basis_gates=None)" modifiers="class">
  ...
  **basis\_gates** (*list\[str] or None*) – Specify an initial basis\_gates for the noise model. If None a default value of \[‘id’, ‘u3’, ‘cx’] is used (Default: None).
  ...
  <span id="qiskit-providers-aer-noise-noisemodel-add-all-qubit-quantum-error" />
  ...
  <span id="qiskit-providers-aer-noise-noisemodel-add-all-qubit-readout-error" />
  ...
  <span id="qiskit-providers-aer-noise-noisemodel-add-basis-gates" />
  ...
  <span id="qiskit-providers-aer-noise-noisemodel-add-nonlocal-quantum-error" />
  ...
  <span id="qiskit-providers-aer-noise-noisemodel-add-quantum-error" />
  ...
  <span id="qiskit-providers-aer-noise-noisemodel-add-readout-error" />
  ...
  <span id="qiskit-providers-aer-noise-noisemodel-from-backend" />
  ...
  <span id="qiskit-providers-aer-noise-noisemodel-from-dict" />
  ...
  <span id="qiskit-providers-aer-noise-noisemodel-is-ideal" />
  ...
  <span id="qiskit-providers-aer-noise-noisemodel-to-dict" />
