...
<Function id="qiskit.aqua.utils.validate_entangler_map" name="validate_entangler_map" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/aqua/utils/entangler_map.py" signature="validate_entangler_map(entangler_map, num_qubits, allow_double_entanglement=False)">
