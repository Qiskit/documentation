...
<Class id="qiskit.chemistry.FermionicOperator" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/chemistry/fermionic_operator.py" signature="FermionicOperator(h1, h2=None, ph_trans_shift=None)">
  Bases: `object`
  ...
  *   **ph\_trans\_shift** (*float*) – energy shift caused by particle hole transformation
  ...
  <Function id="qiskit.chemistry.FermionicOperator.fermion_mode_elimination" name="fermion_mode_elimination" signature="FermionicOperator.fermion_mode_elimination(fermion_mode_array)">
    Eliminate modes.
  ...
  <Function id="qiskit.chemistry.FermionicOperator.fermion_mode_freezing" name="fermion_mode_freezing" signature="FermionicOperator.fermion_mode_freezing(fermion_mode_array)">
  ...
  <Function id="qiskit.chemistry.FermionicOperator.mapping" name="mapping" signature="FermionicOperator.mapping(map_type, threshold=1e-08)">
  ...
  <Function id="qiskit.chemistry.FermionicOperator.particle_hole_transformation" name="particle_hole_transformation" signature="FermionicOperator.particle_hole_transformation(num_particles)">
  ...
  <Function id="qiskit.chemistry.FermionicOperator.total_angular_momentum" name="total_angular_momentum" signature="FermionicOperator.total_angular_momentum()">
  ...
  <Function id="qiskit.chemistry.FermionicOperator.total_magnetization" name="total_magnetization" signature="FermionicOperator.total_magnetization()">
  ...
  <Function id="qiskit.chemistry.FermionicOperator.total_particle_number" name="total_particle_number" signature="FermionicOperator.total_particle_number()">
  ...
  <Function id="qiskit.chemistry.FermionicOperator.transform" name="transform" signature="FermionicOperator.transform(unitary_matrix)">
  ...
  <Attribute id="qiskit.chemistry.FermionicOperator.h1" name="h1">
    Getter of one body integral tensor.
  </Attribute>

  ### h2

  <Attribute id="qiskit.chemistry.FermionicOperator.h2" name="h2">
    Getter of two body integral tensor.
  </Attribute>

  ### modes

  <Attribute id="qiskit.chemistry.FermionicOperator.modes" name="modes">
    Getter of modes.
  </Attribute>
</Class>
