...
<Class id="qiskit.providers.ibmq.IBMQBackendError" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-ibmq-provider/tree/stable/0.16/qiskit/providers/ibmq/exceptions.py" signature="IBMQBackendError(*message)">
