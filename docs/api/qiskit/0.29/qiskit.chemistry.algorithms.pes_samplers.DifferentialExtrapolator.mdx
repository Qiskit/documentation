---
title: DifferentialExtrapolator (v0.29)
description: API reference for qiskit.chemistry.algorithms.pes_samplers.DifferentialExtrapolator in qiskit v0.29
...
<Class id="qiskit.chemistry.algorithms.pes_samplers.DifferentialExtrapolator" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/chemistry/algorithms/pes_samplers/extrapolator.py" signature="DifferentialExtrapolator(degree=1, model=None)" modifiers="class">
  ...
  *   **degree** (`int`) – Specifies (degree -1) derivatives to be added as ‘features’ in regression model.
  ...
  <span id="qiskit-chemistry-algorithms-pes-samplers-differentialextrapolator-extrapolate" />

  ### extrapolate

  <Function id="qiskit.chemistry.algorithms.pes_samplers.DifferentialExtrapolator.extrapolate" signature="DifferentialExtrapolator.extrapolate(points, param_dict)">
  ...
  <span id="qiskit-chemistry-algorithms-pes-samplers-differentialextrapolator-factory" />

  ### factory

  <Function id="qiskit.chemistry.algorithms.pes_samplers.DifferentialExtrapolator.factory" signature="DifferentialExtrapolator.factory(mode, **kwargs)" modifiers="static">
