---
title: Hamiltonian (v0.29)
description: API reference for qiskit.chemistry.core.Hamiltonian in qiskit v0.29
...
<Class id="qiskit.chemistry.core.Hamiltonian" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/chemistry/core/hamiltonian.py" signature="Hamiltonian(transformation=<TransformationType.FULL: 'full'>, qubit_mapping=<QubitMappingType.PARITY: 'parity'>, two_qubit_reduction=True, freeze_core=False, orbital_reduction=None, z2symmetry_reduction=None)" modifiers="class">
  ...
  **Raises**
  ...
  <span id="qiskit-chemistry-core-hamiltonian-process-algorithm-result" />
