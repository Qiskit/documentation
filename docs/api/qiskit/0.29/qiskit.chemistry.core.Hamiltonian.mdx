...
<Class id="qiskit.chemistry.core.Hamiltonian" github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/chemistry/core/hamiltonian.py" signature="Hamiltonian(transformation=<TransformationType.FULL: 'full'>, qubit_mapping=<QubitMappingType.PARITY: 'parity'>, two_qubit_reduction=True, freeze_core=False, orbital_reduction=None, z2symmetry_reduction=None)">
  ...
  **Raises**
  ...
  <Function id="qiskit.chemistry.core.Hamiltonian.process_algorithm_result" name="process_algorithm_result" signature="Hamiltonian.process_algorithm_result(algo_result)">
  ...
  <Function id="qiskit.chemistry.core.Hamiltonian.run" name="run" signature="Hamiltonian.run(qmolecule)">
    run method
  ...
  <Attribute id="qiskit.chemistry.core.Hamiltonian.INFO_NUM_ORBITALS" name="INFO_NUM_ORBITALS" attributeValue="= 'num_orbitals'" />

  ### INFO\_NUM\_PARTICLES

  <Attribute id="qiskit.chemistry.core.Hamiltonian.INFO_NUM_PARTICLES" name="INFO_NUM_PARTICLES" attributeValue="= 'num_particles'" />

  ### INFO\_TWO\_QUBIT\_REDUCTION

  <Attribute id="qiskit.chemistry.core.Hamiltonian.INFO_TWO_QUBIT_REDUCTION" name="INFO_TWO_QUBIT_REDUCTION" attributeValue="= 'two_qubit_reduction'" />

  ### INFO\_Z2SYMMETRIES

  <Attribute id="qiskit.chemistry.core.Hamiltonian.INFO_Z2SYMMETRIES" name="INFO_Z2SYMMETRIES" attributeValue="= 'z2symmetries'" />

  ### molecule\_info

  <Attribute id="qiskit.chemistry.core.Hamiltonian.molecule_info" name="molecule_info">
