...
description: API reference for qiskit.circuit.library.LogNormalDistribution in qiskit v0.29
...
$$
  ...
  *   **name** (`str`) – The name of the circuit.
  ...
  <Attribute id="qiskit.circuit.library.LogNormalDistribution.instances" attributeValue="16" />
