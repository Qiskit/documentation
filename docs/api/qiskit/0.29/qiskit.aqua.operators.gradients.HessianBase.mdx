...
<Class id="qiskit.aqua.operators.gradients.HessianBase" github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/aqua/operators/gradients/hessian_base.py" signature="HessianBase(hess_method='param_shift', **kwargs)">
  ...
  **ValueError** – If method != `fin_diff` and `epsilon` is not None.
  ...
  <Function id="qiskit.aqua.operators.gradients.HessianBase.convert" signature="abstract HessianBase.convert(operator, params=None)">
    **Parameters**
  ...
  <Function id="qiskit.aqua.operators.gradients.HessianBase.parameter_expression_grad" signature="static HessianBase.parameter_expression_grad(param_expr, param)">
