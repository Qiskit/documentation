---
title: GaussianDriver (v0.29)
description: API reference for qiskit.chemistry.drivers.GaussianDriver in qiskit v0.29
...
<Class id="qiskit.chemistry.drivers.GaussianDriver" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/chemistry/drivers/gaussiand/gaussiandriver.py" signature="GaussianDriver(config='# rhf/sto-3g scf(conventional)\\n\\nh2 molecule\\n\\n0 1\\nH 0.0 0.0 0.0\\nH 0.0 0.0 0.735\\n\\n', molecule=None, basis='sto-3g', hf_method=<HFMethodType.RHF: 'rhf'>)" modifiers="class">
  ...
  **Raises**
  ...
  <Function id="qiskit.chemistry.drivers.GaussianDriver.run" signature="GaussianDriver.run()">
