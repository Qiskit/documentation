...
description: API reference for qiskit.opflow.evolutions.EvolutionBase in qiskit v0.29
...
<Class id="qiskit.opflow.evolutions.EvolutionBase" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/opflow/evolutions/evolution_base.py" signature="EvolutionBase" modifiers="class">
