...
<Class id="qiskit.optimization.converters.QuadraticProgramToQubo" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/optimization/converters/quadratic_program_to_qubo.py" signature="QuadraticProgramToQubo(penalty=None)">
  ...
  **penalty** (`Optional`\[`float`]) – Penalty factor to scale equality constraints that are added to objective. If None is passed, penalty factor will be automatically calculated.
  ...
  <Function id="qiskit.optimization.converters.QuadraticProgramToQubo.get_compatibility_msg" signature="static QuadraticProgramToQubo.get_compatibility_msg(problem)">
