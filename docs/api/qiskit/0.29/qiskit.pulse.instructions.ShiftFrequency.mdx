---
title: ShiftFrequency (v0.29)
description: API reference for qiskit.pulse.instructions.ShiftFrequency in qiskit v0.29
...
<Class id="qiskit.pulse.instructions.ShiftFrequency" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/pulse/instructions/frequency.py" signature="ShiftFrequency(frequency, channel, name=None)" modifiers="class">
  ...
  *   **name** (`Optional`\[`str`]) – Name of this set channel frequency instruction.
  ...
  <span id="qiskit-pulse-instructions-shiftfrequency-assign-parameters" />

  ### assign\_parameters

  <Function id="qiskit.pulse.instructions.ShiftFrequency.assign_parameters" signature="ShiftFrequency.assign_parameters(value_dict)">
  ...
  <Function id="qiskit.pulse.instructions.ShiftFrequency.flatten" signature="ShiftFrequency.flatten()">
