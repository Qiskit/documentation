---
title: AmplitudeEstimation (v0.29)
description: API reference for qiskit.aqua.algorithms.AmplitudeEstimation in qiskit v0.29
...
$$
  ...
  *   **i\_objective** (`Optional`\[`int`]) – Deprecated, use `objective_qubits`. The index of the objective qubit, i.e. the qubit marking ‘good’ solutions with the state $|1\rangle$ and ‘bad’ solutions with the state $0\rangle$.
  ...
  <span id="qiskit-aqua-algorithms-amplitudeestimation-confidence-interval" />
  ...
  <span id="qiskit-aqua-algorithms-amplitudeestimation-construct-circuit" />
  ...
  <span id="qiskit-aqua-algorithms-amplitudeestimation-is-good-state" />
  ...
  <span id="qiskit-aqua-algorithms-amplitudeestimation-post-processing" />
  ...
  <span id="qiskit-aqua-algorithms-amplitudeestimation-set-backend" />
