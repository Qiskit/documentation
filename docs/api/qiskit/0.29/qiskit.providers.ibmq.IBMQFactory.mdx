...
<Class id="qiskit.providers.ibmq.IBMQFactory" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-ibmq-provider/tree/stable/0.16/qiskit/providers/ibmq/ibmqfactory.py" signature="IBMQFactory">
  Bases: `object`
  ...
  <Function id="qiskit.providers.ibmq.IBMQFactory.delete_account" signature="static IBMQFactory.delete_account()">
  ...
  <Function id="qiskit.providers.ibmq.IBMQFactory.save_account" signature="static IBMQFactory.save_account(token, url='https://auth.quantum-computing.ibm.com/api', hub=None, group=None, project=None, overwrite=False, **kwargs)">
  ...
  <Function id="qiskit.providers.ibmq.IBMQFactory.stored_account" signature="static IBMQFactory.stored_account()">
  ...
  <Function id="qiskit.providers.ibmq.IBMQFactory.update_account" signature="static IBMQFactory.update_account(force=False)">
