...
<Class id="qiskit.aqua.algorithms.DeutschJozsa" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/aqua/algorithms/education/deutsch_jozsa.py" signature="DeutschJozsa(oracle, quantum_instance=None)">
  ...
  *   **quantum\_instance** (`Union`\[`QuantumInstance`, `Backend`, `BaseBackend`, `None`]) – Quantum Instance or Backend
  ...
  <Attribute id="qiskit.aqua.algorithms.DeutschJozsa.backend" name="backend">
    Returns backend.
  ...
  <Attribute id="qiskit.aqua.algorithms.DeutschJozsa.quantum_instance" name="quantum_instance">
