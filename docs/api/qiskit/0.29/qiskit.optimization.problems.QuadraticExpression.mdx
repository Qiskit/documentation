...
<Class id="qiskit.optimization.problems.QuadraticExpression" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/optimization/problems/quadratic_expression.py" signature="QuadraticExpression(quadratic_program, coefficients)">
  ...
  *   **coefficients** (`Union`\[`ndarray`, `spmatrix`, `List`\[`List`\[`float`]], `Dict`\[`Tuple`\[`Union`\[`int`, `str`], `Union`\[`int`, `str`]], `float`]]) – The (sparse) representation of the coefficients.
  ...
  <Function id="qiskit.optimization.problems.QuadraticExpression.evaluate" name="evaluate" signature="QuadraticExpression.evaluate(x)">
  ...
  <Function id="qiskit.optimization.problems.QuadraticExpression.evaluate_gradient" name="evaluate_gradient" signature="QuadraticExpression.evaluate_gradient(x)">
  ...
  <Function id="qiskit.optimization.problems.QuadraticExpression.to_array" name="to_array" signature="QuadraticExpression.to_array(symmetric=False)">
  ...
  <Function id="qiskit.optimization.problems.QuadraticExpression.to_dict" name="to_dict" signature="QuadraticExpression.to_dict(symmetric=False, use_name=False)">
  ...
  <Attribute id="qiskit.optimization.problems.QuadraticExpression.coefficients" name="coefficients">
  ...
  <Attribute id="qiskit.optimization.problems.QuadraticExpression.quadratic_program" name="quadratic_program">
