...
<Class id="qiskit.providers.aer.QasmSimulator" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-aer/tree/stable/0.8/qiskit/providers/aer/backends/qasm_simulator.py" signature="QasmSimulator(configuration=None, properties=None, provider=None, **backend_options)">
  ...
  **Raises**
  ...
  <Function id="qiskit.providers.aer.QasmSimulator.run" name="run" signature="QasmSimulator.run(circuits, backend_options=None, validate=False, **run_options)">
