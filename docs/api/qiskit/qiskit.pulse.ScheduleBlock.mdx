...
<Class id="qiskit.pulse.ScheduleBlock" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.0/qiskit/pulse/schedule.py#L819-L1612" signature="qiskit.pulse.ScheduleBlock(name=None, metadata=None, alignment_context=None)">
  ...
  **Raises**
  ...
  <Attribute id="qiskit.pulse.ScheduleBlock.alignment_context" name="alignment_context">
    Return alignment instance that allocates block component to generate schedule.
  </Attribute>

  ### blocks

  <Attribute id="qiskit.pulse.ScheduleBlock.blocks" name="blocks">
  ...
  <Attribute id="qiskit.pulse.ScheduleBlock.channels" name="channels">
    Returns channels that this schedule block uses.
  </Attribute>

  ### duration

  <Attribute id="qiskit.pulse.ScheduleBlock.duration" name="duration">
    Duration of this schedule block.
  </Attribute>

  ### instances\_counter

  <Attribute id="qiskit.pulse.ScheduleBlock.instances_counter" name="instances_counter" attributeValue="count(0)" />

  ### instructions

  <Attribute id="qiskit.pulse.ScheduleBlock.instructions" name="instructions">
    Get the time-ordered instructions from self.
  </Attribute>

  ### metadata

  <Attribute id="qiskit.pulse.ScheduleBlock.metadata" name="metadata">
  ...
  <Attribute id="qiskit.pulse.ScheduleBlock.name" name="name">
    Return name of this schedule
  </Attribute>

  ### parameters

  <Attribute id="qiskit.pulse.ScheduleBlock.parameters" name="parameters">
    Return unassigned parameters with raw names.
  </Attribute>

  ### prefix

  <Attribute id="qiskit.pulse.ScheduleBlock.prefix" name="prefix" attributeValue="'block'" />

  ### references

  <Attribute id="qiskit.pulse.ScheduleBlock.references" name="references">
  ...
  <Function id="qiskit.pulse.ScheduleBlock.append" name="append" github="https://github.com/Qiskit/qiskit/tree/stable/1.0/qiskit/pulse/schedule.py#L1195-L1254" signature="append(block, name=None, inplace=True)">
  ...
  <Function id="qiskit.pulse.ScheduleBlock.assign_parameters" name="assign_parameters" github="https://github.com/Qiskit/qiskit/tree/stable/1.0/qiskit/pulse/schedule.py#L1409-L1442" signature="assign_parameters(value_dict, inplace=True)">
  ...
  <Function id="qiskit.pulse.ScheduleBlock.assign_references" name="assign_references" github="https://github.com/Qiskit/qiskit/tree/stable/1.0/qiskit/pulse/schedule.py#L1444-L1522" signature="assign_references(subroutine_dict, inplace=True)">
  ...
  <Function id="qiskit.pulse.ScheduleBlock.ch_duration" name="ch_duration" github="https://github.com/Qiskit/qiskit/tree/stable/1.0/qiskit/pulse/schedule.py#L1186-L1193" signature="ch_duration(*channels)">
  ...
  <Function id="qiskit.pulse.ScheduleBlock.exclude" name="exclude" github="https://github.com/Qiskit/qiskit/tree/stable/1.0/qiskit/pulse/schedule.py#L1295-L1331" signature="exclude(*filter_funcs, channels=None, instruction_types=None, check_subroutine=True)">
  ...
  <Function id="qiskit.pulse.ScheduleBlock.filter" name="filter" github="https://github.com/Qiskit/qiskit/tree/stable/1.0/qiskit/pulse/schedule.py#L1256-L1293" signature="filter(*filter_funcs, channels=None, instruction_types=None, check_subroutine=True)">
  ...
  <Function id="qiskit.pulse.ScheduleBlock.get_parameters" name="get_parameters" github="https://github.com/Qiskit/qiskit/tree/stable/1.0/qiskit/pulse/schedule.py#L1524-L1556" signature="get_parameters(parameter_name)">
  ...
  <Function id="qiskit.pulse.ScheduleBlock.initialize_from" name="initialize_from" github="https://github.com/Qiskit/qiskit/tree/stable/1.0/qiskit/pulse/schedule.py#L1036-L1068" signature="classmethod initialize_from(other_program, name=None)">
  ...
  <Function id="qiskit.pulse.ScheduleBlock.is_parameterized" name="is_parameterized" github="https://github.com/Qiskit/qiskit/tree/stable/1.0/qiskit/pulse/schedule.py#L1401-L1403" signature="is_parameterized()">
  ...
  <Function id="qiskit.pulse.ScheduleBlock.is_referenced" name="is_referenced" github="https://github.com/Qiskit/qiskit/tree/stable/1.0/qiskit/pulse/schedule.py#L1405-L1407" signature="is_referenced()">
  ...
  <Function id="qiskit.pulse.ScheduleBlock.is_schedulable" name="is_schedulable" github="https://github.com/Qiskit/qiskit/tree/stable/1.0/qiskit/pulse/schedule.py#L1100-L1118" signature="is_schedulable()">
  ...
  <Function id="qiskit.pulse.ScheduleBlock.replace" name="replace" github="https://github.com/Qiskit/qiskit/tree/stable/1.0/qiskit/pulse/schedule.py#L1333-L1399" signature="replace(old, new, inplace=True)">
