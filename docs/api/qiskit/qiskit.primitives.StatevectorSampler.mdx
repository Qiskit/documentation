...
<Class id="qiskit.primitives.StatevectorSampler" github="https://github.com/Qiskit/qiskit/tree/stable/1.0/qiskit/primitives/statevector_sampler.py#L52-L205" signature="qiskit.primitives.StatevectorSampler(*, default_shots=1024, seed=None)">
