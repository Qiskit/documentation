...
<Class id="qiskit.primitives.StatevectorSampler" github="https://github.com/qiskit/qiskit/tree/stable/1.0/qiskit/primitives/statevector_sampler.py" signature="qiskit.primitives.StatevectorSampler(*, default_shots=1024, seed=None)">
