...
<Class id="qiskit.providers.models.BackendProperties" github="https://github.com/qiskit/qiskit/tree/stable/1.0/qiskit/providers/models/backendproperties.py" signature="qiskit.providers.models.BackendProperties(backend_name, backend_version, last_update_date, qubits, gates, general, **kwargs)">
