...
<Class id="qiskit.circuit.library.LinearFunction" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.0/qiskit/circuit/library/generalized_gates/linear_function.py#L26-L311" signature="qiskit.circuit.library.LinearFunction(linear, validate_input=False)">
...
$$
  ...
  **Raises**
  ...
  <Attribute id="qiskit.circuit.library.LinearFunction.base_class" name="base_class">
  ...
  <Attribute id="qiskit.circuit.library.LinearFunction.condition" name="condition">
    The classical condition on the instruction.
  </Attribute>

  ### condition\_bits

  <Attribute id="qiskit.circuit.library.LinearFunction.condition_bits" name="condition_bits">
    Get Clbits in condition.
  </Attribute>

  ### decompositions

  <Attribute id="qiskit.circuit.library.LinearFunction.decompositions" name="decompositions">
    Get the decompositions of the instruction from the SessionEquivalenceLibrary.
  </Attribute>

  ### definition

  <Attribute id="qiskit.circuit.library.LinearFunction.definition" name="definition">
    Return definition in terms of other basic gates.
  </Attribute>

  ### duration

  <Attribute id="qiskit.circuit.library.LinearFunction.duration" name="duration">
    Get the duration.
  </Attribute>

  ### label

  <Attribute id="qiskit.circuit.library.LinearFunction.label" name="label">
    Return instruction label
  </Attribute>

  ### linear

  <Attribute id="qiskit.circuit.library.LinearFunction.linear" name="linear">
    Returns the n x n matrix representing this linear function.
  </Attribute>

  ### mutable

  <Attribute id="qiskit.circuit.library.LinearFunction.mutable" name="mutable">
  ...
  <Attribute id="qiskit.circuit.library.LinearFunction.name" name="name">
    Return the name.
  </Attribute>

  ### num\_clbits

  <Attribute id="qiskit.circuit.library.LinearFunction.num_clbits" name="num_clbits">
    Return the number of clbits.
  </Attribute>

  ### num\_qubits

  <Attribute id="qiskit.circuit.library.LinearFunction.num_qubits" name="num_qubits">
    Return the number of qubits.
  </Attribute>

  ### original\_circuit

  <Attribute id="qiskit.circuit.library.LinearFunction.original_circuit" name="original_circuit">
  ...
  <Attribute id="qiskit.circuit.library.LinearFunction.params" name="params">
    return instruction params.
  </Attribute>

  ### unit

  <Attribute id="qiskit.circuit.library.LinearFunction.unit" name="unit">
  ...
  <Function id="qiskit.circuit.library.LinearFunction.extend_with_identity" name="extend_with_identity" github="https://github.com/Qiskit/qiskit/tree/stable/1.0/qiskit/circuit/library/generalized_gates/linear_function.py#L268-L286" signature="extend_with_identity(num_qubits, positions)">
  ...
  <Function id="qiskit.circuit.library.LinearFunction.function_str" name="function_str" github="https://github.com/Qiskit/qiskit/tree/stable/1.0/qiskit/circuit/library/generalized_gates/linear_function.py#L294-L311" signature="function_str()">
    Return string representation of the linear function viewed as a linear transformation.
  </Function>

  ### is\_permutation

  <Function id="qiskit.circuit.library.LinearFunction.is_permutation" name="is_permutation" github="https://github.com/Qiskit/qiskit/tree/stable/1.0/qiskit/circuit/library/generalized_gates/linear_function.py#L247-L254" signature="is_permutation()">
  ...
  <Function id="qiskit.circuit.library.LinearFunction.mat_str" name="mat_str" github="https://github.com/Qiskit/qiskit/tree/stable/1.0/qiskit/circuit/library/generalized_gates/linear_function.py#L288-L292" signature="mat_str()">
    Return string representation of the linear function viewed as a matrix with 0/1 entries.
  </Function>

  ### permutation\_pattern

  <Function id="qiskit.circuit.library.LinearFunction.permutation_pattern" name="permutation_pattern" github="https://github.com/Qiskit/qiskit/tree/stable/1.0/qiskit/circuit/library/generalized_gates/linear_function.py#L256-L266" signature="permutation_pattern()">
  ...
  <Function id="qiskit.circuit.library.LinearFunction.synthesize" name="synthesize" github="https://github.com/Qiskit/qiskit/tree/stable/1.0/qiskit/circuit/library/generalized_gates/linear_function.py#L225-L233" signature="synthesize()">
  ...
  <Function id="qiskit.circuit.library.LinearFunction.validate_parameter" name="validate_parameter" github="https://github.com/Qiskit/qiskit/tree/stable/1.0/qiskit/circuit/library/generalized_gates/linear_function.py#L217-L219" signature="validate_parameter(parameter)">
