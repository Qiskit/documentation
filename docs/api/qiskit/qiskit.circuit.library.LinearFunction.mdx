...
<Class id="qiskit.circuit.library.LinearFunction" github="https://github.com/Qiskit/qiskit/tree/stable/1.0/qiskit/circuit/library/generalized_gates/linear_function.py#L26-L311" signature="qiskit.circuit.library.LinearFunction(linear, validate_input=False)">
