...
<Class id="qiskit.passmanager.BasePassManager" github="https://github.com/qiskit/qiskit/tree/stable/1.0/qiskit/passmanager/passmanager.py" signature="qiskit.passmanager.BasePassManager(tasks=(), max_iteration=1000)">
