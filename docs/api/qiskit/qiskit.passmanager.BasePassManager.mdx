...
<Class id="qiskit.passmanager.BasePassManager" github="https://github.com/Qiskit/qiskit/tree/stable/1.0/qiskit/passmanager/passmanager.py#L33-L267" signature="qiskit.passmanager.BasePassManager(tasks=(), max_iteration=1000)">
