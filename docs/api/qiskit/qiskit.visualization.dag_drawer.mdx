...
<Function id="qiskit.visualization.dag_drawer" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/visualization/dag_visualization.py#L76-L393" signature="qiskit.visualization.dag_drawer(dag, scale=0.7, filename=None, style='color')">
  ...
  *   [**VisualizationError**](/docs/api/qiskit/visualization#qiskit.visualization.VisualizationError "qiskit.visualization.VisualizationError") – when style is not recognized.
  *   [**InvalidFileError**](/docs/api/qiskit/exceptions#qiskit.exceptions.InvalidFileError "qiskit.exceptions.InvalidFileError") – when filename provided is not valid
