...
<Class id="qiskit.providers.Job" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/2.1/qiskit/providers/job.py#L30-L39" signature="qiskit.providers.Job" modifiers="class">
