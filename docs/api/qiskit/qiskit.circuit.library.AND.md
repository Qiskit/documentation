...
![../\_images/qiskit-circuit-library-AND-1.png](/images/api/qiskit/qiskit-circuit-library-AND-1.png)
...
![../\_images/qiskit-circuit-library-AND-2.png](/images/api/qiskit/qiskit-circuit-library-AND-2.png)
...
*   **flags** ([*list*](https://docs.python.org/3/library/stdtypes.html#list "(in Python v3.11)")*\[*[*int*](https://docs.python.org/3/library/functions.html#int "(in Python v3.11)")*] | None*) – A list of +1/0/-1 marking negations or omissions of qubits.
