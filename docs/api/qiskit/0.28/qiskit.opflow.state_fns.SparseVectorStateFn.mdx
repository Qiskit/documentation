...
<Class id="qiskit.opflow.state_fns.SparseVectorStateFn" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/opflow/state_fns/sparse_vector_state_fn.py" signature="SparseVectorStateFn(primitive, coeff=1.0, is_measurement=False)">
  ...
  *   **ValueError** – If the number of elements in the primitive is not a power of 2.
  ...
  <Function id="qiskit.opflow.state_fns.SparseVectorStateFn.coeff" signature="property coeff">
  ...
  <Function id="qiskit.opflow.state_fns.SparseVectorStateFn.instance_id" signature="property instance_id">
  ...
  <Function id="qiskit.opflow.state_fns.SparseVectorStateFn.is_measurement" signature="property is_measurement">
  ...
  <Function id="qiskit.opflow.state_fns.SparseVectorStateFn.num_qubits" signature="property num_qubits">
  ...
  <Function id="qiskit.opflow.state_fns.SparseVectorStateFn.parameters" signature="property parameters">
  ...
  <Function id="qiskit.opflow.state_fns.SparseVectorStateFn.primitive" signature="property primitive">
  ...
  <Function id="qiskit.opflow.state_fns.SparseVectorStateFn.settings" signature="property settings">
    Return settings.
