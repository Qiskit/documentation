...
<Class id="qiskit.opflow.state_fns.SparseVectorStateFn" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/opflow/state_fns/sparse_vector_state_fn.py" signature="SparseVectorStateFn(primitive, coeff=1.0, is_measurement=False)">
  ...
  *   **ValueError** – If the number of elements in the primitive is not a power of 2.
  ...
  <Function id="qiskit.opflow.state_fns.SparseVectorStateFn.__init__" name="__init__" signature="__init__(primitive, coeff=1.0, is_measurement=False)">
    **Parameters**
  ...
  <Function id="qiskit.opflow.state_fns.SparseVectorStateFn.add" name="add" signature="add(other)">
  ...
  <Function id="qiskit.opflow.state_fns.SparseVectorStateFn.adjoint" name="adjoint" signature="adjoint()">
  ...
  <Function id="qiskit.opflow.state_fns.SparseVectorStateFn.assign_parameters" name="assign_parameters" signature="assign_parameters(param_dict)">
  ...
  <Function id="qiskit.opflow.state_fns.SparseVectorStateFn.bind_parameters" name="bind_parameters" signature="bind_parameters(param_dict)">
  ...
  <Function id="qiskit.opflow.state_fns.SparseVectorStateFn.coeff" name="coeff" signature="property coeff">
  ...
  <Function id="qiskit.opflow.state_fns.SparseVectorStateFn.compose" name="compose" signature="compose(other, permutation=None, front=False)">
  ...
  <Function id="qiskit.opflow.state_fns.SparseVectorStateFn.copy" name="copy" signature="copy()">
  ...
  <Function id="qiskit.opflow.state_fns.SparseVectorStateFn.equals" name="equals" signature="equals(other)">
  ...
  <Function id="qiskit.opflow.state_fns.SparseVectorStateFn.eval" name="eval" signature="eval(front=None)">
  ...
  <Function id="qiskit.opflow.state_fns.SparseVectorStateFn.instance_id" name="instance_id" signature="property instance_id">
  ...
  <Function id="qiskit.opflow.state_fns.SparseVectorStateFn.is_measurement" name="is_measurement" signature="property is_measurement">
  ...
  <Function id="qiskit.opflow.state_fns.SparseVectorStateFn.mul" name="mul" signature="mul(scalar)">
  ...
  <Function id="qiskit.opflow.state_fns.SparseVectorStateFn.neg" name="neg" signature="neg()">
  ...
  <Function id="qiskit.opflow.state_fns.SparseVectorStateFn.num_qubits" name="num_qubits" signature="property num_qubits">
  ...
  <Function id="qiskit.opflow.state_fns.SparseVectorStateFn.parameters" name="parameters" signature="property parameters">
    Return a set of Parameter objects contained in the Operator.
  </Function>

  ### permute

  <Function id="qiskit.opflow.state_fns.SparseVectorStateFn.permute" name="permute" signature="permute(permutation)">
  ...
  <Function id="qiskit.opflow.state_fns.SparseVectorStateFn.power" name="power" signature="power(exponent)">
  ...
  <Function id="qiskit.opflow.state_fns.SparseVectorStateFn.primitive" name="primitive" signature="property primitive">
    The primitive which defines the behavior of the underlying State function.
  </Function>

  ### primitive\_strings

  <Function id="qiskit.opflow.state_fns.SparseVectorStateFn.primitive_strings" name="primitive_strings" signature="primitive_strings()">
  ...
  <Function id="qiskit.opflow.state_fns.SparseVectorStateFn.reduce" name="reduce" signature="reduce()">
  ...
  <Function id="qiskit.opflow.state_fns.SparseVectorStateFn.sample" name="sample" signature="sample(shots=1024, massive=False, reverse_endianness=False)">
  ...
  <Function id="qiskit.opflow.state_fns.SparseVectorStateFn.settings" name="settings" signature="property settings">
    Return settings.
  ...
  <Function id="qiskit.opflow.state_fns.SparseVectorStateFn.tensor" name="tensor" signature="tensor(other)">
  ...
  <Function id="qiskit.opflow.state_fns.SparseVectorStateFn.tensorpower" name="tensorpower" signature="tensorpower(other)">
  ...
  <Function id="qiskit.opflow.state_fns.SparseVectorStateFn.to_circuit_op" name="to_circuit_op" signature="to_circuit_op()">
  ...
  <Function id="qiskit.opflow.state_fns.SparseVectorStateFn.to_density_matrix" name="to_density_matrix" signature="to_density_matrix(massive=False)">
  ...
  <Function id="qiskit.opflow.state_fns.SparseVectorStateFn.to_dict_fn" name="to_dict_fn" signature="to_dict_fn()">
  ...
  <Function id="qiskit.opflow.state_fns.SparseVectorStateFn.to_matrix" name="to_matrix" signature="to_matrix(massive=False)">
  ...
  <Function id="qiskit.opflow.state_fns.SparseVectorStateFn.to_matrix_op" name="to_matrix_op" signature="to_matrix_op(massive=False)">
  ...
  <Function id="qiskit.opflow.state_fns.SparseVectorStateFn.to_spmatrix" name="to_spmatrix" signature="to_spmatrix()">
  ...
  <Function id="qiskit.opflow.state_fns.SparseVectorStateFn.traverse" name="traverse" signature="traverse(convert_fn, coeff=None)">
