...
![../\_images/qiskit.circuit.library.GMS\_0\_1.png](/images/api/qiskit/0.28/qiskit.circuit.library.GMS_0_1.png)
...
<span id="qiskit.circuit.library.GMS.__init__" />
...
|                                                                                                                                                                                 |                                                                                                                                     |
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------- |
| [`__init__`](#qiskit.circuit.library.GMS.__init__ "qiskit.circuit.library.GMS.__init__")(num\_qubits, theta)                                                                    | Create a new Global Mølmer–Sørensen (GMS) gate.                                                                                     |
| [`add_bits`](#qiskit.circuit.library.GMS.add_bits "qiskit.circuit.library.GMS.add_bits")(bits)                                                                                  | Add Bits to the circuit.                                                                                                            |
| [`add_calibration`](#qiskit.circuit.library.GMS.add_calibration "qiskit.circuit.library.GMS.add_calibration")(gate, qubits, schedule\[, params])                                | Register a low-level, custom pulse definition for the given gate.                                                                   |
| [`add_register`](#qiskit.circuit.library.GMS.add_register "qiskit.circuit.library.GMS.add_register")(\*regs)                                                                    | Add registers.                                                                                                                      |
| [`append`](#qiskit.circuit.library.GMS.append "qiskit.circuit.library.GMS.append")(instruction\[, qargs, cargs])                                                                | Append one or more instructions to the end of the circuit, modifying the circuit in place.                                          |
| [`assign_parameters`](#qiskit.circuit.library.GMS.assign_parameters "qiskit.circuit.library.GMS.assign_parameters")(parameters\[, inplace, …])                                  | Assign parameters to new parameters or values.                                                                                      |
| [`barrier`](#qiskit.circuit.library.GMS.barrier "qiskit.circuit.library.GMS.barrier")(\*qargs)                                                                                  | Apply `Barrier`.                                                                                                                    |
| [`bind_parameters`](#qiskit.circuit.library.GMS.bind_parameters "qiskit.circuit.library.GMS.bind_parameters")(values\[, value\_dict])                                           | Assign numeric parameters to values yielding a new circuit.                                                                         |
| [`cast`](#qiskit.circuit.library.GMS.cast "qiskit.circuit.library.GMS.cast")(value, \_type)                                                                                     | Best effort to cast value to type.                                                                                                  |
| [`cbit_argument_conversion`](#qiskit.circuit.library.GMS.cbit_argument_conversion "qiskit.circuit.library.GMS.cbit_argument_conversion")(clbit\_representation)                 | Converts several classical bit representations (such as indexes, range, etc.) into a list of classical bits.                        |
| [`ccx`](#qiskit.circuit.library.GMS.ccx "qiskit.circuit.library.GMS.ccx")(control\_qubit1, control\_qubit2, target\_qubit)                                                      | Apply [`CCXGate`](qiskit.circuit.library.CCXGate "qiskit.circuit.library.CCXGate").                                                 |
| [`ch`](#qiskit.circuit.library.GMS.ch "qiskit.circuit.library.GMS.ch")(control\_qubit, target\_qubit\[, label, …])                                                              | Apply [`CHGate`](qiskit.circuit.library.CHGate "qiskit.circuit.library.CHGate").                                                    |
| [`cls_instances`](#qiskit.circuit.library.GMS.cls_instances "qiskit.circuit.library.GMS.cls_instances")()                                                                       | Return the current number of instances of this class, useful for auto naming.                                                       |
| [`cls_prefix`](#qiskit.circuit.library.GMS.cls_prefix "qiskit.circuit.library.GMS.cls_prefix")()                                                                                | Return the prefix to use for auto naming.                                                                                           |
| [`cnot`](#qiskit.circuit.library.GMS.cnot "qiskit.circuit.library.GMS.cnot")(control\_qubit, target\_qubit\[, label, …])                                                        | Apply [`CXGate`](qiskit.circuit.library.CXGate "qiskit.circuit.library.CXGate").                                                    |
| [`combine`](#qiskit.circuit.library.GMS.combine "qiskit.circuit.library.GMS.combine")(rhs)                                                                                      | DEPRECATED - Returns rhs appended to self if self contains compatible registers.                                                    |
| [`compose`](#qiskit.circuit.library.GMS.compose "qiskit.circuit.library.GMS.compose")(other\[, qubits, clbits, front, …])                                                       | Compose circuit with `other` circuit or instruction, optionally permuting wires.                                                    |
| [`control`](#qiskit.circuit.library.GMS.control "qiskit.circuit.library.GMS.control")(\[num\_ctrl\_qubits, label, ctrl\_state])                                                 | Control this circuit on `num_ctrl_qubits` qubits.                                                                                   |
| [`copy`](#qiskit.circuit.library.GMS.copy "qiskit.circuit.library.GMS.copy")(\[name])                                                                                           | Copy the circuit.                                                                                                                   |
| [`count_ops`](#qiskit.circuit.library.GMS.count_ops "qiskit.circuit.library.GMS.count_ops")()                                                                                   | Count each operation kind in the circuit.                                                                                           |
| [`cp`](#qiskit.circuit.library.GMS.cp "qiskit.circuit.library.GMS.cp")(theta, control\_qubit, target\_qubit\[, …])                                                              | Apply [`CPhaseGate`](qiskit.circuit.library.CPhaseGate "qiskit.circuit.library.CPhaseGate").                                        |
| [`crx`](#qiskit.circuit.library.GMS.crx "qiskit.circuit.library.GMS.crx")(theta, control\_qubit, target\_qubit\[, …])                                                           | Apply [`CRXGate`](qiskit.circuit.library.CRXGate "qiskit.circuit.library.CRXGate").                                                 |
| [`cry`](#qiskit.circuit.library.GMS.cry "qiskit.circuit.library.GMS.cry")(theta, control\_qubit, target\_qubit\[, …])                                                           | Apply [`CRYGate`](qiskit.circuit.library.CRYGate "qiskit.circuit.library.CRYGate").                                                 |
| [`crz`](#qiskit.circuit.library.GMS.crz "qiskit.circuit.library.GMS.crz")(theta, control\_qubit, target\_qubit\[, …])                                                           | Apply [`CRZGate`](qiskit.circuit.library.CRZGate "qiskit.circuit.library.CRZGate").                                                 |
| [`cswap`](#qiskit.circuit.library.GMS.cswap "qiskit.circuit.library.GMS.cswap")(control\_qubit, target\_qubit1, …\[, …])                                                        | Apply [`CSwapGate`](qiskit.circuit.library.CSwapGate "qiskit.circuit.library.CSwapGate").                                           |
| [`csx`](#qiskit.circuit.library.GMS.csx "qiskit.circuit.library.GMS.csx")(control\_qubit, target\_qubit\[, label, …])                                                           | Apply [`CSXGate`](qiskit.circuit.library.CSXGate "qiskit.circuit.library.CSXGate").                                                 |
| [`cu`](#qiskit.circuit.library.GMS.cu "qiskit.circuit.library.GMS.cu")(theta, phi, lam, gamma, control\_qubit, …)                                                               | Apply [`CUGate`](qiskit.circuit.library.CUGate "qiskit.circuit.library.CUGate").                                                    |
| [`cu1`](#qiskit.circuit.library.GMS.cu1 "qiskit.circuit.library.GMS.cu1")(theta, control\_qubit, target\_qubit\[, …])                                                           | Apply [`CU1Gate`](qiskit.circuit.library.CU1Gate "qiskit.circuit.library.CU1Gate").                                                 |
| [`cu3`](#qiskit.circuit.library.GMS.cu3 "qiskit.circuit.library.GMS.cu3")(theta, phi, lam, control\_qubit, target\_qubit)                                                       | Apply [`CU3Gate`](qiskit.circuit.library.CU3Gate "qiskit.circuit.library.CU3Gate").                                                 |
| [`cx`](#qiskit.circuit.library.GMS.cx "qiskit.circuit.library.GMS.cx")(control\_qubit, target\_qubit\[, label, …])                                                              | Apply [`CXGate`](qiskit.circuit.library.CXGate "qiskit.circuit.library.CXGate").                                                    |
| [`cy`](#qiskit.circuit.library.GMS.cy "qiskit.circuit.library.GMS.cy")(control\_qubit, target\_qubit\[, label, …])                                                              | Apply [`CYGate`](qiskit.circuit.library.CYGate "qiskit.circuit.library.CYGate").                                                    |
| [`cz`](#qiskit.circuit.library.GMS.cz "qiskit.circuit.library.GMS.cz")(control\_qubit, target\_qubit\[, label, …])                                                              | Apply [`CZGate`](qiskit.circuit.library.CZGate "qiskit.circuit.library.CZGate").                                                    |
| [`dcx`](#qiskit.circuit.library.GMS.dcx "qiskit.circuit.library.GMS.dcx")(qubit1, qubit2)                                                                                       | Apply [`DCXGate`](qiskit.circuit.library.DCXGate "qiskit.circuit.library.DCXGate").                                                 |
| [`decompose`](#qiskit.circuit.library.GMS.decompose "qiskit.circuit.library.GMS.decompose")()                                                                                   | Call a decomposition pass on this circuit, to decompose one level (shallow decompose).                                              |
| [`delay`](#qiskit.circuit.library.GMS.delay "qiskit.circuit.library.GMS.delay")(duration\[, qarg, unit])                                                                        | Apply [`Delay`](qiskit.circuit.Delay "qiskit.circuit.Delay").                                                                       |
| [`depth`](#qiskit.circuit.library.GMS.depth "qiskit.circuit.library.GMS.depth")()                                                                                               | Return circuit depth (i.e., length of critical path).                                                                               |
| [`diagonal`](#qiskit.circuit.library.GMS.diagonal "qiskit.circuit.library.GMS.diagonal")(diag, qubit)                                                                           | Attach a diagonal gate to a circuit.                                                                                                |
| [`draw`](#qiskit.circuit.library.GMS.draw "qiskit.circuit.library.GMS.draw")(\[output, scale, filename, style, …])                                                              | Draw the quantum circuit.                                                                                                           |
| [`ecr`](#qiskit.circuit.library.GMS.ecr "qiskit.circuit.library.GMS.ecr")(qubit1, qubit2)                                                                                       | Apply [`ECRGate`](qiskit.circuit.library.ECRGate "qiskit.circuit.library.ECRGate").                                                 |
| [`extend`](#qiskit.circuit.library.GMS.extend "qiskit.circuit.library.GMS.extend")(rhs)                                                                                         | DEPRECATED - Append QuantumCircuit to the RHS if it contains compatible registers.                                                  |
| [`fredkin`](#qiskit.circuit.library.GMS.fredkin "qiskit.circuit.library.GMS.fredkin")(control\_qubit, target\_qubit1, …)                                                        | Apply [`CSwapGate`](qiskit.circuit.library.CSwapGate "qiskit.circuit.library.CSwapGate").                                           |
| [`from_qasm_file`](#qiskit.circuit.library.GMS.from_qasm_file "qiskit.circuit.library.GMS.from_qasm_file")(path)                                                                | Take in a QASM file and generate a QuantumCircuit object.                                                                           |
| [`from_qasm_str`](#qiskit.circuit.library.GMS.from_qasm_str "qiskit.circuit.library.GMS.from_qasm_str")(qasm\_str)                                                              | Take in a QASM string and generate a QuantumCircuit object.                                                                         |
| [`get_instructions`](#qiskit.circuit.library.GMS.get_instructions "qiskit.circuit.library.GMS.get_instructions")(name)                                                          | Get instructions matching name.                                                                                                     |
| [`h`](#qiskit.circuit.library.GMS.h "qiskit.circuit.library.GMS.h")(qubit)                                                                                                      | Apply [`HGate`](qiskit.circuit.library.HGate "qiskit.circuit.library.HGate").                                                       |
| [`hamiltonian`](#qiskit.circuit.library.GMS.hamiltonian "qiskit.circuit.library.GMS.hamiltonian")(operator, time, qubits\[, label])                                             | Apply hamiltonian evolution to qubits.                                                                                              |
| [`has_register`](#qiskit.circuit.library.GMS.has_register "qiskit.circuit.library.GMS.has_register")(register)                                                                  | Test if this circuit has the register r.                                                                                            |
| [`i`](#qiskit.circuit.library.GMS.i "qiskit.circuit.library.GMS.i")(qubit)                                                                                                      | Apply [`IGate`](qiskit.circuit.library.IGate "qiskit.circuit.library.IGate").                                                       |
| [`id`](#qiskit.circuit.library.GMS.id "qiskit.circuit.library.GMS.id")(qubit)                                                                                                   | Apply [`IGate`](qiskit.circuit.library.IGate "qiskit.circuit.library.IGate").                                                       |
| [`initialize`](#qiskit.circuit.library.GMS.initialize "qiskit.circuit.library.GMS.initialize")(params\[, qubits])                                                               | Initialize qubits in a specific state.                                                                                              |
| [`inverse`](#qiskit.circuit.library.GMS.inverse "qiskit.circuit.library.GMS.inverse")()                                                                                         | Invert (take adjoint of) this circuit.                                                                                              |
| [`iso`](#qiskit.circuit.library.GMS.iso "qiskit.circuit.library.GMS.iso")(isometry, q\_input, q\_ancillas\_for\_output)                                                         | Attach an arbitrary isometry from m to n qubits to a circuit.                                                                       |
| [`isometry`](#qiskit.circuit.library.GMS.isometry "qiskit.circuit.library.GMS.isometry")(isometry, q\_input, …\[, …])                                                           | Attach an arbitrary isometry from m to n qubits to a circuit.                                                                       |
| [`iswap`](#qiskit.circuit.library.GMS.iswap "qiskit.circuit.library.GMS.iswap")(qubit1, qubit2)                                                                                 | Apply [`iSwapGate`](qiskit.circuit.library.iSwapGate "qiskit.circuit.library.iSwapGate").                                           |
| [`mcp`](#qiskit.circuit.library.GMS.mcp "qiskit.circuit.library.GMS.mcp")(lam, control\_qubits, target\_qubit)                                                                  | Apply [`MCPhaseGate`](qiskit.circuit.library.MCPhaseGate "qiskit.circuit.library.MCPhaseGate").                                     |
| [`mcrx`](#qiskit.circuit.library.GMS.mcrx "qiskit.circuit.library.GMS.mcrx")(theta, q\_controls, q\_target\[, …])                                                               | Apply Multiple-Controlled X rotation gate                                                                                           |
| [`mcry`](#qiskit.circuit.library.GMS.mcry "qiskit.circuit.library.GMS.mcry")(theta, q\_controls, q\_target\[, …])                                                               | Apply Multiple-Controlled Y rotation gate                                                                                           |
| [`mcrz`](#qiskit.circuit.library.GMS.mcrz "qiskit.circuit.library.GMS.mcrz")(lam, q\_controls, q\_target\[, …])                                                                 | Apply Multiple-Controlled Z rotation gate                                                                                           |
| [`mct`](#qiskit.circuit.library.GMS.mct "qiskit.circuit.library.GMS.mct")(control\_qubits, target\_qubit\[, …])                                                                 | Apply [`MCXGate`](qiskit.circuit.library.MCXGate "qiskit.circuit.library.MCXGate").                                                 |
| [`mcu1`](#qiskit.circuit.library.GMS.mcu1 "qiskit.circuit.library.GMS.mcu1")(lam, control\_qubits, target\_qubit)                                                               | Apply `MCU1Gate`.                                                                                                                   |
| [`mcx`](#qiskit.circuit.library.GMS.mcx "qiskit.circuit.library.GMS.mcx")(control\_qubits, target\_qubit\[, …])                                                                 | Apply [`MCXGate`](qiskit.circuit.library.MCXGate "qiskit.circuit.library.MCXGate").                                                 |
| [`measure`](#qiskit.circuit.library.GMS.measure "qiskit.circuit.library.GMS.measure")(qubit, cbit)                                                                              | Measure quantum bit into classical bit (tuples).                                                                                    |
| [`measure_active`](#qiskit.circuit.library.GMS.measure_active "qiskit.circuit.library.GMS.measure_active")(\[inplace])                                                          | Adds measurement to all non-idle qubits.                                                                                            |
| [`measure_all`](#qiskit.circuit.library.GMS.measure_all "qiskit.circuit.library.GMS.measure_all")(\[inplace])                                                                   | Adds measurement to all qubits.                                                                                                     |
| [`ms`](#qiskit.circuit.library.GMS.ms "qiskit.circuit.library.GMS.ms")(theta, qubits)                                                                                           | Apply [`MSGate`](qiskit.circuit.library.MSGate "qiskit.circuit.library.MSGate").                                                    |
| [`num_connected_components`](#qiskit.circuit.library.GMS.num_connected_components "qiskit.circuit.library.GMS.num_connected_components")(\[unitary\_only])                      | How many non-entangled subcircuits can the circuit be factored to.                                                                  |
| [`num_nonlocal_gates`](#qiskit.circuit.library.GMS.num_nonlocal_gates "qiskit.circuit.library.GMS.num_nonlocal_gates")()                                                        | Return number of non-local gates (i.e.                                                                                              |
| [`num_tensor_factors`](#qiskit.circuit.library.GMS.num_tensor_factors "qiskit.circuit.library.GMS.num_tensor_factors")()                                                        | Computes the number of tensor factors in the unitary (quantum) part of the circuit only.                                            |
| [`num_unitary_factors`](#qiskit.circuit.library.GMS.num_unitary_factors "qiskit.circuit.library.GMS.num_unitary_factors")()                                                     | Computes the number of tensor factors in the unitary (quantum) part of the circuit only.                                            |
| [`p`](#qiskit.circuit.library.GMS.p "qiskit.circuit.library.GMS.p")(theta, qubit)                                                                                               | Apply [`PhaseGate`](qiskit.circuit.library.PhaseGate "qiskit.circuit.library.PhaseGate").                                           |
| [`pauli`](#qiskit.circuit.library.GMS.pauli "qiskit.circuit.library.GMS.pauli")(pauli\_string, qubits)                                                                          | Apply [`PauliGate`](qiskit.circuit.library.PauliGate "qiskit.circuit.library.PauliGate").                                           |
| [`power`](#qiskit.circuit.library.GMS.power "qiskit.circuit.library.GMS.power")(power\[, matrix\_power])                                                                        | Raise this circuit to the power of `power`.                                                                                         |
| [`qasm`](#qiskit.circuit.library.GMS.qasm "qiskit.circuit.library.GMS.qasm")(\[formatted, filename, encoding])                                                                  | Return OpenQASM string.                                                                                                             |
| [`qbit_argument_conversion`](#qiskit.circuit.library.GMS.qbit_argument_conversion "qiskit.circuit.library.GMS.qbit_argument_conversion")(qubit\_representation)                 | Converts several qubit representations (such as indexes, range, etc.) into a list of qubits.                                        |
| [`qubit_duration`](#qiskit.circuit.library.GMS.qubit_duration "qiskit.circuit.library.GMS.qubit_duration")(\*qubits)                                                            | Return the duration between the start and stop time of the first and last instructions, excluding delays, over the supplied qubits. |
| [`qubit_start_time`](#qiskit.circuit.library.GMS.qubit_start_time "qiskit.circuit.library.GMS.qubit_start_time")(\*qubits)                                                      | Return the start time of the first instruction, excluding delays, over the supplied qubits.                                         |
| [`qubit_stop_time`](#qiskit.circuit.library.GMS.qubit_stop_time "qiskit.circuit.library.GMS.qubit_stop_time")(\*qubits)                                                         | Return the stop time of the last instruction, excluding delays, over the supplied qubits.                                           |
| [`r`](#qiskit.circuit.library.GMS.r "qiskit.circuit.library.GMS.r")(theta, phi, qubit)                                                                                          | Apply [`RGate`](qiskit.circuit.library.RGate "qiskit.circuit.library.RGate").                                                       |
| [`rcccx`](#qiskit.circuit.library.GMS.rcccx "qiskit.circuit.library.GMS.rcccx")(control\_qubit1, control\_qubit2, …)                                                            | Apply [`RC3XGate`](qiskit.circuit.library.RC3XGate "qiskit.circuit.library.RC3XGate").                                              |
| [`rccx`](#qiskit.circuit.library.GMS.rccx "qiskit.circuit.library.GMS.rccx")(control\_qubit1, control\_qubit2, …)                                                               | Apply [`RCCXGate`](qiskit.circuit.library.RCCXGate "qiskit.circuit.library.RCCXGate").                                              |
| [`remove_final_measurements`](#qiskit.circuit.library.GMS.remove_final_measurements "qiskit.circuit.library.GMS.remove_final_measurements")(\[inplace])                         | Removes final measurement on all qubits if they are present.                                                                        |
| [`repeat`](#qiskit.circuit.library.GMS.repeat "qiskit.circuit.library.GMS.repeat")(reps)                                                                                        | Repeat this circuit `reps` times.                                                                                                   |
| [`reset`](#qiskit.circuit.library.GMS.reset "qiskit.circuit.library.GMS.reset")(qubit)                                                                                          | Reset q.                                                                                                                            |
| [`reverse_bits`](#qiskit.circuit.library.GMS.reverse_bits "qiskit.circuit.library.GMS.reverse_bits")()                                                                          | Return a circuit with the opposite order of wires.                                                                                  |
| [`reverse_ops`](#qiskit.circuit.library.GMS.reverse_ops "qiskit.circuit.library.GMS.reverse_ops")()                                                                             | Reverse the circuit by reversing the order of instructions.                                                                         |
| [`rv`](#qiskit.circuit.library.GMS.rv "qiskit.circuit.library.GMS.rv")(vx, vy, vz, qubit)                                                                                       | Apply [`RVGate`](qiskit.circuit.library.RVGate "qiskit.circuit.library.RVGate").                                                    |
| [`rx`](#qiskit.circuit.library.GMS.rx "qiskit.circuit.library.GMS.rx")(theta, qubit\[, label])                                                                                  | Apply [`RXGate`](qiskit.circuit.library.RXGate "qiskit.circuit.library.RXGate").                                                    |
| [`rxx`](#qiskit.circuit.library.GMS.rxx "qiskit.circuit.library.GMS.rxx")(theta, qubit1, qubit2)                                                                                | Apply [`RXXGate`](qiskit.circuit.library.RXXGate "qiskit.circuit.library.RXXGate").                                                 |
| [`ry`](#qiskit.circuit.library.GMS.ry "qiskit.circuit.library.GMS.ry")(theta, qubit\[, label])                                                                                  | Apply [`RYGate`](qiskit.circuit.library.RYGate "qiskit.circuit.library.RYGate").                                                    |
| [`ryy`](#qiskit.circuit.library.GMS.ryy "qiskit.circuit.library.GMS.ryy")(theta, qubit1, qubit2)                                                                                | Apply [`RYYGate`](qiskit.circuit.library.RYYGate "qiskit.circuit.library.RYYGate").                                                 |
| [`rz`](#qiskit.circuit.library.GMS.rz "qiskit.circuit.library.GMS.rz")(phi, qubit)                                                                                              | Apply [`RZGate`](qiskit.circuit.library.RZGate "qiskit.circuit.library.RZGate").                                                    |
| [`rzx`](#qiskit.circuit.library.GMS.rzx "qiskit.circuit.library.GMS.rzx")(theta, qubit1, qubit2)                                                                                | Apply [`RZXGate`](qiskit.circuit.library.RZXGate "qiskit.circuit.library.RZXGate").                                                 |
| [`rzz`](#qiskit.circuit.library.GMS.rzz "qiskit.circuit.library.GMS.rzz")(theta, qubit1, qubit2)                                                                                | Apply [`RZZGate`](qiskit.circuit.library.RZZGate "qiskit.circuit.library.RZZGate").                                                 |
| [`s`](#qiskit.circuit.library.GMS.s "qiskit.circuit.library.GMS.s")(qubit)                                                                                                      | Apply [`SGate`](qiskit.circuit.library.SGate "qiskit.circuit.library.SGate").                                                       |
| [`save_amplitudes`](#qiskit.circuit.library.GMS.save_amplitudes "qiskit.circuit.library.GMS.save_amplitudes")(params\[, label, pershot, …])                                     | Save complex statevector amplitudes.                                                                                                |
| [`save_amplitudes_squared`](#qiskit.circuit.library.GMS.save_amplitudes_squared "qiskit.circuit.library.GMS.save_amplitudes_squared")(params\[, label, …])                      | Save squared statevector amplitudes (probabilities).                                                                                |
| [`save_density_matrix`](#qiskit.circuit.library.GMS.save_density_matrix "qiskit.circuit.library.GMS.save_density_matrix")(\[qubits, label, …])                                  | Save the current simulator quantum state as a density matrix.                                                                       |
| [`save_expectation_value`](#qiskit.circuit.library.GMS.save_expectation_value "qiskit.circuit.library.GMS.save_expectation_value")(operator, qubits\[, …])                      | Save the expectation value of a Hermitian operator.                                                                                 |
| [`save_expectation_value_variance`](#qiskit.circuit.library.GMS.save_expectation_value_variance "qiskit.circuit.library.GMS.save_expectation_value_variance")(operator, qubits) | Save the expectation value of a Hermitian operator.                                                                                 |
| [`save_matrix_product_state`](#qiskit.circuit.library.GMS.save_matrix_product_state "qiskit.circuit.library.GMS.save_matrix_product_state")(\[label, pershot, …])               | Save the current simulator quantum state as a matrix product state.                                                                 |
| [`save_probabilities`](#qiskit.circuit.library.GMS.save_probabilities "qiskit.circuit.library.GMS.save_probabilities")(\[qubits, label, …])                                     | Save measurement outcome probabilities vector.                                                                                      |
| [`save_probabilities_dict`](#qiskit.circuit.library.GMS.save_probabilities_dict "qiskit.circuit.library.GMS.save_probabilities_dict")(\[qubits, label, …])                      | Save measurement outcome probabilities vector.                                                                                      |
| [`save_stabilizer`](#qiskit.circuit.library.GMS.save_stabilizer "qiskit.circuit.library.GMS.save_stabilizer")(\[label, pershot, conditional])                                   | Save the current stabilizer simulator quantum state as a Clifford.                                                                  |
| [`save_state`](#qiskit.circuit.library.GMS.save_state "qiskit.circuit.library.GMS.save_state")(\[label, pershot, conditional])                                                  | Save the current simulator quantum state.                                                                                           |
| [`save_statevector`](#qiskit.circuit.library.GMS.save_statevector "qiskit.circuit.library.GMS.save_statevector")(\[label, pershot, conditional])                                | Save the current simulator quantum state as a statevector.                                                                          |
| [`save_statevector_dict`](#qiskit.circuit.library.GMS.save_statevector_dict "qiskit.circuit.library.GMS.save_statevector_dict")(\[label, pershot, …])                           | Save the current simulator quantum state as a statevector as a dict.                                                                |
| [`save_superop`](#qiskit.circuit.library.GMS.save_superop "qiskit.circuit.library.GMS.save_superop")(\[label, pershot])                                                         | Save the current state of the superop simulator.                                                                                    |
| [`save_unitary`](#qiskit.circuit.library.GMS.save_unitary "qiskit.circuit.library.GMS.save_unitary")(\[label, pershot])                                                         | Save the current state of the unitary simulator.                                                                                    |
| [`sdg`](#qiskit.circuit.library.GMS.sdg "qiskit.circuit.library.GMS.sdg")(qubit)                                                                                                | Apply [`SdgGate`](qiskit.circuit.library.SdgGate "qiskit.circuit.library.SdgGate").                                                 |
| [`set_density_matrix`](#qiskit.circuit.library.GMS.set_density_matrix "qiskit.circuit.library.GMS.set_density_matrix")(state)                                                   | Set the density matrix state of the simulator.                                                                                      |
| [`set_matrix_product_state`](#qiskit.circuit.library.GMS.set_matrix_product_state "qiskit.circuit.library.GMS.set_matrix_product_state")(state)                                 | Set the matrix product state of the simulator.                                                                                      |
| [`set_stabilizer`](#qiskit.circuit.library.GMS.set_stabilizer "qiskit.circuit.library.GMS.set_stabilizer")(state)                                                               | Set the Clifford stabilizer state of the simulator.                                                                                 |
| [`set_statevector`](#qiskit.circuit.library.GMS.set_statevector "qiskit.circuit.library.GMS.set_statevector")(state)                                                            | Set the statevector state of the simulator.                                                                                         |
| [`set_superop`](#qiskit.circuit.library.GMS.set_superop "qiskit.circuit.library.GMS.set_superop")(state)                                                                        | Set the superop state of the simulator.                                                                                             |
| [`set_unitary`](#qiskit.circuit.library.GMS.set_unitary "qiskit.circuit.library.GMS.set_unitary")(state)                                                                        | Set the state state of the simulator.                                                                                               |
| [`size`](#qiskit.circuit.library.GMS.size "qiskit.circuit.library.GMS.size")()                                                                                                  | Returns total number of gate operations in circuit.                                                                                 |
| [`snapshot`](#qiskit.circuit.library.GMS.snapshot "qiskit.circuit.library.GMS.snapshot")(label\[, snapshot\_type, qubits, params])                                              | Take a statevector snapshot of the internal simulator representation.                                                               |
| [`snapshot_density_matrix`](#qiskit.circuit.library.GMS.snapshot_density_matrix "qiskit.circuit.library.GMS.snapshot_density_matrix")(label\[, qubits])                         | Take a density matrix snapshot of simulator state.                                                                                  |
| [`snapshot_expectation_value`](#qiskit.circuit.library.GMS.snapshot_expectation_value "qiskit.circuit.library.GMS.snapshot_expectation_value")(label, op, qubits)               | Take a snapshot of expectation value \<O> of an Operator.                                                                           |
| [`snapshot_probabilities`](#qiskit.circuit.library.GMS.snapshot_probabilities "qiskit.circuit.library.GMS.snapshot_probabilities")(label, qubits\[, variance])                  | Take a probability snapshot of the simulator state.                                                                                 |
| [`snapshot_stabilizer`](#qiskit.circuit.library.GMS.snapshot_stabilizer "qiskit.circuit.library.GMS.snapshot_stabilizer")(label)                                                | Take a stabilizer snapshot of the simulator state.                                                                                  |
| [`snapshot_statevector`](#qiskit.circuit.library.GMS.snapshot_statevector "qiskit.circuit.library.GMS.snapshot_statevector")(label)                                             | Take a statevector snapshot of the simulator state.                                                                                 |
| [`squ`](#qiskit.circuit.library.GMS.squ "qiskit.circuit.library.GMS.squ")(unitary\_matrix, qubit\[, mode, …])                                                                   | Decompose an arbitrary 2\*2 unitary into three rotation gates.                                                                      |
| [`swap`](#qiskit.circuit.library.GMS.swap "qiskit.circuit.library.GMS.swap")(qubit1, qubit2)                                                                                    | Apply [`SwapGate`](qiskit.circuit.library.SwapGate "qiskit.circuit.library.SwapGate").                                              |
| [`sx`](#qiskit.circuit.library.GMS.sx "qiskit.circuit.library.GMS.sx")(qubit)                                                                                                   | Apply [`SXGate`](qiskit.circuit.library.SXGate "qiskit.circuit.library.SXGate").                                                    |
| [`sxdg`](#qiskit.circuit.library.GMS.sxdg "qiskit.circuit.library.GMS.sxdg")(qubit)                                                                                             | Apply [`SXdgGate`](qiskit.circuit.library.SXdgGate "qiskit.circuit.library.SXdgGate").                                              |
| [`t`](#qiskit.circuit.library.GMS.t "qiskit.circuit.library.GMS.t")(qubit)                                                                                                      | Apply [`TGate`](qiskit.circuit.library.TGate "qiskit.circuit.library.TGate").                                                       |
| [`tdg`](#qiskit.circuit.library.GMS.tdg "qiskit.circuit.library.GMS.tdg")(qubit)                                                                                                | Apply [`TdgGate`](qiskit.circuit.library.TdgGate "qiskit.circuit.library.TdgGate").                                                 |
| [`tensor`](#qiskit.circuit.library.GMS.tensor "qiskit.circuit.library.GMS.tensor")(other\[, inplace])                                                                           | Tensor `self` with `other`.                                                                                                         |
| [`to_gate`](#qiskit.circuit.library.GMS.to_gate "qiskit.circuit.library.GMS.to_gate")(\[parameter\_map, label])                                                                 | Create a Gate out of this circuit.                                                                                                  |
| [`to_instruction`](#qiskit.circuit.library.GMS.to_instruction "qiskit.circuit.library.GMS.to_instruction")(\[parameter\_map, label])                                            | Create an Instruction out of this circuit.                                                                                          |
| [`toffoli`](#qiskit.circuit.library.GMS.toffoli "qiskit.circuit.library.GMS.toffoli")(control\_qubit1, control\_qubit2, …)                                                      | Apply [`CCXGate`](qiskit.circuit.library.CCXGate "qiskit.circuit.library.CCXGate").                                                 |
| [`u`](#qiskit.circuit.library.GMS.u "qiskit.circuit.library.GMS.u")(theta, phi, lam, qubit)                                                                                     | Apply [`UGate`](qiskit.circuit.library.UGate "qiskit.circuit.library.UGate").                                                       |
| [`u1`](#qiskit.circuit.library.GMS.u1 "qiskit.circuit.library.GMS.u1")(theta, qubit)                                                                                            | Apply [`U1Gate`](qiskit.circuit.library.U1Gate "qiskit.circuit.library.U1Gate").                                                    |
| [`u2`](#qiskit.circuit.library.GMS.u2 "qiskit.circuit.library.GMS.u2")(phi, lam, qubit)                                                                                         | Apply [`U2Gate`](qiskit.circuit.library.U2Gate "qiskit.circuit.library.U2Gate").                                                    |
| [`u3`](#qiskit.circuit.library.GMS.u3 "qiskit.circuit.library.GMS.u3")(theta, phi, lam, qubit)                                                                                  | Apply [`U3Gate`](qiskit.circuit.library.U3Gate "qiskit.circuit.library.U3Gate").                                                    |
| [`uc`](#qiskit.circuit.library.GMS.uc "qiskit.circuit.library.GMS.uc")(gate\_list, q\_controls, q\_target\[, …])                                                                | Attach a uniformly controlled gates (also called multiplexed gates) to a circuit.                                                   |
| [`ucrx`](#qiskit.circuit.library.GMS.ucrx "qiskit.circuit.library.GMS.ucrx")(angle\_list, q\_controls, q\_target)                                                               | Attach a uniformly controlled (also called multiplexed) Rx rotation gate to a circuit.                                              |
| [`ucry`](#qiskit.circuit.library.GMS.ucry "qiskit.circuit.library.GMS.ucry")(angle\_list, q\_controls, q\_target)                                                               | Attach a uniformly controlled (also called multiplexed) Ry rotation gate to a circuit.                                              |
| [`ucrz`](#qiskit.circuit.library.GMS.ucrz "qiskit.circuit.library.GMS.ucrz")(angle\_list, q\_controls, q\_target)                                                               | Attach a uniformly controlled (also called multiplexed gates) Rz rotation gate to a circuit.                                        |
| [`unitary`](#qiskit.circuit.library.GMS.unitary "qiskit.circuit.library.GMS.unitary")(obj, qubits\[, label])                                                                    | Apply unitary gate to q.                                                                                                            |
| [`width`](#qiskit.circuit.library.GMS.width "qiskit.circuit.library.GMS.width")()                                                                                               | Return number of qubits plus clbits in circuit.                                                                                     |
| [`x`](#qiskit.circuit.library.GMS.x "qiskit.circuit.library.GMS.x")(qubit\[, label])                                                                                            | Apply [`XGate`](qiskit.circuit.library.XGate "qiskit.circuit.library.XGate").                                                       |
| [`y`](#qiskit.circuit.library.GMS.y "qiskit.circuit.library.GMS.y")(qubit)                                                                                                      | Apply [`YGate`](qiskit.circuit.library.YGate "qiskit.circuit.library.YGate").                                                       |
| [`z`](#qiskit.circuit.library.GMS.z "qiskit.circuit.library.GMS.z")(qubit)                                                                                                      | Apply [`ZGate`](qiskit.circuit.library.ZGate "qiskit.circuit.library.ZGate").                                                       |

## Attributes

|                                                                                                            |                                                                              |
| ---------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------- |
| [`ancillas`](#qiskit.circuit.library.GMS.ancillas "qiskit.circuit.library.GMS.ancillas")                   | Returns a list of ancilla bits in the order that the registers were added.   |
| [`calibrations`](#qiskit.circuit.library.GMS.calibrations "qiskit.circuit.library.GMS.calibrations")       | Return calibration dictionary.                                               |
| [`clbits`](#qiskit.circuit.library.GMS.clbits "qiskit.circuit.library.GMS.clbits")                         | Returns a list of classical bits in the order that the registers were added. |
| [`data`](#qiskit.circuit.library.GMS.data "qiskit.circuit.library.GMS.data")                               | Return the circuit data (instructions and context).                          |
| `extension_lib`                                                                                            |                                                                              |
| [`global_phase`](#qiskit.circuit.library.GMS.global_phase "qiskit.circuit.library.GMS.global_phase")       | Return the global phase of the circuit in radians.                           |
| `header`                                                                                                   |                                                                              |
| `instances`                                                                                                |                                                                              |
| [`metadata`](#qiskit.circuit.library.GMS.metadata "qiskit.circuit.library.GMS.metadata")                   | The user provided metadata associated with the circuit                       |
| [`num_ancillas`](#qiskit.circuit.library.GMS.num_ancillas "qiskit.circuit.library.GMS.num_ancillas")       | Return the number of ancilla qubits.                                         |
| [`num_clbits`](#qiskit.circuit.library.GMS.num_clbits "qiskit.circuit.library.GMS.num_clbits")             | Return number of classical bits.                                             |
| [`num_parameters`](#qiskit.circuit.library.GMS.num_parameters "qiskit.circuit.library.GMS.num_parameters") | Convenience function to get the number of parameter objects in the circuit.  |
| [`num_qubits`](#qiskit.circuit.library.GMS.num_qubits "qiskit.circuit.library.GMS.num_qubits")             | Return number of qubits.                                                     |
| [`parameters`](#qiskit.circuit.library.GMS.parameters "qiskit.circuit.library.GMS.parameters")             | Convenience function to get the parameters defined in the parameter table.   |
| `prefix`                                                                                                   |                                                                              |
| [`qubits`](#qiskit.circuit.library.GMS.qubits "qiskit.circuit.library.GMS.qubits")                         | Returns a list of quantum bits in the order that the registers were added.   |

### add\_bits

<span id="qiskit.circuit.library.GMS.add_bits" />
...
<span id="qiskit.circuit.library.GMS.add_calibration" />
...
To assign new Parameter objects or bind the values in-place, without yielding a new circuit, use the [`assign_parameters()`](#qiskit.circuit.library.GMS.assign_parameters "qiskit.circuit.library.GMS.assign_parameters") method.
...
<span id="qiskit.circuit.library.GMS.control" />
...
<span id="qiskit.circuit.library.GMS.cp" />
...
<span id="qiskit.circuit.library.GMS.csx" />
...
<span id="qiskit.circuit.library.GMS.cu" />
...
<span id="qiskit.circuit.library.GMS.delay" />
...
![../\_images/qiskit.circuit.library.GMS\_3\_0.png](/images/api/qiskit/0.28/qiskit.circuit.library.GMS_3_0.png) ![../\_images/qiskit.circuit.library.GMS\_3\_1.png](/images/api/qiskit/0.28/qiskit.circuit.library.GMS_3_1.png)

### ecr

<span id="qiskit.circuit.library.GMS.ecr" />
...
<span id="qiskit.circuit.library.GMS.get_instructions" />
...
<span id="qiskit.circuit.library.GMS.mcp" />
...
<span id="qiskit.circuit.library.GMS.p" />
...
<span id="qiskit.circuit.library.GMS.pauli" />
...
<span id="qiskit.circuit.library.GMS.power" />
...
<span id="qiskit.circuit.library.GMS.qubit_duration" />
...
<span id="qiskit.circuit.library.GMS.qubit_start_time" />
...
<span id="qiskit.circuit.library.GMS.qubit_stop_time" />
...
<span id="qiskit.circuit.library.GMS.repeat" />
...
<span id="qiskit.circuit.library.GMS.reverse_bits" />
...
<span id="qiskit.circuit.library.GMS.reverse_ops" />
...
<span id="qiskit.circuit.library.GMS.rv" />
...
<span id="qiskit.circuit.library.GMS.save_amplitudes" />
...
<span id="qiskit.circuit.library.GMS.save_amplitudes_squared" />
...
<span id="qiskit.circuit.library.GMS.save_density_matrix" />
...
<span id="qiskit.circuit.library.GMS.save_expectation_value" />
...
<span id="qiskit.circuit.library.GMS.save_expectation_value_variance" />
...
<span id="qiskit.circuit.library.GMS.save_matrix_product_state" />
...
<span id="qiskit.circuit.library.GMS.save_probabilities" />
...
<span id="qiskit.circuit.library.GMS.save_probabilities_dict" />
...
<span id="qiskit.circuit.library.GMS.save_stabilizer" />
...
<span id="qiskit.circuit.library.GMS.save_state" />
...
<span id="qiskit.circuit.library.GMS.save_statevector" />
...
<span id="qiskit.circuit.library.GMS.save_statevector_dict" />
...
<span id="qiskit.circuit.library.GMS.save_superop" />
...
<span id="qiskit.circuit.library.GMS.save_unitary" />
...
<span id="qiskit.circuit.library.GMS.set_density_matrix" />
...
<span id="qiskit.circuit.library.GMS.set_matrix_product_state" />
...
<span id="qiskit.circuit.library.GMS.set_stabilizer" />
...
<span id="qiskit.circuit.library.GMS.set_statevector" />
...
<span id="qiskit.circuit.library.GMS.set_superop" />
...
<span id="qiskit.circuit.library.GMS.set_unitary" />
...
<span id="qiskit.circuit.library.GMS.sx" />
...
<span id="qiskit.circuit.library.GMS.sxdg" />
...
<span id="qiskit.circuit.library.GMS.tensor" />
...
<span id="qiskit.circuit.library.GMS.u" />
