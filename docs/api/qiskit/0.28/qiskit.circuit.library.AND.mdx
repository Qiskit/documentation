...
![../\_images/qiskit.circuit.library.AND\_0\_1.png](/images/api/qiskit/0.28/qiskit.circuit.library.AND_0_1.png)
...
![../\_images/qiskit.circuit.library.AND\_1\_1.png](/images/api/qiskit/0.28/qiskit.circuit.library.AND_1_1.png)
...
| [`compose`](#qiskit.circuit.library.AND.compose "qiskit.circuit.library.AND.compose")(other\[, qubits, clbits, front, …])                                                       | Compose circuit with `other` circuit or instruction, optionally permuting wires.                                                    |
...
| [`get_instructions`](#qiskit.circuit.library.AND.get_instructions "qiskit.circuit.library.AND.get_instructions")(name)                                                          | Get instructions matching name.                                                                                                     |
...
| [`pauli`](#qiskit.circuit.library.AND.pauli "qiskit.circuit.library.AND.pauli")(pauli\_string, qubits)                                                                          | Apply [`PauliGate`](qiskit.circuit.library.PauliGate "qiskit.circuit.library.PauliGate").                                           |
...
| [`qasm`](#qiskit.circuit.library.AND.qasm "qiskit.circuit.library.AND.qasm")(\[formatted, filename, encoding])                                                                  | Return OpenQASM string.                                                                                                             |
...
| [`to_instruction`](#qiskit.circuit.library.AND.to_instruction "qiskit.circuit.library.AND.to_instruction")(\[parameter\_map, label])                                            | Create an Instruction out of this circuit.                                                                                          |
...
<span id="qiskit.circuit.library.AND.add_bits" />
...
![../\_images/qiskit.circuit.library.AND\_4\_0.png](/images/api/qiskit/0.28/qiskit.circuit.library.AND_4_0.png) ![../\_images/qiskit.circuit.library.AND\_4\_1.png](/images/api/qiskit/0.28/qiskit.circuit.library.AND_4_1.png)

### ecr

<span id="qiskit.circuit.library.AND.ecr" />
...
<span id="qiskit.circuit.library.AND.get_instructions" />
...
<span id="qiskit.circuit.library.AND.pauli" />
...
<span id="qiskit.circuit.library.AND.rv" />
...
<span id="qiskit.circuit.library.AND.save_amplitudes" />
...
<span id="qiskit.circuit.library.AND.save_amplitudes_squared" />
...
<span id="qiskit.circuit.library.AND.save_density_matrix" />
...
<span id="qiskit.circuit.library.AND.save_expectation_value" />
...
<span id="qiskit.circuit.library.AND.save_expectation_value_variance" />
...
<span id="qiskit.circuit.library.AND.save_matrix_product_state" />
...
<span id="qiskit.circuit.library.AND.save_probabilities" />
...
<span id="qiskit.circuit.library.AND.save_probabilities_dict" />
...
<span id="qiskit.circuit.library.AND.save_stabilizer" />
...
<span id="qiskit.circuit.library.AND.save_state" />
...
<span id="qiskit.circuit.library.AND.save_statevector" />
...
<span id="qiskit.circuit.library.AND.save_statevector_dict" />
...
<span id="qiskit.circuit.library.AND.save_superop" />
...
<span id="qiskit.circuit.library.AND.save_unitary" />
...
<span id="qiskit.circuit.library.AND.set_density_matrix" />
...
<span id="qiskit.circuit.library.AND.set_matrix_product_state" />
...
<span id="qiskit.circuit.library.AND.set_stabilizer" />
...
<span id="qiskit.circuit.library.AND.set_statevector" />
...
<span id="qiskit.circuit.library.AND.set_superop" />
...
<span id="qiskit.circuit.library.AND.set_unitary" />
...
<span id="qiskit.circuit.library.AND.tensor" />
