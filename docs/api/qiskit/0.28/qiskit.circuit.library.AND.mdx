...
<Class id="qiskit.circuit.library.AND" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/circuit/library/boolean_logic/quantum_and.py" signature="AND(num_variable_qubits, flags=None, mcx_mode='noancilla')" modifiers="class">
  ...
  *   **mcx\_mode** (`str`) – The mode to be used to implement the multi-controlled X gate.
  ...
  <Function id="qiskit.circuit.library.AND.ancillas" signature="ancillas" modifiers="property">
  ...
  <Function id="qiskit.circuit.library.AND.calibrations" signature="calibrations" modifiers="property">
  ...
  <Function id="qiskit.circuit.library.AND.clbits" signature="clbits" modifiers="property">
  ...
  <Function id="qiskit.circuit.library.AND.data" signature="data" modifiers="property">
  ...
  <Function id="qiskit.circuit.library.AND.global_phase" signature="global_phase" modifiers="property">
  ...
  <Function id="qiskit.circuit.library.AND.metadata" signature="metadata" modifiers="property">
  ...
  <Function id="qiskit.circuit.library.AND.num_ancillas" signature="num_ancillas" modifiers="property">
    Return the number of ancilla qubits.
  </Function>

  ### num\_clbits

  <Function id="qiskit.circuit.library.AND.num_clbits" signature="num_clbits" modifiers="property">
  ...
  <Function id="qiskit.circuit.library.AND.num_parameters" signature="num_parameters" modifiers="property">
    Convenience function to get the number of parameter objects in the circuit.
  </Function>

  ### num\_qubits

  <Function id="qiskit.circuit.library.AND.num_qubits" signature="num_qubits" modifiers="property">
  ...
  <Function id="qiskit.circuit.library.AND.parameters" signature="parameters" modifiers="property">
  ...
  <Function id="qiskit.circuit.library.AND.qubits" signature="qubits" modifiers="property">
