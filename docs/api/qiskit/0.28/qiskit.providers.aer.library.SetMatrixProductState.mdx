...
<Class id="qiskit.providers.aer.library.SetMatrixProductState" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-aer/tree/stable/0.8/qiskit/providers/aer/library/set_instructions/set_matrix_product_state.py" signature="SetMatrixProductState(state)">
  ...
  **state** (*Tuple\[List\[Tuple\[np.array\[complex\_t]]]], List\[List\[float]]*) – A matrix\_product\_state.
  ...
  <Function id="qiskit.providers.aer.library.SetMatrixProductState.decompositions" signature="property decompositions">
    Get the decompositions of the instruction from the SessionEquivalenceLibrary.
  </Function>

  ### definition

  <Function id="qiskit.providers.aer.library.SetMatrixProductState.definition" signature="property definition">
    Return definition in terms of other basic gates.
  </Function>

  ### duration

  <Function id="qiskit.providers.aer.library.SetMatrixProductState.duration" signature="property duration">
    Get the duration.
  </Function>
  ...
  <Function id="qiskit.providers.aer.library.SetMatrixProductState.label" signature="property label">
  ...
  <Function id="qiskit.providers.aer.library.SetMatrixProductState.params" signature="property params">
  ...
  <Function id="qiskit.providers.aer.library.SetMatrixProductState.unit" signature="property unit">
