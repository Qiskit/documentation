...
<Class id="qiskit.pulse.Waveform" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/pulse/library/waveform.py" signature="Waveform(samples, name=None, epsilon=1e-07, limit_amplitude=None)">
  ...
  *   **limit\_amplitude** (`Optional`\[`bool`]) – Passed to parent Pulse
  ...
  <Function id="qiskit.pulse.Waveform.id" signature="property id">
  ...
  <Function id="qiskit.pulse.Waveform.parameters" signature="property parameters">
  ...
  <Function id="qiskit.pulse.Waveform.samples" signature="property samples">
