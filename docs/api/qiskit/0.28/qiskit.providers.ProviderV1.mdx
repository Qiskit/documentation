...
<Class id="qiskit.providers.ProviderV1" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/providers/provider.py" signature="ProviderV1">
  Base class for a Backend Provider.

  ### \_\_init\_\_

  <Function id="qiskit.providers.ProviderV1.__init__" name="__init__" signature="__init__()">
