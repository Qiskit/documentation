...
<Class id="qiskit.transpiler.passes.BasicSwap" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/transpiler/passes/routing/basic_swap.py" signature="BasicSwap(*args, **kwargs)" modifiers="class">
  ...
  *   **fake\_run** (*bool*) – if true, it only pretend to do routing, i.e., no swap is effectively added.
  ...
  <Function id="qiskit.transpiler.passes.BasicSwap.is_analysis_pass" signature="is_analysis_pass" modifiers="property">
  ...
  <Function id="qiskit.transpiler.passes.BasicSwap.is_transformation_pass" signature="is_transformation_pass" modifiers="property">
