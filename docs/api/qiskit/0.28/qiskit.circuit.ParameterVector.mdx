...
<Class id="qiskit.circuit.ParameterVector" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/circuit/parametervector.py" signature="ParameterVector(name, length=0)" modifiers="class">
  ...
  <Function id="qiskit.circuit.ParameterVector.name" signature="name" modifiers="property">
    Returns the name of the ParameterVector.
  </Function>

  ### params

  <Function id="qiskit.circuit.ParameterVector.params" signature="params" modifiers="property">
