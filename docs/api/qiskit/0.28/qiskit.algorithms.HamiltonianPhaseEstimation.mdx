...
<Class id="qiskit.algorithms.HamiltonianPhaseEstimation" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/algorithms/phase_estimators/hamiltonian_phase_estimation.py" signature="HamiltonianPhaseEstimation(num_evaluation_qubits, quantum_instance=None)">
...
$$
  ...
  *   **quantum\_instance** (`Union`\[`QuantumInstance`, `BaseBackend`, `None`]) – The quantum instance on which the circuit will be run.
  ...
  <Function id="qiskit.algorithms.HamiltonianPhaseEstimation.__init__" name="__init__" signature="__init__(num_evaluation_qubits, quantum_instance=None)">
    **Parameters**
  ...
  <Function id="qiskit.algorithms.HamiltonianPhaseEstimation.estimate" name="estimate" signature="estimate(hamiltonian, state_preparation=None, evolution=None, bound=None)">
