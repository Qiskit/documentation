...
<Class id="qiskit.providers.aer.library.SetDensityMatrix" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-aer/tree/stable/0.8/qiskit/providers/aer/library/set_instructions/set_density_matrix.py" signature="SetDensityMatrix(state)" modifiers="class">
  ...
  **ExtensionError** – if the input density matrix is not valid.
  ...
  <Function id="qiskit.providers.aer.library.SetDensityMatrix.decompositions" signature="decompositions" modifiers="property">
    Get the decompositions of the instruction from the SessionEquivalenceLibrary.
  </Function>

  ### definition

  <Function id="qiskit.providers.aer.library.SetDensityMatrix.definition" signature="definition" modifiers="property">
    Return definition in terms of other basic gates.
  </Function>

  ### duration

  <Function id="qiskit.providers.aer.library.SetDensityMatrix.duration" signature="duration" modifiers="property">
    Get the duration.
  </Function>
  ...
  <Function id="qiskit.providers.aer.library.SetDensityMatrix.label" signature="label" modifiers="property">
  ...
  <Function id="qiskit.providers.aer.library.SetDensityMatrix.params" signature="params" modifiers="property">
  ...
  <Function id="qiskit.providers.aer.library.SetDensityMatrix.unit" signature="unit" modifiers="property">
