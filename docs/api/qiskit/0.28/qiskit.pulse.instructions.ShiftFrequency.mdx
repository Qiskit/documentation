...
<Class id="qiskit.pulse.instructions.ShiftFrequency" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/pulse/instructions/frequency.py" signature="ShiftFrequency(frequency, channel, name=None)" modifiers="class">
  ...
  *   **name** (`Optional`\[`str`]) – Name of this set channel frequency instruction.
  ...
  <Function id="qiskit.pulse.instructions.ShiftFrequency.__init__" signature="__init__(frequency, channel, name=None)">
    Creates a new shift frequency instruction.
  ...
  <Function id="qiskit.pulse.instructions.ShiftFrequency.assign_parameters" signature="assign_parameters(value_dict)">
  ...
  <Function id="qiskit.pulse.instructions.ShiftFrequency.channel" signature="channel" modifiers="property">
  ...
  <Function id="qiskit.pulse.instructions.ShiftFrequency.channels" signature="channels" modifiers="property">
  ...
  <Function id="qiskit.pulse.instructions.ShiftFrequency.duration" signature="duration" modifiers="property">
  ...
  <Function id="qiskit.pulse.instructions.ShiftFrequency.flatten" signature="flatten()">
  ...
  <Function id="qiskit.pulse.instructions.ShiftFrequency.frequency" signature="frequency" modifiers="property">
  ...
  <Function id="qiskit.pulse.instructions.ShiftFrequency.id" signature="id" modifiers="property">
  ...
  <Function id="qiskit.pulse.instructions.ShiftFrequency.instructions" signature="instructions" modifiers="property">
  ...
  <Function id="qiskit.pulse.instructions.ShiftFrequency.name" signature="name" modifiers="property">
  ...
  <Function id="qiskit.pulse.instructions.ShiftFrequency.operands" signature="operands" modifiers="property">
  ...
  <Function id="qiskit.pulse.instructions.ShiftFrequency.parameters" signature="parameters" modifiers="property">
  ...
  <Function id="qiskit.pulse.instructions.ShiftFrequency.start_time" signature="start_time" modifiers="property">
  ...
  <Function id="qiskit.pulse.instructions.ShiftFrequency.stop_time" signature="stop_time" modifiers="property">
