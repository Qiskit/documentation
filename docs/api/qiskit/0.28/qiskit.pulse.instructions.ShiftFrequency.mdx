...
<Class id="qiskit.pulse.instructions.ShiftFrequency" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/pulse/instructions/frequency.py" signature="ShiftFrequency(frequency, channel, name=None)">
  ...
  *   **name** (`Optional`\[`str`]) – Name of this set channel frequency instruction.
  ...
  <Function id="qiskit.pulse.instructions.ShiftFrequency.__init__" name="__init__" signature="__init__(frequency, channel, name=None)">
    Creates a new shift frequency instruction.
  ...
  <Function id="qiskit.pulse.instructions.ShiftFrequency.assign_parameters" name="assign_parameters" signature="assign_parameters(value_dict)">
  ...
  <Function id="qiskit.pulse.instructions.ShiftFrequency.channel" name="channel" signature="property channel">
  ...
  <Function id="qiskit.pulse.instructions.ShiftFrequency.channels" name="channels" signature="property channels">
  ...
  <Function id="qiskit.pulse.instructions.ShiftFrequency.draw" name="draw" signature="draw(dt=1, style=None, filename=None, interp_method=None, scale=1, plot_all=False, plot_range=None, interactive=False, table=True, label=False, framechange=True, channels=None)">
  ...
  <Function id="qiskit.pulse.instructions.ShiftFrequency.duration" name="duration" signature="property duration">
  ...
  <Function id="qiskit.pulse.instructions.ShiftFrequency.flatten" name="flatten" signature="flatten()">
  ...
  <Function id="qiskit.pulse.instructions.ShiftFrequency.frequency" name="frequency" signature="property frequency">
  ...
  <Function id="qiskit.pulse.instructions.ShiftFrequency.id" name="id" signature="property id">
  ...
  <Function id="qiskit.pulse.instructions.ShiftFrequency.instructions" name="instructions" signature="property instructions">
  ...
  <Function id="qiskit.pulse.instructions.ShiftFrequency.name" name="name" signature="property name">
  ...
  <Function id="qiskit.pulse.instructions.ShiftFrequency.operands" name="operands" signature="property operands">
  ...
  <Function id="qiskit.pulse.instructions.ShiftFrequency.parameters" name="parameters" signature="property parameters">
  ...
  <Function id="qiskit.pulse.instructions.ShiftFrequency.start_time" name="start_time" signature="property start_time">
  ...
  <Function id="qiskit.pulse.instructions.ShiftFrequency.stop_time" name="stop_time" signature="property stop_time">
