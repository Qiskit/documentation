...
<Class id="qiskit.transpiler.passes.SabreLayout" github="https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/transpiler/passes/layout/sabre_layout.py" signature="SabreLayout(*args, **kwargs)">
