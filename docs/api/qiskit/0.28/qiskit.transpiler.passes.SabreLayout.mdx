...
<Class id="qiskit.transpiler.passes.SabreLayout" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/transpiler/passes/layout/sabre_layout.py" signature="SabreLayout(*args, **kwargs)">
  ...
  *   **max\_iterations** (*int*) – number of forward-backward iterations.
  ...
  <Function id="qiskit.transpiler.passes.SabreLayout.__init__" name="__init__" signature="__init__(coupling_map, routing_pass=None, seed=None, max_iterations=3)">
    SabreLayout initializer.
  ...
  <Function id="qiskit.transpiler.passes.SabreLayout.is_analysis_pass" name="is_analysis_pass" signature="property is_analysis_pass">
  ...
  <Function id="qiskit.transpiler.passes.SabreLayout.is_transformation_pass" name="is_transformation_pass" signature="property is_transformation_pass">
