...
<Class id="qiskit.transpiler.passes.SabreLayout" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/transpiler/passes/layout/sabre_layout.py" signature="SabreLayout(*args, **kwargs)" modifiers="class">
  ...
  *   **max\_iterations** (*int*) – number of forward-backward iterations.
  ...
  <Function id="qiskit.transpiler.passes.SabreLayout.is_analysis_pass" signature="is_analysis_pass" modifiers="property">
  ...
  <Function id="qiskit.transpiler.passes.SabreLayout.is_transformation_pass" signature="is_transformation_pass" modifiers="property">
