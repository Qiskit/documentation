...
<Class id="qiskit.transpiler.passes.SabreLayout" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/transpiler/passes/layout/sabre_layout.py" signature="SabreLayout(*args, **kwargs)">
  ...
  *   **max\_iterations** (*int*) – number of forward-backward iterations.
  ...
  <Function id="qiskit.transpiler.passes.SabreLayout.is_analysis_pass" signature="property is_analysis_pass">
  ...
  <Function id="qiskit.transpiler.passes.SabreLayout.is_transformation_pass" signature="property is_transformation_pass">
