...
<Class id="qiskit.circuit.Instruction" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/circuit/instruction.py" signature="Instruction(name, num_qubits, num_clbits, params, duration=None, unit='dt', label=None)">
  ...
  **CircuitError** – when the register is not in the correct format.
  ...
  <Function id="qiskit.circuit.Instruction.decompositions" signature="property decompositions">
    Get the decompositions of the instruction from the SessionEquivalenceLibrary.
  </Function>

  ### definition

  <Function id="qiskit.circuit.Instruction.definition" signature="property definition">
    Return definition in terms of other basic gates.
  </Function>

  ### duration

  <Function id="qiskit.circuit.Instruction.duration" signature="property duration">
    Get the duration.
  </Function>
  ...
  <Function id="qiskit.circuit.Instruction.label" signature="property label">
  ...
  <Function id="qiskit.circuit.Instruction.params" signature="property params">
  ...
  <Function id="qiskit.circuit.Instruction.unit" signature="property unit">
