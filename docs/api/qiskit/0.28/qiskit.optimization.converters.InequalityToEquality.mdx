...
<Class id="qiskit.optimization.converters.InequalityToEquality" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/optimization/converters/inequality_to_equality.py" signature="InequalityToEquality(mode='auto')">
  ...
  *   **’auto’: Try to use integer variables but if it’s not possible,**
  ...
  <Function id="qiskit.optimization.converters.InequalityToEquality.__init__" name="__init__" signature="__init__(mode='auto')">
    **Parameters**
  ...
  <Function id="qiskit.optimization.converters.InequalityToEquality.convert" name="convert" signature="convert(problem)">
  ...
  <Function id="qiskit.optimization.converters.InequalityToEquality.interpret" name="interpret" signature="interpret(x)">
  ...
  <Function id="qiskit.optimization.converters.InequalityToEquality.mode" name="mode" signature="property mode">
