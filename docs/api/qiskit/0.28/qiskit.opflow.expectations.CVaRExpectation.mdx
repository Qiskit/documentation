...
description: API reference for qiskit.opflow.expectations.CVaRExpectation in qiskit v0.28
...
<Class id="qiskit.opflow.expectations.CVaRExpectation" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/opflow/expectations/cvar_expectation.py" signature="CVaRExpectation(alpha, expectation=None)" modifiers="class">
  ...
  **NotImplementedError** – If the `expectation` is an AerPauliExpecation.
  ...
  <Function id="qiskit.opflow.expectations.CVaRExpectation.__init__" signature="__init__(alpha, expectation=None)">
    **Parameters**
