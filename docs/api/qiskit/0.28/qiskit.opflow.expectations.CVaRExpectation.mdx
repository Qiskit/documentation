...
<Class id="qiskit.opflow.expectations.CVaRExpectation" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/opflow/expectations/cvar_expectation.py" signature="CVaRExpectation(alpha, expectation=None)">
  ...
  **NotImplementedError** – If the `expectation` is an AerPauliExpecation.
  ...
  <Function id="qiskit.opflow.expectations.CVaRExpectation.__init__" name="__init__" signature="__init__(alpha, expectation=None)">
    **Parameters**
  ...
  <Function id="qiskit.opflow.expectations.CVaRExpectation.compute_variance" name="compute_variance" signature="compute_variance(exp_op)">
  ...
  <Function id="qiskit.opflow.expectations.CVaRExpectation.convert" name="convert" signature="convert(operator)">
