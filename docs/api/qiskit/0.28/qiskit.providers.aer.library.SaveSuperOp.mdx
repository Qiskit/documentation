...
<Class id="qiskit.providers.aer.library.SaveSuperOp" github="https://github.com/qiskit/qiskit-aer/tree/stable/0.8/qiskit/providers/aer/library/save_instructions/save_superop.py" signature="SaveSuperOp(num_qubits, label='superop', pershot=False)">
