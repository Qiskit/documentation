...
<Class id="qiskit.providers.aer.library.SaveSuperOp" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-aer/tree/stable/0.8/qiskit/providers/aer/library/save_instructions/save_superop.py" signature="SaveSuperOp(num_qubits, label='superop', pershot=False)">
  ...
  *   **pershot** (*bool*) – if True save a list of SuperOp matrices for each shot of the simulation \[Default: False].
  ...
  <Function id="qiskit.providers.aer.library.SaveSuperOp.decompositions" signature="property decompositions">
    Get the decompositions of the instruction from the SessionEquivalenceLibrary.
  </Function>

  ### definition

  <Function id="qiskit.providers.aer.library.SaveSuperOp.definition" signature="property definition">
    Return definition in terms of other basic gates.
  </Function>

  ### duration

  <Function id="qiskit.providers.aer.library.SaveSuperOp.duration" signature="property duration">
    Get the duration.
  </Function>
  ...
  <Function id="qiskit.providers.aer.library.SaveSuperOp.label" signature="property label">
  ...
  <Function id="qiskit.providers.aer.library.SaveSuperOp.params" signature="property params">
  ...
  <Function id="qiskit.providers.aer.library.SaveSuperOp.unit" signature="property unit">
