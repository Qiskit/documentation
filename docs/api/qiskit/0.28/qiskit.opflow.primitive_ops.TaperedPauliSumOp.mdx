...
<Class id="qiskit.opflow.primitive_ops.TaperedPauliSumOp" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/opflow/primitive_ops/tapered_pauli_sum_op.py" signature="TaperedPauliSumOp(primitive, z2_symmetries, coeff=1.0)">
  ...
  **TypeError** – invalid parameters.
  ...
  <Function id="qiskit.opflow.primitive_ops.TaperedPauliSumOp.__init__" name="__init__" signature="__init__(primitive, z2_symmetries, coeff=1.0)">
    **Parameters**
  ...
  <Function id="qiskit.opflow.primitive_ops.TaperedPauliSumOp.add" name="add" signature="add(other)">
  ...
  <Function id="qiskit.opflow.primitive_ops.TaperedPauliSumOp.adjoint" name="adjoint" signature="adjoint()">
  ...
  <Function id="qiskit.opflow.primitive_ops.TaperedPauliSumOp.assign_parameters" name="assign_parameters" signature="assign_parameters(param_dict)">
  ...
  <Function id="qiskit.opflow.primitive_ops.TaperedPauliSumOp.bind_parameters" name="bind_parameters" signature="bind_parameters(param_dict)">
  ...
  <Function id="qiskit.opflow.primitive_ops.TaperedPauliSumOp.coeff" name="coeff" signature="property coeff">
  ...
  <Function id="qiskit.opflow.primitive_ops.TaperedPauliSumOp.coeffs" name="coeffs" signature="property coeffs">
    Return the Pauli coefficients.
  </Function>

  ### compose

  <Function id="qiskit.opflow.primitive_ops.TaperedPauliSumOp.compose" name="compose" signature="compose(other, permutation=None, front=False)">
  ...
  <Function id="qiskit.opflow.primitive_ops.TaperedPauliSumOp.copy" name="copy" signature="copy()">
  ...
  <Function id="qiskit.opflow.primitive_ops.TaperedPauliSumOp.equals" name="equals" signature="equals(other)">
  ...
  <Function id="qiskit.opflow.primitive_ops.TaperedPauliSumOp.eval" name="eval" signature="eval(front=None)">
  ...
  <Function id="qiskit.opflow.primitive_ops.TaperedPauliSumOp.exp_i" name="exp_i" signature="exp_i()">
  ...
  <Function id="qiskit.opflow.primitive_ops.TaperedPauliSumOp.from_list" name="from_list" signature="classmethod from_list(pauli_list, coeff=1.0)">
  ...
  <Function id="qiskit.opflow.primitive_ops.TaperedPauliSumOp.grouping_type" name="grouping_type" signature="property grouping_type">
    Type of Grouping
  ...
  <Function id="qiskit.opflow.primitive_ops.TaperedPauliSumOp.instance_id" name="instance_id" signature="property instance_id">
  ...
  <Function id="qiskit.opflow.primitive_ops.TaperedPauliSumOp.is_zero" name="is_zero" signature="is_zero()">
  ...
  <Function id="qiskit.opflow.primitive_ops.TaperedPauliSumOp.log_i" name="log_i" signature="log_i(massive=False)">
  ...
  <Function id="qiskit.opflow.primitive_ops.TaperedPauliSumOp.matrix_iter" name="matrix_iter" signature="matrix_iter(sparse=False)">
  ...
  <Function id="qiskit.opflow.primitive_ops.TaperedPauliSumOp.mul" name="mul" signature="mul(scalar)">
  ...
  <Function id="qiskit.opflow.primitive_ops.TaperedPauliSumOp.neg" name="neg" signature="neg()">
  ...
  <Function id="qiskit.opflow.primitive_ops.TaperedPauliSumOp.num_qubits" name="num_qubits" signature="property num_qubits">
  ...
  <Function id="qiskit.opflow.primitive_ops.TaperedPauliSumOp.parameters" name="parameters" signature="property parameters">
    Return a set of Parameter objects contained in the Operator.
  </Function>

  ### permute

  <Function id="qiskit.opflow.primitive_ops.TaperedPauliSumOp.permute" name="permute" signature="permute(permutation)">
  ...
  <Function id="qiskit.opflow.primitive_ops.TaperedPauliSumOp.power" name="power" signature="power(exponent)">
    Return Operator composed with self multiple times, overloaded by `**`.
  </Function>

  ### primitive

  <Function id="qiskit.opflow.primitive_ops.TaperedPauliSumOp.primitive" name="primitive" signature="property primitive">
  ...
  <Function id="qiskit.opflow.primitive_ops.TaperedPauliSumOp.primitive_strings" name="primitive_strings" signature="primitive_strings()">
  ...
  <Function id="qiskit.opflow.primitive_ops.TaperedPauliSumOp.reduce" name="reduce" signature="reduce(atol=None, rtol=None)">
  ...
  <Function id="qiskit.opflow.primitive_ops.TaperedPauliSumOp.settings" name="settings" signature="property settings">
  ...
  <Function id="qiskit.opflow.primitive_ops.TaperedPauliSumOp.tensor" name="tensor" signature="tensor(other)">
  ...
  <Function id="qiskit.opflow.primitive_ops.TaperedPauliSumOp.tensorpower" name="tensorpower" signature="tensorpower(other)">
  ...
  <Function id="qiskit.opflow.primitive_ops.TaperedPauliSumOp.to_circuit" name="to_circuit" signature="to_circuit()">
  ...
  <Function id="qiskit.opflow.primitive_ops.TaperedPauliSumOp.to_circuit_op" name="to_circuit_op" signature="to_circuit_op()">
  ...
  <Function id="qiskit.opflow.primitive_ops.TaperedPauliSumOp.to_instruction" name="to_instruction" signature="to_instruction()">
  ...
  <Function id="qiskit.opflow.primitive_ops.TaperedPauliSumOp.to_matrix" name="to_matrix" signature="to_matrix(massive=False)">
  ...
  <Function id="qiskit.opflow.primitive_ops.TaperedPauliSumOp.to_matrix_op" name="to_matrix_op" signature="to_matrix_op(massive=False)">
  ...
  <Function id="qiskit.opflow.primitive_ops.TaperedPauliSumOp.to_pauli_op" name="to_pauli_op" signature="to_pauli_op(massive=False)">
  ...
  <Function id="qiskit.opflow.primitive_ops.TaperedPauliSumOp.to_spmatrix" name="to_spmatrix" signature="to_spmatrix()">
  ...
  <Function id="qiskit.opflow.primitive_ops.TaperedPauliSumOp.z2_symmetries" name="z2_symmetries" signature="property z2_symmetries">
