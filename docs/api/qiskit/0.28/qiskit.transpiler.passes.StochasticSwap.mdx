...
<Class id="qiskit.transpiler.passes.StochasticSwap" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/transpiler/passes/routing/stochastic_swap.py" signature="StochasticSwap(*args, **kwargs)">
  ...
  *   **fake\_run** (*bool*) – if true, it only pretend to do routing, i.e., no swap is effectively added.
  ...
  <Function id="qiskit.transpiler.passes.StochasticSwap.__init__" name="__init__" signature="__init__(coupling_map, trials=20, seed=None, fake_run=False)">
    StochasticSwap initializer.
  ...
  <Function id="qiskit.transpiler.passes.StochasticSwap.is_analysis_pass" name="is_analysis_pass" signature="property is_analysis_pass">
  ...
  <Function id="qiskit.transpiler.passes.StochasticSwap.is_transformation_pass" name="is_transformation_pass" signature="property is_transformation_pass">
  ...
  <Function id="qiskit.transpiler.passes.StochasticSwap.name" name="name" signature="name()">
    Return the name of the pass.
  </Function>

  ### run

  <Function id="qiskit.transpiler.passes.StochasticSwap.run" name="run" signature="run(dag)">
