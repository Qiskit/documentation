...
<Class id="qiskit.transpiler.passes.StochasticSwap" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/transpiler/passes/routing/stochastic_swap.py" signature="StochasticSwap(*args, **kwargs)" modifiers="class">
  ...
  *   **fake\_run** (*bool*) – if true, it only pretend to do routing, i.e., no swap is effectively added.
  ...
  <Function id="qiskit.transpiler.passes.StochasticSwap.__init__" signature="__init__(coupling_map, trials=20, seed=None, fake_run=False)">
    StochasticSwap initializer.
  ...
  <Function id="qiskit.transpiler.passes.StochasticSwap.is_analysis_pass" signature="is_analysis_pass" modifiers="property">
  ...
  <Function id="qiskit.transpiler.passes.StochasticSwap.is_transformation_pass" signature="is_transformation_pass" modifiers="property">
