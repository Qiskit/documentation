...
<Class id="qiskit.algorithms.PhaseEstimationResult" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/algorithms/phase_estimators/phase_estimation_result.py" signature="PhaseEstimationResult(num_evaluation_qubits, circuit_result, phases)">
  ...
  *   **phases** (`Union`\[`ndarray`, `Dict`\[`str`, `float`]]) – ndarray or dict of phases and frequencies determined by QPE.
  ...
  <Function id="qiskit.algorithms.PhaseEstimationResult.circuit_result" signature="property circuit_result">
  ...
  <Function id="qiskit.algorithms.PhaseEstimationResult.most_likely_phase" signature="property most_likely_phase">
  ...
  <Function id="qiskit.algorithms.PhaseEstimationResult.phase" signature="property phase">
  ...
  <Function id="qiskit.algorithms.PhaseEstimationResult.phases" signature="property phases">
