...
<Class id="qiskit.chemistry.algorithms.OrbitalOptimizationVQE" github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/chemistry/algorithms/ground_state_solvers/orbital_optimization_vqe.py" signature="OrbitalOptimizationVQE(transformation, solver, initial_point=None, orbital_rotation=None, bounds=None, iterative_oo=True, iterative_oo_iterations=2)">
  ...
  **Raises**
  ...
  <Function id="qiskit.chemistry.algorithms.OrbitalOptimizationVQE.__init__" name="__init__" signature="__init__(transformation, solver, initial_point=None, orbital_rotation=None, bounds=None, iterative_oo=True, iterative_oo_iterations=2)">
    **Parameters**
  ...
  <Function id="qiskit.chemistry.algorithms.OrbitalOptimizationVQE.evaluate_operators" name="evaluate_operators" signature="evaluate_operators(state, operators)">
  ...
  <Function id="qiskit.chemistry.algorithms.OrbitalOptimizationVQE.returns_groundstate" name="returns_groundstate" signature="returns_groundstate()">
  ...
  <Function id="qiskit.chemistry.algorithms.OrbitalOptimizationVQE.solve" name="solve" signature="solve(driver, aux_operators=None)">
  ...
  <Function id="qiskit.chemistry.algorithms.OrbitalOptimizationVQE.solver" name="solver" signature="property solver">
  ...
  <Function id="qiskit.chemistry.algorithms.OrbitalOptimizationVQE.transformation" name="transformation" signature="property transformation">
