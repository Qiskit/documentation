...
<Class id="qiskit.chemistry.algorithms.OrbitalOptimizationVQE" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/chemistry/algorithms/ground_state_solvers/orbital_optimization_vqe.py" signature="OrbitalOptimizationVQE(transformation, solver, initial_point=None, orbital_rotation=None, bounds=None, iterative_oo=True, iterative_oo_iterations=2)">
  ...
  **Raises**
  ...
  <Function id="qiskit.chemistry.algorithms.OrbitalOptimizationVQE.solver" signature="property solver">
  ...
  <Function id="qiskit.chemistry.algorithms.OrbitalOptimizationVQE.transformation" signature="property transformation">
