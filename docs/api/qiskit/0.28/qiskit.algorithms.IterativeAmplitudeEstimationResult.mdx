...
<Class id="qiskit.algorithms.IterativeAmplitudeEstimationResult" github="https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/algorithms/amplitude_estimators/iae.py" signature="IterativeAmplitudeEstimationResult">
