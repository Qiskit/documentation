...
<Class id="qiskit.aqua.components.feature_maps.RawFeatureVector" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/aqua/components/feature_maps/raw_feature_vector.py" signature="RawFeatureVector(feature_dimension=2)">
  ...
  **feature\_dimension** (`int`) – The feature dimension, has a minimum value of 1.
  ...
  <Function id="qiskit.aqua.components.feature_maps.RawFeatureVector.feature_dimension" signature="property feature_dimension">
    returns feature dimension
  </Function>

  ### get\_entangler\_map

  <Function id="qiskit.aqua.components.feature_maps.RawFeatureVector.get_entangler_map" signature="static get_entangler_map(map_type, num_qubits)">
    get entangle map
  </Function>

  ### num\_qubits

  <Function id="qiskit.aqua.components.feature_maps.RawFeatureVector.num_qubits" signature="property num_qubits">
    returns number of qubits
  </Function>

  ### support\_parameterized\_circuit

  <Function id="qiskit.aqua.components.feature_maps.RawFeatureVector.support_parameterized_circuit" signature="property support_parameterized_circuit">
    returns whether or not the sub-class support parameterized circuit
  </Function>

  ### validate\_entangler\_map

  <Function id="qiskit.aqua.components.feature_maps.RawFeatureVector.validate_entangler_map" signature="static validate_entangler_map(entangler_map, num_qubits)">
