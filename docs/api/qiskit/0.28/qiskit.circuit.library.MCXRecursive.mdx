...
<Class id="qiskit.circuit.library.MCXRecursive" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/circuit/library/standard_gates/x.py" signature="MCXRecursive(num_ctrl_qubits=None, label=None, ctrl_state=None)" modifiers="class">
  ...
  <Function id="qiskit.circuit.library.MCXRecursive.ctrl_state" signature="ctrl_state" modifiers="property">
  ...
  <Function id="qiskit.circuit.library.MCXRecursive.decompositions" signature="decompositions" modifiers="property">
    Get the decompositions of the instruction from the SessionEquivalenceLibrary.
  </Function>

  ### definition

  <Function id="qiskit.circuit.library.MCXRecursive.definition" signature="definition" modifiers="property">
  ...
  <Function id="qiskit.circuit.library.MCXRecursive.duration" signature="duration" modifiers="property">
    Get the duration.
  </Function>
  ...
  <Function id="qiskit.circuit.library.MCXRecursive.label" signature="label" modifiers="property">
  ...
  <Function id="qiskit.circuit.library.MCXRecursive.name" signature="name" modifiers="property">
  ...
  <Function id="qiskit.circuit.library.MCXRecursive.num_ancilla_qubits" signature="num_ancilla_qubits" modifiers="property">
    The number of ancilla qubits.
  </Function>

  ### num\_ctrl\_qubits

  <Function id="qiskit.circuit.library.MCXRecursive.num_ctrl_qubits" signature="num_ctrl_qubits" modifiers="property">
  ...
  <Function id="qiskit.circuit.library.MCXRecursive.params" signature="params" modifiers="property">
  ...
  <Function id="qiskit.circuit.library.MCXRecursive.unit" signature="unit" modifiers="property">
