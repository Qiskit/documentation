...
<Class id="qiskit.circuit.library.MCXRecursive" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/circuit/library/standard_gates/x.py" signature="MCXRecursive(num_ctrl_qubits=None, label=None, ctrl_state=None)">
  ...
  <Function id="qiskit.circuit.library.MCXRecursive.__init__" name="__init__" signature="__init__(num_ctrl_qubits, label=None, ctrl_state=None)">
    Create new MCX gate.
  </Function>
  ...
  <Function id="qiskit.circuit.library.MCXRecursive.add_decomposition" name="add_decomposition" signature="add_decomposition(decomposition)">
    Add a decomposition of the instruction to the SessionEquivalenceLibrary.
  </Function>

  ### assemble

  <Function id="qiskit.circuit.library.MCXRecursive.assemble" name="assemble" signature="assemble()">
    Assemble a QasmQobjInstruction
  </Function>

  ### broadcast\_arguments

  <Function id="qiskit.circuit.library.MCXRecursive.broadcast_arguments" name="broadcast_arguments" signature="broadcast_arguments(qargs, cargs)">
  ...
  <Function id="qiskit.circuit.library.MCXRecursive.c_if" name="c_if" signature="c_if(classical, val)">
    Add classical condition on register or cbit classical and value val.
  </Function>

  ### control

  <Function id="qiskit.circuit.library.MCXRecursive.control" name="control" signature="control(num_ctrl_qubits=1, label=None, ctrl_state=None)">
  ...
  <Function id="qiskit.circuit.library.MCXRecursive.copy" name="copy" signature="copy(name=None)">
  ...
  <Function id="qiskit.circuit.library.MCXRecursive.ctrl_state" name="ctrl_state" signature="property ctrl_state">
  ...
  <Function id="qiskit.circuit.library.MCXRecursive.decompositions" name="decompositions" signature="property decompositions">
    Get the decompositions of the instruction from the SessionEquivalenceLibrary.
  </Function>

  ### definition

  <Function id="qiskit.circuit.library.MCXRecursive.definition" name="definition" signature="property definition">
  ...
  <Function id="qiskit.circuit.library.MCXRecursive.duration" name="duration" signature="property duration">
    Get the duration.
  </Function>
  ...
  <Function id="qiskit.circuit.library.MCXRecursive.is_parameterized" name="is_parameterized" signature="is_parameterized()">
    Return True .IFF. instruction is parameterized else False
  </Function>

  ### label

  <Function id="qiskit.circuit.library.MCXRecursive.label" name="label" signature="property label">
  ...
  <Function id="qiskit.circuit.library.MCXRecursive.mirror" name="mirror" signature="mirror()">
  ...
  <Function id="qiskit.circuit.library.MCXRecursive.name" name="name" signature="property name">
  ...
  <Function id="qiskit.circuit.library.MCXRecursive.num_ancilla_qubits" name="num_ancilla_qubits" signature="property num_ancilla_qubits">
    The number of ancilla qubits.
  </Function>

  ### num\_ctrl\_qubits

  <Function id="qiskit.circuit.library.MCXRecursive.num_ctrl_qubits" name="num_ctrl_qubits" signature="property num_ctrl_qubits">
  ...
  <Function id="qiskit.circuit.library.MCXRecursive.params" name="params" signature="property params">
  ...
  <Function id="qiskit.circuit.library.MCXRecursive.power" name="power" signature="power(exponent)">
  ...
  <Function id="qiskit.circuit.library.MCXRecursive.qasm" name="qasm" signature="qasm()">
  ...
  <Function id="qiskit.circuit.library.MCXRecursive.repeat" name="repeat" signature="repeat(n)">
  ...
  <Function id="qiskit.circuit.library.MCXRecursive.reverse_ops" name="reverse_ops" signature="reverse_ops()">
  ...
  <Function id="qiskit.circuit.library.MCXRecursive.soft_compare" name="soft_compare" signature="soft_compare(other)">
  ...
  <Function id="qiskit.circuit.library.MCXRecursive.to_matrix" name="to_matrix" signature="to_matrix()">
  ...
  <Function id="qiskit.circuit.library.MCXRecursive.unit" name="unit" signature="property unit">
    Get the time unit of duration.
  </Function>

  ### validate\_parameter

  <Function id="qiskit.circuit.library.MCXRecursive.validate_parameter" name="validate_parameter" signature="validate_parameter(parameter)">
