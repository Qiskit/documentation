...
<Class id="qiskit.circuit.library.MCXRecursive" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/circuit/library/standard_gates/x.py" signature="MCXRecursive(num_ctrl_qubits=None, label=None, ctrl_state=None)">
  ...
  <Function id="qiskit.circuit.library.MCXRecursive.ctrl_state" signature="property ctrl_state">
  ...
  <Function id="qiskit.circuit.library.MCXRecursive.decompositions" signature="property decompositions">
    Get the decompositions of the instruction from the SessionEquivalenceLibrary.
  </Function>

  ### definition

  <Function id="qiskit.circuit.library.MCXRecursive.definition" signature="property definition">
  ...
  <Function id="qiskit.circuit.library.MCXRecursive.duration" signature="property duration">
    Get the duration.
  </Function>

  ### get\_num\_ancilla\_qubits

  <Function id="qiskit.circuit.library.MCXRecursive.get_num_ancilla_qubits" signature="static get_num_ancilla_qubits(num_ctrl_qubits, mode='recursion')">
  ...
  <Function id="qiskit.circuit.library.MCXRecursive.label" signature="property label">
  ...
  <Function id="qiskit.circuit.library.MCXRecursive.name" signature="property name">
  ...
  <Function id="qiskit.circuit.library.MCXRecursive.num_ancilla_qubits" signature="property num_ancilla_qubits">
    The number of ancilla qubits.
  </Function>

  ### num\_ctrl\_qubits

  <Function id="qiskit.circuit.library.MCXRecursive.num_ctrl_qubits" signature="property num_ctrl_qubits">
  ...
  <Function id="qiskit.circuit.library.MCXRecursive.params" signature="property params">
  ...
  <Function id="qiskit.circuit.library.MCXRecursive.unit" signature="property unit">
