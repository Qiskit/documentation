# qiskit.providers.aer.library.SaveExpectationValueVariance[¶](#qiskit-providers-aer-library-saveexpectationvaluevariance "Permalink to this headline")
...
| [`c_if`](#qiskit.providers.aer.library.SaveExpectationValueVariance.c_if "qiskit.providers.aer.library.SaveExpectationValueVariance.c_if")(classical, val)                                            | Add classical condition on register or cbit classical and value val.            |
...
| [`label`](#qiskit.providers.aer.library.SaveExpectationValueVariance.label "qiskit.providers.aer.library.SaveExpectationValueVariance.label")                            | Return instruction label                                                      |
