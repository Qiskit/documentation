...
<Class id="qiskit.providers.ibmq.IBMQAccountCredentialsInvalidFormat" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-ibmq-provider/tree/stable/0.15/qiskit/providers/ibmq/exceptions.py" signature="IBMQAccountCredentialsInvalidFormat(*message)">
