...
<Class id="qiskit.opflow.gradients.NaturalGradient" github="https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/opflow/gradients/natural_gradient.py" signature="NaturalGradient(grad_method='lin_comb', qfi_method='lin_comb_full', regularization=None, **kwargs)">
  ...
  *   **kwargs** (*dict*) – Optional parameters for a CircuitGradient
  ...
  <Function id="qiskit.opflow.gradients.NaturalGradient.gradient_wrapper" name="gradient_wrapper" signature="gradient_wrapper(operator, bind_params, grad_params=None, backend=None, expectation=None)">
