...
<Class id="qiskit.aqua.operators.gradients.CircuitQFI" github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/aqua/operators/gradients/circuit_qfis/circuit_qfi.py" signature="CircuitQFI">
  ...
  <Function id="qiskit.aqua.operators.gradients.CircuitQFI.__init__" name="__init__" signature="__init__()">
  ...
  <Function id="qiskit.aqua.operators.gradients.CircuitQFI.convert" name="convert" signature="abstract convert(operator, params=None)">
    **Parameters**
