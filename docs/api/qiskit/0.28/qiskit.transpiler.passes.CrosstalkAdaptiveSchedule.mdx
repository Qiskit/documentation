...
<Class id="qiskit.transpiler.passes.CrosstalkAdaptiveSchedule" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/transpiler/passes/optimization/crosstalk_adaptive_schedule.py" signature="CrosstalkAdaptiveSchedule(*args, **kwargs)">
  ...
  **ImportError** – if unable to import z3 solver
  ...
  <Function id="qiskit.transpiler.passes.CrosstalkAdaptiveSchedule.__init__" signature="__init__(backend_prop, crosstalk_prop, weight_factor=0.5, measured_qubits=None)">
    CrosstalkAdaptiveSchedule initializer.
  ...
  <Function id="qiskit.transpiler.passes.CrosstalkAdaptiveSchedule.is_analysis_pass" signature="property is_analysis_pass">
  ...
  <Function id="qiskit.transpiler.passes.CrosstalkAdaptiveSchedule.is_transformation_pass" signature="property is_transformation_pass">
