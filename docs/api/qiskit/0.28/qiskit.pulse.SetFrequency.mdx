...
<Class id="qiskit.pulse.SetFrequency" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/pulse/instructions/frequency.py" signature="SetFrequency(frequency, channel, name=None)">
...
$$
  ...
  *   **name** (`Optional`\[`str`]) – Name of this set channel frequency instruction.
  ...
  <Function id="qiskit.pulse.SetFrequency.is_parameterized" signature="is_parameterized()">
  ...
  <Function id="qiskit.pulse.SetFrequency.parameters" signature="property parameters">
