...
<Class id="qiskit.opflow.converters.PauliBasisChange" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/opflow/converters/pauli_basis_change.py" signature="PauliBasisChange(destination_basis=None, traverse=True, replacement_fn=None)">
  ...
  *   **replacement\_fn** (`Optional`\[`Callable`]) –
  ...
  <Function id="qiskit.opflow.converters.PauliBasisChange.destination" signature="property destination">
