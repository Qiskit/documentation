...
<Class id="qiskit.opflow.evolutions.TrotterizationBase" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/opflow/evolutions/trotterizations/trotterization_base.py" signature="TrotterizationBase(reps=1)">
  ...
  <Function id="qiskit.opflow.evolutions.TrotterizationBase.__init__" name="__init__" signature="__init__(reps=1)">
  ...
  <Function id="qiskit.opflow.evolutions.TrotterizationBase.convert" name="convert" signature="abstract convert(operator)">
  ...
  <Function id="qiskit.opflow.evolutions.TrotterizationBase.reps" name="reps" signature="property reps">
