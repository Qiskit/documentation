...
<Class id="qiskit.providers.aer.QasmSimulator" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-aer/tree/stable/0.8/qiskit/providers/aer/backends/qasm_simulator.py" signature="QasmSimulator(configuration=None, properties=None, provider=None, **backend_options)">
  ...
  **Raises**
  ...
  <Function id="qiskit.providers.aer.QasmSimulator.__init__" name="__init__" signature="__init__(configuration=None, properties=None, provider=None, **backend_options)">
    Aer class for backends.
  ...
  <Function id="qiskit.providers.aer.QasmSimulator.available_methods" name="available_methods" signature="available_methods()">
    Return the available simulation methods.
  </Function>

  ### clear\_options

  <Function id="qiskit.providers.aer.QasmSimulator.clear_options" name="clear_options" signature="clear_options()">
    Reset the simulator options to default values.
  </Function>

  ### configuration

  <Function id="qiskit.providers.aer.QasmSimulator.configuration" name="configuration" signature="configuration()">
  ...
  <Function id="qiskit.providers.aer.QasmSimulator.defaults" name="defaults" signature="defaults()">
  ...
  <Function id="qiskit.providers.aer.QasmSimulator.from_backend" name="from_backend" signature="classmethod from_backend(backend, **options)">
    Initialize simulator from backend.
  </Function>

  ### name

  <Function id="qiskit.providers.aer.QasmSimulator.name" name="name" signature="name()">
  ...
  <Function id="qiskit.providers.aer.QasmSimulator.options" name="options" signature="property options">
  ...
  <Function id="qiskit.providers.aer.QasmSimulator.properties" name="properties" signature="properties()">
  ...
  <Function id="qiskit.providers.aer.QasmSimulator.provider" name="provider" signature="provider()">
  ...
  <Function id="qiskit.providers.aer.QasmSimulator.run" name="run" signature="run(circuits, backend_options=None, validate=False, **run_options)">
  ...
  <Function id="qiskit.providers.aer.QasmSimulator.set_option" name="set_option" signature="set_option(key, value)">
  ...
  <Function id="qiskit.providers.aer.QasmSimulator.set_options" name="set_options" signature="set_options(**fields)">
  ...
  <Function id="qiskit.providers.aer.QasmSimulator.status" name="status" signature="status()">
