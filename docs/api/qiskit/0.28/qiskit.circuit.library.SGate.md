# qiskit.circuit.library.SGate[¶](#qiskit-circuit-library-sgate "Permalink to this headline")
...
| [`c_if`](#qiskit.circuit.library.SGate.c_if "qiskit.circuit.library.SGate.c_if")(classical, val)                                            | Add classical condition on register or cbit classical and value val.     |
...
| [`soft_compare`](#qiskit.circuit.library.SGate.soft_compare "qiskit.circuit.library.SGate.soft_compare")(other)                             | Soft comparison between gates.                                           |
| [`to_matrix`](#qiskit.circuit.library.SGate.to_matrix "qiskit.circuit.library.SGate.to_matrix")()                                           | Return a Numpy.array for the gate unitary matrix.                        |
...
| [`label`](#qiskit.circuit.library.SGate.label "qiskit.circuit.library.SGate.label")                            | Return instruction label                                                      |
