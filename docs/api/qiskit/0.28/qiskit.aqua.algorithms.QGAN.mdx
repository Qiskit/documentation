...
<Class id="qiskit.aqua.algorithms.QGAN" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/aqua/algorithms/distribution_learners/qgan.py" signature="QGAN(data, bounds=None, num_qubits=None, batch_size=500, num_epochs=3000, seed=7, discriminator=None, generator=None, tol_rel_ent=None, snapshot_dir=None, quantum_instance=None)">
  ...
  **Raises**
  ...
  <Function id="qiskit.aqua.algorithms.QGAN.backend" signature="property backend">
    Returns backend.
  ...
  <Function id="qiskit.aqua.algorithms.QGAN.d_loss" signature="property d_loss">
  ...
  <Function id="qiskit.aqua.algorithms.QGAN.discriminator" signature="property discriminator">
    Returns discriminator
  </Function>

  ### g\_loss

  <Function id="qiskit.aqua.algorithms.QGAN.g_loss" signature="property g_loss">
  ...
  <Function id="qiskit.aqua.algorithms.QGAN.generator" signature="property generator">
    Returns generator
  </Function>
  ...
  <Function id="qiskit.aqua.algorithms.QGAN.quantum_instance" signature="property quantum_instance">
  ...
  <Function id="qiskit.aqua.algorithms.QGAN.random" signature="property random">
    Return a numpy random.
  </Function>

  ### rel\_entr

  <Function id="qiskit.aqua.algorithms.QGAN.rel_entr" signature="property rel_entr">
  ...
  <Function id="qiskit.aqua.algorithms.QGAN.seed" signature="property seed">
    Returns random seed
  </Function>
  ...
  <Function id="qiskit.aqua.algorithms.QGAN.tol_rel_ent" signature="property tol_rel_ent">
