...
<Function id="qiskit.aqua.utils.name_args" github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/aqua/utils/name_unnamed_args.py" signature="name_args(mapping, skip=0)">
