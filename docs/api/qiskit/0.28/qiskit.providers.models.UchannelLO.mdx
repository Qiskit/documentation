...
<Class id="qiskit.providers.models.UchannelLO" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/providers/models/backendconfiguration.py" signature="UchannelLO(q, scale)">
  ...
  **QiskitError** – If q is \< 0
  ...
  <Function id="qiskit.providers.models.UchannelLO.__init__" name="__init__" signature="__init__(q, scale)">
    Initialize a UchannelLOSchema object
  ...
  <Function id="qiskit.providers.models.UchannelLO.from_dict" name="from_dict" signature="classmethod from_dict(data)">
  ...
  <Function id="qiskit.providers.models.UchannelLO.to_dict" name="to_dict" signature="to_dict()">
