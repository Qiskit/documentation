---
title: marginal_counts (v0.28)
description: API reference for qiskit.ignis.verification.marginal_counts in qiskit v0.28
in_page_toc_min_heading_level: 1
python_api_type: function
python_api_name: qiskit.ignis.verification.marginal_counts
---

<span id="qiskit-ignis-verification-marginal-counts" />

# qiskit.ignis.verification.marginal\_counts

<Function id="qiskit.ignis.verification.marginal_counts" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-ignis/tree/stable/0.6/qiskit/ignis/verification/tomography/data.py" signature="marginal_counts(counts, meas_qubits=True, pad_zeros=False)">
