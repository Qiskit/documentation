---
title: IBMQFactory (v0.28)
description: API reference for qiskit.providers.ibmq.IBMQFactory in qiskit v0.28
...
<Class id="qiskit.providers.ibmq.IBMQFactory" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-ibmq-provider/tree/stable/0.15/qiskit/providers/ibmq/ibmqfactory.py" signature="IBMQFactory" modifiers="class">
