...
| [`pauli`](#qiskit.circuit.library.ExcitationPreserving.pauli "qiskit.circuit.library.ExcitationPreserving.pauli")(pauli\_string, qubits)                                                                          | Apply [`PauliGate`](qiskit.circuit.library.PauliGate#qiskit.circuit.library.PauliGate "qiskit.circuit.library.PauliGate").          |
