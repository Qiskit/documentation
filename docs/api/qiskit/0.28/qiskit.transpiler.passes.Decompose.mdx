...
<Class id="qiskit.transpiler.passes.Decompose" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/transpiler/passes/basis/decompose.py" signature="Decompose(gate=None)">
  ...
  **gate** (`Optional`\[`Type`\[`Gate`]]) – gate to decompose.
  ...
  <Function id="qiskit.transpiler.passes.Decompose.is_analysis_pass" signature="property is_analysis_pass">
  ...
  <Function id="qiskit.transpiler.passes.Decompose.is_transformation_pass" signature="property is_transformation_pass">
