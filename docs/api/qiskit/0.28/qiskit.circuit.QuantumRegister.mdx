...
<Class id="qiskit.circuit.QuantumRegister" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/circuit/quantumregister.py" signature="QuantumRegister(size=None, name=None, bits=None)">
  ...
  *   **CircuitError** – if `bits` contained bits of an incorrect type.
  ...
  <Function id="qiskit.circuit.QuantumRegister.__init__" name="__init__" signature="__init__(size=None, name=None, bits=None)">
    Create a new generic register.
  ...
  <Attribute id="qiskit.circuit.QuantumRegister.bit_type" name="bit_type">
    alias of [`Qubit`](qiskit.circuit.Qubit "qiskit.circuit.Qubit")
  </Attribute>

  ### name

  <Function id="qiskit.circuit.QuantumRegister.name" name="name" signature="property name">
  ...
  <Function id="qiskit.circuit.QuantumRegister.size" name="size" signature="property size">
