...
<Class id="qiskit.chemistry.algorithms.BOPESSampler" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/chemistry/algorithms/pes_samplers/bopes_sampler.py" signature="BOPESSampler(gss, tolerance=0.001, bootstrap=True, num_bootstrap=None, extrapolator=None)">
  ...
  **Raises**
  ...
  <Function id="qiskit.chemistry.algorithms.BOPESSampler.__init__" name="__init__" signature="__init__(gss, tolerance=0.001, bootstrap=True, num_bootstrap=None, extrapolator=None)">
    **Parameters**
  ...
  <Function id="qiskit.chemistry.algorithms.BOPESSampler.sample" name="sample" signature="sample(driver, points)">
