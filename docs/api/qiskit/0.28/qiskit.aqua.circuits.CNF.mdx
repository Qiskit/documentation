...
<Class id="qiskit.aqua.circuits.CNF" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/aqua/circuits/boolean_logical_circuits.py" signature="CNF(ast, num_vars=None)" modifiers="class">
  ...
  **Raises**
  ...
  <Function id="qiskit.aqua.circuits.CNF.ancillary_register" signature="ancillary_register" modifiers="property">
    returns ancillary register
  </Function>

  ### clause\_register

  <Function id="qiskit.aqua.circuits.CNF.clause_register" signature="clause_register" modifiers="property">
  ...
  <Function id="qiskit.aqua.circuits.CNF.num_clauses" signature="num_clauses" modifiers="property">
    returns num clauses
  </Function>

  ### num\_variables

  <Function id="qiskit.aqua.circuits.CNF.num_variables" signature="num_variables" modifiers="property">
    return num variables
  </Function>

  ### output\_register

  <Function id="qiskit.aqua.circuits.CNF.output_register" signature="output_register" modifiers="property">
    returns output register
  </Function>

  ### variable\_register

  <Function id="qiskit.aqua.circuits.CNF.variable_register" signature="variable_register" modifiers="property">
