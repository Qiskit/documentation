...
<Class id="qiskit.aqua.circuits.WeightedSumOperator" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/aqua/circuits/weighted_sum_operator.py" signature="WeightedSumOperator(num_state_qubits, weights, i_state=None, i_sum=None)">
  ...
  **Raises**
  ...
  <Function id="qiskit.aqua.circuits.WeightedSumOperator.get_required_sum_qubits" signature="static get_required_sum_qubits(weights)">
    get required sum qubits
  </Function>

  ### num\_carry\_qubits

  <Function id="qiskit.aqua.circuits.WeightedSumOperator.num_carry_qubits" signature="property num_carry_qubits">
    returns num carry qubits
  </Function>

  ### num\_state\_qubits

  <Function id="qiskit.aqua.circuits.WeightedSumOperator.num_state_qubits" signature="property num_state_qubits">
    returns num state qubits
  </Function>

  ### num\_sum\_qubits

  <Function id="qiskit.aqua.circuits.WeightedSumOperator.num_sum_qubits" signature="property num_sum_qubits">
    returns num sum qubits
  </Function>

  ### num\_target\_qubits

  <Function id="qiskit.aqua.circuits.WeightedSumOperator.num_target_qubits" signature="property num_target_qubits">
  ...
  <Function id="qiskit.aqua.circuits.WeightedSumOperator.weights" signature="property weights">
    returns weights
  </Function>
</Class>
