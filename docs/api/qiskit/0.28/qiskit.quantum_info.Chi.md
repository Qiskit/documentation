# qiskit.quantum\_info.Chi[¶](#qiskit-quantum-info-chi "Permalink to this headline")
...
| [`settings`](#qiskit.quantum_info.Chi.settings "qiskit.quantum_info.Chi.settings")       | Return operator settings.                                            |
