...
<Class id="qiskit.opflow.expectations.AerPauliExpectation" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/opflow/expectations/aer_pauli_expectation.py" signature="AerPauliExpectation">
  ...
  <Function id="qiskit.opflow.expectations.AerPauliExpectation.__init__" name="__init__" signature="__init__()">
  ...
  <Function id="qiskit.opflow.expectations.AerPauliExpectation.compute_variance" name="compute_variance" signature="compute_variance(exp_op)">
  ...
  <Function id="qiskit.opflow.expectations.AerPauliExpectation.convert" name="convert" signature="convert(operator)">
