...
<Class id="qiskit.pulse.GaussianSquare" github="https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/pulse/library/parametric_pulses.py" signature="GaussianSquare(duration, amp, sigma, width=None, risefall_sigma_ratio=None, name=None)">
...
$$
  ...
  *   **name** (`Optional`\[`str`]) – Display name for this pulse envelope.
  ...
  <Function id="qiskit.pulse.GaussianSquare.__init__" name="__init__" signature="__init__(duration, amp, sigma, width=None, risefall_sigma_ratio=None, name=None)">
    Initialize the gaussian square pulse.
  ...
  <Function id="qiskit.pulse.GaussianSquare.risefall_sigma_ratio" name="risefall_sigma_ratio" signature="property risefall_sigma_ratio">
