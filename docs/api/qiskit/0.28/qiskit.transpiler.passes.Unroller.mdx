...
<Class id="qiskit.transpiler.passes.Unroller" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/transpiler/passes/basis/unroller.py" signature="Unroller(*args, **kwargs)" modifiers="class">
  ...
  **basis** (*list\[str] or None*) – Target basis names to unroll to, e.g. \[‘u3’, ‘cx’] . If None, does not unroll any gate.
  ...
  <Function id="qiskit.transpiler.passes.Unroller.is_analysis_pass" signature="is_analysis_pass" modifiers="property">
  ...
  <Function id="qiskit.transpiler.passes.Unroller.is_transformation_pass" signature="is_transformation_pass" modifiers="property">
