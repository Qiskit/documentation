---
title: UnivariatePiecewiseLinearObjective (v0.28)
description: API reference for qiskit.aqua.components.uncertainty_problems.UnivariatePiecewiseLinearObjective in qiskit v0.28
