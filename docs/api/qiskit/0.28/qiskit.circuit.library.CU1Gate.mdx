...
<Class id="qiskit.circuit.library.CU1Gate" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/circuit/library/standard_gates/u1.py" signature="CU1Gate(theta, label=None, ctrl_state=None)">
  Controlled-U1 gate.
...
$$
  ...
  <Function id="qiskit.circuit.library.CU1Gate.__init__" name="__init__" signature="__init__(theta, label=None, ctrl_state=None)">
    Create new CU1 gate.
  </Function>
  ...
  <Function id="qiskit.circuit.library.CU1Gate.add_decomposition" name="add_decomposition" signature="add_decomposition(decomposition)">
    Add a decomposition of the instruction to the SessionEquivalenceLibrary.
  </Function>

  ### assemble

  <Function id="qiskit.circuit.library.CU1Gate.assemble" name="assemble" signature="assemble()">
    Assemble a QasmQobjInstruction
  </Function>

  ### broadcast\_arguments

  <Function id="qiskit.circuit.library.CU1Gate.broadcast_arguments" name="broadcast_arguments" signature="broadcast_arguments(qargs, cargs)">
  ...
  <Function id="qiskit.circuit.library.CU1Gate.c_if" name="c_if" signature="c_if(classical, val)">
    Add classical condition on register or cbit classical and value val.
  </Function>

  ### control

  <Function id="qiskit.circuit.library.CU1Gate.control" name="control" signature="control(num_ctrl_qubits=1, label=None, ctrl_state=None)">
  ...
  <Function id="qiskit.circuit.library.CU1Gate.copy" name="copy" signature="copy(name=None)">
  ...
  <Function id="qiskit.circuit.library.CU1Gate.ctrl_state" name="ctrl_state" signature="property ctrl_state">
  ...
  <Function id="qiskit.circuit.library.CU1Gate.decompositions" name="decompositions" signature="property decompositions">
    Get the decompositions of the instruction from the SessionEquivalenceLibrary.
  </Function>

  ### definition

  <Function id="qiskit.circuit.library.CU1Gate.definition" name="definition" signature="property definition">
  ...
  <Function id="qiskit.circuit.library.CU1Gate.duration" name="duration" signature="property duration">
    Get the duration.
  </Function>

  ### inverse

  <Function id="qiskit.circuit.library.CU1Gate.inverse" name="inverse" signature="inverse()">
    Return inverted CU1 gate ($CU1(\lambda){\dagger} = CU1(-\lambda)$)
  </Function>

  ### is\_parameterized

  <Function id="qiskit.circuit.library.CU1Gate.is_parameterized" name="is_parameterized" signature="is_parameterized()">
    Return True .IFF. instruction is parameterized else False
  </Function>

  ### label

  <Function id="qiskit.circuit.library.CU1Gate.label" name="label" signature="property label">
  ...
  <Function id="qiskit.circuit.library.CU1Gate.mirror" name="mirror" signature="mirror()">
  ...
  <Function id="qiskit.circuit.library.CU1Gate.name" name="name" signature="property name">
  ...
  <Function id="qiskit.circuit.library.CU1Gate.num_ctrl_qubits" name="num_ctrl_qubits" signature="property num_ctrl_qubits">
  ...
  <Function id="qiskit.circuit.library.CU1Gate.params" name="params" signature="property params">
  ...
  <Function id="qiskit.circuit.library.CU1Gate.power" name="power" signature="power(exponent)">
  ...
  <Function id="qiskit.circuit.library.CU1Gate.qasm" name="qasm" signature="qasm()">
  ...
  <Function id="qiskit.circuit.library.CU1Gate.repeat" name="repeat" signature="repeat(n)">
  ...
  <Function id="qiskit.circuit.library.CU1Gate.reverse_ops" name="reverse_ops" signature="reverse_ops()">
  ...
  <Function id="qiskit.circuit.library.CU1Gate.soft_compare" name="soft_compare" signature="soft_compare(other)">
  ...
  <Function id="qiskit.circuit.library.CU1Gate.to_matrix" name="to_matrix" signature="to_matrix()">
  ...
  <Function id="qiskit.circuit.library.CU1Gate.unit" name="unit" signature="property unit">
    Get the time unit of duration.
  </Function>

  ### validate\_parameter

  <Function id="qiskit.circuit.library.CU1Gate.validate_parameter" name="validate_parameter" signature="validate_parameter(parameter)">
