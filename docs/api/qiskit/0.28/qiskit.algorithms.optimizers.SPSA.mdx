...
<Class id="qiskit.algorithms.optimizers.SPSA" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/algorithms/optimizers/spsa.py" signature="SPSA(maxiter=100, blocking=False, allowed_increase=None, trust_region=False, learning_rate=None, perturbation=None, last_avg=1, resamplings=1, perturbation_dims=None, second_order=False, regularization=None, hessian_delay=0, lse_solver=None, initial_hessian=None, callback=None)" modifiers="class">
  ...
  **ValueError** – If `learning_rate` or `perturbation` is an array with less elements than the number of iterations.
  ...
  <Function id="qiskit.algorithms.optimizers.SPSA.bounds_support_level" signature="bounds_support_level" modifiers="property">
...
$$
  ...
  <Function id="qiskit.algorithms.optimizers.SPSA.gradient_support_level" signature="gradient_support_level" modifiers="property">
    Returns gradient support level
  </Function>

  ### initial\_point\_support\_level

  <Function id="qiskit.algorithms.optimizers.SPSA.initial_point_support_level" signature="initial_point_support_level" modifiers="property">
    Returns initial point support level
  </Function>

  ### is\_bounds\_ignored

  <Function id="qiskit.algorithms.optimizers.SPSA.is_bounds_ignored" signature="is_bounds_ignored" modifiers="property">
    Returns is bounds ignored
  </Function>

  ### is\_bounds\_required

  <Function id="qiskit.algorithms.optimizers.SPSA.is_bounds_required" signature="is_bounds_required" modifiers="property">
    Returns is bounds required
  </Function>

  ### is\_bounds\_supported

  <Function id="qiskit.algorithms.optimizers.SPSA.is_bounds_supported" signature="is_bounds_supported" modifiers="property">
    Returns is bounds supported
  </Function>

  ### is\_gradient\_ignored

  <Function id="qiskit.algorithms.optimizers.SPSA.is_gradient_ignored" signature="is_gradient_ignored" modifiers="property">
    Returns is gradient ignored
  </Function>

  ### is\_gradient\_required

  <Function id="qiskit.algorithms.optimizers.SPSA.is_gradient_required" signature="is_gradient_required" modifiers="property">
    Returns is gradient required
  </Function>

  ### is\_gradient\_supported

  <Function id="qiskit.algorithms.optimizers.SPSA.is_gradient_supported" signature="is_gradient_supported" modifiers="property">
    Returns is gradient supported
  </Function>

  ### is\_initial\_point\_ignored

  <Function id="qiskit.algorithms.optimizers.SPSA.is_initial_point_ignored" signature="is_initial_point_ignored" modifiers="property">
    Returns is initial point ignored
  </Function>

  ### is\_initial\_point\_required

  <Function id="qiskit.algorithms.optimizers.SPSA.is_initial_point_required" signature="is_initial_point_required" modifiers="property">
    Returns is initial point required
  </Function>

  ### is\_initial\_point\_supported

  <Function id="qiskit.algorithms.optimizers.SPSA.is_initial_point_supported" signature="is_initial_point_supported" modifiers="property">
  ...
  <Function id="qiskit.algorithms.optimizers.SPSA.setting" signature="setting" modifiers="property">
    Return setting
  </Function>

  ### settings

  <Function id="qiskit.algorithms.optimizers.SPSA.settings" signature="settings" modifiers="property">
