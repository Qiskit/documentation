...
<Class id="qiskit.transpiler.passes.ValidatePulseGates" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/transpiler/passes/scheduling/instruction_alignment.py" signature="ValidatePulseGates(granularity=1, min_length=1)">
  ...
  *   **min\_length** (`int`) – Integer number representing the minimum data point length to define the pulse gate in units of `dt`. This value depends on the control electronics of your quantum processor.
  ...
  <Function id="qiskit.transpiler.passes.ValidatePulseGates.is_analysis_pass" signature="property is_analysis_pass">
  ...
  <Function id="qiskit.transpiler.passes.ValidatePulseGates.is_transformation_pass" signature="property is_transformation_pass">
