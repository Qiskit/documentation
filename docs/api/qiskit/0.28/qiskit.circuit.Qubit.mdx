...
<Class id="qiskit.circuit.Qubit" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/circuit/quantumregister.py" signature="Qubit(register=None, index=None)">
  ...
  **CircuitError** – if the provided register is not a valid [`QuantumRegister`](qiskit.circuit.QuantumRegister "qiskit.circuit.QuantumRegister")
  ...
  <Function id="qiskit.circuit.Qubit.__init__" name="__init__" signature="__init__(register=None, index=None)">
    Creates a qubit.
  ...
  <Function id="qiskit.circuit.Qubit.index" name="index" signature="property index">
    Get bit’s index.
  </Function>

  ### register

  <Function id="qiskit.circuit.Qubit.register" name="register" signature="property register">
    Get bit’s register.
  </Function>
</Class>
