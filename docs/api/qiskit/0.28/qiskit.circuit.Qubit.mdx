...
<Class id="qiskit.circuit.Qubit" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/circuit/quantumregister.py" signature="Qubit(register=None, index=None)" modifiers="class">
  ...
  **CircuitError** – if the provided register is not a valid [`QuantumRegister`](qiskit.circuit.QuantumRegister "qiskit.circuit.QuantumRegister")
  ...
  <Function id="qiskit.circuit.Qubit.index" signature="index" modifiers="property">
    Get bit’s index.
  </Function>

  ### register

  <Function id="qiskit.circuit.Qubit.register" signature="register" modifiers="property">
    Get bit’s register.
  </Function>
</Class>
