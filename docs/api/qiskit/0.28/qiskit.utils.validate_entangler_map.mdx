---
title: validate_entangler_map (v0.28)
description: API reference for qiskit.utils.validate_entangler_map in qiskit v0.28
in_page_toc_min_heading_level: 1
python_api_type: function
python_api_name: qiskit.utils.validate_entangler_map
---

<span id="qiskit-utils-validate-entangler-map" />

# qiskit.utils.validate\_entangler\_map

<Function id="qiskit.utils.validate_entangler_map" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/utils/entangler_map.py" signature="validate_entangler_map(entangler_map, num_qubits, allow_double_entanglement=False)">
