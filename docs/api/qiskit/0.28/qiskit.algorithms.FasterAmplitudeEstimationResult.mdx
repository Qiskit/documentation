...
<Class id="qiskit.algorithms.FasterAmplitudeEstimationResult" github="https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/algorithms/amplitude_estimators/fae.py" signature="FasterAmplitudeEstimationResult">
