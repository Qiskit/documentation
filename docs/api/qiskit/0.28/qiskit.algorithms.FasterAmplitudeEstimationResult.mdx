...
<Class id="qiskit.algorithms.FasterAmplitudeEstimationResult" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/algorithms/amplitude_estimators/fae.py" signature="FasterAmplitudeEstimationResult">
  The result object for the Faster Amplitude Estimation algorithm.

  ### \_\_init\_\_

  <Function id="qiskit.algorithms.FasterAmplitudeEstimationResult.__init__" name="__init__" signature="__init__()">
  ...
  <Function id="qiskit.algorithms.FasterAmplitudeEstimationResult.circuit_results" name="circuit_results" signature="property circuit_results">
  ...
  <Function id="qiskit.algorithms.FasterAmplitudeEstimationResult.combine" name="combine" signature="combine(result)">
  ...
  <Function id="qiskit.algorithms.FasterAmplitudeEstimationResult.confidence_interval" name="confidence_interval" signature="property confidence_interval">
  ...
  <Function id="qiskit.algorithms.FasterAmplitudeEstimationResult.confidence_interval_processed" name="confidence_interval_processed" signature="property confidence_interval_processed">
  ...
  <Function id="qiskit.algorithms.FasterAmplitudeEstimationResult.estimation" name="estimation" signature="property estimation">
  ...
  <Function id="qiskit.algorithms.FasterAmplitudeEstimationResult.estimation_processed" name="estimation_processed" signature="property estimation_processed">
  ...
  <Function id="qiskit.algorithms.FasterAmplitudeEstimationResult.num_first_state_steps" name="num_first_state_steps" signature="property num_first_state_steps">
  ...
  <Function id="qiskit.algorithms.FasterAmplitudeEstimationResult.num_oracle_queries" name="num_oracle_queries" signature="property num_oracle_queries">
  ...
  <Function id="qiskit.algorithms.FasterAmplitudeEstimationResult.num_steps" name="num_steps" signature="property num_steps">
  ...
  <Function id="qiskit.algorithms.FasterAmplitudeEstimationResult.post_processing" name="post_processing" signature="property post_processing">
  ...
  <Function id="qiskit.algorithms.FasterAmplitudeEstimationResult.shots" name="shots" signature="property shots">
  ...
  <Function id="qiskit.algorithms.FasterAmplitudeEstimationResult.success_probability" name="success_probability" signature="property success_probability">
  ...
  <Function id="qiskit.algorithms.FasterAmplitudeEstimationResult.theta_intervals" name="theta_intervals" signature="property theta_intervals">
