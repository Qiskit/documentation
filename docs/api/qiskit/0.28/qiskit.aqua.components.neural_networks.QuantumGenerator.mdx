...
<Class id="qiskit.aqua.components.neural_networks.QuantumGenerator" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/aqua/components/neural_networks/quantum_generator.py" signature="QuantumGenerator(bounds, num_qubits, generator_circuit=None, init_params=None, optimizer=None, gradient_function=None, snapshot_dir=None)">
  Quantum Generator.
  ...
  **Raises**
  ...
  <Function id="qiskit.aqua.components.neural_networks.QuantumGenerator.__init__" name="__init__" signature="__init__(bounds, num_qubits, generator_circuit=None, init_params=None, optimizer=None, gradient_function=None, snapshot_dir=None)">
    **Parameters**
  ...
  <Function id="qiskit.aqua.components.neural_networks.QuantumGenerator.construct_circuit" name="construct_circuit" signature="construct_circuit(params=None)">
  ...
  <Function id="qiskit.aqua.components.neural_networks.QuantumGenerator.discriminator" name="discriminator" signature="property discriminator">
    Get discriminator.
  ...
  <Function id="qiskit.aqua.components.neural_networks.QuantumGenerator.get_output" name="get_output" signature="get_output(quantum_instance, params=None, shots=None)">
  ...
  <Function id="qiskit.aqua.components.neural_networks.QuantumGenerator.loss" name="loss" signature="loss(x, weights)">
  ...
  <Function id="qiskit.aqua.components.neural_networks.QuantumGenerator.optimizer" name="optimizer" signature="property optimizer">
    Get optimizer.
  ...
  <Function id="qiskit.aqua.components.neural_networks.QuantumGenerator.parameter_values" name="parameter_values" signature="property parameter_values">
  ...
  <Function id="qiskit.aqua.components.neural_networks.QuantumGenerator.seed" name="seed" signature="property seed">
    Get seed.
  ...
  <Function id="qiskit.aqua.components.neural_networks.QuantumGenerator.set_discriminator" name="set_discriminator" signature="set_discriminator(discriminator)">
  ...
  <Function id="qiskit.aqua.components.neural_networks.QuantumGenerator.set_seed" name="set_seed" signature="set_seed(seed)">
    Set seed.
  ...
  <Function id="qiskit.aqua.components.neural_networks.QuantumGenerator.train" name="train" signature="train(quantum_instance=None, shots=None)">
