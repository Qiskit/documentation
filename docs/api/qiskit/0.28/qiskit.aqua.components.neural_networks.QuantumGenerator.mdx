...
<Class id="qiskit.aqua.components.neural_networks.QuantumGenerator" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/aqua/components/neural_networks/quantum_generator.py" signature="QuantumGenerator(bounds, num_qubits, generator_circuit=None, init_params=None, optimizer=None, gradient_function=None, snapshot_dir=None)" modifiers="class">
  ...
  **Raises**
  ...
  <Function id="qiskit.aqua.components.neural_networks.QuantumGenerator.__init__" signature="__init__(bounds, num_qubits, generator_circuit=None, init_params=None, optimizer=None, gradient_function=None, snapshot_dir=None)">
    **Parameters**
  ...
  <Function id="qiskit.aqua.components.neural_networks.QuantumGenerator.discriminator" signature="discriminator" modifiers="property">
    Get discriminator.
  ...
  <Function id="qiskit.aqua.components.neural_networks.QuantumGenerator.optimizer" signature="optimizer" modifiers="property">
    Get optimizer.
  ...
  <Function id="qiskit.aqua.components.neural_networks.QuantumGenerator.parameter_values" signature="parameter_values" modifiers="property">
  ...
  <Function id="qiskit.aqua.components.neural_networks.QuantumGenerator.seed" signature="seed" modifiers="property">
    Get seed.
