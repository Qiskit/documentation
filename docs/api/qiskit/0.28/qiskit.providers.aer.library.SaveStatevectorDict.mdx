...
<Class id="qiskit.providers.aer.library.SaveStatevectorDict" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-aer/tree/stable/0.8/qiskit/providers/aer/library/save_instructions/save_statevector.py" signature="SaveStatevectorDict(num_qubits, label='statevector_dict', pershot=False, conditional=False)" modifiers="class">
  ...
  *   **conditional** (*bool*) – if True save data conditional on the current classical register values \[Default: False].
  ...
  <Function id="qiskit.providers.aer.library.SaveStatevectorDict.decompositions" signature="decompositions" modifiers="property">
    Get the decompositions of the instruction from the SessionEquivalenceLibrary.
  </Function>

  ### definition

  <Function id="qiskit.providers.aer.library.SaveStatevectorDict.definition" signature="definition" modifiers="property">
    Return definition in terms of other basic gates.
  </Function>

  ### duration

  <Function id="qiskit.providers.aer.library.SaveStatevectorDict.duration" signature="duration" modifiers="property">
    Get the duration.
  </Function>
  ...
  <Function id="qiskit.providers.aer.library.SaveStatevectorDict.label" signature="label" modifiers="property">
  ...
  <Function id="qiskit.providers.aer.library.SaveStatevectorDict.params" signature="params" modifiers="property">
  ...
  <Function id="qiskit.providers.aer.library.SaveStatevectorDict.unit" signature="unit" modifiers="property">
