...
<Class id="qiskit.opflow.evolutions.TrotterizationFactory" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/opflow/evolutions/trotterizations/trotterization_factory.py" signature="TrotterizationFactory">
  A factory for conveniently creating TrotterizationBase instances.

  ### \_\_init\_\_

  <Function id="qiskit.opflow.evolutions.TrotterizationFactory.__init__" name="__init__" signature="__init__()">
  ...
  <Function id="qiskit.opflow.evolutions.TrotterizationFactory.build" name="build" signature="static build(mode='trotter', reps=1)">
    A factory for conveniently creating TrotterizationBase instances.
