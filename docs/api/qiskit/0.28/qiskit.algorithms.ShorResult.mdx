...
<Class id="qiskit.algorithms.ShorResult" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/algorithms/factorizers/shor.py" signature="ShorResult" modifiers="class">
  ...
  <Function id="qiskit.algorithms.ShorResult.factors" signature="factors" modifiers="property">
    returns factors
  ...
  <Function id="qiskit.algorithms.ShorResult.successful_counts" signature="successful_counts" modifiers="property">
  ...
  <Function id="qiskit.algorithms.ShorResult.total_counts" signature="total_counts" modifiers="property">
