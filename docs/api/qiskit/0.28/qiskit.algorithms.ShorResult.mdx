...
<Class id="qiskit.algorithms.ShorResult" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/algorithms/factorizers/shor.py" signature="ShorResult">
  ...
  <Function id="qiskit.algorithms.ShorResult.factors" signature="property factors">
    returns factors
  ...
  <Function id="qiskit.algorithms.ShorResult.successful_counts" signature="property successful_counts">
  ...
  <Function id="qiskit.algorithms.ShorResult.total_counts" signature="property total_counts">
