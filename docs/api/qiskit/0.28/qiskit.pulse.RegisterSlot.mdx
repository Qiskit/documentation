...
<Class id="qiskit.pulse.RegisterSlot" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/pulse/channels.py" signature="RegisterSlot(index)">
  ...
  **index** (`int`) – Index of channel.
  ...
  <Function id="qiskit.pulse.RegisterSlot.index" signature="property index">
  ...
  <Function id="qiskit.pulse.RegisterSlot.name" signature="property name">
  ...
  <Function id="qiskit.pulse.RegisterSlot.parameters" signature="property parameters">
