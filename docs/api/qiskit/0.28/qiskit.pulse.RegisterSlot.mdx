...
<Class id="qiskit.pulse.RegisterSlot" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/pulse/channels.py" signature="RegisterSlot(index)" modifiers="class">
  ...
  **index** (`int`) – Index of channel.
  ...
  <Function id="qiskit.pulse.RegisterSlot.assign" signature="assign(parameter, value)">
  ...
  <Function id="qiskit.pulse.RegisterSlot.index" signature="index" modifiers="property">
  ...
  <Function id="qiskit.pulse.RegisterSlot.is_parameterized" signature="is_parameterized()">
  ...
  <Function id="qiskit.pulse.RegisterSlot.name" signature="name" modifiers="property">
  ...
  <Function id="qiskit.pulse.RegisterSlot.parameters" signature="parameters" modifiers="property">
