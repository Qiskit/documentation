...
<Class id="qiskit.pulse.RegisterSlot" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/pulse/channels.py" signature="RegisterSlot(index)">
  ...
  **index** (`int`) – Index of channel.
  ...
  <Function id="qiskit.pulse.RegisterSlot.__init__" name="__init__" signature="__init__(index)">
    Channel class.
  ...
  <Function id="qiskit.pulse.RegisterSlot.assign" name="assign" signature="assign(parameter, value)">
  ...
  <Function id="qiskit.pulse.RegisterSlot.index" name="index" signature="property index">
  ...
  <Function id="qiskit.pulse.RegisterSlot.is_parameterized" name="is_parameterized" signature="is_parameterized()">
  ...
  <Function id="qiskit.pulse.RegisterSlot.name" name="name" signature="property name">
  ...
  <Function id="qiskit.pulse.RegisterSlot.parameters" name="parameters" signature="property parameters">
