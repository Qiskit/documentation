...
<Class id="qiskit.quantum_info.Clifford" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/quantum_info/operators/symplectic/clifford.py" signature="Clifford(data, validate=True)">
  ...
  **References**
  ...
  <Function id="qiskit.quantum_info.Clifford.destabilizer" signature="property destabilizer">
    Return the destabilizer block of the StabilizerTable.
  </Function>

  ### dim

  <Function id="qiskit.quantum_info.Clifford.dim" signature="property dim">
  ...
  <Function id="qiskit.quantum_info.Clifford.from_circuit" signature="static from_circuit(circuit)">
  ...
  <Function id="qiskit.quantum_info.Clifford.from_dict" signature="static from_dict(obj)">
    Load a Clifford from a dictionary
  </Function>

  ### from\_label

  <Function id="qiskit.quantum_info.Clifford.from_label" signature="static from_label(label)">
  ...
  <Function id="qiskit.quantum_info.Clifford.num_qubits" signature="property num_qubits">
  ...
  <Function id="qiskit.quantum_info.Clifford.qargs" signature="property qargs">
  ...
  <Function id="qiskit.quantum_info.Clifford.settings" signature="property settings">
    Return operator settings.
  </Function>

  ### stabilizer

  <Function id="qiskit.quantum_info.Clifford.stabilizer" signature="property stabilizer">
    Return the stabilizer block of the StabilizerTable.
  </Function>

  ### table

  <Function id="qiskit.quantum_info.Clifford.table" signature="property table">
