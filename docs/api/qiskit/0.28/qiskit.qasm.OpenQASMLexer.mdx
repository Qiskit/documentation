...
<Class id="qiskit.qasm.OpenQASMLexer" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/qasm/pygments/lexer.py" signature="OpenQASMLexer(*args, **kwds)">
  ...
  <Function id="qiskit.qasm.OpenQASMLexer.__init__" name="__init__" signature="__init__(**options)">
  ...
  <Function id="qiskit.qasm.OpenQASMLexer.add_filter" name="add_filter" signature="add_filter(filter_, **options)">
    Add a new stream filter to this lexer.
  </Function>

  ### analyse\_text

  <Function id="qiskit.qasm.OpenQASMLexer.analyse_text" name="analyse_text" signature="static analyse_text(text)">
  ...
  <Function id="qiskit.qasm.OpenQASMLexer.get_tokens" name="get_tokens" signature="get_tokens(text, unfiltered=False)">
  ...
  <Function id="qiskit.qasm.OpenQASMLexer.get_tokens_unprocessed" name="get_tokens_unprocessed" signature="get_tokens_unprocessed(text, stack=('root'))">
