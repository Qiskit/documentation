...
<Class id="qiskit.circuit.Measure" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/circuit/measure.py" signature="Measure" modifiers="class">
  ...
  <Function id="qiskit.circuit.Measure.decompositions" signature="decompositions" modifiers="property">
    Get the decompositions of the instruction from the SessionEquivalenceLibrary.
  </Function>

  ### definition

  <Function id="qiskit.circuit.Measure.definition" signature="definition" modifiers="property">
    Return definition in terms of other basic gates.
  </Function>

  ### duration

  <Function id="qiskit.circuit.Measure.duration" signature="duration" modifiers="property">
    Get the duration.
  </Function>
  ...
  <Function id="qiskit.circuit.Measure.label" signature="label" modifiers="property">
  ...
  <Function id="qiskit.circuit.Measure.params" signature="params" modifiers="property">
  ...
  <Function id="qiskit.circuit.Measure.soft_compare" signature="soft_compare(other)">
  ...
  <Function id="qiskit.circuit.Measure.unit" signature="unit" modifiers="property">
