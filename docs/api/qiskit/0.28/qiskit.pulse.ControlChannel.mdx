...
<Class id="qiskit.pulse.ControlChannel" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/pulse/channels.py" signature="ControlChannel(index)" modifiers="class">
  ...
  **index** (`int`) – Index of channel.
  ...
  <Function id="qiskit.pulse.ControlChannel.index" signature="index" modifiers="property">
  ...
  <Function id="qiskit.pulse.ControlChannel.name" signature="name" modifiers="property">
  ...
  <Function id="qiskit.pulse.ControlChannel.parameters" signature="parameters" modifiers="property">
