...
<Class id="qiskit.transpiler.passes.CheckMap" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/transpiler/passes/utils/check_map.py" signature="CheckMap(*args, **kwargs)">
  ...
  **coupling\_map** ([*CouplingMap*](qiskit.transpiler.CouplingMap "qiskit.transpiler.CouplingMap")) – Directed graph representing a coupling map.
  ...
  <Function id="qiskit.transpiler.passes.CheckMap.__init__" name="__init__" signature="__init__(coupling_map)">
    CheckMap initializer.
  ...
  <Function id="qiskit.transpiler.passes.CheckMap.is_analysis_pass" name="is_analysis_pass" signature="property is_analysis_pass">
  ...
  <Function id="qiskit.transpiler.passes.CheckMap.is_transformation_pass" name="is_transformation_pass" signature="property is_transformation_pass">
  ...
  <Function id="qiskit.transpiler.passes.CheckMap.name" name="name" signature="name()">
    Return the name of the pass.
  </Function>

  ### run

  <Function id="qiskit.transpiler.passes.CheckMap.run" name="run" signature="run(dag)">
