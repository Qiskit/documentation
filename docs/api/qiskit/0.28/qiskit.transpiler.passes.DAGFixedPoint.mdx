...
<Class id="qiskit.transpiler.passes.DAGFixedPoint" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/transpiler/passes/utils/dag_fixed_point.py" signature="DAGFixedPoint(*args, **kwargs)" modifiers="class">
  ...
  <Function id="qiskit.transpiler.passes.DAGFixedPoint.is_analysis_pass" signature="is_analysis_pass" modifiers="property">
  ...
  <Function id="qiskit.transpiler.passes.DAGFixedPoint.is_transformation_pass" signature="is_transformation_pass" modifiers="property">
