...
<Class id="qiskit.opflow.OperatorBase" github="https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/opflow/operator_base.py" signature="OperatorBase">
  ...
  <Function id="qiskit.opflow.OperatorBase.power" name="power" signature="power(exponent)">
  ...
  <Function id="qiskit.opflow.OperatorBase.settings" name="settings" signature="abstract property settings">
