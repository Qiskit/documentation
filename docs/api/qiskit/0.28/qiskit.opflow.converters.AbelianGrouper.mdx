---
title: AbelianGrouper (v0.28)
description: API reference for qiskit.opflow.converters.AbelianGrouper in qiskit v0.28
...
<Class id="qiskit.opflow.converters.AbelianGrouper" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/opflow/converters/abelian_grouper.py" signature="AbelianGrouper(traverse=True)" modifiers="class">
