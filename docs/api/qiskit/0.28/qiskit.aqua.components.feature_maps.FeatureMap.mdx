...
<Class id="qiskit.aqua.components.feature_maps.FeatureMap" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/aqua/components/feature_maps/feature_map.py" signature="FeatureMap">
  ...
  <Function id="qiskit.aqua.components.feature_maps.FeatureMap.__init__" signature="abstract __init__()">
  ...
  <Function id="qiskit.aqua.components.feature_maps.FeatureMap.construct_circuit" signature="abstract construct_circuit(x, qr=None, inverse=False)">
  ...
  <Function id="qiskit.aqua.components.feature_maps.FeatureMap.feature_dimension" signature="property feature_dimension">
    returns feature dimension
  </Function>

  ### get\_entangler\_map

  <Function id="qiskit.aqua.components.feature_maps.FeatureMap.get_entangler_map" signature="static get_entangler_map(map_type, num_qubits)">
    get entangle map
  </Function>

  ### num\_qubits

  <Function id="qiskit.aqua.components.feature_maps.FeatureMap.num_qubits" signature="property num_qubits">
    returns number of qubits
  </Function>

  ### support\_parameterized\_circuit

  <Function id="qiskit.aqua.components.feature_maps.FeatureMap.support_parameterized_circuit" signature="property support_parameterized_circuit">
    returns whether or not the sub-class support parameterized circuit
  </Function>

  ### validate\_entangler\_map

  <Function id="qiskit.aqua.components.feature_maps.FeatureMap.validate_entangler_map" signature="static validate_entangler_map(entangler_map, num_qubits)">
