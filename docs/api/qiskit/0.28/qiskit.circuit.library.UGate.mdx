...
<Class id="qiskit.circuit.library.UGate" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/circuit/library/standard_gates/u.py" signature="UGate(theta, phi, lam, label=None)" modifiers="class">
...
$$
  ...
  <Function id="qiskit.circuit.library.UGate.__init__" signature="__init__(theta, phi, lam, label=None)">
    Create new U gate.
  </Function>
  ...
  <Function id="qiskit.circuit.library.UGate.add_decomposition" signature="add_decomposition(decomposition)">
    Add a decomposition of the instruction to the SessionEquivalenceLibrary.
  </Function>

  ### assemble

  <Function id="qiskit.circuit.library.UGate.assemble" signature="assemble()">
    Assemble a QasmQobjInstruction
  </Function>

  ### broadcast\_arguments

  <Function id="qiskit.circuit.library.UGate.broadcast_arguments" signature="broadcast_arguments(qargs, cargs)">
  ...
  <Function id="qiskit.circuit.library.UGate.c_if" signature="c_if(classical, val)">
  ...
  <Function id="qiskit.circuit.library.UGate.copy" signature="copy(name=None)">
  ...
  <Function id="qiskit.circuit.library.UGate.decompositions" signature="decompositions" modifiers="property">
    Get the decompositions of the instruction from the SessionEquivalenceLibrary.
  </Function>

  ### definition

  <Function id="qiskit.circuit.library.UGate.definition" signature="definition" modifiers="property">
    Return definition in terms of other basic gates.
  </Function>

  ### duration

  <Function id="qiskit.circuit.library.UGate.duration" signature="duration" modifiers="property">
    Get the duration.
  </Function>
  ...
  <Function id="qiskit.circuit.library.UGate.is_parameterized" signature="is_parameterized()">
    Return True .IFF. instruction is parameterized else False
  </Function>

  ### label

  <Function id="qiskit.circuit.library.UGate.label" signature="label" modifiers="property">
  ...
  <Function id="qiskit.circuit.library.UGate.mirror" signature="mirror()">
  ...
  <Function id="qiskit.circuit.library.UGate.params" signature="params" modifiers="property">
    return instruction params.
  </Function>

  ### power

  <Function id="qiskit.circuit.library.UGate.power" signature="power(exponent)">
  ...
  <Function id="qiskit.circuit.library.UGate.qasm" signature="qasm()">
  ...
  <Function id="qiskit.circuit.library.UGate.repeat" signature="repeat(n)">
  ...
  <Function id="qiskit.circuit.library.UGate.reverse_ops" signature="reverse_ops()">
  ...
  <Function id="qiskit.circuit.library.UGate.soft_compare" signature="soft_compare(other)">
  ...
  <Function id="qiskit.circuit.library.UGate.to_matrix" signature="to_matrix()">
  ...
  <Function id="qiskit.circuit.library.UGate.unit" signature="unit" modifiers="property">
    Get the time unit of duration.
  </Function>

  ### validate\_parameter

  <Function id="qiskit.circuit.library.UGate.validate_parameter" signature="validate_parameter(parameter)">
