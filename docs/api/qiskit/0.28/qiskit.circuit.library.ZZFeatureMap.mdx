  ...
  **ValueError** – If the feature dimension is smaller than 2.
  ...
  <Function id="qiskit.circuit.library.ZZFeatureMap.draw" signature="draw(output=None, scale=None, filename=None, style=None, interactive=False, plot_barriers=True, reverse_bits=False, justify=None, vertical_compression='medium', idle_wires=True, with_layout=True, fold=None, ax=None, initial_state=False, cregbundle=True)">
    ...
    **Example**
    ...
    ![../\_images/qiskit.circuit.library.ZZFeatureMap\_0\_0.png](/images/api/qiskit/0.28/qiskit.circuit.library.ZZFeatureMap_0_0.avif) ![../\_images/qiskit.circuit.library.ZZFeatureMap\_0\_1.png](/images/api/qiskit/0.28/qiskit.circuit.library.ZZFeatureMap_0_1.avif)
  </Function>
