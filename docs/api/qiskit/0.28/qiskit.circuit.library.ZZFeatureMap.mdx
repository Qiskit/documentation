...
| [`pauli`](#qiskit.circuit.library.ZZFeatureMap.pauli "qiskit.circuit.library.ZZFeatureMap.pauli")(pauli\_string, qubits)                                                                          | Apply [`PauliGate`](qiskit.circuit.library.PauliGate "qiskit.circuit.library.PauliGate").                                           |
...
<span id="qiskit.circuit.library.ZZFeatureMap.get_instructions" />
