...
<Class id="qiskit.providers.aer.library.SetUnitary" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-aer/tree/stable/0.8/qiskit/providers/aer/library/set_instructions/set_unitary.py" signature="SetUnitary(state)">
  ...
  **ExtensionError** – if the input matrix is not state.
  ...
  <Function id="qiskit.providers.aer.library.SetUnitary.__init__" name="__init__" signature="__init__(state)">
    Create new instruction to set the unitary simulator state.
  ...
  <Function id="qiskit.providers.aer.library.SetUnitary.add_decomposition" name="add_decomposition" signature="add_decomposition(decomposition)">
    Add a decomposition of the instruction to the SessionEquivalenceLibrary.
  </Function>

  ### assemble

  <Function id="qiskit.providers.aer.library.SetUnitary.assemble" name="assemble" signature="assemble()">
    Assemble a QasmQobjInstruction
  </Function>

  ### broadcast\_arguments

  <Function id="qiskit.providers.aer.library.SetUnitary.broadcast_arguments" name="broadcast_arguments" signature="broadcast_arguments(qargs, cargs)">
  ...
  <Function id="qiskit.providers.aer.library.SetUnitary.c_if" name="c_if" signature="c_if(classical, val)">
    Add classical condition on register or cbit classical and value val.
  </Function>

  ### copy

  <Function id="qiskit.providers.aer.library.SetUnitary.copy" name="copy" signature="copy(name=None)">
  ...
  <Function id="qiskit.providers.aer.library.SetUnitary.decompositions" name="decompositions" signature="property decompositions">
    Get the decompositions of the instruction from the SessionEquivalenceLibrary.
  </Function>

  ### definition

  <Function id="qiskit.providers.aer.library.SetUnitary.definition" name="definition" signature="property definition">
    Return definition in terms of other basic gates.
  </Function>

  ### duration

  <Function id="qiskit.providers.aer.library.SetUnitary.duration" name="duration" signature="property duration">
    Get the duration.
  </Function>

  ### inverse

  <Function id="qiskit.providers.aer.library.SetUnitary.inverse" name="inverse" signature="inverse()">
  ...
  <Function id="qiskit.providers.aer.library.SetUnitary.is_parameterized" name="is_parameterized" signature="is_parameterized()">
    Return True .IFF. instruction is parameterized else False
  </Function>

  ### label

  <Function id="qiskit.providers.aer.library.SetUnitary.label" name="label" signature="property label">
  ...
  <Function id="qiskit.providers.aer.library.SetUnitary.mirror" name="mirror" signature="mirror()">
  ...
  <Function id="qiskit.providers.aer.library.SetUnitary.params" name="params" signature="property params">
    return instruction params.
  </Function>

  ### qasm

  <Function id="qiskit.providers.aer.library.SetUnitary.qasm" name="qasm" signature="qasm()">
  ...
  <Function id="qiskit.providers.aer.library.SetUnitary.repeat" name="repeat" signature="repeat(n)">
  ...
  <Function id="qiskit.providers.aer.library.SetUnitary.reverse_ops" name="reverse_ops" signature="reverse_ops()">
  ...
  <Function id="qiskit.providers.aer.library.SetUnitary.soft_compare" name="soft_compare" signature="soft_compare(other)">
  ...
  <Function id="qiskit.providers.aer.library.SetUnitary.unit" name="unit" signature="property unit">
    Get the time unit of duration.
  </Function>

  ### validate\_parameter

  <Function id="qiskit.providers.aer.library.SetUnitary.validate_parameter" name="validate_parameter" signature="validate_parameter(parameter)">
