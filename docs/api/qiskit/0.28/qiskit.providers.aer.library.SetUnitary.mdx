...
<Class id="qiskit.providers.aer.library.SetUnitary" github="https://github.com/qiskit/qiskit-aer/tree/stable/0.8/qiskit/providers/aer/library/set_instructions/set_unitary.py" signature="SetUnitary(state)">
