...
<span id="qiskit.opflow.list_ops.SummedOp.__init__" />
...
|                                                                                                                                            |                                                                                                                                                                               |
| ------------------------------------------------------------------------------------------------------------------------------------------ | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [`__init__`](#qiskit.opflow.list_ops.SummedOp.__init__ "qiskit.opflow.list_ops.SummedOp.__init__")(oplist\[, coeff, abelian])              | **type oplist**`List`\[`OperatorBase`]                                                                                                                                        |
| [`add`](#qiskit.opflow.list_ops.SummedOp.add "qiskit.opflow.list_ops.SummedOp.add")(other)                                                 | Return Operator addition of `self` and `other`, overloaded by `+`.                                                                                                            |
| [`adjoint`](#qiskit.opflow.list_ops.SummedOp.adjoint "qiskit.opflow.list_ops.SummedOp.adjoint")()                                          | Return a new Operator equal to the Operator’s adjoint (conjugate transpose), overloaded by `~`.                                                                               |
| [`assign_parameters`](#qiskit.opflow.list_ops.SummedOp.assign_parameters "qiskit.opflow.list_ops.SummedOp.assign_parameters")(param\_dict) | Binds scalar values to any Terra `Parameters` in the coefficients or primitives of the Operator, or substitutes one `Parameter` for another.                                  |
| [`bind_parameters`](#qiskit.opflow.list_ops.SummedOp.bind_parameters "qiskit.opflow.list_ops.SummedOp.bind_parameters")(param\_dict)       | Same as assign\_parameters, but maintained for consistency with QuantumCircuit in Terra (which has both assign\_parameters and bind\_parameters).                             |
...
| [`compose`](#qiskit.opflow.list_ops.SummedOp.compose "qiskit.opflow.list_ops.SummedOp.compose")(other\[, permutation, front])              | Return Operator Composition between self and other (linear algebra-style: A\@B(x) = A(B(x))), overloaded by `@`.                                                              |
| [`copy`](#qiskit.opflow.list_ops.SummedOp.copy "qiskit.opflow.list_ops.SummedOp.copy")()                                                   | Return a deep copy of the Operator.                                                                                                                                           |
| [`default_combo_fn`](#qiskit.opflow.list_ops.SummedOp.default_combo_fn "qiskit.opflow.list_ops.SummedOp.default_combo_fn")(x)              | ListOp default combo function i.e. lambda x: x.                                                                                                                               |
| [`equals`](#qiskit.opflow.list_ops.SummedOp.equals "qiskit.opflow.list_ops.SummedOp.equals")(other)                                        | Check if other is equal to self.                                                                                                                                              |
| [`eval`](#qiskit.opflow.list_ops.SummedOp.eval "qiskit.opflow.list_ops.SummedOp.eval")(\[front])                                           | Evaluate the Operator’s underlying function, either on a binary string or another Operator.                                                                                   |
| [`exp_i`](#qiskit.opflow.list_ops.SummedOp.exp_i "qiskit.opflow.list_ops.SummedOp.exp_i")()                                                | Return an `OperatorBase` equivalent to an exponentiation of self \* -i, e^(-i\*op).                                                                                           |
| [`log_i`](#qiskit.opflow.list_ops.SummedOp.log_i "qiskit.opflow.list_ops.SummedOp.log_i")(\[massive])                                      | Return a `MatrixOp` equivalent to log(H)/-i for this operator H.                                                                                                              |
| [`mul`](#qiskit.opflow.list_ops.SummedOp.mul "qiskit.opflow.list_ops.SummedOp.mul")(scalar)                                                | Returns the scalar multiplication of the Operator, overloaded by `*`, including support for Terra’s `Parameters`, which can be bound to values later (via `bind_parameters`). |
| [`neg`](#qiskit.opflow.list_ops.SummedOp.neg "qiskit.opflow.list_ops.SummedOp.neg")()                                                      | Return the Operator’s negation, effectively just multiplying by -1.0, overloaded by `-`.                                                                                      |
| [`permute`](#qiskit.opflow.list_ops.SummedOp.permute "qiskit.opflow.list_ops.SummedOp.permute")(permutation)                               | Permute the qubits of the operator.                                                                                                                                           |
| [`power`](#qiskit.opflow.list_ops.SummedOp.power "qiskit.opflow.list_ops.SummedOp.power")(exponent)                                        | Return Operator composed with self multiple times, overloaded by `**`.                                                                                                        |
| [`primitive_strings`](#qiskit.opflow.list_ops.SummedOp.primitive_strings "qiskit.opflow.list_ops.SummedOp.primitive_strings")()            | Return a set of strings describing the primitives contained in the Operator.                                                                                                  |
...
| [`tensor`](#qiskit.opflow.list_ops.SummedOp.tensor "qiskit.opflow.list_ops.SummedOp.tensor")(other)                                        | Return tensor product between self and other, overloaded by `^`.                                                                                                              |
| [`tensorpower`](#qiskit.opflow.list_ops.SummedOp.tensorpower "qiskit.opflow.list_ops.SummedOp.tensorpower")(other)                         | Return tensor product with self multiple times, overloaded by `^`.                                                                                                            |
...
| [`to_circuit_op`](#qiskit.opflow.list_ops.SummedOp.to_circuit_op "qiskit.opflow.list_ops.SummedOp.to_circuit_op")()                        | Returns an equivalent Operator composed of only QuantumCircuit-based primitives, such as `CircuitOp` and `CircuitStateFn`.                                                    |
| [`to_matrix`](#qiskit.opflow.list_ops.SummedOp.to_matrix "qiskit.opflow.list_ops.SummedOp.to_matrix")(\[massive])                          | Return NumPy representation of the Operator.                                                                                                                                  |
| [`to_matrix_op`](#qiskit.opflow.list_ops.SummedOp.to_matrix_op "qiskit.opflow.list_ops.SummedOp.to_matrix_op")(\[massive])                 | Returns an equivalent Operator composed of only NumPy-based primitives, such as `MatrixOp` and `VectorStateFn`.                                                               |
| [`to_pauli_op`](#qiskit.opflow.list_ops.SummedOp.to_pauli_op "qiskit.opflow.list_ops.SummedOp.to_pauli_op")(\[massive])                    | Returns an equivalent Operator composed of only Pauli-based primitives, such as `PauliOp`.                                                                                    |
| [`to_spmatrix`](#qiskit.opflow.list_ops.SummedOp.to_spmatrix "qiskit.opflow.list_ops.SummedOp.to_spmatrix")()                              | Returns SciPy sparse matrix representation of the Operator.                                                                                                                   |
| [`traverse`](#qiskit.opflow.list_ops.SummedOp.traverse "qiskit.opflow.list_ops.SummedOp.traverse")(convert\_fn\[, coeff])                  | Apply the convert\_fn to each node in the oplist.                                                                                                                             |
...
| ----------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------- |
| `INDENTATION`                                                                                                     |                                                                                                                            |
| [`abelian`](#qiskit.opflow.list_ops.SummedOp.abelian "qiskit.opflow.list_ops.SummedOp.abelian")                   | Whether the Operators in `oplist` are known to commute with one another.                                                   |
| [`coeff`](#qiskit.opflow.list_ops.SummedOp.coeff "qiskit.opflow.list_ops.SummedOp.coeff")                         | The scalar coefficient multiplying the Operator.                                                                           |
| [`combo_fn`](#qiskit.opflow.list_ops.SummedOp.combo_fn "qiskit.opflow.list_ops.SummedOp.combo_fn")                | The function defining how to combine `oplist` (or Numbers, or NumPy arrays) to produce the Operator’s underlying function. |
| [`distributive`](#qiskit.opflow.list_ops.SummedOp.distributive "qiskit.opflow.list_ops.SummedOp.distributive")    | Indicates whether the ListOp or subclass is distributive under composition.                                                |
| [`grad_combo_fn`](#qiskit.opflow.list_ops.SummedOp.grad_combo_fn "qiskit.opflow.list_ops.SummedOp.grad_combo_fn") | The gradient of `combo_fn`.                                                                                                |
| [`instance_id`](#qiskit.opflow.list_ops.SummedOp.instance_id "qiskit.opflow.list_ops.SummedOp.instance_id")       | Return the unique instance id.                                                                                             |
| [`num_qubits`](#qiskit.opflow.list_ops.SummedOp.num_qubits "qiskit.opflow.list_ops.SummedOp.num_qubits")          | The number of qubits over which the Operator is defined.                                                                   |
| [`oplist`](#qiskit.opflow.list_ops.SummedOp.oplist "qiskit.opflow.list_ops.SummedOp.oplist")                      | The list of `OperatorBases` defining the underlying function of this Operator.                                             |
| [`parameters`](#qiskit.opflow.list_ops.SummedOp.parameters "qiskit.opflow.list_ops.SummedOp.parameters")          | Return a set of Parameter objects contained in the Operator.                                                               |
| [`settings`](#qiskit.opflow.list_ops.SummedOp.settings "qiskit.opflow.list_ops.SummedOp.settings")                | Return settings.                                                                                                           |
...
<span id="qiskit.opflow.list_ops.SummedOp.adjoint" />
...
<span id="qiskit.opflow.list_ops.SummedOp.assign_parameters" />
...
<span id="qiskit.opflow.list_ops.SummedOp.bind_parameters" />
...
<span id="qiskit.opflow.list_ops.SummedOp.compose" />
...
<span id="qiskit.opflow.list_ops.SummedOp.copy" />
...
<span id="qiskit.opflow.list_ops.SummedOp.default_combo_fn" />
...
<span id="qiskit.opflow.list_ops.SummedOp.eval" />
...
<span id="qiskit.opflow.list_ops.SummedOp.exp_i" />
...
<span id="qiskit.opflow.list_ops.SummedOp.log_i" />
...
<span id="qiskit.opflow.list_ops.SummedOp.mul" />
...
<span id="qiskit.opflow.list_ops.SummedOp.neg" />
...
<span id="qiskit.opflow.list_ops.SummedOp.permute" />
...
<span id="qiskit.opflow.list_ops.SummedOp.power" />
...
<span id="qiskit.opflow.list_ops.SummedOp.primitive_strings" />
...
<span id="qiskit.opflow.list_ops.SummedOp.tensor" />
...
<span id="qiskit.opflow.list_ops.SummedOp.tensorpower" />
...
<span id="qiskit.opflow.list_ops.SummedOp.to_circuit_op" />
...
<span id="qiskit.opflow.list_ops.SummedOp.to_matrix" />
...
<span id="qiskit.opflow.list_ops.SummedOp.to_spmatrix" />
...
<span id="qiskit.opflow.list_ops.SummedOp.traverse" />
