...
<Class id="qiskit.providers.ibmq.runtime.RuntimeJob" github="https://github.com/qiskit/qiskit-ibmq-provider/tree/stable/0.15/qiskit/providers/ibmq/runtime/runtime_job.py" signature="RuntimeJob(backend, api_client, credentials, job_id, program_id, params=None, creation_date=None, user_callback=None, result_decoder=<class 'qiskit.providers.ibmq.runtime.program.result_decoder.ResultDecoder'>)">
  ...
  *   **result\_decoder** (`Type`\[`ResultDecoder`]) – A [`ResultDecoder`](qiskit.providers.ibmq.runtime.ResultDecoder "qiskit.providers.ibmq.runtime.ResultDecoder") subclass used to decode job results.
  ...
  <Function id="qiskit.providers.ibmq.runtime.RuntimeJob.__init__" name="__init__" signature="__init__(backend, api_client, credentials, job_id, program_id, params=None, creation_date=None, user_callback=None, result_decoder=<class 'qiskit.providers.ibmq.runtime.program.result_decoder.ResultDecoder'>)">
    RuntimeJob constructor.
  ...
  <Function id="qiskit.providers.ibmq.runtime.RuntimeJob.backend" name="backend" signature="backend()">
  ...
  <Function id="qiskit.providers.ibmq.runtime.RuntimeJob.cancel" name="cancel" signature="cancel()">
    Cancel the job.
  ...
  <Function id="qiskit.providers.ibmq.runtime.RuntimeJob.cancel_result_streaming" name="cancel_result_streaming" signature="cancel_result_streaming()">
  ...
  <Function id="qiskit.providers.ibmq.runtime.RuntimeJob.creation_date" name="creation_date" signature="property creation_date">
  ...
  <Function id="qiskit.providers.ibmq.runtime.RuntimeJob.error_message" name="error_message" signature="error_message()">
  ...
  <Function id="qiskit.providers.ibmq.runtime.RuntimeJob.inputs" name="inputs" signature="property inputs">
  ...
  <Function id="qiskit.providers.ibmq.runtime.RuntimeJob.job_id" name="job_id" signature="job_id()">
  ...
  <Function id="qiskit.providers.ibmq.runtime.RuntimeJob.logs" name="logs" signature="logs()">
    Return job logs.
  ...
  <Function id="qiskit.providers.ibmq.runtime.RuntimeJob.program_id" name="program_id" signature="property program_id">
    Program ID.
  ...
  <Function id="qiskit.providers.ibmq.runtime.RuntimeJob.result" name="result" signature="result(timeout=None, wait=5, decoder=None)">
  ...
  <Function id="qiskit.providers.ibmq.runtime.RuntimeJob.status" name="status" signature="status()">
  ...
  <Function id="qiskit.providers.ibmq.runtime.RuntimeJob.stream_results" name="stream_results" signature="stream_results(callback, decoder=None)">
  ...
  <Function id="qiskit.providers.ibmq.runtime.RuntimeJob.wait_for_final_state" name="wait_for_final_state" signature="wait_for_final_state(timeout=None, wait=5)">
