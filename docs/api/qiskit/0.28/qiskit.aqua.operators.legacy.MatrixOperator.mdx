...
<Class id="qiskit.aqua.operators.legacy.MatrixOperator" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/aqua/operators/legacy/matrix_operator.py" signature="MatrixOperator(matrix, basis=None, z2_symmetries=None, atol=1e-12, name=None)">
  ...
  *   **name** (*str*) – name
  ...
  <Function id="qiskit.aqua.operators.legacy.MatrixOperator.atol" signature="property atol">
    return atol
  </Function>

  ### basis

  <Function id="qiskit.aqua.operators.legacy.MatrixOperator.basis" signature="property basis">
    returns basis
  </Function>
  ...
  <Function id="qiskit.aqua.operators.legacy.MatrixOperator.dense_matrix" signature="property dense_matrix">
    Getter of matrix in dense matrix form.
  </Function>

  ### dia\_matrix

  <Function id="qiskit.aqua.operators.legacy.MatrixOperator.dia_matrix" signature="property dia_matrix">
    diagonal matrix
  </Function>
  ...
  <Function id="qiskit.aqua.operators.legacy.MatrixOperator.matrix" signature="property matrix">
    Getter of matrix.
  </Function>

  ### name

  <Function id="qiskit.aqua.operators.legacy.MatrixOperator.name" signature="property name">
    returns name
  </Function>

  ### num\_qubits

  <Function id="qiskit.aqua.operators.legacy.MatrixOperator.num_qubits" signature="property num_qubits">
  ...
  <Function id="qiskit.aqua.operators.legacy.MatrixOperator.z2_symmetries" signature="property z2_symmetries">
