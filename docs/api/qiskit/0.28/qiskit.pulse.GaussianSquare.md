# qiskit.pulse.GaussianSquare[¶](#qiskit-pulse-gaussiansquare "Permalink to this headline")
...
|                                                                                                                                    |                                                                                                                                |
| ---------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------ |
| [`__init__`](#qiskit.pulse.GaussianSquare.__init__ "qiskit.pulse.GaussianSquare.__init__")(duration, amp, sigma\[, width, …])      | Initialize the gaussian square pulse.                                                                                          |
...
| [`risefall_sigma_ratio`](#qiskit.pulse.GaussianSquare.risefall_sigma_ratio "qiskit.pulse.GaussianSquare.risefall_sigma_ratio") | The duration of each risefall in terms of sigma.       |
