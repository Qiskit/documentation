---
title: BackendProperties (v0.28)
description: API reference for qiskit.providers.models.BackendProperties in qiskit v0.28
...
<Class id="qiskit.providers.models.BackendProperties" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/providers/models/backendproperties.py" signature="BackendProperties(backend_name, backend_version, last_update_date, qubits, gates, general, **kwargs)" modifiers="class">
  ...
  *   **kwargs** – optional additional fields
  ...
  <Function id="qiskit.providers.models.BackendProperties.__init__" signature="__init__(backend_name, backend_version, last_update_date, qubits, gates, general, **kwargs)">
    Initialize a BackendProperties instance.
  ...
  <Function id="qiskit.providers.models.BackendProperties.faulty_gates" signature="faulty_gates()">
    Return a list of faulty gates.
  </Function>

  ### faulty\_qubits

  <Function id="qiskit.providers.models.BackendProperties.faulty_qubits" signature="faulty_qubits()">
    Return a list of faulty qubits.
  </Function>

  ### frequency

  <Function id="qiskit.providers.models.BackendProperties.frequency" signature="frequency(qubit)">
  ...
  <Function id="qiskit.providers.models.BackendProperties.from_dict" signature="from_dict(data)" modifiers="classmethod">
  ...
  <Function id="qiskit.providers.models.BackendProperties.gate_error" signature="gate_error(gate, qubits)">
  ...
  <Function id="qiskit.providers.models.BackendProperties.gate_length" signature="gate_length(gate, qubits)">
  ...
  <Function id="qiskit.providers.models.BackendProperties.gate_property" signature="gate_property(gate, qubits=None, name=None)">
  ...
  <Function id="qiskit.providers.models.BackendProperties.is_gate_operational" signature="is_gate_operational(gate, qubits=None)">
  ...
  <Function id="qiskit.providers.models.BackendProperties.is_qubit_operational" signature="is_qubit_operational(qubit)">
  ...
  <Function id="qiskit.providers.models.BackendProperties.qubit_property" signature="qubit_property(qubit, name=None)">
  ...
  <Function id="qiskit.providers.models.BackendProperties.readout_error" signature="readout_error(qubit)">
  ...
  <Function id="qiskit.providers.models.BackendProperties.readout_length" signature="readout_length(qubit)">
  ...
  <Function id="qiskit.providers.models.BackendProperties.t1" signature="t1(qubit)">
  ...
  <Function id="qiskit.providers.models.BackendProperties.t2" signature="t2(qubit)">
  ...
  <Function id="qiskit.providers.models.BackendProperties.to_dict" signature="to_dict()">
