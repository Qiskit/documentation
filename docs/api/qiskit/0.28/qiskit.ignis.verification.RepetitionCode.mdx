...
<Class id="qiskit.ignis.verification.RepetitionCode" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-ignis/tree/stable/0.6/qiskit/ignis/verification/topological_codes/circuits.py" signature="RepetitionCode(d, T=0)">
  ...
  **Additional information:**
  ...
  <Function id="qiskit.ignis.verification.RepetitionCode.__init__" name="__init__" signature="__init__(d, T=0)">
    Creates the circuits corresponding to a logical 0 and 1 encoded using a repetition code.
  ...
  <Function id="qiskit.ignis.verification.RepetitionCode.get_circuit_list" name="get_circuit_list" signature="get_circuit_list()">
    **Returns**
  ...
  <Function id="qiskit.ignis.verification.RepetitionCode.process_results" name="process_results" signature="process_results(raw_results)">
    **Parameters**
  ...
  <Function id="qiskit.ignis.verification.RepetitionCode.readout" name="readout" signature="readout()">
  ...
  <Function id="qiskit.ignis.verification.RepetitionCode.syndrome_measurement" name="syndrome_measurement" signature="syndrome_measurement(reset=True, barrier=False)">
  ...
  <Function id="qiskit.ignis.verification.RepetitionCode.x" name="x" signature="x(logs=('0', '1'), barrier=False)">
