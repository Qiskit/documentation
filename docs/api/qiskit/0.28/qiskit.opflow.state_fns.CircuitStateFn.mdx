...
<Class id="qiskit.opflow.state_fns.CircuitStateFn" github="https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/opflow/state_fns/circuit_state_fn.py" signature="CircuitStateFn(primitive=None, coeff=1.0, is_measurement=False, from_operator=False)">
  ...
  **TypeError** – Unsupported primitive, or primitive has ClassicalRegisters.
  ...
  <Function id="qiskit.opflow.state_fns.CircuitStateFn.__init__" name="__init__" signature="__init__(primitive=None, coeff=1.0, is_measurement=False, from_operator=False)">
    **Parameters**
  ...
  <Function id="qiskit.opflow.state_fns.CircuitStateFn.settings" name="settings" signature="property settings">
    Return settings.
