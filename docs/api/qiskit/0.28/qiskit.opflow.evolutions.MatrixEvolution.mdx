...
<Class id="qiskit.opflow.evolutions.MatrixEvolution" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/opflow/evolutions/matrix_evolution.py" signature="MatrixEvolution">
  ...
  <Function id="qiskit.opflow.evolutions.MatrixEvolution.__init__" name="__init__" signature="__init__()">
  ...
  <Function id="qiskit.opflow.evolutions.MatrixEvolution.convert" name="convert" signature="convert(operator)">
