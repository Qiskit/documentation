...
<Class id="qiskit.ignis.verification.RBFitter" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-ignis/tree/stable/0.6/qiskit/ignis/verification/randomized_benchmarking/fitters.py" signature="RBFitter(backend_result, cliff_lengths, rb_pattern=None)" modifiers="class">
  ...
  *   **rb\_pattern** (*list*) – the pattern for the RB sequences.
  ...
  <Function id="qiskit.ignis.verification.RBFitter.cliff_lengths" signature="cliff_lengths" modifiers="property">
    Return clifford lengths.
  </Function>

  ### fit

  <Function id="qiskit.ignis.verification.RBFitter.fit" signature="fit" modifiers="property">
    Return fit.
  </Function>
  ...
  <Function id="qiskit.ignis.verification.RBFitter.raw_data" signature="raw_data" modifiers="property">
    Return raw data.
  </Function>

  ### rb\_fit\_fun

  <Function id="qiskit.ignis.verification.RBFitter.rb_fit_fun" signature="rb_fit_fun" modifiers="property">
    Return the fit function rb\_fit\_fun.
  </Function>

  ### results

  <Function id="qiskit.ignis.verification.RBFitter.results" signature="results" modifiers="property">
    Return all the results.
  </Function>

  ### seeds

  <Function id="qiskit.ignis.verification.RBFitter.seeds" signature="seeds" modifiers="property">
    Return the number of loaded seeds.
  </Function>

  ### ydata

  <Function id="qiskit.ignis.verification.RBFitter.ydata" signature="ydata" modifiers="property">
