...
<Class id="qiskit.transpiler.passes.BIPMapping" github="https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/transpiler/passes/routing/bip_mapping.py" signature="BIPMapping(*args, **kwargs)">
  ...
  **Raises**
  ...
  <Function id="qiskit.transpiler.passes.BIPMapping.__init__" name="__init__" signature="__init__(coupling_map, objective='depth', backend_prop=None, time_limit=30, threads=None, max_swaps_inbetween_layers=None)">
    BIPMapping initializer.
  ...
  <Function id="qiskit.transpiler.passes.BIPMapping.is_analysis_pass" name="is_analysis_pass" signature="property is_analysis_pass">
  ...
  <Function id="qiskit.transpiler.passes.BIPMapping.is_transformation_pass" name="is_transformation_pass" signature="property is_transformation_pass">
