...
<Class id="qiskit.algorithms.Shor" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/algorithms/factorizers/shor.py" signature="Shor(quantum_instance=None)">
  ...
  **quantum\_instance** (`Union`\[`Backend`, `BaseBackend`, `QuantumInstance`, `None`]) – Quantum Instance or Backend
  ...
  <Function id="qiskit.algorithms.Shor.modinv" signature="static modinv(a, m)">
  ...
  <Function id="qiskit.algorithms.Shor.quantum_instance" signature="property quantum_instance">
