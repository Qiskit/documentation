...
<Class id="qiskit.ignis.characterization.BaseGateFitter" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-ignis/tree/stable/0.6/qiskit/ignis/characterization/fitters.py" signature="BaseGateFitter(description, backend_result, xdata, qubits, fit_fun, fit_p0, fit_bounds, circuit_names, series=None, expected_state='0')">
  ...
  <Function id="qiskit.ignis.characterization.BaseGateFitter.backend_result" signature="property backend_result">
  ...
  <Function id="qiskit.ignis.characterization.BaseGateFitter.description" signature="property description">
  ...
  <Function id="qiskit.ignis.characterization.BaseGateFitter.fit_fun" signature="property fit_fun">
  ...
  <Function id="qiskit.ignis.characterization.BaseGateFitter.measured_qubits" signature="property measured_qubits">
  ...
  <Function id="qiskit.ignis.characterization.BaseGateFitter.params" signature="property params">
  ...
  <Function id="qiskit.ignis.characterization.BaseGateFitter.params_err" signature="property params_err">
  ...
  <Function id="qiskit.ignis.characterization.BaseGateFitter.series" signature="property series">
  ...
  <Function id="qiskit.ignis.characterization.BaseGateFitter.xdata" signature="property xdata">
  ...
  <Function id="qiskit.ignis.characterization.BaseGateFitter.ydata" signature="property ydata">
