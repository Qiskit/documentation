---
title: StabilizerState (v0.28)
description: API reference for qiskit.quantum_info.StabilizerState in qiskit v0.28
in_page_toc_min_heading_level: 1
python_api_type: class
python_api_name: qiskit.quantum_info.StabilizerState
---

<span id="qiskit-quantum-info-stabilizerstate" />
