...
<Class id="qiskit.quantum_info.StabilizerState" github="https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/quantum_info/states/stabilizerstate.py" signature="StabilizerState(data, validate=True)">
  ...
  *   **validate** (*boolean*) – validate that the stabilizer state data is a valid Clifford.
  ...
  <Function id="qiskit.quantum_info.StabilizerState.__init__" name="__init__" signature="__init__(data, validate=True)">
    Initialize a StabilizerState object.
  ...
  <Function id="qiskit.quantum_info.StabilizerState.clifford" name="clifford" signature="property clifford">
  ...
  <Function id="qiskit.quantum_info.StabilizerState.dim" name="dim" signature="property dim">
  ...
  <Function id="qiskit.quantum_info.StabilizerState.num_qubits" name="num_qubits" signature="property num_qubits">
