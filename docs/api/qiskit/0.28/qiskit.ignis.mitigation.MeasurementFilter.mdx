---
title: MeasurementFilter (v0.28)
description: API reference for qiskit.ignis.mitigation.MeasurementFilter in qiskit v0.28
...
<Class id="qiskit.ignis.mitigation.MeasurementFilter" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-ignis/tree/stable/0.6/qiskit/ignis/mitigation/measurement/filters.py" signature="MeasurementFilter(cal_matrix, state_labels)" modifiers="class">
