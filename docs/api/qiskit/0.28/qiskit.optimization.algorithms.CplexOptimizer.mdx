...
<Class id="qiskit.optimization.algorithms.CplexOptimizer" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/optimization/algorithms/cplex_optimizer.py" signature="CplexOptimizer(disp=False)">
  ...
  **Raises**
  ...
  <Function id="qiskit.optimization.algorithms.CplexOptimizer.__init__" name="__init__" signature="__init__(disp=False)">
    Initializes the CplexOptimizer.
  ...
  <Function id="qiskit.optimization.algorithms.CplexOptimizer.disp" name="disp" signature="property disp">
  ...
  <Function id="qiskit.optimization.algorithms.CplexOptimizer.get_compatibility_msg" name="get_compatibility_msg" signature="get_compatibility_msg(problem)">
  ...
  <Function id="qiskit.optimization.algorithms.CplexOptimizer.is_compatible" name="is_compatible" signature="is_compatible(problem)">
  ...
  <Function id="qiskit.optimization.algorithms.CplexOptimizer.is_cplex_installed" name="is_cplex_installed" signature="static is_cplex_installed()">
    Returns True if cplex is installed
  </Function>

  ### solve

  <Function id="qiskit.optimization.algorithms.CplexOptimizer.solve" name="solve" signature="solve(problem)">
