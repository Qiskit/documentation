...
<Class id="qiskit.opflow.evolutions.Trotter" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/opflow/evolutions/trotterizations/trotter.py" signature="Trotter(reps=1)" modifiers="class">
  ...
  **reps** (`int`) – The number of times to repeat the Trotterization circuit.
  ...
  <Function id="qiskit.opflow.evolutions.Trotter.order" signature="order" modifiers="property">
    returns order
  ...
  <Function id="qiskit.opflow.evolutions.Trotter.reps" signature="reps" modifiers="property">
