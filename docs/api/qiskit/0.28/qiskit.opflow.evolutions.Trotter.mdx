...
<Class id="qiskit.opflow.evolutions.Trotter" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/opflow/evolutions/trotterizations/trotter.py" signature="Trotter(reps=1)">
  ...
  **reps** (`int`) – The number of times to repeat the Trotterization circuit.
  ...
  <Function id="qiskit.opflow.evolutions.Trotter.__init__" name="__init__" signature="__init__(reps=1)">
    **Parameters**
  ...
  <Function id="qiskit.opflow.evolutions.Trotter.convert" name="convert" signature="convert(operator)">
  ...
  <Function id="qiskit.opflow.evolutions.Trotter.order" name="order" signature="property order">
    returns order
  ...
  <Function id="qiskit.opflow.evolutions.Trotter.reps" name="reps" signature="property reps">
