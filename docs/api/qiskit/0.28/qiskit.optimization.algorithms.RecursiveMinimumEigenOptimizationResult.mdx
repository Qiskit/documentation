---
title: RecursiveMinimumEigenOptimizationResult (v0.28)
description: API reference for qiskit.optimization.algorithms.RecursiveMinimumEigenOptimizationResult in qiskit v0.28
