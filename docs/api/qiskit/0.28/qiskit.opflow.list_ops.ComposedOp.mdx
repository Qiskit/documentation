...
<Class id="qiskit.opflow.list_ops.ComposedOp" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/opflow/list_ops/composed_op.py" signature="ComposedOp(oplist, coeff=1.0, abelian=False)">
  ...
  *   **abelian** (`bool`) – Indicates whether the Operators in `oplist` are known to mutually commute.
  ...
  <Function id="qiskit.opflow.list_ops.ComposedOp.default_combo_fn" signature="static default_combo_fn(x)">
  ...
  <Function id="qiskit.opflow.list_ops.ComposedOp.settings" signature="property settings">
    Return settings.
