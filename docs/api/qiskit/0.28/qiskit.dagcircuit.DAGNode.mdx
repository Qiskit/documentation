...
<Class id="qiskit.dagcircuit.DAGNode" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/dagcircuit/dagnode.py" signature="DAGNode(type=None, op=None, name=None, qargs=None, cargs=None, wire=None, nid=- 1)">
  ...
  <Function id="qiskit.dagcircuit.DAGNode.condition" signature="property condition">
    Returns the condition of the node.op
  </Function>

  ### name

  <Function id="qiskit.dagcircuit.DAGNode.name" signature="property name">
    Returns the Instruction name corresponding to the op for this node
  </Function>

  ### op

  <Function id="qiskit.dagcircuit.DAGNode.op" signature="property op">
    Returns the Instruction object corresponding to the op for the node, else None
  </Function>

  ### qargs

  <Function id="qiskit.dagcircuit.DAGNode.qargs" signature="property qargs">
    Returns list of Qubit, else an empty list.
  </Function>

  ### semantic\_eq

  <Function id="qiskit.dagcircuit.DAGNode.semantic_eq" signature="static semantic_eq(node1, node2, bit_indices1=None, bit_indices2=None)">
  ...
  <Function id="qiskit.dagcircuit.DAGNode.wire" signature="property wire">
