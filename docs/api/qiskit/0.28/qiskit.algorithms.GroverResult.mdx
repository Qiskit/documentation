...
<Class id="qiskit.algorithms.GroverResult" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/algorithms/amplitude_amplifiers/grover.py" signature="GroverResult">
  Grover Result.

  ### \_\_init\_\_

  <Function id="qiskit.algorithms.GroverResult.__init__" name="__init__" signature="__init__()">
  ...
  <Function id="qiskit.algorithms.GroverResult.assignment" name="assignment" signature="property assignment">
  ...
  <Function id="qiskit.algorithms.GroverResult.circuit_results" name="circuit_results" signature="property circuit_results">
  ...
  <Function id="qiskit.algorithms.GroverResult.combine" name="combine" signature="combine(result)">
  ...
  <Function id="qiskit.algorithms.GroverResult.iterations" name="iterations" signature="property iterations">
  ...
  <Function id="qiskit.algorithms.GroverResult.max_probability" name="max_probability" signature="property max_probability">
  ...
  <Function id="qiskit.algorithms.GroverResult.oracle_evaluation" name="oracle_evaluation" signature="property oracle_evaluation">
  ...
  <Function id="qiskit.algorithms.GroverResult.top_measurement" name="top_measurement" signature="property top_measurement">
