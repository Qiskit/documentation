---
title: AncillaQubit (v0.28)
description: API reference for qiskit.circuit.AncillaQubit in qiskit v0.28
...
<Class id="qiskit.circuit.AncillaQubit" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/circuit/quantumregister.py" signature="AncillaQubit(register=None, index=None)" modifiers="class">
