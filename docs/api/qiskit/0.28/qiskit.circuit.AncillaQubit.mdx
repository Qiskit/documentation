...
<Class id="qiskit.circuit.AncillaQubit" github="https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/circuit/quantumregister.py" signature="AncillaQubit(register=None, index=None)">
