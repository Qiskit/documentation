...
<Class id="qiskit.algorithms.IterativePhaseEstimation" github="https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/algorithms/phase_estimators/ipe.py" signature="IterativePhaseEstimation(num_iterations, quantum_instance=None)">
  ...
  **ValueError** – if num\_iterations is not greater than zero.
  ...
  <Function id="qiskit.algorithms.IterativePhaseEstimation.__init__" name="__init__" signature="__init__(num_iterations, quantum_instance=None)">
    **Parameters**
  ...
  <Function id="qiskit.algorithms.IterativePhaseEstimation.construct_circuit" name="construct_circuit" signature="construct_circuit(unitary, state_preparation, k, omega=0, measurement=False)">
