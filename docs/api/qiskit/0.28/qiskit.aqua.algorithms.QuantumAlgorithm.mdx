...
<Class id="qiskit.aqua.algorithms.QuantumAlgorithm" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/aqua/algorithms/quantum_algorithm.py" signature="QuantumAlgorithm(quantum_instance)">
  ...
  <Function id="qiskit.aqua.algorithms.QuantumAlgorithm.__init__" name="__init__" signature="abstract __init__(quantum_instance)">
  ...
  <Function id="qiskit.aqua.algorithms.QuantumAlgorithm.backend" name="backend" signature="property backend">
    Returns backend.
  ...
  <Function id="qiskit.aqua.algorithms.QuantumAlgorithm.quantum_instance" name="quantum_instance" signature="property quantum_instance">
  ...
  <Function id="qiskit.aqua.algorithms.QuantumAlgorithm.random" name="random" signature="property random">
    Return a numpy random.
  </Function>

  ### run

  <Function id="qiskit.aqua.algorithms.QuantumAlgorithm.run" name="run" signature="run(quantum_instance=None, **kwargs)">
  ...
  <Function id="qiskit.aqua.algorithms.QuantumAlgorithm.set_backend" name="set_backend" signature="set_backend(backend, **kwargs)">
