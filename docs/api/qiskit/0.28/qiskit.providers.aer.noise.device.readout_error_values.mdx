...
`readout_error_values(properties)` [GitHub](https://github.com/qiskit/qiskit-aer/tree/stable/0.8/qiskit/providers/aer/noise/device/parameters.py "view source code")
