...
<Class id="qiskit.aqua.components.multiclass_extensions.MulticlassExtension" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/aqua/components/multiclass_extensions/multiclass_extension.py" signature="MulticlassExtension">
  ...
  <Function id="qiskit.aqua.components.multiclass_extensions.MulticlassExtension.__init__" signature="abstract __init__()">
  ...
  <Function id="qiskit.aqua.components.multiclass_extensions.MulticlassExtension.predict" signature="abstract predict(x)">
  ...
  <Function id="qiskit.aqua.components.multiclass_extensions.MulticlassExtension.test" signature="abstract test(x, y)">
  ...
  <Function id="qiskit.aqua.components.multiclass_extensions.MulticlassExtension.train" signature="abstract train(x, y)">
