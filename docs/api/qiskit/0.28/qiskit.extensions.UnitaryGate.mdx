...
<Class id="qiskit.extensions.UnitaryGate" github="https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/extensions/unitary.py" signature="UnitaryGate(data, label=None)">
