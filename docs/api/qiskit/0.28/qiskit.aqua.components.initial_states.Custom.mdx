...
<Class id="qiskit.aqua.components.initial_states.Custom" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/aqua/components/initial_states/custom.py" signature="Custom(num_qubits, state='zero', state_vector=None, circuit=None)">
  ...
  **Raises**
  ...
  <Function id="qiskit.aqua.components.initial_states.Custom.__init__" name="__init__" signature="__init__(num_qubits, state='zero', state_vector=None, circuit=None)">
    **Parameters**
  ...
  <Function id="qiskit.aqua.components.initial_states.Custom.bitstr" name="bitstr" signature="property bitstr" />

  ### construct\_circuit

  <Function id="qiskit.aqua.components.initial_states.Custom.construct_circuit" name="construct_circuit" signature="construct_circuit(mode='circuit', register=None)">
