...
<Class id="qiskit.providers.ibmq.BackendJobLimit" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-ibmq-provider/tree/stable/0.15/qiskit/providers/ibmq/backendjoblimit.py" signature="BackendJobLimit(maximum_jobs, running_jobs, **kwargs)">
  ...
  <Attribute id="qiskit.providers.ibmq.BackendJobLimit.maximum_jobs" name="maximum_jobs">
    The maximum number of concurrent jobs this account is allowed to submit to this backend, with this provider.
  </Attribute>

  ### running\_jobs

  <Attribute id="qiskit.providers.ibmq.BackendJobLimit.running_jobs" name="running_jobs">
  ...
  *   **kwargs** (`Any`) – Additional attributes that will be added as instance members.
  ...
  <Function id="qiskit.providers.ibmq.BackendJobLimit.__init__" name="__init__" signature="__init__(maximum_jobs, running_jobs, **kwargs)">
    BackendJobLimit constructor.
