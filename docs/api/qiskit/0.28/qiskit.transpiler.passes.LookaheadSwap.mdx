...
<Class id="qiskit.transpiler.passes.LookaheadSwap" github="https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/transpiler/passes/routing/lookahead_swap.py" signature="LookaheadSwap(*args, **kwargs)">
  ...
  *   **fake\_run** (*bool*) – if true, it only pretend to do routing, i.e., no swap is effectively added.
  ...
  <Function id="qiskit.transpiler.passes.LookaheadSwap.__init__" name="__init__" signature="__init__(coupling_map, search_depth=4, search_width=4, fake_run=False)">
    LookaheadSwap initializer.
