...
<Class id="qiskit.pulse.AcquireChannel" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/pulse/channels.py" signature="AcquireChannel(index)">
  ...
  **index** (`int`) – Index of channel.
  ...
  <Function id="qiskit.pulse.AcquireChannel.__init__" name="__init__" signature="__init__(index)">
    Channel class.
  ...
  <Function id="qiskit.pulse.AcquireChannel.assign" name="assign" signature="assign(parameter, value)">
  ...
  <Function id="qiskit.pulse.AcquireChannel.index" name="index" signature="property index">
  ...
  <Function id="qiskit.pulse.AcquireChannel.is_parameterized" name="is_parameterized" signature="is_parameterized()">
  ...
  <Function id="qiskit.pulse.AcquireChannel.name" name="name" signature="property name">
  ...
  <Function id="qiskit.pulse.AcquireChannel.parameters" name="parameters" signature="property parameters">
