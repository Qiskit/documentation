...
<Class id="qiskit.pulse.AcquireChannel" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/pulse/channels.py" signature="AcquireChannel(index)" modifiers="class">
  ...
  **index** (`int`) – Index of channel.
  ...
  <Function id="qiskit.pulse.AcquireChannel.index" signature="index" modifiers="property">
  ...
  <Function id="qiskit.pulse.AcquireChannel.name" signature="name" modifiers="property">
  ...
  <Function id="qiskit.pulse.AcquireChannel.parameters" signature="parameters" modifiers="property">
