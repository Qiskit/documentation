...
<span id="qiskit.circuit.library.SdgGate.__init__" />
...
| [`c_if`](#qiskit.circuit.library.SdgGate.c_if "qiskit.circuit.library.SdgGate.c_if")(classical, val)                                            | Add classical condition on register or cbit classical and value val.     |
...
| [`label`](#qiskit.circuit.library.SdgGate.label "qiskit.circuit.library.SdgGate.label")                            | Return instruction label                                                      |
...
<span id="qiskit.circuit.library.SdgGate.reverse_ops" />
...
<span id="qiskit.circuit.library.SdgGate.soft_compare" />
...
<span id="qiskit.circuit.library.SdgGate.validate_parameter" />
