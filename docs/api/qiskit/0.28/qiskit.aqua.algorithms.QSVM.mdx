...
<Class id="qiskit.aqua.algorithms.QSVM" github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/aqua/algorithms/classifiers/qsvm/qsvm.py" signature="QSVM(feature_map, training_dataset=None, test_dataset=None, datapoints=None, multiclass_extension=None, lambda2=0.001, quantum_instance=None)">
  ...
  **Raises**
  ...
  <Function id="qiskit.aqua.algorithms.QSVM.__init__" name="__init__" signature="__init__(feature_map, training_dataset=None, test_dataset=None, datapoints=None, multiclass_extension=None, lambda2=0.001, quantum_instance=None)">
    **Parameters**
  ...
  <Function id="qiskit.aqua.algorithms.QSVM.backend" name="backend" signature="property backend">
    Returns backend.
  ...
  <Function id="qiskit.aqua.algorithms.QSVM.construct_circuit" name="construct_circuit" signature="construct_circuit(x1, x2, measurement=False)">
  ...
  <Function id="qiskit.aqua.algorithms.QSVM.construct_kernel_matrix" name="construct_kernel_matrix" signature="construct_kernel_matrix(x1_vec, x2_vec=None, quantum_instance=None)">
  ...
  <Function id="qiskit.aqua.algorithms.QSVM.get_kernel_matrix" name="get_kernel_matrix" signature="static get_kernel_matrix(quantum_instance, feature_map, x1_vec, x2_vec=None, enforce_psd=True)">
    Construct kernel matrix, if x2\_vec is None, self-innerproduct is conducted.
  ...
  <Function id="qiskit.aqua.algorithms.QSVM.load_model" name="load_model" signature="load_model(file_path)">
  ...
  <Function id="qiskit.aqua.algorithms.QSVM.predict" name="predict" signature="predict(data, quantum_instance=None)">
  ...
  <Function id="qiskit.aqua.algorithms.QSVM.quantum_instance" name="quantum_instance" signature="property quantum_instance">
  ...
  <Function id="qiskit.aqua.algorithms.QSVM.random" name="random" signature="property random">
    Return a numpy random.
  </Function>

  ### ret

  <Function id="qiskit.aqua.algorithms.QSVM.ret" name="ret" signature="property ret">
    returns result
  </Function>

  ### run

  <Function id="qiskit.aqua.algorithms.QSVM.run" name="run" signature="run(quantum_instance=None, **kwargs)">
  ...
  <Function id="qiskit.aqua.algorithms.QSVM.save_model" name="save_model" signature="save_model(file_path)">
  ...
  <Function id="qiskit.aqua.algorithms.QSVM.set_backend" name="set_backend" signature="set_backend(backend, **kwargs)">
  ...
  <Function id="qiskit.aqua.algorithms.QSVM.setup_datapoint" name="setup_datapoint" signature="setup_datapoint(datapoints)">
  ...
  <Function id="qiskit.aqua.algorithms.QSVM.setup_test_data" name="setup_test_data" signature="setup_test_data(test_dataset)">
  ...
  <Function id="qiskit.aqua.algorithms.QSVM.setup_training_data" name="setup_training_data" signature="setup_training_data(training_dataset)">
  ...
  <Function id="qiskit.aqua.algorithms.QSVM.test" name="test" signature="test(data, labels, quantum_instance=None)">
    Test the svm.
  ...
  <Function id="qiskit.aqua.algorithms.QSVM.train" name="train" signature="train(data, labels, quantum_instance=None)">
    Train the svm.
