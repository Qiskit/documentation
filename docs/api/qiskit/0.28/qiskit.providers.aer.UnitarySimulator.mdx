...
<Class id="qiskit.providers.aer.UnitarySimulator" github="https://github.com/qiskit/qiskit-aer/tree/stable/0.8/qiskit/providers/aer/backends/unitary_simulator.py" signature="UnitarySimulator(configuration=None, properties=None, provider=None, **backend_options)">
  ...
  **Raises**
  ...
  <Function id="qiskit.providers.aer.UnitarySimulator.run" name="run" signature="run(circuits, backend_options=None, validate=False, **run_options)">
  ...
  <Function id="qiskit.providers.aer.UnitarySimulator.set_option" name="set_option" signature="set_option(key, value)">
  ...
  <Function id="qiskit.providers.aer.UnitarySimulator.set_options" name="set_options" signature="set_options(**fields)">
