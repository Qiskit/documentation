---
title: IQXStandard (v0.28)
description: API reference for qiskit.visualization.pulse_v2.IQXStandard in qiskit v0.28
in_page_toc_min_heading_level: 1
python_api_type: class
python_api_name: qiskit.visualization.pulse_v2.IQXStandard
---

<span id="qiskit-visualization-pulse-v2-iqxstandard" />
