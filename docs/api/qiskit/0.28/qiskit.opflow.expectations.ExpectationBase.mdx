...
<Class id="qiskit.opflow.expectations.ExpectationBase" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/opflow/expectations/expectation_base.py" signature="ExpectationBase">
  ...
  <Function id="qiskit.opflow.expectations.ExpectationBase.__init__" name="__init__" signature="__init__()">
  ...
  <Function id="qiskit.opflow.expectations.ExpectationBase.compute_variance" name="compute_variance" signature="abstract compute_variance(exp_op)">
  ...
  <Function id="qiskit.opflow.expectations.ExpectationBase.convert" name="convert" signature="abstract convert(operator)">
