...
<Function id="qiskit.ignis.verification.expectation_counts" github="https://github.com/qiskit-community/qiskit-ignis/tree/stable/0.6/qiskit/ignis/verification/tomography/data.py" signature="expectation_counts(counts)">
