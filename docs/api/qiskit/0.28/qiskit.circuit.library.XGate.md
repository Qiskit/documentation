# qiskit.circuit.library.XGate[¶](#qiskit-circuit-library-xgate "Permalink to this headline")
...
| [`c_if`](#qiskit.circuit.library.XGate.c_if "qiskit.circuit.library.XGate.c_if")(classical, val)                                            | Add classical condition on register or cbit classical and value val.     |
...
| [`label`](#qiskit.circuit.library.XGate.label "qiskit.circuit.library.XGate.label")                            | Return instruction label                                                      |
