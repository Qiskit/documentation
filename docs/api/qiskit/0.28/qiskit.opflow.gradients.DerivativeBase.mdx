---
title: DerivativeBase (v0.28)
description: API reference for qiskit.opflow.gradients.DerivativeBase in qiskit v0.28
...
<Class id="qiskit.opflow.gradients.DerivativeBase" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/opflow/gradients/derivative_base.py" signature="DerivativeBase" modifiers="class">
