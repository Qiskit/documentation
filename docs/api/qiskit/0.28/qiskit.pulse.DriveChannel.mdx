...
<Class id="qiskit.pulse.DriveChannel" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/pulse/channels.py" signature="DriveChannel(index)">
  ...
  **index** (`int`) – Index of channel.
  ...
  <Function id="qiskit.pulse.DriveChannel.index" signature="property index">
  ...
  <Function id="qiskit.pulse.DriveChannel.name" signature="property name">
  ...
  <Function id="qiskit.pulse.DriveChannel.parameters" signature="property parameters">
