...
<Class id="qiskit.pulse.DriveChannel" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/pulse/channels.py" signature="DriveChannel(index)">
  ...
  **index** (`int`) – Index of channel.
  ...
  <Function id="qiskit.pulse.DriveChannel.__init__" name="__init__" signature="__init__(index)">
    Channel class.
  ...
  <Function id="qiskit.pulse.DriveChannel.assign" name="assign" signature="assign(parameter, value)">
  ...
  <Function id="qiskit.pulse.DriveChannel.index" name="index" signature="property index">
  ...
  <Function id="qiskit.pulse.DriveChannel.is_parameterized" name="is_parameterized" signature="is_parameterized()">
  ...
  <Function id="qiskit.pulse.DriveChannel.name" name="name" signature="property name">
  ...
  <Function id="qiskit.pulse.DriveChannel.parameters" name="parameters" signature="property parameters">
