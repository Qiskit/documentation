...
<Class id="qiskit.pulse.DriveChannel" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/pulse/channels.py" signature="DriveChannel(index)" modifiers="class">
  ...
  **index** (`int`) – Index of channel.
  ...
  <Function id="qiskit.pulse.DriveChannel.index" signature="index" modifiers="property">
  ...
  <Function id="qiskit.pulse.DriveChannel.name" signature="name" modifiers="property">
  ...
  <Function id="qiskit.pulse.DriveChannel.parameters" signature="parameters" modifiers="property">
