...
$$
  ...
  **Additional Information:**
  ...
  <Function id="qiskit.quantum_info.PauliTable.__init__" name="__init__" signature="__init__(data)">
    Initialize the PauliTable.
  ...
  <Function id="qiskit.quantum_info.PauliTable.X" name="X" signature="property X">
    The X block of the [`array`](#qiskit.quantum_info.PauliTable.array "qiskit.quantum_info.PauliTable.array").
  </Function>

  ### Z

  <Function id="qiskit.quantum_info.PauliTable.Z" name="Z" signature="property Z">
    The Z block of the [`array`](#qiskit.quantum_info.PauliTable.array "qiskit.quantum_info.PauliTable.array").
  </Function>

  ### adjoint

  <Function id="qiskit.quantum_info.PauliTable.adjoint" name="adjoint" signature="adjoint()">
    Return the adjoint of the Operator.
  </Function>

  ### anticommutes\_with\_all

  <Function id="qiskit.quantum_info.PauliTable.anticommutes_with_all" name="anticommutes_with_all" signature="anticommutes_with_all(other)">
  ...
  <Function id="qiskit.quantum_info.PauliTable.argsort" name="argsort" signature="argsort(weight=False)">
  ...
  <Function id="qiskit.quantum_info.PauliTable.array" name="array" signature="property array">
    The underlying boolean array.
  </Function>

  ### commutes

  <Function id="qiskit.quantum_info.PauliTable.commutes" name="commutes" signature="commutes(pauli)">
  ...
  <Function id="qiskit.quantum_info.PauliTable.commutes_with_all" name="commutes_with_all" signature="commutes_with_all(other)">
    Return indexes of rows that commute other.
  ...
  <Function id="qiskit.quantum_info.PauliTable.compose" name="compose" signature="compose(other, qargs=None, front=True)">
  ...
  <Function id="qiskit.quantum_info.PauliTable.conjugate" name="conjugate" signature="conjugate()">
    Not implemented.
  </Function>

  ### copy

  <Function id="qiskit.quantum_info.PauliTable.copy" name="copy" signature="copy()">
    Make a deep copy of current operator.
  </Function>

  ### delete

  <Function id="qiskit.quantum_info.PauliTable.delete" name="delete" signature="delete(ind, qubit=False)">
  ...
  <Function id="qiskit.quantum_info.PauliTable.dim" name="dim" signature="property dim">
    Return tuple (input\_shape, output\_shape).
  </Function>

  ### dot

  <Function id="qiskit.quantum_info.PauliTable.dot" name="dot" signature="dot(other, qargs=None)">
  ...
  <Function id="qiskit.quantum_info.PauliTable.expand" name="expand" signature="expand(other)">
  ...
  <Function id="qiskit.quantum_info.PauliTable.from_labels" name="from_labels" signature="classmethod from_labels(labels)">
  ...
  <Function id="qiskit.quantum_info.PauliTable.input_dims" name="input_dims" signature="input_dims(qargs=None)">
    Return tuple of input dimension for specified subsystems.
  </Function>

  ### insert

  <Function id="qiskit.quantum_info.PauliTable.insert" name="insert" signature="insert(ind, value, qubit=False)">
  ...
  <Function id="qiskit.quantum_info.PauliTable.label_iter" name="label_iter" signature="label_iter()">
  ...
  <Function id="qiskit.quantum_info.PauliTable.matrix_iter" name="matrix_iter" signature="matrix_iter(sparse=False)">
  ...
  <Function id="qiskit.quantum_info.PauliTable.num_qubits" name="num_qubits" signature="property num_qubits">
    Return the number of qubits if a N-qubit operator or None otherwise.
  </Function>

  ### output\_dims

  <Function id="qiskit.quantum_info.PauliTable.output_dims" name="output_dims" signature="output_dims(qargs=None)">
    Return tuple of output dimension for specified subsystems.
  </Function>

  ### power

  <Function id="qiskit.quantum_info.PauliTable.power" name="power" signature="power(n)">
  ...
  <Function id="qiskit.quantum_info.PauliTable.qargs" name="qargs" signature="property qargs">
    Return the qargs for the operator.
  </Function>

  ### reshape

  <Function id="qiskit.quantum_info.PauliTable.reshape" name="reshape" signature="reshape(input_dims=None, output_dims=None, num_qubits=None)">
  ...
  <Function id="qiskit.quantum_info.PauliTable.settings" name="settings" signature="property settings">
    Return settings.
  ...
  <Function id="qiskit.quantum_info.PauliTable.shape" name="shape" signature="property shape">
    The full shape of the [`array()`](#qiskit.quantum_info.PauliTable.array "qiskit.quantum_info.PauliTable.array")
  </Function>

  ### size

  <Function id="qiskit.quantum_info.PauliTable.size" name="size" signature="property size">
    The number of Pauli rows in the table.
  </Function>

  ### sort

  <Function id="qiskit.quantum_info.PauliTable.sort" name="sort" signature="sort(weight=False)">
  ...
  <Function id="qiskit.quantum_info.PauliTable.tensor" name="tensor" signature="tensor(other)">
  ...
  <Function id="qiskit.quantum_info.PauliTable.to_labels" name="to_labels" signature="to_labels(array=False)">
  ...
  <Function id="qiskit.quantum_info.PauliTable.to_matrix" name="to_matrix" signature="to_matrix(sparse=False, array=False)">
  ...
  <Function id="qiskit.quantum_info.PauliTable.transpose" name="transpose" signature="transpose()">
    Not implemented.
  </Function>

  ### unique

  <Function id="qiskit.quantum_info.PauliTable.unique" name="unique" signature="unique(return_index=False, return_counts=False)">
