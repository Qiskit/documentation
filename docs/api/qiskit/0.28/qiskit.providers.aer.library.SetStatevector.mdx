...
<Class id="qiskit.providers.aer.library.SetStatevector" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-aer/tree/stable/0.8/qiskit/providers/aer/library/set_instructions/set_statevector.py" signature="SetStatevector(state)">
  ...
  **ExtensionError** – if the input is not a valid state.
  ...
  <Function id="qiskit.providers.aer.library.SetStatevector.__init__" name="__init__" signature="__init__(state)">
    Create new instruction to set the statevector state of the simulator.
  ...
  <Function id="qiskit.providers.aer.library.SetStatevector.add_decomposition" name="add_decomposition" signature="add_decomposition(decomposition)">
    Add a decomposition of the instruction to the SessionEquivalenceLibrary.
  </Function>

  ### assemble

  <Function id="qiskit.providers.aer.library.SetStatevector.assemble" name="assemble" signature="assemble()">
    Assemble a QasmQobjInstruction
  </Function>

  ### broadcast\_arguments

  <Function id="qiskit.providers.aer.library.SetStatevector.broadcast_arguments" name="broadcast_arguments" signature="broadcast_arguments(qargs, cargs)">
  ...
  <Function id="qiskit.providers.aer.library.SetStatevector.c_if" name="c_if" signature="c_if(classical, val)">
    Add classical condition on register or cbit classical and value val.
  </Function>

  ### copy

  <Function id="qiskit.providers.aer.library.SetStatevector.copy" name="copy" signature="copy(name=None)">
  ...
  <Function id="qiskit.providers.aer.library.SetStatevector.decompositions" name="decompositions" signature="property decompositions">
    Get the decompositions of the instruction from the SessionEquivalenceLibrary.
  </Function>

  ### definition

  <Function id="qiskit.providers.aer.library.SetStatevector.definition" name="definition" signature="property definition">
    Return definition in terms of other basic gates.
  </Function>

  ### duration

  <Function id="qiskit.providers.aer.library.SetStatevector.duration" name="duration" signature="property duration">
    Get the duration.
  </Function>

  ### inverse

  <Function id="qiskit.providers.aer.library.SetStatevector.inverse" name="inverse" signature="inverse()">
  ...
  <Function id="qiskit.providers.aer.library.SetStatevector.is_parameterized" name="is_parameterized" signature="is_parameterized()">
    Return True .IFF. instruction is parameterized else False
  </Function>

  ### label

  <Function id="qiskit.providers.aer.library.SetStatevector.label" name="label" signature="property label">
  ...
  <Function id="qiskit.providers.aer.library.SetStatevector.mirror" name="mirror" signature="mirror()">
  ...
  <Function id="qiskit.providers.aer.library.SetStatevector.params" name="params" signature="property params">
    return instruction params.
  </Function>

  ### qasm

  <Function id="qiskit.providers.aer.library.SetStatevector.qasm" name="qasm" signature="qasm()">
  ...
  <Function id="qiskit.providers.aer.library.SetStatevector.repeat" name="repeat" signature="repeat(n)">
  ...
  <Function id="qiskit.providers.aer.library.SetStatevector.reverse_ops" name="reverse_ops" signature="reverse_ops()">
  ...
  <Function id="qiskit.providers.aer.library.SetStatevector.soft_compare" name="soft_compare" signature="soft_compare(other)">
  ...
  <Function id="qiskit.providers.aer.library.SetStatevector.unit" name="unit" signature="property unit">
    Get the time unit of duration.
  </Function>

  ### validate\_parameter

  <Function id="qiskit.providers.aer.library.SetStatevector.validate_parameter" name="validate_parameter" signature="validate_parameter(parameter)">
