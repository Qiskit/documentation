...
<Class id="qiskit.providers.aer.library.SetStatevector" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-aer/tree/stable/0.8/qiskit/providers/aer/library/set_instructions/set_statevector.py" signature="SetStatevector(state)" modifiers="class">
  ...
  **ExtensionError** – if the input is not a valid state.
  ...
  <Function id="qiskit.providers.aer.library.SetStatevector.decompositions" signature="decompositions" modifiers="property">
    Get the decompositions of the instruction from the SessionEquivalenceLibrary.
  </Function>

  ### definition

  <Function id="qiskit.providers.aer.library.SetStatevector.definition" signature="definition" modifiers="property">
    Return definition in terms of other basic gates.
  </Function>

  ### duration

  <Function id="qiskit.providers.aer.library.SetStatevector.duration" signature="duration" modifiers="property">
    Get the duration.
  </Function>
  ...
  <Function id="qiskit.providers.aer.library.SetStatevector.label" signature="label" modifiers="property">
  ...
  <Function id="qiskit.providers.aer.library.SetStatevector.params" signature="params" modifiers="property">
  ...
  <Function id="qiskit.providers.aer.library.SetStatevector.unit" signature="unit" modifiers="property">
