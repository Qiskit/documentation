---
title: ExpectationFactory (v0.28)
description: API reference for qiskit.aqua.operators.expectations.ExpectationFactory in qiskit v0.28
...
<Class id="qiskit.aqua.operators.expectations.ExpectationFactory" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/aqua/operators/expectations/expectation_factory.py" signature="ExpectationFactory" modifiers="class">
  ...
  <Function id="qiskit.aqua.operators.expectations.ExpectationFactory.__init__" signature="__init__()">
  ...
  <Function id="qiskit.aqua.operators.expectations.ExpectationFactory.build" signature="build(operator, backend=None, include_custom=True)" modifiers="static">
