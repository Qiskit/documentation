...
<Class id="qiskit.algorithms.PhaseEstimation" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/algorithms/phase_estimators/phase_estimation.py" signature="PhaseEstimation(num_evaluation_qubits, quantum_instance=None)">
...
$$
  ...
  *   **quantum\_instance** (`Union`\[`Backend`, `BaseBackend`, `QuantumInstance`, `None`]) – The quantum instance on which the circuit will be run.
  ...
  <Function id="qiskit.algorithms.PhaseEstimation.__init__" name="__init__" signature="__init__(num_evaluation_qubits, quantum_instance=None)">
    **Parameters**
  ...
  <Function id="qiskit.algorithms.PhaseEstimation.construct_circuit" name="construct_circuit" signature="construct_circuit(unitary, state_preparation=None)">
  ...
  <Function id="qiskit.algorithms.PhaseEstimation.estimate" name="estimate" signature="estimate(unitary=None, state_preparation=None, pe_circuit=None, num_unitary_qubits=None)">
  ...
  <Function id="qiskit.algorithms.PhaseEstimation.estimate_from_pe_circuit" name="estimate_from_pe_circuit" signature="estimate_from_pe_circuit(pe_circuit, num_unitary_qubits)">
