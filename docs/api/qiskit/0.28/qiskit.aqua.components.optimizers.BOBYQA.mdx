...
<Class id="qiskit.aqua.components.optimizers.BOBYQA" github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/aqua/components/optimizers/bobyqa.py" signature="BOBYQA(maxiter=1000)">
