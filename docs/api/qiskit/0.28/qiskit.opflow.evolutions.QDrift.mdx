...
<Class id="qiskit.opflow.evolutions.QDrift" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/opflow/evolutions/trotterizations/qdrift.py" signature="QDrift(reps=1)">
  ...
  **reps** (`int`) – The number of times to repeat the Trotterization circuit.
  ...
  <Function id="qiskit.opflow.evolutions.QDrift.__init__" name="__init__" signature="__init__(reps=1)">
    **Parameters**
  ...
  <Function id="qiskit.opflow.evolutions.QDrift.convert" name="convert" signature="convert(operator)">
  ...
  <Function id="qiskit.opflow.evolutions.QDrift.reps" name="reps" signature="property reps">
