...
<Class id="qiskit.pulse.ShiftPhase" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/pulse/instructions/phase.py" signature="ShiftPhase(phase, channel, name=None)">
...
$$
  ...
  *   **name** (`Optional`\[`str`]) – Display name for this instruction.
  ...
  <Function id="qiskit.pulse.ShiftPhase.__init__" name="__init__" signature="__init__(phase, channel, name=None)">
    Instantiate a shift phase instruction, increasing the output signal phase on `channel` by `phase` \[radians].
  ...
  <Function id="qiskit.pulse.ShiftPhase.append" name="append" signature="append(schedule, name=None)">
  ...
  <Function id="qiskit.pulse.ShiftPhase.assign_parameters" name="assign_parameters" signature="assign_parameters(value_dict)">
  ...
  <Function id="qiskit.pulse.ShiftPhase.ch_duration" name="ch_duration" signature="ch_duration(*channels)">
  ...
  <Function id="qiskit.pulse.ShiftPhase.ch_start_time" name="ch_start_time" signature="ch_start_time(*channels)">
  ...
  <Function id="qiskit.pulse.ShiftPhase.ch_stop_time" name="ch_stop_time" signature="ch_stop_time(*channels)">
  ...
  <Function id="qiskit.pulse.ShiftPhase.channel" name="channel" signature="property channel">
  ...
  <Function id="qiskit.pulse.ShiftPhase.channels" name="channels" signature="property channels">
  ...
  <Function id="qiskit.pulse.ShiftPhase.draw" name="draw" signature="draw(dt=1, style=None, filename=None, interp_method=None, scale=1, plot_all=False, plot_range=None, interactive=False, table=True, label=False, framechange=True, channels=None)">
  ...
  <Function id="qiskit.pulse.ShiftPhase.duration" name="duration" signature="property duration">
  ...
  <Function id="qiskit.pulse.ShiftPhase.flatten" name="flatten" signature="flatten()">
  ...
  <Function id="qiskit.pulse.ShiftPhase.id" name="id" signature="property id">
  ...
  <Function id="qiskit.pulse.ShiftPhase.insert" name="insert" signature="insert(start_time, schedule, name=None)">
  ...
  <Function id="qiskit.pulse.ShiftPhase.instructions" name="instructions" signature="property instructions">
  ...
  <Function id="qiskit.pulse.ShiftPhase.is_parameterized" name="is_parameterized" signature="is_parameterized()">
  ...
  <Function id="qiskit.pulse.ShiftPhase.name" name="name" signature="property name">
  ...
  <Function id="qiskit.pulse.ShiftPhase.operands" name="operands" signature="property operands">
  ...
  <Function id="qiskit.pulse.ShiftPhase.parameters" name="parameters" signature="property parameters">
  ...
  <Function id="qiskit.pulse.ShiftPhase.phase" name="phase" signature="property phase">
  ...
  <Function id="qiskit.pulse.ShiftPhase.shift" name="shift" signature="shift(time, name=None)">
  ...
  <Function id="qiskit.pulse.ShiftPhase.start_time" name="start_time" signature="property start_time">
  ...
  <Function id="qiskit.pulse.ShiftPhase.stop_time" name="stop_time" signature="property stop_time">
