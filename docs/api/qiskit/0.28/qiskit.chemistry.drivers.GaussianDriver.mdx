...
<Class id="qiskit.chemistry.drivers.GaussianDriver" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/chemistry/drivers/gaussiand/gaussiandriver.py" signature="GaussianDriver(config='# rhf/sto-3g scf(conventional)\\n\\nh2 molecule\\n\\n0 1\\nH 0.0 0.0 0.0\\nH 0.0 0.0 0.735\\n\\n', molecule=None, basis='sto-3g', hf_method=<HFMethodType.RHF: 'rhf'>)">
  ...
  **Raises**
  ...
  <Function id="qiskit.chemistry.drivers.GaussianDriver.__init__" name="__init__" signature="__init__(config='# rhf/sto-3g scf(conventional)\\n\\nh2 molecule\\n\\n0 1\\nH 0.0 0.0 0.0\\nH 0.0 0.0 0.735\\n\\n', molecule=None, basis='sto-3g', hf_method=<HFMethodType.RHF: 'rhf'>)">
    **Parameters**
  ...
  <Function id="qiskit.chemistry.drivers.GaussianDriver.basis" name="basis" signature="property basis">
    return basis
  ...
  <Function id="qiskit.chemistry.drivers.GaussianDriver.hf_method" name="hf_method" signature="property hf_method">
  ...
  <Function id="qiskit.chemistry.drivers.GaussianDriver.molecule" name="molecule" signature="property molecule">
    return molecule
  ...
  <Function id="qiskit.chemistry.drivers.GaussianDriver.run" name="run" signature="run()">
  ...
  <Function id="qiskit.chemistry.drivers.GaussianDriver.supports_molecule" name="supports_molecule" signature="property supports_molecule">
