...
<Class id="qiskit.circuit.library.C3SXGate" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/circuit/library/standard_gates/x.py" signature="C3SXGate(label=None, ctrl_state=None, *, angle=None)" modifiers="class">
  ...
  *   **angle** (*float*) – DEPRECATED. The angle used in the controlled-U1 gates. An angle of π/8 yields the sqrt(X) gates, an angle of π/4 the 3-qubit controlled X gate.
  ...
  <Function id="qiskit.circuit.library.C3SXGate.ctrl_state" signature="ctrl_state" modifiers="property">
  ...
  <Function id="qiskit.circuit.library.C3SXGate.decompositions" signature="decompositions" modifiers="property">
    Get the decompositions of the instruction from the SessionEquivalenceLibrary.
  </Function>

  ### definition

  <Function id="qiskit.circuit.library.C3SXGate.definition" signature="definition" modifiers="property">
  ...
  <Function id="qiskit.circuit.library.C3SXGate.duration" signature="duration" modifiers="property">
    Get the duration.
  </Function>
  ...
  <Function id="qiskit.circuit.library.C3SXGate.label" signature="label" modifiers="property">
  ...
  <Function id="qiskit.circuit.library.C3SXGate.name" signature="name" modifiers="property">
  ...
  <Function id="qiskit.circuit.library.C3SXGate.num_ctrl_qubits" signature="num_ctrl_qubits" modifiers="property">
  ...
  <Function id="qiskit.circuit.library.C3SXGate.params" signature="params" modifiers="property">
  ...
  <Function id="qiskit.circuit.library.C3SXGate.unit" signature="unit" modifiers="property">
