...
<Class id="qiskit.circuit.Gate" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/circuit/gate.py" signature="Gate(name, num_qubits, params, label=None)">
  ...
  *   **label** (`Optional`\[`str`]) – An optional label for the gate.
  ...
  <Function id="qiskit.circuit.Gate.__init__" name="__init__" signature="__init__(name, num_qubits, params, label=None)">
    Create a new gate.
  ...
  <Function id="qiskit.circuit.Gate.control" name="control" signature="control(num_ctrl_qubits=1, label=None, ctrl_state=None)">
  ...
  <Function id="qiskit.circuit.Gate.decompositions" name="decompositions" signature="property decompositions">
    Get the decompositions of the instruction from the SessionEquivalenceLibrary.
  </Function>

  ### definition

  <Function id="qiskit.circuit.Gate.definition" name="definition" signature="property definition">
    Return definition in terms of other basic gates.
  </Function>

  ### duration

  <Function id="qiskit.circuit.Gate.duration" name="duration" signature="property duration">
    Get the duration.
  </Function>

  ### inverse

  <Function id="qiskit.circuit.Gate.inverse" name="inverse" signature="inverse()">
  ...
  <Function id="qiskit.circuit.Gate.label" name="label" signature="property label">
  ...
  <Function id="qiskit.circuit.Gate.mirror" name="mirror" signature="mirror()">
  ...
  <Function id="qiskit.circuit.Gate.params" name="params" signature="property params">
  ...
  <Function id="qiskit.circuit.Gate.qasm" name="qasm" signature="qasm()">
  ...
  <Function id="qiskit.circuit.Gate.unit" name="unit" signature="property unit">
