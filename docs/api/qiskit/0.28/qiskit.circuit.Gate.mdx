...
<Class id="qiskit.circuit.Gate" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/circuit/gate.py" signature="Gate(name, num_qubits, params, label=None)" modifiers="class">
  Unitary gate.
  ...
  *   **label** (`Optional`\[`str`]) – An optional label for the gate.
  ...
  <Function id="qiskit.circuit.Gate.__init__" signature="__init__(name, num_qubits, params, label=None)">
    Create a new gate.
  ...
  <Function id="qiskit.circuit.Gate.decompositions" signature="decompositions" modifiers="property">
    Get the decompositions of the instruction from the SessionEquivalenceLibrary.
  </Function>

  ### definition

  <Function id="qiskit.circuit.Gate.definition" signature="definition" modifiers="property">
    Return definition in terms of other basic gates.
  </Function>

  ### duration

  <Function id="qiskit.circuit.Gate.duration" signature="duration" modifiers="property">
    Get the duration.
  </Function>
  ...
  <Function id="qiskit.circuit.Gate.label" signature="label" modifiers="property">
  ...
  <Function id="qiskit.circuit.Gate.mirror" signature="mirror()">
  ...
  <Function id="qiskit.circuit.Gate.params" signature="params" modifiers="property">
  ...
  <Function id="qiskit.circuit.Gate.unit" signature="unit" modifiers="property">
