...
<Class id="qiskit.circuit.Gate" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/circuit/gate.py" signature="Gate(name, num_qubits, params, label=None)">
  ...
  *   **label** (`Optional`\[`str`]) – An optional label for the gate.
  ...
  <Function id="qiskit.circuit.Gate.decompositions" signature="property decompositions">
    Get the decompositions of the instruction from the SessionEquivalenceLibrary.
  </Function>

  ### definition

  <Function id="qiskit.circuit.Gate.definition" signature="property definition">
    Return definition in terms of other basic gates.
  </Function>

  ### duration

  <Function id="qiskit.circuit.Gate.duration" signature="property duration">
    Get the duration.
  </Function>
  ...
  <Function id="qiskit.circuit.Gate.label" signature="property label">
  ...
  <Function id="qiskit.circuit.Gate.params" signature="property params">
  ...
  <Function id="qiskit.circuit.Gate.unit" signature="property unit">
