...
<Class id="qiskit.providers.models.Command" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/providers/models/pulsedefaults.py" signature="Command(name, qubits=None, sequence=None, **kwargs)">
  Class representing a Command.

  ### name

  <Attribute id="qiskit.providers.models.Command.name" name="name">
    Pulse command name.
  </Attribute>
  ...
  *   **kwargs** – Optional additional fields
  ...
  <Function id="qiskit.providers.models.Command.__init__" name="__init__" signature="__init__(name, qubits=None, sequence=None, **kwargs)">
    Initialize a Command object
  ...
  <Function id="qiskit.providers.models.Command.from_dict" name="from_dict" signature="classmethod from_dict(data)">
  ...
  <Function id="qiskit.providers.models.Command.to_dict" name="to_dict" signature="to_dict()">
