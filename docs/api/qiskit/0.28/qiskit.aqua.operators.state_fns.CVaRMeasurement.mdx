...
<Class id="qiskit.aqua.operators.state_fns.CVaRMeasurement" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/aqua/operators/state_fns/cvar_measurement.py" signature="CVaRMeasurement(primitive=None, alpha=1.0, coeff=1.0)">
  ...
  *   [**AquaError**](qiskit.aqua.AquaError "qiskit.aqua.AquaError") – If the primitive is not diagonal.
  ...
  <Function id="qiskit.aqua.operators.state_fns.CVaRMeasurement.alpha" signature="property alpha">
  ...
  <Function id="qiskit.aqua.operators.state_fns.CVaRMeasurement.coeff" signature="property coeff">
  ...
  <Function id="qiskit.aqua.operators.state_fns.CVaRMeasurement.compute_cvar" signature="compute_cvar(energies, probabilities)">
  ...
  <Function id="qiskit.aqua.operators.state_fns.CVaRMeasurement.eval_variance" signature="eval_variance(front=None)">
  ...
  <Function id="qiskit.aqua.operators.state_fns.CVaRMeasurement.get_outcome_energies_probabilities" signature="get_outcome_energies_probabilities(front=None)">
  ...
  <Function id="qiskit.aqua.operators.state_fns.CVaRMeasurement.is_measurement" signature="property is_measurement">
  ...
  <Function id="qiskit.aqua.operators.state_fns.CVaRMeasurement.num_qubits" signature="property num_qubits">
  ...
  <Function id="qiskit.aqua.operators.state_fns.CVaRMeasurement.parameters" signature="property parameters">
  ...
  <Function id="qiskit.aqua.operators.state_fns.CVaRMeasurement.primitive" signature="property primitive">
