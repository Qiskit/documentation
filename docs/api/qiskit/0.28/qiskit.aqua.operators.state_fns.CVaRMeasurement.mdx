...
<Class id="qiskit.aqua.operators.state_fns.CVaRMeasurement" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/aqua/operators/state_fns/cvar_measurement.py" signature="CVaRMeasurement(primitive=None, alpha=1.0, coeff=1.0)" modifiers="class">
  ...
  *   [**AquaError**](qiskit.aqua.AquaError "qiskit.aqua.AquaError") – If the primitive is not diagonal.
  ...
  <Function id="qiskit.aqua.operators.state_fns.CVaRMeasurement.alpha" signature="alpha" modifiers="property">
  ...
  <Function id="qiskit.aqua.operators.state_fns.CVaRMeasurement.coeff" signature="coeff" modifiers="property">
  ...
  <Function id="qiskit.aqua.operators.state_fns.CVaRMeasurement.is_measurement" signature="is_measurement" modifiers="property">
  ...
  <Function id="qiskit.aqua.operators.state_fns.CVaRMeasurement.num_qubits" signature="num_qubits" modifiers="property">
  ...
  <Function id="qiskit.aqua.operators.state_fns.CVaRMeasurement.parameters" signature="parameters" modifiers="property">
  ...
  <Function id="qiskit.aqua.operators.state_fns.CVaRMeasurement.primitive" signature="primitive" modifiers="property">
