...
<Class id="qiskit.providers.aer.library.SaveAmplitudesSquared" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-aer/tree/stable/0.8/qiskit/providers/aer/library/save_instructions/save_amplitudes.py" signature="SaveAmplitudesSquared(num_qubits, params, label='amplitudes_squared', unnormalized=False, pershot=False, conditional=False)" modifiers="class">
  ...
  **ExtensionError** – if params is invalid for the specified number of qubits.
  ...
  <Function id="qiskit.providers.aer.library.SaveAmplitudesSquared.decompositions" signature="decompositions" modifiers="property">
    Get the decompositions of the instruction from the SessionEquivalenceLibrary.
  </Function>

  ### definition

  <Function id="qiskit.providers.aer.library.SaveAmplitudesSquared.definition" signature="definition" modifiers="property">
    Return definition in terms of other basic gates.
  </Function>

  ### duration

  <Function id="qiskit.providers.aer.library.SaveAmplitudesSquared.duration" signature="duration" modifiers="property">
    Get the duration.
  </Function>
  ...
  <Function id="qiskit.providers.aer.library.SaveAmplitudesSquared.label" signature="label" modifiers="property">
  ...
  <Function id="qiskit.providers.aer.library.SaveAmplitudesSquared.params" signature="params" modifiers="property">
  ...
  <Function id="qiskit.providers.aer.library.SaveAmplitudesSquared.unit" signature="unit" modifiers="property">
