...
<Class id="qiskit.providers.ibmq.runtime.ResultDecoder" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-ibmq-provider/tree/stable/0.15/qiskit/providers/ibmq/runtime/program/result_decoder.py" signature="ResultDecoder">
  ...
  <Function id="qiskit.providers.ibmq.runtime.ResultDecoder.__init__" name="__init__" signature="__init__()">
  ...
  <Function id="qiskit.providers.ibmq.runtime.ResultDecoder.decode" name="decode" signature="classmethod decode(data)">
