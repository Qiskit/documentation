...
<Class id="qiskit.opflow.evolutions.Suzuki" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/opflow/evolutions/trotterizations/suzuki.py" signature="Suzuki(reps=1, order=2)" modifiers="class">
  ...
  *   **order** (`int`) – The order of the expansion to perform.
  ...
  <Function id="qiskit.opflow.evolutions.Suzuki.order" signature="order" modifiers="property">
    returns order
  ...
  <Function id="qiskit.opflow.evolutions.Suzuki.reps" signature="reps" modifiers="property">
