...
<Class id="qiskit.qobj.PulseQobjExperimentConfig" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/qobj/pulse_qobj.py" signature="PulseQobjExperimentConfig(qubit_lo_freq=None, meas_lo_freq=None, **kwargs)">
  ...
  *   **kwargs** – Additional free form key value fields to add to the configuration
  ...
  <Function id="qiskit.qobj.PulseQobjExperimentConfig.__init__" name="__init__" signature="__init__(qubit_lo_freq=None, meas_lo_freq=None, **kwargs)">
    Instantiate a PulseQobjExperimentConfig object.
  ...
  <Function id="qiskit.qobj.PulseQobjExperimentConfig.from_dict" name="from_dict" signature="classmethod from_dict(data)">
  ...
  <Function id="qiskit.qobj.PulseQobjExperimentConfig.to_dict" name="to_dict" signature="to_dict()">
