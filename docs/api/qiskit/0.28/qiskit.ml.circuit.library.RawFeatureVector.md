...
| [`pauli`](#qiskit.ml.circuit.library.RawFeatureVector.pauli "qiskit.ml.circuit.library.RawFeatureVector.pauli")(pauli\_string, qubits)                                                                          | Apply [`PauliGate`](qiskit.circuit.library.PauliGate#qiskit.circuit.library.PauliGate "qiskit.circuit.library.PauliGate").          |
