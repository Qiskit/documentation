...
<Class id="qiskit.circuit.library.RGate" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/circuit/library/standard_gates/r.py" signature="RGate(theta, phi)">
...
$$
  ...
  <Function id="qiskit.circuit.library.RGate.__init__" name="__init__" signature="__init__(theta, phi)">
    Create new r single-qubit gate.
  </Function>
  ...
  <Function id="qiskit.circuit.library.RGate.add_decomposition" name="add_decomposition" signature="add_decomposition(decomposition)">
    Add a decomposition of the instruction to the SessionEquivalenceLibrary.
  </Function>

  ### assemble

  <Function id="qiskit.circuit.library.RGate.assemble" name="assemble" signature="assemble()">
    Assemble a QasmQobjInstruction
  </Function>

  ### broadcast\_arguments

  <Function id="qiskit.circuit.library.RGate.broadcast_arguments" name="broadcast_arguments" signature="broadcast_arguments(qargs, cargs)">
  ...
  <Function id="qiskit.circuit.library.RGate.c_if" name="c_if" signature="c_if(classical, val)">
    Add classical condition on register or cbit classical and value val.
  </Function>

  ### control

  <Function id="qiskit.circuit.library.RGate.control" name="control" signature="control(num_ctrl_qubits=1, label=None, ctrl_state=None)">
  ...
  <Function id="qiskit.circuit.library.RGate.copy" name="copy" signature="copy(name=None)">
  ...
  <Function id="qiskit.circuit.library.RGate.decompositions" name="decompositions" signature="property decompositions">
    Get the decompositions of the instruction from the SessionEquivalenceLibrary.
  </Function>

  ### definition

  <Function id="qiskit.circuit.library.RGate.definition" name="definition" signature="property definition">
    Return definition in terms of other basic gates.
  </Function>

  ### duration

  <Function id="qiskit.circuit.library.RGate.duration" name="duration" signature="property duration">
    Get the duration.
  </Function>

  ### inverse

  <Function id="qiskit.circuit.library.RGate.inverse" name="inverse" signature="inverse()">
    Invert this gate.
  ...
  <Function id="qiskit.circuit.library.RGate.is_parameterized" name="is_parameterized" signature="is_parameterized()">
    Return True .IFF. instruction is parameterized else False
  </Function>

  ### label

  <Function id="qiskit.circuit.library.RGate.label" name="label" signature="property label">
  ...
  <Function id="qiskit.circuit.library.RGate.mirror" name="mirror" signature="mirror()">
  ...
  <Function id="qiskit.circuit.library.RGate.params" name="params" signature="property params">
    return instruction params.
  </Function>

  ### power

  <Function id="qiskit.circuit.library.RGate.power" name="power" signature="power(exponent)">
  ...
  <Function id="qiskit.circuit.library.RGate.qasm" name="qasm" signature="qasm()">
  ...
  <Function id="qiskit.circuit.library.RGate.repeat" name="repeat" signature="repeat(n)">
  ...
  <Function id="qiskit.circuit.library.RGate.reverse_ops" name="reverse_ops" signature="reverse_ops()">
  ...
  <Function id="qiskit.circuit.library.RGate.soft_compare" name="soft_compare" signature="soft_compare(other)">
  ...
  <Function id="qiskit.circuit.library.RGate.to_matrix" name="to_matrix" signature="to_matrix()">
  ...
  <Function id="qiskit.circuit.library.RGate.unit" name="unit" signature="property unit">
    Get the time unit of duration.
  </Function>

  ### validate\_parameter

  <Function id="qiskit.circuit.library.RGate.validate_parameter" name="validate_parameter" signature="validate_parameter(parameter)">
