---
title: shift_phase (v0.28)
description: API reference for qiskit.pulse.builder.shift_phase in qiskit v0.28
...
<Function id="qiskit.pulse.builder.shift_phase" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/pulse/builder.py" signature="shift_phase(phase, channel, name=None)">
