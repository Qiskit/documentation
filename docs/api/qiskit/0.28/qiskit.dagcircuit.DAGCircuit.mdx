...
<Class id="qiskit.dagcircuit.DAGCircuit" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/dagcircuit/dagcircuit.py" signature="DAGCircuit">
  ...
  <Function id="qiskit.dagcircuit.DAGCircuit.__init__" name="__init__" signature="__init__()">
    Create an empty circuit.
  </Function>
  ...
  <Function id="qiskit.dagcircuit.DAGCircuit.apply_operation_back" name="apply_operation_back" signature="apply_operation_back(op, qargs=None, cargs=None, condition=None)">
  ...
  <Function id="qiskit.dagcircuit.DAGCircuit.apply_operation_front" name="apply_operation_front" signature="apply_operation_front(op, qargs, cargs, condition=None)">
  ...
  <Function id="qiskit.dagcircuit.DAGCircuit.calibrations" name="calibrations" signature="property calibrations">
  ...
  <Function id="qiskit.dagcircuit.DAGCircuit.compose" name="compose" signature="compose(other, edge_map=None, qubits=None, clbits=None, front=False, inplace=True)">
  ...
  <Function id="qiskit.dagcircuit.DAGCircuit.compose_back" name="compose_back" signature="compose_back(input_circuit, edge_map=None)">
    DEPRECATED: use DAGCircuit.compose() instead.
  </Function>

  ### count\_ops

  <Function id="qiskit.dagcircuit.DAGCircuit.count_ops" name="count_ops" signature="count_ops()">
  ...
  <Function id="qiskit.dagcircuit.DAGCircuit.depth" name="depth" signature="depth()">
  ...
  <Function id="qiskit.dagcircuit.DAGCircuit.extend_back" name="extend_back" signature="extend_back(dag, edge_map=None)">
    DEPRECATED: Add dag at the end of self, using edge\_map.
  </Function>

  ### from\_networkx

  <Function id="qiskit.dagcircuit.DAGCircuit.from_networkx" name="from_networkx" signature="classmethod from_networkx(graph)">
  ...
  <Function id="qiskit.dagcircuit.DAGCircuit.global_phase" name="global_phase" signature="property global_phase">
  ...
  <Function id="qiskit.dagcircuit.DAGCircuit.node_counter" name="node_counter" signature="property node_counter">
  ...
  <Function id="qiskit.dagcircuit.DAGCircuit.size" name="size" signature="size()">
    Return the number of operations.
  </Function>

  ### substitute\_node

  <Function id="qiskit.dagcircuit.DAGCircuit.substitute_node" name="substitute_node" signature="substitute_node(node, op, inplace=False)">
  ...
  <Function id="qiskit.dagcircuit.DAGCircuit.substitute_node_with_dag" name="substitute_node_with_dag" signature="substitute_node_with_dag(node, input_dag, wires=None)">
  ...
  <Function id="qiskit.dagcircuit.DAGCircuit.threeQ_or_more_gates" name="threeQ_or_more_gates" signature="threeQ_or_more_gates()">
    Get list of 3-or-more-qubit gates: (id, data).
  </Function>

  ### to\_networkx

  <Function id="qiskit.dagcircuit.DAGCircuit.to_networkx" name="to_networkx" signature="to_networkx()">
    Returns a copy of the DAGCircuit in networkx format.
  </Function>

  ### topological\_nodes

  <Function id="qiskit.dagcircuit.DAGCircuit.topological_nodes" name="topological_nodes" signature="topological_nodes()">
  ...
  <Function id="qiskit.dagcircuit.DAGCircuit.topological_op_nodes" name="topological_op_nodes" signature="topological_op_nodes()">
  ...
  <Function id="qiskit.dagcircuit.DAGCircuit.twoQ_gates" name="twoQ_gates" signature="twoQ_gates()">
  ...
  <Function id="qiskit.dagcircuit.DAGCircuit.wires" name="wires" signature="property wires">
