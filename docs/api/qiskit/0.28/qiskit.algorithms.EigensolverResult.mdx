...
<Class id="qiskit.algorithms.EigensolverResult" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/algorithms/eigen_solvers/eigen_solver.py" signature="EigensolverResult">
  ...
  <Function id="qiskit.algorithms.EigensolverResult.aux_operator_eigenvalues" signature="property aux_operator_eigenvalues">
  ...
  <Function id="qiskit.algorithms.EigensolverResult.eigenstates" signature="property eigenstates">
    return eigen states
  ...
  <Function id="qiskit.algorithms.EigensolverResult.eigenvalues" signature="property eigenvalues">
