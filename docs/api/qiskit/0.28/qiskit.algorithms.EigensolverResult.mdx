...
<Class id="qiskit.algorithms.EigensolverResult" github="https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/algorithms/eigen_solvers/eigen_solver.py" signature="EigensolverResult">
  Eigensolver Result.
