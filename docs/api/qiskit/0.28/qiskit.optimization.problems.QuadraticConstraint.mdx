...
<Class id="qiskit.optimization.problems.QuadraticConstraint" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/optimization/problems/quadratic_constraint.py" signature="QuadraticConstraint(quadratic_program, name, linear, quadratic, sense, rhs)">
  ...
  *   **rhs** (`float`) – The right-hand-side of the constraint.
  ...
  <Function id="qiskit.optimization.problems.QuadraticConstraint.linear" signature="property linear">
  ...
  <Function id="qiskit.optimization.problems.QuadraticConstraint.name" signature="property name">
  ...
  <Function id="qiskit.optimization.problems.QuadraticConstraint.quadratic" signature="property quadratic">
  ...
  <Function id="qiskit.optimization.problems.QuadraticConstraint.quadratic_program" signature="property quadratic_program">
  ...
  <Function id="qiskit.optimization.problems.QuadraticConstraint.rhs" signature="property rhs">
  ...
  <Function id="qiskit.optimization.problems.QuadraticConstraint.sense" signature="property sense">
