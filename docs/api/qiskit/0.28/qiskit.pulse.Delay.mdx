...
<Class id="qiskit.pulse.Delay" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/pulse/instructions/delay.py" signature="Delay(duration, channel, name=None)">
  ...
  *   **name** (`Optional`\[`str`]) – Name of the delay for display purposes.
  ...
  <Function id="qiskit.pulse.Delay.channel" signature="property channel">
  ...
  <Function id="qiskit.pulse.Delay.channels" signature="property channels">
  ...
  <Function id="qiskit.pulse.Delay.duration" signature="property duration">
  ...
  <Function id="qiskit.pulse.Delay.id" signature="property id">
  ...
  <Function id="qiskit.pulse.Delay.instructions" signature="property instructions">
  ...
  <Function id="qiskit.pulse.Delay.name" signature="property name">
  ...
  <Function id="qiskit.pulse.Delay.operands" signature="property operands">
  ...
  <Function id="qiskit.pulse.Delay.parameters" signature="property parameters">
  ...
  <Function id="qiskit.pulse.Delay.start_time" signature="property start_time">
  ...
  <Function id="qiskit.pulse.Delay.stop_time" signature="property stop_time">
