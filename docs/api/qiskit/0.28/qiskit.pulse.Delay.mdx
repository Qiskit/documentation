...
<Class id="qiskit.pulse.Delay" github="https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/pulse/instructions/delay.py" signature="Delay(duration, channel, name=None)">
