...
<Class id="qiskit.pulse.Delay" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/pulse/instructions/delay.py" signature="Delay(duration, channel, name=None)">
  ...
  *   **name** (`Optional`\[`str`]) – Name of the delay for display purposes.
  ...
  <Function id="qiskit.pulse.Delay.__init__" name="__init__" signature="__init__(duration, channel, name=None)">
    Create a new delay instruction.
  ...
  <Function id="qiskit.pulse.Delay.append" name="append" signature="append(schedule, name=None)">
  ...
  <Function id="qiskit.pulse.Delay.assign_parameters" name="assign_parameters" signature="assign_parameters(value_dict)">
  ...
  <Function id="qiskit.pulse.Delay.ch_duration" name="ch_duration" signature="ch_duration(*channels)">
  ...
  <Function id="qiskit.pulse.Delay.ch_start_time" name="ch_start_time" signature="ch_start_time(*channels)">
  ...
  <Function id="qiskit.pulse.Delay.ch_stop_time" name="ch_stop_time" signature="ch_stop_time(*channels)">
  ...
  <Function id="qiskit.pulse.Delay.channel" name="channel" signature="property channel">
  ...
  <Function id="qiskit.pulse.Delay.channels" name="channels" signature="property channels">
  ...
  <Function id="qiskit.pulse.Delay.draw" name="draw" signature="draw(dt=1, style=None, filename=None, interp_method=None, scale=1, plot_all=False, plot_range=None, interactive=False, table=True, label=False, framechange=True, channels=None)">
  ...
  <Function id="qiskit.pulse.Delay.duration" name="duration" signature="property duration">
  ...
  <Function id="qiskit.pulse.Delay.flatten" name="flatten" signature="flatten()">
  ...
  <Function id="qiskit.pulse.Delay.id" name="id" signature="property id">
  ...
  <Function id="qiskit.pulse.Delay.insert" name="insert" signature="insert(start_time, schedule, name=None)">
  ...
  <Function id="qiskit.pulse.Delay.instructions" name="instructions" signature="property instructions">
  ...
  <Function id="qiskit.pulse.Delay.is_parameterized" name="is_parameterized" signature="is_parameterized()">
  ...
  <Function id="qiskit.pulse.Delay.name" name="name" signature="property name">
  ...
  <Function id="qiskit.pulse.Delay.operands" name="operands" signature="property operands">
  ...
  <Function id="qiskit.pulse.Delay.parameters" name="parameters" signature="property parameters">
  ...
  <Function id="qiskit.pulse.Delay.shift" name="shift" signature="shift(time, name=None)">
  ...
  <Function id="qiskit.pulse.Delay.start_time" name="start_time" signature="property start_time">
  ...
  <Function id="qiskit.pulse.Delay.stop_time" name="stop_time" signature="property stop_time">
