...
<Class id="qiskit.providers.aer.library.SaveUnitary" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-aer/tree/stable/0.8/qiskit/providers/aer/library/save_instructions/save_unitary.py" signature="SaveUnitary(num_qubits, label='unitary', pershot=False)">
  ...
  *   **pershot** (*bool*) – if True save a list of unitaries for each shot of the simulation rather than a single statevector \[Default: False].
  ...
  <Function id="qiskit.providers.aer.library.SaveUnitary.decompositions" signature="property decompositions">
    Get the decompositions of the instruction from the SessionEquivalenceLibrary.
  </Function>

  ### definition

  <Function id="qiskit.providers.aer.library.SaveUnitary.definition" signature="property definition">
    Return definition in terms of other basic gates.
  </Function>

  ### duration

  <Function id="qiskit.providers.aer.library.SaveUnitary.duration" signature="property duration">
    Get the duration.
  </Function>
  ...
  <Function id="qiskit.providers.aer.library.SaveUnitary.label" signature="property label">
  ...
  <Function id="qiskit.providers.aer.library.SaveUnitary.params" signature="property params">
  ...
  <Function id="qiskit.providers.aer.library.SaveUnitary.unit" signature="property unit">
