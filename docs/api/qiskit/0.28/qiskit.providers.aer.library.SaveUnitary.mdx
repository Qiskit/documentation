...
<Class id="qiskit.providers.aer.library.SaveUnitary" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-aer/tree/stable/0.8/qiskit/providers/aer/library/save_instructions/save_unitary.py" signature="SaveUnitary(num_qubits, label='unitary', pershot=False)">
  Save Unitary
  ...
  *   **pershot** (*bool*) – if True save a list of unitaries for each shot of the simulation rather than a single statevector \[Default: False].
  ...
  <Function id="qiskit.providers.aer.library.SaveUnitary.label" name="label" signature="property label">
