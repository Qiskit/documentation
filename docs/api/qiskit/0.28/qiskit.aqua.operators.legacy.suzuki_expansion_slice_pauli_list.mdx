---
title: suzuki_expansion_slice_pauli_list (v0.28)
description: API reference for qiskit.aqua.operators.legacy.suzuki_expansion_slice_pauli_list in qiskit v0.28
