...
$$
  ...
  **Additional Information:**
  ...
  <Function id="qiskit.quantum_info.SuperOp.atol" signature="property atol">
  ...
  <Function id="qiskit.quantum_info.SuperOp.data" signature="property data">
    Return data.
  </Function>

  ### dim

  <Function id="qiskit.quantum_info.SuperOp.dim" signature="property dim">
  ...
  <Function id="qiskit.quantum_info.SuperOp.num_qubits" signature="property num_qubits">
  ...
  <Function id="qiskit.quantum_info.SuperOp.qargs" signature="property qargs">
  ...
  <Function id="qiskit.quantum_info.SuperOp.rtol" signature="property rtol">
    Default relative tolerance parameter for float comparisons.
  </Function>

  ### settings

  <Function id="qiskit.quantum_info.SuperOp.settings" signature="property settings">
