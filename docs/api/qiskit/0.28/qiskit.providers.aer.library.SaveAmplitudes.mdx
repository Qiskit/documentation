...
<Class id="qiskit.providers.aer.library.SaveAmplitudes" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-aer/tree/stable/0.8/qiskit/providers/aer/library/save_instructions/save_amplitudes.py" signature="SaveAmplitudes(num_qubits, params, label='amplitudes', pershot=False, conditional=False)" modifiers="class">
  ...
  **ExtensionError** – if params is invalid for the specified number of qubits.
  ...
  <Function id="qiskit.providers.aer.library.SaveAmplitudes.__init__" signature="__init__(num_qubits, params, label='amplitudes', pershot=False, conditional=False)">
    Instruction to save complex statevector amplitudes.
  ...
  <Function id="qiskit.providers.aer.library.SaveAmplitudes.add_decomposition" signature="add_decomposition(decomposition)">
    Add a decomposition of the instruction to the SessionEquivalenceLibrary.
  </Function>

  ### assemble

  <Function id="qiskit.providers.aer.library.SaveAmplitudes.assemble" signature="assemble()">
    Return the QasmQobjInstruction for the intructions.
  </Function>

  ### broadcast\_arguments

  <Function id="qiskit.providers.aer.library.SaveAmplitudes.broadcast_arguments" signature="broadcast_arguments(qargs, cargs)">
  ...
  <Function id="qiskit.providers.aer.library.SaveAmplitudes.c_if" signature="c_if(classical, val)">
    Add classical condition on register or cbit classical and value val.
  </Function>

  ### copy

  <Function id="qiskit.providers.aer.library.SaveAmplitudes.copy" signature="copy(name=None)">
  ...
  <Function id="qiskit.providers.aer.library.SaveAmplitudes.decompositions" signature="decompositions" modifiers="property">
    Get the decompositions of the instruction from the SessionEquivalenceLibrary.
  </Function>

  ### definition

  <Function id="qiskit.providers.aer.library.SaveAmplitudes.definition" signature="definition" modifiers="property">
    Return definition in terms of other basic gates.
  </Function>

  ### duration

  <Function id="qiskit.providers.aer.library.SaveAmplitudes.duration" signature="duration" modifiers="property">
    Get the duration.
  </Function>

  ### inverse

  <Function id="qiskit.providers.aer.library.SaveAmplitudes.inverse" signature="inverse()">
    Special case. Return self.
  </Function>

  ### is\_parameterized

  <Function id="qiskit.providers.aer.library.SaveAmplitudes.is_parameterized" signature="is_parameterized()">
    Return True .IFF. instruction is parameterized else False
  </Function>

  ### label

  <Function id="qiskit.providers.aer.library.SaveAmplitudes.label" signature="label" modifiers="property">
  ...
  <Function id="qiskit.providers.aer.library.SaveAmplitudes.mirror" signature="mirror()">
  ...
  <Function id="qiskit.providers.aer.library.SaveAmplitudes.params" signature="params" modifiers="property">
    return instruction params.
  </Function>

  ### qasm

  <Function id="qiskit.providers.aer.library.SaveAmplitudes.qasm" signature="qasm()">
  ...
  <Function id="qiskit.providers.aer.library.SaveAmplitudes.repeat" signature="repeat(n)">
  ...
  <Function id="qiskit.providers.aer.library.SaveAmplitudes.reverse_ops" signature="reverse_ops()">
  ...
  <Function id="qiskit.providers.aer.library.SaveAmplitudes.soft_compare" signature="soft_compare(other)">
  ...
  <Function id="qiskit.providers.aer.library.SaveAmplitudes.unit" signature="unit" modifiers="property">
    Get the time unit of duration.
  </Function>

  ### validate\_parameter

  <Function id="qiskit.providers.aer.library.SaveAmplitudes.validate_parameter" signature="validate_parameter(parameter)">
