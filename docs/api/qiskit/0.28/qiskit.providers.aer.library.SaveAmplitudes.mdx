...
<Class id="qiskit.providers.aer.library.SaveAmplitudes" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-aer/tree/stable/0.8/qiskit/providers/aer/library/save_instructions/save_amplitudes.py" signature="SaveAmplitudes(num_qubits, params, label='amplitudes', pershot=False, conditional=False)">
  ...
  **ExtensionError** – if params is invalid for the specified number of qubits.
  ...
  <Function id="qiskit.providers.aer.library.SaveAmplitudes.decompositions" signature="property decompositions">
    Get the decompositions of the instruction from the SessionEquivalenceLibrary.
  </Function>

  ### definition

  <Function id="qiskit.providers.aer.library.SaveAmplitudes.definition" signature="property definition">
    Return definition in terms of other basic gates.
  </Function>

  ### duration

  <Function id="qiskit.providers.aer.library.SaveAmplitudes.duration" signature="property duration">
    Get the duration.
  </Function>
  ...
  <Function id="qiskit.providers.aer.library.SaveAmplitudes.label" signature="property label">
  ...
  <Function id="qiskit.providers.aer.library.SaveAmplitudes.params" signature="property params">
  ...
  <Function id="qiskit.providers.aer.library.SaveAmplitudes.unit" signature="property unit">
