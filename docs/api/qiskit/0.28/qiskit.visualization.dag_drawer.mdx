...
<Function id="qiskit.visualization.dag_drawer" github="https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/visualization/dag_visualization.py" signature="dag_drawer(dag, scale=0.7, filename=None, style='color')">
