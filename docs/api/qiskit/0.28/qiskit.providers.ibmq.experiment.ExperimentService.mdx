---
title: ExperimentService (v0.28)
description: API reference for qiskit.providers.ibmq.experiment.ExperimentService in qiskit v0.28
...
<Class id="qiskit.providers.ibmq.experiment.ExperimentService" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-ibmq-provider/tree/stable/0.15/qiskit/providers/ibmq/experiment/experimentservice.py" signature="ExperimentService(provider)" modifiers="class">
