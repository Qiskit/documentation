...
<Class id="qiskit.scheduler.ScheduleConfig" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/scheduler/config.py" signature="ScheduleConfig(inst_map, meas_map, dt)">
  ...
  *   **dt** (`float`) – Sample duration.
  ...
  <Function id="qiskit.scheduler.ScheduleConfig.__init__" name="__init__" signature="__init__(inst_map, meas_map, dt)">
    Container for information needed to schedule a QuantumCircuit into a pulse Schedule.
