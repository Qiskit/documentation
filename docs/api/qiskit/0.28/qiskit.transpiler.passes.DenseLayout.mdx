...
<Class id="qiskit.transpiler.passes.DenseLayout" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/transpiler/passes/layout/dense_layout.py" signature="DenseLayout(*args, **kwargs)">
  ...
  *   **backend\_prop** ([*BackendProperties*](qiskit.providers.models.BackendProperties "qiskit.providers.models.BackendProperties")) – backend properties object
  ...
  <Function id="qiskit.transpiler.passes.DenseLayout.__init__" name="__init__" signature="__init__(coupling_map, backend_prop=None)">
    DenseLayout initializer.
  ...
  <Function id="qiskit.transpiler.passes.DenseLayout.is_analysis_pass" name="is_analysis_pass" signature="property is_analysis_pass">
  ...
  <Function id="qiskit.transpiler.passes.DenseLayout.is_transformation_pass" name="is_transformation_pass" signature="property is_transformation_pass">
