...
<Class id="qiskit.circuit.classicalfunction.BooleanExpression" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/circuit/classicalfunction/boolean_expression.py" signature="BooleanExpression(expression, name=None)">
  ...
  *   **name** (*str*) – Optional. Instruction gate name. Otherwise part of the expression is going to be used.
  ...
  <Function id="qiskit.circuit.classicalfunction.BooleanExpression.__init__" name="__init__" signature="__init__(expression, name=None)">
    **Parameters**
  ...
  <Function id="qiskit.circuit.classicalfunction.BooleanExpression.decompositions" name="decompositions" signature="property decompositions">
    Get the decompositions of the instruction from the SessionEquivalenceLibrary.
  </Function>

  ### definition

  <Function id="qiskit.circuit.classicalfunction.BooleanExpression.definition" name="definition" signature="property definition">
    Return definition in terms of other basic gates.
  </Function>

  ### duration

  <Function id="qiskit.circuit.classicalfunction.BooleanExpression.duration" name="duration" signature="property duration">
    Get the duration.
  </Function>
  ...
  <Function id="qiskit.circuit.classicalfunction.BooleanExpression.label" name="label" signature="property label">
  ...
  <Function id="qiskit.circuit.classicalfunction.BooleanExpression.mirror" name="mirror" signature="mirror()">
  ...
  <Function id="qiskit.circuit.classicalfunction.BooleanExpression.params" name="params" signature="property params">
  ...
  <Function id="qiskit.circuit.classicalfunction.BooleanExpression.unit" name="unit" signature="property unit">
