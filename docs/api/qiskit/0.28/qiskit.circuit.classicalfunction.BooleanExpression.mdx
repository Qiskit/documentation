...
<Class id="qiskit.circuit.classicalfunction.BooleanExpression" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/circuit/classicalfunction/boolean_expression.py" signature="BooleanExpression(expression, name=None)">
  ...
  *   **name** (*str*) – Optional. Instruction gate name. Otherwise part of the expression is going to be used.
  ...
  <Function id="qiskit.circuit.classicalfunction.BooleanExpression.decompositions" signature="property decompositions">
    Get the decompositions of the instruction from the SessionEquivalenceLibrary.
  </Function>

  ### definition

  <Function id="qiskit.circuit.classicalfunction.BooleanExpression.definition" signature="property definition">
    Return definition in terms of other basic gates.
  </Function>

  ### duration

  <Function id="qiskit.circuit.classicalfunction.BooleanExpression.duration" signature="property duration">
    Get the duration.
  </Function>

  ### from\_dimacs\_file

  <Function id="qiskit.circuit.classicalfunction.BooleanExpression.from_dimacs_file" signature="classmethod from_dimacs_file(filename)">
  ...
  <Function id="qiskit.circuit.classicalfunction.BooleanExpression.label" signature="property label">
  ...
  <Function id="qiskit.circuit.classicalfunction.BooleanExpression.params" signature="property params">
  ...
  <Function id="qiskit.circuit.classicalfunction.BooleanExpression.unit" signature="property unit">
