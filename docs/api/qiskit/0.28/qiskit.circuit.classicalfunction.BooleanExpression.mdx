...
<Class id="qiskit.circuit.classicalfunction.BooleanExpression" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/circuit/classicalfunction/boolean_expression.py" signature="BooleanExpression(expression, name=None)" modifiers="class">
  ...
  *   **name** (*str*) – Optional. Instruction gate name. Otherwise part of the expression is going to be used.
  ...
  <Function id="qiskit.circuit.classicalfunction.BooleanExpression.decompositions" signature="decompositions" modifiers="property">
    Get the decompositions of the instruction from the SessionEquivalenceLibrary.
  </Function>

  ### definition

  <Function id="qiskit.circuit.classicalfunction.BooleanExpression.definition" signature="definition" modifiers="property">
    Return definition in terms of other basic gates.
  </Function>

  ### duration

  <Function id="qiskit.circuit.classicalfunction.BooleanExpression.duration" signature="duration" modifiers="property">
    Get the duration.
  </Function>
  ...
  <Function id="qiskit.circuit.classicalfunction.BooleanExpression.label" signature="label" modifiers="property">
  ...
  <Function id="qiskit.circuit.classicalfunction.BooleanExpression.params" signature="params" modifiers="property">
  ...
  <Function id="qiskit.circuit.classicalfunction.BooleanExpression.unit" signature="unit" modifiers="property">
