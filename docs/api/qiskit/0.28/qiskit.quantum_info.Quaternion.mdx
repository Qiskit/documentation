...
<Class id="qiskit.quantum_info.Quaternion" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/quantum_info/synthesis/quaternion.py" signature="Quaternion(data)">
  ...
  <Function id="qiskit.quantum_info.Quaternion.from_axis_rotation" signature="classmethod from_axis_rotation(angle, axis)">
  ...
  <Function id="qiskit.quantum_info.Quaternion.from_euler" signature="classmethod from_euler(angles, order='yzy')">
