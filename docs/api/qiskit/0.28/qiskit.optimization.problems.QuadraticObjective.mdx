...
<Class id="qiskit.optimization.problems.QuadraticObjective" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/optimization/problems/quadratic_objective.py" signature="QuadraticObjective(quadratic_program, constant=0.0, linear=None, quadratic=None, sense=<ObjSense.MINIMIZE: 1>)">
  ...
  *   **sense** (`ObjSense`) – The optimization sense of the objective.
  ...
  <Function id="qiskit.optimization.problems.QuadraticObjective.__init__" name="__init__" signature="__init__(quadratic_program, constant=0.0, linear=None, quadratic=None, sense=<ObjSense.MINIMIZE: 1>)">
    Constructs a quadratic objective function.
  ...
  <Attribute id="qiskit.optimization.problems.QuadraticObjective.Sense" name="Sense">
    alias of `ObjSense`
  </Attribute>

  ### constant

  <Function id="qiskit.optimization.problems.QuadraticObjective.constant" name="constant" signature="property constant">
  ...
  <Function id="qiskit.optimization.problems.QuadraticObjective.evaluate" name="evaluate" signature="evaluate(x)">
  ...
  <Function id="qiskit.optimization.problems.QuadraticObjective.evaluate_gradient" name="evaluate_gradient" signature="evaluate_gradient(x)">
  ...
  <Function id="qiskit.optimization.problems.QuadraticObjective.linear" name="linear" signature="property linear">
  ...
  <Function id="qiskit.optimization.problems.QuadraticObjective.quadratic" name="quadratic" signature="property quadratic">
  ...
  <Function id="qiskit.optimization.problems.QuadraticObjective.quadratic_program" name="quadratic_program" signature="property quadratic_program">
  ...
  <Function id="qiskit.optimization.problems.QuadraticObjective.sense" name="sense" signature="property sense">
