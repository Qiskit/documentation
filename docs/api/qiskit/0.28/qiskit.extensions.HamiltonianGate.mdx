...
<Class id="qiskit.extensions.HamiltonianGate" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/extensions/hamiltonian_gate.py" signature="HamiltonianGate(data, time, label=None)">
  ...
  **ExtensionError** – if input data is not an N-qubit unitary operator.
  ...
  <Function id="qiskit.extensions.HamiltonianGate.__init__" name="__init__" signature="__init__(data, time, label=None)">
    Create a gate from a hamiltonian operator and evolution time parameter t
  ...
  <Function id="qiskit.extensions.HamiltonianGate.add_decomposition" name="add_decomposition" signature="add_decomposition(decomposition)">
    Add a decomposition of the instruction to the SessionEquivalenceLibrary.
  </Function>

  ### adjoint

  <Function id="qiskit.extensions.HamiltonianGate.adjoint" name="adjoint" signature="adjoint()">
    Return the adjoint of the unitary.
  </Function>

  ### assemble

  <Function id="qiskit.extensions.HamiltonianGate.assemble" name="assemble" signature="assemble()">
    Assemble a QasmQobjInstruction
  </Function>

  ### broadcast\_arguments

  <Function id="qiskit.extensions.HamiltonianGate.broadcast_arguments" name="broadcast_arguments" signature="broadcast_arguments(qargs, cargs)">
  ...
  <Function id="qiskit.extensions.HamiltonianGate.c_if" name="c_if" signature="c_if(classical, val)">
    Add classical condition on register or cbit classical and value val.
  </Function>

  ### conjugate

  <Function id="qiskit.extensions.HamiltonianGate.conjugate" name="conjugate" signature="conjugate()">
    Return the conjugate of the Hamiltonian.
  </Function>

  ### control

  <Function id="qiskit.extensions.HamiltonianGate.control" name="control" signature="control(num_ctrl_qubits=1, label=None, ctrl_state=None)">
  ...
  <Function id="qiskit.extensions.HamiltonianGate.copy" name="copy" signature="copy(name=None)">
  ...
  <Function id="qiskit.extensions.HamiltonianGate.decompositions" name="decompositions" signature="property decompositions">
    Get the decompositions of the instruction from the SessionEquivalenceLibrary.
  </Function>

  ### definition

  <Function id="qiskit.extensions.HamiltonianGate.definition" name="definition" signature="property definition">
    Return definition in terms of other basic gates.
  </Function>

  ### duration

  <Function id="qiskit.extensions.HamiltonianGate.duration" name="duration" signature="property duration">
    Get the duration.
  </Function>

  ### inverse

  <Function id="qiskit.extensions.HamiltonianGate.inverse" name="inverse" signature="inverse()">
    Return the adjoint of the unitary.
  </Function>

  ### is\_parameterized

  <Function id="qiskit.extensions.HamiltonianGate.is_parameterized" name="is_parameterized" signature="is_parameterized()">
    Return True .IFF. instruction is parameterized else False
  </Function>

  ### label

  <Function id="qiskit.extensions.HamiltonianGate.label" name="label" signature="property label">
  ...
  <Function id="qiskit.extensions.HamiltonianGate.mirror" name="mirror" signature="mirror()">
  ...
  <Function id="qiskit.extensions.HamiltonianGate.params" name="params" signature="property params">
    return instruction params.
  </Function>

  ### power

  <Function id="qiskit.extensions.HamiltonianGate.power" name="power" signature="power(exponent)">
  ...
  <Function id="qiskit.extensions.HamiltonianGate.qasm" name="qasm" signature="qasm()">
    Raise an error, as QASM is not defined for the HamiltonianGate.
  </Function>

  ### repeat

  <Function id="qiskit.extensions.HamiltonianGate.repeat" name="repeat" signature="repeat(n)">
  ...
  <Function id="qiskit.extensions.HamiltonianGate.reverse_ops" name="reverse_ops" signature="reverse_ops()">
  ...
  <Function id="qiskit.extensions.HamiltonianGate.soft_compare" name="soft_compare" signature="soft_compare(other)">
  ...
  <Function id="qiskit.extensions.HamiltonianGate.to_matrix" name="to_matrix" signature="to_matrix()">
  ...
  <Function id="qiskit.extensions.HamiltonianGate.transpose" name="transpose" signature="transpose()">
    Return the transpose of the Hamiltonian.
  </Function>

  ### unit

  <Function id="qiskit.extensions.HamiltonianGate.unit" name="unit" signature="property unit">
    Get the time unit of duration.
  </Function>

  ### validate\_parameter

  <Function id="qiskit.extensions.HamiltonianGate.validate_parameter" name="validate_parameter" signature="validate_parameter(parameter)">
