---
title: DIRECT_L (v0.28)
description: API reference for qiskit.aqua.components.optimizers.DIRECT_L in qiskit v0.28
...
<Class id="qiskit.aqua.components.optimizers.DIRECT_L" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/aqua/components/optimizers/nlopts/direct_l.py" signature="DIRECT_L(max_evals=1000)" modifiers="class">
