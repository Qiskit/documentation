...
<Class id="qiskit.ignis.verification.GraphDecoder" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-ignis/tree/stable/0.6/qiskit/ignis/verification/topological_codes/fitters.py" signature="GraphDecoder(code, S=None)">
  ...
  **Additional information:**
  ...
  <Function id="qiskit.ignis.verification.GraphDecoder.__init__" name="__init__" signature="__init__(code, S=None)">
    **Parameters**
  ...
  <Function id="qiskit.ignis.verification.GraphDecoder.get_error_probs" name="get_error_probs" signature="get_error_probs(results)">
  ...
  <Function id="qiskit.ignis.verification.GraphDecoder.get_logical_prob" name="get_logical_prob" signature="get_logical_prob(results, algorithm='matching')">
    **Parameters**
  ...
  <Function id="qiskit.ignis.verification.GraphDecoder.make_error_graph" name="make_error_graph" signature="make_error_graph(string, subgraphs=None)">
    **Parameters**
  ...
  <Function id="qiskit.ignis.verification.GraphDecoder.matching" name="matching" signature="matching(string)">
    **Parameters**
  ...
  <Function id="qiskit.ignis.verification.GraphDecoder.weight_syndrome_graph" name="weight_syndrome_graph" signature="weight_syndrome_graph(results)">
