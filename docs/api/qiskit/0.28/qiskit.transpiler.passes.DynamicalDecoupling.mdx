...
<Class id="qiskit.transpiler.passes.DynamicalDecoupling" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/transpiler/passes/scheduling/dynamical_decoupling.py" signature="DynamicalDecoupling(*args, **kwargs)" modifiers="class">
  ...
  *   **skip\_reset\_qubits** (*bool*) – if True, does not insert DD on idle periods that immediately follow initialized/reset qubits (as qubits in the ground state are less susceptile to decoherence).
  ...
  <Function id="qiskit.transpiler.passes.DynamicalDecoupling.__init__" signature="__init__(durations, dd_sequence, qubits=None, spacing=None, skip_reset_qubits=True)">
    Dynamical decoupling initializer.
  ...
  <Function id="qiskit.transpiler.passes.DynamicalDecoupling.is_analysis_pass" signature="is_analysis_pass" modifiers="property">
  ...
  <Function id="qiskit.transpiler.passes.DynamicalDecoupling.is_transformation_pass" signature="is_transformation_pass" modifiers="property">
