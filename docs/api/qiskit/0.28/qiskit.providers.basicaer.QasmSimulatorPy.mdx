...
<Class id="qiskit.providers.basicaer.QasmSimulatorPy" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/providers/basicaer/qasm_simulator.py" signature="QasmSimulatorPy(configuration=None, provider=None, **fields)">
  ...
  **AttributeError** – if input field not a valid options
  ...
  <Function id="qiskit.providers.basicaer.QasmSimulatorPy.__init__" name="__init__" signature="__init__(configuration=None, provider=None, **fields)">
    Initialize a backend class
  ...
  <Function id="qiskit.providers.basicaer.QasmSimulatorPy.options" name="options" signature="property options">
