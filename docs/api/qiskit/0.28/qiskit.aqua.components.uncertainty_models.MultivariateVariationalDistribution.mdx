---
title: MultivariateVariationalDistribution (v0.28)
description: API reference for qiskit.aqua.components.uncertainty_models.MultivariateVariationalDistribution in qiskit v0.28
