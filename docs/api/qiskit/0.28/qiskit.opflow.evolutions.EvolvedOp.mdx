...
<Class id="qiskit.opflow.evolutions.EvolvedOp" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/opflow/evolutions/evolved_op.py" signature="EvolvedOp(primitive, coeff=1.0)">
  ...
  *   **coeff** (`Union`\[`complex`, `ParameterExpression`]) – A coefficient multiplying the operator
  ...
  <Function id="qiskit.opflow.evolutions.EvolvedOp.__init__" signature="__init__(primitive, coeff=1.0)">
    **Parameters**
  ...
  <Function id="qiskit.opflow.evolutions.EvolvedOp.add" signature="add(other)">
  ...
  <Function id="qiskit.opflow.evolutions.EvolvedOp.adjoint" signature="adjoint()">
  ...
  <Function id="qiskit.opflow.evolutions.EvolvedOp.assign_parameters" signature="assign_parameters(param_dict)">
  ...
  <Function id="qiskit.opflow.evolutions.EvolvedOp.bind_parameters" signature="bind_parameters(param_dict)">
  ...
  <Function id="qiskit.opflow.evolutions.EvolvedOp.coeff" signature="property coeff">
  ...
  <Function id="qiskit.opflow.evolutions.EvolvedOp.compose" signature="compose(other, permutation=None, front=False)">
  ...
  <Function id="qiskit.opflow.evolutions.EvolvedOp.copy" signature="copy()">
  ...
  <Function id="qiskit.opflow.evolutions.EvolvedOp.equals" signature="equals(other)">
  ...
  <Function id="qiskit.opflow.evolutions.EvolvedOp.eval" signature="eval(front=None)">
  ...
  <Function id="qiskit.opflow.evolutions.EvolvedOp.exp_i" signature="exp_i()">
  ...
  <Function id="qiskit.opflow.evolutions.EvolvedOp.instance_id" signature="property instance_id">
  ...
  <Function id="qiskit.opflow.evolutions.EvolvedOp.log_i" signature="log_i(massive=False)">
  ...
  <Function id="qiskit.opflow.evolutions.EvolvedOp.mul" signature="mul(scalar)">
  ...
  <Function id="qiskit.opflow.evolutions.EvolvedOp.neg" signature="neg()">
  ...
  <Function id="qiskit.opflow.evolutions.EvolvedOp.num_qubits" signature="property num_qubits">
  ...
  <Function id="qiskit.opflow.evolutions.EvolvedOp.parameters" signature="property parameters">
    Return a set of Parameter objects contained in the Operator.
  </Function>

  ### permute

  <Function id="qiskit.opflow.evolutions.EvolvedOp.permute" signature="permute(permutation)">
  ...
  <Function id="qiskit.opflow.evolutions.EvolvedOp.power" signature="power(exponent)">
    Return Operator composed with self multiple times, overloaded by `**`.
  </Function>

  ### primitive

  <Function id="qiskit.opflow.evolutions.EvolvedOp.primitive" signature="property primitive">
  ...
  <Function id="qiskit.opflow.evolutions.EvolvedOp.primitive_strings" signature="primitive_strings()">
  ...
  <Function id="qiskit.opflow.evolutions.EvolvedOp.reduce" signature="reduce()">
  ...
  <Function id="qiskit.opflow.evolutions.EvolvedOp.settings" signature="property settings">
  ...
  <Function id="qiskit.opflow.evolutions.EvolvedOp.tensor" signature="tensor(other)">
  ...
  <Function id="qiskit.opflow.evolutions.EvolvedOp.tensorpower" signature="tensorpower(other)">
  ...
  <Function id="qiskit.opflow.evolutions.EvolvedOp.to_circuit" signature="to_circuit()">
  ...
  <Function id="qiskit.opflow.evolutions.EvolvedOp.to_circuit_op" signature="to_circuit_op()">
  ...
  <Function id="qiskit.opflow.evolutions.EvolvedOp.to_instruction" signature="to_instruction(massive=False)">
  ...
  <Function id="qiskit.opflow.evolutions.EvolvedOp.to_matrix" signature="to_matrix(massive=False)">
  ...
  <Function id="qiskit.opflow.evolutions.EvolvedOp.to_matrix_op" signature="to_matrix_op(massive=False)">
  ...
  <Function id="qiskit.opflow.evolutions.EvolvedOp.to_pauli_op" signature="to_pauli_op(massive=False)">
  ...
  <Function id="qiskit.opflow.evolutions.EvolvedOp.to_spmatrix" signature="to_spmatrix()">
