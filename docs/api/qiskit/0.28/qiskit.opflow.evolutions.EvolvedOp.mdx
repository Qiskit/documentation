...
<Class id="qiskit.opflow.evolutions.EvolvedOp" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/opflow/evolutions/evolved_op.py" signature="EvolvedOp(primitive, coeff=1.0)" modifiers="class">
  ...
  *   **coeff** (`Union`\[`complex`, `ParameterExpression`]) – A coefficient multiplying the operator
  ...
  <Function id="qiskit.opflow.evolutions.EvolvedOp.coeff" signature="coeff" modifiers="property">
  ...
  <Function id="qiskit.opflow.evolutions.EvolvedOp.instance_id" signature="instance_id" modifiers="property">
  ...
  <Function id="qiskit.opflow.evolutions.EvolvedOp.num_qubits" signature="num_qubits" modifiers="property">
  ...
  <Function id="qiskit.opflow.evolutions.EvolvedOp.parameters" signature="parameters" modifiers="property">
  ...
  <Function id="qiskit.opflow.evolutions.EvolvedOp.primitive" signature="primitive" modifiers="property">
  ...
  <Function id="qiskit.opflow.evolutions.EvolvedOp.settings" signature="settings" modifiers="property">
