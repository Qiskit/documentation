...
<Class id="qiskit.transpiler.passes.RZXCalibrationBuilder" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/transpiler/passes/scheduling/calibration_creators.py" signature="RZXCalibrationBuilder(backend)">
  ...
  **QiskitError** – if open pulse is not supported by the backend.
  ...
  <Function id="qiskit.transpiler.passes.RZXCalibrationBuilder.is_analysis_pass" signature="property is_analysis_pass">
  ...
  <Function id="qiskit.transpiler.passes.RZXCalibrationBuilder.is_transformation_pass" signature="property is_transformation_pass">
  ...
  <Function id="qiskit.transpiler.passes.RZXCalibrationBuilder.rescale_cr_inst" signature="static rescale_cr_inst(instruction, theta, sample_mult=16)">
    **Parameters**
