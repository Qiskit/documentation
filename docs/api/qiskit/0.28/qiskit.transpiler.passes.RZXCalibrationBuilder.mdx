...
<Class id="qiskit.transpiler.passes.RZXCalibrationBuilder" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/transpiler/passes/scheduling/calibration_creators.py" signature="RZXCalibrationBuilder(backend)">
  ...
  **QiskitError** – if open pulse is not supported by the backend.
  ...
  <Function id="qiskit.transpiler.passes.RZXCalibrationBuilder.__init__" name="__init__" signature="__init__(backend)">
    Initializes a RZXGate calibration builder.
  ...
  <Function id="qiskit.transpiler.passes.RZXCalibrationBuilder.get_calibration" name="get_calibration" signature="get_calibration(params, qubits)">
    **Parameters**
  ...
  <Function id="qiskit.transpiler.passes.RZXCalibrationBuilder.is_analysis_pass" name="is_analysis_pass" signature="property is_analysis_pass">
  ...
  <Function id="qiskit.transpiler.passes.RZXCalibrationBuilder.is_transformation_pass" name="is_transformation_pass" signature="property is_transformation_pass">
  ...
  <Function id="qiskit.transpiler.passes.RZXCalibrationBuilder.supported" name="supported" signature="supported(node_op)">
    **Parameters**
