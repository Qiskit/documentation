...
<Class id="qiskit.opflow.list_ops.TensoredOp" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/opflow/list_ops/tensored_op.py" signature="TensoredOp(oplist, coeff=1.0, abelian=False)">
  ...
  *   **abelian** (`bool`) – Indicates whether the Operators in `oplist` are known to mutually commute.
  ...
  <Function id="qiskit.opflow.list_ops.TensoredOp.abelian" signature="property abelian">
  ...
  <Function id="qiskit.opflow.list_ops.TensoredOp.coeff" signature="property coeff">
  ...
  <Function id="qiskit.opflow.list_ops.TensoredOp.combo_fn" signature="property combo_fn">
  ...
  <Function id="qiskit.opflow.list_ops.TensoredOp.default_combo_fn" signature="static default_combo_fn(x)">
  ...
  <Function id="qiskit.opflow.list_ops.TensoredOp.distributive" signature="property distributive">
  ...
  <Function id="qiskit.opflow.list_ops.TensoredOp.grad_combo_fn" signature="property grad_combo_fn">
  ...
  <Function id="qiskit.opflow.list_ops.TensoredOp.instance_id" signature="property instance_id">
  ...
  <Function id="qiskit.opflow.list_ops.TensoredOp.num_qubits" signature="property num_qubits">
  ...
  <Function id="qiskit.opflow.list_ops.TensoredOp.oplist" signature="property oplist">
  ...
  <Function id="qiskit.opflow.list_ops.TensoredOp.parameters" signature="property parameters">
  ...
  <Function id="qiskit.opflow.list_ops.TensoredOp.settings" signature="property settings">
    Return settings.
