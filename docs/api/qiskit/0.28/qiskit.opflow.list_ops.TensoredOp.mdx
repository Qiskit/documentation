...
<Class id="qiskit.opflow.list_ops.TensoredOp" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/opflow/list_ops/tensored_op.py" signature="TensoredOp(oplist, coeff=1.0, abelian=False)">
  ...
  *   **abelian** (`bool`) – Indicates whether the Operators in `oplist` are known to mutually commute.
  ...
  <Function id="qiskit.opflow.list_ops.TensoredOp.__init__" name="__init__" signature="__init__(oplist, coeff=1.0, abelian=False)">
    **Parameters**
  ...
  <Function id="qiskit.opflow.list_ops.TensoredOp.abelian" name="abelian" signature="property abelian">
  ...
  <Function id="qiskit.opflow.list_ops.TensoredOp.add" name="add" signature="add(other)">
  ...
  <Function id="qiskit.opflow.list_ops.TensoredOp.adjoint" name="adjoint" signature="adjoint()">
  ...
  <Function id="qiskit.opflow.list_ops.TensoredOp.assign_parameters" name="assign_parameters" signature="assign_parameters(param_dict)">
  ...
  <Function id="qiskit.opflow.list_ops.TensoredOp.bind_parameters" name="bind_parameters" signature="bind_parameters(param_dict)">
  ...
  <Function id="qiskit.opflow.list_ops.TensoredOp.coeff" name="coeff" signature="property coeff">
  ...
  <Function id="qiskit.opflow.list_ops.TensoredOp.combo_fn" name="combo_fn" signature="property combo_fn">
  ...
  <Function id="qiskit.opflow.list_ops.TensoredOp.compose" name="compose" signature="compose(other, permutation=None, front=False)">
  ...
  <Function id="qiskit.opflow.list_ops.TensoredOp.copy" name="copy" signature="copy()">
  ...
  <Function id="qiskit.opflow.list_ops.TensoredOp.default_combo_fn" name="default_combo_fn" signature="static default_combo_fn(x)">
  ...
  <Function id="qiskit.opflow.list_ops.TensoredOp.distributive" name="distributive" signature="property distributive">
  ...
  <Function id="qiskit.opflow.list_ops.TensoredOp.equals" name="equals" signature="equals(other)">
  ...
  <Function id="qiskit.opflow.list_ops.TensoredOp.eval" name="eval" signature="eval(front=None)">
  ...
  <Function id="qiskit.opflow.list_ops.TensoredOp.exp_i" name="exp_i" signature="exp_i()">
  ...
  <Function id="qiskit.opflow.list_ops.TensoredOp.grad_combo_fn" name="grad_combo_fn" signature="property grad_combo_fn">
  ...
  <Function id="qiskit.opflow.list_ops.TensoredOp.instance_id" name="instance_id" signature="property instance_id">
  ...
  <Function id="qiskit.opflow.list_ops.TensoredOp.log_i" name="log_i" signature="log_i(massive=False)">
  ...
  <Function id="qiskit.opflow.list_ops.TensoredOp.mul" name="mul" signature="mul(scalar)">
  ...
  <Function id="qiskit.opflow.list_ops.TensoredOp.neg" name="neg" signature="neg()">
  ...
  <Function id="qiskit.opflow.list_ops.TensoredOp.num_qubits" name="num_qubits" signature="property num_qubits">
  ...
  <Function id="qiskit.opflow.list_ops.TensoredOp.oplist" name="oplist" signature="property oplist">
  ...
  <Function id="qiskit.opflow.list_ops.TensoredOp.parameters" name="parameters" signature="property parameters">
    Return a set of Parameter objects contained in the Operator.
  </Function>

  ### permute

  <Function id="qiskit.opflow.list_ops.TensoredOp.permute" name="permute" signature="permute(permutation)">
  ...
  <Function id="qiskit.opflow.list_ops.TensoredOp.power" name="power" signature="power(exponent)">
  ...
  <Function id="qiskit.opflow.list_ops.TensoredOp.primitive_strings" name="primitive_strings" signature="primitive_strings()">
  ...
  <Function id="qiskit.opflow.list_ops.TensoredOp.reduce" name="reduce" signature="reduce()">
  ...
  <Function id="qiskit.opflow.list_ops.TensoredOp.settings" name="settings" signature="property settings">
    Return settings.
  ...
  <Function id="qiskit.opflow.list_ops.TensoredOp.tensor" name="tensor" signature="tensor(other)">
  ...
  <Function id="qiskit.opflow.list_ops.TensoredOp.tensorpower" name="tensorpower" signature="tensorpower(other)">
  ...
  <Function id="qiskit.opflow.list_ops.TensoredOp.to_circuit" name="to_circuit" signature="to_circuit()">
  ...
  <Function id="qiskit.opflow.list_ops.TensoredOp.to_circuit_op" name="to_circuit_op" signature="to_circuit_op()">
  ...
  <Function id="qiskit.opflow.list_ops.TensoredOp.to_matrix" name="to_matrix" signature="to_matrix(massive=False)">
  ...
  <Function id="qiskit.opflow.list_ops.TensoredOp.to_matrix_op" name="to_matrix_op" signature="to_matrix_op(massive=False)">
  ...
  <Function id="qiskit.opflow.list_ops.TensoredOp.to_pauli_op" name="to_pauli_op" signature="to_pauli_op(massive=False)">
  ...
  <Function id="qiskit.opflow.list_ops.TensoredOp.to_spmatrix" name="to_spmatrix" signature="to_spmatrix()">
  ...
  <Function id="qiskit.opflow.list_ops.TensoredOp.traverse" name="traverse" signature="traverse(convert_fn, coeff=None)">
