...
<Class id="qiskit.providers.aer.PulseSimulator" github="https://github.com/qiskit/qiskit-aer/tree/stable/0.8/qiskit/providers/aer/backends/pulse_simulator.py" signature="PulseSimulator(configuration=None, properties=None, defaults=None, provider=None, **backend_options)">
  ...
  **Raises**
  ...
  <Function id="qiskit.providers.aer.PulseSimulator.run" name="run" signature="run(schedules, *args, backend_options=None, validate=True, **run_options)">
  ...
  <Function id="qiskit.providers.aer.PulseSimulator.set_option" name="set_option" signature="set_option(key, value)">
    Set pulse simulation options and update backend.
  </Function>

  ### set\_options

  <Function id="qiskit.providers.aer.PulseSimulator.set_options" name="set_options" signature="set_options(**fields)">
