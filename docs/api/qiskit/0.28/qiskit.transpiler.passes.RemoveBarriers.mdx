...
<Class id="qiskit.transpiler.passes.RemoveBarriers" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/transpiler/passes/utils/remove_barriers.py" signature="RemoveBarriers(*args, **kwargs)" modifiers="class">
  ...
  **Example**
  ...
  <Function id="qiskit.transpiler.passes.RemoveBarriers.__init__" signature="__init__()">
  ...
  <Function id="qiskit.transpiler.passes.RemoveBarriers.is_analysis_pass" signature="is_analysis_pass" modifiers="property">
  ...
  <Function id="qiskit.transpiler.passes.RemoveBarriers.is_transformation_pass" signature="is_transformation_pass" modifiers="property">
