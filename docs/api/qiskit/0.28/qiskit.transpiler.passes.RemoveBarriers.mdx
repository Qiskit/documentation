...
<Class id="qiskit.transpiler.passes.RemoveBarriers" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/transpiler/passes/utils/remove_barriers.py" signature="RemoveBarriers(*args, **kwargs)">
  ...
  **Example**
  ...
  <Function id="qiskit.transpiler.passes.RemoveBarriers.is_analysis_pass" signature="property is_analysis_pass">
  ...
  <Function id="qiskit.transpiler.passes.RemoveBarriers.is_transformation_pass" signature="property is_transformation_pass">
