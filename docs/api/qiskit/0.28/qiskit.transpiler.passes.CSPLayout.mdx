...
<Class id="qiskit.transpiler.passes.CSPLayout" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/transpiler/passes/layout/csp_layout.py" signature="CSPLayout(*args, **kwargs)">
  ...
  *   **time\_limit** (*int*) – Amount of seconds that the pass will try to find a solution. None means no time limit. Default: 10 seconds.
  ...
  <Function id="qiskit.transpiler.passes.CSPLayout.__init__" name="__init__" signature="__init__(coupling_map, strict_direction=False, seed=None, call_limit=1000, time_limit=10)">
    If possible, chooses a Layout as a CSP, using backtracking.
  ...
  <Function id="qiskit.transpiler.passes.CSPLayout.is_analysis_pass" name="is_analysis_pass" signature="property is_analysis_pass">
  ...
  <Function id="qiskit.transpiler.passes.CSPLayout.is_transformation_pass" name="is_transformation_pass" signature="property is_transformation_pass">
