...
<Class id="qiskit.opflow.expectations.MatrixExpectation" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/opflow/expectations/matrix_expectation.py" signature="MatrixExpectation">
  ...
  <Function id="qiskit.opflow.expectations.MatrixExpectation.__init__" name="__init__" signature="__init__()">
  ...
  <Function id="qiskit.opflow.expectations.MatrixExpectation.compute_variance" name="compute_variance" signature="compute_variance(exp_op)">
  ...
  <Function id="qiskit.opflow.expectations.MatrixExpectation.convert" name="convert" signature="convert(operator)">
