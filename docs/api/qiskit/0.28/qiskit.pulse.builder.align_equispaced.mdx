---
title: align_equispaced (v0.28)
description: API reference for qiskit.pulse.builder.align_equispaced in qiskit v0.28
...
<Function id="qiskit.pulse.builder.align_equispaced" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/pulse/builder.py" signature="align_equispaced(duration)">
  ...
  ![../\_images/qiskit.pulse.builder.align\_equispaced\_0\_0.png](/docs/images/api/qiskit/0.28/qiskit.pulse.builder.align_equispaced_0_0.avif) ![../\_images/qiskit.pulse.builder.align\_equispaced\_0\_1.png](/docs/images/api/qiskit/0.28/qiskit.pulse.builder.align_equispaced_0_1.avif)
