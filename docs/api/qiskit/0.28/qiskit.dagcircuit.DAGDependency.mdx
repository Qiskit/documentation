...
<Class id="qiskit.dagcircuit.DAGDependency" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/dagcircuit/dagdependency.py" signature="DAGDependency" modifiers="class">
  ...
  **Reference:**
  ...
  <Function id="qiskit.dagcircuit.DAGDependency.calibrations" signature="calibrations" modifiers="property">
  ...
  <Function id="qiskit.dagcircuit.DAGDependency.global_phase" signature="global_phase" modifiers="property">
