...
<Class id="qiskit.dagcircuit.DAGDependency" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/dagcircuit/dagdependency.py" signature="DAGDependency">
  ...
  **Reference:**
  ...
  <Function id="qiskit.dagcircuit.DAGDependency.calibrations" signature="property calibrations">
  ...
  <Function id="qiskit.dagcircuit.DAGDependency.global_phase" signature="property global_phase">
