...
<Class id="qiskit.optimization.problems.Variable" github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/optimization/problems/variable.py" signature="Variable(quadratic_program, name, lowerbound=0, upperbound=1e+20, vartype=<VarType.CONTINUOUS: 0>)">
  ...
  **Raises**
  ...
  <Function id="qiskit.optimization.problems.Variable.__init__" name="__init__" signature="__init__(quadratic_program, name, lowerbound=0, upperbound=1e+20, vartype=<VarType.CONTINUOUS: 0>)">
    Creates a new Variable.
  ...
  <Attribute id="qiskit.optimization.problems.Variable.Type" name="Type">
    alias of `VarType`
  </Attribute>

  ### as\_tuple

  <Function id="qiskit.optimization.problems.Variable.as_tuple" name="as_tuple" signature="as_tuple()">
  ...
  <Function id="qiskit.optimization.problems.Variable.lowerbound" name="lowerbound" signature="property lowerbound">
  ...
  <Function id="qiskit.optimization.problems.Variable.name" name="name" signature="property name">
  ...
  <Function id="qiskit.optimization.problems.Variable.quadratic_program" name="quadratic_program" signature="property quadratic_program">
  ...
  <Function id="qiskit.optimization.problems.Variable.upperbound" name="upperbound" signature="property upperbound">
  ...
  <Function id="qiskit.optimization.problems.Variable.vartype" name="vartype" signature="property vartype">
