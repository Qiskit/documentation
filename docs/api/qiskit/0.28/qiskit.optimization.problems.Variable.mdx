...
<Class id="qiskit.optimization.problems.Variable" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/optimization/problems/variable.py" signature="Variable(quadratic_program, name, lowerbound=0, upperbound=1e+20, vartype=<VarType.CONTINUOUS: 0>)">
  ...
  **Raises**
  ...
  <Function id="qiskit.optimization.problems.Variable.lowerbound" signature="property lowerbound">
  ...
  <Function id="qiskit.optimization.problems.Variable.name" signature="property name">
  ...
  <Function id="qiskit.optimization.problems.Variable.quadratic_program" signature="property quadratic_program">
  ...
  <Function id="qiskit.optimization.problems.Variable.upperbound" signature="property upperbound">
  ...
  <Function id="qiskit.optimization.problems.Variable.vartype" signature="property vartype">
