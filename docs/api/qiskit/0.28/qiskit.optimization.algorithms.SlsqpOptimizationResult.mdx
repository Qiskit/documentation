...
<Class id="qiskit.optimization.algorithms.SlsqpOptimizationResult" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/optimization/algorithms/slsqp_optimizer.py" signature="SlsqpOptimizationResult(x, fval, variables, status, fx=None, its=None, imode=None, smode=None)">
  ...
  *   **status** (`OptimizationResultStatus`) – the termination status of the optimization algorithm.
  ...
  <Function id="qiskit.optimization.algorithms.SlsqpOptimizationResult.samples" name="samples" signature="property samples">
