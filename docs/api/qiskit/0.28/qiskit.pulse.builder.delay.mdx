...
<Function id="qiskit.pulse.builder.delay" github="https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/pulse/builder.py" signature="delay(duration, channel, name=None)">
