...
<Class id="qiskit.algorithms.HHL" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/algorithms/linear_solvers/hhl.py" signature="HHL(epsilon=0.01, expectation=None, quantum_instance=None)" modifiers="class">
  ...
  *   **quantum\_instance** (`Union`\[`Backend`, `BaseBackend`, `QuantumInstance`, `None`]) – Quantum Instance or Backend. If None, a Statevector calculation is done.
  ...
  <Function id="qiskit.algorithms.HHL.expectation" signature="expectation" modifiers="property">
  ...
  <Function id="qiskit.algorithms.HHL.quantum_instance" signature="quantum_instance" modifiers="property">
  ...
  <Function id="qiskit.algorithms.HHL.scaling" signature="scaling" modifiers="property">
