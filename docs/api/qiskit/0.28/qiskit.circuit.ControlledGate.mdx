...
<Class id="qiskit.circuit.ControlledGate" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/circuit/controlledgate.py" signature="ControlledGate(name, num_qubits, params, label=None, num_ctrl_qubits=1, definition=None, ctrl_state=None, base_gate=None)">
  ...
  *   **CircuitError** – ctrl\_state \< 0 or ctrl\_state > 2\*\*num\_ctrl\_qubits.
  ...
  <Function id="qiskit.circuit.ControlledGate.__init__" name="__init__" signature="__init__(name, num_qubits, params, label=None, num_ctrl_qubits=1, definition=None, ctrl_state=None, base_gate=None)">
    Create a new ControlledGate. In the new gate the first `num_ctrl_qubits` of the gate are the controls.
  ...
  <Function id="qiskit.circuit.ControlledGate.control" name="control" signature="control(num_ctrl_qubits=1, label=None, ctrl_state=None)">
  ...
  <Function id="qiskit.circuit.ControlledGate.ctrl_state" name="ctrl_state" signature="property ctrl_state">
  ...
  <Function id="qiskit.circuit.ControlledGate.decompositions" name="decompositions" signature="property decompositions">
    Get the decompositions of the instruction from the SessionEquivalenceLibrary.
  </Function>

  ### definition

  <Function id="qiskit.circuit.ControlledGate.definition" name="definition" signature="property definition">
  ...
  <Function id="qiskit.circuit.ControlledGate.duration" name="duration" signature="property duration">
    Get the duration.
  </Function>

  ### inverse

  <Function id="qiskit.circuit.ControlledGate.inverse" name="inverse" signature="inverse()">
  ...
  <Function id="qiskit.circuit.ControlledGate.label" name="label" signature="property label">
  ...
  <Function id="qiskit.circuit.ControlledGate.mirror" name="mirror" signature="mirror()">
  ...
  <Function id="qiskit.circuit.ControlledGate.name" name="name" signature="property name">
  ...
  <Function id="qiskit.circuit.ControlledGate.num_ctrl_qubits" name="num_ctrl_qubits" signature="property num_ctrl_qubits">
  ...
  <Function id="qiskit.circuit.ControlledGate.params" name="params" signature="property params">
  ...
  <Function id="qiskit.circuit.ControlledGate.qasm" name="qasm" signature="qasm()">
  ...
  <Function id="qiskit.circuit.ControlledGate.unit" name="unit" signature="property unit">
