---
title: InnerProduct (v0.28)
description: API reference for qiskit.circuit.library.InnerProduct in qiskit v0.28
...
$$
  ...
  **Reference Circuit:**
  ...
  ![../\_images/qiskit.circuit.library.InnerProduct\_0\_1.png](/docs/images/api/qiskit/0.28/qiskit.circuit.library.InnerProduct_0_1.avif)
  ...
  **num\_qubits** (`int`) – width of top and bottom registers (half total circuit width)
  ...
  <Function id="qiskit.circuit.library.InnerProduct.draw" signature="draw(output=None, scale=None, filename=None, style=None, interactive=False, plot_barriers=True, reverse_bits=False, justify=None, vertical_compression='medium', idle_wires=True, with_layout=True, fold=None, ax=None, initial_state=False, cregbundle=True)">
    ...
    **Example**
    ...
    ![../\_images/qiskit.circuit.library.InnerProduct\_3\_0.png](/docs/images/api/qiskit/0.28/qiskit.circuit.library.InnerProduct_3_0.avif) ![../\_images/qiskit.circuit.library.InnerProduct\_3\_1.png](/docs/images/api/qiskit/0.28/qiskit.circuit.library.InnerProduct_3_1.avif)
  </Function>
