...
<Class id="qiskit.algorithms.optimizers.NFT" github="https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/algorithms/optimizers/nft.py" signature="NFT(maxiter=None, maxfev=1024, disp=False, reset_interval=32, options=None, **kwargs)">
  ...
  **1**
  ...
  <Function id="qiskit.algorithms.optimizers.NFT.__init__" name="__init__" signature="__init__(maxiter=None, maxfev=1024, disp=False, reset_interval=32, options=None, **kwargs)">
    Built out using scipy framework, for details, please refer to [https://docs.scipy.org/doc/scipy/reference/generated/scipy.optimize.minimize.html](https://docs.scipy.org/doc/scipy/reference/generated/scipy.optimize.minimize.html).
  ...
  <Function id="qiskit.algorithms.optimizers.NFT.settings" name="settings" signature="property settings">
