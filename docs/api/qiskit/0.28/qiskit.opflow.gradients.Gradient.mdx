---
title: Gradient (v0.28)
description: API reference for qiskit.opflow.gradients.Gradient in qiskit v0.28
...
<Class id="qiskit.opflow.gradients.Gradient" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/opflow/gradients/gradient.py" signature="Gradient(grad_method='param_shift', **kwargs)" modifiers="class">
