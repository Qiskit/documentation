...
<Class id="qiskit.pulse.InstructionScheduleMap" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/pulse/instruction_schedule_map.py" signature="InstructionScheduleMap">
  ...
  <Function id="qiskit.pulse.InstructionScheduleMap.__init__" name="__init__" signature="__init__()">
    Initialize a circuit instruction to schedule mapper instance.
  </Function>
  ...
  <Function id="qiskit.pulse.InstructionScheduleMap.instructions" name="instructions" signature="property instructions">
