---
title: InstructionScheduleMap (v0.28)
description: API reference for qiskit.pulse.InstructionScheduleMap in qiskit v0.28
...
<Class id="qiskit.pulse.InstructionScheduleMap" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/pulse/instruction_schedule_map.py" signature="InstructionScheduleMap" modifiers="class">
