...
<Class id="qiskit.opflow.primitive_ops.PauliSumOp" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/opflow/primitive_ops/pauli_sum_op.py" signature="PauliSumOp(primitive, coeff=1.0, grouping_type='None')">
  ...
  **TypeError** – invalid parameters.
  ...
  <Function id="qiskit.opflow.primitive_ops.PauliSumOp.coeff" signature="property coeff">
  ...
  <Function id="qiskit.opflow.primitive_ops.PauliSumOp.coeffs" signature="property coeffs">
  ...
  <Function id="qiskit.opflow.primitive_ops.PauliSumOp.from_list" signature="classmethod from_list(pauli_list, coeff=1.0)">
  ...
  <Function id="qiskit.opflow.primitive_ops.PauliSumOp.grouping_type" signature="property grouping_type">
    Type of Grouping
  ...
  <Function id="qiskit.opflow.primitive_ops.PauliSumOp.instance_id" signature="property instance_id">
  ...
  <Function id="qiskit.opflow.primitive_ops.PauliSumOp.num_qubits" signature="property num_qubits">
  ...
  <Function id="qiskit.opflow.primitive_ops.PauliSumOp.parameters" signature="property parameters">
  ...
  <Function id="qiskit.opflow.primitive_ops.PauliSumOp.primitive" signature="property primitive">
  ...
  <Function id="qiskit.opflow.primitive_ops.PauliSumOp.settings" signature="property settings">
