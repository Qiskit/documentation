...
<Class id="qiskit.chemistry.algorithms.pes_samplers.PolynomialExtrapolator" github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/chemistry/algorithms/pes_samplers/extrapolator.py" signature="PolynomialExtrapolator(degree=1)">
  ...
  **degree** (`int`) – Degree of polynomial to use for fitting in extrapolation.
  ...
  <Function id="qiskit.chemistry.algorithms.pes_samplers.PolynomialExtrapolator.__init__" name="__init__" signature="__init__(degree=1)">
    Constructor.
  ...
  <Function id="qiskit.chemistry.algorithms.pes_samplers.PolynomialExtrapolator.extrapolate" name="extrapolate" signature="extrapolate(points, param_dict)">
  ...
  <Function id="qiskit.chemistry.algorithms.pes_samplers.PolynomialExtrapolator.factory" name="factory" signature="static factory(mode, **kwargs)">
