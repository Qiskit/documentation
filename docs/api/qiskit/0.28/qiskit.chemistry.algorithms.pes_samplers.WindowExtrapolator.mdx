...
<Class id="qiskit.chemistry.algorithms.pes_samplers.WindowExtrapolator" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/chemistry/algorithms/pes_samplers/extrapolator.py" signature="WindowExtrapolator(extrapolator=None, window=2)">
  ...
  *   **window** (`int`) – Number of previous points to use for extrapolation. A value of zero indicates that all previous points will be used for bootstrapping.
  ...
  <Function id="qiskit.chemistry.algorithms.pes_samplers.WindowExtrapolator.__init__" name="__init__" signature="__init__(extrapolator=None, window=2)">
    Constructor.
  ...
  <Function id="qiskit.chemistry.algorithms.pes_samplers.WindowExtrapolator.extrapolate" name="extrapolate" signature="extrapolate(points, param_dict)">
  ...
  <Function id="qiskit.chemistry.algorithms.pes_samplers.WindowExtrapolator.extrapolator" name="extrapolator" signature="property extrapolator">
  ...
  <Function id="qiskit.chemistry.algorithms.pes_samplers.WindowExtrapolator.factory" name="factory" signature="static factory(mode, **kwargs)">
  ...
  <Function id="qiskit.chemistry.algorithms.pes_samplers.WindowExtrapolator.window" name="window" signature="property window">
