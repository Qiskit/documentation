---
title: CTMPExpvalMeasMitigator (v0.28)
description: API reference for qiskit.ignis.mitigation.CTMPExpvalMeasMitigator in qiskit v0.28
...
<Class id="qiskit.ignis.mitigation.CTMPExpvalMeasMitigator" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-ignis/tree/stable/0.6/qiskit/ignis/mitigation/expval/ctmp_mitigator.py" signature="CTMPExpvalMeasMitigator(generators, rates, num_qubits=None, seed=None)" modifiers="class">
