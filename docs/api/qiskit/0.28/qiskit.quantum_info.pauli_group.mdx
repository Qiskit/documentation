---
title: pauli_group (v0.28)
description: API reference for qiskit.quantum_info.pauli_group in qiskit v0.28
...
<Function id="qiskit.quantum_info.pauli_group" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/quantum_info/operators/pauli.py" signature="pauli_group(number_of_qubits, case='weight')">
