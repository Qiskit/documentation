...
<Class id="qiskit.transpiler.passes.SabreSwap" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/transpiler/passes/routing/sabre_swap.py" signature="SabreSwap(*args, **kwargs)" modifiers="class">
  ...
  *   **fake\_run** (*bool*) – if true, it only pretend to do routing, i.e., no swap is effectively added.
  ...
  <Function id="qiskit.transpiler.passes.SabreSwap.__init__" signature="__init__(coupling_map, heuristic='basic', seed=None, fake_run=False)">
    SabreSwap initializer.
  ...
  <Function id="qiskit.transpiler.passes.SabreSwap.is_analysis_pass" signature="is_analysis_pass" modifiers="property">
  ...
  <Function id="qiskit.transpiler.passes.SabreSwap.is_transformation_pass" signature="is_transformation_pass" modifiers="property">
