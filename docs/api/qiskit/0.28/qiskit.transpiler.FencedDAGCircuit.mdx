...
<Class id="qiskit.transpiler.FencedDAGCircuit" github="https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/transpiler/fencedobjs.py" signature="FencedDAGCircuit(dag_circuit_instance)">
