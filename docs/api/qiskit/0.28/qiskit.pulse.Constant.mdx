...
<Class id="qiskit.pulse.Constant" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/pulse/library/parametric_pulses.py" signature="Constant(duration, amp, name=None)">
...
$$
  ...
  *   **name** (`Optional`\[`str`]) – Display name for this pulse envelope.
  ...
  <Function id="qiskit.pulse.Constant.__init__" name="__init__" signature="__init__(duration, amp, name=None)">
    Initialize the constant-valued pulse.
  ...
  <Function id="qiskit.pulse.Constant.amp" name="amp" signature="property amp">
  ...
  <Function id="qiskit.pulse.Constant.assign" name="assign" signature="assign(parameter, value)">
  ...
  <Function id="qiskit.pulse.Constant.assign_parameters" name="assign_parameters" signature="assign_parameters(value_dict)">
  ...
  <Function id="qiskit.pulse.Constant.draw" name="draw" signature="draw(dt=None, style=None, filename=None, interp_method=None, scale=None, interactive=None, draw_title=None, backend=None, time_range=None, time_unit='dt', show_waveform_info=True, plotter='mpl2d', axis=None)">
  ...
  <Function id="qiskit.pulse.Constant.get_waveform" name="get_waveform" signature="get_waveform()">
  ...
  <Function id="qiskit.pulse.Constant.id" name="id" signature="property id">
  ...
  <Function id="qiskit.pulse.Constant.is_parameterized" name="is_parameterized" signature="is_parameterized()">
  ...
  <Function id="qiskit.pulse.Constant.parameters" name="parameters" signature="property parameters">
  ...
  <Function id="qiskit.pulse.Constant.validate_parameters" name="validate_parameters" signature="validate_parameters()">
    Validate parameters.
