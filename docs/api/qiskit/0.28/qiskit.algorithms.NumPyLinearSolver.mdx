...
<Class id="qiskit.algorithms.NumPyLinearSolver" github="https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/algorithms/linear_solvers/numpy_linear_solver.py" signature="NumPyLinearSolver">
