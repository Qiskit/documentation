...
<Class id="qiskit.transpiler.passes.NumTensorFactors" github="https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/transpiler/passes/analysis/num_tensor_factors.py" signature="NumTensorFactors(*args, **kwargs)">
