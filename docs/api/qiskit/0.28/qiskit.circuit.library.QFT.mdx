...
`QFT(num_qubits=None, approximation_degree=0, do_swaps=True, inverse=False, insert_barriers=False, name='QFT')` [GitHub](https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/circuit/library/basis_change/qft.py "view source code")
...
![../\_images/qiskit.circuit.library.QFT\_0\_1.png](/images/api/qiskit/0.28/qiskit.circuit.library.QFT_0_1.png)

The inverse QFT can be obtained by calling the `inverse` method on this class. The respective circuit diagram is:

![../\_images/qiskit.circuit.library.QFT\_1\_1.png](/images/api/qiskit/0.28/qiskit.circuit.library.QFT_1_1.png)
...
![../\_images/qiskit.circuit.library.QFT\_2\_1.png](/images/api/qiskit/0.28/qiskit.circuit.library.QFT_2_1.png)
...
<span id="qiskit.circuit.library.QFT.__init__" />

`__init__(num_qubits=None, approximation_degree=0, do_swaps=True, inverse=False, insert_barriers=False, name='QFT')`
...
|                                                                                                                                                                                 |                                                                                                                                     |
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------- |
| [`__init__`](#qiskit.circuit.library.QFT.__init__ "qiskit.circuit.library.QFT.__init__")(\[num\_qubits, approximation\_degree, …])                                              | Construct a new QFT circuit.                                                                                                        |
| [`add_bits`](#qiskit.circuit.library.QFT.add_bits "qiskit.circuit.library.QFT.add_bits")(bits)                                                                                  | Add Bits to the circuit.                                                                                                            |
| [`add_calibration`](#qiskit.circuit.library.QFT.add_calibration "qiskit.circuit.library.QFT.add_calibration")(gate, qubits, schedule\[, params])                                | Register a low-level, custom pulse definition for the given gate.                                                                   |
| [`add_register`](#qiskit.circuit.library.QFT.add_register "qiskit.circuit.library.QFT.add_register")(\*regs)                                                                    | Add registers.                                                                                                                      |
| [`append`](#qiskit.circuit.library.QFT.append "qiskit.circuit.library.QFT.append")(instruction\[, qargs, cargs])                                                                | Append one or more instructions to the end of the circuit, modifying the circuit in place.                                          |
| [`assign_parameters`](#qiskit.circuit.library.QFT.assign_parameters "qiskit.circuit.library.QFT.assign_parameters")(parameters\[, inplace, …])                                  | Assign parameters to new parameters or values.                                                                                      |
| [`barrier`](#qiskit.circuit.library.QFT.barrier "qiskit.circuit.library.QFT.barrier")(\*qargs)                                                                                  | Apply `Barrier`.                                                                                                                    |
| [`bind_parameters`](#qiskit.circuit.library.QFT.bind_parameters "qiskit.circuit.library.QFT.bind_parameters")(values\[, value\_dict])                                           | Assign numeric parameters to values yielding a new circuit.                                                                         |
| [`cast`](#qiskit.circuit.library.QFT.cast "qiskit.circuit.library.QFT.cast")(value, \_type)                                                                                     | Best effort to cast value to type.                                                                                                  |
| [`cbit_argument_conversion`](#qiskit.circuit.library.QFT.cbit_argument_conversion "qiskit.circuit.library.QFT.cbit_argument_conversion")(clbit\_representation)                 | Converts several classical bit representations (such as indexes, range, etc.) into a list of classical bits.                        |
| [`ccx`](#qiskit.circuit.library.QFT.ccx "qiskit.circuit.library.QFT.ccx")(control\_qubit1, control\_qubit2, target\_qubit)                                                      | Apply [`CCXGate`](qiskit.circuit.library.CCXGate "qiskit.circuit.library.CCXGate").                                                 |
| [`ch`](#qiskit.circuit.library.QFT.ch "qiskit.circuit.library.QFT.ch")(control\_qubit, target\_qubit\[, label, …])                                                              | Apply [`CHGate`](qiskit.circuit.library.CHGate "qiskit.circuit.library.CHGate").                                                    |
| [`cls_instances`](#qiskit.circuit.library.QFT.cls_instances "qiskit.circuit.library.QFT.cls_instances")()                                                                       | Return the current number of instances of this class, useful for auto naming.                                                       |
| [`cls_prefix`](#qiskit.circuit.library.QFT.cls_prefix "qiskit.circuit.library.QFT.cls_prefix")()                                                                                | Return the prefix to use for auto naming.                                                                                           |
| [`cnot`](#qiskit.circuit.library.QFT.cnot "qiskit.circuit.library.QFT.cnot")(control\_qubit, target\_qubit\[, label, …])                                                        | Apply [`CXGate`](qiskit.circuit.library.CXGate "qiskit.circuit.library.CXGate").                                                    |
| [`combine`](#qiskit.circuit.library.QFT.combine "qiskit.circuit.library.QFT.combine")(rhs)                                                                                      | DEPRECATED - Returns rhs appended to self if self contains compatible registers.                                                    |
| [`compose`](#qiskit.circuit.library.QFT.compose "qiskit.circuit.library.QFT.compose")(other\[, qubits, clbits, front, …])                                                       | Compose circuit with `other` circuit or instruction, optionally permuting wires.                                                    |
| [`control`](#qiskit.circuit.library.QFT.control "qiskit.circuit.library.QFT.control")(\[num\_ctrl\_qubits, label, ctrl\_state])                                                 | Control this circuit on `num_ctrl_qubits` qubits.                                                                                   |
| [`copy`](#qiskit.circuit.library.QFT.copy "qiskit.circuit.library.QFT.copy")(\[name])                                                                                           | Copy the circuit.                                                                                                                   |
| [`count_ops`](#qiskit.circuit.library.QFT.count_ops "qiskit.circuit.library.QFT.count_ops")()                                                                                   | Count each operation kind in the circuit.                                                                                           |
| [`cp`](#qiskit.circuit.library.QFT.cp "qiskit.circuit.library.QFT.cp")(theta, control\_qubit, target\_qubit\[, …])                                                              | Apply [`CPhaseGate`](qiskit.circuit.library.CPhaseGate "qiskit.circuit.library.CPhaseGate").                                        |
| [`crx`](#qiskit.circuit.library.QFT.crx "qiskit.circuit.library.QFT.crx")(theta, control\_qubit, target\_qubit\[, …])                                                           | Apply [`CRXGate`](qiskit.circuit.library.CRXGate "qiskit.circuit.library.CRXGate").                                                 |
| [`cry`](#qiskit.circuit.library.QFT.cry "qiskit.circuit.library.QFT.cry")(theta, control\_qubit, target\_qubit\[, …])                                                           | Apply [`CRYGate`](qiskit.circuit.library.CRYGate "qiskit.circuit.library.CRYGate").                                                 |
| [`crz`](#qiskit.circuit.library.QFT.crz "qiskit.circuit.library.QFT.crz")(theta, control\_qubit, target\_qubit\[, …])                                                           | Apply [`CRZGate`](qiskit.circuit.library.CRZGate "qiskit.circuit.library.CRZGate").                                                 |
| [`cswap`](#qiskit.circuit.library.QFT.cswap "qiskit.circuit.library.QFT.cswap")(control\_qubit, target\_qubit1, …\[, …])                                                        | Apply [`CSwapGate`](qiskit.circuit.library.CSwapGate "qiskit.circuit.library.CSwapGate").                                           |
| [`csx`](#qiskit.circuit.library.QFT.csx "qiskit.circuit.library.QFT.csx")(control\_qubit, target\_qubit\[, label, …])                                                           | Apply [`CSXGate`](qiskit.circuit.library.CSXGate "qiskit.circuit.library.CSXGate").                                                 |
| [`cu`](#qiskit.circuit.library.QFT.cu "qiskit.circuit.library.QFT.cu")(theta, phi, lam, gamma, control\_qubit, …)                                                               | Apply [`CUGate`](qiskit.circuit.library.CUGate "qiskit.circuit.library.CUGate").                                                    |
| [`cu1`](#qiskit.circuit.library.QFT.cu1 "qiskit.circuit.library.QFT.cu1")(theta, control\_qubit, target\_qubit\[, …])                                                           | Apply [`CU1Gate`](qiskit.circuit.library.CU1Gate "qiskit.circuit.library.CU1Gate").                                                 |
| [`cu3`](#qiskit.circuit.library.QFT.cu3 "qiskit.circuit.library.QFT.cu3")(theta, phi, lam, control\_qubit, target\_qubit)                                                       | Apply [`CU3Gate`](qiskit.circuit.library.CU3Gate "qiskit.circuit.library.CU3Gate").                                                 |
| [`cx`](#qiskit.circuit.library.QFT.cx "qiskit.circuit.library.QFT.cx")(control\_qubit, target\_qubit\[, label, …])                                                              | Apply [`CXGate`](qiskit.circuit.library.CXGate "qiskit.circuit.library.CXGate").                                                    |
| [`cy`](#qiskit.circuit.library.QFT.cy "qiskit.circuit.library.QFT.cy")(control\_qubit, target\_qubit\[, label, …])                                                              | Apply [`CYGate`](qiskit.circuit.library.CYGate "qiskit.circuit.library.CYGate").                                                    |
| [`cz`](#qiskit.circuit.library.QFT.cz "qiskit.circuit.library.QFT.cz")(control\_qubit, target\_qubit\[, label, …])                                                              | Apply [`CZGate`](qiskit.circuit.library.CZGate "qiskit.circuit.library.CZGate").                                                    |
| [`dcx`](#qiskit.circuit.library.QFT.dcx "qiskit.circuit.library.QFT.dcx")(qubit1, qubit2)                                                                                       | Apply [`DCXGate`](qiskit.circuit.library.DCXGate "qiskit.circuit.library.DCXGate").                                                 |
| [`decompose`](#qiskit.circuit.library.QFT.decompose "qiskit.circuit.library.QFT.decompose")()                                                                                   | Call a decomposition pass on this circuit, to decompose one level (shallow decompose).                                              |
| [`delay`](#qiskit.circuit.library.QFT.delay "qiskit.circuit.library.QFT.delay")(duration\[, qarg, unit])                                                                        | Apply [`Delay`](qiskit.circuit.Delay "qiskit.circuit.Delay").                                                                       |
| [`depth`](#qiskit.circuit.library.QFT.depth "qiskit.circuit.library.QFT.depth")()                                                                                               | Return circuit depth (i.e., length of critical path).                                                                               |
| [`diagonal`](#qiskit.circuit.library.QFT.diagonal "qiskit.circuit.library.QFT.diagonal")(diag, qubit)                                                                           | Attach a diagonal gate to a circuit.                                                                                                |
| [`draw`](#qiskit.circuit.library.QFT.draw "qiskit.circuit.library.QFT.draw")(\[output, scale, filename, style, …])                                                              | Draw the quantum circuit.                                                                                                           |
| [`ecr`](#qiskit.circuit.library.QFT.ecr "qiskit.circuit.library.QFT.ecr")(qubit1, qubit2)                                                                                       | Apply [`ECRGate`](qiskit.circuit.library.ECRGate "qiskit.circuit.library.ECRGate").                                                 |
| [`extend`](#qiskit.circuit.library.QFT.extend "qiskit.circuit.library.QFT.extend")(rhs)                                                                                         | DEPRECATED - Append QuantumCircuit to the RHS if it contains compatible registers.                                                  |
| [`fredkin`](#qiskit.circuit.library.QFT.fredkin "qiskit.circuit.library.QFT.fredkin")(control\_qubit, target\_qubit1, …)                                                        | Apply [`CSwapGate`](qiskit.circuit.library.CSwapGate "qiskit.circuit.library.CSwapGate").                                           |
| [`from_qasm_file`](#qiskit.circuit.library.QFT.from_qasm_file "qiskit.circuit.library.QFT.from_qasm_file")(path)                                                                | Take in a QASM file and generate a QuantumCircuit object.                                                                           |
| [`from_qasm_str`](#qiskit.circuit.library.QFT.from_qasm_str "qiskit.circuit.library.QFT.from_qasm_str")(qasm\_str)                                                              | Take in a QASM string and generate a QuantumCircuit object.                                                                         |
| [`get_instructions`](#qiskit.circuit.library.QFT.get_instructions "qiskit.circuit.library.QFT.get_instructions")(name)                                                          | Get instructions matching name.                                                                                                     |
| [`h`](#qiskit.circuit.library.QFT.h "qiskit.circuit.library.QFT.h")(qubit)                                                                                                      | Apply [`HGate`](qiskit.circuit.library.HGate "qiskit.circuit.library.HGate").                                                       |
| [`hamiltonian`](#qiskit.circuit.library.QFT.hamiltonian "qiskit.circuit.library.QFT.hamiltonian")(operator, time, qubits\[, label])                                             | Apply hamiltonian evolution to qubits.                                                                                              |
| [`has_register`](#qiskit.circuit.library.QFT.has_register "qiskit.circuit.library.QFT.has_register")(register)                                                                  | Test if this circuit has the register r.                                                                                            |
| [`i`](#qiskit.circuit.library.QFT.i "qiskit.circuit.library.QFT.i")(qubit)                                                                                                      | Apply [`IGate`](qiskit.circuit.library.IGate "qiskit.circuit.library.IGate").                                                       |
| [`id`](#qiskit.circuit.library.QFT.id "qiskit.circuit.library.QFT.id")(qubit)                                                                                                   | Apply [`IGate`](qiskit.circuit.library.IGate "qiskit.circuit.library.IGate").                                                       |
| [`initialize`](#qiskit.circuit.library.QFT.initialize "qiskit.circuit.library.QFT.initialize")(params\[, qubits])                                                               | Initialize qubits in a specific state.                                                                                              |
...
| [`iso`](#qiskit.circuit.library.QFT.iso "qiskit.circuit.library.QFT.iso")(isometry, q\_input, q\_ancillas\_for\_output)                                                         | Attach an arbitrary isometry from m to n qubits to a circuit.                                                                       |
| [`isometry`](#qiskit.circuit.library.QFT.isometry "qiskit.circuit.library.QFT.isometry")(isometry, q\_input, …\[, …])                                                           | Attach an arbitrary isometry from m to n qubits to a circuit.                                                                       |
| [`iswap`](#qiskit.circuit.library.QFT.iswap "qiskit.circuit.library.QFT.iswap")(qubit1, qubit2)                                                                                 | Apply [`iSwapGate`](qiskit.circuit.library.iSwapGate "qiskit.circuit.library.iSwapGate").                                           |
| [`mcp`](#qiskit.circuit.library.QFT.mcp "qiskit.circuit.library.QFT.mcp")(lam, control\_qubits, target\_qubit)                                                                  | Apply [`MCPhaseGate`](qiskit.circuit.library.MCPhaseGate "qiskit.circuit.library.MCPhaseGate").                                     |
| [`mcrx`](#qiskit.circuit.library.QFT.mcrx "qiskit.circuit.library.QFT.mcrx")(theta, q\_controls, q\_target\[, …])                                                               | Apply Multiple-Controlled X rotation gate                                                                                           |
| [`mcry`](#qiskit.circuit.library.QFT.mcry "qiskit.circuit.library.QFT.mcry")(theta, q\_controls, q\_target\[, …])                                                               | Apply Multiple-Controlled Y rotation gate                                                                                           |
| [`mcrz`](#qiskit.circuit.library.QFT.mcrz "qiskit.circuit.library.QFT.mcrz")(lam, q\_controls, q\_target\[, …])                                                                 | Apply Multiple-Controlled Z rotation gate                                                                                           |
| [`mct`](#qiskit.circuit.library.QFT.mct "qiskit.circuit.library.QFT.mct")(control\_qubits, target\_qubit\[, …])                                                                 | Apply [`MCXGate`](qiskit.circuit.library.MCXGate "qiskit.circuit.library.MCXGate").                                                 |
| [`mcu1`](#qiskit.circuit.library.QFT.mcu1 "qiskit.circuit.library.QFT.mcu1")(lam, control\_qubits, target\_qubit)                                                               | Apply `MCU1Gate`.                                                                                                                   |
| [`mcx`](#qiskit.circuit.library.QFT.mcx "qiskit.circuit.library.QFT.mcx")(control\_qubits, target\_qubit\[, …])                                                                 | Apply [`MCXGate`](qiskit.circuit.library.MCXGate "qiskit.circuit.library.MCXGate").                                                 |
| [`measure`](#qiskit.circuit.library.QFT.measure "qiskit.circuit.library.QFT.measure")(qubit, cbit)                                                                              | Measure quantum bit into classical bit (tuples).                                                                                    |
| [`measure_active`](#qiskit.circuit.library.QFT.measure_active "qiskit.circuit.library.QFT.measure_active")(\[inplace])                                                          | Adds measurement to all non-idle qubits.                                                                                            |
| [`measure_all`](#qiskit.circuit.library.QFT.measure_all "qiskit.circuit.library.QFT.measure_all")(\[inplace])                                                                   | Adds measurement to all qubits.                                                                                                     |
| [`ms`](#qiskit.circuit.library.QFT.ms "qiskit.circuit.library.QFT.ms")(theta, qubits)                                                                                           | Apply [`MSGate`](qiskit.circuit.library.MSGate "qiskit.circuit.library.MSGate").                                                    |
| [`num_connected_components`](#qiskit.circuit.library.QFT.num_connected_components "qiskit.circuit.library.QFT.num_connected_components")(\[unitary\_only])                      | How many non-entangled subcircuits can the circuit be factored to.                                                                  |
| [`num_nonlocal_gates`](#qiskit.circuit.library.QFT.num_nonlocal_gates "qiskit.circuit.library.QFT.num_nonlocal_gates")()                                                        | Return number of non-local gates (i.e.                                                                                              |
| [`num_tensor_factors`](#qiskit.circuit.library.QFT.num_tensor_factors "qiskit.circuit.library.QFT.num_tensor_factors")()                                                        | Computes the number of tensor factors in the unitary (quantum) part of the circuit only.                                            |
| [`num_unitary_factors`](#qiskit.circuit.library.QFT.num_unitary_factors "qiskit.circuit.library.QFT.num_unitary_factors")()                                                     | Computes the number of tensor factors in the unitary (quantum) part of the circuit only.                                            |
| [`p`](#qiskit.circuit.library.QFT.p "qiskit.circuit.library.QFT.p")(theta, qubit)                                                                                               | Apply [`PhaseGate`](qiskit.circuit.library.PhaseGate "qiskit.circuit.library.PhaseGate").                                           |
| [`pauli`](#qiskit.circuit.library.QFT.pauli "qiskit.circuit.library.QFT.pauli")(pauli\_string, qubits)                                                                          | Apply [`PauliGate`](qiskit.circuit.library.PauliGate "qiskit.circuit.library.PauliGate").                                           |
| [`power`](#qiskit.circuit.library.QFT.power "qiskit.circuit.library.QFT.power")(power\[, matrix\_power])                                                                        | Raise this circuit to the power of `power`.                                                                                         |
| [`qasm`](#qiskit.circuit.library.QFT.qasm "qiskit.circuit.library.QFT.qasm")(\[formatted, filename, encoding])                                                                  | Return OpenQASM string.                                                                                                             |
| [`qbit_argument_conversion`](#qiskit.circuit.library.QFT.qbit_argument_conversion "qiskit.circuit.library.QFT.qbit_argument_conversion")(qubit\_representation)                 | Converts several qubit representations (such as indexes, range, etc.) into a list of qubits.                                        |
| [`qubit_duration`](#qiskit.circuit.library.QFT.qubit_duration "qiskit.circuit.library.QFT.qubit_duration")(\*qubits)                                                            | Return the duration between the start and stop time of the first and last instructions, excluding delays, over the supplied qubits. |
| [`qubit_start_time`](#qiskit.circuit.library.QFT.qubit_start_time "qiskit.circuit.library.QFT.qubit_start_time")(\*qubits)                                                      | Return the start time of the first instruction, excluding delays, over the supplied qubits.                                         |
| [`qubit_stop_time`](#qiskit.circuit.library.QFT.qubit_stop_time "qiskit.circuit.library.QFT.qubit_stop_time")(\*qubits)                                                         | Return the stop time of the last instruction, excluding delays, over the supplied qubits.                                           |
| [`r`](#qiskit.circuit.library.QFT.r "qiskit.circuit.library.QFT.r")(theta, phi, qubit)                                                                                          | Apply [`RGate`](qiskit.circuit.library.RGate "qiskit.circuit.library.RGate").                                                       |
| [`rcccx`](#qiskit.circuit.library.QFT.rcccx "qiskit.circuit.library.QFT.rcccx")(control\_qubit1, control\_qubit2, …)                                                            | Apply [`RC3XGate`](qiskit.circuit.library.RC3XGate "qiskit.circuit.library.RC3XGate").                                              |
| [`rccx`](#qiskit.circuit.library.QFT.rccx "qiskit.circuit.library.QFT.rccx")(control\_qubit1, control\_qubit2, …)                                                               | Apply [`RCCXGate`](qiskit.circuit.library.RCCXGate "qiskit.circuit.library.RCCXGate").                                              |
| [`remove_final_measurements`](#qiskit.circuit.library.QFT.remove_final_measurements "qiskit.circuit.library.QFT.remove_final_measurements")(\[inplace])                         | Removes final measurement on all qubits if they are present.                                                                        |
| [`repeat`](#qiskit.circuit.library.QFT.repeat "qiskit.circuit.library.QFT.repeat")(reps)                                                                                        | Repeat this circuit `reps` times.                                                                                                   |
| [`reset`](#qiskit.circuit.library.QFT.reset "qiskit.circuit.library.QFT.reset")(qubit)                                                                                          | Reset q.                                                                                                                            |
| [`reverse_bits`](#qiskit.circuit.library.QFT.reverse_bits "qiskit.circuit.library.QFT.reverse_bits")()                                                                          | Return a circuit with the opposite order of wires.                                                                                  |
| [`reverse_ops`](#qiskit.circuit.library.QFT.reverse_ops "qiskit.circuit.library.QFT.reverse_ops")()                                                                             | Reverse the circuit by reversing the order of instructions.                                                                         |
| [`rv`](#qiskit.circuit.library.QFT.rv "qiskit.circuit.library.QFT.rv")(vx, vy, vz, qubit)                                                                                       | Apply [`RVGate`](qiskit.circuit.library.RVGate "qiskit.circuit.library.RVGate").                                                    |
| [`rx`](#qiskit.circuit.library.QFT.rx "qiskit.circuit.library.QFT.rx")(theta, qubit\[, label])                                                                                  | Apply [`RXGate`](qiskit.circuit.library.RXGate "qiskit.circuit.library.RXGate").                                                    |
| [`rxx`](#qiskit.circuit.library.QFT.rxx "qiskit.circuit.library.QFT.rxx")(theta, qubit1, qubit2)                                                                                | Apply [`RXXGate`](qiskit.circuit.library.RXXGate "qiskit.circuit.library.RXXGate").                                                 |
| [`ry`](#qiskit.circuit.library.QFT.ry "qiskit.circuit.library.QFT.ry")(theta, qubit\[, label])                                                                                  | Apply [`RYGate`](qiskit.circuit.library.RYGate "qiskit.circuit.library.RYGate").                                                    |
| [`ryy`](#qiskit.circuit.library.QFT.ryy "qiskit.circuit.library.QFT.ryy")(theta, qubit1, qubit2)                                                                                | Apply [`RYYGate`](qiskit.circuit.library.RYYGate "qiskit.circuit.library.RYYGate").                                                 |
| [`rz`](#qiskit.circuit.library.QFT.rz "qiskit.circuit.library.QFT.rz")(phi, qubit)                                                                                              | Apply [`RZGate`](qiskit.circuit.library.RZGate "qiskit.circuit.library.RZGate").                                                    |
| [`rzx`](#qiskit.circuit.library.QFT.rzx "qiskit.circuit.library.QFT.rzx")(theta, qubit1, qubit2)                                                                                | Apply [`RZXGate`](qiskit.circuit.library.RZXGate "qiskit.circuit.library.RZXGate").                                                 |
| [`rzz`](#qiskit.circuit.library.QFT.rzz "qiskit.circuit.library.QFT.rzz")(theta, qubit1, qubit2)                                                                                | Apply [`RZZGate`](qiskit.circuit.library.RZZGate "qiskit.circuit.library.RZZGate").                                                 |
| [`s`](#qiskit.circuit.library.QFT.s "qiskit.circuit.library.QFT.s")(qubit)                                                                                                      | Apply [`SGate`](qiskit.circuit.library.SGate "qiskit.circuit.library.SGate").                                                       |
| [`save_amplitudes`](#qiskit.circuit.library.QFT.save_amplitudes "qiskit.circuit.library.QFT.save_amplitudes")(params\[, label, pershot, …])                                     | Save complex statevector amplitudes.                                                                                                |
| [`save_amplitudes_squared`](#qiskit.circuit.library.QFT.save_amplitudes_squared "qiskit.circuit.library.QFT.save_amplitudes_squared")(params\[, label, …])                      | Save squared statevector amplitudes (probabilities).                                                                                |
| [`save_density_matrix`](#qiskit.circuit.library.QFT.save_density_matrix "qiskit.circuit.library.QFT.save_density_matrix")(\[qubits, label, …])                                  | Save the current simulator quantum state as a density matrix.                                                                       |
| [`save_expectation_value`](#qiskit.circuit.library.QFT.save_expectation_value "qiskit.circuit.library.QFT.save_expectation_value")(operator, qubits\[, …])                      | Save the expectation value of a Hermitian operator.                                                                                 |
| [`save_expectation_value_variance`](#qiskit.circuit.library.QFT.save_expectation_value_variance "qiskit.circuit.library.QFT.save_expectation_value_variance")(operator, qubits) | Save the expectation value of a Hermitian operator.                                                                                 |
| [`save_matrix_product_state`](#qiskit.circuit.library.QFT.save_matrix_product_state "qiskit.circuit.library.QFT.save_matrix_product_state")(\[label, pershot, …])               | Save the current simulator quantum state as a matrix product state.                                                                 |
| [`save_probabilities`](#qiskit.circuit.library.QFT.save_probabilities "qiskit.circuit.library.QFT.save_probabilities")(\[qubits, label, …])                                     | Save measurement outcome probabilities vector.                                                                                      |
| [`save_probabilities_dict`](#qiskit.circuit.library.QFT.save_probabilities_dict "qiskit.circuit.library.QFT.save_probabilities_dict")(\[qubits, label, …])                      | Save measurement outcome probabilities vector.                                                                                      |
| [`save_stabilizer`](#qiskit.circuit.library.QFT.save_stabilizer "qiskit.circuit.library.QFT.save_stabilizer")(\[label, pershot, conditional])                                   | Save the current stabilizer simulator quantum state as a Clifford.                                                                  |
| [`save_state`](#qiskit.circuit.library.QFT.save_state "qiskit.circuit.library.QFT.save_state")(\[label, pershot, conditional])                                                  | Save the current simulator quantum state.                                                                                           |
| [`save_statevector`](#qiskit.circuit.library.QFT.save_statevector "qiskit.circuit.library.QFT.save_statevector")(\[label, pershot, conditional])                                | Save the current simulator quantum state as a statevector.                                                                          |
| [`save_statevector_dict`](#qiskit.circuit.library.QFT.save_statevector_dict "qiskit.circuit.library.QFT.save_statevector_dict")(\[label, pershot, …])                           | Save the current simulator quantum state as a statevector as a dict.                                                                |
| [`save_superop`](#qiskit.circuit.library.QFT.save_superop "qiskit.circuit.library.QFT.save_superop")(\[label, pershot])                                                         | Save the current state of the superop simulator.                                                                                    |
| [`save_unitary`](#qiskit.circuit.library.QFT.save_unitary "qiskit.circuit.library.QFT.save_unitary")(\[label, pershot])                                                         | Save the current state of the unitary simulator.                                                                                    |
| [`sdg`](#qiskit.circuit.library.QFT.sdg "qiskit.circuit.library.QFT.sdg")(qubit)                                                                                                | Apply [`SdgGate`](qiskit.circuit.library.SdgGate "qiskit.circuit.library.SdgGate").                                                 |
| [`set_density_matrix`](#qiskit.circuit.library.QFT.set_density_matrix "qiskit.circuit.library.QFT.set_density_matrix")(state)                                                   | Set the density matrix state of the simulator.                                                                                      |
| [`set_matrix_product_state`](#qiskit.circuit.library.QFT.set_matrix_product_state "qiskit.circuit.library.QFT.set_matrix_product_state")(state)                                 | Set the matrix product state of the simulator.                                                                                      |
| [`set_stabilizer`](#qiskit.circuit.library.QFT.set_stabilizer "qiskit.circuit.library.QFT.set_stabilizer")(state)                                                               | Set the Clifford stabilizer state of the simulator.                                                                                 |
| [`set_statevector`](#qiskit.circuit.library.QFT.set_statevector "qiskit.circuit.library.QFT.set_statevector")(state)                                                            | Set the statevector state of the simulator.                                                                                         |
| [`set_superop`](#qiskit.circuit.library.QFT.set_superop "qiskit.circuit.library.QFT.set_superop")(state)                                                                        | Set the superop state of the simulator.                                                                                             |
| [`set_unitary`](#qiskit.circuit.library.QFT.set_unitary "qiskit.circuit.library.QFT.set_unitary")(state)                                                                        | Set the state state of the simulator.                                                                                               |
| [`size`](#qiskit.circuit.library.QFT.size "qiskit.circuit.library.QFT.size")()                                                                                                  | Returns total number of gate operations in circuit.                                                                                 |
| [`snapshot`](#qiskit.circuit.library.QFT.snapshot "qiskit.circuit.library.QFT.snapshot")(label\[, snapshot\_type, qubits, params])                                              | Take a statevector snapshot of the internal simulator representation.                                                               |
| [`snapshot_density_matrix`](#qiskit.circuit.library.QFT.snapshot_density_matrix "qiskit.circuit.library.QFT.snapshot_density_matrix")(label\[, qubits])                         | Take a density matrix snapshot of simulator state.                                                                                  |
| [`snapshot_expectation_value`](#qiskit.circuit.library.QFT.snapshot_expectation_value "qiskit.circuit.library.QFT.snapshot_expectation_value")(label, op, qubits)               | Take a snapshot of expectation value \<O> of an Operator.                                                                           |
| [`snapshot_probabilities`](#qiskit.circuit.library.QFT.snapshot_probabilities "qiskit.circuit.library.QFT.snapshot_probabilities")(label, qubits\[, variance])                  | Take a probability snapshot of the simulator state.                                                                                 |
| [`snapshot_stabilizer`](#qiskit.circuit.library.QFT.snapshot_stabilizer "qiskit.circuit.library.QFT.snapshot_stabilizer")(label)                                                | Take a stabilizer snapshot of the simulator state.                                                                                  |
| [`snapshot_statevector`](#qiskit.circuit.library.QFT.snapshot_statevector "qiskit.circuit.library.QFT.snapshot_statevector")(label)                                             | Take a statevector snapshot of the simulator state.                                                                                 |
| [`squ`](#qiskit.circuit.library.QFT.squ "qiskit.circuit.library.QFT.squ")(unitary\_matrix, qubit\[, mode, …])                                                                   | Decompose an arbitrary 2\*2 unitary into three rotation gates.                                                                      |
| [`swap`](#qiskit.circuit.library.QFT.swap "qiskit.circuit.library.QFT.swap")(qubit1, qubit2)                                                                                    | Apply [`SwapGate`](qiskit.circuit.library.SwapGate "qiskit.circuit.library.SwapGate").                                              |
| [`sx`](#qiskit.circuit.library.QFT.sx "qiskit.circuit.library.QFT.sx")(qubit)                                                                                                   | Apply [`SXGate`](qiskit.circuit.library.SXGate "qiskit.circuit.library.SXGate").                                                    |
| [`sxdg`](#qiskit.circuit.library.QFT.sxdg "qiskit.circuit.library.QFT.sxdg")(qubit)                                                                                             | Apply [`SXdgGate`](qiskit.circuit.library.SXdgGate "qiskit.circuit.library.SXdgGate").                                              |
| [`t`](#qiskit.circuit.library.QFT.t "qiskit.circuit.library.QFT.t")(qubit)                                                                                                      | Apply [`TGate`](qiskit.circuit.library.TGate "qiskit.circuit.library.TGate").                                                       |
| [`tdg`](#qiskit.circuit.library.QFT.tdg "qiskit.circuit.library.QFT.tdg")(qubit)                                                                                                | Apply [`TdgGate`](qiskit.circuit.library.TdgGate "qiskit.circuit.library.TdgGate").                                                 |
| [`tensor`](#qiskit.circuit.library.QFT.tensor "qiskit.circuit.library.QFT.tensor")(other\[, inplace])                                                                           | Tensor `self` with `other`.                                                                                                         |
| [`to_gate`](#qiskit.circuit.library.QFT.to_gate "qiskit.circuit.library.QFT.to_gate")(\[parameter\_map, label])                                                                 | Create a Gate out of this circuit.                                                                                                  |
| [`to_instruction`](#qiskit.circuit.library.QFT.to_instruction "qiskit.circuit.library.QFT.to_instruction")(\[parameter\_map, label])                                            | Create an Instruction out of this circuit.                                                                                          |
| [`toffoli`](#qiskit.circuit.library.QFT.toffoli "qiskit.circuit.library.QFT.toffoli")(control\_qubit1, control\_qubit2, …)                                                      | Apply [`CCXGate`](qiskit.circuit.library.CCXGate "qiskit.circuit.library.CCXGate").                                                 |
| [`u`](#qiskit.circuit.library.QFT.u "qiskit.circuit.library.QFT.u")(theta, phi, lam, qubit)                                                                                     | Apply [`UGate`](qiskit.circuit.library.UGate "qiskit.circuit.library.UGate").                                                       |
| [`u1`](#qiskit.circuit.library.QFT.u1 "qiskit.circuit.library.QFT.u1")(theta, qubit)                                                                                            | Apply [`U1Gate`](qiskit.circuit.library.U1Gate "qiskit.circuit.library.U1Gate").                                                    |
| [`u2`](#qiskit.circuit.library.QFT.u2 "qiskit.circuit.library.QFT.u2")(phi, lam, qubit)                                                                                         | Apply [`U2Gate`](qiskit.circuit.library.U2Gate "qiskit.circuit.library.U2Gate").                                                    |
| [`u3`](#qiskit.circuit.library.QFT.u3 "qiskit.circuit.library.QFT.u3")(theta, phi, lam, qubit)                                                                                  | Apply [`U3Gate`](qiskit.circuit.library.U3Gate "qiskit.circuit.library.U3Gate").                                                    |
| [`uc`](#qiskit.circuit.library.QFT.uc "qiskit.circuit.library.QFT.uc")(gate\_list, q\_controls, q\_target\[, …])                                                                | Attach a uniformly controlled gates (also called multiplexed gates) to a circuit.                                                   |
| [`ucrx`](#qiskit.circuit.library.QFT.ucrx "qiskit.circuit.library.QFT.ucrx")(angle\_list, q\_controls, q\_target)                                                               | Attach a uniformly controlled (also called multiplexed) Rx rotation gate to a circuit.                                              |
| [`ucry`](#qiskit.circuit.library.QFT.ucry "qiskit.circuit.library.QFT.ucry")(angle\_list, q\_controls, q\_target)                                                               | Attach a uniformly controlled (also called multiplexed) Ry rotation gate to a circuit.                                              |
| [`ucrz`](#qiskit.circuit.library.QFT.ucrz "qiskit.circuit.library.QFT.ucrz")(angle\_list, q\_controls, q\_target)                                                               | Attach a uniformly controlled (also called multiplexed gates) Rz rotation gate to a circuit.                                        |
| [`unitary`](#qiskit.circuit.library.QFT.unitary "qiskit.circuit.library.QFT.unitary")(obj, qubits\[, label])                                                                    | Apply unitary gate to q.                                                                                                            |
| [`width`](#qiskit.circuit.library.QFT.width "qiskit.circuit.library.QFT.width")()                                                                                               | Return number of qubits plus clbits in circuit.                                                                                     |
| [`x`](#qiskit.circuit.library.QFT.x "qiskit.circuit.library.QFT.x")(qubit\[, label])                                                                                            | Apply [`XGate`](qiskit.circuit.library.XGate "qiskit.circuit.library.XGate").                                                       |
| [`y`](#qiskit.circuit.library.QFT.y "qiskit.circuit.library.QFT.y")(qubit)                                                                                                      | Apply [`YGate`](qiskit.circuit.library.YGate "qiskit.circuit.library.YGate").                                                       |
| [`z`](#qiskit.circuit.library.QFT.z "qiskit.circuit.library.QFT.z")(qubit)                                                                                                      | Apply [`ZGate`](qiskit.circuit.library.ZGate "qiskit.circuit.library.ZGate").                                                       |

## Attributes

|                                                                                                                              |                                                                              |
| ---------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------- |
| [`ancillas`](#qiskit.circuit.library.QFT.ancillas "qiskit.circuit.library.QFT.ancillas")                                     | Returns a list of ancilla bits in the order that the registers were added.   |
| [`approximation_degree`](#qiskit.circuit.library.QFT.approximation_degree "qiskit.circuit.library.QFT.approximation_degree") | The approximation degree of the QFT.                                         |
| [`calibrations`](#qiskit.circuit.library.QFT.calibrations "qiskit.circuit.library.QFT.calibrations")                         | Return calibration dictionary.                                               |
| [`clbits`](#qiskit.circuit.library.QFT.clbits "qiskit.circuit.library.QFT.clbits")                                           | Returns a list of classical bits in the order that the registers were added. |
| [`data`](#qiskit.circuit.library.QFT.data "qiskit.circuit.library.QFT.data")                                                 | Return the circuit data (instructions and context).                          |
| [`do_swaps`](#qiskit.circuit.library.QFT.do_swaps "qiskit.circuit.library.QFT.do_swaps")                                     | Whether the final swaps of the QFT are applied or not.                       |
| `extension_lib`                                                                                                              |                                                                              |
| [`global_phase`](#qiskit.circuit.library.QFT.global_phase "qiskit.circuit.library.QFT.global_phase")                         | Return the global phase of the circuit in radians.                           |
| `header`                                                                                                                     |                                                                              |
| [`insert_barriers`](#qiskit.circuit.library.QFT.insert_barriers "qiskit.circuit.library.QFT.insert_barriers")                | Whether barriers are inserted for better visualization or not.               |
| `instances`                                                                                                                  |                                                                              |
| [`metadata`](#qiskit.circuit.library.QFT.metadata "qiskit.circuit.library.QFT.metadata")                                     | The user provided metadata associated with the circuit                       |
| [`num_ancillas`](#qiskit.circuit.library.QFT.num_ancillas "qiskit.circuit.library.QFT.num_ancillas")                         | Return the number of ancilla qubits.                                         |
| [`num_clbits`](#qiskit.circuit.library.QFT.num_clbits "qiskit.circuit.library.QFT.num_clbits")                               | Return number of classical bits.                                             |
| [`num_parameters`](#qiskit.circuit.library.QFT.num_parameters "qiskit.circuit.library.QFT.num_parameters")                   | Convenience function to get the number of parameter objects in the circuit.  |
| [`num_qubits`](#qiskit.circuit.library.QFT.num_qubits "qiskit.circuit.library.QFT.num_qubits")                               | The number of qubits in the QFT circuit.                                     |
| [`parameters`](#qiskit.circuit.library.QFT.parameters "qiskit.circuit.library.QFT.parameters")                               | Convenience function to get the parameters defined in the parameter table.   |
| `prefix`                                                                                                                     |                                                                              |
| [`qregs`](#qiskit.circuit.library.QFT.qregs "qiskit.circuit.library.QFT.qregs")                                              | A list of the quantum registers associated with the circuit.                 |
| [`qubits`](#qiskit.circuit.library.QFT.qubits "qiskit.circuit.library.QFT.qubits")                                           | Returns a list of quantum bits in the order that the registers were added.   |

### add\_bits

<span id="qiskit.circuit.library.QFT.add_bits" />
...
<span id="qiskit.circuit.library.QFT.add_calibration" />
...
<span id="qiskit.circuit.library.QFT.append" />
...
<span id="qiskit.circuit.library.QFT.assign_parameters" />
...
<span id="qiskit.circuit.library.QFT.bind_parameters" />

`bind_parameters(values, value_dict=None)`

Assign numeric parameters to values yielding a new circuit.

To assign new Parameter objects or bind the values in-place, without yielding a new circuit, use the [`assign_parameters()`](#qiskit.circuit.library.QFT.assign_parameters "qiskit.circuit.library.QFT.assign_parameters") method.
...
<span id="qiskit.circuit.library.QFT.cast" />
...
<span id="qiskit.circuit.library.QFT.cbit_argument_conversion" />
...
<span id="qiskit.circuit.library.QFT.ccx" />
...
<span id="qiskit.circuit.library.QFT.ch" />
...
<span id="qiskit.circuit.library.QFT.cls_instances" />
...
<span id="qiskit.circuit.library.QFT.cnot" />
...
<span id="qiskit.circuit.library.QFT.combine" />
...
<span id="qiskit.circuit.library.QFT.compose" />
...
<span id="qiskit.circuit.library.QFT.control" />
...
<span id="qiskit.circuit.library.QFT.copy" />
...
<span id="qiskit.circuit.library.QFT.count_ops" />
...
<span id="qiskit.circuit.library.QFT.cp" />
...
<span id="qiskit.circuit.library.QFT.crx" />
...
<span id="qiskit.circuit.library.QFT.cry" />
...
<span id="qiskit.circuit.library.QFT.crz" />
...
<span id="qiskit.circuit.library.QFT.cswap" />
...
<span id="qiskit.circuit.library.QFT.csx" />
...
<span id="qiskit.circuit.library.QFT.cu" />
...
<span id="qiskit.circuit.library.QFT.cu1" />
...
<span id="qiskit.circuit.library.QFT.cu3" />
...
<span id="qiskit.circuit.library.QFT.cx" />
...
<span id="qiskit.circuit.library.QFT.cy" />
...
<span id="qiskit.circuit.library.QFT.cz" />
...
<span id="qiskit.circuit.library.QFT.dcx" />
...
<span id="qiskit.circuit.library.QFT.decompose" />
...
<span id="qiskit.circuit.library.QFT.delay" />
...
<span id="qiskit.circuit.library.QFT.depth" />
...
<span id="qiskit.circuit.library.QFT.diagonal" />
...
<span id="qiskit.circuit.library.QFT.draw" />
...
![../\_images/qiskit.circuit.library.QFT\_5\_0.png](/images/api/qiskit/0.28/qiskit.circuit.library.QFT_5_0.png) ![../\_images/qiskit.circuit.library.QFT\_5\_1.png](/images/api/qiskit/0.28/qiskit.circuit.library.QFT_5_1.png)

### ecr

<span id="qiskit.circuit.library.QFT.ecr" />
...
<span id="qiskit.circuit.library.QFT.extend" />
...
<span id="qiskit.circuit.library.QFT.fredkin" />
...
<span id="qiskit.circuit.library.QFT.from_qasm_str" />
...
<span id="qiskit.circuit.library.QFT.get_instructions" />
...
<span id="qiskit.circuit.library.QFT.h" />
...
<span id="qiskit.circuit.library.QFT.has_register" />
...
<span id="qiskit.circuit.library.QFT.i" />
...
<span id="qiskit.circuit.library.QFT.iso" />
...
<span id="qiskit.circuit.library.QFT.isometry" />
...
<span id="qiskit.circuit.library.QFT.iswap" />
...
<span id="qiskit.circuit.library.QFT.mcp" />
...
<span id="qiskit.circuit.library.QFT.mcrx" />
...
<span id="qiskit.circuit.library.QFT.mcry" />
...
<span id="qiskit.circuit.library.QFT.mcrz" />
...
<span id="qiskit.circuit.library.QFT.mcu1" />
...
<span id="qiskit.circuit.library.QFT.mcx" />
...
<span id="qiskit.circuit.library.QFT.measure" />
...
<span id="qiskit.circuit.library.QFT.measure_active" />
...
<span id="qiskit.circuit.library.QFT.measure_all" />
...
<span id="qiskit.circuit.library.QFT.num_connected_components" />
...
<span id="qiskit.circuit.library.QFT.num_tensor_factors" />
...
<span id="qiskit.circuit.library.QFT.p" />
...
<span id="qiskit.circuit.library.QFT.pauli" />
...
<span id="qiskit.circuit.library.QFT.power" />
...
<span id="qiskit.circuit.library.QFT.qasm" />
...
<span id="qiskit.circuit.library.QFT.qbit_argument_conversion" />
...
<span id="qiskit.circuit.library.QFT.qubit_duration" />
...
<span id="qiskit.circuit.library.QFT.qubit_start_time" />
...
<span id="qiskit.circuit.library.QFT.qubit_stop_time" />
...
<span id="qiskit.circuit.library.QFT.rcccx" />
...
<span id="qiskit.circuit.library.QFT.rccx" />
...
<span id="qiskit.circuit.library.QFT.remove_final_measurements" />
...
<span id="qiskit.circuit.library.QFT.repeat" />
...
<span id="qiskit.circuit.library.QFT.reverse_bits" />
...
<span id="qiskit.circuit.library.QFT.reverse_ops" />
...
<span id="qiskit.circuit.library.QFT.rv" />
...
<span id="qiskit.circuit.library.QFT.rx" />
...
<span id="qiskit.circuit.library.QFT.rxx" />
...
<span id="qiskit.circuit.library.QFT.ry" />
...
<span id="qiskit.circuit.library.QFT.ryy" />
...
<span id="qiskit.circuit.library.QFT.rz" />
...
<span id="qiskit.circuit.library.QFT.rzx" />
...
<span id="qiskit.circuit.library.QFT.rzz" />
...
<span id="qiskit.circuit.library.QFT.s" />
...
<span id="qiskit.circuit.library.QFT.save_amplitudes" />
...
<span id="qiskit.circuit.library.QFT.save_amplitudes_squared" />
...
<span id="qiskit.circuit.library.QFT.save_density_matrix" />
...
<span id="qiskit.circuit.library.QFT.save_expectation_value" />
...
<span id="qiskit.circuit.library.QFT.save_expectation_value_variance" />
...
<span id="qiskit.circuit.library.QFT.save_matrix_product_state" />
...
<span id="qiskit.circuit.library.QFT.save_probabilities" />
...
<span id="qiskit.circuit.library.QFT.save_probabilities_dict" />
...
<span id="qiskit.circuit.library.QFT.save_stabilizer" />
...
<span id="qiskit.circuit.library.QFT.save_state" />
...
<span id="qiskit.circuit.library.QFT.save_statevector" />
...
<span id="qiskit.circuit.library.QFT.save_statevector_dict" />
...
<span id="qiskit.circuit.library.QFT.save_superop" />
...
<span id="qiskit.circuit.library.QFT.save_unitary" />
...
<span id="qiskit.circuit.library.QFT.sdg" />
...
<span id="qiskit.circuit.library.QFT.set_density_matrix" />
...
<span id="qiskit.circuit.library.QFT.set_matrix_product_state" />
...
<span id="qiskit.circuit.library.QFT.set_stabilizer" />
...
<span id="qiskit.circuit.library.QFT.set_statevector" />
...
<span id="qiskit.circuit.library.QFT.set_superop" />
...
<span id="qiskit.circuit.library.QFT.set_unitary" />
...
<span id="qiskit.circuit.library.QFT.snapshot" />
...
<span id="qiskit.circuit.library.QFT.snapshot_density_matrix" />
...
<span id="qiskit.circuit.library.QFT.snapshot_expectation_value" />
...
<span id="qiskit.circuit.library.QFT.snapshot_probabilities" />
...
<span id="qiskit.circuit.library.QFT.snapshot_stabilizer" />
...
<span id="qiskit.circuit.library.QFT.snapshot_statevector" />
...
<span id="qiskit.circuit.library.QFT.squ" />
...
<span id="qiskit.circuit.library.QFT.sx" />
...
<span id="qiskit.circuit.library.QFT.sxdg" />
...
<span id="qiskit.circuit.library.QFT.t" />
...
<span id="qiskit.circuit.library.QFT.tdg" />
...
<span id="qiskit.circuit.library.QFT.tensor" />
...
<span id="qiskit.circuit.library.QFT.to_gate" />
...
<span id="qiskit.circuit.library.QFT.to_instruction" />
...
<span id="qiskit.circuit.library.QFT.toffoli" />
...
<span id="qiskit.circuit.library.QFT.u" />
...
<span id="qiskit.circuit.library.QFT.u1" />
...
<span id="qiskit.circuit.library.QFT.u2" />
...
<span id="qiskit.circuit.library.QFT.u3" />
...
<span id="qiskit.circuit.library.QFT.uc" />
...
<span id="qiskit.circuit.library.QFT.ucrx" />
...
<span id="qiskit.circuit.library.QFT.ucry" />
...
<span id="qiskit.circuit.library.QFT.ucrz" />
...
<span id="qiskit.circuit.library.QFT.unitary" />
...
<span id="qiskit.circuit.library.QFT.x" />
...
<span id="qiskit.circuit.library.QFT.y" />
...
<span id="qiskit.circuit.library.QFT.z" />
