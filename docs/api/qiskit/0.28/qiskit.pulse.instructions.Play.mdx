...
<Class id="qiskit.pulse.instructions.Play" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/pulse/instructions/play.py" signature="Play(pulse, channel, name=None)">
  ...
  **Raises**
  ...
  <Function id="qiskit.pulse.instructions.Play.channel" signature="property channel">
  ...
  <Function id="qiskit.pulse.instructions.Play.channels" signature="property channels">
  ...
  <Function id="qiskit.pulse.instructions.Play.duration" signature="property duration">
  ...
  <Function id="qiskit.pulse.instructions.Play.id" signature="property id">
  ...
  <Function id="qiskit.pulse.instructions.Play.instructions" signature="property instructions">
  ...
  <Function id="qiskit.pulse.instructions.Play.name" signature="property name">
  ...
  <Function id="qiskit.pulse.instructions.Play.operands" signature="property operands">
  ...
  <Function id="qiskit.pulse.instructions.Play.parameters" signature="property parameters">
  ...
  <Function id="qiskit.pulse.instructions.Play.pulse" signature="property pulse">
  ...
  <Function id="qiskit.pulse.instructions.Play.start_time" signature="property start_time">
  ...
  <Function id="qiskit.pulse.instructions.Play.stop_time" signature="property stop_time">
