  ...
  *   **name** (`str`) – Name of the circuit.
  ...
  <Function id="qiskit.circuit.library.LinearAmplitudeFunction.draw" signature="draw(output=None, scale=None, filename=None, style=None, interactive=False, plot_barriers=True, reverse_bits=False, justify=None, vertical_compression='medium', idle_wires=True, with_layout=True, fold=None, ax=None, initial_state=False, cregbundle=True)">
    ...
    **Example**
    ...
    ![../\_images/qiskit.circuit.library.LinearAmplitudeFunction\_2\_0.png](/images/api/qiskit/0.28/qiskit.circuit.library.LinearAmplitudeFunction_2_0.avif) ![../\_images/qiskit.circuit.library.LinearAmplitudeFunction\_2\_1.png](/images/api/qiskit/0.28/qiskit.circuit.library.LinearAmplitudeFunction_2_1.avif)
  </Function>
