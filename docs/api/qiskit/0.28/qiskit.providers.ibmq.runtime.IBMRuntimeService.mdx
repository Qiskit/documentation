...
<Class id="qiskit.providers.ibmq.runtime.IBMRuntimeService" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-ibmq-provider/tree/stable/0.15/qiskit/providers/ibmq/runtime/ibm_runtime_service.py" signature="IBMRuntimeService(provider)">
  ...
  **provider** (`AccountProvider`) – IBM Quantum account provider.
  ...
  <Function id="qiskit.providers.ibmq.runtime.IBMRuntimeService.__init__" name="__init__" signature="__init__(provider)">
    IBMRuntimeService constructor.
  ...
  <Function id="qiskit.providers.ibmq.runtime.IBMRuntimeService.delete_job" name="delete_job" signature="delete_job(job_id)">
  ...
  <Function id="qiskit.providers.ibmq.runtime.IBMRuntimeService.delete_program" name="delete_program" signature="delete_program(program_id)">
  ...
  <Function id="qiskit.providers.ibmq.runtime.IBMRuntimeService.job" name="job" signature="job(job_id)">
  ...
  <Function id="qiskit.providers.ibmq.runtime.IBMRuntimeService.jobs" name="jobs" signature="jobs(limit=10, skip=0, pending=None)">
  ...
  <Function id="qiskit.providers.ibmq.runtime.IBMRuntimeService.logout" name="logout" signature="logout()">
  ...
  <Function id="qiskit.providers.ibmq.runtime.IBMRuntimeService.pprint_programs" name="pprint_programs" signature="pprint_programs(refresh=False)">
  ...
  <Function id="qiskit.providers.ibmq.runtime.IBMRuntimeService.program" name="program" signature="program(program_id, refresh=False)">
  ...
  <Function id="qiskit.providers.ibmq.runtime.IBMRuntimeService.programs" name="programs" signature="programs(refresh=False)">
  ...
  <Function id="qiskit.providers.ibmq.runtime.IBMRuntimeService.run" name="run" signature="run(program_id, options, inputs, callback=None, result_decoder=None)">
  ...
  <Function id="qiskit.providers.ibmq.runtime.IBMRuntimeService.set_program_visibility" name="set_program_visibility" signature="set_program_visibility(program_id, public)">
  ...
  <Function id="qiskit.providers.ibmq.runtime.IBMRuntimeService.upload_program" name="upload_program" signature="upload_program(data, metadata=None, name=None, max_execution_time=None, description=None, version=None, backend_requirements=None, parameters=None, return_values=None, interim_results=None)">
