...
<Class id="qiskit.providers.aer.noise.ReadoutError" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-aer/tree/stable/0.8/qiskit/providers/aer/noise/errors/readout_error.py" signature="ReadoutError(probabilities, atol=1e-08)" modifiers="class">
  ...
  *   **atol** (*double*) – Threshold for checking probabilities are normalized (Default: 1e-8).
  ...
  <Function id="qiskit.providers.aer.noise.ReadoutError.atol" signature="atol" modifiers="property">
  ...
  <Function id="qiskit.providers.aer.noise.ReadoutError.number_of_qubits" signature="number_of_qubits" modifiers="property">
  ...
  <Function id="qiskit.providers.aer.noise.ReadoutError.probabilities" signature="probabilities" modifiers="property">
    Return the readout error probabilities matrix.
  </Function>

  ### rtol

  <Function id="qiskit.providers.aer.noise.ReadoutError.rtol" signature="rtol" modifiers="property">
