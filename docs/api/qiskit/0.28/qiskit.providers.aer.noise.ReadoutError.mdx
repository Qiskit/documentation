...
<Class id="qiskit.providers.aer.noise.ReadoutError" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-aer/tree/stable/0.8/qiskit/providers/aer/noise/errors/readout_error.py" signature="ReadoutError(probabilities, atol=1e-08)">
  ...
  *   **atol** (*double*) – Threshold for checking probabilities are normalized (Default: 1e-8).
  ...
  <Function id="qiskit.providers.aer.noise.ReadoutError.atol" signature="property atol">
  ...
  <Function id="qiskit.providers.aer.noise.ReadoutError.number_of_qubits" signature="property number_of_qubits">
  ...
  <Function id="qiskit.providers.aer.noise.ReadoutError.probabilities" signature="property probabilities">
    Return the readout error probabilities matrix.
  </Function>

  ### rtol

  <Function id="qiskit.providers.aer.noise.ReadoutError.rtol" signature="property rtol">
    The relative tolerance parameter for float comparisons.
  </Function>

  ### set\_atol

  <Function id="qiskit.providers.aer.noise.ReadoutError.set_atol" signature="classmethod set_atol(value)">
    Set the class default absolute tolerance parameter for float comparisons.
  </Function>

  ### set\_rtol

  <Function id="qiskit.providers.aer.noise.ReadoutError.set_rtol" signature="classmethod set_rtol(value)">
