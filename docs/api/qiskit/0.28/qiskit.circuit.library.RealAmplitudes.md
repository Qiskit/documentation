...
`__init__(num_qubits=None, entanglement='full', reps=3, skip_unentangled_qubits=False, skip_final_rotation_layer=False, parameter_prefix='θ', insert_barriers=False, initial_state=None, name='RealAmplitudes')`
...
|                                                                                                                                                                                                       |                                                                                                                                     |
| ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------- |
| [`__init__`](#qiskit.circuit.library.RealAmplitudes.__init__ "qiskit.circuit.library.RealAmplitudes.__init__")(\[num\_qubits, entanglement, reps, …])                                                 | Create a new RealAmplitudes 2-local circuit.                                                                                        |
| [`add_bits`](#qiskit.circuit.library.RealAmplitudes.add_bits "qiskit.circuit.library.RealAmplitudes.add_bits")(bits)                                                                                  | Add Bits to the circuit.                                                                                                            |
| [`add_calibration`](#qiskit.circuit.library.RealAmplitudes.add_calibration "qiskit.circuit.library.RealAmplitudes.add_calibration")(gate, qubits, schedule\[, params])                                | Register a low-level, custom pulse definition for the given gate.                                                                   |
| [`add_layer`](#qiskit.circuit.library.RealAmplitudes.add_layer "qiskit.circuit.library.RealAmplitudes.add_layer")(other\[, entanglement, front])                                                      | Append another layer to the NLocal.                                                                                                 |
| [`add_register`](#qiskit.circuit.library.RealAmplitudes.add_register "qiskit.circuit.library.RealAmplitudes.add_register")(\*regs)                                                                    | Add registers.                                                                                                                      |
| [`append`](#qiskit.circuit.library.RealAmplitudes.append "qiskit.circuit.library.RealAmplitudes.append")(instruction\[, qargs, cargs])                                                                | Append one or more instructions to the end of the circuit, modifying the circuit in place.                                          |
| [`assign_parameters`](#qiskit.circuit.library.RealAmplitudes.assign_parameters "qiskit.circuit.library.RealAmplitudes.assign_parameters")(parameters\[, inplace, …])                                  | Assign parameters to the n-local circuit.                                                                                           |
| [`barrier`](#qiskit.circuit.library.RealAmplitudes.barrier "qiskit.circuit.library.RealAmplitudes.barrier")(\*qargs)                                                                                  | Apply `Barrier`.                                                                                                                    |
| [`bind_parameters`](#qiskit.circuit.library.RealAmplitudes.bind_parameters "qiskit.circuit.library.RealAmplitudes.bind_parameters")(values\[, value\_dict])                                           | Assign numeric parameters to values yielding a new circuit.                                                                         |
...
| [`combine`](#qiskit.circuit.library.RealAmplitudes.combine "qiskit.circuit.library.RealAmplitudes.combine")(rhs)                                                                                      | DEPRECATED - Returns rhs appended to self if self contains compatible registers.                                                    |
| [`compose`](#qiskit.circuit.library.RealAmplitudes.compose "qiskit.circuit.library.RealAmplitudes.compose")(other\[, qubits, clbits, front, …])                                                       | Compose circuit with `other` circuit or instruction, optionally permuting wires.                                                    |
...
| [`ecr`](#qiskit.circuit.library.RealAmplitudes.ecr "qiskit.circuit.library.RealAmplitudes.ecr")(qubit1, qubit2)                                                                                       | Apply [`ECRGate`](qiskit.circuit.library.ECRGate "qiskit.circuit.library.ECRGate").                                                 |
| [`extend`](#qiskit.circuit.library.RealAmplitudes.extend "qiskit.circuit.library.RealAmplitudes.extend")(rhs)                                                                                         | DEPRECATED - Append QuantumCircuit to the RHS if it contains compatible registers.                                                  |
...
| [`get_instructions`](#qiskit.circuit.library.RealAmplitudes.get_instructions "qiskit.circuit.library.RealAmplitudes.get_instructions")(name)                                                          | Get instructions matching name.                                                                                                     |
...
| [`hamiltonian`](#qiskit.circuit.library.RealAmplitudes.hamiltonian "qiskit.circuit.library.RealAmplitudes.hamiltonian")(operator, time, qubits\[, label])                                             | Apply hamiltonian evolution to qubits.                                                                                              |
...
| [`initialize`](#qiskit.circuit.library.RealAmplitudes.initialize "qiskit.circuit.library.RealAmplitudes.initialize")(params\[, qubits])                                                               | Initialize qubits in a specific state.                                                                                              |
...
| [`mcry`](#qiskit.circuit.library.RealAmplitudes.mcry "qiskit.circuit.library.RealAmplitudes.mcry")(theta, q\_controls, q\_target\[, …])                                                               | Apply Multiple-Controlled Y rotation gate                                                                                           |
...
| [`pauli`](#qiskit.circuit.library.RealAmplitudes.pauli "qiskit.circuit.library.RealAmplitudes.pauli")(pauli\_string, qubits)                                                                          | Apply [`PauliGate`](qiskit.circuit.library.PauliGate "qiskit.circuit.library.PauliGate").                                           |
...
| [`qasm`](#qiskit.circuit.library.RealAmplitudes.qasm "qiskit.circuit.library.RealAmplitudes.qasm")(\[formatted, filename, encoding])                                                                  | Return OpenQASM string.                                                                                                             |
| [`qbit_argument_conversion`](#qiskit.circuit.library.RealAmplitudes.qbit_argument_conversion "qiskit.circuit.library.RealAmplitudes.qbit_argument_conversion")(qubit\_representation)                 | Converts several qubit representations (such as indexes, range, etc.) into a list of qubits.                                        |
| [`qubit_duration`](#qiskit.circuit.library.RealAmplitudes.qubit_duration "qiskit.circuit.library.RealAmplitudes.qubit_duration")(\*qubits)                                                            | Return the duration between the start and stop time of the first and last instructions, excluding delays, over the supplied qubits. |
...
| [`r`](#qiskit.circuit.library.RealAmplitudes.r "qiskit.circuit.library.RealAmplitudes.r")(theta, phi, qubit)                                                                                          | Apply [`RGate`](qiskit.circuit.library.RGate "qiskit.circuit.library.RGate").                                                       |
...
| [`rv`](#qiskit.circuit.library.RealAmplitudes.rv "qiskit.circuit.library.RealAmplitudes.rv")(vx, vy, vz, qubit)                                                                                       | Apply [`RVGate`](qiskit.circuit.library.RVGate "qiskit.circuit.library.RVGate").                                                    |
...
| [`save_amplitudes`](#qiskit.circuit.library.RealAmplitudes.save_amplitudes "qiskit.circuit.library.RealAmplitudes.save_amplitudes")(params\[, label, pershot, …])                                     | Save complex statevector amplitudes.                                                                                                |
| [`save_amplitudes_squared`](#qiskit.circuit.library.RealAmplitudes.save_amplitudes_squared "qiskit.circuit.library.RealAmplitudes.save_amplitudes_squared")(params\[, label, …])                      | Save squared statevector amplitudes (probabilities).                                                                                |
| [`save_density_matrix`](#qiskit.circuit.library.RealAmplitudes.save_density_matrix "qiskit.circuit.library.RealAmplitudes.save_density_matrix")(\[qubits, label, …])                                  | Save the current simulator quantum state as a density matrix.                                                                       |
| [`save_expectation_value`](#qiskit.circuit.library.RealAmplitudes.save_expectation_value "qiskit.circuit.library.RealAmplitudes.save_expectation_value")(operator, qubits\[, …])                      | Save the expectation value of a Hermitian operator.                                                                                 |
| [`save_expectation_value_variance`](#qiskit.circuit.library.RealAmplitudes.save_expectation_value_variance "qiskit.circuit.library.RealAmplitudes.save_expectation_value_variance")(operator, qubits) | Save the expectation value of a Hermitian operator.                                                                                 |
| [`save_matrix_product_state`](#qiskit.circuit.library.RealAmplitudes.save_matrix_product_state "qiskit.circuit.library.RealAmplitudes.save_matrix_product_state")(\[label, pershot, …])               | Save the current simulator quantum state as a matrix product state.                                                                 |
| [`save_probabilities`](#qiskit.circuit.library.RealAmplitudes.save_probabilities "qiskit.circuit.library.RealAmplitudes.save_probabilities")(\[qubits, label, …])                                     | Save measurement outcome probabilities vector.                                                                                      |
| [`save_probabilities_dict`](#qiskit.circuit.library.RealAmplitudes.save_probabilities_dict "qiskit.circuit.library.RealAmplitudes.save_probabilities_dict")(\[qubits, label, …])                      | Save measurement outcome probabilities vector.                                                                                      |
| [`save_stabilizer`](#qiskit.circuit.library.RealAmplitudes.save_stabilizer "qiskit.circuit.library.RealAmplitudes.save_stabilizer")(\[label, pershot, conditional])                                   | Save the current stabilizer simulator quantum state as a Clifford.                                                                  |
| [`save_state`](#qiskit.circuit.library.RealAmplitudes.save_state "qiskit.circuit.library.RealAmplitudes.save_state")(\[label, pershot, conditional])                                                  | Save the current simulator quantum state.                                                                                           |
| [`save_statevector`](#qiskit.circuit.library.RealAmplitudes.save_statevector "qiskit.circuit.library.RealAmplitudes.save_statevector")(\[label, pershot, conditional])                                | Save the current simulator quantum state as a statevector.                                                                          |
| [`save_statevector_dict`](#qiskit.circuit.library.RealAmplitudes.save_statevector_dict "qiskit.circuit.library.RealAmplitudes.save_statevector_dict")(\[label, pershot, …])                           | Save the current simulator quantum state as a statevector as a dict.                                                                |
| [`save_superop`](#qiskit.circuit.library.RealAmplitudes.save_superop "qiskit.circuit.library.RealAmplitudes.save_superop")(\[label, pershot])                                                         | Save the current state of the superop simulator.                                                                                    |
| [`save_unitary`](#qiskit.circuit.library.RealAmplitudes.save_unitary "qiskit.circuit.library.RealAmplitudes.save_unitary")(\[label, pershot])                                                         | Save the current state of the unitary simulator.                                                                                    |
...
| [`set_density_matrix`](#qiskit.circuit.library.RealAmplitudes.set_density_matrix "qiskit.circuit.library.RealAmplitudes.set_density_matrix")(state)                                                   | Set the density matrix state of the simulator.                                                                                      |
| [`set_matrix_product_state`](#qiskit.circuit.library.RealAmplitudes.set_matrix_product_state "qiskit.circuit.library.RealAmplitudes.set_matrix_product_state")(state)                                 | Set the matrix product state of the simulator.                                                                                      |
| [`set_stabilizer`](#qiskit.circuit.library.RealAmplitudes.set_stabilizer "qiskit.circuit.library.RealAmplitudes.set_stabilizer")(state)                                                               | Set the Clifford stabilizer state of the simulator.                                                                                 |
| [`set_statevector`](#qiskit.circuit.library.RealAmplitudes.set_statevector "qiskit.circuit.library.RealAmplitudes.set_statevector")(state)                                                            | Set the statevector state of the simulator.                                                                                         |
| [`set_superop`](#qiskit.circuit.library.RealAmplitudes.set_superop "qiskit.circuit.library.RealAmplitudes.set_superop")(state)                                                                        | Set the superop state of the simulator.                                                                                             |
| [`set_unitary`](#qiskit.circuit.library.RealAmplitudes.set_unitary "qiskit.circuit.library.RealAmplitudes.set_unitary")(state)                                                                        | Set the state state of the simulator.                                                                                               |
...
| [`snapshot_expectation_value`](#qiskit.circuit.library.RealAmplitudes.snapshot_expectation_value "qiskit.circuit.library.RealAmplitudes.snapshot_expectation_value")(label, op, qubits)               | Take a snapshot of expectation value \<O> of an Operator.                                                                           |
| [`snapshot_probabilities`](#qiskit.circuit.library.RealAmplitudes.snapshot_probabilities "qiskit.circuit.library.RealAmplitudes.snapshot_probabilities")(label, qubits\[, variance])                  | Take a probability snapshot of the simulator state.                                                                                 |
...
| [`tensor`](#qiskit.circuit.library.RealAmplitudes.tensor "qiskit.circuit.library.RealAmplitudes.tensor")(other\[, inplace])                                                                           | Tensor `self` with `other`.                                                                                                         |
...
| [`to_instruction`](#qiskit.circuit.library.RealAmplitudes.to_instruction "qiskit.circuit.library.RealAmplitudes.to_instruction")(\[parameter\_map, label])                                            | Create an Instruction out of this circuit.                                                                                          |
...
| `instances`                                                                                                                                                 |                                                                              |
| [`metadata`](#qiskit.circuit.library.RealAmplitudes.metadata "qiskit.circuit.library.RealAmplitudes.metadata")                                              | The user provided metadata associated with the circuit                       |
...
| [`parameters`](#qiskit.circuit.library.RealAmplitudes.parameters "qiskit.circuit.library.RealAmplitudes.parameters")                                        | Convenience function to get the parameters defined in the parameter table.   |
...
<span id="qiskit.circuit.library.RealAmplitudes.add_bits" />
...
This method also supports passing a list instead of a dictionary. If a list is passed, the list must have the same length as the number of unbound parameters in the circuit. The parameters are assigned in the order of the parameters in [`ordered_parameters()`](#qiskit.circuit.library.RealAmplitudes.ordered_parameters "qiskit.circuit.library.RealAmplitudes.ordered_parameters").
...
To assign new Parameter objects or bind the values in-place, without yielding a new circuit, use the [`assign_parameters()`](#qiskit.circuit.library.RealAmplitudes.assign_parameters "qiskit.circuit.library.RealAmplitudes.assign_parameters") method.
...
![../\_images/qiskit.circuit.library.RealAmplitudes\_0\_0.png](/images/api/qiskit/0.28/qiskit.circuit.library.RealAmplitudes_0_0.png) ![../\_images/qiskit.circuit.library.RealAmplitudes\_0\_1.png](/images/api/qiskit/0.28/qiskit.circuit.library.RealAmplitudes_0_1.png)

### ecr

<span id="qiskit.circuit.library.RealAmplitudes.ecr" />
...
<span id="qiskit.circuit.library.RealAmplitudes.get_instructions" />
...
<span id="qiskit.circuit.library.RealAmplitudes.pauli" />
...
<span id="qiskit.circuit.library.RealAmplitudes.rv" />
...
<span id="qiskit.circuit.library.RealAmplitudes.save_amplitudes" />
...
<span id="qiskit.circuit.library.RealAmplitudes.save_amplitudes_squared" />
...
<span id="qiskit.circuit.library.RealAmplitudes.save_density_matrix" />
...
<span id="qiskit.circuit.library.RealAmplitudes.save_expectation_value" />
...
<span id="qiskit.circuit.library.RealAmplitudes.save_expectation_value_variance" />
...
<span id="qiskit.circuit.library.RealAmplitudes.save_matrix_product_state" />
...
<span id="qiskit.circuit.library.RealAmplitudes.save_probabilities" />
...
<span id="qiskit.circuit.library.RealAmplitudes.save_probabilities_dict" />
...
<span id="qiskit.circuit.library.RealAmplitudes.save_stabilizer" />
...
<span id="qiskit.circuit.library.RealAmplitudes.save_state" />
...
<span id="qiskit.circuit.library.RealAmplitudes.save_statevector" />
...
<span id="qiskit.circuit.library.RealAmplitudes.save_statevector_dict" />
...
<span id="qiskit.circuit.library.RealAmplitudes.save_superop" />
...
<span id="qiskit.circuit.library.RealAmplitudes.save_unitary" />
...
<span id="qiskit.circuit.library.RealAmplitudes.set_density_matrix" />
...
<span id="qiskit.circuit.library.RealAmplitudes.set_matrix_product_state" />
...
<span id="qiskit.circuit.library.RealAmplitudes.set_stabilizer" />
...
<span id="qiskit.circuit.library.RealAmplitudes.set_statevector" />
...
<span id="qiskit.circuit.library.RealAmplitudes.set_superop" />
...
<span id="qiskit.circuit.library.RealAmplitudes.set_unitary" />
...
<span id="qiskit.circuit.library.RealAmplitudes.tensor" />
