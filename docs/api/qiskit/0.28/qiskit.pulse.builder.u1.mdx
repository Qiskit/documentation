---
title: u1 (v0.28)
description: API reference for qiskit.pulse.builder.u1 in qiskit v0.28
...
<Function id="qiskit.pulse.builder.u1" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/pulse/builder.py" signature="u1(theta, qubit)">
