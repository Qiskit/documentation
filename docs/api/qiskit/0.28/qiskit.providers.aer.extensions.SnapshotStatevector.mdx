...
<Class id="qiskit.providers.aer.extensions.SnapshotStatevector" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-aer/tree/stable/0.8/qiskit/providers/aer/extensions/snapshot_statevector.py" signature="SnapshotStatevector(label, num_qubits=0)">
  ...
  **Additional Information:**
  ...
  <Function id="qiskit.providers.aer.extensions.SnapshotStatevector.decompositions" signature="property decompositions">
    Get the decompositions of the instruction from the SessionEquivalenceLibrary.
  </Function>

  ### define\_snapshot\_register

  <Function id="qiskit.providers.aer.extensions.SnapshotStatevector.define_snapshot_register" signature="static define_snapshot_register(circuit, label=None, qubits=None)">
    Defines qubits to snapshot for all snapshot methods
  </Function>

  ### definition

  <Function id="qiskit.providers.aer.extensions.SnapshotStatevector.definition" signature="property definition">
    Return definition in terms of other basic gates.
  </Function>

  ### duration

  <Function id="qiskit.providers.aer.extensions.SnapshotStatevector.duration" signature="property duration">
    Get the duration.
  </Function>
  ...
  <Function id="qiskit.providers.aer.extensions.SnapshotStatevector.label" signature="property label">
  ...
  <Function id="qiskit.providers.aer.extensions.SnapshotStatevector.params" signature="property params">
  ...
  <Function id="qiskit.providers.aer.extensions.SnapshotStatevector.snapshot_type" signature="property snapshot_type">
  ...
  <Function id="qiskit.providers.aer.extensions.SnapshotStatevector.unit" signature="property unit">
