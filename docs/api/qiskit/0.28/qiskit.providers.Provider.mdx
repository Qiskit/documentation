...
<Class id="qiskit.providers.Provider" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/providers/provider.py" signature="Provider">
  ...
  <Function id="qiskit.providers.Provider.__init__" name="__init__" signature="__init__()">
