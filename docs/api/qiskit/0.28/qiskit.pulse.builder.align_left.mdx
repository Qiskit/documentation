...
<Function id="qiskit.pulse.builder.align_left" name="align_left" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/pulse/builder.py" signature="align_left()">
