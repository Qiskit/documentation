...
<Class id="qiskit.qobj.PulseLibraryItem" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/qobj/pulse_qobj.py" signature="PulseLibraryItem(name, samples)">
  ...
  *   **samples** (*list\[complex]*) – A list of complex values defining pulse shape.
  ...
  <Function id="qiskit.qobj.PulseLibraryItem.__init__" name="__init__" signature="__init__(name, samples)">
    Instantiate a pulse library item.
  ...
  <Function id="qiskit.qobj.PulseLibraryItem.from_dict" name="from_dict" signature="classmethod from_dict(data)">
  ...
  <Function id="qiskit.qobj.PulseLibraryItem.to_dict" name="to_dict" signature="to_dict()">
