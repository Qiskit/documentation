...
<Class id="qiskit.ignis.mitigation.TensoredFilter" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-ignis/tree/stable/0.6/qiskit/ignis/mitigation/measurement/filters.py" signature="TensoredFilter(cal_matrices, substate_labels_list, mit_pattern)">
  ...
  *   **mit\_pattern** (`list`) – for each calibration matrix a list of the logical qubit indices (as int, states in the subspace)
  ...
  <Function id="qiskit.ignis.mitigation.TensoredFilter.__init__" name="__init__" signature="__init__(cal_matrices, substate_labels_list, mit_pattern)">
    Initialize a tensored measurement error mitigation filter using the cal\_matrices from a tensored measurement calibration fitter. A simple usage this class is explained \[here] ([https://qiskit.org/documentation/tutorials/noise/3\_measurement\_error\_mitigation.html](https://qiskit.org/documentation/tutorials/noise/3_measurement_error_mitigation.html)).
  ...
  <Function id="qiskit.ignis.mitigation.TensoredFilter.apply" name="apply" signature="apply(raw_data, method='least_squares', meas_layout=None)">
  ...
  <Function id="qiskit.ignis.mitigation.TensoredFilter.cal_matrices" name="cal_matrices" signature="property cal_matrices">
    Return cal\_matrices.
  </Function>

  ### compute\_index\_of\_cal\_mat

  <Function id="qiskit.ignis.mitigation.TensoredFilter.compute_index_of_cal_mat" name="compute_index_of_cal_mat" signature="compute_index_of_cal_mat(state, pos_qubits, indices)">
  ...
  <Function id="qiskit.ignis.mitigation.TensoredFilter.flip_state" name="flip_state" signature="flip_state(state, mat_index, flip_poses)">
  ...
  <Function id="qiskit.ignis.mitigation.TensoredFilter.nqubits" name="nqubits" signature="property nqubits">
    Return the number of qubits. See also MeasurementFilter.apply()
  </Function>

  ### qubit\_list\_sizes

  <Function id="qiskit.ignis.mitigation.TensoredFilter.qubit_list_sizes" name="qubit_list_sizes" signature="property qubit_list_sizes">
    Return \_qubit\_list\_sizes.
  </Function>

  ### substate\_labels\_list

  <Function id="qiskit.ignis.mitigation.TensoredFilter.substate_labels_list" name="substate_labels_list" signature="property substate_labels_list">
