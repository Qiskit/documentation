...
<Class id="qiskit.circuit.library.U3Gate" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/circuit/library/standard_gates/u3.py" signature="U3Gate(theta, phi, lam, label=None)">
...
$$
  ...
  <Function id="qiskit.circuit.library.U3Gate.soft_compare" name="soft_compare" signature="soft_compare(other)">
