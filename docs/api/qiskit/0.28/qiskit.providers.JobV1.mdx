...
<Class id="qiskit.providers.JobV1" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/providers/job.py" signature="JobV1(backend, job_id, **kwargs)">
  ...
  *   **kwargs** – Any key value metadata to associate with this job.
  ...
  <Function id="qiskit.providers.JobV1.__init__" name="__init__" signature="__init__(backend, job_id, **kwargs)">
    Initializes the asynchronous job.
  ...
  <Function id="qiskit.providers.JobV1.backend" name="backend" signature="backend()">
  ...
  <Function id="qiskit.providers.JobV1.cancel" name="cancel" signature="cancel()">
    Attempt to cancel the job.
  </Function>

  ### cancelled

  <Function id="qiskit.providers.JobV1.cancelled" name="cancelled" signature="cancelled()">
  ...
  <Function id="qiskit.providers.JobV1.done" name="done" signature="done()">
  ...
  <Function id="qiskit.providers.JobV1.in_final_state" name="in_final_state" signature="in_final_state()">
  ...
  <Function id="qiskit.providers.JobV1.job_id" name="job_id" signature="job_id()">
  ...
  <Function id="qiskit.providers.JobV1.result" name="result" signature="abstract result()">
    Return the results of the job.
  </Function>

  ### running

  <Function id="qiskit.providers.JobV1.running" name="running" signature="running()">
  ...
  <Function id="qiskit.providers.JobV1.status" name="status" signature="abstract status()">
    Return the status of the job, among the values of `JobStatus`.
  </Function>

  ### submit

  <Function id="qiskit.providers.JobV1.submit" name="submit" signature="abstract submit()">
    Submit the job to the backend for execution.
  </Function>

  ### wait\_for\_final\_state

  <Function id="qiskit.providers.JobV1.wait_for_final_state" name="wait_for_final_state" signature="wait_for_final_state(timeout=None, wait=5, callback=None)">
