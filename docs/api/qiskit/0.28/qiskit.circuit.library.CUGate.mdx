...
$$
  ...
  <Function id="qiskit.circuit.library.CUGate.name" name="name" signature="property name">
  ...
  <Function id="qiskit.circuit.library.CUGate.soft_compare" name="soft_compare" signature="soft_compare(other)">
