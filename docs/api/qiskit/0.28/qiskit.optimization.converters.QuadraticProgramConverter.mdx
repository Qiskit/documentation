...
<Class id="qiskit.optimization.converters.QuadraticProgramConverter" github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/optimization/converters/quadratic_program_converter.py" signature="QuadraticProgramConverter">
  An abstract class for converters of quadratic programs in Qiskit’s optimization module.

  ### \_\_init\_\_

  <Function id="qiskit.optimization.converters.QuadraticProgramConverter.__init__" name="__init__" signature="__init__()">
  ...
  <Function id="qiskit.optimization.converters.QuadraticProgramConverter.convert" name="convert" signature="abstract convert(problem)">
  ...
  <Function id="qiskit.optimization.converters.QuadraticProgramConverter.interpret" name="interpret" signature="abstract interpret(x)">
