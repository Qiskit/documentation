...
<Function id="qiskit.aqua.utils.get_entangler_map" github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/aqua/utils/entangler_map.py" signature="get_entangler_map(map_type, num_qubits, offset=0)">
