...
<Class id="qiskit.circuit.library.MSGate" github="https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/circuit/library/standard_gates/ms.py" signature="MSGate(num_qubits, theta, label=None)">
