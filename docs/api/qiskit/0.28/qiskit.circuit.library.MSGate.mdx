...
<Class id="qiskit.circuit.library.MSGate" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/circuit/library/standard_gates/ms.py" signature="MSGate(num_qubits, theta, label=None)">
  ...
  <Function id="qiskit.circuit.library.MSGate.__init__" signature="__init__(num_qubits, theta, label=None)">
    Create new MS gate.
  </Function>
  ...
  <Function id="qiskit.circuit.library.MSGate.add_decomposition" signature="add_decomposition(decomposition)">
    Add a decomposition of the instruction to the SessionEquivalenceLibrary.
  </Function>

  ### assemble

  <Function id="qiskit.circuit.library.MSGate.assemble" signature="assemble()">
    Assemble a QasmQobjInstruction
  </Function>

  ### broadcast\_arguments

  <Function id="qiskit.circuit.library.MSGate.broadcast_arguments" signature="broadcast_arguments(qargs, cargs)">
  ...
  <Function id="qiskit.circuit.library.MSGate.c_if" signature="c_if(classical, val)">
    Add classical condition on register or cbit classical and value val.
  </Function>

  ### control

  <Function id="qiskit.circuit.library.MSGate.control" signature="control(num_ctrl_qubits=1, label=None, ctrl_state=None)">
  ...
  <Function id="qiskit.circuit.library.MSGate.copy" signature="copy(name=None)">
  ...
  <Function id="qiskit.circuit.library.MSGate.decompositions" signature="property decompositions">
    Get the decompositions of the instruction from the SessionEquivalenceLibrary.
  </Function>

  ### definition

  <Function id="qiskit.circuit.library.MSGate.definition" signature="property definition">
    Return definition in terms of other basic gates.
  </Function>

  ### duration

  <Function id="qiskit.circuit.library.MSGate.duration" signature="property duration">
    Get the duration.
  </Function>

  ### inverse

  <Function id="qiskit.circuit.library.MSGate.inverse" signature="inverse()">
  ...
  <Function id="qiskit.circuit.library.MSGate.is_parameterized" signature="is_parameterized()">
    Return True .IFF. instruction is parameterized else False
  </Function>

  ### label

  <Function id="qiskit.circuit.library.MSGate.label" signature="property label">
  ...
  <Function id="qiskit.circuit.library.MSGate.mirror" signature="mirror()">
  ...
  <Function id="qiskit.circuit.library.MSGate.params" signature="property params">
    return instruction params.
  </Function>

  ### power

  <Function id="qiskit.circuit.library.MSGate.power" signature="power(exponent)">
  ...
  <Function id="qiskit.circuit.library.MSGate.qasm" signature="qasm()">
  ...
  <Function id="qiskit.circuit.library.MSGate.repeat" signature="repeat(n)">
  ...
  <Function id="qiskit.circuit.library.MSGate.reverse_ops" signature="reverse_ops()">
  ...
  <Function id="qiskit.circuit.library.MSGate.soft_compare" signature="soft_compare(other)">
  ...
  <Function id="qiskit.circuit.library.MSGate.to_matrix" signature="to_matrix()">
  ...
  <Function id="qiskit.circuit.library.MSGate.unit" signature="property unit">
    Get the time unit of duration.
  </Function>

  ### validate\_parameter

  <Function id="qiskit.circuit.library.MSGate.validate_parameter" signature="validate_parameter(parameter)">
