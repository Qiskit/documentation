...
![../\_images/transpiling\_core\_steps.png](/images/api/qiskit/0.34/transpiling_core_steps.png)
...
![../\_images/transpiler\_2\_0.png](/images/api/qiskit/0.34/transpiler_2_0.png)
...
![../\_images/transpiler\_3\_0.png](/images/api/qiskit/0.34/transpiler_3_0.png)
...
1.  A SWAP gate is not a native gate on the IBM Q devices, and must be decomposed into three CNOT gates:
    ...
    ![../\_images/transpiler\_5\_0.png](/images/api/qiskit/0.34/transpiler_5_0.png)
...
2.  A Toffoli, or controlled-controlled-not gate (ccx), is a three-qubit gate. Given that our basis gate set includes only single- and two-qubit gates, it is obvious that this gate must be decomposed. This decomposition is quite costly:
    ...
    ![../\_images/transpiler\_6\_0.png](/images/api/qiskit/0.34/transpiler_6_0.png)
...
![../\_images/mapping.png](/images/api/qiskit/0.34/mapping.png)
...
![../\_images/transpiler\_7\_0.png](/images/api/qiskit/0.34/transpiler_7_0.png)
...
*   **Layout Using Optimization Level 0**
    ...
    > ```
    >
    > ![../\_images/transpiler\_8\_0.png](/images/api/qiskit/0.34/transpiler_8_0.png)
...
*   **Layout Using Optimization Level 3**
    ...
    > ```
    >
    > ![../\_images/transpiler\_9\_0.png](/images/api/qiskit/0.34/transpiler_9_0.png)
...
![../\_images/transpiler\_10\_0.png](/images/api/qiskit/0.34/transpiler_10_0.png)
...
![../\_images/transpiler\_11\_0.png](/images/api/qiskit/0.34/transpiler_11_0.png)
...
![../\_images/transpiler\_12\_0.png](/images/api/qiskit/0.34/transpiler_12_0.png)
...
![../\_images/transpiler\_13\_0.png](/images/api/qiskit/0.34/transpiler_13_0.png)
...
Depth: 12
Gate counts: OrderedDict([('cx', 20), ('u2', 1)])

Optimization Level 2
Depth: 10
Gate counts: OrderedDict([('cx', 12), ('u2', 1)])

Optimization Level 3
Depth: 9
Gate counts: OrderedDict([('cx', 5), ('u2', 4), ('u3', 3)])
```
...
|                                                                                                                                                                             |                                                                                                                                                                                                                    |
| --------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| [`Target`](qiskit.transpiler.Target#qiskit.transpiler.Target "qiskit.transpiler.Target")(\[description, num\_qubits, dt, …])                                                | The intent of the `Target` object is to inform Qiskit’s compiler about the constraints of a particular backend so the compiler can compile an input circuit to something that works and is optimized for a device. |
| [`InstructionProperties`](qiskit.transpiler.InstructionProperties#qiskit.transpiler.InstructionProperties "qiskit.transpiler.InstructionProperties")(\[duration, error, …]) | A representation of the properties of a gate implementation.                                                                                                                                                       |
...
| [`ConditionalController`](qiskit.transpiler.ConditionalController#qiskit.transpiler.ConditionalController "qiskit.transpiler.ConditionalController")(passes\[, options, …]) | Implements a set of passes under a certain condition.                  |
| [`DoWhileController`](qiskit.transpiler.DoWhileController#qiskit.transpiler.DoWhileController "qiskit.transpiler.DoWhileController")(passes\[, options, do\_while])         | Implements a set of passes in a do-while loop.                         |
