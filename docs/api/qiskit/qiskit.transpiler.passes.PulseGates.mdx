...
<Class id="qiskit.transpiler.passes.PulseGates" github="https://github.com/Qiskit/qiskit/tree/stable/1.0/qiskit/transpiler/passes/calibration/pulse_gate.py#L26-L98" signature="qiskit.transpiler.passes.PulseGates(*args, **kwargs)">
