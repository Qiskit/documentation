...
$$
  ...
  **Examples**
  ...
  ![Circuit diagram output by the previous code.](/images/api/qiskit/qiskit-circuit-library-excitation_preserving-1.avif)

  The entanglement structure can be explicitly specified with the `entanglement` argument. The `"fsim"` mode includes an additional parameterized [`CPhaseGate`](circuit-library-c-phase-gate "qiskit.circuit.library.CPhaseGate") in each block:
  ...
  ![Circuit diagram output by the previous code.](/images/api/qiskit/qiskit-circuit-library-excitation_preserving-2_00.avif)

  ![Circuit diagram output by the previous code.](/images/api/qiskit/qiskit-circuit-library-excitation_preserving-2_01.avif)
