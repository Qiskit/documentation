...
<Class id="qiskit.transpiler.passes.CollectCliffords" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/2.1/qiskit/transpiler/passes/optimization/collect_cliffords.py#L29-L79" signature="qiskit.transpiler.passes.CollectCliffords(*args, **kwargs)" modifiers="class">
  ...
  *   **max\_block\_width** ([*int*](https://docs.python.org/3/library/functions.html#int "(in Python v3.13)") *| None*) – specifies the maximum width of the block (that is, the number of qubits over which the block is defined) for the block to be collected.
  ...
  <Function id="qiskit.transpiler.passes.CollectCliffords.execute" github="https://github.com/Qiskit/qiskit/tree/stable/2.1/qiskit/transpiler/basepasses.py#L161-L180" signature="execute(passmanager_ir, state, callback=None)">
  ...
  <Function id="qiskit.transpiler.passes.CollectCliffords.name" github="https://github.com/Qiskit/qiskit/tree/stable/2.1/qiskit/passmanager/base_tasks.py#L68-L70" signature="name()">
    Name of the pass.
  ...
  <Function id="qiskit.transpiler.passes.CollectCliffords.run" github="https://github.com/Qiskit/qiskit/tree/stable/2.1/qiskit/transpiler/passes/optimization/collect_and_collapse.py#L65-L88" signature="run(dag)">
  ...
  <Function id="qiskit.transpiler.passes.CollectCliffords.update_status" github="https://github.com/Qiskit/qiskit/tree/stable/2.1/qiskit/transpiler/basepasses.py#L182-L190" signature="update_status(state, run_state)">
