...
<Class id="qiskit.transpiler.passes.RXCalibrationBuilder" github="https://github.com/qiskit/qiskit/tree/stable/1.0/qiskit/transpiler/passes/calibration/rx_builder.py" signature="qiskit.transpiler.passes.RXCalibrationBuilder(*args, **kwargs)">
