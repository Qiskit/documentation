...
<Function id="qiskit.qpy.load" github="https://github.com/Qiskit/qiskit/tree/stable/1.4/qiskit/qpy/interface.py#L238-L391" signature="qiskit.qpy.load(file_obj, metadata_deserializer=None, trust_payload=False)">
  ...
  *   **trust\_payload** ([*bool*](https://docs.python.org/3/library/functions.html#bool "(in Python v3.13)")) – if set to `False` (the default), [`ScheduleBlock`](qiskit.pulse.ScheduleBlock "qiskit.pulse.ScheduleBlock") objects in the payload that were serialized using `sympy` are not allowed and will error. This is because the `sympy` parsing uses [`eval()`](https://docs.python.org/3/library/functions.html#eval "(in Python v3.13)"), which can allow for arbitrary code execution. The flag should only be set to `True` if you trust the QPY payload you are loading.

  **Return type**

  [*List*](https://docs.python.org/3/library/typing.html#typing.List "(in Python v3.13)")\[[*QuantumCircuit*](qiskit.circuit.QuantumCircuit "qiskit.circuit.quantumcircuit.QuantumCircuit") | [*ScheduleBlock*](qiskit.pulse.ScheduleBlock "qiskit.pulse.schedule.ScheduleBlock")]

  <Admonition title="Warning" type="caution">
    If `trust_payload` is set to `True` this can enable arbitrary code execution because internally `sympy` relies on [`eval()`](https://docs.python.org/3/library/functions.html#eval "(in Python v3.13)").
  </Admonition>
  ...
  *   **file\_obj** ([*BinaryIO*](https://docs.python.org/3/library/typing.html#typing.BinaryIO "(in Python v3.13)")) –
  *   **metadata\_deserializer** ([*Type*](https://docs.python.org/3/library/typing.html#typing.Type "(in Python v3.13)")*\[JSONDecoder] | None*) –
  *   **trust\_payload** ([*bool*](https://docs.python.org/3/library/functions.html#bool "(in Python v3.13)")) –
...
<Function id="qiskit.qpy.dump" github="https://github.com/Qiskit/qiskit/tree/stable/1.4/qiskit/qpy/interface.py#L77-L235" signature="qiskit.qpy.dump(programs, file_obj, metadata_serializer=None, use_symengine=True, version=13)">
...
<Class id="qiskit.qpy.QpyError" github="https://github.com/Qiskit/qiskit/tree/stable/1.4/qiskit/qpy/exceptions.py#L18-L28" signature="qiskit.qpy.QpyError(*message)" modifiers="exception">
...
<Class id="qiskit.qpy.UnsupportedFeatureForVersion" github="https://github.com/Qiskit/qiskit/tree/stable/1.4/qiskit/qpy/exceptions.py#L31-L48" signature="qiskit.qpy.UnsupportedFeatureForVersion(feature, required, target)" modifiers="exception">
...
<Class id="qiskit.qpy.QPYLoadingDeprecatedFeatureWarning" github="https://github.com/Qiskit/qiskit/tree/stable/1.4/qiskit/qpy/exceptions.py#L51-L53" signature="qiskit.qpy.QPYLoadingDeprecatedFeatureWarning" modifiers="exception">
...
With the support of `ScheduleBlock`, now [`QuantumCircuit`](qiskit.circuit.QuantumCircuit "qiskit.circuit.QuantumCircuit") can be serialized together with [`calibrations`](qiskit.circuit.QuantumCircuit#calibrations "qiskit.circuit.QuantumCircuit.calibrations"), or [Pulse Gates](/guides/pulse). In QPY version 5 and above, [CIRCUIT\_CALIBRATIONS](#qpy-circuit-calibrations) payload is packed after the [INSTRUCTIONS](#qpy-instructions) block.
