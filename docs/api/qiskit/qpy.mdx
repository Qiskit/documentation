...
<Function id="qiskit.qpy.load" name="load" github="https://github.com/Qiskit/qiskit/tree/stable/1.0/qiskit/qpy/interface.py#L210-L340" signature="qiskit.qpy.load(file_obj, metadata_deserializer=None)">
...
<Function id="qiskit.qpy.dump" name="dump" github="https://github.com/Qiskit/qiskit/tree/stable/1.0/qiskit/qpy/interface.py#L76-L207" signature="qiskit.qpy.dump(programs, file_obj, metadata_serializer=None, use_symengine=True, version=11)">
...
<Class id="qiskit.qpy.QpyError" name="QpyError" github="https://github.com/Qiskit/qiskit/tree/stable/1.0/qiskit/qpy/exceptions.py#L18-L28" signature="qiskit.qpy.QpyError(*message)">
...
<Class id="qiskit.qpy.QPYLoadingDeprecatedFeatureWarning" name="QPYLoadingDeprecatedFeatureWarning" github="https://github.com/Qiskit/qiskit/tree/stable/1.0/qiskit/qpy/exceptions.py#L31-L33" signature="qiskit.qpy.QPYLoadingDeprecatedFeatureWarning">
