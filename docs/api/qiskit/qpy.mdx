...
<Function id="qiskit.qpy.load" github="https://github.com/Qiskit/qiskit/tree/stable/2.0/qiskit/qpy/interface.py#L207-L344" signature="qiskit.qpy.load(file_obj, metadata_deserializer=None)">
...
<Function id="qiskit.qpy.dump" github="https://github.com/Qiskit/qiskit/tree/stable/2.0/qiskit/qpy/interface.py#L75-L204" signature="qiskit.qpy.dump(programs, file_obj, metadata_serializer=None, use_symengine=False, version=14)">
...
<Class id="qiskit.qpy.QpyError" github="https://github.com/Qiskit/qiskit/tree/stable/2.0/qiskit/qpy/exceptions.py#L18-L28" signature="qiskit.qpy.QpyError(*message)" modifiers="exception">
...
<Class id="qiskit.qpy.UnsupportedFeatureForVersion" github="https://github.com/Qiskit/qiskit/tree/stable/2.0/qiskit/qpy/exceptions.py#L31-L48" signature="qiskit.qpy.UnsupportedFeatureForVersion(feature, required, target)" modifiers="exception">
...
<Class id="qiskit.qpy.QPYLoadingDeprecatedFeatureWarning" github="https://github.com/Qiskit/qiskit/tree/stable/2.0/qiskit/qpy/exceptions.py#L51-L53" signature="qiskit.qpy.QPYLoadingDeprecatedFeatureWarning" modifiers="exception">
...
A [`Duration`](circuit#qiskit.circuit.Duration "qiskit.circuit.Duration") is encoded by a single-byte ASCII `char` that encodes the kind of type, followed by a payload that varies depending on the type. The defined codes are:
...
| [`Duration`](circuit#qiskit.circuit.Duration "qiskit.circuit.Duration") | `t`       | One `DURATION`.     |
