...
<Function id="qiskit.qpy.load" github="https://github.com/Qiskit/qiskit/tree/stable/2.4/qiskit/qpy/interface.py#L277-L443" signature="qiskit.qpy.load(file_obj, metadata_deserializer=None, annotation_factories=None)">
...
<Function id="qiskit.qpy.dump" github="https://github.com/Qiskit/qiskit/tree/stable/2.4/qiskit/qpy/interface.py#L89-L274" signature="qiskit.qpy.dump(programs, file_obj, metadata_serializer=None, use_symengine=False, version=17, annotation_factories=None)">
  ...
  *   **metadata\_serializer** ([*type*](qiskit.dagcircuit.DAGDepNode#type "qiskit.dagcircuit.DAGDepNode.type")*\[JSONEncoder] | None*) – An optional JSONEncoder class that will be passed the `.metadata` attribute for each program in `programs` and will be used as the `cls` kwarg on the json.dump()\` call to JSON serialize that dictionary.
  ...
  *   **annotation\_factories** (*Mapping\[*[*str*](https://docs.python.org/3/library/stdtypes.html#str)*, Callable\[\[],* [*annotation.QPYSerializer*](circuit_annotation#qiskit.circuit.annotation.QPYSerializer "qiskit.circuit.annotation.QPYSerializer")*]] | None*) – Mapping of namespaces to functions that create new instances of `annotation.QPUSerializer`, for handling the dumping of custom [`Annotation`](qiskit.circuit.Annotation "qiskit.circuit.Annotation") objects. The subsequent call to [`load()`](#qiskit.qpy.load "qiskit.qpy.load") will need to use similar serializer objects, that understand the custom output format of those serializers.
...
<Function id="qiskit.qpy.get_qpy_version" github="https://github.com/Qiskit/qiskit/tree/stable/2.4/qiskit/qpy/interface.py#L446-L473" signature="qiskit.qpy.get_qpy_version(file_obj)">
...
<Class id="qiskit.qpy.QpyError" github="https://github.com/Qiskit/qiskit/tree/stable/2.4/qiskit/qpy/exceptions.py#L18-L28" signature="qiskit.qpy.QpyError(*message)" modifiers="exception">
...
<Class id="qiskit.qpy.UnsupportedFeatureForVersion" github="https://github.com/Qiskit/qiskit/tree/stable/2.4/qiskit/qpy/exceptions.py#L31-L48" signature="qiskit.qpy.UnsupportedFeatureForVersion(feature, required, target)" modifiers="exception">
...
Note that circuit metadata and custom [`Annotation`](qiskit.circuit.Annotation "qiskit.circuit.Annotation") objects are serialized and deserialized by user-supplied classes, as the objects themselves are completely user-custom, so the forwards- and backwards-compatibility of these is limited by what the user provides.
...
<Class id="qiskit.qpy.QPYLoadingDeprecatedFeatureWarning" github="https://github.com/Qiskit/qiskit/tree/stable/2.4/qiskit/qpy/exceptions.py#L51-L53" signature="qiskit.qpy.QPYLoadingDeprecatedFeatureWarning" modifiers="exception">
...
Version 17 adds support for serializing and deserializing [`PauliEvolutionGate`](qiskit.circuit.library.PauliEvolutionGate "qiskit.circuit.library.PauliEvolutionGate") containing [`SparseObservable`](qiskit.quantum_info.SparseObservable "qiskit.quantum_info.SparseObservable") as operator(s).

<span id="changes-to-pauli-evolution" />

#### Changes to PAULI\_EVOLUTION

The format of PAULI\_EVOLUTION itself remains unchanged, but the format of the operators that immediately follow the packed evolution gate is updated. Instead of operator\_count elements defined by SPARSE\_PAULI\_OP\_LIST\_ELEM format, the payload now specifies the type of each operator to account for either operators of type [`SparsePauliOp`](qiskit.quantum_info.SparsePauliOp "qiskit.quantum_info.SparsePauliOp") or of [`SparseObservable`](qiskit.quantum_info.SparseObservable "qiskit.quantum_info.SparseObservable").

The new payload following PAULI\_EVOLUTION now contains exactly operator\_count sequences of a bool (`"!?"`) followed by the operator. If the bool is `True`, the operator is a [`SparseObservable`](qiskit.quantum_info.SparseObservable "qiskit.quantum_info.SparseObservable") and interpreted with the new SPARSE\_OBSERVABLE format (see below). If it is `False`, the operator is a [`SparsePauliOp`](qiskit.quantum_info.SparsePauliOp "qiskit.quantum_info.SparsePauliOp") and interpreted according to the existing SPARSE\_PAULI\_OP\_LIST\_ELEM format.

<span id="new-sparse-observable" />

#### New SPARSE\_OBSERVABLE

The SPARSE\_OBSERVABLE format represents an instance of a [`SparseObservable`](qiskit.quantum_info.SparseObservable "qiskit.quantum_info.SparseObservable"), given by
...
> *   The bit term elements are of type “!H” and represents the u8 value of the [`SparseObservable.BitTerm`](qiskit.quantum_info.SparseObservable#bitterm "qiskit.quantum_info.SparseObservable.BitTerm")
...
The struct itself is unchanged. However, for a `PARAM_EXPR_ELEM_V13` representing a [`ParameterExpression.subs()`](qiskit.circuit.ParameterExpression#subs "qiskit.circuit.ParameterExpression.subs") call (with `op_code = 15`, and therefore `lhs_type = 'p'` and `rhs_type = 'n'`), the trailing [MAPPING](#qpy-mapping) now maps keys of the raw bytes of the [`Parameter`](qiskit.circuit.Parameter "qiskit.circuit.Parameter") UUIDs to the substituted values. Previously (in QPY versions 13 and 14), this mapping stored the parameter names as the keys.
...
which is immediately followed by `pauli_op_size` bytes which are .npy format <span id="id6" />[\[2\]](#f2) data which represents the [`SparsePauliOp`](qiskit.quantum_info.SparsePauliOp "qiskit.quantum_info.SparsePauliOp").
