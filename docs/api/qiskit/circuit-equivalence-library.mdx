...
<Class id="qiskit.circuit.EquivalenceLibrary" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.3/qiskit/circuit/equivalence.py#L29-L94" signature="qiskit.circuit.EquivalenceLibrary" modifiers="class">
  ...
  <Function id="qiskit.circuit.EquivalenceLibrary.add_equivalence" signature="add_equivalence(gate, equivalent_circuit)">
    ...
    *   **gate** ([*Gate*](circuit-gate "qiskit.circuit.Gate")) – A Gate instance.
    *   **equivalent\_circuit** ([*QuantumCircuit*](circuit-quantum-circuit "qiskit.circuit.QuantumCircuit")) – A circuit equivalently implementing the given Gate.
  </Function>

  ### draw

  <Function id="qiskit.circuit.EquivalenceLibrary.draw" github="https://github.com/Qiskit/qiskit/tree/stable/1.3/qiskit/circuit/equivalence.py#L33-L58" signature="draw(filename=None)">
  ...
  <Function id="qiskit.circuit.EquivalenceLibrary.get_entry" signature="get_entry(gate)">
    Gets the set of [`QuantumCircuit`](circuit-quantum-circuit "qiskit.circuit.QuantumCircuit") instances circuits from the library which equivalently implement the given [`Gate`](circuit-gate "qiskit.circuit.Gate").
    ...
    **A list of equivalent [`QuantumCircuit`](circuit-quantum-circuit "qiskit.circuit.QuantumCircuit") instances.**
    ...
    **Return type**
    ...
    List\[[QuantumCircuit](circuit-quantum-circuit "qiskit.circuit.QuantumCircuit")]
  </Function>
  ...
  <Function id="qiskit.circuit.EquivalenceLibrary.has_entry" signature="has_entry(gate)">
    ...
    **Return type**
    ...
    [Bool](circuit-classical#qiskit.circuit.classical.types.Bool "qiskit.circuit.classical.types.Bool")
  </Function>
  ...
  <Function id="qiskit.circuit.EquivalenceLibrary.set_entry" signature="set_entry(gate, entry)">
    ...
    *   **gate** ([*Gate*](circuit-gate "qiskit.circuit.Gate")) – A Gate instance.
    *   **entry** (*List\['QuantumCircuit']*) – A list of [`QuantumCircuit`](circuit-quantum-circuit "qiskit.circuit.QuantumCircuit") instances, each equivalently implementing the given Gate.
  </Function>
</Class>
