...
<Class id="qiskit.transpiler.passes.synthesis.hls_plugins.GreedySynthesisClifford" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.4/qiskit/transpiler/passes/synthesis/hls_plugins.py#L535-L549" signature="qiskit.transpiler.passes.synthesis.hls_plugins.GreedySynthesisClifford" modifiers="class">
  ...
  <Function id="qiskit.transpiler.passes.synthesis.hls_plugins.GreedySynthesisClifford.run" github="https://github.com/Qiskit/qiskit/tree/stable/1.4/qiskit/transpiler/passes/synthesis/hls_plugins.py#L543-L549" signature="run(high_level_object, coupling_map=None, target=None, qubits=None, **options)">
