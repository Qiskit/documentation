---
title: FakeBackendV2 (v0.43)
description: API reference for qiskit.providers.fake_provider.FakeBackendV2 in qiskit v0.43
...
<Class id="qiskit.providers.fake_provider.FakeBackendV2" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/providers/fake_provider/fake_backend_v2.py" signature="FakeBackendV2" modifiers="class">
