...
<Class id="qiskit.transpiler.synthesis.aqc.FastCNOTUnitObjective" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/transpiler/synthesis/aqc/fast_gradient/fast_gradient.py" signature="FastCNOTUnitObjective(num_qubits, cnots)">
