...
<Class id="qiskit.pulse.instructions.SetFrequency" github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/pulse/instructions/frequency.py" signature="SetFrequency(frequency, channel, name=None)">
