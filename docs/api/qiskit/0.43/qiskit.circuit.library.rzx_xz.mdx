...
<Function id="qiskit.circuit.library.rzx_xz" github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/circuit/library/templates/rzx/rzx_xz.py" signature="rzx_xz(theta=None)">
