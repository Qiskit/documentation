...
<Class id="qiskit.circuit.library.FourierChecking" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/circuit/library/fourier_checking.py" signature="FourierChecking(f, g)">
  ...
  **Reference Circuit:**
  ...
  <Attribute id="qiskit.circuit.library.FourierChecking.instances" name="instances" attributeValue="= 123" />
