...
`ConsolidateBlocks(*args, **kwargs)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.43/qiskit/transpiler/passes/optimization/consolidate_blocks.py "view source code")
...
*   **approximation\_degree** (*float*) – a float between \[0.0, 1.0]. Lower approximates more.
...
`ConsolidateBlocks.run(dag)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.43/qiskit/transpiler/passes/optimization/consolidate_blocks.py "view source code")
