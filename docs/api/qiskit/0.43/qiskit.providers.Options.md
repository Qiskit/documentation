...
`Options(**kwargs)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.43/qiskit/providers/options.py "view source code")
...
`Options.get(k[, d]) → D[k] if k in D, else d.  d defaults to None.`
...
`Options.items() → a set-like object providing a view on D's items`
...
`Options.keys() → a set-like object providing a view on D's keys`
...
`Options.set_validator(field, validator_value)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.43/qiskit/providers/options.py "view source code")
...
`Options.update_options(**fields)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.43/qiskit/providers/options.py "view source code")
...
`Options.values() → an object providing a view on D's values`
