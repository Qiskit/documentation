...
<Class id="qiskit.providers.fake_provider.FakeGeneva" github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/providers/fake_provider/backends/geneva/fake_geneva.py" signature="FakeGeneva">
  ...
  <Function id="qiskit.providers.fake_provider.FakeGeneva.acquire_channel" signature="FakeGeneva.acquire_channel(qubit)">
  ...
  <Function id="qiskit.providers.fake_provider.FakeGeneva.control_channel" signature="FakeGeneva.control_channel(qubits)">
  ...
  <Function id="qiskit.providers.fake_provider.FakeGeneva.drive_channel" signature="FakeGeneva.drive_channel(qubit)">
  ...
  <Function id="qiskit.providers.fake_provider.FakeGeneva.measure_channel" signature="FakeGeneva.measure_channel(qubit)">
  ...
  <Function id="qiskit.providers.fake_provider.FakeGeneva.qubit_properties" signature="FakeGeneva.qubit_properties(qubit)">
  ...
  <Function id="qiskit.providers.fake_provider.FakeGeneva.run" signature="FakeGeneva.run(run_input, **options)">
  ...
  <Function id="qiskit.providers.fake_provider.FakeGeneva.set_options" signature="FakeGeneva.set_options(**fields)">
