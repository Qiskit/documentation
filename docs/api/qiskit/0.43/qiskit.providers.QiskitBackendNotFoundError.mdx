...
<Class id="qiskit.providers.QiskitBackendNotFoundError" github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/providers/exceptions.py" signature="QiskitBackendNotFoundError(*message)">
