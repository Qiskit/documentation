...
<Class id="qiskit.providers.BackendV2" github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/providers/backend.py" signature="BackendV2(provider=None, name=None, description=None, online_date=None, backend_version=None, **fields)">
