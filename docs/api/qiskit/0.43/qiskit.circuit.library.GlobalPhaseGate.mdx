---
title: GlobalPhaseGate (v0.43)
description: API reference for qiskit.circuit.library.GlobalPhaseGate in qiskit v0.43
...
<Class id="qiskit.circuit.library.GlobalPhaseGate" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/circuit/library/standard_gates/global_phase.py" signature="GlobalPhaseGate(phase, label=None)" modifiers="class">
...
$$
  ...
  *   **label** (*str | None*) – An optional label for the gate.
  ...
  <Function id="qiskit.circuit.library.GlobalPhaseGate.inverse" signature="GlobalPhaseGate.inverse()">
