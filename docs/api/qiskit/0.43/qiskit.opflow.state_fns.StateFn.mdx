---
title: StateFn (v0.43)
description: API reference for qiskit.opflow.state_fns.StateFn in qiskit v0.43
...
<Class id="qiskit.opflow.state_fns.StateFn" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/opflow/state_fns/state_fn.py" signature="StateFn(primitive=None, coeff=1.0, is_measurement=False)" modifiers="class">
