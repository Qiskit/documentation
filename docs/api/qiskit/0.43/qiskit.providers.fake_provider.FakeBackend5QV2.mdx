...
<Class id="qiskit.providers.fake_provider.FakeBackend5QV2" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/providers/fake_provider/fake_backend_v2.py" signature="FakeBackend5QV2(bidirectional=True)">
  ...
  **AttributeError** – If a field is specified that’s outside the backend’s options
  ...
  <Function id="qiskit.providers.fake_provider.FakeBackend5QV2.acquire_channel" name="acquire_channel" signature="FakeBackend5QV2.acquire_channel(qubit)">
  ...
  <Function id="qiskit.providers.fake_provider.FakeBackend5QV2.control_channel" name="control_channel" signature="FakeBackend5QV2.control_channel(qubits)">
  ...
  <Function id="qiskit.providers.fake_provider.FakeBackend5QV2.drive_channel" name="drive_channel" signature="FakeBackend5QV2.drive_channel(qubit)">
  ...
  <Function id="qiskit.providers.fake_provider.FakeBackend5QV2.measure_channel" name="measure_channel" signature="FakeBackend5QV2.measure_channel(qubit)">
  ...
  <Function id="qiskit.providers.fake_provider.FakeBackend5QV2.qubit_properties" name="qubit_properties" signature="FakeBackend5QV2.qubit_properties(qubit)">
  ...
  <Function id="qiskit.providers.fake_provider.FakeBackend5QV2.run" name="run" signature="FakeBackend5QV2.run(run_input, **options)">
    Run on the backend.
  ...
  <Function id="qiskit.providers.fake_provider.FakeBackend5QV2.set_options" name="set_options" signature="FakeBackend5QV2.set_options(**fields)">
