---
title: ImaginaryTimeEvolver (v0.43)
description: API reference for qiskit.algorithms.ImaginaryTimeEvolver in qiskit v0.43
...
<Class id="qiskit.algorithms.ImaginaryTimeEvolver" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/algorithms/time_evolvers/imaginary_time_evolver.py" signature="ImaginaryTimeEvolver" modifiers="class">
  Bases: `ABC`
