...
`barrier(*channels_or_qubits, name=None)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.43/qiskit/pulse/builder.py "view source code")
...
*   **channels\_or\_qubits** ([*Channel*](pulse#qiskit.pulse.channels.Channel "qiskit.pulse.channels.Channel") *| int*) – Channels or qubits to barrier.
