---
title: barrier (v0.43)
description: API reference for qiskit.pulse.builder.barrier in qiskit v0.43
...
<Function id="qiskit.pulse.builder.barrier" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/pulse/builder.py" signature="barrier(*channels_or_qubits, name=None)">
