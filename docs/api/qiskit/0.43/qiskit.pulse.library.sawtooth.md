...
`sawtooth(duration, amp, freq=None, phase=0, name=None)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.43/qiskit/pulse/library/discrete.py "view source code")
...
![../\_images/qiskit-pulse-library-sawtooth-1.png](/images/api/qiskit/0.43/qiskit-pulse-library-sawtooth-1.png)
