...
<Class id="qiskit.algorithms.optimizers.Minimizer" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/algorithms/optimizers/optimizer.py" signature="Minimizer(*args, **kwargs)">
  Bases: `Protocol`
