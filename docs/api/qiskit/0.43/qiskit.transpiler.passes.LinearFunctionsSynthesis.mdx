---
title: LinearFunctionsSynthesis (v0.43)
description: API reference for qiskit.transpiler.passes.LinearFunctionsSynthesis in qiskit v0.43
...
<Class id="qiskit.transpiler.passes.LinearFunctionsSynthesis" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/transpiler/passes/synthesis/linear_functions_synthesis.py" signature="LinearFunctionsSynthesis(*args, **kwargs)" modifiers="class">
