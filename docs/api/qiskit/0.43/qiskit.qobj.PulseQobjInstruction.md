...
<span id="qiskit-qobj-pulseqobjinstruction-from-dict" />

### from\_dict

<span id="qiskit.qobj.PulseQobjInstruction.from_dict" />

`classmethod PulseQobjInstruction.from_dict(data)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.43/qiskit/qobj/pulse_qobj.py "view source code")
...
<span id="qiskit-qobj-pulseqobjinstruction-to-dict" />

### to\_dict

<span id="qiskit.qobj.PulseQobjInstruction.to_dict" />

`PulseQobjInstruction.to_dict()`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.43/qiskit/qobj/pulse_qobj.py "view source code")
