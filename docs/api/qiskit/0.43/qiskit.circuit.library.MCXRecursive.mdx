---
title: MCXRecursive (v0.43)
description: API reference for qiskit.circuit.library.MCXRecursive in qiskit v0.43
...
<Class id="qiskit.circuit.library.MCXRecursive" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/circuit/library/standard_gates/x.py" signature="MCXRecursive(num_ctrl_qubits=None, label=None, ctrl_state=None)" modifiers="class">
