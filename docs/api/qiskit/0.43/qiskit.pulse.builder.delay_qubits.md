...
`delay_qubits(duration, *qubits)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.43/qiskit/pulse/builder.py "view source code")
...
*   **qubits** (*int | Iterable\[int]*) – Physical qubits to delay on. Delays will be inserted based on the channels returned by `pulse.qubit_channels()`.
