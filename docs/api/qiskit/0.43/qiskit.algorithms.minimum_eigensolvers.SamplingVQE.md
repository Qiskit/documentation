...
`SamplingVQE(sampler, ansatz, optimizer, *, initial_point=None, aggregation=None, callback=None)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.43/qiskit/algorithms/minimum_eigensolvers/sampling_vqe.py "view source code")
...
<span id="qiskit-algorithms-minimum-eigensolvers-samplingvqe-compute-minimum-eigenvalue" />

### compute\_minimum\_eigenvalue

<span id="qiskit.algorithms.minimum_eigensolvers.SamplingVQE.compute_minimum_eigenvalue" />

`SamplingVQE.compute_minimum_eigenvalue(operator, aux_operators=None)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.43/qiskit/algorithms/minimum_eigensolvers/sampling_vqe.py "view source code")
...
<span id="qiskit-algorithms-minimum-eigensolvers-samplingvqe-supports-aux-operators" />

### supports\_aux\_operators

<span id="qiskit.algorithms.minimum_eigensolvers.SamplingVQE.supports_aux_operators" />

`classmethod SamplingVQE.supports_aux_operators()`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.43/qiskit/algorithms/minimum_eigensolvers/sampling_vqe.py "view source code")
