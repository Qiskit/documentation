...
<Class id="qiskit.circuit.classicalfunction.ClassicalFunctionParseError" name="ClassicalFunctionParseError" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/circuit/classicalfunction/exceptions.py" signature="ClassicalFunctionParseError(*message)">
