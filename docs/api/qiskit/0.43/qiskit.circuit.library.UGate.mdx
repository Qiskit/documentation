---
title: UGate (v0.43)
description: API reference for qiskit.circuit.library.UGate in qiskit v0.43
...
<Class id="qiskit.circuit.library.UGate" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/circuit/library/standard_gates/u.py" signature="UGate(theta, phi, lam, label=None)" modifiers="class">
