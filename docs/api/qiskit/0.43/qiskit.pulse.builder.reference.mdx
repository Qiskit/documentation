...
description: API reference for qiskit.pulse.builder.reference in qiskit v0.43
...
<Function id="qiskit.pulse.builder.reference" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/pulse/builder.py" signature="reference(name, *extra_keys)">
