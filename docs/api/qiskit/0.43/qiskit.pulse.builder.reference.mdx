...
<Function id="qiskit.pulse.builder.reference" name="reference" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/pulse/builder.py" signature="reference(name, *extra_keys)">
