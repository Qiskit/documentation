---
title: Provider (v0.43)
description: API reference for qiskit.providers.Provider in qiskit v0.43
...
<Class id="qiskit.providers.Provider" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/providers/provider.py" signature="Provider" modifiers="class">
  Bases: `object`
