...
<Class id="qiskit.primitives.BaseEstimator" github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/primitives/base/base_estimator.py" signature="BaseEstimator(*, options=None)">
