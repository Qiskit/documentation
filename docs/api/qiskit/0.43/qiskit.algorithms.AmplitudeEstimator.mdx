---
title: AmplitudeEstimator (v0.43)
description: API reference for qiskit.algorithms.AmplitudeEstimator in qiskit v0.43
...
<Class id="qiskit.algorithms.AmplitudeEstimator" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/algorithms/amplitude_estimators/amplitude_estimator.py" signature="AmplitudeEstimator" modifiers="class">
  Bases: `ABC`
