...
<Class id="qiskit.synthesis.EvolutionSynthesis" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/synthesis/evolution/evolution_synthesis.py" signature="EvolutionSynthesis">
  Bases: `ABC`
  ...
  <Function id="qiskit.synthesis.EvolutionSynthesis.synthesize" name="synthesize" signature="abstract EvolutionSynthesis.synthesize(evolution)">
