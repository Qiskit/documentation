---
title: EvolutionSynthesis (v0.43)
description: API reference for qiskit.synthesis.EvolutionSynthesis in qiskit v0.43
...
<Class id="qiskit.synthesis.EvolutionSynthesis" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/synthesis/evolution/evolution_synthesis.py" signature="EvolutionSynthesis" modifiers="class">
  Bases: `ABC`
