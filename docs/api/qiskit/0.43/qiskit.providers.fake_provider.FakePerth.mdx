...
description: API reference for qiskit.providers.fake_provider.FakePerth in qiskit v0.43
...
<Class id="qiskit.providers.fake_provider.FakePerth" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/providers/fake_provider/backends/perth/fake_perth.py" signature="FakePerth" modifiers="class">
  Bases: `FakeBackendV2`
  ...
  <Attribute id="qiskit.providers.fake_provider.FakePerth.dirname" attributeValue="'/home/computertreker/git/qiskit/qiskit/.tox/docs/lib/python3.8/site-packages/qiskit/providers/fake_provider/backends/perth'" />
