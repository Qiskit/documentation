...
`Chi(data, input_dims=None, output_dims=None)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.43/qiskit/quantum_info/operators/channel/chi.py "view source code")
...
<span id="qiskit-quantum-info-chi-adjoint" />

### adjoint

<span id="qiskit.quantum_info.Chi.adjoint" />

`Chi.adjoint()`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.43/qiskit/quantum_info/operators/channel/chi.py "view source code")
...
<span id="qiskit-quantum-info-chi-compose" />

### compose

<span id="qiskit.quantum_info.Chi.compose" />

`Chi.compose(other, qargs=None, front=False)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.43/qiskit/quantum_info/operators/channel/chi.py "view source code")
...
<span id="qiskit-quantum-info-chi-conjugate" />

### conjugate

<span id="qiskit.quantum_info.Chi.conjugate" />

`Chi.conjugate()`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.43/qiskit/quantum_info/operators/channel/chi.py "view source code")
...
<span id="qiskit-quantum-info-chi-copy" />
...
<span id="qiskit-quantum-info-chi-dot" />
...
<span id="qiskit-quantum-info-chi-expand" />

### expand

<span id="qiskit.quantum_info.Chi.expand" />

`Chi.expand(other)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.43/qiskit/quantum_info/operators/channel/chi.py "view source code")
...
<span id="qiskit-quantum-info-chi-input-dims" />
...
<span id="qiskit-quantum-info-chi-is-cp" />
...
<span id="qiskit-quantum-info-chi-is-cptp" />
...
<span id="qiskit-quantum-info-chi-is-tp" />
...
<span id="qiskit-quantum-info-chi-is-unitary" />
...
<span id="qiskit-quantum-info-chi-output-dims" />
...
<span id="qiskit-quantum-info-chi-power" />
...
<span id="qiskit-quantum-info-chi-reshape" />
...
<span id="qiskit-quantum-info-chi-tensor" />

### tensor

<span id="qiskit.quantum_info.Chi.tensor" />

`Chi.tensor(other)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.43/qiskit/quantum_info/operators/channel/chi.py "view source code")
...
<span id="qiskit-quantum-info-chi-to-instruction" />
...
<span id="qiskit-quantum-info-chi-to-operator" />
...
<span id="qiskit-quantum-info-chi-transpose" />

### transpose

<span id="qiskit.quantum_info.Chi.transpose" />

`Chi.transpose()`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.43/qiskit/quantum_info/operators/channel/chi.py "view source code")
