...
<Function id="qiskit.synthesis.generate_basic_approximations" name="generate_basic_approximations" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/synthesis/discrete_basis/generate_basis_approximations.py" signature="generate_basic_approximations(basis_gates, depth, filename=None)">
