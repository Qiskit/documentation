...
<Class id="qiskit.algorithms.PhaseEstimation" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/algorithms/phase_estimators/phase_estimation.py" signature="PhaseEstimation(num_evaluation_qubits, quantum_instance=None, sampler=None)">
...
$$
  ...
  **Raises**
  ...
  <Function id="qiskit.algorithms.PhaseEstimation.construct_circuit" name="construct_circuit" signature="PhaseEstimation.construct_circuit(unitary, state_preparation=None)">
  ...
  <Function id="qiskit.algorithms.PhaseEstimation.estimate" name="estimate" signature="PhaseEstimation.estimate(unitary, state_preparation=None)">
  ...
  <Function id="qiskit.algorithms.PhaseEstimation.estimate_from_pe_circuit" name="estimate_from_pe_circuit" signature="PhaseEstimation.estimate_from_pe_circuit(pe_circuit, num_unitary_qubits)">
