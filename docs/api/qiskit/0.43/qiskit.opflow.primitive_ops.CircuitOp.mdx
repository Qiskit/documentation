---
title: CircuitOp (v0.43)
description: API reference for qiskit.opflow.primitive_ops.CircuitOp in qiskit v0.43
...
<Class id="qiskit.opflow.primitive_ops.CircuitOp" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/opflow/primitive_ops/circuit_op.py" signature="CircuitOp(*args, **kwargs)" modifiers="class">
  ...
  **TypeError** – Unsupported primitive, or primitive has ClassicalRegisters.
  ...
  <Attribute id="qiskit.opflow.primitive_ops.CircuitOp.primitive" attributeTypeHint="QuantumCircuit">
