...
<Class id="qiskit.opflow.primitive_ops.CircuitOp" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/opflow/primitive_ops/circuit_op.py" signature="CircuitOp(*args, **kwargs)">
  ...
  **TypeError** – Unsupported primitive, or primitive has ClassicalRegisters.
  ...
  <Attribute id="qiskit.opflow.primitive_ops.CircuitOp.primitive" name="primitive" attributeTypeHint="QuantumCircuit">
