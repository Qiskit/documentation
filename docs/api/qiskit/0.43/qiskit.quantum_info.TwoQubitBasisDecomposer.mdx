...
<Class id="qiskit.quantum_info.TwoQubitBasisDecomposer" github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/quantum_info/synthesis/two_qubit_decompose.py" signature="TwoQubitBasisDecomposer(gate, basis_fidelity=1.0, euler_basis='U', pulse_optimize=None)">
  Bases: `object`
