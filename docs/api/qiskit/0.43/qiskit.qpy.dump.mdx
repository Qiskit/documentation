---
title: dump (v0.43)
description: API reference for qiskit.qpy.dump in qiskit v0.43
...
<Function id="qiskit.qpy.dump" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/qpy/interface.py" signature="dump(programs, file_obj, metadata_serializer=None)">
