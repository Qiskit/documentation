...
<Class id="qiskit.providers.JobTimeoutError" name="JobTimeoutError" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/providers/exceptions.py" signature="JobTimeoutError(*message)">
