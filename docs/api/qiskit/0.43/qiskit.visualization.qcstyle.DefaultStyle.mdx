---
title: DefaultStyle (v0.43)
description: API reference for qiskit.visualization.qcstyle.DefaultStyle in qiskit v0.43
...
<Class id="qiskit.visualization.qcstyle.DefaultStyle" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/visualization/circuit/qcstyle.py" signature="DefaultStyle" modifiers="class">
  Bases: `object`
