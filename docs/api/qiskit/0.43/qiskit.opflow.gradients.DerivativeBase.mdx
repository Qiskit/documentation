...
<Class id="qiskit.opflow.gradients.DerivativeBase" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/opflow/gradients/derivative_base.py" signature="DerivativeBase">
  ...
  <Function id="qiskit.opflow.gradients.DerivativeBase.convert" signature="abstract DerivativeBase.convert(operator, params=None)">
    **Parameters**
  ...
  <Function id="qiskit.opflow.gradients.DerivativeBase.parameter_expression_grad" signature="static DerivativeBase.parameter_expression_grad(param_expr, param)">
