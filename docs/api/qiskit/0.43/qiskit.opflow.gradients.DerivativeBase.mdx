...
<Class id="qiskit.opflow.gradients.DerivativeBase" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/opflow/gradients/derivative_base.py" signature="DerivativeBase">
  ...
  <Function id="qiskit.opflow.gradients.DerivativeBase.convert" name="convert" signature="abstract DerivativeBase.convert(operator, params=None)">
    **Parameters**
  ...
  <span id="qiskit-opflow-gradients-derivativebase-gradient-wrapper" />

  ### gradient\_wrapper

  <Function id="qiskit.opflow.gradients.DerivativeBase.gradient_wrapper" name="gradient_wrapper" signature="DerivativeBase.gradient_wrapper(operator, bind_params, grad_params=None, backend=None, expectation=None)">
    ...
    *Callable*\[\[*Iterable*], [*ndarray*](https://numpy.org/doc/stable/reference/generated/numpy.ndarray.html#numpy.ndarray "(in NumPy v1.25)")]
  </Function>

  <span id="qiskit-opflow-gradients-derivativebase-parameter-expression-grad" />

  ### parameter\_expression\_grad

  <Function id="qiskit.opflow.gradients.DerivativeBase.parameter_expression_grad" name="parameter_expression_grad" signature="static DerivativeBase.parameter_expression_grad(param_expr, param)">
    ...
    **Return type**
    ...
    [*ParameterExpression*](qiskit.circuit.ParameterExpression "qiskit.circuit.parameterexpression.ParameterExpression") | float
  </Function>
</Class>
