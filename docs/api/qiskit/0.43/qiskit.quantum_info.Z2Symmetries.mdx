...
<Class id="qiskit.quantum_info.Z2Symmetries" github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/quantum_info/analysis/z2_symmetries.py" signature="Z2Symmetries(symmetries, sq_paulis, sq_list, tapering_values=None, *, tol=1e-14)">
  Bases: `object`
