...
<Class id="qiskit.quantum_info.Z2Symmetries" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/quantum_info/analysis/z2_symmetries.py" signature="Z2Symmetries(symmetries, sq_paulis, sq_list, tapering_values=None, *, tol=1e-14)">
  Bases: `object`
  ...
  **QiskitError** – Invalid paulis. The lists of symmetries, single-qubit paulis support paulis and tapering values must be of equal length. This length is the number of applied symmetries and translates directly to the number of eliminated qubits.
  ...
  <Function id="qiskit.quantum_info.Z2Symmetries.convert_clifford" name="convert_clifford" signature="Z2Symmetries.convert_clifford(operator)">
  ...
  <Function id="qiskit.quantum_info.Z2Symmetries.find_z2_symmetries" name="find_z2_symmetries" signature="classmethod Z2Symmetries.find_z2_symmetries(operator)">
  ...
  <Function id="qiskit.quantum_info.Z2Symmetries.is_empty" name="is_empty" signature="Z2Symmetries.is_empty()">
  ...
  <Function id="qiskit.quantum_info.Z2Symmetries.taper" name="taper" signature="Z2Symmetries.taper(operator)">
  ...
  <Function id="qiskit.quantum_info.Z2Symmetries.taper_clifford" name="taper_clifford" signature="Z2Symmetries.taper_clifford(operator)">
