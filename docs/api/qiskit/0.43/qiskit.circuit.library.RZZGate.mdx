---
title: RZZGate (v0.43)
description: API reference for qiskit.circuit.library.RZZGate in qiskit v0.43
...
<Class id="qiskit.circuit.library.RZZGate" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/circuit/library/standard_gates/rzz.py" signature="RZZGate(theta, label=None)" modifiers="class">
