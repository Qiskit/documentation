---
title: align_func (v0.43)
description: API reference for qiskit.pulse.builder.align_func in qiskit v0.43
...
<Function id="qiskit.pulse.builder.align_func" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/pulse/builder.py" signature="align_func(duration, func)">
  ...
  ![../\_images/qiskit-pulse-builder-align\_func-1.png](/docs/images/api/qiskit/0.43/qiskit-pulse-builder-align_func-1.avif)
