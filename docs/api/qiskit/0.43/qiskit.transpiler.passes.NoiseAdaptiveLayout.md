...
`NoiseAdaptiveLayout(*args, **kwargs)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.43/qiskit/transpiler/passes/layout/noise_adaptive_layout.py "view source code")
...
`NoiseAdaptiveLayout.run(dag)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.43/qiskit/transpiler/passes/layout/noise_adaptive_layout.py "view source code")
