---
title: Optimize1qGatesDecomposition (v0.43)
description: API reference for qiskit.transpiler.passes.Optimize1qGatesDecomposition in qiskit v0.43
...
<Class id="qiskit.transpiler.passes.Optimize1qGatesDecomposition" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/transpiler/passes/optimization/optimize_1q_decomposition.py" signature="Optimize1qGatesDecomposition(*args, **kwargs)" modifiers="class">
