---
title: DCXGate (v0.43)
description: API reference for qiskit.circuit.library.DCXGate in qiskit v0.43
...
<Class id="qiskit.circuit.library.DCXGate" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/circuit/library/standard_gates/dcx.py" signature="DCXGate" modifiers="class">
