---
title: PauliOp (v0.43)
description: API reference for qiskit.opflow.primitive_ops.PauliOp in qiskit v0.43
...
<Class id="qiskit.opflow.primitive_ops.PauliOp" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/opflow/primitive_ops/pauli_op.py" signature="PauliOp(*args, **kwargs)" modifiers="class">
