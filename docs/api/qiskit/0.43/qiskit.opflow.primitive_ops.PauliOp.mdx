...
<Class id="qiskit.opflow.primitive_ops.PauliOp" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/opflow/primitive_ops/pauli_op.py" signature="PauliOp(*args, **kwargs)">
  ...
  **TypeError** – invalid parameters.
  ...
  <Attribute id="qiskit.opflow.primitive_ops.PauliOp.primitive" name="primitive" attributeTypeHint="Pauli">
