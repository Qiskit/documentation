---
title: Job (v0.43)
description: API reference for qiskit.providers.Job in qiskit v0.43
...
<Class id="qiskit.providers.Job" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/providers/job.py" signature="Job" modifiers="class">
  Bases: `object`
