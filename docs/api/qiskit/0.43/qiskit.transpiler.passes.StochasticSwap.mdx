...
<Class id="qiskit.transpiler.passes.StochasticSwap" github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/transpiler/passes/routing/stochastic_swap.py" signature="StochasticSwap(*args, **kwargs)">
