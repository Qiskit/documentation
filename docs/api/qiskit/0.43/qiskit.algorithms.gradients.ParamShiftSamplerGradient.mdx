...
<Class id="qiskit.algorithms.gradients.ParamShiftSamplerGradient" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/algorithms/gradients/param_shift_sampler_gradient.py" signature="ParamShiftSamplerGradient(sampler, options=None)">
  ...
  *   **options** ([*Options*](qiskit.providers.Options "qiskit.providers.Options") *| None*) – Primitive backend runtime options used for circuit execution. The order of priority is: options in `run` method > gradient’s default options > primitive’s default setting. Higher priority setting overrides lower priority setting
  ...
  <Function id="qiskit.algorithms.gradients.ParamShiftSamplerGradient.run" name="run" signature="ParamShiftSamplerGradient.run(circuits, parameter_values, parameters=None, **options)">
  ...
  <Function id="qiskit.algorithms.gradients.ParamShiftSamplerGradient.update_default_options" name="update_default_options" signature="ParamShiftSamplerGradient.update_default_options(**options)">
  ...
  <Attribute id="qiskit.algorithms.gradients.ParamShiftSamplerGradient.SUPPORTED_GATES" name="SUPPORTED_GATES" attributeValue="['x', 'y', 'z', 'h', 'rx', 'ry', 'rz', 'p', 'cx', 'cy', 'cz', 'ryy', 'rxx', 'rzz', 'rzx']" />

  ### options

  <Attribute id="qiskit.algorithms.gradients.ParamShiftSamplerGradient.options" name="options">
