---
title: ParamShiftSamplerGradient (v0.43)
description: API reference for qiskit.algorithms.gradients.ParamShiftSamplerGradient in qiskit v0.43
...
<Class id="qiskit.algorithms.gradients.ParamShiftSamplerGradient" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/algorithms/gradients/param_shift_sampler_gradient.py" signature="ParamShiftSamplerGradient(sampler, options=None)" modifiers="class">
