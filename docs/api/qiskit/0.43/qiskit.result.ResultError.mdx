...
<Class id="qiskit.result.ResultError" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/result/exceptions.py" signature="ResultError(error)">
