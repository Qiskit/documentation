...
`GMS(num_qubits, theta)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.43/qiskit/circuit/library/generalized_gates/gms.py "view source code")
...
![../\_images/qiskit-circuit-library-GMS-1.png](/images/api/qiskit/0.43/qiskit-circuit-library-GMS-1.png)
...
*   **theta** (*List\[List\[float]] |* [*ndarray*](https://numpy.org/doc/stable/reference/generated/numpy.ndarray.html#numpy.ndarray "(in NumPy v1.25)")) – a num\_qubits x num\_qubits symmetric matrix of interaction angles for each qubit pair. The upper triangle is considered.
