...
<Class id="qiskit.algorithms.SciPyImaginaryEvolver" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/algorithms/time_evolvers/classical_methods/scipy_imaginary_evolver.py" signature="SciPyImaginaryEvolver(num_timesteps)">
