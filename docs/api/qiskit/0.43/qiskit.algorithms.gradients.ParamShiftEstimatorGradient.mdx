...
<Class id="qiskit.algorithms.gradients.ParamShiftEstimatorGradient" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/algorithms/gradients/param_shift_estimator_gradient.py" signature="ParamShiftEstimatorGradient(estimator, options=None, derivative_type=DerivativeType.REAL)">
  ...
  *   **derivative\_type** ([*DerivativeType*](qiskit.algorithms.gradients.DerivativeType "qiskit.algorithms.gradients.DerivativeType")) –
  ...
  <Function id="qiskit.algorithms.gradients.ParamShiftEstimatorGradient.run" name="run" signature="ParamShiftEstimatorGradient.run(circuits, observables, parameter_values, parameters=None, **options)">
  ...
  <Function id="qiskit.algorithms.gradients.ParamShiftEstimatorGradient.update_default_options" name="update_default_options" signature="ParamShiftEstimatorGradient.update_default_options(**options)">
  ...
  <Attribute id="qiskit.algorithms.gradients.ParamShiftEstimatorGradient.SUPPORTED_GATES" name="SUPPORTED_GATES" attributeValue="['x', 'y', 'z', 'h', 'rx', 'ry', 'rz', 'p', 'cx', 'cy', 'cz', 'ryy', 'rxx', 'rzz', 'rzx']" />

  ### derivative\_type

  <Attribute id="qiskit.algorithms.gradients.ParamShiftEstimatorGradient.derivative_type" name="derivative_type">
  ...
  <Attribute id="qiskit.algorithms.gradients.ParamShiftEstimatorGradient.options" name="options">
