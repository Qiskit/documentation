...
`TensoredMeasFitter(results, mit_pattern, substate_labels_list=None, circlabel='')`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.43/qiskit/utils/mitigation/fitters.py "view source code")
...
*   **substate\_labels\_list** (*List\[List\[str]]*) – for each calibration matrix, the labels of its rows and columns. If None, the labels are ordered lexicographically
...
`TensoredMeasFitter.add_data(new_results, rebuild_cal_matrix=True)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.43/qiskit/utils/mitigation/fitters.py "view source code")
...
`TensoredMeasFitter.readout_fidelity(cal_index=0, label_list=None)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.43/qiskit/utils/mitigation/fitters.py "view source code")
...
`TensoredMeasFitter.subset_fitter(qubit_sublist)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.43/qiskit/utils/mitigation/fitters.py "view source code")
