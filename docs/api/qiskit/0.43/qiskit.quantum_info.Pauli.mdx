---
title: Pauli (v0.43)
description: API reference for qiskit.quantum_info.Pauli in qiskit v0.43
...
<Class id="qiskit.quantum_info.Pauli" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/quantum_info/operators/symplectic/pauli.py" signature="Pauli(data=None, x=None, *, z=None, label=None)" modifiers="class">
  Bases: `BasePauli`
