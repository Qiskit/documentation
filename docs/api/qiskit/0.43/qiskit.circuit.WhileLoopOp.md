...
`WhileLoopOp(condition, body, label=None)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.43/qiskit/circuit/controlflow/while_loop.py "view source code")
...
<span id="qiskit-circuit-whileloopop-add-decomposition" />
...
<span id="qiskit-circuit-whileloopop-broadcast-arguments" />
...
<span id="qiskit-circuit-whileloopop-c-if" />

### c\_if

<span id="qiskit.circuit.WhileLoopOp.c_if" />

`WhileLoopOp.c_if(classical, val)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.43/qiskit/circuit/controlflow/while_loop.py "view source code")
...
<span id="qiskit-circuit-whileloopop-is-parameterized" />
...
<span id="qiskit-circuit-whileloopop-replace-blocks" />

### replace\_blocks

<span id="qiskit.circuit.WhileLoopOp.replace_blocks" />

`WhileLoopOp.replace_blocks(blocks)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.43/qiskit/circuit/controlflow/while_loop.py "view source code")
...
<span id="qiskit-circuit-whileloopop-reverse-ops" />
...
<span id="qiskit-circuit-whileloopop-soft-compare" />
...
<span id="qiskit-circuit-whileloopop-validate-parameter" />
