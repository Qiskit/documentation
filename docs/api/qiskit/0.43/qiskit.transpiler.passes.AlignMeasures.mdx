---
title: AlignMeasures (v0.43)
description: API reference for qiskit.transpiler.passes.AlignMeasures in qiskit v0.43
...
<Class id="qiskit.transpiler.passes.AlignMeasures" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/transpiler/passes/scheduling/alignments/align_measures.py" signature="AlignMeasures(*args, **kwargs)" modifiers="class">
