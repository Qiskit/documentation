...
*   **style** (*Dict\[str, Any] | None*) – Stylesheet options. This can be dictionary or preset stylesheet classes. See `IQXStandard`, `IQXSimple`, and `IQXDebugging` for details of preset stylesheets. See also the stylesheet section for details of configuration keys.

*   **time\_range** (*Tuple\[int, int] | None*) – Set horizontal axis limit.

*   **disable\_bits** (*List\[Bits] | None*) – List of qubits of classical bits not shown in the output image.

*   **show\_clbits** (*bool | None*) – A control property to show classical bits. Set True to show classical bits.

*   **show\_idle** (*bool | None*) – A control property to show idle timeline. Set True to show timeline without gates.

*   **show\_barriers** (*bool | None*) – A control property to show barrier instructions. Set True to show barrier instructions.

*   **show\_delays** (*bool | None*) – A control property to show delay instructions. Set True to show delay instructions.
...
*   **axis** (*Any | None*) – Arbitrary object passed to the plotter. If this object is provided, the plotters uses given axis instead of internally initializing a figure object. This object format depends on the plotter. See plotters section for details.

*   **filename** (*str | None*) – If provided the output image is dumped into a file under the filename.
...
![../\_images/qiskit-visualization-timeline\_drawer-1.png](/images/api/qiskit/0.43/qiskit-visualization-timeline_drawer-1.png)
...
![../\_images/qiskit-visualization-timeline\_drawer-2.png](/images/api/qiskit/0.43/qiskit-visualization-timeline_drawer-2.png)
...
![../\_images/qiskit-visualization-timeline\_drawer-3.png](/images/api/qiskit/0.43/qiskit-visualization-timeline_drawer-3.png)
