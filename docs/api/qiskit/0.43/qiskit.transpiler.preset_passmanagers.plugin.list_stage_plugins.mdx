---
title: list_stage_plugins (v0.43)
description: API reference for qiskit.transpiler.preset_passmanagers.plugin.list_stage_plugins in qiskit v0.43
...
<Function id="qiskit.transpiler.preset_passmanagers.plugin.list_stage_plugins" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/transpiler/preset_passmanagers/plugin.py" signature="list_stage_plugins(stage_name)">
