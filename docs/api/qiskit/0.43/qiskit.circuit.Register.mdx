...
<Class id="qiskit.circuit.Register" github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/circuit/register.py" signature="Register(size=None, name=None, bits=None)">
  Bases: `object`
