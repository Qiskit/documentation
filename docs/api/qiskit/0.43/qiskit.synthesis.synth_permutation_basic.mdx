...
<Function id="qiskit.synthesis.synth_permutation_basic" github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/synthesis/permutation/permutation_full.py" signature="synth_permutation_basic(pattern)">
