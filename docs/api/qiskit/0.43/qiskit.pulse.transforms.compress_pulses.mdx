...
<Function id="qiskit.pulse.transforms.compress_pulses" github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/pulse/transforms/canonicalization.py" signature="compress_pulses(schedules)">
