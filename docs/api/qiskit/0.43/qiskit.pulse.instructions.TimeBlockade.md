...
`TimeBlockade(duration, channel, name=None)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.43/qiskit/pulse/instructions/directives.py "view source code")
