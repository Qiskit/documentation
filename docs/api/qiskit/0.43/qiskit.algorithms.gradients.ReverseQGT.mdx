...
<Class id="qiskit.algorithms.gradients.ReverseQGT" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/algorithms/gradients/reverse_gradient/reverse_qgt.py" signature="ReverseQGT(phase_fix=True, derivative_type=DerivativeType.COMPLEX)">
