...
|                                                                                                                |                                                              |
| -------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------ |
| [`convert`](qiskit.opflow.gradients.CircuitGradient#convert "qiskit.opflow.gradients.CircuitGradient.convert") | **param operator**The operator we are taking the gradient of |
