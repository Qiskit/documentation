...
<Class id="qiskit.algorithms.optimizers.SteppableOptimizer" github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/algorithms/optimizers/steppable_optimizer.py" signature="SteppableOptimizer(maxiter=100)">
