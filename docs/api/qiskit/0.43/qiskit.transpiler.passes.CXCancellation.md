...
`CXCancellation(*args, **kwargs)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.43/qiskit/transpiler/passes/optimization/cx_cancellation.py "view source code")
...
`CXCancellation.run(dag)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.43/qiskit/transpiler/passes/optimization/cx_cancellation.py "view source code")
