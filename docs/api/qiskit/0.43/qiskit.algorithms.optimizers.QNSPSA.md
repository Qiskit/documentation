...
*   **target\_magnitude** (*float | None*) – The target magnitude for the first update step, defaults to $2\pi / 10$.
...
`static QNSPSA.get_fidelity(circuit, backend=None, expectation=None, *, sampler=None)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.43/qiskit/algorithms/optimizers/qnspsa.py "view source code")
...
*   **initial\_point** ([*numpy.ndarray*](https://numpy.org/doc/stable/reference/generated/numpy.ndarray.html#numpy.ndarray "(in NumPy v1.25)")*\[float]*) – Initial point.
