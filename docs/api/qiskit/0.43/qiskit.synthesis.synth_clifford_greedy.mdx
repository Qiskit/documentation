---
title: synth_clifford_greedy (v0.43)
description: API reference for qiskit.synthesis.synth_clifford_greedy in qiskit v0.43
...
<Function id="qiskit.synthesis.synth_clifford_greedy" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/synthesis/clifford/clifford_decompose_greedy.py" signature="synth_clifford_greedy(clifford)">
