...
<Function id="qiskit.synthesis.synth_clifford_greedy" github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/synthesis/clifford/clifford_decompose_greedy.py" signature="synth_clifford_greedy(clifford)">
