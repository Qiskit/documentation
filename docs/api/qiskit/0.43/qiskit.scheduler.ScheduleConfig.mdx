...
<Class id="qiskit.scheduler.ScheduleConfig" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/scheduler/config.py" signature="ScheduleConfig(inst_map, meas_map, dt)">
  Bases: `object`
