...
<Class id="qiskit.circuit.library.OR" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/circuit/library/boolean_logic/quantum_or.py" signature="OR(num_variable_qubits, flags=None, mcx_mode='noancilla')">
  ...
  ![../\_images/qiskit-circuit-library-OR-1.png](/images/api/qiskit/0.43/qiskit-circuit-library-OR-1.png)
  ...
  ![../\_images/qiskit-circuit-library-OR-2.png](/images/api/qiskit/0.43/qiskit-circuit-library-OR-2.png)
  ...
  *   **mcx\_mode** (*str*) – The mode to be used to implement the multi-controlled X gate.
  ...
  <Attribute id="qiskit.circuit.library.OR.instances" name="instances" attributeValue="= 124" />
