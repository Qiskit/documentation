---
title: ParameterVector (v0.43)
description: API reference for qiskit.circuit.ParameterVector in qiskit v0.43
...
<Class id="qiskit.circuit.ParameterVector" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/circuit/parametervector.py" signature="ParameterVector(name, length=0)" modifiers="class">
  Bases: `object`
