...
<Class id="qiskit.pulse.instructions.Reference" github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/pulse/instructions/reference.py" signature="Reference(name, *extra_keys)">
