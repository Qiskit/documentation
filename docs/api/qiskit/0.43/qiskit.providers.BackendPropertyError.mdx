...
<Class id="qiskit.providers.BackendPropertyError" name="BackendPropertyError" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/providers/exceptions.py" signature="BackendPropertyError(*message)">
