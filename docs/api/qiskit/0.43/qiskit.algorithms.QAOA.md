...
*   **gradient** ([*GradientBase*](qiskit.opflow.gradients.GradientBase "qiskit.opflow.gradients.GradientBase") *| Callable\[\[np.ndarray | list], list] | None*) – An optional gradient operator respectively a gradient function used for optimization.
