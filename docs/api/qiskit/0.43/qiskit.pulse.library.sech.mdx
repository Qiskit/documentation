---
title: sech (v0.43)
description: API reference for qiskit.pulse.library.sech in qiskit v0.43
...
<Function id="qiskit.pulse.library.sech" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/pulse/library/discrete.py" signature="sech(duration, amp, sigma, name=None, zero_ends=True)">
