---
title: BaseSamplerGradient (v0.43)
description: API reference for qiskit.algorithms.gradients.BaseSamplerGradient in qiskit v0.43
...
<Class id="qiskit.algorithms.gradients.BaseSamplerGradient" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/algorithms/gradients/base_sampler_gradient.py" signature="BaseSamplerGradient(sampler, options=None)" modifiers="class">
  Bases: `ABC`
