...
`AcquireChannel(*args, **kwargs)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.43/qiskit/pulse/channels.py "view source code")
...
<span id="qiskit-pulse-channels-acquirechannel-is-parameterized" />
