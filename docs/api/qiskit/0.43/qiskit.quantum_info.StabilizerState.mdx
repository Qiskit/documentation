---
title: StabilizerState (v0.43)
description: API reference for qiskit.quantum_info.StabilizerState in qiskit v0.43
...
<Class id="qiskit.quantum_info.StabilizerState" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/quantum_info/states/stabilizerstate.py" signature="StabilizerState(data, validate=True)" modifiers="class">
  Bases: `QuantumState`
  ...
  *   **validate** (*boolean*) – validate that the stabilizer state data is a valid Clifford.
  ...
  <Function id="qiskit.quantum_info.StabilizerState.equiv" signature="StabilizerState.equiv(other)">
