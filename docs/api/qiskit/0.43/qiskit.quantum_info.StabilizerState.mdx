...
<Class id="qiskit.quantum_info.StabilizerState" github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/quantum_info/states/stabilizerstate.py" signature="StabilizerState(data, validate=True)">
  Bases: `QuantumState`
