---
title: SPSAEstimatorGradient (v0.43)
description: API reference for qiskit.algorithms.gradients.SPSAEstimatorGradient in qiskit v0.43
...
<Class id="qiskit.algorithms.gradients.SPSAEstimatorGradient" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/algorithms/gradients/spsa_estimator_gradient.py" signature="SPSAEstimatorGradient(estimator, epsilon, batch_size=1, seed=None, options=None)" modifiers="class">
