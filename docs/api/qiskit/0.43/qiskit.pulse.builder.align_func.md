...
`align_func(duration, func)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.43/qiskit/pulse/builder.py "view source code")
...
![../\_images/qiskit-pulse-builder-align\_func-1.png](/images/api/qiskit/0.43/qiskit-pulse-builder-align_func-1.png)

**Parameters**

*   **duration** (*int |* [*ParameterExpression*](qiskit.circuit.ParameterExpression "qiskit.circuit.parameterexpression.ParameterExpression")) – Duration of context. This should be larger than the schedule duration.
