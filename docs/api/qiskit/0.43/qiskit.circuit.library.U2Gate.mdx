---
title: U2Gate (v0.43)
description: API reference for qiskit.circuit.library.U2Gate in qiskit v0.43
...
<Class id="qiskit.circuit.library.U2Gate" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/circuit/library/standard_gates/u2.py" signature="U2Gate(phi, lam, label=None)" modifiers="class">
