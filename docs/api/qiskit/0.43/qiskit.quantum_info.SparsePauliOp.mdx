...
<Class id="qiskit.quantum_info.SparsePauliOp" github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/quantum_info/operators/symplectic/sparse_pauli_op.py" signature="SparsePauliOp(data, coeffs=None, *, ignore_pauli_phase=False, copy=True)">
  ...
  **QiskitError** – If the input data or coeffs are invalid.
  ...
  <Function id="qiskit.quantum_info.SparsePauliOp.argsort" signature="SparsePauliOp.argsort(weight=False)">
  ...
  <Function id="qiskit.quantum_info.SparsePauliOp.assign_parameters" signature="SparsePauliOp.assign_parameters(parameters, inplace=False)">
  ...
  <Function id="qiskit.quantum_info.SparsePauliOp.equiv" signature="SparsePauliOp.equiv(other, atol=None)">
  ...
  <Function id="qiskit.quantum_info.SparsePauliOp.from_list" signature="static SparsePauliOp.from_list(obj, dtype=<class 'complex'>)">
  ...
  <Function id="qiskit.quantum_info.SparsePauliOp.from_operator" signature="static SparsePauliOp.from_operator(obj, atol=None, rtol=None)">
  ...
  <Function id="qiskit.quantum_info.SparsePauliOp.from_sparse_list" signature="static SparsePauliOp.from_sparse_list(obj, num_qubits, do_checks=True, dtype=<class 'complex'>)">
  ...
  <Function id="qiskit.quantum_info.SparsePauliOp.sort" signature="SparsePauliOp.sort(weight=False)">
  ...
  <Function id="qiskit.quantum_info.SparsePauliOp.sum" signature="static SparsePauliOp.sum(ops)">
