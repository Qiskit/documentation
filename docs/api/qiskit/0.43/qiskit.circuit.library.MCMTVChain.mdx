---
title: MCMTVChain (v0.43)
description: API reference for qiskit.circuit.library.MCMTVChain in qiskit v0.43
...
<Class id="qiskit.circuit.library.MCMTVChain" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/circuit/library/generalized_gates/mcmt.py" signature="MCMTVChain(gate, num_ctrl_qubits, num_target_qubits)" modifiers="class">
  ...
  **Expanded Circuit:**
  ...
  ![../\_images/qiskit-circuit-library-MCMTVChain-1.png](/docs/images/api/qiskit/0.43/qiskit-circuit-library-MCMTVChain-1.avif)
  ...
  *   **AttributeError** – If the number of controls or targets is 0.
  ...
  <Attribute id="qiskit.circuit.library.MCMTVChain.instances" attributeValue="154" />
