...
<Class id="qiskit.circuit.library.MCMTVChain" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/circuit/library/generalized_gates/mcmt.py" signature="MCMTVChain(gate, num_ctrl_qubits, num_target_qubits)">
  ...
  *   **AttributeError** – If the number of controls or targets is 0.
  ...
  <Attribute id="qiskit.circuit.library.MCMTVChain.instances" name="instances" attributeValue="154" />
