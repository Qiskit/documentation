...
<Function id="qiskit.circuit.library.rzx_yz" github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/circuit/library/templates/rzx/rzx_yz.py" signature="rzx_yz(theta=None)">
