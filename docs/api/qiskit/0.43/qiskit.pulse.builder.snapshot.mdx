...
<Function id="qiskit.pulse.builder.snapshot" name="snapshot" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/pulse/builder.py" signature="snapshot(label, snapshot_type='statevector')">
  Simulator snapshot.
