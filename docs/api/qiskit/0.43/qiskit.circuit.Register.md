...
`Register(size=None, name=None, bits=None)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.43/qiskit/circuit/register.py "view source code")
...
`Register.index(bit)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.43/qiskit/circuit/register.py "view source code")
