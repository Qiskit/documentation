---
title: DAGNode (v0.43)
description: API reference for qiskit.dagcircuit.DAGNode in qiskit v0.43
...
<Class id="qiskit.dagcircuit.DAGNode" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/dagcircuit/dagnode.py" signature="DAGNode(nid=-1)" modifiers="class">
  Bases: `object`
