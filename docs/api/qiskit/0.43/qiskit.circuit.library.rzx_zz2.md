...
<span id="qiskit-circuit-library-rzx-zz2" />

# qiskit.circuit.library.rzx\_zz2

<span id="qiskit.circuit.library.rzx_zz2" />

`rzx_zz2(theta=None)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.43/qiskit/circuit/library/templates/rzx/rzx_zz2.py "view source code")
