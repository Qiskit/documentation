---
title: SparseVectorStateFn (v0.43)
description: API reference for qiskit.opflow.state_fns.SparseVectorStateFn in qiskit v0.43
...
<Class id="qiskit.opflow.state_fns.SparseVectorStateFn" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/opflow/state_fns/sparse_vector_state_fn.py" signature="SparseVectorStateFn(*args, **kwargs)" modifiers="class">
