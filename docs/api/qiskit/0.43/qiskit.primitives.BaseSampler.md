...
`BaseSampler(*, options=None)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.43/qiskit/primitives/base/base_sampler.py "view source code")
...
`BaseSampler.run(circuits, parameter_values=None, **run_options)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.43/qiskit/primitives/base/base_sampler.py "view source code")
