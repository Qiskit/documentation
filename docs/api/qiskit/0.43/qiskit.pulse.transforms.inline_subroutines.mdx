...
<Function id="qiskit.pulse.transforms.inline_subroutines" github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/pulse/transforms/canonicalization.py" signature="inline_subroutines(program)">
