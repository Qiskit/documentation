...
<Class id="qiskit.providers.basicaer.QasmSimulatorPy" github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/providers/basicaer/qasm_simulator.py" signature="QasmSimulatorPy(configuration=None, provider=None, **fields)">
  ...
  **AttributeError** – if input field not a valid options
  ...
  <Function id="qiskit.providers.basicaer.QasmSimulatorPy.run" signature="QasmSimulatorPy.run(qobj, **backend_options)">
  ...
  <Function id="qiskit.providers.basicaer.QasmSimulatorPy.set_options" signature="QasmSimulatorPy.set_options(**fields)">
