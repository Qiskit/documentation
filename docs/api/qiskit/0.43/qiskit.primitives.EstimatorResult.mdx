---
title: EstimatorResult (v0.43)
description: API reference for qiskit.primitives.EstimatorResult in qiskit v0.43
...
<Class id="qiskit.primitives.EstimatorResult" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/primitives/base/estimator_result.py" signature="EstimatorResult(values, metadata)" modifiers="class">
