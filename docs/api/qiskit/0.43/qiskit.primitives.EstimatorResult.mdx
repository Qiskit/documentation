...
<Class id="qiskit.primitives.EstimatorResult" github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/primitives/base/estimator_result.py" signature="EstimatorResult(values, metadata)">
