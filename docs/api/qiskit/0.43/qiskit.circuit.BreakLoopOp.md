...
`BreakLoopOp(num_qubits, num_clbits, label=None)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.43/qiskit/circuit/controlflow/break_loop.py "view source code")
...
<span id="qiskit-circuit-breakloopop-add-decomposition" />
...
<span id="qiskit-circuit-breakloopop-broadcast-arguments" />
...
<span id="qiskit-circuit-breakloopop-c-if" />
...
<span id="qiskit-circuit-breakloopop-is-parameterized" />
...
<span id="qiskit-circuit-breakloopop-reverse-ops" />
...
<span id="qiskit-circuit-breakloopop-soft-compare" />
...
<span id="qiskit-circuit-breakloopop-validate-parameter" />
