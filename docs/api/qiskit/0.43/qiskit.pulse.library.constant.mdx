...
<Function id="qiskit.pulse.library.constant" github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/pulse/library/discrete.py" signature="constant(duration, amp, name=None)">
