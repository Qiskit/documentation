...
`ControlledGate(name, num_qubits, params, label=None, num_ctrl_qubits=1, definition=None, ctrl_state=None, base_gate=None)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.43/qiskit/circuit/controlledgate.py "view source code")
...
*   **ctrl\_state** (*Optional\[Union\[int, str]]*) – The control state in decimal or as a bitstring (e.g. ‘111’). If specified as a bitstring the length must equal num\_ctrl\_qubits, MSB on left. If None, use 2\*\*num\_ctrl\_qubits-1.
...
![../\_images/qiskit-circuit-ControlledGate-1.png](/images/api/qiskit/0.43/qiskit-circuit-ControlledGate-1.png)
...
![../\_images/qiskit-circuit-ControlledGate-2.png](/images/api/qiskit/0.43/qiskit-circuit-ControlledGate-2.png)
...
`ControlledGate.inverse()`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.43/qiskit/circuit/controlledgate.py "view source code")
