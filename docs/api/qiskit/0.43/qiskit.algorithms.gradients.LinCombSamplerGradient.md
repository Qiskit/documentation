...
`LinCombSamplerGradient(sampler, options=None)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.43/qiskit/algorithms/gradients/lin_comb_sampler_gradient.py "view source code")
...
<span id="qiskit-algorithms-gradients-lincombsamplergradient-update-default-options" />
