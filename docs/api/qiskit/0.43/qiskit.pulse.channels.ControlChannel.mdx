---
title: ControlChannel (v0.43)
description: API reference for qiskit.pulse.channels.ControlChannel in qiskit v0.43
...
<Class id="qiskit.pulse.channels.ControlChannel" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/pulse/channels.py" signature="ControlChannel(*args, **kwargs)" modifiers="class">
  Bases: `PulseChannel`
