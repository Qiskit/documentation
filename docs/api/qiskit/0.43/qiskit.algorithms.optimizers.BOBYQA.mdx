---
title: BOBYQA (v0.43)
description: API reference for qiskit.algorithms.optimizers.BOBYQA in qiskit v0.43
...
<Class id="qiskit.algorithms.optimizers.BOBYQA" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/algorithms/optimizers/bobyqa.py" signature="BOBYQA(maxiter=1000)" modifiers="class">
