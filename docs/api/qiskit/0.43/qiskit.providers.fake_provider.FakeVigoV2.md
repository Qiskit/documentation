...
`FakeVigoV2`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.43/qiskit/providers/fake_provider/backends/vigo/fake_vigo.py "view source code")
...
<span id="qiskit-providers-fake-provider-fakevigov2-acquire-channel" />

### acquire\_channel

<span id="qiskit.providers.fake_provider.FakeVigoV2.acquire_channel" />

`FakeVigoV2.acquire_channel(qubit)`
...
<span id="qiskit-providers-fake-provider-fakevigov2-control-channel" />
...
<span id="qiskit-providers-fake-provider-fakevigov2-drive-channel" />

### drive\_channel

<span id="qiskit.providers.fake_provider.FakeVigoV2.drive_channel" />

`FakeVigoV2.drive_channel(qubit)`
...
<span id="qiskit-providers-fake-provider-fakevigov2-measure-channel" />

### measure\_channel

<span id="qiskit.providers.fake_provider.FakeVigoV2.measure_channel" />

`FakeVigoV2.measure_channel(qubit)`
...
<span id="qiskit-providers-fake-provider-fakevigov2-qubit-properties" />

### qubit\_properties

<span id="qiskit.providers.fake_provider.FakeVigoV2.qubit_properties" />

`FakeVigoV2.qubit_properties(qubit)`
...
<span id="qiskit-providers-fake-provider-fakevigov2-run" />

### run

<span id="qiskit.providers.fake_provider.FakeVigoV2.run" />

`FakeVigoV2.run(run_input, **options)`
...
<span id="qiskit-providers-fake-provider-fakevigov2-set-options" />

### set\_options

<span id="qiskit.providers.fake_provider.FakeVigoV2.set_options" />

`FakeVigoV2.set_options(**fields)`
...
`= '/home/computertreker/git/qiskit/qiskit/.tox/docs/lib/python3.8/site-packages/qiskit/providers/fake_provider/backends/vigo'`
...
<span id="qiskit.providers.fake_provider.FakeVigoV2.meas_map" />
