...
<Function id="qiskit.circuit.library.templates.nct.template_nct_5a_2" name="template_nct_5a_2" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/circuit/library/templates/nct/template_nct_5a_2.py" signature="template_nct_5a_2()">
  **Returns**
