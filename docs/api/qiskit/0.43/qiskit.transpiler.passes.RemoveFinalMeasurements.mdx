---
title: RemoveFinalMeasurements (v0.43)
description: API reference for qiskit.transpiler.passes.RemoveFinalMeasurements in qiskit v0.43
...
<Class id="qiskit.transpiler.passes.RemoveFinalMeasurements" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/transpiler/passes/utils/remove_final_measurements.py" signature="RemoveFinalMeasurements(*args, **kwargs)" modifiers="class">
