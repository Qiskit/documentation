...
<Class id="qiskit.algorithms.gradients.LinCombSamplerGradient" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/algorithms/gradients/lin_comb_sampler_gradient.py" signature="LinCombSamplerGradient(sampler, options=None)">
  ...
  *   **options** ([*Options*](qiskit.providers.Options "qiskit.providers.Options") *| None*) – Primitive backend runtime options used for circuit execution. The order of priority is: options in `run` method > gradient’s default options > primitive’s default setting. Higher priority setting overrides lower priority setting
  ...
  <Function id="qiskit.algorithms.gradients.LinCombSamplerGradient.run" name="run" signature="LinCombSamplerGradient.run(circuits, parameter_values, parameters=None, **options)">
  ...
  <Function id="qiskit.algorithms.gradients.LinCombSamplerGradient.update_default_options" name="update_default_options" signature="LinCombSamplerGradient.update_default_options(**options)">
  ...
  <Attribute id="qiskit.algorithms.gradients.LinCombSamplerGradient.SUPPORTED_GATES" name="SUPPORTED_GATES" attributeValue="= ['rx', 'ry', 'rz', 'rzx', 'rzz', 'ryy', 'rxx', 'cx', 'cy', 'cz', 'ccx', 'swap', 'iswap', 'h', 't', 's', 'sdg', 'x', 'y', 'z']" />

  ### options

  <Attribute id="qiskit.algorithms.gradients.LinCombSamplerGradient.options" name="options">
