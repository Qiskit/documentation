...
<Class id="qiskit.opflow.state_fns.OperatorStateFn" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/opflow/state_fns/operator_state_fn.py" signature="OperatorStateFn(*args, **kwargs)">
  ...
  *   **is\_measurement** – Whether the StateFn is a measurement operator
  ...
  <Function id="qiskit.opflow.state_fns.OperatorStateFn.add" name="add" signature="OperatorStateFn.add(other)">
  ...
  <Function id="qiskit.opflow.state_fns.OperatorStateFn.adjoint" name="adjoint" signature="OperatorStateFn.adjoint()">
  ...
  <Function id="qiskit.opflow.state_fns.OperatorStateFn.eval" name="eval" signature="OperatorStateFn.eval(front=None)">
  ...
  <Function id="qiskit.opflow.state_fns.OperatorStateFn.permute" name="permute" signature="OperatorStateFn.permute(permutation)">
  ...
  <Function id="qiskit.opflow.state_fns.OperatorStateFn.primitive_strings" name="primitive_strings" signature="OperatorStateFn.primitive_strings()">
  ...
  <Function id="qiskit.opflow.state_fns.OperatorStateFn.sample" name="sample" signature="OperatorStateFn.sample(shots=1024, massive=False, reverse_endianness=False)">
  ...
  <Function id="qiskit.opflow.state_fns.OperatorStateFn.tensor" name="tensor" signature="OperatorStateFn.tensor(other)">
  ...
  <Function id="qiskit.opflow.state_fns.OperatorStateFn.to_circuit_op" name="to_circuit_op" signature="OperatorStateFn.to_circuit_op()">
  ...
  <Function id="qiskit.opflow.state_fns.OperatorStateFn.to_density_matrix" name="to_density_matrix" signature="OperatorStateFn.to_density_matrix(massive=False)">
  ...
  <Function id="qiskit.opflow.state_fns.OperatorStateFn.to_matrix" name="to_matrix" signature="OperatorStateFn.to_matrix(massive=False)">
  ...
  <Function id="qiskit.opflow.state_fns.OperatorStateFn.to_matrix_op" name="to_matrix_op" signature="OperatorStateFn.to_matrix_op(massive=False)">
  ...
  <Attribute id="qiskit.opflow.state_fns.OperatorStateFn.INDENTATION" name="INDENTATION" attributeValue="'  '" />

  ### coeff

  <Attribute id="qiskit.opflow.state_fns.OperatorStateFn.coeff" name="coeff">
    A coefficient by which the state function is multiplied.
  </Attribute>

  ### instance\_id

  <Attribute id="qiskit.opflow.state_fns.OperatorStateFn.instance_id" name="instance_id">
    Return the unique instance id.
  </Attribute>

  ### is\_measurement

  <Attribute id="qiskit.opflow.state_fns.OperatorStateFn.is_measurement" name="is_measurement">
    Whether the StateFn object is a measurement Operator.
  </Attribute>

  ### num\_qubits

  <Attribute id="qiskit.opflow.state_fns.OperatorStateFn.num_qubits" name="num_qubits" />

  ### parameters

  <Attribute id="qiskit.opflow.state_fns.OperatorStateFn.parameters" name="parameters" />

  ### primitive

  <Attribute id="qiskit.opflow.state_fns.OperatorStateFn.primitive" name="primitive" attributeTypeHint="OperatorBase">
    The primitive which defines the behavior of the underlying State function.
  </Attribute>

  ### settings

  <Attribute id="qiskit.opflow.state_fns.OperatorStateFn.settings" name="settings">
    Return settings.
  </Attribute>
</Class>
