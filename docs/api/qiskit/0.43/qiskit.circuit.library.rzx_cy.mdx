...
<Function id="qiskit.circuit.library.rzx_cy" github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/circuit/library/templates/rzx/rzx_cy.py" signature="rzx_cy(theta=None)">
