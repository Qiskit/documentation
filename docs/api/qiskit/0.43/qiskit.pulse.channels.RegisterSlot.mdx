---
title: RegisterSlot (v0.43)
description: API reference for qiskit.pulse.channels.RegisterSlot in qiskit v0.43
...
<Class id="qiskit.pulse.channels.RegisterSlot" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/pulse/channels.py" signature="RegisterSlot(*args, **kwargs)" modifiers="class">
