...
<Class id="qiskit.algorithms.optimizers.GradientDescentState" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/algorithms/optimizers/gradient_descent.py" signature="GradientDescentState(x, fun, jac, nfev, njev, nit, stepsize, learning_rate)">
