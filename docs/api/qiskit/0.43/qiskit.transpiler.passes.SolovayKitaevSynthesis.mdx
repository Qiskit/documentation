---
title: SolovayKitaevSynthesis (v0.43)
description: API reference for qiskit.transpiler.passes.SolovayKitaevSynthesis in qiskit v0.43
...
<Class id="qiskit.transpiler.passes.SolovayKitaevSynthesis" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/transpiler/passes/synthesis/solovay_kitaev_synthesis.py" signature="SolovayKitaevSynthesis" modifiers="class">
