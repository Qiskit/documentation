...
<Class id="qiskit.transpiler.passes.SolovayKitaevSynthesis" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/transpiler/passes/synthesis/solovay_kitaev_synthesis.py" signature="SolovayKitaevSynthesis">
  ...
  **recursion\_degree (int):**
  ...
  <Function id="qiskit.transpiler.passes.SolovayKitaevSynthesis.run" name="run" signature="SolovayKitaevSynthesis.run(unitary, **options)">
