...
<Class id="qiskit.transpiler.synthesis.aqc.ApproximatingObjective" github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/transpiler/synthesis/aqc/approximate.py" signature="ApproximatingObjective">
  Bases: `ABC`
