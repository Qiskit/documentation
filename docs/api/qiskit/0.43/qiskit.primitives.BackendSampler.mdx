...
<Class id="qiskit.primitives.BackendSampler" github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/primitives/backend_sampler.py" signature="BackendSampler(backend, options=None, bound_pass_manager=None, skip_transpilation=False)">
