...
<Class id="qiskit.circuit.library.QuantumVolume" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/circuit/library/quantum_volume.py" signature="QuantumVolume(num_qubits, depth=None, seed=None, classical_permutation=True)" modifiers="class">
  ...
  **Reference Circuit:**
  ...
  ![../\_images/qiskit-circuit-library-QuantumVolume-1.png](/images/api/qiskit/0.43/qiskit-circuit-library-QuantumVolume-1.avif)

  **Expanded Circuit:**

  ![../\_images/qiskit-circuit-library-QuantumVolume-2.png](/images/api/qiskit/0.43/qiskit-circuit-library-QuantumVolume-2.avif)
