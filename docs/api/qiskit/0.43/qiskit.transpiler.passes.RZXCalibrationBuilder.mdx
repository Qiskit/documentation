...
<Class id="qiskit.transpiler.passes.RZXCalibrationBuilder" github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/transpiler/passes/calibration/rzx_builder.py" signature="RZXCalibrationBuilder(*args, **kwargs)">
