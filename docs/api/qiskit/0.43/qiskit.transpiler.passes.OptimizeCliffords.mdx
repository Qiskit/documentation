---
title: OptimizeCliffords (v0.43)
description: API reference for qiskit.transpiler.passes.OptimizeCliffords in qiskit v0.43
...
<Class id="qiskit.transpiler.passes.OptimizeCliffords" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/transpiler/passes/optimization/optimize_cliffords.py" signature="OptimizeCliffords(*args, **kwargs)" modifiers="class">
