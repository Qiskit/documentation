---
title: DictToCircuitSum (v0.43)
description: API reference for qiskit.opflow.converters.DictToCircuitSum in qiskit v0.43
...
<Class id="qiskit.opflow.converters.DictToCircuitSum" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/opflow/converters/dict_to_circuit_sum.py" signature="DictToCircuitSum(traverse=True, convert_dicts=True, convert_vectors=True)" modifiers="class">
