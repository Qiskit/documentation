...
<span id="qiskit-quantum-info-random-clifford" />

# qiskit.quantum\_info.random\_clifford

<span id="qiskit.quantum_info.random_clifford" />

`random_clifford(num_qubits, seed=None)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.43/qiskit/quantum_info/operators/symplectic/random.py "view source code")
