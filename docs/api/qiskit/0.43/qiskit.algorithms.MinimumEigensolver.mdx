...
<Class id="qiskit.algorithms.MinimumEigensolver" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/algorithms/minimum_eigen_solvers/minimum_eigen_solver.py" signature="MinimumEigensolver">
  Bases: `ABC`
  ...
  <span id="qiskit-algorithms-minimumeigensolver-compute-minimum-eigenvalue" />

  ### compute\_minimum\_eigenvalue

  <Function id="qiskit.algorithms.MinimumEigensolver.compute_minimum_eigenvalue" name="compute_minimum_eigenvalue" signature="abstract MinimumEigensolver.compute_minimum_eigenvalue(operator, aux_operators=None)">
  ...
  <span id="qiskit-algorithms-minimumeigensolver-supports-aux-operators" />

  ### supports\_aux\_operators

  <Function id="qiskit.algorithms.MinimumEigensolver.supports_aux_operators" name="supports_aux_operators" signature="classmethod MinimumEigensolver.supports_aux_operators()">
