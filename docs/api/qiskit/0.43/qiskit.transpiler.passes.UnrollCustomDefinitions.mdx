...
<Class id="qiskit.transpiler.passes.UnrollCustomDefinitions" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/transpiler/passes/basis/unroll_custom_definitions.py" signature="UnrollCustomDefinitions(*args, **kwargs)">
