---
title: AncillaQubit (v0.43)
description: API reference for qiskit.circuit.AncillaQubit in qiskit v0.43
...
<Class id="qiskit.circuit.AncillaQubit" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/circuit/quantumregister.py" signature="AncillaQubit(register=None, index=None)" modifiers="class">
