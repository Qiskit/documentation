...
<Function id="qiskit.converters.circuit_to_dag" name="circuit_to_dag" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/converters/circuit_to_dag.py" signature="circuit_to_dag(circuit, copy_operations=True)">
