...
<Class id="qiskit.opflow.primitive_ops.Z2Symmetries" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/opflow/primitive_ops/tapered_pauli_sum_op.py" signature="Z2Symmetries(symmetries, sq_paulis, sq_list, tapering_values=None, tol=1e-14)">
  Bases: `object`
  ...
  **Raises**
  ...
  <Function id="qiskit.opflow.primitive_ops.Z2Symmetries.consistent_tapering" name="consistent_tapering" signature="Z2Symmetries.consistent_tapering(operator)">
  ...
  <Function id="qiskit.opflow.primitive_ops.Z2Symmetries.convert_clifford" name="convert_clifford" signature="Z2Symmetries.convert_clifford(operator)">
  ...
  <Function id="qiskit.opflow.primitive_ops.Z2Symmetries.copy" name="copy" signature="Z2Symmetries.copy()">
  ...
  <Function id="qiskit.opflow.primitive_ops.Z2Symmetries.find_Z2_symmetries" name="find_Z2_symmetries" signature="classmethod Z2Symmetries.find_Z2_symmetries(operator)">
  ...
  <Function id="qiskit.opflow.primitive_ops.Z2Symmetries.is_empty" name="is_empty" signature="Z2Symmetries.is_empty()">
  ...
  <Function id="qiskit.opflow.primitive_ops.Z2Symmetries.taper" name="taper" signature="Z2Symmetries.taper(operator)">
  ...
  <Function id="qiskit.opflow.primitive_ops.Z2Symmetries.taper_clifford" name="taper_clifford" signature="Z2Symmetries.taper_clifford(operator)">
  ...
  <Attribute id="qiskit.opflow.primitive_ops.Z2Symmetries.cliffords" name="cliffords">
  ...
  <Attribute id="qiskit.opflow.primitive_ops.Z2Symmetries.settings" name="settings">
    Return operator settings.
  </Attribute>

  ### sq\_list

  <Attribute id="qiskit.opflow.primitive_ops.Z2Symmetries.sq_list" name="sq_list">
    returns sq list
  </Attribute>

  ### sq\_paulis

  <Attribute id="qiskit.opflow.primitive_ops.Z2Symmetries.sq_paulis" name="sq_paulis">
    returns sq paulis
  </Attribute>

  ### symmetries

  <Attribute id="qiskit.opflow.primitive_ops.Z2Symmetries.symmetries" name="symmetries">
    return symmetries
  </Attribute>

  ### tapering\_values

  <Attribute id="qiskit.opflow.primitive_ops.Z2Symmetries.tapering_values" name="tapering_values">
    returns tapering values
  </Attribute>

  ### tol

  <Attribute id="qiskit.opflow.primitive_ops.Z2Symmetries.tol" name="tol">
