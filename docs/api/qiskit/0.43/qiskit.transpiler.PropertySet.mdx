---
title: PropertySet (v0.43)
description: API reference for qiskit.transpiler.PropertySet in qiskit v0.43
...
<Class id="qiskit.transpiler.PropertySet" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/transpiler/propertyset.py" signature="PropertySet" modifiers="class">
  Bases: `dict`
