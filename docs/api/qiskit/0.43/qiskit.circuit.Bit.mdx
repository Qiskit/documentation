...
<Class id="qiskit.circuit.Bit" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/circuit/bit.py" signature="Bit(register=None, index=None)">
  Bases: `object`
