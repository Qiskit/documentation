...
<Class id="qiskit.algorithms.AlgorithmError" github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/algorithms/exceptions.py" signature="AlgorithmError(*message)">
