...
<Class id="qiskit.transpiler.passes.EnlargeWithAncilla" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/transpiler/passes/layout/enlarge_with_ancilla.py" signature="EnlargeWithAncilla(*args, **kwargs)">
  ...
  <Function id="qiskit.transpiler.passes.EnlargeWithAncilla.name" name="name" signature="EnlargeWithAncilla.name()">
  ...
  <Function id="qiskit.transpiler.passes.EnlargeWithAncilla.run" name="run" signature="EnlargeWithAncilla.run(dag)">
  ...
  <Attribute id="qiskit.transpiler.passes.EnlargeWithAncilla.is_analysis_pass" name="is_analysis_pass">
  ...
  <Attribute id="qiskit.transpiler.passes.EnlargeWithAncilla.is_transformation_pass" name="is_transformation_pass">
