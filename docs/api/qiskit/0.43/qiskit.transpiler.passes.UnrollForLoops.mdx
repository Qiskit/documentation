...
<Class id="qiskit.transpiler.passes.UnrollForLoops" github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/transpiler/passes/utils/unroll_forloops.py" signature="UnrollForLoops(*args, **kwargs)">
