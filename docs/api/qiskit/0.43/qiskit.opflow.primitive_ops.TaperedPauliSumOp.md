...
`TaperedPauliSumOp(*args, **kwargs)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.43/qiskit/opflow/primitive_ops/tapered_pauli_sum_op.py "view source code")
...
<span id="qiskit-opflow-primitive-ops-taperedpaulisumop-assign-parameters" />

### assign\_parameters

<span id="qiskit.opflow.primitive_ops.TaperedPauliSumOp.assign_parameters" />

`TaperedPauliSumOp.assign_parameters(param_dict)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.43/qiskit/opflow/primitive_ops/tapered_pauli_sum_op.py "view source code")
