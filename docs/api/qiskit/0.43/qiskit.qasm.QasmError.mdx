...
<Class id="qiskit.qasm.QasmError" name="QasmError" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/qasm/exceptions.py" signature="QasmError(*msg)">
