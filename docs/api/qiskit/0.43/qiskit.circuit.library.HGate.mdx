---
title: HGate (v0.43)
description: API reference for qiskit.circuit.library.HGate in qiskit v0.43
...
<Class id="qiskit.circuit.library.HGate" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/circuit/library/standard_gates/h.py" signature="HGate(label=None)" modifiers="class">
