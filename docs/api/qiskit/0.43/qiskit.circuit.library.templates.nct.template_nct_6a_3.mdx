...
<Function id="qiskit.circuit.library.templates.nct.template_nct_6a_3" name="template_nct_6a_3" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/circuit/library/templates/nct/template_nct_6a_3.py" signature="template_nct_6a_3()">
  **Returns**
