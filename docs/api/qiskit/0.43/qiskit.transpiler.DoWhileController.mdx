...
<Class id="qiskit.transpiler.DoWhileController" github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/transpiler/runningpassmanager.py" signature="DoWhileController(passes, options=None, do_while=None, **partial_controller)">
  ...
  <Function id="qiskit.transpiler.DoWhileController.add_flow_controller" signature="classmethod DoWhileController.add_flow_controller(name, controller)">
  ...
  <Function id="qiskit.transpiler.DoWhileController.controller_factory" signature="classmethod DoWhileController.controller_factory(passes, options, **partial_controller)">
  ...
  <Function id="qiskit.transpiler.DoWhileController.remove_flow_controller" signature="classmethod DoWhileController.remove_flow_controller(name)">
