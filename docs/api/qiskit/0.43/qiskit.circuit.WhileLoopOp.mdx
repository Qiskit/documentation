---
title: WhileLoopOp (v0.43)
description: API reference for qiskit.circuit.WhileLoopOp in qiskit v0.43
...
<Class id="qiskit.circuit.WhileLoopOp" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/circuit/controlflow/while_loop.py" signature="WhileLoopOp(condition, body, label=None)" modifiers="class">
