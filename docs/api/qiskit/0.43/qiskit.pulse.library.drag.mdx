...
<Function id="qiskit.pulse.library.drag" github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/pulse/library/discrete.py" signature="drag(duration, amp, sigma, beta, name=None, zero_ends=True)">
