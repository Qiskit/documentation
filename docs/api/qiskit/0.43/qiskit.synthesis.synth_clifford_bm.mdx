...
<Function id="qiskit.synthesis.synth_clifford_bm" name="synth_clifford_bm" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/synthesis/clifford/clifford_decompose_bm.py" signature="synth_clifford_bm(clifford)">
