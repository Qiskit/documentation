---
title: CRXGate (v0.43)
description: API reference for qiskit.circuit.library.CRXGate in qiskit v0.43
...
<Class id="qiskit.circuit.library.CRXGate" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/circuit/library/standard_gates/rx.py" signature="CRXGate(theta, label=None, ctrl_state=None)" modifiers="class">
