...
`SPSAEstimatorGradient(estimator, epsilon, batch_size=1, seed=None, options=None)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.43/qiskit/algorithms/gradients/spsa_estimator_gradient.py "view source code")
...
<span id="qiskit-algorithms-gradients-spsaestimatorgradient-update-default-options" />
...
<span id="qiskit.algorithms.gradients.SPSAEstimatorGradient.derivative_type" />
