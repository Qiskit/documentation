...
<span id="qiskit-providers-models-qasmbackendconfiguration-from-dict" />

### from\_dict

<span id="qiskit.providers.models.QasmBackendConfiguration.from_dict" />

`classmethod QasmBackendConfiguration.from_dict(data)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.43/qiskit/providers/models/backendconfiguration.py "view source code")
...
<span id="qiskit-providers-models-qasmbackendconfiguration-to-dict" />

### to\_dict

<span id="qiskit.providers.models.QasmBackendConfiguration.to_dict" />

`QasmBackendConfiguration.to_dict()`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.43/qiskit/providers/models/backendconfiguration.py "view source code")
