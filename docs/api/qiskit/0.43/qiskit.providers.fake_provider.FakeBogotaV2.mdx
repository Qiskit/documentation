---
title: FakeBogotaV2 (v0.43)
description: API reference for qiskit.providers.fake_provider.FakeBogotaV2 in qiskit v0.43
...
<Class id="qiskit.providers.fake_provider.FakeBogotaV2" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/providers/fake_provider/backends/bogota/fake_bogota.py" signature="FakeBogotaV2" modifiers="class">
  Bases: `FakeBackendV2`
  ...
  <Attribute id="qiskit.providers.fake_provider.FakeBogotaV2.dirname" attributeValue="'/home/computertreker/git/qiskit/qiskit/.tox/docs/lib/python3.8/site-packages/qiskit/providers/fake_provider/backends/bogota'" />
