...
<Class id="qiskit.synthesis.MatrixExponential" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/synthesis/evolution/matrix_synthesis.py" signature="MatrixExponential">
