---
title: MatrixExponential (v0.43)
description: API reference for qiskit.synthesis.MatrixExponential in qiskit v0.43
...
<Class id="qiskit.synthesis.MatrixExponential" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/synthesis/evolution/matrix_synthesis.py" signature="MatrixExponential" modifiers="class">
