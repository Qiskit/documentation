...
<Class id="qiskit.qobj.GateCalibration" github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/qobj/qasm_qobj.py" signature="GateCalibration(name, qubits, params, instructions)">
  Bases: `object`
