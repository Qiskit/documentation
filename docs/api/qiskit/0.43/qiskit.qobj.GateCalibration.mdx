...
<Class id="qiskit.qobj.GateCalibration" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/qobj/qasm_qobj.py" signature="GateCalibration(name, qubits, params, instructions)">
  Bases: `object`
  ...
  *   **instructions** (*list(*[*PulseQobjInstruction*](qiskit.qobj.PulseQobjInstruction "qiskit.qobj.PulseQobjInstruction")*)*) – The gate implementation.
  ...
  <Function id="qiskit.qobj.GateCalibration.from_dict" name="from_dict" signature="classmethod GateCalibration.from_dict(data)">
  ...
  <Function id="qiskit.qobj.GateCalibration.to_dict" name="to_dict" signature="GateCalibration.to_dict()">
