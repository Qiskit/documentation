...
<Function id="qiskit.quantum_info.double_commutator" name="double_commutator" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/quantum_info/operators/utils/double_commutator.py" signature="double_commutator(a, b, c, *, commutator=True)">
