...
<Class id="qiskit.transpiler.passes.Layout2qDistance" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/transpiler/passes/layout/layout_2q_distance.py" signature="Layout2qDistance(*args, **kwargs)">
  ...
  *   **property\_name** (*str*) – The property name to save the score. Default: layout\_score
  ...
  <Function id="qiskit.transpiler.passes.Layout2qDistance.name" name="name" signature="Layout2qDistance.name()">
  ...
  <Function id="qiskit.transpiler.passes.Layout2qDistance.run" name="run" signature="Layout2qDistance.run(dag)">
  ...
  <Attribute id="qiskit.transpiler.passes.Layout2qDistance.is_analysis_pass" name="is_analysis_pass">
  ...
  <Attribute id="qiskit.transpiler.passes.Layout2qDistance.is_transformation_pass" name="is_transformation_pass">
