...
<Function id="qiskit.pulse.library.sin" name="sin" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/pulse/library/discrete.py" signature="sin(duration, amp, freq=None, phase=0, name=None)">
