---
title: AcquireChannel (v0.43)
description: API reference for qiskit.pulse.channels.AcquireChannel in qiskit v0.43
...
<Class id="qiskit.pulse.channels.AcquireChannel" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/pulse/channels.py" signature="AcquireChannel(*args, **kwargs)" modifiers="class">
