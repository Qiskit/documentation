...
<Class id="qiskit.algorithms.time_evolvers.variational.RealMcLachlanPrinciple" github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/algorithms/time_evolvers/variational/variational_principles/real_mc_lachlan_principle.py" signature="RealMcLachlanPrinciple(qgt=None, gradient=None)">
