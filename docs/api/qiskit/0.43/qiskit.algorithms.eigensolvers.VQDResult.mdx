---
title: VQDResult (v0.43)
description: API reference for qiskit.algorithms.eigensolvers.VQDResult in qiskit v0.43
...
<Class id="qiskit.algorithms.eigensolvers.VQDResult" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/algorithms/eigensolvers/vqd.py" signature="VQDResult" modifiers="class">
