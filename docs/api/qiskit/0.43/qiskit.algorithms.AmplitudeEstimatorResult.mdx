---
title: AmplitudeEstimatorResult (v0.43)
description: API reference for qiskit.algorithms.AmplitudeEstimatorResult in qiskit v0.43
...
<Class id="qiskit.algorithms.AmplitudeEstimatorResult" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/algorithms/amplitude_estimators/amplitude_estimator.py" signature="AmplitudeEstimatorResult" modifiers="class">
