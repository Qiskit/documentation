...
<Class id="qiskit.circuit.library.IQP" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/circuit/library/iqp.py" signature="IQP(interactions)">
  ...
  **CircuitError** – if the inputs is not as symmetric matrix.
  ...
  <Attribute id="qiskit.circuit.library.IQP.instances" name="instances" attributeValue="= 132" />
