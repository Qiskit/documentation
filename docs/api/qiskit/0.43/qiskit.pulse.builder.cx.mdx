---
title: cx (v0.43)
description: API reference for qiskit.pulse.builder.cx in qiskit v0.43
...
<Function id="qiskit.pulse.builder.cx" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/pulse/builder.py" signature="cx(control, target)">
