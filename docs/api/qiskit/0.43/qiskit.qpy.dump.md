...
`dump(programs, file_obj, metadata_serializer=None)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.43/qiskit/qpy/interface.py "view source code")
