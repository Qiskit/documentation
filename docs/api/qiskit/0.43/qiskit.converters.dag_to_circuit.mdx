---
title: dag_to_circuit (v0.43)
description: API reference for qiskit.converters.dag_to_circuit in qiskit v0.43
...
<Function id="qiskit.converters.dag_to_circuit" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/converters/dag_to_circuit.py" signature="dag_to_circuit(dag, copy_operations=True)">
  ...
  **Example**
  ...
  ![../\_images/qiskit-converters-dag\_to\_circuit-1.png](/docs/images/api/qiskit/0.43/qiskit-converters-dag_to_circuit-1.avif)
</Function>
