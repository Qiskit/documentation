...
`GRY(num_qubits, theta)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.43/qiskit/circuit/library/generalized_gates/gr.py "view source code")
...
![../\_images/qiskit-circuit-library-GRY-1.png](/images/api/qiskit/0.43/qiskit-circuit-library-GRY-1.png)
