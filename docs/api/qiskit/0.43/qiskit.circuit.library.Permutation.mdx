...
<Class id="qiskit.circuit.library.Permutation" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/circuit/library/generalized_gates/permutation.py" signature="Permutation(num_qubits, pattern=None, seed=None)" modifiers="class">
  ...
  **Reference Circuit:**
  ...
  ![../\_images/qiskit-circuit-library-Permutation-1.png](/images/api/qiskit/0.43/qiskit-circuit-library-Permutation-1.avif)

  **Expanded Circuit:**

  ![../\_images/qiskit-circuit-library-Permutation-2.png](/images/api/qiskit/0.43/qiskit-circuit-library-Permutation-2.avif)
