...
<Function id="qiskit.synthesis.synth_clifford_ag" name="synth_clifford_ag" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/synthesis/clifford/clifford_decompose_ag.py" signature="synth_clifford_ag(clifford)">
