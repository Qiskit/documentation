...
<Class id="qiskit.transpiler.preset_passmanagers.plugin.PassManagerStagePlugin" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/transpiler/preset_passmanagers/plugin.py" signature="PassManagerStagePlugin">
  Bases: `ABC`
