---
title: CircuitInstruction (v0.43)
description: API reference for qiskit.circuit.CircuitInstruction in qiskit v0.43
...
<Class id="qiskit.circuit.CircuitInstruction" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/circuit/quantumcircuitdata.py" signature="CircuitInstruction(operation, qubits=(), clbits=())" modifiers="class">
  Bases: `object`
