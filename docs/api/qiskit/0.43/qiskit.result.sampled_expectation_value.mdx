---
title: sampled_expectation_value (v0.43)
description: API reference for qiskit.result.sampled_expectation_value in qiskit v0.43
...
<Function id="qiskit.result.sampled_expectation_value" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/result/sampled_expval.py" signature="sampled_expectation_value(dist, oper)">
