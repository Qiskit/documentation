...
<Class id="qiskit.qasm3.QASM3ExporterError" github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/qasm3/exceptions.py" signature="QASM3ExporterError(*message)">
...
<Class id="qiskit.qasm3.QASM3ImporterError" github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/qasm3/exceptions.py" signature="QASM3ImporterError(*message)">
