---
title: passmanager_stage_plugins (v0.43)
description: API reference for qiskit.transpiler.preset_passmanagers.plugin.passmanager_stage_plugins in qiskit v0.43
