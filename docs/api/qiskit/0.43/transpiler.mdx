...
![../\_images/transpiling\_core\_steps.png](/images/api/qiskit/0.43/transpiling_core_steps.avif)
...
![../\_images/transpiler-4.png](/images/api/qiskit/0.43/transpiler-4.avif)
...
![../\_images/transpiler-5.png](/images/api/qiskit/0.43/transpiler-5.avif)
...
2.  A Toffoli, or controlled-controlled-not gate (`ccx`), is a three-qubit gate. Given that our basis gate set includes only single- and two-qubit gates, it is obvious that this gate must be decomposed. This decomposition is quite costly:
    ...
    ![../\_images/transpiler-6.png](/images/api/qiskit/0.43/transpiler-6.avif)
...
![../\_images/mapping.png](/images/api/qiskit/0.43/mapping.avif)
...
![../\_images/transpiler-7.png](/images/api/qiskit/0.43/transpiler-7.avif)
...
*   **Layout Using Optimization Level 0**
    ...
    > ```
    >
    > ![../\_images/transpiler-8.png](/images/api/qiskit/0.43/transpiler-8.avif)
...
*   **Layout Using Optimization Level 3**
    ...
    > ```
    >
    > ![../\_images/transpiler-9.png](/images/api/qiskit/0.43/transpiler-9.avif)
...
![../\_images/transpiler-10.png](/images/api/qiskit/0.43/transpiler-10.avif)
...
![../\_images/transpiler-11.png](/images/api/qiskit/0.43/transpiler-11.avif)
...
![../\_images/transpiler-12.png](/images/api/qiskit/0.43/transpiler-12.avif)
...
![../\_images/transpiler-13.png](/images/api/qiskit/0.43/transpiler-13.avif)
...
![../\_images/transpiler-14.png](/images/api/qiskit/0.43/transpiler-14.avif)
...
![../\_images/transpiler-15.png](/images/api/qiskit/0.43/transpiler-15.avif)
...
![../\_images/transpiler-16.png](/images/api/qiskit/0.43/transpiler-16.avif)
...
![../\_images/transpiler-17.png](/images/api/qiskit/0.43/transpiler-17.avif)
