---
title: FakeProviderForBackendV2 (v0.43)
description: API reference for qiskit.providers.fake_provider.FakeProviderForBackendV2 in qiskit v0.43
...
<Class id="qiskit.providers.fake_provider.FakeProviderForBackendV2" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/providers/fake_provider/fake_provider.py" signature="FakeProviderForBackendV2" modifiers="class">
