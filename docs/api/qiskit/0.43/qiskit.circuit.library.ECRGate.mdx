...
<Class id="qiskit.circuit.library.ECRGate" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/circuit/library/standard_gates/ecr.py" signature="ECRGate">
...
$$
  ...
  <Function id="qiskit.circuit.library.ECRGate.inverse" name="inverse" signature="ECRGate.inverse()">
