...
`C3SXGate(label=None, ctrl_state=None)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.43/qiskit/circuit/library/standard_gates/x.py "view source code")
...
`C3SXGate.qasm()`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.43/qiskit/circuit/library/standard_gates/x.py "view source code")
