---
title: Depth (v0.43)
description: API reference for qiskit.transpiler.passes.Depth in qiskit v0.43
...
<Class id="qiskit.transpiler.passes.Depth" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/transpiler/passes/analysis/depth.py" signature="Depth(*args, **kwargs)" modifiers="class">
