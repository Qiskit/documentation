---
title: triangle (v0.43)
description: API reference for qiskit.pulse.library.triangle in qiskit v0.43
...
<Function id="qiskit.pulse.library.triangle" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/pulse/library/discrete.py" signature="triangle(duration, amp, freq=None, phase=0, name=None)">
...
$$
  ...
  **Example**
  ...
  ![../\_images/qiskit-pulse-library-triangle-1.png](/docs/images/api/qiskit/0.43/qiskit-pulse-library-triangle-1.avif)
</Function>
