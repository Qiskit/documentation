---
title: SabreSwap (v0.43)
description: API reference for qiskit.transpiler.passes.SabreSwap in qiskit v0.43
...
<Class id="qiskit.transpiler.passes.SabreSwap" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/transpiler/passes/routing/sabre_swap.py" signature="SabreSwap(*args, **kwargs)" modifiers="class">
