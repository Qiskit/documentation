...
<Class id="qiskit.transpiler.passes.SabreSwap" github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/transpiler/passes/routing/sabre_swap.py" signature="SabreSwap(*args, **kwargs)">
