...
`random_circuit(num_qubits, depth, max_operands=4, measure=False, conditional=False, reset=False, seed=None)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.43/qiskit/circuit/random/utils.py "view source code")
...
![../\_images/qiskit-circuit-random-random\_circuit-1.png](/images/api/qiskit/0.43/qiskit-circuit-random-random_circuit-1.png)
