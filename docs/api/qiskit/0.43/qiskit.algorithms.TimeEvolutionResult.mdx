...
<Class id="qiskit.algorithms.TimeEvolutionResult" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/algorithms/time_evolvers/time_evolution_result.py" signature="TimeEvolutionResult(evolved_state, aux_ops_evaluated=None, observables=None, times=None)">
  ...
  <Attribute id="qiskit.algorithms.TimeEvolutionResult.evolved_state" name="evolved_state">
  ...
  <Attribute id="qiskit.algorithms.TimeEvolutionResult.aux_ops_evaluated" name="aux_ops_evaluated">
  ...
  <Attribute id="qiskit.algorithms.TimeEvolutionResult.observables" name="observables">
  ...
  <Attribute id="qiskit.algorithms.TimeEvolutionResult.times" name="times">
  ...
  *   **times** (*np.ndarray | None*) – Optional list of times at which each observable has been evaluated.
  ...
  <Function id="qiskit.algorithms.TimeEvolutionResult.combine" name="combine" signature="TimeEvolutionResult.combine(result)">
