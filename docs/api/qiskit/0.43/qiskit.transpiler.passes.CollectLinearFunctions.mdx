...
<Class id="qiskit.transpiler.passes.CollectLinearFunctions" github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/transpiler/passes/optimization/collect_linear_functions.py" signature="CollectLinearFunctions(*args, **kwargs)">
