...
<Class id="qiskit.transpiler.Target" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/transpiler/target.py" signature="Target(description=None, num_qubits=0, dt=None, granularity=1, min_length=1, pulse_alignment=1, acquire_alignment=1, qubit_properties=None)">
  Bases: `Mapping`
  ...
  *   **qubit\_properties\`** –
  ...
  <Function id="qiskit.transpiler.Target.build_coupling_map" name="build_coupling_map" signature="Target.build_coupling_map(two_q_gate=None, filter_idle_qubits=False)">
  ...
  <Function id="qiskit.transpiler.Target.from_configuration" name="from_configuration" signature="classmethod Target.from_configuration(basis_gates, num_qubits=None, coupling_map=None, inst_map=None, backend_properties=None, instruction_durations=None, dt=None, timing_constraints=None, custom_name_mapping=None)">
  ...
  <Function id="qiskit.transpiler.Target.get_calibration" name="get_calibration" signature="Target.get_calibration(operation_name, qargs, *args, **kwargs)">
  ...
  <Function id="qiskit.transpiler.Target.has_calibration" name="has_calibration" signature="Target.has_calibration(operation_name, qargs)">
