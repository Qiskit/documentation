...
<Class id="qiskit.providers.BackendV2Converter" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/providers/backend_compat.py" signature="BackendV2Converter(backend, name_mapping=None, add_delay=False, filter_faulty=False)">
  ...
  *   **filter\_faulty** (*bool*) – If the [`BackendProperties`](qiskit.providers.models.BackendProperties "qiskit.providers.models.BackendProperties") object (if present) for `backend` has any qubits or gates flagged as non-operational filter those from the output target.
  ...
  <Function id="qiskit.providers.BackendV2Converter.acquire_channel" name="acquire_channel" signature="BackendV2Converter.acquire_channel(qubit)">
  ...
  <Function id="qiskit.providers.BackendV2Converter.control_channel" name="control_channel" signature="BackendV2Converter.control_channel(qubits)">
  ...
  <Function id="qiskit.providers.BackendV2Converter.drive_channel" name="drive_channel" signature="BackendV2Converter.drive_channel(qubit)">
  ...
  <Function id="qiskit.providers.BackendV2Converter.measure_channel" name="measure_channel" signature="BackendV2Converter.measure_channel(qubit)">
  ...
  <Function id="qiskit.providers.BackendV2Converter.qubit_properties" name="qubit_properties" signature="BackendV2Converter.qubit_properties(qubit)">
  ...
  <Function id="qiskit.providers.BackendV2Converter.run" name="run" signature="BackendV2Converter.run(run_input, **options)">
    Run on the backend.
  ...
  <Function id="qiskit.providers.BackendV2Converter.set_options" name="set_options" signature="BackendV2Converter.set_options(**fields)">
