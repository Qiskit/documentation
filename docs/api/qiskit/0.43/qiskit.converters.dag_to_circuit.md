...
`dag_to_circuit(dag, copy_operations=True)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.43/qiskit/converters/dag_to_circuit.py "view source code")
...
![../\_images/qiskit-converters-dag\_to\_circuit-1.png](/images/api/qiskit/0.43/qiskit-converters-dag_to_circuit-1.png)
