...
`synth_clifford_depth_lnn(cliff)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.43/qiskit/synthesis/clifford/clifford_decompose_layers.py "view source code")
