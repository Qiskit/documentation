...
<Class id="qiskit.transpiler.CouplingMap" github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/transpiler/coupling.py" signature="CouplingMap(couplinglist=None, description=None)">
  ...
  *   **description** (*str*) – A string to describe the coupling map.
  ...
  <Function id="qiskit.transpiler.CouplingMap.from_full" signature="classmethod CouplingMap.from_full(num_qubits, bidirectional=True)">
  ...
  <Function id="qiskit.transpiler.CouplingMap.from_grid" signature="classmethod CouplingMap.from_grid(num_rows, num_columns, bidirectional=True)">
  ...
  <Function id="qiskit.transpiler.CouplingMap.from_heavy_hex" signature="classmethod CouplingMap.from_heavy_hex(distance, bidirectional=True)">
  ...
  <Function id="qiskit.transpiler.CouplingMap.from_heavy_square" signature="classmethod CouplingMap.from_heavy_square(distance, bidirectional=True)">
  ...
  <Function id="qiskit.transpiler.CouplingMap.from_hexagonal_lattice" signature="classmethod CouplingMap.from_hexagonal_lattice(rows, cols, bidirectional=True)">
  ...
  <Function id="qiskit.transpiler.CouplingMap.from_line" signature="classmethod CouplingMap.from_line(num_qubits, bidirectional=True)">
  ...
  <Function id="qiskit.transpiler.CouplingMap.from_ring" signature="classmethod CouplingMap.from_ring(num_qubits, bidirectional=True)">
