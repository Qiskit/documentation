...
<Class id="qiskit.transpiler.CouplingMap" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/transpiler/coupling.py" signature="CouplingMap(couplinglist=None, description=None)">
  Bases: `object`
  ...
  *   **description** (*str*) – A string to describe the coupling map.
  ...
  <Function id="qiskit.transpiler.CouplingMap.add_edge" name="add_edge" signature="CouplingMap.add_edge(src, dst)">
  ...
  <Function id="qiskit.transpiler.CouplingMap.add_physical_qubit" name="add_physical_qubit" signature="CouplingMap.add_physical_qubit(physical_qubit)">
  ...
  <Function id="qiskit.transpiler.CouplingMap.compute_distance_matrix" name="compute_distance_matrix" signature="CouplingMap.compute_distance_matrix()">
  ...
  <Function id="qiskit.transpiler.CouplingMap.connected_components" name="connected_components" signature="CouplingMap.connected_components()">
  ...
  <Function id="qiskit.transpiler.CouplingMap.distance" name="distance" signature="CouplingMap.distance(physical_qubit1, physical_qubit2)">
  ...
  <Function id="qiskit.transpiler.CouplingMap.draw" name="draw" signature="CouplingMap.draw()">
  ...
  <Function id="qiskit.transpiler.CouplingMap.from_full" name="from_full" signature="classmethod CouplingMap.from_full(num_qubits, bidirectional=True)">
  ...
  <Function id="qiskit.transpiler.CouplingMap.from_grid" name="from_grid" signature="classmethod CouplingMap.from_grid(num_rows, num_columns, bidirectional=True)">
  ...
  <Function id="qiskit.transpiler.CouplingMap.from_heavy_hex" name="from_heavy_hex" signature="classmethod CouplingMap.from_heavy_hex(distance, bidirectional=True)">
  ...
  <Function id="qiskit.transpiler.CouplingMap.from_heavy_square" name="from_heavy_square" signature="classmethod CouplingMap.from_heavy_square(distance, bidirectional=True)">
  ...
  <Function id="qiskit.transpiler.CouplingMap.from_hexagonal_lattice" name="from_hexagonal_lattice" signature="classmethod CouplingMap.from_hexagonal_lattice(rows, cols, bidirectional=True)">
  ...
  <Function id="qiskit.transpiler.CouplingMap.from_line" name="from_line" signature="classmethod CouplingMap.from_line(num_qubits, bidirectional=True)">
  ...
  <Function id="qiskit.transpiler.CouplingMap.from_ring" name="from_ring" signature="classmethod CouplingMap.from_ring(num_qubits, bidirectional=True)">
  ...
  <Function id="qiskit.transpiler.CouplingMap.get_edges" name="get_edges" signature="CouplingMap.get_edges()">
  ...
  <Function id="qiskit.transpiler.CouplingMap.is_connected" name="is_connected" signature="CouplingMap.is_connected()">
  ...
  <Function id="qiskit.transpiler.CouplingMap.largest_connected_component" name="largest_connected_component" signature="CouplingMap.largest_connected_component()">
  ...
  <Function id="qiskit.transpiler.CouplingMap.make_symmetric" name="make_symmetric" signature="CouplingMap.make_symmetric()">
  ...
  <Function id="qiskit.transpiler.CouplingMap.neighbors" name="neighbors" signature="CouplingMap.neighbors(physical_qubit)">
  ...
  <Function id="qiskit.transpiler.CouplingMap.reduce" name="reduce" signature="CouplingMap.reduce(mapping)">
  ...
  <Function id="qiskit.transpiler.CouplingMap.shortest_undirected_path" name="shortest_undirected_path" signature="CouplingMap.shortest_undirected_path(physical_qubit1, physical_qubit2)">
  ...
  <Function id="qiskit.transpiler.CouplingMap.size" name="size" signature="CouplingMap.size()">
  ...
  <Function id="qiskit.transpiler.CouplingMap.subgraph" name="subgraph" signature="CouplingMap.subgraph(nodelist)">
