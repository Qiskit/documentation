...
<Function id="qiskit.synthesis.synth_clifford_full" github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/synthesis/clifford/clifford_decompose_full.py" signature="synth_clifford_full(clifford, method=None)">
