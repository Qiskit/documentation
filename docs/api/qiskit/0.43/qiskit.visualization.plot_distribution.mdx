...
<Function id="qiskit.visualization.plot_distribution" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/visualization/counts_visualization.py" signature="plot_distribution(data, figsize=(7, 5), color=None, number_to_keep=None, sort='asc', target_string=None, legend=None, bar_labels=True, title=None, ax=None, filename=None)">
  ...
  **Examples**
  ...
  ![../\_images/qiskit-visualization-plot\_distribution-1\_00.png](/images/api/qiskit/0.43/qiskit-visualization-plot_distribution-1_00.avif)

  ![../\_images/qiskit-visualization-plot\_distribution-1\_01.png](/images/api/qiskit/0.43/qiskit-visualization-plot_distribution-1_01.avif)

  ![../\_images/qiskit-visualization-plot\_distribution-1\_02.png](/images/api/qiskit/0.43/qiskit-visualization-plot_distribution-1_02.avif)
</Function>
