...
<Class id="qiskit.transpiler.TranspileLayout" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/transpiler/layout.py" signature="TranspileLayout(initial_layout, input_qubit_mapping, final_layout=None)">
  Bases: `object`
