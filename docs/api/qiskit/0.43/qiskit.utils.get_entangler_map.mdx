...
<Function id="qiskit.utils.get_entangler_map" github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/utils/entangler_map.py" signature="get_entangler_map(map_type, num_qubits, offset=0)">
