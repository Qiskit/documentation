...
<Class id="qiskit.result.QuasiDistribution" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/result/distributions/quasi.py" signature="QuasiDistribution(data, shots=None, stddev_upper_bound=None)">
  Bases: `dict`
