...
<Class id="qiskit.algorithms.optimizers.COBYLA" github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/algorithms/optimizers/cobyla.py" signature="COBYLA(maxiter=1000, disp=False, rhobeg=1.0, tol=None, options=None, **kwargs)">
  ...
  *   **kwargs** – additional kwargs for scipy.optimize.minimize.
  ...
  <Function id="qiskit.algorithms.optimizers.COBYLA.gradient_num_diff" signature="static COBYLA.gradient_num_diff(x_center, f, epsilon, max_evals_grouped=None)">
  ...
  <Function id="qiskit.algorithms.optimizers.COBYLA.wrap_function" signature="static COBYLA.wrap_function(function, args)">
