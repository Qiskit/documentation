...
`synth_permutation_acg(pattern)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.43/qiskit/synthesis/permutation/permutation_full.py "view source code")
