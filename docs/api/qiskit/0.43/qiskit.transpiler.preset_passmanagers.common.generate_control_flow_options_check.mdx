---
title: generate_control_flow_options_check (v0.43)
description: API reference for qiskit.transpiler.preset_passmanagers.common.generate_control_flow_options_check in qiskit v0.43
...
<Function id="qiskit.transpiler.preset_passmanagers.common.generate_control_flow_options_check" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/transpiler/preset_passmanagers/common.py" signature="generate_control_flow_options_check(layout_method=None, routing_method=None, translation_method=None, optimization_method=None, scheduling_method=None, basis_gates=(), target=None)">
