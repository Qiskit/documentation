...
<Class id="qiskit.opflow.state_fns.VectorStateFn" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/opflow/state_fns/vector_state_fn.py" signature="VectorStateFn(*args, **kwargs)">
  ...
  *   **is\_measurement** – Whether the StateFn is a measurement operator
  ...
  <Attribute id="qiskit.opflow.state_fns.VectorStateFn.primitive" name="primitive" attributeTypeHint="Statevector">
