...
<Class id="qiskit.result.CorrelatedReadoutMitigator" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/result/mitigation/correlated_readout_mitigator.py" signature="CorrelatedReadoutMitigator(assignment_matrix, qubits=None)">
  ...
  **QiskitError** – matrix size does not agree with number of qubits
  ...
  <Function id="qiskit.result.CorrelatedReadoutMitigator.quasi_probabilities" name="quasi_probabilities" signature="CorrelatedReadoutMitigator.quasi_probabilities(data, qubits=None, clbits=None, shots=None)">
