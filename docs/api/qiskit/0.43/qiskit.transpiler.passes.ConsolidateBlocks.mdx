---
title: ConsolidateBlocks (v0.43)
description: API reference for qiskit.transpiler.passes.ConsolidateBlocks in qiskit v0.43
...
<Class id="qiskit.transpiler.passes.ConsolidateBlocks" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/transpiler/passes/optimization/consolidate_blocks.py" signature="ConsolidateBlocks(*args, **kwargs)" modifiers="class">
