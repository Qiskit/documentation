...
<Class id="qiskit.transpiler.passes.ConsolidateBlocks" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/transpiler/passes/optimization/consolidate_blocks.py" signature="ConsolidateBlocks(*args, **kwargs)">
  ...
  *   **target** ([*Target*](qiskit.transpiler.Target "qiskit.transpiler.Target")) – The target object for the compilation target backend
  ...
  <Function id="qiskit.transpiler.passes.ConsolidateBlocks.name" name="name" signature="ConsolidateBlocks.name()">
  ...
  <Function id="qiskit.transpiler.passes.ConsolidateBlocks.run" name="run" signature="ConsolidateBlocks.run(dag)">
