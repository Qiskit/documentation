...
<Class id="qiskit.algorithms.time_evolvers.variational.RealVariationalPrinciple" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/algorithms/time_evolvers/variational/variational_principles/real_variational_principle.py" signature="RealVariationalPrinciple(qgt, gradient)">
