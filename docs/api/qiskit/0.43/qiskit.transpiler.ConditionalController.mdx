...
<Class id="qiskit.transpiler.ConditionalController" github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/transpiler/runningpassmanager.py" signature="ConditionalController(passes, options=None, condition=None, **partial_controller)">
  ...
  <Function id="qiskit.transpiler.ConditionalController.add_flow_controller" signature="classmethod ConditionalController.add_flow_controller(name, controller)">
  ...
  <Function id="qiskit.transpiler.ConditionalController.controller_factory" signature="classmethod ConditionalController.controller_factory(passes, options, **partial_controller)">
  ...
  <Function id="qiskit.transpiler.ConditionalController.remove_flow_controller" signature="classmethod ConditionalController.remove_flow_controller(name)">
