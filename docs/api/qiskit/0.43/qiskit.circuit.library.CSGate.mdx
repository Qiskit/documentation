---
title: CSGate (v0.43)
description: API reference for qiskit.circuit.library.CSGate in qiskit v0.43
...
<Class id="qiskit.circuit.library.CSGate" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/circuit/library/standard_gates/s.py" signature="CSGate(label=None, ctrl_state=None)" modifiers="class">
