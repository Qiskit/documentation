---
title: ContinueLoopOp (v0.43)
description: API reference for qiskit.circuit.ContinueLoopOp in qiskit v0.43
...
<Class id="qiskit.circuit.ContinueLoopOp" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/circuit/controlflow/continue_loop.py" signature="ContinueLoopOp(num_qubits, num_clbits, label=None)" modifiers="class">
