...
<Class id="qiskit.algorithms.time_evolvers.variational.ImaginaryMcLachlanPrinciple" github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/algorithms/time_evolvers/variational/variational_principles/imaginary_mc_lachlan_principle.py" signature="ImaginaryMcLachlanPrinciple(qgt=None, gradient=None)">
