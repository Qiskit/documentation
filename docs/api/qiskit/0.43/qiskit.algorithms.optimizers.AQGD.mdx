...
*   **eta** (*float | list\[float]*) – The coefficient of the gradient update. Increasing this value results in larger step sizes: param = previous\_param - eta \* deriv
...
<span id="qiskit-algorithms-optimizers-aqgd-get-support-level" />
...
<span id="qiskit-algorithms-optimizers-aqgd-gradient-num-diff" />
...
<span id="qiskit-algorithms-optimizers-aqgd-print-options" />
...
<span id="qiskit-algorithms-optimizers-aqgd-set-max-evals-grouped" />
...
<span id="qiskit-algorithms-optimizers-aqgd-set-options" />
...
<span id="qiskit-algorithms-optimizers-aqgd-wrap-function" />
