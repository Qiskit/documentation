...
<Class id="qiskit.algorithms.optimizers.AQGD" github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/algorithms/optimizers/aqgd.py" signature="AQGD(maxiter=1000, eta=1.0, tol=1e-06, momentum=0.25, param_tol=1e-06, averaging=10)">
  ...
  **Raises**
  ...
  <Function id="qiskit.algorithms.optimizers.AQGD.gradient_num_diff" signature="static AQGD.gradient_num_diff(x_center, f, epsilon, max_evals_grouped=None)">
  ...
  <Function id="qiskit.algorithms.optimizers.AQGD.wrap_function" signature="static AQGD.wrap_function(function, args)">
