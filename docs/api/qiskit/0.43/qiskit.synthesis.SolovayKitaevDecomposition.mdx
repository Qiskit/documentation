---
title: SolovayKitaevDecomposition (v0.43)
description: API reference for qiskit.synthesis.SolovayKitaevDecomposition in qiskit v0.43
...
<Class id="qiskit.synthesis.SolovayKitaevDecomposition" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/synthesis/discrete_basis/solovay_kitaev.py" signature="SolovayKitaevDecomposition(basic_approximations=None)" modifiers="class">
  Bases: `object`
