...
<Class id="qiskit.algorithms.gradients.BaseEstimatorGradient" github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/algorithms/gradients/base_estimator_gradient.py" signature="BaseEstimatorGradient(estimator, options=None, derivative_type=DerivativeType.REAL)">
  Bases: `ABC`
