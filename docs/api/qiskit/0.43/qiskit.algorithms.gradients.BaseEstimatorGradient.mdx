---
title: BaseEstimatorGradient (v0.43)
description: API reference for qiskit.algorithms.gradients.BaseEstimatorGradient in qiskit v0.43
...
<Class id="qiskit.algorithms.gradients.BaseEstimatorGradient" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/algorithms/gradients/base_estimator_gradient.py" signature="BaseEstimatorGradient(estimator, options=None, derivative_type=DerivativeType.REAL)" modifiers="class">
  Bases: `ABC`
