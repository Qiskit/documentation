...
`circuit_to_dag(circuit, copy_operations=True)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.43/qiskit/converters/circuit_to_dag.py "view source code")
