...
`ReverseQGT(phase_fix=True, derivative_type=DerivativeType.COMPLEX)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.43/qiskit/algorithms/gradients/reverse_gradient/reverse_qgt.py "view source code")
...
*   **derivative\_type** ([*DerivativeType*](qiskit.algorithms.gradients.DerivativeType "qiskit.algorithms.gradients.DerivativeType")) – Determines whether the complex QGT or only the real or imaginary parts are calculated.
...
<span id="qiskit-algorithms-gradients-reverseqgt-update-default-options" />
