...
| [`passmanager_stage_plugins`](qiskit.transpiler.preset_passmanagers.plugin.passmanager_stage_plugins "qiskit.transpiler.preset_passmanagers.plugin.passmanager_stage_plugins")(stage)        | Return a dict with, for each stage name, the class type of the plugin.                                                                                     |
