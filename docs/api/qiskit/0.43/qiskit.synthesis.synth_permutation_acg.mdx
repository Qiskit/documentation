...
<Function id="qiskit.synthesis.synth_permutation_acg" name="synth_permutation_acg" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/synthesis/permutation/permutation_full.py" signature="synth_permutation_acg(pattern)">
