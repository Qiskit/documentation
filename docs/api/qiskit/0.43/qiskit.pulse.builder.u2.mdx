---
title: u2 (v0.43)
description: API reference for qiskit.pulse.builder.u2 in qiskit v0.43
...
<Function id="qiskit.pulse.builder.u2" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/pulse/builder.py" signature="u2(phi, lam, qubit)">
