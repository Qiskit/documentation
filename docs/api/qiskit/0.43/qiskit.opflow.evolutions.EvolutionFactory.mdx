...
<Class id="qiskit.opflow.evolutions.EvolutionFactory" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/opflow/evolutions/evolution_factory.py" signature="EvolutionFactory">
  Bases: `object`
