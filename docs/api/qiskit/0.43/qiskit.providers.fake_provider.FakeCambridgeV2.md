...
`FakeCambridgeV2`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.43/qiskit/providers/fake_provider/backends/cambridge/fake_cambridge.py "view source code")
