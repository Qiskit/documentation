---
title: TimeUnitConversion (v0.43)
description: API reference for qiskit.transpiler.passes.TimeUnitConversion in qiskit v0.43
...
<Class id="qiskit.transpiler.passes.TimeUnitConversion" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/transpiler/passes/scheduling/time_unit_conversion.py" signature="TimeUnitConversion(*args, **kwargs)" modifiers="class">
