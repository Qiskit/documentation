...
<Class id="qiskit.algorithms.time_evolvers.variational.VariationalPrinciple" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/algorithms/time_evolvers/variational/variational_principles/variational_principle.py" signature="VariationalPrinciple(qgt, gradient)">
  Bases: `ABC`
