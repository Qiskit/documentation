---
title: JobStatus (v0.43)
description: API reference for qiskit.providers.JobStatus in qiskit v0.43
...
<Class id="qiskit.providers.JobStatus" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/providers/jobstatus.py" signature="JobStatus(value)" modifiers="class">
  Bases: `Enum`
