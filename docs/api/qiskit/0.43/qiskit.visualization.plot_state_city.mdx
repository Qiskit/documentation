---
title: plot_state_city (v0.43)
description: API reference for qiskit.visualization.plot_state_city in qiskit v0.43
...
<Function id="qiskit.visualization.plot_state_city" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/visualization/state_visualization.py" signature="plot_state_city(state, title='', figsize=None, color=None, alpha=1, ax_real=None, ax_imag=None, *, rho=None, filename=None)">
  ...
  **Examples**
  ...
  ![../\_images/qiskit-visualization-plot\_state\_city-1.png](/docs/images/api/qiskit/0.43/qiskit-visualization-plot_state_city-1.avif)
  ...
  ![../\_images/qiskit-visualization-plot\_state\_city-2.png](/docs/images/api/qiskit/0.43/qiskit-visualization-plot_state_city-2.avif)
</Function>
