...
<Class id="qiskit.transpiler.passes.RemoveResetInZeroState" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/transpiler/passes/optimization/remove_reset_in_zero_state.py" signature="RemoveResetInZeroState(*args, **kwargs)">
