...
`WeightedAdder(num_state_qubits=None, weights=None, name='adder')`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.43/qiskit/circuit/library/arithmetic/weighted_adder.py "view source code")
...
*   **num\_state\_qubits** (*int | None*) – The number of state qubits.
