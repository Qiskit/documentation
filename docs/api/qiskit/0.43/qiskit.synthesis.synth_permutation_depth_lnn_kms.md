...
`synth_permutation_depth_lnn_kms(pattern)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.43/qiskit/synthesis/permutation/permutation_lnn.py "view source code")
