---
title: BIPMapping (v0.43)
description: API reference for qiskit.transpiler.passes.BIPMapping in qiskit v0.43
...
<Class id="qiskit.transpiler.passes.BIPMapping" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/transpiler/passes/routing/bip_mapping.py" signature="BIPMapping(*args, **kwargs)" modifiers="class">
