---
title: random_density_matrix (v0.43)
description: API reference for qiskit.quantum_info.random_density_matrix in qiskit v0.43
...
<Function id="qiskit.quantum_info.random_density_matrix" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/quantum_info/states/random.py" signature="random_density_matrix(dims, rank=None, method='Hilbert-Schmidt', seed=None)">
