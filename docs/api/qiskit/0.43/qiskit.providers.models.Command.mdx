---
title: Command (v0.43)
description: API reference for qiskit.providers.models.Command in qiskit v0.43
...
<Class id="qiskit.providers.models.Command" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/providers/models/pulsedefaults.py" signature="Command(name, qubits=None, sequence=None, **kwargs)" modifiers="class">
  Bases: `object`
