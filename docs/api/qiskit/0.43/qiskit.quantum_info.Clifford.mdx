---
title: Clifford (v0.43)
description: API reference for qiskit.quantum_info.Clifford in qiskit v0.43
...
<Class id="qiskit.quantum_info.Clifford" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/quantum_info/operators/symplectic/clifford.py" signature="Clifford(data, validate=True, copy=True)" modifiers="class">
  ...
  **References**
  ...
  <Function id="qiskit.quantum_info.Clifford.from_dict" signature="Clifford.from_dict(obj)" modifiers="classmethod">
  ...
  <Function id="qiskit.quantum_info.Clifford.from_matrix" signature="Clifford.from_matrix(matrix)" modifiers="classmethod">
  ...
  <Function id="qiskit.quantum_info.Clifford.from_operator" signature="Clifford.from_operator(operator)" modifiers="classmethod">
