...
<Class id="qiskit.quantum_info.Clifford" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/quantum_info/operators/symplectic/clifford.py" signature="Clifford(data, validate=True, copy=True)">
  ...
  **References**
  ...
  <Function id="qiskit.quantum_info.Clifford.from_dict" name="from_dict" signature="classmethod Clifford.from_dict(obj)">
  ...
  <Function id="qiskit.quantum_info.Clifford.from_matrix" name="from_matrix" signature="classmethod Clifford.from_matrix(matrix)">
  ...
  <Function id="qiskit.quantum_info.Clifford.from_operator" name="from_operator" signature="classmethod Clifford.from_operator(operator)">
  ...
  <Function id="qiskit.quantum_info.Clifford.to_labels" name="to_labels" signature="Clifford.to_labels(array=False, mode='B')">
