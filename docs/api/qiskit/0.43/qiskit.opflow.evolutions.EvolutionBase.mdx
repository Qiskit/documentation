---
title: EvolutionBase (v0.43)
description: API reference for qiskit.opflow.evolutions.EvolutionBase in qiskit v0.43
...
<Class id="qiskit.opflow.evolutions.EvolutionBase" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/opflow/evolutions/evolution_base.py" signature="EvolutionBase" modifiers="class">
