...
<Class id="qiskit.algorithms.GroverResult" github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/algorithms/amplitude_amplifiers/grover.py" signature="GroverResult">
