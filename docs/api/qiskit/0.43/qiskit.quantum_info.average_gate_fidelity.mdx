---
title: average_gate_fidelity (v0.43)
description: API reference for qiskit.quantum_info.average_gate_fidelity in qiskit v0.43
...
<Function id="qiskit.quantum_info.average_gate_fidelity" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/quantum_info/operators/measures.py" signature="average_gate_fidelity(channel, target=None, require_cp=True, require_tp=False)">
