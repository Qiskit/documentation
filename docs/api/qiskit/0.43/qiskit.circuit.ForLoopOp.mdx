---
title: ForLoopOp (v0.43)
description: API reference for qiskit.circuit.ForLoopOp in qiskit v0.43
...
<Class id="qiskit.circuit.ForLoopOp" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/circuit/controlflow/for_loop.py" signature="ForLoopOp(indexset, loop_parameter, body, label=None)" modifiers="class">
