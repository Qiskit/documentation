...
`synth_cnot_count_full_pmh(state, section_size=2)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.43/qiskit/synthesis/linear/cnot_synth.py "view source code")
