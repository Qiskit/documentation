---
title: HiddenLinearFunction (v0.43)
description: API reference for qiskit.circuit.library.HiddenLinearFunction in qiskit v0.43
...
$$
  ...
  **Reference Circuit:**
  ...
  > ![../\_images/qiskit-circuit-library-HiddenLinearFunction-1.png](/docs/images/api/qiskit/0.43/qiskit-circuit-library-HiddenLinearFunction-1.avif)
