...
<Class id="qiskit.transpiler.PassManager" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/transpiler/passmanager.py" signature="PassManager(passes=None, max_iteration=1000)">
  Bases: `object`
  ...
  *   **max\_iteration** (*int*) – The maximum number of iterations the schedule will be looped if the condition is not met.
  ...
  <Function id="qiskit.transpiler.PassManager.append" name="append" signature="PassManager.append(passes, max_iteration=None, **flow_controller_conditions)">
  ...
  <Function id="qiskit.transpiler.PassManager.draw" name="draw" signature="PassManager.draw(filename=None, style=None, raw=False)">
  ...
  <Function id="qiskit.transpiler.PassManager.passes" name="passes" signature="PassManager.passes()">
  ...
  <Function id="qiskit.transpiler.PassManager.remove" name="remove" signature="PassManager.remove(index)">
  ...
  <Function id="qiskit.transpiler.PassManager.replace" name="replace" signature="PassManager.replace(index, passes, max_iteration=None, **flow_controller_conditions)">
  ...
  <Function id="qiskit.transpiler.PassManager.run" name="run" signature="PassManager.run(circuits, output_name=None, callback=None)">
  ...
  <Function id="qiskit.transpiler.PassManager.to_flow_controller" name="to_flow_controller" signature="PassManager.to_flow_controller()">
