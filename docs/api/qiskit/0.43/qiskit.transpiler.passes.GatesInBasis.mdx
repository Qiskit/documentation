...
<Class id="qiskit.transpiler.passes.GatesInBasis" github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/transpiler/passes/utils/gates_basis.py" signature="GatesInBasis(*args, **kwargs)">
