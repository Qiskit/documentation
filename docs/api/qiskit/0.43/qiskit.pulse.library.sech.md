...
`sech(duration, amp, sigma, name=None, zero_ends=True)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.43/qiskit/pulse/library/discrete.py "view source code")
