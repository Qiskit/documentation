...
<Function id="qiskit.utils.add_deprecation_to_docstring" github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/utils/deprecation.py" signature="add_deprecation_to_docstring(func, msg, *, since, pending)">
