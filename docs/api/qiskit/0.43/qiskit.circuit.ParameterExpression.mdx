...
<Class id="qiskit.circuit.ParameterExpression" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/circuit/parameterexpression.py" signature="ParameterExpression(symbol_map, expr)">
  Bases: `object`
  ...
  *   **expr** (*sympy.Expr*) – Expression of `sympy.Symbol` s.
  ...
  <Function id="qiskit.circuit.ParameterExpression.bind" name="bind" signature="ParameterExpression.bind(parameter_values, allow_unknown_parameters=False)">
  ...
  <Function id="qiskit.circuit.ParameterExpression.subs" name="subs" signature="ParameterExpression.subs(parameter_map, allow_unknown_parameters=False)">
