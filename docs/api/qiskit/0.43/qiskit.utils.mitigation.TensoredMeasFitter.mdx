---
title: TensoredMeasFitter (v0.43)
description: API reference for qiskit.utils.mitigation.TensoredMeasFitter in qiskit v0.43
...
<Class id="qiskit.utils.mitigation.TensoredMeasFitter" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/utils/mitigation/fitters.py" signature="TensoredMeasFitter(results, mit_pattern, substate_labels_list=None, circlabel='')" modifiers="class">
  Bases: `object`
