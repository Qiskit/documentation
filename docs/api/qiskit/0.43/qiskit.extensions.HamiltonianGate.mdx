---
title: HamiltonianGate (v0.43)
description: API reference for qiskit.extensions.HamiltonianGate in qiskit v0.43
...
<Class id="qiskit.extensions.HamiltonianGate" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/extensions/hamiltonian_gate.py" signature="HamiltonianGate(data, time, label=None)" modifiers="class">
