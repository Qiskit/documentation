...
<Class id="qiskit.opflow.primitive_ops.PauliSumOp" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/opflow/primitive_ops/pauli_sum_op.py" signature="PauliSumOp(*args, **kwargs)">
  ...
  **TypeError** – invalid parameters.
  ...
  <Attribute id="qiskit.opflow.primitive_ops.PauliSumOp.primitive" name="primitive" attributeTypeHint="SparsePauliOp">
