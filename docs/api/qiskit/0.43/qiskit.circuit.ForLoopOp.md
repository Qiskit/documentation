...
`ForLoopOp(indexset, loop_parameter, body, label=None)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.43/qiskit/circuit/controlflow/for_loop.py "view source code")
...
<span id="qiskit-circuit-forloopop-add-decomposition" />
...
<span id="qiskit-circuit-forloopop-broadcast-arguments" />
...
<span id="qiskit-circuit-forloopop-c-if" />
...
<span id="qiskit-circuit-forloopop-is-parameterized" />
...
<span id="qiskit-circuit-forloopop-replace-blocks" />

### replace\_blocks

<span id="qiskit.circuit.ForLoopOp.replace_blocks" />

`ForLoopOp.replace_blocks(blocks)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.43/qiskit/circuit/controlflow/for_loop.py "view source code")
...
<span id="qiskit-circuit-forloopop-reverse-ops" />
...
<span id="qiskit-circuit-forloopop-soft-compare" />
...
<span id="qiskit-circuit-forloopop-validate-parameter" />
