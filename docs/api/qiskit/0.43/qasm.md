...
`OpenQASMLexer(*args, **kwds)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.43/qiskit/qasm/pygments/lexer.py "view source code")

A pygments lexer for OpenQasm.

<span id="qiskit.qasm.QasmHTMLStyle" />

`QasmHTMLStyle`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.43/qiskit/qasm/pygments/lexer.py "view source code")

A style for OpenQasm in a HTML env (e.g. Jupyter widget).

<span id="qiskit.qasm.QasmTerminalStyle" />

`QasmTerminalStyle`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.43/qiskit/qasm/pygments/lexer.py "view source code")
