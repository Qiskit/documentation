...
<Function id="qiskit.synthesis.synth_clifford_depth_lnn" github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/synthesis/clifford/clifford_decompose_layers.py" signature="synth_clifford_depth_lnn(cliff)">
