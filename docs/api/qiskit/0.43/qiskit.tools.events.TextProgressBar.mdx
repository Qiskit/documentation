...
<Class id="qiskit.tools.events.TextProgressBar" github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/tools/events/progressbar.py" signature="TextProgressBar(output_handler=None)">
