...
<Class id="qiskit.tools.events.TextProgressBar" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/tools/events/progressbar.py" signature="TextProgressBar(output_handler=None)">
  ...
  **Examples**
  ...
  <Function id="qiskit.tools.events.TextProgressBar.clear" name="clear" signature="TextProgressBar.clear()">
  ...
  <Function id="qiskit.tools.events.TextProgressBar.finished" name="finished" signature="TextProgressBar.finished()">
  ...
  <Function id="qiskit.tools.events.TextProgressBar.start" name="start" signature="TextProgressBar.start(iterations)">
  ...
  <Function id="qiskit.tools.events.TextProgressBar.subscribe" name="subscribe" signature="TextProgressBar.subscribe(event, callback)">
  ...
  <Function id="qiskit.tools.events.TextProgressBar.time_elapsed" name="time_elapsed" signature="TextProgressBar.time_elapsed()">
  ...
  <Function id="qiskit.tools.events.TextProgressBar.time_remaining_est" name="time_remaining_est" signature="TextProgressBar.time_remaining_est(completed_iter)">
  ...
  <Function id="qiskit.tools.events.TextProgressBar.unsubscribe" name="unsubscribe" signature="TextProgressBar.unsubscribe(event, callback)">
  ...
  <Function id="qiskit.tools.events.TextProgressBar.update" name="update" signature="TextProgressBar.update(n)">
