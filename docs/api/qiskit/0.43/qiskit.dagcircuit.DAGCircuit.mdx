---
title: DAGCircuit (v0.43)
description: API reference for qiskit.dagcircuit.DAGCircuit in qiskit v0.43
...
<Class id="qiskit.dagcircuit.DAGCircuit" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/dagcircuit/dagcircuit.py" signature="DAGCircuit" modifiers="class">
  Bases: `object`
  ...
  <Function id="qiskit.dagcircuit.DAGCircuit.swap_nodes" signature="DAGCircuit.swap_nodes(node1, node2)">
