...
<span id="qiskit-qobj-qasmqobjconfig-from-dict" />

### from\_dict

<span id="qiskit.qobj.QasmQobjConfig.from_dict" />

`classmethod QasmQobjConfig.from_dict(data)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.43/qiskit/qobj/qasm_qobj.py "view source code")
...
<span id="qiskit-qobj-qasmqobjconfig-to-dict" />

### to\_dict

<span id="qiskit.qobj.QasmQobjConfig.to_dict" />

`QasmQobjConfig.to_dict()`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.43/qiskit/qobj/qasm_qobj.py "view source code")
