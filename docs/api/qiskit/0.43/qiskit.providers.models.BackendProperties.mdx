...
<Class id="qiskit.providers.models.BackendProperties" github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/providers/models/backendproperties.py" signature="BackendProperties(backend_name, backend_version, last_update_date, qubits, gates, general, **kwargs)">
  Bases: `object`
