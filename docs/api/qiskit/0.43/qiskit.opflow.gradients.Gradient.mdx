...
<Class id="qiskit.opflow.gradients.Gradient" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/opflow/gradients/gradient.py" signature="Gradient(grad_method='param_shift', **kwargs)">
  ...
  <Function id="qiskit.opflow.gradients.Gradient.convert" name="convert" signature="Gradient.convert(operator, params=None)">
    **Parameters**
  ...
  <span id="qiskit-opflow-gradients-gradient-get-gradient" />

  ### get\_gradient

  <Function id="qiskit.opflow.gradients.Gradient.get_gradient" name="get_gradient" signature="Gradient.get_gradient(operator, params)">
  ...
  <Attribute id="qiskit.opflow.gradients.Gradient.grad_method" name="grad_method">
