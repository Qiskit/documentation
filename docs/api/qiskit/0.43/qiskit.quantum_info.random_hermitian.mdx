...
<Function id="qiskit.quantum_info.random_hermitian" name="random_hermitian" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/quantum_info/operators/random.py" signature="random_hermitian(dims, traceless=False, seed=None)">
