...
`FakeBackendV2`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.43/qiskit/providers/fake_provider/fake_backend_v2.py "view source code")
...
<span id="qiskit-providers-fake-provider-fakebackendv2-acquire-channel" />
...
<span id="qiskit-providers-fake-provider-fakebackendv2-control-channel" />
...
<span id="qiskit-providers-fake-provider-fakebackendv2-drive-channel" />
...
<span id="qiskit-providers-fake-provider-fakebackendv2-measure-channel" />
...
<span id="qiskit-providers-fake-provider-fakebackendv2-qubit-properties" />
...
<span id="qiskit-providers-fake-provider-fakebackendv2-run" />

### run

<span id="qiskit.providers.fake_provider.FakeBackendV2.run" />

`FakeBackendV2.run(run_input, **options)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.43/qiskit/providers/fake_provider/fake_backend_v2.py "view source code")
...
<span id="qiskit-providers-fake-provider-fakebackendv2-set-options" />
