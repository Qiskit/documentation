...
<Function id="qiskit.qpy.load" name="load" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/qpy/interface.py" signature="load(file_obj, metadata_deserializer=None)">
