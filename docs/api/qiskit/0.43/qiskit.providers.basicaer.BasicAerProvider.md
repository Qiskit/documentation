...
`BasicAerProvider`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.43/qiskit/providers/basicaer/basicaerprovider.py "view source code")
...
`BasicAerProvider.backends(name=None, filters=None, **kwargs)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.43/qiskit/providers/basicaer/basicaerprovider.py "view source code")
...
<span id="qiskit-providers-basicaer-basicaerprovider-get-backend" />

### get\_backend

<span id="qiskit.providers.basicaer.BasicAerProvider.get_backend" />

`BasicAerProvider.get_backend(name=None, **kwargs)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.43/qiskit/providers/basicaer/basicaerprovider.py "view source code")
