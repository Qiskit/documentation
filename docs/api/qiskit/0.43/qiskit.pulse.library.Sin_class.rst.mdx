---
title: Sin (v0.43)
description: API reference for qiskit.pulse.library.Sin in qiskit v0.43
...
<Function id="qiskit.pulse.library.Sin" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/pulse/library/symbolic_pulses.py" signature="Sin(duration, amp, phase, freq=None, angle=0.0, name=None, limit_amplitude=None)">
  A sinusoidal pulse.
