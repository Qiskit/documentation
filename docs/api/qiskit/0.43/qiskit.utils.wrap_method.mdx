---
title: wrap_method (v0.43)
description: API reference for qiskit.utils.wrap_method in qiskit v0.43
...
<Function id="qiskit.utils.wrap_method" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/utils/classtools.py" signature="wrap_method(cls, name, *, before=None, after=None)">
