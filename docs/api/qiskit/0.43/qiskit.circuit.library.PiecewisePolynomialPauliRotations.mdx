...
<Class id="qiskit.circuit.library.PiecewisePolynomialPauliRotations" github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/circuit/library/arithmetic/piecewise_polynomial_pauli_rotations.py" signature="PiecewisePolynomialPauliRotations(num_state_qubits=None, breakpoints=None, coeffs=None, basis='Y', name='pw_poly')">
...
$$
  ...
  *   **name** (*str*) – The name of the circuit.
  ...
  <Function id="qiskit.circuit.library.PiecewisePolynomialPauliRotations.evaluate" name="evaluate" signature="PiecewisePolynomialPauliRotations.evaluate(x)">
  ...
  <Attribute id="qiskit.circuit.library.PiecewisePolynomialPauliRotations.extension_lib" name="extension_lib" attributeValue="= 'include &#x22;qelib1.inc&#x22;;'" />
  ...
  <Attribute id="qiskit.circuit.library.PiecewisePolynomialPauliRotations.header" name="header" attributeValue="= 'OPENQASM 2.0;'" />

  ### instances

  <Attribute id="qiskit.circuit.library.PiecewisePolynomialPauliRotations.instances" name="instances" attributeValue="= 123" />
