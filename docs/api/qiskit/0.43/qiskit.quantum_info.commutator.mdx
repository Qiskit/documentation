...
<Function id="qiskit.quantum_info.commutator" name="commutator" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/quantum_info/operators/utils/commutator.py" signature="commutator(a, b)">
