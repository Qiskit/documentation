...
<Class id="qiskit.circuit.library.GraphState" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/circuit/library/graph_state.py" signature="GraphState(adjacency_matrix)">
...
$$
  ...
  **CircuitError** – If adjacency\_matrix is not symmetric.
  ...
  <Attribute id="qiskit.circuit.library.GraphState.instances" name="instances" attributeValue="123" />
