...
<Class id="qiskit.circuit.library.GraphState" github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/circuit/library/graph_state.py" signature="GraphState(adjacency_matrix)">
