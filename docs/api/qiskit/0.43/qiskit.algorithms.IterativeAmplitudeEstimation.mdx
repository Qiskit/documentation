...
<Class id="qiskit.algorithms.IterativeAmplitudeEstimation" github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/algorithms/amplitude_estimators/iae.py" signature="IterativeAmplitudeEstimation(epsilon_target, alpha, confint_method='beta', min_ratio=2, quantum_instance=None, sampler=None)">
  ...
  *   **ValueError** – If confint\_method is not supported
  ...
  <Function id="qiskit.algorithms.IterativeAmplitudeEstimation.construct_circuit" name="construct_circuit" signature="IterativeAmplitudeEstimation.construct_circuit(estimation_problem, k=0, measurement=False)">
  ...
  <Function id="qiskit.algorithms.IterativeAmplitudeEstimation.estimate" name="estimate" signature="IterativeAmplitudeEstimation.estimate(estimation_problem)">
  ...
  <Attribute id="qiskit.algorithms.IterativeAmplitudeEstimation.epsilon_target" name="epsilon_target">
  ...
  <Attribute id="qiskit.algorithms.IterativeAmplitudeEstimation.quantum_instance" name="quantum_instance">
  ...
  <Attribute id="qiskit.algorithms.IterativeAmplitudeEstimation.sampler" name="sampler">
