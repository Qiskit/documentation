...
<Class id="qiskit.primitives.Estimator" github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/primitives/estimator.py" signature="Estimator(*, options=None)">
