---
title: Estimator (v0.43)
description: API reference for qiskit.primitives.Estimator in qiskit v0.43
...
<Class id="qiskit.primitives.Estimator" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/primitives/estimator.py" signature="Estimator(*, options=None)" modifiers="class">
