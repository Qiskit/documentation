...
<Class id="qiskit.transpiler.passes.HoareOptimizer" github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/transpiler/passes/optimization/hoare_opt.py" signature="HoareOptimizer(*args, **kwargs)">
