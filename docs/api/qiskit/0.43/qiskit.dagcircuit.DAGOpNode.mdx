---
title: DAGOpNode (v0.43)
description: API reference for qiskit.dagcircuit.DAGOpNode in qiskit v0.43
...
<Class id="qiskit.dagcircuit.DAGOpNode" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/dagcircuit/dagnode.py" signature="DAGOpNode(op, qargs=(), cargs=())" modifiers="class">
