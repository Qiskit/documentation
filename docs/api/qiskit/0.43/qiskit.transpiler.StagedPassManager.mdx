...
<Class id="qiskit.transpiler.StagedPassManager" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/transpiler/passmanager.py" signature="StagedPassManager(stages=None, **kwargs)">
  ...
  *   **ValueError** – If an invalid stage name is specified.
  ...
  <Function id="qiskit.transpiler.StagedPassManager.append" name="append" signature="StagedPassManager.append(passes, max_iteration=None, **flow_controller_conditions)">
  ...
  <Function id="qiskit.transpiler.StagedPassManager.draw" name="draw" signature="StagedPassManager.draw(filename=None, style=None, raw=False)">
  ...
  <Function id="qiskit.transpiler.StagedPassManager.passes" name="passes" signature="StagedPassManager.passes()">
  ...
  <Function id="qiskit.transpiler.StagedPassManager.remove" name="remove" signature="StagedPassManager.remove(index)">
  ...
  <Function id="qiskit.transpiler.StagedPassManager.replace" name="replace" signature="StagedPassManager.replace(index, passes, max_iteration=None, **flow_controller_conditions)">
  ...
  <Function id="qiskit.transpiler.StagedPassManager.run" name="run" signature="StagedPassManager.run(circuits, output_name=None, callback=None)">
  ...
  <Function id="qiskit.transpiler.StagedPassManager.to_flow_controller" name="to_flow_controller" signature="StagedPassManager.to_flow_controller()">
