---
title: align_equispaced (v0.43)
description: API reference for qiskit.pulse.builder.align_equispaced in qiskit v0.43
...
<Function id="qiskit.pulse.builder.align_equispaced" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/pulse/builder.py" signature="align_equispaced(duration)">
  ...
  ![../\_images/qiskit-pulse-builder-align\_equispaced-1.png](/docs/images/api/qiskit/0.43/qiskit-pulse-builder-align_equispaced-1.avif)
