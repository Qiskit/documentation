...
<Class id="qiskit.transpiler.passes.InverseCancellation" github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/transpiler/passes/optimization/inverse_cancellation.py" signature="InverseCancellation(*args, **kwargs)">
