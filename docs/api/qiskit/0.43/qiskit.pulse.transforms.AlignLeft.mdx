...
<Class id="qiskit.pulse.transforms.AlignLeft" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/pulse/transforms/alignments.py" signature="AlignLeft">
