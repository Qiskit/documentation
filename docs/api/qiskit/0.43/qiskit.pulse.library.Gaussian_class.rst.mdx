---
title: Gaussian (v0.43)
description: API reference for qiskit.pulse.library.Gaussian in qiskit v0.43
...
<Class id="qiskit.pulse.library.Gaussian" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/pulse/library/symbolic_pulses.py" signature="Gaussian(duration, amp, sigma, angle=None, name=None, limit_amplitude=None)" modifiers="class">
  Bases: `object`
