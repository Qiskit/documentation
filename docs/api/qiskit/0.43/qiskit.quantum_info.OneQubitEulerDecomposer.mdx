...
<Class id="qiskit.quantum_info.OneQubitEulerDecomposer" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/quantum_info/synthesis/one_qubit_decompose.py" signature="OneQubitEulerDecomposer(basis='U3', use_dag=False)">
  Bases: `object`
  ...
  **QiskitError** – If input basis is not recognized.
  ...
  <Function id="qiskit.quantum_info.OneQubitEulerDecomposer.angles" name="angles" signature="OneQubitEulerDecomposer.angles(unitary)">
  ...
  <Function id="qiskit.quantum_info.OneQubitEulerDecomposer.angles_and_phase" name="angles_and_phase" signature="OneQubitEulerDecomposer.angles_and_phase(unitary)">
  ...
  <Function id="qiskit.quantum_info.OneQubitEulerDecomposer.build_circuit" name="build_circuit" signature="OneQubitEulerDecomposer.build_circuit(gates, global_phase)">
  ...
  <Attribute id="qiskit.quantum_info.OneQubitEulerDecomposer.basis" name="basis">
