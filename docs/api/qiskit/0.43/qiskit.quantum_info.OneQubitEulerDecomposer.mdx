...
<Class id="qiskit.quantum_info.OneQubitEulerDecomposer" github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/quantum_info/synthesis/one_qubit_decompose.py" signature="OneQubitEulerDecomposer(basis='U3', use_dag=False)">
  Bases: `object`
