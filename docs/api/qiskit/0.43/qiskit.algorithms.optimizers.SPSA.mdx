...
<Class id="qiskit.algorithms.optimizers.SPSA" github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/algorithms/optimizers/spsa.py" signature="SPSA(maxiter=100, blocking=False, allowed_increase=None, trust_region=False, learning_rate=None, perturbation=None, last_avg=1, resamplings=1, perturbation_dims=None, second_order=False, regularization=None, hessian_delay=0, lse_solver=None, initial_hessian=None, callback=None, termination_checker=None)">
  ...
  **ValueError** – If `learning_rate` or `perturbation` is an array with less elements than the number of iterations.
  ...
  <Function id="qiskit.algorithms.optimizers.SPSA.calibrate" signature="static SPSA.calibrate(loss, initial_point, c=0.2, stability_constant=0, target_magnitude=None, alpha=0.602, gamma=0.101, modelspace=False, max_evals_grouped=1)">
  ...
  <Function id="qiskit.algorithms.optimizers.SPSA.estimate_stddev" signature="static SPSA.estimate_stddev(loss, initial_point, avg=25, max_evals_grouped=1)">
  ...
  <Function id="qiskit.algorithms.optimizers.SPSA.gradient_num_diff" signature="static SPSA.gradient_num_diff(x_center, f, epsilon, max_evals_grouped=None)">
  ...
  <Function id="qiskit.algorithms.optimizers.SPSA.wrap_function" signature="static SPSA.wrap_function(function, args)">
