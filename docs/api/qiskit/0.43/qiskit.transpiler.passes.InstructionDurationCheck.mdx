...
<Class id="qiskit.transpiler.passes.InstructionDurationCheck" github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/transpiler/passes/scheduling/alignments/check_durations.py" signature="InstructionDurationCheck(*args, **kwargs)">
