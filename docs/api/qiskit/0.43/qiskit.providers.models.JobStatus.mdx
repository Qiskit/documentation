...
description: API reference for qiskit.providers.models.JobStatus in qiskit v0.43
...
<Class id="qiskit.providers.models.JobStatus" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/providers/models/jobstatus.py" signature="JobStatus(job_id, status, status_msg, **kwargs)" modifiers="class">
  Bases: `object`
