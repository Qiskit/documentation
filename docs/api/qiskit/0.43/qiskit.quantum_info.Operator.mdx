---
title: Operator (v0.43)
description: API reference for qiskit.quantum_info.Operator in qiskit v0.43
...
<Class id="qiskit.quantum_info.Operator" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/quantum_info/operators/operator.py" signature="Operator(data, input_dims=None, output_dims=None)" modifiers="class">
  Bases: `LinearOp`
...
$$
  ...
  **Additional Information:**
  ...
  <Function id="qiskit.quantum_info.Operator.apply_permutation" signature="Operator.apply_permutation(perm, front=False)">
