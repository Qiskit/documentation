...
<Function id="qiskit.visualization.visualize_transition" github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/visualization/transition_visualization.py" signature="visualize_transition(circuit, trace=False, saveas=None, fpg=100, spg=2)">
