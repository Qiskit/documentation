...
<Class id="qiskit.qobj.PulseLibraryItem" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/qobj/pulse_qobj.py" signature="PulseLibraryItem(name, samples)">
  Bases: `object`
  ...
  *   **samples** (*list\[complex]*) – A list of complex values defining pulse shape.
  ...
  <Function id="qiskit.qobj.PulseLibraryItem.from_dict" name="from_dict" signature="classmethod PulseLibraryItem.from_dict(data)">
  ...
  <Function id="qiskit.qobj.PulseLibraryItem.to_dict" name="to_dict" signature="PulseLibraryItem.to_dict()">
