---
title: PulseLibraryItem (v0.43)
description: API reference for qiskit.qobj.PulseLibraryItem in qiskit v0.43
...
<Class id="qiskit.qobj.PulseLibraryItem" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/qobj/pulse_qobj.py" signature="PulseLibraryItem(name, samples)" modifiers="class">
  Bases: `object`
