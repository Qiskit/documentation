...
<Class id="qiskit.pulse.library.Drag" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/pulse/library/symbolic_pulses.py" signature="Drag(duration, amp, sigma, beta, angle=None, name=None, limit_amplitude=None)">
  Bases: `object`
