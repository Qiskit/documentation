---
title: PulseGates (v0.43)
description: API reference for qiskit.transpiler.passes.PulseGates in qiskit v0.43
...
<Class id="qiskit.transpiler.passes.PulseGates" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/transpiler/passes/calibration/pulse_gate.py" signature="PulseGates(*args, **kwargs)" modifiers="class">
