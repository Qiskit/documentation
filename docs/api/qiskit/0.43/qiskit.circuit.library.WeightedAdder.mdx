...
<Class id="qiskit.circuit.library.WeightedAdder" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/circuit/library/arithmetic/weighted_adder.py" signature="WeightedAdder(num_state_qubits=None, weights=None, name='adder')">
...
$$
  ...
  *   **name** (*str*) – The name of the circuit.
  ...
  <Attribute id="qiskit.circuit.library.WeightedAdder.extension_lib" name="extension_lib" attributeValue="'include &#x22;qelib1.inc&#x22;;'" />
  ...
  <Attribute id="qiskit.circuit.library.WeightedAdder.header" name="header" attributeValue="'OPENQASM 2.0;'" />

  ### instances

  <Attribute id="qiskit.circuit.library.WeightedAdder.instances" name="instances" attributeValue="121" />
