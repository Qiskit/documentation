---
title: MatrixEvolution (v0.43)
description: API reference for qiskit.opflow.evolutions.MatrixEvolution in qiskit v0.43
...
<Class id="qiskit.opflow.evolutions.MatrixEvolution" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/opflow/evolutions/matrix_evolution.py" signature="MatrixEvolution" modifiers="class">
