...
`QuantumVolume(num_qubits, depth=None, seed=None, classical_permutation=True)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.43/qiskit/circuit/library/quantum_volume.py "view source code")
...
![../\_images/qiskit-circuit-library-QuantumVolume-1.png](/images/api/qiskit/0.43/qiskit-circuit-library-QuantumVolume-1.png)

**Expanded Circuit:**

![../\_images/qiskit-circuit-library-QuantumVolume-2.png](/images/api/qiskit/0.43/qiskit-circuit-library-QuantumVolume-2.png)
...
*   **depth** (*int | None*) – layers of SU(4) operations in model circuit.
*   **seed** ([*Generator*](https://numpy.org/doc/stable/reference/random/generator.html#numpy.random.Generator "(in NumPy v1.25)") *| int | None*) – Random number generator or generator seed.
