...
<Class id="qiskit.qobj.PulseQobjInstruction" github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/qobj/pulse_qobj.py" signature="PulseQobjInstruction(name, t0, ch=None, conditional=None, val=None, phase=None, duration=None, qubits=None, memory_slot=None, register_slot=None, kernels=None, discriminators=None, label=None, type=None, pulse_shape=None, parameters=None, frequency=None)">
  ...
  *   **parameters** (*dict*) – The parameters for a parametric pulse
  ...
  <Function id="qiskit.qobj.PulseQobjInstruction.from_dict" signature="classmethod PulseQobjInstruction.from_dict(data)">
  ...
  <Function id="qiskit.qobj.PulseQobjInstruction.to_dict" signature="PulseQobjInstruction.to_dict()">
