...
<Class id="qiskit.circuit.SwitchCaseOp" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/circuit/controlflow/switch_case.py" signature="SwitchCaseOp(target, cases, *, label=None)">
  ...
  *   **TypeError** – when the optional label is provided, but it is not a string.
  ...
  <Function id="qiskit.circuit.SwitchCaseOp.add_decomposition" name="add_decomposition" signature="SwitchCaseOp.add_decomposition(decomposition)">
  ...
  <Function id="qiskit.circuit.SwitchCaseOp.assemble" name="assemble" signature="SwitchCaseOp.assemble()">
  ...
  <Function id="qiskit.circuit.SwitchCaseOp.broadcast_arguments" name="broadcast_arguments" signature="SwitchCaseOp.broadcast_arguments(qargs, cargs)">
  ...
  <Function id="qiskit.circuit.SwitchCaseOp.c_if" name="c_if" signature="SwitchCaseOp.c_if(classical, val)">
  ...
  <Function id="qiskit.circuit.SwitchCaseOp.cases" name="cases" signature="SwitchCaseOp.cases()">
  ...
  <Function id="qiskit.circuit.SwitchCaseOp.cases_specifier" name="cases_specifier" signature="SwitchCaseOp.cases_specifier()">
  ...
  <Function id="qiskit.circuit.SwitchCaseOp.copy" name="copy" signature="SwitchCaseOp.copy(name=None)">
  ...
  <Function id="qiskit.circuit.SwitchCaseOp.inverse" name="inverse" signature="SwitchCaseOp.inverse()">
  ...
  <Function id="qiskit.circuit.SwitchCaseOp.is_parameterized" name="is_parameterized" signature="SwitchCaseOp.is_parameterized()">
  ...
  <Function id="qiskit.circuit.SwitchCaseOp.qasm" name="qasm" signature="SwitchCaseOp.qasm()">
  ...
  <Function id="qiskit.circuit.SwitchCaseOp.repeat" name="repeat" signature="SwitchCaseOp.repeat(n)">
  ...
  <Function id="qiskit.circuit.SwitchCaseOp.replace_blocks" name="replace_blocks" signature="SwitchCaseOp.replace_blocks(blocks)">
  ...
  <Function id="qiskit.circuit.SwitchCaseOp.reverse_ops" name="reverse_ops" signature="SwitchCaseOp.reverse_ops()">
  ...
  <Function id="qiskit.circuit.SwitchCaseOp.soft_compare" name="soft_compare" signature="SwitchCaseOp.soft_compare(other)">
  ...
  <Function id="qiskit.circuit.SwitchCaseOp.validate_parameter" name="validate_parameter" signature="SwitchCaseOp.validate_parameter(parameter)">
  ...
  <Attribute id="qiskit.circuit.SwitchCaseOp.blocks" name="blocks" />

  ### condition\_bits

  <Attribute id="qiskit.circuit.SwitchCaseOp.condition_bits" name="condition_bits">
    Get Clbits in condition.
  </Attribute>

  ### decompositions

  <Attribute id="qiskit.circuit.SwitchCaseOp.decompositions" name="decompositions">
    Get the decompositions of the instruction from the SessionEquivalenceLibrary.
  </Attribute>

  ### definition

  <Attribute id="qiskit.circuit.SwitchCaseOp.definition" name="definition">
    Return definition in terms of other basic gates.
  </Attribute>

  ### duration

  <Attribute id="qiskit.circuit.SwitchCaseOp.duration" name="duration">
    Get the duration.
  </Attribute>

  ### label

  <Attribute id="qiskit.circuit.SwitchCaseOp.label" name="label">
    Return instruction label
  </Attribute>

  ### name

  <Attribute id="qiskit.circuit.SwitchCaseOp.name" name="name">
    Return the name.
  </Attribute>

  ### num\_clbits

  <Attribute id="qiskit.circuit.SwitchCaseOp.num_clbits" name="num_clbits">
    Return the number of clbits.
  </Attribute>

  ### num\_qubits

  <Attribute id="qiskit.circuit.SwitchCaseOp.num_qubits" name="num_qubits">
    Return the number of qubits.
  </Attribute>

  ### params

  <Attribute id="qiskit.circuit.SwitchCaseOp.params" name="params">
    return instruction params.
  </Attribute>

  ### unit

  <Attribute id="qiskit.circuit.SwitchCaseOp.unit" name="unit">
