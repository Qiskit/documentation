...
description: API reference for qiskit.algorithms.VQDResult in qiskit v0.43
...
<Class id="qiskit.algorithms.VQDResult" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/algorithms/eigen_solvers/vqd.py" signature="VQDResult" modifiers="class">
