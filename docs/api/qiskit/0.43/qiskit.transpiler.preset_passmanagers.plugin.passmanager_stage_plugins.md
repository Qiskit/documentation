...
`passmanager_stage_plugins(stage)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.43/qiskit/transpiler/preset_passmanagers/plugin.py "view source code")
