---
title: GRX (v0.43)
description: API reference for qiskit.circuit.library.GRX in qiskit v0.43
...
<Class id="qiskit.circuit.library.GRX" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/circuit/library/generalized_gates/gr.py" signature="GRX(num_qubits, theta)" modifiers="class">
...
$$
  ...
  **Expanded Circuit:**
  ...
  ![../\_images/qiskit-circuit-library-GRX-1.png](/docs/images/api/qiskit/0.43/qiskit-circuit-library-GRX-1.avif)
  ...
  *   **theta** (*float*) – rotation angle about x-axis
  ...
  <Attribute id="qiskit.circuit.library.GRX.instances" attributeValue="136" />
