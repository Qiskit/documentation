---
title: PhaseOracle (v0.43)
description: API reference for qiskit.circuit.library.PhaseOracle in qiskit v0.43
...
<Class id="qiskit.circuit.library.PhaseOracle" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/circuit/library/phase_oracle.py" signature="PhaseOracle(expression, synthesizer=None, var_order=None)" modifiers="class">
  ...
  *   **var\_order** (*list*) – A list with the order in which variables will be created. (default: by appearance)
  ...
  <Attribute id="qiskit.circuit.library.PhaseOracle.instances" attributeValue="121" />
