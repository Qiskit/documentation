...
`StateFn(primitive=None, coeff=1.0, is_measurement=False)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.43/qiskit/opflow/state_fns/state_fn.py "view source code")
...
<span id="qiskit-opflow-state-fns-statefn-add" />

### add

<span id="qiskit.opflow.state_fns.StateFn.add" />

`StateFn.add(other)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.43/qiskit/opflow/state_fns/state_fn.py "view source code")
...
<span id="qiskit-opflow-state-fns-statefn-adjoint" />

### adjoint

<span id="qiskit.opflow.state_fns.StateFn.adjoint" />

`StateFn.adjoint()`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.43/qiskit/opflow/state_fns/state_fn.py "view source code")
...
<span id="qiskit-opflow-state-fns-statefn-assign-parameters" />

### assign\_parameters

<span id="qiskit.opflow.state_fns.StateFn.assign_parameters" />

`StateFn.assign_parameters(param_dict)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.43/qiskit/opflow/state_fns/state_fn.py "view source code")
...
<span id="qiskit-opflow-state-fns-statefn-compose" />

### compose

<span id="qiskit.opflow.state_fns.StateFn.compose" />

`StateFn.compose(other, permutation=None, front=False)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.43/qiskit/opflow/state_fns/state_fn.py "view source code")
...
<span id="qiskit-opflow-state-fns-statefn-equals" />

### equals

<span id="qiskit.opflow.state_fns.StateFn.equals" />

`StateFn.equals(other)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.43/qiskit/opflow/state_fns/state_fn.py "view source code")
...
<span id="qiskit-opflow-state-fns-statefn-eval" />

### eval

<span id="qiskit.opflow.state_fns.StateFn.eval" />

`StateFn.eval(front=None)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.43/qiskit/opflow/state_fns/state_fn.py "view source code")
...
<span id="qiskit-opflow-state-fns-statefn-mul" />

### mul

<span id="qiskit.opflow.state_fns.StateFn.mul" />

`StateFn.mul(scalar)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.43/qiskit/opflow/state_fns/state_fn.py "view source code")
...
<span id="qiskit-opflow-state-fns-statefn-permute" />

### permute

<span id="qiskit.opflow.state_fns.StateFn.permute" />

`StateFn.permute(permutation)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.43/qiskit/opflow/state_fns/state_fn.py "view source code")
...
<span id="qiskit-opflow-state-fns-statefn-power" />

### power

<span id="qiskit.opflow.state_fns.StateFn.power" />

`StateFn.power(exponent)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.43/qiskit/opflow/state_fns/state_fn.py "view source code")
...
<span id="qiskit-opflow-state-fns-statefn-primitive-strings" />

### primitive\_strings

<span id="qiskit.opflow.state_fns.StateFn.primitive_strings" />

`StateFn.primitive_strings()`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.43/qiskit/opflow/state_fns/state_fn.py "view source code")
...
<span id="qiskit-opflow-state-fns-statefn-reduce" />

### reduce

<span id="qiskit.opflow.state_fns.StateFn.reduce" />

`StateFn.reduce()`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.43/qiskit/opflow/state_fns/state_fn.py "view source code")
...
<span id="qiskit-opflow-state-fns-statefn-sample" />

### sample

<span id="qiskit.opflow.state_fns.StateFn.sample" />

`StateFn.sample(shots=1024, massive=False, reverse_endianness=False)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.43/qiskit/opflow/state_fns/state_fn.py "view source code")
...
<span id="qiskit-opflow-state-fns-statefn-tensor" />

### tensor

<span id="qiskit.opflow.state_fns.StateFn.tensor" />

`StateFn.tensor(other)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.43/qiskit/opflow/state_fns/state_fn.py "view source code")
...
<span id="qiskit-opflow-state-fns-statefn-tensorpower" />

### tensorpower

<span id="qiskit.opflow.state_fns.StateFn.tensorpower" />

`StateFn.tensorpower(other)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.43/qiskit/opflow/state_fns/state_fn.py "view source code")
...
<span id="qiskit-opflow-state-fns-statefn-to-circuit-op" />

### to\_circuit\_op

<span id="qiskit.opflow.state_fns.StateFn.to_circuit_op" />

`StateFn.to_circuit_op()`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.43/qiskit/opflow/state_fns/state_fn.py "view source code")
...
<span id="qiskit-opflow-state-fns-statefn-to-density-matrix" />

### to\_density\_matrix

<span id="qiskit.opflow.state_fns.StateFn.to_density_matrix" />

`StateFn.to_density_matrix(massive=False)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.43/qiskit/opflow/state_fns/state_fn.py "view source code")
...
<span id="qiskit-opflow-state-fns-statefn-to-matrix" />

### to\_matrix

<span id="qiskit.opflow.state_fns.StateFn.to_matrix" />

`StateFn.to_matrix(massive=False)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.43/qiskit/opflow/state_fns/state_fn.py "view source code")
...
<span id="qiskit-opflow-state-fns-statefn-to-matrix-op" />

### to\_matrix\_op

<span id="qiskit.opflow.state_fns.StateFn.to_matrix_op" />

`StateFn.to_matrix_op(massive=False)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.43/qiskit/opflow/state_fns/state_fn.py "view source code")
...
<span id="qiskit-opflow-state-fns-statefn-traverse" />

### traverse

<span id="qiskit.opflow.state_fns.StateFn.traverse" />

`StateFn.traverse(convert_fn, coeff=None)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.43/qiskit/opflow/state_fns/state_fn.py "view source code")
