...
<Class id="qiskit.algorithms.gradients.LinCombEstimatorGradient" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/algorithms/gradients/lin_comb_estimator_gradient.py" signature="LinCombEstimatorGradient(estimator, derivative_type=DerivativeType.REAL, options=None)">
  ...
  *   **options** ([*Options*](qiskit.providers.Options "qiskit.providers.Options") *| None*) – Primitive backend runtime options used for circuit execution. The order of priority is: options in `run` method > gradient’s default options > primitive’s default setting. Higher priority setting overrides lower priority setting.
  ...
  <Function id="qiskit.algorithms.gradients.LinCombEstimatorGradient.run" name="run" signature="LinCombEstimatorGradient.run(circuits, observables, parameter_values, parameters=None, **options)">
  ...
  <span id="qiskit-algorithms-gradients-lincombestimatorgradient-update-default-options" />

  ### update\_default\_options

  <Function id="qiskit.algorithms.gradients.LinCombEstimatorGradient.update_default_options" name="update_default_options" signature="LinCombEstimatorGradient.update_default_options(**options)">
  ...
  <Attribute id="qiskit.algorithms.gradients.LinCombEstimatorGradient.SUPPORTED_GATES" name="SUPPORTED_GATES" attributeValue="= ['rx', 'ry', 'rz', 'rzx', 'rzz', 'ryy', 'rxx', 'cx', 'cy', 'cz', 'ccx', 'swap', 'iswap', 'h', 't', 's', 'sdg', 'x', 'y', 'z']" />

  ### derivative\_type

  <Attribute id="qiskit.algorithms.gradients.LinCombEstimatorGradient.derivative_type" name="derivative_type">
  ...
  <Attribute id="qiskit.algorithms.gradients.LinCombEstimatorGradient.options" name="options">
