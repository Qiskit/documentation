---
title: qubit_channels (v0.43)
description: API reference for qiskit.pulse.builder.qubit_channels in qiskit v0.43
...
<Function id="qiskit.pulse.builder.qubit_channels" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/pulse/builder.py" signature="qubit_channels(qubit)">
