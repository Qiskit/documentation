...
<Class id="qiskit.opflow.converters.ConverterBase" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/opflow/converters/converter_base.py" signature="ConverterBase">
  Bases: `ABC`
  ...
  <Function id="qiskit.opflow.converters.ConverterBase.convert" name="convert" signature="abstract ConverterBase.convert(operator)">
