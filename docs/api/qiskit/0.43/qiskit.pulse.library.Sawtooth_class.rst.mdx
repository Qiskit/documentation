...
<Function id="qiskit.pulse.library.Sawtooth" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/pulse/library/symbolic_pulses.py" signature="Sawtooth(duration, amp, phase, freq=None, angle=0.0, name=None, limit_amplitude=None)">
  A sawtooth pulse.
