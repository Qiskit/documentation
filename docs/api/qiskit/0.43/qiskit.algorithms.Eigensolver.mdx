---
title: Eigensolver (v0.43)
description: API reference for qiskit.algorithms.Eigensolver in qiskit v0.43
...
<Class id="qiskit.algorithms.Eigensolver" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/algorithms/eigen_solvers/eigen_solver.py" signature="Eigensolver" modifiers="class">
  Bases: `ABC`
