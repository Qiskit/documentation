---
title: CSdgGate (v0.43)
description: API reference for qiskit.circuit.library.CSdgGate in qiskit v0.43
...
<Class id="qiskit.circuit.library.CSdgGate" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/circuit/library/standard_gates/s.py" signature="CSdgGate(label=None, ctrl_state=None)" modifiers="class">
