...
<Class id="qiskit.algorithms.EstimationProblem" github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/algorithms/amplitude_estimators/estimation_problem.py" signature="EstimationProblem(state_preparation, objective_qubits, grover_operator=None, post_processing=None, is_good_state=None)">
  Bases: `object`
  ...
  *   **is\_good\_state** (*Callable\[\[str], bool] | None*) – A function to check whether a string represents a good state. Defaults to all objective qubits being in state $|1\rangle$.
  ...
  <Function id="qiskit.algorithms.EstimationProblem.rescale" name="rescale" signature="EstimationProblem.rescale(scaling_factor)">
  ...
  <Attribute id="qiskit.algorithms.EstimationProblem.grover_operator" name="grover_operator">
  ...
  <Attribute id="qiskit.algorithms.EstimationProblem.has_good_state" name="has_good_state">
  ...
  <Attribute id="qiskit.algorithms.EstimationProblem.is_good_state" name="is_good_state">
  ...
  <Attribute id="qiskit.algorithms.EstimationProblem.objective_qubits" name="objective_qubits">
  ...
  <Attribute id="qiskit.algorithms.EstimationProblem.post_processing" name="post_processing">
  ...
  <Attribute id="qiskit.algorithms.EstimationProblem.state_preparation" name="state_preparation">
