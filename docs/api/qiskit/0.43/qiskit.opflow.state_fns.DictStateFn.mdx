---
title: DictStateFn (v0.43)
description: API reference for qiskit.opflow.state_fns.DictStateFn in qiskit v0.43
...
<Class id="qiskit.opflow.state_fns.DictStateFn" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/opflow/state_fns/dict_state_fn.py" signature="DictStateFn(*args, **kwargs)" modifiers="class">
