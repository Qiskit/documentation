...
<Function id="qiskit.opflow.commutator" name="commutator" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/opflow/utils.py" signature="commutator(op_a, op_b)">
