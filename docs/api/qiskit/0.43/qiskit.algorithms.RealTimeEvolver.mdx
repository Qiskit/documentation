---
title: RealTimeEvolver (v0.43)
description: API reference for qiskit.algorithms.RealTimeEvolver in qiskit v0.43
...
<Class id="qiskit.algorithms.RealTimeEvolver" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/algorithms/time_evolvers/real_time_evolver.py" signature="RealTimeEvolver" modifiers="class">
  Bases: `ABC`
