...
<Class id="qiskit.transpiler.InstructionProperties" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/transpiler/target.py" signature="InstructionProperties(duration=None, error=None, calibration=None)">
  Bases: `object`
  ...
  *   **calibration** (*Union\[*[*Schedule*](qiskit.pulse.Schedule "qiskit.pulse.Schedule")*,* [*ScheduleBlock*](qiskit.pulse.ScheduleBlock "qiskit.pulse.ScheduleBlock")*, CalibrationEntry]*) – The pulse representation of the instruction.
  ...
  <Attribute id="qiskit.transpiler.InstructionProperties.duration" name="duration" />

  ### error

  <Attribute id="qiskit.transpiler.InstructionProperties.error" name="error" />

  ### calibration

  <Attribute id="qiskit.transpiler.InstructionProperties.calibration" name="calibration">
