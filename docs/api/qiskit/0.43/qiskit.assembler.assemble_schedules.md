...
`assemble_schedules(schedules, qobj_id, qobj_header, run_config)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.43/qiskit/assembler/assemble_schedules.py "view source code")
