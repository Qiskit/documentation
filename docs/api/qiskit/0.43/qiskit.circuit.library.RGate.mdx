---
title: RGate (v0.43)
description: API reference for qiskit.circuit.library.RGate in qiskit v0.43
...
<Class id="qiskit.circuit.library.RGate" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/circuit/library/standard_gates/r.py" signature="RGate(theta, phi, label=None)" modifiers="class">
