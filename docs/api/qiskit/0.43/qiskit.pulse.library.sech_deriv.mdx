---
title: sech_deriv (v0.43)
description: API reference for qiskit.pulse.library.sech_deriv in qiskit v0.43
...
<Function id="qiskit.pulse.library.sech_deriv" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/pulse/library/discrete.py" signature="sech_deriv(duration, amp, sigma, name=None)">
