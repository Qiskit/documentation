---
title: SetIOLatency (v0.43)
description: API reference for qiskit.transpiler.passes.SetIOLatency in qiskit v0.43
...
<Class id="qiskit.transpiler.passes.SetIOLatency" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/transpiler/passes/scheduling/scheduling/set_io_latency.py" signature="SetIOLatency(*args, **kwargs)" modifiers="class">
