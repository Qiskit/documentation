...
<Class id="qiskit.transpiler.passes.SetIOLatency" github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/transpiler/passes/scheduling/scheduling/set_io_latency.py" signature="SetIOLatency(*args, **kwargs)">
