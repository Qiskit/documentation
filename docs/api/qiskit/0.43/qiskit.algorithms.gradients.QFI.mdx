---
title: QFI (v0.43)
description: API reference for qiskit.algorithms.gradients.QFI in qiskit v0.43
...
<Class id="qiskit.algorithms.gradients.QFI" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/algorithms/gradients/qfi.py" signature="QFI(qgt, options=None)" modifiers="class">
  Bases: `ABC`
