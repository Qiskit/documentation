...
`UnrollForLoops(*args, **kwargs)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.43/qiskit/transpiler/passes/utils/unroll_forloops.py "view source code")
...
`UnrollForLoops.run(dag)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.43/qiskit/transpiler/passes/utils/unroll_forloops.py "view source code")
