...
<Class id="qiskit.visualization.VisualizationError" name="VisualizationError" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/visualization/exceptions.py" signature="VisualizationError(*message)">
