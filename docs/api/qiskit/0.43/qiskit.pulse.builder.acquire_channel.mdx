...
<Function id="qiskit.pulse.builder.acquire_channel" name="acquire_channel" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/pulse/builder.py" signature="acquire_channel(qubit)">
