...
<Function id="qiskit.pulse.builder.acquire_channel" github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/pulse/builder.py" signature="acquire_channel(qubit)">
