...
<Class id="qiskit.transpiler.passes.TranslateParameterizedGates" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/transpiler/passes/basis/translate_parameterized.py" signature="TranslateParameterizedGates(*args, **kwargs)">
  ...
  **ValueError** – If neither of `supported_gates` and `target` are passed.
  ...
  <Function id="qiskit.transpiler.passes.TranslateParameterizedGates.name" name="name" signature="TranslateParameterizedGates.name()">
  ...
  <Function id="qiskit.transpiler.passes.TranslateParameterizedGates.run" name="run" signature="TranslateParameterizedGates.run(dag)">
