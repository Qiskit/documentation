---
title: MatrixOp (v0.43)
description: API reference for qiskit.opflow.primitive_ops.MatrixOp in qiskit v0.43
...
<Class id="qiskit.opflow.primitive_ops.MatrixOp" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/opflow/primitive_ops/matrix_op.py" signature="MatrixOp(*args, **kwargs)" modifiers="class">
