---
title: TGate (v0.43)
description: API reference for qiskit.circuit.library.TGate in qiskit v0.43
...
<Class id="qiskit.circuit.library.TGate" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/circuit/library/standard_gates/t.py" signature="TGate(label=None)" modifiers="class">
