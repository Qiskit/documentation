---
title: set_phase (v0.43)
description: API reference for qiskit.pulse.builder.set_phase in qiskit v0.43
...
<Function id="qiskit.pulse.builder.set_phase" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/pulse/builder.py" signature="set_phase(phase, channel, name=None)">
