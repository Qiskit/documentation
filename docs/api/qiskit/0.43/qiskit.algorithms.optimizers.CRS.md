...
`CRS(max_evals=1000)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.43/qiskit/algorithms/optimizers/nlopts/crs.py "view source code")
...
<span id="qiskit-algorithms-optimizers-crs-get-nlopt-optimizer" />

### get\_nlopt\_optimizer

<span id="qiskit.algorithms.optimizers.CRS.get_nlopt_optimizer" />

`CRS.get_nlopt_optimizer()`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.43/qiskit/algorithms/optimizers/nlopts/crs.py "view source code")
...
<span id="qiskit-algorithms-optimizers-crs-get-support-level" />
...
<span id="qiskit-algorithms-optimizers-crs-gradient-num-diff" />
...
<span id="qiskit-algorithms-optimizers-crs-print-options" />
...
<span id="qiskit-algorithms-optimizers-crs-set-max-evals-grouped" />
...
<span id="qiskit-algorithms-optimizers-crs-set-options" />
...
<span id="qiskit-algorithms-optimizers-crs-wrap-function" />
