---
title: CommutationAnalysis (v0.43)
description: API reference for qiskit.transpiler.passes.CommutationAnalysis in qiskit v0.43
...
<Class id="qiskit.transpiler.passes.CommutationAnalysis" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/transpiler/passes/optimization/commutation_analysis.py" signature="CommutationAnalysis(*args, **kwargs)" modifiers="class">
