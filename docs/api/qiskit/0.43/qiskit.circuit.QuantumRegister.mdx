...
<Class id="qiskit.circuit.QuantumRegister" github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/circuit/quantumregister.py" signature="QuantumRegister(size=None, name=None, bits=None)">
