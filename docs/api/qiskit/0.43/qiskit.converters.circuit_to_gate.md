...
`circuit_to_gate(circuit, parameter_map=None, equivalence_library=None, label=None)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.43/qiskit/converters/circuit_to_gate.py "view source code")
