...
<Class id="qiskit.algorithms.TimeEvolutionProblem" github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/algorithms/time_evolvers/time_evolution_problem.py" signature="TimeEvolutionProblem(hamiltonian, time, initial_state=None, aux_operators=None, truncation_threshold=1e-12, t_param=None, param_value_map=None)">
  ...
  <Attribute id="qiskit.algorithms.TimeEvolutionProblem.hamiltonian" name="hamiltonian">
  ...
  <Attribute id="qiskit.algorithms.TimeEvolutionProblem.initial_state" name="initial_state">
  ...
  <Attribute id="qiskit.algorithms.TimeEvolutionProblem.aux_operators" name="aux_operators">
  ...
  <Attribute id="qiskit.algorithms.TimeEvolutionProblem.truncation_threshold" name="truncation_threshold">
  ...
  <Attribute id="qiskit.algorithms.TimeEvolutionProblem.t_param" name="t_param">
  ...
  <Attribute id="qiskit.algorithms.TimeEvolutionProblem.param_value_map" name="param_value_map">
  ...
  **ValueError** – If non-positive time of evolution is provided.
  ...
  <Function id="qiskit.algorithms.TimeEvolutionProblem.validate_params" name="validate_params" signature="TimeEvolutionProblem.validate_params()">
  ...
  <Attribute id="qiskit.algorithms.TimeEvolutionProblem.time" name="time">
    Returns time.
  </Attribute>
</Class>
