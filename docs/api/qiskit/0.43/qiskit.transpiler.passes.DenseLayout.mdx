---
title: DenseLayout (v0.43)
description: API reference for qiskit.transpiler.passes.DenseLayout in qiskit v0.43
...
<Class id="qiskit.transpiler.passes.DenseLayout" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/transpiler/passes/layout/dense_layout.py" signature="DenseLayout(*args, **kwargs)" modifiers="class">
