...
<Class id="qiskit.algorithms.optimizers.NELDER_MEAD" github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/algorithms/optimizers/nelder_mead.py" signature="NELDER_MEAD(maxiter=None, maxfev=1000, disp=False, xatol=0.0001, tol=None, adaptive=False, options=None, **kwargs)">
  ...
  *   **kwargs** – additional kwargs for scipy.optimize.minimize.
  ...
  <Function id="qiskit.algorithms.optimizers.NELDER_MEAD.gradient_num_diff" signature="static NELDER_MEAD.gradient_num_diff(x_center, f, epsilon, max_evals_grouped=None)">
  ...
  <Function id="qiskit.algorithms.optimizers.NELDER_MEAD.minimize" signature="NELDER_MEAD.minimize(fun, x0, jac=None, bounds=None)">
  ...
  <Function id="qiskit.algorithms.optimizers.NELDER_MEAD.wrap_function" signature="static NELDER_MEAD.wrap_function(function, args)">
