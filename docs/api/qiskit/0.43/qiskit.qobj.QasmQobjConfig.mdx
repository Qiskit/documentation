...
<Class id="qiskit.qobj.QasmQobjConfig" github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/qobj/qasm_qobj.py" signature="QasmQobjConfig(shots=None, seed_simulator=None, memory=None, parameter_binds=None, meas_level=None, meas_return=None, memory_slots=None, n_qubits=None, pulse_library=None, calibrations=None, rep_delay=None, qubit_lo_freq=None, meas_lo_freq=None, **kwargs)">
  ...
  *   **kwargs** – Additional free form key value fields to add to the configuration.
  ...
  <Function id="qiskit.qobj.QasmQobjConfig.from_dict" name="from_dict" signature="classmethod QasmQobjConfig.from_dict(data)">
  ...
  <Function id="qiskit.qobj.QasmQobjConfig.to_dict" name="to_dict" signature="QasmQobjConfig.to_dict()">
