---
title: SummedOp (v0.43)
description: API reference for qiskit.opflow.list_ops.SummedOp in qiskit v0.43
...
<Class id="qiskit.opflow.list_ops.SummedOp" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/opflow/list_ops/summed_op.py" signature="SummedOp(oplist, coeff=1.0, abelian=False)" modifiers="class">
