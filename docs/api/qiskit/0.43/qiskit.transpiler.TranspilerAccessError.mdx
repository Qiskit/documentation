...
<Class id="qiskit.transpiler.TranspilerAccessError" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/transpiler/exceptions.py" signature="TranspilerAccessError(*message)">
