...
<Function id="qiskit.synthesis.synth_cnotdihedral_two_qubits" github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/synthesis/cnotdihedral/cnotdihedral_decompose_two_qubits.py" signature="synth_cnotdihedral_two_qubits(elem)">
