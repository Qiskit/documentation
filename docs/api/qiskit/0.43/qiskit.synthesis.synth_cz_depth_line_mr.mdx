...
<Function id="qiskit.synthesis.synth_cz_depth_line_mr" github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/synthesis/linear_phase/cz_depth_lnn.py" signature="synth_cz_depth_line_mr(mat)">
