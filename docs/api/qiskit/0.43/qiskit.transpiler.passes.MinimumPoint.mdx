...
<Class id="qiskit.transpiler.passes.MinimumPoint" github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/transpiler/passes/utils/minimum_point.py" signature="MinimumPoint(*args, **kwargs)">
