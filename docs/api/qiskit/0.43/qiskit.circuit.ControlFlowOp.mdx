...
<Class id="qiskit.circuit.ControlFlowOp" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/circuit/controlflow/control_flow.py" signature="ControlFlowOp(name, num_qubits, num_clbits, params, duration=None, unit='dt', label=None)">
