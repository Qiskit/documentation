...
<Class id="qiskit.algorithms.EvolutionProblem" github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/algorithms/evolvers/evolution_problem.py" signature="EvolutionProblem(hamiltonian, time, initial_state=None, aux_operators=None, truncation_threshold=1e-12, t_param=None, param_value_dict=None)">
  Bases: `object`
  ...
  **ValueError** – If non-positive time of evolution is provided.
  ...
  <Function id="qiskit.algorithms.EvolutionProblem.validate_params" name="validate_params" signature="EvolutionProblem.validate_params()">
  ...
  <Attribute id="qiskit.algorithms.EvolutionProblem.time" name="time">
    Returns time.
  </Attribute>
</Class>
