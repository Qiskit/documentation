...
description: API reference for qiskit.algorithms.eigensolvers.Eigensolver in qiskit v0.43
...
<Class id="qiskit.algorithms.eigensolvers.Eigensolver" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/algorithms/eigensolvers/eigensolver.py" signature="Eigensolver" modifiers="class">
  Bases: `ABC`
