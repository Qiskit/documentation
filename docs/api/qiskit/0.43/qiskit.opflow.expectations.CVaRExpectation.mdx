...
<Class id="qiskit.opflow.expectations.CVaRExpectation" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/opflow/expectations/cvar_expectation.py" signature="CVaRExpectation(alpha, expectation=None)">
  ...
  **NotImplementedError** – If the `expectation` is an AerPauliExpecation.
  ...
  <Function id="qiskit.opflow.expectations.CVaRExpectation.compute_variance" name="compute_variance" signature="CVaRExpectation.compute_variance(exp_op)">
  ...
  <Function id="qiskit.opflow.expectations.CVaRExpectation.convert" name="convert" signature="CVaRExpectation.convert(operator)">
