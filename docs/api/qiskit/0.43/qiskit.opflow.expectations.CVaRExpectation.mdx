---
title: CVaRExpectation (v0.43)
description: API reference for qiskit.opflow.expectations.CVaRExpectation in qiskit v0.43
...
<Class id="qiskit.opflow.expectations.CVaRExpectation" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/opflow/expectations/cvar_expectation.py" signature="CVaRExpectation(alpha, expectation=None)" modifiers="class">
