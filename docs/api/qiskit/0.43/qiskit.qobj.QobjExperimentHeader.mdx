...
<Class id="qiskit.qobj.QobjExperimentHeader" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/qobj/common.py" signature="QobjExperimentHeader(**kwargs)">
  ...
  **kwargs** – arbitrary keyword arguments that can be accessed as attributes of the object.
  ...
  <Function id="qiskit.qobj.QobjExperimentHeader.from_dict" name="from_dict" signature="classmethod QobjExperimentHeader.from_dict(data)">
  ...
  <Function id="qiskit.qobj.QobjExperimentHeader.to_dict" name="to_dict" signature="QobjExperimentHeader.to_dict()">
