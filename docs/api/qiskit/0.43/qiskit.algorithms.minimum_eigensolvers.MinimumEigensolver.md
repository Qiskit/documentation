...
`MinimumEigensolver`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.43/qiskit/algorithms/minimum_eigensolvers/minimum_eigensolver.py "view source code")
...
`abstract MinimumEigensolver.compute_minimum_eigenvalue(operator, aux_operators=None)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.43/qiskit/algorithms/minimum_eigensolvers/minimum_eigensolver.py "view source code")
...
`classmethod MinimumEigensolver.supports_aux_operators()`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.43/qiskit/algorithms/minimum_eigensolvers/minimum_eigensolver.py "view source code")
