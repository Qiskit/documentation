...
<Function id="qiskit.synthesis.synth_stabilizer_depth_lnn" name="synth_stabilizer_depth_lnn" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/synthesis/stabilizer/stabilizer_decompose.py" signature="synth_stabilizer_depth_lnn(stab)">
