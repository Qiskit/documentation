...
<Class id="qiskit.algorithms.gradients.FiniteDiffSamplerGradient" github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/algorithms/gradients/finite_diff_sampler_gradient.py" signature="FiniteDiffSamplerGradient(sampler, epsilon, options=None, *, method='central')">
