...
<Class id="qiskit.transpiler.passes.PadDelay" github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/transpiler/passes/scheduling/padding/pad_delay.py" signature="PadDelay(*args, **kwargs)">
  Bases: `BasePadding`
