...
<Class id="qiskit.opflow.state_fns.CircuitStateFn" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/opflow/state_fns/circuit_state_fn.py" signature="CircuitStateFn(*args, **kwargs)">
  ...
  **TypeError** – Unsupported primitive, or primitive has ClassicalRegisters.
  ...
  <Attribute id="qiskit.opflow.state_fns.CircuitStateFn.primitive" name="primitive" attributeTypeHint="QuantumCircuit">
