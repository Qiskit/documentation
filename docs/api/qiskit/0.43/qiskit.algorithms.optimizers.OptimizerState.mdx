---
title: OptimizerState (v0.43)
description: API reference for qiskit.algorithms.optimizers.OptimizerState in qiskit v0.43
...
<Class id="qiskit.algorithms.optimizers.OptimizerState" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/algorithms/optimizers/steppable_optimizer.py" signature="OptimizerState(x, fun, jac, nfev, njev, nit)" modifiers="class">
  Bases: `object`
