...
<Function id="qiskit.converters.circuit_to_dagdependency" name="circuit_to_dagdependency" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/converters/circuit_to_dagdependency.py" signature="circuit_to_dagdependency(circuit, create_preds_and_succs=True)">
