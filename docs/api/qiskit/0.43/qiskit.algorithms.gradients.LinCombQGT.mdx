---
title: LinCombQGT (v0.43)
description: API reference for qiskit.algorithms.gradients.LinCombQGT in qiskit v0.43
...
<Class id="qiskit.algorithms.gradients.LinCombQGT" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/algorithms/gradients/lin_comb_qgt.py" signature="LinCombQGT(estimator, phase_fix=True, derivative_type=DerivativeType.COMPLEX, options=None)" modifiers="class">
