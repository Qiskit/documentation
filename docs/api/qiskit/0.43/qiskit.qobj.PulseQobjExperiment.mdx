...
<Class id="qiskit.qobj.PulseQobjExperiment" github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/qobj/pulse_qobj.py" signature="PulseQobjExperiment(instructions, config=None, header=None)">
  Bases: `object`
