---
title: ApplyLayout (v0.43)
description: API reference for qiskit.transpiler.passes.ApplyLayout in qiskit v0.43
...
<Class id="qiskit.transpiler.passes.ApplyLayout" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/transpiler/passes/layout/apply_layout.py" signature="ApplyLayout(*args, **kwargs)" modifiers="class">
