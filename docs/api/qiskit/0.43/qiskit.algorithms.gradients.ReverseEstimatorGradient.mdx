...
<Class id="qiskit.algorithms.gradients.ReverseEstimatorGradient" github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/algorithms/gradients/reverse_gradient/reverse_gradient.py" signature="ReverseEstimatorGradient(derivative_type=DerivativeType.REAL)">
