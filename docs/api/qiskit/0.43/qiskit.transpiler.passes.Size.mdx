---
title: Size (v0.43)
description: API reference for qiskit.transpiler.passes.Size in qiskit v0.43
...
<Class id="qiskit.transpiler.passes.Size" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/transpiler/passes/analysis/size.py" signature="Size(*args, **kwargs)" modifiers="class">
