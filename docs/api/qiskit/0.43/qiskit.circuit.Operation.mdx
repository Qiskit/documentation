---
title: Operation (v0.43)
description: API reference for qiskit.circuit.Operation in qiskit v0.43
...
<Class id="qiskit.circuit.Operation" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/circuit/operation.py" signature="Operation" modifiers="class">
  Bases: `ABC`
  ...
  **Example**
  ...
  ![../\_images/qiskit-circuit-Operation-1.png](/docs/images/api/qiskit/0.43/qiskit-circuit-Operation-1.avif)
