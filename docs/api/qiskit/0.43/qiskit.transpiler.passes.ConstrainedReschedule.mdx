---
title: ConstrainedReschedule (v0.43)
description: API reference for qiskit.transpiler.passes.ConstrainedReschedule in qiskit v0.43
...
<Class id="qiskit.transpiler.passes.ConstrainedReschedule" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/transpiler/passes/scheduling/alignments/reschedule.py" signature="ConstrainedReschedule(*args, **kwargs)" modifiers="class">
