...
<Class id="qiskit.transpiler.passes.ConstrainedReschedule" github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/transpiler/passes/scheduling/alignments/reschedule.py" signature="ConstrainedReschedule(*args, **kwargs)">
