---
title: RGQFTMultiplier (v0.43)
description: API reference for qiskit.circuit.library.RGQFTMultiplier in qiskit v0.43
...
<Class id="qiskit.circuit.library.RGQFTMultiplier" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/circuit/library/arithmetic/multipliers/rg_qft_multiplier.py" signature="RGQFTMultiplier(num_state_qubits, num_result_qubits=None, name='RGQFTMultiplier')" modifiers="class">
  Bases: `Multiplier`
