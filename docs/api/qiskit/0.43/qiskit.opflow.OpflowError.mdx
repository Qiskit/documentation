...
<Class id="qiskit.opflow.OpflowError" name="OpflowError" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/opflow/exceptions.py" signature="OpflowError(*message)">
