...
<Class id="qiskit.result.LocalReadoutMitigator" github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/result/mitigation/local_readout_mitigator.py" signature="LocalReadoutMitigator(assignment_matrices=None, qubits=None, backend=None)">
