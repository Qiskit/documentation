---
title: LocalReadoutMitigator (v0.43)
description: API reference for qiskit.result.LocalReadoutMitigator in qiskit v0.43
...
<Class id="qiskit.result.LocalReadoutMitigator" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/result/mitigation/local_readout_mitigator.py" signature="LocalReadoutMitigator(assignment_matrices=None, qubits=None, backend=None)" modifiers="class">
