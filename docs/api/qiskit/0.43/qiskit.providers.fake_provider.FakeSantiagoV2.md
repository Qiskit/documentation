...
`FakeSantiagoV2`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.43/qiskit/providers/fake_provider/backends/santiago/fake_santiago.py "view source code")
...
<span id="qiskit-providers-fake-provider-fakesantiagov2-acquire-channel" />

### acquire\_channel

<span id="qiskit.providers.fake_provider.FakeSantiagoV2.acquire_channel" />

`FakeSantiagoV2.acquire_channel(qubit)`
...
<span id="qiskit-providers-fake-provider-fakesantiagov2-control-channel" />

### control\_channel

<span id="qiskit.providers.fake_provider.FakeSantiagoV2.control_channel" />

`FakeSantiagoV2.control_channel(qubits)`
...
<span id="qiskit-providers-fake-provider-fakesantiagov2-drive-channel" />

### drive\_channel

<span id="qiskit.providers.fake_provider.FakeSantiagoV2.drive_channel" />

`FakeSantiagoV2.drive_channel(qubit)`
...
<span id="qiskit-providers-fake-provider-fakesantiagov2-measure-channel" />

### measure\_channel

<span id="qiskit.providers.fake_provider.FakeSantiagoV2.measure_channel" />

`FakeSantiagoV2.measure_channel(qubit)`
...
<span id="qiskit-providers-fake-provider-fakesantiagov2-qubit-properties" />

### qubit\_properties

<span id="qiskit.providers.fake_provider.FakeSantiagoV2.qubit_properties" />

`FakeSantiagoV2.qubit_properties(qubit)`
...
<span id="qiskit-providers-fake-provider-fakesantiagov2-run" />

### run

<span id="qiskit.providers.fake_provider.FakeSantiagoV2.run" />

`FakeSantiagoV2.run(run_input, **options)`
...
<span id="qiskit-providers-fake-provider-fakesantiagov2-set-options" />

### set\_options

<span id="qiskit.providers.fake_provider.FakeSantiagoV2.set_options" />

`FakeSantiagoV2.set_options(**fields)`
...
`= '/home/computertreker/git/qiskit/qiskit/.tox/docs/lib/python3.8/site-packages/qiskit/providers/fake_provider/backends/santiago'`
