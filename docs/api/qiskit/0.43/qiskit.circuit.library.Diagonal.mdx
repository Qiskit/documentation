...
<Class id="qiskit.circuit.library.Diagonal" github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/circuit/library/generalized_gates/diagonal.py" signature="Diagonal(diag)">
