...
<Class id="qiskit.circuit.library.Diagonal" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/circuit/library/generalized_gates/diagonal.py" signature="Diagonal(diag)">
...
$$
  ...
  **CircuitError** – if the list of the diagonal entries or the qubit list is in bad format; if the number of diagonal entries is not 2^k, where k denotes the number of qubits
  ...
  <Attribute id="qiskit.circuit.library.Diagonal.ancillas" name="ancillas">
    Returns a list of ancilla bits in the order that the registers were added.
  </Attribute>

  ### calibrations

  <Attribute id="qiskit.circuit.library.Diagonal.calibrations" name="calibrations">
  ...
  <Attribute id="qiskit.circuit.library.Diagonal.extension_lib" name="extension_lib" attributeValue="= 'include &#x22;qelib1.inc&#x22;;'" />

  ### global\_phase

  <Attribute id="qiskit.circuit.library.Diagonal.global_phase" name="global_phase">
    Return the global phase of the circuit in radians.
  </Attribute>

  ### header

  <Attribute id="qiskit.circuit.library.Diagonal.header" name="header" attributeValue="= 'OPENQASM 2.0;'" />

  ### instances

  <Attribute id="qiskit.circuit.library.Diagonal.instances" name="instances" attributeValue="= 121" />

  ### layout

  <Attribute id="qiskit.circuit.library.Diagonal.layout" name="layout">
  ...
  <Attribute id="qiskit.circuit.library.Diagonal.metadata" name="metadata">
  ...
  <Attribute id="qiskit.circuit.library.Diagonal.num_ancillas" name="num_ancillas">
  ...
  <Attribute id="qiskit.circuit.library.Diagonal.op_start_times" name="op_start_times">
  ...
  <Attribute id="qiskit.circuit.library.Diagonal.prefix" name="prefix" attributeValue="= 'circuit'" />
