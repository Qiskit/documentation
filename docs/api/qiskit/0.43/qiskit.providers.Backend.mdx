---
title: Backend (v0.43)
description: API reference for qiskit.providers.Backend in qiskit v0.43
...
<Class id="qiskit.providers.Backend" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/providers/backend.py" signature="Backend" modifiers="class">
  Bases: `object`
