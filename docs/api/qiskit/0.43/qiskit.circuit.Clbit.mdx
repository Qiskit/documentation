---
title: Clbit (v0.43)
description: API reference for qiskit.circuit.Clbit in qiskit v0.43
...
<Class id="qiskit.circuit.Clbit" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/circuit/classicalregister.py" signature="Clbit(register=None, index=None)" modifiers="class">
