...
<Function id="qiskit.circuit.library.rzx_zz1" github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/circuit/library/templates/rzx/rzx_zz1.py" signature="rzx_zz1(theta=None)">
