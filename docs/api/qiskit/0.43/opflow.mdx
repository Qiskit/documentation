---
title: opflow (v0.43)
description: API reference for qiskit.opflow in qiskit v0.43
...
|                                                                                                                        |                                                                            |
| ---------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------- |
| [`commutator`](qiskit.opflow.commutator "qiskit.opflow.commutator")(op\_a, op\_b)                                      | Deprecated: Compute commutator of op\_a and op\_b.                         |
| [`anti_commutator`](qiskit.opflow.anti_commutator "qiskit.opflow.anti_commutator")(op\_a, op\_b)                       | Deprecated: Compute anti-commutator of op\_a and op\_b.                    |
| [`double_commutator`](qiskit.opflow.double_commutator "qiskit.opflow.double_commutator")(op\_a, op\_b, op\_c\[, sign]) | Deprecated: Compute symmetric double commutator of op\_a, op\_b and op\_c. |

## Exceptions

|                                                                                   |                                         |
| --------------------------------------------------------------------------------- | --------------------------------------- |
| [`OpflowError`](qiskit.opflow.OpflowError "qiskit.opflow.OpflowError")(\*message) | Deprecated: For Opflow specific errors. |
