---
title: GRY (v0.43)
description: API reference for qiskit.circuit.library.GRY in qiskit v0.43
...
<Class id="qiskit.circuit.library.GRY" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/circuit/library/generalized_gates/gr.py" signature="GRY(num_qubits, theta)" modifiers="class">
...
$$
  ...
  **Expanded Circuit:**
  ...
  ![../\_images/qiskit-circuit-library-GRY-1.png](/docs/images/api/qiskit/0.43/qiskit-circuit-library-GRY-1.avif)
  ...
  *   **theta** (*float*) – rotation angle about y-axis
  ...
  <Attribute id="qiskit.circuit.library.GRY.instances" attributeValue="136" />
