---
title: Play (v0.43)
description: API reference for qiskit.pulse.instructions.Play in qiskit v0.43
...
<Class id="qiskit.pulse.instructions.Play" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/pulse/instructions/play.py" signature="Play(pulse, channel, name=None)" modifiers="class">
