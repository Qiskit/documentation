...
<Class id="qiskit.transpiler.FlowController" github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/transpiler/runningpassmanager.py" signature="FlowController(passes, options, **partial_controller)">
  Bases: `object`
