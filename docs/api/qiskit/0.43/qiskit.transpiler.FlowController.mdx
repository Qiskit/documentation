...
<Class id="qiskit.transpiler.FlowController" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/transpiler/runningpassmanager.py" signature="FlowController(passes, options, **partial_controller)">
  Bases: `object`
  ...
  <Function id="qiskit.transpiler.FlowController.add_flow_controller" name="add_flow_controller" signature="classmethod FlowController.add_flow_controller(name, controller)">
  ...
  <Function id="qiskit.transpiler.FlowController.controller_factory" name="controller_factory" signature="classmethod FlowController.controller_factory(passes, options, **partial_controller)">
  ...
  <Function id="qiskit.transpiler.FlowController.dump_passes" name="dump_passes" signature="FlowController.dump_passes()">
  ...
  <Function id="qiskit.transpiler.FlowController.remove_flow_controller" name="remove_flow_controller" signature="classmethod FlowController.remove_flow_controller(name)">
