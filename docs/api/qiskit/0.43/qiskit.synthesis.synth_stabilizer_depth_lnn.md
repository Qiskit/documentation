...
`synth_stabilizer_depth_lnn(stab)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.43/qiskit/synthesis/stabilizer/stabilizer_decompose.py "view source code")
