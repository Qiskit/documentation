---
title: RYYGate (v0.43)
description: API reference for qiskit.circuit.library.RYYGate in qiskit v0.43
...
<Class id="qiskit.circuit.library.RYYGate" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/circuit/library/standard_gates/ryy.py" signature="RYYGate(theta, label=None)" modifiers="class">
