---
title: ValidatePulseGates (v0.43)
description: API reference for qiskit.transpiler.passes.ValidatePulseGates in qiskit v0.43
...
<Class id="qiskit.transpiler.passes.ValidatePulseGates" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.24/qiskit/transpiler/passes/scheduling/alignments/pulse_gate_validation.py" signature="ValidatePulseGates(*args, **kwargs)" modifiers="class">
