...
<Class id="qiskit.transpiler.InstructionDurations" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.0/qiskit/transpiler/instruction_durations.py#L26-L268" signature="qiskit.transpiler.InstructionDurations(instruction_durations=None, dt=None)">
  ...
  <Function id="qiskit.transpiler.InstructionDurations.from_backend" name="from_backend" github="https://github.com/Qiskit/qiskit/tree/stable/1.0/qiskit/transpiler/instruction_durations.py#L65-L97" signature="classmethod from_backend(backend)">
  ...
  <Function id="qiskit.transpiler.InstructionDurations.get" name="get" github="https://github.com/Qiskit/qiskit/tree/stable/1.0/qiskit/transpiler/instruction_durations.py#L165-L206" signature="get(inst, qubits, unit='dt', parameters=None)">
  ...
  <Function id="qiskit.transpiler.InstructionDurations.units_used" name="units_used" github="https://github.com/Qiskit/qiskit/tree/stable/1.0/qiskit/transpiler/instruction_durations.py#L257-L268" signature="units_used()">
  ...
  <Function id="qiskit.transpiler.InstructionDurations.update" name="update" github="https://github.com/Qiskit/qiskit/tree/stable/1.0/qiskit/transpiler/instruction_durations.py#L99-L163" signature="update(inst_durations, dt=None)">
