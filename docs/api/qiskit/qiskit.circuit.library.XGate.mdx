...
<Class id="qiskit.circuit.library.XGate" github="https://github.com/Qiskit/qiskit/tree/stable/1.0/qiskit/circuit/library/standard_gates/x.py#L26-L148" signature="qiskit.circuit.library.XGate(*args, _force_mutable=False, **kwargs)">
