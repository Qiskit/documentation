...
<Class id="qiskit.circuit.library.XGate" github="https://github.com/qiskit/qiskit/tree/stable/1.0/qiskit/circuit/library/standard_gates/x.py" signature="qiskit.circuit.library.XGate(*args, _force_mutable=False, **kwargs)">
...
$$
  ...
  <Function id="qiskit.circuit.library.XGate.control" name="control" signature="control(num_ctrl_qubits=1, label=None, ctrl_state=None, annotated=False)">
  ...
  <Function id="qiskit.circuit.library.XGate.inverse" name="inverse" signature="inverse(annotated=False)">
