...
<Class id="qiskit.circuit.library.XGate" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.0/qiskit/circuit/library/standard_gates/x.py#L26-L148" signature="qiskit.circuit.library.XGate(*args, _force_mutable=False, **kwargs)">
...
$$
  ...
  <Attribute id="qiskit.circuit.library.XGate.base_class" name="base_class">
  ...
  <Attribute id="qiskit.circuit.library.XGate.condition" name="condition">
    The classical condition on the instruction.
  </Attribute>

  ### condition\_bits

  <Attribute id="qiskit.circuit.library.XGate.condition_bits" name="condition_bits">
  ...
  <Attribute id="qiskit.circuit.library.XGate.duration" name="duration">
    Get the duration.
  </Attribute>

  ### label

  <Attribute id="qiskit.circuit.library.XGate.label" name="label">
    Return instruction label
  </Attribute>

  ### mutable

  <Attribute id="qiskit.circuit.library.XGate.mutable" name="mutable">
  ...
  <Attribute id="qiskit.circuit.library.XGate.name" name="name">
    Return the name.
  </Attribute>

  ### num\_clbits

  <Attribute id="qiskit.circuit.library.XGate.num_clbits" name="num_clbits">
    Return the number of clbits.
  </Attribute>

  ### num\_qubits

  <Attribute id="qiskit.circuit.library.XGate.num_qubits" name="num_qubits">
  ...
  <Attribute id="qiskit.circuit.library.XGate.unit" name="unit">
  ...
  <Function id="qiskit.circuit.library.XGate.control" name="control" github="https://github.com/Qiskit/qiskit/tree/stable/1.0/qiskit/circuit/library/standard_gates/x.py#L95-L131" signature="control(num_ctrl_qubits=1, label=None, ctrl_state=None, annotated=False)">
  ...
  <Function id="qiskit.circuit.library.XGate.inverse" name="inverse" github="https://github.com/Qiskit/qiskit/tree/stable/1.0/qiskit/circuit/library/standard_gates/x.py#L133-L145" signature="inverse(annotated=False)">
