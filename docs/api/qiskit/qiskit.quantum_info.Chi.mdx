...
<Class id="qiskit.quantum_info.Chi" github="https://github.com/Qiskit/qiskit/tree/stable/1.0/qiskit/quantum_info/operators/channel/chi.py#L33-L186" signature="qiskit.quantum_info.Chi(data, input_dims=None, output_dims=None)">
