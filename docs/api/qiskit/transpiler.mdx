...
![Circuit diagram output by the previous code.](/images/api/qiskit/transpiler-4.avif)
...
![Circuit diagram output by the previous code.](/images/api/qiskit/transpiler-5.avif)
...
2.  A Toffoli, or controlled-controlled-not gate (`ccx`), is a three-qubit gate. Given that our basis gate set includes only single- and two-qubit gates, it is obvious that this gate must be decomposed. This decomposition is quite costly:
    ...
    ![Circuit diagram output by the previous code.](/images/api/qiskit/transpiler-6.avif)
...
![Diagram illustrating how virtual qubits are mapped to physical qubits.](/images/api/qiskit/mapping.avif)
...
*   **Layout Using Optimization Level 0**
    ...
    > ```
    >
    > ![Output from the previous code.](/images/api/qiskit/transpiler-8.avif)
...
*   **Layout Using Optimization Level 3**
    ...
    > ```
    >
    > ![Output from the previous code.](/images/api/qiskit/transpiler-9.avif)
...
![Output from the previous code.](/images/api/qiskit/transpiler-10.avif)
...
![Diagram illustrating the previously described circuit.](/images/api/qiskit/transpiler-11.avif)
...
![Output from the previous code.](/images/api/qiskit/transpiler-12.avif)
...
![Diagram illustrating the previously described circuit.](/images/api/qiskit/transpiler-13.avif)
...
![Output from the previous code.](/images/api/qiskit/transpiler-14.avif)
...
![Diagram illustrating the previously described circuit.](/images/api/qiskit/transpiler-15.avif)
...
![Circuit diagram output by the previous code.](/images/api/qiskit/transpiler-16.avif)
...
![Output from circuit timeline drawer.](/images/api/qiskit/transpiler-17.avif)
