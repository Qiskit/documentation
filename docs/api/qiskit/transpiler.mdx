...
![The transpilation process takes the input circuit, applies the transpilation       passes, then produces the output circuit.](/images/api/qiskit/transpiling_core_steps.png)
...
![Circuit diagram output by the previous code.](/images/api/qiskit/transpiler-4.png)
...
![Circuit diagram output by the previous code.](/images/api/qiskit/transpiler-5.png)
...
2.  A Toffoli, or controlled-controlled-not gate (`ccx`), is a three-qubit gate. Given that our basis gate set includes only single- and two-qubit gates, it is obvious that this gate must be decomposed. This decomposition is quite costly:
    ...
    ![Circuit diagram output by the previous code.](/images/api/qiskit/transpiler-6.png)
...
![Diagram illustrating how virtual qubits are mapped to physical qubits.](/images/api/qiskit/mapping.png)
...
![Circuit diagram output by the previous code.](/images/api/qiskit/transpiler-7.png)
...
*   **Layout Using Optimization Level 0**
    ...
    > ```
    >
    > ![Output from the previous code.](/images/api/qiskit/transpiler-8.png)
...
*   **Layout Using Optimization Level 3**
    ...
    > ```
    >
    > ![Output from the previous code.](/images/api/qiskit/transpiler-9.png)
...
![Output from the previous code.](/images/api/qiskit/transpiler-10.png)
...
![Diagram illustrating the previously described circuit.](/images/api/qiskit/transpiler-11.png)
...
![Output from the previous code.](/images/api/qiskit/transpiler-12.png)
...
![Diagram illustrating the previously described circuit.](/images/api/qiskit/transpiler-13.png)
...
![Output from the previous code.](/images/api/qiskit/transpiler-14.png)
...
![Diagram illustrating the previously described circuit.](/images/api/qiskit/transpiler-15.png)
...
![Circuit diagram output by the previous code.](/images/api/qiskit/transpiler-16.png)
...
![Output from circuit timeline drawer.](/images/api/qiskit/transpiler-17.png)
