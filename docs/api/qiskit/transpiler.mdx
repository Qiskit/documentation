...
![Diagram illustrating the previously described circuit.](/images/api/qiskit/transpiler-8.avif)
...
![Circuit diagram output by the previous code.](/images/api/qiskit/transpiler-9.avif)
...
![Output from circuit timeline drawer.](/images/api/qiskit/transpiler-10.avif)
