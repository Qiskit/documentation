...
<Function id="qiskit.circuit.classicalfunction.classical_function" github="https://github.com/Qiskit/qiskit/tree/stable/1.1/qiskit/circuit/classicalfunction/__init__.py#L124-L140" signature="qiskit.circuit.classicalfunction.classical_function(func)">
