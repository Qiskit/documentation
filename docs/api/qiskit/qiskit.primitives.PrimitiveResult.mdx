...
<Class id="qiskit.primitives.PrimitiveResult" github="https://github.com/qiskit/qiskit/tree/stable/1.0/qiskit/primitives/containers/primitive_result.py" signature="qiskit.primitives.PrimitiveResult(pub_results, metadata=None)">
