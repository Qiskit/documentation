...
<Class id="qiskit.synthesis.TwoQubitBasisDecomposer" github="https://github.com/qiskit/qiskit/tree/stable/1.0/qiskit/synthesis/two_qubit/two_qubit_decompose.py" signature="qiskit.synthesis.TwoQubitBasisDecomposer(gate, basis_fidelity=1.0, euler_basis='U', pulse_optimize=None)">
  ...
  *   **pulse\_optimize** ([*bool*](https://docs.python.org/3/library/functions.html#bool "(in Python v3.12)") *| None*) – If `True`, try to do decomposition which minimizes local unitaries in between entangling gates. This will raise an exception if an optimal decomposition is not implemented. Currently, only \[\{CX, SX, RZ}] is known. If `False`, don’t attempt optimization. If `None`, attempt optimization but don’t raise if unknown.
  ...
  <Function id="qiskit.synthesis.TwoQubitBasisDecomposer.__call__" name="__call__" signature="__call__(unitary, basis_fidelity=None, approximate=True, *, _num_basis_uses=None)">
...
$$
  ...
  <Function id="qiskit.synthesis.TwoQubitBasisDecomposer.decomp1" name="decomp1" signature="decomp1(target)">
...
$$
  ...
  <Function id="qiskit.synthesis.TwoQubitBasisDecomposer.decomp2_supercontrolled" name="decomp2_supercontrolled" signature="decomp2_supercontrolled(target)">
...
$$
  ...
  <Function id="qiskit.synthesis.TwoQubitBasisDecomposer.decomp3_supercontrolled" name="decomp3_supercontrolled" signature="decomp3_supercontrolled(target)">
  ...
  <Function id="qiskit.synthesis.TwoQubitBasisDecomposer.traces" name="traces" signature="traces(target)">
