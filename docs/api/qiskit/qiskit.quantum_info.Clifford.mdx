...
<Class id="qiskit.quantum_info.Clifford" github="https://github.com/Qiskit/qiskit/tree/stable/1.0/qiskit/quantum_info/operators/symplectic/clifford.py#L38-L999" signature="qiskit.quantum_info.Clifford(data, validate=True, copy=True)">
