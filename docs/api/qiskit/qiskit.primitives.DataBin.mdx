...
<Class id="qiskit.primitives.DataBin" github="https://github.com/qiskit/qiskit/tree/stable/1.0/qiskit/primitives/containers/data_bin.py" signature="qiskit.primitives.DataBin">
