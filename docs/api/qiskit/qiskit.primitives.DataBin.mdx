...
<Class id="qiskit.primitives.DataBin" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/primitives/containers/data_bin.py#L33-L171" signature="qiskit.primitives.DataBin(*, shape=(), **data)" modifiers="class">
  Bases: `ShapedMixin`
  ...
  *   [**ValueError**](https://docs.python.org/3/library/exceptions.html#ValueError) – If some value is inconsistent with the provided shape.
  ...
  <Attribute id="qiskit.primitives.DataBin.ndim" name="ndim" headingLevel={3} />

  <Attribute id="qiskit.primitives.DataBin.shape" name="shape" headingLevel={3} />

  <Attribute id="qiskit.primitives.DataBin.size" name="size" headingLevel={3} />

  ## Methods

  ### items

  <Function id="qiskit.primitives.DataBin.items" github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/primitives/containers/data_bin.py#L153-L155" signature="items()">
  ...
  <Function id="qiskit.primitives.DataBin.keys" github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/primitives/containers/data_bin.py#L145-L147" signature="keys()">
  ...
  <Function id="qiskit.primitives.DataBin.values" github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/primitives/containers/data_bin.py#L149-L151" signature="values()">
