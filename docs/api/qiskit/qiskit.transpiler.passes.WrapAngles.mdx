...
<Class id="qiskit.transpiler.passes.WrapAngles" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/transpiler/passes/utils/wrap_angles.py#L21-L108" signature="qiskit.transpiler.passes.WrapAngles(*args, **kwargs)" modifiers="class">
  ...
  *   **registry** ([*WrapAngleRegistry*](qiskit.transpiler.WrapAngleRegistry "qiskit.transpiler.WrapAngleRegistry")) –
  ...
  <Attribute id="qiskit.transpiler.passes.WrapAngles.DEFAULT_REGISTRY" name="DEFAULT_REGISTRY" headingLevel={3}>
    <AttributeTypeHint>= {"<qiskit._accelerate.angle_bound_registry.WrapAngleRegistry"} {"object>"}</AttributeTypeHint>
  ...
  <Attribute id="qiskit.transpiler.passes.WrapAngles.is_analysis_pass" name="is_analysis_pass" headingLevel={3}>
    Check if the pass is an analysis pass.

    If the pass is an AnalysisPass, that means that the pass can analyze the DAG and write the results of that analysis in the property set. Modifications on the DAG are not allowed by this kind of pass.
  </Attribute>

  <Attribute id="qiskit.transpiler.passes.WrapAngles.is_transformation_pass" name="is_transformation_pass" headingLevel={3}>
