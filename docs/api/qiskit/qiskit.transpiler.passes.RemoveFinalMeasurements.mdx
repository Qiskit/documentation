...
<Class id="qiskit.transpiler.passes.RemoveFinalMeasurements" github="https://github.com/qiskit/qiskit/tree/stable/1.0/qiskit/transpiler/passes/utils/remove_final_measurements.py" signature="qiskit.transpiler.passes.RemoveFinalMeasurements(*args, **kwargs)">
