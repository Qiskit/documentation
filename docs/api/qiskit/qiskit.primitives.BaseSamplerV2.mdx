...
<Class id="qiskit.primitives.BaseSamplerV2" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/2.2/qiskit/primitives/base/base_sampler.py#L35-L74" signature="qiskit.primitives.BaseSamplerV2" modifiers="class">
  ...
  <Function id="qiskit.primitives.BaseSamplerV2.run" github="https://github.com/Qiskit/qiskit/tree/stable/2.2/qiskit/primitives/base/base_sampler.py#L59-L74" signature="run(pubs, *, shots=None)" modifiers="abstract">
