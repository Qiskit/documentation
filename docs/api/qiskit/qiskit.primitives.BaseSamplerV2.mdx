...
<Class id="qiskit.primitives.BaseSamplerV2" github="https://github.com/qiskit/qiskit/tree/stable/1.0/qiskit/primitives/base/base_sampler.py" signature="qiskit.primitives.BaseSamplerV2">
  ...
  <Function id="qiskit.primitives.BaseSamplerV2.run" name="run" signature="abstract run(pubs, *, shots=None)">
