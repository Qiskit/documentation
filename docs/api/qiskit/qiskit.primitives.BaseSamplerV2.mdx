...
<Class id="qiskit.primitives.BaseSamplerV2" github="https://github.com/Qiskit/qiskit/tree/stable/1.0/qiskit/primitives/base/base_sampler.py#L156-L180" signature="qiskit.primitives.BaseSamplerV2">
