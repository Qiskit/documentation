...
<Class id="qiskit.synthesis.unitary.aqc.ApproximatingObjective" github="https://github.com/qiskit/qiskit/tree/stable/1.0/qiskit/synthesis/unitary/aqc/approximate.py" signature="qiskit.synthesis.unitary.aqc.ApproximatingObjective">
  ...
  <Function id="qiskit.synthesis.unitary.aqc.ApproximatingObjective.gradient" name="gradient" signature="abstract gradient(param_values)">
  ...
  <Function id="qiskit.synthesis.unitary.aqc.ApproximatingObjective.objective" name="objective" signature="abstract objective(param_values)">
