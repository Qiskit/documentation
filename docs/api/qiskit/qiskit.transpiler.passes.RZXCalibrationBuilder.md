...
`qiskit.transpiler.passes.RZXCalibrationBuilder(*args, **kwargs)` [GitHub](https://github.com/qiskit/qiskit/tree/stable/1.0/qiskit/transpiler/passes/calibration/rzx_builder.py "view source code")
...
<span id="qiskit.transpiler.passes.RZXCalibrationBuilder.execute" />
...
<span id="qiskit.transpiler.passes.RZXCalibrationBuilder.update_status" />
