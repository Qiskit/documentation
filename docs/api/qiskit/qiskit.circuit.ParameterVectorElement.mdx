...
<Class id="qiskit.circuit.ParameterVectorElement" isDedicatedPage={true} signature="qiskit.circuit.ParameterVectorElement(vector, index, uuid=None)" modifiers="class">
  ...
  <Attribute id="qiskit.circuit.ParameterVectorElement.index" name="index" headingLevel={3}>
    Get the index of this element in the parent vector.
  </Attribute>

  <Attribute id="qiskit.circuit.ParameterVectorElement.name" name="name" headingLevel={3}>
    Returns the name of the [`Parameter`](qiskit.circuit.Parameter "qiskit.circuit.Parameter").
  </Attribute>

  <Attribute id="qiskit.circuit.ParameterVectorElement.num_parameters" name="num_parameters" headingLevel={3}>
  ...
  <Attribute id="qiskit.circuit.ParameterVectorElement.parameters" name="parameters" headingLevel={3}>
  ...
  <Attribute id="qiskit.circuit.ParameterVectorElement.uuid" name="uuid" headingLevel={3}>
  ...
  <Attribute id="qiskit.circuit.ParameterVectorElement.vector" name="vector" headingLevel={3}>
