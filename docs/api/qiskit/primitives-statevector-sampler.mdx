...
<Class id="qiskit.primitives.StatevectorSampler" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.3/qiskit/primitives/statevector_sampler.py#L52-L203" signature="qiskit.primitives.StatevectorSampler(*, default_shots=1024, seed=None)" modifiers="class">
  Bases: [`BaseSamplerV2`](primitives-base-sampler-v-2 "qiskit.primitives.base.base_sampler.BaseSamplerV2")

  Simple implementation of [`BaseSamplerV2`](primitives-base-sampler-v-2 "qiskit.primitives.BaseSamplerV2") using full state vector simulation.

  This class is implemented via [`Statevector`](quantum-info-statevector "qiskit.quantum_info.Statevector") which turns provided circuits into pure state vectors, and is therefore incompatible with mid-circuit measurements (although other implementations may be).
  ...
  *   **seed** (*np.random.Generator |* [*int*](https://docs.python.org/3/library/functions.html#int "(in Python v3.13)") *| None*) – The seed or Generator object for random number generation. If None, a random seeded default RNG will be used.
  ...
  <Function id="qiskit.primitives.StatevectorSampler.run" github="https://github.com/Qiskit/qiskit/tree/stable/1.3/qiskit/primitives/statevector_sampler.py#L155-L170" signature="run(pubs, *, shots=None)">
