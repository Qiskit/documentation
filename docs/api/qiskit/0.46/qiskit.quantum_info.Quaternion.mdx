...
<Class id="qiskit.quantum_info.Quaternion" github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/quantum_info/quaternion.py" signature="qiskit.quantum_info.Quaternion(data)">
