...
<Class id="qiskit.providers.fake_provider.FakeLondonV2" github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/providers/fake_provider/backends/london/fake_london.py" signature="qiskit.providers.fake_provider.FakeLondonV2">
