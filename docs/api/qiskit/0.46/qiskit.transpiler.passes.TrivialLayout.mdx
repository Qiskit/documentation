---
title: TrivialLayout (v0.46)
description: API reference for qiskit.transpiler.passes.TrivialLayout in qiskit v0.46
...
<Class id="qiskit.transpiler.passes.TrivialLayout" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/transpiler/passes/layout/trivial_layout.py" signature="qiskit.transpiler.passes.TrivialLayout(*args, **kwargs)" modifiers="class">
  ...
  **Raises**
  ...
  <Function id="qiskit.transpiler.passes.TrivialLayout.execute" signature="execute(passmanager_ir, state, callback=None)">
  ...
  <Function id="qiskit.transpiler.passes.TrivialLayout.update_status" signature="update_status(state, run_state)">
