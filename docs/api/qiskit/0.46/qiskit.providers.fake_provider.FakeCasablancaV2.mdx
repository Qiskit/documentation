...
<Class id="qiskit.providers.fake_provider.FakeCasablancaV2" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/providers/fake_provider/backends/casablanca/fake_casablanca.py" signature="qiskit.providers.fake_provider.FakeCasablancaV2">
