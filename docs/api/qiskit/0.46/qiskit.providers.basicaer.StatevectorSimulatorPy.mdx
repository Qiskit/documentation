...
<Class id="qiskit.providers.basicaer.StatevectorSimulatorPy" github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/providers/basicaer/statevector_simulator.py" signature="qiskit.providers.basicaer.StatevectorSimulatorPy(configuration=None, provider=None, **fields)">
