...
<Class id="qiskit.providers.basicaer.StatevectorSimulatorPy" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/providers/basicaer/statevector_simulator.py" signature="qiskit.providers.basicaer.StatevectorSimulatorPy(configuration=None, provider=None, **fields)">
  ...
  <Attribute id="qiskit.providers.basicaer.StatevectorSimulatorPy.MAX_QUBITS_MEMORY" name="MAX_QUBITS_MEMORY" attributeValue="= 29" />
  ...
  <Function id="qiskit.providers.basicaer.StatevectorSimulatorPy.configuration" name="configuration" signature="configuration()">
  ...
  <Function id="qiskit.providers.basicaer.StatevectorSimulatorPy.name" name="name" signature="name()">
  ...
  <Function id="qiskit.providers.basicaer.StatevectorSimulatorPy.properties" name="properties" signature="properties()">
  ...
  <Function id="qiskit.providers.basicaer.StatevectorSimulatorPy.provider" name="provider" signature="provider()">
  ...
  <Function id="qiskit.providers.basicaer.StatevectorSimulatorPy.run" name="run" signature="run(run_input, **backend_options)">
    Run on the backend.
  ...
  <Function id="qiskit.providers.basicaer.StatevectorSimulatorPy.run_experiment" name="run_experiment" signature="run_experiment(experiment)">
  ...
  <Function id="qiskit.providers.basicaer.StatevectorSimulatorPy.set_options" name="set_options" signature="set_options(**fields)">
  ...
  <Function id="qiskit.providers.basicaer.StatevectorSimulatorPy.status" name="status" signature="status()">
