...
<Class id="qiskit.algorithms.gradients.ParamShiftEstimatorGradient" github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/algorithms/gradients/param_shift/param_shift_estimator_gradient.py" signature="qiskit.algorithms.gradients.ParamShiftEstimatorGradient(estimator, options=None, derivative_type=DerivativeType.REAL)">
