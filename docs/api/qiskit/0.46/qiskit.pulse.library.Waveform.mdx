---
title: Waveform (v0.46)
description: API reference for qiskit.pulse.library.Waveform in qiskit v0.46
...
<Class id="qiskit.pulse.library.Waveform" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/pulse/library/waveform.py" signature="qiskit.pulse.library.Waveform(samples, name=None, epsilon=1e-07, limit_amplitude=None)" modifiers="class">
  Bases: `Pulse`
  ...
  *   **samples** ([*ndarray*](https://numpy.org/doc/stable/reference/generated/numpy.ndarray.html#numpy.ndarray)  *|*[*List*](https://docs.python.org/3/library/typing.html#typing.List)*\[*[*complex*](https://docs.python.org/3/library/functions.html#complex)*]*) – Complex array of the samples in the pulse envelope.
  ...
  *   **limit\_amplitude** ([*bool*](https://docs.python.org/3/library/functions.html#bool) *| None*) – Passed to parent Pulse
  ...
  <Function id="qiskit.pulse.library.Waveform.draw" signature="draw(style=None, backend=None, time_range=None, time_unit='dt', show_waveform_info=True, plotter='mpl2d', axis=None)">
  ...
  <Function id="qiskit.pulse.library.Waveform.is_parameterized" signature="is_parameterized()">
