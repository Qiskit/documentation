---
title: UCRYGate (v0.46)
description: API reference for qiskit.circuit.library.UCRYGate in qiskit v0.46
...
<Class id="qiskit.circuit.library.UCRYGate" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/circuit/library/generalized_gates/ucry.py" signature="qiskit.circuit.library.UCRYGate(angle_list)" modifiers="class">
