---
title: RGate (v0.46)
description: API reference for qiskit.circuit.library.RGate in qiskit v0.46
...
<Class id="qiskit.circuit.library.RGate" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/circuit/library/standard_gates/r.py" signature="qiskit.circuit.library.RGate(theta, phi, label=None, *, duration=None, unit='dt')" modifiers="class">
