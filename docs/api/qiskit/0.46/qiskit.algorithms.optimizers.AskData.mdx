...
<Class id="qiskit.algorithms.optimizers.AskData" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/algorithms/optimizers/steppable_optimizer.py" signature="qiskit.algorithms.optimizers.AskData(x_fun=None, x_jac=None)">
  ...
  *   **optimizer.** –
  ...
  <Attribute id="qiskit.algorithms.optimizers.AskData.x_fun" name="x_fun" attributeTypeHint="POINT | list[POINT] | None" attributeValue="= None" />

  ### x\_jac

  <Attribute id="qiskit.algorithms.optimizers.AskData.x_jac" name="x_jac" attributeTypeHint="POINT | list[POINT] | None" attributeValue="= None" />
</Class>
