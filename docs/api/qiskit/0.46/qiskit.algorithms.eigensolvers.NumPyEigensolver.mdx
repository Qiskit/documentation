...
description: API reference for qiskit.algorithms.eigensolvers.NumPyEigensolver in qiskit v0.46
...
<Class id="qiskit.algorithms.eigensolvers.NumPyEigensolver" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/algorithms/eigensolvers/numpy_eigensolver.py" signature="qiskit.algorithms.eigensolvers.NumPyEigensolver(k=1, filter_criterion=None)" modifiers="class">
  ...
  *   **k** ([*int*](https://docs.python.org/3/library/functions.html#int)) – Number of eigenvalues are to be computed, with a minimum value of 1.
