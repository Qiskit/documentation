---
title: RealTimeEvolver (v0.46)
description: API reference for qiskit.algorithms.RealTimeEvolver in qiskit v0.46
...
<Class id="qiskit.algorithms.RealTimeEvolver" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/algorithms/time_evolvers/real_time_evolver.py" signature="qiskit.algorithms.RealTimeEvolver" modifiers="class">
