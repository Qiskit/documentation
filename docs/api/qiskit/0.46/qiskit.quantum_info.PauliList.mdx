---
title: PauliList (v0.46)
description: API reference for qiskit.quantum_info.PauliList in qiskit v0.46
...
<Class id="qiskit.quantum_info.PauliList" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/quantum_info/operators/symplectic/pauli_list.py" signature="qiskit.quantum_info.PauliList(data)" modifiers="class">
