---
title: ZGate (v0.46)
description: API reference for qiskit.circuit.library.ZGate in qiskit v0.46
...
<Class id="qiskit.circuit.library.ZGate" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/circuit/library/standard_gates/z.py" signature="qiskit.circuit.library.ZGate(*args, _force_mutable=False, **kwargs)" modifiers="class">
