---
title: MinimumEigensolver (v0.46)
description: API reference for qiskit.algorithms.MinimumEigensolver in qiskit v0.46
...
<Class id="qiskit.algorithms.MinimumEigensolver" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/algorithms/minimum_eigen_solvers/minimum_eigen_solver.py" signature="qiskit.algorithms.MinimumEigensolver" modifiers="class">
