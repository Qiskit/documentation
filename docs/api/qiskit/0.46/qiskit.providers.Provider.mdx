...
<Class id="qiskit.providers.Provider" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/providers/provider.py" signature="qiskit.providers.Provider">
  ...
  <Attribute id="qiskit.providers.Provider.version" name="version" attributeValue="= 0" />
</Class>
