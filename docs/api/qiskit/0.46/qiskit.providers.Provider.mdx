---
title: Provider (v0.46)
description: API reference for qiskit.providers.Provider in qiskit v0.46
...
<Class id="qiskit.providers.Provider" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/providers/provider.py" signature="qiskit.providers.Provider" modifiers="class">
