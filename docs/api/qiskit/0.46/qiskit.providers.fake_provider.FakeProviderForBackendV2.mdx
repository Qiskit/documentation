...
description: API reference for qiskit.providers.fake_provider.FakeProviderForBackendV2 in qiskit v0.46
...
<Class id="qiskit.providers.fake_provider.FakeProviderForBackendV2" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/providers/fake_provider/fake_provider.py" signature="qiskit.providers.fake_provider.FakeProviderForBackendV2" modifiers="class">
