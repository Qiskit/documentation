...
<Class id="qiskit.providers.basic_provider.BasicSimulator" github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/providers/basic_provider/basic_simulator.py" signature="qiskit.providers.basic_provider.BasicSimulator(provider=None, target=None, **fields)">
