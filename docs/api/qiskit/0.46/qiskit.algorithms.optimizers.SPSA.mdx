...
<Class id="qiskit.algorithms.optimizers.SPSA" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/algorithms/optimizers/spsa.py" signature="qiskit.algorithms.optimizers.SPSA(maxiter=100, blocking=False, allowed_increase=None, trust_region=False, learning_rate=None, perturbation=None, last_avg=1, resamplings=1, perturbation_dims=None, second_order=False, regularization=None, hessian_delay=0, lse_solver=None, initial_hessian=None, callback=None, termination_checker=None)">
  ...
  **Raises**
  ...
  <Function id="qiskit.algorithms.optimizers.SPSA.calibrate" signature="static calibrate(loss, initial_point, c=0.2, stability_constant=0, target_magnitude=None, alpha=0.602, gamma=0.101, modelspace=False, max_evals_grouped=1)">
...
$$
  ...
  <Function id="qiskit.algorithms.optimizers.SPSA.estimate_stddev" signature="static estimate_stddev(loss, initial_point, avg=25, max_evals_grouped=1)">
  ...
  <Function id="qiskit.algorithms.optimizers.SPSA.gradient_num_diff" signature="static gradient_num_diff(x_center, f, epsilon, max_evals_grouped=None)">
