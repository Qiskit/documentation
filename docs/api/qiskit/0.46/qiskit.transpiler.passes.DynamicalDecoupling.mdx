---
title: DynamicalDecoupling (v0.46)
description: API reference for qiskit.transpiler.passes.DynamicalDecoupling in qiskit v0.46
...
<Class id="qiskit.transpiler.passes.DynamicalDecoupling" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/transpiler/passes/scheduling/dynamical_decoupling.py" signature="qiskit.transpiler.passes.DynamicalDecoupling(*args, **kwargs)" modifiers="class">
  ...
  ![../\_images/qiskit-transpiler-passes-DynamicalDecoupling-1\_00.png](/docs/images/api/qiskit/0.46/qiskit-transpiler-passes-DynamicalDecoupling-1_00.avif)

  ![../\_images/qiskit-transpiler-passes-DynamicalDecoupling-1\_01.png](/docs/images/api/qiskit/0.46/qiskit-transpiler-passes-DynamicalDecoupling-1_01.avif)
  ...
  *   **skip\_reset\_qubits** ([*bool*](https://docs.python.org/3/library/functions.html#bool)) – if True, does not insert DD on idle periods that immediately follow initialized/reset qubits (as qubits in the ground state are less susceptile to decoherence).
  *   **target** ([*Target*](qiskit.transpiler.Target "qiskit.transpiler.Target")) – The [`Target`](qiskit.transpiler.Target "qiskit.transpiler.Target") representing the target backend, if both `durations` and this are specified then this argument will take precedence and `durations` will be ignored.
  ...
  <Function id="qiskit.transpiler.passes.DynamicalDecoupling.execute" signature="execute(passmanager_ir, state, callback=None)">
  ...
  <Function id="qiskit.transpiler.passes.DynamicalDecoupling.name" signature="name()">
    Name of the pass.
  ...
  <Function id="qiskit.transpiler.passes.DynamicalDecoupling.run" signature="run(dag)">
  ...
  <Function id="qiskit.transpiler.passes.DynamicalDecoupling.update_status" signature="update_status(state, run_state)">
