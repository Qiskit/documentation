---
title: DCXGate (v0.46)
description: API reference for qiskit.circuit.library.DCXGate in qiskit v0.46
...
<Class id="qiskit.circuit.library.DCXGate" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/circuit/library/standard_gates/dcx.py" signature="qiskit.circuit.library.DCXGate(*args, _force_mutable=False, **kwargs)" modifiers="class">
