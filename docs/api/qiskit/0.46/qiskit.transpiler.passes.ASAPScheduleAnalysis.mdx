...
description: API reference for qiskit.transpiler.passes.ASAPScheduleAnalysis in qiskit v0.46
...
<Class id="qiskit.transpiler.passes.ASAPScheduleAnalysis" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/transpiler/passes/scheduling/scheduling/asap.py" signature="qiskit.transpiler.passes.ASAPScheduleAnalysis(*args, **kwargs)" modifiers="class">
  Bases: `BaseScheduler`
  ...
  *   **target** – The [`Target`](qiskit.transpiler.Target "qiskit.transpiler.Target") representing the target backend, if both `durations` and this are specified then this argument will take precedence and `durations` will be ignored.
  ...
  <Function id="qiskit.transpiler.passes.ASAPScheduleAnalysis.execute" signature="execute(passmanager_ir, state, callback=None)">
  ...
  <Function id="qiskit.transpiler.passes.ASAPScheduleAnalysis.name" signature="name()">
    Name of the pass.
  ...
  <Function id="qiskit.transpiler.passes.ASAPScheduleAnalysis.run" signature="run(dag)">
  ...
  <Function id="qiskit.transpiler.passes.ASAPScheduleAnalysis.update_status" signature="update_status(state, run_state)">
