...
<Class id="qiskit.dagcircuit.DAGOpNode" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/dagcircuit/dagnode.py" signature="qiskit.dagcircuit.DAGOpNode(op, qargs=(), cargs=(), dag=None)">
  ...
  <Function id="qiskit.dagcircuit.DAGOpNode.semantic_eq" name="semantic_eq" signature="static semantic_eq(node1, node2, bit_indices1, bit_indices2)">
