...
<span id="qiskit.providers.fake_provider.FakePerth.name" />

### name

Name of the backend.

<span id="qiskit.providers.fake_provider.FakePerth.description" />

### description

Optional human-readable description.

<span id="qiskit.providers.fake_provider.FakePerth.online_date" />

### online\_date

Date that the backend came online.

<span id="qiskit.providers.fake_provider.FakePerth.backend_version" />
