---
title: UnitarySynthesis (v0.46)
description: API reference for qiskit.transpiler.passes.UnitarySynthesis in qiskit v0.46
...
<Class id="qiskit.transpiler.passes.UnitarySynthesis" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/transpiler/passes/synthesis/unitary_synthesis.py" signature="qiskit.transpiler.passes.UnitarySynthesis(*args, **kwargs)" modifiers="class">
  ...
  *   **target** – The optional [`Target`](qiskit.transpiler.Target "qiskit.transpiler.Target") for the target device the pass is compiling for. If specified this will supersede the values set for `basis_gates`, `coupling_map`, and `backend_props`.
  ...
  <Function id="qiskit.transpiler.passes.UnitarySynthesis.execute" signature="execute(passmanager_ir, state, callback=None)">
  ...
  <Function id="qiskit.transpiler.passes.UnitarySynthesis.update_status" signature="update_status(state, run_state)">
