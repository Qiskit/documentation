---
title: DAGDependency (v0.46)
description: API reference for qiskit.dagcircuit.DAGDependency in qiskit v0.46
...
<Class id="qiskit.dagcircuit.DAGDependency" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/dagcircuit/dagdependency.py" signature="qiskit.dagcircuit.DAGDependency" modifiers="class">
