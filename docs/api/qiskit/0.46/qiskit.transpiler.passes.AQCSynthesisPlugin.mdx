...
<Class id="qiskit.transpiler.passes.AQCSynthesisPlugin" github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/transpiler/passes/synthesis/aqc_plugin.py" signature="qiskit.transpiler.passes.AQCSynthesisPlugin">
