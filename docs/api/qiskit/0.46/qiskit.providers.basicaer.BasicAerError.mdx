...
<Class id="qiskit.providers.basicaer.BasicAerError" name="BasicAerError" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/providers/basicaer/exceptions.py" signature="qiskit.providers.basicaer.BasicAerError(*message)">
