...
<Class id="qiskit.providers.fake_provider.FakeSherbrooke" github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/providers/fake_provider/backends/sherbrooke/fake_sherbrooke.py" signature="qiskit.providers.fake_provider.FakeSherbrooke">
