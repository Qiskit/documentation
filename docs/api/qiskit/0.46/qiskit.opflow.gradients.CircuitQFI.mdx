---
title: CircuitQFI (v0.46)
description: API reference for qiskit.opflow.gradients.CircuitQFI in qiskit v0.46
...
<Class id="qiskit.opflow.gradients.CircuitQFI" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/opflow/gradients/circuit_qfis/circuit_qfi.py" signature="qiskit.opflow.gradients.CircuitQFI" modifiers="class">
