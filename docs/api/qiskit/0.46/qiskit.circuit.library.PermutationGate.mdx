---
title: PermutationGate (v0.46)
description: API reference for qiskit.circuit.library.PermutationGate in qiskit v0.46
...
<Class id="qiskit.circuit.library.PermutationGate" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/circuit/library/generalized_gates/permutation.py" signature="qiskit.circuit.library.PermutationGate(pattern)" modifiers="class">
  ...
  **Reference Circuit:**
  ...
  ![../\_images/qiskit-circuit-library-PermutationGate-1.png](/docs/images/api/qiskit/0.46/qiskit-circuit-library-PermutationGate-1.avif)

  **Expanded Circuit:**

  ![../\_images/qiskit-circuit-library-PermutationGate-2.png](/docs/images/api/qiskit/0.46/qiskit-circuit-library-PermutationGate-2.avif)
