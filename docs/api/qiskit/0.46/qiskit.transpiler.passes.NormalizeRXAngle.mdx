...
<Class id="qiskit.transpiler.passes.NormalizeRXAngle" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/transpiler/passes/optimization/normalize_rx_angle.py" signature="qiskit.transpiler.passes.NormalizeRXAngle(*args, **kwargs)">
  ...
  *   **resolution\_in\_radian** ([*float*](https://docs.python.org/3/library/functions.html#float "(in Python v3.12)")) – Resolution for RX rotation angle quantization. If set to zero, this pass won’t modify the rotation angles in the given DAG. (=Provides arbitrary-angle RX)
  ...
  <Function id="qiskit.transpiler.passes.NormalizeRXAngle.execute" name="execute" signature="execute(passmanager_ir, state, callback=None)">
  ...
  <Function id="qiskit.transpiler.passes.NormalizeRXAngle.name" name="name" signature="name()">
    Name of the pass.
  ...
  <Function id="qiskit.transpiler.passes.NormalizeRXAngle.quantize_angles" name="quantize_angles" signature="quantize_angles(qubit, original_angle)">
  ...
  <Function id="qiskit.transpiler.passes.NormalizeRXAngle.run" name="run" signature="run(dag)">
  ...
  <Function id="qiskit.transpiler.passes.NormalizeRXAngle.update_status" name="update_status" signature="update_status(state, run_state)">
