---
title: HoareOptimizer (v0.46)
description: API reference for qiskit.transpiler.passes.HoareOptimizer in qiskit v0.46
...
<Class id="qiskit.transpiler.passes.HoareOptimizer" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/transpiler/passes/optimization/hoare_opt.py" signature="qiskit.transpiler.passes.HoareOptimizer(*args, **kwargs)" modifiers="class">
  ...
  **Raises**
  ...
  <Function id="qiskit.transpiler.passes.HoareOptimizer.execute" signature="execute(passmanager_ir, state, callback=None)">
  ...
  <Function id="qiskit.transpiler.passes.HoareOptimizer.update_status" signature="update_status(state, run_state)">
