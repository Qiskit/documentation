...
<Class id="qiskit.transpiler.passes.CollectLinearFunctions" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/transpiler/passes/optimization/collect_linear_functions.py" signature="qiskit.transpiler.passes.CollectLinearFunctions(*args, **kwargs)">
