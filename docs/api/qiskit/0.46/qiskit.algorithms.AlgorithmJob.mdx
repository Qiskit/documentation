---
title: AlgorithmJob (v0.46)
description: API reference for qiskit.algorithms.AlgorithmJob in qiskit v0.46
...
<Class id="qiskit.algorithms.AlgorithmJob" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/algorithms/algorithm_job.py" signature="qiskit.algorithms.AlgorithmJob(function, *args, **kwargs)" modifiers="class">
  Bases: `PrimitiveJob`
