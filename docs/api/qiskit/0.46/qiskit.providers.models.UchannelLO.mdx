...
<Class id="qiskit.providers.models.UchannelLO" github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/providers/models/backendconfiguration.py" signature="qiskit.providers.models.UchannelLO(q, scale)">
