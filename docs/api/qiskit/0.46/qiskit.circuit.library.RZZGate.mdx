...
<Class id="qiskit.circuit.library.RZZGate" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/circuit/library/standard_gates/rzz.py" signature="qiskit.circuit.library.RZZGate(theta, label=None, *, duration=None, unit='dt')">
