...
<Class id="qiskit.transpiler.passes.ApplyLayout" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/transpiler/passes/layout/apply_layout.py" signature="qiskit.transpiler.passes.ApplyLayout(*args, **kwargs)">
  ...
  <Function id="qiskit.transpiler.passes.ApplyLayout.execute" name="execute" signature="execute(passmanager_ir, state, callback=None)">
  ...
  <Function id="qiskit.transpiler.passes.ApplyLayout.name" name="name" signature="name()">
    Name of the pass.
  ...
  <Function id="qiskit.transpiler.passes.ApplyLayout.run" name="run" signature="run(dag)">
  ...
  <Function id="qiskit.transpiler.passes.ApplyLayout.update_status" name="update_status" signature="update_status(state, run_state)">
