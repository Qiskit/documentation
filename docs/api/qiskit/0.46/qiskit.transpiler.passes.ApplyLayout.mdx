---
title: ApplyLayout (v0.46)
description: API reference for qiskit.transpiler.passes.ApplyLayout in qiskit v0.46
...
<Class id="qiskit.transpiler.passes.ApplyLayout" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/transpiler/passes/layout/apply_layout.py" signature="qiskit.transpiler.passes.ApplyLayout(*args, **kwargs)" modifiers="class">
  ...
  <Function id="qiskit.transpiler.passes.ApplyLayout.execute" signature="execute(passmanager_ir, state, callback=None)">
  ...
  <Function id="qiskit.transpiler.passes.ApplyLayout.update_status" signature="update_status(state, run_state)">
