...
<Class id="qiskit.opflow.state_fns.DictStateFn" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/opflow/state_fns/dict_state_fn.py" signature="qiskit.opflow.state_fns.DictStateFn(*args, **kwargs)">
