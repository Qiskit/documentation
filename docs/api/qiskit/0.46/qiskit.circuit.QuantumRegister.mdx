...
<Class id="qiskit.circuit.QuantumRegister" github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/circuit/quantumregister.py" signature="qiskit.circuit.QuantumRegister(size=None, name=None, bits=None)">
