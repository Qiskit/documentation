...
<Class id="qiskit.transpiler.passes.TranslateParameterizedGates" github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/transpiler/passes/basis/translate_parameterized.py" signature="qiskit.transpiler.passes.TranslateParameterizedGates(*args, **kwargs)">
