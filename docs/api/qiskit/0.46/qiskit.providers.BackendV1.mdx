...
<Class id="qiskit.providers.BackendV1" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/providers/backend.py" signature="qiskit.providers.BackendV1(configuration, provider=None, **fields)">
  ...
  <Function id="qiskit.providers.BackendV1._default_options" name="_default_options" signature="abstract classmethod _default_options()">
  ...
  **Raises**
  ...
  <Function signature="abstract classmethod _default_options()">
    Return the default options
  ...
  <Function id="qiskit.providers.BackendV1.configuration" name="configuration" signature="configuration()">
  ...
  <Function id="qiskit.providers.BackendV1.name" name="name" signature="name()">
  ...
  <Function id="qiskit.providers.BackendV1.properties" name="properties" signature="properties()">
  ...
  <Function id="qiskit.providers.BackendV1.provider" name="provider" signature="provider()">
  ...
  <Function id="qiskit.providers.BackendV1.run" name="run" signature="abstract run(run_input, **options)">
    Run on the backend.
  ...
  <Function id="qiskit.providers.BackendV1.set_options" name="set_options" signature="set_options(**fields)">
  ...
  <Function id="qiskit.providers.BackendV1.status" name="status" signature="status()">
