---
title: Depth (v0.46)
description: API reference for qiskit.transpiler.passes.Depth in qiskit v0.46
...
<Class id="qiskit.transpiler.passes.Depth" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/transpiler/passes/analysis/depth.py" signature="qiskit.transpiler.passes.Depth(*args, **kwargs)" modifiers="class">
  ...
  **recurse** – whether to allow recursion into control flow. If this is `False` (default), the pass will throw an error when control flow is present, to avoid returning a number with little meaning.
  ...
  <Function id="qiskit.transpiler.passes.Depth.execute" signature="execute(passmanager_ir, state, callback=None)">
  ...
  <Function id="qiskit.transpiler.passes.Depth.update_status" signature="update_status(state, run_state)">
