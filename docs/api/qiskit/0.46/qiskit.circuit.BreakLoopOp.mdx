...
<Class id="qiskit.circuit.BreakLoopOp" github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/circuit/controlflow/break_loop.py" signature="qiskit.circuit.BreakLoopOp(num_qubits, num_clbits, label=None)">
