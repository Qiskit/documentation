---
title: Width (v0.46)
description: API reference for qiskit.transpiler.passes.Width in qiskit v0.46
...
<Class id="qiskit.transpiler.passes.Width" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/transpiler/passes/analysis/width.py" signature="qiskit.transpiler.passes.Width(*args, **kwargs)" modifiers="class">
  ...
  <Function id="qiskit.transpiler.passes.Width.execute" signature="execute(passmanager_ir, state, callback=None)">
  ...
  <Function id="qiskit.transpiler.passes.Width.update_status" signature="update_status(state, run_state)">
