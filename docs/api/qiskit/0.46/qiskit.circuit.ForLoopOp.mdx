...
<Class id="qiskit.circuit.ForLoopOp" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/circuit/controlflow/for_loop.py" signature="qiskit.circuit.ForLoopOp(indexset, loop_parameter, body, label=None)">
