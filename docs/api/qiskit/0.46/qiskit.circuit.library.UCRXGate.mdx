---
title: UCRXGate (v0.46)
description: API reference for qiskit.circuit.library.UCRXGate in qiskit v0.46
...
<Class id="qiskit.circuit.library.UCRXGate" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/circuit/library/generalized_gates/ucrx.py" signature="qiskit.circuit.library.UCRXGate(angle_list)" modifiers="class">
