...
<Class id="qiskit.circuit.library.UCRXGate" github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/circuit/library/generalized_gates/ucrx.py" signature="qiskit.circuit.library.UCRXGate(angle_list)">
