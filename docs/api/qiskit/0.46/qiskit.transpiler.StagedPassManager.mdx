...
<Class id="qiskit.transpiler.StagedPassManager" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/transpiler/passmanager.py" signature="qiskit.transpiler.StagedPassManager(stages=None, **kwargs)">
  ...
  *   [**ValueError**](https://docs.python.org/3/library/exceptions.html#ValueError "(in Python v3.12)") – If an invalid stage name is specified.
  ...
  <Function id="qiskit.transpiler.StagedPassManager.append" name="append" signature="append(passes, max_iteration=None, **flow_controller_conditions)">
  ...
  <Function id="qiskit.transpiler.StagedPassManager.draw" name="draw" signature="draw(filename=None, style=None, raw=False)">
    Draw the staged pass manager.
  </Function>

  ### passes

  <Function id="qiskit.transpiler.StagedPassManager.passes" name="passes" signature="passes()">
  ...
  <Function id="qiskit.transpiler.StagedPassManager.remove" name="remove" signature="remove(index)">
  ...
  <Function id="qiskit.transpiler.StagedPassManager.replace" name="replace" signature="replace(index, passes, max_iteration=None, **flow_controller_conditions)">
  ...
  <Function id="qiskit.transpiler.StagedPassManager.run" name="run" signature="run(circuits, output_name=None, callback=None)">
  ...
  <Function id="qiskit.transpiler.StagedPassManager.to_flow_controller" name="to_flow_controller" signature="to_flow_controller()">
