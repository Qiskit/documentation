---
title: Initialize (v0.46)
description: API reference for qiskit.circuit.library.Initialize in qiskit v0.46
...
<Class id="qiskit.circuit.library.Initialize" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/circuit/library/data_preparation/initializer.py" signature="qiskit.circuit.library.Initialize(params, num_qubits=None, normalize=False)" modifiers="class">
  ...
  *   **normalize** ([*bool*](https://docs.python.org/3/library/functions.html#bool)) – Whether to normalize an input array to a unit vector.
  ...
  <Function id="qiskit.circuit.library.Initialize.broadcast_arguments" signature="broadcast_arguments(qargs, cargs)">
  ...
  <Function id="qiskit.circuit.library.Initialize.gates_to_uncompute" signature="gates_to_uncompute()">
