---
title: TrotterizationBase (v0.46)
description: API reference for qiskit.opflow.evolutions.TrotterizationBase in qiskit v0.46
...
<Class id="qiskit.opflow.evolutions.TrotterizationBase" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/opflow/evolutions/trotterizations/trotterization_base.py" signature="qiskit.opflow.evolutions.TrotterizationBase(reps=1)" modifiers="class">
  ...
  <Function id="qiskit.opflow.evolutions.TrotterizationBase.convert" signature="convert(operator)" modifiers="abstract">
    ...
    **Raises**
    ...
    [**TypeError**](https://docs.python.org/3/library/exceptions.html#TypeError) – A non-SummedOps Operator is passed into `convert`.
