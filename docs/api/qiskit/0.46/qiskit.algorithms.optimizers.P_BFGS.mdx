---
title: P_BFGS (v0.46)
description: API reference for qiskit.algorithms.optimizers.P_BFGS in qiskit v0.46
...
<Class id="qiskit.algorithms.optimizers.P_BFGS" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/algorithms/optimizers/p_bfgs.py" signature="qiskit.algorithms.optimizers.P_BFGS(maxfun=1000, ftol=2.220446049250313e-15, iprint=-1, max_processes=None, options=None, max_evals_grouped=1, **kwargs)" modifiers="class">
  ...
  *   **maxfun** ([*int*](https://docs.python.org/3/library/functions.html#int)) – Maximum number of function evaluations.
  *   **ftol** (*SupportsFloat*) – The iteration stops when (f^k - f^\{k+1})/max\{|f^k|,|f^\{k+1}|,1} \<= ftol.
  *   **iprint** ([*int*](https://docs.python.org/3/library/functions.html#int)) – Controls the frequency of output. iprint \< 0 means no output; iprint = 0 print only one line at the last iteration; 0 \< iprint \< 99 print also f and |proj g| every iprint iterations; iprint = 99 print details of every iteration except n-vectors; iprint = 100 print also the changes of active set and final x; iprint > 100 print details of every iteration including x and g.
  *   **max\_processes** ([*int*](https://docs.python.org/3/library/functions.html#int) *| None*) – maximum number of processes allowed, has a min. value of 1 if not None.
