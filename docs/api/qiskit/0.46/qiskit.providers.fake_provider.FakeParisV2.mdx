...
<Class id="qiskit.providers.fake_provider.FakeParisV2" github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/providers/fake_provider/backends/paris/fake_paris.py" signature="qiskit.providers.fake_provider.FakeParisV2">
