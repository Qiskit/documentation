...
description: API reference for qiskit.quantum_info.Z2Symmetries in qiskit v0.46
...
<Class id="qiskit.quantum_info.Z2Symmetries" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/quantum_info/analysis/z2_symmetries.py" signature="qiskit.quantum_info.Z2Symmetries(symmetries, sq_paulis, sq_list, tapering_values=None, *, tol=1e-14)" modifiers="class">
  ...
  **Raises**
  ...
  <Function id="qiskit.quantum_info.Z2Symmetries.convert_clifford" signature="convert_clifford(operator)">
  ...
  <Function id="qiskit.quantum_info.Z2Symmetries.find_z2_symmetries" signature="find_z2_symmetries(operator)" modifiers="classmethod">
  ...
  <Function id="qiskit.quantum_info.Z2Symmetries.is_empty" signature="is_empty()">
  ...
  <Function id="qiskit.quantum_info.Z2Symmetries.taper" signature="taper(operator)">
  ...
  <Function id="qiskit.quantum_info.Z2Symmetries.taper_clifford" signature="taper_clifford(operator)">
