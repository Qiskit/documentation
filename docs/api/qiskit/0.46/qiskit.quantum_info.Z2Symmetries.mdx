...
<Class id="qiskit.quantum_info.Z2Symmetries" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/quantum_info/analysis/z2_symmetries.py" signature="qiskit.quantum_info.Z2Symmetries(symmetries, sq_paulis, sq_list, tapering_values=None, *, tol=1e-14)">
  ...
  **Raises**
  ...
  <Function id="qiskit.quantum_info.Z2Symmetries.convert_clifford" name="convert_clifford" signature="convert_clifford(operator)">
  ...
  <Function id="qiskit.quantum_info.Z2Symmetries.find_z2_symmetries" name="find_z2_symmetries" signature="classmethod find_z2_symmetries(operator)">
  ...
  <Function id="qiskit.quantum_info.Z2Symmetries.is_empty" name="is_empty" signature="is_empty()">
  ...
  <Function id="qiskit.quantum_info.Z2Symmetries.taper" name="taper" signature="taper(operator)">
  ...
  <Function id="qiskit.quantum_info.Z2Symmetries.taper_clifford" name="taper_clifford" signature="taper_clifford(operator)">
