---
title: BaseReadoutMitigator (v0.46)
description: API reference for qiskit.result.BaseReadoutMitigator in qiskit v0.46
...
<Class id="qiskit.result.BaseReadoutMitigator" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/result/mitigation/base_readout_mitigator.py" signature="qiskit.result.BaseReadoutMitigator" modifiers="class">
  ...
  <Function id="qiskit.result.BaseReadoutMitigator.expectation_value" signature="expectation_value(data, diagonal, qubits=None, clbits=None, shots=None)" modifiers="abstract">
  ...
  <Function id="qiskit.result.BaseReadoutMitigator.quasi_probabilities" signature="quasi_probabilities(data, qubits=None, clbits=None, shots=None)" modifiers="abstract">
