...
<Class id="qiskit.algorithms.gradients.LinCombEstimatorGradient" github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/algorithms/gradients/lin_comb/lin_comb_estimator_gradient.py" signature="qiskit.algorithms.gradients.LinCombEstimatorGradient(estimator, derivative_type=DerivativeType.REAL, options=None)">
