---
title: ResultError (v0.46)
description: API reference for qiskit.result.ResultError in qiskit v0.46
...
<Class id="qiskit.result.ResultError" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/result/exceptions.py" signature="qiskit.result.ResultError(error)" modifiers="exception">
