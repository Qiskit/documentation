---
title: RXCalibrationBuilder (v0.46)
description: API reference for qiskit.transpiler.passes.RXCalibrationBuilder in qiskit v0.46
...
<Class id="qiskit.transpiler.passes.RXCalibrationBuilder" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/transpiler/passes/calibration/rx_builder.py" signature="qiskit.transpiler.passes.RXCalibrationBuilder(*args, **kwargs)" modifiers="class">
  ...
  *   **calibrations.** (*used for bootstrapping RX*) –
  ...
  <Function id="qiskit.transpiler.passes.RXCalibrationBuilder.execute" signature="execute(passmanager_ir, state, callback=None)">
  ...
  <Function id="qiskit.transpiler.passes.RXCalibrationBuilder.get_calibration" signature="get_calibration(node_op, qubits)">
  ...
  <Function id="qiskit.transpiler.passes.RXCalibrationBuilder.name" signature="name()">
    Name of the pass.
  ...
  <Function id="qiskit.transpiler.passes.RXCalibrationBuilder.run" signature="run(dag)">
  ...
  <Function id="qiskit.transpiler.passes.RXCalibrationBuilder.supported" signature="supported(node_op, qubits)">
  ...
  <Function id="qiskit.transpiler.passes.RXCalibrationBuilder.update_status" signature="update_status(state, run_state)">
