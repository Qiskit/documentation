...
<Class id="qiskit.transpiler.passes.RXCalibrationBuilder" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/transpiler/passes/calibration/rx_builder.py" signature="qiskit.transpiler.passes.RXCalibrationBuilder(*args, **kwargs)">
  ...
  *   **calibrations.** (*used for bootstrapping RX*) –
  ...
  <Function id="qiskit.transpiler.passes.RXCalibrationBuilder.execute" name="execute" signature="execute(passmanager_ir, state, callback=None)">
  ...
  <Function id="qiskit.transpiler.passes.RXCalibrationBuilder.get_calibration" name="get_calibration" signature="get_calibration(node_op, qubits)">
  ...
  <Function id="qiskit.transpiler.passes.RXCalibrationBuilder.name" name="name" signature="name()">
    Name of the pass.
  ...
  <Function id="qiskit.transpiler.passes.RXCalibrationBuilder.run" name="run" signature="run(dag)">
  ...
  <Function id="qiskit.transpiler.passes.RXCalibrationBuilder.supported" name="supported" signature="supported(node_op, qubits)">
  ...
  <Function id="qiskit.transpiler.passes.RXCalibrationBuilder.update_status" name="update_status" signature="update_status(state, run_state)">
