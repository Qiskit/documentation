...
<Class id="qiskit.transpiler.passes.StochasticSwap" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/transpiler/passes/routing/stochastic_swap.py" signature="qiskit.transpiler.passes.StochasticSwap(*args, **kwargs)">
  ...
  *   **initial\_layout** ([*Layout*](qiskit.transpiler.Layout "qiskit.transpiler.Layout")) – starting layout at beginning of pass.
  ...
  <Function id="qiskit.transpiler.passes.StochasticSwap.execute" name="execute" signature="execute(passmanager_ir, state, callback=None)">
  ...
  <Function id="qiskit.transpiler.passes.StochasticSwap.update_status" name="update_status" signature="update_status(state, run_state)">
