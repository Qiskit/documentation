---
title: ISRES (v0.46)
description: API reference for qiskit.algorithms.optimizers.ISRES in qiskit v0.46
...
<Class id="qiskit.algorithms.optimizers.ISRES" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/algorithms/optimizers/nlopts/isres.py" signature="qiskit.algorithms.optimizers.ISRES(max_evals=1000)" modifiers="class">
