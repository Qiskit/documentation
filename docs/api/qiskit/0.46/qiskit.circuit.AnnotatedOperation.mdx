...
<Class id="qiskit.circuit.AnnotatedOperation" github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/circuit/annotated_operation.py" signature="qiskit.circuit.AnnotatedOperation(base_op, modifiers)">
