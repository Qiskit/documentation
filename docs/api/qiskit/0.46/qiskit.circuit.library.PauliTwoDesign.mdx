---
title: PauliTwoDesign (v0.46)
description: API reference for qiskit.circuit.library.PauliTwoDesign in qiskit v0.46
...
<Class id="qiskit.circuit.library.PauliTwoDesign" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/circuit/library/n_local/pauli_two_design.py" signature="qiskit.circuit.library.PauliTwoDesign(num_qubits=None, reps=3, seed=None, insert_barriers=False, name='PauliTwoDesign')" modifiers="class">
  ...
  **Examples**
  ...
  ![../\_images/qiskit-circuit-library-PauliTwoDesign-1.png](/docs/images/api/qiskit/0.46/qiskit-circuit-library-PauliTwoDesign-1.avif)
  ...
  *   **insert\_barriers** ([*bool*](https://docs.python.org/3/library/functions.html#bool)) – If `True`, barriers are inserted in between each layer. If `False`, no barriers are inserted. Defaults to `False`.
  ...
  <Attribute id="qiskit.circuit.library.PauliTwoDesign.instances" attributeValue="174" />
