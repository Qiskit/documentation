...
<Class id="qiskit.primitives.EstimatorResult" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/primitives/base/estimator_result.py" signature="qiskit.primitives.EstimatorResult(values, metadata)">
  ...
  *   **metadata** ([*list*](https://docs.python.org/3/library/stdtypes.html#list "(in Python v3.12)")*\[*[*dict*](https://docs.python.org/3/library/stdtypes.html#dict "(in Python v3.12)")*]*) – List of the metadata.
  ...
  <Attribute id="qiskit.primitives.EstimatorResult.experiments" name="experiments">
  ...
  <Attribute id="qiskit.primitives.EstimatorResult.num_experiments" name="num_experiments">
  ...
  <Attribute id="qiskit.primitives.EstimatorResult.values" name="values" attributeTypeHint="np.ndarray[Any, np.dtype[np.float64]]" />

  ### metadata

  <Attribute id="qiskit.primitives.EstimatorResult.metadata" name="metadata" attributeTypeHint="list[dict[str, Any]]" />

  ## Methods

  ### decompose

  <Function id="qiskit.primitives.EstimatorResult.decompose" name="decompose" signature="decompose()">
