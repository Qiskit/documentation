---
title: EstimatorResult (v0.46)
description: API reference for qiskit.primitives.EstimatorResult in qiskit v0.46
  ...
  *   **metadata** ([*list*](https://docs.python.org/3/library/stdtypes.html#list)*\[*[*dict*](https://docs.python.org/3/library/stdtypes.html#dict)*]*) – List of the metadata.
  ...
  <Function id="qiskit.primitives.EstimatorResult.decompose" signature="decompose()">
    ...
    **Return type**
    ...
    [*Iterator*](https://docs.python.org/3/library/collections.abc.html#collections.abc.Iterator)\[*\_BasePrimitiveResult*]
  </Function>
</Class>
