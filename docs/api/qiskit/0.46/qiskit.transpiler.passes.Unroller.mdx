---
title: Unroller (v0.46)
description: API reference for qiskit.transpiler.passes.Unroller in qiskit v0.46
...
<Class id="qiskit.transpiler.passes.Unroller" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/transpiler/passes/basis/unroller.py" signature="qiskit.transpiler.passes.Unroller(*args, **kwargs)" modifiers="class">
  ...
  *   **basis** ([*list*](https://docs.python.org/3/library/stdtypes.html#list)*\[*[*str*](https://docs.python.org/3/library/stdtypes.html#str)*] or None*) – Target basis names to unroll to, e.g. \[‘u3’, ‘cx’] . If None, does not unroll any gate.
