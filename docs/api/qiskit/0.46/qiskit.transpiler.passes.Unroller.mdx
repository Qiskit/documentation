...
<Class id="qiskit.transpiler.passes.Unroller" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/transpiler/passes/basis/unroller.py" signature="qiskit.transpiler.passes.Unroller(*args, **kwargs)">
  ...
  *   **target** ([*Target*](qiskit.transpiler.Target "qiskit.transpiler.Target")) – The [`Target`](qiskit.transpiler.Target "qiskit.transpiler.Target") representing the target backend, if both `basis` and this are specified then this argument will take precedence and `basis` will be ignored.
  ...
  <Attribute id="qiskit.transpiler.passes.Unroller.is_analysis_pass" name="is_analysis_pass">
  ...
  <Attribute id="qiskit.transpiler.passes.Unroller.is_transformation_pass" name="is_transformation_pass">
  ...
  <Function id="qiskit.transpiler.passes.Unroller.execute" name="execute" signature="execute(passmanager_ir, state, callback=None)">
  ...
  <Function id="qiskit.transpiler.passes.Unroller.name" name="name" signature="name()">
    Name of the pass.
  ...
  <Function id="qiskit.transpiler.passes.Unroller.run" name="run" signature="run(dag)">
  ...
  <Function id="qiskit.transpiler.passes.Unroller.update_status" name="update_status" signature="update_status(state, run_state)">
