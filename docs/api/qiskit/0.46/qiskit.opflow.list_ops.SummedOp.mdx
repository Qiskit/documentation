---
title: SummedOp (v0.46)
description: API reference for qiskit.opflow.list_ops.SummedOp in qiskit v0.46
...
<Class id="qiskit.opflow.list_ops.SummedOp" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/opflow/list_ops/summed_op.py" signature="qiskit.opflow.list_ops.SummedOp(oplist, coeff=1.0, abelian=False)" modifiers="class">
  ...
  *   **oplist** ([*List*](https://docs.python.org/3/library/typing.html#typing.List)*\[*[*OperatorBase*](qiskit.opflow.OperatorBase "qiskit.opflow.operator_base.OperatorBase")*]*) – The Operators being summed.
