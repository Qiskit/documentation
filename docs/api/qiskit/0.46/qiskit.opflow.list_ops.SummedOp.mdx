...
<Class id="qiskit.opflow.list_ops.SummedOp" github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/opflow/list_ops/summed_op.py" signature="qiskit.opflow.list_ops.SummedOp(oplist, coeff=1.0, abelian=False)">
