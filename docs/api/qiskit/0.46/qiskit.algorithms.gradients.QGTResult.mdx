...
<Class id="qiskit.algorithms.gradients.QGTResult" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/algorithms/gradients/base/qgt_result.py" signature="qiskit.algorithms.gradients.QGTResult(qgts, derivative_type, metadata, options)" modifiers="class">
