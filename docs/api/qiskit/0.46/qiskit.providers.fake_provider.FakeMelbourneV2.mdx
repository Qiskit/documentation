...
<Class id="qiskit.providers.fake_provider.FakeMelbourneV2" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/providers/fake_provider/backends/melbourne/fake_melbourne.py" signature="qiskit.providers.fake_provider.FakeMelbourneV2">
