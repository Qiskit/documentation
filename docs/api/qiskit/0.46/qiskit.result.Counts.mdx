...
<Class id="qiskit.result.Counts" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/result/counts.py" signature="qiskit.result.Counts(data, time_taken=None, creg_sizes=None, memory_slots=None)">
  ...
  *   [**QiskitError**](exceptions#qiskit.exceptions.QiskitError "qiskit.exceptions.QiskitError") – If a dit string key is input with `creg_sizes` and/or `memory_slots`.
  ...
  <Function id="qiskit.result.Counts.hex_outcomes" name="hex_outcomes" signature="hex_outcomes()">
  ...
  <Function id="qiskit.result.Counts.int_outcomes" name="int_outcomes" signature="int_outcomes()">
  ...
  <Function id="qiskit.result.Counts.most_frequent" name="most_frequent" signature="most_frequent()">
  ...
  <Function id="qiskit.result.Counts.shots" name="shots" signature="shots()">
