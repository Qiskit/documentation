---
title: ConstrainedReschedule (v0.46)
description: API reference for qiskit.transpiler.passes.ConstrainedReschedule in qiskit v0.46
...
<Class id="qiskit.transpiler.passes.ConstrainedReschedule" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/transpiler/passes/scheduling/alignments/reschedule.py" signature="qiskit.transpiler.passes.ConstrainedReschedule(*args, **kwargs)" modifiers="class">
  ...
  *   **pulse\_alignment** – Integer number representing the minimum time resolution to trigger gate instruction in units of `dt`.
  ...
  <Function id="qiskit.transpiler.passes.ConstrainedReschedule.execute" signature="execute(passmanager_ir, state, callback=None)">
  ...
  <Function id="qiskit.transpiler.passes.ConstrainedReschedule.update_status" signature="update_status(state, run_state)">
