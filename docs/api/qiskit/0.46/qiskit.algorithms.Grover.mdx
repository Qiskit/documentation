---
title: Grover (v0.46)
description: API reference for qiskit.algorithms.Grover in qiskit v0.46
...
<Class id="qiskit.algorithms.Grover" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/algorithms/amplitude_amplifiers/grover.py" signature="qiskit.algorithms.Grover(iterations=None, growth_rate=None, sample_from_iterations=False, quantum_instance=None, sampler=None)" modifiers="class">
...
$$
  ...
  *   [**ValueError**](https://docs.python.org/3/library/exceptions.html#ValueError) – If `growth_rate` is a float but not larger than 1.
  *   [**ValueError**](https://docs.python.org/3/library/exceptions.html#ValueError) – If both `iterations` and `growth_rate` is set.
  ...
  **\[1]: Boyer et al., Tight bounds on quantum searching**
  ...
  <Function id="qiskit.algorithms.Grover.amplify" signature="amplify(amplification_problem)">
    ...
    *   [**ValueError**](https://docs.python.org/3/library/exceptions.html#ValueError) – If a quantum instance or sampler is not set.
    *   [**AlgorithmError**](algorithms#qiskit.algorithms.AlgorithmError "qiskit.algorithms.AlgorithmError") – If a sampler job fails.
    *   [**TypeError**](https://docs.python.org/3/library/exceptions.html#TypeError) – If `is_good_state` is not provided and is required (i.e. when iterations
    *   **is None**\*\* or ****a list****)\*\* –
  ...
  <Function id="qiskit.algorithms.Grover.construct_circuit" signature="construct_circuit(problem, power=None, measurement=False)">
    ...
    *   **power** ([*int*](https://docs.python.org/3/library/functions.html#int) *| None*) – The number of times the Grover operator is repeated. If None, this argument is set to the first item in `iterations`.
    ...
    **Raises**
    ...
    [**ValueError**](https://docs.python.org/3/library/exceptions.html#ValueError) – If no power is passed and the iterations are not an integer.
  </Function>
  ...
  <Function id="qiskit.algorithms.Grover.optimal_num_iterations" signature="optimal_num_iterations(num_solutions, num_qubits)" modifiers="static">
    ...
    *   **num\_solutions** ([*int*](https://docs.python.org/3/library/functions.html#int)) – The number of solutions.
    *   **num\_qubits** ([*int*](https://docs.python.org/3/library/functions.html#int)) – The number of qubits used to encode the states.
