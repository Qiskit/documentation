...
<Class id="qiskit.providers.fake_provider.FakeRochesterV2" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/providers/fake_provider/backends/rochester/fake_rochester.py" signature="qiskit.providers.fake_provider.FakeRochesterV2">
  ...
  <Attribute id="qiskit.providers.fake_provider.FakeRochesterV2.dirname" name="dirname" attributeValue="= '/home/runner/work/qiskit/qiskit/qiskit/providers/fake_provider/backends/rochester'" />
  ...
  <Attribute id="qiskit.providers.fake_provider.FakeRochesterV2.name" name="name">
    Name of the backend.
  </Attribute>

  ### description

  <Attribute id="qiskit.providers.fake_provider.FakeRochesterV2.description" name="description">
    Optional human-readable description.
  </Attribute>

  ### online\_date

  <Attribute id="qiskit.providers.fake_provider.FakeRochesterV2.online_date" name="online_date">
    Date that the backend came online.
  </Attribute>

  ### backend\_version

  <Attribute id="qiskit.providers.fake_provider.FakeRochesterV2.backend_version" name="backend_version">
  ...
  <Function id="qiskit.providers.fake_provider.FakeRochesterV2.acquire_channel" name="acquire_channel" signature="acquire_channel(qubit)">
  ...
  <Function id="qiskit.providers.fake_provider.FakeRochesterV2.control_channel" name="control_channel" signature="control_channel(qubits)">
  ...
  <Function id="qiskit.providers.fake_provider.FakeRochesterV2.drive_channel" name="drive_channel" signature="drive_channel(qubit)">
  ...
  <Function id="qiskit.providers.fake_provider.FakeRochesterV2.measure_channel" name="measure_channel" signature="measure_channel(qubit)">
  ...
  <Function id="qiskit.providers.fake_provider.FakeRochesterV2.qubit_properties" name="qubit_properties" signature="qubit_properties(qubit)">
  ...
  <Function id="qiskit.providers.fake_provider.FakeRochesterV2.run" name="run" signature="run(run_input, **options)">
  ...
  <Function id="qiskit.providers.fake_provider.FakeRochesterV2.set_options" name="set_options" signature="set_options(**fields)">
