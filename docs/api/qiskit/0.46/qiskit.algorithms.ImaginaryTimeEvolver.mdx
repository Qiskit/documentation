---
title: ImaginaryTimeEvolver (v0.46)
description: API reference for qiskit.algorithms.ImaginaryTimeEvolver in qiskit v0.46
...
<Class id="qiskit.algorithms.ImaginaryTimeEvolver" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/algorithms/time_evolvers/imaginary_time_evolver.py" signature="qiskit.algorithms.ImaginaryTimeEvolver" modifiers="class">
