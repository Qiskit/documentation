...
<Class id="qiskit.algorithms.ImaginaryTimeEvolver" github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/algorithms/time_evolvers/imaginary_time_evolver.py" signature="qiskit.algorithms.ImaginaryTimeEvolver">
