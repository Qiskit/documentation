---
title: UnitarySynthesisPlugin (v0.46)
description: API reference for qiskit.transpiler.passes.synthesis.plugin.UnitarySynthesisPlugin in qiskit v0.46
...
<Class id="qiskit.transpiler.passes.synthesis.plugin.UnitarySynthesisPlugin" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/transpiler/passes/synthesis/plugin.py" signature="qiskit.transpiler.passes.synthesis.plugin.UnitarySynthesisPlugin" modifiers="class">
  ...
  <Function id="qiskit.transpiler.passes.synthesis.plugin.UnitarySynthesisPlugin.run" signature="run(unitary, **options)" modifiers="abstract">
