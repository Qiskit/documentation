---
title: COBYLA (v0.46)
description: API reference for qiskit.algorithms.optimizers.COBYLA in qiskit v0.46
...
<Class id="qiskit.algorithms.optimizers.COBYLA" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/algorithms/optimizers/cobyla.py" signature="qiskit.algorithms.optimizers.COBYLA(maxiter=1000, disp=False, rhobeg=1.0, tol=None, options=None, **kwargs)" modifiers="class">
  ...
  *   **rhobeg** ([*float*](https://docs.python.org/3/library/functions.html#float)) – Reasonable initial changes to the variables.
  *   **tol** ([*float*](https://docs.python.org/3/library/functions.html#float) *| None*) – Final accuracy in the optimization (not precisely guaranteed). This is a lower bound on the size of the trust region.
  ...
  *   **kwargs** – additional kwargs for scipy.optimize.minimize.
  ...
  <Function id="qiskit.algorithms.optimizers.COBYLA.gradient_num_diff" signature="gradient_num_diff(x_center, f, epsilon, max_evals_grouped=None)" modifiers="static">
  ...
  <Function id="qiskit.algorithms.optimizers.COBYLA.minimize" signature="minimize(fun, x0, jac=None, bounds=None)">
