---
title: RegisterSlot (v0.46)
description: API reference for qiskit.pulse.channels.RegisterSlot in qiskit v0.46
...
<Class id="qiskit.pulse.channels.RegisterSlot" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/pulse/channels.py" signature="qiskit.pulse.channels.RegisterSlot(*args, **kwargs)" modifiers="class">
