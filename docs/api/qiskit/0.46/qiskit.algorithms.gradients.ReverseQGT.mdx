...
<Class id="qiskit.algorithms.gradients.ReverseQGT" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/algorithms/gradients/reverse/reverse_qgt.py" signature="qiskit.algorithms.gradients.ReverseQGT(phase_fix=True, derivative_type=DerivativeType.COMPLEX)">
  ...
  *   **derivative\_type** (*DerivativeType*) – Determines whether the complex QGT or only the real or imaginary parts are calculated.
  ...
  <Function id="qiskit.algorithms.gradients.ReverseQGT.run" name="run" signature="run(circuits, parameter_values, parameters=None, **options)">
  ...
  <Function id="qiskit.algorithms.gradients.ReverseQGT.update_default_options" name="update_default_options" signature="update_default_options(**options)">
