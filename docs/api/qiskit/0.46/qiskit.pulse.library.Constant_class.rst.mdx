---
title: Constant (v0.46)
description: API reference for qiskit.pulse.library.Constant in qiskit v0.46
...
<Class id="qiskit.pulse.library.Constant" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/pulse/library/symbolic_pulses.py" signature="qiskit.pulse.library.Constant(duration, amp, angle=None, name=None, limit_amplitude=None)" modifiers="class">
