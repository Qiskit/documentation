...
<Class id="qiskit.extensions.Snapshot" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/extensions/simulator/snapshot.py" signature="qiskit.extensions.Snapshot(label, snapshot_type='statevector', num_qubits=0, num_clbits=0, params=None)">
  ...
  **Raises**
  ...
  <Attribute id="qiskit.extensions.Snapshot.base_class" name="base_class">
  ...
  <Attribute id="qiskit.extensions.Snapshot.condition" name="condition">
    The classical condition on the instruction.
  </Attribute>

  ### condition\_bits

  <Attribute id="qiskit.extensions.Snapshot.condition_bits" name="condition_bits">
    Get Clbits in condition.
  </Attribute>

  ### decompositions

  <Attribute id="qiskit.extensions.Snapshot.decompositions" name="decompositions">
    Get the decompositions of the instruction from the SessionEquivalenceLibrary.
  </Attribute>

  ### definition

  <Attribute id="qiskit.extensions.Snapshot.definition" name="definition">
    Return definition in terms of other basic gates.
  </Attribute>

  ### duration

  <Attribute id="qiskit.extensions.Snapshot.duration" name="duration">
    Get the duration.
  </Attribute>

  ### label

  <Attribute id="qiskit.extensions.Snapshot.label" name="label">
    Return instruction label
  </Attribute>

  ### mutable

  <Attribute id="qiskit.extensions.Snapshot.mutable" name="mutable">
  ...
  <Attribute id="qiskit.extensions.Snapshot.name" name="name">
    Return the name.
  </Attribute>

  ### num\_clbits

  <Attribute id="qiskit.extensions.Snapshot.num_clbits" name="num_clbits">
    Return the number of clbits.
  </Attribute>

  ### num\_qubits

  <Attribute id="qiskit.extensions.Snapshot.num_qubits" name="num_qubits">
    Return the number of qubits.
  </Attribute>

  ### params

  <Attribute id="qiskit.extensions.Snapshot.params" name="params">
    return instruction params.
  </Attribute>

  ### snapshot\_type

  <Attribute id="qiskit.extensions.Snapshot.snapshot_type" name="snapshot_type">
    Return snapshot type
  </Attribute>

  ### unit

  <Attribute id="qiskit.extensions.Snapshot.unit" name="unit">
  ...
  <Function id="qiskit.extensions.Snapshot.add_decomposition" name="add_decomposition" signature="add_decomposition(decomposition)">
    Add a decomposition of the instruction to the SessionEquivalenceLibrary.
  </Function>

  ### assemble

  <Function id="qiskit.extensions.Snapshot.assemble" name="assemble" signature="assemble()">
    Assemble a QasmQobjInstruction
  </Function>

  ### broadcast\_arguments

  <Function id="qiskit.extensions.Snapshot.broadcast_arguments" name="broadcast_arguments" signature="broadcast_arguments(qargs, cargs)">
  ...
  <Function id="qiskit.extensions.Snapshot.c_if" name="c_if" signature="c_if(classical, val)">
  ...
  <Function id="qiskit.extensions.Snapshot.copy" name="copy" signature="copy(name=None)">
  ...
  <Function id="qiskit.extensions.Snapshot.inverse" name="inverse" signature="inverse()">
    Special case. Return self.
  </Function>

  ### is\_parameterized

  <Function id="qiskit.extensions.Snapshot.is_parameterized" name="is_parameterized" signature="is_parameterized()">
    Return True .IFF. instruction is parameterized else False
  </Function>

  ### qasm

  <Function id="qiskit.extensions.Snapshot.qasm" name="qasm" signature="qasm()">
  ...
  <Function id="qiskit.extensions.Snapshot.repeat" name="repeat" signature="repeat(n)">
  ...
  <Function id="qiskit.extensions.Snapshot.reverse_ops" name="reverse_ops" signature="reverse_ops()">
  ...
  <Function id="qiskit.extensions.Snapshot.soft_compare" name="soft_compare" signature="soft_compare(other)">
  ...
  <Function id="qiskit.extensions.Snapshot.to_mutable" name="to_mutable" signature="to_mutable()">
  ...
  <Function id="qiskit.extensions.Snapshot.validate_parameter" name="validate_parameter" signature="validate_parameter(parameter)">
