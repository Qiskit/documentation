...
description: API reference for qiskit.providers.JobStatus in qiskit v0.46
...
<Class id="qiskit.providers.JobStatus" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/providers/jobstatus.py" signature="qiskit.providers.JobStatus(value)" modifiers="class">
