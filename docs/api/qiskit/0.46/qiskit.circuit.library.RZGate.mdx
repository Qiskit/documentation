...
<Class id="qiskit.circuit.library.RZGate" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/circuit/library/standard_gates/rz.py" signature="qiskit.circuit.library.RZGate(phi, label=None, *, duration=None, unit='dt')">
