---
title: RealEvolver (v0.46)
description: API reference for qiskit.algorithms.RealEvolver in qiskit v0.46
...
<Class id="qiskit.algorithms.RealEvolver" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/algorithms/evolvers/real_evolver.py" signature="qiskit.algorithms.RealEvolver" modifiers="class">
