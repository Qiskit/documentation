---
title: ApproximateCircuit (v0.46)
description: API reference for qiskit.synthesis.unitary.aqc.ApproximateCircuit in qiskit v0.46
...
<Class id="qiskit.synthesis.unitary.aqc.ApproximateCircuit" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/synthesis/unitary/aqc/approximate.py" signature="qiskit.synthesis.unitary.aqc.ApproximateCircuit(num_qubits, name=None)" modifiers="class">
  ...
  *   **num\_qubits** ([*int*](https://docs.python.org/3/library/functions.html#int)) – number of qubit this circuit will span.
  *   **name** (*Optional\[*[*str*](https://docs.python.org/3/library/stdtypes.html#str)*]*) – a name of the circuit.
  ...
  <Attribute id="qiskit.synthesis.unitary.aqc.ApproximateCircuit.extension_lib" attributeValue="'include &#x22;qelib1.inc&#x22;;'" />
  ...
  <Attribute id="qiskit.synthesis.unitary.aqc.ApproximateCircuit.header" attributeValue="'OPENQASM 2.0;'" />
  ...
  <Function id="qiskit.synthesis.unitary.aqc.ApproximateCircuit.build" signature="build(thetas)" modifiers="abstract">
