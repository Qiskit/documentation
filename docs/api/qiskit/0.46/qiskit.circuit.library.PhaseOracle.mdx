...
<Class id="qiskit.circuit.library.PhaseOracle" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/circuit/library/phase_oracle.py" signature="qiskit.circuit.library.PhaseOracle(expression, synthesizer=None, var_order=None)">
  ...
  *   **var\_order** ([*list*](https://docs.python.org/3/library/stdtypes.html#list "(in Python v3.12)")) – A list with the order in which variables will be created. (default: by appearance)
  ...
  <Attribute id="qiskit.circuit.library.PhaseOracle.instances" name="instances" attributeValue="248" />
