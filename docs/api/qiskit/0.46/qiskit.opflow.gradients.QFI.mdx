...
<Class id="qiskit.opflow.gradients.QFI" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/opflow/gradients/qfi.py" signature="qiskit.opflow.gradients.QFI(qfi_method='lin_comb_full')">
...
$$
  ...
  <Attribute id="qiskit.opflow.gradients.QFI.qfi_method" name="qfi_method">
    Returns `CircuitQFI`.
