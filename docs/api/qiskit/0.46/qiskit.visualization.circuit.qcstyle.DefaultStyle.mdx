...
<Class id="qiskit.visualization.circuit.qcstyle.DefaultStyle" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/visualization/circuit/qcstyle.py" signature="qiskit.visualization.circuit.qcstyle.DefaultStyle">
