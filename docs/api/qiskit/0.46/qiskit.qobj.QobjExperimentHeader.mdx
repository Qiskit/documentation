...
<Class id="qiskit.qobj.QobjExperimentHeader" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/qobj/common.py" signature="qiskit.qobj.QobjExperimentHeader(**kwargs)">
