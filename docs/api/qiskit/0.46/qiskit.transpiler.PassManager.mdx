...
<Class id="qiskit.transpiler.PassManager" github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/transpiler/passmanager.py" signature="qiskit.transpiler.PassManager(passes=(), max_iteration=1000)">
