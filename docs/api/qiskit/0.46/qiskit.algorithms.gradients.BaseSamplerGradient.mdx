---
title: BaseSamplerGradient (v0.46)
description: API reference for qiskit.algorithms.gradients.BaseSamplerGradient in qiskit v0.46
...
<Class id="qiskit.algorithms.gradients.BaseSamplerGradient" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/algorithms/gradients/base/base_sampler_gradient.py" signature="qiskit.algorithms.gradients.BaseSamplerGradient(sampler, options=None)" modifiers="class">
