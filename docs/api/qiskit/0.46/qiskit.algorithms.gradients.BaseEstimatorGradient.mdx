---
title: BaseEstimatorGradient (v0.46)
description: API reference for qiskit.algorithms.gradients.BaseEstimatorGradient in qiskit v0.46
...
<Class id="qiskit.algorithms.gradients.BaseEstimatorGradient" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/algorithms/gradients/base/base_estimator_gradient.py" signature="qiskit.algorithms.gradients.BaseEstimatorGradient(estimator, options=None, derivative_type=DerivativeType.REAL)" modifiers="class">
  ...
  *   **derivative\_type** (*DerivativeType*) –
  ...
  <Function id="qiskit.algorithms.gradients.BaseEstimatorGradient.run" signature="run(circuits, observables, parameter_values, parameters=None, **options)">
  ...
  <Function id="qiskit.algorithms.gradients.BaseEstimatorGradient.update_default_options" signature="update_default_options(**options)">
