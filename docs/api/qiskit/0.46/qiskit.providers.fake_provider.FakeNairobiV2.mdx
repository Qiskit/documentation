...
<Class id="qiskit.providers.fake_provider.FakeNairobiV2" github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/providers/fake_provider/backends/nairobi/fake_nairobi.py" signature="qiskit.providers.fake_provider.FakeNairobiV2">
