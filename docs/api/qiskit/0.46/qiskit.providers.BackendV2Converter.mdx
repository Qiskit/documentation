...
<Class id="qiskit.providers.BackendV2Converter" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/providers/backend_compat.py" signature="qiskit.providers.BackendV2Converter(backend, name_mapping=None, add_delay=False, filter_faulty=False)">
