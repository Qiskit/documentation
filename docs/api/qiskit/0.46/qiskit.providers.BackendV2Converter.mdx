---
title: BackendV2Converter (v0.46)
description: API reference for qiskit.providers.BackendV2Converter in qiskit v0.46
...
<Class id="qiskit.providers.BackendV2Converter" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/providers/backend_compat.py" signature="qiskit.providers.BackendV2Converter(backend, name_mapping=None, add_delay=False, filter_faulty=False)" modifiers="class">
