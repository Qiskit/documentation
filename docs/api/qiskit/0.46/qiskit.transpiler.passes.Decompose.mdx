---
title: Decompose (v0.46)
description: API reference for qiskit.transpiler.passes.Decompose in qiskit v0.46
...
<Class id="qiskit.transpiler.passes.Decompose" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/transpiler/passes/basis/decompose.py" signature="qiskit.transpiler.passes.Decompose(*args, **kwargs)" modifiers="class">
  ...
  **gates\_to\_decompose** – optional subset of gates to be decomposed, identified by gate label, name or type. Defaults to all gates.
  ...
  <Function id="qiskit.transpiler.passes.Decompose.execute" signature="execute(passmanager_ir, state, callback=None)">
  ...
  <Function id="qiskit.transpiler.passes.Decompose.update_status" signature="update_status(state, run_state)">
