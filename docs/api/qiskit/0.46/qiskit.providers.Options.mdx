...
<Class id="qiskit.providers.Options" github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/providers/options.py" signature="qiskit.providers.Options(**kwargs)">
