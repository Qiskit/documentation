---
title: Options (v0.46)
description: API reference for qiskit.providers.Options in qiskit v0.46
...
<Class id="qiskit.providers.Options" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/providers/options.py" signature="qiskit.providers.Options(**kwargs)" modifiers="class">
