---
title: Bit (v0.46)
description: API reference for qiskit.circuit.Bit in qiskit v0.46
...
<Class id="qiskit.circuit.Bit" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/circuit/bit.py" signature="qiskit.circuit.Bit(register=None, index=None)" modifiers="class">
  ...
  <Attribute id="qiskit.circuit.Bit.index">
  ...
  <Attribute id="qiskit.circuit.Bit.register">
