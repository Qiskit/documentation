...
<Class id="qiskit.circuit.Bit" github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/circuit/bit.py" signature="qiskit.circuit.Bit(register=None, index=None)">
