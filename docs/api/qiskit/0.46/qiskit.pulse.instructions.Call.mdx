---
title: Call (v0.46)
description: API reference for qiskit.pulse.instructions.Call in qiskit v0.46
...
<Class id="qiskit.pulse.instructions.Call" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/pulse/instructions/call.py" signature="qiskit.pulse.instructions.Call(subroutine, value_dict=None, name=None)" modifiers="class">
