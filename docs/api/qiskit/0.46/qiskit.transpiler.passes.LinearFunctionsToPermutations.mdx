---
title: LinearFunctionsToPermutations (v0.46)
description: API reference for qiskit.transpiler.passes.LinearFunctionsToPermutations in qiskit v0.46
...
<Class id="qiskit.transpiler.passes.LinearFunctionsToPermutations" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/transpiler/passes/synthesis/linear_functions_synthesis.py" signature="qiskit.transpiler.passes.LinearFunctionsToPermutations(*args, **kwargs)" modifiers="class">
  ...
  <Function id="qiskit.transpiler.passes.LinearFunctionsToPermutations.execute" signature="execute(passmanager_ir, state, callback=None)">
  ...
  <Function id="qiskit.transpiler.passes.LinearFunctionsToPermutations.update_status" signature="update_status(state, run_state)">
