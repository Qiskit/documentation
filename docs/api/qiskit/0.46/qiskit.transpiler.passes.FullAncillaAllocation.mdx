---
title: FullAncillaAllocation (v0.46)
description: API reference for qiskit.transpiler.passes.FullAncillaAllocation in qiskit v0.46
...
<Class id="qiskit.transpiler.passes.FullAncillaAllocation" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/transpiler/passes/layout/full_ancilla_allocation.py" signature="qiskit.transpiler.passes.FullAncillaAllocation(*args, **kwargs)" modifiers="class">
  ...
  **coupling\_map** (*Union\[*[*CouplingMap*](qiskit.transpiler.CouplingMap "qiskit.transpiler.CouplingMap")*,* [*Target*](qiskit.transpiler.Target "qiskit.transpiler.Target")*]*) – directed graph representing a coupling map.
  ...
  <Function id="qiskit.transpiler.passes.FullAncillaAllocation.execute" signature="execute(passmanager_ir, state, callback=None)">
  ...
  <Function id="qiskit.transpiler.passes.FullAncillaAllocation.name" signature="name()">
    Name of the pass.
  ...
  <Function id="qiskit.transpiler.passes.FullAncillaAllocation.run" signature="run(dag)">
  ...
  <Function id="qiskit.transpiler.passes.FullAncillaAllocation.update_status" signature="update_status(state, run_state)">
  ...
  <Function id="qiskit.transpiler.passes.FullAncillaAllocation.validate_layout" signature="validate_layout(layout_qubits, dag_qubits)" modifiers="static">
