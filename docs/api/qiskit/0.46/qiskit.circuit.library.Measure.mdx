---
title: Measure (v0.46)
description: API reference for qiskit.circuit.library.Measure in qiskit v0.46
...
<Class id="qiskit.circuit.library.Measure" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/circuit/measure.py" signature="qiskit.circuit.library.Measure(label=None, *, duration=None, unit='dt')" modifiers="class">
  ...
  <Function id="qiskit.circuit.library.Measure.to_mutable" signature="to_mutable()">
