...
<Class id="qiskit.circuit.Instruction" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/circuit/instruction.py" signature="qiskit.circuit.Instruction(name, num_qubits, num_clbits, params, duration=None, unit='dt', label=None)">
  ...
  *   [**TypeError**](https://docs.python.org/3/library/exceptions.html#TypeError "(in Python v3.12)") – when the optional label is provided, but it is not a string.
  ...
  <Attribute id="qiskit.circuit.Instruction.base_class" name="base_class">
  ...
  <Attribute id="qiskit.circuit.Instruction.condition" name="condition">
  ...
  <Attribute id="qiskit.circuit.Instruction.mutable" name="mutable">
  ...
  <Function id="qiskit.circuit.Instruction.inverse" name="inverse" signature="inverse()">
  ...
  <Function id="qiskit.circuit.Instruction.qasm" name="qasm" signature="qasm()">
