---
title: Job (v0.46)
description: API reference for qiskit.providers.Job in qiskit v0.46
...
<Class id="qiskit.providers.Job" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/providers/job.py" signature="qiskit.providers.Job" modifiers="class">
