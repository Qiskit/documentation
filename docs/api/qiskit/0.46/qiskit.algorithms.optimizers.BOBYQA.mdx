---
title: BOBYQA (v0.46)
description: API reference for qiskit.algorithms.optimizers.BOBYQA in qiskit v0.46
...
<Class id="qiskit.algorithms.optimizers.BOBYQA" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/algorithms/optimizers/bobyqa.py" signature="qiskit.algorithms.optimizers.BOBYQA(maxiter=1000)" modifiers="class">
