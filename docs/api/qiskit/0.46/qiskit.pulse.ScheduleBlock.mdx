---
title: ScheduleBlock (v0.46)
description: API reference for qiskit.pulse.ScheduleBlock in qiskit v0.46
...
<Class id="qiskit.pulse.ScheduleBlock" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/pulse/schedule.py" signature="qiskit.pulse.ScheduleBlock(name=None, metadata=None, alignment_context=None)" modifiers="class">
  ...
  **Raises**
  ...
  <Function id="qiskit.pulse.ScheduleBlock.assign_parameters" signature="assign_parameters(value_dict, inplace=True)">
    ...
    *   **value\_dict** ([*Dict*](https://docs.python.org/3/library/typing.html#typing.Dict)*\[*[*ParameterExpression*](qiskit.circuit.ParameterExpression "qiskit.circuit.parameterexpression.ParameterExpression")*,* [*ParameterExpression*](qiskit.circuit.ParameterExpression "qiskit.circuit.parameterexpression.ParameterExpression")  *|*[*float*](https://docs.python.org/3/library/functions.html#float)*]*) – A mapping from Parameters to either numeric values or another Parameter expression.
  ...
  <Function id="qiskit.pulse.ScheduleBlock.draw" signature="draw(style=None, backend=None, time_range=None, time_unit='dt', disable_channels=None, show_snapshot=True, show_framechange=True, show_waveform_info=True, show_barrier=True, plotter='mpl2d', axis=None)">
    ...
    *   **disable\_channels** ([*List*](https://docs.python.org/3/library/typing.html#typing.List)*\[*[*Channel*](pulse#qiskit.pulse.channels.Channel "qiskit.pulse.channels.Channel")*] | None*) – A control property to show specific pulse channel. Pulse channel instances provided as a list are not shown in the output image.
    ...
    *   **show\_barrier** ([*bool*](https://docs.python.org/3/library/functions.html#bool)) – Show barrier lines.
  ...
  <Function id="qiskit.pulse.ScheduleBlock.exclude" signature="exclude(*filter_funcs, channels=None, instruction_types=None, check_subroutine=True)">
    ...
    *   **filter\_funcs** ([*List*](https://docs.python.org/3/library/typing.html#typing.List)*\[*[*Callable*](https://docs.python.org/3/library/typing.html#typing.Callable)*]*) – A list of Callables which take a `Instruction` and return a bool.
    *   **channels** ([*Iterable*](https://docs.python.org/3/library/typing.html#typing.Iterable)*\[*[*Channel*](pulse#qiskit.pulse.channels.Channel "qiskit.pulse.channels.Channel")*] | None*) – For example, `[DriveChannel(0), AcquireChannel(0)]`.
    *   **instruction\_types** ([*Iterable*](https://docs.python.org/3/library/typing.html#typing.Iterable)*\[*[*ABCMeta*](https://docs.python.org/3/library/abc.html#abc.ABCMeta)*] |* [*ABCMeta*](https://docs.python.org/3/library/abc.html#abc.ABCMeta) *| None*) – For example, `[PulseInstruction, AcquireInstruction]`.
    *   **check\_subroutine** ([*bool*](https://docs.python.org/3/library/functions.html#bool)) – Set True to individually filter instructions inside of a subroutine defined by the [`Call`](qiskit.pulse.instructions.Call "qiskit.pulse.instructions.Call") instruction.
  ...
  <Function id="qiskit.pulse.ScheduleBlock.filter" signature="filter(*filter_funcs, channels=None, instruction_types=None, check_subroutine=True)">
    ...
    *   **channels** ([*Iterable*](https://docs.python.org/3/library/typing.html#typing.Iterable)*\[*[*Channel*](pulse#qiskit.pulse.channels.Channel "qiskit.pulse.channels.Channel")*] | None*) – For example, `[DriveChannel(0), AcquireChannel(0)]`.
    *   **instruction\_types** ([*Iterable*](https://docs.python.org/3/library/typing.html#typing.Iterable)*\[*[*ABCMeta*](https://docs.python.org/3/library/abc.html#abc.ABCMeta)*] |* [*ABCMeta*](https://docs.python.org/3/library/abc.html#abc.ABCMeta) *| None*) – For example, `[PulseInstruction, AcquireInstruction]`.
    *   **check\_subroutine** ([*bool*](https://docs.python.org/3/library/functions.html#bool)) – Set True to individually filter instructions inside a subroutine defined by the [`Call`](qiskit.pulse.instructions.Call "qiskit.pulse.instructions.Call") instruction.
  ...
  <Function id="qiskit.pulse.ScheduleBlock.get_parameters" signature="get_parameters(parameter_name)">
    ...
    **Return type**
    ...
    [*List*](https://docs.python.org/3/library/typing.html#typing.List)\[[*Parameter*](qiskit.circuit.Parameter "qiskit.circuit.parameter.Parameter")]
  </Function>
  ...
  <Function id="qiskit.pulse.ScheduleBlock.initialize_from" signature="initialize_from(other_program, name=None)" modifiers="classmethod">
    ...
    *   **other\_program** ([*Any*](https://docs.python.org/3/library/typing.html#typing.Any)) – Qiskit program that provides metadata to new object.
  ...
  <Function id="qiskit.pulse.ScheduleBlock.scoped_parameters" signature="scoped_parameters()">
    ...
    **Return type**
    ...
    [*Tuple*](https://docs.python.org/3/library/typing.html#typing.Tuple)\[[*Parameter*](qiskit.circuit.Parameter "qiskit.circuit.parameter.Parameter")]
  </Function>
  ...
  <Function id="qiskit.pulse.ScheduleBlock.search_parameters" signature="search_parameters(parameter_regex)">
    ...
    **parameter\_regex** ([*str*](https://docs.python.org/3/library/stdtypes.html#str)) – Regular expression for scoped parameter name.
