...
<Class id="qiskit.quantum_info.Choi" github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/quantum_info/operators/channel/choi.py" signature="qiskit.quantum_info.Choi(data, input_dims=None, output_dims=None)">
