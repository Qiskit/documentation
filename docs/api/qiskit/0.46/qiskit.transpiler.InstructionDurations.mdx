...
<Class id="qiskit.transpiler.InstructionDurations" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/transpiler/instruction_durations.py" signature="qiskit.transpiler.InstructionDurations(instruction_durations=None, dt=None)">
  ...
  <Function id="qiskit.transpiler.InstructionDurations.get" name="get" signature="get(inst, qubits, unit='dt', parameters=None)">
