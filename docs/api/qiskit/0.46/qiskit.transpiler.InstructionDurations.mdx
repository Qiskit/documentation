---
title: InstructionDurations (v0.46)
description: API reference for qiskit.transpiler.InstructionDurations in qiskit v0.46
...
<Class id="qiskit.transpiler.InstructionDurations" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/transpiler/instruction_durations.py" signature="qiskit.transpiler.InstructionDurations(instruction_durations=None, dt=None)" modifiers="class">
  ...
  <Function id="qiskit.transpiler.InstructionDurations.get" signature="get(inst, qubits, unit='dt', parameters=None)">
