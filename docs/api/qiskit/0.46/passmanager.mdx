---
title: passmanager (v0.46)
description: API reference for qiskit.passmanager in qiskit v0.46
...
<Class id="qiskit.passmanager.PassManagerError" github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/passmanager/exceptions.py" signature="qiskit.passmanager.PassManagerError(*message)" modifiers="exception">
  Pass manager error.
