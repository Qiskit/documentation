...
<Class id="qiskit.passmanager.PassManagerError" name="PassManagerError" github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/passmanager/exceptions.py" signature="qiskit.passmanager.PassManagerError(*message)">
  Pass manager error.
