...
<Class id="qiskit.providers.fake_provider.FakeManhattanV2" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/providers/fake_provider/backends/manhattan/fake_manhattan.py" signature="qiskit.providers.fake_provider.FakeManhattanV2">
