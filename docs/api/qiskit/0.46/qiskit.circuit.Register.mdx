---
title: Register (v0.46)
description: API reference for qiskit.circuit.Register in qiskit v0.46
...
<Class id="qiskit.circuit.Register" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/circuit/register.py" signature="qiskit.circuit.Register(size=None, name=None, bits=None)" modifiers="class">
  ...
  *   [**CircuitError**](circuit#qiskit.circuit.CircuitError "qiskit.circuit.CircuitError") – if `bits` contained bits of an incorrect type.
  ...
  <Function id="qiskit.circuit.Register.index" signature="index(bit)">
