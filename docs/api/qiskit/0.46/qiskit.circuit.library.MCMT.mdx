---
title: MCMT (v0.46)
description: API reference for qiskit.circuit.library.MCMT in qiskit v0.46
...
<Class id="qiskit.circuit.library.MCMT" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/circuit/library/generalized_gates/mcmt.py" signature="qiskit.circuit.library.MCMT(gate, num_ctrl_qubits, num_target_qubits)" modifiers="class">
  ...
  *   [**AttributeError**](https://docs.python.org/3/library/exceptions.html#AttributeError) – If the number of controls or targets is 0.
  ...
  <Attribute id="qiskit.circuit.library.MCMT.instances" attributeValue="163" />
