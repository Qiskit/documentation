...
<Class id="qiskit.providers.fake_provider.FakeLimaV2" github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/providers/fake_provider/backends/lima/fake_lima.py" signature="qiskit.providers.fake_provider.FakeLimaV2">
