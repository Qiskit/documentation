---
title: Stinespring (v0.46)
description: API reference for qiskit.quantum_info.Stinespring in qiskit v0.46
...
<Class id="qiskit.quantum_info.Stinespring" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/quantum_info/operators/channel/stinespring.py" signature="qiskit.quantum_info.Stinespring(data, input_dims=None, output_dims=None)" modifiers="class">
