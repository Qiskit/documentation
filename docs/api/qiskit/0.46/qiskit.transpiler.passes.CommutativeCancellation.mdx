...
<Class id="qiskit.transpiler.passes.CommutativeCancellation" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/transpiler/passes/optimization/commutative_cancellation.py" signature="qiskit.transpiler.passes.CommutativeCancellation(*args, **kwargs)">
  ...
  *   **target** ([*Target*](qiskit.transpiler.Target "qiskit.transpiler.Target")) – The [`Target`](qiskit.transpiler.Target "qiskit.transpiler.Target") representing the target backend, if both `basis_gates` and `target` are specified then this argument will take precedence and `basis_gates` will be ignored.
  ...
  <Attribute id="qiskit.transpiler.passes.CommutativeCancellation.is_analysis_pass" name="is_analysis_pass">
  ...
  <Attribute id="qiskit.transpiler.passes.CommutativeCancellation.is_transformation_pass" name="is_transformation_pass">
  ...
  <Function id="qiskit.transpiler.passes.CommutativeCancellation.execute" name="execute" signature="execute(passmanager_ir, state, callback=None)">
  ...
  <Function id="qiskit.transpiler.passes.CommutativeCancellation.name" name="name" signature="name()">
    Name of the pass.
  ...
  <Function id="qiskit.transpiler.passes.CommutativeCancellation.run" name="run" signature="run(dag)">
  ...
  <Function id="qiskit.transpiler.passes.CommutativeCancellation.update_status" name="update_status" signature="update_status(state, run_state)">
