---
title: SabreLayout (v0.46)
description: API reference for qiskit.transpiler.passes.SabreLayout in qiskit v0.46
...
<Class id="qiskit.transpiler.passes.SabreLayout" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/transpiler/passes/layout/sabre_layout.py" signature="qiskit.transpiler.passes.SabreLayout(*args, **kwargs)" modifiers="class">
  ...
  **raises both `routing_pass` and `layout_trials` are specified**
  ...
  <Function id="qiskit.transpiler.passes.SabreLayout.execute" signature="execute(passmanager_ir, state, callback=None)">
  ...
  <Function id="qiskit.transpiler.passes.SabreLayout.update_status" signature="update_status(state, run_state)">
