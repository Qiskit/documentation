---
title: CommutationAnalysis (v0.46)
description: API reference for qiskit.transpiler.passes.CommutationAnalysis in qiskit v0.46
...
<Class id="qiskit.transpiler.passes.CommutationAnalysis" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/transpiler/passes/optimization/commutation_analysis.py" signature="qiskit.transpiler.passes.CommutationAnalysis(*args, **kwargs)" modifiers="class">
  ...
  <Function id="qiskit.transpiler.passes.CommutationAnalysis.execute" signature="execute(passmanager_ir, state, callback=None)">
  ...
  <Function id="qiskit.transpiler.passes.CommutationAnalysis.update_status" signature="update_status(state, run_state)">
