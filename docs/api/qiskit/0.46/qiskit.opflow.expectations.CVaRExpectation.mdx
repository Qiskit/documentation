---
title: CVaRExpectation (v0.46)
description: API reference for qiskit.opflow.expectations.CVaRExpectation in qiskit v0.46
...
<Class id="qiskit.opflow.expectations.CVaRExpectation" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/opflow/expectations/cvar_expectation.py" signature="qiskit.opflow.expectations.CVaRExpectation(alpha, expectation=None)" modifiers="class">
  ...
  *   **alpha** ([*float*](https://docs.python.org/3/library/functions.html#float)) – The alpha value describing the quantile considered in the expectation value.
  ...
  **Raises**
  ...
  [**NotImplementedError**](https://docs.python.org/3/library/exceptions.html#NotImplementedError) – If the `expectation` is an AerPauliExpecation.
  ...
  <Function id="qiskit.opflow.expectations.CVaRExpectation.compute_variance" signature="compute_variance(exp_op)">
    ...
    **Raises**
    ...
    [**ValueError**](https://docs.python.org/3/library/exceptions.html#ValueError) – If the exp\_op does not correspond to an expectation value.
