...
<Class id="qiskit.synthesis.unitary.aqc.CNOTUnitObjective" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/synthesis/unitary/aqc/cnot_unit_objective.py" signature="qiskit.synthesis.unitary.aqc.CNOTUnitObjective(num_qubits, cnots)">
