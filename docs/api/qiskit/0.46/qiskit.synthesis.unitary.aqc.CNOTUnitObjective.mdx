---
title: CNOTUnitObjective (v0.46)
description: API reference for qiskit.synthesis.unitary.aqc.CNOTUnitObjective in qiskit v0.46
...
<Class id="qiskit.synthesis.unitary.aqc.CNOTUnitObjective" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/synthesis/unitary/aqc/cnot_unit_objective.py" signature="qiskit.synthesis.unitary.aqc.CNOTUnitObjective(num_qubits, cnots)" modifiers="class">
