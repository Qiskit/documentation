...
<Class id="qiskit.providers.basicaer.QasmSimulatorPy" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/providers/basicaer/qasm_simulator.py" signature="qiskit.providers.basicaer.QasmSimulatorPy(configuration=None, provider=None, **fields)">
  ...
  <Attribute id="qiskit.providers.basicaer.QasmSimulatorPy.MAX_QUBITS_MEMORY" name="MAX_QUBITS_MEMORY" attributeValue="= 29" />
  ...
  <Function id="qiskit.providers.basicaer.QasmSimulatorPy.configuration" name="configuration" signature="configuration()">
  ...
  <Function id="qiskit.providers.basicaer.QasmSimulatorPy.name" name="name" signature="name()">
  ...
  <Function id="qiskit.providers.basicaer.QasmSimulatorPy.properties" name="properties" signature="properties()">
  ...
  <Function id="qiskit.providers.basicaer.QasmSimulatorPy.provider" name="provider" signature="provider()">
  ...
  <Function id="qiskit.providers.basicaer.QasmSimulatorPy.run" name="run" signature="run(run_input, **backend_options)">
    Run on the backend.
  ...
  <Function id="qiskit.providers.basicaer.QasmSimulatorPy.run_experiment" name="run_experiment" signature="run_experiment(experiment)">
  ...
  <Function id="qiskit.providers.basicaer.QasmSimulatorPy.set_options" name="set_options" signature="set_options(**fields)">
  ...
  <Function id="qiskit.providers.basicaer.QasmSimulatorPy.status" name="status" signature="status()">
