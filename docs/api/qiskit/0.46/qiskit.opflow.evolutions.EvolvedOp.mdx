---
title: EvolvedOp (v0.46)
description: API reference for qiskit.opflow.evolutions.EvolvedOp in qiskit v0.46
...
<Class id="qiskit.opflow.evolutions.EvolvedOp" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/opflow/evolutions/evolved_op.py" signature="qiskit.opflow.evolutions.EvolvedOp(*args, **kwargs)" modifiers="class">
  ...
  *   **coeff** – A coefficient multiplying the operator
  ...
  <Function id="qiskit.opflow.evolutions.EvolvedOp.eval" signature="eval(front=None)">
    ...
    **front** ([*str*](https://docs.python.org/3/library/stdtypes.html#str)  *|*[*dict*](https://docs.python.org/3/library/stdtypes.html#dict)  *|*[*ndarray*](https://numpy.org/doc/stable/reference/generated/numpy.ndarray.html#numpy.ndarray)  *|*[*OperatorBase*](qiskit.opflow.OperatorBase "qiskit.opflow.operator_base.OperatorBase")  *|*[*Statevector*](qiskit.quantum_info.Statevector "qiskit.quantum_info.states.statevector.Statevector") *| None*) – The bitstring, dict of bitstrings (with values being coefficients), or StateFn to evaluated by the Operator’s underlying function, or None.
  ...
  <Function id="qiskit.opflow.evolutions.EvolvedOp.permute" signature="permute(permutation)">
    ...
    **permutation** ([*List*](https://docs.python.org/3/library/typing.html#typing.List)*\[*[*int*](https://docs.python.org/3/library/functions.html#int)*]*) – A list defining where each qubit should be permuted. The qubit at index j should be permuted to position permutation\[j].
