...
<Class id="qiskit.opflow.evolutions.EvolvedOp" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/opflow/evolutions/evolved_op.py" signature="qiskit.opflow.evolutions.EvolvedOp(*args, **kwargs)">
  ...
  *   **coeff** – A coefficient multiplying the operator
  ...
  <Attribute id="qiskit.opflow.evolutions.EvolvedOp.primitive" name="primitive" attributeTypeHint="PrimitiveOp">
