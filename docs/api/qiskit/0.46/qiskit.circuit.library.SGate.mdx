---
title: SGate (v0.46)
description: API reference for qiskit.circuit.library.SGate in qiskit v0.46
...
<Class id="qiskit.circuit.library.SGate" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/circuit/library/standard_gates/s.py" signature="qiskit.circuit.library.SGate(*args, _force_mutable=False, **kwargs)" modifiers="class">
