---
title: SetLayout (v0.46)
description: API reference for qiskit.transpiler.passes.SetLayout in qiskit v0.46
...
<Class id="qiskit.transpiler.passes.SetLayout" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/transpiler/passes/layout/set_layout.py" signature="qiskit.transpiler.passes.SetLayout(*args, **kwargs)" modifiers="class">
  ...
  *   a list of integers: takes the index in the list as the physical position in which the virtual qubit is going to be mapped.
  ...
  <Function id="qiskit.transpiler.passes.SetLayout.execute" signature="execute(passmanager_ir, state, callback=None)">
  ...
  <Function id="qiskit.transpiler.passes.SetLayout.update_status" signature="update_status(state, run_state)">
