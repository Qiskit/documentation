...
<Class id="qiskit.algorithms.optimizers.TellData" github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/algorithms/optimizers/steppable_optimizer.py" signature="qiskit.algorithms.optimizers.TellData(eval_fun=None, eval_jac=None)">
