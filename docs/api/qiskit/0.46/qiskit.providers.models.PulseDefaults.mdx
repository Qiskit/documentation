---
title: PulseDefaults (v0.46)
description: API reference for qiskit.providers.models.PulseDefaults in qiskit v0.46
...
<Class id="qiskit.providers.models.PulseDefaults" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/providers/models/pulsedefaults.py" signature="qiskit.providers.models.PulseDefaults(qubit_freq_est, meas_freq_est, buffer, pulse_library, cmd_def, meas_kernel=None, discriminator=None, **kwargs)" modifiers="class">
  ...
  <Function id="qiskit.providers.models.PulseDefaults.from_dict" signature="from_dict(data)" modifiers="classmethod">
  ...
  <Function id="qiskit.providers.models.PulseDefaults.to_dict" signature="to_dict()">
