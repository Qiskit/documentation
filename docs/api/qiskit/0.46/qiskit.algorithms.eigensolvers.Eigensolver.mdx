---
title: Eigensolver (v0.46)
description: API reference for qiskit.algorithms.eigensolvers.Eigensolver in qiskit v0.46
...
<Class id="qiskit.algorithms.eigensolvers.Eigensolver" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/algorithms/eigensolvers/eigensolver.py" signature="qiskit.algorithms.eigensolvers.Eigensolver" modifiers="class">
