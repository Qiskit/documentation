---
title: GenericPass (v0.46)
description: API reference for qiskit.passmanager.GenericPass in qiskit v0.46
...
<Class id="qiskit.passmanager.GenericPass" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/passmanager/base_tasks.py" signature="qiskit.passmanager.GenericPass" modifiers="class">
  ...
  <Function id="qiskit.passmanager.GenericPass.execute" signature="execute(passmanager_ir, state, callback=None)">
  ...
  <Function id="qiskit.passmanager.GenericPass.name" signature="name()">
    Name of the pass.
  ...
  <Function id="qiskit.passmanager.GenericPass.run" signature="run(passmanager_ir)" modifiers="abstract">
  ...
  <Function id="qiskit.passmanager.GenericPass.update_status" signature="update_status(state, run_state)">
