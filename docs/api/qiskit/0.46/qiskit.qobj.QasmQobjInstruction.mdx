---
title: QasmQobjInstruction (v0.46)
description: API reference for qiskit.qobj.QasmQobjInstruction in qiskit v0.46
...
<Class id="qiskit.qobj.QasmQobjInstruction" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/qobj/qasm_qobj.py" signature="qiskit.qobj.QasmQobjInstruction(name, params=None, qubits=None, register=None, memory=None, condition=None, conditional=None, label=None, mask=None, relation=None, val=None, snapshot_type=None)" modifiers="class">
