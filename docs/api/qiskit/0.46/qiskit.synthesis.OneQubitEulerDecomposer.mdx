...
<Class id="qiskit.synthesis.OneQubitEulerDecomposer" github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/synthesis/one_qubit/one_qubit_decompose.py" signature="qiskit.synthesis.OneQubitEulerDecomposer(basis='U3', use_dag=False)">
