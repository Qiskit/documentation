...
<Class id="qiskit.opflow.converters.TwoQubitReduction" github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/opflow/converters/two_qubit_reduction.py" signature="qiskit.opflow.converters.TwoQubitReduction(num_particles)">
