---
title: LinCombSamplerGradient (v0.46)
description: API reference for qiskit.algorithms.gradients.LinCombSamplerGradient in qiskit v0.46
...
<Class id="qiskit.algorithms.gradients.LinCombSamplerGradient" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/algorithms/gradients/lin_comb/lin_comb_sampler_gradient.py" signature="qiskit.algorithms.gradients.LinCombSamplerGradient(sampler, options=None)" modifiers="class">
