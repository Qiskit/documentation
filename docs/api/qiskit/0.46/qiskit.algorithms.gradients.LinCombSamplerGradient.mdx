...
<Class id="qiskit.algorithms.gradients.LinCombSamplerGradient" github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/algorithms/gradients/lin_comb/lin_comb_sampler_gradient.py" signature="qiskit.algorithms.gradients.LinCombSamplerGradient(sampler, options=None)">
