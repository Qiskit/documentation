---
title: plot_circuit_layout (v0.46)
description: API reference for qiskit.visualization.plot_circuit_layout in qiskit v0.46
...
<Function id="qiskit.visualization.plot_circuit_layout" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/visualization/gate_map.py" signature="qiskit.visualization.plot_circuit_layout(circuit, backend, view='virtual', qubit_coordinates=None)">
  ...
  *   **view** ([*str*](https://docs.python.org/3/library/stdtypes.html#str)) – Layout view: either ‘virtual’ or ‘physical’.
  ...
  **Example**
  ...
  ![../\_images/qiskit-visualization-plot\_circuit\_layout-1.png](/docs/images/api/qiskit/0.46/qiskit-visualization-plot_circuit_layout-1.avif)
</Function>
