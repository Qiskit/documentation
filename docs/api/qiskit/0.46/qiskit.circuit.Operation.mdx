...
<Class id="qiskit.circuit.Operation" github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/circuit/operation.py" signature="qiskit.circuit.Operation">
