---
title: Operation (v0.46)
description: API reference for qiskit.circuit.Operation in qiskit v0.46
...
<Class id="qiskit.circuit.Operation" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/circuit/operation.py" signature="qiskit.circuit.Operation" modifiers="class">
  ...
  **Example**
  ...
  ![../\_images/qiskit-circuit-Operation-1.png](/docs/images/api/qiskit/0.46/qiskit-circuit-Operation-1.avif)
