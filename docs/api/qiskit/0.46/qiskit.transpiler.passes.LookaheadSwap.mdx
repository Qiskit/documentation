---
title: LookaheadSwap (v0.46)
description: API reference for qiskit.transpiler.passes.LookaheadSwap in qiskit v0.46
...
<Class id="qiskit.transpiler.passes.LookaheadSwap" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/transpiler/passes/routing/lookahead_swap.py" signature="qiskit.transpiler.passes.LookaheadSwap(*args, **kwargs)" modifiers="class">
