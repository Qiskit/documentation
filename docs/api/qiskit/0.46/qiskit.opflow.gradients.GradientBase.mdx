...
<Class id="qiskit.opflow.gradients.GradientBase" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/opflow/gradients/gradient_base.py" signature="qiskit.opflow.gradients.GradientBase(grad_method='param_shift', **kwargs)">
  ...
  **Raises**
  ...
  <Attribute id="qiskit.opflow.gradients.GradientBase.grad_method" name="grad_method">
