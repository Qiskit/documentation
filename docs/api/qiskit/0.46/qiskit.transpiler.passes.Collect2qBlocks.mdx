---
title: Collect2qBlocks (v0.46)
description: API reference for qiskit.transpiler.passes.Collect2qBlocks in qiskit v0.46
...
<Class id="qiskit.transpiler.passes.Collect2qBlocks" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/transpiler/passes/optimization/collect_2q_blocks.py" signature="qiskit.transpiler.passes.Collect2qBlocks(*args, **kwargs)" modifiers="class">
  ...
  <Function id="qiskit.transpiler.passes.Collect2qBlocks.execute" signature="execute(passmanager_ir, state, callback=None)">
  ...
  <Function id="qiskit.transpiler.passes.Collect2qBlocks.update_status" signature="update_status(state, run_state)">
