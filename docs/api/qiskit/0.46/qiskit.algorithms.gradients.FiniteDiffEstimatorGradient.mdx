---
title: FiniteDiffEstimatorGradient (v0.46)
description: API reference for qiskit.algorithms.gradients.FiniteDiffEstimatorGradient in qiskit v0.46
...
<Class id="qiskit.algorithms.gradients.FiniteDiffEstimatorGradient" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/algorithms/gradients/finite_diff/finite_diff_estimator_gradient.py" signature="qiskit.algorithms.gradients.FiniteDiffEstimatorGradient(estimator, epsilon, options=None, *, method='central')" modifiers="class">
  ...
  *   **epsilon** ([*float*](https://docs.python.org/3/library/functions.html#float)) – The offset size for the finite difference gradients.
  ...
  *   [**TypeError**](https://docs.python.org/3/library/exceptions.html#TypeError) – If `method` is invalid.
