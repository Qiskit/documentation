---
title: SolovayKitaevSynthesis (v0.46)
description: API reference for qiskit.transpiler.passes.SolovayKitaevSynthesis in qiskit v0.46
...
<Class id="qiskit.transpiler.passes.SolovayKitaevSynthesis" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/transpiler/passes/synthesis/solovay_kitaev_synthesis.py" signature="qiskit.transpiler.passes.SolovayKitaevSynthesis" modifiers="class">
  ...
  **recursion\_degree (int):**
  ...
  <Attribute id="qiskit.transpiler.passes.SolovayKitaevSynthesis.supports_gate_errors_by_qubit">
  ...
  <Attribute id="qiskit.transpiler.passes.SolovayKitaevSynthesis.supports_gate_lengths_by_qubit">
  ...
  <Function id="qiskit.transpiler.passes.SolovayKitaevSynthesis.run" signature="run(unitary, **options)">
