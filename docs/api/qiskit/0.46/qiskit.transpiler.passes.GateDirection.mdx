...
<Class id="qiskit.transpiler.passes.GateDirection" github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/transpiler/passes/utils/gate_direction.py" signature="qiskit.transpiler.passes.GateDirection(*args, **kwargs)">
