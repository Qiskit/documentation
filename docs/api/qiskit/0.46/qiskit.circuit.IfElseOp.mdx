...
<Class id="qiskit.circuit.IfElseOp" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/circuit/controlflow/if_else.py" signature="qiskit.circuit.IfElseOp(condition, true_body, false_body=None, label=None)">
  ...
  *   [**TypeError**](https://docs.python.org/3/library/exceptions.html#TypeError "(in Python v3.12)") – when the optional label is provided, but it is not a string.
  ...
  <Attribute id="qiskit.circuit.IfElseOp.base_class" name="base_class">
  ...
  <Attribute id="qiskit.circuit.IfElseOp.condition" name="condition">
  ...
  <Attribute id="qiskit.circuit.IfElseOp.mutable" name="mutable">
  ...
  <Function id="qiskit.circuit.IfElseOp.inverse" name="inverse" signature="inverse()">
  ...
  <Function id="qiskit.circuit.IfElseOp.qasm" name="qasm" signature="qasm()">
