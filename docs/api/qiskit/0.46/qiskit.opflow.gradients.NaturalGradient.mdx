...
<Class id="qiskit.opflow.gradients.NaturalGradient" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/opflow/gradients/natural_gradient.py" signature="qiskit.opflow.gradients.NaturalGradient(grad_method='lin_comb', qfi_method='lin_comb_full', regularization=None, **kwargs)">
  ...
  *   **kwargs** ([*dict*](https://docs.python.org/3/library/stdtypes.html#dict "(in Python v3.12)")) – Optional parameters for a CircuitGradient
  ...
  <Function id="qiskit.opflow.gradients.NaturalGradient.convert" name="convert" signature="convert(operator, params=None)">
    **Parameters**
  ...
  <Function id="qiskit.opflow.gradients.NaturalGradient.nat_grad_combo_fn" name="nat_grad_combo_fn" signature="static nat_grad_combo_fn(x, regularization=None)">
