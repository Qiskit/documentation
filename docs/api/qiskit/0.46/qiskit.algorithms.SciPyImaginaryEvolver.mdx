...
<Class id="qiskit.algorithms.SciPyImaginaryEvolver" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/algorithms/time_evolvers/classical_methods/scipy_imaginary_evolver.py" signature="qiskit.algorithms.SciPyImaginaryEvolver(num_timesteps)">
