...
<Class id="qiskit.qobj.QobjMeasurementOption" github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/qobj/pulse_qobj.py" signature="qiskit.qobj.QobjMeasurementOption(name, params=None)">
