...
<Class id="qiskit.circuit.EquivalenceLibrary" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/circuit/equivalence.py" signature="qiskit.circuit.EquivalenceLibrary(*, base=None)">
