...
<Class id="qiskit.opflow.list_ops.TensoredOp" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/opflow/list_ops/tensored_op.py" signature="qiskit.opflow.list_ops.TensoredOp(oplist, coeff=1.0, abelian=False)">
