---
title: TensoredOp (v0.46)
description: API reference for qiskit.opflow.list_ops.TensoredOp in qiskit v0.46
...
<Class id="qiskit.opflow.list_ops.TensoredOp" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/opflow/list_ops/tensored_op.py" signature="qiskit.opflow.list_ops.TensoredOp(oplist, coeff=1.0, abelian=False)" modifiers="class">
  ...
  *   **oplist** ([*List*](https://docs.python.org/3/library/typing.html#typing.List)*\[*[*OperatorBase*](qiskit.opflow.OperatorBase "qiskit.opflow.operator_base.OperatorBase")*]*) – The Operators being tensored.
  *   **coeff** ([*complex*](https://docs.python.org/3/library/functions.html#complex)  *|*[*ParameterExpression*](qiskit.circuit.ParameterExpression "qiskit.circuit.parameterexpression.ParameterExpression")) – A coefficient multiplying the operator
  *   **abelian** ([*bool*](https://docs.python.org/3/library/functions.html#bool)) – Indicates whether the Operators in `oplist` are known to mutually commute.
  ...
  <Function id="qiskit.opflow.list_ops.TensoredOp.eval" signature="eval(front=None)">
    ...
    **front** ([*str*](https://docs.python.org/3/library/stdtypes.html#str)  *|*[*dict*](https://docs.python.org/3/library/stdtypes.html#dict)  *|*[*ndarray*](https://numpy.org/doc/stable/reference/generated/numpy.ndarray.html#numpy.ndarray)  *|*[*OperatorBase*](qiskit.opflow.OperatorBase "qiskit.opflow.operator_base.OperatorBase")  *|*[*Statevector*](qiskit.quantum_info.Statevector "qiskit.quantum_info.states.statevector.Statevector") *| None*) – The bitstring, dict of bitstrings (with values being coefficients), or StateFn to evaluated by the Operator’s underlying function.
    ...
    *   [**NotImplementedError**](https://docs.python.org/3/library/exceptions.html#NotImplementedError) – Raised if called for a subclass which is not distributive.
    *   [**TypeError**](https://docs.python.org/3/library/exceptions.html#TypeError) – Operators with mixed hierarchies, such as a ListOp containing both PrimitiveOps and ListOps, are not supported.
    *   [**NotImplementedError**](https://docs.python.org/3/library/exceptions.html#NotImplementedError) – Attempting to call ListOp’s eval from a non-distributive subclass.
