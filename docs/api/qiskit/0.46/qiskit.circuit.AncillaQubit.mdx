...
<Class id="qiskit.circuit.AncillaQubit" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/circuit/quantumregister.py" signature="qiskit.circuit.AncillaQubit(register=None, index=None)">
