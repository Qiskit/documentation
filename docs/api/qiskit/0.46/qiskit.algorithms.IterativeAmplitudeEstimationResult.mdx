---
title: IterativeAmplitudeEstimationResult (v0.46)
description: API reference for qiskit.algorithms.IterativeAmplitudeEstimationResult in qiskit v0.46
...
<Class id="qiskit.algorithms.IterativeAmplitudeEstimationResult" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/algorithms/amplitude_estimators/iae.py" signature="qiskit.algorithms.IterativeAmplitudeEstimationResult" modifiers="class">
