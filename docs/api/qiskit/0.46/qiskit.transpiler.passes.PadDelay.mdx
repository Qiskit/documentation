...
description: API reference for qiskit.transpiler.passes.PadDelay in qiskit v0.46
...
<Class id="qiskit.transpiler.passes.PadDelay" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/transpiler/passes/scheduling/padding/pad_delay.py" signature="qiskit.transpiler.passes.PadDelay(*args, **kwargs)" modifiers="class">
  Bases: `BasePadding`
