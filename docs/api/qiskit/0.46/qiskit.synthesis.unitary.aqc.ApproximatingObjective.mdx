...
<Class id="qiskit.synthesis.unitary.aqc.ApproximatingObjective" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/synthesis/unitary/aqc/approximate.py" signature="qiskit.synthesis.unitary.aqc.ApproximatingObjective">
  ...
  <Function id="qiskit.synthesis.unitary.aqc.ApproximatingObjective.gradient" signature="abstract gradient(param_values)">
  ...
  <Function id="qiskit.synthesis.unitary.aqc.ApproximatingObjective.objective" signature="abstract objective(param_values)">
