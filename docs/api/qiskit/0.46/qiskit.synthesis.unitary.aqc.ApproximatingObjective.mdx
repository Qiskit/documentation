...
<Class id="qiskit.synthesis.unitary.aqc.ApproximatingObjective" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/synthesis/unitary/aqc/approximate.py" signature="qiskit.synthesis.unitary.aqc.ApproximatingObjective" modifiers="class">
  ...
  <Function id="qiskit.synthesis.unitary.aqc.ApproximatingObjective.gradient" signature="gradient(param_values)" modifiers="abstract">
  ...
  <Function id="qiskit.synthesis.unitary.aqc.ApproximatingObjective.objective" signature="objective(param_values)" modifiers="abstract">
