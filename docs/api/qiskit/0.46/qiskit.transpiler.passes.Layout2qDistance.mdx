...
<Class id="qiskit.transpiler.passes.Layout2qDistance" github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/transpiler/passes/layout/layout_2q_distance.py" signature="qiskit.transpiler.passes.Layout2qDistance(*args, **kwargs)">
