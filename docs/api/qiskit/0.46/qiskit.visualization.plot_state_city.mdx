...
<Function id="qiskit.visualization.plot_state_city" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/visualization/state_visualization.py" signature="qiskit.visualization.plot_state_city(state, title='', figsize=None, color=None, alpha=1, ax_real=None, ax_imag=None, *, filename=None)">
  ...
  **Examples**
  ...
  ![../\_images/qiskit-visualization-plot\_state\_city-1.png](/images/api/qiskit/0.46/qiskit-visualization-plot_state_city-1.avif)
  ...
  ![../\_images/qiskit-visualization-plot\_state\_city-2.png](/images/api/qiskit/0.46/qiskit-visualization-plot_state_city-2.avif)
</Function>
