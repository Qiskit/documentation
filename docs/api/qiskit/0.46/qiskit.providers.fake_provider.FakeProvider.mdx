...
<Class id="qiskit.providers.fake_provider.FakeProvider" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/providers/fake_provider/fake_provider.py" signature="qiskit.providers.fake_provider.FakeProvider">
