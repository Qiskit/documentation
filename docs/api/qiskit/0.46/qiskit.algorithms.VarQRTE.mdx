---
title: VarQRTE (v0.46)
description: API reference for qiskit.algorithms.VarQRTE in qiskit v0.46
...
<Class id="qiskit.algorithms.VarQRTE" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/algorithms/time_evolvers/variational/var_qrte.py" signature="qiskit.algorithms.VarQRTE(ansatz, initial_parameters, variational_principle=None, estimator=None, ode_solver=<class 'qiskit.algorithms.time_evolvers.variational.solvers.ode.forward_euler_solver.ForwardEulerSolver'>, lse_solver=None, num_timesteps=None, imag_part_tol=1e-07, num_instability_tol=1e-07)" modifiers="class">
  ...
  *   **initial\_parameters** (*Mapping\[*[*Parameter*](qiskit.circuit.Parameter "qiskit.circuit.Parameter")*,* [*float*](https://docs.python.org/3/library/functions.html#float)*] | Sequence\[*[*float*](https://docs.python.org/3/library/functions.html#float)*]*) – Initial parameter values for an ansatz.
  ...
  *   **ode\_solver** ([*Type*](circuit_classical#qiskit.circuit.classical.types.Type "qiskit.circuit.classical.types.Type")*\[OdeSolver] |* [*str*](https://docs.python.org/3/library/stdtypes.html#str)) – ODE solver callable that implements a SciPy `OdeSolver` interface or a string indicating a valid method offered by SciPy.
