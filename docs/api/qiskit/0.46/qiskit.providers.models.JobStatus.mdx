...
<Class id="qiskit.providers.models.JobStatus" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/providers/models/jobstatus.py" signature="qiskit.providers.models.JobStatus(job_id, status, status_msg, **kwargs)">
