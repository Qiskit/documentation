...
<Class id="qiskit.primitives.SamplerResult" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/primitives/base/sampler_result.py" signature="qiskit.primitives.SamplerResult(quasi_dists, metadata)">
