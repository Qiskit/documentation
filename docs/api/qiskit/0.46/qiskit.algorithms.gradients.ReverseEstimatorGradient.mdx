---
title: ReverseEstimatorGradient (v0.46)
description: API reference for qiskit.algorithms.gradients.ReverseEstimatorGradient in qiskit v0.46
...
<Class id="qiskit.algorithms.gradients.ReverseEstimatorGradient" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/algorithms/gradients/reverse/reverse_gradient.py" signature="qiskit.algorithms.gradients.ReverseEstimatorGradient(derivative_type=DerivativeType.REAL)" modifiers="class">
