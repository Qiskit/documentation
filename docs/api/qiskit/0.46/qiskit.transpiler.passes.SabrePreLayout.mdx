...
<Class id="qiskit.transpiler.passes.SabrePreLayout" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/transpiler/passes/layout/sabre_pre_layout.py" signature="qiskit.transpiler.passes.SabrePreLayout(*args, **kwargs)">
