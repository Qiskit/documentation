---
title: VF2Layout (v0.46)
description: API reference for qiskit.transpiler.passes.VF2Layout in qiskit v0.46
...
<Class id="qiskit.transpiler.passes.VF2Layout" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/transpiler/passes/layout/vf2_layout.py" signature="qiskit.transpiler.passes.VF2Layout(*args, **kwargs)" modifiers="class">
  ...
  **Raises**
  ...
  <Function id="qiskit.transpiler.passes.VF2Layout.execute" signature="execute(passmanager_ir, state, callback=None)">
  ...
  <Function id="qiskit.transpiler.passes.VF2Layout.name" signature="name()">
    Name of the pass.
  ...
  <Function id="qiskit.transpiler.passes.VF2Layout.run" signature="run(dag)">
    run the layout method
  </Function>

  ### update\_status

  <Function id="qiskit.transpiler.passes.VF2Layout.update_status" signature="update_status(state, run_state)">
