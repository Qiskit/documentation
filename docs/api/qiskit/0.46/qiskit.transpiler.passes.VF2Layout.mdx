...
<Class id="qiskit.transpiler.passes.VF2Layout" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/transpiler/passes/layout/vf2_layout.py" signature="qiskit.transpiler.passes.VF2Layout(*args, **kwargs)">
