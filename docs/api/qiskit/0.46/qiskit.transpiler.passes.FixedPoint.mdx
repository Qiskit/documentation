---
title: FixedPoint (v0.46)
description: API reference for qiskit.transpiler.passes.FixedPoint in qiskit v0.46
...
<Class id="qiskit.transpiler.passes.FixedPoint" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/transpiler/passes/utils/fixed_point.py" signature="qiskit.transpiler.passes.FixedPoint(*args, **kwargs)" modifiers="class">
