...
<Class id="qiskit.providers.fake_provider.FakeBelemV2" github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/providers/fake_provider/backends/belem/fake_belem.py" signature="qiskit.providers.fake_provider.FakeBelemV2">
