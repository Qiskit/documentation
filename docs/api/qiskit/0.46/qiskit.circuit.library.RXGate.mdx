...
<Class id="qiskit.circuit.library.RXGate" github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/circuit/library/standard_gates/rx.py" signature="qiskit.circuit.library.RXGate(theta, label=None, *, duration=None, unit='dt')">
