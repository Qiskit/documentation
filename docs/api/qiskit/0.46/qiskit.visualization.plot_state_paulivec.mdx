...
<Function id="qiskit.visualization.plot_state_paulivec" github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/visualization/state_visualization.py" signature="qiskit.visualization.plot_state_paulivec(state, title='', figsize=None, color=None, ax=None, *, filename=None)">
