...
<Class id="qiskit.passmanager.BaseController" github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/passmanager/base_tasks.py" signature="qiskit.passmanager.BaseController(options=None)">
