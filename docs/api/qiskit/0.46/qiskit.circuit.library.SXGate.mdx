...
<Class id="qiskit.circuit.library.SXGate" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/circuit/library/standard_gates/sx.py" signature="qiskit.circuit.library.SXGate(*args, _force_mutable=False, **kwargs)">
