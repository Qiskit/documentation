...
<Class id="qiskit.algorithms.PhaseEstimationScale" github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/algorithms/phase_estimators/phase_estimation_scale.py" signature="qiskit.algorithms.PhaseEstimationScale(bound)">
