---
title: PhaseEstimationScale (v0.46)
description: API reference for qiskit.algorithms.PhaseEstimationScale in qiskit v0.46
...
<Class id="qiskit.algorithms.PhaseEstimationScale" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/algorithms/phase_estimators/phase_estimation_scale.py" signature="qiskit.algorithms.PhaseEstimationScale(bound)" modifiers="class">
  ...
  **bound** ([*float*](https://docs.python.org/3/library/functions.html#float)) – an upper bound on the absolute value of the eigenvalues of a Hermitian operator. (The operator is not needed here.)
  ...
  <Function id="qiskit.algorithms.PhaseEstimationScale.from_pauli_sum" signature="from_pauli_sum(pauli_sum)" modifiers="classmethod">
    ...
    **Raises**
    ...
    [**ValueError**](https://docs.python.org/3/library/exceptions.html#ValueError) – if `pauli_sum` is not a sum of Pauli operators.
    ...
    **Return type**
    ...
    ‘PhaseEstimationScale’ | [float](https://docs.python.org/3/library/functions.html#float)
  </Function>
  ...
  <Function id="qiskit.algorithms.PhaseEstimationScale.scale_phase" signature="scale_phase(phi, id_coefficient=0.0)">
    ...
    *   **phi** ([*float*](https://docs.python.org/3/library/functions.html#float)) – Normalized phase in $[0, 1)$ to be converted to an eigenvalue.
    *   **id\_coefficient** ([*float*](https://docs.python.org/3/library/functions.html#float)) – All eigenvalues are shifted by this value.
  ...
  <Function id="qiskit.algorithms.PhaseEstimationScale.scale_phases" signature="scale_phases(phases, id_coefficient=0.0)">
    ...
    *   **phases** ([*list*](https://docs.python.org/3/library/stdtypes.html#list)  *|*[*dict*](https://docs.python.org/3/library/stdtypes.html#dict)) – a list or dict of values of `phi`.
    *   **id\_coefficient** ([*float*](https://docs.python.org/3/library/functions.html#float)) – All eigenvalues are shifted by this value.
    ...
    **Return type**
    ...
    [dict](https://docs.python.org/3/library/stdtypes.html#dict) | [list](https://docs.python.org/3/library/stdtypes.html#list)
  </Function>
</Class>
