---
title: CrosstalkAdaptiveSchedule (v0.46)
description: API reference for qiskit.transpiler.passes.CrosstalkAdaptiveSchedule in qiskit v0.46
...
<Class id="qiskit.transpiler.passes.CrosstalkAdaptiveSchedule" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/transpiler/passes/optimization/crosstalk_adaptive_schedule.py" signature="qiskit.transpiler.passes.CrosstalkAdaptiveSchedule(*args, **kwargs)" modifiers="class">
  ...
  *   **crosstalk\_prop** ([*dict*](https://docs.python.org/3/library/stdtypes.html#dict)) –
  ...
  **Raises**
  ...
  [**ImportError**](https://docs.python.org/3/library/exceptions.html#ImportError) – if unable to import z3 solver
