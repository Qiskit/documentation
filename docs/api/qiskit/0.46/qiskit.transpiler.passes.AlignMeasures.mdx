...
<Class id="qiskit.transpiler.passes.AlignMeasures" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/transpiler/passes/scheduling/alignments/align_measures.py" signature="qiskit.transpiler.passes.AlignMeasures(*args, **kwargs)">
  ...
  **alignment** – Integer number representing the minimum time resolution to trigger measure instruction in units of `dt`. This value depends on the control electronics of your quantum processor.
  ...
  <Function id="qiskit.transpiler.passes.AlignMeasures.execute" name="execute" signature="execute(passmanager_ir, state, callback=None)">
  ...
  <Function id="qiskit.transpiler.passes.AlignMeasures.update_status" name="update_status" signature="update_status(state, run_state)">
