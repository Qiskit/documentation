...
<Class id="qiskit.providers.fake_provider.FakeKolkataV2" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/providers/fake_provider/backends/kolkata/fake_kolkata.py" signature="qiskit.providers.fake_provider.FakeKolkataV2">
