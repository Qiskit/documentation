...
<Class id="qiskit.algorithms.optimizers.Optimizer" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/algorithms/optimizers/optimizer.py" signature="qiskit.algorithms.optimizers.Optimizer">
  ...
  <Function id="qiskit.algorithms.optimizers.Optimizer.gradient_num_diff" signature="static gradient_num_diff(x_center, f, epsilon, max_evals_grouped=None)">
  ...
  <Function id="qiskit.algorithms.optimizers.Optimizer.minimize" signature="abstract minimize(fun, x0, jac=None, bounds=None)">
