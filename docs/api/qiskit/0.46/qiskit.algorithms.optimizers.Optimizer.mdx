---
title: Optimizer (v0.46)
description: API reference for qiskit.algorithms.optimizers.Optimizer in qiskit v0.46
...
<Class id="qiskit.algorithms.optimizers.Optimizer" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/algorithms/optimizers/optimizer.py" signature="qiskit.algorithms.optimizers.Optimizer" modifiers="class">
  ...
  <Function id="qiskit.algorithms.optimizers.Optimizer.gradient_num_diff" signature="gradient_num_diff(x_center, f, epsilon, max_evals_grouped=None)" modifiers="static">
  ...
  <Function id="qiskit.algorithms.optimizers.Optimizer.minimize" signature="minimize(fun, x0, jac=None, bounds=None)" modifiers="abstract">
