...
<Class id="qiskit.algorithms.ImaginaryEvolver" github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/algorithms/evolvers/imaginary_evolver.py" signature="qiskit.algorithms.ImaginaryEvolver">
