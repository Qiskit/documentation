...
description: API reference for qiskit.primitives.Estimator in qiskit v0.46
...
<Class id="qiskit.primitives.Estimator" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/primitives/estimator.py" signature="qiskit.primitives.Estimator(*, options=None)" modifiers="class">
