...
<Class id="qiskit.primitives.Estimator" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/primitives/estimator.py" signature="qiskit.primitives.Estimator(*, options=None)">
