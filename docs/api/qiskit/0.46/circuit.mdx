...
<Class id="qiskit.circuit.CircuitError" github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/circuit/exceptions.py" signature="qiskit.circuit.CircuitError(*message)">
