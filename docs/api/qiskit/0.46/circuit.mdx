---
title: circuit (v0.46)
description: API reference for qiskit.circuit in qiskit v0.46
...
![../\_images/circuit-1.png](/docs/images/api/qiskit/0.46/circuit-1.avif)
...
![../\_images/circuit-2.png](/docs/images/api/qiskit/0.46/circuit-2.avif)
...
![../\_images/circuit-3.png](/docs/images/api/qiskit/0.46/circuit-3.avif)
...
![../\_images/circuit-4.png](/docs/images/api/qiskit/0.46/circuit-4.avif)
...
![../\_images/depth.gif](/docs/images/api/qiskit/0.46/depth.gif)
...
<Function id="qiskit.circuit.random.random_circuit" github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/circuit/random/utils.py" signature="qiskit.circuit.random.random_circuit(num_qubits, depth, max_operands=4, measure=False, conditional=False, reset=False, seed=None)">
  ...
  ![../\_images/circuit-5.png](/docs/images/api/qiskit/0.46/circuit-5.avif)
