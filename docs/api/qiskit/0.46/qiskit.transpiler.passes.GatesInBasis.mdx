---
title: GatesInBasis (v0.46)
description: API reference for qiskit.transpiler.passes.GatesInBasis in qiskit v0.46
...
<Class id="qiskit.transpiler.passes.GatesInBasis" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/transpiler/passes/utils/gates_basis.py" signature="qiskit.transpiler.passes.GatesInBasis(*args, **kwargs)" modifiers="class">
  ...
  *   **target** ([*Target*](qiskit.transpiler.Target "qiskit.transpiler.Target")) – The target representing the backend. If specified this will be used instead of the `basis_gates` parameter
  ...
  <Function id="qiskit.transpiler.passes.GatesInBasis.execute" signature="execute(passmanager_ir, state, callback=None)">
  ...
  <Function id="qiskit.transpiler.passes.GatesInBasis.name" signature="name()">
    Name of the pass.
  ...
  <Function id="qiskit.transpiler.passes.GatesInBasis.run" signature="run(dag)">
    Run the GatesInBasis pass on dag.
  </Function>

  ### update\_status

  <Function id="qiskit.transpiler.passes.GatesInBasis.update_status" signature="update_status(state, run_state)">
