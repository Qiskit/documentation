---
title: NFT (v0.46)
description: API reference for qiskit.algorithms.optimizers.NFT in qiskit v0.46
...
<Class id="qiskit.algorithms.optimizers.NFT" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/algorithms/optimizers/nft.py" signature="qiskit.algorithms.optimizers.NFT(maxiter=None, maxfev=1024, disp=False, reset_interval=32, options=None, **kwargs)" modifiers="class">
  ...
  *   **maxiter** ([*int*](https://docs.python.org/3/library/functions.html#int) *| None*) – Maximum number of iterations to perform.
  *   **maxfev** ([*int*](https://docs.python.org/3/library/functions.html#int)) – Maximum number of function evaluations to perform.
  *   **disp** ([*bool*](https://docs.python.org/3/library/functions.html#bool)) – disp
  *   **reset\_interval** ([*int*](https://docs.python.org/3/library/functions.html#int)) – The minimum estimates directly once in `reset_interval` times.
