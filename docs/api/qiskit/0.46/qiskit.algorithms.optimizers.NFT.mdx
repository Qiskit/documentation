...
<Class id="qiskit.algorithms.optimizers.NFT" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/algorithms/optimizers/nft.py" signature="qiskit.algorithms.optimizers.NFT(maxiter=None, maxfev=1024, disp=False, reset_interval=32, options=None, **kwargs)">
  ...
  **References**
  ...
  <Function id="qiskit.algorithms.optimizers.NFT.gradient_num_diff" signature="static gradient_num_diff(x_center, f, epsilon, max_evals_grouped=None)">
  ...
  <Function id="qiskit.algorithms.optimizers.NFT.wrap_function" signature="static wrap_function(function, args)">
