---
title: UCPauliRotGate (v0.46)
description: API reference for qiskit.circuit.library.UCPauliRotGate in qiskit v0.46
...
<Class id="qiskit.circuit.library.UCPauliRotGate" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/circuit/library/generalized_gates/uc_pauli_rot.py" signature="qiskit.circuit.library.UCPauliRotGate(angle_list, rot_axis)" modifiers="class">
