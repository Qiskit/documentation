---
title: QDrift (v0.46)
description: API reference for qiskit.opflow.evolutions.QDrift in qiskit v0.46
...
<Class id="qiskit.opflow.evolutions.QDrift" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/opflow/evolutions/trotterizations/qdrift.py" signature="qiskit.opflow.evolutions.QDrift(reps=1)" modifiers="class">
  ...
  Deprecated: The QDrift Trotterization method, which selects each term in the Trotterization randomly, with a probability proportional to its weight. Based on the work of Earl Campbell in [https://arxiv.org/abs/1811.08017](https://arxiv.org/abs/1811.08017).
