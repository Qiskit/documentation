...
<Function id="qiskit.quantum_info.pauli_basis" github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/quantum_info/operators/symplectic/pauli_utils.py" signature="qiskit.quantum_info.pauli_basis(num_qubits, weight=False)">
