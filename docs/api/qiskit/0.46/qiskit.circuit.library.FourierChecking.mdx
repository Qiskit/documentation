---
title: FourierChecking (v0.46)
description: API reference for qiskit.circuit.library.FourierChecking in qiskit v0.46
...
<Class id="qiskit.circuit.library.FourierChecking" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/circuit/library/fourier_checking.py" signature="qiskit.circuit.library.FourierChecking(f, g)" modifiers="class">
  ...
  *   **f** ([*List*](https://docs.python.org/3/library/typing.html#typing.List)*\[*[*int*](https://docs.python.org/3/library/functions.html#int)*]*) – truth table for f, length 2\*\*n list of \{1,-1}.
  *   **g** ([*List*](https://docs.python.org/3/library/typing.html#typing.List)*\[*[*int*](https://docs.python.org/3/library/functions.html#int)*]*) – truth table for g, length 2\*\*n list of \{1,-1}.
  ...
  **Reference Circuit:**
  ...
  ![../\_images/qiskit-circuit-library-FourierChecking-1.png](/docs/images/api/qiskit/0.46/qiskit-circuit-library-FourierChecking-1.avif)
  ...
  <Attribute id="qiskit.circuit.library.FourierChecking.instances" attributeValue="167" />
