...
<Class id="qiskit.quantum_info.ScalarOp" github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/quantum_info/operators/scalar_op.py" signature="qiskit.quantum_info.ScalarOp(dims=None, coeff=1)">
  Bases: `LinearOp`
