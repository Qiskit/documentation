---
title: ScalarOp (v0.46)
description: API reference for qiskit.quantum_info.ScalarOp in qiskit v0.46
...
<Class id="qiskit.quantum_info.ScalarOp" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/quantum_info/operators/scalar_op.py" signature="qiskit.quantum_info.ScalarOp(dims=None, coeff=1)" modifiers="class">
  Bases: `LinearOp`
