---
title: MaximumLikelihoodAmplitudeEstimationResult (v0.46)
description: API reference for qiskit.algorithms.MaximumLikelihoodAmplitudeEstimationResult in qiskit v0.46
...
<Class id="qiskit.algorithms.MaximumLikelihoodAmplitudeEstimationResult" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/algorithms/amplitude_estimators/mlae.py" signature="qiskit.algorithms.MaximumLikelihoodAmplitudeEstimationResult" modifiers="class">
