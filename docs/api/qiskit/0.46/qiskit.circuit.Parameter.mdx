---
title: Parameter (v0.46)
description: API reference for qiskit.circuit.Parameter in qiskit v0.46
...
<Class id="qiskit.circuit.Parameter" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/circuit/parameter.py" signature="qiskit.circuit.Parameter(name, *, uuid=None)" modifiers="class">
  ...
  **Examples**
  ...
  ![../\_images/qiskit-circuit-Parameter-1\_00.png](/docs/images/api/qiskit/0.46/qiskit-circuit-Parameter-1_00.avif)

  ![../\_images/qiskit-circuit-Parameter-1\_01.png](/docs/images/api/qiskit/0.46/qiskit-circuit-Parameter-1_01.avif)
