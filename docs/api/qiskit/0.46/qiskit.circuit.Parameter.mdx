...
<Class id="qiskit.circuit.Parameter" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/circuit/parameter.py" signature="qiskit.circuit.Parameter(name, *, uuid=None)">
