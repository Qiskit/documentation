---
title: PauliGate (v0.46)
description: API reference for qiskit.circuit.library.PauliGate in qiskit v0.46
...
<Class id="qiskit.circuit.library.PauliGate" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/circuit/library/generalized_gates/pauli.py" signature="qiskit.circuit.library.PauliGate(label)" modifiers="class">
