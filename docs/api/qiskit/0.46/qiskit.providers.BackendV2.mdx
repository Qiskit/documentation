---
title: BackendV2 (v0.46)
description: API reference for qiskit.providers.BackendV2 in qiskit v0.46
...
<Class id="qiskit.providers.BackendV2" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/providers/backend.py" signature="qiskit.providers.BackendV2(provider=None, name=None, description=None, online_date=None, backend_version=None, **fields)" modifiers="class">
  ...
  <Function id="qiskit.providers.BackendV2._default_options" signature="_default_options()" modifiers="abstract classmethod">
  ...
  **Raises**
  ...
  <Function id="qiskit.providers.BackendV2.acquire_channel" signature="acquire_channel(qubit)">
  ...
  <Function id="qiskit.providers.BackendV2.control_channel" signature="control_channel(qubits)">
  ...
  <Function id="qiskit.providers.BackendV2.drive_channel" signature="drive_channel(qubit)">
  ...
  <Function id="qiskit.providers.BackendV2.measure_channel" signature="measure_channel(qubit)">
  ...
  <Function id="qiskit.providers.BackendV2.qubit_properties" signature="qubit_properties(qubit)">
  ...
  <Function id="qiskit.providers.BackendV2.run" signature="run(run_input, **options)" modifiers="abstract">
    Run on the backend.
  ...
  <Function id="qiskit.providers.BackendV2.set_options" signature="set_options(**fields)">
