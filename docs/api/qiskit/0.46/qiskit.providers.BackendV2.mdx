...
<Class id="qiskit.providers.BackendV2" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/providers/backend.py" signature="qiskit.providers.BackendV2(provider=None, name=None, description=None, online_date=None, backend_version=None, **fields)">
  ...
  <Function id="qiskit.providers.BackendV2._default_options" name="_default_options" signature="abstract classmethod _default_options()">
  ...
  **Raises**
  ...
  <Function id="qiskit.providers.BackendV2.acquire_channel" name="acquire_channel" signature="acquire_channel(qubit)">
  ...
  <Function id="qiskit.providers.BackendV2.control_channel" name="control_channel" signature="control_channel(qubits)">
  ...
  <Function id="qiskit.providers.BackendV2.drive_channel" name="drive_channel" signature="drive_channel(qubit)">
  ...
  <Function id="qiskit.providers.BackendV2.measure_channel" name="measure_channel" signature="measure_channel(qubit)">
  ...
  <Function id="qiskit.providers.BackendV2.qubit_properties" name="qubit_properties" signature="qubit_properties(qubit)">
  ...
  <Function id="qiskit.providers.BackendV2.run" name="run" signature="abstract run(run_input, **options)">
    Run on the backend.
  ...
  <Function id="qiskit.providers.BackendV2.set_options" name="set_options" signature="set_options(**fields)">
