...
<Class id="qiskit.providers.fake_provider.FakeCairoV2" github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/providers/fake_provider/backends/cairo/fake_cairo.py" signature="qiskit.providers.fake_provider.FakeCairoV2">
