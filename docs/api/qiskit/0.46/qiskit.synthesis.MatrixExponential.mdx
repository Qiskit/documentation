---
title: MatrixExponential (v0.46)
description: API reference for qiskit.synthesis.MatrixExponential in qiskit v0.46
...
<Class id="qiskit.synthesis.MatrixExponential" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/synthesis/evolution/matrix_synthesis.py" signature="qiskit.synthesis.MatrixExponential" modifiers="class">
