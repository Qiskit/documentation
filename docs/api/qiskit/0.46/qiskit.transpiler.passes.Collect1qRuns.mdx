---
title: Collect1qRuns (v0.46)
description: API reference for qiskit.transpiler.passes.Collect1qRuns in qiskit v0.46
...
<Class id="qiskit.transpiler.passes.Collect1qRuns" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/transpiler/passes/optimization/collect_1q_runs.py" signature="qiskit.transpiler.passes.Collect1qRuns(*args, **kwargs)" modifiers="class">
  ...
  <Function id="qiskit.transpiler.passes.Collect1qRuns.execute" signature="execute(passmanager_ir, state, callback=None)">
  ...
  <Function id="qiskit.transpiler.passes.Collect1qRuns.update_status" signature="update_status(state, run_state)">
