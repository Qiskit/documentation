---
title: BasicSwap (v0.46)
description: API reference for qiskit.transpiler.passes.BasicSwap in qiskit v0.46
...
<Class id="qiskit.transpiler.passes.BasicSwap" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/transpiler/passes/routing/basic_swap.py" signature="qiskit.transpiler.passes.BasicSwap(*args, **kwargs)" modifiers="class">
  ...
  *   **fake\_run** ([*bool*](https://docs.python.org/3/library/functions.html#bool)) – if true, it will only pretend to do routing, i.e., no swap is effectively added.
  ...
  <Function id="qiskit.transpiler.passes.BasicSwap.execute" signature="execute(passmanager_ir, state, callback=None)">
  ...
  <Function id="qiskit.transpiler.passes.BasicSwap.name" signature="name()">
    Name of the pass.
  ...
  <Function id="qiskit.transpiler.passes.BasicSwap.run" signature="run(dag)">
  ...
  <Function id="qiskit.transpiler.passes.BasicSwap.update_status" signature="update_status(state, run_state)">
