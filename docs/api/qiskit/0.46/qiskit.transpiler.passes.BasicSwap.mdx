...
<Class id="qiskit.transpiler.passes.BasicSwap" github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/transpiler/passes/routing/basic_swap.py" signature="qiskit.transpiler.passes.BasicSwap(*args, **kwargs)">
