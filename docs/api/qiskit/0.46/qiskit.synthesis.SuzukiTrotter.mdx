...
<Class id="qiskit.synthesis.SuzukiTrotter" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/synthesis/evolution/suzuki_trotter.py" signature="qiskit.synthesis.SuzukiTrotter(order=2, reps=1, insert_barriers=False, cx_structure='chain', atomic_evolution=None)">
...
$$
  ...
  **Raises**
  ...
  <Function id="qiskit.synthesis.SuzukiTrotter.synthesize" name="synthesize" signature="synthesize(evolution)">
