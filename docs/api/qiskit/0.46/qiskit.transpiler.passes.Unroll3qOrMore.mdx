---
title: Unroll3qOrMore (v0.46)
description: API reference for qiskit.transpiler.passes.Unroll3qOrMore in qiskit v0.46
...
<Class id="qiskit.transpiler.passes.Unroll3qOrMore" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/transpiler/passes/basis/unroll_3q_or_more.py" signature="qiskit.transpiler.passes.Unroll3qOrMore(*args, **kwargs)" modifiers="class">
