...
<Class id="qiskit.qobj.PulseLibraryItem" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/qobj/pulse_qobj.py" signature="qiskit.qobj.PulseLibraryItem(name, samples)">
