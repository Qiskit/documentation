---
title: PulseLibraryItem (v0.46)
description: API reference for qiskit.qobj.PulseLibraryItem in qiskit v0.46
...
<Class id="qiskit.qobj.PulseLibraryItem" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/qobj/pulse_qobj.py" signature="qiskit.qobj.PulseLibraryItem(name, samples)" modifiers="class">
