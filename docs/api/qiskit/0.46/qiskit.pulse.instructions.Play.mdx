...
<Class id="qiskit.pulse.instructions.Play" github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/pulse/instructions/play.py" signature="qiskit.pulse.instructions.Play(pulse, channel, name=None)">
