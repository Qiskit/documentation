---
title: SNOBFIT (v0.46)
description: API reference for qiskit.algorithms.optimizers.SNOBFIT in qiskit v0.46
...
<Class id="qiskit.algorithms.optimizers.SNOBFIT" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/algorithms/optimizers/snobfit.py" signature="qiskit.algorithms.optimizers.SNOBFIT(maxiter=1000, maxfail=10, maxmp=None, verbose=False)" modifiers="class">
  ...
  *   **maxmp** ([*int*](https://docs.python.org/3/library/functions.html#int)) – Maximum number of model points requested for the local fit. Default = 2 \* number of parameters + 6 set to this value when None.
  *   **maxfail** ([*int*](https://docs.python.org/3/library/functions.html#int)) – Maximum number of failures to improve the solution. Stops the algorithm after maxfail is reached.
  *   **verbose** ([*bool*](https://docs.python.org/3/library/functions.html#bool)) – Provide verbose (debugging) output.
  ...
  *   [**QiskitError**](exceptions#qiskit.exceptions.QiskitError "qiskit.exceptions.QiskitError") – If NumPy 1.24.0 or above is installed. See [https://github.com/scikit-quant/scikit-quant/issues/24](https://github.com/scikit-quant/scikit-quant/issues/24) for more details.
  ...
  <Function id="qiskit.algorithms.optimizers.SNOBFIT.gradient_num_diff" signature="gradient_num_diff(x_center, f, epsilon, max_evals_grouped=None)" modifiers="static">
  ...
  <Function id="qiskit.algorithms.optimizers.SNOBFIT.minimize" signature="minimize(fun, x0, jac=None, bounds=None)">
