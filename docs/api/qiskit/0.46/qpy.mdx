---
title: qpy (v0.46)
description: API reference for qiskit.qpy in qiskit v0.46
...
<Function id="qiskit.qpy.load" github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/qpy/interface.py" signature="qiskit.qpy.load(file_obj, metadata_deserializer=None)">
...
<Function id="qiskit.qpy.dump" github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/qpy/interface.py" signature="qiskit.qpy.dump(programs, file_obj, metadata_serializer=None, use_symengine=False)">
...
<Class id="qiskit.qpy.QpyError" github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/qpy/exceptions.py" signature="qiskit.qpy.QpyError(*message)" modifiers="exception">
