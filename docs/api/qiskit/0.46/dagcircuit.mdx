...
description: API reference for qiskit.dagcircuit in qiskit v0.46
...
<Class id="qiskit.dagcircuit.DAGCircuitError" github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/dagcircuit/exceptions.py" signature="qiskit.dagcircuit.DAGCircuitError(*msg)" modifiers="exception">
...
<Class id="qiskit.dagcircuit.DAGDependencyError" github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/dagcircuit/exceptions.py" signature="qiskit.dagcircuit.DAGDependencyError(*msg)" modifiers="exception">
