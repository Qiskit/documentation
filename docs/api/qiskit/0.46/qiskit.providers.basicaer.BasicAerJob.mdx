...
<Class id="qiskit.providers.basicaer.BasicAerJob" github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/providers/basicaer/basicaerjob.py" signature="qiskit.providers.basicaer.BasicAerJob(backend, job_id, result)">
