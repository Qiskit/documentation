...
<Class id="qiskit.providers.fake_provider.FakeMontrealV2" github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/providers/fake_provider/backends/montreal/fake_montreal.py" signature="qiskit.providers.fake_provider.FakeMontrealV2">
