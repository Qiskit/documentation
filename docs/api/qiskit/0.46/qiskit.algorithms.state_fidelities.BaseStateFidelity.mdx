...
<Class id="qiskit.algorithms.state_fidelities.BaseStateFidelity" github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/algorithms/state_fidelities/base_state_fidelity.py" signature="qiskit.algorithms.state_fidelities.BaseStateFidelity">
