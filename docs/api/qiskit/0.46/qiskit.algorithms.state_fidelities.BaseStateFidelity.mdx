---
title: BaseStateFidelity (v0.46)
description: API reference for qiskit.algorithms.state_fidelities.BaseStateFidelity in qiskit v0.46
...
<Class id="qiskit.algorithms.state_fidelities.BaseStateFidelity" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/algorithms/state_fidelities/base_state_fidelity.py" signature="qiskit.algorithms.state_fidelities.BaseStateFidelity" modifiers="class">
