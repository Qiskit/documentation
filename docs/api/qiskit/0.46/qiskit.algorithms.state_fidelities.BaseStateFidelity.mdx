...
<Class id="qiskit.algorithms.state_fidelities.BaseStateFidelity" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/algorithms/state_fidelities/base_state_fidelity.py" signature="qiskit.algorithms.state_fidelities.BaseStateFidelity">
...
$$
  ...
  <Function id="qiskit.algorithms.state_fidelities.BaseStateFidelity.create_fidelity_circuit" name="create_fidelity_circuit" signature="abstract create_fidelity_circuit(circuit_1, circuit_2)">
  ...
  <Function id="qiskit.algorithms.state_fidelities.BaseStateFidelity.run" name="run" signature="run(circuits_1, circuits_2, values_1=None, values_2=None, **options)">
