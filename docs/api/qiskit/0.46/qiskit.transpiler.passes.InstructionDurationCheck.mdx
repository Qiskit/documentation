...
<Class id="qiskit.transpiler.passes.InstructionDurationCheck" github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/transpiler/passes/scheduling/alignments/check_durations.py" signature="qiskit.transpiler.passes.InstructionDurationCheck(*args, **kwargs)">
