---
title: AnalysisPass (v0.46)
description: API reference for qiskit.transpiler.AnalysisPass in qiskit v0.46
...
<Class id="qiskit.transpiler.AnalysisPass" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/transpiler/basepasses.py" signature="qiskit.transpiler.AnalysisPass(*args, **kwargs)" modifiers="class">
  Bases: `BasePass`
  ...
  <Function id="qiskit.transpiler.AnalysisPass.execute" signature="execute(passmanager_ir, state, callback=None)">
  ...
  <Function id="qiskit.transpiler.AnalysisPass.update_status" signature="update_status(state, run_state)">
