...
<Class id="qiskit.opflow.state_fns.OperatorStateFn" github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/opflow/state_fns/operator_state_fn.py" signature="qiskit.opflow.state_fns.OperatorStateFn(*args, **kwargs)">
