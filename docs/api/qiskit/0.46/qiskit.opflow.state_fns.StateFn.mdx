...
<Class id="qiskit.opflow.state_fns.StateFn" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/opflow/state_fns/state_fn.py" signature="qiskit.opflow.state_fns.StateFn(primitive=None, coeff=1.0, is_measurement=False)">
  ...
  **Return type**
  ...
  <Function id="qiskit.opflow.state_fns.StateFn.add" name="add" signature="add(other)">
  ...
  <Function id="qiskit.opflow.state_fns.StateFn.adjoint" name="adjoint" signature="adjoint()">
  ...
  <Function id="qiskit.opflow.state_fns.StateFn.assign_parameters" name="assign_parameters" signature="assign_parameters(param_dict)">
  ...
  <Function id="qiskit.opflow.state_fns.StateFn.compose" name="compose" signature="compose(other, permutation=None, front=False)">
  ...
  <Function id="qiskit.opflow.state_fns.StateFn.equals" name="equals" signature="equals(other)">
  ...
  <Function id="qiskit.opflow.state_fns.StateFn.eval" name="eval" signature="eval(front=None)">
  ...
  <Function id="qiskit.opflow.state_fns.StateFn.mul" name="mul" signature="mul(scalar)">
  ...
  <Function id="qiskit.opflow.state_fns.StateFn.permute" name="permute" signature="permute(permutation)">
  ...
  <Function id="qiskit.opflow.state_fns.StateFn.power" name="power" signature="power(exponent)">
  ...
  <Function id="qiskit.opflow.state_fns.StateFn.primitive_strings" name="primitive_strings" signature="primitive_strings()">
  ...
  <Function id="qiskit.opflow.state_fns.StateFn.reduce" name="reduce" signature="reduce()">
  ...
  <Function id="qiskit.opflow.state_fns.StateFn.sample" name="sample" signature="sample(shots=1024, massive=False, reverse_endianness=False)">
  ...
  <Function id="qiskit.opflow.state_fns.StateFn.tensor" name="tensor" signature="tensor(other)">
  ...
  <Function id="qiskit.opflow.state_fns.StateFn.tensorpower" name="tensorpower" signature="tensorpower(other)">
  ...
  <Function id="qiskit.opflow.state_fns.StateFn.to_circuit_op" name="to_circuit_op" signature="to_circuit_op()">
  ...
  <Function id="qiskit.opflow.state_fns.StateFn.to_density_matrix" name="to_density_matrix" signature="to_density_matrix(massive=False)">
  ...
  <Function id="qiskit.opflow.state_fns.StateFn.to_matrix" name="to_matrix" signature="to_matrix(massive=False)">
  ...
  <Function id="qiskit.opflow.state_fns.StateFn.to_matrix_op" name="to_matrix_op" signature="to_matrix_op(massive=False)">
  ...
  <Function id="qiskit.opflow.state_fns.StateFn.traverse" name="traverse" signature="traverse(convert_fn, coeff=None)">
