...
<Class id="qiskit.pulse.instructions.TimeBlockade" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/pulse/instructions/directives.py" signature="qiskit.pulse.instructions.TimeBlockade(duration, channel, name=None)">
  Bases: `Directive`
  ...
  *   **name** ([*str*](https://docs.python.org/3/library/stdtypes.html#str "(in Python v3.12)") *| None*) – Name of the time blockade for display purposes.
  ...
  <Function id="qiskit.pulse.instructions.TimeBlockade.append" name="append" signature="append(schedule, name=None)">
  ...
  <Function id="qiskit.pulse.instructions.TimeBlockade.ch_duration" name="ch_duration" signature="ch_duration(*channels)">
  ...
  <Function id="qiskit.pulse.instructions.TimeBlockade.ch_start_time" name="ch_start_time" signature="ch_start_time(*channels)">
  ...
  <Function id="qiskit.pulse.instructions.TimeBlockade.ch_stop_time" name="ch_stop_time" signature="ch_stop_time(*channels)">
  ...
  <Function id="qiskit.pulse.instructions.TimeBlockade.draw" name="draw" signature="draw(dt=1, style=None, filename=None, interp_method=None, scale=1, plot_all=False, plot_range=None, interactive=False, table=True, label=False, framechange=True, channels=None)">
  ...
  <Function id="qiskit.pulse.instructions.TimeBlockade.insert" name="insert" signature="insert(start_time, schedule, name=None)">
  ...
  <Function id="qiskit.pulse.instructions.TimeBlockade.is_parameterized" name="is_parameterized" signature="is_parameterized()">
  ...
  <Function id="qiskit.pulse.instructions.TimeBlockade.shift" name="shift" signature="shift(time, name=None)">
