---
title: AmplitudeEstimationResult (v0.46)
description: API reference for qiskit.algorithms.AmplitudeEstimationResult in qiskit v0.46
...
<Class id="qiskit.algorithms.AmplitudeEstimationResult" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/algorithms/amplitude_estimators/ae.py" signature="qiskit.algorithms.AmplitudeEstimationResult" modifiers="class">
