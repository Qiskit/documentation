...
<Class id="qiskit.circuit.library.Barrier" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/circuit/barrier.py" signature="qiskit.circuit.library.Barrier(num_qubits, label=None)">
  ...
  **Raises**
  ...
  <Attribute id="qiskit.circuit.library.Barrier.base_class" name="base_class">
  ...
  <Attribute id="qiskit.circuit.library.Barrier.condition" name="condition">
  ...
  <Attribute id="qiskit.circuit.library.Barrier.mutable" name="mutable">
  ...
  <Function id="qiskit.circuit.library.Barrier.inverse" name="inverse" signature="inverse()">
  ...
  <Function id="qiskit.circuit.library.Barrier.qasm" name="qasm" signature="qasm()">
