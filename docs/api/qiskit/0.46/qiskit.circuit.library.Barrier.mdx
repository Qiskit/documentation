---
title: Barrier (v0.46)
description: API reference for qiskit.circuit.library.Barrier in qiskit v0.46
...
<Class id="qiskit.circuit.library.Barrier" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/circuit/barrier.py" signature="qiskit.circuit.library.Barrier(num_qubits, label=None)" modifiers="class">
  ...
  *   **num\_qubits** ([*int*](https://docs.python.org/3/library/functions.html#int)) – the number of qubits for the barrier type \[Default: 0].
  *   **label** ([*str*](https://docs.python.org/3/library/stdtypes.html#str)) – the barrier label

  **Raises**

  [**TypeError**](https://docs.python.org/3/library/exceptions.html#TypeError) – if barrier label is invalid.
  ...
  <Function id="qiskit.circuit.library.Barrier.soft_compare" signature="soft_compare(other)">
  ...
  <Function id="qiskit.circuit.library.Barrier.to_mutable" signature="to_mutable()">
