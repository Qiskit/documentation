---
title: AlignRight (v0.46)
description: API reference for qiskit.pulse.transforms.AlignRight in qiskit v0.46
...
<Class id="qiskit.pulse.transforms.AlignRight" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/pulse/transforms/alignments.py" signature="qiskit.pulse.transforms.AlignRight" modifiers="class">
