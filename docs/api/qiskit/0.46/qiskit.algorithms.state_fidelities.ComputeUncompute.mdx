...
<Class id="qiskit.algorithms.state_fidelities.ComputeUncompute" github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/algorithms/state_fidelities/compute_uncompute.py" signature="qiskit.algorithms.state_fidelities.ComputeUncompute(sampler, options=None, local=False)">
