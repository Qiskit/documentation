...
<Class id="qiskit.opflow.evolutions.PauliTrotterEvolution" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/opflow/evolutions/pauli_trotter_evolution.py" signature="qiskit.opflow.evolutions.PauliTrotterEvolution(trotter_mode='trotter', reps=1)">
