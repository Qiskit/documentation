...
description: API reference for qiskit.algorithms.PhaseEstimation in qiskit v0.46
...
<Class id="qiskit.algorithms.PhaseEstimation" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/algorithms/phase_estimators/phase_estimation.py" signature="qiskit.algorithms.PhaseEstimation(num_evaluation_qubits, quantum_instance=None, sampler=None)" modifiers="class">
...
$$
  ...
  **Raises**
  ...
  <Function id="qiskit.algorithms.PhaseEstimation.estimate_from_pe_circuit" signature="estimate_from_pe_circuit(pe_circuit, num_unitary_qubits)">
    ...
    *   **num\_unitary\_qubits** ([*int*](https://docs.python.org/3/library/functions.html#int)) – Must agree with the number of qubits in the unitary in pe\_circuit.
