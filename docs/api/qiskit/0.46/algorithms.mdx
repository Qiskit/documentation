---
title: algorithms (v0.46)
description: API reference for qiskit.algorithms in qiskit v0.46
...
<Function id="qiskit.algorithms.eval_observables" github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/algorithms/aux_ops_evaluator.py" signature="qiskit.algorithms.eval_observables(quantum_instance, quantum_state, observables, expectation, threshold=1e-12)">
  ...
  *   **threshold** ([*float*](https://docs.python.org/3/library/functions.html#float)) – A threshold value that defines which mean values should be neglected (helpful for ignoring numerical instabilities close to 0).
  ...
  **Raises**
  ...
  [**ValueError**](https://docs.python.org/3/library/exceptions.html#ValueError) – If a `quantum_state` with free parameters is provided.

  **Return type**

  ListOrDict\[[tuple](https://docs.python.org/3/library/stdtypes.html#tuple)\[[complex](https://docs.python.org/3/library/functions.html#complex), [complex](https://docs.python.org/3/library/functions.html#complex)]]
</Function>
...
<Function id="qiskit.algorithms.estimate_observables" github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/algorithms/observables_evaluator.py" signature="qiskit.algorithms.estimate_observables(estimator, quantum_state, observables, parameter_values=None, threshold=1e-12)">
  ...
  *   **parameter\_values** (*Sequence\[*[*float*](https://docs.python.org/3/library/functions.html#float)*] | None*) – Optional list of parameters values to evaluate the quantum circuit on.
  *   **threshold** ([*float*](https://docs.python.org/3/library/functions.html#float)) – A threshold value that defines which mean values should be neglected (helpful for ignoring numerical instabilities close to 0).
  ...
  **Return type**
  ...
  ListOrDict\[[tuple](https://docs.python.org/3/library/stdtypes.html#tuple)\[[complex](https://docs.python.org/3/library/functions.html#complex), [dict](https://docs.python.org/3/library/stdtypes.html#dict)\[[str](https://docs.python.org/3/library/stdtypes.html#str), Any]]]
</Function>
