...
<Class id="qiskit.transpiler.InstructionProperties" github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/transpiler/target.py" signature="qiskit.transpiler.InstructionProperties(duration=None, error=None, calibration=None)">
