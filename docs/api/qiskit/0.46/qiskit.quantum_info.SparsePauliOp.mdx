...
<Class id="qiskit.quantum_info.SparsePauliOp" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/quantum_info/operators/symplectic/sparse_pauli_op.py" signature="qiskit.quantum_info.SparsePauliOp(data, coeffs=None, *, ignore_pauli_phase=False, copy=True)">
  ...
  **Raises**
  ...
  <Function id="qiskit.quantum_info.SparsePauliOp.from_list" signature="static from_list(obj, dtype=<class 'complex'>, *, num_qubits=None)">
...
$$
  ...
  <Function id="qiskit.quantum_info.SparsePauliOp.from_operator" signature="static from_operator(obj, atol=None, rtol=None)">
  ...
  <Function id="qiskit.quantum_info.SparsePauliOp.from_sparse_list" signature="static from_sparse_list(obj, num_qubits, do_checks=True, dtype=<class 'complex'>)">
...
$$
  ...
  <Function id="qiskit.quantum_info.SparsePauliOp.sum" signature="static sum(ops)">
