---
title: SparsePauliOp (v0.46)
description: API reference for qiskit.quantum_info.SparsePauliOp in qiskit v0.46
...
<Class id="qiskit.quantum_info.SparsePauliOp" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/quantum_info/operators/symplectic/sparse_pauli_op.py" signature="qiskit.quantum_info.SparsePauliOp(data, coeffs=None, *, ignore_pauli_phase=False, copy=True)" modifiers="class">
  Bases: `LinearOp`
  ...
  **Raises**
  ...
  <Function id="qiskit.quantum_info.SparsePauliOp.apply_layout" signature="apply_layout(layout, num_qubits=None)">
    Apply a transpiler layout to this [`SparsePauliOp`](#qiskit.quantum_info.SparsePauliOp "qiskit.quantum_info.SparsePauliOp")

    **Parameters**

    *   **layout** ([*TranspileLayout*](qiskit.transpiler.TranspileLayout "qiskit.transpiler.TranspileLayout") *| List\[*[*int*](https://docs.python.org/3/library/functions.html#int)*]*) – Either a [`TranspileLayout`](qiskit.transpiler.TranspileLayout "qiskit.transpiler.TranspileLayout") or a list of integers.
    *   **num\_qubits** ([*int*](https://docs.python.org/3/library/functions.html#int) *| None*) – The number of qubits to expand the operator to. If not provided then if `layout` is a [`TranspileLayout`](qiskit.transpiler.TranspileLayout "qiskit.transpiler.TranspileLayout") the number of the transpiler output circuit qubits will be used by default. If `layout` is a list of integers the permutation specified will be applied without any expansion.
  ...
  <Function id="qiskit.quantum_info.SparsePauliOp.argsort" signature="argsort(weight=False)">
  ...
  <Function id="qiskit.quantum_info.SparsePauliOp.assign_parameters" signature="assign_parameters(parameters, inplace=False)">
  ...
  <Function id="qiskit.quantum_info.SparsePauliOp.chop" signature="chop(tol=1e-14)">
  ...
  <Function id="qiskit.quantum_info.SparsePauliOp.equiv" signature="equiv(other, atol=None)">
  ...
  <Function id="qiskit.quantum_info.SparsePauliOp.from_list" signature="from_list(obj, dtype=<class 'complex'>, *, num_qubits=None)" modifiers="static">
...
$$
  ...
  <Function id="qiskit.quantum_info.SparsePauliOp.from_sparse_list" signature="from_sparse_list(obj, num_qubits, do_checks=True, dtype=<class 'complex'>)" modifiers="static">
...
$$
  ...
  <Function id="qiskit.quantum_info.SparsePauliOp.group_commuting" signature="group_commuting(qubit_wise=False)">
  ...
  <Function id="qiskit.quantum_info.SparsePauliOp.reshape" signature="reshape(input_dims=None, output_dims=None, num_qubits=None)">
  ...
  <Function id="qiskit.quantum_info.SparsePauliOp.sort" signature="sort(weight=False)">
  ...
  <Function id="qiskit.quantum_info.SparsePauliOp.sum" signature="sum(ops)" modifiers="static">
  ...
  <Function id="qiskit.quantum_info.SparsePauliOp.to_matrix" signature="to_matrix(sparse=False)">
    ...
    **sparse** ([*bool*](https://docs.python.org/3/library/functions.html#bool)) – if True return a sparse CSR matrix, otherwise return dense Numpy array (Default: False).
