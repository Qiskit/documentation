...
<Class id="qiskit.providers.fake_provider.FakeLagosV2" github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/providers/fake_provider/backends/lagos/fake_lagos.py" signature="qiskit.providers.fake_provider.FakeLagosV2">
