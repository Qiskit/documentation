---
title: LinearAmplitudeFunction (v0.46)
description: API reference for qiskit.circuit.library.LinearAmplitudeFunction in qiskit v0.46
...
$$
  ...
  *   **name** ([*str*](https://docs.python.org/3/library/stdtypes.html#str)) – Name of the circuit.
  ...
  <Attribute id="qiskit.circuit.library.LinearAmplitudeFunction.instances" attributeValue="163" />
