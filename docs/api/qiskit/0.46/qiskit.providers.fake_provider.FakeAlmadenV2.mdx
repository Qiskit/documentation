...
<Class id="qiskit.providers.fake_provider.FakeAlmadenV2" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/providers/fake_provider/backends/almaden/fake_almaden.py" signature="qiskit.providers.fake_provider.FakeAlmadenV2">
