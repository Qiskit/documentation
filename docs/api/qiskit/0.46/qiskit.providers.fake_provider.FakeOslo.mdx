...
<Class id="qiskit.providers.fake_provider.FakeOslo" github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/providers/fake_provider/backends/oslo/fake_oslo.py" signature="qiskit.providers.fake_provider.FakeOslo">
