---
title: QuantumVolume (v0.46)
description: API reference for qiskit.circuit.library.QuantumVolume in qiskit v0.46
...
<Class id="qiskit.circuit.library.QuantumVolume" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/circuit/library/quantum_volume.py" signature="qiskit.circuit.library.QuantumVolume(num_qubits, depth=None, seed=None, classical_permutation=True)" modifiers="class">
  ...
  **Reference Circuit:**
  ...
  ![../\_images/qiskit-circuit-library-QuantumVolume-1.png](/docs/images/api/qiskit/0.46/qiskit-circuit-library-QuantumVolume-1.avif)

  **Expanded Circuit:**

  ![../\_images/qiskit-circuit-library-QuantumVolume-2.png](/docs/images/api/qiskit/0.46/qiskit-circuit-library-QuantumVolume-2.avif)
  ...
  *   **classical\_permutation** ([*bool*](https://docs.python.org/3/library/functions.html#bool)) – use classical permutations at every layer, rather than quantum.
  ...
  <Attribute id="qiskit.circuit.library.QuantumVolume.instances" attributeValue="325" />
