...
<Class id="qiskit.providers.fake_provider.FakeHanoiV2" github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/providers/fake_provider/backends/hanoi/fake_hanoi.py" signature="qiskit.providers.fake_provider.FakeHanoiV2">
