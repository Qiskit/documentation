...
<Class id="qiskit.providers.fake_provider.FakeSingaporeV2" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/providers/fake_provider/backends/singapore/fake_singapore.py" signature="qiskit.providers.fake_provider.FakeSingaporeV2">
