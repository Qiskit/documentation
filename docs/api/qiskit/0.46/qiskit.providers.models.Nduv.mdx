...
<Class id="qiskit.providers.models.Nduv" github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/providers/models/backendproperties.py" signature="qiskit.providers.models.Nduv(date, name, unit, value)">
