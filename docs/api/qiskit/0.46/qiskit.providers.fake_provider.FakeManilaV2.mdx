...
<Class id="qiskit.providers.fake_provider.FakeManilaV2" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/providers/fake_provider/backends/manila/fake_manila.py" signature="qiskit.providers.fake_provider.FakeManilaV2">
