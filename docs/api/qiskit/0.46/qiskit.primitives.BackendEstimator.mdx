---
title: BackendEstimator (v0.46)
description: API reference for qiskit.primitives.BackendEstimator in qiskit v0.46
...
<Class id="qiskit.primitives.BackendEstimator" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/primitives/backend_estimator.py" signature="qiskit.primitives.BackendEstimator(backend, options=None, abelian_grouping=True, bound_pass_manager=None, skip_transpilation=False)" modifiers="class">
  ...
  *   **abelian\_grouping** ([*bool*](https://docs.python.org/3/library/functions.html#bool)) – Whether the observable should be grouped into commuting
  ...
  *   **skip\_transpilation** ([*bool*](https://docs.python.org/3/library/functions.html#bool)) – If this is set to True the internal compilation of the input circuits is skipped and the circuit objects will be directly executed when this object is called.
