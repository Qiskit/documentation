---
title: GR (v0.46)
description: API reference for qiskit.circuit.library.GR in qiskit v0.46
...
<Class id="qiskit.circuit.library.GR" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/circuit/library/generalized_gates/gr.py" signature="qiskit.circuit.library.GR(num_qubits, theta, phi)" modifiers="class">
...
$$
  ...
  **Expanded Circuit:**
  ...
  ![../\_images/qiskit-circuit-library-GR-1.png](/docs/images/api/qiskit/0.46/qiskit-circuit-library-GR-1.avif)
  ...
  *   **phi** ([*float*](https://docs.python.org/3/library/functions.html#float)) – angle of rotation axis in xy-plane
  ...
  <Attribute id="qiskit.circuit.library.GR.instances" attributeValue="179" />
