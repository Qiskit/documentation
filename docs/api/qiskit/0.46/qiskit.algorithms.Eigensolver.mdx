...
<Class id="qiskit.algorithms.Eigensolver" github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/algorithms/eigen_solvers/eigen_solver.py" signature="qiskit.algorithms.Eigensolver">
