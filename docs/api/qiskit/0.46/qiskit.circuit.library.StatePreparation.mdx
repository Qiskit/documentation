---
title: StatePreparation (v0.46)
description: API reference for qiskit.circuit.library.StatePreparation in qiskit v0.46
...
<Class id="qiskit.circuit.library.StatePreparation" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/circuit/library/data_preparation/state_preparation.py" signature="qiskit.circuit.library.StatePreparation(params, num_qubits=None, inverse=False, label=None, normalize=False)" modifiers="class">
