---
title: Pauli (v0.46)
description: API reference for qiskit.quantum_info.Pauli in qiskit v0.46
...
<Class id="qiskit.quantum_info.Pauli" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/quantum_info/operators/symplectic/pauli.py" signature="qiskit.quantum_info.Pauli(data=None)" modifiers="class">
  Bases: `BasePauli`
...
$$
  ...
  **Raises**
  ...
  <Function id="qiskit.quantum_info.Pauli.evolve" signature="evolve(other, qargs=None, frame='h')">
