---
title: PauliEvolutionGate (v0.46)
description: API reference for qiskit.circuit.library.PauliEvolutionGate in qiskit v0.46
...
<Class id="qiskit.circuit.library.PauliEvolutionGate" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/circuit/library/pauli_evolution.py" signature="qiskit.circuit.library.PauliEvolutionGate(operator, time=1.0, label=None, synthesis=None)" modifiers="class">
