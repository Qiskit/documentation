---
title: EvolutionFactory (v0.46)
description: API reference for qiskit.opflow.evolutions.EvolutionFactory in qiskit v0.46
...
<Class id="qiskit.opflow.evolutions.EvolutionFactory" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/opflow/evolutions/evolution_factory.py" signature="qiskit.opflow.evolutions.EvolutionFactory" modifiers="class">
  ...
  <Function id="qiskit.opflow.evolutions.EvolutionFactory.build" signature="build(operator=None)" modifiers="static">
    ...
    **Raises**
    ...
    [**ValueError**](https://docs.python.org/3/library/exceptions.html#ValueError) – If operator is not of a composition for which we know the best Evolution method.
  </Function>
</Class>
