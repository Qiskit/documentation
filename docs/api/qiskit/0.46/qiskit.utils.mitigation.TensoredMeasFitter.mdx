...
<Class id="qiskit.utils.mitigation.TensoredMeasFitter" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/utils/mitigation/fitters.py" signature="qiskit.utils.mitigation.TensoredMeasFitter(results, mit_pattern, substate_labels_list=None, circlabel='')" modifiers="class">
  ...
  **Raises**
  ...
  <Function id="qiskit.utils.mitigation.TensoredMeasFitter.add_data" signature="add_data(new_results, rebuild_cal_matrix=True)">
    ...
    *   **new\_results** ([*list*](https://docs.python.org/3/library/stdtypes.html#list)  *or*[*qiskit.result.Result*](qiskit.result.Result "qiskit.result.Result")) – a single result or list of Result objects.
