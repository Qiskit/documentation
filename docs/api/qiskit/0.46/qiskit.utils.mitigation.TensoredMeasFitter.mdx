...
<Class id="qiskit.utils.mitigation.TensoredMeasFitter" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/utils/mitigation/fitters.py" signature="qiskit.utils.mitigation.TensoredMeasFitter(results, mit_pattern, substate_labels_list=None, circlabel='')">
  ...
  **Raises**
  ...
  <Function id="qiskit.utils.mitigation.TensoredMeasFitter.add_data" name="add_data" signature="add_data(new_results, rebuild_cal_matrix=True)">
  ...
  <Function id="qiskit.utils.mitigation.TensoredMeasFitter.readout_fidelity" name="readout_fidelity" signature="readout_fidelity(cal_index=0, label_list=None)">
  ...
  <Function id="qiskit.utils.mitigation.TensoredMeasFitter.subset_fitter" name="subset_fitter" signature="subset_fitter(qubit_sublist)">
