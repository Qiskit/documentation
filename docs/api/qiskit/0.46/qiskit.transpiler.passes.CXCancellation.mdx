---
title: CXCancellation (v0.46)
description: API reference for qiskit.transpiler.passes.CXCancellation in qiskit v0.46
...
<Class id="qiskit.transpiler.passes.CXCancellation" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/transpiler/passes/optimization/cx_cancellation.py" signature="qiskit.transpiler.passes.CXCancellation(*args, **kwargs)" modifiers="class">
