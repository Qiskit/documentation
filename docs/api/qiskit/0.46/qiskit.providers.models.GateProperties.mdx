...
<Class id="qiskit.providers.models.GateProperties" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/providers/models/backendproperties.py" signature="qiskit.providers.models.GateProperties(qubits, gate, parameters, **kwargs)">
