---
title: plot_state_qsphere (v0.46)
description: API reference for qiskit.visualization.plot_state_qsphere in qiskit v0.46
...
<Function id="qiskit.visualization.plot_state_qsphere" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/visualization/state_visualization.py" signature="qiskit.visualization.plot_state_qsphere(state, figsize=None, ax=None, show_state_labels=True, show_state_phases=False, use_degrees=False, *, filename=None)">
  ...
  **Examples**
  ...
  ![../\_images/qiskit-visualization-plot\_state\_qsphere-1.png](/docs/images/api/qiskit/0.46/qiskit-visualization-plot_state_qsphere-1.avif)
  ...
  ![../\_images/qiskit-visualization-plot\_state\_qsphere-2.png](/docs/images/api/qiskit/0.46/qiskit-visualization-plot_state_qsphere-2.avif)
</Function>
