...
<Class id="qiskit.providers.basic_provider.BasicProvider" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/providers/basic_provider/basic_provider.py" signature="qiskit.providers.basic_provider.BasicProvider">
