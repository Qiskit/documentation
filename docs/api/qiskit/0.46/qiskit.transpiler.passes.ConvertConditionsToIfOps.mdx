---
title: ConvertConditionsToIfOps (v0.46)
description: API reference for qiskit.transpiler.passes.ConvertConditionsToIfOps in qiskit v0.46
...
<Class id="qiskit.transpiler.passes.ConvertConditionsToIfOps" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/transpiler/passes/utils/convert_conditions_to_if_ops.py" signature="qiskit.transpiler.passes.ConvertConditionsToIfOps(*args, **kwargs)" modifiers="class">
