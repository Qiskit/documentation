---
title: DAGFixedPoint (v0.46)
description: API reference for qiskit.transpiler.passes.DAGFixedPoint in qiskit v0.46
...
<Class id="qiskit.transpiler.passes.DAGFixedPoint" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/transpiler/passes/utils/dag_fixed_point.py" signature="qiskit.transpiler.passes.DAGFixedPoint(*args, **kwargs)" modifiers="class">
  ...
  <Function id="qiskit.transpiler.passes.DAGFixedPoint.execute" signature="execute(passmanager_ir, state, callback=None)">
  ...
  <Function id="qiskit.transpiler.passes.DAGFixedPoint.update_status" signature="update_status(state, run_state)">
