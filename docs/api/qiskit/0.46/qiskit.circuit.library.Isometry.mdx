---
title: Isometry (v0.46)
description: API reference for qiskit.circuit.library.Isometry in qiskit v0.46
...
<Class id="qiskit.circuit.library.Isometry" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/circuit/library/generalized_gates/isometry.py" signature="qiskit.circuit.library.Isometry(isometry, num_ancillas_zero, num_ancillas_dirty, epsilon=1e-10)" modifiers="class">
