---
title: ClassicalRegister (v0.46)
description: API reference for qiskit.circuit.ClassicalRegister in qiskit v0.46
...
<Class id="qiskit.circuit.ClassicalRegister" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/circuit/classicalregister.py" signature="qiskit.circuit.ClassicalRegister(size=None, name=None, bits=None)" modifiers="class">
  ...
  *   [**CircuitError**](circuit#qiskit.circuit.CircuitError "qiskit.circuit.CircuitError") – if `bits` contained bits of an incorrect type.
  ...
  <Attribute id="qiskit.circuit.ClassicalRegister.name_format" attributeValue="re.compile('[a-z][a-zA-Z0-9_]*')" />
  ...
  <Function id="qiskit.circuit.ClassicalRegister.index" signature="index(bit)">
