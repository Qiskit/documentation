...
<Class id="qiskit.primitives.BackendSampler" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/primitives/backend_sampler.py" signature="qiskit.primitives.BackendSampler(backend, options=None, bound_pass_manager=None, skip_transpilation=False)">
