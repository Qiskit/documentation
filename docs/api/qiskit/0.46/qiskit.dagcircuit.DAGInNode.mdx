...
<Class id="qiskit.dagcircuit.DAGInNode" github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/dagcircuit/dagnode.py" signature="qiskit.dagcircuit.DAGInNode(wire)">
