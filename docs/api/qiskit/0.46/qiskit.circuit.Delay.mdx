...
<Class id="qiskit.circuit.Delay" github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/circuit/delay.py" signature="qiskit.circuit.Delay(duration, unit='dt')">
