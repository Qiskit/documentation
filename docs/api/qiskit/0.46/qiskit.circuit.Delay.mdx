---
title: Delay (v0.46)
description: API reference for qiskit.circuit.Delay in qiskit v0.46
...
<Class id="qiskit.circuit.Delay" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/circuit/delay.py" signature="qiskit.circuit.Delay(duration, unit='dt')" modifiers="class">
