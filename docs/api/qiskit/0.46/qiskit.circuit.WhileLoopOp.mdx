...
<Class id="qiskit.circuit.WhileLoopOp" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/circuit/controlflow/while_loop.py" signature="qiskit.circuit.WhileLoopOp(condition, body, label=None)">
  ...
  *   [**TypeError**](https://docs.python.org/3/library/exceptions.html#TypeError "(in Python v3.12)") – when the optional label is provided, but it is not a string.
  ...
  <Attribute id="qiskit.circuit.WhileLoopOp.base_class" name="base_class">
  ...
  <Attribute id="qiskit.circuit.WhileLoopOp.condition" name="condition">
  ...
  <Attribute id="qiskit.circuit.WhileLoopOp.mutable" name="mutable">
  ...
  <Function id="qiskit.circuit.WhileLoopOp.inverse" name="inverse" signature="inverse()">
  ...
  <Function id="qiskit.circuit.WhileLoopOp.qasm" name="qasm" signature="qasm()">
