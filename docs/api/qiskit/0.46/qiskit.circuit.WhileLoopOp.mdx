---
title: WhileLoopOp (v0.46)
description: API reference for qiskit.circuit.WhileLoopOp in qiskit v0.46
...
<Class id="qiskit.circuit.WhileLoopOp" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/circuit/controlflow/while_loop.py" signature="qiskit.circuit.WhileLoopOp(condition, body, label=None)" modifiers="class">
  ...
  *   [**TypeError**](https://docs.python.org/3/library/exceptions.html#TypeError) – when the optional label is provided, but it is not a string.
  ...
  <Function id="qiskit.circuit.WhileLoopOp.to_mutable" signature="to_mutable()">
