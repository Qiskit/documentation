---
title: Diagonal (v0.46)
description: API reference for qiskit.circuit.library.Diagonal in qiskit v0.46
...
<Class id="qiskit.circuit.library.Diagonal" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/circuit/library/generalized_gates/diagonal.py" signature="qiskit.circuit.library.Diagonal(diag)" modifiers="class">
