...
<Class id="qiskit.circuit.library.UnitaryOverlap" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/circuit/library/overlap.py" signature="qiskit.circuit.library.UnitaryOverlap(unitary1, unitary2, prefix1='p1', prefix2='p2')">
  ...
  *   [**CircuitError**](circuit#qiskit.circuit.CircuitError "qiskit.circuit.CircuitError") – Inputs contain measurements and/or resets.
  ...
  <Attribute id="qiskit.circuit.library.UnitaryOverlap.extension_lib" name="extension_lib" attributeValue="'include &#x22;qelib1.inc&#x22;;'" />
  ...
  <Attribute id="qiskit.circuit.library.UnitaryOverlap.header" name="header" attributeValue="'OPENQASM 2.0;'" />

  ### instances

  <Attribute id="qiskit.circuit.library.UnitaryOverlap.instances" name="instances" attributeValue="159" />
