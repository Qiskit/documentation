...
<Class id="qiskit.circuit.library.UnitaryOverlap" github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/circuit/library/overlap.py" signature="qiskit.circuit.library.UnitaryOverlap(unitary1, unitary2, prefix1='p1', prefix2='p2')">
