---
title: UnitaryOverlap (v0.46)
description: API reference for qiskit.circuit.library.UnitaryOverlap in qiskit v0.46
...
<Class id="qiskit.circuit.library.UnitaryOverlap" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/circuit/library/overlap.py" signature="qiskit.circuit.library.UnitaryOverlap(unitary1, unitary2, prefix1='p1', prefix2='p2')" modifiers="class">
