...
<Class id="qiskit.providers.basic_provider.BasicProviderError" github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/providers/basic_provider/exceptions.py" signature="qiskit.providers.basic_provider.BasicProviderError(*message)">
