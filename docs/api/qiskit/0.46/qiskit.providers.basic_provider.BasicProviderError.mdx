...
<Class id="qiskit.providers.basic_provider.BasicProviderError" name="BasicProviderError" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/providers/basic_provider/exceptions.py" signature="qiskit.providers.basic_provider.BasicProviderError(*message)">
