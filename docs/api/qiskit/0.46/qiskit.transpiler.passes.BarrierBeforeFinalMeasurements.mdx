---
title: BarrierBeforeFinalMeasurements (v0.46)
description: API reference for qiskit.transpiler.passes.BarrierBeforeFinalMeasurements in qiskit v0.46
