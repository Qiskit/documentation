...
<Class id="qiskit.providers.fake_provider.FakeBackend5QV2" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/providers/fake_provider/fake_backend_v2.py" signature="qiskit.providers.fake_provider.FakeBackend5QV2(bidirectional=True)">
