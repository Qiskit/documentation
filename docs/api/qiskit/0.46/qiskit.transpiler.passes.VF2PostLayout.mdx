---
title: VF2PostLayout (v0.46)
description: API reference for qiskit.transpiler.passes.VF2PostLayout in qiskit v0.46
...
<Class id="qiskit.transpiler.passes.VF2PostLayout" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/transpiler/passes/layout/vf2_post_layout.py" signature="qiskit.transpiler.passes.VF2PostLayout(*args, **kwargs)" modifiers="class">
