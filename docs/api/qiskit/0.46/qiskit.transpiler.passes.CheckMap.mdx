...
<Class id="qiskit.transpiler.passes.CheckMap" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/transpiler/passes/utils/check_map.py" signature="qiskit.transpiler.passes.CheckMap(*args, **kwargs)">
