...
<Class id="qiskit.primitives.BaseEstimator" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/primitives/base/base_estimator.py" signature="qiskit.primitives.BaseEstimator(*, options=None)">
  ...
  **options** ([*dict*](https://docs.python.org/3/library/stdtypes.html#dict "(in Python v3.12)") *| None*) – Default options.
  ...
  <Function id="qiskit.primitives.BaseEstimator.run" name="run" signature="run(circuits, observables, parameter_values=None, **run_options)">
  ...
  <Function id="qiskit.primitives.BaseEstimator.set_options" name="set_options" signature="set_options(**fields)">
