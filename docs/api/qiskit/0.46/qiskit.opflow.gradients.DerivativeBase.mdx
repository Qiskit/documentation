...
<Class id="qiskit.opflow.gradients.DerivativeBase" github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/opflow/gradients/derivative_base.py" signature="qiskit.opflow.gradients.DerivativeBase">
