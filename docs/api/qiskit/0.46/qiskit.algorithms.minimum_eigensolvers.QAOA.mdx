---
title: QAOA (v0.46)
description: API reference for qiskit.algorithms.minimum_eigensolvers.QAOA in qiskit v0.46
...
<Class id="qiskit.algorithms.minimum_eigensolvers.QAOA" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/algorithms/minimum_eigensolvers/qaoa.py" signature="qiskit.algorithms.minimum_eigensolvers.QAOA(sampler, optimizer, *, reps=1, initial_state=None, mixer=None, initial_point=None, aggregation=None, callback=None)" modifiers="class">
  ...
  <Attribute id="qiskit.algorithms.minimum_eigensolvers.QAOA.aggregation">
    ...
    **Type**
    ...
    [float](https://docs.python.org/3/library/functions.html#float) | Callable\[\[[list](https://docs.python.org/3/library/stdtypes.html#list)\[[float](https://docs.python.org/3/library/functions.html#float)]], [float](https://docs.python.org/3/library/functions.html#float)] | None
  </Attribute>
  ...
  *   **reps** ([*int*](https://docs.python.org/3/library/functions.html#int)) – The integer parameter $p$. Has a minimum valid value of 1.
  ...
  *   **aggregation** ([*float*](https://docs.python.org/3/library/functions.html#float) *| Callable\[\[*[*list*](https://docs.python.org/3/library/stdtypes.html#list)*\[*[*float*](https://docs.python.org/3/library/functions.html#float)*]],* [*float*](https://docs.python.org/3/library/functions.html#float)*] | None*) – A float or callable to specify how the objective function evaluated on the basis states should be aggregated. If a float, this specifies the $\alpha \in [0,1]$ parameter for a CVaR expectation value.
  *   **callback** (*Callable\[\[*[*int*](https://docs.python.org/3/library/functions.html#int)*, np.ndarray,* [*float*](https://docs.python.org/3/library/functions.html#float)*,* [*dict*](https://docs.python.org/3/library/stdtypes.html#dict)*\[*[*str*](https://docs.python.org/3/library/stdtypes.html#str)*, Any]], None] | None*) – A callback that can access the intermediate data at each optimization step. These data are: the evaluation count, the optimizer parameters for the ansatz, the evaluated value, the metadata dictionary.
  ...
  <Function id="qiskit.algorithms.minimum_eigensolvers.QAOA.compute_minimum_eigenvalue" signature="compute_minimum_eigenvalue(operator, aux_operators=None)">
  ...
  <Function id="qiskit.algorithms.minimum_eigensolvers.QAOA.supports_aux_operators" signature="supports_aux_operators()" modifiers="classmethod">
