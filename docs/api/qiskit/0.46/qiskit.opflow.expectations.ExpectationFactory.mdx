...
<Class id="qiskit.opflow.expectations.ExpectationFactory" github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/opflow/expectations/expectation_factory.py" signature="qiskit.opflow.expectations.ExpectationFactory">
