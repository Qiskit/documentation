---
title: QubitProperties (v0.46)
description: API reference for qiskit.providers.QubitProperties in qiskit v0.46
...
<Class id="qiskit.providers.QubitProperties" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/providers/backend.py" signature="qiskit.providers.QubitProperties(t1=None, t2=None, frequency=None)" modifiers="class">
