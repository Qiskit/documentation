...
<Class id="qiskit.providers.QubitProperties" github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/providers/backend.py" signature="qiskit.providers.QubitProperties(t1=None, t2=None, frequency=None)">
