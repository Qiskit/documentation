...
<Class id="qiskit.pulse.instructions.SetPhase" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/pulse/instructions/phase.py" signature="qiskit.pulse.instructions.SetPhase(phase, channel, name=None)">
