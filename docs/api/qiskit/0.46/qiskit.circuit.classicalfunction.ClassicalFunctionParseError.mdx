...
<Class id="qiskit.circuit.classicalfunction.ClassicalFunctionParseError" github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/circuit/classicalfunction/exceptions.py" signature="qiskit.circuit.classicalfunction.ClassicalFunctionParseError(*message)">
