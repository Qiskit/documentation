...
<Class id="qiskit.providers.fake_provider.FakeQuitoV2" github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/providers/fake_provider/backends/quito/fake_quito.py" signature="qiskit.providers.fake_provider.FakeQuitoV2">
