...
<Class id="qiskit.circuit.library.IQP" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/circuit/library/iqp.py" signature="qiskit.circuit.library.IQP(interactions)" modifiers="class">
  ...
  **Reference Circuit:**
  ...
  ![../\_images/qiskit-circuit-library-IQP-1.png](/images/api/qiskit/0.46/qiskit-circuit-library-IQP-1.avif)

  **Expanded Circuit:**

  > ![../\_images/qiskit-circuit-library-IQP-2.png](/images/api/qiskit/0.46/qiskit-circuit-library-IQP-2.avif)
