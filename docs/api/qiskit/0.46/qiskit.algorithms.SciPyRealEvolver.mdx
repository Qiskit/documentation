---
title: SciPyRealEvolver (v0.46)
description: API reference for qiskit.algorithms.SciPyRealEvolver in qiskit v0.46
...
<Class id="qiskit.algorithms.SciPyRealEvolver" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/algorithms/time_evolvers/classical_methods/scipy_real_evolver.py" signature="qiskit.algorithms.SciPyRealEvolver(num_timesteps)" modifiers="class">
  ...
  **Raises**
  ...
  [**ValueError**](https://docs.python.org/3/library/exceptions.html#ValueError) – If steps is not a positive integer.
