---
title: SPSASamplerGradient (v0.46)
description: API reference for qiskit.algorithms.gradients.SPSASamplerGradient in qiskit v0.46
...
<Class id="qiskit.algorithms.gradients.SPSASamplerGradient" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/algorithms/gradients/spsa/spsa_sampler_gradient.py" signature="qiskit.algorithms.gradients.SPSASamplerGradient(sampler, epsilon, batch_size=1, seed=None, options=None)" modifiers="class">
  ...
  *   **epsilon** ([*float*](https://docs.python.org/3/library/functions.html#float)) – The offset size for the SPSA gradients.
  *   **batch\_size** ([*int*](https://docs.python.org/3/library/functions.html#int)) – number of gradients to average.
  *   **seed** ([*int*](https://docs.python.org/3/library/functions.html#int) *| None*) – The seed for a random perturbation vector.
