---
title: UCGate (v0.46)
description: API reference for qiskit.circuit.library.UCGate in qiskit v0.46
...
<Class id="qiskit.circuit.library.UCGate" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/circuit/library/generalized_gates/uc.py" signature="qiskit.circuit.library.UCGate(gate_list, up_to_diagonal=False)" modifiers="class">
