---
title: OptimizeCliffords (v0.46)
description: API reference for qiskit.transpiler.passes.OptimizeCliffords in qiskit v0.46
...
<Class id="qiskit.transpiler.passes.OptimizeCliffords" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/transpiler/passes/optimization/optimize_cliffords.py" signature="qiskit.transpiler.passes.OptimizeCliffords(*args, **kwargs)" modifiers="class">
  ...
  <Function id="qiskit.transpiler.passes.OptimizeCliffords.execute" signature="execute(passmanager_ir, state, callback=None)">
  ...
  <Function id="qiskit.transpiler.passes.OptimizeCliffords.name" signature="name()">
    Name of the pass.
  ...
  <Function id="qiskit.transpiler.passes.OptimizeCliffords.run" signature="run(dag)">
  ...
  <Function id="qiskit.transpiler.passes.OptimizeCliffords.update_status" signature="update_status(state, run_state)">
