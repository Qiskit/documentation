---
title: OperatorBase (v0.46)
description: API reference for qiskit.opflow.OperatorBase in qiskit v0.46
...
<Class id="qiskit.opflow.OperatorBase" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/opflow/operator_base.py" signature="qiskit.opflow.OperatorBase" modifiers="class">
  Bases: `StarAlgebraMixin`, `TensorMixin`, [`ABC`](https://docs.python.org/3/library/abc.html#abc.ABC)
  ...
  <Function id="qiskit.opflow.OperatorBase.assign_parameters" signature="assign_parameters(param_dict)" modifiers="abstract">
    ...
    **param\_dict** ([*Dict*](https://docs.python.org/3/library/typing.html#typing.Dict)*\[*[*ParameterExpression*](qiskit.circuit.ParameterExpression "qiskit.circuit.parameterexpression.ParameterExpression")*,* [*complex*](https://docs.python.org/3/library/functions.html#complex)  *|*[*ParameterExpression*](qiskit.circuit.ParameterExpression "qiskit.circuit.parameterexpression.ParameterExpression")  *|*[*List*](https://docs.python.org/3/library/typing.html#typing.List)*\[*[*complex*](https://docs.python.org/3/library/functions.html#complex)  *|*[*ParameterExpression*](qiskit.circuit.ParameterExpression "qiskit.circuit.parameterexpression.ParameterExpression")*]]*) – The dictionary of `Parameters` to replace, and values or lists of values by which to replace them.
