---
title: CircuitInstruction (v0.46)
description: API reference for qiskit.circuit.CircuitInstruction in qiskit v0.46
...
<Class id="qiskit.circuit.CircuitInstruction" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/circuit/quantumcircuitdata.py" signature="qiskit.circuit.CircuitInstruction(operation, qubits=(), clbits=())" modifiers="class">
