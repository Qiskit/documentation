...
<Class id="qiskit.transpiler.passes.LinearFunctionsSynthesis" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/transpiler/passes/synthesis/linear_functions_synthesis.py" signature="qiskit.transpiler.passes.LinearFunctionsSynthesis(*args, **kwargs)">
