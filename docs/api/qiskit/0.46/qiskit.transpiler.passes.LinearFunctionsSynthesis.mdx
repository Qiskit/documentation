---
title: LinearFunctionsSynthesis (v0.46)
description: API reference for qiskit.transpiler.passes.LinearFunctionsSynthesis in qiskit v0.46
...
<Class id="qiskit.transpiler.passes.LinearFunctionsSynthesis" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/transpiler/passes/synthesis/linear_functions_synthesis.py" signature="qiskit.transpiler.passes.LinearFunctionsSynthesis(*args, **kwargs)" modifiers="class">
