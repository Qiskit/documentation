...
<Class id="qiskit.circuit.library.U1Gate" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/circuit/library/standard_gates/u1.py" signature="qiskit.circuit.library.U1Gate(theta, label=None, *, duration=None, unit='dt')">
