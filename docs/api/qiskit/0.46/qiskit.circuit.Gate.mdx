...
<Class id="qiskit.circuit.Gate" github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/circuit/gate.py" signature="qiskit.circuit.Gate(name, num_qubits, params, label=None, duration=None, unit='dt')">
