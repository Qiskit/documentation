---
title: Size (v0.46)
description: API reference for qiskit.transpiler.passes.Size in qiskit v0.46
...
<Class id="qiskit.transpiler.passes.Size" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/transpiler/passes/analysis/size.py" signature="qiskit.transpiler.passes.Size(*args, **kwargs)" modifiers="class">
  ...
  **recurse** – whether to allow recursion into control flow. If this is `False` (default), the pass will throw an error when control flow is present, to avoid returning a number with little meaning.
  ...
  <Function id="qiskit.transpiler.passes.Size.execute" signature="execute(passmanager_ir, state, callback=None)">
  ...
  <Function id="qiskit.transpiler.passes.Size.update_status" signature="update_status(state, run_state)">
