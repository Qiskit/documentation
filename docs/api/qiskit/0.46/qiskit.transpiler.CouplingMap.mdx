...
<Class id="qiskit.transpiler.CouplingMap" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/transpiler/coupling.py" signature="qiskit.transpiler.CouplingMap(couplinglist=None, description=None)">
  ...
  *   **description** ([*str*](https://docs.python.org/3/library/stdtypes.html#str "(in Python v3.12)")) – A string to describe the coupling map.
  ...
  <Function id="qiskit.transpiler.CouplingMap.compute_distance_matrix" signature="compute_distance_matrix()">
  ...
  <Function id="qiskit.transpiler.CouplingMap.connected_components" signature="connected_components()">
  ...
  <Function id="qiskit.transpiler.CouplingMap.from_full" signature="classmethod from_full(num_qubits, bidirectional=True)">
  ...
  <Function id="qiskit.transpiler.CouplingMap.from_grid" signature="classmethod from_grid(num_rows, num_columns, bidirectional=True)">
  ...
  <Function id="qiskit.transpiler.CouplingMap.from_heavy_hex" signature="classmethod from_heavy_hex(distance, bidirectional=True)">
  ...
  <Function id="qiskit.transpiler.CouplingMap.from_heavy_square" signature="classmethod from_heavy_square(distance, bidirectional=True)">
  ...
  <Function id="qiskit.transpiler.CouplingMap.from_hexagonal_lattice" signature="classmethod from_hexagonal_lattice(rows, cols, bidirectional=True)">
  ...
  <Function id="qiskit.transpiler.CouplingMap.from_line" signature="classmethod from_line(num_qubits, bidirectional=True)">
  ...
  <Function id="qiskit.transpiler.CouplingMap.from_ring" signature="classmethod from_ring(num_qubits, bidirectional=True)">
  ...
  <Function id="qiskit.transpiler.CouplingMap.reduce" signature="reduce(mapping, check_if_connected=True)">
