---
title: UnrollCustomDefinitions (v0.46)
description: API reference for qiskit.transpiler.passes.UnrollCustomDefinitions in qiskit v0.46
...
<Class id="qiskit.transpiler.passes.UnrollCustomDefinitions" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/transpiler/passes/basis/unroll_custom_definitions.py" signature="qiskit.transpiler.passes.UnrollCustomDefinitions(*args, **kwargs)" modifiers="class">
