...
<Class id="qiskit.transpiler.passes.ALAPSchedule" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/transpiler/passes/scheduling/alap.py" signature="qiskit.transpiler.passes.ALAPSchedule(*args, **kwargs)">
  ...
  <Function id="qiskit.transpiler.passes.ALAPSchedule.execute" name="execute" signature="execute(passmanager_ir, state, callback=None)">
  ...
  <Function id="qiskit.transpiler.passes.ALAPSchedule.update_status" name="update_status" signature="update_status(state, run_state)">
