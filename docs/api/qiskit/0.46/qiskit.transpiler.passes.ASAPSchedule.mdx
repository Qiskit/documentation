---
title: ASAPSchedule (v0.46)
description: API reference for qiskit.transpiler.passes.ASAPSchedule in qiskit v0.46
...
<Class id="qiskit.transpiler.passes.ASAPSchedule" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/transpiler/passes/scheduling/asap.py" signature="qiskit.transpiler.passes.ASAPSchedule(*args, **kwargs)" modifiers="class">
