...
<Class id="qiskit.algorithms.TimeEvolutionProblem" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/algorithms/time_evolvers/time_evolution_problem.py" signature="qiskit.algorithms.TimeEvolutionProblem(hamiltonian, time, initial_state=None, aux_operators=None, truncation_threshold=1e-12, t_param=None, param_value_map=None)" modifiers="class">
  ...
  <Attribute id="qiskit.algorithms.TimeEvolutionProblem.param_value_map">
    ...
    **Type**
    ...
    [dict](https://docs.python.org/3/library/stdtypes.html#dict)\[[Parameter](qiskit.circuit.Parameter "qiskit.circuit.Parameter"), [complex](https://docs.python.org/3/library/functions.html#complex)] | None
  </Attribute>
  ...
  *   **param\_value\_map** (*Mapping\[*[*Parameter*](qiskit.circuit.Parameter "qiskit.circuit.Parameter")*,* [*complex*](https://docs.python.org/3/library/functions.html#complex)*] | None*) – Maps free parameters in the problem to values. Depending on the algorithm, it might refer to e.g. a Hamiltonian or an initial state.
