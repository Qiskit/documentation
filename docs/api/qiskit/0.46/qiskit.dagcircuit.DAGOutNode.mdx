...
<Class id="qiskit.dagcircuit.DAGOutNode" github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/dagcircuit/dagnode.py" signature="qiskit.dagcircuit.DAGOutNode(wire)">
