...
<Class id="qiskit.opflow.gradients.HessianBase" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/opflow/gradients/hessian_base.py" signature="qiskit.opflow.gradients.HessianBase(hess_method='param_shift', **kwargs)">
