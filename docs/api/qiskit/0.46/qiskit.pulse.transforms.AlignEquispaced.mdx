...
<Class id="qiskit.pulse.transforms.AlignEquispaced" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/pulse/transforms/alignments.py" signature="qiskit.pulse.transforms.AlignEquispaced(duration)">
