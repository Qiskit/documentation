---
title: DAGLongestPath (v0.46)
description: API reference for qiskit.transpiler.passes.DAGLongestPath in qiskit v0.46
...
<Class id="qiskit.transpiler.passes.DAGLongestPath" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/transpiler/passes/analysis/dag_longest_path.py" signature="qiskit.transpiler.passes.DAGLongestPath(*args, **kwargs)" modifiers="class">
  ...
  <Function id="qiskit.transpiler.passes.DAGLongestPath.execute" signature="execute(passmanager_ir, state, callback=None)">
  ...
  <Function id="qiskit.transpiler.passes.DAGLongestPath.update_status" signature="update_status(state, run_state)">
