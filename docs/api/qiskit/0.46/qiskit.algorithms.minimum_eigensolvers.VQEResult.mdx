---
title: VQEResult (v0.46)
description: API reference for qiskit.algorithms.minimum_eigensolvers.VQEResult in qiskit v0.46
...
<Class id="qiskit.algorithms.minimum_eigensolvers.VQEResult" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/algorithms/minimum_eigensolvers/vqe.py" signature="qiskit.algorithms.minimum_eigensolvers.VQEResult" modifiers="class">
