---
title: QDrift (v0.46)
description: API reference for qiskit.synthesis.QDrift in qiskit v0.46
...
<Class id="qiskit.synthesis.QDrift" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/synthesis/evolution/qdrift.py" signature="qiskit.synthesis.QDrift(reps=1, insert_barriers=False, cx_structure='chain', atomic_evolution=None, seed=None)" modifiers="class">
