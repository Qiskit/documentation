---
title: DefaultCNOTUnitObjective (v0.46)
description: API reference for qiskit.synthesis.unitary.aqc.DefaultCNOTUnitObjective in qiskit v0.46
...
<Class id="qiskit.synthesis.unitary.aqc.DefaultCNOTUnitObjective" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/synthesis/unitary/aqc/cnot_unit_objective.py" signature="qiskit.synthesis.unitary.aqc.DefaultCNOTUnitObjective(num_qubits, cnots)" modifiers="class">
  ...
  *   **cnots** (*np.ndarray*) – a CNOT structure to be used in the optimization procedure.
  ...
  <Function id="qiskit.synthesis.unitary.aqc.DefaultCNOTUnitObjective.gradient" signature="gradient(param_values)">
  ...
  <Function id="qiskit.synthesis.unitary.aqc.DefaultCNOTUnitObjective.objective" signature="objective(param_values)">
