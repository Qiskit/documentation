...
<Class id="qiskit.circuit.ControlFlowOp" github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/circuit/controlflow/control_flow.py" signature="qiskit.circuit.ControlFlowOp(name, num_qubits, num_clbits, params, duration=None, unit='dt', label=None)">
