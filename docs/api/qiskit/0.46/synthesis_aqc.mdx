---
title: aqc (v0.46)
description: API reference for qiskit.synthesis.unitary.aqc in qiskit v0.46
...
<Function id="qiskit.synthesis.unitary.aqc.make_cnot_network" github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/synthesis/unitary/aqc/cnot_structures.py" signature="qiskit.synthesis.unitary.aqc.make_cnot_network(num_qubits, network_layout='spin', connectivity_type='full', depth=0)">
