---
title: Layout (v0.46)
description: API reference for qiskit.transpiler.Layout in qiskit v0.46
...
<Class id="qiskit.transpiler.Layout" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/transpiler/layout.py" signature="qiskit.transpiler.Layout(input_dict=None)" modifiers="class">
  ...
  <Function id="qiskit.transpiler.Layout.reorder_bits" signature="reorder_bits(bits)">
    ...
    **bits** ([*list*](https://docs.python.org/3/library/stdtypes.html#list)*\[*[*Bit*](qiskit.circuit.Bit "qiskit.circuit.Bit")*]*) – the bits to reorder.
