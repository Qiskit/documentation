...
<Class id="qiskit.algorithms.IterativePhaseEstimation" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.46/qiskit/algorithms/phase_estimators/ipe.py" signature="qiskit.algorithms.IterativePhaseEstimation(num_iterations, quantum_instance=None, sampler=None)">
  ...
  *   [**AlgorithmError**](algorithms#qiskit.algorithms.AlgorithmError "qiskit.algorithms.AlgorithmError") – If neither sampler nor quantum instance is provided.
  ...
  <Function id="qiskit.algorithms.IterativePhaseEstimation.construct_circuit" name="construct_circuit" signature="construct_circuit(unitary, state_preparation, k, omega=0.0, measurement=False)">
  ...
  <Function id="qiskit.algorithms.IterativePhaseEstimation.estimate" name="estimate" signature="estimate(unitary, state_preparation)">
