...
<Class id="qiskit.circuit.AnnotatedOperation" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.3/qiskit/circuit/annotated_operation.py#L60-L242" signature="qiskit.circuit.AnnotatedOperation(base_op, modifiers)" modifiers="class">
  ...
  *   **modifiers** (*Union\[Modifier, List\[Modifier]]*) – ordered list of modifiers. Supported modifiers include `InverseModifier`, `ControlModifier` and `PowerModifier`.
  ...
  <Function id="qiskit.circuit.AnnotatedOperation.control" github="https://github.com/Qiskit/qiskit/tree/stable/1.3/qiskit/circuit/annotated_operation.py#L159-L186" signature="control(num_ctrl_qubits=1, label=None, ctrl_state=None, annotated=True)">
  ...
  <Function id="qiskit.circuit.AnnotatedOperation.copy" github="https://github.com/Qiskit/qiskit/tree/stable/1.3/qiskit/circuit/annotated_operation.py#L134-L136" signature="copy()">
  ...
  <Function id="qiskit.circuit.AnnotatedOperation.inverse" github="https://github.com/Qiskit/qiskit/tree/stable/1.3/qiskit/circuit/annotated_operation.py#L188-L203" signature="inverse(annotated=True)">
  ...
  <Function id="qiskit.circuit.AnnotatedOperation.power" github="https://github.com/Qiskit/qiskit/tree/stable/1.3/qiskit/circuit/annotated_operation.py#L205-L221" signature="power(exponent, annotated=False)">
  ...
  <Function id="qiskit.circuit.AnnotatedOperation.to_matrix" github="https://github.com/Qiskit/qiskit/tree/stable/1.3/qiskit/circuit/annotated_operation.py#L138-L157" signature="to_matrix()">
    Return a matrix representation (allowing to construct Operator).
  </Function>

  ### validate\_parameter

  <Function id="qiskit.circuit.AnnotatedOperation.validate_parameter" github="https://github.com/Qiskit/qiskit/tree/stable/1.3/qiskit/circuit/annotated_operation.py#L237-L242" signature="validate_parameter(parameter)">
