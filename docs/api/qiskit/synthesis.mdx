...
<Function id="qiskit.synthesis.synth_permutation_depth_lnn_kms" github="https://github.com/Qiskit/qiskit/tree/stable/1.2/qiskit/synthesis/permutation/permutation_lnn.py#L21-L52" signature="qiskit.synthesis.synth_permutation_depth_lnn_kms(pattern)">
