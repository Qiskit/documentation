...
<Class id="qiskit.circuit.CircuitInstruction" isDedicatedPage={true} signature="qiskit.circuit.CircuitInstruction(operation, qubits=None, clbits=None)" modifiers="class">
  Bases: [`object`](https://docs.python.org/3/library/functions.html#object)

  A single instruction in a [`QuantumCircuit`](/docs/api/qiskit/qiskit.circuit.QuantumCircuit "qiskit.circuit.QuantumCircuit"), comprised of the [`operation`](#qiskit.circuit.CircuitInstruction.operation "qiskit.circuit.CircuitInstruction.operation") and various operands.
  ...
  <Attribute id="qiskit.circuit.CircuitInstruction.clbits" name="clbits" headingLevel={3}>
    A sequence of the classical bits that this operation reads from or writes to.
  </Attribute>

  <Attribute id="qiskit.circuit.CircuitInstruction.label" name="label" headingLevel={3} />

  <Attribute id="qiskit.circuit.CircuitInstruction.matrix" name="matrix" headingLevel={3} />

  <Attribute id="qiskit.circuit.CircuitInstruction.name" name="name" headingLevel={3}>
    Returns the Instruction name corresponding to the op for this node
  </Attribute>

  <Attribute id="qiskit.circuit.CircuitInstruction.operation" name="operation" headingLevel={3}>
    The logical operation that this instruction represents an execution of.
  </Attribute>

  <Attribute id="qiskit.circuit.CircuitInstruction.params" name="params" headingLevel={3} />

  <Attribute id="qiskit.circuit.CircuitInstruction.qubits" name="qubits" headingLevel={3}>
