...
<Class id="qiskit.transpiler.passes.SetIOLatency" github="https://github.com/qiskit/qiskit/tree/stable/1.0/qiskit/transpiler/passes/scheduling/scheduling/set_io_latency.py" signature="qiskit.transpiler.passes.SetIOLatency(*args, **kwargs)">
