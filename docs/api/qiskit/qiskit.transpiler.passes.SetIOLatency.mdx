...
<Class id="qiskit.transpiler.passes.SetIOLatency" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/2.2/qiskit/transpiler/passes/scheduling/scheduling/set_io_latency.py#L18-L64" signature="qiskit.transpiler.passes.SetIOLatency(*args, **kwargs)" modifiers="class">
  ...
  *   **conditional\_latency** – A control flow constraints. This value represents a latency of reading a classical register for the conditional operation. The gate operation occurs after this latency. This appears as a delay in front of the DAGOpNode of the gate. This defaults to 0 dt.
  ...
  <Function id="qiskit.transpiler.passes.SetIOLatency.execute" github="https://github.com/Qiskit/qiskit/tree/stable/2.2/qiskit/passmanager/base_tasks.py#L72-L118" signature="execute(passmanager_ir, state, callback=None)">
  ...
  <Function id="qiskit.transpiler.passes.SetIOLatency.name" github="https://github.com/Qiskit/qiskit/tree/stable/2.2/qiskit/passmanager/base_tasks.py#L68-L70" signature="name()">
    Name of the pass.
  ...
  <Function id="qiskit.transpiler.passes.SetIOLatency.run" github="https://github.com/Qiskit/qiskit/tree/stable/2.2/qiskit/transpiler/passes/scheduling/scheduling/set_io_latency.py#L57-L64" signature="run(dag)">
  ...
  <Function id="qiskit.transpiler.passes.SetIOLatency.update_status" github="https://github.com/Qiskit/qiskit/tree/stable/2.2/qiskit/passmanager/base_tasks.py#L120-L138" signature="update_status(state, run_state)">
