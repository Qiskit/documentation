...
<Class id="qiskit.circuit.library.ZGate" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.0/qiskit/circuit/library/standard_gates/z.py#L29-L148" signature="qiskit.circuit.library.ZGate(*args, _force_mutable=False, **kwargs)">
...
$$
  ...
  <Function id="qiskit.circuit.library.ZGate.control" name="control" github="https://github.com/Qiskit/qiskit/tree/stable/1.0/qiskit/circuit/library/standard_gates/z.py#L96-L127" signature="control(num_ctrl_qubits=1, label=None, ctrl_state=None, annotated=False)">
  ...
  <Function id="qiskit.circuit.library.ZGate.inverse" name="inverse" github="https://github.com/Qiskit/qiskit/tree/stable/1.0/qiskit/circuit/library/standard_gates/z.py#L129-L141" signature="inverse(annotated=False)">
  ...
  <Function id="qiskit.circuit.library.ZGate.power" name="power" github="https://github.com/Qiskit/qiskit/tree/stable/1.0/qiskit/circuit/library/standard_gates/z.py#L143-L145" signature="power(exponent)">
