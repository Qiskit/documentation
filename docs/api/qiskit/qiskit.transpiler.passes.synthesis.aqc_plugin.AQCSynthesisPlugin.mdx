...
<Class id="qiskit.transpiler.passes.synthesis.aqc_plugin.AQCSynthesisPlugin" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/transpiler/passes/synthesis/aqc_plugin.py#L29-L153" signature="qiskit.transpiler.passes.synthesis.aqc_plugin.AQCSynthesisPlugin" modifiers="class">
  ...
  **initial\_point ([`ndarray`](https://numpy.org/doc/stable/reference/generated/numpy.ndarray.html#numpy.ndarray))**
  ...
  <Attribute id="qiskit.transpiler.passes.synthesis.aqc_plugin.AQCSynthesisPlugin.max_qubits" name="max_qubits" headingLevel={3}>
    Maximum number of supported qubits is `14`.
  </Attribute>

  <Attribute id="qiskit.transpiler.passes.synthesis.aqc_plugin.AQCSynthesisPlugin.min_qubits" name="min_qubits" headingLevel={3}>
    Minimum number of supported qubits is `3`.
  </Attribute>

  <Attribute id="qiskit.transpiler.passes.synthesis.aqc_plugin.AQCSynthesisPlugin.supported_bases" name="supported_bases" headingLevel={3}>
    The plugin does not support bases for synthesis.
  </Attribute>

  <Attribute id="qiskit.transpiler.passes.synthesis.aqc_plugin.AQCSynthesisPlugin.supports_basis_gates" name="supports_basis_gates" headingLevel={3}>
    The plugin does not support basis gates and by default it synthesizes a circuit using `["rx", "ry", "rz", "cx"]` gate basis.
  </Attribute>

  <Attribute id="qiskit.transpiler.passes.synthesis.aqc_plugin.AQCSynthesisPlugin.supports_coupling_map" name="supports_coupling_map" headingLevel={3}>
    The plugin does not support coupling maps.
  </Attribute>

  <Attribute id="qiskit.transpiler.passes.synthesis.aqc_plugin.AQCSynthesisPlugin.supports_gate_errors" name="supports_gate_errors" headingLevel={3}>
    The plugin does not support gate errors.
  </Attribute>

  <Attribute id="qiskit.transpiler.passes.synthesis.aqc_plugin.AQCSynthesisPlugin.supports_gate_errors_by_qubit" name="supports_gate_errors_by_qubit" headingLevel={3}>
  ...
  <Attribute id="qiskit.transpiler.passes.synthesis.aqc_plugin.AQCSynthesisPlugin.supports_gate_lengths" name="supports_gate_lengths" headingLevel={3}>
    The plugin does not support gate lengths.
  </Attribute>

  <Attribute id="qiskit.transpiler.passes.synthesis.aqc_plugin.AQCSynthesisPlugin.supports_gate_lengths_by_qubit" name="supports_gate_lengths_by_qubit" headingLevel={3}>
  ...
  <Attribute id="qiskit.transpiler.passes.synthesis.aqc_plugin.AQCSynthesisPlugin.supports_natural_direction" name="supports_natural_direction" headingLevel={3}>
    The plugin does not support natural direction, it assumes bidirectional two qubit gates.
  </Attribute>

  <Attribute id="qiskit.transpiler.passes.synthesis.aqc_plugin.AQCSynthesisPlugin.supports_pulse_optimize" name="supports_pulse_optimize" headingLevel={3}>
    The plugin does not support optimization of pulses.
  </Attribute>

  <Attribute id="qiskit.transpiler.passes.synthesis.aqc_plugin.AQCSynthesisPlugin.supports_target" name="supports_target" headingLevel={3}>
