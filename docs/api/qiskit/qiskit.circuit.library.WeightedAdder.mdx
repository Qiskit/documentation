---
title: WeightedAdder (latest version)
description: API reference for qiskit.circuit.library.WeightedAdder in the latest version of qiskit
...
<Class id="qiskit.circuit.library.WeightedAdder" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/circuit/library/arithmetic/weighted_adder.py#L25-L354" signature="qiskit.circuit.library.WeightedAdder(num_state_qubits=None, weights=None, name='adder')" modifiers="class">
...
$$
  ...
  *   **name** ([*str*](https://docs.python.org/3/library/stdtypes.html#str)) – The name of the circuit.
  ...
  <Attribute id="qiskit.circuit.library.WeightedAdder.num_carry_qubits" name="num_carry_qubits" headingLevel={3}>
  ...
  <Attribute id="qiskit.circuit.library.WeightedAdder.num_control_qubits" name="num_control_qubits" headingLevel={3}>
  ...
  <Attribute id="qiskit.circuit.library.WeightedAdder.num_state_qubits" name="num_state_qubits" headingLevel={3}>
  ...
  <Attribute id="qiskit.circuit.library.WeightedAdder.num_sum_qubits" name="num_sum_qubits" headingLevel={3}>
  ...
  <Attribute id="qiskit.circuit.library.WeightedAdder.weights" name="weights" headingLevel={3}>
  ...
  <Attribute id="qiskit.circuit.library.WeightedAdder.name" name="name" headingLevel={3}>
