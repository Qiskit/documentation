...
<Class id="qiskit.quantum_info.Stinespring" github="https://github.com/qiskit/qiskit/tree/stable/1.0/qiskit/quantum_info/operators/channel/stinespring.py" signature="qiskit.quantum_info.Stinespring(data, input_dims=None, output_dims=None)">
