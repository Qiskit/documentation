...
<Class id="qiskit.providers.basic_provider.BasicProviderError" github="https://github.com/qiskit/qiskit/tree/stable/1.0/qiskit/providers/basic_provider/exceptions.py" signature="qiskit.providers.basic_provider.BasicProviderError(*message)">
