...
<Class id="qiskit.passmanager.PassManagerState" github="https://github.com/Qiskit/qiskit/tree/stable/1.0/qiskit/passmanager/compilation_status.py#L55-L74" signature="qiskit.passmanager.PassManagerState(workflow_status, property_set)">
