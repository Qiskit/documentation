...
<Class id="qiskit.passmanager.PassManagerState" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/passmanager/compilation_status.py#L55-L74" signature="qiskit.passmanager.PassManagerState(workflow_status, property_set)" modifiers="class">
  ...
  *   **property\_set** ([*PropertySet*](qiskit.passmanager.PropertySet "qiskit.passmanager.compilation_status.PropertySet"))
  ...
  <Attribute id="qiskit.passmanager.PassManagerState.workflow_status" name="workflow_status" headingLevel={3}>
    <AttributeTypeHint>
      [WorkflowStatus](qiskit.passmanager.WorkflowStatus "qiskit.passmanager.compilation_status.WorkflowStatus")
    </AttributeTypeHint>
  ...
  <Attribute id="qiskit.passmanager.PassManagerState.property_set" name="property_set" headingLevel={3}>
    <AttributeTypeHint>
      [PropertySet](qiskit.passmanager.PropertySet "qiskit.passmanager.compilation_status.PropertySet")
    </AttributeTypeHint>
