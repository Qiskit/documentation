...
<Class id="qiskit.circuit.library.RC3XGate" github="https://github.com/Qiskit/qiskit/tree/stable/1.0/qiskit/circuit/library/standard_gates/x.py#L831-L927" signature="qiskit.circuit.library.RC3XGate(*args, _force_mutable=False, **kwargs)">
