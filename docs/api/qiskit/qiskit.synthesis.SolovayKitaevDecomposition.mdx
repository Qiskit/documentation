...
<Class id="qiskit.synthesis.SolovayKitaevDecomposition" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/synthesis/discrete_basis/solovay_kitaev.py#L33-L270" signature="qiskit.synthesis.SolovayKitaevDecomposition(basic_approximations=None, *, basis_gates=None, depth=12, check_input=False)" modifiers="class">
  ...
  *   **check\_input** ([*bool*](https://docs.python.org/3/library/functions.html#bool)) – If `True`, perform intermediate steps checking whether the matrices are of expected form.
  ...
  <Attribute id="qiskit.synthesis.SolovayKitaevDecomposition.basis_gates" name="basis_gates" headingLevel={3}>
    The basis gate set of the basic approximations.

    If `None`, defaults to `["h", "t", "tdg"]`.
  </Attribute>

  <Attribute id="qiskit.synthesis.SolovayKitaevDecomposition.check_input" name="check_input" headingLevel={3}>
    Whether to perform runtime checks on the internal data.
  </Attribute>

  <Attribute id="qiskit.synthesis.SolovayKitaevDecomposition.depth" name="depth" headingLevel={3}>
  ...
  <Function id="qiskit.synthesis.SolovayKitaevDecomposition.find_basic_approximation" github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/synthesis/discrete_basis/solovay_kitaev.py#L256-L270" signature="find_basic_approximation(sequence)">
  ...
  <Function id="qiskit.synthesis.SolovayKitaevDecomposition.load_basic_approximations" github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/synthesis/discrete_basis/solovay_kitaev.py#L117-L176" signature="load_basic_approximations(data)" modifiers="static">
  ...
  <Function id="qiskit.synthesis.SolovayKitaevDecomposition.query_basic_approximation" github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/synthesis/discrete_basis/solovay_kitaev.py#L246-L254" signature="query_basic_approximation(gate)">
  ...
  <Function id="qiskit.synthesis.SolovayKitaevDecomposition.run" github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/synthesis/discrete_basis/solovay_kitaev.py#L206-L244" signature="run(gate_matrix, recursion_degree, return_dag=False, check_input=True)">
    Run the algorithm.
    ...
    *   **return\_dag** ([*bool*](https://docs.python.org/3/library/functions.html#bool)) – If `True` return a [`DAGCircuit`](qiskit.dagcircuit.DAGCircuit "qiskit.dagcircuit.DAGCircuit"), else a [`QuantumCircuit`](/docs/api/qiskit/qiskit.circuit.QuantumCircuit "qiskit.circuit.QuantumCircuit").
  ...
  <Function id="qiskit.synthesis.SolovayKitaevDecomposition.save_basic_approximations" github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/synthesis/discrete_basis/solovay_kitaev.py#L178-L204" signature="save_basic_approximations(filename)">
