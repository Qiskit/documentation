...
<Class id="qiskit.transpiler.passes.CollectAndCollapse" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.2/qiskit/transpiler/passes/optimization/collect_and_collapse.py#L23-L88" signature="qiskit.transpiler.passes.CollectAndCollapse(*args, **kwargs)" modifiers="class">
  ...
  *   **do\_commutative\_analysis** ([*bool*](https://docs.python.org/3/library/functions.html#bool "(in Python v3.12)")) – if True, exploits commutativity relations between nodes.
  ...
  <Function id="qiskit.transpiler.passes.CollectAndCollapse.run" github="https://github.com/Qiskit/qiskit/tree/stable/1.2/qiskit/transpiler/passes/utils/control_flow.py#L65-L88" signature="run(dag)">
