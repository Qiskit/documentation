...
<Class id="qiskit.qobj.PulseQobjExperiment" github="https://github.com/Qiskit/qiskit/tree/stable/1.0/qiskit/qobj/pulse_qobj.py#L379-L470" signature="qiskit.qobj.PulseQobjExperiment(instructions, config=None, header=None)">
