...
<Class id="qiskit.qobj.PulseQobjExperiment" github="https://github.com/qiskit/qiskit/tree/stable/1.0/qiskit/qobj/pulse_qobj.py" signature="qiskit.qobj.PulseQobjExperiment(instructions, config=None, header=None)">
