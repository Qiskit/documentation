...
<Function id="qiskit.qpy.load" github="https://github.com/Qiskit/qiskit/tree/stable/1.4/qiskit/qpy/interface.py#L238-L391" signature="qiskit.qpy.load(file_obj, metadata_deserializer=None, trust_payload=False)">
  ...
  *   **trust\_payload** ([*bool*](https://docs.python.org/3/library/functions.html#bool)) – if set to `False` (the default), [`ScheduleBlock`](qiskit.pulse.ScheduleBlock "qiskit.pulse.ScheduleBlock") objects in the payload that were serialized using `sympy` are not allowed and will error. This is because the `sympy` parsing uses [`eval()`](https://docs.python.org/3/library/functions.html#eval), which can allow for arbitrary code execution. The flag should only be set to `True` if you trust the QPY payload you are loading.
  ...
  **Return type**
  ...
  <Admonition title="Warning" type="caution">
    If `trust_payload` is set to `True` this can enable arbitrary code execution because internally `sympy` relies on [`eval()`](https://docs.python.org/3/library/functions.html#eval).
  </Admonition>
  ...
  *   **file\_obj** ([*BinaryIO*](https://docs.python.org/3/library/typing.html#typing.BinaryIO)) –
  *   **metadata\_deserializer** ([*Type*](https://docs.python.org/3/library/typing.html#typing.Type)*\[JSONDecoder] | None*) –
  *   **trust\_payload** ([*bool*](https://docs.python.org/3/library/functions.html#bool)) –
