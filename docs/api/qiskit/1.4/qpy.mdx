---
title: qpy (v1.4)
description: API reference for qiskit.qpy in qiskit v1.4
...
<Function id="qiskit.qpy.load" github="https://github.com/Qiskit/qiskit/tree/stable/1.4/qiskit/qpy/interface.py#L238-L391" signature="qiskit.qpy.load(file_obj, metadata_deserializer=None, trust_payload=False)">
  ...
  *   **file\_obj** ([*BinaryIO*](https://docs.python.org/3/library/typing.html#typing.BinaryIO "(in Python v3.14)")) – A file like object that contains the QPY binary data for a circuit or pulse schedule.
  *   **metadata\_deserializer** ([*Type*](https://docs.python.org/3/library/typing.html#typing.Type "(in Python v3.14)")*\[JSONDecoder] | None*) – An optional JSONDecoder class that will be used for the `cls` kwarg on the internal `json.load` call used to deserialize the JSON payload used for the `.metadata` attribute for any programs in the QPY file. If this is not specified the circuit metadata will be parsed as JSON with the stdlib `json.load()` function using the default `JSONDecoder` class.
  *   **trust\_payload** ([*bool*](https://docs.python.org/3/library/functions.html#bool "(in Python v3.14)")) – if set to `False` (the default), [`ScheduleBlock`](qiskit.pulse.ScheduleBlock "qiskit.pulse.ScheduleBlock") objects in the payload that were serialized using `sympy` are not allowed and will error. This is because the `sympy` parsing uses [`eval()`](https://docs.python.org/3/library/functions.html#eval "(in Python v3.14)"), which can allow for arbitrary code execution. The flag should only be set to `True` if you trust the QPY payload you are loading.

  **Return type**

  [*List*](https://docs.python.org/3/library/typing.html#typing.List "(in Python v3.14)")\[[*QuantumCircuit*](qiskit.circuit.QuantumCircuit "qiskit.circuit.quantumcircuit.QuantumCircuit") | [*ScheduleBlock*](qiskit.pulse.ScheduleBlock "qiskit.pulse.schedule.ScheduleBlock")]

  <Admonition title="Warning" type="caution">
    If `trust_payload` is set to `True` this can enable arbitrary code execution because internally `sympy` relies on [`eval()`](https://docs.python.org/3/library/functions.html#eval "(in Python v3.14)").
  </Admonition>
  ...
  *   **file\_obj** ([*BinaryIO*](https://docs.python.org/3/library/typing.html#typing.BinaryIO "(in Python v3.14)")) –
  *   **metadata\_deserializer** ([*Type*](https://docs.python.org/3/library/typing.html#typing.Type "(in Python v3.14)")*\[JSONDecoder] | None*) –
  *   **trust\_payload** ([*bool*](https://docs.python.org/3/library/functions.html#bool "(in Python v3.14)")) –
