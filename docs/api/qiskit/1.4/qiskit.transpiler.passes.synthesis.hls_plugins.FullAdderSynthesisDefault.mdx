---
title: FullAdderSynthesisDefault (v1.4)
description: API reference for qiskit.transpiler.passes.synthesis.hls_plugins.FullAdderSynthesisDefault in qiskit v1.4
