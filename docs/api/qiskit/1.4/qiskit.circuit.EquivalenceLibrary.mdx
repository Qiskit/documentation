---
title: EquivalenceLibrary (v1.4)
description: API reference for qiskit.circuit.EquivalenceLibrary in qiskit v1.4
...
<Class id="qiskit.circuit.EquivalenceLibrary" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.4/qiskit/circuit/equivalence.py#L29-L94" signature="qiskit.circuit.EquivalenceLibrary" modifiers="class">
  ...
  <Function id="qiskit.circuit.EquivalenceLibrary.draw" github="https://github.com/Qiskit/qiskit/tree/stable/1.4/qiskit/circuit/equivalence.py#L33-L58" signature="draw(filename=None)">
