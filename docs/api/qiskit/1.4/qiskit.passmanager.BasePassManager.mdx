...
<Class id="qiskit.passmanager.BasePassManager" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.4/qiskit/passmanager/passmanager.py#L36-L285" signature="qiskit.passmanager.BasePassManager(tasks=(), max_iteration=1000)" modifiers="class">
  ...
  *   **max\_iteration** ([*int*](https://docs.python.org/3/library/functions.html#int "(in Python v3.14)")) – The maximum number of iterations the schedule will be looped if the condition is not met.
  ...
  <Function id="qiskit.passmanager.BasePassManager.run" github="https://github.com/Qiskit/qiskit/tree/stable/1.4/qiskit/passmanager/passmanager.py#L175-L269" signature="run(in_programs, callback=None, num_processes=None, *, property_set=<object object>, **kwargs)">
    ...
    *   **property\_set** ([*object*](https://docs.python.org/3/library/functions.html#object "(in Python v3.14)")) – Currently a key that will be interpreted as all other arbitrary `kwargs`. In Qiskit 2.0, this will instead seed the [`PropertySet`](qiskit.passmanager.PropertySet "qiskit.passmanager.PropertySet") of the compilation (but does not do so in this version).
