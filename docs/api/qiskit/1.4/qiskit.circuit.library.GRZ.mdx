---
title: GRZ (v1.4)
description: API reference for qiskit.circuit.library.GRZ in qiskit v1.4
...
$$
  ...
  **Expanded Circuit:**
  ...
  ![Diagram illustrating the previously described circuit.](/docs/images/api/qiskit/1.4/qiskit-circuit-library-GRZ-1.avif)
