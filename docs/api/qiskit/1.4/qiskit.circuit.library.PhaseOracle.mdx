---
title: PhaseOracle (v1.4)
description: API reference for qiskit.circuit.library.PhaseOracle in qiskit v1.4
...
<Class id="qiskit.circuit.library.PhaseOracle" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.4/qiskit/circuit/library/phase_oracle.py#L28-L160" signature="qiskit.circuit.library.PhaseOracle(expression, synthesizer=None, var_order=None)" modifiers="class">
  ...
  *   **expression** (*Union\[*[*str*](https://docs.python.org/3/library/stdtypes.html#str "(in Python v3.14)")*, ClassicalElement]*) – A Python-like boolean expression.
