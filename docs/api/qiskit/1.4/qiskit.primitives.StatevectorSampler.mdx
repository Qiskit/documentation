---
title: StatevectorSampler (v1.4)
description: API reference for qiskit.primitives.StatevectorSampler in qiskit v1.4
...
<Class id="qiskit.primitives.StatevectorSampler" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.4/qiskit/primitives/statevector_sampler.py#L52-L203" signature="qiskit.primitives.StatevectorSampler(*, default_shots=1024, seed=None)" modifiers="class">
  ...
  *   **seed** (*np.random.Generator |* [*int*](https://docs.python.org/3/library/functions.html#int "(in Python v3.13)") *| None*) – The seed or Generator object for random number generation. If None, a random seeded default RNG will be used.
  ...
  <Function id="qiskit.primitives.StatevectorSampler.run" github="https://github.com/Qiskit/qiskit/tree/stable/1.4/qiskit/primitives/statevector_sampler.py#L155-L170" signature="run(pubs, *, shots=None)">
