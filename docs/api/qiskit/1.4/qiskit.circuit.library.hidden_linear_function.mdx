---
title: hidden_linear_function (v1.4)
description: API reference for qiskit.circuit.library.hidden_linear_function in qiskit v1.4
...
<Class id="qiskit.circuit.library.hidden_linear_function" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.4/qiskit/circuit/library/hidden_linear_function.py#L92-L163" signature="qiskit.circuit.library.hidden_linear_function(adjacency_matrix)" modifiers="class">
  Bases:
...
$$
  ...
  **Reference Circuit:**
  ...
  ![Circuit diagram output by the previous code.](/docs/images/api/qiskit/1.4/qiskit-circuit-library-hidden_linear_function-1.avif)
