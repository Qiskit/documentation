---
title: ZGate (v1.4)
description: API reference for qiskit.circuit.library.ZGate in qiskit v1.4
...
<Class id="qiskit.circuit.library.ZGate" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.4/qiskit/circuit/library/standard_gates/z.py#L30-L150" signature="qiskit.circuit.library.ZGate(*args, _force_mutable=False, **kwargs)" modifiers="class">
...
$$
  ...
  <Function id="qiskit.circuit.library.ZGate.control" github="https://github.com/Qiskit/qiskit/tree/stable/1.4/qiskit/circuit/library/standard_gates/z.py#L99-L130" signature="control(num_ctrl_qubits=1, label=None, ctrl_state=None, annotated=False)">
  ...
  <Function id="qiskit.circuit.library.ZGate.inverse" github="https://github.com/Qiskit/qiskit/tree/stable/1.4/qiskit/circuit/library/standard_gates/z.py#L132-L144" signature="inverse(annotated=False)">
  ...
  <Function id="qiskit.circuit.library.ZGate.power" github="https://github.com/Qiskit/qiskit/tree/stable/1.4/qiskit/circuit/library/standard_gates/z.py#L146-L147" signature="power(exponent, annotated=False)">
