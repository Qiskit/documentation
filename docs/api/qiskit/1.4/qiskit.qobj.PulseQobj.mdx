...
<Class id="qiskit.qobj.PulseQobj" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.4/qiskit/qobj/pulse_qobj.py#L591-L709" signature="qiskit.qobj.PulseQobj(qobj_id, config, experiments, header=None)" modifiers="class">
  ...
  *   **qobj\_id** ([*str*](https://docs.python.org/3/library/stdtypes.html#str "(in Python v3.14)")) – An identifier for the qobj
  ...
  *   **experiments** ([*list*](https://docs.python.org/3/library/stdtypes.html#list "(in Python v3.14)")) – A list of lists of [`PulseQobjExperiment`](qiskit.qobj.PulseQobjExperiment "qiskit.qobj.PulseQobjExperiment") objects representing an experiment
  ...
  <Function id="qiskit.qobj.PulseQobj.from_dict" github="https://github.com/Qiskit/qiskit/tree/stable/1.4/qiskit/qobj/pulse_qobj.py#L680-L703" signature="from_dict(data)" modifiers="classmethod">
    ...
    **data** ([*dict*](https://docs.python.org/3/library/stdtypes.html#dict "(in Python v3.14)")) – A dictionary representing the PulseQobj to create. It will be in the same format as output by [`to_dict()`](#qiskit.qobj.PulseQobj.to_dict "qiskit.qobj.PulseQobj.to_dict").
