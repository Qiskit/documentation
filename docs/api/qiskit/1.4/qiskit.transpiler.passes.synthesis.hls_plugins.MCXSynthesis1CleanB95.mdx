---
title: MCXSynthesis1CleanB95 (v1.4)
description: API reference for qiskit.transpiler.passes.synthesis.hls_plugins.MCXSynthesis1CleanB95 in qiskit v1.4
...
<Class id="qiskit.transpiler.passes.synthesis.hls_plugins.MCXSynthesis1CleanB95" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.4/qiskit/transpiler/passes/synthesis/hls_plugins.py#L1027-L1072" signature="qiskit.transpiler.passes.synthesis.hls_plugins.MCXSynthesis1CleanB95" modifiers="class">
  ...
  **References**
  ...
  <Function id="qiskit.transpiler.passes.synthesis.hls_plugins.MCXSynthesis1CleanB95.run" github="https://github.com/Qiskit/qiskit/tree/stable/1.4/qiskit/transpiler/passes/synthesis/hls_plugins.py#L1049-L1072" signature="run(high_level_object, coupling_map=None, target=None, qubits=None, **options)">
