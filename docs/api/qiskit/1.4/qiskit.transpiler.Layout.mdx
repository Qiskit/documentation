...
<Class id="qiskit.transpiler.Layout" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.4/qiskit/transpiler/layout.py#L30-L439" signature="qiskit.transpiler.Layout(input_dict=None)" modifiers="class">
  ...
  <Function id="qiskit.transpiler.Layout.inverse" github="https://github.com/Qiskit/qiskit/tree/stable/1.4/qiskit/transpiler/layout.py#L391-L416" signature="inverse(source_qubits, target_qubits)">
    ...
    *   **source\_qubits** ([*List*](https://docs.python.org/3/library/typing.html#typing.List)*\[*[*Qubit*](circuit#qiskit.circuit.Qubit "qiskit.circuit.quantumregister.Qubit")*]*) – A list of [`Qubit`](circuit#qiskit.circuit.Qubit "qiskit.circuit.Qubit") objects representing the domain of the layout.
    *   **target\_qubits** ([*List*](https://docs.python.org/3/library/typing.html#typing.List)*\[*[*Qubit*](circuit#qiskit.circuit.Qubit "qiskit.circuit.quantumregister.Qubit")*]*) – A list of [`Qubit`](circuit#qiskit.circuit.Qubit "qiskit.circuit.Qubit") objects representing the image of the layout.
  ...
  <Function id="qiskit.transpiler.Layout.reorder_bits" github="https://github.com/Qiskit/qiskit/tree/stable/1.4/qiskit/transpiler/layout.py#L266-L284" signature="reorder_bits(bits)">
    ...
    **bits** ([*list*](https://docs.python.org/3/library/stdtypes.html#list)*\[*[*Bit*](circuit#qiskit.circuit.Bit "qiskit.circuit.Bit")*]*) – the bits to reorder.
  ...
  <Function id="qiskit.transpiler.Layout.to_permutation" github="https://github.com/Qiskit/qiskit/tree/stable/1.4/qiskit/transpiler/layout.py#L418-L439" signature="to_permutation(qubits)">
    ...
    **qubits** ([*List*](https://docs.python.org/3/library/typing.html#typing.List)*\[*[*Qubit*](circuit#qiskit.circuit.Qubit "qiskit.circuit.quantumregister.Qubit")*]*) –
  </Function>
</Class>
