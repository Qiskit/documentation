...
<Class id="qiskit.result.Result" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.4/qiskit/result/result.py#L32-L481" signature="qiskit.result.Result(*args, date=None, status=None, header=None, **kwargs)" modifiers="class">
  ...
  *   **backend\_name** ([*str*](https://docs.python.org/3/library/stdtypes.html#str)) – (REQUIRED) backend name.
  *   **backend\_version** ([*str*](https://docs.python.org/3/library/stdtypes.html#str)) – (REQUIRED) backend version, in the form X.Y.Z.
  *   **qobj\_id** ([*str*](https://docs.python.org/3/library/stdtypes.html#str)) – (REQUIRED) user-generated Qobj id.
  *   **job\_id** ([*str*](https://docs.python.org/3/library/stdtypes.html#str)) – (REQUIRED) unique execution id from the backend.
  *   **success** ([*bool*](https://docs.python.org/3/library/functions.html#bool)) – (REQUIRED) True if complete input qobj executed correctly. (Implies each experiment success)
  *   **results** ([*list*](https://docs.python.org/3/library/stdtypes.html#list)*\[ExperimentResult]*) – (REQUIRED) corresponding results for array of experiments of the input qobj
  *   **date** ([*str*](https://docs.python.org/3/library/stdtypes.html#str)) – (OPTIONAL) date of the experiment
  *   **header** ([*dict*](https://docs.python.org/3/library/stdtypes.html#dict)) – (OPTIONAL)experiment header
