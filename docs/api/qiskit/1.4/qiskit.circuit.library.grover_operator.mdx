---
title: grover_operator (v1.4)
description: API reference for qiskit.circuit.library.grover_operator in qiskit v1.4
...
$$
  ...
  **Examples**
  ...
  ![Circuit diagram output by the previous code.](/docs/images/api/qiskit/1.4/qiskit-circuit-library-grover_operator-1.avif)
  ...
  ![Circuit diagram output by the previous code.](/docs/images/api/qiskit/1.4/qiskit-circuit-library-grover_operator-2.avif)
  ...
  ![Circuit diagram output by the previous code.](/docs/images/api/qiskit/1.4/qiskit-circuit-library-grover_operator-3.avif)
  ...
  ![Circuit diagram output by the previous code.](/docs/images/api/qiskit/1.4/qiskit-circuit-library-grover_operator-4.avif)
