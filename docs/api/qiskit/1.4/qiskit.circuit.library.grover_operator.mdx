...
$$
  ...
  **Examples**
  ...
  ![Circuit diagram output by the previous code.](/images/api/qiskit/1.4/qiskit-circuit-library-grover_operator-1.avif)
  ...
  ![Circuit diagram output by the previous code.](/images/api/qiskit/1.4/qiskit-circuit-library-grover_operator-2.avif)
  ...
  ![Circuit diagram output by the previous code.](/images/api/qiskit/1.4/qiskit-circuit-library-grover_operator-3.avif)
  ...
  ![Circuit diagram output by the previous code.](/images/api/qiskit/1.4/qiskit-circuit-library-grover_operator-4.avif)
