---
title: DraperQFTAdder (v1.4)
description: API reference for qiskit.circuit.library.DraperQFTAdder in qiskit v1.4
...
<Class id="qiskit.circuit.library.DraperQFTAdder" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.4/qiskit/circuit/library/arithmetic/adders/draper_qft_adder.py#L24-L129" signature="qiskit.circuit.library.DraperQFTAdder(num_state_qubits, kind='fixed', name='DraperQFTAdder')" modifiers="class">
  ...
  <Admonition title="See also" type="note">
    ...
    **[`HalfAdderGate`](qiskit.circuit.library.HalfAdderGate "qiskit.circuit.library.HalfAdderGate"): A generic inplace adder. This**
