---
title: plot_state_paulivec (v1.4)
description: API reference for qiskit.visualization.plot_state_paulivec in qiskit v1.4
...
<Function id="qiskit.visualization.plot_state_paulivec" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.4/qiskit/visualization/state_visualization.py#L618-L731" signature="qiskit.visualization.plot_state_paulivec(state, title='', figsize=None, color=None, ax=None, *, filename=None)">
...
$$
  ...
  **Examples**
  ...
  ![Output from the previous code.](/docs/images/api/qiskit/1.4/qiskit-visualization-plot_state_paulivec-1.avif)
  ...
  ![Output from the previous code.](/docs/images/api/qiskit/1.4/qiskit-visualization-plot_state_paulivec-2.avif)
</Function>
