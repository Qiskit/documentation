---
title: KMSSynthesisLinearFunction (v1.4)
description: API reference for qiskit.transpiler.passes.synthesis.hls_plugins.KMSSynthesisLinearFunction in qiskit v1.4
