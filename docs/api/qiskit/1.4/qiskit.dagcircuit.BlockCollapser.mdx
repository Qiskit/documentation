---
title: BlockCollapser (v1.4)
description: API reference for qiskit.dagcircuit.BlockCollapser in qiskit v1.4
...
<Class id="qiskit.dagcircuit.BlockCollapser" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.4/qiskit/dagcircuit/collect_blocks.py#L325-L395" signature="qiskit.dagcircuit.BlockCollapser(dag)" modifiers="class">
  ...
  **Raises**
  ...
  <Function id="qiskit.dagcircuit.BlockCollapser.collapse_to_operation" github="https://github.com/Qiskit/qiskit/tree/stable/1.4/qiskit/dagcircuit/collect_blocks.py#L343-L395" signature="collapse_to_operation(blocks, collapse_fn)">
