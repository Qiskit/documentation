...
<Class id="qiskit.transpiler.passes.StochasticSwap" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.4/qiskit/transpiler/passes/routing/stochastic_swap.py#L48-L480" signature="qiskit.transpiler.passes.StochasticSwap(*args, **kwargs)" modifiers="class">
  ...
  *   **trials** ([*int*](https://docs.python.org/3/library/functions.html#int "(in Python v3.14)")) – maximum number of iterations to attempt
  *   **seed** ([*int*](https://docs.python.org/3/library/functions.html#int "(in Python v3.14)")) – seed for random number generator
