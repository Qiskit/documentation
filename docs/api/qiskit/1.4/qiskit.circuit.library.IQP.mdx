...
<Class id="qiskit.circuit.library.IQP" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.4/qiskit/circuit/library/iqp.py#L24-L83" signature="qiskit.circuit.library.IQP(interactions)" modifiers="class">
  ...
  **Reference Circuit:**
  ...
  ![Diagram illustrating the previously described circuit.](/docs/images/api/qiskit/1.4/qiskit-circuit-library-IQP-1.avif)

  **Expanded Circuit:**

  > ![Diagram illustrating the previously described circuit.](/docs/images/api/qiskit/1.4/qiskit-circuit-library-IQP-2.avif)
