---
title: StarPreRouting (v1.4)
description: API reference for qiskit.transpiler.passes.StarPreRouting in qiskit v1.4
...
<Class id="qiskit.transpiler.passes.StarPreRouting" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.4/qiskit/transpiler/passes/routing/star_prerouting.py#L90-L367" signature="qiskit.transpiler.passes.StarPreRouting(*args, **kwargs)" modifiers="class">
  ...
  > ```
  >
  > ![Circuit diagram output by the previous code.](/docs/images/api/qiskit/1.4/qiskit-transpiler-passes-StarPreRouting-1.avif)
  ...
  <Function id="qiskit.transpiler.passes.StarPreRouting.collect_all_matching_blocks" github="https://github.com/Qiskit/qiskit/tree/stable/1.4/qiskit/transpiler/passes/routing/star_prerouting.py#L211-L258" signature="collect_all_matching_blocks(dag, min_block_size=2)">
  ...
  <Function id="qiskit.transpiler.passes.StarPreRouting.collect_matching_block" github="https://github.com/Qiskit/qiskit/tree/stable/1.4/qiskit/transpiler/passes/routing/star_prerouting.py#L176-L209" signature="collect_matching_block(dag, filter_fn)">
  ...
  <Function id="qiskit.transpiler.passes.StarPreRouting.determine_star_blocks_processing" github="https://github.com/Qiskit/qiskit/tree/stable/1.4/qiskit/transpiler/passes/routing/star_prerouting.py#L292-L307" signature="determine_star_blocks_processing(dag, min_block_size)">
  ...
  <Function id="qiskit.transpiler.passes.StarPreRouting.execute" github="https://github.com/Qiskit/qiskit/tree/stable/1.4/qiskit/transpiler/basepasses.py#L189-L211" signature="execute(passmanager_ir, state, callback=None)">
  ...
  <Function id="qiskit.transpiler.passes.StarPreRouting.name" github="https://github.com/Qiskit/qiskit/tree/stable/1.4/qiskit/passmanager/base_tasks.py#L68-L70" signature="name()">
    Name of the pass.
  ...
  <Function id="qiskit.transpiler.passes.StarPreRouting.run" github="https://github.com/Qiskit/qiskit/tree/stable/1.4/qiskit/transpiler/passes/routing/star_prerouting.py#L260-L290" signature="run(dag)">
  ...
  <Function id="qiskit.transpiler.passes.StarPreRouting.star_preroute" github="https://github.com/Qiskit/qiskit/tree/stable/1.4/qiskit/transpiler/passes/routing/star_prerouting.py#L309-L367" signature="star_preroute(dag, blocks, processing_order)">
  ...
  <Function id="qiskit.transpiler.passes.StarPreRouting.update_status" github="https://github.com/Qiskit/qiskit/tree/stable/1.4/qiskit/transpiler/basepasses.py#L213-L221" signature="update_status(state, run_state)">
