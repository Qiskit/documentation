---
title: HalfAdderSynthesisDefault (v1.4)
description: API reference for qiskit.transpiler.passes.synthesis.hls_plugins.HalfAdderSynthesisDefault in qiskit v1.4
...
<Class id="qiskit.transpiler.passes.synthesis.hls_plugins.HalfAdderSynthesisDefault" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.4/qiskit/transpiler/passes/synthesis/hls_plugins.py#L1358-L1401" signature="qiskit.transpiler.passes.synthesis.hls_plugins.HalfAdderSynthesisDefault" modifiers="class">
  ...
  *   `num_clean_ancillas`: The number of clean auxiliary qubits available.
  ...
  <Function id="qiskit.transpiler.passes.synthesis.hls_plugins.HalfAdderSynthesisDefault.run" github="https://github.com/Qiskit/qiskit/tree/stable/1.4/qiskit/transpiler/passes/synthesis/hls_plugins.py#L1378-L1401" signature="run(high_level_object, coupling_map=None, target=None, qubits=None, **options)">
