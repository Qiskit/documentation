---
title: SamplerPubResult (v1.4)
description: API reference for qiskit.primitives.SamplerPubResult in qiskit v1.4
...
<Class id="qiskit.primitives.SamplerPubResult" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.4/qiskit/primitives/containers/sampler_pub_result.py#L27-L74" signature="qiskit.primitives.SamplerPubResult(data, metadata=None)" modifiers="class">
  ...
  *   **metadata** ([*dict*](https://docs.python.org/3/library/stdtypes.html#dict "(in Python v3.13)")*\[*[*str*](https://docs.python.org/3/library/stdtypes.html#str "(in Python v3.13)")*, Any] | None*) – Metadata specific to this pub. Keys are expected to be strings.
  ...
  <Function id="qiskit.primitives.SamplerPubResult.join_data" github="https://github.com/Qiskit/qiskit/tree/stable/1.4/qiskit/primitives/containers/sampler_pub_result.py#L30-L74" signature="join_data(names=None)">
