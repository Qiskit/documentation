---
title: AGSynthesisClifford (v1.4)
description: API reference for qiskit.transpiler.passes.synthesis.hls_plugins.AGSynthesisClifford in qiskit v1.4
...
<Class id="qiskit.transpiler.passes.synthesis.hls_plugins.AGSynthesisClifford" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.4/qiskit/transpiler/passes/synthesis/hls_plugins.py#L496-L509" signature="qiskit.transpiler.passes.synthesis.hls_plugins.AGSynthesisClifford" modifiers="class">
  ...
  <Function id="qiskit.transpiler.passes.synthesis.hls_plugins.AGSynthesisClifford.run" github="https://github.com/Qiskit/qiskit/tree/stable/1.4/qiskit/transpiler/passes/synthesis/hls_plugins.py#L503-L509" signature="run(high_level_object, coupling_map=None, target=None, qubits=None, **options)">
