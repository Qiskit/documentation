---
title: KMSSynthesisPermutation (v1.4)
description: API reference for qiskit.transpiler.passes.synthesis.hls_plugins.KMSSynthesisPermutation in qiskit v1.4
...
<Class id="qiskit.transpiler.passes.synthesis.hls_plugins.KMSSynthesisPermutation" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.4/qiskit/transpiler/passes/synthesis/hls_plugins.py#L694-L707" signature="qiskit.transpiler.passes.synthesis.hls_plugins.KMSSynthesisPermutation" modifiers="class">
  ...
  <Function id="qiskit.transpiler.passes.synthesis.hls_plugins.KMSSynthesisPermutation.run" github="https://github.com/Qiskit/qiskit/tree/stable/1.4/qiskit/transpiler/passes/synthesis/hls_plugins.py#L701-L707" signature="run(high_level_object, coupling_map=None, target=None, qubits=None, **options)">
