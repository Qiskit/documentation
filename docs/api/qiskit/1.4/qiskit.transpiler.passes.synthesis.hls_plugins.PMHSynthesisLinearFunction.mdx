---
title: PMHSynthesisLinearFunction (v1.4)
description: API reference for qiskit.transpiler.passes.synthesis.hls_plugins.PMHSynthesisLinearFunction in qiskit v1.4
...
<Class id="qiskit.transpiler.passes.synthesis.hls_plugins.PMHSynthesisLinearFunction" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.4/qiskit/transpiler/passes/synthesis/hls_plugins.py#L645-L691" signature="qiskit.transpiler.passes.synthesis.hls_plugins.PMHSynthesisLinearFunction" modifiers="class">
  ...
  **References**
  ...
  <Function id="qiskit.transpiler.passes.synthesis.hls_plugins.PMHSynthesisLinearFunction.run" github="https://github.com/Qiskit/qiskit/tree/stable/1.4/qiskit/transpiler/passes/synthesis/hls_plugins.py#L668-L691" signature="run(high_level_object, coupling_map=None, target=None, qubits=None, **options)">
