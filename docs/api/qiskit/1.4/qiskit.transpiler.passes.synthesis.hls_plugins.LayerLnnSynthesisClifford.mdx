---
title: LayerLnnSynthesisClifford (v1.4)
description: API reference for qiskit.transpiler.passes.synthesis.hls_plugins.LayerLnnSynthesisClifford in qiskit v1.4
