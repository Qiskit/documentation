...
![Output from the previous code.](/docs/images/api/qiskit/1.4/visualization-1.avif)
...
![Output from the previous code.](/docs/images/api/qiskit/1.4/visualization-2.avif)
...
![Output from the previous code.](/docs/images/api/qiskit/1.4/visualization-3.avif)
...
![Output from the previous code.](/docs/images/api/qiskit/1.4/visualization-4.avif)
...
![Output from the previous code.](/docs/images/api/qiskit/1.4/visualization-5.avif)
...
![Output from the previous code.](/docs/images/api/qiskit/1.4/visualization-6.avif)
