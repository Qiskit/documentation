...
<Class id="qiskit.transpiler.passes.RZXCalibrationBuilderNoEcho" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.4/qiskit/transpiler/passes/calibration/rzx_builder.py#L252-L318" signature="qiskit.transpiler.passes.RZXCalibrationBuilderNoEcho(*args, **kwargs)" modifiers="class">
  ...
  <Admonition title="Deprecated since version 1.3" type="danger">
    The class `qiskit.transpiler.passes.calibration.rzx_builder.RZXCalibrationBuilder` is deprecated as of Qiskit 1.3. It will be removed in Qiskit 2.0. The entire Qiskit Pulse package has been deprecated. Once removed, `qiskit.transpiler.passes.calibration.rzx_builder.RZXCalibrationBuilder` will have no alternative in Qiskit.
  </Admonition>
  ...
  **Raises**
  ...
  <Function id="qiskit.transpiler.passes.RZXCalibrationBuilderNoEcho.get_calibration" github="https://github.com/Qiskit/qiskit/tree/stable/1.4/qiskit/transpiler/passes/calibration/rzx_builder.py#L266-L318" signature="get_calibration(node_op, qubits)">
    ...
    *   **qubits** ([*list*](https://docs.python.org/3/library/stdtypes.html#list "(in Python v3.14)")) – List of qubits for which to get the schedules. The first qubit is the control and the second is the target.
  ...
  <Function id="qiskit.transpiler.passes.RZXCalibrationBuilderNoEcho.rescale_cr_inst" github="https://github.com/Qiskit/qiskit/tree/stable/1.4/qiskit/transpiler/passes/calibration/rzx_builder.py#L112-L165" signature="rescale_cr_inst(instruction, theta, sample_mult=16)" modifiers="static">
    ...
    *   **theta** ([*float*](https://docs.python.org/3/library/functions.html#float "(in Python v3.14)")) – desired angle, pi/2 is assumed to be the angle that the pulse in the given play instruction implements.
    *   **sample\_mult** ([*int*](https://docs.python.org/3/library/functions.html#int "(in Python v3.14)")) – All pulses must be a multiple of sample\_mult.
  ...
  <Function id="qiskit.transpiler.passes.RZXCalibrationBuilderNoEcho.supported" github="https://github.com/Qiskit/qiskit/tree/stable/1.4/qiskit/transpiler/passes/calibration/rzx_builder.py#L98-L110" signature="supported(node_op, qubits)">
    ...
    *   **qubits** ([*list*](https://docs.python.org/3/library/stdtypes.html#list "(in Python v3.14)")) – Integer qubit indices to check.
