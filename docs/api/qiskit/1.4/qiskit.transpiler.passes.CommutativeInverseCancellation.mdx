---
title: CommutativeInverseCancellation (v1.4)
description: API reference for qiskit.transpiler.passes.CommutativeInverseCancellation in qiskit v1.4
...
<Class id="qiskit.transpiler.passes.CommutativeInverseCancellation" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.4/qiskit/transpiler/passes/optimization/commutative_inverse_cancellation.py#L22-L140" signature="qiskit.transpiler.passes.CommutativeInverseCancellation(*args, **kwargs)" modifiers="class">
  ...
  *   **max\_qubits** – Limits the number of qubits in matrix-based commutativity and inverse checks.
  ...
  <Function id="qiskit.transpiler.passes.CommutativeInverseCancellation.execute" github="https://github.com/Qiskit/qiskit/tree/stable/1.4/qiskit/transpiler/basepasses.py#L189-L211" signature="execute(passmanager_ir, state, callback=None)">
  ...
  <Function id="qiskit.transpiler.passes.CommutativeInverseCancellation.name" github="https://github.com/Qiskit/qiskit/tree/stable/1.4/qiskit/passmanager/base_tasks.py#L68-L70" signature="name()">
    Name of the pass.
  ...
  <Function id="qiskit.transpiler.passes.CommutativeInverseCancellation.run" github="https://github.com/Qiskit/qiskit/tree/stable/1.4/qiskit/transpiler/passes/optimization/commutative_inverse_cancellation.py#L81-L140" signature="run(dag)">
  ...
  <Function id="qiskit.transpiler.passes.CommutativeInverseCancellation.update_status" github="https://github.com/Qiskit/qiskit/tree/stable/1.4/qiskit/transpiler/basepasses.py#L213-L221" signature="update_status(state, run_state)">
