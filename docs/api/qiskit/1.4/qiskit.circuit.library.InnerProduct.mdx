---
title: InnerProduct (v1.4)
description: API reference for qiskit.circuit.library.InnerProduct in qiskit v1.4
...
<Class id="qiskit.circuit.library.InnerProduct" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.4/qiskit/circuit/library/boolean_logic/inner_product.py#L21-L85" signature="qiskit.circuit.library.InnerProduct(num_qubits)" modifiers="class">
...
$$
  ...
  **Reference Circuit:**
  ...
  ![Diagram illustrating the previously described circuit.](/docs/images/api/qiskit/1.4/qiskit-circuit-library-InnerProduct-1.avif)
