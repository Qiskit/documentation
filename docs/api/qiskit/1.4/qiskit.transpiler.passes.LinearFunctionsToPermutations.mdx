---
title: LinearFunctionsToPermutations (v1.4)
description: API reference for qiskit.transpiler.passes.LinearFunctionsToPermutations in qiskit v1.4
...
<Class id="qiskit.transpiler.passes.LinearFunctionsToPermutations" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.4/qiskit/transpiler/passes/synthesis/linear_functions_synthesis.py#L22-L41" signature="qiskit.transpiler.passes.LinearFunctionsToPermutations(*args, **kwargs)" modifiers="class">
  ...
  <Function id="qiskit.transpiler.passes.LinearFunctionsToPermutations.execute" github="https://github.com/Qiskit/qiskit/tree/stable/1.4/qiskit/transpiler/basepasses.py#L189-L211" signature="execute(passmanager_ir, state, callback=None)">
  ...
  <Function id="qiskit.transpiler.passes.LinearFunctionsToPermutations.name" github="https://github.com/Qiskit/qiskit/tree/stable/1.4/qiskit/passmanager/base_tasks.py#L68-L70" signature="name()">
    Name of the pass.
  ...
  <Function id="qiskit.transpiler.passes.LinearFunctionsToPermutations.run" github="https://github.com/Qiskit/qiskit/tree/stable/1.4/qiskit/transpiler/passes/synthesis/linear_functions_synthesis.py#L25-L41" signature="run(dag)">
  ...
  <Function id="qiskit.transpiler.passes.LinearFunctionsToPermutations.update_status" github="https://github.com/Qiskit/qiskit/tree/stable/1.4/qiskit/transpiler/basepasses.py#L213-L221" signature="update_status(state, run_state)">
