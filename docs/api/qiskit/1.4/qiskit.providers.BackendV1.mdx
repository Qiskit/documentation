...
<Class id="qiskit.providers.BackendV1" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.4/qiskit/providers/backend.py#L42-L246" signature="qiskit.providers.BackendV1(configuration, provider=None, **fields)" modifiers="class">
  ...
  **Raises**
  ...
  [**AttributeError**](https://docs.python.org/3/library/exceptions.html#AttributeError) – if input field not a valid options
