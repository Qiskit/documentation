---
title: PhaseEstimation (v1.4)
description: API reference for qiskit.circuit.library.PhaseEstimation in qiskit v1.4
...
$$
  ...
  **Reference Circuit:**
  ...
  ![Diagram illustrating the previously described circuit.](/docs/images/api/qiskit/1.4/qiskit-circuit-library-PhaseEstimation-1.avif)
