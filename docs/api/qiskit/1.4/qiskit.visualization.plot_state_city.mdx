...
<Function id="qiskit.visualization.plot_state_city" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.4/qiskit/visualization/state_visualization.py#L365-L615" signature="qiskit.visualization.plot_state_city(state, title='', figsize=None, color=None, alpha=1, ax_real=None, ax_imag=None, *, filename=None)">
  ...
  **Examples**
  ...
  ![Output from the previous code.](/docs/images/api/qiskit/1.4/qiskit-visualization-plot_state_city-1.avif)
  ...
  ![Output from the previous code.](/docs/images/api/qiskit/1.4/qiskit-visualization-plot_state_city-2.avif)
</Function>
