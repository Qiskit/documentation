...
$$
  ...
  **Examples**
  ...
  ![Circuit diagram output by the previous code.](/images/api/qiskit/1.4/qiskit-circuit-library-hamiltonian_variational_ansatz-1.avif)
  ...
  ![Circuit diagram output by the previous code.](/images/api/qiskit/1.4/qiskit-circuit-library-hamiltonian_variational_ansatz-2.avif)
