...
<Class id="qiskit.circuit.library.quantum_volume" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.4/qiskit/circuit/library/quantum_volume.py#L133-L171" signature="qiskit.circuit.library.quantum_volume(num_qubits, depth=None, seed=None)" modifiers="class">
  ...
  *   **depth** ([*int*](https://docs.python.org/3/library/functions.html#int "(in Python v3.14)") *| None*) –
  *   **seed** ([*int*](https://docs.python.org/3/library/functions.html#int "(in Python v3.14)") *| np.random.Generator | None*) –
