---
title: plot_circuit_layout (v1.4)
description: API reference for qiskit.visualization.plot_circuit_layout in qiskit v1.4
...
<Function id="qiskit.visualization.plot_circuit_layout" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.4/qiskit/visualization/gate_map.py#L1161-L1283" signature="qiskit.visualization.plot_circuit_layout(circuit, backend, view='virtual', qubit_coordinates=None)">
  ...
  <Admonition title="Deprecated since version 1.4" type="danger">
    The function `plot_circuit_layout` will stop supporting inputs of type [`BackendV1`](qiskit.providers.BackendV1 "qiskit.providers.BackendV1") in the backend parameter in a future release no earlier than 2.0. [`BackendV1`](qiskit.providers.BackendV1 "qiskit.providers.BackendV1") is deprecated and implementations should move to [`BackendV2`](qiskit.providers.BackendV2 "qiskit.providers.BackendV2").
  </Admonition>
  ...
  **Example**
  ...
  ![Output from the previous code.](/docs/images/api/qiskit/1.4/qiskit-visualization-plot_circuit_layout-1.avif)
</Function>
