---
title: SabreLayout (v1.4)
description: API reference for qiskit.transpiler.passes.SabreLayout in qiskit v1.4
...
<Class id="qiskit.transpiler.passes.SabreLayout" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.4/qiskit/transpiler/passes/layout/sabre_layout.py#L47-L481" signature="qiskit.transpiler.passes.SabreLayout(*args, **kwargs)" modifiers="class">
  ...
  **raises both `routing_pass` and `layout_trials` are specified**
  ...
  <Function id="qiskit.transpiler.passes.SabreLayout.execute" github="https://github.com/Qiskit/qiskit/tree/stable/1.4/qiskit/transpiler/basepasses.py#L189-L211" signature="execute(passmanager_ir, state, callback=None)">
  ...
  <Function id="qiskit.transpiler.passes.SabreLayout.name" github="https://github.com/Qiskit/qiskit/tree/stable/1.4/qiskit/passmanager/base_tasks.py#L68-L70" signature="name()">
    Name of the pass.
  ...
  <Function id="qiskit.transpiler.passes.SabreLayout.run" github="https://github.com/Qiskit/qiskit/tree/stable/1.4/qiskit/transpiler/passes/layout/sabre_layout.py#L197-L378" signature="run(dag)">
  ...
  <Function id="qiskit.transpiler.passes.SabreLayout.update_status" github="https://github.com/Qiskit/qiskit/tree/stable/1.4/qiskit/transpiler/basepasses.py#L213-L221" signature="update_status(state, run_state)">
