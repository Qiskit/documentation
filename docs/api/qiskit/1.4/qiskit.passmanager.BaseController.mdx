---
title: BaseController (v1.4)
description: API reference for qiskit.passmanager.BaseController in qiskit v1.4
...
<Class id="qiskit.passmanager.BaseController" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.4/qiskit/passmanager/base_tasks.py#L156-L230" signature="qiskit.passmanager.BaseController(options=None)" modifiers="class">
  ...
  **options** ([*dict*](https://docs.python.org/3/library/stdtypes.html#dict)*\[*[*str*](https://docs.python.org/3/library/stdtypes.html#str)*, Any] | None*) – Option for this flow controller.
  ...
  <Function id="qiskit.passmanager.BaseController.execute" github="https://github.com/Qiskit/qiskit/tree/stable/1.4/qiskit/passmanager/base_tasks.py#L202-L230" signature="execute(passmanager_ir, state, callback=None)">
  ...
  <Function id="qiskit.passmanager.BaseController.iter_tasks" github="https://github.com/Qiskit/qiskit/tree/stable/1.4/qiskit/passmanager/base_tasks.py#L176-L200" signature="iter_tasks(state)" modifiers="abstract">
