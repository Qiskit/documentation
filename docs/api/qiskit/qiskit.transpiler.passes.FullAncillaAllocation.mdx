...
<Class id="qiskit.transpiler.passes.FullAncillaAllocation" github="https://github.com/Qiskit/qiskit/tree/stable/1.0/qiskit/transpiler/passes/layout/full_ancilla_allocation.py#L21-L117" signature="qiskit.transpiler.passes.FullAncillaAllocation(*args, **kwargs)">
