...
<Class id="qiskit.transpiler.passes.FullAncillaAllocation" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.4/qiskit/transpiler/passes/layout/full_ancilla_allocation.py#L21-L117" signature="qiskit.transpiler.passes.FullAncillaAllocation(*args, **kwargs)" modifiers="class">
  ...
  **coupling\_map** (*Union\[*[*CouplingMap*](qiskit.transpiler.CouplingMap "qiskit.transpiler.CouplingMap")*,* [*Target*](qiskit.transpiler.Target "qiskit.transpiler.Target")*]*) – directed graph representing a coupling map.
  ...
  <Function id="qiskit.transpiler.passes.FullAncillaAllocation.execute" github="https://github.com/Qiskit/qiskit/tree/stable/1.4/qiskit/passmanager/base_tasks.py#L72-L118" signature="execute(passmanager_ir, state, callback=None)">
  ...
  <Function id="qiskit.transpiler.passes.FullAncillaAllocation.name" github="https://github.com/Qiskit/qiskit/tree/stable/1.4/qiskit/passmanager/base_tasks.py#L68-L70" signature="name()">
    Name of the pass.
  ...
  <Function id="qiskit.transpiler.passes.FullAncillaAllocation.run" github="https://github.com/Qiskit/qiskit/tree/stable/1.4/qiskit/transpiler/passes/layout/full_ancilla_allocation.py#L50-L105" signature="run(dag)">
  ...
  <Function id="qiskit.transpiler.passes.FullAncillaAllocation.update_status" github="https://github.com/Qiskit/qiskit/tree/stable/1.4/qiskit/passmanager/base_tasks.py#L120-L138" signature="update_status(state, run_state)">
  ...
  <Function id="qiskit.transpiler.passes.FullAncillaAllocation.validate_layout" github="https://github.com/Qiskit/qiskit/tree/stable/1.4/qiskit/transpiler/passes/layout/full_ancilla_allocation.py#L107-L117" signature="validate_layout(layout_qubits, dag_qubits)" modifiers="static">
