---
title: synth_permutation_basic (v0.42)
description: API reference for qiskit.synthesis.synth_permutation_basic in qiskit v0.42
...
<Function id="qiskit.synthesis.synth_permutation_basic" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/synthesis/permutation/permutation_full.py" signature="synth_permutation_basic(pattern)">
