...
<Function id="qiskit.synthesis.synth_permutation_acg" github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/synthesis/permutation/permutation_full.py" signature="synth_permutation_acg(pattern)">
