---
title: BaseEstimatorGradient (v0.42)
description: API reference for qiskit.algorithms.gradients.BaseEstimatorGradient in qiskit v0.42
...
<Class id="qiskit.algorithms.gradients.BaseEstimatorGradient" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/algorithms/gradients/base_estimator_gradient.py" signature="BaseEstimatorGradient(estimator, options=None, derivative_type=DerivativeType.REAL)" modifiers="class">
  Bases: `abc.ABC`
  ...
  *   **derivative\_type** ([*DerivativeType*](qiskit.algorithms.gradients.DerivativeType "qiskit.algorithms.gradients.DerivativeType")) –
  ...
  <Attribute id="qiskit.algorithms.gradients.BaseEstimatorGradient.derivative_type">
