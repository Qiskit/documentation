...
<Class id="qiskit_aer.PulseSimulator" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-aer/tree/stable/0.12/qiskit_aer/backends/pulse_simulator.py" signature="PulseSimulator(configuration=None, properties=None, defaults=None, provider=None, **backend_options)">
  ...
  **Raises**
  ...
  <Function id="qiskit_aer.PulseSimulator.clear_options" name="clear_options" signature="PulseSimulator.clear_options()">
    Reset the simulator options to default values.
  </Function>

  ### configuration

  <Function id="qiskit_aer.PulseSimulator.configuration" name="configuration" signature="PulseSimulator.configuration()">
  ...
  <Function id="qiskit_aer.PulseSimulator.defaults" name="defaults" signature="PulseSimulator.defaults()">
  ...
  <Function id="qiskit_aer.PulseSimulator.from_backend" name="from_backend" signature="classmethod PulseSimulator.from_backend(backend, **options)">
    Initialize simulator from backend.
  </Function>

  ### name

  <Function id="qiskit_aer.PulseSimulator.name" name="name" signature="PulseSimulator.name()">
  ...
  <Function id="qiskit_aer.PulseSimulator.properties" name="properties" signature="PulseSimulator.properties()">
  ...
  <Function id="qiskit_aer.PulseSimulator.provider" name="provider" signature="PulseSimulator.provider()">
  ...
  <Function id="qiskit_aer.PulseSimulator.run" name="run" signature="PulseSimulator.run(schedules, validate=True, **run_options)">
  ...
  <Function id="qiskit_aer.PulseSimulator.set_option" name="set_option" signature="PulseSimulator.set_option(key, value)">
    Set pulse simulation options and update backend.
  </Function>

  ### set\_options

  <Function id="qiskit_aer.PulseSimulator.set_options" name="set_options" signature="PulseSimulator.set_options(**fields)">
    Set the simulator options
  </Function>

  ### status

  <Function id="qiskit_aer.PulseSimulator.status" name="status" signature="PulseSimulator.status()">
  ...
  <Attribute id="qiskit_aer.PulseSimulator.options" name="options">
  ...
  <Attribute id="qiskit_aer.PulseSimulator.version" name="version" attributeValue="1" />
</Class>
