---
title: IBMExperimentService (v0.42)
description: API reference for qiskit.providers.ibmq.experiment.IBMExperimentService in qiskit v0.42
...
<Class id="qiskit.providers.ibmq.experiment.IBMExperimentService" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-ibmq-provider/tree/stable/0.20/qiskit/providers/ibmq/experiment/ibm_experiment_service.py" signature="IBMExperimentService(provider)" modifiers="class">
  Bases: `object`
