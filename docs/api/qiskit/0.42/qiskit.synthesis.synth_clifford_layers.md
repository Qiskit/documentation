...
`synth_clifford_layers(cliff, cx_synth_func=<function _default_cx_synth_func>, cz_synth_func=<function _default_cz_synth_func>, cx_cz_synth_func=None, validate=False)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.42/qiskit/synthesis/clifford/clifford_decompose_layers.py "view source code")
