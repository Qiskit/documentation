---
title: Qasm (v0.42)
description: API reference for qiskit.qasm.Qasm in qiskit v0.42
...
<Class id="qiskit.qasm.Qasm" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/qasm/qasm.py" signature="Qasm(filename=None, data=None)" modifiers="class">
  Bases: `object`
