...
<Function id="qiskit.pulse.builder.align_sequential" github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/pulse/builder.py" signature="align_sequential()">
