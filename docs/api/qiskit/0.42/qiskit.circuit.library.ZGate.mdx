---
title: ZGate (v0.42)
description: API reference for qiskit.circuit.library.ZGate in qiskit v0.42
...
<Class id="qiskit.circuit.library.ZGate" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/circuit/library/standard_gates/z.py" signature="ZGate(label=None)" modifiers="class">
