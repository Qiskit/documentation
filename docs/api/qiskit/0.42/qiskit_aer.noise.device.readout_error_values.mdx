...
<Function id="qiskit_aer.noise.device.readout_error_values" github="https://github.com/qiskit/qiskit-aer/tree/stable/0.12/qiskit_aer/noise/device/parameters.py" signature="readout_error_values(properties)">
