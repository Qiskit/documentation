---
title: readout_error_values (v0.42)
description: API reference for qiskit_aer.noise.device.readout_error_values in qiskit v0.42
in_page_toc_min_heading_level: 1
python_api_type: function
python_api_name: qiskit_aer.noise.device.readout_error_values
---

<span id="qiskit-aer-noise-device-readout-error-values" />

# qiskit\_aer.noise.device.readout\_error\_values

<Function id="qiskit_aer.noise.device.readout_error_values" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-aer/tree/stable/0.12/qiskit_aer/noise/device/parameters.py" signature="readout_error_values(properties)">
