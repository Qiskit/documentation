...
<Function id="qiskit.quantum_info.partial_trace" github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/quantum_info/states/utils.py" signature="partial_trace(state, qargs)">
