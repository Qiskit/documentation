---
title: Options (v0.42)
description: API reference for qiskit.providers.Options in qiskit v0.42
...
<Class id="qiskit.providers.Options" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/providers/options.py" signature="Options(**kwargs)" modifiers="class">
  Bases: `object`
