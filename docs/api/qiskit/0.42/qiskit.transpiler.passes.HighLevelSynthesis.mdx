---
title: HighLevelSynthesis (v0.42)
description: API reference for qiskit.transpiler.passes.HighLevelSynthesis in qiskit v0.42
...
<Class id="qiskit.transpiler.passes.HighLevelSynthesis" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/transpiler/passes/synthesis/high_level_synthesis.py" signature="HighLevelSynthesis(*args, **kwargs)" modifiers="class">
