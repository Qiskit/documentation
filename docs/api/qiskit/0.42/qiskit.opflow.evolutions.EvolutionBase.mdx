...
<Class id="qiskit.opflow.evolutions.EvolutionBase" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/opflow/evolutions/evolution_base.py" signature="EvolutionBase">
  ...
  <Function id="qiskit.opflow.evolutions.EvolutionBase.convert" name="convert" signature="abstract EvolutionBase.convert(operator)">
