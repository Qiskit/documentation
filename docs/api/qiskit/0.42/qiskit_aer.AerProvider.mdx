...
<Class id="qiskit_aer.AerProvider" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-aer/tree/stable/0.12/qiskit_aer/aerprovider.py" signature="AerProvider">
