---
title: plot_bloch_vector (v0.42)
description: API reference for qiskit.visualization.plot_bloch_vector in qiskit v0.42
...
<Function id="qiskit.visualization.plot_bloch_vector" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/visualization/state_visualization.py" signature="plot_bloch_vector(bloch, title='', ax=None, figsize=None, coord_type='cartesian')">
  ...
  **Examples**
  ...
  ![../\_images/qiskit-visualization-plot\_bloch\_vector-1.png](/docs/images/api/qiskit/0.42/qiskit-visualization-plot_bloch_vector-1.avif)
  ...
  ![../\_images/qiskit-visualization-plot\_bloch\_vector-2.png](/docs/images/api/qiskit/0.42/qiskit-visualization-plot_bloch_vector-2.avif)
</Function>
