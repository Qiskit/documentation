---
title: InverseCancellation (v0.42)
description: API reference for qiskit.transpiler.passes.InverseCancellation in qiskit v0.42
...
<Class id="qiskit.transpiler.passes.InverseCancellation" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/transpiler/passes/optimization/inverse_cancellation.py" signature="InverseCancellation(gates_to_cancel)" modifiers="class">
