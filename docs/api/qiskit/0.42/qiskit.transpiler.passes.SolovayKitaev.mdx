---
title: SolovayKitaev (v0.42)
description: API reference for qiskit.transpiler.passes.SolovayKitaev in qiskit v0.42
...
<Class id="qiskit.transpiler.passes.SolovayKitaev" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/transpiler/passes/synthesis/solovay_kitaev_synthesis.py" signature="SolovayKitaev(*args, **kwargs)" modifiers="class">
