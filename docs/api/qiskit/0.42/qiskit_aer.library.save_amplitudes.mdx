...
<Function id="qiskit_aer.library.save_amplitudes" github="https://github.com/qiskit/qiskit-aer/tree/stable/0.12/qiskit_aer/library/save_instructions/save_amplitudes.py" signature="save_amplitudes(self, params, label='amplitudes', pershot=False, conditional=False)">
