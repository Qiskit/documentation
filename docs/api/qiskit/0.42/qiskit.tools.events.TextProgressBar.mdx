...
<Class id="qiskit.tools.events.TextProgressBar" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/tools/events/progressbar.py" signature="TextProgressBar(output_handler=None)">
