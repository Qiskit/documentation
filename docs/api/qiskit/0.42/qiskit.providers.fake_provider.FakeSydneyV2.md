...
<span id="qiskit.providers.fake_provider.FakeSydneyV2" />

`FakeSydneyV2`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.42/qiskit/providers/fake_provider/backends/sydney/fake_sydney.py "view source code")
...
<span id="qiskit.providers.fake_provider.FakeSydneyV2.acquire_channel" />

`FakeSydneyV2.acquire_channel(qubit)`
...
<span id="qiskit.providers.fake_provider.FakeSydneyV2.control_channel" />

`FakeSydneyV2.control_channel(qubits)`
...
<span id="qiskit.providers.fake_provider.FakeSydneyV2.drive_channel" />

`FakeSydneyV2.drive_channel(qubit)`
...
<span id="qiskit.providers.fake_provider.FakeSydneyV2.measure_channel" />

`FakeSydneyV2.measure_channel(qubit)`
...
<span id="qiskit.providers.fake_provider.FakeSydneyV2.qubit_properties" />

`FakeSydneyV2.qubit_properties(qubit)`
...
<span id="qiskit.providers.fake_provider.FakeSydneyV2.run" />

`FakeSydneyV2.run(run_input, **options)`
...
<span id="qiskit.providers.fake_provider.FakeSydneyV2.set_options" />

`FakeSydneyV2.set_options(**fields)`
...
<span id="qiskit.providers.fake_provider.FakeSydneyV2.backend_name" />

### backend\_name

`= 'fake_sydney_v2'`

<span id="qiskit.providers.fake_provider.FakeSydneyV2.conf_filename" />

### conf\_filename

`= 'conf_sydney.json'`

<span id="qiskit.providers.fake_provider.FakeSydneyV2.coupling_map" />

### coupling\_map

Return the [`CouplingMap`](qiskit.transpiler.CouplingMap "qiskit.transpiler.CouplingMap") object

<span id="qiskit.providers.fake_provider.FakeSydneyV2.defs_filename" />

### defs\_filename

`= 'defs_sydney.json'`

<span id="qiskit.providers.fake_provider.FakeSydneyV2.dirname" />

### dirname

`= '/home/runner/work/qiskit/qiskit/.tox/docs/lib/python3.8/site-packages/qiskit/providers/fake_provider/backends/sydney'`

<span id="qiskit.providers.fake_provider.FakeSydneyV2.dt" />
...
<span id="qiskit.providers.fake_provider.FakeSydneyV2.dtm" />
...
<span id="qiskit.providers.fake_provider.FakeSydneyV2.instruction_durations" />

### instruction\_durations

Return the [`InstructionDurations`](qiskit.transpiler.InstructionDurations "qiskit.transpiler.InstructionDurations") object.

<span id="qiskit.providers.fake_provider.FakeSydneyV2.instruction_schedule_map" />
...
<span id="qiskit.providers.fake_provider.FakeSydneyV2.instructions" />
...
<span id="qiskit.providers.fake_provider.FakeSydneyV2.max_circuits" />

### max\_circuits

<span id="qiskit.providers.fake_provider.FakeSydneyV2.meas_map" />
...
<span id="qiskit.providers.fake_provider.FakeSydneyV2.num_qubits" />
...
<span id="qiskit.providers.fake_provider.FakeSydneyV2.operation_names" />
...
<span id="qiskit.providers.fake_provider.FakeSydneyV2.operations" />
...
<span id="qiskit.providers.fake_provider.FakeSydneyV2.options" />
...
<span id="qiskit.providers.fake_provider.FakeSydneyV2.props_filename" />

### props\_filename

`= 'props_sydney.json'`

<span id="qiskit.providers.fake_provider.FakeSydneyV2.provider" />
...
<span id="qiskit.providers.fake_provider.FakeSydneyV2.target" />
...
<span id="qiskit.providers.fake_provider.FakeSydneyV2.version" />
