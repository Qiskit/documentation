...
<Function id="qiskit_aer.noise.pauli_error" github="https://github.com/qiskit/qiskit-aer/tree/stable/0.12/qiskit_aer/noise/errors/standard_errors.py" signature="pauli_error(noise_ops)">
