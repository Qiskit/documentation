---
title: save_probabilities (v0.42)
description: API reference for qiskit_aer.library.save_probabilities in qiskit v0.42
in_page_toc_min_heading_level: 1
python_api_type: function
python_api_name: qiskit_aer.library.save_probabilities
---

<span id="qiskit-aer-library-save-probabilities" />

# qiskit\_aer.library.save\_probabilities

<Function id="qiskit_aer.library.save_probabilities" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-aer/tree/stable/0.12/qiskit_aer/library/save_instructions/save_probabilities.py" signature="save_probabilities(self, qubits=None, label='probabilities', unnormalized=False, pershot=False, conditional=False)">
