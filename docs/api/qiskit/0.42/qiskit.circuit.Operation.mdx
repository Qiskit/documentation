---
title: Operation (v0.42)
description: API reference for qiskit.circuit.Operation in qiskit v0.42
...
<Class id="qiskit.circuit.Operation" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/circuit/operation.py" signature="Operation" modifiers="class">
  ...
  **Example**
  ...
  ![../\_images/qiskit-circuit-Operation-1.png](/docs/images/api/qiskit/0.42/qiskit-circuit-Operation-1.avif)
