---
title: LinearSolver (v0.42)
description: API reference for qiskit.algorithms.linear_solvers.LinearSolver in qiskit v0.42
...
<Class id="qiskit.algorithms.linear_solvers.LinearSolver" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/algorithms/linear_solvers/linear_solver.py" signature="LinearSolver" modifiers="class">
  Bases: `abc.ABC`
  ...
  <span id="qiskit-algorithms-linear-solvers-linearsolver-solve" />
