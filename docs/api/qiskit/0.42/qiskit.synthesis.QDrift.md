...
`QDrift(reps=1, insert_barriers=False, cx_structure='chain', atomic_evolution=None)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.42/qiskit/synthesis/evolution/qdrift.py "view source code")
...
`QDrift.synthesize(evolution)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.42/qiskit/synthesis/evolution/qdrift.py "view source code")
