...
<Class id="qiskit.circuit.ClassicalRegister" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/circuit/classicalregister.py" signature="ClassicalRegister(size=None, name=None, bits=None)">
  ...
  *   **CircuitError** – if `bits` contained bits of an incorrect type.
  ...
  <Function id="qiskit.circuit.ClassicalRegister.index" name="index" signature="ClassicalRegister.index(bit)">
    Find the index of the provided bit within this register.
  </Function>

  ### qasm

  <Function id="qiskit.circuit.ClassicalRegister.qasm" name="qasm" signature="ClassicalRegister.qasm()">
  ...
  <Attribute id="qiskit.circuit.ClassicalRegister.instances_counter" name="instances_counter" attributeValue="count(6)" />

  ### name

  <Attribute id="qiskit.circuit.ClassicalRegister.name" name="name">
    Get the register name.
  </Attribute>

  ### name\_format

  <Attribute id="qiskit.circuit.ClassicalRegister.name_format" name="name_format" attributeValue="re.compile('[a-z][a-zA-Z0-9_]*')" />

  ### prefix

  <Attribute id="qiskit.circuit.ClassicalRegister.prefix" name="prefix" attributeValue="'c'" />

  ### size

  <Attribute id="qiskit.circuit.ClassicalRegister.size" name="size">
