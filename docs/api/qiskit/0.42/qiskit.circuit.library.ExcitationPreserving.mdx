---
title: ExcitationPreserving (v0.42)
description: API reference for qiskit.circuit.library.ExcitationPreserving in qiskit v0.42
...
$$
  ...
  **ValueError** – If the selected mode is not supported.
  ...
  <Attribute id="qiskit.circuit.library.ExcitationPreserving.instances" attributeValue="2051" />
