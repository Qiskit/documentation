...
`SolovayKitaev(*args, **kwargs)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.42/qiskit/transpiler/passes/synthesis/solovay_kitaev_synthesis.py "view source code")
...
`SolovayKitaev.run(dag)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.42/qiskit/transpiler/passes/synthesis/solovay_kitaev_synthesis.py "view source code")
