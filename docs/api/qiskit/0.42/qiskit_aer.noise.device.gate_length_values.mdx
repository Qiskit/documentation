---
title: gate_length_values (v0.42)
description: API reference for qiskit_aer.noise.device.gate_length_values in qiskit v0.42
...
<Function id="qiskit_aer.noise.device.gate_length_values" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-aer/tree/stable/0.12/qiskit_aer/noise/device/parameters.py" signature="gate_length_values(properties)">
