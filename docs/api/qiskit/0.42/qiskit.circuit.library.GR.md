...
`GR(num_qubits, theta, phi)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.42/qiskit/circuit/library/generalized_gates/gr.py "view source code")
...
![../\_images/qiskit-circuit-library-GR-1.png](/images/api/qiskit/0.42/qiskit-circuit-library-GR-1.png)
