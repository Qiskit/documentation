---
title: AerStatevector (v0.42)
description: API reference for qiskit_aer.quantum_info.AerStatevector in qiskit v0.42
...
<Class id="qiskit_aer.quantum_info.AerStatevector" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-aer/tree/stable/0.12/qiskit_aer/quantum_info/states/aer_statevector.py" signature="AerStatevector(data, dims=None, **configs)" modifiers="class">
  ...
  **Additional Information:**
  ...
  <Function id="qiskit_aer.quantum_info.AerStatevector.draw" signature="AerStatevector.draw(output=None, **drawer_args)">
    ...
    **Examples**
    ...
    ![../\_images/qiskit\_aer-quantum\_info-AerStatevector-draw-1.png](/docs/images/api/qiskit/0.42/qiskit_aer-quantum_info-AerStatevector-draw-1.avif)
  </Function>
