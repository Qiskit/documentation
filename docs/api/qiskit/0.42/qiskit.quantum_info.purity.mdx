---
title: purity (v0.42)
description: API reference for qiskit.quantum_info.purity in qiskit v0.42
...
<Function id="qiskit.quantum_info.purity" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/quantum_info/states/measures.py" signature="purity(state, validate=True)">
