...
<Function id="qiskit.pulse.builder.drive_channel" name="drive_channel" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/pulse/builder.py" signature="drive_channel(qubit)">
