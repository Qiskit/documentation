...
<Class id="qiskit_aer.primitives.Sampler" github="https://github.com/qiskit/qiskit-aer/tree/stable/0.12/qiskit_aer/primitives/sampler.py" signature="Sampler(*, backend_options=None, transpile_options=None, run_options=None, skip_transpilation=False)">
