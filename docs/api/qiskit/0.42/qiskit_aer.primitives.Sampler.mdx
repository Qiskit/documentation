...
<Class id="qiskit_aer.primitives.Sampler" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-aer/tree/stable/0.12/qiskit_aer/primitives/sampler.py" signature="Sampler(*, backend_options=None, transpile_options=None, run_options=None, skip_transpilation=False)">
  ...
  *   **skip\_transpilation** (*bool*) – if True, transpilation is skipped.
  ...
  <Function id="qiskit_aer.primitives.Sampler.close" name="close" signature="Sampler.close()">
    Close the session and free resources
  </Function>

  ### run

  <Function id="qiskit_aer.primitives.Sampler.run" name="run" signature="Sampler.run(circuits, parameter_values=None, **run_options)">
  ...
  <Function id="qiskit_aer.primitives.Sampler.set_options" name="set_options" signature="Sampler.set_options(**fields)">
  ...
  <Attribute id="qiskit_aer.primitives.Sampler.circuits" name="circuits">
  ...
  <Attribute id="qiskit_aer.primitives.Sampler.options" name="options">
  ...
  <Attribute id="qiskit_aer.primitives.Sampler.parameters" name="parameters">
