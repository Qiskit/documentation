---
title: Sampler (v0.42)
description: API reference for qiskit_aer.primitives.Sampler in qiskit v0.42
...
<Class id="qiskit_aer.primitives.Sampler" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-aer/tree/stable/0.12/qiskit_aer/primitives/sampler.py" signature="Sampler(*, backend_options=None, transpile_options=None, run_options=None, skip_transpilation=False)" modifiers="class">
  ...
  *   **skip\_transpilation** (*bool*) – if True, transpilation is skipped.
  ...
  <span id="qiskit-aer-primitives-sampler-close" />
  ...
  <span id="qiskit-aer-primitives-sampler-run" />
  ...
  <span id="qiskit-aer-primitives-sampler-set-options" />
