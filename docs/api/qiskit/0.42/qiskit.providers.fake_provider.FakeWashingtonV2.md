...
`FakeWashingtonV2`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.42/qiskit/providers/fake_provider/backends/washington/fake_washington.py "view source code")
...
`FakeWashingtonV2.acquire_channel(qubit)`
...
`FakeWashingtonV2.control_channel(qubits)`
...
`FakeWashingtonV2.drive_channel(qubit)`
...
`FakeWashingtonV2.measure_channel(qubit)`
...
`FakeWashingtonV2.qubit_properties(qubit)`
...
`FakeWashingtonV2.run(run_input, **options)`
...
`FakeWashingtonV2.set_options(**fields)`
...
`= '/home/runner/work/qiskit/qiskit/.tox/docs/lib/python3.8/site-packages/qiskit/providers/fake_provider/backends/washington'`
