---
title: MinimumEigensolver (v0.42)
description: API reference for qiskit.algorithms.minimum_eigensolvers.MinimumEigensolver in qiskit v0.42
...
<Class id="qiskit.algorithms.minimum_eigensolvers.MinimumEigensolver" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/algorithms/minimum_eigensolvers/minimum_eigensolver.py" signature="MinimumEigensolver" modifiers="class">
  Bases: `abc.ABC`
