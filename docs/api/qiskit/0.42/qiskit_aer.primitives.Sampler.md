...
`Sampler(*, backend_options=None, transpile_options=None, run_options=None, skip_transpilation=False)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.42/qiskit_aer/primitives/sampler.py "view source code")
...
`Sampler.close()`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.42/qiskit_aer/primitives/sampler.py "view source code")
