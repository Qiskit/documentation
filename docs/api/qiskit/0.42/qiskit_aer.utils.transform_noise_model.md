...
`transform_noise_model(noise_model, func)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.42/qiskit_aer/utils/noise_transformation.py "view source code")
