...
<Function id="qiskit.pulse.library.sawtooth" name="sawtooth" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/pulse/library/discrete.py" signature="sawtooth(duration, amp, freq=None, phase=0, name=None)">
...
$$
  ...
  **Example**
  ...
  ![../\_images/qiskit-pulse-library-sawtooth-1.png](/images/api/qiskit/0.42/qiskit-pulse-library-sawtooth-1.png)
