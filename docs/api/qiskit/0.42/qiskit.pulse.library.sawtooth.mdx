---
title: sawtooth (v0.42)
description: API reference for qiskit.pulse.library.sawtooth in qiskit v0.42
...
$$
  ...
  **Example**
  ...
  ![../\_images/qiskit-pulse-library-sawtooth-1.png](/docs/images/api/qiskit/0.42/qiskit-pulse-library-sawtooth-1.avif)
