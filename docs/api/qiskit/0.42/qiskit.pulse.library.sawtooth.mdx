...
<Function id="qiskit.pulse.library.sawtooth" github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/pulse/library/discrete.py" signature="sawtooth(duration, amp, freq=None, phase=0, name=None)">
