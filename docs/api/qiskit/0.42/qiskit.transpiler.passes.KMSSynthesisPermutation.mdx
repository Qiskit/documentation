...
<Class id="qiskit.transpiler.passes.KMSSynthesisPermutation" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/transpiler/passes/synthesis/high_level_synthesis.py" signature="KMSSynthesisPermutation">
  ...
  <Function id="qiskit.transpiler.passes.KMSSynthesisPermutation.run" name="run" signature="KMSSynthesisPermutation.run(high_level_object, **options)">
