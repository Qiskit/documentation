...
`FakeTokyo`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.42/qiskit/providers/fake_provider/backends/tokyo/fake_tokyo.py "view source code")
...
`FakeTokyo.properties()`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.42/qiskit/providers/fake_provider/backends/tokyo/fake_tokyo.py "view source code")
