---
title: ParameterVector (v0.42)
description: API reference for qiskit.circuit.ParameterVector in qiskit v0.42
...
<Class id="qiskit.circuit.ParameterVector" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/circuit/parametervector.py" signature="ParameterVector(name, length=0)" modifiers="class">
  Bases: `object`
