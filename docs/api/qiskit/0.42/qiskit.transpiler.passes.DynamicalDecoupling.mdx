---
title: DynamicalDecoupling (v0.42)
description: API reference for qiskit.transpiler.passes.DynamicalDecoupling in qiskit v0.42
...
<Class id="qiskit.transpiler.passes.DynamicalDecoupling" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/transpiler/passes/scheduling/dynamical_decoupling.py" signature="DynamicalDecoupling(*args, **kwargs)" modifiers="class">
  ...
  ![../\_images/qiskit-transpiler-passes-DynamicalDecoupling-1\_00.png](/docs/images/api/qiskit/0.42/qiskit-transpiler-passes-DynamicalDecoupling-1_00.avif)

  ![../\_images/qiskit-transpiler-passes-DynamicalDecoupling-1\_01.png](/docs/images/api/qiskit/0.42/qiskit-transpiler-passes-DynamicalDecoupling-1_01.avif)
