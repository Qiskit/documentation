...
`PhaseEstimation(num_evaluation_qubits, unitary, iqft=None, name='QPE')`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.42/qiskit/circuit/library/phase_estimation.py "view source code")
...
![../\_images/qiskit-circuit-library-PhaseEstimation-1.png](/images/api/qiskit/0.42/qiskit-circuit-library-PhaseEstimation-1.png)
