...
<Class id="qiskit.providers.ibmq.experiment.IBMExperimentError" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-ibmq-provider/tree/stable/0.20/qiskit/providers/ibmq/experiment/exceptions.py" signature="IBMExperimentError(*message)">
