...
<Class id="qiskit_aer.noise.NoiseModel" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-aer/tree/stable/0.12/qiskit_aer/noise/noise_model.py" signature="NoiseModel(basis_gates=None)">
  Bases: `object`
  ...
  **basis\_gates** (*list\[str] or None*) – Specify an initial basis\_gates for the noise model. If None a default value of \[‘id’, ‘rz’, ‘sx’, ‘cx’] is used (Default: None).
  ...
  <Function id="qiskit_aer.noise.NoiseModel.add_basis_gates" name="add_basis_gates" signature="NoiseModel.add_basis_gates(instructions)">
  ...
  <Function id="qiskit_aer.noise.NoiseModel.from_backend" name="from_backend" signature="classmethod NoiseModel.from_backend(backend, gate_error=True, readout_error=True, thermal_relaxation=True, temperature=0, gate_lengths=None, gate_length_units='ns', warnings=None)">
  ...
  <Function id="qiskit_aer.noise.NoiseModel.from_backend_properties" name="from_backend_properties" signature="classmethod NoiseModel.from_backend_properties(backend_properties, gate_error=True, readout_error=True, thermal_relaxation=True, temperature=0, gate_lengths=None, gate_length_units='ns', dt=None)">
