---
title: NoiseModel (v0.42)
description: API reference for qiskit_aer.noise.NoiseModel in qiskit v0.42
...
<Class id="qiskit_aer.noise.NoiseModel" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-aer/tree/stable/0.12/qiskit_aer/noise/noise_model.py" signature="NoiseModel(basis_gates=None)" modifiers="class">
  Bases: `object`
  ...
  **basis\_gates** (*list\[str] or None*) – Specify an initial basis\_gates for the noise model. If None a default value of \[‘id’, ‘rz’, ‘sx’, ‘cx’] is used (Default: None).
  ...
  <Function id="qiskit_aer.noise.NoiseModel.add_basis_gates" signature="NoiseModel.add_basis_gates(instructions)">
  ...
  <Function id="qiskit_aer.noise.NoiseModel.from_backend" signature="NoiseModel.from_backend(backend, gate_error=True, readout_error=True, thermal_relaxation=True, temperature=0, gate_lengths=None, gate_length_units='ns', warnings=None)" modifiers="classmethod">
  ...
  <span id="qiskit-aer-noise-noisemodel-from-backend-properties" />

  ### from\_backend\_properties

  <Function id="qiskit_aer.noise.NoiseModel.from_backend_properties" signature="NoiseModel.from_backend_properties(backend_properties, gate_error=True, readout_error=True, thermal_relaxation=True, temperature=0, gate_lengths=None, gate_length_units='ns', dt=None)" modifiers="classmethod">
