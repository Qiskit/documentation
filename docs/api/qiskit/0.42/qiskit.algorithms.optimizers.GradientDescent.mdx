...
<Class id="qiskit.algorithms.optimizers.GradientDescent" github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/algorithms/optimizers/gradient_descent.py" signature="GradientDescent(maxiter=100, learning_rate=0.01, tol=1e-07, callback=None, perturbation=None)">
  ...
  **ValueError** – If `learning_rate` is an array and its lenght is less than `maxiter`.
  ...
  <Function id="qiskit.algorithms.optimizers.GradientDescent.gradient_num_diff" signature="static GradientDescent.gradient_num_diff(x_center, f, epsilon, max_evals_grouped=None)">
  ...
  <Function id="qiskit.algorithms.optimizers.GradientDescent.wrap_function" signature="static GradientDescent.wrap_function(function, args)">
