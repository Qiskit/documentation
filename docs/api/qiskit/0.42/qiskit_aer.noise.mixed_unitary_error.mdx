...
<Function id="qiskit_aer.noise.mixed_unitary_error" github="https://github.com/qiskit/qiskit-aer/tree/stable/0.12/qiskit_aer/noise/errors/standard_errors.py" signature="mixed_unitary_error(noise_ops)">
