---
title: mixed_unitary_error (v0.42)
description: API reference for qiskit_aer.noise.mixed_unitary_error in qiskit v0.42
in_page_toc_min_heading_level: 1
python_api_type: function
python_api_name: qiskit_aer.noise.mixed_unitary_error
---

<span id="qiskit-aer-noise-mixed-unitary-error" />
