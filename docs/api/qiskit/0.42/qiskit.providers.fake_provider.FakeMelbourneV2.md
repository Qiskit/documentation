...
`FakeMelbourneV2`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.42/qiskit/providers/fake_provider/backends/melbourne/fake_melbourne.py "view source code")
...
`= '/home/runner/work/qiskit/qiskit/.tox/docs/lib/python3.8/site-packages/qiskit/providers/fake_provider/backends/melbourne'`

<span id="qiskit.providers.fake_provider.FakeMelbourneV2.dt" />
