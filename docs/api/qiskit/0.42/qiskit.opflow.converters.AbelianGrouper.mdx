...
<Class id="qiskit.opflow.converters.AbelianGrouper" github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/opflow/converters/abelian_grouper.py" signature="AbelianGrouper(traverse=True)">
