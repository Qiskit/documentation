---
title: block_to_dag (v0.42)
description: API reference for qiskit.pulse.transforms.block_to_dag in qiskit v0.42
...
<Function id="qiskit.pulse.transforms.block_to_dag" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/pulse/transforms/dag.py" signature="block_to_dag(block)">
