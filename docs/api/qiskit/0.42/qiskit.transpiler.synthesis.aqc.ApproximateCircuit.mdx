---
title: ApproximateCircuit (v0.42)
description: API reference for qiskit.transpiler.synthesis.aqc.ApproximateCircuit in qiskit v0.42
...
<Class id="qiskit.transpiler.synthesis.aqc.ApproximateCircuit" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/transpiler/synthesis/aqc/approximate.py" signature="ApproximateCircuit(num_qubits, name=None)" modifiers="class">
  ...
  *   **name** (`Optional`\[`str`]) – a name of the circuit.
  ...
  <Attribute id="qiskit.transpiler.synthesis.aqc.ApproximateCircuit.instances" attributeValue="2497" />
