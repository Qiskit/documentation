---
title: GRY (v0.42)
description: API reference for qiskit.circuit.library.GRY in qiskit v0.42
...
$$
  ...
  **Expanded Circuit:**
  ...
  ![../\_images/qiskit-circuit-library-GRY-1.png](/docs/images/api/qiskit/0.42/qiskit-circuit-library-GRY-1.avif)
