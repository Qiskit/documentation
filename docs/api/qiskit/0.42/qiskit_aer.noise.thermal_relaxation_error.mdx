...
<Function id="qiskit_aer.noise.thermal_relaxation_error" github="https://github.com/qiskit/qiskit-aer/tree/stable/0.12/qiskit_aer/noise/errors/standard_errors.py" signature="thermal_relaxation_error(t1, t2, time, excited_state_population=0)">
