---
title: insert_noise (v0.42)
description: API reference for qiskit_aer.utils.insert_noise in qiskit v0.42
...
<Function id="qiskit_aer.utils.insert_noise" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-aer/tree/stable/0.12/qiskit_aer/utils/noise_model_inserter.py" signature="insert_noise(circuits, noise_model, transpile=False)">
