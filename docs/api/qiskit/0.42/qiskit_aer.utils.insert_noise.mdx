...
<Function id="qiskit_aer.utils.insert_noise" github="https://github.com/qiskit/qiskit-aer/tree/stable/0.12/qiskit_aer/utils/noise_model_inserter.py" signature="insert_noise(circuits, noise_model, transpile=False)">
