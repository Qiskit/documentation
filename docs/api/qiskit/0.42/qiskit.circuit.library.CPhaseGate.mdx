---
title: CPhaseGate (v0.42)
description: API reference for qiskit.circuit.library.CPhaseGate in qiskit v0.42
...
<Class id="qiskit.circuit.library.CPhaseGate" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/circuit/library/standard_gates/p.py" signature="CPhaseGate(theta, label=None, ctrl_state=None)" modifiers="class">
...
$$
  ...
  <Function id="qiskit.circuit.library.CPhaseGate.power" signature="CPhaseGate.power(exponent)">
