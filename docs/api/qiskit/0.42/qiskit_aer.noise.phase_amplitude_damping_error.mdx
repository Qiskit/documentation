---
title: phase_amplitude_damping_error (v0.42)
description: API reference for qiskit_aer.noise.phase_amplitude_damping_error in qiskit v0.42
...
<Function id="qiskit_aer.noise.phase_amplitude_damping_error" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-aer/tree/stable/0.12/qiskit_aer/noise/errors/standard_errors.py" signature="phase_amplitude_damping_error(param_amp, param_phase, excited_state_population=0, canonical_kraus=True)">
