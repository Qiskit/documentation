---
title: RealVariationalPrinciple (v0.42)
description: API reference for qiskit.algorithms.time_evolvers.variational.RealVariationalPrinciple in qiskit v0.42
