...
<Class id="qiskit.circuit.EquivalenceLibrary" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/circuit/equivalence.py" signature="EquivalenceLibrary(*, base=None)">
  Bases: `object`
  ...
  **base** (*Optional\[*[*EquivalenceLibrary*](#qiskit.circuit.EquivalenceLibrary "qiskit.circuit.EquivalenceLibrary")*]*) – Base equivalence library to be referenced if an entry is not found in this library.
  ...
  <Function id="qiskit.circuit.EquivalenceLibrary.add_equivalence" name="add_equivalence" signature="EquivalenceLibrary.add_equivalence(gate, equivalent_circuit)">
  ...
  <Function id="qiskit.circuit.EquivalenceLibrary.draw" name="draw" signature="EquivalenceLibrary.draw(filename=None)">
  ...
  <Function id="qiskit.circuit.EquivalenceLibrary.get_entry" name="get_entry" signature="EquivalenceLibrary.get_entry(gate)">
  ...
  <Function id="qiskit.circuit.EquivalenceLibrary.has_entry" name="has_entry" signature="EquivalenceLibrary.has_entry(gate)">
  ...
  <Function id="qiskit.circuit.EquivalenceLibrary.keys" name="keys" signature="EquivalenceLibrary.keys()">
  ...
  <Function id="qiskit.circuit.EquivalenceLibrary.node_index" name="node_index" signature="EquivalenceLibrary.node_index(key)">
  ...
  <Function id="qiskit.circuit.EquivalenceLibrary.set_entry" name="set_entry" signature="EquivalenceLibrary.set_entry(gate, entry)">
  ...
  <Attribute id="qiskit.circuit.EquivalenceLibrary.graph" name="graph">
