---
title: EquivalenceLibrary (v0.42)
description: API reference for qiskit.circuit.EquivalenceLibrary in qiskit v0.42
...
<Class id="qiskit.circuit.EquivalenceLibrary" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/circuit/equivalence.py" signature="EquivalenceLibrary(*, base=None)" modifiers="class">
  Bases: `object`
  ...
  **base** (*Optional\[*[*EquivalenceLibrary*](#qiskit.circuit.EquivalenceLibrary "qiskit.circuit.EquivalenceLibrary")*]*) – Base equivalence library to be referenced if an entry is not found in this library.
  ...
  <Function id="qiskit.circuit.EquivalenceLibrary.keys" signature="EquivalenceLibrary.keys()">
  ...
  <Function id="qiskit.circuit.EquivalenceLibrary.node_index" signature="EquivalenceLibrary.node_index(key)">
