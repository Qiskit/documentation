...
<Class id="qiskit.transpiler.passes.PulseGates" github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/transpiler/passes/calibration/pulse_gate.py" signature="PulseGates(inst_map)">
