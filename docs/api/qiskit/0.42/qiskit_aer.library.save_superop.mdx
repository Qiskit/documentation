...
<Function id="qiskit_aer.library.save_superop" name="save_superop" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-aer/tree/stable/0.12/qiskit_aer/library/save_instructions/save_superop.py" signature="save_superop(self, label='superop', pershot=False)">
