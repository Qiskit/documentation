...
<Class id="qiskit.opflow.state_fns.CircuitStateFn" github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/opflow/state_fns/circuit_state_fn.py" signature="CircuitStateFn(primitive=None, coeff=1.0, is_measurement=False, from_operator=False)">
  ...
  **TypeError** – Unsupported primitive, or primitive has ClassicalRegisters.
  ...
  <Function id="qiskit.opflow.state_fns.CircuitStateFn.from_dict" signature="static CircuitStateFn.from_dict(density_dict)">
  ...
  <Function id="qiskit.opflow.state_fns.CircuitStateFn.from_vector" signature="static CircuitStateFn.from_vector(statevector)">
