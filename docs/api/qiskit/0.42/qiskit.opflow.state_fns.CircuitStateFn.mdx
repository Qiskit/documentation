---
title: CircuitStateFn (v0.42)
description: API reference for qiskit.opflow.state_fns.CircuitStateFn in qiskit v0.42
...
<Class id="qiskit.opflow.state_fns.CircuitStateFn" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/opflow/state_fns/circuit_state_fn.py" signature="CircuitStateFn(primitive=None, coeff=1.0, is_measurement=False, from_operator=False)" modifiers="class">
