...
<Function id="qiskit_aer.library.save_stabilizer" name="save_stabilizer" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-aer/tree/stable/0.12/qiskit_aer/library/save_instructions/save_stabilizer.py" signature="save_stabilizer(self, label='stabilizer', pershot=False, conditional=False)">
