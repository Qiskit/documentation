---
title: SamplingMinimumEigensolverResult (v0.42)
description: API reference for qiskit.algorithms.minimum_eigensolvers.SamplingMinimumEigensolverResult in qiskit v0.42
