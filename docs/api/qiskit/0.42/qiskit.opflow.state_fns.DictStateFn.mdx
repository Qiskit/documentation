...
<Class id="qiskit.opflow.state_fns.DictStateFn" github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/opflow/state_fns/dict_state_fn.py" signature="DictStateFn(primitive=None, coeff=1.0, is_measurement=False, from_operator=False)">
