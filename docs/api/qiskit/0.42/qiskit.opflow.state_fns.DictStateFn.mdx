...
<Class id="qiskit.opflow.state_fns.DictStateFn" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/opflow/state_fns/dict_state_fn.py" signature="DictStateFn(primitive=None, coeff=1.0, is_measurement=False, from_operator=False)">
  ...
  **TypeError** – invalid parameters.
  ...
  <Function id="qiskit.opflow.state_fns.DictStateFn.add" name="add" signature="DictStateFn.add(other)">
  ...
  <Function id="qiskit.opflow.state_fns.DictStateFn.adjoint" name="adjoint" signature="DictStateFn.adjoint()">
  ...
  <Function id="qiskit.opflow.state_fns.DictStateFn.eval" name="eval" signature="DictStateFn.eval(front=None)">
  ...
  <Function id="qiskit.opflow.state_fns.DictStateFn.permute" name="permute" signature="DictStateFn.permute(permutation)">
  ...
  <Function id="qiskit.opflow.state_fns.DictStateFn.primitive_strings" name="primitive_strings" signature="DictStateFn.primitive_strings()">
  ...
  <Function id="qiskit.opflow.state_fns.DictStateFn.sample" name="sample" signature="DictStateFn.sample(shots=1024, massive=False, reverse_endianness=False)">
  ...
  <Function id="qiskit.opflow.state_fns.DictStateFn.tensor" name="tensor" signature="DictStateFn.tensor(other)">
  ...
  <Function id="qiskit.opflow.state_fns.DictStateFn.to_circuit_op" name="to_circuit_op" signature="DictStateFn.to_circuit_op()">
  ...
  <Function id="qiskit.opflow.state_fns.DictStateFn.to_density_matrix" name="to_density_matrix" signature="DictStateFn.to_density_matrix(massive=False)">
  ...
  <Function id="qiskit.opflow.state_fns.DictStateFn.to_matrix" name="to_matrix" signature="DictStateFn.to_matrix(massive=False)">
  ...
  <Function id="qiskit.opflow.state_fns.DictStateFn.to_spmatrix" name="to_spmatrix" signature="DictStateFn.to_spmatrix()">
  ...
  <Function id="qiskit.opflow.state_fns.DictStateFn.to_spmatrix_op" name="to_spmatrix_op" signature="DictStateFn.to_spmatrix_op()">
  ...
  <Attribute id="qiskit.opflow.state_fns.DictStateFn.INDENTATION" name="INDENTATION" attributeValue="= '  '" />

  ### coeff

  <Attribute id="qiskit.opflow.state_fns.DictStateFn.coeff" name="coeff">
  ...
  <Attribute id="qiskit.opflow.state_fns.DictStateFn.instance_id" name="instance_id">
  ...
  <Attribute id="qiskit.opflow.state_fns.DictStateFn.is_measurement" name="is_measurement">
  ...
  <Attribute id="qiskit.opflow.state_fns.DictStateFn.num_qubits" name="num_qubits">
    **Return type**
  ...
  <Attribute id="qiskit.opflow.state_fns.DictStateFn.parameters" name="parameters" />

  ### primitive

  <Attribute id="qiskit.opflow.state_fns.DictStateFn.primitive" name="primitive" attributeTypeHint="Dict[str, complex]">
    The primitive which defines the behavior of the underlying State function.
  </Attribute>

  ### settings

  <Attribute id="qiskit.opflow.state_fns.DictStateFn.settings" name="settings">
    Return settings.
