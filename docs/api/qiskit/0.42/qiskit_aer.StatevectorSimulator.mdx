...
<Class id="qiskit_aer.StatevectorSimulator" github="https://github.com/qiskit/qiskit-aer/tree/stable/0.12/qiskit_aer/backends/statevector_simulator.py" signature="StatevectorSimulator(configuration=None, properties=None, provider=None, **backend_options)">
