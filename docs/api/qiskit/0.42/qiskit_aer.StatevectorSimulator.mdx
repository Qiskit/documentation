---
title: StatevectorSimulator (v0.42)
description: API reference for qiskit_aer.StatevectorSimulator in qiskit v0.42
...
<Class id="qiskit_aer.StatevectorSimulator" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-aer/tree/stable/0.12/qiskit_aer/backends/statevector_simulator.py" signature="StatevectorSimulator(configuration=None, properties=None, provider=None, **backend_options)" modifiers="class">
