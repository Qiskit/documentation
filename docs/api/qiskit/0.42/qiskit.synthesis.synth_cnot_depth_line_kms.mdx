...
<Function id="qiskit.synthesis.synth_cnot_depth_line_kms" github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/synthesis/linear/linear_depth_lnn.py" signature="synth_cnot_depth_line_kms(mat)">
