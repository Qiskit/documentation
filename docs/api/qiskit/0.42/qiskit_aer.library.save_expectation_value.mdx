---
title: save_expectation_value (v0.42)
description: API reference for qiskit_aer.library.save_expectation_value in qiskit v0.42
...
<Function id="qiskit_aer.library.save_expectation_value" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-aer/tree/stable/0.12/qiskit_aer/library/save_instructions/save_expectation_value.py" signature="save_expectation_value(self, operator, qubits, label='expectation_value', unnormalized=False, pershot=False, conditional=False)">
