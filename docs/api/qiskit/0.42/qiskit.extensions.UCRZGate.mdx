---
title: UCRZGate (v0.42)
description: API reference for qiskit.extensions.UCRZGate in qiskit v0.42
...
<Class id="qiskit.extensions.UCRZGate" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/extensions/quantum_initializer/ucrz.py" signature="UCRZGate(angle_list)" modifiers="class">
