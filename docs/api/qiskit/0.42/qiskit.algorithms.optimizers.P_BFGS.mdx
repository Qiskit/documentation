---
title: P_BFGS (v0.42)
description: API reference for qiskit.algorithms.optimizers.P_BFGS in qiskit v0.42
...
<Class id="qiskit.algorithms.optimizers.P_BFGS" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/algorithms/optimizers/p_bfgs.py" signature="P_BFGS(maxfun=1000, ftol=2.220446049250313e-15, iprint=- 1, max_processes=None, options=None, max_evals_grouped=1, **kwargs)" modifiers="class">
