...
<Class id="qiskit.circuit.library.XXPlusYYGate" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/circuit/library/standard_gates/xx_plus_yy.py" signature="XXPlusYYGate(theta, beta=0, label='{XX+YY}')">
...
$$
  ...
  *   **label** (`Optional`\[`str`]) – The label of the gate.
  ...
  <Function id="qiskit.circuit.library.XXPlusYYGate.inverse" name="inverse" signature="XXPlusYYGate.inverse()">
    Return inverse XX+YY gate (i.e. with the negative rotation angle and same phase angle).
  </Function>

  ### power

  <Function id="qiskit.circuit.library.XXPlusYYGate.power" name="power" signature="XXPlusYYGate.power(exponent)">
