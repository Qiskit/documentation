---
title: unitary_synthesis_plugin_names (v0.42)
description: API reference for qiskit.transpiler.passes.synthesis.plugin.unitary_synthesis_plugin_names in qiskit v0.42
