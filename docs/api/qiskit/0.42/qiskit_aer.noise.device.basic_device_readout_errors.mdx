...
<Function id="qiskit_aer.noise.device.basic_device_readout_errors" name="basic_device_readout_errors" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-aer/tree/stable/0.12/qiskit_aer/noise/device/models.py" signature="basic_device_readout_errors(properties=None, target=None)">
