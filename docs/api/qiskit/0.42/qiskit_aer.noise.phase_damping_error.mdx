---
title: phase_damping_error (v0.42)
description: API reference for qiskit_aer.noise.phase_damping_error in qiskit v0.42
in_page_toc_min_heading_level: 1
python_api_type: function
python_api_name: qiskit_aer.noise.phase_damping_error
---

<span id="qiskit-aer-noise-phase-damping-error" />

# qiskit\_aer.noise.phase\_damping\_error

<Function id="qiskit_aer.noise.phase_damping_error" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-aer/tree/stable/0.12/qiskit_aer/noise/errors/standard_errors.py" signature="phase_damping_error(param_phase, canonical_kraus=True)">
