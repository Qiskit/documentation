---
title: GradientDescentState (v0.42)
description: API reference for qiskit.algorithms.optimizers.GradientDescentState in qiskit v0.42
...
<Class id="qiskit.algorithms.optimizers.GradientDescentState" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/algorithms/optimizers/gradient_descent.py" signature="GradientDescentState(x, fun, jac, nfev, njev, nit, stepsize, learning_rate)" modifiers="class">
