---
title: Delay (v0.42)
description: API reference for qiskit.pulse.instructions.Delay in qiskit v0.42
...
<Class id="qiskit.pulse.instructions.Delay" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/pulse/instructions/delay.py" signature="Delay(duration, channel, name=None)" modifiers="class">
