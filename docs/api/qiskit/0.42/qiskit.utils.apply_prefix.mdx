---
title: apply_prefix (v0.42)
description: API reference for qiskit.utils.apply_prefix in qiskit v0.42
...
<Function id="qiskit.utils.apply_prefix" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/utils/units.py" signature="apply_prefix(value, unit)">
