---
title: QasmSimulator (v0.42)
description: API reference for qiskit_aer.QasmSimulator in qiskit v0.42
...
<Class id="qiskit_aer.QasmSimulator" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-aer/tree/stable/0.12/qiskit_aer/backends/qasm_simulator.py" signature="QasmSimulator(configuration=None, properties=None, provider=None, **backend_options)" modifiers="class">
  ...
  **Raises**
  ...
  <span id="qiskit-aer-qasmsimulator-available-devices" />
  ...
  <span id="qiskit-aer-qasmsimulator-available-methods" />
  ...
  <span id="qiskit-aer-qasmsimulator-clear-options" />
  ...
  <span id="qiskit-aer-qasmsimulator-configuration" />
  ...
  <span id="qiskit-aer-qasmsimulator-defaults" />
  ...
  <span id="qiskit-aer-qasmsimulator-from-backend" />
  ...
  <span id="qiskit-aer-qasmsimulator-name" />
  ...
  <span id="qiskit-aer-qasmsimulator-properties" />
  ...
  <span id="qiskit-aer-qasmsimulator-provider" />
  ...
  <span id="qiskit-aer-qasmsimulator-run" />
  ...
  <span id="qiskit-aer-qasmsimulator-set-option" />
  ...
  <span id="qiskit-aer-qasmsimulator-set-options" />
  ...
  <span id="qiskit-aer-qasmsimulator-status" />
