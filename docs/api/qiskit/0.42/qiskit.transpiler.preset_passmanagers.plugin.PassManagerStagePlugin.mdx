---
title: PassManagerStagePlugin (v0.42)
description: API reference for qiskit.transpiler.preset_passmanagers.plugin.PassManagerStagePlugin in qiskit v0.42
...
<Class id="qiskit.transpiler.preset_passmanagers.plugin.PassManagerStagePlugin" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/transpiler/preset_passmanagers/plugin.py" signature="PassManagerStagePlugin" modifiers="class">
  Bases: `abc.ABC`
  ...
  <Function id="qiskit.transpiler.preset_passmanagers.plugin.PassManagerStagePlugin.pass_manager" signature="PassManagerStagePlugin.pass_manager(pass_manager_config, optimization_level=None)" modifiers="abstract">
