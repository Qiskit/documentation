...
<Class id="qiskit.transpiler.TransformationPass" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/transpiler/basepasses.py" signature="TransformationPass(*args, **kwargs)">
