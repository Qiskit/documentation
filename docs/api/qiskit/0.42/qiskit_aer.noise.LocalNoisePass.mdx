...
<Class id="qiskit_aer.noise.LocalNoisePass" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-aer/tree/stable/0.12/qiskit_aer/noise/passes/local_noise_pass.py" signature="LocalNoisePass(func, op_types=None, method='append')">
