---
title: IGate (v0.42)
description: API reference for qiskit.circuit.library.IGate in qiskit v0.42
...
<Class id="qiskit.circuit.library.IGate" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/circuit/library/standard_gates/i.py" signature="IGate(label=None)" modifiers="class">
