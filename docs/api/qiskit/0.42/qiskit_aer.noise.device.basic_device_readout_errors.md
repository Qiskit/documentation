...
`basic_device_readout_errors(properties=None, target=None)` [GitHub](https://github.com/qiskit/qiskit-aer/tree/stable/0.12/qiskit_aer/noise/device/models.py "view source code")
