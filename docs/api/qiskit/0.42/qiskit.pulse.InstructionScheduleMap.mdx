...
<Class id="qiskit.pulse.InstructionScheduleMap" github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/pulse/instruction_schedule_map.py" signature="InstructionScheduleMap">
  Bases: `object`
