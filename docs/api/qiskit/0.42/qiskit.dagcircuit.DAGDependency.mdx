---
title: DAGDependency (v0.42)
description: API reference for qiskit.dagcircuit.DAGDependency in qiskit v0.42
...
<Class id="qiskit.dagcircuit.DAGDependency" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/dagcircuit/dagdependency.py" signature="DAGDependency" modifiers="class">
  Bases: `object`
