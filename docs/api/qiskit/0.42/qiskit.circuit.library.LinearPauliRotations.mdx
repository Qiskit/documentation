---
title: LinearPauliRotations (v0.42)
description: API reference for qiskit.circuit.library.LinearPauliRotations in qiskit v0.42
...
$$
  ...
  *   **name** (`str`) – The name of the circuit object.
  ...
  <Attribute id="qiskit.circuit.library.LinearPauliRotations.instances" attributeValue="2111" />
