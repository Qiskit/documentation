...
`align_func(duration, func)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.42/qiskit/pulse/builder.py "view source code")
...
![../\_images/qiskit-pulse-builder-align\_func-1.png](/images/api/qiskit/0.42/qiskit-pulse-builder-align_func-1.png)
