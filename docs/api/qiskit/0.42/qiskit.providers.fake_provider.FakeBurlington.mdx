---
title: FakeBurlington (v0.42)
description: API reference for qiskit.providers.fake_provider.FakeBurlington in qiskit v0.42
...
<Class id="qiskit.providers.fake_provider.FakeBurlington" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/providers/fake_provider/backends/burlington/fake_burlington.py" signature="FakeBurlington" modifiers="class">
