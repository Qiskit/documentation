...
`set_density_matrix(self, state)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.42/qiskit_aer/library/set_instructions/set_density_matrix.py "view source code")
