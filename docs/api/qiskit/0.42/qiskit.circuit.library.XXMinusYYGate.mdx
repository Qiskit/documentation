---
title: XXMinusYYGate (v0.42)
description: API reference for qiskit.circuit.library.XXMinusYYGate in qiskit v0.42
...
<Class id="qiskit.circuit.library.XXMinusYYGate" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/circuit/library/standard_gates/xx_minus_yy.py" signature="XXMinusYYGate(theta, beta=0, label='{XX-YY}')" modifiers="class">
