...
<Class id="qiskit.circuit.library.XXMinusYYGate" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/circuit/library/standard_gates/xx_minus_yy.py" signature="XXMinusYYGate(theta, beta=0, label='{XX-YY}')">
...
$$
  ...
  *   **label** (`Optional`\[`str`]) – The label of the gate.
  ...
  <Function id="qiskit.circuit.library.XXMinusYYGate.inverse" name="inverse" signature="XXMinusYYGate.inverse()">
    Inverse gate.
  </Function>

  ### power

  <Function id="qiskit.circuit.library.XXMinusYYGate.power" name="power" signature="XXMinusYYGate.power(exponent)">
