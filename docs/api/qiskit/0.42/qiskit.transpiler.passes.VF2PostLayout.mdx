---
title: VF2PostLayout (v0.42)
description: API reference for qiskit.transpiler.passes.VF2PostLayout in qiskit v0.42
...
<Class id="qiskit.transpiler.passes.VF2PostLayout" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/transpiler/passes/layout/vf2_post_layout.py" signature="VF2PostLayout(*args, **kwargs)" modifiers="class">
