...
`FakeBackend5QV2(bidirectional=True)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.42/qiskit/providers/fake_provider/fake_backend_v2.py "view source code")
...
`FakeBackend5QV2.run(run_input, **options)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.42/qiskit/providers/fake_provider/fake_backend_v2.py "view source code")
