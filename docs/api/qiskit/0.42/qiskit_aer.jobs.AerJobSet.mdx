...
<Class id="qiskit_aer.jobs.AerJobSet" github="https://github.com/qiskit/qiskit-aer/tree/stable/0.12/qiskit_aer/jobs/aerjobset.py" signature="AerJobSet(backend, job_id, fn, experiments, executor=None)">
