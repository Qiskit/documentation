---
title: FakeBackend5QV2 (v0.42)
description: API reference for qiskit.providers.fake_provider.FakeBackend5QV2 in qiskit v0.42
...
<Class id="qiskit.providers.fake_provider.FakeBackend5QV2" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/providers/fake_provider/fake_backend_v2.py" signature="FakeBackend5QV2(bidirectional=True)" modifiers="class">
