---
title: approximate_quantum_error (v0.42)
description: API reference for qiskit_aer.utils.approximate_quantum_error in qiskit v0.42
in_page_toc_min_heading_level: 1
python_api_type: function
python_api_name: qiskit_aer.utils.approximate_quantum_error
---

<span id="qiskit-aer-utils-approximate-quantum-error" />

# qiskit\_aer.utils.approximate\_quantum\_error

<Function id="qiskit_aer.utils.approximate_quantum_error" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-aer/tree/stable/0.12/qiskit_aer/utils/noise_transformation.py" signature="approximate_quantum_error(error, *, operator_string=None, operator_dict=None, operator_list=None)">
