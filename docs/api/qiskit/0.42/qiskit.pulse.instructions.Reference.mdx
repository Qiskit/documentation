---
title: Reference (v0.42)
description: API reference for qiskit.pulse.instructions.Reference in qiskit v0.42
...
<Class id="qiskit.pulse.instructions.Reference" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/pulse/instructions/reference.py" signature="Reference(name, *extra_keys)" modifiers="class">
