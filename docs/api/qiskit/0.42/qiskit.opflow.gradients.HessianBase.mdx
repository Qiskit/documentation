...
<Class id="qiskit.opflow.gradients.HessianBase" github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/opflow/gradients/hessian_base.py" signature="HessianBase(hess_method='param_shift', **kwargs)">
