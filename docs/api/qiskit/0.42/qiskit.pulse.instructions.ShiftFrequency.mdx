---
title: ShiftFrequency (v0.42)
description: API reference for qiskit.pulse.instructions.ShiftFrequency in qiskit v0.42
...
<Class id="qiskit.pulse.instructions.ShiftFrequency" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/pulse/instructions/frequency.py" signature="ShiftFrequency(frequency, channel, name=None)" modifiers="class">
