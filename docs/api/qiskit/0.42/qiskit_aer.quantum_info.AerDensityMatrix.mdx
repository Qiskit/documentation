...
<Class id="qiskit_aer.quantum_info.AerDensityMatrix" github="https://github.com/qiskit/qiskit-aer/tree/stable/0.12/qiskit_aer/quantum_info/states/aer_densitymatrix.py" signature="AerDensityMatrix(data, dims=None, **configs)">
  ...
  **Additional Information:**
  ...
  <Function id="qiskit_aer.quantum_info.AerDensityMatrix.from_instruction" signature="classmethod AerDensityMatrix.from_instruction(instruction)">
  ...
  <Function id="qiskit_aer.quantum_info.AerDensityMatrix.from_int" signature="static AerDensityMatrix.from_int(i, dims)">
  ...
  <Function id="qiskit_aer.quantum_info.AerDensityMatrix.from_label" signature="classmethod AerDensityMatrix.from_label(label)">
