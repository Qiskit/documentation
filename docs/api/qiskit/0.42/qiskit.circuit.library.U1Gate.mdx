---
title: U1Gate (v0.42)
description: API reference for qiskit.circuit.library.U1Gate in qiskit v0.42
...
<Class id="qiskit.circuit.library.U1Gate" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/circuit/library/standard_gates/u1.py" signature="U1Gate(theta, label=None)" modifiers="class">
