...
<Class id="qiskit.transpiler.passes.TimeUnitConversion" github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/transpiler/passes/scheduling/time_unit_conversion.py" signature="TimeUnitConversion(inst_durations)">
