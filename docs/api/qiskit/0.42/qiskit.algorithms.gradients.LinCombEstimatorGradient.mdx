...
<Class id="qiskit.algorithms.gradients.LinCombEstimatorGradient" github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/algorithms/gradients/lin_comb_estimator_gradient.py" signature="LinCombEstimatorGradient(estimator, derivative_type=DerivativeType.REAL, options=None)">
