...
<Class id="qiskit.transpiler.passes.LinearFunctionsSynthesis" github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/transpiler/passes/synthesis/linear_functions_synthesis.py" signature="LinearFunctionsSynthesis(*args, **kwargs)">
