...
<Class id="qiskit.dagcircuit.BlockCollapser" github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/dagcircuit/collect_blocks.py" signature="BlockCollapser(dag)">
  Bases: `object`
