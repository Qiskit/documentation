...
<Class id="qiskit.circuit.library.PauliTwoDesign" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/circuit/library/n_local/pauli_two_design.py" signature="PauliTwoDesign(num_qubits=None, reps=3, seed=None, insert_barriers=False, name='PauliTwoDesign')">
  ...
  **Examples**
  ...
  ![../\_images/qiskit-circuit-library-PauliTwoDesign-1.png](/images/api/qiskit/0.42/qiskit-circuit-library-PauliTwoDesign-1.png)
  ...
  *   **initial\_state** – A [`QuantumCircuit`](qiskit.circuit.QuantumCircuit "qiskit.circuit.QuantumCircuit") object to prepend to the circuit.
  ...
  <Attribute id="qiskit.circuit.library.PauliTwoDesign.instances" name="instances" attributeValue="= 2148" />
  ...
  <Attribute id="qiskit.circuit.library.PauliTwoDesign.qregs" name="qregs">
