---
title: LinearAmplitudeFunction (v0.42)
description: API reference for qiskit.circuit.library.LinearAmplitudeFunction in qiskit v0.42
...
$$
  ...
  *   **name** (`str`) – Name of the circuit.
  ...
  <Attribute id="qiskit.circuit.library.LinearAmplitudeFunction.instances" attributeValue="2111" />
