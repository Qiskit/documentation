...
`ClassicalFunctionCompilerTypeError(*message)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.42/qiskit/circuit/classicalfunction/exceptions.py "view source code")
