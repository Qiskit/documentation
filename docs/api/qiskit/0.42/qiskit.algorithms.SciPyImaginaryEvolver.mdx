...
<Class id="qiskit.algorithms.SciPyImaginaryEvolver" github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/algorithms/time_evolvers/classical_methods/scipy_imaginary_evolver.py" signature="SciPyImaginaryEvolver(num_timesteps)">
  ...
  **ValueError** – If num\_timesteps is not a positive integer.
  ...
  <Function id="qiskit.algorithms.SciPyImaginaryEvolver.evolve" name="evolve" signature="SciPyImaginaryEvolver.evolve(evolution_problem)">
