...
`RemoveBarriers(*args, **kwargs)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.42/qiskit/transpiler/passes/utils/remove_barriers.py "view source code")
...
![../\_images/qiskit-transpiler-passes-RemoveBarriers-1.png](/images/api/qiskit/0.42/qiskit-transpiler-passes-RemoveBarriers-1.png)
...
`RemoveBarriers.run(dag)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.42/qiskit/transpiler/passes/utils/remove_barriers.py "view source code")
