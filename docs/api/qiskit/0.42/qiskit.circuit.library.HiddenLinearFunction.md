...
`HiddenLinearFunction(adjacency_matrix)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.42/qiskit/circuit/library/hidden_linear_function.py "view source code")
...
> ![../\_images/qiskit-circuit-library-HiddenLinearFunction-1.png](/images/api/qiskit/0.42/qiskit-circuit-library-HiddenLinearFunction-1.png)
