...
<Function id="qiskit_aer.noise.coherent_unitary_error" name="coherent_unitary_error" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-aer/tree/stable/0.12/qiskit_aer/noise/errors/standard_errors.py" signature="coherent_unitary_error(unitary)">
