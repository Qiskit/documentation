...
`insert_noise(circuits, noise_model, transpile=False)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.42/qiskit_aer/utils/noise_model_inserter.py "view source code")
