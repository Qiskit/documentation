---
title: InnerProduct (v0.42)
description: API reference for qiskit.circuit.library.InnerProduct in qiskit v0.42
...
$$
  ...
  **Reference Circuit:**
  ...
  ![../\_images/qiskit-circuit-library-InnerProduct-1.png](/docs/images/api/qiskit/0.42/qiskit-circuit-library-InnerProduct-1.avif)
