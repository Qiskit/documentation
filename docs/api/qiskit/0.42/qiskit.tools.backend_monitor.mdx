---
title: backend_monitor (v0.42)
description: API reference for qiskit.tools.backend_monitor in qiskit v0.42
...
<Function id="qiskit.tools.backend_monitor" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/tools/monitor/overview.py" signature="backend_monitor(backend)">
