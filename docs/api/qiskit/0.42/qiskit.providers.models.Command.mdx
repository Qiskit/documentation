...
<Class id="qiskit.providers.models.Command" github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/providers/models/pulsedefaults.py" signature="Command(name, qubits=None, sequence=None, **kwargs)">
  Bases: `object`
