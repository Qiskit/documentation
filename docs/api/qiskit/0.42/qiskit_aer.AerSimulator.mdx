...
<Class id="qiskit_aer.AerSimulator" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-aer/tree/stable/0.12/qiskit_aer/backends/aer_simulator.py" signature="AerSimulator(configuration=None, properties=None, provider=None, **backend_options)">
  ...
  **Raises**
  ...
  <Function id="qiskit_aer.AerSimulator.available_devices" name="available_devices" signature="AerSimulator.available_devices()">
    Return the available simulation methods.
  </Function>

  ### available\_methods

  <Function id="qiskit_aer.AerSimulator.available_methods" name="available_methods" signature="AerSimulator.available_methods()">
    Return the available simulation methods.
  </Function>

  ### clear\_options

  <Function id="qiskit_aer.AerSimulator.clear_options" name="clear_options" signature="AerSimulator.clear_options()">
    Reset the simulator options to default values.
  </Function>

  ### configuration

  <Function id="qiskit_aer.AerSimulator.configuration" name="configuration" signature="AerSimulator.configuration()">
  ...
  <Function id="qiskit_aer.AerSimulator.defaults" name="defaults" signature="AerSimulator.defaults()">
  ...
  <Function id="qiskit_aer.AerSimulator.from_backend" name="from_backend" signature="classmethod AerSimulator.from_backend(backend, **options)">
    Initialize simulator from backend.
  </Function>

  ### name

  <Function id="qiskit_aer.AerSimulator.name" name="name" signature="AerSimulator.name()">
    Format backend name string for simulator
  </Function>

  ### properties

  <Function id="qiskit_aer.AerSimulator.properties" name="properties" signature="AerSimulator.properties()">
  ...
  <Function id="qiskit_aer.AerSimulator.provider" name="provider" signature="AerSimulator.provider()">
  ...
  <Function id="qiskit_aer.AerSimulator.run" name="run" signature="AerSimulator.run(circuits, validate=False, parameter_binds=None, **run_options)">
  ...
  <Function id="qiskit_aer.AerSimulator.set_option" name="set_option" signature="AerSimulator.set_option(key, value)">
  ...
  <Function id="qiskit_aer.AerSimulator.set_options" name="set_options" signature="AerSimulator.set_options(**fields)">
    Set the simulator options
  </Function>

  ### status

  <Function id="qiskit_aer.AerSimulator.status" name="status" signature="AerSimulator.status()">
  ...
  <Attribute id="qiskit_aer.AerSimulator.options" name="options">
  ...
  <Attribute id="qiskit_aer.AerSimulator.version" name="version" attributeValue="= 1" />
</Class>
