---
title: DIRECT_L (v0.42)
description: API reference for qiskit.algorithms.optimizers.DIRECT_L in qiskit v0.42
...
<Class id="qiskit.algorithms.optimizers.DIRECT_L" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/algorithms/optimizers/nlopts/direct_l.py" signature="DIRECT_L(max_evals=1000)" modifiers="class">
