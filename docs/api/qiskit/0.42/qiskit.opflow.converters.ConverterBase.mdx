---
title: ConverterBase (v0.42)
description: API reference for qiskit.opflow.converters.ConverterBase in qiskit v0.42
...
<Class id="qiskit.opflow.converters.ConverterBase" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/opflow/converters/converter_base.py" signature="ConverterBase" modifiers="class">
  Bases: `abc.ABC`
