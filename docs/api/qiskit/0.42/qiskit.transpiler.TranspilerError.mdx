...
<Class id="qiskit.transpiler.TranspilerError" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/transpiler/exceptions.py" signature="TranspilerError(*message)">
