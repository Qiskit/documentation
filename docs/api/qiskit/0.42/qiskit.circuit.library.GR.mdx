---
title: GR (v0.42)
description: API reference for qiskit.circuit.library.GR in qiskit v0.42
...
$$
  ...
  **Expanded Circuit:**
  ...
  ![../\_images/qiskit-circuit-library-GR-1.png](/docs/images/api/qiskit/0.42/qiskit-circuit-library-GR-1.avif)
  ...
  *   **phi** (`float`) – angle of rotation axis in xy-plane
  ...
  <Attribute id="qiskit.circuit.library.GR.instances" attributeValue="2065" />
