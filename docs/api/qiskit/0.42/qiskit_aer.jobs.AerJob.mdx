...
<Class id="qiskit_aer.jobs.AerJob" github="https://github.com/qiskit/qiskit-aer/tree/stable/0.12/qiskit_aer/jobs/aerjob.py" signature="AerJob(backend, job_id, fn, qobj=None, circuits=None, noise_model=None, config=None, executor=None)">
