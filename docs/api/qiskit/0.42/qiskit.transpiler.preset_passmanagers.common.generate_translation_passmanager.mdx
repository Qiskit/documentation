---
title: generate_translation_passmanager (v0.42)
description: API reference for qiskit.transpiler.preset_passmanagers.common.generate_translation_passmanager in qiskit v0.42
