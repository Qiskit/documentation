---
title: DCXGate (v0.42)
description: API reference for qiskit.circuit.library.DCXGate in qiskit v0.42
...
<Class id="qiskit.circuit.library.DCXGate" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/circuit/library/standard_gates/dcx.py" signature="DCXGate" modifiers="class">
