---
title: triangle (v0.42)
description: API reference for qiskit.pulse.library.triangle in qiskit v0.42
...
$$
  ...
  **Example**
  ...
  ![../\_images/qiskit-pulse-library-triangle-1.png](/docs/images/api/qiskit/0.42/qiskit-pulse-library-triangle-1.avif)
