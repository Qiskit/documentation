---
title: delay_qubits (v0.42)
description: API reference for qiskit.pulse.builder.delay_qubits in qiskit v0.42
...
<Function id="qiskit.pulse.builder.delay_qubits" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/pulse/builder.py" signature="delay_qubits(duration, *qubits)">
