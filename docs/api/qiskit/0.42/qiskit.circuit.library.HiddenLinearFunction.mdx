---
title: HiddenLinearFunction (v0.42)
description: API reference for qiskit.circuit.library.HiddenLinearFunction in qiskit v0.42
...
$$
  ...
  **Reference Circuit:**
  ...
  > ![../\_images/qiskit-circuit-library-HiddenLinearFunction-1.png](/docs/images/api/qiskit/0.42/qiskit-circuit-library-HiddenLinearFunction-1.avif)
  ...
  **CircuitError** – If A is not symmetric.
  ...
  <Attribute id="qiskit.circuit.library.HiddenLinearFunction.instances" attributeValue="2085" />
