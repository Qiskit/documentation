...
<Class id="qiskit.transpiler.synthesis.aqc.ApproximatingObjective" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/transpiler/synthesis/aqc/approximate.py" signature="ApproximatingObjective">
  Bases: `abc.ABC`
