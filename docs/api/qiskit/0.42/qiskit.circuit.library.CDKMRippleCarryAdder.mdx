---
title: CDKMRippleCarryAdder (v0.42)
description: API reference for qiskit.circuit.library.CDKMRippleCarryAdder in qiskit v0.42
...
<Class id="qiskit.circuit.library.CDKMRippleCarryAdder" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/circuit/library/arithmetic/adders/cdkm_ripple_carry_adder.py" signature="CDKMRippleCarryAdder(num_state_qubits, kind='full', name='CDKMRippleCarryAdder')" modifiers="class">
  ...
  **ValueError** – If `num_state_qubits` is lower than 1.
  ...
  <Attribute id="qiskit.circuit.library.CDKMRippleCarryAdder.instances" attributeValue="2051" />
