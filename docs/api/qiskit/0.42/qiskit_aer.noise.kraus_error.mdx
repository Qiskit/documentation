...
<Function id="qiskit_aer.noise.kraus_error" name="kraus_error" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-aer/tree/stable/0.12/qiskit_aer/noise/errors/standard_errors.py" signature="kraus_error(noise_ops, canonical_kraus=False)">
