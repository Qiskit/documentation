...
<Class id="qiskit_aer.noise.QuantumError" github="https://github.com/qiskit/qiskit-aer/tree/stable/0.12/qiskit_aer/noise/errors/quantum_error.py" signature="QuantumError(noise_ops)">
