---
title: QuantumError (v0.42)
description: API reference for qiskit_aer.noise.QuantumError in qiskit v0.42
...
<Class id="qiskit_aer.noise.QuantumError" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-aer/tree/stable/0.12/qiskit_aer/noise/errors/quantum_error.py" signature="QuantumError(noise_ops)" modifiers="class">
