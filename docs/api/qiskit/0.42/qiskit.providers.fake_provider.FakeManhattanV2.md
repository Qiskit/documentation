...
`FakeManhattanV2`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.42/qiskit/providers/fake_provider/backends/manhattan/fake_manhattan.py "view source code")
