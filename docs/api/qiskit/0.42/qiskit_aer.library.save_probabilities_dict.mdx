---
title: save_probabilities_dict (v0.42)
description: API reference for qiskit_aer.library.save_probabilities_dict in qiskit v0.42
...
<Function id="qiskit_aer.library.save_probabilities_dict" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-aer/tree/stable/0.12/qiskit_aer/library/save_instructions/save_probabilities.py" signature="save_probabilities_dict(self, qubits=None, label='probabilities', unnormalized=False, pershot=False, conditional=False)">
