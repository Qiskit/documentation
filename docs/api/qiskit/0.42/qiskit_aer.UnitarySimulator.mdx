...
<Class id="qiskit_aer.UnitarySimulator" github="https://github.com/qiskit/qiskit-aer/tree/stable/0.12/qiskit_aer/backends/unitary_simulator.py" signature="UnitarySimulator(configuration=None, properties=None, provider=None, **backend_options)">
