...
<Class id="qiskit_aer.UnitarySimulator" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-aer/tree/stable/0.12/qiskit_aer/backends/unitary_simulator.py" signature="UnitarySimulator(configuration=None, properties=None, provider=None, **backend_options)">
  ...
  **Raises**
  ...
  <Function id="qiskit_aer.UnitarySimulator.available_devices" name="available_devices" signature="UnitarySimulator.available_devices()">
    Return the available simulation methods.
  </Function>

  ### available\_methods

  <Function id="qiskit_aer.UnitarySimulator.available_methods" name="available_methods" signature="UnitarySimulator.available_methods()">
    Return the available simulation methods.
  </Function>

  ### clear\_options

  <Function id="qiskit_aer.UnitarySimulator.clear_options" name="clear_options" signature="UnitarySimulator.clear_options()">
    Reset the simulator options to default values.
  </Function>

  ### configuration

  <Function id="qiskit_aer.UnitarySimulator.configuration" name="configuration" signature="UnitarySimulator.configuration()">
  ...
  <Function id="qiskit_aer.UnitarySimulator.defaults" name="defaults" signature="UnitarySimulator.defaults()">
  ...
  <Function id="qiskit_aer.UnitarySimulator.name" name="name" signature="UnitarySimulator.name()">
  ...
  <Function id="qiskit_aer.UnitarySimulator.properties" name="properties" signature="UnitarySimulator.properties()">
  ...
  <Function id="qiskit_aer.UnitarySimulator.provider" name="provider" signature="UnitarySimulator.provider()">
  ...
  <Function id="qiskit_aer.UnitarySimulator.run" name="run" signature="UnitarySimulator.run(circuits, validate=False, parameter_binds=None, **run_options)">
  ...
  <Function id="qiskit_aer.UnitarySimulator.set_option" name="set_option" signature="UnitarySimulator.set_option(key, value)">
  ...
  <Function id="qiskit_aer.UnitarySimulator.set_options" name="set_options" signature="UnitarySimulator.set_options(**fields)">
    Set the simulator options
  </Function>

  ### status

  <Function id="qiskit_aer.UnitarySimulator.status" name="status" signature="UnitarySimulator.status()">
  ...
  <Attribute id="qiskit_aer.UnitarySimulator.options" name="options">
  ...
  <Attribute id="qiskit_aer.UnitarySimulator.version" name="version" attributeValue="1" />
</Class>
