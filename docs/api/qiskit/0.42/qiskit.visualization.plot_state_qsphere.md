...
`plot_state_qsphere(state, figsize=None, ax=None, show_state_labels=True, show_state_phases=False, use_degrees=False, *, rho=None, filename=None)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.42/qiskit/visualization/state_visualization.py "view source code")
...
![../\_images/qiskit-visualization-plot\_state\_qsphere-1.png](/images/api/qiskit/0.42/qiskit-visualization-plot_state_qsphere-1.png)
...
![../\_images/qiskit-visualization-plot\_state\_qsphere-2.png](/images/api/qiskit/0.42/qiskit-visualization-plot_state_qsphere-2.png)
