---
title: random_clifford (v0.42)
description: API reference for qiskit.quantum_info.random_clifford in qiskit v0.42
...
<Function id="qiskit.quantum_info.random_clifford" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/quantum_info/operators/symplectic/random.py" signature="random_clifford(num_qubits, seed=None)">
