...
<Class id="qiskit.circuit.library.PermutationGate" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/circuit/library/generalized_gates/permutation.py" signature="PermutationGate(pattern)" modifiers="class">
  ...
  **Reference Circuit:**
  ...
  ![../\_images/qiskit-circuit-library-PermutationGate-1.png](/images/api/qiskit/0.42/qiskit-circuit-library-PermutationGate-1.avif)

  **Expanded Circuit:**

  ![../\_images/qiskit-circuit-library-PermutationGate-2.png](/images/api/qiskit/0.42/qiskit-circuit-library-PermutationGate-2.avif)
