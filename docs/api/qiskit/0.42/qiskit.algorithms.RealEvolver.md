...
`RealEvolver`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.42/qiskit/algorithms/evolvers/real_evolver.py "view source code")
...
`abstract RealEvolver.evolve(evolution_problem)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.42/qiskit/algorithms/evolvers/real_evolver.py "view source code")
