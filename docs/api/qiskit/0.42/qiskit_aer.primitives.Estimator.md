...
`Estimator(*, backend_options=None, transpile_options=None, run_options=None, approximation=False, skip_transpilation=False, abelian_grouping=True)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.42/qiskit_aer/primitives/estimator.py "view source code")
