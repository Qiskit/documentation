...
<Class id="qiskit.result.LocalReadoutMitigator" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/result/mitigation/local_readout_mitigator.py" signature="LocalReadoutMitigator(assignment_matrices=None, qubits=None, backend=None)">
  ...
  **QiskitError** – matrices sizes do not agree with number of qubits
  ...
  <Function id="qiskit.result.LocalReadoutMitigator.quasi_probabilities" name="quasi_probabilities" signature="LocalReadoutMitigator.quasi_probabilities(data, qubits=None, clbits=None, shots=None)">
