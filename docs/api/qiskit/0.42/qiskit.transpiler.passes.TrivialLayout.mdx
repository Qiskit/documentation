---
title: TrivialLayout (v0.42)
description: API reference for qiskit.transpiler.passes.TrivialLayout in qiskit v0.42
...
<Class id="qiskit.transpiler.passes.TrivialLayout" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/transpiler/passes/layout/trivial_layout.py" signature="TrivialLayout(*args, **kwargs)" modifiers="class">
