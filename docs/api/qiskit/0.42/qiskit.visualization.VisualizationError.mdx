...
<Class id="qiskit.visualization.VisualizationError" github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/visualization/exceptions.py" signature="VisualizationError(*message)">
