...
<Class id="qiskit.providers.fake_provider.Fake1Q" github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/providers/fake_provider/fake_1q.py" signature="Fake1Q">
