---
title: GateDirection (v0.42)
description: API reference for qiskit.transpiler.passes.GateDirection in qiskit v0.42
...
<Class id="qiskit.transpiler.passes.GateDirection" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/transpiler/passes/utils/gate_direction.py" signature="GateDirection(*args, **kwargs)" modifiers="class">
