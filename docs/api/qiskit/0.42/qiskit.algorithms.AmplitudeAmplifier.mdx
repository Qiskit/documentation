---
title: AmplitudeAmplifier (v0.42)
description: API reference for qiskit.algorithms.AmplitudeAmplifier in qiskit v0.42
...
<Class id="qiskit.algorithms.AmplitudeAmplifier" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/algorithms/amplitude_amplifiers/amplitude_amplifier.py" signature="AmplitudeAmplifier" modifiers="class">
  Bases: `abc.ABC`
