...
`OR(num_variable_qubits, flags=None, mcx_mode='noancilla')`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.42/qiskit/circuit/library/boolean_logic/quantum_or.py "view source code")
...
![../\_images/qiskit-circuit-library-OR-1.png](/images/api/qiskit/0.42/qiskit-circuit-library-OR-1.png)
...
![../\_images/qiskit-circuit-library-OR-2.png](/images/api/qiskit/0.42/qiskit-circuit-library-OR-2.png)
