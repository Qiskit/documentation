...
<Function id="qiskit_aer.library.save_density_matrix" github="https://github.com/qiskit/qiskit-aer/tree/stable/0.12/qiskit_aer/library/save_instructions/save_density_matrix.py" signature="save_density_matrix(self, qubits=None, label='density_matrix', unnormalized=False, pershot=False, conditional=False)">
