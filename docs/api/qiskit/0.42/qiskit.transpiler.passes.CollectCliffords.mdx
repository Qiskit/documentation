...
<Class id="qiskit.transpiler.passes.CollectCliffords" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/transpiler/passes/optimization/collect_cliffords.py" signature="CollectCliffords(*args, **kwargs)">
  ...
  *   **min\_block\_size** (*int*) – specifies the minimum number of gates in the block for the block to be collected.
  ...
  <Function id="qiskit.transpiler.passes.CollectCliffords.name" name="name" signature="CollectCliffords.name()">
    Return the name of the pass.
  </Function>

  ### run

  <Function id="qiskit.transpiler.passes.CollectCliffords.run" name="run" signature="CollectCliffords.run(dag)">
