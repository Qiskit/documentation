...
<Function id="qiskit.visualization.plot_circuit_layout" github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/visualization/gate_map.py" signature="plot_circuit_layout(circuit, backend, view='virtual', qubit_coordinates=None)">
