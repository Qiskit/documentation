...
<Class id="qiskit.dagcircuit.BlockCollector" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/dagcircuit/collect_blocks.py" signature="BlockCollector(dag)">
  Bases: `object`
  ...
  **Raises**
  ...
  <Function id="qiskit.dagcircuit.BlockCollector.collect_all_matching_blocks" name="collect_all_matching_blocks" signature="BlockCollector.collect_all_matching_blocks(filter_fn, split_blocks=True, min_block_size=2)">
  ...
  <Function id="qiskit.dagcircuit.BlockCollector.collect_matching_block" name="collect_matching_block" signature="BlockCollector.collect_matching_block(filter_fn)">
