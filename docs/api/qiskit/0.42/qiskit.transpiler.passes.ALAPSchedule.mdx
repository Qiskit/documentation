---
title: ALAPSchedule (v0.42)
description: API reference for qiskit.transpiler.passes.ALAPSchedule in qiskit v0.42
...
<Class id="qiskit.transpiler.passes.ALAPSchedule" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/transpiler/passes/scheduling/alap.py" signature="ALAPSchedule(*args, **kwargs)" modifiers="class">
