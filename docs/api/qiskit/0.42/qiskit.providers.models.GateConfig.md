...
`GateConfig(name, parameters, qasm_def, coupling_map=None, latency_map=None, conditional=None, description=None)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.42/qiskit/providers/models/backendconfiguration.py "view source code")
...
`classmethod GateConfig.from_dict(data)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.42/qiskit/providers/models/backendconfiguration.py "view source code")
...
`GateConfig.to_dict()`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.42/qiskit/providers/models/backendconfiguration.py "view source code")
