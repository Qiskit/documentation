---
title: IntegerComparator (v0.42)
description: API reference for qiskit.circuit.library.IntegerComparator in qiskit v0.42
...
$$
  ...
  *   **name** (`str`) – Name of the circuit.
  ...
  <Attribute id="qiskit.circuit.library.IntegerComparator.instances" attributeValue="2111" />
