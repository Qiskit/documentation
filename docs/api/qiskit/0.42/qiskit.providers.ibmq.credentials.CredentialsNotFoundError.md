...
`CredentialsNotFoundError(*message)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.42/qiskit/providers/ibmq/credentials/exceptions.py "view source code")
