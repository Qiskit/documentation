---
title: Job (v0.42)
description: API reference for qiskit.providers.Job in qiskit v0.42
...
<Class id="qiskit.providers.Job" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/providers/job.py" signature="Job" modifiers="class">
  Bases: `object`
