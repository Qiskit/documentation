...
<Function id="qiskit_aer.noise.device.gate_param_values" github="https://github.com/qiskit/qiskit-aer/tree/stable/0.12/qiskit_aer/noise/device/parameters.py" signature="gate_param_values(properties)">
