---
title: generate_routing_passmanager (v0.42)
description: API reference for qiskit.transpiler.preset_passmanagers.common.generate_routing_passmanager in qiskit v0.42
