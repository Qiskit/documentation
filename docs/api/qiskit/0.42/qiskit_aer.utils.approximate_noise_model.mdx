---
title: approximate_noise_model (v0.42)
description: API reference for qiskit_aer.utils.approximate_noise_model in qiskit v0.42
in_page_toc_min_heading_level: 1
python_api_type: function
python_api_name: qiskit_aer.utils.approximate_noise_model
---

<span id="qiskit-aer-utils-approximate-noise-model" />

# qiskit\_aer.utils.approximate\_noise\_model

<Function id="qiskit_aer.utils.approximate_noise_model" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-aer/tree/stable/0.12/qiskit_aer/utils/noise_transformation.py" signature="approximate_noise_model(model, *, operator_string=None, operator_dict=None, operator_list=None)">
