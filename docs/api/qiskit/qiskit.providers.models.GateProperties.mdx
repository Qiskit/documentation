...
<Class id="qiskit.providers.models.GateProperties" github="https://github.com/qiskit/qiskit/tree/stable/1.0/qiskit/providers/models/backendproperties.py" signature="qiskit.providers.models.GateProperties(qubits, gate, parameters, **kwargs)">
