...
<Class id="qiskit.providers.models.GateProperties" github="https://github.com/Qiskit/qiskit/tree/stable/1.0/qiskit/providers/models/backendproperties.py#L88-L158" signature="qiskit.providers.models.GateProperties(qubits, gate, parameters, **kwargs)">
