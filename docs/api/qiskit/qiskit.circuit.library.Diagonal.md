...
**diag** ([*list*](https://docs.python.org/3/library/stdtypes.html#list "(in Python v3.11)")*\[*[*complex*](https://docs.python.org/3/library/functions.html#complex "(in Python v3.11)")*] | np.ndarray*) – list of the 2^k diagonal entries (for a diagonal gate on k qubits).
