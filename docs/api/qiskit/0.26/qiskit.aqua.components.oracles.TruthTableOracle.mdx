...
<Class id="qiskit.aqua.components.oracles.TruthTableOracle" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/aqua/components/oracles/truth_table_oracle.py" signature="TruthTableOracle(bitmaps, optimization=False, mct_mode='basic')">
  ...
  **Raises**
  ...
  <Function id="qiskit.aqua.components.oracles.TruthTableOracle.__init__" name="__init__" signature="__init__(bitmaps, optimization=False, mct_mode='basic')">
    **Parameters**
  ...
  <Function id="qiskit.aqua.components.oracles.TruthTableOracle.ancillary_register" name="ancillary_register" signature="property ancillary_register">
    returns ancillary register
  </Function>

  ### circuit

  <Function id="qiskit.aqua.components.oracles.TruthTableOracle.circuit" name="circuit" signature="property circuit" />

  ### construct\_circuit

  <Function id="qiskit.aqua.components.oracles.TruthTableOracle.construct_circuit" name="construct_circuit" signature="construct_circuit()">
    construct circuit
  </Function>

  ### evaluate\_classically

  <Function id="qiskit.aqua.components.oracles.TruthTableOracle.evaluate_classically" name="evaluate_classically" signature="evaluate_classically(measurement)">
    evaluate classical
  </Function>

  ### output\_register

  <Function id="qiskit.aqua.components.oracles.TruthTableOracle.output_register" name="output_register" signature="property output_register">
    returns output register
  </Function>

  ### variable\_register

  <Function id="qiskit.aqua.components.oracles.TruthTableOracle.variable_register" name="variable_register" signature="property variable_register">
