...
`schedule_circuit(circuit, schedule_config, method=None)` [GitHub](https://github.com/qiskit/qiskit/tree/stable/0.17/qiskit/scheduler/schedule_circuit.py "view source code")
