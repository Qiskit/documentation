---
title: TrotterizationBase (v0.26)
description: API reference for qiskit.opflow.evolutions.TrotterizationBase in qiskit v0.26
...
<Class id="qiskit.opflow.evolutions.TrotterizationBase" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.17/qiskit/opflow/evolutions/trotterizations/trotterization_base.py" signature="TrotterizationBase(reps=1)" modifiers="class">
