...
<Class id="qiskit.aqua.operators.expectations.AerPauliExpectation" github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/aqua/operators/expectations/aer_pauli_expectation.py" signature="AerPauliExpectation">
