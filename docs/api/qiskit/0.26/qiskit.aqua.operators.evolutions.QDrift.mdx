...
<Class id="qiskit.aqua.operators.evolutions.QDrift" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/aqua/operators/evolutions/trotterizations/qdrift.py" signature="QDrift(reps=1)">
  ...
  **reps** (`int`) – The number of times to repeat the Trotterization circuit.
  ...
  <Function id="qiskit.aqua.operators.evolutions.QDrift.__init__" name="__init__" signature="__init__(reps=1)">
    **Parameters**
  ...
  <Function id="qiskit.aqua.operators.evolutions.QDrift.convert" name="convert" signature="convert(operator)">
  ...
  <Function id="qiskit.aqua.operators.evolutions.QDrift.reps" name="reps" signature="property reps">
