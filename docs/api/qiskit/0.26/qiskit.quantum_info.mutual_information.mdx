---
title: mutual_information (v0.26)
description: API reference for qiskit.quantum_info.mutual_information in qiskit v0.26
...
<Function id="qiskit.quantum_info.mutual_information" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.17/qiskit/quantum_info/states/measures.py" signature="mutual_information(state, base=2)">
