...
<Class id="qiskit.aqua.algorithms.IQPE" github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/aqua/algorithms/minimum_eigen_solvers/iqpe.py" signature="IQPE(operator=None, state_in=None, num_time_slices=1, num_iterations=1, expansion_mode='suzuki', expansion_order=2, shallow_circuit_concat=False, quantum_instance=None)">
  ...
  *   **quantum\_instance** (`Union`\[`QuantumInstance`, `Backend`, `BaseBackend`, `None`]) – Quantum Instance or Backend
  ...
  <Function id="qiskit.aqua.algorithms.IQPE.__init__" name="__init__" signature="__init__(operator=None, state_in=None, num_time_slices=1, num_iterations=1, expansion_mode='suzuki', expansion_order=2, shallow_circuit_concat=False, quantum_instance=None)">
    **Parameters**
  ...
  <Function id="qiskit.aqua.algorithms.IQPE.aux_operators" name="aux_operators" signature="property aux_operators">
  ...
  <Function id="qiskit.aqua.algorithms.IQPE.backend" name="backend" signature="property backend">
    Returns backend.
  ...
  <Function id="qiskit.aqua.algorithms.IQPE.compute_minimum_eigenvalue" name="compute_minimum_eigenvalue" signature="compute_minimum_eigenvalue(operator=None, aux_operators=None)">
  ...
  <Function id="qiskit.aqua.algorithms.IQPE.construct_circuit" name="construct_circuit" signature="construct_circuit(k=None, omega=0, measurement=False)">
  ...
  <Function id="qiskit.aqua.algorithms.IQPE.operator" name="operator" signature="property operator">
    Returns operator
  ...
  <Function id="qiskit.aqua.algorithms.IQPE.quantum_instance" name="quantum_instance" signature="property quantum_instance">
  ...
  <Function id="qiskit.aqua.algorithms.IQPE.random" name="random" signature="property random">
    Return a numpy random.
  </Function>

  ### run

  <Function id="qiskit.aqua.algorithms.IQPE.run" name="run" signature="run(quantum_instance=None, **kwargs)">
  ...
  <Function id="qiskit.aqua.algorithms.IQPE.set_backend" name="set_backend" signature="set_backend(backend, **kwargs)">
  ...
  <Function id="qiskit.aqua.algorithms.IQPE.supports_aux_operators" name="supports_aux_operators" signature="classmethod supports_aux_operators()">
