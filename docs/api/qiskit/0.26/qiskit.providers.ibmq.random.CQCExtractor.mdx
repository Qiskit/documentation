---
title: CQCExtractor (v0.26)
description: API reference for qiskit.providers.ibmq.random.CQCExtractor in qiskit v0.26
...
<Class id="qiskit.providers.ibmq.random.CQCExtractor" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-ibmq-provider/tree/stable/0.13/qiskit/providers/ibmq/random/cqcextractor.py" signature="CQCExtractor(name, provider, client, methods)" modifiers="class">
