...
<Class id="qiskit.circuit.Reset" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.17/qiskit/circuit/reset.py" signature="Reset">
  Qubit reset.
  ...
  <Function id="qiskit.circuit.Reset.__init__" name="__init__" signature="__init__()">
    Create new reset instruction.
  </Function>
  ...
  <Function id="qiskit.circuit.Reset.add_decomposition" name="add_decomposition" signature="add_decomposition(decomposition)">
    Add a decomposition of the instruction to the SessionEquivalenceLibrary.
  </Function>

  ### assemble

  <Function id="qiskit.circuit.Reset.assemble" name="assemble" signature="assemble()">
    Assemble a QasmQobjInstruction
  </Function>

  ### broadcast\_arguments

  <Function id="qiskit.circuit.Reset.broadcast_arguments" name="broadcast_arguments" signature="broadcast_arguments(qargs, cargs)">
  ...
  <Function id="qiskit.circuit.Reset.c_if" name="c_if" signature="c_if(classical, val)">
    Add classical condition on register classical and value val.
  </Function>

  ### copy

  <Function id="qiskit.circuit.Reset.copy" name="copy" signature="copy(name=None)">
  ...
  <Function id="qiskit.circuit.Reset.decompositions" name="decompositions" signature="property decompositions">
    Get the decompositions of the instruction from the SessionEquivalenceLibrary.
  </Function>

  ### definition

  <Function id="qiskit.circuit.Reset.definition" name="definition" signature="property definition">
    Return definition in terms of other basic gates.
  </Function>

  ### duration

  <Function id="qiskit.circuit.Reset.duration" name="duration" signature="property duration">
    Get the duration.
  </Function>

  ### inverse

  <Function id="qiskit.circuit.Reset.inverse" name="inverse" signature="inverse()">
  ...
  <Function id="qiskit.circuit.Reset.is_parameterized" name="is_parameterized" signature="is_parameterized()">
    Return True .IFF. instruction is parameterized else False
  </Function>

  ### mirror

  <Function id="qiskit.circuit.Reset.mirror" name="mirror" signature="mirror()">
  ...
  <Function id="qiskit.circuit.Reset.params" name="params" signature="property params">
    return instruction params.
  </Function>

  ### qasm

  <Function id="qiskit.circuit.Reset.qasm" name="qasm" signature="qasm()">
  ...
  <Function id="qiskit.circuit.Reset.repeat" name="repeat" signature="repeat(n)">
  ...
  <Function id="qiskit.circuit.Reset.reverse_ops" name="reverse_ops" signature="reverse_ops()">
  ...
  <Function id="qiskit.circuit.Reset.soft_compare" name="soft_compare" signature="soft_compare(other)">
  ...
  <Function id="qiskit.circuit.Reset.unit" name="unit" signature="property unit">
    Get the time unit of duration.
  </Function>

  ### validate\_parameter

  <Function id="qiskit.circuit.Reset.validate_parameter" name="validate_parameter" signature="validate_parameter(parameter)">
