---
title: Reset (v0.26)
description: API reference for qiskit.circuit.Reset in qiskit v0.26
...
<Class id="qiskit.circuit.Reset" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.17/qiskit/circuit/reset.py" signature="Reset" modifiers="class">
  Qubit reset.
  ...
  <Attribute id="qiskit.circuit.Reset.duration">
    Get the duration.
  </Attribute>
  ...
  <Attribute id="qiskit.circuit.Reset.unit">
