---
title: SetStabilizer (v0.26)
description: API reference for qiskit.providers.aer.library.SetStabilizer in qiskit v0.26
...
<Class id="qiskit.providers.aer.library.SetStabilizer" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-aer/tree/stable/0.8/qiskit/providers/aer/library/set_instructions/set_stabilizer.py" signature="SetStabilizer(state)" modifiers="class">
  ...
  **state** ([*Clifford*](qiskit.quantum_info.Clifford "qiskit.quantum_info.Clifford")) – A clifford operator.
  ...
  <Function id="qiskit.providers.aer.library.SetStabilizer.__init__" signature="__init__(state)">
    Create new instruction to set the Clifford stabilizer state of the simulator.
  ...
  <Function id="qiskit.providers.aer.library.SetStabilizer.add_decomposition" signature="add_decomposition(decomposition)">
    Add a decomposition of the instruction to the SessionEquivalenceLibrary.
  </Function>

  ### assemble

  <Function id="qiskit.providers.aer.library.SetStabilizer.assemble" signature="assemble()">
    Assemble a QasmQobjInstruction
  </Function>

  ### broadcast\_arguments

  <Function id="qiskit.providers.aer.library.SetStabilizer.broadcast_arguments" signature="broadcast_arguments(qargs, cargs)">
  ...
  <Function id="qiskit.providers.aer.library.SetStabilizer.c_if" signature="c_if(classical, val)">
    Add classical condition on register classical and value val.
  </Function>

  ### copy

  <Function id="qiskit.providers.aer.library.SetStabilizer.copy" signature="copy(name=None)">
  ...
  <Function id="qiskit.providers.aer.library.SetStabilizer.inverse" signature="inverse()">
  ...
  <Function id="qiskit.providers.aer.library.SetStabilizer.is_parameterized" signature="is_parameterized()">
    Return True .IFF. instruction is parameterized else False
  </Function>

  ### mirror

  <Function id="qiskit.providers.aer.library.SetStabilizer.mirror" signature="mirror()">
  ...
  <Function id="qiskit.providers.aer.library.SetStabilizer.qasm" signature="qasm()">
  ...
  <Function id="qiskit.providers.aer.library.SetStabilizer.repeat" signature="repeat(n)">
  ...
  <Function id="qiskit.providers.aer.library.SetStabilizer.reverse_ops" signature="reverse_ops()">
  ...
  <Function id="qiskit.providers.aer.library.SetStabilizer.soft_compare" signature="soft_compare(other)">
  ...
  <Function id="qiskit.providers.aer.library.SetStabilizer.validate_parameter" signature="validate_parameter(parameter)">
