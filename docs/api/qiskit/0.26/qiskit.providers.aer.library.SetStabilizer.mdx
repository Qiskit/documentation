...
<Class id="qiskit.providers.aer.library.SetStabilizer" github="https://github.com/qiskit/qiskit-aer/tree/stable/0.8/qiskit/providers/aer/library/set_instructions/set_stabilizer.py" signature="SetStabilizer(state)">
