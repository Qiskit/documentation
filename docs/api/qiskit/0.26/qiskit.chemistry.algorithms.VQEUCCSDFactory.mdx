...
<Class id="qiskit.chemistry.algorithms.VQEUCCSDFactory" github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/chemistry/algorithms/ground_state_solvers/minimum_eigensolver_factories/vqe_uccsd_factory.py" signature="VQEUCCSDFactory(quantum_instance, optimizer=None, initial_point=None, gradient=None, expectation=None, include_custom=False, method_singles='both', method_doubles='ucc', excitation_type='sd', same_spin_doubles=True)">
  ...
  *   **same\_spin\_doubles** (`bool`) – enable double excitations of the same spin.
  ...
  <Function id="qiskit.chemistry.algorithms.VQEUCCSDFactory.__init__" name="__init__" signature="__init__(quantum_instance, optimizer=None, initial_point=None, gradient=None, expectation=None, include_custom=False, method_singles='both', method_doubles='ucc', excitation_type='sd', same_spin_doubles=True)">
    **Parameters**
  ...
  <Function id="qiskit.chemistry.algorithms.VQEUCCSDFactory.excitation_type" name="excitation_type" signature="property excitation_type">
  ...
  <Function id="qiskit.chemistry.algorithms.VQEUCCSDFactory.expectation" name="expectation" signature="property expectation">
  ...
  <Function id="qiskit.chemistry.algorithms.VQEUCCSDFactory.get_solver" name="get_solver" signature="get_solver(transformation)">
  ...
  <Function id="qiskit.chemistry.algorithms.VQEUCCSDFactory.gradient" name="gradient" signature="property gradient">
  ...
  <Function id="qiskit.chemistry.algorithms.VQEUCCSDFactory.include_custom" name="include_custom" signature="property include_custom">
  ...
  <Function id="qiskit.chemistry.algorithms.VQEUCCSDFactory.initial_point" name="initial_point" signature="property initial_point">
  ...
  <Function id="qiskit.chemistry.algorithms.VQEUCCSDFactory.method_doubles" name="method_doubles" signature="property method_doubles">
  ...
  <Function id="qiskit.chemistry.algorithms.VQEUCCSDFactory.method_singles" name="method_singles" signature="property method_singles">
  ...
  <Function id="qiskit.chemistry.algorithms.VQEUCCSDFactory.optimizer" name="optimizer" signature="property optimizer">
  ...
  <Function id="qiskit.chemistry.algorithms.VQEUCCSDFactory.quantum_instance" name="quantum_instance" signature="property quantum_instance">
  ...
  <Function id="qiskit.chemistry.algorithms.VQEUCCSDFactory.same_spin_doubles" name="same_spin_doubles" signature="property same_spin_doubles">
  ...
  <Function id="qiskit.chemistry.algorithms.VQEUCCSDFactory.supports_aux_operators" name="supports_aux_operators" signature="supports_aux_operators()">
