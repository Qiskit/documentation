---
title: SetDensityMatrix (v0.26)
description: API reference for qiskit.providers.aer.library.SetDensityMatrix in qiskit v0.26
...
<Class id="qiskit.providers.aer.library.SetDensityMatrix" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-aer/tree/stable/0.8/qiskit/providers/aer/library/set_instructions/set_density_matrix.py" signature="SetDensityMatrix(state)" modifiers="class">
  ...
  **ExtensionError** – if the input density matrix is not valid.
  ...
  <Function id="qiskit.providers.aer.library.SetDensityMatrix.__init__" signature="__init__(state)">
    Create new instruction to set the density matrix state of the simulator.
  ...
  <Function id="qiskit.providers.aer.library.SetDensityMatrix.add_decomposition" signature="add_decomposition(decomposition)">
    Add a decomposition of the instruction to the SessionEquivalenceLibrary.
  </Function>

  ### assemble

  <Function id="qiskit.providers.aer.library.SetDensityMatrix.assemble" signature="assemble()">
    Assemble a QasmQobjInstruction
  </Function>

  ### broadcast\_arguments

  <Function id="qiskit.providers.aer.library.SetDensityMatrix.broadcast_arguments" signature="broadcast_arguments(qargs, cargs)">
  ...
  <Function id="qiskit.providers.aer.library.SetDensityMatrix.c_if" signature="c_if(classical, val)">
    Add classical condition on register classical and value val.
  </Function>

  ### copy

  <Function id="qiskit.providers.aer.library.SetDensityMatrix.copy" signature="copy(name=None)">
  ...
  <Function id="qiskit.providers.aer.library.SetDensityMatrix.inverse" signature="inverse()">
  ...
  <Function id="qiskit.providers.aer.library.SetDensityMatrix.is_parameterized" signature="is_parameterized()">
    Return True .IFF. instruction is parameterized else False
  </Function>

  ### mirror

  <Function id="qiskit.providers.aer.library.SetDensityMatrix.mirror" signature="mirror()">
  ...
  <Function id="qiskit.providers.aer.library.SetDensityMatrix.qasm" signature="qasm()">
  ...
  <Function id="qiskit.providers.aer.library.SetDensityMatrix.repeat" signature="repeat(n)">
  ...
  <Function id="qiskit.providers.aer.library.SetDensityMatrix.reverse_ops" signature="reverse_ops()">
  ...
  <Function id="qiskit.providers.aer.library.SetDensityMatrix.soft_compare" signature="soft_compare(other)">
  ...
  <Function id="qiskit.providers.aer.library.SetDensityMatrix.validate_parameter" signature="validate_parameter(parameter)">
