---
title: BasicAerProvider (v0.26)
description: API reference for qiskit.providers.basicaer.BasicAerProvider in qiskit v0.26
...
<Class id="qiskit.providers.basicaer.BasicAerProvider" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.17/qiskit/providers/basicaer/basicaerprovider.py" signature="BasicAerProvider" modifiers="class">
