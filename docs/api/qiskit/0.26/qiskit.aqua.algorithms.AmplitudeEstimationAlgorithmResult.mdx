...
<Class id="qiskit.aqua.algorithms.AmplitudeEstimationAlgorithmResult" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/aqua/algorithms/amplitude_estimators/ae_algorithm.py" signature="AmplitudeEstimationAlgorithmResult(a_dict=None)">
  AmplitudeEstimationAlgorithm Result.

  ### \_\_init\_\_

  <Function id="qiskit.aqua.algorithms.AmplitudeEstimationAlgorithmResult.__init__" name="__init__" signature="__init__(a_dict=None)">
  ...
  <Function id="qiskit.aqua.algorithms.AmplitudeEstimationAlgorithmResult.a_estimation" name="a_estimation" signature="property a_estimation">
  ...
  <Function id="qiskit.aqua.algorithms.AmplitudeEstimationAlgorithmResult.clear" name="clear" signature="clear()">
    **Return type**
  ...
  <Function id="qiskit.aqua.algorithms.AmplitudeEstimationAlgorithmResult.combine" name="combine" signature="combine(result)">
  ...
  <Function id="qiskit.aqua.algorithms.AmplitudeEstimationAlgorithmResult.confidence_interval" name="confidence_interval" signature="property confidence_interval">
  ...
  <Function id="qiskit.aqua.algorithms.AmplitudeEstimationAlgorithmResult.estimation" name="estimation" signature="property estimation">
    return estimation
  ...
  <Function id="qiskit.aqua.algorithms.AmplitudeEstimationAlgorithmResult.from_dict" name="from_dict" signature="static from_dict(a_dict)">
  ...
  <Function id="qiskit.aqua.algorithms.AmplitudeEstimationAlgorithmResult.get" name="get" signature="get(k[, d]) → D[k] if k in D, else d. d defaults to None." />

  ### items

  <Function id="qiskit.aqua.algorithms.AmplitudeEstimationAlgorithmResult.items" name="items" signature="items() → a set-like object providing a view on D’s items" />

  ### keys

  <Function id="qiskit.aqua.algorithms.AmplitudeEstimationAlgorithmResult.keys" name="keys" signature="keys() → a set-like object providing a view on D’s keys" />

  ### num\_oracle\_queries

  <Function id="qiskit.aqua.algorithms.AmplitudeEstimationAlgorithmResult.num_oracle_queries" name="num_oracle_queries" signature="property num_oracle_queries">
  ...
  <Function id="qiskit.aqua.algorithms.AmplitudeEstimationAlgorithmResult.pop" name="pop" signature="pop(key, default=None)">
  ...
  <Function id="qiskit.aqua.algorithms.AmplitudeEstimationAlgorithmResult.popitem" name="popitem" signature="popitem()">
  ...
  <Function id="qiskit.aqua.algorithms.AmplitudeEstimationAlgorithmResult.setdefault" name="setdefault" signature="setdefault(k[, d]) → D.get(k,d), also set D[k]=d if k not in D" />

  ### update

  <Function id="qiskit.aqua.algorithms.AmplitudeEstimationAlgorithmResult.update" name="update" signature="update(*args, **kwargs)">
  ...
  <Function id="qiskit.aqua.algorithms.AmplitudeEstimationAlgorithmResult.values" name="values" signature="values() → an object providing a view on D’s values" />
</Class>
