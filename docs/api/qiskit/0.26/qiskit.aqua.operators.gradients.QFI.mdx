...
$$
  ...
  **ValueError** – if `qfi_method` is neither a `CircuitQFI` object nor one of the predefined strings.
  ...
  <Function id="qiskit.aqua.operators.gradients.QFI.parameter_expression_grad" signature="parameter_expression_grad(param_expr, param)" modifiers="static">
  ...
  <Function id="qiskit.aqua.operators.gradients.QFI.qfi_method" signature="qfi_method" modifiers="property">
    Returns `CircuitQFI`.
