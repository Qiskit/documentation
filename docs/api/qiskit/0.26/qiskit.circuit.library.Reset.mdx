...
<Class id="qiskit.circuit.library.Reset" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.17/qiskit/circuit/reset.py" signature="Reset">
  Qubit reset.
  ...
  <Function id="qiskit.circuit.library.Reset.__init__" name="__init__" signature="__init__()">
    Create new reset instruction.
  </Function>
  ...
  <Function id="qiskit.circuit.library.Reset.decompositions" name="decompositions" signature="property decompositions">
    Get the decompositions of the instruction from the SessionEquivalenceLibrary.
  </Function>

  ### definition

  <Function id="qiskit.circuit.library.Reset.definition" name="definition" signature="property definition">
    Return definition in terms of other basic gates.
  </Function>

  ### duration

  <Function id="qiskit.circuit.library.Reset.duration" name="duration" signature="property duration">
    Get the duration.
  </Function>
  ...
  <Function id="qiskit.circuit.library.Reset.mirror" name="mirror" signature="mirror()">
  ...
  <Function id="qiskit.circuit.library.Reset.params" name="params" signature="property params">
  ...
  <Function id="qiskit.circuit.library.Reset.unit" name="unit" signature="property unit">
