---
title: LinearPauliRotations (v0.26)
description: API reference for qiskit.circuit.library.LinearPauliRotations in qiskit v0.26
  ...
  *   **name** (`str`) – The name of the circuit object.
  ...
  <Function id="qiskit.circuit.library.LinearPauliRotations.draw" signature="draw(output=None, scale=None, filename=None, style=None, interactive=False, plot_barriers=True, reverse_bits=False, justify=None, vertical_compression='medium', idle_wires=True, with_layout=True, fold=None, ax=None, initial_state=False, cregbundle=True)">
    ...
    **Example**
    ...
    ![../\_images/qiskit.circuit.library.LinearPauliRotations\_2\_0.png](/docs/images/api/qiskit/0.26/qiskit.circuit.library.LinearPauliRotations_2_0.avif)
  </Function>
