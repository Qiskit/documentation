...
<Class id="qiskit.aqua.operators.expectations.PauliExpectation" github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/aqua/operators/expectations/pauli_expectation.py" signature="PauliExpectation(group_paulis=True)">
  ...
  **group\_paulis** (`bool`) – Whether to group the Pauli measurements into commuting sums, which all have the same diagonalizing circuit.
  ...
  <Function id="qiskit.aqua.operators.expectations.PauliExpectation.__init__" name="__init__" signature="__init__(group_paulis=True)">
    **Parameters**
  ...
  <Function id="qiskit.aqua.operators.expectations.PauliExpectation.compute_variance" name="compute_variance" signature="compute_variance(exp_op)">
  ...
  <Function id="qiskit.aqua.operators.expectations.PauliExpectation.convert" name="convert" signature="convert(operator)">
