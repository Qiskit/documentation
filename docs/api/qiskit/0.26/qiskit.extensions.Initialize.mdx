...
<Class id="qiskit.extensions.Initialize" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.17/qiskit/extensions/quantum_initializer/initializer.py" signature="Initialize(params, num_qubits=None)">
  ...
  **num\_qubits (int): This parameter is only used if params is an int. Indicates the total**
  ...
  <Function id="qiskit.extensions.Initialize.__init__" name="__init__" signature="__init__(params, num_qubits=None)">
    Create new initialize composite.
  ...
  <Function id="qiskit.extensions.Initialize.decompositions" name="decompositions" signature="property decompositions">
    Get the decompositions of the instruction from the SessionEquivalenceLibrary.
  </Function>

  ### definition

  <Function id="qiskit.extensions.Initialize.definition" name="definition" signature="property definition">
    Return definition in terms of other basic gates.
  </Function>

  ### duration

  <Function id="qiskit.extensions.Initialize.duration" name="duration" signature="property duration">
    Get the duration.
  </Function>
  ...
  <Function id="qiskit.extensions.Initialize.mirror" name="mirror" signature="mirror()">
  ...
  <Function id="qiskit.extensions.Initialize.params" name="params" signature="property params">
  ...
  <Function id="qiskit.extensions.Initialize.unit" name="unit" signature="property unit">
