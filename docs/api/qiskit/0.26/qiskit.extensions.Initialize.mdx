...
<Class id="qiskit.extensions.Initialize" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.17/qiskit/extensions/quantum_initializer/initializer.py" signature="Initialize(params, num_qubits=None)" modifiers="class">
  ...
  **num\_qubits (int): This parameter is only used if params is an int. Indicates the total**
  ...
  <Function id="qiskit.extensions.Initialize.decompositions" signature="decompositions" modifiers="property">
    Get the decompositions of the instruction from the SessionEquivalenceLibrary.
  </Function>

  ### definition

  <Function id="qiskit.extensions.Initialize.definition" signature="definition" modifiers="property">
    Return definition in terms of other basic gates.
  </Function>

  ### duration

  <Function id="qiskit.extensions.Initialize.duration" signature="duration" modifiers="property">
    Get the duration.
  </Function>
  ...
  <Function id="qiskit.extensions.Initialize.params" signature="params" modifiers="property">
  ...
  <Function id="qiskit.extensions.Initialize.unit" signature="unit" modifiers="property">
