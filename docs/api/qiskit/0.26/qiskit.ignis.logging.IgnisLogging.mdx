...
<Class id="qiskit.ignis.logging.IgnisLogging" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-ignis/tree/stable/0.6/qiskit/ignis/logging/ignis_logging.py" signature="IgnisLogging(log_config_path=None)">
  ...
  **Config file fields:**
  ...
  <Function id="qiskit.ignis.logging.IgnisLogging.__init__" name="__init__" signature="__init__()">
  ...
  <Function id="qiskit.ignis.logging.IgnisLogging.default_datetime_fmt" name="default_datetime_fmt" signature="default_datetime_fmt()">
  ...
  <Function id="qiskit.ignis.logging.IgnisLogging.get_file_handler" name="get_file_handler" signature="get_file_handler()">
  ...
  <Function id="qiskit.ignis.logging.IgnisLogging.get_log_file" name="get_log_file" signature="get_log_file()">
  ...
  <Function id="qiskit.ignis.logging.IgnisLogging.get_logger" name="get_logger" signature="get_logger(name)">
