...
<Function id="qiskit.aqua.utils.random_unitary" github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/aqua/utils/random_matrix_generator.py" signature="random_unitary(N)">
