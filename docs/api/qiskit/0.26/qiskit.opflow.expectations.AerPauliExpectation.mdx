---
title: AerPauliExpectation (v0.26)
description: API reference for qiskit.opflow.expectations.AerPauliExpectation in qiskit v0.26
...
<Class id="qiskit.opflow.expectations.AerPauliExpectation" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.17/qiskit/opflow/expectations/aer_pauli_expectation.py" signature="AerPauliExpectation" modifiers="class">
  ...
  <Function id="qiskit.opflow.expectations.AerPauliExpectation.__init__" signature="__init__()">
