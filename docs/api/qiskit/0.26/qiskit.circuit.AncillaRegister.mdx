...
<Class id="qiskit.circuit.AncillaRegister" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.17/qiskit/circuit/quantumregister.py" signature="AncillaRegister(size=None, name=None, bits=None)">
  ...
  *   **CircuitError** – if `bits` contained bits of an incorrect type.
  ...
  <Function id="qiskit.circuit.AncillaRegister.__init__" name="__init__" signature="__init__(size=None, name=None, bits=None)">
    Create a new generic register.
  ...
  <Attribute id="qiskit.circuit.AncillaRegister.bit_type" name="bit_type">
    alias of [`AncillaQubit`](qiskit.circuit.AncillaQubit "qiskit.circuit.AncillaQubit")
  </Attribute>

  ### name

  <Function id="qiskit.circuit.AncillaRegister.name" name="name" signature="property name">
  ...
  <Function id="qiskit.circuit.AncillaRegister.size" name="size" signature="property size">
