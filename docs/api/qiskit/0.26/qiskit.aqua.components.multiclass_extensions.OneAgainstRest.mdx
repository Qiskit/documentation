...
<Class id="qiskit.aqua.components.multiclass_extensions.OneAgainstRest" github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/aqua/components/multiclass_extensions/one_against_rest.py" signature="OneAgainstRest">
  ...
  <Function id="qiskit.aqua.components.multiclass_extensions.OneAgainstRest.__init__" name="__init__" signature="__init__()">
  ...
  <Function id="qiskit.aqua.components.multiclass_extensions.OneAgainstRest.predict" name="predict" signature="predict(x)">
  ...
  <Function id="qiskit.aqua.components.multiclass_extensions.OneAgainstRest.set_estimator" name="set_estimator" signature="set_estimator(estimator_cls, params=None)">
  ...
  <Function id="qiskit.aqua.components.multiclass_extensions.OneAgainstRest.test" name="test" signature="test(x, y)">
  ...
  <Function id="qiskit.aqua.components.multiclass_extensions.OneAgainstRest.train" name="train" signature="train(x, y)">
