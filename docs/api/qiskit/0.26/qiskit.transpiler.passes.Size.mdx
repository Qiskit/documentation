---
title: Size (v0.26)
description: API reference for qiskit.transpiler.passes.Size in qiskit v0.26
...
<Class id="qiskit.transpiler.passes.Size" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.17/qiskit/transpiler/passes/analysis/size.py" signature="Size(*args, **kwargs)" modifiers="class">
