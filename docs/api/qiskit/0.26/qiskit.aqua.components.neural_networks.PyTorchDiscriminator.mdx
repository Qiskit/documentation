...
<Class id="qiskit.aqua.components.neural_networks.PyTorchDiscriminator" github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/aqua/components/neural_networks/pytorch_discriminator.py" signature="PyTorchDiscriminator(n_features=1, n_out=1)">
  ...
  **Raises**
  ...
  <Function id="qiskit.aqua.components.neural_networks.PyTorchDiscriminator.train" name="train" signature="train(data, weights, penalty=False, quantum_instance=None, shots=None)">
