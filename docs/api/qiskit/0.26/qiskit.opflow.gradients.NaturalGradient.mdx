...
<Class id="qiskit.opflow.gradients.NaturalGradient" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.17/qiskit/opflow/gradients/natural_gradient.py" signature="NaturalGradient(grad_method='lin_comb', qfi_method='lin_comb_full', regularization=None, **kwargs)">
  ...
  *   **kwargs** (*dict*) – Optional parameters for a CircuitGradient
  ...
  <Function id="qiskit.opflow.gradients.NaturalGradient.grad_method" signature="property grad_method">
  ...
  <Function id="qiskit.opflow.gradients.NaturalGradient.parameter_expression_grad" signature="static parameter_expression_grad(param_expr, param)">
  ...
  <Function id="qiskit.opflow.gradients.NaturalGradient.qfi_method" signature="property qfi_method">
    Returns `CircuitQFI`.
  ...
  <Function id="qiskit.opflow.gradients.NaturalGradient.regularization" signature="property regularization">
