...
<Class id="qiskit.opflow.OpflowError" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.17/qiskit/opflow/exceptions.py" signature="OpflowError(*message)">
