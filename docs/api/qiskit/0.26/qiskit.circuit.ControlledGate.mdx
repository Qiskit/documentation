...
<Class id="qiskit.circuit.ControlledGate" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.17/qiskit/circuit/controlledgate.py" signature="ControlledGate(name, num_qubits, params, label=None, num_ctrl_qubits=1, definition=None, ctrl_state=None, base_gate=None)">
  ...
  *   **CircuitError** – ctrl\_state \< 0 or ctrl\_state > 2\*\*num\_ctrl\_qubits.
  ...
  <Function id="qiskit.circuit.ControlledGate.ctrl_state" signature="property ctrl_state">
  ...
  <Function id="qiskit.circuit.ControlledGate.decompositions" signature="property decompositions">
    Get the decompositions of the instruction from the SessionEquivalenceLibrary.
  </Function>

  ### definition

  <Function id="qiskit.circuit.ControlledGate.definition" signature="property definition">
  ...
  <Function id="qiskit.circuit.ControlledGate.duration" signature="property duration">
    Get the duration.
  </Function>
  ...
  <Function id="qiskit.circuit.ControlledGate.label" signature="property label">
    Return gate label
  ...
  <Function id="qiskit.circuit.ControlledGate.name" signature="property name">
  ...
  <Function id="qiskit.circuit.ControlledGate.num_ctrl_qubits" signature="property num_ctrl_qubits">
  ...
  <Function id="qiskit.circuit.ControlledGate.params" signature="property params">
  ...
  <Function id="qiskit.circuit.ControlledGate.unit" signature="property unit">
