...
<Function id="qiskit.aqua.operators.legacy.row_echelon_F2" github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/aqua/operators/legacy/common.py" signature="row_echelon_F2(matrix_in)">
