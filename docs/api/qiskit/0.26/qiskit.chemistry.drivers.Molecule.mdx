...
<Class id="qiskit.chemistry.drivers.Molecule" github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/chemistry/drivers/molecule.py" signature="Molecule(geometry, multiplicity=1, charge=0, degrees_of_freedom=None, masses=None)">
  ...
  **ValueError** – Length of masses must match length of geometries.
  ...
  <Function id="qiskit.chemistry.drivers.Molecule.__init__" name="__init__" signature="__init__(geometry, multiplicity=1, charge=0, degrees_of_freedom=None, masses=None)">
    **Parameters**
  ...
  <Function id="qiskit.chemistry.drivers.Molecule.absolute_angle" name="absolute_angle" signature="classmethod absolute_angle(angle, geometry, atom_trio)">
    **Parameters**
  ...
  <Function id="qiskit.chemistry.drivers.Molecule.absolute_bending" name="absolute_bending" signature="classmethod absolute_bending(bend, geometry, atom_trio)">
    **Parameters**
  ...
  <Function id="qiskit.chemistry.drivers.Molecule.absolute_distance" name="absolute_distance" signature="classmethod absolute_distance(distance, geometry, atom_pair)">
    **Parameters**
  ...
  <Function id="qiskit.chemistry.drivers.Molecule.absolute_stretching" name="absolute_stretching" signature="classmethod absolute_stretching(perturbation, geometry, atom_pair)">
    **Parameters**
  ...
  <Function id="qiskit.chemistry.drivers.Molecule.charge" name="charge" signature="property charge">
    Get charge
  ...
  <Function id="qiskit.chemistry.drivers.Molecule.geometry" name="geometry" signature="property geometry">
  ...
  <Function id="qiskit.chemistry.drivers.Molecule.masses" name="masses" signature="property masses">
    Get masses
  ...
  <Function id="qiskit.chemistry.drivers.Molecule.multiplicity" name="multiplicity" signature="property multiplicity">
    Get multiplicity
  ...
  <Function id="qiskit.chemistry.drivers.Molecule.perturbations" name="perturbations" signature="property perturbations">
    Get perturbations
  ...
  <Function id="qiskit.chemistry.drivers.Molecule.relative_bending" name="relative_bending" signature="classmethod relative_bending(bend, geometry, atom_trio)">
    **Parameters**
  ...
  <Function id="qiskit.chemistry.drivers.Molecule.relative_stretching" name="relative_stretching" signature="classmethod relative_stretching(perturbation, geometry, atom_pair)">
    **Parameters**
  ...
  <Function id="qiskit.chemistry.drivers.Molecule.units" name="units" signature="property units">
