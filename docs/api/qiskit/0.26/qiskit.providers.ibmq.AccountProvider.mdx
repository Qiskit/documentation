...
<Class id="qiskit.providers.ibmq.AccountProvider" github="https://github.com/qiskit/qiskit-ibmq-provider/tree/stable/0.13/qiskit/providers/ibmq/accountprovider.py" signature="AccountProvider(credentials)">
