...
| [`c_if`](#qiskit.providers.aer.library.SaveMatrixProductState.c_if "qiskit.providers.aer.library.SaveMatrixProductState.c_if")(classical, val)                                            | Add classical condition on register classical and value val.             |
