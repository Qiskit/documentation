...
<Class id="qiskit.ignis.characterization.DragFitter" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-ignis/tree/stable/0.6/qiskit/ignis/characterization/calibrations/fitters.py" signature="DragFitter(backend_result, xdata, qubits, fit_p0, fit_bounds=None)">
  ...
  <Function id="qiskit.ignis.characterization.DragFitter.backend_result" signature="property backend_result">
  ...
  <Function id="qiskit.ignis.characterization.DragFitter.description" signature="property description">
  ...
  <Function id="qiskit.ignis.characterization.DragFitter.fit_fun" signature="property fit_fun">
  ...
  <Function id="qiskit.ignis.characterization.DragFitter.measured_qubits" signature="property measured_qubits">
  ...
  <Function id="qiskit.ignis.characterization.DragFitter.params" signature="property params">
  ...
  <Function id="qiskit.ignis.characterization.DragFitter.params_err" signature="property params_err">
  ...
  <Function id="qiskit.ignis.characterization.DragFitter.series" signature="property series">
  ...
  <Function id="qiskit.ignis.characterization.DragFitter.xdata" signature="property xdata">
  ...
  <Function id="qiskit.ignis.characterization.DragFitter.ydata" signature="property ydata">
