...
<Class id="qiskit.chemistry.results.BOPESSamplerResult" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/chemistry/results/bopes_sampler_result.py" signature="BOPESSamplerResult(points, energies, raw_results)" modifiers="class">
  ...
  <Function id="qiskit.chemistry.results.BOPESSamplerResult.energies" signature="energies" modifiers="property">
  ...
  <Function id="qiskit.chemistry.results.BOPESSamplerResult.points" signature="points" modifiers="property">
  ...
  <Function id="qiskit.chemistry.results.BOPESSamplerResult.raw_results" signature="raw_results" modifiers="property">
