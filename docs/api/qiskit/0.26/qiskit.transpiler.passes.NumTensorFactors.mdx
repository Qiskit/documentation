...
<Class id="qiskit.transpiler.passes.NumTensorFactors" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.17/qiskit/transpiler/passes/analysis/num_tensor_factors.py" signature="NumTensorFactors(*args, **kwargs)" modifiers="class">
  ...
  <Function id="qiskit.transpiler.passes.NumTensorFactors.__init__" signature="__init__()">
  ...
  <Function id="qiskit.transpiler.passes.NumTensorFactors.is_analysis_pass" signature="is_analysis_pass" modifiers="property">
  ...
  <Function id="qiskit.transpiler.passes.NumTensorFactors.is_transformation_pass" signature="is_transformation_pass" modifiers="property">
