...
<Class id="qiskit.opflow.converters.PauliBasisChange" github="https://github.com/qiskit/qiskit/tree/stable/0.17/qiskit/opflow/converters/pauli_basis_change.py" signature="PauliBasisChange(destination_basis=None, traverse=True, replacement_fn=None)">
  ...
  *   **replacement\_fn** (`Optional`\[`Callable`]) –
  ...
  <Function id="qiskit.opflow.converters.PauliBasisChange.__init__" name="__init__" signature="__init__(destination_basis=None, traverse=True, replacement_fn=None)">
    **Parameters**
  ...
  <Function id="qiskit.opflow.converters.PauliBasisChange.construct_cnot_chain" name="construct_cnot_chain" signature="construct_cnot_chain(diag_pauli_op1, diag_pauli_op2)">
  ...
  <Function id="qiskit.opflow.converters.PauliBasisChange.convert" name="convert" signature="convert(operator)">
  ...
  <Function id="qiskit.opflow.converters.PauliBasisChange.destination" name="destination" signature="property destination">
  ...
  <Function id="qiskit.opflow.converters.PauliBasisChange.get_cob_circuit" name="get_cob_circuit" signature="get_cob_circuit(origin)">
  ...
  <Function id="qiskit.opflow.converters.PauliBasisChange.get_diagonal_pauli_op" name="get_diagonal_pauli_op" signature="get_diagonal_pauli_op(pauli_op)">
  ...
  <Function id="qiskit.opflow.converters.PauliBasisChange.get_diagonalizing_clifford" name="get_diagonalizing_clifford" signature="get_diagonalizing_clifford(pauli)">
  ...
  <Function id="qiskit.opflow.converters.PauliBasisChange.get_tpb_pauli" name="get_tpb_pauli" signature="get_tpb_pauli(list_op)">
  ...
  <Function id="qiskit.opflow.converters.PauliBasisChange.measurement_replacement_fn" name="measurement_replacement_fn" signature="static measurement_replacement_fn(cob_instr_op, dest_pauli_op)">
  ...
  <Function id="qiskit.opflow.converters.PauliBasisChange.operator_replacement_fn" name="operator_replacement_fn" signature="static operator_replacement_fn(cob_instr_op, dest_pauli_op)">
  ...
  <Function id="qiskit.opflow.converters.PauliBasisChange.pad_paulis_to_equal_length" name="pad_paulis_to_equal_length" signature="pad_paulis_to_equal_length(pauli_op1, pauli_op2)">
  ...
  <Function id="qiskit.opflow.converters.PauliBasisChange.statefn_replacement_fn" name="statefn_replacement_fn" signature="static statefn_replacement_fn(cob_instr_op, dest_pauli_op)">
