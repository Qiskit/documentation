...
<Class id="qiskit.ignis.verification.QVFitter" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-ignis/tree/stable/0.6/qiskit/ignis/verification/quantum_volume/fitters.py" signature="QVFitter(backend_result=None, statevector_result=None, qubit_lists=None)">
  ...
  *   **qubit\_lists** (*list*) – list of qubit lists (what was passed to the circuit generation)
  ...
  <Function id="qiskit.ignis.verification.QVFitter.__init__" name="__init__" signature="__init__(backend_result=None, statevector_result=None, qubit_lists=None)">
    **Parameters**
  ...
  <Function id="qiskit.ignis.verification.QVFitter.add_data" name="add_data" signature="add_data(new_backend_result, rerun_fit=True)">
  ...
  <Function id="qiskit.ignis.verification.QVFitter.add_statevectors" name="add_statevectors" signature="add_statevectors(new_statevector_result)">
  ...
  <Function id="qiskit.ignis.verification.QVFitter.calc_confidence_level" name="calc_confidence_level" signature="calc_confidence_level(z_value)">
  ...
  <Function id="qiskit.ignis.verification.QVFitter.calc_data" name="calc_data" signature="calc_data()">
  ...
  <Function id="qiskit.ignis.verification.QVFitter.calc_statistics" name="calc_statistics" signature="calc_statistics()">
  ...
  <Function id="qiskit.ignis.verification.QVFitter.calc_z_value" name="calc_z_value" signature="calc_z_value(mean, sigma)">
  ...
  <Function id="qiskit.ignis.verification.QVFitter.depths" name="depths" signature="property depths">
    Return depth list.
  </Function>

  ### heavy\_output\_counts

  <Function id="qiskit.ignis.verification.QVFitter.heavy_output_counts" name="heavy_output_counts" signature="property heavy_output_counts">
    Return the number of heavy output counts as measured.
  </Function>

  ### heavy\_output\_prob\_ideal

  <Function id="qiskit.ignis.verification.QVFitter.heavy_output_prob_ideal" name="heavy_output_prob_ideal" signature="property heavy_output_prob_ideal">
    Return the heavy output probability ideally.
  </Function>

  ### heavy\_outputs

  <Function id="qiskit.ignis.verification.QVFitter.heavy_outputs" name="heavy_outputs" signature="property heavy_outputs">
    Return the ideal heavy outputs dictionary.
  </Function>

  ### plot\_hop\_accumulative

  <Function id="qiskit.ignis.verification.QVFitter.plot_hop_accumulative" name="plot_hop_accumulative" signature="plot_hop_accumulative(depth, ax=None, figsize=(7, 5))">
  ...
  <Function id="qiskit.ignis.verification.QVFitter.plot_qv_data" name="plot_qv_data" signature="plot_qv_data(ax=None, show_plt=True, figsize=(7, 5), set_title=True, title=None)">
  ...
  <Function id="qiskit.ignis.verification.QVFitter.plot_qv_trial" name="plot_qv_trial" signature="plot_qv_trial(depth, trial_index, figsize=(7, 5), ax=None)">
  ...
  <Function id="qiskit.ignis.verification.QVFitter.quantum_volume" name="quantum_volume" signature="quantum_volume()">
  ...
  <Function id="qiskit.ignis.verification.QVFitter.qubit_lists" name="qubit_lists" signature="property qubit_lists">
    Return depth list.
  </Function>

  ### qv\_success

  <Function id="qiskit.ignis.verification.QVFitter.qv_success" name="qv_success" signature="qv_success()">
  ...
  <Function id="qiskit.ignis.verification.QVFitter.results" name="results" signature="property results">
    Return all the results.
  </Function>

  ### ydata

  <Function id="qiskit.ignis.verification.QVFitter.ydata" name="ydata" signature="property ydata">
