---
title: least_busy (v0.26)
description: API reference for qiskit.providers.ibmq.least_busy in qiskit v0.26
...
<Function id="qiskit.providers.ibmq.least_busy" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-ibmq-provider/tree/stable/0.13/qiskit/providers/ibmq/__init__.py" signature="least_busy(backends, reservation_lookahead=60)">
