...
<Class id="qiskit.circuit.EquivalenceLibrary" github="https://github.com/qiskit/qiskit/tree/stable/0.17/qiskit/circuit/equivalence.py" signature="EquivalenceLibrary(*, base=None)">
