---
title: TaperedPauliSumOp (v0.26)
description: API reference for qiskit.opflow.primitive_ops.TaperedPauliSumOp in qiskit v0.26
in_page_toc_min_heading_level: 1
python_api_type: class
python_api_name: qiskit.opflow.primitive_ops.TaperedPauliSumOp
---

<span id="qiskit-opflow-primitive-ops-taperedpaulisumop" />

# qiskit.opflow\.primitive\_ops.TaperedPauliSumOp

<Class id="qiskit.opflow.primitive_ops.TaperedPauliSumOp" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.17/qiskit/opflow/primitive_ops/tapered_pauli_sum_op.py" signature="TaperedPauliSumOp(primitive, z2_symmetries, coeff=1.0)" modifiers="class">
  ...
  **TypeError** – invalid parameters.
  ...
  <Attribute id="qiskit.opflow.primitive_ops.TaperedPauliSumOp.primitive">
