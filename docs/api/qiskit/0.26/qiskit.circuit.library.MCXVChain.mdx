...
<Class id="qiskit.circuit.library.MCXVChain" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.17/qiskit/circuit/library/standard_gates/x.py" signature="MCXVChain(num_ctrl_qubits=None, dirty_ancillas=False, label=None, ctrl_state=None)" modifiers="class">
  ...
  <Function id="qiskit.circuit.library.MCXVChain.ctrl_state" signature="ctrl_state" modifiers="property">
  ...
  <Function id="qiskit.circuit.library.MCXVChain.decompositions" signature="decompositions" modifiers="property">
    Get the decompositions of the instruction from the SessionEquivalenceLibrary.
  </Function>

  ### definition

  <Function id="qiskit.circuit.library.MCXVChain.definition" signature="definition" modifiers="property">
  ...
  <Function id="qiskit.circuit.library.MCXVChain.duration" signature="duration" modifiers="property">
    Get the duration.
  </Function>
  ...
  <Function id="qiskit.circuit.library.MCXVChain.label" signature="label" modifiers="property">
    Return gate label
  ...
  <Function id="qiskit.circuit.library.MCXVChain.name" signature="name" modifiers="property">
  ...
  <Function id="qiskit.circuit.library.MCXVChain.num_ancilla_qubits" signature="num_ancilla_qubits" modifiers="property">
    The number of ancilla qubits.
  </Function>

  ### num\_ctrl\_qubits

  <Function id="qiskit.circuit.library.MCXVChain.num_ctrl_qubits" signature="num_ctrl_qubits" modifiers="property">
  ...
  <Function id="qiskit.circuit.library.MCXVChain.params" signature="params" modifiers="property">
  ...
  <Function id="qiskit.circuit.library.MCXVChain.unit" signature="unit" modifiers="property">
