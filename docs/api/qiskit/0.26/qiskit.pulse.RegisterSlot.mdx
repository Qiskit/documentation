---
title: RegisterSlot (v0.26)
description: API reference for qiskit.pulse.RegisterSlot in qiskit v0.26
...
<Class id="qiskit.pulse.RegisterSlot" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.17/qiskit/pulse/channels.py" signature="RegisterSlot(index)" modifiers="class">
