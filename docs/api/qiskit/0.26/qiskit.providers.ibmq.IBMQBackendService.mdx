...
<Class id="qiskit.providers.ibmq.IBMQBackendService" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-ibmq-provider/tree/stable/0.13/qiskit/providers/ibmq/ibmqbackendservice.py" signature="IBMQBackendService(provider)">
  ...
  **provider** (`AccountProvider`) – IBM Quantum Experience account provider.
  ...
  <Function id="qiskit.providers.ibmq.IBMQBackendService.__init__" name="__init__" signature="__init__(provider)">
    IBMQBackendService constructor.
  ...
  <Function id="qiskit.providers.ibmq.IBMQBackendService.backends" name="backends" signature="backends(name=None, filters=None, timeout=None, min_num_qubits=None, **kwargs)">
  ...
  <Function id="qiskit.providers.ibmq.IBMQBackendService.jobs" name="jobs" signature="jobs(limit=10, skip=0, backend_name=None, status=None, job_name=None, start_datetime=None, end_datetime=None, job_tags=None, job_tags_operator='OR', experiment_id=None, descending=True, db_filter=None)">
  ...
  <Function id="qiskit.providers.ibmq.IBMQBackendService.my_reservations" name="my_reservations" signature="my_reservations()">
  ...
  <Function id="qiskit.providers.ibmq.IBMQBackendService.retrieve_job" name="retrieve_job" signature="retrieve_job(job_id)">
    Return a single job.
