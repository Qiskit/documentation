---
title: IBMQBackendService (v0.26)
description: API reference for qiskit.providers.ibmq.IBMQBackendService in qiskit v0.26
...
<Class id="qiskit.providers.ibmq.IBMQBackendService" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-ibmq-provider/tree/stable/0.13/qiskit/providers/ibmq/ibmqbackendservice.py" signature="IBMQBackendService(provider)" modifiers="class">
