...
<Class id="qiskit.circuit.library.CPhaseGate" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.17/qiskit/circuit/library/standard_gates/p.py" signature="CPhaseGate(theta, label=None, ctrl_state=None)" modifiers="class">
...
$$
  ...
  <Function id="qiskit.circuit.library.CPhaseGate.__init__" signature="__init__(theta, label=None, ctrl_state=None)">
    Create new CPhase gate.
  </Function>
  ...
  <Function id="qiskit.circuit.library.CPhaseGate.add_decomposition" signature="add_decomposition(decomposition)">
    Add a decomposition of the instruction to the SessionEquivalenceLibrary.
  </Function>

  ### assemble

  <Function id="qiskit.circuit.library.CPhaseGate.assemble" signature="assemble()">
  ...
  <Function id="qiskit.circuit.library.CPhaseGate.broadcast_arguments" signature="broadcast_arguments(qargs, cargs)">
  ...
  <Function id="qiskit.circuit.library.CPhaseGate.c_if" signature="c_if(classical, val)">
  ...
  <Function id="qiskit.circuit.library.CPhaseGate.copy" signature="copy(name=None)">
  ...
  <Function id="qiskit.circuit.library.CPhaseGate.ctrl_state" signature="ctrl_state" modifiers="property">
  ...
  <Function id="qiskit.circuit.library.CPhaseGate.decompositions" signature="decompositions" modifiers="property">
    Get the decompositions of the instruction from the SessionEquivalenceLibrary.
  </Function>

  ### definition

  <Function id="qiskit.circuit.library.CPhaseGate.definition" signature="definition" modifiers="property">
  ...
  <Function id="qiskit.circuit.library.CPhaseGate.duration" signature="duration" modifiers="property">
    Get the duration.
  </Function>
  ...
  <Function id="qiskit.circuit.library.CPhaseGate.is_parameterized" signature="is_parameterized()">
    Return True .IFF. instruction is parameterized else False
  </Function>

  ### label

  <Function id="qiskit.circuit.library.CPhaseGate.label" signature="label" modifiers="property">
    Return gate label
  ...
  <Function id="qiskit.circuit.library.CPhaseGate.mirror" signature="mirror()">
  ...
  <Function id="qiskit.circuit.library.CPhaseGate.name" signature="name" modifiers="property">
  ...
  <Function id="qiskit.circuit.library.CPhaseGate.num_ctrl_qubits" signature="num_ctrl_qubits" modifiers="property">
  ...
  <Function id="qiskit.circuit.library.CPhaseGate.params" signature="params" modifiers="property">
  ...
  <Function id="qiskit.circuit.library.CPhaseGate.qasm" signature="qasm()">
  ...
  <Function id="qiskit.circuit.library.CPhaseGate.repeat" signature="repeat(n)">
  ...
  <Function id="qiskit.circuit.library.CPhaseGate.reverse_ops" signature="reverse_ops()">
  ...
  <Function id="qiskit.circuit.library.CPhaseGate.soft_compare" signature="soft_compare(other)">
  ...
  <Function id="qiskit.circuit.library.CPhaseGate.to_matrix" signature="to_matrix()">
  ...
  <Function id="qiskit.circuit.library.CPhaseGate.unit" signature="unit" modifiers="property">
    Get the time unit of duration.
  </Function>

  ### validate\_parameter

  <Function id="qiskit.circuit.library.CPhaseGate.validate_parameter" signature="validate_parameter(parameter)">
