...
<Class id="qiskit.transpiler.passes.UnitarySynthesis" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.17/qiskit/transpiler/passes/synthesis/unitary_synthesis.py" signature="UnitarySynthesis(basis_gates, approximation_degree=1)">
  ...
  *   **approximation\_degree** (`float`) – closeness of approximation (0: lowest, 1: highest).
  ...
  <Function id="qiskit.transpiler.passes.UnitarySynthesis.__init__" name="__init__" signature="__init__(basis_gates, approximation_degree=1)">
    Synthesize unitaries over some basis gates.
