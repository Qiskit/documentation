---
title: ResultDecoder (v0.26)
description: API reference for qiskit.providers.ibmq.runtime.ResultDecoder in qiskit v0.26
...
<Class id="qiskit.providers.ibmq.runtime.ResultDecoder" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-ibmq-provider/tree/stable/0.13/qiskit/providers/ibmq/runtime/program/result_decoder.py" signature="ResultDecoder" modifiers="class">
