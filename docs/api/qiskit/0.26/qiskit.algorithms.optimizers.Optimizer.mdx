...
description: API reference for qiskit.algorithms.optimizers.Optimizer in qiskit v0.26
...
<Class id="qiskit.algorithms.optimizers.Optimizer" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.17/qiskit/algorithms/optimizers/optimizer.py" signature="Optimizer" modifiers="class">
