...
`OneQubitEulerDecomposer(basis='U3')` [GitHub](https://github.com/qiskit/qiskit/tree/stable/0.17/qiskit/quantum_info/synthesis/one_qubit_decompose.py "view source code")
...
<span id="qiskit.quantum_info.OneQubitEulerDecomposer.__init__" />
