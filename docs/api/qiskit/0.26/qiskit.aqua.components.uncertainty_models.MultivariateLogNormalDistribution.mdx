---
title: MultivariateLogNormalDistribution (v0.26)
description: API reference for qiskit.aqua.components.uncertainty_models.MultivariateLogNormalDistribution in qiskit v0.26
