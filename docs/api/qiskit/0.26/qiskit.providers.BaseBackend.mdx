...
<Class id="qiskit.providers.BaseBackend" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.17/qiskit/providers/basebackend.py" signature="BaseBackend(configuration, provider=None)">
  ...
  **QiskitError** – if an error occurred when instantiating the backend.
  ...
  <Function id="qiskit.providers.BaseBackend.__init__" signature="abstract __init__(configuration, provider=None)">
    Base class for backends.
  ...
  <Function id="qiskit.providers.BaseBackend.run" signature="abstract run(qobj)">
