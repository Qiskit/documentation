---
title: BaseBackend (v0.26)
description: API reference for qiskit.providers.BaseBackend in qiskit v0.26
...
<Class id="qiskit.providers.BaseBackend" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.17/qiskit/providers/basebackend.py" signature="BaseBackend(configuration, provider=None)" modifiers="class">
