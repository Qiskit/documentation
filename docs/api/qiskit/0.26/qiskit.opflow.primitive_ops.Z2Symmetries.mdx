---
title: Z2Symmetries (v0.26)
description: API reference for qiskit.opflow.primitive_ops.Z2Symmetries in qiskit v0.26
in_page_toc_min_heading_level: 1
python_api_type: class
python_api_name: qiskit.opflow.primitive_ops.Z2Symmetries
---

<span id="qiskit-opflow-primitive-ops-z2symmetries" />
