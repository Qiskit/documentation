...
<Class id="qiskit.optimization.algorithms.MinimumEigenOptimizationResult" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/optimization/algorithms/minimum_eigen_optimizer.py" signature="MinimumEigenOptimizationResult(x, fval, variables, status, samples=None, min_eigen_solver_result=None, raw_samples=None)">
  ...
  *   **raw\_samples** (`Optional`\[`List`\[`SolutionSample`]]) – the x values of the QUBO, the objective function value of the QUBO, and the probability of sampling.
  ...
  <Function id="qiskit.optimization.algorithms.MinimumEigenOptimizationResult.fval" signature="property fval">
  ...
  <Function id="qiskit.optimization.algorithms.MinimumEigenOptimizationResult.min_eigen_solver_result" signature="property min_eigen_solver_result">
  ...
  <Function id="qiskit.optimization.algorithms.MinimumEigenOptimizationResult.raw_results" signature="property raw_results">
  ...
  <Function id="qiskit.optimization.algorithms.MinimumEigenOptimizationResult.raw_samples" signature="property raw_samples">
  ...
  <Function id="qiskit.optimization.algorithms.MinimumEigenOptimizationResult.samples" signature="property samples">
  ...
  <Function id="qiskit.optimization.algorithms.MinimumEigenOptimizationResult.status" signature="property status">
  ...
  <Function id="qiskit.optimization.algorithms.MinimumEigenOptimizationResult.variable_names" signature="property variable_names">
  ...
  <Function id="qiskit.optimization.algorithms.MinimumEigenOptimizationResult.variables" signature="property variables">
  ...
  <Function id="qiskit.optimization.algorithms.MinimumEigenOptimizationResult.variables_dict" signature="property variables_dict">
  ...
  <Function id="qiskit.optimization.algorithms.MinimumEigenOptimizationResult.x" signature="property x">
