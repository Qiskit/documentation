...
<Class id="qiskit.circuit.library.MCXGrayCode" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.17/qiskit/circuit/library/standard_gates/x.py" signature="MCXGrayCode(num_ctrl_qubits=None, label=None, ctrl_state=None)">
  ...
  <Function id="qiskit.circuit.library.MCXGrayCode.ctrl_state" signature="property ctrl_state">
  ...
  <Function id="qiskit.circuit.library.MCXGrayCode.decompositions" signature="property decompositions">
    Get the decompositions of the instruction from the SessionEquivalenceLibrary.
  </Function>

  ### definition

  <Function id="qiskit.circuit.library.MCXGrayCode.definition" signature="property definition">
  ...
  <Function id="qiskit.circuit.library.MCXGrayCode.duration" signature="property duration">
    Get the duration.
  </Function>

  ### get\_num\_ancilla\_qubits

  <Function id="qiskit.circuit.library.MCXGrayCode.get_num_ancilla_qubits" signature="static get_num_ancilla_qubits(num_ctrl_qubits, mode='noancilla')">
  ...
  <Function id="qiskit.circuit.library.MCXGrayCode.label" signature="property label">
    Return gate label
  ...
  <Function id="qiskit.circuit.library.MCXGrayCode.name" signature="property name">
  ...
  <Function id="qiskit.circuit.library.MCXGrayCode.num_ancilla_qubits" signature="property num_ancilla_qubits">
    The number of ancilla qubits.
  </Function>

  ### num\_ctrl\_qubits

  <Function id="qiskit.circuit.library.MCXGrayCode.num_ctrl_qubits" signature="property num_ctrl_qubits">
  ...
  <Function id="qiskit.circuit.library.MCXGrayCode.params" signature="property params">
  ...
  <Function id="qiskit.circuit.library.MCXGrayCode.soft_compare" signature="soft_compare(other)">
  ...
  <Function id="qiskit.circuit.library.MCXGrayCode.unit" signature="property unit">
