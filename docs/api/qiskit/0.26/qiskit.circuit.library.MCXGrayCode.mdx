...
<Class id="qiskit.circuit.library.MCXGrayCode" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.17/qiskit/circuit/library/standard_gates/x.py" signature="MCXGrayCode(num_ctrl_qubits=None, label=None, ctrl_state=None)">
  ...
  <Function id="qiskit.circuit.library.MCXGrayCode.__init__" name="__init__" signature="__init__(num_ctrl_qubits, label=None, ctrl_state=None)">
    Create new MCX gate.
  </Function>
  ...
  <Function id="qiskit.circuit.library.MCXGrayCode.add_decomposition" name="add_decomposition" signature="add_decomposition(decomposition)">
    Add a decomposition of the instruction to the SessionEquivalenceLibrary.
  </Function>

  ### assemble

  <Function id="qiskit.circuit.library.MCXGrayCode.assemble" name="assemble" signature="assemble()">
  ...
  <Function id="qiskit.circuit.library.MCXGrayCode.broadcast_arguments" name="broadcast_arguments" signature="broadcast_arguments(qargs, cargs)">
  ...
  <Function id="qiskit.circuit.library.MCXGrayCode.c_if" name="c_if" signature="c_if(classical, val)">
    Add classical condition on register classical and value val.
  </Function>

  ### control

  <Function id="qiskit.circuit.library.MCXGrayCode.control" name="control" signature="control(num_ctrl_qubits=1, label=None, ctrl_state=None)">
  ...
  <Function id="qiskit.circuit.library.MCXGrayCode.copy" name="copy" signature="copy(name=None)">
  ...
  <Function id="qiskit.circuit.library.MCXGrayCode.ctrl_state" name="ctrl_state" signature="property ctrl_state">
  ...
  <Function id="qiskit.circuit.library.MCXGrayCode.decompositions" name="decompositions" signature="property decompositions">
    Get the decompositions of the instruction from the SessionEquivalenceLibrary.
  </Function>

  ### definition

  <Function id="qiskit.circuit.library.MCXGrayCode.definition" name="definition" signature="property definition">
  ...
  <Function id="qiskit.circuit.library.MCXGrayCode.duration" name="duration" signature="property duration">
    Get the duration.
  </Function>

  ### get\_num\_ancilla\_qubits

  <Function id="qiskit.circuit.library.MCXGrayCode.get_num_ancilla_qubits" name="get_num_ancilla_qubits" signature="static get_num_ancilla_qubits(num_ctrl_qubits, mode='noancilla')">
  ...
  <Function id="qiskit.circuit.library.MCXGrayCode.inverse" name="inverse" signature="inverse()">
    Invert this gate. The MCX is its own inverse.
  </Function>

  ### is\_parameterized

  <Function id="qiskit.circuit.library.MCXGrayCode.is_parameterized" name="is_parameterized" signature="is_parameterized()">
    Return True .IFF. instruction is parameterized else False
  </Function>

  ### label

  <Function id="qiskit.circuit.library.MCXGrayCode.label" name="label" signature="property label">
    Return gate label
  ...
  <Function id="qiskit.circuit.library.MCXGrayCode.mirror" name="mirror" signature="mirror()">
  ...
  <Function id="qiskit.circuit.library.MCXGrayCode.name" name="name" signature="property name">
  ...
  <Function id="qiskit.circuit.library.MCXGrayCode.num_ancilla_qubits" name="num_ancilla_qubits" signature="property num_ancilla_qubits">
    The number of ancilla qubits.
  </Function>

  ### num\_ctrl\_qubits

  <Function id="qiskit.circuit.library.MCXGrayCode.num_ctrl_qubits" name="num_ctrl_qubits" signature="property num_ctrl_qubits">
  ...
  <Function id="qiskit.circuit.library.MCXGrayCode.params" name="params" signature="property params">
  ...
  <Function id="qiskit.circuit.library.MCXGrayCode.power" name="power" signature="power(exponent)">
  ...
  <Function id="qiskit.circuit.library.MCXGrayCode.qasm" name="qasm" signature="qasm()">
  ...
  <Function id="qiskit.circuit.library.MCXGrayCode.repeat" name="repeat" signature="repeat(n)">
  ...
  <Function id="qiskit.circuit.library.MCXGrayCode.reverse_ops" name="reverse_ops" signature="reverse_ops()">
  ...
  <Function id="qiskit.circuit.library.MCXGrayCode.soft_compare" name="soft_compare" signature="soft_compare(other)">
  ...
  <Function id="qiskit.circuit.library.MCXGrayCode.to_matrix" name="to_matrix" signature="to_matrix()">
  ...
  <Function id="qiskit.circuit.library.MCXGrayCode.unit" name="unit" signature="property unit">
    Get the time unit of duration.
  </Function>

  ### validate\_parameter

  <Function id="qiskit.circuit.library.MCXGrayCode.validate_parameter" name="validate_parameter" signature="validate_parameter(parameter)">
