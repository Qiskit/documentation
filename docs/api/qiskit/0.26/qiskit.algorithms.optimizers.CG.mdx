...
<Class id="qiskit.algorithms.optimizers.CG" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.17/qiskit/algorithms/optimizers/cg.py" signature="CG(maxiter=20, disp=False, gtol=1e-05, tol=None, eps=1.4901161193847656e-08)">
  ...
  *   **eps** (`float`) – If jac is approximated, use this value for the step size.
  ...
  <Function id="qiskit.algorithms.optimizers.CG.__init__" name="__init__" signature="__init__(maxiter=20, disp=False, gtol=1e-05, tol=None, eps=1.4901161193847656e-08)">
    **Parameters**
