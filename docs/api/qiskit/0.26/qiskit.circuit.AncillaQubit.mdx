...
<Class id="qiskit.circuit.AncillaQubit" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.17/qiskit/circuit/quantumregister.py" signature="AncillaQubit(register=None, index=None)">
  ...
  **CircuitError** – if the provided register is not a valid [`QuantumRegister`](qiskit.circuit.QuantumRegister "qiskit.circuit.QuantumRegister")
  ...
  <Function id="qiskit.circuit.AncillaQubit.index" signature="property index">
    Get bit’s index.
  </Function>

  ### register

  <Function id="qiskit.circuit.AncillaQubit.register" signature="property register">
    Get bit’s register.
  </Function>
</Class>
