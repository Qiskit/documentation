...
<Class id="qiskit.opflow.expectations.PauliExpectation" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.17/qiskit/opflow/expectations/pauli_expectation.py" signature="PauliExpectation(group_paulis=True)">
  ...
  **group\_paulis** (`bool`) – Whether to group the Pauli measurements into commuting sums, which all have the same diagonalizing circuit.
  ...
  <Function id="qiskit.opflow.expectations.PauliExpectation.__init__" name="__init__" signature="__init__(group_paulis=True)">
    **Parameters**
  ...
  <Function id="qiskit.opflow.expectations.PauliExpectation.compute_variance" name="compute_variance" signature="compute_variance(exp_op)">
  ...
  <Function id="qiskit.opflow.expectations.PauliExpectation.convert" name="convert" signature="convert(operator)">
