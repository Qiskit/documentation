...
<Class id="qiskit.pulse.instructions.SetPhase" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.17/qiskit/pulse/instructions/phase.py" signature="SetPhase(phase, channel, name=None)" modifiers="class">
...
$$
  ...
  *   **name** (`Optional`\[`str`]) – Display name for this instruction.
  ...
  <Function id="qiskit.pulse.instructions.SetPhase.channel" signature="channel" modifiers="property">
  ...
  <Function id="qiskit.pulse.instructions.SetPhase.channels" signature="channels" modifiers="property">
  ...
  <Function id="qiskit.pulse.instructions.SetPhase.duration" signature="duration" modifiers="property">
  ...
  <Function id="qiskit.pulse.instructions.SetPhase.id" signature="id" modifiers="property">
  ...
  <Function id="qiskit.pulse.instructions.SetPhase.instructions" signature="instructions" modifiers="property">
  ...
  <Function id="qiskit.pulse.instructions.SetPhase.name" signature="name" modifiers="property">
  ...
  <Function id="qiskit.pulse.instructions.SetPhase.operands" signature="operands" modifiers="property">
  ...
  <Function id="qiskit.pulse.instructions.SetPhase.parameters" signature="parameters" modifiers="property">
  ...
  <Function id="qiskit.pulse.instructions.SetPhase.phase" signature="phase" modifiers="property">
  ...
  <Function id="qiskit.pulse.instructions.SetPhase.start_time" signature="start_time" modifiers="property">
  ...
  <Function id="qiskit.pulse.instructions.SetPhase.stop_time" signature="stop_time" modifiers="property">
