...
<Class id="qiskit.pulse.instructions.SetPhase" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.17/qiskit/pulse/instructions/phase.py" signature="SetPhase(phase, channel, name=None)">
...
$$
  ...
  *   **name** (`Optional`\[`str`]) – Display name for this instruction.
  ...
  <Function id="qiskit.pulse.instructions.SetPhase.__init__" name="__init__" signature="__init__(phase, channel, name=None)">
    Instantiate a set phase instruction, setting the output signal phase on `channel` to `phase` \[radians].
  ...
  <Function id="qiskit.pulse.instructions.SetPhase.assign_parameters" name="assign_parameters" signature="assign_parameters(value_dict)">
  ...
  <Function id="qiskit.pulse.instructions.SetPhase.channel" name="channel" signature="property channel">
  ...
  <Function id="qiskit.pulse.instructions.SetPhase.channels" name="channels" signature="property channels">
  ...
  <Function id="qiskit.pulse.instructions.SetPhase.draw" name="draw" signature="draw(dt=1, style=None, filename=None, interp_method=None, scale=1, plot_all=False, plot_range=None, interactive=False, table=True, label=False, framechange=True, channels=None)">
  ...
  <Function id="qiskit.pulse.instructions.SetPhase.duration" name="duration" signature="property duration">
  ...
  <Function id="qiskit.pulse.instructions.SetPhase.flatten" name="flatten" signature="flatten()">
  ...
  <Function id="qiskit.pulse.instructions.SetPhase.id" name="id" signature="property id">
  ...
  <Function id="qiskit.pulse.instructions.SetPhase.instructions" name="instructions" signature="property instructions">
  ...
  <Function id="qiskit.pulse.instructions.SetPhase.name" name="name" signature="property name">
  ...
  <Function id="qiskit.pulse.instructions.SetPhase.operands" name="operands" signature="property operands">
  ...
  <Function id="qiskit.pulse.instructions.SetPhase.parameters" name="parameters" signature="property parameters">
  ...
  <Function id="qiskit.pulse.instructions.SetPhase.phase" name="phase" signature="property phase">
  ...
  <Function id="qiskit.pulse.instructions.SetPhase.start_time" name="start_time" signature="property start_time">
  ...
  <Function id="qiskit.pulse.instructions.SetPhase.stop_time" name="stop_time" signature="property stop_time">
