---
title: IBMQAccountCredentialsInvalidFormat (v0.26)
description: API reference for qiskit.providers.ibmq.IBMQAccountCredentialsInvalidFormat in qiskit v0.26
