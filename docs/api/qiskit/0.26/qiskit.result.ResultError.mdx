...
<Class id="qiskit.result.ResultError" name="ResultError" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.17/qiskit/result/exceptions.py" signature="ResultError(error)">
