...
<Class id="qiskit.aqua.components.uncertainty_models.UniformDistribution" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/aqua/components/uncertainty_models/uniform_distribution.py" signature="UniformDistribution(num_target_qubits, low=0, high=1)">
  ...
  *   **high** (`float`) – Upper bound, i.e., the value corresponding to |1…1> (assuming an equidistant grid)
  ...
  <Function id="qiskit.aqua.components.uncertainty_models.UniformDistribution.high" signature="property high">
    returns high
  </Function>

  ### low

  <Function id="qiskit.aqua.components.uncertainty_models.UniformDistribution.low" signature="property low">
    returns low
  </Function>

  ### num\_target\_qubits

  <Function id="qiskit.aqua.components.uncertainty_models.UniformDistribution.num_target_qubits" signature="property num_target_qubits">
    Returns the number of target qubits
  </Function>

  ### num\_values

  <Function id="qiskit.aqua.components.uncertainty_models.UniformDistribution.num_values" signature="property num_values">
    returns number of values
  </Function>

  ### pdf\_to\_probabilities

  <Function id="qiskit.aqua.components.uncertainty_models.UniformDistribution.pdf_to_probabilities" signature="static pdf_to_probabilities(pdf, low, high, num_values)">
  ...
  <Function id="qiskit.aqua.components.uncertainty_models.UniformDistribution.probabilities" signature="property probabilities">
  ...
  <Function id="qiskit.aqua.components.uncertainty_models.UniformDistribution.values" signature="property values">
    returns values
  </Function>
</Class>
