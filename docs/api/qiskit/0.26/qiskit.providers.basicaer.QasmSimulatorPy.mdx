---
title: QasmSimulatorPy (v0.26)
description: API reference for qiskit.providers.basicaer.QasmSimulatorPy in qiskit v0.26
...
<Class id="qiskit.providers.basicaer.QasmSimulatorPy" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.17/qiskit/providers/basicaer/qasm_simulator.py" signature="QasmSimulatorPy(configuration=None, provider=None, **fields)" modifiers="class">
