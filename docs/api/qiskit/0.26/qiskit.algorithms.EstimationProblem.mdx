...
<Class id="qiskit.algorithms.EstimationProblem" github="https://github.com/qiskit/qiskit/tree/stable/0.17/qiskit/algorithms/amplitude_estimators/estimation_problem.py" signature="EstimationProblem(state_preparation, objective_qubits, grover_operator=None, post_processing=None, is_good_state=None)">
  ...
  *   **is\_good\_state** (`Optional`\[`Callable`\[\[`str`], `bool`]]) – A function to check whether a string represents a good state. Defaults to all objective qubits being in state $|1\rangle$.
  ...
  <Function id="qiskit.algorithms.EstimationProblem.__init__" name="__init__" signature="__init__(state_preparation, objective_qubits, grover_operator=None, post_processing=None, is_good_state=None)">
    **Parameters**
  ...
  <Function id="qiskit.algorithms.EstimationProblem.grover_operator" name="grover_operator" signature="property grover_operator">
  ...
  <Function id="qiskit.algorithms.EstimationProblem.is_good_state" name="is_good_state" signature="property is_good_state">
  ...
  <Function id="qiskit.algorithms.EstimationProblem.objective_qubits" name="objective_qubits" signature="property objective_qubits">
  ...
  <Function id="qiskit.algorithms.EstimationProblem.post_processing" name="post_processing" signature="property post_processing">
  ...
  <Function id="qiskit.algorithms.EstimationProblem.rescale" name="rescale" signature="rescale(scaling_factor)">
  ...
  <Function id="qiskit.algorithms.EstimationProblem.state_preparation" name="state_preparation" signature="property state_preparation">
