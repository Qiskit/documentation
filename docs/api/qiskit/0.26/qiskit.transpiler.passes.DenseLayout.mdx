...
<Class id="qiskit.transpiler.passes.DenseLayout" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.17/qiskit/transpiler/passes/layout/dense_layout.py" signature="DenseLayout(*args, **kwargs)" modifiers="class">
  ...
  *   **backend\_prop** ([*BackendProperties*](qiskit.providers.models.BackendProperties "qiskit.providers.models.BackendProperties")) – backend properties object
  ...
  <Function id="qiskit.transpiler.passes.DenseLayout.__init__" signature="__init__(coupling_map, backend_prop=None)">
    DenseLayout initializer.
  ...
  <Function id="qiskit.transpiler.passes.DenseLayout.is_analysis_pass" signature="is_analysis_pass" modifiers="property">
  ...
  <Function id="qiskit.transpiler.passes.DenseLayout.is_transformation_pass" signature="is_transformation_pass" modifiers="property">
  ...
  <Function id="qiskit.transpiler.passes.DenseLayout.name" signature="name()">
    Return the name of the pass.
  </Function>

  ### run

  <Function id="qiskit.transpiler.passes.DenseLayout.run" signature="run(dag)">
