...
$$
  ...
  **ValueError** – Invalid input
  ...
  <Function id="qiskit.aqua.algorithms.HHL.__init__" name="__init__" signature="__init__(matrix, vector, truncate_powerdim=False, truncate_hermitian=False, eigs=None, init_state=None, reciprocal=None, num_q=0, num_a=0, orig_size=None, quantum_instance=None)">
    **Parameters**
  ...
  <Function id="qiskit.aqua.algorithms.HHL.backend" name="backend" signature="property backend">
    Returns backend.
  ...
  <Function id="qiskit.aqua.algorithms.HHL.construct_circuit" name="construct_circuit" signature="construct_circuit(measurement=False)">
  ...
  <Function id="qiskit.aqua.algorithms.HHL.expand_to_hermitian" name="expand_to_hermitian" signature="static expand_to_hermitian(matrix, vector)">
  ...
  <Function id="qiskit.aqua.algorithms.HHL.expand_to_powerdim" name="expand_to_powerdim" signature="static expand_to_powerdim(matrix, vector)">
  ...
  <Function id="qiskit.aqua.algorithms.HHL.matrix_resize" name="matrix_resize" signature="static matrix_resize(matrix, vector)">
  ...
  <Function id="qiskit.aqua.algorithms.HHL.quantum_instance" name="quantum_instance" signature="property quantum_instance">
  ...
  <Function id="qiskit.aqua.algorithms.HHL.random" name="random" signature="property random">
    Return a numpy random.
  </Function>

  ### run

  <Function id="qiskit.aqua.algorithms.HHL.run" name="run" signature="run(quantum_instance=None, **kwargs)">
  ...
  <Function id="qiskit.aqua.algorithms.HHL.set_backend" name="set_backend" signature="set_backend(backend, **kwargs)">
