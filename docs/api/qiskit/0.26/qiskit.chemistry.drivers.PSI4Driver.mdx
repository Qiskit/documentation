...
<Class id="qiskit.chemistry.drivers.PSI4Driver" github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/chemistry/drivers/psi4d/psi4driver.py" signature="PSI4Driver(config='molecule h2 {\\n 0 1\\n H 0.0 0.0 0.0\\n H 0.0 0.0 0.735\\n}\\n\\nset {\\n basis sto-3g\\n scf_type pk\\n reference rhf\\n', molecule=None, basis='sto-3g', hf_method=<HFMethodType.RHF: 'rhf'>)">
  ...
  **Raises**
  ...
  <Function id="qiskit.chemistry.drivers.PSI4Driver.__init__" name="__init__" signature="__init__(config='molecule h2 {\\n 0 1\\n H 0.0 0.0 0.0\\n H 0.0 0.0 0.735\\n}\\n\\nset {\\n basis sto-3g\\n scf_type pk\\n reference rhf\\n', molecule=None, basis='sto-3g', hf_method=<HFMethodType.RHF: 'rhf'>)">
    **Parameters**
  ...
  <Function id="qiskit.chemistry.drivers.PSI4Driver.basis" name="basis" signature="property basis">
    return basis
  ...
  <Function id="qiskit.chemistry.drivers.PSI4Driver.hf_method" name="hf_method" signature="property hf_method">
  ...
  <Function id="qiskit.chemistry.drivers.PSI4Driver.molecule" name="molecule" signature="property molecule">
    return molecule
  ...
  <Function id="qiskit.chemistry.drivers.PSI4Driver.run" name="run" signature="run()">
  ...
  <Function id="qiskit.chemistry.drivers.PSI4Driver.supports_molecule" name="supports_molecule" signature="property supports_molecule">
