...
<Class id="qiskit.chemistry.algorithms.pes_samplers.EnergySurfaceBase" github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/chemistry/algorithms/pes_samplers/potentials/potential_base.py" signature="EnergySurfaceBase">
  ...
  <Function id="qiskit.chemistry.algorithms.pes_samplers.EnergySurfaceBase.__init__" name="__init__" signature="__init__()">
  ...
  <Function id="qiskit.chemistry.algorithms.pes_samplers.EnergySurfaceBase.eval" name="eval" signature="abstract eval(x)">
  ...
  <Function id="qiskit.chemistry.algorithms.pes_samplers.EnergySurfaceBase.fit" name="fit" signature="abstract fit(xdata, ydata, initial_vals=None, bounds_list=None)">
  ...
  <Function id="qiskit.chemistry.algorithms.pes_samplers.EnergySurfaceBase.get_equilibrium_geometry" name="get_equilibrium_geometry" signature="abstract get_equilibrium_geometry(scaling=1.0)">
  ...
  <Function id="qiskit.chemistry.algorithms.pes_samplers.EnergySurfaceBase.get_minimal_energy" name="get_minimal_energy" signature="abstract get_minimal_energy(scaling=1.0)">
  ...
  <Function id="qiskit.chemistry.algorithms.pes_samplers.EnergySurfaceBase.get_trust_region" name="get_trust_region" signature="abstract get_trust_region()">
