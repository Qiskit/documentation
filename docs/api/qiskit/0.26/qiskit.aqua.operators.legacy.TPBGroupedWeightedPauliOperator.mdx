...
<Class id="qiskit.aqua.operators.legacy.TPBGroupedWeightedPauliOperator" github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/aqua/operators/legacy/tpb_grouped_weighted_pauli_operator.py" signature="TPBGroupedWeightedPauliOperator(paulis, basis, z2_symmetries=None, atol=1e-12, name=None, grouping_func=None, kwargs=None)">
  ...
  *   **kwargs** (*dict*) – Optional parameters for grouping function call
  ...
  <Function id="qiskit.aqua.operators.legacy.TPBGroupedWeightedPauliOperator.__init__" name="__init__" signature="__init__(paulis, basis, z2_symmetries=None, atol=1e-12, name=None, grouping_func=None, kwargs=None)">
    **Parameters**
  ...
  <Function id="qiskit.aqua.operators.legacy.TPBGroupedWeightedPauliOperator.add" name="add" signature="add(other, copy=False)">
    Perform self + other.
  ...
  <Function id="qiskit.aqua.operators.legacy.TPBGroupedWeightedPauliOperator.anticommute_with" name="anticommute_with" signature="anticommute_with(other)">
    Anti commutes with
  </Function>

  ### atol

  <Function id="qiskit.aqua.operators.legacy.TPBGroupedWeightedPauliOperator.atol" name="atol" signature="property atol">
    get atol
  </Function>

  ### basis

  <Function id="qiskit.aqua.operators.legacy.TPBGroupedWeightedPauliOperator.basis" name="basis" signature="property basis">
    returns basis
  </Function>

  ### chop

  <Function id="qiskit.aqua.operators.legacy.TPBGroupedWeightedPauliOperator.chop" name="chop" signature="chop(threshold=None, copy=False)">
  ...
  <Function id="qiskit.aqua.operators.legacy.TPBGroupedWeightedPauliOperator.commute_with" name="commute_with" signature="commute_with(other)">
    Commutes with
  </Function>

  ### construct\_evaluation\_circuit

  <Function id="qiskit.aqua.operators.legacy.TPBGroupedWeightedPauliOperator.construct_evaluation_circuit" name="construct_evaluation_circuit" signature="construct_evaluation_circuit(wave_function, statevector_mode, qr=None, cr=None, use_simulator_snapshot_mode=False, circuit_name_prefix='')">
  ...
  <Function id="qiskit.aqua.operators.legacy.TPBGroupedWeightedPauliOperator.copy" name="copy" signature="copy()">
    Get a copy of self
  </Function>

  ### evaluate\_with\_result

  <Function id="qiskit.aqua.operators.legacy.TPBGroupedWeightedPauliOperator.evaluate_with_result" name="evaluate_with_result" signature="evaluate_with_result(result, statevector_mode, use_simulator_snapshot_mode=False, circuit_name_prefix='')">
  ...
  <Function id="qiskit.aqua.operators.legacy.TPBGroupedWeightedPauliOperator.evaluate_with_statevector" name="evaluate_with_statevector" signature="evaluate_with_statevector(quantum_state)">
    **Parameters**
  ...
  <Function id="qiskit.aqua.operators.legacy.TPBGroupedWeightedPauliOperator.evaluation_instruction" name="evaluation_instruction" signature="evaluation_instruction(statevector_mode, use_simulator_snapshot_mode=False)">
    **Parameters**
  ...
  <Function id="qiskit.aqua.operators.legacy.TPBGroupedWeightedPauliOperator.evolve" name="evolve" signature="evolve(state_in=None, evo_time=0, num_time_slices=1, quantum_registers=None, expansion_mode='trotter', expansion_order=1)">
  ...
  <Function id="qiskit.aqua.operators.legacy.TPBGroupedWeightedPauliOperator.evolve_instruction" name="evolve_instruction" signature="evolve_instruction(evo_time=0, num_time_slices=1, expansion_mode='trotter', expansion_order=1)">
    Carry out the eoh evolution for the operator under supplied specifications.
  ...
  <Function id="qiskit.aqua.operators.legacy.TPBGroupedWeightedPauliOperator.from_dict" name="from_dict" signature="classmethod from_dict(dictionary, before_04=False)">
  ...
  <Function id="qiskit.aqua.operators.legacy.TPBGroupedWeightedPauliOperator.from_file" name="from_file" signature="classmethod from_file(file_name, before_04=False)">
  ...
  <Function id="qiskit.aqua.operators.legacy.TPBGroupedWeightedPauliOperator.from_list" name="from_list" signature="classmethod from_list(paulis, weights=None, name=None)">
  ...
  <Function id="qiskit.aqua.operators.legacy.TPBGroupedWeightedPauliOperator.grouping_func" name="grouping_func" signature="property grouping_func">
    returns grouping function
  </Function>

  ### is\_empty

  <Function id="qiskit.aqua.operators.legacy.TPBGroupedWeightedPauliOperator.is_empty" name="is_empty" signature="is_empty()">
  ...
  <Function id="qiskit.aqua.operators.legacy.TPBGroupedWeightedPauliOperator.kwargs" name="kwargs" signature="property kwargs">
    returns kwargs
  </Function>

  ### multiply

  <Function id="qiskit.aqua.operators.legacy.TPBGroupedWeightedPauliOperator.multiply" name="multiply" signature="multiply(other)">
    Perform self \* other.
  ...
  <Function id="qiskit.aqua.operators.legacy.TPBGroupedWeightedPauliOperator.name" name="name" signature="property name">
    returns name
  </Function>

  ### num\_groups

  <Function id="qiskit.aqua.operators.legacy.TPBGroupedWeightedPauliOperator.num_groups" name="num_groups" signature="property num_groups">
    returns number of groups
  </Function>

  ### num\_qubits

  <Function id="qiskit.aqua.operators.legacy.TPBGroupedWeightedPauliOperator.num_qubits" name="num_qubits" signature="property num_qubits">
  ...
  <Function id="qiskit.aqua.operators.legacy.TPBGroupedWeightedPauliOperator.paulis" name="paulis" signature="property paulis">
    get paulis
  </Function>

  ### print\_details

  <Function id="qiskit.aqua.operators.legacy.TPBGroupedWeightedPauliOperator.print_details" name="print_details" signature="print_details()">
  ...
  <Function id="qiskit.aqua.operators.legacy.TPBGroupedWeightedPauliOperator.reorder_paulis" name="reorder_paulis" signature="reorder_paulis()">
  ...
  <Function id="qiskit.aqua.operators.legacy.TPBGroupedWeightedPauliOperator.rounding" name="rounding" signature="rounding(decimals, copy=False)">
    Rounding the weight.
  ...
  <Function id="qiskit.aqua.operators.legacy.TPBGroupedWeightedPauliOperator.simplify" name="simplify" signature="simplify(copy=False)">
  ...
  <Function id="qiskit.aqua.operators.legacy.TPBGroupedWeightedPauliOperator.sorted_grouping" name="sorted_grouping" signature="classmethod sorted_grouping(weighted_pauli_operator, method='largest-degree')">
  ...
  <Function id="qiskit.aqua.operators.legacy.TPBGroupedWeightedPauliOperator.sub" name="sub" signature="sub(other, copy=False)">
    Perform self - other.
  ...
  <Function id="qiskit.aqua.operators.legacy.TPBGroupedWeightedPauliOperator.to_dict" name="to_dict" signature="to_dict()">
  ...
  <Function id="qiskit.aqua.operators.legacy.TPBGroupedWeightedPauliOperator.to_file" name="to_file" signature="to_file(file_name)">
  ...
  <Function id="qiskit.aqua.operators.legacy.TPBGroupedWeightedPauliOperator.to_opflow" name="to_opflow" signature="to_opflow(reverse_endianness=False)">
    to op flow
  </Function>

  ### unsorted\_grouping

  <Function id="qiskit.aqua.operators.legacy.TPBGroupedWeightedPauliOperator.unsorted_grouping" name="unsorted_grouping" signature="classmethod unsorted_grouping(weighted_pauli_operator)">
  ...
  <Function id="qiskit.aqua.operators.legacy.TPBGroupedWeightedPauliOperator.z2_symmetries" name="z2_symmetries" signature="property z2_symmetries">
