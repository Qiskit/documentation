---
title: Command (v0.26)
description: API reference for qiskit.providers.models.Command in qiskit v0.26
...
<Class id="qiskit.providers.models.Command" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.17/qiskit/providers/models/pulsedefaults.py" signature="Command(name, qubits=None, sequence=None, **kwargs)" modifiers="class">
  ...
  *   **kwargs** – Optional additional fields
  ...
  <Function id="qiskit.providers.models.Command.__init__" signature="__init__(name, qubits=None, sequence=None, **kwargs)">
    Initialize a Command object
