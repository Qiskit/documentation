...
<Class id="qiskit.providers.ibmq.managed.IBMQJobManager" github="https://github.com/qiskit/qiskit-ibmq-provider/tree/stable/0.13/qiskit/providers/ibmq/managed/ibmqjobmanager.py" signature="IBMQJobManager">
