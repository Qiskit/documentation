...
<Class id="qiskit.aqua.operators.expectations.ExpectationBase" github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/aqua/operators/expectations/expectation_base.py" signature="ExpectationBase">
