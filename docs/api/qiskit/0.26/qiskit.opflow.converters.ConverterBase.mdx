...
<Class id="qiskit.opflow.converters.ConverterBase" github="https://github.com/qiskit/qiskit/tree/stable/0.17/qiskit/opflow/converters/converter_base.py" signature="ConverterBase">
