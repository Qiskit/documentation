...
<Class id="qiskit.optimization.applications.ising.tsp.TspData" signature="TspData(name, dim, coord, w)">
  ...
  <Function id="qiskit.optimization.applications.ising.tsp.TspData.coord" signature="property coord">
  ...
  <Function id="qiskit.optimization.applications.ising.tsp.TspData.dim" signature="property dim">
  ...
  <Function id="qiskit.optimization.applications.ising.tsp.TspData.name" signature="property name">
    Alias for field number 0
  </Function>

  #### w

  <Function id="qiskit.optimization.applications.ising.tsp.TspData.w" signature="property w">
