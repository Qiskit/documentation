...
<Function id="qiskit.aqua.operators.legacy.measure_pauli_z" name="measure_pauli_z" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/aqua/operators/legacy/common.py" signature="measure_pauli_z(data, pauli)">
