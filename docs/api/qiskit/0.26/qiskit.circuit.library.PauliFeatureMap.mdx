---
title: PauliFeatureMap (v0.26)
description: API reference for qiskit.circuit.library.PauliFeatureMap in qiskit v0.26
  ...
  *   **insert\_barriers** (`bool`) – If True, barriers are inserted in between the evolution instructions and hadamard layers.
  ...
  <Function id="qiskit.circuit.library.PauliFeatureMap.draw" signature="draw(output=None, scale=None, filename=None, style=None, interactive=False, plot_barriers=True, reverse_bits=False, justify=None, vertical_compression='medium', idle_wires=True, with_layout=True, fold=None, ax=None, initial_state=False, cregbundle=True)">
    ...
    **Example**
    ...
    ![../\_images/qiskit.circuit.library.PauliFeatureMap\_0\_0.png](/docs/images/api/qiskit/0.26/qiskit.circuit.library.PauliFeatureMap_0_0.avif)
  </Function>
