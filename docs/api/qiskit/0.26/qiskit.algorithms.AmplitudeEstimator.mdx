...
<Class id="qiskit.algorithms.AmplitudeEstimator" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.17/qiskit/algorithms/amplitude_estimators/amplitude_estimator.py" signature="AmplitudeEstimator">
  The Amplitude Estimation interface.

  ### \_\_init\_\_

  <Function id="qiskit.algorithms.AmplitudeEstimator.__init__" name="__init__" signature="__init__()">
  ...
  <Function id="qiskit.algorithms.AmplitudeEstimator.estimate" name="estimate" signature="abstract estimate(estimation_problem)">
