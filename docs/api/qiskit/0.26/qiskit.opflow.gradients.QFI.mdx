...
$$
  ...
  **ValueError** – if `qfi_method` is neither a `CircuitQFI` object nor one of the predefined strings.
  ...
  <Function id="qiskit.opflow.gradients.QFI.gradient_wrapper" signature="gradient_wrapper(operator, bind_params, grad_params=None, backend=None)">
  ...
  <Function id="qiskit.opflow.gradients.QFI.parameter_expression_grad" signature="static parameter_expression_grad(param_expr, param)">
  ...
  <Function id="qiskit.opflow.gradients.QFI.qfi_method" signature="property qfi_method">
    Returns `CircuitQFI`.
