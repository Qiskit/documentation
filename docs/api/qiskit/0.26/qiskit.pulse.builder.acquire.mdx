...
<Function id="qiskit.pulse.builder.acquire" name="acquire" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.17/qiskit/pulse/builder.py" signature="acquire(duration, qubit_or_channel, register, **metadata)">
