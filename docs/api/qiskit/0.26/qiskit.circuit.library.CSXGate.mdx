---
title: CSXGate (v0.26)
description: API reference for qiskit.circuit.library.CSXGate in qiskit v0.26
...
<Class id="qiskit.circuit.library.CSXGate" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.17/qiskit/circuit/library/standard_gates/sx.py" signature="CSXGate(label=None, ctrl_state=None)" modifiers="class">
  Controlled-√X gate.
...
$$
  ...
  <Function id="qiskit.circuit.library.CSXGate.soft_compare" signature="soft_compare(other)">
