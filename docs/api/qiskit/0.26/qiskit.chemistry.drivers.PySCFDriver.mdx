...
<Class id="qiskit.chemistry.drivers.PySCFDriver" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/chemistry/drivers/pyscfd/pyscfdriver.py" signature="PySCFDriver(atom='H 0.0 0.0 0.0; H 0.0 0.0 0.735', unit=<UnitsType.ANGSTROM: 'Angstrom'>, charge=0, spin=0, basis='sto3g', hf_method=<HFMethodType.RHF: 'rhf'>, conv_tol=1e-09, max_cycle=50, init_guess=<InitialGuess.MINAO: 'minao'>, max_memory=None, molecule=None)">
  ...
  **Raises**
  ...
  <Function id="qiskit.chemistry.drivers.PySCFDriver.basis" signature="property basis">
    return basis
  ...
  <Function id="qiskit.chemistry.drivers.PySCFDriver.hf_method" signature="property hf_method">
  ...
  <Function id="qiskit.chemistry.drivers.PySCFDriver.molecule" signature="property molecule">
    return molecule
  ...
  <Function id="qiskit.chemistry.drivers.PySCFDriver.supports_molecule" signature="property supports_molecule">
