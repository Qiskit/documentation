...
<Class id="qiskit.algorithms.ShorResult" github="https://github.com/qiskit/qiskit/tree/stable/0.17/qiskit/algorithms/factorizers/shor.py" signature="ShorResult">
  Shor Result.
