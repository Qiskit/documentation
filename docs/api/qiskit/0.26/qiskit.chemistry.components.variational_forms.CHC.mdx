...
<Class id="qiskit.chemistry.components.variational_forms.CHC" github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/chemistry/components/variational_forms/chc.py" signature="CHC(num_qubits=None, reps=1, ladder=False, excitations=None, entanglement='full', initial_state=None)">
  ...
  *   **initial\_state** (`Union`\[`QuantumCircuit`, `InitialState`, `None`]) – an initial state to prepend to the variational form
  ...
  <Function id="qiskit.chemistry.components.variational_forms.CHC.__init__" name="__init__" signature="__init__(num_qubits=None, reps=1, ladder=False, excitations=None, entanglement='full', initial_state=None)">
    **Parameters**
  ...
  <Function id="qiskit.chemistry.components.variational_forms.CHC.construct_circuit" name="construct_circuit" signature="construct_circuit(parameters, q=None)">
  ...
  <Function id="qiskit.chemistry.components.variational_forms.CHC.get_entangler_map" name="get_entangler_map" signature="static get_entangler_map(map_type, num_qubits, offset=0)">
    returns entangler map
  </Function>

  ### num\_parameters

  <Function id="qiskit.chemistry.components.variational_forms.CHC.num_parameters" name="num_parameters" signature="property num_parameters">
  ...
  <Function id="qiskit.chemistry.components.variational_forms.CHC.num_qubits" name="num_qubits" signature="property num_qubits">
  ...
  <Function id="qiskit.chemistry.components.variational_forms.CHC.parameter_bounds" name="parameter_bounds" signature="property parameter_bounds">
    Parameter bounds.
  ...
  <Function id="qiskit.chemistry.components.variational_forms.CHC.preferred_init_points" name="preferred_init_points" signature="property preferred_init_points">
  ...
  <Function id="qiskit.chemistry.components.variational_forms.CHC.setting" name="setting" signature="property setting" />

  ### support\_parameterized\_circuit

  <Function id="qiskit.chemistry.components.variational_forms.CHC.support_parameterized_circuit" name="support_parameterized_circuit" signature="property support_parameterized_circuit">
  ...
  <Function id="qiskit.chemistry.components.variational_forms.CHC.validate_entangler_map" name="validate_entangler_map" signature="static validate_entangler_map(entangler_map, num_qubits)">
