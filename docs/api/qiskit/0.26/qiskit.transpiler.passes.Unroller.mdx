...
<Class id="qiskit.transpiler.passes.Unroller" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.17/qiskit/transpiler/passes/basis/unroller.py" signature="Unroller(*args, **kwargs)">
  ...
  **basis** (*list\[str] or None*) – Target basis names to unroll to, e.g. \[‘u3’, ‘cx’] . If None, does not unroll any gate.
  ...
  <Function id="qiskit.transpiler.passes.Unroller.__init__" name="__init__" signature="__init__(basis)">
    Unroller initializer.
  ...
  <Function id="qiskit.transpiler.passes.Unroller.is_analysis_pass" name="is_analysis_pass" signature="property is_analysis_pass">
  ...
  <Function id="qiskit.transpiler.passes.Unroller.is_transformation_pass" name="is_transformation_pass" signature="property is_transformation_pass">
