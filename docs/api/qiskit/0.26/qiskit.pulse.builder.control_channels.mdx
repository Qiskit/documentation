---
title: control_channels (v0.26)
description: API reference for qiskit.pulse.builder.control_channels in qiskit v0.26
...
<Function id="qiskit.pulse.builder.control_channels" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.17/qiskit/pulse/builder.py" signature="control_channels(*qubits)">
