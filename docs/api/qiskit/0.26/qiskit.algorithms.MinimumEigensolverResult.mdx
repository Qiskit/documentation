...
<Class id="qiskit.algorithms.MinimumEigensolverResult" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.17/qiskit/algorithms/minimum_eigen_solvers/minimum_eigen_solver.py" signature="MinimumEigensolverResult">
  ...
  <Function id="qiskit.algorithms.MinimumEigensolverResult.aux_operator_eigenvalues" signature="property aux_operator_eigenvalues">
  ...
  <Function id="qiskit.algorithms.MinimumEigensolverResult.eigenstate" signature="property eigenstate">
    return eigen state
  ...
  <Function id="qiskit.algorithms.MinimumEigensolverResult.eigenvalue" signature="property eigenvalue">
    returns eigen value
