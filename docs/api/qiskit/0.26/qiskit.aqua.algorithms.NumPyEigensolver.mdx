...
<Class id="qiskit.aqua.algorithms.NumPyEigensolver" github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/aqua/algorithms/eigen_solvers/numpy_eigen_solver.py" signature="NumPyEigensolver(operator=None, k=1, aux_operators=None, filter_criterion=None)">
