...
<Function id="qiskit.visualization.plot_bloch_multivector" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.17/qiskit/visualization/state_visualization.py" signature="plot_bloch_multivector(state, title='', figsize=None, *, rho=None, reverse_bits=False)">
  ...
  **Example**
  ...
  ![../\_images/qiskit.visualization.plot\_bloch\_multivector\_0\_0.png](/images/api/qiskit/0.26/qiskit.visualization.plot_bloch_multivector_0_0.avif) ![../\_images/qiskit.visualization.plot\_bloch\_multivector\_0\_1.png](/images/api/qiskit/0.26/qiskit.visualization.plot_bloch_multivector_0_1.avif)
</Function>
