...
`plot_gate_map(backend, figsize=None, plot_directed=False, label_qubits=True, qubit_size=24, line_width=4, font_size=12, qubit_color=None, qubit_labels=None, line_color=None, font_color='w', ax=None)` [GitHub](https://github.com/qiskit/qiskit/tree/stable/0.17/qiskit/visualization/gate_map.py "view source code")
...
![../\_images/qiskit.visualization.plot\_gate\_map\_1\_0.png](/images/api/qiskit/0.26/qiskit.visualization.plot_gate_map_1_0.png) ![../\_images/qiskit.visualization.plot\_gate\_map\_1\_1.png](/images/api/qiskit/0.26/qiskit.visualization.plot_gate_map_1_1.png)
