...
<Function id="qiskit.quantum_info.hellinger_fidelity" github="https://github.com/qiskit/qiskit/tree/stable/0.17/qiskit/quantum_info/analysis/distance.py" signature="hellinger_fidelity(dist_p, dist_q)">
