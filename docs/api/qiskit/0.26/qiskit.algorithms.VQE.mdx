...
<Class id="qiskit.algorithms.VQE" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.17/qiskit/algorithms/minimum_eigen_solvers/vqe.py" signature="VQE(ansatz=None, optimizer=None, initial_point=None, gradient=None, expectation=None, include_custom=False, max_evals_grouped=1, callback=None, quantum_instance=None)">
  ...
  *   **quantum\_instance** (`Union`\[`Backend`, `BaseBackend`, `QuantumInstance`, `None`]) – Quantum Instance or Backend
  ...
  <Function id="qiskit.algorithms.VQE.__init__" signature="__init__(ansatz=None, optimizer=None, initial_point=None, gradient=None, expectation=None, include_custom=False, max_evals_grouped=1, callback=None, quantum_instance=None)">
    **Parameters**
  ...
  <Function id="qiskit.algorithms.VQE.ansatz" signature="property ansatz">
    Returns the ansatz
  ...
  <Function id="qiskit.algorithms.VQE.construct_expectation" signature="construct_expectation(parameter, operator)">
  ...
  <Function id="qiskit.algorithms.VQE.expectation" signature="property expectation">
  ...
  <Function id="qiskit.algorithms.VQE.initial_point" signature="property initial_point">
  ...
  <Function id="qiskit.algorithms.VQE.optimal_params" signature="property optimal_params">
  ...
  <Function id="qiskit.algorithms.VQE.optimizer" signature="property optimizer">
    Returns optimizer
  ...
  <Function id="qiskit.algorithms.VQE.quantum_instance" signature="property quantum_instance">
  ...
  <Function id="qiskit.algorithms.VQE.setting" signature="property setting">
    Prepare the setting of VQE as a string.
  </Function>

  ### supports\_aux\_operators

  <Function id="qiskit.algorithms.VQE.supports_aux_operators" signature="classmethod supports_aux_operators()">
