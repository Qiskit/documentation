...
<Function id="qiskit.ignis.verification.marginal_counts" github="https://github.com/qiskit-community/qiskit-ignis/tree/stable/0.6/qiskit/ignis/verification/tomography/data.py" signature="marginal_counts(counts, meas_qubits=True, pad_zeros=False)">
