...
`LinearPauliRotations(num_state_qubits=None, slope=1, offset=0, basis='Y', name='LinRot')` [GitHub](https://github.com/qiskit/qiskit/tree/stable/0.17/qiskit/circuit/library/arithmetic/linear_pauli_rotations.py "view source code")
...
![../\_images/qiskit.circuit.library.LinearPauliRotations\_2\_0.png](/images/api/qiskit/0.26/qiskit.circuit.library.LinearPauliRotations_2_0.png)
