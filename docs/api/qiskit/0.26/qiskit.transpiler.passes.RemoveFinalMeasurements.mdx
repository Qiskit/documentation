...
<Class id="qiskit.transpiler.passes.RemoveFinalMeasurements" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.17/qiskit/transpiler/passes/utils/remove_final_measurements.py" signature="RemoveFinalMeasurements(*args, **kwargs)">
  ...
  <Function id="qiskit.transpiler.passes.RemoveFinalMeasurements.__init__" name="__init__" signature="__init__()">
  ...
  <Function id="qiskit.transpiler.passes.RemoveFinalMeasurements.is_analysis_pass" name="is_analysis_pass" signature="property is_analysis_pass">
  ...
  <Function id="qiskit.transpiler.passes.RemoveFinalMeasurements.is_transformation_pass" name="is_transformation_pass" signature="property is_transformation_pass">
  ...
  <Function id="qiskit.transpiler.passes.RemoveFinalMeasurements.name" name="name" signature="name()">
    Return the name of the pass.
  </Function>

  ### run

  <Function id="qiskit.transpiler.passes.RemoveFinalMeasurements.run" name="run" signature="run(dag)">
