...
![../\_images/transpiling\_core\_steps.png](/images/api/qiskit/0.26/transpiling_core_steps.png)
...
![../\_images/transpiler\_2\_0.png](/images/api/qiskit/0.26/transpiler_2_0.png)
...
![../\_images/transpiler\_3\_0.png](/images/api/qiskit/0.26/transpiler_3_0.png)
...
1.  A SWAP gate is not a native gate on the IBM Q devices, and must be decomposed into three CNOT gates:
    ...
    ![../\_images/transpiler\_5\_0.png](/images/api/qiskit/0.26/transpiler_5_0.png)
...
2.  A Toffoli, or controlled-controlled-not gate (ccx), is a three-qubit gate. Given that our basis gate set includes only single- and two-qubit gates, it is obvious that this gate must be decomposed. This decomposition is quite costly:
    ...
    ![../\_images/transpiler\_6\_0.png](/images/api/qiskit/0.26/transpiler_6_0.png)
...
![../\_images/mapping.png](/images/api/qiskit/0.26/mapping.png)
...
![../\_images/transpiler\_7\_0.png](/images/api/qiskit/0.26/transpiler_7_0.png)
...
*   **Layout Using Optimization Level 0**
    ...
    > ```
    >
    > ![../\_images/transpiler\_8\_0.png](/images/api/qiskit/0.26/transpiler_8_0.png)
...
*   **Layout Using Optimization Level 3**
    ...
    > ```
    >
    > ![../\_images/transpiler\_9\_0.png](/images/api/qiskit/0.26/transpiler_9_0.png)
...
![../\_images/transpiler\_10\_0.png](/images/api/qiskit/0.26/transpiler_10_0.png)
...
![../\_images/transpiler\_11\_0.png](/images/api/qiskit/0.26/transpiler_11_0.png)
...
![../\_images/transpiler\_12\_0.png](/images/api/qiskit/0.26/transpiler_12_0.png)
...
![../\_images/transpiler\_13\_0.png](/images/api/qiskit/0.26/transpiler_13_0.png)
...
Depth: 11
Gate counts: OrderedDict([('u2', 9), ('cx', 9), ('u3', 1), ('u1', 1)])
```
