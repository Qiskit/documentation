...
<Class id="qiskit.providers.ibmq.runtime.ProgramBackend" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-ibmq-provider/tree/stable/0.13/qiskit/providers/ibmq/runtime/program/program_backend.py" signature="ProgramBackend(configuration, provider=None, **fields)">
  ...
  **AttributeError** – if input field not a valid options
  ...
  <Function id="qiskit.providers.ibmq.runtime.ProgramBackend.__init__" name="__init__" signature="__init__(configuration, provider=None, **fields)">
    Initialize a backend class
  ...
  <Function id="qiskit.providers.ibmq.runtime.ProgramBackend.configuration" name="configuration" signature="configuration()">
  ...
  <Function id="qiskit.providers.ibmq.runtime.ProgramBackend.name" name="name" signature="name()">
  ...
  <Function id="qiskit.providers.ibmq.runtime.ProgramBackend.options" name="options" signature="property options">
  ...
  <Function id="qiskit.providers.ibmq.runtime.ProgramBackend.properties" name="properties" signature="properties()">
  ...
  <Function id="qiskit.providers.ibmq.runtime.ProgramBackend.provider" name="provider" signature="provider()">
  ...
  <Function id="qiskit.providers.ibmq.runtime.ProgramBackend.run" name="run" signature="abstract run(circuits, timeout=None, **run_config)">
    Run on the backend.
  ...
  <Function id="qiskit.providers.ibmq.runtime.ProgramBackend.set_options" name="set_options" signature="set_options(**fields)">
  ...
  <Function id="qiskit.providers.ibmq.runtime.ProgramBackend.status" name="status" signature="status()">
