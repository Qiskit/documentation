...
<Class id="qiskit.opflow.state_fns.OperatorStateFn" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.17/qiskit/opflow/state_fns/operator_state_fn.py" signature="OperatorStateFn(primitive, coeff=1.0, is_measurement=False)">
  ...
  *   **is\_measurement** (`bool`) – Whether the StateFn is a measurement operator
  ...
  <Function id="qiskit.opflow.state_fns.OperatorStateFn.__init__" name="__init__" signature="__init__(primitive, coeff=1.0, is_measurement=False)">
    **Parameters**
  ...
  <Function id="qiskit.opflow.state_fns.OperatorStateFn.add" name="add" signature="add(other)">
  ...
  <Function id="qiskit.opflow.state_fns.OperatorStateFn.adjoint" name="adjoint" signature="adjoint()">
  ...
  <Function id="qiskit.opflow.state_fns.OperatorStateFn.assign_parameters" name="assign_parameters" signature="assign_parameters(param_dict)">
  ...
  <Function id="qiskit.opflow.state_fns.OperatorStateFn.bind_parameters" name="bind_parameters" signature="bind_parameters(param_dict)">
  ...
  <Function id="qiskit.opflow.state_fns.OperatorStateFn.coeff" name="coeff" signature="property coeff">
  ...
  <Function id="qiskit.opflow.state_fns.OperatorStateFn.compose" name="compose" signature="compose(other, permutation=None, front=False)">
  ...
  <Function id="qiskit.opflow.state_fns.OperatorStateFn.copy" name="copy" signature="copy()">
  ...
  <Function id="qiskit.opflow.state_fns.OperatorStateFn.equals" name="equals" signature="equals(other)">
  ...
  <Function id="qiskit.opflow.state_fns.OperatorStateFn.eval" name="eval" signature="eval(front=None)">
  ...
  <Function id="qiskit.opflow.state_fns.OperatorStateFn.instance_id" name="instance_id" signature="property instance_id">
  ...
  <Function id="qiskit.opflow.state_fns.OperatorStateFn.is_measurement" name="is_measurement" signature="property is_measurement">
  ...
  <Function id="qiskit.opflow.state_fns.OperatorStateFn.mul" name="mul" signature="mul(scalar)">
  ...
  <Function id="qiskit.opflow.state_fns.OperatorStateFn.neg" name="neg" signature="neg()">
  ...
  <Function id="qiskit.opflow.state_fns.OperatorStateFn.num_qubits" name="num_qubits" signature="property num_qubits">
  ...
  <Function id="qiskit.opflow.state_fns.OperatorStateFn.parameters" name="parameters" signature="property parameters">
    Return a set of Parameter objects contained in the Operator.
  </Function>

  ### permute

  <Function id="qiskit.opflow.state_fns.OperatorStateFn.permute" name="permute" signature="permute(permutation)">
  ...
  <Function id="qiskit.opflow.state_fns.OperatorStateFn.power" name="power" signature="power(exponent)">
  ...
  <Function id="qiskit.opflow.state_fns.OperatorStateFn.primitive" name="primitive" signature="property primitive">
    The primitive which defines the behavior of the underlying State function.
  </Function>

  ### primitive\_strings

  <Function id="qiskit.opflow.state_fns.OperatorStateFn.primitive_strings" name="primitive_strings" signature="primitive_strings()">
  ...
  <Function id="qiskit.opflow.state_fns.OperatorStateFn.reduce" name="reduce" signature="reduce()">
  ...
  <Function id="qiskit.opflow.state_fns.OperatorStateFn.sample" name="sample" signature="sample(shots=1024, massive=False, reverse_endianness=False)">
  ...
  <Function id="qiskit.opflow.state_fns.OperatorStateFn.tensor" name="tensor" signature="tensor(other)">
  ...
  <Function id="qiskit.opflow.state_fns.OperatorStateFn.tensorpower" name="tensorpower" signature="tensorpower(other)">
  ...
  <Function id="qiskit.opflow.state_fns.OperatorStateFn.to_circuit_op" name="to_circuit_op" signature="to_circuit_op()">
  ...
  <Function id="qiskit.opflow.state_fns.OperatorStateFn.to_density_matrix" name="to_density_matrix" signature="to_density_matrix(massive=False)">
  ...
  <Function id="qiskit.opflow.state_fns.OperatorStateFn.to_matrix" name="to_matrix" signature="to_matrix(massive=False)">
  ...
  <Function id="qiskit.opflow.state_fns.OperatorStateFn.to_matrix_op" name="to_matrix_op" signature="to_matrix_op(massive=False)">
  ...
  <Function id="qiskit.opflow.state_fns.OperatorStateFn.to_spmatrix" name="to_spmatrix" signature="to_spmatrix()">
  ...
  <Function id="qiskit.opflow.state_fns.OperatorStateFn.traverse" name="traverse" signature="traverse(convert_fn, coeff=None)">
