---
title: OperatorStateFn (v0.26)
description: API reference for qiskit.opflow.state_fns.OperatorStateFn in qiskit v0.26
in_page_toc_min_heading_level: 1
python_api_type: class
python_api_name: qiskit.opflow.state_fns.OperatorStateFn
---

<span id="qiskit-opflow-state-fns-operatorstatefn" />
...
<Class id="qiskit.opflow.state_fns.OperatorStateFn" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.17/qiskit/opflow/state_fns/operator_state_fn.py" signature="OperatorStateFn(primitive, coeff=1.0, is_measurement=False)" modifiers="class">
  ...
  *   **is\_measurement** (`bool`) – Whether the StateFn is a measurement operator
  ...
  <Attribute id="qiskit.opflow.state_fns.OperatorStateFn.primitive">
