---
title: BarrierBeforeFinalMeasurements (v0.26)
description: API reference for qiskit.transpiler.passes.BarrierBeforeFinalMeasurements in qiskit v0.26
...
<Class id="qiskit.transpiler.passes.BarrierBeforeFinalMeasurements" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.17/qiskit/transpiler/passes/utils/barrier_before_final_measurements.py" signature="BarrierBeforeFinalMeasurements(*args, **kwargs)" modifiers="class">
