...
<Class id="qiskit.chemistry.transformations.FermionicTransformation" github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/chemistry/transformations/fermionic_transformation.py" signature="FermionicTransformation(transformation=<FermionicTransformationType.FULL: 'full'>, qubit_mapping=<FermionicQubitMappingType.PARITY: 'parity'>, two_qubit_reduction=True, freeze_core=False, orbital_reduction=None, z2symmetry_reduction=None)">
  ...
  **Raises**
  ...
  <Function id="qiskit.chemistry.transformations.FermionicTransformation.__init__" name="__init__" signature="__init__(transformation=<FermionicTransformationType.FULL: 'full'>, qubit_mapping=<FermionicQubitMappingType.PARITY: 'parity'>, two_qubit_reduction=True, freeze_core=False, orbital_reduction=None, z2symmetry_reduction=None)">
    **Parameters**
  ...
  <Function id="qiskit.chemistry.transformations.FermionicTransformation.build_hopping_operators" name="build_hopping_operators" signature="build_hopping_operators(excitations='sd')">
  ...
  <Function id="qiskit.chemistry.transformations.FermionicTransformation.commutation_rule" name="commutation_rule" signature="property commutation_rule">
  ...
  <Function id="qiskit.chemistry.transformations.FermionicTransformation.get_default_filter_criterion" name="get_default_filter_criterion" signature="get_default_filter_criterion()">
  ...
  <Function id="qiskit.chemistry.transformations.FermionicTransformation.interpret" name="interpret" signature="interpret(raw_result)">
  ...
  <Function id="qiskit.chemistry.transformations.FermionicTransformation.molecule_info" name="molecule_info" signature="property molecule_info">
  ...
  <Function id="qiskit.chemistry.transformations.FermionicTransformation.qubit_mapping" name="qubit_mapping" signature="property qubit_mapping">
  ...
  <Function id="qiskit.chemistry.transformations.FermionicTransformation.transform" name="transform" signature="transform(driver, aux_operators=None)">
  ...
  <Function id="qiskit.chemistry.transformations.FermionicTransformation.untapered_qubit_op" name="untapered_qubit_op" signature="property untapered_qubit_op">
