...
<Class id="qiskit.providers.ibmq.managed.ManagedJobSet" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-ibmq-provider/tree/stable/0.13/qiskit/providers/ibmq/managed/managedjobset.py" signature="ManagedJobSet(name=None, short_id=None)">
  ...
  *   **short\_id** (`Optional`\[`str`]) – Short ID for this set of jobs.
  ...
  <Function id="qiskit.providers.ibmq.managed.ManagedJobSet.__init__" name="__init__" signature="__init__(name=None, short_id=None)">
    ManagedJobSet constructor.
  ...
  <Function id="qiskit.providers.ibmq.managed.ManagedJobSet.cancel" name="cancel" signature="cancel()">
  ...
  <Function id="qiskit.providers.ibmq.managed.ManagedJobSet.error_messages" name="error_messages" signature="error_messages()">
  ...
  <Function id="qiskit.providers.ibmq.managed.ManagedJobSet.job" name="job" signature="job(experiment)">
  ...
  <Function id="qiskit.providers.ibmq.managed.ManagedJobSet.job_set_id" name="job_set_id" signature="job_set_id()">
  ...
  <Function id="qiskit.providers.ibmq.managed.ManagedJobSet.jobs" name="jobs" signature="jobs()">
  ...
  <Function id="qiskit.providers.ibmq.managed.ManagedJobSet.managed_jobs" name="managed_jobs" signature="managed_jobs()">
  ...
  <Function id="qiskit.providers.ibmq.managed.ManagedJobSet.name" name="name" signature="name()">
  ...
  <Function id="qiskit.providers.ibmq.managed.ManagedJobSet.qobjs" name="qobjs" signature="qobjs()">
  ...
  <Function id="qiskit.providers.ibmq.managed.ManagedJobSet.report" name="report" signature="report(detailed=True)">
  ...
  <Function id="qiskit.providers.ibmq.managed.ManagedJobSet.results" name="results" signature="results(timeout=None, partial=False, refresh=False)">
  ...
  <Function id="qiskit.providers.ibmq.managed.ManagedJobSet.retrieve_jobs" name="retrieve_jobs" signature="retrieve_jobs(provider, refresh=False)">
  ...
  <Function id="qiskit.providers.ibmq.managed.ManagedJobSet.run" name="run" signature="run(experiment_list, backend, executor, job_share_level, job_tags=None, **run_config)">
  ...
  <Function id="qiskit.providers.ibmq.managed.ManagedJobSet.statuses" name="statuses" signature="statuses()">
  ...
  <Function id="qiskit.providers.ibmq.managed.ManagedJobSet.tags" name="tags" signature="tags()">
  ...
  <Function id="qiskit.providers.ibmq.managed.ManagedJobSet.update_name" name="update_name" signature="update_name(name)">
  ...
  <Function id="qiskit.providers.ibmq.managed.ManagedJobSet.update_tags" name="update_tags" signature="update_tags(replacement_tags=None, additional_tags=None, removal_tags=None)">
