---
title: ManagedJobSet (v0.26)
description: API reference for qiskit.providers.ibmq.managed.ManagedJobSet in qiskit v0.26
...
<Class id="qiskit.providers.ibmq.managed.ManagedJobSet" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-ibmq-provider/tree/stable/0.13/qiskit/providers/ibmq/managed/managedjobset.py" signature="ManagedJobSet(name=None, short_id=None)" modifiers="class">
  ...
  *   **short\_id** (`Optional`\[`str`]) – Short ID for this set of jobs.
  ...
  <Function id="qiskit.providers.ibmq.managed.ManagedJobSet.__init__" signature="__init__(name=None, short_id=None)">
    ManagedJobSet constructor.
  ...
  <Function id="qiskit.providers.ibmq.managed.ManagedJobSet.cancel" signature="cancel()">
  ...
  <Function id="qiskit.providers.ibmq.managed.ManagedJobSet.error_messages" signature="error_messages()">
  ...
  <Function id="qiskit.providers.ibmq.managed.ManagedJobSet.job" signature="job(experiment)">
  ...
  <Function id="qiskit.providers.ibmq.managed.ManagedJobSet.job_set_id" signature="job_set_id()">
  ...
  <Function id="qiskit.providers.ibmq.managed.ManagedJobSet.jobs" signature="jobs()">
  ...
  <Function id="qiskit.providers.ibmq.managed.ManagedJobSet.managed_jobs" signature="managed_jobs()">
  ...
  <Function id="qiskit.providers.ibmq.managed.ManagedJobSet.name" signature="name()">
  ...
  <Function id="qiskit.providers.ibmq.managed.ManagedJobSet.qobjs" signature="qobjs()">
  ...
  <Function id="qiskit.providers.ibmq.managed.ManagedJobSet.report" signature="report(detailed=True)">
  ...
  <Function id="qiskit.providers.ibmq.managed.ManagedJobSet.results" signature="results(timeout=None, partial=False, refresh=False)">
  ...
  <Function id="qiskit.providers.ibmq.managed.ManagedJobSet.retrieve_jobs" signature="retrieve_jobs(provider, refresh=False)">
  ...
  <Function id="qiskit.providers.ibmq.managed.ManagedJobSet.run" signature="run(experiment_list, backend, executor, job_share_level, job_tags=None, **run_config)">
  ...
  <Function id="qiskit.providers.ibmq.managed.ManagedJobSet.statuses" signature="statuses()">
  ...
  <Function id="qiskit.providers.ibmq.managed.ManagedJobSet.tags" signature="tags()">
  ...
  <Function id="qiskit.providers.ibmq.managed.ManagedJobSet.update_name" signature="update_name(name)">
  ...
  <Function id="qiskit.providers.ibmq.managed.ManagedJobSet.update_tags" signature="update_tags(replacement_tags=None, additional_tags=None, removal_tags=None)">
