...
<Class id="qiskit.optimization.algorithms.ADMMOptimizationResult" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/optimization/algorithms/admm_optimizer.py" signature="ADMMOptimizationResult(x, fval, variables, state, status)" modifiers="class">
  ...
  *   **status** (`OptimizationResultStatus`) – Termination status of an optimization algorithm
  ...
  <Function id="qiskit.optimization.algorithms.ADMMOptimizationResult.fval" signature="fval" modifiers="property">
  ...
  <Function id="qiskit.optimization.algorithms.ADMMOptimizationResult.raw_results" signature="raw_results" modifiers="property">
  ...
  <Function id="qiskit.optimization.algorithms.ADMMOptimizationResult.samples" signature="samples" modifiers="property">
  ...
  <Function id="qiskit.optimization.algorithms.ADMMOptimizationResult.state" signature="state" modifiers="property">
    returns state
  ...
  <Function id="qiskit.optimization.algorithms.ADMMOptimizationResult.status" signature="status" modifiers="property">
  ...
  <Function id="qiskit.optimization.algorithms.ADMMOptimizationResult.variable_names" signature="variable_names" modifiers="property">
  ...
  <Function id="qiskit.optimization.algorithms.ADMMOptimizationResult.variables" signature="variables" modifiers="property">
  ...
  <Function id="qiskit.optimization.algorithms.ADMMOptimizationResult.variables_dict" signature="variables_dict" modifiers="property">
  ...
  <Function id="qiskit.optimization.algorithms.ADMMOptimizationResult.x" signature="x" modifiers="property">
