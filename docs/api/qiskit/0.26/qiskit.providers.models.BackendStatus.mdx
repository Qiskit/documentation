...
<Class id="qiskit.providers.models.BackendStatus" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.17/qiskit/providers/models/backendstatus.py" signature="BackendStatus(backend_name, backend_version, operational, pending_jobs, status_msg)">
  ...
  **QiskitError** – If the backend version is in an invalid format
  ...
  <Function id="qiskit.providers.models.BackendStatus.__init__" name="__init__" signature="__init__(backend_name, backend_version, operational, pending_jobs, status_msg)">
    Initialize a BackendStatus object
  ...
  <Function id="qiskit.providers.models.BackendStatus.from_dict" name="from_dict" signature="classmethod from_dict(data)">
  ...
  <Function id="qiskit.providers.models.BackendStatus.to_dict" name="to_dict" signature="to_dict()">
