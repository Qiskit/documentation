...
`plot_bloch_multivector(state, title='', figsize=None, *, rho=None, reverse_bits=False)` [GitHub](https://github.com/qiskit/qiskit/tree/stable/0.17/qiskit/visualization/state_visualization.py "view source code")
...
![../\_images/qiskit.visualization.plot\_bloch\_multivector\_0\_0.png](/images/api/qiskit/0.26/qiskit.visualization.plot_bloch_multivector_0_0.png) ![../\_images/qiskit.visualization.plot\_bloch\_multivector\_0\_1.png](/images/api/qiskit/0.26/qiskit.visualization.plot_bloch_multivector_0_1.png)
