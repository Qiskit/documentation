...
<Class id="qiskit.optimization.converters.LinearEqualityToPenalty" github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/optimization/converters/linear_equality_to_penalty.py" signature="LinearEqualityToPenalty(penalty=None)">
  ...
  **penalty** (`Optional`\[`float`]) – Penalty factor to scale equality constraints that are added to objective. If None is passed, penalty factor will be automatically calculated.
  ...
  <Function id="qiskit.optimization.converters.LinearEqualityToPenalty.interpret" name="interpret" signature="interpret(x)">
