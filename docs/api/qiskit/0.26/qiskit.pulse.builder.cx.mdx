...
<Function id="qiskit.pulse.builder.cx" name="cx" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.17/qiskit/pulse/builder.py" signature="cx(control, target)">
