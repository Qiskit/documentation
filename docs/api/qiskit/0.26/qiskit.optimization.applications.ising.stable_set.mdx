...
<Function id="qiskit.optimization.applications.ising.stable_set.get_graph_solution" name="get_graph_solution" github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/optimization/applications/ising/stable_set.py" signature="get_graph_solution(x)">
...
<Function id="qiskit.optimization.applications.ising.stable_set.get_operator" name="get_operator" github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/optimization/applications/ising/stable_set.py" signature="get_operator(w)">
...
<Function id="qiskit.optimization.applications.ising.stable_set.stable_set_value" name="stable_set_value" github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/optimization/applications/ising/stable_set.py" signature="stable_set_value(x, w)">
