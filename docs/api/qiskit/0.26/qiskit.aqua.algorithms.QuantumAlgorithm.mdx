...
<Class id="qiskit.aqua.algorithms.QuantumAlgorithm" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/aqua/algorithms/quantum_algorithm.py" signature="QuantumAlgorithm(quantum_instance)">
  ...
  <Function id="qiskit.aqua.algorithms.QuantumAlgorithm.__init__" signature="abstract __init__(quantum_instance)">
  ...
  <Function id="qiskit.aqua.algorithms.QuantumAlgorithm.backend" signature="property backend">
    Returns backend.
  ...
  <Function id="qiskit.aqua.algorithms.QuantumAlgorithm.quantum_instance" signature="property quantum_instance">
  ...
  <Function id="qiskit.aqua.algorithms.QuantumAlgorithm.random" signature="property random">
