...
<Class id="qiskit.ignis.verification.AccreditationCircuits" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-ignis/tree/stable/0.6/qiskit/ignis/verification/accreditation/circuits.py" signature="AccreditationCircuits(target_circ, two_qubit_gate='cx', coupling_map=None, seed=None)">
  ...
  *   **seed** (*int*) – seed to the random number generator
  ...
  <Function id="qiskit.ignis.verification.AccreditationCircuits.__init__" name="__init__" signature="__init__(target_circ, two_qubit_gate='cx', coupling_map=None, seed=None)">
    Initialize the circuit generation class parse into layers
  ...
  <Function id="qiskit.ignis.verification.AccreditationCircuits.generate_circuits" name="generate_circuits" signature="generate_circuits(num_trap)">
  ...
  <Function id="qiskit.ignis.verification.AccreditationCircuits.target_circuit" name="target_circuit" signature="target_circuit(target_circ, two_qubit_gate='cx', coupling_map=None)">
