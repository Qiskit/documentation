...
<Class id="qiskit.pulse.instructions.Instruction" github="https://github.com/qiskit/qiskit/tree/stable/0.17/qiskit/pulse/instructions/instruction.py" signature="Instruction(operands, duration=None, channels=None, name=None)">
  ...
  *   [**PulseError**](qiskit.pulse.PulseError "qiskit.pulse.PulseError") – If the input `channels` are not all of type `Channel`.
  ...
  <Function id="qiskit.pulse.instructions.Instruction.__init__" name="__init__" signature="__init__(operands, duration=None, channels=None, name=None)">
    Instruction initializer.
  ...
  <Function id="qiskit.pulse.instructions.Instruction.channels" name="channels" signature="abstract property channels">
  ...
  <Function id="qiskit.pulse.instructions.Instruction.is_parameterized" name="is_parameterized" signature="is_parameterized()">
  ...
  <Function id="qiskit.pulse.instructions.Instruction.parameters" name="parameters" signature="property parameters">
