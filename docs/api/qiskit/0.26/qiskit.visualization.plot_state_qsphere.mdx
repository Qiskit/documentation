...
<Function id="qiskit.visualization.plot_state_qsphere" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.17/qiskit/visualization/state_visualization.py" signature="plot_state_qsphere(state, figsize=None, ax=None, show_state_labels=True, show_state_phases=False, use_degrees=False, *, rho=None)">
  ...
  **Example**
  ...
  ![../\_images/qiskit.visualization.plot\_state\_qsphere\_0\_0.png](/images/api/qiskit/0.26/qiskit.visualization.plot_state_qsphere_0_0.avif) ![../\_images/qiskit.visualization.plot\_state\_qsphere\_0\_1.png](/images/api/qiskit/0.26/qiskit.visualization.plot_state_qsphere_0_1.avif)
</Function>
