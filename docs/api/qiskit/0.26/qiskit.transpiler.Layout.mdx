...
<Class id="qiskit.transpiler.Layout" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.17/qiskit/transpiler/layout.py" signature="Layout(input_dict=None)">
  ...
  <Function id="qiskit.transpiler.Layout.from_intlist" signature="static from_intlist(int_list, *qregs)">
  ...
  <Function id="qiskit.transpiler.Layout.from_qubit_list" signature="static from_qubit_list(qubit_list, *qregs)">
  ...
  <Function id="qiskit.transpiler.Layout.generate_trivial_layout" signature="static generate_trivial_layout(*regs)">
  ...
  <Function id="qiskit.transpiler.Layout.order_based_on_type" signature="static order_based_on_type(value1, value2)">
