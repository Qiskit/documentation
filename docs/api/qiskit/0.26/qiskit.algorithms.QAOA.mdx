...
<Class id="qiskit.algorithms.QAOA" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.17/qiskit/algorithms/minimum_eigen_solvers/qaoa.py" signature="QAOA(optimizer=None, reps=1, initial_state=None, mixer=None, initial_point=None, gradient=None, expectation=None, include_custom=False, max_evals_grouped=1, callback=None, quantum_instance=None)">
  ...
  *   **quantum\_instance** (`Union`\[`Backend`, `BaseBackend`, `QuantumInstance`, `None`]) – Quantum Instance or Backend
  ...
  <Function id="qiskit.algorithms.QAOA.ansatz" signature="property ansatz">
    Returns the ansatz
  ...
  <Function id="qiskit.algorithms.QAOA.expectation" signature="property expectation">
  ...
  <Function id="qiskit.algorithms.QAOA.initial_point" signature="property initial_point">
  ...
  <Function id="qiskit.algorithms.QAOA.initial_state" signature="property initial_state">
  ...
  <Function id="qiskit.algorithms.QAOA.mixer" signature="property mixer">
  ...
  <Function id="qiskit.algorithms.QAOA.optimal_params" signature="property optimal_params">
  ...
  <Function id="qiskit.algorithms.QAOA.optimizer" signature="property optimizer">
    Returns optimizer
  ...
  <Function id="qiskit.algorithms.QAOA.quantum_instance" signature="property quantum_instance">
  ...
  <Function id="qiskit.algorithms.QAOA.setting" signature="property setting">
    Prepare the setting of VQE as a string.
  </Function>

  ### supports\_aux\_operators

  <Function id="qiskit.algorithms.QAOA.supports_aux_operators" signature="classmethod supports_aux_operators()">
