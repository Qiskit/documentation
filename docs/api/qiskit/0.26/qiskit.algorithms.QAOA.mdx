...
<Class id="qiskit.algorithms.QAOA" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.17/qiskit/algorithms/minimum_eigen_solvers/qaoa.py" signature="QAOA(optimizer=None, reps=1, initial_state=None, mixer=None, initial_point=None, gradient=None, expectation=None, include_custom=False, max_evals_grouped=1, callback=None, quantum_instance=None)" modifiers="class">
  ...
  *   **quantum\_instance** (`Union`\[`Backend`, `BaseBackend`, `QuantumInstance`, `None`]) – Quantum Instance or Backend
  ...
  <Function id="qiskit.algorithms.QAOA.ansatz" signature="ansatz" modifiers="property">
    Returns the ansatz
  ...
  <Function id="qiskit.algorithms.QAOA.expectation" signature="expectation" modifiers="property">
  ...
  <Function id="qiskit.algorithms.QAOA.initial_point" signature="initial_point" modifiers="property">
  ...
  <Function id="qiskit.algorithms.QAOA.initial_state" signature="initial_state" modifiers="property">
  ...
  <Function id="qiskit.algorithms.QAOA.mixer" signature="mixer" modifiers="property">
  ...
  <Function id="qiskit.algorithms.QAOA.optimal_params" signature="optimal_params" modifiers="property">
  ...
  <Function id="qiskit.algorithms.QAOA.optimizer" signature="optimizer" modifiers="property">
    Returns optimizer
  ...
  <Function id="qiskit.algorithms.QAOA.quantum_instance" signature="quantum_instance" modifiers="property">
  ...
  <Function id="qiskit.algorithms.QAOA.setting" signature="setting" modifiers="property">
