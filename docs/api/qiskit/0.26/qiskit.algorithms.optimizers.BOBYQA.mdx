...
<Class id="qiskit.algorithms.optimizers.BOBYQA" github="https://github.com/qiskit/qiskit/tree/stable/0.17/qiskit/algorithms/optimizers/bobyqa.py" signature="BOBYQA(maxiter=1000)">
