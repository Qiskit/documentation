...
<Class id="qiskit.aqua.utils.CircuitFactory" github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/aqua/utils/circuit_factory.py" signature="CircuitFactory(num_target_qubits)">
