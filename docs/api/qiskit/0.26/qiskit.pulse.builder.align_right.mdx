---
title: align_right (v0.26)
description: API reference for qiskit.pulse.builder.align_right in qiskit v0.26
...
<Function id="qiskit.pulse.builder.align_right" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.17/qiskit/pulse/builder.py" signature="align_right()">
