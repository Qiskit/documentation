...
<Class id="qiskit.ignis.mitigation.CompleteMeasFitter" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-ignis/tree/stable/0.6/qiskit/ignis/mitigation/measurement/fitters.py" signature="CompleteMeasFitter(results, state_labels, qubit_list=None, circlabel='')">
  ...
  *   **circlabel** (`str`) – if the qubits were labeled.
  ...
  <Function id="qiskit.ignis.mitigation.CompleteMeasFitter.cal_matrix" signature="property cal_matrix">
    Return cal\_matrix.
  </Function>

  ### filter

  <Function id="qiskit.ignis.mitigation.CompleteMeasFitter.filter" signature="property filter">
  ...
  <Function id="qiskit.ignis.mitigation.CompleteMeasFitter.qubit_list" signature="property qubit_list">
  ...
  <Function id="qiskit.ignis.mitigation.CompleteMeasFitter.state_labels" signature="property state_labels">
