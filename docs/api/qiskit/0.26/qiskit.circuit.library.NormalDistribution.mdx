...
`NormalDistribution(num_qubits, mu=None, sigma=None, bounds=None, upto_diag=False, name='P(X)')` [GitHub](https://github.com/qiskit/qiskit/tree/stable/0.17/qiskit/circuit/library/probability_distributions/normal.py "view source code")
...
| [`compose`](#qiskit.circuit.library.NormalDistribution.compose "qiskit.circuit.library.NormalDistribution.compose")(other\[, qubits, clbits, front, inplace])                                                 | Compose circuit with `other` circuit or instruction, optionally permuting wires.                                                    |
...
| [`pauli`](#qiskit.circuit.library.NormalDistribution.pauli "qiskit.circuit.library.NormalDistribution.pauli")(pauli\_string, qubits)                                                                          | Apply `PauliGate`.                                                                                                                  |
...
| [`qasm`](#qiskit.circuit.library.NormalDistribution.qasm "qiskit.circuit.library.NormalDistribution.qasm")(\[formatted, filename])                                                                            | Return OpenQASM string.                                                                                                             |
...
| [`to_instruction`](#qiskit.circuit.library.NormalDistribution.to_instruction "qiskit.circuit.library.NormalDistribution.to_instruction")(\[parameter\_map])                                                   | Create an Instruction out of this circuit.                                                                                          |
...
![../\_images/qiskit.circuit.library.NormalDistribution\_2\_0.png](/images/api/qiskit/0.26/qiskit.circuit.library.NormalDistribution_2_0.png)
