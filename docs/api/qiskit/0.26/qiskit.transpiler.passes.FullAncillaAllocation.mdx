---
title: FullAncillaAllocation (v0.26)
description: API reference for qiskit.transpiler.passes.FullAncillaAllocation in qiskit v0.26
...
<Class id="qiskit.transpiler.passes.FullAncillaAllocation" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.17/qiskit/transpiler/passes/layout/full_ancilla_allocation.py" signature="FullAncillaAllocation(*args, **kwargs)" modifiers="class">
  ...
  **coupling\_map** (*Coupling*) – directed graph representing a coupling map.
  ...
  <Function id="qiskit.transpiler.passes.FullAncillaAllocation.__init__" signature="__init__(coupling_map)">
    FullAncillaAllocation initializer.
