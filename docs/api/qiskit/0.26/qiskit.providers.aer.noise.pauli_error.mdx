...
<Function id="qiskit.providers.aer.noise.pauli_error" name="pauli_error" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-aer/tree/stable/0.8/qiskit/providers/aer/noise/errors/standard_errors.py" signature="pauli_error(noise_ops, standard_gates=True)">
