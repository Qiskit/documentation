...
<Class id="qiskit.aqua.operators.evolutions.EvolvedOp" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/aqua/operators/evolutions/evolved_op.py" signature="EvolvedOp(primitive, coeff=1.0)">
  ...
  *   **coeff** (`Union`\[`int`, `float`, `complex`, `ParameterExpression`, `None`]) – A coefficient multiplying the operator
  ...
  <Function id="qiskit.aqua.operators.evolutions.EvolvedOp.__init__" name="__init__" signature="__init__(primitive, coeff=1.0)">
    **Parameters**
  ...
  <Function id="qiskit.aqua.operators.evolutions.EvolvedOp.add" name="add" signature="add(other)">
  ...
  <Function id="qiskit.aqua.operators.evolutions.EvolvedOp.adjoint" name="adjoint" signature="adjoint()">
  ...
  <Function id="qiskit.aqua.operators.evolutions.EvolvedOp.assign_parameters" name="assign_parameters" signature="assign_parameters(param_dict)">
  ...
  <Function id="qiskit.aqua.operators.evolutions.EvolvedOp.bind_parameters" name="bind_parameters" signature="bind_parameters(param_dict)">
  ...
  <Function id="qiskit.aqua.operators.evolutions.EvolvedOp.coeff" name="coeff" signature="property coeff">
  ...
  <Function id="qiskit.aqua.operators.evolutions.EvolvedOp.compose" name="compose" signature="compose(other, permutation=None, front=False)">
  ...
  <Function id="qiskit.aqua.operators.evolutions.EvolvedOp.equals" name="equals" signature="equals(other)">
  ...
  <Function id="qiskit.aqua.operators.evolutions.EvolvedOp.eval" name="eval" signature="eval(front=None)">
  ...
  <Function id="qiskit.aqua.operators.evolutions.EvolvedOp.exp_i" name="exp_i" signature="exp_i()">
  ...
  <Function id="qiskit.aqua.operators.evolutions.EvolvedOp.log_i" name="log_i" signature="log_i(massive=False)">
  ...
  <Function id="qiskit.aqua.operators.evolutions.EvolvedOp.mul" name="mul" signature="mul(scalar)">
  ...
  <Function id="qiskit.aqua.operators.evolutions.EvolvedOp.neg" name="neg" signature="neg()">
  ...
  <Function id="qiskit.aqua.operators.evolutions.EvolvedOp.num_qubits" name="num_qubits" signature="property num_qubits">
  ...
  <Function id="qiskit.aqua.operators.evolutions.EvolvedOp.parameters" name="parameters" signature="property parameters">
    Return a set of Parameter objects contained in the Operator.
  </Function>

  ### permute

  <Function id="qiskit.aqua.operators.evolutions.EvolvedOp.permute" name="permute" signature="permute(permutation)">
  ...
  <Function id="qiskit.aqua.operators.evolutions.EvolvedOp.power" name="power" signature="power(exponent)">
  ...
  <Function id="qiskit.aqua.operators.evolutions.EvolvedOp.primitive" name="primitive" signature="property primitive">
  ...
  <Function id="qiskit.aqua.operators.evolutions.EvolvedOp.primitive_strings" name="primitive_strings" signature="primitive_strings()">
  ...
  <Function id="qiskit.aqua.operators.evolutions.EvolvedOp.reduce" name="reduce" signature="reduce()">
  ...
  <Function id="qiskit.aqua.operators.evolutions.EvolvedOp.tensor" name="tensor" signature="tensor(other)">
  ...
  <Function id="qiskit.aqua.operators.evolutions.EvolvedOp.tensorpower" name="tensorpower" signature="tensorpower(other)">
  ...
  <Function id="qiskit.aqua.operators.evolutions.EvolvedOp.to_circuit" name="to_circuit" signature="to_circuit()">
  ...
  <Function id="qiskit.aqua.operators.evolutions.EvolvedOp.to_circuit_op" name="to_circuit_op" signature="to_circuit_op()">
  ...
  <Function id="qiskit.aqua.operators.evolutions.EvolvedOp.to_instruction" name="to_instruction" signature="to_instruction(massive=False)">
  ...
  <Function id="qiskit.aqua.operators.evolutions.EvolvedOp.to_legacy_op" name="to_legacy_op" signature="to_legacy_op(massive=False)">
  ...
  <Function id="qiskit.aqua.operators.evolutions.EvolvedOp.to_matrix" name="to_matrix" signature="to_matrix(massive=False)">
  ...
  <Function id="qiskit.aqua.operators.evolutions.EvolvedOp.to_matrix_op" name="to_matrix_op" signature="to_matrix_op(massive=False)">
  ...
  <Function id="qiskit.aqua.operators.evolutions.EvolvedOp.to_pauli_op" name="to_pauli_op" signature="to_pauli_op(massive=False)">
