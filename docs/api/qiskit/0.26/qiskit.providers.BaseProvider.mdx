...
<Class id="qiskit.providers.BaseProvider" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.17/qiskit/providers/baseprovider.py" signature="BaseProvider(*args, **kwargs)">
  ...
  <Function id="qiskit.providers.BaseProvider.backends" signature="abstract backends(name=None, **kwargs)">
