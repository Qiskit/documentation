---
title: commutator (v0.26)
description: API reference for qiskit.opflow.commutator in qiskit v0.26
...
<Function id="qiskit.opflow.commutator" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.17/qiskit/opflow/utils.py" signature="commutator(op_a, op_b)">
