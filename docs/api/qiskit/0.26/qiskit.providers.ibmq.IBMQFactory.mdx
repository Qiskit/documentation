...
<Class id="qiskit.providers.ibmq.IBMQFactory" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-ibmq-provider/tree/stable/0.13/qiskit/providers/ibmq/ibmqfactory.py" signature="IBMQFactory">
  ...
  <Function id="qiskit.providers.ibmq.IBMQFactory.__init__" name="__init__" signature="__init__()">
    IBMQFactory constructor.
  </Function>
  ...
  <Function id="qiskit.providers.ibmq.IBMQFactory.active_account" name="active_account" signature="active_account()">
  ...
  <Function id="qiskit.providers.ibmq.IBMQFactory.delete_account" name="delete_account" signature="static delete_account()">
  ...
  <Function id="qiskit.providers.ibmq.IBMQFactory.disable_account" name="disable_account" signature="disable_account()">
  ...
  <Function id="qiskit.providers.ibmq.IBMQFactory.enable_account" name="enable_account" signature="enable_account(token, url='https://auth.quantum-computing.ibm.com/api', hub=None, group=None, project=None, **kwargs)">
  ...
  <Function id="qiskit.providers.ibmq.IBMQFactory.get_provider" name="get_provider" signature="get_provider(hub=None, group=None, project=None)">
  ...
  <Function id="qiskit.providers.ibmq.IBMQFactory.load_account" name="load_account" signature="load_account()">
  ...
  <Function id="qiskit.providers.ibmq.IBMQFactory.providers" name="providers" signature="providers(hub=None, group=None, project=None)">
  ...
  <Function id="qiskit.providers.ibmq.IBMQFactory.save_account" name="save_account" signature="static save_account(token, url='https://auth.quantum-computing.ibm.com/api', hub=None, group=None, project=None, overwrite=False, **kwargs)">
  ...
  <Function id="qiskit.providers.ibmq.IBMQFactory.stored_account" name="stored_account" signature="static stored_account()">
  ...
  <Function id="qiskit.providers.ibmq.IBMQFactory.update_account" name="update_account" signature="static update_account(force=False)">
