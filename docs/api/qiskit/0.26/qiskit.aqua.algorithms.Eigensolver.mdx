...
<Class id="qiskit.aqua.algorithms.Eigensolver" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/aqua/algorithms/eigen_solvers/eigen_solver.py" signature="Eigensolver">
  ...
  <Function id="qiskit.aqua.algorithms.Eigensolver.__init__" name="__init__" signature="abstract __init__()">
  ...
  <Function id="qiskit.aqua.algorithms.Eigensolver.aux_operators" name="aux_operators" signature="abstract property aux_operators">
  ...
  <Function id="qiskit.aqua.algorithms.Eigensolver.compute_eigenvalues" name="compute_eigenvalues" signature="abstract compute_eigenvalues(operator=None, aux_operators=None)">
  ...
  <Function id="qiskit.aqua.algorithms.Eigensolver.operator" name="operator" signature="abstract property operator">
    Return the operator.
  ...
  <Function id="qiskit.aqua.algorithms.Eigensolver.supports_aux_operators" name="supports_aux_operators" signature="classmethod supports_aux_operators()">
