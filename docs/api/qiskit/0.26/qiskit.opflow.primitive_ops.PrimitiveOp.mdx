...
<Class id="qiskit.opflow.primitive_ops.PrimitiveOp" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.17/qiskit/opflow/primitive_ops/primitive_op.py" signature="PrimitiveOp(primitive, coeff=1.0)" modifiers="class">
  ...
  *   **coeff** (`Union`\[`complex`, `ParameterExpression`]) – A coefficient multiplying the primitive.
  ...
  <Function id="qiskit.opflow.primitive_ops.PrimitiveOp.__init__" signature="__init__(primitive, coeff=1.0)">
    **Parameters**
  ...
  <Function id="qiskit.opflow.primitive_ops.PrimitiveOp.bind_parameters" signature="bind_parameters(param_dict)">
  ...
  <Function id="qiskit.opflow.primitive_ops.PrimitiveOp.coeff" signature="coeff" modifiers="property">
  ...
  <Function id="qiskit.opflow.primitive_ops.PrimitiveOp.copy" signature="copy()">
  ...
  <Function id="qiskit.opflow.primitive_ops.PrimitiveOp.instance_id" signature="instance_id" modifiers="property">
  ...
  <Function id="qiskit.opflow.primitive_ops.PrimitiveOp.neg" signature="neg()">
  ...
  <Function id="qiskit.opflow.primitive_ops.PrimitiveOp.num_qubits" signature="num_qubits" modifiers="property">
  ...
  <Function id="qiskit.opflow.primitive_ops.PrimitiveOp.parameters" signature="parameters" modifiers="property">
  ...
  <Function id="qiskit.opflow.primitive_ops.PrimitiveOp.power" signature="power(exponent)">
  ...
  <Function id="qiskit.opflow.primitive_ops.PrimitiveOp.primitive" signature="primitive" modifiers="property">
  ...
  <Function id="qiskit.opflow.primitive_ops.PrimitiveOp.to_spmatrix" signature="to_spmatrix()">
