---
title: PrimitiveOp (v0.26)
description: API reference for qiskit.opflow.primitive_ops.PrimitiveOp in qiskit v0.26
in_page_toc_min_heading_level: 1
python_api_type: class
python_api_name: qiskit.opflow.primitive_ops.PrimitiveOp
---

<span id="qiskit-opflow-primitive-ops-primitiveop" />
