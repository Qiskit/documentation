...
<Function id="qiskit.pulse.builder.barrier" name="barrier" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.17/qiskit/pulse/builder.py" signature="barrier(*channels_or_qubits, name=None)">
