...
<Class id="qiskit.aqua.components.oracles.LogicalExpressionOracle" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/aqua/components/oracles/logical_expression_oracle.py" signature="LogicalExpressionOracle(expression, optimization=False, mct_mode='basic')">
  ...
  **Raises**
  ...
  <Function id="qiskit.aqua.components.oracles.LogicalExpressionOracle.__init__" name="__init__" signature="__init__(expression, optimization=False, mct_mode='basic')">
    **Parameters**
  ...
  <Function id="qiskit.aqua.components.oracles.LogicalExpressionOracle.ancillary_register" name="ancillary_register" signature="property ancillary_register">
    returns ancillary register
  </Function>

  ### circuit

  <Function id="qiskit.aqua.components.oracles.LogicalExpressionOracle.circuit" name="circuit" signature="property circuit" />

  ### construct\_circuit

  <Function id="qiskit.aqua.components.oracles.LogicalExpressionOracle.construct_circuit" name="construct_circuit" signature="construct_circuit()">
    construct circuit
  </Function>

  ### evaluate\_classically

  <Function id="qiskit.aqua.components.oracles.LogicalExpressionOracle.evaluate_classically" name="evaluate_classically" signature="evaluate_classically(measurement)">
    evaluate classically
  </Function>

  ### output\_register

  <Function id="qiskit.aqua.components.oracles.LogicalExpressionOracle.output_register" name="output_register" signature="property output_register">
    returns output register
  </Function>

  ### variable\_register

  <Function id="qiskit.aqua.components.oracles.LogicalExpressionOracle.variable_register" name="variable_register" signature="property variable_register">
