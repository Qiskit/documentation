...
<Class id="qiskit.transpiler.passes.StochasticSwap" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.17/qiskit/transpiler/passes/routing/stochastic_swap.py" signature="StochasticSwap(*args, **kwargs)">
  ...
  *   **seed** (*int*) – seed for random number generator
  ...
  <Function id="qiskit.transpiler.passes.StochasticSwap.__init__" name="__init__" signature="__init__(coupling_map, trials=20, seed=None)">
    StochasticSwap initializer.
