---
title: StochasticSwap (v0.26)
description: API reference for qiskit.transpiler.passes.StochasticSwap in qiskit v0.26
...
<Class id="qiskit.transpiler.passes.StochasticSwap" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.17/qiskit/transpiler/passes/routing/stochastic_swap.py" signature="StochasticSwap(*args, **kwargs)" modifiers="class">
