...
<Class id="qiskit.aqua.components.neural_networks.DiscriminativeNetwork" github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/aqua/components/neural_networks/discriminative_network.py" signature="DiscriminativeNetwork">
  ...
  <Function id="qiskit.aqua.components.neural_networks.DiscriminativeNetwork.__init__" name="__init__" signature="abstract __init__()">
  ...
  <Function id="qiskit.aqua.components.neural_networks.DiscriminativeNetwork.get_label" name="get_label" signature="abstract get_label(x)">
  ...
  <Function id="qiskit.aqua.components.neural_networks.DiscriminativeNetwork.loss" name="loss" signature="abstract loss(x, y, weights=None)">
  ...
  <Function id="qiskit.aqua.components.neural_networks.DiscriminativeNetwork.save_model" name="save_model" signature="abstract save_model(snapshot_dir)">
  ...
  <Function id="qiskit.aqua.components.neural_networks.DiscriminativeNetwork.set_seed" name="set_seed" signature="abstract set_seed(seed)">
    Set seed.
  ...
  <Function id="qiskit.aqua.components.neural_networks.DiscriminativeNetwork.train" name="train" signature="abstract train(data, weights, penalty=False, quantum_instance=None, shots=None)">
