...
<Class id="qiskit.transpiler.passes.EnlargeWithAncilla" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.17/qiskit/transpiler/passes/layout/enlarge_with_ancilla.py" signature="EnlargeWithAncilla(*args, **kwargs)" modifiers="class">
  ...
  <Function id="qiskit.transpiler.passes.EnlargeWithAncilla.__init__" signature="__init__()">
  ...
  <Function id="qiskit.transpiler.passes.EnlargeWithAncilla.is_analysis_pass" signature="is_analysis_pass" modifiers="property">
  ...
  <Function id="qiskit.transpiler.passes.EnlargeWithAncilla.is_transformation_pass" signature="is_transformation_pass" modifiers="property">
  ...
  <Function id="qiskit.transpiler.passes.EnlargeWithAncilla.name" signature="name()">
    Return the name of the pass.
  </Function>

  ### run

  <Function id="qiskit.transpiler.passes.EnlargeWithAncilla.run" signature="run(dag)">
