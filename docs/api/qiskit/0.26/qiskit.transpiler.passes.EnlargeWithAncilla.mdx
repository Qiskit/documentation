...
<Class id="qiskit.transpiler.passes.EnlargeWithAncilla" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.17/qiskit/transpiler/passes/layout/enlarge_with_ancilla.py" signature="EnlargeWithAncilla(*args, **kwargs)">
  ...
  <Function id="qiskit.transpiler.passes.EnlargeWithAncilla.__init__" name="__init__" signature="__init__()">
  ...
  <Function id="qiskit.transpiler.passes.EnlargeWithAncilla.is_analysis_pass" name="is_analysis_pass" signature="property is_analysis_pass">
  ...
  <Function id="qiskit.transpiler.passes.EnlargeWithAncilla.is_transformation_pass" name="is_transformation_pass" signature="property is_transformation_pass">
  ...
  <Function id="qiskit.transpiler.passes.EnlargeWithAncilla.name" name="name" signature="name()">
    Return the name of the pass.
  </Function>

  ### run

  <Function id="qiskit.transpiler.passes.EnlargeWithAncilla.run" name="run" signature="run(dag)">
