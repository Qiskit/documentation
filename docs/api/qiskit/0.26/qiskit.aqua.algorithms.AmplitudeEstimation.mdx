...
$$
  ...
  *   **i\_objective** (`Optional`\[`int`]) – Deprecated, use `objective_qubits`. The index of the objective qubit, i.e. the qubit marking ‘good’ solutions with the state $|1\rangle$ and ‘bad’ solutions with the state $0\rangle$.
  ...
  <Function id="qiskit.aqua.algorithms.AmplitudeEstimation.__init__" signature="__init__(num_eval_qubits, state_preparation=None, grover_operator=None, objective_qubits=None, post_processing=None, phase_estimation_circuit=None, iqft=None, quantum_instance=None, a_factory=None, q_factory=None, i_objective=None)">
    **Parameters**
  ...
  <Function id="qiskit.aqua.algorithms.AmplitudeEstimation.a_factory" signature="property a_factory">
  ...
  <Function id="qiskit.aqua.algorithms.AmplitudeEstimation.backend" signature="property backend">
    Returns backend.
  ...
  <Function id="qiskit.aqua.algorithms.AmplitudeEstimation.confidence_interval" signature="confidence_interval(alpha, kind='likelihood_ratio')">
  ...
  <Function id="qiskit.aqua.algorithms.AmplitudeEstimation.construct_circuit" signature="construct_circuit(measurement=False)">
  ...
  <Function id="qiskit.aqua.algorithms.AmplitudeEstimation.grover_operator" signature="property grover_operator">
  ...
  <Function id="qiskit.aqua.algorithms.AmplitudeEstimation.i_objective" signature="property i_objective">
  ...
  <Function id="qiskit.aqua.algorithms.AmplitudeEstimation.is_good_state" signature="is_good_state(measurement)">
  ...
  <Function id="qiskit.aqua.algorithms.AmplitudeEstimation.objective_qubits" signature="property objective_qubits">
  ...
  <Function id="qiskit.aqua.algorithms.AmplitudeEstimation.post_processing" signature="post_processing(value)">
  ...
  <Function id="qiskit.aqua.algorithms.AmplitudeEstimation.q_factory" signature="property q_factory">
...
$$
  ...
  <Function id="qiskit.aqua.algorithms.AmplitudeEstimation.quantum_instance" signature="property quantum_instance">
  ...
  <Function id="qiskit.aqua.algorithms.AmplitudeEstimation.random" signature="property random">
    Return a numpy random.
  </Function>

  ### run

  <Function id="qiskit.aqua.algorithms.AmplitudeEstimation.run" signature="run(quantum_instance=None, **kwargs)">
  ...
  <Function id="qiskit.aqua.algorithms.AmplitudeEstimation.set_backend" signature="set_backend(backend, **kwargs)">
  ...
  <Function id="qiskit.aqua.algorithms.AmplitudeEstimation.state_preparation" signature="property state_preparation">
