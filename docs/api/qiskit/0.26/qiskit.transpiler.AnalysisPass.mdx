...
<Class id="qiskit.transpiler.AnalysisPass" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.17/qiskit/transpiler/basepasses.py" signature="AnalysisPass(*args, **kwargs)" modifiers="class">
  ...
  <Function id="qiskit.transpiler.AnalysisPass.is_analysis_pass" signature="is_analysis_pass" modifiers="property">
  ...
  <Function id="qiskit.transpiler.AnalysisPass.is_transformation_pass" signature="is_transformation_pass" modifiers="property">
