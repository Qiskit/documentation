...
<Class id="qiskit.transpiler.AnalysisPass" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.17/qiskit/transpiler/basepasses.py" signature="AnalysisPass(*args, **kwargs)">
  ...
  <Function id="qiskit.transpiler.AnalysisPass.is_analysis_pass" signature="property is_analysis_pass">
  ...
  <Function id="qiskit.transpiler.AnalysisPass.is_transformation_pass" signature="property is_transformation_pass">
