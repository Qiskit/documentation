...
<Class id="qiskit.chemistry.algorithms.NumPyEigensolverFactory" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/chemistry/algorithms/excited_states_solvers/eigensolver_factories/numpy_eigensolver_factory.py" signature="NumPyEigensolverFactory(filter_criterion=None, k=100, use_default_filter_criterion=False)">
  ...
  *   **use\_default\_filter\_criterion** – whether to use the transformation’s default filter criterion if `filter_criterion` is `None`.
  ...
  <Function id="qiskit.chemistry.algorithms.NumPyEigensolverFactory.__init__" name="__init__" signature="__init__(filter_criterion=None, k=100, use_default_filter_criterion=False)">
    **Parameters**
  ...
  <Function id="qiskit.chemistry.algorithms.NumPyEigensolverFactory.filter_criterion" name="filter_criterion" signature="property filter_criterion">
  ...
  <Function id="qiskit.chemistry.algorithms.NumPyEigensolverFactory.get_solver" name="get_solver" signature="get_solver(transformation)">
  ...
  <Function id="qiskit.chemistry.algorithms.NumPyEigensolverFactory.k" name="k" signature="property k">
  ...
  <Function id="qiskit.chemistry.algorithms.NumPyEigensolverFactory.use_default_filter_criterion" name="use_default_filter_criterion" signature="property use_default_filter_criterion">
