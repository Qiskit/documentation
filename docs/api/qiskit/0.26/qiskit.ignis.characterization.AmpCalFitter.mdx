---
title: AmpCalFitter (v0.26)
description: API reference for qiskit.ignis.characterization.AmpCalFitter in qiskit v0.26
...
<Class id="qiskit.ignis.characterization.AmpCalFitter" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-ignis/tree/stable/0.6/qiskit/ignis/characterization/gates/fitters.py" signature="AmpCalFitter(backend_result, xdata, qubits, fit_p0, fit_bounds)" modifiers="class">
