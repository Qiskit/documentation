...
<Class id="qiskit.ignis.characterization.AmpCalFitter" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-ignis/tree/stable/0.6/qiskit/ignis/characterization/gates/fitters.py" signature="AmpCalFitter(backend_result, xdata, qubits, fit_p0, fit_bounds)">
  ...
  <Function id="qiskit.ignis.characterization.AmpCalFitter.__init__" name="__init__" signature="__init__(backend_result, xdata, qubits, fit_p0, fit_bounds)">
    See BaseFitter \_\_init\_\_
  </Function>
  ...
  <Function id="qiskit.ignis.characterization.AmpCalFitter.add_data" name="add_data" signature="add_data(results, recalc=True, refit=True)">
  ...
  <Function id="qiskit.ignis.characterization.AmpCalFitter.angle_err" name="angle_err" signature="angle_err(qind=- 1)">
  ...
  <Function id="qiskit.ignis.characterization.AmpCalFitter.backend_result" name="backend_result" signature="property backend_result">
  ...
  <Function id="qiskit.ignis.characterization.AmpCalFitter.description" name="description" signature="property description">
  ...
  <Function id="qiskit.ignis.characterization.AmpCalFitter.fit_data" name="fit_data" signature="fit_data(qid=- 1, p0=None, bounds=None, series=None)">
    Fit the curve.
  ...
  <Function id="qiskit.ignis.characterization.AmpCalFitter.fit_fun" name="fit_fun" signature="property fit_fun">
  ...
  <Function id="qiskit.ignis.characterization.AmpCalFitter.guess_params" name="guess_params" signature="guess_params(qind=0)">
  ...
  <Function id="qiskit.ignis.characterization.AmpCalFitter.measured_qubits" name="measured_qubits" signature="property measured_qubits">
  ...
  <Function id="qiskit.ignis.characterization.AmpCalFitter.params" name="params" signature="property params">
  ...
  <Function id="qiskit.ignis.characterization.AmpCalFitter.params_err" name="params_err" signature="property params_err">
  ...
  <Function id="qiskit.ignis.characterization.AmpCalFitter.plot" name="plot" signature="plot(qind, series='0', ax=None, show_plot=False)">
    Plot err data.
  ...
  <Function id="qiskit.ignis.characterization.AmpCalFitter.series" name="series" signature="property series">
  ...
  <Function id="qiskit.ignis.characterization.AmpCalFitter.xdata" name="xdata" signature="property xdata">
  ...
  <Function id="qiskit.ignis.characterization.AmpCalFitter.ydata" name="ydata" signature="property ydata">
