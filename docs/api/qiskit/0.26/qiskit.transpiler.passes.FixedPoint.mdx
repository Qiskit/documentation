...
<Class id="qiskit.transpiler.passes.FixedPoint" github="https://github.com/qiskit/qiskit/tree/stable/0.17/qiskit/transpiler/passes/utils/fixed_point.py" signature="FixedPoint(*args, **kwargs)">
  ...
  **property\_to\_check** (*str*) – The property to check if a fixed point was reached.
  ...
  <Function id="qiskit.transpiler.passes.FixedPoint.__init__" name="__init__" signature="__init__(property_to_check)">
    FixedPoint initializer.
  ...
  <Function id="qiskit.transpiler.passes.FixedPoint.is_analysis_pass" name="is_analysis_pass" signature="property is_analysis_pass">
  ...
  <Function id="qiskit.transpiler.passes.FixedPoint.is_transformation_pass" name="is_transformation_pass" signature="property is_transformation_pass">
