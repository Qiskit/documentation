...
<Class id="qiskit.aqua.operators.primitive_ops.PauliOp" github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/aqua/operators/primitive_ops/pauli_op.py" signature="PauliOp(primitive, coeff=1.0)">
