...
<Function id="qiskit.finance.applications.ising.portfolio_diversification.get_operator" name="get_operator" github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/finance/applications/ising/portfolio_diversification.py" signature="get_operator(rho, n, q)">
