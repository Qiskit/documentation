...
<Class id="qiskit.pulse.instructions.Delay" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.17/qiskit/pulse/instructions/delay.py" signature="Delay(duration, channel, name=None)">
  ...
  *   **name** (`Optional`\[`str`]) – Name of the delay for display purposes.
  ...
  <Function id="qiskit.pulse.instructions.Delay.__init__" name="__init__" signature="__init__(duration, channel, name=None)">
    Create a new delay instruction.
  ...
  <Function id="qiskit.pulse.instructions.Delay.append" name="append" signature="append(schedule, name=None)">
  ...
  <Function id="qiskit.pulse.instructions.Delay.assign_parameters" name="assign_parameters" signature="assign_parameters(value_dict)">
  ...
  <Function id="qiskit.pulse.instructions.Delay.ch_duration" name="ch_duration" signature="ch_duration(*channels)">
  ...
  <Function id="qiskit.pulse.instructions.Delay.ch_start_time" name="ch_start_time" signature="ch_start_time(*channels)">
  ...
  <Function id="qiskit.pulse.instructions.Delay.ch_stop_time" name="ch_stop_time" signature="ch_stop_time(*channels)">
  ...
  <Function id="qiskit.pulse.instructions.Delay.channel" name="channel" signature="property channel">
  ...
  <Function id="qiskit.pulse.instructions.Delay.channels" name="channels" signature="property channels">
  ...
  <Function id="qiskit.pulse.instructions.Delay.draw" name="draw" signature="draw(dt=1, style=None, filename=None, interp_method=None, scale=1, plot_all=False, plot_range=None, interactive=False, table=True, label=False, framechange=True, channels=None)">
  ...
  <Function id="qiskit.pulse.instructions.Delay.duration" name="duration" signature="property duration">
  ...
  <Function id="qiskit.pulse.instructions.Delay.flatten" name="flatten" signature="flatten()">
  ...
  <Function id="qiskit.pulse.instructions.Delay.id" name="id" signature="property id">
  ...
  <Function id="qiskit.pulse.instructions.Delay.insert" name="insert" signature="insert(start_time, schedule, name=None)">
  ...
  <Function id="qiskit.pulse.instructions.Delay.instructions" name="instructions" signature="property instructions">
  ...
  <Function id="qiskit.pulse.instructions.Delay.is_parameterized" name="is_parameterized" signature="is_parameterized()">
  ...
  <Function id="qiskit.pulse.instructions.Delay.name" name="name" signature="property name">
  ...
  <Function id="qiskit.pulse.instructions.Delay.operands" name="operands" signature="property operands">
  ...
  <Function id="qiskit.pulse.instructions.Delay.parameters" name="parameters" signature="property parameters">
  ...
  <Function id="qiskit.pulse.instructions.Delay.shift" name="shift" signature="shift(time, name=None)">
  ...
  <Function id="qiskit.pulse.instructions.Delay.start_time" name="start_time" signature="property start_time">
  ...
  <Function id="qiskit.pulse.instructions.Delay.stop_time" name="stop_time" signature="property stop_time">
