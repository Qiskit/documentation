...
<Class id="qiskit.algorithms.PhaseEstimationResult" github="https://github.com/qiskit/qiskit/tree/stable/0.17/qiskit/algorithms/phase_estimators/phase_estimation_result.py" signature="PhaseEstimationResult(num_evaluation_qubits, circuit_result, phases)">
  ...
  *   **phases** (`Union`\[`ndarray`, `Dict`\[`str`, `float`]]) – ndarray or dict of phases and frequencies determined by QPE.
  ...
  <Function id="qiskit.algorithms.PhaseEstimationResult.__init__" name="__init__" signature="__init__(num_evaluation_qubits, circuit_result, phases)">
    **Parameters**
  ...
  <Function id="qiskit.algorithms.PhaseEstimationResult.circuit_result" name="circuit_result" signature="property circuit_result">
  ...
  <Function id="qiskit.algorithms.PhaseEstimationResult.combine" name="combine" signature="combine(result)">
  ...
  <Function id="qiskit.algorithms.PhaseEstimationResult.filter_phases" name="filter_phases" signature="filter_phases(cutoff=0.0, as_float=True)">
  ...
  <Function id="qiskit.algorithms.PhaseEstimationResult.most_likely_phase" name="most_likely_phase" signature="property most_likely_phase">
  ...
  <Function id="qiskit.algorithms.PhaseEstimationResult.phases" name="phases" signature="property phases">
