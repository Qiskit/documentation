...
<Class id="qiskit.aqua.components.feature_maps.FeatureMap" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/aqua/components/feature_maps/feature_map.py" signature="FeatureMap" modifiers="class">
  ...
  <Function id="qiskit.aqua.components.feature_maps.FeatureMap.feature_dimension" signature="feature_dimension" modifiers="property">
  ...
  <Function id="qiskit.aqua.components.feature_maps.FeatureMap.num_qubits" signature="num_qubits" modifiers="property">
    returns number of qubits
  </Function>

  ### support\_parameterized\_circuit

  <Function id="qiskit.aqua.components.feature_maps.FeatureMap.support_parameterized_circuit" signature="support_parameterized_circuit" modifiers="property">
