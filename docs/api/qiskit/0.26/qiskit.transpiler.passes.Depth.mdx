...
<Class id="qiskit.transpiler.passes.Depth" github="https://github.com/qiskit/qiskit/tree/stable/0.17/qiskit/transpiler/passes/analysis/depth.py" signature="Depth(*args, **kwargs)">
