---
title: CircuitGradient (v0.26)
description: API reference for qiskit.opflow.gradients.CircuitGradient in qiskit v0.26
...
<Class id="qiskit.opflow.gradients.CircuitGradient" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.17/qiskit/opflow/gradients/circuit_gradients/circuit_gradient.py" signature="CircuitGradient" modifiers="class">
  ...
  <Function id="qiskit.opflow.gradients.CircuitGradient.__init__" signature="__init__()">
