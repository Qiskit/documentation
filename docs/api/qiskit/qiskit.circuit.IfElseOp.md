...
`qiskit.circuit.IfElseOp(condition, true_body, false_body=None, label=None)` [GitHub](https://github.com/qiskit/qiskit/tree/stable/1.0/qiskit/circuit/controlflow/if_else.py "view source code")
...
<span id="qiskit.circuit.IfElseOp.base_class" />
...
<span id="qiskit.circuit.IfElseOp.condition" />
...
<span id="qiskit.circuit.IfElseOp.mutable" />
...
<span id="qiskit.circuit.IfElseOp.to_mutable" />
