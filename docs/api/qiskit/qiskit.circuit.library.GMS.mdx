...
<Class id="qiskit.circuit.library.GMS" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/2.3/qiskit/circuit/library/generalized_gates/gms.py#L30-L101" signature="qiskit.circuit.library.GMS(num_qubits, theta)" modifiers="class">
