...
<Class id="qiskit.circuit.library.PhaseOracle" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.3/qiskit/circuit/library/phase_oracle.py#L28-L153" signature="qiskit.circuit.library.PhaseOracle(expression, synthesizer=None, var_order=None)" modifiers="class">
  Bases: [`QuantumCircuit`](circuit-quantum-circuit "qiskit.circuit.quantumcircuit.QuantumCircuit")
  ...
  *   **expression** (*Union\[*[*str*](https://docs.python.org/3/library/stdtypes.html#str "(in Python v3.13)")*, ClassicalElement]*) – A Python-like boolean expression.
  *   **synthesizer** (*Optional\[Callable\[\[*[*BooleanExpression*](circuit-classicalfunction-boolean-expression "qiskit.circuit.classicalfunction.BooleanExpression")*],* [*QuantumCircuit*](circuit-quantum-circuit "qiskit.circuit.QuantumCircuit")*]]*) – Optional. A function to convert a BooleanExpression into a QuantumCircuit If None is provided, Tweedledum’s pkrm\_synth with phase\_esop will be used.
  *   **var\_order** ([*list*](https://docs.python.org/3/library/stdtypes.html#list "(in Python v3.13)")) – A list with the order in which variables will be created. (default: by appearance)
  ...
  <Attribute id="qiskit.circuit.library.PhaseOracle.instances" attributeValue="262" />
  ...
  <Function id="qiskit.circuit.library.PhaseOracle.evaluate_bitstring" github="https://github.com/Qiskit/qiskit/tree/stable/1.3/qiskit/circuit/library/phase_oracle.py#L92-L103" signature="evaluate_bitstring(bitstring)">
  ...
  <Function id="qiskit.circuit.library.PhaseOracle.from_dimacs_file" github="https://github.com/Qiskit/qiskit/tree/stable/1.3/qiskit/circuit/library/phase_oracle.py#L105-L153" signature="from_dimacs_file(filename)" modifiers="classmethod">
