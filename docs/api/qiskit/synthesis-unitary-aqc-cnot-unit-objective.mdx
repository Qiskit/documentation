---
title: CNOTUnitObjective (latest version)
description: API reference for qiskit.synthesis.unitary.aqc.CNOTUnitObjective in the latest version of qiskit
...
<Class id="qiskit.synthesis.unitary.aqc.CNOTUnitObjective" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.3/qiskit/synthesis/unitary/aqc/cnot_unit_objective.py#L27-L58" signature="qiskit.synthesis.unitary.aqc.CNOTUnitObjective(num_qubits, cnots)" modifiers="class">
  Bases: [`ApproximatingObjective`](synthesis-unitary-aqc-approximating-objective "qiskit.synthesis.unitary.aqc.approximate.ApproximatingObjective"), [`ABC`](https://docs.python.org/3/library/abc.html#abc.ABC "(in Python v3.13)")
