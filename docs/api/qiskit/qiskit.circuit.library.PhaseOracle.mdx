...
<Class id="qiskit.circuit.library.PhaseOracle" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/circuit/library/phase_oracle.py#L26-L144" signature="qiskit.circuit.library.PhaseOracle(expression, var_order=None)" modifiers="class">
...
$$
  ...
  *   **var\_order** ([*list*](https://docs.python.org/3/library/stdtypes.html#list)*\[*[*str*](https://docs.python.org/3/library/stdtypes.html#str)*] | None*) – A list with the order in which variables will be created. (default: by appearance)
  ...
  <Attribute id="qiskit.circuit.library.PhaseOracle.name" name="name" headingLevel={3}>
  ...
  <Function id="qiskit.circuit.library.PhaseOracle.evaluate_bitstring" github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/circuit/library/phase_oracle.py#L83-L94" signature="evaluate_bitstring(bitstring)">
  ...
  <Function id="qiskit.circuit.library.PhaseOracle.from_dimacs_file" github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/circuit/library/phase_oracle.py#L96-L144" signature="from_dimacs_file(filename)" modifiers="classmethod">
