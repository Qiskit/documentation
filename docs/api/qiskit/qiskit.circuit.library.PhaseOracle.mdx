...
<Class id="qiskit.circuit.library.PhaseOracle" github="https://github.com/qiskit/qiskit/tree/stable/1.0/qiskit/circuit/library/phase_oracle.py" signature="qiskit.circuit.library.PhaseOracle(expression, synthesizer=None, var_order=None)">
