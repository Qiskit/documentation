...
<Class id="qiskit.qobj.GateCalibration" github="https://github.com/Qiskit/qiskit/tree/stable/1.0/qiskit/qobj/qasm_qobj.py#L487-L540" signature="qiskit.qobj.GateCalibration(name, qubits, params, instructions)">
