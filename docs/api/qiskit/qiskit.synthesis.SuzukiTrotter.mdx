...
<Class id="qiskit.synthesis.SuzukiTrotter" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/synthesis/evolution/suzuki_trotter.py#L33-L207" signature="qiskit.synthesis.SuzukiTrotter(order=2, reps=1, insert_barriers=False, cx_structure='chain', atomic_evolution=None, wrap=False, preserve_order=True, *, atomic_evolution_sparse_observable=False)" modifiers="class">
...
$$
  ...
  **Raises**
  ...
  [**ValueError**](https://docs.python.org/3/library/exceptions.html#ValueError) – If order is not even

  ## Attributes

  <Attribute id="qiskit.synthesis.SuzukiTrotter.settings" name="settings" headingLevel={3}>
  ...
  <Function id="qiskit.synthesis.SuzukiTrotter.expand" github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/synthesis/evolution/suzuki_trotter.py#L121-L173" signature="expand(evolution)">
  ...
  <Function id="qiskit.synthesis.SuzukiTrotter.synthesize" github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/synthesis/evolution/product_formula.py#L129-L151" signature="synthesize(evolution)">
