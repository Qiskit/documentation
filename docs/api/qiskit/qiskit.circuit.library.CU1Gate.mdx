...
$$
  ...
  <Attribute id="qiskit.circuit.library.CU1Gate.base_class" name="base_class">
  ...
  <Attribute id="qiskit.circuit.library.CU1Gate.condition" name="condition">
  ...
  <Attribute id="qiskit.circuit.library.CU1Gate.mutable" name="mutable">
