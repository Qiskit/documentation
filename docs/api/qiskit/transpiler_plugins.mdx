...
<Function id="qiskit.transpiler.preset_passmanagers.plugin.list_stage_plugins" name="list_stage_plugins" github="https://github.com/Qiskit/qiskit/tree/stable/1.0/qiskit/transpiler/preset_passmanagers/plugin.py#L275-L301" signature="qiskit.transpiler.preset_passmanagers.plugin.list_stage_plugins(stage_name)">
