...
<Function id="qiskit.visualization.plot_distribution" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.3/qiskit/visualization/counts_visualization.py#L166-L260" signature="qiskit.visualization.plot_distribution(data, figsize=(7, 5), color=None, number_to_keep=None, sort='asc', target_string=None, legend=None, bar_labels=True, title=None, ax=None, filename=None)">
  ...
  **Examples**
  ...
  ![Output from the previous code.](/images/api/qiskit/qiskit-visualization-plot_distribution-1_00.png)

  ![Output from the previous code.](/images/api/qiskit/qiskit-visualization-plot_distribution-1_01.png)

  ![Output from the previous code.](/images/api/qiskit/qiskit-visualization-plot_distribution-1_02.png)
</Function>
