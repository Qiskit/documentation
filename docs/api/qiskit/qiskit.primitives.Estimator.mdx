...
<Class id="qiskit.primitives.Estimator" github="https://github.com/Qiskit/qiskit/tree/stable/1.0/qiskit/primitives/estimator.py#L38-L158" signature="qiskit.primitives.Estimator(*, options=None)">
