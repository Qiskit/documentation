...
<Class id="qiskit.primitives.Estimator" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.0/qiskit/primitives/estimator.py#L38-L158" signature="qiskit.primitives.Estimator(*, options=None)">
  ...
  **Raises**
  ...
  <Function id="qiskit.primitives.Estimator.run" name="run" github="https://github.com/Qiskit/qiskit/tree/stable/1.0/qiskit/primitives/base/base_estimator.py#L123-L180" signature="run(circuits, observables, parameter_values=None, **run_options)">
  ...
  <Function id="qiskit.primitives.Estimator.set_options" name="set_options" github="https://github.com/Qiskit/qiskit/tree/stable/1.0/qiskit/primitives/base/base_primitive.py#L39-L45" signature="set_options(**fields)">
