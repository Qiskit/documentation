...
<Class id="qiskit.primitives.Estimator" github="https://github.com/qiskit/qiskit/tree/stable/1.0/qiskit/primitives/estimator.py" signature="qiskit.primitives.Estimator(*, options=None)">
