...
<Class id="qiskit.primitives.SamplerPubResult" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/2.4/qiskit/primitives/containers/sampler_pub_result.py#L27-L80" signature="qiskit.primitives.SamplerPubResult(data, metadata=None)" modifiers="class">
  ...
  *   **metadata** ([*dict*](https://docs.python.org/3/library/stdtypes.html#dict)*\[*[*str*](https://docs.python.org/3/library/stdtypes.html#str)*, Any] | None*) – Metadata specific to this pub. Keys are expected to be strings.
  ...
  <Function id="qiskit.primitives.SamplerPubResult.join_data" github="https://github.com/Qiskit/qiskit/tree/stable/2.4/qiskit/primitives/containers/sampler_pub_result.py#L36-L80" signature="join_data(names=None)">
