...
<Class id="qiskit.transpiler.passes.ApplyLayout" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.4/qiskit/transpiler/passes/layout/apply_layout.py#L22-L123" signature="qiskit.transpiler.passes.ApplyLayout(*args, **kwargs)" modifiers="class">
  ...
  <Function id="qiskit.transpiler.passes.ApplyLayout.execute" github="https://github.com/Qiskit/qiskit/tree/stable/1.4/qiskit/transpiler/basepasses.py#L189-L211" signature="execute(passmanager_ir, state, callback=None)">
  ...
  <Function id="qiskit.transpiler.passes.ApplyLayout.name" github="https://github.com/Qiskit/qiskit/tree/stable/1.4/qiskit/passmanager/base_tasks.py#L68-L70" signature="name()">
    Name of the pass.
  ...
  <Function id="qiskit.transpiler.passes.ApplyLayout.run" github="https://github.com/Qiskit/qiskit/tree/stable/1.4/qiskit/transpiler/passes/layout/apply_layout.py#L38-L123" signature="run(dag)">
  ...
  <Function id="qiskit.transpiler.passes.ApplyLayout.update_status" github="https://github.com/Qiskit/qiskit/tree/stable/1.4/qiskit/transpiler/basepasses.py#L213-L221" signature="update_status(state, run_state)">
