...
<Class id="qiskit.pulse.transforms.AlignFunc" github="https://github.com/qiskit/qiskit/tree/stable/1.0/qiskit/pulse/transforms/alignments.py" signature="qiskit.pulse.transforms.AlignFunc(duration, func)">
