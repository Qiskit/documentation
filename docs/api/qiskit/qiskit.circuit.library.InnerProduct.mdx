...
<Class id="qiskit.circuit.library.InnerProduct" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.3/qiskit/circuit/library/boolean_logic/inner_product.py#L21-L85" signature="qiskit.circuit.library.InnerProduct(num_qubits)" modifiers="class">
