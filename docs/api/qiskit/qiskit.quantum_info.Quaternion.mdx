...
<Class id="qiskit.quantum_info.Quaternion" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.0/qiskit/quantum_info/quaternion.py#L21-L156" signature="qiskit.quantum_info.Quaternion(data)">
  ...
  <Function id="qiskit.quantum_info.Quaternion.from_axis_rotation" github="https://github.com/Qiskit/qiskit/tree/stable/1.0/qiskit/quantum_info/quaternion.py#L111-L136" signature="classmethod from_axis_rotation(angle, axis)">
  ...
  <Function id="qiskit.quantum_info.Quaternion.from_euler" github="https://github.com/Qiskit/qiskit/tree/stable/1.0/qiskit/quantum_info/quaternion.py#L138-L156" signature="classmethod from_euler(angles, order='yzy')">
