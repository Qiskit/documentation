...
<Class id="qiskit.synthesis.EvolutionSynthesis" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.0/qiskit/synthesis/evolution/evolution_synthesis.py#L19-L46" signature="qiskit.synthesis.EvolutionSynthesis">
  ...
  <Function id="qiskit.synthesis.EvolutionSynthesis.synthesize" github="https://github.com/Qiskit/qiskit/tree/stable/1.0/qiskit/synthesis/evolution/evolution_synthesis.py#L22-L32" signature="abstract synthesize(evolution)">
