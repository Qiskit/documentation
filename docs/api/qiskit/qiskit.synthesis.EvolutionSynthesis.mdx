...
<Class id="qiskit.synthesis.EvolutionSynthesis" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/synthesis/evolution/evolution_synthesis.py#L21-L48" signature="qiskit.synthesis.EvolutionSynthesis" modifiers="class">
  ...
  <Attribute id="qiskit.synthesis.EvolutionSynthesis.settings" name="settings" headingLevel={3}>
  ...
  <Function id="qiskit.synthesis.EvolutionSynthesis.synthesize" github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/synthesis/evolution/evolution_synthesis.py#L24-L34" signature="synthesize(evolution)" modifiers="abstractmethod">
