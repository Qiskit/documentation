...
<Class id="qiskit.circuit.library.iqp" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.3/qiskit/circuit/library/iqp.py#L84-L143" signature="qiskit.circuit.library.iqp(interactions)" modifiers="class">
  Bases:
  ...
  **Reference Circuit:**
  ...
  ![../\_images/qiskit-circuit-library-iqp\_function-1.png](/images/api/qiskit/qiskit-circuit-library-iqp_function-1.png)

  **Expanded Circuit:**

  > ![../\_images/qiskit-circuit-library-iqp\_function-2.png](/images/api/qiskit/qiskit-circuit-library-iqp_function-2.png)
