...
<Class id="qiskit.primitives.BitArray" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/primitives/containers/bit_array.py#L57-L785" signature="qiskit.primitives.BitArray(array, num_bits)" modifiers="class">
  Bases: `ShapedMixin`
  ...
  *   [**ValueError**](https://docs.python.org/3/library/exceptions.html#ValueError) – If the input array has fewer than two axes, or the size of the last axis is not the smallest number of bytes that can contain `num_bits`.
  ...
  <Attribute id="qiskit.primitives.BitArray.array" name="array" headingLevel={3}>
    The raw NumPy array of data.
  </Attribute>

  <Attribute id="qiskit.primitives.BitArray.ndim" name="ndim" headingLevel={3} />

  <Attribute id="qiskit.primitives.BitArray.num_bits" name="num_bits" headingLevel={3}>
  ...
  <Attribute id="qiskit.primitives.BitArray.num_shots" name="num_shots" headingLevel={3}>
  ...
  <Attribute id="qiskit.primitives.BitArray.shape" name="shape" headingLevel={3} />

  <Attribute id="qiskit.primitives.BitArray.size" name="size" headingLevel={3} />

  ## Methods

  ### bitcount

  <Function id="qiskit.primitives.BitArray.bitcount" github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/primitives/containers/bit_array.py#L201-L211" signature="bitcount()">
  ...
  <Function id="qiskit.primitives.BitArray.concatenate" github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/primitives/containers/bit_array.py#L657-L706" signature="concatenate(bit_arrays, axis=0)" modifiers="static">
  ...
  <Function id="qiskit.primitives.BitArray.concatenate_bits" github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/primitives/containers/bit_array.py#L744-L785" signature="concatenate_bits(bit_arrays)" modifiers="static">
  ...
  <Function id="qiskit.primitives.BitArray.concatenate_shots" github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/primitives/containers/bit_array.py#L708-L742" signature="concatenate_shots(bit_arrays)" modifiers="static">
  ...
  <Function id="qiskit.primitives.BitArray.expectation_values" github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/primitives/containers/bit_array.py#L613-L655" signature="expectation_values(observables)">
  ...
  <Function id="qiskit.primitives.BitArray.from_bool_array" github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/primitives/containers/bit_array.py#L213-L247" signature="from_bool_array(array, order='big')" modifiers="static">
  ...
  <Function id="qiskit.primitives.BitArray.from_counts" github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/primitives/containers/bit_array.py#L249-L290" signature="from_counts(counts, num_bits=None)" modifiers="static">
  ...
  <Function id="qiskit.primitives.BitArray.from_samples" github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/primitives/containers/bit_array.py#L292-L336" signature="from_samples(samples, num_bits=None)" modifiers="static">
  ...
  <Function id="qiskit.primitives.BitArray.get_bitstrings" github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/primitives/containers/bit_array.py#L389-L402" signature="get_bitstrings(loc=None)">
  ...
  <Function id="qiskit.primitives.BitArray.get_counts" github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/primitives/containers/bit_array.py#L361-L373" signature="get_counts(loc=None)">
  ...
  <Function id="qiskit.primitives.BitArray.get_int_counts" github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/primitives/containers/bit_array.py#L375-L387" signature="get_int_counts(loc=None)">
  ...
  <Function id="qiskit.primitives.BitArray.postselect" github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/primitives/containers/bit_array.py#L522-L611" signature="postselect(indices, selection)">
  ...
  <Function id="qiskit.primitives.BitArray.reshape" github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/primitives/containers/bit_array.py#L404-L430" signature="reshape(*shape)">
  ...
  <Function id="qiskit.primitives.BitArray.slice_bits" github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/primitives/containers/bit_array.py#L462-L497" signature="slice_bits(indices)">
  ...
  <Function id="qiskit.primitives.BitArray.slice_shots" github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/primitives/containers/bit_array.py#L499-L520" signature="slice_shots(indices)">
  ...
  <Function id="qiskit.primitives.BitArray.to_bool_array" github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/primitives/containers/bit_array.py#L338-L359" signature="to_bool_array(order='big')">
  ...
  <Function id="qiskit.primitives.BitArray.transpose" github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/primitives/containers/bit_array.py#L432-L460" signature="transpose(*axes)">
