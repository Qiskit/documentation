...
<Class id="qiskit.primitives.BitArray" github="https://github.com/qiskit/qiskit/tree/stable/1.0/qiskit/primitives/containers/bit_array.py" signature="qiskit.primitives.BitArray(array, num_bits)">
  Bases: `ShapedMixin`
  ...
  *   [**ValueError**](https://docs.python.org/3/library/exceptions.html#ValueError "(in Python v3.12)") – If the input array has fewer than two axes, or the size of the last axis is not the smallest number of bytes that can contain `num_bits`.
  ...
  <Function id="qiskit.primitives.BitArray.bitcount" name="bitcount" signature="bitcount()">
  ...
  <Function id="qiskit.primitives.BitArray.from_bool_array" name="from_bool_array" signature="static from_bool_array(array, order='big')">
  ...
  <Function id="qiskit.primitives.BitArray.from_counts" name="from_counts" signature="static from_counts(counts, num_bits=None)">
  ...
  <Function id="qiskit.primitives.BitArray.from_samples" name="from_samples" signature="static from_samples(samples, num_bits=None)">
  ...
  <Function id="qiskit.primitives.BitArray.get_bitstrings" name="get_bitstrings" signature="get_bitstrings(loc=None)">
  ...
  <Function id="qiskit.primitives.BitArray.get_counts" name="get_counts" signature="get_counts(loc=None)">
  ...
  <Function id="qiskit.primitives.BitArray.get_int_counts" name="get_int_counts" signature="get_int_counts(loc=None)">
  ...
  <Function id="qiskit.primitives.BitArray.reshape" name="reshape" signature="reshape(*shape)">
