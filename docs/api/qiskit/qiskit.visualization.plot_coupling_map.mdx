---
title: plot_coupling_map (latest version)
description: API reference for qiskit.visualization.plot_coupling_map in the latest version of qiskit
...
<Function id="qiskit.visualization.plot_coupling_map" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/visualization/gate_map.py#L937-L1129" signature="qiskit.visualization.plot_coupling_map(num_qubits, qubit_coordinates, coupling_map, figsize=None, plot_directed=False, label_qubits=True, qubit_size=None, line_width=4, font_size=None, qubit_color=None, qubit_labels=None, line_color=None, font_color='white', ax=None, filename=None, *, planar=True)">
  ...
  *   [**MissingOptionalLibraryError**](/docs/api/qiskit/exceptions#qiskit.exceptions.MissingOptionalLibraryError "qiskit.exceptions.MissingOptionalLibraryError") – If matplotlib or graphviz is not installed.
  *   [**QiskitError**](/docs/api/qiskit/exceptions#qiskit.exceptions.QiskitError "qiskit.exceptions.QiskitError") – If the length of qubit labels does not match the number of qubits.
  ...
  **Example**
  ...
  ![Output from the previous code.](/docs/images/api/qiskit/qiskit-visualization-plot_coupling_map-1.avif)
</Function>
