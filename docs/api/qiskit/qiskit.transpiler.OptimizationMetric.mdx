---
title: OptimizationMetric (latest version)
description: API reference for qiskit.transpiler.OptimizationMetric in the latest version of qiskit
...
<Class id="qiskit.transpiler.OptimizationMetric" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/transpiler/optimization_metric.py#L21-L35" signature="qiskit.transpiler.OptimizationMetric(*values)" modifiers="class">
  ...
  <Attribute id="qiskit.transpiler.OptimizationMetric.COUNT_2Q" name="COUNT_2Q" headingLevel={3}>
    <AttributeTypeHint>= 1</AttributeTypeHint>

    The transpilation is optimized towards minimizing the 2q-count.
  </Attribute>

  <Attribute id="qiskit.transpiler.OptimizationMetric.COUNT_T" name="COUNT_T" headingLevel={3}>
