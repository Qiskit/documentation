...
<Class id="qiskit.transpiler.OptimizationMetric" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/2.3/qiskit/transpiler/optimization_metric.py#L21-L35" signature="qiskit.transpiler.OptimizationMetric(value)" modifiers="class">
