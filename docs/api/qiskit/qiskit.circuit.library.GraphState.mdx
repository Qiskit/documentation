...
<Class id="qiskit.circuit.library.GraphState" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/2.3/qiskit/circuit/library/graph_state.py#L23-L86" signature="qiskit.circuit.library.GraphState(adjacency_matrix)" modifiers="class">
