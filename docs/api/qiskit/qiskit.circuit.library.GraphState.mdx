...
<Class id="qiskit.circuit.library.GraphState" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/2.1/qiskit/circuit/library/graph_state.py#L23-L86" signature="qiskit.circuit.library.GraphState(adjacency_matrix)" modifiers="class">
...
$$
  ...
  **Reference Circuit:**
  ...
  ![Diagram illustrating the previously described circuit.](/docs/images/api/qiskit/qiskit-circuit-library-GraphState-1.avif)
  ...
  **Raises**
  ...
  <Attribute id="qiskit.circuit.library.GraphState.instances" attributeValue="244" />
