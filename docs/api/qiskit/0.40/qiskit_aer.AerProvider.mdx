...
<Class id="qiskit_aer.AerProvider" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-aer/tree/stable/0.11/qiskit_aer/aerprovider.py" signature="AerProvider">
  ...
  <Function id="qiskit_aer.AerProvider.backends" name="backends" signature="AerProvider.backends(name=None, filters=None, **kwargs)">
  ...
  <Function id="qiskit_aer.AerProvider.get_backend" name="get_backend" signature="AerProvider.get_backend(name=None, **kwargs)">
  ...
  <Attribute id="qiskit_aer.AerProvider.version" name="version" attributeValue="1" />
</Class>
