...
<Class id="qiskit.pulse.channels.DriveChannel" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/pulse/channels.py" signature="DriveChannel(index)">
