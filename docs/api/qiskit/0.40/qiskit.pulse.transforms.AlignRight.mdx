---
title: AlignRight (v0.40)
description: API reference for qiskit.pulse.transforms.AlignRight in qiskit v0.40
...
<Class id="qiskit.pulse.transforms.AlignRight" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/pulse/transforms/alignments.py" signature="AlignRight" modifiers="class">
