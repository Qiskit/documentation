---
title: QDrift (v0.40)
description: API reference for qiskit.opflow.evolutions.QDrift in qiskit v0.40
...
<Class id="qiskit.opflow.evolutions.QDrift" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/opflow/evolutions/trotterizations/qdrift.py" signature="QDrift(reps=1)" modifiers="class">
