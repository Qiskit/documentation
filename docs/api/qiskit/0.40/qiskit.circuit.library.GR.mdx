---
title: GR (v0.40)
description: API reference for qiskit.circuit.library.GR in qiskit v0.40
...
$$
  ...
  **Expanded Circuit:**
  ...
  ![../\_images/qiskit-circuit-library-GR-1.png](/docs/images/api/qiskit/0.40/qiskit-circuit-library-GR-1.avif)
  ...
  *   **phi** (`float`) – angle of rotation axis in xy-plane
  ...
  <Attribute id="qiskit.circuit.library.GR.instances" attributeValue="2322" />
