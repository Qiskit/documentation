---
title: Eigensolver (v0.40)
description: API reference for qiskit.algorithms.eigensolvers.Eigensolver in qiskit v0.40
...
<Class id="qiskit.algorithms.eigensolvers.Eigensolver" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/algorithms/eigensolvers/eigensolver.py" signature="Eigensolver" modifiers="class">
  Bases: `abc.ABC`
  ...
  <Function id="qiskit.algorithms.eigensolvers.Eigensolver.compute_eigenvalues" signature="Eigensolver.compute_eigenvalues(operator, aux_operators=None)" modifiers="abstract">
  ...
  <Function id="qiskit.algorithms.eigensolvers.Eigensolver.supports_aux_operators" signature="Eigensolver.supports_aux_operators()" modifiers="classmethod">
