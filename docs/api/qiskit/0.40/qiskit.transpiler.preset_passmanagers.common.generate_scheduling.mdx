...
<Function id="qiskit.transpiler.preset_passmanagers.common.generate_scheduling" github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/transpiler/preset_passmanagers/common.py" signature="generate_scheduling(instruction_durations, scheduling_method, timing_constraints, inst_map)">
