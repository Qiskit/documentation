...
<Class id="qiskit.primitives.SamplerResult" github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/primitives/base/sampler_result.py" signature="SamplerResult(quasi_dists, metadata)">
  ...
  *   **metadata** (*list\[dict]*) – List of the metadata.
  ...
  <Attribute id="qiskit.primitives.SamplerResult.quasi_dists" name="quasi_dists" attributeTypeHint="list[QuasiDistribution]" />
