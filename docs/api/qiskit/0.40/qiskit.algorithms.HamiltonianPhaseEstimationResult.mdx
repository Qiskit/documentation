...
<Class id="qiskit.algorithms.HamiltonianPhaseEstimationResult" github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/algorithms/phase_estimators/hamiltonian_phase_estimation_result.py" signature="HamiltonianPhaseEstimationResult(phase_estimation_result, phase_estimation_scale, id_coefficient)">
