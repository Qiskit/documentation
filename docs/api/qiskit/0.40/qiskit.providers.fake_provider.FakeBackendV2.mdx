...
<Class id="qiskit.providers.fake_provider.FakeBackendV2" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/providers/fake_provider/fake_backend_v2.py" signature="FakeBackendV2">
  ...
  **AttributeError** – If a field is specified that’s outside the backend’s options
  ...
  <Function id="qiskit.providers.fake_provider.FakeBackendV2.acquire_channel" name="acquire_channel" signature="FakeBackendV2.acquire_channel(qubit)">
  ...
  <Function id="qiskit.providers.fake_provider.FakeBackendV2.control_channel" name="control_channel" signature="FakeBackendV2.control_channel(qubits)">
  ...
  <Function id="qiskit.providers.fake_provider.FakeBackendV2.drive_channel" name="drive_channel" signature="FakeBackendV2.drive_channel(qubit)">
  ...
  <Function id="qiskit.providers.fake_provider.FakeBackendV2.measure_channel" name="measure_channel" signature="FakeBackendV2.measure_channel(qubit)">
  ...
  <Function id="qiskit.providers.fake_provider.FakeBackendV2.qubit_properties" name="qubit_properties" signature="FakeBackendV2.qubit_properties(qubit)">
  ...
  <Function id="qiskit.providers.fake_provider.FakeBackendV2.run" name="run" signature="FakeBackendV2.run(run_input, **options)">
    Run on the backend.
  ...
  <Function id="qiskit.providers.fake_provider.FakeBackendV2.set_options" name="set_options" signature="FakeBackendV2.set_options(**fields)">
  ...
  <Attribute id="qiskit.providers.fake_provider.FakeBackendV2.coupling_map" name="coupling_map">
    Return the [`CouplingMap`](qiskit.transpiler.CouplingMap "qiskit.transpiler.CouplingMap") object
  </Attribute>

  ### dt

  <Attribute id="qiskit.providers.fake_provider.FakeBackendV2.dt" name="dt">
  ...
  <Attribute id="qiskit.providers.fake_provider.FakeBackendV2.dtm" name="dtm">
  ...
  <Attribute id="qiskit.providers.fake_provider.FakeBackendV2.instruction_durations" name="instruction_durations">
  ...
  <Attribute id="qiskit.providers.fake_provider.FakeBackendV2.instruction_schedule_map" name="instruction_schedule_map">
  ...
  <Attribute id="qiskit.providers.fake_provider.FakeBackendV2.instructions" name="instructions">
  ...
  <Attribute id="qiskit.providers.fake_provider.FakeBackendV2.max_circuits" name="max_circuits" />

  ### meas\_map

  <Attribute id="qiskit.providers.fake_provider.FakeBackendV2.meas_map" name="meas_map">
  ...
  <Attribute id="qiskit.providers.fake_provider.FakeBackendV2.num_qubits" name="num_qubits">
  ...
  <Attribute id="qiskit.providers.fake_provider.FakeBackendV2.operation_names" name="operation_names">
  ...
  <Attribute id="qiskit.providers.fake_provider.FakeBackendV2.operations" name="operations">
  ...
  <Attribute id="qiskit.providers.fake_provider.FakeBackendV2.options" name="options">
  ...
  <Attribute id="qiskit.providers.fake_provider.FakeBackendV2.provider" name="provider">
  ...
  <Attribute id="qiskit.providers.fake_provider.FakeBackendV2.target" name="target" />

  ### version

  <Attribute id="qiskit.providers.fake_provider.FakeBackendV2.version" name="version" attributeValue="= 2" />
</Class>
