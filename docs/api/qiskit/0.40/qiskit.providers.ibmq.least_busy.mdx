...
<Function id="qiskit.providers.ibmq.least_busy" name="least_busy" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-ibmq-provider/tree/stable/0.19/qiskit/providers/ibmq/__init__.py" signature="least_busy(backends, reservation_lookahead=60)">
