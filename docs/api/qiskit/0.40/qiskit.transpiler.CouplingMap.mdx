---
title: CouplingMap (v0.40)
description: API reference for qiskit.transpiler.CouplingMap in qiskit v0.40
...
<Class id="qiskit.transpiler.CouplingMap" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/transpiler/coupling.py" signature="CouplingMap(couplinglist=None, description=None)" modifiers="class">
  Bases: `object`
