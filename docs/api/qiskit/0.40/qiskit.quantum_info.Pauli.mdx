...
<Class id="qiskit.quantum_info.Pauli" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/quantum_info/operators/symplectic/pauli.py" signature="Pauli(data=None, x=None, *, z=None, label=None)">
...
$$
  ...
  **QiskitError** – if input array is invalid shape.
  ...
  <Function id="qiskit.quantum_info.Pauli.evolve" name="evolve" signature="Pauli.evolve(other, qargs=None, frame='h')">
  ...
  <Attribute id="qiskit.quantum_info.Pauli.name" name="name">
    Unique string identifier for operation type.
  </Attribute>

  ### num\_clbits

  <Attribute id="qiskit.quantum_info.Pauli.num_clbits" name="num_clbits">
