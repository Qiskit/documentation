...
<Function id="qiskit.providers.ibmq.utils.seconds_to_duration" github="https://github.com/qiskit/qiskit-ibmq-provider/tree/stable/0.19/qiskit/providers/ibmq/utils/converters.py" signature="seconds_to_duration(seconds)">
