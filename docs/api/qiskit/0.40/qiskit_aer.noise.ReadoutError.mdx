...
<Class id="qiskit_aer.noise.ReadoutError" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-aer/tree/stable/0.11/qiskit_aer/noise/errors/readout_error.py" signature="ReadoutError(probabilities, atol=1e-08)">
  Bases: `object`
  ...
  **NoiseError** – if an invalid argument is provided
  ...
  <Function id="qiskit_aer.noise.ReadoutError.compose" name="compose" signature="ReadoutError.compose(other, front=False)">
  ...
  <Function id="qiskit_aer.noise.ReadoutError.copy" name="copy" signature="ReadoutError.copy()">
    Make a copy of current ReadoutError.
  </Function>

  ### dot

  <Function id="qiskit_aer.noise.ReadoutError.dot" name="dot" signature="ReadoutError.dot(other)">
  ...
  <Function id="qiskit_aer.noise.ReadoutError.expand" name="expand" signature="ReadoutError.expand(other)">
  ...
  <Function id="qiskit_aer.noise.ReadoutError.ideal" name="ideal" signature="ReadoutError.ideal()">
    Return True if current error object is an identity
  </Function>

  ### power

  <Function id="qiskit_aer.noise.ReadoutError.power" name="power" signature="ReadoutError.power(n)">
  ...
  <Function id="qiskit_aer.noise.ReadoutError.set_atol" name="set_atol" signature="classmethod ReadoutError.set_atol(value)">
    Set the class default absolute tolerance parameter for float comparisons.
  </Function>

  ### set\_rtol

  <Function id="qiskit_aer.noise.ReadoutError.set_rtol" name="set_rtol" signature="classmethod ReadoutError.set_rtol(value)">
    Set the class default relative tolerance parameter for float comparisons.
  </Function>

  ### tensor

  <Function id="qiskit_aer.noise.ReadoutError.tensor" name="tensor" signature="ReadoutError.tensor(other)">
    Return the tensor product readout error self ⊗ other.
  ...
  <Function id="qiskit_aer.noise.ReadoutError.to_dict" name="to_dict" signature="ReadoutError.to_dict()">
    Return the current error as a dictionary.
  </Function>

  ### to\_instruction

  <Function id="qiskit_aer.noise.ReadoutError.to_instruction" name="to_instruction" signature="ReadoutError.to_instruction()">
  ...
  <Attribute id="qiskit_aer.noise.ReadoutError.atol" name="atol">
    The default absolute tolerance parameter for float comparisons.
  </Attribute>

  ### number\_of\_qubits

  <Attribute id="qiskit_aer.noise.ReadoutError.number_of_qubits" name="number_of_qubits">
    Return the number of qubits for the error.
  </Attribute>

  ### probabilities

  <Attribute id="qiskit_aer.noise.ReadoutError.probabilities" name="probabilities">
    Return the readout error probabilities matrix.
  </Attribute>

  ### rtol

  <Attribute id="qiskit_aer.noise.ReadoutError.rtol" name="rtol">
