...
<Class id="qiskit.transpiler.synthesis.aqc.FastCNOTUnitObjective" github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/transpiler/synthesis/aqc/fast_gradient/fast_gradient.py" signature="FastCNOTUnitObjective(num_qubits, cnots)">
