---
title: synth_cnotdihedral_general (v0.40)
description: API reference for qiskit.synthesis.synth_cnotdihedral_general in qiskit v0.40
...
<Function id="qiskit.synthesis.synth_cnotdihedral_general" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/synthesis/cnotdihedral/cnotdihedral_decompose_general.py" signature="synth_cnotdihedral_general(elem)">
