...
<Function id="qiskit_aer.noise.device.gate_error_values" github="https://github.com/qiskit/qiskit-aer/tree/stable/0.11/qiskit_aer/noise/device/parameters.py" signature="gate_error_values(properties)">
