---
title: Trotter (v0.40)
description: API reference for qiskit.opflow.evolutions.Trotter in qiskit v0.40
...
<Class id="qiskit.opflow.evolutions.Trotter" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/opflow/evolutions/trotterizations/trotter.py" signature="Trotter(reps=1)" modifiers="class">
