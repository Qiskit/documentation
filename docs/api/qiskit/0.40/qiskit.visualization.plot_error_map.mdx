...
<Function id="qiskit.visualization.plot_error_map" name="plot_error_map" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/visualization/gate_map.py" signature="plot_error_map(backend, figsize=(12, 9), show_title=True, qubit_coordinates=None)">
  ...
  **Example**
  ...
  ([Source code](qiskit-visualization-plot_error_map-1.py), [png](qiskit-visualization-plot_error_map-1.png), [hires.png](qiskit-visualization-plot_error_map-1.hires.png), [pdf](qiskit-visualization-plot_error_map-1.pdf))

  ![../\_images/qiskit-visualization-plot\_error\_map-1.png](/images/api/qiskit/0.40/qiskit-visualization-plot_error_map-1.png)
</Function>
