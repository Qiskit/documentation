---
title: plot_histogram (v0.40)
description: API reference for qiskit.visualization.plot_histogram in qiskit v0.40
...
<Function id="qiskit.visualization.plot_histogram" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/visualization/counts_visualization.py" signature="plot_histogram(data, figsize=(7, 5), color=None, number_to_keep=None, sort='asc', target_string=None, legend=None, bar_labels=True, title=None, ax=None, filename=None)">
  ...
  **Examples**
  ...
  ![../\_images/qiskit-visualization-plot\_histogram-1\_00.png](/docs/images/api/qiskit/0.40/qiskit-visualization-plot_histogram-1_00.avif)

  ![../\_images/qiskit-visualization-plot\_histogram-1\_01.png](/docs/images/api/qiskit/0.40/qiskit-visualization-plot_histogram-1_01.avif)

  ![../\_images/qiskit-visualization-plot\_histogram-1\_02.png](/docs/images/api/qiskit/0.40/qiskit-visualization-plot_histogram-1_02.avif)
</Function>
