...
<Class id="qiskit.algorithms.Eigensolver" github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/algorithms/eigen_solvers/eigen_solver.py" signature="Eigensolver">
  Bases: `abc.ABC`
