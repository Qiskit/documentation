...
<Function id="qiskit_aer.library.save_statevector_dict" github="https://github.com/qiskit/qiskit-aer/tree/stable/0.11/qiskit_aer/library/save_instructions/save_statevector.py" signature="save_statevector_dict(self, label='statevector', pershot=False, conditional=False)">
