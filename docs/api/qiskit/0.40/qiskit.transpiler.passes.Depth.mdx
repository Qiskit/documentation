---
title: Depth (v0.40)
description: API reference for qiskit.transpiler.passes.Depth in qiskit v0.40
...
<Class id="qiskit.transpiler.passes.Depth" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/transpiler/passes/analysis/depth.py" signature="Depth(*args, **kwargs)" modifiers="class">
