...
<Class id="qiskit.algorithms.time_evolvers.trotterization.TrotterQRTE" github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/algorithms/time_evolvers/trotterization/trotter_qrte.py" signature="TrotterQRTE(product_formula=None, estimator=None)">
  ...
  *   **estimator** ([*BaseEstimator*](qiskit.primitives.BaseEstimator "qiskit.primitives.BaseEstimator") *| None*) – An estimator primitive used for calculating expectation values of `TimeEvolutionProblem.aux_operators`.
  ...
  <Function id="qiskit.algorithms.time_evolvers.trotterization.TrotterQRTE.evolve" name="evolve" signature="TrotterQRTE.evolve(evolution_problem)">
  ...
  <Function id="qiskit.algorithms.time_evolvers.trotterization.TrotterQRTE.supports_aux_operators" name="supports_aux_operators" signature="classmethod TrotterQRTE.supports_aux_operators()">
