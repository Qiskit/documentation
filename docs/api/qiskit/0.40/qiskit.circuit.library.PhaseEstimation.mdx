---
title: PhaseEstimation (v0.40)
description: API reference for qiskit.circuit.library.PhaseEstimation in qiskit v0.40
...
<Class id="qiskit.circuit.library.PhaseEstimation" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/circuit/library/phase_estimation.py" signature="PhaseEstimation(num_evaluation_qubits, unitary, iqft=None, name='QPE')" modifiers="class">
...
$$
  ...
  **Reference Circuit:**
  ...
  ![../\_images/qiskit-circuit-library-PhaseEstimation-1.png](/docs/images/api/qiskit/0.40/qiskit-circuit-library-PhaseEstimation-1.avif)
  ...
  <Attribute id="qiskit.circuit.library.PhaseEstimation.instances" attributeValue="2498" />
