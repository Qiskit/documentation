...
<Class id="qiskit.transpiler.passes.CSPLayout" github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/transpiler/passes/layout/csp_layout.py" signature="CSPLayout(*args, **kwargs)">
