...
<Class id="qiskit.algorithms.AmplitudeAmplifier" github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/algorithms/amplitude_amplifiers/amplitude_amplifier.py" signature="AmplitudeAmplifier">
  Bases: `abc.ABC`
