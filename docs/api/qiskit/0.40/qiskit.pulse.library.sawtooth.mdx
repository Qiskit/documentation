---
title: sawtooth (v0.40)
description: API reference for qiskit.pulse.library.sawtooth in qiskit v0.40
...
$$
  ...
  **Example**
  ...
  ![../\_images/qiskit-pulse-library-sawtooth-1.png](/docs/images/api/qiskit/0.40/qiskit-pulse-library-sawtooth-1.avif)
