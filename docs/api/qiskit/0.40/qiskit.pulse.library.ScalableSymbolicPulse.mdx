...
<Class id="qiskit.pulse.library.ScalableSymbolicPulse" github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/pulse/library/symbolic_pulses.py" signature="ScalableSymbolicPulse(pulse_type, duration, amp, angle, parameters=None, name=None, limit_amplitude=None, envelope=None, constraints=None, valid_amp_conditions=None)">
  ...
  **Raises**
  ...
  <Function id="qiskit.pulse.library.ScalableSymbolicPulse.draw" name="draw" signature="ScalableSymbolicPulse.draw(style=None, backend=None, time_range=None, time_unit='dt', show_waveform_info=True, plotter='mpl2d', axis=None)">
  ...
  <Function id="qiskit.pulse.library.ScalableSymbolicPulse.get_waveform" name="get_waveform" signature="ScalableSymbolicPulse.get_waveform()">
...
$$
  ...
  <Function id="qiskit.pulse.library.ScalableSymbolicPulse.is_parameterized" name="is_parameterized" signature="ScalableSymbolicPulse.is_parameterized()">
  ...
  <Function id="qiskit.pulse.library.ScalableSymbolicPulse.validate_parameters" name="validate_parameters" signature="ScalableSymbolicPulse.validate_parameters()">
    Validate parameters.
  ...
  <Attribute id="qiskit.pulse.library.ScalableSymbolicPulse.constraints" name="constraints">
  ...
  <Attribute id="qiskit.pulse.library.ScalableSymbolicPulse.duration" name="duration" />

  ### envelope

  <Attribute id="qiskit.pulse.library.ScalableSymbolicPulse.envelope" name="envelope">
  ...
  <Attribute id="qiskit.pulse.library.ScalableSymbolicPulse.id" name="id">
  ...
  <Attribute id="qiskit.pulse.library.ScalableSymbolicPulse.limit_amplitude" name="limit_amplitude" attributeValue="= True" />

  ### name

  <Attribute id="qiskit.pulse.library.ScalableSymbolicPulse.name" name="name" />

  ### parameters

  <Attribute id="qiskit.pulse.library.ScalableSymbolicPulse.parameters" name="parameters">
    **Return type**
  ...
  <Attribute id="qiskit.pulse.library.ScalableSymbolicPulse.pulse_type" name="pulse_type">
  ...
  <Attribute id="qiskit.pulse.library.ScalableSymbolicPulse.valid_amp_conditions" name="valid_amp_conditions">
