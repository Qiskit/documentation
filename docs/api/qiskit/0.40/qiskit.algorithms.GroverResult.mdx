...
<Class id="qiskit.algorithms.GroverResult" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/algorithms/amplitude_amplifiers/grover.py" signature="GroverResult">
  ...
  <Function id="qiskit.algorithms.GroverResult.combine" name="combine" signature="GroverResult.combine(result)">
