---
title: plot_state_hinton (v0.40)
description: API reference for qiskit.visualization.plot_state_hinton in qiskit v0.40
...
<Function id="qiskit.visualization.plot_state_hinton" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/visualization/state_visualization.py" signature="plot_state_hinton(state, title='', figsize=None, ax_real=None, ax_imag=None, *, rho=None, filename=None)">
  ...
  **Examples**
  ...
  ![../\_images/qiskit-visualization-plot\_state\_hinton-1.png](/docs/images/api/qiskit/0.40/qiskit-visualization-plot_state_hinton-1.avif)
</Function>
