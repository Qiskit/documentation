---
title: HiddenLinearFunction (v0.40)
description: API reference for qiskit.circuit.library.HiddenLinearFunction in qiskit v0.40
...
<Class id="qiskit.circuit.library.HiddenLinearFunction" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/circuit/library/hidden_linear_function.py" signature="HiddenLinearFunction(adjacency_matrix)" modifiers="class">
...
$$
  ...
  **Reference Circuit:**
  ...
  > ![../\_images/qiskit-circuit-library-HiddenLinearFunction-1.png](/docs/images/api/qiskit/0.40/qiskit-circuit-library-HiddenLinearFunction-1.avif)
  ...
  **CircuitError** – If A is not symmetric.
  ...
  <Attribute id="qiskit.circuit.library.HiddenLinearFunction.instances" attributeValue="2342" />
