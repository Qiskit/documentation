---
title: GRZ (v0.40)
description: API reference for qiskit.circuit.library.GRZ in qiskit v0.40
...
$$
  ...
  **Expanded Circuit:**
  ...
  ![../\_images/qiskit-circuit-library-GRZ-1.png](/docs/images/api/qiskit/0.40/qiskit-circuit-library-GRZ-1.avif)
