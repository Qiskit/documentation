---
title: InnerProduct (v0.40)
description: API reference for qiskit.circuit.library.InnerProduct in qiskit v0.40
...
$$
  ...
  **Reference Circuit:**
  ...
  ![../\_images/qiskit-circuit-library-InnerProduct-1.png](/docs/images/api/qiskit/0.40/qiskit-circuit-library-InnerProduct-1.avif)
  ...
  **num\_qubits** (`int`) – width of top and bottom registers (half total circuit width)
  ...
  <Attribute id="qiskit.circuit.library.InnerProduct.instances" attributeValue="2366" />
