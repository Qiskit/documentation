---
title: MCXGrayCode (v0.40)
description: API reference for qiskit.circuit.library.MCXGrayCode in qiskit v0.40
...
<Class id="qiskit.circuit.library.MCXGrayCode" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/circuit/library/standard_gates/x.py" signature="MCXGrayCode(num_ctrl_qubits, label=None, ctrl_state=None)" modifiers="class">
