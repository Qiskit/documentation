...
([Source code](qiskit-circuit-library-XOR-1.py), [png](qiskit-circuit-library-XOR-1.png), [hires.png](qiskit-circuit-library-XOR-1.hires.png), [pdf](qiskit-circuit-library-XOR-1.pdf))

![../\_images/qiskit-circuit-library-XOR-1.png](/images/api/qiskit/0.40/qiskit-circuit-library-XOR-1.png)
