---
title: synth_clifford_bm (v0.40)
description: API reference for qiskit.synthesis.synth_clifford_bm in qiskit v0.40
...
<Function id="qiskit.synthesis.synth_clifford_bm" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/synthesis/clifford/clifford_decompose_bm.py" signature="synth_clifford_bm(clifford)">
