...
<Class id="qiskit.transpiler.passes.HighLevelSynthesis" github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/transpiler/passes/synthesis/high_level_synthesis.py" signature="HighLevelSynthesis(*args, **kwargs)">
