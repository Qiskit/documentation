---
title: transpile_noise_model (v0.40)
description: API reference for qiskit_aer.utils.transpile_noise_model in qiskit v0.40
in_page_toc_min_heading_level: 1
python_api_type: function
python_api_name: qiskit_aer.utils.transpile_noise_model
---

<span id="qiskit-aer-utils-transpile-noise-model" />

# qiskit\_aer.utils.transpile\_noise\_model

<Function id="qiskit_aer.utils.transpile_noise_model" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-aer/tree/stable/0.11/qiskit_aer/utils/noise_transformation.py" signature="transpile_noise_model(noise_model, **transpile_kwargs)">
