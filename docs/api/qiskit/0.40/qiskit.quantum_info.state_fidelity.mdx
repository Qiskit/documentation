...
<Function id="qiskit.quantum_info.state_fidelity" github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/quantum_info/states/measures.py" signature="state_fidelity(state1, state2, validate=True)">
