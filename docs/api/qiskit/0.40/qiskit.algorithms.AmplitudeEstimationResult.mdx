---
title: AmplitudeEstimationResult (v0.40)
description: API reference for qiskit.algorithms.AmplitudeEstimationResult in qiskit v0.40
...
<Class id="qiskit.algorithms.AmplitudeEstimationResult" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/algorithms/amplitude_estimators/ae.py" signature="AmplitudeEstimationResult" modifiers="class">
