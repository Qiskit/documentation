...
<Class id="qiskit.providers.models.UchannelLO" github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/providers/models/backendconfiguration.py" signature="UchannelLO(q, scale)">
  Bases: `object`
