...
<Class id="qiskit.transpiler.passes.BasicSynthesisPermutation" github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/transpiler/passes/synthesis/high_level_synthesis.py" signature="BasicSynthesisPermutation">
