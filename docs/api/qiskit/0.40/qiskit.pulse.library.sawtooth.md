...
([Source code](qiskit-pulse-library-sawtooth-1.py), [png](qiskit-pulse-library-sawtooth-1.png), [hires.png](qiskit-pulse-library-sawtooth-1.hires.png), [pdf](qiskit-pulse-library-sawtooth-1.pdf))

![../\_images/qiskit-pulse-library-sawtooth-1.png](/images/api/qiskit/0.40/qiskit-pulse-library-sawtooth-1.png)
