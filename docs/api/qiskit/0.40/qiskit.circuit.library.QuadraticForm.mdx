---
title: QuadraticForm (v0.40)
description: API reference for qiskit.circuit.library.QuadraticForm in qiskit v0.40
...
$$
  ...
  *   **ValueError** – If `num_result_qubits` is unspecified but cannot be determined because some values of the quadratic form are parameterized.
  ...
  <Attribute id="qiskit.circuit.library.QuadraticForm.instances" attributeValue="2603" />
