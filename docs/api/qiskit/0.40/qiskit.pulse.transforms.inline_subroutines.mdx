...
<Function id="qiskit.pulse.transforms.inline_subroutines" name="inline_subroutines" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/pulse/transforms/canonicalization.py" signature="inline_subroutines(program)">
