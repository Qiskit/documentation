---
title: EvolutionResult (v0.40)
description: API reference for qiskit.algorithms.EvolutionResult in qiskit v0.40
...
<Class id="qiskit.algorithms.EvolutionResult" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/algorithms/evolvers/evolution_result.py" signature="EvolutionResult(evolved_state, aux_ops_evaluated=None)" modifiers="class">
