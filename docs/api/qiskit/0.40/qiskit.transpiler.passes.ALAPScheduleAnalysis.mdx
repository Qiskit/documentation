...
<Class id="qiskit.transpiler.passes.ALAPScheduleAnalysis" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/transpiler/passes/scheduling/scheduling/alap.py" signature="ALAPScheduleAnalysis(durations)">
  ...
  **durations** ([`InstructionDurations`](qiskit.transpiler.InstructionDurations "qiskit.transpiler.instruction_durations.InstructionDurations")) – Durations of instructions to be used in scheduling
  ...
  <Function id="qiskit.transpiler.passes.ALAPScheduleAnalysis.name" name="name" signature="ALAPScheduleAnalysis.name()">
    Return the name of the pass.
  </Function>

  ### run

  <Function id="qiskit.transpiler.passes.ALAPScheduleAnalysis.run" name="run" signature="ALAPScheduleAnalysis.run(dag)">
