---
title: FakeLima (v0.40)
description: API reference for qiskit.providers.fake_provider.FakeLima in qiskit v0.40
...
<Class id="qiskit.providers.fake_provider.FakeLima" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/providers/fake_provider/backends/lima/fake_lima.py" signature="FakeLima" modifiers="class">
  ...
  *   **time\_alive** (*int*) – time to wait before returning result
  ...
  <Attribute id="qiskit.providers.fake_provider.FakeLima.dirname" attributeValue="'/home/runner/work/qiskit/qiskit/.tox/docs/lib/python3.8/site-packages/qiskit/providers/fake_provider/backends/lima'" />
