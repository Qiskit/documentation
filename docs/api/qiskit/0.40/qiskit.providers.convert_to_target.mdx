...
<Function id="qiskit.providers.convert_to_target" github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/providers/backend_compat.py" signature="convert_to_target(configuration, properties=None, defaults=None, custom_name_mapping=None, add_delay=False)">
