---
title: ISRES (v0.40)
description: API reference for qiskit.algorithms.optimizers.ISRES in qiskit v0.40
...
<Class id="qiskit.algorithms.optimizers.ISRES" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/algorithms/optimizers/nlopts/isres.py" signature="ISRES(max_evals=1000)" modifiers="class">
