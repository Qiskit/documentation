---
title: ConditionalController (v0.40)
description: API reference for qiskit.transpiler.ConditionalController in qiskit v0.40
...
<Class id="qiskit.transpiler.ConditionalController" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/transpiler/runningpassmanager.py" signature="ConditionalController(passes, options=None, condition=None, **partial_controller)" modifiers="class">
