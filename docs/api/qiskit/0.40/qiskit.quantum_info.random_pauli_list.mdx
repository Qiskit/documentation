---
title: random_pauli_list (v0.40)
description: API reference for qiskit.quantum_info.random_pauli_list in qiskit v0.40
...
<Function id="qiskit.quantum_info.random_pauli_list" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/quantum_info/operators/symplectic/random.py" signature="random_pauli_list(num_qubits, size=1, seed=None, phase=True)">
