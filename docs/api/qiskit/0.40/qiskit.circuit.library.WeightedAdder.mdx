---
title: WeightedAdder (v0.40)
description: API reference for qiskit.circuit.library.WeightedAdder in qiskit v0.40
...
$$
  ...
  *   **name** (`str`) – The name of the circuit.
  ...
  <Attribute id="qiskit.circuit.library.WeightedAdder.instances" attributeValue="2737" />
