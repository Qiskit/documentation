...
<Class id="qiskit.circuit.Operation" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/circuit/operation.py" signature="Operation">
  Bases: `abc.ABC`
  ...
  **Example**
  ...
  <Attribute id="qiskit.circuit.Operation.name" name="name">
    Unique string identifier for operation type.
  </Attribute>

  ### num\_clbits

  <Attribute id="qiskit.circuit.Operation.num_clbits" name="num_clbits">
    Number of classical bits.
  </Attribute>

  ### num\_qubits

  <Attribute id="qiskit.circuit.Operation.num_qubits" name="num_qubits">
    Number of qubits.
  </Attribute>
</Class>
