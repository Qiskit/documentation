...
<Function id="qiskit.utils.is_main_process" name="is_main_process" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/utils/multiprocessing.py" signature="is_main_process()">
