...
<Class id="qiskit.algorithms.gradients.ReverseEstimatorGradient" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/algorithms/gradients/reverse_gradient/reverse_gradient.py" signature="ReverseEstimatorGradient(derivative_type=DerivativeType.REAL)">
  ...
  **derivative\_type** ([`DerivativeType`](qiskit.algorithms.gradients.DerivativeType "qiskit.algorithms.gradients.utils.DerivativeType")) – Defines whether the real, imaginary or real plus imaginary part of the gradient is returned.
  ...
  <Function id="qiskit.algorithms.gradients.ReverseEstimatorGradient.run" name="run" signature="ReverseEstimatorGradient.run(circuits, observables, parameter_values, parameters=None, **options)">
  ...
  <Function id="qiskit.algorithms.gradients.ReverseEstimatorGradient.update_default_options" name="update_default_options" signature="ReverseEstimatorGradient.update_default_options(**options)">
  ...
  <Attribute id="qiskit.algorithms.gradients.ReverseEstimatorGradient.SUPPORTED_GATES" name="SUPPORTED_GATES" attributeValue="= ['rx', 'ry', 'rz', 'cp', 'crx', 'cry', 'crz']" />

  ### derivative\_type

  <Attribute id="qiskit.algorithms.gradients.ReverseEstimatorGradient.derivative_type" name="derivative_type">
  ...
  <Attribute id="qiskit.algorithms.gradients.ReverseEstimatorGradient.options" name="options">
