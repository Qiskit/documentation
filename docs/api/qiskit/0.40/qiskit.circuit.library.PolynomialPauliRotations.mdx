---
title: PolynomialPauliRotations (v0.40)
description: API reference for qiskit.circuit.library.PolynomialPauliRotations in qiskit v0.40
...
$$
  ...
  *   **name** (`str`) – The name of the circuit.
  ...
  <Attribute id="qiskit.circuit.library.PolynomialPauliRotations.instances" attributeValue="2505" />
