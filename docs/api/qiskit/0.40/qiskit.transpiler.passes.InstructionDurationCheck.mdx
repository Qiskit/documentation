...
<Class id="qiskit.transpiler.passes.InstructionDurationCheck" github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/transpiler/passes/scheduling/alignments/check_durations.py" signature="InstructionDurationCheck(acquire_alignment=1, pulse_alignment=1)">
