---
title: InstructionDurationCheck (v0.40)
description: API reference for qiskit.transpiler.passes.InstructionDurationCheck in qiskit v0.40
...
<Class id="qiskit.transpiler.passes.InstructionDurationCheck" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/transpiler/passes/scheduling/alignments/check_durations.py" signature="InstructionDurationCheck(acquire_alignment=1, pulse_alignment=1)" modifiers="class">
