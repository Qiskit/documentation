---
title: UnitarySimulator (v0.40)
description: API reference for qiskit_aer.UnitarySimulator in qiskit v0.40
...
<Class id="qiskit_aer.UnitarySimulator" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-aer/tree/stable/0.11/qiskit_aer/backends/unitary_simulator.py" signature="UnitarySimulator(configuration=None, properties=None, provider=None, **backend_options)" modifiers="class">
