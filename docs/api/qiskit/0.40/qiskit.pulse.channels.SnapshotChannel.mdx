...
<Class id="qiskit.pulse.channels.SnapshotChannel" github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/pulse/channels.py" signature="SnapshotChannel(*args, **kwargs)">
