---
title: FasterAmplitudeEstimation (v0.40)
description: API reference for qiskit.algorithms.FasterAmplitudeEstimation in qiskit v0.40
...
<Class id="qiskit.algorithms.FasterAmplitudeEstimation" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/algorithms/amplitude_estimators/fae.py" signature="FasterAmplitudeEstimation(delta, maxiter, rescale=True, quantum_instance=None, sampler=None)" modifiers="class">
  ...
  *   **sampler** ([*BaseSampler*](qiskit.primitives.BaseSampler "qiskit.primitives.BaseSampler") *| None*) – A sampler primitive to evaluate the circuits.
  ...
  <span id="qiskit-algorithms-fasteramplitudeestimation-construct-circuit" />
