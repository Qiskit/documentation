...
<Class id="qiskit.utils.mitigation.TensoredMeasFitter" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/utils/mitigation/fitters.py" signature="TensoredMeasFitter(results, mit_pattern, substate_labels_list=None, circlabel='')">
  Bases: `object`
  ...
  **ValueError** – if the mit\_pattern doesn’t match the substate\_labels\_list
  ...
  <Function id="qiskit.utils.mitigation.TensoredMeasFitter.add_data" name="add_data" signature="TensoredMeasFitter.add_data(new_results, rebuild_cal_matrix=True)">
  ...
  <Function id="qiskit.utils.mitigation.TensoredMeasFitter.readout_fidelity" name="readout_fidelity" signature="TensoredMeasFitter.readout_fidelity(cal_index=0, label_list=None)">
  ...
  <Function id="qiskit.utils.mitigation.TensoredMeasFitter.subset_fitter" name="subset_fitter" signature="TensoredMeasFitter.subset_fitter(qubit_sublist)">
  ...
  <Attribute id="qiskit.utils.mitigation.TensoredMeasFitter.cal_matrices" name="cal_matrices">
    Return cal\_matrices.
  </Attribute>

  ### filter

  <Attribute id="qiskit.utils.mitigation.TensoredMeasFitter.filter" name="filter">
    Return a measurement filter using the cal matrices.
  </Attribute>

  ### nqubits

  <Attribute id="qiskit.utils.mitigation.TensoredMeasFitter.nqubits" name="nqubits">
    Return \_qubit\_list\_sizes.
  </Attribute>

  ### substate\_labels\_list

  <Attribute id="qiskit.utils.mitigation.TensoredMeasFitter.substate_labels_list" name="substate_labels_list">
