---
title: QasmTerminalStyle (v0.40)
description: API reference for qiskit.qasm.QasmTerminalStyle in qiskit v0.40
...
<Class id="qiskit.qasm.QasmTerminalStyle" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/qasm/pygments/lexer.py" signature="QasmTerminalStyle" modifiers="class">
