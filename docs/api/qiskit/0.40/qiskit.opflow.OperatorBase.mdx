...
<Class id="qiskit.opflow.OperatorBase" github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/opflow/operator_base.py" signature="OperatorBase">
  ...
  <Function id="qiskit.opflow.OperatorBase.add" signature="abstract OperatorBase.add(other)">
  ...
  <Function id="qiskit.opflow.OperatorBase.adjoint" signature="abstract OperatorBase.adjoint()">
  ...
  <Function id="qiskit.opflow.OperatorBase.assign_parameters" signature="abstract OperatorBase.assign_parameters(param_dict)">
  ...
  <Function id="qiskit.opflow.OperatorBase.compose" signature="abstract OperatorBase.compose(other, permutation=None, front=False)">
  ...
  <Function id="qiskit.opflow.OperatorBase.equals" signature="abstract OperatorBase.equals(other)">
  ...
  <Function id="qiskit.opflow.OperatorBase.eval" signature="abstract OperatorBase.eval(front=None)">
  ...
  <Function id="qiskit.opflow.OperatorBase.mul" signature="abstract OperatorBase.mul(scalar)">
  ...
  <Function id="qiskit.opflow.OperatorBase.permute" signature="abstract OperatorBase.permute(permutation)">
  ...
  <Function id="qiskit.opflow.OperatorBase.primitive_strings" signature="abstract OperatorBase.primitive_strings()">
  ...
  <Function id="qiskit.opflow.OperatorBase.reduce" signature="abstract OperatorBase.reduce()">
  ...
  <Function id="qiskit.opflow.OperatorBase.tensor" signature="abstract OperatorBase.tensor(other)">
  ...
  <Function id="qiskit.opflow.OperatorBase.tensorpower" signature="abstract OperatorBase.tensorpower(other)">
  ...
  <Function id="qiskit.opflow.OperatorBase.to_circuit_op" signature="abstract OperatorBase.to_circuit_op()">
  ...
  <Function id="qiskit.opflow.OperatorBase.to_matrix" signature="abstract OperatorBase.to_matrix(massive=False)">
  ...
  <Function id="qiskit.opflow.OperatorBase.to_matrix_op" signature="abstract OperatorBase.to_matrix_op(massive=False)">
