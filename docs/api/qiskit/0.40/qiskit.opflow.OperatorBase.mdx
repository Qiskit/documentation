...
<Class id="qiskit.opflow.OperatorBase" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/opflow/operator_base.py" signature="OperatorBase">
  ...
  <Function id="qiskit.opflow.OperatorBase.add" name="add" signature="abstract OperatorBase.add(other)">
  ...
  <Function id="qiskit.opflow.OperatorBase.adjoint" name="adjoint" signature="abstract OperatorBase.adjoint()">
  ...
  <Function id="qiskit.opflow.OperatorBase.assign_parameters" name="assign_parameters" signature="abstract OperatorBase.assign_parameters(param_dict)">
  ...
  <Function id="qiskit.opflow.OperatorBase.bind_parameters" name="bind_parameters" signature="OperatorBase.bind_parameters(param_dict)">
  ...
  <Function id="qiskit.opflow.OperatorBase.compose" name="compose" signature="abstract OperatorBase.compose(other, permutation=None, front=False)">
  ...
  <Function id="qiskit.opflow.OperatorBase.copy" name="copy" signature="OperatorBase.copy()">
  ...
  <Function id="qiskit.opflow.OperatorBase.equals" name="equals" signature="abstract OperatorBase.equals(other)">
  ...
  <Function id="qiskit.opflow.OperatorBase.eval" name="eval" signature="abstract OperatorBase.eval(front=None)">
  ...
  <Function id="qiskit.opflow.OperatorBase.is_hermitian" name="is_hermitian" signature="OperatorBase.is_hermitian()">
  ...
  <Function id="qiskit.opflow.OperatorBase.mul" name="mul" signature="abstract OperatorBase.mul(scalar)">
  ...
  <Function id="qiskit.opflow.OperatorBase.neg" name="neg" signature="OperatorBase.neg()">
  ...
  <Function id="qiskit.opflow.OperatorBase.permute" name="permute" signature="abstract OperatorBase.permute(permutation)">
  ...
  <Function id="qiskit.opflow.OperatorBase.primitive_strings" name="primitive_strings" signature="abstract OperatorBase.primitive_strings()">
  ...
  <Function id="qiskit.opflow.OperatorBase.reduce" name="reduce" signature="abstract OperatorBase.reduce()">
  ...
  <Function id="qiskit.opflow.OperatorBase.tensor" name="tensor" signature="abstract OperatorBase.tensor(other)">
  ...
  <Function id="qiskit.opflow.OperatorBase.tensorpower" name="tensorpower" signature="abstract OperatorBase.tensorpower(other)">
  ...
  <Function id="qiskit.opflow.OperatorBase.to_circuit_op" name="to_circuit_op" signature="abstract OperatorBase.to_circuit_op()">
  ...
  <Function id="qiskit.opflow.OperatorBase.to_matrix" name="to_matrix" signature="abstract OperatorBase.to_matrix(massive=False)">
  ...
  <Function id="qiskit.opflow.OperatorBase.to_matrix_op" name="to_matrix_op" signature="abstract OperatorBase.to_matrix_op(massive=False)">
  ...
  <Function id="qiskit.opflow.OperatorBase.to_spmatrix" name="to_spmatrix" signature="OperatorBase.to_spmatrix()">
  ...
  <Attribute id="qiskit.opflow.OperatorBase.INDENTATION" name="INDENTATION" attributeValue="'  '" />

  ### instance\_id

  <Attribute id="qiskit.opflow.OperatorBase.instance_id" name="instance_id">
  ...
  <Attribute id="qiskit.opflow.OperatorBase.num_qubits" name="num_qubits">
  ...
  <Attribute id="qiskit.opflow.OperatorBase.parameters" name="parameters">
    Return a set of Parameter objects contained in the Operator.
  </Attribute>

  ### settings

  <Attribute id="qiskit.opflow.OperatorBase.settings" name="settings">
