...
<Function id="qiskit_aer.library.save_unitary" name="save_unitary" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-aer/tree/stable/0.11/qiskit_aer/library/save_instructions/save_unitary.py" signature="save_unitary(self, label='unitary', pershot=False)">
