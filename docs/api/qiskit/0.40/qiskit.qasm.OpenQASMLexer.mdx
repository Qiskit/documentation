...
<Class id="qiskit.qasm.OpenQASMLexer" github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/qasm/pygments/lexer.py" signature="OpenQASMLexer(*args, **kwds)">
  ...
  <Function id="qiskit.qasm.OpenQASMLexer.analyse_text" signature="static OpenQASMLexer.analyse_text(text)">
