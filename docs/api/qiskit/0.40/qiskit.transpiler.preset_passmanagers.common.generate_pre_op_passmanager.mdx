---
title: generate_pre_op_passmanager (v0.40)
description: API reference for qiskit.transpiler.preset_passmanagers.common.generate_pre_op_passmanager in qiskit v0.40
