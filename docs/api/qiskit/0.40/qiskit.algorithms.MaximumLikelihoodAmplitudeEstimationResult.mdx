---
title: MaximumLikelihoodAmplitudeEstimationResult (v0.40)
description: API reference for qiskit.algorithms.MaximumLikelihoodAmplitudeEstimationResult in qiskit v0.40
