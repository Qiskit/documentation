---
title: CrosstalkAdaptiveSchedule (v0.40)
description: API reference for qiskit.transpiler.passes.CrosstalkAdaptiveSchedule in qiskit v0.40
...
<Class id="qiskit.transpiler.passes.CrosstalkAdaptiveSchedule" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/transpiler/passes/optimization/crosstalk_adaptive_schedule.py" signature="CrosstalkAdaptiveSchedule(*args, **kwargs)" modifiers="class">
