...
<Class id="qiskit.circuit.classicalfunction.BooleanExpression" github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/circuit/classicalfunction/boolean_expression.py" signature="BooleanExpression(expression, name=None)">
  ...
  *   **name** (*str*) – Optional. Instruction gate name. Otherwise part of the expression is going to be used.
  ...
  <Function id="qiskit.circuit.classicalfunction.BooleanExpression.from_dimacs_file" signature="classmethod BooleanExpression.from_dimacs_file(filename)">
