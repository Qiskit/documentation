---
title: GRY (v0.40)
description: API reference for qiskit.circuit.library.GRY in qiskit v0.40
...
$$
  ...
  **Expanded Circuit:**
  ...
  ![../\_images/qiskit-circuit-library-GRY-1.png](/docs/images/api/qiskit/0.40/qiskit-circuit-library-GRY-1.avif)
