---
title: Call (v0.40)
description: API reference for qiskit.pulse.instructions.Call in qiskit v0.40
...
<Class id="qiskit.pulse.instructions.Call" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/pulse/instructions/call.py" signature="Call(subroutine, value_dict=None, name=None)" modifiers="class">
