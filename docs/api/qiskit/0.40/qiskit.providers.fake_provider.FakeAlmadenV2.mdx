---
title: FakeAlmadenV2 (v0.40)
description: API reference for qiskit.providers.fake_provider.FakeAlmadenV2 in qiskit v0.40
...
<Class id="qiskit.providers.fake_provider.FakeAlmadenV2" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/providers/fake_provider/backends/almaden/fake_almaden.py" signature="FakeAlmadenV2" modifiers="class">
