...
<Class id="qiskit.opflow.gradients.GradientBase" github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/opflow/gradients/gradient_base.py" signature="GradientBase(grad_method='param_shift', **kwargs)">
