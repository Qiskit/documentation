---
title: NoiseTransformer (v0.40)
description: API reference for qiskit_aer.utils.NoiseTransformer in qiskit v0.40
...
<Class id="qiskit_aer.utils.NoiseTransformer" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-aer/tree/stable/0.11/qiskit_aer/utils/noise_transformation.py" signature="NoiseTransformer" modifiers="class">
  Bases: `object`
  ...
  <span id="qiskit-aer-utils-noisetransformer-channel-matrix-representation" />

  ### channel\_matrix\_representation

  <Function id="qiskit_aer.utils.NoiseTransformer.channel_matrix_representation" signature="NoiseTransformer.channel_matrix_representation(operators)">
  ...
  <span id="qiskit-aer-utils-noisetransformer-compute-p" />

  ### compute\_P

  <Function id="qiskit_aer.utils.NoiseTransformer.compute_P" signature="NoiseTransformer.compute_P(As)">
  ...
  <span id="qiskit-aer-utils-noisetransformer-compute-channel-operation" />

  ### compute\_channel\_operation

  <Function id="qiskit_aer.utils.NoiseTransformer.compute_channel_operation" signature="NoiseTransformer.compute_channel_operation(rho, operators)" modifiers="static">
  ...
  <span id="qiskit-aer-utils-noisetransformer-compute-q" />

  ### compute\_q

  <Function id="qiskit_aer.utils.NoiseTransformer.compute_q" signature="NoiseTransformer.compute_q(As, C)">
  ...
  <span id="qiskit-aer-utils-noisetransformer-fidelity" />

  ### fidelity

  <Function id="qiskit_aer.utils.NoiseTransformer.fidelity" signature="NoiseTransformer.fidelity(channel)" modifiers="static">
    Calculates channel fidelity
  </Function>

  <span id="qiskit-aer-utils-noisetransformer-flatten-matrix" />

  ### flatten\_matrix

  <Function id="qiskit_aer.utils.NoiseTransformer.flatten_matrix" signature="NoiseTransformer.flatten_matrix(m)" modifiers="static">
    **Parameters**
  ...
  <span id="qiskit-aer-utils-noisetransformer-generate-channel-matrices" />

  ### generate\_channel\_matrices

  <Function id="qiskit_aer.utils.NoiseTransformer.generate_channel_matrices" signature="NoiseTransformer.generate_channel_matrices(transform_channel_operators_list)">
  ...
  <span id="qiskit-aer-utils-noisetransformer-generate-channel-quadratic-programming-matrices" />

  ### generate\_channel\_quadratic\_programming\_matrices

  <Function id="qiskit_aer.utils.NoiseTransformer.generate_channel_quadratic_programming_matrices" signature="NoiseTransformer.generate_channel_quadratic_programming_matrices(channel, symbols)">
  ...
  <span id="qiskit-aer-utils-noisetransformer-get-const-matrix-from-channel" />

  ### get\_const\_matrix\_from\_channel

  <Function id="qiskit_aer.utils.NoiseTransformer.get_const_matrix_from_channel" signature="NoiseTransformer.get_const_matrix_from_channel(channel, symbols)" modifiers="static">
  ...
  <span id="qiskit-aer-utils-noisetransformer-get-matrix-from-channel" />

  ### get\_matrix\_from\_channel

  <Function id="qiskit_aer.utils.NoiseTransformer.get_matrix_from_channel" signature="NoiseTransformer.get_matrix_from_channel(channel, symbol)" modifiers="static">
  ...
  <span id="qiskit-aer-utils-noisetransformer-operator-circuit" />

  ### operator\_circuit

  <Function id="qiskit_aer.utils.NoiseTransformer.operator_circuit" signature="NoiseTransformer.operator_circuit(operator)">
  ...
  <span id="qiskit-aer-utils-noisetransformer-operator-matrix" />

  ### operator\_matrix

  <Function id="qiskit_aer.utils.NoiseTransformer.operator_matrix" signature="NoiseTransformer.operator_matrix(operator)">
  ...
  <span id="qiskit-aer-utils-noisetransformer-prepare-channel-operator-list" />

  ### prepare\_channel\_operator\_list

  <Function id="qiskit_aer.utils.NoiseTransformer.prepare_channel_operator_list" signature="NoiseTransformer.prepare_channel_operator_list(ops_list)" modifiers="static">
  ...
  <span id="qiskit-aer-utils-noisetransformer-prepare-honesty-constraint" />

  ### prepare\_honesty\_constraint

  <Function id="qiskit_aer.utils.NoiseTransformer.prepare_honesty_constraint" signature="NoiseTransformer.prepare_honesty_constraint(transform_channel_operators_list)">
  ...
  <span id="qiskit-aer-utils-noisetransformer-solve-quadratic-program" />

  ### solve\_quadratic\_program

  <Function id="qiskit_aer.utils.NoiseTransformer.solve_quadratic_program" signature="NoiseTransformer.solve_quadratic_program(P, q)">
  ...
  <span id="qiskit-aer-utils-noisetransformer-transform-by-given-channel" />

  ### transform\_by\_given\_channel

  <Function id="qiskit_aer.utils.NoiseTransformer.transform_by_given_channel" signature="NoiseTransformer.transform_by_given_channel(channel_matrices, const_channel_matrix)">
  ...
  <span id="qiskit-aer-utils-noisetransformer-transform-by-operator-list" />

  ### transform\_by\_operator\_list

  <Function id="qiskit_aer.utils.NoiseTransformer.transform_by_operator_list" signature="NoiseTransformer.transform_by_operator_list(transform_channel_operators, noise_kraus_operators)">
