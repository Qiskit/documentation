...
<Class id="qiskit.transpiler.StagedPassManager" github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/transpiler/passmanager.py" signature="StagedPassManager(stages=None, **kwargs)">
