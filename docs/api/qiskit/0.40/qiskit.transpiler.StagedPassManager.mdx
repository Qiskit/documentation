---
title: StagedPassManager (v0.40)
description: API reference for qiskit.transpiler.StagedPassManager in qiskit v0.40
...
<Class id="qiskit.transpiler.StagedPassManager" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/transpiler/passmanager.py" signature="StagedPassManager(stages=None, **kwargs)" modifiers="class">
