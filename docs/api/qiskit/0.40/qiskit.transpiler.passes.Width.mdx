---
title: Width (v0.40)
description: API reference for qiskit.transpiler.passes.Width in qiskit v0.40
...
<Class id="qiskit.transpiler.passes.Width" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/transpiler/passes/analysis/width.py" signature="Width(*args, **kwargs)" modifiers="class">
