---
title: cos (v0.40)
description: API reference for qiskit.pulse.library.cos in qiskit v0.40
...
<Function id="qiskit.pulse.library.cos" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/pulse/library/discrete.py" signature="cos(duration, amp, freq=None, phase=0, name=None)">
