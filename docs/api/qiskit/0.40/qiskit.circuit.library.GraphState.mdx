---
title: GraphState (v0.40)
description: API reference for qiskit.circuit.library.GraphState in qiskit v0.40
...
$$
  ...
  **Reference Circuit:**
  ...
  ![../\_images/qiskit-circuit-library-GraphState-1.png](/docs/images/api/qiskit/0.40/qiskit-circuit-library-GraphState-1.avif)
