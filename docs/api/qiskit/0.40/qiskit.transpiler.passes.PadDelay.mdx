...
<Class id="qiskit.transpiler.passes.PadDelay" github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/transpiler/passes/scheduling/padding/pad_delay.py" signature="PadDelay(fill_very_end=True)">
