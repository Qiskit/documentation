...
<Class id="qiskit.algorithms.optimizers.optimizer_utils.LearningRate" github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/algorithms/optimizers/optimizer_utils/learning_rate.py" signature="LearningRate(learning_rate)">
  Bases: `Generator`
