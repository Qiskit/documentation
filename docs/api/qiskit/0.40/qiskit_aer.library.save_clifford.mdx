...
<Function id="qiskit_aer.library.save_clifford" name="save_clifford" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-aer/tree/stable/0.11/qiskit_aer/library/save_instructions/save_clifford.py" signature="save_clifford(self, label='clifford', pershot=False)">
