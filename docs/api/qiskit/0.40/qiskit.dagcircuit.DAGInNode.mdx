---
title: DAGInNode (v0.40)
description: API reference for qiskit.dagcircuit.DAGInNode in qiskit v0.40
...
<Class id="qiskit.dagcircuit.DAGInNode" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/dagcircuit/dagnode.py" signature="DAGInNode(wire)" modifiers="class">
