...
<Class id="qiskit.dagcircuit.BlockCollector" github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/dagcircuit/collect_blocks.py" signature="BlockCollector(dag)">
  Bases: `object`
