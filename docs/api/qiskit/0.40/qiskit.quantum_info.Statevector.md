...
([Source code](qiskit-quantum_info-Statevector-draw-1.py), [png](qiskit-quantum_info-Statevector-draw-1.png), [hires.png](qiskit-quantum_info-Statevector-draw-1.hires.png), [pdf](qiskit-quantum_info-Statevector-draw-1.pdf))

![../\_images/qiskit-quantum\_info-Statevector-draw-1.png](/images/api/qiskit/0.40/qiskit-quantum_info-Statevector-draw-1.png)
