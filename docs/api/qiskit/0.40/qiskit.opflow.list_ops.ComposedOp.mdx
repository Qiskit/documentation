...
<Class id="qiskit.opflow.list_ops.ComposedOp" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/opflow/list_ops/composed_op.py" signature="ComposedOp(oplist, coeff=1.0, abelian=False)">
  ...
  *   **abelian** (`bool`) – Indicates whether the Operators in `oplist` are known to mutually commute.
  ...
  <Function id="qiskit.opflow.list_ops.ComposedOp.adjoint" name="adjoint" signature="ComposedOp.adjoint()">
  ...
  <Function id="qiskit.opflow.list_ops.ComposedOp.compose" name="compose" signature="ComposedOp.compose(other, permutation=None, front=False)">
  ...
  <Function id="qiskit.opflow.list_ops.ComposedOp.eval" name="eval" signature="ComposedOp.eval(front=None)">
  ...
  <Function id="qiskit.opflow.list_ops.ComposedOp.non_distributive_reduce" name="non_distributive_reduce" signature="ComposedOp.non_distributive_reduce()">
  ...
  <Function id="qiskit.opflow.list_ops.ComposedOp.reduce" name="reduce" signature="ComposedOp.reduce()">
  ...
  <Function id="qiskit.opflow.list_ops.ComposedOp.to_circuit" name="to_circuit" signature="ComposedOp.to_circuit()">
  ...
  <Function id="qiskit.opflow.list_ops.ComposedOp.to_matrix" name="to_matrix" signature="ComposedOp.to_matrix(massive=False)">
  ...
  <Attribute id="qiskit.opflow.list_ops.ComposedOp.INDENTATION" name="INDENTATION" attributeValue="= '  '" />

  ### abelian

  <Attribute id="qiskit.opflow.list_ops.ComposedOp.abelian" name="abelian">
  ...
  <Attribute id="qiskit.opflow.list_ops.ComposedOp.coeff" name="coeff">
  ...
  <Attribute id="qiskit.opflow.list_ops.ComposedOp.coeffs" name="coeffs">
  ...
  <Attribute id="qiskit.opflow.list_ops.ComposedOp.combo_fn" name="combo_fn">
  ...
  <Attribute id="qiskit.opflow.list_ops.ComposedOp.distributive" name="distributive">
    **Return type**
  ...
  <Attribute id="qiskit.opflow.list_ops.ComposedOp.grad_combo_fn" name="grad_combo_fn">
  ...
  <Attribute id="qiskit.opflow.list_ops.ComposedOp.instance_id" name="instance_id">
  ...
  <Attribute id="qiskit.opflow.list_ops.ComposedOp.num_qubits" name="num_qubits">
    **Return type**
  ...
  <Attribute id="qiskit.opflow.list_ops.ComposedOp.oplist" name="oplist">
  ...
  <Attribute id="qiskit.opflow.list_ops.ComposedOp.parameters" name="parameters" />

  ### settings

  <Attribute id="qiskit.opflow.list_ops.ComposedOp.settings" name="settings">
    Return settings.
