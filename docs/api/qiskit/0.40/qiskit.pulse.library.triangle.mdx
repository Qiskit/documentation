---
title: triangle (v0.40)
description: API reference for qiskit.pulse.library.triangle in qiskit v0.40
...
$$
  ...
  **Example**
  ...
  ![../\_images/qiskit-pulse-library-triangle-1.png](/docs/images/api/qiskit/0.40/qiskit-pulse-library-triangle-1.avif)
