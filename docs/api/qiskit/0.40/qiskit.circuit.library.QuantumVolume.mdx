...
([Source code](qiskit-circuit-library-QuantumVolume-1.py), [png](qiskit-circuit-library-QuantumVolume-1.png), [hires.png](qiskit-circuit-library-QuantumVolume-1.hires.png), [pdf](qiskit-circuit-library-QuantumVolume-1.pdf))

![../\_images/qiskit-circuit-library-QuantumVolume-1.png](/images/api/qiskit/0.40/qiskit-circuit-library-QuantumVolume-1.png)

**Expanded Circuit:**

([Source code](qiskit-circuit-library-QuantumVolume-2.py), [png](qiskit-circuit-library-QuantumVolume-2.png), [hires.png](qiskit-circuit-library-QuantumVolume-2.hires.png), [pdf](qiskit-circuit-library-QuantumVolume-2.pdf))

![../\_images/qiskit-circuit-library-QuantumVolume-2.png](/images/api/qiskit/0.40/qiskit-circuit-library-QuantumVolume-2.png)
...
*   **seed** (`Union`\[`Generator`, `int`, `None`]) – Random number generator or generator seed.
