---
title: FakePerth (v0.40)
description: API reference for qiskit.providers.fake_provider.FakePerth in qiskit v0.40
...
<Class id="qiskit.providers.fake_provider.FakePerth" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/providers/fake_provider/backends/perth/fake_perth.py" signature="FakePerth" modifiers="class">
  ...
  <Function id="qiskit.providers.fake_provider.FakePerth.acquire_channel" signature="FakePerth.acquire_channel(qubit)">
  ...
  <Function id="qiskit.providers.fake_provider.FakePerth.control_channel" signature="FakePerth.control_channel(qubits)">
  ...
  <Function id="qiskit.providers.fake_provider.FakePerth.drive_channel" signature="FakePerth.drive_channel(qubit)">
  ...
  <Function id="qiskit.providers.fake_provider.FakePerth.measure_channel" signature="FakePerth.measure_channel(qubit)">
  ...
  <Function id="qiskit.providers.fake_provider.FakePerth.qubit_properties" signature="FakePerth.qubit_properties(qubit)">
  ...
  <Function id="qiskit.providers.fake_provider.FakePerth.run" signature="FakePerth.run(run_input, **options)">
  ...
  <Function id="qiskit.providers.fake_provider.FakePerth.set_options" signature="FakePerth.set_options(**fields)">
  ...
  <Attribute id="qiskit.providers.fake_provider.FakePerth.dirname" attributeValue="'/home/runner/work/qiskit/qiskit/.tox/docs/lib/python3.8/site-packages/qiskit/providers/fake_provider/backends/perth'" />
