...
<Class id="qiskit.qobj.QasmExperimentCalibrations" github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/qobj/qasm_qobj.py" signature="QasmExperimentCalibrations(gates)">
  Bases: `object`
