---
title: disassemble (v0.40)
description: API reference for qiskit.assembler.disassemble in qiskit v0.40
...
<Function id="qiskit.assembler.disassemble" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/assembler/disassemble.py" signature="disassemble(qobj)">
