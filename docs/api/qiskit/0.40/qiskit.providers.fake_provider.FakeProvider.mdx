---
title: FakeProvider (v0.40)
description: API reference for qiskit.providers.fake_provider.FakeProvider in qiskit v0.40
...
<Class id="qiskit.providers.fake_provider.FakeProvider" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/providers/fake_provider/fake_provider.py" signature="FakeProvider" modifiers="class">
