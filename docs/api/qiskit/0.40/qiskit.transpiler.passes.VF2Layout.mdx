---
title: VF2Layout (v0.40)
description: API reference for qiskit.transpiler.passes.VF2Layout in qiskit v0.40
...
<Class id="qiskit.transpiler.passes.VF2Layout" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/transpiler/passes/layout/vf2_layout.py" signature="VF2Layout(*args, **kwargs)" modifiers="class">
