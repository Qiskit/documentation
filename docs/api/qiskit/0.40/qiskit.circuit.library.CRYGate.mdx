---
title: CRYGate (v0.40)
description: API reference for qiskit.circuit.library.CRYGate in qiskit v0.40
...
<Class id="qiskit.circuit.library.CRYGate" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/circuit/library/standard_gates/ry.py" signature="CRYGate(theta, label=None, ctrl_state=None)" modifiers="class">
