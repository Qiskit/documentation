---
title: BaseStateFidelity (v0.40)
description: API reference for qiskit.algorithms.state_fidelities.BaseStateFidelity in qiskit v0.40
...
<Class id="qiskit.algorithms.state_fidelities.BaseStateFidelity" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/algorithms/state_fidelities/base_state_fidelity.py" signature="BaseStateFidelity" modifiers="class">
  Bases: `abc.ABC`
