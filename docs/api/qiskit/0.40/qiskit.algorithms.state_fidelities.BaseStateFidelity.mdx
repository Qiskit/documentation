...
<Class id="qiskit.algorithms.state_fidelities.BaseStateFidelity" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/algorithms/state_fidelities/base_state_fidelity.py" signature="BaseStateFidelity">
  Bases: `abc.ABC`
