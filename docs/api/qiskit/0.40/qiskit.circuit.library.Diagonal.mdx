---
title: Diagonal (v0.40)
description: API reference for qiskit.circuit.library.Diagonal in qiskit v0.40
...
<Class id="qiskit.circuit.library.Diagonal" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/circuit/library/generalized_gates/diagonal.py" signature="Diagonal(diag)" modifiers="class">
...
$$
  ...
  **CircuitError** – if the list of the diagonal entries or the qubit list is in bad format; if the number of diagonal entries is not 2^k, where k denotes the number of qubits
  ...
  <Attribute id="qiskit.circuit.library.Diagonal.instances" attributeValue="2308" />
