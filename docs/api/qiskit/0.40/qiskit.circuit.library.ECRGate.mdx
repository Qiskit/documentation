---
title: ECRGate (v0.40)
description: API reference for qiskit.circuit.library.ECRGate in qiskit v0.40
...
<Class id="qiskit.circuit.library.ECRGate" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/circuit/library/standard_gates/ecr.py" signature="ECRGate" modifiers="class">
