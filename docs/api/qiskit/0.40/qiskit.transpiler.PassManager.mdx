...
<Class id="qiskit.transpiler.PassManager" github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/transpiler/passmanager.py" signature="PassManager(passes=None, max_iteration=1000)">
  Bases: `object`
