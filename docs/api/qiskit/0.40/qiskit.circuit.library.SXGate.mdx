---
title: SXGate (v0.40)
description: API reference for qiskit.circuit.library.SXGate in qiskit v0.40
...
<Class id="qiskit.circuit.library.SXGate" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/circuit/library/standard_gates/sx.py" signature="SXGate(label=None)" modifiers="class">
