...
<Class id="qiskit.transpiler.synthesis.aqc.AQCSynthesisPlugin" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/transpiler/synthesis/aqc/aqc_plugin.py" signature="AQCSynthesisPlugin">
  ...
  **initial\_point (`ndarray`)**
  ...
  <Function id="qiskit.transpiler.synthesis.aqc.AQCSynthesisPlugin.run" name="run" signature="AQCSynthesisPlugin.run(unitary, **options)">
