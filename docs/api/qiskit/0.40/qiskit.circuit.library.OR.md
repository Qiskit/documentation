...
([Source code](qiskit-circuit-library-OR-1.py), [png](qiskit-circuit-library-OR-1.png), [hires.png](qiskit-circuit-library-OR-1.hires.png), [pdf](qiskit-circuit-library-OR-1.pdf))

![../\_images/qiskit-circuit-library-OR-1.png](/images/api/qiskit/0.40/qiskit-circuit-library-OR-1.png)
...
([Source code](qiskit-circuit-library-OR-2.py), [png](qiskit-circuit-library-OR-2.png), [hires.png](qiskit-circuit-library-OR-2.hires.png), [pdf](qiskit-circuit-library-OR-2.pdf))

![../\_images/qiskit-circuit-library-OR-2.png](/images/api/qiskit/0.40/qiskit-circuit-library-OR-2.png)
