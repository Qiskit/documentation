---
title: SPSASamplerGradient (v0.40)
description: API reference for qiskit.algorithms.gradients.SPSASamplerGradient in qiskit v0.40
...
<Class id="qiskit.algorithms.gradients.SPSASamplerGradient" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/algorithms/gradients/spsa_sampler_gradient.py" signature="SPSASamplerGradient(sampler, epsilon, batch_size=1, seed=None, options=None)" modifiers="class">
