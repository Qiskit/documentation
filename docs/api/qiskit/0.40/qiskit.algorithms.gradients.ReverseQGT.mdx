...
<Class id="qiskit.algorithms.gradients.ReverseQGT" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/algorithms/gradients/reverse_gradient/reverse_qgt.py" signature="ReverseQGT(phase_fix=True, derivative_type=DerivativeType.COMPLEX)">
  ...
  *   **derivative\_type** ([`DerivativeType`](qiskit.algorithms.gradients.DerivativeType "qiskit.algorithms.gradients.utils.DerivativeType")) – Determines whether the complex QGT or only the real or imaginary parts are calculated.
  ...
  <Function id="qiskit.algorithms.gradients.ReverseQGT.run" name="run" signature="ReverseQGT.run(circuits, parameter_values, parameters=None, **options)">
  ...
  <Function id="qiskit.algorithms.gradients.ReverseQGT.update_default_options" name="update_default_options" signature="ReverseQGT.update_default_options(**options)">
  ...
  <Attribute id="qiskit.algorithms.gradients.ReverseQGT.SUPPORTED_GATES" name="SUPPORTED_GATES" attributeValue="= ['rx', 'ry', 'rz', 'cp', 'crx', 'cry', 'crz']" />

  ### derivative\_type

  <Attribute id="qiskit.algorithms.gradients.ReverseQGT.derivative_type" name="derivative_type">
    The derivative type.
  ...
  <Attribute id="qiskit.algorithms.gradients.ReverseQGT.options" name="options">
