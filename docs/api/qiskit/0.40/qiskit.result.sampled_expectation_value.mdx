---
title: sampled_expectation_value (v0.40)
description: API reference for qiskit.result.sampled_expectation_value in qiskit v0.40
...
<Function id="qiskit.result.sampled_expectation_value" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/result/sampled_expval.py" signature="sampled_expectation_value(dist, oper)">
