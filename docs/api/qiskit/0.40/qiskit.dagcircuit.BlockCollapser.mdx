...
<Class id="qiskit.dagcircuit.BlockCollapser" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/dagcircuit/collect_blocks.py" signature="BlockCollapser(dag)">
  Bases: `object`
  ...
  **dag** (*Union\[*[*DAGCircuit*](qiskit.dagcircuit.DAGCircuit "qiskit.dagcircuit.DAGCircuit")*,* [*DAGDependency*](qiskit.dagcircuit.DAGDependency "qiskit.dagcircuit.DAGDependency")*]*) – The input DAG.
  ...
  <Function id="qiskit.dagcircuit.BlockCollapser.collapse_to_operation" name="collapse_to_operation" signature="BlockCollapser.collapse_to_operation(blocks, collapse_fn)">
