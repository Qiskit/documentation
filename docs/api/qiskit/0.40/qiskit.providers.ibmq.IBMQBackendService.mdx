---
title: IBMQBackendService (v0.40)
description: API reference for qiskit.providers.ibmq.IBMQBackendService in qiskit v0.40
...
<Class id="qiskit.providers.ibmq.IBMQBackendService" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-ibmq-provider/tree/stable/0.19/qiskit/providers/ibmq/ibmqbackendservice.py" signature="IBMQBackendService(provider)" modifiers="class">
  Bases: `object`
