...
<Class id="qiskit.quantum_info.Operator" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/quantum_info/operators/operator.py" signature="Operator(data, input_dims=None, output_dims=None)">
...
$$
  ...
  **Additional Information:**
  ...
  <Function id="qiskit.quantum_info.Operator.adjoint" name="adjoint" signature="Operator.adjoint()">
    Return the adjoint of the Operator.
  </Function>

  ### compose

  <Function id="qiskit.quantum_info.Operator.compose" name="compose" signature="Operator.compose(other, qargs=None, front=False)">
  ...
  <Function id="qiskit.quantum_info.Operator.conjugate" name="conjugate" signature="Operator.conjugate()">
    Return the conjugate of the Operator.
  </Function>

  ### copy

  <Function id="qiskit.quantum_info.Operator.copy" name="copy" signature="Operator.copy()">
    Make a deep copy of current operator.
  </Function>

  ### dot

  <Function id="qiskit.quantum_info.Operator.dot" name="dot" signature="Operator.dot(other, qargs=None)">
  ...
  <Function id="qiskit.quantum_info.Operator.equiv" name="equiv" signature="Operator.equiv(other, rtol=None, atol=None)">
  ...
  <Function id="qiskit.quantum_info.Operator.expand" name="expand" signature="Operator.expand(other)">
  ...
  <Function id="qiskit.quantum_info.Operator.from_circuit" name="from_circuit" signature="classmethod Operator.from_circuit(circuit, ignore_set_layout=False, layout=None, final_layout=None)">
  ...
  <Function id="qiskit.quantum_info.Operator.from_label" name="from_label" signature="classmethod Operator.from_label(label)">
  ...
  <Function id="qiskit.quantum_info.Operator.input_dims" name="input_dims" signature="Operator.input_dims(qargs=None)">
    Return tuple of input dimension for specified subsystems.
  </Function>

  ### is\_unitary

  <Function id="qiskit.quantum_info.Operator.is_unitary" name="is_unitary" signature="Operator.is_unitary(atol=None, rtol=None)">
    Return True if operator is a unitary matrix.
  </Function>

  ### output\_dims

  <Function id="qiskit.quantum_info.Operator.output_dims" name="output_dims" signature="Operator.output_dims(qargs=None)">
    Return tuple of output dimension for specified subsystems.
  </Function>

  ### power

  <Function id="qiskit.quantum_info.Operator.power" name="power" signature="Operator.power(n)">
  ...
  <Function id="qiskit.quantum_info.Operator.reshape" name="reshape" signature="Operator.reshape(input_dims=None, output_dims=None, num_qubits=None)">
  ...
  <Function id="qiskit.quantum_info.Operator.reverse_qargs" name="reverse_qargs" signature="Operator.reverse_qargs()">
  ...
  <Function id="qiskit.quantum_info.Operator.tensor" name="tensor" signature="Operator.tensor(other)">
  ...
  <Function id="qiskit.quantum_info.Operator.to_instruction" name="to_instruction" signature="Operator.to_instruction()">
    Convert to a UnitaryGate instruction.
  </Function>

  ### to\_matrix

  <Function id="qiskit.quantum_info.Operator.to_matrix" name="to_matrix" signature="Operator.to_matrix()">
    Convert operator to NumPy matrix.
  </Function>

  ### to\_operator

  <Function id="qiskit.quantum_info.Operator.to_operator" name="to_operator" signature="Operator.to_operator()">
    Convert operator to matrix operator class
  </Function>

  ### transpose

  <Function id="qiskit.quantum_info.Operator.transpose" name="transpose" signature="Operator.transpose()">
