...
<Class id="qiskit.quantum_info.Operator" github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/quantum_info/operators/operator.py" signature="Operator(data, input_dims=None, output_dims=None)">
  ...
  **Additional Information:**
  ...
  <Function id="qiskit.quantum_info.Operator.from_circuit" signature="classmethod Operator.from_circuit(circuit, ignore_set_layout=False, layout=None, final_layout=None)">
  ...
  <Function id="qiskit.quantum_info.Operator.from_label" signature="classmethod Operator.from_label(label)">
  ...
  <Function id="qiskit.quantum_info.Operator.to_matrix" signature="Operator.to_matrix()">
