---
title: generate_routing_passmanager (v0.40)
description: API reference for qiskit.transpiler.preset_passmanagers.common.generate_routing_passmanager in qiskit v0.40
