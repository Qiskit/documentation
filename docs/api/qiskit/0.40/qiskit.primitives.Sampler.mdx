---
title: Sampler (v0.40)
description: API reference for qiskit.primitives.Sampler in qiskit v0.40
...
<Class id="qiskit.primitives.Sampler" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/primitives/sampler.py" signature="Sampler(circuits: Iterable[QuantumCircuit] | QuantumCircuit | None = None, parameters: Iterable[Iterable[Parameter]] | None = None, **kwargs)" modifiers="class">
  ...
  **QiskitError** – if some classical bits are not used for measurements.
  ...
  <Function id="qiskit.primitives.Sampler.run" signature="Sampler.run(circuits, parameter_values=None, **run_options)">
  ...
  <Function id="qiskit.primitives.Sampler.set_options" signature="Sampler.set_options(**fields)">
