---
title: StabilizerState (v0.40)
description: API reference for qiskit.quantum_info.StabilizerState in qiskit v0.40
...
<Class id="qiskit.quantum_info.StabilizerState" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/quantum_info/states/stabilizerstate.py" signature="StabilizerState(data, validate=True)" modifiers="class">
