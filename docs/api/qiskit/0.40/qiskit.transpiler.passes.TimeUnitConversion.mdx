---
title: TimeUnitConversion (v0.40)
description: API reference for qiskit.transpiler.passes.TimeUnitConversion in qiskit v0.40
...
<Class id="qiskit.transpiler.passes.TimeUnitConversion" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/transpiler/passes/scheduling/time_unit_conversion.py" signature="TimeUnitConversion(inst_durations)" modifiers="class">
