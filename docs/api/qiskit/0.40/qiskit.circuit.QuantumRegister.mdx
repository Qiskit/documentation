---
title: QuantumRegister (v0.40)
description: API reference for qiskit.circuit.QuantumRegister in qiskit v0.40
...
<Class id="qiskit.circuit.QuantumRegister" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/circuit/quantumregister.py" signature="QuantumRegister(size=None, name=None, bits=None)" modifiers="class">
  ...
  *   **CircuitError** – if `bits` contained bits of an incorrect type.
  ...
  <Attribute id="qiskit.circuit.QuantumRegister.instances_counter" attributeValue="count(416)" />
  ...
  <Attribute id="qiskit.circuit.QuantumRegister.name_format" />
