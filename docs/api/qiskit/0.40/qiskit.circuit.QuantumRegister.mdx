...
<Class id="qiskit.circuit.QuantumRegister" github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/circuit/quantumregister.py" signature="QuantumRegister(size=None, name=None, bits=None)">
  ...
  *   **CircuitError** – if `bits` contained bits of an incorrect type.
  ...
  <Attribute id="qiskit.circuit.QuantumRegister.instances_counter" name="instances_counter" attributeValue="= count(416)" />
  ...
  <Attribute id="qiskit.circuit.QuantumRegister.name_format" name="name_format" />
