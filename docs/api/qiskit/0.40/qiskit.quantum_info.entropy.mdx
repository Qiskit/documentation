---
title: entropy (v0.40)
description: API reference for qiskit.quantum_info.entropy in qiskit v0.40
...
<Function id="qiskit.quantum_info.entropy" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/quantum_info/states/measures.py" signature="entropy(state, base=2)">
