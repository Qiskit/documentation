...
<Function id="qiskit.utils.deprecate_function" name="deprecate_function" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/utils/deprecation.py" signature="deprecate_function(msg, stacklevel=2, category=<class 'DeprecationWarning'>)">
