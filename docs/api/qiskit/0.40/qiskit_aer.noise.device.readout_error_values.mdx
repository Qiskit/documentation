...
<Function id="qiskit_aer.noise.device.readout_error_values" name="readout_error_values" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-aer/tree/stable/0.11/qiskit_aer/noise/device/parameters.py" signature="readout_error_values(properties)">
