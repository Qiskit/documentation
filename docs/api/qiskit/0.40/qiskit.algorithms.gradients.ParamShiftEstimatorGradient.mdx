---
title: ParamShiftEstimatorGradient (v0.40)
description: API reference for qiskit.algorithms.gradients.ParamShiftEstimatorGradient in qiskit v0.40
