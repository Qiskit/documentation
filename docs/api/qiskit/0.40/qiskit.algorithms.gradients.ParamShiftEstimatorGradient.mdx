...
<Class id="qiskit.algorithms.gradients.ParamShiftEstimatorGradient" github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/algorithms/gradients/param_shift_estimator_gradient.py" signature="ParamShiftEstimatorGradient(estimator, options=None, derivative_type=DerivativeType.REAL)">
