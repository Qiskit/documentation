---
title: gaussian_deriv (v0.40)
description: API reference for qiskit.pulse.library.gaussian_deriv in qiskit v0.40
...
<Function id="qiskit.pulse.library.gaussian_deriv" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/pulse/library/discrete.py" signature="gaussian_deriv(duration, amp, sigma, name=None)">
