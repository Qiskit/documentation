---
title: DefaultCNOTUnitObjective (v0.40)
description: API reference for qiskit.transpiler.synthesis.aqc.DefaultCNOTUnitObjective in qiskit v0.40
...
<Class id="qiskit.transpiler.synthesis.aqc.DefaultCNOTUnitObjective" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/transpiler/synthesis/aqc/cnot_unit_objective.py" signature="DefaultCNOTUnitObjective(num_qubits, cnots)" modifiers="class">
