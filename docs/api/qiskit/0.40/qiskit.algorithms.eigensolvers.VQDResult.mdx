---
title: VQDResult (v0.40)
description: API reference for qiskit.algorithms.eigensolvers.VQDResult in qiskit v0.40
...
<Class id="qiskit.algorithms.eigensolvers.VQDResult" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/algorithms/eigensolvers/vqd.py" signature="VQDResult" modifiers="class">
