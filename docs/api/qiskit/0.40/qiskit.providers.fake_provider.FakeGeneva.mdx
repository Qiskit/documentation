...
description: API reference for qiskit.providers.fake_provider.FakeGeneva in qiskit v0.40
...
<Class id="qiskit.providers.fake_provider.FakeGeneva" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/providers/fake_provider/backends/geneva/fake_geneva.py" signature="FakeGeneva" modifiers="class">
  ...
  <Attribute id="qiskit.providers.fake_provider.FakeGeneva.dirname" attributeValue="'/home/runner/work/qiskit/qiskit/.tox/docs/lib/python3.8/site-packages/qiskit/providers/fake_provider/backends/geneva'" />
