---
title: RealTimeEvolver (v0.40)
description: API reference for qiskit.algorithms.RealTimeEvolver in qiskit v0.40
...
<Class id="qiskit.algorithms.RealTimeEvolver" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/algorithms/time_evolvers/real_time_evolver.py" signature="RealTimeEvolver" modifiers="class">
  Bases: `abc.ABC`
  ...
  <Function id="qiskit.algorithms.RealTimeEvolver.evolve" signature="RealTimeEvolver.evolve(evolution_problem)" modifiers="abstract">
