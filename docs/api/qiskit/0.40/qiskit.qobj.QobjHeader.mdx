...
<Class id="qiskit.qobj.QobjHeader" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/qobj/common.py" signature="QobjHeader(**kwargs)">
