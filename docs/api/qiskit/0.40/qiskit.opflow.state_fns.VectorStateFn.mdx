---
title: VectorStateFn (v0.40)
description: API reference for qiskit.opflow.state_fns.VectorStateFn in qiskit v0.40
...
<Class id="qiskit.opflow.state_fns.VectorStateFn" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/opflow/state_fns/vector_state_fn.py" signature="VectorStateFn(primitive=None, coeff=1.0, is_measurement=False)" modifiers="class">
