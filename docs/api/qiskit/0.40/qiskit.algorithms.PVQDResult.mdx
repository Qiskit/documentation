...
<Class id="qiskit.algorithms.PVQDResult" github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/algorithms/time_evolvers/pvqd/pvqd_result.py" signature="PVQDResult(evolved_state, aux_ops_evaluated=None, times=None, parameters=None, fidelities=None, estimated_error=None, observables=None)">
  ...
  *   **observables** – The value of the observables evaluated at each iteration.
  ...
  <Function id="qiskit.algorithms.PVQDResult.combine" name="combine" signature="PVQDResult.combine(result)">
