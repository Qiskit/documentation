---
title: QasmSimulatorPy (v0.40)
description: API reference for qiskit.providers.basicaer.QasmSimulatorPy in qiskit v0.40
...
<Class id="qiskit.providers.basicaer.QasmSimulatorPy" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/providers/basicaer/qasm_simulator.py" signature="QasmSimulatorPy(configuration=None, provider=None, **fields)" modifiers="class">
