...
<Class id="qiskit.algorithms.ImaginaryEvolver" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/algorithms/evolvers/imaginary_evolver.py" signature="ImaginaryEvolver">
  Bases: `abc.ABC`
  ...
  <Function id="qiskit.algorithms.ImaginaryEvolver.evolve" signature="abstract ImaginaryEvolver.evolve(evolution_problem)">
