---
title: SPSAEstimatorGradient (v0.40)
description: API reference for qiskit.algorithms.gradients.SPSAEstimatorGradient in qiskit v0.40
...
<Class id="qiskit.algorithms.gradients.SPSAEstimatorGradient" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/algorithms/gradients/spsa_estimator_gradient.py" signature="SPSAEstimatorGradient(estimator, epsilon, batch_size=1, seed=None, options=None)" modifiers="class">
