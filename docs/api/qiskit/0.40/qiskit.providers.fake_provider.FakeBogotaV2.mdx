---
title: FakeBogotaV2 (v0.40)
description: API reference for qiskit.providers.fake_provider.FakeBogotaV2 in qiskit v0.40
...
<Class id="qiskit.providers.fake_provider.FakeBogotaV2" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/providers/fake_provider/backends/bogota/fake_bogota.py" signature="FakeBogotaV2" modifiers="class">
  ...
  <Attribute id="qiskit.providers.fake_provider.FakeBogotaV2.backend_name" attributeValue="'fake_bogota_v2'" />
  ...
  <Attribute id="qiskit.providers.fake_provider.FakeBogotaV2.dirname" attributeValue="'/home/runner/work/qiskit/qiskit/.tox/docs/lib/python3.8/site-packages/qiskit/providers/fake_provider/backends/bogota'" />
