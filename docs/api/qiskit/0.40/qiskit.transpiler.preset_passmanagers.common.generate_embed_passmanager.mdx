---
title: generate_embed_passmanager (v0.40)
description: API reference for qiskit.transpiler.preset_passmanagers.common.generate_embed_passmanager in qiskit v0.40
