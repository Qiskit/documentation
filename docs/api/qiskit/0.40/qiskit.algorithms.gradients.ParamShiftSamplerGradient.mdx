...
<Class id="qiskit.algorithms.gradients.ParamShiftSamplerGradient" github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/algorithms/gradients/param_shift_sampler_gradient.py" signature="ParamShiftSamplerGradient(sampler, options=None)">
