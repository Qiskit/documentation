---
title: MCXVChain (v0.40)
description: API reference for qiskit.circuit.library.MCXVChain in qiskit v0.40
...
<Class id="qiskit.circuit.library.MCXVChain" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/circuit/library/standard_gates/x.py" signature="MCXVChain(num_ctrl_qubits, dirty_ancillas=False, label=None, ctrl_state=None)" modifiers="class">
