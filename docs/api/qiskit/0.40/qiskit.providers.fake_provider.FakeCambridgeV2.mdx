---
title: FakeCambridgeV2 (v0.40)
description: API reference for qiskit.providers.fake_provider.FakeCambridgeV2 in qiskit v0.40
...
<Class id="qiskit.providers.fake_provider.FakeCambridgeV2" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/providers/fake_provider/backends/cambridge/fake_cambridge.py" signature="FakeCambridgeV2" modifiers="class">
  ...
  <Function id="qiskit.providers.fake_provider.FakeCambridgeV2.acquire_channel" signature="FakeCambridgeV2.acquire_channel(qubit)">
  ...
  <Function id="qiskit.providers.fake_provider.FakeCambridgeV2.control_channel" signature="FakeCambridgeV2.control_channel(qubits)">
  ...
  <Function id="qiskit.providers.fake_provider.FakeCambridgeV2.drive_channel" signature="FakeCambridgeV2.drive_channel(qubit)">
  ...
  <Function id="qiskit.providers.fake_provider.FakeCambridgeV2.measure_channel" signature="FakeCambridgeV2.measure_channel(qubit)">
  ...
  <Function id="qiskit.providers.fake_provider.FakeCambridgeV2.qubit_properties" signature="FakeCambridgeV2.qubit_properties(qubit)">
  ...
  <Function id="qiskit.providers.fake_provider.FakeCambridgeV2.run" signature="FakeCambridgeV2.run(run_input, **options)">
  ...
  <Function id="qiskit.providers.fake_provider.FakeCambridgeV2.set_options" signature="FakeCambridgeV2.set_options(**fields)">
  ...
  <Attribute id="qiskit.providers.fake_provider.FakeCambridgeV2.backend_name" attributeValue="'fake_cambridge_v2'" />
  ...
  <Attribute id="qiskit.providers.fake_provider.FakeCambridgeV2.dirname" attributeValue="'/home/runner/work/qiskit/qiskit/.tox/docs/lib/python3.8/site-packages/qiskit/providers/fake_provider/backends/cambridge'" />
