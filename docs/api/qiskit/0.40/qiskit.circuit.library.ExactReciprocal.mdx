---
title: ExactReciprocal (v0.40)
description: API reference for qiskit.circuit.library.ExactReciprocal in qiskit v0.40
...
$$
  ...
  *   **name** (`str`) – The name of the object.
  ...
  <Attribute id="qiskit.circuit.library.ExactReciprocal.instances" attributeValue="2308" />
