...
([Source code](qiskit-circuit-library-GRX-1.py), [png](qiskit-circuit-library-GRX-1.png), [hires.png](qiskit-circuit-library-GRX-1.hires.png), [pdf](qiskit-circuit-library-GRX-1.pdf))

![../\_images/qiskit-circuit-library-GRX-1.png](/images/api/qiskit/0.40/qiskit-circuit-library-GRX-1.png)
