...
<Class id="qiskit.opflow.expectations.PauliExpectation" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/opflow/expectations/pauli_expectation.py" signature="PauliExpectation(group_paulis=True)">
  ...
  **group\_paulis** (`bool`) – Whether to group the Pauli measurements into commuting sums, which all have the same diagonalizing circuit.
  ...
  <Function id="qiskit.opflow.expectations.PauliExpectation.compute_variance" name="compute_variance" signature="PauliExpectation.compute_variance(exp_op)">
  ...
  <Function id="qiskit.opflow.expectations.PauliExpectation.convert" name="convert" signature="PauliExpectation.convert(operator)">
