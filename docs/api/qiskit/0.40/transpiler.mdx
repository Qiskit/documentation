...
![../\_images/transpiling\_core\_steps.png](/images/api/qiskit/0.40/transpiling_core_steps.png)
...
([Source code](transpiler-4.py), [png](transpiler-4.png), [hires.png](transpiler-4.hires.png), [pdf](transpiler-4.pdf))

![../\_images/transpiler-4.png](/images/api/qiskit/0.40/transpiler-4.png)
...
([Source code](transpiler-5.py), [png](transpiler-5.png), [hires.png](transpiler-5.hires.png), [pdf](transpiler-5.pdf))

![../\_images/transpiler-5.png](/images/api/qiskit/0.40/transpiler-5.png)
...
2.  A Toffoli, or controlled-controlled-not gate (`ccx`), is a three-qubit gate. Given that our basis gate set includes only single- and two-qubit gates, it is obvious that this gate must be decomposed. This decomposition is quite costly:
    ...
    ([Source code](transpiler-6.py), [png](transpiler-6.png), [hires.png](transpiler-6.hires.png), [pdf](transpiler-6.pdf))

    ![../\_images/transpiler-6.png](/images/api/qiskit/0.40/transpiler-6.png)
...
![../\_images/mapping.png](/images/api/qiskit/0.40/mapping.png)
...
([Source code](transpiler-7.py), [png](transpiler-7.png), [hires.png](transpiler-7.hires.png), [pdf](transpiler-7.pdf))

![../\_images/transpiler-7.png](/images/api/qiskit/0.40/transpiler-7.png)
...
*   **Layout Using Optimization Level 0**
    ...
    > ```
    >
    > ([Source code](transpiler-8.py), [png](transpiler-8.png), [hires.png](transpiler-8.hires.png), [pdf](transpiler-8.pdf))
    >
    > ![../\_images/transpiler-8.png](/images/api/qiskit/0.40/transpiler-8.png)
...
*   **Layout Using Optimization Level 3**
    ...
    > ```
    >
    > ([Source code](transpiler-9.py), [png](transpiler-9.png), [hires.png](transpiler-9.hires.png), [pdf](transpiler-9.pdf))
    >
    > ![../\_images/transpiler-9.png](/images/api/qiskit/0.40/transpiler-9.png)
...
([Source code](transpiler-10.py), [png](transpiler-10.png), [hires.png](transpiler-10.hires.png), [pdf](transpiler-10.pdf))

![../\_images/transpiler-10.png](/images/api/qiskit/0.40/transpiler-10.png)
...
([Source code](transpiler-11.py), [png](transpiler-11.png), [hires.png](transpiler-11.hires.png), [pdf](transpiler-11.pdf))

![../\_images/transpiler-11.png](/images/api/qiskit/0.40/transpiler-11.png)
...
([Source code](transpiler-12.py), [png](transpiler-12.png), [hires.png](transpiler-12.hires.png), [pdf](transpiler-12.pdf))

![../\_images/transpiler-12.png](/images/api/qiskit/0.40/transpiler-12.png)
...
([Source code](transpiler-13.py), [png](transpiler-13.png), [hires.png](transpiler-13.hires.png), [pdf](transpiler-13.pdf))

![../\_images/transpiler-13.png](/images/api/qiskit/0.40/transpiler-13.png)
...
([Source code](transpiler-14.py), [png](transpiler-14.png), [hires.png](transpiler-14.hires.png), [pdf](transpiler-14.pdf))

![../\_images/transpiler-14.png](/images/api/qiskit/0.40/transpiler-14.png)
...
([Source code](transpiler-15.py), [png](transpiler-15.png), [hires.png](transpiler-15.hires.png), [pdf](transpiler-15.pdf))

![../\_images/transpiler-15.png](/images/api/qiskit/0.40/transpiler-15.png)
...
([Source code](transpiler-16.py), [png](transpiler-16.png), [hires.png](transpiler-16.hires.png), [pdf](transpiler-16.pdf))

![../\_images/transpiler-16.png](/images/api/qiskit/0.40/transpiler-16.png)
...
([Source code](transpiler-17.py), [png](transpiler-17.png), [hires.png](transpiler-17.hires.png), [pdf](transpiler-17.pdf))

![../\_images/transpiler-17.png](/images/api/qiskit/0.40/transpiler-17.png)
