---
title: Barrier (v0.40)
description: API reference for qiskit.circuit.library.Barrier in qiskit v0.40
...
<Class id="qiskit.circuit.library.Barrier" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/circuit/barrier.py" signature="Barrier(num_qubits, label=None)" modifiers="class">
