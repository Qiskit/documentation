...
<Function id="qiskit.pulse.builder.phase_offset" name="phase_offset" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/pulse/builder.py" signature="phase_offset(phase, *channels)">
