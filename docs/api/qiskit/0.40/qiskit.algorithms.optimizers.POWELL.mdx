---
title: POWELL (v0.40)
description: API reference for qiskit.algorithms.optimizers.POWELL in qiskit v0.40
...
<Class id="qiskit.algorithms.optimizers.POWELL" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/algorithms/optimizers/powell.py" signature="POWELL(maxiter=None, maxfev=1000, disp=False, xtol=0.0001, tol=None, options=None, **kwargs)" modifiers="class">
