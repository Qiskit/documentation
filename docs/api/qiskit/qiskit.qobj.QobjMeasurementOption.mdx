...
<Class id="qiskit.qobj.QobjMeasurementOption" github="https://github.com/Qiskit/qiskit/tree/stable/1.0/qiskit/qobj/pulse_qobj.py#L28-L70" signature="qiskit.qobj.QobjMeasurementOption(name, params=None)">
