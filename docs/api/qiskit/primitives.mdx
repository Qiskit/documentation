...
|                                                                                                      |                                                                    |
| ---------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------ |
| [`ParameterLike`](qiskit.primitives.ParameterLike "qiskit.primitives.ParameterLike")                 | Represent a union type                                             |
...
| [`ObservableLike`](qiskit.primitives.ObservableLike "qiskit.primitives.ObservableLike")                                                   | Represent a union type                                                                                                                                 |
