...
<Class id="qiskit.transpiler.TransformationPass" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.0/qiskit/transpiler/basepasses.py#L186-L221" signature="qiskit.transpiler.TransformationPass(*args, **kwargs)">
  ...
  <Function id="qiskit.transpiler.TransformationPass.run" github="https://github.com/Qiskit/qiskit/tree/stable/1.0/qiskit/transpiler/basepasses.py#L89-L99" signature="abstract run(dag)">
