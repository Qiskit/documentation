...
<Class id="qiskit.quantum_info.PhasedQubitSparsePauli" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/quantum_info/__init__.py" signature="qiskit.quantum_info.PhasedQubitSparsePauli(data, /, num_qubits=None)" modifiers="class">
  ...
  <Attribute id="qiskit.quantum_info.PhasedQubitSparsePauli.indices" name="indices" headingLevel={3}>
    Read-only view onto the indices of each non-identity single-qubit term.

    The indices will always be in sorted order.
  </Attribute>

  <Attribute id="qiskit.quantum_info.PhasedQubitSparsePauli.num_qubits" name="num_qubits" headingLevel={3}>
    The number of qubits the term is defined on.
  </Attribute>

  <Attribute id="qiskit.quantum_info.PhasedQubitSparsePauli.paulis" name="paulis" headingLevel={3}>
  ...
  <Attribute id="qiskit.quantum_info.PhasedQubitSparsePauli.phase" name="phase" headingLevel={3}>
