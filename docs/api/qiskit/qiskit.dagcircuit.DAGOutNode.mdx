...
<Class id="qiskit.dagcircuit.DAGOutNode" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.0/qiskit/dagcircuit/dagnode.py#L307-L322" signature="qiskit.dagcircuit.DAGOutNode(wire)">
  ...
  <Function id="qiskit.dagcircuit.DAGOutNode.semantic_eq" name="semantic_eq" github="https://github.com/Qiskit/qiskit/tree/stable/1.0/qiskit/dagcircuit/dagnode.py#L190-L247" signature="static semantic_eq(node1, node2, bit_indices1, bit_indices2)">
