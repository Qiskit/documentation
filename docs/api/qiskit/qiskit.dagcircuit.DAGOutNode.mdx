...
<Class id="qiskit.dagcircuit.DAGOutNode" github="https://github.com/Qiskit/qiskit/tree/stable/1.0/qiskit/dagcircuit/dagnode.py#L307-L322" signature="qiskit.dagcircuit.DAGOutNode(wire)">
