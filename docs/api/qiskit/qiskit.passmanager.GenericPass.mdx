...
<Class id="qiskit.passmanager.GenericPass" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.0/qiskit/passmanager/base_tasks.py#L57-L153" signature="qiskit.passmanager.GenericPass">
  ...
  <Function id="qiskit.passmanager.GenericPass.run" github="https://github.com/Qiskit/qiskit/tree/stable/1.0/qiskit/passmanager/base_tasks.py#L140-L153" signature="abstract run(passmanager_ir)">
