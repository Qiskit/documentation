...
<Class id="qiskit.circuit.AnnotatedOperation" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/circuit/annotated_operation.py#L59-L241" signature="qiskit.circuit.AnnotatedOperation(base_op, modifiers)" modifiers="class">
  ...
  *   **modifiers** (*Modifier |* [*list*](https://docs.python.org/3/library/stdtypes.html#list)*\[Modifier]*) – ordered list of modifiers. Supported modifiers include `InverseModifier`, `ControlModifier` and `PowerModifier`.
  ...
  <Attribute id="qiskit.circuit.AnnotatedOperation.name" name="name" headingLevel={3}>
    Unique string identifier for operation type.
  </Attribute>

  <Attribute id="qiskit.circuit.AnnotatedOperation.num_clbits" name="num_clbits" headingLevel={3}>
    Number of classical bits.
  </Attribute>

  <Attribute id="qiskit.circuit.AnnotatedOperation.num_qubits" name="num_qubits" headingLevel={3}>
    Number of qubits.
  </Attribute>

  <Attribute id="qiskit.circuit.AnnotatedOperation.params" name="params" headingLevel={3}>
    The params of the underlying base operation.
  </Attribute>

  <Attribute id="qiskit.circuit.AnnotatedOperation.base_op" name="base_op" headingLevel={3}>
    The base operation that the modifiers in this annotated operation apply to.
  </Attribute>

  <Attribute id="qiskit.circuit.AnnotatedOperation.modifiers" name="modifiers" headingLevel={3}>
  ...
  <Function id="qiskit.circuit.AnnotatedOperation.control" github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/circuit/annotated_operation.py#L158-L185" signature="control(num_ctrl_qubits=1, label=None, ctrl_state=None, annotated=None)">
  ...
  <Function id="qiskit.circuit.AnnotatedOperation.copy" github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/circuit/annotated_operation.py#L133-L135" signature="copy()">
  ...
  <Function id="qiskit.circuit.AnnotatedOperation.inverse" github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/circuit/annotated_operation.py#L187-L202" signature="inverse(annotated=True)">
  ...
  <Function id="qiskit.circuit.AnnotatedOperation.power" github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/circuit/annotated_operation.py#L204-L220" signature="power(exponent, annotated=False)">
  ...
  <Function id="qiskit.circuit.AnnotatedOperation.to_matrix" github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/circuit/annotated_operation.py#L137-L156" signature="to_matrix()">
    Return a matrix representation (allowing to construct Operator).
  </Function>

  ### validate\_parameter

  <Function id="qiskit.circuit.AnnotatedOperation.validate_parameter" github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/circuit/annotated_operation.py#L236-L241" signature="validate_parameter(parameter)">
