...
<Class id="qiskit.circuit.library.MSGate" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.0/qiskit/circuit/library/generalized_gates/gms.py#L96-L121" signature="qiskit.circuit.library.MSGate(num_qubits, theta, label=None)">
