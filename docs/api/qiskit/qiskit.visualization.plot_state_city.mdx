---
title: plot_state_city (latest version)
description: API reference for qiskit.visualization.plot_state_city in the latest version of qiskit
...
<Function id="qiskit.visualization.plot_state_city" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/visualization/state_visualization.py#L377-L629" signature="qiskit.visualization.plot_state_city(state, title='', figsize=None, color=None, alpha=1, ax_real=None, ax_imag=None, *, filename=None)">
  ...
  *   **color** ([*list*](https://docs.python.org/3/library/stdtypes.html#list)) – A list of len=2 giving colors for real and imaginary components of matrix elements.
  *   **alpha** ([*float*](https://docs.python.org/3/library/functions.html#float)) – Transparency value for bars
  ...
  *   [**ValueError**](https://docs.python.org/3/library/exceptions.html#ValueError) – When ‘color’ is not a list of len=2.
  *   [**VisualizationError**](/docs/api/qiskit/visualization#qiskit.visualization.VisualizationError "qiskit.visualization.VisualizationError") – if input is not a valid N-qubit state.
  ...
  **Examples**
  ...
  ![Output from the previous code.](/docs/images/api/qiskit/qiskit-visualization-plot_state_city-1.avif)
  ...
  ![Output from the previous code.](/docs/images/api/qiskit/qiskit-visualization-plot_state_city-2.avif)
</Function>
