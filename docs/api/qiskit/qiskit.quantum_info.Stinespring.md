...
`qiskit.quantum_info.Stinespring(data, input_dims=None, output_dims=None)`
...
**n** ([*float*](https://docs.python.org/3/library/functions.html#float "(in Python v3.11)")) – the power exponent.
