...
$$
  ...
  <Attribute id="qiskit.circuit.library.CSdgGate.base_class" name="base_class">
  ...
  <Attribute id="qiskit.circuit.library.CSdgGate.condition" name="condition">
  ...
  <Attribute id="qiskit.circuit.library.CSdgGate.mutable" name="mutable">
