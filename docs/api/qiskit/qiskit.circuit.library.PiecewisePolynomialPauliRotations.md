...
*   **num\_state\_qubits** (*Optional\[*[*int*](https://docs.python.org/3/library/functions.html#int "(in Python v3.11)")*]*) – The number of qubits representing the state.
*   **breakpoints** (*Optional\[List\[*[*int*](https://docs.python.org/3/library/functions.html#int "(in Python v3.11)")*]]*) – The breakpoints to define the piecewise-linear function. Defaults to `[0]`.
*   **coeffs** (*Optional\[List\[List\[*[*float*](https://docs.python.org/3/library/functions.html#float "(in Python v3.11)")*]]]*) – The coefficients of the polynomials for different segments of the
