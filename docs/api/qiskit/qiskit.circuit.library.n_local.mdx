...
<Class id="qiskit.circuit.library.n_local" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.3/qiskit/circuit/library/n_local/n_local.py#L54-L260" signature="qiskit.circuit.library.n_local(num_qubits, rotation_blocks, entanglement_blocks, entanglement='full', reps=3, insert_barriers=False, parameter_prefix='θ', overwrite_block_parameters=True, skip_final_rotation_layer=False, skip_unentangled_qubits=False, name='nlocal')" modifiers="class">
  ...
  **Examples**
  ...
  ![../\_images/qiskit-circuit-library-n\_local-1.png](/images/api/qiskit/qiskit-circuit-library-n_local-1.png)
  ...
  ![../\_images/qiskit-circuit-library-n\_local-2\_00.png](/images/api/qiskit/qiskit-circuit-library-n_local-2_00.png)

  ![../\_images/qiskit-circuit-library-n\_local-2\_01.png](/images/api/qiskit/qiskit-circuit-library-n_local-2_01.png)
  ...
  ![../\_images/qiskit-circuit-library-n\_local-3\_00.png](/images/api/qiskit/qiskit-circuit-library-n_local-3_00.png)

  ![../\_images/qiskit-circuit-library-n\_local-3\_01.png](/images/api/qiskit/qiskit-circuit-library-n_local-3_01.png)

  ![../\_images/qiskit-circuit-library-n\_local-3\_02.png](/images/api/qiskit/qiskit-circuit-library-n_local-3_02.png)
  ...
  ![../\_images/qiskit-circuit-library-n\_local-4\_00.png](/images/api/qiskit/qiskit-circuit-library-n_local-4_00.png)

  ![../\_images/qiskit-circuit-library-n\_local-4\_01.png](/images/api/qiskit/qiskit-circuit-library-n_local-4_01.png)

  ![../\_images/qiskit-circuit-library-n\_local-4\_02.png](/images/api/qiskit/qiskit-circuit-library-n_local-4_02.png)

  ![../\_images/qiskit-circuit-library-n\_local-4\_03.png](/images/api/qiskit/qiskit-circuit-library-n_local-4_03.png)
