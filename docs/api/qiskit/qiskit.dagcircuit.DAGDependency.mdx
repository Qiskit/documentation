...
<Class id="qiskit.dagcircuit.DAGDependency" github="https://github.com/Qiskit/qiskit/tree/stable/1.0/qiskit/dagcircuit/dagdependency.py#L50-L610" signature="qiskit.dagcircuit.DAGDependency">
