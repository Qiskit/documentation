...
<Class id="qiskit.dagcircuit.DAGDependency" github="https://github.com/qiskit/qiskit/tree/stable/1.0/qiskit/dagcircuit/dagdependency.py" signature="qiskit.dagcircuit.DAGDependency">
