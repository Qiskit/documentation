...
<Class id="qiskit.dagcircuit.DAGDependency" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.0/qiskit/dagcircuit/dagdependency.py#L50-L610" signature="qiskit.dagcircuit.DAGDependency">
  ...
  **Reference:**
  ...
  <Attribute id="qiskit.dagcircuit.DAGDependency.calibrations" name="calibrations">
  ...
  <Attribute id="qiskit.dagcircuit.DAGDependency.global_phase" name="global_phase">
  ...
  <Function id="qiskit.dagcircuit.DAGDependency.add_clbits" name="add_clbits" github="https://github.com/Qiskit/qiskit/tree/stable/1.0/qiskit/dagcircuit/dagdependency.py#L187-L196" signature="add_clbits(clbits)">
    Add individual clbit wires.
  </Function>

  ### add\_creg

  <Function id="qiskit.dagcircuit.DAGDependency.add_creg" name="add_creg" github="https://github.com/Qiskit/qiskit/tree/stable/1.0/qiskit/dagcircuit/dagdependency.py#L210-L220" signature="add_creg(creg)">
    Add clbits in a classical register.
  </Function>

  ### add\_op\_node

  <Function id="qiskit.dagcircuit.DAGDependency.add_op_node" name="add_op_node" github="https://github.com/Qiskit/qiskit/tree/stable/1.0/qiskit/dagcircuit/dagdependency.py#L419-L429" signature="add_op_node(operation, qargs, cargs)">
  ...
  <Function id="qiskit.dagcircuit.DAGDependency.add_qreg" name="add_qreg" github="https://github.com/Qiskit/qiskit/tree/stable/1.0/qiskit/dagcircuit/dagdependency.py#L198-L208" signature="add_qreg(qreg)">
    Add qubits in a quantum register.
  </Function>

  ### add\_qubits

  <Function id="qiskit.dagcircuit.DAGDependency.add_qubits" name="add_qubits" github="https://github.com/Qiskit/qiskit/tree/stable/1.0/qiskit/dagcircuit/dagdependency.py#L176-L185" signature="add_qubits(qubits)">
    Add individual qubit wires.
  </Function>

  ### copy

  <Function id="qiskit.dagcircuit.DAGDependency.copy" name="copy" github="https://github.com/Qiskit/qiskit/tree/stable/1.0/qiskit/dagcircuit/dagdependency.py#L501-L517" signature="copy()">
    Function to copy a DAGDependency object. :returns: a copy of a DAGDependency object. :rtype: DAGDependency
  </Function>

  ### depth

  <Function id="qiskit.dagcircuit.DAGDependency.depth" name="depth" github="https://github.com/Qiskit/qiskit/tree/stable/1.0/qiskit/dagcircuit/dagdependency.py#L168-L174" signature="depth()">
    Return the circuit depth. :returns: the circuit depth :rtype: int
  </Function>

  ### direct\_predecessors

  <Function id="qiskit.dagcircuit.DAGDependency.direct_predecessors" name="direct_predecessors" github="https://github.com/Qiskit/qiskit/tree/stable/1.0/qiskit/dagcircuit/dagdependency.py#L326-L336" signature="direct_predecessors(node_id)">
  ...
  <Function id="qiskit.dagcircuit.DAGDependency.direct_successors" name="direct_successors" github="https://github.com/Qiskit/qiskit/tree/stable/1.0/qiskit/dagcircuit/dagdependency.py#L314-L324" signature="direct_successors(node_id)">
  ...
  <Function id="qiskit.dagcircuit.DAGDependency.draw" name="draw" github="https://github.com/Qiskit/qiskit/tree/stable/1.0/qiskit/dagcircuit/dagdependency.py#L519-L537" signature="draw(scale=0.7, filename=None, style='color')">
  ...
  <Function id="qiskit.dagcircuit.DAGDependency.get_all_edges" name="get_all_edges" github="https://github.com/Qiskit/qiskit/tree/stable/1.0/qiskit/dagcircuit/dagdependency.py#L276-L288" signature="get_all_edges()">
  ...
  <Function id="qiskit.dagcircuit.DAGDependency.get_edges" name="get_edges" github="https://github.com/Qiskit/qiskit/tree/stable/1.0/qiskit/dagcircuit/dagdependency.py#L263-L274" signature="get_edges(src_id, dest_id)">
  ...
  <Function id="qiskit.dagcircuit.DAGDependency.get_in_edges" name="get_in_edges" github="https://github.com/Qiskit/qiskit/tree/stable/1.0/qiskit/dagcircuit/dagdependency.py#L290-L300" signature="get_in_edges(node_id)">
  ...
  <Function id="qiskit.dagcircuit.DAGDependency.get_node" name="get_node" github="https://github.com/Qiskit/qiskit/tree/stable/1.0/qiskit/dagcircuit/dagdependency.py#L241-L249" signature="get_node(node_id)">
    **Parameters**
  ...
  <Function id="qiskit.dagcircuit.DAGDependency.get_nodes" name="get_nodes" github="https://github.com/Qiskit/qiskit/tree/stable/1.0/qiskit/dagcircuit/dagdependency.py#L234-L239" signature="get_nodes()">
    **Returns**
  ...
  <Function id="qiskit.dagcircuit.DAGDependency.get_out_edges" name="get_out_edges" github="https://github.com/Qiskit/qiskit/tree/stable/1.0/qiskit/dagcircuit/dagdependency.py#L302-L312" signature="get_out_edges(node_id)">
  ...
  <Function id="qiskit.dagcircuit.DAGDependency.predecessors" name="predecessors" github="https://github.com/Qiskit/qiskit/tree/stable/1.0/qiskit/dagcircuit/dagdependency.py#L350-L360" signature="predecessors(node_id)">
  ...
  <Function id="qiskit.dagcircuit.DAGDependency.replace_block_with_op" name="replace_block_with_op" github="https://github.com/Qiskit/qiskit/tree/stable/1.0/qiskit/dagcircuit/dagdependency.py#L539-L610" signature="replace_block_with_op(node_block, op, wire_pos_map, cycle_check=True)">
  ...
  <Function id="qiskit.dagcircuit.DAGDependency.size" name="size" github="https://github.com/Qiskit/qiskit/tree/stable/1.0/qiskit/dagcircuit/dagdependency.py#L164-L166" signature="size()">
    Returns the number of gates in the circuit
  </Function>

  ### successors

  <Function id="qiskit.dagcircuit.DAGDependency.successors" name="successors" github="https://github.com/Qiskit/qiskit/tree/stable/1.0/qiskit/dagcircuit/dagdependency.py#L338-L348" signature="successors(node_id)">
  ...
  <Function id="qiskit.dagcircuit.DAGDependency.to_retworkx" name="to_retworkx" github="https://github.com/Qiskit/qiskit/tree/stable/1.0/qiskit/dagcircuit/dagdependency.py#L160-L162" signature="to_retworkx()">
    Returns the DAGDependency in retworkx format.
  </Function>

  ### topological\_nodes

  <Function id="qiskit.dagcircuit.DAGDependency.topological_nodes" name="topological_nodes" github="https://github.com/Qiskit/qiskit/tree/stable/1.0/qiskit/dagcircuit/dagdependency.py#L362-L373" signature="topological_nodes()">
