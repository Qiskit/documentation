...
<Class id="qiskit.dagcircuit.BlockCollector" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/2.4/qiskit/dagcircuit/collect_blocks.py#L29-L254" signature="qiskit.dagcircuit.BlockCollector(dag)" modifiers="class">
  ...
  **Raises**
  ...
  <Function id="qiskit.dagcircuit.BlockCollector.collect_all_matching_blocks" github="https://github.com/Qiskit/qiskit/tree/stable/2.4/qiskit/dagcircuit/collect_blocks.py#L184-L254" signature="collect_all_matching_blocks(filter_fn, split_blocks=True, min_block_size=2, split_layers=False, collect_from_back=False, max_block_width=None)">
  ...
  <Function id="qiskit.dagcircuit.BlockCollector.collect_matching_block" github="https://github.com/Qiskit/qiskit/tree/stable/2.4/qiskit/dagcircuit/collect_blocks.py#L137-L182" signature="collect_matching_block(filter_fn, max_block_width)">
