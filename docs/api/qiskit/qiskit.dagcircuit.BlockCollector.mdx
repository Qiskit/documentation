...
<Class id="qiskit.dagcircuit.BlockCollector" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/2.3/qiskit/dagcircuit/collect_blocks.py#L29-L260" signature="qiskit.dagcircuit.BlockCollector(dag)" modifiers="class">
  ...
  **Raises**
  ...
  <Function id="qiskit.dagcircuit.BlockCollector.collect_matching_block" github="https://github.com/Qiskit/qiskit/tree/stable/2.3/qiskit/dagcircuit/collect_blocks.py#L143-L188" signature="collect_matching_block(filter_fn, max_block_width)">
    ...
    *   **filter\_fn** ([*Callable*](https://docs.python.org/3/library/collections.abc.html#collections.abc.Callable "(in Python v3.14)")) –
    *   **max\_block\_width** ([*int*](https://docs.python.org/3/library/functions.html#int "(in Python v3.14)") *| None*) –

    **Return type**

    [list](https://docs.python.org/3/library/stdtypes.html#list "(in Python v3.14)")\[[qiskit.\_accelerate.circuit.DAGOpNode](qiskit.dagcircuit.DAGOpNode "qiskit._accelerate.circuit.DAGOpNode") | [qiskit.dagcircuit.dagdepnode.DAGDepNode](qiskit.dagcircuit.DAGDepNode "qiskit.dagcircuit.dagdepnode.DAGDepNode")]
  </Function>
</Class>
