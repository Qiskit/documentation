---
title: BlockCollector (latest version)
description: API reference for qiskit.dagcircuit.BlockCollector in the latest version of qiskit
...
<Class id="qiskit.dagcircuit.BlockCollector" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/dagcircuit/collect_blocks.py#L29-L254" signature="qiskit.dagcircuit.BlockCollector(dag)" modifiers="class">
  Bases: [`object`](https://docs.python.org/3/library/functions.html#object)

  This class implements various strategies of dividing a DAG (directed acyclic graph) into blocks of nodes that satisfy certain criteria. It works both with the [`DAGCircuit`](qiskit.dagcircuit.DAGCircuit "qiskit.dagcircuit.DAGCircuit") and [`DAGDependency`](qiskit.dagcircuit.DAGDependency "qiskit.dagcircuit.DAGDependency") representations of a DAG, where the latter takes into account commutativity between nodes.
  ...
  **Raises**
  ...
  [**DAGCircuitError**](/docs/api/qiskit/dagcircuit#qiskit.dagcircuit.DAGCircuitError "qiskit.dagcircuit.DAGCircuitError") – the input object is not a DAG.

  ## Methods

  ### collect\_all\_matching\_blocks

  <Function id="qiskit.dagcircuit.BlockCollector.collect_all_matching_blocks" github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/dagcircuit/collect_blocks.py#L184-L254" signature="collect_all_matching_blocks(filter_fn, split_blocks=True, min_block_size=2, split_layers=False, collect_from_back=False, max_block_width=None)">
  ...
  <Function id="qiskit.dagcircuit.BlockCollector.collect_matching_block" github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/dagcircuit/collect_blocks.py#L137-L182" signature="collect_matching_block(filter_fn, max_block_width)">
    ...
    *   **filter\_fn** ([*Callable*](https://docs.python.org/3/library/collections.abc.html#collections.abc.Callable))
    *   **max\_block\_width** ([*int*](https://docs.python.org/3/library/functions.html#int) *| None*)

    **Return type**

    [list](https://docs.python.org/3/library/stdtypes.html#list)\[[*DAGOpNode*](qiskit.dagcircuit.DAGOpNode "qiskit._accelerate.circuit.DAGOpNode") | [*DAGDepNode*](qiskit.dagcircuit.DAGDepNode "qiskit.dagcircuit.dagdepnode.DAGDepNode")]
  </Function>
</Class>
