...
<Function id="qiskit.capi.get_include" github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/capi/__init__.py#L101-L119" signature="qiskit.capi.get_include()">
...
<Function id="qiskit.capi.get_lib" github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/capi/__init__.py#L122-L140" signature="qiskit.capi.get_lib()">
...
<Attribute id="qiskit.capi.LIB" name="qiskit.capi.LIB" headingLevel={3}>
  <AttributeTypeHint>[ctypes.PyDLL](https://docs.python.org/3/library/ctypes.html#ctypes.PyDLL)</AttributeTypeHint>
