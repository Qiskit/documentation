...
<Class id="qiskit.providers.QubitProperties" github="https://github.com/Qiskit/qiskit/tree/stable/1.0/qiskit/providers/backend.py#L245-L270" signature="qiskit.providers.QubitProperties(t1=None, t2=None, frequency=None)">
