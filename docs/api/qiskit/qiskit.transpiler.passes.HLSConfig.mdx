...
<Class id="qiskit.transpiler.passes.HLSConfig" github="https://github.com/qiskit/qiskit/tree/stable/1.0/qiskit/transpiler/passes/synthesis/high_level_synthesis.py" signature="qiskit.transpiler.passes.HLSConfig(use_default_on_unspecified=True, **kwargs)">
  ...
  *   **kwargs** – a dictionary mapping higher-level-objects to lists of synthesis methods.
  ...
  <Function id="qiskit.transpiler.passes.HLSConfig.set_methods" name="set_methods" signature="set_methods(hls_name, hls_methods)">
