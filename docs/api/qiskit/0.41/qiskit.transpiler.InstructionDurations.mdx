...
<Class id="qiskit.transpiler.InstructionDurations" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/transpiler/instruction_durations.py" signature="InstructionDurations(instruction_durations=None, dt=None)">
  Bases: `object`
  ...
  <Function id="qiskit.transpiler.InstructionDurations.from_backend" name="from_backend" signature="classmethod InstructionDurations.from_backend(backend)">
  ...
  <Function id="qiskit.transpiler.InstructionDurations.get" name="get" signature="InstructionDurations.get(inst, qubits, unit='dt', parameters=None)">
  ...
  <Function id="qiskit.transpiler.InstructionDurations.units_used" name="units_used" signature="InstructionDurations.units_used()">
  ...
  <Function id="qiskit.transpiler.InstructionDurations.update" name="update" signature="InstructionDurations.update(inst_durations, dt=None)">
