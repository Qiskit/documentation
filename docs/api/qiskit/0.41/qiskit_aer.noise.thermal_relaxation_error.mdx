---
title: thermal_relaxation_error (v0.41)
description: API reference for qiskit_aer.noise.thermal_relaxation_error in qiskit v0.41
in_page_toc_min_heading_level: 1
python_api_type: function
python_api_name: qiskit_aer.noise.thermal_relaxation_error
---

<span id="qiskit-aer-noise-thermal-relaxation-error" />

# qiskit\_aer.noise.thermal\_relaxation\_error

<Function id="qiskit_aer.noise.thermal_relaxation_error" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-aer/tree/stable/0.11/qiskit_aer/noise/errors/standard_errors.py" signature="thermal_relaxation_error(t1, t2, time, excited_state_population=0)">
