---
title: GR (v0.41)
description: API reference for qiskit.circuit.library.GR in qiskit v0.41
...
<Class id="qiskit.circuit.library.GR" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/circuit/library/generalized_gates/gr.py" signature="GR(num_qubits, theta, phi)" modifiers="class">
...
$$
  ...
  **Expanded Circuit:**
  ...
  ![../\_images/qiskit-circuit-library-GR-1.png](/docs/images/api/qiskit/0.41/qiskit-circuit-library-GR-1.avif)
  ...
  *   **phi** (`float`) – angle of rotation axis in xy-plane
  ...
  <Attribute id="qiskit.circuit.library.GR.instances" attributeValue="2062" />
