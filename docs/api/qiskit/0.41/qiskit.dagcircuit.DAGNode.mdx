---
title: DAGNode (v0.41)
description: API reference for qiskit.dagcircuit.DAGNode in qiskit v0.41
...
<Class id="qiskit.dagcircuit.DAGNode" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/dagcircuit/dagnode.py" signature="DAGNode(nid=- 1)" modifiers="class">
  Bases: `object`
