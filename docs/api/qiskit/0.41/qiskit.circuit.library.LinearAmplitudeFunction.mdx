---
title: LinearAmplitudeFunction (v0.41)
description: API reference for qiskit.circuit.library.LinearAmplitudeFunction in qiskit v0.41
...
$$
  ...
  *   **name** (`str`) – Name of the circuit.
  ...
  <Attribute id="qiskit.circuit.library.LinearAmplitudeFunction.instances" attributeValue="2108" />
