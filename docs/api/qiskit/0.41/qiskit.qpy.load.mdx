---
title: load (v0.41)
description: API reference for qiskit.qpy.load in qiskit v0.41
...
<Function id="qiskit.qpy.load" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/qpy/interface.py" signature="load(file_obj, metadata_deserializer=None)">
