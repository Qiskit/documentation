---
title: Suzuki (v0.41)
description: API reference for qiskit.opflow.evolutions.Suzuki in qiskit v0.41
...
<Class id="qiskit.opflow.evolutions.Suzuki" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/opflow/evolutions/trotterizations/suzuki.py" signature="Suzuki(reps=1, order=2)" modifiers="class">
