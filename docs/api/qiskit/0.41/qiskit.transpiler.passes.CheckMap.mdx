---
title: CheckMap (v0.41)
description: API reference for qiskit.transpiler.passes.CheckMap in qiskit v0.41
...
<Class id="qiskit.transpiler.passes.CheckMap" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/transpiler/passes/utils/check_map.py" signature="CheckMap(*args, **kwargs)" modifiers="class">
