---
title: RC3XGate (v0.41)
description: API reference for qiskit.circuit.library.RC3XGate in qiskit v0.41
...
<Class id="qiskit.circuit.library.RC3XGate" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/circuit/library/standard_gates/x.py" signature="RC3XGate(label=None)" modifiers="class">
