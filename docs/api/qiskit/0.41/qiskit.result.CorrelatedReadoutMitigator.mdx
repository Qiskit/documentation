...
<Class id="qiskit.result.CorrelatedReadoutMitigator" github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/result/mitigation/correlated_readout_mitigator.py" signature="CorrelatedReadoutMitigator(assignment_matrix, qubits=None)">
