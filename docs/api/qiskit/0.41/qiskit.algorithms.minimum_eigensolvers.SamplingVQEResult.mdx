---
title: SamplingVQEResult (v0.41)
description: API reference for qiskit.algorithms.minimum_eigensolvers.SamplingVQEResult in qiskit v0.41
...
<Class id="qiskit.algorithms.minimum_eigensolvers.SamplingVQEResult" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/algorithms/minimum_eigensolvers/sampling_vqe.py" signature="SamplingVQEResult" modifiers="class">
