---
title: ExcitationPreserving (v0.41)
description: API reference for qiskit.circuit.library.ExcitationPreserving in qiskit v0.41
...
$$
  ...
  **ValueError** – If the selected mode is not supported.
  ...
  <Attribute id="qiskit.circuit.library.ExcitationPreserving.instances" attributeValue="2048" />
