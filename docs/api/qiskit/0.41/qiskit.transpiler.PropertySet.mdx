---
title: PropertySet (v0.41)
description: API reference for qiskit.transpiler.PropertySet in qiskit v0.41
...
<Class id="qiskit.transpiler.PropertySet" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/transpiler/propertyset.py" signature="PropertySet" modifiers="class">
  Bases: `dict`
