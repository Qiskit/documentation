---
title: Decompose (v0.41)
description: API reference for qiskit.transpiler.passes.Decompose in qiskit v0.41
...
<Class id="qiskit.transpiler.passes.Decompose" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/transpiler/passes/basis/decompose.py" signature="Decompose(gates_to_decompose=None)" modifiers="class">
