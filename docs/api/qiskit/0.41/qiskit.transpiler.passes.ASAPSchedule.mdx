---
title: ASAPSchedule (v0.41)
description: API reference for qiskit.transpiler.passes.ASAPSchedule in qiskit v0.41
...
<Class id="qiskit.transpiler.passes.ASAPSchedule" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/transpiler/passes/scheduling/asap.py" signature="ASAPSchedule(*args, **kwargs)" modifiers="class">
