...
<Class id="qiskit.pulse.library.ParametricPulse" github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/pulse/library/parametric_pulses.py" signature="ParametricPulse(duration, name=None, limit_amplitude=None)">
  ...
  *   **limit\_amplitude** (`Optional`\[`bool`]) – If `True`, then limit the amplitude of the waveform to 1. The default is `True` and the amplitude is constrained to 1.
  ...
  <Function id="qiskit.pulse.library.ParametricPulse.get_waveform" signature="abstract ParametricPulse.get_waveform()">
  ...
  <Function id="qiskit.pulse.library.ParametricPulse.validate_parameters" signature="abstract ParametricPulse.validate_parameters()">
    Validate parameters.
