...
<Class id="qiskit.pulse.library.ParametricPulse" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/pulse/library/parametric_pulses.py" signature="ParametricPulse(duration, name=None, limit_amplitude=None)">
  ...
  *   **limit\_amplitude** (`Optional`\[`bool`]) – If `True`, then limit the amplitude of the waveform to 1. The default is `True` and the amplitude is constrained to 1.
  ...
  <Function id="qiskit.pulse.library.ParametricPulse.draw" name="draw" signature="ParametricPulse.draw(style=None, backend=None, time_range=None, time_unit='dt', show_waveform_info=True, plotter='mpl2d', axis=None)">
  ...
  <Function id="qiskit.pulse.library.ParametricPulse.get_waveform" name="get_waveform" signature="abstract ParametricPulse.get_waveform()">
  ...
  <Function id="qiskit.pulse.library.ParametricPulse.is_parameterized" name="is_parameterized" signature="ParametricPulse.is_parameterized()">
  ...
  <Function id="qiskit.pulse.library.ParametricPulse.validate_parameters" name="validate_parameters" signature="abstract ParametricPulse.validate_parameters()">
    Validate parameters.
  ...
  <Attribute id="qiskit.pulse.library.ParametricPulse.duration" name="duration" />

  ### name

  <Attribute id="qiskit.pulse.library.ParametricPulse.name" name="name" />

  ### id

  <Attribute id="qiskit.pulse.library.ParametricPulse.id" name="id">
  ...
  <Attribute id="qiskit.pulse.library.ParametricPulse.limit_amplitude" name="limit_amplitude" attributeValue="= True" />

  ### parameters

  <Attribute id="qiskit.pulse.library.ParametricPulse.parameters" name="parameters">
