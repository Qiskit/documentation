---
title: ParametricPulse (v0.41)
description: API reference for qiskit.pulse.library.ParametricPulse in qiskit v0.41
...
<Class id="qiskit.pulse.library.ParametricPulse" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/pulse/library/parametric_pulses.py" signature="ParametricPulse(duration, name=None, limit_amplitude=None)" modifiers="class">
