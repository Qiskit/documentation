---
title: basic_device_readout_errors (v0.41)
description: API reference for qiskit_aer.noise.device.basic_device_readout_errors in qiskit v0.41
in_page_toc_min_heading_level: 1
python_api_type: function
python_api_name: qiskit_aer.noise.device.basic_device_readout_errors
---

<span id="qiskit-aer-noise-device-basic-device-readout-errors" />

# qiskit\_aer.noise.device.basic\_device\_readout\_errors

<Function id="qiskit_aer.noise.device.basic_device_readout_errors" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-aer/tree/stable/0.11/qiskit_aer/noise/device/models.py" signature="basic_device_readout_errors(properties=None, target=None)">
