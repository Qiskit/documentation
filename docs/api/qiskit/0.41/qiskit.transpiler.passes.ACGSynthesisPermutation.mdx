...
<Class id="qiskit.transpiler.passes.ACGSynthesisPermutation" github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/transpiler/passes/synthesis/high_level_synthesis.py" signature="ACGSynthesisPermutation">
  ...
  <Function id="qiskit.transpiler.passes.ACGSynthesisPermutation.run" name="run" signature="ACGSynthesisPermutation.run(high_level_object, **options)">
