---
title: save_state (v0.41)
description: API reference for qiskit_aer.library.save_state in qiskit v0.41
in_page_toc_min_heading_level: 1
python_api_type: function
python_api_name: qiskit_aer.library.save_state
---

<span id="qiskit-aer-library-save-state" />

# qiskit\_aer.library.save\_state

<Function id="qiskit_aer.library.save_state" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-aer/tree/stable/0.11/qiskit_aer/library/save_instructions/save_state.py" signature="save_state(self, label=None, pershot=False, conditional=False)">
