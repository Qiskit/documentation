---
title: save_probabilities_dict (v0.41)
description: API reference for qiskit_aer.library.save_probabilities_dict in qiskit v0.41
in_page_toc_min_heading_level: 1
python_api_type: function
python_api_name: qiskit_aer.library.save_probabilities_dict
---

<span id="qiskit-aer-library-save-probabilities-dict" />

# qiskit\_aer.library.save\_probabilities\_dict

<Function id="qiskit_aer.library.save_probabilities_dict" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-aer/tree/stable/0.11/qiskit_aer/library/save_instructions/save_probabilities.py" signature="save_probabilities_dict(self, qubits=None, label='probabilities', unnormalized=False, pershot=False, conditional=False)">
