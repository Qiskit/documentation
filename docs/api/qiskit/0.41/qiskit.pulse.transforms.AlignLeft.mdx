---
title: AlignLeft (v0.41)
description: API reference for qiskit.pulse.transforms.AlignLeft in qiskit v0.41
...
<Class id="qiskit.pulse.transforms.AlignLeft" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/pulse/transforms/alignments.py" signature="AlignLeft" modifiers="class">
