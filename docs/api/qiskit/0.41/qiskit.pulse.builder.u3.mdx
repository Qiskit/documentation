...
<Function id="qiskit.pulse.builder.u3" name="u3" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/pulse/builder.py" signature="u3(theta, phi, lam, qubit)">
