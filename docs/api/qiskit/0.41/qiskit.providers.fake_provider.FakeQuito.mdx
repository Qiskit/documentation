...
<Class id="qiskit.providers.fake_provider.FakeQuito" github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/providers/fake_provider/backends/quito/fake_quito.py" signature="FakeQuito">
