---
title: WeightedAdder (v0.41)
description: API reference for qiskit.circuit.library.WeightedAdder in qiskit v0.41
...
$$
  ...
  *   **name** (`str`) – The name of the circuit.
  ...
  <Attribute id="qiskit.circuit.library.WeightedAdder.instances" attributeValue="2477" />
