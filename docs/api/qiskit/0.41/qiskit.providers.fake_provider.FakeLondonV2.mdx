...
<Class id="qiskit.providers.fake_provider.FakeLondonV2" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/providers/fake_provider/backends/london/fake_london.py" signature="FakeLondonV2">
