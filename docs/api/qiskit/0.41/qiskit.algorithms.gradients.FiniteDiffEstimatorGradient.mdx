---
title: FiniteDiffEstimatorGradient (v0.41)
description: API reference for qiskit.algorithms.gradients.FiniteDiffEstimatorGradient in qiskit v0.41
...
<Class id="qiskit.algorithms.gradients.FiniteDiffEstimatorGradient" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/algorithms/gradients/finite_diff_estimator_gradient.py" signature="FiniteDiffEstimatorGradient(estimator, epsilon, options=None, *, method='central')" modifiers="class">
