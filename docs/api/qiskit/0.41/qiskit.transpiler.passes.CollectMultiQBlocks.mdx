...
<Class id="qiskit.transpiler.passes.CollectMultiQBlocks" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/transpiler/passes/optimization/collect_multiqubit_blocks.py" signature="CollectMultiQBlocks(*args, **kwargs)">
  ...
  <Function id="qiskit.transpiler.passes.CollectMultiQBlocks.find_set" name="find_set" signature="CollectMultiQBlocks.find_set(index)">
  ...
  <Function id="qiskit.transpiler.passes.CollectMultiQBlocks.name" name="name" signature="CollectMultiQBlocks.name()">
    Return the name of the pass.
  </Function>

  ### run

  <Function id="qiskit.transpiler.passes.CollectMultiQBlocks.run" name="run" signature="CollectMultiQBlocks.run(dag)">
  ...
  <Function id="qiskit.transpiler.passes.CollectMultiQBlocks.union_set" name="union_set" signature="CollectMultiQBlocks.union_set(set1, set2)">
