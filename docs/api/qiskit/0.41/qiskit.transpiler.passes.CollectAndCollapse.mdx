...
<Class id="qiskit.transpiler.passes.CollectAndCollapse" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/transpiler/passes/optimization/collect_and_collapse.py" signature="CollectAndCollapse(*args, **kwargs)">
  ...
  *   **do\_commutative\_analysis** (*bool*) – if True, exploits commutativity relations between nodes.
  ...
  <Function id="qiskit.transpiler.passes.CollectAndCollapse.name" name="name" signature="CollectAndCollapse.name()">
    Return the name of the pass.
  </Function>

  ### run

  <Function id="qiskit.transpiler.passes.CollectAndCollapse.run" name="run" signature="CollectAndCollapse.run(dag)">
  ...
  <Attribute id="qiskit.transpiler.passes.CollectAndCollapse.is_analysis_pass" name="is_analysis_pass">
  ...
  <Attribute id="qiskit.transpiler.passes.CollectAndCollapse.is_transformation_pass" name="is_transformation_pass">
