...
<Class id="qiskit.transpiler.passes.CollectAndCollapse" github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/transpiler/passes/optimization/collect_and_collapse.py" signature="CollectAndCollapse(*args, **kwargs)">
