...
<Class id="qiskit.opflow.evolutions.Trotter" github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/opflow/evolutions/trotterizations/trotter.py" signature="Trotter(reps=1)">
