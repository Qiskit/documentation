---
title: FakeMumbaiFractionalCX (v0.41)
description: API reference for qiskit.providers.fake_provider.FakeMumbaiFractionalCX in qiskit v0.41
...
<Class id="qiskit.providers.fake_provider.FakeMumbaiFractionalCX" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/providers/fake_provider/fake_mumbai_v2.py" signature="FakeMumbaiFractionalCX" modifiers="class">
