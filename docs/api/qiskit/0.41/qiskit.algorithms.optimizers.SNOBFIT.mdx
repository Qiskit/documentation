...
<Class id="qiskit.algorithms.optimizers.SNOBFIT" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/algorithms/optimizers/snobfit.py" signature="SNOBFIT(maxiter=1000, maxfail=10, maxmp=None, verbose=False)">
  ...
  *   **QiskitError** – If NumPy 1.24.0 or above is installed. See [https://github.com/scikit-quant/scikit-quant/issues/24](https://github.com/scikit-quant/scikit-quant/issues/24) for more details.
  ...
  <Function id="qiskit.algorithms.optimizers.SNOBFIT.gradient_num_diff" signature="static SNOBFIT.gradient_num_diff(x_center, f, epsilon, max_evals_grouped=None)">
