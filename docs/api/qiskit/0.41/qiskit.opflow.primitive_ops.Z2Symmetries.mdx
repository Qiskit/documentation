---
title: Z2Symmetries (v0.41)
description: API reference for qiskit.opflow.primitive_ops.Z2Symmetries in qiskit v0.41
...
<Class id="qiskit.opflow.primitive_ops.Z2Symmetries" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/opflow/primitive_ops/tapered_pauli_sum_op.py" signature="Z2Symmetries(symmetries, sq_paulis, sq_list, tapering_values=None, tol=1e-14)" modifiers="class">
  Bases: `object`
