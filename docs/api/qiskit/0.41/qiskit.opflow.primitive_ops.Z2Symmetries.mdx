...
<Class id="qiskit.opflow.primitive_ops.Z2Symmetries" github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/opflow/primitive_ops/tapered_pauli_sum_op.py" signature="Z2Symmetries(symmetries, sq_paulis, sq_list, tapering_values=None, tol=1e-14)">
  Bases: `object`
  ...
  **Raises**
  ...
  <Function id="qiskit.opflow.primitive_ops.Z2Symmetries.find_Z2_symmetries" signature="classmethod Z2Symmetries.find_Z2_symmetries(operator)">
