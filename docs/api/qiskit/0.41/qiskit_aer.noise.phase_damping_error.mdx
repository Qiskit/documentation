---
title: phase_damping_error (v0.41)
description: API reference for qiskit_aer.noise.phase_damping_error in qiskit v0.41
...
<Function id="qiskit_aer.noise.phase_damping_error" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-aer/tree/stable/0.11/qiskit_aer/noise/errors/standard_errors.py" signature="phase_damping_error(param_phase, canonical_kraus=True)">
