...
<Class id="qiskit.transpiler.passes.SolovayKitaev" github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/transpiler/passes/synthesis/solovay_kitaev_synthesis.py" signature="SolovayKitaev(*args, **kwargs)">
