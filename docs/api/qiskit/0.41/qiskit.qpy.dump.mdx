...
<Function id="qiskit.qpy.dump" github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/qpy/interface.py" signature="dump(programs, file_obj, metadata_serializer=None)">
