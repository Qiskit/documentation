...
<Function id="qiskit.synthesis.synth_cnot_count_full_pmh" name="synth_cnot_count_full_pmh" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/synthesis/linear/graysynth.py" signature="synth_cnot_count_full_pmh(state, section_size=2)">
