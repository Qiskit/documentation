---
title: triangle (v0.41)
description: API reference for qiskit.pulse.library.triangle in qiskit v0.41
...
$$
  ...
  **Example**
  ...
  ![../\_images/qiskit-pulse-library-triangle-1.png](/docs/images/api/qiskit/0.41/qiskit-pulse-library-triangle-1.avif)
