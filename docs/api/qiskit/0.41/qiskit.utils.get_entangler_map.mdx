---
title: get_entangler_map (v0.41)
description: API reference for qiskit.utils.get_entangler_map in qiskit v0.41
...
<Function id="qiskit.utils.get_entangler_map" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/utils/entangler_map.py" signature="get_entangler_map(map_type, num_qubits, offset=0)">
