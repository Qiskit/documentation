---
title: AmplitudeEstimation (v0.41)
description: API reference for qiskit.algorithms.AmplitudeEstimation in qiskit v0.41
...
<Class id="qiskit.algorithms.AmplitudeEstimation" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/algorithms/amplitude_estimators/ae.py" signature="AmplitudeEstimation(num_eval_qubits, phase_estimation_circuit=None, iqft=None, quantum_instance=None, sampler=None)" modifiers="class">
