---
title: AND (v0.41)
description: API reference for qiskit.circuit.library.AND in qiskit v0.41
...
<Class id="qiskit.circuit.library.AND" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/circuit/library/boolean_logic/quantum_and.py" signature="AND(num_variable_qubits, flags=None, mcx_mode='noancilla')" modifiers="class">
  ...
  ![../\_images/qiskit-circuit-library-AND-1.png](/docs/images/api/qiskit/0.41/qiskit-circuit-library-AND-1.avif)
  ...
  ![../\_images/qiskit-circuit-library-AND-2.png](/docs/images/api/qiskit/0.41/qiskit-circuit-library-AND-2.avif)
  ...
  *   **mcx\_mode** (`str`) – The mode to be used to implement the multi-controlled X gate.
  ...
  <Attribute id="qiskit.circuit.library.AND.instances" attributeValue="2043" />
