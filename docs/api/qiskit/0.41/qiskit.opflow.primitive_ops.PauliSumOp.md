...
`classmethod PauliSumOp.from_list(pauli_list, coeff=1.0, dtype=<class 'complex'>)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/opflow/primitive_ops/pauli_sum_op.py "view source code")
