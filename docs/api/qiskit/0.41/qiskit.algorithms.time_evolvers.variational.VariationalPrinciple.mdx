...
<Class id="qiskit.algorithms.time_evolvers.variational.VariationalPrinciple" github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/algorithms/time_evolvers/variational/variational_principles/variational_principle.py" signature="VariationalPrinciple(qgt, gradient)">
  Bases: `abc.ABC`
