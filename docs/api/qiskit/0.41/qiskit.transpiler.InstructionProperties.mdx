...
<Class id="qiskit.transpiler.InstructionProperties" github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/transpiler/target.py" signature="InstructionProperties(duration=None, error=None, calibration=None)">
  Bases: `object`
