---
title: CNOTUnitCircuit (v0.41)
description: API reference for qiskit.transpiler.synthesis.aqc.CNOTUnitCircuit in qiskit v0.41
...
<Class id="qiskit.transpiler.synthesis.aqc.CNOTUnitCircuit" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/transpiler/synthesis/aqc/cnot_unit_circuit.py" signature="CNOTUnitCircuit(num_qubits, cnots, tol=0.0, name=None)" modifiers="class">
  ...
  **ValueError** – if an unsupported parameter is passed.
  ...
  <Attribute id="qiskit.transpiler.synthesis.aqc.CNOTUnitCircuit.instances" attributeValue="2494" />
