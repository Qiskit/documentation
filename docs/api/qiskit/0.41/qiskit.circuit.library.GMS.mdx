---
title: GMS (v0.41)
description: API reference for qiskit.circuit.library.GMS in qiskit v0.41
...
<Class id="qiskit.circuit.library.GMS" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/circuit/library/generalized_gates/gms.py" signature="GMS(num_qubits, theta)" modifiers="class">
  ...
  **Expanded Circuit:**
  ...
  ![../\_images/qiskit-circuit-library-GMS-1.png](/docs/images/api/qiskit/0.41/qiskit-circuit-library-GMS-1.avif)
...
$$
  ...
  *   **theta** (`Union`\[`List`\[`List`\[`float`]], `ndarray`]) – a num\_qubits x num\_qubits symmetric matrix of interaction angles for each qubit pair. The upper triangle is considered.
  ...
  <Attribute id="qiskit.circuit.library.GMS.instances" attributeValue="2053" />
