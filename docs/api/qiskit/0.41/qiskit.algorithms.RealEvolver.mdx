...
<Class id="qiskit.algorithms.RealEvolver" github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/algorithms/evolvers/real_evolver.py" signature="RealEvolver">
  Bases: `abc.ABC`
