...
<Class id="qiskit.dagcircuit.DAGOpNode" github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/dagcircuit/dagnode.py" signature="DAGOpNode(op, qargs=(), cargs=())">
