---
title: remap_noise_model (v0.41)
description: API reference for qiskit_aer.utils.remap_noise_model in qiskit v0.41
in_page_toc_min_heading_level: 1
python_api_type: function
python_api_name: qiskit_aer.utils.remap_noise_model
---

<span id="qiskit-aer-utils-remap-noise-model" />
