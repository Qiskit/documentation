---
title: basic_device_gate_errors (v0.41)
description: API reference for qiskit_aer.noise.device.basic_device_gate_errors in qiskit v0.41
in_page_toc_min_heading_level: 1
python_api_type: function
python_api_name: qiskit_aer.noise.device.basic_device_gate_errors
---

<span id="qiskit-aer-noise-device-basic-device-gate-errors" />

# qiskit\_aer.noise.device.basic\_device\_gate\_errors

<Function id="qiskit_aer.noise.device.basic_device_gate_errors" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-aer/tree/stable/0.11/qiskit_aer/noise/device/models.py" signature="basic_device_gate_errors(properties=None, gate_error=True, thermal_relaxation=True, gate_lengths=None, gate_length_units='ns', temperature=0, standard_gates=None, warnings=None, target=None)">
