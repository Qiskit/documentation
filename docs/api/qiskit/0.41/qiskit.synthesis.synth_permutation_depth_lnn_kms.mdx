...
<Function id="qiskit.synthesis.synth_permutation_depth_lnn_kms" name="synth_permutation_depth_lnn_kms" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/synthesis/permutation/permutation_lnn.py" signature="synth_permutation_depth_lnn_kms(pattern)">
