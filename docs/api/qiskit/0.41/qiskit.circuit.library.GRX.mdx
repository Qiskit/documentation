---
title: GRX (v0.41)
description: API reference for qiskit.circuit.library.GRX in qiskit v0.41
...
$$
  ...
  **Expanded Circuit:**
  ...
  ![../\_images/qiskit-circuit-library-GRX-1.png](/docs/images/api/qiskit/0.41/qiskit-circuit-library-GRX-1.avif)
  ...
  *   **theta** (`float`) – rotation angle about x-axis
  ...
  <Attribute id="qiskit.circuit.library.GRX.instances" attributeValue="2063" />
