---
title: unitary_synthesis_plugin_names (v0.41)
description: API reference for qiskit.transpiler.passes.synthesis.plugin.unitary_synthesis_plugin_names in qiskit v0.41
...
<Function id="qiskit.transpiler.passes.synthesis.plugin.unitary_synthesis_plugin_names" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/transpiler/passes/synthesis/plugin.py" signature="unitary_synthesis_plugin_names()">
