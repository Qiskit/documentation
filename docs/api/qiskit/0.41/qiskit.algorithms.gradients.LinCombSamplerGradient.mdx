...
<Class id="qiskit.algorithms.gradients.LinCombSamplerGradient" github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/algorithms/gradients/lin_comb_sampler_gradient.py" signature="LinCombSamplerGradient(sampler, options=None)">
