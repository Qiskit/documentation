---
title: HamiltonianPhaseEstimation (v0.41)
description: API reference for qiskit.algorithms.HamiltonianPhaseEstimation in qiskit v0.41
...
<Class id="qiskit.algorithms.HamiltonianPhaseEstimation" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/algorithms/phase_estimators/hamiltonian_phase_estimation.py" signature="HamiltonianPhaseEstimation(num_evaluation_qubits, quantum_instance=None, sampler=None)" modifiers="class">
  Bases: `object`
