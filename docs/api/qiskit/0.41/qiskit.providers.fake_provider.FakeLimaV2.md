...
`FakeLimaV2.acquire_channel(qubit)`
...
`FakeLimaV2.control_channel(qubits)`
...
`FakeLimaV2.drive_channel(qubit)`
...
`FakeLimaV2.measure_channel(qubit)`
...
`FakeLimaV2.qubit_properties(qubit)`
...
`FakeLimaV2.run(run_input, **options)`
