...
$$
  ...
  ![../\_images/qiskit-circuit-library-QFT-1.png](/images/api/qiskit/0.41/qiskit-circuit-library-QFT-1.avif)

  The inverse QFT can be obtained by calling the `inverse` method on this class. The respective circuit diagram is:

  ![../\_images/qiskit-circuit-library-QFT-2.png](/images/api/qiskit/0.41/qiskit-circuit-library-QFT-2.avif)
  ...
  ![../\_images/qiskit-circuit-library-QFT-3.png](/images/api/qiskit/0.41/qiskit-circuit-library-QFT-3.avif)
