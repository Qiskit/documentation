...
<Class id="qiskit.providers.models.BackendProperties" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/providers/models/backendproperties.py" signature="BackendProperties(backend_name, backend_version, last_update_date, qubits, gates, general, **kwargs)">
  Bases: `object`
  ...
  *   **kwargs** – optional additional fields
  ...
  <Function id="qiskit.providers.models.BackendProperties.faulty_gates" name="faulty_gates" signature="BackendProperties.faulty_gates()">
    Return a list of faulty gates.
  </Function>

  ### faulty\_qubits

  <Function id="qiskit.providers.models.BackendProperties.faulty_qubits" name="faulty_qubits" signature="BackendProperties.faulty_qubits()">
    Return a list of faulty qubits.
  </Function>

  ### frequency

  <Function id="qiskit.providers.models.BackendProperties.frequency" name="frequency" signature="BackendProperties.frequency(qubit)">
  ...
  <Function id="qiskit.providers.models.BackendProperties.from_dict" name="from_dict" signature="classmethod BackendProperties.from_dict(data)">
  ...
  <Function id="qiskit.providers.models.BackendProperties.gate_error" name="gate_error" signature="BackendProperties.gate_error(gate, qubits)">
  ...
  <Function id="qiskit.providers.models.BackendProperties.gate_length" name="gate_length" signature="BackendProperties.gate_length(gate, qubits)">
  ...
  <Function id="qiskit.providers.models.BackendProperties.gate_property" name="gate_property" signature="BackendProperties.gate_property(gate, qubits=None, name=None)">
  ...
  <Function id="qiskit.providers.models.BackendProperties.is_gate_operational" name="is_gate_operational" signature="BackendProperties.is_gate_operational(gate, qubits=None)">
  ...
  <Function id="qiskit.providers.models.BackendProperties.is_qubit_operational" name="is_qubit_operational" signature="BackendProperties.is_qubit_operational(qubit)">
  ...
  <Function id="qiskit.providers.models.BackendProperties.qubit_property" name="qubit_property" signature="BackendProperties.qubit_property(qubit, name=None)">
  ...
  <Function id="qiskit.providers.models.BackendProperties.readout_error" name="readout_error" signature="BackendProperties.readout_error(qubit)">
  ...
  <Function id="qiskit.providers.models.BackendProperties.readout_length" name="readout_length" signature="BackendProperties.readout_length(qubit)">
  ...
  <Function id="qiskit.providers.models.BackendProperties.t1" name="t1" signature="BackendProperties.t1(qubit)">
  ...
  <Function id="qiskit.providers.models.BackendProperties.t2" name="t2" signature="BackendProperties.t2(qubit)">
  ...
  <Function id="qiskit.providers.models.BackendProperties.to_dict" name="to_dict" signature="BackendProperties.to_dict()">
