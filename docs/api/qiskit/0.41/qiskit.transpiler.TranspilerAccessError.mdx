...
<Class id="qiskit.transpiler.TranspilerAccessError" name="TranspilerAccessError" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/transpiler/exceptions.py" signature="TranspilerAccessError(*message)">
