...
<Class id="qiskit.transpiler.TranspilerAccessError" github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/transpiler/exceptions.py" signature="TranspilerAccessError(*message)">
