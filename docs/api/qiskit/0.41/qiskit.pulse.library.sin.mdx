---
title: sin (v0.41)
description: API reference for qiskit.pulse.library.sin in qiskit v0.41
...
<Function id="qiskit.pulse.library.sin" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/pulse/library/discrete.py" signature="sin(duration, amp, freq=None, phase=0, name=None)">
