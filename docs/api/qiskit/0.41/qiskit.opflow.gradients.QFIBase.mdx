---
title: QFIBase (v0.41)
description: API reference for qiskit.opflow.gradients.QFIBase in qiskit v0.41
...
<Class id="qiskit.opflow.gradients.QFIBase" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/opflow/gradients/qfi_base.py" signature="QFIBase(qfi_method='lin_comb_full')" modifiers="class">
