---
title: generate_translation_passmanager (v0.41)
description: API reference for qiskit.transpiler.preset_passmanagers.common.generate_translation_passmanager in qiskit v0.41
