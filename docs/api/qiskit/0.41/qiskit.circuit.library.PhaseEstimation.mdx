---
title: PhaseEstimation (v0.41)
description: API reference for qiskit.circuit.library.PhaseEstimation in qiskit v0.41
...
$$
  ...
  **Reference Circuit:**
  ...
  ![../\_images/qiskit-circuit-library-PhaseEstimation-1.png](/docs/images/api/qiskit/0.41/qiskit-circuit-library-PhaseEstimation-1.avif)
  ...
  <Attribute id="qiskit.circuit.library.PhaseEstimation.instances" attributeValue="2238" />
