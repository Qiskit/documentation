...
description: API reference for qiskit.providers.fake_provider.FakeRomeV2 in qiskit v0.41
...
<Class id="qiskit.providers.fake_provider.FakeRomeV2" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/providers/fake_provider/backends/rome/fake_rome.py" signature="FakeRomeV2" modifiers="class">
  ...
  <Attribute id="qiskit.providers.fake_provider.FakeRomeV2.backend_name" attributeValue="'fake_rome_v2'" />

  ### conf\_filename

  <Attribute id="qiskit.providers.fake_provider.FakeRomeV2.conf_filename" attributeValue="'conf_rome.json'" />

  ### coupling\_map

  <Attribute id="qiskit.providers.fake_provider.FakeRomeV2.coupling_map">
    Return the [`CouplingMap`](qiskit.transpiler.CouplingMap "qiskit.transpiler.CouplingMap") object
  </Attribute>

  ### defs\_filename

  <Attribute id="qiskit.providers.fake_provider.FakeRomeV2.defs_filename" attributeValue="'defs_rome.json'" />

  ### dirname

  <Attribute id="qiskit.providers.fake_provider.FakeRomeV2.dirname" attributeValue="'/home/runner/work/qiskit/qiskit/.tox/docs/lib/python3.8/site-packages/qiskit/providers/fake_provider/backends/rome'" />

  ### dt

  <Attribute id="qiskit.providers.fake_provider.FakeRomeV2.dt">
  ...
  <Attribute id="qiskit.providers.fake_provider.FakeRomeV2.dtm">
  ...
  <Attribute id="qiskit.providers.fake_provider.FakeRomeV2.instruction_durations">
  ...
  <Attribute id="qiskit.providers.fake_provider.FakeRomeV2.instruction_schedule_map">
  ...
  <Attribute id="qiskit.providers.fake_provider.FakeRomeV2.instructions">
  ...
  <Attribute id="qiskit.providers.fake_provider.FakeRomeV2.max_circuits" />

  ### meas\_map

  <Attribute id="qiskit.providers.fake_provider.FakeRomeV2.meas_map">
  ...
  <Attribute id="qiskit.providers.fake_provider.FakeRomeV2.num_qubits">
  ...
  <Attribute id="qiskit.providers.fake_provider.FakeRomeV2.operation_names">
  ...
  <Attribute id="qiskit.providers.fake_provider.FakeRomeV2.operations">
  ...
  <Attribute id="qiskit.providers.fake_provider.FakeRomeV2.options">
  ...
  <Attribute id="qiskit.providers.fake_provider.FakeRomeV2.props_filename" attributeValue="'props_rome.json'" />

  ### provider

  <Attribute id="qiskit.providers.fake_provider.FakeRomeV2.provider">
  ...
  <Attribute id="qiskit.providers.fake_provider.FakeRomeV2.target">
  ...
  <Attribute id="qiskit.providers.fake_provider.FakeRomeV2.version" attributeValue="2" />
</Class>
