...
<Class id="qiskit.transpiler.preset_passmanagers.plugin.PassManagerStagePlugin" github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/transpiler/preset_passmanagers/plugin.py" signature="PassManagerStagePlugin">
  Bases: `abc.ABC`
