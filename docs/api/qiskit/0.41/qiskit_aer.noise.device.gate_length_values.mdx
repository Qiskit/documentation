---
title: gate_length_values (v0.41)
description: API reference for qiskit_aer.noise.device.gate_length_values in qiskit v0.41
in_page_toc_min_heading_level: 1
python_api_type: function
python_api_name: qiskit_aer.noise.device.gate_length_values
---

<span id="qiskit-aer-noise-device-gate-length-values" />

# qiskit\_aer.noise.device.gate\_length\_values

<Function id="qiskit_aer.noise.device.gate_length_values" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-aer/tree/stable/0.11/qiskit_aer/noise/device/parameters.py" signature="gate_length_values(properties)">
