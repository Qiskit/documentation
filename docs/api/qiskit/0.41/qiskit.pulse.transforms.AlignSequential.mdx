---
title: AlignSequential (v0.41)
description: API reference for qiskit.pulse.transforms.AlignSequential in qiskit v0.41
...
<Class id="qiskit.pulse.transforms.AlignSequential" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/pulse/transforms/alignments.py" signature="AlignSequential" modifiers="class">
