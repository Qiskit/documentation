---
title: random_quantum_channel (v0.41)
description: API reference for qiskit.quantum_info.random_quantum_channel in qiskit v0.41
...
<Function id="qiskit.quantum_info.random_quantum_channel" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/quantum_info/operators/random.py" signature="random_quantum_channel(input_dims=None, output_dims=None, rank=None, seed=None)">
