...
<Class id="qiskit.transpiler.synthesis.aqc.AQC" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/transpiler/synthesis/aqc/aqc.py" signature="AQC(optimizer=None, seed=None)">
  Bases: `object`
