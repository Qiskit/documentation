---
title: SXdgGate (v0.41)
description: API reference for qiskit.circuit.library.SXdgGate in qiskit v0.41
...
<Class id="qiskit.circuit.library.SXdgGate" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/circuit/library/standard_gates/sx.py" signature="SXdgGate(label=None)" modifiers="class">
