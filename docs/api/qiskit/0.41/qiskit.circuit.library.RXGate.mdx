---
title: RXGate (v0.41)
description: API reference for qiskit.circuit.library.RXGate in qiskit v0.41
...
<Class id="qiskit.circuit.library.RXGate" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/circuit/library/standard_gates/rx.py" signature="RXGate(theta, label=None)" modifiers="class">
