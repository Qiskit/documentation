---
title: PauliFeatureMap (v0.41)
description: API reference for qiskit.circuit.library.PauliFeatureMap in qiskit v0.41
...
$$
  ...
  *   **insert\_barriers** (`bool`) – If True, barriers are inserted in between the evolution instructions and hadamard layers.
  ...
  <Attribute id="qiskit.circuit.library.PauliFeatureMap.instances" attributeValue="2144" />
