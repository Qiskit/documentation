...
<Class id="qiskit.transpiler.passes.TranslateParameterizedGates" github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/transpiler/passes/basis/translate_parameterized.py" signature="TranslateParameterizedGates(*args, **kwargs)">
