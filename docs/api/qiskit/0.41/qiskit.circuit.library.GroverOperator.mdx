---
title: GroverOperator (v0.41)
description: API reference for qiskit.circuit.library.GroverOperator in qiskit v0.41
...
$$
  ...
  *   **name** (`str`) – The name of the circuit.
  ...
  <Attribute id="qiskit.circuit.library.GroverOperator.instances" attributeValue="2080" />
