---
title: AerSimulator (v0.41)
description: API reference for qiskit_aer.AerSimulator in qiskit v0.41
...
<Class id="qiskit_aer.AerSimulator" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-aer/tree/stable/0.11/qiskit_aer/backends/aer_simulator.py" signature="AerSimulator(configuration=None, properties=None, provider=None, **backend_options)" modifiers="class">
