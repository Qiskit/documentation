...
<Class id="qiskit.providers.ibmq.managed.IBMQJobManagerJobNotFound" github="https://github.com/qiskit/qiskit-ibmq-provider/tree/stable/0.20/qiskit/providers/ibmq/managed/exceptions.py" signature="IBMQJobManagerJobNotFound(*message)">
