...
<Class id="qiskit.synthesis.MatrixExponential" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/synthesis/evolution/matrix_synthesis.py" signature="MatrixExponential">
  ...
  <Function id="qiskit.synthesis.MatrixExponential.synthesize" name="synthesize" signature="MatrixExponential.synthesize(evolution)">
