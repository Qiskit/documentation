---
title: generate_control_flow_options_check (v0.41)
description: API reference for qiskit.transpiler.preset_passmanagers.common.generate_control_flow_options_check in qiskit v0.41
