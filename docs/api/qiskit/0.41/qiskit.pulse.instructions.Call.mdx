...
<Class id="qiskit.pulse.instructions.Call" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/pulse/instructions/call.py" signature="Call(subroutine, value_dict=None, name=None)">
