---
title: FasterAmplitudeEstimationResult (v0.41)
description: API reference for qiskit.algorithms.FasterAmplitudeEstimationResult in qiskit v0.41
...
<Class id="qiskit.algorithms.FasterAmplitudeEstimationResult" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/algorithms/amplitude_estimators/fae.py" signature="FasterAmplitudeEstimationResult" modifiers="class">
