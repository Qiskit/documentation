---
title: AerStatevector (v0.41)
description: API reference for qiskit_aer.quantum_info.AerStatevector in qiskit v0.41
  ...
  **Additional Information:**
  ...
  <Function id="qiskit_aer.quantum_info.AerStatevector.draw" signature="AerStatevector.draw(output=None, **drawer_args)">
    ...
    **Examples**
    ...
    ![../\_images/qiskit\_aer-quantum\_info-AerStatevector-draw-1.png](/docs/images/api/qiskit/0.41/qiskit_aer-quantum_info-AerStatevector-draw-1.avif)
  </Function>
