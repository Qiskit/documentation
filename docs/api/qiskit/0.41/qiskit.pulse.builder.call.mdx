---
title: call (v0.41)
description: API reference for qiskit.pulse.builder.call in qiskit v0.41
...
<Function id="qiskit.pulse.builder.call" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/pulse/builder.py" signature="call(target, name=None, value_dict=None, **kw_params)">
