---
title: SuperOp (v0.41)
description: API reference for qiskit.quantum_info.SuperOp in qiskit v0.41
...
<Class id="qiskit.quantum_info.SuperOp" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/quantum_info/operators/channel/superop.py" signature="SuperOp(data, input_dims=None, output_dims=None)" modifiers="class">
