---
title: gate_error_values (v0.41)
description: API reference for qiskit_aer.noise.device.gate_error_values in qiskit v0.41
...
<Function id="qiskit_aer.noise.device.gate_error_values" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-aer/tree/stable/0.11/qiskit_aer/noise/device/parameters.py" signature="gate_error_values(properties)">
