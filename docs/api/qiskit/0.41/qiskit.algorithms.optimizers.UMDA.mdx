...
<Class id="qiskit.algorithms.optimizers.UMDA" github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/algorithms/optimizers/umda.py" signature="UMDA(maxiter=100, size_gen=20, alpha=0.5)">
