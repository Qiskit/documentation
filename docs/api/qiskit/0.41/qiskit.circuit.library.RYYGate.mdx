---
title: RYYGate (v0.41)
description: API reference for qiskit.circuit.library.RYYGate in qiskit v0.41
...
<Class id="qiskit.circuit.library.RYYGate" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/circuit/library/standard_gates/ryy.py" signature="RYYGate(theta, label=None)" modifiers="class">
