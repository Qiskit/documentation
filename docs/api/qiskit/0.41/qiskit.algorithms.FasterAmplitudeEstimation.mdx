...
<Class id="qiskit.algorithms.FasterAmplitudeEstimation" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/algorithms/amplitude_estimators/fae.py" signature="FasterAmplitudeEstimation(delta, maxiter, rescale=True, quantum_instance=None, sampler=None)">
  ...
  *   **sampler** ([*BaseSampler*](qiskit.primitives.BaseSampler "qiskit.primitives.BaseSampler") *| None*) – A sampler primitive to evaluate the circuits.
  ...
  <Function id="qiskit.algorithms.FasterAmplitudeEstimation.construct_circuit" name="construct_circuit" signature="FasterAmplitudeEstimation.construct_circuit(estimation_problem, k, measurement=False)">
  ...
  <Function id="qiskit.algorithms.FasterAmplitudeEstimation.estimate" name="estimate" signature="FasterAmplitudeEstimation.estimate(estimation_problem)">
  ...
  <Attribute id="qiskit.algorithms.FasterAmplitudeEstimation.quantum_instance" name="quantum_instance">
  ...
  <Attribute id="qiskit.algorithms.FasterAmplitudeEstimation.sampler" name="sampler">
