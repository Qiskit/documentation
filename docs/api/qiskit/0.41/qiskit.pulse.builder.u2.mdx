...
<Function id="qiskit.pulse.builder.u2" name="u2" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/pulse/builder.py" signature="u2(phi, lam, qubit)">
