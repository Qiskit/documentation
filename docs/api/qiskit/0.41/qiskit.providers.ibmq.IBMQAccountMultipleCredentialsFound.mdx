...
<Class id="qiskit.providers.ibmq.IBMQAccountMultipleCredentialsFound" github="https://github.com/qiskit/qiskit-ibmq-provider/tree/stable/0.20/qiskit/providers/ibmq/exceptions.py" signature="IBMQAccountMultipleCredentialsFound(*message)">
