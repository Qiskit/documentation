---
title: pauli_basis (v0.41)
description: API reference for qiskit.quantum_info.pauli_basis in qiskit v0.41
...
<Function id="qiskit.quantum_info.pauli_basis" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/quantum_info/operators/symplectic/pauli_utils.py" signature="pauli_basis(num_qubits, weight=False, pauli_list=None)">
