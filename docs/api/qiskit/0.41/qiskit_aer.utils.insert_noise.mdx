---
title: insert_noise (v0.41)
description: API reference for qiskit_aer.utils.insert_noise in qiskit v0.41
in_page_toc_min_heading_level: 1
python_api_type: function
python_api_name: qiskit_aer.utils.insert_noise
---

<span id="qiskit-aer-utils-insert-noise" />

# qiskit\_aer.utils.insert\_noise

<Function id="qiskit_aer.utils.insert_noise" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-aer/tree/stable/0.11/qiskit_aer/utils/noise_model_inserter.py" signature="insert_noise(circuits, noise_model, transpile=False)">
