...
<Class id="qiskit.qobj.QobjExperimentHeader" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/qobj/common.py" signature="QobjExperimentHeader(**kwargs)">
