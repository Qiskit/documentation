---
title: FourierChecking (v0.41)
description: API reference for qiskit.circuit.library.FourierChecking in qiskit v0.41
...
<Class id="qiskit.circuit.library.FourierChecking" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/circuit/library/fourier_checking.py" signature="FourierChecking(f, g)" modifiers="class">
  ...
  **Reference Circuit:**
  ...
  ![../\_images/qiskit-circuit-library-FourierChecking-1.png](/docs/images/api/qiskit/0.41/qiskit-circuit-library-FourierChecking-1.avif)
  ...
  <Attribute id="qiskit.circuit.library.FourierChecking.instances" attributeValue="2050" />
