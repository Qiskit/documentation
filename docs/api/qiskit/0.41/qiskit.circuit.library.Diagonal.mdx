---
title: Diagonal (v0.41)
description: API reference for qiskit.circuit.library.Diagonal in qiskit v0.41
...
$$
  ...
  **CircuitError** – if the list of the diagonal entries or the qubit list is in bad format; if the number of diagonal entries is not 2^k, where k denotes the number of qubits
  ...
  <Attribute id="qiskit.circuit.library.Diagonal.instances" attributeValue="2048" />
