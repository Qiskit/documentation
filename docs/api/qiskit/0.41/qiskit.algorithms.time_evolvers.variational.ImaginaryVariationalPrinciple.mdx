---
title: ImaginaryVariationalPrinciple (v0.41)
description: API reference for qiskit.algorithms.time_evolvers.variational.ImaginaryVariationalPrinciple in qiskit v0.41
...
<Class id="qiskit.algorithms.time_evolvers.variational.ImaginaryVariationalPrinciple" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/algorithms/time_evolvers/variational/variational_principles/imaginary_variational_principle.py" signature="ImaginaryVariationalPrinciple(qgt, gradient)" modifiers="class">
