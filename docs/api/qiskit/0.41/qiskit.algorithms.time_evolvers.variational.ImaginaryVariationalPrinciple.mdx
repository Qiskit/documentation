...
<Class id="qiskit.algorithms.time_evolvers.variational.ImaginaryVariationalPrinciple" github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/algorithms/time_evolvers/variational/variational_principles/imaginary_variational_principle.py" signature="ImaginaryVariationalPrinciple(qgt, gradient)">
