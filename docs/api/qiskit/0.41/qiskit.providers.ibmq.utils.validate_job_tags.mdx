...
<Function id="qiskit.providers.ibmq.utils.validate_job_tags" name="validate_job_tags" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-ibmq-provider/tree/stable/0.20/qiskit/providers/ibmq/utils/utils.py" signature="validate_job_tags(job_tags, exception)">
