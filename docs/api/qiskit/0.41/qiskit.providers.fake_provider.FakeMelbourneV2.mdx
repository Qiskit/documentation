---
title: FakeMelbourneV2 (v0.41)
description: API reference for qiskit.providers.fake_provider.FakeMelbourneV2 in qiskit v0.41
...
<Class id="qiskit.providers.fake_provider.FakeMelbourneV2" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/providers/fake_provider/backends/melbourne/fake_melbourne.py" signature="FakeMelbourneV2" modifiers="class">
  ...
  <Attribute id="qiskit.providers.fake_provider.FakeMelbourneV2.backend_name" attributeValue="'fake_melbourne_v2'" />
  ...
  <Attribute id="qiskit.providers.fake_provider.FakeMelbourneV2.dirname" attributeValue="'/home/runner/work/qiskit/qiskit/.tox/docs/lib/python3.8/site-packages/qiskit/providers/fake_provider/backends/melbourne'" />
