---
title: AerJob (v0.41)
description: API reference for qiskit_aer.jobs.AerJob in qiskit v0.41
...
<Class id="qiskit_aer.jobs.AerJob" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-aer/tree/stable/0.11/qiskit_aer/jobs/aerjob.py" signature="AerJob(backend, job_id, fn, qobj, executor=None)" modifiers="class">
  ...
  *   **executor** (*ThreadPoolExecutor or dask.distributed.client*) – The executor to be used to submit the job.
  ...
  <span id="qiskit-aer-jobs-aerjob-backend" />
  ...
  <span id="qiskit-aer-jobs-aerjob-cancel" />
  ...
  <span id="qiskit-aer-jobs-aerjob-cancelled" />
  ...
  <span id="qiskit-aer-jobs-aerjob-done" />
  ...
  <span id="qiskit-aer-jobs-aerjob-executor" />
  ...
  <span id="qiskit-aer-jobs-aerjob-in-final-state" />
  ...
  <span id="qiskit-aer-jobs-aerjob-job-id" />
  ...
  <span id="qiskit-aer-jobs-aerjob-qobj" />
  ...
  <span id="qiskit-aer-jobs-aerjob-result" />
  ...
  <span id="qiskit-aer-jobs-aerjob-running" />
  ...
  <span id="qiskit-aer-jobs-aerjob-status" />
  ...
  <span id="qiskit-aer-jobs-aerjob-submit" />
  ...
  <span id="qiskit-aer-jobs-aerjob-wait-for-final-state" />
