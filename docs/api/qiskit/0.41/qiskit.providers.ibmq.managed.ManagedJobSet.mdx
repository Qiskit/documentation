...
<Class id="qiskit.providers.ibmq.managed.ManagedJobSet" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-ibmq-provider/tree/stable/0.20/qiskit/providers/ibmq/managed/managedjobset.py" signature="ManagedJobSet(name=None, short_id=None)">
  Bases: `object`
  ...
  *   **short\_id** (`Optional`\[`str`]) – Short ID for this set of jobs.
  ...
  <Function id="qiskit.providers.ibmq.managed.ManagedJobSet.cancel" name="cancel" signature="ManagedJobSet.cancel()">
  ...
  <Function id="qiskit.providers.ibmq.managed.ManagedJobSet.error_messages" name="error_messages" signature="ManagedJobSet.error_messages()">
  ...
  <Function id="qiskit.providers.ibmq.managed.ManagedJobSet.job" name="job" signature="ManagedJobSet.job(experiment)">
  ...
  <Function id="qiskit.providers.ibmq.managed.ManagedJobSet.job_set_id" name="job_set_id" signature="ManagedJobSet.job_set_id()">
  ...
  <Function id="qiskit.providers.ibmq.managed.ManagedJobSet.jobs" name="jobs" signature="ManagedJobSet.jobs()">
  ...
  <Function id="qiskit.providers.ibmq.managed.ManagedJobSet.managed_jobs" name="managed_jobs" signature="ManagedJobSet.managed_jobs()">
  ...
  <Function id="qiskit.providers.ibmq.managed.ManagedJobSet.name" name="name" signature="ManagedJobSet.name()">
  ...
  <Function id="qiskit.providers.ibmq.managed.ManagedJobSet.qobjs" name="qobjs" signature="ManagedJobSet.qobjs()">
  ...
  <Function id="qiskit.providers.ibmq.managed.ManagedJobSet.report" name="report" signature="ManagedJobSet.report(detailed=True)">
  ...
  <Function id="qiskit.providers.ibmq.managed.ManagedJobSet.results" name="results" signature="ManagedJobSet.results(timeout=None, partial=False, refresh=False)">
  ...
  <Function id="qiskit.providers.ibmq.managed.ManagedJobSet.retrieve_jobs" name="retrieve_jobs" signature="ManagedJobSet.retrieve_jobs(provider, refresh=False)">
  ...
  <Function id="qiskit.providers.ibmq.managed.ManagedJobSet.run" name="run" signature="ManagedJobSet.run(experiment_list, backend, executor, job_share_level=None, job_tags=None, **run_config)">
  ...
  <Function id="qiskit.providers.ibmq.managed.ManagedJobSet.statuses" name="statuses" signature="ManagedJobSet.statuses()">
  ...
  <Function id="qiskit.providers.ibmq.managed.ManagedJobSet.tags" name="tags" signature="ManagedJobSet.tags()">
  ...
  <Function id="qiskit.providers.ibmq.managed.ManagedJobSet.update_name" name="update_name" signature="ManagedJobSet.update_name(name)">
  ...
  <Function id="qiskit.providers.ibmq.managed.ManagedJobSet.update_tags" name="update_tags" signature="ManagedJobSet.update_tags(replacement_tags=None, additional_tags=None, removal_tags=None)">
