---
title: HiddenLinearFunction (v0.41)
description: API reference for qiskit.circuit.library.HiddenLinearFunction in qiskit v0.41
...
$$
  ...
  **Reference Circuit:**
  ...
  > ![../\_images/qiskit-circuit-library-HiddenLinearFunction-1.png](/docs/images/api/qiskit/0.41/qiskit-circuit-library-HiddenLinearFunction-1.avif)
  ...
  **CircuitError** – If A is not symmetric.
  ...
  <Attribute id="qiskit.circuit.library.HiddenLinearFunction.instances" attributeValue="2082" />
