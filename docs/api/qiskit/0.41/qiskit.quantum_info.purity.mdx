...
<Function id="qiskit.quantum_info.purity" github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/quantum_info/states/measures.py" signature="purity(state, validate=True)">
