---
title: Minimizer (v0.41)
description: API reference for qiskit.algorithms.optimizers.Minimizer in qiskit v0.41
...
<Class id="qiskit.algorithms.optimizers.Minimizer" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/algorithms/optimizers/optimizer.py" signature="Minimizer(*args, **kwargs)" modifiers="class">
  Bases: `Protocol`
