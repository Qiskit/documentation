...
<Class id="qiskit.algorithms.gradients.SPSASamplerGradient" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/algorithms/gradients/spsa_sampler_gradient.py" signature="SPSASamplerGradient(sampler, epsilon, batch_size=1, seed=None, options=None)">
  ...
  **ValueError** – If `epsilon` is not positive.
  ...
  <Function id="qiskit.algorithms.gradients.SPSASamplerGradient.run" name="run" signature="SPSASamplerGradient.run(circuits, parameter_values, parameters=None, **options)">
  ...
  <Function id="qiskit.algorithms.gradients.SPSASamplerGradient.update_default_options" name="update_default_options" signature="SPSASamplerGradient.update_default_options(**options)">
  ...
  <Attribute id="qiskit.algorithms.gradients.SPSASamplerGradient.options" name="options">
