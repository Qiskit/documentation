...
<Function id="qiskit_aer.noise.kraus_error" github="https://github.com/qiskit/qiskit-aer/tree/stable/0.11/qiskit_aer/noise/errors/standard_errors.py" signature="kraus_error(noise_ops, standard_gates=None, canonical_kraus=False)">
