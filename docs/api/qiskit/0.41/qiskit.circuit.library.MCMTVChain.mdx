---
title: MCMTVChain (v0.41)
description: API reference for qiskit.circuit.library.MCMTVChain in qiskit v0.41
...
<Class id="qiskit.circuit.library.MCMTVChain" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/circuit/library/generalized_gates/mcmt.py" signature="MCMTVChain(gate, num_ctrl_qubits, num_target_qubits)" modifiers="class">
  ...
  **Expanded Circuit:**
  ...
  ![../\_images/qiskit-circuit-library-MCMTVChain-1.png](/docs/images/api/qiskit/0.41/qiskit-circuit-library-MCMTVChain-1.avif)
