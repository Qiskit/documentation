---
title: CircuitInstruction (v0.41)
description: API reference for qiskit.circuit.CircuitInstruction in qiskit v0.41
...
<Class id="qiskit.circuit.CircuitInstruction" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/circuit/quantumcircuitdata.py" signature="CircuitInstruction(operation, qubits=(), clbits=())" modifiers="class">
  Bases: `object`
