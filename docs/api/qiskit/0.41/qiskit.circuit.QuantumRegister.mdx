...
<Class id="qiskit.circuit.QuantumRegister" github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/circuit/quantumregister.py" signature="QuantumRegister(size=None, name=None, bits=None)">
