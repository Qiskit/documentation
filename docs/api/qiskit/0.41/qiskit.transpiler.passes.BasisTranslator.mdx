...
<Class id="qiskit.transpiler.passes.BasisTranslator" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/transpiler/passes/basis/basis_translator.py" signature="BasisTranslator(*args, **kwargs)">
  ...
  *   **target** ([*Target*](qiskit.transpiler.Target "qiskit.transpiler.Target")) – The backend compilation target
  ...
  <Function id="qiskit.transpiler.passes.BasisTranslator.name" name="name" signature="BasisTranslator.name()">
    Return the name of the pass.
  </Function>

  ### run

  <Function id="qiskit.transpiler.passes.BasisTranslator.run" name="run" signature="BasisTranslator.run(dag)">
  ...
  <Attribute id="qiskit.transpiler.passes.BasisTranslator.is_analysis_pass" name="is_analysis_pass">
  ...
  <Attribute id="qiskit.transpiler.passes.BasisTranslator.is_transformation_pass" name="is_transformation_pass">
