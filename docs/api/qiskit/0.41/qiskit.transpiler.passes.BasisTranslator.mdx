---
title: BasisTranslator (v0.41)
description: API reference for qiskit.transpiler.passes.BasisTranslator in qiskit v0.41
...
<Class id="qiskit.transpiler.passes.BasisTranslator" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/transpiler/passes/basis/basis_translator.py" signature="BasisTranslator(*args, **kwargs)" modifiers="class">
