...
<Class id="qiskit.opflow.list_ops.TensoredOp" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/opflow/list_ops/tensored_op.py" signature="TensoredOp(oplist, coeff=1.0, abelian=False)">
  ...
  *   **abelian** (`bool`) – Indicates whether the Operators in `oplist` are known to mutually commute.
  ...
  <Function id="qiskit.opflow.list_ops.TensoredOp.eval" name="eval" signature="TensoredOp.eval(front=None)">
  ...
  <Function id="qiskit.opflow.list_ops.TensoredOp.reduce" name="reduce" signature="TensoredOp.reduce()">
  ...
  <Function id="qiskit.opflow.list_ops.TensoredOp.tensor" name="tensor" signature="TensoredOp.tensor(other)">
  ...
  <Function id="qiskit.opflow.list_ops.TensoredOp.to_circuit" name="to_circuit" signature="TensoredOp.to_circuit()">
  ...
  <Function id="qiskit.opflow.list_ops.TensoredOp.to_matrix" name="to_matrix" signature="TensoredOp.to_matrix(massive=False)">
  ...
  <Attribute id="qiskit.opflow.list_ops.TensoredOp.INDENTATION" name="INDENTATION" attributeValue="= '  '" />

  ### abelian

  <Attribute id="qiskit.opflow.list_ops.TensoredOp.abelian" name="abelian">
  ...
  <Attribute id="qiskit.opflow.list_ops.TensoredOp.coeff" name="coeff">
  ...
  <Attribute id="qiskit.opflow.list_ops.TensoredOp.coeffs" name="coeffs">
  ...
  <Attribute id="qiskit.opflow.list_ops.TensoredOp.combo_fn" name="combo_fn">
  ...
  <Attribute id="qiskit.opflow.list_ops.TensoredOp.distributive" name="distributive">
    **Return type**
  ...
  <Attribute id="qiskit.opflow.list_ops.TensoredOp.grad_combo_fn" name="grad_combo_fn">
  ...
  <Attribute id="qiskit.opflow.list_ops.TensoredOp.instance_id" name="instance_id">
  ...
  <Attribute id="qiskit.opflow.list_ops.TensoredOp.num_qubits" name="num_qubits">
    **Return type**
  ...
  <Attribute id="qiskit.opflow.list_ops.TensoredOp.oplist" name="oplist">
  ...
  <Attribute id="qiskit.opflow.list_ops.TensoredOp.parameters" name="parameters" />

  ### settings

  <Attribute id="qiskit.opflow.list_ops.TensoredOp.settings" name="settings">
    Return settings.
