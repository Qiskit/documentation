...
<Class id="qiskit.transpiler.passes.AlignMeasures" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/transpiler/passes/scheduling/alignments/align_measures.py" signature="AlignMeasures(alignment=1)">
  ...
  **alignment** (`int`) – Integer number representing the minimum time resolution to trigger measure instruction in units of `dt`. This value depends on the control electronics of your quantum processor.
  ...
  <Function id="qiskit.transpiler.passes.AlignMeasures.name" name="name" signature="AlignMeasures.name()">
    Return the name of the pass.
  </Function>

  ### run

  <Function id="qiskit.transpiler.passes.AlignMeasures.run" name="run" signature="AlignMeasures.run(dag)">
