...
<Class id="qiskit.opflow.primitive_ops.PauliSumOp" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/opflow/primitive_ops/pauli_sum_op.py" signature="PauliSumOp(primitive, coeff=1.0, grouping_type='None')">
  ...
  **TypeError** – invalid parameters.
  ...
  <Function id="qiskit.opflow.primitive_ops.PauliSumOp.add" name="add" signature="PauliSumOp.add(other)">
  ...
  <Function id="qiskit.opflow.primitive_ops.PauliSumOp.adjoint" name="adjoint" signature="PauliSumOp.adjoint()">
  ...
  <Function id="qiskit.opflow.primitive_ops.PauliSumOp.compose" name="compose" signature="PauliSumOp.compose(other, permutation=None, front=False)">
  ...
  <Function id="qiskit.opflow.primitive_ops.PauliSumOp.equals" name="equals" signature="PauliSumOp.equals(other)">
  ...
  <Function id="qiskit.opflow.primitive_ops.PauliSumOp.eval" name="eval" signature="PauliSumOp.eval(front=None)">
  ...
  <Function id="qiskit.opflow.primitive_ops.PauliSumOp.exp_i" name="exp_i" signature="PauliSumOp.exp_i()">
  ...
  <Function id="qiskit.opflow.primitive_ops.PauliSumOp.from_list" name="from_list" signature="classmethod PauliSumOp.from_list(pauli_list, coeff=1.0, dtype=<class 'complex'>)">
  ...
  <Function id="qiskit.opflow.primitive_ops.PauliSumOp.is_hermitian" name="is_hermitian" signature="PauliSumOp.is_hermitian()">
  ...
  <Function id="qiskit.opflow.primitive_ops.PauliSumOp.is_zero" name="is_zero" signature="PauliSumOp.is_zero()">
  ...
  <Function id="qiskit.opflow.primitive_ops.PauliSumOp.matrix_iter" name="matrix_iter" signature="PauliSumOp.matrix_iter(sparse=False)">
  ...
  <Function id="qiskit.opflow.primitive_ops.PauliSumOp.mul" name="mul" signature="PauliSumOp.mul(scalar)">
  ...
  <Function id="qiskit.opflow.primitive_ops.PauliSumOp.permute" name="permute" signature="PauliSumOp.permute(permutation)">
  ...
  <Function id="qiskit.opflow.primitive_ops.PauliSumOp.primitive_strings" name="primitive_strings" signature="PauliSumOp.primitive_strings()">
  ...
  <Function id="qiskit.opflow.primitive_ops.PauliSumOp.reduce" name="reduce" signature="PauliSumOp.reduce(atol=None, rtol=None)">
  ...
  <Function id="qiskit.opflow.primitive_ops.PauliSumOp.tensor" name="tensor" signature="PauliSumOp.tensor(other)">
  ...
  <Function id="qiskit.opflow.primitive_ops.PauliSumOp.to_instruction" name="to_instruction" signature="PauliSumOp.to_instruction()">
  ...
  <Function id="qiskit.opflow.primitive_ops.PauliSumOp.to_matrix" name="to_matrix" signature="PauliSumOp.to_matrix(massive=False)">
  ...
  <Function id="qiskit.opflow.primitive_ops.PauliSumOp.to_pauli_op" name="to_pauli_op" signature="PauliSumOp.to_pauli_op(massive=False)">
  ...
  <Function id="qiskit.opflow.primitive_ops.PauliSumOp.to_spmatrix" name="to_spmatrix" signature="PauliSumOp.to_spmatrix()">
  ...
  <Attribute id="qiskit.opflow.primitive_ops.PauliSumOp.INDENTATION" name="INDENTATION" attributeValue="= '  '" />

  ### coeff

  <Attribute id="qiskit.opflow.primitive_ops.PauliSumOp.coeff" name="coeff">
  ...
  <Attribute id="qiskit.opflow.primitive_ops.PauliSumOp.coeffs" name="coeffs">
    Return the Pauli coefficients.
  </Attribute>

  ### grouping\_type

  <Attribute id="qiskit.opflow.primitive_ops.PauliSumOp.grouping_type" name="grouping_type">
    Type of Grouping
  ...
  <Attribute id="qiskit.opflow.primitive_ops.PauliSumOp.instance_id" name="instance_id">
  ...
  <Attribute id="qiskit.opflow.primitive_ops.PauliSumOp.num_qubits" name="num_qubits">
    **Return type**
  ...
  <Attribute id="qiskit.opflow.primitive_ops.PauliSumOp.parameters" name="parameters" />

  ### primitive

  <Attribute id="qiskit.opflow.primitive_ops.PauliSumOp.primitive" name="primitive" attributeTypeHint="qiskit.quantum_info.operators.symplectic.sparse_pauli_op.SparsePauliOp">
  ...
  <Attribute id="qiskit.opflow.primitive_ops.PauliSumOp.settings" name="settings">
