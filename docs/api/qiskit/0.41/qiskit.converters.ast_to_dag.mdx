---
title: ast_to_dag (v0.41)
description: API reference for qiskit.converters.ast_to_dag in qiskit v0.41
...
<Function id="qiskit.converters.ast_to_dag" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/converters/ast_to_dag.py" signature="ast_to_dag(ast)">
