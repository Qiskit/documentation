---
title: GRZ (v0.41)
description: API reference for qiskit.circuit.library.GRZ in qiskit v0.41
...
$$
  ...
  **Expanded Circuit:**
  ...
  ![../\_images/qiskit-circuit-library-GRZ-1.png](/docs/images/api/qiskit/0.41/qiskit-circuit-library-GRZ-1.avif)
  ...
  *   **phi** (`float`) – rotation angle about z-axis
  ...
  <Attribute id="qiskit.circuit.library.GRZ.instances" attributeValue="2073" />
