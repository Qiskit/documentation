---
title: TGate (v0.41)
description: API reference for qiskit.circuit.library.TGate in qiskit v0.41
...
<Class id="qiskit.circuit.library.TGate" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/circuit/library/standard_gates/t.py" signature="TGate(label=None)" modifiers="class">
