...
<Function id="qiskit_aer.noise.reset_error" github="https://github.com/qiskit/qiskit-aer/tree/stable/0.11/qiskit_aer/noise/errors/standard_errors.py" signature="reset_error(prob0, prob1=0)">
