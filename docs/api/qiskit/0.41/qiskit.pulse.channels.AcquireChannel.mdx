---
title: AcquireChannel (v0.41)
description: API reference for qiskit.pulse.channels.AcquireChannel in qiskit v0.41
...
<Class id="qiskit.pulse.channels.AcquireChannel" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/pulse/channels.py" signature="AcquireChannel(index)" modifiers="class">
  ...
  **index** (`int`) – Index of channel.
  ...
  <Attribute id="qiskit.pulse.channels.AcquireChannel.prefix" attributeTypeHint="Optional[str]" attributeValue="'a'">
