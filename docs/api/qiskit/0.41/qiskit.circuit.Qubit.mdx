---
title: Qubit (v0.41)
description: API reference for qiskit.circuit.Qubit in qiskit v0.41
...
<Class id="qiskit.circuit.Qubit" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/circuit/quantumregister.py" signature="Qubit(register=None, index=None)" modifiers="class">
