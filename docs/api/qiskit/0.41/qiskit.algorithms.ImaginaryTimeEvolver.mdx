---
title: ImaginaryTimeEvolver (v0.41)
description: API reference for qiskit.algorithms.ImaginaryTimeEvolver in qiskit v0.41
...
<Class id="qiskit.algorithms.ImaginaryTimeEvolver" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/algorithms/time_evolvers/imaginary_time_evolver.py" signature="ImaginaryTimeEvolver" modifiers="class">
  Bases: `abc.ABC`
