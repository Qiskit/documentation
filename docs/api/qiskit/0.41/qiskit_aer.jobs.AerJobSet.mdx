---
title: AerJobSet (v0.41)
description: API reference for qiskit_aer.jobs.AerJobSet in qiskit v0.41
...
<Class id="qiskit_aer.jobs.AerJobSet" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-aer/tree/stable/0.11/qiskit_aer/jobs/aerjobset.py" signature="AerJobSet(backend, job_id, fn, experiments, executor=None)" modifiers="class">
  ...
  *   **executor** (*ThreadPoolExecutor or dask.distributed.client*) – The executor to be used to submit the job.
  ...
  <span id="qiskit-aer-jobs-aerjobset-backend" />

  ### backend

  <Function id="qiskit_aer.jobs.AerJobSet.backend" signature="AerJobSet.backend()">
  ...
  <span id="qiskit-aer-jobs-aerjobset-cancel" />

  ### cancel

  <Function id="qiskit_aer.jobs.AerJobSet.cancel" signature="AerJobSet.cancel()">
  ...
  <span id="qiskit-aer-jobs-aerjobset-cancelled" />

  ### cancelled

  <Function id="qiskit_aer.jobs.AerJobSet.cancelled" signature="AerJobSet.cancelled()">
  ...
  <span id="qiskit-aer-jobs-aerjobset-done" />

  ### done

  <Function id="qiskit_aer.jobs.AerJobSet.done" signature="AerJobSet.done()">
  ...
  <span id="qiskit-aer-jobs-aerjobset-executor" />

  ### executor

  <Function id="qiskit_aer.jobs.AerJobSet.executor" signature="AerJobSet.executor()">
    Return the executor for this job
  </Function>

  <span id="qiskit-aer-jobs-aerjobset-in-final-state" />

  ### in\_final\_state

  <Function id="qiskit_aer.jobs.AerJobSet.in_final_state" signature="AerJobSet.in_final_state()">
  ...
  <span id="qiskit-aer-jobs-aerjobset-job" />

  ### job

  <Function id="qiskit_aer.jobs.AerJobSet.job" signature="AerJobSet.job(experiment)">
  ...
  <span id="qiskit-aer-jobs-aerjobset-job-id" />

  ### job\_id

  <Function id="qiskit_aer.jobs.AerJobSet.job_id" signature="AerJobSet.job_id()">
  ...
  <span id="qiskit-aer-jobs-aerjobset-result" />

  ### result

  <Function id="qiskit_aer.jobs.AerJobSet.result" signature="AerJobSet.result(timeout=None)">
  ...
  <span id="qiskit-aer-jobs-aerjobset-running" />

  ### running

  <Function id="qiskit_aer.jobs.AerJobSet.running" signature="AerJobSet.running()">
  ...
  <span id="qiskit-aer-jobs-aerjobset-status" />

  ### status

  <Function id="qiskit_aer.jobs.AerJobSet.status" signature="AerJobSet.status(worker)">
  ...
  <span id="qiskit-aer-jobs-aerjobset-submit" />

  ### submit

  <Function id="qiskit_aer.jobs.AerJobSet.submit" signature="AerJobSet.submit()">
  ...
  <span id="qiskit-aer-jobs-aerjobset-wait-for-final-state" />

  ### wait\_for\_final\_state

  <Function id="qiskit_aer.jobs.AerJobSet.wait_for_final_state" signature="AerJobSet.wait_for_final_state(timeout=None, wait=5, callback=None)">
  ...
  <span id="qiskit-aer-jobs-aerjobset-worker" />

  ### worker

  <Function id="qiskit_aer.jobs.AerJobSet.worker" signature="AerJobSet.worker(experiment)">
  ...
  <span id="qiskit-aer-jobs-aerjobset-worker-job" />

  ### worker\_job

  <Function id="qiskit_aer.jobs.AerJobSet.worker_job" signature="AerJobSet.worker_job(worker)">
  ...
  <span id="qiskit-aer-jobs-aerjobset-worker-results" />

  ### worker\_results

  <Function id="qiskit_aer.jobs.AerJobSet.worker_results" signature="AerJobSet.worker_results(worker, timeout=None)">
  ...
  <Attribute id="qiskit_aer.jobs.AerJobSet.version" attributeValue="1" />
</Class>
