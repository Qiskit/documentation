...
<Class id="qiskit.dagcircuit.DAGDependency" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/dagcircuit/dagdependency.py" signature="DAGDependency">
  Bases: `object`
  ...
  **Reference:**
  ...
  <Function id="qiskit.dagcircuit.DAGDependency.add_clbits" name="add_clbits" signature="DAGDependency.add_clbits(clbits)">
    Add individual clbit wires.
  </Function>

  ### add\_creg

  <Function id="qiskit.dagcircuit.DAGDependency.add_creg" name="add_creg" signature="DAGDependency.add_creg(creg)">
    Add clbits in a classical register.
  </Function>

  ### add\_op\_node

  <Function id="qiskit.dagcircuit.DAGDependency.add_op_node" name="add_op_node" signature="DAGDependency.add_op_node(operation, qargs, cargs)">
  ...
  <Function id="qiskit.dagcircuit.DAGDependency.add_qreg" name="add_qreg" signature="DAGDependency.add_qreg(qreg)">
    Add qubits in a quantum register.
  </Function>

  ### add\_qubits

  <Function id="qiskit.dagcircuit.DAGDependency.add_qubits" name="add_qubits" signature="DAGDependency.add_qubits(qubits)">
    Add individual qubit wires.
  </Function>

  ### copy

  <Function id="qiskit.dagcircuit.DAGDependency.copy" name="copy" signature="DAGDependency.copy()">
    Function to copy a DAGDependency object. :returns: a copy of a DAGDependency object. :rtype: DAGDependency
  </Function>

  ### depth

  <Function id="qiskit.dagcircuit.DAGDependency.depth" name="depth" signature="DAGDependency.depth()">
    Return the circuit depth. :returns: the circuit depth :rtype: int
  </Function>

  ### direct\_predecessors

  <Function id="qiskit.dagcircuit.DAGDependency.direct_predecessors" name="direct_predecessors" signature="DAGDependency.direct_predecessors(node_id)">
  ...
  <Function id="qiskit.dagcircuit.DAGDependency.direct_successors" name="direct_successors" signature="DAGDependency.direct_successors(node_id)">
  ...
  <Function id="qiskit.dagcircuit.DAGDependency.draw" name="draw" signature="DAGDependency.draw(scale=0.7, filename=None, style='color')">
  ...
  <Function id="qiskit.dagcircuit.DAGDependency.get_all_edges" name="get_all_edges" signature="DAGDependency.get_all_edges()">
  ...
  <Function id="qiskit.dagcircuit.DAGDependency.get_edges" name="get_edges" signature="DAGDependency.get_edges(src_id, dest_id)">
  ...
  <Function id="qiskit.dagcircuit.DAGDependency.get_in_edges" name="get_in_edges" signature="DAGDependency.get_in_edges(node_id)">
  ...
  <Function id="qiskit.dagcircuit.DAGDependency.get_node" name="get_node" signature="DAGDependency.get_node(node_id)">
    **Parameters**
  ...
  <Function id="qiskit.dagcircuit.DAGDependency.get_nodes" name="get_nodes" signature="DAGDependency.get_nodes()">
    **Returns**
  ...
  <Function id="qiskit.dagcircuit.DAGDependency.get_out_edges" name="get_out_edges" signature="DAGDependency.get_out_edges(node_id)">
  ...
  <Function id="qiskit.dagcircuit.DAGDependency.predecessors" name="predecessors" signature="DAGDependency.predecessors(node_id)">
  ...
  <Function id="qiskit.dagcircuit.DAGDependency.replace_block_with_op" name="replace_block_with_op" signature="DAGDependency.replace_block_with_op(node_block, op, wire_pos_map, cycle_check=True)">
  ...
  <Function id="qiskit.dagcircuit.DAGDependency.size" name="size" signature="DAGDependency.size()">
    Returns the number of gates in the circuit
  </Function>

  ### successors

  <Function id="qiskit.dagcircuit.DAGDependency.successors" name="successors" signature="DAGDependency.successors(node_id)">
  ...
  <Function id="qiskit.dagcircuit.DAGDependency.to_retworkx" name="to_retworkx" signature="DAGDependency.to_retworkx()">
    Returns the DAGDependency in retworkx format.
  </Function>

  ### topological\_nodes

  <Function id="qiskit.dagcircuit.DAGDependency.topological_nodes" name="topological_nodes" signature="DAGDependency.topological_nodes()">
