---
title: GRY (v0.41)
description: API reference for qiskit.circuit.library.GRY in qiskit v0.41
...
$$
  ...
  **Expanded Circuit:**
  ...
  ![../\_images/qiskit-circuit-library-GRY-1.png](/docs/images/api/qiskit/0.41/qiskit-circuit-library-GRY-1.avif)
  ...
  *   **theta** (`float`) – rotation angle about y-axis
  ...
  <Attribute id="qiskit.circuit.library.GRY.instances" attributeValue="2063" />
