...
<Class id="qiskit.primitives.BackendEstimator" github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/primitives/backend_estimator.py" signature="BackendEstimator(backend, options=None, abelian_grouping=True, bound_pass_manager=None, skip_transpilation=False)">
