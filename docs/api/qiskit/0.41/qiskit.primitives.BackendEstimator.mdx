...
<Class id="qiskit.primitives.BackendEstimator" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/primitives/backend_estimator.py" signature="BackendEstimator(backend, options=None, abelian_grouping=True, bound_pass_manager=None, skip_transpilation=False)">
  ...
  *   **skip\_transpilation** (*bool*) – If this is set to True the internal compilation of the input circuits is skipped and the circuit objects will be directly executed when this object is called.
  ...
  <Function id="qiskit.primitives.BackendEstimator.close" name="close" signature="BackendEstimator.close()">
    Close the session and free resources
  </Function>

  ### run

  <Function id="qiskit.primitives.BackendEstimator.run" name="run" signature="BackendEstimator.run(circuits, observables, parameter_values=None, **run_options)">
  ...
  <Function id="qiskit.primitives.BackendEstimator.set_options" name="set_options" signature="BackendEstimator.set_options(**fields)">
  ...
  <Function id="qiskit.primitives.BackendEstimator.set_transpile_options" name="set_transpile_options" signature="BackendEstimator.set_transpile_options(**fields)">
  ...
  <Attribute id="qiskit.primitives.BackendEstimator.backend" name="backend">
  ...
  <Attribute id="qiskit.primitives.BackendEstimator.circuits" name="circuits">
  ...
  <Attribute id="qiskit.primitives.BackendEstimator.observables" name="observables">
  ...
  <Attribute id="qiskit.primitives.BackendEstimator.options" name="options">
  ...
  <Attribute id="qiskit.primitives.BackendEstimator.parameters" name="parameters">
  ...
  <Attribute id="qiskit.primitives.BackendEstimator.preprocessed_circuits" name="preprocessed_circuits">
    Transpiled quantum circuits produced by preprocessing :returns: List of the transpiled quantum circuit
  </Attribute>

  ### transpile\_options

  <Attribute id="qiskit.primitives.BackendEstimator.transpile_options" name="transpile_options">
  ...
  <Attribute id="qiskit.primitives.BackendEstimator.transpiled_circuits" name="transpiled_circuits">
