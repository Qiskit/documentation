...
<Function id="qiskit_aer.utils.transpile_quantum_error" name="transpile_quantum_error" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-aer/tree/stable/0.11/qiskit_aer/utils/noise_transformation.py" signature="transpile_quantum_error(error, **transpile_kwargs)">
