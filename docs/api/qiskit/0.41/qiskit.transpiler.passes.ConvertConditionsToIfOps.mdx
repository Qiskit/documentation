...
<Class id="qiskit.transpiler.passes.ConvertConditionsToIfOps" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/transpiler/passes/utils/convert_conditions_to_if_ops.py" signature="ConvertConditionsToIfOps(*args, **kwargs)">
