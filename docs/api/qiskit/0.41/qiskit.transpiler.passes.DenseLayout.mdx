---
title: DenseLayout (v0.41)
description: API reference for qiskit.transpiler.passes.DenseLayout in qiskit v0.41
...
<Class id="qiskit.transpiler.passes.DenseLayout" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/transpiler/passes/layout/dense_layout.py" signature="DenseLayout(*args, **kwargs)" modifiers="class">
