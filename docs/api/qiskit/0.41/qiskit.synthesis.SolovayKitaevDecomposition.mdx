...
<Class id="qiskit.synthesis.SolovayKitaevDecomposition" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/synthesis/discrete_basis/solovay_kitaev.py" signature="SolovayKitaevDecomposition(basic_approximations=None)">
  Bases: `object`
