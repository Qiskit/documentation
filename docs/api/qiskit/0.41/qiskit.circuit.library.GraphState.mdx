---
title: GraphState (v0.41)
description: API reference for qiskit.circuit.library.GraphState in qiskit v0.41
...
$$
  ...
  **Reference Circuit:**
  ...
  ![../\_images/qiskit-circuit-library-GraphState-1.png](/docs/images/api/qiskit/0.41/qiskit-circuit-library-GraphState-1.avif)
  ...
  **CircuitError** – If adjacency\_matrix is not symmetric.
  ...
  <Attribute id="qiskit.circuit.library.GraphState.instances" attributeValue="2078" />
