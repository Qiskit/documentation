...
<Class id="qiskit.transpiler.passes.CollectCliffords" github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/transpiler/passes/optimization/collect_cliffords.py" signature="CollectCliffords(*args, **kwargs)">
