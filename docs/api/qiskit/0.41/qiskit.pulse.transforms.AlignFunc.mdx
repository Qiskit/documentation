---
title: AlignFunc (v0.41)
description: API reference for qiskit.pulse.transforms.AlignFunc in qiskit v0.41
...
<Class id="qiskit.pulse.transforms.AlignFunc" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/pulse/transforms/alignments.py" signature="AlignFunc(duration, func)" modifiers="class">
