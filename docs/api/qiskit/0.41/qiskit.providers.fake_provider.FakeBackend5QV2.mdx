...
<Class id="qiskit.providers.fake_provider.FakeBackend5QV2" github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/providers/fake_provider/fake_backend_v2.py" signature="FakeBackend5QV2(bidirectional=True)">
