...
<Function id="qiskit.quantum_info.diamond_norm" github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/quantum_info/operators/measures.py" signature="diamond_norm(choi, **kwargs)">
