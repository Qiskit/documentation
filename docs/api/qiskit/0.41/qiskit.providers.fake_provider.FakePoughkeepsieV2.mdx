---
title: FakePoughkeepsieV2 (v0.41)
description: API reference for qiskit.providers.fake_provider.FakePoughkeepsieV2 in qiskit v0.41
...
<Class id="qiskit.providers.fake_provider.FakePoughkeepsieV2" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/providers/fake_provider/backends/poughkeepsie/fake_poughkeepsie.py" signature="FakePoughkeepsieV2" modifiers="class">
  ...
  <Attribute id="qiskit.providers.fake_provider.FakePoughkeepsieV2.backend_name" attributeValue="'fake_poughkeepsie_v2'" />

  ### conf\_filename

  <Attribute id="qiskit.providers.fake_provider.FakePoughkeepsieV2.conf_filename" attributeValue="'conf_poughkeepsie.json'" />

  ### coupling\_map

  <Attribute id="qiskit.providers.fake_provider.FakePoughkeepsieV2.coupling_map">
    Return the [`CouplingMap`](qiskit.transpiler.CouplingMap "qiskit.transpiler.CouplingMap") object
  </Attribute>

  ### defs\_filename

  <Attribute id="qiskit.providers.fake_provider.FakePoughkeepsieV2.defs_filename" attributeValue="'defs_poughkeepsie.json'" />

  ### dirname

  <Attribute id="qiskit.providers.fake_provider.FakePoughkeepsieV2.dirname" attributeValue="'/home/runner/work/qiskit/qiskit/.tox/docs/lib/python3.8/site-packages/qiskit/providers/fake_provider/backends/poughkeepsie'" />

  ### dt

  <Attribute id="qiskit.providers.fake_provider.FakePoughkeepsieV2.dt">
  ...
  <Attribute id="qiskit.providers.fake_provider.FakePoughkeepsieV2.dtm">
  ...
  <Attribute id="qiskit.providers.fake_provider.FakePoughkeepsieV2.instruction_durations">
  ...
  <Attribute id="qiskit.providers.fake_provider.FakePoughkeepsieV2.instruction_schedule_map">
  ...
  <Attribute id="qiskit.providers.fake_provider.FakePoughkeepsieV2.instructions">
  ...
  <Attribute id="qiskit.providers.fake_provider.FakePoughkeepsieV2.max_circuits" />

  ### meas\_map

  <Attribute id="qiskit.providers.fake_provider.FakePoughkeepsieV2.meas_map">
  ...
  <Attribute id="qiskit.providers.fake_provider.FakePoughkeepsieV2.num_qubits">
  ...
  <Attribute id="qiskit.providers.fake_provider.FakePoughkeepsieV2.operation_names">
  ...
  <Attribute id="qiskit.providers.fake_provider.FakePoughkeepsieV2.operations">
  ...
  <Attribute id="qiskit.providers.fake_provider.FakePoughkeepsieV2.options">
  ...
  <Attribute id="qiskit.providers.fake_provider.FakePoughkeepsieV2.props_filename" attributeValue="'props_poughkeepsie.json'" />

  ### provider

  <Attribute id="qiskit.providers.fake_provider.FakePoughkeepsieV2.provider">
  ...
  <Attribute id="qiskit.providers.fake_provider.FakePoughkeepsieV2.target">
  ...
  <Attribute id="qiskit.providers.fake_provider.FakePoughkeepsieV2.version" attributeValue="2" />
</Class>
