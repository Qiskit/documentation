---
title: align_right (v0.41)
description: API reference for qiskit.pulse.builder.align_right in qiskit v0.41
...
<Function id="qiskit.pulse.builder.align_right" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/pulse/builder.py" signature="align_right()">
