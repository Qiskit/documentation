...
<Function id="qiskit_aer.library.set_matrix_product_state" name="set_matrix_product_state" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-aer/tree/stable/0.11/qiskit_aer/library/set_instructions/set_matrix_product_state.py" signature="set_matrix_product_state(self, state)">
