...
<Class id="qiskit.transpiler.passes.ConstrainedReschedule" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/transpiler/passes/scheduling/alignments/reschedule.py" signature="ConstrainedReschedule(acquire_alignment=1, pulse_alignment=1)">
  ...
  *   **pulse\_alignment** (`int`) – Integer number representing the minimum time resolution to trigger gate instruction in units of `dt`.
  ...
  <Function id="qiskit.transpiler.passes.ConstrainedReschedule.name" name="name" signature="ConstrainedReschedule.name()">
    Return the name of the pass.
  </Function>

  ### run

  <Function id="qiskit.transpiler.passes.ConstrainedReschedule.run" name="run" signature="ConstrainedReschedule.run(dag)">
    Run rescheduler.
