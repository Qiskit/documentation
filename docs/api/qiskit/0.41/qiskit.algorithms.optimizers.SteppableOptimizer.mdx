---
title: SteppableOptimizer (v0.41)
description: API reference for qiskit.algorithms.optimizers.SteppableOptimizer in qiskit v0.41
...
<Class id="qiskit.algorithms.optimizers.SteppableOptimizer" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/algorithms/optimizers/steppable_optimizer.py" signature="SteppableOptimizer(maxiter=100)" modifiers="class">
