...
<Class id="qiskit.providers.ibmq.runtime.RuntimeEncoder" github="https://github.com/qiskit/qiskit-ibmq-provider/tree/stable/0.20/qiskit/providers/ibmq/runtime/utils.py" signature="RuntimeEncoder(*, skipkeys=False, ensure_ascii=True, check_circular=True, allow_nan=True, sort_keys=False, indent=None, separators=None, default=None)">
  ...
  <Function id="qiskit.providers.ibmq.runtime.RuntimeEncoder.default" name="default" signature="RuntimeEncoder.default(obj)">
  ...
  <Function id="qiskit.providers.ibmq.runtime.RuntimeEncoder.encode" name="encode" signature="RuntimeEncoder.encode(o)">
  ...
  <Function id="qiskit.providers.ibmq.runtime.RuntimeEncoder.iterencode" name="iterencode" signature="RuntimeEncoder.iterencode(o, _one_shot=False)">
  ...
  <Attribute id="qiskit.providers.ibmq.runtime.RuntimeEncoder.item_separator" name="item_separator" attributeValue="= ', '" />

  ### key\_separator

  <Attribute id="qiskit.providers.ibmq.runtime.RuntimeEncoder.key_separator" name="key_separator" attributeValue="= ': '" />
</Class>
