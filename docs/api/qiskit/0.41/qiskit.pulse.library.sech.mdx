...
<Function id="qiskit.pulse.library.sech" github="https://github.com/qiskit/qiskit/tree/stable/0.23/qiskit/pulse/library/discrete.py" signature="sech(duration, amp, sigma, name=None, zero_ends=True)">
