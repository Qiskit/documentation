---
title: InstructionSet (v0.41)
description: API reference for qiskit.circuit.InstructionSet in qiskit v0.41
  ...
  **CircuitError** – if both `resource_requester` and `circuit_cregs` are passed. Only one of these may be passed, and it should be `resource_requester`.
  ...
  <Function id="qiskit.circuit.InstructionSet.c_if" signature="InstructionSet.c_if(classical, val)">
    ...
    **Example**
    ...
    ![../\_images/qiskit-circuit-InstructionSet-c\_if-1.png](/docs/images/api/qiskit/0.41/qiskit-circuit-InstructionSet-c_if-1.avif)
  </Function>
