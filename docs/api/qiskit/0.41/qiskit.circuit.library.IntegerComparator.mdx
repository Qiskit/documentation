---
title: IntegerComparator (v0.41)
description: API reference for qiskit.circuit.library.IntegerComparator in qiskit v0.41
...
$$
  ...
  *   **name** (`str`) – Name of the circuit.
  ...
  <Attribute id="qiskit.circuit.library.IntegerComparator.instances" attributeValue="2108" />
