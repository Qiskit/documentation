...
<Class id="qiskit.circuit.EquivalenceLibrary" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/circuit/equivalence.py#L40-L109" signature="qiskit.circuit.EquivalenceLibrary(base=None)" modifiers="class">
  ...
  <Attribute id="qiskit.circuit.EquivalenceLibrary.graph" name="graph" headingLevel={3}>
  ...
  <Function id="qiskit.circuit.EquivalenceLibrary.draw" github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/circuit/equivalence.py#L44-L73" signature="draw(filename=None)">
  ...
  <Function id="qiskit.circuit.EquivalenceLibrary.get_entry" signature="get_entry(gate)">
    Gets the set of [`QuantumCircuit`](/docs/api/qiskit/qiskit.circuit.QuantumCircuit "qiskit.circuit.QuantumCircuit") instances circuits from the library which equivalently implement the given [`Gate`](qiskit.circuit.Gate "qiskit.circuit.Gate").
