...
<Class id="qiskit.passmanager.FlowControllerLinear" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/2.4/qiskit/passmanager/flow_controllers.py#L27-L49" signature="qiskit.passmanager.FlowControllerLinear(tasks=(), *, options=None)" modifiers="class">
  ...
  *   **tasks** (*Task | Iterable\[Task]*)
  ...
  <Function id="qiskit.passmanager.FlowControllerLinear.execute" github="https://github.com/Qiskit/qiskit/tree/stable/2.4/qiskit/passmanager/base_tasks.py#L199-L227" signature="execute(passmanager_ir, state, callback=None)">
  ...
  <Function id="qiskit.passmanager.FlowControllerLinear.iter_tasks" github="https://github.com/Qiskit/qiskit/tree/stable/2.4/qiskit/passmanager/flow_controllers.py#L47-L49" signature="iter_tasks(state)">
    ...
    **Return type**
    ...
    [*Generator*](https://docs.python.org/3/library/collections.abc.html#collections.abc.Generator)\[*Task*, [*PassManagerState*](qiskit.passmanager.PassManagerState "qiskit.passmanager.compilation_status.PassManagerState"), None]
  </Function>
</Class>
