...
<Class id="qiskit.passmanager.FlowControllerLinear" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.2/qiskit/passmanager/flow_controllers.py#L27-L49" signature="qiskit.passmanager.FlowControllerLinear(tasks=(), *, options=None)" modifiers="class">
  ...
  **options** ([*dict*](https://docs.python.org/3/library/stdtypes.html#dict "(in Python v3.13)")*\[*[*str*](https://docs.python.org/3/library/stdtypes.html#str "(in Python v3.13)")*, Any] | None*) – Option for this flow controller.
  ...
  <Function id="qiskit.passmanager.FlowControllerLinear.execute" github="https://github.com/Qiskit/qiskit/tree/stable/1.2/qiskit/passmanager/base_tasks.py#L202-L230" signature="execute(passmanager_ir, state, callback=None)">
  ...
  <Function id="qiskit.passmanager.FlowControllerLinear.iter_tasks" github="https://github.com/Qiskit/qiskit/tree/stable/1.2/qiskit/passmanager/flow_controllers.py#L47-L49" signature="iter_tasks(state)">
