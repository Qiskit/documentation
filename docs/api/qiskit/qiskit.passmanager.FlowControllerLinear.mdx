...
<Class id="qiskit.passmanager.FlowControllerLinear" github="https://github.com/Qiskit/qiskit/tree/stable/1.0/qiskit/passmanager/flow_controllers.py#L27-L49" signature="qiskit.passmanager.FlowControllerLinear(tasks=(), *, options=None)">
