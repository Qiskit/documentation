...
<Class id="qiskit.providers.Provider" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.0/qiskit/providers/provider.py#L20-L29" signature="qiskit.providers.Provider">
