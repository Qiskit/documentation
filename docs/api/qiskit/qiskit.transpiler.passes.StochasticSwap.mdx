...
<Class id="qiskit.transpiler.passes.StochasticSwap" github="https://github.com/Qiskit/qiskit/tree/stable/1.0/qiskit/transpiler/passes/routing/stochastic_swap.py#L48-L468" signature="qiskit.transpiler.passes.StochasticSwap(*args, **kwargs)">
