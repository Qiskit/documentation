...
<Function id="qiskit.result.marginal_counts" name="marginal_counts" github="https://github.com/qiskit/qiskit/tree/stable/1.0/qiskit/result/utils.py" signature="qiskit.result.marginal_counts(result, indices=None, inplace=False, format_marginal=False, marginalize_memory=True)">
...
<Function id="qiskit.result.marginal_distribution" name="marginal_distribution" github="https://github.com/qiskit/qiskit/tree/stable/1.0/qiskit/result/utils.py" signature="qiskit.result.marginal_distribution(counts, indices=None, format_marginal=False)">
  Marginalize counts from an experiment over some indices of interest.
...
<Function id="qiskit.result.marginal_memory" name="marginal_memory" github="https://github.com/qiskit/qiskit/tree/stable/1.0/qiskit/result/utils.py" signature="qiskit.result.marginal_memory(memory, indices=None, int_return=False, hex_return=False, avg_data=False, parallel_threshold=1000)">
...
<Function id="qiskit.result.sampled_expectation_value" name="sampled_expectation_value" github="https://github.com/qiskit/qiskit/tree/stable/1.0/qiskit/result/sampled_expval.py" signature="qiskit.result.sampled_expectation_value(dist, oper)">
