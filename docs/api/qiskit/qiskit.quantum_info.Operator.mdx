...
<Class id="qiskit.quantum_info.Operator" github="https://github.com/Qiskit/qiskit/tree/stable/1.0/qiskit/quantum_info/operators/operator.py#L40-L785" signature="qiskit.quantum_info.Operator(data, input_dims=None, output_dims=None)">
  Bases: `LinearOp`
