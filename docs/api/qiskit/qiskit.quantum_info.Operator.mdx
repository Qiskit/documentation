...
$$
  ...
  **Additional Information:**
  ...
  <Function id="qiskit.quantum_info.Operator.from_circuit" github="https://github.com/Qiskit/qiskit/tree/stable/1.0/qiskit/quantum_info/operators/operator.py#L356-L427" signature="classmethod from_circuit(circuit, ignore_set_layout=False, layout=None, final_layout=None)">
  ...
  <Function id="qiskit.quantum_info.Operator.from_label" github="https://github.com/Qiskit/qiskit/tree/stable/1.0/qiskit/quantum_info/operators/operator.py#L220-L275" signature="classmethod from_label(label)">
