...
[**NotImplementedError**](https://docs.python.org/3/library/exceptions.html#NotImplementedError "(in Python v3.11)") – If `num_result_qubits` is not default and a custom adder is provided.
