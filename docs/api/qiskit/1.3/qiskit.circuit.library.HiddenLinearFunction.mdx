---
title: HiddenLinearFunction (v1.3)
description: API reference for qiskit.circuit.library.HiddenLinearFunction in qiskit v1.3
...
$$
  ...
  **Reference Circuit:**
  ...
  > ![Diagram illustrating the previously described circuit.](/docs/images/api/qiskit/1.3/qiskit-circuit-library-HiddenLinearFunction-1.avif)
