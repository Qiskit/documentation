---
title: plot_state_paulivec (v1.3)
description: API reference for qiskit.visualization.plot_state_paulivec in qiskit v1.3
...
$$
  ...
  **Examples**
  ...
  ![Output from the previous code.](/docs/images/api/qiskit/1.3/qiskit-visualization-plot_state_paulivec-1.avif)
  ...
  ![Output from the previous code.](/docs/images/api/qiskit/1.3/qiskit-visualization-plot_state_paulivec-2.avif)
</Function>
