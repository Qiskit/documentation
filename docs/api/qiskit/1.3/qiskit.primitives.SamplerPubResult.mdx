---
title: SamplerPubResult (v1.3)
description: API reference for qiskit.primitives.SamplerPubResult in qiskit v1.3
...
<Class id="qiskit.primitives.SamplerPubResult" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.3/qiskit/primitives/containers/sampler_pub_result.py#L27-L74" signature="qiskit.primitives.SamplerPubResult(data, metadata=None)" modifiers="class">
  ...
  *   **metadata** ([*dict*](https://docs.python.org/3/library/stdtypes.html#dict)*\[*[*str*](https://docs.python.org/3/library/stdtypes.html#str)*, Any] | None*) – Metadata specific to this pub. Keys are expected to be strings.
  ...
  <Function id="qiskit.primitives.SamplerPubResult.join_data" github="https://github.com/Qiskit/qiskit/tree/stable/1.3/qiskit/primitives/containers/sampler_pub_result.py#L30-L74" signature="join_data(names=None)">
