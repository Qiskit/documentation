---
title: plugin (v1.3)
description: API reference for qiskit.transpiler.passes.synthesis.plugin in qiskit v1.3
...
| Plugin name    | Plugin class                                                                                                                                                              | Number of clean ancillas                                                                                             | Description                                   |
| -------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------- | --------------------------------------------- |
| `"cumulative"` | [`MultiplierSynthesisH18`](qiskit.transpiler.passes.synthesis.hls_plugins.MultiplierSynthesisH18 "qiskit.transpiler.passes.synthesis.hls_plugins.MultiplierSynthesisH18") | depending on the [`HalfAdderGate`](qiskit.circuit.library.HalfAdderGate "qiskit.circuit.library.HalfAdderGate") used | a cumulative adder based on controlled adders |
