---
title: Provider (v1.3)
description: API reference for qiskit.providers.Provider in qiskit v1.3
...
<Class id="qiskit.providers.Provider" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.3/qiskit/providers/provider.py#L21-L39" signature="qiskit.providers.Provider" modifiers="class">
