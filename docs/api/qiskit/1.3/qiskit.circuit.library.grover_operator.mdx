---
title: grover_operator (v1.3)
description: API reference for qiskit.circuit.library.grover_operator in qiskit v1.3
...
$$
  ...
  **Examples**
  ...
  ![Circuit diagram output by the previous code.](/docs/images/api/qiskit/1.3/qiskit-circuit-library-grover_operator-1.avif)
  ...
  ![Circuit diagram output by the previous code.](/docs/images/api/qiskit/1.3/qiskit-circuit-library-grover_operator-2.avif)
  ...
  ![Circuit diagram output by the previous code.](/docs/images/api/qiskit/1.3/qiskit-circuit-library-grover_operator-3.avif)
  ...
  ![Circuit diagram output by the previous code.](/docs/images/api/qiskit/1.3/qiskit-circuit-library-grover_operator-4.avif)
