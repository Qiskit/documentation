---
title: OrGate (v1.3)
description: API reference for qiskit.circuit.library.OrGate in qiskit v1.3
...
<Class id="qiskit.circuit.library.OrGate" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.3/qiskit/circuit/library/boolean_logic/quantum_or.py#L110-L206" signature="qiskit.circuit.library.OrGate(num_variable_qubits, flags=None)" modifiers="class">
  ...
  ![Diagram illustrating the previously described circuit.](/docs/images/api/qiskit/1.3/qiskit-circuit-library-OrGate-1.avif)
  ...
  ![Diagram illustrating the previously described circuit.](/docs/images/api/qiskit/1.3/qiskit-circuit-library-OrGate-2.avif)
  ...
  *   **flags** ([*list*](https://docs.python.org/3/library/stdtypes.html#list)*\[*[*int*](https://docs.python.org/3/library/functions.html#int)*] | None*) – A list of +1/0/-1 marking negations or omissions of qubits.
  ...
  <Function id="qiskit.circuit.library.OrGate.inverse" github="https://github.com/Qiskit/qiskit/tree/stable/1.3/qiskit/circuit/library/boolean_logic/quantum_or.py#L187-L199" signature="inverse(annotated=False)">
