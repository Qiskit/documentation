---
title: ParameterVector (v1.3)
description: API reference for qiskit.circuit.ParameterVector in qiskit v1.3
...
<Class id="qiskit.circuit.ParameterVector" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.3/qiskit/circuit/parametervector.py#L55-L140" signature="qiskit.circuit.ParameterVector(name, length=0)" modifiers="class">
  ...
  <Function id="qiskit.circuit.ParameterVector.index" github="https://github.com/Qiskit/qiskit/tree/stable/1.3/qiskit/circuit/parametervector.py#L91-L95" signature="index(value)">
  ...
  <Function id="qiskit.circuit.ParameterVector.resize" github="https://github.com/Qiskit/qiskit/tree/stable/1.3/qiskit/circuit/parametervector.py#L112-L140" signature="resize(length)">
