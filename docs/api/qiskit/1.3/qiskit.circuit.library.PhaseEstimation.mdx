---
title: PhaseEstimation (v1.3)
description: API reference for qiskit.circuit.library.PhaseEstimation in qiskit v1.3
...
$$
  ...
  **Reference Circuit:**
  ...
  ![Diagram illustrating the previously described circuit.](/docs/images/api/qiskit/1.3/qiskit-circuit-library-PhaseEstimation-1.avif)
