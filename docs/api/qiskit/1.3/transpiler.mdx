---
title: transpiler (v1.3)
description: API reference for qiskit.transpiler in qiskit v1.3
...
![The transpilation process takes the input circuit, applies the transpilation       passes, then produces the output circuit.](/docs/images/api/qiskit/1.3/transpiling_core_steps.avif)
...
![Illustration of how virtual qubits from an input circuit could be mapped to hardware qubits on a backend device's connectivity map.](/docs/images/api/qiskit/1.3/mapping.avif)
...
![Diagram illustrating the previously described circuit.](/docs/images/api/qiskit/1.3/transpiler-6.avif)
...
![Circuit diagram output by the previous code.](/docs/images/api/qiskit/1.3/transpiler-7.avif)
...
![Output from circuit timeline drawer.](/docs/images/api/qiskit/1.3/transpiler-8.avif)
