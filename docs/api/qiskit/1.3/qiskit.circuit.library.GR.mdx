---
title: GR (v1.3)
description: API reference for qiskit.circuit.library.GR in qiskit v1.3
...
$$
  ...
  **Expanded Circuit:**
  ...
  ![Diagram illustrating the previously described circuit.](/docs/images/api/qiskit/1.3/qiskit-circuit-library-GR-1.avif)
