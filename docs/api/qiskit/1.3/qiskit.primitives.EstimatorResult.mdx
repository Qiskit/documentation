---
title: EstimatorResult (v1.3)
description: API reference for qiskit.primitives.EstimatorResult in qiskit v1.3
...
<Class id="qiskit.primitives.EstimatorResult" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.3/qiskit/primitives/base/estimator_result.py#L27-L46" signature="qiskit.primitives.EstimatorResult(values, metadata)" modifiers="class">
