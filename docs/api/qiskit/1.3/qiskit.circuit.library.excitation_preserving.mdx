---
title: excitation_preserving (v1.3)
description: API reference for qiskit.circuit.library.excitation_preserving in qiskit v1.3
...
$$
  ...
  **Examples**
  ...
  ![Circuit diagram output by the previous code.](/docs/images/api/qiskit/1.3/qiskit-circuit-library-excitation_preserving-1.avif)
  ...
  ![Circuit diagram output by the previous code.](/docs/images/api/qiskit/1.3/qiskit-circuit-library-excitation_preserving-2_00.avif)

  ![Circuit diagram output by the previous code.](/docs/images/api/qiskit/1.3/qiskit-circuit-library-excitation_preserving-2_01.avif)
