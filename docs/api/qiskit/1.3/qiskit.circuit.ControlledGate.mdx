---
title: ControlledGate (v1.3)
description: API reference for qiskit.circuit.ControlledGate in qiskit v1.3
...
<Class id="qiskit.circuit.ControlledGate" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.3/qiskit/circuit/controlledgate.py#L28-L276" signature="qiskit.circuit.ControlledGate(name, num_qubits, params, label=None, num_ctrl_qubits=1, definition=None, ctrl_state=None, base_gate=None, duration=None, unit=None, *, _base_label=None)" modifiers="class">
  ...
  *   [**CircuitError**](circuit#qiskit.circuit.CircuitError "qiskit.circuit.CircuitError") – ctrl\_state \< 0 or ctrl\_state > 2\*\*num\_ctrl\_qubits.
  ...
  ![Circuit diagram output by the previous code.](/docs/images/api/qiskit/1.3/qiskit-circuit-ControlledGate-1.avif)
  ...
  ![Circuit diagram output by the previous code.](/docs/images/api/qiskit/1.3/qiskit-circuit-ControlledGate-2.avif)
