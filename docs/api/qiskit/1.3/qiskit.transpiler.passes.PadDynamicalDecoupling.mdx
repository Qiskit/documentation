---
title: PadDynamicalDecoupling (v1.3)
description: API reference for qiskit.transpiler.passes.PadDynamicalDecoupling in qiskit v1.3
...
<Class id="qiskit.transpiler.passes.PadDynamicalDecoupling" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.3/qiskit/transpiler/passes/scheduling/padding/dynamical_decoupling.py#L37-L446" signature="qiskit.transpiler.passes.PadDynamicalDecoupling(*args, **kwargs)" modifiers="class">
  ...
  ![Output from the previous code.](/docs/images/api/qiskit/1.3/qiskit-transpiler-passes-PadDynamicalDecoupling-1_00.avif)

  ![Output from the previous code.](/docs/images/api/qiskit/1.3/qiskit-transpiler-passes-PadDynamicalDecoupling-1_01.avif)
