---
title: DAGCircuit (v1.3)
description: API reference for qiskit.dagcircuit.DAGCircuit in qiskit v1.3
...
<Class id="qiskit.dagcircuit.DAGCircuit" isDedicatedPage={true} signature="qiskit.dagcircuit.DAGCircuit" modifiers="class">
  ...
  <Function id="qiskit.dagcircuit.DAGCircuit.control_flow_op_nodes" signature="control_flow_op_nodes()">
    ...
    **Return type**
    ...
    [list](https://docs.python.org/3/library/stdtypes.html#list)\[[DAGOpNode](qiskit.dagcircuit.DAGOpNode "qiskit.dagcircuit.DAGOpNode")] | None
  </Function>
