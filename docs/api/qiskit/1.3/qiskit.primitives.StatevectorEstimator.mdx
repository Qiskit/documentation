---
title: StatevectorEstimator (v1.3)
description: API reference for qiskit.primitives.StatevectorEstimator in qiskit v1.3
...
<Class id="qiskit.primitives.StatevectorEstimator" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.3/qiskit/primitives/statevector_estimator.py#L31-L175" signature="qiskit.primitives.StatevectorEstimator(*, default_precision=0.0, seed=None)" modifiers="class">
  ...
  ![Output from the previous code.](/docs/images/api/qiskit/1.3/qiskit-primitives-StatevectorEstimator-1.avif)
  ...
  *   **seed** (*np.random.Generator |* [*int*](https://docs.python.org/3/library/functions.html#int) *| None*) – The seed or Generator object for random number generation. If None, a random seeded default RNG will be used.
  ...
  <Function id="qiskit.primitives.StatevectorEstimator.run" github="https://github.com/Qiskit/qiskit/tree/stable/1.3/qiskit/primitives/statevector_estimator.py#L135-L144" signature="run(pubs, *, precision=None)">
