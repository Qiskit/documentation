---
title: DefaultSynthesisClifford (v1.3)
description: API reference for qiskit.transpiler.passes.synthesis.hls_plugins.DefaultSynthesisClifford in qiskit v1.3
