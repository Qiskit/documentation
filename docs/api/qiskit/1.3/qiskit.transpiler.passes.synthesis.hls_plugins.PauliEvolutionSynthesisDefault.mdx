---
title: PauliEvolutionSynthesisDefault (v1.3)
description: API reference for qiskit.transpiler.passes.synthesis.hls_plugins.PauliEvolutionSynthesisDefault in qiskit v1.3
