---
title: AlignEquispaced (v1.3)
description: API reference for qiskit.pulse.transforms.AlignEquispaced in qiskit v1.3
...
<Class id="qiskit.pulse.transforms.AlignEquispaced" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.3/qiskit/pulse/transforms/alignments.py#L259-L325" signature="qiskit.pulse.transforms.AlignEquispaced(duration)" modifiers="class">
  ...
  **duration** ([*int*](https://docs.python.org/3/library/functions.html#int)  *|*[*ParameterExpression*](qiskit.circuit.ParameterExpression "qiskit.circuit.ParameterExpression")) – Duration of this context. This should be larger than the schedule duration. If the specified duration is shorter than the schedule duration, no alignment is performed and the input schedule is just returned. This duration can be parametrized.
  ...
  <Function id="qiskit.pulse.transforms.AlignEquispaced.align" github="https://github.com/Qiskit/qiskit/tree/stable/1.3/qiskit/pulse/transforms/alignments.py#L286-L325" signature="align(schedule)">
