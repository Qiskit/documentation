---
title: hamiltonian_variational_ansatz (v1.3)
description: API reference for qiskit.circuit.library.hamiltonian_variational_ansatz in qiskit v1.3
...
$$
  ...
  **Examples**
  ...
  ![Circuit diagram output by the previous code.](/docs/images/api/qiskit/1.3/qiskit-circuit-library-hamiltonian_variational_ansatz-1.avif)
  ...
  ![Circuit diagram output by the previous code.](/docs/images/api/qiskit/1.3/qiskit-circuit-library-hamiltonian_variational_ansatz-2.avif)
