---
title: YGate (v1.3)
description: API reference for qiskit.circuit.library.YGate in qiskit v1.3
...
<Class id="qiskit.circuit.library.YGate" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.3/qiskit/circuit/library/standard_gates/y.py#L27-L143" signature="qiskit.circuit.library.YGate(*args, _force_mutable=False, **kwargs)" modifiers="class">
...
$$
  ...
  <Function id="qiskit.circuit.library.YGate.control" github="https://github.com/Qiskit/qiskit/tree/stable/1.3/qiskit/circuit/library/standard_gates/y.py#L95-L126" signature="control(num_ctrl_qubits=1, label=None, ctrl_state=None, annotated=False)">
  ...
  <Function id="qiskit.circuit.library.YGate.inverse" github="https://github.com/Qiskit/qiskit/tree/stable/1.3/qiskit/circuit/library/standard_gates/y.py#L128-L140" signature="inverse(annotated=False)">
