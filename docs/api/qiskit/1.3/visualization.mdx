...
![Output from the previous code.](/images/api/qiskit/1.3/visualization-1.avif)
...
![Output from the previous code.](/images/api/qiskit/1.3/visualization-2.avif)
...
![Output from the previous code.](/images/api/qiskit/1.3/visualization-3.avif)
...
![Output from the previous code.](/images/api/qiskit/1.3/visualization-4.avif)
...
![Output from the previous code.](/images/api/qiskit/1.3/visualization-5.avif)
...
![Output from the previous code.](/images/api/qiskit/1.3/visualization-6.avif)
