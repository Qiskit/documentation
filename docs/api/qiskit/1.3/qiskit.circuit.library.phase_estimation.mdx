---
title: phase_estimation (v1.3)
description: API reference for qiskit.circuit.library.phase_estimation in qiskit v1.3
...
$$
  ...
  **Reference Circuit:**
  ...
  ![Circuit diagram output by the previous code.](/docs/images/api/qiskit/1.3/qiskit-circuit-library-phase_estimation-1.avif)
