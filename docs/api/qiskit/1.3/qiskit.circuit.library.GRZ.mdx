---
title: GRZ (v1.3)
description: API reference for qiskit.circuit.library.GRZ in qiskit v1.3
...
$$
  ...
  **Expanded Circuit:**
  ...
  ![Diagram illustrating the previously described circuit.](/docs/images/api/qiskit/1.3/qiskit-circuit-library-GRZ-1.avif)
