---
title: fake_provider (v1.3)
description: API reference for qiskit.providers.fake_provider in qiskit v1.3
...
![Output from the previous code.](/docs/images/api/qiskit/1.3/providers_fake_provider-1_00.avif)

![Output from the previous code.](/docs/images/api/qiskit/1.3/providers_fake_provider-1_01.avif)

![Output from the previous code.](/docs/images/api/qiskit/1.3/providers_fake_provider-1_02.avif)
