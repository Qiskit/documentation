---
title: Job (v1.3)
description: API reference for qiskit.providers.Job in qiskit v1.3
...
<Class id="qiskit.providers.Job" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.3/qiskit/providers/job.py#L30-L39" signature="qiskit.providers.Job" modifiers="class">
