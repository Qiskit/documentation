---
title: PMHSynthesisLinearFunction (v1.3)
description: API reference for qiskit.transpiler.passes.synthesis.hls_plugins.PMHSynthesisLinearFunction in qiskit v1.3
