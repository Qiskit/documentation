---
title: InnerProduct (v1.3)
description: API reference for qiskit.circuit.library.InnerProduct in qiskit v1.3
...
$$
  ...
  **Reference Circuit:**
  ...
  ![Diagram illustrating the previously described circuit.](/docs/images/api/qiskit/1.3/qiskit-circuit-library-InnerProduct-1.avif)
