...
<Class id="qiskit.transpiler.passes.LookaheadSwap" github="https://github.com/qiskit/qiskit/tree/stable/1.0/qiskit/transpiler/passes/routing/lookahead_swap.py" signature="qiskit.transpiler.passes.LookaheadSwap(*args, **kwargs)">
