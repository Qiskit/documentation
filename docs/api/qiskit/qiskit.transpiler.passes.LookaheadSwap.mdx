...
<Class id="qiskit.transpiler.passes.LookaheadSwap" github="https://github.com/Qiskit/qiskit/tree/stable/1.0/qiskit/transpiler/passes/routing/lookahead_swap.py#L50-L181" signature="qiskit.transpiler.passes.LookaheadSwap(*args, **kwargs)">
