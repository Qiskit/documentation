...
<Class id="qiskit.transpiler.passes.synthesis.high_level_synthesis.KMSSynthesisPermutation" github="https://github.com/qiskit/qiskit/tree/stable/1.0/qiskit/transpiler/passes/synthesis/high_level_synthesis.py" signature="qiskit.transpiler.passes.synthesis.high_level_synthesis.KMSSynthesisPermutation">
  ...
  <Function id="qiskit.transpiler.passes.synthesis.high_level_synthesis.KMSSynthesisPermutation.run" name="run" signature="run(high_level_object, coupling_map=None, target=None, qubits=None, **options)">
