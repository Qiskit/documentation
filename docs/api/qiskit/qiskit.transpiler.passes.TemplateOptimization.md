...
`qiskit.transpiler.passes.TemplateOptimization(*args, **kwargs)` [GitHub](https://github.com/qiskit/qiskit/tree/stable/1.0/qiskit/transpiler/passes/optimization/template_optimization.py "view source code")
...
<span id="qiskit.transpiler.passes.TemplateOptimization.execute" />
...
<span id="qiskit.transpiler.passes.TemplateOptimization.update_status" />
