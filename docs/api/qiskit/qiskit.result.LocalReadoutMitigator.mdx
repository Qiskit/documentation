...
<Class id="qiskit.result.LocalReadoutMitigator" github="https://github.com/Qiskit/qiskit/tree/stable/1.0/qiskit/result/mitigation/local_readout_mitigator.py#L27-L319" signature="qiskit.result.LocalReadoutMitigator(assignment_matrices=None, qubits=None, backend=None)">
