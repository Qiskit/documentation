...
`qiskit.transpiler.passes.Collect2qBlocks(*args, **kwargs)` [GitHub](https://github.com/qiskit/qiskit/tree/stable/1.0/qiskit/transpiler/passes/optimization/collect_2q_blocks.py "view source code")
...
<span id="qiskit.transpiler.passes.Collect2qBlocks.execute" />
...
<span id="qiskit.transpiler.passes.Collect2qBlocks.update_status" />
