...
<Function id="qiskit.pulse.builder.inline" name="inline" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.20/qiskit/pulse/builder.py" signature="inline()">
