---
title: plot_state_qsphere (v0.35)
description: API reference for qiskit.visualization.plot_state_qsphere in qiskit v0.35
...
<Function id="qiskit.visualization.plot_state_qsphere" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.20/qiskit/visualization/state_visualization.py" signature="plot_state_qsphere(state, figsize=None, ax=None, show_state_labels=True, show_state_phases=False, use_degrees=False, *, rho=None, filename=None)">
  ...
  **Example**
  ...
  ![../\_images/qiskit.visualization.plot\_state\_qsphere\_0\_0.png](/docs/images/api/qiskit/0.35/qiskit.visualization.plot_state_qsphere_0_0.avif)
</Function>
