---
title: LinearSolverResult (v0.35)
description: API reference for qiskit.algorithms.linear_solvers.LinearSolverResult in qiskit v0.35
...
<Class id="qiskit.algorithms.linear_solvers.LinearSolverResult" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.20/qiskit/algorithms/linear_solvers/linear_solver.py" signature="LinearSolverResult" modifiers="class">
  ...
  <span id="qiskit-algorithms-linear-solvers-linearsolverresult-combine" />
