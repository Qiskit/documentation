---
title: BackendJobLimit (v0.35)
description: API reference for qiskit.providers.ibmq.BackendJobLimit in qiskit v0.35
...
<Class id="qiskit.providers.ibmq.BackendJobLimit" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-ibmq-provider/tree/stable/0.18/qiskit/providers/ibmq/backendjoblimit.py" signature="BackendJobLimit(maximum_jobs, running_jobs, **kwargs)" modifiers="class">
  Bases: `object`
