...
`circuit_to_dagdependency(circuit)` [GitHub](https://github.com/qiskit/qiskit/tree/stable/0.20/qiskit/converters/circuit_to_dagdependency.py "view source code")
