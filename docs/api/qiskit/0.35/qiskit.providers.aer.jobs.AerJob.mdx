---
title: AerJob (v0.35)
description: API reference for qiskit.providers.aer.jobs.AerJob in qiskit v0.35
...
<Class id="qiskit.providers.aer.jobs.AerJob" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-aer/tree/stable/0.10/qiskit/providers/aer/jobs/aerjob.py" signature="AerJob(backend, job_id, fn, qobj, executor=None)" modifiers="class">
  ...
  *   **executor** (*ThreadPoolExecutor or dask.distributed.client*) – The executor to be used to submit the job.
  ...
  <span id="qiskit-providers-aer-jobs-aerjob-in-final-state" />
  ...
  <span id="qiskit-providers-aer-jobs-aerjob-job-id" />
  ...
  <span id="qiskit-providers-aer-jobs-aerjob-wait-for-final-state" />
