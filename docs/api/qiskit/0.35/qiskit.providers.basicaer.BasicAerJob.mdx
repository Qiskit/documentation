---
title: BasicAerJob (v0.35)
description: API reference for qiskit.providers.basicaer.BasicAerJob in qiskit v0.35
...
<Class id="qiskit.providers.basicaer.BasicAerJob" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.20/qiskit/providers/basicaer/basicaerjob.py" signature="BasicAerJob(backend, job_id, result)" modifiers="class">
