---
title: SnapshotExpectationValue (v0.35)
description: API reference for qiskit.providers.aer.extensions.SnapshotExpectationValue in qiskit v0.35
...
<Class id="qiskit.providers.aer.extensions.SnapshotExpectationValue" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-aer/tree/stable/0.10/qiskit/providers/aer/extensions/snapshot_expectation_value.py" signature="SnapshotExpectationValue(label, op, single_shot=False, variance=False)" modifiers="class">
  ...
  **ExtensionError** – if snapshot is invalid.
  ...
  <span id="qiskit-providers-aer-extensions-snapshotexpectationvalue-add-decomposition" />
  ...
  <span id="qiskit-providers-aer-extensions-snapshotexpectationvalue-broadcast-arguments" />
  ...
  <span id="qiskit-providers-aer-extensions-snapshotexpectationvalue-c-if" />
  ...
  <span id="qiskit-providers-aer-extensions-snapshotexpectationvalue-define-snapshot-register" />
  ...
  <span id="qiskit-providers-aer-extensions-snapshotexpectationvalue-is-parameterized" />
  ...
  <span id="qiskit-providers-aer-extensions-snapshotexpectationvalue-reverse-ops" />
  ...
  <span id="qiskit-providers-aer-extensions-snapshotexpectationvalue-soft-compare" />
  ...
  <span id="qiskit-providers-aer-extensions-snapshotexpectationvalue-validate-parameter" />
