...
<Class id="qiskit.transpiler.passes.RemoveDiagonalGatesBeforeMeasure" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.20/qiskit/transpiler/passes/optimization/remove_diagonal_gates_before_measure.py" signature="RemoveDiagonalGatesBeforeMeasure(*args, **kwargs)">
