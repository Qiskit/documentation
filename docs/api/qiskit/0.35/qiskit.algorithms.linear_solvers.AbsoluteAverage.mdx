...
<Class id="qiskit.algorithms.linear_solvers.AbsoluteAverage" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.20/qiskit/algorithms/linear_solvers/observables/absolute_average.py" signature="AbsoluteAverage">
