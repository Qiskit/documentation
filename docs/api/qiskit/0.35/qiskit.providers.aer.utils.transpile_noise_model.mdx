---
title: transpile_noise_model (v0.35)
description: API reference for qiskit.providers.aer.utils.transpile_noise_model in qiskit v0.35
in_page_toc_min_heading_level: 1
python_api_type: function
python_api_name: qiskit.providers.aer.utils.transpile_noise_model
---

<span id="qiskit-providers-aer-utils-transpile-noise-model" />
