...
<Function id="qiskit.providers.aer.utils.transpile_noise_model" name="transpile_noise_model" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-aer/tree/stable/0.10/qiskit/providers/aer/utils/noise_transformation.py" signature="transpile_noise_model(noise_model, **transpile_kwargs)">
