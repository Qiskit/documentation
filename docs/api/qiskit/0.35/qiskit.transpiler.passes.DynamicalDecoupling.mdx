---
title: DynamicalDecoupling (v0.35)
description: API reference for qiskit.transpiler.passes.DynamicalDecoupling in qiskit v0.35
...
<Class id="qiskit.transpiler.passes.DynamicalDecoupling" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.20/qiskit/transpiler/passes/scheduling/dynamical_decoupling.py" signature="DynamicalDecoupling(*args, **kwargs)" modifiers="class">
  ...
  ![../\_images/qiskit.transpiler.passes.DynamicalDecoupling\_1\_0.png](/docs/images/api/qiskit/0.35/qiskit.transpiler.passes.DynamicalDecoupling_1_0.avif)
  ...
  ![../\_images/qiskit.transpiler.passes.DynamicalDecoupling\_2\_0.png](/docs/images/api/qiskit/0.35/qiskit.transpiler.passes.DynamicalDecoupling_2_0.avif)
