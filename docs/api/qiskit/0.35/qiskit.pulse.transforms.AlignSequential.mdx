---
title: AlignSequential (v0.35)
description: API reference for qiskit.pulse.transforms.AlignSequential in qiskit v0.35
...
<Class id="qiskit.pulse.transforms.AlignSequential" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.20/qiskit/pulse/transforms/alignments.py" signature="AlignSequential" modifiers="class">
