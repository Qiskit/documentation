---
title: ShiftFrequency (v0.35)
description: API reference for qiskit.pulse.instructions.ShiftFrequency in qiskit v0.35
...
<Class id="qiskit.pulse.instructions.ShiftFrequency" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.20/qiskit/pulse/instructions/frequency.py" signature="ShiftFrequency(frequency, channel, name=None)" modifiers="class">
