---
title: GR (v0.35)
description: API reference for qiskit.circuit.library.GR in qiskit v0.35
...
<Class id="qiskit.circuit.library.GR" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.20/qiskit/circuit/library/generalized_gates/gr.py" signature="GR(num_qubits, theta, phi)" modifiers="class">
