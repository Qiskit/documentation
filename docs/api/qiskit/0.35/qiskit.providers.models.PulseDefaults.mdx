...
<Class id="qiskit.providers.models.PulseDefaults" github="https://github.com/qiskit/qiskit/tree/stable/0.20/qiskit/providers/models/pulsedefaults.py" signature="PulseDefaults(qubit_freq_est, meas_freq_est, buffer, pulse_library, cmd_def, meas_kernel=None, discriminator=None, **kwargs)">
  Bases: `object`
