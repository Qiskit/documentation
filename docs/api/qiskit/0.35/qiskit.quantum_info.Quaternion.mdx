---
title: Quaternion (v0.35)
description: API reference for qiskit.quantum_info.Quaternion in qiskit v0.35
...
<Class id="qiskit.quantum_info.Quaternion" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.20/qiskit/quantum_info/synthesis/quaternion.py" signature="Quaternion(data)" modifiers="class">
  Bases: `object`
