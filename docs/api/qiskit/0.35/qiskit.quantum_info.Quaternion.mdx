...
<Class id="qiskit.quantum_info.Quaternion" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.20/qiskit/quantum_info/synthesis/quaternion.py" signature="Quaternion(data)">
  ...
  <Function id="qiskit.quantum_info.Quaternion.from_axis_rotation" signature="classmethod Quaternion.from_axis_rotation(angle, axis)">
  ...
  <Function id="qiskit.quantum_info.Quaternion.from_euler" signature="classmethod Quaternion.from_euler(angles, order='yzy')">
