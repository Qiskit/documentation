...
<Class id="qiskit.ignis.mitigation.TensoredExpvalMeasMitigator" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-ignis/tree/stable/0.7/qiskit/ignis/mitigation/expval/tensored_mitigator.py" signature="TensoredExpvalMeasMitigator(amats)">
  ...
  **amats** (`List`\[`ndarray`]) – list of single-qubit readout error assignment matrices.
  ...
  <Function id="qiskit.ignis.mitigation.TensoredExpvalMeasMitigator.assignment_fidelity" name="assignment_fidelity" signature="TensoredExpvalMeasMitigator.assignment_fidelity(qubits=None)">
  ...
  <Function id="qiskit.ignis.mitigation.TensoredExpvalMeasMitigator.assignment_matrix" name="assignment_matrix" signature="TensoredExpvalMeasMitigator.assignment_matrix(qubits=None)">
  ...
  <Function id="qiskit.ignis.mitigation.TensoredExpvalMeasMitigator.expectation_value" name="expectation_value" signature="TensoredExpvalMeasMitigator.expectation_value(counts, diagonal=None, qubits=None, clbits=None)">
  ...
  <Function id="qiskit.ignis.mitigation.TensoredExpvalMeasMitigator.mitigation_matrix" name="mitigation_matrix" signature="TensoredExpvalMeasMitigator.mitigation_matrix(qubits=None)">
  ...
  <Function id="qiskit.ignis.mitigation.TensoredExpvalMeasMitigator.mitigation_overhead" name="mitigation_overhead" signature="TensoredExpvalMeasMitigator.mitigation_overhead(qubits=None)">
  ...
  <Function id="qiskit.ignis.mitigation.TensoredExpvalMeasMitigator.plot_assignment_matrix" name="plot_assignment_matrix" signature="TensoredExpvalMeasMitigator.plot_assignment_matrix(qubits=None, ax=None)">
  ...
  <Function id="qiskit.ignis.mitigation.TensoredExpvalMeasMitigator.plot_mitigation_matrix" name="plot_mitigation_matrix" signature="TensoredExpvalMeasMitigator.plot_mitigation_matrix(qubits=None, ax=None)">
  ...
  <Function id="qiskit.ignis.mitigation.TensoredExpvalMeasMitigator.required_shots" name="required_shots" signature="TensoredExpvalMeasMitigator.required_shots(delta, qubits=None)">
  ...
  <Function id="qiskit.ignis.mitigation.TensoredExpvalMeasMitigator.stddev_upper_bound" name="stddev_upper_bound" signature="TensoredExpvalMeasMitigator.stddev_upper_bound(shots=1, qubits=None)">
