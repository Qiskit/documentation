---
title: assemble_schedules (v0.35)
description: API reference for qiskit.assembler.assemble_schedules in qiskit v0.35
...
<Function id="qiskit.assembler.assemble_schedules" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.20/qiskit/assembler/assemble_schedules.py" signature="assemble_schedules(schedules, qobj_id, qobj_header, run_config)">
