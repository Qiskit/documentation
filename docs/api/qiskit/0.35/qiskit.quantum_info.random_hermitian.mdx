...
<Function id="qiskit.quantum_info.random_hermitian" github="https://github.com/qiskit/qiskit/tree/stable/0.20/qiskit/quantum_info/operators/random.py" signature="random_hermitian(dims, traceless=False, seed=None)">
