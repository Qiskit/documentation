---
title: ApproximatingObjective (v0.35)
description: API reference for qiskit.transpiler.synthesis.aqc.ApproximatingObjective in qiskit v0.35
...
<Class id="qiskit.transpiler.synthesis.aqc.ApproximatingObjective" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.20/qiskit/transpiler/synthesis/aqc/approximate.py" signature="ApproximatingObjective" modifiers="class">
  Bases: `abc.ABC`
