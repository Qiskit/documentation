...
<Class id="qiskit.transpiler.synthesis.aqc.ApproximatingObjective" github="https://github.com/qiskit/qiskit/tree/stable/0.20/qiskit/transpiler/synthesis/aqc/approximate.py" signature="ApproximatingObjective">
  ...
  <Function id="qiskit.transpiler.synthesis.aqc.ApproximatingObjective.gradient" signature="abstract ApproximatingObjective.gradient(param_values)">
  ...
  <Function id="qiskit.transpiler.synthesis.aqc.ApproximatingObjective.objective" signature="abstract ApproximatingObjective.objective(param_values)">
