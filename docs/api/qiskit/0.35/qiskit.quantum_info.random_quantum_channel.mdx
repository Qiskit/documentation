...
<Function id="qiskit.quantum_info.random_quantum_channel" github="https://github.com/qiskit/qiskit/tree/stable/0.20/qiskit/quantum_info/operators/random.py" signature="random_quantum_channel(input_dims=None, output_dims=None, rank=None, seed=None)">
