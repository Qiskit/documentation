---
title: LocalReadoutMitigator (v0.35)
description: API reference for qiskit.result.LocalReadoutMitigator in qiskit v0.35
...
<Class id="qiskit.result.LocalReadoutMitigator" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.20/qiskit/result/mitigation/local_readout_mitigator.py" signature="LocalReadoutMitigator(assignment_matrices=None, qubits=None, backend=None)" modifiers="class">
  ...
  **QiskitError** – matrices sizes do not agree with number of qubits
  ...
  <Function id="qiskit.result.LocalReadoutMitigator.quasi_probabilities" signature="LocalReadoutMitigator.quasi_probabilities(data, qubits=None, clbits=None, shots=False)">
