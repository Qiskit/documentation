...
<Function id="qiskit.utils.summarize_circuits" name="summarize_circuits" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.20/qiskit/utils/circuit_utils.py" signature="summarize_circuits(circuits)">
