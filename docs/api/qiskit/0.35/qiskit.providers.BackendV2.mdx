...
<Class id="qiskit.providers.BackendV2" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.20/qiskit/providers/backend.py" signature="BackendV2(provider=None, name=None, description=None, online_date=None, backend_version=None, **fields)">
  ...
  **AttributeError** – If a field is specified that’s outside the backend’s options
  ...
  <Function id="qiskit.providers.BackendV2.acquire_channel" name="acquire_channel" signature="BackendV2.acquire_channel(qubit)">
  ...
  <Function id="qiskit.providers.BackendV2.control_channel" name="control_channel" signature="BackendV2.control_channel(qubits)">
  ...
  <Function id="qiskit.providers.BackendV2.drive_channel" name="drive_channel" signature="BackendV2.drive_channel(qubit)">
  ...
  <Function id="qiskit.providers.BackendV2.measure_channel" name="measure_channel" signature="BackendV2.measure_channel(qubit)">
  ...
  <Function id="qiskit.providers.BackendV2.qubit_properties" name="qubit_properties" signature="BackendV2.qubit_properties(qubit)">
  ...
  <Function id="qiskit.providers.BackendV2.run" name="run" signature="abstract BackendV2.run(run_input, **options)">
    Run on the backend.
  ...
  <Function id="qiskit.providers.BackendV2.set_options" name="set_options" signature="BackendV2.set_options(**fields)">
