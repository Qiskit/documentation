---
title: ExpvalMeasMitigatorFitter (v0.35)
description: API reference for qiskit.ignis.mitigation.ExpvalMeasMitigatorFitter in qiskit v0.35
...
<Class id="qiskit.ignis.mitigation.ExpvalMeasMitigatorFitter" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-ignis/tree/stable/0.7/qiskit/ignis/mitigation/expval/fitter.py" signature="ExpvalMeasMitigatorFitter(result, metadata)" modifiers="class">
  Bases: `object`
