---
title: Options (v0.35)
description: API reference for qiskit.providers.Options in qiskit v0.35
...
<Class id="qiskit.providers.Options" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.20/qiskit/providers/options.py" signature="Options(**kwargs)" modifiers="class">
  Bases: `object`
