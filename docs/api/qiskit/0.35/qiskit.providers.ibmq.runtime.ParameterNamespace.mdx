...
<Class id="qiskit.providers.ibmq.runtime.ParameterNamespace" github="https://github.com/qiskit/qiskit-ibmq-provider/tree/stable/0.18/qiskit/providers/ibmq/runtime/runtime_program.py" signature="ParameterNamespace(parameters)">
