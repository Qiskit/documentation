...
<Class id="qiskit.transpiler.synthesis.aqc.AQCSynthesisPlugin" github="https://github.com/qiskit/qiskit/tree/stable/0.20/qiskit/transpiler/synthesis/aqc/aqc_plugin.py" signature="AQCSynthesisPlugin">
