...
<span id="qiskit.providers.aer.extensions.Snapshot.condition_bits" />
...
<span id="qiskit.providers.aer.extensions.Snapshot.name" />

### name

Return the name.

<span id="qiskit.providers.aer.extensions.Snapshot.num_clbits" />

### num\_clbits

Return the number of clbits.

<span id="qiskit.providers.aer.extensions.Snapshot.num_qubits" />
