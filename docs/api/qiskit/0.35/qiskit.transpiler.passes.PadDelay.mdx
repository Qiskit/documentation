---
title: PadDelay (v0.35)
description: API reference for qiskit.transpiler.passes.PadDelay in qiskit v0.35
...
<Class id="qiskit.transpiler.passes.PadDelay" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.20/qiskit/transpiler/passes/scheduling/padding/pad_delay.py" signature="PadDelay(fill_very_end=True)" modifiers="class">
