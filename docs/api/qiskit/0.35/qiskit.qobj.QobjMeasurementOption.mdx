---
title: QobjMeasurementOption (v0.35)
description: API reference for qiskit.qobj.QobjMeasurementOption in qiskit v0.35
...
<Class id="qiskit.qobj.QobjMeasurementOption" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.20/qiskit/qobj/pulse_qobj.py" signature="QobjMeasurementOption(name, params=None)" modifiers="class">
  Bases: `object`
