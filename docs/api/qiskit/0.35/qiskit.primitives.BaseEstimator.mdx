...
<Class id="qiskit.primitives.BaseEstimator" github="https://github.com/qiskit/qiskit/tree/stable/0.20/qiskit/primitives/base_estimator.py" signature="BaseEstimator(circuits, observables, parameters=None)">
  Bases: `abc.ABC`
  ...
  **QiskitError** – for mismatch of circuits and parameters list.
  ...
  <Function id="qiskit.primitives.BaseEstimator.close" signature="abstract BaseEstimator.close()">
