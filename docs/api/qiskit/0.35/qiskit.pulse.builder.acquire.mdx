---
title: acquire (v0.35)
description: API reference for qiskit.pulse.builder.acquire in qiskit v0.35
...
<Function id="qiskit.pulse.builder.acquire" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.20/qiskit/pulse/builder.py" signature="acquire(duration, qubit_or_channel, register, **metadata)">
