...
<Class id="qiskit.algorithms.AlgorithmError" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.20/qiskit/algorithms/exceptions.py" signature="AlgorithmError(*message)">
