---
title: SetSuperOp (v0.35)
description: API reference for qiskit.providers.aer.library.SetSuperOp in qiskit v0.35
...
<Class id="qiskit.providers.aer.library.SetSuperOp" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-aer/tree/stable/0.10/qiskit/providers/aer/library/set_instructions/set_superop.py" signature="SetSuperOp(state)" modifiers="class">
  ...
  **ExtensionError** – if the input QuantumChannel is not CPTP.
  ...
  <Attribute id="qiskit.providers.aer.library.SetSuperOp.condition_bits">
  ...
  <Attribute id="qiskit.providers.aer.library.SetSuperOp.name">
    Return the name.
  </Attribute>

  ### num\_clbits

  <Attribute id="qiskit.providers.aer.library.SetSuperOp.num_clbits">
    Return the number of clbits.
  </Attribute>

  ### num\_qubits

  <Attribute id="qiskit.providers.aer.library.SetSuperOp.num_qubits">
