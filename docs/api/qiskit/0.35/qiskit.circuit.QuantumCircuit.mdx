...
<Class id="qiskit.circuit.QuantumCircuit" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.20/qiskit/circuit/quantumcircuit.py" signature="QuantumCircuit(*regs, name=None, global_phase=0, metadata=None)">
  Bases: `object`
  ...
  **Examples**
  ...
  <Function id="qiskit.circuit.QuantumCircuit.assign_parameters" name="assign_parameters" signature="QuantumCircuit.assign_parameters(parameters, inplace=False)">
  ...
  <Function id="qiskit.circuit.QuantumCircuit.barrier" name="barrier" signature="QuantumCircuit.barrier(*qargs)">
  ...
  <Function id="qiskit.circuit.QuantumCircuit.combine" name="combine" signature="QuantumCircuit.combine(rhs)">
  ...
  <Function id="qiskit.circuit.QuantumCircuit.cu1" name="cu1" signature="QuantumCircuit.cu1(theta, control_qubit, target_qubit, label=None, ctrl_state=None)">
  ...
  <Function id="qiskit.circuit.QuantumCircuit.cu3" name="cu3" signature="QuantumCircuit.cu3(theta, phi, lam, control_qubit, target_qubit, label=None, ctrl_state=None)">
  ...
  <Function id="qiskit.circuit.QuantumCircuit.decompose" name="decompose" signature="QuantumCircuit.decompose(gates_to_decompose=None)">
  ...
  <Function id="qiskit.circuit.QuantumCircuit.extend" name="extend" signature="QuantumCircuit.extend(rhs)">
  ...
  <Function id="qiskit.circuit.QuantumCircuit.mcu1" name="mcu1" signature="QuantumCircuit.mcu1(lam, control_qubits, target_qubit)">
    Apply `MCU1Gate`.
  ...
  <Function id="qiskit.circuit.QuantumCircuit.save_amplitudes" name="save_amplitudes" signature="QuantumCircuit.save_amplitudes(params, label='amplitudes', pershot=False, conditional=False)">
  ...
  <Function id="qiskit.circuit.QuantumCircuit.save_amplitudes_squared" name="save_amplitudes_squared" signature="QuantumCircuit.save_amplitudes_squared(params, label='amplitudes_squared', unnormalized=False, pershot=False, conditional=False)">
  ...
  <Function id="qiskit.circuit.QuantumCircuit.save_clifford" name="save_clifford" signature="QuantumCircuit.save_clifford(label='clifford', pershot=False)">
  ...
  <Function id="qiskit.circuit.QuantumCircuit.save_density_matrix" name="save_density_matrix" signature="QuantumCircuit.save_density_matrix(qubits=None, label='density_matrix', unnormalized=False, pershot=False, conditional=False)">
  ...
  <Function id="qiskit.circuit.QuantumCircuit.save_expectation_value" name="save_expectation_value" signature="QuantumCircuit.save_expectation_value(operator, qubits, label='expectation_value', unnormalized=False, pershot=False, conditional=False)">
  ...
  <Function id="qiskit.circuit.QuantumCircuit.save_expectation_value_variance" name="save_expectation_value_variance" signature="QuantumCircuit.save_expectation_value_variance(operator, qubits, label='expectation_value_variance', unnormalized=False, pershot=False, conditional=False)">
    Save the expectation value of a Hermitian operator.
  ...
  <Function id="qiskit.circuit.QuantumCircuit.save_matrix_product_state" name="save_matrix_product_state" signature="QuantumCircuit.save_matrix_product_state(label='matrix_product_state', pershot=False, conditional=False)">
  ...
  <Function id="qiskit.circuit.QuantumCircuit.save_probabilities" name="save_probabilities" signature="QuantumCircuit.save_probabilities(qubits=None, label='probabilities', unnormalized=False, pershot=False, conditional=False)">
  ...
  <Function id="qiskit.circuit.QuantumCircuit.save_probabilities_dict" name="save_probabilities_dict" signature="QuantumCircuit.save_probabilities_dict(qubits=None, label='probabilities', unnormalized=False, pershot=False, conditional=False)">
    Save measurement outcome probabilities vector.
  ...
  <Function id="qiskit.circuit.QuantumCircuit.save_stabilizer" name="save_stabilizer" signature="QuantumCircuit.save_stabilizer(label='stabilizer', pershot=False, conditional=False)">
  ...
  <Function id="qiskit.circuit.QuantumCircuit.save_state" name="save_state" signature="QuantumCircuit.save_state(label=None, pershot=False, conditional=False)">
  ...
  <Function id="qiskit.circuit.QuantumCircuit.save_statevector" name="save_statevector" signature="QuantumCircuit.save_statevector(label='statevector', pershot=False, conditional=False)">
  ...
  <Function id="qiskit.circuit.QuantumCircuit.save_statevector_dict" name="save_statevector_dict" signature="QuantumCircuit.save_statevector_dict(label='statevector', pershot=False, conditional=False)">
  ...
  <Function id="qiskit.circuit.QuantumCircuit.save_superop" name="save_superop" signature="QuantumCircuit.save_superop(label='superop', pershot=False)">
  ...
  <Function id="qiskit.circuit.QuantumCircuit.save_unitary" name="save_unitary" signature="QuantumCircuit.save_unitary(label='unitary', pershot=False)">
  ...
  <Function id="qiskit.circuit.QuantumCircuit.set_density_matrix" name="set_density_matrix" signature="QuantumCircuit.set_density_matrix(state)">
  ...
  <Function id="qiskit.circuit.QuantumCircuit.set_matrix_product_state" name="set_matrix_product_state" signature="QuantumCircuit.set_matrix_product_state(state)">
  ...
  <Function id="qiskit.circuit.QuantumCircuit.set_stabilizer" name="set_stabilizer" signature="QuantumCircuit.set_stabilizer(state)">
  ...
  <Function id="qiskit.circuit.QuantumCircuit.set_statevector" name="set_statevector" signature="QuantumCircuit.set_statevector(state)">
  ...
  <Function id="qiskit.circuit.QuantumCircuit.set_superop" name="set_superop" signature="QuantumCircuit.set_superop(state)">
  ...
  <Function id="qiskit.circuit.QuantumCircuit.set_unitary" name="set_unitary" signature="QuantumCircuit.set_unitary(state)">
  ...
  <Function id="qiskit.circuit.QuantumCircuit.snapshot_density_matrix" name="snapshot_density_matrix" signature="QuantumCircuit.snapshot_density_matrix(label, qubits=None)">
  ...
  <Function id="qiskit.circuit.QuantumCircuit.snapshot_expectation_value" name="snapshot_expectation_value" signature="QuantumCircuit.snapshot_expectation_value(label, op, qubits, single_shot=False, variance=False)">
  ...
  <Function id="qiskit.circuit.QuantumCircuit.snapshot_probabilities" name="snapshot_probabilities" signature="QuantumCircuit.snapshot_probabilities(label, qubits, variance=False)">
  ...
  <Function id="qiskit.circuit.QuantumCircuit.snapshot_stabilizer" name="snapshot_stabilizer" signature="QuantumCircuit.snapshot_stabilizer(label)">
  ...
  <Function id="qiskit.circuit.QuantumCircuit.snapshot_statevector" name="snapshot_statevector" signature="QuantumCircuit.snapshot_statevector(label)">
  ...
  <Function id="qiskit.circuit.QuantumCircuit.u1" name="u1" signature="QuantumCircuit.u1(theta, qubit)">
  ...
  <Function id="qiskit.circuit.QuantumCircuit.u2" name="u2" signature="QuantumCircuit.u2(phi, lam, qubit)">
  ...
  <Function id="qiskit.circuit.QuantumCircuit.u3" name="u3" signature="QuantumCircuit.u3(theta, phi, lam, qubit)">
  ...
  <Attribute id="qiskit.circuit.QuantumCircuit.instances" name="instances" attributeValue="9" />
