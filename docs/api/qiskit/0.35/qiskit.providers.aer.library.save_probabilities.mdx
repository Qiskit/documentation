---
title: save_probabilities (v0.35)
description: API reference for qiskit.providers.aer.library.save_probabilities in qiskit v0.35
in_page_toc_min_heading_level: 1
python_api_type: function
python_api_name: qiskit.providers.aer.library.save_probabilities
---

<span id="qiskit-providers-aer-library-save-probabilities" />
