...
<Class id="qiskit.transpiler.passes.Collect1qRuns" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.20/qiskit/transpiler/passes/optimization/collect_1q_runs.py" signature="Collect1qRuns(*args, **kwargs)">
