...
<Class id="qiskit.algorithms.linear_solvers.NumPyMatrix" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.20/qiskit/algorithms/linear_solvers/matrices/numpy_matrix.py" signature="NumPyMatrix(matrix, tolerance=0.01, evolution_time=1.0, name='np_matrix')">
  ...
  *   **name** (`str`) – The name of the object.
  ...
  <Function id="qiskit.algorithms.linear_solvers.NumPyMatrix.barrier" name="barrier" signature="NumPyMatrix.barrier(*qargs)">
  ...
  <Function id="qiskit.algorithms.linear_solvers.NumPyMatrix.decompose" name="decompose" signature="NumPyMatrix.decompose(gates_to_decompose=None)">
  ...
  <Function id="qiskit.algorithms.linear_solvers.NumPyMatrix.draw" name="draw" signature="NumPyMatrix.draw(*args, **kwargs)">
    ...
    **Example**
    ...
    ![../\_images/qiskit.algorithms.linear\_solvers.NumPyMatrix.draw\_0\_0.png](/images/api/qiskit/0.35/qiskit.algorithms.linear_solvers.NumPyMatrix.draw_0_0.png)
  </Function>
  ...
  <Function id="qiskit.algorithms.linear_solvers.NumPyMatrix.snapshot_density_matrix" name="snapshot_density_matrix" signature="NumPyMatrix.snapshot_density_matrix(label, qubits=None)">
  ...
  <Function id="qiskit.algorithms.linear_solvers.NumPyMatrix.snapshot_expectation_value" name="snapshot_expectation_value" signature="NumPyMatrix.snapshot_expectation_value(label, op, qubits, single_shot=False, variance=False)">
  ...
  <Function id="qiskit.algorithms.linear_solvers.NumPyMatrix.snapshot_probabilities" name="snapshot_probabilities" signature="NumPyMatrix.snapshot_probabilities(label, qubits, variance=False)">
  ...
  <Function id="qiskit.algorithms.linear_solvers.NumPyMatrix.snapshot_stabilizer" name="snapshot_stabilizer" signature="NumPyMatrix.snapshot_stabilizer(label)">
  ...
  <Function id="qiskit.algorithms.linear_solvers.NumPyMatrix.snapshot_statevector" name="snapshot_statevector" signature="NumPyMatrix.snapshot_statevector(label)">
  ...
  <Attribute id="qiskit.algorithms.linear_solvers.NumPyMatrix.instances" name="instances" attributeValue="= 9" />
