---
title: Gaussian (v0.35)
description: API reference for qiskit.pulse.library.Gaussian in qiskit v0.35
...
<Class id="qiskit.pulse.library.Gaussian" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.20/qiskit/pulse/library/parametric_pulses.py" signature="Gaussian(duration, amp, sigma, name=None, limit_amplitude=None)" modifiers="class">
