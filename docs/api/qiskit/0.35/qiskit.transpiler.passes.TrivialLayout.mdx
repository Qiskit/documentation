...
<Class id="qiskit.transpiler.passes.TrivialLayout" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.20/qiskit/transpiler/passes/layout/trivial_layout.py" signature="TrivialLayout(*args, **kwargs)">
  ...
  **Raises**
  ...
  <Function id="qiskit.transpiler.passes.TrivialLayout.name" name="name" signature="TrivialLayout.name()">
    Return the name of the pass.
  </Function>

  ### run

  <Function id="qiskit.transpiler.passes.TrivialLayout.run" name="run" signature="TrivialLayout.run(dag)">
  ...
  <Attribute id="qiskit.transpiler.passes.TrivialLayout.is_analysis_pass" name="is_analysis_pass">
  ...
  <Attribute id="qiskit.transpiler.passes.TrivialLayout.is_transformation_pass" name="is_transformation_pass">
