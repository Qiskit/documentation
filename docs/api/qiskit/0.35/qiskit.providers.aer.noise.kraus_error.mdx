---
title: kraus_error (v0.35)
description: API reference for qiskit.providers.aer.noise.kraus_error in qiskit v0.35
in_page_toc_min_heading_level: 1
python_api_type: function
python_api_name: qiskit.providers.aer.noise.kraus_error
---

<span id="qiskit-providers-aer-noise-kraus-error" />
