---
title: SetLayout (v0.35)
description: API reference for qiskit.transpiler.passes.SetLayout in qiskit v0.35
...
<Class id="qiskit.transpiler.passes.SetLayout" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.20/qiskit/transpiler/passes/layout/set_layout.py" signature="SetLayout(*args, **kwargs)" modifiers="class">
