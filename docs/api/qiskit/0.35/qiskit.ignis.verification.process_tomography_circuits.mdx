---
title: process_tomography_circuits (v0.35)
description: API reference for qiskit.ignis.verification.process_tomography_circuits in qiskit v0.35
...
<Function id="qiskit.ignis.verification.process_tomography_circuits" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-ignis/tree/stable/0.7/qiskit/ignis/verification/tomography/basis/circuits.py" signature="process_tomography_circuits(circuit, measured_qubits, prepared_qubits=None, meas_labels='Pauli', meas_basis='Pauli', prep_labels='Pauli', prep_basis='Pauli')">
