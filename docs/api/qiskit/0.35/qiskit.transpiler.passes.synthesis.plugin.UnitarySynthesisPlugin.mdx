---
title: UnitarySynthesisPlugin (v0.35)
description: API reference for qiskit.transpiler.passes.synthesis.plugin.UnitarySynthesisPlugin in qiskit v0.35
...
<Class id="qiskit.transpiler.passes.synthesis.plugin.UnitarySynthesisPlugin" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.20/qiskit/transpiler/passes/synthesis/plugin.py" signature="UnitarySynthesisPlugin" modifiers="class">
  Bases: `abc.ABC`
