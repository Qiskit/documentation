---
title: dump (v0.35)
description: API reference for qiskit.qasm3.dump in qiskit v0.35
...
<Function id="qiskit.qasm3.dump" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.20/qiskit/qasm3/__init__.py" signature="dump(circuit, stream, **kwargs)">
