---
title: DensityMatrix (v0.35)
description: API reference for qiskit.quantum_info.DensityMatrix in qiskit v0.35
...
<Class id="qiskit.quantum_info.DensityMatrix" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.20/qiskit/quantum_info/states/densitymatrix.py" signature="DensityMatrix(data, dims=None)" modifiers="class">
