...
<Function id="qiskit.pulse.builder.delay" name="delay" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.20/qiskit/pulse/builder.py" signature="delay(duration, channel, name=None)">
