---
title: AND (v0.35)
description: API reference for qiskit.circuit.library.AND in qiskit v0.35
...
<Class id="qiskit.circuit.library.AND" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.20/qiskit/circuit/library/boolean_logic/quantum_and.py" signature="AND(num_variable_qubits, flags=None, mcx_mode='noancilla')" modifiers="class">
