---
title: seconds_to_samples (v0.35)
description: API reference for qiskit.pulse.builder.seconds_to_samples in qiskit v0.35
...
<Function id="qiskit.pulse.builder.seconds_to_samples" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.20/qiskit/pulse/builder.py" signature="seconds_to_samples(seconds)">
