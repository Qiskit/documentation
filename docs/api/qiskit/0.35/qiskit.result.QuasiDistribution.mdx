---
title: QuasiDistribution (v0.35)
description: API reference for qiskit.result.QuasiDistribution in qiskit v0.35
...
<Class id="qiskit.result.QuasiDistribution" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.20/qiskit/result/distributions/quasi.py" signature="QuasiDistribution(data, shots=None, stddev_upper_bound=None)" modifiers="class">
  Bases: `dict`
