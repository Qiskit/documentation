---
title: MaximumLikelihoodAmplitudeEstimationResult (v0.35)
description: API reference for qiskit.algorithms.MaximumLikelihoodAmplitudeEstimationResult in qiskit v0.35
