---
title: ManagedResults (v0.35)
description: API reference for qiskit.providers.ibmq.managed.ManagedResults in qiskit v0.35
...
<Class id="qiskit.providers.ibmq.managed.ManagedResults" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-ibmq-provider/tree/stable/0.18/qiskit/providers/ibmq/managed/managedresults.py" signature="ManagedResults(job_set, backend_name, success)" modifiers="class">
  Bases: `object`
  ...
  *   **success** (`bool`) – `True` if all experiments were successful and results available. `False` otherwise.
  ...
  <span id="qiskit-providers-ibmq-managed-managedresults-combine-results" />
  ...
  <span id="qiskit-providers-ibmq-managed-managedresults-get-counts" />
  ...
  <span id="qiskit-providers-ibmq-managed-managedresults-get-memory" />
  ...
  <span id="qiskit-providers-ibmq-managed-managedresults-get-statevector" />
  ...
  <span id="qiskit-providers-ibmq-managed-managedresults-get-unitary" />
