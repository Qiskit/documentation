...
<Class id="qiskit.dagcircuit.DAGCircuitError" github="https://github.com/qiskit/qiskit/tree/stable/0.20/qiskit/dagcircuit/exceptions.py" signature="DAGCircuitError(*msg)">
