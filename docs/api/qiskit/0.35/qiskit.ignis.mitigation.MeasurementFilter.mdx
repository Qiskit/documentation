---
title: MeasurementFilter (v0.35)
description: API reference for qiskit.ignis.mitigation.MeasurementFilter in qiskit v0.35
...
<Class id="qiskit.ignis.mitigation.MeasurementFilter" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-ignis/tree/stable/0.7/qiskit/ignis/mitigation/measurement/filters.py" signature="MeasurementFilter(cal_matrix, state_labels)" modifiers="class">
  Bases: `object`
