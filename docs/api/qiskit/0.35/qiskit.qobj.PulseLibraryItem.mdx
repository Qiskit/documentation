...
<Class id="qiskit.qobj.PulseLibraryItem" github="https://github.com/qiskit/qiskit/tree/stable/0.20/qiskit/qobj/pulse_qobj.py" signature="PulseLibraryItem(name, samples)">
  Bases: `object`
