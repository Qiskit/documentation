---
title: double_commutator (v0.35)
description: API reference for qiskit.opflow.double_commutator in qiskit v0.35
...
<Function id="qiskit.opflow.double_commutator" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.20/qiskit/opflow/utils.py" signature="double_commutator(op_a, op_b, op_c, sign=False)">
