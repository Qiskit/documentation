...
<Function id="qiskit.utils.detach_prefix" github="https://github.com/qiskit/qiskit/tree/stable/0.20/qiskit/utils/units.py" signature="detach_prefix(value, decimal=None)">
