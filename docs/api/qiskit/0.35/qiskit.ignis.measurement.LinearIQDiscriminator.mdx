...
<Class id="qiskit.ignis.measurement.LinearIQDiscriminator" github="https://github.com/qiskit-community/qiskit-ignis/tree/stable/0.7/qiskit/ignis/measurement/discriminator/iq_discriminators.py" signature="LinearIQDiscriminator(cal_results, qubit_mask, expected_states=None, standardize=False, schedules=None, discriminator_parameters=None)">
  ...
  **ImportError** – If scikit-learn is not installed
  ...
  <Function id="qiskit.ignis.measurement.LinearIQDiscriminator.add_data" name="add_data" signature="LinearIQDiscriminator.add_data(result, expected_states, refit=True, schedules=None)">
    **Parameters**
  ...
  <Function id="qiskit.ignis.measurement.LinearIQDiscriminator.discriminate" name="discriminate" signature="LinearIQDiscriminator.discriminate(x_data)">
  ...
  <Function id="qiskit.ignis.measurement.LinearIQDiscriminator.fit" name="fit" signature="LinearIQDiscriminator.fit()">
    Fits the discriminator using self.\_xdata and self.\_ydata.
  </Function>

  ### format\_iq\_data

  <Function id="qiskit.ignis.measurement.LinearIQDiscriminator.format_iq_data" name="format_iq_data" signature="LinearIQDiscriminator.format_iq_data(iq_data)">
  ...
  <Function id="qiskit.ignis.measurement.LinearIQDiscriminator.get_xdata" name="get_xdata" signature="LinearIQDiscriminator.get_xdata(results, schedule_type_to_get, schedules=None)">
  ...
  <Function id="qiskit.ignis.measurement.LinearIQDiscriminator.get_ydata" name="get_ydata" signature="LinearIQDiscriminator.get_ydata(results, schedule_type_to_get, schedules=None)">
  ...
  <Function id="qiskit.ignis.measurement.LinearIQDiscriminator.is_calibration" name="is_calibration" signature="LinearIQDiscriminator.is_calibration(result_name)">
  ...
  <Function id="qiskit.ignis.measurement.LinearIQDiscriminator.plot" name="plot" signature="LinearIQDiscriminator.plot(axs=None, show_boundary=False, show_fitting_data=True, flag_misclassified=False, qubits_to_plot=None, title=True)">
  ...
  <Function id="qiskit.ignis.measurement.LinearIQDiscriminator.plot_xdata" name="plot_xdata" signature="LinearIQDiscriminator.plot_xdata(axs, results, color=None)">
  ...
  <Attribute id="qiskit.ignis.measurement.LinearIQDiscriminator.expected_states" name="expected_states">
    Returns the expected states used to train the discriminator.
  </Attribute>

  ### fitted

  <Attribute id="qiskit.ignis.measurement.LinearIQDiscriminator.fitted" name="fitted">
    True if the discriminator has been fitted to calibration data.
  </Attribute>

  ### schedules

  <Attribute id="qiskit.ignis.measurement.LinearIQDiscriminator.schedules" name="schedules">
