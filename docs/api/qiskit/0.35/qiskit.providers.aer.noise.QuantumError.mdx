---
title: QuantumError (v0.35)
description: API reference for qiskit.providers.aer.noise.QuantumError in qiskit v0.35
...
<Class id="qiskit.providers.aer.noise.QuantumError" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-aer/tree/stable/0.10/qiskit/providers/aer/noise/errors/quantum_error.py" signature="QuantumError(noise_ops, number_of_qubits=None, standard_gates=None, atol=None)" modifiers="class">
  ...
  **NoiseError** – If input noise\_ops is invalid, e.g. it’s not a CPTP map.
  ...
  <Function id="qiskit.providers.aer.noise.QuantumError.compose" signature="QuantumError.compose(other, qargs=None, front=False)">
  ...
  <Function id="qiskit.providers.aer.noise.QuantumError.dot" signature="QuantumError.dot(other, qargs=None)">
  ...
  <span id="qiskit-providers-aer-noise-quantumerror-error-term" />
  ...
  <span id="qiskit-providers-aer-noise-quantumerror-input-dims" />

  ### input\_dims

  <Function id="qiskit.providers.aer.noise.QuantumError.input_dims" signature="QuantumError.input_dims(qargs=None)">
    Return tuple of input dimension for specified subsystems.
  </Function>

  <span id="qiskit-providers-aer-noise-quantumerror-output-dims" />

  ### output\_dims

  <Function id="qiskit.providers.aer.noise.QuantumError.output_dims" signature="QuantumError.output_dims(qargs=None)">
  ...
  <Function id="qiskit.providers.aer.noise.QuantumError.reshape" signature="QuantumError.reshape(input_dims=None, output_dims=None, num_qubits=None)">
  ...
  <span id="qiskit-providers-aer-noise-quantumerror-set-atol" />
  ...
  <span id="qiskit-providers-aer-noise-quantumerror-set-rtol" />
  ...
  <span id="qiskit-providers-aer-noise-quantumerror-to-dict" />
  ...
  <span id="qiskit-providers-aer-noise-quantumerror-to-instruction" />
  ...
  <span id="qiskit-providers-aer-noise-quantumerror-to-quantumchannel" />
  ...
  <Attribute id="qiskit.providers.aer.noise.QuantumError.atol" attributeValue="1e-08" />
  ...
  <Attribute id="qiskit.providers.aer.noise.QuantumError.dim">
    Return tuple (input\_shape, output\_shape).
  </Attribute>

  ### id

  <Attribute id="qiskit.providers.aer.noise.QuantumError.id">
    Return unique ID string for error
  </Attribute>

  ### num\_qubits

  <Attribute id="qiskit.providers.aer.noise.QuantumError.num_qubits">
  ...
  <Attribute id="qiskit.providers.aer.noise.QuantumError.qargs">
    Return the qargs for the operator.
  </Attribute>

  ### rtol

  <Attribute id="qiskit.providers.aer.noise.QuantumError.rtol" attributeValue="1e-05" />
