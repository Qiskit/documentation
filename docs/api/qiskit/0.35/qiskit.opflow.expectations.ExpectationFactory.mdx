...
<Class id="qiskit.opflow.expectations.ExpectationFactory" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.20/qiskit/opflow/expectations/expectation_factory.py" signature="ExpectationFactory">
  Bases: `object`
  ...
  <Function id="qiskit.opflow.expectations.ExpectationFactory.build" name="build" signature="static ExpectationFactory.build(operator, backend=None, include_custom=True)">
