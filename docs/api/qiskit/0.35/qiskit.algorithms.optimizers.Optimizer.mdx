---
title: Optimizer (v0.35)
description: API reference for qiskit.algorithms.optimizers.Optimizer in qiskit v0.35
...
<Class id="qiskit.algorithms.optimizers.Optimizer" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.20/qiskit/algorithms/optimizers/optimizer.py" signature="Optimizer" modifiers="class">
  Bases: `abc.ABC`
