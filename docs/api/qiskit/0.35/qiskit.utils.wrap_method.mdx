---
title: wrap_method (v0.35)
description: API reference for qiskit.utils.wrap_method in qiskit v0.35
...
<Function id="qiskit.utils.wrap_method" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.20/qiskit/utils/classtools.py" signature="wrap_method(cls, name, *, before=None, after=None)">
