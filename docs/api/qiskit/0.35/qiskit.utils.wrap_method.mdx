...
<Function id="qiskit.utils.wrap_method" github="https://github.com/qiskit/qiskit/tree/stable/0.20/qiskit/utils/classtools.py" signature="wrap_method(cls, name, *, before=None, after=None)">
