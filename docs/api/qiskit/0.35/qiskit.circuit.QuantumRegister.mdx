---
title: QuantumRegister (v0.35)
description: API reference for qiskit.circuit.QuantumRegister in qiskit v0.35
...
<Class id="qiskit.circuit.QuantumRegister" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.20/qiskit/circuit/quantumregister.py" signature="QuantumRegister(size=None, name=None, bits=None)" modifiers="class">
