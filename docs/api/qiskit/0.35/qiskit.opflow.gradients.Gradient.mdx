...
<Class id="qiskit.opflow.gradients.Gradient" github="https://github.com/qiskit/qiskit/tree/stable/0.20/qiskit/opflow/gradients/gradient.py" signature="Gradient(grad_method='param_shift', **kwargs)">
