---
title: UnitaryGate (v0.35)
description: API reference for qiskit.extensions.UnitaryGate in qiskit v0.35
...
<Class id="qiskit.extensions.UnitaryGate" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.20/qiskit/extensions/unitary.py" signature="UnitaryGate(data, label=None)" modifiers="class">
