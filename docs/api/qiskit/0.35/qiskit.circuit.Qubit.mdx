---
title: Qubit (v0.35)
description: API reference for qiskit.circuit.Qubit in qiskit v0.35
...
<Class id="qiskit.circuit.Qubit" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.20/qiskit/circuit/quantumregister.py" signature="Qubit(register=None, index=None)" modifiers="class">
