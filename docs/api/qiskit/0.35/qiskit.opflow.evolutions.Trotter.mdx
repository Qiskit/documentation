---
title: Trotter (v0.35)
description: API reference for qiskit.opflow.evolutions.Trotter in qiskit v0.35
...
<Class id="qiskit.opflow.evolutions.Trotter" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.20/qiskit/opflow/evolutions/trotterizations/trotter.py" signature="Trotter(reps=1)" modifiers="class">
