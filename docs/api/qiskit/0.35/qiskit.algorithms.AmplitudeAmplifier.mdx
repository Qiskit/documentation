...
<Class id="qiskit.algorithms.AmplitudeAmplifier" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.20/qiskit/algorithms/amplitude_amplifiers/amplitude_amplifier.py" signature="AmplitudeAmplifier">
  Bases: `abc.ABC`
