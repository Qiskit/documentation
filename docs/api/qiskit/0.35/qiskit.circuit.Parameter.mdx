...
<Class id="qiskit.circuit.Parameter" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.20/qiskit/circuit/parameter.py" signature="Parameter(name)">
  ...
  **name** (`str`) – name of the `Parameter`, used for visual representation. This can be any unicode string, e.g. “ϕ”.
  ...
  <Function id="qiskit.circuit.Parameter.bind" name="bind" signature="Parameter.bind(parameter_values)">
  ...
  <Function id="qiskit.circuit.Parameter.subs" name="subs" signature="Parameter.subs(parameter_map)">
