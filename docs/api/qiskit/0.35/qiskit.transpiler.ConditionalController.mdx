---
title: ConditionalController (v0.35)
description: API reference for qiskit.transpiler.ConditionalController in qiskit v0.35
...
<Class id="qiskit.transpiler.ConditionalController" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.20/qiskit/transpiler/runningpassmanager.py" signature="ConditionalController(passes, options=None, condition=None, **partial_controller)" modifiers="class">
