---
title: sequence (v0.35)
description: API reference for qiskit.compiler.sequence in qiskit v0.35
...
<Function id="qiskit.compiler.sequence" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.20/qiskit/compiler/sequencer.py" signature="sequence(scheduled_circuits, backend=None, inst_map=None, meas_map=None, dt=None)">
