...
<Class id="qiskit.pulse.transforms.AlignEquispaced" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.20/qiskit/pulse/transforms/alignments.py" signature="AlignEquispaced(duration)">
  ...
  **duration** (`Union`\[`int`, `ParameterExpression`]) – Duration of this context. This should be larger than the schedule duration. If the specified duration is shorter than the schedule duration, no alignment is performed and the input schedule is just returned. This duration can be parametrized.
  ...
  <Function id="qiskit.pulse.transforms.AlignEquispaced.align" name="align" signature="AlignEquispaced.align(schedule)">
  ...
  <Function id="qiskit.pulse.transforms.AlignEquispaced.to_dict" name="to_dict" signature="AlignEquispaced.to_dict()">
  ...
  <Attribute id="qiskit.pulse.transforms.AlignEquispaced.duration" name="duration">
    Return context duration.
  </Attribute>

  ### is\_sequential

  <Attribute id="qiskit.pulse.transforms.AlignEquispaced.is_sequential" name="is_sequential" attributeValue="= True" />
</Class>
