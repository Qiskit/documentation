---
title: state_fidelity (v0.35)
description: API reference for qiskit.quantum_info.state_fidelity in qiskit v0.35
...
<Function id="qiskit.quantum_info.state_fidelity" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.20/qiskit/quantum_info/states/measures.py" signature="state_fidelity(state1, state2, validate=True)">
