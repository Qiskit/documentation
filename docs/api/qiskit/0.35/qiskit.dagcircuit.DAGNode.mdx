---
title: DAGNode (v0.35)
description: API reference for qiskit.dagcircuit.DAGNode in qiskit v0.35
...
<Class id="qiskit.dagcircuit.DAGNode" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.20/qiskit/dagcircuit/dagnode.py" signature="DAGNode(type=None, op=None, name=None, qargs=None, cargs=None, wire=None, nid=- 1)" modifiers="class">
  Bases: `object`
  ...
  <span id="qiskit-dagcircuit-dagnode-semantic-eq" />
