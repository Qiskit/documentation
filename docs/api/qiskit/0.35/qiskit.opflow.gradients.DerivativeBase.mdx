...
<Class id="qiskit.opflow.gradients.DerivativeBase" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.20/qiskit/opflow/gradients/derivative_base.py" signature="DerivativeBase">
  ...
  <Function id="qiskit.opflow.gradients.DerivativeBase.gradient_wrapper" name="gradient_wrapper" signature="DerivativeBase.gradient_wrapper(operator, bind_params, grad_params=None, backend=None, expectation=None)">
    ...
    *   **backend** (`Union`\[`QuantumInstance`, `Backend`, `BaseBackend`, `None`]) – The quantum backend or QuantumInstance to use to evaluate the gradient, Hessian or QFI.
