...
<Class id="qiskit.pulse.library.Constant" github="https://github.com/qiskit/qiskit/tree/stable/0.20/qiskit/pulse/library/parametric_pulses.py" signature="Constant(duration, amp, name=None, limit_amplitude=None)">
