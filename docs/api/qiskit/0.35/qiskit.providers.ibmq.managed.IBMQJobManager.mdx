---
title: IBMQJobManager (v0.35)
description: API reference for qiskit.providers.ibmq.managed.IBMQJobManager in qiskit v0.35
...
<Class id="qiskit.providers.ibmq.managed.IBMQJobManager" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-ibmq-provider/tree/stable/0.18/qiskit/providers/ibmq/managed/ibmqjobmanager.py" signature="IBMQJobManager" modifiers="class">
  Bases: `object`
  ...
  <span id="qiskit-providers-ibmq-managed-ibmqjobmanager-job-sets" />
  ...
  <span id="qiskit-providers-ibmq-managed-ibmqjobmanager-retrieve-job-set" />
