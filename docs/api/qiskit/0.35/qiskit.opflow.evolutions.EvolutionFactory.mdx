...
<Class id="qiskit.opflow.evolutions.EvolutionFactory" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.20/qiskit/opflow/evolutions/evolution_factory.py" signature="EvolutionFactory">
  Bases: `object`
  ...
  <Function id="qiskit.opflow.evolutions.EvolutionFactory.build" name="build" signature="static EvolutionFactory.build(operator=None)">
