...
<Class id="qiskit.transpiler.PropertySet" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.20/qiskit/transpiler/propertyset.py" signature="PropertySet">
  Bases: `dict`
