...
<Function id="qiskit.qasm3.dumps" name="dumps" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.20/qiskit/qasm3/__init__.py" signature="dumps(circuit, **kwargs)">
