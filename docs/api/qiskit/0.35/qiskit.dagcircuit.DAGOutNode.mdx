...
<Class id="qiskit.dagcircuit.DAGOutNode" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.20/qiskit/dagcircuit/dagnode.py" signature="DAGOutNode(wire)">
