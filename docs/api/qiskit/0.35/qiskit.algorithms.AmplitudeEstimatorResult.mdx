...
<Class id="qiskit.algorithms.AmplitudeEstimatorResult" github="https://github.com/qiskit/qiskit/tree/stable/0.20/qiskit/algorithms/amplitude_estimators/amplitude_estimator.py" signature="AmplitudeEstimatorResult">
