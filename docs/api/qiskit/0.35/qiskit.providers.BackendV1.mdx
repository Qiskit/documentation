...
<Class id="qiskit.providers.BackendV1" github="https://github.com/qiskit/qiskit/tree/stable/0.20/qiskit/providers/backend.py" signature="BackendV1(configuration, provider=None, **fields)">
