...
<Class id="qiskit.transpiler.Layout" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.20/qiskit/transpiler/layout.py" signature="Layout(input_dict=None)">
  Bases: `object`
