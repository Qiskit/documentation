...
<Function id="qiskit.utils.apply_prefix" name="apply_prefix" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.20/qiskit/utils/units.py" signature="apply_prefix(value, unit)">
