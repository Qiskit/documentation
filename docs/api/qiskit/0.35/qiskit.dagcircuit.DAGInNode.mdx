...
<Class id="qiskit.dagcircuit.DAGInNode" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.20/qiskit/dagcircuit/dagnode.py" signature="DAGInNode(wire)">
