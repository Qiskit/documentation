...
<Class id="qiskit.dagcircuit.DAGDependency" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.20/qiskit/dagcircuit/dagdependency.py" signature="DAGDependency">
  Bases: `object`
