...
<Function id="qiskit.pulse.builder.measure" github="https://github.com/qiskit/qiskit/tree/stable/0.20/qiskit/pulse/builder.py" signature="measure(qubits, registers=None)">
