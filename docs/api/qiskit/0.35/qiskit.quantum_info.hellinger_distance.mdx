...
<Function id="qiskit.quantum_info.hellinger_distance" github="https://github.com/qiskit/qiskit/tree/stable/0.20/qiskit/quantum_info/analysis/distance.py" signature="hellinger_distance(dist_p, dist_q)">
