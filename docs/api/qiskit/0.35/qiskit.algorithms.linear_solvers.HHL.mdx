---
title: HHL (v0.35)
description: API reference for qiskit.algorithms.linear_solvers.HHL in qiskit v0.35
...
<Class id="qiskit.algorithms.linear_solvers.HHL" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.20/qiskit/algorithms/linear_solvers/hhl.py" signature="HHL(epsilon=0.01, expectation=None, quantum_instance=None)" modifiers="class">
  ...
  *   **quantum\_instance** (`Union`\[`QuantumInstance`, `Backend`, `BaseBackend`, `None`]) – Quantum Instance or Backend. If None, a Statevector calculation is done.
  ...
  <span id="qiskit-algorithms-linear-solvers-hhl-construct-circuit" />
  ...
  <span id="qiskit-algorithms-linear-solvers-hhl-solve" />
