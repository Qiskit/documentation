...
<Class id="qiskit.algorithms.linear_solvers.HHL" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.20/qiskit/algorithms/linear_solvers/hhl.py" signature="HHL(epsilon=0.01, expectation=None, quantum_instance=None)">
  ...
  *   **quantum\_instance** (`Union`\[`QuantumInstance`, `Backend`, `BaseBackend`, `None`]) – Quantum Instance or Backend. If None, a Statevector calculation is done.
  ...
  <Function id="qiskit.algorithms.linear_solvers.HHL.construct_circuit" name="construct_circuit" signature="HHL.construct_circuit(matrix, vector, neg_vals=True)">
  ...
  <Function id="qiskit.algorithms.linear_solvers.HHL.solve" name="solve" signature="HHL.solve(matrix, vector, observable=None, observable_circuit=None, post_processing=None)">
  ...
  <Attribute id="qiskit.algorithms.linear_solvers.HHL.expectation" name="expectation">
  ...
  <Attribute id="qiskit.algorithms.linear_solvers.HHL.quantum_instance" name="quantum_instance">
  ...
  <Attribute id="qiskit.algorithms.linear_solvers.HHL.scaling" name="scaling">
