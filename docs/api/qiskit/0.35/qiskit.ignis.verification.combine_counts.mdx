---
title: combine_counts (v0.35)
description: API reference for qiskit.ignis.verification.combine_counts in qiskit v0.35
in_page_toc_min_heading_level: 1
python_api_type: function
python_api_name: qiskit.ignis.verification.combine_counts
---

<span id="qiskit-ignis-verification-combine-counts" />

# qiskit.ignis.verification.combine\_counts

<Function id="qiskit.ignis.verification.combine_counts" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-ignis/tree/stable/0.7/qiskit/ignis/verification/tomography/data.py" signature="combine_counts(counts1, counts2)">
