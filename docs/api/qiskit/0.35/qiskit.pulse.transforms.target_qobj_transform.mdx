...
<Function id="qiskit.pulse.transforms.target_qobj_transform" name="target_qobj_transform" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.20/qiskit/pulse/transforms/base_transforms.py" signature="target_qobj_transform(sched, remove_directives=True)">
