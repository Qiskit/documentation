...
<Function id="qiskit.quantum_info.random_pauli" github="https://github.com/qiskit/qiskit/tree/stable/0.20/qiskit/quantum_info/operators/symplectic/random.py" signature="random_pauli(num_qubits, group_phase=False, seed=None)">
