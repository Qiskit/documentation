...
$$
  ...
  *   **name** (`str`) – The name of the object.
  ...
  <Function id="qiskit.algorithms.linear_solvers.TridiagonalToeplitz.decompose" name="decompose" signature="TridiagonalToeplitz.decompose(gates_to_decompose=None)">
  ...
  <Attribute id="qiskit.algorithms.linear_solvers.TridiagonalToeplitz.instances" name="instances" attributeValue="= 9" />
