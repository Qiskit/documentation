...
<Class id="qiskit.ignis.verification.Plotter" github="https://github.com/qiskit-community/qiskit-ignis/tree/stable/0.7/qiskit/ignis/verification/entanglement/analysis.py" signature="Plotter(label)">
  Bases: `object`
  ...
  <Function id="qiskit.ignis.verification.Plotter.get_fourier_info" name="get_fourier_info" signature="Plotter.get_fourier_info(qn, x, y, y_m, p_dict)">
  ...
  <Function id="qiskit.ignis.verification.Plotter.sin_plotter" name="sin_plotter" signature="Plotter.sin_plotter(x, y, y_m=None)">
  ...
  <Function id="qiskit.ignis.verification.Plotter.title_maker" name="title_maker" signature="Plotter.title_maker()">
