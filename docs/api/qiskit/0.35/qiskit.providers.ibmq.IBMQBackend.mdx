...
<Class id="qiskit.providers.ibmq.IBMQBackend" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-ibmq-provider/tree/stable/0.18/qiskit/providers/ibmq/ibmqbackend.py" signature="IBMQBackend(configuration, provider, credentials, api_client)">
  ...
  *   **api\_client** (`AccountClient`) – IBM Quantum Experience client used to communicate with the server.
  ...
  <Function id="qiskit.providers.ibmq.IBMQBackend.active_jobs" name="active_jobs" signature="IBMQBackend.active_jobs(limit=10)">
  ...
  <Function id="qiskit.providers.ibmq.IBMQBackend.configuration" name="configuration" signature="IBMQBackend.configuration()">
  ...
  <Function id="qiskit.providers.ibmq.IBMQBackend.defaults" name="defaults" signature="IBMQBackend.defaults(refresh=False)">
  ...
  <Function id="qiskit.providers.ibmq.IBMQBackend.job_limit" name="job_limit" signature="IBMQBackend.job_limit()">
  ...
  <Function id="qiskit.providers.ibmq.IBMQBackend.jobs" name="jobs" signature="IBMQBackend.jobs(limit=10, skip=0, status=None, job_name=None, start_datetime=None, end_datetime=None, job_tags=None, job_tags_operator='OR', experiment_id=None, descending=True, db_filter=None)">
  ...
  <Function id="qiskit.providers.ibmq.IBMQBackend.name" name="name" signature="IBMQBackend.name()">
  ...
  <Function id="qiskit.providers.ibmq.IBMQBackend.properties" name="properties" signature="IBMQBackend.properties(refresh=False, datetime=None)">
  ...
  <Function id="qiskit.providers.ibmq.IBMQBackend.provider" name="provider" signature="IBMQBackend.provider()">
  ...
  <Function id="qiskit.providers.ibmq.IBMQBackend.remaining_jobs_count" name="remaining_jobs_count" signature="IBMQBackend.remaining_jobs_count()">
  ...
  <Function id="qiskit.providers.ibmq.IBMQBackend.reservations" name="reservations" signature="IBMQBackend.reservations(start_datetime=None, end_datetime=None)">
  ...
  <Function id="qiskit.providers.ibmq.IBMQBackend.retrieve_job" name="retrieve_job" signature="IBMQBackend.retrieve_job(job_id)">
  ...
  <Function id="qiskit.providers.ibmq.IBMQBackend.set_options" name="set_options" signature="IBMQBackend.set_options(**fields)">
  ...
  <Function id="qiskit.providers.ibmq.IBMQBackend.status" name="status" signature="IBMQBackend.status()">
  ...
  <Attribute id="qiskit.providers.ibmq.IBMQBackend.id_warning_issued" name="id_warning_issued" attributeValue="False" />

  ### options

  <Attribute id="qiskit.providers.ibmq.IBMQBackend.options" name="options">
  ...
  <Attribute id="qiskit.providers.ibmq.IBMQBackend.qobj_warning_issued" name="qobj_warning_issued" attributeValue="False" />

  ### version

  <Attribute id="qiskit.providers.ibmq.IBMQBackend.version" name="version" attributeValue="1" />
</Class>
