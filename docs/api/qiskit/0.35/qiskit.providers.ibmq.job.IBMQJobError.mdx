...
<Class id="qiskit.providers.ibmq.job.IBMQJobError" github="https://github.com/qiskit/qiskit-ibmq-provider/tree/stable/0.18/qiskit/providers/ibmq/job/exceptions.py" signature="IBMQJobError(*message)">
