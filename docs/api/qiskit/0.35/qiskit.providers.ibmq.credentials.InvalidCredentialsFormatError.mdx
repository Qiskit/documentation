...
<Class id="qiskit.providers.ibmq.credentials.InvalidCredentialsFormatError" name="InvalidCredentialsFormatError" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-ibmq-provider/tree/stable/0.18/qiskit/providers/ibmq/credentials/exceptions.py" signature="InvalidCredentialsFormatError(*message)">
