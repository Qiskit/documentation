...
`qiskit.circuit.ControlFlowOp(name, num_qubits, num_clbits, params, duration=None, unit='dt', label=None)` [GitHub](https://github.com/qiskit/qiskit/tree/stable/1.0/qiskit/circuit/controlflow/control_flow.py "view source code")
...
<span id="qiskit.circuit.ControlFlowOp.base_class" />
...
<span id="qiskit.circuit.ControlFlowOp.condition" />
...
<span id="qiskit.circuit.ControlFlowOp.mutable" />
...
<span id="qiskit.circuit.ControlFlowOp.to_mutable" />
