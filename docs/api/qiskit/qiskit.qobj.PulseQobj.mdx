...
<Class id="qiskit.qobj.PulseQobj" github="https://github.com/qiskit/qiskit/tree/stable/1.0/qiskit/qobj/pulse_qobj.py" signature="qiskit.qobj.PulseQobj(qobj_id, config, experiments, header=None)">
