...
<Class id="qiskit.transpiler.preset_passmanagers.plugin.PassManagerStagePlugin" github="https://github.com/Qiskit/qiskit/tree/stable/1.0/qiskit/transpiler/preset_passmanagers/plugin.py#L174-L199" signature="qiskit.transpiler.preset_passmanagers.plugin.PassManagerStagePlugin">
