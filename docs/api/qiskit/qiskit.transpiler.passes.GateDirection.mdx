...
<Class id="qiskit.transpiler.passes.GateDirection" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.4/qiskit/transpiler/passes/utils/gate_direction.py#L19-L86" signature="qiskit.transpiler.passes.GateDirection(*args, **kwargs)" modifiers="class">
  ...
  *   **target** ([*Target*](qiskit.transpiler.Target "qiskit.transpiler.Target")) – The backend target to use for this pass. If this is specified it will be used instead of the coupling map
  ...
  <Function id="qiskit.transpiler.passes.GateDirection.execute" github="https://github.com/Qiskit/qiskit/tree/stable/1.4/qiskit/transpiler/basepasses.py#L189-L211" signature="execute(passmanager_ir, state, callback=None)">
  ...
  <Function id="qiskit.transpiler.passes.GateDirection.name" github="https://github.com/Qiskit/qiskit/tree/stable/1.4/qiskit/passmanager/base_tasks.py#L68-L70" signature="name()">
    Name of the pass.
  ...
  <Function id="qiskit.transpiler.passes.GateDirection.run" github="https://github.com/Qiskit/qiskit/tree/stable/1.4/qiskit/transpiler/passes/utils/gate_direction.py#L68-L86" signature="run(dag)">
  ...
  <Function id="qiskit.transpiler.passes.GateDirection.update_status" github="https://github.com/Qiskit/qiskit/tree/stable/1.4/qiskit/transpiler/basepasses.py#L213-L221" signature="update_status(state, run_state)">
