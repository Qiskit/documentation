...
<Class id="qiskit.transpiler.passes.synthesis.plugin.UnitarySynthesisPlugin" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/transpiler/passes/synthesis/plugin.py#L404-L633" signature="qiskit.transpiler.passes.synthesis.plugin.UnitarySynthesisPlugin" modifiers="class">
  ...
  <Attribute id="qiskit.transpiler.passes.synthesis.plugin.UnitarySynthesisPlugin.max_qubits" name="max_qubits" headingLevel={3}>
  ...
  <Attribute id="qiskit.transpiler.passes.synthesis.plugin.UnitarySynthesisPlugin.min_qubits" name="min_qubits" headingLevel={3}>
  ...
  <Attribute id="qiskit.transpiler.passes.synthesis.plugin.UnitarySynthesisPlugin.supported_bases" name="supported_bases" headingLevel={3}>
  ...
  <Attribute id="qiskit.transpiler.passes.synthesis.plugin.UnitarySynthesisPlugin.supports_basis_gates" name="supports_basis_gates" headingLevel={3}>
  ...
  <Attribute id="qiskit.transpiler.passes.synthesis.plugin.UnitarySynthesisPlugin.supports_coupling_map" name="supports_coupling_map" headingLevel={3}>
  ...
  <Attribute id="qiskit.transpiler.passes.synthesis.plugin.UnitarySynthesisPlugin.supports_gate_errors" name="supports_gate_errors" headingLevel={3}>
  ...
  <Attribute id="qiskit.transpiler.passes.synthesis.plugin.UnitarySynthesisPlugin.supports_gate_errors_by_qubit" name="supports_gate_errors_by_qubit" headingLevel={3}>
  ...
  <Attribute id="qiskit.transpiler.passes.synthesis.plugin.UnitarySynthesisPlugin.supports_gate_lengths" name="supports_gate_lengths" headingLevel={3}>
  ...
  <Attribute id="qiskit.transpiler.passes.synthesis.plugin.UnitarySynthesisPlugin.supports_gate_lengths_by_qubit" name="supports_gate_lengths_by_qubit" headingLevel={3}>
  ...
  <Attribute id="qiskit.transpiler.passes.synthesis.plugin.UnitarySynthesisPlugin.supports_natural_direction" name="supports_natural_direction" headingLevel={3}>
  ...
  <Attribute id="qiskit.transpiler.passes.synthesis.plugin.UnitarySynthesisPlugin.supports_pulse_optimize" name="supports_pulse_optimize" headingLevel={3}>
    Return whether the plugin supports a toggle to optimize pulses during synthesis as `pulse_optimize`.

    Refer to the documentation for [`UnitarySynthesis`](qiskit.transpiler.passes.UnitarySynthesis "qiskit.transpiler.passes.UnitarySynthesis") for the possible values and meaning of these values.
  </Attribute>

  <Attribute id="qiskit.transpiler.passes.synthesis.plugin.UnitarySynthesisPlugin.supports_target" name="supports_target" headingLevel={3}>
