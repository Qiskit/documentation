...
<Class id="qiskit.circuit.library.GRZ" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/2.3/qiskit/circuit/library/generalized_gates/gr.py#L171-L218" signature="qiskit.circuit.library.GRZ(num_qubits, phi)" modifiers="class">
