...
<Class id="qiskit.circuit.library.GRZ" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/circuit/library/generalized_gates/gr.py#L171-L218" signature="qiskit.circuit.library.GRZ(num_qubits, phi)" modifiers="class">
...
$$
  ...
  **Expanded Circuit:**
  ...
  ![Diagram illustrating the previously described circuit.](/docs/images/api/qiskit/qiskit-circuit-library-GRZ-1.avif)
  ...
  *   **phi** ([*float*](https://docs.python.org/3/library/functions.html#float)) – rotation angle about z-axis
  ...
  <Attribute id="qiskit.circuit.library.GRZ.name" name="name" headingLevel={3}>
