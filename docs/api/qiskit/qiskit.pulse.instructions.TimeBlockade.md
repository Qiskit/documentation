...
`qiskit.pulse.instructions.TimeBlockade(duration, channel, name=None)`
...
*   **duration** ([*int*](https://docs.python.org/3/library/functions.html#int "(in Python v3.11)")) – Length of time of the occupation in terms of dt.
*   **channel** ([*Channel*](pulse#qiskit.pulse.channels.Channel "qiskit.pulse.channels.Channel")) – The channel that will be the occupied.
*   **name** ([*str*](https://docs.python.org/3/library/stdtypes.html#str "(in Python v3.11)") *| None*) – Name of the time blockade for display purposes.
