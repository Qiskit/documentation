...
<Class id="qiskit.synthesis.OneQubitEulerDecomposer" github="https://github.com/qiskit/qiskit/tree/stable/1.0/qiskit/synthesis/one_qubit/one_qubit_decompose.py" signature="qiskit.synthesis.OneQubitEulerDecomposer(basis='U3', use_dag=False)">
  ...
  <Function id="qiskit.synthesis.OneQubitEulerDecomposer.__call__" name="__call__" signature="__call__(unitary, simplify=True, atol=1e-12)">
  ...
  **Raises**
  ...
  <Function id="qiskit.synthesis.OneQubitEulerDecomposer.angles" name="angles" signature="angles(unitary)">
  ...
  <Function id="qiskit.synthesis.OneQubitEulerDecomposer.angles_and_phase" name="angles_and_phase" signature="angles_and_phase(unitary)">
  ...
  <Function id="qiskit.synthesis.OneQubitEulerDecomposer.build_circuit" name="build_circuit" signature="build_circuit(gates, global_phase)">
