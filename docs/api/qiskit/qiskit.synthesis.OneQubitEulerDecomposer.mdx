...
<Class id="qiskit.synthesis.OneQubitEulerDecomposer" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/2.0/qiskit/synthesis/one_qubit/one_qubit_decompose.py#L76-L288" signature="qiskit.synthesis.OneQubitEulerDecomposer(basis='U3', use_dag=False)" modifiers="class">
  ...
  <Function id="qiskit.synthesis.OneQubitEulerDecomposer.__call__" github="https://github.com/Qiskit/qiskit/tree/stable/2.0/qiskit/synthesis/one_qubit/one_qubit_decompose.py#L178-L215" signature="__call__(unitary, simplify=True, atol=1e-12)">
  ...
  **Raises**
  ...
  <Function id="qiskit.synthesis.OneQubitEulerDecomposer.angles" github="https://github.com/Qiskit/qiskit/tree/stable/2.0/qiskit/synthesis/one_qubit/one_qubit_decompose.py#L258-L269" signature="angles(unitary)">
  ...
  <Function id="qiskit.synthesis.OneQubitEulerDecomposer.angles_and_phase" github="https://github.com/Qiskit/qiskit/tree/stable/2.0/qiskit/synthesis/one_qubit/one_qubit_decompose.py#L271-L281" signature="angles_and_phase(unitary)">
  ...
  <Function id="qiskit.synthesis.OneQubitEulerDecomposer.build_circuit" github="https://github.com/Qiskit/qiskit/tree/stable/2.0/qiskit/synthesis/one_qubit/one_qubit_decompose.py#L157-L176" signature="build_circuit(gates, global_phase)">
