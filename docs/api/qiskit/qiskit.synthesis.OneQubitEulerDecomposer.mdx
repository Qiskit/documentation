...
<Class id="qiskit.synthesis.OneQubitEulerDecomposer" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.2/qiskit/synthesis/one_qubit/one_qubit_decompose.py#L76-L288" signature="qiskit.synthesis.OneQubitEulerDecomposer(basis='U3', use_dag=False)" modifiers="class">
  ...
  **Raises**
  ...
  <Function id="qiskit.synthesis.OneQubitEulerDecomposer.angles" github="https://github.com/Qiskit/qiskit/tree/stable/1.2/qiskit/synthesis/one_qubit/one_qubit_decompose.py#L258-L269" signature="angles(unitary)">
    ...
    **unitary** ([*ndarray*](https://numpy.org/doc/stable/reference/generated/numpy.ndarray.html#numpy.ndarray "(in NumPy v2.1)")) – $2\times2$ unitary matrix.
  ...
  <Function id="qiskit.synthesis.OneQubitEulerDecomposer.angles_and_phase" github="https://github.com/Qiskit/qiskit/tree/stable/1.2/qiskit/synthesis/one_qubit/one_qubit_decompose.py#L271-L281" signature="angles_and_phase(unitary)">
    ...
    **unitary** ([*ndarray*](https://numpy.org/doc/stable/reference/generated/numpy.ndarray.html#numpy.ndarray "(in NumPy v2.1)")) – $2\times2$
