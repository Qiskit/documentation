...
<Class id="qiskit.circuit.library.UCGate" github="https://github.com/Qiskit/qiskit/tree/stable/1.0/qiskit/circuit/library/generalized_gates/uc.py#L46-L309" signature="qiskit.circuit.library.UCGate(gate_list, up_to_diagonal=False)">
