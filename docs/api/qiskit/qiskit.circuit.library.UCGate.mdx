...
<Class id="qiskit.circuit.library.UCGate" github="https://github.com/qiskit/qiskit/tree/stable/1.0/qiskit/circuit/library/generalized_gates/uc.py" signature="qiskit.circuit.library.UCGate(gate_list, up_to_diagonal=False)">
...
$$
  ...
  **Raises**
  ...
  <Function id="qiskit.circuit.library.UCGate.inverse" name="inverse" signature="inverse(annotated=False)">
    Return the inverse.
