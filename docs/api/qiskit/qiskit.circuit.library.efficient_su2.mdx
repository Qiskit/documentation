...
<Class id="qiskit.circuit.library.efficient_su2" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.3/qiskit/circuit/library/n_local/efficient_su2.py#L31-L129" signature="qiskit.circuit.library.efficient_su2(num_qubits, su2_gates=None, entanglement='reverse_linear', reps=3, skip_unentangled_qubits=False, skip_final_rotation_layer=False, parameter_prefix='θ', insert_barriers=False, name='EfficientSU2')" modifiers="class">
  Bases:
  ...
  **Examples**
  ...
  ![../\_images/qiskit-circuit-library-efficient\_su2-1.png](/images/api/qiskit/qiskit-circuit-library-efficient_su2-1.png)
  ...
  ![../\_images/qiskit-circuit-library-efficient\_su2-2\_00.png](/images/api/qiskit/qiskit-circuit-library-efficient_su2-2_00.png)

  ![../\_images/qiskit-circuit-library-efficient\_su2-2\_01.png](/images/api/qiskit/qiskit-circuit-library-efficient_su2-2_01.png)
