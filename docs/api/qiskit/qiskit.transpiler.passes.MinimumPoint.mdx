...
<Class id="qiskit.transpiler.passes.MinimumPoint" github="https://github.com/Qiskit/qiskit/tree/stable/1.0/qiskit/transpiler/passes/utils/minimum_point.py#L24-L109" signature="qiskit.transpiler.passes.MinimumPoint(*args, **kwargs)">
