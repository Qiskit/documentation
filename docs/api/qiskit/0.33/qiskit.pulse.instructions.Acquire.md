...
`Acquire(duration, channel, mem_slot=None, reg_slot=None, kernel=None, discriminator=None, name=None)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.19/qiskit/pulse/instructions/acquire.py "view source code")
...
`Acquire.is_parameterized()`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.19/qiskit/pulse/instructions/acquire.py "view source code")
