---
title: AerPauliExpectation (v0.33)
description: API reference for qiskit.opflow.expectations.AerPauliExpectation in qiskit v0.33
...
<Class id="qiskit.opflow.expectations.AerPauliExpectation" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.19/qiskit/opflow/expectations/aer_pauli_expectation.py" signature="AerPauliExpectation" modifiers="class">
