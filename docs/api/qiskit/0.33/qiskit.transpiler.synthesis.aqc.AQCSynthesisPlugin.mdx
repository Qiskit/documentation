---
title: AQCSynthesisPlugin (v0.33)
description: API reference for qiskit.transpiler.synthesis.aqc.AQCSynthesisPlugin in qiskit v0.33
...
<Class id="qiskit.transpiler.synthesis.aqc.AQCSynthesisPlugin" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.19/qiskit/transpiler/synthesis/aqc/aqc_plugin.py" signature="AQCSynthesisPlugin" modifiers="class">
