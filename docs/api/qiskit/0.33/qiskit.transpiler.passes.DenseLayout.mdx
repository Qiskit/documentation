...
<Class id="qiskit.transpiler.passes.DenseLayout" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.19/qiskit/transpiler/passes/layout/dense_layout.py" signature="DenseLayout(*args, **kwargs)">
  ...
  *   **backend\_prop** ([*BackendProperties*](qiskit.providers.models.BackendProperties "qiskit.providers.models.BackendProperties")) – backend properties object
  ...
  <Function id="qiskit.transpiler.passes.DenseLayout.name" name="name" signature="DenseLayout.name()">
    Return the name of the pass.
  </Function>

  ### run

  <Function id="qiskit.transpiler.passes.DenseLayout.run" name="run" signature="DenseLayout.run(dag)">
