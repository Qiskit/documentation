---
title: DAGDependency (v0.33)
description: API reference for qiskit.dagcircuit.DAGDependency in qiskit v0.33
...
<Class id="qiskit.dagcircuit.DAGDependency" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.19/qiskit/dagcircuit/dagdependency.py" signature="DAGDependency" modifiers="class">
  Bases: `object`
