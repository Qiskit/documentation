...
<Class id="qiskit.dagcircuit.DAGDependency" github="https://github.com/qiskit/qiskit/tree/stable/0.19/qiskit/dagcircuit/dagdependency.py" signature="DAGDependency">
  Bases: `object`
