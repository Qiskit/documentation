---
title: IterativePhaseEstimation (v0.33)
description: API reference for qiskit.algorithms.IterativePhaseEstimation in qiskit v0.33
...
<Class id="qiskit.algorithms.IterativePhaseEstimation" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.19/qiskit/algorithms/phase_estimators/ipe.py" signature="IterativePhaseEstimation(num_iterations, quantum_instance=None)" modifiers="class">
