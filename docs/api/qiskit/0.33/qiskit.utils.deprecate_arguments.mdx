...
<Function id="qiskit.utils.deprecate_arguments" name="deprecate_arguments" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.19/qiskit/utils/deprecation.py" signature="deprecate_arguments(kwarg_map)">
