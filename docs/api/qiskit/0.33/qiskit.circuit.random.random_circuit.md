...
`random_circuit(num_qubits, depth, max_operands=3, measure=False, conditional=False, reset=False, seed=None)` [GitHub](https://github.com/qiskit/qiskit/tree/stable/0.19/qiskit/circuit/random/utils.py "view source code")
...
![../\_images/qiskit.circuit.random.random\_circuit\_0\_0.png](/images/api/qiskit/0.33/qiskit.circuit.random.random_circuit_0_0.png)
