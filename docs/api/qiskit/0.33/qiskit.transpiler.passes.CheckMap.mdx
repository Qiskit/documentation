---
title: CheckMap (v0.33)
description: API reference for qiskit.transpiler.passes.CheckMap in qiskit v0.33
...
<Class id="qiskit.transpiler.passes.CheckMap" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.19/qiskit/transpiler/passes/utils/check_map.py" signature="CheckMap(*args, **kwargs)" modifiers="class">
