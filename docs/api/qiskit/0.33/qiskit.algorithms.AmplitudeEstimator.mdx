...
<Class id="qiskit.algorithms.AmplitudeEstimator" github="https://github.com/qiskit/qiskit/tree/stable/0.19/qiskit/algorithms/amplitude_estimators/amplitude_estimator.py" signature="AmplitudeEstimator">
  Bases: `object`
