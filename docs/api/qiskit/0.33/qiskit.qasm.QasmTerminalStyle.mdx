...
<Class id="qiskit.qasm.QasmTerminalStyle" github="https://github.com/qiskit/qiskit/tree/stable/0.19/qiskit/qasm/pygments/lexer.py" signature="QasmTerminalStyle">
