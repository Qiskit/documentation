---
title: QasmTerminalStyle (v0.33)
description: API reference for qiskit.qasm.QasmTerminalStyle in qiskit v0.33
...
<Class id="qiskit.qasm.QasmTerminalStyle" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.19/qiskit/qasm/pygments/lexer.py" signature="QasmTerminalStyle" modifiers="class">
  ...
  <Attribute id="qiskit.qasm.QasmTerminalStyle.web_style_gallery_exclude" attributeValue="False" />
</Class>
