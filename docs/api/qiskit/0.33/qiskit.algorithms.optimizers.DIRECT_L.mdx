---
title: DIRECT_L (v0.33)
description: API reference for qiskit.algorithms.optimizers.DIRECT_L in qiskit v0.33
...
<Class id="qiskit.algorithms.optimizers.DIRECT_L" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.19/qiskit/algorithms/optimizers/nlopts/direct_l.py" signature="DIRECT_L(max_evals=1000)" modifiers="class">
  ...
  **MissingOptionalLibraryError** – NLopt library not installed.
  ...
  <Function id="qiskit.algorithms.optimizers.DIRECT_L.gradient_num_diff" signature="DIRECT_L.gradient_num_diff(x_center, f, epsilon, max_evals_grouped=1)" modifiers="static">
  ...
  <span id="qiskit-algorithms-optimizers-direct-l-optimize" />
