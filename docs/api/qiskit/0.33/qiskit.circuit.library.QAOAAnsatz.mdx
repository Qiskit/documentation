---
title: QAOAAnsatz (v0.33)
description: API reference for qiskit.circuit.library.QAOAAnsatz in qiskit v0.33
...
<Class id="qiskit.circuit.library.QAOAAnsatz" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.19/qiskit/circuit/library/n_local/qaoa_ansatz.py" signature="QAOAAnsatz(cost_operator=None, reps=1, initial_state=None, mixer_operator=None, name='QAOA')" modifiers="class">
