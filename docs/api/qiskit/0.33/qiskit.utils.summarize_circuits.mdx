---
title: summarize_circuits (v0.33)
description: API reference for qiskit.utils.summarize_circuits in qiskit v0.33
...
<Function id="qiskit.utils.summarize_circuits" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.19/qiskit/utils/circuit_utils.py" signature="summarize_circuits(circuits)">
