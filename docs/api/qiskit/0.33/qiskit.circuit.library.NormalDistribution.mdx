...
<Class id="qiskit.circuit.library.NormalDistribution" github="https://github.com/qiskit/qiskit/tree/stable/0.19/qiskit/circuit/library/probability_distributions/normal.py" signature="NormalDistribution(num_qubits, mu=None, sigma=None, bounds=None, upto_diag=False, name='P(X)')">
