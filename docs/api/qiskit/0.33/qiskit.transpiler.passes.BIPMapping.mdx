---
title: BIPMapping (v0.33)
description: API reference for qiskit.transpiler.passes.BIPMapping in qiskit v0.33
...
<Class id="qiskit.transpiler.passes.BIPMapping" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.19/qiskit/transpiler/passes/routing/bip_mapping.py" signature="BIPMapping(*args, **kwargs)" modifiers="class">
