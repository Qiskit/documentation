...
<Class id="qiskit.transpiler.passes.BIPMapping" github="https://github.com/qiskit/qiskit/tree/stable/0.19/qiskit/transpiler/passes/routing/bip_mapping.py" signature="BIPMapping(*args, **kwargs)">
