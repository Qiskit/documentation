---
title: GRZ (v0.33)
description: API reference for qiskit.circuit.library.GRZ in qiskit v0.33
...
<Class id="qiskit.circuit.library.GRZ" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.19/qiskit/circuit/library/generalized_gates/gr.py" signature="GRZ(num_qubits, phi)" modifiers="class">
