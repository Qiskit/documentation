---
title: dag_to_dagdependency (v0.33)
description: API reference for qiskit.converters.dag_to_dagdependency in qiskit v0.33
...
<Function id="qiskit.converters.dag_to_dagdependency" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.19/qiskit/converters/dag_to_dagdependency.py" signature="dag_to_dagdependency(dag)">
