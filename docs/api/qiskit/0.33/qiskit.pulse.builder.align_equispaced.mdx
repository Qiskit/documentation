...
<Function id="qiskit.pulse.builder.align_equispaced" name="align_equispaced" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.19/qiskit/pulse/builder.py" signature="align_equispaced(duration)">
