---
title: ast_to_dag (v0.33)
description: API reference for qiskit.converters.ast_to_dag in qiskit v0.33
...
<Function id="qiskit.converters.ast_to_dag" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.19/qiskit/converters/ast_to_dag.py" signature="ast_to_dag(ast)">
  ...
  **Example**
  ...
  ![../\_images/qiskit.converters.ast\_to\_dag\_0\_0.png](/docs/images/api/qiskit/0.33/qiskit.converters.ast_to_dag_0_0.avif)
</Function>
