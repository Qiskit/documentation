---
title: save_amplitudes_squared (v0.33)
description: API reference for qiskit.providers.aer.library.save_amplitudes_squared in qiskit v0.33
...
<Function id="qiskit.providers.aer.library.save_amplitudes_squared" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-aer/tree/stable/0.9/qiskit/providers/aer/library/save_instructions/save_amplitudes.py" signature="save_amplitudes_squared(self, params, label='amplitudes_squared', unnormalized=False, pershot=False, conditional=False)">
