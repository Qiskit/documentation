...
<Function id="qiskit.converters.circuit_to_dagdependency" github="https://github.com/qiskit/qiskit/tree/stable/0.19/qiskit/converters/circuit_to_dagdependency.py" signature="circuit_to_dagdependency(circuit)">
