...
`DictToCircuitSum.convert(operator)` [GitHub](https://github.com/qiskit/qiskit/tree/stable/0.19/qiskit/opflow/converters/dict_to_circuit_sum.py "view source code")
