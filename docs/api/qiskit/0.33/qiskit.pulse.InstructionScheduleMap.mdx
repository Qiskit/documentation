---
title: InstructionScheduleMap (v0.33)
description: API reference for qiskit.pulse.InstructionScheduleMap in qiskit v0.33
...
<Class id="qiskit.pulse.InstructionScheduleMap" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.19/qiskit/pulse/instruction_schedule_map.py" signature="InstructionScheduleMap" modifiers="class">
  Bases: `object`
