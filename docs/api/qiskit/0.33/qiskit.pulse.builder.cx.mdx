---
title: cx (v0.33)
description: API reference for qiskit.pulse.builder.cx in qiskit v0.33
...
<Function id="qiskit.pulse.builder.cx" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.19/qiskit/pulse/builder.py" signature="cx(control, target)">
