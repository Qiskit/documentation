---
title: CYGate (v0.33)
description: API reference for qiskit.circuit.library.CYGate in qiskit v0.33
...
<Class id="qiskit.circuit.library.CYGate" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.19/qiskit/circuit/library/standard_gates/y.py" signature="CYGate(label=None, ctrl_state=None)" modifiers="class">
