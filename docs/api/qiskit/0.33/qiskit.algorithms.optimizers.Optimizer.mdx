---
title: Optimizer (v0.33)
description: API reference for qiskit.algorithms.optimizers.Optimizer in qiskit v0.33
...
<Class id="qiskit.algorithms.optimizers.Optimizer" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.19/qiskit/algorithms/optimizers/optimizer.py" signature="Optimizer" modifiers="class">
  Bases: `abc.ABC`
  ...
  <Function id="qiskit.algorithms.optimizers.Optimizer.gradient_num_diff" signature="Optimizer.gradient_num_diff(x_center, f, epsilon, max_evals_grouped=1)" modifiers="static">
