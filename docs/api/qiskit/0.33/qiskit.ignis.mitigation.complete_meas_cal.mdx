---
title: complete_meas_cal (v0.33)
description: API reference for qiskit.ignis.mitigation.complete_meas_cal in qiskit v0.33
...
<Function id="qiskit.ignis.mitigation.complete_meas_cal" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-ignis/tree/stable/0.7/qiskit/ignis/mitigation/measurement/circuits.py" signature="complete_meas_cal(qubit_list=None, qr=None, cr=None, circlabel='')">
