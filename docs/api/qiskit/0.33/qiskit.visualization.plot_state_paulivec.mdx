...
`plot_state_paulivec(state, title='', figsize=None, color=None, ax=None, *, rho=None, filename=None)` [GitHub](https://github.com/qiskit/qiskit/tree/stable/0.19/qiskit/visualization/state_visualization.py "view source code")
...
![../\_images/qiskit.visualization.plot\_state\_paulivec\_0\_0.png](/images/api/qiskit/0.33/qiskit.visualization.plot_state_paulivec_0_0.png)
