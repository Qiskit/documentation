---
title: PauliGate (v0.33)
description: API reference for qiskit.circuit.library.PauliGate in qiskit v0.33
...
<Class id="qiskit.circuit.library.PauliGate" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.19/qiskit/circuit/library/generalized_gates/pauli.py" signature="PauliGate(label)" modifiers="class">
