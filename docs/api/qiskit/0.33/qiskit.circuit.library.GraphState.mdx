---
title: GraphState (v0.33)
description: API reference for qiskit.circuit.library.GraphState in qiskit v0.33
...
<Class id="qiskit.circuit.library.GraphState" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.19/qiskit/circuit/library/graph_state.py" signature="GraphState(adjacency_matrix)" modifiers="class">
