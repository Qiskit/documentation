---
title: ShiftPhase (v0.33)
description: API reference for qiskit.pulse.instructions.ShiftPhase in qiskit v0.33
...
<Class id="qiskit.pulse.instructions.ShiftPhase" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.19/qiskit/pulse/instructions/phase.py" signature="ShiftPhase(phase, channel, name=None)" modifiers="class">
