...
<Class id="qiskit.quantum_info.StabilizerState" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.19/qiskit/quantum_info/states/stabilizerstate.py" signature="StabilizerState(data, validate=True)">
  ...
  *   **validate** (*boolean*) – validate that the stabilizer state data is a valid Clifford.
  ...
  <Function id="qiskit.quantum_info.StabilizerState.conjugate" name="conjugate" signature="StabilizerState.conjugate()">
    Return the conjugate of the operator.
  </Function>

  ### copy

  <Function id="qiskit.quantum_info.StabilizerState.copy" name="copy" signature="StabilizerState.copy()">
    Make a copy of current operator.
  </Function>

  ### dims

  <Function id="qiskit.quantum_info.StabilizerState.dims" name="dims" signature="StabilizerState.dims(qargs=None)">
    Return tuple of input dimension for specified subsystems.
  </Function>

  ### evolve

  <Function id="qiskit.quantum_info.StabilizerState.evolve" name="evolve" signature="StabilizerState.evolve(other, qargs=None)">
  ...
  <Function id="qiskit.quantum_info.StabilizerState.expand" name="expand" signature="StabilizerState.expand(other)">
  ...
  <Function id="qiskit.quantum_info.StabilizerState.expectation_value" name="expectation_value" signature="StabilizerState.expectation_value(oper, qargs=None)">
  ...
  <Function id="qiskit.quantum_info.StabilizerState.is_valid" name="is_valid" signature="StabilizerState.is_valid(atol=None, rtol=None)">
    Return True if a valid StabilizerState.
  </Function>

  ### measure

  <Function id="qiskit.quantum_info.StabilizerState.measure" name="measure" signature="StabilizerState.measure(qargs=None)">
  ...
  <Function id="qiskit.quantum_info.StabilizerState.probabilities" name="probabilities" signature="StabilizerState.probabilities(qargs=None, decimals=None)">
  ...
  <Function id="qiskit.quantum_info.StabilizerState.probabilities_dict" name="probabilities_dict" signature="StabilizerState.probabilities_dict(qargs=None, decimals=None)">
  ...
  <Function id="qiskit.quantum_info.StabilizerState.purity" name="purity" signature="StabilizerState.purity()">
  ...
  <Function id="qiskit.quantum_info.StabilizerState.reset" name="reset" signature="StabilizerState.reset(qargs=None)">
  ...
  <Function id="qiskit.quantum_info.StabilizerState.sample_counts" name="sample_counts" signature="StabilizerState.sample_counts(shots, qargs=None)">
  ...
  <Function id="qiskit.quantum_info.StabilizerState.sample_memory" name="sample_memory" signature="StabilizerState.sample_memory(shots, qargs=None)">
  ...
  <Function id="qiskit.quantum_info.StabilizerState.seed" name="seed" signature="StabilizerState.seed(value=None)">
    Set the seed for the quantum state RNG.
  </Function>

  ### tensor

  <Function id="qiskit.quantum_info.StabilizerState.tensor" name="tensor" signature="StabilizerState.tensor(other)">
  ...
  <Function id="qiskit.quantum_info.StabilizerState.to_operator" name="to_operator" signature="StabilizerState.to_operator()">
    Convert state to matrix operator class
  </Function>

  ### trace

  <Function id="qiskit.quantum_info.StabilizerState.trace" name="trace" signature="StabilizerState.trace()">
  ...
  <Attribute id="qiskit.quantum_info.StabilizerState.clifford" name="clifford">
    Return StabilizerState Clifford data
  </Attribute>

  ### dim

  <Attribute id="qiskit.quantum_info.StabilizerState.dim" name="dim">
    Return total state dimension.
  </Attribute>

  ### num\_qubits

  <Attribute id="qiskit.quantum_info.StabilizerState.num_qubits" name="num_qubits">
