---
title: schedule (v0.33)
description: API reference for qiskit.compiler.schedule in qiskit v0.33
...
<Function id="qiskit.compiler.schedule" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.19/qiskit/compiler/scheduler.py" signature="schedule(circuits, backend=None, inst_map=None, meas_map=None, dt=None, method=None)">
