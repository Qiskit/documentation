---
title: HamiltonianGate (v0.33)
description: API reference for qiskit.extensions.HamiltonianGate in qiskit v0.33
...
<Class id="qiskit.extensions.HamiltonianGate" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.19/qiskit/extensions/hamiltonian_gate.py" signature="HamiltonianGate(data, time, label=None)" modifiers="class">
