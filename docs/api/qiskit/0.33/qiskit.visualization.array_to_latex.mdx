...
<Function id="qiskit.visualization.array_to_latex" name="array_to_latex" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.19/qiskit/visualization/array.py" signature="array_to_latex(array, precision=5, prefix='', source=False, max_size=8)">
