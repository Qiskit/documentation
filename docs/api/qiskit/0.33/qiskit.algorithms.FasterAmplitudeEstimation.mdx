---
title: FasterAmplitudeEstimation (v0.33)
description: API reference for qiskit.algorithms.FasterAmplitudeEstimation in qiskit v0.33
...
<Class id="qiskit.algorithms.FasterAmplitudeEstimation" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.19/qiskit/algorithms/amplitude_estimators/fae.py" signature="FasterAmplitudeEstimation(delta, maxiter, rescale=True, quantum_instance=None)" modifiers="class">
