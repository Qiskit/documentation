---
title: NELDER_MEAD (v0.33)
description: API reference for qiskit.algorithms.optimizers.NELDER_MEAD in qiskit v0.33
...
<Class id="qiskit.algorithms.optimizers.NELDER_MEAD" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.19/qiskit/algorithms/optimizers/nelder_mead.py" signature="NELDER_MEAD(maxiter=None, maxfev=1000, disp=False, xatol=0.0001, tol=None, adaptive=False, options=None, **kwargs)" modifiers="class">
