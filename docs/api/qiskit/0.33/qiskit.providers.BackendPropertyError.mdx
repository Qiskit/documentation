...
<Class id="qiskit.providers.BackendPropertyError" github="https://github.com/qiskit/qiskit/tree/stable/0.19/qiskit/providers/exceptions.py" signature="BackendPropertyError(*message)">
