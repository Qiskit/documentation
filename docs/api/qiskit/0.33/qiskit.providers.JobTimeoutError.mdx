...
<Class id="qiskit.providers.JobTimeoutError" github="https://github.com/qiskit/qiskit/tree/stable/0.19/qiskit/providers/exceptions.py" signature="JobTimeoutError(*message)">
