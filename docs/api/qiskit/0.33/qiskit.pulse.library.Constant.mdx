---
title: Constant (v0.33)
description: API reference for qiskit.pulse.library.Constant in qiskit v0.33
...
<Class id="qiskit.pulse.library.Constant" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.19/qiskit/pulse/library/parametric_pulses.py" signature="Constant(duration, amp, name=None, limit_amplitude=None)" modifiers="class">
