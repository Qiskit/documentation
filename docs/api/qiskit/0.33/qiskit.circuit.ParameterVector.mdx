---
title: ParameterVector (v0.33)
description: API reference for qiskit.circuit.ParameterVector in qiskit v0.33
...
<Class id="qiskit.circuit.ParameterVector" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.19/qiskit/circuit/parametervector.py" signature="ParameterVector(name, length=0)" modifiers="class">
  Bases: `object`
