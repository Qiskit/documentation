...
<Function id="qiskit.quantum_info.entanglement_of_formation" name="entanglement_of_formation" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.19/qiskit/quantum_info/states/measures.py" signature="entanglement_of_formation(state)">
