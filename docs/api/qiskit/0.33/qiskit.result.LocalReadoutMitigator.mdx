...
<Class id="qiskit.result.LocalReadoutMitigator" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.19/qiskit/result/mitigation/local_readout_mitigator.py" signature="LocalReadoutMitigator(amats=None, qubits=None, backend=None)">
