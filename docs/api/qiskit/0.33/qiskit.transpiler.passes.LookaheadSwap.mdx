...
<Class id="qiskit.transpiler.passes.LookaheadSwap" github="https://github.com/qiskit/qiskit/tree/stable/0.19/qiskit/transpiler/passes/routing/lookahead_swap.py" signature="LookaheadSwap(*args, **kwargs)">
