...
<Function id="qiskit.ignis.verification.get_ghz_mqc_para" github="https://github.com/qiskit-community/qiskit-ignis/tree/stable/0.7/qiskit/ignis/verification/entanglement/linear.py" signature="get_ghz_mqc_para(n, full_measurement=True)">
