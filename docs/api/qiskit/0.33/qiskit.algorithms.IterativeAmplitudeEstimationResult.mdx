---
title: IterativeAmplitudeEstimationResult (v0.33)
description: API reference for qiskit.algorithms.IterativeAmplitudeEstimationResult in qiskit v0.33
...
<Class id="qiskit.algorithms.IterativeAmplitudeEstimationResult" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.19/qiskit/algorithms/amplitude_estimators/iae.py" signature="IterativeAmplitudeEstimationResult" modifiers="class">
