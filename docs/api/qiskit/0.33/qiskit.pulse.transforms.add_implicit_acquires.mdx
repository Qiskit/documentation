---
title: add_implicit_acquires (v0.33)
description: API reference for qiskit.pulse.transforms.add_implicit_acquires in qiskit v0.33
...
<Function id="qiskit.pulse.transforms.add_implicit_acquires" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.19/qiskit/pulse/transforms/canonicalization.py" signature="add_implicit_acquires(schedule, meas_map)">
