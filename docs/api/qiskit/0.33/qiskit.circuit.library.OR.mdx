---
title: OR (v0.33)
description: API reference for qiskit.circuit.library.OR in qiskit v0.33
...
<Class id="qiskit.circuit.library.OR" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.19/qiskit/circuit/library/boolean_logic/quantum_or.py" signature="OR(num_variable_qubits, flags=None, mcx_mode='noancilla')" modifiers="class">
