...
`DynamicalDecoupling(*args, **kwargs)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.19/qiskit/transpiler/passes/scheduling/dynamical_decoupling.py "view source code")
...
![../\_images/qiskit.transpiler.passes.DynamicalDecoupling\_1\_0.png](/images/api/qiskit/0.33/qiskit.transpiler.passes.DynamicalDecoupling_1_0.png)
...
![../\_images/qiskit.transpiler.passes.DynamicalDecoupling\_2\_0.png](/images/api/qiskit/0.33/qiskit.transpiler.passes.DynamicalDecoupling_2_0.png)
...
`DynamicalDecoupling.run(dag)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.19/qiskit/transpiler/passes/scheduling/dynamical_decoupling.py "view source code")
