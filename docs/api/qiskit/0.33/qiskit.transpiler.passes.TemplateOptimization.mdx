---
title: TemplateOptimization (v0.33)
description: API reference for qiskit.transpiler.passes.TemplateOptimization in qiskit v0.33
...
<Class id="qiskit.transpiler.passes.TemplateOptimization" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.19/qiskit/transpiler/passes/optimization/template_optimization.py" signature="TemplateOptimization(*args, **kwargs)" modifiers="class">
