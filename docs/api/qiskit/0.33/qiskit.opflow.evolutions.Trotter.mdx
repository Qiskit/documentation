...
<Class id="qiskit.opflow.evolutions.Trotter" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.19/qiskit/opflow/evolutions/trotterizations/trotter.py" signature="Trotter(reps=1)">
