---
title: samples_to_seconds (v0.33)
description: API reference for qiskit.pulse.builder.samples_to_seconds in qiskit v0.33
...
<Function id="qiskit.pulse.builder.samples_to_seconds" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.19/qiskit/pulse/builder.py" signature="samples_to_seconds(samples)">
