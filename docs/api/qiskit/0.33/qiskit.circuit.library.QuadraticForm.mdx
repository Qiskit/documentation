---
title: QuadraticForm (v0.33)
description: API reference for qiskit.circuit.library.QuadraticForm in qiskit v0.33
...
<Class id="qiskit.circuit.library.QuadraticForm" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.19/qiskit/circuit/library/arithmetic/quadratic_form.py" signature="QuadraticForm(num_result_qubits=None, quadratic=None, linear=None, offset=None, little_endian=True)" modifiers="class">
