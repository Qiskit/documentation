---
title: CorrelatedReadoutMitigator (v0.33)
description: API reference for qiskit.result.CorrelatedReadoutMitigator in qiskit v0.33
...
<Class id="qiskit.result.CorrelatedReadoutMitigator" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.19/qiskit/result/mitigation/correlated_readout_mitigator.py" signature="CorrelatedReadoutMitigator(amat, qubits=None)" modifiers="class">
