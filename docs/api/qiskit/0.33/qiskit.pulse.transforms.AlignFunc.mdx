...
<Class id="qiskit.pulse.transforms.AlignFunc" github="https://github.com/qiskit/qiskit/tree/stable/0.19/qiskit/pulse/transforms/alignments.py" signature="AlignFunc(duration, func)">
