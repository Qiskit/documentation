---
title: name_args (v0.33)
description: API reference for qiskit.utils.name_args in qiskit v0.33
...
<Function id="qiskit.utils.name_args" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.19/qiskit/utils/name_unnamed_args.py" signature="name_args(mapping, skip=0)">
