...
<Class id="qiskit.providers.aer.jobs.AerJobSet" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-aer/tree/stable/0.9/qiskit/providers/aer/jobs/aerjobset.py" signature="AerJobSet(backend, job_id, fn, experiments, executor=None)">
