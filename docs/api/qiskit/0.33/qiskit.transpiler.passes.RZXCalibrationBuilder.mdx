...
<Class id="qiskit.transpiler.passes.RZXCalibrationBuilder" github="https://github.com/qiskit/qiskit/tree/stable/0.19/qiskit/transpiler/passes/calibration/builders.py" signature="RZXCalibrationBuilder(backend=None, instruction_schedule_map=None, qubit_channel_mapping=None)">
