...
`plot_state_hinton(state, title='', figsize=None, ax_real=None, ax_imag=None, *, rho=None, filename=None)` [GitHub](https://github.com/qiskit/qiskit/tree/stable/0.19/qiskit/visualization/state_visualization.py "view source code")
...
![../\_images/qiskit.visualization.plot\_state\_hinton\_0\_0.png](/images/api/qiskit/0.33/qiskit.visualization.plot_state_hinton_0_0.png)
