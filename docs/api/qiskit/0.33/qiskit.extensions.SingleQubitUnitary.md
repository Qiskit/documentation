...
`SingleQubitUnitary(unitary_matrix, mode='ZYZ', up_to_diagonal=False)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.19/qiskit/extensions/quantum_initializer/squ.py "view source code")
...
`SingleQubitUnitary.inverse()`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.19/qiskit/extensions/quantum_initializer/squ.py "view source code")
...
<span id="qiskit.extensions.SingleQubitUnitary.mirror" />
...
`SingleQubitUnitary.validate_parameter(parameter)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.19/qiskit/extensions/quantum_initializer/squ.py "view source code")
