---
title: DerivativeBase (v0.33)
description: API reference for qiskit.opflow.gradients.DerivativeBase in qiskit v0.33
...
<Class id="qiskit.opflow.gradients.DerivativeBase" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.19/qiskit/opflow/gradients/derivative_base.py" signature="DerivativeBase" modifiers="class">
