---
title: Optimize1qGatesDecomposition (v0.33)
description: API reference for qiskit.transpiler.passes.Optimize1qGatesDecomposition in qiskit v0.33
...
<Class id="qiskit.transpiler.passes.Optimize1qGatesDecomposition" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.19/qiskit/transpiler/passes/optimization/optimize_1q_decomposition.py" signature="Optimize1qGatesDecomposition(*args, **kwargs)" modifiers="class">
