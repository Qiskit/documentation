...
<Class id="qiskit.opflow.converters.AbelianGrouper" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.19/qiskit/opflow/converters/abelian_grouper.py" signature="AbelianGrouper(traverse=True)">
