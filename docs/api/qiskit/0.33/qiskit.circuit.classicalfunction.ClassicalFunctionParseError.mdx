...
<Class id="qiskit.circuit.classicalfunction.ClassicalFunctionParseError" github="https://github.com/qiskit/qiskit/tree/stable/0.19/qiskit/circuit/classicalfunction/exceptions.py" signature="ClassicalFunctionParseError(*message)">
