---
title: DAGInNode (v0.33)
description: API reference for qiskit.dagcircuit.DAGInNode in qiskit v0.33
...
<Class id="qiskit.dagcircuit.DAGInNode" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.19/qiskit/dagcircuit/dagnode.py" signature="DAGInNode(wire)" modifiers="class">
