...
<Function id="qiskit.quantum_info.shannon_entropy" name="shannon_entropy" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.19/qiskit/quantum_info/states/utils.py" signature="shannon_entropy(pvec, base=2)">
