---
title: TaperedPauliSumOp (v0.33)
description: API reference for qiskit.opflow.primitive_ops.TaperedPauliSumOp in qiskit v0.33
...
<Class id="qiskit.opflow.primitive_ops.TaperedPauliSumOp" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.19/qiskit/opflow/primitive_ops/tapered_pauli_sum_op.py" signature="TaperedPauliSumOp(primitive, z2_symmetries, coeff=1.0)" modifiers="class">
