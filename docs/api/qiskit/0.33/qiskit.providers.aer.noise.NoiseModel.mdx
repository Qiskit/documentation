...
<Class id="qiskit.providers.aer.noise.NoiseModel" github="https://github.com/qiskit/qiskit-aer/tree/stable/0.9/qiskit/providers/aer/noise/noise_model.py" signature="NoiseModel(basis_gates=None)">
  Bases: `object`
  ...
  **basis\_gates** (*list\[str] or None*) – Specify an initial basis\_gates for the noise model. If None a default value of \[‘id’, ‘rz’, ‘sx’, ‘cx’] is used (Default: None).
  ...
  <Function id="qiskit.providers.aer.noise.NoiseModel.from_backend" signature="classmethod NoiseModel.from_backend(backend, gate_error=True, readout_error=True, thermal_relaxation=True, temperature=0, gate_lengths=None, gate_length_units='ns', standard_gates=True, warnings=True)">
