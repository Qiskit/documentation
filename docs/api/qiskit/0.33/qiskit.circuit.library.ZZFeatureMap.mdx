---
title: ZZFeatureMap (v0.33)
description: API reference for qiskit.circuit.library.ZZFeatureMap in qiskit v0.33
...
<Class id="qiskit.circuit.library.ZZFeatureMap" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.19/qiskit/circuit/library/data_preparation/zz_feature_map.py" signature="ZZFeatureMap(feature_dimension, reps=2, entanglement='full', data_map_func=None, insert_barriers=False, name='ZZFeatureMap')" modifiers="class">
