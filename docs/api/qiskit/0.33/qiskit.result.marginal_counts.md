...
`marginal_counts(result, indices=None, inplace=False, format_marginal=False)` [GitHub](https://github.com/qiskit/qiskit/tree/stable/0.19/qiskit/result/utils.py "view source code")
