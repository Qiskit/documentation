...
`pauli_basis(num_qubits, weight=False, pauli_list=False)` [GitHub](https://github.com/qiskit/qiskit/tree/stable/0.19/qiskit/quantum_info/operators/symplectic/pauli_utils.py "view source code")
