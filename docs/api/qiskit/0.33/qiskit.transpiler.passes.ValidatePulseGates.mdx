---
title: ValidatePulseGates (v0.33)
description: API reference for qiskit.transpiler.passes.ValidatePulseGates in qiskit v0.33
...
<Class id="qiskit.transpiler.passes.ValidatePulseGates" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.19/qiskit/transpiler/passes/scheduling/instruction_alignment.py" signature="ValidatePulseGates(granularity=1, min_length=1)" modifiers="class">
