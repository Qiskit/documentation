...
<Function id="qiskit.circuit.qpy_serialization.load" github="https://github.com/qiskit/qiskit/tree/stable/0.19/qiskit/circuit/qpy_serialization.py" signature="load(file_obj)">
