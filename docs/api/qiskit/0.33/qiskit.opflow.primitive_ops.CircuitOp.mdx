---
title: CircuitOp (v0.33)
description: API reference for qiskit.opflow.primitive_ops.CircuitOp in qiskit v0.33
...
<Class id="qiskit.opflow.primitive_ops.CircuitOp" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.19/qiskit/opflow/primitive_ops/circuit_op.py" signature="CircuitOp(primitive, coeff=1.0)" modifiers="class">
