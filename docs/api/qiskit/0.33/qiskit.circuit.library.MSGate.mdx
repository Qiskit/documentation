---
title: MSGate (v0.33)
description: API reference for qiskit.circuit.library.MSGate in qiskit v0.33
...
<Class id="qiskit.circuit.library.MSGate" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.19/qiskit/circuit/library/standard_gates/ms.py" signature="MSGate(num_qubits, theta, label=None)" modifiers="class">
