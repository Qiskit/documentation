---
title: inline (v0.33)
description: API reference for qiskit.pulse.builder.inline in qiskit v0.33
...
<Function id="qiskit.pulse.builder.inline" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.19/qiskit/pulse/builder.py" signature="inline()">
