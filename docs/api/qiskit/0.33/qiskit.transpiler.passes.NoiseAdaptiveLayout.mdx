---
title: NoiseAdaptiveLayout (v0.33)
description: API reference for qiskit.transpiler.passes.NoiseAdaptiveLayout in qiskit v0.33
...
<Class id="qiskit.transpiler.passes.NoiseAdaptiveLayout" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.19/qiskit/transpiler/passes/layout/noise_adaptive_layout.py" signature="NoiseAdaptiveLayout(*args, **kwargs)" modifiers="class">
