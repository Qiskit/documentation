---
title: C4XGate (v0.33)
description: API reference for qiskit.circuit.library.C4XGate in qiskit v0.33
...
<Class id="qiskit.circuit.library.C4XGate" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.19/qiskit/circuit/library/standard_gates/x.py" signature="C4XGate(label=None, ctrl_state=None)" modifiers="class">
