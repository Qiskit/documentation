---
title: ExpectationBase (v0.33)
description: API reference for qiskit.opflow.expectations.ExpectationBase in qiskit v0.33
...
<Class id="qiskit.opflow.expectations.ExpectationBase" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.19/qiskit/opflow/expectations/expectation_base.py" signature="ExpectationBase" modifiers="class">
