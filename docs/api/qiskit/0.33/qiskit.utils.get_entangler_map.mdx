...
<Function id="qiskit.utils.get_entangler_map" name="get_entangler_map" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.19/qiskit/utils/entangler_map.py" signature="get_entangler_map(map_type, num_qubits, offset=0)">
