...
<Function id="qiskit.pulse.transforms.flatten" name="flatten" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.19/qiskit/pulse/transforms/canonicalization.py" signature="flatten(program)">
