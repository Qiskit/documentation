...
`ast_to_dag(ast)` [GitHub](https://github.com/qiskit/qiskit/tree/stable/0.19/qiskit/converters/ast_to_dag.py "view source code")
...
![../\_images/qiskit.converters.ast\_to\_dag\_0\_0.png](/images/api/qiskit/0.33/qiskit.converters.ast_to_dag_0_0.png)
