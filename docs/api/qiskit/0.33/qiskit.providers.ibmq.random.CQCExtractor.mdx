...
<Class id="qiskit.providers.ibmq.random.CQCExtractor" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-ibmq-provider/tree/stable/0.18/qiskit/providers/ibmq/random/cqcextractor.py" signature="CQCExtractor(name, provider, client, methods)">
  ...
  *   **methods** (`List`) – Service methods.
  ...
  <Function id="qiskit.providers.ibmq.random.CQCExtractor.retrieve_job" name="retrieve_job" signature="CQCExtractor.retrieve_job(job_id)">
  ...
  <Function id="qiskit.providers.ibmq.random.CQCExtractor.run" name="run" signature="CQCExtractor.run(ext1_input_num_bits, ext1_output_num_bits, ext1_raw_bytes, ext1_wsr_bytes, ext2_seed_num_bits, ext2_wsr_multiplier, ext2_wsr_generator=None)">
  ...
  <Function id="qiskit.providers.ibmq.random.CQCExtractor.run_async_ext1" name="run_async_ext1" signature="CQCExtractor.run_async_ext1(ext1_input_num_bits, ext1_output_num_bits, ext1_raw_bytes, ext1_wsr_bytes)">
  ...
  <Function id="qiskit.providers.ibmq.random.CQCExtractor.run_async_ext2" name="run_async_ext2" signature="CQCExtractor.run_async_ext2(ext2_seed, ext2_seed_num_bits, ext2_wsr_multiplier, ext2_wsr_generator=None)">
