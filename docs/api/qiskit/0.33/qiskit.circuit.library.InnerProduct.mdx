---
title: InnerProduct (v0.33)
description: API reference for qiskit.circuit.library.InnerProduct in qiskit v0.33
...
<Class id="qiskit.circuit.library.InnerProduct" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.19/qiskit/circuit/library/boolean_logic/inner_product.py" signature="InnerProduct(num_qubits)" modifiers="class">
