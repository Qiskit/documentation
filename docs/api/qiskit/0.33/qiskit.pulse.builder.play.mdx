...
<Function id="qiskit.pulse.builder.play" github="https://github.com/qiskit/qiskit/tree/stable/0.19/qiskit/pulse/builder.py" signature="play(pulse, channel, name=None)">
