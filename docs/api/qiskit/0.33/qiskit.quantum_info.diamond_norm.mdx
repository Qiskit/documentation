...
<Function id="qiskit.quantum_info.diamond_norm" name="diamond_norm" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.19/qiskit/quantum_info/operators/measures.py" signature="diamond_norm(choi, **kwargs)">
