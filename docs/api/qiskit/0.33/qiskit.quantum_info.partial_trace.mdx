...
<Function id="qiskit.quantum_info.partial_trace" name="partial_trace" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.19/qiskit/quantum_info/states/utils.py" signature="partial_trace(state, qargs)">
