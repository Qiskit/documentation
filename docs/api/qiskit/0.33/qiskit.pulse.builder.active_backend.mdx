...
<Function id="qiskit.pulse.builder.active_backend" name="active_backend" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.19/qiskit/pulse/builder.py" signature="active_backend()">
