---
title: CheckGateDirection (v0.33)
description: API reference for qiskit.transpiler.passes.CheckGateDirection in qiskit v0.33
...
<Class id="qiskit.transpiler.passes.CheckGateDirection" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.19/qiskit/transpiler/passes/utils/check_gate_direction.py" signature="CheckGateDirection(*args, **kwargs)" modifiers="class">
