...
<Class id="qiskit.algorithms.HHL" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.19/qiskit/algorithms/linear_solvers/hhl.py" signature="HHL(epsilon=0.01, expectation=None, quantum_instance=None)">
  ...
  *   **quantum\_instance** (`Union`\[`Backend`, `BaseBackend`, `QuantumInstance`, `None`]) – Quantum Instance or Backend. If None, a Statevector calculation is done.
  ...
  <Function id="qiskit.algorithms.HHL.construct_circuit" name="construct_circuit" signature="HHL.construct_circuit(matrix, vector, neg_vals=True)">
  ...
  <Function id="qiskit.algorithms.HHL.solve" name="solve" signature="HHL.solve(matrix, vector, observable=None, observable_circuit=None, post_processing=None)">
  ...
  <Attribute id="qiskit.algorithms.HHL.expectation" name="expectation">
  ...
  <Attribute id="qiskit.algorithms.HHL.quantum_instance" name="quantum_instance">
  ...
  <Attribute id="qiskit.algorithms.HHL.scaling" name="scaling">
