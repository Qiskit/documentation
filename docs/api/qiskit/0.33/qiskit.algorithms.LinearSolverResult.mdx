---
title: LinearSolverResult (v0.33)
description: API reference for qiskit.algorithms.LinearSolverResult in qiskit v0.33
...
<Class id="qiskit.algorithms.LinearSolverResult" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.19/qiskit/algorithms/linear_solvers/linear_solver.py" signature="LinearSolverResult" modifiers="class">
