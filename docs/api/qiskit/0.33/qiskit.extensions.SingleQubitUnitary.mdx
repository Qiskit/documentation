---
title: SingleQubitUnitary (v0.33)
description: API reference for qiskit.extensions.SingleQubitUnitary in qiskit v0.33
...
<Class id="qiskit.extensions.SingleQubitUnitary" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.19/qiskit/extensions/quantum_initializer/squ.py" signature="SingleQubitUnitary(unitary_matrix, mode='ZYZ', up_to_diagonal=False)" modifiers="class">
