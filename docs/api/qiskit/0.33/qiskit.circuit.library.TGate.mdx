---
title: TGate (v0.33)
description: API reference for qiskit.circuit.library.TGate in qiskit v0.33
...
<Class id="qiskit.circuit.library.TGate" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.19/qiskit/circuit/library/standard_gates/t.py" signature="TGate(label=None)" modifiers="class">
