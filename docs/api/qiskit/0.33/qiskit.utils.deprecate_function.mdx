...
<Function id="qiskit.utils.deprecate_function" github="https://github.com/qiskit/qiskit/tree/stable/0.19/qiskit/utils/deprecation.py" signature="deprecate_function(msg, stacklevel=2)">
