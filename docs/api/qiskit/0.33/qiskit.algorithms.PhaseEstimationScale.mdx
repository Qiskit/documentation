...
<Class id="qiskit.algorithms.PhaseEstimationScale" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.19/qiskit/algorithms/phase_estimators/phase_estimation_scale.py" signature="PhaseEstimationScale(bound)">
  Bases: `object`
