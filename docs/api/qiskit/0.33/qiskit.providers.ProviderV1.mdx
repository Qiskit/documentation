---
title: ProviderV1 (v0.33)
description: API reference for qiskit.providers.ProviderV1 in qiskit v0.33
...
<Class id="qiskit.providers.ProviderV1" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.19/qiskit/providers/provider.py" signature="ProviderV1" modifiers="class">
