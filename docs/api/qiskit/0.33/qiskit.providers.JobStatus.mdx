...
description: API reference for qiskit.providers.JobStatus in qiskit v0.33
...
<Class id="qiskit.providers.JobStatus" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.19/qiskit/providers/jobstatus.py" signature="JobStatus(value)" modifiers="class">
  Bases: `enum.Enum`
