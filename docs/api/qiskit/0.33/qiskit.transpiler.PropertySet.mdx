---
title: PropertySet (v0.33)
description: API reference for qiskit.transpiler.PropertySet in qiskit v0.33
...
<Class id="qiskit.transpiler.PropertySet" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.19/qiskit/transpiler/propertyset.py" signature="PropertySet" modifiers="class">
  Bases: `dict`
