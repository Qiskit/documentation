---
title: Unroll3qOrMore (v0.33)
description: API reference for qiskit.transpiler.passes.Unroll3qOrMore in qiskit v0.33
...
<Class id="qiskit.transpiler.passes.Unroll3qOrMore" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.19/qiskit/transpiler/passes/basis/unroll_3q_or_more.py" signature="Unroll3qOrMore(*args, **kwargs)" modifiers="class">
