---
title: Diagonal (v0.33)
description: API reference for qiskit.circuit.library.Diagonal in qiskit v0.33
...
<Class id="qiskit.circuit.library.Diagonal" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.19/qiskit/circuit/library/generalized_gates/diagonal.py" signature="Diagonal(diag)" modifiers="class">
