...
<Class id="qiskit.qobj.PulseQobjExperimentConfig" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.19/qiskit/qobj/pulse_qobj.py" signature="PulseQobjExperimentConfig(qubit_lo_freq=None, meas_lo_freq=None, **kwargs)">
  ...
  *   **kwargs** – Additional free form key value fields to add to the configuration
  ...
  <Function id="qiskit.qobj.PulseQobjExperimentConfig.from_dict" name="from_dict" signature="classmethod PulseQobjExperimentConfig.from_dict(data)">
  ...
  <Function id="qiskit.qobj.PulseQobjExperimentConfig.to_dict" name="to_dict" signature="PulseQobjExperimentConfig.to_dict()">
