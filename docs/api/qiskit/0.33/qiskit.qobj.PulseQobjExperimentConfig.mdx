...
<Class id="qiskit.qobj.PulseQobjExperimentConfig" github="https://github.com/qiskit/qiskit/tree/stable/0.19/qiskit/qobj/pulse_qobj.py" signature="PulseQobjExperimentConfig(qubit_lo_freq=None, meas_lo_freq=None, **kwargs)">
