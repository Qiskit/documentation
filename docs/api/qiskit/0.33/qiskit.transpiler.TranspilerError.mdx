...
<Class id="qiskit.transpiler.TranspilerError" github="https://github.com/qiskit/qiskit/tree/stable/0.19/qiskit/transpiler/exceptions.py" signature="TranspilerError(*message)">
