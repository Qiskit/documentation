---
title: transpiler (v0.33)
description: API reference for qiskit.transpiler in qiskit v0.33
...
![../\_images/transpiling\_core\_steps.png](/docs/images/api/qiskit/0.33/transpiling_core_steps.avif)
...
![../\_images/transpiler\_2\_0.png](/docs/images/api/qiskit/0.33/transpiler_2_0.avif)
...
![../\_images/transpiler\_3\_0.png](/docs/images/api/qiskit/0.33/transpiler_3_0.avif)
...
1.  A SWAP gate is not a native gate on the IBM Q devices, and must be decomposed into three CNOT gates:
    ...
    ![../\_images/transpiler\_5\_0.png](/docs/images/api/qiskit/0.33/transpiler_5_0.avif)
...
2.  A Toffoli, or controlled-controlled-not gate (ccx), is a three-qubit gate. Given that our basis gate set includes only single- and two-qubit gates, it is obvious that this gate must be decomposed. This decomposition is quite costly:
    ...
    ![../\_images/transpiler\_6\_0.png](/docs/images/api/qiskit/0.33/transpiler_6_0.avif)
...
![../\_images/mapping.png](/docs/images/api/qiskit/0.33/mapping.avif)
...
![../\_images/transpiler\_7\_0.png](/docs/images/api/qiskit/0.33/transpiler_7_0.avif)
...
*   **Layout Using Optimization Level 0**
    ...
    > ```
    >
    > ![../\_images/transpiler\_8\_0.png](/docs/images/api/qiskit/0.33/transpiler_8_0.avif)
...
*   **Layout Using Optimization Level 3**
    ...
    > ```
    >
    > ![../\_images/transpiler\_9\_0.png](/docs/images/api/qiskit/0.33/transpiler_9_0.avif)
...
![../\_images/transpiler\_10\_0.png](/docs/images/api/qiskit/0.33/transpiler_10_0.avif)
...
![../\_images/transpiler\_11\_0.png](/docs/images/api/qiskit/0.33/transpiler_11_0.avif)
...
![../\_images/transpiler\_12\_0.png](/docs/images/api/qiskit/0.33/transpiler_12_0.avif)
...
![../\_images/transpiler\_13\_0.png](/docs/images/api/qiskit/0.33/transpiler_13_0.avif)
