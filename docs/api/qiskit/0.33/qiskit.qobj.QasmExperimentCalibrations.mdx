---
title: QasmExperimentCalibrations (v0.33)
description: API reference for qiskit.qobj.QasmExperimentCalibrations in qiskit v0.33
...
<Class id="qiskit.qobj.QasmExperimentCalibrations" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.19/qiskit/qobj/qasm_qobj.py" signature="QasmExperimentCalibrations(gates)" modifiers="class">
  Bases: `object`
