---
title: ResultError (v0.33)
description: API reference for qiskit.result.ResultError in qiskit v0.33
...
<Class id="qiskit.result.ResultError" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.19/qiskit/result/exceptions.py" signature="ResultError(error)" modifiers="exception">
