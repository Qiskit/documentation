...
<Class id="qiskit.visualization.qcstyle.DefaultStyle" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.19/qiskit/visualization/qcstyle.py" signature="DefaultStyle">
  Bases: `object`
