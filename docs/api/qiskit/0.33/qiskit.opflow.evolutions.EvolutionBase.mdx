---
title: EvolutionBase (v0.33)
description: API reference for qiskit.opflow.evolutions.EvolutionBase in qiskit v0.33
...
<Class id="qiskit.opflow.evolutions.EvolutionBase" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.19/qiskit/opflow/evolutions/evolution_base.py" signature="EvolutionBase" modifiers="class">
