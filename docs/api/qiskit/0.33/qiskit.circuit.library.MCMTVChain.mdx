---
title: MCMTVChain (v0.33)
description: API reference for qiskit.circuit.library.MCMTVChain in qiskit v0.33
...
<Class id="qiskit.circuit.library.MCMTVChain" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.19/qiskit/circuit/library/generalized_gates/mcmt.py" signature="MCMTVChain(gate, num_ctrl_qubits, num_target_qubits, label=None)" modifiers="class">
