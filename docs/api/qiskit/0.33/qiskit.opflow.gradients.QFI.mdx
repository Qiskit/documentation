...
<Class id="qiskit.opflow.gradients.QFI" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.19/qiskit/opflow/gradients/qfi.py" signature="QFI(qfi_method='lin_comb_full')">
...
$$
  ...
  **ValueError** – if `qfi_method` is neither a `CircuitQFI` object nor one of the predefined strings.
  ...
  <Function id="qiskit.opflow.gradients.QFI.convert" name="convert" signature="QFI.convert(operator, params=None)">
    **Parameters**
