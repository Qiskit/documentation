---
title: SabreLayout (v0.33)
description: API reference for qiskit.transpiler.passes.SabreLayout in qiskit v0.33
...
<Class id="qiskit.transpiler.passes.SabreLayout" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.19/qiskit/transpiler/passes/layout/sabre_layout.py" signature="SabreLayout(*args, **kwargs)" modifiers="class">
