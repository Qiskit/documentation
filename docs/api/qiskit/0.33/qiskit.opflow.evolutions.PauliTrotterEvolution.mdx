...
<Class id="qiskit.opflow.evolutions.PauliTrotterEvolution" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.19/qiskit/opflow/evolutions/pauli_trotter_evolution.py" signature="PauliTrotterEvolution(trotter_mode='trotter', reps=1)">
  ...
  *   **rather than each Pauli.** (*#*) –
  ...
  <Function id="qiskit.opflow.evolutions.PauliTrotterEvolution.convert" name="convert" signature="PauliTrotterEvolution.convert(operator)">
  ...
  <Function id="qiskit.opflow.evolutions.PauliTrotterEvolution.evolution_for_abelian_paulisum" name="evolution_for_abelian_paulisum" signature="PauliTrotterEvolution.evolution_for_abelian_paulisum(op_sum)">
  ...
  <Function id="qiskit.opflow.evolutions.PauliTrotterEvolution.evolution_for_pauli" name="evolution_for_pauli" signature="PauliTrotterEvolution.evolution_for_pauli(pauli_op)">
  ...
  <Attribute id="qiskit.opflow.evolutions.PauliTrotterEvolution.trotter" name="trotter">
