...
<Class id="qiskit.opflow.evolutions.PauliTrotterEvolution" github="https://github.com/qiskit/qiskit/tree/stable/0.19/qiskit/opflow/evolutions/pauli_trotter_evolution.py" signature="PauliTrotterEvolution(trotter_mode='trotter', reps=1)">
