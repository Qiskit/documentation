---
title: SparseVectorStateFn (v0.33)
description: API reference for qiskit.opflow.state_fns.SparseVectorStateFn in qiskit v0.33
...
<Class id="qiskit.opflow.state_fns.SparseVectorStateFn" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.19/qiskit/opflow/state_fns/sparse_vector_state_fn.py" signature="SparseVectorStateFn(primitive, coeff=1.0, is_measurement=False)" modifiers="class">
