---
title: OpenQASMLexer (v0.33)
description: API reference for qiskit.qasm.OpenQASMLexer in qiskit v0.33
...
<Class id="qiskit.qasm.OpenQASMLexer" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.19/qiskit/qasm/pygments/lexer.py" signature="OpenQASMLexer(*args, **kwds)" modifiers="class">
  ...
  <span id="qiskit-qasm-openqasmlexer-add-filter" />
  ...
  <span id="qiskit-qasm-openqasmlexer-analyse-text" />
  ...
  <span id="qiskit-qasm-openqasmlexer-get-tokens" />
  ...
  <span id="qiskit-qasm-openqasmlexer-get-tokens-unprocessed" />
