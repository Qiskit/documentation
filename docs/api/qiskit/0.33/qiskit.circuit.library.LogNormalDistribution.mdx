...
<Class id="qiskit.circuit.library.LogNormalDistribution" github="https://github.com/qiskit/qiskit/tree/stable/0.19/qiskit/circuit/library/probability_distributions/lognormal.py" signature="LogNormalDistribution(num_qubits, mu=None, sigma=None, bounds=None, upto_diag=False, name='P(X)')">
