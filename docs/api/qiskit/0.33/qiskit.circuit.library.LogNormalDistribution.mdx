...
<Class id="qiskit.circuit.library.LogNormalDistribution" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.19/qiskit/circuit/library/probability_distributions/lognormal.py" signature="LogNormalDistribution(num_qubits, mu=None, sigma=None, bounds=None, upto_diag=False, name='P(X)')">
...
$$
  ...
  *   **name** (`str`) – The name of the circuit.
  ...
  <Attribute id="qiskit.circuit.library.LogNormalDistribution.ancillas" name="ancillas">
  ...
  <Attribute id="qiskit.circuit.library.LogNormalDistribution.bounds" name="bounds">
  ...
  <Attribute id="qiskit.circuit.library.LogNormalDistribution.calibrations" name="calibrations">
  ...
  <Attribute id="qiskit.circuit.library.LogNormalDistribution.clbits" name="clbits">
  ...
  <Attribute id="qiskit.circuit.library.LogNormalDistribution.data" name="data">
  ...
  <Attribute id="qiskit.circuit.library.LogNormalDistribution.extension_lib" name="extension_lib" attributeValue="'include &#x22;qelib1.inc&#x22;;'" />

  ### global\_phase

  <Attribute id="qiskit.circuit.library.LogNormalDistribution.global_phase" name="global_phase">
  ...
  <Attribute id="qiskit.circuit.library.LogNormalDistribution.header" name="header" attributeValue="'OPENQASM 2.0;'" />

  ### instances

  <Attribute id="qiskit.circuit.library.LogNormalDistribution.instances" name="instances" attributeValue="9" />

  ### metadata

  <Attribute id="qiskit.circuit.library.LogNormalDistribution.metadata" name="metadata">
  ...
  <Attribute id="qiskit.circuit.library.LogNormalDistribution.num_ancillas" name="num_ancillas">
  ...
  <Attribute id="qiskit.circuit.library.LogNormalDistribution.num_clbits" name="num_clbits">
  ...
  <Attribute id="qiskit.circuit.library.LogNormalDistribution.num_parameters" name="num_parameters">
  ...
  <Attribute id="qiskit.circuit.library.LogNormalDistribution.num_qubits" name="num_qubits">
  ...
  <Attribute id="qiskit.circuit.library.LogNormalDistribution.parameters" name="parameters">
  ...
  <Attribute id="qiskit.circuit.library.LogNormalDistribution.prefix" name="prefix" attributeValue="'circuit'" />

  ### probabilities

  <Attribute id="qiskit.circuit.library.LogNormalDistribution.probabilities" name="probabilities">
  ...
  <Attribute id="qiskit.circuit.library.LogNormalDistribution.qubits" name="qubits">
  ...
  <Attribute id="qiskit.circuit.library.LogNormalDistribution.values" name="values">
