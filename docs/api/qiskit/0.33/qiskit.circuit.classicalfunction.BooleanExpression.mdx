---
title: BooleanExpression (v0.33)
description: API reference for qiskit.circuit.classicalfunction.BooleanExpression in qiskit v0.33
...
<Class id="qiskit.circuit.classicalfunction.BooleanExpression" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.19/qiskit/circuit/classicalfunction/boolean_expression.py" signature="BooleanExpression(expression, name=None)" modifiers="class">
