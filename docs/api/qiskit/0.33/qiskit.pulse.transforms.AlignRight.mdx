---
title: AlignRight (v0.33)
description: API reference for qiskit.pulse.transforms.AlignRight in qiskit v0.33
...
<Class id="qiskit.pulse.transforms.AlignRight" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.19/qiskit/pulse/transforms/alignments.py" signature="AlignRight" modifiers="class">
