...
`GateCalibration(name, qubits, params, instructions)` [GitHub](https://github.com/qiskit/qiskit/tree/stable/0.19/qiskit/qobj/qasm_qobj.py "view source code")
...
`classmethod GateCalibration.from_dict(data)` [GitHub](https://github.com/qiskit/qiskit/tree/stable/0.19/qiskit/qobj/qasm_qobj.py "view source code")
...
`GateCalibration.to_dict()` [GitHub](https://github.com/qiskit/qiskit/tree/stable/0.19/qiskit/qobj/qasm_qobj.py "view source code")
