...
<Class id="qiskit.providers.Options" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.19/qiskit/providers/options.py" signature="Options(**kwargs)">
  Bases: `object`
  ...
  <Function id="qiskit.providers.Options.get" name="get" signature="Options.get(field, default=None)">
    Get an option value for a given key.
  </Function>

  ### set\_validator

  <Function id="qiskit.providers.Options.set_validator" name="set_validator" signature="Options.set_validator(field, validator_value)">
  ...
  <Function id="qiskit.providers.Options.update_options" name="update_options" signature="Options.update_options(**fields)">
