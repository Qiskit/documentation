---
title: LinearSolver (v0.33)
description: API reference for qiskit.algorithms.LinearSolver in qiskit v0.33
...
<Class id="qiskit.algorithms.LinearSolver" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.19/qiskit/algorithms/linear_solvers/linear_solver.py" signature="LinearSolver" modifiers="class">
  Bases: `abc.ABC`
