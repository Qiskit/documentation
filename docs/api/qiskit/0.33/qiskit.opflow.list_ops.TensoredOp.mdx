---
title: TensoredOp (v0.33)
description: API reference for qiskit.opflow.list_ops.TensoredOp in qiskit v0.33
...
<Class id="qiskit.opflow.list_ops.TensoredOp" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.19/qiskit/opflow/list_ops/tensored_op.py" signature="TensoredOp(oplist, coeff=1.0, abelian=False)" modifiers="class">
