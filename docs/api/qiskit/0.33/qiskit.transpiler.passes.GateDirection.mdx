...
<Class id="qiskit.transpiler.passes.GateDirection" github="https://github.com/qiskit/qiskit/tree/stable/0.19/qiskit/transpiler/passes/utils/gate_direction.py" signature="GateDirection(*args, **kwargs)">
