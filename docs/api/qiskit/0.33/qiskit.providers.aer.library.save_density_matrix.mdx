---
title: save_density_matrix (v0.33)
description: API reference for qiskit.providers.aer.library.save_density_matrix in qiskit v0.33
in_page_toc_min_heading_level: 1
python_api_type: function
python_api_name: qiskit.providers.aer.library.save_density_matrix
---

<span id="qiskit-providers-aer-library-save-density-matrix" />
