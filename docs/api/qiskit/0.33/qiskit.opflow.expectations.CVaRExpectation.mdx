---
title: CVaRExpectation (v0.33)
description: API reference for qiskit.opflow.expectations.CVaRExpectation in qiskit v0.33
...
<Class id="qiskit.opflow.expectations.CVaRExpectation" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.19/qiskit/opflow/expectations/cvar_expectation.py" signature="CVaRExpectation(alpha, expectation=None)" modifiers="class">
