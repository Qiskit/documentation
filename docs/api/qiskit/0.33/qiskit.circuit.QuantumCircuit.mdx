...
<Class id="qiskit.circuit.QuantumCircuit" github="https://github.com/qiskit/qiskit/tree/stable/0.19/qiskit/circuit/quantumcircuit.py" signature="QuantumCircuit(*regs, name=None, global_phase=0, metadata=None)">
  Bases: `object`
