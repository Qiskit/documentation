...
<Class id="qiskit.opflow.converters.ConverterBase" github="https://github.com/qiskit/qiskit/tree/stable/0.19/qiskit/opflow/converters/converter_base.py" signature="ConverterBase">
  Bases: `abc.ABC`
