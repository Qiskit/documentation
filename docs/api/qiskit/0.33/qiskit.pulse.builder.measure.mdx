...
<Function id="qiskit.pulse.builder.measure" name="measure" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.19/qiskit/pulse/builder.py" signature="measure(qubits, registers=None)">
