---
title: XGate (v0.33)
description: API reference for qiskit.circuit.library.XGate in qiskit v0.33
...
<Class id="qiskit.circuit.library.XGate" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.19/qiskit/circuit/library/standard_gates/x.py" signature="XGate(label=None)" modifiers="class">
