...
<Class id="qiskit.providers.ibmq.runtime.RuntimeJob" github="https://github.com/qiskit/qiskit-ibmq-provider/tree/stable/0.18/qiskit/providers/ibmq/runtime/runtime_job.py" signature="RuntimeJob(backend, api_client, credentials, job_id, program_id, params=None, creation_date=None, user_callback=None, result_decoder=<class 'qiskit.providers.ibmq.runtime.program.result_decoder.ResultDecoder'>, image='')">
  ...
  *   **image** (`Optional`\[`str`]) – Runtime image used for this job: image\_name:tag.
  ...
  <Function id="qiskit.providers.ibmq.runtime.RuntimeJob.backend" name="backend" signature="RuntimeJob.backend()">
  ...
  <Function id="qiskit.providers.ibmq.runtime.RuntimeJob.cancel" name="cancel" signature="RuntimeJob.cancel()">
    Cancel the job.
  ...
  <Function id="qiskit.providers.ibmq.runtime.RuntimeJob.cancel_result_streaming" name="cancel_result_streaming" signature="RuntimeJob.cancel_result_streaming()">
  ...
  <Function id="qiskit.providers.ibmq.runtime.RuntimeJob.error_message" name="error_message" signature="RuntimeJob.error_message()">
  ...
  <Function id="qiskit.providers.ibmq.runtime.RuntimeJob.job_id" name="job_id" signature="RuntimeJob.job_id()">
  ...
  <Function id="qiskit.providers.ibmq.runtime.RuntimeJob.logs" name="logs" signature="RuntimeJob.logs()">
    Return job logs.
  ...
  <Function id="qiskit.providers.ibmq.runtime.RuntimeJob.result" name="result" signature="RuntimeJob.result(timeout=None, wait=5, decoder=None)">
  ...
  <Function id="qiskit.providers.ibmq.runtime.RuntimeJob.status" name="status" signature="RuntimeJob.status()">
  ...
  <Function id="qiskit.providers.ibmq.runtime.RuntimeJob.stream_results" name="stream_results" signature="RuntimeJob.stream_results(callback, decoder=None)">
  ...
  <Function id="qiskit.providers.ibmq.runtime.RuntimeJob.wait_for_final_state" name="wait_for_final_state" signature="RuntimeJob.wait_for_final_state(timeout=None, wait=5)">
  ...
  <Attribute id="qiskit.providers.ibmq.runtime.RuntimeJob.creation_date" name="creation_date">
  ...
  <Attribute id="qiskit.providers.ibmq.runtime.RuntimeJob.image" name="image">
  ...
  <Attribute id="qiskit.providers.ibmq.runtime.RuntimeJob.inputs" name="inputs">
  ...
  <Attribute id="qiskit.providers.ibmq.runtime.RuntimeJob.program_id" name="program_id">
    Program ID.
