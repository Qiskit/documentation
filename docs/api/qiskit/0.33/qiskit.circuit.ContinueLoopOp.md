...
`ContinueLoopOp(num_qubits, num_clbits, label=None)` [GitHub](https://github.com/qiskit/qiskit/tree/stable/0.19/qiskit/circuit/controlflow/continue_loop.py "view source code")
...
<span id="qiskit.circuit.ContinueLoopOp.mirror" />
