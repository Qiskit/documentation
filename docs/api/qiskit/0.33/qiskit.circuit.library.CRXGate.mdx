---
title: CRXGate (v0.33)
description: API reference for qiskit.circuit.library.CRXGate in qiskit v0.33
...
<Class id="qiskit.circuit.library.CRXGate" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.19/qiskit/circuit/library/standard_gates/rx.py" signature="CRXGate(theta, label=None, ctrl_state=None)" modifiers="class">
