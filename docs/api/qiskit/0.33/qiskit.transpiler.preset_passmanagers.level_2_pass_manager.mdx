...
<Function id="qiskit.transpiler.preset_passmanagers.level_2_pass_manager" github="https://github.com/qiskit/qiskit/tree/stable/0.19/qiskit/transpiler/preset_passmanagers/level2.py" signature="level_2_pass_manager(pass_manager_config)">
