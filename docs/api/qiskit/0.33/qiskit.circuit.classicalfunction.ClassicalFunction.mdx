---
title: ClassicalFunction (v0.33)
description: API reference for qiskit.circuit.classicalfunction.ClassicalFunction in qiskit v0.33
...
<Class id="qiskit.circuit.classicalfunction.ClassicalFunction" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.19/qiskit/circuit/classicalfunction/classicalfunction.py" signature="ClassicalFunction(source, name=None)" modifiers="class">
