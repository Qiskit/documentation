...
<Class id="qiskit.providers.aer.utils.NoiseTransformer" github="https://github.com/qiskit/qiskit-aer/tree/stable/0.9/qiskit/providers/aer/utils/noise_transformation.py" signature="NoiseTransformer">
  Bases: `object`
