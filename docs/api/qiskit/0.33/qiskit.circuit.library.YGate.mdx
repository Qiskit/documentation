---
title: YGate (v0.33)
description: API reference for qiskit.circuit.library.YGate in qiskit v0.33
...
<Class id="qiskit.circuit.library.YGate" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.19/qiskit/circuit/library/standard_gates/y.py" signature="YGate(label=None)" modifiers="class">
