---
title: QasmHTMLStyle (v0.33)
description: API reference for qiskit.qasm.QasmHTMLStyle in qiskit v0.33
...
<Class id="qiskit.qasm.QasmHTMLStyle" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.19/qiskit/qasm/pygments/lexer.py" signature="QasmHTMLStyle" modifiers="class">
