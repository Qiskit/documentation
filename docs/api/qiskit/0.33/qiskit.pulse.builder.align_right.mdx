...
<Function id="qiskit.pulse.builder.align_right" name="align_right" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.19/qiskit/pulse/builder.py" signature="align_right()">
