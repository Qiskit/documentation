...
`dagdependency_to_circuit(dagdependency)` [GitHub](https://github.com/qiskit/qiskit/tree/stable/0.19/qiskit/converters/dagdependency_to_circuit.py "view source code")
