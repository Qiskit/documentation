---
title: Command (v0.33)
description: API reference for qiskit.providers.models.Command in qiskit v0.33
...
<Class id="qiskit.providers.models.Command" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.19/qiskit/providers/models/pulsedefaults.py" signature="Command(name, qubits=None, sequence=None, **kwargs)" modifiers="class">
  Bases: `object`
