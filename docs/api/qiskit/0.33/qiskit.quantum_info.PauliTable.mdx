---
title: PauliTable (v0.33)
description: API reference for qiskit.quantum_info.PauliTable in qiskit v0.33
...
<Class id="qiskit.quantum_info.PauliTable" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.19/qiskit/quantum_info/operators/symplectic/pauli_table.py" signature="PauliTable(data)" modifiers="class">
