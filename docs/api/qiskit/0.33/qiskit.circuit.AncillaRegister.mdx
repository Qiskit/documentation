...
<Class id="qiskit.circuit.AncillaRegister" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.19/qiskit/circuit/quantumregister.py" signature="AncillaRegister(size=None, name=None, bits=None)">
  ...
  *   **CircuitError** – if `bits` contained bits of an incorrect type.
  ...
  <Function id="qiskit.circuit.AncillaRegister.index" name="index" signature="AncillaRegister.index(bit)">
    Find the index of the provided bit within this register.
  </Function>

  ### qasm

  <Function id="qiskit.circuit.AncillaRegister.qasm" name="qasm" signature="AncillaRegister.qasm()">
  ...
  <Attribute id="qiskit.circuit.AncillaRegister.instances_counter" name="instances_counter" attributeValue="= count(0)" />

  ### name

  <Attribute id="qiskit.circuit.AncillaRegister.name" name="name">
    Get the register name.
  </Attribute>

  ### name\_format

  <Attribute id="qiskit.circuit.AncillaRegister.name_format" name="name_format" attributeValue="= re.compile('[a-z][a-zA-Z0-9_]*')" />

  ### prefix

  <Attribute id="qiskit.circuit.AncillaRegister.prefix" name="prefix" attributeValue="= 'a'" />

  ### size

  <Attribute id="qiskit.circuit.AncillaRegister.size" name="size">
