...
<Function id="qiskit.converters.dagdependency_to_dag" github="https://github.com/qiskit/qiskit/tree/stable/0.19/qiskit/converters/dagdependency_to_dag.py" signature="dagdependency_to_dag(dagdependency)">
