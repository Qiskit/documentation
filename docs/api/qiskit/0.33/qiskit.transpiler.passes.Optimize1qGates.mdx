---
title: Optimize1qGates (v0.33)
description: API reference for qiskit.transpiler.passes.Optimize1qGates in qiskit v0.33
...
<Class id="qiskit.transpiler.passes.Optimize1qGates" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.19/qiskit/transpiler/passes/optimization/optimize_1q_gates.py" signature="Optimize1qGates(*args, **kwargs)" modifiers="class">
