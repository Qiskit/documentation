---
title: Stinespring (v0.33)
description: API reference for qiskit.quantum_info.Stinespring in qiskit v0.33
...
<Class id="qiskit.quantum_info.Stinespring" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.19/qiskit/quantum_info/operators/channel/stinespring.py" signature="Stinespring(data, input_dims=None, output_dims=None)" modifiers="class">
