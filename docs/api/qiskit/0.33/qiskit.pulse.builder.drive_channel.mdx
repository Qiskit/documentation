...
<Function id="qiskit.pulse.builder.drive_channel" github="https://github.com/qiskit/qiskit/tree/stable/0.19/qiskit/pulse/builder.py" signature="drive_channel(qubit)">
