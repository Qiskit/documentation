...
<Class id="qiskit.circuit.library.QFT" github="https://github.com/qiskit/qiskit/tree/stable/0.19/qiskit/circuit/library/basis_change/qft.py" signature="QFT(num_qubits=None, approximation_degree=0, do_swaps=True, inverse=False, insert_barriers=False, name=None)">
