...
<Function id="qiskit.pulse.builder.control_channels" name="control_channels" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.19/qiskit/pulse/builder.py" signature="control_channels(*qubits)">
