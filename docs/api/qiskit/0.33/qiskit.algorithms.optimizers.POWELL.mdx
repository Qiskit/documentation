---
title: POWELL (v0.33)
description: API reference for qiskit.algorithms.optimizers.POWELL in qiskit v0.33
...
<Class id="qiskit.algorithms.optimizers.POWELL" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.19/qiskit/algorithms/optimizers/powell.py" signature="POWELL(maxiter=None, maxfev=1000, disp=False, xtol=0.0001, tol=None, options=None, **kwargs)" modifiers="class">
  ...
  *   **kwargs** – additional kwargs for scipy.optimize.minimize.
  ...
  <Function id="qiskit.algorithms.optimizers.POWELL.gradient_num_diff" signature="POWELL.gradient_num_diff(x_center, f, epsilon, max_evals_grouped=1)" modifiers="static">
