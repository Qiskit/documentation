---
title: FasterAmplitudeEstimationResult (v0.33)
description: API reference for qiskit.algorithms.FasterAmplitudeEstimationResult in qiskit v0.33
...
<Class id="qiskit.algorithms.FasterAmplitudeEstimationResult" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.19/qiskit/algorithms/amplitude_estimators/fae.py" signature="FasterAmplitudeEstimationResult" modifiers="class">
