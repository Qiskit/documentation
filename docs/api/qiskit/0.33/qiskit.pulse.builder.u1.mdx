...
<Function id="qiskit.pulse.builder.u1" name="u1" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.19/qiskit/pulse/builder.py" signature="u1(theta, qubit)">
