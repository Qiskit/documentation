---
title: AcquireChannel (v0.33)
description: API reference for qiskit.pulse.channels.AcquireChannel in qiskit v0.33
...
<Class id="qiskit.pulse.channels.AcquireChannel" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.19/qiskit/pulse/channels.py" signature="AcquireChannel(index)" modifiers="class">
