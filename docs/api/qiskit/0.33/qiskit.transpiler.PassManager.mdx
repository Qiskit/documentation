---
title: PassManager (v0.33)
description: API reference for qiskit.transpiler.PassManager in qiskit v0.33
...
<Class id="qiskit.transpiler.PassManager" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.19/qiskit/transpiler/passmanager.py" signature="PassManager(passes=None, max_iteration=1000)" modifiers="class">
  Bases: `object`
