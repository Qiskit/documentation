---
title: ISRES (v0.33)
description: API reference for qiskit.algorithms.optimizers.ISRES in qiskit v0.33
...
<Class id="qiskit.algorithms.optimizers.ISRES" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.19/qiskit/algorithms/optimizers/nlopts/isres.py" signature="ISRES(max_evals=1000)" modifiers="class">
