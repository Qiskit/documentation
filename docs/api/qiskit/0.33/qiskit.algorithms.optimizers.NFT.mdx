---
title: NFT (v0.33)
description: API reference for qiskit.algorithms.optimizers.NFT in qiskit v0.33
...
<Class id="qiskit.algorithms.optimizers.NFT" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.19/qiskit/algorithms/optimizers/nft.py" signature="NFT(maxiter=None, maxfev=1024, disp=False, reset_interval=32, options=None, **kwargs)" modifiers="class">
  ...
  **[1](#id1)**
  ...
  <Function id="qiskit.algorithms.optimizers.NFT.gradient_num_diff" signature="NFT.gradient_num_diff(x_center, f, epsilon, max_evals_grouped=1)" modifiers="static">
