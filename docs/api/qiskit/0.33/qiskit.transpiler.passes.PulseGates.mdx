...
<Class id="qiskit.transpiler.passes.PulseGates" github="https://github.com/qiskit/qiskit/tree/stable/0.19/qiskit/transpiler/passes/calibration/builders.py" signature="PulseGates(inst_map)">
