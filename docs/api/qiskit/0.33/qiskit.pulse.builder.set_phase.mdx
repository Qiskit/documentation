...
<Function id="qiskit.pulse.builder.set_phase" github="https://github.com/qiskit/qiskit/tree/stable/0.19/qiskit/pulse/builder.py" signature="set_phase(phase, channel, name=None)">
