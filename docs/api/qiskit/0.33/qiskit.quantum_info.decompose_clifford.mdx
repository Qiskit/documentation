---
title: decompose_clifford (v0.33)
description: API reference for qiskit.quantum_info.decompose_clifford in qiskit v0.33
...
<Function id="qiskit.quantum_info.decompose_clifford" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.19/qiskit/quantum_info/synthesis/clifford_decompose.py" signature="decompose_clifford(clifford, method=None)">
