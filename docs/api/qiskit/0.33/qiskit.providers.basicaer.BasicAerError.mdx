...
<Class id="qiskit.providers.basicaer.BasicAerError" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.19/qiskit/providers/basicaer/exceptions.py" signature="BasicAerError(*message)">
