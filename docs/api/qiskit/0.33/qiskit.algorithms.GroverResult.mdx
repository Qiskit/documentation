---
title: GroverResult (v0.33)
description: API reference for qiskit.algorithms.GroverResult in qiskit v0.33
...
<Class id="qiskit.algorithms.GroverResult" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.19/qiskit/algorithms/amplitude_amplifiers/grover.py" signature="GroverResult" modifiers="class">
