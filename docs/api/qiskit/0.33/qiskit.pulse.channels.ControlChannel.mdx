---
title: ControlChannel (v0.33)
description: API reference for qiskit.pulse.channels.ControlChannel in qiskit v0.33
...
<Class id="qiskit.pulse.channels.ControlChannel" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.19/qiskit/pulse/channels.py" signature="ControlChannel(index)" modifiers="class">
