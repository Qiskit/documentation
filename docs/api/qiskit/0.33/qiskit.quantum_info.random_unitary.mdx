...
<Function id="qiskit.quantum_info.random_unitary" name="random_unitary" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.19/qiskit/quantum_info/operators/random.py" signature="random_unitary(dims, seed=None)">
