---
title: CircuitQFI (v0.33)
description: API reference for qiskit.opflow.gradients.CircuitQFI in qiskit v0.33
...
<Class id="qiskit.opflow.gradients.CircuitQFI" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.19/qiskit/opflow/gradients/circuit_qfis/circuit_qfi.py" signature="CircuitQFI" modifiers="class">
