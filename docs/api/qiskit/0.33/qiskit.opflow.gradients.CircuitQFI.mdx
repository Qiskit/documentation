...
<Class id="qiskit.opflow.gradients.CircuitQFI" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.19/qiskit/opflow/gradients/circuit_qfis/circuit_qfi.py" signature="CircuitQFI">
  ...
  <Function id="qiskit.opflow.gradients.CircuitQFI.convert" name="convert" signature="abstract CircuitQFI.convert(operator, params)">
    **Parameters**
