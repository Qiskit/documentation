...
<Function id="qiskit.circuit.qpy_serialization.dump" name="dump" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.19/qiskit/circuit/qpy_serialization.py" signature="dump(circuits, file_obj)">
