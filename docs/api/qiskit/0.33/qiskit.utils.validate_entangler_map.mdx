...
<Function id="qiskit.utils.validate_entangler_map" github="https://github.com/qiskit/qiskit/tree/stable/0.19/qiskit/utils/entangler_map.py" signature="validate_entangler_map(entangler_map, num_qubits, allow_double_entanglement=False)">
