---
title: EvolvedOp (v0.33)
description: API reference for qiskit.opflow.evolutions.EvolvedOp in qiskit v0.33
...
<Class id="qiskit.opflow.evolutions.EvolvedOp" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.19/qiskit/opflow/evolutions/evolved_op.py" signature="EvolvedOp(primitive, coeff=1.0)" modifiers="class">
