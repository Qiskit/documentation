...
<Function id="qiskit.pulse.builder.frequency_offset" github="https://github.com/qiskit/qiskit/tree/stable/0.19/qiskit/pulse/builder.py" signature="frequency_offset(frequency, *channels, compensate_phase=False)">
