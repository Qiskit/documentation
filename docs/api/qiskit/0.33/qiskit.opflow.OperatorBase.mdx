---
title: OperatorBase (v0.33)
description: API reference for qiskit.opflow.OperatorBase in qiskit v0.33
...
<Class id="qiskit.opflow.OperatorBase" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.19/qiskit/opflow/operator_base.py" signature="OperatorBase" modifiers="class">
