...
<Class id="qiskit.transpiler.passes.AlignMeasures" github="https://github.com/qiskit/qiskit/tree/stable/0.19/qiskit/transpiler/passes/scheduling/instruction_alignment.py" signature="AlignMeasures(alignment=1)">
