...
`Decompose(gate=None, gates_to_decompose=None)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.19/qiskit/transpiler/passes/basis/decompose.py "view source code")
...
`Decompose.run(dag)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.19/qiskit/transpiler/passes/basis/decompose.py "view source code")
