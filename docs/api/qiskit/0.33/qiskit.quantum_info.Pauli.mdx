...
<Class id="qiskit.quantum_info.Pauli" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.19/qiskit/quantum_info/operators/symplectic/pauli.py" signature="Pauli(data=None, x=None, *, z=None, label=None)">
...
$$
  ...
  **QiskitError** – if input array is invalid shape.
  ...
  <Function id="qiskit.quantum_info.Pauli.adjoint" name="adjoint" signature="Pauli.adjoint()">
    Return the adjoint of the Operator.
  </Function>

  ### anticommutes

  <Function id="qiskit.quantum_info.Pauli.anticommutes" name="anticommutes" signature="Pauli.anticommutes(other, qargs=None)">
  ...
  <Function id="qiskit.quantum_info.Pauli.append_paulis" name="append_paulis" signature="Pauli.append_paulis(paulis=None, pauli_labels=None)">
  ...
  <Function id="qiskit.quantum_info.Pauli.commutes" name="commutes" signature="Pauli.commutes(other, qargs=None)">
  ...
  <Function id="qiskit.quantum_info.Pauli.compose" name="compose" signature="Pauli.compose(other, qargs=None, front=False, inplace=False)">
  ...
  <Function id="qiskit.quantum_info.Pauli.conjugate" name="conjugate" signature="Pauli.conjugate()">
    Return the conjugate of each Pauli in the list.
  </Function>

  ### copy

  <Function id="qiskit.quantum_info.Pauli.copy" name="copy" signature="Pauli.copy()">
    Make a deep copy of current operator.
  </Function>

  ### delete

  <Function id="qiskit.quantum_info.Pauli.delete" name="delete" signature="Pauli.delete(qubits)">
  ...
  <Function id="qiskit.quantum_info.Pauli.delete_qubits" name="delete_qubits" signature="Pauli.delete_qubits(indices)">
  ...
  <Function id="qiskit.quantum_info.Pauli.dot" name="dot" signature="Pauli.dot(other, qargs=None, inplace=False)">
  ...
  <Function id="qiskit.quantum_info.Pauli.equiv" name="equiv" signature="Pauli.equiv(other)">
  ...
  <Function id="qiskit.quantum_info.Pauli.evolve" name="evolve" signature="Pauli.evolve(other, qargs=None)">
  ...
  <Function id="qiskit.quantum_info.Pauli.expand" name="expand" signature="Pauli.expand(other)">
  ...
  <Function id="qiskit.quantum_info.Pauli.from_label" name="from_label" signature="static Pauli.from_label(*args, **kwargs)">
  ...
  <Function id="qiskit.quantum_info.Pauli.input_dims" name="input_dims" signature="Pauli.input_dims(qargs=None)">
    Return tuple of input dimension for specified subsystems.
  </Function>

  ### insert

  <Function id="qiskit.quantum_info.Pauli.insert" name="insert" signature="Pauli.insert(qubits, value)">
  ...
  <Function id="qiskit.quantum_info.Pauli.insert_paulis" name="insert_paulis" signature="Pauli.insert_paulis(indices=None, paulis=None, pauli_labels=None)">
  ...
  <Function id="qiskit.quantum_info.Pauli.inverse" name="inverse" signature="Pauli.inverse()">
    Return the inverse of the Pauli.
  </Function>

  ### kron

  <Function id="qiskit.quantum_info.Pauli.kron" name="kron" signature="Pauli.kron(other)">
  ...
  <Function id="qiskit.quantum_info.Pauli.output_dims" name="output_dims" signature="Pauli.output_dims(qargs=None)">
    Return tuple of output dimension for specified subsystems.
  </Function>

  ### pauli\_single

  <Function id="qiskit.quantum_info.Pauli.pauli_single" name="pauli_single" signature="classmethod Pauli.pauli_single(num_qubits, index, pauli_label)">
  ...
  <Function id="qiskit.quantum_info.Pauli.power" name="power" signature="Pauli.power(n)">
  ...
  <Function id="qiskit.quantum_info.Pauli.random" name="random" signature="classmethod Pauli.random(num_qubits, seed=None)">
  ...
  <Function id="qiskit.quantum_info.Pauli.reshape" name="reshape" signature="Pauli.reshape(input_dims=None, output_dims=None, num_qubits=None)">
  ...
  <Function id="qiskit.quantum_info.Pauli.set_truncation" name="set_truncation" signature="classmethod Pauli.set_truncation(val)">
  ...
  <Function id="qiskit.quantum_info.Pauli.sgn_prod" name="sgn_prod" signature="static Pauli.sgn_prod(*args, **kwargs)">
  ...
  <Function id="qiskit.quantum_info.Pauli.tensor" name="tensor" signature="Pauli.tensor(other)">
  ...
  <Function id="qiskit.quantum_info.Pauli.to_instruction" name="to_instruction" signature="Pauli.to_instruction()">
    Convert to Pauli circuit instruction.
  </Function>

  ### to\_label

  <Function id="qiskit.quantum_info.Pauli.to_label" name="to_label" signature="Pauli.to_label()">
  ...
  <Function id="qiskit.quantum_info.Pauli.to_matrix" name="to_matrix" signature="Pauli.to_matrix(sparse=False)">
  ...
  <Function id="qiskit.quantum_info.Pauli.to_spmatrix" name="to_spmatrix" signature="Pauli.to_spmatrix()">
  ...
  <Function id="qiskit.quantum_info.Pauli.transpose" name="transpose" signature="Pauli.transpose()">
    Return the transpose of each Pauli in the list.
  </Function>

  ### update\_x

  <Function id="qiskit.quantum_info.Pauli.update_x" name="update_x" signature="Pauli.update_x(x, indices=None)">
  ...
  <Function id="qiskit.quantum_info.Pauli.update_z" name="update_z" signature="Pauli.update_z(z, indices=None)">
  ...
  <Attribute id="qiskit.quantum_info.Pauli.dim" name="dim">
    Return tuple (input\_shape, output\_shape).
  </Attribute>

  ### num\_qubits

  <Attribute id="qiskit.quantum_info.Pauli.num_qubits" name="num_qubits">
    Return the number of qubits if a N-qubit operator or None otherwise.
  </Attribute>

  ### phase

  <Attribute id="qiskit.quantum_info.Pauli.phase" name="phase">
    Return the group phase exponent for the Pauli.
  </Attribute>

  ### qargs

  <Attribute id="qiskit.quantum_info.Pauli.qargs" name="qargs">
    Return the qargs for the operator.
  </Attribute>

  ### settings

  <Attribute id="qiskit.quantum_info.Pauli.settings" name="settings">
    Return settings.
  ...
  <Attribute id="qiskit.quantum_info.Pauli.x" name="x">
    The x vector for the Pauli.
  </Attribute>

  ### z

  <Attribute id="qiskit.quantum_info.Pauli.z" name="z">
