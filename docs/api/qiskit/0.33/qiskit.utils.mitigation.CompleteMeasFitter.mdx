...
<Class id="qiskit.utils.mitigation.CompleteMeasFitter" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.19/qiskit/utils/mitigation/fitters.py" signature="CompleteMeasFitter(results, state_labels, qubit_list=None, circlabel='')">
  Bases: `object`
