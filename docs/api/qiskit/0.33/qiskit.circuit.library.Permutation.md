...
`Permutation(num_qubits, pattern=None, seed=None)` [GitHub](https://github.com/qiskit/qiskit/tree/stable/0.19/qiskit/circuit/library/generalized_gates/permutation.py "view source code")
...
![../\_images/qiskit.circuit.library.Permutation\_0\_0.png](/images/api/qiskit/0.33/qiskit.circuit.library.Permutation_0_0.png)
