---
title: double_commutator (v0.33)
description: API reference for qiskit.opflow.double_commutator in qiskit v0.33
...
<Function id="qiskit.opflow.double_commutator" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.19/qiskit/opflow/utils.py" signature="double_commutator(op_a, op_b, op_c, sign=False)">
