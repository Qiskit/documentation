...
<Class id="qiskit.qobj.QobjMeasurementOption" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.19/qiskit/qobj/pulse_qobj.py" signature="QobjMeasurementOption(name, params=None)">
  Bases: `object`
  ...
  *   **params** (*list*) – The parameters of the measurement option.
  ...
  <Function id="qiskit.qobj.QobjMeasurementOption.from_dict" name="from_dict" signature="classmethod QobjMeasurementOption.from_dict(data)">
  ...
  <Function id="qiskit.qobj.QobjMeasurementOption.to_dict" name="to_dict" signature="QobjMeasurementOption.to_dict()">
