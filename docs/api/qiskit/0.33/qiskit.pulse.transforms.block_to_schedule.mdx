...
<Function id="qiskit.pulse.transforms.block_to_schedule" github="https://github.com/qiskit/qiskit/tree/stable/0.19/qiskit/pulse/transforms/canonicalization.py" signature="block_to_schedule(block)">
