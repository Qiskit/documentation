...
<Class id="qiskit.dagcircuit.DAGOutNode" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.19/qiskit/dagcircuit/dagnode.py" signature="DAGOutNode(wire)">
  ...
  <Function id="qiskit.dagcircuit.DAGOutNode.semantic_eq" name="semantic_eq" signature="static DAGOutNode.semantic_eq(node1, node2, bit_indices1=None, bit_indices2=None)">
  ...
  <Attribute id="qiskit.dagcircuit.DAGOutNode.cargs" name="cargs">
    Returns list of Clbit, else an empty list.
  </Attribute>

  ### condition

  <Attribute id="qiskit.dagcircuit.DAGOutNode.condition" name="condition">
    Returns the condition of the node.op
  </Attribute>

  ### name

  <Attribute id="qiskit.dagcircuit.DAGOutNode.name" name="name">
    Returns the Instruction name corresponding to the op for this node
  </Attribute>

  ### op

  <Attribute id="qiskit.dagcircuit.DAGOutNode.op" name="op">
    Returns the Instruction object corresponding to the op for the node, else None
  </Attribute>

  ### qargs

  <Attribute id="qiskit.dagcircuit.DAGOutNode.qargs" name="qargs">
    Returns list of Qubit, else an empty list.
  </Attribute>

  ### sort\_key

  <Attribute id="qiskit.dagcircuit.DAGOutNode.sort_key" name="sort_key" />

  ### type

  <Attribute id="qiskit.dagcircuit.DAGOutNode.type" name="type">
    Returns the type object
  </Attribute>

  ### wire

  <Attribute id="qiskit.dagcircuit.DAGOutNode.wire" name="wire" />
</Class>
