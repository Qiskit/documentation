---
title: DAGOutNode (v0.33)
description: API reference for qiskit.dagcircuit.DAGOutNode in qiskit v0.33
...
<Class id="qiskit.dagcircuit.DAGOutNode" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.19/qiskit/dagcircuit/dagnode.py" signature="DAGOutNode(wire)" modifiers="class">
