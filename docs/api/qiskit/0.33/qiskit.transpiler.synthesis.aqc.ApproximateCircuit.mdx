---
title: ApproximateCircuit (v0.33)
description: API reference for qiskit.transpiler.synthesis.aqc.ApproximateCircuit in qiskit v0.33
...
<Class id="qiskit.transpiler.synthesis.aqc.ApproximateCircuit" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.19/qiskit/transpiler/synthesis/aqc/approximate.py" signature="ApproximateCircuit(num_qubits, name=None)" modifiers="class">
