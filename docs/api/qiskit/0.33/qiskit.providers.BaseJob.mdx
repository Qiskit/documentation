---
title: BaseJob (v0.33)
description: API reference for qiskit.providers.BaseJob in qiskit v0.33
...
<Class id="qiskit.providers.BaseJob" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.19/qiskit/providers/basejob.py" signature="BaseJob(backend, job_id)" modifiers="class">
  Bases: `abc.ABC`
