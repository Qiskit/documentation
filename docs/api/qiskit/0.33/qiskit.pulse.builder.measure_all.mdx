---
title: measure_all (v0.33)
description: API reference for qiskit.pulse.builder.measure_all in qiskit v0.33
...
<Function id="qiskit.pulse.builder.measure_all" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.19/qiskit/pulse/builder.py" signature="measure_all()">
