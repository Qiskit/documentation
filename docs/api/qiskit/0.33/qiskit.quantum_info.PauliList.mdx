...
<Class id="qiskit.quantum_info.PauliList" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.19/qiskit/quantum_info/operators/symplectic/pauli_list.py" signature="PauliList(data)">
  ...
  **Additional Information:**
  ...
  <Function id="qiskit.quantum_info.PauliList.evolve" name="evolve" signature="PauliList.evolve(other, qargs=None)">
