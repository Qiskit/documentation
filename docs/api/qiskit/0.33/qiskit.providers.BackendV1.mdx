---
title: BackendV1 (v0.33)
description: API reference for qiskit.providers.BackendV1 in qiskit v0.33
...
<Class id="qiskit.providers.BackendV1" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.19/qiskit/providers/backend.py" signature="BackendV1(configuration, provider=None, **fields)" modifiers="class">
