...
<Function id="qiskit.pulse.builder.snapshot" github="https://github.com/qiskit/qiskit/tree/stable/0.19/qiskit/pulse/builder.py" signature="snapshot(label, snapshot_type='statevector')">
  Simulator snapshot.
