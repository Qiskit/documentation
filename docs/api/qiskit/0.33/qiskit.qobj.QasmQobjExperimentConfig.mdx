...
<Class id="qiskit.qobj.QasmQobjExperimentConfig" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.19/qiskit/qobj/qasm_qobj.py" signature="QasmQobjExperimentConfig(calibrations=None, qubit_lo_freq=None, meas_lo_freq=None, **kwargs)">
  ...
  *   **kwargs** – Additional free form key value fields to add to the configuration
  ...
  <Function id="qiskit.qobj.QasmQobjExperimentConfig.from_dict" name="from_dict" signature="classmethod QasmQobjExperimentConfig.from_dict(data)">
  ...
  <Function id="qiskit.qobj.QasmQobjExperimentConfig.to_dict" name="to_dict" signature="QasmQobjExperimentConfig.to_dict()">
