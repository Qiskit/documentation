---
title: PulseQobj (v0.33)
description: API reference for qiskit.qobj.PulseQobj in qiskit v0.33
...
<Class id="qiskit.qobj.PulseQobj" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.19/qiskit/qobj/pulse_qobj.py" signature="PulseQobj(qobj_id, config, experiments, header=None)" modifiers="class">
  Bases: `object`
