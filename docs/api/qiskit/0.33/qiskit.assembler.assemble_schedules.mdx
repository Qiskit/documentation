...
<Function id="qiskit.assembler.assemble_schedules" github="https://github.com/qiskit/qiskit/tree/stable/0.19/qiskit/assembler/assemble_schedules.py" signature="assemble_schedules(schedules, qobj_id, qobj_header, run_config)">
