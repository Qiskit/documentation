...
Currently, only simple expressions on bits and registers that result in a Boolean value are supported, and these are only valid for use in the conditions of [`QuantumCircuit.if_test()`](qiskit.circuit.QuantumCircuit#if_test "qiskit.circuit.QuantumCircuit.if_test") ([`IfElseOp`](/docs/api/qiskit/qiskit.circuit.IfElseOp "qiskit.circuit.IfElseOp")) and [`QuantumCircuit.while_loop()`](qiskit.circuit.QuantumCircuit#while_loop "qiskit.circuit.QuantumCircuit.while_loop") ([`WhileLoopOp`](/docs/api/qiskit/qiskit.circuit.WhileLoopOp "qiskit.circuit.WhileLoopOp")), and in the target of [`QuantumCircuit.switch()`](qiskit.circuit.QuantumCircuit#switch "qiskit.circuit.QuantumCircuit.switch") ([`SwitchCaseOp`](/docs/api/qiskit/qiskit.circuit.SwitchCaseOp "qiskit.circuit.SwitchCaseOp")).
...
<Class id="qiskit.circuit.classical.expr.Expr" signature="qiskit.circuit.classical.expr.Expr" modifiers="class">
...
All [`Expr`](#qiskit.circuit.classical.expr.Expr "qiskit.circuit.classical.expr.Expr") instances define a boolean `const` attribute, which indicates whether the expression can be evaluated at compile time. Most expression classes infer this during construction based on the const-ness of their operands.
...
<Class id="qiskit.circuit.classical.expr.Var" signature="qiskit.circuit.classical.expr.Var(var, type, *, name=None)" modifiers="class">
  Bases: [`Expr`](#qiskit.circuit.classical.expr.Expr "qiskit._accelerate.circuit.classical.expr.Expr")
  ...
  <Attribute id="qiskit.circuit.classical.expr.Var.name" name="name" headingLevel={5}>
    The name of the variable. This is required to exist if the backing [`var`](#qiskit.circuit.classical.expr.Var.var "qiskit.circuit.classical.expr.Var.var") attribute is a [`UUID`](https://docs.python.org/3/library/uuid.html#uuid.UUID), i.e. if it is a new-style variable, and must be `None` if it is an old-style variable.
  </Attribute>
...
<Class id="qiskit.circuit.classical.expr.Value" signature="qiskit.circuit.classical.expr.Value(value, type)" modifiers="class">
  Bases: [`Expr`](#qiskit.circuit.classical.expr.Expr "qiskit._accelerate.circuit.classical.expr.Expr")
...
<Class id="qiskit.circuit.classical.expr.Stretch" signature="qiskit.circuit.classical.expr.Stretch(var, name)" modifiers="class">
  Bases: [`Expr`](#qiskit.circuit.classical.expr.Expr "qiskit._accelerate.circuit.classical.expr.Expr")

  A stretch variable.

  In general, construction of stretch variables for use in programs should use [`Stretch.new()`](#qiskit.circuit.classical.expr.Stretch.new "qiskit.circuit.classical.expr.Stretch.new") or [`QuantumCircuit.add_stretch()`](qiskit.circuit.QuantumCircuit#add_stretch "qiskit.circuit.QuantumCircuit.add_stretch")

  <Attribute id="qiskit.circuit.classical.expr.Stretch.name" name="name" headingLevel={5}>
    The name of the stretch variable.
  </Attribute>

  ##### new

  <Function id="qiskit.circuit.classical.expr.Stretch.new" signature="new(name)" modifiers="classmethod">
    Generate a new named stretch variable.
  </Function>

  <Attribute id="qiskit.circuit.classical.expr.Stretch.var" name="var" headingLevel={5}>
    A [`UUID`](https://docs.python.org/3/library/uuid.html#uuid.UUID) to uniquely identify this stretch.
  </Attribute>
</Class>
...
<Class id="qiskit.circuit.classical.expr.Unary" signature="qiskit.circuit.classical.expr.Unary(op, operand, type)" modifiers="class">
  Bases: [`Expr`](#qiskit.circuit.classical.expr.Expr "qiskit._accelerate.circuit.classical.expr.Expr")
  ...
  *   **type** – The resolved type of the result.
  ...
  <Class id="qiskit.circuit.classical.expr.Unary.Op" signature="Op(*values)" modifiers="class">
    ...
    The arithmetic negation `NEGATE` takes an input that is either float or duration and returns a value of the same type.
  </Class>
</Class>

#### Binary

<Class id="qiskit.circuit.classical.expr.Binary" signature="qiskit.circuit.classical.expr.Binary(op, left, right, type)" modifiers="class">
  Bases: [`Expr`](#qiskit.circuit.classical.expr.Expr "qiskit._accelerate.circuit.classical.expr.Expr")
  ...
  *   **type** – The resolved type of the result.
  ...
  <Class id="qiskit.circuit.classical.expr.Binary.Op" signature="Op(*values)" modifiers="class">
    Bases: [`Enum`](https://docs.python.org/3/library/enum.html#enum.Enum)
    ...
    The binary arithmetic operators `ADD`, `SUB`, `MUL`, and `DIV` can be applied to two floats or two unsigned integers, which should be made to be of the same width during construction via a cast. The `ADD`, `SUB`, and `DIV` operators can be applied on two durations yielding another duration, or a float in the case of `DIV`. The `MUL` operator can also be applied to a duration and a numeric type, yielding another duration. Finally, the `DIV` operator can be used to divide a duration by a numeric type, yielding a duration.
  </Class>
</Class>
...
<Class id="qiskit.circuit.classical.expr.Index" signature="qiskit.circuit.classical.expr.Index(target, index, type)" modifiers="class">
  Bases: [`Expr`](#qiskit.circuit.classical.expr.Expr "qiskit._accelerate.circuit.classical.expr.Expr")
...
<Class id="qiskit.circuit.classical.expr.Cast" signature="qiskit.circuit.classical.expr.Cast(operand, type, implicit=False)" modifiers="class">
  Bases: [`Expr`](#qiskit.circuit.classical.expr.Expr "qiskit._accelerate.circuit.classical.expr.Expr")
...
<Function id="qiskit.circuit.classical.expr.lift" github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/circuit/classical/expr/constructors.py#L85-L144" signature="qiskit.circuit.classical.expr.lift(value, /, type=None)">
  Lift the given Python `value` to a [`Value`](#qiskit.circuit.classical.expr.Value "qiskit.circuit.classical.expr.Value") or [`Var`](#qiskit.circuit.classical.expr.Var "qiskit.circuit.classical.expr.Var").

  If an explicit `type` is given, the typing in the output will reflect that.

  **Examples**

  Lifting simple circuit objects to be [`Var`](#qiskit.circuit.classical.expr.Var "qiskit.circuit.classical.expr.Var") instances:
  ...
  The type of the return value can be influenced, if the given value could be interpreted losslessly as the given type (use [`cast()`](#qiskit.circuit.classical.expr.cast "qiskit.circuit.classical.expr.cast") to perform a full set of casting operations, including lossy ones):
  ...
  *   **type** ([*Type*](#qiskit.circuit.classical.types.Type "qiskit._accelerate.circuit.classical.types.Type") *| None*)

  **Return type**

  [*Expr*](#qiskit.circuit.classical.expr.Expr "qiskit._accelerate.circuit.classical.expr.Expr")
</Function>
...
<Function id="qiskit.circuit.classical.expr.cast" github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/circuit/classical/expr/constructors.py#L147-L162" signature="qiskit.circuit.classical.expr.cast(operand, type, /)">
  ...
  *   **operand** ([*Any*](https://docs.python.org/3/library/typing.html#typing.Any))
...
<Function id="qiskit.circuit.classical.expr.bit_not" github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/circuit/classical/expr/constructors.py#L165-L180" signature="qiskit.circuit.classical.expr.bit_not(operand, /)">
...
<Function id="qiskit.circuit.classical.expr.logic_not" github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/circuit/classical/expr/constructors.py#L183-L203" signature="qiskit.circuit.classical.expr.logic_not(operand, /)">
...
<Function id="qiskit.circuit.classical.expr.negate" github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/circuit/classical/expr/constructors.py#L766-L793" signature="qiskit.circuit.classical.expr.negate(operand, /)">
  Negate an expression node from the given value, resolving any implicit casts and lifting the value into a [`Value`](#qiskit.circuit.classical.expr.Value "qiskit.circuit.classical.expr.Value") node if required.
...
<Function id="qiskit.circuit.classical.expr.bit_and" github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/circuit/classical/expr/constructors.py#L259-L275" signature="qiskit.circuit.classical.expr.bit_and(left, right, /)">
  ...
  *   **left** ([*Any*](https://docs.python.org/3/library/typing.html#typing.Any))
  *   **right** ([*Any*](https://docs.python.org/3/library/typing.html#typing.Any))
...
<Function id="qiskit.circuit.classical.expr.bit_or" github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/circuit/classical/expr/constructors.py#L278-L294" signature="qiskit.circuit.classical.expr.bit_or(left, right, /)">
...
<Function id="qiskit.circuit.classical.expr.bit_xor" github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/circuit/classical/expr/constructors.py#L297-L313" signature="qiskit.circuit.classical.expr.bit_xor(left, right, /)">
...
<Function id="qiskit.circuit.classical.expr.logic_and" github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/circuit/classical/expr/constructors.py#L327-L339" signature="qiskit.circuit.classical.expr.logic_and(left, right, /)">
...
<Function id="qiskit.circuit.classical.expr.logic_or" github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/circuit/classical/expr/constructors.py#L342-L354" signature="qiskit.circuit.classical.expr.logic_or(left, right, /)">
...
<Function id="qiskit.circuit.classical.expr.equal" github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/circuit/classical/expr/constructors.py#L367-L382" signature="qiskit.circuit.classical.expr.equal(left, right, /)">
...
<Function id="qiskit.circuit.classical.expr.not_equal" github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/circuit/classical/expr/constructors.py#L385-L400" signature="qiskit.circuit.classical.expr.not_equal(left, right, /)">
...
<Function id="qiskit.circuit.classical.expr.less" github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/circuit/classical/expr/constructors.py#L413-L428" signature="qiskit.circuit.classical.expr.less(left, right, /)">
...
<Function id="qiskit.circuit.classical.expr.less_equal" github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/circuit/classical/expr/constructors.py#L431-L446" signature="qiskit.circuit.classical.expr.less_equal(left, right, /)">
...
<Function id="qiskit.circuit.classical.expr.greater" github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/circuit/classical/expr/constructors.py#L449-L464" signature="qiskit.circuit.classical.expr.greater(left, right, /)">
...
<Function id="qiskit.circuit.classical.expr.greater_equal" github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/circuit/classical/expr/constructors.py#L467-L482" signature="qiskit.circuit.classical.expr.greater_equal(left, right, /)">
...
<Function id="qiskit.circuit.classical.expr.shift_left" github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/circuit/classical/expr/constructors.py#L504-L529" signature="qiskit.circuit.classical.expr.shift_left(left, right, /, type=None)">
...
<Function id="qiskit.circuit.classical.expr.shift_right" github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/circuit/classical/expr/constructors.py#L532-L549" signature="qiskit.circuit.classical.expr.shift_right(left, right, /, type=None)">
...
<Function id="qiskit.circuit.classical.expr.add" github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/circuit/classical/expr/constructors.py#L589-L615" signature="qiskit.circuit.classical.expr.add(left, right, /)">
...
<Function id="qiskit.circuit.classical.expr.sub" github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/circuit/classical/expr/constructors.py#L618-L644" signature="qiskit.circuit.classical.expr.sub(left, right, /)">
...
<Function id="qiskit.circuit.classical.expr.mul" github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/circuit/classical/expr/constructors.py#L647-L695" signature="qiskit.circuit.classical.expr.mul(left, right)">
...
<Function id="qiskit.circuit.classical.expr.div" github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/circuit/classical/expr/constructors.py#L698-L763" signature="qiskit.circuit.classical.expr.div(left, right)">
  ...
  This can be used to divide numeric operands of the same type kind, to divide a [`Duration`](#qiskit.circuit.classical.types.Duration "qiskit.circuit.classical.types.Duration") operand by a numeric operand, or to divide two [`Duration`](#qiskit.circuit.classical.types.Duration "qiskit.circuit.classical.types.Duration") operands which yields an expression of type [`Float`](#qiskit.circuit.classical.types.Float "qiskit.circuit.classical.types.Float").
...
<Function id="qiskit.circuit.classical.expr.index" github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/circuit/classical/expr/constructors.py#L552-L569" signature="qiskit.circuit.classical.expr.index(target, index, /)">
  ...
  *   **target** ([*Any*](https://docs.python.org/3/library/typing.html#typing.Any))
  *   **index** ([*Any*](https://docs.python.org/3/library/typing.html#typing.Any))
...
<Function id="qiskit.circuit.classical.expr.lift_legacy_condition" github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/circuit/classical/expr/constructors.py#L68-L82" signature="qiskit.circuit.classical.expr.lift_legacy_condition(condition, /)">
  ...
  **condition** ([*tuple*](https://docs.python.org/3/library/stdtypes.html#tuple)*\[*[*qiskit.circuit.Clbit*](circuit#qiskit.circuit.Clbit "qiskit.circuit.Clbit")  *|*[*qiskit.circuit.ClassicalRegister*](circuit#qiskit.circuit.ClassicalRegister "qiskit.circuit.ClassicalRegister")*,* [*int*](https://docs.python.org/3/library/functions.html#int)*]*)
...
<Class id="qiskit.circuit.classical.expr.ExprVisitor" github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/circuit/classical/expr/visitors.py#L32-L63" signature="qiskit.circuit.classical.expr.ExprVisitor" modifiers="class">
  Bases: [`Generic`](https://docs.python.org/3/library/typing.html#typing.Generic)\[`_T_co`]
  ...
  <Function id="qiskit.circuit.classical.expr.ExprVisitor.visit_binary" github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/circuit/classical/expr/visitors.py#L56-L57" signature="visit_binary(node, /)">
    **Parameters**

    **node** ([*Binary*](#qiskit.circuit.classical.expr.Binary "qiskit._accelerate.circuit.classical.expr.Binary"))
  ...
  <Function id="qiskit.circuit.classical.expr.ExprVisitor.visit_cast" github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/circuit/classical/expr/visitors.py#L59-L60" signature="visit_cast(node, /)">
    **Parameters**

    **node** ([*Cast*](#qiskit.circuit.classical.expr.Cast "qiskit._accelerate.circuit.classical.expr.Cast"))
  ...
  <Function id="qiskit.circuit.classical.expr.ExprVisitor.visit_generic" github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/circuit/classical/expr/visitors.py#L41-L42" signature="visit_generic(node, /)">
    **Parameters**

    **node** ([*Expr*](#qiskit.circuit.classical.expr.Expr "qiskit._accelerate.circuit.classical.expr.Expr"))
  ...
  <Function id="qiskit.circuit.classical.expr.ExprVisitor.visit_index" github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/circuit/classical/expr/visitors.py#L62-L63" signature="visit_index(node, /)">
    **Parameters**

    **node** ([*Index*](#qiskit.circuit.classical.expr.Index "qiskit._accelerate.circuit.classical.expr.Index"))
  ...
  <Function id="qiskit.circuit.classical.expr.ExprVisitor.visit_stretch" github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/circuit/classical/expr/visitors.py#L47-L48" signature="visit_stretch(node, /)">
    **Parameters**

    **node** ([*Stretch*](#qiskit.circuit.classical.expr.Stretch "qiskit._accelerate.circuit.classical.expr.Stretch"))
  ...
  <Function id="qiskit.circuit.classical.expr.ExprVisitor.visit_unary" github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/circuit/classical/expr/visitors.py#L53-L54" signature="visit_unary(node, /)">
    **Parameters**

    **node** ([*Unary*](#qiskit.circuit.classical.expr.Unary "qiskit._accelerate.circuit.classical.expr.Unary"))
  ...
  <Function id="qiskit.circuit.classical.expr.ExprVisitor.visit_value" github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/circuit/classical/expr/visitors.py#L50-L51" signature="visit_value(node, /)">
    **Parameters**

    **node** ([*Value*](#qiskit.circuit.classical.expr.Value "qiskit._accelerate.circuit.classical.expr.Value"))
  ...
  <Function id="qiskit.circuit.classical.expr.ExprVisitor.visit_var" github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/circuit/classical/expr/visitors.py#L44-L45" signature="visit_var(node, /)">
    **Parameters**

    **node** ([*Var*](#qiskit.circuit.classical.expr.Var "qiskit._accelerate.circuit.classical.expr.Var"))
...
<Function id="qiskit.circuit.classical.expr.iter_vars" github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/circuit/classical/expr/visitors.py#L129-L151" signature="qiskit.circuit.classical.expr.iter_vars(node)">
  Get an iterator over the [`Var`](#qiskit.circuit.classical.expr.Var "qiskit.circuit.classical.expr.Var") nodes referenced at any level in the given [`Expr`](#qiskit.circuit.classical.expr.Expr "qiskit.circuit.classical.expr.Expr").
  ...
  **Examples**
  ...
  <Admonition title="See also" type="note">
    **[`iter_identifiers()`](#qiskit.circuit.classical.expr.iter_identifiers "qiskit.circuit.classical.expr.iter_identifiers")**
    ...
    Get an iterator over all identifier nodes in the expression, including both [`Var`](#qiskit.circuit.classical.expr.Var "qiskit.circuit.classical.expr.Var") and [`Stretch`](#qiskit.circuit.classical.expr.Stretch "qiskit.circuit.classical.expr.Stretch") nodes.
  </Admonition>
  ...
  **Return type**
  ...
  [*Iterator*](https://docs.python.org/3/library/typing.html#typing.Iterator)\[[*Var*](#qiskit.circuit.classical.expr.Var "qiskit._accelerate.circuit.classical.expr.Var")]
</Function>
...
<Function id="qiskit.circuit.classical.expr.iter_identifiers" github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/circuit/classical/expr/visitors.py#L154-L175" signature="qiskit.circuit.classical.expr.iter_identifiers(node)">
  ...
  **Examples**
  ...
  <Admonition title="See also" type="note">
    **[`iter_vars()`](#qiskit.circuit.classical.expr.iter_vars "qiskit.circuit.classical.expr.iter_vars")**
    ...
    Get an iterator over just the [`Var`](#qiskit.circuit.classical.expr.Var "qiskit.circuit.classical.expr.Var") nodes in the expression.
  </Admonition>
  ...
  **Return type**
  ...
  [*Iterator*](https://docs.python.org/3/library/typing.html#typing.Iterator)\[[*Var*](#qiskit.circuit.classical.expr.Var "qiskit._accelerate.circuit.classical.expr.Var") | [*Stretch*](#qiskit.circuit.classical.expr.Stretch "qiskit._accelerate.circuit.classical.expr.Stretch")]
</Function>
...
<Function id="qiskit.circuit.classical.expr.structurally_equivalent" github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/circuit/classical/expr/visitors.py#L259-L308" signature="qiskit.circuit.classical.expr.structurally_equivalent(left, right, left_var_key=None, right_var_key=None)">
  Do these two expressions have exactly the same tree structure, up to some key function for the [`Var`](#qiskit.circuit.classical.expr.Var "qiskit.circuit.classical.expr.Var") objects?
  ...
  *   **left** ([*Expr*](#qiskit.circuit.classical.expr.Expr "qiskit._accelerate.circuit.classical.expr.Expr")) – one of the [`Expr`](#qiskit.circuit.classical.expr.Expr "qiskit.circuit.classical.expr.Expr") nodes.
  *   **right** ([*Expr*](#qiskit.circuit.classical.expr.Expr "qiskit._accelerate.circuit.classical.expr.Expr")) – the other [`Expr`](#qiskit.circuit.classical.expr.Expr "qiskit.circuit.classical.expr.Expr") node.
  *   **left\_var\_key** ([*Callable*](https://docs.python.org/3/library/typing.html#typing.Callable)*\[\[*[*Any*](https://docs.python.org/3/library/typing.html#typing.Any)*],* [*Any*](https://docs.python.org/3/library/typing.html#typing.Any)*] | None*) – a callable whose output should be used when comparing [`Var.var`](#qiskit.circuit.classical.expr.Var.var "qiskit.circuit.classical.expr.Var.var") attributes. If this argument is `None` or its output is `None` for a given variable in `left`, the variable will be used verbatim.
  *   **right\_var\_key** ([*Callable*](https://docs.python.org/3/library/typing.html#typing.Callable)*\[\[*[*Any*](https://docs.python.org/3/library/typing.html#typing.Any)*],* [*Any*](https://docs.python.org/3/library/typing.html#typing.Any)*] | None*) – same as `left_var_key`, but used on the variables in `right` instead.
...
<Function id="qiskit.circuit.classical.expr.is_lvalue" github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/circuit/classical/expr/visitors.py#L339-L379" signature="qiskit.circuit.classical.expr.is_lvalue(node, /)">
  ...
  **Examples**
  ...
  [`Var`](#qiskit.circuit.classical.expr.Var "qiskit.circuit.classical.expr.Var") nodes are always l-values, because they always have some associated memory location:
...
<Class id="qiskit.circuit.classical.types.Type" signature="qiskit.circuit.classical.types.Type" modifiers="class">
  Bases: [`object`](https://docs.python.org/3/library/functions.html#object)
...
<Class id="qiskit.circuit.classical.types.Bool" signature="qiskit.circuit.classical.types.Bool" modifiers="class">
  Bases: [`Type`](#qiskit.circuit.classical.types.Type "qiskit._accelerate.circuit.classical.types.Type")
...
<Class id="qiskit.circuit.classical.types.Uint" signature="qiskit.circuit.classical.types.Uint(width)" modifiers="class">
  Bases: [`Type`](#qiskit.circuit.classical.types.Type "qiskit._accelerate.circuit.classical.types.Type")
...
<Class id="qiskit.circuit.classical.types.Float" signature="qiskit.circuit.classical.types.Float" modifiers="class">
  Bases: [`Type`](#qiskit.circuit.classical.types.Type "qiskit._accelerate.circuit.classical.types.Type")
...
<Class id="qiskit.circuit.classical.types.Duration" signature="qiskit.circuit.classical.types.Duration" modifiers="class">
  Bases: [`Type`](#qiskit.circuit.classical.types.Type "qiskit._accelerate.circuit.classical.types.Type")
...
<Function id="qiskit.circuit.classical.types.order" github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/circuit/classical/types/ordering.py#L74-L91" signature="qiskit.circuit.classical.types.order(left, right, /)">
...
<Class id="qiskit.circuit.classical.types.Ordering" github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/circuit/classical/types/ordering.py#L38-L55" signature="qiskit.circuit.classical.types.Ordering(*values)" modifiers="class">
  Bases: [`Enum`](https://docs.python.org/3/library/enum.html#enum.Enum)
...
<Function id="qiskit.circuit.classical.types.is_subtype" github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/circuit/classical/types/ordering.py#L94-L114" signature="qiskit.circuit.classical.types.is_subtype(left, right, /, strict=False)">
...
<Function id="qiskit.circuit.classical.types.is_supertype" github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/circuit/classical/types/ordering.py#L117-L137" signature="qiskit.circuit.classical.types.is_supertype(left, right, /, strict=False)">
...
<Function id="qiskit.circuit.classical.types.greater" github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/circuit/classical/types/ordering.py#L140-L163" signature="qiskit.circuit.classical.types.greater(left, right, /)">
  ...
  **Raises**
  ...
  [**TypeError**](https://docs.python.org/3/library/exceptions.html#TypeError) – if there is no ordering relation between the two types.
  ...
  **Return type**
  ...
  [*Type*](#qiskit.circuit.classical.types.Type "qiskit._accelerate.circuit.classical.types.Type")
...
It is common to need to cast values of one type to another type. The casting rules for this are embedded into the [`types`](https://docs.python.org/3/library/types.html#module-types) module. You can query the casting kinds using [`cast_kind()`](#qiskit.circuit.classical.types.cast_kind "qiskit.circuit.classical.types.cast_kind"):

#### cast\_kind

<Function id="qiskit.circuit.classical.types.cast_kind" github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/circuit/classical/types/ordering.py#L207-L229" signature="qiskit.circuit.classical.types.cast_kind(from_, to_, /)">
  ...
  *   **from\_** ([*Type*](#qiskit.circuit.classical.types.Type "qiskit._accelerate.circuit.classical.types.Type"))
  *   **to\_** ([*Type*](#qiskit.circuit.classical.types.Type "qiskit._accelerate.circuit.classical.types.Type"))
...
<Class id="qiskit.circuit.classical.types.CastKind" github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/circuit/classical/types/ordering.py#L166-L182" signature="qiskit.circuit.classical.types.CastKind(*values)" modifiers="class">
  Bases: [`Enum`](https://docs.python.org/3/library/enum.html#enum.Enum)
