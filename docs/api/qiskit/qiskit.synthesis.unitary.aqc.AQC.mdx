...
<Class id="qiskit.synthesis.unitary.aqc.AQC" github="https://github.com/qiskit/qiskit/tree/stable/1.0/qiskit/synthesis/unitary/aqc/aqc.py" signature="qiskit.synthesis.unitary.aqc.AQC(optimizer=None, seed=None)">
