...
<Class id="qiskit.transpiler.passes.OptimizeAnnotated" github="https://github.com/qiskit/qiskit/tree/stable/1.0/qiskit/transpiler/passes/optimization/optimize_annotated.py" signature="qiskit.transpiler.passes.OptimizeAnnotated(*args, **kwargs)">
  ...
  *   **recurse** – By default, when either `target` or `basis_gates` is specified, the pass recursively descends into gate definitions (and the recursion is not applied when neither is specified since such objects do not need to be synthesized). Setting this value to `False` precludes the recursion in every case.
  ...
  <Function id="qiskit.transpiler.passes.OptimizeAnnotated.execute" name="execute" signature="execute(passmanager_ir, state, callback=None)">
  ...
  <Function id="qiskit.transpiler.passes.OptimizeAnnotated.name" name="name" signature="name()">
    Name of the pass.
  ...
  <Function id="qiskit.transpiler.passes.OptimizeAnnotated.run" name="run" signature="run(dag)">
  ...
  <Function id="qiskit.transpiler.passes.OptimizeAnnotated.update_status" name="update_status" signature="update_status(state, run_state)">
