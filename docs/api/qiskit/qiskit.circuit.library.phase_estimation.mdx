...
<Function id="qiskit.circuit.library.phase_estimation" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/2.2/qiskit/circuit/library/phase_estimation.py#L109-L180" signature="qiskit.circuit.library.phase_estimation(num_evaluation_qubits, unitary, name='QPE')">
