---
title: TokenSwapperSynthesisPermutation (v2.0)
description: API reference for qiskit.transpiler.passes.synthesis.hls_plugins.TokenSwapperSynthesisPermutation in qiskit v2.0
