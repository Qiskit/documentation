---
title: Operation (v2.0)
description: API reference for qiskit.circuit.Operation in qiskit v2.0
...
<Class id="qiskit.circuit.Operation" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/2.0/qiskit/circuit/operation.py#L18-L68" signature="qiskit.circuit.Operation" modifiers="class">
  ...
  **Example**
  ...
  ![Circuit diagram output by the previous code.](/docs/images/api/qiskit/2.0/qiskit-circuit-Operation-1.avif)
