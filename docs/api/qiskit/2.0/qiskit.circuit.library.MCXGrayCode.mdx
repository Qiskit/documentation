---
title: MCXGrayCode (v2.0)
description: API reference for qiskit.circuit.library.MCXGrayCode in qiskit v2.0
...
<Class id="qiskit.circuit.library.MCXGrayCode" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/2.0/qiskit/circuit/library/standard_gates/x.py#L1217-L1289" signature="qiskit.circuit.library.MCXGrayCode(num_ctrl_qubits=None, label=None, ctrl_state=None, *, _base_label=None)" modifiers="class">
  ...
  *   **ctrl\_state** (*Optional\[Union\[*[*str*](https://docs.python.org/3/library/stdtypes.html#str)*,* [*int*](https://docs.python.org/3/library/functions.html#int)*]]*) –
  ...
  <Function id="qiskit.circuit.library.MCXGrayCode.inverse" github="https://github.com/Qiskit/qiskit/tree/stable/2.0/qiskit/circuit/library/standard_gates/x.py#L1269-L1281" signature="inverse(annotated=False)">
