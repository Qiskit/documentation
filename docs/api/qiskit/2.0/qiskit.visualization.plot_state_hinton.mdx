---
title: plot_state_hinton (v2.0)
description: API reference for qiskit.visualization.plot_state_hinton in qiskit v2.0
...
<Function id="qiskit.visualization.plot_state_hinton" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/2.0/qiskit/visualization/state_visualization.py#L39-L185" signature="qiskit.visualization.plot_state_hinton(state, title='', figsize=None, ax_real=None, ax_imag=None, *, filename=None)">
  ...
  **Examples**
  ...
  ![Output from the previous code.](/docs/images/api/qiskit/2.0/qiskit-visualization-plot_state_hinton-1.avif)
</Function>
