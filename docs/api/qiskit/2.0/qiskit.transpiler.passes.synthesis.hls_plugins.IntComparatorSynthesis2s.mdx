---
title: IntComparatorSynthesis2s (v2.0)
description: API reference for qiskit.transpiler.passes.synthesis.hls_plugins.IntComparatorSynthesis2s in qiskit v2.0
