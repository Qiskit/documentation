---
title: BackendV2 (v2.0)
description: API reference for qiskit.providers.BackendV2 in qiskit v2.0
...
<Class id="qiskit.providers.BackendV2" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/2.0/qiskit/providers/backend.py#L66-L364" signature="qiskit.providers.BackendV2(provider=None, name=None, description=None, online_date=None, backend_version=None, **fields)" modifiers="class">
  ...
  <Function id="qiskit.providers.BackendV2._default_options" github="https://github.com/Qiskit/qiskit/tree/stable/2.0/qiskit/providers/backend.py#L211-L225" signature="_default_options()" modifiers="abstract classmethod">
  ...
  **Raises**
  ...
  <Function id="qiskit.providers.BackendV2.qubit_properties" github="https://github.com/Qiskit/qiskit/tree/stable/2.0/qiskit/providers/backend.py#L269-L301" signature="qubit_properties(qubit)">
  ...
  <Function id="qiskit.providers.BackendV2.run" github="https://github.com/Qiskit/qiskit/tree/stable/2.0/qiskit/providers/backend.py#L341-L364" signature="run(run_input, **options)" modifiers="abstract">
    Run on the backend.
  ...
  <Function id="qiskit.providers.BackendV2.set_options" github="https://github.com/Qiskit/qiskit/tree/stable/2.0/qiskit/providers/backend.py#L303-L320" signature="set_options(**fields)">
