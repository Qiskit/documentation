---
title: evolved_operator_ansatz (v2.0)
description: API reference for qiskit.circuit.library.evolved_operator_ansatz in qiskit v2.0
...
<Function id="qiskit.circuit.library.evolved_operator_ansatz" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/2.0/qiskit/circuit/library/n_local/evolved_operator_ansatz.py#L40-L186" signature="qiskit.circuit.library.evolved_operator_ansatz(operators, reps=1, evolution=None, insert_barriers=False, name='EvolvedOps', parameter_prefix='t', remove_identities=True, flatten=None)">
...
$$
  ...
  **Examples**
  ...
  ![Circuit diagram output by the previous code.](/docs/images/api/qiskit/2.0/qiskit-circuit-library-evolved_operator_ansatz-1.avif)
