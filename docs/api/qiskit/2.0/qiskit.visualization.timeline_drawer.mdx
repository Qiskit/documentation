---
title: timeline_drawer (v2.0)
description: API reference for qiskit.visualization.timeline_drawer in qiskit v2.0
...
<Function id="qiskit.visualization.timeline_drawer" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/2.0/qiskit/visualization/timeline/interface.py#L32-L444" signature="qiskit.visualization.timeline_drawer(program, style=None, time_range=None, disable_bits=None, show_clbits=None, idle_wires=None, plot_barriers=None, show_delays=None, show_labels=True, plotter='mpl', axis=None, filename=None, target=None, *, show_idle=None, show_barriers=None)">
  ...
  **Examples**
  ...
  ![Output from the previous code.](/docs/images/api/qiskit/2.0/qiskit-visualization-timeline_drawer-1.avif)
  ...
  ![Output from the previous code.](/docs/images/api/qiskit/2.0/qiskit-visualization-timeline_drawer-2.avif)
  ...
  ![Output from the previous code.](/docs/images/api/qiskit/2.0/qiskit-visualization-timeline_drawer-3.avif)
