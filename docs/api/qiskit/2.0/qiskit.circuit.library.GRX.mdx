---
title: GRX (v2.0)
description: API reference for qiskit.circuit.library.GRX in qiskit v2.0
...
<Class id="qiskit.circuit.library.GRX" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/2.0/qiskit/circuit/library/generalized_gates/gr.py#L74-L120" signature="qiskit.circuit.library.GRX(num_qubits, theta)" modifiers="class">
...
$$
  ...
  **Expanded Circuit:**
  ...
  ![Diagram illustrating the previously described circuit.](/docs/images/api/qiskit/2.0/qiskit-circuit-library-GRX-1.avif)
  ...
  *   **theta** ([*float*](https://docs.python.org/3/library/functions.html#float)) – rotation angle about x-axis
  ...
  <Attribute id="qiskit.circuit.library.GRX.instances" attributeValue="287" />
