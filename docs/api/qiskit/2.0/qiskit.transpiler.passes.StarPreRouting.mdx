---
title: StarPreRouting (v2.0)
description: API reference for qiskit.transpiler.passes.StarPreRouting in qiskit v2.0
...
<Class id="qiskit.transpiler.passes.StarPreRouting" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/2.0/qiskit/transpiler/passes/routing/star_prerouting.py#L90-L367" signature="qiskit.transpiler.passes.StarPreRouting(*args, **kwargs)" modifiers="class">
  ...
  > ```
  >
  > ![Circuit diagram output by the previous code.](/docs/images/api/qiskit/2.0/qiskit-transpiler-passes-StarPreRouting-1.avif)
