---
title: GR (v2.0)
description: API reference for qiskit.circuit.library.GR in qiskit v2.0
...
$$
  ...
  **Expanded Circuit:**
  ...
  ![Diagram illustrating the previously described circuit.](/docs/images/api/qiskit/2.0/qiskit-circuit-library-GR-1.avif)
