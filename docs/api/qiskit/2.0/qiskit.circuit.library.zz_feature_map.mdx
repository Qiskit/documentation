---
title: zz_feature_map (v2.0)
description: API reference for qiskit.circuit.library.zz_feature_map in qiskit v2.0
...
<Function id="qiskit.circuit.library.zz_feature_map" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/2.0/qiskit/circuit/library/data_preparation/pauli_feature_map.py#L249-L321" signature="qiskit.circuit.library.zz_feature_map(feature_dimension, reps=2, entanglement='full', alpha=2.0, data_map_func=None, parameter_prefix='x', insert_barriers=False, name='ZZFeatureMap')">
