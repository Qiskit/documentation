---
title: unitary_overlap (v2.0)
description: API reference for qiskit.circuit.library.unitary_overlap in qiskit v2.0
...
<Function id="qiskit.circuit.library.unitary_overlap" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/2.0/qiskit/circuit/library/overlap.py#L105-L183" signature="qiskit.circuit.library.unitary_overlap(unitary1, unitary2, prefix1='p1', prefix2='p2', insert_barrier=False)">
...
$$
  ...
  **Reference Circuit:**
  ...
  ![Circuit diagram output by the previous code.](/docs/images/api/qiskit/2.0/qiskit-circuit-library-unitary_overlap-1.avif)
