---
title: hamiltonian_variational_ansatz (v2.0)
description: API reference for qiskit.circuit.library.hamiltonian_variational_ansatz in qiskit v2.0
...
$$
  ...
  **Examples**
  ...
  ![Circuit diagram output by the previous code.](/docs/images/api/qiskit/2.0/qiskit-circuit-library-hamiltonian_variational_ansatz-1.avif)
  ...
  ![Circuit diagram output by the previous code.](/docs/images/api/qiskit/2.0/qiskit-circuit-library-hamiltonian_variational_ansatz-2.avif)
