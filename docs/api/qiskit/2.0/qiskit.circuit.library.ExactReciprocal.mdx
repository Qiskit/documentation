---
title: ExactReciprocal (v2.0)
description: API reference for qiskit.circuit.library.ExactReciprocal in qiskit v2.0
...
$$
  ...
  *   **name** ([*str*](https://docs.python.org/3/library/stdtypes.html#str)) – The name of the object.
  ...
  <Attribute id="qiskit.circuit.library.ExactReciprocal.instances" attributeValue="213" />
