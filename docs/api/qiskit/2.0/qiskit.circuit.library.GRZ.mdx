---
title: GRZ (v2.0)
description: API reference for qiskit.circuit.library.GRZ in qiskit v2.0
...
<Class id="qiskit.circuit.library.GRZ" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/2.0/qiskit/circuit/library/generalized_gates/gr.py#L172-L219" signature="qiskit.circuit.library.GRZ(num_qubits, phi)" modifiers="class">
...
$$
  ...
  **Expanded Circuit:**
  ...
  ![Diagram illustrating the previously described circuit.](/docs/images/api/qiskit/2.0/qiskit-circuit-library-GRZ-1.avif)
  ...
  *   **phi** ([*float*](https://docs.python.org/3/library/functions.html#float)) – rotation angle about z-axis
  ...
  <Attribute id="qiskit.circuit.library.GRZ.instances" attributeValue="339" />
