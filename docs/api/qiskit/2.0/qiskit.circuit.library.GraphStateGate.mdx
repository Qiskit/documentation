---
title: GraphStateGate (v2.0)
description: API reference for qiskit.circuit.library.GraphStateGate in qiskit v2.0
...
$$
  ...
  **Reference Circuit:**
  ...
  ![Circuit diagram output by the previous code.](/docs/images/api/qiskit/2.0/qiskit-circuit-library-GraphStateGate-1.avif)
