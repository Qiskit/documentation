---
title: synthesis (v2.0)
description: API reference for qiskit.synthesis in qiskit v2.0
...
<Function id="qiskit.synthesis.multiplier_cumulative_h18" github="https://github.com/Qiskit/qiskit/tree/stable/2.0/qiskit/synthesis/arithmetic/multipliers/hrs_cumulative_multiplier.py#L21-L103" signature="qiskit.synthesis.multiplier_cumulative_h18(num_state_qubits, num_result_qubits=None)">
  ...
  ![Circuit diagram output by the previous code.](/docs/images/api/qiskit/2.0/synthesis-1.avif)
...
<Function id="qiskit.synthesis.multiplier_qft_r17" github="https://github.com/Qiskit/qiskit/tree/stable/2.0/qiskit/synthesis/arithmetic/multipliers/rg_qft_multiplier.py#L25-L100" signature="qiskit.synthesis.multiplier_qft_r17(num_state_qubits, num_result_qubits=None)">
  ...
  ![Circuit diagram output by the previous code.](/docs/images/api/qiskit/2.0/synthesis-2.avif)
