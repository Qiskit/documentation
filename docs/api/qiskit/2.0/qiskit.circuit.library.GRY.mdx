---
title: GRY (v2.0)
description: API reference for qiskit.circuit.library.GRY in qiskit v2.0
...
$$
  ...
  **Expanded Circuit:**
  ...
  ![Diagram illustrating the previously described circuit.](/docs/images/api/qiskit/2.0/qiskit-circuit-library-GRY-1.avif)
  ...
  *   **theta** ([*float*](https://docs.python.org/3/library/functions.html#float)) – rotation angle about y-axis
  ...
  <Attribute id="qiskit.circuit.library.GRY.instances" attributeValue="287" />
