---
title: ModularAdderSynthesisDefault (v2.0)
description: API reference for qiskit.transpiler.passes.synthesis.hls_plugins.ModularAdderSynthesisDefault in qiskit v2.0
