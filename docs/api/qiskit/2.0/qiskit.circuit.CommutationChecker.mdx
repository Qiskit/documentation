---
title: CommutationChecker (v2.0)
description: API reference for qiskit.circuit.CommutationChecker in qiskit v2.0
...
<Class id="qiskit.circuit.CommutationChecker" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/2.0/qiskit/circuit/commutation_checker.py#L22-L133" signature="qiskit.circuit.CommutationChecker(standard_gate_commutations=None, cache_max_entries=1000000, *, gates=None)" modifiers="class">
...
$$
  ...
  *   **gates** (*Optional\[Set\[*[*str*](https://docs.python.org/3/library/stdtypes.html#str)*]]*) –
  ...
  <Function id="qiskit.circuit.CommutationChecker.check_commutation_entries" github="https://github.com/Qiskit/qiskit/tree/stable/2.0/qiskit/circuit/commutation_checker.py#L113-L133" signature="check_commutation_entries(first_op, first_qargs, second_op, second_qargs)">
  ...
  <Function id="qiskit.circuit.CommutationChecker.clear_cached_commutations" github="https://github.com/Qiskit/qiskit/tree/stable/2.0/qiskit/circuit/commutation_checker.py#L109-L111" signature="clear_cached_commutations()">
    Clears the dictionary holding cached commutations
  </Function>

  ### commute

  <Function id="qiskit.circuit.CommutationChecker.commute" github="https://github.com/Qiskit/qiskit/tree/stable/2.0/qiskit/circuit/commutation_checker.py#L69-L103" signature="commute(op1, qargs1, cargs1, op2, qargs2, cargs2, max_num_qubits=3, approximation_degree=1.0)">
  ...
  <Function id="qiskit.circuit.CommutationChecker.commute_nodes" github="https://github.com/Qiskit/qiskit/tree/stable/2.0/qiskit/circuit/commutation_checker.py#L59-L67" signature="commute_nodes(op1, op2, max_num_qubits=3, approximation_degree=1.0)">
  ...
  <Function id="qiskit.circuit.CommutationChecker.num_cached_entries" github="https://github.com/Qiskit/qiskit/tree/stable/2.0/qiskit/circuit/commutation_checker.py#L105-L107" signature="num_cached_entries()">
