---
title: plot_state_paulivec (v2.0)
description: API reference for qiskit.visualization.plot_state_paulivec in qiskit v2.0
...
$$
  ...
  **Examples**
  ...
  ![Output from the previous code.](/docs/images/api/qiskit/2.0/qiskit-visualization-plot_state_paulivec-1.avif)
  ...
  ![Output from the previous code.](/docs/images/api/qiskit/2.0/qiskit-visualization-plot_state_paulivec-2.avif)
</Function>
