---
title: HiddenLinearFunction (v2.0)
description: API reference for qiskit.circuit.library.HiddenLinearFunction in qiskit v2.0
...
<Class id="qiskit.circuit.library.HiddenLinearFunction" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/2.0/qiskit/circuit/library/hidden_linear_function.py#L23-L89" signature="qiskit.circuit.library.HiddenLinearFunction(adjacency_matrix)" modifiers="class">
...
$$
  ...
  **Reference Circuit:**
  ...
  > ![Diagram illustrating the previously described circuit.](/docs/images/api/qiskit/2.0/qiskit-circuit-library-HiddenLinearFunction-1.avif)
  ...
  **Raises**
  ...
  <Attribute id="qiskit.circuit.library.HiddenLinearFunction.cregs">
    A list of `Clbit`s in the order that they were added. You should not mutate this.
  </Attribute>
  ...
  <Attribute id="qiskit.circuit.library.HiddenLinearFunction.instances" attributeValue="195" />
  ...
  <Attribute id="qiskit.circuit.library.HiddenLinearFunction.num_captured_stretches">
    The number of stretches in the circuit marked as captured from an enclosing scope.

    This is the length of the `iter_captured_stretches()` iterable. If this is non-zero, [`num_input_vars`](#qiskit.circuit.library.HiddenLinearFunction.num_input_vars "qiskit.circuit.library.HiddenLinearFunction.num_input_vars") must be zero.
  </Attribute>
  ...
  <Attribute id="qiskit.circuit.library.HiddenLinearFunction.num_declared_stretches">
  ...
  <Attribute id="qiskit.circuit.library.HiddenLinearFunction.num_identifiers">
    The number of real-time classical variables and stretches in the circuit.

    This is equal to [`num_vars()`](#qiskit.circuit.library.HiddenLinearFunction.num_vars "qiskit.circuit.library.HiddenLinearFunction.num_vars") + [`num_stretches()`](#qiskit.circuit.library.HiddenLinearFunction.num_stretches "qiskit.circuit.library.HiddenLinearFunction.num_stretches").
  </Attribute>
  ...
  <Attribute id="qiskit.circuit.library.HiddenLinearFunction.num_stretches">
  ...
  <Attribute id="qiskit.circuit.library.HiddenLinearFunction.qregs">
