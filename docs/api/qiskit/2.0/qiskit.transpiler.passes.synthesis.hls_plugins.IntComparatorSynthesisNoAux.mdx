---
title: IntComparatorSynthesisNoAux (v2.0)
description: API reference for qiskit.transpiler.passes.synthesis.hls_plugins.IntComparatorSynthesisNoAux in qiskit v2.0
