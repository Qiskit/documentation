---
title: UnitarySynthesisPluginManager (v2.0)
description: API reference for qiskit.transpiler.passes.synthesis.plugin.UnitarySynthesisPluginManager in qiskit v2.0
