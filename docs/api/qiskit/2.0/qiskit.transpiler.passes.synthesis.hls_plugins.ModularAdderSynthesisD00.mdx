---
title: ModularAdderSynthesisD00 (v2.0)
description: API reference for qiskit.transpiler.passes.synthesis.hls_plugins.ModularAdderSynthesisD00 in qiskit v2.0
