---
title: DefaultSynthesisClifford (v2.0)
description: API reference for qiskit.transpiler.passes.synthesis.hls_plugins.DefaultSynthesisClifford in qiskit v2.0
