...
<Function id="qiskit.result.sampled_expectation_value" github="https://github.com/Qiskit/qiskit/tree/stable/2.0/qiskit/result/sampled_expval.py#L26-L74" signature="qiskit.result.sampled_expectation_value(dist, oper)">
  ...
  *   **oper** ([*str*](https://docs.python.org/3/library/stdtypes.html#str)  *or*[*Pauli*](qiskit.quantum_info.Pauli "qiskit.quantum_info.Pauli")  *or*[*SparsePauliOp*](qiskit.quantum_info.SparsePauliOp "qiskit.quantum_info.SparsePauliOp")) – The operator for the observable
