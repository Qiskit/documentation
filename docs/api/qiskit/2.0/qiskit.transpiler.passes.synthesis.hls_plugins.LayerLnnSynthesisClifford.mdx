---
title: LayerLnnSynthesisClifford (v2.0)
description: API reference for qiskit.transpiler.passes.synthesis.hls_plugins.LayerLnnSynthesisClifford in qiskit v2.0
