---
title: ExcitationPreserving (v2.0)
description: API reference for qiskit.circuit.library.ExcitationPreserving in qiskit v2.0
...
$$
  ...
  **Raises**
  ...
  <Attribute id="qiskit.circuit.library.ExcitationPreserving.instances" attributeValue="226" />
