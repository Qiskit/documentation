---
title: IntComparatorSynthesisDefault (v2.0)
description: API reference for qiskit.transpiler.passes.synthesis.hls_plugins.IntComparatorSynthesisDefault in qiskit v2.0
