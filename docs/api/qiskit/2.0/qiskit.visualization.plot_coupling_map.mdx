---
title: plot_coupling_map (v2.0)
description: API reference for qiskit.visualization.plot_coupling_map in qiskit v2.0
...
<Function id="qiskit.visualization.plot_coupling_map" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/2.0/qiskit/visualization/gate_map.py#L938-L1126" signature="qiskit.visualization.plot_coupling_map(num_qubits, qubit_coordinates, coupling_map, figsize=None, plot_directed=False, label_qubits=True, qubit_size=None, line_width=4, font_size=None, qubit_color=None, qubit_labels=None, line_color=None, font_color='white', ax=None, filename=None, *, planar=True)">
  ...
  **Example**
  ...
  ![Output from the previous code.](/docs/images/api/qiskit/2.0/qiskit-visualization-plot_coupling_map-1.avif)
</Function>
