---
title: plot_histogram (v2.0)
description: API reference for qiskit.visualization.plot_histogram in qiskit v2.0
...
<Function id="qiskit.visualization.plot_histogram" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/2.0/qiskit/visualization/counts_visualization.py#L59-L163" signature="qiskit.visualization.plot_histogram(data, figsize=None, color=None, number_to_keep=None, sort='asc', target_string=None, legend=None, bar_labels=True, title=None, ax=None, filename=None)">
  ...
  **Examples**
  ...
  ![Output from the previous code.](/docs/images/api/qiskit/2.0/qiskit-visualization-plot_histogram-1_00.avif)

  ![Output from the previous code.](/docs/images/api/qiskit/2.0/qiskit-visualization-plot_histogram-1_01.avif)

  ![Output from the previous code.](/docs/images/api/qiskit/2.0/qiskit-visualization-plot_histogram-1_02.avif)
</Function>
