---
title: OR (v2.0)
description: API reference for qiskit.circuit.library.OR in qiskit v2.0
...
<Class id="qiskit.circuit.library.OR" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/2.0/qiskit/circuit/library/boolean_logic/quantum_or.py#L24-L107" signature="qiskit.circuit.library.OR(num_variable_qubits, flags=None, mcx_mode='noancilla')" modifiers="class">
  ...
  ![Diagram illustrating the previously described circuit.](/docs/images/api/qiskit/2.0/qiskit-circuit-library-OR-1.avif)
  ...
  ![Diagram illustrating the previously described circuit.](/docs/images/api/qiskit/2.0/qiskit-circuit-library-OR-2.avif)
  ...
  *   **mcx\_mode** ([*str*](https://docs.python.org/3/library/stdtypes.html#str)) – The mode to be used to implement the multi-controlled X gate.
  ...
  <Attribute id="qiskit.circuit.library.OR.instances" attributeValue="338" />
