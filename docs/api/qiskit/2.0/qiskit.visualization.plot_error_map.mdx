---
title: plot_error_map (v2.0)
description: API reference for qiskit.visualization.plot_error_map in qiskit v2.0
...
<Function id="qiskit.visualization.plot_error_map" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/2.0/qiskit/visualization/gate_map.py#L1231-L1424" signature="qiskit.visualization.plot_error_map(backend, figsize=(15, 12), show_title=True, qubit_coordinates=None)">
  ...
  **Example**
  ...
  ![Output from the previous code.](/docs/images/api/qiskit/2.0/qiskit-visualization-plot_error_map-1.avif)
</Function>
