...
<Class id="qiskit.passmanager.ConditionalController" github="https://github.com/Qiskit/qiskit/tree/stable/1.0/qiskit/passmanager/flow_controllers.py#L90-L116" signature="qiskit.passmanager.ConditionalController(tasks=(), condition=None, *, options=None)">
