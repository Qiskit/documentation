...
<Class id="qiskit.passmanager.ConditionalController" github="https://github.com/qiskit/qiskit/tree/stable/1.0/qiskit/passmanager/flow_controllers.py" signature="qiskit.passmanager.ConditionalController(tasks=(), condition=None, *, options=None)">
