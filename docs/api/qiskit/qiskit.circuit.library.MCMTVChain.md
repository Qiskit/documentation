...
`qiskit.circuit.library.MCMTVChain(gate, num_ctrl_qubits, num_target_qubits)`
...
*   **num\_target\_qubits** ([*int*](https://docs.python.org/3/library/functions.html#int "(in Python v3.11)")) – The number of target qubits.

**Raises**

*   [**AttributeError**](https://docs.python.org/3/library/exceptions.html#AttributeError "(in Python v3.11)") – If the gate cannot be casted to a controlled gate.
*   [**AttributeError**](https://docs.python.org/3/library/exceptions.html#AttributeError "(in Python v3.11)") – If the number of controls or targets is 0.
