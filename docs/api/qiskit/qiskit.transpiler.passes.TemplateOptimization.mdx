...
<Class id="qiskit.transpiler.passes.TemplateOptimization" github="https://github.com/qiskit/qiskit/tree/stable/1.0/qiskit/transpiler/passes/optimization/template_optimization.py" signature="qiskit.transpiler.passes.TemplateOptimization(*args, **kwargs)">
