---
title: PauliLindbladMap (latest version)
description: API reference for qiskit.quantum_info.PauliLindbladMap in the latest version of qiskit
...
<Class id="qiskit.quantum_info.PauliLindbladMap" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/quantum_info/__init__.py" signature="qiskit.quantum_info.PauliLindbladMap(data, /, num_qubits=None)" modifiers="class">
...
$$
  ...
  <Class id="qiskit.quantum_info.PauliLindbladMap.GeneratorTerm" github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/quantum_info/__init__.py" signature="GeneratorTerm(rate, qubit_sparse_pauli)" modifiers="class">
    Bases: [`object`](https://docs.python.org/3/library/functions.html#object)
    ...
    <Attribute id="qiskit.quantum_info.PauliLindbladMap.GeneratorTerm.indices" name="indices" headingLevel={5}>
      Read-only view onto the indices of each non-identity single-qubit term.

      The indices will always be in sorted order.
    </Attribute>

    <Attribute id="qiskit.quantum_info.PauliLindbladMap.GeneratorTerm.num_qubits" name="num_qubits" headingLevel={5}>
    ...
    <Attribute id="qiskit.quantum_info.PauliLindbladMap.GeneratorTerm.paulis" name="paulis" headingLevel={5}>
    ...
    <Attribute id="qiskit.quantum_info.PauliLindbladMap.GeneratorTerm.qubit_sparse_pauli" name="qubit_sparse_pauli" headingLevel={5}>
      The term’s qubit\_sparse\_pauli.
    </Attribute>

    <Attribute id="qiskit.quantum_info.PauliLindbladMap.GeneratorTerm.rate" name="rate" headingLevel={5}>
      The term’s rate.
    </Attribute>
  ...
  <Attribute id="qiskit.quantum_info.PauliLindbladMap.num_qubits" name="num_qubits" headingLevel={3}>
  ...
  <Attribute id="qiskit.quantum_info.PauliLindbladMap.num_terms" name="num_terms" headingLevel={3}>
    The number of generator terms in the exponent for this map.
  </Attribute>

  <Attribute id="qiskit.quantum_info.PauliLindbladMap.rates" name="rates" headingLevel={3}>
