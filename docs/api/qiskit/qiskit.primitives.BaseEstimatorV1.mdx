...
<Class id="qiskit.primitives.BaseEstimatorV1" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/primitives/base/base_estimator.py#L96-L247" signature="qiskit.primitives.BaseEstimatorV1(*, options=None)" modifiers="class">
  ...
  *   quantum circuits ($\psi_i(\theta)$): list of (parameterized) quantum circuits (a list of [`QuantumCircuit`](/docs/api/qiskit/qiskit.circuit.QuantumCircuit "qiskit.circuit.QuantumCircuit") objects).
...
$$
  ...
  **options** ([*dict*](https://docs.python.org/3/library/stdtypes.html#dict) *| None*) – Default options.
  ...
  <Attribute id="qiskit.primitives.BaseEstimatorV1.options" name="options" headingLevel={3}>
  ...
  <Function id="qiskit.primitives.BaseEstimatorV1.run" github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/primitives/base/base_estimator.py#L180-L237" signature="run(circuits, observables, parameter_values=None, **run_options)">
    ...
    *   **circuits** ([*Sequence*](https://docs.python.org/3/library/collections.abc.html#collections.abc.Sequence)*\[*[*QuantumCircuit*](/docs/api/qiskit/qiskit.circuit.QuantumCircuit "qiskit.circuit.quantumcircuit.QuantumCircuit")*] |* [*QuantumCircuit*](/docs/api/qiskit/qiskit.circuit.QuantumCircuit "qiskit.circuit.quantumcircuit.QuantumCircuit")) – one or more circuit objects.
  ...
  <Function id="qiskit.primitives.BaseEstimatorV1.set_options" github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/primitives/base/base_primitive_v1.py#L39-L45" signature="set_options(**fields)">
