...
<Class id="qiskit.transpiler.Target" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/transpiler/target.py#L87-L950" signature="qiskit.transpiler.Target(description=None, num_qubits=0, dt=None, granularity=1, min_length=1, pulse_alignment=1, acquire_alignment=1, qubit_properties=None, concurrent_measurements=None, **_subclass_kwargs)" modifiers="class">
  ...
  **raises ValueError**
  ...
  <Attribute id="qiskit.transpiler.Target.acquire_alignment" name="acquire_alignment" headingLevel={3} />

  <Attribute id="qiskit.transpiler.Target.concurrent_measurements" name="concurrent_measurements" headingLevel={3} />

  <Attribute id="qiskit.transpiler.Target.description" name="description" headingLevel={3} />

  <Attribute id="qiskit.transpiler.Target.dt" name="dt" headingLevel={3}>
    Return dt.
  </Attribute>

  <Attribute id="qiskit.transpiler.Target.granularity" name="granularity" headingLevel={3} />

  <Attribute id="qiskit.transpiler.Target.instructions" name="instructions" headingLevel={3}>
  ...
  <Attribute id="qiskit.transpiler.Target.min_length" name="min_length" headingLevel={3} />

  <Attribute id="qiskit.transpiler.Target.num_qubits" name="num_qubits" headingLevel={3} />

  <Attribute id="qiskit.transpiler.Target.operation_names" name="operation_names" headingLevel={3}>
    Get the operation names in the target.
  </Attribute>

  <Attribute id="qiskit.transpiler.Target.operations" name="operations" headingLevel={3}>
    Get the operation objects in the target.
  </Attribute>

  <Attribute id="qiskit.transpiler.Target.physical_qubits" name="physical_qubits" headingLevel={3}>
    Returns a sorted list of physical qubits.
  </Attribute>

  <Attribute id="qiskit.transpiler.Target.pulse_alignment" name="pulse_alignment" headingLevel={3} />

  <Attribute id="qiskit.transpiler.Target.qargs" name="qargs" headingLevel={3}>
    The set of qargs in the target.
  </Attribute>

  <Attribute id="qiskit.transpiler.Target.qubit_properties" name="qubit_properties" headingLevel={3} />
