...
<Class id="qiskit.transpiler.Target" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.4/qiskit/transpiler/target.py#L180-L1253" signature="qiskit.transpiler.Target(description=None, num_qubits=0, dt=None, granularity=1, min_length=1, pulse_alignment=1, acquire_alignment=1, qubit_properties=None, concurrent_measurements=None, *args, **kwargs)" modifiers="class">
  Bases: `BaseTarget`
  ...
  **Raises**
  ...
  <Function id="qiskit.transpiler.Target.add_instruction" github="https://github.com/Qiskit/qiskit/tree/stable/1.4/qiskit/transpiler/target.py#L360-L449" signature="add_instruction(instruction, properties=None, name=None)">
  ...
  <Function id="qiskit.transpiler.Target.build_coupling_map" github="https://github.com/Qiskit/qiskit/tree/stable/1.4/qiskit/transpiler/target.py#L837-L903" signature="build_coupling_map(two_q_gate=None, filter_idle_qubits=False)">
  ...
  <Function id="qiskit.transpiler.Target.durations" github="https://github.com/Qiskit/qiskit/tree/stable/1.4/qiskit/transpiler/target.py#L597-L612" signature="durations()">
  ...
  <Function id="qiskit.transpiler.Target.from_configuration" github="https://github.com/Qiskit/qiskit/tree/stable/1.4/qiskit/transpiler/target.py#L996-L1253" signature="from_configuration(basis_gates, num_qubits=None, coupling_map=None, inst_map=None, backend_properties=None, instruction_durations=None, concurrent_measurements=None, dt=None, timing_constraints=None, custom_name_mapping=None)" modifiers="classmethod">
    ...
    <Admonition title="Deprecated since version 1.4" type="danger">
      `qiskit.transpiler.target.Target.from_configuration()`’s argument `backend_properties` is deprecated as of Qiskit 1.4. It will be removed in Qiskit 2.0. To add instructions with specific properties use Target.add\_instruction(instruction, properties, name).
    </Admonition>
  ...
  <Function id="qiskit.transpiler.Target.get" github="https://github.com/Qiskit/qiskit/tree/stable/1.4/qiskit/transpiler/target.py#L919-L924" signature="get(key, default=None)">
    Gets an item from the Target. If not found return a provided default or None.
  </Function>

  ### get\_calibration

  <Function id="qiskit.transpiler.Target.get_calibration" github="https://github.com/Qiskit/qiskit/tree/stable/1.4/qiskit/transpiler/target.py#L699-L727" signature="get_calibration(operation_name, qargs, *args, operation_params=None, **kwargs)">
    ...
    *   **qargs** ([*tuple*](https://docs.python.org/3/library/stdtypes.html#tuple "(in Python v3.13)")*\[*[*int*](https://docs.python.org/3/library/functions.html#int "(in Python v3.13)")*, ...]*) – The qubit indices for the instruction.
    *   **args** (*ParameterValueType*) – Parameter values to build schedule if any.
    *   **operation\_params** ([*list*](https://docs.python.org/3/library/stdtypes.html#list "(in Python v3.13)")*\[*[*float*](https://docs.python.org/3/library/functions.html#float "(in Python v3.13)")*] |* [*float*](https://docs.python.org/3/library/functions.html#float "(in Python v3.13)") *| None*) – The parameters for the Instruction. In case
    *   **gate** (*of multi-parameter*) –
    *   **tuple** (*the order of parameters in the*) –
    *   **parameters.** (*must match the order of the gate*) –
  ...
  <Function id="qiskit.transpiler.Target.has_calibration" github="https://github.com/Qiskit/qiskit/tree/stable/1.4/qiskit/transpiler/target.py#L655-L675" signature="has_calibration(operation_name, qargs, operation_params=None)">
    Return whether the instruction (operation + operation\_params + qubits) defines a calibration.
  ...
  <Function id="qiskit.transpiler.Target.instruction_properties" github="https://github.com/Qiskit/qiskit/tree/stable/1.4/qiskit/transpiler/target.py#L765-L803" signature="instruction_properties(index)">
  ...
  <Function id="qiskit.transpiler.Target.instruction_schedule_map" github="https://github.com/Qiskit/qiskit/tree/stable/1.4/qiskit/transpiler/target.py#L624-L633" signature="instruction_schedule_map()">
  ...
  <Function id="qiskit.transpiler.Target.items" github="https://github.com/Qiskit/qiskit/tree/stable/1.4/qiskit/transpiler/target.py#L940-L942" signature="items()">
    Returns pairs of Gate names and its property map (str, dict\[tuple, InstructionProperties])
  </Function>

  ### keys

  <Function id="qiskit.transpiler.Target.keys" github="https://github.com/Qiskit/qiskit/tree/stable/1.4/qiskit/transpiler/target.py#L932-L934" signature="keys()">
  ...
  <Function id="qiskit.transpiler.Target.qargs_for_operation_name" github="https://github.com/Qiskit/qiskit/tree/stable/1.4/qiskit/transpiler/target.py#L585-L595" signature="qargs_for_operation_name(operation)">
  ...
  <Function id="qiskit.transpiler.Target.timing_constraints" github="https://github.com/Qiskit/qiskit/tree/stable/1.4/qiskit/transpiler/target.py#L614-L622" signature="timing_constraints()">
  ...
  <Function id="qiskit.transpiler.Target.update_from_instruction_schedule_map" github="https://github.com/Qiskit/qiskit/tree/stable/1.4/qiskit/transpiler/target.py#L466-L583" signature="update_from_instruction_schedule_map(inst_map, inst_name_map=None, error_dict=None)">
  ...
  <Function id="qiskit.transpiler.Target.update_instruction_properties" github="https://github.com/Qiskit/qiskit/tree/stable/1.4/qiskit/transpiler/target.py#L451-L464" signature="update_instruction_properties(instruction, qargs, properties)">
  ...
  <Function id="qiskit.transpiler.Target.values" github="https://github.com/Qiskit/qiskit/tree/stable/1.4/qiskit/transpiler/target.py#L936-L938" signature="values()">
