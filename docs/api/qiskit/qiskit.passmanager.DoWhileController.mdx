...
<Class id="qiskit.passmanager.DoWhileController" github="https://github.com/Qiskit/qiskit/tree/stable/1.0/qiskit/passmanager/flow_controllers.py#L52-L87" signature="qiskit.passmanager.DoWhileController(tasks=(), do_while=None, *, options=None)">
