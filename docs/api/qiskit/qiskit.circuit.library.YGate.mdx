...
<Class id="qiskit.circuit.library.YGate" github="https://github.com/Qiskit/qiskit/tree/stable/1.0/qiskit/circuit/library/standard_gates/y.py#L26-L140" signature="qiskit.circuit.library.YGate(*args, _force_mutable=False, **kwargs)">
