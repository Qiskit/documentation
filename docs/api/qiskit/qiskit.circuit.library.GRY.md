...
![../\_images/qiskit-circuit-library-GRY-1.png](/images/api/qiskit/qiskit-circuit-library-GRY-1.png)
...
*   **theta** ([*float*](https://docs.python.org/3/library/functions.html#float "(in Python v3.11)")) – rotation angle about y-axis
