---
title: AILinearFunctionSynthesis (v0.3)
description: API reference for qiskit_transpiler_service.ai.AILinearFunctionSynthesis in qiskit-ibm-transpiler v0.3
