---
title: utils (v0.3)
description: API reference for qiskit_transpiler_service.utils in qiskit-ibm-transpiler v0.3
...
<Function id="qiskit_transpiler_service.utils.create_random_linear_function" signature="qiskit_transpiler_service.utils.create_random_linear_function(n_qubits, seed=123)">
  ...
  **Return type**
  ...
  [*LinearFunction*](/docs/api/qiskit/qiskit.circuit.library.LinearFunction "(in Qiskit v1.1)")
</Function>
...
<Function id="qiskit_transpiler_service.utils.get_metrics" signature="qiskit_transpiler_service.utils.get_metrics(qc)">
  ...
  **qc** ([*QuantumCircuit*](/docs/api/qiskit/qiskit.circuit.QuantumCircuit "(in Qiskit v1.1)")) –
