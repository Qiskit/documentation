...
<Function id="qiskit_ibm_transpiler.utils.create_random_linear_function" github="https://github.com/Qiskit/qiskit-ibm-transpiler/tree/stable/0.9/qiskit_ibm_transpiler/utils.py#L64-L69" signature="qiskit_ibm_transpiler.utils.create_random_linear_function(n_qubits, seed=123)">
  **Parameters**
...
<Function id="qiskit_ibm_transpiler.utils.get_metrics" github="https://github.com/Qiskit/qiskit-ibm-transpiler/tree/stable/0.9/qiskit_ibm_transpiler/utils.py#L48-L56" signature="qiskit_ibm_transpiler.utils.get_metrics(qc)">
