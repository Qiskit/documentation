...
<Class id="qiskit_ibm_transpiler.ai.AIPermutationSynthesis" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit-ibm-transpiler/tree/stable/0.16/qiskit_ibm_transpiler/ai/synthesis.py#L292-L345" signature="qiskit_ibm_transpiler.ai.AIPermutationSynthesis(coupling_map: list[list[int]] | None = None, backend: Backend | None = None, replace_only_if_better: bool = True, max_threads: int | None = None)" modifiers="class">
  ...
  *   **max\_threads** ([*int*](https://docs.python.org/3/library/functions.html#int)*, optional*) – Set the number of requests to send in parallel.
  ...
  <Function id="qiskit_ibm_transpiler.ai.AIPermutationSynthesis.run" github="https://github.com/Qiskit/qiskit-ibm-transpiler/tree/stable/0.16/qiskit_ibm_transpiler/ai/synthesis.py#L163-L180" signature="run(dag)">
  ...
  <Function id="qiskit_ibm_transpiler.ai.AIPermutationSynthesis.synth_nodes" github="https://github.com/Qiskit/qiskit-ibm-transpiler/tree/stable/0.16/qiskit_ibm_transpiler/ai/synthesis.py#L116-L161" signature="synth_nodes(nodes)" />
