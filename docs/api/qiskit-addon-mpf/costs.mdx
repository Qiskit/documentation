...
<Class id="qiskit_addon_mpf.costs.LSE" github="https://github.com/Qiskit/qiskit-addon-mpf/tree/main/qiskit_addon_mpf/costs/lse.py#L23-L73" signature="LSE(A, b)" modifiers="class">
...
$$
  ...
  *   **b** ([*ndarray*](https://numpy.org/doc/stable/reference/generated/numpy.ndarray.html#numpy.ndarray "(in NumPy v2.1)"))
  ...
  <Function id="qiskit_addon_mpf.costs.LSE.solve" github="https://github.com/Qiskit/qiskit-addon-mpf/tree/main/qiskit_addon_mpf/costs/lse.py#L41-L73" signature="solve()">
...
<Function id="qiskit_addon_mpf.costs.setup_exact_problem" github="https://github.com/Qiskit/qiskit-addon-mpf/tree/main/qiskit_addon_mpf/costs/exact.py#L22-L74" signature="setup_exact_problem(lse)">
...
<Function id="qiskit_addon_mpf.costs.setup_sum_of_squares_problem" github="https://github.com/Qiskit/qiskit-addon-mpf/tree/main/qiskit_addon_mpf/costs/sum_of_squares.py#L22-L77" signature="setup_sum_of_squares_problem(lse, *, max_l1_norm=10.0)">
...
<Function id="qiskit_addon_mpf.costs.setup_frobenius_problem" github="https://github.com/Qiskit/qiskit-addon-mpf/tree/main/qiskit_addon_mpf/costs/frobenius.py#L22-L126" signature="setup_frobenius_problem(lse, *, max_l1_norm=10.0)">
  Construct a [`cvxpy.Problem`](https://www.cvxpy.org/api_reference/cvxpy.problems.html#cvxpy.Problem "(in CVXPY v1.6)") for finding approximate MPF coefficients.
