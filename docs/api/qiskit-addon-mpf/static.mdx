...
<Function id="qiskit_addon_mpf.static.setup_static_lse" github="https://github.com/Qiskit/qiskit-addon-mpf/tree/main/qiskit_addon_mpf/static.py#L31-L110" signature="setup_static_lse(trotter_steps, *, order=1, symmetric=False)">
