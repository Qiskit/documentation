...
<Class id="samplomatic.quantum_program.ChunkTiming" isDedicatedPage={true} github="https://github.com/Qiskit/samplomatic/tree/main/samplomatic/quantum_program/quantum_program_result.py#L62-L166" signature="samplomatic.quantum_program.ChunkTiming(spans: Iterable[ChunkSpan])" modifiers="class">
  ...
  **Methods Documentation**
  ...
  <Function id="samplomatic.quantum_program.ChunkTiming.draw" github="https://github.com/Qiskit/samplomatic/tree/main/samplomatic/quantum_program/quantum_program_result.py#L138-L166" signature="draw(name: str | None = None, normalize_y: bool = False, line_width: int = 4, tz: timezone | None = None) → PlotlyFigure">
