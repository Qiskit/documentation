...
<Function id="samplomatic.utils.replace_annotations" isDedicatedPage={true} github="https://github.com/Qiskit/samplomatic/tree/main/samplomatic/samplomatic/utils/map_annotations.py#L144-L179" signature="samplomatic.utils.replace_annotations(circuit: QuantumCircuit, fn: Callable[[Annotation], list[Annotation]]) → QuantumCircuit">
