---
title: QkObsTerm (v2.4)
description: API reference for QkObsTerm in qiskit-c v2.4
...
<Function id="qk_obsterm_str" signature="char *qk_obsterm_str(const QkObsTerm *term)">
  ...
  <span id="group__QkObsTerm_1autotoc_md242" />
  ...
  <span id="group__QkObsTerm_1autotoc_md243" />
