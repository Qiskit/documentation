---
title: QkParam (v2.4)
description: API reference for QkParam in qiskit-c v2.4
...
While functionality for a `QkParam` within a circuit is currently limited, a user is able to perform operations similar to the ones present in [`Parameter`](/docs/api/qiskit-c/2.4/qiskit-circuit-parameter#qiskit.circuit.Parameter "qiskit.circuit.Parameter").
