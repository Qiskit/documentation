---
title: Configuration (v2.4)
description: API reference for Configuration in qiskit-c v2.4
...
<Attribute id="QISKIT_PYTHON_EXTENSION">
...
<Function id="qk_import" signature="int qk_import(void)">
  Import the Qiskit C API from the Python-space [`qiskit`](/docs/api/qiskit-c/2.4/index#module-qiskit "qiskit") package.
