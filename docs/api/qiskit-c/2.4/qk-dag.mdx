---
title: QkDag (v2.4)
description: API reference for QkDag in qiskit-c v2.4
...
<Function id="qk_dag_apply_unitary" signature="uint32_t qk_dag_apply_unitary(QkDag *dag, const QkComplex64 *matrix, const uint32_t *qubits, uint32_t num_qubits, bool front)">
  ...
  See :[Circuit conventions](/docs/api/qiskit-c/2.4/circuit#circuit-conventions) for detail on the bit-labelling and matrix conventions of Qiskit.
