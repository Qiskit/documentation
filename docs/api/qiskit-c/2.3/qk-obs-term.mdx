---
title: QkObsTerm (v2.3)
description: API reference for QkObsTerm in qiskit-c v2.3
...
<Function id="qk_obsterm_str" signature="char *qk_obsterm_str(const QkObsTerm *term)">
  ...
  <span id="group__QkObsTerm_1autotoc_md200" />
  ...
  <span id="group__QkObsTerm_1autotoc_md201" />
