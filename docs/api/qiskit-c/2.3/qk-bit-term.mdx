---
title: QkBitTerm (v2.3)
description: API reference for QkBitTerm in qiskit-c v2.3
...
<Function id="qk_bitterm_label" signature="uint8_t qk_bitterm_label(QkBitTerm bit_term)">
  ...
  <span id="group__QkBitTerm_1autotoc_md202" />
  ...
  <span id="group__QkBitTerm_1autotoc_md203" />
