...
While functionality for a `QkParam` within a circuit is currently limited, a user is able to perform operations similar to the ones present in [`Parameter`](/docs/api/qiskit/qiskit.circuit.Parameter#qiskit.circuit.Parameter "qiskit.circuit.Parameter").
