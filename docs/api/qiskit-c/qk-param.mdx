---
title: QkParam (latest version)
description: API reference for QkParam in the latest version of qiskit-c
...
While functionality for a `QkParam` within a circuit is currently limited, a user is able to perform operations similar to the ones present in [`Parameter`](/docs/api/qiskit-c/qiskit-circuit-parameter#qiskit.circuit.Parameter "qiskit.circuit.Parameter").
