...
<Class id="QkObsTerm" signature="struct QkObsTerm">
  A term in a [QkObs](/api/qiskit-c/2.0/qk-obs#qkobs-1).
  ...
  <span id="struct_qk_obs_term_1autotoc_md2" />
...
<Admonition title="Warning" type="caution">
  doxygentypedef: Cannot find typedef “CSparseObservable” in doxygen xml output for project “qiskit” from directory: xml/
</Admonition>
...
<Function id="qk_obsterm_str" signature="char *qk_obsterm_str(const QkObsTerm *term)">
  ...
  <span id="group___qk_obs_term_1autotoc_md44" />
  ...
  <span id="group___qk_obs_term_1autotoc_md45" />
