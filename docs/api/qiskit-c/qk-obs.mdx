...
<Function id="qk_obs_to_python" signature="PyObject *qk_obs_to_python(const QkObs *obs)">
  Convert to a Python-space [](/api/qiskit/qiskit.quantum_info.SparseObservable#sparseobservable).

  <span id="group___qk_obs_1autotoc_md48" />
  ...
  **Returns**
  ...
  A Python object representing the [](/api/qiskit/qiskit.quantum_info.SparseObservable#sparseobservable).
</Function>
