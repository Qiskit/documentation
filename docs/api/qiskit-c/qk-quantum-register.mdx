...
<Function id="qk_quantum_register_new" signature="QkQuantumRegister *qk_quantum_register_new(uint32_t num_qubits, const char *name)">
  ...
  <span id="group__QkQuantumRegister_1autotoc_md1" />
  ...
  <span id="group__QkQuantumRegister_1autotoc_md2" />
...
<Function id="qk_quantum_register_free" signature="void qk_quantum_register_free(QkQuantumRegister *reg)">
  ...
  <span id="group__QkQuantumRegister_1autotoc_md3" />
...
<Function id="qk_quantum_register_name" signature="char *qk_quantum_register_name(const QkQuantumRegister *qreg)">
...
<Function id="qk_quantum_register_num_bits" signature="size_t qk_quantum_register_num_bits(const QkQuantumRegister *qreg)">
  ...
  <span id="group__QkQuantumRegister_1autotoc_md8" />
...
<Function id="qk_quantum_register_circuit_bits" signature="void qk_quantum_register_circuit_bits(const QkQuantumRegister *qreg, const QkCircuit *circuit, uint32_t *out_bits)">
  ...
  <span id="group__QkQuantumRegister_1autotoc_md9" />
  ...
  <span id="group__QkQuantumRegister_1autotoc_md10" />
