---
title: Circuit Library (latest version)
description: API reference for Circuit Library in the latest version of qiskit-c
...
<Function id="qk_circuit_library_iqp" signature="QkCircuit *qk_circuit_library_iqp(uint32_t num_qubits, const int64_t *interactions, bool check_input)">
  ...
  <span id="group__QkCircuitLibrary_1autotoc_md72" />
...
<Function id="qk_pauli_product_rotation_clear" signature="void qk_pauli_product_rotation_clear(QkPauliProductRotation *inst)">
  ...
  <span id="group__QkCircuitLibrary_1autotoc_md73" />
  ...
  <span id="group__QkCircuitLibrary_1autotoc_md74" />
...
<Function id="qk_pauli_product_measurement_clear" signature="void qk_pauli_product_measurement_clear(QkPauliProductMeasurement *inst)">
  ...
  <span id="group__QkCircuitLibrary_1autotoc_md75" />
