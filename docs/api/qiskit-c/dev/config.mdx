---
title: Configuration (dev version)
description: API reference for Configuration in the dev version of qiskit-c
...
<Function id="qk_import" signature="int qk_import(void)">
  Import the Qiskit C API from the Python-space [`qiskit`](/docs/api/qiskit-c/dev/index#module-qiskit "qiskit") package.
