---
title: QkBitTerm (dev version)
description: API reference for QkBitTerm in the dev version of qiskit-c
...
<Function id="qk_bitterm_label" signature="uint8_t qk_bitterm_label(QkBitTerm bit_term)">
  ...
  <span id="group__QkBitTerm_1autotoc_md213" />
  ...
  <span id="group__QkBitTerm_1autotoc_md214" />
