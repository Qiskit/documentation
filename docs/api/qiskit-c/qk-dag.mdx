...
The `QkDag` struct exposes a low level interface to the Qiskit transpiler’s directed acyclic graph (DAG) representation of a quantum circuit for use in transpiler passes. It exposes only what is defined in the inner data model of Qiskit. Therefore it is missing some functionality that is available in the higher level Python [`DAGCircuit`](/docs/api/qiskit-c/qiskit-dagcircuit-dag-circuit#qiskit.dagcircuit.DAGCircuit "qiskit.dagcircuit.DAGCircuit") class.

The C API currently only supports building DAGs that contain operations defined in Qiskit’s internal Rust data model. Generally this includes only gates in the standard gate library, standard non-unitary operations (currently [`Barrier`](/docs/api/qiskit-c/circuit#qiskit.circuit.Barrier "qiskit.circuit.Barrier"), [`Measure`](/docs/api/qiskit-c/circuit#qiskit.circuit.Measure "qiskit.circuit.Measure"), [`Reset`](/docs/api/qiskit-c/circuit#qiskit.circuit.Reset "qiskit.circuit.Reset"), and [`Delay`](/docs/api/qiskit-c/circuit#qiskit.circuit.Delay "qiskit.circuit.Delay")) and [`UnitaryGate`](/docs/api/qiskit-c/qiskit-circuit-library-unitary-gate#qiskit.circuit.library.UnitaryGate "qiskit.circuit.library.UnitaryGate"). This functionality will be expanded over time as the Rust data model is expanded to natively support more functionality.
...
<Function id="qk_dag_new" signature="QkDag *qk_dag_new(void)">
  ...
  <span id="group__QkDag_1autotoc_md200" />
...
<Function id="qk_dag_add_quantum_register" signature="void qk_dag_add_quantum_register(QkDag *dag, const QkQuantumRegister *reg)">
  ...
  <span id="group__QkDag_1autotoc_md201" />
  ...
  <span id="group__QkDag_1autotoc_md202" />
...
<Function id="qk_dag_add_classical_register" signature="void qk_dag_add_classical_register(QkDag *dag, const QkClassicalRegister *reg)">
  ...
  <span id="group__QkDag_1autotoc_md203" />
  ...
  <span id="group__QkDag_1autotoc_md204" />
...
<Function id="qk_dag_num_qubits" signature="uint32_t qk_dag_num_qubits(const QkDag *dag)">
  ...
  <span id="group__QkDag_1autotoc_md205" />
  ...
  <span id="group__QkDag_1autotoc_md206" />
...
<Function id="qk_dag_num_clbits" signature="uint32_t qk_dag_num_clbits(const QkDag *dag)">
  ...
  <span id="group__QkDag_1autotoc_md207" />
  ...
  <span id="group__QkDag_1autotoc_md208" />
...
<Function id="qk_dag_num_op_nodes" signature="size_t qk_dag_num_op_nodes(const QkDag *dag)">
  ...
  <span id="group__QkDag_1autotoc_md209" />
  ...
  <span id="group__QkDag_1autotoc_md210" />
...
### qk\_dag\_global\_phase

<Function id="qk_dag_global_phase" signature="QkParam *qk_dag_global_phase(const QkDag *dag)">
  ...
  <span id="group__QkDag_1autotoc_md211" />
  ...
  <span id="group__QkDag_1autotoc_md212" />
  ...
  **Returns**
  ...
  The global phase of the DAG.
</Function>

### qk\_dag\_set\_global\_phase

<Function id="qk_dag_set_global_phase" signature="QkExitCode qk_dag_set_global_phase(QkDag *dag, const QkParam *phase)">
  ...
  <span id="group__QkDag_1autotoc_md213" />
  ...
  <span id="group__QkDag_1autotoc_md214" />
  ...
  *   **dag** – A pointer to the DAG.
  *   **phase** – A pointer to the global phase to set.

  **Returns**

  `QkExitCode_Success` upon successful setting of the global phase. Upon failure, `QkExitCode_ParameterError` describes generic failures when attempting to track the parameter symbols such as invalid parameter values. Otherwise, `QkExitCode_DagError` indicates a DAG-specific cause of the failure.
</Function>
...
<Function id="qk_dag_node_type" signature="QkDagNodeType qk_dag_node_type(const QkDag *dag, uint32_t node)">
  ...
  <span id="group__QkDag_1autotoc_md215" />
...
<Function id="qk_dag_qubit_in_node" signature="uint32_t qk_dag_qubit_in_node(const QkDag *dag, uint32_t qubit)">
  ...
  <span id="group__QkDag_1autotoc_md216" />
...
<Function id="qk_dag_qubit_out_node" signature="uint32_t qk_dag_qubit_out_node(const QkDag *dag, uint32_t qubit)">
  ...
  <span id="group__QkDag_1autotoc_md217" />
...
<Function id="qk_dag_clbit_in_node" signature="uint32_t qk_dag_clbit_in_node(const QkDag *dag, uint32_t clbit)">
  ...
  <span id="group__QkDag_1autotoc_md218" />
...
<Function id="qk_dag_clbit_out_node" signature="uint32_t qk_dag_clbit_out_node(const QkDag *dag, uint32_t clbit)">
  ...
  <span id="group__QkDag_1autotoc_md219" />
...
<Function id="qk_dag_wire_node_value" signature="uint32_t qk_dag_wire_node_value(const QkDag *dag, uint32_t node)">
  ...
  <span id="group__QkDag_1autotoc_md220" />
...
<Function id="qk_dag_op_node_num_qubits" signature="uint32_t qk_dag_op_node_num_qubits(const QkDag *dag, uint32_t node)">
  ...
  <span id="group__QkDag_1autotoc_md221" />
...
<Function id="qk_dag_op_node_num_clbits" signature="uint32_t qk_dag_op_node_num_clbits(const QkDag *dag, uint32_t node)">
  ...
  <span id="group__QkDag_1autotoc_md222" />
...
<Function id="qk_dag_op_node_num_params" signature="uint32_t qk_dag_op_node_num_params(const QkDag *dag, uint32_t node)">
  ...
  <span id="group__QkDag_1autotoc_md223" />
...
<Function id="qk_dag_op_node_qubits" signature="const uint32_t *qk_dag_op_node_qubits(const QkDag *dag, uint32_t node)">
  ...
  <span id="group__QkDag_1autotoc_md224" />
...
<Function id="qk_dag_op_node_clbits" signature="const uint32_t *qk_dag_op_node_clbits(const QkDag *dag, uint32_t node)">
  ...
  <span id="group__QkDag_1autotoc_md225" />
...
<Function id="qk_dag_apply_gate" signature="uint32_t qk_dag_apply_gate(QkDag *dag, QkGate gate, const uint32_t *qubits, const double *params, bool front)">
  ...
  <span id="group__QkDag_1autotoc_md226" />
  ...
  <span id="group__QkDag_1autotoc_md227" />
...
<Function id="qk_dag_apply_measure" signature="uint32_t qk_dag_apply_measure(QkDag *dag, uint32_t qubit, uint32_t clbit, bool front)">
  ...
  <span id="group__QkDag_1autotoc_md228" />
  ...
  <span id="group__QkDag_1autotoc_md229" />
...
<Function id="qk_dag_apply_reset" signature="uint32_t qk_dag_apply_reset(QkDag *dag, uint32_t qubit, bool front)">
  ...
  <span id="group__QkDag_1autotoc_md230" />
  ...
  <span id="group__QkDag_1autotoc_md231" />
...
<Function id="qk_dag_apply_barrier" signature="uint32_t qk_dag_apply_barrier(QkDag *dag, const uint32_t *qubits, uint32_t num_qubits, bool front)">
  ...
  <span id="group__QkDag_1autotoc_md232" />
  ...
  <span id="group__QkDag_1autotoc_md233" />
...
<Function id="qk_dag_apply_unitary" signature="uint32_t qk_dag_apply_unitary(QkDag *dag, const QkComplex64 *matrix, const uint32_t *qubits, uint32_t num_qubits, bool front)">
  ...
  See :[Circuit conventions](/docs/api/qiskit-c/circuit#circuit-conventions) for detail on the bit-labelling and matrix conventions of Qiskit.

  <span id="group__QkDag_1autotoc_md234" />
...
<Function id="qk_dag_op_node_gate_op" signature="QkGate qk_dag_op_node_gate_op(const QkDag *dag, uint32_t node, double *out_params)">
  ...
  <span id="group__QkDag_1autotoc_md235" />
  ...
  <span id="group__QkDag_1autotoc_md236" />
...
<Function id="qk_dag_op_node_unitary" signature="void qk_dag_op_node_unitary(const QkDag *dag, uint32_t node, QkComplex64 *out)">
  ...
  <span id="group__QkDag_1autotoc_md237" />
...
<Function id="qk_dag_op_node_kind" signature="QkOperationKind qk_dag_op_node_kind(const QkDag *dag, uint32_t node)">
  ...
  <span id="group__QkDag_1autotoc_md238" />
...
<Function id="qk_dag_successors" signature="QkDagNeighbors qk_dag_successors(const QkDag *dag, uint32_t node)">
  ...
  <span id="group__QkDag_1autotoc_md239" />
  ...
  <span id="group__QkDag_1autotoc_md240" />
...
<Function id="qk_dag_predecessors" signature="QkDagNeighbors qk_dag_predecessors(const QkDag *dag, uint32_t node)">
  ...
  <span id="group__QkDag_1autotoc_md241" />
  ...
  <span id="group__QkDag_1autotoc_md242" />
...
<Function id="qk_dag_neighbors_clear" signature="void qk_dag_neighbors_clear(QkDagNeighbors *neighbors)">
  ...
  <span id="group__QkDag_1autotoc_md243" />
...
<Function id="qk_dag_get_instruction" signature="void qk_dag_get_instruction(const QkDag *dag, uint32_t index, QkCircuitInstruction *instruction)">
  ...
  <span id="group__QkDag_1autotoc_md244" />
  ...
  <span id="group__QkDag_1autotoc_md245" />
...
<Function id="qk_dag_compose" signature="QkExitCode qk_dag_compose(QkDag *dag, const QkDag *other, const uint32_t *qubits, const uint32_t *clbits)">
  ...
  <span id="group__QkDag_1autotoc_md246" />
  ...
  <span id="group__QkDag_1autotoc_md247" />
...
<Function id="qk_dag_free" signature="void qk_dag_free(QkDag *dag)">
  ...
  <span id="group__QkDag_1autotoc_md248" />
  ...
  <span id="group__QkDag_1autotoc_md249" />
...
<Function id="qk_dag_to_circuit" signature="QkCircuit *qk_dag_to_circuit(const QkDag *dag)">
  ...
  <span id="group__QkDag_1autotoc_md250" />
  ...
  <span id="group__QkDag_1autotoc_md251" />
...
<Function id="qk_dag_topological_op_nodes" signature="void qk_dag_topological_op_nodes(const QkDag *dag, uint32_t *out_order)">
  ...
  <span id="group__QkDag_1autotoc_md252" />
  ...
  <span id="group__QkDag_1autotoc_md253" />
...
<Function id="qk_dag_substitute_node_with_dag" signature="void qk_dag_substitute_node_with_dag(QkDag *dag, uint32_t node, const QkDag *replacement)">
  ...
  <span id="group__QkDag_1autotoc_md254" />
  ...
  <span id="group__QkDag_1autotoc_md255" />
...
<Function id="qk_dag_copy_empty_like" signature="QkDag *qk_dag_copy_empty_like(const QkDag *dag, QkVarsMode vars_mode, QkBlocksMode blocks_mode)">
  ...
  *   all the qubits and clbits, including the registers.
  ...
  <span id="group__QkDag_1autotoc_md256" />
  ...
  <span id="group__QkDag_1autotoc_md257" />
...
<Function id="qk_dag_replace_block_with_unitary" signature="uint32_t qk_dag_replace_block_with_unitary(QkDag *dag, uint32_t num_block_ids, const uint32_t *block_ids, const QkComplex64 *matrix, uint32_t num_qubits, const uint32_t *qubits, bool cycle_check)">
  ...
  <span id="group__QkDag_1autotoc_md258" />
  ...
  <span id="group__QkDag_1autotoc_md259" />
...
<Function id="qk_dag_substitute_node_with_unitary" signature="void qk_dag_substitute_node_with_unitary(QkDag *dag, uint32_t node, const QkComplex64 *matrix, uint32_t num_qubits)">
  ...
  <span id="group__QkDag_1autotoc_md260" />
  ...
  <span id="group__QkDag_1autotoc_md261" />
...
<Function id="qk_dag_to_python" signature="PyObject *qk_dag_to_python(QkDag *dag)">
  ...
  <span id="group__QkDag_1autotoc_md262" />
...
<Function id="qk_dag_borrow_from_python" signature="QkDag *qk_dag_borrow_from_python(PyObject *ob)">
  ...
  <span id="group__QkDag_1autotoc_md263" />
...
<Function id="qk_dag_convert_from_python" signature="int qk_dag_convert_from_python(PyObject *object, void *address)">
  ...
  <span id="group__QkDag_1autotoc_md264" />
