---
title: Versioning (latest version)
description: API reference for Versioning in the latest version of qiskit-c
in_page_toc_min_heading_level: 2
python_api_type: module
python_api_name: Versioning
---

<span id="capi-version" />
...
<Attribute id="QISKIT_RELEASE_SERIAL">
...
<Attribute id="QISKIT_GET_VERSION_HEX">
