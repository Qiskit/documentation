...
<Class id="qiskit_addon_slc.bounds.CommutatorBounds" github="https://github.com/Qiskit/qiskit-addon-slc/tree/main/qiskit_addon_slc/bounds/commutator_bounds.py#L52-L87" signature="CommutatorBounds(commutator_bound, truncation_bias, fallback_to_tri_ineq)" modifiers="class">
  ...
  *   **fallback\_to\_tri\_ineq** ([*bool*](https://docs.python.org/3/library/functions.html#bool))
  ...
  <Attribute id="qiskit_addon_slc.bounds.CommutatorBounds.commutator_bound">
  ...
  <Attribute id="qiskit_addon_slc.bounds.CommutatorBounds.fallback_to_tri_ineq">
  ...
  <Attribute id="qiskit_addon_slc.bounds.CommutatorBounds.truncation_bias">
    Type: [`float`](https://docs.python.org/3/library/functions.html#float)
