...
<Function id="qiskit_addon_cutting.utils.observable_grouping.observables_restricted_to_subsystem" github="https://github.com/Qiskit/qiskit-addon-cutting/tree/stable/0.9/qiskit_addon_cutting/utils/observable_grouping.py" signature="observables_restricted_to_subsystem(qubits, global_observables, /)">
  ...
  A [`PauliList`](/docs/api/qiskit/qiskit.quantum_info.PauliList "(in Qiskit v1.3)") will be returned if a [`PauliList`](/docs/api/qiskit/qiskit.quantum_info.PauliList "(in Qiskit v1.3)") is provided; otherwise, a `list[Pauli]` will be returned.
  ...
  **Returns**
  ...
  Each [`Pauli`](/docs/api/qiskit/qiskit.quantum_info.Pauli "(in Qiskit v1.3)") restricted to the subsystem.
...
<Class id="qiskit_addon_cutting.utils.observable_grouping.CommutingObservableGroup" github="https://github.com/Qiskit/qiskit-addon-cutting/tree/stable/0.9/qiskit_addon_cutting/utils/observable_grouping.py" signature="CommutingObservableGroup(general_observable, commuting_observables)" modifiers="class">
  ...
  *   **general\_observable** ([*Pauli*](/docs/api/qiskit/qiskit.quantum_info.Pauli "(in Qiskit v1.3)"))
  *   **commuting\_observables** ([*list*](https://docs.python.org/3/library/stdtypes.html#list "(in Python v3.13)")*\[*[*Pauli*](/docs/api/qiskit/qiskit.quantum_info.Pauli "(in Qiskit v1.3)")*]*)
  ...
  <Attribute id="qiskit_addon_cutting.utils.observable_grouping.CommutingObservableGroup.pauli_indices" attributeTypeHint="list[int]">
    The indices of non-identity [`Pauli`](/docs/api/qiskit/qiskit.quantum_info.Pauli "(in Qiskit v1.3)")s in `general_observable`.
  </Attribute>
</Class>
  ...
  **observables** (PauliList | Iterable\[Pauli]) – Observables of interest
  ...
  <Function id="qiskit_addon_cutting.utils.observable_grouping.ObservableCollection.construct_general_observables" signature="construct_general_observables(commuting_subobservables, /)" modifiers="static">
    ...
    **Return type**
    ...
    [`list`](https://docs.python.org/3/library/stdtypes.html#list "(in Python v3.13)")\[[`Pauli`](/docs/api/qiskit/qiskit.quantum_info.Pauli "(in Qiskit v1.3)")]

    **Parameters**

    **commuting\_subobservables** ([*list*](https://docs.python.org/3/library/stdtypes.html#list "(in Python v3.13)")*\[*[*list*](https://docs.python.org/3/library/stdtypes.html#list "(in Python v3.13)")*\[*[*Pauli*](/docs/api/qiskit/qiskit.quantum_info.Pauli "(in Qiskit v1.3)")*]]*)
  </Function>
  ...
  <Attribute id="qiskit_addon_cutting.utils.observable_grouping.ObservableCollection.lookup" attributeTypeHint="dict[Pauli, list[tuple[int, int]]]">
    Get dict which maps each [`Pauli`](/docs/api/qiskit/qiskit.quantum_info.Pauli "(in Qiskit v1.3)") observable to a list of indices, `(i, j)`, to commuting observables in `groups`.

    For each element of the list, it means that the [`Pauli`](/docs/api/qiskit/qiskit.quantum_info.Pauli "(in Qiskit v1.3)") is given by the `j`-th commuting observable in the `i`-th group.

    This list will be of length 1 at minimum, but may potentially be longer if multiple [`CommutingObservableGroup`](#qiskit_addon_cutting.utils.observable_grouping.CommutingObservableGroup "qiskit_addon_cutting.utils.observable_grouping.CommutingObservableGroup") objects are compatible with the given [`Pauli`](/docs/api/qiskit/qiskit.quantum_info.Pauli "(in Qiskit v1.3)").
  </Attribute>
</Class>
