...
<Class id="qiskit_addon_cutting.qpd.TwoQubitQPDGate" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit-addon-cutting/tree/stable/0.9/qiskit_addon_cutting/qpd/instructions/qpd_gate.py" signature="TwoQubitQPDGate(basis, *, basis_id=None, label=None)" modifiers="class">
  ...
  **Raises**
  ...
  [**ValueError**](https://docs.python.org/3/library/exceptions.html#ValueError) – The [`QPDBasis`](qpd-qpd-basis "qiskit_addon_cutting.qpd.QPDBasis") acts on a number of qubits not equal to 2.
  ...
  <Function id="qiskit_addon_cutting.qpd.TwoQubitQPDGate.from_instruction" signature="from_instruction(instruction, /)" modifiers="classmethod">
    ...
    **instruction** ([*Instruction*](/docs/api/qiskit/qiskit.circuit.Instruction))
  </Function>
