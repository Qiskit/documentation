...
<Function id="qiskit_addon_cutting.cut_wires" github="https://github.com/Qiskit/qiskit-addon-cutting/tree/stable/0.10/qiskit_addon_cutting/wire_cutting_transforms.py" signature="cut_wires(circuit, /)">
  ...
  **circuit** ([`QuantumCircuit`](/docs/api/qiskit/qiskit.circuit.QuantumCircuit "(in Qiskit v1.4)")) – Original circuit with [`CutWire`](instructions-cut-wire "qiskit_addon_cutting.instructions.CutWire") instructions
...
<Function id="qiskit_addon_cutting.expand_observables" github="https://github.com/Qiskit/qiskit-addon-cutting/tree/stable/0.10/qiskit_addon_cutting/wire_cutting_transforms.py" signature="expand_observables(observables, original_circuit, final_circuit, /)">
  ...
  *   **observables** ([`PauliList`](/docs/api/qiskit/qiskit.quantum_info.PauliList "(in Qiskit v1.4)")) – Observables corresponding to `original_circuit`
  *   **original\_circuit** ([`QuantumCircuit`](/docs/api/qiskit/qiskit.circuit.QuantumCircuit "(in Qiskit v1.4)")) – Original circuit
  *   **final\_circuit** ([`QuantumCircuit`](/docs/api/qiskit/qiskit.circuit.QuantumCircuit "(in Qiskit v1.4)")) – Final circuit, whose qubits the original `observables` should be expanded to

  **Return type**

  [`PauliList`](/docs/api/qiskit/qiskit.quantum_info.PauliList "(in Qiskit v1.4)")
...
<Function id="qiskit_addon_cutting.partition_circuit_qubits" github="https://github.com/Qiskit/qiskit-addon-cutting/tree/stable/0.10/qiskit_addon_cutting/cutting_decomposition.py" signature="partition_circuit_qubits(circuit, partition_labels, inplace=False)">
  ...
  *   **circuit** ([`QuantumCircuit`](/docs/api/qiskit/qiskit.circuit.QuantumCircuit "(in Qiskit v1.4)")) – The circuit to partition
...
<Function id="qiskit_addon_cutting.cut_gates" github="https://github.com/Qiskit/qiskit-addon-cutting/tree/stable/0.10/qiskit_addon_cutting/cutting_decomposition.py" signature="cut_gates(circuit, gate_ids, inplace=False)">
  ...
  *   **circuit** ([`QuantumCircuit`](/docs/api/qiskit/qiskit.circuit.QuantumCircuit "(in Qiskit v1.4)")) – The circuit containing gates to be decomposed
  ...
  **Return type**
  ...
  [`tuple`](https://docs.python.org/3/library/stdtypes.html#tuple "(in Python v3.13)")\[[`QuantumCircuit`](/docs/api/qiskit/qiskit.circuit.QuantumCircuit "(in Qiskit v1.4)"), [`list`](https://docs.python.org/3/library/stdtypes.html#list "(in Python v3.13)")\[[`QPDBasis`](qpd-qpd-basis "qiskit_addon_cutting.qpd.qpd_basis.QPDBasis")]]
...
<Function id="qiskit_addon_cutting.reconstruct_expectation_values" github="https://github.com/Qiskit/qiskit-addon-cutting/tree/stable/0.10/qiskit_addon_cutting/cutting_reconstruction.py" signature="reconstruct_expectation_values(results, coefficients, observables)">
  ...
  *   **observables** (PauliList | dict\[Hashable, PauliList]) – The observable(s) for which the expectation values will be calculated. This should be a [`PauliList`](/docs/api/qiskit/qiskit.quantum_info.PauliList "(in Qiskit v1.4)") if `results` is a [`SamplerResult`](/docs/api/qiskit/qiskit.primitives.SamplerResult "(in Qiskit v1.4)") instance. Otherwise, it should be a dictionary mapping partition labels to the observables associated with that partition.
...
<Function id="qiskit_addon_cutting.find_cuts" github="https://github.com/Qiskit/qiskit-addon-cutting/tree/stable/0.10/qiskit_addon_cutting/automated_cut_finding.py" signature="find_cuts(circuit, optimization, constraints)">
  ...
  *   **circuit** ([`QuantumCircuit`](/docs/api/qiskit/qiskit.circuit.QuantumCircuit "(in Qiskit v1.4)")) – The circuit to cut. The input circuit may not contain gates acting on more than two qubits.
  ...
  **Return type**
  ...
  [`tuple`](https://docs.python.org/3/library/stdtypes.html#tuple "(in Python v3.13)")\[[`QuantumCircuit`](/docs/api/qiskit/qiskit.circuit.QuantumCircuit "(in Qiskit v1.4)"), [`dict`](https://docs.python.org/3/library/stdtypes.html#dict "(in Python v3.13)")\[[`str`](https://docs.python.org/3/library/stdtypes.html#str "(in Python v3.13)"), [`float`](https://docs.python.org/3/library/functions.html#float "(in Python v3.13)")]]
