---
title: BaseQPDGate (latest version)
description: API reference for qiskit_addon_cutting.qpd.BaseQPDGate in the latest version of qiskit-addon-cutting
...
<Class id="qiskit_addon_cutting.qpd.BaseQPDGate" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit-addon-cutting/tree/stable/0.10/qiskit_addon_cutting/qpd/instructions/qpd_gate.py" signature="BaseQPDGate(name, basis, num_qubits, *, basis_id=None, label=None)" modifiers="class">
  Bases: [`Instruction`](/docs/api/qiskit/qiskit.circuit.Instruction "(in Qiskit v1.4)")
