---
title: UCJ (v0.1)
description: API reference for qiskit_fermions.circuit.library.UCJ in qiskit-fermions v0.1
...
$$
  ...
  **Raises**
  ...
  <Function id="qiskit_fermions.circuit.library.UCJ.from_t_amplitudes" signature="from_t_amplitudes(nelec, t2, *, t1=None, variant='balanced', n_reps=None, interaction_pairs=None, tol=1e-08)" modifiers="classmethod">
    ...
    The ansatz layers are obtained from an *exact* double factorization of the $t_2$ amplitudes (via [`double_factorized_t2()`](linalg-double-factorized-t-2 "qiskit_fermions.linalg.double_factorized_t2") / [`double_factorized_t2_alpha_beta()`](linalg-double-factorized-t-2-alpha-beta "qiskit_fermions.linalg.double_factorized_t2_alpha_beta")) and, when $t_1$ is supplied, a final orbital rotation from [`OrbitalRotation.from_t1_amplitudes()`](circuit-library-orbital-rotation#from_t1_amplitudes "qiskit_fermions.circuit.library.OrbitalRotation.from_t1_amplitudes").
