---
title: givens_decomposition_slater (v0.1)
description: API reference for qiskit_fermions.linalg.givens_decomposition_slater in qiskit-fermions v0.1
...
$$
  ...
  <Admonition title="See also" type="note">
    [`givens_decomposition()`](linalg-givens-decomposition "qiskit_fermions.linalg.givens_decomposition") for the square (full orbital rotation) decomposition.
  </Admonition>
</Function>
