---
title: group_terms_by_electronic_structure (v0.1)
description: API reference for qiskit_fermions.operators.terms.group_terms_by_electronic_structure in qiskit-fermions v0.1
