---
title: TrivialF2QLayout (v0.1)
description: API reference for qiskit_fermions.transpiler.passes.TrivialF2QLayout in qiskit-fermions v0.1
...
<Class id="qiskit_fermions.transpiler.passes.TrivialF2QLayout" isDedicatedPage={true} signature="TrivialF2QLayout" modifiers="class">
  ...
  This pass simply populates the `f2q_layout` field of the [`property_set`](/docs/api/qiskit/qiskit.passmanager.PassManagerState#property_set), with a dictionary associating each [`FermionicRegister`](circuit-fermionic-register "qiskit_fermions.circuit.FermionicRegister") with an equally sized [`QuantumRegister`](/docs/api/qiskit/circuit#qiskit.circuit.QuantumRegister).
