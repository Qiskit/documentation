---
title: SupportsApplyUnitary (v0.1)
description: API reference for qiskit_fermions.protocols.SupportsApplyUnitary in qiskit-fermions v0.1
...
<Class id="qiskit_fermions.protocols.SupportsApplyUnitary" isDedicatedPage={true} signature="SupportsApplyUnitary(*args, **kwargs)" modifiers="class">
  ...
  See [`apply_unitary()`](linalg-apply-unitary "qiskit_fermions.linalg.apply_unitary") for the type-agnostic helper function dispatching to the method below.
