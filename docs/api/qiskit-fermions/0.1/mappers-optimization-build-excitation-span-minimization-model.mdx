---
title: build_excitation_span_minimization_model (v0.1)
description: API reference for qiskit_fermions.mappers.optimization.build_excitation_span_minimization_model in qiskit-fermions v0.1
