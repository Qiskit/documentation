...
$$
  ...
  In this example, we have leveraged [`cre()`](operators-cre "qiskit_fermions.operators.cre") and [`ann()`](operators-ann "qiskit_fermions.operators.ann") for creating the creation and annihilation operators at the specified modes.
...
$$
  ...
  <Function id="qiskit_fermions.operators.FermionOperator.from_dict" signature="from_dict(data)" modifiers="classmethod">
    ...
    **data** – a dictionary mapping tuples of terms to complex coefficients. Each key is a tuple of `(bool, int)` pairs. You may use [`cre()`](operators-cre "qiskit_fermions.operators.cre") and [`ann()`](operators-ann "qiskit_fermions.operators.ann") to simplify their construction.
  ...
  <Function id="qiskit_fermions.operators.FermionOperator.from_fcidump" signature="from_fcidump(fcidump)" modifiers="classmethod">
    Constructs a [`FermionOperator`](#qiskit_fermions.operators.FermionOperator "qiskit_fermions.operators.FermionOperator") from an [`FCIDump`](operators-library-fci-dump "qiskit_fermions.operators.library.FCIDump") data structure.
  ...
  **Protocol Methods**
  ...
  <Function id="qiskit_fermions.operators.FermionOperator._linear_operator_" signature="_linear_operator_(norb, nelec)">
    ...
    This implements [`ffsim.SupportsLinearOperator`](https://qiskit-community.github.io/ffsim/api/stubs/ffsim.SupportsLinearOperator.html#ffsim.SupportsLinearOperator "(in ffsim)") by converting to an [`ffsim.FermionOperator`](https://qiskit-community.github.io/ffsim/api/stubs/ffsim.FermionOperator.html#ffsim.FermionOperator "(in ffsim)") and handing that to [`ffsim.linear_operator()`](https://qiskit-community.github.io/ffsim/api/stubs/ffsim.linear_operator.html#ffsim.linear_operator "(in ffsim)"): simulation is ffsim’s concern, and this package owns the mapper-agnostic circuit rather than a second simulation backend.

    ffsim rejects an operator that does not conserve both particle number and the z-component of spin, since such an operator has no action on a fixed sector, and silently ignores a term acting on an orbital outside `[0, norb)`.

    **Parameters**

    *   **norb** ([*int*](https://docs.python.org/3/builtins/functions.html#int)) – the number of spatial orbitals.
    *   **nelec** ([*int*](https://docs.python.org/3/builtins/functions.html#int)  *|*[*tuple*](https://docs.python.org/3/builtins/stdtypes.html#tuple)*\[*[*int*](https://docs.python.org/3/builtins/functions.html#int)*,* [*int*](https://docs.python.org/3/builtins/functions.html#int)*]*) – the electron count – an integer for a spinless sector, or an `(n_alpha, n_beta)` pair for a spinful one.
    *   **self** ([*FermionOperator*](#qiskit_fermions.operators.FermionOperator "qiskit_fermions.operators.FermionOperator"))
    ...
    **Return type**
    ...
    [scipy.sparse.linalg.LinearOperator](https://docs.scipy.org/doc/scipy/reference/generated/scipy.sparse.linalg.LinearOperator.html#scipy.sparse.linalg.LinearOperator "(in SciPy v1.18.0)")
  </Function>
  ...
  <Function id="qiskit_fermions.operators.FermionOperator._majorana_operator_" signature="_majorana_operator_()">
    ...
    This implements the [`SupportsMajoranaOperator`](protocols-supports-majorana-operator "qiskit_fermions.protocols.SupportsMajoranaOperator") protocol by delegating to [`fermion_to_majorana()`](mappers-library-fermion-to-majorana "qiskit_fermions.mappers.library.fermion_to_majorana").
  </Function>

  ##### \_trace\_

  <Function id="qiskit_fermions.operators.FermionOperator._trace_" signature="_trace_(norb, nelec)">
    Returns the trace of this operator on the `(norb, nelec)` FCI sector.

    This implements [`ffsim.SupportsTrace`](https://qiskit-community.github.io/ffsim/api/stubs/ffsim.SupportsTrace.html#ffsim.SupportsTrace "(in ffsim)") via [`ffsim.trace()`](https://qiskit-community.github.io/ffsim/api/stubs/ffsim.trace.html#ffsim.trace "(in ffsim)"), mirroring `_linear_operator_`.
