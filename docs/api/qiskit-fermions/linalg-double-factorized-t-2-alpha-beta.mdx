...
<Function id="qiskit_fermions.linalg.double_factorized_t2_alpha_beta" isDedicatedPage={true} signature="double_factorized_t2_alpha_beta(t2_amplitudes, tol, max_terms=None)">
  ...
  Returns a list of terms suitable for reconstruction by [`reconstruct_t2_alpha_beta()`](linalg-reconstruct-t-2-alpha-beta "qiskit_fermions.linalg.reconstruct_t2_alpha_beta"). The number of terms is truncated to `max_terms` (default: all).
