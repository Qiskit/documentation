...
<Class id="qiskit_fermions.transpiler.passes.CustomF2QLayout" isDedicatedPage={true} signature="CustomF2QLayout(layout)" modifiers="class">
  ...
  Sets the user-provided [`F2QLayout`](transpiler-f-2-q-layout "qiskit_fermions.transpiler.F2QLayout") in the transpiler.
  ...
  <Admonition title="Note" type="note">
    It is the user’s responsibility to ensure that subsequently used transpilation passes (and plugins) are configured to adhere to this [`F2QLayout`](transpiler-f-2-q-layout "qiskit_fermions.transpiler.F2QLayout") correctly.
  </Admonition>
  ...
  **layout** ([*F2QLayout*](transpiler-f-2-q-layout "qiskit_fermions.transpiler.F2QLayout")) – the custom `f2q_layout` to use.
  ...
  <Attribute id="qiskit_fermions.transpiler.passes.CustomF2QLayout.layout">
    Type: [`F2QLayout`](transpiler-f-2-q-layout "qiskit_fermions.transpiler.F2QLayout")

    The user-provided mapping of [`FermionicRegister`](circuit-fermionic-register "qiskit_fermions.circuit.FermionicRegister") to [`QuantumRegister`](/docs/api/qiskit/circuit#qiskit.circuit.QuantumRegister).
  </Attribute>
  ...
  <Function id="qiskit_fermions.transpiler.passes.CustomF2QLayout.run" signature="run(dag)">
    ...
    **dag** ([*DAGCircuit*](/docs/api/qiskit/qiskit.dagcircuit.DAGCircuit)) – the DAG circuit representation of a [`FermionicCircuit`](circuit-fermionic-circuit "qiskit_fermions.circuit.FermionicCircuit").
