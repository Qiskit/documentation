...
<Function id="qiskit_fermions.operators.gamma" isDedicatedPage={true} signature="gamma(mode, is_prime)">
  ...
  *   **mode** ([*int*](https://docs.python.org/3/builtins/functions.html#int)) – index of the fermionic mode.
  *   **is\_prime** ([*bool*](https://docs.python.org/3/builtins/functions.html#bool)) – whether to create $\gamma$ (False) or $\gamma'$ (True).
