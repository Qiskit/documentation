...
python_api_name: qiskit_fermions.operators.library.anti_commutator
---

<span id="anti-commutator" />

# anti\_commutator

<Function id="qiskit_fermions.operators.library.anti_commutator" isDedicatedPage={true} signature="anti_commutator(op_a, op_b)">
