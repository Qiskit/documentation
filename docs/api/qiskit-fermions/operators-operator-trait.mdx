...
<Class id="qiskit_fermions.operators.OperatorTrait" isDedicatedPage={true} signature="OperatorTrait(*args, **kwargs)" modifiers="class">
  ...
  <Function id="qiskit_fermions.operators.OperatorTrait.is_hermitian" signature="is_hermitian(atol=1e-08)">
    ...
    **atol** ([*float*](https://docs.python.org/3/library/functions.html#float)) – The numerical accuracy upto which coefficients are considered equal. This value defaults to `1e-8`.
