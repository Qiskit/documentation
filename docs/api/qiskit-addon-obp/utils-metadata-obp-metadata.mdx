---
title: OBPMetadata
description: API reference for qiskit_addon_obp.utils.metadata.OBPMetadata
...
<Class id="qiskit_addon_obp.utils.metadata.OBPMetadata" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit-addon-obp/tree/main/qiskit_addon_obp/utils/metadata.py#L103-L265" signature="OBPMetadata(truncation_error_budget, num_slices, operator_budget, backpropagation_history, num_backpropagated_slices)" modifiers="class">
  ...
  <Function id="qiskit_addon_obp.utils.metadata.OBPMetadata.accumulated_error" github="https://github.com/Qiskit/qiskit-addon-obp/tree/main/qiskit_addon_obp/utils/metadata.py#L131-L168" signature="accumulated_error(observable_idx, slice_idx=None)">
  ...
  <Function id="qiskit_addon_obp.utils.metadata.OBPMetadata.from_json" github="https://github.com/Qiskit/qiskit-addon-obp/tree/main/qiskit_addon_obp/utils/metadata.py#L232-L255" signature="from_json(json_file)" modifiers="classmethod">
  ...
  <Function id="qiskit_addon_obp.utils.metadata.OBPMetadata.left_over_error_budget" github="https://github.com/Qiskit/qiskit-addon-obp/tree/main/qiskit_addon_obp/utils/metadata.py#L170-L230" signature="left_over_error_budget(observable_idx, slice_idx=None)">
  ...
  <Function id="qiskit_addon_obp.utils.metadata.OBPMetadata.to_json" github="https://github.com/Qiskit/qiskit-addon-obp/tree/main/qiskit_addon_obp/utils/metadata.py#L257-L265" signature="to_json(json_file, **kwargs)">
