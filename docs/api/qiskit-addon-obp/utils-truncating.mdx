...
<Class id="qiskit_addon_obp.utils.truncating.TruncationErrorBudget" github="https://github.com/Qiskit/qiskit-addon-obp/tree/main/qiskit_addon_obp/utils/truncating.py#L25-L58" signature="TruncationErrorBudget(per_slice_budget=<factory>, max_error_total=0.0, p_norm=1, tol=1e-08)" modifiers="class">
  ...
  *   **tol** ([*float*](https://docs.python.org/3/library/functions.html#float))
  ...
  <Function id="qiskit_addon_obp.utils.truncating.TruncationErrorBudget.is_active" github="https://github.com/Qiskit/qiskit-addon-obp/tree/main/qiskit_addon_obp/utils/truncating.py#L56-L58" signature="is_active()">
  ...
  <Attribute id="qiskit_addon_obp.utils.truncating.TruncationErrorBudget.max_error_total">
  ...
  <Attribute id="qiskit_addon_obp.utils.truncating.TruncationErrorBudget.p_norm">
  ...
  <Attribute id="qiskit_addon_obp.utils.truncating.TruncationErrorBudget.per_slice_budget">
  ...
  <Attribute id="qiskit_addon_obp.utils.truncating.TruncationErrorBudget.tol">
    Type: [`float`](https://docs.python.org/3/library/functions.html#float)
...
<Function id="qiskit_addon_obp.utils.truncating.setup_budget" github="https://github.com/Qiskit/qiskit-addon-obp/tree/main/qiskit_addon_obp/utils/truncating.py#L61-L141" signature="setup_budget(*, max_error_per_slice=None, max_error_total=None, num_slices=None, p_norm=1)">
...
<Function id="qiskit_addon_obp.utils.truncating.truncate_binary_search" github="https://github.com/Qiskit/qiskit-addon-obp/tree/main/qiskit_addon_obp/utils/truncating.py#L144-L204" signature="truncate_binary_search(observable, budget, *, p_norm=1, tol=1e-08)">
