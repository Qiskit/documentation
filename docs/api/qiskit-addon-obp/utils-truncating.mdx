...
<Function id="qiskit_addon_obp.utils.truncating.truncate_binary_search" github="https://github.com/Qiskit/qiskit-addon-obp/tree/stable/0.2/qiskit_addon_obp/utils/truncating.py#L144-L204" signature="truncate_binary_search(observable, budget, *, p_norm=1, tol=1e-08)">
  ...
  *   **observable** ([*SparsePauliOp*](/api/qiskit/qiskit.quantum_info.SparsePauliOp "(in Qiskit v1.4)")) – the `SparsePauliOp` to truncate terms from.
  ...
  **Return type**
  ...
  [tuple](https://docs.python.org/3/library/stdtypes.html#tuple "(in Python v3.13)")\[[*SparsePauliOp*](/api/qiskit/qiskit.quantum_info.SparsePauliOp "(in Qiskit v1.4)"), [float](https://docs.python.org/3/library/functions.html#float "(in Python v3.13)")]
</Function>
