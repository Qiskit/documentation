...
<Function id="qiskit_addon_obp.utils.visualization.plot_accumulated_error" github="https://github.com/Qiskit/qiskit-addon-obp/tree/main/qiskit_addon_obp/utils/visualization.py#L24-L84" signature="plot_accumulated_error(metadata, axes, *, show_legend=True)">
...
<Function id="qiskit_addon_obp.utils.visualization.plot_left_over_error_budget" github="https://github.com/Qiskit/qiskit-addon-obp/tree/main/qiskit_addon_obp/utils/visualization.py#L87-L134" signature="plot_left_over_error_budget(metadata, axes, *, show_legend=True)">
...
<Function id="qiskit_addon_obp.utils.visualization.plot_slice_errors" github="https://github.com/Qiskit/qiskit-addon-obp/tree/main/qiskit_addon_obp/utils/visualization.py#L137-L190" signature="plot_slice_errors(metadata, axes, *, show_legend=True)">
...
<Function id="qiskit_addon_obp.utils.visualization.plot_num_paulis" github="https://github.com/Qiskit/qiskit-addon-obp/tree/main/qiskit_addon_obp/utils/visualization.py#L193-L238" signature="plot_num_paulis(metadata, axes, *, show_legend=True)">
...
<Function id="qiskit_addon_obp.utils.visualization.plot_num_truncated_paulis" github="https://github.com/Qiskit/qiskit-addon-obp/tree/main/qiskit_addon_obp/utils/visualization.py#L241-L295" signature="plot_num_truncated_paulis(metadata, axes, *, show_legend=True)">
...
<Function id="qiskit_addon_obp.utils.visualization.plot_sum_paulis" github="https://github.com/Qiskit/qiskit-addon-obp/tree/main/qiskit_addon_obp/utils/visualization.py#L298-L352" signature="plot_sum_paulis(metadata, axes, *, show_legend=True)">
...
<Function id="qiskit_addon_obp.utils.visualization.plot_num_qwc_groups" github="https://github.com/Qiskit/qiskit-addon-obp/tree/main/qiskit_addon_obp/utils/visualization.py#L355-L405" signature="plot_num_qwc_groups(metadata, axes, *, show_legend=True)">
