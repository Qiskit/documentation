...
<Function id="qiskit_addon_obp.utils.visualization.plot_accumulated_error" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit-addon-obp/tree/main/qiskit_addon_obp/utils/visualization.py#L39-L96" signature="plot_accumulated_error(metadata, axes)">
  ...
  This data is related to the one visualized by [`plot_slice_errors()`](utils-visualization-plot-slice-errors "qiskit_addon_obp.utils.visualization.plot_slice_errors"). This method plots the cumulative sum of the slice errors along the x-axis.
