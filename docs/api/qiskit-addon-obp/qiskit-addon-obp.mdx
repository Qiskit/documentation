...
<Function id="qiskit_addon_obp.backpropagate" github="https://github.com/Qiskit/qiskit-addon-obp/tree/main/qiskit_addon_obp/backpropagation.py#L48-L311" signature="backpropagate(observables, slices, *, truncation_error_budget=None, operator_budget=None, max_seconds=None)">
