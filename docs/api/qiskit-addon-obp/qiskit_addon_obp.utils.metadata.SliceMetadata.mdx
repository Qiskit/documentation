...
<Class id="qiskit_addon_obp.utils.metadata.SliceMetadata" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit-addon-obp/tree/main/qiskit_addon_obp/utils/metadata.py#L35-L100" signature="SliceMetadata(slice_errors, raw_num_paulis, num_unique_paulis, num_duplicate_paulis, num_trimmed_paulis, sum_trimmed_coeffs, num_truncated_paulis, num_paulis, sum_paulis, num_qwc_groups)" modifiers="class">
  ...
  <Attribute id="qiskit_addon_obp.utils.metadata.SliceMetadata.sum_trimmed_coeffs" attributeTypeHint="list[float] | None">
    ...
    <Admonition title="Warning" type="caution">
      This sum is *not* affected by the value of [`p_norm`](qiskit_addon_obp.utils.truncating.TruncationErrorBudget#p_norm "qiskit_addon_obp.utils.truncating.TruncationErrorBudget.p_norm")!
    </Admonition>
