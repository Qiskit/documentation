...
<Class id="qiskit_addon_obp.utils.simplify.OperatorBudget" github="https://github.com/Qiskit/qiskit-addon-obp/tree/main/qiskit_addon_obp/utils/simplify.py#L43-L77" signature="OperatorBudget(max_paulis=None, max_qwc_groups=None, simplify=True, atol=None, rtol=None)" modifiers="class">
  ...
  *   **rtol** ([*float*](https://docs.python.org/3/library/functions.html#float) *| None*)
  ...
  <Attribute id="qiskit_addon_obp.utils.simplify.OperatorBudget.atol">
  ...
  <Function id="qiskit_addon_obp.utils.simplify.OperatorBudget.is_active" github="https://github.com/Qiskit/qiskit-addon-obp/tree/main/qiskit_addon_obp/utils/simplify.py#L75-L77" signature="is_active()">
  ...
  <Attribute id="qiskit_addon_obp.utils.simplify.OperatorBudget.max_paulis">
  ...
  <Attribute id="qiskit_addon_obp.utils.simplify.OperatorBudget.max_qwc_groups">
    Type: [`int`](https://docs.python.org/3/library/functions.html#int) | [`None`](https://docs.python.org/3/library/constants.html#None)
  ...
  <Attribute id="qiskit_addon_obp.utils.simplify.OperatorBudget.rtol">
    Type: [`float`](https://docs.python.org/3/library/functions.html#float) | [`None`](https://docs.python.org/3/library/constants.html#None)
  ...
  <Attribute id="qiskit_addon_obp.utils.simplify.OperatorBudget.simplify">
...
<Class id="qiskit_addon_obp.utils.simplify.SimplifyMetadata" github="https://github.com/Qiskit/qiskit-addon-obp/tree/main/qiskit_addon_obp/utils/simplify.py#L26-L40" signature="SimplifyMetadata(num_unique_paulis, num_duplicate_paulis, num_trimmed_paulis, sum_trimmed_coeffs)" modifiers="class">
  ...
  *   **sum\_trimmed\_coeffs** ([*float*](https://docs.python.org/3/library/functions.html#float))
  ...
  <Attribute id="qiskit_addon_obp.utils.simplify.SimplifyMetadata.num_duplicate_paulis">
  ...
  <Attribute id="qiskit_addon_obp.utils.simplify.SimplifyMetadata.num_trimmed_paulis">
    Type: [`int`](https://docs.python.org/3/library/functions.html#int)
  ...
  <Attribute id="qiskit_addon_obp.utils.simplify.SimplifyMetadata.num_unique_paulis">
    Type: [`int`](https://docs.python.org/3/library/functions.html#int)
  ...
  <Attribute id="qiskit_addon_obp.utils.simplify.SimplifyMetadata.sum_trimmed_coeffs">
...
<Function id="qiskit_addon_obp.utils.simplify.simplify" github="https://github.com/Qiskit/qiskit-addon-obp/tree/main/qiskit_addon_obp/utils/simplify.py#L80-L169" signature="simplify(operator, *, atol=None, rtol=None)">
