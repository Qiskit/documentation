...
This summary of the latest changes to the Qiskit Runtime service applies to anyone using Qiskit Runtime, regardless how you communicate with the service (using qiskit-ibm-runtime or otherwise), or which version of the client SDK you use. 
