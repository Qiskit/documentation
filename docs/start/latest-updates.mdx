...
### Qiskit Runtime IBM Client 0.24
...
**Highlights from the 0.24 (2024-06-10) version release**

#### Deprecation notes

- The `backend` and `session` parameters in `SamplerV2` and `EstimatorV2` are deprecated. You can use the new `mode` parameter instead. See [Get started with primitives](../run/primitives-get-started) for details.
