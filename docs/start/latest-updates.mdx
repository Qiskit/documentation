...
- The ZneOptions.amplifier option was added, which can be one of: "gate_folding" (default), "gate_folding_front", and "gate_folding_back". See the API reference for more details.
