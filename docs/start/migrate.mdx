...
-   [Algorithm tuning options (shots, transpilation, error mitigation)](../optimize#tuning-opt)
...
an algorithm, you might want to tune certain primitive options. For details, see the [Algorithm tuning options](../optimize#tuning-opt).
