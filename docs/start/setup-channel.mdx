...
You can access IBM Quantum systems by using the IBM Quantum Platform or IBM Cloud _channel_.  _Channel_ is the term used to describe the method you use to access IBM Quantum systems. 
