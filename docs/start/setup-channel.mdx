...
You can then [transpile circuits using REST APIs](/transpile/rest-api-transpilation) and run them using either the [Sampler or the Estimator Primitives](/run/rest-api-primitives).   
