...
<Admonition type="caution" title="Current users must create a new virtual environment to install Qiskit 1.0">
...
This upgrade introduces breaking changes, so you may need to adapt your code. See the [Qiskit 1.0 migration guide](/api/migration-guides/qiskit-1.0) for details and instructions.
