...
Whether you will work locally or in a cloud environment, the first step for all users is to install Qiskit. For those wanting to run on a real QPU, your next step is to choose a channel to access IBM QPUs: IBM Quantum Platform or IBM Cloud&reg;.
...
<Admonition type="tip" title="Recommendations">
  -  [Select and set up an IBM Quantum&trade; channel.](setup-channel)
