...
(If you do not have a Qiskit installation already, skip this section.) To upgrade to Qiskit 1.0, create a new virtual environment. Here is an example, using the standard tool *venv*:
