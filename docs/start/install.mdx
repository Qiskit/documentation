...
NOTE -- put John's comments in "more info on venv" twistie, with bullets
...
1. [Install pip](https://pip.pypa.io/en/stable/installation/). Pip is a Python packaging management "thing" that you use to install Qiskit and other Python packages. Use `pip list` to see what is in your venv.

1. Install the Qiskit SDK and Runtime for running on IBM Quantum hardware...
...
1. If you want to run a Jupyter notebook with the Qiskit packages you just installed, you will need to install jupyter in your environment, and run `command` to open your notebook 
