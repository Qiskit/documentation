...
<Admonition type="info" title="You must create a new virtual environment to install Qiskit 1.0">
  Because Qiskit 1.0 uses a new packaging structure, you cannot use `pip install -U qiskit` to upgrade from any Qiskit 0.x version to 1.0. Create a new virtual environment following the following steps. 
