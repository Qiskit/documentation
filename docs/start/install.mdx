---
title: Install and set up the Qiskit SDK
description: Install and set up the Qiskit SDK and Qiskit Runtime on various operating systems

---
<span id="qiskit-install"></span>
# Install and set up the Qiskit SDK

Whether you will work locally or in a cloud environment, the first step for all users is to install the Qiskit SDK. For those wanting to run on a real system, your next step is to choose one of two channels in order to access IBM Quantum&trade; systems: IBM Quantum Platform or IBM Cloud&reg;.
