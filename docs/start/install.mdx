...
<Admonition type="info" title="You must create a new virtual environment to install Qiskit 1.0">
  Because Qiskit 1.0 uses a new packaging structure, you cannot upgrade an existing Qiskit 0.x installation to Qiskit 1.0 in-place. Future updates starting with Qiskit 1.0 will allow for in-place upgrades.  
</Admonition>
