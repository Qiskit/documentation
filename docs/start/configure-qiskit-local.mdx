---
title: Configure Qiskit SDK locally
description: How to customize the configuration of a local Qiskit SDK installation.

---
# Configure Qiskit SDK locally

After Qiskit SDK is installed and running, there are some optional steps you can take to change the default Qiskit behavior.
