...
<Admonition type="note">
    * Circuit drawer settings apply to [qiskit.circuit.QuantumCircuit.draw](https://docs.quantum.ibm.com/api/qiskit/qiskit.circuit.QuantumCircuit) and [qiskit.visualization.circuit_drawer.](https://docs.quantum.ibm.com/api/qiskit/qiskit.visualization.circuit_drawer#qiskitvisualizationcircuit_drawer)
    * State visualization draw methods are [qiskit.quantum_info.Statevector.draw](https://docs.quantum.ibm.com/api/qiskit/qiskit.quantum_info.Statevector#statevector) and [qiskit.quantum_info.DensityMatrix.draw.](https://docs.quantum.ibm.com/api/qiskit/qiskit.quantum_info.Statevector#statevector)
</Admonition>
