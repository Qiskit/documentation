...
Installing Qiskit&reg; from source allows you to access the current development version, instead of using the version in the Python Package Index&reg; (PyPI&reg;) repository. This lets you inspect and extend the latest version of the Qiskit code more efficiently. 

## Create and activate a new virtual environment

1. Create a minimal environment with only Python&reg; installed in it.
...
A Rust compiler must be installed on your system to compile Qiskit. To install the Rust compiler, use the cross-platform Rust&reg; installer [rustup](https://rustup.rs/) or [another install method.](https://forge.rust-lang.org/infra/other-installation-methods.html) 
