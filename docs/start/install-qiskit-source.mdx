...
Installing Qiskit from source allows you to access the current development version, instead of using the version in the Python Package Index (PyPI) repository. This lets youe inspect and extend the latest version of the Qiskit code more efficiently. 
...
2. Change to the `qiskit-terra` directory. 
...
You can run Qiskit code examples by running the following command:
