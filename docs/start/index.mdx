...
<Admonition type="tip" title="Recommendations">
    ...
    - Explore hand-on tutorials in IBM Quantum Learning, such as:
      - [Variational Quantum Eigensolver](../tutorial/variational-quantum-eigensolver)
      - [Quantum Approximate Optimization Algorithm](../tutorial/quantum-approximate-optimization-algorithm)
      - [Grover's algorithm](../tutorial/grovers-algorithm)
    - Take the [Basics of quantum information](../course/basics-of-quantum-information) course.
    - View a list of [all tutorials in IBM Quantum Learning](../catalog?content=tutorials).
</Admonition>
