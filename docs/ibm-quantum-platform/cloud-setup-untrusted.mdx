...
Follow these instructions if you are working with IBM Cloud or the IBM Quantum Compute Service REST API in an untrusted environment, such as a public computer.
...
Follow these steps to use your API key directly to authenticate to the IBM Quantum Compute Service REST API, where `<your_API_KEY>` is the 44-character API key you created and saved from your IBM Quantum Platform dashboard.
