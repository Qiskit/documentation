...
This documentation is relevant to IBM Quantum&reg; Platform Classic. If you need the newer version, go to the new [IBM Quantum Platform documentation.]( https://quantum.cloud.ibm.com/docs/responsible-quantum-computing)
</Admonition>
</LegacyContent>
<CloudContent>
<Admonition type="note">
This documentation is relevant to the new IBM Quantum&reg; Platform. If you need the previous version, return to the [IBM Quantum Platform Classic documentation.](https://docs.quantum.ibm.com/responsible-quantum-computing)
</Admonition>
</CloudContent>
...
<CloudContent>
Please take note of two sections in the [IBM Terms](https://www.ibm.com/support/customer/csol/terms/?id=i126-9425&lc=en) that describe acceptable and responsible uses of IBM Quantum technology and services. 
