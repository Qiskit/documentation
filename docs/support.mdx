...
**A:** Please cite Qiskit by using the included `[BibTeX file](https://github.com/Qiskit/qiskit/blob/main/CITATION.bib).

**How do I cite an IBM Quantum system in my research?**

**A:** For research papers, we encourage authors to acknowledge IBM Quantum using:
