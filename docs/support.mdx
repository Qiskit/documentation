...
virtual environment, you can follow the [installation](/start/install) steps.
...
to [Operating system support](/start/install#operating-system-support) for a list of platforms supported by Qiskit, some
