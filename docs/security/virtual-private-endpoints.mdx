...
|-----------------|-----------------|-----------------|-----------------|
| `eu-de` | `Standard` | `private.eu-de.quantum.cloud.ibm.com` | `crn:v1:bluemix:public:quantum:eu-de:::endpoint:qiskit-runtime.private.eu-de.quantum.cloud.ibm.com` |
|  | `Channel Partner` | `qiskitruntime.private.eu-de.quantum.cloud.ibm.com`, `scheduler.private.eu-de.quantum.cloud.ibm.com` | `crn:v1:bluemix:public:quantum:eu-de:::endpoint:qiskit-runtime.private.eu-de.quantum.cloud.ibm.com` |
...
```bash
  curl -X POST https://private.$REGION.quantum.cloud.ibm.com/jobs -H "Authorization: Bearer $BEARER_TOKEN" -H "Service-CRN: $SERVICE_INSTANCE_CRN" -d '{
    "backend": "backend",
    "program_id": "sampler"
  }'
```
