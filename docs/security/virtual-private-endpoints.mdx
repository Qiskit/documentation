...
|  | `Channel Partner` | `qiskitruntime.private.eu-de.quantum.cloud.ibm.com`, `scheduler.private.eu-de.quantum.cloud.ibm.com` | `crn:v1:bluemix:public:quantum-computing:eu-de:::endpoint:qiskit-runtime.private.eu-de.quantum.cloud.ibm.com` |
